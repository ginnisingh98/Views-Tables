--------------------------------------------------------
--  DDL for Package PSP_POA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_POA_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_organization_account_id
--     already exists.
--
--  In Arguments:
