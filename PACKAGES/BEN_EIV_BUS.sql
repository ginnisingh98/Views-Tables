--------------------------------------------------------
--  DDL for Package BEN_EIV_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EIV_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_extra_input_value_id
--     already exists.
--
--  In Arguments:
