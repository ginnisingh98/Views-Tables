--------------------------------------------------------
--  DDL for Package BEN_WCT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_WCT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  wv_prtn_rsn_ctfn_ptip_id          number(15),
  effective_start_date              date,
  effective_end_date                date,
  wv_prtn_ctfn_cd                   varchar2(30),
  wv_prtn_rsn_ptip_id               number(15),
  lack_ctfn_sspnd_wvr_flag          varchar2(30),
  rqd_flag                          varchar2(30),
  ctfn_rqd_when_rl                  number(15),
  pfd_flag                          varchar2(30),
  wv_prtn_ctfn_typ_cd               varchar2(30),
  business_group_id                 number(15),
  wct_attribute_category            varchar2(30),
  wct_attribute1                    varchar2(150),
  wct_attribute2                    varchar2(150),
  wct_attribute3                    varchar2(150),
  wct_attribute4                    varchar2(150),
  wct_attribute5                    varchar2(150),
  wct_attribute6                    varchar2(150),
  wct_attribute7                    varchar2(150),
  wct_attribute8                    varchar2(150),
  wct_attribute9                    varchar2(150),
  wct_attribute10                   varchar2(150),
  wct_attribute11                   varchar2(150),
  wct_attribute12                   varchar2(150),
  wct_attribute13                   varchar2(150),
  wct_attribute14                   varchar2(150),
  wct_attribute15                   varchar2(150),
  wct_attribute16                   varchar2(150),
  wct_attribute17                   varchar2(150),
  wct_attribute18                   varchar2(150),
  wct_attribute19                   varchar2(150),
  wct_attribute20                   varchar2(150),
  wct_attribute21                   varchar2(150),
  wct_attribute22                   varchar2(150),
  wct_attribute23                   varchar2(150),
  wct_attribute24                   varchar2(150),
  wct_attribute25                   varchar2(150),
  wct_attribute26                   varchar2(150),
  wct_attribute27                   varchar2(150),
  wct_attribute28                   varchar2(150),
  wct_attribute29                   varchar2(150),
  wct_attribute30                   varchar2(150),
...
--           p_base_key_value = :wv_prtn_rsn_ctfn_ptip_id).
--
-- Post Success:
--   Processing continues.
--
