--------------------------------------------------------
--  DDL for Package BEN_PUM_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PUM_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_pop_up_messages_id already exists.
--
--  In Arguments:
...
function return_legislation_code
  (p_pop_up_messages_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
