--------------------------------------------------------
--  DDL for Package PER_OBJ_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_OBJ_FLEX" AUTHID CURRENT_USER as
/* $Header: peobjfli.pkh 115.2 99/10/15 15:42:02 porting ship $ */
--
--
-------------------------------------------------------------------------------
-- |-------------------------------< df>-------------------------------------|
