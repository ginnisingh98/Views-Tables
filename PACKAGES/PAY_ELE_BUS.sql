--------------------------------------------------------
--  DDL for Package PAY_ELE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_ELE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_element_entry_id
--     already exists.
--
--  In Arguments:
--    p_element_entry_id
