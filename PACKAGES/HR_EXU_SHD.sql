--------------------------------------------------------
--  DDL for Package HR_EXU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_EXU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  exception_usage_id                number(15),
  exception_reason                  varchar2(2000),
  calendar_id                       number(15),
  calendar_usage_id                 number(15),
