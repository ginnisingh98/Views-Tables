--------------------------------------------------------
--  DDL for Package BEN_ECT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ECT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_dsblty_ctg_prte_id           number(15),
  ...
  ect_attribute_category            varchar2(30),
  ect_attribute1                    varchar2(150),
  ect_attribute2                    varchar2(150),
  ect_attribute3                    varchar2(150),
  ect_attribute4                    varchar2(150),
  ect_attribute5                    varchar2(150),
  ect_attribute6                    varchar2(150),
  ect_attribute7                    varchar2(150),
  ect_attribute8                    varchar2(150),
  ect_attribute9                    varchar2(150),
  ect_attribute10                   varchar2(150),
  ect_attribute11                   varchar2(150),
  ect_attribute12                   varchar2(150),
  ect_attribute13                   varchar2(150),
  ect_attribute14                   varchar2(150),
  ect_attribute15                   varchar2(150),
  ect_attribute16                   varchar2(150),
  ect_attribute17                   varchar2(150),
  ect_attribute18                   varchar2(150),
  ect_attribute19                   varchar2(150),
  ect_attribute20                   varchar2(150),
  ect_attribute21                   varchar2(150),
  ect_attribute22                   varchar2(150),
  ect_attribute23                   varchar2(150),
  ect_attribute24                   varchar2(150),
  ect_attribute25                   varchar2(150),
  ect_attribute26                   varchar2(150),
  ect_attribute27                   varchar2(150),
  ect_attribute28                   varchar2(150),
  ect_attribute29                   varchar2(150),
  ect_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_dsblty_ctg_prte_id).
--
-- Post Success:
--   Processing continues.
--
