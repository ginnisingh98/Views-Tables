--------------------------------------------------------
--  DDL for Package PAY_RFP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_RFP_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_REPORT_FORMAT_PARAMETERS';
