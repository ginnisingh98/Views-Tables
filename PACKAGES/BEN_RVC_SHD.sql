--------------------------------------------------------
--  DDL for Package BEN_RVC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_RVC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  prtt_rt_val_ctfn_prvdd_id               number(15),
  ...
  rvc_attribute_category            varchar2(30),
  rvc_attribute1                    varchar2(150),
  rvc_attribute2                    varchar2(150),
  rvc_attribute3                    varchar2(150),
  rvc_attribute4                    varchar2(150),
  rvc_attribute5                    varchar2(150),
  rvc_attribute6                    varchar2(150),
  rvc_attribute7                    varchar2(150),
  rvc_attribute8                    varchar2(150),
  rvc_attribute9                    varchar2(150),
  rvc_attribute10                   varchar2(150),
  rvc_attribute11                   varchar2(150),
  rvc_attribute12                   varchar2(150),
  rvc_attribute13                   varchar2(150),
  rvc_attribute14                   varchar2(150),
  rvc_attribute15                   varchar2(150),
  rvc_attribute16                   varchar2(150),
  rvc_attribute17                   varchar2(150),
  rvc_attribute18                   varchar2(150),
  rvc_attribute19                   varchar2(150),
  rvc_attribute20                   varchar2(150),
  rvc_attribute21                   varchar2(150),
  rvc_attribute22                   varchar2(150),
  rvc_attribute23                   varchar2(150),
  rvc_attribute24                   varchar2(150),
  rvc_attribute25                   varchar2(150),
  rvc_attribute26                   varchar2(150),
  rvc_attribute27                   varchar2(150),
  rvc_attribute28                   varchar2(150),
  rvc_attribute29                   varchar2(150),
  rvc_attribute30                   varchar2(150),
