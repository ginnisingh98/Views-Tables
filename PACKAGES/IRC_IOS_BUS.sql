--------------------------------------------------------
--  DDL for Package IRC_IOS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IOS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_offer_status_history_id
--     already exists.
--
--  In Arguments:
