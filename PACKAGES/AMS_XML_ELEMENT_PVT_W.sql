--------------------------------------------------------
--  DDL for Package AMS_XML_ELEMENT_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_XML_ELEMENT_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswxels.pls 115.3 2002/11/12 23:47:23 jieli noship $ */
  procedure rosetta_table_copy_in_p1(t OUT NOCOPY ams_xml_element_pvt.num_data_set_type_w, a0 JTF_NUMBER_TABLE);
  procedure rosetta_table_copy_out_p1(t ams_xml_element_pvt.num_data_set_type_w, a0 OUT NOCOPY JTF_NUMBER_TABLE);

  procedure rosetta_table_copy_in_p2(t OUT NOCOPY ams_xml_element_pvt.varchar2_2000_set_type, a0 JTF_VARCHAR2_TABLE_2000);
  procedure rosetta_table_copy_out_p2(t ams_xml_element_pvt.varchar2_2000_set_type, a0 OUT NOCOPY JTF_VARCHAR2_TABLE_2000);
