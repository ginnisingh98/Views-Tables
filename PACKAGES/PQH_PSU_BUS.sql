--------------------------------------------------------
--  DDL for Package PQH_PSU_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_PSU_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_emp_stat_situation_id
--     already exists.
--
--  In Arguments:
