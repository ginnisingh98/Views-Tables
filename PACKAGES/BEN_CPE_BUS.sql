--------------------------------------------------------
--  DDL for Package BEN_CPE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CPE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_copy_entity_result_id
--     already exists.
--
--  In Arguments:
