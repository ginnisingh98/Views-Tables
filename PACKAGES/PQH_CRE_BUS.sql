--------------------------------------------------------
--  DDL for Package PQH_CRE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CRE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_criteria_rate_element_id
--     already exists.
--
--  In Arguments:
