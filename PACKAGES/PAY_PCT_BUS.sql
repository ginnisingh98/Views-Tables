--------------------------------------------------------
--  DDL for Package PAY_PCT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PCT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_user_column_id
--     already exists.
--
--  In Arguments:
--    p_user_column_id
