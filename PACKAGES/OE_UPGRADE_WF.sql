--------------------------------------------------------
--  DDL for Package OE_UPGRADE_WF
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_UPGRADE_WF" AUTHID CURRENT_USER as
/* $Header: OEXIUWFS.pls 115.10 2003/10/20 06:58:46 appldev ship $ */
...
V_ERROR_MESSAGE     varchar2(80);   /* Globle variable */
