--------------------------------------------------------
--  DDL for Package HR_EAP_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_EAP_DEL" AUTHID CURRENT_USER as
...
-- {Start of Comments}
-- Description:
--   This procedure is called to delete the external application details in SSO
--   schema and if successful then delete from hr_ki_ext_applications
--
-- Prerequisites:
--
-- In Parameters:
...
--
-- Post Success:
-- External application is deleted from SSO schema and from
-- hr_ki_ext_applications.
--
-- Post Failure:
