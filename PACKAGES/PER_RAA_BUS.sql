--------------------------------------------------------
--  DDL for Package PER_RAA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RAA_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_recruitment_activity_id
--     already exists.
--
--  In Arguments:
