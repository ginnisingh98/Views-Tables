--------------------------------------------------------
--  DDL for Package PQH_RLS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RLS_SHD" AUTHID CURRENT_USER as
...
--
-- mvankada
-- Added Developer DF columns to the type g_rec_type

Type g_rec_type Is Record
  (role_id                         number(15)
  ,role_name                       varchar2(30)
  ,role_type_cd                    varchar2(30)
...
-- mvanakda
-- Passed Developer DF Columns to the function convert_args
