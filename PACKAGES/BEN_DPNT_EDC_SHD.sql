--------------------------------------------------------
--  DDL for Package BEN_DPNT_EDC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DPNT_EDC_SHD" AUTHID CURRENT_USER AS
...
Type g_rec_type Is Record
  (
  dpnt_eligy_crit_values_id                             Number(15),
  dpnt_cvg_eligy_prfl_id                                Number(15),
  eligy_criteria_dpnt_id                                Number(15),
  ...
  edc_attribute_category                           Varchar2(30),
  edc_attribute1                                   Varchar2(150),
  edc_attribute2                                   Varchar2(150),
  edc_attribute3                                   Varchar2(150),
  edc_attribute4                                   Varchar2(150),
  edc_attribute5                                   Varchar2(150),
  edc_attribute6                                   Varchar2(150),
  edc_attribute7                                   Varchar2(150),
  edc_attribute8                                   Varchar2(150),
  edc_attribute9                                   Varchar2(150),
  edc_attribute10                                  Varchar2(150),
  edc_attribute11                                  Varchar2(150),
  edc_attribute12                                  Varchar2(150),
  edc_attribute13                                  Varchar2(150),
  edc_attribute14                                  Varchar2(150),
  edc_attribute15                                  Varchar2(150),
  edc_attribute16                                  Varchar2(150),
  edc_attribute17                                  Varchar2(150),
  edc_attribute18                                  Varchar2(150),
  edc_attribute19                                  Varchar2(150),
  edc_attribute20                                  Varchar2(150),
  edc_attribute21                                  Varchar2(150),
  edc_attribute22                                  Varchar2(150),
  edc_attribute23                                  Varchar2(150),
  edc_attribute24                                  Varchar2(150),
  edc_attribute25                                  Varchar2(150),
  edc_attribute26                                  Varchar2(150),
  edc_attribute27                                  Varchar2(150),
  edc_attribute28                                  Varchar2(150),
  edc_attribute29                                  Varchar2(150),
  edc_attribute30                                  Varchar2(150),
  object_version_number                            Number(9),
  Char_value3                                      Varchar2(240),
  Char_value4                                      Varchar2(240),
  Number_value3                                    Number,
  Number_value4                                    Number,
  Date_value3                                      Date,
  Date_value4                                      Date
  );
--
...
--           p_base_key_value = :eligy_crit_values_id).
--
-- Post Success:
--   Processing continues.
--
