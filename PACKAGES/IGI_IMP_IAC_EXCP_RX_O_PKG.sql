--------------------------------------------------------
--  DDL for Package IGI_IMP_IAC_EXCP_RX_O_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGI_IMP_IAC_EXCP_RX_O_PKG" AUTHID CURRENT_USER AS
-- $Header: igiiaeos.pls 120.3.12000000.1 2007/08/01 16:15:11 npandya noship $
