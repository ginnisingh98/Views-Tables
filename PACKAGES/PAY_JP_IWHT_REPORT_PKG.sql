--------------------------------------------------------
--  DDL for Package PAY_JP_IWHT_REPORT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_JP_IWHT_REPORT_PKG" AUTHID CURRENT_USER AS
-- $Header: pyjpiwrt.pkh 120.0.12010000.4 2010/03/08 18:07:47 rdarasi noship $
-- *******************************************************************************************************
...
-- *                                                                                                     *
-- * USAGE                                                                                               *
-- *   To install       sqlplus <apps_user>/<apps_pwd> @PAYJPIWHTREPORTPKG.pkh                           *
...
-- *******************************************************************************************************
TYPE parameters IS RECORD (rep_group                        VARCHAR2(50)
                          ,rep_cat                          VARCHAR2(50)
                          ,business_group_id                NUMBER
                          ,effective_date                   DATE
                          ,subject_year                     NUMBER
                          ,withholding_agent                NUMBER
