--------------------------------------------------------
--  DDL for Package BEN_BCD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BCD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (cwb_matrix_dtl_id               number(15)
  ,cwb_matrix_id                   number(15)
  ,row_crit_val                    varchar2(150)
  ,col_crit_val                    varchar2(150)
  ,pct_emp_cndr                    number
  ,pct_val                         number
  ,emp_amt                         number
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_CWB_MATRIX_DTL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
