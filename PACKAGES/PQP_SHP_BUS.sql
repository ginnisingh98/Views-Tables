--------------------------------------------------------
--  DDL for Package PQP_SHP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_SHP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_service_history_period_id
--     already exists.
--
--  In Arguments:
