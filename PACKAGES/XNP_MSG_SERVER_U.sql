--------------------------------------------------------
--  DDL for Package XNP_MSG_SERVER_U
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XNP_MSG_SERVER_U" AUTHID CURRENT_USER AS
/* $Header: XNPMSGSS.pls 120.1 2005/06/24 04:44:41 appldev ship $ */


--Create message procedure for message type MSG_SERVER
--
...
--Create publish procedure for message type MSG_SERVER
--
...
--Create send procedure for message type MSG_SERVER
--
...
--Create process procedure for message type MSG_SERVER
--
...
--Create default process procedure for message type MSG_SERVER
--
...
--Create validate procedure for message type MSG_SERVER
--
