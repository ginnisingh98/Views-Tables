--------------------------------------------------------
--  DDL for Package ASF_USER_PREFERENCE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ASF_USER_PREFERENCE_PUB_W" AUTHID CURRENT_USER as
  /* $Header: asfupfws.pls 115.3 2003/01/28 22:13:22 avijayak ship $ */
