--------------------------------------------------------
--  DDL for Package EDW_OPI_LOT_MOPM_SZ
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."EDW_OPI_LOT_MOPM_SZ" AUTHID CURRENT_USER AS
/* $Header: OPIPLTZS.pls 120.1 2005/06/07 03:57:56 appldev  $*/
