--------------------------------------------------------
--  DDL for Package HXT_TRAN_PA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXT_TRAN_PA" AUTHID CURRENT_USER AS
/* $Header: hxtpa.pkh 120.0 2005/05/29 05:54:38 appldev noship $ */
  ...
  g_err_effective_end   DATE                   DEFAULT hr_general.end_of_time;  --FORMS60
