--------------------------------------------------------
--  DDL for Package PO_HEADERS_PKG_S2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PO_HEADERS_PKG_S2" AUTHID CURRENT_USER as
/* $Header: POXP3PHS.pls 120.3.12010000.2 2011/04/08 17:26:30 lswamina ship $ */
...
/*===========================================================================
  ...
  CHANGE HISTORY:      Sudha Iyer         04/95
                       WLAU               06/27/96  Added Supply_Agreement_Flag
...
/*===========================================================================
  ...
  DESCRIPTION:     Table Handler for Delete Row()
...
/*===========================================================================
  ...
  DESCRIPTION:     Checking if the docuemnt number entered is
                   a unique one. Called during Insert_Row().
  ...
  CHANGE HISTORY:      Sudha Iyer         04/95
			Melissa Snyder	  12/95	  added RFQ/Quote specific
						  processing.
...
===============================================================================*/
  ...
  FUNCTION Check_Unique(X_Segment1 VARCHAR2 , X_rowid VARCHAR2,
			X_Type_lookup_code VARCHAR2,X_bid_number NUMBER default NULL)
           return boolean;


  FUNCTION po_total(X_po_header_id IN NUMBER)
           return number;
--  pragma restrict_references (po_total,WNDS, RNPS, WNPS);
