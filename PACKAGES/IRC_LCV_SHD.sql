--------------------------------------------------------
--  DDL for Package IRC_LCV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_LCV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (location_criteria_value_id      number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_LOCATION_CRITERIA_VALUES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
