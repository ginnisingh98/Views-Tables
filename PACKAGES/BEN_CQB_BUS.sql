--------------------------------------------------------
--  DDL for Package BEN_CQB_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CQB_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cbr_quald_bnf_id already exists.
--
--  In Arguments:
--    p_cbr_quald_bnf_id
--
...
function return_legislation_code
  (p_cbr_quald_bnf_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
