--------------------------------------------------------
--  DDL for Package BEN_EDB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EDB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  edb_attribute_category            varchar2(30),
  edb_attribute1                    varchar2(150),
  edb_attribute2                    varchar2(150),
  edb_attribute3                    varchar2(150),
  edb_attribute4                    varchar2(150),
  edb_attribute5                    varchar2(150),
  edb_attribute6                    varchar2(150),
  edb_attribute7                    varchar2(150),
  edb_attribute8                    varchar2(150),
  edb_attribute9                    varchar2(150),
  edb_attribute10                   varchar2(150),
  edb_attribute11                   varchar2(150),
  edb_attribute12                   varchar2(150),
  edb_attribute13                   varchar2(150),
  edb_attribute14                   varchar2(150),
  edb_attribute15                   varchar2(150),
  edb_attribute16                   varchar2(150),
  edb_attribute17                   varchar2(150),
  edb_attribute18                   varchar2(150),
  edb_attribute19                   varchar2(150),
  edb_attribute20                   varchar2(150),
  edb_attribute21                   varchar2(150),
  edb_attribute22                   varchar2(150),
  edb_attribute23                   varchar2(150),
  edb_attribute24                   varchar2(150),
  edb_attribute25                   varchar2(150),
  edb_attribute26                   varchar2(150),
  edb_attribute27                   varchar2(150),
  edb_attribute28                   varchar2(150),
  edb_attribute29                   varchar2(150),
  edb_attribute30                   varchar2(150),
  object_version_number             number(9),
  criteria_score               number,  --added for Eligibility ranking
  criteria_weight            number ); --added for Eligibility ranking
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :elig_dsbld_prte_id).
--
-- Post Success:
--   Processing continues.
--
