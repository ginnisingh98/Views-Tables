--------------------------------------------------------
--  DDL for Package IEO_SVR_TYPES_SEED_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IEO_SVR_TYPES_SEED_PVT" AUTHID CURRENT_USER AS
/* $Header: IEOSEEDS.pls 115.0 2000/01/19 10:10:05 pkm ship     $ */
