--------------------------------------------------------
--  DDL for Package PAY_EVENT_QUALIFIERS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EVENT_QUALIFIERS_BK1" AUTHID CURRENT_USER as
/* $Header: pyevqapi.pkh 120.1 2005/10/02 02:31:23 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------< create_event_qualifier_b >-------------------------|
-- ----------------------------------------------------------------------------
--
