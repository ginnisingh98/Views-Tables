--------------------------------------------------------
--  DDL for Package PER_MEDICAL_ASSESSMENT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_MEDICAL_ASSESSMENT_BK2" AUTHID CURRENT_USER AS
/* $Header: pemeaapi.pkh 120.2 2005/10/22 01:23:54 aroussel noship $ */
--
-- ----------------------------------------------------------------------------
-- |--------------------< update_medical_assessment_b >-----------------------|
-- ----------------------------------------------------------------------------
--
PROCEDURE update_medical_assessment_b
...
--
-- ----------------------------------------------------------------------------
-- |--------------------< update_medical_assessment_a >-----------------------|
-- ----------------------------------------------------------------------------
--
PROCEDURE update_medical_assessment_a
  (p_medical_assessment_id         IN     NUMBER
  ,p_object_version_number         IN     NUMBER
  ,p_effective_date                IN     DATE
  ,p_consultation_date             IN     DATE
  ...
  ,p_mea_information30             IN     VARCHAR2);
--
END per_medical_assessment_bk2;
