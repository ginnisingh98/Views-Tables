--------------------------------------------------------
--  DDL for Package XNP_ERROR_RESP_U
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XNP_ERROR_RESP_U" AUTHID CURRENT_USER AS
/* $Header: XNPERRES.pls 120.2 2006/02/13 07:46:40 dputhiye ship $ */

--Create message procedure for message type ERROR_RESP
--
...
--Create publish procedure for message type ERROR_RESP
...
--Create send procedure for message type ERROR_RESP
--
...
--Create process procedure for message type ERROR_RESP
--
...
--Create default process procedure for message type ERROR_RESP
--
...
--Create validate procedure for message type ERROR_RESP
--
