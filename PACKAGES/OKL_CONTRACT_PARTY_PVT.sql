--------------------------------------------------------
--  DDL for Package OKL_CONTRACT_PARTY_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_CONTRACT_PARTY_PVT" AUTHID CURRENT_USER AS
/* $Header: OKLRCPCS.pls 115.5 2002/03/21 18:04:09 pkm ship       $ */
  -- complex entity object subtype definitions
SUBTYPE ctcv_rec_type is OKL_OKC_MIGRATION_PVT.ctcv_rec_type;
...
END; -- Package Specification OKL_CONTRACT_PARTY_PVT
