--------------------------------------------------------
--  DDL for Package BEN_DDR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DDR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dsgn_rqmt_id                      number(15),
  effective_start_date              date,
  effective_end_date                date,
  mn_dpnts_rqd_num                  number(15),
  mx_dpnts_alwd_num                 number(15),
  no_mn_num_dfnd_flag               varchar2(30),
  no_mx_num_dfnd_flag               varchar2(30),
  cvr_all_elig_flag                 varchar2(30),
  oipl_id                           number(15),
  pl_id                             number(15),
  opt_id                            number(15),
  grp_rlshp_cd                      varchar2(30),
  dsgn_typ_cd                       varchar2(30),
  business_group_id                 number(15),
  ddr_attribute_category            varchar2(30),
  ddr_attribute1                    varchar2(150),
  ddr_attribute2                    varchar2(150),
  ddr_attribute3                    varchar2(150),
  ddr_attribute4                    varchar2(150),
  ddr_attribute5                    varchar2(150),
  ddr_attribute6                    varchar2(150),
  ddr_attribute7                    varchar2(150),
  ddr_attribute8                    varchar2(150),
  ddr_attribute9                    varchar2(150),
  ddr_attribute10                   varchar2(150),
  ddr_attribute11                   varchar2(150),
  ddr_attribute12                   varchar2(150),
  ddr_attribute13                   varchar2(150),
  ddr_attribute14                   varchar2(150),
  ddr_attribute15                   varchar2(150),
  ddr_attribute16                   varchar2(150),
  ddr_attribute17                   varchar2(150),
  ddr_attribute18                   varchar2(150),
  ddr_attribute19                   varchar2(150),
  ddr_attribute20                   varchar2(150),
  ddr_attribute21                   varchar2(150),
  ddr_attribute22                   varchar2(150),
  ddr_attribute23                   varchar2(150),
  ddr_attribute24                   varchar2(150),
  ddr_attribute25                   varchar2(150),
  ddr_attribute26                   varchar2(150),
  ddr_attribute27                   varchar2(150),
  ddr_attribute28                   varchar2(150),
  ddr_attribute29                   varchar2(150),
  ddr_attribute30                   varchar2(150),
