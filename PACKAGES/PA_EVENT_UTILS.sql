--------------------------------------------------------
--  DDL for Package PA_EVENT_UTILS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PA_EVENT_UTILS" AUTHID CURRENT_USER AS
/* $Header: PAEVAPUS.pls 120.2 2007/02/07 10:42:29 rgandhi ship $ */


pvt_excp        exception;  --user defined exception
