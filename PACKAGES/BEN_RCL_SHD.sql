--------------------------------------------------------
--  DDL for Package BEN_RCL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_RCL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  rltd_per_chg_cs_ler_id            number(15),
  name                              varchar2(600),
  ...
  rltd_per_chg_cs_ler_rl            number(15),
  business_group_id                 number(15),
  rcl_attribute_category            varchar2(30),
  rcl_attribute1                    varchar2(150),
  rcl_attribute2                    varchar2(150),
  rcl_attribute3                    varchar2(150),
  rcl_attribute4                    varchar2(150),
  rcl_attribute5                    varchar2(150),
  rcl_attribute6                    varchar2(150),
  rcl_attribute7                    varchar2(150),
  rcl_attribute8                    varchar2(150),
  rcl_attribute9                    varchar2(150),
  rcl_attribute10                   varchar2(150),
  rcl_attribute11                   varchar2(150),
  rcl_attribute12                   varchar2(150),
  rcl_attribute13                   varchar2(150),
  rcl_attribute14                   varchar2(150),
  rcl_attribute15                   varchar2(150),
  rcl_attribute16                   varchar2(150),
  rcl_attribute17                   varchar2(150),
  rcl_attribute18                   varchar2(150),
  rcl_attribute19                   varchar2(150),
  rcl_attribute20                   varchar2(150),
  rcl_attribute21                   varchar2(150),
  rcl_attribute22                   varchar2(150),
  rcl_attribute23                   varchar2(150),
  rcl_attribute24                   varchar2(150),
  rcl_attribute25                   varchar2(150),
  rcl_attribute26                   varchar2(150),
  rcl_attribute27                   varchar2(150),
  rcl_attribute28                   varchar2(150),
  rcl_attribute29                   varchar2(150),
  rcl_attribute30                   varchar2(150),
...
--           p_base_key_value = :rltd_per_chg_cs_ler_id).
--
-- Post Success:
--   Processing continues.
--
