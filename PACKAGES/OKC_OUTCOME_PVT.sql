--------------------------------------------------------
--  DDL for Package OKC_OUTCOME_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_OUTCOME_PVT" AUTHID CURRENT_USER as
/* $Header: OKCCOCES.pls 120.0 2005/05/25 22:38:44 appldev noship $ */
 ...
 ----------------------------------------------------------------------------------
 -- Global Variables
 G_PKG_NAME             CONSTANT VARCHAR2(200) := 'OKC_OUTCOME_PVT';
