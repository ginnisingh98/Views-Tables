--------------------------------------------------------
--  DDL for Package PER_ESA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ESA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  establishment_id                  number(9),
  establishment                     varchar2(255),
  attended_start_date               date,
  attended_end_date                 date,
  full_time                         varchar2(30),
  ...
  party_id                          per_establishment_attendances.party_id%TYPE,
