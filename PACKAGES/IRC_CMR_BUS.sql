--------------------------------------------------------
--  DDL for Package IRC_CMR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_CMR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_communication_recipient_id
--     already exists.
--
--  In Arguments:
