--------------------------------------------------------
--  DDL for Package BEN_BENCLSUM_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BENCLSUM_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: BENCLSUMS.pls 120.1 2007/12/10 08:26:51 vjaganat noship $ */
	...
	CP_CLSNODEF	number;
	CP_TOTCLSDEF	number;
	CP_TOTCLSNDEF	number;
	CP_tot	number;
	CP_LOCATION	varchar2(240);
	CP_ASSIGNED_LIFE_EVENT_DATE	varchar2(30);
	CP_ACTION_ITEM_EFFECTIVE_DATE	date;
	CP_AUDIT_LOG_FLAG	varchar2(32767);
	CP_CLOSE_ACTION_ITEMS_FLAG	varchar2(32767);
	...
	Function CP_TOTCLSDEF_p return number;
	Function CP_TOTCLSNDEF_p return number;
	...
	Function CP_ACTION_ITEM_EFFECTIVE_DATE1 return date;
