--------------------------------------------------------
--  DDL for Package BEN_GOS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_GOS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_gd_or_svc_typ_id already exists.
--
--  In Arguments:
--    p_gd_or_svc_typ_id
--
...
function return_legislation_code
  (p_gd_or_svc_typ_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
