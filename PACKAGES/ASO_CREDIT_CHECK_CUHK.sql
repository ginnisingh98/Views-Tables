--------------------------------------------------------
--  DDL for Package ASO_CREDIT_CHECK_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ASO_CREDIT_CHECK_CUHK" AUTHID CURRENT_USER as
/* $Header: asocqccs.pls 120.1 2005/06/29 12:31:25 appldev ship $ */
-- Start of Comments
-- Start of Comments
-- Package name     : ASO_CREDIT_CHECK_CUHK
-- Purpose          :
...
--       P_result_out              IN   VARCHAR2   Only to Post Hook Procedure.
--       P_cc_hold_comment         IN   VARCHAR2   Only to Post Hook Procedure.
--
--   OUT:
