--------------------------------------------------------
--  DDL for Package FA_FAS444_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_FAS444_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: FAS444S.pls 120.0.12010000.1 2008/07/28 13:14:42 appldev ship $ */
	P_BOOK	varchar2(15);
