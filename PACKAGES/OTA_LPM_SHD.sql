--------------------------------------------------------
--  DDL for Package OTA_LPM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_LPM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,course_sequence                 number(9)         -- Increased length
  ...
  ,learning_path_section_id        number(10)
  ,notify_days_before_target       number(10)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_LEARNING_PATH_MEMBERS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
