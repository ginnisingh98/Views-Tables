--------------------------------------------------------
--  DDL for Package EAM_SUB_RESOURCE_DEFAULT_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."EAM_SUB_RESOURCE_DEFAULT_PVT" AUTHID CURRENT_USER AS
/* $Header: EAMVSRDS.pls 115.1 2002/11/24 23:48:44 baroy noship $ */
/***************************************************************************
--
