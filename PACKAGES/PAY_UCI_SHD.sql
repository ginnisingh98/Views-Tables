--------------------------------------------------------
--  DDL for Package PAY_UCI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_UCI_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (user_column_instance_id         number(15)
  ,effective_start_date            date
  ,effective_end_date              date
  ,user_row_id                     number(15)
  ,user_column_id                  number(9)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_USER_COLUMN_INSTANCES_F';
...
--           p_base_key_value = :user_column_instance_id).
--
-- Post Success:
--   Processing continues.
--
