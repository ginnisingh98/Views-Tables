--------------------------------------------------------
--  DDL for Package BEN_BATCH_PARAMETER_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BATCH_PARAMETER_BK1" AUTHID CURRENT_USER as
/* $Header: bebbpapi.pkh 120.0 2005/05/28 00:33:50 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_batch_parameter_b >-------------------|
-- ----------------------------------------------------------------------------
--
