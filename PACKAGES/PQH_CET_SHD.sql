--------------------------------------------------------
--  DDL for Package PQH_CET_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CET_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  context_business_group_id         number(15),
  datetrack_mode                    varchar2(30),
  context                           varchar2(27),
  action_date                       date ,
  src_effective_date                date ,
  number_of_copies                  number(15),
  display_name                      varchar2(100),
  replacement_type_cd               varchar2(30),
  start_with                        varchar2(255),
  increment_by                      number(15),
  status                            varchar2(30),
