--------------------------------------------------------
--  DDL for Package OKL_PROCESS_ACC_GROUP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_PROCESS_ACC_GROUP_PVT" AUTHID CURRENT_USER AS
/* $Header: OKLRAGGS.pls 115.3 2002/02/18 20:12:23 pkm ship       $ */



  SUBTYPE agcv_rec_type IS okl_acc_group_pub.agcv_rec_type;

  SUBTYPE agcv_tbl_type IS okl_acc_group_pub.agcv_tbl_type;



  SUBTYPE agbv_rec_type IS okl_acc_group_pub.agbv_rec_type;

  SUBTYPE agbv_tbl_type IS okl_acc_group_pub.agbv_tbl_type;
  ...
  G_PKG_NAME                     CONSTANT VARCHAR2(200) := 'OKL_PROCESS_ACC_GROUP_PVT';
