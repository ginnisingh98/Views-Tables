--------------------------------------------------------
--  DDL for Package OTA_RESOURCE_DEFINITION_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_RESOURCE_DEFINITION_BK1" AUTHID CURRENT_USER as
/* $Header: ottsrapi.pkh 120.3 2006/08/04 10:43:59 niarora noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  OTA_RESOURCE_DEFINITION_BK1.';
--
-- ----------------------------------------------------------------------------
-- |--------------------------< CREATE_RESOURCE_DEFINITION_B >---------------------------|
-- ----------------------------------------------------------------------------
-- {Start Of Comments}
--
-- Description:
...
-- {End Of Comments}
--
procedure CREATE_RESOURCE_DEFINITION_B
...
-- {End Of Comments}
--
procedure CREATE_RESOURCE_DEFINITION_A
...
end OTA_RESOURCE_DEFINITION_BK1;
