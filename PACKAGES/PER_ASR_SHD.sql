--------------------------------------------------------
--  DDL for Package PER_ASR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ASR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  assessment_group_id               number(9),
  name                              varchar2(30),
  business_group_id                 number(15),
  membership_list                   varchar2(2000),
