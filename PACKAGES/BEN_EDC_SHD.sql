--------------------------------------------------------
--  DDL for Package BEN_EDC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EDC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_dsbld_stat_cvg_id            number(15),
...
--           p_base_key_value = :elig_dsbld_stat_cvg_id).
--
-- Post Success:
--   Processing continues.
--
