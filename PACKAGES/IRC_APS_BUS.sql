--------------------------------------------------------
--  DDL for Package IRC_APS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_APS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_profile_snapshot_id
--     already exists.
--
--  In Arguments:
