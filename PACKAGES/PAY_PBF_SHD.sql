--------------------------------------------------------
--  DDL for Package PAY_PBF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PBF_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_BALANCE_FEEDS_F';
...
--           p_base_key_value = :balance_feed_id).
--
-- Post Success:
--   Processing continues.
--
