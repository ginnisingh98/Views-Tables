--------------------------------------------------------
--  DDL for Package PQH_PQIPED7_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_PQIPED7_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: PQIPED7S.pls 120.2 2007/12/21 17:28:28 vjaganat noship $ */
	...
	CP_PT	varchar2(2000);
	line_num	number := 69 ;
	LastLineNo	number := 77 ;
	totTitle	varchar2(52) := 'Total Part-Time Employees (sum of lines 68-76)' ;
