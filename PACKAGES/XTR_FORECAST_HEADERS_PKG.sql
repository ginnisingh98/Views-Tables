--------------------------------------------------------
--  DDL for Package XTR_FORECAST_HEADERS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XTR_FORECAST_HEADERS_PKG" AUTHID CURRENT_USER AS
/* $Header: xtrfhdrs.pls 120.1 2005/06/29 06:37:32 badiredd ship $ 	*/
--
-- Package
--   XTR_FORECAST_HEADERS_PKG
-- Purpose
...
--
  ...
  --   07.10.96   C. Kawamoto   Created
  -- Example
  --   XTR_FORECAST_HEADERS_PKG.Check_Unique(...);
  -- Notes
  --
  PROCEDURE Check_Unique(
		X_rowid			VARCHAR2,
		X_name			VARCHAR2,
		l_err_code	IN OUT	NOCOPY VARCHAR2);
  ...
  --   07.10.96   C. Kawamoto   Created
  -- Example
  --   XTR_FORECAST_HEADERS_PKG.Insert_Row(...)
  -- Notes
  --
  ...
  --   07.10.96   C. Kawamoto   Created
  -- Example
  --   XTR_FORECAST_HEADERS_PKG.Lock_Row(...)
  -- Notes
  --
  ...
  --   07.10.96   C. Kawamoto   Created
  -- Example
  --   XTR_FORECAST_HEADERS_PKG.Update_Row(...)
  -- Notes
  --
  ...
  --   07.10.96   C. Kawamoto   Created
  -- Example
  --   XTR_FORECAST_HEADERS_PKG.Delete_Row(...)
  -- Notes
  --
PROCEDURE Delete_Row;
  ...
  --   07.10.96   C. Kawamoto   Created
  -- Example
  --   XTR_FORECAST_HEADERS_PKG.Delete_Forecasts(...)
  -- Notes
  --
PROCEDURE Delete_Forecasts;

END XTR_FORECAST_HEADERS_PKG;
