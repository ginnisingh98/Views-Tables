--------------------------------------------------------
--  DDL for Package BEN_LOU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LOU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_chg_oipl_enrt_rl_id           number(15),
  ...
  lou_attribute_category            varchar2(30),
  lou_attribute1                    varchar2(150),
  lou_attribute2                    varchar2(150),
  lou_attribute3                    varchar2(150),
  lou_attribute4                    varchar2(150),
  lou_attribute5                    varchar2(150),
  lou_attribute6                    varchar2(150),
  lou_attribute7                    varchar2(150),
  lou_attribute8                    varchar2(150),
  lou_attribute9                    varchar2(150),
  lou_attribute10                   varchar2(150),
  lou_attribute11                   varchar2(150),
  lou_attribute12                   varchar2(150),
  lou_attribute13                   varchar2(150),
  lou_attribute14                   varchar2(150),
  lou_attribute15                   varchar2(150),
  lou_attribute16                   varchar2(150),
  lou_attribute17                   varchar2(150),
  lou_attribute18                   varchar2(150),
  lou_attribute19                   varchar2(150),
  lou_attribute20                   varchar2(150),
  lou_attribute21                   varchar2(150),
  lou_attribute22                   varchar2(150),
  lou_attribute23                   varchar2(150),
  lou_attribute24                   varchar2(150),
  lou_attribute25                   varchar2(150),
  lou_attribute26                   varchar2(150),
  lou_attribute27                   varchar2(150),
  lou_attribute28                   varchar2(150),
  lou_attribute29                   varchar2(150),
  lou_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_chg_oipl_enrt_rl_id).
--
-- Post Success:
--   Processing continues.
--
