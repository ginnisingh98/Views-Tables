--------------------------------------------------------
--  DDL for Package BEN_PGI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PGI_UPD" AUTHID CURRENT_USER as
...
--   2) After the conversion has taken pgmace, the corresponding record upd
