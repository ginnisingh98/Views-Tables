--------------------------------------------------------
--  DDL for Package PQH_BVR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_BVR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  date_from                         date,
  date_to                           date,
  transfered_to_gl_flag             varchar2(30),
  gl_status                         varchar2(30),
  xfer_to_other_apps_cd             varchar2(30),
