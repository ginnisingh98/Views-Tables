--------------------------------------------------------
--  DDL for Package PQH_CRD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CRD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_criteria_rate_defn_id
--     already exists.
--
--  In Arguments:
