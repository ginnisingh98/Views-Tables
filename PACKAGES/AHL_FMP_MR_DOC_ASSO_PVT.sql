--------------------------------------------------------
--  DDL for Package AHL_FMP_MR_DOC_ASSO_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_FMP_MR_DOC_ASSO_PVT" AUTHID CURRENT_USER AS
/* $Header: AHLVMRDS.pls 120.0 2005/05/26 01:12:43 appldev noship $ */
...
-- Start of Comments
-- Procedure name              : Process_Doc_Association
-- Type                        : Private
-- Pre-reqs                    :
-- Function                    :
-- Parameters                  :
...
--	p_validate_only             VARCHAR2 Default  FND_API.G_TRUE
...
--	p_x_association_tbl        doc_association_tbl
--
