--------------------------------------------------------
--  DDL for Package OZF_CLAIMS_INT_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_CLAIMS_INT_PUB" AUTHID CURRENT_USER AS
/* $Header: ozfpcins.pls 120.0 2005/06/01 03:02:11 appldev noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
--          OZF_Claims_Int_PUB
...
TYPE  claims_int_tbl_type      IS TABLE OF claims_int_rec_type INDEX BY BINARY_INTEGER;
g_miss_claims_int_tbl          claims_int_tbl_type;

TYPE claims_int_sort_rec_type IS RECORD
(
...
--       p_claims_int_rec            IN   claims_int_rec_type  Required
--
--   OUT
