--------------------------------------------------------
--  DDL for Package BEN_PRY_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRY_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,apprvd_fr_pymt_num              number(15)
  ,adjmt_flag                      varchar2(30)
  ,aprvd_fr_pymt_amt               number
  ,pymt_stat_cd                    varchar2(30)
  ,pymt_stat_rsn_cd                varchar2(30)
  ,pymt_stat_ovrdn_rsn_cd          varchar2(30)
  ,pymt_stat_prr_to_ovrd_cd        varchar2(30)
  ,business_group_id               number(15)
  ,element_entry_value_id          number(15)
  ,pry_attribute_category          varchar2(30)
  ,pry_attribute1                  varchar2(150)
  ,pry_attribute2                  varchar2(150)
  ,pry_attribute3                  varchar2(150)
  ,pry_attribute4                  varchar2(150)
  ,pry_attribute5                  varchar2(150)
  ,pry_attribute6                  varchar2(150)
  ,pry_attribute7                  varchar2(150)
  ,pry_attribute8                  varchar2(150)
  ,pry_attribute9                  varchar2(150)
  ,pry_attribute10                 varchar2(150)
  ,pry_attribute11                 varchar2(150)
  ,pry_attribute12                 varchar2(150)
  ,pry_attribute13                 varchar2(150)
  ,pry_attribute14                 varchar2(150)
  ,pry_attribute15                 varchar2(150)
  ,pry_attribute16                 varchar2(150)
  ,pry_attribute17                 varchar2(150)
  ,pry_attribute18                 varchar2(150)
  ,pry_attribute19                 varchar2(150)
  ,pry_attribute20                 varchar2(150)
  ,pry_attribute21                 varchar2(150)
  ,pry_attribute22                 varchar2(150)
  ,pry_attribute23                 varchar2(150)
  ,pry_attribute24                 varchar2(150)
  ,pry_attribute25                 varchar2(150)
  ,pry_attribute26                 varchar2(150)
  ,pry_attribute27                 varchar2(150)
  ,pry_attribute28                 varchar2(150)
  ,pry_attribute29                 varchar2(150)
  ,pry_attribute30                 varchar2(150)
...
--           p_base_key_value = :prtt_rmt_aprvd_fr_pymt_id).
--
-- Post Success:
--   Processing continues.
--
