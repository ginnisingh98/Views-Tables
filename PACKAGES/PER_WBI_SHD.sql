--------------------------------------------------------
--  DDL for Package PER_WBI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_WBI_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,menu_id                         number(10)
  ,workbench_item_sequence         number(10)
  ,workbench_parent_item_code      varchar2(60)
  ,workbench_item_creation_date    date
  ,workbench_item_type             varchar2(60)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_RI_WORKBENCH_ITEMS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
