--------------------------------------------------------
--  DDL for Package BEN_CPY_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CPY_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  popl_yr_perd_id                   number(15),
  yr_perd_id                        number(15),
  business_group_id                 number(15),
  pl_id                             number(15),
  pgm_id                            number(15),
  ordr_num                          number(15),
  acpt_clm_rqsts_thru_dt            date,
  py_clms_thru_dt                   date,
  cpy_attribute_category            varchar2(30),
  cpy_attribute1                    varchar2(150),
  cpy_attribute2                    varchar2(150),
  cpy_attribute3                    varchar2(150),
  cpy_attribute4                    varchar2(150),
  cpy_attribute5                    varchar2(150),
  cpy_attribute6                    varchar2(150),
  cpy_attribute7                    varchar2(150),
  cpy_attribute8                    varchar2(150),
  cpy_attribute9                    varchar2(150),
  cpy_attribute10                   varchar2(150),
  cpy_attribute11                   varchar2(150),
  cpy_attribute12                   varchar2(150),
  cpy_attribute13                   varchar2(150),
  cpy_attribute14                   varchar2(150),
  cpy_attribute15                   varchar2(150),
  cpy_attribute16                   varchar2(150),
  cpy_attribute17                   varchar2(150),
  cpy_attribute18                   varchar2(150),
  cpy_attribute19                   varchar2(150),
  cpy_attribute20                   varchar2(150),
  cpy_attribute21                   varchar2(150),
  cpy_attribute22                   varchar2(150),
  cpy_attribute23                   varchar2(150),
  cpy_attribute24                   varchar2(150),
  cpy_attribute25                   varchar2(150),
  cpy_attribute26                   varchar2(150),
  cpy_attribute27                   varchar2(150),
  cpy_attribute28                   varchar2(150),
  cpy_attribute29                   varchar2(150),
  cpy_attribute30                   varchar2(150),
