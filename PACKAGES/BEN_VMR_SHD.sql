--------------------------------------------------------
--  DDL for Package BEN_VMR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_VMR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  vrbl_mtchg_rt_id                  number(15),
  effective_end_date                date,
  effective_start_date              date,
  no_mx_pct_of_py_num_flag          varchar2(30),
  to_pct_val                        number(15),
  no_mx_amt_of_py_num_flag          varchar2(30),
  mx_pct_of_py_num                  number(15),
  no_mx_mtch_amt_flag               varchar2(30),
  ordr_num                          number(15),
  pct_val                           number(15),
  mx_mtch_amt                       number,         --(15,2),
  mx_amt_of_py_num                  number(15,2),
  mn_mtch_amt                       number,         --(15,2),
  mtchg_rt_calc_rl                  number(15),
  cntnu_mtch_aftr_max_rl_flag       varchar2(30),
  from_pct_val                      number(15),
  vrbl_rt_prfl_id                   number(15),
  business_group_id                 number(15),
  vmr_attribute_category            varchar2(30),
  vmr_attribute1                    varchar2(150),
  vmr_attribute2                    varchar2(150),
  vmr_attribute3                    varchar2(150),
  vmr_attribute4                    varchar2(150),
  vmr_attribute5                    varchar2(150),
  vmr_attribute6                    varchar2(150),
  vmr_attribute7                    varchar2(150),
  vmr_attribute8                    varchar2(150),
  vmr_attribute9                    varchar2(150),
  vmr_attribute10                   varchar2(150),
  vmr_attribute11                   varchar2(150),
  vmr_attribute12                   varchar2(150),
  vmr_attribute13                   varchar2(150),
  vmr_attribute14                   varchar2(150),
  vmr_attribute15                   varchar2(150),
  vmr_attribute16                   varchar2(150),
  vmr_attribute17                   varchar2(150),
  vmr_attribute18                   varchar2(150),
  vmr_attribute19                   varchar2(150),
  vmr_attribute20                   varchar2(150),
  vmr_attribute21                   varchar2(150),
  vmr_attribute22                   varchar2(150),
  vmr_attribute23                   varchar2(150),
  vmr_attribute24                   varchar2(150),
  vmr_attribute25                   varchar2(150),
  vmr_attribute26                   varchar2(150),
  vmr_attribute27                   varchar2(150),
  vmr_attribute28                   varchar2(150),
  vmr_attribute29                   varchar2(150),
  vmr_attribute30                   varchar2(150),
...
--           p_base_key_value = :vrbl_mtchg_rt_id).
--
-- Post Success:
--   Processing continues.
--
