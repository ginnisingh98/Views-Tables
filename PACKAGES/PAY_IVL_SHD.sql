--------------------------------------------------------
--  DDL for Package PAY_IVL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_IVL_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_INPUT_VALUES_F';
...
--           p_base_key_value = :input_value_id).
--
-- Post Success:
--   Processing continues.
--
