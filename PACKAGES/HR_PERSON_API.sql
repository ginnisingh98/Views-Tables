--------------------------------------------------------
--  DDL for Package HR_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PERSON_API" AUTHID CURRENT_USER as
...
-- {Start Of Comments}
/*#
 * This API updates person information in a United Kingdom business group.
 *
 *
 * <p><b>Licensing</b><br>
 * This API is licensed for use with Human Resources.
 ...
 * @param p_paye_aggregate_assignment Indicates whether the assignments need to
 * be aggregated for PAYE purposes. Valid values are defined by the YES_NO
 * lookup type.
 * @param p_date_of_death Date of death.
 * @param p_background_check_status Flag indicating whether the person's
 * background has been checked.
 ...
 * @param p_orig_hire_warning If set to true, an orginal date of hire exists
 * for a person who has never been an employee.
 * @rep:displayname Update Person for United Kingdom
 * @rep:category BUSINESS_ENTITY HR_PERSON
 * @rep:category MISC_EXTENSIONS HR_DATAPUMP
 * @rep:scope public
 * @rep:lifecycle active
...
-- {Start Of Comments}
/*#
 * This API updates person information in a United States business group.
 *
 *
 * <p><b>Licensing</b><br>
 * This API is licensed for use with Human Resources.
 ...
 * @param p_orig_hire_warning If set to true, an orginal date of hire exists
 * for a person who has never been an employee.
 * @rep:displayname Update Person for United States
 * @rep:category BUSINESS_ENTITY HR_PERSON
 * @rep:category MISC_EXTENSIONS HR_DATAPUMP
 * @rep:scope public
 * @rep:lifecycle active
...
-- {Start Of Comments}
/*#
 * This API deletes the person and the associated person related records.
 *
 * This API deletes the person as identified by by p_person_id from HRMS
 * Applications.
 *
 * <p><b>Licensing</b><br>
 * This API is licensed for use with Human Resources.
 *
 * <p><b>Prerequisites</b><br>
 * The person, identified by p_person_id must already exist.
 *
 * <p><b>Post Success</b><br>
 * The API deletes the person and the associated person related records and
 * sets the following out parameters: p_person_org_manager_warning warning
 * message.
 *
 * <p><b>Post Failure</b><br>
 * The API does not delete the person and raises an error.
 *
 * @param p_validate If true, then validation alone will be performed and the
 * database will remain unchanged. If false and all validation checks pass,
 * then the database will be modified.
 ...
 * @param p_person_id Identifies the person record to be deleted.
 * @param p_perform_predel_validation When this parameter is set to TRUE, the
 * API performs a check to see if any data in addition to that set up by
 * default, e.g. data in per_all_people_f, per_all_assignments_f,
 * per_periods_of_service exists for the person. If no additional data exists,
 * then the API cascade deletes the person data. If any additional data exists
 * for this person in any non-HRMS tables, then this person will not be deleted
 * irrespective of whether only default data exists. When this parameter is set
 * to FALSE, the API cascade deletes all data held in HRMS tables for this
 * person, provided no additional data exists in any non-HRMS tables.
 * @param p_person_org_manager_warning If the person being deleted is an
 * organization manager, then a warning message will be returned otherwise no
 * value will be returned.
 * @rep:displayname Delete Person
 * @rep:category BUSINESS_ENTITY HR_PERSON
 * @rep:lifecycle active
 * @rep:category MISC_EXTENSIONS HR_USER_HOOKS
 * @rep:scope public
...
-- {End Of Comments}
--
procedure delete_person (p_validate        in boolean default false
                        ,p_effective_date  in date
                        ,p_person_id       in number
                        ,p_perform_predel_validation  in boolean default false
...
-- {Start Of Comments}
/*#
 * This API is specifically designed for iRecruitment users to merge
 * two iRec profiles(parties)
 *
 * <p><b>Licensing</b><br>
 * This API is licensed for use with Human Resources.
 *
 * <p><b>Prerequisites</b><br>
 * The parties, identified by p_target_party_id,p_source_party_id must already
 * exists.
 *
 * <p><b>Post Success</b><br>
 * The API copies applications from source party to target party and
 * terminate or purge the source records as per user requirement.
 *
 * <p><b>Post Failure</b><br>
 * The API does not merge the profiles.
 *
 * @param p_validate If true, then validation alone will be performed and the
 * database will remain unchanged. If false and all validation checks pass,
 * then the database will be modified.
 * @param p_target_party_id Target party id.
 * @param p_source_party_id Source party id.
 * @param p_term_or_purge_s If the value passed is 'TERM', then the persons
 * with source party_id gets terminated.If the value passed is 'PURGE', then
 * the persons with target party_id gets terminated.The default value
 * is null for this paramter.
 * @param p_create_new_application Wherever it is not possible to do a date-tracked
 * copy (for example, target party does not exists as of the application date
 * of the source), then it should create a new application based on the
 * parameter 'create-new-application Y or N'
 * @rep:displayname Merge Party
 * @rep:category BUSINESS_ENTITY HR_PERSON
 * @rep:lifecycle active
 * @rep:category MISC_EXTENSIONS HR_USER_HOOKS
 * @rep:scope public
