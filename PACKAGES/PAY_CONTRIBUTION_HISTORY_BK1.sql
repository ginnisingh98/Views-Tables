--------------------------------------------------------
--  DDL for Package PAY_CONTRIBUTION_HISTORY_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CONTRIBUTION_HISTORY_BK1" AUTHID CURRENT_USER as
/* $Header: pyconapi.pkh 115.1 99/09/30 13:47:38 porting ship  $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Contribution_History_b >-----------------|
-- ----------------------------------------------------------------------------
--
