--------------------------------------------------------
--  DDL for Package OZF_NA_DDN_RULE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_NA_DDN_RULE_PVT" AUTHID CURRENT_USER AS
/* $Header: ozfvdnrs.pls 120.1 2006/02/25 19:23:21 julou noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
--          OZF_Na_Ddn_Rule_PVT
...
g_miss_na_ddn_rule_rec          na_ddn_rule_rec_type := NULL;
TYPE  na_ddn_rule_tbl_type      IS TABLE OF na_ddn_rule_rec_type INDEX BY BINARY_INTEGER;
g_miss_na_ddn_rule_tbl          na_ddn_rule_tbl_type;
