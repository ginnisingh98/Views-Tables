--------------------------------------------------------
--  DDL for Package FA_FAS449_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_FAS449_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: FAS449S.pls 120.0.12010000.1 2008/07/28 13:14:53 appldev ship $ */
	P_BOOK	varchar2(15);
	P_PERIOD1	varchar2(15);
	P_CONC_REQUEST_ID	number;
	P_PERIOD2	varchar2(15);
	P_MIN_PRECISION	number;
	P_RET_TYPE	varchar2(40);
	P_RT_SHORT	varchar2(32767);
	P_RT_LONG	varchar2(32767);
	...
	function precisionformula(V_CURRENCY_CODE in varchar2) return number  ;
