--------------------------------------------------------
--  DDL for Package JERX_C_TO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JERX_C_TO" AUTHID CURRENT_USER AS
/* $Header: jegrctos.pls 115.2 2002/11/28 10:53:34 arimai ship $ */
...
PROCEDURE GET_TRNOVR_DATA(
  ...
  argument11        in  varchar2,   -- exclusion rule
  argument12        in  varchar2,   -- invoice amount lower limit
  argument13        in  varchar2,   -- Balance Type +ve / -ve
