--------------------------------------------------------
--  DDL for Package IRC_IPT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IPT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,benefit_info                    varchar2(32767)
  ,image_url                       varchar2(32767)
  ,image_url_alt                   varchar2(32767)
  );
--
Type g_clob_rec_type Is Record
  (posting_content_id              number(15)
  ,language                        varchar2(9)
  ,source_language                 varchar2(9)
  ,name                            varchar2(240)
  ,org_name                        varchar2(240)
  ,org_description                 clob
  ,job_title                       varchar2(240)
...
g_clob_old_rec  g_clob_rec_type;                  -- Global record definition
g_tab_name constant varchar2(30) := 'IRC_POSTING_CONTENTS_TL';
--
...
g_benefit_info_upd boolean default false;
