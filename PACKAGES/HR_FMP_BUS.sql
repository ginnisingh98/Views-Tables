--------------------------------------------------------
--  DDL for Package HR_FMP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FMP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_form_property_id already exists.
--
--  In Arguments:
--    p_form_property_id
--
