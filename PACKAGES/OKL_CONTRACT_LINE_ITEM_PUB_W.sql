--------------------------------------------------------
--  DDL for Package OKL_CONTRACT_LINE_ITEM_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_CONTRACT_LINE_ITEM_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUCLIS.pls 115.2 2003/10/16 01:15:03 smereddy noship $ */
