--------------------------------------------------------
--  DDL for Package BEN_XWC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XWC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_ext_where_clause_id
--     already exists.
--
--  In Arguments:
...
--
--  Prerequisites:
--    The primary key identified by p_ext_where_clause_id already exists.
--
--  In Arguments:
--    p_ext_where_clause_id
--
...
function return_legislation_code
  (p_ext_where_clause_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
