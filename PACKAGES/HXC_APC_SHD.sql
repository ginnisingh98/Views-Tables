--------------------------------------------------------
--  DDL for Package HXC_APC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_APC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (approval_period_comp_id         number(15)
  ,time_recipient_id               number(15)
  ,recurring_period_id             number(15)
  ,approval_period_set_id          number(15)
