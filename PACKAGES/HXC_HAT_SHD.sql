--------------------------------------------------------
--  DDL for Package HXC_HAT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_HAT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,alias_type                      varchar2(30)
  ,reference_object                varchar2(150)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HXC_ALIAS_TYPES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
