--------------------------------------------------------
--  DDL for Package BEN_BVR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BVR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  bnft_vrbl_rt_id                   number(15),
  effective_start_date              date,
  effective_end_date                date,
  cvg_amt_calc_mthd_id              number(15),
  vrbl_rt_prfl_id                   number(15),
  business_group_id                 number(15),
  bvr_attribute_category            varchar2(30),
  bvr_attribute1                    varchar2(150),
  bvr_attribute2                    varchar2(150),
  bvr_attribute3                    varchar2(150),
  bvr_attribute4                    varchar2(150),
  bvr_attribute5                    varchar2(150),
  bvr_attribute6                    varchar2(150),
  bvr_attribute7                    varchar2(150),
  bvr_attribute8                    varchar2(150),
  bvr_attribute9                    varchar2(150),
  bvr_attribute10                   varchar2(150),
  bvr_attribute11                   varchar2(150),
  bvr_attribute12                   varchar2(150),
  bvr_attribute13                   varchar2(150),
  bvr_attribute14                   varchar2(150),
  bvr_attribute15                   varchar2(150),
  bvr_attribute16                   varchar2(150),
  bvr_attribute17                   varchar2(150),
  bvr_attribute18                   varchar2(150),
  bvr_attribute19                   varchar2(150),
  bvr_attribute20                   varchar2(150),
  bvr_attribute21                   varchar2(150),
  bvr_attribute22                   varchar2(150),
  bvr_attribute23                   varchar2(150),
  bvr_attribute24                   varchar2(150),
  bvr_attribute25                   varchar2(150),
  bvr_attribute26                   varchar2(150),
  bvr_attribute27                   varchar2(150),
  bvr_attribute28                   varchar2(150),
  bvr_attribute29                   varchar2(150),
  bvr_attribute30                   varchar2(150),
...
--           p_base_key_value = :bnft_vrbl_rt_id).
--
-- Post Success:
--   Processing continues.
--
