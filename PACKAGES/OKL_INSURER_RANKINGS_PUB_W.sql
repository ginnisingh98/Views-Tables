--------------------------------------------------------
--  DDL for Package OKL_INSURER_RANKINGS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_INSURER_RANKINGS_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLOIRKS.pls 120.1 2005/07/14 12:01:24 asawanka noship $ */
