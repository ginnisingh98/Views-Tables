--------------------------------------------------------
--  DDL for Package AHL_FMP_MR_RELATION_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_FMP_MR_RELATION_PVT_W" AUTHID CURRENT_USER as
  /* $Header: AHLWMRLS.pls 120.0 2005/05/26 00:00:11 appldev noship $ */
