--------------------------------------------------------
--  DDL for Package OPI_EDW_UOM_CONV_F_SZ
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OPI_EDW_UOM_CONV_F_SZ" AUTHID CURRENT_USER AS
/* $Header: OPIOUCZS.pls 120.2 2005/06/16 03:52:40 appldev  $*/
