--------------------------------------------------------
--  DDL for Package ARP_MUL_EXEMPT_COV
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARP_MUL_EXEMPT_COV" AUTHID CURRENT_USER as
/* $Header: ARXEMECS.pls 120.1 2002/11/15 04:15:58 anukumar ship $ */

/* Purpose: This package contains the cover routines used to create Multiple */
/*	    tax rate exceptions. The routines are called from the 10SC form */
/*	    RAXSTDTE(Item Tax Rate Exceptions)	*/
...
/*----------------------------------------------------------------------------*
 ...
 |    09-Mar-99  Nilesh Patel - added parameters exempt_context and exempt    |
 |                              percent1-10 in procedure exemptions for       |
 |                              Descriptive Flexfield AR_VDR_EXEMPT_RATES     |
 *----------------------------------------------------------------------------*/
