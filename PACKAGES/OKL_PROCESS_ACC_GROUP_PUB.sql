--------------------------------------------------------
--  DDL for Package OKL_PROCESS_ACC_GROUP_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_PROCESS_ACC_GROUP_PUB" AUTHID CURRENT_USER AS
/* $Header: OKLPAGGS.pls 115.3 2002/02/18 20:11:53 pkm ship       $  */



  SUBTYPE agcv_rec_type IS okl_process_acc_group_pvt.agcv_rec_type;

  SUBTYPE agcv_tbl_type IS okl_process_acc_group_pvt.agcv_tbl_type;



  SUBTYPE agbv_rec_type IS okl_process_acc_group_pvt.agbv_rec_type;

  SUBTYPE agbv_tbl_type IS okl_process_acc_group_pvt.agbv_tbl_type;
  ...
  G_PKG_NAME                     CONSTANT VARCHAR2(200) := 'OKL_PROCESS_ACC_GROUP_PUB';
