--------------------------------------------------------
--  DDL for Package PAY_GRR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_GRR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  grade_rule_id                     number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  rate_id                           number(15),
  grade_or_spinal_point_id          number(15),
  rate_type                         varchar2(30),
  maximum                           varchar2(20),
  mid_value                         varchar2(20),
  minimum                           varchar2(20),
  sequence                          number(15),
  value                             varchar2(20),
...
--           p_base_key_value = :grade_rule_id).
--
-- Post Success:
--   Processing continues.
--
...
--   UPDATE_OVERRIDE, DELETE, FUTURE_CHANGES and DELETE_NEXT_CHANGE.
