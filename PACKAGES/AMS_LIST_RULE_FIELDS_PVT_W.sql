--------------------------------------------------------
--  DDL for Package AMS_LIST_RULE_FIELDS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_LIST_RULE_FIELDS_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswrufs.pls 115.8 2002/11/22 08:57:53 jieli ship $ */
