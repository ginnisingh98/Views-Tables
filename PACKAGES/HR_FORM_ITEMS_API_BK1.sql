--------------------------------------------------------
--  DDL for Package HR_FORM_ITEMS_API_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FORM_ITEMS_API_BK1" AUTHID CURRENT_USER as
...
--,p_form_item_property_id       in number
  ,p_object_version_number       in number
  ,p_override_value_warning      in boolean
  );
--
end hr_form_items_api_bk1;
