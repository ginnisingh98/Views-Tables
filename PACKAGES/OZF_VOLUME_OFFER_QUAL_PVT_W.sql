--------------------------------------------------------
--  DDL for Package OZF_VOLUME_OFFER_QUAL_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_VOLUME_OFFER_QUAL_PVT_W" AUTHID CURRENT_USER as
  /* $Header: ozfwvoqs.pls 120.1 2006/07/24 21:07:50 rssharma noship $ */
