--------------------------------------------------------
--  DDL for Package PQH_TEM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TEM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  attribute_only_flag               varchar2(10),
  enable_flag                       varchar2(10),
  create_flag                       varchar2(10),
  transaction_category_id           number(15),
  under_review_flag                 varchar2(10),
  object_version_number             number(9),
  freeze_status_cd                  varchar2(30),
  template_type_cd                  varchar2(30),
