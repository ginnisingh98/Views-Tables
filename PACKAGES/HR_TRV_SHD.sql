--------------------------------------------------------
--  DDL for Package HR_TRV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TRV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  transaction_value_id              number(15),
  ...
  number_value                      number,
  date_value                        date,
  original_varchar2_value           varchar2(2000),
  original_number_value             number,
