--------------------------------------------------------
--  DDL for Package BEN_CMD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CMD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cm_dlvry_med_typ_id already exists.
--
--  In Arguments:
...
function return_legislation_code
  (p_cm_dlvry_med_typ_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
