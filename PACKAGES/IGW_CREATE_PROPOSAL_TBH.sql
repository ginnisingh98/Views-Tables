--------------------------------------------------------
--  DDL for Package IGW_CREATE_PROPOSAL_TBH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGW_CREATE_PROPOSAL_TBH" AUTHID CURRENT_USER as
--$Header: igwtcprs.pls 115.3 2002/11/14 18:44:03 vmedikon ship $
