--------------------------------------------------------
--  DDL for Package HR_DEPLOYMENT_FACTOR_BK5
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_DEPLOYMENT_FACTOR_BK5" AUTHID CURRENT_USER as
/* $Header: pedpfapi.pkh 120.1 2005/10/02 02:15:01 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |----------------------< create_job_dpmt_factor_b >------------------------|
-- ----------------------------------------------------------------------------
--
procedure create_job_dpmt_factor_b
...
--
-- ----------------------------------------------------------------------------
-- |-----------------------< create_job_dpmt_factor_a >-----------------------|
-- ----------------------------------------------------------------------------
--
procedure create_job_dpmt_factor_a
  (p_effective_date               in     date
  ,p_job_id                       in     number
  ,p_business_group_id            in     number
  ,p_work_any_country             in     varchar2
