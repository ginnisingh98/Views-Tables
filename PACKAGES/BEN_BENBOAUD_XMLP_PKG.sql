--------------------------------------------------------
--  DDL for Package BEN_BENBOAUD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BENBOAUD_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: BENBOAUDS.pls 120.1 2007/12/10 08:24:28 vjaganat noship $ */
	...
	CP_POSTAL_ZIP_RANGE	varchar2(240);
	...
	CP_TO_OCRD_DT	date;
	CP_RESULTING_STATUS	varchar2(20);
