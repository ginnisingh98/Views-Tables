--------------------------------------------------------
--  DDL for Package OZF_CLAIM_LINES_INT_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_CLAIM_LINES_INT_PUB" AUTHID CURRENT_USER AS
/* $Header: ozfpclis.pls 120.0 2005/06/01 02:53:09 appldev noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
--          OZF_Claim_Lines_Int_PUB
-- Purpose
--
-- History
--
...
TYPE claim_lines_int_sort_rec_type IS RECORD
(
