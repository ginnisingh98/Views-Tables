--------------------------------------------------------
--  DDL for Package CS_CONTRACTTYPE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CS_CONTRACTTYPE_PVT" AUTHID CURRENT_USER AS
/* $Header: csctctys.pls 115.0 99/07/16 08:51:54 porting ship  $ */
  ---------------------------------------------------------------------------
  -- GLOBAL DATASTRUCTURES
  ---------------------------------------------------------------------------
  TYPE ContractType_Rec_Type IS RECORD (
    contract_type_id               NUMBER := NULL,
    name                           CS_CONTRACT_TYPES.NAME%TYPE := NULL,
    description                    CS_CONTRACT_TYPES.DESCRIPTION%TYPE := NULL,
    cust_trx_type_id               NUMBER := NULL,
    last_update_date               CS_CONTRACT_TYPES.LAST_UPDATE_DATE%TYPE := NULL,
    last_updated_by                NUMBER := NULL,
    creation_date                  CS_CONTRACT_TYPES.CREATION_DATE%TYPE := NULL,
    created_by                     NUMBER := NULL,
    last_update_login              NUMBER := NULL,
    start_date_active              CS_CONTRACT_TYPES.START_DATE_ACTIVE%TYPE := NULL,
    end_date_active                CS_CONTRACT_TYPES.END_DATE_ACTIVE%TYPE := NULL,
    attribute1                     CS_CONTRACT_TYPES.ATTRIBUTE1%TYPE := NULL,
    attribute2                     CS_CONTRACT_TYPES.ATTRIBUTE2%TYPE := NULL,
    attribute3                     CS_CONTRACT_TYPES.ATTRIBUTE3%TYPE := NULL,
    attribute4                     CS_CONTRACT_TYPES.ATTRIBUTE4%TYPE := NULL,
    attribute5                     CS_CONTRACT_TYPES.ATTRIBUTE5%TYPE := NULL,
    attribute6                     CS_CONTRACT_TYPES.ATTRIBUTE6%TYPE := NULL,
    attribute7                     CS_CONTRACT_TYPES.ATTRIBUTE7%TYPE := NULL,
    attribute8                     CS_CONTRACT_TYPES.ATTRIBUTE8%TYPE := NULL,
    attribute9                     CS_CONTRACT_TYPES.ATTRIBUTE9%TYPE := NULL,
    attribute10                    CS_CONTRACT_TYPES.ATTRIBUTE10%TYPE := NULL,
    attribute11                    CS_CONTRACT_TYPES.ATTRIBUTE11%TYPE := NULL,
    attribute12                    CS_CONTRACT_TYPES.ATTRIBUTE12%TYPE := NULL,
    attribute13                    CS_CONTRACT_TYPES.ATTRIBUTE13%TYPE := NULL,
    attribute14                    CS_CONTRACT_TYPES.ATTRIBUTE14%TYPE := NULL,
    attribute15                    CS_CONTRACT_TYPES.ATTRIBUTE15%TYPE := NULL,
    context                        CS_CONTRACT_TYPES.CONTEXT%TYPE := NULL,
    object_version_number          NUMBER := NULL);
  G_MISS_contracttype_rec                 ContractType_Rec_Type;
  TYPE ContractType_Val_Rec_Type IS RECORD (
    contract_type_id               NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    name                           CS_CONTRACT_TYPES.NAME%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    description                    CS_CONTRACT_TYPES.DESCRIPTION%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    cust_trx_type_id               NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    last_update_date               CS_CONTRACT_TYPES.LAST_UPDATE_DATE%TYPE := TAPI_DEV_KIT.G_MISS_DATE,
    last_updated_by                NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    creation_date                  CS_CONTRACT_TYPES.CREATION_DATE%TYPE := TAPI_DEV_KIT.G_MISS_DATE,
    created_by                     NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    last_update_login              NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    start_date_active              CS_CONTRACT_TYPES.START_DATE_ACTIVE%TYPE := TAPI_DEV_KIT.G_MISS_DATE,
    end_date_active                CS_CONTRACT_TYPES.END_DATE_ACTIVE%TYPE := TAPI_DEV_KIT.G_MISS_DATE,
    attribute1                     CS_CONTRACT_TYPES.ATTRIBUTE1%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute2                     CS_CONTRACT_TYPES.ATTRIBUTE2%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute3                     CS_CONTRACT_TYPES.ATTRIBUTE3%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute4                     CS_CONTRACT_TYPES.ATTRIBUTE4%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute5                     CS_CONTRACT_TYPES.ATTRIBUTE5%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute6                     CS_CONTRACT_TYPES.ATTRIBUTE6%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute7                     CS_CONTRACT_TYPES.ATTRIBUTE7%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute8                     CS_CONTRACT_TYPES.ATTRIBUTE8%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute9                     CS_CONTRACT_TYPES.ATTRIBUTE9%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute10                    CS_CONTRACT_TYPES.ATTRIBUTE10%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute11                    CS_CONTRACT_TYPES.ATTRIBUTE11%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute12                    CS_CONTRACT_TYPES.ATTRIBUTE12%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute13                    CS_CONTRACT_TYPES.ATTRIBUTE13%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute14                    CS_CONTRACT_TYPES.ATTRIBUTE14%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute15                    CS_CONTRACT_TYPES.ATTRIBUTE15%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    context                        CS_CONTRACT_TYPES.CONTEXT%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    object_version_number          NUMBER := TAPI_DEV_KIT.G_MISS_NUM);
  G_MISS_contracttype_val_rec             ContractType_Val_Rec_Type;
  ---------------------------------------------------------------------------
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME			CONSTANT	VARCHAR2(200) := 'CS_CONTRACTTYPE_PVT';
