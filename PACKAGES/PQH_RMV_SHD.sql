--------------------------------------------------------
--  DDL for Package PQH_RMV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RMV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (node_value_id                   number(15)
  ,rate_matrix_node_id             number(15)
  ...
  ,number_value3                   number(15)
  ,number_value4                   number(15)
  ,date_value1                     date
  ,date_value2                     date
  ,date_value3                     date
  ,date_value4                     date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_RT_MATRIX_NODE_VALUES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
