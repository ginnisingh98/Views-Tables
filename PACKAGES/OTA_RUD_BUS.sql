--------------------------------------------------------
--  DDL for Package OTA_RUD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_RUD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_resource_usage_id
--     already exists.
--
--  In Arguments:
--    p_resource_usage_id
