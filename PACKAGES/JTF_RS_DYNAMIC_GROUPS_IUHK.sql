--------------------------------------------------------
--  DDL for Package JTF_RS_DYNAMIC_GROUPS_IUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_RS_DYNAMIC_GROUPS_IUHK" AUTHID CURRENT_USER AS
 /* $Header: jtfrsnys.pls 120.0 2005/05/11 08:21:01 appldev ship $ */
