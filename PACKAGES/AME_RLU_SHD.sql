--------------------------------------------------------
--  DDL for Package AME_RLU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_RLU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (item_id                         number
  ,usage_type                      varchar2(9)       -- Increased length
  ,rule_id                         number
  ,start_date                      date
  ,end_date                        date
  ,security_group_id               number(15)
  ,priority                        number(38)
  ,approver_category               varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_RULE_USAGES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
