--------------------------------------------------------
--  DDL for Package BEN_CWB_BDGT_IMPORT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CWB_BDGT_IMPORT_PKG" AUTHID CURRENT_USER as
/* $Header: bencwbbsim.pkh 120.0 2005/05/28 12:47 appldev noship $ */
