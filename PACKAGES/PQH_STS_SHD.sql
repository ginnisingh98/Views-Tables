--------------------------------------------------------
--  DDL for Package PQH_STS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_STS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (statutory_situation_id          number(15)
  ,business_group_id               number(15)
  ,situation_name                  varchar2(240)
  ,type_of_ps                      varchar2(30)
  ,situation_type                  varchar2(30)
  ...
  ,employee_agreement_needed       varchar2(10)
  ,manager_agreement_needed        varchar2(10)
  ,print_arrette                   varchar2(10)
  ,reserve_position                varchar2(10)
  ,allow_progressions              varchar2(10)
  ,extend_probation_period         varchar2(10)
  ,remuneration_paid               varchar2(10)
  ,pay_share                       number
  ,pay_periods                     number
  ,frequency                       varchar2(30)
  ,first_period_max_duration       number
  ,min_duration_per_request        number
  ,max_duration_per_request        number
  ,max_duration_whole_career       number
  ,renewable_allowed               varchar2(10)
  ,max_no_of_renewals              number
  ,max_duration_per_renewal        number
  ,max_tot_continuous_duration     number
  ,object_version_number           number(9)
  ,remunerate_assign_status_id     number(9)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_FR_STAT_SITUATIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
