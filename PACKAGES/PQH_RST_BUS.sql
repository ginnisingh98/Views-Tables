--------------------------------------------------------
--  DDL for Package PQH_RST_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RST_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_rule_set_id already exists.
--
--  In Arguments:
--    p_rule_set_id
--
...
function return_legislation_code
  (p_rule_set_id in number) return varchar2;
--
--
--
-- Declaration for procedures which are called from forms also
--
