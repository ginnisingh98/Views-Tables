--------------------------------------------------------
--  DDL for Package BEN_XCL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XCL_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_ext_chg_evt_log_id already exists.
--
--  In Arguments:
...
function return_legislation_code
  (p_ext_chg_evt_log_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
