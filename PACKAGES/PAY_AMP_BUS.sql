--------------------------------------------------------
--  DDL for Package PAY_AMP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_AMP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_module_parameter_id
--     already exists.
--
--  In Arguments:
