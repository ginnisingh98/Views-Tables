--------------------------------------------------------
--  DDL for Package PAY_PPM_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PPM_DEL" AUTHID CURRENT_USER as
...
--   1) Delete mode is DELETE and related rows exist in PAY_PRE_PAYMENTS
--      for PAY_PAYROLL_ACTION effective dates that are effective beyond
--      the session effective date
--   2) Delete mode is ZAP and related rows exist in PAY_PRE_PAYMENTS
--
-- Developer Implementation Notes:
--   None.
--
