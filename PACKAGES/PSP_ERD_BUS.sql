--------------------------------------------------------
--  DDL for Package PSP_ERD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_ERD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_effort_report_detail_id
--     already exists.
--
--  In Arguments:
