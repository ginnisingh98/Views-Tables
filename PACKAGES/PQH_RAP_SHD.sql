--------------------------------------------------------
--  DDL for Package PQH_RAP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RAP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (rank_process_approval_id        number(15)
  ,rank_process_id                 number(15)
  ,approval_date                   date
  ,supervisor_id                   number(15)
  ,system_rank                     number(15)
  ,population_count                number(15)
  ,proposed_rank                   number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_RANK_PROCESS_APPROVALS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
