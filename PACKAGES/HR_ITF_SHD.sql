--------------------------------------------------------
--  DDL for Package HR_ITF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_ITF_SHD" AUTHID CURRENT_USER as
/* $Header: hritfrhi.pkh 120.0 2005/05/31 00:58:23 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  ...
  ,user_interface_key              varchar2(150)
  ,type                            varchar2(30)
  ,form_name                       varchar2(30)
  ,page_region_code                varchar2(490)
  ,region_code                     varchar2(60)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_KI_USER_INTERFACES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
