--------------------------------------------------------
--  DDL for Package OKC_ACTIONS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_ACTIONS_PUB" AUTHID CURRENT_USER AS
/* $Header: OKCPACNS.pls 120.0 2005/05/25 22:49:16 appldev noship $ */
...
/***********************  HAND-CODED  ***************************************/
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME	               CONSTANT VARCHAR2(200) := 'OKC_ACTIONS_PUB';
  G_APP_NAME	               CONSTANT VARCHAR2(3)   :=  OKC_API.G_APP_NAME;

  g_acnv_rec                   acnv_rec_type;
  g_aaev_rec                   aaev_rec_type;
  ---------------------------------------------------------------------------
