--------------------------------------------------------
--  DDL for Package PQH_WST_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_WST_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  worksheet_budget_set_id           number(15),
  dflt_budget_set_id                number(15),
