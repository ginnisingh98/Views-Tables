--------------------------------------------------------
--  DDL for Package BEN_PRY_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRY_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_prtt_rmt_aprvd_fr_pymt_id
--     already exists.
--
--  In Arguments:
