--------------------------------------------------------
--  DDL for Package BEN_APC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_APC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  mn_cvg_alwd_amt                   number,
  pgm_id                            number,
  business_group_id                 number(15),
  apc_attribute_category            varchar2(30),
  apc_attribute1                    varchar2(150),
  apc_attribute2                    varchar2(150),
  apc_attribute3                    varchar2(150),
  apc_attribute4                    varchar2(150),
  apc_attribute5                    varchar2(150),
  apc_attribute6                    varchar2(150),
  apc_attribute7                    varchar2(150),
  apc_attribute8                    varchar2(150),
  apc_attribute9                    varchar2(150),
  apc_attribute10                   varchar2(150),
  apc_attribute11                   varchar2(150),
  apc_attribute12                   varchar2(150),
  apc_attribute13                   varchar2(150),
  apc_attribute14                   varchar2(150),
  apc_attribute15                   varchar2(150),
  apc_attribute16                   varchar2(150),
  apc_attribute17                   varchar2(150),
  apc_attribute18                   varchar2(150),
  apc_attribute19                   varchar2(150),
  apc_attribute20                   varchar2(150),
  apc_attribute21                   varchar2(150),
  apc_attribute22                   varchar2(150),
  apc_attribute23                   varchar2(150),
  apc_attribute24                   varchar2(150),
  apc_attribute25                   varchar2(150),
  apc_attribute26                   varchar2(150),
  apc_attribute27                   varchar2(150),
  apc_attribute28                   varchar2(150),
  apc_attribute29                   varchar2(150),
  apc_attribute30                   varchar2(150),
...
--           p_base_key_value = :acrs_ptip_cvg_id).
--
-- Post Success:
--   Processing continues.
--
