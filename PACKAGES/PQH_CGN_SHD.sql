--------------------------------------------------------
--  DDL for Package PQH_CGN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CGN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (case_group_id                   number(15)
  ,case_group_number               varchar2(30)
  ,description                     varchar2(500)
  ,advanced_pay_grade              number(15)
  ,entries_in_minute               varchar2(1400)
  ,period_of_prob_advmnt           number(10)
  ,period_of_time_advmnt           number(10)
  ,advancement_to                  number(15)
  ,object_version_number           number(9)
  ,advancement_additional_pyt      number(10)
  ,time_advanced_pay_grade         number(15)
  ,time_advancement_to             number(15)
  ,business_group_id               number(15)
  ,time_advn_units                 varchar2(30)
  ,prob_advn_units                 varchar2(30)
  ,sub_csgrp_description           varchar2(500)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_CASE_GROUPS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
