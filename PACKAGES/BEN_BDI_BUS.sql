--------------------------------------------------------
--  DDL for Package BEN_BDI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BDI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_batch_dpnt_id already exists.
--
--  In Arguments:
--    p_batch_dpnt_id
--
...
function return_legislation_code
  (p_batch_dpnt_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
