--------------------------------------------------------
--  DDL for Package OTA_TPM_API_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TPM_API_BK1" AUTHID CURRENT_USER as
/* $Header: ottpmapi.pkh 120.1 2005/10/02 02:08:35 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_plan_member_b >-------------------------|
-- ----------------------------------------------------------------------------
procedure create_training_plan_member_b
...
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_training_plan_member_a >--------------------------|
-- ----------------------------------------------------------------------------
--
procedure create_training_plan_member_a
  (p_effective_date                in     date
  ,p_business_group_id             in     number
  ,p_training_plan_id              in     number
  ,p_activity_version_id           in     number
