--------------------------------------------------------
--  DDL for Package PQH_CRF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CRF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_criteria_rate_factor_id
--     already exists.
--
--  In Arguments:
