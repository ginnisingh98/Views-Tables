--------------------------------------------------------
--  DDL for Package PER_PGT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PGT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (hier_node_type_id               number(15)
  ,business_group_id               number(15)
  ,hierarchy_type                  varchar2(30)
  ,parent_node_type                varchar2(30)
  ,child_node_type                 varchar2(30)
  ,child_value_set                 varchar2(60)
  ,object_version_number           number(9)
  ,identifier_key                  varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_GEN_HIER_NODE_TYPES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
