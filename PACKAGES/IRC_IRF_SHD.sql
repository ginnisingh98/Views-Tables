--------------------------------------------------------
--  DDL for Package IRC_IRF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IRF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ( referral_info_id            number(15)
   ...
   ,source_criteria1            varchar2(30)
   ,source_value1            	varchar2(320)
   ,source_criteria2            varchar2(30)
   ,source_value2            	varchar2(320)
   ,source_criteria3            varchar2(30)
   ,source_value3               varchar2(320)
   ,source_criteria4            varchar2(30)
   ,source_value4               varchar2(320)
   ,source_criteria5            varchar2(30)
   ,source_value5               varchar2(320)
   ,source_person_id            number(15)
   ,candidate_comment           varchar2(4000)
   ,employee_comment            varchar2(4000)
   ,irf_attribute_category      varchar2(30)
   ,irf_attribute1              varchar2(150)
   ,irf_attribute2              varchar2(150)
   ,irf_attribute3              varchar2(150)
   ,irf_attribute4              varchar2(150)
   ,irf_attribute5              varchar2(150)
   ,irf_attribute6              varchar2(150)
   ,irf_attribute7              varchar2(150)
   ,irf_attribute8              varchar2(150)
   ,irf_attribute9              varchar2(150)
   ,irf_attribute10             varchar2(150)
   ,irf_information_category    varchar2(30)
   ,irf_information1            varchar2(150)
   ,irf_information2            varchar2(150)
   ,irf_information3            varchar2(150)
   ,irf_information4            varchar2(150)
   ,irf_information5            varchar2(150)
   ,irf_information6            varchar2(150)
   ,irf_information7            varchar2(150)
   ,irf_information8            varchar2(150)
   ,irf_information9            varchar2(150)
   ,irf_information10           varchar2(150)
   ,object_created_by           varchar2(30)
...
-- Global table name
g_tab_name  constant varchar2(30) := 'IRC_REFERRAL_INFO';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--
-- Description:
--   This function is used to get the next object version number to be used
--   within datetrack for an insert or update dml operation. The returned
--   object version number will be determined by taking the maximum
--   object version number for the datetracked rows and then incrementing by 1.
--
--
-- Prerequisites:
--   This is a private function and can only be called from the ins or upd
