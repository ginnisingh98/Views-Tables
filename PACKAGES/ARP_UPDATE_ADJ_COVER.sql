--------------------------------------------------------
--  DDL for Package ARP_UPDATE_ADJ_COVER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARP_UPDATE_ADJ_COVER" AUTHID CURRENT_USER AS
/* $Header: ARTADJUS.pls 115.1 99/07/17 00:13:28 porting ship $ */
