--------------------------------------------------------
--  DDL for Package AMV_CHANNEL_GRP_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMV_CHANNEL_GRP_W" AUTHID CURRENT_USER as
  /* $Header: amvwchgs.pls 120.2 2005/06/30 07:51 appldev ship $ */
