--------------------------------------------------------
--  DDL for Package BEN_MATCHING_RATES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_MATCHING_RATES_BK1" AUTHID CURRENT_USER as
/* $Header: bemtrapi.pkh 120.0 2005/05/28 03:39:53 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_MATCHING_RATES_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_MATCHING_RATES_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_MATCHING_RATES_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_MATCHING_RATES_a
  (
