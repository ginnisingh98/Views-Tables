--------------------------------------------------------
--  DDL for Package HXC_TKGQ_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_TKGQ_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,tk_group_id                 number(15)
  ,group_query_name            varchar2(80)
  ,include_exclude             varchar2(1)
  ,system_user                 varchar2(1)
