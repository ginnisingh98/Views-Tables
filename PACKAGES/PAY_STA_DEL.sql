--------------------------------------------------------
--  DDL for Package PAY_STA_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_STA_DEL" AUTHID CURRENT_USER as
...
--   p_delete_routine
--     Identifies if delete is the result of an assignment delete.
--
-- Post Success:
...
Procedure del
  ...
  p_effective_date      in            date,
  p_datetrack_mode      in            varchar2,
  p_delete_routine      in            varchar2   default null --#2364468
  );
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< del >----------------------------------|
