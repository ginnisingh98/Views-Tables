--------------------------------------------------------
--  DDL for Package AME_ITU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_ITU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,item_id_query                   varchar2(4000)
  ,item_class_order_number         number(15)
  ,item_class_par_mode             varchar2(9)       -- Increased length
  ,item_class_sublist_mode         varchar2(9)       -- Increased length
  ,start_date                      date
  ,end_date                        date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_ITEM_CLASS_USAGES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :item_class_id).
--
-- Post Success:
