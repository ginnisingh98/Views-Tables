--------------------------------------------------------
--  DDL for Package ASO_PROJ_COMM_INT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ASO_PROJ_COMM_INT" AUTHID CURRENT_USER AS
/* $Header: asoipqcs.pls 120.1 2005/06/29 12:34:47 appldev ship $ */
