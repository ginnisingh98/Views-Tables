--------------------------------------------------------
--  DDL for Package IRC_CMR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_CMR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (communication_recipient_id      number(15)
  ,communication_object_type       varchar2(50)
  ,communication_object_id         number(15)
  ,recipient_type                  varchar2(50)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_COMM_RECIPIENTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
