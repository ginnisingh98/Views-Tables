--------------------------------------------------------
--  DDL for Package HR_ITP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_ITP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (item_property_id                number(15)
  ,object_version_number           number(9)
  ,form_item_id                    number(15)
  ,template_item_id                number(15)
  ,template_item_context_id        number(15)
  ,alignment                       number(10)
  ,bevel                           number(10)
  ,case_restriction                number(10)
  ,enabled                         number(10)
  ,format_mask                     varchar2(80)
  ,height                          number(12,2)
  ,information_formula_id          number(15)
  ,information_parameter_item_id1  number(15)
  ,information_parameter_item_id2  number(15)
  ,information_parameter_item_id3  number(15)
  ,information_parameter_item_id4  number(15)
  ,information_parameter_item_id5  number(15)
  ,insert_allowed                  number(10)
  ,prompt_alignment_offset         number(12,2)
  ,prompt_display_style            number(10)
  ,prompt_edge                     number(10)
  ,prompt_edge_alignment           number(10)
  ,prompt_edge_offset              number(12,2)
  ,prompt_text_alignment           number(10)
  ,query_allowed                   number(10)
  ,required                        number(10)
  ,update_allowed                  number(10)
  ,validation_formula_id           number(15)
  ,validation_parameter_item_id1   number(15)
  ,validation_parameter_item_id2   number(15)
  ,validation_parameter_item_id3   number(15)
  ,validation_parameter_item_id4   number(15)
  ,validation_parameter_item_id5   number(15)
  ,visible                         number(10)
  ,width                           number(12,2)
  ,x_position                      number(12,2)
  ,y_position                      number(12,2)
  ,information_category            varchar2(150)
  ...
  ,next_navigation_item_id         number(15)
  ,previous_navigation_item_id     number(15)
  );
--
-- ----------------------------------------------------------------------------
