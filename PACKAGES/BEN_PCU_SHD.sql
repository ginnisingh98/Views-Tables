--------------------------------------------------------
--  DDL for Package BEN_PCU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PCU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  per_cm_usg_id                     number(15),
  effective_start_date              date,
  effective_end_date                date,
  per_cm_id                         number(15),
  cm_typ_usg_id                     number(15),
  business_group_id                 number(15),
  pcu_attribute_category            varchar2(30),
  pcu_attribute1                    varchar2(150),
  pcu_attribute2                    varchar2(150),
  pcu_attribute3                    varchar2(150),
  pcu_attribute4                    varchar2(150),
  pcu_attribute5                    varchar2(150),
  pcu_attribute6                    varchar2(150),
  pcu_attribute7                    varchar2(150),
  pcu_attribute8                    varchar2(150),
  pcu_attribute9                    varchar2(150),
  pcu_attribute10                   varchar2(150),
  pcu_attribute11                   varchar2(150),
  pcu_attribute12                   varchar2(150),
  pcu_attribute13                   varchar2(150),
  pcu_attribute14                   varchar2(150),
  pcu_attribute15                   varchar2(150),
  pcu_attribute16                   varchar2(150),
  pcu_attribute17                   varchar2(150),
  pcu_attribute18                   varchar2(150),
  pcu_attribute19                   varchar2(150),
  pcu_attribute20                   varchar2(150),
  pcu_attribute21                   varchar2(150),
  pcu_attribute22                   varchar2(150),
  pcu_attribute23                   varchar2(150),
  pcu_attribute24                   varchar2(150),
  pcu_attribute25                   varchar2(150),
  pcu_attribute26                   varchar2(150),
  pcu_attribute27                   varchar2(150),
  pcu_attribute28                   varchar2(150),
  pcu_attribute29                   varchar2(150),
  pcu_attribute30                   varchar2(150),
...
--           p_base_key_value = :per_cm_usg_id).
--
-- Post Success:
--   Processing continues.
--
