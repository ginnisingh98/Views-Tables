--------------------------------------------------------
--  DDL for Package AP_APXT7F96_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_APXT7F96_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: APXT7F96S.pls 120.0 2007/12/27 08:36:34 vjaganat noship $ */
  ...
  P_TAX_ENTITY_ID VARCHAR2(32767);

  P_ADDRESS_CHOICE VARCHAR2(32767);
  ...
  C_NUMBER_OF_DOCS NUMBER;

  C_TOTAL_REPORTED NUMBER;

  C_TOTAL_WITHHELD NUMBER;

  C_COMPANY_NAME VARCHAR2(240);

  C_US_LINE2 VARCHAR2(240);

  C_US_LINE3 VARCHAR2(240);

  C_US_CITY VARCHAR2(30);

  C_US_STATE VARCHAR2(150);

  C_US_ZIP VARCHAR2(30);
  ...
  FUNCTION MAIL_SEL RETURN BOOLEAN;

  FUNCTION SEL_COMPANY_NAME RETURN BOOLEAN;
  ...
  FUNCTION C_NUMBER_OF_DOCS_P RETURN NUMBER;

  FUNCTION C_TOTAL_REPORTED_P RETURN NUMBER;

  FUNCTION C_TOTAL_WITHHELD_P RETURN NUMBER;

  FUNCTION C_COMPANY_NAME_P RETURN VARCHAR2;

  FUNCTION C_US_LINE2_P RETURN VARCHAR2;

  FUNCTION C_US_LINE3_P RETURN VARCHAR2;

  FUNCTION C_US_CITY_P RETURN VARCHAR2;

  FUNCTION C_US_STATE_P RETURN VARCHAR2;

  FUNCTION C_US_ZIP_P RETURN VARCHAR2;
