--------------------------------------------------------
--  DDL for Package HXC_ERR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_ERR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (error_id                        number(15)
  ,transaction_detail_id           number(15)
  ,time_building_block_id          number(15)
  ,time_building_block_ovn         number(9)
  ,time_attribute_id               number(15)
  ,time_attribute_ovn              number(9)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HXC_ERRORS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
