--------------------------------------------------------
--  DDL for Package OTA_CRE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CRE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cert_enrollment_id
--     already exists.
--
--  In Arguments:
