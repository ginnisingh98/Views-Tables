--------------------------------------------------------
--  DDL for Package BEN_ECQ_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ECQ_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_cbr_quald_bnf_id             number(15),
  ...
  ecq_attribute_category            varchar2(30),
  ecq_attribute1                    varchar2(150),
  ecq_attribute2                    varchar2(150),
  ecq_attribute3                    varchar2(150),
  ecq_attribute4                    varchar2(150),
  ecq_attribute5                    varchar2(150),
  ecq_attribute6                    varchar2(150),
  ecq_attribute7                    varchar2(150),
  ecq_attribute8                    varchar2(150),
  ecq_attribute9                    varchar2(150),
  ecq_attribute10                   varchar2(150),
  ecq_attribute11                   varchar2(150),
  ecq_attribute12                   varchar2(150),
  ecq_attribute13                   varchar2(150),
  ecq_attribute14                   varchar2(150),
  ecq_attribute15                   varchar2(150),
  ecq_attribute16                   varchar2(150),
  ecq_attribute17                   varchar2(150),
  ecq_attribute18                   varchar2(150),
  ecq_attribute19                   varchar2(150),
  ecq_attribute20                   varchar2(150),
  ecq_attribute21                   varchar2(150),
  ecq_attribute22                   varchar2(150),
  ecq_attribute23                   varchar2(150),
  ecq_attribute24                   varchar2(150),
  ecq_attribute25                   varchar2(150),
  ecq_attribute26                   varchar2(150),
  ecq_attribute27                   varchar2(150),
  ecq_attribute28                   varchar2(150),
  ecq_attribute29                   varchar2(150),
  ecq_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_cbr_quald_bnf_id).
--
-- Post Success:
--   Processing continues.
--
