--------------------------------------------------------
--  DDL for Package BEN_EDI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EDI_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_dpnt_cvrd_plip_id            number(15),
  ...
  edi_attribute_category            varchar2(30),
  edi_attribute1                    varchar2(150),
  edi_attribute2                    varchar2(150),
  edi_attribute3                    varchar2(150),
  edi_attribute4                    varchar2(150),
  edi_attribute5                    varchar2(150),
  edi_attribute6                    varchar2(150),
  edi_attribute7                    varchar2(150),
  edi_attribute8                    varchar2(150),
  edi_attribute9                    varchar2(150),
  edi_attribute10                   varchar2(150),
  edi_attribute11                   varchar2(150),
  edi_attribute12                   varchar2(150),
  edi_attribute13                   varchar2(150),
  edi_attribute14                   varchar2(150),
  edi_attribute15                   varchar2(150),
  edi_attribute16                   varchar2(150),
  edi_attribute17                   varchar2(150),
  edi_attribute18                   varchar2(150),
  edi_attribute19                   varchar2(150),
  edi_attribute20                   varchar2(150),
  edi_attribute21                   varchar2(150),
  edi_attribute22                   varchar2(150),
  edi_attribute23                   varchar2(150),
  edi_attribute24                   varchar2(150),
  edi_attribute25                   varchar2(150),
  edi_attribute26                   varchar2(150),
  edi_attribute27                   varchar2(150),
  edi_attribute28                   varchar2(150),
  edi_attribute29                   varchar2(150),
  edi_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_dpnt_cvrd_plip_id).
--
-- Post Success:
--   Processing continues.
--
