--------------------------------------------------------
--  DDL for Package GMD_SS_APPROVAL_WF_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GMD_SS_APPROVAL_WF_PKG" AUTHID CURRENT_USER AS
/* $Header: GMDQMSAS.pls 115.0 2003/04/16 18:50:38 hsaleeb noship $ */
...
************************************************************************************************************/
   ...
   ***   This code will execute when stability Study Status Change Event.        **
...
/**************************************************************************************
 *** This procedure is associated with GMDQMSAP_APP_COMMENT activity of the workflow **
