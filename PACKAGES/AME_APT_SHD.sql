--------------------------------------------------------
--  DDL for Package AME_APT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_APT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,query_variable_1_label          varchar2(50)
  ,query_variable_2_label          varchar2(50)
  ,query_variable_3_label          varchar2(50)
  ,query_variable_4_label          varchar2(50)
  ,query_variable_5_label          varchar2(50)
  ,variable_1_lov_query            varchar2(4000)
  ,variable_2_lov_query            varchar2(4000)
  ,variable_3_lov_query            varchar2(4000)
  ,variable_4_lov_query            varchar2(4000)
  ,variable_5_lov_query            varchar2(4000)
  ,query_procedure                 varchar2(100)
  ,start_date                      date
  ,end_date                        date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_APPROVER_TYPES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :approver_type_id).
--
-- Post Success:
