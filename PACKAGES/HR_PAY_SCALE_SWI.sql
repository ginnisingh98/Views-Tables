--------------------------------------------------------
--  DDL for Package HR_PAY_SCALE_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PAY_SCALE_SWI" AUTHID CURRENT_USER As
-- $Header: peppsswi.pkh 115.0 2003/12/17 04:36 lsilveir noship $
-- ----------------------------------------------------------------------------
-- |---------------------------< create_pay_scale >---------------------------|
-- ----------------------------------------------------------------------------
-- {Start of comments}
...
--  API: hr_pay_scale_api.create_pay_scale
--
-- Pre-requisites
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: hr_pay_scale_api.delete_pay_scale
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: hr_pay_scale_api.update_pay_scale
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
