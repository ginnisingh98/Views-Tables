--------------------------------------------------------
--  DDL for Package BEN_CCT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CCT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  name                              varchar2(240),
  desc_txt                          varchar2(240),
  cm_typ_rl                         number(15),
  cm_usg_cd                         varchar2(30),
  whnvr_trgrd_flag                  varchar2(30),
  shrt_name                         varchar2(90),
  pc_kit_cd                         varchar2(30),
  trk_mlg_flag                      varchar2(30),
  mx_num_avlbl_val                  number(15),
  to_be_sent_dt_cd                  varchar2(30),
  to_be_sent_dt_rl                  number(15),
  inspn_rqd_flag                    varchar2(30),
  inspn_rqd_rl                      number(15),
  rcpent_cd                         varchar2(30),
  parnt_cm_typ_id                   number(15),
  business_group_id                 number(15),
  cct_attribute_category            varchar2(30),
  cct_attribute1                    varchar2(150),
  cct_attribute10                   varchar2(150),
  cct_attribute11                   varchar2(150),
  cct_attribute12                   varchar2(150),
  cct_attribute13                   varchar2(150),
  cct_attribute14                   varchar2(150),
  cct_attribute15                   varchar2(150),
  cct_attribute16                   varchar2(150),
  cct_attribute17                   varchar2(150),
  cct_attribute18                   varchar2(150),
  cct_attribute19                   varchar2(150),
  cct_attribute2                    varchar2(150),
  cct_attribute20                   varchar2(150),
  cct_attribute21                   varchar2(150),
  cct_attribute22                   varchar2(150),
  cct_attribute23                   varchar2(150),
  cct_attribute24                   varchar2(150),
  cct_attribute25                   varchar2(150),
  cct_attribute26                   varchar2(150),
  cct_attribute27                   varchar2(150),
  cct_attribute28                   varchar2(150),
  cct_attribute29                   varchar2(150),
  cct_attribute3                    varchar2(150),
  cct_attribute30                   varchar2(150),
  cct_attribute4                    varchar2(150),
  cct_attribute5                    varchar2(150),
  cct_attribute6                    varchar2(150),
  cct_attribute7                    varchar2(150),
  cct_attribute8                    varchar2(150),
  cct_attribute9                    varchar2(150),
