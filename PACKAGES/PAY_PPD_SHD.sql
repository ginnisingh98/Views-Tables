--------------------------------------------------------
--  DDL for Package PAY_PPD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PPD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,tax_reduction                   varchar2(30)
  ,tax_calc_with_spouse_child      varchar2(30)
  ,income_reduction                varchar2(30)
  ,income_reduction_amount         number(14,2)
  ,rate_of_tax                     varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_PL_PAYE_DETAILS_F';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :paye_details_id).
--
-- Post Success:
