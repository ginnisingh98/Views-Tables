--------------------------------------------------------
--  DDL for Package AMS_IS_LINE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_IS_LINE_PVT" AUTHID CURRENT_USER AS
/* $Header: amsvisls.pls 115.9 2004/01/27 20:48:12 sranka ship $ */
-- ===============================================================
-- Start of Comments
-- Package name
--          AMS_Is_Line_PVT
...
(
       ...
       vehicle_response_code           VARCHAR2(30) := FND_API.G_MISS_CHAR,
        ...
        custom_column1                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column2                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column3                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column4                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column5                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column6                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column7                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column8                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column9                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column10                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column11                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column12                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column13                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column14                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column15                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column16                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column17                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column18                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column19                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column20                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column21                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column22                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column23                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column24                          VARCHAR2(2000) := FND_API.G_MISS_CHAR,
        custom_column25                          VARCHAR2(2000) := FND_API.G_MISS_CHAR
