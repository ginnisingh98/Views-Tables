--------------------------------------------------------
--  DDL for Package PER_CAG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CAG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  status                            varchar2(30),
  pl_id                             number(15),
  cag_number                        number(15),
  description                       varchar2(2000),
  start_date                        date,
  end_date                          date,
  employer_organization_id          number(15),
  employer_signatory                varchar2(80),
  bargaining_organization_id        number(15),
  bargaining_unit_signatory         varchar2(80),
  jurisdiction                      varchar2(80),
  authorizing_body                  varchar2(80),
  authorized_date                   date,
  cag_information_category          varchar2(30),
  cag_information1                  varchar2(150),
  cag_information2                  varchar2(150),
  cag_information3                  varchar2(150),
  cag_information4                  varchar2(150),
  cag_information5                  varchar2(150),
  cag_information6                  varchar2(150),
  cag_information7                  varchar2(150),
  cag_information8                  varchar2(150),
  cag_information9                  varchar2(150),
  cag_information10                 varchar2(150),
  cag_information11                 varchar2(150),
  cag_information12                 varchar2(150),
  cag_information13                 varchar2(150),
  cag_information14                 varchar2(150),
  cag_information15                 varchar2(150),
  cag_information16                 varchar2(150),
  cag_information17                 varchar2(150),
  cag_information18                 varchar2(150),
  cag_information19                 varchar2(150),
  cag_information20                 varchar2(150),
