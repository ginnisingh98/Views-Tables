--------------------------------------------------------
--  DDL for Package PQP_VAI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_VAI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_veh_alloc_extra_info_id
--     already exists.
--
--  In Arguments:
...
--
--  Prerequisites:
--    The primary key identified by p_vehicle_allocation_id
--     already exists.
--
--  In Arguments:
