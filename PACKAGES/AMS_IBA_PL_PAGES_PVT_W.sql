--------------------------------------------------------
--  DDL for Package AMS_IBA_PL_PAGES_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_IBA_PL_PAGES_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswpags.pls 120.1 2005/11/18 06:35 anskumar noship $ */
