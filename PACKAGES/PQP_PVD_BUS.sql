--------------------------------------------------------
--  DDL for Package PQP_PVD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_PVD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_vehicle_details_id
--     already exists.
--
--  In Arguments:
