--------------------------------------------------------
--  DDL for Package HR_LOCATION_EXTRA_INFO_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_LOCATION_EXTRA_INFO_BK2" AUTHID CURRENT_USER as
/* $Header: hrleiapi.pkh 120.1 2005/10/02 02:03:25 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< update_location_extra_info_b >-----------------|
-- ----------------------------------------------------------------------------

Procedure update_location_extra_info_b	(
...
-- ----------------------------------------------------------------------------
-- |-------------------------< update_location_extra_info_a >-----------------|
-- ----------------------------------------------------------------------------

Procedure update_location_extra_info_a
	(
		p_location_extra_info_id	in	number	,
		p_lei_attribute_category	in	varchar2	,
		p_lei_attribute1			in	varchar2	,
...
end hr_location_extra_info_bk2;
