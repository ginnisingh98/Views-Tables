--------------------------------------------------------
--  DDL for Package BEN_VRR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_VRR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  vrbl_rt_rl_id                     number(15),
  effective_start_date              date,
  effective_end_date                date,
  drvbl_fctr_apls_flag              varchar2(30),
  rt_trtmt_cd                       varchar2(30),
  business_group_id                 number(15),
  formula_id                        number(15),
  acty_base_rt_id                   number(15),
  ordr_to_aply_num                  number(15),
  vrr_attribute_category            varchar2(30),
  vrr_attribute1                    varchar2(150),
  vrr_attribute2                    varchar2(150),
  vrr_attribute3                    varchar2(150),
  vrr_attribute4                    varchar2(150),
  vrr_attribute5                    varchar2(150),
  vrr_attribute6                    varchar2(150),
  vrr_attribute7                    varchar2(150),
  vrr_attribute8                    varchar2(150),
  vrr_attribute9                    varchar2(150),
  vrr_attribute10                   varchar2(150),
  vrr_attribute11                   varchar2(150),
  vrr_attribute12                   varchar2(150),
  vrr_attribute13                   varchar2(150),
  vrr_attribute14                   varchar2(150),
  vrr_attribute15                   varchar2(150),
  vrr_attribute16                   varchar2(150),
  vrr_attribute17                   varchar2(150),
  vrr_attribute18                   varchar2(150),
  vrr_attribute19                   varchar2(150),
  vrr_attribute20                   varchar2(150),
  vrr_attribute21                   varchar2(150),
  vrr_attribute22                   varchar2(150),
  vrr_attribute23                   varchar2(150),
  vrr_attribute24                   varchar2(150),
  vrr_attribute25                   varchar2(150),
  vrr_attribute26                   varchar2(150),
  vrr_attribute27                   varchar2(150),
  vrr_attribute28                   varchar2(150),
  vrr_attribute29                   varchar2(150),
  vrr_attribute30                   varchar2(150),
...
--           p_base_key_value = :vrbl_rt_rl_id).
--
-- Post Success:
--   Processing continues.
--
