--------------------------------------------------------
--  DDL for Package BEN_BCD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BCD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cwb_matrix_dtl_id
--     already exists.
--
--  In Arguments:
--    p_cwb_matrix_dtl_id
