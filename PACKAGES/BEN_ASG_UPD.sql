--------------------------------------------------------
--  DDL for Package BEN_ASG_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ASG_UPD" AUTHID CURRENT_USER as
...
--   to perform the datetrack update mode, without validating the row
...
--      value.
--   5) No validation business rules are executed.
...
--
-- Post Success:
--   The specified row will be datetracked updated for the specified entity
--   without being committed for the datetrack mode. If the p_validate argument
--   has been set to true then all the work will be rolled back.
--
-- Post Failure:
...
--   The role of this process is to update a row into the
...
--
-- Post Success:
--   A row will be updated for the specified entity
