--------------------------------------------------------
--  DDL for Package GHR_CST_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CST_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_compl_agency_cost_id
--     already exists.
--
--  In Arguments:
