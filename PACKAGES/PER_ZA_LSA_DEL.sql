--------------------------------------------------------
--  DDL for Package PER_ZA_LSA_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_LSA_DEL" AUTHID CURRENT_USER as
/* $Header: pezalsde.pkh 115.0 2001/02/04 22:33:41 pkm ship        $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< del >----------------------------------|
-- ----------------------------------------------------------------------------
