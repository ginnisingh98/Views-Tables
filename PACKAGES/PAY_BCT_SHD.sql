--------------------------------------------------------
--  DDL for Package PAY_BCT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_BCT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (batch_control_id                number(15)
  ,batch_id                        number(15)
  ,control_status                  varchar2(30)
