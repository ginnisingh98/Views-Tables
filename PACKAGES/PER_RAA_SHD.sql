--------------------------------------------------------
--  DDL for Package PER_RAA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RAA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,run_by_organization_id          number(15)
  ,internal_contact_person_id      number(10)
  ,parent_recruitment_activity_id  number(15)
  ,currency_code                   varchar2(15)
  ,date_start                      date
  ,name                            varchar2(30)
  ,actual_cost                     varchar2(30)
  ,comments                        varchar2(2000)
  ,contact_telephone_number        varchar2(60)
  ,date_closing                    date
  ,date_end                        date
  ,external_contact                varchar2(80)
  ,planned_cost                    varchar2(30)
  ,recruiting_site_id              number(15)
  ,recruiting_site_response        varchar2(32767)
...
g_tab_nam constant varchar2(30) := 'PER_RECRUITMENT_ACTIVITIES';
