--------------------------------------------------------
--  DDL for Package JL_JLARPPTF_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JL_JLARPPTF_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: JLARPPTFS.pls 120.1 2007/12/25 16:34:53 dwkrishn noship $ */
  ...
  P_VAT_PERCEP_TAX_TYPE VARCHAR2(25);
  ...
  FUNCTION C_PERCEPTION_AMT_CHARFORMULA(PERCEPTION_AMOUNT IN NUMBER) RETURN VARCHAR2;

  FUNCTION POPULATE_TRL RETURN BOOLEAN;

  FUNCTION GET_FORMATTED_DOCNUM(P_DOC_NUM IN VARCHAR2) RETURN VARCHAR2;

  FUNCTION DOC_NUMBERFORMULA(DOC_NUM IN VARCHAR2) RETURN VARCHAR2;
