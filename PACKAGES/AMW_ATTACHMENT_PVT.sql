--------------------------------------------------------
--  DDL for Package AMW_ATTACHMENT_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMW_ATTACHMENT_PVT" AUTHID CURRENT_USER AS
/* $Header: amwvatcs.pls 120.0 2005/05/31 22:19:31 appldev noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
--         AMW_Attachment_PVT
-- Purpose
--  This package is used by Internal Controls Manager starting
--  11.5.10.
-- History
--
-- NOTE
