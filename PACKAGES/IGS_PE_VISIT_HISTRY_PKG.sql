--------------------------------------------------------
--  DDL for Package IGS_PE_VISIT_HISTRY_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PE_VISIT_HISTRY_PKG" AUTHID CURRENT_USER AS
/* $Header: IGSNI52S.pls 115.0 2002/12/12 09:33:22 npalanis noship $ */
  ...
  PROCEDURE before_dml (
    ...
    x_port_of_entry                     IN     VARCHAR2    DEFAULT NULL,
    x_cntry_entry_form_num              IN     VARCHAR2    DEFAULT NULL,
    x_visa_id                           IN     NUMBER      DEFAULT NULL,
    x_visit_start_date                  IN     DATE        DEFAULT NULL,
    x_visit_end_date                    IN     DATE        DEFAULT NULL,
