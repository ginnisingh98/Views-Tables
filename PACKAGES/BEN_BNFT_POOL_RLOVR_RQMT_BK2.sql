--------------------------------------------------------
--  DDL for Package BEN_BNFT_POOL_RLOVR_RQMT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BNFT_POOL_RLOVR_RQMT_BK2" AUTHID CURRENT_USER as
/* $Header: bebprapi.pkh 120.0 2005/05/28 00:49:04 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_Bnft_Pool_Rlovr_Rqmt_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_Bnft_Pool_Rlovr_Rqmt_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_Bnft_Pool_Rlovr_Rqmt_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_Bnft_Pool_Rlovr_Rqmt_a
  (
   p_bnft_pool_rlovr_rqmt_id        in  number
...
--
end ben_Bnft_Pool_Rlovr_Rqmt_bk2;
