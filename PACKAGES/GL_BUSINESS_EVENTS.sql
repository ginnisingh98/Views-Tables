--------------------------------------------------------
--  DDL for Package GL_BUSINESS_EVENTS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GL_BUSINESS_EVENTS" AUTHID CURRENT_USER AS
/* $Header: glubeevs.pls 120.1 2005/05/05 01:35:57 kvora noship $ */
--
-- Package
--   gl_business_events
-- Purpose
--   To hide calls to the business event system to reduce dependencies
-- History
--   23-MAY-03  	D. J. Ogg	Created
