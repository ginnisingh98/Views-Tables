--------------------------------------------------------
--  DDL for Package JG_RX_C_FAREG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JG_RX_C_FAREG" AUTHID CURRENT_USER AS
/* $Header: jgrxcfrs.pls 120.4.12010000.2 2008/08/04 13:52:27 vgadde ship $ */
