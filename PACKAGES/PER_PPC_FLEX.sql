--------------------------------------------------------
--  DDL for Package PER_PPC_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PPC_FLEX" AUTHID CURRENT_USER as
/* $Header: peppcfli.pkh 115.0 99/07/18 14:28:33 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
