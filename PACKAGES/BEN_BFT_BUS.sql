--------------------------------------------------------
--  DDL for Package BEN_BFT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BFT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_benefit_action_id already exists.
--
--  In Arguments:
--    p_benefit_action_id
--
...
function return_legislation_code
  (p_benefit_action_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
