--------------------------------------------------------
--  DDL for Package IGS_AD_SS_PERSON_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_AD_SS_PERSON_PKG" AUTHID CURRENT_USER AS
/* $Header: IGSAIG5S.pls 120.1 2005/09/23 00:22:35 appldev noship $ */
 ...
 procedure UPDATE_ROW (
  ...
  PROCEDURE BEFORE_DML (
    ...
    x_DECLARED_ETHNICITY IN VARCHAR2 DEFAULT NULL,
    x_MARITAL_STATUS IN VARCHAR2 DEFAULT NULL,
    x_MARITAL_STATUS_DATE IN VARCHAR2 DEFAULT NULL,
