--------------------------------------------------------
--  DDL for Package HXC_EGC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_EGC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (entity_group_comp_id            number(15)
  ,entity_group_id                 number(15)
  ,entity_id                       number(15)
