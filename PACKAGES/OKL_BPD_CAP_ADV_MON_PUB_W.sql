--------------------------------------------------------
--  DDL for Package OKL_BPD_CAP_ADV_MON_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_BPD_CAP_ADV_MON_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUAMSS.pls 120.1 2005/10/30 04:02:52 appldev noship $ */
