--------------------------------------------------------
--  DDL for Package BEN_APF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_APF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  acty_rt_pymt_sched_id             number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  pymt_sched_rl                     number(15),
  acty_base_rt_id                   number(15),
  pymt_sched_cd                     varchar2(30),
  apf_attribute_category            varchar2(30),
  apf_attribute1                    varchar2(150),
  apf_attribute2                    varchar2(150),
  apf_attribute3                    varchar2(150),
  apf_attribute4                    varchar2(150),
  apf_attribute5                    varchar2(150),
  apf_attribute6                    varchar2(150),
  apf_attribute7                    varchar2(150),
  apf_attribute8                    varchar2(150),
  apf_attribute9                    varchar2(150),
  apf_attribute10                   varchar2(150),
  apf_attribute11                   varchar2(150),
  apf_attribute12                   varchar2(150),
  apf_attribute13                   varchar2(150),
  apf_attribute14                   varchar2(150),
  apf_attribute15                   varchar2(150),
  apf_attribute16                   varchar2(150),
  apf_attribute17                   varchar2(150),
  apf_attribute18                   varchar2(150),
  apf_attribute19                   varchar2(150),
  apf_attribute20                   varchar2(150),
  apf_attribute21                   varchar2(150),
  apf_attribute22                   varchar2(150),
  apf_attribute23                   varchar2(150),
  apf_attribute24                   varchar2(150),
  apf_attribute25                   varchar2(150),
  apf_attribute26                   varchar2(150),
  apf_attribute27                   varchar2(150),
  apf_attribute28                   varchar2(150),
  apf_attribute29                   varchar2(150),
  apf_attribute30                   varchar2(150),
...
--           p_base_key_value = :acty_rt_pymt_sched_id).
--
-- Post Success:
--   Processing continues.
--
