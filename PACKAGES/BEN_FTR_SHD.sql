--------------------------------------------------------
--  DDL for Package BEN_FTR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_FTR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ftr_attribute_category            varchar2(30),
  ftr_attribute1                    varchar2(150),
  ftr_attribute2                    varchar2(150),
  ftr_attribute3                    varchar2(150),
  ftr_attribute4                    varchar2(150),
  ftr_attribute5                    varchar2(150),
  ftr_attribute6                    varchar2(150),
  ftr_attribute7                    varchar2(150),
  ftr_attribute8                    varchar2(150),
  ftr_attribute9                    varchar2(150),
  ftr_attribute10                   varchar2(150),
  ftr_attribute11                   varchar2(150),
  ftr_attribute12                   varchar2(150),
  ftr_attribute13                   varchar2(150),
  ftr_attribute14                   varchar2(150),
  ftr_attribute15                   varchar2(150),
  ftr_attribute16                   varchar2(150),
  ftr_attribute17                   varchar2(150),
  ftr_attribute18                   varchar2(150),
  ftr_attribute19                   varchar2(150),
  ftr_attribute20                   varchar2(150),
  ftr_attribute21                   varchar2(150),
  ftr_attribute22                   varchar2(150),
  ftr_attribute23                   varchar2(150),
  ftr_attribute24                   varchar2(150),
  ftr_attribute25                   varchar2(150),
  ftr_attribute26                   varchar2(150),
  ftr_attribute27                   varchar2(150),
  ftr_attribute28                   varchar2(150),
  ftr_attribute29                   varchar2(150),
  ftr_attribute30                   varchar2(150),
...
--           p_base_key_value = :fl_tm_pt_tm_rt_id).
--
-- Post Success:
--   Processing continues.
--
