--------------------------------------------------------
--  DDL for Package ENG_SUB_COMPONENT_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ENG_SUB_COMPONENT_UTIL" AUTHID CURRENT_USER AS
/* $Header: ENGUSBCS.pls 115.7 2002/11/24 12:30:57 bbontemp ship $ */
