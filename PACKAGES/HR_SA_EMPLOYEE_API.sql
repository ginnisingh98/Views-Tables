--------------------------------------------------------
--  DDL for Package HR_SA_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_SA_EMPLOYEE_API" AUTHID CURRENT_USER as
/* $Header: peempsai.pkh 120.2 2005/10/02 02:16:35 aroussel $ */
/*#
 * This package contains employee APIs for Saudi Arabia.
 * @rep:scope public
 * @rep:product per
 * @rep:displayname Employee for Saudi Arabia
*/
--
-- ----------------------------------------------------------------------------
-- |----------------------------< create_sa_employee >------------------------|
...
-- {Start Of Comments}
/*#
 * This API creates an employee in a Saudi Arabia business group.
 *
 * The API calls the generic API create_employee, with parameters set as
 * appropriate for the Saudi person. As this API is effectively an alternative
 * to the API create_employee, see that API for further explanation.
 *
 * <p><b>Licensing</b><br>
 ...
 * The API successfully creates the employee record in the database.
 *
 * <p><b>Post Failure</b><br>
 * The API does not create the employee record and raises an error.
 ...
 * @param p_hijrah_hire_date Hire date according to the Hijrah calendar
 ...
 * @rep:displayname Create Employee for Saudi Arabia
