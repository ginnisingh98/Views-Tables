--------------------------------------------------------
--  DDL for Package ICX_RESP_EXCL_ATTR_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ICX_RESP_EXCL_ATTR_PVT" AUTHID CURRENT_USER AS
-- $Header: ICXVTRES.pls 115.1 99/07/17 03:30:41 porting ship $

--  Global constants holding the package and file names to be used by
--  messaging routines in the case of an unexpected error.

G_PKG_NAME	CONSTANT VARCHAR2(30) := 'ICX_Resp_Excl_Attr_PVT';
G_FILE_NAME	CONSTANT VARCHAR2(12) := 'ICXVTREB.pls';

-- Start of Comments
--	API name 	: Create_Resp_Excl_Attr
--	Type		: Private.
--	Function	: Create Excluding Attribute information in AK_EXCLUDED_ITEMS
--	Pre-reqs	: None.
--	Paramaeters	:
...
--	Type		: Private.
--	Function	: Delete Excluding Attribute information in AK_EXCLUDED_ITEMS
--	Pre-reqs	: None.
--	Paramaeters	:
--	IN		:	p_api_version_number	IN NUMBER		Required
--				p_init_msg_list		IN VARCHAR2 		Optional
