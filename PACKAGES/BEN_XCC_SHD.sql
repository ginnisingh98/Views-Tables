--------------------------------------------------------
--  DDL for Package BEN_XCC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XCC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ext_crit_cmbn_id                  number(15),
  crit_typ_cd                       varchar2(30),
  oper_cd                           varchar2(30),
  val_1                             varchar2(200),
  val_2                             varchar2(200),
