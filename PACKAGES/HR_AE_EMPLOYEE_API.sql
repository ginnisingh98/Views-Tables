--------------------------------------------------------
--  DDL for Package HR_AE_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_AE_EMPLOYEE_API" AUTHID CURRENT_USER as
/* $Header: peempaei.pkh 120.5 2006/04/26 23:55:45 spendhar noship $ */
/*#
 * This package contains employee APIs.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Employee for UAE
*/
--
--
  -- ----------------------------------------------------------------------------
 ...
 * The API creates a person, primary assignment and period of service.
 *
 ...
 * @param p_hire_date The employee hire date and thus the effective start
 * date of the person, primary assignment and period of service.
 * @param p_business_group_id Identifies the employee's business group.
 * @param p_family_name Employee's family name.
 * @param p_sex Employee sex.
 * @param p_person_type_id Identifies the person type id. If a person_type_id
 * is not specified, then the API will use the default 'EMP' type for the
 * business group.
 * @param p_comments Employee comments.
 * @param p_date_employee_data_verified The date on which the Employee data
 * was last verified.
 ...
 * @param p_known_as Alternate name.
 ...
 * @param p_background_check_status Y/N flag indicates whether
 ...
 * @param p_last_medical_test_by Name of physician who performed
 * last medical test.
 ...
 * @param p_on_military_service Y/N flag indicating whether person
 ...
 * @param p_work_schedule Type of work schedule indicating which
 * days person works.
 ...
 * @param p_coord_ben_med_insr_crr_name Secondary medical coverage
 * insurance carrier.
 ...
 * end date.
 * @param p_uses_tobacco_flag Y/N flag indicating use of tobacco.
 ...
 * the person created. If p_validate is true this will be set to the same
 * value as passed in.
 ...
 * @param p_assignment_id If p_validate is false, this uniquely identifies
 * the primary assignment created. If p_validate is true this will be null.
 ...
 * @param p_per_effective_start_date If p_validate is false, this will
 * be set to the effective start date of the person. If p_validate is true
 * this will be null.
 * @param p_per_effective_end_date If p_validate is false, this will
 * be set to the effective end date of the person. If p_validate is true
 * this will be null.
 ...
 * @param p_assign_payroll_warning Set to true if the date of birth has not been set.
 ...
 * @rep:displayname Create Employee for UAE
