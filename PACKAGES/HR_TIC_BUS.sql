--------------------------------------------------------
--  DDL for Package HR_TIC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TIC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_template_item_context_id already exists.
--
--  In Arguments:
