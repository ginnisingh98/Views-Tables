--------------------------------------------------------
--  DDL for Package BEN_LENGTH_OF_SVC_RATE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LENGTH_OF_SVC_RATE_BK1" AUTHID CURRENT_USER as
/* $Header: belsrapi.pkh 120.0 2005/05/28 03:38:18 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_LENGTH_OF_SVC_RATE_b >-----------------|
-- ----------------------------------------------------------------------------
--
