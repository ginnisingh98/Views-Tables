--------------------------------------------------------
--  DDL for Package FA_FASAAMTS_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_FASAAMTS_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: FASAAMTSS.pls 120.0.12010000.1 2008/07/28 13:16:16 appldev ship $ */
	...
	RP_Report_ShortName  Varchar2(30);
