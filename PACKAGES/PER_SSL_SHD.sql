--------------------------------------------------------
--  DDL for Package PER_SSL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SSL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  salary_survey_line_id            number(15),
  object_version_number             number(9),
  salary_survey_id                  number(15),
  survey_job_name_code              varchar2(30),
  survey_region_code                varchar2(30),
  survey_seniority_code             varchar2(30),
  company_size_code                 varchar2(30),
  industry_code                     varchar2(30),
  survey_age_code                   varchar2(30),
  start_date                        date,
  end_date                          date,
  ...
  job_first_quartile                number,
  job_median_quartile               number,
  job_third_quartile                number,
  job_fourth_quartile               number,
  minimum_total_compensation        number,
  mean_total_compensation           number,
  maximum_total_compensation        number,
  compnstn_first_quartile           number,
  compnstn_median_quartile          number,
  compnstn_third_quartile           number,
  compnstn_fourth_quartile          number,
/*Added for Enhancement 4021737 */
  ...
  minimum_salary_increase           number,
  mean_salary_increase              number,
  maximum_salary_increase           number,
  min_variable_compensation         number,
  mean_variable_compensation        number,
  max_variable_compensation         number,
  minimum_stock                     number,
  mean_stock                        number,
  maximum_stock                     number,
  stock_display_type                varchar2(30),
