--------------------------------------------------------
--  DDL for Package PER_PGT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PGT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_hier_node_type_id
--     already exists.
--
--  In Arguments:
--    p_hier_node_type_id
