--------------------------------------------------------
--  DDL for Package HR_US_UTILITY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_US_UTILITY" AUTHID CURRENT_USER AS
/* $Header: hrusutil.pkh 115.9 2003/01/07 07:25:36 fsheikh noship $ */
--
FUNCTION per_us_full_name(
