--------------------------------------------------------
--  DDL for Package IRC_IAV_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IAV_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_agency_vacancy_id
--     already exists.
--
--  In Arguments:
--    p_agency_vacancy_id
