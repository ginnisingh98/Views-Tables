--------------------------------------------------------
--  DDL for Package BEN_ELIG_DSBLTY_CTG_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_DSBLTY_CTG_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beectapi.pkh 120.0 2005/05/28 01:54:03 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_dsblty_ctg_PRTE_b >---------------|
-- ----------------------------------------------------------------------------
--
procedure CREATE_ELIG_DSBLTY_CTG_PRTE_B
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_dsblty_ctg_PRTE_a >--------------|
-- ----------------------------------------------------------------------------
--
procedure CREATE_ELIG_DSBLTY_CTG_PRTE_A
  (
...
--
end BEN_ELIG_DSBLTY_CTG_PRTE_BK1;
