--------------------------------------------------------
--  DDL for Package HR_PPU_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PPU_UPD" AUTHID CURRENT_USER as
/* $Header: hrppurhi.pkh 115.0 99/07/17 05:37:00 porting ship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< upd >----------------------------------|
-- ----------------------------------------------------------------------------
