--------------------------------------------------------
--  DDL for Package BEN_DRR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DRR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dsgn_rqmt_rlshp_typ_id            number(15),
  rlshp_typ_cd                      varchar2(30),
  dsgn_rqmt_id                      number(15),
  business_group_id                 number(15),
  drr_attribute_category            varchar2(30),
  drr_attribute1                    varchar2(150),
  drr_attribute2                    varchar2(150),
  drr_attribute3                    varchar2(150),
  drr_attribute4                    varchar2(150),
  drr_attribute5                    varchar2(150),
  drr_attribute6                    varchar2(150),
  drr_attribute7                    varchar2(150),
  drr_attribute8                    varchar2(150),
  drr_attribute9                    varchar2(150),
  drr_attribute10                   varchar2(150),
  drr_attribute11                   varchar2(150),
  drr_attribute12                   varchar2(150),
  drr_attribute13                   varchar2(150),
  drr_attribute14                   varchar2(150),
  drr_attribute15                   varchar2(150),
  drr_attribute16                   varchar2(150),
  drr_attribute17                   varchar2(150),
  drr_attribute18                   varchar2(150),
  drr_attribute19                   varchar2(150),
  drr_attribute20                   varchar2(150),
  drr_attribute21                   varchar2(150),
  drr_attribute22                   varchar2(150),
  drr_attribute23                   varchar2(150),
  drr_attribute24                   varchar2(150),
  drr_attribute25                   varchar2(150),
  drr_attribute26                   varchar2(150),
  drr_attribute27                   varchar2(150),
  drr_attribute28                   varchar2(150),
  drr_attribute29                   varchar2(150),
  drr_attribute30                   varchar2(150),
