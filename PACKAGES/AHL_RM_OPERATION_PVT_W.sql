--------------------------------------------------------
--  DDL for Package AHL_RM_OPERATION_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_RM_OPERATION_PVT_W" AUTHID CURRENT_USER as
  /* $Header: AHLWOPMS.pls 120.0.12010000.2 2008/11/23 14:29:28 bachandr ship $ */
