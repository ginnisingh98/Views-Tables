--------------------------------------------------------
--  DDL for Package BEN_ELI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELI_UPD" AUTHID CURRENT_USER as
...
--   2) After the conversion has taken elpace, the corresponding record upd
