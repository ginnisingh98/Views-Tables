--------------------------------------------------------
--  DDL for Package EAM_OP_NETWORK_DEFAULT_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."EAM_OP_NETWORK_DEFAULT_PVT" AUTHID CURRENT_USER AS
/* $Header: EAMVONDS.pls 115.1 2002/11/25 00:08:12 baroy noship $ */
/***************************************************************************
--
