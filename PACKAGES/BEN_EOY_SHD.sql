--------------------------------------------------------
--  DDL for Package BEN_EOY_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EOY_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_othr_ptip_prte_id            number(15),
  ...
  eoy_attribute_category            varchar2(30),
  eoy_attribute1                    varchar2(150),
  eoy_attribute2                    varchar2(150),
  eoy_attribute3                    varchar2(150),
  eoy_attribute4                    varchar2(150),
  eoy_attribute5                    varchar2(150),
  eoy_attribute6                    varchar2(150),
  eoy_attribute7                    varchar2(150),
  eoy_attribute8                    varchar2(150),
  eoy_attribute9                    varchar2(150),
  eoy_attribute10                   varchar2(150),
  eoy_attribute11                   varchar2(150),
  eoy_attribute12                   varchar2(150),
  eoy_attribute13                   varchar2(150),
  eoy_attribute14                   varchar2(150),
  eoy_attribute15                   varchar2(150),
  eoy_attribute16                   varchar2(150),
  eoy_attribute17                   varchar2(150),
  eoy_attribute18                   varchar2(150),
  eoy_attribute19                   varchar2(150),
  eoy_attribute20                   varchar2(150),
  eoy_attribute21                   varchar2(150),
  eoy_attribute22                   varchar2(150),
  eoy_attribute23                   varchar2(150),
  eoy_attribute24                   varchar2(150),
  eoy_attribute25                   varchar2(150),
  eoy_attribute26                   varchar2(150),
  eoy_attribute27                   varchar2(150),
  eoy_attribute28                   varchar2(150),
  eoy_attribute29                   varchar2(150),
  eoy_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_othr_ptip_prte_id).
--
-- Post Success:
--   Processing continues.
--
