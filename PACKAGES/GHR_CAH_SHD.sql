--------------------------------------------------------
--  DDL for Package GHR_CAH_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CAH_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (compl_ca_header_id              number(15)
  ,complaint_id                    number(15)
  ,ca_source                       varchar2(30)       -- Increased length
  ,last_compliance_report          date
  ,compliance_closed               date
  ,compl_docket_number             varchar2(50)
  ,appeal_docket_number            varchar2(50)
  ,pfe_docket_number               varchar2(50)
  ,pfe_received                    date
  ,agency_brief_pfe_due            date
  ,agency_brief_pfe_date           date
  ,decision_pfe_date               date
  ,decision_pfe                    varchar2(2000)
  ,agency_recvd_pfe_decision       date
  ,agency_pfe_brief_forwd          date
  ,agency_notified_noncom          date
  ,comrep_noncom_req               varchar2(30)       -- Increased length
  ,eeo_off_req_data_from_org       date
  ,org_forwd_data_to_eeo_off       date
  ,dec_implemented                 date
  ,complaint_reinstated            date
  ,stage_complaint_reinstated      varchar2(30)       -- Increased length
