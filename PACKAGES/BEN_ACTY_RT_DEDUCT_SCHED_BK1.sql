--------------------------------------------------------
--  DDL for Package BEN_ACTY_RT_DEDUCT_SCHED_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ACTY_RT_DEDUCT_SCHED_BK1" AUTHID CURRENT_USER as
/* $Header: beadsapi.pkh 120.0 2005/05/28 00:22:09 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ACTY_RT_DEDUCT_SCHED_b >-----------------|
-- ----------------------------------------------------------------------------
--
