--------------------------------------------------------
--  DDL for Package BEN_DCP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DCP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dpnt_cvrd_plip_rt_id            number(15),
  ...
  dcp_attribute_category            varchar2(30),
  dcp_attribute1                    varchar2(150),
  dcp_attribute2                    varchar2(150),
  dcp_attribute3                    varchar2(150),
  dcp_attribute4                    varchar2(150),
  dcp_attribute5                    varchar2(150),
  dcp_attribute6                    varchar2(150),
  dcp_attribute7                    varchar2(150),
  dcp_attribute8                    varchar2(150),
  dcp_attribute9                    varchar2(150),
  dcp_attribute10                   varchar2(150),
  dcp_attribute11                   varchar2(150),
  dcp_attribute12                   varchar2(150),
  dcp_attribute13                   varchar2(150),
  dcp_attribute14                   varchar2(150),
  dcp_attribute15                   varchar2(150),
  dcp_attribute16                   varchar2(150),
  dcp_attribute17                   varchar2(150),
  dcp_attribute18                   varchar2(150),
  dcp_attribute19                   varchar2(150),
  dcp_attribute20                   varchar2(150),
  dcp_attribute21                   varchar2(150),
  dcp_attribute22                   varchar2(150),
  dcp_attribute23                   varchar2(150),
  dcp_attribute24                   varchar2(150),
  dcp_attribute25                   varchar2(150),
  dcp_attribute26                   varchar2(150),
  dcp_attribute27                   varchar2(150),
  dcp_attribute28                   varchar2(150),
  dcp_attribute29                   varchar2(150),
  dcp_attribute30                   varchar2(150),
...
--           p_base_key_value = :dpnt_cvrd_plip_rt_id).
--
-- Post Success:
--   Processing continues.
--
