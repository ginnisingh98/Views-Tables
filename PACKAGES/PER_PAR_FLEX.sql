--------------------------------------------------------
--  DDL for Package PER_PAR_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PAR_FLEX" AUTHID CURRENT_USER as
/* $Header: peparfli.pkh 115.2 99/10/15 15:42:22 porting ship $ */
--
--
-------------------------------------------------------------------------------
-- |-------------------------------< df>-------------------------------------|
