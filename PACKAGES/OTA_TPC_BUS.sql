--------------------------------------------------------
--  DDL for Package OTA_TPC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TPC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_training_plan_cost_id
--     already exists.
--
--  In Arguments:
