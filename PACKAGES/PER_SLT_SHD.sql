--------------------------------------------------------
--  DDL for Package PER_SLT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SLT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,solution_category               varchar2(120)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_SOLUTION_TYPES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
