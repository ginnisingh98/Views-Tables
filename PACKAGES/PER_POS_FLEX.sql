--------------------------------------------------------
--  DDL for Package PER_POS_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_POS_FLEX" AUTHID CURRENT_USER as
/* $Header: peposfli.pkh 115.1 99/07/18 14:28:14 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
...
--  {End of Comments}
-- -----------------------------------------------------------------------------
procedure df(p_rec   in per_pos_shd.g_rec_type);
--
end per_pos_flex;
