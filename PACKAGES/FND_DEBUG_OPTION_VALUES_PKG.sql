--------------------------------------------------------
--  DDL for Package FND_DEBUG_OPTION_VALUES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FND_DEBUG_OPTION_VALUES_PKG" AUTHID CURRENT_USER as
-- $Header: AFOAMDVS.pls 120.1 2005/07/02 03:03:00 appldev noship $
