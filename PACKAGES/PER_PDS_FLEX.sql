--------------------------------------------------------
--  DDL for Package PER_PDS_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PDS_FLEX" AUTHID CURRENT_USER as
/* $Header: pepdsfli.pkh 115.0 99/07/18 14:12:38 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
