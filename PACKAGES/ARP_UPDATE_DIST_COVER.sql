--------------------------------------------------------
--  DDL for Package ARP_UPDATE_DIST_COVER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARP_UPDATE_DIST_COVER" AUTHID CURRENT_USER AS
/* $Header: ARTLGDUS.pls 120.4.12010000.2 2009/09/14 11:38:08 rasarasw ship $ */
...
PROCEDURE update_dist_cover(
           ...
           p_rec_offset_flag             IN
             ra_cust_trx_line_gl_dist.rec_offset_flag%type,	/* bug 3598021 */
