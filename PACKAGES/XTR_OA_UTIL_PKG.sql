--------------------------------------------------------
--  DDL for Package XTR_OA_UTIL_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XTR_OA_UTIL_PKG" AUTHID CURRENT_USER as
/* $Header: xtroauts.pls 115.3 2002/02/13 17:00:54 pkm ship      $*/
