--------------------------------------------------------
--  DDL for Package PER_PSE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PSE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (pos_structure_element_id        number(15)
  ,business_group_id               number(15)
  ,pos_structure_version_id        number
  ,subordinate_position_id         number(15)
