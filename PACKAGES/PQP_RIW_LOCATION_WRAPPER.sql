--------------------------------------------------------
--  DDL for Package PQP_RIW_LOCATION_WRAPPER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_RIW_LOCATION_WRAPPER" AUTHID CURRENT_USER as
/* $Header: pqpriwlcwr.pkh 120.0.12010000.3 2009/08/25 15:47:29 psengupt noship $ */
     PROCEDURE INSUPD_LOCATION(p_effective_date                 IN  DATE
     ...
     ,p_global_flag                    IN  VARCHAR2  DEFAULT NULL);
