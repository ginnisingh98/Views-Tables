--------------------------------------------------------
--  DDL for Package BEN_ELIG_DSBLD_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_DSBLD_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beedbapi.pkh 120.0 2005/05/28 01:56:06 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_DSBLD_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_DSBLD_PRTE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_DSBLD_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_DSBLD_PRTE_a
  (
