--------------------------------------------------------
--  DDL for Package BEN_LRI_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LRI_DEL" AUTHID CURRENT_USER as
...
--      datatype.
--   2) After the conversion has taken lerace, the corresponding record del
