--------------------------------------------------------
--  DDL for Package BEN_ENB_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ENB_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_enrt_bnft_id already exists.
--
--  In Arguments:
--    p_enrt_bnft_id
--
...
function return_legislation_code
  (p_enrt_bnft_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
