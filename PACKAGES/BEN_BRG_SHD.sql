--------------------------------------------------------
--  DDL for Package BEN_BRG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BRG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ordr_num                          number(15),
  brg_attribute_category            varchar2(30),
  brg_attribute1                    varchar2(150),
  brg_attribute2                    varchar2(150),
  brg_attribute3                    varchar2(150),
  brg_attribute4                    varchar2(150),
  brg_attribute5                    varchar2(150),
  brg_attribute6                    varchar2(150),
  brg_attribute7                    varchar2(150),
  brg_attribute8                    varchar2(150),
  brg_attribute9                    varchar2(150),
  brg_attribute10                   varchar2(150),
  brg_attribute11                   varchar2(150),
  brg_attribute12                   varchar2(150),
  brg_attribute13                   varchar2(150),
  brg_attribute14                   varchar2(150),
  brg_attribute15                   varchar2(150),
  brg_attribute16                   varchar2(150),
  brg_attribute17                   varchar2(150),
  brg_attribute18                   varchar2(150),
  brg_attribute19                   varchar2(150),
  brg_attribute20                   varchar2(150),
  brg_attribute21                   varchar2(150),
  brg_attribute22                   varchar2(150),
  brg_attribute23                   varchar2(150),
  brg_attribute24                   varchar2(150),
  brg_attribute25                   varchar2(150),
  brg_attribute26                   varchar2(150),
  brg_attribute27                   varchar2(150),
  brg_attribute28                   varchar2(150),
  brg_attribute29                   varchar2(150),
  brg_attribute30                   varchar2(150),
...
--           p_base_key_value = :benfts_grp_rt_id).
--
-- Post Success:
--   Processing continues.
--
