--------------------------------------------------------
--  DDL for Package IGS_PS_USEC_WLST_PRF_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PS_USEC_WLST_PRF_PKG" AUTHID CURRENT_USER AS
/* $Header: IGSPI0ZS.pls 115.6 2002/11/29 02:01:34 nsidana ship $ */
