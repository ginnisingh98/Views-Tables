--------------------------------------------------------
--  DDL for Package PAY_ESU_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_ESU_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_element_span_usage_id
--     already exists.
--
--  In Arguments:
