--------------------------------------------------------
--  DDL for Package BEN_DCR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DCR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dpnt_cvg_rqd_rlshp_id             number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  per_relshp_typ_cd                 varchar2(30),
  cvg_strt_dt_cd                    varchar2(30),
  cvg_thru_dt_rl                    number(15),
  cvg_thru_dt_cd                    varchar2(30),
  cvg_strt_dt_rl                    number(15),
  dpnt_cvg_eligy_prfl_id            number(15),
  dcr_attribute_category            varchar2(30),
  dcr_attribute1                    varchar2(150),
  dcr_attribute2                    varchar2(150),
  dcr_attribute3                    varchar2(150),
  dcr_attribute4                    varchar2(150),
  dcr_attribute5                    varchar2(150),
  dcr_attribute6                    varchar2(150),
  dcr_attribute7                    varchar2(150),
  dcr_attribute8                    varchar2(150),
  dcr_attribute9                    varchar2(150),
  dcr_attribute10                   varchar2(150),
  dcr_attribute11                   varchar2(150),
  dcr_attribute12                   varchar2(150),
  dcr_attribute13                   varchar2(150),
  dcr_attribute14                   varchar2(150),
  dcr_attribute15                   varchar2(150),
  dcr_attribute16                   varchar2(150),
  dcr_attribute17                   varchar2(150),
  dcr_attribute18                   varchar2(150),
  dcr_attribute19                   varchar2(150),
  dcr_attribute20                   varchar2(150),
  dcr_attribute21                   varchar2(150),
  dcr_attribute22                   varchar2(150),
  dcr_attribute23                   varchar2(150),
  dcr_attribute24                   varchar2(150),
  dcr_attribute25                   varchar2(150),
  dcr_attribute26                   varchar2(150),
  dcr_attribute27                   varchar2(150),
  dcr_attribute28                   varchar2(150),
  dcr_attribute29                   varchar2(150),
  dcr_attribute30                   varchar2(150),
...
--           p_base_key_value = :dpnt_cvg_rqd_rlshp_id).
--
-- Post Success:
--   Processing continues.
--
