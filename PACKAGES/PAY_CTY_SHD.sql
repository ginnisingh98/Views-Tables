--------------------------------------------------------
--  DDL for Package PAY_CTY_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CTY_SHD" AUTHID CURRENT_USER AS
...
Type g_rec_type Is Record
  ...
  school_district_code              varchar2(9),      -- Increased length
  ...
  cty_information_category                varchar2(30),
  cty_information1                        varchar2(150),
  cty_information2                        varchar2(150),
  cty_information3                        varchar2(150),
  cty_information4                        varchar2(150),
  cty_information5                        varchar2(150),
  cty_information6                        varchar2(150),
  cty_information7                        varchar2(150),
  cty_information8                        varchar2(150),
  cty_information9                        varchar2(150),
  cty_information10                       varchar2(150),
  cty_information11                       varchar2(150),
  cty_information12                       varchar2(150),
  cty_information13                       varchar2(150),
  cty_information14                       varchar2(150),
  cty_information15                       varchar2(150),
  cty_information16                       varchar2(150),
  cty_information17                       varchar2(150),
  cty_information18                       varchar2(150),
  cty_information19                       varchar2(150),
  cty_information20                       varchar2(150),
  cty_information21                       varchar2(150),
  cty_information22                       varchar2(150),
  cty_information23                      varchar2(150),
  cty_information24                      varchar2(150),
  cty_information25                       varchar2(150),
  cty_information26                       varchar2(150),
  cty_information27                       varchar2(150),
  cty_information28                       varchar2(150),
  cty_information29                       varchar2(150),
  cty_information30                       varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :emp_city_tax_rule_id).
--
-- Post Success:
--   Processing continues.
--
