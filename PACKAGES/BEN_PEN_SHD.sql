--------------------------------------------------------
--  DDL for Package BEN_PEN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PEN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  pgm_id                            number(15),
  pl_id                             number(15),
  rplcs_sspndd_rslt_id              number(15),
  ptip_id                           number(15),
  pl_typ_id                         number(15),
  ler_id                            number(15),
  sspndd_flag                       varchar2(30),
  prtt_is_cvrd_flag                 varchar2(30),
  bnft_amt                          number,
  uom                               varchar2(30),
  orgnl_enrt_dt                     date,
  enrt_mthd_cd                      varchar2(30),
  no_lngr_elig_flag                 varchar2(30),
  enrt_ovridn_flag                  varchar2(30),
  enrt_ovrid_rsn_cd                 varchar2(30),
  ...
  pen_attribute_category            varchar2(30),
  pen_attribute1                    varchar2(150),
  pen_attribute2                    varchar2(150),
  pen_attribute3                    varchar2(150),
  pen_attribute4                    varchar2(150),
  pen_attribute5                    varchar2(150),
  pen_attribute6                    varchar2(150),
  pen_attribute7                    varchar2(150),
  pen_attribute8                    varchar2(150),
  pen_attribute9                    varchar2(150),
  pen_attribute10                   varchar2(150),
  pen_attribute11                   varchar2(150),
  pen_attribute12                   varchar2(150),
  pen_attribute13                   varchar2(150),
  pen_attribute14                   varchar2(150),
  pen_attribute15                   varchar2(150),
  pen_attribute16                   varchar2(150),
  pen_attribute17                   varchar2(150),
  pen_attribute18                   varchar2(150),
  pen_attribute19                   varchar2(150),
  pen_attribute20                   varchar2(150),
  pen_attribute21                   varchar2(150),
  pen_attribute22                   varchar2(150),
  pen_attribute23                   varchar2(150),
  pen_attribute24                   varchar2(150),
  pen_attribute25                   varchar2(150),
  pen_attribute26                   varchar2(150),
  pen_attribute27                   varchar2(150),
  pen_attribute28                   varchar2(150),
  pen_attribute29                   varchar2(150),
  pen_attribute30                   varchar2(150),
  ...
  bnft_ordr_num                     number(15),
  prtt_enrt_rslt_stat_cd            varchar2(30),
  bnft_nnmntry_uom                  varchar2(30) ,
...
--           p_base_key_value = :prtt_enrt_rslt_id).
--
-- Post Success:
--   Processing continues.
--
...
--
-- ----------------------------------------------------------------------------
-- Bug 3843657 : Added this overloaded procedure to pass p_prtt_enrt_rslt_stat_cd
-- as an extra paramter.
--
Procedure upd_effective_end_date
	(p_effective_date		in date,
	 p_base_key_value		in number,
