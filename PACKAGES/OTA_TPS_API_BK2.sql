--------------------------------------------------------
--  DDL for Package OTA_TPS_API_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TPS_API_BK2" AUTHID CURRENT_USER as
/* $Header: ottpsapi.pkh 120.1 2005/10/02 02:08:40 aroussel $ */
-- ----------------------------------------------------------------------------
-- |-------------------------< update_training_plan_b >------------------------|
-- ----------------------------------------------------------------------------
procedure update_training_plan_b
...
--
-- ----------------------------------------------------------------------------
-- |-------------------------< update_training_plan_a >------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_training_plan_a
  (p_effective_date                in     date
  ,p_training_plan_id              in     number
  ,p_object_version_number         in     number
  ,p_time_period_id                in     number
