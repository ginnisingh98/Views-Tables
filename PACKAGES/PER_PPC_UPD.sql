--------------------------------------------------------
--  DDL for Package PER_PPC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PPC_UPD" AUTHID CURRENT_USER as
...
--     to STRONG unless called from the update proposal api which is trying
--     to update the components of a proposal which is about to change.
--     In this case it should be set to WEAK and the conditions that you
--     cannot change the components of an approved proposal, or change
--     components of a proposal with multiple components set to
--     'N' will be ignored.
--
--
-- Post Success:
