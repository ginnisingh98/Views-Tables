--------------------------------------------------------
--  DDL for Package PER_ENV_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ENV_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cal_entry_value_id
--     already exists.
--
--  In Arguments:
