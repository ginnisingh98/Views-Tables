--------------------------------------------------------
--  DDL for Package ONT_OEXOEOCS_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ONT_OEXOEOCS_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: OEXOEOCSS.pls 120.2 2008/05/05 12:38:41 dwkrishn noship $ */
  ...
  P_ORDER_DATE_HIGH1 VARCHAR2(30);

  P_ORDER_DATE_LOW1 VARCHAR2(30);
  ...
  CP_UNIT3 VARCHAR2(20);

  CP_UNIT4 VARCHAR2(20);
  ...
  FUNCTION ITEM_DSPFORMULA (item_identifier_type in varchar2, IID number, ORDERED_ITEM_ID number, ORDERED_ITEM varchar2,C_ORGANIZATION_ID in varchar2,C_INVENTORY_ITEM_ID in varchar2) RETURN CHAR;
  ...
  FUNCTION C_CURRENCY_CODEFORMULA(CURRENCY2 IN VARCHAR2) RETURN VARCHAR2;

  FUNCTION RP_ORDER_CATEGORYFORMULA RETURN VARCHAR2;

  FUNCTION RP_LINE_CATEGORYFORMULA RETURN VARCHAR2;

  FUNCTION CF_UNIT4FORMULA(UNIT2 IN VARCHAR2) RETURN CHAR;

  FUNCTION CF_UNIT3FORMULA(UNIT1 IN VARCHAR2) RETURN CHAR;

  --FUNCTION C_PRECISIONFORMULA(CURRENCY_CODE IN VARCHAR2) RETURN NUMBER;
  FUNCTION C_PRECISIONFORMULA(P_CURRENCY_CODE IN VARCHAR2) RETURN NUMBER;
  ...
  FUNCTION CP_UNIT3_P RETURN VARCHAR2;

  FUNCTION CP_UNIT4_P RETURN VARCHAR2;
