--------------------------------------------------------
--  DDL for Package IRC_ILC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_ILC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (link_id               number(15)
  ,target_party_id       number(15)
  ,duplicate_set_id      number(15)
  ,status                varchar2(50)
  ,party_id              number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_LINKED_CANDIDATES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
