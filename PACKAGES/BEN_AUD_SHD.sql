--------------------------------------------------------
--  DDL for Package BEN_AUD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_AUD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (cwb_audit_id                    number(15)
  ,group_per_in_ler_id             number(15)
  ,group_pl_id                     number(15)
  ,lf_evt_ocrd_dt                  date
  ,pl_id                           number(15)
  ,group_oipl_id                   number(15)
  ,audit_type_cd                   varchar2(30)
  ,old_val_varchar                 varchar2(200)
  ,new_val_varchar                 varchar2(200)
  ,old_val_number                  number
  ,new_val_number                  number
  ,old_val_date                    date
  ,new_val_date                    date
  ,date_stamp                      date
  ,change_made_by_person_id        number(15)
  ,supporting_information          varchar2(200)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_CWB_AUDIT';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
