--------------------------------------------------------
--  DDL for Package AME_ACF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_ACF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,voting_regime                   varchar2(9)       -- Increased length
  ,order_number                    number(15)
  ,chain_ordering_mode             varchar2(9)       -- Increased length
  ,start_date                      date
  ,end_date                        date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_ACTION_TYPE_CONFIG';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
