--------------------------------------------------------
--  DDL for Package AHL_VWP_TASK_CST_PR_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_VWP_TASK_CST_PR_PVT_W" AUTHID CURRENT_USER as
  /* $Header: AHLWTCPS.pls 120.1 2006/05/04 06:44 anraj noship $ */
