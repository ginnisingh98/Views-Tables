--------------------------------------------------------
--  DDL for Package PAY_OPM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_OPM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,org_payment_method_name         varchar2(80)
  ...
  ,pmeth_information_category      varchar2(30)
  ,pmeth_information1              varchar2(150)
  ,pmeth_information2              varchar2(150)
  ,pmeth_information3              varchar2(150)
  ,pmeth_information4              varchar2(150)
  ,pmeth_information5              varchar2(150)
  ,pmeth_information6              varchar2(150)
  ,pmeth_information7              varchar2(150)
  ,pmeth_information8              varchar2(150)
  ,pmeth_information9              varchar2(150)
  ,pmeth_information10             varchar2(150)
  ,pmeth_information11             varchar2(150)
  ,pmeth_information12             varchar2(150)
  ,pmeth_information13             varchar2(150)
  ,pmeth_information14             varchar2(150)
  ,pmeth_information15             varchar2(150)
  ,pmeth_information16             varchar2(150)
  ,pmeth_information17             varchar2(150)
  ,pmeth_information18             varchar2(150)
  ,pmeth_information19             varchar2(150)
  ,pmeth_information20             varchar2(150)
  ,object_version_number           number(9)
  ,transfer_to_gl_flag             varchar2(30)
  ,cost_payment                    varchar2(30)
  ,cost_cleared_payment            varchar2(30)
  ,cost_cleared_void_payment       varchar2(30)
  ,exclude_manual_payment          varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :org_payment_method_id).
--
-- Post Success:
--   Processing continues.
--
