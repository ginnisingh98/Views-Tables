--------------------------------------------------------
--  DDL for Package BEN_EGN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EGN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  egn_attribute_category            varchar2(30),
  egn_attribute1                    varchar2(150),
  egn_attribute2                    varchar2(150),
  egn_attribute3                    varchar2(150),
  egn_attribute4                    varchar2(150),
  egn_attribute5                    varchar2(150),
  egn_attribute6                    varchar2(150),
  egn_attribute7                    varchar2(150),
  egn_attribute8                    varchar2(150),
  egn_attribute9                    varchar2(150),
  egn_attribute10                   varchar2(150),
  egn_attribute11                   varchar2(150),
  egn_attribute12                   varchar2(150),
  egn_attribute13                   varchar2(150),
  egn_attribute14                   varchar2(150),
  egn_attribute15                   varchar2(150),
  egn_attribute16                   varchar2(150),
  egn_attribute17                   varchar2(150),
  egn_attribute18                   varchar2(150),
  egn_attribute19                   varchar2(150),
  egn_attribute20                   varchar2(150),
  egn_attribute21                   varchar2(150),
  egn_attribute22                   varchar2(150),
  egn_attribute23                   varchar2(150),
  egn_attribute24                   varchar2(150),
  egn_attribute25                   varchar2(150),
  egn_attribute26                   varchar2(150),
  egn_attribute27                   varchar2(150),
  egn_attribute28                   varchar2(150),
  egn_attribute29                   varchar2(150),
  egn_attribute30                   varchar2(150),
  ordr_num			    number(15),
...
--           p_base_key_value = :elig_gndr_prte_id).
--
-- Post Success:
--   Processing continues.
--
