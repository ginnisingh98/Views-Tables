--------------------------------------------------------
--  DDL for Package BEN_APV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_APV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  actl_prem_vrbl_rt_id              number(15),
  ...
  apv_attribute_category            varchar2(30),
  apv_attribute1                    varchar2(150),
  apv_attribute2                    varchar2(150),
  apv_attribute3                    varchar2(150),
  apv_attribute4                    varchar2(150),
  apv_attribute5                    varchar2(150),
  apv_attribute6                    varchar2(150),
  apv_attribute7                    varchar2(150),
  apv_attribute8                    varchar2(150),
  apv_attribute9                    varchar2(150),
  apv_attribute10                   varchar2(150),
  apv_attribute11                   varchar2(150),
  apv_attribute12                   varchar2(150),
  apv_attribute13                   varchar2(150),
  apv_attribute14                   varchar2(150),
  apv_attribute15                   varchar2(150),
  apv_attribute16                   varchar2(150),
  apv_attribute17                   varchar2(150),
  apv_attribute18                   varchar2(150),
  apv_attribute19                   varchar2(150),
  apv_attribute20                   varchar2(150),
  apv_attribute21                   varchar2(150),
  apv_attribute22                   varchar2(150),
  apv_attribute23                   varchar2(150),
  apv_attribute24                   varchar2(150),
  apv_attribute25                   varchar2(150),
  apv_attribute26                   varchar2(150),
  apv_attribute27                   varchar2(150),
  apv_attribute28                   varchar2(150),
  apv_attribute29                   varchar2(150),
  apv_attribute30                   varchar2(150),
...
--           p_base_key_value = :actl_prem_vrbl_rt_id).
--
-- Post Success:
--   Processing continues.
--
