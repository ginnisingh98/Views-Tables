--------------------------------------------------------
--  DDL for Package PER_WORK_INCIDENT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_WORK_INCIDENT_BK2" AUTHID CURRENT_USER as
/* $Header: peincapi.pkh 120.1 2005/10/02 02:17:38 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |-----------------------< update_work_incident_b >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_work_incident_b
...
--
-- ----------------------------------------------------------------------------
-- |-----------------------< update_work_incident_a >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_work_incident_a
  (p_effective_date                in     date
  ,p_incident_id                   in     number
  ,p_object_version_number         in     number
  ,p_incident_reference            in     varchar2
