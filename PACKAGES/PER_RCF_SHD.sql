--------------------------------------------------------
--  DDL for Package PER_RCF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RCF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (rec_activity_for_id             number(15)
  ,business_group_id               number(15)
  ,vacancy_id                      number(15)
  ,rec_activity_id                 number(15)
...
g_tab_nam  constant varchar2(30) := 'PER_RECRUITMENT_ACTIVITY_FOR';
