--------------------------------------------------------
--  DDL for Package PQH_VER_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_VER_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (wrkplc_vldtn_ver_id             number(15)
  ,wrkplc_vldtn_id                 number(15)
  ,version_number                  number(10)
  ,business_group_id               number(15)
  ,tariff_contract_code            varchar2(30)
  ,tariff_group_code               varchar2(30)
  ,remuneration_job_description    varchar2(250)
  ,job_group_id                    number(15)
  ,remuneration_job_id             number(15)
  ,derived_grade_id                number(15)
  ,derived_case_group_id           number(15)
  ,derived_subcasgrp_id            number(15)
  ,user_enterable_grade_id         number(15)
  ,user_enterable_case_group_id    number(15)
  ,user_enterable_subcasgrp_id     number(15)
  ,freeze                          varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_WRKPLC_VLDTN_VERS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
