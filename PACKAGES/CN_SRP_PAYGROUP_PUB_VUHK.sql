--------------------------------------------------------
--  DDL for Package CN_SRP_PAYGROUP_PUB_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CN_SRP_PAYGROUP_PUB_VUHK" AUTHID CURRENT_USER as
-- $Header: cnispgps.pls 120.1 2005/06/10 13:56:14 appldev  $ --+
