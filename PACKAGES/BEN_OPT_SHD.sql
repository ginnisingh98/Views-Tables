--------------------------------------------------------
--  DDL for Package BEN_OPT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_OPT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  opt_attribute_category            varchar2(30),
  opt_attribute1                    varchar2(150),
  opt_attribute2                    varchar2(150),
  opt_attribute3                    varchar2(150),
  opt_attribute4                    varchar2(150),
  opt_attribute5                    varchar2(150),
  opt_attribute6                    varchar2(150),
  opt_attribute7                    varchar2(150),
  opt_attribute8                    varchar2(150),
  opt_attribute9                    varchar2(150),
  opt_attribute10                   varchar2(150),
  opt_attribute11                   varchar2(150),
  opt_attribute12                   varchar2(150),
  opt_attribute13                   varchar2(150),
  opt_attribute14                   varchar2(150),
  opt_attribute15                   varchar2(150),
  opt_attribute16                   varchar2(150),
  opt_attribute17                   varchar2(150),
  opt_attribute18                   varchar2(150),
  opt_attribute19                   varchar2(150),
  opt_attribute20                   varchar2(150),
  opt_attribute21                   varchar2(150),
  opt_attribute22                   varchar2(150),
  opt_attribute23                   varchar2(150),
  opt_attribute24                   varchar2(150),
  opt_attribute25                   varchar2(150),
  opt_attribute26                   varchar2(150),
  opt_attribute27                   varchar2(150),
  opt_attribute28                   varchar2(150),
  opt_attribute29                   varchar2(150),
  opt_attribute30                   varchar2(150),
  object_version_number             number(9),
  rqd_perd_enrt_nenrt_uom           varchar2(30),
  rqd_perd_enrt_nenrt_val           number(15),
  rqd_perd_enrt_nenrt_rl            number(15),
  invk_wv_opt_flag                  varchar2(30),
