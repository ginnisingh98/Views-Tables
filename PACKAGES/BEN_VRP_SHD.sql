--------------------------------------------------------
--  DDL for Package BEN_VRP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_VRP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  vald_rlshp_for_reimb_id           number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  pl_id                             number(15),
  rlshp_typ_cd                      varchar2(30),
  vrp_attribute_category            varchar2(30),
  vrp_attribute1                    varchar2(150),
  vrp_attribute2                    varchar2(150),
  vrp_attribute3                    varchar2(150),
  vrp_attribute4                    varchar2(150),
  vrp_attribute5                    varchar2(150),
  vrp_attribute6                    varchar2(150),
  vrp_attribute7                    varchar2(150),
  vrp_attribute8                    varchar2(150),
  vrp_attribute9                    varchar2(150),
  vrp_attribute10                   varchar2(150),
  vrp_attribute11                   varchar2(150),
  vrp_attribute12                   varchar2(150),
  vrp_attribute13                   varchar2(150),
  vrp_attribute14                   varchar2(150),
  vrp_attribute15                   varchar2(150),
  vrp_attribute16                   varchar2(150),
  vrp_attribute17                   varchar2(150),
  vrp_attribute18                   varchar2(150),
  vrp_attribute19                   varchar2(150),
  vrp_attribute20                   varchar2(150),
  vrp_attribute21                   varchar2(150),
  vrp_attribute22                   varchar2(150),
  vrp_attribute23                   varchar2(150),
  vrp_attribute24                   varchar2(150),
  vrp_attribute25                   varchar2(150),
  vrp_attribute26                   varchar2(150),
  vrp_attribute27                   varchar2(150),
  vrp_attribute28                   varchar2(150),
  vrp_attribute29                   varchar2(150),
  vrp_attribute30                   varchar2(150),
...
--           p_base_key_value = :vald_rlshp_for_reimb_id).
--
-- Post Success:
--   Processing continues.
--
