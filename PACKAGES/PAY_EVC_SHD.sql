--------------------------------------------------------
--  DDL for Package PAY_EVC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EVC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (event_value_change_id           number(15)
  ,effective_start_date            date
  ,effective_end_date              date
  ,event_qualifier_id              number(9)
  ,datetracked_event_id            number(15)
  ,default_event                   varchar2(30)
  ,valid_event                     varchar2(30)
  ,business_group_id               number(9)
  ,legislation_code                varchar2(30)
  ,from_value                      varchar2(80)
  ,to_value                        varchar2(80)
  ,proration_style                 varchar2(30)
  ,qualifier_value                 varchar2(2000)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_EVENT_VALUE_CHANGES_F';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :event_value_change_id).
--
-- Post Success:
