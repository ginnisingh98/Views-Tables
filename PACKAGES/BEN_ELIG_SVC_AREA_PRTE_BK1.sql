--------------------------------------------------------
--  DDL for Package BEN_ELIG_SVC_AREA_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_SVC_AREA_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beesaapi.pkh 120.0 2005/05/28 02:53:50 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_elig_svc_area_prte_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_elig_svc_area_prte_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_elig_svc_area_prte_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_elig_svc_area_prte_a
  (
...
--
end ben_elig_svc_area_prte_bk1;
