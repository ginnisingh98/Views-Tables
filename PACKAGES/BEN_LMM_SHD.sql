--------------------------------------------------------
--  DDL for Package BEN_LMM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LMM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  business_group_id                 number(15),
   lmm_attribute_category           varchar2(30),
   lmm_attribute1                   varchar2(150),
   lmm_attribute2                   varchar2(150),
   lmm_attribute3                   varchar2(150),
   lmm_attribute4                   varchar2(150),
   lmm_attribute5                   varchar2(150),
   lmm_attribute6                   varchar2(150),
   lmm_attribute7                   varchar2(150),
   lmm_attribute8                   varchar2(150),
   lmm_attribute9                   varchar2(150),
   lmm_attribute10                  varchar2(150),
   lmm_attribute11                  varchar2(150),
   lmm_attribute12                  varchar2(150),
   lmm_attribute13                  varchar2(150),
   lmm_attribute14                  varchar2(150),
   lmm_attribute15                  varchar2(150),
   lmm_attribute16                  varchar2(150),
   lmm_attribute17                  varchar2(150),
   lmm_attribute18                  varchar2(150),
   lmm_attribute19                  varchar2(150),
   lmm_attribute20                  varchar2(150),
   lmm_attribute21                  varchar2(150),
   lmm_attribute22                  varchar2(150),
   lmm_attribute23                  varchar2(150),
   lmm_attribute24                  varchar2(150),
   lmm_attribute25                  varchar2(150),
   lmm_attribute26                  varchar2(150),
   lmm_attribute27                  varchar2(150),
   lmm_attribute28                  varchar2(150),
   lmm_attribute29                  varchar2(150),
   lmm_attribute30                  varchar2(150),
...
--           p_base_key_value = :lbr_mmbr_rt_id).
--
-- Post Success:
--   Processing continues.
--
