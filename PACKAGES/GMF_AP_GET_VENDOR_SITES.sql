--------------------------------------------------------
--  DDL for Package GMF_AP_GET_VENDOR_SITES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GMF_AP_GET_VENDOR_SITES" AUTHID CURRENT_USER AS
/* $Header: gmfvndis.pls 120.0 2005/08/30 15:27:51 sschinch noship $ */
