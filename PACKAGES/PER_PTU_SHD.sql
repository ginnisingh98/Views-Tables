--------------------------------------------------------
--  DDL for Package PER_PTU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PTU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  person_type_usage_id              number(15),
  person_id                         number(15),
...
--           p_base_key_value = :person_type_usage_id).
--
-- Post Success:
