--------------------------------------------------------
--  DDL for Package PSP_PSO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_PSO_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (salary_cap_override_id          number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PSP_SALARY_CAP_OVERRIDES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
