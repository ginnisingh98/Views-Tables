--------------------------------------------------------
--  DDL for Package OTA_LPE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_LPE_SHD" AUTHID CURRENT_USER as
/* $Header: otlperhi.pkh 120.2 2005/06/15 03:26:24 jbharath noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (lp_enrollment_id                number
  ,learning_path_id                number(9)
  ,person_id                       number(9)
  ,contact_id                      number(15)
  ,path_status_code                varchar2(30)
  ,enrollment_source_code          varchar2(30)
  ,no_of_mandatory_courses         number(10)
  ,no_of_completed_courses         number(10)
  ,completion_target_date          date
  ,completion_date                  date
  ,creator_person_id               number(10,0)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_LP_ENROLLMENTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
