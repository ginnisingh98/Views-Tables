--------------------------------------------------------
--  DDL for Package PAY_CA_EMP_PRVTAX_INF_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CA_EMP_PRVTAX_INF_BK2" AUTHID CURRENT_USER as
/* $Header: pycprapi.pkh 120.3.12000000.1 2007/01/17 18:12:09 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ca_emp_prvtax_inf_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ca_emp_prvtax_inf_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ca_emp_prvtax_inf_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ca_emp_prvtax_inf_a
  (
   p_emp_province_tax_inf_id        in  number
