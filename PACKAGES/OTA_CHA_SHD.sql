--------------------------------------------------------
--  DDL for Package OTA_CHA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CHA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,start_time_active               varchar2(9)       -- Increased length
  ,end_time_active                 varchar2(9)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_CHATS_B';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
