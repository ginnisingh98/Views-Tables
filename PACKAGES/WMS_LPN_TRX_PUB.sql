--------------------------------------------------------
--  DDL for Package WMS_LPN_TRX_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."WMS_LPN_TRX_PUB" AUTHID CURRENT_USER AS
/* $Header: WMSTRXWS.pls 115.1 2000/06/25 20:04:51 pkm ship        $ */
...
FUNCTION PROCESS_LPN_TRX(p_org_id         IN  NUMBER,
                         ...
                         x_proc_msg      OUT  VARCHAR2 )  RETURN NUMBER;
