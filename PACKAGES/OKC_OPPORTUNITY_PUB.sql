--------------------------------------------------------
--  DDL for Package OKC_OPPORTUNITY_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_OPPORTUNITY_PUB" AUTHID CURRENT_USER AS
/* $Header: OKCPOPPS.pls 120.0 2005/05/25 19:21:06 appldev noship $ */
 ...
 -- GLOBAL VARIABLES
  ...
  G_PKG_NAME			CONSTANT VARCHAR2(200) := 'OKC_OPPORTUNITY_PUB';
