--------------------------------------------------------
--  DDL for Package PQH_FTR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_FTR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (wrkplc_vldtn_jobftr_id          number(15)
  ,wrkplc_vldtn_opr_job_id         number(15)
  ,job_feature_code                varchar2(30)
  ,wrkplc_vldtn_opr_job_type       varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_WRKPLC_VLDTN_JOBFTRS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
