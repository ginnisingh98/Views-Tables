--------------------------------------------------------
--  DDL for Package PQH_OPL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_OPL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (operation_id                    number(15)
  ,operation_number                varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_OPERATIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
