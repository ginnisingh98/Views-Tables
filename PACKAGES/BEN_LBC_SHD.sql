--------------------------------------------------------
--  DDL for Package BEN_LBC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LBC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_bnft_rstrn_ctfn_id            number(15),
  effective_start_date              date,
  effective_end_date                date,
  rqd_flag                          varchar2(30),
  enrt_ctfn_typ_cd                  varchar2(30),
  ctfn_rqd_when_rl                  number(15),
  ler_bnft_rstrn_id                 number(15),
  business_group_id                 number(15),
  lbc_attribute_category            varchar2(30),
  lbc_attribute1                    varchar2(150),
  lbc_attribute2                    varchar2(150),
  lbc_attribute3                    varchar2(150),
  lbc_attribute4                    varchar2(150),
  lbc_attribute5                    varchar2(150),
  lbc_attribute6                    varchar2(150),
  lbc_attribute7                    varchar2(150),
  lbc_attribute8                    varchar2(150),
  lbc_attribute9                    varchar2(150),
  lbc_attribute10                   varchar2(150),
  lbc_attribute11                   varchar2(150),
  lbc_attribute12                   varchar2(150),
  lbc_attribute13                   varchar2(150),
  lbc_attribute14                   varchar2(150),
  lbc_attribute15                   varchar2(150),
  lbc_attribute16                   varchar2(150),
  lbc_attribute17                   varchar2(150),
  lbc_attribute18                   varchar2(150),
  lbc_attribute19                   varchar2(150),
  lbc_attribute20                   varchar2(150),
  lbc_attribute21                   varchar2(150),
  lbc_attribute22                   varchar2(150),
  lbc_attribute23                   varchar2(150),
  lbc_attribute24                   varchar2(150),
  lbc_attribute25                   varchar2(150),
  lbc_attribute26                   varchar2(150),
  lbc_attribute27                   varchar2(150),
  lbc_attribute28                   varchar2(150),
  lbc_attribute29                   varchar2(150),
  lbc_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_bnft_rstrn_ctfn_id).
--
-- Post Success:
--   Processing continues.
--
