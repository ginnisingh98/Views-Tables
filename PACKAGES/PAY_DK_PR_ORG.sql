--------------------------------------------------------
--  DDL for Package PAY_DK_PR_ORG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_DK_PR_ORG" AUTHID CURRENT_USER AS
 /* $Header: pydkprorg.pkh 120.5 2006/01/27 07:00:54 pgopal noship $ */
