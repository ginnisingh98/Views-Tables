--------------------------------------------------------
--  DDL for Package BEN_EOP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EOP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ELIG_ANTHR_PL_PRTE_id             number(15),
  ...
  eop_attribute_category            varchar2(30),
  eop_attribute1                    varchar2(150),
  eop_attribute2                    varchar2(150),
  eop_attribute3                    varchar2(150),
  eop_attribute4                    varchar2(150),
  eop_attribute5                    varchar2(150),
  eop_attribute6                    varchar2(150),
  eop_attribute7                    varchar2(150),
  eop_attribute8                    varchar2(150),
  eop_attribute9                    varchar2(150),
  eop_attribute10                   varchar2(150),
  eop_attribute11                   varchar2(150),
  eop_attribute12                   varchar2(150),
  eop_attribute13                   varchar2(150),
  eop_attribute14                   varchar2(150),
  eop_attribute15                   varchar2(150),
  eop_attribute16                   varchar2(150),
  eop_attribute17                   varchar2(150),
  eop_attribute18                   varchar2(150),
  eop_attribute19                   varchar2(150),
  eop_attribute20                   varchar2(150),
  eop_attribute21                   varchar2(150),
  eop_attribute22                   varchar2(150),
  eop_attribute23                   varchar2(150),
  eop_attribute24                   varchar2(150),
  eop_attribute25                   varchar2(150),
  eop_attribute26                   varchar2(150),
  eop_attribute27                   varchar2(150),
  eop_attribute28                   varchar2(150),
  eop_attribute29                   varchar2(150),
  eop_attribute30                   varchar2(150),
...
--           p_base_key_value = :ELIG_ANTHR_PL_PRTE_id).
--
-- Post Success:
--   Processing continues.
--
...
--   The processing steop are as follows:
