--------------------------------------------------------
--  DDL for Package BEN_EDD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EDD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_dsblty_dgr_prte_id              number(15),
  ...
  edd_attribute_category            varchar2(30),
  edd_attribute1                    varchar2(150),
  edd_attribute2                    varchar2(150),
  edd_attribute3                    varchar2(150),
  edd_attribute4                    varchar2(150),
  edd_attribute5                    varchar2(150),
  edd_attribute6                    varchar2(150),
  edd_attribute7                    varchar2(150),
  edd_attribute8                    varchar2(150),
  edd_attribute9                    varchar2(150),
  edd_attribute10                   varchar2(150),
  edd_attribute11                   varchar2(150),
  edd_attribute12                   varchar2(150),
  edd_attribute13                   varchar2(150),
  edd_attribute14                   varchar2(150),
  edd_attribute15                   varchar2(150),
  edd_attribute16                   varchar2(150),
  edd_attribute17                   varchar2(150),
  edd_attribute18                   varchar2(150),
  edd_attribute19                   varchar2(150),
  edd_attribute20                   varchar2(150),
  edd_attribute21                   varchar2(150),
  edd_attribute22                   varchar2(150),
  edd_attribute23                   varchar2(150),
  edd_attribute24                   varchar2(150),
  edd_attribute25                   varchar2(150),
  edd_attribute26                   varchar2(150),
  edd_attribute27                   varchar2(150),
  edd_attribute28                   varchar2(150),
  edd_attribute29                   varchar2(150),
  edd_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_dsblty_dgr_prte_id).
--
-- Post Success:
--   Processing continues.
--
