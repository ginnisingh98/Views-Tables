--------------------------------------------------------
--  DDL for Package PER_SHA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SHA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  std_holiday_absences_id           number(9),
  date_not_taken                    date,
  person_id                         per_std_holiday_absences.person_id%TYPE,
  standard_holiday_id               number(15),
  actual_date_taken                 date,
  reason                            varchar2(60),
  expired                           varchar2(1),
