--------------------------------------------------------
--  DDL for Package PER_PHN_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PHN_UPD" AUTHID CURRENT_USER as
/* $Header: pephnrhi.pkh 120.0 2005/05/31 14:21:23 appldev noship $ */

-- Added 11i - Rvydyana - 10-DEC-1999
--
-- ----------------------------------------------------------------------------
-- |-----------------------------< convert_defs >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
-- Pre Conditions:
--   This was private function can only be called from the upd process.
--   and has been made public for Quickhire changes
--   Please note this is for Oracle Internal User only
--
-- In Parameters:
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy per_phn_shd.g_rec_type);
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< upd >----------------------------------|
