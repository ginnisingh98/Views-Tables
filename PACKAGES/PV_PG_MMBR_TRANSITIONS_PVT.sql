--------------------------------------------------------
--  DDL for Package PV_PG_MMBR_TRANSITIONS_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PV_PG_MMBR_TRANSITIONS_PVT" AUTHID CURRENT_USER AS
/* $Header: pvxvmbts.pls 115.1 2002/12/10 20:59:19 pukken ship $ */
-- ===============================================================
-- Start of Comments
-- Package name
...
--===================================================================
TYPE mmbr_tran_rec_type IS RECORD
(
...
g_miss_mmbr_tran_rec          mmbr_tran_rec_type := NULL;
TYPE  mmbr_tran_tbl_type      IS TABLE OF mmbr_tran_rec_type INDEX BY BINARY_INTEGER;
g_miss_mmbr_tran_tbl          mmbr_tran_tbl_type;
