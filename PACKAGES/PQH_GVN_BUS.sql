--------------------------------------------------------
--  DDL for Package PQH_GVN_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_GVN_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_level_number_id
--     already exists.
--
--  In Arguments:
--    p_level_number_id
