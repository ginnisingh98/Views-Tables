--------------------------------------------------------
--  DDL for Package BEN_LRC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LRC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_rltd_per_cs_ler_id            number(15),
  effective_start_date              date,
  effective_end_date                date,
  ler_rltd_per_cs_chg_rl            number(15),
  ler_id                            number(15),
  rltd_per_chg_cs_ler_id            number(15),
  business_group_id                 number(15),
  lrc_attribute_category            varchar2(30),
  lrc_attribute1                    varchar2(150),
  lrc_attribute2                    varchar2(150),
  lrc_attribute3                    varchar2(150),
  lrc_attribute4                    varchar2(150),
  lrc_attribute5                    varchar2(150),
  lrc_attribute6                    varchar2(150),
  lrc_attribute7                    varchar2(150),
  lrc_attribute8                    varchar2(150),
  lrc_attribute9                    varchar2(150),
  lrc_attribute10                   varchar2(150),
  lrc_attribute11                   varchar2(150),
  lrc_attribute12                   varchar2(150),
  lrc_attribute13                   varchar2(150),
  lrc_attribute14                   varchar2(150),
  lrc_attribute15                   varchar2(150),
  lrc_attribute16                   varchar2(150),
  lrc_attribute17                   varchar2(150),
  lrc_attribute18                   varchar2(150),
  lrc_attribute19                   varchar2(150),
  lrc_attribute20                   varchar2(150),
  lrc_attribute21                   varchar2(150),
  lrc_attribute22                   varchar2(150),
  lrc_attribute23                   varchar2(150),
  lrc_attribute24                   varchar2(150),
  lrc_attribute25                   varchar2(150),
  lrc_attribute26                   varchar2(150),
  lrc_attribute27                   varchar2(150),
  lrc_attribute28                   varchar2(150),
  lrc_attribute29                   varchar2(150),
  lrc_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_rltd_per_cs_ler_id).
--
-- Post Success:
--   Processing continues.
--
