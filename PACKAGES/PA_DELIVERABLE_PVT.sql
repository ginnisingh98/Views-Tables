--------------------------------------------------------
--  DDL for Package PA_DELIVERABLE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PA_DELIVERABLE_PVT" AUTHID CURRENT_USER AS
/* $Header: PADLVPVS.pls 120.1 2005/08/19 16:21:39 mwasowic noship $ */
...
PROCEDURE Create_Deliverable
    (
     ...
     , p_dlvr_reference         IN   VARCHAR2   := NULL
