--------------------------------------------------------
--  DDL for Package CN_IMP_HEADERS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CN_IMP_HEADERS_PKG" AUTHID CURRENT_USER AS
/* $Header: cntimhrs.pls 115.2 2002/02/05 00:25:54 pkm ship    $*/
...
PROCEDURE insert_row
    ( p_imp_headers_rec IN CN_IMP_HEADERS_PVT.IMP_HEADERS_REC_TYPE);
