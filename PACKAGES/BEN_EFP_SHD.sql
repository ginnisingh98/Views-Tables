--------------------------------------------------------
--  DDL for Package BEN_EFP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EFP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_fl_tm_pt_tm_prte_id          number(15),
  ...
  efp_attribute_category            varchar2(30),
  efp_attribute1                    varchar2(150),
  efp_attribute2                    varchar2(150),
  efp_attribute3                    varchar2(150),
  efp_attribute4                    varchar2(150),
  efp_attribute5                    varchar2(150),
  efp_attribute6                    varchar2(150),
  efp_attribute7                    varchar2(150),
  efp_attribute8                    varchar2(150),
  efp_attribute9                    varchar2(150),
  efp_attribute10                   varchar2(150),
  efp_attribute11                   varchar2(150),
  efp_attribute12                   varchar2(150),
  efp_attribute13                   varchar2(150),
  efp_attribute14                   varchar2(150),
  efp_attribute15                   varchar2(150),
  efp_attribute16                   varchar2(150),
  efp_attribute17                   varchar2(150),
  efp_attribute18                   varchar2(150),
  efp_attribute19                   varchar2(150),
  efp_attribute20                   varchar2(150),
  efp_attribute21                   varchar2(150),
  efp_attribute22                   varchar2(150),
  efp_attribute23                   varchar2(150),
  efp_attribute24                   varchar2(150),
  efp_attribute25                   varchar2(150),
  efp_attribute26                   varchar2(150),
  efp_attribute27                   varchar2(150),
  efp_attribute28                   varchar2(150),
  efp_attribute29                   varchar2(150),
  efp_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_fl_tm_pt_tm_prte_id).
--
-- Post Success:
--   Processing continues.
--
