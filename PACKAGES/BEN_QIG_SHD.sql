--------------------------------------------------------
--  DDL for Package BEN_QIG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_QIG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,ordr_num                        number(15)
  ,qig_attribute_category          varchar2(30)
  ,qig_attribute1                  varchar2(150)
  ,qig_attribute2                  varchar2(150)
  ,qig_attribute3                  varchar2(150)
  ,qig_attribute4                  varchar2(150)
  ,qig_attribute5                  varchar2(150)
  ,qig_attribute6                  varchar2(150)
  ,qig_attribute7                  varchar2(150)
  ,qig_attribute8                  varchar2(150)
  ,qig_attribute9                  varchar2(150)
  ,qig_attribute10                 varchar2(150)
  ,qig_attribute11                 varchar2(150)
  ,qig_attribute12                 varchar2(150)
  ,qig_attribute13                 varchar2(150)
  ,qig_attribute14                 varchar2(150)
  ,qig_attribute15                 varchar2(150)
  ,qig_attribute16                 varchar2(150)
  ,qig_attribute17                 varchar2(150)
  ,qig_attribute18                 varchar2(150)
  ,qig_attribute19                 varchar2(150)
  ,qig_attribute20                 varchar2(150)
  ,qig_attribute21                 varchar2(150)
  ,qig_attribute22                 varchar2(150)
  ,qig_attribute23                 varchar2(150)
  ,qig_attribute24                 varchar2(150)
  ,qig_attribute25                 varchar2(150)
  ,qig_attribute26                 varchar2(150)
  ,qig_attribute27                 varchar2(150)
  ,qig_attribute28                 varchar2(150)
  ,qig_attribute29                 varchar2(150)
  ,qig_attribute30                 varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_QUA_IN_GR_RT_F';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :qua_in_gr_rt_id).
--
-- Post Success:
