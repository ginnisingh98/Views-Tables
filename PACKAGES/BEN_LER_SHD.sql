--------------------------------------------------------
--  DDL for Package BEN_LER_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LER_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  typ_cd                            varchar2(30),
  lf_evt_oper_cd                    varchar2(30),
  short_name                       varchar2(30),
  short_code                       varchar2(30),
  ptnl_ler_trtmt_cd                 varchar2(30),
  ck_rltd_per_elig_flag             varchar2(30),
  ler_eval_rl                       number(15),
  cm_aply_flag                      varchar2(30),
  ovridg_le_flag                    varchar2(30),
  qualg_evt_flag                    varchar2(30),
  whn_to_prcs_cd                    varchar2(30),
  desc_txt                          varchar2(2000),
  tmlns_eval_cd                     varchar2(30),
  tmlns_perd_cd                     varchar2(30),
  tmlns_dys_num                     number(15),
  tmlns_perd_rl                     number(15),
  ocrd_dt_det_cd                    varchar2(30),
  ler_stat_cd                       varchar2(30),
  slctbl_slf_svc_cd                 varchar2(30),
	ss_pcp_disp_cd                    varchar2(30),
  ler_attribute_category            varchar2(30),
  ler_attribute1                    varchar2(150),
  ler_attribute2                    varchar2(150),
  ler_attribute3                    varchar2(150),
  ler_attribute4                    varchar2(150),
  ler_attribute5                    varchar2(150),
  ler_attribute6                    varchar2(150),
  ler_attribute7                    varchar2(150),
  ler_attribute8                    varchar2(150),
  ler_attribute9                    varchar2(150),
  ler_attribute10                   varchar2(150),
  ler_attribute11                   varchar2(150),
  ler_attribute12                   varchar2(150),
  ler_attribute13                   varchar2(150),
  ler_attribute14                   varchar2(150),
  ler_attribute15                   varchar2(150),
  ler_attribute16                   varchar2(150),
  ler_attribute17                   varchar2(150),
  ler_attribute18                   varchar2(150),
  ler_attribute19                   varchar2(150),
  ler_attribute20                   varchar2(150),
  ler_attribute21                   varchar2(150),
  ler_attribute22                   varchar2(150),
  ler_attribute23                   varchar2(150),
  ler_attribute24                   varchar2(150),
  ler_attribute25                   varchar2(150),
  ler_attribute26                   varchar2(150),
  ler_attribute27                   varchar2(150),
  ler_attribute28                   varchar2(150),
  ler_attribute29                   varchar2(150),
  ler_attribute30                   varchar2(150),
