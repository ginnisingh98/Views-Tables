--------------------------------------------------------
--  DDL for Package BEN_XDF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XDF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_ext_dfn_id
--     already exists.
--
--  In Arguments:
...
--
--  Prerequisites:
--    The primary key identified by p_ext_dfn_id already exists.
--
--  In Arguments:
--    p_ext_dfn_id
--
...
function return_legislation_code
  (p_ext_dfn_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
