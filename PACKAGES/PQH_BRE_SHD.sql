--------------------------------------------------------
--  DDL for Package PQH_BRE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_BRE_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_BDGT_POOL_REALLOCTIONS';
