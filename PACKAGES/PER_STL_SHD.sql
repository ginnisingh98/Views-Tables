--------------------------------------------------------
--  DDL for Package PER_STL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_STL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,setup_task_name                 varchar2(240)
  ,setup_task_description          varchar2(240)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_RI_SETUP_TASKS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
