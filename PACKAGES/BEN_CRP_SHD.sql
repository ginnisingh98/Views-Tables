--------------------------------------------------------
--  DDL for Package BEN_CRP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CRP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  cbr_per_in_ler_id                 number(15),
  init_evt_flag                     varchar2(30),
  cnt_num                           number(15),
  per_in_ler_id                     number(15),
  cbr_quald_bnf_id                  number(15),
  prvs_elig_perd_end_dt             date,
  business_group_id                 number(15),
  crp_attribute_category            varchar2(30),
  crp_attribute1                    varchar2(150),
  crp_attribute2                    varchar2(150),
  crp_attribute3                    varchar2(150),
  crp_attribute4                    varchar2(150),
  crp_attribute5                    varchar2(150),
  crp_attribute6                    varchar2(150),
  crp_attribute7                    varchar2(150),
  crp_attribute8                    varchar2(150),
  crp_attribute9                    varchar2(150),
  crp_attribute10                   varchar2(150),
  crp_attribute11                   varchar2(150),
  crp_attribute12                   varchar2(150),
  crp_attribute13                   varchar2(150),
  crp_attribute14                   varchar2(150),
  crp_attribute15                   varchar2(150),
  crp_attribute16                   varchar2(150),
  crp_attribute17                   varchar2(150),
  crp_attribute18                   varchar2(150),
  crp_attribute19                   varchar2(150),
  crp_attribute20                   varchar2(150),
  crp_attribute21                   varchar2(150),
  crp_attribute22                   varchar2(150),
  crp_attribute23                   varchar2(150),
  crp_attribute24                   varchar2(150),
  crp_attribute25                   varchar2(150),
  crp_attribute26                   varchar2(150),
  crp_attribute27                   varchar2(150),
  crp_attribute28                   varchar2(150),
  crp_attribute29                   varchar2(150),
  crp_attribute30                   varchar2(150),
