--------------------------------------------------------
--  DDL for Package HXC_DTL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_DTL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,alias_definition_name           varchar2(80) --Increased length
