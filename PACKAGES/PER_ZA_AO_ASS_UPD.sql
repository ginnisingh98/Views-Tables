--------------------------------------------------------
--  DDL for Package PER_ZA_AO_ASS_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_AO_ASS_UPD" AUTHID CURRENT_USER as
/* $Header: pezaaaup.pkh 115.1 2002/12/05 06:48:56 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< upd >----------------------------------|
-- ----------------------------------------------------------------------------
