--------------------------------------------------------
--  DDL for Package HXC_HTR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_HTR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,application_retrieval_function  varchar2(2000)
  ,application_update_process      varchar2(2000)
  ,appl_validation_process         varchar2(2000)
  ,application_period_function     varchar2(2000)
  ,appl_dynamic_template_process   varchar2(2000)
  ,extension_function1             varchar2(2000)
  ,extension_function2             varchar2(2000)
  );
--
-- ----------------------------------------------------------------------------
