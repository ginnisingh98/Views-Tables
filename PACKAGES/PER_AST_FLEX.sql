--------------------------------------------------------
--  DDL for Package PER_AST_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_AST_FLEX" AUTHID CURRENT_USER as
/* $Header: peastfli.pkh 115.0 99/07/17 18:45:57 porting ship $ */
--
--
-- ----------------------------------------------------------------------------
-- |-------------------------------< df>--------------------------------------|
