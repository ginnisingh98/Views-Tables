--------------------------------------------------------
--  DDL for Package IRC_JBI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_JBI_BUS" AUTHID CURRENT_USER as
...
-- ----------------------------------------------------------------------------
--
Procedure chk_recruitment_activity_id(p_recruitment_activity_id in number);
--
-- ----------------------------------------------------------------------------
-- |---------------------------< chk_unique_item >----------------------------|
-- ----------------------------------------------------------------------------
--
Procedure chk_unique_item(p_job_basket_item_id  in   number );
--
-- ---------------------------------------------------------------------------
...
--
--  Prerequisites:
--    The primary key identified by p_person_id
