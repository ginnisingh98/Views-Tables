--------------------------------------------------------
--  DDL for Package BEN_ELG_PRT_ANTHR_PL_PT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELG_PRT_ANTHR_PL_PT_BK2" AUTHID CURRENT_USER as
/* $Header: beeppapi.pkh 120.0 2005/05/28 02:42:59 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELG_PRT_ANTHR_PL_PT_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELG_PRT_ANTHR_PL_PT_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELG_PRT_ANTHR_PL_PT_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELG_PRT_ANTHR_PL_PT_a
  (
   p_elig_prtt_anthr_pl_prte_id     in  number
...
--
end ben_ELG_PRT_ANTHR_PL_PT_bk2;
