--------------------------------------------------------
--  DDL for Package BEN_ELIG_DPNT_OTHR_PTIP_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_DPNT_OTHR_PTIP_BK1" AUTHID CURRENT_USER as
/* $Header: beetdapi.pkh 120.0 2005/05/28 03:01:18 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_DPNT_OTHR_PTIP_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_DPNT_OTHR_PTIP_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_DPNT_OTHR_PTIP_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_DPNT_OTHR_PTIP_a
  (
...
--
end ben_ELIG_DPNT_OTHR_PTIP_bk1;
