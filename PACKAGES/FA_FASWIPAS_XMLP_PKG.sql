--------------------------------------------------------
--  DDL for Package FA_FASWIPAS_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_FASWIPAS_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: FASWIPASS.pls 120.0.12010000.1 2008/07/28 13:17:52 appldev ship $ */
	P_BOOK	varchar2(15);
