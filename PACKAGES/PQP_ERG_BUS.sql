--------------------------------------------------------
--  DDL for Package PQP_ERG_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_ERG_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_exception_group_id
--     already exists.
--
--  In Arguments:
