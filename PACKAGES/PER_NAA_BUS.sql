--------------------------------------------------------
--  DDL for Package PER_NAA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_NAA_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_absence_action_id
--     already exists.
--
--  In Arguments:
--    p_absence_action_id
