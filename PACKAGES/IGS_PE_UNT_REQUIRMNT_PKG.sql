--------------------------------------------------------
--  DDL for Package IGS_PE_UNT_REQUIRMNT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PE_UNT_REQUIRMNT_PKG" AUTHID CURRENT_USER AS
  /* $Header: IGSNI34S.pls 115.3 2002/11/29 01:22:33 nsidana ship $ */
