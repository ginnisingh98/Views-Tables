--------------------------------------------------------
--  DDL for Package PER_STC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_STC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (component_name                  varchar2(120)
  ,solution_type_name              varchar2(120)
  ,legislation_code                varchar2(30)
  ,api_name                        varchar2(120)
  ,parent_component_name           varchar2(120)
  ,updateable                      varchar2(10)
  ,extensible                      varchar2(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_SOLUTION_TYPE_CMPTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
