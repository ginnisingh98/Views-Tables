--------------------------------------------------------
--  DDL for Package INV_PP_DATECHECK_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."INV_PP_DATECHECK_PVT" AUTHID CURRENT_USER AS
/* $Header: INVVPPDS.pls 115.1 2003/11/12 14:40:29 gbhagra noship $*/
--
