--------------------------------------------------------
--  DDL for Package PQH_CRL_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CRL_UPD" AUTHID CURRENT_USER as
...
--
-- Description:
--   This procedure is updates the name column for each language.
--
-- Pre-requisites:
--   A unique surrogate key ID value is known to exist in the
--   non-translated table.  The row in the non-translated table has been
