--------------------------------------------------------
--  DDL for Package BEN_EMPLOYEE_STATUS_RT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EMPLOYEE_STATUS_RT_BK2" AUTHID CURRENT_USER as
/* $Header: beesrapi.pkh 120.0 2005/05/28 02:58:06 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_EMPLOYEE_STATUS_RT_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_EMPLOYEE_STATUS_RT_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_EMPLOYEE_STATUS_RT_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_EMPLOYEE_STATUS_RT_a
  (
   p_ee_stat_rt_id                  in  number
...
--
end ben_EMPLOYEE_STATUS_RT_bk2;
