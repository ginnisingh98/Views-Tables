--------------------------------------------------------
--  DDL for Package BEN_LDC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LDC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ler_id                            number(15),
  ptip_id                           number(15),
  add_rmv_cvg_cd                    varchar2(30),
  cvg_eff_end_cd                    varchar2(30),
  cvg_eff_strt_cd                   varchar2(30),
  ler_chg_dpnt_cvg_rl               number(15),
  ler_chg_dpnt_cvg_cd               varchar2(30),
  cvg_eff_strt_rl                   number(15),
  cvg_eff_end_rl                    number(15),
  ldc_attribute_category            varchar2(30),
  ldc_attribute1                    varchar2(150),
  ldc_attribute2                    varchar2(150),
  ldc_attribute3                    varchar2(150),
  ldc_attribute4                    varchar2(150),
  ldc_attribute5                    varchar2(150),
  ldc_attribute6                    varchar2(150),
  ldc_attribute7                    varchar2(150),
  ldc_attribute8                    varchar2(150),
  ldc_attribute9                    varchar2(150),
  ldc_attribute10                   varchar2(150),
  ldc_attribute11                   varchar2(150),
  ldc_attribute12                   varchar2(150),
  ldc_attribute13                   varchar2(150),
  ldc_attribute14                   varchar2(150),
  ldc_attribute15                   varchar2(150),
  ldc_attribute16                   varchar2(150),
  ldc_attribute17                   varchar2(150),
  ldc_attribute18                   varchar2(150),
  ldc_attribute19                   varchar2(150),
  ldc_attribute20                   varchar2(150),
  ldc_attribute21                   varchar2(150),
  ldc_attribute22                   varchar2(150),
  ldc_attribute23                   varchar2(150),
  ldc_attribute24                   varchar2(150),
  ldc_attribute25                   varchar2(150),
  ldc_attribute26                   varchar2(150),
  ldc_attribute27                   varchar2(150),
  ldc_attribute28                   varchar2(150),
  ldc_attribute29                   varchar2(150),
  ldc_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_chg_dpnt_cvg_id).
--
-- Post Success:
--   Processing continues.
--
