--------------------------------------------------------
--  DDL for Package PER_RES_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RES_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (cagr_entitlement_result_id      number(15)
  ,assignment_id                   number(11)
  ,start_date                      date
  ,end_date                        date
  ,collective_agreement_id         number(10)
  ,cagr_entitlement_item_id        number(10)
  ...
  ,cagr_entitlement_line_id        number(10)
  ,value                           varchar2(30)
  ,units_of_measure                varchar2(60)
  ,range_from                      varchar2(60)
  ,range_to                        varchar2(60)
  ,grade_spine_id                  number
  ,parent_spine_id                 number(10)
  ,step_id                         number(15)
  ,from_step_id                    number(15)
  ,to_step_id                      number(15)
  ,beneficial_flag                 varchar2(9)       -- Increased length
  ,oipl_id                         number(10)
  ,chosen_flag                     varchar2(9)       -- Increased length
  ,column_type                     varchar2(30)
  ,column_size                     number
  ,cagr_request_id                 number(15)
