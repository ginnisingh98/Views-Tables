--------------------------------------------------------
--  DDL for Package HR_NO_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_NO_APPLICANT_API" AUTHID CURRENT_USER AS
/* $Header: peappnoi.pkh 120.1 2005/10/02 02:38 aroussel $ */
/*#
 * This package contains applicant APIs.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Applicant for Norway
*/
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_no_applicant >------------------------|
...
-- {Start Of Comments}
/*#
 * This API creates a new Norwegian applicant.
 *
 ...
 * The business group for Norway legislation must exist on the effective date.
 ...
 * @param p_marital_status Marital status of the applicant. The lookup type
 ...
 * @param p_social_security_office Social security office of the applicant.
 * @param p_qualification Qualification of the applicant.
 * @param p_nus2000_code Applicant's NUS-2000 code.
 * @param p_grade_point_avg Indicates the academic grade point average of the
 * applicant.
 * @param p_no_of_credits Indicates the number of academic credits of the
 * applicant.
 ...
 * @rep:displayname Create Applicant for Norway
