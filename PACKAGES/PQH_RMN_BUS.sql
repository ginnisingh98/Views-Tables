--------------------------------------------------------
--  DDL for Package PQH_RMN_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RMN_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_rate_matrix_node_id
--     already exists.
--
--  In Arguments:
