--------------------------------------------------------
--  DDL for Package PA_CI_ACTIONS_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PA_CI_ACTIONS_PVT" AUTHID CURRENT_USER as
/* $Header: PACIACVS.pls 120.0 2005/06/03 13:52:45 appldev noship $ */
 ...
 PROCEDURE CLOSE_CI_ACTION
    ...
    p_validate_only       IN     VARCHAR2 := FND_API.g_true,
    p_max_msg_count       IN     NUMBER := FND_API.g_miss_num,
    P_calling_context     IN     VARCHAR2 default 'CLOSE' ,
...
END PA_CI_ACTIONS_PVT; -- Package Specification PA_CI_ACTIONS_PVT
