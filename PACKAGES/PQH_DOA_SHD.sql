--------------------------------------------------------
--  DDL for Package PQH_DOA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_DOA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (document_attribute_id           number(9)             -- Increased length
  ,effective_start_date            date
  ,effective_end_date              date
  ,document_id                     number(15)
  ,attribute_id                    number(15)
  ,tag_name                        varchar2(240)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DOCUMENT_ATTRIBUTES_F';
...
--           p_base_key_value = :document_attribute_id).
--
-- Post Success:
--   Processing continues.
--
