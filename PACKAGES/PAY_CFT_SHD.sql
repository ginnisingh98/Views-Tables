--------------------------------------------------------
--  DDL for Package PAY_CFT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CFT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  other_fedtax_credits              varchar2(11),
  cpp_qpp_exempt_flag               varchar2(30),
  fed_exempt_flag                   varchar2(30),
  ei_exempt_flag                    varchar2(30),
  tax_calc_method                   varchar2(30),
  fed_override_amount               number(11,2),
  fed_override_rate                 number(11,2),
...
--           p_base_key_value = :emp_fed_tax_inf_id).
--
-- Post Success:
--   Processing continues.
--
