--------------------------------------------------------
--  DDL for Package PER_CNF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CNF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,configuration_type              varchar2(60)
  ,configuration_status            varchar2(60)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_RI_CONFIGURATIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
