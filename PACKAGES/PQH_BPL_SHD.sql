--------------------------------------------------------
--  DDL for Package PQH_BPL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_BPL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,parent_pool_id                  number(15)
  ,business_group_id               number(15)
  ,approval_status                 varchar2(30)
  ,wf_transaction_category_id	   number
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_BUDGET_POOLS';
