--------------------------------------------------------
--  DDL for Package AME_ATY_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_ATY_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,dynamic_description             varchar2(9)       -- Increased length
  ,description_query               varchar2(4000)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_ACTION_TYPES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
-- In Parameters:
--   p_new_end_date
--     Specifies the new end date which will be set for the
...
--           p_base_key_value = :action_type_id).
--
-- Post Success:
