--------------------------------------------------------
--  DDL for Package BEN_CLP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CLP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  clpse_lf_evt_id                   number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  seq                               number(15),
  ler1_id                           number(15),
  bool1_cd                          varchar2(30),
  ler2_id                           number(15),
  bool2_cd                          varchar2(30),
  ler3_id                           number(15),
  bool3_cd                          varchar2(30),
  ler4_id                           number(15),
  bool4_cd                          varchar2(30),
  ler5_id                           number(15),
  bool5_cd                          varchar2(30),
  ler6_id                           number(15),
  bool6_cd                          varchar2(30),
  ler7_id                           number(15),
  bool7_cd                          varchar2(30),
  ler8_id                           number(15),
  bool8_cd                          varchar2(30),
  ler9_id                           number(15),
  bool9_cd                          varchar2(30),
  ler10_id                          number(15),
  eval_cd                           varchar2(30),
  eval_rl                           number(15),
  tlrnc_dys_num                     number(15),
  eval_ler_id                       number(15),
  eval_ler_det_cd                   varchar2(30),
  eval_ler_det_rl                   number(15),
  clp_attribute_category            varchar2(30),
  clp_attribute1                    varchar2(150),
  clp_attribute2                    varchar2(150),
  clp_attribute3                    varchar2(150),
  clp_attribute4                    varchar2(150),
  clp_attribute5                    varchar2(150),
  clp_attribute6                    varchar2(150),
  clp_attribute7                    varchar2(150),
  clp_attribute8                    varchar2(150),
  clp_attribute9                    varchar2(150),
  clp_attribute10                   varchar2(150),
  clp_attribute11                   varchar2(150),
  clp_attribute12                   varchar2(150),
  clp_attribute13                   varchar2(150),
  clp_attribute14                   varchar2(150),
  clp_attribute15                   varchar2(150),
  clp_attribute16                   varchar2(150),
  clp_attribute17                   varchar2(150),
  clp_attribute18                   varchar2(150),
  clp_attribute19                   varchar2(150),
  clp_attribute20                   varchar2(150),
  clp_attribute21                   varchar2(150),
  clp_attribute22                   varchar2(150),
  clp_attribute23                   varchar2(150),
  clp_attribute24                   varchar2(150),
  clp_attribute25                   varchar2(150),
  clp_attribute26                   varchar2(150),
  clp_attribute27                   varchar2(150),
  clp_attribute28                   varchar2(150),
  clp_attribute29                   varchar2(150),
  clp_attribute30                   varchar2(150),
...
--           p_base_key_value = :clpse_lf_evt_id).
--
-- Post Success:
--   Processing continues.
--
