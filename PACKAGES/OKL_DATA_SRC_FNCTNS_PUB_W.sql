--------------------------------------------------------
--  DDL for Package OKL_DATA_SRC_FNCTNS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_DATA_SRC_FNCTNS_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUDSFS.pls 120.1 2005/07/08 10:34:57 dkagrawa noship $ */
