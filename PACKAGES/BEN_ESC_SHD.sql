--------------------------------------------------------
--  DDL for Package BEN_ESC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ESC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_stdnt_stat_cvg_id            number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  dpnt_cvg_eligy_prfl_id            number(15),
  cvg_strt_cd                       varchar2(30),
  cvg_strt_rl                       number(15),
  cvg_thru_cd                       varchar2(30),
  cvg_thru_rl                       number(15),
  stdnt_stat_cd                     varchar2(30),
  esc_attribute_category            varchar2(30),
  esc_attribute1                    varchar2(150),
  esc_attribute2                    varchar2(150),
  esc_attribute3                    varchar2(150),
  esc_attribute4                    varchar2(150),
  esc_attribute5                    varchar2(150),
  esc_attribute6                    varchar2(150),
  esc_attribute7                    varchar2(150),
  esc_attribute8                    varchar2(150),
  esc_attribute9                    varchar2(150),
  esc_attribute10                   varchar2(150),
  esc_attribute11                   varchar2(150),
  esc_attribute12                   varchar2(150),
  esc_attribute13                   varchar2(150),
  esc_attribute14                   varchar2(150),
  esc_attribute15                   varchar2(150),
  esc_attribute16                   varchar2(150),
  esc_attribute17                   varchar2(150),
  esc_attribute18                   varchar2(150),
  esc_attribute19                   varchar2(150),
  esc_attribute20                   varchar2(150),
  esc_attribute21                   varchar2(150),
  esc_attribute22                   varchar2(150),
  esc_attribute23                   varchar2(150),
  esc_attribute24                   varchar2(150),
  esc_attribute25                   varchar2(150),
  esc_attribute26                   varchar2(150),
  esc_attribute27                   varchar2(150),
  esc_attribute28                   varchar2(150),
  esc_attribute29                   varchar2(150),
  esc_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_stdnt_stat_cvg_id).
--
-- Post Success:
--   Processing continues.
--
