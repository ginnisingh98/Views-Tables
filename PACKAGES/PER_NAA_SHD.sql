--------------------------------------------------------
--  DDL for Package PER_NAA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_NAA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,document_file_name              varchar2(240)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_NL_ABSENCE_ACTIONS';
