--------------------------------------------------------
--  DDL for Package PA_PURGE_SUMMARY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PA_PURGE_SUMMARY" AUTHID CURRENT_USER as
/* $Header: PAXSUPRS.pls 120.1 2005/08/19 17:21:07 mwasowic noship $ */
...
--                    Calls a seperate procedure to purge each table
-- Parameters       :
--                     p_purge_batch_id  -> Purge batch Id
--                     p_project_id      -> Project Id
--                     p_purge_release   -> The release during which it is
--                                          purged
--                     p_archive_flag    -> set to 'Y' if summary data
--                                          is to be archived
