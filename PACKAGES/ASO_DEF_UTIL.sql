--------------------------------------------------------
--  DDL for Package ASO_DEF_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ASO_DEF_UTIL" AUTHID CURRENT_USER AS
/* $Header: asodutls.pls 120.1 2005/07/01 10:19:36 appldev noship $ */
