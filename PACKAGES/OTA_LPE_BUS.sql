--------------------------------------------------------
--  DDL for Package OTA_LPE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_LPE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_lp_enrollment_id
--     already exists.
--
--  In Arguments:
--    p_lp_enrollment_id
