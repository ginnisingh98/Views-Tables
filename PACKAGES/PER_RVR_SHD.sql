--------------------------------------------------------
--  DDL for Package PER_RVR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RVR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (workbench_item_code             varchar2(60)
  ,workbench_view_report_code      varchar2(60)
  ,workbench_view_report_type      varchar2(80)
  ,workbench_view_report_action    varchar2(520)
  ,workbench_view_country          varchar2(9)       -- Increased length
  ,wb_view_report_instruction      varchar2(240)
  ,object_version_number           number(9)
  ,primary_industry		           varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_RI_VIEW_REPORTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
