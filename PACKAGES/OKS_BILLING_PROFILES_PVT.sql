--------------------------------------------------------
--  DDL for Package OKS_BILLING_PROFILES_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKS_BILLING_PROFILES_PVT" AUTHID CURRENT_USER AS
/* $Header: OKSCBPES.pls 120.0 2005/05/25 18:30:13 appldev noship $ */
  ---------------------------------------------------------------------------
...
/*
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME                     CONSTANT VARCHAR2(200) := 'OKS_BILLING_PROFILES_PVT';
