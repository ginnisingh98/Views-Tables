--------------------------------------------------------
--  DDL for Package INV_LABEL_PVT15
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."INV_LABEL_PVT15" AUTHID CURRENT_USER AS
  /* $Header: INVLA15S.pls 120.0 2005/06/21 02:47:04 fabdi noship $ */

  g_pkg_name CONSTANT VARCHAR2(50) := 'INV_LABEL_PVT15';
  g_lpn_id            NUMBER       := -1;
