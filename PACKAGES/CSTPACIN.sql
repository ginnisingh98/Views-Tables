--------------------------------------------------------
--  DDL for Package CSTPACIN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CSTPACIN" AUTHID CURRENT_USER as
/* $Header: CSTACINS.pls 115.5 2003/02/07 00:11:12 rthng ship $ */
