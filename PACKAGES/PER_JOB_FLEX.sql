--------------------------------------------------------
--  DDL for Package PER_JOB_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_JOB_FLEX" AUTHID CURRENT_USER as
/* $Header: pejobfli.pkh 115.0 99/07/18 13:57:11 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
...
--    descriptive flexfield - 'Additional Job Details'
--    by calling the relevant validation procedures.
--    These are called dependant on the value of the relevant
