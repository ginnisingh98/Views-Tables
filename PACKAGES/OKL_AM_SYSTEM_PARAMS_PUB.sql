--------------------------------------------------------
--  DDL for Package OKL_AM_SYSTEM_PARAMS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_AM_SYSTEM_PARAMS_PUB" AUTHID CURRENT_USER AS
/* $Header: OKLPASAS.pls 115.0 2003/10/17 21:20:21 rmunjulu noship $ */
  ---------------------------------------------------------------------------
  -- GLOBAL DATASTRUCTURES
  ---------------------------------------------------------------------------
  SUBTYPE sypv_rec_type IS OKL_AM_SYSTEM_PARAMS_PVT.sypv_rec_type;
  SUBTYPE sypv_tbl_type IS OKL_AM_SYSTEM_PARAMS_PVT.sypv_tbl_type;
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME            CONSTANT VARCHAR2(200) := 'OKL_AM_SYSTEM_PARAMS_PUB';
