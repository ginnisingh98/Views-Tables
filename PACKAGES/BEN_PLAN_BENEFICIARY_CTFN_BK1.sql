--------------------------------------------------------
--  DDL for Package BEN_PLAN_BENEFICIARY_CTFN_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PLAN_BENEFICIARY_CTFN_BK1" AUTHID CURRENT_USER as
/* $Header: bepcxapi.pkh 120.0 2005/05/28 10:20:54 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Plan_Beneficiary_Ctfn_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Plan_Beneficiary_Ctfn_b
  (
   p_pl_id                          in  number
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Plan_Beneficiary_Ctfn_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Plan_Beneficiary_Ctfn_a
  (
...
--
end ben_Plan_Beneficiary_Ctfn_bk1;
