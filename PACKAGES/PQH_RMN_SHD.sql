--------------------------------------------------------
--  DDL for Package PQH_RMN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RMN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,criteria_short_code             varchar2(30)
  ,node_name                       varchar2(2000)
  ,parent_node_id                  number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_RATE_MATRIX_NODES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
