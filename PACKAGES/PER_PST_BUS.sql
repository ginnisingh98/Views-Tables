--------------------------------------------------------
--  DDL for Package PER_PST_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PST_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_position_structure_id
--     already exists.
--
--  In Arguments:
