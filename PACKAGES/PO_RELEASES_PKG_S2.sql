--------------------------------------------------------
--  DDL for Package PO_RELEASES_PKG_S2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PO_RELEASES_PKG_S2" AUTHID CURRENT_USER as
/* $Header: POXP3PLS.pls 115.5 2003/07/06 18:48:13 dxie ship $ */

/*===========================================================================
  PROCEDURE NAME:	Update_row()

  DESCRIPTION:		Table Handler to update the Release Header
...
/*===========================================================================
  ...
  DESCRIPTION:		Table Handler to Delete the Release Header.
