--------------------------------------------------------
--  DDL for Package BEN_ERG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ERG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ELIG_PERF_RTNG_PRTE_id             	    number(15),
  ...
  erg_attribute_category            varchar2(30),
  erg_attribute1                    varchar2(150),
  erg_attribute2                    varchar2(150),
  erg_attribute3                    varchar2(150),
  erg_attribute4                    varchar2(150),
  erg_attribute5                    varchar2(150),
  erg_attribute6                    varchar2(150),
  erg_attribute7                    varchar2(150),
  erg_attribute8                    varchar2(150),
  erg_attribute9                    varchar2(150),
  erg_attribute10                   varchar2(150),
  erg_attribute11                   varchar2(150),
  erg_attribute12                   varchar2(150),
  erg_attribute13                   varchar2(150),
  erg_attribute14                   varchar2(150),
  erg_attribute15                   varchar2(150),
  erg_attribute16                   varchar2(150),
  erg_attribute17                   varchar2(150),
  erg_attribute18                   varchar2(150),
  erg_attribute19                   varchar2(150),
  erg_attribute20                   varchar2(150),
  erg_attribute21                   varchar2(150),
  erg_attribute22                   varchar2(150),
  erg_attribute23                   varchar2(150),
  erg_attribute24                   varchar2(150),
  erg_attribute25                   varchar2(150),
  erg_attribute26                   varchar2(150),
  erg_attribute27                   varchar2(150),
  erg_attribute28                   varchar2(150),
  erg_attribute29                   varchar2(150),
  erg_attribute30                   varchar2(150),
...
--           p_base_key_value = :ELIG_PERF_RTNG_PRTE_id).
--
-- Post Success:
--   Processing continues.
--
