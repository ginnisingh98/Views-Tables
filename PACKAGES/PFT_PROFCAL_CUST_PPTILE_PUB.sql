--------------------------------------------------------
--  DDL for Package PFT_PROFCAL_CUST_PPTILE_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PFT_PROFCAL_CUST_PPTILE_PUB" AUTHID CURRENT_USER AS
/* $Header: PFTPPCTS.pls 120.1 2006/05/25 10:24:44 ssthiaga noship $ */

---------------------------------------------
--  Package Constants
---------------------------------------------
   g_block                CONSTANT  VARCHAR2(80) := 'FEM.PLSQL.PFT_PROFCAL_CUST_PPTILE_PUB';
...
--------Message Constants--------------
   ...
   G_ENG_PPCT_NO_OP_ROWS_ERR     CONSTANT  VARCHAR2(30) := 'PFT_PPROF_PPCT_NO_OP_ROWS_ERR';
...
/*=============================================================================+
 ...
 |
 | DESCRIPTION
 |   The procedure performs the Profit Percentile Step of the Profit Calculation
 | Step
 |
 | scope - public
 |
