--------------------------------------------------------
--  DDL for Package PER_DPF_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_DPF_FLEX" AUTHID CURRENT_USER as
/* $Header: pedpffli.pkh 115.0 99/07/17 18:54:05 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
