--------------------------------------------------------
--  DDL for Package HR_QSN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_QSN_SHD" AUTHID CURRENT_USER as
...
g_tab_nam  constant varchar2(30) := 'HR_QUESTIONNAIRES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
