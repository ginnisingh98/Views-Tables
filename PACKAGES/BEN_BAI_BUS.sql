--------------------------------------------------------
--  DDL for Package BEN_BAI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BAI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_batch_actn_item_id already exists.
--
--  In Arguments:
...
function return_legislation_code
  (p_batch_actn_item_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
