--------------------------------------------------------
--  DDL for Package XNP_T_DUMMY_U
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XNP_T_DUMMY_U" AUTHID CURRENT_USER AS
/* $Header: XNPTDUMS.pls 120.1 2005/06/24 04:47:35 appldev ship $ */

--Create message procedure for message type T_DUMMY
--
...
--Create process procedure for message type T_DUMMY
--
...
--Create default process procedure for message type T_DUMMY
--
...
--Create validate procedure for message type T_DUMMY
--
...
--Create fire procedure for message type T_DUMMY
--
