--------------------------------------------------------
--  DDL for Package BEN_ELIG_MLTRY_STAT_CVG_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_MLTRY_STAT_CVG_BK2" AUTHID CURRENT_USER as
/* $Header: beemcapi.pkh 120.0 2005/05/28 02:24:35 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_Elig_Mltry_Stat_Cvg_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_Elig_Mltry_Stat_Cvg_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_Elig_Mltry_Stat_Cvg_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_Elig_Mltry_Stat_Cvg_a
  (
   p_elig_mltry_stat_cvg_id         in  number
...
--
end ben_Elig_Mltry_Stat_Cvg_bk2;
