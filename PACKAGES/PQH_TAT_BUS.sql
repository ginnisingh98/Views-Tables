--------------------------------------------------------
--  DDL for Package PQH_TAT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TAT_BUS" AUTHID CURRENT_USER as
...
Procedure populate_attribute_name(
          ...
          p_attr_name_table out nocopy pqh_prvcalc.t_attname_priv);
--
end pqh_tat_bus;
