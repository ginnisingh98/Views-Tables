--------------------------------------------------------
--  DDL for Package BEN_ACTION_TYPE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ACTION_TYPE_BK2" AUTHID CURRENT_USER as
/* $Header: beeatapi.pkh 120.0 2005/05/28 01:46:27 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ACTION_TYPE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ACTION_TYPE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ACTION_TYPE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ACTION_TYPE_a
  (
   p_actn_typ_id                    in  number
  ,p_business_group_id              in  number
  ,p_type_cd                        in  varchar2
