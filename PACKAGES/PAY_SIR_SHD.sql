--------------------------------------------------------
--  DDL for Package PAY_SIR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_SIR_SHD" AUTHID CURRENT_USER as
/* $Header: pysirrhi.pkh 115.2 2003/02/17 16:16:54 arashid noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (iterative_rule_id               number(9)
  ,element_type_id                 number(9)
  ,result_name                     varchar2(80)
  ,iterative_rule_type             varchar2(30)
