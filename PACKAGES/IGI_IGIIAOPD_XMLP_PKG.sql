--------------------------------------------------------
--  DDL for Package IGI_IGIIAOPD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGI_IGIIAOPD_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: IGIIAOPDS.pls 120.0.12010000.1 2008/07/29 08:58:34 appldev ship $ */
  P_BOOK VARCHAR2(15);
  ...
  FUNCTION COST_MOVEMENTFORMULA(BALANCE_TYPE IN VARCHAR2
                               ...
                               ,RECLASS IN NUMBER
                               ,ASSET_COST_TRANSFER IN NUMBER) RETURN NUMBER;
