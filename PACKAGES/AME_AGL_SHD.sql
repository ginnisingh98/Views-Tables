--------------------------------------------------------
--  DDL for Package AME_AGL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_AGL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,user_approval_group_name        varchar2(50)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_APPROVAL_GROUPS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
