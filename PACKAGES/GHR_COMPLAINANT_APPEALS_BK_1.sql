--------------------------------------------------------
--  DDL for Package GHR_COMPLAINANT_APPEALS_BK_1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_COMPLAINANT_APPEALS_BK_1" AUTHID CURRENT_USER as
/* $Header: ghccaapi.pkh 120.1 2005/10/02 01:57:18 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_complainant_appeal_b >------------------|
-- ----------------------------------------------------------------------------
--
procedure create_complainant_appeal_b
...
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_complainant_appeal_a >------------------|
-- ----------------------------------------------------------------------------
--
procedure create_complainant_appeal_a
  (p_effective_date                 in     date
  ,p_complaint_id                   in     number
  ,p_appeal_date                    in     date
  ,p_appealed_to                    in     varchar2
...
end ghr_complainant_appeals_bk_1;
