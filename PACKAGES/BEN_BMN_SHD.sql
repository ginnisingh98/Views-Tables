--------------------------------------------------------
--  DDL for Package BEN_BMN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BMN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  reporting_id                      number(38),
  benefit_action_id                 number(38),
  thread_id                         number(38),
  sequence                          number(38),
  text                              varchar2(2000),
  rep_typ_cd                        varchar2(30),
  error_message_code                varchar2(30),
  national_identifier               varchar2(30),
  related_person_ler_id             number(15),
  temporal_ler_id                   number(15),
  ler_id                            number(15),
  person_id                         number(15),
  pgm_id                            number(15),
  pl_id                             number(15),
  related_person_id                 number(15),
  oipl_id                           number(15),
  pl_typ_id                         number(15),
