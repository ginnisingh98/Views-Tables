--------------------------------------------------------
--  DDL for Package IEX_CO_REPORT_CB_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IEX_CO_REPORT_CB_PVT" AUTHID CURRENT_USER AS
/* $Header: IEXRRCBS.pls 120.0 2004/01/24 03:15:25 appldev noship $ */
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME                    CONSTANT VARCHAR2(200) := 'IEX_CO_REPORT_CB_PVT';
