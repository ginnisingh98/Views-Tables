--------------------------------------------------------
--  DDL for Package PE_PEI_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PE_PEI_FLEX" AUTHID CURRENT_USER as
/* $Header: pepeifli.pkh 115.0 99/07/18 14:14:15 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
