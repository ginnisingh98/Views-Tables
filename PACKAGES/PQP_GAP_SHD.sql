--------------------------------------------------------
--  DDL for Package PQP_GAP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_GAP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,pl_id                           number(10)
  ,last_gap_daily_absence_date     date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQP_GAP_ABSENCE_PLANS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
