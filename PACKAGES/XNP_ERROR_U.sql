--------------------------------------------------------
--  DDL for Package XNP_ERROR_U
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XNP_ERROR_U" AUTHID CURRENT_USER AS
/* $Header: XNPERRRS.pls 120.2 2006/02/13 07:47:33 dputhiye ship $ */

--Create message procedure for message type ERROR
--
...
--Create publish procedure for message type ERROR
--
PROCEDURE PUBLISH  (   XNP$ERROR_CODE VARCHAR2,
  ...
  p_wi_instance_id  IN NUMBER DEFAULT NULL,
  p_fa_instance_id  IN NUMBER  DEFAULT NULL ) ;
--Create send procedure for message type ERROR
--
...
--Create process procedure for message type ERROR
--
...
--Create default process procedure for message type ERROR
--
PROCEDURE DEFAULT_PROCESS (    p_msg_header IN XNP_MESSAGE.MSG_HEADER_REC_TYPE,
  ...
  x_error_code OUT NOCOPY  NUMBER,
  x_error_message  OUT NOCOPY VARCHAR2 ) ;
--Create validate procedure for message type ERROR
--
