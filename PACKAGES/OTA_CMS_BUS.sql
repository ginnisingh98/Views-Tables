--------------------------------------------------------
--  DDL for Package OTA_CMS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CMS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_chat_message_id
--     already exists.
--
--  In Arguments:
--    p_chat_message_id
