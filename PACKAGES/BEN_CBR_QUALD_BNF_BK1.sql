--------------------------------------------------------
--  DDL for Package BEN_CBR_QUALD_BNF_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CBR_QUALD_BNF_BK1" AUTHID CURRENT_USER as
/* $Header: becqbapi.pkh 120.0 2005/05/28 01:19:34 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_CBR_QUALD_BNF_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_CBR_QUALD_BNF_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_CBR_QUALD_BNF_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_CBR_QUALD_BNF_a
  (
