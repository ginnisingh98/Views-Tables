--------------------------------------------------------
--  DDL for Package BEN_XRF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XRF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_ext_rcd_in_file_id
--     already exists.
--
--  In Arguments:
...
--
--  Prerequisites:
--    The primary key identified by p_ext_rcd_in_file_id already exists.
--
--  In Arguments:
--    p_ext_rcd_in_file_id
--
...
function return_legislation_code
  (p_ext_rcd_in_file_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
