--------------------------------------------------------
--  DDL for Package WIP_SUB_OP_RESOURCES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."WIP_SUB_OP_RESOURCES_PKG" AUTHID CURRENT_USER AS
/* $Header: wipsorss.pls 115.10 2004/03/18 23:49:14 ccai ship $ */
...
/*=====================================================================+
 ...
 |   inserts new resources into WIP_OPERATION_RESOURCES for the given
 ...
 |   to WIP_SUB_OPERATIONS before calling this procedure.
 |
 +=====================================================================*/
...
/*=====================================================================+
 ...
 |
 | PURPOSE
 |   Before a resource substitution, we should check whether the primary
 |   resources have already been applied in that operation.  If so, for
 |   costing purposes we should not allow the replacement (for the same
 |   reason that we don't allow the resource to be deleted either).
 |
 |   Returns true if primary resource has been applied or pending.
 |
 | ARGUMENTS
 |   IN
 |     p_org_id                Organization ID
 |     p_wip_entity_id         WIP entity ID
 |     p_op_seq                Operation where res sub is requested
 |     p_sub_group             Substitute group where sub is requested
 |
 | EXCEPTIONS
 |
 | NOTES
