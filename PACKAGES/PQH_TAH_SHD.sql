--------------------------------------------------------
--  DDL for Package PQH_TAH_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TAH_SHD" AUTHID CURRENT_USER as
/* $Header: pqtahrhi.pkh 120.1 2005/09/30 06:12:40 hpandya noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (approval_history_id             number(15)
  ,transaction_history_id          number(15)
  ,transaction_effective_date      date
  ,action                          varchar2(30)
  ,user_name                       varchar2(320)
  ,transaction_item_type           varchar2(9)       -- Increased length
  ,transaction_item_key            varchar2(240)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_SS_APPROVAL_HISTORY';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
