--------------------------------------------------------
--  DDL for Package HXC_HDP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_HDP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (deposit_process_id              number(15)
  ,name                            varchar2(80)
  ,time_source_id                  number(15)
  ,mapping_id                      number
