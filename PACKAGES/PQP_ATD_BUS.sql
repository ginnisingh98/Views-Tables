--------------------------------------------------------
--  DDL for Package PQP_ATD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_ATD_BUS" AUTHID CURRENT_USER as
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
/* The following error message was defined by Ashu Gupta on 08/07/2000 */
