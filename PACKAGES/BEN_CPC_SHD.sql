--------------------------------------------------------
--  DDL for Package BEN_CPC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CPC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  cntnu_prtn_ctfn_typ_id            number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  cntng_prtn_elig_prfl_id           number(15),
  pfd_flag                          varchar2(30),
  lack_ctfn_sspnd_elig_flag         varchar2(30),
  ctfn_rqd_when_rl                  number(15),
  prtn_ctfn_typ_cd                  varchar2(30),
  cpc_attribute_category            varchar2(30),
  cpc_attribute1                    varchar2(150),
  cpc_attribute2                    varchar2(150),
  cpc_attribute3                    varchar2(150),
  cpc_attribute4                    varchar2(150),
  cpc_attribute5                    varchar2(150),
  cpc_attribute6                    varchar2(150),
  cpc_attribute7                    varchar2(150),
  cpc_attribute8                    varchar2(150),
  cpc_attribute9                    varchar2(150),
  cpc_attribute10                   varchar2(150),
  cpc_attribute11                   varchar2(150),
  cpc_attribute12                   varchar2(150),
  cpc_attribute13                   varchar2(150),
  cpc_attribute14                   varchar2(150),
  cpc_attribute15                   varchar2(150),
  cpc_attribute16                   varchar2(150),
  cpc_attribute17                   varchar2(150),
  cpc_attribute18                   varchar2(150),
  cpc_attribute19                   varchar2(150),
  cpc_attribute20                   varchar2(150),
  cpc_attribute21                   varchar2(150),
  cpc_attribute22                   varchar2(150),
  cpc_attribute23                   varchar2(150),
  cpc_attribute24                   varchar2(150),
  cpc_attribute25                   varchar2(150),
  cpc_attribute26                   varchar2(150),
  cpc_attribute27                   varchar2(150),
  cpc_attribute28                   varchar2(150),
  cpc_attribute29                   varchar2(150),
  cpc_attribute30                   varchar2(150),
...
--           p_base_key_value = :cntnu_prtn_ctfn_typ_id).
--
-- Post Success:
--   Processing continues.
--
