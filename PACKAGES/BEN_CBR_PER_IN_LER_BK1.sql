--------------------------------------------------------
--  DDL for Package BEN_CBR_PER_IN_LER_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CBR_PER_IN_LER_BK1" AUTHID CURRENT_USER as
/* $Header: becrpapi.pkh 120.0 2005/05/28 01:21:44 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_CBR_PER_IN_LER_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_CBR_PER_IN_LER_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_CBR_PER_IN_LER_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_CBR_PER_IN_LER_a
  (
