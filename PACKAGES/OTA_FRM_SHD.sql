--------------------------------------------------------
--  DDL for Package OTA_FRM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_FRM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,message_type_flag               varchar2(9)       -- Increased length
  ,allow_html_flag                 varchar2(9)       -- Increased length
  ,allow_attachment_flag           varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_FORUMS_B';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
