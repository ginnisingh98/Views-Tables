--------------------------------------------------------
--  DDL for Package IRC_CMC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_CMC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_communication_id
--     already exists.
--
--  In Arguments:
--    p_communication_id
