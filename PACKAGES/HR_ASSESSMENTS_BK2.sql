--------------------------------------------------------
--  DDL for Package HR_ASSESSMENTS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_ASSESSMENTS_BK2" AUTHID CURRENT_USER as
