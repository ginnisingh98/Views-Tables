--------------------------------------------------------
--  DDL for Package BEN_CPP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CPP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  mn_cvg_amt                        number,
  mn_cvg_rl                         number(15),
  mx_cvg_alwd_amt                   number,
  mx_cvg_incr_alwd_amt              number,
  mx_cvg_incr_wcf_alwd_amt          number,
  mx_cvg_mlt_incr_num               number(15),
  mx_cvg_mlt_incr_wcf_num	    number(15),
  mx_cvg_rl            		    number(15),
  mx_cvg_wcfn_amt                   number,
  ...
  cpp_attribute_category            varchar2(30),
  cpp_attribute1                    varchar2(150),
  cpp_attribute2                    varchar2(150),
  cpp_attribute3                    varchar2(150),
  cpp_attribute4                    varchar2(150),
  cpp_attribute5                    varchar2(150),
  cpp_attribute6                    varchar2(150),
  cpp_attribute7                    varchar2(150),
  cpp_attribute8                    varchar2(150),
  cpp_attribute9                    varchar2(150),
  cpp_attribute10                   varchar2(150),
  cpp_attribute11                   varchar2(150),
  cpp_attribute12                   varchar2(150),
  cpp_attribute13                   varchar2(150),
  cpp_attribute14                   varchar2(150),
  cpp_attribute15                   varchar2(150),
  cpp_attribute16                   varchar2(150),
  cpp_attribute17                   varchar2(150),
  cpp_attribute18                   varchar2(150),
  cpp_attribute19                   varchar2(150),
  cpp_attribute20                   varchar2(150),
  cpp_attribute21                   varchar2(150),
  cpp_attribute22                   varchar2(150),
  cpp_attribute23                   varchar2(150),
  cpp_attribute24                   varchar2(150),
  cpp_attribute25                   varchar2(150),
  cpp_attribute26                   varchar2(150),
  cpp_attribute27                   varchar2(150),
  cpp_attribute28                   varchar2(150),
  cpp_attribute29                   varchar2(150),
  cpp_attribute30                   varchar2(150),
