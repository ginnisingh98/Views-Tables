--------------------------------------------------------
--  DDL for Package PER_CPA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CPA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,column_type                     varchar2(60)
  ,column_size                     number(15)
  ,uom_parameter                   varchar2(60)
  ,uom_lookup                      varchar2(30)
  ,default_uom                     varchar2(30)
  ,hidden                          varchar2(30)
