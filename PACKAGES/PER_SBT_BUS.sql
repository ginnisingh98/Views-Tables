--------------------------------------------------------
--  DDL for Package PER_SBT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SBT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_subjects_taken_id
--     already exists.
--
--  In Arguments:
--    p_subjects_taken_id
