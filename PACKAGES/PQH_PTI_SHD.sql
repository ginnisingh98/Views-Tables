--------------------------------------------------------
--  DDL for Package PQH_PTI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_PTI_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  active_inactive_flag              varchar2(9),      -- Increased length
  description                       varchar2(240),
  multiple_occurences_flag          varchar2(9),      -- Increased length
