--------------------------------------------------------
--  DDL for Package PER_ABV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ABV_SHD" AUTHID CURRENT_USER as
...
-- ----------------------------------------------------------------------------
--
-- Changed column value from number(22,2) => number(25,5)
-- as a part of Bug fix 2172818

Type g_rec_type Is Record
  (assignment_budget_value_id      number(15)
...
--           p_base_key_value = :assignment_budget_value_id).
--
-- Post Success:
--   Processing continues.
--
...
Function convert_args
  (p_assignment_budget_value_id     in number default null
