--------------------------------------------------------
--  DDL for Package OTA_FINANCE_HEADER_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_FINANCE_HEADER_BK2" AUTHID CURRENT_USER as
/* $Header: ottfhapi.pkh 120.3 2006/08/30 09:49:56 niarora noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  OTA_FINANCE_HEADER_BK2.';
--
-- ----------------------------------------------------------------------------
-- |-------------------------< UPDATE_FINANCE_HEADER_B >----------------------|
-- ----------------------------------------------------------------------------
-- {Start Of Comments}
--
-- Description:
