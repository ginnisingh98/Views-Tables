--------------------------------------------------------
--  DDL for Package PJI_FM_PLAN_CAL_RLPS_T
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PJI_FM_PLAN_CAL_RLPS_T" AUTHID CURRENT_USER AS
/* $Header: PJIPP05S.pls 120.1.12010000.2 2009/10/30 12:22:54 arbandyo ship $ */
...
PROCEDURE CREATE_FP_PA_PRI_ROLLUP (
  p_honor_rbs  IN VARCHAR2 := 'Y' ); -- 4632551
...
, p_calendar_type IN VARCHAR2 ); -- 4632551 /* Modified for bug 9067086 */
