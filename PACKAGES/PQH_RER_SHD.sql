--------------------------------------------------------
--  DDL for Package PQH_RER_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RER_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (rate_element_relation_id        number(15)
  ,criteria_rate_element_id        number(15)
  ,relation_type_cd                varchar2(30)
  ,rel_element_type_id             number(15)
  ,rel_input_value_id              number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_RATE_ELEMENT_RELATIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
