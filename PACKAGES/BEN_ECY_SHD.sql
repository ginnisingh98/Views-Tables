--------------------------------------------------------
--  DDL for Package BEN_ECY_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ECY_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ELIG_COMPTNCY_PRTE_id             number(15),
  ...
  ecy_attribute_category            varchar2(30),
  ecy_attribute1                    varchar2(150),
  ecy_attribute2                    varchar2(150),
  ecy_attribute3                    varchar2(150),
  ecy_attribute4                    varchar2(150),
  ecy_attribute5                    varchar2(150),
  ecy_attribute6                    varchar2(150),
  ecy_attribute7                    varchar2(150),
  ecy_attribute8                    varchar2(150),
  ecy_attribute9                    varchar2(150),
  ecy_attribute10                   varchar2(150),
  ecy_attribute11                   varchar2(150),
  ecy_attribute12                   varchar2(150),
  ecy_attribute13                   varchar2(150),
  ecy_attribute14                   varchar2(150),
  ecy_attribute15                   varchar2(150),
  ecy_attribute16                   varchar2(150),
  ecy_attribute17                   varchar2(150),
  ecy_attribute18                   varchar2(150),
  ecy_attribute19                   varchar2(150),
  ecy_attribute20                   varchar2(150),
  ecy_attribute21                   varchar2(150),
  ecy_attribute22                   varchar2(150),
  ecy_attribute23                   varchar2(150),
  ecy_attribute24                   varchar2(150),
  ecy_attribute25                   varchar2(150),
  ecy_attribute26                   varchar2(150),
  ecy_attribute27                   varchar2(150),
  ecy_attribute28                   varchar2(150),
  ecy_attribute29                   varchar2(150),
  ecy_attribute30                   varchar2(150),
...
--           p_base_key_value = :ELIG_COMPTNCY_PRTE_id).
--
-- Post Success:
--   Processing continues.
--
...
--   The processing stecy are as follows:
