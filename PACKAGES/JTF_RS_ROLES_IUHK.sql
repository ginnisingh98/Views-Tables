--------------------------------------------------------
--  DDL for Package JTF_RS_ROLES_IUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_RS_ROLES_IUHK" AUTHID CURRENT_USER AS
  /* $Header: jtfrsnos.pls 120.0 2005/05/11 08:20:53 appldev ship $ */
