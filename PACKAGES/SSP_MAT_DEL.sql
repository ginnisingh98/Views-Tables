--------------------------------------------------------
--  DDL for Package SSP_MAT_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."SSP_MAT_DEL" AUTHID CURRENT_USER as
/* $Header: spmatrhi.pkh 120.1 2006/08/23 09:33:36 kthampan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< del >----------------------------------|
-- ----------------------------------------------------------------------------
