--------------------------------------------------------
--  DDL for Package PAY_CA_EOY_T4A_AMEND_ARCH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CA_EOY_T4A_AMEND_ARCH" AUTHID CURRENT_USER AS
/* $Header: pycat4aca.pkh 120.0.12000000.1 2007/01/17 17:29:08 appldev noship $ */
/*
   ******************************************************************
   *                                                                *
   ...
   ******************************************************************
   ...
   -----------  ----------  -----  -------  -----------------------------------
   27-AUG-2004  SSouresr    115.0            Created.
*/
