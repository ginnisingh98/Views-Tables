--------------------------------------------------------
--  DDL for Package EAM_RES_VALIDATE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."EAM_RES_VALIDATE_PVT" AUTHID CURRENT_USER AS
/* $Header: EAMVRSVS.pls 115.1 2002/11/24 23:55:30 baroy noship $ */
/***************************************************************************
--
...
--  DESCRIPTION
--
--      Spec of package EAM_RES_VALIDATE_PVT
--
--  NOTES
--
--  HISTORY
