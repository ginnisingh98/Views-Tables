--------------------------------------------------------
--  DDL for Package PQH_OPG_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_OPG_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_operation_group_id
--     already exists.
--
--  In Arguments:
