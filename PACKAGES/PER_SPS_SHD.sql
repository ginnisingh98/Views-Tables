--------------------------------------------------------
--  DDL for Package PER_SPS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SPS_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_SPINAL_POINT_STEPS_F';
