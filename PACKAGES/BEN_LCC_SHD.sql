--------------------------------------------------------
--  DDL for Package BEN_LCC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LCC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_chg_dpnt_cvg_ctfn_id          number(15),
  effective_start_date              date,
  effective_end_date                date,
  dpnt_cvg_ctfn_typ_cd              varchar2(30),
  rlshp_typ_cd			    varchar2(30),
  ctfn_rqd_when_rl		    number(15),
  lack_ctfn_sspnd_enrt_flag	    varchar2(30),
  rqd_flag			    varchar2(30),
  ler_chg_dpnt_cvg_id               number(15),
  business_group_id                 number(15),
  lcc_attribute_category            varchar2(30),
  lcc_attribute1                    varchar2(150),
  lcc_attribute2                    varchar2(150),
  lcc_attribute3                    varchar2(150),
  lcc_attribute4                    varchar2(150),
  lcc_attribute5                    varchar2(150),
  lcc_attribute6                    varchar2(150),
  lcc_attribute7                    varchar2(150),
  lcc_attribute8                    varchar2(150),
  lcc_attribute9                    varchar2(150),
  lcc_attribute10                   varchar2(150),
  lcc_attribute11                   varchar2(150),
  lcc_attribute12                   varchar2(150),
  lcc_attribute13                   varchar2(150),
  lcc_attribute14                   varchar2(150),
  lcc_attribute15                   varchar2(150),
  lcc_attribute16                   varchar2(150),
  lcc_attribute17                   varchar2(150),
  lcc_attribute18                   varchar2(150),
  lcc_attribute19                   varchar2(150),
  lcc_attribute20                   varchar2(150),
  lcc_attribute21                   varchar2(150),
  lcc_attribute22                   varchar2(150),
  lcc_attribute23                   varchar2(150),
  lcc_attribute24                   varchar2(150),
  lcc_attribute25                   varchar2(150),
  lcc_attribute26                   varchar2(150),
  lcc_attribute27                   varchar2(150),
  lcc_attribute28                   varchar2(150),
  lcc_attribute29                   varchar2(150),
  lcc_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_chg_dpnt_cvg_ctfn_id).
--
-- Post Success:
--   Processing continues.
--
