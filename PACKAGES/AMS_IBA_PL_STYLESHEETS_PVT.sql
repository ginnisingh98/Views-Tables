--------------------------------------------------------
--  DDL for Package AMS_IBA_PL_STYLESHEETS_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_IBA_PL_STYLESHEETS_PVT" AUTHID CURRENT_USER AS
/* $Header: amsvstys.pls 120.0 2005/06/01 01:01:27 appldev noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
...
--===================================================================
TYPE iba_pl_stylesheets_rec_type IS RECORD
(
       stylesheet_id                   NUMBER := FND_API.G_MISS_NUM,
       content_type                    VARCHAR2(30) := FND_API.G_MISS_CHAR,
       stylesheet_filename             VARCHAR2(500) := FND_API.G_MISS_CHAR,
...
g_miss_iba_pl_stylesheets_rec          iba_pl_stylesheets_rec_type;
TYPE  iba_pl_stylesheets_tbl_type      IS TABLE OF iba_pl_stylesheets_rec_type INDEX BY BINARY_INTEGER;
g_miss_iba_pl_stylesheets_tbl          iba_pl_stylesheets_tbl_type;

--   ==============================================================================
--    Start of Comments
--   ==============================================================================
--   API Name
--           Create_Iba_Pl_Stylesheets
--   Type
--           Private
--   Pre-Req
--
...
--       p_iba_pl_stylesheets_rec  IN   iba_pl_stylesheets_rec_type  Required
--
--   OUT
