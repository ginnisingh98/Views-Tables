--------------------------------------------------------
--  DDL for Package PER_ENV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ENV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (cal_entry_value_id              number(15)
  ,calendar_entry_id               number(15)
  ,hierarchy_node_id               number(15)
  ,value                           varchar2(255)
  ,org_structure_element_id        number(15)
  ,organization_id                 number(15)
  ,usage_flag                      varchar2(15)
  ,override_name                   varchar2(80)
  ,override_type                   varchar2(30)
  ,parent_entry_value_id           number(15)
  ,identifier_key                  varchar2(60)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_CAL_ENTRY_VALUES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
