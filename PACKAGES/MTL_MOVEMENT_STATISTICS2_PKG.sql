--------------------------------------------------------
--  DDL for Package MTL_MOVEMENT_STATISTICS2_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."MTL_MOVEMENT_STATISTICS2_PKG" AUTHID CURRENT_USER as
/* $Header: INVTTM2S.pls 120.0 2005/05/25 06:52:20 appldev noship $ */
