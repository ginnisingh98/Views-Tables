--------------------------------------------------------
--  DDL for Package PQP_ERT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_ERT_SHD" AUTHID CURRENT_USER as
...
Procedure load_row  (
                         ...
                         ,p_output_format_type     IN VARCHAr2  default null
                         ,p_variance_operator      IN VARCHAr2  default null
                         ,p_type                   IN VARCHAR2 );
--------------------------------------------------------------------------------
