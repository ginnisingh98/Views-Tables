--------------------------------------------------------
--  DDL for Package BEN_EMP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EMP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_mrtl_sts_prte_id            number(15),
  ...
  emp_attribute_category            varchar2(30),
  emp_attribute1                    varchar2(150),
  emp_attribute2                    varchar2(150),
  emp_attribute3                    varchar2(150),
  emp_attribute4                    varchar2(150),
  emp_attribute5                    varchar2(150),
  emp_attribute6                    varchar2(150),
  emp_attribute7                    varchar2(150),
  emp_attribute8                    varchar2(150),
  emp_attribute9                    varchar2(150),
  emp_attribute10                   varchar2(150),
  emp_attribute11                   varchar2(150),
  emp_attribute12                   varchar2(150),
  emp_attribute13                   varchar2(150),
  emp_attribute14                   varchar2(150),
  emp_attribute15                   varchar2(150),
  emp_attribute16                   varchar2(150),
  emp_attribute17                   varchar2(150),
  emp_attribute18                   varchar2(150),
  emp_attribute19                   varchar2(150),
  emp_attribute20                   varchar2(150),
  emp_attribute21                   varchar2(150),
  emp_attribute22                   varchar2(150),
  emp_attribute23                   varchar2(150),
  emp_attribute24                   varchar2(150),
  emp_attribute25                   varchar2(150),
  emp_attribute26                   varchar2(150),
  emp_attribute27                   varchar2(150),
  emp_attribute28                   varchar2(150),
  emp_attribute29                   varchar2(150),
  emp_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_mrtl_sts_prte_id).
--
-- Post Success:
--   Processing continues.
--
