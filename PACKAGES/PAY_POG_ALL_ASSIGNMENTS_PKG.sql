--------------------------------------------------------
--  DDL for Package PAY_POG_ALL_ASSIGNMENTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_POG_ALL_ASSIGNMENTS_PKG" AUTHID CURRENT_USER AS
/* $Header: pypogasg.pkh 120.0 2005/09/10 03:52:09 psnellin noship $ */
--
dyt_mode varchar2(30);
--
