--------------------------------------------------------
--  DDL for Package BEN_PGR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PGR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  pgr_attribute_category            varchar2(30),
  pgr_attribute1                    varchar2(150),
  pgr_attribute2                    varchar2(150),
  pgr_attribute3                    varchar2(150),
  pgr_attribute4                    varchar2(150),
  pgr_attribute5                    varchar2(150),
  pgr_attribute6                    varchar2(150),
  pgr_attribute7                    varchar2(150),
  pgr_attribute8                    varchar2(150),
  pgr_attribute9                    varchar2(150),
  pgr_attribute10                   varchar2(150),
  pgr_attribute11                   varchar2(150),
  pgr_attribute12                   varchar2(150),
  pgr_attribute13                   varchar2(150),
  pgr_attribute14                   varchar2(150),
  pgr_attribute15                   varchar2(150),
  pgr_attribute16                   varchar2(150),
  pgr_attribute17                   varchar2(150),
  pgr_attribute18                   varchar2(150),
  pgr_attribute19                   varchar2(150),
  pgr_attribute20                   varchar2(150),
  pgr_attribute21                   varchar2(150),
  pgr_attribute22                   varchar2(150),
  pgr_attribute23                   varchar2(150),
  pgr_attribute24                   varchar2(150),
  pgr_attribute25                   varchar2(150),
  pgr_attribute26                   varchar2(150),
  pgr_attribute27                   varchar2(150),
  pgr_attribute28                   varchar2(150),
  pgr_attribute29                   varchar2(150),
  pgr_attribute30                   varchar2(150),
...
--           p_base_key_value = :ppl_grp_rt_id).
--
-- Post Success:
--   Processing continues.
--
