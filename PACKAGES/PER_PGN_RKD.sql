--------------------------------------------------------
--  DDL for Package PER_PGN_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PGN_RKD" AUTHID CURRENT_USER as
/* $Header: pepgnrhi.pkh 120.0 2005/05/31 14:10:14 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |----------------------------< after_delete >------------------------------|
-- ----------------------------------------------------------------------------
...
procedure after_delete
  ...
  ,p_entity_id_o                  in varchar2
  ,p_hierarchy_version_id_o       in number
  ,p_node_type_o                  in varchar2
  ,p_seq_o                        in number
  ,p_parent_hierarchy_node_id_o   in number
