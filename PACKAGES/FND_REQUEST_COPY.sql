--------------------------------------------------------
--  DDL for Package FND_REQUEST_COPY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FND_REQUEST_COPY" AUTHID CURRENT_USER as
/* $Header: AFRSCPRS.pls 115.1 99/07/16 23:26:41 porting sh $ */
procedure request_args(
  ...
  attribute99 in out varchar2, attribute100 in out varchar2);
