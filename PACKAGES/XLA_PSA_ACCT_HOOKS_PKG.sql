--------------------------------------------------------
--  DDL for Package XLA_PSA_ACCT_HOOKS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XLA_PSA_ACCT_HOOKS_PKG" AUTHID CURRENT_USER AS
-- $Header: xlaappsh.pkh 120.0 2005/08/17 18:27:11 wychan noship $
/*===========================================================================+
...
END xla_psa_acct_hooks_pkg; -- end of package spec.
