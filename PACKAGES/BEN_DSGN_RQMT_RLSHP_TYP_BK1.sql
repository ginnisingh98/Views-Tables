--------------------------------------------------------
--  DDL for Package BEN_DSGN_RQMT_RLSHP_TYP_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DSGN_RQMT_RLSHP_TYP_BK1" AUTHID CURRENT_USER as
/* $Header: bedrrapi.pkh 120.0 2005/05/28 01:40:08 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_DSGN_RQMT_RLSHP_TYP_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_DSGN_RQMT_RLSHP_TYP_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_DSGN_RQMT_RLSHP_TYP_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_DSGN_RQMT_RLSHP_TYP_a
  (
...
--
end ben_DSGN_RQMT_RLSHP_TYP_bk1;
