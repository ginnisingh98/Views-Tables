--------------------------------------------------------
--  DDL for Package PAY_AMT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_AMT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_module_type_id
--     already exists.
--
--  In Arguments:
--    p_module_type_id
