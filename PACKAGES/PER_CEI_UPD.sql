--------------------------------------------------------
--  DDL for Package PER_CEI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CEI_UPD" AUTHID CURRENT_USER as
...
Procedure upd
  ...
  ,p_auto_create_entries_flag     in varchar2  default hr_api.g_varchar2 -- Added for CEI enhancement
  );
--
end per_cei_upd;
