--------------------------------------------------------
--  DDL for Package PER_OSV_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_OSV_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_org_structure_version_id
--     already exists.
--
--  In Arguments:
