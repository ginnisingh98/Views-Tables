--------------------------------------------------------
--  DDL for Package PER_ZA_EQT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_EQT_UPD" AUTHID CURRENT_USER as
/* $Header: pezaequp.pkh 115.1 2002/12/05 06:35:47 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< upd >----------------------------------|
-- ----------------------------------------------------------------------------
