--------------------------------------------------------
--  DDL for Package BEN_PCT_FULL_TIME_RATE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PCT_FULL_TIME_RATE_BK1" AUTHID CURRENT_USER as
/* $Header: bepfrapi.pkh 120.0 2005/05/28 10:43:12 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_PCT_FULL_TIME_RATE_b >-----------------|
-- ----------------------------------------------------------------------------
--
