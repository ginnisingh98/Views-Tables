--------------------------------------------------------
--  DDL for Package PAY_CNU_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CNU_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_contribution_usage_id
--     already exists.
--
--  In Arguments:
