--------------------------------------------------------
--  DDL for Package PQP_ALIEN_TRANS_DATA_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_ALIEN_TRANS_DATA_BK2" AUTHID CURRENT_USER as
/* $Header: pqatdapi.pkh 120.0 2005/05/29 01:42:31 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_alien_trans_data_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_alien_trans_data_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_alien_trans_data_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_alien_trans_data_a
  (
   p_alien_transaction_id           in  number
  ,p_person_id                      in  number
  ,p_data_source_type               in  varchar2
