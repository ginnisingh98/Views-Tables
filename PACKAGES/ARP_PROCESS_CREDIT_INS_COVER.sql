--------------------------------------------------------
--  DDL for Package ARP_PROCESS_CREDIT_INS_COVER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARP_PROCESS_CREDIT_INS_COVER" AUTHID CURRENT_USER AS
/* $Header: ARTCCMIS.pls 115.7 2002/11/15 03:30:33 anukumar ship $ */
