--------------------------------------------------------
--  DDL for Package CN_POST_COL_TAE_PUB_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CN_POST_COL_TAE_PUB_VUHK" AUTHID CURRENT_USER AS
--$Header: cnipcols.pls 115.0 2003/09/17 01:03:40 fting noship $
