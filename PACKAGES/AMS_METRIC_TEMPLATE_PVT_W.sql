--------------------------------------------------------
--  DDL for Package AMS_METRIC_TEMPLATE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_METRIC_TEMPLATE_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswmths.pls 115.4 2003/10/12 09:59:22 sunkumar ship $ */
