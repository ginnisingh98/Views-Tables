--------------------------------------------------------
--  DDL for Package OKL_AM_SEND_FULFILLMENT_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_AM_SEND_FULFILLMENT_PVT_W" AUTHID CURRENT_USER as
  /* $Header: OKLESFWS.pls 115.9 2002/12/13 19:34:31 gkadarka noship $ */
