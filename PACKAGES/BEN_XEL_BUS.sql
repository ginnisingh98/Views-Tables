--------------------------------------------------------
--  DDL for Package BEN_XEL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XEL_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_ext_data_elmt_id
--     already exists.
--
--  In Arguments:
--    p_ext_data_elmt_id
...
--
--  Prerequisites:
--    The primary key identified by p_ext_data_elmt_id already exists.
--
--  In Arguments:
--    p_ext_data_elmt_id
--
...
function return_legislation_code
  (p_ext_data_elmt_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
