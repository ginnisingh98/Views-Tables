--------------------------------------------------------
--  DDL for Package XNP_LI_DONE_U
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XNP_LI_DONE_U" AUTHID CURRENT_USER AS
/* $Header: XNPLIDNS.pls 115.5 2000/03/29 16:20:15 pkm ship     $ */


--Create message procedure for message type LI_DONE
--
...
--Create publish procedure for message type LI_DONE
...
--Create send procedure for message type LI_DONE
--
...
--Create process procedure for message type LI_DONE
--
...
--Create default process procedure for message type LI_DONE
PROCEDURE DEFAULT_PROCESS (    p_msg_header IN XNP_MESSAGE.MSG_HEADER_REC_TYPE,
  p_msg_text IN VARCHAR2,
  x_error_code OUT  NUMBER,
  x_error_message  OUT VARCHAR2 ) ;
--Create validate procedure for message type LI_DONE
