--------------------------------------------------------
--  DDL for Package HXC_HAS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_HAS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_approval_style_id
--     already exists.
--
--  In Arguments:
--    p_approval_style_id
