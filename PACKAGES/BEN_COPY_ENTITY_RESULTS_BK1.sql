--------------------------------------------------------
--  DDL for Package BEN_COPY_ENTITY_RESULTS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_COPY_ENTITY_RESULTS_BK1" AUTHID CURRENT_USER as
/* $Header: becpeapi.pkh 120.0 2005/05/28 01:12:11 appldev noship $  */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_copy_entity_results_b >-----------------|
-- ----------------------------------------------------------------------------
--
