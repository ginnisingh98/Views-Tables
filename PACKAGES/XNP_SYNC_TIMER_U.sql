--------------------------------------------------------
--  DDL for Package XNP_SYNC_TIMER_U
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XNP_SYNC_TIMER_U" AUTHID CURRENT_USER AS
/* $Header: XNPSYTIS.pls 120.2 2006/02/13 07:56:46 dputhiye ship $ */

--Create message procedure for message type SYNC_TIMER
--
...
--Create process procedure for message type SYNC_TIMER
--
...
--Create default process procedure for message type SYNC_TIMER
--
...
--Create validate procedure for message type SYNC_TIMER
--
...
--Create fire procedure for message type  SYNC_TIMER
--
