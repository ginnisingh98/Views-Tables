--------------------------------------------------------
--  DDL for Package BEN_EBU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EBU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_brgng_unit_prte_id           number(15),
  ...
  ebu_attribute_category            varchar2(30),
  ebu_attribute1                    varchar2(150),
  ebu_attribute2                    varchar2(150),
  ebu_attribute3                    varchar2(150),
  ebu_attribute4                    varchar2(150),
  ebu_attribute5                    varchar2(150),
  ebu_attribute6                    varchar2(150),
  ebu_attribute7                    varchar2(150),
  ebu_attribute8                    varchar2(150),
  ebu_attribute9                    varchar2(150),
  ebu_attribute10                   varchar2(150),
  ebu_attribute11                   varchar2(150),
  ebu_attribute12                   varchar2(150),
  ebu_attribute13                   varchar2(150),
  ebu_attribute14                   varchar2(150),
  ebu_attribute15                   varchar2(150),
  ebu_attribute16                   varchar2(150),
  ebu_attribute17                   varchar2(150),
  ebu_attribute18                   varchar2(150),
  ebu_attribute19                   varchar2(150),
  ebu_attribute20                   varchar2(150),
  ebu_attribute21                   varchar2(150),
  ebu_attribute22                   varchar2(150),
  ebu_attribute23                   varchar2(150),
  ebu_attribute24                   varchar2(150),
  ebu_attribute25                   varchar2(150),
  ebu_attribute26                   varchar2(150),
  ebu_attribute27                   varchar2(150),
  ebu_attribute28                   varchar2(150),
  ebu_attribute29                   varchar2(150),
  ebu_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_brgng_unit_prte_id).
--
-- Post Success:
--   Processing continues.
--
