--------------------------------------------------------
--  DDL for Package OTA_LCI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_LCI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_learning_path_id
--    p_category_usage_id
--     already exists.
--
--  In Arguments:
...
--
-- In Parameters:
--   Learning_path_id and Category_usage_id
--
-- Post Success:
--   Processing continues.
--
