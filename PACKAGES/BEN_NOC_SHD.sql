--------------------------------------------------------
--  DDL for Package BEN_NOC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_NOC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  no_othr_cvg_rt_id          number(15),
  effective_start_date              date,
  effective_end_date                date,
  coord_ben_no_cvg_flag             varchar2(30),
  vrbl_rt_prfl_id                     number(15),
  business_group_id                 number(15),
  noc_attribute_category            varchar2(30),
  noc_attribute1                    varchar2(150),
  noc_attribute2                    varchar2(150),
  noc_attribute3                    varchar2(150),
  noc_attribute4                    varchar2(150),
  noc_attribute5                    varchar2(150),
  noc_attribute6                    varchar2(150),
  noc_attribute7                    varchar2(150),
  noc_attribute8                    varchar2(150),
  noc_attribute9                    varchar2(150),
  noc_attribute10                   varchar2(150),
  noc_attribute11                   varchar2(150),
  noc_attribute12                   varchar2(150),
  noc_attribute13                   varchar2(150),
  noc_attribute14                   varchar2(150),
  noc_attribute15                   varchar2(150),
  noc_attribute16                   varchar2(150),
  noc_attribute17                   varchar2(150),
  noc_attribute18                   varchar2(150),
  noc_attribute19                   varchar2(150),
  noc_attribute20                   varchar2(150),
  noc_attribute21                   varchar2(150),
  noc_attribute22                   varchar2(150),
  noc_attribute23                   varchar2(150),
  noc_attribute24                   varchar2(150),
  noc_attribute25                   varchar2(150),
  noc_attribute26                   varchar2(150),
  noc_attribute27                   varchar2(150),
  noc_attribute28                   varchar2(150),
  noc_attribute29                   varchar2(150),
  noc_attribute30                   varchar2(150),
...
--           p_base_key_value = :no_othr_cvg_rt_id).
--
-- Post Success:
--   Processing continues.
--
