--------------------------------------------------------
--  DDL for Package PQH_TXH_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TXH_SHD" AUTHID CURRENT_USER as
/* $Header: pqtxhrhi.pkh 120.1 2005/09/30 06:13:13 hpandya noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  ...
  ,approval_item_type              varchar2(10)
  ,approval_item_key               varchar2(240)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_SS_TRANSACTION_HISTORY';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
