--------------------------------------------------------
--  DDL for Package FV_SLA_CST_PROCESSING_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FV_SLA_CST_PROCESSING_PKG" AUTHID CURRENT_USER as
--$Header: FVXLACMS.pls 120.0.12010000.1 2010/02/10 19:38:02 sasukuma noship $
...
END fv_sla_cst_processing_pkg; -- Package spec
