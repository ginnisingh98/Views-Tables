--------------------------------------------------------
--  DDL for Package BEN_PND_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PND_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  pnd_attribute_category            varchar2(30),
  pnd_attribute1                    varchar2(150),
  pnd_attribute2                    varchar2(150),
  pnd_attribute3                    varchar2(150),
  pnd_attribute4                    varchar2(150),
  pnd_attribute5                    varchar2(150),
  pnd_attribute6                    varchar2(150),
  pnd_attribute7                    varchar2(150),
  pnd_attribute8                    varchar2(150),
  pnd_attribute9                    varchar2(150),
  pnd_attribute10                   varchar2(150),
  pnd_attribute11                   varchar2(150),
  pnd_attribute12                   varchar2(150),
  pnd_attribute13                   varchar2(150),
  pnd_attribute14                   varchar2(150),
  pnd_attribute15                   varchar2(150),
  pnd_attribute16                   varchar2(150),
  pnd_attribute17                   varchar2(150),
  pnd_attribute18                   varchar2(150),
  pnd_attribute19                   varchar2(150),
  pnd_attribute20                   varchar2(150),
  pnd_attribute21                   varchar2(150),
  pnd_attribute22                   varchar2(150),
  pnd_attribute23                   varchar2(150),
  pnd_attribute24                   varchar2(150),
  pnd_attribute25                   varchar2(150),
  pnd_attribute26                   varchar2(150),
  pnd_attribute27                   varchar2(150),
  pnd_attribute28                   varchar2(150),
  pnd_attribute29                   varchar2(150),
  pnd_attribute30                   varchar2(150),
...
--           p_base_key_value = :pl_dpnt_cvg_ctfn_id).
--
-- Post Success:
--   Processing continues.
--
