--------------------------------------------------------
--  DDL for Package BEN_XRC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XRC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_ext_rcd_id
--     already exists.
--
--  In Arguments:
--    p_ext_rcd_id
...
--
--  Prerequisites:
--    The primary key identified by p_ext_rcd_id already exists.
--
--  In Arguments:
--    p_ext_rcd_id
--
...
function return_legislation_code
  (p_ext_rcd_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
