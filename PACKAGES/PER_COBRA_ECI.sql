--------------------------------------------------------
--  DDL for Package PER_COBRA_ECI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_COBRA_ECI" AUTHID CURRENT_USER AS
/* $Header: pecobeci.pkh 120.2.12000000.1 2007/01/21 21:24:23 appldev ship $ */
...
PROCEDURE check_cobra_coverage_period
                 (p_qualifying_event      IN VARCHAR2,
                  ...
                  p_coverage_uom          OUT nocopy VARCHAR2);
--
--
...
--
-- Arguments
-- Added session date to get the correct cobra amount charged, part of fix#4599753
-- p_cobra_coverage_enrollment_id
-- p_session_date
--
-- Example
...
-- Added new procedure as part of fix for bug#4599753
...
--
--
-- Name       hr_cobra_element_update
--
-- Purpose
--
-- update cobra coverage element
--
-- Arguments
--
-- Example
...
PROCEDURE hr_cobra_term_enroll( p_business_group_id             NUMBER,
                                ...
                                p_qualifying_event              VARCHAR2,
                                p_coverage_start_date           DATE,
                                p_coverage_end_date  IN OUT nocopy DATE);
...
--
-- Purpose
-- Update COBRA Dependent Effective_End_date with Session date when Cobra
-- event is terminated. Part of fix for bug#4599753
--
-- Arguments
--
...
PROCEDURE hr_cobra_default_cobra_cost ( p_element_type_id        NUMBER,
                                        ...
                                        p_basic_cost      IN OUT nocopy VARCHAR2);
--
--
--
...
PROCEDURE hr_cobra_do_ccb_update ( p_Rowid                        IN OUT nocopy VARCHAR2,
                                   ...
                                   p_Attribute20                       VARCHAR2,
                                   p_qualifying_event                  VARCHAR2,
                                   p_new_amount_charged         IN OUT nocopy VARCHAR2 );
--
--
--
...
--
PROCEDURE hr_cobra_do_cdp_insert(p_cobra_dependent_id           out nocopy number,
...
FUNCTION check_clashing_periods
   (p_cobra_coverage_enrollment_id in     number,
    ...
    p_qualifying_event             in     varchar2) return boolean;
--
