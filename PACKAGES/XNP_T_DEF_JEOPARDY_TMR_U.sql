--------------------------------------------------------
--  DDL for Package XNP_T_DEF_JEOPARDY_TMR_U
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XNP_T_DEF_JEOPARDY_TMR_U" AUTHID CURRENT_USER AS
/* $Header: XNPJPTMS.pls 120.2 2006/02/13 07:51:06 dputhiye ship $ */

--Create message procedure for message type T_DEF_JEOPARDY_TMR
--
