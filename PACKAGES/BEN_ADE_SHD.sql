--------------------------------------------------------
--  DDL for Package BEN_ADE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ADE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  apld_dpnt_cvg_elig_prfl_id        number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  apld_dpnt_cvg_elig_rl             number(15),
  mndtry_flag                       varchar2(30),
  dpnt_cvg_eligy_prfl_id            number(15),
  pgm_id                            number(15),
  pl_id                             number(15),
  ptip_id                           number(15),
  ade_attribute_category            varchar2(30),
  ade_attribute1                    varchar2(150),
  ade_attribute2                    varchar2(150),
  ade_attribute3                    varchar2(150),
  ade_attribute4                    varchar2(150),
  ade_attribute5                    varchar2(150),
  ade_attribute6                    varchar2(150),
  ade_attribute7                    varchar2(150),
  ade_attribute8                    varchar2(150),
  ade_attribute9                    varchar2(150),
  ade_attribute10                   varchar2(150),
  ade_attribute11                   varchar2(150),
  ade_attribute12                   varchar2(150),
  ade_attribute13                   varchar2(150),
  ade_attribute14                   varchar2(150),
  ade_attribute15                   varchar2(150),
  ade_attribute16                   varchar2(150),
  ade_attribute17                   varchar2(150),
  ade_attribute18                   varchar2(150),
  ade_attribute19                   varchar2(150),
  ade_attribute20                   varchar2(150),
  ade_attribute21                   varchar2(150),
  ade_attribute22                   varchar2(150),
  ade_attribute23                   varchar2(150),
  ade_attribute24                   varchar2(150),
  ade_attribute25                   varchar2(150),
  ade_attribute26                   varchar2(150),
  ade_attribute27                   varchar2(150),
  ade_attribute28                   varchar2(150),
  ade_attribute29                   varchar2(150),
  ade_attribute30                   varchar2(150),
...
--           p_base_key_value = :apld_dpnt_cvg_elig_prfl_id).
--
-- Post Success:
--   Processing continues.
--
