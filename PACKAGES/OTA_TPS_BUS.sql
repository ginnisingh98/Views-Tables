--------------------------------------------------------
--  DDL for Package OTA_TPS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TPS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_training_plan_id
--     already exists.
--
--  In Arguments:
--    p_training_plan_id
