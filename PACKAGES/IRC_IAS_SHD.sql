--------------------------------------------------------
--  DDL for Package IRC_IAS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IAS_SHD" AUTHID CURRENT_USER as
...
g_tab_nam  constant varchar2(30) := 'IRC_ASSIGNMENT_STATUSES';
