--------------------------------------------------------
--  DDL for Package HR_FCT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FCT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_form_canvas_id already exists.
--
--  In Arguments:
--    p_form_canvas_id
--
