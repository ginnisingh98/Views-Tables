--------------------------------------------------------
--  DDL for Package OKL_SIF_RET_STRMS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SIF_RET_STRMS_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUSRSS.pls 120.1 2005/07/19 09:44:53 viselvar noship $ */
