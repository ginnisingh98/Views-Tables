--------------------------------------------------------
--  DDL for Package HXC_HRR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_HRR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (resource_rule_id                number(15)
  ,name                            varchar2(80)
  ,business_group_id		   number(15)
  ,legislation_code		   varchar2(30)
  ,eligibility_criteria_type       varchar2(30)
  ,eligibility_criteria_id         varchar2(60)
  ,pref_hierarchy_id               number(15)
  ,rule_evaluation_order           number(9)
