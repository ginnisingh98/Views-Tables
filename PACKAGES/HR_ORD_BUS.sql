--------------------------------------------------------
--  DDL for Package HR_ORD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_ORD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_organization_link_id
--     already exists.
--
--  In Arguments:
