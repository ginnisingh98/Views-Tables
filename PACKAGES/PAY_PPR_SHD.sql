--------------------------------------------------------
--  DDL for Package PAY_PPR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PPR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,formula_id                      number(9)
  ,processing_rule                 varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_STATUS_PROCESSING_RULES_F';
...
--           p_base_key_value = :status_processing_rule_id).
--
-- Post Success:
--   Processing continues.
--
