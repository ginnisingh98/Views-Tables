--------------------------------------------------------
--  DDL for Package PER_CNT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CNT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,configuration_name              varchar2(120)
  ,configuration_description       varchar2(240)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_RI_CONFIGURATIONS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
