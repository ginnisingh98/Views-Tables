--------------------------------------------------------
--  DDL for Package PER_SHT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SHT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_shared_type_id already exists.
--
--  In Arguments:
--    p_shared_type_id
--
...
function return_legislation_code
  (p_shared_type_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
