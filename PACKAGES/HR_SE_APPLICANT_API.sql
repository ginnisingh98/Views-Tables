--------------------------------------------------------
--  DDL for Package HR_SE_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_SE_APPLICANT_API" AUTHID CURRENT_USER AS
/* $Header: peappsei.pkh 120.2 2005/12/08 00:50:49 rravi noship $ */
/*#
 * This package contains applicant APIs.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Applicant for Sweden
*/
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_se_applicant >------------------------|
...
-- {Start Of Comments}
/*#
 * This API creates a new Swedish applicant.
 *
 * The API creates the applicant details, a default applicant assignment, and an
 ...
 * The business group for Sweden legislation must exist on the effective date.
 ...
 * The API creates an applicant, application, and default applicant assignment. If
 ...
 * @rep:displayname Create Applicant for Sweden
