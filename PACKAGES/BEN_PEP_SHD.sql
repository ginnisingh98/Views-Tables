--------------------------------------------------------
--  DDL for Package BEN_PEP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PEP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  dpnt_othr_pl_cvrd_rl_flag         varchar2(30),
  prtn_ovridn_thru_dt               date,
  pl_key_ee_flag                    varchar2(30),
  pl_hghly_compd_flag               varchar2(30),
  ...
  prtn_end_dt                       date,
  prtn_strt_dt                      date,
  wait_perd_cmpltn_dt               date,
  wait_perd_strt_dt                 date,
  wv_ctfn_typ_cd                    varchar2(30),
  hrs_wkd_val                       number,
  hrs_wkd_bndry_perd_cd             varchar2(30),
  prtn_ovridn_flag                  varchar2(30),
  no_mx_prtn_ovrid_thru_flag        varchar2(30),
  prtn_ovridn_rsn_cd                varchar2(30),
  age_uom                           varchar2(30),
  los_uom                           varchar2(30),
  ovrid_svc_dt                      date,
  ...
  frz_comb_age_and_los_flag         varchar2(9),      -- Increased length
  dstr_rstcn_flag                   varchar2(30),
  pct_fl_tm_val                     number,
  wv_prtn_rsn_cd                    varchar2(30),
  pl_wvd_flag                       varchar2(30),
  ...
  pep_attribute_category            varchar2(30),
  pep_attribute1                    varchar2(150),
  pep_attribute2                    varchar2(150),
  pep_attribute3                    varchar2(150),
  pep_attribute4                    varchar2(150),
  pep_attribute5                    varchar2(150),
  pep_attribute6                    varchar2(150),
  pep_attribute7                    varchar2(150),
  pep_attribute8                    varchar2(150),
  pep_attribute9                    varchar2(150),
  pep_attribute10                   varchar2(150),
  pep_attribute11                   varchar2(150),
  pep_attribute12                   varchar2(150),
  pep_attribute13                   varchar2(150),
  pep_attribute14                   varchar2(150),
  pep_attribute15                   varchar2(150),
  pep_attribute16                   varchar2(150),
  pep_attribute17                   varchar2(150),
  pep_attribute18                   varchar2(150),
  pep_attribute19                   varchar2(150),
  pep_attribute20                   varchar2(150),
  pep_attribute21                   varchar2(150),
  pep_attribute22                   varchar2(150),
  pep_attribute23                   varchar2(150),
  pep_attribute24                   varchar2(150),
  pep_attribute25                   varchar2(150),
  pep_attribute26                   varchar2(150),
  pep_attribute27                   varchar2(150),
  pep_attribute28                   varchar2(150),
  pep_attribute29                   varchar2(150),
  pep_attribute30                   varchar2(150),
