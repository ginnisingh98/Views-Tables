--------------------------------------------------------
--  DDL for Package BEN_ELIG_TTL_PRTT_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_TTL_PRTT_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beetpapi.pkh 120.0 2005/05/28 03:02:13 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_TTL_PRTT_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_TTL_PRTT_PRTE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_TTL_PRTT_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_TTL_PRTT_PRTE_a
  (
...
--
end ben_ELIG_TTL_PRTT_PRTE_bk1;
