--------------------------------------------------------
--  DDL for Package AME_ATR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_ATR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,line_item                       varchar2(9)       -- Increased length
  ,start_date                      date
  ,end_date                        date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_ATTRIBUTES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
