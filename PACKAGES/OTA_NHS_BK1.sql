--------------------------------------------------------
--  DDL for Package OTA_NHS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_NHS_BK1" AUTHID CURRENT_USER as
/* $Header: otnhsapi.pkh 120.2 2006/01/09 03:19:33 dbatra noship $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< <CREATE_NON_OTA_HISTORIES_b >-------------------|
-- ----------------------------------------------------------------------------
--
procedure create_non_ota_histories_b
  ...
  --
-- ----------------------------------------------------------------------------
-- |-------------------------< <CREATE_NON_OTA_HISTORIES_a >-------------------|
-- ----------------------------------------------------------------------------
--
procedure create_non_ota_histories_a
  (p_effective_date           in date
  ,p_nota_history_id             in number
  ,p_person_id             in number
  ,p_contact_id               in number
