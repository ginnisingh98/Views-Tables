--------------------------------------------------------
--  DDL for Package PER_PSO_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PSO_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_security_organization_id already exists.
--
--  In Arguments:
