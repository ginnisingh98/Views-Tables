--------------------------------------------------------
--  DDL for Package OKI_LOAD_RBS_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKI_LOAD_RBS_PVT" AUTHID CURRENT_USER AS
/* $Header: OKIRRBSS.pls 115.8 2002/12/01 17:54:04 rpotnuru noship $ */

--------------------------------------------------------------------------------
-- Start of comments
--
-- API Name   : OKI_LOAD_RBS_PVT
-- Type       : Process
-- Purpose    : Load the oki_renew_by_statuses table
...
--                  Calculate the expired amounts and counts
--                  Determine if the record should be inserted or updated
--                  Calculate the WIP amounts and counts
--                  Determine if the record should be inserted or updated
--                  Calculate the signed amounts and counts
--                  Determine if the record should be inserted or updated
--                  Calculate the forecast amounts and counts
--                  Determine if the record should be inserted or updated
...
--------------------------------------------------------------------------------
  -- Procedure to create the renew by statuses records.
