--------------------------------------------------------
--  DDL for Package ARP_PROCESS_CREDIT_LOCK_COVER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARP_PROCESS_CREDIT_LOCK_COVER" AUTHID CURRENT_USER AS
/* $Header: ARTCCMLS.pls 115.2 99/07/17 00:13:48 porting ship $ */
