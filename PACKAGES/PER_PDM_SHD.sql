--------------------------------------------------------
--  DDL for Package PER_PDM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PDM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  delivery_method_id                number(15),
  date_start                        date,
  date_end                          date,
  person_id                         number(15),
  comm_dlvry_method                 varchar2(30),
  preferred_flag                    varchar2(30),
