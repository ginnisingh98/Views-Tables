--------------------------------------------------------
--  DDL for Package OTA_CFS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CFS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (conference_server_id            number(15)
  ,url                             varchar2(4000)
  ,type                            varchar2(30)       -- Increased length
  ,owc_site_id                     varchar2(240)
  ,owc_auth_token                  varchar2(240)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_CONFERENCE_SERVERS_B';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
