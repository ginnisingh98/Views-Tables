--------------------------------------------------------
--  DDL for Package BEN_OPI_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_OPI_INS" AUTHID CURRENT_USER as
...
--   2) After the conversion has taken optace, the corresponding record ins
