--------------------------------------------------------
--  DDL for Package BEN_PGI_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PGI_DEL" AUTHID CURRENT_USER as
...
--      datatype.
--   2) After the conversion has taken pgmace, the corresponding record del
