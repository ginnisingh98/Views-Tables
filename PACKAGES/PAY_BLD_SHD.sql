--------------------------------------------------------
--  DDL for Package PAY_BLD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_BLD_SHD" AUTHID CURRENT_USER as
/* $Header: pybldrhi.pkh 120.0 2005/05/29 03:19:37 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  ...
  ,dimension_type                  varchar2(9)       -- Increased length
  ,description                     varchar2(240)
  ,feed_checking_code              varchar2(61)
  ,legislation_subgroup            varchar2(30)
  ,payments_flag                   varchar2(30)
  ,expiry_checking_code            varchar2(61)
  ,expiry_checking_level           varchar2(9)       -- Increased length
  ,feed_checking_type              varchar2(9)       -- Increased length
  ,dimension_level                 varchar2(30)
  ,period_type                     varchar2(30)
  ,asg_action_balance_dim_id       number(9)
  ,database_item_function          varchar2(30)
  ,save_run_balance_enabled        varchar2(30)
  ,start_date_code                 varchar2(61)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_BALANCE_DIMENSIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
