--------------------------------------------------------
--  DDL for Package HR_CGD_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_CGD_UPD" AUTHID CURRENT_USER as
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy hr_cgd_shd.g_rec_type);
--
-- ----------------------------------------------------------------------------
-- |-------------------------------< upd_or_sel >-----------------------------|
-- ----------------------------------------------------------------------------
...
--   functionality of HR_CGD_ins.ins_or_sel except is has to take into
...
--      returning the new p_cagr_grade_def_id.
...
--
-- In Parameters:
--   p_business_group_id   allows setting of client_info
--
-- Post Success:
