--------------------------------------------------------
--  DDL for Package CSI_INV_ISO_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CSI_INV_ISO_PKG" AUTHID CURRENT_USER as
-- $Header: csiintss.pls 120.0.12000000.1 2007/01/16 15:32:01 appldev ship $
