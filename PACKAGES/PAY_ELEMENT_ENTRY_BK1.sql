--------------------------------------------------------
--  DDL for Package PAY_ELEMENT_ENTRY_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_ELEMENT_ENTRY_BK1" AUTHID CURRENT_USER as
/* $Header: pyeleapi.pkh 120.2.12010000.1 2008/07/27 22:30:34 appldev ship $ */
--
-- ----------------------------------------------------------------------------
-- |------------------------< create_element_entry_b >------------------------|
-- ----------------------------------------------------------------------------
--
procedure create_element_entry_b
...
--
-- ----------------------------------------------------------------------------
-- |------------------------< create_element_entry_a >------------------------|
-- ----------------------------------------------------------------------------
--
procedure create_element_entry_a
  (p_effective_date                in     date
  ,p_business_group_id             in     number
  ,p_original_entry_id             in     number
  ,p_assignment_id                 in     number
  ...
  ,p_create_warning                in     boolean
  );
--
end pay_element_entry_bk1;
