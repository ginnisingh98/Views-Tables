--------------------------------------------------------
--  DDL for Package AP_ACCTG_PAY_DIST_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_ACCTG_PAY_DIST_PKG" AUTHID CURRENT_USER AS
/* $Header: appaydis.pls 120.16.12010000.5 2009/10/30 13:06:54 amitmukh ship $ */
  ...
  AND    AIP.Accounting_Event_ID NOT IN
                    (SELECT APH.Accounting_Event_ID
                     ...
                     AND    APH.Transaction_Type = 'PAYMENT CANCELLED');  --bug 7029334 'PAYMENT CANCELLATION'
  ...
  ORDER  BY abs(AID.Amount), AID.Invoice_Distribution_ID; --bug 5410819
