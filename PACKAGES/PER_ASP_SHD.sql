--------------------------------------------------------
--  DDL for Package PER_ASP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ASP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  sec_profile_assignment_id         number(15),
  user_id                           number(15),
  security_group_id                 number(15),
  business_group_id                 number(15),
  security_profile_id               number(15),
  responsibility_id                 number(15),
  responsibility_application_id     number(15),
  start_date                        date,
  end_date                          date,
