--------------------------------------------------------
--  DDL for Package PQH_CRD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CRD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (criteria_rate_defn_id           number(15)
  ,short_name                      varchar2(30)
  ,uom                             varchar2(30)
  ,currency_code                   varchar2(30)
  ,reference_period_cd             varchar2(30)
  ,define_max_rate_flag            varchar2(10)
  ,define_min_rate_flag            varchar2(10)
  ,define_mid_rate_flag            varchar2(10)
  ,define_std_rate_flag            varchar2(10)
  ,rate_calc_cd                    varchar2(30)
  ,rate_calc_rule                  number(15)
  ,preferential_rate_cd            varchar2(30)
  ,preferential_rate_rule          number(15)
  ,rounding_cd                     varchar2(30)
  ,rounding_rule                   number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_CRITERIA_RATE_DEFN';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
