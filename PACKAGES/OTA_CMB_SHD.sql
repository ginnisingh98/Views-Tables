--------------------------------------------------------
--  DDL for Package OTA_CMB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CMB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (certification_member_id         number(9)
  ,certification_id                number(9)
  ,object_id                       number(9)
  ,object_type                     varchar2(30)
  ,member_sequence                 number(10)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_CERTIFICATION_MEMBERS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
