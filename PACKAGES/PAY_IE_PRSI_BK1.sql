--------------------------------------------------------
--  DDL for Package PAY_IE_PRSI_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_IE_PRSI_BK1" AUTHID CURRENT_USER as
/* $Header: pysidapi.pkh 120.1 2005/10/02 02:34:20 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_ie_prsi_details_b >-------------------------|
-- ----------------------------------------------------------------------------
--
