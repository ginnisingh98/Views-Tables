--------------------------------------------------------
--  DDL for Package GHR_PDC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_PDC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  pd_classification_id              number(15),
  position_description_id           number(15),
  class_grade_by                    varchar2(9),        -- Increased length
  official_title                    varchar2(80),
  pay_plan                          varchar2(9),      -- Increased length
  occupational_code                 varchar2(9),
  grade_level                       varchar2(9),      -- Increased length
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
/* Commented out because the API is for a new entity. */
