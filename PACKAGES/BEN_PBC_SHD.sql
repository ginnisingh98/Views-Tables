--------------------------------------------------------
--  DDL for Package BEN_PBC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PBC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  pl_bnf_ctfn_prvdd_id              number(15),
  effective_start_date              date,
  effective_end_date                date,
  bnf_ctfn_typ_cd                   varchar2(30),
  bnf_ctfn_recd_dt                  date,
  bnf_ctfn_rqd_flag                 varchar2(30),
  pl_bnf_id                         number(15),
  prtt_enrt_actn_id                 number(15),
  business_group_id                 number(15),
  pbc_attribute_category            varchar2(30),
  pbc_attribute1                    varchar2(150),
  pbc_attribute2                    varchar2(150),
  pbc_attribute3                    varchar2(150),
  pbc_attribute4                    varchar2(150),
  pbc_attribute5                    varchar2(150),
  pbc_attribute6                    varchar2(150),
  pbc_attribute7                    varchar2(150),
  pbc_attribute8                    varchar2(150),
  pbc_attribute9                    varchar2(150),
  pbc_attribute10                   varchar2(150),
  pbc_attribute11                   varchar2(150),
  pbc_attribute12                   varchar2(150),
  pbc_attribute13                   varchar2(150),
  pbc_attribute14                   varchar2(150),
  pbc_attribute15                   varchar2(150),
  pbc_attribute16                   varchar2(150),
  pbc_attribute17                   varchar2(150),
  pbc_attribute18                   varchar2(150),
  pbc_attribute19                   varchar2(150),
  pbc_attribute20                   varchar2(150),
  pbc_attribute21                   varchar2(150),
  pbc_attribute22                   varchar2(150),
  pbc_attribute23                   varchar2(150),
  pbc_attribute24                   varchar2(150),
  pbc_attribute25                   varchar2(150),
  pbc_attribute26                   varchar2(150),
  pbc_attribute27                   varchar2(150),
  pbc_attribute28                   varchar2(150),
  pbc_attribute29                   varchar2(150),
  pbc_attribute30                   varchar2(150),
...
--           p_base_key_value = :pl_bnf_ctfn_prvdd_id).
--
-- Post Success:
--   Processing continues.
--
