--------------------------------------------------------
--  DDL for Package IRC_PARTY_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_PARTY_BK1" AUTHID CURRENT_USER as
...
-- ----------------------------------------------------------------------------
--
procedure CREATE_REGISTERED_USER_B
  (
