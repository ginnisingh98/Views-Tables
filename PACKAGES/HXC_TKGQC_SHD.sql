--------------------------------------------------------
--  DDL for Package HXC_TKGQC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_TKGQC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (tk_group_query_criteria_id      number(15)
  ,tk_group_query_id               number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HXC_TK_GROUP_QUERY_CRITERIA';
