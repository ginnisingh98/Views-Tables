--------------------------------------------------------
--  DDL for Package OKC_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_API" AUTHID CURRENT_USER AS
/* $Header: OKCPAPIS.pls 120.0.12010000.2 2012/08/06 12:51:32 harchand ship $ */
------------------------------------------------------------------------------
-- GLOBAL STRUCTURES
------------------------------------------------------------------------------
...
G_APP_NAME			CONSTANT VARCHAR2(200) := 'OKC';
...
G_FORM_RECORD_DELETED		CONSTANT VARCHAR2(200) := 'OKC_RECORD_DELETED';
G_FORM_RECORD_CHANGED		CONSTANT VARCHAR2(200) := 'OKC_RECORD_CHANGED';
G_UNABLE_TO_RESERVE_REC	CONSTANT VARCHAR2(200) := 'FORM_COULD_NOT_RESERVE_RECORD';
G_RECORD_DELETED		CONSTANT VARCHAR2(200) := 'OKC_RECORD_DELETED';
G_RECORD_CHANGED		CONSTANT VARCHAR2(200) := 'OKC_RECORD_CHANGED';
G_RECORD_LOGICALLY_DELETED	CONSTANT VARCHAR2(200) := 'OKC_CONTRACTS_RECORD_LDELETED';
G_REQUIRED_VALUE		CONSTANT VARCHAR2(200) := 'OKC_CONTRACTS_REQUIRED_VALUE';
G_INVALID_VALUE			CONSTANT VARCHAR2(200) := 'OKC_CONTRACTS_INVALID_VALUE';
...
G_LOCK_RECORD_DELETED		CONSTANT VARCHAR2(200) := 'OKC_LOCK_RECORD_DELETED';
--------------------------------------------------------------------------------
