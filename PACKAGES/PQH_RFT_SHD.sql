--------------------------------------------------------
--  DDL for Package PQH_RFT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RFT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  base_template_id                  number(15),
  parent_template_id                number(15),
  reference_type_cd                 varchar2(30),
