--------------------------------------------------------
--  DDL for Package ONT_LINE_PAYMENT_DEF_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ONT_LINE_PAYMENT_DEF_UTIL" AUTHID CURRENT_USER AS
...
--  DESCRIPTION
--  
--      Spec of package ONT_LINE_PAYMENT_Def_Util
--  
--  NOTES
--  
--  HISTORY
...
--  
  ...
  g_cached_record          OE_AK_LINE_PAYMENTS_V%ROWTYPE;
