--------------------------------------------------------
--  DDL for Package BEN_EPE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPE_BUS" AUTHID CURRENT_USER as
...
function return_legislation_code
  (p_elig_per_elctbl_chc_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
