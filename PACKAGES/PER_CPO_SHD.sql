--------------------------------------------------------
--  DDL for Package PER_CPO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CPO_SHD" AUTHID CURRENT_USER as
/* $Header: pecporhi.pkh 120.0 2005/05/31 07:16 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  ...
  ,outcome_number                  number(9)
  ,name                            varchar2(60)
  ,date_from                       date
  ,date_to                         date
  ,assessment_criteria             varchar2(2000)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_COMPETENCE_OUTCOMES';
