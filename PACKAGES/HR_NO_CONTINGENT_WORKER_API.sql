--------------------------------------------------------
--  DDL for Package HR_NO_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_NO_CONTINGENT_WORKER_API" AUTHID CURRENT_USER as
/* $Header: pecwknoi.pkh 120.1 2005/10/02 02:40:40 aroussel $ */
/*#
 * This package contains contingent worker APIs.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Contingent Worker for Norway
*/
--
-- ----------------------------------------------------------------------------
-- |------------------------------< create_no_cwk >---------------------------|
...
-- {Start Of Comments}
/*#
 * The following procedure creates a Norwegian contingent worker.
 *
 ...
 * The business group for Norway legislation must already exist. Also a valid
 ...
 * @param p_sex The contingent worker's sex. The valid values are defined by
 * the 'SEX' lookup type.
 ...
 * @rep:displayname Create Contingent Worker for Norway
...
END hr_no_contingent_worker_api;
