--------------------------------------------------------
--  DDL for Package PQP_VEH_REPOS_EXTRA_INFO_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_VEH_REPOS_EXTRA_INFO_BK2" AUTHID CURRENT_USER as
/* $Header: pqvriapi.pkh 120.0.12010000.3 2008/08/08 07:23:57 ubhat ship $ */
--
-- ----------------------------------------------------------------------------
-- |-----------------< UPDATE_VEH_REPOS_EXTRA_INFO_b >-----------------------|
-- ----------------------------------------------------------------------------
--
procedure update_veh_repos_extra_info_b
...
--
-- ----------------------------------------------------------------------------
-- |------------------< UPDATE_VEH_REPOS_EXTRA_INFO_a >---------------------|
-- ----------------------------------------------------------------------------
--
procedure update_veh_repos_extra_info_a
 (p_veh_repos_extra_info_id      in     number
  ,p_object_version_number        in     number
  ,p_vehicle_repository_id        in     number
  ,p_information_type             in     varchar2
...
--
end  PQP_VEH_REPOS_EXTRA_INFO_BK2;
