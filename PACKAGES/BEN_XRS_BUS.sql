--------------------------------------------------------
--  DDL for Package BEN_XRS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XRS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_ext_rslt_id already exists.
--
--  In Arguments:
--    p_ext_rslt_id
--
...
function return_legislation_code
  (p_ext_rslt_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
