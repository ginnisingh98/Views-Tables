--------------------------------------------------------
--  DDL for Package OKL_AM_RV_WRITEDOWN_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_AM_RV_WRITEDOWN_PVT_W" AUTHID CURRENT_USER as
  /* $Header: OKLERVWS.pls 120.1 2005/07/07 12:46:36 asawanka noship $ */
