--------------------------------------------------------
--  DDL for Package BEN_ELIGY_PROFILE_RULE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIGY_PROFILE_RULE_BK1" AUTHID CURRENT_USER as
/* $Header: beerlapi.pkh 120.0 2005/05/28 02:52:05 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIGY_PROFILE_RULE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIGY_PROFILE_RULE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIGY_PROFILE_RULE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIGY_PROFILE_RULE_a
  (
...
--
end ben_ELIGY_PROFILE_RULE_bk1;
