--------------------------------------------------------
--  DDL for Package HR_IT_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_IT_EMPLOYEE_API" AUTHID CURRENT_USER as
/* $Header: hrempiti.pkh 120.1 2005/10/02 02:01:59 aroussel $ */
/*#
 * This package contains employee APIs for Italy.
 * @rep:scope public
 * @rep:product per
 * @rep:displayname Employee for Italy
*/
--
-- ----------------------------------------------------------------------------
-- |----------------------------< create_it_employee >------------------------|
 ...
 * a period of service for Italy.
 *
 * The API calls the generic API create_employee, with the parameters set as
 * appropriate for an Italian employee. For further information see the
 * create_employee API.
 *
 * <p><b>Licensing</b><br>
 ...
 * The person, primary assignment and period of service is successfully
 * inserted.
 *
 ...
 * @param p_fiscal_code The employee's fiscal code
 ...
 * @param p_work_registration_card The work registration card number
 * @param p_emp_reference_number The employee reference number
 ...
 * @rep:displayname Create Employee for Italy
