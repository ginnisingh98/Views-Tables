--------------------------------------------------------
--  DDL for Package AMS_DELIVERABLE_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_DELIVERABLE_CUHK" AUTHID CURRENT_USER as
/*$Header: amscdels.pls 115.1 2002/11/14 00:20:48 musman noship $*/

--------------------------------------------------------
-- Start of Comments
-- Package name     : AMS_Deliverable_CUHK
-- PURPOSE
...
--
-- PURPOSE
--    Customer pre-processing for validate_Deliverable_pre.
------------------------------------------------------------
