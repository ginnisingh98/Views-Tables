--------------------------------------------------------
--  DDL for Package HR_FGT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FGT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_form_data_group_id already exists.
--
--  In Arguments:
