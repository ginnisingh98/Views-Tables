--------------------------------------------------------
--  DDL for Package JTF_PERZ_DDF_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_PERZ_DDF_PUB" AUTHID CURRENT_USER as
/* $Header: jtfzpdds.pls 120.2 2005/11/02 03:23:06 skothe ship $ */
--
--
-- Start of Comments
--
...
-- Start of Comments
--
--	ddf_out_rec_type Rec
--
--	This record is used to set the data attributes associated with a personalized
--	data object.
--
-- End of Comments

TYPE ddf_out_rec_type		IS RECORD
(
 	perz_ddf_id		NUMBER  	:= NULL,
	perz_ddf_context	VARCHAR2(60)	:= NULL,
 	profile_id		NUMBER        	:= NULL,
 	application_id		NUMBER        	:= NULL,
	gui_object_name		VARCHAR2(60)	:= NULL,
 	gui_object_id		NUMBER        	:= NULL,
	ddf_value		VARCHAR2(60)	:= NULL,
	ddf_value_type 		VARCHAR2(30)	:= NULL
);

-- Start of Comments
--
--      ddf_out_rec_type Table: ddf_out_tbl_type
--
--
-- End of Comments

TYPE ddf_out_tbl_type	IS TABLE OF ddf_out_rec_type
			INDEX BY BINARY_INTEGER;

-- G_MISS definition for table
G_MISS_DDF_TBL		ddf_out_tbl_type;
