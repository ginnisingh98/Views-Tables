--------------------------------------------------------
--  DDL for Package BEN_ELIG_DPNT_CVD_OTHR_PL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_DPNT_CVD_OTHR_PL_BK1" AUTHID CURRENT_USER as
/* $Header: beedpapi.pkh 120.0 2005/05/28 02:00:05 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_DPNT_CVD_OTHR_PL_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_DPNT_CVD_OTHR_PL_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_DPNT_CVD_OTHR_PL_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_DPNT_CVD_OTHR_PL_a
  (
...
--
end ben_ELIG_DPNT_CVD_OTHR_PL_bk1;
