--------------------------------------------------------
--  DDL for Package BEN_WITHIN_YEAR_PERD_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_WITHIN_YEAR_PERD_BK1" AUTHID CURRENT_USER as
/* $Header: bewypapi.pkh 120.0 2005/05/28 12:21:12 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_WITHIN_YEAR_PERD_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_WITHIN_YEAR_PERD_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_WITHIN_YEAR_PERD_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_WITHIN_YEAR_PERD_a
  (
