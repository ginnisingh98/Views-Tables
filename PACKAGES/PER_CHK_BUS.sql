--------------------------------------------------------
--  DDL for Package PER_CHK_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CHK_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_checklist_item_id
--     already exists.
--
--  In Arguments:
--    p_checklist_item_id
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_validate(p_rec in per_chk_shd.g_rec_type);
--
end per_chk_bus;
