--------------------------------------------------------
--  DDL for Package PAY_FI_RULES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_FI_RULES" AUTHID CURRENT_USER AS
/* $Header: pyfirule.pkh 120.1.12000000.1 2007/01/17 19:29:23 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |--------------------------< PAY_FI_RULES >--------------------------------|
-- ----------------------------------------------------------------------------
