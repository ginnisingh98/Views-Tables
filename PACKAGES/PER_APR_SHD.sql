--------------------------------------------------------
--  DDL for Package PER_APR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_APR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  appraisal_id                      number(15),
  business_group_id                 number(15),
  object_version_number             number(9),
  appraisal_template_id             number(15),
  appraisee_person_id               number(15),
  appraiser_person_id               number(15),
  appraisal_date                    date,
  appraisal_period_end_date         date,
  appraisal_period_start_date       date,
  type                              varchar2(30),
  next_appraisal_date               date,
  status                            varchar2(30),
  group_date 			    date,
  group_initiator_id		    number(9),
  comments                          varchar2(2000),   -- pseudo column
  overall_performance_level_id      number(15),
  open                              varchar2(30),
  ...
  system_type                       varchar2(60),
  system_params                     varchar2(500),
  appraisee_access                  varchar2(30),
  main_appraiser_id                 number(15),
  assignment_id                     number(10),
  assignment_start_date             date,
  assignment_business_group_id      number(15),
  assignment_organization_id        number(15),
  assignment_job_id                 number(15),
  assignment_position_id            number(15),
  assignment_grade_id               number(15),
  appraisal_system_status           varchar2(30),
  potential_readiness_level 	    varchar2(30),
  potential_short_term_workopp 	    varchar2(240),
  potential_long_term_workopp 	    varchar2(240),
  potential_details 		        varchar2(2000),
  event_id 			            number(15),
  ...
  update_appraisal                  varchar2(30),
  provide_overall_feedback          varchar2(30),
  appraisee_comments                varchar2(2000),
  plan_id                           number(15),
  offline_status                    varchar2(30),
retention_potential             varchar2(30),
...
g_tab_nam constant varchar2(30) :='PER_APPRAISALS';
-- ---------------------------------------------------------------------------+
-- |---------------------------< constraint_error >---------------------------|
-- ---------------------------------------------------------------------------+
-- {Start Of Comments}
