--------------------------------------------------------
--  DDL for Package HR_CAU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_CAU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  primary_key_value                 number(15),
  purpose_usage_id                  number(9),
  start_date                        date,
  end_date                          date,
