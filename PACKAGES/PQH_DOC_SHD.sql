--------------------------------------------------------
--  DDL for Package PQH_DOC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_DOC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,lob_code                        varchar2(80)
  ,language                        varchar2(6)
  ,territory                       varchar2(6)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DOCUMENTS_F';
