--------------------------------------------------------
--  DDL for Package AME_ACA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_ACA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,line_item_id_query              varchar2(4000)
  ,start_date                      date
  ,end_date                        date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_CALLING_APPS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :application_id).
--
-- Post Success:
