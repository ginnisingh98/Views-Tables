--------------------------------------------------------
--  DDL for Package BEN_CTP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CTP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  coord_cvg_for_all_pls_flag        varchar2(30),
  dpnt_dsgn_cd                      varchar2(30),
  dpnt_cvg_no_ctfn_rqd_flag         varchar2(9),      -- Increased length
  ...
  rqd_perd_enrt_nenrt_rl            number(15),
  auto_enrt_mthd_rl                 number(15),
  enrt_mthd_cd                      varchar2(30),
  enrt_cd                           varchar2(30),
  enrt_rl                           number(15),
  dflt_enrt_cd                      varchar2(30),
  dflt_enrt_det_rl                  number(15),
  ...
  crs_this_pl_typ_only_flag         varchar2(30),
  ptip_stat_cd                      varchar2(30),
  mx_cvg_alwd_amt                   number,        -- (15),
  mx_enrd_alwd_ovrid_num            number(15),
  mn_enrd_rqd_ovrid_num             number(15),
  no_mx_pl_typ_ovrid_flag           varchar2(30),
  ordr_num                          number(15),
  prvds_cr_flag                     varchar2(30),
  rqd_perd_enrt_nenrt_val           number(15,2),  --(15),
  rqd_perd_enrt_nenrt_tm_uom        varchar2(30),
  wvbl_flag                         varchar2(30),
  drvd_fctr_dpnt_cvg_flag           varchar2(30),
  no_mn_pl_typ_overid_flag          varchar2(30),
  sbj_to_sps_lf_ins_mx_flag         varchar2(30),
  sbj_to_dpnt_lf_ins_mx_flag        varchar2(30),
  use_to_sum_ee_lf_ins_flag         varchar2(30),
  ...
  rqd_enrt_perd_tco_cd              varchar2(30),
  pgm_id                            number(15),
  pl_typ_id                         number(15),
  cmbn_ptip_id                      number(15),
  cmbn_ptip_opt_id                  number(15),
  acrs_ptip_cvg_id                  number(15),
  business_group_id                 number(15),
  ctp_attribute_category            varchar2(30),
  ctp_attribute1                    varchar2(150),
  ctp_attribute2                    varchar2(150),
  ctp_attribute3                    varchar2(150),
  ctp_attribute4                    varchar2(150),
  ctp_attribute5                    varchar2(150),
  ctp_attribute6                    varchar2(150),
  ctp_attribute7                    varchar2(150),
  ctp_attribute8                    varchar2(150),
  ctp_attribute9                    varchar2(150),
  ctp_attribute10                   varchar2(150),
  ctp_attribute11                   varchar2(150),
  ctp_attribute12                   varchar2(150),
  ctp_attribute13                   varchar2(150),
  ctp_attribute14                   varchar2(150),
  ctp_attribute15                   varchar2(150),
  ctp_attribute16                   varchar2(150),
  ctp_attribute17                   varchar2(150),
  ctp_attribute18                   varchar2(150),
  ctp_attribute19                   varchar2(150),
  ctp_attribute20                   varchar2(150),
  ctp_attribute21                   varchar2(150),
  ctp_attribute22                   varchar2(150),
  ctp_attribute23                   varchar2(150),
  ctp_attribute24                   varchar2(150),
  ctp_attribute25                   varchar2(150),
  ctp_attribute26                   varchar2(150),
  ctp_attribute27                   varchar2(150),
  ctp_attribute28                   varchar2(150),
  ctp_attribute29                   varchar2(150),
  ctp_attribute30                   varchar2(150),
