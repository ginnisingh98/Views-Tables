--------------------------------------------------------
--  DDL for Package HR_SFT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_SFT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (source_form_template_id         number(15)
  ,object_version_number           number(9)
  ,form_template_id_to             number(15)
  ,form_template_id_from           number(15)
  );
--
-- ----------------------------------------------------------------------------
