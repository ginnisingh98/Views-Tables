--------------------------------------------------------
--  DDL for Package PAY_EVENT_VALUE_CHANGES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EVENT_VALUE_CHANGES_BK1" AUTHID CURRENT_USER as
/* $Header: pyevcapi.pkh 120.1 2005/10/02 02:31:07 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------< create_event_value_change_b >-------------------------|
-- ----------------------------------------------------------------------------
--
