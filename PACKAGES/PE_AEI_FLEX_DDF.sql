--------------------------------------------------------
--  DDL for Package PE_AEI_FLEX_DDF
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PE_AEI_FLEX_DDF" AUTHID CURRENT_USER as
/* $Header: peaeiddf.pkh 115.0 99/07/17 18:27:06 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< ddf >--------------------------------------|
-- -----------------------------------------------------------------------------
