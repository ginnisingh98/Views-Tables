--------------------------------------------------------
--  DDL for Package OKL_RULE_APIS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_RULE_APIS_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLURAPS.pls 120.1 2005/07/18 15:57:30 viselvar noship $ */
