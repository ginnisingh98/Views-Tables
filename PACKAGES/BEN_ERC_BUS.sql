--------------------------------------------------------
--  DDL for Package BEN_ERC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ERC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_enrt_rt_ctfn_id already exists.
--
--  In Arguments:
--    p_enrt_rt_ctfn_id
--
...
function return_legislation_code
  (p_enrt_rt_ctfn_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
