--------------------------------------------------------
--  DDL for Package HRI_BPL_PROFICIENCY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HRI_BPL_PROFICIENCY" AUTHID CURRENT_USER AS
/* $Header: hribcprf.pkh 120.0 2005/05/29 07:00 appldev noship $ */
--
