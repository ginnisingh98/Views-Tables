--------------------------------------------------------
--  DDL for Package HR_IPT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_IPT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,information_prompt              varchar2(80)
  ,label                           varchar2(80)
  ,prompt_text                     varchar2(80)
  ,tooltip_text                    varchar2(80)
  );
--
-- ----------------------------------------------------------------------------
