--------------------------------------------------------
--  DDL for Package IBE_ATTACHMENT_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IBE_ATTACHMENT_GRP" AUTHID CURRENT_USER AS
/* $Header: IBEGATHS.pls 120.0 2005/05/30 02:46:10 appldev noship $ */
...
G_PKG_NAME CONSTANT VARCHAR2(30) := 'IBE_Attachment_GRP';
...
PROCEDURE save_attachment (
	...
	x_msg_count              OUT NOCOPY NUMBER,
	x_msg_data               OUT NOCOPY VARCHAR2,
	p_attachment_tbl         IN OUT NOCOPY ATTACHMENT_TBL_TYPE );
...
PROCEDURE delete_attachment (
	...
	x_msg_count              OUT NOCOPY NUMBER,
	x_msg_data               OUT NOCOPY VARCHAR2,
	p_ath_id_ver_tbl         IN OUT NOCOPY ATH_ID_VER_TBL_TYPE );
