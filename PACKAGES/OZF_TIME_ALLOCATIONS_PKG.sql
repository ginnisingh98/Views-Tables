--------------------------------------------------------
--  DDL for Package OZF_TIME_ALLOCATIONS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_TIME_ALLOCATIONS_PKG" AUTHID CURRENT_USER AS
/* $Header: ozfttals.pls 115.1 2003/11/18 23:54:17 mkothari noship $  */

---g_version	CONSTANT CHAR(80)    := '$Header: ozfttals.pls 115.1 2003/11/18 23:54:17 mkothari noship $';
   G_PKG_NAME   CONSTANT VARCHAR2(30):='OZF_TIME_ALLOCATIONS_PKG';
   G_FILE_NAME CONSTANT VARCHAR2(12) := 'ozfttals.pls';
