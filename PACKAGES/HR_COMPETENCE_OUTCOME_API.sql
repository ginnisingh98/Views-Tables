--------------------------------------------------------
--  DDL for Package HR_COMPETENCE_OUTCOME_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_COMPETENCE_OUTCOME_API" AUTHID CURRENT_USER as
/* $Header: pecpoapi.pkh 120.1 2005/10/02 02:13 aroussel $ */
/*#
 * This package contains competence outcome APIs.
 * @rep:scope public
 * @rep:product per
 * @rep:displayname Competence Outcome
*/
--
-- ----------------------------------------------------------------------------
-- |------------------------------< create_outcome >--------------------------|
...
-- {Start Of Comments}
/*#
 * This API creates Competence Outcome.
 *
 * Competence outcome is the expected outcome that would be the resultant after
 * taking any training
 *
 * <p><b>Licensing</b><br>
 ...
 * Competence must exist.
 *
 * <p><b>Post Success</b><br>
 * Competence outcome is created.
 *
 * <p><b>Post Failure</b><br>
 * Competence outcome is not created and an error is raised
 ...
 * value.
 * @param p_competence_id Identifies the competence record to which this
 * outcome belongs.
 * @param p_outcome_number Outcome number
 * @param p_name Name or title of the outcome.
 * @param p_date_from Active start date of this outcome.
 * @param p_date_to Date until which this outcome is active.
 * @param p_assessment_criteria Assessment criteria
 ...
 * @param p_outcome_id If p_validate is false, then this uniquely identifies
 * the competence outcome created. If p_validate is true, then set to null.
 * @param p_object_version_number If p_validate is false, then set to the
 * version number of the created competence outcome. If p_validate is true,
 * then the value will be null.
 * @rep:displayname Create Outcome
...
-- {Start Of Comments}
/*#
 * This API updates the competence outcome.
 *
 * Competence outcome is the expected outcome that would be the resultant after
 * taking any training
 *
 ...
 *
 * <p><b>Prerequisites</b><br>
 * The competence outcome must exist.
 *
 * <p><b>Post Success</b><br>
 * Competence outcome is updated.
 *
 * <p><b>Post Failure</b><br>
 * Competence outcome is not updated and an error will be raised.
 * @param p_validate If true, then validation alone will be performed and the
 * database will remain unchanged. If false and all validation checks pass,
 * then the database will be modified.
 * @param p_effective_date Reference date for validating lookup values are
 ...
 * of hr_api.userenv_lang is equivalent to the RDBMS userenv('LANG') function
 * value.
 * @param p_outcome_id Identifies the competence outcome to be modified.
 * @param p_object_version_number Pass in the current version number of the
 * competence outcome to be updated. When the API completes if p_validate is
 * false, will be set to the new version number of the updated competence
 * outcome. If p_validate is true will be set to the same value which was
 * passed in
 * @param p_competence_id Identifies the competence record to which this
 * outcome belongs.
 * @param p_outcome_number Outcome number
 ...
 * @param p_information19 Developer descriptive flexfield segment.
 * @param p_information20 Developer descriptive flexfield segment.
 * @rep:displayname Update Outcome
 * @rep:category BUSINESS_ENTITY PER_COMPETENCE
 * @rep:category MISC_EXTENSIONS HR_DATAPUMP
 * @rep:category MISC_EXTENSIONS HR_USER_HOOKS
 * @rep:scope public
...
-- {Start Of Comments}
/*#
 * This API deletes competence outcome.
 *
 * Competence outcome is the expected outcome that would be the resultant after
 * taking any training
 *
 ...
 *
 * <p><b>Prerequisites</b><br>
 * Competence outcome must exist.
 *
 * <p><b>Post Success</b><br>
 * Competence outcome is deleted.
 *
 * <p><b>Post Failure</b><br>
 * Competence outcome is not deleted and an error is raised.
 * @param p_validate If true, then validation alone will be performed and the
 * database will remain unchanged. If false and all validation checks pass,
 * then the database will be modified.
 * @param p_outcome_id Identifies the competence outcome record to be deleted.
 * @param p_object_version_number Current version number of the competence
 * outcome to be deleted.
 * @rep:displayname Delete Outcome
 * @rep:category BUSINESS_ENTITY PER_COMPETENCE
 * @rep:category MISC_EXTENSIONS HR_USER_HOOKS
 * @rep:scope public
 * @rep:lifecycle active
