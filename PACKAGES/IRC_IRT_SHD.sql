--------------------------------------------------------
--  DDL for Package IRC_IRT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IRT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,redirection_url_c               clob
  ,redirection_url                 varchar2(32767)
  ,posting_url_c                   clob
  ,posting_url                     varchar2(32767)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_ALL_RECRUITING_SITES_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
