--------------------------------------------------------
--  DDL for Package PER_PRT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PRT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  performance_rating_id             number(15),
  person_id                         number(15),
  objective_id                      number(15),
  object_version_number             number(9),
  appraisal_id                      number(15),
  performance_level_id              number(15),
...
g_tab_nam constant varchar2(30)  := 'PER_PERFORMANCE_RATINGS';
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
