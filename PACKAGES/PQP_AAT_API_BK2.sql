--------------------------------------------------------
--  DDL for Package PQP_AAT_API_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_AAT_API_BK2" AUTHID CURRENT_USER as
/* $Header: pqaatapi.pkh 120.6.12010000.1 2008/07/28 11:07:01 appldev ship $ */
--
-- ---------------------------------------------------------------------------+
-- |-------------------------< update_assignment_attribute_b >----------------|
-- ---------------------------------------------------------------------------+
--
