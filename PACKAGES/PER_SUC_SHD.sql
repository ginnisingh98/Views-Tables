--------------------------------------------------------
--  DDL for Package PER_SUC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SUC_SHD" AUTHID CURRENT_USER AS
...
--
   TYPE g_rec_type IS RECORD (
      succession_plan_id        NUMBER (9),
      person_id                 per_succession_planning.person_id%TYPE,
      position_id               per_succession_planning.position_id%TYPE,
      business_group_id         NUMBER (15),
      start_date                DATE,
      time_scale                VARCHAR2 (30),
      end_date                  DATE,
      available_for_promotion   VARCHAR2 (30),
      manager_comments          VARCHAR2 (2000),
      ...
      job_id                    per_succession_planning.job_id%TYPE,
      successee_person_id       per_succession_planning.successee_person_id%TYPE,
      person_rank               per_succession_planning.person_rank%TYPE,
      performance               per_succession_planning.performance%TYPE,
      plan_status               per_succession_planning.plan_status%TYPE,
      readiness_percentage      per_succession_planning.readiness_percentage%TYPE
   );
