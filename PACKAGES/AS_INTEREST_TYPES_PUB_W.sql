--------------------------------------------------------
--  DDL for Package AS_INTEREST_TYPES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AS_INTEREST_TYPES_PUB_W" AUTHID CURRENT_USER as
  /* $Header: asxwinys.pls 115.0 2003/10/09 14:52:58 gbatra noship $ */
