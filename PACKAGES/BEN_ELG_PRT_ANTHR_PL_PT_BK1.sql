--------------------------------------------------------
--  DDL for Package BEN_ELG_PRT_ANTHR_PL_PT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELG_PRT_ANTHR_PL_PT_BK1" AUTHID CURRENT_USER as
/* $Header: beeppapi.pkh 120.0 2005/05/28 02:42:59 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELG_PRT_ANTHR_PL_PT_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELG_PRT_ANTHR_PL_PT_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELG_PRT_ANTHR_PL_PT_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELG_PRT_ANTHR_PL_PT_a
  (
...
--
end ben_ELG_PRT_ANTHR_PL_PT_bk1;
