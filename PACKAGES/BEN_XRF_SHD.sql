--------------------------------------------------------
--  DDL for Package BEN_XRF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XRF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  seq_num                           number(15),
  sprs_cd                           varchar2(30),
  sort1_data_elmt_in_rcd_id         number(15),
  sort2_data_elmt_in_rcd_id         number(15),
  sort3_data_elmt_in_rcd_id         number(15),
  sort4_data_elmt_in_rcd_id         number(15),
  ...
  any_or_all_cd                     varchar2(30),
  hide_flag                         varchar2(30),
  rqd_flag                          varchar2(30),
  chg_rcd_upd_flag                  varchar2(30)
  );
--
