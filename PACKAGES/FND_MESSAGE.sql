--------------------------------------------------------
--  DDL for Package FND_MESSAGE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FND_MESSAGE" AUTHID DEFINER as
...
/
  ...
  GRANT EXECUTE ON "APPS"."FND_MESSAGE" TO "APPLSYSPUB";
  GRANT EXECUTE ON "APPS"."FND_MESSAGE" TO "EM_OAM_MONITOR_ROLE";
