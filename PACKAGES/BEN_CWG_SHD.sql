--------------------------------------------------------
--  DDL for Package BEN_CWG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CWG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (cwb_wksht_grp_id                number(15)
  ,business_group_id               number(15)
  ,pl_id                           number(15)
  ,ordr_num                        number(15)
  ,wksht_grp_cd                    varchar2(30)
  ,label                           varchar2(80)
  ,cwg_attribute_category          varchar2(30)
  ,cwg_attribute1                  varchar2(150)
  ,cwg_attribute2                  varchar2(150)
  ,cwg_attribute3                  varchar2(150)
  ,cwg_attribute4                  varchar2(150)
  ,cwg_attribute5                  varchar2(150)
  ,cwg_attribute6                  varchar2(150)
  ,cwg_attribute7                  varchar2(150)
  ,cwg_attribute8                  varchar2(150)
  ,cwg_attribute9                  varchar2(150)
  ,cwg_attribute10                 varchar2(150)
  ,cwg_attribute11                 varchar2(150)
  ,cwg_attribute12                 varchar2(150)
  ,cwg_attribute13                 varchar2(150)
  ,cwg_attribute14                 varchar2(150)
  ,cwg_attribute15                 varchar2(150)
  ,cwg_attribute16                 varchar2(150)
  ,cwg_attribute17                 varchar2(150)
  ,cwg_attribute18                 varchar2(150)
  ,cwg_attribute19                 varchar2(150)
  ,cwg_attribute20                 varchar2(150)
  ,cwg_attribute21                 varchar2(150)
  ,cwg_attribute22                 varchar2(150)
  ,cwg_attribute23                 varchar2(150)
  ,cwg_attribute24                 varchar2(150)
  ,cwg_attribute25                 varchar2(150)
  ,cwg_attribute26                 varchar2(150)
  ,cwg_attribute27                 varchar2(150)
  ,cwg_attribute28                 varchar2(150)
  ,cwg_attribute29                 varchar2(150)
  ,cwg_attribute30                 varchar2(150)
  ,status_cd                       varchar2(30)
  ,hidden_cd                     varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_CWB_WKSHT_GRP';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
