--------------------------------------------------------
--  DDL for Package PSP_RTD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_RTD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,criteria_lookup_type            varchar2(30)
  ,criteria_lookup_code            varchar2(30)
  ,include_exclude_flag            varchar2(9)       -- Increased length
  ,criteria_value1                 varchar2(30)
  ,criteria_value2                 varchar2(60)      -- 8257434 Increased size to 60
  ,criteria_value3                 varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PSP_REPORT_TEMPLATE_DETAILS';
