--------------------------------------------------------
--  DDL for Package BEN_WYP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_WYP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_wthn_yr_perd_id already exists.
--
--  In Arguments:
--    p_wthn_yr_perd_id
--
...
function return_legislation_code
  (p_wthn_yr_perd_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
