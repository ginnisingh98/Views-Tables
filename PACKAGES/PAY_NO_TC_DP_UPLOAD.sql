--------------------------------------------------------
--  DDL for Package PAY_NO_TC_DP_UPLOAD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_NO_TC_DP_UPLOAD" AUTHID CURRENT_USER AS
/* $Header: pynotaxu.pkh 120.0 2005/05/29 07:02:10 appldev noship $ */
