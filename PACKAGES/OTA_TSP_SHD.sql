--------------------------------------------------------
--  DDL for Package OTA_TSP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TSP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  skill_provision_id                number(9),
  activity_version_id               number(9),
  object_version_number             number(9),        -- Increased length
  type                              varchar2(30),
  comments                          varchar2(2000),
  tsp_information_category          varchar2(30),
  tsp_information1                  varchar2(150),
  tsp_information2                  varchar2(150),
  tsp_information3                  varchar2(150),
  tsp_information4                  varchar2(150),
  tsp_information5                  varchar2(150),
  tsp_information6                  varchar2(150),
  tsp_information7                  varchar2(150),
  tsp_information8                  varchar2(150),
  tsp_information9                  varchar2(150),
  tsp_information10                 varchar2(150),
  tsp_information11                 varchar2(150),
  tsp_information12                 varchar2(150),
  tsp_information13                 varchar2(150),
  tsp_information14                 varchar2(150),
  tsp_information15                 varchar2(150),
  tsp_information16                 varchar2(150),
  tsp_information17                 varchar2(150),
  tsp_information18                 varchar2(150),
  tsp_information19                 varchar2(150),
  tsp_information20                 varchar2(150),
