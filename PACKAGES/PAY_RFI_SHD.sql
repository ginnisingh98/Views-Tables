--------------------------------------------------------
--  DDL for Package PAY_RFI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_RFI_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,report_format_item_id           number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_REPORT_FORMAT_ITEMS_F';
...
--           p_base_key_value = :report_format_item_id).
--
-- Post Success:
--   Processing continues.
--
...
--
-- Description:
--   This function is used to return the report_format_item_id of a
--   particular report format item from its true key - report_type,
--   report_qualifier, report_category and user_entity_id.
--
-- Prerequisites:
--   None
--
...
--
-- Post Success:
--   Returns the report_format_item_id of the corresponding report format
--   item if it exists. If the report format item does not exists then
--   the function returns null.
--
-- Post Failure:
--   Failure might occur if the report_format_item_id is null
--   or there is a non unique report_format_item_id for the report format
--   item that is being referred. The errors are trapped and reported.
--
-- Developer Implementation Notes:
--   None
--
