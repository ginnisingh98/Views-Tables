--------------------------------------------------------
--  DDL for Package BEN_BCM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BCM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (cwb_matrix_id                   number(15)
  ,name                            varchar2(240)
  ,date_saved                      date
  ,plan_id                         number(15)
  ,matrix_typ_cd                   varchar2(30)
  ,person_id                       number(15)
  ,row_crit_cd                     varchar2(30)
  ,col_crit_cd                     varchar2(30)
  ,alct_by_cd                      varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_CWB_MATRIX';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
