--------------------------------------------------------
--  DDL for Package CAC_NOTE_PURGE_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CAC_NOTE_PURGE_PUB" AUTHID CURRENT_USER AS
/* $Header: cacntprs.pls 120.4 2005/09/13 10:49:42 abraina noship $ */
/*=======================================================================+
 ...
 G_PKG_NAME      CONSTANT        VARCHAR2(30):='CAC_NOTE_PURGE_PUB';
