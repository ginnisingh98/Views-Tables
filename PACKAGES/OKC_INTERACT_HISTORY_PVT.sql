--------------------------------------------------------
--  DDL for Package OKC_INTERACT_HISTORY_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_INTERACT_HISTORY_PVT" AUTHID CURRENT_USER AS
/* $Header: OKCCIHAS.pls 120.0 2005/05/25 19:10:11 appldev noship $ */

  G_HANDLER_ID CONSTANT NUMBER := 510;
