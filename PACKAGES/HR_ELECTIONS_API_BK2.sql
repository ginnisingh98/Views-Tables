--------------------------------------------------------
--  DDL for Package HR_ELECTIONS_API_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_ELECTIONS_API_BK2" AUTHID CURRENT_USER as
/* $Header: peelcapi.pkh 120.1 2005/10/02 02:15:24 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |--------------------< update_election_information_b >---------------------|
-- ----------------------------------------------------------------------------
--
procedure update_election_information_b
...
--
-- ----------------------------------------------------------------------------
-- |--------------------< update_election_information_a >---------------------|
-- ----------------------------------------------------------------------------
--
procedure update_election_information_a
    (p_effective_date              in     date
    ,p_election_id		     	in     number
    ,p_object_version_number	     in number
    ,p_business_group_id           in     number
