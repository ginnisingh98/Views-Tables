--------------------------------------------------------
--  DDL for Package PQH_PTX_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_PTX_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  position_transaction_id           number(15),
  action_date                       date,
  position_id                       number(15),
  availability_status_id            number(15),
  business_group_id                 number(15),
  entry_step_id                     number(15),
  entry_grade_rule_id               number(15),
  job_id                            number(15),
  location_id                       number(15),
  organization_id                   number(15),
  pay_freq_payroll_id               number(15),
  position_definition_id            number(15),
  prior_position_id                 number(15),
  relief_position_id                number(15),
  entry_grade_id                    number(15),
  successor_position_id             number(15),
  supervisor_position_id            number(15),
  amendment_date                    date,
  amendment_recommendation          varchar2(2000),
  amendment_ref_number              varchar2(30),
  avail_status_prop_end_date        date,
  bargaining_unit_cd                varchar2(30),
  comments                          varchar2(2000),   -- pseudo column
  country1                          varchar2(30),
  country2                          varchar2(30),
  country3                          varchar2(30),
  current_job_prop_end_date         date,
  current_org_prop_end_date         date,
  date_effective                    date,
  date_end                          date,
  earliest_hire_date                date,
  fill_by_date                      date,
  frequency                         varchar2(30),
  fte                               number(15,5),      -- Increased length and precision
  fte_capacity                      varchar2(30),
  location1                         varchar2(30),
  location2                         varchar2(30),
  location3                         varchar2(30),
  max_persons                       number(9),        -- Increased length
  name                              varchar2(240),
  other_requirements                varchar2(2000),
  overlap_period                    number(19,0),
  overlap_unit_cd                   varchar2(30),
  passport_required                 varchar2(30),
  pay_term_end_day_cd               varchar2(30),
  pay_term_end_month_cd             varchar2(30),
  permanent_temporary_flag          varchar2(30),
  permit_recruitment_flag           varchar2(30),
  position_type                     varchar2(30),
  posting_description               varchar2(2000),
  probation_period                  number(19,0),
  probation_period_unit_cd          varchar2(30),
  relocate_domestically             varchar2(30),
  relocate_internationally          varchar2(30),
  replacement_required_flag         varchar2(30),
  review_flag                       varchar2(30),
  seasonal_flag                     varchar2(30),
  security_requirements             varchar2(2000),
  service_minimum                   varchar2(30),
  term_start_day_cd                 varchar2(30),
  term_start_month_cd               varchar2(30),
  ...
  travel_required                   varchar2(30),
  working_hours                     number(22,3),
  works_council_approval_flag       varchar2(30),
  work_any_country                  varchar2(30),
  work_any_location                 varchar2(30),
  work_period_type_cd               varchar2(30),
  work_schedule                     varchar2(30),
  work_duration                     varchar2(30),
  work_term_end_day_cd              varchar2(30),
  work_term_end_month_cd            varchar2(30),
  proposed_fte_for_layoff           number(15,2),      -- Increased length
  proposed_date_for_layoff          date,
  ...
  wf_transaction_category_id        number(15)
  );
--
-- ----------------------------------------------------------------------------
