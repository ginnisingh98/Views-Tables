--------------------------------------------------------
--  DDL for Package BEN_CLF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CLF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_comp_lvl_fctr_id already exists.
--
--  In Arguments:
--    p_comp_lvl_fctr_id
--
...
function return_legislation_code
  (p_comp_lvl_fctr_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
