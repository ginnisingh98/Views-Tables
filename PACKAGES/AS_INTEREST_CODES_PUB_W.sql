--------------------------------------------------------
--  DDL for Package AS_INTEREST_CODES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AS_INTEREST_CODES_PUB_W" AUTHID CURRENT_USER as
  /* $Header: asxwincs.pls 115.0 2003/10/09 14:52:57 gbatra noship $ */
