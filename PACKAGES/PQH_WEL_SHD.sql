--------------------------------------------------------
--  DDL for Package PQH_WEL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_WEL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  worksheet_bdgt_elmnt_id           number(15),
  worksheet_budget_set_id           number(15),
  element_type_id                   number(15),
  distribution_percentage           number(15,2),
