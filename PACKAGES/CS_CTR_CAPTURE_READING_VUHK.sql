--------------------------------------------------------
--  DDL for Package CS_CTR_CAPTURE_READING_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CS_CTR_CAPTURE_READING_VUHK" AUTHID CURRENT_USER as
/* $Header: csxicrds.pls 115.9 2002/11/01 21:13:36 mkommuri ship $*/
-- Start of Comments
-- Package name     : CS_CTR_CAPTURE_READING_VUHK
