--------------------------------------------------------
--  DDL for Package PSP_PEE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_PEE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (external_effort_line_id         number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PSP_EXTERNAL_EFFORT_LINES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
