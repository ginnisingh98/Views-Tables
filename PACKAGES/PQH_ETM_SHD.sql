--------------------------------------------------------
--  DDL for Package PQH_ETM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_ETM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (ent_minutes_id                  number(15)
  ,description                     varchar2(2000)
  ,ent_minutes_cd                  varchar2(30)
  ,tariff_group_cd                 varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_ENT_MINUTES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
