--------------------------------------------------------
--  DDL for Package HR_FI_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FI_APPLICANT_API" AUTHID CURRENT_USER as
/* $Header: peappfii.pkh 120.5.12010000.1 2008/07/28 04:06:51 appldev ship $ */
/*#
 * This package contains applicant APIs.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Applicant for Finland
*/
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_fi_applicant >------------------------|
...
-- {Start Of Comments}
/*#
 * This API creates a new Finnish applicant.
 *
 * The API creates the person details, a default applicant assignment, and an
 * application for the applicant. This API is effectively an alternative to the
 * API create_applicant. If p_validate is set to false, an applicant is
 * created.
 *
 * <p><b>Licensing</b><br>
 ...
 * The business group for Finland legislation must exist on the effective date.
 ...
 * applicant number generation method is Automatic this will be set to the
 * generated applicant number of the person created. If p_validate is true,
 * then the parameter value will be set to the same value as passed in.
 ...
 * @param p_secondary_email Secondary e-mail address.
 * @param p_epost_address E-post address.
 * @param p_speed_dial_number Speed dial number.
 * @param p_qualification Qualification of the applicant.
 * @param p_level Qualification level of the applicant. The lookup type
 * 'FI_QUAL_LEVEL' defines the valid values.
 * @param p_field Indicates the professional field of qualification. The lookup
 * type 'FI_QUAL_FIELD' defines the valid values.
 ...
 * @param p_dpdnt_adoption_date Date the dependent was adopted.
 ...
 * null and the person type is not Employee, Employee Applicant, Ex-Employee or
 * Ex- Employee Applicant.
 * @param p_union_name Name of the Trade Union to which the applicant belongs.
 * @param p_membership_number Applicant's Trade Union membership number.
 ...
 * @rep:displayname Create Applicant for Finland
