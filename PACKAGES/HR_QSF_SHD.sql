--------------------------------------------------------
--  DDL for Package HR_QSF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_QSF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  name                              varchar2(2000),
  type                              varchar2(30),
  html_text                         varchar2(32767),
  sql_required_flag                 varchar2(30),
...
g_tab_nam  constant varchar2(30) := 'HR_QUEST_FIELDS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
