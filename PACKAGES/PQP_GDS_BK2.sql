--------------------------------------------------------
--  DDL for Package PQP_GDS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_GDS_BK2" AUTHID CURRENT_USER as
/* $Header: pqgdsapi.pkh 120.0 2005/10/28 07:31 rvishwan noship $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< update_duration_summary_b >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_duration_summary_b
...
--
-- ----------------------------------------------------------------------------
-- |-------------------------< update_duration_summary_a >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_duration_summary_a
 (p_date_start                        IN  DATE
 ,p_gap_duration_summary_id     IN  NUMBER
 ,p_date_end                          IN  DATE
 ,p_assignment_id                     IN  NUMBER
