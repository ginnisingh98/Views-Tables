--------------------------------------------------------
--  DDL for Package HR_CNP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_CNP_SHD" AUTHID CURRENT_USER as
/* $Header: hrcnprhi.pkh 120.0 2005/05/30 23:17:21 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (canvas_property_id              number(15)
  ,object_version_number           number(9)
  ,form_canvas_id                  number(15)
  ,template_canvas_id              number(15)
  ,height                          number(12,2)
  ,visible                         number(10)
  ,width                           number(12,2)
