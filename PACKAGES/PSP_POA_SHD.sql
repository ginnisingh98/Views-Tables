--------------------------------------------------------
--  DDL for Package PSP_POA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_POA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (organization_account_id         number(9)
  ...
  ,task_id                         number(15)
  ,award_id                        number(15)
  ,comments                        varchar2(255)     -- pseudo column
  ...
  ,poeta_start_date                date
  ,poeta_end_date                  date
  ,object_version_number           number(9)
  ,funding_source_code             varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PSP_ORGANIZATION_ACCOUNTS';
