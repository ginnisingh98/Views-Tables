--------------------------------------------------------
--  DDL for Package PAY_TER_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_TER_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  flexfield_column                  varchar2(30),
  exclusion_value                   varchar2(150),
