--------------------------------------------------------
--  DDL for Package AST_UWQ_MLIST_INFO_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AST_UWQ_MLIST_INFO_PKG" AUTHID CURRENT_USER AS
/* $Header: astumins.pls 115.4 2002/12/04 23:38:36 gkeshava noship $ */

--Purpose:  This package will be used for displaying information within
--          the marketing list node of work panel
