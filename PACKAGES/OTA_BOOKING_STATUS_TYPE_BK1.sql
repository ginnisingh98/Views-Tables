--------------------------------------------------------
--  DDL for Package OTA_BOOKING_STATUS_TYPE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_BOOKING_STATUS_TYPE_BK1" AUTHID CURRENT_USER as
/* $Header: otbstapi.pkh 120.2 2006/08/30 06:58:23 niarora noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  OTA_BOOKING_STATUS_TYPE_BK1.';
--
-- ----------------------------------------------------------------------------
-- |--------------------------< CREATE_BOOKING_STATUS_TYPE_B >---------------------------|
-- ----------------------------------------------------------------------------
-- {Start Of Comments}
--
-- Description:
...
-- {End Of Comments}
--
procedure CREATE_BOOKING_STATUS_TYPE_B
...
-- {End Of Comments}
--
procedure CREATE_BOOKING_STATUS_TYPE_A
  (  p_effective_date                 in     date
  ,p_business_group_id              in     number
  ,p_active_flag                    in     varchar2
  ,p_default_flag                   in     varchar2
...
end OTA_BOOKING_STATUS_TYPE_BK1;
