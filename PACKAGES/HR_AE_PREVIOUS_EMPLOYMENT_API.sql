--------------------------------------------------------
--  DDL for Package HR_AE_PREVIOUS_EMPLOYMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_AE_PREVIOUS_EMPLOYMENT_API" AUTHID CURRENT_USER as
/* $Header: pepemaei.pkh 120.0.12010000.2 2008/10/31 12:29:29 pvelugul ship $ */
/*#
 * This package contains previous employment APIs.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Previous Employment for UAE
*/
--
-- ----------------------------------------------------------------------------
-- |-----------------------< create_ae_previous_employer >--------------------|
-- ----------------------------------------------------------------------------
--
-- {Start Of Comments}
/*#
 ...
 * @rep:displayname Create Previous Employer for UAE
 ...
 * previous employer.
 * @param p_end_date The date on which the employee left the previous employer.
 * @param p_period_years Number of years for the previous employment. This
 * is calculated based on the start date and end date.
 * @param p_period_months Number of months for the previous employment.
 * This is calculated based on the start date and end date.
 * @param p_period_days Remaining number of days. It is calculated from
 * period days.
 * @param p_employer_name Previous employer name.
 * @param p_employer_country The country in which the previous employer is
 * located.
 ...
 * @param p_object_version_number After a new record is is created object
 * version number is set to 1.
 * @rep:displayname Update Previous Employer for UAE
 * @rep:category BUSINESS_ENTITY PER_PREVIOUS_EMPLOYMENT
 * @rep:lifecycle active
 * @rep:scope public
 * @rep:ihelp PER/@scalapi APIs in Oracle HRMS
