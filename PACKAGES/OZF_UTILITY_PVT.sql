--------------------------------------------------------
--  DDL for Package OZF_UTILITY_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_UTILITY_PVT" AUTHID CURRENT_USER as
/* $Header: ozfvutls.pls 120.7.12010000.2 2010/03/05 09:22:48 bkunjan ship $ */
...
--    07-Aug-2000  ptendulk  Added procedure to write Concurrent Progrozf logs.
...
--   Wed Oct 29 2003:3/44 PM  RSSHARMA Added function get_party_name
...
--  17-FEB-2005   feliu    added  functions
			...
			--  get_paid_amount
			--  get_earned_amount
--   21-Sep-05    SSHIVALI   R12: Added a Type
...
g_ozf_lookups  CONSTANT VARCHAR2(12) :=  'OZF_LOOKUPS';
...
--Multiorg Changes
TYPE operating_units_tbl IS TABLE OF NUMBER INDEX BY BINARY_INTEGER;
...
--    3. p_pk_data_type can be OZF_Global_PVT.g_number/g_varchar2.
...
--   x_EXCHANGE_RATE_TYPE OUT VARCHAR2,-- comes from a OZF profile  or what ever is passed
--   x_EXCHANGE_RATE_DATE  OUT DATE, -- could come from a OZF profile but right now is sysdate
...
FUNCTION get_utilized_amount(p_list_header_id IN NUMBER) RETURN NUMBER;
