--------------------------------------------------------
--  DDL for Package HR_EDW_WRK_CMPSTN_F_SIZING
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_EDW_WRK_CMPSTN_F_SIZING" AUTHID CURRENT_USER AS
/* $Header: hriezwcp.pkh 120.1 2005/06/08 02:51:38 anmajumd noship $ */
