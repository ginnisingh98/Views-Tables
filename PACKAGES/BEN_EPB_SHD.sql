--------------------------------------------------------
--  DDL for Package BEN_EPB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  epb_attribute_category            varchar2(30),
  epb_attribute1                    varchar2(150),
  epb_attribute2                    varchar2(150),
  epb_attribute3                    varchar2(150),
  epb_attribute4                    varchar2(150),
  epb_attribute5                    varchar2(150),
  epb_attribute6                    varchar2(150),
  epb_attribute7                    varchar2(150),
  epb_attribute8                    varchar2(150),
  epb_attribute9                    varchar2(150),
  epb_attribute10                   varchar2(150),
  epb_attribute11                   varchar2(150),
  epb_attribute12                   varchar2(150),
  epb_attribute13                   varchar2(150),
  epb_attribute14                   varchar2(150),
  epb_attribute15                   varchar2(150),
  epb_attribute16                   varchar2(150),
  epb_attribute17                   varchar2(150),
  epb_attribute18                   varchar2(150),
  epb_attribute19                   varchar2(150),
  epb_attribute20                   varchar2(150),
  epb_attribute21                   varchar2(150),
  epb_attribute22                   varchar2(150),
  epb_attribute23                   varchar2(150),
  epb_attribute24                   varchar2(150),
  epb_attribute25                   varchar2(150),
  epb_attribute26                   varchar2(150),
  epb_attribute27                   varchar2(150),
  epb_attribute28                   varchar2(150),
  epb_attribute29                   varchar2(150),
  epb_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_py_bss_prte_id).
--
-- Post Success:
--   Processing continues.
--
