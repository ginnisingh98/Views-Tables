--------------------------------------------------------
--  DDL for Package BEN_BENERRTY_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BENERRTY_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: BENERRTYS.pls 120.1 2007/12/10 08:32:56 vjaganat noship $ */
	P_CONC_REQUEST_ID	number;
	P_DATE_MASK	varchar2(32767);
	P_CONCURRENT_REQUEST_ID	number;
	P_BENEFIT_ACTION_ID	number;
	P_PROCESS_DATE	varchar2(32767);
