--------------------------------------------------------
--  DDL for Package OKC_CONTRACT_SEQ_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_CONTRACT_SEQ_PVT" AUTHID CURRENT_USER as
/* $Header: OKCCKSQS.pls 120.0 2005/05/25 18:04:57 appldev noship $ */

  subtype ksqv_rec_type is okc_ksq_pvt.ksqv_rec_type;
  subtype ksqv_tbl_type is okc_ksq_pvt.ksqv_tbl_type;
  subtype lsqv_rec_type is okc_lsq_pvt.lsqv_rec_type;
  subtype lsqv_tbl_type is okc_lsq_pvt.lsqv_tbl_type;
  ...
  G_PKG_NAME			CONSTANT VARCHAR2(200) := 'OKC_CONTRACT_SEQ_PVT';
