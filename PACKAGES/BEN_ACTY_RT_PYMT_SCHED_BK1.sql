--------------------------------------------------------
--  DDL for Package BEN_ACTY_RT_PYMT_SCHED_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ACTY_RT_PYMT_SCHED_BK1" AUTHID CURRENT_USER as
/* $Header: beapfapi.pkh 120.0 2005/05/28 00:25:07 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_acty_rt_pymt_sched_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_acty_rt_pymt_sched_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_acty_rt_pymt_sched_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_acty_rt_pymt_sched_a
  (
...
--
end ben_acty_rt_pymt_sched_bk1;
