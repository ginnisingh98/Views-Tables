--------------------------------------------------------
--  DDL for Package HR_AMM_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_AMM_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_authoria_mapping_id
--     already exists.
--
--  In Arguments:
