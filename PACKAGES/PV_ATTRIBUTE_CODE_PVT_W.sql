--------------------------------------------------------
--  DDL for Package PV_ATTRIBUTE_CODE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PV_ATTRIBUTE_CODE_PVT_W" AUTHID CURRENT_USER as
  /* $Header: pvxwatcs.pls 120.1 2005/07/05 14:38 appldev ship $ */
