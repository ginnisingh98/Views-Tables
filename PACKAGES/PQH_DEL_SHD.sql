--------------------------------------------------------
--  DDL for Package PQH_DEL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_DEL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dflt_budget_element_id            number(10),
  dflt_budget_set_id                number(15),
  element_type_id                   number(9),
  dflt_dist_percentage              number(15,2),
