--------------------------------------------------------
--  DDL for Package BEN_PLAN_TYPE_IN_PROGRAM_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PLAN_TYPE_IN_PROGRAM_BK1" AUTHID CURRENT_USER as
/* $Header: bectpapi.pkh 120.0 2005/05/28 01:25:54 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Plan_Type_In_Program_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Plan_Type_In_Program_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Plan_Type_In_Program_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Plan_Type_In_Program_a
  (
   p_ptip_id                        in  number
...
--
end ben_Plan_Type_In_Program_bk1;
