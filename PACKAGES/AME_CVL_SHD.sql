--------------------------------------------------------
--  DDL for Package AME_CVL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_CVL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,user_config_var_name            varchar2(50)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_CONFIG_VARS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
