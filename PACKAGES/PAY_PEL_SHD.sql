--------------------------------------------------------
--  DDL for Package PAY_PEL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PEL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,grade_id                        number(15)
  ,balancing_keyflex_id            number(9)
  ,business_group_id               number(15)
  ,element_set_id                  number(9)
  ,pay_basis_id                    number(9)
  ,costable_type                   varchar2(30)
  ,link_to_all_payrolls_flag       varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_ELEMENT_LINKS_F';
...
--           p_base_key_value = :element_link_id).
--
-- Post Success:
--   Processing continues.
--
