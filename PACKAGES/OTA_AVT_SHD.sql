--------------------------------------------------------
--  DDL for Package OTA_AVT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_AVT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,intended_audience               varchar2(4000)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_ACTIVITY_VERSIONS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
