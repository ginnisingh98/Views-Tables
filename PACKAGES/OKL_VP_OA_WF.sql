--------------------------------------------------------
--  DDL for Package OKL_VP_OA_WF
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_VP_OA_WF" AUTHID CURRENT_USER AS
/* $Header: OKLROAWS.pls 120.0 2005/07/28 11:45:57 sjalasut noship $ */
  ---------------------------------------------------------------------------
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME       CONSTANT VARCHAR2(200) := 'OKL_VP_OA_WF';
  G_APP_NAME       CONSTANT VARCHAR2(3)   := OKL_API.G_APP_NAME;
  G_API_TYPE       CONSTANT VARCHAR2(30)  := '_PVT';

  -------------------------------------------------------------------------------
  -- PROCEDURE raise_oa_event_approval
  -------------------------------------------------------------------------------
  -- Start of comments
  --
  -- Procedure Name  : raise_oa_event_approval
  -- Description     : procedure raises business event for operating agreement approval
  --                 : business event name oracle.apps.okl.la.vp.approve_operating_agreement
  ...
  -------------------------------------------------------------------------------
  -- PROCEDURE process_oa_for_ame
  -------------------------------------------------------------------------------
  -- Start of comments
  --
  -- Procedure Name  : process_oa_for_ame
  -- Description     : procedure that sets the message subjects, transaction context
  --                 : for Oracle Approvals Managment to handle the operating agreement
  --                   approval process
  -- Parameters      : default wf parameters
  -- Version         : 1.0
  -- History         : May 18, 05 SJALASUT created
