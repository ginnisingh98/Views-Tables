--------------------------------------------------------
--  DDL for Package PSP_PSPLDPRJ_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_PSPLDPRJ_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: PSPLDPRJS.pls 120.4 2007/10/29 07:24:29 amakrish noship $ */
  P_PROJECT_ID VARCHAR2(2000);
  ...
  FUNCTION CF_CURR_PROJ_AMT_TOTALFORMULA(CF_CURRENCY_FORMAT IN VARCHAR2
                                        ,CS_CURR_PROJ_AMT_TOTAL IN NUMBER) RETURN CHAR;

  FUNCTION CF_EARNINGS_AMOUNTFORMULA(CF_CURRENCY_FORMAT IN VARCHAR2
                                    ,EARNINGS_AMOUNT IN NUMBER) RETURN CHAR;

  FUNCTION CF_PROJECT_NAMEFORMULA(PROJECT_ID_arg IN NUMBER) RETURN VARCHAR2;

  FUNCTION CF_EMPLOYEE_NAMEFORMULA(PERSON_ID_arg IN NUMBER) RETURN VARCHAR2;
  ...
  FUNCTION CF_TIME_PERIOD_NAMEFORMULA(TIME_PERIOD_ID_arg IN NUMBER) RETURN VARCHAR2;

  FUNCTION AFTERREPORT RETURN BOOLEAN;

  FUNCTION CF_BEGIN_DATE_DSPFORMULA(CF_DATE_FORMAT IN VARCHAR2) RETURN CHAR;
