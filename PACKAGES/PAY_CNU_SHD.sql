--------------------------------------------------------
--  DDL for Package PAY_CNU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CNU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (contribution_usage_id           number(9)
  ,date_from                       date
  ,date_to                         date
  ...
  ,retro_contribution_code         varchar2(30)
  ,contribution_type               varchar2(10)
  ,contribution_usage_type         varchar2(30)
  ,rate_category                   varchar2(9)       -- Increased length
  ,business_group_id               number(15)
  ,object_version_number           number(15)
  ,code_rate_id                    number(15)
  );
--
-- ----------------------------------------------------------------------------
