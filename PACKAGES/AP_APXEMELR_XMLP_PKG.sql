--------------------------------------------------------
--  DDL for Package AP_APXEMELR_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_APXEMELR_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: APXEMELRS.pls 120.0 2007/12/27 07:38:55 vjaganat noship $ */
	P_DEBUG_SWITCH	varchar2(1);
	P_CONC_REQUEST_ID	number;
	P_MIN_PRECISION	number;
	P_FLEXDATA	varchar2(600);
	P_SET_OF_BOOKS_ID	number;
	P_SUP_CHOSE	varchar2(40);
	P_LOC_CHOSE	varchar2(40);
	P_SUP_CHOSE_m	varchar2(40);
	P_LOC_CHOSE_m	varchar2(40);
	P_OUT_TYPE	varchar2(40);
	P_INA_TYPE	varchar2(32767);
