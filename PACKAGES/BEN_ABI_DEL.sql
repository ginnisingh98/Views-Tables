--------------------------------------------------------
--  DDL for Package BEN_ABI_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ABI_DEL" AUTHID CURRENT_USER as
...
--      datatype.
--   2) After the conversion has taken abrace, the corresponding record del
