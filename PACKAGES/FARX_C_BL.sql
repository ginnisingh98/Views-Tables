--------------------------------------------------------
--  DDL for Package FARX_C_BL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FARX_C_BL" AUTHID CURRENT_USER as
/* $Header: farxcbls.pls 120.3.12010000.3 2009/10/30 12:33:01 pmadas ship $ */
...
PROCEDURE ASSET_COST_BAL (
  ...
  argument5         in  varchar2  default 'N',   -- standard or drill down
...
PROCEDURE CIP_COST_BAL (
  ...
  argument4             in      varchar2 default null,   --request_id
  argument5           in      varchar2 default null,       --login_id
  argument6        in  varchar2  default  null,
  argument7        in  varchar2  default  null,
  argument8        in  varchar2  default  null,
  argument9        in  varchar2  default  null,
