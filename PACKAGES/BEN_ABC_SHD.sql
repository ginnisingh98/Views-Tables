--------------------------------------------------------
--  DDL for Package BEN_ABC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ABC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  acty_base_rt_ctfn_id              number(15),
  ...
  abc_attribute_category            varchar2(30),
  abc_attribute1                    varchar2(150),
  abc_attribute2                    varchar2(150),
  abc_attribute3                    varchar2(150),
  abc_attribute4                    varchar2(150),
  abc_attribute5                    varchar2(150),
  abc_attribute6                    varchar2(150),
  abc_attribute7                    varchar2(150),
  abc_attribute8                    varchar2(150),
  abc_attribute9                    varchar2(150),
  abc_attribute10                   varchar2(150),
  abc_attribute11                   varchar2(150),
  abc_attribute12                   varchar2(150),
  abc_attribute13                   varchar2(150),
  abc_attribute14                   varchar2(150),
  abc_attribute15                   varchar2(150),
  abc_attribute16                   varchar2(150),
  abc_attribute17                   varchar2(150),
  abc_attribute18                   varchar2(150),
  abc_attribute19                   varchar2(150),
  abc_attribute20                   varchar2(150),
  abc_attribute21                   varchar2(150),
  abc_attribute22                   varchar2(150),
  abc_attribute23                   varchar2(150),
  abc_attribute24                   varchar2(150),
  abc_attribute25                   varchar2(150),
  abc_attribute26                   varchar2(150),
  abc_attribute27                   varchar2(150),
  abc_attribute28                   varchar2(150),
  abc_attribute29                   varchar2(150),
  abc_attribute30                   varchar2(150),
...
--           p_base_key_value = :acty_base_rt_ctfn_id).
--
-- Post Success:
--   Processing continues.
--
