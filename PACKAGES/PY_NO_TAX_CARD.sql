--------------------------------------------------------
--  DDL for Package PY_NO_TAX_CARD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PY_NO_TAX_CARD" AUTHID CURRENT_USER AS
/* $Header: pynotaxc.pkh 120.0.12000000.1 2007/05/20 08:42:05 rlingama noship $ */
--
-- ----------------------------------------------------------------------------
-- |--------------------------< create_taxcard >----------------------------|
-- ----------------------------------------------------------------------------
