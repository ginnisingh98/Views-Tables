--------------------------------------------------------
--  DDL for Package BEN_CBS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CBS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  prem_cstg_by_sgmt_id              number(15),
  effective_start_date              date,
  effective_end_date                date,
  sgmt_num                          number(15),
  sgmt_cstg_mthd_cd                 varchar2(30),
  sgmt_cstg_mthd_rl                 number(15),
  business_group_id                 number(15),
  actl_prem_id                      number(15),
  cbs_attribute_category            varchar2(30),
  cbs_attribute1                    varchar2(150),
  cbs_attribute2                    varchar2(150),
  cbs_attribute3                    varchar2(150),
  cbs_attribute4                    varchar2(150),
  cbs_attribute5                    varchar2(150),
  cbs_attribute6                    varchar2(150),
  cbs_attribute7                    varchar2(150),
  cbs_attribute8                    varchar2(150),
  cbs_attribute9                    varchar2(150),
  cbs_attribute10                   varchar2(150),
  cbs_attribute11                   varchar2(150),
  cbs_attribute12                   varchar2(150),
  cbs_attribute13                   varchar2(150),
  cbs_attribute14                   varchar2(150),
  cbs_attribute15                   varchar2(150),
  cbs_attribute16                   varchar2(150),
  cbs_attribute17                   varchar2(150),
  cbs_attribute18                   varchar2(150),
  cbs_attribute19                   varchar2(150),
  cbs_attribute20                   varchar2(150),
  cbs_attribute21                   varchar2(150),
  cbs_attribute22                   varchar2(150),
  cbs_attribute23                   varchar2(150),
  cbs_attribute24                   varchar2(150),
  cbs_attribute25                   varchar2(150),
  cbs_attribute26                   varchar2(150),
  cbs_attribute27                   varchar2(150),
  cbs_attribute28                   varchar2(150),
  cbs_attribute29                   varchar2(150),
  cbs_attribute30                   varchar2(150),
...
--           p_base_key_value = :prem_cstg_by_sgmt_id).
--
-- Post Success:
--   Processing continues.
--
