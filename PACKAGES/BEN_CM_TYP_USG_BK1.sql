--------------------------------------------------------
--  DDL for Package BEN_CM_TYP_USG_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CM_TYP_USG_BK1" AUTHID CURRENT_USER as
