--------------------------------------------------------
--  DDL for Package PAY_APM_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_APM_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_process_module_id
--     already exists.
--
--  In Arguments:
--    p_process_module_id
