--------------------------------------------------------
--  DDL for Package HR_AE_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_AE_APPLICANT_API" AUTHID CURRENT_USER as
/* $Header: peappaei.pkh 120.5.12010000.2 2008/08/06 08:55:06 ubhat ship $ */
/*#
 * This package contains applicant APIs.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Applicant for UAE
*/
--
--
  -- ----------------------------------------------------------------------------
  ...
  -- {Start Of Comments}
/*#
 * This API creates a new UAE applicant.
 *
 ...
 * create_applicant, with the parameters set as appropriate for a UAE
 ...
 * @param p_place_of_birth Town or city of birth of the applicant.
 ...
 * @rep:displayname Create Applicant for UAE
