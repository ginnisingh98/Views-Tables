--------------------------------------------------------
--  DDL for Package BEN_EET_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EET_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_enrld_anthr_ptip_id          number(15),
  ...
  eet_attribute_category            varchar2(30),
  eet_attribute1                    varchar2(150),
  eet_attribute2                    varchar2(150),
  eet_attribute3                    varchar2(150),
  eet_attribute4                    varchar2(150),
  eet_attribute5                    varchar2(150),
  eet_attribute6                    varchar2(150),
  eet_attribute7                    varchar2(150),
  eet_attribute8                    varchar2(150),
  eet_attribute9                    varchar2(150),
  eet_attribute10                   varchar2(150),
  eet_attribute11                   varchar2(150),
  eet_attribute12                   varchar2(150),
  eet_attribute13                   varchar2(150),
  eet_attribute14                   varchar2(150),
  eet_attribute15                   varchar2(150),
  eet_attribute16                   varchar2(150),
  eet_attribute17                   varchar2(150),
  eet_attribute18                   varchar2(150),
  eet_attribute19                   varchar2(150),
  eet_attribute20                   varchar2(150),
  eet_attribute21                   varchar2(150),
  eet_attribute22                   varchar2(150),
  eet_attribute23                   varchar2(150),
  eet_attribute24                   varchar2(150),
  eet_attribute25                   varchar2(150),
  eet_attribute26                   varchar2(150),
  eet_attribute27                   varchar2(150),
  eet_attribute28                   varchar2(150),
  eet_attribute29                   varchar2(150),
  eet_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_enrld_anthr_ptip_id).
--
-- Post Success:
--   Processing continues.
--
