--------------------------------------------------------
--  DDL for Package BEN_PRP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  pl_regy_prps_id                   number(15),
  effective_start_date              date,
  effective_end_date                date,
  pl_regy_prps_cd                   varchar2(30),
  pl_regy_bod_id                    number(15),
  business_group_id                 number(15),
  prp_attribute_category            varchar2(30),
  prp_attribute1                    varchar2(150),
  prp_attribute2                    varchar2(150),
  prp_attribute3                    varchar2(150),
  prp_attribute4                    varchar2(150),
  prp_attribute5                    varchar2(150),
  prp_attribute6                    varchar2(150),
  prp_attribute7                    varchar2(150),
  prp_attribute8                    varchar2(150),
  prp_attribute9                    varchar2(150),
  prp_attribute10                   varchar2(150),
  prp_attribute11                   varchar2(150),
  prp_attribute12                   varchar2(150),
  prp_attribute13                   varchar2(150),
  prp_attribute14                   varchar2(150),
  prp_attribute15                   varchar2(150),
  prp_attribute16                   varchar2(150),
  prp_attribute17                   varchar2(150),
  prp_attribute18                   varchar2(150),
  prp_attribute19                   varchar2(150),
  prp_attribute20                   varchar2(150),
  prp_attribute21                   varchar2(150),
  prp_attribute22                   varchar2(150),
  prp_attribute23                   varchar2(150),
  prp_attribute24                   varchar2(150),
  prp_attribute25                   varchar2(150),
  prp_attribute26                   varchar2(150),
  prp_attribute27                   varchar2(150),
  prp_attribute28                   varchar2(150),
  prp_attribute29                   varchar2(150),
  prp_attribute30                   varchar2(150),
...
--           p_base_key_value = :pl_regy_prps_id).
--
-- Post Success:
--   Processing continues.
--
