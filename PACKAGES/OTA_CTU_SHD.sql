--------------------------------------------------------
--  DDL for Package OTA_CTU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CTU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,parent_cat_usage_id             number
  ,synchronous_flag                varchar2(30)
  ,online_flag                     varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_CATEGORY_USAGES';
