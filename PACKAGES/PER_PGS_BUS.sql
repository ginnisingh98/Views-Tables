--------------------------------------------------------
--  DDL for Package PER_PGS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PGS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_grade_spine_id
--     already exists.
--
--  In Arguments:
--    p_grade_spine_id
