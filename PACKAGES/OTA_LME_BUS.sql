--------------------------------------------------------
--  DDL for Package OTA_LME_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_LME_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_lp_member_enrollment_id
--     already exists.
--
--  In Arguments:
