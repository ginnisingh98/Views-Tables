--------------------------------------------------------
--  DDL for Package IGI_IGIIARRV_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGI_IGIIARRV_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: IGIIARRVS.pls 120.0.12010000.1 2008/07/29 08:58:48 appldev ship $ */
  P_BOOK VARCHAR2(15);
DO_INSERT number;
