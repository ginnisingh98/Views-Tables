--------------------------------------------------------
--  DDL for Package HR_TTL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TTL_SHD" AUTHID CURRENT_USER as
/* $Header: hrttlrhi.pkh 120.0 2005/05/31 03:32:39 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_KI_TOPICS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
