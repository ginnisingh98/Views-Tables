--------------------------------------------------------
--  DDL for Package BEN_PAP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PAP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  pap_attribute_category            varchar2(30),
  pap_attribute1                    varchar2(150),
  pap_attribute2                    varchar2(150),
  pap_attribute3                    varchar2(150),
  pap_attribute4                    varchar2(150),
  pap_attribute5                    varchar2(150),
  pap_attribute6                    varchar2(150),
  pap_attribute7                    varchar2(150),
  pap_attribute8                    varchar2(150),
  pap_attribute9                    varchar2(150),
  pap_attribute10                   varchar2(150),
  pap_attribute11                   varchar2(150),
  pap_attribute12                   varchar2(150),
  pap_attribute13                   varchar2(150),
  pap_attribute14                   varchar2(150),
  pap_attribute15                   varchar2(150),
  pap_attribute16                   varchar2(150),
  pap_attribute17                   varchar2(150),
  pap_attribute18                   varchar2(150),
  pap_attribute19                   varchar2(150),
  pap_attribute20                   varchar2(150),
  pap_attribute21                   varchar2(150),
  pap_attribute22                   varchar2(150),
  pap_attribute23                   varchar2(150),
  pap_attribute24                   varchar2(150),
  pap_attribute25                   varchar2(150),
  pap_attribute26                   varchar2(150),
  pap_attribute27                   varchar2(150),
  pap_attribute28                   varchar2(150),
  pap_attribute29                   varchar2(150),
  pap_attribute30                   varchar2(150),
...
--           p_base_key_value = :prtt_anthr_pl_rt_id).
--
-- Post Success:
--   Processing continues.
--
