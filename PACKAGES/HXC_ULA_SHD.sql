--------------------------------------------------------
--  DDL for Package HXC_ULA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_ULA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (layout_id                       number(15)
  ,layout_name                     varchar2(30)
  ,application_id                  number(15)
  ,layout_type                     varchar2(30)
  ,modifier_level                  varchar2(30)
  ,modifier_value                  varchar2(240)
  ,top_level_region_code           varchar2(30)
