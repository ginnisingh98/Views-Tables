--------------------------------------------------------
--  DDL for Package HXC_LCK_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_LCK_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (locker_type_id                  number(15)
  ,locker_type                     varchar2(80)
  ,process_type                    varchar2(80)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HXC_LOCKER_TYPES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
