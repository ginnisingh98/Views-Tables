--------------------------------------------------------
--  DDL for Package BEN_EDP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EDP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_dpnt_cvrd_othr_pl_id         number(15),
  ...
  pl_id                             number(15),
  edp_attribute_category            varchar2(30),
  edp_attribute1                    varchar2(150),
  edp_attribute2                    varchar2(150),
  edp_attribute3                    varchar2(150),
  edp_attribute4                    varchar2(150),
  edp_attribute5                    varchar2(150),
  edp_attribute6                    varchar2(150),
  edp_attribute7                    varchar2(150),
  edp_attribute8                    varchar2(150),
  edp_attribute9                    varchar2(150),
  edp_attribute10                   varchar2(150),
  edp_attribute11                   varchar2(150),
  edp_attribute12                   varchar2(150),
  edp_attribute13                   varchar2(150),
  edp_attribute14                   varchar2(150),
  edp_attribute15                   varchar2(150),
  edp_attribute16                   varchar2(150),
  edp_attribute17                   varchar2(150),
  edp_attribute18                   varchar2(150),
  edp_attribute19                   varchar2(150),
  edp_attribute20                   varchar2(150),
  edp_attribute21                   varchar2(150),
  edp_attribute22                   varchar2(150),
  edp_attribute23                   varchar2(150),
  edp_attribute24                   varchar2(150),
  edp_attribute25                   varchar2(150),
  edp_attribute26                   varchar2(150),
  edp_attribute27                   varchar2(150),
  edp_attribute28                   varchar2(150),
  edp_attribute29                   varchar2(150),
  edp_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_dpnt_cvrd_othr_pl_id).
--
-- Post Success:
--   Processing continues.
--
