--------------------------------------------------------
--  DDL for Package PER_PAC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PAC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_allocated_checklist_id
--     already exists.
--
--  In Arguments:
