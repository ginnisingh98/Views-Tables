--------------------------------------------------------
--  DDL for Package QP_PLL_PRICING_ATTR_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."QP_PLL_PRICING_ATTR_UTIL" AUTHID CURRENT_USER AS
/* $Header: QPXUPLAS.pls 120.1.12000000.1 2007/01/17 22:32:11 appldev ship $ */
...
G_FROM_RLTD_MODIFIER          CONSTANT NUMBER := 39;
G_COMPARISON_OPERATOR_CODE    CONSTANT NUMBER := 40;
G_PRICING_ATTRIBUTE_DATATYPE  CONSTANT NUMBER := 41;
G_PRODUCT_ATTRIBUTE_DATATYPE  CONSTANT NUMBER := 42;
G_LIST_HEADER                 CONSTANT NUMBER := 43;
G_PRICING_PHASE               CONSTANT NUMBER := 44;
