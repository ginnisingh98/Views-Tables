--------------------------------------------------------
--  DDL for Package BEN_ETW_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ETW_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_per_wv_pl_typ_id             number(15),
  effective_start_date              date,
  effective_end_date                date,
  pl_typ_id                         number(15),
  elig_per_id                       number(15),
  wv_cftn_typ_cd                    varchar2(30),
  wv_prtn_rsn_cd                    varchar2(30),
  wvd_flag                          varchar2(30),
  business_group_id                 number(15),
  etw_attribute_category            varchar2(30),
  etw_attribute1                    varchar2(150),
  etw_attribute2                    varchar2(150),
  etw_attribute3                    varchar2(150),
  etw_attribute4                    varchar2(150),
  etw_attribute5                    varchar2(150),
  etw_attribute6                    varchar2(150),
  etw_attribute7                    varchar2(150),
  etw_attribute8                    varchar2(150),
  etw_attribute9                    varchar2(150),
  etw_attribute10                   varchar2(150),
  etw_attribute11                   varchar2(150),
  etw_attribute12                   varchar2(150),
  etw_attribute13                   varchar2(150),
  etw_attribute14                   varchar2(150),
  etw_attribute15                   varchar2(150),
  etw_attribute16                   varchar2(150),
  etw_attribute17                   varchar2(150),
  etw_attribute18                   varchar2(150),
  etw_attribute19                   varchar2(150),
  etw_attribute20                   varchar2(150),
  etw_attribute21                   varchar2(150),
  etw_attribute22                   varchar2(150),
  etw_attribute23                   varchar2(150),
  etw_attribute24                   varchar2(150),
  etw_attribute25                   varchar2(150),
  etw_attribute26                   varchar2(150),
  etw_attribute27                   varchar2(150),
  etw_attribute28                   varchar2(150),
  etw_attribute29                   varchar2(150),
  etw_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_per_wv_pl_typ_id).
--
-- Post Success:
--   Processing continues.
--
