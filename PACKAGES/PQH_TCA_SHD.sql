--------------------------------------------------------
--  DDL for Package PQH_TCA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TCA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  txn_category_attribute_id         number(15),
  attribute_id                      number(15),
  transaction_category_id           number(15),
  value_set_id                      number(15),
  object_version_number             number(9),
  transaction_table_route_id        number(15),
  form_column_name                  varchar2(30),
  identifier_flag                   varchar2(10),
  list_identifying_flag             varchar2(10),
  member_identifying_flag           varchar2(10),
  refresh_flag                      varchar2(10),
  select_flag                       varchar2(10),
  value_style_cd                    varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
