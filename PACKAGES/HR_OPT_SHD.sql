--------------------------------------------------------
--  DDL for Package HR_OPT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_OPT_SHD" AUTHID CURRENT_USER as
/* $Header: hroptrhi.pkh 120.0 2005/05/31 01:47:12 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (option_id                       number(15)
  ,option_type_id                  number(15)
  ,option_level                    number(15)
  ,option_level_id                 varchar2(50)
  ,value                           varchar2(1000)
  ,encrypted                       varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_KI_OPTIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
