--------------------------------------------------------
--  DDL for Package OTA_TMT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TMT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,tp_measurement_code             varchar2(30)
  ,unit                            varchar2(30)
  ,reporting_sequence              number(9)
  ,budget_level                    varchar2(30)
  ,cost_level                      varchar2(30)
  ,many_budget_values_flag         varchar2(30)
  ,item_type_usage_id              number(15)
