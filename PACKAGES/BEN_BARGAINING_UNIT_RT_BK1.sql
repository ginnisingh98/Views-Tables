--------------------------------------------------------
--  DDL for Package BEN_BARGAINING_UNIT_RT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BARGAINING_UNIT_RT_BK1" AUTHID CURRENT_USER as
/* $Header: beburapi.pkh 120.0 2005/05/28 00:53:43 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_BARGAINING_UNIT_RT_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_BARGAINING_UNIT_RT_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_BARGAINING_UNIT_RT_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_BARGAINING_UNIT_RT_a
  (
...
--
end ben_BARGAINING_UNIT_RT_bk1;
