--------------------------------------------------------
--  DDL for Package PAY_SID_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_SID_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (prsi_details_id                 number(10)
  ,effective_start_date            date
  ,effective_end_date              date
  ,object_version_number           number(9)
  ,assignment_id                   number(10)
  ,contribution_class              varchar2(30)
  ,overridden_subclass             varchar2(30)
  ,soc_ben_flag                    varchar2(30)
  ,soc_ben_start_date              date
  ,overridden_ins_weeks            number(10)
  ,non_standard_ins_weeks          number(10)
  ,exemption_start_date            date
  ,exemption_end_date              date
  ,cert_issued_by                  varchar2(240)
  ,director_flag                   varchar2(30)
  ,request_id                      number(15)
  ,program_application_id          number(15)
  ,program_id                      number(15)
  ,program_update_date             date
  ,community_flag                  varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :prsi_details_id).
--
-- Post Success:
