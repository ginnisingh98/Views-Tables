--------------------------------------------------------
--  DDL for Package PER_ZA_TRA_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_TRA_DEL" AUTHID CURRENT_USER as
/* $Header: pezatrde.pkh 115.0 2001/02/04 22:36:06 pkm ship        $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< del >----------------------------------|
-- ----------------------------------------------------------------------------
