--------------------------------------------------------
--  DDL for Package BEN_EOU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EOU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_org_unit_prte_id             number(15),
  ...
  ordr_num                          number(15),
  eou_attribute_category            varchar2(30),
  eou_attribute1                    varchar2(150),
  eou_attribute2                    varchar2(150),
  eou_attribute3                    varchar2(150),
  eou_attribute4                    varchar2(150),
  eou_attribute5                    varchar2(150),
  eou_attribute6                    varchar2(150),
  eou_attribute7                    varchar2(150),
  eou_attribute8                    varchar2(150),
  eou_attribute9                    varchar2(150),
  eou_attribute10                   varchar2(150),
  eou_attribute11                   varchar2(150),
  eou_attribute12                   varchar2(150),
  eou_attribute13                   varchar2(150),
  eou_attribute14                   varchar2(150),
  eou_attribute15                   varchar2(150),
  eou_attribute16                   varchar2(150),
  eou_attribute17                   varchar2(150),
  eou_attribute18                   varchar2(150),
  eou_attribute19                   varchar2(150),
  eou_attribute20                   varchar2(150),
  eou_attribute21                   varchar2(150),
  eou_attribute22                   varchar2(150),
  eou_attribute23                   varchar2(150),
  eou_attribute24                   varchar2(150),
  eou_attribute25                   varchar2(150),
  eou_attribute26                   varchar2(150),
  eou_attribute27                   varchar2(150),
  eou_attribute28                   varchar2(150),
  eou_attribute29                   varchar2(150),
  eou_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_org_unit_prte_id).
--
-- Post Success:
--   Processing continues.
--
