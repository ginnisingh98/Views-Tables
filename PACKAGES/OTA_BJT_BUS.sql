--------------------------------------------------------
--  DDL for Package OTA_BJT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_BJT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_booking_justification_id
--     already exists.
--
--  In Arguments:
