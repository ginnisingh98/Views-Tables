--------------------------------------------------------
--  DDL for Package PQH_ATT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_ATT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  master_attribute_id               number(15),
  master_table_route_id             number(15),
  column_name                       varchar2(2000),
  column_type                       varchar2(9),      -- Increased length
  enable_flag                       varchar2(10),
  width                             number(15),
  object_version_number             number(9),
  region_itemname                   varchar2(80),
  attribute_itemname                varchar2(80),
  decode_function_name              varchar2(80)
  );
--
-- ----------------------------------------------------------------------------
