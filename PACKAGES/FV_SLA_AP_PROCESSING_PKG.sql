--------------------------------------------------------
--  DDL for Package FV_SLA_AP_PROCESSING_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FV_SLA_AP_PROCESSING_PKG" AUTHID CURRENT_USER as
--$Header: FVXLAAPS.pls 120.0.12010000.1 2010/02/10 19:34:58 sasukuma noship $
...
END fv_sla_ap_processing_pkg; -- Package spec
