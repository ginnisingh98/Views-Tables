--------------------------------------------------------
--  DDL for Package BEN_EPN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_prbtn_perd_prte_id            number(15),
  ...
  epn_attribute_category            varchar2(30),
  epn_attribute1                    varchar2(150),
  epn_attribute2                    varchar2(150),
  epn_attribute3                    varchar2(150),
  epn_attribute4                    varchar2(150),
  epn_attribute5                    varchar2(150),
  epn_attribute6                    varchar2(150),
  epn_attribute7                    varchar2(150),
  epn_attribute8                    varchar2(150),
  epn_attribute9                    varchar2(150),
  epn_attribute10                   varchar2(150),
  epn_attribute11                   varchar2(150),
  epn_attribute12                   varchar2(150),
  epn_attribute13                   varchar2(150),
  epn_attribute14                   varchar2(150),
  epn_attribute15                   varchar2(150),
  epn_attribute16                   varchar2(150),
  epn_attribute17                   varchar2(150),
  epn_attribute18                   varchar2(150),
  epn_attribute19                   varchar2(150),
  epn_attribute20                   varchar2(150),
  epn_attribute21                   varchar2(150),
  epn_attribute22                   varchar2(150),
  epn_attribute23                   varchar2(150),
  epn_attribute24                   varchar2(150),
  epn_attribute25                   varchar2(150),
  epn_attribute26                   varchar2(150),
  epn_attribute27                   varchar2(150),
  epn_attribute28                   varchar2(150),
  epn_attribute29                   varchar2(150),
  epn_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_prbtn_perd_prte_id).
--
-- Post Success:
--   Processing continues.
--
