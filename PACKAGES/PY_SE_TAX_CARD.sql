--------------------------------------------------------
--  DDL for Package PY_SE_TAX_CARD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PY_SE_TAX_CARD" AUTHID CURRENT_USER AS
/* $Header: pysetaxc.pkh 120.0.12000000.1 2007/04/24 06:36:29 rsahai noship $ */
--
-- ----------------------------------------------------------------------------
-- |--------------------------< create_taxcard >----------------------------|
-- ----------------------------------------------------------------------------
...
--
-- Description:
--	This API will insert a tax card entry for a Sweden Assignment.
...
--
-- Description:
--	This API will update the tax card entry for a Sweden Assignment.
