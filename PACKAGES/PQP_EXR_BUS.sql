--------------------------------------------------------
--  DDL for Package PQP_EXR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_EXR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_exception_report_id
--     already exists.
--
--  In Arguments:
