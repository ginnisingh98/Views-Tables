--------------------------------------------------------
--  DDL for Package BEN_APR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_APR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  val                               number,
  mlt_cd                            varchar2(30),
  prdct_cd                          varchar2(30),
  rndg_cd                           varchar2(30),
  rndg_rl                           number(15),
  val_calc_rl                       number(15),
  prem_asnmt_cd                     varchar2(30),
  prem_asnmt_lvl_cd                 varchar2(30),
  actl_prem_typ_cd                  varchar2(30),
  prem_pyr_cd                       varchar2(30),
  cr_lkbk_val                       number,
  cr_lkbk_uom                       varchar2(30),
  cr_lkbk_crnt_py_only_flag         varchar2(30),
  prsptv_r_rtsptv_cd                varchar2(30),
  upr_lmt_val                       number,
  upr_lmt_calc_rl                   number,
  lwr_lmt_val                       number,
  lwr_lmt_calc_rl                   number,
  ...
  wsh_rl_dy_mo_num                  number(9),
  vrbl_rt_add_on_calc_rl            number(15),
  apr_attribute_category            varchar2(30),
  apr_attribute1                    varchar2(150),
  apr_attribute2                    varchar2(150),
  apr_attribute3                    varchar2(150),
  apr_attribute4                    varchar2(150),
  apr_attribute5                    varchar2(150),
  apr_attribute6                    varchar2(150),
  apr_attribute7                    varchar2(150),
  apr_attribute8                    varchar2(150),
  apr_attribute9                    varchar2(150),
  apr_attribute10                   varchar2(150),
  apr_attribute11                   varchar2(150),
  apr_attribute12                   varchar2(150),
  apr_attribute13                   varchar2(150),
  apr_attribute14                   varchar2(150),
  apr_attribute15                   varchar2(150),
  apr_attribute16                   varchar2(150),
  apr_attribute17                   varchar2(150),
  apr_attribute18                   varchar2(150),
  apr_attribute19                   varchar2(150),
  apr_attribute20                   varchar2(150),
  apr_attribute21                   varchar2(150),
  apr_attribute22                   varchar2(150),
  apr_attribute23                   varchar2(150),
  apr_attribute24                   varchar2(150),
  apr_attribute25                   varchar2(150),
  apr_attribute26                   varchar2(150),
  apr_attribute27                   varchar2(150),
  apr_attribute28                   varchar2(150),
  apr_attribute29                   varchar2(150),
  apr_attribute30                   varchar2(150),
