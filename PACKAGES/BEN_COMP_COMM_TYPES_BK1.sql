--------------------------------------------------------
--  DDL for Package BEN_COMP_COMM_TYPES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_COMP_COMM_TYPES_BK1" AUTHID CURRENT_USER as
/* $Header: becctapi.pkh 120.0 2005/05/28 00:58:44 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_comp_comm_types_b >-------------------|
-- ----------------------------------------------------------------------------
--
procedure create_comp_comm_types_b
  (p_name                           in  varchar2
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_comp_comm_types_a >-------------------|
-- ----------------------------------------------------------------------------
--
procedure create_comp_comm_types_a
