--------------------------------------------------------
--  DDL for Package PAY_LIV_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_LIV_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_link_input_value_id
--     already exists.
--
--  In Arguments:
