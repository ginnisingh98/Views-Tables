--------------------------------------------------------
--  DDL for Package ZX_VTX_USER_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ZX_VTX_USER_PKG" AUTHID CURRENT_USER AS
/* $Header: zxvtxuserpkgs.pls 120.9 2006/09/14 21:15:54 svaze ship $ */
   ...
   fetch from the main cursor defined in Derive_Line_Ext_Attr procedure .*/
	 ...
	 TYPE arp_customer_code_table     IS TABLE OF ZX_PRVDR_LINE_EXTNS_GT.LINE_EXT_VARCHAR_ATTRIBUTE12%TYPE
		INDEX BY BINARY_INTEGER;
	 TYPE arp_customer_class_table     IS TABLE OF ZX_PRVDR_LINE_EXTNS_GT.LINE_EXT_VARCHAR_ATTRIBUTE13%TYPE
		INDEX BY BINARY_INTEGER;
	 ...
	 TYPE bill_third_pty_site_table        IS TABLE OF ZX_LINES_DET_FACTORS.BILL_THIRD_PTY_ACCT_SITE_ID%TYPE
		INDEX BY BINARY_INTEGER;
         ...
         certificate_number      ZX_PRVDR_LINE_EXTNS_GT.LINE_EXT_VARCHAR_ATTRIBUTE3%TYPE,
         ...
         district_exempt_reason  ZX_PRVDR_LINE_EXTNS_GT.LINE_EXT_VARCHAR_ATTRIBUTE7%TYPE,
         ...
         district_exempt_pct     ZX_PRVDR_LINE_EXTNS_GT.LINE_EXT_NUMBER_ATTRIBUTE4%TYPE,
	 ...
	 TYPE exemptions_info_table          IS TABLE OF exemptions_info_rec
         ...
         arp_customer_class_tab     arp_customer_class_table;
