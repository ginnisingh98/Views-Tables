--------------------------------------------------------
--  DDL for Package PQP_VAL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_VAL_SHD" AUTHID CURRENT_USER as
...
-- ----------------------------------------------------------------------------
--
g_message                          VARCHAR2(80);
Type g_rec_type Is Record
  (vehicle_allocation_id           number(10)
  ,effective_start_date            date
  ,effective_end_date              date
  ,assignment_id                   number(10)
  ,business_group_id               number(15)
  ,across_assignments              varchar2(30)
  ,vehicle_repository_id           number(10)
  ,usage_type                      varchar2(30)
  ,capital_contribution            number(11,2)
  ,private_contribution            number(11,2)
  ,default_vehicle                 varchar2(9)       -- Increased length
  ,fuel_card                       varchar2(30)
  ,fuel_card_number                varchar2(30)
  ,calculation_method              varchar2(80)
  ,rates_table_id                  number(10)
  ,element_type_id                 number(10)
  ,private_use_flag		   varchar2(30)
  ,insurance_number		   varchar2(80)
  ,insurance_expiry_date	   date
  ,val_attribute_category          varchar2(30)
  ,val_attribute1                  varchar2(150)
  ,val_attribute2                  varchar2(150)
  ,val_attribute3                  varchar2(150)
  ,val_attribute4                  varchar2(150)
  ,val_attribute5                  varchar2(150)
  ,val_attribute6                  varchar2(150)
  ,val_attribute7                  varchar2(150)
  ,val_attribute8                  varchar2(150)
  ,val_attribute9                  varchar2(150)
  ,val_attribute10                 varchar2(150)
  ,val_attribute11                 varchar2(150)
  ,val_attribute12                 varchar2(150)
  ,val_attribute13                 varchar2(150)
  ,val_attribute14                 varchar2(150)
  ,val_attribute15                 varchar2(150)
  ,val_attribute16                 varchar2(150)
  ,val_attribute17                 varchar2(150)
  ,val_attribute18                 varchar2(150)
  ,val_attribute19                 varchar2(150)
  ,val_attribute20                 varchar2(150)
  ,val_information_category        varchar2(30)
  ,val_information1                varchar2(150)
  ,val_information2                varchar2(150)
  ,val_information3                varchar2(150)
  ,val_information4                varchar2(150)
  ,val_information5                varchar2(150)
  ,val_information6                varchar2(150)
  ,val_information7                varchar2(150)
  ,val_information8                varchar2(150)
  ,val_information9                varchar2(150)
  ,val_information10               varchar2(150)
  ,val_information11               varchar2(150)
  ,val_information12               varchar2(150)
  ,val_information13               varchar2(150)
  ,val_information14               varchar2(150)
  ,val_information15               varchar2(150)
  ,val_information16               varchar2(150)
  ,val_information17               varchar2(150)
  ,val_information18               varchar2(150)
  ,val_information19               varchar2(150)
  ,val_information20               varchar2(150)
  ,object_version_number           number(9)
  ,fuel_benefit                    varchar2(30)
  ,sliding_rates_info              varchar2(80)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQP_VEHICLE_ALLOCATIONS_F';
...
--
------------------------------------------------------------------------------
--This function returns global value.
Function pqp_get_global_msg_value return
varchar2 ;
...
--           p_base_key_value = :vehicle_allocation_id).
--
-- Post Success:
