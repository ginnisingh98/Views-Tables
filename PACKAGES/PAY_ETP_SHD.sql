--------------------------------------------------------
--  DDL for Package PAY_ETP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_ETP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,advance_element_type_id	   number(9)	     -- Added for Advance Pay
  ,deduction_element_type_id	   number(9)
  );
--
-- ----------------------------------------------------------------------------
