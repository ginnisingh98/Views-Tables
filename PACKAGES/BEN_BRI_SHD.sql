--------------------------------------------------------
--  DDL for Package BEN_BRI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BRI_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  mn_elcn_val                       number(38),
  mx_elcn_val                       number(38),
  incrmt_elcn_val                   number(38),
  dflt_val                          number(38),
  rt_strt_dt                        date,
