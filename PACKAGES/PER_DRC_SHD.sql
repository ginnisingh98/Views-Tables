--------------------------------------------------------
--  DDL for Package PER_DRC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_DRC_SHD" AUTHID CURRENT_USER as
/* $Header: pedrcrhi.pkh 120.0.12010000.1 2018/04/12 14:19:25 gahluwal noship $ */
...
-- Global table name
g_tab_nam  constant VARCHAR2(30) := 'PER_DRT_COLUMNS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
