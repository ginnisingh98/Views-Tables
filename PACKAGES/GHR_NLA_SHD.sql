--------------------------------------------------------
--  DDL for Package GHR_NLA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_NLA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  noac_la_id                        number(15),
  nature_of_action_id               number(15),
  lac_lookup_code                   varchar2(30),
  enabled_flag                      varchar2(9),      -- Increased length
  date_from                         date,
  date_to                           date,
  object_version_number             number(9),
  valid_first_lac_flag              varchar2(9),      -- Increased length
  valid_second_lac_flag             varchar2(9)
  );
--
-- ----------------------------------------------------------------------------
