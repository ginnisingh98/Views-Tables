--------------------------------------------------------
--  DDL for Package BEN_BCI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BCI_BUS" AUTHID CURRENT_USER as
...
function return_legislation_code
  (p_batch_benft_cert_id in number) return varchar2;
--
