--------------------------------------------------------
--  DDL for Package PER_PAT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PAT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_allocated_task_id
--     already exists.
--
--  In Arguments:
--    p_allocated_task_id
