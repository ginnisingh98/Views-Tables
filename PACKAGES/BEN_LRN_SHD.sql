--------------------------------------------------------
--  DDL for Package BEN_LRN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LRN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  lrn_attribute_category            varchar2(30),
  lrn_attribute1                    varchar2(150),
  lrn_attribute2                    varchar2(150),
  lrn_attribute3                    varchar2(150),
  lrn_attribute4                    varchar2(150),
  lrn_attribute5                    varchar2(150),
  lrn_attribute6                    varchar2(150),
  lrn_attribute7                    varchar2(150),
  lrn_attribute8                    varchar2(150),
  lrn_attribute9                    varchar2(150),
  lrn_attribute10                   varchar2(150),
  lrn_attribute11                   varchar2(150),
  lrn_attribute12                   varchar2(150),
  lrn_attribute13                   varchar2(150),
  lrn_attribute14                   varchar2(150),
  lrn_attribute15                   varchar2(150),
  lrn_attribute16                   varchar2(150),
  lrn_attribute17                   varchar2(150),
  lrn_attribute18                   varchar2(150),
  lrn_attribute19                   varchar2(150),
  lrn_attribute20                   varchar2(150),
  lrn_attribute21                   varchar2(150),
  lrn_attribute22                   varchar2(150),
  lrn_attribute23                   varchar2(150),
  lrn_attribute24                   varchar2(150),
  lrn_attribute25                   varchar2(150),
  lrn_attribute26                   varchar2(150),
  lrn_attribute27                   varchar2(150),
  lrn_attribute28                   varchar2(150),
  lrn_attribute29                   varchar2(150),
  lrn_attribute30                   varchar2(150),
...
--           p_base_key_value = :lvg_rsn_rt_id).
--
-- Post Success:
--   Processing continues.
--
