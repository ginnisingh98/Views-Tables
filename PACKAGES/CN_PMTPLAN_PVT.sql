--------------------------------------------------------
--  DDL for Package CN_PMTPLAN_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CN_PMTPLAN_PVT" AUTHID CURRENT_USER as
-- $Header: cnvpplns.pls 120.5 2005/07/20 07:40:25 raramasa ship $
...
TYPE PmtPlan_rec_type IS RECORD
  (  org_id             cn_pmt_plans.org_id%TYPE,
     ...
     credit_type_name	   cn_credit_types_all_tl.name%TYPE,
     pay_interval_type_name cn_interval_types_all_tl.name%TYPE,
     ...
     payment_group_code	   cn_pmt_plans.payment_group_code%TYPE,
