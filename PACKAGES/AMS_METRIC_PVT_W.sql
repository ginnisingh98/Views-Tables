--------------------------------------------------------
--  DDL for Package AMS_METRIC_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_METRIC_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswmtcs.pls 120.1 2005/08/24 23:10 dmvincen noship $ */
