--------------------------------------------------------
--  DDL for Package BEN_PL_BNF_CTFN_PRVDD_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PL_BNF_CTFN_PRVDD_BK1" AUTHID CURRENT_USER as
/* $Header: bepbcapi.pkh 120.0 2005/05/28 10:04:28 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_PL_BNF_CTFN_PRVDD_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_PL_BNF_CTFN_PRVDD_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_PL_BNF_CTFN_PRVDD_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_PL_BNF_CTFN_PRVDD_a
  (
