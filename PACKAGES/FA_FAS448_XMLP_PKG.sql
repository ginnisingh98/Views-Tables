--------------------------------------------------------
--  DDL for Package FA_FAS448_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_FAS448_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: FAS448S.pls 120.0.12010000.1 2008/07/28 13:14:51 appldev ship $ */
	P_BOOK	varchar2(15);
