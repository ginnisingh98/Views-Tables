--------------------------------------------------------
--  DDL for Package PER_RVR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RVR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_workbench_view_report_code
--     already exists.
--
--  In Arguments:
