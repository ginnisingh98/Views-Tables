--------------------------------------------------------
--  DDL for Package MO_GLOBAL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."MO_GLOBAL" AUTHID CURRENT_USER AS
/* $Header: AFMOGBLS.pls 120.10.12000000.2 2007/12/26 17:29:25 shnaraya ship $ */
...
-- PURPOSE
--   Populates MO_GLOB_ORG_ACCESS_TMP with orgs
--
...
-- PURPOSE
--   deletes all rows in  MO_GLOB_ORG_ACCESS_TMP
--
