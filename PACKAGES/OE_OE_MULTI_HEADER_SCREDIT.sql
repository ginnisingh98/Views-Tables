--------------------------------------------------------
--  DDL for Package OE_OE_MULTI_HEADER_SCREDIT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_OE_MULTI_HEADER_SCREDIT" AUTHID CURRENT_USER AS
/* $Header: OEXMHSCS.pls 120.1.12000000.2 2007/07/27 08:20:54 cpati ship $ */

TYPE HEADER_MULTI_Scredit_Tbl_Type IS TABLE OF OE_ORDER_PUB.Header_Scredit_Rec_Type
...
/* Returns a substr separted by null char ie chr(12) */
