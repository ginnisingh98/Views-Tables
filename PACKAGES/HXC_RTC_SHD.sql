--------------------------------------------------------
--  DDL for Package HXC_RTC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_RTC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (retrieval_rule_comp_id          number(15)
  ,retrieval_rule_id               number(15)
  ,status                          varchar2(30)       -- Increased length
