--------------------------------------------------------
--  DDL for Package PQH_ETM_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_ETM_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_ent_minutes_id
--     already exists.
--
--  In Arguments:
--    p_ent_minutes_id
