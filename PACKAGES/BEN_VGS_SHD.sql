--------------------------------------------------------
--  DDL for Package BEN_VGS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_VGS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  alw_rcrrg_clms_flag               varchar2(30),
  gd_or_svc_usg_cd                  varchar2(30),
  vgs_attribute_category            varchar2(30),
  vgs_attribute1                    varchar2(150),
  vgs_attribute2                    varchar2(150),
  vgs_attribute3                    varchar2(150),
  vgs_attribute4                    varchar2(150),
  vgs_attribute5                    varchar2(150),
  vgs_attribute6                    varchar2(150),
  vgs_attribute7                    varchar2(150),
  vgs_attribute8                    varchar2(150),
  vgs_attribute9                    varchar2(150),
  vgs_attribute10                   varchar2(150),
  vgs_attribute11                   varchar2(150),
  vgs_attribute12                   varchar2(150),
  vgs_attribute13                   varchar2(150),
  vgs_attribute14                   varchar2(150),
  vgs_attribute15                   varchar2(150),
  vgs_attribute16                   varchar2(150),
  vgs_attribute17                   varchar2(150),
  vgs_attribute18                   varchar2(150),
  vgs_attribute19                   varchar2(150),
  vgs_attribute20                   varchar2(150),
  vgs_attribute21                   varchar2(150),
  vgs_attribute22                   varchar2(150),
  vgs_attribute23                   varchar2(150),
  vgs_attribute24                   varchar2(150),
  vgs_attribute25                   varchar2(150),
  vgs_attribute26                   varchar2(150),
  vgs_attribute27                   varchar2(150),
  vgs_attribute28                   varchar2(150),
  vgs_attribute29                   varchar2(150),
  vgs_attribute30                   varchar2(150),
  object_version_number             number(9) ,
  gd_svc_recd_basis_cd              varchar2(30),
  gd_svc_recd_basis_dt              date  ,
  gd_svc_recd_basis_mo              number(15)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :pl_gd_or_svc_id).
--
-- Post Success:
--   Processing continues.
--
