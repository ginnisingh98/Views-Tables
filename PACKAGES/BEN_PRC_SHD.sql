--------------------------------------------------------
--  DDL for Package BEN_PRC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  incrd_to_dt                       date,
  rqst_num                          number(15),
  rqst_amt                          number(15,2),
  rqst_amt_uom                      varchar2(30),
  rqst_btch_num                     number(15),
  prtt_reimbmt_rqst_stat_cd         varchar2(30),
  reimbmt_ctfn_typ_prvdd_cd         varchar2(30),
  rcrrg_cd                          varchar2(30),
  submitter_person_id               number(15),
  recipient_person_id               number(15),
  provider_person_id                number(15),
  provider_ssn_person_id            number(15),
  pl_id                             number(15),
  gd_or_svc_typ_id                  number(15),
  contact_relationship_id           number(15),
  business_group_id                 number(15),
  opt_id                            number(15),
  popl_yr_perd_id_1                 number(15),
  popl_yr_perd_id_2                 number(15),
  amt_year1                         number,
  amt_year2                         number,
  prc_attribute_category            varchar2(30),
  prc_attribute1                    varchar2(150),
  prc_attribute2                    varchar2(150),
  prc_attribute3                    varchar2(150),
  prc_attribute4                    varchar2(150),
  prc_attribute5                    varchar2(150),
  prc_attribute6                    varchar2(150),
  prc_attribute7                    varchar2(150),
  prc_attribute8                    varchar2(150),
  prc_attribute9                    varchar2(150),
  prc_attribute10                   varchar2(150),
  prc_attribute11                   varchar2(150),
  prc_attribute12                   varchar2(150),
  prc_attribute13                   varchar2(150),
  prc_attribute14                   varchar2(150),
  prc_attribute15                   varchar2(150),
  prc_attribute16                   varchar2(150),
  prc_attribute17                   varchar2(150),
  prc_attribute18                   varchar2(150),
  prc_attribute19                   varchar2(150),
  prc_attribute20                   varchar2(150),
  prc_attribute21                   varchar2(150),
  prc_attribute22                   varchar2(150),
  prc_attribute23                   varchar2(150),
  prc_attribute24                   varchar2(150),
  prc_attribute25                   varchar2(150),
  prc_attribute26                   varchar2(150),
  prc_attribute27                   varchar2(150),
  prc_attribute28                   varchar2(150),
  prc_attribute29                   varchar2(150),
  prc_attribute30                   varchar2(150),
  prtt_enrt_rslt_id                 number(15)   ,
  comment_id                        number(15)   ,
  object_version_number             number(9) ,
  -- Fide enh -- Check datatype and width.
  stat_rsn_cd                       varchar2(30),
  pymt_stat_cd                      varchar2(30),
  pymt_stat_rsn_cd                  varchar2(30),
  stat_ovrdn_flag                   varchar2(30),
  stat_ovrdn_rsn_cd                 varchar2(30),
  stat_prr_to_ovrd                  varchar2(30),
  pymt_stat_ovrdn_flag              varchar2(30),
  pymt_stat_ovrdn_rsn_cd            varchar2(30),
  pymt_stat_prr_to_ovrd             varchar2(30),
  adjmt_flag                        varchar2(30),
  submtd_dt                         date,
  ttl_rqst_amt                      number,
  aprvd_for_pymt_amt                number,
  pymt_amount                       number,         -- this not db column added for stroing value
  exp_incurd_dt			    date	    -- 2272862
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :prtt_reimbmt_rqst_id).
--
-- Post Success:
--   Processing continues.
--
...
Function convert_args
	...
	p_object_version_number         in number ,
        -- Fide enh
        p_stat_rsn_cd                    in varchar2  default null,
        ...
        p_aprvd_for_pymt_amt             in  number    default null,
        p_pymt_amount                    in  number    default null,
