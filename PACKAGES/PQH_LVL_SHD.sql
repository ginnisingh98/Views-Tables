--------------------------------------------------------
--  DDL for Package PQH_LVL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_LVL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (wrkplc_vldtn_lvlnum_id          number(15)
  ,wrkplc_vldtn_ver_id             number(15)
  ,level_number_id                 varchar2(30)
  ,level_code_id                   varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_WRKPLC_VLDTN_LVLNUMS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
