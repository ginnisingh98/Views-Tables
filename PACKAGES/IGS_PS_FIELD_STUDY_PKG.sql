--------------------------------------------------------
--  DDL for Package IGS_PS_FIELD_STUDY_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PS_FIELD_STUDY_PKG" AUTHID CURRENT_USER AS
  /* $Header: IGSPI13S.pls 115.4 2003/06/05 13:09:19 sarakshi ship $ */
