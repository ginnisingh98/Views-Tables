--------------------------------------------------------
--  DDL for Package BEN_PBM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PBM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  pl_r_oipl_prem_by_mo_id           number(15),
  ...
  pbm_attribute_category            varchar2(30),
  pbm_attribute1                    varchar2(150),
  pbm_attribute2                    varchar2(150),
  pbm_attribute3                    varchar2(150),
  pbm_attribute4                    varchar2(150),
  pbm_attribute5                    varchar2(150),
  pbm_attribute6                    varchar2(150),
  pbm_attribute7                    varchar2(150),
  pbm_attribute8                    varchar2(150),
  pbm_attribute9                    varchar2(150),
  pbm_attribute10                   varchar2(150),
  pbm_attribute11                   varchar2(150),
  pbm_attribute12                   varchar2(150),
  pbm_attribute13                   varchar2(150),
  pbm_attribute14                   varchar2(150),
  pbm_attribute15                   varchar2(150),
  pbm_attribute16                   varchar2(150),
  pbm_attribute17                   varchar2(150),
  pbm_attribute18                   varchar2(150),
  pbm_attribute19                   varchar2(150),
  pbm_attribute20                   varchar2(150),
  pbm_attribute21                   varchar2(150),
  pbm_attribute22                   varchar2(150),
  pbm_attribute23                   varchar2(150),
  pbm_attribute24                   varchar2(150),
  pbm_attribute25                   varchar2(150),
  pbm_attribute26                   varchar2(150),
  pbm_attribute27                   varchar2(150),
  pbm_attribute28                   varchar2(150),
  pbm_attribute29                   varchar2(150),
  pbm_attribute30                   varchar2(150),
...
--           p_base_key_value = :pl_r_oipl_prem_by_mo_id).
--
-- Post Success:
--   Processing continues.
--
