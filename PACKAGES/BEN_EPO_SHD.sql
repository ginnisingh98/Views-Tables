--------------------------------------------------------
--  DDL for Package BEN_EPO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPO_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  epo_attribute_category            varchar2(30),
  epo_attribute1                    varchar2(150),
  epo_attribute2                    varchar2(150),
  epo_attribute3                    varchar2(150),
  epo_attribute4                    varchar2(150),
  epo_attribute5                    varchar2(150),
  epo_attribute6                    varchar2(150),
  epo_attribute7                    varchar2(150),
  epo_attribute8                    varchar2(150),
  epo_attribute9                    varchar2(150),
  epo_attribute10                   varchar2(150),
  epo_attribute11                   varchar2(150),
  epo_attribute12                   varchar2(150),
  epo_attribute13                   varchar2(150),
  epo_attribute14                   varchar2(150),
  epo_attribute15                   varchar2(150),
  epo_attribute16                   varchar2(150),
  epo_attribute17                   varchar2(150),
  epo_attribute18                   varchar2(150),
  epo_attribute19                   varchar2(150),
  epo_attribute20                   varchar2(150),
  epo_attribute21                   varchar2(150),
  epo_attribute22                   varchar2(150),
  epo_attribute23                   varchar2(150),
  epo_attribute24                   varchar2(150),
  epo_attribute25                   varchar2(150),
  epo_attribute26                   varchar2(150),
  epo_attribute27                   varchar2(150),
  epo_attribute28                   varchar2(150),
  epo_attribute29                   varchar2(150),
  epo_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_per_opt_id).
--
-- Post Success:
--   Processing continues.
--
