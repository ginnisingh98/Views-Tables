--------------------------------------------------------
--  DDL for Package OKL_CSH_ALLCT_RULES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_CSH_ALLCT_RULES_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUCSAS.pls 120.1 2005/09/20 13:42:22 dkagrawa noship $ */
