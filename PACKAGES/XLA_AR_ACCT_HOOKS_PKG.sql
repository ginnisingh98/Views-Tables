--------------------------------------------------------
--  DDL for Package XLA_AR_ACCT_HOOKS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XLA_AR_ACCT_HOOKS_PKG" AUTHID CURRENT_USER AS
-- $Header: xlaaparh.pkh 120.0 2005/06/01 04:56:58 sasingha noship $
/*===========================================================================+
...
|                                                                            |
| DESCRIPTION                                                                |
|     Call accounting program integration APIs for Account Recievables       |
|                                                                            |
| HISTORY                                                                    |
...
END xla_ar_acct_hooks_pkg; -- end of package spec.
