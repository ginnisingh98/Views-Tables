--------------------------------------------------------
--  DDL for Package OZF_OFFER_ADJ_LINE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_OFFER_ADJ_LINE_PVT_W" AUTHID CURRENT_USER as
  /* $Header: ozfwoals.pls 120.1 2005/09/26 17:59 rssharma noship $ */
