--------------------------------------------------------
--  DDL for Package OKC_TAL_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_TAL_PVT" AUTHID CURRENT_USER AS
/* $Header: OKCSTALS.pls 120.0 2005/05/26 09:29:53 appldev noship $ */
  ---------------------------------------------------------------------------
...
--Bug 3122962
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME			CONSTANT VARCHAR2(200) := 'OKC_TAL_PVT';
