--------------------------------------------------------
--  DDL for Package BEN_PRTT_CLM_GD_R_SVC_TYP_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRTT_CLM_GD_R_SVC_TYP_BK2" AUTHID CURRENT_USER as
/* $Header: bepcgapi.pkh 120.0 2005/05/28 10:10:41 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_PRTT_CLM_GD_R_SVC_TYP_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_PRTT_CLM_GD_R_SVC_TYP_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_PRTT_CLM_GD_R_SVC_TYP_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_PRTT_CLM_GD_R_SVC_TYP_a
  (
   p_prtt_clm_gd_or_svc_typ_id      in  number
  ,p_prtt_reimbmt_rqst_id           in  number
  ,p_gd_or_svc_typ_id               in  number
...
--
end ben_PRTT_CLM_GD_R_SVC_TYP_bk2;
