--------------------------------------------------------
--  DDL for Package OTA_LPS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_LPS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,path_source_code                varchar2(30)
  ,source_function_code            varchar2(30)
  ,assignment_id                   number(10,0)
  ,source_id                       number
  ,notify_days_before_target       number(10,0)
  ,person_id                       number
  ,contact_id                      number(10,0)
  --Bug#4052408
  -- Increased lengths of folllowing fields to 9 because update api has default
  -- value hr_api.g_varchar2 and hence convert_args will throw ORA-06502
  --,display_to_learner_flag         varchar2(1)
  --,public_flag                     varchar2(1));
  ,display_to_learner_flag         varchar2(9)
  ,public_flag                     varchar2(9)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_LEARNING_PATHS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
