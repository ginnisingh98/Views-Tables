--------------------------------------------------------
--  DDL for Package PER_ZA_EQT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_EQT_INS" AUTHID CURRENT_USER as
/* $Header: pezaeqin.pkh 115.1 2002/12/05 06:35:14 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< ins >----------------------------------|
-- ----------------------------------------------------------------------------
