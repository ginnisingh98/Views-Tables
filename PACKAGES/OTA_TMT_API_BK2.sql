--------------------------------------------------------
--  DDL for Package OTA_TMT_API_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TMT_API_BK2" AUTHID CURRENT_USER as
/* $Header: ottmtapi.pkh 120.1 2005/10/02 02:08:25 aroussel $ */
-- ----------------------------------------------------------------------------
-- |-------------------------< update_measure_b >-----------------------------|
-- ----------------------------------------------------------------------------
procedure update_measure_b
