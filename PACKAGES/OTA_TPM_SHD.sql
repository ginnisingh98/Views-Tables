--------------------------------------------------------
--  DDL for Package OTA_TPM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TPM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (training_plan_member_id         number(9)
  ,training_plan_id                number(9)
  ,activity_version_id             number(9)
  ,activity_definition_id          number(9)
  ,member_status_type_id           varchar2(30)
...
--
g_tab_nam constant varchar2(30) := 'OTA_TRAINING_PLAN_MEMBERS' ;
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
-- {Start Of Comments}
