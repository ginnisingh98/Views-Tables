--------------------------------------------------------
--  DDL for Package XLA_AP_ACCT_HOOKS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XLA_AP_ACCT_HOOKS_PKG" AUTHID CURRENT_USER AS
-- $Header: xlaapaph.pkh 120.0 2005/06/01 04:57:35 sasingha noship $
/*===========================================================================+
...
END xla_ap_acct_hooks_pkg; -- end of package spec.
