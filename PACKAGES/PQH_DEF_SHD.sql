--------------------------------------------------------
--  DDL for Package PQH_DEF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_DEF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,validation_name                 varchar2(150)
  ,business_group_id               number(15)
  ,employment_type                 varchar2(30)
  ,remuneration_regulation         varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_WRKPLC_VLDTNS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
