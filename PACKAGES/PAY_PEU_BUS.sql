--------------------------------------------------------
--  DDL for Package PAY_PEU_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PEU_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_event_update_id
--     already exists.
--
--  In Arguments:
--    p_event_update_id
