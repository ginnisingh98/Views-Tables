--------------------------------------------------------
--  DDL for Package BEN_BENUASUM_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BENUASUM_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: BENUASUMS.pls 120.1 2007/12/10 08:39:12 vjaganat noship $ */
	...
	Function CP_ACTNCLSED_p return number;
	...
	Function CP_TOTPROCD_p return number;
