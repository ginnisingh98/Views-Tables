--------------------------------------------------------
--  DDL for Package BEN_HWF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_HWF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  hrs_wkd_in_perd_fctr_id           number(15),
  name                              varchar2(240),
  business_group_id                 number(15),
  hrs_src_cd                        varchar2(30),
  rndg_cd                           varchar2(30),
  rndg_rl                           number(15),
  hrs_wkd_det_cd                    varchar2(30),
  hrs_wkd_det_rl                    number(15),
  no_mn_hrs_wkd_flag                varchar2(30),
  mx_hrs_num                        number,
  no_mx_hrs_wkd_flag                varchar2(30),
  once_r_cntug_cd                   varchar2(30),
  mn_hrs_num                        number,
  hrs_alt_val_to_use_cd             varchar2(30),
  pyrl_freq_cd                      varchar2(30),
  hrs_wkd_calc_rl                   number(15),
  defined_balance_id                number,
  bnfts_bal_id                      number,
  hwf_attribute_category            varchar2(30),
  hwf_attribute1                    varchar2(150),
  hwf_attribute2                    varchar2(150),
  hwf_attribute3                    varchar2(150),
  hwf_attribute4                    varchar2(150),
  hwf_attribute5                    varchar2(150),
  hwf_attribute6                    varchar2(150),
  hwf_attribute7                    varchar2(150),
  hwf_attribute8                    varchar2(150),
  hwf_attribute9                    varchar2(150),
  hwf_attribute10                   varchar2(150),
  hwf_attribute11                   varchar2(150),
  hwf_attribute12                   varchar2(150),
  hwf_attribute13                   varchar2(150),
  hwf_attribute14                   varchar2(150),
  hwf_attribute15                   varchar2(150),
  hwf_attribute16                   varchar2(150),
  hwf_attribute17                   varchar2(150),
  hwf_attribute18                   varchar2(150),
  hwf_attribute19                   varchar2(150),
  hwf_attribute20                   varchar2(150),
  hwf_attribute21                   varchar2(150),
  hwf_attribute22                   varchar2(150),
  hwf_attribute23                   varchar2(150),
  hwf_attribute24                   varchar2(150),
  hwf_attribute25                   varchar2(150),
  hwf_attribute26                   varchar2(150),
  hwf_attribute27                   varchar2(150),
  hwf_attribute28                   varchar2(150),
  hwf_attribute29                   varchar2(150),
  hwf_attribute30                   varchar2(150),
