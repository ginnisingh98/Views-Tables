--------------------------------------------------------
--  DDL for Package IRC_RTM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_RTM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,start_date                      date
  ,end_date                        date
  ,update_allowed                  varchar2(30)
  ,delete_allowed                  varchar2(30)
  ,object_version_number           number(9)
  ,Interview_security               varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
g_tab_name constant varchar2(30) := 'IRC_REC_TEAM_MEMBERS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
