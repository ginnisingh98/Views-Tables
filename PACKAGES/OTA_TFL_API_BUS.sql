--------------------------------------------------------
--  DDL for Package OTA_TFL_API_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TFL_API_BUS" AUTHID CURRENT_USER as
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_validate(p_rec in ota_tfl_api_shd.g_rec_type);
--
...
--
--  Prerequisites:
--    The primary key identified by p_finance_line_id
--     already exists.
--
--  In Arguments:
--    p_finance_line_id
...
--   of by the user hooks of ota_finance_lines business process.
--
-- Pre Conditions:
