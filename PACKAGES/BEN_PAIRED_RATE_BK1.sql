--------------------------------------------------------
--  DDL for Package BEN_PAIRED_RATE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PAIRED_RATE_BK1" AUTHID CURRENT_USER as
/* $Header: beprdapi.pkh 120.0 2005/05/28 11:06:34 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_PAIRED_RATE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_PAIRED_RATE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_PAIRED_RATE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_PAIRED_RATE_a
  (
