--------------------------------------------------------
--  DDL for Package WSH_CC_PARAMETER_SETUPS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."WSH_CC_PARAMETER_SETUPS_PKG" AUTHID CURRENT_USER as
 /* $Header: WSHCCTHS.pls 115.2 2002/06/03 12:30:25 pkm ship       $ */
 ...
 /*  --
   ...
   --
   -- Input parameters for clear cross parameters information
   ...
   --   p_PARAMETER_ID  - Clear Cross sequence Id ( PK)
...
procedure INSERT_ROW (
 ...
 /*  --
   -- Purpose
   --  Check Lock a row of WSH_CC_PARAMETER_SETUPS_B entity.
   --  Check Lock a row of WSH_CC_PARAMETER_SETUPS_TL entity.
   -- Input Parameters
   --   p_api_version
   --      API version number (current version is 1.0)
   --   p_init_msg_list (optional, default FND_API.G_FALSE)
