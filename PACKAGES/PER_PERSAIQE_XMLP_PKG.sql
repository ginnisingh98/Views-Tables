--------------------------------------------------------
--  DDL for Package PER_PERSAIQE_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PERSAIQE_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: PERSAIQES.pls 120.0 2007/12/24 13:23:37 amakrish noship $ */
