--------------------------------------------------------
--  DDL for Package PER_PAR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PAR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  participant_id                    number(15),
  business_group_id                 number(15),
  object_version_number             number(9),
  questionnaire_template_id         number(15),
  participation_in_table            varchar2(80),
  participation_in_column           varchar2(80),
  participation_in_id               number(15),
  ...
  participant_usage_status			    varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
g_tab_nam constant varchar2(30)  := 'PER_PARTICIPANTS';
--
--
--
-- ----------------------------------------------------------------------------
