--------------------------------------------------------
--  DDL for Package XLA_EVENTS_PUB_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XLA_EVENTS_PUB_PKG" AUTHID CURRENT_USER AS
-- $Header: xlaevevp.pkh 120.31.12010000.2 2009/07/17 07:03:16 vkasina ship $
/*===========================================================================+
...
TYPE t_array_entity_id            IS TABLE OF PLS_INTEGER             INDEX BY BINARY_INTEGER;
TYPE t_array_event_id             IS TABLE OF PLS_INTEGER             INDEX BY BINARY_INTEGER;
