--------------------------------------------------------
--  DDL for Package PQP_FXT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_FXT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (flxdu_xml_tag_id                number(22)
  ,flxdu_column_id                 number(22)
  ,flxdu_xml_tag_name              varchar2(150)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQP_FLXDU_XML_TAGS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
