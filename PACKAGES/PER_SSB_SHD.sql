--------------------------------------------------------
--  DDL for Package PER_SSB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SSB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (setup_sub_task_code             varchar2(60)
  ,setup_task_code                 varchar2(60)
  ,setup_sub_task_sequence         number(10)
  ,setup_sub_task_status           varchar2(80)
  ,setup_sub_task_type             varchar2(60)
  ,setup_sub_task_data_pump_link   varchar2(60)
  ,setup_sub_task_action           varchar2(520)
  ,setup_sub_task_creation_date    date
  ,setup_sub_task_last_mod_date    date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_RI_SETUP_SUB_TASKS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
