--------------------------------------------------------
--  DDL for Package OKL_CASH_APPL_RULES_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_CASH_APPL_RULES_W" AUTHID CURRENT_USER as
  /* $Header: OKLECAPS.pls 120.3 2007/08/02 15:51:43 nikshah ship $ */
