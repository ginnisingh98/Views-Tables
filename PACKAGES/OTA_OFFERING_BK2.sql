--------------------------------------------------------
--  DDL for Package OTA_OFFERING_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_OFFERING_BK2" AUTHID CURRENT_USER as
/* $Header: otoffapi.pkh 120.4.12010000.2 2008/08/05 11:45:04 ubhat ship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ota_offering_bk2.';
--
-- ----------------------------------------------------------------------------
-- |-------------------------< UPDATE_OFFERING_B >----------------------------|
-- ----------------------------------------------------------------------------
