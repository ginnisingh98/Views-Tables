--------------------------------------------------------
--  DDL for Package PER_SUPPLEMENTARY_ROLE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SUPPLEMENTARY_ROLE_BK2" AUTHID CURRENT_USER as
/* $Header: perolapi.pkh 120.1.12010000.1 2008/07/28 05:45:40 appldev ship $ */
--
-- ----------------------------------------------------------------------------
-- |-----------------------< update_supplementary_role_b >--------------------|
-- ----------------------------------------------------------------------------
--
procedure update_supplementary_role_b
...
--
-- ----------------------------------------------------------------------------
-- |-----------------------< update_supplementary_role_a >--------------------|
-- ----------------------------------------------------------------------------
--
procedure update_supplementary_role_a
  (p_effective_date                in     date
  ,p_role_id                       in     number
  ,p_object_version_number         in     number
  ,p_start_date                    in     date
...
--
end per_supplementary_role_bk2;
