--------------------------------------------------------
--  DDL for Package SO_PICKING_LINE_DETAILS_PKG1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."SO_PICKING_LINE_DETAILS_PKG1" AUTHID CURRENT_USER as
/* $Header: WSHPLDXS.pls 115.0 99/07/16 08:19:44 porting ship $ */
