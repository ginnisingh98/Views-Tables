--------------------------------------------------------
--  DDL for Package PQH_RFE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RFE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_rate_factor_on_elmnt_id
--     already exists.
--
--  In Arguments:
