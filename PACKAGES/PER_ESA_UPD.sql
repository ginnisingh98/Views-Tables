--------------------------------------------------------
--  DDL for Package PER_ESA_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ESA_UPD" AUTHID CURRENT_USER as
...
Procedure upd
  ...
  p_effective_date               in date,
  p_validate                     in boolean      default false,
  p_party_id                     in number           default hr_api.g_number, --HR/TCA merge
