--------------------------------------------------------
--  DDL for Package ZX_PRODUCT_INTEGRATION_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ZX_PRODUCT_INTEGRATION_PKG" AUTHID CURRENT_USER AS
/* $Header: zxdiprodintgpkgs.pls 120.9.12010000.2 2008/11/12 12:23:29 spasala ship $ */
...
tax_info_out_rec_tbl	tax_info_rec_tbl_type;
...
PROCEDURE  dump_tax_info_rec(p_IO_flag  IN  VARCHAR2 );
