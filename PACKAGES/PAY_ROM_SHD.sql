--------------------------------------------------------
--  DDL for Package PAY_ROM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_ROM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,priority                        number(15)
  ,percentage                      number(22,2)
  ,amount                          number
  ,object_version_number           number(9)
  ,run_type_org_method_id          number(9)
...
--           p_base_key_value = :run_type_org_method_id).
--
-- Post Success:
