--------------------------------------------------------
--  DDL for Package BEN_ELV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_lvg_rsn_prte_id              number(15),
  effective_start_date              date,
  effective_end_date                date,
  excld_flag                        varchar2(30),
  ordr_num                          number(15),
  lvg_rsn_cd                        varchar2(30),
  eligy_prfl_id                     number(15),
  business_group_id                 number(15),
  elv_attribute_category            varchar2(30),
  elv_attribute1                    varchar2(150),
  elv_attribute2                    varchar2(150),
  elv_attribute3                    varchar2(150),
  elv_attribute4                    varchar2(150),
  elv_attribute5                    varchar2(150),
  elv_attribute6                    varchar2(150),
  elv_attribute7                    varchar2(150),
  elv_attribute8                    varchar2(150),
  elv_attribute9                    varchar2(150),
  elv_attribute10                   varchar2(150),
  elv_attribute11                   varchar2(150),
  elv_attribute12                   varchar2(150),
  elv_attribute13                   varchar2(150),
  elv_attribute14                   varchar2(150),
  elv_attribute15                   varchar2(150),
  elv_attribute16                   varchar2(150),
  elv_attribute17                   varchar2(150),
  elv_attribute18                   varchar2(150),
  elv_attribute19                   varchar2(150),
  elv_attribute20                   varchar2(150),
  elv_attribute21                   varchar2(150),
  elv_attribute22                   varchar2(150),
  elv_attribute23                   varchar2(150),
  elv_attribute24                   varchar2(150),
  elv_attribute25                   varchar2(150),
  elv_attribute26                   varchar2(150),
  elv_attribute27                   varchar2(150),
  elv_attribute28                   varchar2(150),
  elv_attribute29                   varchar2(150),
  elv_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_lvg_rsn_prte_id).
--
-- Post Success:
--   Processing continues.
--
