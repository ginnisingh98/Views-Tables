--------------------------------------------------------
--  DDL for Package OE_HEADER_PCFWK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_HEADER_PCFWK" AUTHID CURRENT_USER AS
/* $Header: OEXKHDRS.pls 120.0 2005/06/01 01:31:23 appldev noship $ */
...
--     against operations on HEADER or its columns
--  Pre-reqs
--
--  Parameters
--
