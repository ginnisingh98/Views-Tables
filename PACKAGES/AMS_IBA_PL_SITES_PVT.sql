--------------------------------------------------------
--  DDL for Package AMS_IBA_PL_SITES_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_IBA_PL_SITES_PVT" AUTHID CURRENT_USER AS
/* $Header: amsvsits.pls 120.0 2005/05/31 14:01:09 appldev noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
...
--===================================================================
TYPE iba_pl_sites_rec_type IS RECORD
(
       site_id                         NUMBER := FND_API.G_MISS_NUM,
       site_ref_code                   VARCHAR2(30) := FND_API.G_MISS_CHAR,
       site_category_type              VARCHAR2(30) := FND_API.G_MISS_CHAR,
       site_category_object_id         NUMBER := FND_API.G_MISS_NUM,
...
g_miss_iba_pl_sites_rec          iba_pl_sites_rec_type;
TYPE  iba_pl_sites_tbl_type      IS TABLE OF iba_pl_sites_rec_type INDEX BY BINARY_INTEGER;
g_miss_iba_pl_sites_tbl          iba_pl_sites_tbl_type;
...
--       p_iba_pl_sites_rec            IN   iba_pl_sites_rec_type  Required
--
--   OUT
