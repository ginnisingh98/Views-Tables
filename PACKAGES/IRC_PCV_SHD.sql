--------------------------------------------------------
--  DDL for Package IRC_PCV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_PCV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (prof_area_criteria_value_id     number(15)
  ,search_criteria_id              number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_PROF_AREA_CRITERIA_VALUES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
