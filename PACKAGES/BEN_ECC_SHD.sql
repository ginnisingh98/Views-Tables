--------------------------------------------------------
--  DDL for Package BEN_ECC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ECC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elctbl_chc_ctfn_id                number(15),
  enrt_ctfn_typ_cd                  varchar2(30),
  rqd_flag                          varchar2(30),
  elig_per_elctbl_chc_id            number(15),
  enrt_bnft_id                      number(15),
  business_group_id                 number(15),
  ecc_attribute_category            varchar2(30),
  ecc_attribute1                    varchar2(150),
  ecc_attribute2                    varchar2(150),
  ecc_attribute3                    varchar2(150),
  ecc_attribute4                    varchar2(150),
  ecc_attribute5                    varchar2(150),
  ecc_attribute6                    varchar2(150),
  ecc_attribute7                    varchar2(150),
  ecc_attribute8                    varchar2(150),
  ecc_attribute9                    varchar2(150),
  ecc_attribute10                   varchar2(150),
  ecc_attribute11                   varchar2(150),
  ecc_attribute12                   varchar2(150),
  ecc_attribute13                   varchar2(150),
  ecc_attribute14                   varchar2(150),
  ecc_attribute15                   varchar2(150),
  ecc_attribute16                   varchar2(150),
  ecc_attribute17                   varchar2(150),
  ecc_attribute18                   varchar2(150),
  ecc_attribute19                   varchar2(150),
  ecc_attribute20                   varchar2(150),
  ecc_attribute21                   varchar2(150),
  ecc_attribute22                   varchar2(150),
  ecc_attribute23                   varchar2(150),
  ecc_attribute24                   varchar2(150),
  ecc_attribute25                   varchar2(150),
  ecc_attribute26                   varchar2(150),
  ecc_attribute27                   varchar2(150),
  ecc_attribute28                   varchar2(150),
  ecc_attribute29                   varchar2(150),
  ecc_attribute30                   varchar2(150),
