--------------------------------------------------------
--  DDL for Package BEN_PCT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PCT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  pl_gd_or_svc_id                   number(15),
  pfd_flag                          varchar2(30),
  lack_ctfn_deny_rmbmt_flag         varchar2(30),
  rmbmt_ctfn_typ_cd                 varchar2(30),
  lack_ctfn_deny_rmbmt_rl           number(15),
  pct_attribute_category            varchar2(30),
  pct_attribute1                    varchar2(150),
  pct_attribute2                    varchar2(150),
  pct_attribute3                    varchar2(150),
  pct_attribute4                    varchar2(150),
  pct_attribute5                    varchar2(150),
  pct_attribute6                    varchar2(150),
  pct_attribute7                    varchar2(150),
  pct_attribute8                    varchar2(150),
  pct_attribute9                    varchar2(150),
  pct_attribute10                   varchar2(150),
  pct_attribute11                   varchar2(150),
  pct_attribute12                   varchar2(150),
  pct_attribute13                   varchar2(150),
  pct_attribute14                   varchar2(150),
  pct_attribute15                   varchar2(150),
  pct_attribute16                   varchar2(150),
  pct_attribute17                   varchar2(150),
  pct_attribute18                   varchar2(150),
  pct_attribute19                   varchar2(150),
  pct_attribute20                   varchar2(150),
  pct_attribute21                   varchar2(150),
  pct_attribute22                   varchar2(150),
  pct_attribute23                   varchar2(150),
  pct_attribute24                   varchar2(150),
  pct_attribute25                   varchar2(150),
  pct_attribute26                   varchar2(150),
  pct_attribute27                   varchar2(150),
  pct_attribute28                   varchar2(150),
  pct_attribute29                   varchar2(150),
  pct_attribute30                   varchar2(150),
  object_version_number             number(9) ,
  ctfn_rqd_when_rl                  number(30) ,
...
--           p_base_key_value = :pl_gd_r_svc_ctfn_id).
--
-- Post Success:
--   Processing continues.
--
