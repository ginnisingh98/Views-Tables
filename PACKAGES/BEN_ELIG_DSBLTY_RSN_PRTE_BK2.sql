--------------------------------------------------------
--  DDL for Package BEN_ELIG_DSBLTY_RSN_PRTE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_DSBLTY_RSN_PRTE_BK2" AUTHID CURRENT_USER as
/* $Header: beedrapi.pkh 120.0 2005/05/28 02:00:58 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_elig_dsblty_rsn_prte_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_elig_dsblty_rsn_prte_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_elig_dsblty_rsn_prte_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_elig_dsblty_rsn_prte_a
  (
   p_elig_dsblty_rsn_prte_id           in  number
...
--
end ben_elig_dsblty_rsn_prte_bk2;
