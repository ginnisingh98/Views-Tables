--------------------------------------------------------
--  DDL for Package AME_CAL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_CAL_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_application_id
--     already exists.
--
--  In Arguments:
--    p_application_id
