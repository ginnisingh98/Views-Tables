--------------------------------------------------------
--  DDL for Package BEN_CSR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CSR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  css_rltd_per_per_in_ler_id        number(15),
  effective_start_date              date,
  effective_end_date                date,
  ordr_to_prcs_num                  number(15),
  ler_id                            number(15),
  rsltg_ler_id                      number(15),
  business_group_id                 number(15),
  csr_attribute_category            varchar2(30),
  csr_attribute1                    varchar2(150),
  csr_attribute2                    varchar2(150),
  csr_attribute3                    varchar2(150),
  csr_attribute4                    varchar2(150),
  csr_attribute5                    varchar2(150),
  csr_attribute6                    varchar2(150),
  csr_attribute7                    varchar2(150),
  csr_attribute8                    varchar2(150),
  csr_attribute9                    varchar2(150),
  csr_attribute10                   varchar2(150),
  csr_attribute11                   varchar2(150),
  csr_attribute12                   varchar2(150),
  csr_attribute13                   varchar2(150),
  csr_attribute14                   varchar2(150),
  csr_attribute15                   varchar2(150),
  csr_attribute16                   varchar2(150),
  csr_attribute17                   varchar2(150),
  csr_attribute18                   varchar2(150),
  csr_attribute19                   varchar2(150),
  csr_attribute20                   varchar2(150),
  csr_attribute21                   varchar2(150),
  csr_attribute22                   varchar2(150),
  csr_attribute23                   varchar2(150),
  csr_attribute24                   varchar2(150),
  csr_attribute25                   varchar2(150),
  csr_attribute26                   varchar2(150),
  csr_attribute27                   varchar2(150),
  csr_attribute28                   varchar2(150),
  csr_attribute29                   varchar2(150),
  csr_attribute30                   varchar2(150),
...
--           p_base_key_value = :css_rltd_per_per_in_ler_id).
--
-- Post Success:
--   Processing continues.
--
