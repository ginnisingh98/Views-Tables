--------------------------------------------------------
--  DDL for Package CN_NOTIFICATION_PUB_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CN_NOTIFICATION_PUB_CUHK" AUTHID CURRENT_USER AS
/* $Header: cncntxs.pls 120.1 2005/06/13 00:05:44 appldev  $ */
...
(
   p_not_trx_id      IN    cn_not_trx_all.not_trx_id%TYPE
) RETURN BOOLEAN;
END CN_NOTIFICATION_PUB_CUHK ;
