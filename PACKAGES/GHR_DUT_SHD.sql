--------------------------------------------------------
--  DDL for Package GHR_DUT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_DUT_SHD" AUTHID CURRENT_USER as
...
--BUG 5233888
 /*Type g_rec_type Is Record
  ...
  duty_station_id       number(15),
   ...
   locality_pay_area_id  number(15),
   leo_pay_area_code     varchar2(1),
   name                  varchar2(40),
   duty_station_code     varchar2(9),
   msa_code              varchar2(4),
   cmsa_code             varchar2(2),
   state_or_country_code varchar2(9),
   county_code           varchar2(9),
   is_duty_station       varchar2(1),
...
Type g_rec_type Is Record
  (
  duty_station_id        GHR_DUTY_STATIONS_F.DUTY_STATION_ID%TYPE,
   effective_start_date  GHR_DUTY_STATIONS_F.EFFECTIVE_START_DATE%TYPE,
   effective_end_date    GHR_DUTY_STATIONS_F.EFFECTIVE_END_DATE%TYPE,
   locality_pay_area_id  GHR_DUTY_STATIONS_F.LOCALITY_PAY_AREA_ID%TYPE,
   leo_pay_area_code     GHR_DUTY_STATIONS_F.LEO_PAY_AREA_CODE%TYPE,
   name                  GHR_DUTY_STATIONS_F.NAME%TYPE,
   duty_station_code     GHR_DUTY_STATIONS_F.DUTY_STATION_CODE%TYPE,
   msa_code              GHR_DUTY_STATIONS_F.MSA_CODE%TYPE,
   cmsa_code             GHR_DUTY_STATIONS_F.CMSA_CODE%TYPE,
   state_or_country_code GHR_DUTY_STATIONS_F.STATE_OR_COUNTRY_CODE%TYPE,
   county_code           GHR_DUTY_STATIONS_F.COUNTY_CODE%TYPE,
   is_duty_station       GHR_DUTY_STATIONS_F.IS_DUTY_STATION%TYPE,
   object_version_number GHR_DUTY_STATIONS_F.OBJECT_VERSION_NUMBER%TYPE
  );
...
--           p_base_key_value = :p_duty_station_id).
--
-- Post Success:
--   Processing continues.
--
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Function convert_args 	(  p_duty_station_id        in number,
