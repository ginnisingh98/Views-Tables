--------------------------------------------------------
--  DDL for Package PER_CHK_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CHK_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  checklist_item_id                 number(15),
  person_id                         number(10),
  item_code                         varchar2(30),
  date_due                          date,
  date_done                         date,
  status                            varchar2(30),
  notes                             varchar2(255),    -- pseudo column
