--------------------------------------------------------
--  DDL for Package HR_AHK_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_AHK_SHD" AUTHID CURRENT_USER as
/* $Header: hrahkrhi.pkh 115.2 2002/12/03 16:44:14 apholt ship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (
  api_hook_id                       number(15),
  api_module_id                     number(15),
  api_hook_type                     varchar2(30),
  hook_package                      varchar2(30),
  hook_procedure                    varchar2(30),
