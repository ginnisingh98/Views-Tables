--------------------------------------------------------
--  DDL for Package IGS_AS_MSHT_SU_ATMPT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_AS_MSHT_SU_ATMPT_PKG" AUTHID CURRENT_USER AS
 /* $Header: IGSDI16S.pls 115.5 2003/04/30 05:50:40 svanukur ship $ */
