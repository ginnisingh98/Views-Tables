--------------------------------------------------------
--  DDL for Package PAY_PGP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PGP_SHD" AUTHID CURRENT_USER as
...
--   people group combination segments. The returning
--   p_people_group_id can have three states:
--
--   p_people_group_id
--   state                 meaning
--   ===================== =======
...
--
--   Depending on the p_people_group_id state the following out arguments
--   are either set or null.
--
--   p_people_group_id      out
--   state                  argument                 set
--   =====================  ========                 ===
--   -1                     p_id_flex_num             Y
--
...
--
-- Post Success:
--   Depending on the p_people_group_id state the corresponding out
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Function api_updating(p_people_group_id in number) Return Boolean;
--
-- ----------------------------------------------------------------------------
-- |-----------------------------< convert_args >-----------------------------|
-- ----------------------------------------------------------------------------
