--------------------------------------------------------
--  DDL for Package GHR_NRE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_NRE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  noac_remark_id                    number(15),
  nature_of_action_id               number(15),
  remark_id                         number(15),
  required_flag                     varchar2(9),      -- Increased length
