--------------------------------------------------------
--  DDL for Package HR_DE_SOC_INS_CLE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_DE_SOC_INS_CLE_BK1" AUTHID CURRENT_USER as
/* $Header: hrcleapi.pkh 120.1 2005/10/02 02:00:02 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_soc_ins_contributions_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_soc_ins_contributions_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_soc_ins_contributions_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_soc_ins_contributions_a
  (
