--------------------------------------------------------
--  DDL for Package BEN_BENDESUM_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BENDESUM_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: BENDESUMS.pls 120.1 2007/12/10 08:29:42 vjaganat noship $ */
	...
	CP_DEFTOTAL	number;
	cp_participants_ended	number;
	CP_LOCATION	varchar2(20);
	...
	Function CP_DEFNOCHG_p return number;
	Function CP_DEFWCHG_p return number;
	...
	Function CP_DEFTOTAL_p return number;
	Function cp_participants_ended_p return number;
