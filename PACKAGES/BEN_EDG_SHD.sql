--------------------------------------------------------
--  DDL for Package BEN_EDG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EDG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_dpnt_cvrd_othr_pgm_id        number(15),
  ...
  edg_attribute_category            varchar2(30),
  edg_attribute1                    varchar2(150),
  edg_attribute2                    varchar2(150),
  edg_attribute3                    varchar2(150),
  edg_attribute4                    varchar2(150),
  edg_attribute5                    varchar2(150),
  edg_attribute6                    varchar2(150),
  edg_attribute7                    varchar2(150),
  edg_attribute8                    varchar2(150),
  edg_attribute9                    varchar2(150),
  edg_attribute10                   varchar2(150),
  edg_attribute11                   varchar2(150),
  edg_attribute12                   varchar2(150),
  edg_attribute13                   varchar2(150),
  edg_attribute14                   varchar2(150),
  edg_attribute15                   varchar2(150),
  edg_attribute16                   varchar2(150),
  edg_attribute17                   varchar2(150),
  edg_attribute18                   varchar2(150),
  edg_attribute19                   varchar2(150),
  edg_attribute20                   varchar2(150),
  edg_attribute21                   varchar2(150),
  edg_attribute22                   varchar2(150),
  edg_attribute23                   varchar2(150),
  edg_attribute24                   varchar2(150),
  edg_attribute25                   varchar2(150),
  edg_attribute26                   varchar2(150),
  edg_attribute27                   varchar2(150),
  edg_attribute28                   varchar2(150),
  edg_attribute29                   varchar2(150),
  edg_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_dpnt_cvrd_othr_pgm_id).
--
-- Post Success:
--   Processing continues.
--
