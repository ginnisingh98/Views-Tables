--------------------------------------------------------
--  DDL for Package OKL_DRILLDOWN_PUB_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_DRILLDOWN_PUB_PKG" AUTHID CURRENT_USER AS
/* $Header: OKLPDRDS.pls 120.4 2008/01/17 08:12:14 rgooty noship $ */
 /*============================================================================+
 | PROCEDURE:  DRILLDOWN
