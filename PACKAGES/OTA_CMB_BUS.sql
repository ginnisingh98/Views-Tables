--------------------------------------------------------
--  DDL for Package OTA_CMB_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CMB_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_certification_member_id
--     already exists.
--
--  In Arguments:
