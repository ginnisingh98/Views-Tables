--------------------------------------------------------
--  DDL for Package PQH_TKT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TKT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (tatigkeit_detail_id             number(15)
  ,tatigkeit_number                varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_TATIGKEIT_DETAILS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
