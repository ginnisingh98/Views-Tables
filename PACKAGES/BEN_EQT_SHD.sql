--------------------------------------------------------
--  DDL for Package BEN_EQT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EQT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_qual_titl_prte_id             number(15),
  ...
  title                             varchar2(120),
  eqt_attribute_category            varchar2(30),
  eqt_attribute1                    varchar2(150),
  eqt_attribute2                    varchar2(150),
  eqt_attribute3                    varchar2(150),
  eqt_attribute4                    varchar2(150),
  eqt_attribute5                    varchar2(150),
  eqt_attribute6                    varchar2(150),
  eqt_attribute7                    varchar2(150),
  eqt_attribute8                    varchar2(150),
  eqt_attribute9                    varchar2(150),
  eqt_attribute10                   varchar2(150),
  eqt_attribute11                   varchar2(150),
  eqt_attribute12                   varchar2(150),
  eqt_attribute13                   varchar2(150),
  eqt_attribute14                   varchar2(150),
  eqt_attribute15                   varchar2(150),
  eqt_attribute16                   varchar2(150),
  eqt_attribute17                   varchar2(150),
  eqt_attribute18                   varchar2(150),
  eqt_attribute19                   varchar2(150),
  eqt_attribute20                   varchar2(150),
  eqt_attribute21                   varchar2(150),
  eqt_attribute22                   varchar2(150),
  eqt_attribute23                   varchar2(150),
  eqt_attribute24                   varchar2(150),
  eqt_attribute25                   varchar2(150),
  eqt_attribute26                   varchar2(150),
  eqt_attribute27                   varchar2(150),
  eqt_attribute28                   varchar2(150),
  eqt_attribute29                   varchar2(150),
  eqt_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_qual_titl_prte_id).
--
-- Post Success:
--   Processing continues.
--
