--------------------------------------------------------
--  DDL for Package HR_PAE_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PAE_UPD" AUTHID CURRENT_USER as
...
Procedure upd
  ...
  p_exception_name               in varchar2         default hr_api.g_varchar2,
  p_exception_category           in varchar2         default hr_api.g_varchar2,
