--------------------------------------------------------
--  DDL for Package PAY_EGU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EGU_SHD" AUTHID CURRENT_USER as
/* $Header: pyegurhi.pkh 120.0 2005/09/26 09:28 tvankayl noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (event_group_usage_id            number(15)
  ,event_group_id                  number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_EVENT_GROUP_USAGES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
