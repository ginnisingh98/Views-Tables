--------------------------------------------------------
--  DDL for Package PER_CNI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CNI_BUS" AUTHID CURRENT_USER as
/* $Header: pecnirhi.pkh 120.0 2005/05/31 06:49:33 appldev noship $ */
 ...
 --
 --  Prerequisites:
 --    The primary key identified by p_config_information_id
 --     already exists.
 --
 --  In Arguments:
