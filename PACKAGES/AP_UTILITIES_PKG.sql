--------------------------------------------------------
--  DDL for Package AP_UTILITIES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_UTILITIES_PKG" AUTHID CURRENT_USER AS
/* $Header: aputilss.pls 120.19.12010000.7 2009/09/11 11:59:51 sjetti ship $ */
