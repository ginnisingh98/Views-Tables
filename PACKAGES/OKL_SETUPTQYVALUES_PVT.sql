--------------------------------------------------------
--  DDL for Package OKL_SETUPTQYVALUES_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SETUPTQYVALUES_PVT" AUTHID CURRENT_USER AS
/* $Header: OKLRSEVS.pls 115.2 2002/02/06 20:33:17 pkm ship       $ */
  ...
  G_PKG_NAME                  CONSTANT VARCHAR2(30)  := 'OKL_SETUPTQYVALUES_PVT';
  ...
  --TEMPLATE QUALITY
  SUBTYPE ptqv_rec_type IS okl_ptl_qualitys_pub.ptqv_rec_type;
  SUBTYPE ptqv_tbl_type IS okl_ptl_qualitys_pub.ptqv_tbl_type;
