--------------------------------------------------------
--  DDL for Package BEN_ENL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ENL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  enrld_anthr_pl_rt_id            number(15),
  ...
  pl_id                             number(15),
  enl_attribute_category            varchar2(30),
  enl_attribute1                    varchar2(150),
  enl_attribute2                    varchar2(150),
  enl_attribute3                    varchar2(150),
  enl_attribute4                    varchar2(150),
  enl_attribute5                    varchar2(150),
  enl_attribute6                    varchar2(150),
  enl_attribute7                    varchar2(150),
  enl_attribute8                    varchar2(150),
  enl_attribute9                    varchar2(150),
  enl_attribute10                   varchar2(150),
  enl_attribute11                   varchar2(150),
  enl_attribute12                   varchar2(150),
  enl_attribute13                   varchar2(150),
  enl_attribute14                   varchar2(150),
  enl_attribute15                   varchar2(150),
  enl_attribute16                   varchar2(150),
  enl_attribute17                   varchar2(150),
  enl_attribute18                   varchar2(150),
  enl_attribute19                   varchar2(150),
  enl_attribute20                   varchar2(150),
  enl_attribute21                   varchar2(150),
  enl_attribute22                   varchar2(150),
  enl_attribute23                   varchar2(150),
  enl_attribute24                   varchar2(150),
  enl_attribute25                   varchar2(150),
  enl_attribute26                   varchar2(150),
  enl_attribute27                   varchar2(150),
  enl_attribute28                   varchar2(150),
  enl_attribute29                   varchar2(150),
  enl_attribute30                   varchar2(150),
...
--           p_base_key_value = :enrld_anthr_pl_rt_id).
--
-- Post Success:
--   Processing continues.
--
