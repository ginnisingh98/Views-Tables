--------------------------------------------------------
--  DDL for Package FTP_BR_PREPAY_TABLE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FTP_BR_PREPAY_TABLE_PVT" AUTHID CURRENT_USER AS
/* $Header: ftpbppts.pls 120.0 2005/06/06 19:12:41 appldev noship $ */
