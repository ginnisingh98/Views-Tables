--------------------------------------------------------
--  DDL for Package HR_HK_PERSONAL_PAY_METHOD_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_HK_PERSONAL_PAY_METHOD_API" AUTHID CURRENT_USER AS
/* $Header: hrhkwrpm.pkh 120.1 2005/10/02 02:02:50 aroussel $ */
/*#
 * This package contains APIs for creation of personal payment methods for Hong
 * Kong.
 * @rep:scope public
 * @rep:product per
 * @rep:displayname Personal Payment Method for Hong Kong
*/
--
-- ----------------------------------------------------------------------------
-- |----------------------< create_hk_personal_pay_method >-------------------|
-- ----------------------------------------------------------------------------
--
-- {Start Of Comments}
/*#
 * This API creates the personal payment method of an employee for Hong Kong.
 *
 * The API calls the generic API create_personal_pay_method, with the
 * parameters set as appropriate for a Hong Kong employee assignment.
 *
 * <p><b>Licensing</b><br>
 ...
 * @param p_bank_code Bank Code - 3 Characters.
 * @param p_branch_code Branch Code - 3 Characters..
 ...
 * will be null.
 * @rep:displayname Create Personal Payment Method for Hong Kong
...
-- {End Of Comments}
--
PROCEDURE create_hk_personal_pay_method
...
--
-- ----------------------------------------------------------------------------
-- |----------------------< update_hk_personal_pay_method >-------------------|
-- ----------------------------------------------------------------------------
--
-- {Start Of Comments}
/*#
 * This API updates the personal payment method for Hong Kong.
 *
 ...
 * exists as of the effective date. If p_validate is true, then set to null.
 * @rep:displayname Update Personal Payment Method for Hong Kong
 * @rep:category BUSINESS_ENTITY PAY_PERSONAL_PAY_METHOD
 * @rep:category MISC_EXTENSIONS HR_DATAPUMP
 * @rep:scope public
 * @rep:lifecycle active
...
END hr_hk_personal_pay_method_api;
