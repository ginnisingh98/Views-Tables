--------------------------------------------------------
--  DDL for Package JAI_OM_WSH_PROCESSING_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JAI_OM_WSH_PROCESSING_PKG" AUTHID CURRENT_USER AS
/* $Header: jai_om_wsh_prc.pls 120.2 2007/04/23 05:13:28 ssawant ship $ */
