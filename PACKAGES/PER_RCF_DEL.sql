--------------------------------------------------------
--  DDL for Package PER_RCF_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RCF_DEL" AUTHID CURRENT_USER as
...
--
-- Description:
--   This procedure is the record intercfce for the delete process
...
--
-- Description:
--   This procedure is the attribute intercfce for the delete
