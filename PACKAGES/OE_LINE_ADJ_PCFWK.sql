--------------------------------------------------------
--  DDL for Package OE_LINE_ADJ_PCFWK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_LINE_ADJ_PCFWK" AUTHID CURRENT_USER AS
/* $Header: OEXKLADS.pls 120.0 2005/06/01 02:38:36 appldev noship $ */
...
--     against operations on LINE_ADJ or its columns
--  Pre-reqs
--
--  Parameters
--
