--------------------------------------------------------
--  DDL for Package PAY_PTA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PTA_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_dated_table_id
--     already exists.
--
--  In Arguments:
--    p_dated_table_id
