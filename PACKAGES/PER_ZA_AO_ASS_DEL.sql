--------------------------------------------------------
--  DDL for Package PER_ZA_AO_ASS_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_AO_ASS_DEL" AUTHID CURRENT_USER as
/* $Header: pezaaade.pkh 115.0 2001/02/04 22:28:40 pkm ship        $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< del >----------------------------------|
-- ----------------------------------------------------------------------------
-- {Start Of Comments}2000
--
-- Description:
...
--   6) If the p_validate parameter has been set to true an exception is raised
...
--   entity without being committed. If the p_validate parameter has been set
