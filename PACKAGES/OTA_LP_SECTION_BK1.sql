--------------------------------------------------------
--  DDL for Package OTA_LP_SECTION_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_LP_SECTION_BK1" AUTHID CURRENT_USER as
/* $Header: otlpcapi.pkh 120.1 2005/10/02 02:36:59 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_lp_section_b >-------------------------|
-- ----------------------------------------------------------------------------
procedure create_lp_section_b
