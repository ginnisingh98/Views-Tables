--------------------------------------------------------
--  DDL for Package PSP_PEE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_PEE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_external_effort_line_id
--     already exists.
--
--  In Arguments:
