--------------------------------------------------------
--  DDL for Package HR_FIT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FIT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_form_item_id already exists.
--
--  In Arguments:
--    p_form_item_id
--
