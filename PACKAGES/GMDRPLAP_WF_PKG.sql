--------------------------------------------------------
--  DDL for Package GMDRPLAP_WF_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GMDRPLAP_WF_PKG" AUTHID CURRENT_USER AS
/* $Header: GMDRPLAS.pls 115.3 2002/10/29 19:13:13 txdaniel noship $ */
