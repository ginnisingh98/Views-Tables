--------------------------------------------------------
--  DDL for Package PV_BATCH_CHG_PRTNR_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PV_BATCH_CHG_PRTNR_PVT" AUTHID CURRENT_USER AS
/* $Header: pvxvchps.pls 115.0 2003/10/15 04:03:02 rdsharma noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
--          PV_Batch_Chg_Prtnrs_PVT
-- Purpose
--
-- History
--
...
--===================================================================
TYPE Batch_Chg_Prtnrs_Rec_Type IS RECORD
(
       partner_id                      NUMBER,
...
g_miss_Batch_Chg_Prtnrs_rec          Batch_Chg_Prtnrs_rec_type := NULL;
TYPE  Batch_Chg_Prtnrs_tbl_type      IS TABLE OF Batch_Chg_Prtnrs_rec_type INDEX BY BINARY_INTEGER;
g_miss_Batch_Chg_Prtnrs_tbl          Batch_Chg_Prtnrs_tbl_type;
