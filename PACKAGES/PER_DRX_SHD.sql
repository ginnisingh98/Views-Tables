--------------------------------------------------------
--  DDL for Package PER_DRX_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_DRX_SHD" AUTHID CURRENT_USER as
/* $Header: pedrxrhi.pkh 120.0.12010000.1 2018/04/12 14:33:29 gahluwal noship $ */
...
TYPE g_rec_type IS RECORD
  (ff_column_id							number(15)
  ,column_id							number(15)
  ,ff_name                    			varchar2(50)
  ,context_name                       	varchar2(200)
  ,column_name                     		varchar2(128)
  ,column_phase                     	number(3)
...
-- Global table name
g_tab_nam  constant VARCHAR2(30) := 'PER_DRT_COL_CONTEXTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
