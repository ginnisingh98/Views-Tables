--------------------------------------------------------
--  DDL for Package INV_LABEL_PVT16
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."INV_LABEL_PVT16" AUTHID CURRENT_USER AS
/* $Header: INVLA16S.pls 120.0 2007/09/18 13:13:32 hjogleka noship $ */
G_PKG_NAME       CONSTANT VARCHAR2(50) := 'INV_LABEL_PVT16';
