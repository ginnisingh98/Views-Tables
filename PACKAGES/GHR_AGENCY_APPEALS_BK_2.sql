--------------------------------------------------------
--  DDL for Package GHR_AGENCY_APPEALS_BK_2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_AGENCY_APPEALS_BK_2" AUTHID CURRENT_USER as
/* $Header: ghcaaapi.pkh 120.1 2005/10/02 01:56:59 aroussel $ */
--
--
-- ----------------------------------------------------------------------------
-- |-------------------------< update_agency_appeal_b >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_agency_appeal_b
...
--
-- ----------------------------------------------------------------------------
-- |-------------------------< update_agency_appeal_a >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_agency_appeal_a
  (p_effective_date               in     date
  ,p_complaint_id                 in     number
  ,p_appeal_date                  in     date
  ,p_reason_for_appeal            in     varchar2
