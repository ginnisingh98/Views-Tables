--------------------------------------------------------
--  DDL for Package PER_PPS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PPS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,increment_frequency             number(15)
  ,increment_period                varchar2(30)
  ,last_automatic_increment_date   date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_PARENT_SPINES';
