--------------------------------------------------------
--  DDL for Package BEN_LCT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LCT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_chg_ptip_enrt_id              number(15),
  effective_start_date              date,
  effective_end_date                date,
  crnt_enrt_prclds_chg_flag         varchar2(30),
  stl_elig_cant_chg_flag            varchar2(30),
  dflt_flag                         varchar2(30),
  dflt_enrt_cd                      varchar2(30),
  dflt_enrt_rl                      varchar2(30),
  enrt_cd                           varchar2(30),
  enrt_mthd_cd                      varchar2(9),      -- Increased length
  enrt_rl                           varchar2(30),
  tco_chg_enrt_cd                   varchar2(30),
  ptip_id                           number(15),
  ler_id                            number(15),
  business_group_id                 number(15),
  lct_attribute_category            varchar2(30),
  lct_attribute1                    varchar2(150),
  lct_attribute2                    varchar2(150),
  lct_attribute3                    varchar2(150),
  lct_attribute4                    varchar2(150),
  lct_attribute5                    varchar2(150),
  lct_attribute6                    varchar2(150),
  lct_attribute7                    varchar2(150),
  lct_attribute8                    varchar2(150),
  lct_attribute9                    varchar2(150),
  lct_attribute10                   varchar2(150),
  lct_attribute11                   varchar2(150),
  lct_attribute12                   varchar2(150),
  lct_attribute13                   varchar2(150),
  lct_attribute14                   varchar2(150),
  lct_attribute15                   varchar2(150),
  lct_attribute16                   varchar2(150),
  lct_attribute17                   varchar2(150),
  lct_attribute18                   varchar2(150),
  lct_attribute19                   varchar2(150),
  lct_attribute20                   varchar2(150),
  lct_attribute21                   varchar2(150),
  lct_attribute22                   varchar2(150),
  lct_attribute23                   varchar2(150),
  lct_attribute24                   varchar2(150),
  lct_attribute25                   varchar2(150),
  lct_attribute26                   varchar2(150),
  lct_attribute27                   varchar2(150),
  lct_attribute28                   varchar2(150),
  lct_attribute29                   varchar2(150),
  lct_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_chg_ptip_enrt_id).
--
-- Post Success:
--   Processing continues.
--
