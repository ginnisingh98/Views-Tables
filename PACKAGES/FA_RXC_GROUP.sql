--------------------------------------------------------
--  DDL for Package FA_RXC_GROUP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_RXC_GROUP" AUTHID CURRENT_USER AS
/* $Header: farxcgas.pls 120.2.12010000.3 2009/10/30 10:07:01 pmadas ship $ */
...
PROCEDURE get_group_asset_info (
  ...
  argument3         in  varchar2,   -- start fiscal year
  argument4         in  varchar2,   -- end fiscal year
  argument5         in  varchar2  default  null, -- category structure number
  argument6         in  varchar2  default  null, -- major category low
  argument7         in  varchar2  default  null, -- major category high
  argument8         in  varchar2  default  null, -- minor category exists
  argument9         in  varchar2  default  null, -- minor category low
  argument10        in  varchar2  default  null, -- minor category high
  argument11        in  varchar2  default  null, -- category segment name
  argument12        in  varchar2  default  null, -- category segment name low
  argument13        in  varchar2  default  null, -- category segment name high
  argument14        in  varchar2  default  null, -- asset number low
  argument15        in  varchar2  default  null, -- asset number high
  argument16        in  varchar2  default  null, -- drill down
