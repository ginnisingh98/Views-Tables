--------------------------------------------------------
--  DDL for Package IRC_APA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_APA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (apl_profile_access_id           number(15)
  ,person_id                       number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_APL_PROFILE_ACCESS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
