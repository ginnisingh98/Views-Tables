--------------------------------------------------------
--  DDL for Package BEN_PRM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  prtt_prem_by_mo_id                number(15),
  effective_start_date              date,
  effective_end_date                date,
  mnl_adj_flag                      varchar2(30),
  mo_num                            number(9),        -- Increased length
  yr_num                            number(9),        -- Increased length
  antcpd_prtt_cntr_uom              varchar2(30),
  antcpd_prtt_cntr_val              number,
  val                               number,
  cr_val                            number,
  cr_mnl_adj_flag                   varchar2(30),
  alctd_val_flag                    varchar2(30),
  uom                               varchar2(30),
  prtt_prem_id                      number(15),
  cost_allocation_keyflex_id        number(15),
  business_group_id                 number(15),
  prm_attribute_category            varchar2(30),
  prm_attribute1                    varchar2(150),
  prm_attribute2                    varchar2(150),
  prm_attribute3                    varchar2(150),
  prm_attribute4                    varchar2(150),
  prm_attribute5                    varchar2(150),
  prm_attribute6                    varchar2(150),
  prm_attribute7                    varchar2(150),
  prm_attribute8                    varchar2(150),
  prm_attribute9                    varchar2(150),
  prm_attribute10                   varchar2(150),
  prm_attribute11                   varchar2(150),
  prm_attribute12                   varchar2(150),
  prm_attribute13                   varchar2(150),
  prm_attribute14                   varchar2(150),
  prm_attribute15                   varchar2(150),
  prm_attribute16                   varchar2(150),
  prm_attribute17                   varchar2(150),
  prm_attribute18                   varchar2(150),
  prm_attribute19                   varchar2(150),
  prm_attribute20                   varchar2(150),
  prm_attribute21                   varchar2(150),
  prm_attribute22                   varchar2(150),
  prm_attribute23                   varchar2(150),
  prm_attribute24                   varchar2(150),
  prm_attribute25                   varchar2(150),
  prm_attribute26                   varchar2(150),
  prm_attribute27                   varchar2(150),
  prm_attribute28                   varchar2(150),
  prm_attribute29                   varchar2(150),
  prm_attribute30                   varchar2(150),
...
--           p_base_key_value = :prtt_prem_by_mo_id).
--
-- Post Success:
--   Processing continues.
--
