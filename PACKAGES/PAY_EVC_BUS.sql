--------------------------------------------------------
--  DDL for Package PAY_EVC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EVC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_event_value_change_id
--     already exists.
--
--  In Arguments:
