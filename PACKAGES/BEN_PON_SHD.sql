--------------------------------------------------------
--  DDL for Package BEN_PON_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PON_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  pl_typ_opt_typ_cd                 varchar2(30),
  opt_id                            number(15),
  pl_typ_id                         number(15),
  business_group_id                 number(15),
  legislation_code            varchar2(30),
  legislation_subgroup            varchar2(30),
  pon_attribute_category            varchar2(30),
  pon_attribute1                    varchar2(150),
  pon_attribute2                    varchar2(150),
  pon_attribute3                    varchar2(150),
  pon_attribute4                    varchar2(150),
  pon_attribute5                    varchar2(150),
  pon_attribute6                    varchar2(150),
  pon_attribute7                    varchar2(150),
  pon_attribute8                    varchar2(150),
  pon_attribute9                    varchar2(150),
  pon_attribute10                   varchar2(150),
  pon_attribute11                   varchar2(150),
  pon_attribute12                   varchar2(150),
  pon_attribute13                   varchar2(150),
  pon_attribute14                   varchar2(150),
  pon_attribute15                   varchar2(150),
  pon_attribute16                   varchar2(150),
  pon_attribute17                   varchar2(150),
  pon_attribute18                   varchar2(150),
  pon_attribute19                   varchar2(150),
  pon_attribute20                   varchar2(150),
  pon_attribute21                   varchar2(150),
  pon_attribute22                   varchar2(150),
  pon_attribute23                   varchar2(150),
  pon_attribute24                   varchar2(150),
  pon_attribute25                   varchar2(150),
  pon_attribute26                   varchar2(150),
  pon_attribute27                   varchar2(150),
  pon_attribute28                   varchar2(150),
  pon_attribute29                   varchar2(150),
  pon_attribute30                   varchar2(150),
...
--           p_base_key_value = :pl_typ_opt_typ_id).
--
-- Post Success:
--   Processing continues.
--
