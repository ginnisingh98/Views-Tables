--------------------------------------------------------
--  DDL for Package PER_AST_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_AST_BUS" AUTHID CURRENT_USER as
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_validate(p_rec in per_ast_shd.g_rec_type);
--
-- ----------------------------------------------------------------------------
...
--
-- In Parameters:
--   the primary key of the table (per_assessment_types)
--
-- Post Success:
--   Processing continues.
--
