--------------------------------------------------------
--  DDL for Package BEN_ENO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ENO_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_no_othr_cvg_prte_id          number(15),
  effective_start_date              date,
  effective_end_date                date,
  coord_ben_no_cvg_flag             varchar2(30),
  eligy_prfl_id                     number(15),
  business_group_id                 number(15),
  eno_attribute_category            varchar2(30),
  eno_attribute1                    varchar2(150),
  eno_attribute2                    varchar2(150),
  eno_attribute3                    varchar2(150),
  eno_attribute4                    varchar2(150),
  eno_attribute5                    varchar2(150),
  eno_attribute6                    varchar2(150),
  eno_attribute7                    varchar2(150),
  eno_attribute8                    varchar2(150),
  eno_attribute9                    varchar2(150),
  eno_attribute10                   varchar2(150),
  eno_attribute11                   varchar2(150),
  eno_attribute12                   varchar2(150),
  eno_attribute13                   varchar2(150),
  eno_attribute14                   varchar2(150),
  eno_attribute15                   varchar2(150),
  eno_attribute16                   varchar2(150),
  eno_attribute17                   varchar2(150),
  eno_attribute18                   varchar2(150),
  eno_attribute19                   varchar2(150),
  eno_attribute20                   varchar2(150),
  eno_attribute21                   varchar2(150),
  eno_attribute22                   varchar2(150),
  eno_attribute23                   varchar2(150),
  eno_attribute24                   varchar2(150),
  eno_attribute25                   varchar2(150),
  eno_attribute26                   varchar2(150),
  eno_attribute27                   varchar2(150),
  eno_attribute28                   varchar2(150),
  eno_attribute29                   varchar2(150),
  eno_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_no_othr_cvg_prte_id).
--
-- Post Success:
--   Processing continues.
--
