--------------------------------------------------------
--  DDL for Package PER_EST_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_EST_FLEX" AUTHID CURRENT_USER as
/* $Header: peestfli.pkh 115.0 99/07/17 18:59:57 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
