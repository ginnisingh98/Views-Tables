--------------------------------------------------------
--  DDL for Package PQH_RAP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RAP_BUS" AUTHID CURRENT_USER as
...
--
--  Description:
--    The procedure is not define as it is calling parent procedure in the
--    insert_validate and update_validate procedures.
--
-- {End Of Comments}
-- ---------------------------------------------------------------------------
--
...
--
--  Prerequisites:
--    The primary key identified by p_rank_process_approval_id
--     already exists.
--
--  In Arguments:
