--------------------------------------------------------
--  DDL for Package QP_MODIFIERS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."QP_MODIFIERS_PUB_W" AUTHID CURRENT_USER as
  /* $Header: ozfwqmps.pls 120.0 2005/08/26 15:39 julou noship $ */
