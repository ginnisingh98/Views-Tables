--------------------------------------------------------
--  DDL for Package BEN_XRE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XRE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_ext_rslt_err_id already exists.
--
--  In Arguments:
--    p_ext_rslt_err_id
--
...
function return_legislation_code
  (p_ext_rslt_err_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
