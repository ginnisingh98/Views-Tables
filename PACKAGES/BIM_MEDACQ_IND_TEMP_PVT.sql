--------------------------------------------------------
--  DDL for Package BIM_MEDACQ_IND_TEMP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BIM_MEDACQ_IND_TEMP_PVT" AUTHID CURRENT_USER AS
/* $Header: bimvmqis.pls 115.2 2000/03/03 20:36:15 pkm ship  $ */
