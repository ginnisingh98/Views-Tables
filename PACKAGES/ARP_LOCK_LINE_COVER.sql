--------------------------------------------------------
--  DDL for Package ARP_LOCK_LINE_COVER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARP_LOCK_LINE_COVER" AUTHID CURRENT_USER AS
/* $Header: ARTCTLLS.pls 120.1 2005/10/07 18:32:29 ralat noship $ */
