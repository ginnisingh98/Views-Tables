--------------------------------------------------------
--  DDL for Package IRC_ISC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_ISC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,min_qual_level                  number(9)
  ,max_qual_level                  number(9)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_SEARCH_CRITERIA';
