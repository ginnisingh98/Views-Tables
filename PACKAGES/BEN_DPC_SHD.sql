--------------------------------------------------------
--  DDL for Package BEN_DPC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DPC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dpnt_cvrd_anthr_pl_cvg_id         number(15),
  ...
  pl_id                             number(15),
  dpc_attribute_category            varchar2(30),
  dpc_attribute1                    varchar2(150),
  dpc_attribute2                    varchar2(150),
  dpc_attribute3                    varchar2(150),
  dpc_attribute4                    varchar2(150),
  dpc_attribute5                    varchar2(150),
  dpc_attribute6                    varchar2(150),
  dpc_attribute7                    varchar2(150),
  dpc_attribute8                    varchar2(150),
  dpc_attribute9                    varchar2(150),
  dpc_attribute10                   varchar2(150),
  dpc_attribute11                   varchar2(150),
  dpc_attribute12                   varchar2(150),
  dpc_attribute13                   varchar2(150),
  dpc_attribute14                   varchar2(150),
  dpc_attribute15                   varchar2(150),
  dpc_attribute16                   varchar2(150),
  dpc_attribute17                   varchar2(150),
  dpc_attribute18                   varchar2(150),
  dpc_attribute19                   varchar2(150),
  dpc_attribute20                   varchar2(150),
  dpc_attribute21                   varchar2(150),
  dpc_attribute22                   varchar2(150),
  dpc_attribute23                   varchar2(150),
  dpc_attribute24                   varchar2(150),
  dpc_attribute25                   varchar2(150),
  dpc_attribute26                   varchar2(150),
  dpc_attribute27                   varchar2(150),
  dpc_attribute28                   varchar2(150),
  dpc_attribute29                   varchar2(150),
  dpc_attribute30                   varchar2(150),
...
--           p_base_key_value = :dpnt_cvrd_anthr_pl_cvg_id).
--
-- Post Success:
--   Processing continues.
--
