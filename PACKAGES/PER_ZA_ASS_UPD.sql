--------------------------------------------------------
--  DDL for Package PER_ZA_ASS_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_ASS_UPD" AUTHID CURRENT_USER as
/* $Header: pezaasup.pkh 115.1 2002/12/05 06:49:39 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< upd >----------------------------------|
-- ----------------------------------------------------------------------------
