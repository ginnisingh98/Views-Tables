--------------------------------------------------------
--  DDL for Package BEN_PCX_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PCX_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  pl_bnf_ctfn_id                    number(15),
  effective_start_date              date,
  effective_end_date                date,
  pl_id                             number(15),
  bnf_ctfn_typ_cd                   varchar2(30),
  lack_ctfn_sspnd_enrt_flag         varchar2(30),
  pfd_flag                          varchar2(30),
  rqd_flag                          varchar2(30),
  ctfn_rqd_when_rl                  number(15),
  bnf_typ_cd                        varchar2(30),
  rlshp_typ_cd                      varchar2(30),
  object_version_number             number(9),
  business_group_id                 number(15),
  pcx_attribute_category            varchar2(30),
  pcx_attribute1                    varchar2(150),
  pcx_attribute2                    varchar2(150),
  pcx_attribute3                    varchar2(150),
  pcx_attribute4                    varchar2(150),
  pcx_attribute5                    varchar2(150),
  pcx_attribute6                    varchar2(150),
  pcx_attribute7                    varchar2(150),
  pcx_attribute8                    varchar2(150),
  pcx_attribute9                    varchar2(150),
  pcx_attribute10                   varchar2(150),
  pcx_attribute11                   varchar2(150),
  pcx_attribute12                   varchar2(150),
  pcx_attribute13                   varchar2(150),
  pcx_attribute14                   varchar2(150),
  pcx_attribute15                   varchar2(150),
  pcx_attribute16                   varchar2(150),
  pcx_attribute17                   varchar2(150),
  pcx_attribute18                   varchar2(150),
  pcx_attribute19                   varchar2(150),
  pcx_attribute20                   varchar2(150),
  pcx_attribute21                   varchar2(150),
  pcx_attribute22                   varchar2(150),
  pcx_attribute23                   varchar2(150),
  pcx_attribute24                   varchar2(150),
  pcx_attribute25                   varchar2(150),
  pcx_attribute26                   varchar2(150),
  pcx_attribute27                   varchar2(150),
  pcx_attribute28                   varchar2(150),
  pcx_attribute29                   varchar2(150),
  pcx_attribute30                   varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :pl_bnf_ctfn_id).
--
-- Post Success:
--   Processing continues.
--
