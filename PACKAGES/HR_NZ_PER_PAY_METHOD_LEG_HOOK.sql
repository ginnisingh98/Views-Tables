--------------------------------------------------------
--  DDL for Package HR_NZ_PER_PAY_METHOD_LEG_HOOK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_NZ_PER_PAY_METHOD_LEG_HOOK" AUTHID CURRENT_USER AS
/* $Header: hrnzlhpp.pkh 120.0 2005/05/31 01:39:36 appldev noship $ */
/*
 ******************************************************************
 *                                                                *
...
/*
	Filename: hrnzlhpp.pkh (HEADER)
    Author: Philip Macdonald
 	Description: Creates the user hook seed data for the HR_PERSONAL_PAYMENT_API package procedures.
