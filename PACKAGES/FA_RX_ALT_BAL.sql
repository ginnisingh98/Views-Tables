--------------------------------------------------------
--  DDL for Package FA_RX_ALT_BAL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_RX_ALT_BAL" AUTHID CURRENT_USER as
/* $Header: farxacbls.pls 120.0.12010000.2 2009/07/19 12:58:26 glchen ship $ */
...
PROCEDURE ASSET_COST_BAL (
  ...
  argument4             in      varchar2 default 'N',   -- standard or drill down
