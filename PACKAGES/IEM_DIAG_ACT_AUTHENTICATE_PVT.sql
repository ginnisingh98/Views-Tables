--------------------------------------------------------
--  DDL for Package IEM_DIAG_ACT_AUTHENTICATE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IEM_DIAG_ACT_AUTHENTICATE_PVT" AUTHID CURRENT_USER AS
/* $Header: iemdauts.pls 115.2 2003/01/20 22:40:11 chtang noship $ */
