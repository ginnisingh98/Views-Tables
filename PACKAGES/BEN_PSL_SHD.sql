--------------------------------------------------------
--  DDL for Package BEN_PSL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PSL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  per_info_chg_cs_ler_id            number(15),
  name                              varchar2(600), --Bug 2342584
  effective_start_date              date,
  effective_end_date                date,
  per_info_chg_cs_ler_rl            number(15),
  old_val                           varchar2(180),
  new_val                           varchar2(180),
  whatif_lbl_txt                    varchar2(300),
  rule_overrides_flag                    varchar2(30),
  source_column                     varchar2(90),
  source_table                      varchar2(90),
  business_group_id                 number(15),
  psl_attribute_category            varchar2(30),
  psl_attribute1                    varchar2(150),
  psl_attribute2                    varchar2(150),
  psl_attribute3                    varchar2(150),
  psl_attribute4                    varchar2(150),
  psl_attribute5                    varchar2(150),
  psl_attribute6                    varchar2(150),
  psl_attribute7                    varchar2(150),
  psl_attribute8                    varchar2(150),
  psl_attribute9                    varchar2(150),
  psl_attribute10                   varchar2(150),
  psl_attribute11                   varchar2(150),
  psl_attribute12                   varchar2(150),
  psl_attribute13                   varchar2(150),
  psl_attribute14                   varchar2(150),
  psl_attribute15                   varchar2(150),
  psl_attribute16                   varchar2(150),
  psl_attribute17                   varchar2(150),
  psl_attribute18                   varchar2(150),
  psl_attribute19                   varchar2(150),
  psl_attribute20                   varchar2(150),
  psl_attribute21                   varchar2(150),
  psl_attribute22                   varchar2(150),
  psl_attribute23                   varchar2(150),
  psl_attribute24                   varchar2(150),
  psl_attribute25                   varchar2(150),
  psl_attribute26                   varchar2(150),
  psl_attribute27                   varchar2(150),
  psl_attribute28                   varchar2(150),
  psl_attribute29                   varchar2(150),
  psl_attribute30                   varchar2(150),
...
--           p_base_key_value = :per_info_chg_cs_ler_id).
--
-- Post Success:
--   Processing continues.
--
