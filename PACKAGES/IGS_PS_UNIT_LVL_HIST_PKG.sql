--------------------------------------------------------
--  DDL for Package IGS_PS_UNIT_LVL_HIST_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PS_UNIT_LVL_HIST_PKG" AUTHID CURRENT_USER AS
 /* $Header: IGSPI41S.pls 115.6 2003/11/05 18:08:40 ijeddy ship $ */
