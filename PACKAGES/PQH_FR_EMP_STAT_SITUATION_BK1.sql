--------------------------------------------------------
--  DDL for Package PQH_FR_EMP_STAT_SITUATION_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_FR_EMP_STAT_SITUATION_BK1" AUTHID CURRENT_USER as
/* $Header: pqpsuapi.pkh 120.0 2005/05/29 02:19:41 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< CREATE_EMP_STAT_SITUATION_B >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure CREATE_EMP_STAT_SITUATION_B
...
--
-- ----------------------------------------------------------------------------
-- |-----------------< CREATE_EMP_STAT_SITUATION_A >----------------------|
-- ----------------------------------------------------------------------------
--
procedure CREATE_EMP_STAT_SITUATION_A
  (p_effective_date                IN     date
  ,P_STATUTORY_SITUATION_ID        IN     NUMBER
  ,P_PERSON_ID                     IN     NUMBER
  ,P_PROVISIONAL_START_DATE        IN     DATE
...
--
end PQH_FR_EMP_STAT_SITUATION_BK1;
