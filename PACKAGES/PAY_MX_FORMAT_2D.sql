--------------------------------------------------------
--  DDL for Package PAY_MX_FORMAT_2D
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_MX_FORMAT_2D" AUTHID CURRENT_USER as
/* $Header: paymxformat2d.pkh 120.0.12000000.1 2007/02/22 16:25:25 vmehta noship $ */
/*  +======================================================================+
    ...
    Package File Name   : paymxformat2d.pkh

    Description : Used for format2D
    ...
    ------------- ----------- ------- ------- ------------------------------
    Nageswara     10-Nov-2006 115.0           Initial Version
    ========================================================================*/
