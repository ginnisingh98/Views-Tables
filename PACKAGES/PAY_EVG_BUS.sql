--------------------------------------------------------
--  DDL for Package PAY_EVG_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EVG_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_event_group_id
--     already exists.
--
--  In Arguments:
--    p_event_group_id
