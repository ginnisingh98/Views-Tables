--------------------------------------------------------
--  DDL for Package HR_PAE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PAE_SHD" AUTHID CURRENT_USER as
...
Function convert_args
	...
	p_exception_end_time            in date,
	p_exception_category            in varchar2,
	p_object_version_number         in number
	)
	Return g_rec_type;
--
