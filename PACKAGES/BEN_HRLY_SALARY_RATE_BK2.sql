--------------------------------------------------------
--  DDL for Package BEN_HRLY_SALARY_RATE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_HRLY_SALARY_RATE_BK2" AUTHID CURRENT_USER as
/* $Header: behsrapi.pkh 120.0 2005/05/28 03:11:04 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_HRLY_SALARY_RATE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_HRLY_SALARY_RATE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_HRLY_SALARY_RATE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_HRLY_SALARY_RATE_a
  (
   p_hrly_slrd_rt_id                in  number
