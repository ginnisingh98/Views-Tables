--------------------------------------------------------
--  DDL for Package OKL_SPLIT_CONTRACT_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SPLIT_CONTRACT_PVT" AUTHID CURRENT_USER as
/* $Header: OKLRSKHS.pls 115.6 2004/01/24 00:52:22 rravikir noship $ */

  TYPE ktl_rec_type IS RECORD (line_number      NUMBER := OKC_API.G_MISS_NUM,
                               contract_number  OKC_K_HEADERS_B.CONTRACT_NUMBER%TYPE := OKC_API.G_MISS_CHAR,
                               kle_id           NUMBER := OKC_API.G_MISS_NUM);
  TYPE ktl_tbl_type IS TABLE OF ktl_rec_type
