--------------------------------------------------------
--  DDL for Package GHR_CAH_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CAH_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_compl_ca_header_id
--     already exists.
--
--  In Arguments:
