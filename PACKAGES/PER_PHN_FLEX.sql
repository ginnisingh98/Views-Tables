--------------------------------------------------------
--  DDL for Package PER_PHN_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PHN_FLEX" AUTHID CURRENT_USER as
/* $Header: pephnfli.pkh 115.0 99/07/18 14:18:05 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
