--------------------------------------------------------
--  DDL for Package BEN_PSQ_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PSQ_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_pymt_sched_py_freq_id already exists.
--
--  In Arguments:
...
function return_legislation_code
  (p_pymt_sched_py_freq_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
