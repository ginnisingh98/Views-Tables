--------------------------------------------------------
--  DDL for Package IGIRX_C_IAC_PROJ
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGIRX_C_IAC_PROJ" AUTHID CURRENT_USER AS
/* $Header: igiiapxs.pls 120.3 2007/08/01 10:45:11 npandya ship $ */
