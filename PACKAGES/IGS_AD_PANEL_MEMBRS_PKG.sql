--------------------------------------------------------
--  DDL for Package IGS_AD_PANEL_MEMBRS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_AD_PANEL_MEMBRS_PKG" AUTHID CURRENT_USER AS
/* $Header: IGSAIG8S.pls 115.1 2003/06/19 15:19:09 akadam noship $ */
  ...
  PROCEDURE before_dml (
    ...
    x_panel_seq_num                     IN     NUMBER      DEFAULT NULL,
