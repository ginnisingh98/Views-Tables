--------------------------------------------------------
--  DDL for Package AMS_DM_IMP_ATTRIBUTE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_DM_IMP_ATTRIBUTE_PVT" AUTHID CURRENT_USER AS
/* $Header: amsvdias.pls 115.3 2002/12/09 11:05:06 choang noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
...
--===================================================================
TYPE imp_attribute_rec_type IS RECORD
(
       imp_attribute_id                NUMBER,
       ...
       rank                            NUMBER,
       value                           NUMBER,
       source_field_name	            VARCHAR2(120)
);

g_miss_imp_attribute_rec          imp_attribute_rec_type := NULL;
TYPE  imp_attribute_tbl_type      IS TABLE OF imp_attribute_rec_type INDEX BY BINARY_INTEGER;
g_miss_imp_attribute_tbl          imp_attribute_tbl_type;
