--------------------------------------------------------
--  DDL for Package BEN_APL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_APL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  acty_rt_ptd_lmt_id                number(15),
  effective_start_date              date,
  effective_end_date                date,
  acty_base_rt_id                   number(15),
  ptd_lmt_id                        number(15),
  business_group_id                 number(15),
  apl_attribute_category            varchar2(30),
  apl_attribute1                    varchar2(150),
  apl_attribute2                    varchar2(150),
  apl_attribute3                    varchar2(150),
  apl_attribute4                    varchar2(150),
  apl_attribute5                    varchar2(150),
  apl_attribute6                    varchar2(150),
  apl_attribute7                    varchar2(150),
  apl_attribute8                    varchar2(150),
  apl_attribute9                    varchar2(150),
  apl_attribute10                   varchar2(150),
  apl_attribute11                   varchar2(150),
  apl_attribute12                   varchar2(150),
  apl_attribute13                   varchar2(150),
  apl_attribute14                   varchar2(150),
  apl_attribute15                   varchar2(150),
  apl_attribute16                   varchar2(150),
  apl_attribute17                   varchar2(150),
  apl_attribute18                   varchar2(150),
  apl_attribute19                   varchar2(150),
  apl_attribute20                   varchar2(150),
  apl_attribute21                   varchar2(150),
  apl_attribute22                   varchar2(150),
  apl_attribute23                   varchar2(150),
  apl_attribute24                   varchar2(150),
  apl_attribute25                   varchar2(150),
  apl_attribute26                   varchar2(150),
  apl_attribute27                   varchar2(150),
  apl_attribute28                   varchar2(150),
  apl_attribute29                   varchar2(150),
  apl_attribute30                   varchar2(150),
...
--           p_base_key_value = :acty_rt_ptd_lmt_id).
--
-- Post Success:
--   Processing continues.
--
