--------------------------------------------------------
--  DDL for Package HR_AHC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_AHC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  api_hook_call_id                  number(15),
  api_hook_id                       number(15),
  api_hook_call_type                varchar2(30),
