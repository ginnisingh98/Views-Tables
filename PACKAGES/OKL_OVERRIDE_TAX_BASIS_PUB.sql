--------------------------------------------------------
--  DDL for Package OKL_OVERRIDE_TAX_BASIS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_OVERRIDE_TAX_BASIS_PUB" AUTHID CURRENT_USER AS
/* $Header: OKLPOTBS.pls 120.0 2005/08/26 21:57:31 sechawla noship $ */
  ---------------------------------------------------------------------------
  -- GLOBAL DATASTRUCTURES
  ---------------------------------------------------------------------------
  SUBTYPE tbov_rec_type IS OKL_OVERRIDE_TAX_BASIS_PVT.tbov_rec_type;
  SUBTYPE tbov_tbl_type IS OKL_OVERRIDE_TAX_BASIS_PVT.tbov_tbl_type;
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME            CONSTANT VARCHAR2(200) := 'OKL_OVERRIDE_TAX_BASIS_PUB';
