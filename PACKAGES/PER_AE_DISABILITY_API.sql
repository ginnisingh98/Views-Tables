--------------------------------------------------------
--  DDL for Package PER_AE_DISABILITY_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_AE_DISABILITY_API" AUTHID CURRENT_USER as
/* $Header: pedisaei.pkh 120.2 2006/09/27 13:33:39 spendhar noship $ */
/*#
 * This API creates a disability record for a person.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname UAE Disability APIs
*/
--
-- ----------------------------------------------------------------------------
 ...
 * @param p_relevant_to_social_security Relevant to social security indicator.
 ...
 * @rep:displayname Create UAE Disability
 ...
 * @param p_attribute29 Descriptive flexfield segment.
 * @param p_attribute30 Descriptive flexfield segment.
 * @param p_relevant_to_social_security Relevent to social security indicator.
 ...
 * @rep:displayname Update UAE Disability
 * @rep:category BUSINESS_ENTITY PER_DISABILITY
 * @rep:lifecycle active
 * @rep:scope public
 * @rep:ihelp PER/@scalapi APIs in Oracle HRMS
