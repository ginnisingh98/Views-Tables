--------------------------------------------------------
--  DDL for Package PQH_RNK_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RNK_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_rank_process_id
--     already exists.
--
--  In Arguments:
--    p_rank_process_id
