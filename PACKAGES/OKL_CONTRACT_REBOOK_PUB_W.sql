--------------------------------------------------------
--  DDL for Package OKL_CONTRACT_REBOOK_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_CONTRACT_REBOOK_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLURBKS.pls 120.2 2005/12/06 23:43:17 rpillay noship $ */
