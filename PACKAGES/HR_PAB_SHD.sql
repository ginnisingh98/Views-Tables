--------------------------------------------------------
--  DDL for Package HR_PAB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PAB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  pattern_bit_code                  varchar2(30),
  bit_meaning                       varchar2(2000),
  time_unit_multiplier              number,
  base_time_unit                    varchar2(30),
