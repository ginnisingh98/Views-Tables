--------------------------------------------------------
--  DDL for Package BEN_DPNT_ELIG_CRIT_VAL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DPNT_ELIG_CRIT_VAL_BK1" AUTHID CURRENT_USER AS
/* $Header: beedvapi.pkh 120.0.12010000.4 2010/04/19 07:30:10 pvelvano noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_dpnt_eligy_crit_val_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_dpnt_eligy_crit_val_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_dpnt_eligy_crit_val_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_dpnt_eligy_crit_val_a
  (
...
--
end ben_dpnt_elig_crit_val_bk1;
