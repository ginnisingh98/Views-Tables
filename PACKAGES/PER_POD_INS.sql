--------------------------------------------------------
--  DDL for Package PER_POD_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_POD_INS" AUTHID CURRENT_USER as
...
--   3. If a combination does exist the p_position_definition_id is returned.
--
-- Pre Conditions:
--
-- In Arguments:
...
--   the per_position_definitions and the out arguments are returned.
