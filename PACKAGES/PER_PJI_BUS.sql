--------------------------------------------------------
--  DDL for Package PER_PJI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PJI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_previous_job_extra_info_id
--     already exists.
--
--  In Arguments:
