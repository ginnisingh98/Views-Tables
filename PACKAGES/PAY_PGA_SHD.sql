--------------------------------------------------------
--  DDL for Package PAY_PGA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PGA_SHD" AUTHID CURRENT_USER as
/* $Header: pypgarhi.pkh 120.0 2005/09/29 10:52 tvankayl noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (pay_gl_account_id               number(15)
  ,effective_start_date            date
  ,effective_end_date              date
  ,set_of_books_id                 number(15)
  ,gl_cash_ac_id                   number(15)
  ,gl_cash_clearing_ac_id          number(15)
  ,gl_control_ac_id                number(15)
  ,gl_error_ac_id                  number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_PAYMENT_GL_ACCOUNTS_F';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :pay_gl_account_id).
--
-- Post Success:
