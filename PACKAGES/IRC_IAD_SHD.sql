--------------------------------------------------------
--  DDL for Package IRC_IAD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IAD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (assignment_details_id           number(15)
  ,assignment_id                   number(15)
  ,effective_start_date            date
  ,effective_end_date              date
  ,details_version                 number(15)
  ,latest_details                  varchar2(30)
  ,attempt_id                      number(15)
  ,qualified                       varchar2(30)
  ,considered                      varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_ASSIGNMENT_DETAILS_F';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :assignment_details_id).
--
-- Post Success:
