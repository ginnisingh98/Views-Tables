--------------------------------------------------------
--  DDL for Package PAY_DK_RULES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_DK_RULES" AUTHID CURRENT_USER AS
/* $Header: pydkrule.pkh 120.3.12010000.1 2008/07/27 22:27:12 appldev ship $ */
--
-- ----------------------------------------------------------------------------
-- |--------------------------< PAY_DK_RULES >--------------------------------|
-- ----------------------------------------------------------------------------
...
------ cursor to get the balance details ------------------------------------
	...
	AND ((pai1.action_context_id = 	p_action_context_id)
--          OR
--          pai1.action_context_id  in ( SELECT paa.assignment_action_id
