--------------------------------------------------------
--  DDL for Package PAY_SPR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_SPR_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_SECURITY_PAYROLLS';
