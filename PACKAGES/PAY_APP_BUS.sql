--------------------------------------------------------
--  DDL for Package PAY_APP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_APP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_process_parameter_id
--     already exists.
--
--  In Arguments:
