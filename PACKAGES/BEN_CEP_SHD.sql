--------------------------------------------------------
--  DDL for Package BEN_CEP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CEP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  Elig_prfl_type_cd                 varchar2(30),
  cep_attribute_category            varchar2(30),
  cep_attribute1                    varchar2(150),
  cep_attribute2                    varchar2(150),
  cep_attribute3                    varchar2(150),
  cep_attribute4                    varchar2(150),
  cep_attribute5                    varchar2(150),
  cep_attribute6                    varchar2(150),
  cep_attribute7                    varchar2(150),
  cep_attribute8                    varchar2(150),
  cep_attribute9                    varchar2(150),
  cep_attribute10                   varchar2(150),
  cep_attribute11                   varchar2(150),
  cep_attribute12                   varchar2(150),
  cep_attribute13                   varchar2(150),
  cep_attribute14                   varchar2(150),
  cep_attribute15                   varchar2(150),
  cep_attribute16                   varchar2(150),
  cep_attribute17                   varchar2(150),
  cep_attribute18                   varchar2(150),
  cep_attribute19                   varchar2(150),
  cep_attribute20                   varchar2(150),
  cep_attribute21                   varchar2(150),
  cep_attribute22                   varchar2(150),
  cep_attribute23                   varchar2(150),
  cep_attribute24                   varchar2(150),
  cep_attribute25                   varchar2(150),
  cep_attribute26                   varchar2(150),
  cep_attribute27                   varchar2(150),
  cep_attribute28                   varchar2(150),
  cep_attribute29                   varchar2(150),
  cep_attribute30                   varchar2(150),
  object_version_number             number(9)    ,
  compute_score_flag                varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :prtn_elig_prfl_id).
--
-- Post Success:
--   Processing continues.
--
