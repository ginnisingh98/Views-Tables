--------------------------------------------------------
--  DDL for Package PER_PERSACTR_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PERSACTR_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: PERSACTRS.pls 120.0 2007/12/24 13:20:17 amakrish noship $ */
  ...
  L_STATUS_CONDITION VARCHAR2(200);

  P_EMP_STATUS VARCHAR2(30);
  ...
  FUNCTION CF_CON_TYPEFORMULA RETURN CHAR;

  FUNCTION CF_DURATION_UNITSFORMULA RETURN CHAR;

  FUNCTION AFTERPFORM RETURN BOOLEAN;

  FUNCTION CF_EMP_STATUSFORMULA RETURN CHAR;
