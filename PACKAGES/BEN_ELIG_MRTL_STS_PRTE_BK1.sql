--------------------------------------------------------
--  DDL for Package BEN_ELIG_MRTL_STS_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_MRTL_STS_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beempapi.pkh 120.0 2005/05/28 02:25:28 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_elig_mrtl_sts_prte_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_elig_mrtl_sts_prte_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_elig_mrtl_sts_prte_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_elig_mrtl_sts_prte_a
  (
...
--
end ben_elig_mrtl_sts_prte_bk1;
