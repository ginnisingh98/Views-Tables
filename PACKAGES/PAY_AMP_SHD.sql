--------------------------------------------------------
--  DDL for Package PAY_AMP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_AMP_SHD" AUTHID CURRENT_USER as
/* $Header: pyamprhi.pkh 120.2 2006/12/04 13:29:42 abhargav noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (module_parameter_id             number(15)
  ,module_id                       number(15)
  ,internal_name                   varchar2(30)
  ,data_type                       varchar2(30)
  ,input_flag                      varchar2(30)
  ,context_flag                    varchar2(30)
  ,output_flag                     varchar2(30)
  ,result_flag                     varchar2(30)
  ,error_message_flag              varchar2(30)
  ,function_return_flag            varchar2(30)
  ,enabled_flag                    varchar2(30)
  ,external_name                   varchar2(30)
  ,database_item_name              varchar2(30)
  ,constant_value                  varchar2(240)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_AU_MODULE_PARAMETERS';
