--------------------------------------------------------
--  DDL for Package HRDPP_INSERT_EXTERNAL_EFFORT_L
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HRDPP_INSERT_EXTERNAL_EFFORT_L" as
/*
...
,P_EXT_EFFORT_LINES_USER_KEY in varchar2);
--
procedure call
