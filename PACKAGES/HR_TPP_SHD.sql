--------------------------------------------------------
--  DDL for Package HR_TPP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TPP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (tab_page_property_id            number(15)
  ,object_version_number           number(9)
  ,form_tab_page_id                number(15)
  ,template_tab_page_id            number(15)
  ,navigation_direction            varchar2(30)
  ,visible                         number(10)
