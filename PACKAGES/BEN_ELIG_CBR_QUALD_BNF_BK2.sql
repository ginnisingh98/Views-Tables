--------------------------------------------------------
--  DDL for Package BEN_ELIG_CBR_QUALD_BNF_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_CBR_QUALD_BNF_BK2" AUTHID CURRENT_USER as
/* $Header: beecqapi.pkh 120.0 2005/05/28 01:52:08 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_CBR_QUALD_BNF_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_CBR_QUALD_BNF_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_CBR_QUALD_BNF_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_CBR_QUALD_BNF_a
  (
   p_elig_cbr_quald_bnf_id          in  number
...
--
end ben_ELIG_CBR_QUALD_BNF_bk2;
