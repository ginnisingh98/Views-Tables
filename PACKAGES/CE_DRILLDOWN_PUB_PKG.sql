--------------------------------------------------------
--  DDL for Package CE_DRILLDOWN_PUB_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CE_DRILLDOWN_PUB_PKG" AUTHID CURRENT_USER AS
/* $Header: cexladds.pls 120.1.12010000.1 2009/10/26 23:08:26 vnetan noship $ */
