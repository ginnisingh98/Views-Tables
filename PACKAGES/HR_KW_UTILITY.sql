--------------------------------------------------------
--  DDL for Package HR_KW_UTILITY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_KW_UTILITY" AUTHID CURRENT_USER AS
 /* $Header: hrkwutil.pkh 120.0 2005/05/31 01:12:56 appldev noship $ */
 --
 --
