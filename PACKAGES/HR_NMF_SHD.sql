--------------------------------------------------------
--  DDL for Package HR_NMF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_NMF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (name_format_id                  number(15)
  ,format_name                     varchar2(80)
  ,legislation_code                varchar2(30)
  ,user_format_choice              varchar2(9)       -- Increased length
  ,format_mask                     varchar2(250)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_NAME_FORMATS';
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
