--------------------------------------------------------
--  DDL for Package CSI_COUNTER_TEMPLATE_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CSI_COUNTER_TEMPLATE_VUHK" AUTHID CURRENT_USER AS
/* $Header: csivhcts.pls 120.3 2005/09/19 13:03:41 epajaril noship $ */
...
G_FILE_NAME CONSTANT VARCHAR2(12) := 'csivhcts.pls';
