--------------------------------------------------------
--  DDL for Package ITG_DEBUG_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ITG_DEBUG_PUB" AUTHID CURRENT_USER AS
/* $Header: ITGDBGS.pls 120.0 2005/12/22 04:19:46 bsaratna noship $ */
/*#
* Debug API for ITG transactions
* @rep:scope private
* @rep:product ITG
* @rep:displayname Debug transactions
* @rep:category BUSINESS_ENTITY  ITG_TRADING_PARTNER_COLL
* @rep:compatibility  S
* @rep:lifecycle  active
*/
--  Constants used as tokens for unexpected error Debugs.

    G_PKG_NAME  CONSTANT    VARCHAR2(15):=  'ITG_DEBUG_PUB';
