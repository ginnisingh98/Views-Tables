--------------------------------------------------------
--  DDL for Package BEN_EOM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EOM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_optd_mdcr_prte_id            number(15),
  effective_start_date              date,
  effective_end_date                date,
  optd_mdcr_flag                    varchar2(30),
  exlcd_flag                        varchar2(30),
  eligy_prfl_id                     number(15),
  business_group_id                 number(15),
  eom_attribute_category            varchar2(30),
  eom_attribute1                    varchar2(150),
  eom_attribute2                    varchar2(150),
  eom_attribute3                    varchar2(150),
  eom_attribute4                    varchar2(150),
  eom_attribute5                    varchar2(150),
  eom_attribute6                    varchar2(150),
  eom_attribute7                    varchar2(150),
  eom_attribute8                    varchar2(150),
  eom_attribute9                    varchar2(150),
  eom_attribute10                   varchar2(150),
  eom_attribute11                   varchar2(150),
  eom_attribute12                   varchar2(150),
  eom_attribute13                   varchar2(150),
  eom_attribute14                   varchar2(150),
  eom_attribute15                   varchar2(150),
  eom_attribute16                   varchar2(150),
  eom_attribute17                   varchar2(150),
  eom_attribute18                   varchar2(150),
  eom_attribute19                   varchar2(150),
  eom_attribute20                   varchar2(150),
  eom_attribute21                   varchar2(150),
  eom_attribute22                   varchar2(150),
  eom_attribute23                   varchar2(150),
  eom_attribute24                   varchar2(150),
  eom_attribute25                   varchar2(150),
  eom_attribute26                   varchar2(150),
  eom_attribute27                   varchar2(150),
  eom_attribute28                   varchar2(150),
  eom_attribute29                   varchar2(150),
  eom_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_optd_mdcr_prte_id).
--
-- Post Success:
--   Processing continues.
--
