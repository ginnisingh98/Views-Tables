--------------------------------------------------------
--  DDL for Package PQH_SAT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_SAT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  special_attribute_id              number(10),
  txn_category_attribute_id         number(15),
  attribute_type_cd                 varchar2(30),
  key_attribute_type                 varchar2(30),
  enable_flag                 varchar2(10),
  flex_code                         varchar2(30),
  object_version_number             number(9),
  ddf_column_name                   varchar2(30),
  ddf_value_column_name             varchar2(30),
  context                           varchar2(27)
  );
--
-- ----------------------------------------------------------------------------
