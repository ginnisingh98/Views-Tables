--------------------------------------------------------
--  DDL for Package BEN_CCP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CCP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  cvrd_dpnt_ctfn_prvdd_id           number(15),
  effective_start_date              date,
  effective_end_date                date,
  dpnt_dsgn_ctfn_typ_cd             varchar2(30),
  dpnt_dsgn_ctfn_rqd_flag           varchar2(30),
  dpnt_dsgn_ctfn_recd_dt            date,
  elig_cvrd_dpnt_id                 number(15),
  prtt_enrt_actn_id                 number(15),
  business_group_id                 number(15),
  ccp_attribute_category            varchar2(30),
  ccp_attribute1                    varchar2(150),
  ccp_attribute2                    varchar2(150),
  ccp_attribute3                    varchar2(150),
  ccp_attribute4                    varchar2(150),
  ccp_attribute5                    varchar2(150),
  ccp_attribute6                    varchar2(150),
  ccp_attribute7                    varchar2(150),
  ccp_attribute8                    varchar2(150),
  ccp_attribute9                    varchar2(150),
  ccp_attribute10                   varchar2(150),
  ccp_attribute11                   varchar2(150),
  ccp_attribute12                   varchar2(150),
  ccp_attribute13                   varchar2(150),
  ccp_attribute14                   varchar2(150),
  ccp_attribute15                   varchar2(150),
  ccp_attribute16                   varchar2(150),
  ccp_attribute17                   varchar2(150),
  ccp_attribute18                   varchar2(150),
  ccp_attribute19                   varchar2(150),
  ccp_attribute20                   varchar2(150),
  ccp_attribute21                   varchar2(150),
  ccp_attribute22                   varchar2(150),
  ccp_attribute23                   varchar2(150),
  ccp_attribute24                   varchar2(150),
  ccp_attribute25                   varchar2(150),
  ccp_attribute26                   varchar2(150),
  ccp_attribute27                   varchar2(150),
  ccp_attribute28                   varchar2(150),
  ccp_attribute29                   varchar2(150),
  ccp_attribute30                   varchar2(150),
...
--           p_base_key_value = :cvrd_dpnt_ctfn_prvdd_id).
--
-- Post Success:
--   Processing continues.
--
