--------------------------------------------------------
--  DDL for Package BEN_EHW_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EHW_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_hrs_wkd_prte_id              number(15),
  ...
  ordr_num                          number(15),
  excld_flag                        varchar2(9),      -- Increased length
  ehw_attribute_category            varchar2(30),
  ehw_attribute1                    varchar2(150),
  ehw_attribute2                    varchar2(150),
  ehw_attribute3                    varchar2(150),
  ehw_attribute4                    varchar2(150),
  ehw_attribute5                    varchar2(150),
  ehw_attribute6                    varchar2(150),
  ehw_attribute7                    varchar2(150),
  ehw_attribute8                    varchar2(150),
  ehw_attribute9                    varchar2(150),
  ehw_attribute10                   varchar2(150),
  ehw_attribute11                   varchar2(150),
  ehw_attribute12                   varchar2(150),
  ehw_attribute13                   varchar2(150),
  ehw_attribute14                   varchar2(150),
  ehw_attribute15                   varchar2(150),
  ehw_attribute16                   varchar2(150),
  ehw_attribute17                   varchar2(150),
  ehw_attribute18                   varchar2(150),
  ehw_attribute19                   varchar2(150),
  ehw_attribute20                   varchar2(150),
  ehw_attribute21                   varchar2(150),
  ehw_attribute22                   varchar2(150),
  ehw_attribute23                   varchar2(150),
  ehw_attribute24                   varchar2(150),
  ehw_attribute25                   varchar2(150),
  ehw_attribute26                   varchar2(150),
  ehw_attribute27                   varchar2(150),
  ehw_attribute28                   varchar2(150),
  ehw_attribute29                   varchar2(150),
  ehw_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_hrs_wkd_prte_id).
--
-- Post Success:
--   Processing continues.
--
