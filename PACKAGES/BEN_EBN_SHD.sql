--------------------------------------------------------
--  DDL for Package BEN_EBN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EBN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_benfts_grp_prte_id           number(15),
  ...
  ebn_attribute_category            varchar2(30),
  ebn_attribute1                    varchar2(150),
  ebn_attribute2                    varchar2(150),
  ebn_attribute3                    varchar2(150),
  ebn_attribute4                    varchar2(150),
  ebn_attribute5                    varchar2(150),
  ebn_attribute6                    varchar2(150),
  ebn_attribute7                    varchar2(150),
  ebn_attribute8                    varchar2(150),
  ebn_attribute9                    varchar2(150),
  ebn_attribute10                   varchar2(150),
  ebn_attribute11                   varchar2(150),
  ebn_attribute12                   varchar2(150),
  ebn_attribute13                   varchar2(150),
  ebn_attribute14                   varchar2(150),
  ebn_attribute15                   varchar2(150),
  ebn_attribute16                   varchar2(150),
  ebn_attribute17                   varchar2(150),
  ebn_attribute18                   varchar2(150),
  ebn_attribute19                   varchar2(150),
  ebn_attribute20                   varchar2(150),
  ebn_attribute21                   varchar2(150),
  ebn_attribute22                   varchar2(150),
  ebn_attribute23                   varchar2(150),
  ebn_attribute24                   varchar2(150),
  ebn_attribute25                   varchar2(150),
  ebn_attribute26                   varchar2(150),
  ebn_attribute27                   varchar2(150),
  ebn_attribute28                   varchar2(150),
  ebn_attribute29                   varchar2(150),
  ebn_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_benfts_grp_prte_id).
--
-- Post Success:
--   Processing continues.
--
