--------------------------------------------------------
--  DDL for Package OKC_STD_ARTICLE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_STD_ARTICLE_PVT" AUTHID CURRENT_USER as
/* $Header: OKCCSAES.pls 120.0 2005/05/25 19:40:59 appldev noship $ */
 subtype saev_rec_type is okc_sae_pvt.saev_rec_type;
 subtype saev_tbl_type is okc_sae_pvt.saev_tbl_type;

 subtype savv_rec_type is okc_sav_pvt.savv_rec_type;
 subtype savv_tbl_type is okc_sav_pvt.savv_tbl_type;

 subtype saiv_rec_type is okc_sai_pvt.saiv_rec_type;
 subtype saiv_tbl_type is okc_sai_pvt.saiv_tbl_type;

 subtype samv_rec_type is okc_sam_pvt.samv_rec_type;
 subtype samv_tbl_type is okc_sam_pvt.samv_tbl_type;

 subtype sacv_rec_type is okc_sac_pvt.sacv_rec_type;
 subtype sacv_tbl_type is okc_sac_pvt.sacv_tbl_type;


  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_UNEXPECTED_ERROR           CONSTANT   varchar2(200) := 'OKC_UNEXPECTED_ERROR';
  G_PKG_NAME			CONSTANT VARCHAR2(200) := 'OKC_STD_ARTICLE_PVT';
  ...
  G_CHILD_DELETE           CONSTANT   varchar2(200) := 'OKC_CANNOT_DELETE_MASTER';
...
-- Function Signature for the new API function
