--------------------------------------------------------
--  DDL for Package OTA_RESOURCE_USAGE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_RESOURCE_USAGE_BK2" AUTHID CURRENT_USER as
/* $Header: otrudapi.pkh 120.1 2005/10/02 02:07:53 aroussel $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ota_resource_usage_bk2.';
--
-- ----------------------------------------------------------------------------
-- |-------------------------< Update_resource_b >----------------------------|
-- ----------------------------------------------------------------------------
