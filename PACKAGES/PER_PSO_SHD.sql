--------------------------------------------------------
--  DDL for Package PER_PSO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PSO_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,security_organization_id        number(15)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_SECURITY_ORGANIZATIONS';
