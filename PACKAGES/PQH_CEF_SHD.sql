--------------------------------------------------------
--  DDL for Package PQH_CEF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CEF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  copy_entity_function_id           number(15),
  table_route_id                    number(15),
  function_type_cd                  varchar2(30),
  pre_copy_function_name            varchar2(4000),
  copy_function_name                varchar2(4000),
  post_copy_function_name           varchar2(4000),
