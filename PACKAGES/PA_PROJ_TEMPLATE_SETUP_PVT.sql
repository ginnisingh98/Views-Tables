--------------------------------------------------------
--  DDL for Package PA_PROJ_TEMPLATE_SETUP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PA_PROJ_TEMPLATE_SETUP_PVT" AUTHID CURRENT_USER AS
/* $Header: PATMSTVS.pls 120.2 2005/08/19 17:04:30 mwasowic noship $ */
...
PROCEDURE Update_Quick_Entry_Field(
 ...
 p_limiting_value         IN    VARCHAR2    := 'JUNK_CHARS',
 p_prompt               IN  VARCHAR2,
 p_required_flag          IN    VARCHAR2       :='N',  -- bug 2463257
 p_record_version_number IN NUMBER,
 x_return_status          OUT   NOCOPY VARCHAR2, --File.Sql.39 bug 4440895
 x_msg_count          OUT   NOCOPY NUMBER, --File.Sql.39 bug 4440895
 x_msg_data             OUT     NOCOPY VARCHAR2 --File.Sql.39 bug 4440895
