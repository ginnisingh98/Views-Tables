--------------------------------------------------------
--  DDL for Package IGS_PS_VER_NOTE_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PS_VER_NOTE_PKG" AUTHID CURRENT_USER AS
 /* $Header: IGSPI44S.pls 115.3 2002/11/29 02:28:40 nsidana ship $ */
