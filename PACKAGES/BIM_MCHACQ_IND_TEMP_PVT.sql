--------------------------------------------------------
--  DDL for Package BIM_MCHACQ_IND_TEMP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BIM_MCHACQ_IND_TEMP_PVT" AUTHID CURRENT_USER AS
/* $Header: bimvnqis.pls 115.2 2000/03/03 20:36:22 pkm ship  $ */
