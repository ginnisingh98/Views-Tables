--------------------------------------------------------
--  DDL for Package CN_RULE_PUB_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CN_RULE_PUB_CUHK" AUTHID CURRENT_USER as
-- $Header: cncrules.pls 120.1 2005/06/20 17:40:39 appldev ship $
