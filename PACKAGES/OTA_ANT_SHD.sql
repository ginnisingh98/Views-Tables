--------------------------------------------------------
--  DDL for Package OTA_ANT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_ANT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (announcement_id                 number(15)
  ,language                        varchar2(9)       -- Increased length
  ,source_lang                     varchar2(9)       -- Increased length
  ,announcement_title              varchar2(240)
  ,announcement_body               varchar2(4000)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_ANNOUNCEMENTS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
