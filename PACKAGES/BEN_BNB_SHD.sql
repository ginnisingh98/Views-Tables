--------------------------------------------------------
--  DDL for Package BEN_BNB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BNB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  name                              varchar2(240),
  bnfts_bal_usg_cd                  varchar2(30),
  bnfts_bal_desc                    varchar2(240),
  uom                               varchar2(30),
  nnmntry_uom                       varchar2(30),
  business_group_id                 number(15),
  bnb_attribute_category            varchar2(30),
  bnb_attribute1                    varchar2(150),
  bnb_attribute2                    varchar2(150),
  bnb_attribute3                    varchar2(150),
  bnb_attribute4                    varchar2(150),
  bnb_attribute5                    varchar2(150),
  bnb_attribute6                    varchar2(150),
  bnb_attribute7                    varchar2(150),
  bnb_attribute8                    varchar2(150),
  bnb_attribute9                    varchar2(150),
  bnb_attribute10                   varchar2(150),
  bnb_attribute11                   varchar2(150),
  bnb_attribute12                   varchar2(150),
  bnb_attribute13                   varchar2(150),
  bnb_attribute14                   varchar2(150),
  bnb_attribute15                   varchar2(150),
  bnb_attribute16                   varchar2(150),
  bnb_attribute17                   varchar2(150),
  bnb_attribute18                   varchar2(150),
  bnb_attribute19                   varchar2(150),
  bnb_attribute20                   varchar2(150),
  bnb_attribute21                   varchar2(150),
  bnb_attribute22                   varchar2(150),
  bnb_attribute23                   varchar2(150),
  bnb_attribute24                   varchar2(150),
  bnb_attribute25                   varchar2(150),
  bnb_attribute26                   varchar2(150),
  bnb_attribute27                   varchar2(150),
  bnb_attribute28                   varchar2(150),
  bnb_attribute29                   varchar2(150),
  bnb_attribute30                   varchar2(150),
