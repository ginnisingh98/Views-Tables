--------------------------------------------------------
--  DDL for Package OKL_DEAL_CREATE_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_DEAL_CREATE_PUB" AUTHID CURRENT_USER AS
/* $Header: OKLPDCRS.pls 120.5 2006/11/13 07:32:40 dpsingh noship $ */
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME			CONSTANT VARCHAR2(200) :=  'OKL_DEAL_CREATE_PVT';
...
/*  PROCEDURE validate_deal(
    ...
    p_contract_number              IN  VARCHAR2,
    p_scs_code                     IN  VARCHAR2,
    p_customer_id1                 IN OUT VARCHAR2,
    p_customer_id2                 IN OUT VARCHAR2,
    p_customer_code                IN OUT VARCHAR2,
    p_customer_name                IN  VARCHAR2,
    p_customer_acc_id1             IN OUT VARCHAR2,
    p_customer_acc_id2             IN OUT VARCHAR2,
    p_customer_acc_code            IN OUT VARCHAR2,
    p_customer_acc_name            IN  VARCHAR2,
    p_product_name                 IN  VARCHAR2,
    p_product_id                   IN OUT VARCHAR2
    );
*/
