--------------------------------------------------------
--  DDL for Package PAY_FED_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_FED_SHD" AUTHID CURRENT_USER AS
...
Type g_rec_type Is Record
  (
  emp_fed_tax_rule_id               number(9),
  effective_start_date              date,
  effective_end_date                date,
  assignment_id                     number(9),
  sui_state_code                    varchar2(9),      -- Increased length
  sui_jurisdiction_code             varchar2(11),
  business_group_id                 number(15),
  additional_wa_amount              number(11,2),
  filing_status_code                varchar2(30),
  fit_override_amount               number(11,2),
  fit_override_rate                 number(11,2),      -- Increased length
  withholding_allowances            number(11),        -- Increased length
  cumulative_taxation               varchar2(30),
  eic_filing_status_code            varchar2(30),
  fit_additional_tax                number(11,2),
  fit_exempt                        varchar2(30),
  futa_tax_exempt                   varchar2(30),
  medicare_tax_exempt               varchar2(30),
  ss_tax_exempt                     varchar2(30),
  wage_exempt                       varchar2(30),
  statutory_employee                varchar2(30),
  w2_filed_year                     number(11),        -- Increased length
  supp_tax_override_rate            number(11,2),      -- Increased length
  excessive_wa_reject_date          date,
  ...
  fed_information_category                varchar2(30),
  fed_information1                        varchar2(150),
  fed_information2                        varchar2(150),
  fed_information3                        varchar2(150),
  fed_information4                        varchar2(150),
  fed_information5                        varchar2(150),
  fed_information6                        varchar2(150),
  fed_information7                        varchar2(150),
  fed_information8                        varchar2(150),
  fed_information9                        varchar2(150),
  fed_information10                       varchar2(150),
  fed_information11                       varchar2(150),
  fed_information12                       varchar2(150),
  fed_information13                       varchar2(150),
  fed_information14                       varchar2(150),
  fed_information15                       varchar2(150),
  fed_information16                       varchar2(150),
  fed_information17                       varchar2(150),
  fed_information18                       varchar2(150),
  fed_information19                       varchar2(150),
  fed_information20                       varchar2(150),
  fed_information21                       varchar2(150),
  fed_information22                       varchar2(150),
  fed_information23                      varchar2(150),
  fed_information24                      varchar2(150),
  fed_information25                       varchar2(150),
  fed_information26                       varchar2(150),
  fed_information27                       varchar2(150),
  fed_information28                       varchar2(150),
  fed_information29                       varchar2(150),
  fed_information30                       varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :emp_fed_tax_rule_id).
--
-- Post Success:
--   Processing continues.
--
