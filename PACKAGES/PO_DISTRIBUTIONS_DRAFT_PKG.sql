--------------------------------------------------------
--  DDL for Package PO_DISTRIBUTIONS_DRAFT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PO_DISTRIBUTIONS_DRAFT_PKG" AUTHID CURRENT_USER AS
/* $Header: PO_DISTRIBUTIONS_DRAFT_PKG.pls 120.1 2005/06/30 17:27 bao noship $ */
