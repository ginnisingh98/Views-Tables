--------------------------------------------------------
--  DDL for Package PER_PCL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PCL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,mandatory                       varchar2(9)       -- Increased length
  ,value                           varchar2(240)
...
--
--  Description:
--    Returns FALSE if the category is either Pay Scales, Position or Process
--    as for these categories the VALUE field is not used.
--
--  Prerequisites:
--
--  In Arguments:
...
FUNCTION non_value_category
  (p_category_name IN VARCHAR2) RETURN BOOLEAN;
--
-- ---------------------------------------------------------------------------
-- |----------------------------< retrieve_cagr_info >------------------------|
-- ---------------------------------------------------------------------------
...
--
--  Description:
--    Retrieves the collective_agreement_id and business_group_id that
--    the entitlement line is linked to.
--
--  Prerequisites:
--
--  In Arguments:
...
--
-- ---------------------------------------------------------------------------
-- |--------------------< retrieve_entitlement_item_info >---------------------|
-- ---------------------------------------------------------------------------
-- {Start Of Comments}
--
--  Description:
--    Retrieves the entitlement item id and category name
--    for the entitlement item that the entitlement record is linked to
--
--  Prerequisites:
--
--  In Arguments:
...
--
--  Post Success:
--    Returns cagr_entitlement_item_id, category_name
--
--  Post Failure:
--    An error is raised if the procedure cannont retrieve the requried
--    rows.
--
--  Access Status:
--    Internal Development Use Only.
...
PROCEDURE retrieve_entitlement_item_info
  ...
  ,p_formula_criteria            OUT NOCOPY VARCHAR2);
--
-- ---------------------------------------------------------------------------
...
--
--  Description:
--    Retrieves the flex_value_set_id for a given entitlement item
--
--  Prerequisites:
--
--  In Arguments:
...
FUNCTION retrieve_value_set_id
  (p_cagr_entitlement_item_id IN
     per_cagr_entitlements.cagr_entitlement_item_id%TYPE)
  RETURN NUMBER;
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
...
--           p_base_key_value = :cagr_entitlement_line_id).
--
-- Post Success:
