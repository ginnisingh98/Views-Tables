--------------------------------------------------------
--  DDL for Package QP_MODIFIERS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."QP_MODIFIERS_PUB" AUTHID CURRENT_USER AS
/* $Header: QPXPMLSS.pls 120.3 2006/02/22 21:48:49 prarasto ship $ */
/*#
 * This package consists of entities to set up modifiers.
 *
 * @rep:scope public
 * @rep:product QP
 * @rep:displayname Modifier Setup
...
,   list_source_code              VARCHAR2(30)   := FND_API.G_MISS_CHAR -- Blanket Pricing
,   orig_system_header_ref        VARCHAR2(50)   := FND_API.G_MISS_CHAR -- Blanket Pricing
,   shareable_flag                VARCHAR2(1)    := FND_API.G_MISS_CHAR -- Blanket Pricing
...
,   list_source_code              VARCHAR2(240)  := FND_API.G_MISS_CHAR -- Blanket Pricing
);
...
,   db_flag                       VARCHAR2(1)    := FND_API.G_MISS_CHAR
,   operation                     VARCHAR2(30)   := FND_API.G_MISS_CHAR
,   Modifier_parent_index          NUMBER         := FND_API.G_MISS_NUM
,   qualification_ind              NUMBER         := FND_API.G_MISS_NUM
,   net_amount_flag               VARCHAR2(1)    := FND_API.G_MISS_CHAR
,   accum_attribute               VARCHAR2(240)  := FND_API.G_MISS_CHAR
,   continuous_price_break_flag   VARCHAR2(1)    := FND_API.G_MISS_CHAR
);
...
,   list_header			    VARCHAR2(240)  := FND_API.G_MISS_CHAR
,   pricing_phase			    VARCHAR2(240)  := FND_API.G_MISS_CHAR
);
...
/*#
 * Use this API to create, update, and delete modifiers.
 *
 ...
 * @param p_MODIFIER_LIST_rec the input record corresponding to the columns in
 *        the modifier header tables QP_LIST_HEADERS_B and
 *        QP_LIST_HEADERS_TL
 * @param p_MODIFIER_LIST_val_rec the input record for the modifier header values
 * @param p_MODIFIERS_tbl the input table used to set up multiple modifier lines
 *        by giving multiple modifier definitions
 * @param p_MODIFIERS_val_tbl the input table for the modifier definition values
 ...
 *        definition values
 * @param x_MODIFIER_LIST_rec the output record for the modifier list header
 *        definition
 * @param x_MODIFIER_LIST_val_rec the output record for the modifier list header
 *        values
 * @param x_MODIFIERS_tbl the output table for the modifier definition
 * @param x_MODIFIERS_val_tbl the output table for the modifier values
 ...
 *        values
 *
 * @rep:displayname Process Modifier
 */
