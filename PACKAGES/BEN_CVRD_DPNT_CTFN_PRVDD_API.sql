--------------------------------------------------------
--  DDL for Package BEN_CVRD_DPNT_CTFN_PRVDD_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CVRD_DPNT_CTFN_PRVDD_API" AUTHID CURRENT_USER as
...
--   p_dpnt_dsgn_ctfn_typ_cd        Yes  varchar2
--   p_dpnt_dsgn_ctfn_rqd_flag      Yes  varchar2
--   p_dpnt_dsgn_ctfn_recd_dt       No   date
--   p_elig_cvrd_dpnt_id            Yes  number
--   p_prtt_enrt_actn_id            Yes  number
--   p_business_group_id            Yes  number    Business Group of Record
--   p_ccp_attribute_category       No   varchar2  Descriptive Flexfield
--   p_ccp_attribute1               No   varchar2  Descriptive Flexfield
--   p_ccp_attribute2               No   varchar2  Descriptive Flexfield
--   p_ccp_attribute3               No   varchar2  Descriptive Flexfield
--   p_ccp_attribute4               No   varchar2  Descriptive Flexfield
--   p_ccp_attribute5               No   varchar2  Descriptive Flexfield
--   p_ccp_attribute6               No   varchar2  Descriptive Flexfield
--   p_ccp_attribute7               No   varchar2  Descriptive Flexfield
--   p_ccp_attribute8               No   varchar2  Descriptive Flexfield
--   p_ccp_attribute9               No   varchar2  Descriptive Flexfield
--   p_ccp_attribute10              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute11              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute12              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute13              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute14              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute15              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute16              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute17              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute18              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute19              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute20              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute21              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute22              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute23              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute24              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute25              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute26              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute27              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute28              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute29              No   varchar2  Descriptive Flexfield
--   p_ccp_attribute30              No   varchar2  Descriptive Flexfield
...
--   p_cvrd_dpnt_ctfn_prvdd_id      Yes  number    PK of record
...
--
-- Overloaded Procedure Bug 2386000
--
procedure delete_CVRD_DPNT_CTFN_PRVDD
  (
   p_validate                       in boolean        default false
