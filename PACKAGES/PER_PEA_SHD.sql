--------------------------------------------------------
--  DDL for Package PER_PEA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PEA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  person_id                         per_person_analyses.person_id%TYPE,
  /* Fix for the bug 6895989 starts here*/
 -- comments                          varchar2(2000),
  comments			    long,
  /*Fix for the bug 6895989 ends here*/
  date_from                         date,
  date_to                           date,
  id_flex_num                       number,
...
g_tab_nam  constant varchar2(30) :='PER_PERSON_ANALYSES';
--
-- ----------------------------------------------------------------------------
