--------------------------------------------------------
--  DDL for Package PER_ENT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ENT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,type                            varchar2(30)
  ,start_date                      date
  ,start_hour                      varchar2(30)
  ,start_min                       varchar2(30)
  ,end_date                        date
  ,end_hour                        varchar2(30)
  ,end_min                         varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_CALENDAR_ENTRIES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
