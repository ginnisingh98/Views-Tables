--------------------------------------------------------
--  DDL for Package BEN_AGF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_AGF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_age_fctr_id already exists.
--
--  In Arguments:
--    p_age_fctr_id
--
...
function return_legislation_code
  (p_age_fctr_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
