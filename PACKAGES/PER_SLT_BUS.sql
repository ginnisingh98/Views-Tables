--------------------------------------------------------
--  DDL for Package PER_SLT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SLT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_solution_type_name
--     already exists.
--
--  In Arguments:
