--------------------------------------------------------
--  DDL for Package BEN_ELIG_MRTL_STS_PRTE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_MRTL_STS_PRTE_BK2" AUTHID CURRENT_USER as
/* $Header: beempapi.pkh 120.0 2005/05/28 02:25:28 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_elig_mrtl_sts_prte_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_elig_mrtl_sts_prte_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_elig_mrtl_sts_prte_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_elig_mrtl_sts_prte_a
  (
   p_elig_mrtl_sts_prte_id          in  number
...
--
end ben_elig_mrtl_sts_prte_bk2;
