--------------------------------------------------------
--  DDL for Package HR_AVM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_AVM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (ath_variablemap_id              number(15)
  ,ath_dsn                         varchar2(200)
  ,ath_tablename                   varchar2(30)
  ,ath_columnname                  varchar2(30)
  ,ath_varname                     varchar2(255)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_ATH_VARIABLEMAP';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
