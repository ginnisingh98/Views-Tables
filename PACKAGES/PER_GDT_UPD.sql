--------------------------------------------------------
--  DDL for Package PER_GDT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_GDT_UPD" AUTHID CURRENT_USER as
...
--
-- Description:
--   This will update all rows for the specified ID for lanugages. It will
--   translate the for key flex meaning for each language.
--
-- Pre-requisites:
--   A unique surrogate key ID value is known to exist in the
