--------------------------------------------------------
--  DDL for Package BEN_ESP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ESP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_sp_clng_prg_prte_id          number(15),
  ...
  esp_attribute_category            varchar2(30),
  esp_attribute1                    varchar2(150),
  esp_attribute2                    varchar2(150),
  esp_attribute3                    varchar2(150),
  esp_attribute4                    varchar2(150),
  esp_attribute5                    varchar2(150),
  esp_attribute6                    varchar2(150),
  esp_attribute7                    varchar2(150),
  esp_attribute8                    varchar2(150),
  esp_attribute9                    varchar2(150),
  esp_attribute10                   varchar2(150),
  esp_attribute11                   varchar2(150),
  esp_attribute12                   varchar2(150),
  esp_attribute13                   varchar2(150),
  esp_attribute14                   varchar2(150),
  esp_attribute15                   varchar2(150),
  esp_attribute16                   varchar2(150),
  esp_attribute17                   varchar2(150),
  esp_attribute18                   varchar2(150),
  esp_attribute19                   varchar2(150),
  esp_attribute20                   varchar2(150),
  esp_attribute21                   varchar2(150),
  esp_attribute22                   varchar2(150),
  esp_attribute23                   varchar2(150),
  esp_attribute24                   varchar2(150),
  esp_attribute25                   varchar2(150),
  esp_attribute26                   varchar2(150),
  esp_attribute27                   varchar2(150),
  esp_attribute28                   varchar2(150),
  esp_attribute29                   varchar2(150),
  esp_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_sp_clng_prg_prte_id).
--
-- Post Success:
--   Processing continues.
--
