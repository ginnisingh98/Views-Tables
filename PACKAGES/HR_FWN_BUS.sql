--------------------------------------------------------
--  DDL for Package HR_FWN_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FWN_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_form_window_id already exists.
--
--  In Arguments:
--    p_form_window_id
--
