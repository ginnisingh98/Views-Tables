--------------------------------------------------------
--  DDL for Package HXC_TER_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_TER_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (time_entry_rule_id           number(15)
  ,name                            varchar2(80)
  ,business_group_id		   number(15)
  ,legislation_code		   varchar2(30)
  ,rule_usage                      varchar2(30)       -- Increased length
