--------------------------------------------------------
--  DDL for Package BEN_LNC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LNC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_enrt_ctfn_id                  number(15),
  effective_start_date              date,
  effective_end_date                date,
  rqd_flag                          varchar2(30),
  enrt_ctfn_typ_cd                  varchar2(30),
  ctfn_rqd_when_rl                  number(15),
  ler_rqrs_enrt_ctfn_id             number(15),
  business_group_id                 number(15),
  lnc_attribute_category            varchar2(30),
  lnc_attribute1                    varchar2(150),
  lnc_attribute2                    varchar2(150),
  lnc_attribute3                    varchar2(150),
  lnc_attribute4                    varchar2(150),
  lnc_attribute5                    varchar2(150),
  lnc_attribute6                    varchar2(150),
  lnc_attribute7                    varchar2(150),
  lnc_attribute8                    varchar2(150),
  lnc_attribute9                    varchar2(150),
  lnc_attribute10                   varchar2(150),
  lnc_attribute11                   varchar2(150),
  lnc_attribute12                   varchar2(150),
  lnc_attribute13                   varchar2(150),
  lnc_attribute14                   varchar2(150),
  lnc_attribute15                   varchar2(150),
  lnc_attribute16                   varchar2(150),
  lnc_attribute17                   varchar2(150),
  lnc_attribute18                   varchar2(150),
  lnc_attribute19                   varchar2(150),
  lnc_attribute20                   varchar2(150),
  lnc_attribute21                   varchar2(150),
  lnc_attribute22                   varchar2(150),
  lnc_attribute23                   varchar2(150),
  lnc_attribute24                   varchar2(150),
  lnc_attribute25                   varchar2(150),
  lnc_attribute26                   varchar2(150),
  lnc_attribute27                   varchar2(150),
  lnc_attribute28                   varchar2(150),
  lnc_attribute29                   varchar2(150),
  lnc_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_enrt_ctfn_id).
--
-- Post Success:
--   Processing continues.
--
