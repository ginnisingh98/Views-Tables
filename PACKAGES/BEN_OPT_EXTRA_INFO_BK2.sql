--------------------------------------------------------
--  DDL for Package BEN_OPT_EXTRA_INFO_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_OPT_EXTRA_INFO_BK2" AUTHID CURRENT_USER as
/* $Header: beopiapi.pkh 120.0 2005/05/28 09:52:55 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |----------------------< update_opt_extra_info_b >----------------------|
-- ----------------------------------------------------------------------------
Procedure update_opt_extra_info_b	(
...
-- |----------------------< update_opt_extra_info_a >----------------------|

Procedure update_opt_extra_info_a
	(
		p_opt_extra_info_id		in	number	,
		p_opi_attribute_category	in	varchar2	,
		p_opi_attribute1			in	varchar2	,
