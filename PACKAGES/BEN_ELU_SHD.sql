--------------------------------------------------------
--  DDL for Package BEN_ELU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_lbr_mmbr_prte_id             number(15),
  ...
  elu_attribute_category            varchar2(30),
  elu_attribute1                    varchar2(150),
  elu_attribute2                    varchar2(150),
  elu_attribute3                    varchar2(150),
  elu_attribute4                    varchar2(150),
  elu_attribute5                    varchar2(150),
  elu_attribute6                    varchar2(150),
  elu_attribute7                    varchar2(150),
  elu_attribute8                    varchar2(150),
  elu_attribute9                    varchar2(150),
  elu_attribute10                   varchar2(150),
  elu_attribute11                   varchar2(150),
  elu_attribute12                   varchar2(150),
  elu_attribute13                   varchar2(150),
  elu_attribute14                   varchar2(150),
  elu_attribute15                   varchar2(150),
  elu_attribute16                   varchar2(150),
  elu_attribute17                   varchar2(150),
  elu_attribute18                   varchar2(150),
  elu_attribute19                   varchar2(150),
  elu_attribute20                   varchar2(150),
  elu_attribute21                   varchar2(150),
  elu_attribute22                   varchar2(150),
  elu_attribute23                   varchar2(150),
  elu_attribute24                   varchar2(150),
  elu_attribute25                   varchar2(150),
  elu_attribute26                   varchar2(150),
  elu_attribute27                   varchar2(150),
  elu_attribute28                   varchar2(150),
  elu_attribute29                   varchar2(150),
  elu_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_lbr_mmbr_prte_id).
--
-- Post Success:
--   Processing continues.
--
