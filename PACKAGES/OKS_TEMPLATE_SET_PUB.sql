--------------------------------------------------------
--  DDL for Package OKS_TEMPLATE_SET_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKS_TEMPLATE_SET_PUB" AUTHID CURRENT_USER AS
/* $Header: OKSPTMPS.pls 120.1 2005/07/14 16:52:31 skekkar noship $ */
 ---------------------------------------------------------------------------
 -- GLOBAL DATASTRUCTURES
 ---------------------------------------------------------------------------
 -- OKS_TEMPLATE_SET_V Record Spec
  SUBTYPE tmsv_rec_type IS OKS_TEMPLATE_SET_PVT.tmsv_rec_type;
  SUBTYPE tmsv_tbl_type IS OKS_TEMPLATE_SET_PVT.tmsv_tbl_type;
  SUBTYPE tms_rec_type IS OKS_TEMPLATE_SET_PVT.tms_rec_type;
  SUBTYPE tms_tbl_type IS OKS_TEMPLATE_SET_PVT.tms_tbl_type;
  ---------------------------------------------------------------------------
  ---------------------------------------------------------------------------
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME                     CONSTANT VARCHAR2(200) := 'OKS_TEMPLATE_SET_PUB';
