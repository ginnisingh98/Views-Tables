--------------------------------------------------------
--  DDL for Package PAY_RFM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_RFM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,report_format                   varchar2(30)
  ,effective_start_date            date
  ,effective_end_date              date
  ,range_code                      varchar2(60)
  ,assignment_action_code          varchar2(60)
  ,initialization_code             varchar2(60)
  ,archive_code                    varchar2(60)
  ,magnetic_code                   varchar2(60)
  ,report_category                 varchar2(30)
  ,report_name                     varchar2(60)
  ,sort_code                       varchar2(60)
  ,updatable_flag                  varchar2(9)       -- Increased length
  ,deinitialization_code           varchar2(60)
  ,report_format_mapping_id        number(15)
  ,business_group_id               number(15)
  ,legislation_code                varchar2(30)
  ,temporary_action_flag           varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_REPORT_FORMAT_MAPPINGS_F';
...
--           p_base_key_value = :report_format_mapping_id).
--
-- Post Success:
--   Processing continues.
--
...
--
-- Description:
--   This function is used to return the report_format_mapping_id of a
--   particular report format mapping from its true key - report_type,
--   report_qualifier and report_category.
--
-- Prerequisites:
--   None
--
...
--
-- Post Success:
--   Returns the report_format_mapping_id of the corresponding report format
--   mapping if it exists. If the report format mapping does not exists then
--   the function returns null.
--
-- Post Failure:
--   Failure might occur if the report_format_mapping_id is null
--   or there is a non unique report_format_mapping_id for the report format
--   mapping that is being referred. The errors are trapped and reported.
--
-- Developer Implementation Notes:
--   None
--
