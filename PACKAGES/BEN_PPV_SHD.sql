--------------------------------------------------------
--  DDL for Package BEN_PPV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PPV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  prtl_mo_rt_prtn_val_id            number(15),
  effective_end_date                date,
  effective_start_date              date,
  business_group_id                 number(15),
  rndg_cd                           varchar2(30),
  to_dy_mo_num                      number(15),
  from_dy_mo_num                    number(15),
  pct_val                           number,
  acty_base_rt_id                   number(15),
  strt_r_stp_cvg_cd                 varchar2(30),
  rndg_rl                           number(15),
  prtl_mo_prortn_rl                 number(15),
  actl_prem_id                      number(15),
  cvg_amt_calc_mthd_id              number(15),
  NUM_DAYS_MONTH                    number(15),
  PRORATE_BY_DAY_TO_MON_FLAG        varchar2(30),
  pmrpv_attribute_category          varchar2(30),
  pmrpv_attribute1                  varchar2(150),
  pmrpv_attribute2                  varchar2(150),
  pmrpv_attribute3                  varchar2(150),
  pmrpv_attribute4                  varchar2(150),
  pmrpv_attribute5                  varchar2(150),
  pmrpv_attribute6                  varchar2(150),
  pmrpv_attribute7                  varchar2(150),
  pmrpv_attribute8                  varchar2(150),
  pmrpv_attribute9                  varchar2(150),
  pmrpv_attribute10                 varchar2(150),
  pmrpv_attribute11                 varchar2(150),
  pmrpv_attribute12                 varchar2(150),
  pmrpv_attribute13                 varchar2(150),
  pmrpv_attribute14                 varchar2(150),
  pmrpv_attribute15                 varchar2(150),
  pmrpv_attribute16                 varchar2(150),
  pmrpv_attribute17                 varchar2(150),
  pmrpv_attribute18                 varchar2(150),
  pmrpv_attribute19                 varchar2(150),
  pmrpv_attribute20                 varchar2(150),
  pmrpv_attribute21                 varchar2(150),
  pmrpv_attribute22                 varchar2(150),
  pmrpv_attribute23                 varchar2(150),
  pmrpv_attribute24                 varchar2(150),
  pmrpv_attribute25                 varchar2(150),
  pmrpv_attribute26                 varchar2(150),
  pmrpv_attribute27                 varchar2(150),
  pmrpv_attribute28                 varchar2(150),
  pmrpv_attribute29                 varchar2(150),
  pmrpv_attribute30                 varchar2(150),
...
--           p_base_key_value = :prtl_mo_rt_prtn_val_id).
--
-- Post Success:
--   Processing continues.
--
