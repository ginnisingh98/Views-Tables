--------------------------------------------------------
--  DDL for Package GHR_CCL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CCL_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_compl_claim_id
--     already exists.
--
--  In Arguments:
--    p_compl_claim_id
