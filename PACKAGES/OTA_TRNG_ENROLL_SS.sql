--------------------------------------------------------
--  DDL for Package OTA_TRNG_ENROLL_SS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TRNG_ENROLL_SS" AUTHID CURRENT_USER as
/* $Header: ottrnenr.pkh 115.1 2003/05/08 13:14:22 dbatra noship $ */
