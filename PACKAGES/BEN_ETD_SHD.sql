--------------------------------------------------------
--  DDL for Package BEN_ETD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ETD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_dpnt_othr_ptip_id            number(15),
  ...
  etd_attribute_category            varchar2(30),
  etd_attribute1                    varchar2(150),
  etd_attribute2                    varchar2(150),
  etd_attribute3                    varchar2(150),
  etd_attribute4                    varchar2(150),
  etd_attribute5                    varchar2(150),
  etd_attribute6                    varchar2(150),
  etd_attribute7                    varchar2(150),
  etd_attribute8                    varchar2(150),
  etd_attribute9                    varchar2(150),
  etd_attribute10                   varchar2(150),
  etd_attribute11                   varchar2(150),
  etd_attribute12                   varchar2(150),
  etd_attribute13                   varchar2(150),
  etd_attribute14                   varchar2(150),
  etd_attribute15                   varchar2(150),
  etd_attribute16                   varchar2(150),
  etd_attribute17                   varchar2(150),
  etd_attribute18                   varchar2(150),
  etd_attribute19                   varchar2(150),
  etd_attribute20                   varchar2(150),
  etd_attribute21                   varchar2(150),
  etd_attribute22                   varchar2(150),
  etd_attribute23                   varchar2(150),
  etd_attribute24                   varchar2(150),
  etd_attribute25                   varchar2(150),
  etd_attribute26                   varchar2(150),
  etd_attribute27                   varchar2(150),
  etd_attribute28                   varchar2(150),
  etd_attribute29                   varchar2(150),
  etd_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_dpnt_othr_ptip_id).
--
-- Post Success:
--   Processing continues.
--
