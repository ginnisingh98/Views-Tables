--------------------------------------------------------
--  DDL for Package PAY_BAD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_BAD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,alterable                       varchar2(30)
  ,legislation_code                varchar2(30)
  ,business_group_id               number(15)
  ,user_attribute_name             varchar(240)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_BAL_ATTRIBUTE_DEFINITIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
