--------------------------------------------------------
--  DDL for Package IRC_PCV_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_PCV_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_prof_area_criteria_value_id
--     already exists.
--
--  In Arguments:
