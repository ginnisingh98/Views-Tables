--------------------------------------------------------
--  DDL for Package INV_DIAG_OH_SERIAL_STATUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."INV_DIAG_OH_SERIAL_STATUS" AUTHID CURRENT_USER AS
/* $Header: INVDOH2S.pls 120.0.12010000.1 2009/03/18 09:15:12 aambulka noship $ */
