--------------------------------------------------------
--  DDL for Package PQH_CRF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CRF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,parent_rate_matrix_id           number(15)
  ,parent_criteria_rate_defn_id    number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_CRITERIA_RATE_FACTORS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
