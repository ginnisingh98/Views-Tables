--------------------------------------------------------
--  DDL for Package GHR_CCL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CCL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (compl_claim_id                  number(15)
  ,complaint_id                    number(15)
  ,claim                           varchar2(30)       -- Increased length
  ,incident_date                   date
  ,phase                           varchar2(30)       -- Increased length
  ,mixed_flag                      varchar2(9)       -- Increased length
  ,claim_source                    varchar2(50)       -- Increased length
  ,agency_acceptance               varchar2(30)       -- Increased length
  ,aj_acceptance                   varchar2(30)       -- Increased length
  ,agency_appeal                   varchar2(9)
