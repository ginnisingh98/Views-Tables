--------------------------------------------------------
--  DDL for Package IGS_FI_REFUNDS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_FI_REFUNDS_PKG" AUTHID CURRENT_USER AS
/* $Header: IGSSIB4S.pls 120.1 2006/06/27 14:19:17 skharida noship $ */
  ...
  PROCEDURE before_dml (
    ...
    x_transfer_status                   IN     VARCHAR2    DEFAULT NULL,
    x_reversal_ind                      IN     VARCHAR2    DEFAULT NULL,
