--------------------------------------------------------
--  DDL for Package BEN_PERCENT_FT_FACTORS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PERCENT_FT_FACTORS_BK1" AUTHID CURRENT_USER as
/* $Header: bepffapi.pkh 120.0 2005/05/28 10:42:03 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_percent_ft_factors_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_percent_ft_factors_b
  (
   p_name                           in  varchar2
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_percent_ft_factors_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_percent_ft_factors_a
  (
...
--
end ben_percent_ft_factors_bk1;
