--------------------------------------------------------
--  DDL for Package PQP_PCV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_PCV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (configuration_value_id          number(10)
  ,business_group_id               number(15)
  ,legislation_code                varchar2(30)
  ,pcv_attribute_category          varchar2(30)
  ,pcv_attribute1                  varchar2(150)
  ,pcv_attribute2                  varchar2(150)
  ,pcv_attribute3                  varchar2(150)
  ,pcv_attribute4                  varchar2(150)
  ,pcv_attribute5                  varchar2(150)
  ,pcv_attribute6                  varchar2(150)
  ,pcv_attribute7                  varchar2(150)
  ,pcv_attribute8                  varchar2(150)
  ,pcv_attribute9                  varchar2(150)
  ,pcv_attribute10                 varchar2(150)
  ,pcv_attribute11                 varchar2(150)
  ,pcv_attribute12                 varchar2(150)
  ,pcv_attribute13                 varchar2(150)
  ,pcv_attribute14                 varchar2(150)
  ,pcv_attribute15                 varchar2(150)
  ,pcv_attribute16                 varchar2(150)
  ,pcv_attribute17                 varchar2(150)
  ,pcv_attribute18                 varchar2(150)
  ,pcv_attribute19                 varchar2(150)
  ,pcv_attribute20                 varchar2(150)
  ,pcv_information_category        varchar2(80)
  ,pcv_information1                varchar2(150)
  ,pcv_information2                varchar2(150)
  ,pcv_information3                varchar2(150)
  ,pcv_information4                varchar2(150)
  ,pcv_information5                varchar2(150)
  ,pcv_information6                varchar2(150)
  ,pcv_information7                varchar2(150)
  ,pcv_information8                varchar2(150)
  ,pcv_information9                varchar2(150)
  ,pcv_information10               varchar2(150)
  ,pcv_information11               varchar2(150)
  ,pcv_information12               varchar2(150)
  ,pcv_information13               varchar2(150)
  ,pcv_information14               varchar2(150)
  ,pcv_information15               varchar2(150)
  ,pcv_information16               varchar2(150)
  ,pcv_information17               varchar2(150)
  ,pcv_information18               varchar2(150)
  ,pcv_information19               varchar2(150)
  ,pcv_information20               varchar2(150)
  ,object_version_number           number(9)
  ,configuration_name              varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQP_CONFIGURATION_VALUES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
