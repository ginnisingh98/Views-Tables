--------------------------------------------------------
--  DDL for Package OZF_OFFR_QUAL_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_OFFR_QUAL_PVT_W" AUTHID CURRENT_USER as
  /* $Header: ozfwoqfs.pls 120.1 2005/09/22 16:02 rssharma noship $ */
