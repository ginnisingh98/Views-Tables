--------------------------------------------------------
--  DDL for Package PO_HEADERS_PKG_S0
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PO_HEADERS_PKG_S0" AUTHID CURRENT_USER as
/* $Header: POXP1PHS.pls 120.3.12010000.4 2010/09/07 07:05:57 smvinod ship $ */

/*===========================================================================
  PROCEDURE NAME:	Insert_row()


  DESCRIPTION:     Table Handler for Insert Row()
...
===============================================================================*/
/* bug 10017321: Changing specification of insert_row to include style_id with default NULL as value */
...
/* Ben bug#465696 created this procedure to resolve the performance problem.
       See POXPIHDB.pls for detailed explanation.
*/
