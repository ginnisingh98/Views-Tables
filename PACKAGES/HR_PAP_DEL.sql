--------------------------------------------------------
--  DDL for Package HR_PAP_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PAP_DEL" AUTHID CURRENT_USER as
/* $Header: hrpaprhi.pkh 115.1 99/07/17 05:36:37 porting ship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< del >----------------------------------|
-- ----------------------------------------------------------------------------
