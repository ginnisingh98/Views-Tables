--------------------------------------------------------
--  DDL for Package BEN_BRI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BRI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_batch_rt_id already exists.
--
--  In Arguments:
--    p_batch_rt_id
--
...
function return_legislation_code
  (p_batch_rt_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
