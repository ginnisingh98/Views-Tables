--------------------------------------------------------
--  DDL for Package HR_TIS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TIS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (topic_integrations_id         number(15)
  ,topic_id                      number(15)
  ,integration_id                number(15)
  ,param_name1                   varchar2(30)
  ,param_value1                  varchar2(150)
  ,param_name2                   varchar2(30)
  ,param_value2                  varchar2(150)
  ,param_name3                   varchar2(30)
  ,param_value3                  varchar2(150)
  ,param_name4                   varchar2(30)
  ,param_value4                  varchar2(150)
  ,param_name5                   varchar2(30)
  ,param_value5                  varchar2(150)
  ,param_name6                   varchar2(30)
  ,param_value6                  varchar2(150)
  ,param_name7                   varchar2(30)
  ,param_value7                  varchar2(150)
  ,param_name8                   varchar2(30)
  ,param_value8                  varchar2(150)
  ,param_name9                   varchar2(30)
  ,param_value9                  varchar2(150)
  ,param_name10                  varchar2(30)
  ,param_value10                 varchar2(150)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_KI_TOPIC_INTEGRATIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
