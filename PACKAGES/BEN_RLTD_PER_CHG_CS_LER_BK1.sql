--------------------------------------------------------
--  DDL for Package BEN_RLTD_PER_CHG_CS_LER_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_RLTD_PER_CHG_CS_LER_BK1" AUTHID CURRENT_USER as
/* $Header: berclapi.pkh 120.0 2005/05/28 11:35:00 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Rltd_Per_Chg_Cs_Ler_b >-----------------|
-- ----------------------------------------------------------------------------
--
