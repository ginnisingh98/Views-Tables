--------------------------------------------------------
--  DDL for Package BEN_PL_PRMRY_CARE_PRVDR_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PL_PRMRY_CARE_PRVDR_BK1" AUTHID CURRENT_USER as
/* $Header: bepcpapi.pkh 120.0 2005/05/28 10:13:08 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_pl_prmry_care_prvdr_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_pl_prmry_care_prvdr_b
  (
   p_pl_id                          in  number
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_pl_prmry_care_prvdr_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_pl_prmry_care_prvdr_a
  (
...
--
end ben_pl_prmry_care_prvdr_bk1;
