--------------------------------------------------------
--  DDL for Package PQH_BGT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_BGT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_budget_id already exists.
--
--  In Arguments:
--    p_budget_id
--
...
function return_legislation_code
  (p_budget_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
