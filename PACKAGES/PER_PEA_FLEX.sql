--------------------------------------------------------
--  DDL for Package PER_PEA_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PEA_FLEX" AUTHID CURRENT_USER as
/* $Header: pepeafli.pkh 115.1 99/07/18 14:13:23 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
...
--  {End of Comments}
-- -----------------------------------------------------------------------------
procedure df(p_rec   in per_pea_shd.g_rec_type);
--
end per_pea_flex;
