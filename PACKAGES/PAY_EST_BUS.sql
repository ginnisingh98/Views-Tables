--------------------------------------------------------
--  DDL for Package PAY_EST_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EST_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_element_set_id
--     already exists.
--
--  In Arguments:
--    p_element_set_id
