--------------------------------------------------------
--  DDL for Package BEN_ECL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ECL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_comp_lvl_prte_id             number(15),
  ...
  ordr_num                          number(15),
  ecl_attribute_category            varchar2(30),
  ecl_attribute1                    varchar2(150),
  ecl_attribute2                    varchar2(150),
  ecl_attribute3                    varchar2(150),
  ecl_attribute4                    varchar2(150),
  ecl_attribute5                    varchar2(150),
  ecl_attribute6                    varchar2(150),
  ecl_attribute7                    varchar2(150),
  ecl_attribute8                    varchar2(150),
  ecl_attribute9                    varchar2(150),
  ecl_attribute10                   varchar2(150),
  ecl_attribute11                   varchar2(150),
  ecl_attribute12                   varchar2(150),
  ecl_attribute13                   varchar2(150),
  ecl_attribute14                   varchar2(150),
  ecl_attribute15                   varchar2(150),
  ecl_attribute16                   varchar2(150),
  ecl_attribute17                   varchar2(150),
  ecl_attribute18                   varchar2(150),
  ecl_attribute19                   varchar2(150),
  ecl_attribute20                   varchar2(150),
  ecl_attribute21                   varchar2(150),
  ecl_attribute22                   varchar2(150),
  ecl_attribute23                   varchar2(150),
  ecl_attribute24                   varchar2(150),
  ecl_attribute25                   varchar2(150),
  ecl_attribute26                   varchar2(150),
  ecl_attribute27                   varchar2(150),
  ecl_attribute28                   varchar2(150),
  ecl_attribute29                   varchar2(150),
  ecl_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_comp_lvl_prte_id).
--
-- Post Success:
--   Processing continues.
--
