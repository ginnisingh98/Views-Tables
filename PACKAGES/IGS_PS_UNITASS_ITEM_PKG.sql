--------------------------------------------------------
--  DDL for Package IGS_PS_UNITASS_ITEM_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PS_UNITASS_ITEM_PKG" AUTHID CURRENT_USER AS
/* $Header: IGSPI0KS.pls 120.0 2005/06/01 18:14:50 appldev noship $ */
  ...
  PROCEDURE get_fk_igs_as_grd_schema (x_grading_schema_cd IN VARCHAR2, x_version_number IN NUMBER);

  PROCEDURE get_fk_igs_as_us_ai_group (x_us_ass_item_group_id IN NUMBER);
