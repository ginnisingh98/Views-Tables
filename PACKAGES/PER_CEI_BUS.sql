--------------------------------------------------------
--  DDL for Package PER_CEI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CEI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cagr_entitlement_item_id
--     already exists.
--
--  In Arguments:
