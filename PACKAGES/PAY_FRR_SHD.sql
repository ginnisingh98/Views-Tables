--------------------------------------------------------
--  DDL for Package PAY_FRR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_FRR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (formula_result_rule_id          number(9)
  ,effective_start_date            date
  ,effective_end_date              date
  ,business_group_id               number(15)
  ,legislation_code                varchar2(30)
  ,element_type_id                 number(9)
  ,status_processing_rule_id       number(9)
  ,result_name                     varchar2(80)
  ,result_rule_type                varchar2(30)
  ,legislation_subgroup            varchar2(30)
  ,severity_level                  varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_FORMULA_RESULT_RULES_F';
...
--           p_base_key_value = :formula_result_rule_id).
--
-- Post Success:
--   Processing continues.
--
