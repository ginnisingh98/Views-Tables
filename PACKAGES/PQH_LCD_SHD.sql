--------------------------------------------------------
--  DDL for Package PQH_LCD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_LCD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (level_code_id                   number(15)
  ,level_number_id                 number(15)
  ,level_code                      varchar2(30)
  ,description                     varchar2(250)
  ,gradual_value_number            number(9)         -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_LEVEL_CODES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
