--------------------------------------------------------
--  DDL for Package HR_TMP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TMP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_form_template_id already exists.
--
--  In Arguments:
--    p_form_template_id
--
