--------------------------------------------------------
--  DDL for Package BEN_EES_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EES_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_ee_stat_prte_id              number(15),
  ...
  ees_attribute_category            varchar2(30),
  ees_attribute1                    varchar2(150),
  ees_attribute2                    varchar2(150),
  ees_attribute3                    varchar2(150),
  ees_attribute4                    varchar2(150),
  ees_attribute5                    varchar2(150),
  ees_attribute6                    varchar2(150),
  ees_attribute7                    varchar2(150),
  ees_attribute8                    varchar2(150),
  ees_attribute9                    varchar2(150),
  ees_attribute10                   varchar2(150),
  ees_attribute11                   varchar2(150),
  ees_attribute12                   varchar2(150),
  ees_attribute13                   varchar2(150),
  ees_attribute14                   varchar2(150),
  ees_attribute15                   varchar2(150),
  ees_attribute16                   varchar2(150),
  ees_attribute17                   varchar2(150),
  ees_attribute18                   varchar2(150),
  ees_attribute19                   varchar2(150),
  ees_attribute20                   varchar2(150),
  ees_attribute21                   varchar2(150),
  ees_attribute22                   varchar2(150),
  ees_attribute23                   varchar2(150),
  ees_attribute24                   varchar2(150),
  ees_attribute25                   varchar2(150),
  ees_attribute26                   varchar2(150),
  ees_attribute27                   varchar2(150),
  ees_attribute28                   varchar2(150),
  ees_attribute29                   varchar2(150),
  ees_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_ee_stat_prte_id).
--
-- Post Success:
--   Processing continues.
--
