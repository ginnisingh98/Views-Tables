--------------------------------------------------------
--  DDL for Package OKL_LTE_CHRG_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_LTE_CHRG_PVT" AUTHID CURRENT_USER AS
/* $Header: OKLRCHGS.pls 115.3 2003/02/11 23:25:11 stmathew noship $ */
--
...
-- ---------   ------  ------------------------------------------
 ...
 subtype lsmv_tbl_type is okl_lsm_pvt.lsmv_tbl_type;
  ...
  -- Global Variables
  G_PKG_NAME             CONSTANT VARCHAR2(200) := 'OKL_LTE_CHRG_PVT';
...
END OKL_LTE_CHRG_PVT; -- Package spec
