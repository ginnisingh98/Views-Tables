--------------------------------------------------------
--  DDL for Package PSP_EXTERNAL_EFFORT_LINES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_EXTERNAL_EFFORT_LINES_BK1" AUTHID CURRENT_USER AS
/* $Header: PSPEEAIS.pls 120.3 2006/07/06 13:25:21 tbalacha noship $ */
--
-- ----------------------------------------------------------------------------
-- |-----------------------< insert_external_effort_line_b >-----------------------|
-- ----------------------------------------------------------------------------
--
