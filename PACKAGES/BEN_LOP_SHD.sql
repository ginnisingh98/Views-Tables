--------------------------------------------------------
--  DDL for Package BEN_LOP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LOP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_chg_oipl_enrt_id              number(15),
  ...
  lop_attribute_category            varchar2(30),
  lop_attribute1                    varchar2(150),
  lop_attribute2                    varchar2(150),
  lop_attribute3                    varchar2(150),
  lop_attribute4                    varchar2(150),
  lop_attribute5                    varchar2(150),
  lop_attribute6                    varchar2(150),
  lop_attribute7                    varchar2(150),
  lop_attribute8                    varchar2(150),
  lop_attribute9                    varchar2(150),
  lop_attribute10                   varchar2(150),
  lop_attribute11                   varchar2(150),
  lop_attribute12                   varchar2(150),
  lop_attribute13                   varchar2(150),
  lop_attribute14                   varchar2(150),
  lop_attribute15                   varchar2(150),
  lop_attribute16                   varchar2(150),
  lop_attribute17                   varchar2(150),
  lop_attribute18                   varchar2(150),
  lop_attribute19                   varchar2(150),
  lop_attribute20                   varchar2(150),
  lop_attribute21                   varchar2(150),
  lop_attribute22                   varchar2(150),
  lop_attribute23                   varchar2(150),
  lop_attribute24                   varchar2(150),
  lop_attribute25                   varchar2(150),
  lop_attribute26                   varchar2(150),
  lop_attribute27                   varchar2(150),
  lop_attribute28                   varchar2(150),
  lop_attribute29                   varchar2(150),
  lop_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_chg_oipl_enrt_id).
--
-- Post Success:
--   Processing continues.
--
