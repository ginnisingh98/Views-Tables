--------------------------------------------------------
--  DDL for Package BOM_DIAGUNITTEST_EXPDATA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BOM_DIAGUNITTEST_EXPDATA" AUTHID CURRENT_USER AS
/* $Header: BOMDGEXS.pls 120.0.12000000.1 2007/07/26 12:57:30 vggarg noship $ */
