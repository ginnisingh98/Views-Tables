--------------------------------------------------------
--  DDL for Package OTA_CRE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CRE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (cert_enrollment_id              number(9)
  ,certification_id                number(9)
  ,person_id                       number(9)
  ,contact_id                      number(15)
  ,object_version_number           number(9)
  ,certification_status_code       varchar2(30)
  ,completion_date                 date
  ,business_group_id               number(15)
  ,unenrollment_date               date
  ,expiration_date                 date
  ,earliest_enroll_date            date
  ,is_history_flag                 varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_CERT_ENROLLMENTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
