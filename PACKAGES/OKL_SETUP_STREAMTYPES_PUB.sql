--------------------------------------------------------
--  DDL for Package OKL_SETUP_STREAMTYPES_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SETUP_STREAMTYPES_PUB" AUTHID CURRENT_USER AS
/* $Header: OKLPSMTS.pls 115.2 2002/02/15 18:19:34 pkm ship       $ */
  ...
  G_PKG_NAME                  CONSTANT VARCHAR2(30)  := 'OKL_SETUP_STREAMTYPES_PUB';
