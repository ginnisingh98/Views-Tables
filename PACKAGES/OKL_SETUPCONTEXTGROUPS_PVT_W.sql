--------------------------------------------------------
--  DDL for Package OKL_SETUPCONTEXTGROUPS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SETUPCONTEXTGROUPS_PVT_W" AUTHID CURRENT_USER as
  /* $Header: OKLESCGS.pls 120.1 2005/07/12 09:08:40 dkagrawa noship $ */
