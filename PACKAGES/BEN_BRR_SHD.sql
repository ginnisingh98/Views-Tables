--------------------------------------------------------
--  DDL for Package BEN_BRR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BRR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  bnft_vrbl_rt_rl_id                number(15),
  effective_start_date              date,
  effective_end_date                date,
  ordr_to_aply_num                  number,
  cvg_amt_calc_mthd_id              number(15),
  formula_id                        number(9),
  business_group_id                 number(15),
  brr_attribute_category            varchar2(30),
  brr_attribute1                    varchar2(150),
  brr_attribute2                    varchar2(150),
  brr_attribute3                    varchar2(150),
  brr_attribute4                    varchar2(150),
  brr_attribute5                    varchar2(150),
  brr_attribute6                    varchar2(150),
  brr_attribute7                    varchar2(150),
  brr_attribute8                    varchar2(150),
  brr_attribute9                    varchar2(150),
  brr_attribute10                   varchar2(150),
  brr_attribute11                   varchar2(150),
  brr_attribute12                   varchar2(150),
  brr_attribute13                   varchar2(150),
  brr_attribute14                   varchar2(150),
  brr_attribute15                   varchar2(150),
  brr_attribute16                   varchar2(150),
  brr_attribute17                   varchar2(150),
  brr_attribute18                   varchar2(150),
  brr_attribute19                   varchar2(150),
  brr_attribute20                   varchar2(150),
  brr_attribute21                   varchar2(150),
  brr_attribute22                   varchar2(150),
  brr_attribute23                   varchar2(150),
  brr_attribute24                   varchar2(150),
  brr_attribute25                   varchar2(150),
  brr_attribute26                   varchar2(150),
  brr_attribute27                   varchar2(150),
  brr_attribute28                   varchar2(150),
  brr_attribute29                   varchar2(150),
  brr_attribute30                   varchar2(150),
...
--           p_base_key_value = :bnft_vrbl_rt_rl_id).
--
-- Post Success:
--   Processing continues.
--
