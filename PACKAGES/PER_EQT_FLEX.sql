--------------------------------------------------------
--  DDL for Package PER_EQT_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_EQT_FLEX" AUTHID CURRENT_USER as
/* $Header: peeqtfli.pkh 115.0 99/07/17 18:58:14 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
