--------------------------------------------------------
--  DDL for Package PQP_GDS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_GDS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_gap_duration_summary_id
--     already exists.
--
--  In Arguments:
