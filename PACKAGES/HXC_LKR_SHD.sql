--------------------------------------------------------
--  DDL for Package HXC_LKR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_LKR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (locker_type_owner_id            number(15)
  ,locker_type_requestor_id        number(15)
  ,grant_lock                      varchar2(9)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HXC_LOCKING_RULES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
