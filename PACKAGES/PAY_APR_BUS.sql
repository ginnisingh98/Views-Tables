--------------------------------------------------------
--  DDL for Package PAY_APR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_APR_BUS" AUTHID CURRENT_USER as
/* $Header: pyaprrhi.pkh 120.2 2006/12/04 13:29:21 abhargav noship $ */
--
-- ---------------------------------------------------------------------------
...
--
--  Prerequisites:
--    The primary key identified by p_process_id
--     already exists.
--
--  In Arguments:
--    p_process_id
...
--
--  Description:
--    Check the field enabled_flag is 'Y' or 'N'
--
--  Prerequisites:
--
--  In Arguments:
...
--
--  Post Failure:
--    An error is raised if the value of the enabled flag is invalid.
--
--  Access Status:
--    Internal Development Use Only.
--
