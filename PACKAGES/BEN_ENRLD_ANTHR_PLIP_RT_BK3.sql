--------------------------------------------------------
--  DDL for Package BEN_ENRLD_ANTHR_PLIP_RT_BK3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ENRLD_ANTHR_PLIP_RT_BK3" AUTHID CURRENT_USER as
/* $Header: beearapi.pkh 120.0 2005/05/28 01:45:45 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< delete_ENRLD_ANTHR_PLIP_RT_b >-----------------|
-- ----------------------------------------------------------------------------
--
