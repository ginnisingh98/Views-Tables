--------------------------------------------------------
--  DDL for Package HXC_HAD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_HAD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,alias_definition_name           varchar2(80)
  ,alias_context_code		   varchar2(30)
  ,business_group_id		   number(15)
  ,legislation_code		   varchar2(30)
  ,timecard_field                  varchar2(80)
