--------------------------------------------------------
--  DDL for Package PER_ASG_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ASG_FLEX" AUTHID CURRENT_USER as
/* $Header: peasgfli.pkh 115.0 99/07/17 18:38:03 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
