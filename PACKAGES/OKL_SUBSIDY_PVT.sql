--------------------------------------------------------
--  DDL for Package OKL_SUBSIDY_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SUBSIDY_PVT" AUTHID CURRENT_USER AS
/* $Header: OKLCSUBS.pls 115.0 2003/09/19 22:43:50 avsingh noship $ */

  -- simple entity object subtype definitions
  subtype subv_rec_type is OKL_SUB_PVT.subv_rec_type;
  subtype subv_tbl_type is OKL_SUB_PVT.subv_tbl_type;
  subtype sucv_rec_type is OKL_SUC_PVT.sucv_rec_type;
  subtype sucv_tbl_type is OKL_SUC_PVT.sucv_tbl_type;
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME			CONSTANT VARCHAR2(200) := 'OKL_SUBSIDY_PVT';
