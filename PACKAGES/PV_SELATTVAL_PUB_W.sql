--------------------------------------------------------
--  DDL for Package PV_SELATTVAL_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PV_SELATTVAL_PUB_W" AUTHID CURRENT_USER as
  /* $Header: pvrwsavs.pls 115.4 2003/09/24 22:10:21 pklin ship $ */
