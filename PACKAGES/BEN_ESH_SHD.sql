--------------------------------------------------------
--  DDL for Package BEN_ESH_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ESH_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_schedd_hrs_prte_id           number(15),
  ...
  esh_attribute_category            varchar2(30),
  esh_attribute1                    varchar2(150),
  esh_attribute2                    varchar2(150),
  esh_attribute3                    varchar2(150),
  esh_attribute4                    varchar2(150),
  esh_attribute5                    varchar2(150),
  esh_attribute6                    varchar2(150),
  esh_attribute7                    varchar2(150),
  esh_attribute8                    varchar2(150),
  esh_attribute9                    varchar2(150),
  esh_attribute10                   varchar2(150),
  esh_attribute11                   varchar2(150),
  esh_attribute12                   varchar2(150),
  esh_attribute13                   varchar2(150),
  esh_attribute14                   varchar2(150),
  esh_attribute15                   varchar2(150),
  esh_attribute16                   varchar2(150),
  esh_attribute17                   varchar2(150),
  esh_attribute18                   varchar2(150),
  esh_attribute19                   varchar2(150),
  esh_attribute20                   varchar2(150),
  esh_attribute21                   varchar2(150),
  esh_attribute22                   varchar2(150),
  esh_attribute23                   varchar2(150),
  esh_attribute24                   varchar2(150),
  esh_attribute25                   varchar2(150),
  esh_attribute26                   varchar2(150),
  esh_attribute27                   varchar2(150),
  esh_attribute28                   varchar2(150),
  esh_attribute29                   varchar2(150),
  esh_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_schedd_hrs_prte_id).
--
-- Post Success:
--   Processing continues.
--
