--------------------------------------------------------
--  DDL for Package PER_CEO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CEO_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (comp_element_outcome_id         number(15)
  ,competence_element_id           number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_COMP_ELEMENT_OUTCOMES';
