--------------------------------------------------------
--  DDL for Package SSP_ERN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."SSP_ERN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  earnings_calculations_id          number(9),
  object_version_number             number(9),
  person_id                         number(10),
  effective_date                    date,
  average_earnings_amount           number,
  user_entered                      varchar2(30),
  absence_category		    varchar2(30), -- DFoster 1304683
