--------------------------------------------------------
--  DDL for Package PER_US_EEO5_EXP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_US_EEO5_EXP_PKG" AUTHID CURRENT_USER AS
/* $Header: peruseeo5exp.pkh 120.1 2007/07/12 13:47:36 jdevasah noship $ */
/*
   ******************************************************************
   *                                                                *
