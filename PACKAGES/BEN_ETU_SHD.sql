--------------------------------------------------------
--  DDL for Package BEN_ETU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ETU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_tbco_use_prte_id             number(15),
  ...
  etu_attribute_category            varchar2(30),
  etu_attribute1                    varchar2(150),
  etu_attribute2                    varchar2(150),
  etu_attribute3                    varchar2(150),
  etu_attribute4                    varchar2(150),
  etu_attribute5                    varchar2(150),
  etu_attribute6                    varchar2(150),
  etu_attribute7                    varchar2(150),
  etu_attribute8                    varchar2(150),
  etu_attribute9                    varchar2(150),
  etu_attribute10                   varchar2(150),
  etu_attribute11                   varchar2(150),
  etu_attribute12                   varchar2(150),
  etu_attribute13                   varchar2(150),
  etu_attribute14                   varchar2(150),
  etu_attribute15                   varchar2(150),
  etu_attribute16                   varchar2(150),
  etu_attribute17                   varchar2(150),
  etu_attribute18                   varchar2(150),
  etu_attribute19                   varchar2(150),
  etu_attribute20                   varchar2(150),
  etu_attribute21                   varchar2(150),
  etu_attribute22                   varchar2(150),
  etu_attribute23                   varchar2(150),
  etu_attribute24                   varchar2(150),
  etu_attribute25                   varchar2(150),
  etu_attribute26                   varchar2(150),
  etu_attribute27                   varchar2(150),
  etu_attribute28                   varchar2(150),
  etu_attribute29                   varchar2(150),
  etu_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_tbco_use_prte_id).
--
-- Post Success:
--   Processing continues.
--
