--------------------------------------------------------
--  DDL for Package CS_COUNTERS_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CS_COUNTERS_VUHK" AUTHID CURRENT_USER as
/* $Header: csxictrs.pls 115.4 2002/11/01 21:14:57 mkommuri noship $*/
-- Start of Comments
-- Package name     : CS_COUNTERS_VUHK
-- Purpose          : Vertical Hookup for Counters
-- History          :
-- NOTE             :
-- End of Comments
