--------------------------------------------------------
--  DDL for Package PSP_ERA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_ERA_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_effort_report_approval_id
--     already exists.
--
--  In Arguments:
