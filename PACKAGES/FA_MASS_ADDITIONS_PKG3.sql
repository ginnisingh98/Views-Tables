--------------------------------------------------------
--  DDL for Package FA_MASS_ADDITIONS_PKG3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_MASS_ADDITIONS_PKG3" AUTHID CURRENT_USER as
/* $Header: faxima3s.pls 120.5.12010000.2 2009/07/19 10:24:00 glchen ship $ */
  PROCEDURE Insert_Row(X_Rowid                   IN OUT NOCOPY VARCHAR2,
		       ...
		       X_Context			VARCHAR2 DEFAULT NULL,
                       ...
                       X_prorate_convention_code      VARCHAR2 DEFAULT NULL, -- Bug 8675206
