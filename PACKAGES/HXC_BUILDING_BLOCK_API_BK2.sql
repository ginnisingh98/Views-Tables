--------------------------------------------------------
--  DDL for Package HXC_BUILDING_BLOCK_API_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_BUILDING_BLOCK_API_BK2" AUTHID CURRENT_USER as
/* $Header: hxctbbapi.pkh 120.1 2005/07/14 17:18:24 arundell noship $ */

procedure update_building_block_b
...
procedure update_building_block_a
  (p_effective_date            in     date
  ,p_type                      in     varchar2
  ,p_measure                   in     number
  ,p_unit_of_measure           in     varchar2
...
end hxc_building_block_api_bk2;
