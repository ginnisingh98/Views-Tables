--------------------------------------------------------
--  DDL for Package AMS_RULE_GROUP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_RULE_GROUP_PVT" AUTHID CURRENT_USER AS
/* $Header: amsvrgps.pls 115.8 2002/11/25 20:48:27 ryedator ship $ */
-- ===============================================================
-- Start of Comments
-- Package name
--          AMS_Rule_Group_PVT
...
(
       ...
       rule_name                       VARCHAR2(240) := FND_API.G_MISS_CHAR,
       rule_description                VARCHAR2(4000) := FND_API.G_MISS_CHAR
);
