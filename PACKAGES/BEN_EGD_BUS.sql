--------------------------------------------------------
--  DDL for Package BEN_EGD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EGD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_elig_dpnt_id already exists.
--
--  In Arguments:
--    p_elig_dpnt_id
--
...
function return_legislation_code
  (p_elig_dpnt_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
