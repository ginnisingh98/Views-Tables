--------------------------------------------------------
--  DDL for Package BEN_CRT_ORDERS_CVRD_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CRT_ORDERS_CVRD_BK2" AUTHID CURRENT_USER as
/* $Header: becrdapi.pkh 120.0 2005/05/28 01:21:00 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_crt_orders_cvrd_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_crt_orders_cvrd_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_crt_orders_cvrd_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_crt_orders_cvrd_a
  (
   p_crt_ordr_cvrd_per_id           in  number
  ,p_crt_ordr_id                    in  number
  ,p_person_id                      in  number
