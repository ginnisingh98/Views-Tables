--------------------------------------------------------
--  DDL for Package GME_API_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GME_API_PUB" AUTHID CURRENT_USER AS
/* $Header: GMEPAPIS.pls 120.32.12010000.4 2009/06/15 20:24:45 gmurator ship $ */
/*#
...
* @rep:scope public
* @rep:lifecycle active
* @rep:displayname incremental_batckflush
*/
/*===========================================================================================
   Procedure
