--------------------------------------------------------
--  DDL for Package GMD_EXPRESSION_MIG_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GMD_EXPRESSION_MIG_UTIL" AUTHID CURRENT_USER AS
/* $Header: GMDPEXMS.pls 120.0 2005/08/11 08:54:50 txdaniel noship $ */
