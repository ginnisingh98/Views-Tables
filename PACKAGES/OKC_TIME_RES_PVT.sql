--------------------------------------------------------
--  DDL for Package OKC_TIME_RES_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_TIME_RES_PVT" AUTHID CURRENT_USER AS
/* $Header: OKCCRESS.pls 120.2 2006/02/24 15:09:35 smallya noship $ */
  ---------------------------------------------------------------------------
  ...
  PICKUP_UPTO_MONTHS            NUMBER   := 12;
  RESOLVE_UNTIL_MONTHS          NUMBER   := 6;
  ---------------------------------------------------------------------------
