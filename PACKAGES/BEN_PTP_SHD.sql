--------------------------------------------------------
--  DDL for Package BEN_PTP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PTP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  name                              varchar2(240),
  mx_enrl_alwd_num                  number(15),
  mn_enrl_rqd_num                   number(15),
  pl_typ_stat_cd                    varchar2(30),
  opt_typ_cd                        varchar2(30),
  opt_dsply_fmt_cd                  varchar2(30),
  comp_typ_cd                       varchar2(30),
  ivr_ident                         varchar2(90),
  no_mx_enrl_num_dfnd_flag          varchar2(30),
  no_mn_enrl_num_dfnd_flag          varchar2(30),
  business_group_id                 number(15),
  ptp_attribute_category            varchar2(30),
  ptp_attribute1                    varchar2(150),
  ptp_attribute2                    varchar2(150),
  ptp_attribute3                    varchar2(150),
  ptp_attribute4                    varchar2(150),
  ptp_attribute5                    varchar2(150),
  ptp_attribute6                    varchar2(150),
  ptp_attribute7                    varchar2(150),
  ptp_attribute8                    varchar2(150),
  ptp_attribute9                    varchar2(150),
  ptp_attribute10                   varchar2(150),
  ptp_attribute11                   varchar2(150),
  ptp_attribute12                   varchar2(150),
  ptp_attribute13                   varchar2(150),
  ptp_attribute14                   varchar2(150),
  ptp_attribute15                   varchar2(150),
  ptp_attribute16                   varchar2(150),
  ptp_attribute17                   varchar2(150),
  ptp_attribute18                   varchar2(150),
  ptp_attribute19                   varchar2(150),
  ptp_attribute20                   varchar2(150),
  ptp_attribute21                   varchar2(150),
  ptp_attribute22                   varchar2(150),
  ptp_attribute23                   varchar2(150),
  ptp_attribute24                   varchar2(150),
  ptp_attribute25                   varchar2(150),
  ptp_attribute26                   varchar2(150),
  ptp_attribute27                   varchar2(150),
  ptp_attribute28                   varchar2(150),
  ptp_attribute29                   varchar2(150),
  ptp_attribute30                   varchar2(150),
