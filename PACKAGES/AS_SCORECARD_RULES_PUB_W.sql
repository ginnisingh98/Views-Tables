--------------------------------------------------------
--  DDL for Package AS_SCORECARD_RULES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AS_SCORECARD_RULES_PUB_W" AUTHID CURRENT_USER as
  /* $Header: asxwscos.pls 120.2 2006/03/09 15:41 solin ship $ */
