--------------------------------------------------------
--  DDL for Package BEN_CVRD_DPNT_CTFN_PRVDD_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CVRD_DPNT_CTFN_PRVDD_BK1" AUTHID CURRENT_USER as
/* $Header: beccpapi.pkh 120.0 2005/05/28 00:58:01 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_CVRD_DPNT_CTFN_PRVDD_b >-----------------|
-- ----------------------------------------------------------------------------
--
