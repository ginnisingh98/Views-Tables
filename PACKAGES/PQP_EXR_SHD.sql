--------------------------------------------------------
--  DDL for Package PQP_EXR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_EXR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (exception_report_id             number(9)
  ,exception_report_name           varchar2(80)
  ,legislation_code                varchar2(30)
  ,business_group_id               number
  ,currency_code                   varchar2(15)
  ,balance_type_id                 number(9)
  ,balance_dimension_id            number(9)
  ,variance_type                   varchar2(30)
  ,variance_value                  number(9)
  ,comparison_type                 varchar2(30)
  ,comparison_value                number(9)
  ,object_version_number           number(15)
  ,output_format_type		   varchar2(15)
  ,variance_operator		   varchar2(15)
