--------------------------------------------------------
--  DDL for Package HXC_ULP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_ULP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (layout_comp_prompt_id           number(15)
  ,layout_component_id             number(15)
  ,prompt_alias                    varchar2(80)
  ,prompt_type                     varchar2(30)
