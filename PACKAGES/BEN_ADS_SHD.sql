--------------------------------------------------------
--  DDL for Package BEN_ADS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ADS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  acty_rt_ded_sched_id              number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  ded_sched_py_freq_id              number(15),
  acty_base_rt_id                   number(15),
  ded_sched_rl                      number(15),
  ded_sched_cd                      varchar2(30),
  ads_attribute_category            varchar2(30),
  ads_attribute1                    varchar2(150),
  ads_attribute2                    varchar2(150),
  ads_attribute3                    varchar2(150),
  ads_attribute4                    varchar2(150),
  ads_attribute5                    varchar2(150),
  ads_attribute6                    varchar2(150),
  ads_attribute7                    varchar2(150),
  ads_attribute8                    varchar2(150),
  ads_attribute9                    varchar2(150),
  ads_attribute10                   varchar2(150),
  ads_attribute11                   varchar2(150),
  ads_attribute12                   varchar2(150),
  ads_attribute13                   varchar2(150),
  ads_attribute14                   varchar2(150),
  ads_attribute15                   varchar2(150),
  ads_attribute16                   varchar2(150),
  ads_attribute17                   varchar2(150),
  ads_attribute18                   varchar2(150),
  ads_attribute19                   varchar2(150),
  ads_attribute20                   varchar2(150),
  ads_attribute21                   varchar2(150),
  ads_attribute22                   varchar2(150),
  ads_attribute23                   varchar2(150),
  ads_attribute24                   varchar2(150),
  ads_attribute25                   varchar2(150),
  ads_attribute26                   varchar2(150),
  ads_attribute27                   varchar2(150),
  ads_attribute28                   varchar2(150),
  ads_attribute29                   varchar2(150),
  ads_attribute30                   varchar2(150),
...
--           p_base_key_value = :acty_rt_ded_sched_id).
--
-- Post Success:
--   Processing continues.
--
