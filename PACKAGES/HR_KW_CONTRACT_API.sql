--------------------------------------------------------
--  DDL for Package HR_KW_CONTRACT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_KW_CONTRACT_API" AUTHID CURRENT_USER as
/* $Header: pectckwi.pkh 120.1 2005/10/02 02:39:53 aroussel $ */
/*#
 * This package contains contract APIs for Kuwait.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Contract for Kuwait
*/
--
-- ----------------------------------------------------------------------------
-- |----------------------------< create_kw_contract >------------------------|
...
-- {Start Of Comments}
/*#
 * This API creates a new Kuwaiti contract.
 *
 *
 * <p><b>Licensing</b><br>
 ...
 * force.
 * @rep:displayname Create Contract for Kuwait
...
-- {Start Of Comments}
/*#
 * This API updates an existing Kuwaiti contract.
 *
 *
 * <p><b>Licensing</b><br>
 * This API is licensed for use with Human Resources.
 ...
 * this change.
 * @rep:displayname Update Contract for Kuwait
 * @rep:category BUSINESS_ENTITY PER_EMPLOYMENT_CONTRACT
 * @rep:lifecycle active
 * @rep:scope public
 * @rep:ihelp PER/@scalapi APIs in Oracle HRMS
