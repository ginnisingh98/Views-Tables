--------------------------------------------------------
--  DDL for Package CZ_PUB_MGR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CZ_PUB_MGR" AUTHID CURRENT_USER as
/*  $Header: czpmmgrs.pls 115.8 2002/11/27 17:10:09 askhacha ship $	*/
