--------------------------------------------------------
--  DDL for Package PQH_SITUATIONS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_SITUATIONS_BK2" AUTHID CURRENT_USER as
