--------------------------------------------------------
--  DDL for Package HR_TEMPLATE_ITEM_INFO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TEMPLATE_ITEM_INFO" 
/* $Header: hrtiminf.pkh 120.0 2005/05/31 03:14:07 appldev noship $ */
AUTHID CURRENT_USER AS
  --
  -- Global types
  --
  TYPE t_template_item IS RECORD
  ...
  TYPE t_template_items IS TABLE OF t_template_item;
  TYPE t_template_items_pst IS TABLE OF t_template_item INDEX BY BINARY_INTEGER;
--
-- -----------------------------------------------------------------------------
-- |-----------------------------< template_items >----------------------------|
-- -----------------------------------------------------------------------------
...
--
-- Post Success
--   A table containing the details of the template items is returned
--
-- Post Failure
--   An error is raised
--
