--------------------------------------------------------
--  DDL for Package PAY_BLD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_BLD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_balance_dimension_id
--     already exists.
--
--  In Arguments:
