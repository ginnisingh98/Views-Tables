--------------------------------------------------------
--  DDL for Package OKL_AM_AMORTIZE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_AM_AMORTIZE_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUTATS.pls 120.5.12010000.2 2010/04/29 15:37:55 rpillay ship $ */
