--------------------------------------------------------
--  DDL for Package PQH_REI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_REI_UPD" AUTHID CURRENT_USER as
...
--      is issued.
--   2) The row to be updated is locked and selected into the record
--      structure g_old_rec.
