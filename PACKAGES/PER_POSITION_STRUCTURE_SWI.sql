--------------------------------------------------------
--  DDL for Package PER_POSITION_STRUCTURE_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_POSITION_STRUCTURE_SWI" AUTHID CURRENT_USER As
/* $Header: pepstswi.pkh 115.2 2002/12/04 17:14:50 eumenyio noship $ */
-- ----------------------------------------------------------------------------
...
--  API: per_position_structure_api.create_position_structure
--
-- Pre-requisites
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: per_position_structure_api.create_pos_struct_and_def_ver
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: per_position_structure_api.delete_position_structure
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: per_position_structure_api.update_position_structure
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
