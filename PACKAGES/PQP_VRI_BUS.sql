--------------------------------------------------------
--  DDL for Package PQP_VRI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_VRI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_veh_repos_extra_info_id
--     already exists.
--
--  In Arguments:
