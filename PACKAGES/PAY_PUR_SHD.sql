--------------------------------------------------------
--  DDL for Package PAY_PUR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PUR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (user_row_id                     number(15)
  ,effective_start_date            date
  ,effective_end_date              date
  ,business_group_id               number(15)
  ,legislation_code                varchar2(30)
  ,user_table_id                   number(9)
  ,row_low_range_or_name           varchar2(80)
  ,display_sequence                number(9)         -- Increased length
  ,row_high_range                  varchar2(80)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_USER_ROWS_F';
