--------------------------------------------------------
--  DDL for Package IRC_INP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_INP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (party_id                        number(15)
  ,notification_preference_id      number(15)
  ,person_id                       number(15)
  ,matching_jobs                   varchar2(30)
  ,matching_job_freq               varchar2(30)
  ,attribute_category              varchar2(30)
  ,receive_info_mail               varchar2(30)
...
g_tab_nam  constant varchar2(30) := 'IRC_NOTIFICATION_PREFERENCES';
