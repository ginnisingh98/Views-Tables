--------------------------------------------------------
--  DDL for Package BEN_BBP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BBP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_batch_parameter_id already exists.
--
--  In Arguments:
...
function return_legislation_code
  (p_batch_parameter_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
