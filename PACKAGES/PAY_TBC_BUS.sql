--------------------------------------------------------
--  DDL for Package PAY_TBC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_TBC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_balance_category_id
--     already exists.
--
--  In Arguments:
