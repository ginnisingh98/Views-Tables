--------------------------------------------------------
--  DDL for Package PER_PPB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PPB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,annualized_hours                number
  ,pay_annualization_factor        number
  ,grade_annualization_factor      number
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_PAY_BASES';
