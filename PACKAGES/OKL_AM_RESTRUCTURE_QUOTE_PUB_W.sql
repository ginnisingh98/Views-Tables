--------------------------------------------------------
--  DDL for Package OKL_AM_RESTRUCTURE_QUOTE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_AM_RESTRUCTURE_QUOTE_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLURTQS.pls 120.2 2007/11/02 21:08:34 rmunjulu ship $ */
