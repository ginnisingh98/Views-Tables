--------------------------------------------------------
--  DDL for Package BEN_ELIG_COMP_LVL_PRTE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_COMP_LVL_PRTE_BK2" AUTHID CURRENT_USER as
/* $Header: beeclapi.pkh 120.0 2005/05/28 01:50:29 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_COMP_LVL_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_COMP_LVL_PRTE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_COMP_LVL_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_COMP_LVL_PRTE_a
  (
   p_elig_comp_lvl_prte_id          in  number
...
--
end ben_ELIG_COMP_LVL_PRTE_bk2;
