--------------------------------------------------------
--  DDL for Package BEN_JOB_RT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_JOB_RT_BK2" AUTHID CURRENT_USER as
