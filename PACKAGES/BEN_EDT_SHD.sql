--------------------------------------------------------
--  DDL for Package BEN_EDT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EDT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_dpnt_cvrd_othr_ptip_id       number(15),
  ...
  edt_attribute_category            varchar2(30),
  edt_attribute1                    varchar2(150),
  edt_attribute2                    varchar2(150),
  edt_attribute3                    varchar2(150),
  edt_attribute4                    varchar2(150),
  edt_attribute5                    varchar2(150),
  edt_attribute6                    varchar2(150),
  edt_attribute7                    varchar2(150),
  edt_attribute8                    varchar2(150),
  edt_attribute9                    varchar2(150),
  edt_attribute10                   varchar2(150),
  edt_attribute11                   varchar2(150),
  edt_attribute12                   varchar2(150),
  edt_attribute13                   varchar2(150),
  edt_attribute14                   varchar2(150),
  edt_attribute15                   varchar2(150),
  edt_attribute16                   varchar2(150),
  edt_attribute17                   varchar2(150),
  edt_attribute18                   varchar2(150),
  edt_attribute19                   varchar2(150),
  edt_attribute20                   varchar2(150),
  edt_attribute21                   varchar2(150),
  edt_attribute22                   varchar2(150),
  edt_attribute23                   varchar2(150),
  edt_attribute24                   varchar2(150),
  edt_attribute25                   varchar2(150),
  edt_attribute26                   varchar2(150),
  edt_attribute27                   varchar2(150),
  edt_attribute28                   varchar2(150),
  edt_attribute29                   varchar2(150),
  edt_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_dpnt_cvrd_othr_ptip_id).
--
-- Post Success:
--   Processing continues.
--
