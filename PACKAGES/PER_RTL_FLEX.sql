--------------------------------------------------------
--  DDL for Package PER_RTL_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RTL_FLEX" AUTHID CURRENT_USER as
/* $Header: pertlfli.pkh 115.1 99/07/18 15:02:00 porting ship $ */
--
--
-------------------------------------------------------------------------------
-------------------------------< df>--------------------------------------|--
