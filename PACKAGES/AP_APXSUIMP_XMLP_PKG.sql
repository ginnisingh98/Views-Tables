--------------------------------------------------------
--  DDL for Package AP_APXSUIMP_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_APXSUIMP_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: APXSUIMPS.pls 120.0 2007/12/27 08:33:58 vjaganat noship $ */
