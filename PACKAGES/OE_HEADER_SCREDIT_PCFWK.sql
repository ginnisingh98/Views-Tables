--------------------------------------------------------
--  DDL for Package OE_HEADER_SCREDIT_PCFWK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_HEADER_SCREDIT_PCFWK" AUTHID CURRENT_USER AS
/* $Header: OEXKHSCS.pls 120.0 2005/06/01 01:18:41 appldev noship $ */
...
--     against operations on HEADER_SCREDIT or its columns
--  Pre-reqs
--
--  Parameters
--
