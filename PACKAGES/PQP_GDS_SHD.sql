--------------------------------------------------------
--  DDL for Package PQP_GDS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_GDS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (gap_duration_summary_id         number(15)
  ,assignment_id                   number(10)
  ,gap_absence_plan_id             number(15)
  ,summary_type                    varchar2(30)
  ,gap_level                       varchar2(30)
  ,duration_in_days                number(15,5)
  ,duration_in_hours               number(15,5)
  ,date_start                      date
  ,date_end                        date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQP_GAP_DURATION_SUMMARY';
