--------------------------------------------------------
--  DDL for Package PER_BBA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_BBA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  bba_attribute_category                varchar2(30),
  bba_attribute1                        varchar2(150),
  bba_attribute2                        varchar2(150),
  bba_attribute3                        varchar2(150),
  bba_attribute4                        varchar2(150),
  bba_attribute5                        varchar2(150),
  bba_attribute6                        varchar2(150),
  bba_attribute7                        varchar2(150),
  bba_attribute8                        varchar2(150),
  bba_attribute9                        varchar2(150),
  bba_attribute10                       varchar2(150),
  bba_attribute11                       varchar2(150),
  bba_attribute12                       varchar2(150),
  bba_attribute13                       varchar2(150),
  bba_attribute14                       varchar2(150),
  bba_attribute15                       varchar2(150),
  bba_attribute16                       varchar2(150),
  bba_attribute17                       varchar2(150),
  bba_attribute18                       varchar2(150),
  bba_attribute19                       varchar2(150),
  bba_attribute20                       varchar2(150),
  bba_attribute21                       varchar2(150),
  bba_attribute22                       varchar2(150),
  bba_attribute23                       varchar2(150),
  bba_attribute24                       varchar2(150),
  bba_attribute25                       varchar2(150),
  bba_attribute26                       varchar2(150),
  bba_attribute27                       varchar2(150),
  bba_attribute28                       varchar2(150),
  bba_attribute29                       varchar2(150),
  bba_attribute30                       varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
