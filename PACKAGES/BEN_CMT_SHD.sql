--------------------------------------------------------
--  DDL for Package BEN_CMT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CMT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  cm_dlvry_mthd_typ_id              number(15),
  cm_dlvry_mthd_typ_cd              varchar2(30),
  business_group_id                 number(15),
  cm_typ_id                         number,
  cmt_attribute1                    varchar2(150),
  cmt_attribute10                   varchar2(150),
  cmt_attribute11                   varchar2(150),
  cmt_attribute12                   varchar2(150),
  cmt_attribute13                   varchar2(150),
  cmt_attribute14                   varchar2(150),
  cmt_attribute15                   varchar2(150),
  cmt_attribute16                   varchar2(150),
  cmt_attribute17                   varchar2(150),
  cmt_attribute18                   varchar2(150),
  cmt_attribute19                   varchar2(150),
  cmt_attribute2                    varchar2(150),
  cmt_attribute20                   varchar2(150),
  cmt_attribute21                   varchar2(150),
  cmt_attribute22                   varchar2(150),
  cmt_attribute23                   varchar2(150),
  cmt_attribute24                   varchar2(150),
  cmt_attribute25                   varchar2(150),
  cmt_attribute26                   varchar2(150),
  cmt_attribute27                   varchar2(150),
  cmt_attribute28                   varchar2(150),
  cmt_attribute29                   varchar2(150),
  cmt_attribute3                    varchar2(150),
  cmt_attribute30                   varchar2(150),
  rqd_flag                          varchar2(30),
  cmt_attribute_category            varchar2(30),
  cmt_attribute4                    varchar2(150),
  cmt_attribute5                    varchar2(150),
  cmt_attribute6                    varchar2(150),
  cmt_attribute7                    varchar2(150),
  cmt_attribute8                    varchar2(150),
  cmt_attribute9                    varchar2(150),
