--------------------------------------------------------
--  DDL for Package PER_RTX_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RTX_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_rating_level_id
--     already exists.
--
--  In Arguments:
--    p_rating_level_id
