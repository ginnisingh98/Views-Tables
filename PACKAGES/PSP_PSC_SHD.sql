--------------------------------------------------------
--  DDL for Package PSP_PSC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_PSC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (salary_cap_id                   number(15)
  ,funding_source_code             varchar2(30)
  ,start_date                      date
  ,end_date                        date
  ,currency_code                   varchar2(15)
  ,annual_salary_cap               number
  ,object_version_number           number(9)
  ,seed_flag                       varchar2(9)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PSP_SALARY_CAPS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
