--------------------------------------------------------
--  DDL for Package BEN_ESA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ESA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_svc_area_prte_id             number(15),
  ...
  esa_attribute_category            varchar2(30),
  esa_attribute1                    varchar2(150),
  esa_attribute2                    varchar2(150),
  esa_attribute3                    varchar2(150),
  esa_attribute4                    varchar2(150),
  esa_attribute5                    varchar2(150),
  esa_attribute6                    varchar2(150),
  esa_attribute7                    varchar2(150),
  esa_attribute8                    varchar2(150),
  esa_attribute9                    varchar2(150),
  esa_attribute10                   varchar2(150),
  esa_attribute11                   varchar2(150),
  esa_attribute12                   varchar2(150),
  esa_attribute13                   varchar2(150),
  esa_attribute14                   varchar2(150),
  esa_attribute15                   varchar2(150),
  esa_attribute16                   varchar2(150),
  esa_attribute17                   varchar2(150),
  esa_attribute18                   varchar2(150),
  esa_attribute19                   varchar2(150),
  esa_attribute20                   varchar2(150),
  esa_attribute21                   varchar2(150),
  esa_attribute22                   varchar2(150),
  esa_attribute23                   varchar2(150),
  esa_attribute24                   varchar2(150),
  esa_attribute25                   varchar2(150),
  esa_attribute26                   varchar2(150),
  esa_attribute27                   varchar2(150),
  esa_attribute28                   varchar2(150),
  esa_attribute29                   varchar2(150),
  esa_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_svc_area_prte_id).
--
-- Post Success:
--   Processing continues.
--
