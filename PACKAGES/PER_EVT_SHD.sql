--------------------------------------------------------
--  DDL for Package PER_EVT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_EVT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,organization_run_by_id          number(15)
  ...
  ,date_end                        date
  ,emp_or_apl                      varchar2(9)       -- Increased length
  ,event_or_interview              varchar2(30)
