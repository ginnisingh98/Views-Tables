--------------------------------------------------------
--  DDL for Package OTA_LST_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_LST_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_learning_path_section_id
--     already exists.
--
--  In Arguments:
