--------------------------------------------------------
--  DDL for Package PA_PAGE_TYPE_REGION_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PA_PAGE_TYPE_REGION_PVT" AUTHID CURRENT_USER AS
--$Header: PAPLPTVS.pls 120.1 2005/08/19 16:41:46 mwasowic noship $
