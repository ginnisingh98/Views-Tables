--------------------------------------------------------
--  DDL for Package PER_ZA_EQT_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_EQT_DEL" AUTHID CURRENT_USER as
/* $Header: pezaeqde.pkh 115.0 2001/02/04 22:32:10 pkm ship        $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< del >----------------------------------|
-- ----------------------------------------------------------------------------
