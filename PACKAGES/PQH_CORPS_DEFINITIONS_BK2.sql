--------------------------------------------------------
--  DDL for Package PQH_CORPS_DEFINITIONS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CORPS_DEFINITIONS_BK2" AUTHID CURRENT_USER as
/* $Header: pqcpdapi.pkh 120.1 2005/10/02 02:26:32 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_corps_definition_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_corps_definition_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_corps_definition_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_corps_definition_a
  (
  p_effective_date               in    date
  ,p_corps_definition_id          in    number
  ,p_business_group_id            in    number
