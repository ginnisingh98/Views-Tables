--------------------------------------------------------
--  DDL for Package BEN_PET_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PET_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  pl_id                             number(15),
  pgm_id                            number(15),
  pet_attribute_category            varchar2(30),
  pet_attribute1                    varchar2(150),
  pet_attribute2                    varchar2(150),
  pet_attribute3                    varchar2(150),
  pet_attribute4                    varchar2(150),
  pet_attribute5                    varchar2(150),
  pet_attribute6                    varchar2(150),
  pet_attribute7                    varchar2(150),
  pet_attribute8                    varchar2(150),
  pet_attribute9                    varchar2(150),
  pet_attribute10                   varchar2(150),
  pet_attribute11                   varchar2(150),
  pet_attribute12                   varchar2(150),
  pet_attribute13                   varchar2(150),
  pet_attribute14                   varchar2(150),
  pet_attribute15                   varchar2(150),
  pet_attribute16                   varchar2(150),
  pet_attribute17                   varchar2(150),
  pet_attribute18                   varchar2(150),
  pet_attribute19                   varchar2(150),
  pet_attribute20                   varchar2(150),
  pet_attribute21                   varchar2(150),
  pet_attribute22                   varchar2(150),
  pet_attribute23                   varchar2(150),
  pet_attribute24                   varchar2(150),
  pet_attribute25                   varchar2(150),
  pet_attribute26                   varchar2(150),
  pet_attribute27                   varchar2(150),
  pet_attribute28                   varchar2(150),
  pet_attribute29                   varchar2(150),
  pet_attribute30                   varchar2(150),
...
--           p_base_key_value = :popl_enrt_typ_cycl_id).
--
-- Post Success:
--   Processing continues.
--
