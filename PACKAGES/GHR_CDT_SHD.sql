--------------------------------------------------------
--  DDL for Package GHR_CDT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CDT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,request_date                    date
  ,complete_date                   date
  ,category                        varchar2(30)       -- Increased length
