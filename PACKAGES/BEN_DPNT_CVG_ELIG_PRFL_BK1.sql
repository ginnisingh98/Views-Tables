--------------------------------------------------------
--  DDL for Package BEN_DPNT_CVG_ELIG_PRFL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DPNT_CVG_ELIG_PRFL_BK1" AUTHID CURRENT_USER as
/* $Header: bedceapi.pkh 120.0.12010000.2 2010/04/07 06:40:30 pvelvano ship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_DPNT_CVG_ELIG_PRFL_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_DPNT_CVG_ELIG_PRFL_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_DPNT_CVG_ELIG_PRFL_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_DPNT_CVG_ELIG_PRFL_a
  (
...
--
end ben_DPNT_CVG_ELIG_PRFL_bk1;
