--------------------------------------------------------
--  DDL for Package BEN_CRD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CRD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  crt_ordr_cvrd_per_id              number(15),
  crt_ordr_id                       number(15),
  person_id                         number(15),
  business_group_id                 number(15),
  crd_attribute_category            varchar2(30),
  crd_attribute1                    varchar2(150),
  crd_attribute2                    varchar2(150),
  crd_attribute3                    varchar2(150),
  crd_attribute4                    varchar2(150),
  crd_attribute5                    varchar2(150),
  crd_attribute6                    varchar2(150),
  crd_attribute7                    varchar2(150),
  crd_attribute8                    varchar2(150),
  crd_attribute9                    varchar2(150),
  crd_attribute10                   varchar2(150),
  crd_attribute11                   varchar2(150),
  crd_attribute12                   varchar2(150),
  crd_attribute13                   varchar2(150),
  crd_attribute14                   varchar2(150),
  crd_attribute15                   varchar2(150),
  crd_attribute16                   varchar2(150),
  crd_attribute17                   varchar2(150),
  crd_attribute18                   varchar2(150),
  crd_attribute19                   varchar2(150),
  crd_attribute20                   varchar2(150),
  crd_attribute21                   varchar2(150),
  crd_attribute22                   varchar2(150),
  crd_attribute23                   varchar2(150),
  crd_attribute24                   varchar2(150),
  crd_attribute25                   varchar2(150),
  crd_attribute26                   varchar2(150),
  crd_attribute27                   varchar2(150),
  crd_attribute28                   varchar2(150),
  crd_attribute29                   varchar2(150),
  crd_attribute30                   varchar2(150),
