--------------------------------------------------------
--  DDL for Package JTF_RS_SALESREPS_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_RS_SALESREPS_CUHK" AUTHID CURRENT_USER AS
  /* $Header: jtfrscss.pls 120.0 2005/05/11 08:19:43 appldev ship $ */
