--------------------------------------------------------
--  DDL for Package BEN_PSG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PSG_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_PIL_ASSIGNMENT';
