--------------------------------------------------------
--  DDL for Package PER_RVT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RVT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,workbench_view_report_name      varchar2(520)
  ,wb_view_report_description      varchar2(520)
  ,source_lang                     varchar2(9)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_RI_VIEW_REPORTS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
