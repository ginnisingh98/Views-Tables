--------------------------------------------------------
--  DDL for Package IRC_CMP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_CMP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (communication_property_id       number(15)
  ,object_type                     varchar2(50)
  ,object_id                       number(15)
  ,default_comm_status             varchar2(50)
  ,allow_attachment_flag           varchar2(50)
  ,auto_notification_flag          varchar2(9)       -- Increased length
  ,allow_add_recipients            varchar2(50)
  ,default_moderator               varchar2(50)
  ...
  ,information1                    varchar2(50)
  ,information2                    varchar2(50)
  ,information3                    varchar2(50)
  ,information4                    varchar2(50)
  ,information5                    varchar2(50)
  ,information6                    varchar2(50)
  ,information7                    varchar2(50)
  ,information8                    varchar2(50)
  ,information9                    varchar2(50)
  ,information10                   varchar2(50)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_COMM_PROPERTIES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
