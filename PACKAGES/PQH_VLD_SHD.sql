--------------------------------------------------------
--  DDL for Package PQH_VLD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_VLD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (validation_id                   number(15)
  ,pension_fund_type_code          varchar2(30)
  ,pension_fund_id                 number(15)
  ,business_group_id               number(15)
  ,person_id                       number(15)
  ,request_date                    date
  ,completion_date                 date
  ,previous_employer_id            number(15)
  ,previously_validated_flag       varchar2(30)
  ,status                          varchar2(30)
  ,employer_amount                 number
  ,employer_currency_code          varchar2(15)
  ,employee_amount                 number
  ,employee_currency_code          varchar2(15)
  ,deduction_per_period            number
  ,deduction_currency_code         varchar2(30)
  ,percent_of_salary               number(22,3)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_FR_VALIDATIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
