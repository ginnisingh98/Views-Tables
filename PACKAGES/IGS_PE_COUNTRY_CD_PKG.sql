--------------------------------------------------------
--  DDL for Package IGS_PE_COUNTRY_CD_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PE_COUNTRY_CD_PKG" AUTHID CURRENT_USER AS
 /* $Header: IGSNI04S.pls 115.3 2002/11/29 01:14:41 nsidana ship $ */
