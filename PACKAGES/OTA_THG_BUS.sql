--------------------------------------------------------
--  DDL for Package OTA_THG_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_THG_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_gl_default_segment_id
--     already exists.
--
--  In Arguments:
