--------------------------------------------------------
--  DDL for Package PAY_ECU_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_ECU_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_element_class_usage_id
--     already exists.
--
--  In Arguments:
