--------------------------------------------------------
--  DDL for Package PER_STB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_STB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,setup_task_sequence             number(10)
  ,setup_task_status               varchar2(80)
  ,setup_task_creation_date        date
  ,setup_task_last_modified_date   date
  ,setup_task_type                 varchar2(80)
  ,setup_task_action               varchar2(520)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_RI_SETUP_TASKS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
