--------------------------------------------------------
--  DDL for Package PAY_LIV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_LIV_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_LINK_INPUT_VALUES_F';
...
--           p_base_key_value = :link_input_value_id).
--
-- Post Success:
--   Processing continues.
--
