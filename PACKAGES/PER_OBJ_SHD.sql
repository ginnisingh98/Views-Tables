--------------------------------------------------------
--  DDL for Package PER_OBJ_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_OBJ_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  objective_id                      number(15),
  name                              varchar2(400), -- Fix 5122263 (Prev fix 2462004)
  target_date                       date,
  start_date                        date,
  business_group_id                 number(15),
  object_version_number             number(9),
  owning_person_id                  number(15),
  achievement_date                   date,
  detail                            varchar2(4000),
  comments                          varchar2(4000),   -- pseudo column
  ...
  scorecard_id                    number(15),
  copied_from_library_id          number(15),
  copied_from_objective_id        number(15),
  aligned_with_objective_id       number(15),

  next_review_date                date,
  group_code                      varchar2(30),
  priority_code                   varchar2(30),
  appraise_flag                   varchar2(30),
  verified_flag                   varchar2(30),

  target_value                    number,
  actual_value                    number,
  weighting_percent               number(15),
  complete_percent                number(15),
  uom_code                        varchar2(30),

  measurement_style_code          varchar2(30),
  measure_name                    varchar2(240),
  measure_type_code               varchar2(30),
  measure_comments                varchar2(4000),
  sharing_access_code             varchar2(30)
...
g_tab_nam constant varchar2(30)  := 'PER_OBJECTIVES';
...
--
-- Post Failure: --   No direct error handling is required within this function. Any possible
