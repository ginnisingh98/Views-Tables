--------------------------------------------------------
--  DDL for Package BEN_XRS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XRS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  run_strt_dt                       date,
  run_end_dt                        date,
  ext_stat_cd                       varchar2(30),
  tot_rec_num                       number(15),
  tot_per_num                       number(15),
  tot_err_num                       number(15),
  eff_dt                            date,
  ext_strt_dt                       date,
  ext_end_dt                        date,
  output_name                       varchar2(110),
