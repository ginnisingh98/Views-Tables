--------------------------------------------------------
--  DDL for Package BEN_CCM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CCM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  mx_val                            number,
  mn_val                            number,
  no_mx_val_dfnd_flag               varchar2(30),
  no_mn_val_dfnd_flag               varchar2(30),
  rndg_cd                           varchar2(30),
  rndg_rl                           number(15),
  lwr_lmt_val                       number,
  ...
  ccm_attribute_category            varchar2(30),
  ccm_attribute1                    varchar2(150),
  ccm_attribute2                    varchar2(150),
  ccm_attribute3                    varchar2(150),
  ccm_attribute4                    varchar2(150),
  ccm_attribute5                    varchar2(150),
  ccm_attribute6                    varchar2(150),
  ccm_attribute7                    varchar2(150),
  ccm_attribute8                    varchar2(150),
  ccm_attribute9                    varchar2(150),
  ccm_attribute10                   varchar2(150),
  ccm_attribute11                   varchar2(150),
  ccm_attribute12                   varchar2(150),
  ccm_attribute13                   varchar2(150),
  ccm_attribute14                   varchar2(150),
  ccm_attribute15                   varchar2(150),
  ccm_attribute16                   varchar2(150),
  ccm_attribute17                   varchar2(150),
  ccm_attribute18                   varchar2(150),
  ccm_attribute19                   varchar2(150),
  ccm_attribute20                   varchar2(150),
  ccm_attribute21                   varchar2(150),
  ccm_attribute22                   varchar2(150),
  ccm_attribute23                   varchar2(150),
  ccm_attribute24                   varchar2(150),
  ccm_attribute25                   varchar2(150),
  ccm_attribute26                   varchar2(150),
  ccm_attribute27                   varchar2(150),
  ccm_attribute28                   varchar2(150),
  ccm_attribute29                   varchar2(150),
  ccm_attribute30                   varchar2(150),
...
--           p_base_key_value = :cvg_amt_calc_mthd_id).
--
-- Post Success:
--   Processing continues.
--
