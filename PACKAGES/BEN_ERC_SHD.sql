--------------------------------------------------------
--  DDL for Package BEN_ERC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ERC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  enrt_rt_ctfn_id                number(15),
  enrt_ctfn_typ_cd                  varchar2(30),
  rqd_flag                          varchar2(30),
  enrt_rt_id            number(15),
  business_group_id                 number(15),
  erc_attribute_category            varchar2(30),
  erc_attribute1                    varchar2(150),
  erc_attribute2                    varchar2(150),
  erc_attribute3                    varchar2(150),
  erc_attribute4                    varchar2(150),
  erc_attribute5                    varchar2(150),
  erc_attribute6                    varchar2(150),
  erc_attribute7                    varchar2(150),
  erc_attribute8                    varchar2(150),
  erc_attribute9                    varchar2(150),
  erc_attribute10                   varchar2(150),
  erc_attribute11                   varchar2(150),
  erc_attribute12                   varchar2(150),
  erc_attribute13                   varchar2(150),
  erc_attribute14                   varchar2(150),
  erc_attribute15                   varchar2(150),
  erc_attribute16                   varchar2(150),
  erc_attribute17                   varchar2(150),
  erc_attribute18                   varchar2(150),
  erc_attribute19                   varchar2(150),
  erc_attribute20                   varchar2(150),
  erc_attribute21                   varchar2(150),
  erc_attribute22                   varchar2(150),
  erc_attribute23                   varchar2(150),
  erc_attribute24                   varchar2(150),
  erc_attribute25                   varchar2(150),
  erc_attribute26                   varchar2(150),
  erc_attribute27                   varchar2(150),
  erc_attribute28                   varchar2(150),
  erc_attribute29                   varchar2(150),
  erc_attribute30                   varchar2(150),
