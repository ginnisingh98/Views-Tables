--------------------------------------------------------
--  DDL for Package JE_JEPTAPER_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JE_JEPTAPER_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: JEPTAPERS.pls 120.1 2007/12/25 16:58:51 dwkrishn noship $ */
  ...
  C_VAT_COUNTRY_CODE VARCHAR2(15);

  PLACE_REP_TITLE VARCHAR2(240);

  PLACE_COA_ID NUMBER;

  PLACE_SOB_NAME VARCHAR2(80);

  PLACE_FUNCT_CURR VARCHAR2(80);

  FUNCTION BEFOREREPORT RETURN BOOLEAN;

  FUNCTION AFTERREPORT RETURN BOOLEAN;

  FUNCTION C_VAT_COUNTRY_CODE_P RETURN VARCHAR2;

  FUNCTION PLACE_REP_TITLE_P RETURN VARCHAR2;

  FUNCTION PLACE_COA_ID_P RETURN NUMBER;
