--------------------------------------------------------
--  DDL for Package PAY_DK_PR_ASG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_DK_PR_ASG" AUTHID CURRENT_USER AS
 /* $Header: pydkprasg.pkh 120.5 2006/01/27 06:50:12 pgopal noship $ */
