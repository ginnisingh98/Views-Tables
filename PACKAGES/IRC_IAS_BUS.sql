--------------------------------------------------------
--  DDL for Package IRC_IAS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IAS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_assignment_status_id
--     already exists.
--
--  In Arguments:
