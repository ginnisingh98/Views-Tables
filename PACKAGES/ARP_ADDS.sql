--------------------------------------------------------
--  DDL for Package ARP_ADDS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARP_ADDS" AUTHID CURRENT_USER AS
/* $Header: ARPLLOCS.pls 120.6 2005/01/26 01:39:35 sachandr ship $ */
...
-- The following new signature is added for bug 3105634
PROCEDURE Set_Location_CCID(  Country        in out NOCOPY varchar2,
                              City           in out NOCOPY varchar2,
                              State          in out NOCOPY varchar2,
                              County         in out NOCOPY varchar2,
