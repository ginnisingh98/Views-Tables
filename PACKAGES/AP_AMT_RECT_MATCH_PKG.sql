--------------------------------------------------------
--  DDL for Package AP_AMT_RECT_MATCH_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_AMT_RECT_MATCH_PKG" AUTHID CURRENT_USER AS
/* $Header: apamorcs.pls 120.0 2005/05/20 22:44:37 bghose noship $ */
