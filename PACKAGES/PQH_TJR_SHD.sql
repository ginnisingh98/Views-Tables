--------------------------------------------------------
--  DDL for Package PQH_TJR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TJR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (txn_job_requirement_id          number(15)
  ,position_transaction_id         number(15)
  ,job_requirement_id              number(15)
  ,business_group_id               number(15)
  ,analysis_criteria_id            number(15)
  ,date_from                       date
  ,date_to                         date
  ,essential                       varchar2(30)
  ,job_id                          number(15)
