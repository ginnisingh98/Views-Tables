--------------------------------------------------------
--  DDL for Package AMS_EVTREGS_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_EVTREGS_VUHK" AUTHID CURRENT_USER as
/*$Header: amsiregs.pls 115.1 2002/11/16 00:47:48 dbiswas ship $*/

-- Start of Comments
-- Package name     : AMS_EvtRegs_VUHK
-- PURPOSE
