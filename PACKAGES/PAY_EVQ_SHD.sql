--------------------------------------------------------
--  DDL for Package PAY_EVQ_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EVQ_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (event_qualifier_id              number(9)
  ,effective_start_date            date
  ,effective_end_date              date
  ,dated_table_id                  number(15)
  ,column_name                     varchar2(30)
  ,qualifier_name                  varchar2(80)
  ,legislation_code                varchar2(30)
  ,business_group_id               number(9)
  ,comparison_column               varchar2(2000)
  ,qualifier_definition            varchar2(2000)
  ,qualifier_where_clause          varchar2(2000)
  ,entry_qualification             varchar2(2000)
  ,assignment_qualification        varchar2(2000)
  ,multi_event_sql                 varchar2(2000)
...
-- Global table name
g_tab_name  constant varchar2(30) := 'PAY_EVENT_QUALIFIERS_F';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :event_qualifier_id).
--
-- Post Success:
