--------------------------------------------------------
--  DDL for Package BEN_EQG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EQG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ELIG_QUA_IN_GR_PRTE_id                number(15),
  ...
  eqg_attribute_category            varchar2(30),
  eqg_attribute1                    varchar2(150),
  eqg_attribute2                    varchar2(150),
  eqg_attribute3                    varchar2(150),
  eqg_attribute4                    varchar2(150),
  eqg_attribute5                    varchar2(150),
  eqg_attribute6                    varchar2(150),
  eqg_attribute7                    varchar2(150),
  eqg_attribute8                    varchar2(150),
  eqg_attribute9                    varchar2(150),
  eqg_attribute10                   varchar2(150),
  eqg_attribute11                   varchar2(150),
  eqg_attribute12                   varchar2(150),
  eqg_attribute13                   varchar2(150),
  eqg_attribute14                   varchar2(150),
  eqg_attribute15                   varchar2(150),
  eqg_attribute16                   varchar2(150),
  eqg_attribute17                   varchar2(150),
  eqg_attribute18                   varchar2(150),
  eqg_attribute19                   varchar2(150),
  eqg_attribute20                   varchar2(150),
  eqg_attribute21                   varchar2(150),
  eqg_attribute22                   varchar2(150),
  eqg_attribute23                   varchar2(150),
  eqg_attribute24                   varchar2(150),
  eqg_attribute25                   varchar2(150),
  eqg_attribute26                   varchar2(150),
  eqg_attribute27                   varchar2(150),
  eqg_attribute28                   varchar2(150),
  eqg_attribute29                   varchar2(150),
  eqg_attribute30                   varchar2(150),
...
--           p_base_key_value = :ELIG_QUA_IN_GR_PRTE_id).
--
-- Post Success:
--   Processing continues.
--
