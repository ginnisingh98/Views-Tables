--------------------------------------------------------
--  DDL for Package HR_TIP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TIP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_template_item_tab_page_id already exists.
--
--  In Arguments:
