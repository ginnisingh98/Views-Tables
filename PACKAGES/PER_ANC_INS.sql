--------------------------------------------------------
--  DDL for Package PER_ANC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ANC_INS" AUTHID CURRENT_USER as
...
--   3. If a combination does exist the p_analysis_criteria_id is returned.
--
-- Pre Conditions:
--
-- In Arguments:
...
--   per_analysis_criteria and the out arguments are returned.
