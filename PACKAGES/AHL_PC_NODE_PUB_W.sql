--------------------------------------------------------
--  DDL for Package AHL_PC_NODE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_PC_NODE_PUB_W" AUTHID CURRENT_USER as
  /* $Header: AHLWPCNS.pls 115.8 2002/12/02 14:57:39 pbarman noship $ */
  procedure rosetta_table_copy_in_p8(t out nocopy ahl_pc_node_pub.pc_node_tbl, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p8(t ahl_pc_node_pub.pc_node_tbl, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure process_nodes(p_api_version  NUMBER
    ...
    , p5_a3 in out nocopy JTF_VARCHAR2_TABLE_2000
