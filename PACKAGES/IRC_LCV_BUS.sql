--------------------------------------------------------
--  DDL for Package IRC_LCV_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_LCV_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_location_criteria_value_id
--     already exists.
--
--  In Arguments:
