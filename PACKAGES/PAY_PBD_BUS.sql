--------------------------------------------------------
--  DDL for Package PAY_PBD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PBD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_bal_attribute_default_id
--     already exists.
--
--  In Arguments:
