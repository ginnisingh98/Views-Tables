--------------------------------------------------------
--  DDL for Package PER_SUB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SUB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  subjects_taken_id                 number(9),
  start_date                        date,
  major                             varchar2(30),
  subject_status                    varchar2(100),
  subject                           varchar2(30),
  ...
  sub_information_category          varchar2(30),
  sub_information1                  varchar2(150),
  sub_information2                  varchar2(150),
  sub_information3                  varchar2(150),
  sub_information4                  varchar2(150),
  sub_information5                  varchar2(150),
  sub_information6                  varchar2(150),
  sub_information7                  varchar2(150),
  sub_information8                  varchar2(150),
  sub_information9                  varchar2(150),
  sub_information10                 varchar2(150),
  sub_information11                 varchar2(150),
  sub_information12                 varchar2(150),
  sub_information13                 varchar2(150),
  sub_information14                 varchar2(150),
  sub_information15                 varchar2(150),
  sub_information16                 varchar2(150),
  sub_information17                 varchar2(150),
  sub_information18                 varchar2(150),
  sub_information19                 varchar2(150),
  sub_information20                 varchar2(150)
  );
