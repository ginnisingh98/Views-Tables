--------------------------------------------------------
--  DDL for Package BEN_REGULATORY_PURPOSE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_REGULATORY_PURPOSE_BK1" AUTHID CURRENT_USER as
/* $Header: beprpapi.pkh 120.0 2005/05/28 11:11:02 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_regulatory_purpose_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_regulatory_purpose_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_regulatory_purpose_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_regulatory_purpose_a
  (
...
--
end ben_regulatory_purpose_bk1;
