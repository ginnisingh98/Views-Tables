--------------------------------------------------------
--  DDL for Package PER_SHT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SHT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  shared_type_id                    number(15),
  business_group_id                 number(15),
  shared_type_name                  varchar2(80),
  shared_type_code                  varchar2(30),
  system_type_cd                    varchar2(30),
