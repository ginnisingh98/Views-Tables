--------------------------------------------------------
--  DDL for Package BEN_EEG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EEG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_enrld_anthr_pgm_id           number(15),
  ...
  eeg_attribute_category            varchar2(30),
  eeg_attribute1                    varchar2(150),
  eeg_attribute2                    varchar2(150),
  eeg_attribute3                    varchar2(150),
  eeg_attribute4                    varchar2(150),
  eeg_attribute5                    varchar2(150),
  eeg_attribute6                    varchar2(150),
  eeg_attribute7                    varchar2(150),
  eeg_attribute8                    varchar2(150),
  eeg_attribute9                    varchar2(150),
  eeg_attribute10                   varchar2(150),
  eeg_attribute11                   varchar2(150),
  eeg_attribute12                   varchar2(150),
  eeg_attribute13                   varchar2(150),
  eeg_attribute14                   varchar2(150),
  eeg_attribute15                   varchar2(150),
  eeg_attribute16                   varchar2(150),
  eeg_attribute17                   varchar2(150),
  eeg_attribute18                   varchar2(150),
  eeg_attribute19                   varchar2(150),
  eeg_attribute20                   varchar2(150),
  eeg_attribute21                   varchar2(150),
  eeg_attribute22                   varchar2(150),
  eeg_attribute23                   varchar2(150),
  eeg_attribute24                   varchar2(150),
  eeg_attribute25                   varchar2(150),
  eeg_attribute26                   varchar2(150),
  eeg_attribute27                   varchar2(150),
  eeg_attribute28                   varchar2(150),
  eeg_attribute29                   varchar2(150),
  eeg_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_enrld_anthr_pgm_id).
--
-- Post Success:
--   Processing continues.
--
