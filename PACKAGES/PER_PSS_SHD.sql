--------------------------------------------------------
--  DDL for Package PER_PSS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PSS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  survey_company_code               varchar2(30),
  identifier                        varchar2(9),
--ras  currency_code                     varchar2(15),
  survey_type_code                  varchar2(30),
  base_region                       varchar2(30),
