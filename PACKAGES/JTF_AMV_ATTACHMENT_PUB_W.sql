--------------------------------------------------------
--  DDL for Package JTF_AMV_ATTACHMENT_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_AMV_ATTACHMENT_PUB_W" AUTHID CURRENT_USER as
  /* $Header: jtfpatws.pls 120.3 2005/09/13 11:10:08 vimohan ship $ */
