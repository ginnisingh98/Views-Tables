--------------------------------------------------------
--  DDL for Package FF_FGL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FF_FGL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,global_name                     varchar2(80)
  ,global_description              varchar2(240)
  ,global_value                    varchar2(240)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'FF_GLOBALS_F';
