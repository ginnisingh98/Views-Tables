--------------------------------------------------------
--  DDL for Package BEN_PDT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PDT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_pymt_check_det_id
--     already exists.
--
--  In Arguments:
--    p_pymt_check_det_id
