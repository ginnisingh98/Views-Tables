--------------------------------------------------------
--  DDL for Package GHR_CPL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CPL_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_compl_person_id
--     already exists.
--
--  In Arguments:
--    p_compl_person_id
