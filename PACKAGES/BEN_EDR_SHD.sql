--------------------------------------------------------
--  DDL for Package BEN_EDR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EDR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_dsblty_rsn_prte_id              number(15),
  ...
  edr_attribute_category            varchar2(30),
  edr_attribute1                    varchar2(150),
  edr_attribute2                    varchar2(150),
  edr_attribute3                    varchar2(150),
  edr_attribute4                    varchar2(150),
  edr_attribute5                    varchar2(150),
  edr_attribute6                    varchar2(150),
  edr_attribute7                    varchar2(150),
  edr_attribute8                    varchar2(150),
  edr_attribute9                    varchar2(150),
  edr_attribute10                   varchar2(150),
  edr_attribute11                   varchar2(150),
  edr_attribute12                   varchar2(150),
  edr_attribute13                   varchar2(150),
  edr_attribute14                   varchar2(150),
  edr_attribute15                   varchar2(150),
  edr_attribute16                   varchar2(150),
  edr_attribute17                   varchar2(150),
  edr_attribute18                   varchar2(150),
  edr_attribute19                   varchar2(150),
  edr_attribute20                   varchar2(150),
  edr_attribute21                   varchar2(150),
  edr_attribute22                   varchar2(150),
  edr_attribute23                   varchar2(150),
  edr_attribute24                   varchar2(150),
  edr_attribute25                   varchar2(150),
  edr_attribute26                   varchar2(150),
  edr_attribute27                   varchar2(150),
  edr_attribute28                   varchar2(150),
  edr_attribute29                   varchar2(150),
  edr_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_dsblty_rsn_prte_id).
--
-- Post Success:
--   Processing continues.
--
