--------------------------------------------------------
--  DDL for Package HR_FGI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FGI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_form_data_group_item_id already exists.
--
--  In Arguments:
