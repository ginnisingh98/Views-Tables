--------------------------------------------------------
--  DDL for Package OE_HEADER_PAYMENT_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_HEADER_PAYMENT_UTIL" AUTHID CURRENT_USER AS
/* $Header: OEXUHPMS.pls 120.3.12010000.2 2009/08/18 16:19:56 amimukhe ship $ */

--  Attributes global constants

G_ATTRIBUTE1                  CONSTANT NUMBER := 1;
G_ATTRIBUTE2                  CONSTANT NUMBER := 2;
G_ATTRIBUTE3                  CONSTANT NUMBER := 3;
G_ATTRIBUTE4                  CONSTANT NUMBER := 4;
G_ATTRIBUTE5                  CONSTANT NUMBER := 5;
G_ATTRIBUTE6                  CONSTANT NUMBER := 6;
G_ATTRIBUTE7                  CONSTANT NUMBER := 7;
G_ATTRIBUTE8                  CONSTANT NUMBER := 8;
G_ATTRIBUTE9                  CONSTANT NUMBER := 9;
G_ATTRIBUTE10                 CONSTANT NUMBER := 10;
G_ATTRIBUTE11                 CONSTANT NUMBER := 11;
G_ATTRIBUTE12                 CONSTANT NUMBER := 12;
G_ATTRIBUTE13                 CONSTANT NUMBER := 13;
G_ATTRIBUTE14                 CONSTANT NUMBER := 14;
G_ATTRIBUTE15                 CONSTANT NUMBER := 15;
...
G_CHECK_NUMBER                CONSTANT NUMBER := 22;
G_CREDIT_CARD_APPROVAL_CODE   CONSTANT NUMBER := 23;
G_CREDIT_CARD_APPROVAL_DATE   CONSTANT NUMBER := 24;
G_CREDIT_CARD_CODE            CONSTANT NUMBER := 25;
G_CREDIT_CARD_EXPIRATION_DATE CONSTANT NUMBER := 26;
G_CREDIT_CARD_HOLDER_NAME     CONSTANT NUMBER := 27;
G_CREDIT_CARD_NUMBER          CONSTANT NUMBER := 28;
G_PAYMENT_LEVEL_CODE          CONSTANT NUMBER := 29;
G_COMMITMENT_APPLIED_AMOUNT   CONSTANT NUMBER := 30;
G_COMMITMENT_INTERFACED_AMOUNT  CONSTANT NUMBER := 31;
G_HEADER                      CONSTANT NUMBER := 32;
G_LINE                        CONSTANT NUMBER := 33;
...
G_PAYMENT_PERCENTAGE          CONSTANT NUMBER := 54; -- Added for bug 8478559


FUNCTION G_MISS_OE_AK_HPAYMENT_REC
RETURN OE_AK_HEADER_PAYMENTS_V%ROWTYPE;
