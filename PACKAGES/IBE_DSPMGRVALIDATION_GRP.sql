--------------------------------------------------------
--  DDL for Package IBE_DSPMGRVALIDATION_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IBE_DSPMGRVALIDATION_GRP" AUTHID CURRENT_USER AS
/* $Header: IBEGDVDS.pls 115.2 2002/08/15 17:25:59 jshang ship $ */


g_api_version CONSTANT NUMBER       := 1.0;
g_pkg_name   CONSTANT VARCHAR2(30):='IBE_DSPMGRVALIDATION_GRP';
...
-- 2. If Access Name already exists, message IBE_MSITE_DUP_ACCNAME is pushed on stack.
---------------------------------------------------------------------
...
---------------------------------------------------------------------
-- NOTES
--   1. This function is added to do validation before calling
--        create_item and update_item procedure in jtf_amv_item_pub
--   2. The old istore specific validation logic is removed from
--        jmes package. enhancement 2317704 is logged for this.
--   3. If the data is valid, return 0,
--       otherwise, -1
---------------------------------------------------------------------
