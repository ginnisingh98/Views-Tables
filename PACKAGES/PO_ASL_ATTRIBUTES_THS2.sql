--------------------------------------------------------
--  DDL for Package PO_ASL_ATTRIBUTES_THS2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PO_ASL_ATTRIBUTES_THS2" AUTHID CURRENT_USER as
/* $Header: POXA7LSS.pls 115.7 2003/08/21 09:42:29 tmanda ship $ */

/*===========================================================================
  PACKAGE NAME:		po_asl_attributes_ths2

  DESCRIPTION:		Table handlers for PO_ASL_ATTRIBUTES - part 3
...
/*===========================================================================
  ...
  DESCRIPTION:     	Lock table handler for PO_ASL_ATTRIBUTES
