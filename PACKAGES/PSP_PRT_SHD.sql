--------------------------------------------------------
--  DDL for Package PSP_PRT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_PRT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,period_frequency_id             number
  ,report_template_code            varchar2(80)
  ,display_all_emp_distrib_flag    varchar2(9)       -- Increased length
  ,manual_entry_override_flag      varchar2(9)       -- Increased length
  ,approval_type                   varchar2(30)
  ,custom_approval_code            varchar2(30)
  ,sup_levels                      number
  ,preview_effort_report_flag      varchar2(9)       -- Increased length
  ,notification_reminder_in_days   number
  ,sprcd_tolerance_amt             number
  ,sprcd_tolerance_percent         number
  ,description                     varchar2(1000)
  ,legislation_code                varchar2(30)
  ,hundred_pcent_eff_at_per_asg    varchar2(9)       -- Increased length
  ,selection_match_level           varchar2(9)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PSP_REPORT_TEMPLATES';
