--------------------------------------------------------
--  DDL for Package PER_PSE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PSE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_pos_structure_element_id
--     already exists.
--
--  In Arguments:
