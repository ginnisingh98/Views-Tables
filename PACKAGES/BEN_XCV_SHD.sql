--------------------------------------------------------
--  DDL for Package BEN_XCV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XCV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ext_crit_val_id                   number(15),
  val_1                             varchar2(90),
  val_2                             varchar2(90),
  ext_crit_typ_id                   number(15),
  business_group_id                 number(15),
  ext_crit_bg_id                    number(15),
