--------------------------------------------------------
--  DDL for Package PAY_PRF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PRF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_range_table_id
--     already exists.
--
--  In Arguments:
--    p_range_table_id
