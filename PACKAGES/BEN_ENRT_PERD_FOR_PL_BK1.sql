--------------------------------------------------------
--  DDL for Package BEN_ENRT_PERD_FOR_PL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ENRT_PERD_FOR_PL_BK1" AUTHID CURRENT_USER as
/* $Header: beerpapi.pkh 120.0 2005/05/28 02:53:00 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_enrt_perd_for_pl_b >-----------------|
-- ----------------------------------------------------------------------------
--
