--------------------------------------------------------
--  DDL for Package PER_SLS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SLS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (solution_set_name               varchar2(120)
  ,user_id                         number(15)
  ,description                     varchar2(240)
  ,status                          varchar2(120)
  ,solution_set_impl_id            number(9)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_SOLUTION_SETS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
