--------------------------------------------------------
--  DDL for Package OKL_OPTION_RULES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_OPTION_RULES_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUORLS.pls 115.3 2002/12/24 04:13:35 sgorantl noship $ */
