--------------------------------------------------------
--  DDL for Package PQH_BRE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_BRE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_reallocation_id
--     already exists.
--
--  In Arguments:
--    p_reallocation_id
