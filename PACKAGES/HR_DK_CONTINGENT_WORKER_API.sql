--------------------------------------------------------
--  DDL for Package HR_DK_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_DK_CONTINGENT_WORKER_API" AUTHID CURRENT_USER as
/* $Header: pecwkdki.pkh 120.4 2006/10/11 07:24:34 saurai noship $ */
/*#
 * This package contains contingent worker APIs.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Contingent Worker for Denmark
*/
--
-- ----------------------------------------------------------------------------
-- |------------------------------< create_dk_cwk >---------------------------|
...
-- {Start Of Comments}
/*#
 * The following procedure creates a Danish contingent worker.
 *
 ...
 * @rep:displayname Create Contingent Worker for Denmark
