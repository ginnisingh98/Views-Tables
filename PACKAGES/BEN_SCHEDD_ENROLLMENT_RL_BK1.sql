--------------------------------------------------------
--  DDL for Package BEN_SCHEDD_ENROLLMENT_RL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_SCHEDD_ENROLLMENT_RL_BK1" AUTHID CURRENT_USER as
/* $Header: beserapi.pkh 120.0 2005/05/28 11:50:19 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Schedd_Enrollment_Rl_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Schedd_Enrollment_Rl_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Schedd_Enrollment_Rl_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Schedd_Enrollment_Rl_a
  (
...
--
end ben_Schedd_Enrollment_Rl_bk1;
