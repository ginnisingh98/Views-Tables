--------------------------------------------------------
--  DDL for Package HXC_HAC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_HAC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (approval_comp_id                number(15)
  ,approval_style_id               number(15)
  ,time_recipient_id               number(15)
  ,approval_mechanism              varchar2(30)
  ,approval_mechanism_id           number(15)
  ,wf_item_type                    varchar2(9)       -- Increased length
  ,wf_name                         varchar2(30)
  ,start_date                      date
  ,end_date                        date
  ,object_version_number           number(9)
  ,approval_order                  number(15)
  ,time_category_id                number(15)
  ,parent_comp_id                  number(15)
  ,parent_comp_ovn                 number(9)
  ,run_recipient_extensions        varchar2(1)
  );
--
-- ----------------------------------------------------------------------------
