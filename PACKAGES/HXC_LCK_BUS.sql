--------------------------------------------------------
--  DDL for Package HXC_LCK_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_LCK_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_locker_type_id
--     already exists.
--
--  In Arguments:
--    p_locker_type_id
