--------------------------------------------------------
--  DDL for Package PAY_ISB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_ISB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,calculation_option              varchar2(30)
  ,reduced_tax_credit              number
  ,reduced_standard_cutoff         number
  ,incident_id                     number(15)
  ,request_id                      number(15)
  ,program_application_id          number(15)
  ,program_id                      varchar2(240)
...
--           p_base_key_value = :social_benefit_id).
--
-- Post Success:
