--------------------------------------------------------
--  DDL for Package IGS_PE_LANGUAGE_CD_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PE_LANGUAGE_CD_PKG" AUTHID CURRENT_USER AS
 /* $Header: IGSNI10S.pls 115.3 2002/11/29 01:16:25 nsidana ship $ */
