--------------------------------------------------------
--  DDL for Package JTF_TERR_1004_DEF_MGMT_DYN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_TERR_1004_DEF_MGMT_DYN" AUTHID CURRENT_USER AS
/* $Header: jtfvddds.pls 120.2 2005/09/14 00:08:03 achanda ship $ */
/*===========================================================================+
...
--    Start of Comments
--    ---------------------------------------------------
--    PACKAGE NAME:   JTF_TERR_1002_DEF_MGMT_DYN
--    ---------------------------------------------------
--    PURPOSE
...
END JTF_TERR_1004_DEF_MGMT_DYN;
