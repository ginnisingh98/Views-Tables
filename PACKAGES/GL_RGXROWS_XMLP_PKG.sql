--------------------------------------------------------
--  DDL for Package GL_RGXROWS_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GL_RGXROWS_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: RGXROWSS.pls 120.0 2007/12/27 15:38:01 vijranga noship $ */
