--------------------------------------------------------
--  DDL for Package BEN_ABI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ABI_UPD" AUTHID CURRENT_USER as
...
--   2) After the conversion has taken abrace, the corresponding record upd
