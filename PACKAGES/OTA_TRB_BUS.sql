--------------------------------------------------------
--  DDL for Package OTA_TRB_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TRB_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_resource_booking_id
--     already exists.
--
--  In Arguments:
