--------------------------------------------------------
--  DDL for Package BEN_ELIG_ENRLD_ANTHR_PTIP_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_ENRLD_ANTHR_PTIP_BK1" AUTHID CURRENT_USER as
/* $Header: beeetapi.pkh 120.0 2005/05/28 02:06:38 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_ENRLD_ANTHR_PTIP_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_ENRLD_ANTHR_PTIP_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_ENRLD_ANTHR_PTIP_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_ENRLD_ANTHR_PTIP_a
  (
...
--
end ben_ELIG_ENRLD_ANTHR_PTIP_bk1;
