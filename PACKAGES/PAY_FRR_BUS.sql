--------------------------------------------------------
--  DDL for Package PAY_FRR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_FRR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_formula_result_rule_id
--     already exists.
--
--  In Arguments:
...
--
-- Description:
--   This procedure sets the effective end date of the formula result rule
--   depending on the result rule.
--
-- Prerequisites:
--   This procedure is called from ins and del procedures.
--
-- Post Success:
--   Processing continues.
--
