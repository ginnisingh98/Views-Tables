--------------------------------------------------------
--  DDL for Package PER_BPR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_BPR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  payroll_run_id                    number(9),
  payroll_id                        number(9),
  business_group_id                 number(15),
  payroll_identifier                varchar2(30),
