--------------------------------------------------------
--  DDL for Package BEN_LBR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LBR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  plip_id    	 		    number(15),
  lbr_attribute_category            varchar2(30),
  lbr_attribute1                    varchar2(150),
  lbr_attribute2                    varchar2(150),
  lbr_attribute3                    varchar2(150),
  lbr_attribute4                    varchar2(150),
  lbr_attribute5                    varchar2(150),
  lbr_attribute6                    varchar2(150),
  lbr_attribute7                    varchar2(150),
  lbr_attribute8                    varchar2(150),
  lbr_attribute9                    varchar2(150),
  lbr_attribute10                   varchar2(150),
  lbr_attribute11                   varchar2(150),
  lbr_attribute12                   varchar2(150),
  lbr_attribute13                   varchar2(150),
  lbr_attribute14                   varchar2(150),
  lbr_attribute15                   varchar2(150),
  lbr_attribute16                   varchar2(150),
  lbr_attribute17                   varchar2(150),
  lbr_attribute18                   varchar2(150),
  lbr_attribute19                   varchar2(150),
  lbr_attribute20                   varchar2(150),
  lbr_attribute21                   varchar2(150),
  lbr_attribute22                   varchar2(150),
  lbr_attribute23                   varchar2(150),
  lbr_attribute24                   varchar2(150),
  lbr_attribute25                   varchar2(150),
  lbr_attribute26                   varchar2(150),
  lbr_attribute27                   varchar2(150),
  lbr_attribute28                   varchar2(150),
  lbr_attribute29                   varchar2(150),
  lbr_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_bnft_rstrn_id).
--
-- Post Success:
--   Processing continues.
--
