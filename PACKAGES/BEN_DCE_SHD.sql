--------------------------------------------------------
--  DDL for Package BEN_DCE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DCE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dpnt_cvg_eligy_prfl_id            number(15),
  effective_end_date                date,
  effective_start_date              date,
  business_group_id                 number(15),
  regn_id                           number(15),
  name                              varchar2(240), -- UTF8 Change Bug 2254683
  dpnt_cvg_eligy_prfl_stat_cd       varchar2(30),
  dce_desc                          varchar2(240),
--  military_status_rqmt_ind          varchar2(30),
  dpnt_cvg_elig_det_rl              number(15),
  dce_attribute_category            varchar2(30),
  dce_attribute1                    varchar2(150),
  dce_attribute2                    varchar2(150),
  dce_attribute3                    varchar2(150),
  dce_attribute4                    varchar2(150),
  dce_attribute5                    varchar2(150),
  dce_attribute6                    varchar2(150),
  dce_attribute7                    varchar2(150),
  dce_attribute8                    varchar2(150),
  dce_attribute9                    varchar2(150),
  dce_attribute10                   varchar2(150),
  dce_attribute11                   varchar2(150),
  dce_attribute12                   varchar2(150),
  dce_attribute13                   varchar2(150),
  dce_attribute14                   varchar2(150),
  dce_attribute15                   varchar2(150),
  dce_attribute16                   varchar2(150),
  dce_attribute17                   varchar2(150),
  dce_attribute18                   varchar2(150),
  dce_attribute19                   varchar2(150),
  dce_attribute20                   varchar2(150),
  dce_attribute21                   varchar2(150),
  dce_attribute22                   varchar2(150),
  dce_attribute23                   varchar2(150),
  dce_attribute24                   varchar2(150),
  dce_attribute25                   varchar2(150),
  dce_attribute26                   varchar2(150),
  dce_attribute27                   varchar2(150),
  dce_attribute28                   varchar2(150),
  dce_attribute29                   varchar2(150),
  dce_attribute30                   varchar2(150),
  object_version_number             number(9),
  dpnt_rlshp_flag                   varchar2(30),
  dpnt_age_flag                     varchar2(30),
  dpnt_stud_flag                    varchar2(30),
  dpnt_dsbld_flag                   varchar2(30),
  dpnt_mrtl_flag                    varchar2(30),
  dpnt_mltry_flag                   varchar2(30),
  dpnt_pstl_flag                    varchar2(30),
  dpnt_cvrd_in_anthr_pl_flag        varchar2(30),
  dpnt_dsgnt_crntly_enrld_flag      varchar2(30),
  dpnt_crit_flag                    varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :dpnt_cvg_eligy_prfl_id).
--
-- Post Success:
--   Processing continues.
--
