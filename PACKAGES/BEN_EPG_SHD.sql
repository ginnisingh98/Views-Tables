--------------------------------------------------------
--  DDL for Package BEN_EPG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_ppl_grp_prte_id              number(15),
  ...
  epg_attribute_category            varchar2(30),
  epg_attribute1                    varchar2(150),
  epg_attribute2                    varchar2(150),
  epg_attribute3                    varchar2(150),
  epg_attribute4                    varchar2(150),
  epg_attribute5                    varchar2(150),
  epg_attribute6                    varchar2(150),
  epg_attribute7                    varchar2(150),
  epg_attribute8                    varchar2(150),
  epg_attribute9                    varchar2(150),
  epg_attribute10                   varchar2(150),
  epg_attribute11                   varchar2(150),
  epg_attribute12                   varchar2(150),
  epg_attribute13                   varchar2(150),
  epg_attribute14                   varchar2(150),
  epg_attribute15                   varchar2(150),
  epg_attribute16                   varchar2(150),
  epg_attribute17                   varchar2(150),
  epg_attribute18                   varchar2(150),
  epg_attribute19                   varchar2(150),
  epg_attribute20                   varchar2(150),
  epg_attribute21                   varchar2(150),
  epg_attribute22                   varchar2(150),
  epg_attribute23                   varchar2(150),
  epg_attribute24                   varchar2(150),
  epg_attribute25                   varchar2(150),
  epg_attribute26                   varchar2(150),
  epg_attribute27                   varchar2(150),
  epg_attribute28                   varchar2(150),
  epg_attribute29                   varchar2(150),
  epg_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_ppl_grp_prte_id).
--
-- Post Success:
--   Processing continues.
--
