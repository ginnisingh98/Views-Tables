--------------------------------------------------------
--  DDL for Package AS_OPPORTUNITY_PUB_W2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AS_OPPORTUNITY_PUB_W2" AUTHID CURRENT_USER as
  /* $Header: asxwop2s.pls 120.2 2005/08/04 03:06 appldev ship $ */
