--------------------------------------------------------
--  DDL for Package BEN_ETP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ETP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ELIG_TTL_PRTT_PRTE_id             number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  excld_flag                        varchar2(30),
  no_mn_prtt_num_apls_flag          varchar2(30),
  no_mx_prtt_num_apls_flag          varchar2(30),
  ordr_num                          number(15),
  mn_prtt_num                       number(15),
  mx_prtt_num                       number(15),
  prtt_det_cd                       varchar2(30),
  prtt_det_rl                       number(15),
  eligy_prfl_id                     number(15),
  etp_attribute_category            varchar2(30),
  etp_attribute1                    varchar2(150),
  etp_attribute2                    varchar2(150),
  etp_attribute3                    varchar2(150),
  etp_attribute4                    varchar2(150),
  etp_attribute5                    varchar2(150),
  etp_attribute6                    varchar2(150),
  etp_attribute7                    varchar2(150),
  etp_attribute8                    varchar2(150),
  etp_attribute9                    varchar2(150),
  etp_attribute10                   varchar2(150),
  etp_attribute11                   varchar2(150),
  etp_attribute12                   varchar2(150),
  etp_attribute13                   varchar2(150),
  etp_attribute14                   varchar2(150),
  etp_attribute15                   varchar2(150),
  etp_attribute16                   varchar2(150),
  etp_attribute17                   varchar2(150),
  etp_attribute18                   varchar2(150),
  etp_attribute19                   varchar2(150),
  etp_attribute20                   varchar2(150),
  etp_attribute21                   varchar2(150),
  etp_attribute22                   varchar2(150),
  etp_attribute23                   varchar2(150),
  etp_attribute24                   varchar2(150),
  etp_attribute25                   varchar2(150),
  etp_attribute26                   varchar2(150),
  etp_attribute27                   varchar2(150),
  etp_attribute28                   varchar2(150),
  etp_attribute29                   varchar2(150),
  etp_attribute30                   varchar2(150),
...
--           p_base_key_value = :ELIG_TTL_PRTT_PRTE_id).
--
-- Post Success:
--   Processing continues.
--
