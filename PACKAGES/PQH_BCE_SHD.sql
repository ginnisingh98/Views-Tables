--------------------------------------------------------
--  DDL for Package PQH_BCE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_BCE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  bdgt_cmmtmnt_elmnt_id             number(15),
  budget_id                         number(15),
  actual_commitment_type            varchar2(10),
  element_type_id                   number(9),
  salary_basis_flag                 varchar2(10),
  element_input_value_id            number(9),
  balance_type_id                   number(9),
  frequency_input_value_id          number(9),
  formula_id                        number(9),
  dflt_elmnt_frequency              varchar2(30),
  overhead_percentage               number(9,2),      -- Increased length
