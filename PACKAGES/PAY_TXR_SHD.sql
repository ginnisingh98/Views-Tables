--------------------------------------------------------
--  DDL for Package PAY_TXR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_TXR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,taxability_rules_date_id        number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_TAXABILITY_RULES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
