--------------------------------------------------------
--  DDL for Package PO_ASL_ATTRIBUTES_THS1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PO_ASL_ATTRIBUTES_THS1" AUTHID CURRENT_USER as
/* $Header: POXA6LSS.pls 115.7 2003/08/21 09:39:39 tmanda ship $ */

/*===========================================================================
  PACKAGE NAME:		po_asl_attributes_th1

  DESCRIPTION:		Table handlers for PO_ASL_ATTRIBUTES - part 2
...
/*===========================================================================
  ...
  DESCRIPTION:     	Update table handler for PO_ASL_ATTRIBUTES
