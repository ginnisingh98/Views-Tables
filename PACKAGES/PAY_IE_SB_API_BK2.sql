--------------------------------------------------------
--  DDL for Package PAY_IE_SB_API_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_IE_SB_API_BK2" AUTHID CURRENT_USER as
/* $Header: pyisbapi.pkh 120.0 2005/05/29 06:01:35 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< update_ie_sb_details_b >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_ie_sb_details_b
...
--
-- ----------------------------------------------------------------------------
-- |------------------------< update_ie_sb_details_a >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_ie_sb_details_a
  (p_effective_date                 in      date
  ,p_business_group_id              in      number
  ,p_datetrack_update_mode          in      varchar2
  ,p_absence_start_date             in      date
