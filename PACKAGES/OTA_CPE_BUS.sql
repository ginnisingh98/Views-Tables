--------------------------------------------------------
--  DDL for Package OTA_CPE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CPE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cert_prd_enrollment_id
--     already exists.
--
--  In Arguments:
