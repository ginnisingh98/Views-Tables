--------------------------------------------------------
--  DDL for Package PER_PSP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PSP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_spinal_point_id
--     already exists.
--
--  In Arguments:
--    p_spinal_point_id
