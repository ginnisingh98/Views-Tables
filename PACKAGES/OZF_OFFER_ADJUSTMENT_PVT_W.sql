--------------------------------------------------------
--  DDL for Package OZF_OFFER_ADJUSTMENT_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_OFFER_ADJUSTMENT_PVT_W" AUTHID CURRENT_USER as
  /* $Header: ozfwoads.pls 120.1 2005/09/20 17:34 rssharma noship $ */
