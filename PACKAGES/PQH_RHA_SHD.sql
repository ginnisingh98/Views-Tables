--------------------------------------------------------
--  DDL for Package PQH_RHA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RHA_SHD" AUTHID CURRENT_USER as
