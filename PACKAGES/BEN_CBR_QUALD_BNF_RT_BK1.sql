--------------------------------------------------------
--  DDL for Package BEN_CBR_QUALD_BNF_RT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CBR_QUALD_BNF_RT_BK1" AUTHID CURRENT_USER as
/* $Header: becqrapi.pkh 120.0 2005/05/28 01:20:21 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_CBR_QUALD_BNF_RT_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_cbr_quald_bnf_rt_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_cbr_quald_bnf_rt_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_cbr_quald_bnf_rt_a
  (
