--------------------------------------------------------
--  DDL for Package PER_APL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_APL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  current_employer                  varchar2(30),
  date_end                          date,
  projected_hire_date               date,
  successful_flag                   varchar2(30),
  termination_reason                varchar2(30),
  request_id                        number(15),
  program_application_id            number(15),
  program_id                        number(15),
  program_update_date               date,
  appl_attribute_category           varchar2(30),
  appl_attribute1                   varchar2(150),
  appl_attribute2                   varchar2(150),
  appl_attribute3                   varchar2(150),
  appl_attribute4                   varchar2(150),
  appl_attribute5                   varchar2(150),
  appl_attribute6                   varchar2(150),
  appl_attribute7                   varchar2(150),
  appl_attribute8                   varchar2(150),
  appl_attribute9                   varchar2(150),
  appl_attribute10                  varchar2(150),
  appl_attribute11                  varchar2(150),
  appl_attribute12                  varchar2(150),
  appl_attribute13                  varchar2(150),
  appl_attribute14                  varchar2(150),
  appl_attribute15                  varchar2(150),
  appl_attribute16                  varchar2(150),
  appl_attribute17                  varchar2(150),
  appl_attribute18                  varchar2(150),
  appl_attribute19                  varchar2(150),
  appl_attribute20                  varchar2(150),
...
g_tab_nam  constant varchar2(30) :='PER_APPLICATIONS';
--
-- ----------------------------------------------------------------------------
