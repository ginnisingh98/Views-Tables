--------------------------------------------------------
--  DDL for Package OKC_CONTRACT_PARTY_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_CONTRACT_PARTY_PVT" AUTHID CURRENT_USER as
/* $Header: OKCCCPLS.pls 120.0 2005/05/25 19:23:22 appldev noship $ */
  -- complex entity object subtype definitions
  subtype ctcv_rec_type is OKC_CTC_PVT.ctcv_rec_type;
  subtype ctcv_tbl_type is OKC_CTC_PVT.ctcv_tbl_type;
  subtype cplv_rec_type is OKC_CPL_PVT.cplv_rec_type;
  subtype cplv_tbl_type is OKC_CPL_PVT.cplv_tbl_type;
