--------------------------------------------------------
--  DDL for Package BEN_ELN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_lgl_enty_prte_id             number(15),
  ...
  eln_attribute_category            varchar2(30),
  eln_attribute1                    varchar2(150),
  eln_attribute2                    varchar2(150),
  eln_attribute3                    varchar2(150),
  eln_attribute4                    varchar2(150),
  eln_attribute5                    varchar2(150),
  eln_attribute6                    varchar2(150),
  eln_attribute7                    varchar2(150),
  eln_attribute8                    varchar2(150),
  eln_attribute9                    varchar2(150),
  eln_attribute10                   varchar2(150),
  eln_attribute11                   varchar2(150),
  eln_attribute12                   varchar2(150),
  eln_attribute13                   varchar2(150),
  eln_attribute14                   varchar2(150),
  eln_attribute15                   varchar2(150),
  eln_attribute16                   varchar2(150),
  eln_attribute17                   varchar2(150),
  eln_attribute18                   varchar2(150),
  eln_attribute19                   varchar2(150),
  eln_attribute20                   varchar2(150),
  eln_attribute21                   varchar2(150),
  eln_attribute22                   varchar2(150),
  eln_attribute23                   varchar2(150),
  eln_attribute24                   varchar2(150),
  eln_attribute25                   varchar2(150),
  eln_attribute26                   varchar2(150),
  eln_attribute27                   varchar2(150),
  eln_attribute28                   varchar2(150),
  eln_attribute29                   varchar2(150),
  eln_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_lgl_enty_prte_id).
--
-- Post Success:
--   Processing continues.
--
