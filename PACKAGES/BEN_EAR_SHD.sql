--------------------------------------------------------
--  DDL for Package BEN_EAR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EAR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  enrld_anthr_plip_rt_id          number(15),
  ...
  ear_attribute_category            varchar2(30),
  ear_attribute1                    varchar2(150),
  ear_attribute2                    varchar2(150),
  ear_attribute3                    varchar2(150),
  ear_attribute4                    varchar2(150),
  ear_attribute5                    varchar2(150),
  ear_attribute6                    varchar2(150),
  ear_attribute7                    varchar2(150),
  ear_attribute8                    varchar2(150),
  ear_attribute9                    varchar2(150),
  ear_attribute10                   varchar2(150),
  ear_attribute11                   varchar2(150),
  ear_attribute12                   varchar2(150),
  ear_attribute13                   varchar2(150),
  ear_attribute14                   varchar2(150),
  ear_attribute15                   varchar2(150),
  ear_attribute16                   varchar2(150),
  ear_attribute17                   varchar2(150),
  ear_attribute18                   varchar2(150),
  ear_attribute19                   varchar2(150),
  ear_attribute20                   varchar2(150),
  ear_attribute21                   varchar2(150),
  ear_attribute22                   varchar2(150),
  ear_attribute23                   varchar2(150),
  ear_attribute24                   varchar2(150),
  ear_attribute25                   varchar2(150),
  ear_attribute26                   varchar2(150),
  ear_attribute27                   varchar2(150),
  ear_attribute28                   varchar2(150),
  ear_attribute29                   varchar2(150),
  ear_attribute30                   varchar2(150),
...
--           p_base_key_value = :enrld_anthr_plip_rt_id).
--
-- Post Success:
--   Processing continues.
--
