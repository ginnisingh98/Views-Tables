--------------------------------------------------------
--  DDL for Package PAY_ITR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_ITR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_iterative_rule_id
--     already exists.
--
--  In Arguments:
--    p_iterative_rule_id
