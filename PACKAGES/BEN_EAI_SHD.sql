--------------------------------------------------------
--  DDL for Package BEN_EAI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EAI_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_enrld_anthr_plip_id          number(15),
  ...
  eai_attribute_category            varchar2(30),
  eai_attribute1                    varchar2(150),
  eai_attribute2                    varchar2(150),
  eai_attribute3                    varchar2(150),
  eai_attribute4                    varchar2(150),
  eai_attribute5                    varchar2(150),
  eai_attribute6                    varchar2(150),
  eai_attribute7                    varchar2(150),
  eai_attribute8                    varchar2(150),
  eai_attribute9                    varchar2(150),
  eai_attribute10                   varchar2(150),
  eai_attribute11                   varchar2(150),
  eai_attribute12                   varchar2(150),
  eai_attribute13                   varchar2(150),
  eai_attribute14                   varchar2(150),
  eai_attribute15                   varchar2(150),
  eai_attribute16                   varchar2(150),
  eai_attribute17                   varchar2(150),
  eai_attribute18                   varchar2(150),
  eai_attribute19                   varchar2(150),
  eai_attribute20                   varchar2(150),
  eai_attribute21                   varchar2(150),
  eai_attribute22                   varchar2(150),
  eai_attribute23                   varchar2(150),
  eai_attribute24                   varchar2(150),
  eai_attribute25                   varchar2(150),
  eai_attribute26                   varchar2(150),
  eai_attribute27                   varchar2(150),
  eai_attribute28                   varchar2(150),
  eai_attribute29                   varchar2(150),
  eai_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_enrld_anthr_plip_id).
--
-- Post Success:
--   Processing continues.
--
