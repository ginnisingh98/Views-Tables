--------------------------------------------------------
--  DDL for Package PER_PSV_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PSV_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_pos_structure_version_id
--     already exists.
--
--  In Arguments:
