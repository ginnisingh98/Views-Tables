--------------------------------------------------------
--  DDL for Package XDP_INTERFACES_OD_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XDP_INTERFACES_OD_VUHK" AUTHID CURRENT_USER AS
/* $Header: XDPODVHS.pls 120.2 2005/07/07 02:09:28 appldev ship $ */
