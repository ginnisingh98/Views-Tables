--------------------------------------------------------
--  DDL for Package IRC_IAD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IAD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_assignment_details_id
--     already exists.
--
--  In Arguments:
