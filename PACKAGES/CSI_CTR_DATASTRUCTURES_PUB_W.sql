--------------------------------------------------------
--  DDL for Package CSI_CTR_DATASTRUCTURES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CSI_CTR_DATASTRUCTURES_PUB_W" AUTHID CURRENT_USER as
  /* $Header: csitcdws.pls 120.10 2008/03/26 09:12:11 ngoutam ship $ */
