--------------------------------------------------------
--  DDL for Package HRDPP_UPDATE_IN_PASSPORT_DETAI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HRDPP_UPDATE_IN_PASSPORT_DETAI" as
/*
...
,P_ISSUING_COUNTRY in varchar2 default null);
--
procedure call
