--------------------------------------------------------
--  DDL for Package OTA_BJT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_BJT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,justification_text              varchar2(80)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_BKNG_JUSTIFICATIONS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
