--------------------------------------------------------
--  DDL for Package PQH_TCT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TCT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  custom_wf_process_name            varchar2(30),
  custom_workflow_name              varchar2(30),
  form_name                         varchar2(30),
  freeze_status_cd                  varchar2(30),
  future_action_cd                  varchar2(30),
  member_cd                         varchar2(30),
  name                              varchar2(100),
  short_name                        varchar2(30),
  post_style_cd                     varchar2(30),
  post_txn_function                 varchar2(61),
  route_validated_txn_flag          varchar2(10),
  prevent_approver_skip             varchar2(10),
  workflow_enable_flag              varchar2(10),
  enable_flag              varchar2(10),
  timeout_days                      number(9),        -- Increased length
  object_version_number             number(9),
  consolidated_table_route_id       number(15),
  business_group_id                 number(15),
  setup_type_cd                     varchar2(30),
  master_table_route_id       number(15)
  );
--
-- ----------------------------------------------------------------------------
