--------------------------------------------------------
--  DDL for Package OE_PRICE_ORDER_PVT_W_OBSOLETE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_PRICE_ORDER_PVT_W_OBSOLETE" AUTHID CURRENT_USER as
  /* $Header: OERVPROS.pls 115.2 2004/05/19 21:37:39 lchen noship $ */
