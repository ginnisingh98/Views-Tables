--------------------------------------------------------
--  DDL for Package PER_ANC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ANC_UPD" AUTHID CURRENT_USER as
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out NOCOPY per_anc_shd.g_rec_type);
--
-- ----------------------------------------------------------------------------
-- |-------------------------------< upd_or_sel >-----------------------------|
-- ----------------------------------------------------------------------------
...
--   functionality of per_anc_ins.ins_or_sel except is has to take into
...
--      returning the new p_analysis_criteria_id.
...
--   the per_analysis_criteria table and the out arguments are returned.
