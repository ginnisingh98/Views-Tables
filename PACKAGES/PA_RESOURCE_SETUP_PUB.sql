--------------------------------------------------------
--  DDL for Package PA_RESOURCE_SETUP_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PA_RESOURCE_SETUP_PUB" AUTHID CURRENT_USER AS
/* $Header: PARESTPS.pls 120.1 2005/08/19 16:51:02 mwasowic noship $ */
