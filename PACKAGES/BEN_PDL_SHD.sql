--------------------------------------------------------
--  DDL for Package BEN_PDL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PDL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ptd_lmt_id                        number(15),
  effective_start_date              date,
  effective_end_date                date,
  name                              varchar2(240),
  mx_comp_to_cnsdr                  number,
  mx_val                            number,
  mx_pct_val                        number,
  ptd_lmt_calc_rl                   number(15),
  lmt_det_cd                        varchar2(30),
  comp_lvl_fctr_id                  number(15),
  balance_type_id                   number(15),
  business_group_id                 number(15),
  pdl_attribute_category            varchar2(30),
  pdl_attribute1                    varchar2(150),
  pdl_attribute2                    varchar2(150),
  pdl_attribute3                    varchar2(150),
  pdl_attribute4                    varchar2(150),
  pdl_attribute5                    varchar2(150),
  pdl_attribute6                    varchar2(150),
  pdl_attribute7                    varchar2(150),
  pdl_attribute8                    varchar2(150),
  pdl_attribute9                    varchar2(150),
  pdl_attribute10                   varchar2(150),
  pdl_attribute11                   varchar2(150),
  pdl_attribute12                   varchar2(150),
  pdl_attribute13                   varchar2(150),
  pdl_attribute14                   varchar2(150),
  pdl_attribute15                   varchar2(150),
  pdl_attribute16                   varchar2(150),
  pdl_attribute17                   varchar2(150),
  pdl_attribute18                   varchar2(150),
  pdl_attribute19                   varchar2(150),
  pdl_attribute20                   varchar2(150),
  pdl_attribute21                   varchar2(150),
  pdl_attribute22                   varchar2(150),
  pdl_attribute23                   varchar2(150),
  pdl_attribute24                   varchar2(150),
  pdl_attribute25                   varchar2(150),
  pdl_attribute26                   varchar2(150),
  pdl_attribute27                   varchar2(150),
  pdl_attribute28                   varchar2(150),
  pdl_attribute29                   varchar2(150),
  pdl_attribute30                   varchar2(150),
