--------------------------------------------------------
--  DDL for Package PER_SOL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SOL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (solution_name                   varchar2(120)
  ,solution_id                     number(15)
  ,description                     varchar2(240)
  ,link_to_full_description        varchar2(150)
  ,solution_type_name              varchar2(120)
  ,vertical                        varchar2(120)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_SOLUTIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
