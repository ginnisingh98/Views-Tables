--------------------------------------------------------
--  DDL for Package OTA_TPS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TPS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,plan_status_type_id             varchar2(30)
  ,organization_id                 number(15)
  ,person_id                       number(9)
  ,budget_currency                 varchar2(15)
  ,name                            varchar2(80)
  ...
  ,plan_source                     varchar2(30)  --changed
  ,start_date                      date
  ,end_date                        date
  ,creator_person_id               number(9)
  ,additional_member_flag          varchar2(10)
...
g_tab_nam  constant varchar2(30) := 'OTA_TRAINING_PLANS' ;
--
-- ----------------------------------------------------------------------------
