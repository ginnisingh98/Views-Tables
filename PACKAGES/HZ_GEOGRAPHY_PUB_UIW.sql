--------------------------------------------------------
--  DDL for Package HZ_GEOGRAPHY_PUB_UIW
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HZ_GEOGRAPHY_PUB_UIW" AUTHID CURRENT_USER AS
/*$Header: ARHGEOWS.pls 120.2 2006/02/17 09:09:06 idali noship $ */
...
TYPE geo_identifier_rec_type IS RECORD(
  ...
  created_by_module     VARCHAR2(150),
  application_id	NUMBER,
  new_identifier_value VARCHAR2(360),  -- Bug 4578867
