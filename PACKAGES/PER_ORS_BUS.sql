--------------------------------------------------------
--  DDL for Package PER_ORS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ORS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_organization_structure_id
--     already exists.
--
--  In Arguments:
