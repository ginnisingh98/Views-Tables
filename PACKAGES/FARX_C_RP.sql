--------------------------------------------------------
--  DDL for Package FARX_C_RP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FARX_C_RP" AUTHID CURRENT_USER AS
/* $Header: FARXCRPS.pls 120.2.12010000.2 2009/07/19 11:54:51 glchen ship $ */

/*=====================================================================================+
|
|   Name:          Mass_Reclass_Preview
|
|   Description:   Concurrent wrapper procedure for mass reclass preview.
|		   This procedure calls the inner procedure,
|		   FARX_RP.Preview_Reclass() that actually performs
|		   preview of a mass reclass transaction.
|
