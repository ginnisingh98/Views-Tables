--------------------------------------------------------
--  DDL for Package AMS_CAT_ACTIVITY_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_CAT_ACTIVITY_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswcacs.pls 120.1 2005/11/23 05:22 vmodur noship $ */
