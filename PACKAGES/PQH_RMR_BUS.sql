--------------------------------------------------------
--  DDL for Package PQH_RMR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RMR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_rate_matrix_rate_id
--     already exists.
--
--  In Arguments:
