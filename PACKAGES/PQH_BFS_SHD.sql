--------------------------------------------------------
--  DDL for Package PQH_BFS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_BFS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  budget_fund_src_id                number(10),
  budget_element_id                 number(15),
