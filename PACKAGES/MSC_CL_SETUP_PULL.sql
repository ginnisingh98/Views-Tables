--------------------------------------------------------
--  DDL for Package MSC_CL_SETUP_PULL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."MSC_CL_SETUP_PULL" AUTHID CURRENT_USER AS -- specification
/* $Header: MSCPSTPS.pls 120.0 2007/04/05 11:48:23 vpalla noship $ */
