--------------------------------------------------------
--  DDL for Package BEN_EPM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  enrld_anthr_pgm_rt_id           number(15),
  ...
  epm_attribute_category            varchar2(30),
  epm_attribute1                    varchar2(150),
  epm_attribute2                    varchar2(150),
  epm_attribute3                    varchar2(150),
  epm_attribute4                    varchar2(150),
  epm_attribute5                    varchar2(150),
  epm_attribute6                    varchar2(150),
  epm_attribute7                    varchar2(150),
  epm_attribute8                    varchar2(150),
  epm_attribute9                    varchar2(150),
  epm_attribute10                   varchar2(150),
  epm_attribute11                   varchar2(150),
  epm_attribute12                   varchar2(150),
  epm_attribute13                   varchar2(150),
  epm_attribute14                   varchar2(150),
  epm_attribute15                   varchar2(150),
  epm_attribute16                   varchar2(150),
  epm_attribute17                   varchar2(150),
  epm_attribute18                   varchar2(150),
  epm_attribute19                   varchar2(150),
  epm_attribute20                   varchar2(150),
  epm_attribute21                   varchar2(150),
  epm_attribute22                   varchar2(150),
  epm_attribute23                   varchar2(150),
  epm_attribute24                   varchar2(150),
  epm_attribute25                   varchar2(150),
  epm_attribute26                   varchar2(150),
  epm_attribute27                   varchar2(150),
  epm_attribute28                   varchar2(150),
  epm_attribute29                   varchar2(150),
  epm_attribute30                   varchar2(150),
...
--           p_base_key_value = :enrld_anthr_pgm_rt_id).
--
-- Post Success:
--   Processing continues.
--
