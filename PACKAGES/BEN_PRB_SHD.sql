--------------------------------------------------------
--  DDL for Package BEN_PRB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  quald_dt                          date,
  quald_flag                        varchar2(30),
  regy_pl_name                      varchar2(240),
  aprvd_trmn_dt                     date,
  prb_attribute_category            varchar2(30),
  prb_attribute1                    varchar2(150),
  prb_attribute2                    varchar2(150),
  prb_attribute3                    varchar2(150),
  prb_attribute4                    varchar2(150),
  prb_attribute5                    varchar2(150),
  prb_attribute6                    varchar2(150),
  prb_attribute7                    varchar2(150),
  prb_attribute8                    varchar2(150),
  prb_attribute9                    varchar2(150),
  prb_attribute10                   varchar2(150),
  prb_attribute11                   varchar2(150),
  prb_attribute12                   varchar2(150),
  prb_attribute13                   varchar2(150),
  prb_attribute14                   varchar2(150),
  prb_attribute15                   varchar2(150),
  prb_attribute16                   varchar2(150),
  prb_attribute17                   varchar2(150),
  prb_attribute18                   varchar2(150),
  prb_attribute19                   varchar2(150),
  prb_attribute20                   varchar2(150),
  prb_attribute21                   varchar2(150),
  prb_attribute22                   varchar2(150),
  prb_attribute23                   varchar2(150),
  prb_attribute24                   varchar2(150),
  prb_attribute25                   varchar2(150),
  prb_attribute26                   varchar2(150),
  prb_attribute27                   varchar2(150),
  prb_attribute28                   varchar2(150),
  prb_attribute29                   varchar2(150),
  prb_attribute30                   varchar2(150),
...
--           p_base_key_value = :pl_regy_bod_id).
--
-- Post Success:
--   Processing continues.
--
