--------------------------------------------------------
--  DDL for Package BEN_ENP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ENP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  bdgt_upd_strt_dt                date,
  bdgt_upd_end_dt                 date,
  ws_upd_strt_dt                  date,
  ws_upd_end_dt                   date,
  dflt_ws_acc_cd                  varchar2(30),
  prsvr_bdgt_cd                   varchar2(30),
  uses_bdgt_flag                  varchar2(30),
  auto_distr_flag                 varchar2(30),
  hrchy_to_use_cd                 varchar2(30),
  pos_structure_version_id           number(15),
  emp_interview_type_cd           varchar2(30),
  wthn_yr_perd_id                 number(15),
  ler_id                          number(15),
  perf_revw_strt_dt               date,
  asg_updt_eff_date               date,
  enp_attribute_category            varchar2(30),
  enp_attribute1                    varchar2(150),
  enp_attribute2                    varchar2(150),
  enp_attribute3                    varchar2(150),
  enp_attribute4                    varchar2(150),
  enp_attribute5                    varchar2(150),
  enp_attribute6                    varchar2(150),
  enp_attribute7                    varchar2(150),
  enp_attribute8                    varchar2(150),
  enp_attribute9                    varchar2(150),
  enp_attribute10                   varchar2(150),
  enp_attribute11                   varchar2(150),
  enp_attribute12                   varchar2(150),
  enp_attribute13                   varchar2(150),
  enp_attribute14                   varchar2(150),
  enp_attribute15                   varchar2(150),
  enp_attribute16                   varchar2(150),
  enp_attribute17                   varchar2(150),
  enp_attribute18                   varchar2(150),
  enp_attribute19                   varchar2(150),
  enp_attribute20                   varchar2(150),
  enp_attribute21                   varchar2(150),
  enp_attribute22                   varchar2(150),
  enp_attribute23                   varchar2(150),
  enp_attribute24                   varchar2(150),
  enp_attribute25                   varchar2(150),
  enp_attribute26                   varchar2(150),
  enp_attribute27                   varchar2(150),
  enp_attribute28                   varchar2(150),
  enp_attribute29                   varchar2(150),
  enp_attribute30                   varchar2(150),
  enrt_perd_det_ovrlp_bckdt_cd      varchar2(30),
  --cwb
  data_freeze_date                date         ,
  Sal_chg_reason_cd               varchar2(30) ,
  Approval_mode_cd                varchar2(30) ,
  hrchy_ame_trn_cd                varchar2(30) ,
  hrchy_rl                        number(15)   ,
  hrchy_ame_app_id                number(15)   ,
  --
