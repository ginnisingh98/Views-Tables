--------------------------------------------------------
--  DDL for Package BEN_POPL_RPTG_GRP_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_POPL_RPTG_GRP_BK1" AUTHID CURRENT_USER as
/* $Header: bergrapi.pkh 120.0 2005/05/28 11:39:18 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_POPL_RPTG_GRP_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_POPL_RPTG_GRP_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_POPL_RPTG_GRP_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_POPL_RPTG_GRP_a
  (
