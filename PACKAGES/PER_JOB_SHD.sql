--------------------------------------------------------
--  DDL for Package PER_JOB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_JOB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  date_from                         date,
  -- Bug Fix 3128624.Comments field width increased to 32000.
  comments                          varchar2(32000),   -- pseudo column
  date_to                           date,
  approval_authority                number(38),
  name                              varchar2(700), -- changed the length 3213714
