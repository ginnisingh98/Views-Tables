--------------------------------------------------------
--  DDL for Package OKL_FE_STD_RATE_TMPL_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_FE_STD_RATE_TMPL_PVT_W" AUTHID CURRENT_USER as
  /* $Header: OKLESRTS.pls 120.0 2005/07/07 10:38:09 viselvar noship $ */
  procedure rosetta_table_copy_in_p5(t out nocopy okl_fe_std_rate_tmpl_pvt.okl_number_table, a0 JTF_NUMBER_TABLE);
  procedure rosetta_table_copy_out_p5(t okl_fe_std_rate_tmpl_pvt.okl_number_table, a0 out nocopy JTF_NUMBER_TABLE);
