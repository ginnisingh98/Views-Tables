--------------------------------------------------------
--  DDL for Package PQP_ERS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_ERS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_database_item_suffix
--    p_legislation_code
--     already exists.
--
--  In Arguments:
