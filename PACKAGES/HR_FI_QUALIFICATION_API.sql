--------------------------------------------------------
--  DDL for Package HR_FI_QUALIFICATION_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FI_QUALIFICATION_API" AUTHID CURRENT_USER AS
/* $Header: pequafii.pkh 120.1 2005/10/02 02:44 aroussel $ */
/*#
 * This package contains qualification APIs for Finland.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Qualification for Finland
*/
--
-- ----------------------------------------------------------------------------
...
-- {Start Of Comments}
/*#
 * This API creates qualifications for a person.
 *
 * This API is an alternative to the API create_qualification. If p_validate is
 * set to false, a qualification is created.
 *
 * <p><b>Licensing</b><br>
 * This API is licensed for use with Human Resources.
 *
 * <p><b>Prerequisites</b><br>
 * The person must exist at the effective start date of the qualification. Also
 * a valid qualification_type_id must exist in PER_QUALIFICATION_TYPES.
 *
 * <p><b>Post Success</b><br>
 * A new qualification will be created for the person.
 *
 ...
 * value.
 * @param p_business_group_id The business group of the person.
 ...
 * @param p_comments Qualification comment text.
 * @param p_attendance_id Attendance ID.
 ...
 * @param p_education_code Education code.
 * @param p_preferred_level Preferred level. Valid values are defined by
 * 'YES_NO' lookup type.
 ...
 * @param p_qualification_id Identifier for the qualification.
 * @param p_object_version_number If p_validate is false, then set to the
 * version number of the created qualification. If p_validate is true, then the
 * value will be null.
 * @rep:displayname Create Qualification for Finland
...
-- {Start Of Comments}
/*#
 * This API updates a qualification for a person.
 *
 * This API is an alternative to the API update_qualification. If p_validate is
 * set to false, a qualification is updated.
 *
 * <p><b>Licensing</b><br>
 * This API is licensed for use with Human Resources.
 *
 * <p><b>Prerequisites</b><br>
 * The person must exist at the effective start date of the qualification. Also
 * a valid qualification_type_id must exist in PER_QUALIFICATION_TYPES.The
 * qualification_id must exist in PER_QUALIFICATIONS.
 *
 * <p><b>Post Success</b><br>
 * The qualification will be updated for the person.
 *
 * <p><b>Post Failure</b><br>
 * The API does not increment the Object Version Number (OVN), the details
 * relating to the qualification remain unchanged, and an error is raised.
 *
 * @param p_validate If true, then validation alone will be performed and the
 * database will remain unchanged. If false and all validation checks pass,
 * then the database will be modified.
 ...
 * @rep:displayname Update Qualification for Finland
 * @rep:category BUSINESS_ENTITY PER_QUALIFICATION
 * @rep:lifecycle active
 * @rep:scope public
 * @rep:ihelp PER/@scalapi APIs in Oracle HRMS
