--------------------------------------------------------
--  DDL for Package PAY_EVP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EVP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_event_procedure_id
--     already exists.
--
--  In Arguments:
