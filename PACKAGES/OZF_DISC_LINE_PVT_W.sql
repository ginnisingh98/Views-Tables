--------------------------------------------------------
--  DDL for Package OZF_DISC_LINE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_DISC_LINE_PVT_W" AUTHID CURRENT_USER as
  /* $Header: ozfwodls.pls 120.3 2006/05/04 15:26 julou ship $ */
