--------------------------------------------------------
--  DDL for Package ARRX_C_UNAPP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARRX_C_UNAPP" AUTHID CURRENT_USER AS
/* $Header: ARRXCUNS.pls 120.1 2005/10/30 04:45:51 appldev noship $ */
