--------------------------------------------------------
--  DDL for Package BEN_XDD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XDD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ext_data_elmt_decd_id             number(15),
  val                               varchar2(600),
  dcd_val                           varchar2(600),
  chg_evt_source                    varchar2(35),
