--------------------------------------------------------
--  DDL for Package PER_CEO_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CEO_BUS" AUTHID CURRENT_USER as
/* $Header: peceorhi.pkh 120.0 2005/05/31 06:35 appldev noship $ */
--
-- ---------------------------------------------------------------------------
...
--
--  Prerequisites:
--    The primary key identified by p_comp_element_outcome_id
--     already exists.
--
--  In Arguments:
...
--
-- Description:
--   This fucntion checks all required outcome are achieved or not.
--   validation.
--
-- Prerequisites:
--   This private procedure is called from create_element_outcome api.
--
-- In Parameters:
--   A Pl/Sql record structure.
--
