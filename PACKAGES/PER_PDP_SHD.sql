--------------------------------------------------------
--  DDL for Package PER_PDP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PDP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,period_of_placement_id          number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_PERIODS_OF_PLACEMENT';
g_validate_df_flex  boolean      := TRUE;
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
