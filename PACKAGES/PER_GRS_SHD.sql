--------------------------------------------------------
--  DDL for Package PER_GRS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_GRS_SHD" AUTHID CURRENT_USER as
