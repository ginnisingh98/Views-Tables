--------------------------------------------------------
--  DDL for Package BEN_CTU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CTU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  cm_typ_usg_id                     number(15),
  effective_start_date              date,
  effective_end_date                date,
  all_r_any_cd                      varchar2(30),
  cm_usg_rl                         number(15),
  descr_text                        varchar2(2000),
  pgm_id                            number(15),
  pl_id                             number(15),
  pl_typ_id                         number(15),
  ...
  ctu_attribute_category            varchar2(30),
  ctu_attribute1                    varchar2(150),
  ctu_attribute2                    varchar2(150),
  ctu_attribute3                    varchar2(150),
  ctu_attribute4                    varchar2(150),
  ctu_attribute5                    varchar2(150),
  ctu_attribute6                    varchar2(150),
  ctu_attribute7                    varchar2(150),
  ctu_attribute8                    varchar2(150),
  ctu_attribute9                    varchar2(150),
  ctu_attribute10                   varchar2(150),
  ctu_attribute11                   varchar2(150),
  ctu_attribute12                   varchar2(150),
  ctu_attribute13                   varchar2(150),
  ctu_attribute14                   varchar2(150),
  ctu_attribute15                   varchar2(150),
  ctu_attribute16                   varchar2(150),
  ctu_attribute17                   varchar2(150),
  ctu_attribute18                   varchar2(150),
  ctu_attribute19                   varchar2(150),
  ctu_attribute20                   varchar2(150),
  ctu_attribute21                   varchar2(150),
  ctu_attribute22                   varchar2(150),
  ctu_attribute23                   varchar2(150),
  ctu_attribute24                   varchar2(150),
  ctu_attribute25                   varchar2(150),
  ctu_attribute26                   varchar2(150),
  ctu_attribute27                   varchar2(150),
  ctu_attribute28                   varchar2(150),
  ctu_attribute29                   varchar2(150),
  ctu_attribute30                   varchar2(150),
...
--           p_base_key_value = :cm_typ_usg_id).
--
-- Post Success:
--   Processing continues.
--
