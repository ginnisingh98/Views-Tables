--------------------------------------------------------
--  DDL for Package PAY_CPT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CPT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  emp_province_tax_inf_id           number(9),
  effective_start_date              date,
  effective_end_date                date,
  legislation_code                  varchar2(30),
  assignment_id                     pay_ca_emp_prov_tax_info_f.assignment_id%TYPE,
  business_group_id                 number(10),
  province_code                     varchar2(30),
  jurisdiction_code                 varchar2(11),
  tax_credit_amount                 number(11,2),
  basic_exemption_flag              varchar2(30),
  deduction_code                    varchar2(30),
  extra_info_not_provided           varchar2(30),
  marriage_status                   varchar2(30),
  no_of_infirm_dependants           number(30),
  non_resident_status               varchar2(30),
  disability_status                 varchar2(30),
  no_of_dependants                  number(30),
  annual_dedn                       number(11,2),
  total_expense_by_commission       number(11,2),
  total_remnrtn_by_commission       number(11,2),
  prescribed_zone_dedn_amt          number(11,2),
  additional_tax                    number(11,2),
  prov_override_rate                number(9,2),      -- Increased length
  prov_override_amount              number(11,2),
  prov_exempt_flag                  varchar2(30),
  pmed_exempt_flag                  varchar2(30),
  wc_exempt_flag                    varchar2(30),
  qpp_exempt_flag                   varchar2(30),
  tax_calc_method                   varchar2(30),
  other_tax_credit                  number(11,2),
  ca_tax_information_category       varchar2(30),
  ca_tax_information1               varchar2(150),
  ca_tax_information2               varchar2(150),
  ca_tax_information3               varchar2(150),
  ca_tax_information4               varchar2(150),
  ca_tax_information5               varchar2(150),
  ca_tax_information6               varchar2(150),
  ca_tax_information7               varchar2(150),
  ca_tax_information8               varchar2(150),
  ca_tax_information9               varchar2(150),
  ca_tax_information10              varchar2(150),
  ca_tax_information11              varchar2(150),
  ca_tax_information12              varchar2(150),
  ca_tax_information13              varchar2(150),
  ca_tax_information14              varchar2(150),
  ca_tax_information15              varchar2(150),
  ca_tax_information16              varchar2(150),
  ca_tax_information17              varchar2(150),
  ca_tax_information18              varchar2(150),
  ca_tax_information19              varchar2(150),
  ca_tax_information20              varchar2(150),
  ca_tax_information21              varchar2(150),
  ca_tax_information22              varchar2(150),
  ca_tax_information23              varchar2(150),
  ca_tax_information24              varchar2(150),
  ca_tax_information25              varchar2(150),
  ca_tax_information26              varchar2(150),
  ca_tax_information27              varchar2(150),
  ca_tax_information28              varchar2(150),
  ca_tax_information29              varchar2(150),
  ca_tax_information30              varchar2(150),
  object_version_number             number(30),
  prov_lsp_amount                   number(11,2),
  ppip_exempt_flag                   varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :emp_province_tax_inf_id).
--
-- Post Success:
--   Processing continues.
--
