--------------------------------------------------------
--  DDL for Package BEN_PEO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PEO_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ptip_id                           number(15),
  plip_id                           number(15),
  ignr_prtn_ovrid_flag              varchar2(30),
  elig_inelig_cd                    varchar2(30),
  prtn_eff_strt_dt_cd               varchar2(30),
  prtn_eff_strt_dt_rl               number(15),
  prtn_eff_end_dt_cd                varchar2(30),
  prtn_eff_end_dt_rl                number(15),
  wait_perd_dt_to_use_cd            varchar2(30),
  wait_perd_dt_to_use_rl            number(15),
  wait_perd_val                     number(15),
  wait_perd_uom                     varchar2(30),
  wait_perd_rl                      number(15),
  mx_poe_det_dt_cd                  varchar2(30),
  mx_poe_det_dt_rl                  number(15),
  mx_poe_val                        number(15),
  mx_poe_uom                        varchar2(30),
  mx_poe_rl                         number(15),
  mx_poe_apls_cd                    varchar2(30),
  prtn_ovridbl_flag                 varchar2(30),
  vrfy_fmly_mmbr_cd                 varchar2(30),
  vrfy_fmly_mmbr_rl                 number(15),
  peo_attribute_category            varchar2(30),
  peo_attribute1                    varchar2(150),
  peo_attribute2                    varchar2(150),
  peo_attribute3                    varchar2(150),
  peo_attribute4                    varchar2(150),
  peo_attribute5                    varchar2(150),
  peo_attribute6                    varchar2(150),
  peo_attribute7                    varchar2(150),
  peo_attribute8                    varchar2(150),
  peo_attribute9                    varchar2(150),
  peo_attribute10                   varchar2(150),
  peo_attribute11                   varchar2(150),
  peo_attribute12                   varchar2(150),
  peo_attribute13                   varchar2(150),
  peo_attribute14                   varchar2(150),
  peo_attribute15                   varchar2(150),
  peo_attribute16                   varchar2(150),
  peo_attribute17                   varchar2(150),
  peo_attribute18                   varchar2(150),
  peo_attribute19                   varchar2(150),
  peo_attribute20                   varchar2(150),
  peo_attribute21                   varchar2(150),
  peo_attribute22                   varchar2(150),
  peo_attribute23                   varchar2(150),
  peo_attribute24                   varchar2(150),
  peo_attribute25                   varchar2(150),
  peo_attribute26                   varchar2(150),
  peo_attribute27                   varchar2(150),
  peo_attribute28                   varchar2(150),
  peo_attribute29                   varchar2(150),
  peo_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_to_prte_rsn_id).
--
-- Post Success:
--   Processing continues.
--
