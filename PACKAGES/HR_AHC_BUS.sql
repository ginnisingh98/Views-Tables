--------------------------------------------------------
--  DDL for Package HR_AHC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_AHC_BUS" AUTHID CURRENT_USER as
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_validate(p_rec in hr_ahc_shd.g_rec_type);
--
end hr_ahc_bus;
