--------------------------------------------------------
--  DDL for Package FF_FCU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FF_FCU_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'FF_FUNCTION_CONTEXT_USAGES';
