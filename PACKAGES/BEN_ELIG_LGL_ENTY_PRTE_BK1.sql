--------------------------------------------------------
--  DDL for Package BEN_ELIG_LGL_ENTY_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_LGL_ENTY_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beelnapi.pkh 120.0 2005/05/28 02:19:00 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_LGL_ENTY_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_LGL_ENTY_PRTE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_LGL_ENTY_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_LGL_ENTY_PRTE_a
  (
...
--
end ben_ELIG_LGL_ENTY_PRTE_bk1;
