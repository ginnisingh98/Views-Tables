--------------------------------------------------------
--  DDL for Package OTA_MANDATORY_ENROLL_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_MANDATORY_ENROLL_UTIL" AUTHID CURRENT_USER as
/* $Header: otmandatoryenr.pkh 120.3 2008/01/25 11:48:11 shwnayak noship $ */
...
PROCEDURE process_mandatory_enr_requests(p_conc_request_id IN NUMBER);
