--------------------------------------------------------
--  DDL for Package BEN_PRD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  paird_rt_id                       number(15),
  effective_start_date              date,
  effective_end_date                date,
  use_parnt_ded_sched_flag          varchar2(30),
  asn_on_chc_of_parnt_flag          varchar2(30),
  use_parnt_prtl_mo_cd_flag         varchar2(30),
  alloc_sme_as_parnt_flag           varchar2(30),
  use_parnt_pymt_sched_flag         varchar2(30),
  no_cmbnd_mx_amt_dfnd_flag         varchar2(30),
  cmbnd_mx_amt                      number,        --(15,2),
  cmbnd_mn_amt                      number,        --(15,2),
  cmbnd_mx_pct_num                  number,
  cmbnd_mn_pct_num                  number,
  no_cmbnd_mn_amt_dfnd_flag         varchar2(30),
  no_cmbnd_mn_pct_dfnd_flag         varchar2(30),
  no_cmbnd_mx_pct_dfnd_flag         varchar2(30),
  parnt_acty_base_rt_id             number(15),
  chld_acty_base_rt_id              number(15),
  business_group_id                 number(15),
  prd_attribute_category            varchar2(30),
  prd_attribute1                    varchar2(150),
  prd_attribute2                    varchar2(150),
  prd_attribute3                    varchar2(150),
  prd_attribute4                    varchar2(150),
  prd_attribute5                    varchar2(150),
  prd_attribute6                    varchar2(150),
  prd_attribute7                    varchar2(150),
  prd_attribute8                    varchar2(150),
  prd_attribute9                    varchar2(150),
  prd_attribute10                   varchar2(150),
  prd_attribute11                   varchar2(150),
  prd_attribute12                   varchar2(150),
  prd_attribute13                   varchar2(150),
  prd_attribute14                   varchar2(150),
  prd_attribute15                   varchar2(150),
  prd_attribute16                   varchar2(150),
  prd_attribute17                   varchar2(150),
  prd_attribute18                   varchar2(150),
  prd_attribute19                   varchar2(150),
  prd_attribute20                   varchar2(150),
  prd_attribute21                   varchar2(150),
  prd_attribute22                   varchar2(150),
  prd_attribute23                   varchar2(150),
  prd_attribute24                   varchar2(150),
  prd_attribute25                   varchar2(150),
  prd_attribute26                   varchar2(150),
  prd_attribute27                   varchar2(150),
  prd_attribute28                   varchar2(150),
  prd_attribute29                   varchar2(150),
  prd_attribute30                   varchar2(150),
