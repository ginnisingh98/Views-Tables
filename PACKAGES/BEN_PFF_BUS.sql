--------------------------------------------------------
--  DDL for Package BEN_PFF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PFF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_pct_fl_tm_fctr_id already exists.
--
--  In Arguments:
--    p_pct_fl_tm_fctr_id
--
...
function return_legislation_code
  (p_pct_fl_tm_fctr_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
