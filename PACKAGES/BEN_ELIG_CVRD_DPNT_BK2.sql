--------------------------------------------------------
--  DDL for Package BEN_ELIG_CVRD_DPNT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_CVRD_DPNT_BK2" AUTHID CURRENT_USER as
/* $Header: bepdpapi.pkh 120.0.12000000.1 2007/01/19 20:54:51 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_CVRD_DPNT_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_CVRD_DPNT_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_CVRD_DPNT_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_CVRD_DPNT_a
  (
   p_elig_cvrd_dpnt_id              in  number
