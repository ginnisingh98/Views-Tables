--------------------------------------------------------
--  DDL for Package PQP_GDA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_GDA_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_gap_daily_absence_id
--     already exists.
--
--  In Arguments:
