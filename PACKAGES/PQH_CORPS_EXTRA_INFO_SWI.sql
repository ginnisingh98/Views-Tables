--------------------------------------------------------
--  DDL for Package PQH_CORPS_EXTRA_INFO_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CORPS_EXTRA_INFO_SWI" AUTHID CURRENT_USER As
/* $Header: pqceiswi.pkh 115.0 2003/12/15 05:46 kgowripe noship $ */
-- ----------------------------------------------------------------------------
...
--  API: pqh_corps_extra_info_api.create_corps_extra_info
--
-- Pre-requisites
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: pqh_corps_extra_info_api.delete_corps_extra_info
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: pqh_corps_extra_info_api.update_corps_extra_info
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
