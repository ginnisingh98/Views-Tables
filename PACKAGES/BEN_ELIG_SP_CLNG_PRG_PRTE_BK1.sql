--------------------------------------------------------
--  DDL for Package BEN_ELIG_SP_CLNG_PRG_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_SP_CLNG_PRG_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beespapi.pkh 120.0 2005/05/28 02:57:13 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_SP_CLNG_PRG_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_elig_sp_clng_prg_prte_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_SP_CLNG_PRG_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_elig_sp_clng_prg_prte_a
  (
...
--
end ben_ELIG_SP_CLNG_PRG_PRTE_bk1;
