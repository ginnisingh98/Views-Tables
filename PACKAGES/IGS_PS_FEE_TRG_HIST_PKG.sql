--------------------------------------------------------
--  DDL for Package IGS_PS_FEE_TRG_HIST_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PS_FEE_TRG_HIST_PKG" AUTHID CURRENT_USER AS
  /* $Header: IGSPI12S.pls 115.5 2003/02/12 09:48:34 shtatiko ship $ */
