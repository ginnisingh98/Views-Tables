--------------------------------------------------------
--  DDL for Package BEN_PQC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PQC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_prtt_rmt_rqst_ctfn_prvdd_id
--     already exists.
--
--  In Arguments:
