--------------------------------------------------------
--  DDL for Package OKL_CREDIT_CHECKLIST_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_CREDIT_CHECKLIST_PVT" AUTHID CURRENT_USER AS
/* $Header: OKLRCLCS.pls 120.1 2005/05/27 17:06:11 cklee noship $ */
 ----------------------------------------------------------------------------
 -- GLOBAL VARIABLES
 ----------------------------------------------------------------------------
 G_PKG_NAME             CONSTANT VARCHAR2(200) := 'OKL_CREDIT_CHECKLIST_PVT';
