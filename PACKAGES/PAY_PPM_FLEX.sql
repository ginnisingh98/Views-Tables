--------------------------------------------------------
--  DDL for Package PAY_PPM_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PPM_FLEX" AUTHID CURRENT_USER as
/* $Header: pyppmfli.pkh 115.0 99/07/17 06:25:32 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
...
--  {End of Comments}
-- -----------------------------------------------------------------------------
procedure df(p_rec   in pay_ppm_shd.g_rec_type);
--
end pay_ppm_flex;
