--------------------------------------------------------
--  DDL for Package PSP_MATRIX_DRIVER2_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_MATRIX_DRIVER2_PKG" AUTHID CURRENT_USER as
-- $Header: PSPLSM2S.pls 115.4 2002/04/22 12:58:52 pkm ship      $
