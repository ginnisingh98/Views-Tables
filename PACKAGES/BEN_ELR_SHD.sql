--------------------------------------------------------
--  DDL for Package BEN_ELR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_loa_rsn_prte_id              number(15),
  ...
  elr_attribute_category            varchar2(30),
  elr_attribute1                    varchar2(150),
  elr_attribute2                    varchar2(150),
  elr_attribute3                    varchar2(150),
  elr_attribute4                    varchar2(150),
  elr_attribute5                    varchar2(150),
  elr_attribute6                    varchar2(150),
  elr_attribute7                    varchar2(150),
  elr_attribute8                    varchar2(150),
  elr_attribute9                    varchar2(150),
  elr_attribute10                   varchar2(150),
  elr_attribute11                   varchar2(150),
  elr_attribute12                   varchar2(150),
  elr_attribute13                   varchar2(150),
  elr_attribute14                   varchar2(150),
  elr_attribute15                   varchar2(150),
  elr_attribute16                   varchar2(150),
  elr_attribute17                   varchar2(150),
  elr_attribute18                   varchar2(150),
  elr_attribute19                   varchar2(150),
  elr_attribute20                   varchar2(150),
  elr_attribute21                   varchar2(150),
  elr_attribute22                   varchar2(150),
  elr_attribute23                   varchar2(150),
  elr_attribute24                   varchar2(150),
  elr_attribute25                   varchar2(150),
  elr_attribute26                   varchar2(150),
  elr_attribute27                   varchar2(150),
  elr_attribute28                   varchar2(150),
  elr_attribute29                   varchar2(150),
  elr_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_loa_rsn_prte_id).
--
-- Post Success:
--   Processing continues.
--
