--------------------------------------------------------
--  DDL for Package OKL_SETUP_STRMS_TRANS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SETUP_STRMS_TRANS_PUB" AUTHID CURRENT_USER AS
/* $Header: OKLPSMNS.pls 115.2 2002/07/22 23:38:55 smahapat noship $ */

  G_UNEXPECTED_ERROR                CONSTANT VARCHAR2(200) := 'OKL_CONTRACTS_UNEXPECTED_ERROR';
  G_SQLERRM_TOKEN                   CONSTANT VARCHAR2(200) := 'OKL_SQLERRM';
  G_SQLCODE_TOKEN                   CONSTANT VARCHAR2(200) := 'OKL_SQLCODE';
  G_PKG_NAME                        CONSTANT VARCHAR2(200) := 'OKL_SETUP_STRMS_TRANS_PUB' ;
