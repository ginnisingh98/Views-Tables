--------------------------------------------------------
--  DDL for Package BEN_CWB_AUDIT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CWB_AUDIT_BK2" AUTHID CURRENT_USER as
/* $Header: beaudapi.pkh 120.4 2006/10/27 10:52:17 steotia noship $ */
--
-- -------------------------------------------------------------------------
-- |------------------------< update_audit_entry_b >-----------------------|
-- -------------------------------------------------------------------------
--
procedure update_audit_entry_b
...
--
-- --------------------------------------------------------------------------
-- |------------------------< update_audit_entry_a >------------------------|
-- --------------------------------------------------------------------------
--
procedure update_audit_entry_a
  (p_cwb_audit_id                  in     number
  ,p_group_per_in_ler_id           in     number
  ,p_group_pl_id                   in     number
  ,p_lf_evt_ocrd_dt                in     date
