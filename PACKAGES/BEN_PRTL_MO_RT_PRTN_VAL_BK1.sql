--------------------------------------------------------
--  DDL for Package BEN_PRTL_MO_RT_PRTN_VAL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRTL_MO_RT_PRTN_VAL_BK1" AUTHID CURRENT_USER as
/* $Header: beppvapi.pkh 120.0 2005/05/28 11:01:43 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Prtl_Mo_Rt_Prtn_Val_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Prtl_Mo_Rt_Prtn_Val_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Prtl_Mo_Rt_Prtn_Val_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Prtl_Mo_Rt_Prtn_Val_a
  (
...
--
end ben_Prtl_Mo_Rt_Prtn_Val_bk1;
