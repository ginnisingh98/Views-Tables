--------------------------------------------------------
--  DDL for Package PER_ABC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ABC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_absence_case_id
--     already exists.
--
--  In Arguments:
--    p_absence_case_id
...
--
-- Description:
--   This function calculates and returns the minimum of the start dates of
--   the absences attached to the given absence case.
--
-- Prerequisites:
--   This public procedure can be called from outside.
--
-- In Parameters:
--   absence_case_id as input parameter.
--
-- Post Success:
--   Processing continues.
--
...
--
-- Developer Implementation Notes:
--   Currently this function is being called from the PER_ABSENCE_CASES VO.
--
-- Access Status:
--   Internal Row Handler Use Only.
--
...
--
-- Description:
--   This function calculates and returns the maximum of the end dates of
--   the absences attached to the given absence case.
--
-- Prerequisites:
--   This public procedure can be called from outside.
