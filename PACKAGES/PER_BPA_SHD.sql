--------------------------------------------------------
--  DDL for Package PER_BPA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_BPA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  bpa_attribute_category                varchar2(30),
  bpa_attribute1                        varchar2(150),
  bpa_attribute2                        varchar2(150),
  bpa_attribute3                        varchar2(150),
  bpa_attribute4                        varchar2(150),
  bpa_attribute5                        varchar2(150),
  bpa_attribute6                        varchar2(150),
  bpa_attribute7                        varchar2(150),
  bpa_attribute8                        varchar2(150),
  bpa_attribute9                        varchar2(150),
  bpa_attribute10                       varchar2(150),
  bpa_attribute11                       varchar2(150),
  bpa_attribute12                       varchar2(150),
  bpa_attribute13                       varchar2(150),
  bpa_attribute14                       varchar2(150),
  bpa_attribute15                       varchar2(150),
  bpa_attribute16                       varchar2(150),
  bpa_attribute17                       varchar2(150),
  bpa_attribute18                       varchar2(150),
  bpa_attribute19                       varchar2(150),
  bpa_attribute20                       varchar2(150),
  bpa_attribute21                       varchar2(150),
  bpa_attribute22                       varchar2(150),
  bpa_attribute23                       varchar2(150),
  bpa_attribute24                       varchar2(150),
  bpa_attribute25                       varchar2(150),
  bpa_attribute26                       varchar2(150),
  bpa_attribute27                       varchar2(150),
  bpa_attribute28                       varchar2(150),
  bpa_attribute29                       varchar2(150),
  bpa_attribute30                       varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
