--------------------------------------------------------
--  DDL for Package BEN_EST_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EST_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_suppl_role_prte_id        number(15),
  ...
  job_id                            number(15),
  est_attribute_category            varchar2(30),
  est_attribute1                    varchar2(150),
  est_attribute2                    varchar2(150),
  est_attribute3                    varchar2(150),
  est_attribute4                    varchar2(150),
  est_attribute5                    varchar2(150),
  est_attribute6                    varchar2(150),
  est_attribute7                    varchar2(150),
  est_attribute8                    varchar2(150),
  est_attribute9                    varchar2(150),
  est_attribute10                   varchar2(150),
  est_attribute11                   varchar2(150),
  est_attribute12                   varchar2(150),
  est_attribute13                   varchar2(150),
  est_attribute14                   varchar2(150),
  est_attribute15                   varchar2(150),
  est_attribute16                   varchar2(150),
  est_attribute17                   varchar2(150),
  est_attribute18                   varchar2(150),
  est_attribute19                   varchar2(150),
  est_attribute20                   varchar2(150),
  est_attribute21                   varchar2(150),
  est_attribute22                   varchar2(150),
  est_attribute23                   varchar2(150),
  est_attribute24                   varchar2(150),
  est_attribute25                   varchar2(150),
  est_attribute26                   varchar2(150),
  est_attribute27                   varchar2(150),
  est_attribute28                   varchar2(150),
  est_attribute29                   varchar2(150),
  est_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_suppl_role_prte_id).
--
-- Post Success:
--   Processing continues.
--
