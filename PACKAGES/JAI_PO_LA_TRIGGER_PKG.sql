--------------------------------------------------------
--  DDL for Package JAI_PO_LA_TRIGGER_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JAI_PO_LA_TRIGGER_PKG" AUTHID CURRENT_USER AS
/* $Header: jai_po_la_t.pls 120.0.12000000.2 2007/10/25 02:23:44 rallamse ship $ */

  t_rec  PO_LINES_ALL%rowtype ;
