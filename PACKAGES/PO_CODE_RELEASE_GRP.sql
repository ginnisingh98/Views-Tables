--------------------------------------------------------
--  DDL for Package PO_CODE_RELEASE_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PO_CODE_RELEASE_GRP" AUTHID CURRENT_USER AS
/* $Header: POXGCRLS.pls 115.0 2003/07/01 02:40:01 bmunagal noship $*/
...
--   11.05.10.00 indicates 11.5.10 or PRC Family Pack J. Returned version 115.1
