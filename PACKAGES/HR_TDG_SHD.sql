--------------------------------------------------------
--  DDL for Package HR_TDG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TDG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (template_data_group_id          number(15)
  ,object_version_number           number(9)
  ,form_template_id                number(15)
  ,form_data_group_id              number(15)
  );
--
-- ----------------------------------------------------------------------------
