--------------------------------------------------------
--  DDL for Package BEN_PARTICIPATION_ELIG_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PARTICIPATION_ELIG_BK1" AUTHID CURRENT_USER as
/* $Header: beepaapi.pkh 120.0 2005/05/28 02:35:03 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |--------------------------< create_Participation_Elig_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Participation_Elig_b
...
--
-- ----------------------------------------------------------------------------
-- |--------------------------< create_Participation_Elig_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Participation_Elig_a
  ...
  ,p_effective_date                 in  date);
--
end ben_Participation_Elig_bk1;
