--------------------------------------------------------
--  DDL for Package PQH_FTR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_FTR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_wrkplc_vldtn_jobftr_id
--     already exists.
--
--  In Arguments:
