--------------------------------------------------------
--  DDL for Package PQH_TKT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TKT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_tatigkeit_detail_id
--     already exists.
--
--  In Arguments:
