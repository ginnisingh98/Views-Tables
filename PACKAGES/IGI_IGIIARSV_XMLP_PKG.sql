--------------------------------------------------------
--  DDL for Package IGI_IGIIARSV_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGI_IGIIARSV_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: IGIIARSVS.pls 120.0.12010000.1 2008/07/29 08:58:54 appldev ship $ */
...
DO_INSERT number;
  ...
  FUNCTION REPORT_NAMEFORMULA(COMPANY_NAME IN VARCHAR2
                             ,RP_CURRENCY_CODE IN VARCHAR2) RETURN CHAR;
