--------------------------------------------------------
--  DDL for Package AME_AYL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_AYL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,user_action_type_name           varchar2(50)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_ACTION_TYPES_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
