--------------------------------------------------------
--  DDL for Package PQH_RFE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RFE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (rate_factor_on_elmnt_id         number(15)
  ,criteria_rate_element_id        number(15)
  ,criteria_rate_factor_id         number(15)
  ,rate_factor_val_record_tbl      varchar2(30)
  ,rate_factor_val_record_col      varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_RATE_FACTOR_ON_ELMNTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
