--------------------------------------------------------
--  DDL for Package BEN_BNFT_RSTRN_CTFN_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BNFT_RSTRN_CTFN_BK1" AUTHID CURRENT_USER as
/* $Header: bebrcapi.pkh 120.0 2005/05/28 00:49:57 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_BNFT_RSTRN_CTFN_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_BNFT_RSTRN_CTFN_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_BNFT_RSTRN_CTFN_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_BNFT_RSTRN_CTFN_a
  (
