--------------------------------------------------------
--  DDL for Package PER_RES_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RES_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cagr_entitlement_result_id
--     already exists.
--
--  In Arguments:
