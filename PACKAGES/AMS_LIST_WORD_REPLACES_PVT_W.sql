--------------------------------------------------------
--  DDL for Package AMS_LIST_WORD_REPLACES_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_LIST_WORD_REPLACES_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswwdrs.pls 115.6 2002/11/22 08:58:04 jieli ship $ */
