--------------------------------------------------------
--  DDL for Package MSC_WS_ASCP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."MSC_WS_ASCP" AUTHID CURRENT_USER AS
/* $Header: MSCWASCS.pls 120.3 2008/03/20 15:54:43 bnaghi noship $ */



  -- =============================================================
  -- Desc: This procedure is invoke from web services to launch
  --       ASCP plan.  It mirrors all the parameters from the Launch
  ...
  --              NO - No
  --              YES_NOPURGE - Yes , do not purge current pln after switch plan
  --        launchPlanner, releaseReschedules
