--------------------------------------------------------
--  DDL for Package CSP_PACK_SERIAL_LOTS_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CSP_PACK_SERIAL_LOTS_PVT" AUTHID CURRENT_USER AS
/* $Header: cspvtsps.pls 115.6 2003/05/02 16:40:18 hhaugeru ship $ */
-- Start of Comments
-- Package name     : CSP_Pack_Serial_Lots_PVT
-- Purpose          :
-- History          :
-- NOTE             :
-- End of Comments
...
PROCEDURE Validate_PL_SERIAL_LOT_ID (
    ...
    P_PACKLIST_SERIAL_LOT_ID                IN   NUMBER,
...
PROCEDURE Validate_pack_serial_lots(
    P_Init_Msg_List              IN   VARCHAR2     := FND_API.G_FALSE,
    P_Validation_level           IN   NUMBER := FND_API.G_VALID_LEVEL_FULL,
    P_Validation_mode            IN   VARCHAR2,
    P_plsl_Rec     IN    plsl_Rec_Type,
