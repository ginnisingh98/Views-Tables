--------------------------------------------------------
--  DDL for Package PER_PMP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PMP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,administrator_person_id         number(15)
  ,previous_plan_id                number(15)
  ,start_date                      date
  ,end_date                        date
  ,status_code                     varchar2(30)
  ,hierarchy_type_code             varchar2(30)
  ...
  ,top_organization_id           number(15)
  ,position_structure_id           number(15)
  ,pos_structure_version_id        number(15)
  ,top_position_id               number(15)
  ,hierarchy_levels                number(15)
  ,automatic_enrollment_flag       varchar2(30)
  ,assignment_types_code           varchar2(30)
  ,primary_asg_only_flag           varchar2(30)
  ,include_obj_setting_flag        varchar2(30)
  ,obj_setting_start_date          date
  ,obj_setting_deadline            date
  ,obj_set_outside_period_flag     varchar2(30)
  ,method_code                     varchar2(30)
  ,notify_population_flag          varchar2(30)
  ,automatic_allocation_flag       varchar2(30)
  ,copy_past_objectives_flag       varchar2(30)
  ,sharing_alignment_task_flag     varchar2(30)
  ,include_appraisals_flag         varchar2(30)
  ,change_sc_status_flag    varchar2(30)
  ...
  ,update_library_objectives     varchar2(30)    -- 8740021 bug fix
  ,automatic_approval_flag     varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_PERF_MGMT_PLANS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
