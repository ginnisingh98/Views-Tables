--------------------------------------------------------
--  DDL for Package IGW_BUDGET_PERSONNEL_OH_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGW_BUDGET_PERSONNEL_OH_PVT" AUTHID CURRENT_USER as
--$Header: igwvbpos.pls 115.3 2002/11/14 18:41:34 vmedikon ship $
G_package_name   VARCHAR2(30)  := 'IGW_BUDGET_PERSONNEL_OH_PVT';

/*
  procedure create_budget_personnel_oh
...
-----------------------------------------------------------------------
/*
procedure delete_budget_personnel_oh
       (p_init_msg_list                 IN  VARCHAR2   := FND_API.G_TRUE
        ,p_commit                       IN  VARCHAR2   := FND_API.G_FALSE
        ,p_validate_only                IN  VARCHAR2   := FND_API.G_TRUE
