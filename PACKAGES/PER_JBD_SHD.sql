--------------------------------------------------------
--  DDL for Package PER_JBD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_JBD_SHD" AUTHID CURRENT_USER as
...
--   job definition combination segments. The returning
--   p_job_definition_id can have three states:
--
--   p_job_definition_id
--   state                 meaning
--   ===================== =======
...
--
--   Depending on the p_job_definition_id state the following out
--   arguments are either set or null.
--
--   p_job_definition_id    out
--   state                  argument                 set
--   =====================  ========                 ===
--   -1                     p_id_flex_num             Y
--
...
--
-- Post Success:
--   Depending on the p_job_definition_id state the corresponding out
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Function api_updating(p_job_definition_id in number) Return Boolean;
--
-- ----------------------------------------------------------------------------
-- |-----------------------------< convert_args >-----------------------------|
-- ----------------------------------------------------------------------------
