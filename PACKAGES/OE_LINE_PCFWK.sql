--------------------------------------------------------
--  DDL for Package OE_LINE_PCFWK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_LINE_PCFWK" AUTHID CURRENT_USER AS
/* $Header: OEXKLINS.pls 120.0 2005/06/01 00:38:04 appldev noship $ */
...
--     against operations on LINE or its columns
--  Pre-reqs
--
--  Parameters
--
