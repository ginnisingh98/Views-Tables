--------------------------------------------------------
--  DDL for Package PQP_GAP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_GAP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_gap_absence_plan_id
--     already exists.
--
--  In Arguments:
...
--
--  Prerequisites:
--    The primary key identified by p_assignment_id
--     already exists.
--
--  In Arguments:
--    p_assignment_id
