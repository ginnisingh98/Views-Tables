--------------------------------------------------------
--  DDL for Package PER_PYP_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PYP_FLEX" AUTHID CURRENT_USER as
/* $Header: pepypfli.pkh 115.0 99/07/18 14:39:31 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
