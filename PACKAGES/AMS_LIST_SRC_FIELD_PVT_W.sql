--------------------------------------------------------
--  DDL for Package AMS_LIST_SRC_FIELD_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_LIST_SRC_FIELD_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswlsfs.pls 115.13 2004/03/18 20:29:52 usingh ship $ */
