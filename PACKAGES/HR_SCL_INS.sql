--------------------------------------------------------
--  DDL for Package HR_SCL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_SCL_INS" AUTHID CURRENT_USER as
...
--   3. If a combination does exist the p_soft_coding_keyflex_id is returned.
--
-- Pre Conditions:
--
-- In Arguments:
