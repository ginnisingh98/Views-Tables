--------------------------------------------------------
--  DDL for Package BEN_EPA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ptip_id                           number(15),
  plip_id                           number(15),
  trk_scr_for_inelg_flag            varchar2(30),
  ...
  epa_attribute_category            varchar2(30),
  epa_attribute1                    varchar2(150),
  epa_attribute2                    varchar2(150),
  epa_attribute3                    varchar2(150),
  epa_attribute4                    varchar2(150),
  epa_attribute5                    varchar2(150),
  epa_attribute6                    varchar2(150),
  epa_attribute7                    varchar2(150),
  epa_attribute8                    varchar2(150),
  epa_attribute9                    varchar2(150),
  epa_attribute10                   varchar2(150),
  epa_attribute11                   varchar2(150),
  epa_attribute12                   varchar2(150),
  epa_attribute13                   varchar2(150),
  epa_attribute14                   varchar2(150),
  epa_attribute15                   varchar2(150),
  epa_attribute16                   varchar2(150),
  epa_attribute17                   varchar2(150),
  epa_attribute18                   varchar2(150),
  epa_attribute19                   varchar2(150),
  epa_attribute20                   varchar2(150),
  epa_attribute21                   varchar2(150),
  epa_attribute22                   varchar2(150),
  epa_attribute23                   varchar2(150),
  epa_attribute24                   varchar2(150),
  epa_attribute25                   varchar2(150),
  epa_attribute26                   varchar2(150),
  epa_attribute27                   varchar2(150),
  epa_attribute28                   varchar2(150),
  epa_attribute29                   varchar2(150),
  epa_attribute30                   varchar2(150),
