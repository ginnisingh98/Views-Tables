--------------------------------------------------------
--  DDL for Package PSP_PFT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_PFT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_period_frequency_id
--     already exists.
--
--  In Arguments:
