--------------------------------------------------------
--  DDL for Package IGS_AS_EXM_INS_SPVSR_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_AS_EXM_INS_SPVSR_PKG" AUTHID CURRENT_USER AS
 /* $Header: IGSDI11S.pls 115.3 2002/11/28 23:13:02 nsidana ship $ */
