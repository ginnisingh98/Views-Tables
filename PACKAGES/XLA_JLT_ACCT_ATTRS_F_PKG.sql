--------------------------------------------------------
--  DDL for Package XLA_JLT_ACCT_ATTRS_F_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XLA_JLT_ACCT_ATTRS_F_PKG" AUTHID CURRENT_USER AS
/* $Header: xlatbass.pkh 120.6 2004/05/27 20:32:21 dcshah ship $ */
/*======================================================================+
