--------------------------------------------------------
--  DDL for Package HXC_TCC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_TCC_SHD" AUTHID CURRENT_USER as
