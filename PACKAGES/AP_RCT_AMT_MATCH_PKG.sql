--------------------------------------------------------
--  DDL for Package AP_RCT_AMT_MATCH_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_RCT_AMT_MATCH_PKG" AUTHID CURRENT_USER AS
/*$Header: apamtrcs.pls 120.3 2005/07/29 11:44:15 schitlap noship $*/
