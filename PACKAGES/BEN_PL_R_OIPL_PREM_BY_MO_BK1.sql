--------------------------------------------------------
--  DDL for Package BEN_PL_R_OIPL_PREM_BY_MO_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PL_R_OIPL_PREM_BY_MO_BK1" AUTHID CURRENT_USER as
/* $Header: bepbmapi.pkh 120.0 2005/05/28 10:05:32 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_PL_R_OIPL_PREM_BY_MO_b >-----------------|
-- ----------------------------------------------------------------------------
--
