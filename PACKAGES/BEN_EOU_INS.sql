--------------------------------------------------------
--  DDL for Package BEN_EOU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EOU_INS" AUTHID CURRENT_USER as
...
--   Internal Development Use Only.
--
procedure set_base_key_value(p_elig_org_unit_prte_id  in  number);
