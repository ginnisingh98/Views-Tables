--------------------------------------------------------
--  DDL for Package HXC_ATC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_ATC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (alias_type_component_id         number(15)
  ,component_name                  varchar2(240)
  ,component_type                  varchar2(80)
  ,mapping_component_id            number(15)
  ,alias_type_id                   number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HXC_ALIAS_TYPE_COMPONENTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
