--------------------------------------------------------
--  DDL for Package PAY_IE_PAYE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_IE_PAYE_BK2" AUTHID CURRENT_USER as
/* $Header: pyipdapi.pkh 120.9 2008/01/11 06:59:21 rrajaman noship $ */
--
-- ----------------------------------------------------------------------------
-- |------------------------< update_ie_paye_details_b >----------------------|
-- ----------------------------------------------------------------------------
--
procedure update_ie_paye_details_b
...
--
-- ----------------------------------------------------------------------------
-- |---------------------< update_ie_paye_details_a >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_ie_paye_details_a
  (p_effective_date                in     date
  ,p_business_group_id             in     number
  ,p_datetrack_update_mode         in     varchar2
  ,p_paye_details_id               in     number
