--------------------------------------------------------
--  DDL for Package BEN_ELIG_DPNT_OTHR_PTIP_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_DPNT_OTHR_PTIP_BK2" AUTHID CURRENT_USER as
/* $Header: beetdapi.pkh 120.0 2005/05/28 03:01:18 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_DPNT_OTHR_PTIP_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_DPNT_OTHR_PTIP_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_DPNT_OTHR_PTIP_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_DPNT_OTHR_PTIP_a
  (
   p_elig_dpnt_othr_ptip_id         in  number
...
--
end ben_ELIG_DPNT_OTHR_PTIP_bk2;
