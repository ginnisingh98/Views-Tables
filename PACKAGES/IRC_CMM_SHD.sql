--------------------------------------------------------
--  DDL for Package IRC_CMM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_CMM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (communication_message_id        number(15)
  ,parent_id                       number(15)
  ,communication_topic_id          number(15)
  ,message_subject                 varchar2(150)
  ,message_body                    varchar2(4000)
  ,message_post_date               date
  ,sender_type                     varchar2(50)
  ,sender_id                       number(15)
  ,document_type                   varchar2(50)
  ,document_id                     number(15)
  ,deleted_flag                    varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_COMM_MESSAGES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
