--------------------------------------------------------
--  DDL for Package BEN_DERIVE_PART_AND_RATE_CVG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DERIVE_PART_AND_RATE_CVG" AUTHID CURRENT_USER as
/* $Header: bendrcvg.pkh 120.0 2005/05/28 04:12:06 appldev noship $ */
--------------------------------------------------------------------------------
/*
+==============================================================================+
...
g_cache_plip_los_rt_rec ben_derive_part_and_rate_cache.g_cache_los_rec_table;
--
...
g_cache_plip_age_rt_rec ben_derive_part_and_rate_cache.g_cache_age_rec_table;
--
...
g_cache_plip_clf_rt_rec ben_derive_part_and_rate_cache.g_cache_clf_rec_table;
--
...
g_cache_plip_cla_rt_rec ben_derive_part_and_rate_cache.g_cache_cla_rec_table;
--
...
g_cache_plip_pff_rt_rec ben_derive_part_and_rate_cache.g_cache_pff_rec_table;
--
...
g_cache_plip_hwf_rt_rec ben_derive_part_and_rate_cache.g_cache_hwf_rec_table;
--
