--------------------------------------------------------
--  DDL for Package PAY_PAYGBP45_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PAYGBP45_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: PAYGBP45S.pls 120.0 2008/01/07 15:33:54 srikrish noship $ */
  P_SESSION_DATE DATE;
  ...
  FUNCTION C_FORMAT_DATA_FORMULA(TITLE IN VARCHAR2
                                ...
                                ,W1_M1_INDICATOR IN VARCHAR2) RETURN VARCHAR2;
