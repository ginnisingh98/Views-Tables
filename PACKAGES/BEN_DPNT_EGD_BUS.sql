--------------------------------------------------------
--  DDL for Package BEN_DPNT_EGD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DPNT_EGD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_eligy_criteria_id already exists.
--
--  In Arguments:
--    p_eligy_criteria_id
--
...
function return_legislation_code
  (p_eligy_criteria_dpnt_id in number) return varchar2;
  */
--
--
-- ----------------------------------------------------------------------------
