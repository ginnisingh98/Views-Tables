--------------------------------------------------------
--  DDL for Package OKL_PROCESS_BUCKETS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_PROCESS_BUCKETS_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUBUKS.pls 120.1 2005/07/18 10:30:28 asawanka noship $ */
