--------------------------------------------------------
--  DDL for Package IRC_IVC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IVC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (vacancy_consideration_id        number(15)
  ,person_id                       number(15)
  ,party_id                        number(15)
  ,vacancy_id                      number(15)
  ,consideration_status            varchar2(30)
...
g_tab_nam  constant varchar2(30) := 'IRC_VACANCY_CONSIDERATIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
