--------------------------------------------------------
--  DDL for Package HR_TWN_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TWN_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_template_window_id already exists.
--
--  In Arguments:
