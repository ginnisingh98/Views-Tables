--------------------------------------------------------
--  DDL for Package PER_PAC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PAC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,checklist_name                  varchar2(240)
  ,description                     varchar2(360)
  ,checklist_category              varchar2(60)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_ALLOCATED_CHECKLISTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
