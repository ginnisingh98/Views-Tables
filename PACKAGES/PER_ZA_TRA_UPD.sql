--------------------------------------------------------
--  DDL for Package PER_ZA_TRA_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_TRA_UPD" AUTHID CURRENT_USER as
/* $Header: pezatrup.pkh 115.1 2002/12/05 06:52:40 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< upd >----------------------------------|
-- ----------------------------------------------------------------------------
