--------------------------------------------------------
--  DDL for Package BEN_ENRLD_ANTHR_PTIP_RT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ENRLD_ANTHR_PTIP_RT_BK2" AUTHID CURRENT_USER as
/* $Header: beentapi.pkh 120.0 2005/05/28 02:30:56 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ENRLD_ANTHR_PTIP_RT_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ENRLD_ANTHR_PTIP_RT_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ENRLD_ANTHR_PTIP_RT_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ENRLD_ANTHR_PTIP_RT_a
  (
   p_enrld_anthr_ptip_rt_id       in  number
...
--
end ben_ENRLD_ANTHR_PTIP_RT_bk2;
