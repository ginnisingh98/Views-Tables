--------------------------------------------------------
--  DDL for Package OTA_CPR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CPR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,prerequisite_course_id          number(9)
  ,business_group_id               number(15)
  ,prerequisite_type               varchar2(30)
  ,enforcement_mode                varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_COURSE_PREREQUISITES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
