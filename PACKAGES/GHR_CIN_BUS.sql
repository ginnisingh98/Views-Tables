--------------------------------------------------------
--  DDL for Package GHR_CIN_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CIN_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_compl_incident_id
--     already exists.
--
--  In Arguments:
--    p_compl_incident_id
