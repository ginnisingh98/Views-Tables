--------------------------------------------------------
--  DDL for Package PER_PAT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PAT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (allocated_task_id               number(15)
  ,allocated_checklist_id          number(15)
  ,task_name                       varchar2(240)
  ,description                     varchar2(360)
  ,performer_orig_system           varchar2(240)
  ,performer_orig_sys_id           number(15)
  ,task_owner_person_id            number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_ALLOCATED_TASKS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
