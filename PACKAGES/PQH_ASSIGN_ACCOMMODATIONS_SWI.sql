--------------------------------------------------------
--  DDL for Package PQH_ASSIGN_ACCOMMODATIONS_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_ASSIGN_ACCOMMODATIONS_SWI" AUTHID CURRENT_USER As
/* $Header: pqasaswi.pkh 115.2 2002/11/27 00:35:32 rpasapul noship $ */
-- ----------------------------------------------------------------------------
...
--  API: pqh_assign_accommodations_api.create_assign_accommodation
--
-- Pre-requisites
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: pqh_assign_accommodations_api.delete_assign_accommodation
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: pqh_assign_accommodations_api.update_assign_accommodation
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
