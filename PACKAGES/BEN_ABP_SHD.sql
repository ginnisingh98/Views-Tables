--------------------------------------------------------
--  DDL for Package BEN_ABP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ABP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  aplcn_to_bnft_pool_id             number(15),
  effective_start_date              date,
  effective_end_date                date,
  acty_base_rt_id                   number(15),
  bnft_prvdr_pool_id                number(15),
  business_group_id                 number(15),
  abp_attribute_category            varchar2(30),
  abp_attribute1                    varchar2(150),
  abp_attribute2                    varchar2(150),
  abp_attribute3                    varchar2(150),
  abp_attribute4                    varchar2(150),
  abp_attribute5                    varchar2(150),
  abp_attribute6                    varchar2(150),
  abp_attribute7                    varchar2(150),
  abp_attribute8                    varchar2(150),
  abp_attribute9                    varchar2(150),
  abp_attribute10                   varchar2(150),
  abp_attribute11                   varchar2(150),
  abp_attribute12                   varchar2(150),
  abp_attribute13                   varchar2(150),
  abp_attribute14                   varchar2(150),
  abp_attribute15                   varchar2(150),
  abp_attribute16                   varchar2(150),
  abp_attribute17                   varchar2(150),
  abp_attribute18                   varchar2(150),
  abp_attribute19                   varchar2(150),
  abp_attribute20                   varchar2(150),
  abp_attribute21                   varchar2(150),
  abp_attribute22                   varchar2(150),
  abp_attribute23                   varchar2(150),
  abp_attribute24                   varchar2(150),
  abp_attribute25                   varchar2(150),
  abp_attribute26                   varchar2(150),
  abp_attribute27                   varchar2(150),
  abp_attribute28                   varchar2(150),
  abp_attribute29                   varchar2(150),
  abp_attribute30                   varchar2(150),
...
--           p_base_key_value = :aplcn_to_bnft_pool_id).
--
-- Post Success:
--   Processing continues.
--
