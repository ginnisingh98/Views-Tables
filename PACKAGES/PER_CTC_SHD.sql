--------------------------------------------------------
--  DDL for Package PER_CTC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CTC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  type                              varchar2(30),
  status                            varchar2(30),
  status_reason                     varchar2(240),
  doc_status                        varchar2(240),
  doc_status_change_date           date,
  description                       varchar2(2000),
  duration                          number(22,2),
  duration_units                    varchar2(30),
  contractual_job_title             varchar2(80),
  parties                           varchar2(80),
  start_reason                      varchar2(30),
  end_reason                        varchar2(30),
  number_of_extensions              number(9),
  extension_reason                  varchar2(80),
  extension_period                  number(22,2),
  extension_period_units            varchar2(30),
  ctr_information_category          varchar2(30),
  ctr_information1                  varchar2(150),
  ctr_information2                  varchar2(150),
  ctr_information3                  varchar2(150),
  ctr_information4                  varchar2(150),
  ctr_information5                  varchar2(150),
  ctr_information6                  varchar2(150),
  ctr_information7                  varchar2(150),
  ctr_information8                  varchar2(150),
  ctr_information9                  varchar2(150),
  ctr_information10                 varchar2(150),
  ctr_information11                 varchar2(150),
  ctr_information12                 varchar2(150),
  ctr_information13                 varchar2(150),
  ctr_information14                 varchar2(150),
  ctr_information15                 varchar2(150),
  ctr_information16                 varchar2(150),
  ctr_information17                 varchar2(150),
  ctr_information18                 varchar2(150),
  ctr_information19                 varchar2(150),
  ctr_information20                 varchar2(150),
