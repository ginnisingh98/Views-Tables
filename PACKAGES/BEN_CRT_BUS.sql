--------------------------------------------------------
--  DDL for Package BEN_CRT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CRT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_crt_ordr_id already exists.
--
--  In Arguments:
--    p_crt_ordr_id
--
...
function return_legislation_code
  (p_crt_ordr_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
