--------------------------------------------------------
--  DDL for Package HR_TCN_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TCN_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_template_canvas_id already exists.
--
--  In Arguments:
