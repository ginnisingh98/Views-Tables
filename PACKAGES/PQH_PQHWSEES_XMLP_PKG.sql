--------------------------------------------------------
--  DDL for Package PQH_PQHWSEES_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_PQHWSEES_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: PQHWSEESS.pls 120.1 2007/12/07 07:00:24 vjaganat noship $ */
  ...
  P_BUDGETED_ENTITY_CD VARCHAR2(40);

  P_ENTITY_TYPE VARCHAR2(40);
