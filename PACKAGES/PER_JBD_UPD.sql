--------------------------------------------------------
--  DDL for Package PER_JBD_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_JBD_UPD" AUTHID CURRENT_USER as
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out per_jbd_shd.g_rec_type);
--
-- ----------------------------------------------------------------------------
-- |-------------------------------< upd_or_sel >-----------------------------|
-- ----------------------------------------------------------------------------
...
--   functionality of per_jbd_ins.ins_or_sel except is has to take into
...
--   the per_job_definitions table and the out arguments are returned.
...
procedure upd_or_sel
         (p_segment1               in     varchar2 default hr_api.g_varchar2,
          ...
          p_job_definition_id      in out number,
          p_name                      out varchar2,
