--------------------------------------------------------
--  DDL for Package PA_STATUS_LISTS_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PA_STATUS_LISTS_PVT" AUTHID CURRENT_USER AS
/* $Header: PACISLVS.pls 120.1 2005/08/19 16:18:44 mwasowic noship $ */
...
--      If in use it returns 'VIEW' otherwise it returns 'DELETE'.
--
--  HISTORY
