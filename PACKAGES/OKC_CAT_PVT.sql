--------------------------------------------------------
--  DDL for Package OKC_CAT_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_CAT_PVT" AUTHID CURRENT_USER AS
/* $Header: OKCSCATS.pls 120.0 2005/05/26 09:49:32 appldev noship $ */
  ---------------------------------------------------------------------------
...
--+Hand code end
  ...
  PROCEDURE INSERT_ROW_UPG(x_return_status OUT NOCOPY VARCHAR2, p_catv_tbl catv_tbl_type);
