--------------------------------------------------------
--  DDL for Package PAY_APM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_APM_SHD" AUTHID CURRENT_USER as
/* $Header: pyapmrhi.pkh 120.2 2006/12/04 13:39:39 abhargav noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (process_module_id               number(15)
  ,process_id                      number(15)
  ,module_id                       number(15)
  ,process_sequence                number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_AU_PROCESS_MODULES';
