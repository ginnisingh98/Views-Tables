--------------------------------------------------------
--  DDL for Package PER_RET_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RET_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cagr_retained_right_id
--     already exists.
--
--  In Arguments:
