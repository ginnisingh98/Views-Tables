--------------------------------------------------------
--  DDL for Package WSH_EXCEPTIONS_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."WSH_EXCEPTIONS_GRP" AUTHID CURRENT_USER AS
/* $Header: WSHXCPGS.pls 120.0 2005/05/26 18:16:22 appldev noship $ */
