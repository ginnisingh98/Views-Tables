--------------------------------------------------------
--  DDL for Package AP_AMT_MATCH_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_AMT_MATCH_PKG" AUTHID CURRENT_USER AS
/*$Header: apamopos.pls 120.1 2005/07/21 20:25:18 kkotwal noship $*/
...
FUNCTION get_prepay_ccid (po_dist_ccid  IN NUMBER,
                          l_prepay_ccid IN NUMBER) return number;
