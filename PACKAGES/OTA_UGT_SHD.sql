--------------------------------------------------------
--  DDL for Package OTA_UGT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_UGT_SHD" AUTHID CURRENT_USER as
/* $Header: otugtrhi.pkh 120.1 2008/03/27 13:16:45 pekasi noship $ */
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_USER_GROUPS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
