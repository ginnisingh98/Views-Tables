--------------------------------------------------------
--  DDL for Package IRC_IAV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IAV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (agency_vacancy_id               number(15)
  ,agency_id                       number(15)
  ,vacancy_id                      number(15)
  ,start_date                      date
  ,end_date                        date
  ,max_allowed_applicants          number(15)
  ,manage_applicants_allowed       varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_AGENCY_VACANCIES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
