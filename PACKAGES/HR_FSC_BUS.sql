--------------------------------------------------------
--  DDL for Package HR_FSC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FSC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_form_tab_stacked_canvas_id already exists.
--
--  In Arguments:
