--------------------------------------------------------
--  DDL for Package MTL_MOVEMENT_STATISTICS1_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."MTL_MOVEMENT_STATISTICS1_PKG" AUTHID CURRENT_USER as
/* $Header: INVTTM1S.pls 120.1 2005/06/11 12:59:10 appldev  $ */
...
procedure delete_row (v_rowid varchar2);
