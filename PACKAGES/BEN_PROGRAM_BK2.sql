--------------------------------------------------------
--  DDL for Package BEN_PROGRAM_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PROGRAM_BK2" AUTHID CURRENT_USER as
