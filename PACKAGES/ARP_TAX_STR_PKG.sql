--------------------------------------------------------
--  DDL for Package ARP_TAX_STR_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARP_TAX_STR_PKG" AUTHID CURRENT_USER AS
/* $Header: ARTXSTRS.pls 115.2 2002/08/30 00:57:27 cleyvaol ship $ */
