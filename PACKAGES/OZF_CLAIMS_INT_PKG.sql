--------------------------------------------------------
--  DDL for Package OZF_CLAIMS_INT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_CLAIMS_INT_PKG" AUTHID CURRENT_USER AS
/* $Header: ozftcins.pls 115.3 2004/07/05 08:49:16 upoluri ship $ */
-- ===============================================================
-- Start of Comments
-- Package name
--          OZF_CLAIMS_INT_PKG
