--------------------------------------------------------
--  DDL for Package BEN_ELIGIBLE_PERSON_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIGIBLE_PERSON_BK2" AUTHID CURRENT_USER as
/* $Header: bepepapi.pkh 120.0 2005/05/28 10:39:02 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_Eligible_Person_b >-------------------|
-- ----------------------------------------------------------------------------
--
procedure update_Eligible_Person_b
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_Eligible_Person_a >-------------------|
-- ----------------------------------------------------------------------------
--
procedure update_Eligible_Person_a
  (p_elig_per_id                    in  number
