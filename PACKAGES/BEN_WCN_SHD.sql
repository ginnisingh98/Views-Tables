--------------------------------------------------------
--  DDL for Package BEN_WCN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_WCN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  wv_prtn_rsn_ctfn_pl_id            number(15),
  ...
  wv_prtn_rsn_pl_id                 number(15),
  business_group_id                 number(15),
  wcn_attribute_category            varchar2(30),
  wcn_attribute1                    varchar2(150),
  wcn_attribute2                    varchar2(150),
  wcn_attribute3                    varchar2(150),
  wcn_attribute4                    varchar2(150),
  wcn_attribute5                    varchar2(150),
  wcn_attribute6                    varchar2(150),
  wcn_attribute7                    varchar2(150),
  wcn_attribute8                    varchar2(150),
  wcn_attribute9                    varchar2(150),
  wcn_attribute10                   varchar2(150),
  wcn_attribute11                   varchar2(150),
  wcn_attribute12                   varchar2(150),
  wcn_attribute13                   varchar2(150),
  wcn_attribute14                   varchar2(150),
  wcn_attribute15                   varchar2(150),
  wcn_attribute16                   varchar2(150),
  wcn_attribute17                   varchar2(150),
  wcn_attribute18                   varchar2(150),
  wcn_attribute19                   varchar2(150),
  wcn_attribute20                   varchar2(150),
  wcn_attribute21                   varchar2(150),
  wcn_attribute22                   varchar2(150),
  wcn_attribute23                   varchar2(150),
  wcn_attribute24                   varchar2(150),
  wcn_attribute25                   varchar2(150),
  wcn_attribute26                   varchar2(150),
  wcn_attribute27                   varchar2(150),
  wcn_attribute28                   varchar2(150),
  wcn_attribute29                   varchar2(150),
  wcn_attribute30                   varchar2(150),
...
--           p_base_key_value = :wv_prtn_rsn_ctfn_pl_id).
--
-- Post Success:
--   Processing continues.
--
