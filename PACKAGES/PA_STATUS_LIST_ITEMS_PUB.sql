--------------------------------------------------------
--  DDL for Package PA_STATUS_LIST_ITEMS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PA_STATUS_LIST_ITEMS_PUB" AUTHID CURRENT_USER AS
/* $Header: PACISIPS.pls 120.1 2005/08/19 16:18:11 mwasowic noship $ */
