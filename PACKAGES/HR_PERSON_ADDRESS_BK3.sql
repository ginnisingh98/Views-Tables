--------------------------------------------------------
--  DDL for Package HR_PERSON_ADDRESS_BK3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PERSON_ADDRESS_BK3" AUTHID CURRENT_USER as
/* $Header: peaddapi.pkh 120.4.12010000.2 2009/10/01 07:19:46 pchowdav ship $ */
--
-- ----------------------------------------------------------------------------
-- |--------------------<update_pers_addr_with_style_b >---------------------|
-- ----------------------------------------------------------------------------
--
procedure update_pers_addr_with_style_b
  ...
  ,p_style                         in     varchar2
  ,p_primary_flag		   in     varchar2 --fix for bug 8938775
  );
--
-- ----------------------------------------------------------------------------
-- |-------------------< update_pers_addr_with_style_a >---------------------|
-- ----------------------------------------------------------------------------
--
