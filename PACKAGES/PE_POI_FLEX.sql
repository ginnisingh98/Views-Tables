--------------------------------------------------------
--  DDL for Package PE_POI_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PE_POI_FLEX" AUTHID CURRENT_USER as
/* $Header: pepoifli.pkh 115.0 99/07/18 14:27:42 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
