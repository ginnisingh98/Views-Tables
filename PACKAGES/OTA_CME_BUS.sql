--------------------------------------------------------
--  DDL for Package OTA_CME_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CME_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cert_mbr_enrollment_id
--     already exists.
--
--  In Arguments:
