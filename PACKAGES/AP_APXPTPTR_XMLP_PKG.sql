--------------------------------------------------------
--  DDL for Package AP_APXPTPTR_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_APXPTPTR_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: APXPTPTRS.pls 120.0 2007/12/27 08:27:21 vjaganat noship $ */
	P_DEBUG_SWITCH	varchar2(1);
	P_CONC_REQUEST_ID	number;
	P_MIN_PRECISION	number;
	P_FLEXDATA	varchar2(600);
	P_SET_OF_BOOKS_ID	number;
	P_TERMTYPE	varchar2(32767);
	P_EFFECTIVE_DATE	date;
	LP_EFFECTIVE_DATE	varchar2(11);
	...
	Function C_NLS_TERMTYPE_p return varchar2;
