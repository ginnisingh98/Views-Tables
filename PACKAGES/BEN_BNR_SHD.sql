--------------------------------------------------------
--  DDL for Package BEN_BNR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BNR_SHD" AUTHID CURRENT_USER as
...
--  pgm_id                            number(15),
  rptg_prps_cd                      varchar2(30),
  rpg_desc                          varchar2(240),
  bnr_attribute_category            varchar2(30),
  bnr_attribute1                    varchar2(150),
  bnr_attribute2                    varchar2(150),
  bnr_attribute3                    varchar2(150),
  bnr_attribute4                    varchar2(150),
  bnr_attribute5                    varchar2(150),
  bnr_attribute6                    varchar2(150),
  bnr_attribute7                    varchar2(150),
  bnr_attribute8                    varchar2(150),
  bnr_attribute9                    varchar2(150),
  bnr_attribute10                   varchar2(150),
  bnr_attribute11                   varchar2(150),
  bnr_attribute12                   varchar2(150),
  bnr_attribute13                   varchar2(150),
  bnr_attribute14                   varchar2(150),
  bnr_attribute15                   varchar2(150),
  bnr_attribute16                   varchar2(150),
  bnr_attribute17                   varchar2(150),
  bnr_attribute18                   varchar2(150),
  bnr_attribute19                   varchar2(150),
  bnr_attribute20                   varchar2(150),
  bnr_attribute21                   varchar2(150),
  bnr_attribute22                   varchar2(150),
  bnr_attribute23                   varchar2(150),
  bnr_attribute24                   varchar2(150),
  bnr_attribute25                   varchar2(150),
  bnr_attribute26                   varchar2(150),
  bnr_attribute27                   varchar2(150),
  bnr_attribute28                   varchar2(150),
  bnr_attribute29                   varchar2(150),
  bnr_attribute30                   varchar2(150),
