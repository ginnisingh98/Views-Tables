--------------------------------------------------------
--  DDL for Package BEN_EPF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_pct_fl_tm_prte_id            number(15),
  ...
  ordr_num                          number(15),
  epf_attribute_category            varchar2(30),
  epf_attribute1                    varchar2(150),
  epf_attribute2                    varchar2(150),
  epf_attribute3                    varchar2(150),
  epf_attribute4                    varchar2(150),
  epf_attribute5                    varchar2(150),
  epf_attribute6                    varchar2(150),
  epf_attribute7                    varchar2(150),
  epf_attribute8                    varchar2(150),
  epf_attribute9                    varchar2(150),
  epf_attribute10                   varchar2(150),
  epf_attribute11                   varchar2(150),
  epf_attribute12                   varchar2(150),
  epf_attribute13                   varchar2(150),
  epf_attribute14                   varchar2(150),
  epf_attribute15                   varchar2(150),
  epf_attribute16                   varchar2(150),
  epf_attribute17                   varchar2(150),
  epf_attribute18                   varchar2(150),
  epf_attribute19                   varchar2(150),
  epf_attribute20                   varchar2(150),
  epf_attribute21                   varchar2(150),
  epf_attribute22                   varchar2(150),
  epf_attribute23                   varchar2(150),
  epf_attribute24                   varchar2(150),
  epf_attribute25                   varchar2(150),
  epf_attribute26                   varchar2(150),
  epf_attribute27                   varchar2(150),
  epf_attribute28                   varchar2(150),
  epf_attribute29                   varchar2(150),
  epf_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_pct_fl_tm_prte_id).
--
-- Post Success:
--   Processing continues.
--
