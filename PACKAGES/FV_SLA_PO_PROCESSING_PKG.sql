--------------------------------------------------------
--  DDL for Package FV_SLA_PO_PROCESSING_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FV_SLA_PO_PROCESSING_PKG" AUTHID CURRENT_USER as
--$Header: FVXLAPOS.pls 120.0.12010000.1 2010/02/10 19:36:46 sasukuma noship $
...
END fv_sla_po_processing_pkg; -- Package spec
