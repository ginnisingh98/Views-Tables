--------------------------------------------------------
--  DDL for Package SSP_SMP_SUPPORT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."SSP_SMP_SUPPORT_PKG" AUTHID CURRENT_USER as
/*      $Header: spsspbsi.pkh 120.0.12010000.2 2008/08/13 13:31:39 ubhat ship $
+==============================================================================+
