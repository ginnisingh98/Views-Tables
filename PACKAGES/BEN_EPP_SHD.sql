--------------------------------------------------------
--  DDL for Package BEN_EPP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_prtt_anthr_pl_prte_id        number(15),
  ...
  epp_attribute_category            varchar2(30),
  epp_attribute1                    varchar2(150),
  epp_attribute2                    varchar2(150),
  epp_attribute3                    varchar2(150),
  epp_attribute4                    varchar2(150),
  epp_attribute5                    varchar2(150),
  epp_attribute6                    varchar2(150),
  epp_attribute7                    varchar2(150),
  epp_attribute8                    varchar2(150),
  epp_attribute9                    varchar2(150),
  epp_attribute10                   varchar2(150),
  epp_attribute11                   varchar2(150),
  epp_attribute12                   varchar2(150),
  epp_attribute13                   varchar2(150),
  epp_attribute14                   varchar2(150),
  epp_attribute15                   varchar2(150),
  epp_attribute16                   varchar2(150),
  epp_attribute17                   varchar2(150),
  epp_attribute18                   varchar2(150),
  epp_attribute19                   varchar2(150),
  epp_attribute20                   varchar2(150),
  epp_attribute21                   varchar2(150),
  epp_attribute22                   varchar2(150),
  epp_attribute23                   varchar2(150),
  epp_attribute24                   varchar2(150),
  epp_attribute25                   varchar2(150),
  epp_attribute26                   varchar2(150),
  epp_attribute27                   varchar2(150),
  epp_attribute28                   varchar2(150),
  epp_attribute29                   varchar2(150),
  epp_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_prtt_anthr_pl_prte_id).
--
-- Post Success:
--   Processing continues.
--
