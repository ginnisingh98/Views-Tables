--------------------------------------------------------
--  DDL for Package OTA_TPL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TPL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  price_list_type                   varchar2(30),
  start_date                        date,
  comments                          varchar2(2000),
  description                       varchar2(240),
  end_date                          date,
  single_unit_price                 number(17,2),     -- Increased length
  training_unit_type                varchar2(30),
  tpl_information_category          varchar2(30),
  tpl_information1                  varchar2(150),
  tpl_information2                  varchar2(150),
  tpl_information3                  varchar2(150),
  tpl_information4                  varchar2(150),
  tpl_information5                  varchar2(150),
  tpl_information6                  varchar2(150),
  tpl_information7                  varchar2(150),
  tpl_information8                  varchar2(150),
  tpl_information9                  varchar2(150),
  tpl_information10                 varchar2(150),
  tpl_information11                 varchar2(150),
  tpl_information12                 varchar2(150),
  tpl_information13                 varchar2(150),
  tpl_information14                 varchar2(150),
  tpl_information15                 varchar2(150),
  tpl_information16                 varchar2(150),
  tpl_information17                 varchar2(150),
  tpl_information18                 varchar2(150),
  tpl_information19                 varchar2(150),
  tpl_information20                 varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
