--------------------------------------------------------
--  DDL for Package AME_ATU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_ATU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,use_count                       number
  ,user_editable                   varchar2(9)       -- Increased length
  ,is_static                       varchar2(9)       -- Increased length
  ,start_date                      date
  ,end_date                        date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_ATTRIBUTE_USAGES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
