--------------------------------------------------------
--  DDL for Package CN_RT_QUOTA_ASGN_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CN_RT_QUOTA_ASGN_PVT_W" AUTHID CURRENT_USER as
  /* $Header: cnwrtqas.pls 120.2 2005/09/14 04:30 rarajara ship $ */
