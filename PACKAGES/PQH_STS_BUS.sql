--------------------------------------------------------
--  DDL for Package PQH_STS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_STS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_statutory_situation_id
--     already exists.
--
--  In Arguments:
