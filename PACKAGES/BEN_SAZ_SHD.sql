--------------------------------------------------------
--  DDL for Package BEN_SAZ_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_SAZ_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  svc_area_pstl_zip_rng_id          number(15),
  effective_start_date              date,
  effective_end_date                date,
  svc_area_id                       number(15),
  pstl_zip_rng_id                   number(15),
  business_group_id                 number(15),
  saz_attribute_category            varchar2(30),
  saz_attribute1                    varchar2(150),
  saz_attribute2                    varchar2(150),
  saz_attribute3                    varchar2(150),
  saz_attribute4                    varchar2(150),
  saz_attribute5                    varchar2(150),
  saz_attribute6                    varchar2(150),
  saz_attribute7                    varchar2(150),
  saz_attribute8                    varchar2(150),
  saz_attribute9                    varchar2(150),
  saz_attribute10                   varchar2(150),
  saz_attribute11                   varchar2(150),
  saz_attribute12                   varchar2(150),
  saz_attribute13                   varchar2(150),
  saz_attribute14                   varchar2(150),
  saz_attribute15                   varchar2(150),
  saz_attribute16                   varchar2(150),
  saz_attribute17                   varchar2(150),
  saz_attribute18                   varchar2(150),
  saz_attribute19                   varchar2(150),
  saz_attribute20                   varchar2(150),
  saz_attribute21                   varchar2(150),
  saz_attribute22                   varchar2(150),
  saz_attribute23                   varchar2(150),
  saz_attribute24                   varchar2(150),
  saz_attribute25                   varchar2(150),
  saz_attribute26                   varchar2(150),
  saz_attribute27                   varchar2(150),
  saz_attribute28                   varchar2(150),
  saz_attribute29                   varchar2(150),
  saz_attribute30                   varchar2(150),
...
--           p_base_key_value = :svc_area_pstl_zip_rng_id).
--
-- Post Success:
--   Processing continues.
--
