--------------------------------------------------------
--  DDL for Package BEN_ELIG_MRTL_STAT_CVG_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_MRTL_STAT_CVG_BK1" AUTHID CURRENT_USER as
/* $Header: beemsapi.pkh 120.0 2005/05/28 02:26:19 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Elig_Mrtl_Stat_Cvg_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Elig_Mrtl_Stat_Cvg_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Elig_Mrtl_Stat_Cvg_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Elig_Mrtl_Stat_Cvg_a
  (
...
--
end ben_Elig_Mrtl_Stat_Cvg_bk1;
