--------------------------------------------------------
--  DDL for Package PFT_PPROFCAL_MASTER_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PFT_PPROFCAL_MASTER_PUB" AUTHID CURRENT_USER AS
/* $Header: PFTPCAMS.pls 120.1 2006/05/25 09:53:48 ssthiaga noship $ */

---------------------------------------------
--  Package Constants
---------------------------------------------
   g_block               CONSTANT  VARCHAR2(80) := 'FEM.PLSQL.PFT_PROFCAL_MASTER_PUB';
...
--------Message Constants--------------
   ...
   G_ENG_RGN_CNT_DONE_ERR        CONSTANT  VARCHAR2(30) := 'PFT_PPROF_RGN_CNT_DONE_ERR';
   G_ENG_PPTILE_DONE_ERR         CONSTANT  VARCHAR2(30) := 'PFT_PPROF_PPTILE_DONE_ERR';
--------------------------------------------
--  Variable Types
---------------------------------------------
   id                               NUMBER(9);
...
---------------------------------------------
 ...
 |
 | DESCRIPTION
 |      This procedure is the public procedure for the profit calculation master
 |      Engine API
 |
 | scope - public
 |
