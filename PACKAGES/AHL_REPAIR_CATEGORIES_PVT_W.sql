--------------------------------------------------------
--  DDL for Package AHL_REPAIR_CATEGORIES_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_REPAIR_CATEGORIES_PVT_W" AUTHID CURRENT_USER as
  /* $Header: AHLWRCTS.pls 120.0 2005/07/04 03:58 tamdas noship $ */
