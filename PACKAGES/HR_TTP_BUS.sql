--------------------------------------------------------
--  DDL for Package HR_TTP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TTP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_template_tab_page_id already exists.
--
--  In Arguments:
