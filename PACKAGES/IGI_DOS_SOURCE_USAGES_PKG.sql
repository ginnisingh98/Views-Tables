--------------------------------------------------------
--  DDL for Package IGI_DOS_SOURCE_USAGES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGI_DOS_SOURCE_USAGES_PKG" AUTHID CURRENT_USER AS
/* $Header: igidosps.pls 120.4.12000000.2 2007/06/14 04:58:05 pshivara ship $ */
  ...
  PROCEDURE before_dml (
    ...
    x_stored_name                       IN     VARCHAR2    DEFAULT NULL,
