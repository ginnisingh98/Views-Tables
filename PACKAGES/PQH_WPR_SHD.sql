--------------------------------------------------------
--  DDL for Package PQH_WPR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_WPR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  worksheet_period_id               number(15),
  end_time_period_id                number(15),
  ...
  start_time_period_id              number(15),
