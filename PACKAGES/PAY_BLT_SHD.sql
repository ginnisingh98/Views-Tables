--------------------------------------------------------
--  DDL for Package PAY_BLT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_BLT_SHD" AUTHID CURRENT_USER as
/* $Header: pybltrhi.pkh 120.0 2005/05/29 03:22:05 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  ...
  ,assignment_remuneration_flag    varchar2(30)
  ,balance_name                    varchar2(80)
  ,balance_uom                     varchar2(30)
  ...
  ,jurisdiction_level              number(9)         -- Increased length
  ,tax_type                        varchar2(30)
  ,object_version_number           number(9)
  ,balance_category_id             number(9)
  ,base_balance_type_id            number(9)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_BALANCE_TYPES';
