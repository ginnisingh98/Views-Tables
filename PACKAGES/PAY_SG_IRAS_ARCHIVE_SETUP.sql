--------------------------------------------------------
--  DDL for Package PAY_SG_IRAS_ARCHIVE_SETUP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_SG_IRAS_ARCHIVE_SETUP" AUTHID CURRENT_USER as
/* $Header: pysgirsu.pkh 120.0 2005/05/29 08:47:25 appldev noship $ */
  --------------------------------------------------------------------
