--------------------------------------------------------
--  DDL for Package BEN_LER_RQRS_ENRT_CTFN_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LER_RQRS_ENRT_CTFN_BK1" AUTHID CURRENT_USER as
/* $Header: belreapi.pkh 120.0 2005/05/28 03:34:09 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ler_rqrs_enrt_ctfn_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ler_rqrs_enrt_ctfn_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ler_rqrs_enrt_ctfn_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ler_rqrs_enrt_ctfn_a
  (
...
--
end ben_ler_rqrs_enrt_ctfn_bk1;
