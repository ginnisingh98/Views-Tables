--------------------------------------------------------
--  DDL for Package ARH_CPC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARH_CPC_PKG" AUTHID CURRENT_USER as
/*$Header: ARHCPCS.pls 120.5.12010000.2 2009/02/02 14:07:48 mpsingh ship $*/
...
/* Bug 3619062 Overloaded this procedure with X_Credit_Classification as parameter*/
PROCEDURE Insert_Row  (X_Row_Id                         IN OUT NOCOPY VARCHAR2,
                       X_Customer_Profile_Class_Id      IN OUT NOCOPY NUMBER ,
                       X_Last_Updated_By                NUMBER,
                       X_Last_Update_Date               DATE,
