--------------------------------------------------------
--  DDL for Package BEN_ELIG_BENFTS_GRP_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_BENFTS_GRP_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beebnapi.pkh 120.0 2005/05/28 01:47:09 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_BENFTS_GRP_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_BENFTS_GRP_PRTE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_BENFTS_GRP_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_BENFTS_GRP_PRTE_a
  (
...
--
end ben_ELIG_BENFTS_GRP_PRTE_bk1;
