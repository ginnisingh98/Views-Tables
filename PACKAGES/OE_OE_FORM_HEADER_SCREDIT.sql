--------------------------------------------------------
--  DDL for Package OE_OE_FORM_HEADER_SCREDIT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_OE_FORM_HEADER_SCREDIT" AUTHID CURRENT_USER AS
/* $Header: OEXFHSCS.pls 120.0 2005/05/31 23:15:51 appldev noship $ */
...
,   x_dw_update_advice_flag         OUT NOCOPY /* file.sql.39 change */ VARCHAR2
...
,   x_sales_credit_type_id          OUT NOCOPY /* file.sql.39 change */ NUMBER
,   x_sales_credit_id               OUT NOCOPY /* file.sql.39 change */ NUMBER
,   x_wh_update_date                OUT NOCOPY /* file.sql.39 change */ DATE
,   x_salesrep                      OUT NOCOPY /* file.sql.39 change */ VARCHAR2
,   x_sales_credit_type             OUT NOCOPY /* file.sql.39 change */ VARCHAR2
--SG {
...
Procedure Get_Values(p_header_scredit_rec      IN OE_Order_PUB.Header_Scredit_Rec_Type
                     ,x_header_scredit_val_rec OUT NOCOPY OE_Order_PUB.Header_Scredit_Val_Rec_Type);
--SG}
