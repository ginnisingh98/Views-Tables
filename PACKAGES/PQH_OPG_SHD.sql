--------------------------------------------------------
--  DDL for Package PQH_OPG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_OPG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (operation_group_id              number(15)
  ,operation_group_code            varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_OPERATION_GROUPS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
