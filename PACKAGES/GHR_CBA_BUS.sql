--------------------------------------------------------
--  DDL for Package GHR_CBA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CBA_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_compl_basis_id
--     already exists.
--
--  In Arguments:
--    p_compl_basis_id
