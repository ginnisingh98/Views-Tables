--------------------------------------------------------
--  DDL for Package PER_RSC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RSC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  max_scale_step                    number(15),
  min_scale_step                    number(15),
