--------------------------------------------------------
--  DDL for Package PSP_PFB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_PFB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,start_date                      date
  ,unit_of_measure                 varchar2(9)       -- Increased length
  ,period_duration                 number
  ,report_type                     varchar2(9)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PSP_REPORT_PERIOD_FREQUENCY_B';
