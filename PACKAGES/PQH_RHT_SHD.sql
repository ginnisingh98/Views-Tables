--------------------------------------------------------
--  DDL for Package PQH_RHT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RHT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  routing_history_id                number(15),
  approval_cd                       varchar2(30),
  comments                          varchar2(2000),   -- pseudo column
  forwarded_by_assignment_id        number(15),
  forwarded_by_member_id            number(15),
  forwarded_by_position_id          number(15),
  forwarded_by_user_id              number(15),
  forwarded_by_role_id              number(15),
  forwarded_to_assignment_id        number(15),
  forwarded_to_member_id            number(15),
  forwarded_to_position_id          number(15),
  forwarded_to_user_id              number(15),
  forwarded_to_role_id              number(15),
  notification_date                 date,
  pos_structure_version_id          number,
  routing_category_id               number(15),
  transaction_category_id           number(15),
  transaction_id                    number(15),
  user_action_cd                    varchar2(10),
  from_range_name                   varchar2(30),
  to_range_name                     varchar2(30),
  list_range_name                   varchar2(30),
