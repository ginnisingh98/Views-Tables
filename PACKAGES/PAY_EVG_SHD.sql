--------------------------------------------------------
--  DDL for Package PAY_EVG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EVG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,proration_type                  varchar2(30)
  ,business_group_id               number(15)
  ,legislation_code                varchar2(30)
  ,object_version_number           number(9)
  ,time_definition_id              number(15)
  );
--
-- ----------------------------------------------------------------------------
