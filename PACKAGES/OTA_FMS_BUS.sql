--------------------------------------------------------
--  DDL for Package OTA_FMS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_FMS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_forum_message_id
--     already exists.
--
--  In Arguments:
--    p_forum_message_id
