--------------------------------------------------------
--  DDL for Package AP_APXQCQCL_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_APXQCQCL_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: APXQCQCLS.pls 120.0 2007/12/27 08:28:42 vjaganat noship $ */
	...
	Function C_NLS_ACTIVE_TYPE_p return varchar2;
