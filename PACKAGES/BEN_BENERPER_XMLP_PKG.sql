--------------------------------------------------------
--  DDL for Package BEN_BENERPER_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BENERPER_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: BENERPERS.pls 120.1 2007/12/10 08:31:58 vjaganat noship $ */
    run_mode varchar2(100);
	P_CONCURRENT_REQUEST_ID	number;
	P_SUB_TITLE	varchar2(60);
	...
	CV_19	varchar2(240);
	CV_20	varchar2(240);
	CP_DEBUG_MESSAGE	varchar2(240);
	CP_LOCATION	varchar2(240);
	CP_AUDIT_LOG	varchar2(240);
	CP_BENFT_GROUP	varchar2(240);
	CP_1	varchar2(272);
	CP_FROM_OCRD_DT	varchar2(30);
	CP_TO_OCRD_DT	varchar2(30);
	CP_BCKT_STAT_CD	varchar2(30);
	...
	Function CP_FROM_OCRD_DT_p return varchar2;
	Function CP_TO_OCRD_DT_p return varchar2;
	Function CP_BCKT_STAT_CD_p return varchar2;
