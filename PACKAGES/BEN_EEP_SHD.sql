--------------------------------------------------------
--  DDL for Package BEN_EEP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EEP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_enrld_anthr_pl_id            number(15),
  ...
  pl_id                             number(15),
  eep_attribute_category            varchar2(30),
  eep_attribute1                    varchar2(150),
  eep_attribute2                    varchar2(150),
  eep_attribute3                    varchar2(150),
  eep_attribute4                    varchar2(150),
  eep_attribute5                    varchar2(150),
  eep_attribute6                    varchar2(150),
  eep_attribute7                    varchar2(150),
  eep_attribute8                    varchar2(150),
  eep_attribute9                    varchar2(150),
  eep_attribute10                   varchar2(150),
  eep_attribute11                   varchar2(150),
  eep_attribute12                   varchar2(150),
  eep_attribute13                   varchar2(150),
  eep_attribute14                   varchar2(150),
  eep_attribute15                   varchar2(150),
  eep_attribute16                   varchar2(150),
  eep_attribute17                   varchar2(150),
  eep_attribute18                   varchar2(150),
  eep_attribute19                   varchar2(150),
  eep_attribute20                   varchar2(150),
  eep_attribute21                   varchar2(150),
  eep_attribute22                   varchar2(150),
  eep_attribute23                   varchar2(150),
  eep_attribute24                   varchar2(150),
  eep_attribute25                   varchar2(150),
  eep_attribute26                   varchar2(150),
  eep_attribute27                   varchar2(150),
  eep_attribute28                   varchar2(150),
  eep_attribute29                   varchar2(150),
  eep_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_enrld_anthr_pl_id).
--
-- Post Success:
--   Processing continues.
--
