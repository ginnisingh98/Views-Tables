--------------------------------------------------------
--  DDL for Package ARP_STAX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ARP_STAX" AUTHID CURRENT_USER AS
/* $Header: ARPLSTXS.pls 115.6 2002/11/15 22:03:57 thwon ship $   */
