--------------------------------------------------------
--  DDL for Package BEN_XIC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XIC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ext_incl_chg_id                   number(15),
  chg_evt_cd                        varchar2(30),
  chg_evt_source                    varchar2(30),
