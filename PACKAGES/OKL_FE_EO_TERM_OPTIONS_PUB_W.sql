--------------------------------------------------------
--  DDL for Package OKL_FE_EO_TERM_OPTIONS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_FE_EO_TERM_OPTIONS_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUEOTS.pls 120.0 2005/07/07 10:46:10 viselvar noship $ */
