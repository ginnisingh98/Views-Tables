--------------------------------------------------------
--  DDL for Package PER_HIERARCHY_VERSIONS_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_HIERARCHY_VERSIONS_SWI" AUTHID CURRENT_USER As
/* $Header: pepgvswi.pkh 115.0 2003/09/25 04:03 krmahade noship $ */
-- ----------------------------------------------------------------------------
...
--  API: per_hierarchy_versions_api.create_hierarchy_versions
--
-- Pre-requisites
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: per_hierarchy_versions_api.delete_hierarchy_versions
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: per_hierarchy_versions_api.lck
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: per_hierarchy_versions_api.update_hierarchy_versions
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
...
end per_hierarchy_versions_swi;
