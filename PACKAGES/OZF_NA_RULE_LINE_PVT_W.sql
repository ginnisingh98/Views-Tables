--------------------------------------------------------
--  DDL for Package OZF_NA_RULE_LINE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_NA_RULE_LINE_PVT_W" AUTHID CURRENT_USER as
  /* $Header: ozfwdnls.pls 120.1 2005/10/26 14:19 rssharma noship $ */
