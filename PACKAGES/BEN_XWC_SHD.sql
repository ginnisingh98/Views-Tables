--------------------------------------------------------
--  DDL for Package BEN_XWC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XWC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ext_where_clause_id               number(15),
  seq_num                           number(15),
  oper_cd                           varchar2(30),
  val                               varchar2(300),
  and_or_cd                         varchar2(30),
  ext_data_elmt_id                  number(15),
  cond_ext_data_elmt_id             number(15),
  ext_rcd_in_file_id                number(15),
  ext_data_elmt_in_rcd_id           number(15),
  ...
  cond_ext_data_elmt_in_rcd_id      number(15)
  );
--
