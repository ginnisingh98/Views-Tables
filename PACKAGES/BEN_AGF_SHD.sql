--------------------------------------------------------
--  DDL for Package BEN_AGF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_AGF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  age_to_use_cd                     varchar2(30),
  age_det_cd                        varchar2(30),
  age_det_rl                        number(15),
  rndg_cd                           varchar2(30),
  rndg_rl                           number(15),
  age_calc_rl                       number(15),
  business_group_id                 number(15),
  agf_attribute_category            varchar2(30),
  agf_attribute1                    varchar2(150),
  agf_attribute2                    varchar2(150),
  agf_attribute3                    varchar2(150),
  agf_attribute4                    varchar2(150),
  agf_attribute5                    varchar2(150),
  agf_attribute6                    varchar2(150),
  agf_attribute7                    varchar2(150),
  agf_attribute8                    varchar2(150),
  agf_attribute9                    varchar2(150),
  agf_attribute10                   varchar2(150),
  agf_attribute11                   varchar2(150),
  agf_attribute12                   varchar2(150),
  agf_attribute13                   varchar2(150),
  agf_attribute14                   varchar2(150),
  agf_attribute15                   varchar2(150),
  agf_attribute16                   varchar2(150),
  agf_attribute17                   varchar2(150),
  agf_attribute18                   varchar2(150),
  agf_attribute19                   varchar2(150),
  agf_attribute20                   varchar2(150),
  agf_attribute21                   varchar2(150),
  agf_attribute22                   varchar2(150),
  agf_attribute23                   varchar2(150),
  agf_attribute24                   varchar2(150),
  agf_attribute25                   varchar2(150),
  agf_attribute26                   varchar2(150),
  agf_attribute27                   varchar2(150),
  agf_attribute28                   varchar2(150),
  agf_attribute29                   varchar2(150),
  agf_attribute30                   varchar2(150),
