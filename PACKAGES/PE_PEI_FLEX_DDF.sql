--------------------------------------------------------
--  DDL for Package PE_PEI_FLEX_DDF
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PE_PEI_FLEX_DDF" AUTHID CURRENT_USER as
/* $Header: pepeiddf.pkh 115.0 99/07/18 14:14:09 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< ddf >--------------------------------------|
-- -----------------------------------------------------------------------------
