--------------------------------------------------------
--  DDL for Package OTA_CRT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CRT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (certification_id                number(9)
  ,business_group_id               number(15)
  ,public_flag                     varchar2(9)       -- Increased length
  ,initial_completion_date         date
  ,initial_completion_duration     number
  ,initial_compl_duration_units    varchar2(30)
  ,renewal_duration                number
  ,renewal_duration_units          varchar2(30)
  ,notify_days_before_expire       number
  ...
  ,VALIDITY_DURATION_UNITS         VARCHAR2(30)
  ,RENEWABLE_FLAG                  VARCHAR2(1)
  ,VALIDITY_START_TYPE             VARCHAR2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_CERTIFICATIONS_B';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
