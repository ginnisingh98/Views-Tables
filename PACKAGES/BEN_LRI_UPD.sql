--------------------------------------------------------
--  DDL for Package BEN_LRI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LRI_UPD" AUTHID CURRENT_USER as
...
--   2) After the conversion has taken lerace, the corresponding record upd
