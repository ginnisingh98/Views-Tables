--------------------------------------------------------
--  DDL for Package JTF_TASK_PHONES_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_TASK_PHONES_CUHK" AUTHID CURRENT_USER AS
/* $Header: jtfctkps.pls 115.6 2002/12/05 23:30:31 sachoudh ship $ */
