--------------------------------------------------------
--  DDL for Package PY_ZA_TX_01082000
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PY_ZA_TX_01082000" AUTHID CURRENT_USER AS
/* $Header: pyzat003.pkh 120.2 2005/06/28 00:11:09 kapalani noship $ */
/* Copyright (c) Oracle Corporation 2000. All rights reserved. */
/*
   PRODUCT
      Oracle Payroll - ZA Localisation Tax Module
   NAME
      PY_ZA_TX_01082000.pkh
  ...
  PUBLIC FUNCTIONS
   ...
   ---------   ----------------  -------  --------------------------------
   J.N. Louw   27/09/2001        115.3    Added bal_ANN_PF_CYTD
                                          Added trc_NegPtd Global
   J.N. Louw   24/08/2001        115.2    Bug: 1887835
                                          New Annual Classifications
   J.N. Louw   08/06/2001        115.1    Bug 1820687
   J.N. Louw   13/12/2000        110.2    Upped Header Ver for Patch
   J.N. Louw   06/12/2000        110.1    ZaTxDbi_01082000 def cleaned
...
-- Balances
-------------------------------------------------------------------------------
   bal_ANN_ARR_PF_CMTD            NUMBER(15,2);
   bal_ANN_ARR_PF_CYTD            NUMBER(15,2);
   bal_ANN_ARR_PF_RUN             NUMBER(15,2);
   bal_ANN_ARR_PF_PTD             NUMBER(15,2);
   bal_ANN_ARR_PF_YTD             NUMBER(15,2);
   bal_ANN_ARR_RA_CMTD            NUMBER(15,2);
   bal_ANN_ARR_RA_CYTD            NUMBER(15,2);
   bal_ANN_ARR_RA_RUN             NUMBER(15,2);
   bal_ANN_ARR_RA_PTD             NUMBER(15,2);
   bal_ANN_ARR_RA_YTD             NUMBER(15,2);
   bal_AA_PRCHD_RVAL_NRFI_CMTD    NUMBER(15,2);
   bal_AA_PRCHD_RVAL_NRFI_RUN     NUMBER(15,2);
   bal_AA_PRCHD_RVAL_NRFI_PTD     NUMBER(15,2);
   bal_AA_PRCHD_RVAL_NRFI_YTD     NUMBER(15,2);
   bal_AA_PRCHD_RVAL_RFI_CMTD     NUMBER(15,2);
   bal_AA_PRCHD_RVAL_RFI_RUN      NUMBER(15,2);
   bal_AA_PRCHD_RVAL_RFI_PTD      NUMBER(15,2);
   bal_AA_PRCHD_RVAL_RFI_YTD      NUMBER(15,2);
   ...
   bal_AC_NRFI_CMTD               NUMBER(15,2);
   bal_AC_NRFI_RUN                NUMBER(15,2);
   bal_AC_NRFI_PTD                NUMBER(15,2);
   bal_AC_NRFI_YTD                NUMBER(15,2);
   bal_AC_RFI_CMTD                NUMBER(15,2);
   bal_AC_RFI_RUN                 NUMBER(15,2);
   bal_AC_RFI_PTD                 NUMBER(15,2);
   bal_AC_RFI_YTD                 NUMBER(15,2);
   bal_ANN_PF_CMTD                NUMBER(15,2);
   bal_ANN_PF_CYTD                NUMBER(15,2);
   bal_ANN_PF_RUN                 NUMBER(15,2);
   bal_ANN_PF_PTD                 NUMBER(15,2);
   bal_ANN_PF_YTD                 NUMBER(15,2);
   bal_ARES_TRD_NRFI_CMTD         NUMBER(15,2);
   bal_ARES_TRD_NRFI_RUN          NUMBER(15,2);
   bal_ARES_TRD_NRFI_PTD          NUMBER(15,2);
   bal_ARES_TRD_NRFI_YTD          NUMBER(15,2);
   bal_ARES_TRD_RFI_CMTD          NUMBER(15,2);
   bal_ARES_TRD_RFI_RUN           NUMBER(15,2);
   bal_ARES_TRD_RFI_PTD           NUMBER(15,2);
   bal_ARES_TRD_RFI_YTD           NUMBER(15,2);
   bal_ANN_RA_CMTD                NUMBER(15,2);
   bal_ANN_RA_CYTD                NUMBER(15,2);
   bal_ANN_RA_RUN                 NUMBER(15,2);
   bal_ANN_RA_PTD                 NUMBER(15,2);
   bal_ANN_RA_YTD                 NUMBER(15,2);
   ...
   bal_PF_CMTD                    NUMBER(15,2);
   bal_PF_CYTD                    NUMBER(15,2);
   bal_PF_RUN                     NUMBER(15,2);
   bal_PF_PTD                     NUMBER(15,2);
   bal_PF_YTD                     NUMBER(15,2);
   bal_RA_CMTD                    NUMBER(15,2);
   bal_RA_CYTD                    NUMBER(15,2);
   bal_RA_RUN                     NUMBER(15,2);
   bal_RA_PTD                     NUMBER(15,2);
   bal_RA_YTD                     NUMBER(15,2);
   ...
   bal_RES_TRD_NRFI_CMTD          NUMBER(15,2);
   bal_RES_TRD_NRFI_CYTD          NUMBER(15,2);
   bal_RES_TRD_NRFI_RUN           NUMBER(15,2);
   bal_RES_TRD_NRFI_PTD           NUMBER(15,2);
   bal_RES_TRD_NRFI_YTD           NUMBER(15,2);
   bal_RES_TRD_RFI_CMTD           NUMBER(15,2);
   bal_RES_TRD_RFI_CYTD           NUMBER(15,2);
   bal_RES_TRD_RFI_RUN            NUMBER(15,2);
   bal_RES_TRD_RFI_PTD            NUMBER(15,2);
   bal_RES_TRD_RFI_YTD            NUMBER(15,2);
...
--
  ...
  trc_PerArrPenFnd    NUMBER(15,2) DEFAULT 0;
  trc_PerArrPenFndAbm NUMBER(15,2) DEFAULT 0;
  -- Annual Arrear Pension
  trc_AnnArrPenFnd    NUMBER(15,2) DEFAULT 0;
  trc_AnnArrPenFndAbm NUMBER(15,2) DEFAULT 0;
  -- Arrear Excess Update Value
  trc_PfUpdFig        NUMBER(15,2) DEFAULT 0;
  -- Period Retirement Annuity
  trc_PerRetAnu       NUMBER(15,2) DEFAULT 0;
  trc_PerNrfiCon      NUMBER(15,2) DEFAULT 0;
  trc_PerRetAnuMax    NUMBER(15,2) DEFAULT 0;
  trc_PerRetAnuAbm    NUMBER(15,2) DEFAULT 0;
  -- Annual Retirement Annuity
  trc_AnnRetAnu       NUMBER(15,2) DEFAULT 0;
  trc_AnnNrfiCon      NUMBER(15,2) DEFAULT 0;
  trc_AnnRetAnuMax    NUMBER(15,2) DEFAULT 0;
  trc_AnnRetAnuAbm    NUMBER(15,2) DEFAULT 0;
  -- Period Arrear Retirement Annuity
  trc_PerArrRetAnu    NUMBER(15,2) DEFAULT 0;
  trc_PerArrRetAnuAbm NUMBER(15,2) DEFAULT 0;
  -- Annual Arrear Retirement Annuity
  trc_AnnArrRetAnu    NUMBER(15,2) DEFAULT 0;
  trc_AnnArrRetAnuAbm NUMBER(15,2) DEFAULT 0;
  -- Arrear Excess Update Value
