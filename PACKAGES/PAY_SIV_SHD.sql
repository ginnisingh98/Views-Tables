--------------------------------------------------------
--  DDL for Package PAY_SIV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_SIV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  default_value_column              varchar2(30),
  exclusion_rule_id                 number(9),
  formula_id                        number(9),
  input_validation_formula	    varchar2(80),
