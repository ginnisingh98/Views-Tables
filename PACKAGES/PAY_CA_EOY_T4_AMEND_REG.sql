--------------------------------------------------------
--  DDL for Package PAY_CA_EOY_T4_AMEND_REG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CA_EOY_T4_AMEND_REG" AUTHID CURRENT_USER AS
/* $Header: pycat4cr.pkh 120.0.12000000.1 2007/01/17 17:29:38 appldev noship $ */
/*
   ******************************************************************
   *                                                                *
   ...
   ******************************************************************
   ...
   20-OCT-2003  SSattini    115.1            Added p_report_type parameter
                                             to get_payroll_action_info procedure.
*/
