--------------------------------------------------------
--  DDL for Package BEN_CQB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CQB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  cbr_quald_bnf_id                  number(15),
  quald_bnf_flag                    varchar2(30),
  cbr_elig_perd_strt_dt             date,
  cbr_elig_perd_end_dt              date,
  quald_bnf_person_id               number(15),
  pgm_id                            number(15),
  ptip_id                           number(15),
  pl_typ_id                         number(15),
  cvrd_emp_person_id                number(15),
  cbr_inelg_rsn_cd                  varchar2(30),
  business_group_id                 number(15),
  cqb_attribute_category            varchar2(30),
  cqb_attribute1                    varchar2(150),
  cqb_attribute2                    varchar2(150),
  cqb_attribute3                    varchar2(150),
  cqb_attribute4                    varchar2(150),
  cqb_attribute5                    varchar2(150),
  cqb_attribute6                    varchar2(150),
  cqb_attribute7                    varchar2(150),
  cqb_attribute8                    varchar2(150),
  cqb_attribute9                    varchar2(150),
  cqb_attribute10                   varchar2(150),
  cqb_attribute11                   varchar2(150),
  cqb_attribute12                   varchar2(150),
  cqb_attribute13                   varchar2(150),
  cqb_attribute14                   varchar2(150),
  cqb_attribute15                   varchar2(150),
  cqb_attribute16                   varchar2(150),
  cqb_attribute17                   varchar2(150),
  cqb_attribute18                   varchar2(150),
  cqb_attribute19                   varchar2(150),
  cqb_attribute20                   varchar2(150),
  cqb_attribute21                   varchar2(150),
  cqb_attribute22                   varchar2(150),
  cqb_attribute23                   varchar2(150),
  cqb_attribute24                   varchar2(150),
  cqb_attribute25                   varchar2(150),
  cqb_attribute26                   varchar2(150),
  cqb_attribute27                   varchar2(150),
  cqb_attribute28                   varchar2(150),
  cqb_attribute29                   varchar2(150),
  cqb_attribute30                   varchar2(150),
