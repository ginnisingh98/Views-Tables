--------------------------------------------------------
--  DDL for Package FA_MAINT_PURGE_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_MAINT_PURGE_PKG" AUTHID CURRENT_USER as
/* $Header: FAXMTPRS.pls 120.1.12010000.2 2009/07/19 11:08:06 glchen ship $ */
...
procedure do_purge(
		...
		argument3         in  varchar2,   -- to asset number
	  	...
	  	argument6         in  varchar2,   -- category id
