--------------------------------------------------------
--  DDL for Package BEN_EHC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EHC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ELIG_HLTH_CVG_PRTE_id             number(15),
  ...
  ehc_attribute_category            varchar2(30),
  ehc_attribute1                    varchar2(150),
  ehc_attribute2                    varchar2(150),
  ehc_attribute3                    varchar2(150),
  ehc_attribute4                    varchar2(150),
  ehc_attribute5                    varchar2(150),
  ehc_attribute6                    varchar2(150),
  ehc_attribute7                    varchar2(150),
  ehc_attribute8                    varchar2(150),
  ehc_attribute9                    varchar2(150),
  ehc_attribute10                   varchar2(150),
  ehc_attribute11                   varchar2(150),
  ehc_attribute12                   varchar2(150),
  ehc_attribute13                   varchar2(150),
  ehc_attribute14                   varchar2(150),
  ehc_attribute15                   varchar2(150),
  ehc_attribute16                   varchar2(150),
  ehc_attribute17                   varchar2(150),
  ehc_attribute18                   varchar2(150),
  ehc_attribute19                   varchar2(150),
  ehc_attribute20                   varchar2(150),
  ehc_attribute21                   varchar2(150),
  ehc_attribute22                   varchar2(150),
  ehc_attribute23                   varchar2(150),
  ehc_attribute24                   varchar2(150),
  ehc_attribute25                   varchar2(150),
  ehc_attribute26                   varchar2(150),
  ehc_attribute27                   varchar2(150),
  ehc_attribute28                   varchar2(150),
  ehc_attribute29                   varchar2(150),
  ehc_attribute30                   varchar2(150),
...
--           p_base_key_value = :ELIG_HLTH_CVG_PRTE_id).
--
-- Post Success:
--   Processing continues.
--
...
--   The processing stehc are as follows:
