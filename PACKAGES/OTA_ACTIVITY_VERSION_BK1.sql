--------------------------------------------------------
--  DDL for Package OTA_ACTIVITY_VERSION_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_ACTIVITY_VERSION_BK1" AUTHID CURRENT_USER as
/* $Header: ottavapi.pkh 120.4.12010000.2 2009/08/11 13:01:11 smahanka ship $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------< create_activity_version_b >-------------------------|
-- ----------------------------------------------------------------------------
procedure create_activity_version_b
...
--
-- ----------------------------------------------------------------------------
-- |-----------------< create_activity_version_a >---------------------------|
-- ----------------------------------------------------------------------------
--
procedure create_activity_version_a
  (p_effective_date               in date,
  p_activity_id                  in number,
  p_superseded_by_act_version_id in number,
  p_object_version_number         in     number,
