--------------------------------------------------------
--  DDL for Package AMS_ACT_MARKET_SEGMENTS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_ACT_MARKET_SEGMENTS_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswmkss.pls 120.1 2005/06/16 06:13 appldev  $ */
