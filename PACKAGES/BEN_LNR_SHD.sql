--------------------------------------------------------
--  DDL for Package BEN_LNR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LNR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_chg_pl_nip_rl_id              number(15),
  ...
  lnr_attribute_category            varchar2(30),
  lnr_attribute1                    varchar2(150),
  lnr_attribute2                    varchar2(150),
  lnr_attribute3                    varchar2(150),
  lnr_attribute4                    varchar2(150),
  lnr_attribute5                    varchar2(150),
  lnr_attribute6                    varchar2(150),
  lnr_attribute7                    varchar2(150),
  lnr_attribute8                    varchar2(150),
  lnr_attribute9                    varchar2(150),
  lnr_attribute10                   varchar2(150),
  lnr_attribute11                   varchar2(150),
  lnr_attribute12                   varchar2(150),
  lnr_attribute13                   varchar2(150),
  lnr_attribute14                   varchar2(150),
  lnr_attribute15                   varchar2(150),
  lnr_attribute16                   varchar2(150),
  lnr_attribute17                   varchar2(150),
  lnr_attribute18                   varchar2(150),
  lnr_attribute19                   varchar2(150),
  lnr_attribute20                   varchar2(150),
  lnr_attribute21                   varchar2(150),
  lnr_attribute22                   varchar2(150),
  lnr_attribute23                   varchar2(150),
  lnr_attribute24                   varchar2(150),
  lnr_attribute25                   varchar2(150),
  lnr_attribute26                   varchar2(150),
  lnr_attribute27                   varchar2(150),
  lnr_attribute28                   varchar2(150),
  lnr_attribute29                   varchar2(150),
  lnr_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_chg_pl_nip_rl_id).
--
-- Post Success:
--   Processing continues.
--
