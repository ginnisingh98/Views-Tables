--------------------------------------------------------
--  DDL for Package HR_DTY_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_DTY_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,system_document_type            varchar2(40)
  ,category_code                   varchar2(30)
  ,sub_category_code               varchar2(30)
  ,active_inactive_flag            varchar2(30)
  ,multiple_occurences_flag        varchar2(30)
  ,legislation_code                varchar2(30)
  ,authorization_required          varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_DOCUMENT_TYPES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
