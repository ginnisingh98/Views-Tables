--------------------------------------------------------
--  DDL for Package HR_SE_ASSIGNMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_SE_ASSIGNMENT_API" AUTHID CURRENT_USER AS
/* $Header: peasgsei.pkh 120.2 2005/12/08 00:49:17 rravi noship $ */
/*#
 * This package contains assignment APIs for Sweden.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Assignment for Sweden
*/
--
-- ----------------------------------------------------------------------------
 ...
 *
 * The API is effectively an alternative to the API create_secondary_emp_asg.
 ...
 * @param p_ssyk_skills_code SSYK skill code.
 * @param p_work_title Work title.
 * @param p_notification_date Date of Notification.
 * @param p_asg_termination_date Date of assignment Termination.
 * @param p_termination_reason Reasons for Termination.
 ...
 * 'Y' for yes.
 * @rep:displayname Create Secondary Employee Assignment for Sweden
 ...
 * to element entries.
 *
 * The API is effectively an alternative to the API update_emp_asg. If
 ...
 * @param p_notification_date Date of notification.
 * @param p_asg_termination_date Date of assignment termination.
 * @param p_termination_reason Reason for termination.
 ...
 * organization prior to calling this API and the manager flag has been set to
 * 'Y' for yes.
 * @rep:displayname Update Employee Assignment for Sweden
 * @rep:category BUSINESS_ENTITY PER_EMPLOYEE_ASG
 * @rep:lifecycle active
 * @rep:scope public
 * @rep:ihelp PER/@scalapi APIs in Oracle HRMS
