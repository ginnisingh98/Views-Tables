--------------------------------------------------------
--  DDL for Package ZX_AR_POPULATE_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ZX_AR_POPULATE_PKG" AUTHID CURRENT_USER AS
/* $Header: zxrirpopulatpvts.pls 120.4 2006/06/01 01:25:16 skorrapa ship $ */
...
TYPE cust_bill_ar_rec IS RECORD(
     ...
     BILL_TO_PARTY_ID           zx_rep_trx_detail_t.BILL_TO_PARTY_ID%TYPE,
     BILL_TO_PARTY_SITE_ID           zx_rep_trx_detail_t.BILL_TO_PARTY_SITE_ID%TYPE
    );
...
TYPE cust_ship_ar_rec IS RECORD(
     ...
     SHIP_TO_PARTY_ID            zx_rep_trx_detail_t.SHIP_TO_PARTY_ID%TYPE,
     SHIP_TO_PARTY_SITE_ID       zx_rep_trx_detail_t.SHIP_TO_PARTY_SITE_ID%TYPE
     );
