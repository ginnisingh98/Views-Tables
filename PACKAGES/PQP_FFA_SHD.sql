--------------------------------------------------------
--  DDL for Package PQP_FFA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_FFA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (flxdu_func_attribute_id         number(15)
  ,flxdu_func_name                 varchar2(30)
  ,flxdu_func_source_type          varchar2(30)
  ,flxdu_func_integrator_code      varchar2(30)
  ,flxdu_func_xml_data             varchar2(4000)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQP_FLXDU_FUNC_ATTRIBUTES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
