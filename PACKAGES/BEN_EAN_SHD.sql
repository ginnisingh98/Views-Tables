--------------------------------------------------------
--  DDL for Package BEN_EAN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EAN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_asnt_set_prte_id             number(15),
  ...
  ean_attribute_category            varchar2(30),
  ean_attribute1                    varchar2(150),
  ean_attribute2                    varchar2(150),
  ean_attribute3                    varchar2(150),
  ean_attribute4                    varchar2(150),
  ean_attribute5                    varchar2(150),
  ean_attribute6                    varchar2(150),
  ean_attribute7                    varchar2(150),
  ean_attribute8                    varchar2(150),
  ean_attribute9                    varchar2(150),
  ean_attribute10                   varchar2(150),
  ean_attribute11                   varchar2(150),
  ean_attribute12                   varchar2(150),
  ean_attribute13                   varchar2(150),
  ean_attribute14                   varchar2(150),
  ean_attribute15                   varchar2(150),
  ean_attribute16                   varchar2(150),
  ean_attribute17                   varchar2(150),
  ean_attribute18                   varchar2(150),
  ean_attribute19                   varchar2(150),
  ean_attribute20                   varchar2(150),
  ean_attribute21                   varchar2(150),
  ean_attribute22                   varchar2(150),
  ean_attribute23                   varchar2(150),
  ean_attribute24                   varchar2(150),
  ean_attribute25                   varchar2(150),
  ean_attribute26                   varchar2(150),
  ean_attribute27                   varchar2(150),
  ean_attribute28                   varchar2(150),
  ean_attribute29                   varchar2(150),
  ean_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_asnt_set_prte_id).
--
-- Post Success:
--   Processing continues.
--
