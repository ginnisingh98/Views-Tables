--------------------------------------------------------
--  DDL for Package PQH_RST_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RST_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  rule_set_id                       number(15),
  rule_set_name                     varchar2(100),
  organization_structure_id         number(15),
  organization_id                   number(15),
  referenced_rule_set_id            number(15),
  rule_level_cd                     varchar2(30),
