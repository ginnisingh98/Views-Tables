--------------------------------------------------------
--  DDL for Package BEN_PTR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PTR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ptr_attribute_category            varchar2(30),
  ptr_attribute1                    varchar2(150),
  ptr_attribute2                    varchar2(150),
  ptr_attribute3                    varchar2(150),
  ptr_attribute4                    varchar2(150),
  ptr_attribute5                    varchar2(150),
  ptr_attribute6                    varchar2(150),
  ptr_attribute7                    varchar2(150),
  ptr_attribute8                    varchar2(150),
  ptr_attribute9                    varchar2(150),
  ptr_attribute10                   varchar2(150),
  ptr_attribute11                   varchar2(150),
  ptr_attribute12                   varchar2(150),
  ptr_attribute13                   varchar2(150),
  ptr_attribute14                   varchar2(150),
  ptr_attribute15                   varchar2(150),
  ptr_attribute16                   varchar2(150),
  ptr_attribute17                   varchar2(150),
  ptr_attribute18                   varchar2(150),
  ptr_attribute19                   varchar2(150),
  ptr_attribute20                   varchar2(150),
  ptr_attribute21                   varchar2(150),
  ptr_attribute22                   varchar2(150),
  ptr_attribute23                   varchar2(150),
  ptr_attribute24                   varchar2(150),
  ptr_attribute25                   varchar2(150),
  ptr_attribute26                   varchar2(150),
  ptr_attribute27                   varchar2(150),
  ptr_attribute28                   varchar2(150),
  ptr_attribute29                   varchar2(150),
  ptr_attribute30                   varchar2(150),
...
--           p_base_key_value = :per_typ_rt_id).
--
-- Post Success:
--   Processing continues.
--
