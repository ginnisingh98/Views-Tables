--------------------------------------------------------
--  DDL for Package RFD_CONTROLLER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."RFD_CONTROLLER" AUTHID CURRENT_USER AS
/* $Header: ENGCRFDS.pls 115.5 2004/02/12 22:57:23 sshrikha ship $ */
...
TYPE Controller_RFD_Rec_Type IS RECORD
...
,   Reference_Designator_Name       VARCHAR2(700) := NULL
,   Acd_Type                      NUMBER         := NULL
,   Ref_Designator_Comment	  VARCHAR2(240)  := NULL
