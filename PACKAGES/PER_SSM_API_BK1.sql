--------------------------------------------------------
--  DDL for Package PER_SSM_API_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SSM_API_BK1" AUTHID CURRENT_USER as
