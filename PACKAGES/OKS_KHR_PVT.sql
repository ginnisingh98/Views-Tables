--------------------------------------------------------
--  DDL for Package OKS_KHR_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKS_KHR_PVT" AUTHID CURRENT_USER AS
/* $Header: OKSSKHRS.pls 120.4.12010000.2 2008/11/07 10:12:24 serukull ship $ */
  ---------------------------------------------------------------------------
  -- GLOBAL DATASTRUCTURES
  ---------------------------------------------------------------------------
  -- OKS_K_HEADERS_V Record Spec
    ...
    TYPE khrv_tbl_type IS TABLE OF khrv_rec_type
    INDEX BY BINARY_INTEGER;
  -- OKS_K_HEADERS_B Record Spec
    TYPE khr_rec_type IS RECORD (
                                 id NUMBER := OKC_API.G_MISS_NUM
                                 , chr_id NUMBER := OKC_API.G_MISS_NUM
                                 , acct_rule_id NUMBER := OKC_API.G_MISS_NUM
                                 , payment_type OKS_K_HEADERS_B.PAYMENT_TYPE%TYPE := OKC_API.G_MISS_CHAR
                                 , cc_no OKS_K_HEADERS_B.CC_NO%TYPE := OKC_API.G_MISS_CHAR
                                 , cc_expiry_date OKS_K_HEADERS_B.CC_EXPIRY_DATE%TYPE := OKC_API.G_MISS_DATE
                                 , cc_bank_acct_id NUMBER := OKC_API.G_MISS_NUM
                                 , cc_auth_code OKS_K_HEADERS_B.CC_AUTH_CODE%TYPE := OKC_API.G_MISS_CHAR
                                 , commitment_id NUMBER := OKC_API.G_MISS_NUM
                                 , grace_duration NUMBER := OKC_API.G_MISS_NUM
                                 , grace_period OKS_K_HEADERS_B.GRACE_PERIOD%TYPE := OKC_API.G_MISS_CHAR
                                 , est_rev_percent NUMBER := OKC_API.G_MISS_NUM
                                 , est_rev_date OKS_K_HEADERS_B.EST_REV_DATE%TYPE := OKC_API.G_MISS_DATE
                                 , tax_amount NUMBER := OKC_API.G_MISS_NUM
                                 , tax_status OKS_K_HEADERS_B.TAX_STATUS%TYPE := OKC_API.G_MISS_CHAR
                                 , tax_code NUMBER := OKC_API.G_MISS_NUM
                                 , tax_exemption_id NUMBER := OKC_API.G_MISS_NUM
                                 , billing_profile_id NUMBER := OKC_API.G_MISS_NUM
                                 , renewal_status OKS_K_HEADERS_B.RENEWAL_STATUS%TYPE := OKC_API.G_MISS_CHAR
                                 , electronic_renewal_flag OKS_K_HEADERS_B.ELECTRONIC_RENEWAL_FLAG%TYPE := OKC_API.G_MISS_CHAR
                                 , quote_to_contact_id NUMBER := OKC_API.G_MISS_NUM
                                 , quote_to_site_id NUMBER := OKC_API.G_MISS_NUM
                                 , quote_to_email_id NUMBER := OKC_API.G_MISS_NUM
                                 , quote_to_phone_id NUMBER := OKC_API.G_MISS_NUM
                                 , quote_to_fax_id NUMBER := OKC_API.G_MISS_NUM
                                 , renewal_po_required OKS_K_HEADERS_B.RENEWAL_PO_REQUIRED%TYPE := OKC_API.G_MISS_CHAR
                                 , renewal_po_number OKS_K_HEADERS_B.RENEWAL_PO_NUMBER%TYPE := OKC_API.G_MISS_CHAR
                                 , renewal_price_list NUMBER := OKC_API.G_MISS_NUM
                                 , renewal_pricing_type OKS_K_HEADERS_B.RENEWAL_PRICING_TYPE%TYPE := OKC_API.G_MISS_CHAR
                                 , renewal_markup_percent NUMBER := OKC_API.G_MISS_NUM
                                 , renewal_grace_duration NUMBER := OKC_API.G_MISS_NUM
                                 , renewal_grace_period OKS_K_HEADERS_B.RENEWAL_GRACE_PERIOD%TYPE := OKC_API.G_MISS_CHAR
                                 , renewal_est_rev_percent NUMBER := OKC_API.G_MISS_NUM
                                 , renewal_est_rev_duration NUMBER := OKC_API.G_MISS_NUM
                                 , renewal_est_rev_period OKS_K_HEADERS_B.RENEWAL_EST_REV_PERIOD%TYPE := OKC_API.G_MISS_CHAR
                                 , renewal_price_list_used NUMBER := OKC_API.G_MISS_NUM
                                 , renewal_type_used OKS_K_HEADERS_B.RENEWAL_TYPE_USED%TYPE := OKC_API.G_MISS_CHAR
                                 , renewal_notification_to NUMBER := OKC_API.G_MISS_NUM
                                 , renewal_po_used OKS_K_HEADERS_B.RENEWAL_PO_USED%TYPE := OKC_API.G_MISS_CHAR
                                 , renewal_pricing_type_used OKS_K_HEADERS_B.RENEWAL_PRICING_TYPE_USED%TYPE := OKC_API.G_MISS_CHAR
                                 , renewal_markup_percent_used NUMBER := OKC_API.G_MISS_NUM
                                 , rev_est_percent_used NUMBER := OKC_API.G_MISS_NUM
                                 , rev_est_duration_used NUMBER := OKC_API.G_MISS_NUM
                                 , rev_est_period_used OKS_K_HEADERS_B.REV_EST_PERIOD_USED%TYPE := OKC_API.G_MISS_CHAR
                                 , billing_profile_used NUMBER := OKC_API.G_MISS_NUM
                                 , evn_threshold_amt NUMBER := OKC_API.G_MISS_NUM
                                 , evn_threshold_cur OKS_K_HEADERS_B.EVN_THRESHOLD_CUR%TYPE := OKC_API.G_MISS_CHAR
                                 , ern_threshold_amt NUMBER := OKC_API.G_MISS_NUM
                                 , ern_threshold_cur OKS_K_HEADERS_B.ERN_THRESHOLD_CUR%TYPE := OKC_API.G_MISS_CHAR
                                 , renewal_grace_duration_used NUMBER := OKC_API.G_MISS_NUM
                                 , renewal_grace_period_used OKS_K_HEADERS_B.RENEWAL_GRACE_PERIOD_USED%TYPE := OKC_API.G_MISS_CHAR
                                 , inv_trx_type OKS_K_HEADERS_B.INV_TRX_TYPE%TYPE := OKC_API.G_MISS_CHAR
                                 , inv_print_profile OKS_K_HEADERS_B.INV_PRINT_PROFILE%TYPE := OKC_API.G_MISS_CHAR
                                 , ar_interface_yn OKS_K_HEADERS_B.AR_INTERFACE_YN%TYPE := OKC_API.G_MISS_CHAR
                                 , hold_billing OKS_K_HEADERS_B.HOLD_BILLING%TYPE := OKC_API.G_MISS_CHAR
                                 , summary_trx_yn OKS_K_HEADERS_B.SUMMARY_TRX_YN%TYPE := OKC_API.G_MISS_CHAR
                                 , service_po_number OKS_K_HEADERS_B.SERVICE_PO_NUMBER%TYPE := OKC_API.G_MISS_CHAR
                                 , service_po_required OKS_K_HEADERS_B.SERVICE_PO_REQUIRED%TYPE := OKC_API.G_MISS_CHAR
                                 , billing_schedule_type OKS_K_HEADERS_B.BILLING_SCHEDULE_TYPE%TYPE := OKC_API.G_MISS_CHAR
                                 , object_version_number NUMBER := OKC_API.G_MISS_NUM
                                 , request_id NUMBER := OKC_API.G_MISS_NUM
                                 , created_by NUMBER := OKC_API.G_MISS_NUM
                                 , creation_date OKS_K_HEADERS_B.CREATION_DATE%TYPE := OKC_API.G_MISS_DATE
                                 , last_updated_by NUMBER := OKC_API.G_MISS_NUM
                                 , last_update_date OKS_K_HEADERS_B.LAST_UPDATE_DATE%TYPE := OKC_API.G_MISS_DATE
                                 , last_update_login NUMBER := OKC_API.G_MISS_NUM
                                 , ern_flag_used_yn OKS_K_HEADERS_B.ERN_FLAG_USED_YN%TYPE := OKC_API.G_MISS_CHAR
                                 , follow_up_action OKS_K_HEADERS_B.FOLLOW_UP_ACTION%TYPE := OKC_API.G_MISS_CHAR
                                 , follow_up_date OKS_K_HEADERS_B.FOLLOW_UP_DATE%TYPE := OKC_API.G_MISS_DATE
                                 , trxn_extension_id NUMBER := OKC_API.G_MISS_NUM
                                 , date_accepted OKS_K_HEADERS_B.DATE_ACCEPTED%TYPE := OKC_API.G_MISS_DATE
                                 , accepted_by NUMBER := OKC_API.G_MISS_NUM
                                 , rmndr_suppress_flag OKS_K_HEADERS_B.RMNDR_SUPPRESS_FLAG%TYPE := OKC_API.G_MISS_CHAR
                                 , rmndr_sent_flag OKS_K_HEADERS_B.RMNDR_SENT_FLAG%TYPE := OKC_API.G_MISS_CHAR
                                 , quote_sent_flag OKS_K_HEADERS_B.QUOTE_SENT_FLAG%TYPE := OKC_API.G_MISS_CHAR
                                 , process_request_id NUMBER := OKC_API.G_MISS_NUM
                                 , wf_item_key OKS_K_HEADERS_B.WF_ITEM_KEY%TYPE := OKC_API.G_MISS_CHAR
                                 , period_start OKS_K_HEADERS_B.PERIOD_START%TYPE := OKC_API.G_MISS_CHAR
                                 , period_type OKS_K_HEADERS_B.PERIOD_TYPE%TYPE := OKC_API.G_MISS_CHAR
                                 , price_uom OKS_K_HEADERS_B.PRICE_UOM%TYPE := OKC_API.G_MISS_CHAR
                                 , person_party_id NUMBER := OKC_API.G_MISS_NUM
                                 , tax_classification_code OKS_K_HEADERS_B.TAX_CLASSIFICATION_CODE%TYPE := OKC_API.G_MISS_CHAR
                                 , exempt_certificate_number OKS_K_HEADERS_B.EXEMPT_CERTIFICATE_NUMBER%TYPE := OKC_API.G_MISS_CHAR
                                 , exempt_reason_code OKS_K_HEADERS_B.EXEMPT_REASON_CODE%TYPE := OKC_API.G_MISS_CHAR
                                 , approval_type_used OKS_K_HEADERS_B.APPROVAL_TYPE_USED%TYPE := OKC_API.G_MISS_CHAR
				 , renewal_comment OKS_K_HEADERS_B.renewal_comment%TYPE := OKC_API.G_MISS_CHAR);
    G_MISS_khr_rec khr_rec_type;
    TYPE khr_tbl_type IS TABLE OF khr_rec_type
    INDEX BY BINARY_INTEGER;
  ---------------------------------------------------------------------------
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
    G_PKG_NAME CONSTANT VARCHAR2(200) := 'OKS_KHR_PVT';
