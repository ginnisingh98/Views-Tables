--------------------------------------------------------
--  DDL for Package PER_PGN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PGN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,entity_id                       varchar2(250)
  ,hierarchy_version_id            number(15)
