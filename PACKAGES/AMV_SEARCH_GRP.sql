--------------------------------------------------------
--  DDL for Package AMV_SEARCH_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMV_SEARCH_GRP" AUTHID CURRENT_USER AS
/* $Header: amvgsers.pls 120.1 2005/06/22 16:31:23 appldev ship $ */
--
-- NAME
--   AMV_SEARCH_GRP
-- PURPOSE
...
--                    Example:
--
--                      col_name||two single quote ||operator||two single quote ||string_value
--
