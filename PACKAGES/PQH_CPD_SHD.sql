--------------------------------------------------------
--  DDL for Package PQH_CPD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CPD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,retirement_age                  number(10)
  ,category_cd                     varchar2(30)
  ,recruitment_end_date            date
  ,corps_type_cd                   varchar2(30)
  ,starting_grade_step_id          number(15)
  ,task_desc                       varchar2(2000)
  ,secondment_threshold            number(9)         -- Increased length
  ,normal_hours                    number(15,3)
  ,normal_hours_frequency          varchar2(30)
  ,minimum_hours                   number(15,3)
  ,minimum_hours_frequency         varchar2(30)
  ...
  ,date_from                       date
  ,date_to                         date
  ,primary_prof_field_id           number(15)
  ,starting_grade_id               number(15)
  ,ben_pgm_id                      number(15)
  ,probation_period                number(15,3)
  ,probation_units                 varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_CORPS_DEFINITIONS';
