--------------------------------------------------------
--  DDL for Package PER_ZA_QUA_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_QUA_DEL" AUTHID CURRENT_USER as
/* $Header: pezaqude.pkh 115.0 2001/02/04 22:34:51 pkm ship        $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< del >----------------------------------|
-- ----------------------------------------------------------------------------
