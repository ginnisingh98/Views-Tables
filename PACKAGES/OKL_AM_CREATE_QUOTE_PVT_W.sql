--------------------------------------------------------
--  DDL for Package OKL_AM_CREATE_QUOTE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_AM_CREATE_QUOTE_PVT_W" AUTHID CURRENT_USER as
  /* $Header: OKLECQTS.pls 120.4 2007/11/02 21:03:24 rmunjulu ship $ */
