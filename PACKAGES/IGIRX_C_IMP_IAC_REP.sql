--------------------------------------------------------
--  DDL for Package IGIRX_C_IMP_IAC_REP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGIRX_C_IMP_IAC_REP" AUTHID CURRENT_USER AS
--  $Header: igiimxcs.pls 120.3.12000000.1 2007/08/01 16:22:24 npandya noship $
