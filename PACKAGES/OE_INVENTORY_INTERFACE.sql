--------------------------------------------------------
--  DDL for Package OE_INVENTORY_INTERFACE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_INVENTORY_INTERFACE" AUTHID CURRENT_USER AS
/* $Header: WSHWFSTS.pls 115.0 99/08/19 17:55:08 porting ship  $ */
--
-- Package
--   OE_INVENTORY_INTERFACE
-- Purpose
--   Stub Package
-- History
--   30-Jun-99  Shashi Bhaskaran 	Created
--
