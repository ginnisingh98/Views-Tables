--------------------------------------------------------
--  DDL for Package BEN_RTS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_RTS_SHD" AUTHID CURRENT_USER as
/* $Header: bertsrhi.pkh 120.1 2006/01/09 14:36:43 maagrawa noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  ...
  ,rec_mx_val                      number
  ,rec_incr_val                    number
  ,ws_val_last_upd_date            date
  ,ws_val_last_upd_by              number(15)
  ,pay_proposal_id                 number(15)
  ,element_entry_value_id          number(15)
  ,inelig_rsn_cd                   varchar2(30)
  ,elig_ovrid_dt                   date
  ,elig_ovrid_person_id            number(15)
  ,copy_dist_bdgt_val              number
  ,copy_ws_bdgt_val                number
  ,copy_rsrv_val                   number
  ,copy_dist_bdgt_mn_val           number
  ,copy_dist_bdgt_mx_val           number
  ,copy_dist_bdgt_incr_val         number
  ,copy_ws_bdgt_mn_val             number
  ,copy_ws_bdgt_mx_val             number
  ,copy_ws_bdgt_incr_val           number
  ,copy_rsrv_mn_val                number
  ,copy_rsrv_mx_val                number
  ,copy_rsrv_incr_val              number
  ,copy_dist_bdgt_iss_val          number
  ,copy_ws_bdgt_iss_val            number
  ,copy_dist_bdgt_iss_date         date
  ,copy_ws_bdgt_iss_date           date
  ,comp_posting_date               date
  ,ws_rt_start_date                date
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_CWB_PERSON_RATES';
...
--   are based on group_per_in_ler_id, pl_id, and oipl_id combination.
--
-- Access Status:
--   Internal Development Use Only.
--
