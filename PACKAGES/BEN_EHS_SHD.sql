--------------------------------------------------------
--  DDL for Package BEN_EHS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EHS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_hrly_slrd_prte_id            number(15),
  ...
  ehs_attribute_category            varchar2(30),
  ehs_attribute1                    varchar2(150),
  ehs_attribute2                    varchar2(150),
  ehs_attribute3                    varchar2(150),
  ehs_attribute4                    varchar2(150),
  ehs_attribute5                    varchar2(150),
  ehs_attribute6                    varchar2(150),
  ehs_attribute7                    varchar2(150),
  ehs_attribute8                    varchar2(150),
  ehs_attribute9                    varchar2(150),
  ehs_attribute10                   varchar2(150),
  ehs_attribute11                   varchar2(150),
  ehs_attribute12                   varchar2(150),
  ehs_attribute13                   varchar2(150),
  ehs_attribute14                   varchar2(150),
  ehs_attribute15                   varchar2(150),
  ehs_attribute16                   varchar2(150),
  ehs_attribute17                   varchar2(150),
  ehs_attribute18                   varchar2(150),
  ehs_attribute19                   varchar2(150),
  ehs_attribute20                   varchar2(150),
  ehs_attribute21                   varchar2(150),
  ehs_attribute22                   varchar2(150),
  ehs_attribute23                   varchar2(150),
  ehs_attribute24                   varchar2(150),
  ehs_attribute25                   varchar2(150),
  ehs_attribute26                   varchar2(150),
  ehs_attribute27                   varchar2(150),
  ehs_attribute28                   varchar2(150),
  ehs_attribute29                   varchar2(150),
  ehs_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_hrly_slrd_prte_id).
--
-- Post Success:
--   Processing continues.
--
