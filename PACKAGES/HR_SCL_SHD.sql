--------------------------------------------------------
--  DDL for Package HR_SCL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_SCL_SHD" AUTHID CURRENT_USER as
...
--   soft coded combination segments. The returning
--   p_soft_coding_keyflex_id can have three states:
--
...
--
--   Depending on the p_soft_coding_keyflex_id state the following out
--   parameters are either set or null.
--
--   p_soft_coding_keyflex_id      out
--   state                      argument                 set
--   =====================      ========                 ===
--   -1                         p_id_flex_num             Y
--                              p_concatenated_segments   N
--
--   null                       p_id_flex_num             N
--                              p_concatenated_segments   N
--
--   id                         p_id_flex_num             Y
--                              p_concatenated_segments   Y
--
-- Pre Conditions:
--
-- In Parameters:
...
--
-- Post Success:
--   Depending on the p_soft_coding_keyflex_id state the corresponding out
...
Function api_updating
  (p_soft_coding_keyflex_id in number) Return Boolean;
--
-- ----------------------------------------------------------------------------
-- |-----------------------------< convert_args >-----------------------------|
-- ----------------------------------------------------------------------------
