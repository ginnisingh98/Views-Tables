--------------------------------------------------------
--  DDL for Package BEN_HWF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_HWF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_hrs_wkd_in_perd_fctr_id already exists.
--
--  In Arguments:
...
function return_legislation_code
  (p_hrs_wkd_in_perd_fctr_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
