--------------------------------------------------------
--  DDL for Package BEN_LVG_RSN_RT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LVG_RSN_RT_BK2" AUTHID CURRENT_USER as
