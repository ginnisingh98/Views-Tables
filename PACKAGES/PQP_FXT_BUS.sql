--------------------------------------------------------
--  DDL for Package PQP_FXT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_FXT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_flxdu_xml_tag_id
--     already exists.
--
--  In Arguments:
--    p_flxdu_xml_tag_id
