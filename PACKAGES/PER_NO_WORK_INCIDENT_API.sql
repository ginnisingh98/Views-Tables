--------------------------------------------------------
--  DDL for Package PER_NO_WORK_INCIDENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_NO_WORK_INCIDENT_API" AUTHID CURRENT_USER as
/* $Header: peincnoi.pkh 120.1 2005/10/02 02:42:15 aroussel $ */
/*#
 * This package contains work incidents APIs for Norway.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Work Incident for Norway.
*/
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_no_work_incident >----------------------|
-- ----------------------------------------------------------------------------
--
-- {Start Of Comments}
/*#
 * This API creates a work incident record for a person in Norway.
 *
 * This API is an alternative to the API create_work_incident. If p_validate is
 * set to false, an applicant is created.
 *
 * <p><b>Licensing</b><br>
 ...
 * The API does not create the work incident record and raises an error.
 *
 ...
 * @param p_privacy_issue Indicates whether the incident needs to be kept
 * private.
 ...
 * @param p_remedial_hs_action Description of corrective action that has been
 * recommended by the health and safety representative.
 ...
 * representative body.
 * @param p_related_incident_id The id of any work incident that is related to
 ...
 * @param p_date_rep_social_security Date reported to social security.
 * @param p_date_rep_labor_inspection Date reported to labor inspection
 ...
 * value will be null.
 * @rep:displayname Create Work Incident for Norway.
...
-- {End Of Comments}
--
procedure create_no_work_incident
  ...
  ,p_date_rep_social_security      in     varchar2 default null
  ,p_date_rep_labor_inspection     in     varchar2 default null
  ,p_incident_id                      out nocopy number
  ,p_object_version_number            out nocopy number
  );
--
-- ----------------------------------------------------------------------------
-- |-------------------------< update_no_work_incident >----------------------|
-- ----------------------------------------------------------------------------
--
-- {Start Of Comments}
/*#
 * This API updates a work incident record for a person in Norway.
 *
 ...
 * @param p_effective_date Determines when the DateTrack operation comes into
 * force.
 * @param p_incident_id Identifier of the incident record.
 ...
 * @param p_date_rep_social_security Date Reported to Social Security.
 * @param p_date_rep_labor_inspection Date Reported to Labor Inspection.
 * @rep:displayname Update Work Incident for Norway
 * @rep:category BUSINESS_ENTITY PER_WORK_INCIDENT
 * @rep:lifecycle active
 * @rep:scope public
 * @rep:ihelp PER/@scalapi APIs in Oracle HRMS
...
-- {End Of Comments}
--
procedure update_no_work_incident
  (p_validate                      in     boolean  default false
  ,p_effective_date                in     date
  ...
  ,p_date_rep_social_security      in     varchar2 default hr_api.g_varchar2
  ,p_date_rep_labor_inspection     in     varchar2 default hr_api.g_varchar2
  );

end per_no_work_incident_api;
