--------------------------------------------------------
--  DDL for Package GHR_CDT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CDT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_compl_ca_detail_id
--     already exists.
--
--  In Arguments:
