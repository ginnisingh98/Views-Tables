--------------------------------------------------------
--  DDL for Package PER_ABB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ABB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,date_end                        date
  ,hours_or_days                   varchar2(9)       -- Increased length
  ,increasing_or_decreasing_flag   varchar2(9)       -- Increased length
  ...
  ,advance_pay                     varchar2(30)
  ,absence_overlap_flag            varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_ABSENCE_ATTENDANCE_TYPES';
