--------------------------------------------------------
--  DDL for Package BEN_PRG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  hghly_compd_det_rl                number(15),
  key_ee_det_rl                     number(15),
  cntr_nndscrn_rl                   number(15),
  cvg_nndscrn_rl                    number(15),
  five_pct_ownr_rl                  number(15),
  regy_pl_typ_cd                    varchar2(30),
  prg_attribute_category            varchar2(30),
  prg_attribute1                    varchar2(150),
  prg_attribute2                    varchar2(150),
  prg_attribute3                    varchar2(150),
  prg_attribute4                    varchar2(150),
  prg_attribute5                    varchar2(150),
  prg_attribute6                    varchar2(150),
  prg_attribute7                    varchar2(150),
  prg_attribute8                    varchar2(150),
  prg_attribute9                    varchar2(150),
  prg_attribute10                   varchar2(150),
  prg_attribute11                   varchar2(150),
  prg_attribute12                   varchar2(150),
  prg_attribute13                   varchar2(150),
  prg_attribute14                   varchar2(150),
  prg_attribute15                   varchar2(150),
  prg_attribute16                   varchar2(150),
  prg_attribute17                   varchar2(150),
  prg_attribute18                   varchar2(150),
  prg_attribute19                   varchar2(150),
  prg_attribute20                   varchar2(150),
  prg_attribute21                   varchar2(150),
  prg_attribute22                   varchar2(150),
  prg_attribute23                   varchar2(150),
  prg_attribute24                   varchar2(150),
  prg_attribute25                   varchar2(150),
  prg_attribute26                   varchar2(150),
  prg_attribute27                   varchar2(150),
  prg_attribute28                   varchar2(150),
  prg_attribute29                   varchar2(150),
  prg_attribute30                   varchar2(150),
