--------------------------------------------------------
--  DDL for Package BEN_DOP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DOP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dpnt_cvrd_othr_pgm_rt_id        number(15),
  ...
  dop_attribute_category            varchar2(30),
  dop_attribute1                    varchar2(150),
  dop_attribute2                    varchar2(150),
  dop_attribute3                    varchar2(150),
  dop_attribute4                    varchar2(150),
  dop_attribute5                    varchar2(150),
  dop_attribute6                    varchar2(150),
  dop_attribute7                    varchar2(150),
  dop_attribute8                    varchar2(150),
  dop_attribute9                    varchar2(150),
  dop_attribute10                   varchar2(150),
  dop_attribute11                   varchar2(150),
  dop_attribute12                   varchar2(150),
  dop_attribute13                   varchar2(150),
  dop_attribute14                   varchar2(150),
  dop_attribute15                   varchar2(150),
  dop_attribute16                   varchar2(150),
  dop_attribute17                   varchar2(150),
  dop_attribute18                   varchar2(150),
  dop_attribute19                   varchar2(150),
  dop_attribute20                   varchar2(150),
  dop_attribute21                   varchar2(150),
  dop_attribute22                   varchar2(150),
  dop_attribute23                   varchar2(150),
  dop_attribute24                   varchar2(150),
  dop_attribute25                   varchar2(150),
  dop_attribute26                   varchar2(150),
  dop_attribute27                   varchar2(150),
  dop_attribute28                   varchar2(150),
  dop_attribute29                   varchar2(150),
  dop_attribute30                   varchar2(150),
...
--           p_base_key_value = :dpnt_cvrd_othr_pgm_rt_id).
--
-- Post Success:
--   Processing continues.
--
