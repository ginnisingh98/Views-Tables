--------------------------------------------------------
--  DDL for Package AMS_DELIVKITITEM_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_DELIVKITITEM_CUHK" AUTHID CURRENT_USER as
/*$Header: amsckits.pls 115.1 2002/11/14 00:20:56 musman noship $*/

--------------------------------------------------------
-- Start of Comments
-- Package name     : AMS_DelivKitItem_CUHK
-- PURPOSE
...
--
-- PURPOSE
--    Customer pre-processing for validate_DelivKitItem_pre.
------------------------------------------------------------
