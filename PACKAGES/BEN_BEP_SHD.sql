--------------------------------------------------------
--  DDL for Package BEN_BEP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BEP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (elig_obj_elig_prfl_id           number
  ,effective_start_date            date
  ,effective_end_date              date
  ,elig_obj_id                     number
  ,elig_prfl_id                    number
  ,mndtry_flag                     varchar2(9)       -- Increased length
  ,business_group_id               number
  ,bep_attribute_category          varchar2(150)
  ,bep_attribute1                  varchar2(30)
  ,bep_attribute2                  varchar2(30)
  ,bep_attribute3                  varchar2(30)
  ,bep_attribute4                  varchar2(30)
  ,bep_attribute5                  varchar2(30)
  ,bep_attribute6                  varchar2(30)
  ,bep_attribute7                  varchar2(30)
  ,bep_attribute8                  varchar2(30)
  ,bep_attribute9                  varchar2(30)
  ,bep_attribute10                 varchar2(30)
  ,bep_attribute11                 varchar2(30)
  ,bep_attribute12                 varchar2(30)
  ,bep_attribute13                 varchar2(30)
  ,bep_attribute14                 varchar2(30)
  ,bep_attribute15                 varchar2(30)
  ,bep_attribute16                 varchar2(30)
  ,bep_attribute17                 varchar2(30)
  ,bep_attribute18                 varchar2(30)
  ,bep_attribute19                 varchar2(30)
  ,bep_attribute20                 varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_ELIG_OBJ_ELIG_PROFL_F';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :elig_obj_elig_prfl_id).
--
-- Post Success:
