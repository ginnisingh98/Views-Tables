--------------------------------------------------------
--  DDL for Package PAY_CA_EOY_T4A_AMEND_REG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CA_EOY_T4A_AMEND_REG" AUTHID CURRENT_USER AS
/* $Header: pycat4acr.pkh 120.0.12000000.1 2007/01/17 17:29:17 appldev noship $ */
/*
   ******************************************************************
   *                                                                *
