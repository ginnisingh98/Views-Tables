--------------------------------------------------------
--  DDL for Package BEN_LEE_RSN_RL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LEE_RSN_RL_BK1" AUTHID CURRENT_USER as
