--------------------------------------------------------
--  DDL for Package OTA_SRT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_SRT_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_SUPPLIABLE_RESOURCES_TL';
--
g_app_code  varchar2(3) := 'OTA';
g_flex_code varchar2(3) := 'RES';
