--------------------------------------------------------
--  DDL for Package OTA_PMM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_PMM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  program_membership_id             number(9),
  event_id                          number(9),
  program_event_id                  number(9),
  ...
  role                              varchar2(30),
  sequence                          number(9),
  pmm_information_category          varchar2(30),
  pmm_information1                  varchar2(150),
  pmm_information2                  varchar2(150),
  pmm_information3                  varchar2(150),
  pmm_information4                  varchar2(150),
  pmm_information5                  varchar2(150),
  pmm_information6                  varchar2(150),
  pmm_information7                  varchar2(150),
  pmm_information8                  varchar2(150),
  pmm_information9                  varchar2(150),
  pmm_information10                 varchar2(150),
  pmm_information11                 varchar2(150),
  pmm_information12                 varchar2(150),
  pmm_information13                 varchar2(150),
  pmm_information14                 varchar2(150),
  pmm_information15                 varchar2(150),
  pmm_information16                 varchar2(150),
  pmm_information17                 varchar2(150),
  pmm_information18                 varchar2(150),
  pmm_information19                 varchar2(150),
  pmm_information20                 varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
