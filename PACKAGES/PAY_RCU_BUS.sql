--------------------------------------------------------
--  DDL for Package PAY_RCU_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_RCU_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_retro_component_usage_id
--     already exists.
--
--  In Arguments:
