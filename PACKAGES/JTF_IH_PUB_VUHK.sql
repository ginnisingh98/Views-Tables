--------------------------------------------------------
--  DDL for Package JTF_IH_PUB_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_IH_PUB_VUHK" AUTHID CURRENT_USER AS
 /* $Header: JTFIHPKS.pls 115.6 2002/11/08 18:46:19 ialeshin ship $ */
