--------------------------------------------------------
--  DDL for Package PQH_RCT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RCT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  override_position_id              number(15),
  override_assignment_id            number(15),
  override_role_id                  number(15),
  override_user_id                  number(15),
