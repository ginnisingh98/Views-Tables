--------------------------------------------------------
--  DDL for Package ENG_CHANGE_TEXT_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ENG_CHANGE_TEXT_PVT" AUTHID CURRENT_USER AS
/* $Header: ENGVIDXS.pls 120.0 2005/05/26 18:30:14 appldev noship $ */

-- -----------------------------------------------------------------------------
--  				Public Globals
-- -----------------------------------------------------------------------------

G_FILE_NAME	CONSTANT  VARCHAR2(12)  :=  'ENGVIDXS.pls';
