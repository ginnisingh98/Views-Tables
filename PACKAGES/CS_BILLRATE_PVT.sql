--------------------------------------------------------
--  DDL for Package CS_BILLRATE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CS_BILLRATE_PVT" AUTHID CURRENT_USER AS
/* $Header: csctcbrs.pls 115.0 99/07/16 08:49:28 porting ship  $ */
  ---------------------------------------------------------------------------
  -- GLOBAL DATASTRUCTURES
  ---------------------------------------------------------------------------
  TYPE BillRate_Rec_Type IS RECORD (
    coverage_bill_rate_id          NUMBER := NULL,
    coverage_billing_type_id       NUMBER := NULL,
    rate_type_code                 CS_COV_BILL_RATES.RATE_TYPE_CODE%TYPE := NULL,
    unit_of_measure_code           CS_COV_BILL_RATES.UNIT_OF_MEASURE_CODE%TYPE := NULL,
    flat_rate                      NUMBER := NULL,
    percent_rate                   NUMBER := NULL,
    last_update_date               CS_COV_BILL_RATES.LAST_UPDATE_DATE%TYPE := NULL,
    last_updated_by                NUMBER := NULL,
    creation_date                  CS_COV_BILL_RATES.CREATION_DATE%TYPE := NULL,
    created_by                     NUMBER := NULL,
    last_update_login              NUMBER := NULL,
    attribute1                     CS_COV_BILL_RATES.ATTRIBUTE1%TYPE := NULL,
    attribute2                     CS_COV_BILL_RATES.ATTRIBUTE2%TYPE := NULL,
    attribute3                     CS_COV_BILL_RATES.ATTRIBUTE3%TYPE := NULL,
    attribute4                     CS_COV_BILL_RATES.ATTRIBUTE4%TYPE := NULL,
    attribute5                     CS_COV_BILL_RATES.ATTRIBUTE5%TYPE := NULL,
    attribute6                     CS_COV_BILL_RATES.ATTRIBUTE6%TYPE := NULL,
    attribute7                     CS_COV_BILL_RATES.ATTRIBUTE7%TYPE := NULL,
    attribute8                     CS_COV_BILL_RATES.ATTRIBUTE8%TYPE := NULL,
    attribute9                     CS_COV_BILL_RATES.ATTRIBUTE9%TYPE := NULL,
    attribute10                    CS_COV_BILL_RATES.ATTRIBUTE10%TYPE := NULL,
    attribute11                    CS_COV_BILL_RATES.ATTRIBUTE11%TYPE := NULL,
    attribute12                    CS_COV_BILL_RATES.ATTRIBUTE12%TYPE := NULL,
    attribute13                    CS_COV_BILL_RATES.ATTRIBUTE13%TYPE := NULL,
    attribute14                    CS_COV_BILL_RATES.ATTRIBUTE14%TYPE := NULL,
    attribute15                    CS_COV_BILL_RATES.ATTRIBUTE15%TYPE := NULL,
    context                        CS_COV_BILL_RATES.CONTEXT%TYPE := NULL,
    object_version_number          NUMBER := NULL);
  G_MISS_billrate_rec                     BillRate_Rec_Type;
  TYPE BillRate_Val_Rec_Type IS RECORD (
    coverage_bill_rate_id          NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    coverage_billing_type_id       NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    rate_type_code                 CS_COV_BILL_RATES.RATE_TYPE_CODE%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    unit_of_measure_code           CS_COV_BILL_RATES.UNIT_OF_MEASURE_CODE%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    flat_rate                      NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    percent_rate                   NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    last_update_date               CS_COV_BILL_RATES.LAST_UPDATE_DATE%TYPE := TAPI_DEV_KIT.G_MISS_DATE,
    last_updated_by                NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    creation_date                  CS_COV_BILL_RATES.CREATION_DATE%TYPE := TAPI_DEV_KIT.G_MISS_DATE,
    created_by                     NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    last_update_login              NUMBER := TAPI_DEV_KIT.G_MISS_NUM,
    attribute1                     CS_COV_BILL_RATES.ATTRIBUTE1%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute2                     CS_COV_BILL_RATES.ATTRIBUTE2%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute3                     CS_COV_BILL_RATES.ATTRIBUTE3%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute4                     CS_COV_BILL_RATES.ATTRIBUTE4%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute5                     CS_COV_BILL_RATES.ATTRIBUTE5%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute6                     CS_COV_BILL_RATES.ATTRIBUTE6%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute7                     CS_COV_BILL_RATES.ATTRIBUTE7%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute8                     CS_COV_BILL_RATES.ATTRIBUTE8%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute9                     CS_COV_BILL_RATES.ATTRIBUTE9%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute10                    CS_COV_BILL_RATES.ATTRIBUTE10%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute11                    CS_COV_BILL_RATES.ATTRIBUTE11%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute12                    CS_COV_BILL_RATES.ATTRIBUTE12%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute13                    CS_COV_BILL_RATES.ATTRIBUTE13%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute14                    CS_COV_BILL_RATES.ATTRIBUTE14%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    attribute15                    CS_COV_BILL_RATES.ATTRIBUTE15%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    context                        CS_COV_BILL_RATES.CONTEXT%TYPE := TAPI_DEV_KIT.G_MISS_CHAR,
    object_version_number          NUMBER := TAPI_DEV_KIT.G_MISS_NUM);
  G_MISS_billrate_val_rec                 BillRate_Val_Rec_Type;
  ---------------------------------------------------------------------------
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME			CONSTANT	VARCHAR2(200) := 'CS_BILLRATE_PVT';
