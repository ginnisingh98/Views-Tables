--------------------------------------------------------
--  DDL for Package PER_PJU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PJU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (previous_job_usage_id           number(15)
  ,assignment_id                   number(15)
  ,previous_employer_id            number(15)
  ,previous_job_id                 number(15)
  ,start_date                      date
  ,end_date                        date
  ,period_years                    number(9)
  ,period_months                   number(9)
  ,period_days                     number(9)
  ,pju_attribute_category          varchar2(30)
  ,pju_attribute1                  varchar2(150)
  ,pju_attribute2                  varchar2(150)
  ,pju_attribute3                  varchar2(150)
  ,pju_attribute4                  varchar2(150)
  ,pju_attribute5                  varchar2(150)
  ,pju_attribute6                  varchar2(150)
  ,pju_attribute7                  varchar2(150)
  ,pju_attribute8                  varchar2(150)
  ,pju_attribute9                  varchar2(150)
  ,pju_attribute10                 varchar2(150)
  ,pju_attribute11                 varchar2(150)
  ,pju_attribute12                 varchar2(150)
  ,pju_attribute13                 varchar2(150)
  ,pju_attribute14                 varchar2(150)
  ,pju_attribute15                 varchar2(150)
  ,pju_attribute16                 varchar2(150)
  ,pju_attribute17                 varchar2(150)
  ,pju_attribute18                 varchar2(150)
  ,pju_attribute19                 varchar2(150)
  ,pju_attribute20                 varchar2(150)
  ,pju_information_category        varchar2(30)
  ,pju_information1                varchar2(150)
  ,pju_information2                varchar2(150)
  ,pju_information3                varchar2(150)
  ,pju_information4                varchar2(150)
  ,pju_information5                varchar2(150)
  ,pju_information6                varchar2(150)
  ,pju_information7                varchar2(150)
  ,pju_information8                varchar2(150)
  ,pju_information9                varchar2(150)
  ,pju_information10               varchar2(150)
  ,pju_information11               varchar2(150)
  ,pju_information12               varchar2(150)
  ,pju_information13               varchar2(150)
  ,pju_information14               varchar2(150)
  ,pju_information15               varchar2(150)
  ,pju_information16               varchar2(150)
  ,pju_information17               varchar2(150)
  ,pju_information18               varchar2(150)
  ,pju_information19               varchar2(150)
  ,pju_information20               varchar2(150)
