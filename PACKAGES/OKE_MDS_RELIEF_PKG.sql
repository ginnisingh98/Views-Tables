--------------------------------------------------------
--  DDL for Package OKE_MDS_RELIEF_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKE_MDS_RELIEF_PKG" AUTHID CURRENT_USER AS
/* $Header: OKEMDSFS.pls 115.6 2002/12/04 08:45:56 alaw ship $ */
