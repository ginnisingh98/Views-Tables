--------------------------------------------------------
--  DDL for Package BEN_PUM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PUM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  pop_up_messages_id                number,
  pop_name                          varchar2(300),
  formula_id                        number,
  function_name                     varchar2(300),
  block_name                        varchar2(300),
  field_name                        varchar2(300),
  event_name                        varchar2(300),
  message                           varchar2(300),
  message_type                      varchar2(300),
  business_group_id                 number,
  object_version_number             number,
  start_date                        date,
  end_date                          date,
  no_formula_flag                   varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
