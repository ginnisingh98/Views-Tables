--------------------------------------------------------
--  DDL for Package PQP_ATD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_ATD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  alien_transaction_id              number(15),
  person_id                         number(10),  -- Added by Ashu Gupta
  data_source_type                  varchar2(30),
  tax_year                          number(9),        -- Increased length
  ...
  current_residency_status          varchar2(30),
  nra_to_ra_date                    date,
  target_departure_date             date,
  tax_residence_country_code        varchar2(30),
  treaty_info_update_date           date,
  nra_exempt_from_fica              varchar2(30),
  student_exempt_from_fica          varchar2(30),
  ...
  number_of_days_in_usa             number(9),        -- Increased length
  wthldg_allow_eligible_flag        varchar2(30),
  treaty_ben_allowed_flag           varchar2(30),
  treaty_benefits_start_date        date,
  ra_effective_date                 date,
  state_code                        varchar2(30),
  state_honors_treaty_flag          varchar2(30),
  ytd_payments                      number(11,2),
  ytd_w2_payments                   number(11,2),
  ytd_w2_withholding                number(11,2),
  ytd_withholding_allowance         number(11,2),
  ytd_treaty_payments               number(11,2),
  ytd_treaty_withheld_amt           number(11,2),
  record_source                     varchar2(30),
  visa_type                         varchar2(30),
  j_sub_type                        varchar2(30),
  primary_activity                  varchar2(30),
  non_us_country_code               varchar2(30),
  citizenship_country_code          varchar2(30),
  constant_addl_tax                 number(11,2),
  date_8233_signed                  date,
  date_w4_signed                    date,
  error_indicator                   varchar2(30),
  prev_er_treaty_benefit_amt        number(11,2),
...
Function convert_args
	(
	p_alien_transaction_id          in number,
        p_person_id                     in number,   -- Added by Ashu Gupta
