--------------------------------------------------------
--  DDL for Package OKS_BILLTRAN_LINE_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKS_BILLTRAN_LINE_PUB" AUTHID CURRENT_USER AS
/* $Header: OKSPBTLS.pls 120.0 2005/05/25 18:06:45 appldev noship $ */

  SUBTYPE btlv_rec_type IS OKS_BILLTRAN_LINE_PVT.btlv_rec_type;
  SUBTYPE btlv_tbl_type IS OKS_BILLTRAN_LINE_PVT.btlv_tbl_type;

 -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME			CONSTANT VARCHAR2(200) := 'OKS_BILLTRAN_LINE_PUB' ;
  G_APP_NAME			CONSTANT VARCHAR2(3)   :=  OKC_API.G_APP_NAME;
  G_btlv_REC			btlv_rec_type;
  ---------------------------------------------------------------------------
