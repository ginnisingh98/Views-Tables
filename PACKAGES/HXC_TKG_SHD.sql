--------------------------------------------------------
--  DDL for Package HXC_TKG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_TKG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,tk_group_name               varchar2(80)
  ,tk_resource_id                 number(15)
