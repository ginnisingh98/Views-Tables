--------------------------------------------------------
--  DDL for Package HXC_ULD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_ULD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (layout_comp_definition_id       number(15)
  ,component_type                  varchar2(30)
  ,component_class                 varchar2(240)
