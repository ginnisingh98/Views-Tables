--------------------------------------------------------
--  DDL for Package BEN_PAT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PAT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  popl_actn_typ_id                  number(15),
  effective_start_date              date,
  effective_end_date                date,
  actn_typ_due_dt_cd                varchar2(30),
  actn_typ_due_dt_rl                number(15),
  actn_typ_id                       number(15),
  pgm_id                            number(15),
  pl_id                             number(15),
  business_group_id                 number(15),
  pat_attribute_category            varchar2(30),
  pat_attribute1                    varchar2(150),
  pat_attribute2                    varchar2(150),
  pat_attribute3                    varchar2(150),
  pat_attribute4                    varchar2(150),
  pat_attribute5                    varchar2(150),
  pat_attribute6                    varchar2(150),
  pat_attribute7                    varchar2(150),
  pat_attribute8                    varchar2(150),
  pat_attribute9                    varchar2(150),
  pat_attribute10                   varchar2(150),
  pat_attribute11                   varchar2(150),
  pat_attribute12                   varchar2(150),
  pat_attribute13                   varchar2(150),
  pat_attribute14                   varchar2(150),
  pat_attribute15                   varchar2(150),
  pat_attribute16                   varchar2(150),
  pat_attribute17                   varchar2(150),
  pat_attribute18                   varchar2(150),
  pat_attribute19                   varchar2(150),
  pat_attribute20                   varchar2(150),
  pat_attribute21                   varchar2(150),
  pat_attribute22                   varchar2(150),
  pat_attribute23                   varchar2(150),
  pat_attribute24                   varchar2(150),
  pat_attribute25                   varchar2(150),
  pat_attribute26                   varchar2(150),
  pat_attribute27                   varchar2(150),
  pat_attribute28                   varchar2(150),
  pat_attribute29                   varchar2(150),
  pat_attribute30                   varchar2(150),
  object_version_number             number(9),
  mandatory                       varchar2(30),
  once_or_always                  varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :popl_actn_typ_id).
--
-- Post Success:
--   Processing continues.
--
