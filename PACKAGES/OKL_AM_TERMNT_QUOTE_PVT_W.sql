--------------------------------------------------------
--  DDL for Package OKL_AM_TERMNT_QUOTE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_AM_TERMNT_QUOTE_PVT_W" AUTHID CURRENT_USER as
  /* $Header: OKLETNQS.pls 120.5 2007/11/02 21:06:14 rmunjulu ship $ */
