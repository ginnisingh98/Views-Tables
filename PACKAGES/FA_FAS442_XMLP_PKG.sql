--------------------------------------------------------
--  DDL for Package FA_FAS442_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_FAS442_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: FAS442S.pls 120.0.12010000.1 2008/07/28 13:14:37 appldev ship $ */
	P_BOOK	varchar2(15);
