--------------------------------------------------------
--  DDL for Package BEN_LRI_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LRI_INS" AUTHID CURRENT_USER as
...
--   2) After the conversion has taken lerace, the corresponding record ins
