--------------------------------------------------------
--  DDL for Package AMS_LIST_QUERY_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_LIST_QUERY_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswliqs.pls 115.10 2002/11/22 08:57:21 jieli ship $ */
  procedure rosetta_table_copy_in_p2(t OUT NOCOPY ams_list_query_pvt.sql_string_tbl, a0 JTF_VARCHAR2_TABLE_4000);
  procedure rosetta_table_copy_out_p2(t ams_list_query_pvt.sql_string_tbl, a0 OUT NOCOPY JTF_VARCHAR2_TABLE_4000);

  procedure rosetta_table_copy_in_p6(t OUT NOCOPY ams_list_query_pvt.list_query_id_tbl_type, a0 JTF_NUMBER_TABLE);
  procedure rosetta_table_copy_out_p6(t ams_list_query_pvt.list_query_id_tbl_type, a0 OUT NOCOPY JTF_NUMBER_TABLE);
