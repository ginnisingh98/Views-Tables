--------------------------------------------------------
--  DDL for Package INV_PRJ_CUST_VAL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."INV_PRJ_CUST_VAL" AUTHID CURRENT_USER AS
/* $Header: INVPRJCS.pls 120.2 2005/06/11 14:05:58 appldev  $ */
