--------------------------------------------------------
--  DDL for Package BEN_YRP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_YRP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  perds_in_yr_num                   number(15),
  perd_tm_uom_cd                    varchar2(30),
  perd_typ_cd                       varchar2(30),
  end_date                          date,
  start_date                        date,
  lmtn_yr_strt_dt                   date,
  lmtn_yr_end_dt                    date,
  business_group_id                 number(15),
  yrp_attribute_category            varchar2(30),
  yrp_attribute1                    varchar2(150),
  yrp_attribute2                    varchar2(150),
  yrp_attribute3                    varchar2(150),
  yrp_attribute4                    varchar2(150),
  yrp_attribute5                    varchar2(150),
  yrp_attribute6                    varchar2(150),
  yrp_attribute7                    varchar2(150),
  yrp_attribute8                    varchar2(150),
  yrp_attribute9                    varchar2(150),
  yrp_attribute10                   varchar2(150),
  yrp_attribute11                   varchar2(150),
  yrp_attribute12                   varchar2(150),
  yrp_attribute13                   varchar2(150),
  yrp_attribute14                   varchar2(150),
  yrp_attribute15                   varchar2(150),
  yrp_attribute16                   varchar2(150),
  yrp_attribute17                   varchar2(150),
  yrp_attribute18                   varchar2(150),
  yrp_attribute19                   varchar2(150),
  yrp_attribute20                   varchar2(150),
  yrp_attribute21                   varchar2(150),
  yrp_attribute22                   varchar2(150),
  yrp_attribute23                   varchar2(150),
  yrp_attribute24                   varchar2(150),
  yrp_attribute25                   varchar2(150),
  yrp_attribute26                   varchar2(150),
  yrp_attribute27                   varchar2(150),
  yrp_attribute28                   varchar2(150),
  yrp_attribute29                   varchar2(150),
  yrp_attribute30                   varchar2(150),
