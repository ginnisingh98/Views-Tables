--------------------------------------------------------
--  DDL for Package BEN_ELIG_BENFTS_GRP_PRTE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_BENFTS_GRP_PRTE_BK2" AUTHID CURRENT_USER as
/* $Header: beebnapi.pkh 120.0 2005/05/28 01:47:09 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_BENFTS_GRP_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_BENFTS_GRP_PRTE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_BENFTS_GRP_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_BENFTS_GRP_PRTE_a
  (
   p_elig_benfts_grp_prte_id        in  number
...
--
end ben_ELIG_BENFTS_GRP_PRTE_bk2;
