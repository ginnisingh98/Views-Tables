--------------------------------------------------------
--  DDL for Package IRC_IID_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IID_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (interview_details_id            number(15)
  ,status                          varchar2(30)
  ,feedback                        varchar2(4000)
  ,notes                           varchar2(4000)
  ,notes_to_candidate              varchar2(4000)
  ,category                        varchar2(30)
  ,result                          varchar2(150)
  ,iid_information_category        varchar2(30)
  ,iid_information1                varchar2(150)
  ,iid_information2                varchar2(150)
  ,iid_information3                varchar2(150)
  ,iid_information4                varchar2(150)
  ,iid_information5                varchar2(150)
  ,iid_information6                varchar2(150)
  ,iid_information7                varchar2(150)
  ,iid_information8                varchar2(150)
  ,iid_information9                varchar2(150)
  ,iid_information10               varchar2(150)
  ,iid_information11               varchar2(150)
  ,iid_information12               varchar2(150)
  ,iid_information13               varchar2(150)
  ,iid_information14               varchar2(150)
  ,iid_information15               varchar2(150)
  ,iid_information16               varchar2(150)
  ,iid_information17               varchar2(150)
  ,iid_information18               varchar2(150)
  ,iid_information19               varchar2(150)
  ,iid_information20               varchar2(150)
  ,start_date                      date
  ,end_date                        date
  ,event_id                        number(15)
...
-- Global table name
g_tab_name  constant varchar2(30) := 'IRC_INTERVIEW_DETAILS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
