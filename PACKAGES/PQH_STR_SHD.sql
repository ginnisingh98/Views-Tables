--------------------------------------------------------
--  DDL for Package PQH_STR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_STR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (stat_situation_rule_id          number(15)
  ,statutory_situation_id          number(15)
  ,processing_sequence             number(10)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_FR_STAT_SITUATION_RULES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
