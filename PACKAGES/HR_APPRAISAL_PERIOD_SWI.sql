--------------------------------------------------------
--  DDL for Package HR_APPRAISAL_PERIOD_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_APPRAISAL_PERIOD_SWI" AUTHID CURRENT_USER As
/* $Header: pepmaswi.pkh 120.3.12010000.2 2009/10/23 13:45:45 schowdhu ship $ */
-- ----------------------------------------------------------------------------
...
--  API: hr_appraisal_period_api.create_appraisal_period
--
-- Pre-requisites
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: hr_appraisal_period_api.delete_appraisal_period
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
...
-- Description:
--  This procedure is the self-service wrapper procedure to the following
--  API: hr_appraisal_period_api.update_appraisal_period
--
-- Pre-requisites
--  All 'IN' parameters to this procedure have been appropriately derived.
--
