--------------------------------------------------------
--  DDL for Package BEN_LER_RLTD_PER_CS_LER_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LER_RLTD_PER_CS_LER_BK1" AUTHID CURRENT_USER as
/* $Header: belrcapi.pkh 120.0 2005/05/28 03:33:03 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Ler_Rltd_Per_Cs_Ler_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Ler_Rltd_Per_Cs_Ler_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Ler_Rltd_Per_Cs_Ler_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Ler_Rltd_Per_Cs_Ler_a
  (
...
--
end ben_Ler_Rltd_Per_Cs_Ler_bk1;
