--------------------------------------------------------
--  DDL for Package QP_QUALIFIER_RULES_PUB_OA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."QP_QUALIFIER_RULES_PUB_OA" AUTHID CURRENT_USER as
  /* $Header: ozfaqprs.pls 120.0 2005/08/31 09:43 gramanat noship $ */
