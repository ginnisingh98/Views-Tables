--------------------------------------------------------
--  DDL for Package PAY_SEU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_SEU_SHD" AUTHID CURRENT_USER as
/* $Header: pyseurhi.pkh 115.1 2002/12/09 15:27:12 divicker noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (element_type_usage_id           number(9)
  ,element_type_id                 number(9)
  ,inclusion_flag                  varchar2(30)
