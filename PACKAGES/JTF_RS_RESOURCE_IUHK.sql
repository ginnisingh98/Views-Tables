--------------------------------------------------------
--  DDL for Package JTF_RS_RESOURCE_IUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_RS_RESOURCE_IUHK" AUTHID CURRENT_USER AS
  /* $Header: jtfrsnrs.pls 120.0 2005/05/11 08:20:55 appldev ship $ */
