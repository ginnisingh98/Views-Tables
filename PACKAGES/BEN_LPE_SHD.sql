--------------------------------------------------------
--  DDL for Package BEN_LPE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LPE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_chg_pl_nip_enrt_id            number(15),
  ...
  lpe_attribute_category            varchar2(30),
  lpe_attribute1                    varchar2(150),
  lpe_attribute2                    varchar2(150),
  lpe_attribute3                    varchar2(150),
  lpe_attribute4                    varchar2(150),
  lpe_attribute5                    varchar2(150),
  lpe_attribute6                    varchar2(150),
  lpe_attribute7                    varchar2(150),
  lpe_attribute8                    varchar2(150),
  lpe_attribute9                    varchar2(150),
  lpe_attribute10                   varchar2(150),
  lpe_attribute11                   varchar2(150),
  lpe_attribute12                   varchar2(150),
  lpe_attribute13                   varchar2(150),
  lpe_attribute14                   varchar2(150),
  lpe_attribute15                   varchar2(150),
  lpe_attribute16                   varchar2(150),
  lpe_attribute17                   varchar2(150),
  lpe_attribute18                   varchar2(150),
  lpe_attribute19                   varchar2(150),
  lpe_attribute20                   varchar2(150),
  lpe_attribute21                   varchar2(150),
  lpe_attribute22                   varchar2(150),
  lpe_attribute23                   varchar2(150),
  lpe_attribute24                   varchar2(150),
  lpe_attribute25                   varchar2(150),
  lpe_attribute26                   varchar2(150),
  lpe_attribute27                   varchar2(150),
  lpe_attribute28                   varchar2(150),
  lpe_attribute29                   varchar2(150),
  lpe_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_chg_pl_nip_enrt_id).
--
-- Post Success:
--   Processing continues.
--
