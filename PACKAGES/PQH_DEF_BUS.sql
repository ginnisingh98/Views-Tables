--------------------------------------------------------
--  DDL for Package PQH_DEF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_DEF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_wrkplc_vldtn_id
--     already exists.
--
--  In Arguments:
--    p_wrkplc_vldtn_id
