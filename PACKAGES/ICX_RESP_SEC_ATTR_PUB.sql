--------------------------------------------------------
--  DDL for Package ICX_RESP_SEC_ATTR_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ICX_RESP_SEC_ATTR_PUB" AUTHID CURRENT_USER AS
/* $Header: ICXPTRSS.pls 115.2 99/07/17 03:21:20 porting ship $ */

--  Global constants holding the package and file names to be used by
--  messaging routines in the case of an unexpected error.

G_PKG_NAME	CONSTANT VARCHAR2(30) := 'ICX_Resp_Sec_Attr_PUB';
G_FILE_NAME	CONSTANT VARCHAR2(12) := 'ICXPTRSB.pls';
