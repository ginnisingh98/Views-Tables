--------------------------------------------------------
--  DDL for Package HR_AMM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_AMM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (authoria_mapping_id             number(15)
  ,pl_id                           number(15)
  ,plip_id                         number(15)
  ,open_enrollment_flag            varchar2(9)       -- Increased length
  ,target_page                     varchar2(200)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_AUTHORIA_MAPPINGS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
