--------------------------------------------------------
--  DDL for Package BEN_PERSON_LIFE_EVENT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PERSON_LIFE_EVENT_BK2" AUTHID CURRENT_USER as
/* $Header: bepilapi.pkh 120.0 2005/05/28 10:49:48 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_Person_Life_Event_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_Person_Life_Event_b
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_Person_Life_Event_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_Person_Life_Event_a
  (p_per_in_ler_id                  in  number
  ,p_per_in_ler_stat_cd             in  varchar2
  ,p_prvs_stat_cd                   in  varchar2
  ,p_lf_evt_ocrd_dt                 in  date
