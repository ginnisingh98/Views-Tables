--------------------------------------------------------
--  DDL for Package FUN_NET_AGREEMENTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FUN_NET_AGREEMENTS_PKG" AUTHID CURRENT_USER AS
/* $Header: funntags.pls 120.0 2005/12/09 08:30:55 vgadde noship $ */
...
END FUN_NET_AGREEMENTS_PKG; -- Package spec
