--------------------------------------------------------
--  DDL for Package PQP_PTY_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_PTY_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_pension_type_id
--     already exists.
--
--  In Arguments:
--    p_pension_type_id
