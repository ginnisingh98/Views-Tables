--------------------------------------------------------
--  DDL for Package PNRX_C_SPACE_UTIL_LEASE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PNRX_C_SPACE_UTIL_LEASE" AUTHID CURRENT_USER AS
/* $Header: PNRXCLUS.pls 115.2 2002/11/15 20:36:16 stripath ship $ */
