--------------------------------------------------------
--  DDL for Package BEN_ELIG_DSBLTY_DGR_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_DSBLTY_DGR_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beeddapi.pkh 120.0 2005/05/28 01:57:41 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_dsblty_dgr_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_dsblty_dgr_PRTE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_dsblty_dgr_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_dsblty_dgr_PRTE_a
  (
...
--
end ben_ELIG_dsblty_dgr_PRTE_bk1;
