--------------------------------------------------------
--  DDL for Package PER_APT_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_APT_FLEX" AUTHID CURRENT_USER as
/* $Header: peaptfli.pkh 115.1 99/07/17 18:36:16 porting ship $ */
--
--
-------------------------------------------------------------------------------
-- |-------------------------------< df>-------------------------------------|
