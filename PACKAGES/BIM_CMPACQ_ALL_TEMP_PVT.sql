--------------------------------------------------------
--  DDL for Package BIM_CMPACQ_ALL_TEMP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BIM_CMPACQ_ALL_TEMP_PVT" AUTHID CURRENT_USER AS
/* $Header: bimvcqas.pls 115.2 2000/03/03 20:36:02 pkm ship  $ */
