--------------------------------------------------------
--  DDL for Package BEN_DCO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DCO_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dpnt_cvrd_othr_ptip_rt_id       number(15),
  ...
  dco_attribute_category            varchar2(30),
  dco_attribute1                    varchar2(150),
  dco_attribute2                    varchar2(150),
  dco_attribute3                    varchar2(150),
  dco_attribute4                    varchar2(150),
  dco_attribute5                    varchar2(150),
  dco_attribute6                    varchar2(150),
  dco_attribute7                    varchar2(150),
  dco_attribute8                    varchar2(150),
  dco_attribute9                    varchar2(150),
  dco_attribute10                   varchar2(150),
  dco_attribute11                   varchar2(150),
  dco_attribute12                   varchar2(150),
  dco_attribute13                   varchar2(150),
  dco_attribute14                   varchar2(150),
  dco_attribute15                   varchar2(150),
  dco_attribute16                   varchar2(150),
  dco_attribute17                   varchar2(150),
  dco_attribute18                   varchar2(150),
  dco_attribute19                   varchar2(150),
  dco_attribute20                   varchar2(150),
  dco_attribute21                   varchar2(150),
  dco_attribute22                   varchar2(150),
  dco_attribute23                   varchar2(150),
  dco_attribute24                   varchar2(150),
  dco_attribute25                   varchar2(150),
  dco_attribute26                   varchar2(150),
  dco_attribute27                   varchar2(150),
  dco_attribute28                   varchar2(150),
  dco_attribute29                   varchar2(150),
  dco_attribute30                   varchar2(150),
...
--           p_base_key_value = :dpnt_cvrd_othr_ptip_rt_id).
--
-- Post Success:
--   Processing continues.
--
