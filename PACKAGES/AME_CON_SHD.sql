--------------------------------------------------------
--  DDL for Package AME_CON_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_CON_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (condition_id                    number
  ,condition_type                  varchar2(9)       -- Increased length
  ,attribute_id                    number
  ,parameter_one                   varchar2(50)
  ,parameter_two                   varchar2(320)
  ,parameter_three                 varchar2(50)
  ,include_lower_limit             varchar2(9)       -- Increased length
  ,include_upper_limit             varchar2(9)       -- Increased length
  ,start_date                      date
  ,end_date                        date
  ,security_group_id               number(15)
  ,condition_key                   varchar2(100)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'AME_CONDITIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
