--------------------------------------------------------
--  DDL for Package GCS_TRANS_RE_DYNAMIC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GCS_TRANS_RE_DYNAMIC_PKG" AUTHID CURRENT_USER AS
 /* $Header: gcsxldreps.pls 120.2 2007/06/28 12:29:21 vkosuri noship $ */


  --
  -- Procedure
  --   Roll_Forward_Retained_Earnings
  -- Purpose
  --   Roll forward retained earnings from prior periods.
  -- Arguments
  ...
  -- Example
  --   GCS_TRANS_HRATES_DYNAMIC_PKG.Roll_Forward_Retained_Earnings;
  -- Notes
  --
  ...
  --   Trans_RE_First_Per
  -- Purpose
  --   Translate balances for retained earnings for a period which
  -- is the first period ever to be translated.
  -- Arguments
  ...
  --   p_hier_li_id      Line Item Id of retained earnings selected for the hierarchy.
  -- Example
  --   GCS_TRANS_HRATES_DYNAMIC_PKG.Trans_RE_First_Per;
  -- Notes
  --
  ...
  --   Trans_RE_Subseq_Per
  -- Purpose
  --   Translate balances for retained earnings rates for a period which is not the first period ever
  --   to be translated.
  -- Arguments
  ...
  --   p_hier_li_id         Line Item Id of retained earnings selected for the hierarchy.
  -- Example
  --   GCS_TRANS_HRATES_DYNAMIC_PKG.Trans_RE_Subseq_Per;
  -- Notes
  --
