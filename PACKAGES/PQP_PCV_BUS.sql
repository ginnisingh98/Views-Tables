--------------------------------------------------------
--  DDL for Package PQP_PCV_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_PCV_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_configuration_value_id
--     already exists.
--
--  In Arguments:
...
TYPE column_details IS RECORD
      (end_user_column_name  fnd_descr_flex_column_usages.end_user_column_name%TYPE
      );
TYPE t_column_details IS TABLE OF column_details INDEX BY Binary_Integer;
g_column_details         t_column_details;
