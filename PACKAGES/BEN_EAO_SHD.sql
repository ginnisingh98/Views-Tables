--------------------------------------------------------
--  DDL for Package BEN_EAO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EAO_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  enrld_anthr_oipl_rt_id          number(15),
  ...
  eao_attribute_category            varchar2(30),
  eao_attribute1                    varchar2(150),
  eao_attribute2                    varchar2(150),
  eao_attribute3                    varchar2(150),
  eao_attribute4                    varchar2(150),
  eao_attribute5                    varchar2(150),
  eao_attribute6                    varchar2(150),
  eao_attribute7                    varchar2(150),
  eao_attribute8                    varchar2(150),
  eao_attribute9                    varchar2(150),
  eao_attribute10                   varchar2(150),
  eao_attribute11                   varchar2(150),
  eao_attribute12                   varchar2(150),
  eao_attribute13                   varchar2(150),
  eao_attribute14                   varchar2(150),
  eao_attribute15                   varchar2(150),
  eao_attribute16                   varchar2(150),
  eao_attribute17                   varchar2(150),
  eao_attribute18                   varchar2(150),
  eao_attribute19                   varchar2(150),
  eao_attribute20                   varchar2(150),
  eao_attribute21                   varchar2(150),
  eao_attribute22                   varchar2(150),
  eao_attribute23                   varchar2(150),
  eao_attribute24                   varchar2(150),
  eao_attribute25                   varchar2(150),
  eao_attribute26                   varchar2(150),
  eao_attribute27                   varchar2(150),
  eao_attribute28                   varchar2(150),
  eao_attribute29                   varchar2(150),
  eao_attribute30                   varchar2(150),
...
--           p_base_key_value = :enrld_anthr_oipl_rt_id).
--
-- Post Success:
--   Processing continues.
--
