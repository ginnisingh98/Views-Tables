--------------------------------------------------------
--  DDL for Package PQH_WKS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_WKS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  budget_id                         number(15),
  worksheet_name                    varchar2(240),
  version_number                    number(15),
  action_date                       date,
  date_from                         date,
  date_to                           date,
  worksheet_mode_cd                 varchar2(30),
