--------------------------------------------------------
--  DDL for Package HR_ES_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_ES_PERSON_API" AUTHID CURRENT_USER as
/* $Header: peperesi.pkh 120.1 2005/10/02 02:20:48 aroussel $ */
/*#
 * This package contains update person APIs for Spain.
 * @rep:scope public
 * @rep:product per
 * @rep:displayname Update Person for Spain
*/
--
-- ----------------------------------------------------------------------------
-- |-----------------------------< update_es_person >-------------------------|
...
-- {Start Of Comments}
/*#
 * This API updates a person record for Spain.
 *
 * The API calls the generic API update_person, with the parameters set as
 * appropriate for a Spanish employee. See the API update_person for a further
 * explanation.
 *
 * <p><b>Licensing</b><br>
 ...
 * @param p_preferred_name Preferred Name
...
procedure update_es_person
  ...
  ,p_first_last_name              in      varchar2 default hr_api.g_varchar2
  ...
  ,p_nif_value                    in      varchar2 default hr_api.g_varchar2
  ...
  ,p_second_last_name             in      varchar2 default hr_api.g_varchar2
  ,p_identifier_type              in      varchar2 default hr_api.g_varchar2
  ,p_identifier_value             in      varchar2 default hr_api.g_varchar2
  ,p_overtime_approval            in      varchar2 default hr_api.g_varchar2
