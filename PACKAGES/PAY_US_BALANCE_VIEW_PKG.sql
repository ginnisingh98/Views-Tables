--------------------------------------------------------
--  DDL for Package PAY_US_BALANCE_VIEW_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_US_BALANCE_VIEW_PKG" AUTHID CURRENT_USER AS
/* $Header: pybaluev.pkh 115.7 2004/02/17 03:44:27 sdahiya ship $ */
/* Copyright (c) Oracle Corporation 1998. All rights reserved. */
/*
--
Name           : pybaluev.pkh
Author         : A Rashid
Date Created   : 29th October 1997
Description    : US Balance Code
Date        BugNo     Author    Comment
-----------+---------+---------+--------------------------------------
06-NOV-1997           A Rashid  Created.
06-DEC-1997           B Homan updated for US 10.7
11-MAY-1998           T Battoo modified so GRE PYDATE routes work over a range
14-MAY-1998           B Homan modified debug_dump_to_trace to support p_trace_id
26-MAY-1998           B Homan addedd set_session_var and get_session_var

Version  Date         Author    Bugno   Comment
--------|------------|---------|-------|---------------------------------------
110.3    06-JUN-1999  JARTHURT          Added new SOURCE_ID context
115.4    06-11-2001   TCLEWIS           added new structure(s) gre_record_type,
                                        gre_table_type and session gre_table.
115.5    04-OCT-2002  Tclewis           Removed pragma definitions for the
                                        get_value functions.
115.7    17-FEB-2004  SDAHIYA   3331035 Deleted following sub-program declarations: -
