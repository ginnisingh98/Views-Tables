--------------------------------------------------------
--  DDL for Package PQP_VEH_ALLOC_EXTRA_INFO_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_VEH_ALLOC_EXTRA_INFO_BK1" AUTHID CURRENT_USER as
/* $Header: pqvaiapi.pkh 120.0.12010000.3 2008/08/08 07:18:36 ubhat ship $ */
--
-- ----------------------------------------------------------------------------
-- |-----------------< CREATE_VEH_ALLOC_EXTRA_INFO_b >-----------------------|
-- ----------------------------------------------------------------------------
--
procedure create_veh_alloc_extra_info_b
...
--
-- ----------------------------------------------------------------------------
-- |------------------< CREATE_VEH_ALLOC_EXTRA_INFO_a >---------------------|
-- ----------------------------------------------------------------------------
--
procedure create_veh_alloc_extra_info_a
 ( p_vehicle_allocation_id         in     number
  ,p_information_type               in     varchar2
  ,p_vaei_attribute_category        in     varchar2
  ,p_vaei_attribute1                in     varchar2
...
--
end  PQP_VEH_ALLOC_EXTRA_INFO_BK1;
