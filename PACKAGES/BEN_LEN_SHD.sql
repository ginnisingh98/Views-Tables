--------------------------------------------------------
--  DDL for Package BEN_LEN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LEN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  dys_aftr_end_to_dflt_num          number(15),
  enrt_cvg_end_dt_cd                varchar2(30),
  enrt_cvg_strt_dt_cd               varchar2(30),
  enrt_perd_strt_dt_cd              varchar2(30),
  enrt_perd_strt_dt_rl              number(15),
  enrt_perd_end_dt_cd               varchar2(30),
  enrt_perd_end_dt_rl               number(15),
  addl_procg_dys_num                number(15),
  dys_no_enrl_not_elig_num          number(15),
  dys_no_enrl_cant_enrl_num         number(15),
  ...
  len_attribute_category            varchar2(30),
  len_attribute1                    varchar2(150),
  len_attribute2                    varchar2(150),
  len_attribute3                    varchar2(150),
  len_attribute4                    varchar2(150),
  len_attribute5                    varchar2(150),
  len_attribute6                    varchar2(150),
  len_attribute7                    varchar2(150),
  len_attribute8                    varchar2(150),
  len_attribute9                    varchar2(150),
  len_attribute10                   varchar2(150),
  len_attribute11                   varchar2(150),
  len_attribute12                   varchar2(150),
  len_attribute13                   varchar2(150),
  len_attribute14                   varchar2(150),
  len_attribute15                   varchar2(150),
  len_attribute16                   varchar2(150),
  len_attribute17                   varchar2(150),
  len_attribute18                   varchar2(150),
  len_attribute19                   varchar2(150),
  len_attribute20                   varchar2(150),
  len_attribute21                   varchar2(150),
  len_attribute22                   varchar2(150),
  len_attribute23                   varchar2(150),
  len_attribute24                   varchar2(150),
  len_attribute25                   varchar2(150),
  len_attribute26                   varchar2(150),
  len_attribute27                   varchar2(150),
  len_attribute28                   varchar2(150),
  len_attribute29                   varchar2(150),
  len_attribute30                   varchar2(150),
  object_version_number             number(9) ,
  enrt_perd_det_ovrlp_bckdt_cd      varchar2(30),
  reinstate_cd				varchar2(30),
  reinstate_ovrdn_cd		varchar2(30),
  ENRT_PERD_STRT_DAYS		number(15),
  ENRT_PERD_END_DAYS		number(15),
