--------------------------------------------------------
--  DDL for Package BEN_CTK_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CTK_SHD" AUTHID CURRENT_USER as
/* $Header: bectkrhi.pkh 120.0 2005/05/28 01:25:32 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  ...
  ,task_last_update_date           date
  ,task_last_update_by             number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_CWB_PERSON_TASKS';
