--------------------------------------------------------
--  DDL for Package BEN_ETC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ETC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_ttl_cvg_vol_prte_id          number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  excld_flag                        varchar2(30),
  no_mn_cvg_vol_amt_apls_flag       varchar2(30),
  no_mx_cvg_vol_amt_apls_flag       varchar2(30),
  ordr_num                          number(15),
  mn_cvg_vol_amt                    number,
  mx_cvg_vol_amt                    number,
  cvg_vol_det_cd                    varchar2(30),
  cvg_vol_det_rl                    number(15),
  eligy_prfl_id                     number(15),
  etc_attribute_category            varchar2(30),
  etc_attribute1                    varchar2(150),
  etc_attribute2                    varchar2(150),
  etc_attribute3                    varchar2(150),
  etc_attribute4                    varchar2(150),
  etc_attribute5                    varchar2(150),
  etc_attribute6                    varchar2(150),
  etc_attribute7                    varchar2(150),
  etc_attribute8                    varchar2(150),
  etc_attribute9                    varchar2(150),
  etc_attribute10                   varchar2(150),
  etc_attribute11                   varchar2(150),
  etc_attribute12                   varchar2(150),
  etc_attribute13                   varchar2(150),
  etc_attribute14                   varchar2(150),
  etc_attribute15                   varchar2(150),
  etc_attribute16                   varchar2(150),
  etc_attribute17                   varchar2(150),
  etc_attribute18                   varchar2(150),
  etc_attribute19                   varchar2(150),
  etc_attribute20                   varchar2(150),
  etc_attribute21                   varchar2(150),
  etc_attribute22                   varchar2(150),
  etc_attribute23                   varchar2(150),
  etc_attribute24                   varchar2(150),
  etc_attribute25                   varchar2(150),
  etc_attribute26                   varchar2(150),
  etc_attribute27                   varchar2(150),
  etc_attribute28                   varchar2(150),
  etc_attribute29                   varchar2(150),
  etc_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_ttl_cvg_vol_prte_id).
--
-- Post Success:
--   Processing continues.
--
