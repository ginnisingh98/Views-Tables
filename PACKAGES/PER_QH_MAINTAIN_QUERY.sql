--------------------------------------------------------
--  DDL for Package PER_QH_MAINTAIN_QUERY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_QH_MAINTAIN_QUERY" AUTHID CURRENT_USER as
/* $Header: peqhmntq.pkh 120.2 2006/08/22 11:26:59 rvarshne noship $ */
...
,per_validation_start_date     date
,per_validation_end_date       date
...
,pdp_object_version_number     per_periods_of_placement.object_version_number%type
...
,grade_rule_id                 pay_grade_rules_f.grade_rule_id%TYPE
,rate_id                       pay_grade_rules_f.rate_id%TYPE
,rate_name                     pay_rates.name%TYPE
,rate_basis                    pay_rates.rate_basis%TYPE
,asg_rate_type_name            fnd_lookups.meaning%TYPE
,rate_currency                 fnd_currencies_vl.name%TYPE
,rate_currency_code            pay_grade_rules_f.currency_code%TYPE
,rate_value                    pay_grade_rules_f.value%TYPE
,rate_effective_start_date     pay_grade_rules_f.effective_start_date%TYPE
,rate_effective_end_date       pay_grade_rules_f.effective_end_date%TYPE
,rate_object_version_number    pay_grade_rules_f.object_version_number%TYPE
--
...
,expnse_check_send_to_address  per_all_people_f.expense_check_send_to_address%type
...
,registered_disabled           per_all_people_f.registered_disabled_flag%type
...
,asg_validation_start_date     date
,asg_validation_end_date       date
...
,notice_unit                   per_all_assignments_f.notice_period_uom%type
--
,set_of_books_id               per_all_assignments_f.set_of_books_id%type
,set_of_books_name             gl_sets_of_books.name%type
,gl_keyflex_struct             gl_sets_of_books.chart_of_accounts_id%type
,billing_title                 per_all_assignments_f.title%type
--
...
,work_at_home                  per_all_assignments_f.work_at_home%type default null
...
,app_object_version_number     per_applications.object_version_number%type
,adjusted_svc_date             per_periods_of_service.adjusted_svc_date%type
,employment_end_date           per_periods_of_service.final_process_date%type
...
,pds_object_version_number     per_periods_of_service.object_version_number%type
,address_id                    per_addresses.address_id%type
,adr_date_from                 per_addresses.date_from%type
,addr_primary_flag             per_addresses.primary_flag%type
...
,addr_object_version_number    per_addresses.object_version_number%type
,phn_h_phone_id                per_phones.phone_id%type
...
,phn_h_object_version_number   per_phones.object_version_number%type
,phn_w_phone_id                per_phones.phone_id%type
...
,phn_w_object_version_number   per_phones.object_version_number%type
,phn_m_phone_id                per_phones.phone_id%type
...
,phn_m_object_version_number   per_phones.object_version_number%type
,phn_hf_phone_id               per_phones.phone_id%type
...
,phn_hf_object_version_number  per_phones.object_version_number%type
,phn_wf_phone_id               per_phones.phone_id%type
...
,phn_wf_object_version_number  per_phones.object_version_number%type
,pay_proposal_id               per_pay_proposals.pay_proposal_id%type
...
,pyp_object_version_number     per_pay_proposals.object_version_number%type
,multiple_components           per_pay_proposals.multiple_components%type
,approved                      per_pay_proposals.approved%type
,deployment_factor_id          per_deployment_factors.deployment_factor_id%type
...
,country1                      per_deployment_factors.country1%type
,country2_meaning              fnd_territories_vl.territory_short_name%type
,country2                      per_deployment_factors.country2%type
,country3_meaning              fnd_territories_vl.territory_short_name%type
,country3                      fnd_territories_vl.territory_code%type
,dpf_work_duration_meaning     hr_lookups.meaning%type
,dpf_work_duration             per_deployment_factors.work_duration%type
,dpf_work_schedule_meaning     hr_lookups.meaning%type
,dpf_work_schedule             per_deployment_factors.work_schedule%type
,dpf_work_hours_meaning        hr_lookups.meaning%type
,dpf_work_hours                per_deployment_factors.work_hours%type
,dpf_fte_capacity_meaning      hr_lookups.meaning%type
,dpf_fte_capacity              per_deployment_factors.fte_capacity%type
...
,no_country1                   per_deployment_factors.no_country1%type
,no_country2_meaning           fnd_territories_vl.territory_short_name%type
,no_country2                   per_deployment_factors.no_country2%type
,no_country3_meaning           fnd_territories_vl.territory_short_name%type
,no_country3                   per_deployment_factors.no_country3%type
...
,dpf_object_version_number     per_deployment_factors.object_version_number%type
...
,supervisor_assignment_id      per_assignments_v.supervisor_assignment_id%TYPE
,supervisor_assignment_number  per_assignments_v.supervisor_assignment_number%TYPE
,location_address              varchar2(600)
);
