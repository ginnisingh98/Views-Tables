--------------------------------------------------------
--  DDL for Package PER_JGR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_JGR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,displayed_name                  varchar2(30)
  ,id_flex_num                     number(15)
  ,master_flag                     varchar2(9)       -- Increased length
