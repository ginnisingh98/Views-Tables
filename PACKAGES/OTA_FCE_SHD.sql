--------------------------------------------------------
--  DDL for Package OTA_FCE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_FCE_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_OPEN_FC_ENROLLMENTS';
