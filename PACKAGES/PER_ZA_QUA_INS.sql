--------------------------------------------------------
--  DDL for Package PER_ZA_QUA_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_QUA_INS" AUTHID CURRENT_USER as
/* $Header: pezaquin.pkh 115.1 2002/12/05 06:51:18 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< ins >----------------------------------|
-- ----------------------------------------------------------------------------
