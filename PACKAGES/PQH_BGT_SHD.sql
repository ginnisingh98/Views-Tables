--------------------------------------------------------
--  DDL for Package PQH_BGT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_BGT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  budgeted_entity_cd                varchar2(30),
  budget_style_cd                   varchar2(30),
  budget_name                       varchar2(30),
  period_set_name                   varchar2(30),
  budget_start_date                 date,
  budget_end_date                   date,
  gl_budget_name                    gl_budgets.budget_name%type,
  psb_budget_flag                   varchar2(30),
  transfer_to_gl_flag               varchar2(30),
  transfer_to_grants_flag           varchar2(30),
  status                            varchar2(30),
  object_version_number             number(9),
  budget_unit1_id                   number(15),
  budget_unit2_id                   number(15),
  budget_unit3_id                   number(15),
  gl_set_of_books_id                number(15),
  budget_unit1_aggregate            varchar2(30),
  budget_unit2_aggregate            varchar2(30),
  budget_unit3_aggregate            varchar2(30),
  position_control_flag             varchar2(30),
  valid_grade_reqd_flag             varchar2(15),
