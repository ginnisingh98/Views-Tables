--------------------------------------------------------
--  DDL for Package CHV_ORG_OPTIONS_PKG_S2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CHV_ORG_OPTIONS_PKG_S2" AUTHID CURRENT_USER as
/* $Header: CHVSEO2S.pls 115.0 99/07/17 01:30:53 porting ship $ */

/*===========================================================================
  PROCEDURE NAME:	Lock_row()

  DESCRIPTION:		Table Handler to Lock the Organization Options
