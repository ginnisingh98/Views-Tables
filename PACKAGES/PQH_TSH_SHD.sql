--------------------------------------------------------
--  DDL for Package PQH_TSH_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TSH_SHD" AUTHID CURRENT_USER as
/* $Header: pqtshrhi.pkh 120.1 2005/09/30 06:13:33 hpandya noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  ...
  ,approval_history_id             number(9)         -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_SS_TRANS_STATE_HISTORY';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
