--------------------------------------------------------
--  DDL for Package OKC_ASSENT_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_ASSENT_PVT" AUTHID CURRENT_USER AS
/* $Header: OKCCASTS.pls 120.0 2005/05/25 18:24:28 appldev noship $ */

 subtype astv_rec_type is okc_ast_pvt.astv_rec_type;
 subtype astv_tbl_type is okc_ast_pvt.astv_tbl_type;
 subtype stsv_rec_type is okc_sts_pvt.stsv_rec_type;
 subtype stsv_tbl_type is okc_sts_pvt.stsv_tbl_type;
 ...
 -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME			CONSTANT VARCHAR2(200) := 'OKC_ASSENT_PVT';
