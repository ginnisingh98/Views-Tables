--------------------------------------------------------
--  DDL for Package HR_WNP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_WNP_SHD" AUTHID CURRENT_USER as
/* $Header: hrwnprhi.pkh 120.0 2005/05/31 03:51:23 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (window_property_id              number(15)
  ,form_window_id                  number(15)
  ,template_window_id              number(15)
  ,height                          number(12,2)
  ,width                           number(12,2)
