--------------------------------------------------------
--  DDL for Package PAY_CAL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CAL_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_COST_ALLOCATIONS_F';
...
--           p_base_key_value = :cost_allocation_id).
--
-- Post Success:
--   Processing continues.
--
