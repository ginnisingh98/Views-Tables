--------------------------------------------------------
--  DDL for Package HR_CAU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_CAU_INS" AUTHID CURRENT_USER as
...
Procedure ins
  ...
  p_calendar_usage_id            out nocopy number,
  p_primary_key_value            in number,
  p_purpose_usage_id             in number,
  p_start_date                   in date,
  p_end_date                     in date default hr_general.end_of_time,
