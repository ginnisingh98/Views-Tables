--------------------------------------------------------
--  DDL for Package IEX_CASES_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IEX_CASES_PVT" AUTHID CURRENT_USER as
/* $Header: iexvcass.pls 120.0 2004/01/24 03:24:49 appldev noship $ */
-- Start of Comments
...
TYPE  cas_Tbl_Type      IS TABLE OF cas_Rec_Type
...
--       P_cas_Rec                 IN case_object_Rec_Type  Required
...
--       p_commit                  IN   VARCHAR2   Optional  Default = FND_API.G_FALSE
--       p_validation_level        IN   NUMBER     Optional  Default = FND_API.G_VALID_LEVEL_FULL
--       P_CAS_Rec                 IN CAS_Rec_Type  Required
--   OUT:
--       x_return_status           OUT NOCOPY  VARCHAR2
--       x_msg_count               OUT NOCOPY  NUMBER
--       x_msg_data                OUT NOCOPY  VARCHAR2
