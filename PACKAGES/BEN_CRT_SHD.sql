--------------------------------------------------------
--  DDL for Package BEN_CRT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CRT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  crt_ordr_id                       number(15),
  crt_ordr_typ_cd                   varchar2(30),
  apls_perd_endg_dt                 date,
  apls_perd_strtg_dt                date,
  crt_ident                         varchar2(90),-- UTF8 Change Bug 2254683
  description                       varchar2(600), -- UTF8 Change Bug 2254683
  detd_qlfd_ordr_dt                 date,
  issue_dt                          date,
  qdro_amt                          number,
  qdro_dstr_mthd_cd                 varchar2(30),
  qdro_pct                          number(15),
  rcvd_dt                           date,
  uom                               varchar2(30),
  crt_issng                         varchar2(180),-- UTF8 Change Bug 2254683
  pl_id                             number(15),
  person_id                         number(15),
  business_group_id                 number(15),
  crt_attribute_category            varchar2(30),
  crt_attribute1                    varchar2(150),
  crt_attribute2                    varchar2(150),
  crt_attribute3                    varchar2(150),
  crt_attribute4                    varchar2(150),
  crt_attribute5                    varchar2(150),
  crt_attribute6                    varchar2(150),
  crt_attribute7                    varchar2(150),
  crt_attribute8                    varchar2(150),
  crt_attribute9                    varchar2(150),
  crt_attribute10                   varchar2(150),
  crt_attribute11                   varchar2(150),
  crt_attribute12                   varchar2(150),
  crt_attribute13                   varchar2(150),
  crt_attribute14                   varchar2(150),
  crt_attribute15                   varchar2(150),
  crt_attribute16                   varchar2(150),
  crt_attribute17                   varchar2(150),
  crt_attribute18                   varchar2(150),
  crt_attribute19                   varchar2(150),
  crt_attribute20                   varchar2(150),
  crt_attribute21                   varchar2(150),
  crt_attribute22                   varchar2(150),
  crt_attribute23                   varchar2(150),
  crt_attribute24                   varchar2(150),
  crt_attribute25                   varchar2(150),
  crt_attribute26                   varchar2(150),
  crt_attribute27                   varchar2(150),
  crt_attribute28                   varchar2(150),
  crt_attribute29                   varchar2(150),
  crt_attribute30                   varchar2(150),
  object_version_number             number(9),
  qdro_num_pymt_val                 number(15),
  qdro_per_perd_cd                  varchar2(30),
  pl_typ_id                         number(15)
  );
--
-- ----------------------------------------------------------------------------
