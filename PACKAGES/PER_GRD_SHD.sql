--------------------------------------------------------
--  DDL for Package PER_GRD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_GRD_SHD" AUTHID CURRENT_USER as
/* $Header: pegrdrhi.pkh 120.0 2005/05/31 09:31:46 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_GRADES';
