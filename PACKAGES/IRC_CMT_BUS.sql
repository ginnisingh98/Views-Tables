--------------------------------------------------------
--  DDL for Package IRC_CMT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_CMT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_communication_topic_id
--     already exists.
--
--  In Arguments:
