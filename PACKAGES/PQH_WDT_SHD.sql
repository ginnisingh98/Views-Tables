--------------------------------------------------------
--  DDL for Package PQH_WDT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_WDT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  parent_worksheet_detail_id        number(15),
  user_id                           number(15),
  action_cd                         varchar2(30),
  budget_unit1_percent              number(15,2),
  budget_unit1_value                number,
  budget_unit2_percent              number(15,2),
  budget_unit2_value                number,
  budget_unit3_percent              number(15,2),
  budget_unit3_value                number,
  object_version_number             number(9),
  budget_unit1_value_type_cd        varchar2(30),
  budget_unit2_value_type_cd        varchar2(30),
  budget_unit3_value_type_cd        varchar2(30),
  status                            varchar2(10),
  budget_unit1_available            number,
  budget_unit2_available            number,
  budget_unit3_available            number,
  old_unit1_value                   number,
  old_unit2_value                   number,
  old_unit3_value                   number,
  defer_flag                        varchar2(10),
  propagation_method                varchar2(9)
  );
--
-- ----------------------------------------------------------------------------
