--------------------------------------------------------
--  DDL for Package OE_CNCL_VALIDATE_ADJ
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_CNCL_VALIDATE_ADJ" AUTHID CURRENT_USER AS
/* $Header: OEXVCADS.pls 120.0 2005/06/01 02:29:20 appldev noship $ */
