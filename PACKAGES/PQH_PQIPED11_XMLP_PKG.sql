--------------------------------------------------------
--  DDL for Package PQH_PQIPED11_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_PQIPED11_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: PQIPED11S.pls 120.1 2007/12/21 17:26:23 vjaganat noship $ */
	...
	totTitle	varchar2(52) := 'Total Part-Time Employees (sum of lines 1-9)' ;
