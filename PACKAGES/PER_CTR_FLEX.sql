--------------------------------------------------------
--  DDL for Package PER_CTR_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CTR_FLEX" AUTHID CURRENT_USER as
/* $Header: pectrfli.pkh 115.0 99/07/17 18:53:08 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
