--------------------------------------------------------
--  DDL for Package BEN_PPR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PPR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  prmry_care_prvdr_id               number(15),
  effective_start_date              date,
  effective_end_date                date,
  prmry_care_prvdr_typ_cd           varchar2(30),
  name                              varchar2(240),
  ext_ident                         varchar2(90),
  prtt_enrt_rslt_id                 number(15),
  elig_cvrd_dpnt_id                 number(15),
  business_group_id                 number(15),
  ppr_attribute_category            varchar2(30),
  ppr_attribute1                    varchar2(150),
  ppr_attribute2                    varchar2(150),
  ppr_attribute3                    varchar2(150),
  ppr_attribute4                    varchar2(150),
  ppr_attribute5                    varchar2(150),
  ppr_attribute6                    varchar2(150),
  ppr_attribute7                    varchar2(150),
  ppr_attribute8                    varchar2(150),
  ppr_attribute9                    varchar2(150),
  ppr_attribute10                   varchar2(150),
  ppr_attribute11                   varchar2(150),
  ppr_attribute12                   varchar2(150),
  ppr_attribute13                   varchar2(150),
  ppr_attribute14                   varchar2(150),
  ppr_attribute15                   varchar2(150),
  ppr_attribute16                   varchar2(150),
  ppr_attribute17                   varchar2(150),
  ppr_attribute18                   varchar2(150),
  ppr_attribute19                   varchar2(150),
  ppr_attribute20                   varchar2(150),
  ppr_attribute21                   varchar2(150),
  ppr_attribute22                   varchar2(150),
  ppr_attribute23                   varchar2(150),
  ppr_attribute24                   varchar2(150),
  ppr_attribute25                   varchar2(150),
  ppr_attribute26                   varchar2(150),
  ppr_attribute27                   varchar2(150),
  ppr_attribute28                   varchar2(150),
  ppr_attribute29                   varchar2(150),
  ppr_attribute30                   varchar2(150),
...
--           p_base_key_value = :prmry_care_prvdr_id).
--
-- Post Success:
--   Processing continues.
--
