--------------------------------------------------------
--  DDL for Package BEN_CPG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CPG_SHD" AUTHID CURRENT_USER as
/* $Header: becpgrhi.pkh 120.0 2005/05/28 01:13:20 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  ...
  ,lf_evt_ocrd_dt                  date
  ,bdgt_pop_cd                     varchar2(30)
  ,due_dt                          date
  ,access_cd                       varchar2(30)
  ,approval_cd                     varchar2(30)
  ,approval_date                   date
  ,approval_comments               varchar2(2000)
  ,submit_cd                       varchar2(30)
  ,submit_date                     date
  ,submit_comments                 varchar2(2000)
  ,dist_bdgt_val                   number
  ,ws_bdgt_val                     number
  ,rsrv_val                        number
  ,dist_bdgt_mn_val                number
  ,dist_bdgt_mx_val                number
  ,dist_bdgt_incr_val              number
  ,ws_bdgt_mn_val                  number
  ,ws_bdgt_mx_val                  number
  ,ws_bdgt_incr_val                number
  ,rsrv_mn_val                     number
  ,rsrv_mx_val                     number
  ,rsrv_incr_val                   number
  ,dist_bdgt_iss_val               number
  ,ws_bdgt_iss_val                 number
  ,dist_bdgt_iss_date              date
  ,ws_bdgt_iss_date                date
  ,ws_bdgt_val_last_upd_date       date
  ,dist_bdgt_val_last_upd_date     date
  ,rsrv_val_last_upd_date          date
  ,ws_bdgt_val_last_upd_by         number(15)
  ,dist_bdgt_val_last_upd_by       number(15)
  ,rsrv_val_last_upd_by            number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_CWB_PERSON_GROUPS';
