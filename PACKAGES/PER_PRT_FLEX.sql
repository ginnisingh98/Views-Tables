--------------------------------------------------------
--  DDL for Package PER_PRT_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PRT_FLEX" AUTHID CURRENT_USER as
/* $Header: peprtfli.pkh 115.1 99/07/18 14:29:28 porting ship $ */
--
--
-------------------------------------------------------------------------------
-- |-------------------------------< df>-------------------------------------|
