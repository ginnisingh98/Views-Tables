--------------------------------------------------------
--  DDL for Package PFT_PROFITAGG_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PFT_PROFITAGG_PUB" AUTHID CURRENT_USER AS
/* $Header: pftpaggs.pls 120.4 2006/05/25 09:32:12 ssthiaga noship $ */

-------------------------------------------
--  Package Constants
---------------------------------------------
  G_BLOCK                CONSTANT VARCHAR2(80) := 'FEM.PLSQL.PFT_PROFITAGG_PUB';
...
--------Message Constants--------------
   ...
   G_ENG_PAG_NO_OP_ROWS_ERR      CONSTANT  VARCHAR2(30) := 'PFT_PPROF_PAG_NO_OP_ROWS_ERR';
   ...
   G_ENG_GEN_CPOP_AGG_AGG_ERR    CONSTANT  VARCHAR2(30) := 'PFT_PPROF_GEN_CPOP_AGG_AGG_ERR';
...
---------------------------------------------
  ...
  TYPE param_record IS RECORD (
    ...
    ,output_currency_code          currency_code%TYPE
 ...
 |    relationship data by placing the results in fem_customer_profit table
 |
 | scope - public
 |
 +============================================================================*/
