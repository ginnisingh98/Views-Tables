--------------------------------------------------------
--  DDL for Package BEN_DEC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DEC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dsgntr_enrld_cvg_id               number(15),
  effective_start_date              date,
  effective_end_date                date,
  dsgntr_crntly_enrld_flag          varchar2(30),
  dpnt_cvg_eligy_prfl_id            number(15),
  business_group_id                 number(15),
  dec_attribute_category            varchar2(30),
  dec_attribute1                    varchar2(150),
  dec_attribute2                    varchar2(150),
  dec_attribute3                    varchar2(150),
  dec_attribute4                    varchar2(150),
  dec_attribute5                    varchar2(150),
  dec_attribute6                    varchar2(150),
  dec_attribute7                    varchar2(150),
  dec_attribute8                    varchar2(150),
  dec_attribute9                    varchar2(150),
  dec_attribute10                   varchar2(150),
  dec_attribute11                   varchar2(150),
  dec_attribute12                   varchar2(150),
  dec_attribute13                   varchar2(150),
  dec_attribute14                   varchar2(150),
  dec_attribute15                   varchar2(150),
  dec_attribute16                   varchar2(150),
  dec_attribute17                   varchar2(150),
  dec_attribute18                   varchar2(150),
  dec_attribute19                   varchar2(150),
  dec_attribute20                   varchar2(150),
  dec_attribute21                   varchar2(150),
  dec_attribute22                   varchar2(150),
  dec_attribute23                   varchar2(150),
  dec_attribute24                   varchar2(150),
  dec_attribute25                   varchar2(150),
  dec_attribute26                   varchar2(150),
  dec_attribute27                   varchar2(150),
  dec_attribute28                   varchar2(150),
  dec_attribute29                   varchar2(150),
  dec_attribute30                   varchar2(150),
...
--           p_base_key_value = :dsgntr_enrld_cvg_id).
--
-- Post Success:
--   Processing continues.
--
