--------------------------------------------------------
--  DDL for Package BEN_PSQ_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PSQ_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  pymt_sched_py_freq_id             number(15),
  py_freq_cd                        varchar2(30),
  dflt_flag                         varchar2(30),
  business_group_id                 number(15),
  acty_rt_pymt_sched_id             number(15),
  psq_attribute_category            varchar2(30),
  psq_attribute1                    varchar2(150),
  psq_attribute2                    varchar2(150),
  psq_attribute3                    varchar2(150),
  psq_attribute4                    varchar2(150),
  psq_attribute5                    varchar2(150),
  psq_attribute6                    varchar2(150),
  psq_attribute7                    varchar2(150),
  psq_attribute8                    varchar2(150),
  psq_attribute9                    varchar2(150),
  psq_attribute10                   varchar2(150),
  psq_attribute11                   varchar2(150),
  psq_attribute12                   varchar2(150),
  psq_attribute13                   varchar2(150),
  psq_attribute14                   varchar2(150),
  psq_attribute15                   varchar2(150),
  psq_attribute16                   varchar2(150),
  psq_attribute17                   varchar2(150),
  psq_attribute18                   varchar2(150),
  psq_attribute19                   varchar2(150),
  psq_attribute20                   varchar2(150),
  psq_attribute21                   varchar2(150),
  psq_attribute22                   varchar2(150),
  psq_attribute23                   varchar2(150),
  psq_attribute24                   varchar2(150),
  psq_attribute25                   varchar2(150),
  psq_attribute26                   varchar2(150),
  psq_attribute27                   varchar2(150),
  psq_attribute28                   varchar2(150),
  psq_attribute29                   varchar2(150),
  psq_attribute30                   varchar2(150),
