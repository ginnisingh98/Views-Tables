--------------------------------------------------------
--  DDL for Package HR_ASSIGNMENT_BK8
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_ASSIGNMENT_BK8" AUTHID CURRENT_USER as
/* $Header: peasgapi.pkh 120.11.12010000.4 2009/07/28 10:08:56 ghshanka ship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------< create_secondary_apl_asg_b >----------------------|
-- ----------------------------------------------------------------------------
--
...
-- Bug 944911
-- Amended concatenated_segments to concat_segments
...
procedure create_secondary_apl_asg_a
  ...
  ,p_scl_segment29                in     varchar2
  ,p_scl_segment30                in     varchar2
-- Amended scl_concatendated_segments to concatenated_segments
