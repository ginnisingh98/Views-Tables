--------------------------------------------------------
--  DDL for Package BEN_PLN_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PLN_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_pl_id already exists.
--
--  In Arguments:
--    p_pl_id
--
...
function return_legislation_code
  ...
  (p_pl_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
...
-- |---------------------------< chk_pl_group_id >----------------------------|
-- ----------------------------------------------------------------------------
-- The call to this procedure is moved from insert_validate to pre_insert
-- Bug : 3460429
