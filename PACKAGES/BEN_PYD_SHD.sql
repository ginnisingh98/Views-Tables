--------------------------------------------------------
--  DDL for Package BEN_PYD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PYD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ptip_dpnt_cvg_ctfn_id             number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  ptip_id                           number(15),
  pfd_flag                          varchar2(9),      -- Increased length
  lack_ctfn_sspnd_enrt_flag         varchar2(9),      -- Increased length
  ctfn_rqd_when_rl                  number(15),
  dpnt_cvg_ctfn_typ_cd              varchar2(30),
  rlshp_typ_cd                      varchar2(30),
  rqd_flag                          varchar2(30),
  pyd_attribute_category            varchar2(30),
  pyd_attribute1                    varchar2(150),
  pyd_attribute2                    varchar2(150),
  pyd_attribute3                    varchar2(150),
  pyd_attribute4                    varchar2(150),
  pyd_attribute5                    varchar2(150),
  pyd_attribute6                    varchar2(150),
  pyd_attribute7                    varchar2(150),
  pyd_attribute8                    varchar2(150),
  pyd_attribute9                    varchar2(150),
  pyd_attribute10                   varchar2(150),
  pyd_attribute11                   varchar2(150),
  pyd_attribute12                   varchar2(150),
  pyd_attribute13                   varchar2(150),
  pyd_attribute14                   varchar2(150),
  pyd_attribute15                   varchar2(150),
  pyd_attribute16                   varchar2(150),
  pyd_attribute17                   varchar2(150),
  pyd_attribute18                   varchar2(150),
  pyd_attribute19                   varchar2(150),
  pyd_attribute20                   varchar2(150),
  pyd_attribute21                   varchar2(150),
  pyd_attribute22                   varchar2(150),
  pyd_attribute23                   varchar2(150),
  pyd_attribute24                   varchar2(150),
  pyd_attribute25                   varchar2(150),
  pyd_attribute26                   varchar2(150),
  pyd_attribute27                   varchar2(150),
  pyd_attribute28                   varchar2(150),
  pyd_attribute29                   varchar2(150),
  pyd_attribute30                   varchar2(150),
...
--           p_base_key_value = :ptip_dpnt_cvg_ctfn_id).
--
-- Post Success:
--   Processing continues.
--
