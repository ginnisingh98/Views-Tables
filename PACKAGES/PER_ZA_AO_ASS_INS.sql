--------------------------------------------------------
--  DDL for Package PER_ZA_AO_ASS_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_AO_ASS_INS" AUTHID CURRENT_USER as
/* $Header: pezaaain.pkh 115.1 2002/12/05 06:48:33 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< ins >----------------------------------|
-- ----------------------------------------------------------------------------
