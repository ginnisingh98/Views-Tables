--------------------------------------------------------
--  DDL for Package OTA_TMT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TMT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_tp_measurement_type_id
--     already exists.
--
--  In Arguments:
