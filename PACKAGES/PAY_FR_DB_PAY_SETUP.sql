--------------------------------------------------------
--  DDL for Package PAY_FR_DB_PAY_SETUP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_FR_DB_PAY_SETUP" AUTHID CURRENT_USER as
/* $Header: pyfrsetp.pkh 120.0 2005/05/29 05:09:41 appldev noship $ */
--
/*
   ...
   ******************************************************************
   ...
   10-JUL-2003 Scchakra     115.10  1253330   Defaulted p_rule_type to 'DC' in
                                              get_default_currency.
   30-JUL-2003 ASNELL       115.3             Recloned from pypsetup.pkh to
                                              keep in step
                                                                              */
--.
 -------------------------------- create element -----------------------------
