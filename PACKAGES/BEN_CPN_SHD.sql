--------------------------------------------------------
--  DDL for Package BEN_CPN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CPN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  cntng_prtn_prfl_rt_id           number(15),
  ...
  cpn_attribute_category            varchar2(30),
  cpn_attribute1                    varchar2(150),
  cpn_attribute2                    varchar2(150),
  cpn_attribute3                    varchar2(150),
  cpn_attribute4                    varchar2(150),
  cpn_attribute5                    varchar2(150),
  cpn_attribute6                    varchar2(150),
  cpn_attribute7                    varchar2(150),
  cpn_attribute8                    varchar2(150),
  cpn_attribute9                    varchar2(150),
  cpn_attribute10                   varchar2(150),
  cpn_attribute11                   varchar2(150),
  cpn_attribute12                   varchar2(150),
  cpn_attribute13                   varchar2(150),
  cpn_attribute14                   varchar2(150),
  cpn_attribute15                   varchar2(150),
  cpn_attribute16                   varchar2(150),
  cpn_attribute17                   varchar2(150),
  cpn_attribute18                   varchar2(150),
  cpn_attribute19                   varchar2(150),
  cpn_attribute20                   varchar2(150),
  cpn_attribute21                   varchar2(150),
  cpn_attribute22                   varchar2(150),
  cpn_attribute23                   varchar2(150),
  cpn_attribute24                   varchar2(150),
  cpn_attribute25                   varchar2(150),
  cpn_attribute26                   varchar2(150),
  cpn_attribute27                   varchar2(150),
  cpn_attribute28                   varchar2(150),
  cpn_attribute29                   varchar2(150),
  cpn_attribute30                   varchar2(150),
...
--           p_base_key_value = :cntng_prtn_prfl_rt_id).
--
-- Post Success:
--   Processing continues.
--
