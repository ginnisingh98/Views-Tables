--------------------------------------------------------
--  DDL for Package PAY_CA_EOY_ARCHIVE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CA_EOY_ARCHIVE" AUTHID CURRENT_USER as
/* $Header: pycayear.pkh 120.0.12010000.1 2008/07/27 22:19:13 appldev ship $ */
--
/*
/*
   ******************************************************************
...
row in this table for T4 archiver is like:
 ...
 RANGE_CODE             : pay_ca_eoy_archive.eoy_range_cursor
 ASSIGNMENT_ACTION_CODE : pay_ca_eoy_archive.eoy_action_creation
 INITIALIZATION_CODE    : pay_ca_eoy_archive.eoy_archinit
 ARCHIVE_CODE           : pay_ca_eoy_archive.eoy_archive_data
 MAGNETIC_CODE          : NULL
 ...
 UPDATABLE_FLAG         : NULL
   ...
   13-NOV-2001  pganguly    115.1           Added set verify off
   13-NOV-2001  pganguly    115.2           Added commit at the end.
   14-NOV-2001  pganguly    115.3           Added dbdrv and oserror.
   08-feb-2002  ssattini    115.4           Added checkfile
   02-DEC-2002  pganguly    115.5           Added nocopy.
