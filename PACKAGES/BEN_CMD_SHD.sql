--------------------------------------------------------
--  DDL for Package BEN_CMD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CMD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  cm_dlvry_med_typ_id               number(15),
  cm_dlvry_med_typ_cd               varchar2(30),
  cm_dlvry_mthd_typ_id              number,
  rqd_flag                          varchar2(30),
  dflt_flag                         varchar2(30),
  business_group_id                 number(15),
  cmd_attribute_category            varchar2(30),
  cmd_attribute1                    varchar2(150),
  cmd_attribute2                    varchar2(150),
  cmd_attribute3                    varchar2(150),
  cmd_attribute4                    varchar2(150),
  cmd_attribute5                    varchar2(150),
  cmd_attribute6                    varchar2(150),
  cmd_attribute7                    varchar2(150),
  cmd_attribute8                    varchar2(150),
  cmd_attribute9                    varchar2(150),
  cmd_attribute10                   varchar2(150),
  cmd_attribute11                   varchar2(150),
  cmd_attribute12                   varchar2(150),
  cmd_attribute13                   varchar2(150),
  cmd_attribute14                   varchar2(150),
  cmd_attribute15                   varchar2(150),
  cmd_attribute16                   varchar2(150),
  cmd_attribute17                   varchar2(150),
  cmd_attribute18                   varchar2(150),
  cmd_attribute19                   varchar2(150),
  cmd_attribute20                   varchar2(150),
  cmd_attribute21                   varchar2(150),
  cmd_attribute22                   varchar2(150),
  cmd_attribute23                   varchar2(150),
  cmd_attribute24                   varchar2(150),
  cmd_attribute25                   varchar2(150),
  cmd_attribute26                   varchar2(150),
  cmd_attribute27                   varchar2(150),
  cmd_attribute28                   varchar2(150),
  cmd_attribute29                   varchar2(150),
  cmd_attribute30                   varchar2(150),
