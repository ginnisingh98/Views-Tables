--------------------------------------------------------
--  DDL for Package BEN_ENP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ENP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_enrt_perd_id already exists.
--
--  In Arguments:
--    p_enrt_perd_id
--
...
function return_legislation_code
  (p_enrt_perd_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
