--------------------------------------------------------
--  DDL for Package FTP_BR_TP_PROCESS_RULE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FTP_BR_TP_PROCESS_RULE_PVT" AUTHID CURRENT_USER AS
/* $Header: ftpbtprs.pls 120.0 2005/06/06 19:03:07 appldev noship $ */
