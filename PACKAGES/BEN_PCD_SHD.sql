--------------------------------------------------------
--  DDL for Package BEN_PCD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PCD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  per_cm_prvdd_id                   number(15),
  effective_start_date              date,
  effective_end_date                date,
  rqstd_flag                        varchar2(30),
  per_cm_prvdd_stat_cd              varchar2(30),
  cm_dlvry_med_cd                   varchar2(30),
  cm_dlvry_mthd_cd                  varchar2(30),
  sent_dt                           date,
  instnc_num                        number(15),
  to_be_sent_dt                     date,
  dlvry_instn_txt                   varchar2(250),
  inspn_rqd_flag                    varchar2(30),
  resnd_rsn_cd                      varchar2(30),
  resnd_cmnt_txt                    varchar2(240),
  per_cm_id                         number(15),
  address_id                        number(15),
  business_group_id                 number(15),
  pcd_attribute_category            varchar2(30),
  pcd_attribute1                    varchar2(150),
  pcd_attribute2                    varchar2(150),
  pcd_attribute3                    varchar2(150),
  pcd_attribute4                    varchar2(150),
  pcd_attribute5                    varchar2(150),
  pcd_attribute6                    varchar2(150),
  pcd_attribute7                    varchar2(150),
  pcd_attribute8                    varchar2(150),
  pcd_attribute9                    varchar2(150),
  pcd_attribute10                   varchar2(150),
  pcd_attribute11                   varchar2(150),
  pcd_attribute12                   varchar2(150),
  pcd_attribute13                   varchar2(150),
  pcd_attribute14                   varchar2(150),
  pcd_attribute15                   varchar2(150),
  pcd_attribute16                   varchar2(150),
  pcd_attribute17                   varchar2(150),
  pcd_attribute18                   varchar2(150),
  pcd_attribute19                   varchar2(150),
  pcd_attribute20                   varchar2(150),
  pcd_attribute21                   varchar2(150),
  pcd_attribute22                   varchar2(150),
  pcd_attribute23                   varchar2(150),
  pcd_attribute24                   varchar2(150),
  pcd_attribute25                   varchar2(150),
  pcd_attribute26                   varchar2(150),
  pcd_attribute27                   varchar2(150),
  pcd_attribute28                   varchar2(150),
  pcd_attribute29                   varchar2(150),
  pcd_attribute30                   varchar2(150),
...
--           p_base_key_value = :per_cm_prvdd_id).
--
-- Post Success:
--   Processing continues.
--
