--------------------------------------------------------
--  DDL for Package PER_EQT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_EQT_SHD" AUTHID CURRENT_USER as
...
-- BUG3356369 Unit Standard Framework Qualification
 ,qual_framework_id           number(10)
 ,qualification_type          varchar2(100)
...
-- Passed Developer DF columns as argumnets to the function convert_args
--
