--------------------------------------------------------
--  DDL for Package BEN_PEL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PEL_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_pil_elctbl_chc_popl_id already exists.
--
--  In Arguments:
...
function return_legislation_code
  (p_pil_elctbl_chc_popl_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
