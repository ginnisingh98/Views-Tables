--------------------------------------------------------
--  DDL for Package BEN_XRC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XRC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  rcd_type_cd                       varchar2(30),
  low_lvl_cd                        varchar2(30),
  business_group_id                 number(15),
  legislation_code                  varchar2(30),
  xrc_attribute_category            varchar2(30),
  xrc_attribute1                    varchar2(150),
  xrc_attribute2                    varchar2(150),
  xrc_attribute3                    varchar2(150),
  xrc_attribute4                    varchar2(150),
  xrc_attribute5                    varchar2(150),
  xrc_attribute6                    varchar2(150),
  xrc_attribute7                    varchar2(150),
  xrc_attribute8                    varchar2(150),
  xrc_attribute9                    varchar2(150),
  xrc_attribute10                   varchar2(150),
  xrc_attribute11                   varchar2(150),
  xrc_attribute12                   varchar2(150),
  xrc_attribute13                   varchar2(150),
  xrc_attribute14                   varchar2(150),
  xrc_attribute15                   varchar2(150),
  xrc_attribute16                   varchar2(150),
  xrc_attribute17                   varchar2(150),
  xrc_attribute18                   varchar2(150),
  xrc_attribute19                   varchar2(150),
  xrc_attribute20                   varchar2(150),
  xrc_attribute21                   varchar2(150),
  xrc_attribute22                   varchar2(150),
  xrc_attribute23                   varchar2(150),
  xrc_attribute24                   varchar2(150),
  xrc_attribute25                   varchar2(150),
  xrc_attribute26                   varchar2(150),
  xrc_attribute27                   varchar2(150),
  xrc_attribute28                   varchar2(150),
  xrc_attribute29                   varchar2(150),
  xrc_attribute30                   varchar2(150),
