--------------------------------------------------------
--  DDL for Package PQH_LVL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_LVL_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_wrkplc_vldtn_lvlnum_id
--     already exists.
--
--  In Arguments:
