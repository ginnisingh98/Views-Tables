--------------------------------------------------------
--  DDL for Package PAY_PTA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PTA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,surrogate_key_name              varchar2(30)
  ,start_date_name                 varchar2(30)
  ,end_date_name                   varchar2(30)
  ,business_group_id               number(15)
  ,legislation_code                varchar2(30)
  ,object_version_number           number(9)
  ,dyn_trigger_type                varchar2(30)
  ,dyn_trigger_package_name        varchar2(80)
  ,dyn_trig_pkg_generated          varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
