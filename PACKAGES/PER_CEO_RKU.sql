--------------------------------------------------------
--  DDL for Package PER_CEO_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CEO_RKU" AUTHID CURRENT_USER as
...
procedure after_update
  ...
  ,p_competence_element_id_o      in number
  ,p_outcome_id_o                 in number
