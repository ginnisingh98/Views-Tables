--------------------------------------------------------
--  DDL for Package ASO_CONTRACT_TERMS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ASO_CONTRACT_TERMS_PUB" AUTHID CURRENT_USER AS
/* $Header: asopktcs.pls 120.1 2005/06/29 12:36:56 appldev ship $ */
-- Start of Comments
