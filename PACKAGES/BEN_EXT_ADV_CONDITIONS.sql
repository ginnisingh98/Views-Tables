--------------------------------------------------------
--  DDL for Package BEN_EXT_ADV_CONDITIONS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EXT_ADV_CONDITIONS" AUTHID CURRENT_USER as
/* $Header: benxadvc.pkh 120.3 2006/04/27 11:28:14 tjesumic noship $ */
--------------------------------------------------------------------------------
/*
+==============================================================================+
...
History:
        ...
        10/07/99  115.2    Ty Hayden   Added chg_evt_incl procedure.
        01/21/00  115.3    Ty Hayden   Fix for data element conditions.
        12/23/02  115.6    rpgupta     Nocopy changes
        06/21/05  115.7    tjesumic    pernnserver ,  chg_rcd_merge added
        06/21/05  115.8    tjesumic    nocopy added to  chg_rcd_merge
        04/25/06  115.6    tjesumic    new global qdded g_ext_adv_ct_validation
*/
-----------------------------------------------------------------------------------
--
g_ext_adv_ct_validation  varchar2(1) ;
...
Procedure chg_evt_incl
         (p_ext_rcd_in_file_id      in number default null,
          ...
          p_exclude_flag            out nocopy boolean);
...
procedure chg_rcd_merge (
 ...
 Procedure WRITE_WARNING
           (p_err_name in varchar2,
            ...
            p_element   in varchar2 default null ) ;
