--------------------------------------------------------
--  DDL for Package IRC_IPD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IPD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_pending_data_id
--     already exists.
--
--  In Arguments:
--    p_pending_data_id
