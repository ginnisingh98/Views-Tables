--------------------------------------------------------
--  DDL for Package OTA_OTARPATT_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_OTARPATT_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: OTARPATTS.pls 120.1 2007/12/07 05:59:25 amakrish noship $ */
	P_BUSINESS_GROUP_ID	number;
	P_SESSION_DATE	date;
	LP_SESSION_DATE varchar2(15);
