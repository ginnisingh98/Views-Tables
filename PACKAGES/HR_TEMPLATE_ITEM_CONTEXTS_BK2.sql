--------------------------------------------------------
--  DDL for Package HR_TEMPLATE_ITEM_CONTEXTS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TEMPLATE_ITEM_CONTEXTS_BK2" AUTHID CURRENT_USER as
/* $Header: hrticapi.pkh 120.0 2005/05/31 03:08:47 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------< create_template_item_context_b >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure create_template_item_context_b
  ...
  ,p_template_tab_page_id         in varchar2
...
--
-- ----------------------------------------------------------------------------
-- |---------------< create_template_item_context_a >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure create_template_item_context_a
  (p_effective_date               in date
  ,p_language_code                in varchar2
  ,p_template_item_id             in number
  ,p_context_type                 in varchar2
...
--
end hr_template_item_contexts_bk2;
