--------------------------------------------------------
--  DDL for Package PAY_DTE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_DTE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_datetracked_event_id
--     already exists.
--
--  In Arguments:
