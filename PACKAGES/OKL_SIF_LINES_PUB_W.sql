--------------------------------------------------------
--  DDL for Package OKL_SIF_LINES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SIF_LINES_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUSILS.pls 120.2 2005/10/11 06:40:11 rgooty noship $ */
