--------------------------------------------------------
--  DDL for Package BEN_OUR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_OUR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ordr_num                          number(15),
  our_attribute_category            varchar2(30),
  our_attribute1                    varchar2(150),
  our_attribute2                    varchar2(150),
  our_attribute3                    varchar2(150),
  our_attribute4                    varchar2(150),
  our_attribute5                    varchar2(150),
  our_attribute6                    varchar2(150),
  our_attribute7                    varchar2(150),
  our_attribute8                    varchar2(150),
  our_attribute9                    varchar2(150),
  our_attribute10                   varchar2(150),
  our_attribute11                   varchar2(150),
  our_attribute12                   varchar2(150),
  our_attribute13                   varchar2(150),
  our_attribute14                   varchar2(150),
  our_attribute15                   varchar2(150),
  our_attribute16                   varchar2(150),
  our_attribute17                   varchar2(150),
  our_attribute18                   varchar2(150),
  our_attribute19                   varchar2(150),
  our_attribute20                   varchar2(150),
  our_attribute21                   varchar2(150),
  our_attribute22                   varchar2(150),
  our_attribute23                   varchar2(150),
  our_attribute24                   varchar2(150),
  our_attribute25                   varchar2(150),
  our_attribute26                   varchar2(150),
  our_attribute27                   varchar2(150),
  our_attribute28                   varchar2(150),
  our_attribute29                   varchar2(150),
  our_attribute30                   varchar2(150),
...
--           p_base_key_value = :org_unit_rt_id).
--
-- Post Success:
--   Processing continues.
--
