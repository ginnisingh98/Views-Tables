--------------------------------------------------------
--  DDL for Package BEN_CPO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CPO_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  cstmr_num                         number(15),
  plcy_r_grp			    varchar2(90),-- UTF8 Change Bug 2254683
  pgm_id                            number(15),
  pl_id                             number(15),
  organization_id                   number(15),
  person_id                         number(15),
  cpo_attribute_category            varchar2(30),
  cpo_attribute1                    varchar2(150),
  cpo_attribute2                    varchar2(150),
  cpo_attribute3                    varchar2(150),
  cpo_attribute4                    varchar2(150),
  cpo_attribute5                    varchar2(150),
  cpo_attribute6                    varchar2(150),
  cpo_attribute7                    varchar2(150),
  cpo_attribute8                    varchar2(150),
  cpo_attribute9                    varchar2(150),
  cpo_attribute10                   varchar2(150),
  cpo_attribute11                   varchar2(150),
  cpo_attribute12                   varchar2(150),
  cpo_attribute13                   varchar2(150),
  cpo_attribute14                   varchar2(150),
  cpo_attribute15                   varchar2(150),
  cpo_attribute16                   varchar2(150),
  cpo_attribute17                   varchar2(150),
  cpo_attribute18                   varchar2(150),
  cpo_attribute19                   varchar2(150),
  cpo_attribute20                   varchar2(150),
  cpo_attribute21                   varchar2(150),
  cpo_attribute22                   varchar2(150),
  cpo_attribute23                   varchar2(150),
  cpo_attribute24                   varchar2(150),
  cpo_attribute25                   varchar2(150),
  cpo_attribute26                   varchar2(150),
  cpo_attribute27                   varchar2(150),
  cpo_attribute28                   varchar2(150),
  cpo_attribute29                   varchar2(150),
  cpo_attribute30                   varchar2(150),
