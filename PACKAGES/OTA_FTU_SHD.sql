--------------------------------------------------------
--  DDL for Package OTA_FTU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_FTU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,author_person_id                number(10)
  ,author_contact_id               number(15)
  ,person_id                       number(10)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_PVT_FRM_THREAD_USERS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
