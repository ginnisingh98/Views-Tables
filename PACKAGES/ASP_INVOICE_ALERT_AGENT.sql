--------------------------------------------------------
--  DDL for Package ASP_INVOICE_ALERT_AGENT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ASP_INVOICE_ALERT_AGENT" AUTHID CURRENT_USER as
/* $Header: aspadias.pls 120.1 2005/08/19 12:57 axavier noship $ */
---------------------------------------------------------------------------
