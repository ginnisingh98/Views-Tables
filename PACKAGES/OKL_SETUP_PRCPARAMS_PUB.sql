--------------------------------------------------------
--  DDL for Package OKL_SETUP_PRCPARAMS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SETUP_PRCPARAMS_PUB" AUTHID CURRENT_USER AS
/* $Header: OKLPPPRS.pls 115.2 2004/07/02 02:56:05 sgorantl noship $ */
  ...
  G_PKG_NAME                  CONSTANT VARCHAR2(30)  := 'OKL_SETUP_PRCPARAMS_PUB';
