--------------------------------------------------------
--  DDL for Package PSB_PSBRPPAL_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSB_PSBRPPAL_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: PSBRPPALS.pls 120.0 2008/01/07 10:41:49 vijranga noship $ */
  P_SOB_ID NUMBER;
