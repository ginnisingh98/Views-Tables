--------------------------------------------------------
--  DDL for Package IRC_CMM_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_CMM_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_communication_message_id
--     already exists.
--
--  In Arguments:
