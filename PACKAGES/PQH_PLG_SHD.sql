--------------------------------------------------------
--  DDL for Package PQH_PLG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_PLG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  process_log_id                    number(15),
  module_cd                         varchar2(30),
  txn_id                            number(15),
  master_process_log_id             number(15),
  message_text                      varchar2(4000),
  message_type_cd                   varchar2(30),
  batch_status                      varchar2(30),
  batch_start_date                  date,
  batch_end_date                    date,
  txn_table_route_id                number(15),
