--------------------------------------------------------
--  DDL for Package PER_WORK_INCIDENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_WORK_INCIDENT_API" AUTHID CURRENT_USER as
...
-- {Start Of Comments}
/*#
 * This API creates a work incident record for a person.
 *
 ...
 * @param p_inc_information_category This context value determines which
 * Flexfield Structure to use with the Developer Descriptive flexfield
 * segments.
 * @param p_inc_information1 Developer Descriptive flexfield segment.
 * @param p_inc_information2 Developer Descriptive flexfield segment.
 * @param p_inc_information3 Developer Descriptive flexfield segment.
 * @param p_inc_information4 Developer Descriptive flexfield segment.
 * @param p_inc_information5 Developer Descriptive flexfield segment.
 * @param p_inc_information6 Developer Descriptive flexfield segment.
 * @param p_inc_information7 Developer Descriptive flexfield segment.
 * @param p_inc_information8 Developer Descriptive flexfield segment.
 * @param p_inc_information9 Developer Descriptive flexfield segment.
 * @param p_inc_information10 Developer Descriptive flexfield segment.
 * @param p_inc_information11 Developer Descriptive flexfield segment.
 * @param p_inc_information12 Developer Descriptive flexfield segment.
 * @param p_inc_information13 Developer Descriptive flexfield segment.
 * @param p_inc_information14 Developer Descriptive flexfield segment.
 * @param p_inc_information15 Developer Descriptive flexfield segment.
 * @param p_inc_information16 Developer Descriptive flexfield segment.
 * @param p_inc_information17 Developer Descriptive flexfield segment.
 * @param p_inc_information18 Developer Descriptive flexfield segment.
 * @param p_inc_information19 Developer Descriptive flexfield segment.
 * @param p_inc_information20 Developer Descriptive flexfield segment.
 * @param p_inc_information21 Developer Descriptive flexfield segment.
 * @param p_inc_information22 Developer Descriptive flexfield segment.
 * @param p_inc_information23 Developer Descriptive flexfield segment.
 * @param p_inc_information24 Developer Descriptive flexfield segment.
 * @param p_inc_information25 Developer Descriptive flexfield segment.
 * @param p_inc_information26 Developer Descriptive flexfield segment.
 * @param p_inc_information27 Developer Descriptive flexfield segment.
 * @param p_inc_information28 Developer Descriptive flexfield segment.
 * @param p_inc_information29 Developer Descriptive flexfield segment.
 * @param p_inc_information30 Developer Descriptive flexfield segment.
 ...
 * value will be null.
 * @rep:displayname Create Work Incident
...
-- {Start Of Comments}
/*#
 * This API updates a work incident record for a person.
 *
 * A work incident holds the information about an occurrence which is
 * detrimental to the health, safety and well-being of a specific person which
 * happened whilst they were at work or en route to the work place. A work
 ...
 * @param p_inc_information29 Developer Descriptive flexfield segment.
 * @param p_inc_information30 Developer Descriptive flexfield segment.
 * @rep:displayname Update Work Incident
 * @rep:category BUSINESS_ENTITY PER_WORK_INCIDENT
 * @rep:category MISC_EXTENSIONS HR_USER_HOOKS
 * @rep:scope public
 * @rep:lifecycle active
...
-- {Start Of Comments}
/*#
 * This API deletes a work incident record for a person.
 *
 * A work incident holds the information about an occurrence which is
 * detrimental to the health, safety and well-being of a specific person which
 * happened whilst they were at work or en route to the work place. A work
 ...
 *
 * <p><b>Prerequisites</b><br>
 * The work incident to be deleted must already exist.
 *
 * <p><b>Post Success</b><br>
 * The work incident is deleted.
 *
 * <p><b>Post Failure</b><br>
 * The work incident is not deleted and an error is raised.
 * @param p_validate If true, then validation alone will be performed and the
 * database will remain unchanged. If false and all validation checks pass,
 * then the database will be modified.
 * @param p_incident_id Uniquely identifies the work incident to be deleted.
 * @param p_object_version_number Current version number of the work incident
 * to be deleted.
 * @rep:displayname Delete Work Incident
 * @rep:category BUSINESS_ENTITY PER_WORK_INCIDENT
 * @rep:category MISC_EXTENSIONS HR_USER_HOOKS
 * @rep:scope public
 * @rep:lifecycle active
