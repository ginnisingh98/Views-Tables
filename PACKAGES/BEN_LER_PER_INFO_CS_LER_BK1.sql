--------------------------------------------------------
--  DDL for Package BEN_LER_PER_INFO_CS_LER_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LER_PER_INFO_CS_LER_BK1" AUTHID CURRENT_USER as
/* $Header: belplapi.pkh 120.0 2005/05/28 03:30:59 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Ler_Per_Info_Cs_Ler_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Ler_Per_Info_Cs_Ler_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Ler_Per_Info_Cs_Ler_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Ler_Per_Info_Cs_Ler_a
  (
...
--
end ben_Ler_Per_Info_Cs_Ler_bk1;
