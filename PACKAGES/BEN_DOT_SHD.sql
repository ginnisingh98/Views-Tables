--------------------------------------------------------
--  DDL for Package BEN_DOT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DOT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dpnt_othr_ptip_rt_id            number(15),
  ...
  dot_attribute_category            varchar2(30),
  dot_attribute1                    varchar2(150),
  dot_attribute2                    varchar2(150),
  dot_attribute3                    varchar2(150),
  dot_attribute4                    varchar2(150),
  dot_attribute5                    varchar2(150),
  dot_attribute6                    varchar2(150),
  dot_attribute7                    varchar2(150),
  dot_attribute8                    varchar2(150),
  dot_attribute9                    varchar2(150),
  dot_attribute10                   varchar2(150),
  dot_attribute11                   varchar2(150),
  dot_attribute12                   varchar2(150),
  dot_attribute13                   varchar2(150),
  dot_attribute14                   varchar2(150),
  dot_attribute15                   varchar2(150),
  dot_attribute16                   varchar2(150),
  dot_attribute17                   varchar2(150),
  dot_attribute18                   varchar2(150),
  dot_attribute19                   varchar2(150),
  dot_attribute20                   varchar2(150),
  dot_attribute21                   varchar2(150),
  dot_attribute22                   varchar2(150),
  dot_attribute23                   varchar2(150),
  dot_attribute24                   varchar2(150),
  dot_attribute25                   varchar2(150),
  dot_attribute26                   varchar2(150),
  dot_attribute27                   varchar2(150),
  dot_attribute28                   varchar2(150),
  dot_attribute29                   varchar2(150),
  dot_attribute30                   varchar2(150),
...
--           p_base_key_value = :dpnt_othr_ptip_rt_id).
--
-- Post Success:
--   Processing continues.
--
