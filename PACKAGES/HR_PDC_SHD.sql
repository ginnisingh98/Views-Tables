--------------------------------------------------------
--  DDL for Package HR_PDC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PDC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (person_deplymt_contact_id       number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_PERSON_DEPLYMT_CONTACTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
