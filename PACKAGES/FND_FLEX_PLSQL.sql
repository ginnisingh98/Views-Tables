--------------------------------------------------------
--  DDL for Package FND_FLEX_PLSQL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FND_FLEX_PLSQL" AUTHID CURRENT_USER AS
/* $Header: AFFFPLVS.pls 115.0 99/07/16 23:18:49 porting ship $ */
