--------------------------------------------------------
--  DDL for Package OKL_SETUPDQUALITYS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SETUPDQUALITYS_PUB" AUTHID CURRENT_USER AS
/* $Header: OKLPSDQS.pls 120.6 2008/02/29 10:50:20 asawanka ship $ */
  ...
  G_PKG_NAME                  CONSTANT VARCHAR2(30)  := 'OKL_SETUPDQUALITYS_PUB';

  G_EXCEPTION_HALT_PROCESSING EXCEPTION;

  SUBTYPE pdqv_rec_type IS OKL_SETUPDQUALITYS_PVT.pdqv_rec_type;
  SUBTYPE pdqv_tbl_type IS OKL_SETUPDQUALITYS_PVT.pdqv_tbl_type;

  SUBTYPE ptlv_rec_type IS OKL_SETUPDQUALITYS_PVT.ptlv_rec_type;
  SUBTYPE ptlv_tbl_type IS OKL_SETUPDQUALITYS_PVT.ptlv_tbl_type;
