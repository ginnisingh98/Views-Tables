--------------------------------------------------------
--  DDL for Package AME_ACTION_TYPE_CONFIG_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_ACTION_TYPE_CONFIG_API" AUTHID CURRENT_USER AS
/* $Header: ametcapi.pkh 120.0 2005/07/26 06:07 mbocutt noship $ */
