--------------------------------------------------------
--  DDL for Package PO_CUSTOM_PRICE_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PO_CUSTOM_PRICE_PUB" AUTHID CURRENT_USER AS
/* $Header: POXPCPRS.pls 120.3.12010000.8 2012/11/16 08:47:02 jemishra ship $ */
/*#
 ...
 * @rep:paraminfo  {@rep:required}
 *
 * @param p_order_line_id
 * The line id of the order document.
 * @rep:paraminfo  {@rep:required}
 *
 * @param x_return_status Possible Values are:
 * S = Success - Completed without errors.
...
PROCEDURE GET_CUSTOM_PO_PRICE(p_api_version		IN NUMBER,
							  ...
							  p_order_line_id  IN  NUMBER DEFAULT NULL); -- <Bug 15871591>
