--------------------------------------------------------
--  DDL for Package PER_ASR_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ASR_FLEX" AUTHID CURRENT_USER as
/* $Header: peasrfli.pkh 115.0 99/07/17 18:44:14 porting ship $ */
--
--
-- ----------------------------------------------------------------------------
-- |-------------------------------< df>--------------------------------------|
