--------------------------------------------------------
--  DDL for Package JTF_TASK_DEPENDENCY_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_TASK_DEPENDENCY_CUHK" AUTHID CURRENT_USER AS
/* $Header: jtfctkes.pls 115.6 2002/12/05 23:29:38 sachoudh ship $ */
