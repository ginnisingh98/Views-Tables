--------------------------------------------------------
--  DDL for Package OKL_AM_CONSOLIDATED_QTE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_AM_CONSOLIDATED_QTE_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUCNQS.pls 120.2 2007/11/02 21:05:29 rmunjulu ship $ */
