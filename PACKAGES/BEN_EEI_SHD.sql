--------------------------------------------------------
--  DDL for Package BEN_EEI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EEI_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_enrld_anthr_oipl_id          number(15),
  ...
  eei_attribute21                   varchar2(150),
  eei_attribute22                   varchar2(150),
  eei_attribute23                   varchar2(150),
  eei_attribute24                   varchar2(150),
  eei_attribute25                   varchar2(150),
  eei_attribute26                   varchar2(150),
  eei_attribute27                   varchar2(150),
  eei_attribute28                   varchar2(150),
  eei_attribute29                   varchar2(150),
  eei_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_enrld_anthr_oipl_id).
--
-- Post Success:
--   Processing continues.
--
