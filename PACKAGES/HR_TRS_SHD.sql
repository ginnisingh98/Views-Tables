--------------------------------------------------------
--  DDL for Package HR_TRS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TRS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  transaction_step_id               number(15),
  transaction_id                    number(15),
  api_name                          varchar2(61),
  api_display_name                  varchar2(61),
  processing_order                  number(9),        -- Increased length
  item_type                         varchar2(9),      -- Increased length
  item_key                          varchar2(240),
  activity_id                       number,
  creator_person_id                 number(15),
  update_person_id                  number(15),
  object_version_number             number(9),
  object_type                       varchar2(30),
  object_name                       varchar2(150),
  object_identifier                 varchar2(150),
  object_state                      varchar2(30),
  pk1                               varchar2(350),
  pk2                               varchar2(350),
  pk3                               varchar2(350),
  pk4                               varchar2(350),
