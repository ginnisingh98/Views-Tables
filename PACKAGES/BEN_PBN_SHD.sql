--------------------------------------------------------
--  DDL for Package BEN_PBN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PBN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ttee_person_id                    number(15),
  prmry_cntngnt_cd                  varchar2(30),
  pct_dsgd_num                      number(15,2),
  amt_dsgd_val                      number,  --  (17,2),   -- Increased length
  amt_dsgd_uom                      varchar2(30),
  dsgn_strt_dt                      date,
  dsgn_thru_dt                      date,
  addl_instrn_txt                   varchar2(2000),
  pbn_attribute_category            varchar2(30),
  pbn_attribute1                    varchar2(150),
  pbn_attribute2                    varchar2(150),
  pbn_attribute3                    varchar2(150),
  pbn_attribute4                    varchar2(150),
  pbn_attribute5                    varchar2(150),
  pbn_attribute6                    varchar2(150),
  pbn_attribute7                    varchar2(150),
  pbn_attribute8                    varchar2(150),
  pbn_attribute9                    varchar2(150),
  pbn_attribute10                   varchar2(150),
  pbn_attribute11                   varchar2(150),
  pbn_attribute12                   varchar2(150),
  pbn_attribute13                   varchar2(150),
  pbn_attribute14                   varchar2(150),
  pbn_attribute15                   varchar2(150),
  pbn_attribute16                   varchar2(150),
  pbn_attribute17                   varchar2(150),
  pbn_attribute18                   varchar2(150),
  pbn_attribute19                   varchar2(150),
  pbn_attribute20                   varchar2(150),
  pbn_attribute21                   varchar2(150),
  pbn_attribute22                   varchar2(150),
  pbn_attribute23                   varchar2(150),
  pbn_attribute24                   varchar2(150),
  pbn_attribute25                   varchar2(150),
  pbn_attribute26                   varchar2(150),
  pbn_attribute27                   varchar2(150),
  pbn_attribute28                   varchar2(150),
  pbn_attribute29                   varchar2(150),
  pbn_attribute30                   varchar2(150),
