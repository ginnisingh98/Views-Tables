--------------------------------------------------------
--  DDL for Package BEN_DSGNTR_ENRLD_CVG_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DSGNTR_ENRLD_CVG_BK2" AUTHID CURRENT_USER as
/* $Header: bedecapi.pkh 120.0 2005/05/28 01:36:05 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_DSGNTR_ENRLD_CVG_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_DSGNTR_ENRLD_CVG_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_DSGNTR_ENRLD_CVG_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_DSGNTR_ENRLD_CVG_a
  (
   p_dsgntr_enrld_cvg_id            in  number
