--------------------------------------------------------
--  DDL for Package AP_APXINVAD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_APXINVAD_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: APXINVADS.pls 120.0 2007/12/27 08:05:14 vjaganat noship $ */
	...
	Function C_sequence_id_p return number;
