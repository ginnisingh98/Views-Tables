--------------------------------------------------------
--  DDL for Package PER_RTL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RTL_BUS" AUTHID CURRENT_USER as
...
--   (business_group_id, rating_scale_id,competnce_id or step) have been altered.
--
-- Access Status:
--   Internal Table Handler Use Only.
--
--
Procedure chk_non_updateable_args(p_rec in per_rtl_shd.g_rec_type);
--
--
--
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_validate(p_rec in per_rtl_shd.g_rec_type);
--
--
-- ----------------------------------------------------------------------------
...
--
-- In Parameters:
--   the primary key of the table (per_rating_levels)
--
-- Post Success:
--   Processing continues.
--
