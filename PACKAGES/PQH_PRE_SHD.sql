--------------------------------------------------------
--  DDL for Package PQH_PRE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_PRE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (ins_end_reason_id               number(15)
  ,business_group_id               number(15)
  ,provider_organization_id        number(15)
  ,end_reason_number               varchar2(30)
  ,end_reason_short_name           varchar2(150)
  ,end_reason_description          varchar2(2000)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_INS_END_REASONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
