--------------------------------------------------------
--  DDL for Package BEN_AVA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_AVA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  actl_prem_vrbl_rt_rl_id           number(15),
  ...
  ava_attribute_category            varchar2(30),
  ava_attribute1                    varchar2(150),
  ava_attribute2                    varchar2(150),
  ava_attribute3                    varchar2(150),
  ava_attribute4                    varchar2(150),
  ava_attribute5                    varchar2(150),
  ava_attribute6                    varchar2(150),
  ava_attribute7                    varchar2(150),
  ava_attribute8                    varchar2(150),
  ava_attribute9                    varchar2(150),
  ava_attribute10                   varchar2(150),
  ava_attribute11                   varchar2(150),
  ava_attribute12                   varchar2(150),
  ava_attribute13                   varchar2(150),
  ava_attribute14                   varchar2(150),
  ava_attribute15                   varchar2(150),
  ava_attribute16                   varchar2(150),
  ava_attribute17                   varchar2(150),
  ava_attribute18                   varchar2(150),
  ava_attribute19                   varchar2(150),
  ava_attribute20                   varchar2(150),
  ava_attribute21                   varchar2(150),
  ava_attribute22                   varchar2(150),
  ava_attribute23                   varchar2(150),
  ava_attribute24                   varchar2(150),
  ava_attribute25                   varchar2(150),
  ava_attribute26                   varchar2(150),
  ava_attribute27                   varchar2(150),
  ava_attribute28                   varchar2(150),
  ava_attribute29                   varchar2(150),
  ava_attribute30                   varchar2(150),
...
--           p_base_key_value = :actl_prem_vrbl_rt_rl_id).
--
-- Post Success:
--   Processing continues.
--
