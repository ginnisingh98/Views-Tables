--------------------------------------------------------
--  DDL for Package OZF_NA_RULE_HEADER_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_NA_RULE_HEADER_PVT_W" AUTHID CURRENT_USER as
  /* $Header: ozfwnars.pls 120.1 2005/10/25 17:32 rssharma noship $ */
