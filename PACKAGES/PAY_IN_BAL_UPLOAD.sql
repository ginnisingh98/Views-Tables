--------------------------------------------------------
--  DDL for Package PAY_IN_BAL_UPLOAD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_IN_BAL_UPLOAD" AUTHID CURRENT_USER AS
/* $Header: pyinupld.pkh 120.0 2005/05/29 05:56 appldev noship $ */
