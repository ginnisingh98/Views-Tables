--------------------------------------------------------
--  DDL for Package PAY_PBD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PBD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (bal_attribute_default_id        number(9)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_BAL_ATTRIBUTE_DEFAULTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
