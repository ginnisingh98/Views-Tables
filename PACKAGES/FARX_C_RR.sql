--------------------------------------------------------
--  DDL for Package FARX_C_RR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FARX_C_RR" AUTHID CURRENT_USER AS
/* $Header: FARXCRRS.pls 120.2.12010000.2 2009/07/19 11:55:48 glchen ship $ */

/*=====================================================================================+
|
|   Name:          Mass_Reclass_Review
|
|   Description:   Concurrent wrapper procedure for mass reclass review.
|		   This procedure calls the inner procedure,
|		   FARX_RR.Review_Reclass() that actually performs
|		   review of a mass reclass transaction.
|
