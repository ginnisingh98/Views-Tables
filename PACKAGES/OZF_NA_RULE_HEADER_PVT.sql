--------------------------------------------------------
--  DDL for Package OZF_NA_RULE_HEADER_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_NA_RULE_HEADER_PVT" AUTHID CURRENT_USER AS
/* $Header: ozfvnars.pls 120.0 2005/06/01 00:14:36 appldev noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
...
--===================================================================
TYPE na_rule_header_rec_type IS RECORD
(
       ...
       name             VARCHAR2(4000) := FND_API.G_MISS_CHAR,
       description             VARCHAR2(4000):= FND_API.G_MISS_CHAR
);

g_miss_na_rule_header_rec          na_rule_header_rec_type := NULL;
TYPE  na_rule_header_tbl_type      IS TABLE OF na_rule_header_rec_type INDEX BY BINARY_INTEGER;
g_miss_na_rule_header_tbl          na_rule_header_tbl_type;
...
PROCEDURE Create_Na_Rule_Header(
    ...
    p_na_rule_header_rec              IN   na_rule_header_rec_type  := g_miss_na_rule_header_rec,
