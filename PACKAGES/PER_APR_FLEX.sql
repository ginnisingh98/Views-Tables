--------------------------------------------------------
--  DDL for Package PER_APR_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_APR_FLEX" AUTHID CURRENT_USER as
/* $Header: peaprfli.pkh 115.2 99/10/15 15:41:31 porting ship $ */
--
--
-------------------------------------------------------------------------------
-- |-------------------------------< df>-------------------------------------|
