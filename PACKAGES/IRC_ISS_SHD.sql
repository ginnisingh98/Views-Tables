--------------------------------------------------------
--  DDL for Package IRC_ISS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_ISS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (saved_search_criteria_id        number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_SAVED_SEARCH_CRITERIA';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
