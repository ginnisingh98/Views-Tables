--------------------------------------------------------
--  DDL for Package BEN_CPR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CPR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  popl_org_role_id                  number(15),
  effective_start_date              date,
  effective_end_date                date,
  name                              varchar2(240),
  org_role_typ_cd                   varchar2(30),
  popl_org_id                       number(15),
  business_group_id                 number(15),
  cpr_attribute_category            varchar2(30),
  cpr_attribute1                    varchar2(150),
  cpr_attribute2                    varchar2(150),
  cpr_attribute3                    varchar2(150),
  cpr_attribute4                    varchar2(150),
  cpr_attribute5                    varchar2(150),
  cpr_attribute6                    varchar2(150),
  cpr_attribute7                    varchar2(150),
  cpr_attribute8                    varchar2(150),
  cpr_attribute9                    varchar2(150),
  cpr_attribute10                   varchar2(150),
  cpr_attribute11                   varchar2(150),
  cpr_attribute12                   varchar2(150),
  cpr_attribute13                   varchar2(150),
  cpr_attribute14                   varchar2(150),
  cpr_attribute15                   varchar2(150),
  cpr_attribute16                   varchar2(150),
  cpr_attribute17                   varchar2(150),
  cpr_attribute18                   varchar2(150),
  cpr_attribute19                   varchar2(150),
  cpr_attribute20                   varchar2(150),
  cpr_attribute21                   varchar2(150),
  cpr_attribute22                   varchar2(150),
  cpr_attribute23                   varchar2(150),
  cpr_attribute24                   varchar2(150),
  cpr_attribute25                   varchar2(150),
  cpr_attribute26                   varchar2(150),
  cpr_attribute27                   varchar2(150),
  cpr_attribute28                   varchar2(150),
  cpr_attribute29                   varchar2(150),
  cpr_attribute30                   varchar2(150),
...
--           p_base_key_value = :popl_org_role_id).
--
-- Post Success:
--   Processing continues.
--
