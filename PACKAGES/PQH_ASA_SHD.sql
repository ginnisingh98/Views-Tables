--------------------------------------------------------
--  DDL for Package PQH_ASA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_ASA_SHD" AUTHID CURRENT_USER as
/* $Header: pqasarhi.pkh 120.0 2005/05/29 01:25:12 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (assignment_acco_id              number(15)
  ,effective_start_date            date
  ,effective_end_date              date
  ,business_group_id               number(15)
  ,assignment_id                   number(10)
  ,accommodation_given             varchar2(10)
  ,temporary_assignment            varchar2(10)
  ,accommodation_id                number(15)
  ,acceptance_date                 date
  ,moving_date                     date
  ,refusal_date                    date
  ,comments                        varchar2(2000)    -- pseudo column
  ,indemnity_entitlement           varchar2(10)
  ,indemnity_amount                number(15)
  ,type_of_payment                 varchar2(50)
  ...
  ,reason_for_no_acco              varchar2(30)
  ,indemnity_currency              varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_ASSIGN_ACCOMMODATIONS_F';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :assignment_acco_id).
--
-- Post Success:
