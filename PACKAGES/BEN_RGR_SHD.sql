--------------------------------------------------------
--  DDL for Package BEN_RGR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_RGR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  pgm_id                            number(15),
  pl_id                             number(15),
  ordr_num                          number(15),                --iRec
  rgr_attribute_category            varchar2(30),
  rgr_attribute1                    varchar2(150),
  rgr_attribute2                    varchar2(150),
  rgr_attribute3                    varchar2(150),
  rgr_attribute4                    varchar2(150),
  rgr_attribute5                    varchar2(150),
  rgr_attribute6                    varchar2(150),
  rgr_attribute7                    varchar2(150),
  rgr_attribute8                    varchar2(150),
  rgr_attribute9                    varchar2(150),
  rgr_attribute10                   varchar2(150),
  rgr_attribute11                   varchar2(150),
  rgr_attribute12                   varchar2(150),
  rgr_attribute13                   varchar2(150),
  rgr_attribute14                   varchar2(150),
  rgr_attribute15                   varchar2(150),
  rgr_attribute16                   varchar2(150),
  rgr_attribute17                   varchar2(150),
  rgr_attribute18                   varchar2(150),
  rgr_attribute19                   varchar2(150),
  rgr_attribute20                   varchar2(150),
  rgr_attribute21                   varchar2(150),
  rgr_attribute22                   varchar2(150),
  rgr_attribute23                   varchar2(150),
  rgr_attribute24                   varchar2(150),
  rgr_attribute25                   varchar2(150),
  rgr_attribute26                   varchar2(150),
  rgr_attribute27                   varchar2(150),
  rgr_attribute28                   varchar2(150),
  rgr_attribute29                   varchar2(150),
  rgr_attribute30                   varchar2(150),
...
--           p_base_key_value = :popl_rptg_grp_id).
--
-- Post Success:
--   Processing continues.
--
