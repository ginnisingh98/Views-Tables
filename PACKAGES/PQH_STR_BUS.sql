--------------------------------------------------------
--  DDL for Package PQH_STR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_STR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_stat_situation_rule_id
--     already exists.
--
--  In Arguments:
