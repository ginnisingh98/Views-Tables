--------------------------------------------------------
--  DDL for Package JTF_RS_DYNAMIC_GROUPS_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_RS_DYNAMIC_GROUPS_VUHK" AUTHID CURRENT_USER AS
 /* $Header: jtfrsiys.pls 120.0 2005/05/11 08:20:23 appldev ship $ */
...
END jtf_rs_dynamic_groups_vuhk;
