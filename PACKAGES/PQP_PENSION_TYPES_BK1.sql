--------------------------------------------------------
--  DDL for Package PQP_PENSION_TYPES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_PENSION_TYPES_BK1" AUTHID CURRENT_USER As
/* $Header: pqptyapi.pkh 120.1.12000000.1 2007/01/16 04:28:57 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< Create_Pension_Type_b >-------------------------|
-- ----------------------------------------------------------------------------
--
Procedure Create_Pension_Type_b
...
--
-- ----------------------------------------------------------------------------
-- |-------------------------< Create_Pension_Type_a >-------------------------|
-- ----------------------------------------------------------------------------
--
Procedure Create_Pension_Type_a
  (p_validate                     in Boolean
  ,p_effective_date               in date
  ,p_pension_type_name            in varchar2
  ,p_pension_category             in varchar2
