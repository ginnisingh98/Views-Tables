--------------------------------------------------------
--  DDL for Package HR_FMP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FMP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (form_property_id                number(15)
  ,object_version_number           number(9)
  ,application_id                  number(15)
  ,form_id                         number(15)
  ,form_template_id                number(15)
  ,help_target                     varchar2(150)
