--------------------------------------------------------
--  DDL for Package PQH_OPS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_OPS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_wrkplc_vldtn_op_id
--     already exists.
--
--  In Arguments:
