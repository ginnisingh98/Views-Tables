--------------------------------------------------------
--  DDL for Package PER_REQ_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_REQ_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_requisition_id
--     already exists.
--
--  In Arguments:
--    p_requisition_id
