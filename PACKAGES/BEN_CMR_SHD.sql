--------------------------------------------------------
--  DDL for Package BEN_CMR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CMR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  cmr_attribute_category            varchar2(30),
  cmr_attribute1                    varchar2(150),
  cmr_attribute2                    varchar2(150),
  cmr_attribute3                    varchar2(150),
  cmr_attribute4                    varchar2(150),
  cmr_attribute5                    varchar2(150),
  cmr_attribute6                    varchar2(150),
  cmr_attribute7                    varchar2(150),
  cmr_attribute8                    varchar2(150),
  cmr_attribute9                    varchar2(150),
  cmr_attribute10                   varchar2(150),
  cmr_attribute11                   varchar2(150),
  cmr_attribute12                   varchar2(150),
  cmr_attribute13                   varchar2(150),
  cmr_attribute14                   varchar2(150),
  cmr_attribute15                   varchar2(150),
  cmr_attribute16                   varchar2(150),
  cmr_attribute17                   varchar2(150),
  cmr_attribute18                   varchar2(150),
  cmr_attribute19                   varchar2(150),
  cmr_attribute20                   varchar2(150),
  cmr_attribute21                   varchar2(150),
  cmr_attribute22                   varchar2(150),
  cmr_attribute23                   varchar2(150),
  cmr_attribute24                   varchar2(150),
  cmr_attribute25                   varchar2(150),
  cmr_attribute26                   varchar2(150),
  cmr_attribute27                   varchar2(150),
  cmr_attribute28                   varchar2(150),
  cmr_attribute29                   varchar2(150),
  cmr_attribute30                   varchar2(150),
...
--           p_base_key_value = :cmbn_age_los_rt_id).
--
-- Post Success:
--   Processing continues.
--
