--------------------------------------------------------
--  DDL for Package PAY_TDF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_TDF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,definition_name                 varchar2(80)
  ,period_type                     varchar2(30)
  ,period_unit                     varchar2(30)
  ,day_adjustment                  varchar2(30)
  ,dynamic_code                    varchar2(61)
  ,business_group_id               number(15)
  ,legislation_code                varchar2(30)
  ,definition_type                 varchar2(30)
  ,number_of_years                 number(9)
  ,start_date                      date
  ,period_time_definition_id       number(9)
  ,creator_id                      number(9)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_TIME_DEFINITIONS';
