--------------------------------------------------------
--  DDL for Package AHL_MC_ITEM_COMP_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_MC_ITEM_COMP_PUB_W" AUTHID CURRENT_USER as
  /* $Header: AHLPICWS.pls 115.1 2003/08/29 09:59:22 tamdas noship $ */
