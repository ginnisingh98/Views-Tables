--------------------------------------------------------
--  DDL for Package PER_CNL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CNL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,configuration_context           varchar2(120)
  ,location_id                     number(15)
  ,location_code                   varchar2(60)
  ,description                     varchar2(240)
  ,style                           varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_RI_CONFIG_LOCATIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
