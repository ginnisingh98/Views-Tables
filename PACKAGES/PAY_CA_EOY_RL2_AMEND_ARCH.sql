--------------------------------------------------------
--  DDL for Package PAY_CA_EOY_RL2_AMEND_ARCH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CA_EOY_RL2_AMEND_ARCH" AUTHID CURRENT_USER AS
/* $Header: pycarl2ca.pkh 120.0.12000000.1 2007/01/17 17:19:58 appldev noship $ */
/*
   ******************************************************************
   *                                                                *
