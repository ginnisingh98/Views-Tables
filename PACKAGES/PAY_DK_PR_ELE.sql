--------------------------------------------------------
--  DDL for Package PAY_DK_PR_ELE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_DK_PR_ELE" AUTHID CURRENT_USER AS
/* $Header: pydkprele.pkh 120.7 2006/01/27 06:55:53 pgopal noship $ */
