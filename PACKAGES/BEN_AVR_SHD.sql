--------------------------------------------------------
--  DDL for Package BEN_AVR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_AVR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  avr_attribute_category            varchar2(30),
  avr_attribute1                    varchar2(150),
  avr_attribute2                    varchar2(150),
  avr_attribute3                    varchar2(150),
  avr_attribute4                    varchar2(150),
  avr_attribute5                    varchar2(150),
  avr_attribute6                    varchar2(150),
  avr_attribute7                    varchar2(150),
  avr_attribute8                    varchar2(150),
  avr_attribute9                    varchar2(150),
  avr_attribute10                   varchar2(150),
  avr_attribute11                   varchar2(150),
  avr_attribute12                   varchar2(150),
  avr_attribute13                   varchar2(150),
  avr_attribute14                   varchar2(150),
  avr_attribute15                   varchar2(150),
  avr_attribute16                   varchar2(150),
  avr_attribute17                   varchar2(150),
  avr_attribute18                   varchar2(150),
  avr_attribute19                   varchar2(150),
  avr_attribute20                   varchar2(150),
  avr_attribute21                   varchar2(150),
  avr_attribute22                   varchar2(150),
  avr_attribute23                   varchar2(150),
  avr_attribute24                   varchar2(150),
  avr_attribute25                   varchar2(150),
  avr_attribute26                   varchar2(150),
  avr_attribute27                   varchar2(150),
  avr_attribute28                   varchar2(150),
  avr_attribute29                   varchar2(150),
  avr_attribute30                   varchar2(150),
...
--           p_base_key_value = :acty_vrbl_rt_id).
--
-- Post Success:
--   Processing continues.
--
