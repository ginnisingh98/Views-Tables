--------------------------------------------------------
--  DDL for Package PNRX_C_LEASE_OPTIONS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PNRX_C_LEASE_OPTIONS" AUTHID CURRENT_USER AS
/* $Header: PNRXCOLS.pls 115.2 2002/11/15 20:46:20 stripath ship $ */
