--------------------------------------------------------
--  DDL for Package GHR_CBA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CBA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (compl_basis_id                  number(15)
  ,compl_claim_id                  number(15)
  ,basis                           varchar2(30)
  ,value                           varchar2(30)       -- Increased length
  ,statute                         varchar2(30)       -- Increased length
  ,agency_finding                  varchar2(30)       -- Increased length
  ,aj_finding                      varchar2(30)       -- Increased length
