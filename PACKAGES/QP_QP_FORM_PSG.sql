--------------------------------------------------------
--  DDL for Package QP_QP_FORM_PSG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."QP_QP_FORM_PSG" AUTHID CURRENT_USER AS
/* $Header: QPXFPSGS.pls 120.1 2005/06/13 23:42:32 appldev  $ */
