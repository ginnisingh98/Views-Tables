--------------------------------------------------------
--  DDL for Package BEN_BNR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BNR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_rptg_grp_id already exists.
--
--  In Arguments:
--    p_rptg_grp_id
--
...
function return_legislation_code
  (p_rptg_grp_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
