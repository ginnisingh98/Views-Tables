--------------------------------------------------------
--  DDL for Package ZX_AP_ACTG_POPULATE_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ZX_AP_ACTG_POPULATE_PKG" AUTHID CURRENT_USER AS
/* $Header: zxripactgpoppvts.pls 120.1 2005/07/29 12:32:24 skorrapa ship $ */
