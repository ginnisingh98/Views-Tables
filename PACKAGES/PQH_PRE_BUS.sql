--------------------------------------------------------
--  DDL for Package PQH_PRE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_PRE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_ins_end_reason_id
--     already exists.
--
--  In Arguments:
--    p_ins_end_reason_id
