--------------------------------------------------------
--  DDL for Package BEN_CER_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CER_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  prtn_eligy_rl_id                  number(15),
  effective_start_date              date,
  effective_end_date                date,
  business_group_id                 number(15),
  prtn_elig_id                      number(15),
  formula_id                        number(15),
  drvbl_fctr_apls_flag              varchar2(30),
  mndtry_flag                       varchar2(30),
  ordr_to_aply_num                  number(15),
  cer_attribute_category            varchar2(30),
  cer_attribute1                    varchar2(150),
  cer_attribute2                    varchar2(150),
  cer_attribute3                    varchar2(150),
  cer_attribute4                    varchar2(150),
  cer_attribute5                    varchar2(150),
  cer_attribute6                    varchar2(150),
  cer_attribute7                    varchar2(150),
  cer_attribute8                    varchar2(150),
  cer_attribute9                    varchar2(150),
  cer_attribute10                   varchar2(150),
  cer_attribute11                   varchar2(150),
  cer_attribute12                   varchar2(150),
  cer_attribute13                   varchar2(150),
  cer_attribute14                   varchar2(150),
  cer_attribute15                   varchar2(150),
  cer_attribute16                   varchar2(150),
  cer_attribute17                   varchar2(150),
  cer_attribute18                   varchar2(150),
  cer_attribute19                   varchar2(150),
  cer_attribute20                   varchar2(150),
  cer_attribute21                   varchar2(150),
  cer_attribute22                   varchar2(150),
  cer_attribute23                   varchar2(150),
  cer_attribute24                   varchar2(150),
  cer_attribute25                   varchar2(150),
  cer_attribute26                   varchar2(150),
  cer_attribute27                   varchar2(150),
  cer_attribute28                   varchar2(150),
  cer_attribute29                   varchar2(150),
  cer_attribute30                   varchar2(150),
...
--           p_base_key_value = :prtn_eligy_rl_id).
--
-- Post Success:
--   Processing continues.
--
