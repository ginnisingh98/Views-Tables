--------------------------------------------------------
--  DDL for Package PQP_GDA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_GDA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (gap_daily_absence_id            number(15)
  ,gap_absence_plan_id             number(15)
  ,absence_date                    date
  ,work_pattern_day_type           varchar2(30)
  ,level_of_entitlement            varchar2(30)
  ,level_of_pay                    varchar2(30)
  ,duration                        number(18,5)      -- Increased length
  ,duration_in_hours               number(18,5)      -- Increased length
  ,working_days_per_week           number(15,13)
  ,fte                             number(25,5) -- LG
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQP_GAP_DAILY_ABSENCES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
