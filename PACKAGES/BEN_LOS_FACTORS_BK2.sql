--------------------------------------------------------
--  DDL for Package BEN_LOS_FACTORS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LOS_FACTORS_BK2" AUTHID CURRENT_USER as
/* $Header: belsfapi.pkh 120.0 2005/05/28 03:37:30 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_LOS_FACTORS_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_LOS_FACTORS_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_LOS_FACTORS_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_LOS_FACTORS_a
  (
   p_los_fctr_id                    in  number
  ,p_name                           in  varchar2
  ,p_business_group_id              in  number
