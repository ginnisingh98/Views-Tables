--------------------------------------------------------
--  DDL for Package PAY_BTH_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_BTH_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,action_if_exists                varchar2(30)
  ,batch_reference                 varchar2(30)
  ,batch_source                    varchar2(150)
  ,batch_type                      varchar2(30)
  ,comments                        varchar2(2000)    -- pseudo column
  ,date_effective_changes          varchar2(30)
  ,purge_after_transfer            varchar2(30)
  ,reject_if_future_changes        varchar2(30)
  ,reject_if_results_exists        varchar2(30)
  ,purge_after_rollback            varchar2(30)
  ,REJECT_ENTRY_NOT_REMOVED        varchar2(30)
  ,ROLLBACK_ENTRY_UPDATES          varchar2(30)
