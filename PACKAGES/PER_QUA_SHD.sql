--------------------------------------------------------
--  DDL for Package PER_QUA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_QUA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  qualification_id                  number(9),
  business_group_id                 number(15),
  object_version_number             number(9),
  person_id                         per_qualifications.person_id%TYPE,
  title                             varchar2(120),
  grade_attained                    varchar2(100),
  status                            varchar2(100),
  awarded_date                      date,
  fee                               number(15,2),
  fee_currency                      varchar2(15),
  training_completed_amount         number(15,2),
  reimbursement_arrangements        varchar2(2000),
  training_completed_units          varchar2(100),
  total_training_amount             number(15,2),
  start_date                        date,
  end_date                          date,
  license_number                    varchar2(60),
  expiry_date                       date,
  license_restrictions              varchar2(255),
  projected_completion_date         date,
  awarding_body                     varchar2(100),
  tuition_method                    varchar2(30),
  group_ranking                     varchar2(100),
  comments                          varchar2(2000),   -- pseudo column
  qualification_type_id             number(9),
  attendance_id                     number(9),
  ...
  qua_information_category                varchar2(30),
  qua_information1                        varchar2(150),
  qua_information2                        varchar2(150),
  qua_information3                        varchar2(150),
  qua_information4                        varchar2(150),
  qua_information5                        varchar2(150),
  qua_information6                        varchar2(150),
  qua_information7                        varchar2(150),
  qua_information8                        varchar2(150),
  qua_information9                        varchar2(150),
  qua_information10                       varchar2(150),
  qua_information11                       varchar2(150),
  qua_information12                       varchar2(150),
  qua_information13                       varchar2(150),
  qua_information14                       varchar2(150),
  qua_information15                       varchar2(150),
  qua_information16                       varchar2(150),
  qua_information17                       varchar2(150),
  qua_information18                       varchar2(150),
  qua_information19                       varchar2(150),
  qua_information20                       varchar2(150),
  professional_body_name             varchar2(80),
  membership_number                  varchar2(80),
  membership_category                varchar2(80),
  subscription_payment_method        varchar2(80),
  party_id                           per_qualifications.party_id%TYPE -- HR/TCA merge
  );
--
-- ----------------------------------------------------------------------------
...
g_tab_nam  constant varchar2(30) := 'PER_QUALIFICATIONS';
--
-- ----------------------------------------------------------------------------
