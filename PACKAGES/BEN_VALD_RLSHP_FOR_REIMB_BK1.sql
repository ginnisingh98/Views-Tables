--------------------------------------------------------
--  DDL for Package BEN_VALD_RLSHP_FOR_REIMB_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_VALD_RLSHP_FOR_REIMB_BK1" AUTHID CURRENT_USER as
/* $Header: bevrpapi.pkh 120.0 2005/05/28 12:12:17 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Vald_Rlshp_For_Reimb_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Vald_Rlshp_For_Reimb_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Vald_Rlshp_For_Reimb_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Vald_Rlshp_For_Reimb_a
  (
...
--
end ben_Vald_Rlshp_For_Reimb_bk1;
