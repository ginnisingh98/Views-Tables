--------------------------------------------------------
--  DDL for Package BEN_DRR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DRR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_dsgn_rqmt_rlshp_typ_id already exists.
--
--  In Arguments:
...
function return_legislation_code
  (p_dsgn_rqmt_rlshp_typ_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
