--------------------------------------------------------
--  DDL for Package BEN_CRP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CRP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cbr_per_in_ler_id already exists.
--
--  In Arguments:
--    p_cbr_per_in_ler_id
--
...
function return_legislation_code
  (p_cbr_per_in_ler_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
