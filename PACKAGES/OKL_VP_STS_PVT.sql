--------------------------------------------------------
--  DDL for Package OKL_VP_STS_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_VP_STS_PVT" AUTHID CURRENT_USER AS
/*$Header: OKLRSSCS.pls 115.5 2002/12/18 12:51:25 kjinger noship $*/
...
SUBTYPE sts_tbl_type IS vp_sts_tbl_type;
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME			CONSTANT VARCHAR2(200) := 'OKL_VP_STS_PVT';
