--------------------------------------------------------
--  DDL for Package BEN_EJP_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EJP_INS" AUTHID CURRENT_USER as
...
--   Internal Development Use Only.
--
procedure set_base_key_value(p_elig_job_prte_id  in  number);
