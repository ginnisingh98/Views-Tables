--------------------------------------------------------
--  DDL for Package OKL_SETUP_PRD_PRCTEMPL_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SETUP_PRD_PRCTEMPL_PVT" AUTHID CURRENT_USER AS
/* $Header: OKLRPPES.pls 115.3 2002/02/18 19:50:19 pkm ship        $ */
  ...
  G_PKG_NAME                  CONSTANT VARCHAR2(30)  := 'OKL_SETUP_PRD_PRCTEMPL_PVT';
