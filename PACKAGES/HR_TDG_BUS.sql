--------------------------------------------------------
--  DDL for Package HR_TDG_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TDG_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_template_data_group_id already exists.
--
--  In Arguments:
