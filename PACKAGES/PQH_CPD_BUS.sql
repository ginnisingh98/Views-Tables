--------------------------------------------------------
--  DDL for Package PQH_CPD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CPD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_corps_definition_id
--     already exists.
--
--  In Arguments:
