--------------------------------------------------------
--  DDL for Package OE_UPGRADE_MISC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_UPGRADE_MISC" AUTHID CURRENT_USER AS
/* $Header: OEXIUMSS.pls 115.5 2003/10/20 06:58:30 appldev ship $ */
