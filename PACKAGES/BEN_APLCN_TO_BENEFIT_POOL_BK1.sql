--------------------------------------------------------
--  DDL for Package BEN_APLCN_TO_BENEFIT_POOL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_APLCN_TO_BENEFIT_POOL_BK1" AUTHID CURRENT_USER as
/* $Header: beabpapi.pkh 120.0 2005/05/28 00:17:58 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Aplcn_To_Benefit_Pool_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Aplcn_To_Benefit_Pool_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_Aplcn_To_Benefit_Pool_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_Aplcn_To_Benefit_Pool_a
  (
...
--
end ben_Aplcn_To_Benefit_Pool_bk1;
