--------------------------------------------------------
--  DDL for Package PQH_LOS_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_LOS_RKD" AUTHID CURRENT_USER as
...
procedure after_delete
  ...
  ,p_situation_o                  in varchar2
  ,p_effective_start_date_o       in date
  ,p_effective_end_date_o         in date
  ,p_business_group_id_o          in number
  ,p_situation_type_o             in varchar2
  ,p_length_of_service_o          in varchar2
  ,p_employee_type_o              in varchar2
  ,p_entitlement_flag_o           in varchar2
  ,p_worktime_proportional_o      in varchar2
  ,p_entitlement_value_o          in number
