--------------------------------------------------------
--  DDL for Package BEN_PGC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PGC_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  pgm_dpnt_cvg_ctfn_id              number(15),
  ...
  pgc_attribute_category            varchar2(30),
  pgc_attribute1                    varchar2(150),
  pgc_attribute2                    varchar2(150),
  pgc_attribute3                    varchar2(150),
  pgc_attribute4                    varchar2(150),
  pgc_attribute5                    varchar2(150),
  pgc_attribute6                    varchar2(150),
  pgc_attribute7                    varchar2(150),
  pgc_attribute8                    varchar2(150),
  pgc_attribute9                    varchar2(150),
  pgc_attribute10                   varchar2(150),
  pgc_attribute11                   varchar2(150),
  pgc_attribute12                   varchar2(150),
  pgc_attribute13                   varchar2(150),
  pgc_attribute14                   varchar2(150),
  pgc_attribute15                   varchar2(150),
  pgc_attribute16                   varchar2(150),
  pgc_attribute17                   varchar2(150),
  pgc_attribute18                   varchar2(150),
  pgc_attribute19                   varchar2(150),
  pgc_attribute20                   varchar2(150),
  pgc_attribute21                   varchar2(150),
  pgc_attribute22                   varchar2(150),
  pgc_attribute23                   varchar2(150),
  pgc_attribute24                   varchar2(150),
  pgc_attribute25                   varchar2(150),
  pgc_attribute26                   varchar2(150),
  pgc_attribute27                   varchar2(150),
  pgc_attribute28                   varchar2(150),
  pgc_attribute29                   varchar2(150),
  pgc_attribute30                   varchar2(150),
...
--           p_base_key_value = :pgm_dpnt_cvg_ctfn_id).
--
-- Post Success:
--   Processing continues.
--
