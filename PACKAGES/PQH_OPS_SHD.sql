--------------------------------------------------------
--  DDL for Package PQH_OPS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_OPS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (wrkplc_vldtn_op_id              number(15)
  ,wrkplc_vldtn_ver_id             number(15)
  ,wrkplc_operation_id             number(15)
  ,business_group_id               number(15)
  ,description                     varchar2(100)
  ,unit_percentage                 number(10)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_WRKPLC_VLDTN_OPS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
