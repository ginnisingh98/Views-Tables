--------------------------------------------------------
--  DDL for Package HR_QSA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_QSA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  questionnaire_answer_id           number(15),
  questionnaire_template_id         number(15),
  type                              varchar2(30),
  type_object_id                    number(15),
