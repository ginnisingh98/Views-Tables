--------------------------------------------------------
--  DDL for Package PER_SSB_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SSB_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_setup_sub_task_code
--     already exists.
--
--  In Arguments:
