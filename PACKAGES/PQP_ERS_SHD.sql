--------------------------------------------------------
--  DDL for Package PQP_ERS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_ERS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,exception_report_period         varchar2(80)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQP_EXCEPTION_REPORT_SUFFIX';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
