--------------------------------------------------------
--  DDL for Package PQP_FFA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_FFA_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_flxdu_func_attribute_id
--     already exists.
--
--  In Arguments:
