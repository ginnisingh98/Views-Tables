--------------------------------------------------------
--  DDL for Package OTA_FMS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_FMS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (forum_message_id                number(9)
  ,forum_id                        number(9)
  ,forum_thread_id                 number(9)
  ,business_group_id               number(15)
  ,message_body                    varchar2(4000)
  ,parent_message_id               number(9)
  ,person_id                       number(10)
  ,contact_id                      number(15)
  ,target_person_id                number(10)
  ,target_contact_id               number(15)
  ,message_scope                   varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_FORUM_MESSAGES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
