--------------------------------------------------------
--  DDL for Package OKL_CONTRACT_LINE_ITEM_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_CONTRACT_LINE_ITEM_PVT_W" AUTHID CURRENT_USER as
  /* $Header: OKLECLIS.pls 115.2 2003/10/16 01:11:50 smereddy noship $ */
