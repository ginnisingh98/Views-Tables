--------------------------------------------------------
--  DDL for Package PAY_NCR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_NCR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  net_calculation_rule_id           number(9),
  accrual_plan_id                   number(9),
  business_group_id                 number(15),
  input_value_id                    number(9),
  add_or_subtract                   varchar2(30),
