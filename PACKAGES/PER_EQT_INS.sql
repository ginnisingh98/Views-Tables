--------------------------------------------------------
--  DDL for Package PER_EQT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_EQT_INS" AUTHID CURRENT_USER as
...
-- Added  Developer DF columns as arguments to ins procedure
