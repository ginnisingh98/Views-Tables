--------------------------------------------------------
--  DDL for Package AHL_DI_SUBSCRIPTION_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_DI_SUBSCRIPTION_PUB_W" AUTHID CURRENT_USER as
  /* $Header: AHLSUBWS.pls 115.10 2003/07/28 07:30:56 pbarman noship $ */
  procedure rosetta_table_copy_in_p1(t out nocopy ahl_di_subscription_pub.subscription_tbl, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p1(t ahl_di_subscription_pub.subscription_tbl, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure create_subscription(p_api_version  NUMBER
    ...
    , p5_a6 in out nocopy JTF_VARCHAR2_TABLE_400
    ...
    , p5_a12 in out nocopy JTF_VARCHAR2_TABLE_400
    ...
    , p5_a38 in out nocopy JTF_VARCHAR2_TABLE_2000
  ...
  procedure modify_subscription(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , p_commit  VARCHAR2
    , p_validate_only  VARCHAR2
    , p_validation_level  NUMBER
