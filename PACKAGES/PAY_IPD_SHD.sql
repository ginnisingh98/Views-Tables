--------------------------------------------------------
--  DDL for Package PAY_IPD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_IPD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,comm_period_no                  number(10)
  ,tax_basis                       varchar2(30)
  ,certificate_start_date          date
  ,certificate_end_date            date
  ,tax_assess_basis                varchar2(30)
  ,weekly_tax_credit               number
  ,weekly_std_rate_cut_off         number
  ,monthly_tax_credit              number
  ,monthly_std_rate_cut_off        number
