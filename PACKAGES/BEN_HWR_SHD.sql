--------------------------------------------------------
--  DDL for Package BEN_HWR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_HWR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  hrs_wkd_in_perd_rt_id             number(15),
  ...
  hwr_attribute_category            varchar2(30),
  hwr_attribute1                    varchar2(150),
  hwr_attribute2                    varchar2(150),
  hwr_attribute3                    varchar2(150),
  hwr_attribute4                    varchar2(150),
  hwr_attribute5                    varchar2(150),
  hwr_attribute6                    varchar2(150),
  hwr_attribute7                    varchar2(150),
  hwr_attribute8                    varchar2(150),
  hwr_attribute9                    varchar2(150),
  hwr_attribute10                   varchar2(150),
  hwr_attribute11                   varchar2(150),
  hwr_attribute12                   varchar2(150),
  hwr_attribute13                   varchar2(150),
  hwr_attribute14                   varchar2(150),
  hwr_attribute15                   varchar2(150),
  hwr_attribute16                   varchar2(150),
  hwr_attribute17                   varchar2(150),
  hwr_attribute18                   varchar2(150),
  hwr_attribute19                   varchar2(150),
  hwr_attribute20                   varchar2(150),
  hwr_attribute21                   varchar2(150),
  hwr_attribute22                   varchar2(150),
  hwr_attribute23                   varchar2(150),
  hwr_attribute24                   varchar2(150),
  hwr_attribute25                   varchar2(150),
  hwr_attribute26                   varchar2(150),
  hwr_attribute27                   varchar2(150),
  hwr_attribute28                   varchar2(150),
  hwr_attribute29                   varchar2(150),
  hwr_attribute30                   varchar2(150),
...
--           p_base_key_value = :hrs_wkd_in_perd_rt_id).
--
-- Post Success:
--   Processing continues.
--
