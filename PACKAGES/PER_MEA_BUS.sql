--------------------------------------------------------
--  DDL for Package PER_MEA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_MEA_BUS" AUTHID CURRENT_USER as
...
--
--  Description:
--    Checks that the consultation date is not after the
...
--
--  Post Failure:
--    An error is raised if the date combination is invalid
--
--  Access Status:
...
--
--  Prerequisites:
--    The primary key identified by p_medical_assessment_id
--     already exists.
--
--  In Arguments:
