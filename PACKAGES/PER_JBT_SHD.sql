--------------------------------------------------------
--  DDL for Package PER_JBT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_JBT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,name                            varchar2(700)     -- Increased length 3213714
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_JOBS_TL';
--
--
g_app_code  varchar2(3) := 'PER';
g_flex_code varchar2(3) := 'JOB';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
