--------------------------------------------------------
--  DDL for Package HR_DM_MASTER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_DM_MASTER" AUTHID CURRENT_USER AS
/* $Header: perdmmas.pkh 120.0 2005/05/31 17:12:10 appldev noship $ */
