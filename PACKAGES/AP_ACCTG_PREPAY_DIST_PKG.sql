--------------------------------------------------------
--  DDL for Package AP_ACCTG_PREPAY_DIST_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_ACCTG_PREPAY_DIST_PKG" AUTHID CURRENT_USER AS
/* $Header: appredis.pls 120.11.12010000.6 2010/04/01 23:58:17 gagrawal ship $ */
 ...
 (SELECT AID.Invoice_ID,
  ...
  AND    NVL(AID.Accounting_Event_ID, -99) =
             DECODE(P_Event_ID, NULL, NVL(AID.Accounting_Event_ID, -99),
                    P_Event_ID)
  AND    AID.Line_Type_Lookup_Code NOT IN ('PREPAY', 'ERV')
