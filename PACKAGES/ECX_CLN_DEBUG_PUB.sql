--------------------------------------------------------
--  DDL for Package ECX_CLN_DEBUG_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ECX_CLN_DEBUG_PUB" AUTHID CURRENT_USER AS
/* $Header: ECXCLNDBGS.pls 120.0 2005/08/25 04:45:53 nparihar noship $ */
/*#
