--------------------------------------------------------
--  DDL for Package OTA_CRT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CRT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_certification_id
--     already exists.
--
--  In Arguments:
--    p_certification_id
