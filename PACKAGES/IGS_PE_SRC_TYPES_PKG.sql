--------------------------------------------------------
--  DDL for Package IGS_PE_SRC_TYPES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_PE_SRC_TYPES_PKG" AUTHID CURRENT_USER AS
/* $Header: IGSNI65S.pls 120.0 2005/06/01 18:56:37 appldev noship $ */
