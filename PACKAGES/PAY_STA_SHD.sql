--------------------------------------------------------
--  DDL for Package PAY_STA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_STA_SHD" AUTHID CURRENT_USER AS
...
Type g_rec_type Is Record
  (
  emp_state_tax_rule_id             number(9),
  ...
  remainder_percent                 number(11,2),      -- Increased length
  secondary_wa                      number(11),        -- Increased length
  sit_additional_tax                number(11,2),
  sit_override_amount               number(11,2),
  sit_override_rate                 number(11,2),      -- Increased length
  withholding_allowances            number(11),        -- Increased length
  excessive_wa_reject_date          date,
  sdi_exempt                        varchar2(30),
  sit_exempt                        varchar2(30),
  sit_optional_calc_ind             varchar2(30),
  state_non_resident_cert           varchar2(30),
  sui_exempt                        varchar2(30),
  wc_exempt                         varchar2(30),
  wage_exempt                       varchar2(30),
  sui_wage_base_override_amount     number(11,2),
  ...
  sta_information_category                varchar2(30),
  sta_information1                        varchar2(150),
  sta_information2                        varchar2(150),
  sta_information3                        varchar2(150),
  sta_information4                        varchar2(150),
  sta_information5                        varchar2(150),
  sta_information6                        varchar2(150),
  sta_information7                        varchar2(150),
  sta_information8                        varchar2(150),
  sta_information9                        varchar2(150),
  sta_information10                       varchar2(150),
  sta_information11                       varchar2(150),
  sta_information12                       varchar2(150),
  sta_information13                       varchar2(150),
  sta_information14                       varchar2(150),
  sta_information15                       varchar2(150),
  sta_information16                       varchar2(150),
  sta_information17                       varchar2(150),
  sta_information18                       varchar2(150),
  sta_information19                       varchar2(150),
  sta_information20                       varchar2(150),
  sta_information21                       varchar2(150),
  sta_information22                       varchar2(150),
  sta_information23                      varchar2(150),
  sta_information24                      varchar2(150),
  sta_information25                       varchar2(150),
  sta_information26                       varchar2(150),
  sta_information27                       varchar2(150),
  sta_information28                       varchar2(150),
  sta_information29                       varchar2(150),
  sta_information30                       varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
...
--           p_base_key_value = :emp_state_tax_rule_id).
--
-- Post Success:
--   Processing continues.
--
