--------------------------------------------------------
--  DDL for Package PER_RCF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RCF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_rec_activity_for_id
--     already exists.
--
--  In Arguments:
