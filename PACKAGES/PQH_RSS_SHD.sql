--------------------------------------------------------
--  DDL for Package PQH_RSS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RSS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (result_set_id                   number(15)
  ,gradual_value_number_from       number(9)         -- Increased length
  ,gradual_value_number_to         number(9)         -- Increased length
  ,grade_id                        number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_RESULT_SETS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
