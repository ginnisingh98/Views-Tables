--------------------------------------------------------
--  DDL for Package JL_FND_REQUEST
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JL_FND_REQUEST" AUTHID CURRENT_USER as
/* $Header: jlfndrqs.pls 115.1 99/07/16 03:12:05 porting ship $ */
