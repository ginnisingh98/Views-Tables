--------------------------------------------------------
--  DDL for Package PER_ZA_LSA_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_LSA_INS" AUTHID CURRENT_USER as
/* $Header: pezalsin.pkh 115.1 2002/12/05 06:50:03 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< ins >----------------------------------|
-- ----------------------------------------------------------------------------
