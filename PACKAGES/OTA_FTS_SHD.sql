--------------------------------------------------------
--  DDL for Package OTA_FTS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_FTS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,subject                         varchar2(800)
  ,last_post_date                  date
  ,reply_count                     number(10)
  ,private_thread_flag             varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_FORUM_THREADS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
