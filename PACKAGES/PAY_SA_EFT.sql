--------------------------------------------------------
--  DDL for Package PAY_SA_EFT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_SA_EFT" AUTHID CURRENT_USER as
/* $Header: pysaeftp.pkh 120.0 2005/05/29 08:30:12 appldev noship $ */
level_cnt NUMBER;
l_id_header number;
l_id_body number;
l_id_footer number;
...
FUNCTION get_customer_formula_header    (
                                ...
                                ,p_report_text10 OUT NOCOPY VARCHAR2) return varchar2;
--
--
...
FUNCTION get_customer_formula_body      (
                                ...
                                ,p_local_nationality IN VARCHAR2) return varchar2;
--
/*
--
...
CURSOR CSR_SA_EFT_HEADER IS
SELECT 'CREATION_DATE=P'
      ,to_char(ppa.effective_date, 'YYYYMMDD')

      ,'PROCESS_DATE=P'
      ,to_char(fnd_date.canonical_to_date(pay_sa_general.get_parameter(
      ...
      ,ppa.payroll_action_id
       ,'COUNT1=P'
      ,pay_sa_general.get_count
      ,'SUM1=P'
      ,pay_sa_general.get_sum  * 100
...
SELECT 'AMOUNT=P'
      ...
      ,'ASG_NO=P'
      ,decode(pay_sa_general.chk_multiple_assignments(ppa.effective_date,paf.person_id)
      ...
      ,'LOCAL_NATIONALITY=P'
      ,pay_sa_general.get_parameter(ppa.legislative_parameters,
                                'LOCAL_NATIONALITY')
...
ORDER BY decode(pay_sa_general.get_parameter(legislative_parameters,
                                  'SORT_ORDER'),
