--------------------------------------------------------
--  DDL for Package INV_LABEL_PVT4
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."INV_LABEL_PVT4" AUTHID CURRENT_USER AS
/* $Header: INVLAP4S.pls 120.1.12010000.3 2009/11/26 12:09:04 abasheer ship $ */
G_PKG_NAME	CONSTANT VARCHAR2(50) := 'INV_LABEL_PVT4';
...
, item_attribute1         VARCHAR2(240)    -- Bug#8523069
, item_attribute2         VARCHAR2(240)    -- Bug#8523069
, item_attribute3         VARCHAR2(240)    -- Bug#8523069
, item_attribute4         VARCHAR2(240)    -- Bug#8523069
, item_attribute5         VARCHAR2(240)    -- Bug#8523069
, item_attribute6         VARCHAR2(240)    -- Bug#8523069
, item_attribute7         VARCHAR2(240)    -- Bug#8523069
, item_attribute8         VARCHAR2(240)    -- Bug#8523069
, item_attribute9         VARCHAR2(240)    -- Bug#8523069
, item_attribute10        VARCHAR2(240)    -- Bug#8523069
, item_attribute11        VARCHAR2(240)    -- Bug#8523069
, item_attribute12        VARCHAR2(240)    -- Bug#8523069
, item_attribute13        VARCHAR2(240)    -- Bug#8523069
, item_attribute14        VARCHAR2(240)    -- Bug#8523069
, item_attribute15        VARCHAR2(240)    -- Bug#8523069
...
, parent_lot_number      VARCHAR2(80) -- invcovn changes start
, expiration_action_date DATE
, origination_type       NUMBER(2)
, hold_date              DATE
, expiration_action_code VARCHAR2(32)
, supplier_lot_number    VARCHAR2(150) -- invcovn changes start
);
