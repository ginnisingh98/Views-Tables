--------------------------------------------------------
--  DDL for Package FARX_C_MCP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FARX_C_MCP" AUTHID CURRENT_USER AS
/* $Header: FARXCMCPS.pls 120.0.12010000.2 2009/07/19 11:51:59 glchen ship $ */

/*=====================================================================================+
|
|   Name:          Mass_Change_Preview
|
|   Description:   Concurrent wrapper procedure for mass change preview.
|                  This procedure calls the inner procedure,
|                  FARX_CP.Preview_Change() that actually performs
|                  preview of a mass change transaction.
|
