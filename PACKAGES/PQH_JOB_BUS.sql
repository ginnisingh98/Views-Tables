--------------------------------------------------------
--  DDL for Package PQH_JOB_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_JOB_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_wrkplc_vldtn_job_id
--     already exists.
--
--  In Arguments:
