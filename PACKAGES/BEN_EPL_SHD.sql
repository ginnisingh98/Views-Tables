--------------------------------------------------------
--  DDL for Package BEN_EPL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_pstl_cd_r_rng_cvg_id         number(15),
  ...
  epl_attribute_category            varchar2(30),
  epl_attribute1                    varchar2(150),
  epl_attribute2                    varchar2(150),
  epl_attribute3                    varchar2(150),
  epl_attribute4                    varchar2(150),
  epl_attribute5                    varchar2(150),
  epl_attribute6                    varchar2(150),
  epl_attribute7                    varchar2(150),
  epl_attribute8                    varchar2(150),
  epl_attribute9                    varchar2(150),
  epl_attribute10                   varchar2(150),
  epl_attribute11                   varchar2(150),
  epl_attribute12                   varchar2(150),
  epl_attribute13                   varchar2(150),
  epl_attribute14                   varchar2(150),
  epl_attribute15                   varchar2(150),
  epl_attribute16                   varchar2(150),
  epl_attribute17                   varchar2(150),
  epl_attribute18                   varchar2(150),
  epl_attribute19                   varchar2(150),
  epl_attribute20                   varchar2(150),
  epl_attribute21                   varchar2(150),
  epl_attribute22                   varchar2(150),
  epl_attribute23                   varchar2(150),
  epl_attribute24                   varchar2(150),
  epl_attribute25                   varchar2(150),
  epl_attribute26                   varchar2(150),
  epl_attribute27                   varchar2(150),
  epl_attribute28                   varchar2(150),
  epl_attribute29                   varchar2(150),
  epl_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_pstl_cd_r_rng_cvg_id).
--
-- Post Success:
--   Processing continues.
--
