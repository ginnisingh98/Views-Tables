--------------------------------------------------------
--  DDL for Package PQH_VER_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_VER_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_wrkplc_vldtn_ver_id
--     already exists.
--
--  In Arguments:
