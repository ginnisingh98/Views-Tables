--------------------------------------------------------
--  DDL for Package PER_CPN_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CPN_UPD" AUTHID CURRENT_USER as
...
Procedure upd
  ...
  p_competence_definition_id     in number           default hr_api.g_number
