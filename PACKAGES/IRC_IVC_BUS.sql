--------------------------------------------------------
--  DDL for Package IRC_IVC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IVC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_vacancy_consideration_id
--     already exists.
--
--  In Arguments:
