--------------------------------------------------------
--  DDL for Package HR_SE_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_SE_EMPLOYEE_API" AUTHID CURRENT_USER AS
/* $Header: peempsei.pkh 120.2 2005/12/08 00:58:28 rravi noship $ */
/*#
 * This package contains employee APIs for Sweden.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Employee for Sweden
*/
--
-- ----------------------------------------------------------------------------
-- |----------------------------< create_se_employee >------------------------|
 ...
 *
 * The API is effectively an alternative to the API create_employee. If
 ...
 * When creating an employee, a business group for the Sweden legislation must
 ...
 * The employee, primary assignment, and period of service will be successfully
 * inserted into the database.
 *
 * <p><b>Post Failure</b><br>
 * The employee, primary assignment or period of service will not be created and
 ...
 * @param p_sex Valid values are defined by the SEX lookup type.
 ...
 * performed.
 * @param p_blood_type Blood group of Employee.
 ...
 * @param p_coord_ben_med_ext_er Secondary medical coverage name.
 ...
 * @rep:displayname Create Employee for Sweden
