--------------------------------------------------------
--  DDL for Package IRC_IOS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_IOS_SHD" AUTHID CURRENT_USER as
/*$Header: iriosrhi.pkh 120.2 2005/09/29 09:21:32 mmillmor noship $*/
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (offer_status_history_id         number(15)
  ,offer_id                        number(15)
...
-- Global table name
g_tab_name constant varchar2(30) := 'IRC_OFFER_STATUS_HISTORY';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
