--------------------------------------------------------
--  DDL for Package PAY_MGR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_MGR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  last_run_executed_mode            varchar2(30),
  overflow_mode                     varchar2(30),
  sequence                          number(9),        -- Increased length
  frequency                         number(9) ,
