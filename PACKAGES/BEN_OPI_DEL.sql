--------------------------------------------------------
--  DDL for Package BEN_OPI_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_OPI_DEL" AUTHID CURRENT_USER as
...
--      datatype.
--   2) After the conversion has taken optace, the corresponding record del
