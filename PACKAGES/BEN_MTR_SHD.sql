--------------------------------------------------------
--  DDL for Package BEN_MTR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_MTR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  mtchg_rt_id                       number(15),
  effective_start_date              date,
  effective_end_date                date,
  acty_base_rt_id                   number(15),
  comp_lvl_fctr_id                  number(15),
  ordr_num                          number(15),
  from_pct_val                      number,        -- Increased length
  to_pct_val                        number,        -- Increased length
  pct_val                           number,        -- Increased length
  mx_amt_of_py_num                  number,
  mx_pct_of_py_num                  number,
  mx_mtch_amt                       number,
  mn_mtch_amt                       number,
  mtchg_rt_calc_rl                  number(15),
  no_mx_mtch_amt_flag               varchar2(30),
  no_mx_pct_of_py_num_flag          varchar2(30),
  cntnu_mtch_aftr_mx_rl_flag        varchar2(30),
  no_mx_amt_of_py_num_flag          varchar2(30),
  business_group_id                 number(15),
  mtr_attribute_category            varchar2(30),
  mtr_attribute1                    varchar2(150),
  mtr_attribute2                    varchar2(150),
  mtr_attribute3                    varchar2(150),
  mtr_attribute4                    varchar2(150),
  mtr_attribute5                    varchar2(150),
  mtr_attribute6                    varchar2(150),
  mtr_attribute7                    varchar2(150),
  mtr_attribute8                    varchar2(150),
  mtr_attribute9                    varchar2(150),
  mtr_attribute10                   varchar2(150),
  mtr_attribute11                   varchar2(150),
  mtr_attribute12                   varchar2(150),
  mtr_attribute13                   varchar2(150),
  mtr_attribute14                   varchar2(150),
  mtr_attribute15                   varchar2(150),
  mtr_attribute16                   varchar2(150),
  mtr_attribute17                   varchar2(150),
  mtr_attribute18                   varchar2(150),
  mtr_attribute19                   varchar2(150),
  mtr_attribute20                   varchar2(150),
  mtr_attribute21                   varchar2(150),
  mtr_attribute22                   varchar2(150),
  mtr_attribute23                   varchar2(150),
  mtr_attribute24                   varchar2(150),
  mtr_attribute25                   varchar2(150),
  mtr_attribute26                   varchar2(150),
  mtr_attribute27                   varchar2(150),
  mtr_attribute28                   varchar2(150),
  mtr_attribute29                   varchar2(150),
  mtr_attribute30                   varchar2(150),
