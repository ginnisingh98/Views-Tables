--------------------------------------------------------
--  DDL for Package AHL_RM_ROUTE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_RM_ROUTE_PVT_W" AUTHID CURRENT_USER as
  /* $Header: AHLWROMS.pls 120.0.12010000.3 2008/11/23 14:31:13 bachandr ship $ */
