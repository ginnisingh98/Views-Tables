--------------------------------------------------------
--  DDL for Package PER_ASN_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ASN_FLEX" AUTHID CURRENT_USER as
/* $Header: peasnfli.pkh 115.1 99/10/15 15:41:45 porting ship $ */
--
--
-- ----------------------------------------------------------------------------
-- |-----------------------------< df>--------------------------------------|--
