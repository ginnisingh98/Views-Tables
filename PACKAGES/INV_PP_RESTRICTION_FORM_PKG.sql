--------------------------------------------------------
--  DDL for Package INV_PP_RESTRICTION_FORM_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."INV_PP_RESTRICTION_FORM_PKG" AUTHID CURRENT_USER AS
/* $Header: INVFPRES.pls 120.1 2005/06/11 08:07:46 appldev  $ */
...
end INV_PP_RESTRICTION_FORM_PKG;
