--------------------------------------------------------
--  DDL for Package CN_SYIN_ATTR_RULES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CN_SYIN_ATTR_RULES_PKG" AUTHID CURRENT_USER AS
-- $Header: cnsyinhs.pls 120.5 2005/07/08 09:45:10 appldev ship $
...
PROCEDURE Populate_Fields (x_column_id                 number,
                           ...
                           x_user_column_name  IN OUT NOCOPY varchar2,
                           x_dim_hier_id               number,
                           x_hier_name         IN OUT NOCOPY varchar2,
                           x_value_id                  varchar2,
                           x_hier_value        IN OUT NOCOPY varchar2,
			   x_org_id            IN NUMBER) ;
  --
  -- Procedure Name
  --   default_row
  ...
  --   01/26/94         Tony Lower              Created
  --
PROCEDURE Default_Row (X_rule_id        IN OUT NOCOPY  number);
