--------------------------------------------------------
--  DDL for Package PO_ATTR_VALUES_TLP_DRAFT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PO_ATTR_VALUES_TLP_DRAFT_PKG" AUTHID CURRENT_USER AS
/* $Header: PO_ATTR_VALUES_TLP_DRAFT_PKG.pls 120.1 2005/06/30 17:34 bao noship $ */
