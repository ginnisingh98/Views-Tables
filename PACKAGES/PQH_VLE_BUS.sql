--------------------------------------------------------
--  DDL for Package PQH_VLE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_VLE_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_validation_event_id
--     already exists.
--
--  In Arguments:
