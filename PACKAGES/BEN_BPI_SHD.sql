--------------------------------------------------------
--  DDL for Package BEN_BPI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BPI_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  per_slctd                         number(15),
  per_proc                          number(15),
  per_unproc                        number(15),
  per_proc_succ                     number(15),
  per_err                           number(15),
