--------------------------------------------------------
--  DDL for Package SSP_SSPRPSMP_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."SSP_SSPRPSMP_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: SSPRPSMPS.pls 120.1 2007/12/24 14:07:25 amakrish noship $ */
	...
	function c_smpformula(M_due_date in date, M_PERSON_ID in number) return varchar2  ;
