--------------------------------------------------------
--  DDL for Package AP_APXIAWRE_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_APXIAWRE_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: APXIAWRES.pls 120.0 2007/12/27 07:44:07 vjaganat noship $ */
  ...
  P_FROM_INVOICE_DATE DATE;
  P_FROM_INVOICE_DATE_V varchar2(50);

  P_TO_INVOICE_DATE DATE;
  P_TO_INVOICE_DATE_V varchar2(50);

  LP_VENDOR_ID VARCHAR2(40);

  LP_INVOICES_NUMBER VARCHAR2(40);

  LP_INVOICE_DATE_FROM VARCHAR2(100);

  LP_INVOICE_DATE_TO VARCHAR2(100);

  LP_APPROVAL_TIMING VARCHAR2(200);

  P_APPROVAL_TIMING VARCHAR2(1);
  ...
  FUNCTION CF_RAISE_EVENTFORMULA(C_ITERATION IN NUMBER
                                ,C_INVOICE_ID IN NUMBER) RETURN NUMBER;
