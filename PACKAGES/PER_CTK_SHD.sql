--------------------------------------------------------
--  DDL for Package PER_CTK_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CTK_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (task_in_checklist_id            number(15)
  ,checklist_id                    number(15)
  ,checklist_task_name             varchar2(240)
  ,eligibility_object_id           number(15)
  ,eligibility_profile_id          number(15)
  ,ame_attribute_identifier        varchar2(30)
  ,description                     varchar2(360)
  ,mandatory_flag                  varchar2(30)
  ,target_duration                 number(9)
  ,target_duration_uom             varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_TASKS_IN_CHECKLIST';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
