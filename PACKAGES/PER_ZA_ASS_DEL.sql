--------------------------------------------------------
--  DDL for Package PER_ZA_ASS_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_ASS_DEL" AUTHID CURRENT_USER as
/* $Header: pezaasde.pkh 115.0 2001/02/04 22:30:22 pkm ship        $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< del >----------------------------------|
-- ----------------------------------------------------------------------------
