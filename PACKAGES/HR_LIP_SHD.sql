--------------------------------------------------------
--  DDL for Package HR_LIP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_LIP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (liability_premiums_id           number(15)
  ,organization_link_id            number(15)
  ,effective_start_date            date
  ,effective_end_date              date
  ,std_percentage                  number(16,5)      -- Increased length
  ,calculation_method              varchar2(30)
  ,std_working_hours_per_year      number(15)
  ,max_remuneration                number(15)
...
--           p_base_key_value = :liability_premiums_id).
--
-- Post Success:
