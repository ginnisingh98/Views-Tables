--------------------------------------------------------
--  DDL for Package AMS_MET_TPL_ASSOC_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_MET_TPL_ASSOC_PVT" AUTHID CURRENT_USER AS
/* $Header: amsvmtas.pls 120.0 2005/05/31 20:41:34 appldev noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
...
--===================================================================
TYPE met_tpl_assoc_rec_type IS RECORD
(
       metric_tpl_assoc_id             NUMBER := FND_API.G_MISS_NUM,
...
g_miss_met_tpl_assoc_rec          met_tpl_assoc_rec_type;
TYPE  met_tpl_assoc_tbl_type      IS TABLE OF met_tpl_assoc_rec_type INDEX BY BINARY_INTEGER;
g_miss_met_tpl_assoc_tbl          met_tpl_assoc_tbl_type;

--   ==============================================================================
--    Start of Comments
--   ==============================================================================
--   API Name
--           Create_Met_Tpl_Assoc
--   Type
--           Private
--   Pre-Req
--
...
--       p_met_tpl_assoc_rec            IN   met_tpl_assoc_rec_type  Required
--
--   OUT
...
--       p_commit                  IN   VARCHAR2   Optional  Default = FND_API.G_FALSE
--       p_validation_level        IN   NUMBER     Optional  Default = FND_API.G_VALID_LEVEL_FULL
--       p_AMS_METRIC_TPL_ASSOC_ID                IN   NUMBER
