--------------------------------------------------------
--  DDL for Package BEN_ASR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ASR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  asr_attribute_category            varchar2(30),
  asr_attribute1                    varchar2(150),
  asr_attribute2                    varchar2(150),
  asr_attribute3                    varchar2(150),
  asr_attribute4                    varchar2(150),
  asr_attribute5                    varchar2(150),
  asr_attribute6                    varchar2(150),
  asr_attribute7                    varchar2(150),
  asr_attribute8                    varchar2(150),
  asr_attribute9                    varchar2(150),
  asr_attribute10                   varchar2(150),
  asr_attribute11                   varchar2(150),
  asr_attribute12                   varchar2(150),
  asr_attribute13                   varchar2(150),
  asr_attribute14                   varchar2(150),
  asr_attribute15                   varchar2(150),
  asr_attribute16                   varchar2(150),
  asr_attribute17                   varchar2(150),
  asr_attribute18                   varchar2(150),
  asr_attribute19                   varchar2(150),
  asr_attribute20                   varchar2(150),
  asr_attribute21                   varchar2(150),
  asr_attribute22                   varchar2(150),
  asr_attribute23                   varchar2(150),
  asr_attribute24                   varchar2(150),
  asr_attribute25                   varchar2(150),
  asr_attribute26                   varchar2(150),
  asr_attribute27                   varchar2(150),
  asr_attribute28                   varchar2(150),
  asr_attribute29                   varchar2(150),
  asr_attribute30                   varchar2(150),
...
--           p_base_key_value = :asnt_set_rt_id).
--
-- Post Success:
--   Processing continues.
--
