--------------------------------------------------------
--  DDL for Package PAY_EVQ_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EVQ_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_event_qualifier_id
--     already exists.
--
--  In Arguments:
