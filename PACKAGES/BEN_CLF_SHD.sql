--------------------------------------------------------
--  DDL for Package BEN_CLF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CLF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  comp_lvl_det_cd                   varchar2(30),
  comp_lvl_det_rl                   number(15),
  comp_lvl_uom                      varchar2(30),
  comp_src_cd                       varchar2(30),
  ...
  rndg_cd                           varchar2(30),
  rndg_rl                           number(15),
  bnfts_bal_id                      number(15),
  comp_alt_val_to_use_cd            varchar2(30),
  comp_calc_rl                      number(15),
  proration_flag                    Varchar2(30),
  start_day_mo                      Varchar2(4),
  end_day_mo                        Varchar2(4),
  start_year                        Varchar2(4),
  end_year                          Varchar2(4),
  clf_attribute_category            varchar2(30),
  clf_attribute1                    varchar2(150),
  clf_attribute2                    varchar2(150),
  clf_attribute3                    varchar2(150),
  clf_attribute4                    varchar2(150),
  clf_attribute5                    varchar2(150),
  clf_attribute6                    varchar2(150),
  clf_attribute7                    varchar2(150),
  clf_attribute8                    varchar2(150),
  clf_attribute9                    varchar2(150),
  clf_attribute10                   varchar2(150),
  clf_attribute11                   varchar2(150),
  clf_attribute12                   varchar2(150),
  clf_attribute13                   varchar2(150),
  clf_attribute14                   varchar2(150),
  clf_attribute15                   varchar2(150),
  clf_attribute16                   varchar2(150),
  clf_attribute17                   varchar2(150),
  clf_attribute18                   varchar2(150),
  clf_attribute19                   varchar2(150),
  clf_attribute20                   varchar2(150),
  clf_attribute21                   varchar2(150),
  clf_attribute22                   varchar2(150),
  clf_attribute23                   varchar2(150),
  clf_attribute24                   varchar2(150),
  clf_attribute25                   varchar2(150),
  clf_attribute26                   varchar2(150),
  clf_attribute27                   varchar2(150),
  clf_attribute28                   varchar2(150),
  clf_attribute29                   varchar2(150),
  clf_attribute30                   varchar2(150),
  object_version_number             number(9),
  sttd_sal_prdcty_cd                varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
Function convert_args
  ...
  p_proration_flag                    Varchar2,
  p_start_day_mo                      Varchar2,
  p_end_day_mo                        Varchar2,
