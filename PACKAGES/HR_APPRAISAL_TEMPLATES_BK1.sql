--------------------------------------------------------
--  DDL for Package HR_APPRAISAL_TEMPLATES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_APPRAISAL_TEMPLATES_BK1" AUTHID CURRENT_USER as
/* $Header: peaptapi.pkh 120.4.12010000.6 2010/02/09 15:05:01 psugumar ship $ */
--
-- --------------------------------------------------------------------------
-- |-----------------------< create_appraisal_template_b >------------------|
-- --------------------------------------------------------------------------

Procedure create_appraisal_template_b	(
...
-- --------------------------------------------------------------------------
-- |-----------------------< create_appraisal_template_a >------------------|
-- --------------------------------------------------------------------------

Procedure create_appraisal_template_a	(
...
end hr_appraisal_templates_bk1;
