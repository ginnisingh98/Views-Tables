--------------------------------------------------------
--  DDL for Package PAY_PEV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PEV_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (process_event_id                number(9)
  ,assignment_id                   number(10)
  ,effective_date                  date
  ,change_type                     varchar2(30)
  ,status                          varchar2(30)
  ,description                     varchar2(240)
  ,event_update_id                 number(15)
  ,business_group_id               number(15)
  ,org_process_event_group_id      number(15)
  ,surrogate_key                   varchar2(60)
  ,object_version_number           number(9)
  ,calculation_date                date
  ,retroactive_status              varchar2(30)
  ,noted_value                     varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
