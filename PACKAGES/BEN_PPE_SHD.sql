--------------------------------------------------------
--  DDL for Package BEN_PPE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PPE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  std_prem_uom                      varchar2(30),
  std_prem_val                      number,
  actl_prem_id                      number(15),
  prtt_enrt_rslt_id                 number(15),
  per_in_ler_id                 number(15),
  business_group_id                 number(15),
  ppe_attribute_category            varchar2(30),
  ppe_attribute1                    varchar2(150),
  ppe_attribute2                    varchar2(150),
  ppe_attribute3                    varchar2(150),
  ppe_attribute4                    varchar2(150),
  ppe_attribute5                    varchar2(150),
  ppe_attribute6                    varchar2(150),
  ppe_attribute7                    varchar2(150),
  ppe_attribute8                    varchar2(150),
  ppe_attribute9                    varchar2(150),
  ppe_attribute10                   varchar2(150),
  ppe_attribute11                   varchar2(150),
  ppe_attribute12                   varchar2(150),
  ppe_attribute13                   varchar2(150),
  ppe_attribute14                   varchar2(150),
  ppe_attribute15                   varchar2(150),
  ppe_attribute16                   varchar2(150),
  ppe_attribute17                   varchar2(150),
  ppe_attribute18                   varchar2(150),
  ppe_attribute19                   varchar2(150),
  ppe_attribute20                   varchar2(150),
  ppe_attribute21                   varchar2(150),
  ppe_attribute22                   varchar2(150),
  ppe_attribute23                   varchar2(150),
  ppe_attribute24                   varchar2(150),
  ppe_attribute25                   varchar2(150),
  ppe_attribute26                   varchar2(150),
  ppe_attribute27                   varchar2(150),
  ppe_attribute28                   varchar2(150),
  ppe_attribute29                   varchar2(150),
  ppe_attribute30                   varchar2(150),
