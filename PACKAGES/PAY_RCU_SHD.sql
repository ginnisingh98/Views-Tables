--------------------------------------------------------
--  DDL for Package PAY_RCU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_RCU_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (retro_component_usage_id        number(15)
  ,business_group_id               number(15)
  ,legislation_code                varchar2(30)
  ,retro_component_id              number(15)
  ,creator_id                      number(15)
  ,creator_type                    varchar2(30)
  ,default_component               varchar2(30)
  ,reprocess_type                  varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PAY_RETRO_COMPONENT_USAGES';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
