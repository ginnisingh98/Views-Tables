--------------------------------------------------------
--  DDL for Package AMS_ASSOCIATIONS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AMS_ASSOCIATIONS_PVT_W" AUTHID CURRENT_USER as
  /* $Header: amswasss.pls 120.1 2005/06/15 11:43 appldev  $ */
