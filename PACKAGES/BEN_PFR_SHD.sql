--------------------------------------------------------
--  DDL for Package BEN_PFR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PFR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ordr_num                          number(15),
  pfr_attribute_category            varchar2(30),
  pfr_attribute1                    varchar2(150),
  pfr_attribute2                    varchar2(150),
  pfr_attribute3                    varchar2(150),
  pfr_attribute4                    varchar2(150),
  pfr_attribute5                    varchar2(150),
  pfr_attribute6                    varchar2(150),
  pfr_attribute7                    varchar2(150),
  pfr_attribute8                    varchar2(150),
  pfr_attribute9                    varchar2(150),
  pfr_attribute10                   varchar2(150),
  pfr_attribute11                   varchar2(150),
  pfr_attribute12                   varchar2(150),
  pfr_attribute13                   varchar2(150),
  pfr_attribute14                   varchar2(150),
  pfr_attribute15                   varchar2(150),
  pfr_attribute16                   varchar2(150),
  pfr_attribute17                   varchar2(150),
  pfr_attribute18                   varchar2(150),
  pfr_attribute19                   varchar2(150),
  pfr_attribute20                   varchar2(150),
  pfr_attribute21                   varchar2(150),
  pfr_attribute22                   varchar2(150),
  pfr_attribute23                   varchar2(150),
  pfr_attribute24                   varchar2(150),
  pfr_attribute25                   varchar2(150),
  pfr_attribute26                   varchar2(150),
  pfr_attribute27                   varchar2(150),
  pfr_attribute28                   varchar2(150),
  pfr_attribute29                   varchar2(150),
  pfr_attribute30                   varchar2(150),
...
--           p_base_key_value = :pct_fl_tm_rt_id).
--
-- Post Success:
--   Processing continues.
--
