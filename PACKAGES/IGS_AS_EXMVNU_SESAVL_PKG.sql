--------------------------------------------------------
--  DDL for Package IGS_AS_EXMVNU_SESAVL_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IGS_AS_EXMVNU_SESAVL_PKG" AUTHID CURRENT_USER AS
 /* $Header: IGSDI14S.pls 115.4 2002/11/28 23:13:57 nsidana ship $ */
