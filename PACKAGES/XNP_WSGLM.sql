--------------------------------------------------------
--  DDL for Package XNP_WSGLM
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XNP_WSGLM" AUTHID CURRENT_USER as
/* $Header: XNPWSLMS.pls 120.0 2005/05/30 11:52:47 appldev noship $ */
...
************************************************************************/
  ...
  DSP125_REPOS_APPSYS constant varchar2(100) := 'Repository Application System';
