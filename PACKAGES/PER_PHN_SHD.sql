--------------------------------------------------------
--  DDL for Package PER_PHN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PHN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  party_id                          per_phones.party_id%TYPE, -- HR/TCA merge
  validity                          varchar(30),
...
g_tab_nam              constant varchar2(30) := 'PER_PHONES';
