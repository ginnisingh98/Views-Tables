--------------------------------------------------------
--  DDL for Package PQH_FYN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_FYN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  fyi_notified_id                   number(15),
  transaction_category_id           number(15),
  transaction_id                    number(15),
  notification_event_cd             varchar2(10),
  notified_type_cd                  varchar2(10),
  notified_name                     varchar2(100),
