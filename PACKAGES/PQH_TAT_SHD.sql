--------------------------------------------------------
--  DDL for Package PQH_TAT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TAT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  view_flag                         varchar2(10),
  edit_flag                         varchar2(10),
  template_attribute_id             number(15),
