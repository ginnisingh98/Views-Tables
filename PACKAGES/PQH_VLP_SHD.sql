--------------------------------------------------------
--  DDL for Package PQH_VLP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_VLP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (validation_period_id            number(15)
  ...
  ,period_months                   number(9)         -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_FR_VALIDATION_PERIODS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
