--------------------------------------------------------
--  DDL for Package PAY_PGP_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PGP_UPD" AUTHID CURRENT_USER as
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out pay_pgp_shd.g_rec_type);
--
-- ----------------------------------------------------------------------------
-- |-------------------------------< upd_or_sel >-----------------------------|
-- ----------------------------------------------------------------------------
...
--   functionality of pay_pgp_ins.ins_or_sel except is has to take into
...
--      returning the new p_people_group_id.
...
--   the pay_people_groups table and the out arguments are returned.
