--------------------------------------------------------
--  DDL for Package PER_CNI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CNI_SHD" AUTHID CURRENT_USER as
/* $Header: pecnirhi.pkh 120.0 2005/05/31 06:49:33 appldev noship $ */
 ...
 Type g_rec_type Is Record
   (configuration_code              varchar2(60)
   ,config_information_category     varchar2(120)
   ,config_information1             varchar2(240)
   ,config_information2             varchar2(240)
   ,config_information3             varchar2(240)
   ,config_information4             varchar2(240)
   ,config_information5             varchar2(240)
   ,config_information6             varchar2(240)
   ,config_information7             varchar2(240)
   ,config_information8             varchar2(240)
   ,config_information9             varchar2(240)
   ,config_information10            varchar2(240)
   ,config_information11            varchar2(240)
   ,config_information12            varchar2(240)
   ,config_information13            varchar2(240)
   ,config_information14            varchar2(240)
   ,config_information15            varchar2(240)
   ,config_information16            varchar2(240)
   ,config_information17            varchar2(240)
   ,config_information18            varchar2(240)
   ,config_information19            varchar2(240)
   ,config_information20            varchar2(240)
   ,config_information21            varchar2(240)
   ,config_information22            varchar2(240)
   ,config_information23            varchar2(240)
   ,config_information24            varchar2(240)
   ,config_information25            varchar2(240)
   ,config_information26            varchar2(240)
   ,config_information27            varchar2(240)
   ,config_information28            varchar2(240)
   ,config_information29            varchar2(240)
   ,config_information30            varchar2(240)
   ,config_information_id           number(15)
   ,config_sequence                 number(9)
 ...
 -- Global table name
 g_tab_nam  constant varchar2(30) := 'PER_RI_CONFIG_INFORMATION';
 --
 -- ----------------------------------------------------------------------------
 -- |---------------------------< constraint_error >---------------------------|
 -- ----------------------------------------------------------------------------
