--------------------------------------------------------
--  DDL for Package PER_PML_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PML_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,eligibility_type_code           varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_OBJECTIVES_LIBRARY';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
