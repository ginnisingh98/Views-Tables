--------------------------------------------------------
--  DDL for Package OE_UPG_SO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OE_UPG_SO" AUTHID CURRENT_USER as
/* $Header: OEXIUSOS.pls 120.0 2005/06/01 00:39:12 appldev noship $ */
...
Procedure Process_Upgraded_Returns;
Procedure Fix_Returns_Splits;
