--------------------------------------------------------
--  DDL for Package OKL_AM_TERMNT_QUOTE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_AM_TERMNT_QUOTE_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUTNQS.pls 120.5 2007/11/02 21:07:01 rmunjulu ship $ */
