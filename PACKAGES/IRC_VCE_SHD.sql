--------------------------------------------------------
--  DDL for Package IRC_VCE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_VCE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,variable_comp_lookup            varchar2(30)
...
g_tab_nam constant varchar2(30) := 'IRC_VARIABLE_COMP_ELEMENTS';
