--------------------------------------------------------
--  DDL for Package OTA_LPM_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_LPM_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_learning_path_member_id
--     already exists.
--
--  In Arguments:
