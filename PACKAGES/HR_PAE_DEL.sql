--------------------------------------------------------
--  DDL for Package HR_PAE_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PAE_DEL" AUTHID CURRENT_USER as
/* $Header: hrpaerhi.pkh 115.0 99/07/17 05:36:30 porting ship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< del >----------------------------------|
-- ----------------------------------------------------------------------------
