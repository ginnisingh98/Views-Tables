--------------------------------------------------------
--  DDL for Package BEN_PCS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PCS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  prtt_enrt_ctfn_prvdd_id           number(15),
  effective_start_date              date,
  effective_end_date                date,
  enrt_ctfn_rqd_flag                varchar2(30),
  enrt_ctfn_typ_cd                  varchar2(30),
  enrt_ctfn_recd_dt                 date,
  enrt_ctfn_dnd_dt                  date,
  enrt_r_bnft_ctfn_cd               varchar2(30),
  prtt_enrt_rslt_id                 number(15),
  prtt_enrt_actn_id                 number(15),
  business_group_id                 number(15),
  pcs_attribute_category            varchar2(30),
  pcs_attribute1                    varchar2(150),
  pcs_attribute2                    varchar2(150),
  pcs_attribute3                    varchar2(150),
  pcs_attribute4                    varchar2(150),
  pcs_attribute5                    varchar2(150),
  pcs_attribute6                    varchar2(150),
  pcs_attribute7                    varchar2(150),
  pcs_attribute8                    varchar2(150),
  pcs_attribute9                    varchar2(150),
  pcs_attribute10                   varchar2(150),
  pcs_attribute11                   varchar2(150),
  pcs_attribute12                   varchar2(150),
  pcs_attribute13                   varchar2(150),
  pcs_attribute14                   varchar2(150),
  pcs_attribute15                   varchar2(150),
  pcs_attribute16                   varchar2(150),
  pcs_attribute17                   varchar2(150),
  pcs_attribute18                   varchar2(150),
  pcs_attribute19                   varchar2(150),
  pcs_attribute20                   varchar2(150),
  pcs_attribute21                   varchar2(150),
  pcs_attribute22                   varchar2(150),
  pcs_attribute23                   varchar2(150),
  pcs_attribute24                   varchar2(150),
  pcs_attribute25                   varchar2(150),
  pcs_attribute26                   varchar2(150),
  pcs_attribute27                   varchar2(150),
  pcs_attribute28                   varchar2(150),
  pcs_attribute29                   varchar2(150),
  pcs_attribute30                   varchar2(150),
...
--           p_base_key_value = :prtt_enrt_ctfn_prvdd_id).
--
-- Post Success:
--   Processing continues.
--
