--------------------------------------------------------
--  DDL for Package AHL_VWP_UNPLAN_TASKS_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_VWP_UNPLAN_TASKS_PVT" AUTHID CURRENT_USER AS
/* $Header: AHLVUPTS.pls 115.1 2003/08/21 18:41:24 shbhanda noship $ */
-----------------------------------------------------------
-- PACKAGE
--    Ahl_Vwp_Unplan_Tasks_Pvt
--
-- PURPOSE
--    This package is a Private API for Planning --> Visit Work Package
--    --> Unplanned Tasks procedures in Complex Maintainance, Repair and Overhauling(CMRO).
--
--
--    Create_Unplanned_Task     (see below for specification)
--    Update_Unplanned_Task     (see below for specification)
--    Delete_Unplanned_Task     (see below for specification)
--
--
-- NOTES
--
...
------------------------------------------------------------------
--  Procedure name    : Create_Unplanned_Task
--  Type              : Private
...
-------------------------------------------------------------------
--  Procedure name    : Update_Unplanned_Task
--  Type              : Private
...
-------------------------------------------------------------------
--  Procedure name    : Delete_Unplanned_Task
--  Type              : Private
