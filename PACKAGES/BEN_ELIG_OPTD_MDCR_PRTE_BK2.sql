--------------------------------------------------------
--  DDL for Package BEN_ELIG_OPTD_MDCR_PRTE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_OPTD_MDCR_PRTE_BK2" AUTHID CURRENT_USER as
/* $Header: beeomapi.pkh 120.0 2005/05/28 02:31:42 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_OPTD_MDCR_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_OPTD_MDCR_PRTE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_ELIG_OPTD_MDCR_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_ELIG_OPTD_MDCR_PRTE_a
  (
   p_elig_optd_mdcr_prte_id         in  number
...
--
end ben_ELIG_OPTD_MDCR_PRTE_bk2;
