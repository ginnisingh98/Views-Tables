--------------------------------------------------------
--  DDL for Package BEN_BPP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BPP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  pgm_pool_flag                     varchar2(9),      -- Increased length
  excs_alwys_fftd_flag              varchar2(30),
  use_for_pgm_pool_flag             varchar2(9),      -- Increased length
  pct_rndg_cd                       varchar2(30),
  pct_rndg_rl                       number(15),
  val_rndg_cd                       varchar2(30),
  val_rndg_rl                       number(15),
  dflt_excs_trtmt_cd                varchar2(30),
  dflt_excs_trtmt_rl                number(15),
  rlovr_rstrcn_cd                   varchar2(30),
  no_mn_dstrbl_pct_flag             varchar2(30),
  no_mn_dstrbl_val_flag             varchar2(30),
  no_mx_dstrbl_pct_flag             varchar2(30),
  no_mx_dstrbl_val_flag             varchar2(30),
  auto_alct_excs_flag               varchar2(30),
  alws_ngtv_crs_flag                varchar2(30),
  uses_net_crs_mthd_flag            varchar2(30),
  mx_dfcit_pct_pool_crs_num         number,
  mx_dfcit_pct_comp_num             number,
  comp_lvl_fctr_id                  number(15),
  mn_dstrbl_pct_num                 number(15),
  mn_dstrbl_val                     number,
  mx_dstrbl_pct_num                 number(15),
  mx_dstrbl_val                     number,
  excs_trtmt_cd                     varchar2(30),
  ptip_id                           number(15),
  plip_id                           number(15),
  pgm_id                            number(15),
  oiplip_id                         number(15),
  ...
  bpp_attribute_category            varchar2(30),
  bpp_attribute1                    varchar2(150),
  bpp_attribute2                    varchar2(150),
  bpp_attribute3                    varchar2(150),
  bpp_attribute4                    varchar2(150),
  bpp_attribute5                    varchar2(150),
  bpp_attribute6                    varchar2(150),
  bpp_attribute7                    varchar2(150),
  bpp_attribute8                    varchar2(150),
  bpp_attribute9                    varchar2(150),
  bpp_attribute10                   varchar2(150),
  bpp_attribute11                   varchar2(150),
  bpp_attribute12                   varchar2(150),
  bpp_attribute13                   varchar2(150),
  bpp_attribute14                   varchar2(150),
  bpp_attribute15                   varchar2(150),
  bpp_attribute16                   varchar2(150),
  bpp_attribute17                   varchar2(150),
  bpp_attribute18                   varchar2(150),
  bpp_attribute19                   varchar2(150),
  bpp_attribute20                   varchar2(150),
  bpp_attribute21                   varchar2(150),
  bpp_attribute22                   varchar2(150),
  bpp_attribute23                   varchar2(150),
  bpp_attribute24                   varchar2(150),
  bpp_attribute25                   varchar2(150),
  bpp_attribute26                   varchar2(150),
  bpp_attribute27                   varchar2(150),
  bpp_attribute28                   varchar2(150),
  bpp_attribute29                   varchar2(150),
  bpp_attribute30                   varchar2(150),
...
--           p_base_key_value = :bnft_prvdr_pool_id).
--
-- Post Success:
--   Processing continues.
--
