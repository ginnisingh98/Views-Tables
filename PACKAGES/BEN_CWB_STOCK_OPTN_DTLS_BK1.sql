--------------------------------------------------------
--  DDL for Package BEN_CWB_STOCK_OPTN_DTLS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CWB_STOCK_OPTN_DTLS_BK1" AUTHID CURRENT_USER as
/* $Header: becsoapi.pkh 120.4 2006/10/17 10:30:58 steotia noship $ */
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_cwb_stock_optn_dtls_b >-----------------|
-- ----------------------------------------------------------------------------
--
