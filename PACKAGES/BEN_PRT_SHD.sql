--------------------------------------------------------
--  DDL for Package BEN_PRT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PRT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  mn_poe_num                        number(15),
  mx_poe_num                        number(15),
  no_mn_poe_flag                    varchar2(30),
  no_mx_poe_flag                    varchar2(30),
  rndg_cd                           varchar2(30),
  rndg_rl                           number(15),
  poe_nnmntry_uom                   varchar2(30),
  vrbl_rt_prfl_id                   number(15),
  business_group_id                 number(15),
  prt_attribute_category            varchar2(30),
  prt_attribute1                    varchar2(150),
  prt_attribute2                    varchar2(150),
  prt_attribute3                    varchar2(150),
  prt_attribute4                    varchar2(150),
  prt_attribute5                    varchar2(150),
  prt_attribute6                    varchar2(150),
  prt_attribute7                    varchar2(150),
  prt_attribute8                    varchar2(150),
  prt_attribute9                    varchar2(150),
  prt_attribute10                   varchar2(150),
  prt_attribute11                   varchar2(150),
  prt_attribute12                   varchar2(150),
  prt_attribute13                   varchar2(150),
  prt_attribute14                   varchar2(150),
  prt_attribute15                   varchar2(150),
  prt_attribute16                   varchar2(150),
  prt_attribute17                   varchar2(150),
  prt_attribute18                   varchar2(150),
  prt_attribute19                   varchar2(150),
  prt_attribute20                   varchar2(150),
  prt_attribute21                   varchar2(150),
  prt_attribute22                   varchar2(150),
  prt_attribute23                   varchar2(150),
  prt_attribute24                   varchar2(150),
  prt_attribute25                   varchar2(150),
  prt_attribute26                   varchar2(150),
  prt_attribute27                   varchar2(150),
  prt_attribute28                   varchar2(150),
  prt_attribute29                   varchar2(150),
  prt_attribute30                   varchar2(150),
