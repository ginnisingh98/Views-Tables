--------------------------------------------------------
--  DDL for Package BEN_ELI_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELI_DEL" AUTHID CURRENT_USER as
...
--      datatype.
--   2) After the conversion has taken elpace, the corresponding record del
