--------------------------------------------------------
--  DDL for Package IEX_WF_DEL_REQ_SERVICE_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IEX_WF_DEL_REQ_SERVICE_PUB" AUTHID CURRENT_USER AS
/* $Header: iexwfdss.pls 120.0 2004/01/24 03:31:16 appldev noship $ */

-- PROCEDURE start workflow
-- DESCRIPTION	This procedure is called to start collections Delinquent Request Service Hold workflow*/
