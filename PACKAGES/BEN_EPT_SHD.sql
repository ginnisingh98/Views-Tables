--------------------------------------------------------
--  DDL for Package BEN_EPT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_per_typ_prte_id              number(15),
  ...
  ept_attribute_category            varchar2(30),
  ept_attribute1                    varchar2(150),
  ept_attribute2                    varchar2(150),
  ept_attribute3                    varchar2(150),
  ept_attribute4                    varchar2(150),
  ept_attribute5                    varchar2(150),
  ept_attribute6                    varchar2(150),
  ept_attribute7                    varchar2(150),
  ept_attribute8                    varchar2(150),
  ept_attribute9                    varchar2(150),
  ept_attribute10                   varchar2(150),
  ept_attribute11                   varchar2(150),
  ept_attribute12                   varchar2(150),
  ept_attribute13                   varchar2(150),
  ept_attribute14                   varchar2(150),
  ept_attribute15                   varchar2(150),
  ept_attribute16                   varchar2(150),
  ept_attribute17                   varchar2(150),
  ept_attribute18                   varchar2(150),
  ept_attribute19                   varchar2(150),
  ept_attribute20                   varchar2(150),
  ept_attribute21                   varchar2(150),
  ept_attribute22                   varchar2(150),
  ept_attribute23                   varchar2(150),
  ept_attribute24                   varchar2(150),
  ept_attribute25                   varchar2(150),
  ept_attribute26                   varchar2(150),
  ept_attribute27                   varchar2(150),
  ept_attribute28                   varchar2(150),
  ept_attribute29                   varchar2(150),
  ept_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_per_typ_prte_id).
--
-- Post Success:
--   Processing continues.
--
