--------------------------------------------------------
--  DDL for Package OTA_TEA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_TEA_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  tea_information_category          varchar2(30),
  tea_information1                  varchar2(150),
  tea_information2                  varchar2(150),
  tea_information3                  varchar2(150),
  tea_information4                  varchar2(150),
  tea_information5                  varchar2(150),
  tea_information6                  varchar2(150),
  tea_information7                  varchar2(150),
  tea_information8                  varchar2(150),
  tea_information9                  varchar2(150),
  tea_information10                 varchar2(150),
  tea_information11                 varchar2(150),
  tea_information12                 varchar2(150),
  tea_information13                 varchar2(150),
  tea_information14                 varchar2(150),
  tea_information15                 varchar2(150),
  tea_information16                 varchar2(150),
  tea_information17                 varchar2(150),
  tea_information18                 varchar2(150),
  tea_information19                 varchar2(150),
  tea_information20                 varchar2(150)
  );
--
-- ----------------------------------------------------------------------------
