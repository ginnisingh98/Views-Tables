--------------------------------------------------------
--  DDL for Package BEN_PDT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PDT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (pymt_check_det_id               number(15)
  ,person_id                       number(15)
  ,business_group_id               number(15)
  ,check_num                       varchar2(30)
  ,pymt_dt                         date
  ,pymt_amt                        number
  ,pdt_attribute_category          varchar2(30)
  ,pdt_attribute1                  varchar2(150)
  ,pdt_attribute2                  varchar2(150)
  ,pdt_attribute3                  varchar2(150)
  ,pdt_attribute4                  varchar2(150)
  ,pdt_attribute5                  varchar2(150)
  ,pdt_attribute6                  varchar2(150)
  ,pdt_attribute7                  varchar2(150)
  ,pdt_attribute8                  varchar2(150)
  ,pdt_attribute9                  varchar2(150)
  ,pdt_attribute10                 varchar2(150)
  ,pdt_attribute11                 varchar2(150)
  ,pdt_attribute12                 varchar2(150)
  ,pdt_attribute13                 varchar2(150)
  ,pdt_attribute14                 varchar2(150)
  ,pdt_attribute15                 varchar2(150)
  ,pdt_attribute16                 varchar2(150)
  ,pdt_attribute17                 varchar2(150)
  ,pdt_attribute18                 varchar2(150)
  ,pdt_attribute19                 varchar2(150)
  ,pdt_attribute20                 varchar2(150)
  ,pdt_attribute21                 varchar2(150)
  ,pdt_attribute22                 varchar2(150)
  ,pdt_attribute23                 varchar2(150)
  ,pdt_attribute24                 varchar2(150)
  ,pdt_attribute25                 varchar2(150)
  ,pdt_attribute26                 varchar2(150)
  ,pdt_attribute27                 varchar2(150)
  ,pdt_attribute28                 varchar2(150)
  ,pdt_attribute29                 varchar2(150)
  ,pdt_attribute30                 varchar2(150)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_PYMT_CHECK_DET';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
