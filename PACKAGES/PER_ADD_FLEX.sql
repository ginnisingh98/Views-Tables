--------------------------------------------------------
--  DDL for Package PER_ADD_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ADD_FLEX" AUTHID CURRENT_USER as
/* $Header: peaddfli.pkh 115.0 99/07/17 18:25:57 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
