--------------------------------------------------------
--  DDL for Package PER_WBT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_WBT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_workbench_item_code
--     already exists.
--
--  In Arguments:
