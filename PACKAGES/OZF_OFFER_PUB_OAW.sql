--------------------------------------------------------
--  DDL for Package OZF_OFFER_PUB_OAW
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_OFFER_PUB_OAW" AUTHID CURRENT_USER as
  /* $Header: ozfaofps.pls 120.1 2005/09/29 10:49 gramanat noship $ */
