--------------------------------------------------------
--  DDL for Package HR_NZ_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_NZ_APPLICANT_API" AUTHID CURRENT_USER AS
/* $Header: hrnzwrap.pkh 120.4 2005/10/31 03:18:52 rpalli noship $ */
/*#
 * This package contains applicant related APIs.
 * @rep:scope public
 * @rep:product per
 * @rep:displayname Applicant for New Zealand
*/
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_nz_applicant >------------------------|
...
-- {Start Of Comments}
/*#
 * This procedure creates a new applicant for New Zealand.
 *
 * This API calls the generic create_applicant API, with the parameters set as
 * appropriate for New Zealand applicant. As this API is effectively an
 ...
 * A business group for New Zealand legislation must be specified.
 *
 ...
 * lookup type.
 * @param p_person_type_id Identifies the person type id.If a person_type_id is
 * not specified, then the API will use the default 'APL' type for the business group.
 ...
 * @param p_country_born Indicates the country of birth of applicant. Valid
 * values are defined by the view FND_TERRITORIES_VL
 * @param p_work_permit_number {@rep:casecolumn
 * PER_ALL_PEOPLE_F.PER_INFORMATION2}
 * @param p_work_permit_expiry_date {@rep:casecolumn
 * PER_ALL_PEOPLE_F.PER_INFORMATION3}
 * @param p_ethnic_origin {@rep:casecolumn PER_ALL_PEOPLE_F.PER_INFORMATION4}
 * @param p_tribal_group {@rep:casecolumn PER_ALL_PEOPLE_F.PER_INFORMATION5}
 * @param p_district_of_origin {@rep:casecolumn
 * PER_ALL_PEOPLE_F.PER_INFORMATION6}
 * @param p_employment_category {@rep:casecolumn
 * PER_ALL_PEOPLE_F.PER_INFORMATION7}
 * @param p_working_time {@rep:casecolumn PER_ALL_PEOPLE_F.PER_INFORMATION8}
 ...
 * @param p_vacancy_id Vacancy_id for which this applicant is applying for.
 ...
 * @param p_orig_hire_warning Set to true, if the original date of hire is
 * provided and the person type is not Employee,Employee-Applicant,Ex-Employee
 * or Ex-Employee Applicant.
 * @rep:displayname Create Applicant for New Zealand
