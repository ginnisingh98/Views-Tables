--------------------------------------------------------
--  DDL for Package IRC_ITA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_ITA_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_template_association_id
--     already exists.
--
--  In Arguments:
