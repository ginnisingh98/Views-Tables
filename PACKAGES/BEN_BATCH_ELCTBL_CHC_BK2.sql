--------------------------------------------------------
--  DDL for Package BEN_BATCH_ELCTBL_CHC_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BATCH_ELCTBL_CHC_BK2" AUTHID CURRENT_USER as
/* $Header: bebecapi.pkh 120.0 2005/05/28 00:37:14 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_batch_elctbl_chc_b >------------------|
-- ----------------------------------------------------------------------------
--
procedure update_batch_elctbl_chc_b
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_batch_elctbl_chc_a >------------------|
-- ----------------------------------------------------------------------------
--
procedure update_batch_elctbl_chc_a
  (p_batch_elctbl_id                in  number
  ,p_benefit_action_id              in  number
  ,p_person_id                      in  number
  ,p_pgm_id                         in  number
