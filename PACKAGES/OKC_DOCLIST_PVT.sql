--------------------------------------------------------
--  DDL for Package OKC_DOCLIST_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_DOCLIST_PVT" AUTHID CURRENT_USER AS
/*$Header: OKCRUBLS.pls 120.0 2005/05/30 04:11:50 appldev noship $*/
--
...
*/
   ...
   g_max_list_length		CONSTANT NUMBER := 8;

   g_package_name		CONSTANT VARCHAR2(200) := 'OKC_DOCLIST_PVT';
