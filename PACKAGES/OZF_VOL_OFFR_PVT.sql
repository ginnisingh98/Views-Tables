--------------------------------------------------------
--  DDL for Package OZF_VOL_OFFR_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_VOL_OFFR_PVT" AUTHID CURRENT_USER AS
/* $Header: ozfvvos.pls 120.0 2005/06/01 02:49:18 appldev noship $ */
-- ===============================================================
-- Start of Comments
-- Package name
--          OZF_Vol_Offr_PVT
...
g_miss_vol_offr_tier_rec          vol_offr_tier_rec_type := NULL;
TYPE  vol_offr_tier_tbl_type      IS TABLE OF vol_offr_tier_rec_type INDEX BY BINARY_INTEGER;
g_miss_vol_offr_tier_tbl          vol_offr_tier_tbl_type;
