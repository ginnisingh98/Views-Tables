--------------------------------------------------------
--  DDL for Package PAY_CTY_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CTY_BK1" AUTHID CURRENT_USER as
/* $Header: pyctyapi.pkh 120.2 2007/05/01 22:38:19 ahanda noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_city_tax_rule_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_city_tax_rule_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_city_tax_rule_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_city_tax_rule_a
  (
