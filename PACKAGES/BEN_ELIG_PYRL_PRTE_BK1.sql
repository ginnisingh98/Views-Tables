--------------------------------------------------------
--  DDL for Package BEN_ELIG_PYRL_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_PYRL_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beepyapi.pkh 120.0 2005/05/28 02:47:05 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_PYRL_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_PYRL_PRTE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_PYRL_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_PYRL_PRTE_a
  (
