--------------------------------------------------------
--  DDL for Package OTA_CME_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_CME_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (cert_mbr_enrollment_id          number(9)
  ,cert_prd_enrollment_id          number(9)
  ,cert_member_id                  number(9)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_CERT_MBR_ENROLLMENTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
