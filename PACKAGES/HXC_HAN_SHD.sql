--------------------------------------------------------
--  DDL for Package HXC_HAN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_HAN_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (comp_notification_id             number(15)
  ,object_version_number            number(9)
  ,notification_number_retries      number(9)
  ,notification_timeout_value       number(9)
  ,notification_action_code         varchar2(30)
  ,notification_recipient_code      varchar2(30)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HXC_APP_COMP_NOTIFICATIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
