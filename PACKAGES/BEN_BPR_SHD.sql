--------------------------------------------------------
--  DDL for Package BEN_BPR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BPR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  bnft_pool_rlovr_rqmt_id           number(15),
  effective_start_date              date,
  effective_end_date                date,
  no_mn_rlovr_pct_dfnd_flag         varchar2(30),
  no_mx_rlovr_pct_dfnd_flag         varchar2(30),
  no_mn_rlovr_val_dfnd_flag         varchar2(30),
  no_mx_rlovr_val_dfnd_flag         varchar2(30),
  rlovr_val_incrmt_num              number(15),
  rlovr_val_rl                      number(15),
  mn_rlovr_val                      number,
  mx_rlovr_val                      number,
  ...
  prtt_elig_rlovr_rl                number(15),
  mx_rchd_dflt_ordr_num             number(15),
  pct_rlovr_incrmt_num              number(15),
  mn_rlovr_pct_num                  number(15),
  mx_rlovr_pct_num                  number(15),
  crs_rlovr_procg_cd                varchar2(30),
  mx_pct_ttl_crs_cn_roll_num        number(15),
  bnft_prvdr_pool_id                number(15),
  acty_base_rt_id                   number(15),
  business_group_id                 number(15),
  bpr_attribute_category            varchar2(30),
  bpr_attribute1                    varchar2(150),
  bpr_attribute2                    varchar2(150),
  bpr_attribute3                    varchar2(150),
  bpr_attribute4                    varchar2(150),
  bpr_attribute5                    varchar2(150),
  bpr_attribute6                    varchar2(150),
  bpr_attribute7                    varchar2(150),
  bpr_attribute8                    varchar2(150),
  bpr_attribute9                    varchar2(150),
  bpr_attribute10                   varchar2(150),
  bpr_attribute11                   varchar2(150),
  bpr_attribute12                   varchar2(150),
  bpr_attribute13                   varchar2(150),
  bpr_attribute14                   varchar2(150),
  bpr_attribute15                   varchar2(150),
  bpr_attribute16                   varchar2(150),
  bpr_attribute17                   varchar2(150),
  bpr_attribute18                   varchar2(150),
  bpr_attribute19                   varchar2(150),
  bpr_attribute20                   varchar2(150),
  bpr_attribute21                   varchar2(150),
  bpr_attribute22                   varchar2(150),
  bpr_attribute23                   varchar2(150),
  bpr_attribute24                   varchar2(150),
  bpr_attribute25                   varchar2(150),
  bpr_attribute26                   varchar2(150),
  bpr_attribute27                   varchar2(150),
  bpr_attribute28                   varchar2(150),
  bpr_attribute29                   varchar2(150),
  bpr_attribute30                   varchar2(150),
...
--           p_base_key_value = :bnft_pool_rlovr_rqmt_id).
--
-- Post Success:
--   Processing continues.
--
