--------------------------------------------------------
--  DDL for Package AP_APXVDRAL_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AP_APXVDRAL_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: APXVDRALS.pls 120.0 2007/12/27 08:48:45 vjaganat noship $ */
  ...
  P_LOCATION_CODE VARCHAR2(60);

  P_SENDER_NAME VARCHAR2(30);

  P_SENDER_TITLE VARCHAR2(30);

  P_SENDER_PHONE VARCHAR2(40);
