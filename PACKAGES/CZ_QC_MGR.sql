--------------------------------------------------------
--  DDL for Package CZ_QC_MGR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CZ_QC_MGR" AUTHID CURRENT_USER as
/*  $Header: czqcmgrs.pls 115.12 2002/11/27 17:15:43 askhacha ship $	*/
