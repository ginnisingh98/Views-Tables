--------------------------------------------------------
--  DDL for Package OZF_NA_DDN_RULE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_NA_DDN_RULE_PVT_W" AUTHID CURRENT_USER as
  /* $Header: ozfwdnrs.pls 120.2 2006/02/25 19:23 julou noship $ */
