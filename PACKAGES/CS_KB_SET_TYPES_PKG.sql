--------------------------------------------------------
--  DDL for Package CS_KB_SET_TYPES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CS_KB_SET_TYPES_PKG" AUTHID CURRENT_USER AS
/* $Header: cskbsts.pls 115.6 2002/11/11 23:53:31 mkettle ship $ */
/*======================================================================+
 ...
 |  29-JAN-2000 ALAM    Added parameter name to create/update func.     |
 |  14-AUG-2002 KLOU  (SEDATE)                                          |
 |              1. Add new parameters p_start_date and p_end_date.      |
 +======================================================================*/
