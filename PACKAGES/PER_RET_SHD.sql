--------------------------------------------------------
--  DDL for Package PER_RET_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_RET_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (cagr_retained_right_id         number(15)
  ...
  ,freeze_flag                     varchar2(9)       -- Increased length
  ,value                           varchar2(240)
