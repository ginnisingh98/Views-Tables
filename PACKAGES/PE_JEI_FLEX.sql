--------------------------------------------------------
--  DDL for Package PE_JEI_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PE_JEI_FLEX" AUTHID CURRENT_USER as
/* $Header: pejeifli.pkh 115.0 99/07/18 13:56:24 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
