--------------------------------------------------------
--  DDL for Package BEN_RRB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_RRB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  regn_for_regy_body_id             number(15),
  effective_start_date              date,
  effective_end_date                date,
  regn_admin_cd                     varchar2(30),
  regn_id                           number(15),
  organization_id                   number(15),
  business_group_id                 number(15),
  rrb_attribute_category            varchar2(30),
  rrb_attribute1                    varchar2(150),
  rrb_attribute2                    varchar2(150),
  rrb_attribute3                    varchar2(150),
  rrb_attribute4                    varchar2(150),
  rrb_attribute5                    varchar2(150),
  rrb_attribute6                    varchar2(150),
  rrb_attribute7                    varchar2(150),
  rrb_attribute8                    varchar2(150),
  rrb_attribute9                    varchar2(150),
  rrb_attribute10                   varchar2(150),
  rrb_attribute11                   varchar2(150),
  rrb_attribute12                   varchar2(150),
  rrb_attribute13                   varchar2(150),
  rrb_attribute14                   varchar2(150),
  rrb_attribute15                   varchar2(150),
  rrb_attribute16                   varchar2(150),
  rrb_attribute17                   varchar2(150),
  rrb_attribute18                   varchar2(150),
  rrb_attribute19                   varchar2(150),
  rrb_attribute20                   varchar2(150),
  rrb_attribute21                   varchar2(150),
  rrb_attribute22                   varchar2(150),
  rrb_attribute23                   varchar2(150),
  rrb_attribute24                   varchar2(150),
  rrb_attribute25                   varchar2(150),
  rrb_attribute26                   varchar2(150),
  rrb_attribute27                   varchar2(150),
  rrb_attribute28                   varchar2(150),
  rrb_attribute29                   varchar2(150),
  rrb_attribute30                   varchar2(150),
...
--           p_base_key_value = :regn_for_regy_body_id).
--
-- Post Success:
--   Processing continues.
--
