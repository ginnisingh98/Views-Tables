--------------------------------------------------------
--  DDL for Package PER_ZA_AO_ASS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_AO_ASS_SHD" AUTHID CURRENT_USER as
/* $Header: pezaaash.pkh 115.1 2002/12/05 06:05:10 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_za_rec_type Is Record
  (
    area_of_assessment_id     number(9),
  	assessment_id             number(9),
  	area_of_assessment        varchar2(80),
  	assessment_result    	  varchar2(80),
  	assessment_criteria       varchar2(120)
  );
--
-- ----------------------------------------------------------------------------
...
--
procedure get_new_id(p_area_of_assessment_id out nocopy number);
--
