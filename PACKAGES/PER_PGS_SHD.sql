--------------------------------------------------------
--  DDL for Package PER_PGS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PGS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,grade_id                        number(15)
  ,ceiling_step_id                 number(15)
  ,starting_step                   number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_GRADE_SPINES_F';
...
--           p_base_key_value = :grade_spine_id).
--
-- Post Success:
--   Processing continues.
--
