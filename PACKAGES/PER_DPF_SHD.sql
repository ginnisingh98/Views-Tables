--------------------------------------------------------
--  DDL for Package PER_DPF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_DPF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  deployment_factor_id              number(9),
  position_id                       per_deployment_factors.position_id%TYPE,
  person_id                         per_deployment_factors.person_id%TYPE,
  job_id                            number(9),
  ...
  visit_internationally             varchar2(30),
  only_current_location             varchar2(30),
  no_country1                       varchar2(30),
  no_country2                       varchar2(30),
  no_country3                       varchar2(30),
  comments                          varchar2(2000),   -- pseudo column
  earliest_available_date           date,
  available_for_transfer            varchar2(30),
  relocation_preference             varchar2(30),
  relocation_required               varchar2(30),
