--------------------------------------------------------
--  DDL for Package PV_ENTITY_ATTRIBUTE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PV_ENTITY_ATTRIBUTE_PVT_W" AUTHID CURRENT_USER as
  /* $Header: pvxweats.pls 120.2 2005/07/05 14:45 appldev ship $ */
