--------------------------------------------------------
--  DDL for Package PER_SUC_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SUC_FLEX" AUTHID CURRENT_USER as
/* $Header: pesucfli.pkh 115.0 99/07/18 15:15:09 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
procedure df
  (p_rec   in per_suc_shd.g_rec_type);
--
end per_suc_flex;
