--------------------------------------------------------
--  DDL for Package PQH_PSU_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_PSU_SHD" AUTHID CURRENT_USER as
/* $Header: pqpsurhi.pkh 120.0 2005/05/29 02:20:00 appldev noship $ */
--
-- ----------------------------------------------------------------------------
...
Type g_rec_type Is Record
  (emp_stat_situation_id           number(15)
  ...
  ,contact_person_id               number(15)
  ,contact_relationship            varchar2(30)
  ,external_organization_id        number(15)
  ,renewal_flag                    varchar2(10)
  ,renew_stat_situation_id         number(15)
  ,seconded_career_id              number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_FR_EMP_STAT_SITUATIONS';
