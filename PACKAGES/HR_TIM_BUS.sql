--------------------------------------------------------
--  DDL for Package HR_TIM_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TIM_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_template_item_id already exists.
--
--  In Arguments:
--    p_template_item_id
--
...
--
--  Description:
--    Called from post_insert to ensure that template does not contain popup and
--    segments from the same flexfield.
--
--  Prerequisites:
--    The primary key identified by p_form_item_id must already exist.
--
--  In Arguments:
--    p_form_template_id
