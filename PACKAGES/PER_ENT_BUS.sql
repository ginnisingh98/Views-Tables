--------------------------------------------------------
--  DDL for Package PER_ENT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ENT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_calendar_entry_id
--     already exists.
--
--  In Arguments:
--    p_calendar_entry_id
