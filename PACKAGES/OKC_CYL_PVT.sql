--------------------------------------------------------
--  DDL for Package OKC_CYL_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_CYL_PVT" AUTHID CURRENT_USER AS
/* $Header: OKCSCYLS.pls 120.0 2005/05/25 17:58:53 appldev noship $ */
  ---------------------------------------------------------------------------
...
--Bug 3122962
    ...
    last_update_login              NUMBER := OKC_API.G_MISS_NUM);
  g_miss_cylv_rec                         cylv_rec_type;
  TYPE cylv_tbl_type IS TABLE OF cylv_rec_type
        INDEX BY BINARY_INTEGER;
  ---------------------------------------------------------------------------
  ...
  -- GLOBAL VARIABLES
  ---------------------------------------------------------------------------
  G_PKG_NAME			CONSTANT VARCHAR2(200) := 'OKC_CYL_PVT';
  ...
  PROCEDURE insert_row(
    ...
    x_cylv_tbl                     OUT NOCOPY cylv_tbl_type);
