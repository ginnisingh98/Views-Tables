--------------------------------------------------------
--  DDL for Package ASP_ORDER_ALERT_AGENT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."ASP_ORDER_ALERT_AGENT" AUTHID CURRENT_USER as
/* $Header: aspaoras.pls 120.1 2005/08/19 12:58 axavier noship $ */
---------------------------------------------------------------------------
