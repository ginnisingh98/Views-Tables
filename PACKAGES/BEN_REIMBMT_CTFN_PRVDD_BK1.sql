--------------------------------------------------------
--  DDL for Package BEN_REIMBMT_CTFN_PRVDD_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_REIMBMT_CTFN_PRVDD_BK1" AUTHID CURRENT_USER as
/* $Header: bepqcapi.pkh 120.0 2005/05/28 11:02:58 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_reimbmt_ctfn_prvdd_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_reimbmt_ctfn_prvdd_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_reimbmt_ctfn_prvdd_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_reimbmt_ctfn_prvdd_a
  (
...
--
end ben_reimbmt_ctfn_prvdd_bk1;
