--------------------------------------------------------
--  DDL for Package BEN_ELIG_DSBLD_STAT_CVG_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_DSBLD_STAT_CVG_API" AUTHID CURRENT_USER as
...
--   p_elig_dsbld_stat_cvg_id       Yes  number    PK of record
