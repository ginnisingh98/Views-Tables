--------------------------------------------------------
--  DDL for Package PQH_RNG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RNG_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  attribute_range_id                number(15),
  approver_flag                     varchar2(10),
