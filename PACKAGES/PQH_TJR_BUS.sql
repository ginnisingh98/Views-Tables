--------------------------------------------------------
--  DDL for Package PQH_TJR_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_TJR_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_txn_job_requirement_id
--     already exists.
--
--  In Arguments:
