--------------------------------------------------------
--  DDL for Package HR_FIM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_FIM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,full_item_name                  varchar2(80)
  ,item_type                       varchar2(30)
  ,form_tab_page_id                number(15)
  ,radio_button_name               varchar2(30)
  ,required_override               number(10)
  ,form_tab_page_id_override       number(15)
  ,visible_override                number(10)
  );
--
-- ----------------------------------------------------------------------------
