--------------------------------------------------------
--  DDL for Package PAY_CA_EOY_RL1_AMEND_REG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CA_EOY_RL1_AMEND_REG" AUTHID CURRENT_USER AS
/* $Header: pycarl1cr.pkh 120.0.12000000.1 2007/01/17 17:19:44 appldev noship $ */
/*
   ******************************************************************
   *                                                                *
