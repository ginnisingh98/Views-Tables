--------------------------------------------------------
--  DDL for Package JTF_TASK_TEMP_GROUP_IUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_TASK_TEMP_GROUP_IUHK" AUTHID CURRENT_USER AS
/* $Header: jtfitkgs.pls 115.6 2002/12/05 23:48:36 sachoudh ship $ */
