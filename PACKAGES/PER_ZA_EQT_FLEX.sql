--------------------------------------------------------
--  DDL for Package PER_ZA_EQT_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_EQT_FLEX" AUTHID CURRENT_USER as
/* $Header: pezaeqfl.pkh 115.0 2001/02/04 22:32:30 pkm ship        $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
