--------------------------------------------------------
--  DDL for Package BEN_XFI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XFI_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  xfi_attribute_category            varchar2(30),
  xfi_attribute1                    varchar2(150),
  xfi_attribute2                    varchar2(150),
  xfi_attribute3                    varchar2(150),
  xfi_attribute4                    varchar2(150),
  xfi_attribute5                    varchar2(150),
  xfi_attribute6                    varchar2(150),
  xfi_attribute7                    varchar2(150),
  xfi_attribute8                    varchar2(150),
  xfi_attribute9                    varchar2(150),
  xfi_attribute10                   varchar2(150),
  xfi_attribute11                   varchar2(150),
  xfi_attribute12                   varchar2(150),
  xfi_attribute13                   varchar2(150),
  xfi_attribute14                   varchar2(150),
  xfi_attribute15                   varchar2(150),
  xfi_attribute16                   varchar2(150),
  xfi_attribute17                   varchar2(150),
  xfi_attribute18                   varchar2(150),
  xfi_attribute19                   varchar2(150),
  xfi_attribute20                   varchar2(150),
  xfi_attribute21                   varchar2(150),
  xfi_attribute22                   varchar2(150),
  xfi_attribute23                   varchar2(150),
  xfi_attribute24                   varchar2(150),
  xfi_attribute25                   varchar2(150),
  xfi_attribute26                   varchar2(150),
  xfi_attribute27                   varchar2(150),
  xfi_attribute28                   varchar2(150),
  xfi_attribute29                   varchar2(150),
  xfi_attribute30                   varchar2(150),
  ext_rcd_in_file_id                number       ,
  ext_data_elmt_in_rcd_id1          number       ,
  ext_data_elmt_in_rcd_id2          number       ,
