--------------------------------------------------------
--  DDL for Package HR_PSF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PSF_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  fte                               number(14,5),      -- Increased length and precision
  max_persons                       number(9),        -- Increased length
  name                              varchar2(240),
  overlap_period                    number(22,2),
  ...
  proposed_fte_for_layoff           number(11,2),    -- Increased
  proposed_date_for_layoff          date,
  pay_basis_id                      number(11,2),    -- Increased
  supervisor_id                     number(11,2),    -- Increased
  copied_to_old_table_flag          varchar2(30),
...
function SYSTEM_AVAILABILITY_STATUS (
         p_availability_status_id      number) return varchar2;
--
-- ----------------------------------------------------------------------------
-- |-------------------------< position_wf_sync >-----------------------------|
-- ----------------------------------------------------------------------------
--
procedure position_wf_sync(p_position_id number, p_effective_date date);
--
-- ----------------------------------------------------------------------------
-- |---------------------------< my_synch_routine >---------------------------|
-- ----------------------------------------------------------------------------
