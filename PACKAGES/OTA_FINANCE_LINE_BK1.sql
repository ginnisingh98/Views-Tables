--------------------------------------------------------
--  DDL for Package OTA_FINANCE_LINE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_FINANCE_LINE_BK1" AUTHID CURRENT_USER as
/* $Header: ottflapi.pkh 120.5 2006/09/11 10:28:57 niarora noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  OTA_FINANCE_LINE_BK1.';
--
-- ----------------------------------------------------------------------------
-- |--------------------------< CREATE_FINANCE_LINE_B >---------------------|
-- ----------------------------------------------------------------------------
-- {Start Of Comments}
--
-- Description:
