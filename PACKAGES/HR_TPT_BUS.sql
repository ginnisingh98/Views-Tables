--------------------------------------------------------
--  DDL for Package HR_TPT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TPT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_tab_page_property_id already exists.
--
--  In Arguments:
