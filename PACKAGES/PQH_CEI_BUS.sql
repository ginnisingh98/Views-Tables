--------------------------------------------------------
--  DDL for Package PQH_CEI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_CEI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_corps_extra_info_id
--     already exists.
--
--  In Arguments:
