--------------------------------------------------------
--  DDL for Package OKL_SETUPOVERULES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_SETUPOVERULES_PUB_W" AUTHID CURRENT_USER as
  /* $Header: OKLUSODS.pls 115.3 2002/12/24 04:19:16 sgorantl noship $ */
