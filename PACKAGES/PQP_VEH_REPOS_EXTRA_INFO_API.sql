--------------------------------------------------------
--  DDL for Package PQP_VEH_REPOS_EXTRA_INFO_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQP_VEH_REPOS_EXTRA_INFO_API" AUTHID CURRENT_USER as
 ...
 * The extra information types are either delivered by the product or created
 * by the customer. Extra information types store additional information
 * regarding the vehicle, that is not already supported by the module.
 * @rep:scope public
 * @rep:product PER
 * @rep:displayname Vehicle Repository Extra Information
*/
--
-- ----------------------------------------------------------------------------
...
-- {Start Of Comments}
/*#
 * This API creates vehicle repository extra information.
 *
 * The information type and the data stored in each of the columns is defined
 * in the flexfield. Each of the column data is dependend on the valueset of
 ...
 * Vehicle Repository record should be present before creating a vehicle
 * repository extra information.
 *
 * <p><b>Post Success</b><br>
 * The Vehicle Repository Extra Information record will be successfully
 * inserted into the database.
 *
 * <p><b>Post Failure</b><br>
 * The Vehicle Repository Extra Information record will not be created and an
 * error will be raised.
 *
 * @param p_validate If true, then validation alone will be performed and the
 * database will remain unchanged. If false and all validation checks pass,
 * then the database will be modified.
 * @param p_vehicle_repository_id The vehicle for which the extra information
 * is created. It is a foreign key to PQP_VEHICLE_REPOSITORY_F.
 * @param p_information_type Foreign key to PQP_VEH_REPOS_INFO_TYPES to
 * identify the type of information.
 * @param p_vrei_attribute_category Descriptive flexfield column. It identifies
 * the data stored in the flexfield.
 * @param p_vrei_attribute1 Descriptive flexfield column.
 * @param p_vrei_attribute2 Descriptive flexfield column.
 * @param p_vrei_attribute3 Descriptive flexfield column.
 * @param p_vrei_attribute4 Descriptive flexfield column.
 * @param p_vrei_attribute5 Descriptive flexfield column.
 * @param p_vrei_attribute6 Descriptive flexfield column.
 * @param p_vrei_attribute7 Descriptive flexfield column.
 * @param p_vrei_attribute8 Descriptive flexfield column.
 * @param p_vrei_attribute9 Descriptive flexfield column.
 * @param p_vrei_attribute10 Descriptive flexfield column.
 * @param p_vrei_attribute11 Descriptive flexfield column.
 * @param p_vrei_attribute12 Descriptive flexfield column.
 * @param p_vrei_attribute13 Descriptive flexfield column.
 * @param p_vrei_attribute14 Descriptive flexfield column.
 * @param p_vrei_attribute15 Descriptive flexfield column.
 * @param p_vrei_attribute16 Descriptive flexfield column.
 * @param p_vrei_attribute17 Descriptive flexfield column.
 * @param p_vrei_attribute18 Descriptive flexfield column.
 * @param p_vrei_attribute19 Descriptive flexfield column.
 * @param p_vrei_attribute20 Descriptive flexfield column.
 * @param p_vrei_information_category Developer descriptive flexfield column.
 * @param p_vrei_information1 Developer descriptive flexfield column.
 * @param p_vrei_information2 Developer descriptive flexfield column.
 * @param p_vrei_information3 Developer descriptive flexfield column.
 * @param p_vrei_information4 Developer descriptive flexfield column.
 * @param p_vrei_information5 Developer descriptive flexfield column.
 * @param p_vrei_information6 Developer descriptive flexfield column.
 * @param p_vrei_information7 Developer descriptive flexfield column.
 * @param p_vrei_information8 Developer descriptive flexfield column.
 * @param p_vrei_information9 Developer descriptive flexfield column.
 * @param p_vrei_information10 Developer descriptive flexfield column.
 * @param p_vrei_information11 Developer descriptive flexfield column.
 * @param p_vrei_information12 Developer descriptive flexfield column.
 * @param p_vrei_information13 Developer descriptive flexfield column.
 * @param p_vrei_information14 Developer descriptive flexfield column.
 * @param p_vrei_information15 Developer descriptive flexfield column.
 * @param p_vrei_information16 Developer descriptive flexfield column.
 * @param p_vrei_information17 Developer descriptive flexfield column.
 * @param p_vrei_information18 Developer descriptive flexfield column.
 * @param p_vrei_information19 Developer descriptive flexfield column.
 * @param p_vrei_information20 Developer descriptive flexfield column.
 * @param p_vrei_information21 Developer descriptive flexfield column.
 * @param p_vrei_information22 Developer descriptive flexfield column.
 * @param p_vrei_information23 Developer descriptive flexfield column.
 * @param p_vrei_information24 Developer descriptive flexfield column.
 * @param p_vrei_information25 Developer descriptive flexfield column.
 * @param p_vrei_information26 Developer descriptive flexfield column.
 * @param p_vrei_information27 Developer descriptive flexfield column.
 * @param p_vrei_information28 Developer descriptive flexfield column.
 * @param p_vrei_information29 Developer descriptive flexfield column.
 * @param p_vrei_information30 Developer descriptive flexfield column.
 ...
 * @param p_veh_repos_extra_info_id The primary key generated for the vehicle
 * repository extra information record. If p_validate is true, then set to
 * null.
 * @param p_object_version_number If p_validate is false, then set to the
 * version number of the created vehicle repository extra information. If
 * p_validate is true, then the value will be null.
 * @rep:displayname Create Vehicle Repository Extra Information
...
-- {Start Of Comments}
/*#
 * This API updates vehicle repository extra information.
 *
 * The information type and the data stored in each of the columns is defined
 * in the flexfield. You can update the columns based on the definition of the
 * value set for each of the individual segments.
 *
 * <p><b>Licensing</b><br>
 * This API is licensed for use with Human Resources.
 *
 ...
 *
 * <p><b>Post Success</b><br>
 * The Vehicle Repository Extra Information record will be successfully updated
 * in the database.
 *
 * <p><b>Post Failure</b><br>
 * The Vehicle Repository Extra Information record will not be updated and an
 * error will be raised.
 *
 * @param p_validate If true, then validation alone will be performed and the
 * database will remain unchanged. If false and all validation checks pass,
 * then the database will be modified.
 * @param p_veh_repos_extra_info_id System generated primary key column using
 * the sequence PQP_VEH_REPOS_EXTRA_INFO_S.
 * @param p_object_version_number Pass in the current version number of the
 * vehicle repository extra information to be updated. When the API completes
 * if p_validate is false, will be set to the new version number of the updated
 * vehicle repository extra information. If p_validate is true will be set to
 ...
 * @param p_program_update_date When the API is executed from a concurrent
 * program set to when the program was ran.
 * @rep:displayname Update Vehicle Repository Extra Information
 * @rep:category BUSINESS_ENTITY PQP_VEHICLE_REPOSITORY
 * @rep:lifecycle active
 * @rep:category MISC_EXTENSIONS HR_USER_HOOKS
 * @rep:scope public
...
-- {Start Of Comments}
/*#
 * This API deletes vehicle repository extra information.
 *
 ...
 *
 * <p><b>Post Success</b><br>
 * The Vehicle Repository Extra Information record will be successfully deleted
 * from the database.
 *
 * <p><b>Post Failure</b><br>
 * The Vehicle Repository Extra Information record will not be deleted and an
 * error will be raised.
 *
 * @param p_validate If true, then validation alone will be performed and the
 * database will remain unchanged. If false and all validation checks pass,
 ...
 * repository extra information to be deleted.
 * @rep:displayname Delete Vehicle Repository Extra Information
 * @rep:category BUSINESS_ENTITY PQP_VEHICLE_REPOSITORY
 * @rep:lifecycle active
 * @rep:category MISC_EXTENSIONS HR_USER_HOOKS
 * @rep:scope public
