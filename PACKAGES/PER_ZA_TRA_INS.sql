--------------------------------------------------------
--  DDL for Package PER_ZA_TRA_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_TRA_INS" AUTHID CURRENT_USER as
/* $Header: pezatrin.pkh 115.1 2002/12/05 06:52:24 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< ins >----------------------------------|
-- ----------------------------------------------------------------------------
