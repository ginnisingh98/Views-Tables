--------------------------------------------------------
--  DDL for Package BOM_DIAGUNITTEST_BILLHLCHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BOM_DIAGUNITTEST_BILLHLCHK" AUTHID CURRENT_USER AS
/* $Header: BOMDGBIS.pls 120.0.12000000.1 2007/07/26 12:51:52 vggarg noship $ */
