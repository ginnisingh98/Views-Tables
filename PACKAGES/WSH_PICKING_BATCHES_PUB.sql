--------------------------------------------------------
--  DDL for Package WSH_PICKING_BATCHES_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."WSH_PICKING_BATCHES_PUB" AUTHID CURRENT_USER AS
-- $Header: WSHPRPBS.pls 120.3.12010000.2 2009/12/03 14:20:52 gbhargav ship $
/*#
 ...
 * @rep:category BUSINESS_ENTITY WSH_PICKING_BATCHES_PUB
 */
--
--===================
-- PUBLIC VARS
...
--
 TYPE Batch_Info_rec IS Record (
	     ...
	     Customer_Number             hz_cust_accounts.account_number%TYPE, /*Customer Number*/
	     ...
	     append_flag                 wsh_picking_batches.append_flag%TYPE := 'N',
             ...
             allocation_method           wsh_picking_batches.allocation_method%TYPE, -- X-dock
             crossdock_criteria_id       wsh_picking_batches.crossdock_criteria_id%TYPE, -- X-dock
             crossdock_criteria_name     varchar2(80), -- X-dock
             dynamic_replenishment_flag    varchar2(1), --bug# 6689448 (replenishment project)
             -- LSP PROJECT
             client_id                    NUMBER,
