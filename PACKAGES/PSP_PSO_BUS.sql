--------------------------------------------------------
--  DDL for Package PSP_PSO_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_PSO_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_salary_cap_override_id
--     already exists.
--
--  In Arguments:
