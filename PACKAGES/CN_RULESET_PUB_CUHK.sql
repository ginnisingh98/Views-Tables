--------------------------------------------------------
--  DDL for Package CN_RULESET_PUB_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."CN_RULESET_PUB_CUHK" AUTHID CURRENT_USER as
-- $Header: cncrsets.pls 120.1 2005/06/20 17:17:09 appldev ship $
