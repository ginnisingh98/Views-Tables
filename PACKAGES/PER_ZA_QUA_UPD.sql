--------------------------------------------------------
--  DDL for Package PER_ZA_QUA_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_ZA_QUA_UPD" AUTHID CURRENT_USER as
/* $Header: pezaquup.pkh 115.1 2002/12/05 06:51:50 nsugavan noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< upd >----------------------------------|
-- ----------------------------------------------------------------------------
