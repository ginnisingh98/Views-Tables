--------------------------------------------------------
--  DDL for Package OZF_OFFER_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OZF_OFFER_PVT_W" AUTHID CURRENT_USER as
  /* $Header: ozfwofrs.pls 120.12 2006/07/08 00:41:38 rssharma ship $ */
