--------------------------------------------------------
--  DDL for Package AHL_FMP_MR_HEADER_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AHL_FMP_MR_HEADER_PVT_W" AUTHID CURRENT_USER as
  /* $Header: AHLWMRHS.pls 120.0.12010000.2 2008/12/29 01:05:33 sracha ship $ */
