--------------------------------------------------------
--  DDL for Package OKL_ETH_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKL_ETH_PVT_W" AUTHID CURRENT_USER as
  /* $Header: OKLIETHS.pls 120.0 2005/07/07 10:38:30 viselvar noship $ */
