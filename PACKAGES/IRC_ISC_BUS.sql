--------------------------------------------------------
--  DDL for Package IRC_ISC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_ISC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_search_criteria_id
--     already exists.
--
--  In Arguments:
