--------------------------------------------------------
--  DDL for Package OKC_TIME_UTIL_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OKC_TIME_UTIL_PVT" AUTHID CURRENT_USER AS
/* $Header: OKCCTULS.pls 120.1 2005/12/30 10:28:41 skekkar noship $ */
  ---------------------------------------------------------------------------
...
----------------------------------------------------------------------------
  ...
  TYPE col_val_rec IS RECORD (
     ...
     col_value  varchar2(450)
  );

  TYPE t_col_vals is table of col_val_rec index by binary_integer;
...
-- Bug#2249285: New function added to check offsets in months and days for Renewal of Keep Duraion Lines

  FUNCTION get_uom_code(p_timeunit IN VARCHAR2) return VARCHAR2;
