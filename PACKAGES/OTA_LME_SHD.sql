--------------------------------------------------------
--  DDL for Package OTA_LME_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_LME_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (lp_member_enrollment_id         number(9)
  ,lp_enrollment_id                number(9)
  ,learning_path_section_id        number(9)
  ,learning_path_member_id         number(9)
  ,member_status_code              varchar2(30)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'OTA_LP_MEMBER_ENROLLMENTS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
