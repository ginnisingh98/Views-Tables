--------------------------------------------------------
--  DDL for Package PAY_ISB_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_ISB_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_social_benefit_id
--     already exists.
--
--  In Arguments:
--    p_social_benefit_id
