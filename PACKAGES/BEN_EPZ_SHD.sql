--------------------------------------------------------
--  DDL for Package BEN_EPZ_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_EPZ_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  elig_pstl_cd_r_rng_prte_id        number(15),
  ...
  epz_attribute_category            varchar2(30),
  epz_attribute1                    varchar2(150),
  epz_attribute2                    varchar2(150),
  epz_attribute3                    varchar2(150),
  epz_attribute4                    varchar2(150),
  epz_attribute5                    varchar2(150),
  epz_attribute6                    varchar2(150),
  epz_attribute7                    varchar2(150),
  epz_attribute8                    varchar2(150),
  epz_attribute9                    varchar2(150),
  epz_attribute10                   varchar2(150),
  epz_attribute11                   varchar2(150),
  epz_attribute12                   varchar2(150),
  epz_attribute13                   varchar2(150),
  epz_attribute14                   varchar2(150),
  epz_attribute15                   varchar2(150),
  epz_attribute16                   varchar2(150),
  epz_attribute17                   varchar2(150),
  epz_attribute18                   varchar2(150),
  epz_attribute19                   varchar2(150),
  epz_attribute20                   varchar2(150),
  epz_attribute21                   varchar2(150),
  epz_attribute22                   varchar2(150),
  epz_attribute23                   varchar2(150),
  epz_attribute24                   varchar2(150),
  epz_attribute25                   varchar2(150),
  epz_attribute26                   varchar2(150),
  epz_attribute27                   varchar2(150),
  epz_attribute28                   varchar2(150),
  epz_attribute29                   varchar2(150),
  epz_attribute30                   varchar2(150),
...
--           p_base_key_value = :elig_pstl_cd_r_rng_prte_id).
--
-- Post Success:
--   Processing continues.
--
