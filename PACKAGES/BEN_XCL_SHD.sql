--------------------------------------------------------
--  DDL for Package BEN_XCL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_XCL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ext_chg_evt_log_id                number(15),
  chg_evt_cd                        varchar2(30),
  chg_eff_dt                        date,
  chg_user_id                       number(15),
  prmtr_01                          varchar2(90),
  prmtr_02                          varchar2(90),
  prmtr_03                          varchar2(90),
  prmtr_04                          varchar2(90),
  prmtr_05                          varchar2(90),
  prmtr_06                          varchar2(90),
  prmtr_07                          varchar2(90),
  prmtr_08                          varchar2(90),
  prmtr_09                          varchar2(90),
  prmtr_10                          varchar2(90),
  person_id                         number(15),
  business_group_id                 number(15),
  object_version_number             number(9),
  chg_actl_dt                       date,
  new_val1                          varchar2(600),
  new_val2                          varchar2(600),
  new_val3                          varchar2(600),
  new_val4                          varchar2(600),
  new_val5                          varchar2(600),
  new_val6                          varchar2(600),
  old_val1                          varchar2(600),
  old_val2                          varchar2(600),
  old_val3                          varchar2(600),
  old_val4                          varchar2(600),
  old_val5                          varchar2(600),
  old_val6                          varchar2(600)
  );
