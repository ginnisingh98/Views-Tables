--------------------------------------------------------
--  DDL for Package PER_CNT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_CNT_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_configuration_code
--     already exists.
--
--  In Arguments:
