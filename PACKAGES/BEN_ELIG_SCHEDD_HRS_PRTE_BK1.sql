--------------------------------------------------------
--  DDL for Package BEN_ELIG_SCHEDD_HRS_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_ELIG_SCHEDD_HRS_PRTE_BK1" AUTHID CURRENT_USER as
/* $Header: beeshapi.pkh 120.0 2005/05/28 02:56:25 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_SCHEDD_HRS_PRTE_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_SCHEDD_HRS_PRTE_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ELIG_SCHEDD_HRS_PRTE_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ELIG_SCHEDD_HRS_PRTE_a
  (
...
--
end ben_ELIG_SCHEDD_HRS_PRTE_bk1;
