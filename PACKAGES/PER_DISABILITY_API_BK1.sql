--------------------------------------------------------
--  DDL for Package PER_DISABILITY_API_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_DISABILITY_API_BK1" AUTHID CURRENT_USER as
