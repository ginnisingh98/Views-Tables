--------------------------------------------------------
--  DDL for Package PER_PPS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PPS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_parent_spine_id
--     already exists.
--
--  In Arguments:
--    p_parent_spine_id
