--------------------------------------------------------
--  DDL for Package BEN_LSF_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LSF_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_los_fctr_id already exists.
--
--  In Arguments:
--    p_los_fctr_id
--
...
function return_legislation_code
  (p_los_fctr_id in number) return varchar2;
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< insert_validate >----------------------------|
