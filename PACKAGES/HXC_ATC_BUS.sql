--------------------------------------------------------
--  DDL for Package HXC_ATC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HXC_ATC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_alias_type_component_id
--     already exists.
--
--  In Arguments:
