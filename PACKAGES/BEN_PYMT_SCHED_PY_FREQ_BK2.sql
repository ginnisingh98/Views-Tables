--------------------------------------------------------
--  DDL for Package BEN_PYMT_SCHED_PY_FREQ_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PYMT_SCHED_PY_FREQ_BK2" AUTHID CURRENT_USER as
/* $Header: bepsqapi.pkh 120.0 2005/05/28 11:19:54 appldev noship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_pymt_sched_py_freq_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_pymt_sched_py_freq_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< update_pymt_sched_py_freq_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure update_pymt_sched_py_freq_a
  (
   p_pymt_sched_py_freq_id          in  number
  ,p_py_freq_cd                     in  varchar2
  ,p_dflt_flag                      in  varchar2
...
--
end ben_pymt_sched_py_freq_bk2;
