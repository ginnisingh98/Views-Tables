--------------------------------------------------------
--  DDL for Package BEN_PDP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PDP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  cvg_strt_dt                       date,
  cvg_thru_dt                       date,
  cvg_pndg_flag                     varchar2(30),
  pdp_attribute_category            varchar2(30),
  pdp_attribute1                    varchar2(150),
  pdp_attribute2                    varchar2(150),
  pdp_attribute3                    varchar2(150),
  pdp_attribute4                    varchar2(150),
  pdp_attribute5                    varchar2(150),
  pdp_attribute6                    varchar2(150),
  pdp_attribute7                    varchar2(150),
  pdp_attribute8                    varchar2(150),
  pdp_attribute9                    varchar2(150),
  pdp_attribute10                   varchar2(150),
  pdp_attribute11                   varchar2(150),
  pdp_attribute12                   varchar2(150),
  pdp_attribute13                   varchar2(150),
  pdp_attribute14                   varchar2(150),
  pdp_attribute15                   varchar2(150),
  pdp_attribute16                   varchar2(150),
  pdp_attribute17                   varchar2(150),
  pdp_attribute18                   varchar2(150),
  pdp_attribute19                   varchar2(150),
  pdp_attribute20                   varchar2(150),
  pdp_attribute21                   varchar2(150),
  pdp_attribute22                   varchar2(150),
  pdp_attribute23                   varchar2(150),
  pdp_attribute24                   varchar2(150),
  pdp_attribute25                   varchar2(150),
  pdp_attribute26                   varchar2(150),
  pdp_attribute27                   varchar2(150),
  pdp_attribute28                   varchar2(150),
  pdp_attribute29                   varchar2(150),
  pdp_attribute30                   varchar2(150),
  request_id                        number(15),
  program_application_id            number(15),
  program_id                        number(15),
  program_update_date               date,
  object_version_number             number(9),
  ovrdn_flag                        varchar2(9),      -- Increased length
...
--           p_base_key_value = :elig_cvrd_dpnt_id).
--
-- Post Success:
--   Processing continues.
--
