--------------------------------------------------------
--  DDL for Package PER_SPP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SPP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (placement_id                    number(15)
  ,effective_start_date            date
  ,effective_end_date              date
  ,business_group_id               number(15)
  ,assignment_id                   number(10)
  ,step_id                         number(15)
  ,auto_increment_flag             varchar2(30)
