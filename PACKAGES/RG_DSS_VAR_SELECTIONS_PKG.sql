--------------------------------------------------------
--  DDL for Package RG_DSS_VAR_SELECTIONS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."RG_DSS_VAR_SELECTIONS_PKG" AUTHID CURRENT_USER as
/* $Header: rgidvsls.pls 120.2 2002/11/14 02:59:54 djogg ship $ */

  /* Name: check_unique
   * Desc: Check if the already exists. If it does,
  ...
  /* Name: insert_row
   * Desc: Insert a row into rg_dss_var_selections. Ensure that the
