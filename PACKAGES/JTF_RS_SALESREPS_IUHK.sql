--------------------------------------------------------
--  DDL for Package JTF_RS_SALESREPS_IUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_RS_SALESREPS_IUHK" AUTHID CURRENT_USER AS
  /* $Header: jtfrsnss.pls 120.0 2005/05/11 08:20:57 appldev ship $ */
