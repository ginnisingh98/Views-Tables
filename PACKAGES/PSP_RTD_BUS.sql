--------------------------------------------------------
--  DDL for Package PSP_RTD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PSP_RTD_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_template_detail_id
--     already exists.
--
--  In Arguments:
