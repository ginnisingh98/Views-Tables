--------------------------------------------------------
--  DDL for Package BOM_DIAGUNITTEST_IBRDATA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BOM_DIAGUNITTEST_IBRDATA" AUTHID CURRENT_USER AS
/* $Header: BOMDGIBS.pls 120.0.12000000.1 2007/07/26 13:01:34 vggarg noship $ */
