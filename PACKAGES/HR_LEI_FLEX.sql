--------------------------------------------------------
--  DDL for Package HR_LEI_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_LEI_FLEX" AUTHID CURRENT_USER as
/* $Header: hrleifli.pkh 115.0 99/07/17 16:40:36 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
