--------------------------------------------------------
--  DDL for Package PAY_EGU_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_EGU_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_event_group_usage_id
--     already exists.
--
--  In Arguments:
--    p_event_group_usage_id
--
--
--  Post Success:
