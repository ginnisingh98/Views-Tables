--------------------------------------------------------
--  DDL for Package PV_GE_CHKLST_RESP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PV_GE_CHKLST_RESP_PVT" AUTHID CURRENT_USER AS
/* $Header: pvxvgcrs.pls 115.3 2002/12/10 10:22:44 anubhavk ship $ */
-- ===============================================================
-- Start of Comments
-- Package name
...
--===================================================================
TYPE ge_chklst_resp_rec_type IS RECORD
(
       chklst_response_id              NUMBER,
       checklist_item_id               NUMBER,
       object_version_number           NUMBER,
       arc_response_for_entity_code    VARCHAR2(30),
...
g_miss_ge_chklst_resp_rec          ge_chklst_resp_rec_type := NULL;
TYPE  ge_chklst_resp_tbl_type      IS TABLE OF ge_chklst_resp_rec_type INDEX BY BINARY_INTEGER;
g_miss_ge_chklst_resp_tbl          ge_chklst_resp_tbl_type;
