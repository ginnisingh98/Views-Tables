--------------------------------------------------------
--  DDL for Package XLA_AAD_HEADER_AC_ASSGNS_F_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."XLA_AAD_HEADER_AC_ASSGNS_F_PVT" AUTHID CURRENT_USER AS
/* $Header: xlathhac.pkh 120.0 2004/11/04 01:35:54 wychan noship $ */
/*======================================================================+
