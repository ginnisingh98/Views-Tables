--------------------------------------------------------
--  DDL for Package FA_FAS431_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FA_FAS431_XMLP_PKG" AUTHID CURRENT_USER AS
/* $Header: FAS431S.pls 120.1.12010000.1 2008/07/28 13:14:30 appldev ship $ */
	P_BOOK	varchar2(15);
