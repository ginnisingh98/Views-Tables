--------------------------------------------------------
--  DDL for Package BEN_TTP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_TTP_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ttp_attribute_category            varchar2(30),
  ttp_attribute1                    varchar2(150),
  ttp_attribute2                    varchar2(150),
  ttp_attribute3                    varchar2(150),
  ttp_attribute4                    varchar2(150),
  ttp_attribute5                    varchar2(150),
  ttp_attribute6                    varchar2(150),
  ttp_attribute7                    varchar2(150),
  ttp_attribute8                    varchar2(150),
  ttp_attribute9                    varchar2(150),
  ttp_attribute10                   varchar2(150),
  ttp_attribute11                   varchar2(150),
  ttp_attribute12                   varchar2(150),
  ttp_attribute13                   varchar2(150),
  ttp_attribute14                   varchar2(150),
  ttp_attribute15                   varchar2(150),
  ttp_attribute16                   varchar2(150),
  ttp_attribute17                   varchar2(150),
  ttp_attribute18                   varchar2(150),
  ttp_attribute19                   varchar2(150),
  ttp_attribute20                   varchar2(150),
  ttp_attribute21                   varchar2(150),
  ttp_attribute22                   varchar2(150),
  ttp_attribute23                   varchar2(150),
  ttp_attribute24                   varchar2(150),
  ttp_attribute25                   varchar2(150),
  ttp_attribute26                   varchar2(150),
  ttp_attribute27                   varchar2(150),
  ttp_attribute28                   varchar2(150),
  ttp_attribute29                   varchar2(150),
  ttp_attribute30                   varchar2(150),
...
--           p_base_key_value = :ttl_prtt_rt_id).
--
-- Post Success:
--   Processing continues.
--
