--------------------------------------------------------
--  DDL for Package PQH_LOS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_LOS_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (situation_id                    number(15)
  ,situation                       varchar2(240)
  ,effective_start_date            date
  ,effective_end_date              date
  ,business_group_id               number(15)
  ,situation_type                  varchar2(30)
  ,length_of_service               varchar2(30)
  ,employee_type                   varchar2(30)
  ,entitlement_flag                varchar2(10)
  ,worktime_proportional           varchar2(10)
  ,entitlement_value               number(22,3)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_SITUATIONS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
