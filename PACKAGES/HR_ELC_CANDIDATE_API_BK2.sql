--------------------------------------------------------
--  DDL for Package HR_ELC_CANDIDATE_API_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_ELC_CANDIDATE_API_BK2" AUTHID CURRENT_USER as
/* $Header: peecaapi.pkh 120.1 2005/10/02 02:15:09 aroussel $ */
--
-- ----------------------------------------------------------------------------
-- |--------------------------< update_election_candidate_b >--------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_election_candidate_b
...
--
-- ----------------------------------------------------------------------------
-- |--------------------------< update_election_candidate_a >--------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_election_candidate_a
  (p_election_candidate_id         in     number
  ,p_object_version_number         in     number
  ,p_business_group_id             in     number
  ,p_person_id                     in     number
