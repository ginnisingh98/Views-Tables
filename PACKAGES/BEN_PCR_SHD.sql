--------------------------------------------------------
--  DDL for Package BEN_PCR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_PCR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  per_cm_trgr_id                    number(15),
  effective_start_date              date,
  effective_end_date                date,
  cm_trgr_id                        number(15),
  per_cm_id                         number(15),
  business_group_id                 number(15),
  pcr_attribute_category            varchar2(30),
  pcr_attribute1                    varchar2(150),
  pcr_attribute2                    varchar2(150),
  pcr_attribute3                    varchar2(150),
  pcr_attribute4                    varchar2(150),
  pcr_attribute5                    varchar2(150),
  pcr_attribute6                    varchar2(150),
  pcr_attribute7                    varchar2(150),
  pcr_attribute8                    varchar2(150),
  pcr_attribute9                    varchar2(150),
  pcr_attribute10                   varchar2(150),
  pcr_attribute11                   varchar2(150),
  pcr_attribute12                   varchar2(150),
  pcr_attribute13                   varchar2(150),
  pcr_attribute14                   varchar2(150),
  pcr_attribute15                   varchar2(150),
  pcr_attribute16                   varchar2(150),
  pcr_attribute17                   varchar2(150),
  pcr_attribute18                   varchar2(150),
  pcr_attribute19                   varchar2(150),
  pcr_attribute20                   varchar2(150),
  pcr_attribute21                   varchar2(150),
  pcr_attribute22                   varchar2(150),
  pcr_attribute23                   varchar2(150),
  pcr_attribute24                   varchar2(150),
  pcr_attribute25                   varchar2(150),
  pcr_attribute26                   varchar2(150),
  pcr_attribute27                   varchar2(150),
  pcr_attribute28                   varchar2(150),
  pcr_attribute29                   varchar2(150),
  pcr_attribute30                   varchar2(150),
...
--           p_base_key_value = :per_cm_trgr_id).
--
-- Post Success:
--   Processing continues.
--
