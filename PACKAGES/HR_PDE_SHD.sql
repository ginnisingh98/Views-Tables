--------------------------------------------------------
--  DDL for Package HR_PDE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PDE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (person_deplymt_eit_id           number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_PERSON_DEPLYMT_EITS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
