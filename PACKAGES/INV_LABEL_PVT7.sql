--------------------------------------------------------
--  DDL for Package INV_LABEL_PVT7
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."INV_LABEL_PVT7" AUTHID CURRENT_USER AS
/* $Header: INVLAP7S.pls 120.0.12010000.1 2008/07/24 01:37:49 appldev ship $ */
G_PKG_NAME	CONSTANT VARCHAR2(50) := 'INV_LABEL_PVT7';
