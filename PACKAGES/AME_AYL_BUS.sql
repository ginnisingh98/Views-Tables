--------------------------------------------------------
--  DDL for Package AME_AYL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."AME_AYL_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_action_type_id
--     already exists.
--
--  In Arguments:
--    p_action_type_id
