--------------------------------------------------------
--  DDL for Package PER_BF_PAYMENT_DETAILS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_BF_PAYMENT_DETAILS_BK1" AUTHID CURRENT_USER AS
...
-- ----------------------------------------------------------------------------
--
procedure create_payment_detail_b
...
--
-- ----------------------------------------------------------------------------
-- |----------------------< create_payment_detail_a >-------------------------|
-- ----------------------------------------------------------------------------
--
procedure create_payment_detail_a
  (p_effective_date               in     date
  ,p_business_group_id            in     number
  ,p_personal_payment_method_id   in     number
  ,p_check_number                 in     number
...
--
end per_bf_payment_details_bk1;
