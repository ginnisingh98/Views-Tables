--------------------------------------------------------
--  DDL for Package PER_PERFRALC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_PERFRALC_PKG" AUTHID CURRENT_USER AS
/*$Header: perfralc.pkh 115.7 2002/11/25 15:56:20 sfmorris ship $*/
