--------------------------------------------------------
--  DDL for Package BEN_BER_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_BER_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,elig_flag                       varchar2(9)       -- Increased length
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'BEN_ELIG_RSLT_F';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
