--------------------------------------------------------
--  DDL for Package PER_SSM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SSM_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  salary_survey_mapping_id          number(15),
  parent_id                         number(15),
  ...
  grade_id                          number(15),
  company_organization_id           number(15),
  company_age_code                  varchar2(30),
