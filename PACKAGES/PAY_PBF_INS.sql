--------------------------------------------------------
--  DDL for Package PAY_PBF_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_PBF_INS" AUTHID CURRENT_USER as
...
--    provided it can be derived whether the feed is for
--    initial balance feed or not.
--
-- Post Success:
