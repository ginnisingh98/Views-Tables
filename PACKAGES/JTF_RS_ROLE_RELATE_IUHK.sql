--------------------------------------------------------
--  DDL for Package JTF_RS_ROLE_RELATE_IUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_RS_ROLE_RELATE_IUHK" AUTHID CURRENT_USER AS
 /* $Header: jtfrsnls.pls 120.0 2005/05/11 08:20:51 appldev ship $ */
