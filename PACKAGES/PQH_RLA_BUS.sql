--------------------------------------------------------
--  DDL for Package PQH_RLA_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_RLA_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_rule_attribute_id
--     already exists.
--
--  In Arguments:
--    p_rule_attribute_id
