--------------------------------------------------------
--  DDL for Package HR_PDC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PDC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_person_deplymt_contact_id
--     already exists.
--
--  In Arguments:
