--------------------------------------------------------
--  DDL for Package BEN_DCL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_DCL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  dpnt_cvrd_othr_pl_rt_id         number(15),
  ...
  pl_id                             number(15),
  dcl_attribute_category            varchar2(30),
  dcl_attribute1                    varchar2(150),
  dcl_attribute2                    varchar2(150),
  dcl_attribute3                    varchar2(150),
  dcl_attribute4                    varchar2(150),
  dcl_attribute5                    varchar2(150),
  dcl_attribute6                    varchar2(150),
  dcl_attribute7                    varchar2(150),
  dcl_attribute8                    varchar2(150),
  dcl_attribute9                    varchar2(150),
  dcl_attribute10                   varchar2(150),
  dcl_attribute11                   varchar2(150),
  dcl_attribute12                   varchar2(150),
  dcl_attribute13                   varchar2(150),
  dcl_attribute14                   varchar2(150),
  dcl_attribute15                   varchar2(150),
  dcl_attribute16                   varchar2(150),
  dcl_attribute17                   varchar2(150),
  dcl_attribute18                   varchar2(150),
  dcl_attribute19                   varchar2(150),
  dcl_attribute20                   varchar2(150),
  dcl_attribute21                   varchar2(150),
  dcl_attribute22                   varchar2(150),
  dcl_attribute23                   varchar2(150),
  dcl_attribute24                   varchar2(150),
  dcl_attribute25                   varchar2(150),
  dcl_attribute26                   varchar2(150),
  dcl_attribute27                   varchar2(150),
  dcl_attribute28                   varchar2(150),
  dcl_attribute29                   varchar2(150),
  dcl_attribute30                   varchar2(150),
...
--           p_base_key_value = :dpnt_cvrd_othr_pl_rt_id).
--
-- Post Success:
--   Processing continues.
--
