--------------------------------------------------------
--  DDL for Package BEN_LPR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LPR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_chg_plip_enrt_id              number(15),
  ...
  enrt_cd                           varchar2(30),
  lpr_attribute_category            varchar2(30),
  lpr_attribute1                    varchar2(150),
  lpr_attribute2                    varchar2(150),
  lpr_attribute3                    varchar2(150),
  lpr_attribute4                    varchar2(150),
  lpr_attribute5                    varchar2(150),
  lpr_attribute6                    varchar2(150),
  lpr_attribute7                    varchar2(150),
  lpr_attribute8                    varchar2(150),
  lpr_attribute9                    varchar2(150),
  lpr_attribute10                   varchar2(150),
  lpr_attribute11                   varchar2(150),
  lpr_attribute12                   varchar2(150),
  lpr_attribute13                   varchar2(150),
  lpr_attribute14                   varchar2(150),
  lpr_attribute15                   varchar2(150),
  lpr_attribute16                   varchar2(150),
  lpr_attribute17                   varchar2(150),
  lpr_attribute18                   varchar2(150),
  lpr_attribute19                   varchar2(150),
  lpr_attribute20                   varchar2(150),
  lpr_attribute21                   varchar2(150),
  lpr_attribute22                   varchar2(150),
  lpr_attribute23                   varchar2(150),
  lpr_attribute24                   varchar2(150),
  lpr_attribute25                   varchar2(150),
  lpr_attribute26                   varchar2(150),
  lpr_attribute27                   varchar2(150),
  lpr_attribute28                   varchar2(150),
  lpr_attribute29                   varchar2(150),
  lpr_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_chg_plip_enrt_id).
--
-- Post Success:
--   Processing continues.
--
