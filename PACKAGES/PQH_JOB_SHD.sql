--------------------------------------------------------
--  DDL for Package PQH_JOB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_JOB_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (wrkplc_vldtn_job_id             number(15)
  ,wrkplc_vldtn_op_id              number(15)
  ,wrkplc_job_id                   number(15)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PQH_DE_WRKPLC_VLDTN_JOBS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
