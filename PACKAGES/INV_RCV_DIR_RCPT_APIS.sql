--------------------------------------------------------
--  DDL for Package INV_RCV_DIR_RCPT_APIS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."INV_RCV_DIR_RCPT_APIS" AUTHID CURRENT_USER AS
/* $Header: INVDIRDS.pls 120.0.12000000.1 2007/01/17 16:13:41 appldev ship $*/
...
PROCEDURE create_direct_rti_rec(p_move_order_header_id IN OUT NOCOPY NUMBER,
            ...
            p_secondary_rcv_qty IN NUMBER DEFAULT NULL,
