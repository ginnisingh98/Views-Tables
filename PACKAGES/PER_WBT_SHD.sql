--------------------------------------------------------
--  DDL for Package PER_WBT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_WBT_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,workbench_item_name             varchar2(240)
  ,workbench_item_description      varchar2(240)
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'PER_RI_WORKBENCH_ITEMS_TL';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
