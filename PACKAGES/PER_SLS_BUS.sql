--------------------------------------------------------
--  DDL for Package PER_SLS_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_SLS_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_solution_set_name
--    p_user_id
--     already exists.
--
--  In Arguments:
