--------------------------------------------------------
--  DDL for Package HR_PFT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_PFT_SHD" AUTHID CURRENT_USER as
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'HR_ALL_POSITIONS_F_TL';
--
g_app_code  varchar2(3) := 'PER';
g_flex_code varchar2(3) := 'POS';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
