--------------------------------------------------------
--  DDL for Package BIM_SLCHN_CMPR_TEMP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BIM_SLCHN_CMPR_TEMP_PVT" AUTHID CURRENT_USER AS
/* $Header: bimvsccs.pls 115.2 2000/03/03 20:36:27 pkm ship  $ */
