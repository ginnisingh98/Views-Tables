--------------------------------------------------------
--  DDL for Package OTA_ANC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."OTA_ANC_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_announcement_id
--     already exists.
--
--  In Arguments:
--    p_announcement_id
