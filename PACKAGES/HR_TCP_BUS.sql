--------------------------------------------------------
--  DDL for Package HR_TCP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_TCP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_template_item_context_page_i already exists.
--
--  In Arguments:
