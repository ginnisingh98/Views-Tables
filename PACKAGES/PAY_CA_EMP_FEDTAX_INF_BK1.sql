--------------------------------------------------------
--  DDL for Package PAY_CA_EMP_FEDTAX_INF_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_CA_EMP_FEDTAX_INF_BK1" AUTHID CURRENT_USER as
/* $Header: pycatapi.pkh 120.1.12010000.1 2008/07/27 22:17:49 appldev ship $ */
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ca_emp_fedtax_inf_b >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ca_emp_fedtax_inf_b
  (
...
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_ca_emp_fedtax_inf_a >-----------------|
-- ----------------------------------------------------------------------------
--
procedure create_ca_emp_fedtax_inf_a
  (
