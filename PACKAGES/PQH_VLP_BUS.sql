--------------------------------------------------------
--  DDL for Package PQH_VLP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PQH_VLP_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_validation_period_id
--     already exists.
--
--  In Arguments:
