--------------------------------------------------------
--  DDL for Package BEN_LPL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LPL_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_per_info_cs_ler_id            number(15),
  effective_start_date              date,
  effective_end_date                date,
  ler_per_info_cs_ler_rl            number(15),
  per_info_chg_cs_ler_id            number(15),
  ler_id                            number(15),
  business_group_id                 number(15),
  lpl_attribute_category            varchar2(30),
  lpl_attribute1                    varchar2(150),
  lpl_attribute2                    varchar2(150),
  lpl_attribute3                    varchar2(150),
  lpl_attribute4                    varchar2(150),
  lpl_attribute5                    varchar2(150),
  lpl_attribute6                    varchar2(150),
  lpl_attribute7                    varchar2(150),
  lpl_attribute8                    varchar2(150),
  lpl_attribute9                    varchar2(150),
  lpl_attribute10                   varchar2(150),
  lpl_attribute11                   varchar2(150),
  lpl_attribute12                   varchar2(150),
  lpl_attribute13                   varchar2(150),
  lpl_attribute14                   varchar2(150),
  lpl_attribute15                   varchar2(150),
  lpl_attribute16                   varchar2(150),
  lpl_attribute17                   varchar2(150),
  lpl_attribute18                   varchar2(150),
  lpl_attribute19                   varchar2(150),
  lpl_attribute20                   varchar2(150),
  lpl_attribute21                   varchar2(150),
  lpl_attribute22                   varchar2(150),
  lpl_attribute23                   varchar2(150),
  lpl_attribute24                   varchar2(150),
  lpl_attribute25                   varchar2(150),
  lpl_attribute26                   varchar2(150),
  lpl_attribute27                   varchar2(150),
  lpl_attribute28                   varchar2(150),
  lpl_attribute29                   varchar2(150),
  lpl_attribute30                   varchar2(150),
  chg_mandatory_cd                   varchar2(30),
...
--           p_base_key_value = :ler_per_info_cs_ler_id).
--
-- Post Success:
--   Processing continues.
--
