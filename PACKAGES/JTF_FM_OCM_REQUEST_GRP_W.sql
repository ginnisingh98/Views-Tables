--------------------------------------------------------
--  DDL for Package JTF_FM_OCM_REQUEST_GRP_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_FM_OCM_REQUEST_GRP_W" AUTHID CURRENT_USER as
  /* $Header: jtfgfmows.pls 120.1 2005/07/02 00:43:51 appldev ship $ */
