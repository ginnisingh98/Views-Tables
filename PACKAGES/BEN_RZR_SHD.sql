--------------------------------------------------------
--  DDL for Package BEN_RZR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_RZR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  from_value                        varchar2(90),
  to_value                          varchar2(90),
  business_group_id                 number(15),
  rzr_attribute_category            varchar2(30),
  rzr_attribute1                    varchar2(150),
  rzr_attribute10                   varchar2(150),
  rzr_attribute11                   varchar2(150),
  rzr_attribute12                   varchar2(150),
  rzr_attribute13                   varchar2(150),
  rzr_attribute14                   varchar2(150),
  rzr_attribute15                   varchar2(150),
  rzr_attribute16                   varchar2(150),
  rzr_attribute17                   varchar2(150),
  rzr_attribute18                   varchar2(150),
  rzr_attribute19                   varchar2(150),
  rzr_attribute2                    varchar2(150),
  rzr_attribute20                   varchar2(150),
  rzr_attribute21                   varchar2(150),
  rzr_attribute22                   varchar2(150),
  rzr_attribute23                   varchar2(150),
  rzr_attribute24                   varchar2(150),
  rzr_attribute25                   varchar2(150),
  rzr_attribute26                   varchar2(150),
  rzr_attribute27                   varchar2(150),
  rzr_attribute28                   varchar2(150),
  rzr_attribute29                   varchar2(150),
  rzr_attribute3                    varchar2(150),
  rzr_attribute30                   varchar2(150),
  rzr_attribute4                    varchar2(150),
  rzr_attribute5                    varchar2(150),
  rzr_attribute6                    varchar2(150),
  rzr_attribute7                    varchar2(150),
  rzr_attribute8                    varchar2(150),
  rzr_attribute9                    varchar2(150),
...
--           p_base_key_value = :pstl_zip_rng_id).
--
-- Post Success:
--   Processing continues.
--
