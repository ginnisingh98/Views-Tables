--------------------------------------------------------
--  DDL for Package FARX_C_MAD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."FARX_C_MAD" AUTHID CURRENT_USER as
-- $Header: farxcmds.pls 120.2.12010000.2 2009/07/19 13:47:53 glchen ship $
