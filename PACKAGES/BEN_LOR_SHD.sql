--------------------------------------------------------
--  DDL for Package BEN_LOR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_LOR_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (
  ler_chg_plip_enrt_rl_id           number(15),
  ...
  lor_attribute_category            varchar2(30),
  lor_attribute1                    varchar2(150),
  lor_attribute2                    varchar2(150),
  lor_attribute3                    varchar2(150),
  lor_attribute4                    varchar2(150),
  lor_attribute5                    varchar2(150),
  lor_attribute6                    varchar2(150),
  lor_attribute7                    varchar2(150),
  lor_attribute8                    varchar2(150),
  lor_attribute9                    varchar2(150),
  lor_attribute10                   varchar2(150),
  lor_attribute11                   varchar2(150),
  lor_attribute12                   varchar2(150),
  lor_attribute13                   varchar2(150),
  lor_attribute14                   varchar2(150),
  lor_attribute15                   varchar2(150),
  lor_attribute16                   varchar2(150),
  lor_attribute17                   varchar2(150),
  lor_attribute18                   varchar2(150),
  lor_attribute19                   varchar2(150),
  lor_attribute20                   varchar2(150),
  lor_attribute21                   varchar2(150),
  lor_attribute22                   varchar2(150),
  lor_attribute23                   varchar2(150),
  lor_attribute24                   varchar2(150),
  lor_attribute25                   varchar2(150),
  lor_attribute26                   varchar2(150),
  lor_attribute27                   varchar2(150),
  lor_attribute28                   varchar2(150),
  lor_attribute29                   varchar2(150),
  lor_attribute30                   varchar2(150),
...
--           p_base_key_value = :ler_chg_plip_enrt_rl_id).
--
-- Post Success:
--   Processing continues.
--
