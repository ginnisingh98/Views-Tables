--------------------------------------------------------
--  DDL for Package PER_AST_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_AST_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  weighting_scale_id                number(9),
  rating_scale_comment              varchar2(2000),
  weighting_scale_comment           varchar2(2000),
  assessment_classification         varchar2(30),
  display_assessment_comments       varchar2(30),
  date_from	                        date,
  date_to                           date,
  comments                          varchar2(2000),   -- pseudo column
  instructions                      varchar2(2000),
  weighting_classification          varchar2(30),
  line_score_formula                varchar2(30),
  total_score_formula               varchar2(30),
  ...
  type	                            varchar2(30),
  line_score_formula_id		    number(9),
  default_job_competencies          varchar2(30),
