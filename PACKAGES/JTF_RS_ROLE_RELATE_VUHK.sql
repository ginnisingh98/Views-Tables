--------------------------------------------------------
--  DDL for Package JTF_RS_ROLE_RELATE_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."JTF_RS_ROLE_RELATE_VUHK" AUTHID CURRENT_USER AS
 /* $Header: jtfrsils.pls 120.0 2005/05/11 08:20:17 appldev ship $ */
