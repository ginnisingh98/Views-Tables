--------------------------------------------------------
--  DDL for Package BEN_OPI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_OPI_UPD" AUTHID CURRENT_USER as
...
--   2) After the conversion has taken optace, the corresponding record upd
