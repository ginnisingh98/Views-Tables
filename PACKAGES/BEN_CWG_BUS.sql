--------------------------------------------------------
--  DDL for Package BEN_CWG_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."BEN_CWG_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_cwb_wksht_grp_id
--     already exists.
--
--  In Arguments:
--    p_cwb_wksht_grp_id
