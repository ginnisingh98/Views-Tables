--------------------------------------------------------
--  DDL for Package IRC_RSE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."IRC_RSE_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  ...
  ,date_from                       date
  ,date_to                         date
  ,posting_username                varchar2(240)
  ,posting_password                varchar2(240)
  ,internal                        varchar2(30)
  ,external                        varchar2(30)
  ,third_party                     varchar2(30)
  ,posting_cost                    number
  ,posting_cost_period             varchar2(30)
  ,posting_cost_currency           varchar2(30)
  ,stylesheet             varchar2(4000)
  ...
  ,posting_impl_class              varchar2(4000)
  );
--
-- ----------------------------------------------------------------------------
...
-- Global table name
g_tab_nam  constant varchar2(30) := 'IRC_ALL_RECRUITING_SITES';
