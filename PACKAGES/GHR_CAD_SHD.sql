--------------------------------------------------------
--  DDL for Package GHR_CAD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."GHR_CAD_SHD" AUTHID CURRENT_USER as
...
Type g_rec_type Is Record
  (compl_adr_id                    number(15)
  ,complaint_id                    number(15)
  ,stage                           varchar2(30)
  ,start_date                      date
  ,end_date                        date
  ,adr_resource                    varchar2(30)
  ,technique                       varchar2(30)
  ,outcome                         varchar2(30)
  ,adr_offered                     varchar2(30)
  ,date_accepted                   date
