--------------------------------------------------------
--  DDL for Package HR_AE_UTILITY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."HR_AE_UTILITY" AUTHID CURRENT_USER AS
 /* $Header: hraeutil.pkh 120.0 2005/09/10 03:56:58 psnellin noship $ */
 --
 --
