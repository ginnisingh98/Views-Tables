--------------------------------------------------------
--  DDL for Package PAY_UCI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PAY_UCI_BUS" AUTHID CURRENT_USER as
...
--
--  Prerequisites:
--    The primary key identified by p_user_column_instance_id
--     already exists.
--
--  In Arguments:
