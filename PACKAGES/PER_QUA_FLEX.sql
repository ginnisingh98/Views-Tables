--------------------------------------------------------
--  DDL for Package PER_QUA_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."PER_QUA_FLEX" AUTHID CURRENT_USER as
/* $Header: pequafli.pkh 115.0 99/07/18 14:41:03 porting ship $ */
--
-- -----------------------------------------------------------------------------
-- |-------------------------------< df >--------------------------------------|
-- -----------------------------------------------------------------------------
