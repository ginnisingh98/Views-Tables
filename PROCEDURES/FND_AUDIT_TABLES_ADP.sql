--------------------------------------------------------
--  DDL for Procedure FND_AUDIT_TABLES_ADP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."FND_AUDIT_TABLES_ADP" (A0 IN NUMBER,A1 IN NUMBER,A2 IN NUMBER,A3 IN NUMBER,JB IN VARCHAR2,E0 IN NUMBER,E1 IN NUMBER,E2 IN NUMBER,E3 IN NUMBER,RB IN VARCHAR2)
AS
NXT NUMBER;
CMT NUMBER;
NUSER varchar2(100);
