--------------------------------------------------------
--  DDL for Procedure IBY_ACCOUNT_OWNERS_AIP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."IBY_ACCOUNT_OWNERS_AIP" (A0 IN NUMBER,JB IN NUMBER,JC IN DATE,JD IN NUMBER,E0 IN NUMBER,RB IN NUMBER,RC IN DATE,RD IN NUMBER )
AS
ROWKEY number;
NXT number;
CMT number;
