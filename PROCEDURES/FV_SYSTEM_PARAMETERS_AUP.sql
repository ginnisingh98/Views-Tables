--------------------------------------------------------
--  DDL for Procedure FV_SYSTEM_PARAMETERS_AUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."FV_SYSTEM_PARAMETERS_AUP" (A0 IN DATE,JB IN VARCHAR2,JC IN NUMBER,JD IN DATE,JF IN VARCHAR2,JG IN VARCHAR2,
...
||decode(JX,NULL,decode(RX,NULL,'N','Y'),'N') INTO newTRUE_NULLS FROM SYS.DUAL;
