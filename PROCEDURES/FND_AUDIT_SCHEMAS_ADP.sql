--------------------------------------------------------
--  DDL for Procedure FND_AUDIT_SCHEMAS_ADP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."FND_AUDIT_SCHEMAS_ADP" (A0 IN NUMBER,JB IN VARCHAR2,E0 IN NUMBER,RB IN VARCHAR2)
AS
NXT NUMBER;
CMT NUMBER;
NUSER varchar2(100);
