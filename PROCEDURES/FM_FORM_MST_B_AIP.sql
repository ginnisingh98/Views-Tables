--------------------------------------------------------
--  DDL for Procedure FM_FORM_MST_B_AIP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."FM_FORM_MST_B_AIP" (A0 IN NUMBER,JB IN NUMBER,JC IN VARCHAR2,JD IN VARCHAR2,JF IN VARCHAR2,JG IN NUMBER,
