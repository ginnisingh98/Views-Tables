--------------------------------------------------------
--  DDL for Procedure GMD_RECIPES_B_ADP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."GMD_RECIPES_B_ADP" (A0 IN NUMBER,JB IN NUMBER,JC IN NUMBER,JD IN NUMBER,JF IN VARCHAR2,JG IN VARCHAR2,
