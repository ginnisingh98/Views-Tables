--------------------------------------------------------
--  DDL for Procedure GMD_RESULTS_ADP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."GMD_RESULTS_ADP" (A0 IN NUMBER,JB IN VARCHAR2,JC IN DATE,JD IN VARCHAR2,JF IN NUMBER,JG IN NUMBER,
