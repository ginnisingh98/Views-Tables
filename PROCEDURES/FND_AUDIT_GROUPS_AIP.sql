--------------------------------------------------------
--  DDL for Procedure FND_AUDIT_GROUPS_AIP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."FND_AUDIT_GROUPS_AIP" (A0 IN NUMBER,A1 IN NUMBER,JB IN VARCHAR2,JC IN VARCHAR2,E0 IN NUMBER,E1 IN NUMBER,RB IN VARCHAR2,RC IN VARCHAR2 )
AS
ROWKEY number;
NXT number;
CMT number;
