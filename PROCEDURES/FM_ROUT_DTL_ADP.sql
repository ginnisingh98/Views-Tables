--------------------------------------------------------
--  DDL for Procedure FM_ROUT_DTL_ADP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."FM_ROUT_DTL_ADP" (A0 IN NUMBER,A1 IN NUMBER,JB IN NUMBER,JC IN NUMBER,JD IN NUMBER,JF IN NUMBER,E0 IN NUMBER,E1 IN NUMBER,RB IN NUMBER,RC IN NUMBER,RD IN NUMBER,RF IN NUMBER)
AS
NXT NUMBER;
CMT NUMBER;
NUSER varchar2(100);
