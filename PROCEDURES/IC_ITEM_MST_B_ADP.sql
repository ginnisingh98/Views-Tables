--------------------------------------------------------
--  DDL for Procedure IC_ITEM_MST_B_ADP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."IC_ITEM_MST_B_ADP" (A0 IN NUMBER,JB IN NUMBER,JC IN NUMBER,JD IN NUMBER,JF IN VARCHAR2,JG IN VARCHAR2,
