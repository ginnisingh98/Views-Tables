--------------------------------------------------------
--  DDL for Procedure FM_MATL_DTL_AUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."FM_MATL_DTL_AUP" (A0 IN NUMBER,JB IN VARCHAR2,JC IN NUMBER,JD IN NUMBER,JF IN VARCHAR2,JG IN NUMBER,
...
||decode(JN,NULL,decode(RN,NULL,'N','Y'),'N') INTO newTRUE_NULLS FROM SYS.DUAL;
