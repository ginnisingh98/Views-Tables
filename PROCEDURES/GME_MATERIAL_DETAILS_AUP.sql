--------------------------------------------------------
--  DDL for Procedure GME_MATERIAL_DETAILS_AUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."GME_MATERIAL_DETAILS_AUP" (A0 IN NUMBER,JB IN NUMBER,JC IN NUMBER,JD IN VARCHAR2,JF IN NUMBER,JG IN NUMBER,
