--------------------------------------------------------
--  DDL for Procedure FM_MATL_DTL_AIP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."FM_MATL_DTL_AIP" (A0 IN NUMBER,JB IN VARCHAR2,JC IN NUMBER,JD IN NUMBER,JF IN VARCHAR2,JG IN NUMBER,
