--------------------------------------------------------
--  DDL for Procedure GMD_RESULTS_AIP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."GMD_RESULTS_AIP" (A0 IN NUMBER,JB IN VARCHAR2,JC IN DATE,JD IN VARCHAR2,JF IN NUMBER,JG IN NUMBER,
...
INSERT INTO GMD_RESULTS_A
 VALUES(SYSDATE,'I',NUSER,NULL,USERENV('SESSIONID'),NXT,CMT,ROWKEY,E0,NULL,NULL,NULL,NULL,NULL,NULL);
