--------------------------------------------------------
--  DDL for Procedure QC_SPEC_MST_AUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."QC_SPEC_MST_AUP" (A0 IN NUMBER,JB IN VARCHAR2,JC IN NUMBER,JD IN DATE,JF IN NUMBER,JG IN VARCHAR2,
...
||decode(JS,NULL,decode(RS,NULL,'N','Y'),'N') INTO newTRUE_NULLS FROM SYS.DUAL;
IF(newTRUE_NULLS='NNNNNNNNNNNNNNNN')THEN newTRUE_NULLS:=NULL;END IF;
