--------------------------------------------------------
--  DDL for Procedure GMD_RECIPE_VALIDITY_RULE_AUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."GMD_RECIPE_VALIDITY_RULE_AUP" (A0 IN NUMBER,JB IN DATE,JC IN NUMBER,JD IN NUMBER,JF IN NUMBER,JG IN VARCHAR2,
...
END GMD_RECIPE_VALIDITY_RULE_AUP;
