--------------------------------------------------------
--  DDL for Procedure FM_FORM_MST_B_AUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."FM_FORM_MST_B_AUP" (A0 IN NUMBER,JB IN NUMBER,JC IN VARCHAR2,JD IN VARCHAR2,JF IN VARCHAR2,JG IN NUMBER,
JH IN VARCHAR2,JJ IN NUMBER,JK IN NUMBER,E0 IN NUMBER,RB IN NUMBER,RC IN VARCHAR2,RD IN VARCHAR2,RF IN VARCHAR2,RG IN NUMBER,
...
||decode(JK,NULL,decode(RK,NULL,'N','Y'),'N') INTO newTRUE_NULLS FROM SYS.DUAL;
IF(newTRUE_NULLS='NNNNNNNNN')THEN newTRUE_NULLS:=NULL;END IF;
