--------------------------------------------------------
--  DDL for Procedure QC_RSLT_MST_ADP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."QC_RSLT_MST_ADP" (A0 IN NUMBER,JB IN NUMBER,JC IN VARCHAR2,JD IN NUMBER,JF IN NUMBER,JG IN NUMBER,
