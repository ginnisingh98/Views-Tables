--------------------------------------------------------
--  DDL for Procedure GMD_SPECIFICATIONS_B_AIP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."GMD_SPECIFICATIONS_B_AIP" (A0 IN NUMBER,JB IN NUMBER,JC IN VARCHAR2,JD IN NUMBER,JF IN NUMBER,E0 IN NUMBER,RB IN NUMBER,RC IN VARCHAR2,RD IN NUMBER,RF IN NUMBER )
AS
ROWKEY number;
NXT number;
CMT number;
