--------------------------------------------------------
--  DDL for Procedure ITIM_UPDATE_USER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."ITIM_UPDATE_USER" (
...
end ITIM_UPDATE_USER;

/

  GRANT EXECUTE ON "APPS"."ITIM_UPDATE_USER" TO "NONAPPS";
