--------------------------------------------------------
--  DDL for Procedure GMD_OPERATIONS_B_AUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."GMD_OPERATIONS_B_AUP" (A0 IN NUMBER,JB IN NUMBER,JC IN DATE,JD IN DATE,JF IN VARCHAR2,JG IN VARCHAR2,
