--------------------------------------------------------
--  DDL for Procedure FA_SYSTEM_CONTROLS_AUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."FA_SYSTEM_CONTROLS_AUP" (A0 IN VARCHAR2,JB IN NUMBER,JC IN VARCHAR2,JD IN VARCHAR2,JF IN VARCHAR2,JG IN VARCHAR2,
...
||decode(KF,NULL,decode(SF,NULL,'N','Y'),'N') INTO newTRUE_NULLS FROM SYS.DUAL;
