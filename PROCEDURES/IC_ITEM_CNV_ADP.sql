--------------------------------------------------------
--  DDL for Procedure IC_ITEM_CNV_ADP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "APPS"."IC_ITEM_CNV_ADP" (A0 IN NUMBER,JB IN NUMBER,JC IN NUMBER,JD IN NUMBER,JF IN VARCHAR2,E0 IN NUMBER,RB IN NUMBER,RC IN NUMBER,RD IN NUMBER,RF IN VARCHAR2)
AS
NXT NUMBER;
CMT NUMBER;
NUSER varchar2(100);
