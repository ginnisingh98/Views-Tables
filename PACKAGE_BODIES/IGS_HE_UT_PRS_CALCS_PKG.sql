--------------------------------------------------------
--  DDL for Package Body IGS_HE_UT_PRS_CALCS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_HE_UT_PRS_CALCS_PKG" AS
/* $Header: IGSWI39B.pls 120.2 2005/07/03 18:44:45 appldev ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_he_ut_prs_calcs%ROWTYPE;
  new_references igs_he_ut_prs_calcs%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.calc_date                         := x_calc_date;
  ...
  */
  BEGIN
    ...
    igs_he_ut_prs_dtls_pkg.get_fk_igs_he_ut_prs_calcs (
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGS_HE_UT_PRS_CALCS_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
  ...
  END IF;
 INSERT INTO igs_he_ut_prs_calcs (
      tariff_calc_type_cd,
      person_id,
      calc_date,
      creation_date,
...
EXCEPTION
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ((tlinfo.calc_date = x_calc_date) OR ((tlinfo.calc_date IS NULL) AND (X_calc_date IS NULL)))
       ) THEN
      NULL;
    ELSE
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGS_HE_UT_PRS_CALCS_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    igs_sc_gen_001.set_ctx('R');
  END IF;
 UPDATE igs_he_ut_prs_calcs
      SET
        calc_date                         = new_references.calc_date,
  ...
  */
  BEGIN
    ...
    igs_sc_gen_001.set_ctx('R');
  END IF;
 DELETE FROM igs_he_ut_prs_calcs
    WHERE rowid = x_rowid;
