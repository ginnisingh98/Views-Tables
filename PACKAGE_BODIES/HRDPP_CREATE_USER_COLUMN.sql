--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_USER_COLUMN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_USER_COLUMN" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:28
 * Generated for API: PAY_USER_COLUMN_API.CREATE_USER_COLUMN
 */
--
...
,P_FORMULA_NAME in varchar2 default null) is
...
L_FORMULA_ID := 
PAY_USER_TABLE_DATA_PUMP.GET_FORMULA_ID
(P_FORMULA_NAME => c.p6
...
,p_business_group_id => p_business_group_id
,P_LEGISLATION_CODE => c.p1
,P_USER_TABLE_ID => L_USER_TABLE_ID
,P_FORMULA_ID => L_FORMULA_ID
,P_USER_COLUMN_NAME => c.p2
,P_USER_COLUMN_ID => L_USER_COLUMN_ID
,P_OBJECT_VERSION_NUMBER => c.p4);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p3,L_USER_COLUMN_ID);
--
