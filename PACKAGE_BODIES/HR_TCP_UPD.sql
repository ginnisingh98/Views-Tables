--------------------------------------------------------
--  DDL for Package Body HR_TCP_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_TCP_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_tcp_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the hr_template_item_context_pages Row
  --
  update hr_template_item_context_pages
    set
     template_item_context_page_id   = p_rec.template_item_context_page_id
...
Begin
  ...
  --
  convert_defs(p_rec);
  hr_tcp_bus.update_validate
     (p_rec
     );
  --
  -- Call the supporting pre-update operation
  --
  hr_tcp_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hr_tcp_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hr_tcp_upd.post_update
     (p_rec
     );
End upd;
--
