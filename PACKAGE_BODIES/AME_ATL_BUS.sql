--------------------------------------------------------
--  DDL for Package Body AME_ATL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ATL_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_atl_bus.';  -- Global package name
--
...
Begin
  ...
  --
  IF NOT ame_atl_shd.api_updating
