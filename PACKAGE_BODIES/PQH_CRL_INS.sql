--------------------------------------------------------
--  DDL for Package Body PQH_CRL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_CRL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_crl_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: pqh_criteria_rate_defn_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.criteria_rate_defn_id            := p_criteria_rate_defn_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  pqh_crl_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pqh_crl_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
