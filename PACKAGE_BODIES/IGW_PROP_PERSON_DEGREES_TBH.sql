--------------------------------------------------------
--  DDL for Package Body IGW_PROP_PERSON_DEGREES_TBH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGW_PROP_PERSON_DEGREES_TBH" as
 /* $Header: igwtppdb.pls 115.2 2002/03/28 19:15:10 pkm ship    $*/
...
x_return_status := fnd_api.g_ret_sts_success;
     ...
     if(p_mode = 'I') then
      ...
      update IGW_PROP_PERSON_DEGREES set
    	     	 PROPOSAL_ID  			=	P_PROPOSAL_ID
 		,PERSON_DEGREE_ID  		=	P_PERSON_DEGREE_ID
 		,SHOW_FLAG 			=	P_SHOW_FLAG
 		,DEGREE_SEQUENCE		=	P_DEGREE_SEQUENCE
    ...
    EXCEPTION
      when others then
         fnd_msg_pub.add_exc_msg(p_pkg_name 		=> 	'IGW_PROP_PERSON_DEGREES_TBH',
