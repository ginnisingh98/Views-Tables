--------------------------------------------------------
--  DDL for Package Body IGF_GR_COD_DTLS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_GR_COD_DTLS_PKG" AS
/* $Header: IGFGI22B.pls 120.0 2005/06/01 14:51:34 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_gr_cod_dtls%ROWTYPE;
  new_references igf_gr_cod_dtls%ROWTYPE;
  ...
  PROCEDURE set_column_values (
    ...
    x_high_cps_trans_num                IN     NUMBER,
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AW_AWD_GRCOD_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGF_GR_COD_DTLS_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    CLOSE c;
     ...
     -- Insert into the igf_gr_cod_history table also
    igf_gr_cod_history_pkg.insert_row (
      x_rowid                                 =>       l_rowid,
      x_rfms_orig_hist_id                     =>       l_seq,
      ...
      x_award_amt                             =>       new_references.award_amt,
      x_coa_amt                               =>       new_references.coa_amt,
      x_low_tution_fee                        =>       new_references.low_tution_fee,
      x_incarc_flag                           =>       new_references.incarc_flag,
      x_ver_status_code                       =>       new_references.ver_status_code,
      x_enrollment_date                       =>       new_references.enrollment_date,
      x_sec_efc_code                          =>       new_references.sec_efc_code,
      x_ytd_disb_amt                          =>       new_references.ytd_disb_amt,
      x_tot_elig_used                         =>       new_references.tot_elig_used,
      x_schd_pell_amt                         =>       new_references.schd_pell_amt,
      x_neg_pend_amt                          =>       new_references.neg_pend_amt,
      x_cps_verif_flag                        =>       new_references.cps_verif_flag,
      x_high_cps_trans_num                    =>       new_references.high_cps_trans_num,
      ...
      x_pell_status                           =>       new_references.pell_status,
      x_pell_status_date                      =>       new_references.pell_status_date,
      x_s_chg_ssn                             =>       new_references.s_chg_ssn,
      x_driver_lic_state                      =>       new_references.driver_lic_state,
      x_driver_lic_number                     =>       new_references.driver_lic_number,
      x_s_chg_date_of_birth                   =>       new_references.s_chg_date_of_birth,
      x_first_name                            =>       new_references.first_name,
      x_middle_name                           =>       new_references.middle_name,
      ...
      x_permt_addr_foreign_flag               =>       new_references.permt_addr_foreign_flag,
      x_addr_type_code                        =>       new_references.addr_type_code,
      x_permt_addr_line_1                     =>       new_references.permt_addr_line_1,
      x_permt_addr_line_2                     =>       new_references.permt_addr_line_2,
      x_permt_addr_line_3                     =>       new_references.permt_addr_line_3,
      x_permt_addr_city                       =>       new_references.permt_addr_city,
      x_permt_addr_state_code                 =>       new_references.permt_addr_state_code,
      x_permt_addr_post_code                  =>       new_references.permt_addr_post_code,
      x_permt_addr_county                     =>       new_references.permt_addr_county,
      x_permt_addr_country                    =>       new_references.permt_addr_country,
      x_phone_number_1                        =>       new_references.phone_number_1,
      x_phone_number_2                        =>       new_references.phone_number_2,
      x_phone_number_3                        =>       new_references.phone_number_3,
      x_email_address                         =>       new_references.email_address,
      x_citzn_status_code                     =>       new_references.citzn_status_code,
      x_mode                                  =>       'R'
  );
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND ((tlinfo.award_amt = x_award_amt) OR ((tlinfo.award_amt IS NULL) AND (X_award_amt IS NULL)))
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGF_GR_COD_DTLS_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
