--------------------------------------------------------
--  DDL for Package Body OKL_SPLIT_ASSET_COMP_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SPLIT_ASSET_COMP_PVT_W" as
  /* $Header: OKLESACB.pls 115.0 2002/12/25 00:29:03 avsingh noship $ */
  ...
  as
    ddp_asdv_tbl okl_split_asset_comp_pvt.advv_tbl_type;
    ddx_asdv_tbl okl_split_asset_comp_pvt.advv_tbl_type;
...
end okl_split_asset_comp_pvt_w;
