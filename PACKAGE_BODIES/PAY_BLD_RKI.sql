--------------------------------------------------------
--  DDL for Package Body PAY_BLD_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_BLD_RKI" as
...
begin
hr_utility.set_location('Entering: PAY_BLD_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: PAY_BLD_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end PAY_BLD_RKI;
