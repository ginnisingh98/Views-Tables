--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_ELIG_CVRD_DPNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_ELIG_CVRD_DPNT" as
/*
...
decode(l.pval005,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval005,'YES_NO',d(l.pval040),vn)) p5,
l.pval005 d5,
...
l.pval036 d36,
decode(l.pval037,cn,dn,vn,dh,d(l.pval037)) p37,
l.pval037 d37,
decode(l.pval038,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval038,'YES_NO',d(l.pval040),vn)) p38,
l.pval038 d38,
...
--
if upper(c.p42) = 'TRUE' then
L_MULTI_ROW_ACTN := true;
elsif upper(c.p42) = 'FALSE' then
L_MULTI_ROW_ACTN := false;
elsif c.p42 is not null then
...
hr_utility.set_message_token('VALUE',c.p42);
hr_utility.set_message_token('TABLE','HR_PUMP_BATCH_LINES');
hr_utility.raise_error;
end if;
--
...
(P_ELIG_CVRD_DPNT_USER_KEY => c.p43);
end if;
--
if c.d44=cn then
...
,P_CVG_STRT_DT => c.p3
,P_CVG_THRU_DT => c.p4
,P_CVG_PNDG_FLAG => c.p5
,P_PDP_ATTRIBUTE_CATEGORY => c.p6
,P_PDP_ATTRIBUTE1 => c.p7
,P_PDP_ATTRIBUTE2 => c.p8
,P_PDP_ATTRIBUTE3 => c.p9
,P_PDP_ATTRIBUTE4 => c.p10
,P_PDP_ATTRIBUTE5 => c.p11
,P_PDP_ATTRIBUTE6 => c.p12
,P_PDP_ATTRIBUTE7 => c.p13
,P_PDP_ATTRIBUTE8 => c.p14
,P_PDP_ATTRIBUTE9 => c.p15
,P_PDP_ATTRIBUTE10 => c.p16
,P_PDP_ATTRIBUTE11 => c.p17
,P_PDP_ATTRIBUTE12 => c.p18
,P_PDP_ATTRIBUTE13 => c.p19
,P_PDP_ATTRIBUTE14 => c.p20
,P_PDP_ATTRIBUTE15 => c.p21
,P_PDP_ATTRIBUTE16 => c.p22
,P_PDP_ATTRIBUTE17 => c.p23
,P_PDP_ATTRIBUTE18 => c.p24
,P_PDP_ATTRIBUTE19 => c.p25
,P_PDP_ATTRIBUTE20 => c.p26
,P_PDP_ATTRIBUTE21 => c.p27
,P_PDP_ATTRIBUTE22 => c.p28
,P_PDP_ATTRIBUTE23 => c.p29
,P_PDP_ATTRIBUTE24 => c.p30
,P_PDP_ATTRIBUTE25 => c.p31
,P_PDP_ATTRIBUTE26 => c.p32
,P_PDP_ATTRIBUTE27 => c.p33
,P_PDP_ATTRIBUTE28 => c.p34
,P_PDP_ATTRIBUTE29 => c.p35
,P_PDP_ATTRIBUTE30 => c.p36
...
,P_OVRDN_THRU_DT => c.p39
,P_EFFECTIVE_DATE => c.p40
,P_DATETRACK_MODE => c.p41
