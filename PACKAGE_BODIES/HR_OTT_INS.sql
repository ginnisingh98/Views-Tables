--------------------------------------------------------
--  DDL for Package Body HR_OTT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_OTT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_ott_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: hr_ki_option_types_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.option_type_id                   := p_option_type_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  hr_ott_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hr_ott_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
        ...
        ott.option_type_id = p_option_type_id
                          and ott.language = l.language_code);
  --
