--------------------------------------------------------
--  DDL for Package Body ONT_D1_DEFAULT_LINE_SET
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1_DEFAULT_LINE_SET" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D1_DEFAULT_LINE_SET
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1_DEFAULT_LINE_SET';
...
BEGIN
    ...
    l_return_value := ONT_SOLD_TO_ORG_Def_Util.g_cached_record.DEFAULT_LINE_SET;
    END IF;
  ...
  END IF;
    ...
    l_return_value := ONT_INV_ORG_Def_Util.g_cached_record.DEFAULT_LINE_SET;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
    ...
    l_return_value := ONT_SHIP_TO_ORG_Def_Util.g_cached_record.DEFAULT_LINE_SET;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
    ...
    l_return_value := ONT_ORDER_TYPE_Def_Util.g_cached_record.DEFAULT_LINE_SET_CODE;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
...
WHEN OTHERS THEN
         ...
         ( p_attribute_code => 'DEFAULT_LINE_SET'
         , p_rule_id => l_rule_id
         );
         RETURN NULL;
END Get_Default_Value;
END ONT_D1_DEFAULT_LINE_SET;
