--------------------------------------------------------
--  DDL for Package Body ONT_D1025_RECEIPT_METHOD_ID
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1025_RECEIPT_METHOD_ID" AS
...
--  FILENAME
--  
--      ONT_D1025_RECEIPT_METHOD_ID
--  
--  DESCRIPTION
--  
--      Body of package ONT_D1025_RECEIPT_METHOD_ID
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1025_RECEIPT_METHOD_ID';
...
END ONT_D1025_RECEIPT_METHOD_ID;
