--------------------------------------------------------
--  DDL for Package Body HR_SE_WORK_INCIDENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SE_WORK_INCIDENT_API" as
/* $Header: peincsei.pkb 120.0 2005/05/31 10:09:57 appldev noship $ */

-- Package Variables
--
g_package  varchar2(33) := 'hr_se_work_incident_api.';
--
-- ----------------------------------------------------------------------
...
procedure create_se_work_incident
  ...
  l_proc              varchar2(72) := g_package||'create_se_work_incident';
