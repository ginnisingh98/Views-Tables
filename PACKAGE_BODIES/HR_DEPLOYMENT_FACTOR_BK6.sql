--------------------------------------------------------
--  DDL for Package Body HR_DEPLOYMENT_FACTOR_BK6
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DEPLOYMENT_FACTOR_BK6" as
...
begin
hr_utility.set_location('Entering: HR_DEPLOYMENT_FACTOR_BK6.UPDATE_JOB_DPMT_FACTOR_A', 10);
hr_utility.set_location(' Leaving: HR_DEPLOYMENT_FACTOR_BK6.UPDATE_JOB_DPMT_FACTOR_A', 20);
end UPDATE_JOB_DPMT_FACTOR_A;
...
begin
hr_utility.set_location('Entering: HR_DEPLOYMENT_FACTOR_BK6.UPDATE_JOB_DPMT_FACTOR_B', 10);
hr_utility.set_location(' Leaving: HR_DEPLOYMENT_FACTOR_BK6.UPDATE_JOB_DPMT_FACTOR_B', 20);
end UPDATE_JOB_DPMT_FACTOR_B;
