--------------------------------------------------------
--  DDL for Package Body HR_DE_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DE_EMPLOYEE_API" as
/* $Header: peempdei.pkb 120.0 2005/05/31 08:00:02 appldev noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := 'hr_de_employee_api.';
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_de_employee >---------------------------|
-- ----------------------------------------------------------------------------
...
procedure create_de_employee
  ...
  --
  l_proc                 varchar2(72) := g_package||'create_de_employee';
...
begin
  ...
  ,p_national_identifier          => p_social_security_number
  ...
  ,p_per_information_category     => 'DE'
  ,p_per_information1             => p_professional_title
  ,p_per_information2             => p_hereditary_title
  ,p_per_information3             => p_last_name_at_birth
  ,p_per_information4             => p_hereditary_title_at_birth
  ,p_per_information5             => p_prefix_at_birth
  ,p_per_information13            => p_parental_status
