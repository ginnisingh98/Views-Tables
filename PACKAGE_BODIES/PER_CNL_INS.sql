--------------------------------------------------------
--  DDL for Package Body PER_CNL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CNL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_cnl_ins.';  -- Global package name
--
...
Begin
  ...
  --
  per_cnl_ins.g_location_id_i := p_location_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: per_ri_config_locations
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (per_cnl_ins.g_location_id_i is not null) Then
    --
    ...
    p_rec.location_id :=
      per_cnl_ins.g_location_id_i;
    per_cnl_ins.g_location_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.location_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
