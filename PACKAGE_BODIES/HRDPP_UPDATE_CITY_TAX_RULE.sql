--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_CITY_TAX_RULE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_CITY_TAX_RULE" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:12
 * Generated for API: PAY_CITY_TAX_RULE_API.UPDATE_CITY_TAX_RULE
 */
--
...
,P_EMP_CITY_TAX_RULE_USER_KEY in varchar2) is
...
,p_user_sequence
,p_link_value
,nd(P_ADDITIONAL_WA_RATE,I_ADDITIONAL_WA_RATE)
,P_FILING_STATUS_CODE
,nd(P_LIT_ADDITIONAL_TAX,I_LIT_ADDITIONAL_TAX)
,nd(P_LIT_OVERRIDE_AMOUNT,I_LIT_OVERRIDE_AMOUNT)
,nd(P_LIT_OVERRIDE_RATE,I_LIT_OVERRIDE_RATE)
...
decode(l.pval004,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval004,'US_LIT_FILING_STATUS',d(l.pval013),vn)) p4,
l.pval004 d4,
...
decode(l.pval009,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval009,'YES_NO',d(l.pval013),vn)) p9,
l.pval009 d9,
decode(l.pval010,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval010,'YES_NO',d(l.pval013),vn)) p10,
l.pval010 d10,
decode(l.pval011,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval011,'YES_NO',d(l.pval013),vn)) p11,
l.pval011 d11,
...
l.pval076 d76,
decode(l.pval077,cn,vn,l.pval077) p77
...
--
if c.p77 is null then
L_EMP_CITY_TAX_RULE_ID:=nn;
else
L_EMP_CITY_TAX_RULE_ID := 
hr_pump_get.get_emp_city_tax_rule_id
(P_EMP_CITY_TAX_RULE_USER_KEY => c.p77);
end if;
--
if c.p77 is null or
c.p13 is null then
...
hr_pump_get.GET_CITY_TAX_RULE_OVN
(P_EMP_CITY_TAX_RULE_USER_KEY => c.p77
,P_EFFECTIVE_DATE => c.p13);
end if;
--
...
,P_ADDITIONAL_WA_RATE => c.p3
,P_FILING_STATUS_CODE => c.p4
,P_LIT_ADDITIONAL_TAX => c.p5
,P_LIT_OVERRIDE_AMOUNT => c.p6
,P_LIT_OVERRIDE_RATE => c.p7
,P_WITHHOLDING_ALLOWANCES => c.p8
,P_LIT_EXEMPT => c.p9
,P_SD_EXEMPT => c.p10
,P_HT_EXEMPT => c.p11
,P_SCHOOL_DISTRICT_CODE => c.p12
,P_OBJECT_VERSION_NUMBER => L_OBJECT_VERSION_NUMBER
,P_EFFECTIVE_DATE => c.p13
,P_DATETRACK_MODE => c.p14
,P_ATTRIBUTE_CATEGORY => c.p15
,P_ATTRIBUTE1 => c.p16
,P_ATTRIBUTE2 => c.p17
,P_ATTRIBUTE3 => c.p18
,P_ATTRIBUTE4 => c.p19
...
,P_ATTRIBUTE29 => c.p44
,P_ATTRIBUTE30 => c.p45
,P_CTY_INFORMATION_CATEGORY => c.p46
,P_CTY_INFORMATION1 => c.p47
,P_CTY_INFORMATION2 => c.p48
,P_CTY_INFORMATION3 => c.p49
,P_CTY_INFORMATION4 => c.p50
,P_CTY_INFORMATION5 => c.p51
,P_CTY_INFORMATION6 => c.p52
,P_CTY_INFORMATION7 => c.p53
,P_CTY_INFORMATION8 => c.p54
,P_CTY_INFORMATION9 => c.p55
,P_CTY_INFORMATION10 => c.p56
,P_CTY_INFORMATION11 => c.p57
,P_CTY_INFORMATION12 => c.p58
,P_CTY_INFORMATION13 => c.p59
,P_CTY_INFORMATION14 => c.p60
,P_CTY_INFORMATION15 => c.p61
,P_CTY_INFORMATION16 => c.p62
,P_CTY_INFORMATION17 => c.p63
,P_CTY_INFORMATION18 => c.p64
,P_CTY_INFORMATION19 => c.p65
,P_CTY_INFORMATION20 => c.p66
,P_CTY_INFORMATION21 => c.p67
,P_CTY_INFORMATION22 => c.p68
,P_CTY_INFORMATION23 => c.p69
,P_CTY_INFORMATION24 => c.p70
,P_CTY_INFORMATION25 => c.p71
,P_CTY_INFORMATION26 => c.p72
,P_CTY_INFORMATION27 => c.p73
,P_CTY_INFORMATION28 => c.p74
,P_CTY_INFORMATION29 => c.p75
,P_CTY_INFORMATION30 => c.p76);
...
end hrdpp_UPDATE_CITY_TAX_RULE;
