--------------------------------------------------------
--  DDL for Package Body BEN_EST_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EST_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_est_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_elig_suppl_role_prte_f.created_by%TYPE;
  l_creation_date       ben_elig_suppl_role_prte_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_elig_suppl_role_prte_f
  --
...
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.elig_suppl_role_prte_id;
  close c1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  p_elig_suppl_role_prte_id  := l_rec.elig_suppl_role_prte_id;
