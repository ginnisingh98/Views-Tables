--------------------------------------------------------
--  DDL for Package Body BEN_TCV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_TCV_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_tcv_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_TTL_CVG_VOL_RT_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_TTL_CVG_VOL_RT_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
--
  ...
  Cursor C_Sel1 is
    ...
    where	ttl_cvg_vol_rt_id = p_ttl_cvg_vol_rt_id
...
Begin
  ...
  If (p_effective_date is null or
      p_ttl_cvg_vol_rt_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_ttl_cvg_vol_rt_id = g_old_rec.ttl_cvg_vol_rt_id and
...
--
  ...
  Cursor C_Sel1 Is
    ...
    where   t.ttl_cvg_vol_rt_id = p_base_key_value
    and     p_effective_date
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_ttl_cvg_vol_rt_f',
	 p_base_key_column	   => 'ttl_cvg_vol_rt_id',
	 p_base_key_value 	   => p_ttl_cvg_vol_rt_id,
	 p_parent_table_name1      => 'ben_vrbl_rt_prfl_f',
	 p_parent_key_column1      => 'vrbl_rt_prfl_id',
...
Begin
  ...
  l_rec.tcv_attribute_category           := p_tcv_attribute_category;
  l_rec.tcv_attribute1                   := p_tcv_attribute1;
  l_rec.tcv_attribute2                   := p_tcv_attribute2;
  l_rec.tcv_attribute3                   := p_tcv_attribute3;
  l_rec.tcv_attribute4                   := p_tcv_attribute4;
  l_rec.tcv_attribute5                   := p_tcv_attribute5;
  l_rec.tcv_attribute6                   := p_tcv_attribute6;
  l_rec.tcv_attribute7                   := p_tcv_attribute7;
  l_rec.tcv_attribute8                   := p_tcv_attribute8;
  l_rec.tcv_attribute9                   := p_tcv_attribute9;
  l_rec.tcv_attribute10                  := p_tcv_attribute10;
  l_rec.tcv_attribute11                  := p_tcv_attribute11;
  l_rec.tcv_attribute12                  := p_tcv_attribute12;
  l_rec.tcv_attribute13                  := p_tcv_attribute13;
  l_rec.tcv_attribute14                  := p_tcv_attribute14;
  l_rec.tcv_attribute15                  := p_tcv_attribute15;
  l_rec.tcv_attribute16                  := p_tcv_attribute16;
  l_rec.tcv_attribute17                  := p_tcv_attribute17;
  l_rec.tcv_attribute18                  := p_tcv_attribute18;
  l_rec.tcv_attribute19                  := p_tcv_attribute19;
  l_rec.tcv_attribute20                  := p_tcv_attribute20;
  l_rec.tcv_attribute21                  := p_tcv_attribute21;
  l_rec.tcv_attribute22                  := p_tcv_attribute22;
  l_rec.tcv_attribute23                  := p_tcv_attribute23;
  l_rec.tcv_attribute24                  := p_tcv_attribute24;
  l_rec.tcv_attribute25                  := p_tcv_attribute25;
  l_rec.tcv_attribute26                  := p_tcv_attribute26;
  l_rec.tcv_attribute27                  := p_tcv_attribute27;
  l_rec.tcv_attribute28                  := p_tcv_attribute28;
  l_rec.tcv_attribute29                  := p_tcv_attribute29;
  l_rec.tcv_attribute30                  := p_tcv_attribute30;
