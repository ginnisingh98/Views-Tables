--------------------------------------------------------
--  DDL for Package Body PAY_IE_HIST_ARCH_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_IE_HIST_ARCH_PKG" AS
/* $Header: pyiepupg.pkb 120.0.12010000.2 2009/07/28 14:45:42 vijranga noship $ */

g_package           CONSTANT VARCHAR2(30) := 'PAY_IE_HIST_ARCH_PKG.';
...
hr_utility.set_location('Entering ' || l_proc,10);
  ...
  pay_ie_hist_arch_pkg.get_parameters (p_payroll_action_id => pactid
...
begin
   ...
   hr_utility.set_location('stperson :' ||stperson ,20);
   hr_utility.set_location('endperson :' ||endperson ,20);
...
procedure archive_historic_data (p_assactid       in number,
    ...
    l_proc  VARCHAR2(50) := g_package || 'archive_historic_data';
...
begin
	...
	pay_ie_legislative_archive.get_pay_deduct_element_info(l_assignment_action_id);
