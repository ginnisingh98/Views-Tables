--------------------------------------------------------
--  DDL for Package Body IGF_AW_CORRESP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_AW_CORRESP_PKG" AS
/* $Header: IGFWI37B.pls 115.5 2002/11/28 14:42:20 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references igf_aw_corresp_all%ROWTYPE;
  new_references igf_aw_corresp_all%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AW_CRSP_FA_BASE_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igf_aw_corresp_s.NEXTVAL
    INTO      x_crsp_id
    FROM      dual;
    ...
    INSERT INTO igf_aw_corresp_all (
      crsp_id,
      base_id,
      flag,
      line_number,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND ((tlinfo.line_data = x_line_data) OR ((tlinfo.line_data IS NULL) AND (X_line_data IS NULL)))
       ) THEN
      NULL;
    ELSE
  ...
  */
  BEGIN
    ...
    DELETE FROM igf_aw_corresp_all
    WHERE rowid = x_rowid;
