--------------------------------------------------------
--  DDL for Package Body BEN_CMBN_AGE_LOS_RT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CMBN_AGE_LOS_RT_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_CMBN_AGE_LOS_RT_BK1.CREATE_CMBN_AGE_LOS_RT_A', 10);
hr_utility.set_location(' Leaving: BEN_CMBN_AGE_LOS_RT_BK1.CREATE_CMBN_AGE_LOS_RT_A', 20);
end CREATE_CMBN_AGE_LOS_RT_A;
...
begin
hr_utility.set_location('Entering: BEN_CMBN_AGE_LOS_RT_BK1.CREATE_CMBN_AGE_LOS_RT_B', 10);
hr_utility.set_location(' Leaving: BEN_CMBN_AGE_LOS_RT_BK1.CREATE_CMBN_AGE_LOS_RT_B', 20);
end CREATE_CMBN_AGE_LOS_RT_B;
