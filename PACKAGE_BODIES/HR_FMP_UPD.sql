--------------------------------------------------------
--  DDL for Package Body HR_FMP_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_FMP_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_fmp_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure update_dml
  (p_rec in out nocopy hr_fmp_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  -- Update the hr_form_properties Row
  --
  update hr_form_properties
    set
     form_property_id                = p_rec.form_property_id
    ,object_version_number           = p_rec.object_version_number
    ,application_id                  = p_rec.application_id
    ,form_id                         = p_rec.form_id
    ,form_template_id                = p_rec.form_template_id
    ,help_target                     = p_rec.help_target
    ...
    where form_property_id = p_rec.form_property_id;
  --
  --
  --
...
Begin
  ...
  begin
    --
    hr_fmp_rku.after_update
      (p_form_property_id
      => p_rec.form_property_id
      ...
      => p_rec.information30
      ,p_application_id_o
      => hr_fmp_shd.g_old_rec.application_id
      ,p_form_id_o
      => hr_fmp_shd.g_old_rec.form_id
      ,p_object_version_number_o
      => hr_tdg_shd.g_old_rec.object_version_number
      ,p_form_template_id_o
      => hr_fmp_shd.g_old_rec.form_template_id
      ,p_help_target_o
      => hr_fmp_shd.g_old_rec.help_target
      ,p_information_category_o
      => hr_fmp_shd.g_old_rec.information_category
      ,p_information1_o
      => hr_fmp_shd.g_old_rec.information1
      ,p_information2_o
      => hr_fmp_shd.g_old_rec.information2
      ,p_information3_o
      => hr_fmp_shd.g_old_rec.information3
      ,p_information4_o
      => hr_fmp_shd.g_old_rec.information4
      ,p_information5_o
      => hr_fmp_shd.g_old_rec.information5
      ,p_information6_o
      => hr_fmp_shd.g_old_rec.information6
      ,p_information7_o
      => hr_fmp_shd.g_old_rec.information7
      ,p_information8_o
      => hr_fmp_shd.g_old_rec.information8
      ,p_information9_o
      => hr_fmp_shd.g_old_rec.information9
      ,p_information10_o
      => hr_fmp_shd.g_old_rec.information10
      ,p_information11_o
      => hr_fmp_shd.g_old_rec.information11
      ,p_information12_o
      => hr_fmp_shd.g_old_rec.information12
      ,p_information13_o
      => hr_fmp_shd.g_old_rec.information13
      ,p_information14_o
      => hr_fmp_shd.g_old_rec.information14
      ,p_information15_o
      => hr_fmp_shd.g_old_rec.information15
      ,p_information16_o
      => hr_fmp_shd.g_old_rec.information16
      ,p_information17_o
      => hr_fmp_shd.g_old_rec.information17
      ,p_information18_o
      => hr_fmp_shd.g_old_rec.information18
      ,p_information19_o
      => hr_fmp_shd.g_old_rec.information19
      ,p_information20_o
      => hr_fmp_shd.g_old_rec.information20
      ,p_information21_o
      => hr_fmp_shd.g_old_rec.information21
      ,p_information22_o
      => hr_fmp_shd.g_old_rec.information22
      ,p_information23_o
      => hr_fmp_shd.g_old_rec.information23
      ,p_information24_o
      => hr_fmp_shd.g_old_rec.information24
      ,p_information25_o
      => hr_fmp_shd.g_old_rec.information25
      ,p_information26_o
      => hr_fmp_shd.g_old_rec.information26
      ,p_information27_o
      => hr_fmp_shd.g_old_rec.information27
      ,p_information28_o
      => hr_fmp_shd.g_old_rec.information28
      ,p_information29_o
      => hr_fmp_shd.g_old_rec.information29
      ,p_information30_o
      => hr_fmp_shd.g_old_rec.information30
      );
    --
  exception
    --
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'HR_FORM_PROPERTIES'
        ,p_hook_type   => 'AU');
      --
  end;
  --
...
Begin
  ...
  If (p_rec.form_id = hr_api.g_number) then
    ...
    hr_fmp_shd.g_old_rec.form_id;
  End If;
  If (p_rec.form_template_id = hr_api.g_number) then
    p_rec.form_template_id :=
    hr_fmp_shd.g_old_rec.form_template_id;
  End If;
  If (p_rec.help_target = hr_api.g_varchar2) then
    p_rec.help_target :=
    hr_fmp_shd.g_old_rec.help_target;
  End If;
...
Begin
  ...
  --
  convert_defs(p_rec);
  hr_fmp_bus.update_validate
     (p_rec
     );
  --
  -- Call the supporting pre-update operation
  --
  hr_fmp_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hr_fmp_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hr_fmp_upd.post_update
     (p_rec
     );
End upd;
--
...
Procedure upd
  ...
  ,p_form_template_id             in     number    default hr_api.g_number
