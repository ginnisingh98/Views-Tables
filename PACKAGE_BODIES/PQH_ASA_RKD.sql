--------------------------------------------------------
--  DDL for Package Body PQH_ASA_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_ASA_RKD" as
/* $Header: pqasarhi.pkb 115.3 2002/11/27 00:35:21 generated noship $ */
...
begin
hr_utility.set_location('Entering: PQH_ASA_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PQH_ASA_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PQH_ASA_RKD;
