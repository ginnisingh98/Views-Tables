--------------------------------------------------------
--  DDL for Package Body OKL_AM_SYSTEM_PARAMS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_SYSTEM_PARAMS_PVT_W" as
  /* $Header: OKLEASAB.pls 120.9.12010000.2 2008/11/14 05:48:25 kkorrapo ship $ */
  ...
  as
    ddp_sypv_rec okl_am_system_params_pvt.sypv_rec_type;
    ddx_sypv_rec okl_am_system_params_pvt.sypv_rec_type;
  ...
  begin
    ...
    okl_am_system_params_pvt.process_system_params(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_am_system_params_pvt_w;
