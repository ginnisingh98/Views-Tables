--------------------------------------------------------
--  DDL for Package Body BEN_EMPLOYEE_STATUS_RT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EMPLOYEE_STATUS_RT_BK2" as
/* $Header: beesrapi.pkb 120.0 2005/05/28 02:57:58 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_EMPLOYEE_STATUS_RT_BK2.UPDATE_EMPLOYEE_STATUS_RT_A', 10);
hr_utility.set_location(' Leaving: BEN_EMPLOYEE_STATUS_RT_BK2.UPDATE_EMPLOYEE_STATUS_RT_A', 20);
end UPDATE_EMPLOYEE_STATUS_RT_A;
...
begin
hr_utility.set_location('Entering: BEN_EMPLOYEE_STATUS_RT_BK2.UPDATE_EMPLOYEE_STATUS_RT_B', 10);
hr_utility.set_location(' Leaving: BEN_EMPLOYEE_STATUS_RT_BK2.UPDATE_EMPLOYEE_STATUS_RT_B', 20);
end UPDATE_EMPLOYEE_STATUS_RT_B;
