--------------------------------------------------------
--  DDL for Package Body OKL_SETUPPSTYPES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPPSTYPES_PUB_W" as
  /* $Header: OKLUSPSB.pls 120.1 2005/07/19 07:31:33 asawanka noship $ */
  ...
  as
    ddp_psyv_rec okl_setuppstypes_pub.psyv_rec_type;
    ddx_no_data_found boolean;
    ddx_psyv_rec okl_setuppstypes_pub.psyv_rec_type;
  ...
  begin
    ...
    okl_setuppstypes_pub.get_rec(ddp_psyv_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_psyv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_psyv_rec.id);
    p4_a1 := ddx_psyv_rec.from_date;
    p4_a2 := ddx_psyv_rec.to_date;
    p4_a3 := rosetta_g_miss_num_map(ddx_psyv_rec.object_version_number);
    p4_a4 := ddx_psyv_rec.accrual_yn;
    p4_a5 := rosetta_g_miss_num_map(ddx_psyv_rec.sty_id);
    p4_a6 := rosetta_g_miss_num_map(ddx_psyv_rec.pdt_id);
    p4_a7 := rosetta_g_miss_num_map(ddx_psyv_rec.created_by);
    p4_a8 := ddx_psyv_rec.creation_date;
    p4_a9 := ddx_psyv_rec.last_update_date;
    p4_a10 := rosetta_g_miss_num_map(ddx_psyv_rec.last_updated_by);
    p4_a11 := rosetta_g_miss_num_map(ddx_psyv_rec.last_update_login);
  end;
  ...
  as
    ddp_pdtv_rec okl_setuppstypes_pub.pdtv_rec_type;
    ddp_psyv_rec okl_setuppstypes_pub.psyv_rec_type;
    ddx_psyv_rec okl_setuppstypes_pub.psyv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppstypes_pub.insert_pstypes(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppstypes_pub.update_pstypes(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
