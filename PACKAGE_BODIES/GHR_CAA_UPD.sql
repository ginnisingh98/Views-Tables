--------------------------------------------------------
--  DDL for Package Body GHR_CAA_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_CAA_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ghr_caa_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the ghr_compl_agency_appeals Row
  --
  update ghr_compl_agency_appeals
    set
     compl_agency_appeal_id          = p_rec.compl_agency_appeal_id
    ...
    ,agency_recvd_appellant_brief    = p_rec.agency_recvd_appellant_brief
    ...
    where compl_agency_appeal_id = p_rec.compl_agency_appeal_id;
  --
  --
  --
...
Begin
  ...
  begin
    ...
    ghr_caa_rku.after_update
      ...
      ,p_complaint_id_o               => ghr_caa_shd.g_old_rec.complaint_id
      ,p_appeal_date_o                => ghr_caa_shd.g_old_rec.appeal_date
      ,p_reason_for_appeal_o          => ghr_caa_shd.g_old_rec.reason_for_appeal
      ,p_source_decision_date_o       => ghr_caa_shd.g_old_rec.source_decision_date
      ,p_docket_num_o                 => ghr_caa_shd.g_old_rec.docket_num
      ,p_agency_recvd_req_for_files_o => ghr_caa_shd.g_old_rec.agency_recvd_req_for_files
      ,p_files_due_o                  => ghr_caa_shd.g_old_rec.files_due
      ,p_files_forwd_o                => ghr_caa_shd.g_old_rec.files_forwd
      ,p_agency_brief_due_o           => ghr_caa_shd.g_old_rec.agency_brief_due
      ,p_agency_brief_forwd_o         => ghr_caa_shd.g_old_rec.agency_brief_forwd
      ,p_agency_recvd_appellant_bri_o => ghr_caa_shd.g_old_rec.agency_recvd_appellant_brief
      ,p_decision_date_o              => ghr_caa_shd.g_old_rec.decision_date
      ,p_dec_recvd_by_agency_o        => ghr_caa_shd.g_old_rec.dec_recvd_by_agency
      ,p_decision_o                   => ghr_caa_shd.g_old_rec.decision
      ,p_dec_forwd_to_org_o           => ghr_caa_shd.g_old_rec.dec_forwd_to_org
      ,p_agency_rfr_suspense_o        => ghr_caa_shd.g_old_rec.agency_rfr_suspense
      ,p_request_for_rfr_o            => ghr_caa_shd.g_old_rec.request_for_rfr
      ,p_rfr_docket_num_o             => ghr_caa_shd.g_old_rec.rfr_docket_num
      ,p_rfr_requested_by_o           => ghr_caa_shd.g_old_rec.rfr_requested_by
      ,p_agency_rfr_due_o             => ghr_caa_shd.g_old_rec.agency_rfr_due
      ,p_rfr_forwd_to_org_o           => ghr_caa_shd.g_old_rec.rfr_forwd_to_org
      ,p_org_forwd_rfr_to_agency_o    => ghr_caa_shd.g_old_rec.org_forwd_rfr_to_agency
      ,p_agency_forwd_rfr_ofo_o       => ghr_caa_shd.g_old_rec.agency_forwd_rfr_ofo
      ,p_rfr_decision_date_o          => ghr_caa_shd.g_old_rec.rfr_decision_date
      ,p_agency_recvd_rfr_dec_o       => ghr_caa_shd.g_old_rec.agency_recvd_rfr_dec
      ,p_rfr_decision_forwd_to_org_o  => ghr_caa_shd.g_old_rec.rfr_decision_forwd_to_org
      ,p_rfr_decision_o               => ghr_caa_shd.g_old_rec.rfr_decision
      ,p_object_version_number_o      => ghr_caa_shd.g_old_rec.object_version_number
      );
    --
  exception
    --
...
Begin
  ...
  --
  ghr_caa_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ghr_caa_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ghr_caa_upd.post_update
     (p_effective_date
     ,p_rec
     );
End upd;
