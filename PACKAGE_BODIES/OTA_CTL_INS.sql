--------------------------------------------------------
--  DDL for Package Body OTA_CTL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CTL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_ctl_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: ota_certifications_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.certification_id                 := p_certification_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  --
  --Modified for Bug#4775354
  ota_ctl_bus.insert_validate
     (p_effective_date
     ,p_rec
     ,p_certification_id
     );
  ...
  -- Insert the row
  --
  ota_ctl_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ota_ctl_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
