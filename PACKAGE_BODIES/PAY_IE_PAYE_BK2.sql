--------------------------------------------------------
--  DDL for Package Body PAY_IE_PAYE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_IE_PAYE_BK2" as
...
begin
hr_utility.set_location('Entering: PAY_IE_PAYE_BK2.UPDATE_IE_PAYE_DETAILS_A', 10);
hr_utility.set_location(' Leaving: PAY_IE_PAYE_BK2.UPDATE_IE_PAYE_DETAILS_A', 20);
end UPDATE_IE_PAYE_DETAILS_A;
...
begin
hr_utility.set_location('Entering: PAY_IE_PAYE_BK2.UPDATE_IE_PAYE_DETAILS_B', 10);
hr_utility.set_location(' Leaving: PAY_IE_PAYE_BK2.UPDATE_IE_PAYE_DETAILS_B', 20);
end UPDATE_IE_PAYE_DETAILS_B;
end PAY_IE_PAYE_BK2;
