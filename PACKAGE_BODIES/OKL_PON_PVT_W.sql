--------------------------------------------------------
--  DDL for Package Body OKL_PON_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PON_PVT_W" as
  /* $Header: OKLIPONB.pls 115.7 2002/12/24 04:08:20 sgorantl noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_pon_pvt.pon_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p2(t okl_pon_pvt.pon_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_pon_pvt.ponv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_DATE_TABLE
  ...
  procedure rosetta_table_copy_out_p5(t okl_pon_pvt.ponv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
  ...
  as
    ddp_ponv_rec okl_pon_pvt.ponv_rec_type;
    ddx_ponv_rec okl_pon_pvt.ponv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_pon_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ponv_tbl okl_pon_pvt.ponv_tbl_type;
    ddx_ponv_tbl okl_pon_pvt.ponv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pon_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pon_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pon_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pon_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
