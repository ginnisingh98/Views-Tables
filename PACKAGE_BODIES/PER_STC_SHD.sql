--------------------------------------------------------
--  DDL for Package Body PER_STC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_STC_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_stc_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PER_SOLUTION_TYPE_CMPTS_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PER_SOLUTION_TYPE_CMPTS_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  --
  If (p_component_name     is null and
  ...
  Else
    If (p_component_name
        = per_stc_shd.g_old_rec.component_name and
        p_solution_type_name
        = per_stc_shd.g_old_rec.solution_type_name and
        p_legislation_code
        = per_stc_shd.g_old_rec.legislation_code and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_stc_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_stc_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  l_rec.parent_component_name            := p_parent_component_name;
  l_rec.updateable                       := p_updateable;
  l_rec.extensible                       := p_extensible;
