--------------------------------------------------------
--  DDL for Package Body PAY_ETP_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ETP_RKU" as
...
begin
hr_utility.set_location('Entering: PAY_ETP_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PAY_ETP_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PAY_ETP_RKU;
