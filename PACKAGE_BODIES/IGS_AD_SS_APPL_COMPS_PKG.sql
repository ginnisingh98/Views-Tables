--------------------------------------------------------
--  DDL for Package Body IGS_AD_SS_APPL_COMPS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AD_SS_APPL_COMPS_PKG" AS
/* $Header: IGSAIH7B.pls 120.1 2005/09/08 14:43:27 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_ad_ss_appl_comps%ROWTYPE;
  new_references igs_ad_ss_appl_comps%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.comp_disp_name                    := NVL(x_comp_disp_name,old_references.comp_disp_name);
  ...
  */
  BEGIN
    ...
    IF (((old_references.admission_application_type = new_references.admission_application_type) AND
         (old_references.page_name = new_references.page_name)) OR
        ((new_references.admission_application_type IS NULL) OR
         (new_references.page_name IS NULL))) THEN
      NULL;
    ELSIF NOT igs_ad_ss_appl_pgs_pkg.get_pk_for_validation (
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_ad_ss_appl_comps
      WHERE   ((admission_application_type = x_admission_application_type) AND
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'igs_ad_ss_appl_comps_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    INSERT INTO igs_ad_ss_appl_comps (
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.comp_disp_name = x_comp_disp_name)
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'igs_ad_ss_appl_comps_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    UPDATE igs_ad_ss_appl_comps
      SET
        comp_disp_name                    = new_references.comp_disp_name,
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_ad_ss_appl_comps
    WHERE rowid = x_rowid;
