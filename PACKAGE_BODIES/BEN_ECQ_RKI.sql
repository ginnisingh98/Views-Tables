--------------------------------------------------------
--  DDL for Package Body BEN_ECQ_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ECQ_RKI" as
...
begin
hr_utility.set_location('Entering: ben_ecq_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_ecq_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_ecq_RKI;
