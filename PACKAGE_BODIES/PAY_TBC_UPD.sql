--------------------------------------------------------
--  DDL for Package Body PAY_TBC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_TBC_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_tbc_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure update_dml
  (p_rec in out nocopy pay_tbc_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Update the pay_balance_categories_f_tl Row
  --
...
Begin
  ...
  --
  pay_tbc_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  pay_tbc_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  --pay_tbc_upd.post_update(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
End upd;
  ...
  cursor csr_upd_langs is
    select tbc.language
     ...
     where tbc.balance_category_id = p_balance_category_id
       and p_language_code in (tbc.language
                              ,tbc.source_lang);
  --
