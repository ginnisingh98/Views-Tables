--------------------------------------------------------
--  DDL for Package Body BEN_PBC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PBC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pbc_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_pl_bnf_ctfn_prvdd_f.created_by%TYPE;
  l_creation_date       ben_pl_bnf_ctfn_prvdd_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_pl_bnf_ctfn_prvdd_f
  --
...
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.pl_bnf_ctfn_prvdd_id;
  close c1;
  --
  --
  --
...
Begin
  ...
  dt_api.validate_dt_mode
	(p_effective_date	   => p_effective_date,
	 ...
	 p_parent_key_value1       => p_rec.pl_bnf_id,
