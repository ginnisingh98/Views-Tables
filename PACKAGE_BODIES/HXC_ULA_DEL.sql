--------------------------------------------------------
--  DDL for Package Body HXC_ULA_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_ULA_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_ula_del.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Delete the hxc_layouts row.
  --
  delete from hxc_layouts
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hxc_ula_shd.g_rec_type) is
--
  l_proc  varchar2(72) ;
--
Begin
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hxc_ula_shd.g_rec_type) is
--
  l_proc  varchar2(72) ;
--
Begin
...
Begin
  ...
  --
  hxc_ula_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  hxc_ula_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hxc_ula_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hxc_ula_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
