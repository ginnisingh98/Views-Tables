--------------------------------------------------------
--  DDL for Package Body IRC_NOTES_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_NOTES_BE2" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  irc_notes_be2.update_note_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.notes.update_note';
