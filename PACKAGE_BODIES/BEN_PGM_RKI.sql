--------------------------------------------------------
--  DDL for Package Body BEN_PGM_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PGM_RKI" as
...
begin
hr_utility.set_location('Entering: ben_pgm_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_pgm_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_pgm_RKI;
