--------------------------------------------------------
--  DDL for Package Body HR_SA_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SA_PERSON_API" as
/* $Header: pepersai.pkb 120.3 2005/06/20 02:05:11 adevanat noship $ */

   -- Package Variables
   g_package   VARCHAR2(33) := 'hr_sa_person_api.';
