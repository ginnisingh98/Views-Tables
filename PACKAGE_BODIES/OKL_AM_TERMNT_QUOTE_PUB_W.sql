--------------------------------------------------------
--  DDL for Package Body OKL_AM_TERMNT_QUOTE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_TERMNT_QUOTE_PUB_W" as
  /* $Header: OKLUTNQB.pls 120.5 2007/11/02 21:07:28 rmunjulu ship $ */
  ...
  as
    ddp_term_rec okl_am_termnt_quote_pub.term_rec_type;
    ddx_term_rec okl_am_termnt_quote_pub.term_rec_type;
  ...
  begin
    ...
    okl_am_termnt_quote_pub.terminate_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_term_tbl okl_am_termnt_quote_pub.term_tbl_type;
    ddx_term_tbl okl_am_termnt_quote_pub.term_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_termnt_quote_pub.submit_for_approval(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_qld_tbl okl_am_termnt_quote_pub.qte_ln_dtl_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_termnt_quote_pub.quote_line_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tqlv_rec okl_am_termnt_quote_pub.tqlv_rec_type;
    ddx_tqlv_rec okl_am_termnt_quote_pub.tqlv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_termnt_quote_pub.create_quote_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tqlv_tbl okl_am_termnt_quote_pub.tqlv_tbl_type;
    ddx_tqlv_tbl okl_am_termnt_quote_pub.tqlv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_termnt_quote_pub.update_quote_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_termnt_quote_pub.delete_quote_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
