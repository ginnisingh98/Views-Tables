--------------------------------------------------------
--  DDL for Package Body BEN_EXT_CRIT_PRFL_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EXT_CRIT_PRFL_BK2" as
...
procedure UPDATE_EXT_CRIT_PRFL_A
...
begin
hr_utility.set_location('Entering: BEN_EXT_CRIT_PRFL_BK2.UPDATE_EXT_CRIT_PRFL_A', 10);
hr_utility.set_location(' Leaving: BEN_EXT_CRIT_PRFL_BK2.UPDATE_EXT_CRIT_PRFL_A', 20);
end UPDATE_EXT_CRIT_PRFL_A;
procedure UPDATE_EXT_CRIT_PRFL_B
(P_EXT_CRIT_PRFL_ID in NUMBER
,P_NAME in VARCHAR2
,P_BUSINESS_GROUP_ID in NUMBER
,P_LEGISLATION_CODE in VARCHAR2
...
begin
hr_utility.set_location('Entering: BEN_EXT_CRIT_PRFL_BK2.UPDATE_EXT_CRIT_PRFL_B', 10);
hr_utility.set_location(' Leaving: BEN_EXT_CRIT_PRFL_BK2.UPDATE_EXT_CRIT_PRFL_B', 20);
end UPDATE_EXT_CRIT_PRFL_B;
end BEN_EXT_CRIT_PRFL_BK2;
