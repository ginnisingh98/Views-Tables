--------------------------------------------------------
--  DDL for Package Body PSP_PEE_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_PEE_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  psp_pee_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_external_effort_line_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_external_effort_line_id  in  number) is
--
...
Begin
  ...
  --
  psp_pee_ins.g_external_effort_line_id_i := p_external_effort_line_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: psp_external_effort_lines
  --
  insert into psp_external_effort_lines
...
--
  Cursor C_Sel1 is select psp_external_effort_lines_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from psp_external_effort_lines
     where external_effort_line_id =
             psp_pee_ins.g_external_effort_line_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (psp_pee_ins.g_external_effort_line_id_i is not null) Then
    --
    ...
    p_rec.external_effort_line_id :=
      psp_pee_ins.g_external_effort_line_id_i;
    psp_pee_ins.g_external_effort_line_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.external_effort_line_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  psp_pee_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  psp_pee_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  psp_pee_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
...
Begin
  ...
  --
  p_external_effort_line_id := l_rec.external_effort_line_id;
