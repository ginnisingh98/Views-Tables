--------------------------------------------------------
--  DDL for Package Body IGF_AW_FUND_FEECLAS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_AW_FUND_FEECLAS_PKG" AS
/* $Header: IGFWI49B.pls 115.1 2002/11/28 14:43:04 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_aw_fund_feeclas_all%ROWTYPE;
  new_references igf_aw_fund_feeclas_all%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.fclass_id                         := x_fclass_id;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AP_FCLASS_FMAST_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igf_aw_fund_feeclas_s.NEXTVAL
    INTO      x_fclass_id
    FROM      dual;
    ...
    INSERT INTO igf_aw_fund_feeclas_all (
      fclass_id,
      fund_id,
      fee_class,
      org_id,
  ...
  */
  ...
  BEGIN
    ...
    UPDATE igf_aw_fund_feeclas_all
      SET
  ...
  */
  BEGIN
    ...
    DELETE FROM igf_aw_fund_feeclas_all
    WHERE rowid = x_rowid;
