--------------------------------------------------------
--  DDL for Package Body PAY_EEI_MIG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_EEI_MIG_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_eei_mig_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  Else
    If (p_element_type_extra_info_id
        = pay_eei_mig_shd.g_old_rec.element_type_extra_info_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into pay_eei_mig_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> pay_eei_mig_shd.g_old_rec.object_version_number) Then
