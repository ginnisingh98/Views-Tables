--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_CN_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_CN_PERSONAL_PAY_M" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:44
 * Generated for API: HR_CN_PERSONAL_PAY_METHOD_API.UPDATE_CN_PERSONAL_PAY_METHOD
 */
--
...
decode(l.pval030,cn,vn,l.pval030) p30,
decode(l.pval031,cn,vn,vn,vh,l.pval031) p31,
l.pval031 d31,
decode(l.pval032,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval032,'PAYEE_TYPE',d(l.pval001),l.pval040)) p32,
l.pval032 d32,
l.pval033 p33,
l.pval034 p34,
...
(P_PERSONAL_PAY_METHOD_USER_KEY => c.p37);
end if;
--
if c.p37 is null or
c.p1 is null then
...
,P_PAYEE_ORG => c.p38
,P_PAYEE_PERSON_USER_KEY => c.p39
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p40);
--
hr_data_pump.api_trc_on;
HR_CN_PERSONAL_PAY_METHOD_API.UPDATE_CN_PERSONAL_PAY_METHOD
...
end hrdpp_UPDATE_CN_PERSONAL_PAY_M;
