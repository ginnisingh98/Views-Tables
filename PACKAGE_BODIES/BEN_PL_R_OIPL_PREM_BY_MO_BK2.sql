--------------------------------------------------------
--  DDL for Package Body BEN_PL_R_OIPL_PREM_BY_MO_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PL_R_OIPL_PREM_BY_MO_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_PL_R_OIPL_PREM_BY_MO_BK2.UPDATE_PL_R_OIPL_PREM_BY_MO_A', 10);
hr_utility.set_location(' Leaving: BEN_PL_R_OIPL_PREM_BY_MO_BK2.UPDATE_PL_R_OIPL_PREM_BY_MO_A', 20);
end UPDATE_PL_R_OIPL_PREM_BY_MO_A;
...
begin
hr_utility.set_location('Entering: BEN_PL_R_OIPL_PREM_BY_MO_BK2.UPDATE_PL_R_OIPL_PREM_BY_MO_B', 10);
hr_utility.set_location(' Leaving: BEN_PL_R_OIPL_PREM_BY_MO_BK2.UPDATE_PL_R_OIPL_PREM_BY_MO_B', 20);
end UPDATE_PL_R_OIPL_PREM_BY_MO_B;
