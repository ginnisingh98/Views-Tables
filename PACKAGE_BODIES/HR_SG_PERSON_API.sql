--------------------------------------------------------
--  DDL for Package Body HR_SG_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SG_PERSON_API" as
/* $Header: hrsgwrpe.pkb 120.3 2007/10/26 00:05:52 jalin ship $ */

   -- Package Variables
   g_package   VARCHAR2(33) := 'hr_sg_person_api.';
   -- ----------------------------------------------------------------------------
   -- |--------------------------< update_sg_person >----------------------------|
   -- ----------------------------------------------------------------------------
   ...
   --
   l_proc                VARCHAR2(72) := g_package||'update_sg_person';
...
BEGIN
   ...
   ,p_per_information23            => p_payee_id_type /* 6393528 */
   ...
   ,p_party_id                     => p_party_id /* 6393528 */
   ,p_npw_number                   => p_npw_number /* 6393528 */
   --
