--------------------------------------------------------
--  DDL for Package Body PNRX_C_SPACE_UTIL_LOC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PNRX_C_SPACE_UTIL_LOC" AS
/* $Header: PNRXCLOB.pls 115.2 2002/11/15 20:29:44 stripath ship $ */

PROCEDURE pn_sp_ut_loc(
...
IS
  ...
  BEGIN
    ...
    pnrx_sp_util_by_loc.pn_space_util_loc(
