--------------------------------------------------------
--  DDL for Package Body OKL_ILT_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ILT_PVT_W" as
  /* $Header: OKLIILTB.pls 120.1 2005/07/13 09:27:51 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_ilt_pvt.ilt_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).sequence_number := rosetta_g_miss_num_map(a3(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_ilt_pvt.ilt_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a24 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).sequence_number);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_ilt_pvt.oklinvclinetypestltbltype, a0 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p5(t okl_ilt_pvt.oklinvclinetypestltbltype, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_in_p8(t out nocopy okl_ilt_pvt.iltv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_VARCHAR2_TABLE_100
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ity_id := rosetta_g_miss_num_map(a3(indx));
  ...
  procedure rosetta_table_copy_out_p8(t okl_ilt_pvt.iltv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_VARCHAR2_TABLE_100
    , a3 out nocopy JTF_NUMBER_TABLE
    ...
    a27 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).ity_id);
  ...
  as
    ddp_iltv_rec okl_ilt_pvt.iltv_rec_type;
    ddx_iltv_rec okl_ilt_pvt.iltv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_ilt_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_iltv_tbl okl_ilt_pvt.iltv_tbl_type;
    ddx_iltv_tbl okl_ilt_pvt.iltv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ilt_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ilt_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ilt_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ilt_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
