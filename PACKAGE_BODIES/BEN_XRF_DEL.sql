--------------------------------------------------------
--  DDL for Package Body BEN_XRF_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XRF_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xrf_del.';  -- Global package name
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_dml(p_rec in ben_xrf_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Delete the ben_ext_rcd_in_file row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in ben_xrf_shd.g_rec_type) is
--
...
--
  ...
  --
  delete_app_ownerships('EXT_RCD_IN_FILE_ID', p_rec.ext_rcd_in_file_id);
...
Procedure del
  ...
  p_rec	      in ben_xrf_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  ben_xrf_bus.delete_validate(p_rec
  ,p_effective_date);
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_xrf_rec
