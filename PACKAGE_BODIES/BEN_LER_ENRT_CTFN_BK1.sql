--------------------------------------------------------
--  DDL for Package Body BEN_LER_ENRT_CTFN_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LER_ENRT_CTFN_BK1" as
/* $Header: belncapi.pkb 120.0 2005/05/28 03:25:22 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_LER_ENRT_CTFN_BK1.CREATE_LER_ENRT_CTFN_A', 10);
hr_utility.set_location(' Leaving: BEN_LER_ENRT_CTFN_BK1.CREATE_LER_ENRT_CTFN_A', 20);
end CREATE_LER_ENRT_CTFN_A;
...
begin
hr_utility.set_location('Entering: BEN_LER_ENRT_CTFN_BK1.CREATE_LER_ENRT_CTFN_B', 10);
hr_utility.set_location(' Leaving: BEN_LER_ENRT_CTFN_BK1.CREATE_LER_ENRT_CTFN_B', 20);
end CREATE_LER_ENRT_CTFN_B;
