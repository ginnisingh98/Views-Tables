--------------------------------------------------------
--  DDL for Package Body HR_NO_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_NO_PERSON_API" AS
  /* $Header: pepernoi.pkb 120.0 2005/05/31 13:55:17 appldev noship $ */

   -- Package Variables
   g_package   VARCHAR2(33) := 'hr_no_person_api.';
