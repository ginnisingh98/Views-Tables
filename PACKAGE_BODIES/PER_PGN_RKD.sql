--------------------------------------------------------
--  DDL for Package Body PER_PGN_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PGN_RKD" as
...
begin
hr_utility.set_location('Entering: per_pgn_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: per_pgn_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end per_pgn_RKD;
