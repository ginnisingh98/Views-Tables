--------------------------------------------------------
--  DDL for Package Body PQP_EXR_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_EXR_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqp_exr_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Delete the pqp_exception_reports row.
  --
  delete from pqp_exception_reports
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pqp_exr_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in pqp_exr_shd.g_rec_type) is
--
...
Begin
  ...
  delete_app_ownerships('EXCEPTION_REPORT_ID', p_rec.exception_report_id);
    --
    pqp_exr_rkd.after_delete
...
Begin
  ...
  --
  pqp_exr_bus.delete_validate(p_rec);
  hr_multi_message.end_validation_set;
  --
  -- Call the supporting pre-delete operation
  --
  pqp_exr_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  pqp_exr_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  pqp_exr_del.post_delete(p_rec);
