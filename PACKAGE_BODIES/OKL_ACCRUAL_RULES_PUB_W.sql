--------------------------------------------------------
--  DDL for Package Body OKL_ACCRUAL_RULES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ACCRUAL_RULES_PUB_W" as
  /* $Header: OKLUAGNB.pls 120.1 2005/07/07 13:35:22 dkagrawa noship $ */
  ...
  as
    ddp_agnv_rec okl_accrual_rules_pub.agnv_rec_type;
    ddx_agnv_rec okl_accrual_rules_pub.agnv_rec_type;
  ...
  begin
    ...
    okl_accrual_rules_pub.insert_accrual_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_agnv_tbl okl_accrual_rules_pub.agnv_tbl_type;
    ddx_agnv_tbl okl_accrual_rules_pub.agnv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_accrual_rules_pub.lock_accrual_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_accrual_rules_pub.update_accrual_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_accrual_rules_pub.delete_accrual_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_accrual_rules_pub.validate_accrual_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
