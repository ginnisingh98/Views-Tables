--------------------------------------------------------
--  DDL for Package Body AME_AYL_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_AYL_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_ayl_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the ame_action_types_tl row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in ame_ayl_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in ame_ayl_shd.g_rec_type) is
--
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'AME_ACTION_TYPES_TL'
        ,p_hook_type   => 'AD');
      --
  end;
  --
...
Begin
  ...
  --
  ame_ayl_bus.delete_validate(p_rec);
  --
  ...
  --
  ame_ayl_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  ame_ayl_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  ame_ayl_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
...
Begin
  ...
  --
  --
  -- Having converted the arguments into the ame_ayl_rec
  -- plsql record structure we must call the corresponding entity
  -- business process
  --
  ame_ayl_del.del(l_rec);
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End del;
--
