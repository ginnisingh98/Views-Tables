--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_IN_PASSPORT_DETAI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_IN_PASSPORT_DETAI" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:01
 * Generated for API: hr_in_person_extra_info_api.create_in_passport_details
 */
--
...
,P_ISSUING_COUNTRY in varchar2) is
...
(P_ISSUING_COUNTRY => c.p31);
end if;
--
hr_data_pump.api_trc_on;
hr_in_person_extra_info_api.create_in_passport_details
...
,P_OBJECT_VERSION_NUMBER => c.p27);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p26,L_PERSON_EXTRA_INFO_ID);
--
...
end hrdpp_create_in_passport_detai;
