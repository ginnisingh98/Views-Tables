--------------------------------------------------------
--  DDL for Package Body HR_HU_CONTACT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_HU_CONTACT_API" as
/* $Header: peconhui.pkb 115.0 2004/03/18 01:38:58 vikgupta noship $ */
--
--   package variables
g_package  varchar2(33) := 'hr_hu_contact_api.';
--
...
-- Declare cursors and local variables
  --
  l_proc                 varchar2(72) := g_package||'create_hu_contact';
