--------------------------------------------------------
--  DDL for Package Body AHL_DI_DOC_INDEX_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AHL_DI_DOC_INDEX_PUB_W" as
  /* $Header: AHLDOCWB.pls 120.0.12010000.2 2010/01/28 13:09:20 pekambar ship $ */
  ...
  procedure rosetta_table_copy_in_p3(t out nocopy ahl_di_doc_index_pub.document_tbl, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).source_party_id := a1(indx);
          t(ddindx).source_party_number := a2(indx);
          t(ddindx).doc_type_code := a3(indx);
          t(ddindx).doc_type_desc := a4(indx);
          t(ddindx).doc_sub_type_code := a5(indx);
          t(ddindx).doc_sub_type_desc := a6(indx);
          t(ddindx).document_no := a7(indx);
          t(ddindx).operator_code := a8(indx);
          t(ddindx).operator_name := a9(indx);
          t(ddindx).product_type_code := a10(indx);
          t(ddindx).product_type_desc := a11(indx);
          t(ddindx).subscribe_avail_flag := a12(indx);
          t(ddindx).subscribe_to_flag := a13(indx);
          t(ddindx).document_title := a14(indx);
          t(ddindx).language := a15(indx);
          t(ddindx).source_lang := a16(indx);
          ...
          t(ddindx).process_flag := a35(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p3(t ahl_di_doc_index_pub.document_tbl, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a35 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := t(ddindx).source_party_id;
          a2(indx) := t(ddindx).source_party_number;
          a3(indx) := t(ddindx).doc_type_code;
          a4(indx) := t(ddindx).doc_type_desc;
          a5(indx) := t(ddindx).doc_sub_type_code;
          a6(indx) := t(ddindx).doc_sub_type_desc;
          a7(indx) := t(ddindx).document_no;
          a8(indx) := t(ddindx).operator_code;
          a9(indx) := t(ddindx).operator_name;
          a10(indx) := t(ddindx).product_type_code;
          a11(indx) := t(ddindx).product_type_desc;
          a12(indx) := t(ddindx).subscribe_avail_flag;
          a13(indx) := t(ddindx).subscribe_to_flag;
          a14(indx) := t(ddindx).document_title;
          a15(indx) := t(ddindx).language;
          a16(indx) := t(ddindx).source_lang;
          ...
          a35(indx) := t(ddindx).process_flag;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_in_p4(t out nocopy ahl_di_doc_index_pub.supplier_tbl, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_VARCHAR2_TABLE_100
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_VARCHAR2_TABLE_100
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        ddindx := 1;
        while true loop
          t(ddindx).supplier_document_id := a0(indx);
          t(ddindx).supplier_id := a1(indx);
          t(ddindx).supplier_number := a2(indx);
          t(ddindx).document_id := a3(indx);
          t(ddindx).preference_code := a4(indx);
          t(ddindx).preference_desc := a5(indx);
  ...
  procedure rosetta_table_copy_out_p4(t ahl_di_doc_index_pub.supplier_tbl, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_VARCHAR2_TABLE_100
  ...
  if t is null or t.count = 0 then
    ...
    a23 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        indx := 1;
        while true loop
          a0(indx) := t(ddindx).supplier_document_id;
          a1(indx) := t(ddindx).supplier_id;
          a2(indx) := t(ddindx).supplier_number;
          a3(indx) := t(ddindx).document_id;
          a4(indx) := t(ddindx).preference_code;
          a5(indx) := t(ddindx).preference_desc;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy ahl_di_doc_index_pub.recipient_tbl, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_VARCHAR2_TABLE_100
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        ddindx := 1;
        while true loop
          t(ddindx).recipient_document_id := a0(indx);
          t(ddindx).recipient_party_id := a1(indx);
          t(ddindx).recipient_party_number := a2(indx);
          t(ddindx).document_id := a3(indx);
  ...
  procedure rosetta_table_copy_out_p5(t ahl_di_doc_index_pub.recipient_tbl, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_VARCHAR2_TABLE_100
    , a3 out nocopy JTF_NUMBER_TABLE
  ...
  if t is null or t.count = 0 then
    ...
    a21 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        indx := 1;
        while true loop
          a0(indx) := t(ddindx).recipient_document_id;
          a1(indx) := t(ddindx).recipient_party_id;
          a2(indx) := t(ddindx).recipient_party_number;
          a3(indx) := t(ddindx).document_id;
  ...
  procedure create_document(p_api_version  NUMBER
    ...
    , p5_a35 in out nocopy JTF_VARCHAR2_TABLE_100
    ...
    , p6_a8 in out nocopy JTF_VARCHAR2_TABLE_200
    ...
    , p7_a6 in out nocopy JTF_VARCHAR2_TABLE_200
    , p7_a7 in out nocopy JTF_VARCHAR2_TABLE_200
    , p7_a8 in out nocopy JTF_VARCHAR2_TABLE_200
    , p7_a9 in out nocopy JTF_VARCHAR2_TABLE_200
  ...
  as
    ddp_x_document_tbl ahl_di_doc_index_pub.document_tbl;
    ddp_x_supplier_tbl ahl_di_doc_index_pub.supplier_tbl;
    ddp_x_recipient_tbl ahl_di_doc_index_pub.recipient_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ahl_di_doc_index_pub_w.rosetta_table_copy_in_p3(ddp_x_document_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    ahl_di_doc_index_pub_w.rosetta_table_copy_in_p4(ddp_x_supplier_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
    ...
    ahl_di_doc_index_pub_w.rosetta_table_copy_in_p5(ddp_x_recipient_tbl, p7_a0
      , p7_a1
      , p7_a2
      , p7_a3
      , p7_a4
    ...
    ahl_di_doc_index_pub.create_document(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validate_only,
      p_validation_level,
    ...
    ahl_di_doc_index_pub_w.rosetta_table_copy_out_p3(ddp_x_document_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    ahl_di_doc_index_pub_w.rosetta_table_copy_out_p4(ddp_x_supplier_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
    ...
    ahl_di_doc_index_pub_w.rosetta_table_copy_out_p5(ddp_x_recipient_tbl, p7_a0
      , p7_a1
      , p7_a2
      , p7_a3
      , p7_a4
  ...
  procedure modify_document(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , p_commit  VARCHAR2
    , p_validate_only  VARCHAR2
    , p_validation_level  NUMBER
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    ahl_di_doc_index_pub.modify_document(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validate_only,
      p_validation_level,
