--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_ORGANIZATION_STRU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_ORGANIZATION_STRU" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:23
 * Generated for API: PER_ORGANIZATION_STRUCTURE_API.CREATE_ORGANIZATION_STRUCTURE
 */
--
...
,P_OBJECT_VERSION_NUMBER => c.p29);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p28,L_ORGANIZATION_STRUCTURE_ID);
--
...
end hrdpp_CREATE_ORGANIZATION_STRU;
