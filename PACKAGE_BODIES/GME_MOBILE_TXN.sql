--------------------------------------------------------
--  DDL for Package Body GME_MOBILE_TXN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_MOBILE_TXN" AS
/*  $Header: GMEMOTXB.pls 120.29.12010000.4 2010/04/15 14:55:02 apmishra ship $     */
/*===========================================================================+
 ...
 /*+========================================================================+
  ...
  BEGIN
   ...
   inv_quantity_tree_pub.clear_quantity_cache;
    ...
    --
    IF (p_reservation_id IS NOT NULL AND
  ...
  BEGIN
   ...
   ELSIF l_release_type = GME_COMMON_PVT.g_mtl_autobystep_release THEN
     ...
     IF l_is_item_associated_to_step THEN
       IF l_batchstep_status <> 3 THEN
         FND_MESSAGE.SET_NAME('GME', 'GME_YIELD_STEP_COMPLETE');
         RAISE ITEM_NOT_VALID;
       END IF;
     ELSIF l_batch_status <> 3 THEN
       FND_MESSAGE.SET_NAME('GME', 'GME_YIELD_BATCH_COMPLETE');
       RAISE ITEM_NOT_VALID;
     END IF;
   END IF;
...
BEGIN
  ...
  OPEN get_details;
  FETCH get_details INTO l_item_no, l_batch_no, l_txn_id, l_user_id;
  CLOSE get_details;
