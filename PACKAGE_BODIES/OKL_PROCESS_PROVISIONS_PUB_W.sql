--------------------------------------------------------
--  DDL for Package Body OKL_PROCESS_PROVISIONS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PROCESS_PROVISIONS_PUB_W" as
  /* $Header: OKLUPRVB.pls 120.1 2005/07/18 10:31:28 asawanka noship $ */
  ...
  as
    ddp_pvnv_rec okl_process_provisions_pub.pvnv_rec_type;
    ddx_pvnv_rec okl_process_provisions_pub.pvnv_rec_type;
  ...
  begin
    ...
    okl_process_provisions_pub.create_provisions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pvnv_tbl okl_process_provisions_pub.pvnv_tbl_type;
    ddx_pvnv_tbl okl_process_provisions_pub.pvnv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_provisions_pub.update_provisions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_provisions_pub.delete_provisions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_process_provisions_pub_w;
