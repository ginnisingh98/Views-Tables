--------------------------------------------------------
--  DDL for Package Body BEN_ELIGIBLE_PERSON_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIGIBLE_PERSON_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_ELIGIBLE_PERSON_BK1.CREATE_ELIGIBLE_PERSON_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIGIBLE_PERSON_BK1.CREATE_ELIGIBLE_PERSON_A', 20);
end CREATE_ELIGIBLE_PERSON_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIGIBLE_PERSON_BK1.CREATE_ELIGIBLE_PERSON_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIGIBLE_PERSON_BK1.CREATE_ELIGIBLE_PERSON_B', 20);
end CREATE_ELIGIBLE_PERSON_B;
