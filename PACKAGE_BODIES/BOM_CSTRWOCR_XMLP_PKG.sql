--------------------------------------------------------
--  DDL for Package Body BOM_CSTRWOCR_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BOM_CSTRWOCR_XMLP_PKG" AS
/* $Header: CSTRWOCRB.pls 120.0 2007/12/24 10:23:48 dwkrishn noship $ */
  ...
  BEGIN
    ...
    ELSE
      ...
      END IF;
    END IF;
    IF (P_REPORT_TYPE = 1) AND (P_COST_CEILING IS NULL) THEN
      P_COST_CEILING := 0;
    END IF;
    RETURN (TRUE);
  END AFTERPFORM;
