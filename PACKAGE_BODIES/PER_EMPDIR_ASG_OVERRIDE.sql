--------------------------------------------------------
--  DDL for Package Body PER_EMPDIR_ASG_OVERRIDE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_EMPDIR_ASG_OVERRIDE" AS
...
BEGIN
    ...
    /* IF p_srcSystem = 'PER' THEN
      per_empdir_ss.asgTbl.discretionary_title(p_rec_locator) :=
            per_empdir_ss.asgTbl.ass_attribute12(p_rec_locator);
    END IF; */
   ...
   EXCEPTION WHEN OTHERS THEN
        ...
        retcode := '1';
        per_empdir_ss.write_log(1, 'Error in before_dml asg '||SQLCODE);
