--------------------------------------------------------
--  DDL for Package Body XLA_MPA_JLT_AC_ASSGNS_F_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."XLA_MPA_JLT_AC_ASSGNS_F_PVT" AS
/* $Header: xlathmac.pkb 120.0 2005/06/24 01:29:05 eklau noship $ */
...
C_DEFAULT_MODULE      CONSTANT VARCHAR2(240) := 'xla.plsql.XLA_MPA_JLT_AC_ASSGNS_F_PVT';
...
EXCEPTION
  ...
  WHEN OTHERS THEN
    xla_exceptions_pkg.raise_message
      (p_location   => 'XLA_MPA_JLT_AC_ASSGNS_F_PVT.trace');
END trace;
...
END XLA_MPA_JLT_AC_ASSGNS_F_PVT;
