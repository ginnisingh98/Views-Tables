--------------------------------------------------------
--  DDL for Package Body PQP_ATD_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_ATD_RKD" as
...
begin
hr_utility.set_location('Entering: PQP_ATD_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PQP_ATD_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PQP_ATD_RKD;
