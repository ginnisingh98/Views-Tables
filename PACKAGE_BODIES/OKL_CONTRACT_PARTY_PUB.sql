--------------------------------------------------------
--  DDL for Package Body OKL_CONTRACT_PARTY_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CONTRACT_PARTY_PUB" AS
/* $Header: OKLPCPCB.pls 115.5 2002/03/21 18:03:32 pkm ship       $ */
  G_APP_NAME			CONSTANT VARCHAR2(3)   :=  OKC_API.G_APP_NAME;
  G_PKG_NAME			CONSTANT VARCHAR2(200) := 'OKL_CONTRACT_PARTY_PUB';
-- Start of comments
--
...
END; -- Package Body OKL_CONTRACT_PARTY_PUB
