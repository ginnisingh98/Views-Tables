--------------------------------------------------------
--  DDL for Package Body BEN_CM_TYP_USG_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CM_TYP_USG_BK2" as
/* $Header: bectuapi.pkb 115.5 2002/12/16 17:35:24 generated ship $ */
...
begin
hr_utility.set_location('Entering: BEN_CM_TYP_USG_BK2.UPDATE_CM_TYP_USG_A', 10);
hr_utility.set_location(' Leaving: BEN_CM_TYP_USG_BK2.UPDATE_CM_TYP_USG_A', 20);
end UPDATE_CM_TYP_USG_A;
...
begin
hr_utility.set_location('Entering: BEN_CM_TYP_USG_BK2.UPDATE_CM_TYP_USG_B', 10);
hr_utility.set_location(' Leaving: BEN_CM_TYP_USG_BK2.UPDATE_CM_TYP_USG_B', 20);
end UPDATE_CM_TYP_USG_B;
