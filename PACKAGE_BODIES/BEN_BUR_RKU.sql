--------------------------------------------------------
--  DDL for Package Body BEN_BUR_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BUR_RKU" as
/* $Header: beburrhi.pkb 120.0.12010000.2 2008/08/05 14:14:03 generated ship $ */
...
begin
hr_utility.set_location('Entering: ben_bur_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_bur_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_bur_RKU;
