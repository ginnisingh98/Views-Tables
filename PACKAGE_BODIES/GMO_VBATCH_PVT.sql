--------------------------------------------------------
--  DDL for Package Body GMO_VBATCH_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GMO_VBATCH_PVT" AS
/* $Header: GMOVVBTB.pls 120.24.12010000.2 2008/11/13 17:19:07 srpuri ship $ */
...
BEGIN
	...
	IF (P_ENTITY_NAME = GMO_CONSTANTS_GRP.ENTITY_BATCH) THEN
		...
		IF (P_TASK = GMO_CONSTANTS_GRP.ACTION_TERMINATE OR P_TASK = GMO_CONSTANTS_GRP.ACTION_UNRELEASE) THEN
			open c_get_steps;
			loop
