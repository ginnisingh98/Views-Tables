--------------------------------------------------------
--  DDL for Package Body BEN_EOY_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EOY_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_eoy_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_ELIG_OTHR_PTIP_PRTE_PK') Then
...
Begin
  ...
  If (p_effective_date is null or
      p_elig_othr_ptip_prte_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_elig_othr_ptip_prte_id = g_old_rec.elig_othr_ptip_prte_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_elig_othr_ptip_prte_f',
	 p_base_key_column	   => 'elig_othr_ptip_prte_id',
	 p_base_key_value 	   => p_elig_othr_ptip_prte_id,
	 p_parent_table_name1      => 'ben_eligy_prfl_f',
	 p_parent_key_column1      => 'eligy_prfl_id',
...
Begin
  ...
  l_rec.eoy_attribute_category           := p_eoy_attribute_category;
  l_rec.eoy_attribute1                   := p_eoy_attribute1;
  l_rec.eoy_attribute2                   := p_eoy_attribute2;
  l_rec.eoy_attribute3                   := p_eoy_attribute3;
  l_rec.eoy_attribute4                   := p_eoy_attribute4;
  l_rec.eoy_attribute5                   := p_eoy_attribute5;
  l_rec.eoy_attribute6                   := p_eoy_attribute6;
  l_rec.eoy_attribute7                   := p_eoy_attribute7;
  l_rec.eoy_attribute8                   := p_eoy_attribute8;
  l_rec.eoy_attribute9                   := p_eoy_attribute9;
  l_rec.eoy_attribute10                  := p_eoy_attribute10;
  l_rec.eoy_attribute11                  := p_eoy_attribute11;
  l_rec.eoy_attribute12                  := p_eoy_attribute12;
  l_rec.eoy_attribute13                  := p_eoy_attribute13;
  l_rec.eoy_attribute14                  := p_eoy_attribute14;
  l_rec.eoy_attribute15                  := p_eoy_attribute15;
  l_rec.eoy_attribute16                  := p_eoy_attribute16;
  l_rec.eoy_attribute17                  := p_eoy_attribute17;
  l_rec.eoy_attribute18                  := p_eoy_attribute18;
  l_rec.eoy_attribute19                  := p_eoy_attribute19;
  l_rec.eoy_attribute20                  := p_eoy_attribute20;
  l_rec.eoy_attribute21                  := p_eoy_attribute21;
  l_rec.eoy_attribute22                  := p_eoy_attribute22;
  l_rec.eoy_attribute23                  := p_eoy_attribute23;
  l_rec.eoy_attribute24                  := p_eoy_attribute24;
  l_rec.eoy_attribute25                  := p_eoy_attribute25;
  l_rec.eoy_attribute26                  := p_eoy_attribute26;
  l_rec.eoy_attribute27                  := p_eoy_attribute27;
  l_rec.eoy_attribute28                  := p_eoy_attribute28;
  l_rec.eoy_attribute29                  := p_eoy_attribute29;
  l_rec.eoy_attribute30                  := p_eoy_attribute30;
