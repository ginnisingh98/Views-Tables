--------------------------------------------------------
--  DDL for Package Body PAY_GRR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_GRR_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_grr_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- 40.2 change b start.
  --
  If (p_constraint_name = 'PAY_GRL_RATE_TYPE_CHK') Then
    hr_utility.set_message(801, 'HR_7310_GRR_INVALID_RATE_TYPE');
...
Begin
  ...
  If (p_effective_date is null or
    ...
    l_fct_ret := false;
  Else
    If (p_grade_rule_id = g_old_rec.grade_rule_id and
...
Exception
  When HR_Api.Object_Locked then
    ...
    hr_utility.set_message_token('TABLE_NAME', 'pay_grade_rules_f');
    hr_utility.raise_error;
