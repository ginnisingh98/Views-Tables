--------------------------------------------------------
--  DDL for Package Body HR_ASSIGNMENT_BK5
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ASSIGNMENT_BK5" as
...
begin
hr_utility.set_location('Entering: HR_ASSIGNMENT_BK5.UPDATE_APL_ASG_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
hr_assignment_be5.UPDATE_APL_ASG_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_APL_ASG', 'AP');
hr_utility.set_location(' Leaving: HR_ASSIGNMENT_BK5.UPDATE_APL_ASG_A', 20);
...
l_legislation_code   varchar2(30);
begin
hr_utility.set_location('Entering: HR_ASSIGNMENT_BK5.UPDATE_APL_ASG_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_APL_ASG', 'BP');
hr_utility.set_location(' Leaving: HR_ASSIGNMENT_BK5.UPDATE_APL_ASG_B', 20);
end UPDATE_APL_ASG_B;
