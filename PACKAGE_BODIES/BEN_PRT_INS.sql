--------------------------------------------------------
--  DDL for Package Body BEN_PRT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PRT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_prt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_poe_rt_f.created_by%TYPE;
  l_creation_date       ben_poe_rt_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_poe_rt_f
  --
