--------------------------------------------------------
--  DDL for Package Body BEN_PERSON_CHANGE_CS_LER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PERSON_CHANGE_CS_LER_API" as
/* $Header: bepslapi.pkb 115.6 2004/01/25 00:24:46 hmani ship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_Person_Change_Cs_Ler_api.';
--
-- ----------------------------------------------------------------------------
...
procedure create_Person_Change_Cs_Ler
  ...
  --
  l_per_info_chg_cs_ler_id ben_per_info_chg_cs_ler_f.per_info_chg_cs_ler_id%TYPE;
  l_effective_start_date ben_per_info_chg_cs_ler_f.effective_start_date%TYPE;
  l_effective_end_date ben_per_info_chg_cs_ler_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_Person_Change_Cs_Ler';
  l_object_version_number ben_per_info_chg_cs_ler_f.object_version_number%TYPE;
  --
begin
  --
  ...
  --
  savepoint create_Person_Change_Cs_Ler;
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_Person_Change_Cs_Ler
    --
    ben_Person_Change_Cs_Ler_bk1.create_Person_Change_Cs_Ler_b
      (
       p_per_info_chg_cs_ler_rl         =>  p_per_info_chg_cs_ler_rl
      ,p_name                           =>  p_name
      ,p_old_val                        =>  p_old_val
      ,p_new_val                        =>  p_new_val
      ...
      ,p_psl_attribute_category         =>  p_psl_attribute_category
      ,p_psl_attribute1                 =>  p_psl_attribute1
      ,p_psl_attribute2                 =>  p_psl_attribute2
      ,p_psl_attribute3                 =>  p_psl_attribute3
      ,p_psl_attribute4                 =>  p_psl_attribute4
      ,p_psl_attribute5                 =>  p_psl_attribute5
      ,p_psl_attribute6                 =>  p_psl_attribute6
      ,p_psl_attribute7                 =>  p_psl_attribute7
      ,p_psl_attribute8                 =>  p_psl_attribute8
      ,p_psl_attribute9                 =>  p_psl_attribute9
      ,p_psl_attribute10                =>  p_psl_attribute10
      ,p_psl_attribute11                =>  p_psl_attribute11
      ,p_psl_attribute12                =>  p_psl_attribute12
      ,p_psl_attribute13                =>  p_psl_attribute13
      ,p_psl_attribute14                =>  p_psl_attribute14
      ,p_psl_attribute15                =>  p_psl_attribute15
      ,p_psl_attribute16                =>  p_psl_attribute16
      ,p_psl_attribute17                =>  p_psl_attribute17
      ,p_psl_attribute18                =>  p_psl_attribute18
      ,p_psl_attribute19                =>  p_psl_attribute19
      ,p_psl_attribute20                =>  p_psl_attribute20
      ,p_psl_attribute21                =>  p_psl_attribute21
      ,p_psl_attribute22                =>  p_psl_attribute22
      ,p_psl_attribute23                =>  p_psl_attribute23
      ,p_psl_attribute24                =>  p_psl_attribute24
      ,p_psl_attribute25                =>  p_psl_attribute25
      ,p_psl_attribute26                =>  p_psl_attribute26
      ,p_psl_attribute27                =>  p_psl_attribute27
      ,p_psl_attribute28                =>  p_psl_attribute28
      ,p_psl_attribute29                =>  p_psl_attribute29
      ,p_psl_attribute30                =>  p_psl_attribute30
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_Person_Change_Cs_Ler'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_Person_Change_Cs_Ler
    --
  end;
  --
  ben_psl_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_Person_Change_Cs_Ler
    --
    ben_Person_Change_Cs_Ler_bk1.create_Person_Change_Cs_Ler_a
      (
       p_per_info_chg_cs_ler_id         =>  l_per_info_chg_cs_ler_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_Person_Change_Cs_Ler
    --
  end;
  --
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_Person_Change_Cs_Ler;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
    --
    p_per_info_chg_cs_ler_id := null;
  ...
  when others then
    ...
    raise;
    --
end create_Person_Change_Cs_Ler;
-- ----------------------------------------------------------------------------
...
procedure update_Person_Change_Cs_Ler
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_Person_Change_Cs_Ler';
  l_object_version_number ben_per_info_chg_cs_ler_f.object_version_number%TYPE;
  l_effective_start_date ben_per_info_chg_cs_ler_f.effective_start_date%TYPE;
  l_effective_end_date ben_per_info_chg_cs_ler_f.effective_end_date%TYPE;
  --
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_Person_Change_Cs_Ler;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_Person_Change_Cs_Ler
    --
    ben_Person_Change_Cs_Ler_bk2.update_Person_Change_Cs_Ler_b
      (
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_Person_Change_Cs_Ler'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_Person_Change_Cs_Ler
    --
  end;
  --
  ben_psl_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_Person_Change_Cs_Ler
    --
    ben_Person_Change_Cs_Ler_bk2.update_Person_Change_Cs_Ler_a
      (
       p_per_info_chg_cs_ler_id         =>  p_per_info_chg_cs_ler_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_Person_Change_Cs_Ler
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO update_Person_Change_Cs_Ler;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
  ...
  when others then
    ...
    raise;
    --
end update_Person_Change_Cs_Ler;
-- ----------------------------------------------------------------------------
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint delete_Person_Change_Cs_Ler;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_Person_Change_Cs_Ler
    --
    ben_Person_Change_Cs_Ler_bk3.delete_Person_Change_Cs_Ler_b
      (
       p_per_info_chg_cs_ler_id         =>  p_per_info_chg_cs_ler_id
      ,p_object_version_number          =>  p_object_version_number
    ,p_effective_date                      => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_Person_Change_Cs_Ler'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_Person_Change_Cs_Ler
    --
  end;
  --
  ben_psl_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_Person_Change_Cs_Ler
    --
    ben_Person_Change_Cs_Ler_bk3.delete_Person_Change_Cs_Ler_a
      (
       p_per_info_chg_cs_ler_id         =>  p_per_info_chg_cs_ler_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_Person_Change_Cs_Ler
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO delete_Person_Change_Cs_Ler;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
  ...
  when others then
    ...
    raise;
    --
end delete_Person_Change_Cs_Ler;
--
-- ----------------------------------------------------------------------------
-- |-------------------------------< lck >------------------------------------|
-- ----------------------------------------------------------------------------
