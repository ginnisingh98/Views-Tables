--------------------------------------------------------
--  DDL for Package Body BEN_LER_CHG_PLAN_ENRT_RL_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LER_CHG_PLAN_ENRT_RL_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_LER_CHG_PLAN_ENRT_RL_BK2.UPDATE_LER_CHG_PLAN_ENRT_RL_A', 10);
hr_utility.set_location(' Leaving: BEN_LER_CHG_PLAN_ENRT_RL_BK2.UPDATE_LER_CHG_PLAN_ENRT_RL_A', 20);
end UPDATE_LER_CHG_PLAN_ENRT_RL_A;
...
begin
hr_utility.set_location('Entering: BEN_LER_CHG_PLAN_ENRT_RL_BK2.UPDATE_LER_CHG_PLAN_ENRT_RL_B', 10);
hr_utility.set_location(' Leaving: BEN_LER_CHG_PLAN_ENRT_RL_BK2.UPDATE_LER_CHG_PLAN_ENRT_RL_B', 20);
end UPDATE_LER_CHG_PLAN_ENRT_RL_B;
