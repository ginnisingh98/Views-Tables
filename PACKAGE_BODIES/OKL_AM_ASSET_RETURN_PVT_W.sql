--------------------------------------------------------
--  DDL for Package Body OKL_AM_ASSET_RETURN_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_ASSET_RETURN_PVT_W" as
  /* $Header: OKLEARRB.pls 120.4 2007/11/14 19:37:29 rmunjulu ship $ */
  ...
  as
    ddp_artv_rec okl_am_asset_return_pvt.artv_rec_type;
    ddx_artv_rec okl_am_asset_return_pvt.artv_rec_type;
  ...
  begin
    ...
    okl_am_asset_return_pvt.create_asset_return(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_asset_return_pvt.update_asset_return(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_artv_tbl okl_am_asset_return_pvt.artv_tbl_type;
    ddx_artv_tbl okl_am_asset_return_pvt.artv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
