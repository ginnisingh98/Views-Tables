--------------------------------------------------------
--  DDL for Package Body BEN_CWB_PL_DSGN_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CWB_PL_DSGN_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_CWB_PL_DSGN_BK1.CREATE_PLAN_OR_OPTION_A', 10);
hr_utility.set_location(' Leaving: BEN_CWB_PL_DSGN_BK1.CREATE_PLAN_OR_OPTION_A', 20);
end CREATE_PLAN_OR_OPTION_A;
...
begin
hr_utility.set_location('Entering: BEN_CWB_PL_DSGN_BK1.CREATE_PLAN_OR_OPTION_B', 10);
hr_utility.set_location(' Leaving: BEN_CWB_PL_DSGN_BK1.CREATE_PLAN_OR_OPTION_B', 20);
end CREATE_PLAN_OR_OPTION_B;
