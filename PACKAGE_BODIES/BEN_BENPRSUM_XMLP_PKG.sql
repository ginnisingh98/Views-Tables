--------------------------------------------------------
--  DDL for Package Body BEN_BENPRSUM_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENPRSUM_XMLP_PKG" AS
/* $Header: BENPRSUMB.pls 120.2 2007/12/10 08:37:35 vjaganat noship $ */
...
begin
  ...
  CP_PROTHER  := CP_PRTOTAL - CP_PRCURMOP - CP_PRRETROP - CP_PRCREDIT;
