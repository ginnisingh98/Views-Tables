--------------------------------------------------------
--  DDL for Package Body XLA_EVENTS_PUB_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."XLA_EVENTS_PUB_PKG" AS
-- $Header: xlaevevp.pkb 120.31 2008/01/14 07:24:34 pshukla ship $
/*===========================================================================+
...
RETURN INTEGER IS
BEGIN
   trace('@ xla_events_pub_pkg.create_event (fn)'             , 20);
...
BEGIN
   trace('@ xla_events_pub_pkg.get_event_info'                , 20);
...
RETURN VARCHAR2 IS
BEGIN
   trace('@ xla_events_pub_pkg.get_event_status'         , 20);
...
RETURN BOOLEAN IS
BEGIN
   trace('@ xla_events_pub_pkg.event_exists'                  , 20);
...
BEGIN
   trace('@ xla_events_pub_pkg.get_array_event_info'          , 20);
