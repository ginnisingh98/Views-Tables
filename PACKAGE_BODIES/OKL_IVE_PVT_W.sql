--------------------------------------------------------
--  DDL for Package Body OKL_IVE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_IVE_PVT_W" as
  /* $Header: OKLIIVEB.pls 120.1 2005/07/13 09:29:11 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_ive_pvt.ive_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_DATE_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).datetime_valid := rosetta_g_miss_date_in_map(a1(indx));
          t(ddindx).idx_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).value := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).object_version_number := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).datetime_invalid := rosetta_g_miss_date_in_map(a5(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_ive_pvt.ive_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a14 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := t(ddindx).datetime_valid;
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).idx_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).value);
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).object_version_number);
          a5(indx) := t(ddindx).datetime_invalid;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_ive_pvt.ivev_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).idx_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).value := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).datetime_valid := rosetta_g_miss_date_in_map(a4(indx));
          t(ddindx).datetime_invalid := rosetta_g_miss_date_in_map(a5(indx));
          t(ddindx).program_id := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).program_application_id := rosetta_g_miss_num_map(a7(indx));
          t(ddindx).request_id := rosetta_g_miss_num_map(a8(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_ive_pvt.ivev_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a14 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).idx_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).value);
          a4(indx) := t(ddindx).datetime_valid;
          a5(indx) := t(ddindx).datetime_invalid;
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).program_id);
          a7(indx) := rosetta_g_miss_num_map(t(ddindx).program_application_id);
          a8(indx) := rosetta_g_miss_num_map(t(ddindx).request_id);
  ...
  as
    ddp_ivev_rec okl_ive_pvt.ivev_rec_type;
    ddx_ivev_rec okl_ive_pvt.ivev_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_ive_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ivev_tbl okl_ive_pvt.ivev_tbl_type;
    ddx_ivev_tbl okl_ive_pvt.ivev_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ive_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ive_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ive_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ive_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
