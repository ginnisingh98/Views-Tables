--------------------------------------------------------
--  DDL for Package Body PER_MEA_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_MEA_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)    := '  per_mea_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure insert_dml
  ...
  l_created_by          per_medical_assessments.created_by%TYPE;
  l_creation_date       per_medical_assessments.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: per_medical_assessments
  --
  insert into per_medical_assessments
...
--
  Cursor C_Sel1 is
  select per_medical_assessments_s.nextval
  from   sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.medical_assessment_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  per_mea_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  per_mea_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  per_mea_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Begin
  ...
  --
  p_medical_assessment_id := l_rec.medical_assessment_id;
