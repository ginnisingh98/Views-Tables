--------------------------------------------------------
--  DDL for Package Body GME_REOPEN_BATCH_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_REOPEN_BATCH_PVT" AS
/*  $Header: GMEVROBB.pls 120.4.12010000.1 2008/07/25 10:31:36 appldev ship $    */
