--------------------------------------------------------
--  DDL for Package Body PAY_ACCRUAL_PLAN_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ACCRUAL_PLAN_BK1" as
/* $Header: pypapapi.pkb 115.0 2002/04/22 10:28:56 generated ship   $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 02/10/26 01:09:42 (YY/MM/DD HH:MM:SS)
...
begin
hr_utility.set_location('Entering: PAY_ACCRUAL_PLAN_BK1.CREATE_PAY_ACCRUAL_PLAN_A', 10);
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_PAY_ACCRUAL_PLAN', 'AP');
hr_utility.set_location(' Leaving: PAY_ACCRUAL_PLAN_BK1.CREATE_PAY_ACCRUAL_PLAN_A', 20);
end CREATE_PAY_ACCRUAL_PLAN_A;
...
l_legislation_code   varchar2(30);
begin
hr_utility.set_location('Entering: PAY_ACCRUAL_PLAN_BK1.CREATE_PAY_ACCRUAL_PLAN_B', 10);
if hr_api.call_leg_hooks then
l_legislation_code := hr_api.return_legislation_code(p_business_group_id => P_BUSINESS_GROUP_ID);
end if;
hr_utility.set_location(' Leaving: PAY_ACCRUAL_PLAN_BK1.CREATE_PAY_ACCRUAL_PLAN_B', 20);
end CREATE_PAY_ACCRUAL_PLAN_B;
