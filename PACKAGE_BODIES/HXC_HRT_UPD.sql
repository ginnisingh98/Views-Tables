--------------------------------------------------------
--  DDL for Package Body HXC_HRT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_HRT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_hrt_upd.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Update the hxc_retrieval_processes Row
  --
  update hxc_retrieval_processes
    set
...
Begin
  ...
  --
  hxc_hrt_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hxc_hrt_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hxc_hrt_upd.post_update
     (p_effective_date
     ,p_rec
     );
End upd;
