--------------------------------------------------------
--  DDL for Package Body GL_BUSINESS_EVENTS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GL_BUSINESS_EVENTS" AS
/* $Header: glubeevb.pls 120.1 2005/05/05 01:35:50 kvora noship $ */

--
-- PUBLIC FUNCTIONS
--

FUNCTION test(p_event_name in varchar2) return varchar2 IS
BEGIN
