--------------------------------------------------------
--  DDL for Package Body XLA_00206_AAD_S_000003_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."XLA_00206_AAD_S_000003_PKG" AS
--
/*======================================================================+
...
+=======================================================================+
| Package Name                                                          |
|     XLA_00206_AAD_S_000003_PKG                                        |
|                                                                       |
| DESCRIPTION                                                           |
|     Package generated From Product Accounting Definition              |
|      Name    : Loans Standard Accrual                                 |
|      Code    : LNS_STANDARD_ACCRUAL                                   |
|      Owner   : PRODUCT                                                |
|      Version :                                                        |
...
C_DEFAULT_MODULE      CONSTANT VARCHAR2(240) := 'xla.plsql.XLA_00206_AAD_S_000003_PKG';
...
EXCEPTION
       ...
       WHEN OTHERS THEN
          xla_exceptions_pkg.raise_message
             (p_location   => 'XLA_00206_AAD_S_000003_PKG.trace');
END trace;
...
WHEN OTHERS  THEN
   xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.ValidateLookupMeaning');
       --
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.GetMeaning');
END GetMeaning;
--
...
EXCEPTION
 ...
 WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.Description_1');
END Description_1;
...
EXCEPTION
 ...
 WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.Description_2');
END Description_2;
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.AcctDerRule_3');
END AcctDerRule_3;
--
...
l_event_type_code            := 'DIRECT_ALL';
l_line_definition_owner_code := 'S';
l_line_definition_code       := 'LNS_STD_ACCRUAL_DIRECT_LOAN';
--
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.AcctLineType_4');
END AcctLineType_4;
--
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.AcctLineType_5');
END AcctLineType_5;
--
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.AcctLineType_6');
END AcctLineType_6;
--
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.AcctLineType_7');
END AcctLineType_7;
--
...
C_EVENT_TYPE_CODE    CONSTANT  VARCHAR2(30)  := 'DIRECT_ALL';
...
EXCEPTION
  ...
  WHEN OTHERS THEN
      IF (C_LEVEL_EXCEPTION >= g_log_level) THEN
       ...
       END IF;
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.insert_sources_8');
...
BEGIN
IF g_log_enabled THEN
   l_log_module := C_DEFAULT_MODULE||'.EventClass_8';
END IF;
IF (C_LEVEL_PROCEDURE >= g_log_level) THEN
   trace
      (p_msg      => 'BEGIN of EventClass_8'
      ,p_level    => C_LEVEL_PROCEDURE
      ,p_module   => l_log_module);
END IF;
...
xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00206_AAD_S_000003_PKG.EventClass_8');
...
EXCEPTION
  ...
  WHEN OTHERS THEN
      IF (C_LEVEL_EXCEPTION >= g_log_level) THEN
       ...
       END IF;
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000003_PKG.insert_sources_9');
...
BEGIN
IF g_log_enabled THEN
   l_log_module := C_DEFAULT_MODULE||'.EventClass_9';
END IF;
IF (C_LEVEL_PROCEDURE >= g_log_level) THEN
   trace
      (p_msg      => 'BEGIN of EventClass_9'
      ,p_level    => C_LEVEL_PROCEDURE
      ,p_module   => l_log_module);
END IF;
...
xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00206_AAD_S_000003_PKG.EventClass_9');
...
WHEN OTHERS THEN
   xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00206_AAD_S_000003_PKG.CreateHeadersAndLines');
...
xla_ae_journal_entry_pkg.SetProductAcctDefinition
   (p_product_rule_code      => 'LNS_STANDARD_ACCRUAL'
   ,p_product_rule_type_code => 'S'
   ,p_product_rule_version   => ''
   ,p_product_rule_name      => 'Loans Standard Accrual'
   ,p_amb_context_code       => 'DEFAULT'
   );
...
WHEN OTHERS THEN
   ...
   END IF;
   xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00206_AAD_S_000003_PKG.CreateJournalEntries');
...
BEGIN
   ...
   END IF;
--
END XLA_00206_AAD_S_000003_PKG;
--
