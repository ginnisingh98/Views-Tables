--------------------------------------------------------
--  DDL for Package Body ONT_D2_INVOICING_RULE_ID
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D2_INVOICING_RULE_ID" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D2_INVOICING_RULE_ID
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D2_INVOICING_RULE_ID';
...
BEGIN
    ...
    l_return_value := ONT_AGREEMENT_Def_Util.g_cached_record.INVOICING_RULE_ID;
    END IF;
  ...
  END IF;
    ...
    l_return_value := ONT_LINE_TYPE_Def_Util.g_cached_record.INVOICING_RULE_ID;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
    ...
    l_return_value := ONT_ITEM_Def_Util.g_cached_record.INVOICING_RULE_ID;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
    ...
    l_return_value := ONT_HEADER_Def_Util.g_cached_record.INVOICING_RULE_ID;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
...
WHEN OTHERS THEN
         ...
         ( p_attribute_code => 'INVOICING_RULE_ID'
         , p_rule_id => l_rule_id
         );
         RETURN NULL;
END Get_Default_Value;
END ONT_D2_INVOICING_RULE_ID;
