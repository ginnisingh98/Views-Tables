--------------------------------------------------------
--  DDL for Package Body PSB_PSBRPPRM_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSB_PSBRPPRM_XMLP_PKG" AS
/* $Header: PSBRPPRMB.pls 120.0 2008/01/07 10:44:06 vijranga noship $ */
  ...
  BEGIN
    ...
    ELSE
      ...
      INTO CP_SET
      FROM
        PSB_PARAMETER_SETS_V
      WHERE PARAMETER_SET_ID = P_SET_ID;
      SELECT
        SET_OF_BOOKS_ID,
        BUDGET_GROUP_ID
      INTO SOB_ID,BGP_ID
    ...
    FND_MESSAGE.SET_NAME('PSB'
                        ,'PSB_NO_DATA_FOUND');
    CP_NLS_NO_DATA_EXISTS := SUBSTR(FND_MESSAGE.GET,7,13);
    FND_MESSAGE.SET_NAME('PSB'
                        ,'PSB_END_OF_REPORT');
    CP_NLS_END_OF_REPORT := SUBSTR(FND_MESSAGE.GET,7,13);
    RETURN (TRUE);
  EXCEPTION
