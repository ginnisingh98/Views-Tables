--------------------------------------------------------
--  DDL for Package Body PQH_PTE_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_PTE_RKD" as
...
begin
hr_utility.set_location('Entering: PQH_PTE_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PQH_PTE_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PQH_PTE_RKD;
