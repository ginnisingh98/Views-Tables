--------------------------------------------------------
--  DDL for Package Body OKL_CLG_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CLG_PVT_W" as
  /* $Header: OKLICLGB.pls 120.2 2006/11/22 13:57:13 cdubey noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_clg_pvt.clg_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ica_id := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).ibt_id := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).irm_id := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).iuv_id := rosetta_g_miss_num_map(a7(indx));
          ...
          t(ddindx).effective_date_from := rosetta_g_miss_date_in_map(a30(indx));
          t(ddindx).effective_date_to := rosetta_g_miss_date_in_map(a31(indx));
          t(ddindx).ipl_id := rosetta_g_miss_num_map(a32(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_clg_pvt.clg_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a33 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).ica_id);
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).ibt_id);
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).irm_id);
          a7(indx) := rosetta_g_miss_num_map(t(ddindx).iuv_id);
          ...
          a30(indx) := t(ddindx).effective_date_from;
          a31(indx) := t(ddindx).effective_date_to;
          a32(indx) := rosetta_g_miss_num_map(t(ddindx).ipl_id);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_clg_pvt.oklcntrlvlnggrpstltbltype, a0 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).private_label_logo_url := a6(indx);
  ...
  procedure rosetta_table_copy_out_p5(t okl_clg_pvt.oklcntrlvlnggrpstltbltype, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a11 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a6(indx) := t(ddindx).private_label_logo_url;
  ...
  procedure rosetta_table_copy_in_p8(t out nocopy okl_clg_pvt.clgv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_VARCHAR2_TABLE_100
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).sfwt_flag := a3(indx);
          t(ddindx).inf_id := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).ica_id := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).ibt_id := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).currency_code := a7(indx);
          t(ddindx).irm_id := rosetta_g_miss_num_map(a8(indx));
          t(ddindx).iuv_id := rosetta_g_miss_num_map(a9(indx));
          t(ddindx).name := a10(indx);
          t(ddindx).description := a11(indx);
          t(ddindx).private_label_logo_url := a12(indx);
          ...
          t(ddindx).effective_date_from := rosetta_g_miss_date_in_map(a34(indx));
          t(ddindx).effective_date_to := rosetta_g_miss_date_in_map(a35(indx));
          t(ddindx).ipl_id := rosetta_g_miss_num_map(a36(indx));
  ...
  procedure rosetta_table_copy_out_p8(t okl_clg_pvt.clgv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    ...
    a37 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a3(indx) := t(ddindx).sfwt_flag;
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).inf_id);
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).ica_id);
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).ibt_id);
          a7(indx) := t(ddindx).currency_code;
          a8(indx) := rosetta_g_miss_num_map(t(ddindx).irm_id);
          a9(indx) := rosetta_g_miss_num_map(t(ddindx).iuv_id);
          a10(indx) := t(ddindx).name;
          a11(indx) := t(ddindx).description;
          a12(indx) := t(ddindx).private_label_logo_url;
          ...
          a34(indx) := t(ddindx).effective_date_from;
          a35(indx) := t(ddindx).effective_date_to;
          a36(indx) := rosetta_g_miss_num_map(t(ddindx).ipl_id);
  ...
  as
    ddp_clgv_rec okl_clg_pvt.clgv_rec_type;
    ddx_clgv_rec okl_clg_pvt.clgv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_clg_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_clgv_tbl okl_clg_pvt.clgv_tbl_type;
    ddx_clgv_tbl okl_clg_pvt.clgv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_clg_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_clg_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_clg_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_clg_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
