--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_SUPER_CONTRIBUTIO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_SUPER_CONTRIBUTIO" as
/*
...
(P_ORIGINAL_ENTRY_USER_KEY => c.p39);
end if;
--
...
(P_COST_ALLOC_KEYFLEX_USER_KEY => c.p41);
end if;
--
...
(P_UPDATING_ACTION_USER_KEY => c.p42);
end if;
--
...
(P_TARGET_ENTRY_USER_KEY => c.p44);
end if;
--
hr_data_pump.api_trc_on;
HR_AU_SUPER_API.CREATE_SUPER_CONTRIBUTION
...
,P_ATTRIBUTE20 => c.p27
,P_PAY_VALUE => c.p28
,P_MEMBER_NUMBER => c.p29
,P_SG_AMOUNT => c.p30
,P_SG_PERCENT => c.p31
,P_NON_SG_AMOUNT => c.p32
,P_NON_SG_PERCENT => c.p33
...
--
iuk(p_batch_line_id,c.p36,L_ELEMENT_ENTRY_ID);
--
