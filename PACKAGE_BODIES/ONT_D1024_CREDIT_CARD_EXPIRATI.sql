--------------------------------------------------------
--  DDL for Package Body ONT_D1024_CREDIT_CARD_EXPIRATI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1024_CREDIT_CARD_EXPIRATI" AS
...
--  FILENAME
--  
--      ONT_D1024_CREDIT_CARD_EXPIRATI
--  
--  DESCRIPTION
--  
--      Body of package ONT_D1024_CREDIT_CARD_EXPIRATI
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1024_CREDIT_CARD_EXPIRATI';
...
END ONT_D1024_CREDIT_CARD_EXPIRATI;
