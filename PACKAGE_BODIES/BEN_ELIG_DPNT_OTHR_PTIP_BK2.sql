--------------------------------------------------------
--  DDL for Package Body BEN_ELIG_DPNT_OTHR_PTIP_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIG_DPNT_OTHR_PTIP_BK2" as
/* $Header: beetdapi.pkb 120.0 2005/05/28 03:01:11 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_ELIG_DPNT_OTHR_PTIP_BK2.UPDATE_ELIG_DPNT_OTHR_PTIP_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_DPNT_OTHR_PTIP_BK2.UPDATE_ELIG_DPNT_OTHR_PTIP_A', 20);
end UPDATE_ELIG_DPNT_OTHR_PTIP_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIG_DPNT_OTHR_PTIP_BK2.UPDATE_ELIG_DPNT_OTHR_PTIP_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_DPNT_OTHR_PTIP_BK2.UPDATE_ELIG_DPNT_OTHR_PTIP_B', 20);
end UPDATE_ELIG_DPNT_OTHR_PTIP_B;
