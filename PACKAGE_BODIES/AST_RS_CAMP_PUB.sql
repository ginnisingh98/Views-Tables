--------------------------------------------------------
--  DDL for Package Body AST_RS_CAMP_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AST_RS_CAMP_PUB" as
/* $Header: astprcab.pls 115.3 2002/02/05 17:26:39 pkm ship   $ */
-- Start of Comments
...
G_PKG_NAME CONSTANT VARCHAR2(30):= 'AST_rs_camp_PUB';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'astprcab.pls';

-- Start of Comments
-- ***************** Private Conversion Routines Values -> Ids **************
-- Purpose
--
-- This procedure takes a public rs_camp record as input. It may contain
-- values or ids. All values are then converted into ids and a
-- private rs_camprecord is returned for the private
-- API call.
--
-- Conversions:
--
...
--
-- End of Comments
PROCEDURE Convert_rs_camp_Values_To_Ids(
         P_rs_camp_Rec        IN   AST_rs_camp_PUB.rs_camp_Rec_Type,
         x_pvt_rs_camp_rec    OUT   AST_rs_camp_PVT.rs_camp_Rec_Type
)
IS
...
BEGIN
  -- Hint: Add logic to process value-id verification for rs_camp record.
...
/*
    x_pvt_rs_camp_rec.RS_CAMPAIGN_ID := P_rs_camp_Rec.RS_CAMPAIGN_ID;
    x_pvt_rs_camp_rec.RESOURCE_ID := P_rs_camp_Rec.RESOURCE_ID;
    x_pvt_rs_camp_rec.CAMPAIGN_ID := P_rs_camp_Rec.CAMPAIGN_ID;
    x_pvt_rs_camp_rec.START_DATE := P_rs_camp_Rec.START_DATE;
    x_pvt_rs_camp_rec.END_DATE := P_rs_camp_Rec.END_DATE;
    x_pvt_rs_camp_rec.STATUS := P_rs_camp_Rec.STATUS;
    x_pvt_rs_camp_rec.ENABLED_FLAG := P_rs_camp_Rec.ENABLED_FLAG;
    x_pvt_rs_camp_rec.CREATED_BY := P_rs_camp_Rec.CREATED_BY;
    x_pvt_rs_camp_rec.CREATION_DATE := P_rs_camp_Rec.CREATION_DATE;
    x_pvt_rs_camp_rec.LAST_UPDATED_BY := P_rs_camp_Rec.LAST_UPDATED_BY;
    x_pvt_rs_camp_rec.LAST_UPDATE_DATE := P_rs_camp_Rec.LAST_UPDATE_DATE;
    x_pvt_rs_camp_rec.LAST_UPDATE_LOGIN := P_rs_camp_Rec.LAST_UPDATE_LOGIN;
*/
...
END Convert_rs_camp_Values_To_Ids;
...
l_pvt_rs_camp_rec    AST_rs_camp_PVT.rs_camp_Rec_Type;
 BEGIN
      -- Standard Start of API savepoint
      SAVEPOINT CREATE_rs_camp_PUB;
      ...
      -- Debug Message
      JTF_PLSQL_API.Debug_Message(FND_MSG_PUB.G_MSG_LVL_DEBUG_LOW, 'AST', 'AS: Public API: Convert_rs_camp_Values_To_Ids');

      -- Convert the values to ids
      --
      Convert_rs_camp_Values_To_Ids (
            p_rs_camp_rec       =>  p_rs_camp_rec,
            x_pvt_rs_camp_rec   =>  l_pvt_rs_camp_rec
      );

    -- Calling Private package: Create_rs_camp
    -- Hint: Primary key needs to be returned
      AST_rs_camp_PVT.Create_rs_camp(
      P_Api_Version_Number         => 2.0,
      P_Init_Msg_List              => FND_API.G_FALSE,
      P_Commit                     => FND_API.G_FALSE,
      P_Validation_Level           => FND_API.G_VALID_LEVEL_FULL,
      P_rs_camp_Rec  =>  l_pvt_rs_camp_Rec ,
    -- Hint: Add detail tables as parameter lists if it's master-detail relationship.
      X_RS_CAMPAIGN_ID     => x_RS_CAMPAIGN_ID,
...
l_pvt_rs_camp_rec  AST_rs_camp_PVT.rs_camp_Rec_Type;
 BEGIN
    ...
    AST_rs_camp_PVT.Update_rs_camp(
    P_Api_Version_Number         => 2.0,
    P_Init_Msg_List              => FND_API.G_FALSE,
    P_Commit                     => p_commit,
    P_Validation_Level           => FND_API.G_VALID_LEVEL_FULL,
...
l_pvt_rs_camp_rec  AST_rs_camp_PVT.rs_camp_Rec_Type;
 BEGIN
    ...
    AST_rs_camp_PVT.Delete_rs_camp(
    P_Api_Version_Number         => 2.0,
    P_Init_Msg_List              => FND_API.G_FALSE,
    P_Commit                     => p_commit,
    P_Validation_Level           => FND_API.G_VALID_LEVEL_FULL,
...
l_api_version_number      CONSTANT NUMBER   := 2.0;
 BEGIN
      ...
      --
      -- Debug Message
      JTF_PLSQL_API.Debug_Message(FND_MSG_PUB.G_MSG_LVL_DEBUG_LOW, 'AST', 'Public API: - Calling PVT.Get_rs_camp');
    AST_rs_camp_PVT.Get_rs_camp(
    P_Api_Version_Number         => 2.0,
    P_Init_Msg_List              => FND_API.G_FALSE,
    p_validation_level           => FND_API.G_VALID_LEVEL_FULL,
    P_Identity_Salesforce_id     => p_identity_salesforce_id,
