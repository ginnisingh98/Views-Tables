--------------------------------------------------------
--  DDL for Package Body PV_ENTYATTMAP_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PV_ENTYATTMAP_PUB" as
/* $Header: pvrpeamb.pls 120.0 2005/05/27 15:31:23 appldev noship $ */
-- Start of Comments
...
G_PKG_NAME CONSTANT VARCHAR2(30):= 'PV_ENTYATTMAP_PUB';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'pvrpeamb.pls';
...
l_api_version_number      CONSTANT NUMBER   := 2.0;
 BEGIN
      ...
      SAVEPOINT CREATE_ENTYATTMAP_PUB;
      ...
      -- API body
      --
    -- Calling Private package: Create_ENTYATTMAP
      PV_entyattmap_PVT.Create_entyattmap(
...
l_api_version_number      CONSTANT NUMBER   := 2.0;
 BEGIN
      -- Standard Start of API savepoint
      SAVEPOINT UPDATE_ENTYATTMAP_PUB;
    ...
    PV_entyattmap_PVT.Update_entyattmap(
       P_Api_Version_Number         => 2.0,
       P_Init_Msg_List              => FND_API.G_FALSE,
       P_Commit                     => p_commit,
       P_Validation_Level           => P_Validation_Level,
...
l_api_version_number      CONSTANT NUMBER   := 2.0;
 BEGIN
      -- Standard Start of API savepoint
      SAVEPOINT DELETE_ENTYATTMAP_PUB;
