--------------------------------------------------------
--  DDL for Package Body BEN_POSTAL_ZIP_RATE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_POSTAL_ZIP_RATE_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_POSTAL_ZIP_RATE_BK1.CREATE_POSTAL_ZIP_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_POSTAL_ZIP_RATE_BK1.CREATE_POSTAL_ZIP_RATE_A', 20);
end CREATE_POSTAL_ZIP_RATE_A;
...
begin
hr_utility.set_location('Entering: BEN_POSTAL_ZIP_RATE_BK1.CREATE_POSTAL_ZIP_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_POSTAL_ZIP_RATE_BK1.CREATE_POSTAL_ZIP_RATE_B', 20);
end CREATE_POSTAL_ZIP_RATE_B;
