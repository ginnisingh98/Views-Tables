--------------------------------------------------------
--  DDL for Package Body PSP_ERA_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_ERA_RKD" as
...
begin
hr_utility.set_location('Entering: PSP_ERA_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PSP_ERA_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PSP_ERA_RKD;
