--------------------------------------------------------
--  DDL for Package Body HXC_DRU_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_DRU_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_dru_del.';  -- Global package name
...
Begin
  ...
  --
  -- Delete the hxc_data_app_rule_usages row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hxc_dru_shd.g_rec_type) is
--
  l_proc  varchar2(72);
--
Begin
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hxc_dru_shd.g_rec_type) is
--
  l_proc  varchar2(72);
--
Begin
...
Begin
  ...
  --
  hxc_dru_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  hxc_dru_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hxc_dru_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hxc_dru_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
