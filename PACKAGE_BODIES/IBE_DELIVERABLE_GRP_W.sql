--------------------------------------------------------
--  DDL for Package Body IBE_DELIVERABLE_GRP_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IBE_DELIVERABLE_GRP_W" as
  /* $Header: IBEGRDLB.pls 115.1 2002/12/18 07:08:11 schak ship $ */
  ...
  procedure rosetta_table_copy_in_p6(t out nocopy ibe_deliverable_grp.number_table, a0 JTF_NUMBER_TABLE) as
    ddindx binary_integer; indx binary_integer;
  begin
  if a0 is null then
    t := null;
  elsif a0.count = 0 then
    t := ibe_deliverable_grp.number_table();
  else
      if a0.count > 0 then
      t := ibe_deliverable_grp.number_table();
      t.extend(a0.count);
  ...
  procedure rosetta_table_copy_out_p6(t ibe_deliverable_grp.number_table, a0 out nocopy JTF_NUMBER_TABLE) as
    ddindx binary_integer; indx binary_integer;
  begin
  if t is null then
    a0 := null;
  ...
  procedure rosetta_table_copy_in_p7(t out nocopy ibe_deliverable_grp.varchar2_table_100, a0 JTF_VARCHAR2_TABLE_100) as
    ddindx binary_integer; indx binary_integer;
  begin
  if a0 is null then
    t := null;
  elsif a0.count = 0 then
    t := ibe_deliverable_grp.varchar2_table_100();
  else
      if a0.count > 0 then
      t := ibe_deliverable_grp.varchar2_table_100();
      t.extend(a0.count);
  ...
  procedure rosetta_table_copy_out_p7(t ibe_deliverable_grp.varchar2_table_100, a0 out nocopy JTF_VARCHAR2_TABLE_100) as
    ddindx binary_integer; indx binary_integer;
  begin
  if t is null then
    a0 := null;
  ...
  procedure rosetta_table_copy_in_p8(t out nocopy ibe_deliverable_grp.varchar2_table_300, a0 JTF_VARCHAR2_TABLE_300) as
    ddindx binary_integer; indx binary_integer;
  begin
  if a0 is null then
    t := null;
  elsif a0.count = 0 then
    t := ibe_deliverable_grp.varchar2_table_300();
  else
      if a0.count > 0 then
      t := ibe_deliverable_grp.varchar2_table_300();
      t.extend(a0.count);
  ...
  procedure rosetta_table_copy_out_p8(t ibe_deliverable_grp.varchar2_table_300, a0 out nocopy JTF_VARCHAR2_TABLE_300) as
    ddindx binary_integer; indx binary_integer;
  begin
  if t is null then
    a0 := null;
  ...
  procedure rosetta_table_copy_in_p9(t out nocopy ibe_deliverable_grp.varchar2_table_2000, a0 JTF_VARCHAR2_TABLE_2000) as
    ddindx binary_integer; indx binary_integer;
  begin
  if a0 is null then
    t := null;
  elsif a0.count = 0 then
    t := ibe_deliverable_grp.varchar2_table_2000();
  else
      if a0.count > 0 then
      t := ibe_deliverable_grp.varchar2_table_2000();
      t.extend(a0.count);
  ...
  procedure rosetta_table_copy_out_p9(t ibe_deliverable_grp.varchar2_table_2000, a0 out nocopy JTF_VARCHAR2_TABLE_2000) as
    ddindx binary_integer; indx binary_integer;
  begin
  if t is null then
    a0 := null;
  ...
  as
    ddx_dlv_id_tbl ibe_deliverable_grp.number_table;
    ddx_acc_name_tbl ibe_deliverable_grp.varchar2_table_100;
    ddx_dsp_name_tbl ibe_deliverable_grp.varchar2_table_300;
    ddx_item_type_tbl ibe_deliverable_grp.varchar2_table_100;
    ddx_appl_to_tbl ibe_deliverable_grp.varchar2_table_100;
    ddx_keyword_tbl ibe_deliverable_grp.varchar2_table_300;
    ddx_desc_tbl ibe_deliverable_grp.varchar2_table_2000;
    ddx_version_tbl ibe_deliverable_grp.number_table;
    ddx_file_name_tbl ibe_deliverable_grp.varchar2_table_300;
    ddx_file_id_tbl ibe_deliverable_grp.number_table;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ibe_deliverable_grp.list_deliverable(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    ibe_deliverable_grp_w.rosetta_table_copy_out_p6(ddx_dlv_id_tbl, x_dlv_id_tbl);

    ibe_deliverable_grp_w.rosetta_table_copy_out_p7(ddx_acc_name_tbl, x_acc_name_tbl);

    ibe_deliverable_grp_w.rosetta_table_copy_out_p8(ddx_dsp_name_tbl, x_dsp_name_tbl);

    ibe_deliverable_grp_w.rosetta_table_copy_out_p7(ddx_item_type_tbl, x_item_type_tbl);

    ibe_deliverable_grp_w.rosetta_table_copy_out_p7(ddx_appl_to_tbl, x_appl_to_tbl);

    ibe_deliverable_grp_w.rosetta_table_copy_out_p8(ddx_keyword_tbl, x_keyword_tbl);

    ibe_deliverable_grp_w.rosetta_table_copy_out_p9(ddx_desc_tbl, x_desc_tbl);

    ibe_deliverable_grp_w.rosetta_table_copy_out_p6(ddx_version_tbl, x_version_tbl);

    ibe_deliverable_grp_w.rosetta_table_copy_out_p8(ddx_file_name_tbl, x_file_name_tbl);

    ibe_deliverable_grp_w.rosetta_table_copy_out_p6(ddx_file_id_tbl, x_file_id_tbl);
  end;
  ...
  as
    ddp_deliverable_rec ibe_deliverable_grp.deliverable_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    ibe_deliverable_grp.save_deliverable(p_api_version,
      p_init_msg_list,
      p_commit,
      x_return_status,
      x_msg_count,
  ...
  as
    ddp_deliverable_tbl ibe_deliverable_grp.deliverable_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ibe_deliverable_grp_w.rosetta_table_copy_in_p1(ddp_deliverable_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
    ...
    ibe_deliverable_grp_w.rosetta_table_copy_out_p1(ddp_deliverable_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  as
    ddp_dlv_ath_rec ibe_deliverable_grp.dlv_ath_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  as
    ddp_dlv_ath_tbl ibe_deliverable_grp.dlv_ath_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ibe_deliverable_grp_w.rosetta_table_copy_in_p3(ddp_dlv_ath_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
    ...
    ibe_deliverable_grp_w.rosetta_table_copy_out_p3(ddp_dlv_ath_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  as
    ddp_dlv_id_ver_tbl ibe_deliverable_grp.dlv_id_ver_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ibe_deliverable_grp_w.rosetta_table_copy_in_p5(ddp_dlv_id_ver_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      );
    ...
    -- here's the delegated call to the old PL/SQL routine
    ibe_deliverable_grp.delete_deliverable(p_api_version,
      p_init_msg_list,
      p_commit,
      x_return_status,
      x_msg_count,
    ...
    ibe_deliverable_grp_w.rosetta_table_copy_out_p5(ddp_dlv_id_ver_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      );
