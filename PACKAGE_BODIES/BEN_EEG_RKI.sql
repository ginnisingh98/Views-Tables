--------------------------------------------------------
--  DDL for Package Body BEN_EEG_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EEG_RKI" as
/* $Header: beeegrhi.pkb 120.1 2006/02/28 01:33:56 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_eeg_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_eeg_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_eeg_RKI;
