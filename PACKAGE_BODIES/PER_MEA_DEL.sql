--------------------------------------------------------
--  DDL for Package Body PER_MEA_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_MEA_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)    := '  per_mea_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the per_medical_assessments row.
  --
  delete from per_medical_assessments
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in per_mea_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in per_mea_shd.g_rec_type) is
--
...
Begin
  ...
  --
  per_mea_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  per_mea_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  per_mea_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  per_mea_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Having converted the arguments into the per_mea_rec
  -- plsql record structure we must call the corresponding entity
  -- business process
  --
  per_mea_del.del(l_rec);
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End del;
--
