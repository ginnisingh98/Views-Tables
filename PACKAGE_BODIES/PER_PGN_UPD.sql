--------------------------------------------------------
--  DDL for Package Body PER_PGN_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PGN_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_pgn_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure update_dml
  (p_rec in out nocopy per_pgn_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Update the per_gen_hierarchy_nodes Row
  --
  update per_gen_hierarchy_nodes
    set
     hierarchy_node_id               = p_rec.hierarchy_node_id
    ,entity_id                       = p_rec.entity_id
    ,hierarchy_version_id            = p_rec.hierarchy_version_id
    ,seq                             = p_rec.seq
    ,parent_hierarchy_node_id        = p_rec.parent_hierarchy_node_id
    ...
    where hierarchy_node_id = p_rec.hierarchy_node_id;
  --
  --
  --
...
Begin
  ...
  begin
    --
    per_pgn_rku.after_update
      (p_effective_date              => p_effective_date
      ,p_hierarchy_node_id
      => p_rec.hierarchy_node_id
      ,p_entity_id
      => p_rec.entity_id
      ...
      => p_rec.parent_hierarchy_node_id
      ,p_request_id
      => p_rec.request_id
      ...
      => per_pgn_shd.g_old_rec.business_group_id
      ,p_entity_id_o
      => per_pgn_shd.g_old_rec.entity_id
      ,p_hierarchy_version_id_o
      => per_pgn_shd.g_old_rec.hierarchy_version_id
      ,p_node_type_o
      => per_pgn_shd.g_old_rec.node_type
      ,p_seq_o
      => per_pgn_shd.g_old_rec.seq
      ,p_parent_hierarchy_node_id_o
      => per_pgn_shd.g_old_rec.parent_hierarchy_node_id
      ,p_request_id_o
      => per_pgn_shd.g_old_rec.request_id
      ,p_program_application_id_o
      => per_pgn_shd.g_old_rec.program_application_id
      ,p_program_id_o
      => per_pgn_shd.g_old_rec.program_id
      ,p_program_update_date_o
      => per_pgn_shd.g_old_rec.program_update_date
      ,p_object_version_number_o
      => per_pgn_shd.g_old_rec.object_version_number
      ,p_attribute_category_o
      => per_pgn_shd.g_old_rec.attribute_category
      ,p_attribute1_o
      => per_pgn_shd.g_old_rec.attribute1
      ,p_attribute2_o
      => per_pgn_shd.g_old_rec.attribute2
      ,p_attribute3_o
      => per_pgn_shd.g_old_rec.attribute3
      ,p_attribute4_o
      => per_pgn_shd.g_old_rec.attribute4
      ,p_attribute5_o
      => per_pgn_shd.g_old_rec.attribute5
      ,p_attribute6_o
      => per_pgn_shd.g_old_rec.attribute6
      ,p_attribute7_o
      => per_pgn_shd.g_old_rec.attribute7
      ,p_attribute8_o
      => per_pgn_shd.g_old_rec.attribute8
      ,p_attribute9_o
      => per_pgn_shd.g_old_rec.attribute9
      ,p_attribute10_o
      => per_pgn_shd.g_old_rec.attribute10
      ,p_attribute11_o
      => per_pgn_shd.g_old_rec.attribute11
      ,p_attribute12_o
      => per_pgn_shd.g_old_rec.attribute12
      ,p_attribute13_o
      => per_pgn_shd.g_old_rec.attribute13
      ,p_attribute14_o
      => per_pgn_shd.g_old_rec.attribute14
      ,p_attribute15_o
      => per_pgn_shd.g_old_rec.attribute15
      ,p_attribute16_o
      => per_pgn_shd.g_old_rec.attribute16
      ,p_attribute17_o
      => per_pgn_shd.g_old_rec.attribute17
      ,p_attribute18_o
      => per_pgn_shd.g_old_rec.attribute18
      ,p_attribute19_o
      => per_pgn_shd.g_old_rec.attribute19
      ,p_attribute20_o
      => per_pgn_shd.g_old_rec.attribute20
      ,p_attribute21_o
      => per_pgn_shd.g_old_rec.attribute21
      ,p_attribute22_o
      => per_pgn_shd.g_old_rec.attribute22
      ,p_attribute23_o
      => per_pgn_shd.g_old_rec.attribute23
      ,p_attribute24_o
      => per_pgn_shd.g_old_rec.attribute24
      ,p_attribute25_o
      => per_pgn_shd.g_old_rec.attribute25
      ,p_attribute26_o
      => per_pgn_shd.g_old_rec.attribute26
      ,p_attribute27_o
      => per_pgn_shd.g_old_rec.attribute27
      ,p_attribute28_o
      => per_pgn_shd.g_old_rec.attribute28
      ,p_attribute29_o
      => per_pgn_shd.g_old_rec.attribute29
      ,p_attribute30_o
      => per_pgn_shd.g_old_rec.attribute30
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'PER_GEN_HIERARCHY_NODES'
        ,p_hook_type   => 'AU');
      --
  end;
  --
...
Begin
  ...
  If (p_rec.business_group_id = hr_api.g_number) then
    ...
    per_pgn_shd.g_old_rec.business_group_id;
  End If;
  If (p_rec.entity_id = hr_api.g_varchar2) then
    p_rec.entity_id :=
    per_pgn_shd.g_old_rec.entity_id;
  End If;
  If (p_rec.hierarchy_version_id = hr_api.g_number) then
    p_rec.hierarchy_version_id :=
    per_pgn_shd.g_old_rec.hierarchy_version_id;
  End If;
  If (p_rec.node_type = hr_api.g_varchar2) then
    p_rec.node_type :=
    per_pgn_shd.g_old_rec.node_type;
  End If;
  If (p_rec.seq = hr_api.g_number) then
    ...
    per_pgn_shd.g_old_rec.seq;
  End If;
  If (p_rec.parent_hierarchy_node_id = hr_api.g_number) then
    p_rec.parent_hierarchy_node_id :=
    per_pgn_shd.g_old_rec.parent_hierarchy_node_id;
  End If;
...
Begin
  ...
  --
  per_pgn_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  per_pgn_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  per_pgn_upd.post_update
     (p_effective_date
     ,p_rec
     );
End upd;
