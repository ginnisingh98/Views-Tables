--------------------------------------------------------
--  DDL for Package Body BEN_PCU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PCU_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pcu_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.per_cm_usg_id       = p_rec.per_cm_usg_id
    and    t.effective_start_date =
             ben_pcu_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_per_cm_usg_f.created_by%TYPE;
  l_creation_date       ben_per_cm_usg_f.creation_date%TYPE;
  l_last_update_date   	ben_per_cm_usg_f.last_update_date%TYPE;
  l_last_updated_by     ben_per_cm_usg_f.last_updated_by%TYPE;
  l_last_update_login   ben_per_cm_usg_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_per_cm_usg_f
  --
...
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.per_cm_usg_id;
  close c1;
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  dt_api.validate_dt_mode
	(p_effective_date	   => p_effective_date,
	 ...
	 p_parent_key_value1       => p_rec.cm_typ_usg_id,
	 p_parent_table_name2      => 'ben_per_cm_f',
	 p_parent_key_column2      => 'per_cm_id',
	 p_parent_key_value2       => p_rec.per_cm_id,
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_pcu_rec
