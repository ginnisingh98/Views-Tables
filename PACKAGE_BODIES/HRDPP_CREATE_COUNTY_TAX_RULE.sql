--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_COUNTY_TAX_RULE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_COUNTY_TAX_RULE" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:21
 * Generated for API: PAY_COUNTY_TAX_RULE_API.CREATE_COUNTY_TAX_RULE
 */
--
...
,P_CNT_INFORMATION30 in varchar2 default null) is
...
decode(l.pval008,cn,vn,
 hr_pump_get.gl(l.pval008,'US_LIT_FILING_STATUS',d(l.pval018),vn)) p8,
decode(l.pval009,cn,nn,n(l.pval009)) p9,
decode(l.pval010,cn,nn,n(l.pval010)) p10,
decode(l.pval011,cn,nn,n(l.pval011)) p11,
decode(l.pval012,cn,nn,n(l.pval012)) p12,
decode(l.pval013,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval013,'YES_NO',d(l.pval018),vn)) p13,
l.pval013 d13,
decode(l.pval014,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval014,'YES_NO',d(l.pval018),vn)) p14,
l.pval014 d14,
decode(l.pval015,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval015,'YES_NO',d(l.pval018),vn)) p15,
l.pval015 d15,
decode(l.pval016,cn,vn,vn,vn,l.pval016) p16,
l.pval016 d16,
l.pval017 p17,
decode(l.pval018,cn,dn,d(l.pval018)) p18,
...
,P_STATE_CODE => c.p5
,P_COUNTY_CODE => c.p6
,P_ADDITIONAL_WA_RATE => c.p7
,P_FILING_STATUS_CODE => c.p8
,P_LIT_ADDITIONAL_TAX => c.p9
,P_LIT_OVERRIDE_AMOUNT => c.p10
,P_LIT_OVERRIDE_RATE => c.p11
,P_WITHHOLDING_ALLOWANCES => c.p12
,P_LIT_EXEMPT => c.p13
,P_SD_EXEMPT => c.p14
,P_HT_EXEMPT => c.p15
,P_SCHOOL_DISTRICT_CODE => c.p16
,P_OBJECT_VERSION_NUMBER => c.p17
,P_EFFECTIVE_DATE => c.p18
...
,P_ATTRIBUTE29 => c.p48
,P_ATTRIBUTE30 => c.p49
,P_CNT_INFORMATION_CATEGORY => c.p50
,P_CNT_INFORMATION1 => c.p51
,P_CNT_INFORMATION2 => c.p52
,P_CNT_INFORMATION3 => c.p53
,P_CNT_INFORMATION4 => c.p54
,P_CNT_INFORMATION5 => c.p55
,P_CNT_INFORMATION6 => c.p56
,P_CNT_INFORMATION7 => c.p57
,P_CNT_INFORMATION8 => c.p58
,P_CNT_INFORMATION9 => c.p59
,P_CNT_INFORMATION10 => c.p60
,P_CNT_INFORMATION11 => c.p61
,P_CNT_INFORMATION12 => c.p62
,P_CNT_INFORMATION13 => c.p63
,P_CNT_INFORMATION14 => c.p64
,P_CNT_INFORMATION15 => c.p65
,P_CNT_INFORMATION16 => c.p66
,P_CNT_INFORMATION17 => c.p67
,P_CNT_INFORMATION18 => c.p68
,P_CNT_INFORMATION19 => c.p69
,P_CNT_INFORMATION20 => c.p70
,P_CNT_INFORMATION21 => c.p71
,P_CNT_INFORMATION22 => c.p72
,P_CNT_INFORMATION23 => c.p73
,P_CNT_INFORMATION24 => c.p74
,P_CNT_INFORMATION25 => c.p75
,P_CNT_INFORMATION26 => c.p76
,P_CNT_INFORMATION27 => c.p77
,P_CNT_INFORMATION28 => c.p78
,P_CNT_INFORMATION29 => c.p79
,P_CNT_INFORMATION30 => c.p80);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p1,L_EMP_COUNTY_TAX_RULE_ID);
--
...
end hrdpp_CREATE_COUNTY_TAX_RULE;
