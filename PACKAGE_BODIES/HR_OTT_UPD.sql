--------------------------------------------------------
--  DDL for Package Body HR_OTT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_OTT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_ott_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the hr_ki_option_types_tl Row
  --
...
Begin
  ...
  --
  If (p_rec.option_name = hr_api.g_varchar2) then
    p_rec.option_name :=
    hr_ott_shd.g_old_rec.option_name;
  End If;
