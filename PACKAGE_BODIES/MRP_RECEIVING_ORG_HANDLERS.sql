--------------------------------------------------------
--  DDL for Package Body MRP_RECEIVING_ORG_HANDLERS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."MRP_RECEIVING_ORG_HANDLERS" AS
/* $Header: MRPHRCOB.pls 115.2 99/07/16 12:22:44 porting ship $ */

--  Global constant holding the package name

G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'MRP_Receiving_Org_Handlers';
...
BEGIN
    ...
    -- First delete all the shipping orgs that are associated
    -- with this receiving org

    OPEN cur_Shipping_Org;

    WHILE TRUE LOOP
        FETCH cur_Shipping_Org
        INTO  l_sr_source_id;

        EXIT WHEN cur_Shipping_Org%NOTFOUND;
...
BEGIN
    ...
    IF  (   (l_Receiving_Org_rec.Sr_Receipt_Id =
             p_Receiving_Org_rec.Sr_Receipt_Id) OR
            ((p_Receiving_Org_rec.Sr_Receipt_Id = FND_API.G_MISS_NUM) OR
            (   (l_Receiving_Org_rec.Sr_Receipt_Id IS NULL) AND
                (p_Receiving_Org_rec.Sr_Receipt_Id IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute1 =
             p_Receiving_Org_rec.Attribute1) OR
            ((p_Receiving_Org_rec.Attribute1 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute1 IS NULL) AND
                (p_Receiving_Org_rec.Attribute1 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute10 =
             p_Receiving_Org_rec.Attribute10) OR
            ((p_Receiving_Org_rec.Attribute10 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute10 IS NULL) AND
                (p_Receiving_Org_rec.Attribute10 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute11 =
             p_Receiving_Org_rec.Attribute11) OR
            ((p_Receiving_Org_rec.Attribute11 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute11 IS NULL) AND
                (p_Receiving_Org_rec.Attribute11 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute12 =
             p_Receiving_Org_rec.Attribute12) OR
            ((p_Receiving_Org_rec.Attribute12 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute12 IS NULL) AND
                (p_Receiving_Org_rec.Attribute12 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute13 =
             p_Receiving_Org_rec.Attribute13) OR
            ((p_Receiving_Org_rec.Attribute13 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute13 IS NULL) AND
                (p_Receiving_Org_rec.Attribute13 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute14 =
             p_Receiving_Org_rec.Attribute14) OR
            ((p_Receiving_Org_rec.Attribute14 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute14 IS NULL) AND
                (p_Receiving_Org_rec.Attribute14 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute15 =
             p_Receiving_Org_rec.Attribute15) OR
            ((p_Receiving_Org_rec.Attribute15 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute15 IS NULL) AND
                (p_Receiving_Org_rec.Attribute15 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute2 =
             p_Receiving_Org_rec.Attribute2) OR
            ((p_Receiving_Org_rec.Attribute2 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute2 IS NULL) AND
                (p_Receiving_Org_rec.Attribute2 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute3 =
             p_Receiving_Org_rec.Attribute3) OR
            ((p_Receiving_Org_rec.Attribute3 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute3 IS NULL) AND
                (p_Receiving_Org_rec.Attribute3 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute4 =
             p_Receiving_Org_rec.Attribute4) OR
            ((p_Receiving_Org_rec.Attribute4 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute4 IS NULL) AND
                (p_Receiving_Org_rec.Attribute4 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute5 =
             p_Receiving_Org_rec.Attribute5) OR
            ((p_Receiving_Org_rec.Attribute5 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute5 IS NULL) AND
                (p_Receiving_Org_rec.Attribute5 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute6 =
             p_Receiving_Org_rec.Attribute6) OR
            ((p_Receiving_Org_rec.Attribute6 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute6 IS NULL) AND
                (p_Receiving_Org_rec.Attribute6 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute7 =
             p_Receiving_Org_rec.Attribute7) OR
            ((p_Receiving_Org_rec.Attribute7 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute7 IS NULL) AND
                (p_Receiving_Org_rec.Attribute7 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute8 =
             p_Receiving_Org_rec.Attribute8) OR
            ((p_Receiving_Org_rec.Attribute8 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute8 IS NULL) AND
                (p_Receiving_Org_rec.Attribute8 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute9 =
             p_Receiving_Org_rec.Attribute9) OR
            ((p_Receiving_Org_rec.Attribute9 = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute9 IS NULL) AND
                (p_Receiving_Org_rec.Attribute9 IS NULL))))
    AND (   (l_Receiving_Org_rec.Attribute_Category =
             p_Receiving_Org_rec.Attribute_Category) OR
            ((p_Receiving_Org_rec.Attribute_Category = FND_API.G_MISS_CHAR) OR
            (   (l_Receiving_Org_rec.Attribute_Category IS NULL) AND
                (p_Receiving_Org_rec.Attribute_Category IS NULL))))
    AND (   (l_Receiving_Org_rec.Created_By =
             p_Receiving_Org_rec.Created_By) OR
            ((p_Receiving_Org_rec.Created_By = FND_API.G_MISS_NUM) OR
            (   (l_Receiving_Org_rec.Created_By IS NULL) AND
                (p_Receiving_Org_rec.Created_By IS NULL))))
    AND (   (l_Receiving_Org_rec.Creation_Date =
             p_Receiving_Org_rec.Creation_Date) OR
            ((p_Receiving_Org_rec.Creation_Date = FND_API.G_MISS_DATE) OR
            (   (l_Receiving_Org_rec.Creation_Date IS NULL) AND
                (p_Receiving_Org_rec.Creation_Date IS NULL))))
    AND (   (l_Receiving_Org_rec.Disable_Date =
             p_Receiving_Org_rec.Disable_Date) OR
            ((p_Receiving_Org_rec.Disable_Date = FND_API.G_MISS_DATE) OR
            (   (l_Receiving_Org_rec.Disable_Date IS NULL) AND
                (p_Receiving_Org_rec.Disable_Date IS NULL))))
    AND (   (l_Receiving_Org_rec.Effective_Date =
             p_Receiving_Org_rec.Effective_Date) OR
            ((p_Receiving_Org_rec.Effective_Date = FND_API.G_MISS_DATE) OR
            (   (l_Receiving_Org_rec.Effective_Date IS NULL) AND
                (p_Receiving_Org_rec.Effective_Date IS NULL))))
    ...
    THEN
        ...
        x_Receiving_Org_rec.return_status := FND_API.G_RET_STS_SUCCESS;
    ...
    ELSE
        ...
        x_Receiving_Org_rec.return_status := FND_API.G_RET_STS_ERROR;
...
EXCEPTION
    ...
    WHEN OTHERS THEN
        ...
        x_Receiving_Org_rec.return_status := FND_API.G_RET_STS_UNEXP_ERROR;
...
BEGIN
    ...
    RETURN Query_Rows
        (   p_Sr_Receipt_Id               => p_Sr_Receipt_Id
        )(1);
...
BEGIN
    ...
    x_Receiving_Org_rec            := l_Receiving_Org_tbl(1);
    x_Receiving_Org_val_rec        := l_Receiving_Org_val_tbl(1);
...
BEGIN
    ...
    AND
    (p_Sourcing_Rule_Id IS NOT NULL
     AND
    ...
    THEN
            ...
            THEN
                ...
                (   G_PKG_NAME
                ,   'Query Rows'
                ,   'Keys are mutually exclusive: Sr_Receipt_Id = '|| p_Sr_Receipt_Id || ', Sourcing_Rule_Id = '|| p_Sourcing_Rule_Id
                );
            END IF;
    ...
    FOR l_implicit_rec IN l_Receiving_Org_csr LOOP

        l_Receiving_Org_rec.Sr_Receipt_Id := l_implicit_rec.SR_RECEIPT_ID;
        l_Receiving_Org_rec.Attribute1 := l_implicit_rec.ATTRIBUTE1;
        l_Receiving_Org_rec.Attribute10 := l_implicit_rec.ATTRIBUTE10;
        l_Receiving_Org_rec.Attribute11 := l_implicit_rec.ATTRIBUTE11;
        l_Receiving_Org_rec.Attribute12 := l_implicit_rec.ATTRIBUTE12;
        l_Receiving_Org_rec.Attribute13 := l_implicit_rec.ATTRIBUTE13;
        l_Receiving_Org_rec.Attribute14 := l_implicit_rec.ATTRIBUTE14;
        l_Receiving_Org_rec.Attribute15 := l_implicit_rec.ATTRIBUTE15;
        l_Receiving_Org_rec.Attribute2 := l_implicit_rec.ATTRIBUTE2;
        l_Receiving_Org_rec.Attribute3 := l_implicit_rec.ATTRIBUTE3;
        l_Receiving_Org_rec.Attribute4 := l_implicit_rec.ATTRIBUTE4;
        l_Receiving_Org_rec.Attribute5 := l_implicit_rec.ATTRIBUTE5;
        l_Receiving_Org_rec.Attribute6 := l_implicit_rec.ATTRIBUTE6;
        l_Receiving_Org_rec.Attribute7 := l_implicit_rec.ATTRIBUTE7;
        l_Receiving_Org_rec.Attribute8 := l_implicit_rec.ATTRIBUTE8;
        l_Receiving_Org_rec.Attribute9 := l_implicit_rec.ATTRIBUTE9;
        l_Receiving_Org_rec.Attribute_Category := l_implicit_rec.ATTRIBUTE_CATEGORY;
        l_Receiving_Org_rec.Created_By := l_implicit_rec.CREATED_BY;
        l_Receiving_Org_rec.Creation_Date := l_implicit_rec.CREATION_DATE;
        l_Receiving_Org_rec.Disable_Date := l_implicit_rec.DISABLE_DATE;
        l_Receiving_Org_rec.Effective_Date := l_implicit_rec.EFFECTIVE_DATE;
        ...
        l_Receiving_Org_rec.Program_Application_Id := l_implicit_rec.PROGRAM_APPLICATION_ID;
        l_Receiving_Org_rec.Program_Id := l_implicit_rec.PROGRAM_ID;
        l_Receiving_Org_rec.Program_Update_Date := l_implicit_rec.PROGRAM_UPDATE_DATE;
        l_Receiving_Org_rec.Receipt_Organization_Id := l_implicit_rec.RECEIPT_ORGANIZATION_ID;
        l_Receiving_Org_rec.Request_Id := l_implicit_rec.REQUEST_ID;
        l_Receiving_Org_rec.Sourcing_Rule_Id := l_implicit_rec.SOURCING_RULE_ID;

        l_Receiving_Org_tbl(l_Receiving_Org_tbl.COUNT + 1) := l_Receiving_Org_rec;
...
BEGIN
    ...
    FOR l_implicit_rec IN l_Receiving_Org_csr LOOP
        ...
        l_rows_fetched                 := l_Receiving_Org_csr%FOUND;

        x_Receiving_Org_tbl(l_Receiving_Org_csr%ROWCOUNT) := l_Receiving_Org_rec;
        x_Receiving_Org_val_tbl(l_Receiving_Org_csr%ROWCOUNT) := l_Receiving_Org_val_rec;
