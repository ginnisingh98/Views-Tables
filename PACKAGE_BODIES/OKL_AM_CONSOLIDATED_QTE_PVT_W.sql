--------------------------------------------------------
--  DDL for Package Body OKL_AM_CONSOLIDATED_QTE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_CONSOLIDATED_QTE_PVT_W" as
  /* $Header: OKLECNQB.pls 120.2 2007/11/02 21:05:11 rmunjulu ship $ */
  ...
  as
    ddp_qtev_tbl okl_am_consolidated_qte_pvt.qtev_tbl_type;
    ddx_cons_rec okl_am_consolidated_qte_pvt.qtev_rec_type;
  ...
  begin
    ...
    okl_am_consolidated_qte_pvt.create_consolidate_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_cons_rec okl_am_consolidated_qte_pvt.qtev_rec_type;
    ddx_cons_rec okl_am_consolidated_qte_pvt.qtev_rec_type;
    ddx_qtev_tbl okl_am_consolidated_qte_pvt.qtev_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_consolidated_qte_pvt.update_consolidate_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_am_consolidated_qte_pvt_w;
