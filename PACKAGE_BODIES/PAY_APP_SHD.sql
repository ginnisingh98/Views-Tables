--------------------------------------------------------
--  DDL for Package Body PAY_APP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_APP_SHD" as
...
Begin
  ...
  --
  If (p_constraint_name = 'PAY_AU_PROCESS_PARAMETERS_CHK1') Then
    fnd_message.set_name('PER', 'PER_52500_INV_YES_NO_FLAG');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PAY_AU_PROCESS_PARAMETERS_CHK2') Then
    fnd_message.set_name('PAY', 'HR_AU_DATA_TYPE_MISMATCH');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PAY_AU_PROCESS_PARAMETERS_FK1') Then
    fnd_message.set_name('PAY', 'HR_AU_INVALID_PROCESS');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PAY_AU_PROCESS_PARAMETERS_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','20');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PAY_AU_PROCESS_PARAMETERS_UK1') Then
...
Function api_updating
  ...
  Cursor C_Sel1 is
    ...
    where       process_parameter_id = p_process_parameter_id;
  --
  l_fct_ret     boolean;
  --
Begin
  --
  If (p_process_parameter_id is null and
    ...
    l_fct_ret := false;
  Else
    If (p_process_parameter_id
        = pay_app_shd.g_old_rec.process_parameter_id and
        p_object_version_number
        = pay_app_shd.g_old_rec.object_version_number
       ) Then
      --
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into pay_app_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> pay_app_shd.g_old_rec.object_version_number) Then
...
--
begin
  g_package  := '  pay_app_shd.';  -- Global package name
end pay_app_shd;
