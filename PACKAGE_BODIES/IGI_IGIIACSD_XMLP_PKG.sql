--------------------------------------------------------
--  DDL for Package Body IGI_IGIIACSD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGI_IGIIACSD_XMLP_PKG" AS
/* $Header: IGIIACSDB.pls 120.0.12010000.1 2008/07/29 08:58:27 appldev ship $ */
...
procedure FDRCSID(idstring in varchar2) is
  BEGIN
    IF (idstring is NULL) THEN
      NULL;
    END IF;
        --        FDRCSID('$Header: IGIIACSDB.pls 120.0.12010000.1 2008/07/29 08:58:27 appldev ship $');
  END;
