--------------------------------------------------------
--  DDL for Package Body OKL_PROCESS_BUCKETS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PROCESS_BUCKETS_PVT_W" as
  /* $Header: OKLEBUKB.pls 120.1 2005/07/11 12:53:41 dkagrawa noship $ */
  ...
  as
    ddp_bktv_rec okl_process_buckets_pvt.bktv_rec_type;
    ddx_bktv_rec okl_process_buckets_pvt.bktv_rec_type;
  ...
  begin
    ...
    okl_process_buckets_pvt.create_buckets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_bktv_tbl okl_process_buckets_pvt.bktv_tbl_type;
    ddx_bktv_tbl okl_process_buckets_pvt.bktv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_buckets_pvt.update_buckets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_buckets_pvt.delete_buckets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
