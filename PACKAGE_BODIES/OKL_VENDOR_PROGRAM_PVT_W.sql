--------------------------------------------------------
--  DDL for Package Body OKL_VENDOR_PROGRAM_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_VENDOR_PROGRAM_PVT_W" as
  /* $Header: OKLEPRMB.pls 120.7 2006/11/03 11:08:07 sosharma noship $ */
  ...
  as
    ddp_hdr_rec okl_vendor_program_pvt.program_header_rec_type;
    ddx_header_rec okl_vendor_program_pvt.chrv_rec_type;
    ddx_k_header_rec okl_vendor_program_pvt.khrv_rec_type;
  ...
  begin
    ...
    ddp_hdr_rec.p_legal_entity_id := p5_a30;




    -- here's the delegated call to the old PL/SQL routine
    okl_vendor_program_pvt.create_program(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_vendor_program_pvt.update_program(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
