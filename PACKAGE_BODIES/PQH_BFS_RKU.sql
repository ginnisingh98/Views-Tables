--------------------------------------------------------
--  DDL for Package Body PQH_BFS_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_BFS_RKU" as
...
begin
hr_utility.set_location('Entering: PQH_BFS_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PQH_BFS_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQH_BFS_RKU;
