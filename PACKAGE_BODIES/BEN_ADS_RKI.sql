--------------------------------------------------------
--  DDL for Package Body BEN_ADS_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ADS_RKI" as
...
begin
hr_utility.set_location('Entering: ben_ads_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_ads_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_ads_RKI;
