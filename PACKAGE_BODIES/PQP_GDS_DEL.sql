--------------------------------------------------------
--  DDL for Package Body PQP_GDS_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_GDS_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqp_gds_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Delete the pqp_gap_duration_summary row.
  --
  delete from pqp_gap_duration_summary
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pqp_gds_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in pqp_gds_shd.g_rec_type) is
--
...
Begin
  ...
  --
  pqp_gds_bus.delete_validate(p_rec);
  --
  ...
  --
  pqp_gds_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  pqp_gds_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  pqp_gds_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
