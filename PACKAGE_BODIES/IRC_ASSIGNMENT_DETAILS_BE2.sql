--------------------------------------------------------
--  DDL for Package Body IRC_ASSIGNMENT_DETAILS_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_ASSIGNMENT_DETAILS_BE2" as 
...
p_considered                   varchar2) is
  ...
  --
  l_proc varchar2(72):='  irc_assignment_details_be2.update_assignment_details_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.assignment_details.update_assignment_details';
...
end irc_assignment_details_be2;
