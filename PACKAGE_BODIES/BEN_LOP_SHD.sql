--------------------------------------------------------
--  DDL for Package Body BEN_LOP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LOP_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_lop_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_LER_CHG_OIPL_ENRT_FK2') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_LER_CHG_OIPL_ENRT_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
--
  ...
  Cursor C_Sel1 is
    ...
    where	ler_chg_oipl_enrt_id = p_ler_chg_oipl_enrt_id
...
Begin
  ...
  If (p_effective_date is null or
      p_ler_chg_oipl_enrt_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_ler_chg_oipl_enrt_id = g_old_rec.ler_chg_oipl_enrt_id and
...
--
  ...
  Cursor C_Sel1 Is
    ...
    where   t.ler_chg_oipl_enrt_id = p_base_key_value
    and     p_effective_date
...
Begin
  ...
  --
  update  ben_ler_chg_oipl_enrt_f t
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_child_table_name1       => 'ben_ler_chg_oipl_enrt_rl_f',
	 p_child_key_column1       => 'ler_chg_oipl_enrt_rl_id',
...
Begin
  ...
  l_rec.lop_attribute_category           := p_lop_attribute_category;
  l_rec.lop_attribute1                   := p_lop_attribute1;
  l_rec.lop_attribute2                   := p_lop_attribute2;
  l_rec.lop_attribute3                   := p_lop_attribute3;
  l_rec.lop_attribute4                   := p_lop_attribute4;
  l_rec.lop_attribute5                   := p_lop_attribute5;
  l_rec.lop_attribute6                   := p_lop_attribute6;
  l_rec.lop_attribute7                   := p_lop_attribute7;
  l_rec.lop_attribute8                   := p_lop_attribute8;
  l_rec.lop_attribute9                   := p_lop_attribute9;
  l_rec.lop_attribute10                  := p_lop_attribute10;
  l_rec.lop_attribute11                  := p_lop_attribute11;
  l_rec.lop_attribute12                  := p_lop_attribute12;
  l_rec.lop_attribute13                  := p_lop_attribute13;
  l_rec.lop_attribute14                  := p_lop_attribute14;
  l_rec.lop_attribute15                  := p_lop_attribute15;
  l_rec.lop_attribute16                  := p_lop_attribute16;
  l_rec.lop_attribute17                  := p_lop_attribute17;
  l_rec.lop_attribute18                  := p_lop_attribute18;
  l_rec.lop_attribute19                  := p_lop_attribute19;
  l_rec.lop_attribute20                  := p_lop_attribute20;
  l_rec.lop_attribute21                  := p_lop_attribute21;
  l_rec.lop_attribute22                  := p_lop_attribute22;
  l_rec.lop_attribute23                  := p_lop_attribute23;
  l_rec.lop_attribute24                  := p_lop_attribute24;
  l_rec.lop_attribute25                  := p_lop_attribute25;
  l_rec.lop_attribute26                  := p_lop_attribute26;
  l_rec.lop_attribute27                  := p_lop_attribute27;
  l_rec.lop_attribute28                  := p_lop_attribute28;
  l_rec.lop_attribute29                  := p_lop_attribute29;
  l_rec.lop_attribute30                  := p_lop_attribute30;
