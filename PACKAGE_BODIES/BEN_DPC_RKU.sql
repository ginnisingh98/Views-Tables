--------------------------------------------------------
--  DDL for Package Body BEN_DPC_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DPC_RKU" as
...
begin
hr_utility.set_location('Entering: ben_dpc_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_dpc_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_dpc_RKU;
