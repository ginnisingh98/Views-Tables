--------------------------------------------------------
--  DDL for Package Body PAY_AE_EFT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_AE_EFT" as
 /* $Header: pyaeeftp.pkb 120.0 2005/10/03 22:33:51 spendhar noship $ */

 g_package                  varchar2(33) := 'PAY_AE_EFT.';
 -- Global Variables
 ...
 FUNCTION get_customer_formula_header    (
				...
				,p_tape_type     IN VARCHAR2) return varchar2 IS
 ...
 fetch c_get_name into l_employer_code,l_bank_code,l_id_header,l_id_body,l_id_footer;
 close c_get_name;
                   ...
                   l_inputs(9).name  := 'SUMT';
                   l_inputs(9).value := p_sumt;
                   l_inputs(10).name  := 'SUMC';
                   l_inputs(10).value := p_sumc;
                   l_inputs(11).name  := 'SUMD';
                   l_inputs(11).value := p_sumd;
       		   l_inputs(12).name  := 'BANK_CODE';
                   l_inputs(12).value := l_bank_code;
		   l_inputs(13).name  := 'EMPLOYER_CODE';
                   l_inputs(13).value := l_employer_code;
		   l_inputs(14).name  := 'TAPE_TYPE';
                   l_inputs(14).value := p_tape_type;
 ...
 begin
 	...
 	close c_get_name;
                   ...
                   l_inputs(17).name  := 'TRANSFER_SUMT';
                   l_inputs(17).value := p_sumt;
                   l_inputs(18).name  := 'TRANSFER_SUMC';
                   l_inputs(18).value := p_sumc;
                   l_inputs(19).name  := 'TRANSFER_SUMD';
                   l_inputs(19).value := p_sumd;
                   l_inputs(20).name  := 'ORG_PAY_METHOD_ID';
                   l_inputs(20).value := l_payment_method_id;
                   l_inputs(21).name  := 'LOCAL_NATIONALITY';
                   l_inputs(21).value := p_local_nationality;
		   l_inputs(22).name  := 'BANK_CODE';
                   l_inputs(22).value := l_bank_code;
   		   l_inputs(23).name  := 'EMPLOYER_CODE';
                   l_inputs(23).value := l_employer_code;
                   l_inputs(24).name  := 'TRANCODE';
                   l_inputs(24).value := p_trancode;
                   l_inputs(25).name  := 'TRANSFER_TAPE_TYPE';
                   l_inputs(25).value := p_tape_type;
                   l_outputs(1).name := 'WRITE_TEXT1';
                   l_outputs(2).name := 'WRITE_TEXT2';
                   l_outputs(3).name := 'WRITE_TEXT3';
                   l_outputs(4).name := 'WRITE_TEXT4';
