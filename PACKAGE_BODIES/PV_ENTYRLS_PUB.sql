--------------------------------------------------------
--  DDL for Package Body PV_ENTYRLS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PV_ENTYRLS_PUB" as
/* $Header: pvrperab.pls 120.0 2005/05/27 15:26:33 appldev noship $ */
-- Start of Comments
...
G_PKG_NAME CONSTANT VARCHAR2(30):= 'PV_ENTYRLS_PUB';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'pvrperab.pls';
...
l_api_version_number      CONSTANT NUMBER   := 2.0;
 BEGIN
    ...
    -- Calling Private package: Create_ENTYRLS
      PV_entyrls_PVT.Create_entyrls(
         ...
         X_ENTITY_RULE_APPLIED_ID     => x_ENTITY_RULE_APPLIED_ID,
