--------------------------------------------------------
--  DDL for Package Body JTF_EC_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_EC_CUHK" as
/* $Header: jtfecchb.pls 115.2 2002/11/28 05:55:40 siyappan ship $ */
--/**==================================================================*
...
--	Type		: Public.
--	Function	: This is a Customer User Hooks API.The Customers can add --			  customization procedures here for Pre and Post Processing.
--
--	Version	:  1.0
-------------------------------------------------------------------------------------------
--				History
