--------------------------------------------------------
--  DDL for Package Body ISC_DBI_PDUE_PRM_TREND_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ISC_DBI_PDUE_PRM_TREND_PKG" AS
/* $Header: ISCRGAAB.pls 120.0 2005/05/25 17:43:22 appldev noship $ */
