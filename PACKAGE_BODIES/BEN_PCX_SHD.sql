--------------------------------------------------------
--  DDL for Package Body BEN_PCX_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PCX_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pcx_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_PL_BNF_CTFN_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_PL_BNF_CTFN_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  If (p_effective_date is null or
    ...
    l_fct_ret := false;
  Else
    If (p_pl_bnf_ctfn_id = g_old_rec.pl_bnf_ctfn_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_pl_bnf_ctfn_f',
	 p_base_key_column	   => 'pl_bnf_ctfn_id',
	 p_base_key_value 	   => p_pl_bnf_ctfn_id,
	 p_parent_table_name1      => 'ben_pl_f',
	 p_parent_key_column1      => 'pl_id',
...
Begin
  ...
  l_rec.bnf_typ_cd                       := p_bnf_typ_cd;
  l_rec.rlshp_typ_cd                     := p_rlshp_typ_cd;
  l_rec.object_version_number            := p_object_version_number;
  l_rec.business_group_id                := p_business_group_id;
  l_rec.pcx_attribute_category           := p_pcx_attribute_category;
  l_rec.pcx_attribute1                   := p_pcx_attribute1;
  l_rec.pcx_attribute2                   := p_pcx_attribute2;
  l_rec.pcx_attribute3                   := p_pcx_attribute3;
  l_rec.pcx_attribute4                   := p_pcx_attribute4;
  l_rec.pcx_attribute5                   := p_pcx_attribute5;
  l_rec.pcx_attribute6                   := p_pcx_attribute6;
  l_rec.pcx_attribute7                   := p_pcx_attribute7;
  l_rec.pcx_attribute8                   := p_pcx_attribute8;
  l_rec.pcx_attribute9                   := p_pcx_attribute9;
  l_rec.pcx_attribute10                  := p_pcx_attribute10;
  l_rec.pcx_attribute11                  := p_pcx_attribute11;
  l_rec.pcx_attribute12                  := p_pcx_attribute12;
  l_rec.pcx_attribute13                  := p_pcx_attribute13;
  l_rec.pcx_attribute14                  := p_pcx_attribute14;
  l_rec.pcx_attribute15                  := p_pcx_attribute15;
  l_rec.pcx_attribute16                  := p_pcx_attribute16;
  l_rec.pcx_attribute17                  := p_pcx_attribute17;
  l_rec.pcx_attribute18                  := p_pcx_attribute18;
  l_rec.pcx_attribute19                  := p_pcx_attribute19;
  l_rec.pcx_attribute20                  := p_pcx_attribute20;
  l_rec.pcx_attribute21                  := p_pcx_attribute21;
  l_rec.pcx_attribute22                  := p_pcx_attribute22;
  l_rec.pcx_attribute23                  := p_pcx_attribute23;
  l_rec.pcx_attribute24                  := p_pcx_attribute24;
  l_rec.pcx_attribute25                  := p_pcx_attribute25;
  l_rec.pcx_attribute26                  := p_pcx_attribute26;
  l_rec.pcx_attribute27                  := p_pcx_attribute27;
  l_rec.pcx_attribute28                  := p_pcx_attribute28;
  l_rec.pcx_attribute29                  := p_pcx_attribute29;
  l_rec.pcx_attribute30                  := p_pcx_attribute30;
  --
