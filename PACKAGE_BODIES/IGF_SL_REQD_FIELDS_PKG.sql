--------------------------------------------------------
--  DDL for Package Body IGF_SL_REQD_FIELDS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_SL_REQD_FIELDS_PKG" AS
/* $Header: IGFLI19B.pls 120.0 2005/06/01 13:04:19 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_sl_reqd_fields%ROWTYPE;
  new_references igf_sl_reqd_fields%ROWTYPE;

  PROCEDURE set_column_values (
    p_action                            IN     VARCHAR2,
    x_rowid                             IN     VARCHAR2    DEFAULT NULL,
    x_lrf_id                            IN     NUMBER      DEFAULT NULL,
    x_spec_version                      IN     VARCHAR2    DEFAULT NULL,
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.lrf_id                            := x_lrf_id;
    new_references.spec_version                      := x_spec_version;
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.spec_version = x_spec_version)
        AND (tlinfo.field_name = x_field_name)
