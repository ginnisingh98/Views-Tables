--------------------------------------------------------
--  DDL for Package Body PER_SST_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_SST_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_sst_bus.';  -- Global package name
--
...
Begin
  ...
  --
  if ( nvl(per_sst_bus.g_setup_sub_task_code, hr_api.g_varchar2)
    ...
    -- variable.
    --
    l_legislation_code := per_sst_bus.g_legislation_code;
    ...
    --
    close csr_leg_code;
    per_sst_bus.g_setup_sub_task_code         := p_setup_sub_task_code;
    per_sst_bus.g_legislation_code  := l_legislation_code;
  end if;
...
Begin
  ...
  --
  IF NOT per_sst_shd.api_updating
