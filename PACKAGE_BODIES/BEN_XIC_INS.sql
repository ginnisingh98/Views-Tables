--------------------------------------------------------
--  DDL for Package Body BEN_XIC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XIC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xic_ins.';  -- Global package name
--
--
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure insert_dml(p_rec in out nocopy ben_xic_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Insert the row into: ben_ext_incl_chg
  --
  insert into ben_ext_incl_chg
  (	ext_incl_chg_id,
	chg_evt_cd,
	chg_evt_source,
	ext_rcd_in_file_id,
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_insert(p_rec  in out nocopy ben_xic_shd.g_rec_type) is
--
  l_proc  varchar2(72) := g_package||'pre_insert';
--
  Cursor C_Sel1 is select ben_ext_incl_chg_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ext_incl_chg_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
--
  ...
  begin
    ...
    --
    create_app_ownerships('EXT_INCL_CHG_ID', p_rec.ext_incl_chg_id);
    --
    ben_xic_rki.after_insert
      (
...
Begin
  ...
  --
  ben_xic_bus.insert_validate(p_rec
  ,p_effective_date);
  --
...
Begin
  ...
  --
  p_ext_incl_chg_id := l_rec.ext_incl_chg_id;
