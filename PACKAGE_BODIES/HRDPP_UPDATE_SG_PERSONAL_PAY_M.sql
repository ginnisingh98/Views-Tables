--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_SG_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_SG_PERSONAL_PAY_M" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:29
 * Generated for API: HR_SG_PERSONAL_PAY_METHOD_API.UPDATE_SG_PERSONAL_PAY_METHOD
 */
--
...
decode(l.pval005,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval005,'SG_ACCOUNT_TYPE',d(l.pval001),l.pval043)) p5,
l.pval005 d5,
decode(l.pval006,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval006,'SG_BANK_CODE',d(l.pval001),l.pval043)) p6,
l.pval006 d6,
...
decode(l.pval035,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval035,'PAYEE_TYPE',d(l.pval001),l.pval043)) p35,
l.pval035 d35,
l.pval036 p36,
l.pval037 p37,
...
(P_PERSONAL_PAY_METHOD_USER_KEY => c.p40);
end if;
--
if c.p40 is null or
c.p1 is null then
...
HR_SG_PERSONAL_PAY_METHOD_API.UPDATE_SG_PERSONAL_PAY_METHOD
(p_validate => l_validate
,P_EFFECTIVE_DATE => c.p1
,P_DATETRACK_UPDATE_MODE => c.p2
,P_PERSONAL_PAYMENT_METHOD_ID => L_PERSONAL_PAYMENT_METHOD_ID
,P_OBJECT_VERSION_NUMBER => L_OBJECT_VERSION_NUMBER
,P_BANK_ACCOUNT_NUMBER => c.p3
,P_BANK_ACCOUNT_NAME => c.p4
,P_BANK_ACCOUNT_TYPE => c.p5
,P_BANK_CODE => c.p6
,P_BANK_NAME => c.p7
,P_BRANCH_CODE => c.p8
,P_BRANCH_NAME => c.p9
...
,P_COMMENT_ID => c.p36
,P_EXTERNAL_ACCOUNT_ID => c.p37
,P_EFFECTIVE_START_DATE => c.p38
,P_EFFECTIVE_END_DATE => c.p39);
...
l.pval039 = decode(c.p39,null,cn,dc(c.p39))
...
end hrdpp_UPDATE_SG_PERSONAL_PAY_M;
