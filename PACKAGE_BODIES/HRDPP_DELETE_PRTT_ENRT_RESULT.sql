--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_PRTT_ENRT_RESULT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_PRTT_ENRT_RESULT" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 13:01:02
 * Generated for API: ben_prtt_enrt_result_api.DELETE_PRTT_ENRT_RESULT
 */
--
...
,P_PRTT_ENRT_RSLT_USER_KEY in varchar2) is
...
(P_PRTT_ENRT_RSLT_USER_KEY => c.p6);
end if;
--
if c.p6 is null or
c.p3 is null then
...
end hrdpp_DELETE_PRTT_ENRT_RESULT;
