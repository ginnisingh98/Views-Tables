--------------------------------------------------------
--  DDL for Package Body ISC_DBI_PDUE_SCH_AGING_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ISC_DBI_PDUE_SCH_AGING_PKG" AS
/* $Header: ISCRGA6B.pls 120.0 2005/05/25 17:13:57 appldev noship $ */
