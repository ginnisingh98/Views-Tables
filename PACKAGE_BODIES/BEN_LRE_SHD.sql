--------------------------------------------------------
--  DDL for Package Body BEN_LRE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LRE_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_lre_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'AVCON_BEN_L_EXCLD_000') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_LER_RQRS_ENRT_CTFN_F_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','10');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_LER_RQRS_ENRT_CTFN_F_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  If (p_effective_date is null or
      p_ler_rqrs_enrt_ctfn_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_ler_rqrs_enrt_ctfn_id = g_old_rec.ler_rqrs_enrt_ctfn_id and
...
Begin
  ...
  --
  hr_api.mandatory_arg_error(p_api_name       => l_proc,
                             p_argument       => 'ler_rqrs_enrt_ctfn_id',
                             p_argument_value => p_ler_rqrs_enrt_ctfn_id);
  --
  hr_api.mandatory_arg_error(p_api_name       => l_proc,
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_ler_rqrs_enrt_ctfn_f',
	 p_base_key_column	   => 'ler_rqrs_enrt_ctfn_id',
	 p_base_key_value 	   => p_ler_rqrs_enrt_ctfn_id,
	 p_parent_table_name1      => 'ben_pl_f',
	 p_parent_key_column1      => 'pl_id',
	 ...
	 p_parent_table_name3      => 'ben_ler_f',
	 p_parent_key_column3      => 'ler_id',
	 p_parent_key_value3       => g_old_rec.ler_id,
	 p_child_table_name1       => 'ben_ler_enrt_ctfn_f',
	 p_child_key_column1       => 'ler_enrt_ctfn_id',
         p_enforce_foreign_locking => false, --true Bug 6160317
...
Begin
  ...
  l_rec.lre_attribute_category           := p_lre_attribute_category;
  l_rec.lre_attribute1                   := p_lre_attribute1;
  l_rec.lre_attribute2                   := p_lre_attribute2;
  l_rec.lre_attribute3                   := p_lre_attribute3;
  l_rec.lre_attribute4                   := p_lre_attribute4;
  l_rec.lre_attribute5                   := p_lre_attribute5;
  l_rec.lre_attribute6                   := p_lre_attribute6;
  l_rec.lre_attribute7                   := p_lre_attribute7;
  l_rec.lre_attribute8                   := p_lre_attribute8;
  l_rec.lre_attribute9                   := p_lre_attribute9;
  l_rec.lre_attribute10                  := p_lre_attribute10;
  l_rec.lre_attribute11                  := p_lre_attribute11;
  l_rec.lre_attribute12                  := p_lre_attribute12;
  l_rec.lre_attribute13                  := p_lre_attribute13;
  l_rec.lre_attribute14                  := p_lre_attribute14;
  l_rec.lre_attribute15                  := p_lre_attribute15;
  l_rec.lre_attribute16                  := p_lre_attribute16;
  l_rec.lre_attribute17                  := p_lre_attribute17;
  l_rec.lre_attribute18                  := p_lre_attribute18;
  l_rec.lre_attribute19                  := p_lre_attribute19;
  l_rec.lre_attribute20                  := p_lre_attribute20;
  l_rec.lre_attribute21                  := p_lre_attribute21;
  l_rec.lre_attribute22                  := p_lre_attribute22;
  l_rec.lre_attribute23                  := p_lre_attribute23;
  l_rec.lre_attribute24                  := p_lre_attribute24;
  l_rec.lre_attribute25                  := p_lre_attribute25;
  l_rec.lre_attribute26                  := p_lre_attribute26;
  l_rec.lre_attribute27                  := p_lre_attribute27;
  l_rec.lre_attribute28                  := p_lre_attribute28;
  l_rec.lre_attribute29                  := p_lre_attribute29;
  l_rec.lre_attribute30                  := p_lre_attribute30;
