--------------------------------------------------------
--  DDL for Package Body BIM_EDW_IH_REASN_M_SIZE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BIM_EDW_IH_REASN_M_SIZE" AS
/* $Header: bimszrnb.pls 115.0 2001/03/14 12:03:41 pkm ship       $*/
...
CURSOR c_cnt_rows IS
   ...
   from (
	select count(*) cnt
	FROM JTF_IH_REASONS_VL RSN ,
	EDW_LOCAL_INSTANCE INST
        where RSN.last_update_date between
...
END;  -- package body BIM_EDW_IH_REASN_M_SIZE
