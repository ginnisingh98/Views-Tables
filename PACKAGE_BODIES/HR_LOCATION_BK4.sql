--------------------------------------------------------
--  DDL for Package Body HR_LOCATION_BK4
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_LOCATION_BK4" as
...
begin
hr_utility.set_location('Entering: HR_LOCATION_BK4.CREATE_LOCATION_LEGAL_ADR_A', 10);
hr_utility.set_location(' Leaving: HR_LOCATION_BK4.CREATE_LOCATION_LEGAL_ADR_A', 20);
end CREATE_LOCATION_LEGAL_ADR_A;
...
begin
hr_utility.set_location('Entering: HR_LOCATION_BK4.CREATE_LOCATION_LEGAL_ADR_B', 10);
hr_utility.set_location(' Leaving: HR_LOCATION_BK4.CREATE_LOCATION_LEGAL_ADR_B', 20);
end CREATE_LOCATION_LEGAL_ADR_B;
end HR_LOCATION_BK4;
