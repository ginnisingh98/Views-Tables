--------------------------------------------------------
--  DDL for Package Body OTA_LPS_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_LPS_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_lps_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the ota_learning_paths Row
  --
  update ota_learning_paths
    ...
    ,path_source_code                = p_rec.path_source_code
    ,source_function_code            = p_rec.source_function_code
...
Begin
  ...
  begin
    ...
    ota_lps_rku.after_update
      ...
      => ota_lps_shd.g_old_rec.business_group_id
      ,p_duration_o
      => ota_lps_shd.g_old_rec.duration
      ,p_duration_units_o
      => ota_lps_shd.g_old_rec.duration_units
      ,p_start_date_active_o
      => ota_lps_shd.g_old_rec.start_date_active
      ,p_end_date_active_o
      => ota_lps_shd.g_old_rec.end_date_active
      ,p_object_version_number_o
      => ota_lps_shd.g_old_rec.object_version_number
      ,p_attribute_category_o
      => ota_lps_shd.g_old_rec.attribute_category
      ,p_attribute1_o
      => ota_lps_shd.g_old_rec.attribute1
      ,p_attribute2_o
      => ota_lps_shd.g_old_rec.attribute2
      ,p_attribute3_o
      => ota_lps_shd.g_old_rec.attribute3
      ,p_attribute4_o
      => ota_lps_shd.g_old_rec.attribute4
      ,p_attribute5_o
      => ota_lps_shd.g_old_rec.attribute5
      ,p_attribute6_o
      => ota_lps_shd.g_old_rec.attribute6
      ,p_attribute7_o
      => ota_lps_shd.g_old_rec.attribute7
      ,p_attribute8_o
      => ota_lps_shd.g_old_rec.attribute8
      ,p_attribute9_o
      => ota_lps_shd.g_old_rec.attribute9
      ,p_attribute10_o
      => ota_lps_shd.g_old_rec.attribute10
      ,p_attribute11_o
      => ota_lps_shd.g_old_rec.attribute11
      ,p_attribute12_o
      => ota_lps_shd.g_old_rec.attribute12
      ,p_attribute13_o
      => ota_lps_shd.g_old_rec.attribute13
      ,p_attribute14_o
      => ota_lps_shd.g_old_rec.attribute14
      ,p_attribute15_o
      => ota_lps_shd.g_old_rec.attribute15
      ,p_attribute16_o
      => ota_lps_shd.g_old_rec.attribute16
      ,p_attribute17_o
      => ota_lps_shd.g_old_rec.attribute17
      ,p_attribute18_o
      => ota_lps_shd.g_old_rec.attribute18
      ,p_attribute19_o
      => ota_lps_shd.g_old_rec.attribute19
      ,p_attribute20_o
      => ota_lps_shd.g_old_rec.attribute20
      ,p_path_source_code_o
      => ota_lps_shd.g_old_rec.path_source_code
      ,p_source_function_code_o
      => ota_lps_shd.g_old_rec.source_function_code
      ,p_assignment_id_o
      => ota_lps_shd.g_old_rec.assignment_id
      ,p_source_id_o
      => ota_lps_shd.g_old_rec.source_id
      ,p_notify_days_before_target_o
      => ota_lps_shd.g_old_rec.notify_days_before_target
      ,p_person_id_o
      => ota_lps_shd.g_old_rec.person_id
      ,p_contact_id_o
      => ota_lps_shd.g_old_rec.contact_id
      ,p_display_to_learner_flag_o
      => ota_lps_shd.g_old_rec.display_to_learner_flag
      ,p_public_flag_o
      => ota_lps_shd.g_old_rec.public_flag
      ,p_competency_update_level_o      => ota_lps_shd.g_old_rec.competency_update_level
      );
...
Begin
  ...
  End If;
   If (p_rec.end_date_active = hr_api.g_date) then
    ...
    ota_lps_shd.g_old_rec.end_date_active;
  End If;
  If (p_rec.path_source_code = hr_api.g_varchar2) then
    p_rec.path_source_code :=
    ota_lps_shd.g_old_rec.path_source_code;
  End If;
  If (p_rec.source_function_code = hr_api.g_varchar2) then
    p_rec.source_function_code :=
    ota_lps_shd.g_old_rec.source_function_code;
  End If;
  ...
  If (p_rec.competency_update_level = hr_api.g_varchar2) then
    ...
    ota_lps_shd.g_old_rec.competency_update_level;
  End If;
  --
End convert_defs;
--
...
Begin
  ...
  --
  ota_lps_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_lps_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_lps_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
