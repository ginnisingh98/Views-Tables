--------------------------------------------------------
--  DDL for Package Body PER_ORG_STRUCTURE_VERSION_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ORG_STRUCTURE_VERSION_SWI" As
/* $Header: peosvswi.pkb 115.2 2003/05/22 08:11:21 ndorai noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'per_org_structure_version_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_org_struct_version_swi;
  --
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_org_struct_version_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_org_struct_version_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  per_org_structure_version_api.delete_org_structure_version
    (p_validate                     => l_validate
    ,p_org_structure_version_id     => p_org_structure_version_id
    ,p_object_version_number        => p_object_version_number
    );
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_org_struct_version_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
...
PROCEDURE update_org_structure_version
  ...
  --
  -- Other variables
  l_proc    varchar2(72) := g_package ||'update_org_structure_version';
Begin
  hr_utility.set_location(' Entering:' || l_proc,10);
  --
  -- Issue a savepoint
  --
  savepoint update_org_struct_version_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  per_org_structure_version_api.update_org_structure_version
    (p_validate                     => l_validate
    ,p_effective_date               => p_effective_date
    ,p_date_from                    => p_date_from
    ,p_version_number               => p_version_number
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_org_struct_version_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
