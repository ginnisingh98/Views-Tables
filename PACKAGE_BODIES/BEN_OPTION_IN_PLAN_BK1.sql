--------------------------------------------------------
--  DDL for Package Body BEN_OPTION_IN_PLAN_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_OPTION_IN_PLAN_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_OPTION_IN_PLAN_BK1.CREATE_OPTION_IN_PLAN_A', 10);
hr_utility.set_location(' Leaving: BEN_OPTION_IN_PLAN_BK1.CREATE_OPTION_IN_PLAN_A', 20);
end CREATE_OPTION_IN_PLAN_A;
...
begin
hr_utility.set_location('Entering: BEN_OPTION_IN_PLAN_BK1.CREATE_OPTION_IN_PLAN_B', 10);
hr_utility.set_location(' Leaving: BEN_OPTION_IN_PLAN_BK1.CREATE_OPTION_IN_PLAN_B', 20);
end CREATE_OPTION_IN_PLAN_B;
