--------------------------------------------------------
--  DDL for Package Body IRC_DEFAULT_POSTING_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_DEFAULT_POSTING_SWI" As
/* $Header: iridpswi.pkb 120.0 2005/07/26 15:07:15 mbocutt noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'irc_default_posting_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_default_posting_swi;
  --
  ...
  --
  irc_idp_ins.set_base_key_value
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_default_posting_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_default_posting_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_default_posting_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_default_posting_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  irc_default_posting_api.update_default_posting
    (p_validate                     => l_validate
    ,p_language_code                => p_language_code
    ,p_default_posting_id           => p_default_posting_id
    ,p_position_id                  => p_position_id
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_default_posting_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
