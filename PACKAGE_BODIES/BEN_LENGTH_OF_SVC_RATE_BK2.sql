--------------------------------------------------------
--  DDL for Package Body BEN_LENGTH_OF_SVC_RATE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LENGTH_OF_SVC_RATE_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_LENGTH_OF_SVC_RATE_BK2.UPDATE_LENGTH_OF_SVC_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_LENGTH_OF_SVC_RATE_BK2.UPDATE_LENGTH_OF_SVC_RATE_A', 20);
end UPDATE_LENGTH_OF_SVC_RATE_A;
...
begin
hr_utility.set_location('Entering: BEN_LENGTH_OF_SVC_RATE_BK2.UPDATE_LENGTH_OF_SVC_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_LENGTH_OF_SVC_RATE_BK2.UPDATE_LENGTH_OF_SVC_RATE_B', 20);
end UPDATE_LENGTH_OF_SVC_RATE_B;
