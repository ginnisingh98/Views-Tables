--------------------------------------------------------
--  DDL for Package Body BEN_WCT_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_WCT_RKI" as
...
begin
hr_utility.set_location('Entering: ben_wct_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_wct_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_wct_RKI;
