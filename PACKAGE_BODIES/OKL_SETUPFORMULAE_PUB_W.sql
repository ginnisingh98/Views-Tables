--------------------------------------------------------
--  DDL for Package Body OKL_SETUPFORMULAE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPFORMULAE_PUB_W" as
  /* $Header: OKLUSFMB.pls 120.1 2005/07/19 07:29:57 asawanka noship $ */
  ...
  as
    ddp_fmav_rec okl_setupformulae_pub.fmav_rec_type;
    ddx_no_data_found boolean;
    ddx_fmav_rec okl_setupformulae_pub.fmav_rec_type;
  ...
  begin
    ...
    okl_setupformulae_pub.get_rec(ddp_fmav_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_fmav_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_fmav_rec.id);
    p4_a1 := rosetta_g_miss_num_map(ddx_fmav_rec.object_version_number);
    p4_a2 := ddx_fmav_rec.sfwt_flag;
    p4_a3 := rosetta_g_miss_num_map(ddx_fmav_rec.cgr_id);
    p4_a4 := ddx_fmav_rec.fyp_code;
    p4_a5 := ddx_fmav_rec.name;
    p4_a6 := ddx_fmav_rec.formula_string;
    p4_a7 := ddx_fmav_rec.description;
    p4_a8 := ddx_fmav_rec.version;
    p4_a9 := ddx_fmav_rec.start_date;
    p4_a10 := ddx_fmav_rec.end_date;
    p4_a11 := ddx_fmav_rec.attribute_category;
    p4_a12 := ddx_fmav_rec.attribute1;
    p4_a13 := ddx_fmav_rec.attribute2;
    p4_a14 := ddx_fmav_rec.attribute3;
    p4_a15 := ddx_fmav_rec.attribute4;
    p4_a16 := ddx_fmav_rec.attribute5;
    p4_a17 := ddx_fmav_rec.attribute6;
    p4_a18 := ddx_fmav_rec.attribute7;
    p4_a19 := ddx_fmav_rec.attribute8;
    p4_a20 := ddx_fmav_rec.attribute9;
    p4_a21 := ddx_fmav_rec.attribute10;
    p4_a22 := ddx_fmav_rec.attribute11;
    p4_a23 := ddx_fmav_rec.attribute12;
    p4_a24 := ddx_fmav_rec.attribute13;
    p4_a25 := ddx_fmav_rec.attribute14;
    p4_a26 := ddx_fmav_rec.attribute15;
    p4_a27 := rosetta_g_miss_num_map(ddx_fmav_rec.org_id);
    p4_a28 := ddx_fmav_rec.there_can_be_only_one_yn;
    p4_a29 := rosetta_g_miss_num_map(ddx_fmav_rec.created_by);
    p4_a30 := ddx_fmav_rec.creation_date;
    p4_a31 := rosetta_g_miss_num_map(ddx_fmav_rec.last_updated_by);
    p4_a32 := ddx_fmav_rec.last_update_date;
    p4_a33 := rosetta_g_miss_num_map(ddx_fmav_rec.last_update_login);
  end;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupformulae_pub.insert_formulae(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupformulae_pub.update_formulae(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
