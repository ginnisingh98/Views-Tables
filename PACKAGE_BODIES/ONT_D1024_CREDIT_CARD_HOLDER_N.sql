--------------------------------------------------------
--  DDL for Package Body ONT_D1024_CREDIT_CARD_HOLDER_N
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1024_CREDIT_CARD_HOLDER_N" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D1024_CREDIT_CARD_HOLDER_N
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1024_CREDIT_CARD_HOLDER_N';
