--------------------------------------------------------
--  DDL for Package Body CSI_IEA_VALUES_H_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CSI_IEA_VALUES_H_PKG" as
/* $Header: csitivhb.pls 115.20 2003/09/04 00:20:55 sguthiva ship $ */


g_pkg_name CONSTANT VARCHAR2(30):= 'CSI_IEA_VALUES_H_PKG';

PROCEDURE Insert_Row(
          px_ATTRIBUTE_VALUE_HISTORY_ID   IN OUT NOCOPY NUMBER,
          p_ATTRIBUTE_VALUE_ID    NUMBER,
          p_TRANSACTION_ID    NUMBER,
          p_OLD_ATTRIBUTE_VALUE    VARCHAR2,
          p_NEW_ATTRIBUTE_VALUE    VARCHAR2,
 ...
 IS
   CURSOR C2 IS SELECT CSI_IEA_VALUES_H_S.nextval FROM sys.dual;
BEGIN
   If (px_ATTRIBUTE_VALUE_HISTORY_ID IS NULL) OR (px_ATTRIBUTE_VALUE_HISTORY_ID = FND_API.G_MISS_NUM) then
       OPEN C2;
       FETCH C2 INTO px_ATTRIBUTE_VALUE_HISTORY_ID;
       CLOSE C2;
   End If;
   INSERT INTO CSI_IEA_VALUES_H(
          ...
          OBJECT_VERSION_NUMBER
           ...
           px_ATTRIBUTE_VALUE_HISTORY_ID,
           decode( p_ATTRIBUTE_VALUE_ID, FND_API.G_MISS_NUM, NULL, p_ATTRIBUTE_VALUE_ID),
           decode( p_TRANSACTION_ID, FND_API.G_MISS_NUM, NULL, p_TRANSACTION_ID),
           decode( p_OLD_ATTRIBUTE_VALUE, FND_API.G_MISS_CHAR, NULL, p_OLD_ATTRIBUTE_VALUE),
           decode( p_NEW_ATTRIBUTE_VALUE, FND_API.G_MISS_CHAR, NULL, p_NEW_ATTRIBUTE_VALUE),
...
PROCEDURE Update_Row(
          p_ATTRIBUTE_VALUE_HISTORY_ID    NUMBER,
          p_ATTRIBUTE_VALUE_ID    NUMBER,
          p_TRANSACTION_ID    NUMBER,
          p_OLD_ATTRIBUTE_VALUE    VARCHAR2,
          p_NEW_ATTRIBUTE_VALUE    VARCHAR2,
 ...
 BEGIN
    ...
    SET
              ...
              OLD_ATTRIBUTE_VALUE = decode( p_OLD_ATTRIBUTE_VALUE, FND_API.G_MISS_CHAR, OLD_ATTRIBUTE_VALUE, p_OLD_ATTRIBUTE_VALUE),
              NEW_ATTRIBUTE_VALUE = decode( p_NEW_ATTRIBUTE_VALUE, FND_API.G_MISS_CHAR, NEW_ATTRIBUTE_VALUE, p_NEW_ATTRIBUTE_VALUE),
    ...
    where ATTRIBUTE_VALUE_HISTORY_ID = p_ATTRIBUTE_VALUE_HISTORY_ID;
...
PROCEDURE Lock_Row(
 ...
 IS
   CURSOR C IS
        ...
        WHERE ATTRIBUTE_VALUE_HISTORY_ID =  p_ATTRIBUTE_VALUE_HISTORY_ID
        FOR UPDATE of ATTRIBUTE_VALUE_HISTORY_ID NOWAIT;
   Recinfo C%ROWTYPE;
 BEGIN
    OPEN C;
    ...
    CLOSE C;
    if (
           (      Recinfo.ATTRIBUTE_VALUE_HISTORY_ID = p_ATTRIBUTE_VALUE_HISTORY_ID)
       ...
       AND (    ( Recinfo.OLD_ATTRIBUTE_VALUE = p_OLD_ATTRIBUTE_VALUE)
            OR (    ( Recinfo.OLD_ATTRIBUTE_VALUE IS NULL )
                AND (  p_OLD_ATTRIBUTE_VALUE IS NULL )))
       AND (    ( Recinfo.NEW_ATTRIBUTE_VALUE = p_NEW_ATTRIBUTE_VALUE)
            OR (    ( Recinfo.NEW_ATTRIBUTE_VALUE IS NULL )
                AND (  p_NEW_ATTRIBUTE_VALUE IS NULL )))
