--------------------------------------------------------
--  DDL for Package Body OKL_SETUPPQUALITYS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPPQUALITYS_PVT_W" as
  /* $Header: OKLESPQB.pls 115.2 2002/12/24 04:03:53 sgorantl noship $ */
  ...
  as
    ddp_pqyv_rec okl_setuppqualitys_pvt.pqyv_rec_type;
    ddx_no_data_found boolean;
    ddx_pqyv_rec okl_setuppqualitys_pvt.pqyv_rec_type;
  ...
  begin
    ...
    okl_setuppqualitys_pvt.get_rec(ddp_pqyv_rec,
      ddx_no_data_found,
      x_return_status,
      ddx_pqyv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p3_a0 := rosetta_g_miss_num_map(ddx_pqyv_rec.id);
    p3_a1 := rosetta_g_miss_num_map(ddx_pqyv_rec.object_version_number);
    p3_a2 := ddx_pqyv_rec.name;
    p3_a3 := ddx_pqyv_rec.description;
    p3_a4 := ddx_pqyv_rec.location_yn;
    p3_a5 := ddx_pqyv_rec.from_date;
    p3_a6 := ddx_pqyv_rec.to_date;
    p3_a7 := rosetta_g_miss_num_map(ddx_pqyv_rec.created_by);
    p3_a8 := ddx_pqyv_rec.creation_date;
    p3_a9 := rosetta_g_miss_num_map(ddx_pqyv_rec.last_updated_by);
    p3_a10 := ddx_pqyv_rec.last_update_date;
    p3_a11 := rosetta_g_miss_num_map(ddx_pqyv_rec.last_update_login);
  end;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppqualitys_pvt.insert_pqualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppqualitys_pvt.update_pqualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
