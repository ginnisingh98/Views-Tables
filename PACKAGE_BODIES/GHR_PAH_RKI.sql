--------------------------------------------------------
--  DDL for Package Body GHR_PAH_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_PAH_RKI" as
...
begin
hr_utility.set_location('Entering: GHR_PAH_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: GHR_PAH_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end GHR_PAH_RKI;
