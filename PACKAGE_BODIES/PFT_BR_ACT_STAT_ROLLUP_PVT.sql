--------------------------------------------------------
--  DDL for Package Body PFT_BR_ACT_STAT_ROLLUP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PFT_BR_ACT_STAT_ROLLUP_PVT" AS
/* $Header: PFTVSRUB.pls 120.0 2005/06/06 19:05:42 appldev noship $ */

--------------------------------------------------------------------------------
-- PRIVATE CONSTANTS
--------------------------------------------------------------------------------

G_PKG_NAME constant varchar2(30) := 'PFT_BR_ACT_STAT_ROLLUP_PVT';
...
BEGIN
  ...
  delete from PFT_ACTIVITY_STAT_RU
  where stat_rollup_obj_def_id = p_obj_def_id;
...
BEGIN
  ...
  insert into pft_activity_stat_ru (
    stat_rollup_obj_def_id
  ...
  where stat_rollup_obj_def_id = p_source_obj_def_id;
