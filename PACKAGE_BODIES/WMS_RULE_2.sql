--------------------------------------------------------
--  DDL for Package Body WMS_RULE_2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WMS_RULE_2" AS
...
,base.grade_code 
,NULL consist_string
,base.DATE_RECEIVED order_by_string
...
and base.INVENTORY_ITEM_ID = g_inventory_item_id
 ...
 order by base.DATE_RECEIVED desc
...
,base.UOM_CODE
,base.GRADE_CODE
,base.DATE_RECEIVED,base.SERIAL_NUMBER,base.CONVERSION_RATE
,base.DATE_RECEIVED
 order by base.DATE_RECEIVED desc
,base.SERIAL_NUMBER asc,base.CONVERSION_RATE desc
;
