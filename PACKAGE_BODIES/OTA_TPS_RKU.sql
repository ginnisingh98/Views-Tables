--------------------------------------------------------
--  DDL for Package Body OTA_TPS_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TPS_RKU" as
...
begin
hr_utility.set_location('Entering: OTA_TPS_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: OTA_TPS_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end OTA_TPS_RKU;
