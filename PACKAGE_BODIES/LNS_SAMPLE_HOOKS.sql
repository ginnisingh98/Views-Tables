--------------------------------------------------------
--  DDL for Package Body LNS_SAMPLE_HOOKS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."LNS_SAMPLE_HOOKS" as
/* $Header: LNS_SMPL_HOOKS_B.pls 120.0.12010000.1 2009/07/02 17:42:08 scherkas noship $ */


/*=======================================================================+
 |  Package Global Constants
 +=======================================================================*/
    G_PKG_NAME                      CONSTANT VARCHAR2(30):= 'LNS_SAMPLE_HOOKS';
...
BEGIN
    ...
    l_month_difference := floor(months_between(P_NEW_LOAN_START_DATE, P_ORIG_LOAN_START_DATE));
    logMessage(FND_LOG.LEVEL_PROCEDURE, 'l_month_difference: ' || l_month_difference);

    X_NEW_INT_START_DATE := add_months(P_ORIG_INT_START_DATE, l_month_difference);
    ...
    if P_ORIG_PRIN_START_DATE is not null then
        X_NEW_PRIN_START_DATE := add_months(P_ORIG_PRIN_START_DATE, l_month_difference);
