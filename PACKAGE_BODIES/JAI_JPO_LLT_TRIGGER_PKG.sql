--------------------------------------------------------
--  DDL for Package Body JAI_JPO_LLT_TRIGGER_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JAI_JPO_LLT_TRIGGER_PKG" AS
/* $Header: jai_jpo_llt_t.plb 120.0 2005/09/01 12:35:58 rallamse noship $ */

/*
  REM +======================================================================+
  REM NAME          BRU_T1
  REM
  REM DESCRIPTION   Called from trigger JAI_JPO_LLT_BRIUD_T1
  REM
  REM NOTES         Refers to old trigger JAI_JPO_LLT_BRU_T1
  REM
  REM +======================================================================+
  */
