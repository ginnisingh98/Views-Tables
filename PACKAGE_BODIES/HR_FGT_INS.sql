--------------------------------------------------------
--  DDL for Package Body HR_FGT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_FGT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_fgt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: hr_form_data_groups_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.form_data_group_id               := p_form_data_group_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  --
  hr_fgt_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  hr_fgt_ins.pre_insert
    (p_rec                         => p_rec
  ...
  -- Insert the row
  --
  hr_fgt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hr_fgt_ins.post_insert
     (p_rec
     );
  --
