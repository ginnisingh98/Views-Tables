--------------------------------------------------------
--  DDL for Package Body HR_CA_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_CA_APPLICANT_API" as
/* $Header: peappcai.pkb 115.2 2002/12/10 06:58:57 raranjan noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := 'hr_ca_applicant_api.';
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_ca_applicant >--------------------------|
-- ----------------------------------------------------------------------------
...
procedure create_ca_applicant
  ...
  --
  l_proc                 varchar2(72) := g_package||'create_ca_applicant';
...
begin
  ...
  ,p_national_identifier          => p_social_insurance_number
  ...
  ,p_per_information_category     => 'CA'
  ,p_per_information1             => p_work_permit_number
  ,p_per_information2             => p_work_permit_status
  ,p_per_information3             => p_work_permit_end_date
  ,p_per_information4             => p_woman
  ,p_per_information5             => p_aboriginal
  ,p_per_information6             => p_visible_minority
  ,p_per_information7             => p_disabled
  ,p_per_information8             => p_not_provided
  ,p_per_information9             => p_unknown
  ...
  ,p_town_of_birth                => p_city_of_birth
  ,p_region_of_birth              => p_province_of_birth
