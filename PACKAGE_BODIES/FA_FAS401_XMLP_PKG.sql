--------------------------------------------------------
--  DDL for Package Body FA_FAS401_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FAS401_XMLP_PKG" AS
/* $Header: FAS401B.pls 120.0.12010000.1 2008/07/28 13:14:11 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    RETURN(':Responsibility Reserve Ledger:');
END;
RETURN NULL; end;
...
/*PROCEDURE VERSION IS
  ...
  BEGIN
     FDRCSID := '$Header: FAS401B.pls 120.0.12010000.1 2008/07/28 13:14:11 appldev ship $';
  END VERSION;*/
procedure FA_RSVLDG
       (book            in  varchar2,
        period          in  varchar2,
