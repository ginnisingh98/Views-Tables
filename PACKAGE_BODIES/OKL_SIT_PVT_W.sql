--------------------------------------------------------
--  DDL for Package Body OKL_SIT_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SIT_PVT_W" as
  /* $Header: OKLISITB.pls 120.1 2005/07/30 09:40:14 asawanka noship $ */
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).sil_id := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).sfe_id := rosetta_g_miss_num_map(a5(indx));
          ...
          t(ddindx).pricing_name := a11(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
    ...
    a11 := JTF_VARCHAR2_TABLE_200();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).sil_id);
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).sfe_id);
          ...
          a11(indx) := t(ddindx).pricing_name;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  as
    ddp_sitv_rec okl_sit_pvt.sitv_rec_type;
    ddx_sitv_rec okl_sit_pvt.sitv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_sit_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_sitv_tbl okl_sit_pvt.sitv_tbl_type;
    ddx_sitv_tbl okl_sit_pvt.sitv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_sit_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_sit_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_sit_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_sit_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
