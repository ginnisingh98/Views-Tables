--------------------------------------------------------
--  DDL for Package Body PAY_PGP_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PGP_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_pgp_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |-----------------------------< convert_defs >-----------------------------|
-- ----------------------------------------------------------------------------
--
Procedure convert_defs(p_rec in out pay_pgp_shd.g_rec_type) is
--
...
begin
  ...
  --
  if pay_pgp_shd.api_updating
       (p_people_group_id => l_rec.people_group_id) then
    --
    ...
    --
    pay_pgp_upd.convert_defs(p_rec => l_rec);
  else
    --
