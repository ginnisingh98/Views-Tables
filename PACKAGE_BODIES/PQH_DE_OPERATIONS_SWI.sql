--------------------------------------------------------
--  DDL for Package Body PQH_DE_OPERATIONS_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_DE_OPERATIONS_SWI" As
/* $Header: pqoplswi.pkb 115.1 2002/12/03 00:09:38 rpasapul noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'pqh_de_operations_swi.';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< delete_operations >--------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_operations_swi;
  --
  ...
  -- Call API
  --
  pqh_de_operations_api.delete_operations
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to delete_operations_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint insert_operations_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Register Surrogate ID or user key values
  --
  pqh_opl_ins.set_base_key_value
    (p_operation_id => p_operation_id
    );
  --
  -- Call API
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to insert_operations_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_operation_id                 := null;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_operations_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_operations_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
