--------------------------------------------------------
--  DDL for Package Body OKL_PDT_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PDT_PVT_W" as
  /* $Header: OKLIPDTB.pls 120.3 2005/10/30 04:17:12 appldev noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_pdt_pvt.pdt_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).aes_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).ptl_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).legacy_product_yn := a4(indx);
          t(ddindx).version := a5(indx);
          t(ddindx).object_version_number := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).description := a7(indx);
          t(ddindx).reporting_pdt_id := rosetta_g_miss_num_map(a8(indx));
          t(ddindx).product_status_code := a9(indx);
  ...
  procedure rosetta_table_copy_out_p2(t okl_pdt_pvt.pdt_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a32 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).aes_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).ptl_id);
          a4(indx) := t(ddindx).legacy_product_yn;
          a5(indx) := t(ddindx).version;
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).object_version_number);
          a7(indx) := t(ddindx).description;
          a8(indx) := rosetta_g_miss_num_map(t(ddindx).reporting_pdt_id);
          a9(indx) := t(ddindx).product_status_code;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_pdt_pvt.pdtv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).reporting_pdt_id := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).product_status_code := a7(indx);
          t(ddindx).legacy_product_yn := a8(indx);
          t(ddindx).from_date := rosetta_g_miss_date_in_map(a9(indx));
          t(ddindx).version := a10(indx);
          t(ddindx).to_date := rosetta_g_miss_date_in_map(a11(indx));
          t(ddindx).attribute_category := a12(indx);
          t(ddindx).attribute1 := a13(indx);
          t(ddindx).attribute2 := a14(indx);
  ...
  procedure rosetta_table_copy_out_p5(t okl_pdt_pvt.pdtv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a32 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).reporting_pdt_id);
          a7(indx) := t(ddindx).product_status_code;
          a8(indx) := t(ddindx).legacy_product_yn;
          a9(indx) := t(ddindx).from_date;
          a10(indx) := t(ddindx).version;
          a11(indx) := t(ddindx).to_date;
          a12(indx) := t(ddindx).attribute_category;
          a13(indx) := t(ddindx).attribute1;
          a14(indx) := t(ddindx).attribute2;
  ...
  as
    ddp_pdtv_rec okl_pdt_pvt.pdtv_rec_type;
    ddx_pdtv_rec okl_pdt_pvt.pdtv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_pdt_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pdtv_tbl okl_pdt_pvt.pdtv_tbl_type;
    ddx_pdtv_tbl okl_pdt_pvt.pdtv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
