--------------------------------------------------------
--  DDL for Package Body CN_COLLECT_AIA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CN_COLLECT_AIA" AS
-- $Header: CNCOAIB.pls 120.0.12010000.2 2008/11/18 05:02:52 rajukum noship $
...
BEGIN
  ...
  STATEMENT := 'begin cn_collect_aia'||cached_org_append||
