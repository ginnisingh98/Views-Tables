--------------------------------------------------------
--  DDL for Package Body CS_INCIDENTS_EXT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CS_INCIDENTS_EXT_PKG" as
/* $Header: csextypb.pls 120.0 2008/02/01 20:14:42 rtripath noship $ */
...
begin
  ...
  close c;
  if (    ((recinfo.C_EXT_ATTR47 = X_C_EXT_ATTR47)
