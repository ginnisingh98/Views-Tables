--------------------------------------------------------
--  DDL for Package Body ONT_D2_PRICE_LIST_ID
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D2_PRICE_LIST_ID" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D2_PRICE_LIST_ID
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D2_PRICE_LIST_ID';
...
BEGIN
    ...
    l_return_value := ONT_AGREEMENT_Def_Util.g_cached_record.PRICE_LIST_ID;
    END IF;
  ...
  END IF;
    ...
    l_return_value := ONT_HEADER_Def_Util.g_cached_record.PRICE_LIST_ID;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
