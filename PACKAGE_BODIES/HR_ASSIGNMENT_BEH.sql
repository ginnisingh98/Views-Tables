--------------------------------------------------------
--  DDL for Package Body HR_ASSIGNMENT_BEH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ASSIGNMENT_BEH" as 
...
p_entries_changed_warning      varchar2) is
  l_event_key number;
  l_event_data clob;
  ...
  --
  l_proc varchar2(72):='  hr_assignment_beH.final_process_cwk_asg_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.assignment.final_process_cwk_asg';
