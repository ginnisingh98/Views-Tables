--------------------------------------------------------
--  DDL for Package Body HR_PHONE_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PHONE_BE3" as 
...
p_person_id                    number) is
  ...
  --
  l_proc varchar2(72):='  hr_phone_be3.delete_phone_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.phone.delete_phone';
