--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_IN_LOCATION
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_IN_LOCATION" as
/*
...
,I_SHIP_TO_LOCATION_ID in varchar2 default 'N') is
...
,P_COUNTRY
,nd(P_SHIP_TO_LOCATION_ID,I_SHIP_TO_LOCATION_ID));
...
hr_in_location_api.update_in_location
