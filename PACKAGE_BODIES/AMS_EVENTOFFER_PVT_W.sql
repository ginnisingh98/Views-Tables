--------------------------------------------------------
--  DDL for Package Body AMS_EVENTOFFER_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AMS_EVENTOFFER_PVT_W" as
  /* $Header: amswevob.pls 115.19 2002/11/16 01:46:58 dbiswas ship $ */
  ...
  begin
    ...
    ddp_evo_rec.event_offer_id := rosetta_g_miss_num_map(p4_a0);
    ddp_evo_rec.last_update_date := rosetta_g_miss_date_in_map(p4_a1);
    ddp_evo_rec.last_updated_by := rosetta_g_miss_num_map(p4_a2);
    ddp_evo_rec.creation_date := rosetta_g_miss_date_in_map(p4_a3);
    ddp_evo_rec.created_by := rosetta_g_miss_num_map(p4_a4);
    ddp_evo_rec.last_update_login := rosetta_g_miss_num_map(p4_a5);
    ddp_evo_rec.object_version_number := rosetta_g_miss_num_map(p4_a6);
    ddp_evo_rec.application_id := rosetta_g_miss_num_map(p4_a7);
    ddp_evo_rec.event_header_id := rosetta_g_miss_num_map(p4_a8);
    ddp_evo_rec.private_flag := p4_a9;
    ddp_evo_rec.active_flag := p4_a10;
    ddp_evo_rec.source_code := p4_a11;
    ddp_evo_rec.event_level := p4_a12;
    ddp_evo_rec.user_status_id := rosetta_g_miss_num_map(p4_a13);
    ddp_evo_rec.last_status_date := rosetta_g_miss_date_in_map(p4_a14);
    ddp_evo_rec.system_status_code := p4_a15;
    ddp_evo_rec.event_type_code := p4_a16;
    ddp_evo_rec.event_delivery_method_id := rosetta_g_miss_num_map(p4_a17);
    ...
    ddp_evo_rec.event_location_id := rosetta_g_miss_num_map(p4_a21);
    ...
    ddp_evo_rec.parent_event_offer_id := rosetta_g_miss_num_map(p4_a35);
    ddp_evo_rec.event_duration := rosetta_g_miss_num_map(p4_a36);
    ddp_evo_rec.event_duration_uom_code := p4_a37;
    ddp_evo_rec.event_start_date := rosetta_g_miss_date_in_map(p4_a38);
    ddp_evo_rec.event_start_date_time := rosetta_g_miss_date_in_map(p4_a39);
    ddp_evo_rec.event_end_date := rosetta_g_miss_date_in_map(p4_a40);
    ddp_evo_rec.event_end_date_time := rosetta_g_miss_date_in_map(p4_a41);
    ddp_evo_rec.reg_start_date := rosetta_g_miss_date_in_map(p4_a42);
    ddp_evo_rec.reg_start_time := rosetta_g_miss_date_in_map(p4_a43);
    ddp_evo_rec.reg_end_date := rosetta_g_miss_date_in_map(p4_a44);
    ddp_evo_rec.reg_end_time := rosetta_g_miss_date_in_map(p4_a45);
    ddp_evo_rec.reg_maximum_capacity := rosetta_g_miss_num_map(p4_a46);
    ddp_evo_rec.reg_overbook_pct := rosetta_g_miss_num_map(p4_a47);
    ddp_evo_rec.reg_effective_capacity := rosetta_g_miss_num_map(p4_a48);
    ddp_evo_rec.reg_waitlist_pct := rosetta_g_miss_num_map(p4_a49);
    ddp_evo_rec.reg_minimum_capacity := rosetta_g_miss_num_map(p4_a50);
    ddp_evo_rec.reg_minimum_req_by_date := rosetta_g_miss_date_in_map(p4_a51);
    ddp_evo_rec.inventory_item_id := rosetta_g_miss_num_map(p4_a52);
    ddp_evo_rec.inventory_item := p4_a53;
    ddp_evo_rec.organization_id := rosetta_g_miss_num_map(p4_a54);
    ddp_evo_rec.pricelist_header_id := rosetta_g_miss_num_map(p4_a55);
    ddp_evo_rec.pricelist_line_id := rosetta_g_miss_num_map(p4_a56);
    ddp_evo_rec.org_id := rosetta_g_miss_num_map(p4_a57);
    ddp_evo_rec.waitlist_action_type_code := p4_a58;
    ddp_evo_rec.stream_type_code := p4_a59;
    ddp_evo_rec.owner_user_id := rosetta_g_miss_num_map(p4_a60);
    ddp_evo_rec.event_full_flag := p4_a61;
    ddp_evo_rec.forecasted_revenue := rosetta_g_miss_num_map(p4_a62);
    ddp_evo_rec.actual_revenue := rosetta_g_miss_num_map(p4_a63);
    ddp_evo_rec.forecasted_cost := rosetta_g_miss_num_map(p4_a64);
    ddp_evo_rec.actual_cost := rosetta_g_miss_num_map(p4_a65);
    ddp_evo_rec.fund_source_type_code := p4_a66;
    ddp_evo_rec.fund_source_id := rosetta_g_miss_num_map(p4_a67);
    ddp_evo_rec.cert_credit_type_code := p4_a68;
    ddp_evo_rec.certification_credits := rosetta_g_miss_num_map(p4_a69);
    ddp_evo_rec.coordinator_id := rosetta_g_miss_num_map(p4_a70);
    ...
    ddp_evo_rec.fund_amount_tc := rosetta_g_miss_num_map(p4_a76);
    ddp_evo_rec.fund_amount_fc := rosetta_g_miss_num_map(p4_a77);
    ddp_evo_rec.currency_code_tc := p4_a78;
    ddp_evo_rec.currency_code_fc := p4_a79;
    ddp_evo_rec.url := p4_a80;
    ddp_evo_rec.timezone_id := rosetta_g_miss_num_map(p4_a81);
    ddp_evo_rec.event_venue_id := rosetta_g_miss_num_map(p4_a82);
    ddp_evo_rec.pricelist_header_currency_code := p4_a83;
    ddp_evo_rec.pricelist_list_price := rosetta_g_miss_num_map(p4_a84);
    ...
    ddp_evo_rec.custom_setup_id := rosetta_g_miss_num_map(p4_a105);
    ddp_evo_rec.country_code := p4_a106;
    ddp_evo_rec.business_unit_id := rosetta_g_miss_num_map(p4_a107);
    ...
    ddp_evo_rec.task_id := rosetta_g_miss_num_map(p4_a112);
    ddp_evo_rec.parent_type := p4_a113;
    ddp_evo_rec.parent_id := rosetta_g_miss_num_map(p4_a114);
    ...
    ddp_evo_rec.reg_timezone_id := rosetta_g_miss_num_map(p4_a118);
    ...
    ddp_evo_rec.actual_start_time := rosetta_g_miss_date_in_map(p4_a125);
    ddp_evo_rec.actual_end_time := rosetta_g_miss_date_in_map(p4_a126);
    ddp_evo_rec.server_id := rosetta_g_miss_num_map(p4_a127);
    ddp_evo_rec.owner_fnd_user_id := rosetta_g_miss_num_map(p4_a128);
    ...
    ddp_evo_rec.number_of_attendees := rosetta_g_miss_num_map(p4_a136);
  ...
  begin
    ...
    ddp_evo_rec.event_offer_id := rosetta_g_miss_num_map(p3_a0);
    ddp_evo_rec.last_update_date := rosetta_g_miss_date_in_map(p3_a1);
    ddp_evo_rec.last_updated_by := rosetta_g_miss_num_map(p3_a2);
    ddp_evo_rec.creation_date := rosetta_g_miss_date_in_map(p3_a3);
    ddp_evo_rec.created_by := rosetta_g_miss_num_map(p3_a4);
    ddp_evo_rec.last_update_login := rosetta_g_miss_num_map(p3_a5);
    ddp_evo_rec.object_version_number := rosetta_g_miss_num_map(p3_a6);
    ddp_evo_rec.application_id := rosetta_g_miss_num_map(p3_a7);
    ddp_evo_rec.event_header_id := rosetta_g_miss_num_map(p3_a8);
    ddp_evo_rec.private_flag := p3_a9;
    ddp_evo_rec.active_flag := p3_a10;
    ddp_evo_rec.source_code := p3_a11;
    ddp_evo_rec.event_level := p3_a12;
    ddp_evo_rec.user_status_id := rosetta_g_miss_num_map(p3_a13);
    ddp_evo_rec.last_status_date := rosetta_g_miss_date_in_map(p3_a14);
    ddp_evo_rec.system_status_code := p3_a15;
    ddp_evo_rec.event_type_code := p3_a16;
    ddp_evo_rec.event_delivery_method_id := rosetta_g_miss_num_map(p3_a17);
    ...
    ddp_evo_rec.event_location_id := rosetta_g_miss_num_map(p3_a21);
    ...
    ddp_evo_rec.parent_event_offer_id := rosetta_g_miss_num_map(p3_a35);
    ddp_evo_rec.event_duration := rosetta_g_miss_num_map(p3_a36);
    ddp_evo_rec.event_duration_uom_code := p3_a37;
    ddp_evo_rec.event_start_date := rosetta_g_miss_date_in_map(p3_a38);
    ddp_evo_rec.event_start_date_time := rosetta_g_miss_date_in_map(p3_a39);
    ddp_evo_rec.event_end_date := rosetta_g_miss_date_in_map(p3_a40);
    ddp_evo_rec.event_end_date_time := rosetta_g_miss_date_in_map(p3_a41);
    ddp_evo_rec.reg_start_date := rosetta_g_miss_date_in_map(p3_a42);
    ddp_evo_rec.reg_start_time := rosetta_g_miss_date_in_map(p3_a43);
    ddp_evo_rec.reg_end_date := rosetta_g_miss_date_in_map(p3_a44);
    ddp_evo_rec.reg_end_time := rosetta_g_miss_date_in_map(p3_a45);
    ddp_evo_rec.reg_maximum_capacity := rosetta_g_miss_num_map(p3_a46);
    ddp_evo_rec.reg_overbook_pct := rosetta_g_miss_num_map(p3_a47);
    ddp_evo_rec.reg_effective_capacity := rosetta_g_miss_num_map(p3_a48);
    ddp_evo_rec.reg_waitlist_pct := rosetta_g_miss_num_map(p3_a49);
    ddp_evo_rec.reg_minimum_capacity := rosetta_g_miss_num_map(p3_a50);
    ddp_evo_rec.reg_minimum_req_by_date := rosetta_g_miss_date_in_map(p3_a51);
    ddp_evo_rec.inventory_item_id := rosetta_g_miss_num_map(p3_a52);
    ddp_evo_rec.inventory_item := p3_a53;
    ddp_evo_rec.organization_id := rosetta_g_miss_num_map(p3_a54);
    ddp_evo_rec.pricelist_header_id := rosetta_g_miss_num_map(p3_a55);
    ddp_evo_rec.pricelist_line_id := rosetta_g_miss_num_map(p3_a56);
    ddp_evo_rec.org_id := rosetta_g_miss_num_map(p3_a57);
    ddp_evo_rec.waitlist_action_type_code := p3_a58;
    ddp_evo_rec.stream_type_code := p3_a59;
    ddp_evo_rec.owner_user_id := rosetta_g_miss_num_map(p3_a60);
    ddp_evo_rec.event_full_flag := p3_a61;
    ddp_evo_rec.forecasted_revenue := rosetta_g_miss_num_map(p3_a62);
    ddp_evo_rec.actual_revenue := rosetta_g_miss_num_map(p3_a63);
    ddp_evo_rec.forecasted_cost := rosetta_g_miss_num_map(p3_a64);
    ddp_evo_rec.actual_cost := rosetta_g_miss_num_map(p3_a65);
    ddp_evo_rec.fund_source_type_code := p3_a66;
    ddp_evo_rec.fund_source_id := rosetta_g_miss_num_map(p3_a67);
    ddp_evo_rec.cert_credit_type_code := p3_a68;
    ddp_evo_rec.certification_credits := rosetta_g_miss_num_map(p3_a69);
    ddp_evo_rec.coordinator_id := rosetta_g_miss_num_map(p3_a70);
    ...
    ddp_evo_rec.fund_amount_tc := rosetta_g_miss_num_map(p3_a76);
    ddp_evo_rec.fund_amount_fc := rosetta_g_miss_num_map(p3_a77);
    ddp_evo_rec.currency_code_tc := p3_a78;
    ddp_evo_rec.currency_code_fc := p3_a79;
    ddp_evo_rec.url := p3_a80;
    ddp_evo_rec.timezone_id := rosetta_g_miss_num_map(p3_a81);
    ddp_evo_rec.event_venue_id := rosetta_g_miss_num_map(p3_a82);
    ddp_evo_rec.pricelist_header_currency_code := p3_a83;
    ddp_evo_rec.pricelist_list_price := rosetta_g_miss_num_map(p3_a84);
    ...
    ddp_evo_rec.custom_setup_id := rosetta_g_miss_num_map(p3_a105);
    ddp_evo_rec.country_code := p3_a106;
    ddp_evo_rec.business_unit_id := rosetta_g_miss_num_map(p3_a107);
    ...
    ddp_evo_rec.task_id := rosetta_g_miss_num_map(p3_a112);
    ddp_evo_rec.parent_type := p3_a113;
    ddp_evo_rec.parent_id := rosetta_g_miss_num_map(p3_a114);
    ...
    ddp_evo_rec.reg_timezone_id := rosetta_g_miss_num_map(p3_a118);
    ...
    ddp_evo_rec.actual_start_time := rosetta_g_miss_date_in_map(p3_a125);
    ddp_evo_rec.actual_end_time := rosetta_g_miss_date_in_map(p3_a126);
    ddp_evo_rec.server_id := rosetta_g_miss_num_map(p3_a127);
    ddp_evo_rec.owner_fnd_user_id := rosetta_g_miss_num_map(p3_a128);
    ...
    ddp_evo_rec.number_of_attendees := rosetta_g_miss_num_map(p3_a136);
  ...
  begin
    ...
    -- copy data to the local IN or IN-OUT args, if any
    ddp_evo_rec.event_offer_id := rosetta_g_miss_num_map(p0_a0);
    ddp_evo_rec.last_update_date := rosetta_g_miss_date_in_map(p0_a1);
    ddp_evo_rec.last_updated_by := rosetta_g_miss_num_map(p0_a2);
    ddp_evo_rec.creation_date := rosetta_g_miss_date_in_map(p0_a3);
    ddp_evo_rec.created_by := rosetta_g_miss_num_map(p0_a4);
    ddp_evo_rec.last_update_login := rosetta_g_miss_num_map(p0_a5);
    ddp_evo_rec.object_version_number := rosetta_g_miss_num_map(p0_a6);
    ddp_evo_rec.application_id := rosetta_g_miss_num_map(p0_a7);
    ddp_evo_rec.event_header_id := rosetta_g_miss_num_map(p0_a8);
    ddp_evo_rec.private_flag := p0_a9;
    ddp_evo_rec.active_flag := p0_a10;
    ddp_evo_rec.source_code := p0_a11;
    ddp_evo_rec.event_level := p0_a12;
    ddp_evo_rec.user_status_id := rosetta_g_miss_num_map(p0_a13);
    ddp_evo_rec.last_status_date := rosetta_g_miss_date_in_map(p0_a14);
    ddp_evo_rec.system_status_code := p0_a15;
    ddp_evo_rec.event_type_code := p0_a16;
    ddp_evo_rec.event_delivery_method_id := rosetta_g_miss_num_map(p0_a17);
    ...
    ddp_evo_rec.event_location_id := rosetta_g_miss_num_map(p0_a21);
    ...
    ddp_evo_rec.parent_event_offer_id := rosetta_g_miss_num_map(p0_a35);
    ddp_evo_rec.event_duration := rosetta_g_miss_num_map(p0_a36);
    ddp_evo_rec.event_duration_uom_code := p0_a37;
    ddp_evo_rec.event_start_date := rosetta_g_miss_date_in_map(p0_a38);
    ddp_evo_rec.event_start_date_time := rosetta_g_miss_date_in_map(p0_a39);
    ddp_evo_rec.event_end_date := rosetta_g_miss_date_in_map(p0_a40);
    ddp_evo_rec.event_end_date_time := rosetta_g_miss_date_in_map(p0_a41);
    ddp_evo_rec.reg_start_date := rosetta_g_miss_date_in_map(p0_a42);
    ddp_evo_rec.reg_start_time := rosetta_g_miss_date_in_map(p0_a43);
    ddp_evo_rec.reg_end_date := rosetta_g_miss_date_in_map(p0_a44);
    ddp_evo_rec.reg_end_time := rosetta_g_miss_date_in_map(p0_a45);
    ddp_evo_rec.reg_maximum_capacity := rosetta_g_miss_num_map(p0_a46);
    ddp_evo_rec.reg_overbook_pct := rosetta_g_miss_num_map(p0_a47);
    ddp_evo_rec.reg_effective_capacity := rosetta_g_miss_num_map(p0_a48);
    ddp_evo_rec.reg_waitlist_pct := rosetta_g_miss_num_map(p0_a49);
    ddp_evo_rec.reg_minimum_capacity := rosetta_g_miss_num_map(p0_a50);
    ddp_evo_rec.reg_minimum_req_by_date := rosetta_g_miss_date_in_map(p0_a51);
    ddp_evo_rec.inventory_item_id := rosetta_g_miss_num_map(p0_a52);
    ddp_evo_rec.inventory_item := p0_a53;
    ddp_evo_rec.organization_id := rosetta_g_miss_num_map(p0_a54);
    ddp_evo_rec.pricelist_header_id := rosetta_g_miss_num_map(p0_a55);
    ddp_evo_rec.pricelist_line_id := rosetta_g_miss_num_map(p0_a56);
    ddp_evo_rec.org_id := rosetta_g_miss_num_map(p0_a57);
    ddp_evo_rec.waitlist_action_type_code := p0_a58;
    ddp_evo_rec.stream_type_code := p0_a59;
    ddp_evo_rec.owner_user_id := rosetta_g_miss_num_map(p0_a60);
    ddp_evo_rec.event_full_flag := p0_a61;
    ddp_evo_rec.forecasted_revenue := rosetta_g_miss_num_map(p0_a62);
    ddp_evo_rec.actual_revenue := rosetta_g_miss_num_map(p0_a63);
    ddp_evo_rec.forecasted_cost := rosetta_g_miss_num_map(p0_a64);
    ddp_evo_rec.actual_cost := rosetta_g_miss_num_map(p0_a65);
    ddp_evo_rec.fund_source_type_code := p0_a66;
    ddp_evo_rec.fund_source_id := rosetta_g_miss_num_map(p0_a67);
    ddp_evo_rec.cert_credit_type_code := p0_a68;
    ddp_evo_rec.certification_credits := rosetta_g_miss_num_map(p0_a69);
    ddp_evo_rec.coordinator_id := rosetta_g_miss_num_map(p0_a70);
    ...
    ddp_evo_rec.fund_amount_tc := rosetta_g_miss_num_map(p0_a76);
    ddp_evo_rec.fund_amount_fc := rosetta_g_miss_num_map(p0_a77);
    ddp_evo_rec.currency_code_tc := p0_a78;
    ddp_evo_rec.currency_code_fc := p0_a79;
    ddp_evo_rec.url := p0_a80;
    ddp_evo_rec.timezone_id := rosetta_g_miss_num_map(p0_a81);
    ddp_evo_rec.event_venue_id := rosetta_g_miss_num_map(p0_a82);
    ddp_evo_rec.pricelist_header_currency_code := p0_a83;
    ddp_evo_rec.pricelist_list_price := rosetta_g_miss_num_map(p0_a84);
    ...
    ddp_evo_rec.custom_setup_id := rosetta_g_miss_num_map(p0_a105);
    ddp_evo_rec.country_code := p0_a106;
    ddp_evo_rec.business_unit_id := rosetta_g_miss_num_map(p0_a107);
    ...
    ddp_evo_rec.task_id := rosetta_g_miss_num_map(p0_a112);
    ddp_evo_rec.parent_type := p0_a113;
    ddp_evo_rec.parent_id := rosetta_g_miss_num_map(p0_a114);
    ...
    ddp_evo_rec.reg_timezone_id := rosetta_g_miss_num_map(p0_a118);
    ...
    ddp_evo_rec.actual_start_time := rosetta_g_miss_date_in_map(p0_a125);
    ddp_evo_rec.actual_end_time := rosetta_g_miss_date_in_map(p0_a126);
    ddp_evo_rec.server_id := rosetta_g_miss_num_map(p0_a127);
    ddp_evo_rec.owner_fnd_user_id := rosetta_g_miss_num_map(p0_a128);
    ...
    ddp_evo_rec.number_of_attendees := rosetta_g_miss_num_map(p0_a136);
  ...
  begin
    ...
    ddp_complete_rec.event_offer_id := rosetta_g_miss_num_map(p1_a0);
    ...
    ddp_complete_rec.event_header_id := rosetta_g_miss_num_map(p1_a8);
    ...
    ddp_complete_rec.user_status_id := rosetta_g_miss_num_map(p1_a13);
    ...
    ddp_complete_rec.event_delivery_method_id := rosetta_g_miss_num_map(p1_a17);
    ...
    ddp_complete_rec.event_location_id := rosetta_g_miss_num_map(p1_a21);
    ...
    ddp_complete_rec.parent_event_offer_id := rosetta_g_miss_num_map(p1_a35);
    ddp_complete_rec.event_duration := rosetta_g_miss_num_map(p1_a36);
    ddp_complete_rec.event_duration_uom_code := p1_a37;
    ddp_complete_rec.event_start_date := rosetta_g_miss_date_in_map(p1_a38);
    ddp_complete_rec.event_start_date_time := rosetta_g_miss_date_in_map(p1_a39);
    ddp_complete_rec.event_end_date := rosetta_g_miss_date_in_map(p1_a40);
    ddp_complete_rec.event_end_date_time := rosetta_g_miss_date_in_map(p1_a41);
    ddp_complete_rec.reg_start_date := rosetta_g_miss_date_in_map(p1_a42);
    ddp_complete_rec.reg_start_time := rosetta_g_miss_date_in_map(p1_a43);
    ddp_complete_rec.reg_end_date := rosetta_g_miss_date_in_map(p1_a44);
    ddp_complete_rec.reg_end_time := rosetta_g_miss_date_in_map(p1_a45);
    ddp_complete_rec.reg_maximum_capacity := rosetta_g_miss_num_map(p1_a46);
    ddp_complete_rec.reg_overbook_pct := rosetta_g_miss_num_map(p1_a47);
    ddp_complete_rec.reg_effective_capacity := rosetta_g_miss_num_map(p1_a48);
    ddp_complete_rec.reg_waitlist_pct := rosetta_g_miss_num_map(p1_a49);
    ddp_complete_rec.reg_minimum_capacity := rosetta_g_miss_num_map(p1_a50);
    ddp_complete_rec.reg_minimum_req_by_date := rosetta_g_miss_date_in_map(p1_a51);
    ddp_complete_rec.inventory_item_id := rosetta_g_miss_num_map(p1_a52);
    ddp_complete_rec.inventory_item := p1_a53;
    ddp_complete_rec.organization_id := rosetta_g_miss_num_map(p1_a54);
    ddp_complete_rec.pricelist_header_id := rosetta_g_miss_num_map(p1_a55);
    ddp_complete_rec.pricelist_line_id := rosetta_g_miss_num_map(p1_a56);
    ddp_complete_rec.org_id := rosetta_g_miss_num_map(p1_a57);
    ddp_complete_rec.waitlist_action_type_code := p1_a58;
    ddp_complete_rec.stream_type_code := p1_a59;
    ddp_complete_rec.owner_user_id := rosetta_g_miss_num_map(p1_a60);
    ddp_complete_rec.event_full_flag := p1_a61;
    ddp_complete_rec.forecasted_revenue := rosetta_g_miss_num_map(p1_a62);
    ddp_complete_rec.actual_revenue := rosetta_g_miss_num_map(p1_a63);
    ddp_complete_rec.forecasted_cost := rosetta_g_miss_num_map(p1_a64);
    ddp_complete_rec.actual_cost := rosetta_g_miss_num_map(p1_a65);
    ddp_complete_rec.fund_source_type_code := p1_a66;
    ddp_complete_rec.fund_source_id := rosetta_g_miss_num_map(p1_a67);
    ddp_complete_rec.cert_credit_type_code := p1_a68;
    ddp_complete_rec.certification_credits := rosetta_g_miss_num_map(p1_a69);
    ddp_complete_rec.coordinator_id := rosetta_g_miss_num_map(p1_a70);
    ...
    ddp_complete_rec.fund_amount_tc := rosetta_g_miss_num_map(p1_a76);
    ddp_complete_rec.fund_amount_fc := rosetta_g_miss_num_map(p1_a77);
    ddp_complete_rec.currency_code_tc := p1_a78;
    ddp_complete_rec.currency_code_fc := p1_a79;
    ddp_complete_rec.url := p1_a80;
    ddp_complete_rec.timezone_id := rosetta_g_miss_num_map(p1_a81);
    ddp_complete_rec.event_venue_id := rosetta_g_miss_num_map(p1_a82);
    ddp_complete_rec.pricelist_header_currency_code := p1_a83;
    ddp_complete_rec.pricelist_list_price := rosetta_g_miss_num_map(p1_a84);
    ...
    ddp_complete_rec.custom_setup_id := rosetta_g_miss_num_map(p1_a105);
    ddp_complete_rec.country_code := p1_a106;
    ddp_complete_rec.business_unit_id := rosetta_g_miss_num_map(p1_a107);
    ...
    ddp_complete_rec.task_id := rosetta_g_miss_num_map(p1_a112);
    ddp_complete_rec.parent_type := p1_a113;
    ddp_complete_rec.parent_id := rosetta_g_miss_num_map(p1_a114);
    ...
    ddp_complete_rec.reg_timezone_id := rosetta_g_miss_num_map(p1_a118);
    ...
    ddp_complete_rec.actual_start_time := rosetta_g_miss_date_in_map(p1_a125);
    ddp_complete_rec.actual_end_time := rosetta_g_miss_date_in_map(p1_a126);
    ddp_complete_rec.server_id := rosetta_g_miss_num_map(p1_a127);
    ddp_complete_rec.owner_fnd_user_id := rosetta_g_miss_num_map(p1_a128);
    ...
    ddp_complete_rec.number_of_attendees := rosetta_g_miss_num_map(p1_a136);
  ...
  begin
    ...
    -- copy data back from the local OUT or IN-OUT args, if any
    p0_a0 := rosetta_g_miss_num_map(ddx_evo_rec.event_offer_id);
    p0_a1 := ddx_evo_rec.last_update_date;
    p0_a2 := rosetta_g_miss_num_map(ddx_evo_rec.last_updated_by);
    p0_a3 := ddx_evo_rec.creation_date;
    p0_a4 := rosetta_g_miss_num_map(ddx_evo_rec.created_by);
    p0_a5 := rosetta_g_miss_num_map(ddx_evo_rec.last_update_login);
    p0_a6 := rosetta_g_miss_num_map(ddx_evo_rec.object_version_number);
    p0_a7 := rosetta_g_miss_num_map(ddx_evo_rec.application_id);
    p0_a8 := rosetta_g_miss_num_map(ddx_evo_rec.event_header_id);
    p0_a9 := ddx_evo_rec.private_flag;
    p0_a10 := ddx_evo_rec.active_flag;
    p0_a11 := ddx_evo_rec.source_code;
    p0_a12 := ddx_evo_rec.event_level;
    p0_a13 := rosetta_g_miss_num_map(ddx_evo_rec.user_status_id);
    p0_a14 := ddx_evo_rec.last_status_date;
    p0_a15 := ddx_evo_rec.system_status_code;
    p0_a16 := ddx_evo_rec.event_type_code;
    p0_a17 := rosetta_g_miss_num_map(ddx_evo_rec.event_delivery_method_id);
    ...
    p0_a21 := rosetta_g_miss_num_map(ddx_evo_rec.event_location_id);
    ...
    p0_a35 := rosetta_g_miss_num_map(ddx_evo_rec.parent_event_offer_id);
    p0_a36 := rosetta_g_miss_num_map(ddx_evo_rec.event_duration);
    ...
    p0_a46 := rosetta_g_miss_num_map(ddx_evo_rec.reg_maximum_capacity);
    p0_a47 := rosetta_g_miss_num_map(ddx_evo_rec.reg_overbook_pct);
    p0_a48 := rosetta_g_miss_num_map(ddx_evo_rec.reg_effective_capacity);
    p0_a49 := rosetta_g_miss_num_map(ddx_evo_rec.reg_waitlist_pct);
    p0_a50 := rosetta_g_miss_num_map(ddx_evo_rec.reg_minimum_capacity);
    p0_a51 := ddx_evo_rec.reg_minimum_req_by_date;
    p0_a52 := rosetta_g_miss_num_map(ddx_evo_rec.inventory_item_id);
    p0_a53 := ddx_evo_rec.inventory_item;
    p0_a54 := rosetta_g_miss_num_map(ddx_evo_rec.organization_id);
    p0_a55 := rosetta_g_miss_num_map(ddx_evo_rec.pricelist_header_id);
    p0_a56 := rosetta_g_miss_num_map(ddx_evo_rec.pricelist_line_id);
    p0_a57 := rosetta_g_miss_num_map(ddx_evo_rec.org_id);
    p0_a58 := ddx_evo_rec.waitlist_action_type_code;
    p0_a59 := ddx_evo_rec.stream_type_code;
    p0_a60 := rosetta_g_miss_num_map(ddx_evo_rec.owner_user_id);
    p0_a61 := ddx_evo_rec.event_full_flag;
    p0_a62 := rosetta_g_miss_num_map(ddx_evo_rec.forecasted_revenue);
    p0_a63 := rosetta_g_miss_num_map(ddx_evo_rec.actual_revenue);
    p0_a64 := rosetta_g_miss_num_map(ddx_evo_rec.forecasted_cost);
    p0_a65 := rosetta_g_miss_num_map(ddx_evo_rec.actual_cost);
    p0_a66 := ddx_evo_rec.fund_source_type_code;
    p0_a67 := rosetta_g_miss_num_map(ddx_evo_rec.fund_source_id);
    p0_a68 := ddx_evo_rec.cert_credit_type_code;
    p0_a69 := rosetta_g_miss_num_map(ddx_evo_rec.certification_credits);
    p0_a70 := rosetta_g_miss_num_map(ddx_evo_rec.coordinator_id);
    ...
    p0_a76 := rosetta_g_miss_num_map(ddx_evo_rec.fund_amount_tc);
    p0_a77 := rosetta_g_miss_num_map(ddx_evo_rec.fund_amount_fc);
    p0_a78 := ddx_evo_rec.currency_code_tc;
    p0_a79 := ddx_evo_rec.currency_code_fc;
    p0_a80 := ddx_evo_rec.url;
    p0_a81 := rosetta_g_miss_num_map(ddx_evo_rec.timezone_id);
    p0_a82 := rosetta_g_miss_num_map(ddx_evo_rec.event_venue_id);
    p0_a83 := ddx_evo_rec.pricelist_header_currency_code;
    p0_a84 := rosetta_g_miss_num_map(ddx_evo_rec.pricelist_list_price);
    ...
    p0_a105 := rosetta_g_miss_num_map(ddx_evo_rec.custom_setup_id);
    p0_a106 := ddx_evo_rec.country_code;
    p0_a107 := rosetta_g_miss_num_map(ddx_evo_rec.business_unit_id);
    ...
    p0_a112 := rosetta_g_miss_num_map(ddx_evo_rec.task_id);
    p0_a113 := ddx_evo_rec.parent_type;
    p0_a114 := rosetta_g_miss_num_map(ddx_evo_rec.parent_id);
    ...
    p0_a118 := rosetta_g_miss_num_map(ddx_evo_rec.reg_timezone_id);
    ...
    p0_a127 := rosetta_g_miss_num_map(ddx_evo_rec.server_id);
    p0_a128 := rosetta_g_miss_num_map(ddx_evo_rec.owner_fnd_user_id);
    ...
    p0_a136 := rosetta_g_miss_num_map(ddx_evo_rec.number_of_attendees);
  ...
  begin
    ...
    p1_a0 := rosetta_g_miss_num_map(ddx_complete_rec.event_offer_id);
    ...
    p1_a7 := rosetta_g_miss_num_map(ddx_complete_rec.application_id);
    p1_a8 := rosetta_g_miss_num_map(ddx_complete_rec.event_header_id);
    ...
    p1_a17 := rosetta_g_miss_num_map(ddx_complete_rec.event_delivery_method_id);
    ...
    p1_a21 := rosetta_g_miss_num_map(ddx_complete_rec.event_location_id);
    ...
    p1_a35 := rosetta_g_miss_num_map(ddx_complete_rec.parent_event_offer_id);
    p1_a36 := rosetta_g_miss_num_map(ddx_complete_rec.event_duration);
    ...
    p1_a46 := rosetta_g_miss_num_map(ddx_complete_rec.reg_maximum_capacity);
    p1_a47 := rosetta_g_miss_num_map(ddx_complete_rec.reg_overbook_pct);
    p1_a48 := rosetta_g_miss_num_map(ddx_complete_rec.reg_effective_capacity);
    p1_a49 := rosetta_g_miss_num_map(ddx_complete_rec.reg_waitlist_pct);
    p1_a50 := rosetta_g_miss_num_map(ddx_complete_rec.reg_minimum_capacity);
    p1_a51 := ddx_complete_rec.reg_minimum_req_by_date;
    p1_a52 := rosetta_g_miss_num_map(ddx_complete_rec.inventory_item_id);
    p1_a53 := ddx_complete_rec.inventory_item;
    p1_a54 := rosetta_g_miss_num_map(ddx_complete_rec.organization_id);
    p1_a55 := rosetta_g_miss_num_map(ddx_complete_rec.pricelist_header_id);
    p1_a56 := rosetta_g_miss_num_map(ddx_complete_rec.pricelist_line_id);
    p1_a57 := rosetta_g_miss_num_map(ddx_complete_rec.org_id);
    p1_a58 := ddx_complete_rec.waitlist_action_type_code;
    p1_a59 := ddx_complete_rec.stream_type_code;
    p1_a60 := rosetta_g_miss_num_map(ddx_complete_rec.owner_user_id);
    p1_a61 := ddx_complete_rec.event_full_flag;
    p1_a62 := rosetta_g_miss_num_map(ddx_complete_rec.forecasted_revenue);
    p1_a63 := rosetta_g_miss_num_map(ddx_complete_rec.actual_revenue);
    p1_a64 := rosetta_g_miss_num_map(ddx_complete_rec.forecasted_cost);
    p1_a65 := rosetta_g_miss_num_map(ddx_complete_rec.actual_cost);
    p1_a66 := ddx_complete_rec.fund_source_type_code;
    p1_a67 := rosetta_g_miss_num_map(ddx_complete_rec.fund_source_id);
    p1_a68 := ddx_complete_rec.cert_credit_type_code;
    p1_a69 := rosetta_g_miss_num_map(ddx_complete_rec.certification_credits);
    p1_a70 := rosetta_g_miss_num_map(ddx_complete_rec.coordinator_id);
    ...
    p1_a76 := rosetta_g_miss_num_map(ddx_complete_rec.fund_amount_tc);
    p1_a77 := rosetta_g_miss_num_map(ddx_complete_rec.fund_amount_fc);
    p1_a78 := ddx_complete_rec.currency_code_tc;
    p1_a79 := ddx_complete_rec.currency_code_fc;
    p1_a80 := ddx_complete_rec.url;
    p1_a81 := rosetta_g_miss_num_map(ddx_complete_rec.timezone_id);
    p1_a82 := rosetta_g_miss_num_map(ddx_complete_rec.event_venue_id);
    p1_a83 := ddx_complete_rec.pricelist_header_currency_code;
    p1_a84 := rosetta_g_miss_num_map(ddx_complete_rec.pricelist_list_price);
    ...
    p1_a105 := rosetta_g_miss_num_map(ddx_complete_rec.custom_setup_id);
    p1_a106 := ddx_complete_rec.country_code;
    p1_a107 := rosetta_g_miss_num_map(ddx_complete_rec.business_unit_id);
    ...
    p1_a112 := rosetta_g_miss_num_map(ddx_complete_rec.task_id);
    p1_a113 := ddx_complete_rec.parent_type;
    p1_a114 := rosetta_g_miss_num_map(ddx_complete_rec.parent_id);
    ...
    p1_a118 := rosetta_g_miss_num_map(ddx_complete_rec.reg_timezone_id);
    ...
    p1_a127 := rosetta_g_miss_num_map(ddx_complete_rec.server_id);
    p1_a128 := rosetta_g_miss_num_map(ddx_complete_rec.owner_fnd_user_id);
    ...
    p1_a136 := rosetta_g_miss_num_map(ddx_complete_rec.number_of_attendees);
