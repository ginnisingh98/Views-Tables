--------------------------------------------------------
--  DDL for Package Body HR_AU_ASSIGNMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_AU_ASSIGNMENT_API" AS
/* $Header: hrauwrsa.pkb 115.5 2002/12/03 10:44:22 apunekar ship $ */
/*
 +==========================================================================================
 |              Copyright (c) 1999 Oracle Corporation Ltd
 |                           All rights reserved.
 +==========================================================================================
 |SQL Script File Name : HR AU WR AS . PKB
 |                Name : hr_au_assignment_api
 |         Description : Assignment API Wrapper for AU
 |
 |   Name           Date         Version Bug     Text
 |   -------------- ----------   ------- -----   ----
 |   sgoggin        11-JUN-1999  110.0           Created for AU
 |   atopol         01-OCT-1999  115.0           Upgraded
 |   sclarke        09-FEB-2000  115.1   1177545 Added Group Certificate Issue date segment
 |   makelly        28-MAR-2000  115.2           Added extra params for overloading in core api
 |   rsinghal       23-JAN-2001  115.3   1560081 added hours worked per week segment
 |   apunekar       02-DEC-2002  115.5   2689173 Added Nocopy to out and in out parameters
 |NOTES
 +==========================================================================================
*/

g_package  VARCHAR2(33) := 'hr_au_assignment_api.';
--
-- ----------------------------------------------------------------------------
...
PROCEDURE create_au_secondary_emp_asg
  ...
  l_proc               VARCHAR2(72) := g_package||'create_au_secondary_emp_asg';
  --
  -- Declare cursors
  --
...
BEGIN
  ...
  --
  -- Ensure that the employee IS within a au business group
  --
  ...
  ,p_scl_segment2                 =>     p_lev_lod_flg
  ,p_scl_segment3                 =>     p_group_cert_issue_date
  ,p_scl_segment4                 =>     p_hrs_worked_per_week
  ...
  --
  END create_au_secondary_emp_asg;
  ...
  IS
    ...
    -- Declare cursors AND local variables
    --
    l_proc                       VARCHAR2(72) := g_package||'update_au_emp_asg';
    l_effective_date             DATE;
    l_legislation_code           per_business_groups.legislation_code%TYPE;
    l_business_group_id          per_business_groups.business_group_id%type;
    a              varchar2(100);
  ...
  BEGIN
    ...
    --
      ...
      ,p_segment2                     => p_lev_lod_flg
      ,p_segment3                     => p_group_cert_issue_date
      ,p_segment4                     => p_hrs_worked_per_week
      ,p_contract_id                  => p_contract_id
      ,p_establishment_id             => p_establishment_id
      ,p_collective_agreement_id      => p_collective_agreement_id
      ,p_cagr_id_flex_num             => p_cagr_id_flex_num
