--------------------------------------------------------
--  DDL for Package Body PER_MEDICAL_ASSESSMENT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_MEDICAL_ASSESSMENT_BK2" as
...
begin
hr_utility.set_location('Entering: PER_MEDICAL_ASSESSMENT_BK2.UPDATE_MEDICAL_ASSESSMENT_A', 10);
hr_utility.set_location(' Leaving: PER_MEDICAL_ASSESSMENT_BK2.UPDATE_MEDICAL_ASSESSMENT_A', 20);
end UPDATE_MEDICAL_ASSESSMENT_A;
...
begin
hr_utility.set_location('Entering: PER_MEDICAL_ASSESSMENT_BK2.UPDATE_MEDICAL_ASSESSMENT_B', 10);
hr_utility.set_location(' Leaving: PER_MEDICAL_ASSESSMENT_BK2.UPDATE_MEDICAL_ASSESSMENT_B', 20);
end UPDATE_MEDICAL_ASSESSMENT_B;
