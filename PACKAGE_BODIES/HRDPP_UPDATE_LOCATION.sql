--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_LOCATION
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_LOCATION" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:25
 * Generated for API: HR_LOCATION_API.UPDATE_LOCATION
 */
--
...
,I_TP_HEADER_ID in varchar2 default 'N'
...
,I_OPERATING_UNIT_ID in varchar2 default 'N'
,P_INVENTORY_ORGANIZATION_ID in number default null
,I_INVENTORY_ORGANIZATION_ID in varchar2 default 'N'
...
,P_DESCRIPTION
,P_TIMEZONE_CODE
,nd(P_TP_HEADER_ID,I_TP_HEADER_ID)
...
,dd(P_INACTIVE_DATE,I_INACTIVE_DATE)
,nd(P_OPERATING_UNIT_ID,I_OPERATING_UNIT_ID)
,nd(P_INVENTORY_ORGANIZATION_ID,I_INVENTORY_ORGANIZATION_ID)
,P_OFFICE_SITE_FLAG
,P_POSTAL_CODE
...
L_SHIP_TO_LOCATION_ID:=nh;
else
L_SHIP_TO_LOCATION_ID := 
hr_pump_get.get_ship_to_location_id
(P_SHIP_TO_LOCATION_CODE => c.p81
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_LANGUAGE_CODE => c.p2);
end if;
--
if c.p3 is null then
L_OBJECT_VERSION_NUMBER:=nn;
else
L_OBJECT_VERSION_NUMBER := 
hr_pump_get.GET_LOC_OVN
(P_LOCATION_CODE => c.p3);
end if;
--
