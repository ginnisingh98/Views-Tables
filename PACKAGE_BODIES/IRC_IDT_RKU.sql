--------------------------------------------------------
--  DDL for Package Body IRC_IDT_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_IDT_RKU" as
/* $Header: iridtrhi.pkb 120.0 2005/07/26 15:07:27 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/01/04 09:06:31 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: IRC_IDT_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: IRC_IDT_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end IRC_IDT_RKU;
