--------------------------------------------------------
--  DDL for Package Body PER_SLT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_SLT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_slt_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the per_solution_types Row
  --
  update per_solution_types
    set
     solution_type_name              = p_rec.solution_type_name
    ,solution_category               = p_rec.solution_category
...
Begin
  ...
  --
  If (p_rec.solution_category = hr_api.g_varchar2) then
    p_rec.solution_category :=
    per_slt_shd.g_old_rec.solution_category;
  End If;
...
Begin
  ...
  --
  per_slt_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  per_slt_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  per_slt_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
