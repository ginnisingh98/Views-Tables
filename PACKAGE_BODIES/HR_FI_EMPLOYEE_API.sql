--------------------------------------------------------
--  DDL for Package Body HR_FI_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_FI_EMPLOYEE_API" as
/* $Header: peempfii.pkb 120.1.12000000.2 2007/02/14 12:25:01 dbehera ship $ */
--
  g_package  varchar2(33) := 'hr_fi_employee_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_fi_employee >------------------------------|
-- -----------------------------------------------------------------------------
...
is
    ...
    l_proc                 VARCHAR2(72) := g_package||'create_fi_employee';
  ...
  if p_membership_start_date is not null and p_membership_end_date is not null and
    ...
    hr_employee_api.create_employee
      ...
      ,p_per_information14            => p_pension_joining_date
      ,p_per_information15            => p_pension_type
      ,p_per_information16            => p_pension_group
      ,p_per_information17            => p_planned_retirement_age
      ,p_per_information18             => p_membership_start_date
      ,p_per_information19             => p_membership_end_date
      ,p_per_information20             => p_termination_date
      ,p_per_information21             => p_termination_reason
      ,p_per_information22	      => p_mother_tongue
      ,p_per_information23	      => p_foreign_personal_id
      ,p_per_information24	      => p_pension_insurance_number
