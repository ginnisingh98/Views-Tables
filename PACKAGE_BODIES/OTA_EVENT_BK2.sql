--------------------------------------------------------
--  DDL for Package Body OTA_EVENT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_EVENT_BK2" as
...
begin
hr_utility.set_location('Entering: OTA_EVENT_BK2.UPDATE_CLASS_A', 10);
hr_utility.set_location(' Leaving: OTA_EVENT_BK2.UPDATE_CLASS_A', 20);
end UPDATE_CLASS_A;
procedure UPDATE_CLASS_B
(P_EFFECTIVE_DATE in DATE
,P_VENDOR_ID in NUMBER
,P_ACTIVITY_VERSION_ID in NUMBER
,P_BUSINESS_GROUP_ID in NUMBER
...
begin
hr_utility.set_location('Entering: OTA_EVENT_BK2.UPDATE_CLASS_B', 10);
hr_utility.set_location(' Leaving: OTA_EVENT_BK2.UPDATE_CLASS_B', 20);
end UPDATE_CLASS_B;
end OTA_EVENT_BK2;
