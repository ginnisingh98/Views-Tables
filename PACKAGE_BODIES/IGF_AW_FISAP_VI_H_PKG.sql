--------------------------------------------------------
--  DDL for Package Body IGF_AW_FISAP_VI_H_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_AW_FISAP_VI_H_PKG" AS
/* $Header: IGFWI43B.pls 115.5 2002/11/28 14:42:39 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_aw_fisap_vi_h%ROWTYPE;
  new_references igf_aw_fisap_vi_h%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.rec_type                          := x_rec_type;
    new_references.minvalue                          := x_minvalue;
    new_references.maxvalue                          := x_maxvalue;
    new_references.fed_perkins_std_count             := x_fed_perkins_std_count;
    new_references.fed_perkins_fund_total            := x_fed_perkins_fund_total;
    new_references.fseog_std_count                   := x_fseog_std_count;
    new_references.fseog_fund_total                  := x_fseog_fund_total;
    new_references.fws_std_count                     := x_fws_std_count;
    new_references.fws_fund_total                    := x_fws_fund_total;
    new_references.unduplicated_std_count            := x_unduplicated_std_count;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AW_FISVIH_FISET_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  BEGIN
    ...
    set_column_values (
      ...
      x_minvalue,
      x_maxvalue,
      x_fed_perkins_std_count,
      x_fed_perkins_fund_total,
      x_fseog_std_count,
      x_fseog_fund_total,
      x_fws_std_count,
      x_fws_fund_total,
      x_unduplicated_std_count,
      x_creation_date,
      x_created_by,
      x_last_update_date,
      x_last_updated_by,
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igf_aw_fisap_vi_h_s.NEXTVAL
    INTO      x_fisap_id
    FROM      dual;
    ...
    before_dml(
      ...
      x_rec_type                          => x_rec_type,
      x_minvalue                          => x_minvalue,
      x_maxvalue                          => x_maxvalue,
      x_fed_perkins_std_count             => x_fed_perkins_std_count,
      x_fed_perkins_fund_total            => x_fed_perkins_fund_total,
      x_fseog_std_count                   => x_fseog_std_count,
      x_fseog_fund_total                  => x_fseog_fund_total,
      x_fws_std_count                     => x_fws_std_count,
      x_fws_fund_total                    => x_fws_fund_total,
      x_unduplicated_std_count            => x_unduplicated_std_count,
    ...
    INSERT INTO igf_aw_fisap_vi_h (
      ...
      new_references.rec_type,
      new_references.minvalue,
      new_references.maxvalue,
      new_references.fed_perkins_std_count,
      new_references.fed_perkins_fund_total,
      new_references.fseog_std_count,
      new_references.fseog_fund_total,
      new_references.fws_std_count,
      new_references.fws_fund_total,
      new_references.unduplicated_std_count,
      x_last_update_date,
      x_last_updated_by,
      x_last_update_date,
      x_last_updated_by,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND (tlinfo.rec_type = x_rec_type)
        ...
        AND ((tlinfo.fed_perkins_std_count = x_fed_perkins_std_count) OR ((tlinfo.fed_perkins_std_count IS NULL) AND (X_fed_perkins_std_count IS NULL)))
        AND ((tlinfo.fed_perkins_fund_total = x_fed_perkins_fund_total) OR ((tlinfo.fed_perkins_fund_total IS NULL) AND (X_fed_perkins_fund_total IS NULL)))
        AND ((tlinfo.fseog_std_count = x_fseog_std_count) OR ((tlinfo.fseog_std_count IS NULL) AND (X_fseog_std_count IS NULL)))
        AND ((tlinfo.fseog_fund_total = x_fseog_fund_total) OR ((tlinfo.fseog_fund_total IS NULL) AND (X_fseog_fund_total IS NULL)))
        AND ((tlinfo.fws_std_count = x_fws_std_count) OR ((tlinfo.fws_std_count IS NULL) AND (X_fws_std_count IS NULL)))
        AND ((tlinfo.fws_fund_total = x_fws_fund_total) OR ((tlinfo.fws_fund_total IS NULL) AND (X_fws_fund_total IS NULL)))
        AND ((tlinfo.unduplicated_std_count = x_unduplicated_std_count) OR ((tlinfo.unduplicated_std_count IS NULL) AND (X_unduplicated_std_count IS NULL)))
       ) THEN
      NULL;
    ELSE
  ...
  BEGIN
    ...
    UPDATE igf_aw_fisap_vi_h
      SET
        ...
        rec_type                          = new_references.rec_type,
        minvalue                          = new_references.minvalue,
        maxvalue                          = new_references.maxvalue,
        fed_perkins_std_count             = new_references.fed_perkins_std_count,
        fed_perkins_fund_total            = new_references.fed_perkins_fund_total,
        fseog_std_count                   = new_references.fseog_std_count,
        fseog_fund_total                  = new_references.fseog_fund_total,
        fws_std_count                     = new_references.fws_std_count,
        fws_fund_total                    = new_references.fws_fund_total,
        unduplicated_std_count            = new_references.unduplicated_std_count,
