--------------------------------------------------------
--  DDL for Package Body PER_DISABILITY_API_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_DISABILITY_API_BK1" as
...
begin
hr_utility.set_location('Entering: PER_DISABILITY_API_BK1.CREATE_DISABILITY_A', 10);
...
PER_HU_DISABILITY.CREATE_HU_DISABILITY
(P_CATEGORY => P_CATEGORY
,P_DEGREE => P_DEGREE
);
elsif l_legislation_code = 'IN' then
PER_IN_DISABILITY_LEG_HOOK.EMP_DISABILITY_CREATE
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_DISABILITY', 'AP');
hr_utility.set_location(' Leaving: PER_DISABILITY_API_BK1.CREATE_DISABILITY_A', 20);
end CREATE_DISABILITY_A;
...
l_legislation_code   varchar2(30);
begin
hr_utility.set_location('Entering: PER_DISABILITY_API_BK1.CREATE_DISABILITY_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_leg_hooks then
l_legislation_code := PER_PER_BUS.RETURN_LEGISLATION_CODE(P_PERSON_ID => P_PERSON_ID
);
if l_legislation_code = 'AE' then
HR_AE_VALIDATE_PKG.CREATE_DISABILITY_VALIDATE
(P_EFFECTIVE_DATE => P_EFFECTIVE_DATE
,P_PERSON_ID => P_PERSON_ID
,P_CATEGORY => P_CATEGORY
,P_DEGREE => P_DEGREE
...
PER_ES_DISABILITY.CREATE_ES_DISABILITY
(P_CATEGORY => P_CATEGORY
,P_DEGREE => P_DEGREE
);
elsif l_legislation_code = 'GB' then
PER_GB_DISABILITY.VALIDATE_CREATE_DISABILITY
(P_CATEGORY => P_CATEGORY
,P_PERSON_ID => P_PERSON_ID
,P_EFFECTIVE_DATE => P_EFFECTIVE_DATE
);
...
PER_PL_DISABILITY.CREATE_PL_DISABILITY
(P_REASON => P_REASON
);
end if;
end if;
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_DISABILITY', 'BP');
hr_utility.set_location(' Leaving: PER_DISABILITY_API_BK1.CREATE_DISABILITY_B', 20);
end CREATE_DISABILITY_B;
