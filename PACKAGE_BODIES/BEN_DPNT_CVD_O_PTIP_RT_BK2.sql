--------------------------------------------------------
--  DDL for Package Body BEN_DPNT_CVD_O_PTIP_RT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DPNT_CVD_O_PTIP_RT_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_DPNT_CVD_O_PTIP_RT_BK2.UPDATE_DPNT_CVD_O_PTIP_RT_A', 10);
hr_utility.set_location(' Leaving: BEN_DPNT_CVD_O_PTIP_RT_BK2.UPDATE_DPNT_CVD_O_PTIP_RT_A', 20);
end UPDATE_DPNT_CVD_O_PTIP_RT_A;
...
begin
hr_utility.set_location('Entering: BEN_DPNT_CVD_O_PTIP_RT_BK2.UPDATE_DPNT_CVD_O_PTIP_RT_B', 10);
hr_utility.set_location(' Leaving: BEN_DPNT_CVD_O_PTIP_RT_BK2.UPDATE_DPNT_CVD_O_PTIP_RT_B', 20);
end UPDATE_DPNT_CVD_O_PTIP_RT_B;
