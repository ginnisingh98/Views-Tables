--------------------------------------------------------
--  DDL for Package Body FARX_C_BL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FARX_C_BL" as
/* $Header: farxcblb.pls 120.3.12010000.4 2010/02/03 09:32:00 gigupta ship $ */
...
PROCEDURE ASSET_COST_BAL (
  ...
  argument3         in  varchar2,   -- start_period_name
  argument4         in  varchar2,   -- end_period_name
  argument5         in  varchar2,   -- standard 'N' or drill down 'Y'
...
begin
 ...
 h_request_id := fnd_global.conc_request_id;
  ...
  farx_bl.asset_cost_balances_rpt (
    book => argument1,
    start_period_name => argument3,
    end_period_name => argument4,
    sob_id => argument2,
