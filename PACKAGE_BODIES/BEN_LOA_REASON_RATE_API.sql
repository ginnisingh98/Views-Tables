--------------------------------------------------------
--  DDL for Package Body BEN_LOA_REASON_RATE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LOA_REASON_RATE_API" as
/* $Header: belarapi.pkb 120.0 2005/05/28 03:14:27 appldev noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_LOA_REASON_RATE_api.';
--
-- ----------------------------------------------------------------------------
...
procedure create_LOA_REASON_RATE
  ...
  --
  l_loa_rsn_rt_id ben_loa_rsn_rt_f.loa_rsn_rt_id%TYPE;
  l_effective_start_date ben_loa_rsn_rt_f.effective_start_date%TYPE;
  l_effective_end_date ben_loa_rsn_rt_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_LOA_REASON_RATE';
  l_object_version_number ben_loa_rsn_rt_f.object_version_number%TYPE;
  --
begin
  --
  ...
  --
  savepoint create_LOA_REASON_RATE;
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_LOA_REASON_RATE
    --
    ben_LOA_REASON_RATE_bk1.create_LOA_REASON_RATE_b
      (
       p_business_group_id              =>  p_business_group_id
      ,p_ordr_num                       =>  p_ordr_num
      ,p_excld_flag                     =>  p_excld_flag
      ,p_vrbl_rt_prfl_id                =>  p_vrbl_rt_prfl_id
      ,p_loa_rsn_cd                     =>  p_loa_rsn_cd
      ,p_lar_attribute_category         =>  p_lar_attribute_category
      ,p_lar_attribute1                 =>  p_lar_attribute1
      ,p_lar_attribute2                 =>  p_lar_attribute2
      ,p_lar_attribute3                 =>  p_lar_attribute3
      ,p_lar_attribute4                 =>  p_lar_attribute4
      ,p_lar_attribute5                 =>  p_lar_attribute5
      ,p_lar_attribute6                 =>  p_lar_attribute6
      ,p_lar_attribute7                 =>  p_lar_attribute7
      ,p_lar_attribute8                 =>  p_lar_attribute8
      ,p_lar_attribute9                 =>  p_lar_attribute9
      ,p_lar_attribute10                =>  p_lar_attribute10
      ,p_lar_attribute11                =>  p_lar_attribute11
      ,p_lar_attribute12                =>  p_lar_attribute12
      ,p_lar_attribute13                =>  p_lar_attribute13
      ,p_lar_attribute14                =>  p_lar_attribute14
      ,p_lar_attribute15                =>  p_lar_attribute15
      ,p_lar_attribute16                =>  p_lar_attribute16
      ,p_lar_attribute17                =>  p_lar_attribute17
      ,p_lar_attribute18                =>  p_lar_attribute18
      ,p_lar_attribute19                =>  p_lar_attribute19
      ,p_lar_attribute20                =>  p_lar_attribute20
      ,p_lar_attribute21                =>  p_lar_attribute21
      ,p_lar_attribute22                =>  p_lar_attribute22
      ,p_lar_attribute23                =>  p_lar_attribute23
      ,p_lar_attribute24                =>  p_lar_attribute24
      ,p_lar_attribute25                =>  p_lar_attribute25
      ,p_lar_attribute26                =>  p_lar_attribute26
      ,p_lar_attribute27                =>  p_lar_attribute27
      ,p_lar_attribute28                =>  p_lar_attribute28
      ,p_lar_attribute29                =>  p_lar_attribute29
      ,p_lar_attribute30                =>  p_lar_attribute30
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_LOA_REASON_RATE'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_LOA_REASON_RATE
    --
  end;
  --
  ben_lar_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_LOA_REASON_RATE
    --
    ben_LOA_REASON_RATE_bk1.create_LOA_REASON_RATE_a
      (
       p_loa_rsn_rt_id                  =>  l_loa_rsn_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_LOA_REASON_RATE
    --
  end;
  --
  ben_profile_handler.event_handler
    (p_event                       => 'CREATE',
     ...
     p_base_table_reference_column => 'RT_LOA_RSN_FLAG',
     p_reference_table             => 'BEN_LOA_RSN_RT_F',
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_LOA_REASON_RATE;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
    --
    p_loa_rsn_rt_id := null;
...
procedure update_LOA_REASON_RATE
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_LOA_REASON_RATE';
  l_object_version_number ben_loa_rsn_rt_f.object_version_number%TYPE;
  l_effective_start_date ben_loa_rsn_rt_f.effective_start_date%TYPE;
  l_effective_end_date ben_loa_rsn_rt_f.effective_end_date%TYPE;
  --
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_LOA_REASON_RATE;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_LOA_REASON_RATE
    --
    ben_LOA_REASON_RATE_bk2.update_LOA_REASON_RATE_b
      (
       p_loa_rsn_rt_id                  =>  p_loa_rsn_rt_id
      ,p_business_group_id              =>  p_business_group_id
      ,p_ordr_num                       =>  p_ordr_num
      ,p_excld_flag                     =>  p_excld_flag
      ,p_vrbl_rt_prfl_id                =>  p_vrbl_rt_prfl_id
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_LOA_REASON_RATE'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_LOA_REASON_RATE
    --
  end;
  --
  ben_lar_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_LOA_REASON_RATE
    --
    ben_LOA_REASON_RATE_bk2.update_LOA_REASON_RATE_a
      (
       p_loa_rsn_rt_id                  =>  p_loa_rsn_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_LOA_REASON_RATE
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO update_LOA_REASON_RATE;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint delete_LOA_REASON_RATE;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_LOA_REASON_RATE
    --
    ben_LOA_REASON_RATE_bk3.delete_LOA_REASON_RATE_b
      (
       p_loa_rsn_rt_id                  =>  p_loa_rsn_rt_id
      ,p_object_version_number          =>  p_object_version_number
    ,p_effective_date                      => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_LOA_REASON_RATE'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_LOA_REASON_RATE
    --
  end;
  --
  ben_lar_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_LOA_REASON_RATE
    --
    ben_LOA_REASON_RATE_bk3.delete_LOA_REASON_RATE_a
      (
       p_loa_rsn_rt_id                  =>  p_loa_rsn_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_LOA_REASON_RATE
    --
  end;
  --
  ben_profile_handler.event_handler
    (p_event                       => 'DELETE',
     p_base_table                  => 'BEN_VRBL_RT_PRFL_F',
     p_base_table_column           => 'VRBL_RT_PRFL_ID',
     p_base_table_column_value     => ben_lar_shd.g_old_rec.vrbl_rt_prfl_id,
     p_base_table_reference_column => 'RT_LOA_RSN_FLAG',
     p_reference_table             => 'BEN_LOA_RSN_RT_F',
     p_reference_table_column      => 'VRBL_RT_PRFL_ID');
  --
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO delete_LOA_REASON_RATE;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
