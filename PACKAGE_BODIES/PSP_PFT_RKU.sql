--------------------------------------------------------
--  DDL for Package Body PSP_PFT_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_PFT_RKU" as
...
begin
hr_utility.set_location('Entering: PSP_PFT_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PSP_PFT_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PSP_PFT_RKU;
