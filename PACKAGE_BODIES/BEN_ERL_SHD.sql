--------------------------------------------------------
--  DDL for Package Body BEN_ERL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ERL_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_erl_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_ELIGY_PRFL_RL_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_ELIGY_PRFL_RL_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  If (p_effective_date is null or
    ...
    l_fct_ret := false;
  Else
    If (p_eligy_prfl_rl_id = g_old_rec.eligy_prfl_rl_id and
...
--	 p_child_table_name1       => 'ben_eligy_prfl_f',
--	 p_child_key_column1       => 'eligy_prfl_id',
...
Begin
  ...
  l_rec.erl_attribute_category           := p_erl_attribute_category;
  l_rec.erl_attribute1                   := p_erl_attribute1;
  l_rec.erl_attribute2                   := p_erl_attribute2;
  l_rec.erl_attribute3                   := p_erl_attribute3;
  l_rec.erl_attribute4                   := p_erl_attribute4;
  l_rec.erl_attribute5                   := p_erl_attribute5;
  l_rec.erl_attribute6                   := p_erl_attribute6;
  l_rec.erl_attribute7                   := p_erl_attribute7;
  l_rec.erl_attribute8                   := p_erl_attribute8;
  l_rec.erl_attribute9                   := p_erl_attribute9;
  l_rec.erl_attribute10                  := p_erl_attribute10;
  l_rec.erl_attribute11                  := p_erl_attribute11;
  l_rec.erl_attribute12                  := p_erl_attribute12;
  l_rec.erl_attribute13                  := p_erl_attribute13;
  l_rec.erl_attribute14                  := p_erl_attribute14;
  l_rec.erl_attribute15                  := p_erl_attribute15;
  l_rec.erl_attribute17                  := p_erl_attribute17;
  l_rec.erl_attribute16                  := p_erl_attribute16;
  l_rec.erl_attribute18                  := p_erl_attribute18;
  l_rec.erl_attribute19                  := p_erl_attribute19;
  l_rec.erl_attribute20                  := p_erl_attribute20;
  l_rec.erl_attribute21                  := p_erl_attribute21;
  l_rec.erl_attribute22                  := p_erl_attribute22;
  l_rec.erl_attribute23                  := p_erl_attribute23;
  l_rec.erl_attribute24                  := p_erl_attribute24;
  l_rec.erl_attribute25                  := p_erl_attribute25;
  l_rec.erl_attribute26                  := p_erl_attribute26;
  l_rec.erl_attribute27                  := p_erl_attribute27;
  l_rec.erl_attribute28                  := p_erl_attribute28;
  l_rec.erl_attribute29                  := p_erl_attribute29;
  l_rec.erl_attribute30                  := p_erl_attribute30;
