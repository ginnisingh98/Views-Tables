--------------------------------------------------------
--  DDL for Package Body IGI_EXP_AP_TRANS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGI_EXP_AP_TRANS_PKG" AS
/* $Header: igiexpyb.pls 120.4.12000000.1 2007/09/13 04:25:23 mbremkum ship $ */
...
--following variables added for bug 3199481: fnd logging changes: sdixit
  ...
  l_rowid VARCHAR2(25);
  old_references igi_exp_ap_trans_all%ROWTYPE;
  new_references igi_exp_ap_trans_all%ROWTYPE;

  PROCEDURE set_column_values (
    p_action                            IN     VARCHAR2,
    x_rowid                             IN     VARCHAR2    ,
    x_ap_tran_id                        IN     NUMBER      ,
  ...
  BEGIN
   ...
   --bug 3199481 fnd logging changes: sdixit: start block
       IF (l_error_level >=  l_debug_level ) THEN
          FND_LOG.MESSAGE (l_error_level , 'igi.plsql.igiexpyb.IGI_EXP_AP_TRANS_PKG.set_column_values',FALSE);
       END IF;
   --bug 3199481 fnd logging changes: sdixit: end block
    ...
    -- Populate New Values.
    new_references.ap_tran_id                        := x_ap_tran_id;
  ...
  */
  BEGIN
   ...
   --bug 3199481 fnd logging changes: sdixit: start block
       IF (l_error_level >=  l_debug_level ) THEN
          FND_LOG.MESSAGE (l_error_level , 'igi.plsql.igiexpyb.IGI_EXP_AP_TRANS_PKG.check_parent_existance',FALSE);
       END IF;
   --bug 3199481 fnd logging changes: sdixit: end block
  ...
  */
  ...
  BEGIN
   ...
   --bug 3199481 fnd logging changes: sdixit: start block
       IF (l_error_level >=  l_debug_level ) THEN
          FND_LOG.MESSAGE (l_error_level , 'igi.plsql.igiexpyb.IGI_EXP_AP_TRANS_PKG.get_fk_igi_exp_dus',FALSE);
       END IF;
   --bug 3199481 fnd logging changes: sdixit: end block
      app_exception.raise_exception;
      RETURN;
  ...
  */
  BEGIN
    ...
    IF (p_action = 'INSERT') THEN
      ...
      IF ( get_pk_for_validation(
             new_references.ap_tran_id
           )
         ) THEN
        fnd_message.set_name('IGI','IGI_EXP_DUP_ROW');
   --bug 3199481 fnd logging changes: sdixit: start block
       IF (l_error_level >=  l_debug_level ) THEN
          FND_LOG.MESSAGE (l_error_level , 'igi.plsql.igiexpyb.IGI_EXP_AP_TRANS_PKG.before_dml.msg1',FALSE);
       END IF;
   --bug 3199481 fnd logging changes: sdixit: end block
   ...
   --bug 3199481 fnd logging changes: sdixit: start block
       IF (l_error_level >=  l_debug_level ) THEN
          FND_LOG.MESSAGE (l_error_level , 'igi.plsql.igiexpyb.IGI_EXP_AP_TRANS_PKG.before_dml.msg2',FALSE);
       END IF;
   --bug 3199481 fnd logging changes: sdixit: end block
  ...
  PROCEDURE insert_row (
    ...
    x_ap_tran_id                        IN OUT NOCOPY NUMBER,
    x_invoice_id                        IN     NUMBER,
    x_du_id                             IN     NUMBER,
    x_org_id                            IN     NUMBER,
    x_attribute_category                IN     VARCHAR2,
  ...
  */
  ...
  BEGIN
   ...
   --bug 3199481 fnd logging changes: sdixit: start block
       IF (l_error_level >=  l_debug_level ) THEN
          FND_LOG.MESSAGE (l_error_level , 'igi.plsql.igiexpyb.IGI_EXP_AP_TRANS_PKG.insert_row',FALSE);
       END IF;
   --bug 3199481 fnd logging changes: sdixit: end block
    ...
    SELECT    igi_exp_ap_trans_s1.NEXTVAL
    INTO      x_ap_tran_id
    FROM      dual;
    ...
    INSERT INTO igi_exp_ap_trans_all (
      ap_tran_id,
      invoice_id,
      du_id,
      org_id,
  ...
  */
  ...
  BEGIN
   ...
   --bug 3199481 fnd logging changes: sdixit: start block
       IF (l_error_level >=  l_debug_level ) THEN
          FND_LOG.MESSAGE (l_error_level , 'igi.plsql.igiexpyb.IGI_EXP_AP_TRANS_PKG.lock_row',FALSE);
       END IF;
   --bug 3199481 fnd logging changes: sdixit: end block
  ...
  */
  ...
  BEGIN
   ...
   --bug 3199481 fnd logging changes: sdixit: start block
       IF (l_error_level >=  l_debug_level ) THEN
          FND_LOG.MESSAGE (l_error_level , 'igi.plsql.igiexpyb.IGI_EXP_AP_TRANS_PKG.update_row',FALSE);
       END IF;
   --bug 3199481 fnd logging changes: sdixit: end block
  ...
  */
  BEGIN
    ...
    DELETE FROM igi_exp_ap_trans_all
    WHERE rowid = x_rowid;
