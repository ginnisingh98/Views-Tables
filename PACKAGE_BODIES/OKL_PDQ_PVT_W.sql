--------------------------------------------------------
--  DDL for Package Body OKL_PDQ_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PDQ_PVT_W" as
  /* $Header: OKLIPDQB.pls 115.4 2002/12/24 04:07:22 sgorantl noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_pdq_pvt.pdq_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).to_date := rosetta_g_miss_date_in_map(a5(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_pdq_pvt.pdq_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_pdq_pvt.pdqv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ptl_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).pqy_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).from_date := rosetta_g_miss_date_in_map(a4(indx));
          t(ddindx).to_date := rosetta_g_miss_date_in_map(a5(indx));
          t(ddindx).created_by := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).creation_date := rosetta_g_miss_date_in_map(a7(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_pdq_pvt.pdqv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    , a3 out nocopy JTF_NUMBER_TABLE
    , a4 out nocopy JTF_DATE_TABLE
    ...
    a10 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).ptl_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).pqy_id);
          a4(indx) := t(ddindx).from_date;
          a5(indx) := t(ddindx).to_date;
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).created_by);
          a7(indx) := t(ddindx).creation_date;
  ...
  as
    ddp_pdqv_rec okl_pdq_pvt.pdqv_rec_type;
    ddx_pdqv_rec okl_pdq_pvt.pdqv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_pdq_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pdqv_tbl okl_pdq_pvt.pdqv_tbl_type;
    ddx_pdqv_tbl okl_pdq_pvt.pdqv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdq_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdq_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdq_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdq_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
