--------------------------------------------------------
--  DDL for Package Body BEN_EIV_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EIV_RKI" as
...
begin
hr_utility.set_location('Entering: ben_eiv_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_eiv_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_eiv_RKI;
