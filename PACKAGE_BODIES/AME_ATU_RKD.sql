--------------------------------------------------------
--  DDL for Package Body AME_ATU_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ATU_RKD" as
...
begin
hr_utility.set_location('Entering: AME_ATU_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: AME_ATU_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end AME_ATU_RKD;
