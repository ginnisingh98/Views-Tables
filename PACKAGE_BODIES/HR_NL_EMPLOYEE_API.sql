--------------------------------------------------------
--  DDL for Package Body HR_NL_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_NL_EMPLOYEE_API" as
/* $Header: peempnli.pkb 120.0 2005/05/31 08:04:19 appldev noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := 'hr_nl_employee_api.';
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_nl_employee >---------------------------|
-- ----------------------------------------------------------------------------
...
procedure create_nl_employee
  ...
  --
  l_proc                 varchar2(72) := g_package||'create_nl_employee';
...
begin
  ...
  ,p_national_identifier          => p_sofi_number
  ...
  ,p_per_information_category     => 'NL'
  ,p_per_information1             => p_initials
  ,p_per_information2             => p_special_title
  ,p_per_information3             => p_subsequent_academic_title
  ,p_per_information4             => p_fullname_format
  ,p_per_information5             => p_partner_prefix
  ,p_per_information6             => p_partner_surname
  ,p_per_information7             => p_objection_received
  ,p_per_information8             => p_objection_statement
  ,p_per_information9             => p_target_group
  ,p_per_information10            => p_academic_title
  ,p_per_information11            => p_birth_country_father
  ,p_per_information12            => p_birth_country_mother
  ,p_per_information13            => p_addressing_female_employee
  ,p_per_information14            => p_work_abroad_exceeding_year
  ,p_per_information15            => p_iza_participant_number
  ,p_per_information16            => p_contract_at_other_company
