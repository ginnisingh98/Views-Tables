--------------------------------------------------------
--  DDL for Package Body FVXBEGLS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FVXBEGLS" 
-- $Header: FVXBEGLB.pls 115.5 2002/06/17 00:43:07 ksriniva ship $
--
AS
--
...
--
      ...
      fv_utility.debug_mesg('-- Set of Books Id ('||g_set_of_books_id||')'
