--------------------------------------------------------
--  DDL for Package Body PER_BF_BALANCE_AMOUNTS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_BF_BALANCE_AMOUNTS_BK1" as
...
begin
hr_utility.set_location('Entering: PER_BF_BALANCE_AMOUNTS_BK1.CREATE_BALANCE_AMOUNT_A', 10);
hr_utility.set_location(' Leaving: PER_BF_BALANCE_AMOUNTS_BK1.CREATE_BALANCE_AMOUNT_A', 20);
end CREATE_BALANCE_AMOUNT_A;
...
begin
hr_utility.set_location('Entering: PER_BF_BALANCE_AMOUNTS_BK1.CREATE_BALANCE_AMOUNT_B', 10);
hr_utility.set_location(' Leaving: PER_BF_BALANCE_AMOUNTS_BK1.CREATE_BALANCE_AMOUNT_B', 20);
end CREATE_BALANCE_AMOUNT_B;
