--------------------------------------------------------
--  DDL for Package Body HXC_DTL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_DTL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_dtl_ins.';  -- Global package name
...
Procedure insert_dml
  (p_rec in out nocopy hxc_dtl_shd.g_rec_type
  ) is
--
  l_proc  varchar2(72);
--
Begin
  ...
  --
  --
  -- Insert the row into: hxc_alias_definitions_tl
  --
...
Begin
  ...
  --
  p_rec.alias_definition_id              := p_alias_definition_id;
  --
  if g_debug then
	hr_utility.set_location(' Leaving:'||l_proc, 10);
  end if;
...
Begin
  ...
  --
  hxc_dtl_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  hxc_dtl_ins.pre_insert
    (p_rec                         => p_rec
  ...
  -- Insert the row
  --
  hxc_dtl_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hxc_dtl_ins.post_insert
     (p_rec
     );
  --
  if g_debug then
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where dtl.alias_definition_id = p_alias_definition_id
                          and dtl.language = l.language_code);
  --
  l_proc  varchar2(72);
  --
Begin
