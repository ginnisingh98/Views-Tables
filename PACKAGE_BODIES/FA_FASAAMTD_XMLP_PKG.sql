--------------------------------------------------------
--  DDL for Package Body FA_FASAAMTD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FASAAMTD_XMLP_PKG" AS
/* $Header: FASAAMTDB.pls 120.0.12010000.1 2008/07/28 13:16:13 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
	...
	RP_Report_Name := ':Adjusted Form 4626 - AMT Detail Report:';
	ELSE
	RP_Report_Name := ':Form 4626 - AMT Detail Report:';
	END IF;
