--------------------------------------------------------
--  DDL for Package Body OKL_PERD_STATUS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PERD_STATUS_PUB_W" as
  /* $Header: OKLUPSMB.pls 120.1 2005/07/18 10:31:47 asawanka noship $ */
  ...
  as
    ddp_period_rec okl_perd_status_pub.period_rec_type;
    ddx_period_tbl okl_perd_status_pub.period_tbl_type;
  ...
  begin
    ...
    okl_perd_status_pub.search_period_status(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_period_tbl okl_perd_status_pub.period_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_perd_status_pub.update_period_status(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
