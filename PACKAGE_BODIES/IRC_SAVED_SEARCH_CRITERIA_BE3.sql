--------------------------------------------------------
--  DDL for Package Body IRC_SAVED_SEARCH_CRITERIA_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_SAVED_SEARCH_CRITERIA_BE3" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  irc_saved_search_criteria_be3.delete_search_criteria_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.saved_search_criteria.delete_search_criteria';
...
end irc_saved_search_criteria_be3;
