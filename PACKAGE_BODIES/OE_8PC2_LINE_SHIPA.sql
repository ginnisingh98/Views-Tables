--------------------------------------------------------
--  DDL for Package Body OE_8PC2_LINE_SHIPA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_8PC2_LINE_SHIPA" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_status_code varchar2(8) :='NOTIFIED';
   ...
   AND a.LINE_ID = OE_LINE_ADJ_SECURITY.g_record.LINE_ID
;
