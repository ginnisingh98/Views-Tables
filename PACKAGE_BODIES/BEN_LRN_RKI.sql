--------------------------------------------------------
--  DDL for Package Body BEN_LRN_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LRN_RKI" as
...
begin
hr_utility.set_location('Entering: ben_lrn_rki.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_lrn_rki.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_lrn_rki;
