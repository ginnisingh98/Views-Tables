--------------------------------------------------------
--  DDL for Package Body PER_CTR_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CTR_RKI" as
...
begin
hr_utility.set_location('Entering: PER_CTR_RKI.AFTER_INSERT', 10);
...
hr_api.validate_commit_unit(l_commit_unit_number, 'PER_CONTACT_RELATIONSHIPS', 'AI');
hr_utility.set_location(' Leaving: PER_CTR_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end PER_CTR_RKI;
