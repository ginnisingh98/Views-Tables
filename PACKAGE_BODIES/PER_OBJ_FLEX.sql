--------------------------------------------------------
--  DDL for Package Body PER_OBJ_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_OBJ_FLEX" as
/* $Header: peobjfli.pkb 115.2 99/10/15 15:41:55 porting ship $ */
--
--
-- ---------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_obj_flex.';  -- Global package name
--
--
--
----------------------------------------------------------------------------
