--------------------------------------------------------
--  DDL for Package Body PER_QAT_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_QAT_RKD" as
...
begin
hr_utility.set_location('Entering: PER_QAT_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PER_QAT_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PER_QAT_RKD;
