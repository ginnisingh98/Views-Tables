--------------------------------------------------------
--  DDL for Package Body GHR_PDC_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_PDC_BK2" as
...
begin
hr_utility.set_location('Entering: GHR_PDC_BK2.UPDATE_PDC_A', 10);
hr_utility.set_location(' Leaving: GHR_PDC_BK2.UPDATE_PDC_A', 20);
end UPDATE_PDC_A;
...
begin
hr_utility.set_location('Entering: GHR_PDC_BK2.UPDATE_PDC_B', 10);
hr_utility.set_location(' Leaving: GHR_PDC_BK2.UPDATE_PDC_B', 20);
end UPDATE_PDC_B;
end GHR_PDC_BK2;
