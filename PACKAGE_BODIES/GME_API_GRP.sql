--------------------------------------------------------
--  DDL for Package Body GME_API_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_API_GRP" AS
   /* $Header: GMEGAPIB.pls 120.34.12010000.4 2009/11/09 09:00:59 apmishra ship $ */
   ...
   BEGIN
    ...
    IF NVL(l_step_status, 0) = gme_common_pvt.g_step_completed THEN
      x_available_quantity := 0;
      RETURN;
    END IF;
