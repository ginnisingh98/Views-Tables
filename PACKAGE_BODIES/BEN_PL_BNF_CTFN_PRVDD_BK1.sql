--------------------------------------------------------
--  DDL for Package Body BEN_PL_BNF_CTFN_PRVDD_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PL_BNF_CTFN_PRVDD_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PL_BNF_CTFN_PRVDD_BK1.CREATE_PL_BNF_CTFN_PRVDD_A', 10);
hr_utility.set_location(' Leaving: BEN_PL_BNF_CTFN_PRVDD_BK1.CREATE_PL_BNF_CTFN_PRVDD_A', 20);
end CREATE_PL_BNF_CTFN_PRVDD_A;
...
begin
hr_utility.set_location('Entering: BEN_PL_BNF_CTFN_PRVDD_BK1.CREATE_PL_BNF_CTFN_PRVDD_B', 10);
hr_utility.set_location(' Leaving: BEN_PL_BNF_CTFN_PRVDD_BK1.CREATE_PL_BNF_CTFN_PRVDD_B', 20);
end CREATE_PL_BNF_CTFN_PRVDD_B;
