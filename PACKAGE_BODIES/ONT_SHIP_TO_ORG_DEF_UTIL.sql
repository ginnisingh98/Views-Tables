--------------------------------------------------------
--  DDL for Package Body ONT_SHIP_TO_ORG_DEF_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_SHIP_TO_ORG_DEF_UTIL" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_SHIP_TO_ORG_Def_Util
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_SHIP_TO_ORG_Def_Util';
 
 
  g_database_object_name varchar2(30) :='OE_AK_SHIP_TO_ORGS_V';
...
END  Get_Attr_Val_Date;
  ...
  PROCEDURE Clear_SHIP_TO_ORG_Cache
  IS  
  BEGIN  
  g_cached_record.ORGANIZATION_ID := null;
   END Clear_SHIP_TO_ORG_Cache;
...
IS
CURSOR cache IS 
  SELECT * FROM   OE_AK_SHIP_TO_ORGS_V
