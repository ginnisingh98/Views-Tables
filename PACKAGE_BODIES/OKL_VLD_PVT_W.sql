--------------------------------------------------------
--  DDL for Package Body OKL_VLD_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_VLD_PVT_W" as
  /* $Header: OKLIVLDB.pls 120.0 2005/09/20 12:39:04 ssdeshpa noship $ */
  procedure rosetta_table_copy_in_p23(t out nocopy okl_vld_pvt.vldv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).validation_set_id := a18(indx);
          t(ddindx).function_id := a19(indx);
          t(ddindx).failure_severity := a20(indx);
          t(ddindx).short_description := a21(indx);
          t(ddindx).description := a22(indx);
          t(ddindx).comments := a23(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p23(t okl_vld_pvt.vldv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a23 := JTF_VARCHAR2_TABLE_2000();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a18(indx) := t(ddindx).validation_set_id;
          a19(indx) := t(ddindx).function_id;
          a20(indx) := t(ddindx).failure_severity;
          a21(indx) := t(ddindx).short_description;
          a22(indx) := t(ddindx).description;
          a23(indx) := t(ddindx).comments;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure insert_row(p_api_version  NUMBER
    ...
    , p5_a22 JTF_VARCHAR2_TABLE_2000
    ...
    , p6_a22 out nocopy JTF_VARCHAR2_TABLE_2000
    , p6_a23 out nocopy JTF_VARCHAR2_TABLE_2000
  )

  as
    ddp_vldv_tbl okl_vld_pvt.vldv_tbl_type;
    ddx_vldv_tbl okl_vld_pvt.vldv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_vld_pvt_w.rosetta_table_copy_in_p23(ddp_vldv_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_vld_pvt_w.rosetta_table_copy_out_p23(ddx_vldv_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  as
    ddp_vldv_rec okl_vld_pvt.vldv_rec_type;
    ddx_vldv_rec okl_vld_pvt.vldv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    p6_a0 := ddx_vldv_rec.id;
    p6_a1 := ddx_vldv_rec.object_version_number;
    p6_a2 := ddx_vldv_rec.attribute_category;
    p6_a3 := ddx_vldv_rec.attribute1;
    p6_a4 := ddx_vldv_rec.attribute2;
    p6_a5 := ddx_vldv_rec.attribute3;
    p6_a6 := ddx_vldv_rec.attribute4;
    p6_a7 := ddx_vldv_rec.attribute5;
    p6_a8 := ddx_vldv_rec.attribute6;
    p6_a9 := ddx_vldv_rec.attribute7;
    p6_a10 := ddx_vldv_rec.attribute8;
    p6_a11 := ddx_vldv_rec.attribute9;
    p6_a12 := ddx_vldv_rec.attribute10;
    p6_a13 := ddx_vldv_rec.attribute11;
    p6_a14 := ddx_vldv_rec.attribute12;
    p6_a15 := ddx_vldv_rec.attribute13;
    p6_a16 := ddx_vldv_rec.attribute14;
    p6_a17 := ddx_vldv_rec.attribute15;
    p6_a18 := ddx_vldv_rec.validation_set_id;
    p6_a19 := ddx_vldv_rec.function_id;
    p6_a20 := ddx_vldv_rec.failure_severity;
    p6_a21 := ddx_vldv_rec.short_description;
    p6_a22 := ddx_vldv_rec.description;
    p6_a23 := ddx_vldv_rec.comments;
  end;
