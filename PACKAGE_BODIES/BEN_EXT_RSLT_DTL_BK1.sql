--------------------------------------------------------
--  DDL for Package Body BEN_EXT_RSLT_DTL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EXT_RSLT_DTL_BK1" as
...
procedure CREATE_EXT_RSLT_DTL_A
...
begin
hr_utility.set_location('Entering: BEN_EXT_RSLT_DTL_BK1.CREATE_EXT_RSLT_DTL_A', 10);
hr_utility.set_location(' Leaving: BEN_EXT_RSLT_DTL_BK1.CREATE_EXT_RSLT_DTL_A', 20);
end CREATE_EXT_RSLT_DTL_A;
procedure CREATE_EXT_RSLT_DTL_B
(P_PRMY_SORT_VAL in VARCHAR2
,P_SCND_SORT_VAL in VARCHAR2
,P_THRD_SORT_VAL in VARCHAR2
,P_TRANS_SEQ_NUM in NUMBER
...
begin
hr_utility.set_location('Entering: BEN_EXT_RSLT_DTL_BK1.CREATE_EXT_RSLT_DTL_B', 10);
hr_utility.set_location(' Leaving: BEN_EXT_RSLT_DTL_BK1.CREATE_EXT_RSLT_DTL_B', 20);
end CREATE_EXT_RSLT_DTL_B;
end BEN_EXT_RSLT_DTL_BK1;
