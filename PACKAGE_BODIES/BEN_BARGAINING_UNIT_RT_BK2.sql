--------------------------------------------------------
--  DDL for Package Body BEN_BARGAINING_UNIT_RT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BARGAINING_UNIT_RT_BK2" as
/* $Header: beburapi.pkb 120.0 2005/05/28 00:53:37 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/01/04 08:37:53 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: BEN_BARGAINING_UNIT_RT_BK2.UPDATE_BARGAINING_UNIT_RT_A', 10);
hr_utility.set_location(' Leaving: BEN_BARGAINING_UNIT_RT_BK2.UPDATE_BARGAINING_UNIT_RT_A', 20);
end UPDATE_BARGAINING_UNIT_RT_A;
...
begin
hr_utility.set_location('Entering: BEN_BARGAINING_UNIT_RT_BK2.UPDATE_BARGAINING_UNIT_RT_B', 10);
hr_utility.set_location(' Leaving: BEN_BARGAINING_UNIT_RT_BK2.UPDATE_BARGAINING_UNIT_RT_B', 20);
end UPDATE_BARGAINING_UNIT_RT_B;
