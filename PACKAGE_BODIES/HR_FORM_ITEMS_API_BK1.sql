--------------------------------------------------------
--  DDL for Package Body HR_FORM_ITEMS_API_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_FORM_ITEMS_API_BK1" as
...
begin
hr_utility.set_location('Entering: HR_FORM_ITEMS_API_BK1.CREATE_FORM_ITEM_A', 10);
hr_utility.set_location(' Leaving: HR_FORM_ITEMS_API_BK1.CREATE_FORM_ITEM_A', 20);
end CREATE_FORM_ITEM_A;
...
begin
hr_utility.set_location('Entering: HR_FORM_ITEMS_API_BK1.CREATE_FORM_ITEM_B', 10);
hr_utility.set_location(' Leaving: HR_FORM_ITEMS_API_BK1.CREATE_FORM_ITEM_B', 20);
end CREATE_FORM_ITEM_B;
