--------------------------------------------------------
--  DDL for Package Body IRC_VACANCY_CONSIDERATIONS_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_VACANCY_CONSIDERATIONS_BE3" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  irc_vacancy_considerations_be3.delete_vacancy_consideration_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.vacancy_considerations.delete_vacancy_consideration';
...
end delete_vacancy_consideration_a;
end irc_vacancy_considerations_be3;
