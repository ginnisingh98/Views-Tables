--------------------------------------------------------
--  DDL for Package Body HR_PERSON_ADDRESS_BK3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PERSON_ADDRESS_BK3" as
...
begin
hr_utility.set_location('Entering: HR_PERSON_ADDRESS_BK3.UPDATE_PERS_ADDR_WITH_STYLE_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
hr_person_address_be3.UPDATE_PERS_ADDR_WITH_STYLE_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_PERS_ADDR_WITH_STYLE', 'AP');
hr_utility.set_location(' Leaving: HR_PERSON_ADDRESS_BK3.UPDATE_PERS_ADDR_WITH_STYLE_A', 20);
...
l_legislation_code   varchar2(30);
begin
hr_utility.set_location('Entering: HR_PERSON_ADDRESS_BK3.UPDATE_PERS_ADDR_WITH_STYLE_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_leg_hooks then
l_legislation_code := PER_ADD_BUS.return_legislation_code(P_ADDRESS_ID => P_ADDRESS_ID
);
...
PER_ES_ADDRESS.UPDATE_ES_ADDRESS_STYLE
(P_ADDRESS_ID => P_ADDRESS_ID
,P_POSTAL_CODE => P_POSTAL_CODE
,P_REGION_2 => P_REGION_2
,P_STYLE => P_STYLE
...
PER_PL_ADDRESS.UPDATE_PL_ADDRESS_STYLE
(P_ADDRESS_ID => P_ADDRESS_ID
,P_STYLE => P_STYLE
,P_ADDRESS_TYPE => P_ADDRESS_TYPE
,P_DATE_FROM => P_DATE_FROM
...
HR_RU_ADDRESS_HOOK.UPDATE_RU_ADDRESS_WITH_STYLE
(P_STYLE => P_STYLE
,P_ADDRESS_ID => P_ADDRESS_ID
,P_ADD_INFORMATION13 => P_ADD_INFORMATION13
,P_POSTAL_CODE => P_POSTAL_CODE
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_PERS_ADDR_WITH_STYLE', 'BP');
hr_utility.set_location(' Leaving: HR_PERSON_ADDRESS_BK3.UPDATE_PERS_ADDR_WITH_STYLE_B', 20);
end UPDATE_PERS_ADDR_WITH_STYLE_B;
