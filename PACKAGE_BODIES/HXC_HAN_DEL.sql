--------------------------------------------------------
--  DDL for Package Body HXC_HAN_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_HAN_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hxc_han_del.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Delete the hxc_app_comp_notifications row.
  --
  delete from hxc_app_comp_notifications
  where comp_notification_id = p_rec.comp_notification_id
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hxc_han_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hxc_han_shd.g_rec_type) is
--
...
Begin
  ...
  --
  hxc_han_bus.delete_validate(p_rec);
  --
  ...
  --
  hxc_han_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hxc_han_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hxc_han_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
