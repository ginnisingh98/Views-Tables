--------------------------------------------------------
--  DDL for Package Body BEN_XRF_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XRF_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xrf_ins.';  -- Global package name
...
Begin
  ...
  --
  -- Insert the row into: ben_ext_rcd_in_file
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ext_rcd_in_file_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  create_app_ownerships('EXT_RCD_IN_FILE_ID', p_rec.ext_rcd_in_file_id);
...
Begin
  ...
  --
  p_ext_rcd_in_file_id := l_rec.ext_rcd_in_file_id;
