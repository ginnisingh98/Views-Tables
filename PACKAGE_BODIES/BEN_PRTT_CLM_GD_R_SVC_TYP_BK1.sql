--------------------------------------------------------
--  DDL for Package Body BEN_PRTT_CLM_GD_R_SVC_TYP_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PRTT_CLM_GD_R_SVC_TYP_BK1" as
...
procedure CREATE_PRTT_CLM_GD_R_SVC_TYP_A
...
begin
hr_utility.set_location('Entering: BEN_PRTT_CLM_GD_R_SVC_TYP_BK1.CREATE_PRTT_CLM_GD_R_SVC_TYP_A', 10);
hr_utility.set_location(' Leaving: BEN_PRTT_CLM_GD_R_SVC_TYP_BK1.CREATE_PRTT_CLM_GD_R_SVC_TYP_A', 20);
end CREATE_PRTT_CLM_GD_R_SVC_TYP_A;
procedure CREATE_PRTT_CLM_GD_R_SVC_TYP_B
(P_PRTT_REIMBMT_RQST_ID in NUMBER
,P_GD_OR_SVC_TYP_ID in NUMBER
,P_BUSINESS_GROUP_ID in NUMBER
,P_PCG_ATTRIBUTE_CATEGORY in VARCHAR2
...
begin
hr_utility.set_location('Entering: BEN_PRTT_CLM_GD_R_SVC_TYP_BK1.CREATE_PRTT_CLM_GD_R_SVC_TYP_B', 10);
hr_utility.set_location(' Leaving: BEN_PRTT_CLM_GD_R_SVC_TYP_BK1.CREATE_PRTT_CLM_GD_R_SVC_TYP_B', 20);
end CREATE_PRTT_CLM_GD_R_SVC_TYP_B;
end BEN_PRTT_CLM_GD_R_SVC_TYP_BK1;
