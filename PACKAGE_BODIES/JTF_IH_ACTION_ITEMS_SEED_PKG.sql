--------------------------------------------------------
--  DDL for Package Body JTF_IH_ACTION_ITEMS_SEED_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_IH_ACTION_ITEMS_SEED_PKG" as
/* $Header: JTFIHAIB.pls 120.4 2006/04/18 12:59:35 rdday ship $ */
...
begin
	if (X_UPLOAD_MODE = 'NLS') then
		JTF_IH_ACTION_ITEMS_SEED_PKG.TRANSLATE_ROW (
			X_ACTION_ITEM_ID,
			X_ACTION_ITEM,
			X_SHORT_DESCRIPTION,
			X_OWNER);
		...
		JTF_IH_ACTION_ITEMS_SEED_PKG.LOAD_ROW (
			X_ACTION_ITEM_ID,
			X_ACTION_ITEM,
			X_OBJECT_VERSION_NUMBER,
			X_SHORT_DESCRIPTION,
