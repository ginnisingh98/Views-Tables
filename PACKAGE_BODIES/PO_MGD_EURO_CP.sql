--------------------------------------------------------
--  DDL for Package Body PO_MGD_EURO_CP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PO_MGD_EURO_CP" AS
/* $Header: POXCEURB.pls 115.8 2002/11/23 03:32:18 sbull ship $*/
/*+=======================================================================+
...
--|                                                                       |
--| DESCRIPTION                                                           |
--|     Body of concurrent program package PO_MGD_EURO_CP                 |
--|                                                                       |
--| PROCEDURE LIST                                                        |
--|     Run_Vendor_Conversion                                             |
--|                                                                       |
--| HISTORY                                                               |
