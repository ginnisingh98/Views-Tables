--------------------------------------------------------
--  DDL for Package Body BEN_EPN_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EPN_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_epn_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    select t.created_by,
           t.creation_date
    from   ben_ELIG_PRBTN_PERD_PRTE_f t
    where  t.ELIG_PRBTN_PERD_PRTE_id       = p_rec.ELIG_PRBTN_PERD_PRTE_id
    and    t.effective_start_date =
             ben_epn_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_ELIG_PRBTN_PERD_PRTE_f.created_by%TYPE;
  l_creation_date       ben_ELIG_PRBTN_PERD_PRTE_f.creation_date%TYPE;
  l_last_update_date   	ben_ELIG_PRBTN_PERD_PRTE_f.last_update_date%TYPE;
  l_last_updated_by     ben_ELIG_PRBTN_PERD_PRTE_f.last_updated_by%TYPE;
  l_last_update_login   ben_ELIG_PRBTN_PERD_PRTE_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_ELIG_PRBTN_PERD_PRTE_f
  --
  insert into ben_ELIG_PRBTN_PERD_PRTE_f
...
--
cursor c1 is
    select BEN_ELIG_PRBTN_PERD_PRTE_F_S.nextval
    from   sys.dual;
--
--
Begin
  ...
  open c1;
    --
    fetch c1 into p_rec.ELIG_PRBTN_PERD_PRTE_id;
    --
  close c1;
  --
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_epn_rec
  ...
  --
  p_ELIG_PRBTN_PERD_PRTE_id        	:= l_rec.ELIG_PRBTN_PERD_PRTE_id;
