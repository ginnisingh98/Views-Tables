--------------------------------------------------------
--  DDL for Package Body OKL_AM_RESTRUCTURE_QUOTE_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_RESTRUCTURE_QUOTE_PUB" AS
/* $Header: OKLPRTQB.pls 115.4 2004/04/13 11:03:39 rnaik noship $ */
...
SAVEPOINT restructure_quote_create;
...
okl_am_restructure_quote_pvt.create_restructure_quote(
                          l_api_version
                         ,l_init_msg_list
                         ,l_return_status
                         ,l_msg_count
...
EXCEPTION
    ...
    WHEN FND_API.G_EXC_ERROR THEN
      ROLLBACK TO restructure_quote_create;
    ...
    WHEN OTHERS THEN
      ...
      x_msg_count := l_msg_count ;
      x_msg_data := l_msg_data ;
      FND_MSG_PUB.ADD_EXC_MSG('OKL_AM_RESTRUCTURE_QUOTE_PUB','create_restructure_quote');
      FND_MSG_PUB.count_and_get(
             p_count   => x_msg_count
            ,p_data    => x_msg_data);
...
l_msg_count NUMBER ;
l_return_status VARCHAR2(1);
lp_quot_tbl  quot_tbl_type;
lx_quot_tbl  quot_tbl_type;
...
l_msg_count := x_msg_count ;
l_msg_data := x_msg_data ;
lp_quot_tbl :=  p_quot_tbl;
lx_quot_tbl :=  x_quot_tbl;
...
--Copy value of OUT variable in the IN record type
lp_quot_tbl := lx_quot_tbl;



--Assign value to OUT variables
x_quot_tbl  := lx_quot_tbl;
x_return_status := l_return_status ;
x_msg_count := l_msg_count ;
x_msg_data := l_msg_data ;
