--------------------------------------------------------
--  DDL for Package Body IGS_AD_INTVW_PNLS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AD_INTVW_PNLS_PKG" AS
/* $Header: IGSAIG9B.pls 115.2 2003/06/23 06:40:04 akadam noship $ */

  l_rowid VARCHAR2(25);
  old_references IGS_AD_INTVW_PNLS%ROWTYPE;
  new_references IGS_AD_INTVW_PNLS%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.panel_type_code                   := x_panel_type_code;
    new_references.panel_level_code                  := x_panel_level_code;
    new_references.panel_desc                        := x_panel_desc;
  ...
  */
  BEGIN
    ...
    igs_ad_panel_dtls_pkg.get_fk_igs_ad_intvw_pnls (
      old_references.panel_code
    );

   igs_ad_panel_membrs_pkg.get_fk_igs_ad_intvw_pnls (
      old_references.panel_code
    );
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGS_AD_INTVW_PNLS_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    before_dml(
      ...
      x_panel_type_code                   => x_panel_type_code,
      x_panel_level_code                  => x_panel_level_code,
      x_panel_desc                        => x_panel_desc,
    ...
    INSERT INTO igs_ad_intvw_pnls (
      ...
      new_references.panel_code,
      new_references.panel_type_code,
      new_references.panel_level_code,
      new_references.panel_desc     ,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.panel_type_code = x_panel_type_code)
        AND ((tlinfo.panel_level_code = x_panel_level_code) OR ((tlinfo.panel_level_code IS NULL) AND (X_panel_level_code IS NULL)))
        AND (tlinfo.panel_desc      = x_panel_desc     )
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGS_AD_INTVW_PNLS_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    UPDATE igs_ad_intvw_pnls
      SET
        panel_type_code                   = new_references.panel_type_code,
        panel_level_code                  = new_references.panel_level_code,
        panel_desc                            = new_references.panel_desc     ,
