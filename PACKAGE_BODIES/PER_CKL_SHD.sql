--------------------------------------------------------
--  DDL for Package Body PER_CKL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CKL_SHD" as
/* $Header: pecklrhi.pkb 120.2 2005/11/15 09:02:02 lsilveir noship $ */
--
-- ----------------------------------------------------------------------------
-- |                     Private Global Definitions                           |
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_ckl_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PER_CHECKLISTS_PK') Then
...
Begin
  ...
  Else
    If (p_checklist_id
        = per_ckl_shd.g_old_rec.checklist_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_ckl_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_ckl_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  l_rec.event_reason_id                  := p_event_reason_id;
