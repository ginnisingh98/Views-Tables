--------------------------------------------------------
--  DDL for Package Body PER_PAC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PAC_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package varchar2(33) := '  per_pac_shd.';  -- Global package name
...
Begin
  --
  If (p_constraint_name = 'PER_ALLOCATED_CHECKLISTS_PK') Then
...
Function api_updating
  ...
  Cursor C_Sel1 is
    ...
    where       allocated_checklist_id = p_allocated_checklist_id;
  --
  l_fct_ret     boolean;
  --
Begin
  --
  If (p_allocated_checklist_id is null and
    ...
    l_fct_ret := false;
  Else
    If (p_allocated_checklist_id
        = per_pac_shd.g_old_rec.allocated_checklist_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_pac_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_pac_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  hr_api.mandatory_arg_error
    (p_api_name           => l_proc
    ,p_argument           => 'ALLOCATED_CHECKLIST_ID'
    ,p_argument_value     => p_allocated_checklist_id
    );
...
Begin
  ...
  l_rec.checklist_name                   := p_checklist_name;
  l_rec.description                      := p_description;
  l_rec.checklist_category               := p_checklist_category;
