--------------------------------------------------------
--  DDL for Package Body PAY_ETP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ETP_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_etp_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  Else
    If (p_element_type_id =
        pay_etp_shd.g_old_rec.element_type_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into pay_etp_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> pay_etp_shd.g_old_rec.object_version_number) Then
...
--
  ...
  Cursor C_Sel3 is
    ...
    from   hr_comments hc
    where  hc.comment_id = pay_etp_shd.g_old_rec.comment_id;
  --
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  If (p_datetrack_mode <> hr_api.g_insert) then
    ...
    --
    If ((pay_etp_shd.g_old_rec.comment_id is not null) and
       ...
       Open C_Sel3;
       Fetch C_Sel3 Into pay_etp_shd.g_old_rec.comments;
...
Begin
  ...
  l_rec.advance_element_type_id		 := p_advance_element_type_id;
  l_rec.deduction_element_type_id	 := p_deduction_element_type_id;
  --
