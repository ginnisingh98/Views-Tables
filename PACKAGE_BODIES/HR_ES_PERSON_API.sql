--------------------------------------------------------
--  DDL for Package Body HR_ES_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ES_PERSON_API" as
/* $Header: peperesi.pkb 115.0 2004/03/18 01:26:26 vikgupta noship $ */

--   package variables
g_package  varchar2(33) := 'hr_es_person_api.';
...
procedure update_es_person
  ...
  -- Declare cursors and local variables
   l_proc                 varchar2(72) := g_package||'update_es_person';
