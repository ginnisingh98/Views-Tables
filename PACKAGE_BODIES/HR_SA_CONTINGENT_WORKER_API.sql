--------------------------------------------------------
--  DDL for Package Body HR_SA_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SA_CONTINGENT_WORKER_API" as
/* $Header: pecwksai.pkb 120.3 2005/06/20 02:16:48 adevanat noship $ */
--
	-- Package Variables
	g_package  varchar2(33) := '  hr_sa_contingent_worker_api.';
