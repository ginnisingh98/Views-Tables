--------------------------------------------------------
--  DDL for Package Body CN_COLLECT_WRITEOFFS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CN_COLLECT_WRITEOFFS" AS
-- $Header: cncowob.pls 120.2 2006/01/19 04:10:20 apink noship $
...
BEGIN
  ...
  dbms_output.put_line('Error: Package cn_collect_writeoffs'||cached_org_append||' is probably missing');
...
--   collect
-- Purpose
--   This procedure is the router for collecting writeoffs
--
-- History
--   02-Jan-97	Jcheng	Router Procedure for collecting writeoffs
--
...
begin
  ...
  statement := 'begin cn_collect_writeoffs'||cached_org_append||
