--------------------------------------------------------
--  DDL for Package Body AME_ATL_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ATL_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_atl_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the ame_attributes_tl Row
  --
...
Begin
  ...
  --
  ame_atl_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ame_atl_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ame_atl_upd.post_update
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
  ...
  cursor csr_upd_langs is
    select atl.language
     ...
     where atl.attribute_id = p_attribute_id
       and p_language_code in (atl.language
                              ,atl.source_lang);
  --
