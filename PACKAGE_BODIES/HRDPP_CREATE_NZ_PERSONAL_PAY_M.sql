--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_NZ_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_NZ_PERSONAL_PAY_M" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:27
 * Generated for API: HR_NZ_PERSONAL_PAY_METHOD_API.CREATE_NZ_PERSONAL_PAY_METHOD
 */
--
...
l.pval009 d9,
decode(l.pval010,cn,nn,n(l.pval010)) p10,
...
decode(l.pval034,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval034,'PAYEE_TYPE',d(l.pval001),l.pval075)) p34,
l.pval034 d34,
...
decode(l.pval069,cn,dn,d(l.pval069)) p69,
l.pval070 p70,
...
--
L_RUN_TYPE_ID := 
PER_NZ_DATA_PUMP.get_run_type_id;
--
...
(P_ORG_PAYMENT_METHOD_USER_KEY => c.p72);
end if;
--
L_PAYEE_ID := 
...
,P_PAYEE_ORG => c.p73
,P_PAYEE_PERSON_USER_KEY => c.p74
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p75);
--
hr_data_pump.api_trc_on;
HR_NZ_PERSONAL_PAY_METHOD_API.CREATE_NZ_PERSONAL_PAY_METHOD
(p_validate => l_validate
,P_EFFECTIVE_DATE => c.p1
,P_ASSIGNMENT_ID => L_ASSIGNMENT_ID
,P_RUN_TYPE_ID => L_RUN_TYPE_ID
,P_ORG_PAYMENT_METHOD_ID => L_ORG_PAYMENT_METHOD_ID
,P_BANK_BRANCH_NUMBER => c.p2
,P_ACCOUNT_NUMBER => c.p3
,P_ACCOUNT_SUFFIX => c.p4
,P_REFERENCE => c.p5
,P_CODE => c.p6
,P_THIRD_PARTY_PARTICULARS => c.p7
,P_AMOUNT => c.p8
,P_PERCENTAGE => c.p9
,P_PRIORITY => c.p10
,P_COMMENTS => c.p11
...
,P_ATTRIBUTE19 => c.p31
,P_ATTRIBUTE20 => c.p32
,P_CONCAT_SEGMENTS => c.p33
,P_PAYEE_TYPE => c.p34
,P_PAYEE_ID => L_PAYEE_ID
,P_PPM_INFORMATION1 => c.p35
,P_PPM_INFORMATION2 => c.p36
,P_PPM_INFORMATION3 => c.p37
,P_PPM_INFORMATION4 => c.p38
,P_PPM_INFORMATION5 => c.p39
,P_PPM_INFORMATION6 => c.p40
,P_PPM_INFORMATION7 => c.p41
,P_PPM_INFORMATION8 => c.p42
,P_PPM_INFORMATION9 => c.p43
,P_PPM_INFORMATION10 => c.p44
,P_PPM_INFORMATION11 => c.p45
,P_PPM_INFORMATION12 => c.p46
,P_PPM_INFORMATION13 => c.p47
,P_PPM_INFORMATION14 => c.p48
,P_PPM_INFORMATION15 => c.p49
,P_PPM_INFORMATION16 => c.p50
,P_PPM_INFORMATION17 => c.p51
,P_PPM_INFORMATION18 => c.p52
,P_PPM_INFORMATION19 => c.p53
,P_PPM_INFORMATION20 => c.p54
,P_PPM_INFORMATION21 => c.p55
,P_PPM_INFORMATION22 => c.p56
,P_PPM_INFORMATION23 => c.p57
,P_PPM_INFORMATION24 => c.p58
,P_PPM_INFORMATION25 => c.p59
,P_PPM_INFORMATION26 => c.p60
,P_PPM_INFORMATION27 => c.p61
,P_PPM_INFORMATION28 => c.p62
,P_PPM_INFORMATION29 => c.p63
,P_PPM_INFORMATION30 => c.p64
,P_PERSONAL_PAYMENT_METHOD_ID => L_PERSONAL_PAYMENT_METHOD_ID
,P_EXTERNAL_ACCOUNT_ID => c.p66
,P_OBJECT_VERSION_NUMBER => c.p67
,P_EFFECTIVE_START_DATE => c.p68
,P_EFFECTIVE_END_DATE => c.p69
,P_COMMENT_ID => c.p70);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p65,L_PERSONAL_PAYMENT_METHOD_ID);
--
...
l.pval069 = decode(c.p69,null,cn,dc(c.p69)),
...
end hrdpp_CREATE_NZ_PERSONAL_PAY_M;
