--------------------------------------------------------
--  DDL for Package Body PER_BF_PROC_ASSIGNMENT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_BF_PROC_ASSIGNMENT_BK2" as
...
procedure UPDATE_PROCESSED_ASSIGNMENT_A
...
begin
hr_utility.set_location('Entering: PER_BF_PROC_ASSIGNMENT_BK2.UPDATE_PROCESSED_ASSIGNMENT_A', 10);
hr_utility.set_location(' Leaving: PER_BF_PROC_ASSIGNMENT_BK2.UPDATE_PROCESSED_ASSIGNMENT_A', 20);
end UPDATE_PROCESSED_ASSIGNMENT_A;
procedure UPDATE_PROCESSED_ASSIGNMENT_B
(P_EFFECTIVE_DATE in DATE
,P_BPA_ATTRIBUTE_CATEGORY in VARCHAR2
,P_BPA_ATTRIBUTE1 in VARCHAR2
,P_BPA_ATTRIBUTE2 in VARCHAR2
...
begin
hr_utility.set_location('Entering: PER_BF_PROC_ASSIGNMENT_BK2.UPDATE_PROCESSED_ASSIGNMENT_B', 10);
hr_utility.set_location(' Leaving: PER_BF_PROC_ASSIGNMENT_BK2.UPDATE_PROCESSED_ASSIGNMENT_B', 20);
end UPDATE_PROCESSED_ASSIGNMENT_B;
end PER_BF_PROC_ASSIGNMENT_BK2;
