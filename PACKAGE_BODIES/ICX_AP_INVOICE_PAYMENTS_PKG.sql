--------------------------------------------------------
--  DDL for Package Body ICX_AP_INVOICE_PAYMENTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ICX_AP_INVOICE_PAYMENTS_PKG" AS
/* $Header: ICXAPPAB.pls 115.0 99/08/09 17:21:56 porting ship $ */
    ...
    BEGIN
        ...
        LOOP
            ...
            l_paid_by := ICX_AP_INVOICE_PAYMENTS_PKG.CONCAT_DOCUMENT_NUM_TYPE(
                                                        l_payment_record);
