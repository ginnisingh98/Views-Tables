--------------------------------------------------------
--  DDL for Package Body ICX_CAT_POPULATE_REQTMPL_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ICX_CAT_POPULATE_REQTMPL_GRP" AS
/* $Header: ICXGPPRB.pls 120.2 2005/12/13 15:28:54 sbgeorge noship $*/

-- Constants
G_PKG_NAME      CONSTANT VARCHAR2(30):='ICX_CAT_POPULATE_REQTMPL_GRP';
...
BEGIN
  ...
  SAVEPOINT populateOnlineReqTemplates_sp;
  ...
  l_err_loc := 600;
  ICX_CAT_POPULATE_REQTMPL_PVT.populateOnlineReqTemplates(p_key);
...
EXCEPTION
  WHEN OTHERS THEN
    BEGIN
      ROLLBACK TO populateOnlineReqTemplates_sp;
    EXCEPTION
      WHEN OTHERS THEN
