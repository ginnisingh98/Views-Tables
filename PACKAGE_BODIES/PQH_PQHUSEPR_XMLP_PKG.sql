--------------------------------------------------------
--  DDL for Package Body PQH_PQHUSEPR_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_PQHUSEPR_XMLP_PKG" AS
/* $Header: PQHUSEPRB.pls 120.1 2007/12/07 06:49:33 vjaganat noship $ */
  ...
  FUNCTION CF_GETTENURECOUNTFORMULA RETURN NUMBER IS
    L_TENURED_SUP_CNT NUMBER;
    L_TEN_CUR_YR_SUP_CNT NUMBER;
    L_TT_SUP_CNT NUMBER;
    L_TT_FINAL_YR_SUP_CNT NUMBER;
    L_TE_CUR_YR_SUP_CNT NUMBER;
    L_TD_CUR_YR_SUP_CNT NUMBER;
  ...
  BEGIN
    CP_TENURED_CNT := PQH_TENURE_DETAIL.GETPERIODSTATUSCOUNT(P_SUPERVISOR_ID
                                                            ...
                                                            ,L_START_OF_TIME
                                                            ,SYSDATE);
    CP_TENTRACK_CNT := PQH_TENURE_DETAIL.GETPERIODSTATUSCOUNT(P_SUPERVISOR_ID
                                                             ,'02'
                                                             ,L_START_OF_TIME
                                                             ,SYSDATE);
  ...
  FUNCTION CP_TENTRACK_CNT_P RETURN NUMBER IS
  BEGIN
    RETURN CP_TENTRACK_CNT;
  END CP_TENTRACK_CNT_P;
