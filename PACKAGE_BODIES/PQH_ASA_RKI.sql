--------------------------------------------------------
--  DDL for Package Body PQH_ASA_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_ASA_RKI" as
...
begin
hr_utility.set_location('Entering: PQH_ASA_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: PQH_ASA_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end PQH_ASA_RKI;
