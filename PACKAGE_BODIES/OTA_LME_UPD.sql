--------------------------------------------------------
--  DDL for Package Body OTA_LME_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_LME_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_lme_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the ota_lp_member_enrollments Row
  --
  update ota_lp_member_enrollments
    set
     lp_member_enrollment_id         = p_rec.lp_member_enrollment_id
    ,lp_enrollment_id                = p_rec.lp_enrollment_id
    ,learning_path_section_id        = p_rec.learning_path_section_id
    ,learning_path_member_id         = p_rec.learning_path_member_id
    ...
    where lp_member_enrollment_id = p_rec.lp_member_enrollment_id;
  --
  --
  --
...
Begin
  ...
  begin
    ...
    ota_lme_rku.after_update
      ...
      ,p_event_id
      => p_rec.event_id
      ,p_lp_enrollment_id_o
      => ota_lme_shd.g_old_rec.lp_enrollment_id
      ,p_learning_path_section_id_o
      => ota_lme_shd.g_old_rec.learning_path_section_id
      ,p_learning_path_member_id_o
      => ota_lme_shd.g_old_rec.learning_path_member_id
      ,p_member_status_code_o
      => ota_lme_shd.g_old_rec.member_status_code
      ,p_completion_target_date_o
      => ota_lme_shd.g_old_rec.completion_target_date
      ,p_completion_date_o
      => ota_lme_shd.g_old_rec.completion_date
      ,p_business_group_id_o
      => ota_lme_shd.g_old_rec.business_group_id
      ,p_object_version_number_o
      => ota_lme_shd.g_old_rec.object_version_number
      ,p_attribute_category_o
      => ota_lme_shd.g_old_rec.attribute_category
      ,p_attribute1_o
      => ota_lme_shd.g_old_rec.attribute1
      ,p_attribute2_o
      => ota_lme_shd.g_old_rec.attribute2
      ,p_attribute3_o
      => ota_lme_shd.g_old_rec.attribute3
      ,p_attribute4_o
      => ota_lme_shd.g_old_rec.attribute4
      ,p_attribute5_o
      => ota_lme_shd.g_old_rec.attribute5
      ,p_attribute6_o
      => ota_lme_shd.g_old_rec.attribute6
      ,p_attribute7_o
      => ota_lme_shd.g_old_rec.attribute7
      ,p_attribute8_o
      => ota_lme_shd.g_old_rec.attribute8
      ,p_attribute9_o
      => ota_lme_shd.g_old_rec.attribute9
      ,p_attribute10_o
      => ota_lme_shd.g_old_rec.attribute10
      ,p_attribute11_o
      => ota_lme_shd.g_old_rec.attribute11
      ,p_attribute12_o
      => ota_lme_shd.g_old_rec.attribute12
      ,p_attribute13_o
      => ota_lme_shd.g_old_rec.attribute13
      ,p_attribute14_o
      => ota_lme_shd.g_old_rec.attribute14
      ,p_attribute15_o
      => ota_lme_shd.g_old_rec.attribute15
      ,p_attribute16_o
      => ota_lme_shd.g_old_rec.attribute16
      ,p_attribute17_o
      => ota_lme_shd.g_old_rec.attribute17
      ,p_attribute18_o
      => ota_lme_shd.g_old_rec.attribute18
      ,p_attribute19_o
      => ota_lme_shd.g_old_rec.attribute19
      ,p_attribute20_o
      => ota_lme_shd.g_old_rec.attribute20
      ,p_attribute21_o
      => ota_lme_shd.g_old_rec.attribute21
      ,p_attribute22_o
      => ota_lme_shd.g_old_rec.attribute22
      ,p_attribute23_o
      => ota_lme_shd.g_old_rec.attribute23
      ,p_attribute24_o
      => ota_lme_shd.g_old_rec.attribute24
      ,p_attribute25_o
      => ota_lme_shd.g_old_rec.attribute25
      ,p_attribute26_o
      => ota_lme_shd.g_old_rec.attribute26
      ,p_attribute27_o
      => ota_lme_shd.g_old_rec.attribute27
      ,p_attribute28_o
      => ota_lme_shd.g_old_rec.attribute28
      ,p_attribute29_o
      => ota_lme_shd.g_old_rec.attribute29
      ,p_attribute30_o
      => ota_lme_shd.g_old_rec.attribute30
      ,p_creator_person_id_o
      => ota_lme_shd.g_old_rec.creator_person_id
      ,p_event_id_o
      => ota_lme_shd.g_old_rec.event_id
      );
    --
  exception
    --
...
Begin
  ...
  --
  If (p_rec.lp_enrollment_id = hr_api.g_number) then
    p_rec.lp_enrollment_id :=
    ota_lme_shd.g_old_rec.lp_enrollment_id;
  End If;
  If (p_rec.learning_path_section_id = hr_api.g_number) then
    p_rec.learning_path_section_id :=
    ota_lme_shd.g_old_rec.learning_path_section_id;
  End If;
  If (p_rec.learning_path_member_id = hr_api.g_number) then
    p_rec.learning_path_member_id :=
    ota_lme_shd.g_old_rec.learning_path_member_id;
  End If;
...
Begin
  ...
  --
  ota_lme_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_lme_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_lme_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
