--------------------------------------------------------
--  DDL for Package Body CSI_I_PARTIES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CSI_I_PARTIES_PKG" as
/* $Header: csitptyb.pls 115.15 2003/09/04 00:22:35 sguthiva ship $ */


G_PKG_NAME CONSTANT VARCHAR2(30):= 'CSI_I_PARTIES_PKG';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'csitptyb.pls';
...
PROCEDURE Insert_Row(
 ...
 IS
   CURSOR C2 IS SELECT CSI_I_PARTIES_S.nextval FROM sys.dual;
BEGIN
   If (p_INSTANCE_PARTY_ID IS NULL) OR (p_INSTANCE_PARTY_ID = FND_API.G_MISS_NUM) then
       OPEN C2;
       FETCH C2 INTO p_INSTANCE_PARTY_ID;
       CLOSE C2;
   End If;
   INSERT INTO CSI_I_PARTIES(
           ...
           decode( p_CONTACT_IP_ID, FND_API.G_MISS_NUM, NULL, p_CONTACT_IP_ID),
...
PROCEDURE Update_Row(
 ...
 BEGIN
    ...
    SET
              ...
              CONTACT_IP_ID= decode( p_CONTACT_IP_ID, FND_API.G_MISS_NUM, CONTACT_IP_ID, p_CONTACT_IP_ID),
...
PROCEDURE Lock_Row(
 ...
 BEGIN
    ...
    CLOSE C;
    if (
           (      Recinfo.INSTANCE_PARTY_ID = p_INSTANCE_PARTY_ID)
       ...
       AND (    ( Recinfo.CONTACT_IP_ID = p_CONTACT_IP_ID)
            OR (    ( Recinfo.CONTACT_IP_ID IS NULL )
                AND (  p_CONTACT_IP_ID IS NULL )))
