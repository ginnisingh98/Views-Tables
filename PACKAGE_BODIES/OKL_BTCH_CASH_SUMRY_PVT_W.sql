--------------------------------------------------------
--  DDL for Package Body OKL_BTCH_CASH_SUMRY_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_BTCH_CASH_SUMRY_PVT_W" as
  /* $Header: OKLEBASB.pls 115.4 2003/11/11 02:02:16 rgalipo noship $ */
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).trx_status_code := a1(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
    ...
    a1 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := t(ddindx).trx_status_code;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  as
    ddp_btch_tbl okl_btch_cash_sumry_pvt.okl_btch_sumry_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_btch_cash_sumry_pvt.handle_batch_sumry(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
