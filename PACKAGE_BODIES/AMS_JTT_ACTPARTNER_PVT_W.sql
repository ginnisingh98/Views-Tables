--------------------------------------------------------
--  DDL for Package Body AMS_JTT_ACTPARTNER_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AMS_JTT_ACTPARTNER_PVT_W" as
  /* $Header: amsjapnb.pls 120.0 2005/08/24 04:16:19 appldev noship $ */
  ...
  begin
    ...
    ddp_act_partner_rec.activity_partner_id := rosetta_g_miss_num_map(p7_a0);
    ddp_act_partner_rec.last_update_date := rosetta_g_miss_date_in_map(p7_a1);
    ddp_act_partner_rec.last_updated_by := rosetta_g_miss_num_map(p7_a2);
    ddp_act_partner_rec.creation_date := rosetta_g_miss_date_in_map(p7_a3);
    ddp_act_partner_rec.created_by := rosetta_g_miss_num_map(p7_a4);
    ddp_act_partner_rec.last_update_login := rosetta_g_miss_num_map(p7_a5);
    ddp_act_partner_rec.object_version_number := rosetta_g_miss_num_map(p7_a6);
    ddp_act_partner_rec.act_partner_used_by_id := rosetta_g_miss_num_map(p7_a7);
    ddp_act_partner_rec.arc_act_partner_used_by := p7_a8;
    ddp_act_partner_rec.partner_id := rosetta_g_miss_num_map(p7_a9);
    ...
    ddp_act_partner_rec.preferred_vad_id := rosetta_g_miss_num_map(p7_a14);
    ddp_act_partner_rec.partner_address_id := rosetta_g_miss_num_map(p7_a15);
    ddp_act_partner_rec.primary_contact_id := rosetta_g_miss_num_map(p7_a16);
  ...
  begin
    ...
    ddp_act_partner_rec.activity_partner_id := rosetta_g_miss_num_map(p6_a0);
    ddp_act_partner_rec.last_update_date := rosetta_g_miss_date_in_map(p6_a1);
    ddp_act_partner_rec.last_updated_by := rosetta_g_miss_num_map(p6_a2);
    ddp_act_partner_rec.creation_date := rosetta_g_miss_date_in_map(p6_a3);
    ddp_act_partner_rec.created_by := rosetta_g_miss_num_map(p6_a4);
    ddp_act_partner_rec.last_update_login := rosetta_g_miss_num_map(p6_a5);
    ddp_act_partner_rec.object_version_number := rosetta_g_miss_num_map(p6_a6);
    ddp_act_partner_rec.act_partner_used_by_id := rosetta_g_miss_num_map(p6_a7);
    ddp_act_partner_rec.arc_act_partner_used_by := p6_a8;
    ddp_act_partner_rec.partner_id := rosetta_g_miss_num_map(p6_a9);
    ...
    ddp_act_partner_rec.preferred_vad_id := rosetta_g_miss_num_map(p6_a14);
    ddp_act_partner_rec.partner_address_id := rosetta_g_miss_num_map(p6_a15);
    ddp_act_partner_rec.primary_contact_id := rosetta_g_miss_num_map(p6_a16);
  ...
  procedure check_act_partner_items(p_validation_mode  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
  ...
  begin
    ...
    -- copy data to the local IN or IN-OUT args, if any
    ddp_act_partner_rec.activity_partner_id := rosetta_g_miss_num_map(p0_a0);
    ddp_act_partner_rec.last_update_date := rosetta_g_miss_date_in_map(p0_a1);
    ddp_act_partner_rec.last_updated_by := rosetta_g_miss_num_map(p0_a2);
    ddp_act_partner_rec.creation_date := rosetta_g_miss_date_in_map(p0_a3);
    ddp_act_partner_rec.created_by := rosetta_g_miss_num_map(p0_a4);
    ddp_act_partner_rec.last_update_login := rosetta_g_miss_num_map(p0_a5);
    ddp_act_partner_rec.object_version_number := rosetta_g_miss_num_map(p0_a6);
    ddp_act_partner_rec.act_partner_used_by_id := rosetta_g_miss_num_map(p0_a7);
    ddp_act_partner_rec.arc_act_partner_used_by := p0_a8;
    ddp_act_partner_rec.partner_id := rosetta_g_miss_num_map(p0_a9);
    ...
    ddp_act_partner_rec.preferred_vad_id := rosetta_g_miss_num_map(p0_a14);
    ddp_act_partner_rec.partner_address_id := rosetta_g_miss_num_map(p0_a15);
    ddp_act_partner_rec.primary_contact_id := rosetta_g_miss_num_map(p0_a16);
  ...
  procedure check_act_partner_record(x_return_status out nocopy  VARCHAR2
    , p0_a0  NUMBER := 0-1962.0724
    , p0_a1  DATE := fnd_api.g_miss_date
    , p0_a2  NUMBER := 0-1962.0724
    , p0_a3  DATE := fnd_api.g_miss_date
  ...
  begin
    ...
    ddp_complete_rec.activity_partner_id := rosetta_g_miss_num_map(p1_a0);
    ...
    ddp_complete_rec.act_partner_used_by_id := rosetta_g_miss_num_map(p1_a7);
    ddp_complete_rec.arc_act_partner_used_by := p1_a8;
    ddp_complete_rec.partner_id := rosetta_g_miss_num_map(p1_a9);
    ...
    ddp_complete_rec.preferred_vad_id := rosetta_g_miss_num_map(p1_a14);
    ddp_complete_rec.partner_address_id := rosetta_g_miss_num_map(p1_a15);
    ddp_complete_rec.primary_contact_id := rosetta_g_miss_num_map(p1_a16);
  ...
  begin
    ...
    -- copy data back from the local variables to OUT or IN-OUT args, if any
    p0_a0 := rosetta_g_miss_num_map(ddx_act_partner_rec.activity_partner_id);
    p0_a1 := ddx_act_partner_rec.last_update_date;
    p0_a2 := rosetta_g_miss_num_map(ddx_act_partner_rec.last_updated_by);
    p0_a3 := ddx_act_partner_rec.creation_date;
    p0_a4 := rosetta_g_miss_num_map(ddx_act_partner_rec.created_by);
    p0_a5 := rosetta_g_miss_num_map(ddx_act_partner_rec.last_update_login);
    p0_a6 := rosetta_g_miss_num_map(ddx_act_partner_rec.object_version_number);
    p0_a7 := rosetta_g_miss_num_map(ddx_act_partner_rec.act_partner_used_by_id);
    p0_a8 := ddx_act_partner_rec.arc_act_partner_used_by;
    p0_a9 := rosetta_g_miss_num_map(ddx_act_partner_rec.partner_id);
    ...
    p0_a14 := rosetta_g_miss_num_map(ddx_act_partner_rec.preferred_vad_id);
    p0_a15 := rosetta_g_miss_num_map(ddx_act_partner_rec.partner_address_id);
    p0_a16 := rosetta_g_miss_num_map(ddx_act_partner_rec.primary_contact_id);
  ...
  procedure complete_act_partner_rec(p1_a0 out nocopy  NUMBER
  ...
  begin
    ...
    p1_a0 := rosetta_g_miss_num_map(ddx_complete_rec.activity_partner_id);
    ...
    p1_a7 := rosetta_g_miss_num_map(ddx_complete_rec.act_partner_used_by_id);
    p1_a8 := ddx_complete_rec.arc_act_partner_used_by;
    p1_a9 := rosetta_g_miss_num_map(ddx_complete_rec.partner_id);
    ...
    p1_a14 := rosetta_g_miss_num_map(ddx_complete_rec.preferred_vad_id);
    p1_a15 := rosetta_g_miss_num_map(ddx_complete_rec.partner_address_id);
    p1_a16 := rosetta_g_miss_num_map(ddx_complete_rec.primary_contact_id);
