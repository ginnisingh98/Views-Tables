--------------------------------------------------------
--  DDL for Package Body BEN_REPORTING_GROUP_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_REPORTING_GROUP_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_REPORTING_GROUP_BK1.CREATE_REPORTING_GROUP_A', 10);
hr_utility.set_location(' Leaving: BEN_REPORTING_GROUP_BK1.CREATE_REPORTING_GROUP_A', 20);
end CREATE_REPORTING_GROUP_A;
...
begin
hr_utility.set_location('Entering: BEN_REPORTING_GROUP_BK1.CREATE_REPORTING_GROUP_B', 10);
hr_utility.set_location(' Leaving: BEN_REPORTING_GROUP_BK1.CREATE_REPORTING_GROUP_B', 20);
end CREATE_REPORTING_GROUP_B;
