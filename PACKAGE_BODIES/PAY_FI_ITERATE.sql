--------------------------------------------------------
--  DDL for Package Body PAY_FI_ITERATE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_FI_ITERATE" AS
 /* $Header: pyfiiter.pkb 120.0 2005/05/29 04:53:17 appldev noship $ */
 --
