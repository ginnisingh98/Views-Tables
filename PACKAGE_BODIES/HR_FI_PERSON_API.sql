--------------------------------------------------------
--  DDL for Package Body HR_FI_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_FI_PERSON_API" AS
  /* $Header: peperfii.pkb 120.1.12000000.2 2007/02/14 12:29:01 dbehera noship $ */

   -- Package Variables
   g_package  VARCHAR2(33) := 'hr_fi_person_api.';
...
begin
 ...
 l_proc:= g_package||'update_fi_person';
 if g_debug then
