--------------------------------------------------------
--  DDL for Package Body GHR_SF52_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_SF52_BK2" as
...
,P_I_PA_ROUTING_HISTORY_ID in NUMBER
,P_I_PRH_OBJECT_VERSION_NUMBER in NUMBER
...
begin
hr_utility.set_location('Entering: GHR_SF52_BK2.UPDATE_SF52_A', 10);
hr_utility.set_location(' Leaving: GHR_SF52_BK2.UPDATE_SF52_A', 20);
end UPDATE_SF52_A;
procedure UPDATE_SF52_B
(P_PA_REQUEST_ID in NUMBER
,P_NOA_FAMILY_CODE in VARCHAR2
,P_ROUTING_GROUP_ID in NUMBER
,P_PROPOSED_EFFECTIVE_ASAP_FLAG in VARCHAR2
...
begin
hr_utility.set_location('Entering: GHR_SF52_BK2.UPDATE_SF52_B', 10);
hr_utility.set_location(' Leaving: GHR_SF52_BK2.UPDATE_SF52_B', 20);
end UPDATE_SF52_B;
end GHR_SF52_BK2;
