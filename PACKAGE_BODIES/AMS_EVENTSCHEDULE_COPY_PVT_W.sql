--------------------------------------------------------
--  DDL for Package Body AMS_EVENTSCHEDULE_COPY_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AMS_EVENTSCHEDULE_COPY_PVT_W" as
  /* $Header: amswescb.pls 115.4 2004/04/08 09:11:12 anchaudh ship $ */
  ...
  begin
    ...
    ams_eventschedule_copy_pvt.copy_event_schedule(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      x_return_status,
