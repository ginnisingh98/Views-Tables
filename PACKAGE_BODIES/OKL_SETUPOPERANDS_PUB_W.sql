--------------------------------------------------------
--  DDL for Package Body OKL_SETUPOPERANDS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPOPERANDS_PUB_W" as
  /* $Header: OKLUSOPB.pls 120.1 2005/07/19 07:35:12 asawanka noship $ */
  ...
  procedure get_rec(x_return_status out nocopy  VARCHAR2
    ...
    , p4_a14 out nocopy  DATE
    , p4_a15 out nocopy  NUMBER
    , p4_a16 out nocopy  DATE
  ...
  as
    ddp_opdv_rec okl_setupoperands_pub.opdv_rec_type;
    ddx_no_data_found boolean;
    ddx_opdv_rec okl_setupoperands_pub.opdv_rec_type;
  ...
  begin
    ...
    okl_setupoperands_pub.get_rec(ddp_opdv_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_opdv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_opdv_rec.id);
    p4_a1 := rosetta_g_miss_num_map(ddx_opdv_rec.object_version_number);
    p4_a2 := ddx_opdv_rec.sfwt_flag;
    p4_a3 := rosetta_g_miss_num_map(ddx_opdv_rec.fma_id);
    p4_a4 := rosetta_g_miss_num_map(ddx_opdv_rec.dsf_id);
    p4_a5 := ddx_opdv_rec.name;
    p4_a6 := ddx_opdv_rec.description;
    p4_a7 := ddx_opdv_rec.version;
    p4_a8 := ddx_opdv_rec.start_date;
    p4_a9 := ddx_opdv_rec.end_date;
    p4_a10 := ddx_opdv_rec.source;
    p4_a11 := ddx_opdv_rec.opd_type;
    p4_a12 := rosetta_g_miss_num_map(ddx_opdv_rec.org_id);
    p4_a13 := rosetta_g_miss_num_map(ddx_opdv_rec.created_by);
    p4_a14 := ddx_opdv_rec.creation_date;
    p4_a15 := rosetta_g_miss_num_map(ddx_opdv_rec.last_updated_by);
    p4_a16 := ddx_opdv_rec.last_update_date;
    p4_a17 := rosetta_g_miss_num_map(ddx_opdv_rec.last_update_login);
  end;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupoperands_pub.insert_operands(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupoperands_pub.update_operands(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
