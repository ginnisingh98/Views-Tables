--------------------------------------------------------
--  DDL for Package Body OTA_FORUM_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_FORUM_SWI" As
/* $Header: otfrmswi.pkb 120.0 2005/06/24 07:57 appldev noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'ota_forum_swi.';
--
-- ----------------------------------------------------------------------------
-- |-----------------------------< create_forum >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  ota_frm_ins.set_base_key_value
  (
...
PROCEDURE update_forum
  ...
  --
  -- Other variables
  l_proc    varchar2(72) := g_package ||'update_forum';
Begin
  hr_utility.set_location(' Entering:' || l_proc,10);
  --
  -- Issue a savepoint
  --
  savepoint update_forum_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
