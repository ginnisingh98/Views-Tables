--------------------------------------------------------
--  DDL for Package Body BNE_RAW_QUERY_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BNE_RAW_QUERY_PKG" as
/* $Header: bnerawqueryb.pls 120.2 2005/06/29 03:40:52 dvayro noship $ */
...
procedure INSERT_ROW (
  ...
  cursor C is select ROWID from BNE_RAW_QUERY
    where APPLICATION_ID = X_APPLICATION_ID
    and QUERY_CODE = X_QUERY_CODE
    and SEQUENCE_NUM = X_SEQUENCE_NUM
    ;
begin
  insert into BNE_RAW_QUERY (
    APPLICATION_ID,
    QUERY_CODE,
    SEQUENCE_NUM,
...
--  PROCEDURE:     LOAD_ROW                                                   --
--                                                                            --
--  DESCRIPTION:   Load a row into the BNE_RAW_QUERY entity.                  --
