--------------------------------------------------------
--  DDL for Package Body IRC_IPT_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_IPT_RKU" as
...
begin
hr_utility.set_location('Entering: IRC_IPT_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: IRC_IPT_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end IRC_IPT_RKU;
