--------------------------------------------------------
--  DDL for Package Body IGC_CC_MC_HEADERS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGC_CC_MC_HEADERS_PKG" as
/* $Header: IGCCMCHB.pls 120.3.12000000.1 2007/08/20 12:13:02 mbremkum ship $  */

 G_PKG_NAME CONSTANT VARCHAR2(30):= 'IGC_CC_MC_HEADERS_PKG';
...
/* ================================================================================
 ...
 IS
    ...
    CURSOR C IS SELECT Rowid FROM IGC_CC_MC_HEADERS
