--------------------------------------------------------
--  DDL for Package Body OKL_PROCESS_TRX_TYPES_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PROCESS_TRX_TYPES_PVT_W" as
  /* $Header: OKLETXTB.pls 120.2 2005/07/12 09:12:10 dkagrawa noship $ */
  ...
  as
    ddp_tryv_rec okl_process_trx_types_pvt.tryv_rec_type;
    ddx_tryv_rec okl_process_trx_types_pvt.tryv_rec_type;
  ...
  begin
    ...
    okl_process_trx_types_pvt.insert_trx_types(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tryv_tbl okl_process_trx_types_pvt.tryv_tbl_type;
    ddx_tryv_tbl okl_process_trx_types_pvt.tryv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_trx_types_pvt.update_trx_types(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_trx_types_pvt.delete_trx_types(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_process_trx_types_pvt_w;
