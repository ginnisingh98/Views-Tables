--------------------------------------------------------
--  DDL for Package Body WIP_WOL_DIAG_UNCOSTED_MAT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WIP_WOL_DIAG_UNCOSTED_MAT" as
/* $Header: WIPDW01B.pls 120.0.12000000.1 2007/07/10 10:45:34 mraman noship $ */
PROCEDURE init is
BEGIN
null;
END init;
...
WIP_DIAG_WOL_FLOW.Uncosted_mat_txn_wol(inputs,report,reportClob);

END runTest;

PROCEDURE getComponentName(name OUT NOCOPY VARCHAR2) IS
BEGIN
name := 'Health Check - Work Orderless/Flow Schedules.';
...
'Run this diagnostic when WIP material transactions related to workorder less or flow schedules do not get costed or error out during'
|| ' costing.<BR> Please see the diagnostic output for recommended actions.<BR> It is recommended to run this health check before'||
' period close.';
END getTestDesc;
