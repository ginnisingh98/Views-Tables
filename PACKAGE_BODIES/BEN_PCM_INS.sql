--------------------------------------------------------
--  DDL for Package Body BEN_PCM_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PCM_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pcm_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    select t.created_by,
           t.creation_date
    from   ben_per_cm_f t
    where  t.per_cm_id       = p_rec.per_cm_id
    and    t.effective_start_date =
             ben_pcm_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_per_cm_f.created_by%TYPE;
  l_creation_date       ben_per_cm_f.creation_date%TYPE;
  l_last_update_date   	ben_per_cm_f.last_update_date%TYPE;
  l_last_updated_by     ben_per_cm_f.last_updated_by%TYPE;
  l_last_update_login   ben_per_cm_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_per_cm_f
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_pcm_rec
