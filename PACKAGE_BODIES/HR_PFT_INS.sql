--------------------------------------------------------
--  DDL for Package Body HR_PFT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PFT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_pft_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: hr_all_positions_f_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.position_id                      := p_position_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  hr_pft_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hr_pft_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
...
Begin
  ...
  --
  hr_pft_upd.upd_key_flex_meanings( p_position_id
