--------------------------------------------------------
--  DDL for Package Body OKL_MISC_TRANS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_MISC_TRANS_PVT_W" as
  /* $Header: OKLEMSCB.pls 120.2 2005/10/30 03:20:25 appldev noship $ */
  ...
  procedure rosetta_table_copy_in_p14(t out nocopy okl_misc_trans_pvt.jrnl_line_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).tcn_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).description := a4(indx);
          t(ddindx).avl_id := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).sty_id := rosetta_g_miss_num_map(a6(indx));
  ...
  procedure rosetta_table_copy_out_p14(t okl_misc_trans_pvt.jrnl_line_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a8 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).tcn_id);
          a4(indx) := t(ddindx).description;
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).avl_id);
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).sty_id);
  ...
  as
    ddp_tclv_rec okl_misc_trans_pvt.tclv_rec_type;
    ddx_tclv_rec okl_misc_trans_pvt.tclv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_misc_trans_pvt.create_misc_dstr_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure create_dist_line(x_return_status out nocopy  VARCHAR2
  ...
  begin
    ...
    -- copy data to the local IN or IN-OUT args, if any
    ddp_tclv_rec.id := rosetta_g_miss_num_map(p0_a0);
    ddp_tclv_rec.object_version_number := rosetta_g_miss_num_map(p0_a1);
    ddp_tclv_rec.sty_id := rosetta_g_miss_num_map(p0_a2);
    ddp_tclv_rec.rct_id := rosetta_g_miss_num_map(p0_a3);
    ddp_tclv_rec.btc_id := rosetta_g_miss_num_map(p0_a4);
    ddp_tclv_rec.tcn_id := rosetta_g_miss_num_map(p0_a5);
    ddp_tclv_rec.khr_id := rosetta_g_miss_num_map(p0_a6);
    ddp_tclv_rec.kle_id := rosetta_g_miss_num_map(p0_a7);
    ddp_tclv_rec.before_transfer_yn := p0_a8;
    ddp_tclv_rec.line_number := rosetta_g_miss_num_map(p0_a9);
    ddp_tclv_rec.description := p0_a10;
    ddp_tclv_rec.amount := rosetta_g_miss_num_map(p0_a11);
    ddp_tclv_rec.currency_code := p0_a12;
    ddp_tclv_rec.gl_reversal_yn := p0_a13;
    ddp_tclv_rec.attribute_category := p0_a14;
    ddp_tclv_rec.attribute1 := p0_a15;
    ddp_tclv_rec.attribute2 := p0_a16;
    ddp_tclv_rec.attribute3 := p0_a17;
    ddp_tclv_rec.attribute4 := p0_a18;
    ddp_tclv_rec.attribute5 := p0_a19;
    ddp_tclv_rec.attribute6 := p0_a20;
    ddp_tclv_rec.attribute7 := p0_a21;
    ddp_tclv_rec.attribute8 := p0_a22;
    ddp_tclv_rec.attribute9 := p0_a23;
    ddp_tclv_rec.attribute10 := p0_a24;
    ddp_tclv_rec.attribute11 := p0_a25;
    ddp_tclv_rec.attribute12 := p0_a26;
    ddp_tclv_rec.attribute13 := p0_a27;
    ddp_tclv_rec.attribute14 := p0_a28;
    ddp_tclv_rec.attribute15 := p0_a29;
    ddp_tclv_rec.tcl_type := p0_a30;
    ddp_tclv_rec.created_by := rosetta_g_miss_num_map(p0_a31);
    ddp_tclv_rec.creation_date := rosetta_g_miss_date_in_map(p0_a32);
    ddp_tclv_rec.last_updated_by := rosetta_g_miss_num_map(p0_a33);
    ddp_tclv_rec.last_update_date := rosetta_g_miss_date_in_map(p0_a34);
    ddp_tclv_rec.org_id := rosetta_g_miss_num_map(p0_a35);
    ddp_tclv_rec.program_id := rosetta_g_miss_num_map(p0_a36);
    ddp_tclv_rec.program_application_id := rosetta_g_miss_num_map(p0_a37);
    ddp_tclv_rec.request_id := rosetta_g_miss_num_map(p0_a38);
    ddp_tclv_rec.program_update_date := rosetta_g_miss_date_in_map(p0_a39);
    ddp_tclv_rec.last_update_login := rosetta_g_miss_num_map(p0_a40);
    ddp_tclv_rec.avl_id := rosetta_g_miss_num_map(p0_a41);
    ddp_tclv_rec.bkt_id := rosetta_g_miss_num_map(p0_a42);
    ddp_tclv_rec.kle_id_new := rosetta_g_miss_num_map(p0_a43);
    ddp_tclv_rec.percentage := rosetta_g_miss_num_map(p0_a44);
    ddp_tclv_rec.accrual_rule_yn := p0_a45;


    -- here's the delegated call to the old PL/SQL routine
    okl_misc_trans_pvt.create_dist_line(ddp_tclv_rec,
      x_return_status);
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_misc_trans_pvt.create_misc_transaction(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_misc_trans_pvt.update_misc_transaction(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
