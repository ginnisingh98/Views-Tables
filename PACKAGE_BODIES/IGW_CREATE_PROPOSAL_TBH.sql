--------------------------------------------------------
--  DDL for Package Body IGW_CREATE_PROPOSAL_TBH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGW_CREATE_PROPOSAL_TBH" as
 /* $Header: igwtcprb.pls 115.4 2002/11/14 18:44:11 vmedikon ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    FND_MSG_PUB.add_exc_msg( p_pkg_name    => 'IGW_CREATE_PROPOSAL_TBH'
