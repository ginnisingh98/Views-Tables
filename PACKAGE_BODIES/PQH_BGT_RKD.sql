--------------------------------------------------------
--  DDL for Package Body PQH_BGT_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_BGT_RKD" as
...
begin
hr_utility.set_location('Entering: PQH_BGT_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PQH_BGT_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PQH_BGT_RKD;
