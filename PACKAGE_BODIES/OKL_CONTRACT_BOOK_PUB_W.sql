--------------------------------------------------------
--  DDL for Package Body OKL_CONTRACT_BOOK_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CONTRACT_BOOK_PUB_W" as
  /* $Header: OKLUBKGB.pls 120.0 2008/02/14 09:33:41 veramach noship $ */
  ...
  begin
    ...
    okl_contract_book_pub.execute_qa_check_list(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_book_pub.validate_contract(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
