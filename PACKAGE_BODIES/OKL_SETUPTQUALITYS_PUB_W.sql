--------------------------------------------------------
--  DDL for Package Body OKL_SETUPTQUALITYS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPTQUALITYS_PUB_W" as
  /* $Header: OKLUSTQB.pls 115.2 2002/12/24 04:21:45 sgorantl noship $ */
  ...
  as
    ddp_ptqv_rec okl_setuptqualitys_pub.ptqv_rec_type;
    ddx_no_data_found boolean;
    ddx_ptqv_rec okl_setuptqualitys_pub.ptqv_rec_type;
  ...
  begin
    ...
    okl_setuptqualitys_pub.get_rec(ddp_ptqv_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_ptqv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_ptqv_rec.id);
    p4_a1 := rosetta_g_miss_num_map(ddx_ptqv_rec.object_version_number);
    p4_a2 := ddx_ptqv_rec.name;
    p4_a3 := ddx_ptqv_rec.description;
    p4_a4 := ddx_ptqv_rec.from_date;
    p4_a5 := ddx_ptqv_rec.to_date;
    p4_a6 := rosetta_g_miss_num_map(ddx_ptqv_rec.created_by);
    p4_a7 := ddx_ptqv_rec.creation_date;
    p4_a8 := rosetta_g_miss_num_map(ddx_ptqv_rec.last_updated_by);
    p4_a9 := ddx_ptqv_rec.last_update_date;
    p4_a10 := rosetta_g_miss_num_map(ddx_ptqv_rec.last_update_login);
  end;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuptqualitys_pub.insert_tqualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuptqualitys_pub.update_tqualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
