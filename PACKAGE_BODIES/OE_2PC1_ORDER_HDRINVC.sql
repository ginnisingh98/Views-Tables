--------------------------------------------------------
--  DDL for Package Body OE_2PC1_ORDER_HDRINVC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC1_ORDER_HDRINVC" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_status_code varchar2(8) :='COMPLETE';
   ...
   AND a.HEADER_ID = OE_LINE_SECURITY.g_record.HEADER_ID
;
