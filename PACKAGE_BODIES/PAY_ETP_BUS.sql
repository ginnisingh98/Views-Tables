--------------------------------------------------------
--  DDL for Package Body PAY_ETP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ETP_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_etp_bus.';  -- Global package name
--
...
Begin
  ...
  --
  if ( nvl(pay_etp_bus.g_element_type_id, hr_api.g_number)
    ...
    -- variable.
    --
    l_legislation_code := pay_etp_bus.g_legislation_code;
    ...
    --
    close csr_leg_code;
    pay_etp_bus.g_element_type_id             := p_element_type_id;
    pay_etp_bus.g_legislation_code  := l_legislation_code;
  end if;
...
begin
  ...
  if ((p_rec.element_type_id is not null)  and
    (nvl(pay_etp_shd.g_old_rec.element_information_category,
         hr_api.g_varchar2) <>
    nvl(p_rec.element_information_category, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information1, hr_api.g_varchar2) <>
    nvl(p_rec.element_information1, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information2, hr_api.g_varchar2) <>
    nvl(p_rec.element_information2, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information3, hr_api.g_varchar2) <>
    nvl(p_rec.element_information3, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information4, hr_api.g_varchar2) <>
    nvl(p_rec.element_information4, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information5, hr_api.g_varchar2) <>
    nvl(p_rec.element_information5, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information6, hr_api.g_varchar2) <>
    nvl(p_rec.element_information6, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information7, hr_api.g_varchar2) <>
    nvl(p_rec.element_information7, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information8, hr_api.g_varchar2) <>
    nvl(p_rec.element_information8, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information9, hr_api.g_varchar2) <>
    nvl(p_rec.element_information9, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information10, hr_api.g_varchar2) <>
    nvl(p_rec.element_information10, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information11, hr_api.g_varchar2) <>
    nvl(p_rec.element_information11, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information12, hr_api.g_varchar2) <>
    nvl(p_rec.element_information12, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information13, hr_api.g_varchar2) <>
    nvl(p_rec.element_information13, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information14, hr_api.g_varchar2) <>
    nvl(p_rec.element_information14, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information15, hr_api.g_varchar2) <>
    nvl(p_rec.element_information15, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information16, hr_api.g_varchar2) <>
    nvl(p_rec.element_information16, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information17, hr_api.g_varchar2) <>
    nvl(p_rec.element_information17, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information18, hr_api.g_varchar2) <>
    nvl(p_rec.element_information18, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information19, hr_api.g_varchar2) <>
    nvl(p_rec.element_information19, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.element_information20, hr_api.g_varchar2) <>
...
begin
  ...
  --
  if ((p_rec.element_type_id is not null)  and (
    nvl(pay_etp_shd.g_old_rec.attribute_category, hr_api.g_varchar2) <>
    nvl(p_rec.attribute_category, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute1, hr_api.g_varchar2) <>
    nvl(p_rec.attribute1, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute2, hr_api.g_varchar2) <>
    nvl(p_rec.attribute2, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute3, hr_api.g_varchar2) <>
    nvl(p_rec.attribute3, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute4, hr_api.g_varchar2) <>
    nvl(p_rec.attribute4, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute5, hr_api.g_varchar2) <>
    nvl(p_rec.attribute5, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute6, hr_api.g_varchar2) <>
    nvl(p_rec.attribute6, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute7, hr_api.g_varchar2) <>
    nvl(p_rec.attribute7, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute8, hr_api.g_varchar2) <>
    nvl(p_rec.attribute8, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute9, hr_api.g_varchar2) <>
    nvl(p_rec.attribute9, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute10, hr_api.g_varchar2) <>
    nvl(p_rec.attribute10, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute11, hr_api.g_varchar2) <>
    nvl(p_rec.attribute11, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute12, hr_api.g_varchar2) <>
    nvl(p_rec.attribute12, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute13, hr_api.g_varchar2) <>
    nvl(p_rec.attribute13, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute14, hr_api.g_varchar2) <>
    nvl(p_rec.attribute14, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute15, hr_api.g_varchar2) <>
    nvl(p_rec.attribute15, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute16, hr_api.g_varchar2) <>
    nvl(p_rec.attribute16, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute17, hr_api.g_varchar2) <>
    nvl(p_rec.attribute17, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute18, hr_api.g_varchar2) <>
    nvl(p_rec.attribute18, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute19, hr_api.g_varchar2) <>
    nvl(p_rec.attribute19, hr_api.g_varchar2)  or
    nvl(pay_etp_shd.g_old_rec.attribute20, hr_api.g_varchar2) <>
...
Begin
  ...
  --
  IF NOT pay_etp_shd.api_updating
...
Begin
  ...
  If p_element_type_id is not null and
     (p_multiple_entries_allowed_flg <>
      pay_etp_shd.g_old_rec.multiple_entries_allowed_flag) Then
     --
...
Begin
  ...
  End If;
  If p_element_type_id is not null and
     (p_processing_priority <> pay_etp_shd.g_old_rec.processing_priority) Then
    --
...
Begin
  ...
  If p_element_type_id is not null and
     (p_third_party_pay_only_flag <>
      nvl(pay_etp_shd.g_old_rec.third_party_pay_only_flag,hr_api.g_varchar2))
     Then
    --
...
--	is valid or not.
--      The typical business logic is as below:
--	1) If the user has specified the time definition type as STATIC (S)
--         and the time definition id has not specified then the message
--         PAY_34080_FLSA_STATIC_TIME will be raised.
--      2) If the user has specified time definition type other than STATIC(S)
--         and time definition id also then the message
--	   PAY_34052_FLSA_ARG_NOT_NULL will be raised.
-- In parameters:
--	P_TIME_DEFINITION_ID   : ID of the time defintion specified.
--	P_TIME_DEFINITION_TYPE : Time Definition Type
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure chk_time_definition(p_time_definition_id   NUMBER
...
--
	hr_utility.set_location('Entering:'||l_proc, 5);
	If (p_time_definition_type <> hr_api.g_varchar2) AND
	   -- The below check has been added because, we treat NULL and N as same for
	   -- the table PAY_ELEMENT_TYPES_F for the column TIME_DEFINITION_TYPE.
	   -- So no need to check if the value is NULL or N.
           (p_time_definition_type IS NOT NULL AND p_time_definition_type <> 'N') AND
	    hr_api.not_exists_in_hr_lookups( p_effective_date
					    ,'PAY_TIME_DEFINITION_TYPE'
					    ,p_time_definition_type) Then

		hr_utility.set_location('The user has passed some value to time definition type ', 20);
		fnd_message.set_name('PAY','HR_52966_INVALID_LOOKUP');
		fnd_message.set_token('COLUMN','TIME_DEFINITION_TYPE');
		fnd_message.set_token('LOOKUP_TYPE','PAY_TIME_DEFINITION_TYPE');
		fnd_message.raise_error;
	ELSIF ( p_time_definition_type = 'S' ) THEN
		IF (p_time_definition_id IS NOT NULL) THEN
			...
			close csr_time_definition;
		ELSE
			fnd_message.set_name('PAY','PAY_34080_FLSA_STATIC_TIME');
			fnd_message.raise_error;
		END IF;
	ELSIF (nvl(p_time_definition_type, '-1') <> 'S' AND p_time_definition_id IS NOT NULL) THEN
		fnd_message.set_name('PAY','PAY_34052_FLSA_ARG_NOT_NULL');
		fnd_message.set_token('ARGUMENT','TIME_DEFINITION_ID');
		fnd_message.raise_error;
	END IF;
	hr_utility.set_location('Leaving:'||l_proc, 10);
--
...
--
-- Description:
--	This procedure is used to check whether the specified advance element or
--	dediction element is valid or not.
--      The typical business logic is as below:
--	1) If the user has specified the advance_element_type_id as Invalid or
--	   deduction_element_type_id as invalid then the message
--	   PAY_34080_FLSA_STATIC_TIME will be raised.
--      2) If the user has specified advance_payable as 'N' and advance_element_type_id
--         is passed as a parameter to API then then the message
--	   PAY_34052_FLSA_ARG_NOT_NULL will be raised.
--	   Same is checked for advance_deduction.
-- In parameters:
--	P_TIME_DEFINITION_ID   : ID of the time defintion specified.
--	P_TIME_DEFINITION_TYPE : Time Definition Type
--      P_BUSINESS_GROUP_ID    : Business Group ID
...
--
	l_proc  varchar2(72) := g_package||'get_advance_element';
	l_flag  varchar2(1);
	l_count number;
	l_a_count number;
	l_d_count number;
...
--
    hr_utility.set_location('Entering:'||l_proc, 5);
-- Parameter Vaidation
 -- check if the flag is not set but the id is passed
    If ( p_advance_payable = 'N' OR p_advance_payable is Null) and p_advance_element_type_id is not null then
	fnd_message.set_name('PAY','PAY_33299_INVALID_ADVANCE_PAY');
	fnd_message.set_token('ADVANCE_PAYABLE', 'Advance Payable' );
	fnd_message.set_token('ADVANCE', 'Advance' );
	fnd_message.raise_error;
    end if;
    --
    If ( p_advance_deduction = 'N' OR p_advance_deduction is Null) and p_deduction_element_type_id is not null  then
	fnd_message.set_name('PAY','PAY_33299_INVALID_ADVANCE_PAY');
	fnd_message.set_token('ADVANCE_PAYABLE', 'Advance Deduction' );
	fnd_message.set_token('ADVANCE', 'Deduction' );
	fnd_message.raise_error;
    end if;
    --
--
	...
	if p_advance_payable = 'Y'  and p_advance_element_type_id is not null then
		...
		if l_count = 0 then
			fnd_message.set_name('PAY','PAY_33739_INVALID_ADVANCE_ARG');
			fnd_message.set_token('ADVANCE', 'Advance' );
			fnd_message.raise_error;
		end if;
	end if;
	--
	--Normal element with Deduction Element
   ...
   if p_datetrack_mode = 'DELETE_NEXT_CHANGE' or p_datetrack_mode = 'DELETE_FUTURE_CHANGE' then
	...
	--
		...
		if l_count = 0 then
			fnd_message.set_name('PAY','PAY_33425_ADV_ELM_NCD');
			fnd_message.set_token('ADVANCE', 'Advance' );
   ...
   -- PURGE Mode For Advance Element.
...
-- end of ZAP
  ...
  --DELETE Mode For Advance Element.
	...
	if l_count <> 0 then
		...
		select  count(*) into l_d_count from pay_element_types_f
			where deduction_element_type_id = p_element_type_id
			  ...
			  and p_effective_date between effective_start_date and effective_end_date;
			--
			if l_a_count > 0 OR l_d_count > 0 then
				fnd_message.set_name('PAY','PAY_33450_ADVANCE_ELE_DELETE');
				fnd_message.set_token('ADVANCE', 'Advance or Deduction' );
				fnd_message.set_token('DELETE_MODE', p_datetrack_mode);
				fnd_message.raise_error;
			end if;
	end if;
...
Begin
  ...
  --
  If (
     (p_indirect_only_flag <> pay_etp_shd.g_old_rec.indirect_only_flag)
     or
     (p_additional_entry_allowed_flg <>
      pay_etp_shd.g_old_rec.additional_entry_allowed_flag)
     or
     (p_standard_link_flag <> pay_etp_shd.g_old_rec.standard_link_flag)
     or
     (p_adjustment_only_flag <> pay_etp_shd.g_old_rec.adjustment_only_flag)
     or
     (p_post_termination_rule <> pay_etp_shd.g_old_rec.post_termination_rule)
     or
     (p_process_in_run_flag <> pay_etp_shd.g_old_rec.process_in_run_flag)
     or
     (p_once_each_period_flag <> pay_etp_shd.g_old_rec.once_each_period_flag)
     ) Then
    --
    ...
    If l_element_links Then
      ...
      --
    End If;
    If (p_adjustment_only_flag <> pay_etp_shd.g_old_rec.adjustment_only_flag
       )Then
      --
      ...
      --
    End If;
    If ((p_post_termination_rule <> pay_etp_shd.g_old_rec.post_termination_rule)
       or
       (p_process_in_run_flag <> pay_etp_shd.g_old_rec.process_in_run_flag)
       or
       (p_once_each_period_flag <> pay_etp_shd.g_old_rec.once_each_period_flag)
...
Begin
  ...
  IF hr_startup_data_api_support.g_startup_mode
     ...
     hr_api.validate_bus_grp_id
       ...
       ,p_associated_column1 => pay_etp_shd.g_tab_nam
                                || '.BUSINESS_GROUP_ID');
     --
...
chk_advance_element(
  ...
  --
  pay_etp_bus.chk_ddf(p_rec);
  --
  pay_etp_bus.chk_df(p_rec);
  --
  END IF;
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End insert_validate;
