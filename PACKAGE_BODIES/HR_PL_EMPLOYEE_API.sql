--------------------------------------------------------
--  DDL for Package Body HR_PL_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PL_EMPLOYEE_API" as
/* $Header: peemppli.pkb 120.1 2005/09/26 22:45:09 mseshadr noship $ */
--
-- Package Variables
--
...
procedure create_pl_employee
  ...
  --
begin
     g_package :='hr_pl_employee_api.';
     l_proc    := g_package||'create_pl_employee OLD';
  ...
  --
  /*Bug 4340576 : Replaced existing code with call to overloaded procedure
   open csr_bg;
  fetch csr_bg
...
hr_pl_employee_api.create_pl_employee
...
begin
     g_package :='hr_pl_employee_api.';
     l_proc    := g_package||'create_pl_employee';
  ...
  ,p_attribute30                   => p_attribute30
  ,p_per_information_category      => 'PL'
  ,p_per_information1              => p_nip    --per_information2,3 not valid for employee
