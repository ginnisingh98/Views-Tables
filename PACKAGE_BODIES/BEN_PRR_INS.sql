--------------------------------------------------------
--  DDL for Package Body BEN_PRR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PRR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_prr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_perf_rtng_rt_f.created_by%TYPE;
  l_creation_date       ben_perf_rtng_rt_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_perf_rtng_rt_f
  --
...
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.perf_rtng_rt_id;
  close c1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  p_perf_rtng_rt_id  		:= l_rec.perf_rtng_rt_id;
