--------------------------------------------------------
--  DDL for Package Body PER_OSV_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_OSV_RKU" as
...
begin
hr_utility.set_location('Entering: PER_OSV_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PER_OSV_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PER_OSV_RKU;
