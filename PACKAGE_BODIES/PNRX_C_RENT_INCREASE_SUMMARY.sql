--------------------------------------------------------
--  DDL for Package Body PNRX_C_RENT_INCREASE_SUMMARY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PNRX_C_RENT_INCREASE_SUMMARY" AS
/* $Header: PNRXCRSB.pls 120.0 2007/10/03 14:26:22 rthumma noship $ */
...
IS
  ...
  BEGIN
    ...
    -- Call the inner report passing mandatory parameters (and optional parameters if any)
     pnrx_rent_increase_summary.rent_increase_summary(
...
END pnrx_c_rent_increase_summary;
