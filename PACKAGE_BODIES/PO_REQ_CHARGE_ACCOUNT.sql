--------------------------------------------------------
--  DDL for Package Body PO_REQ_CHARGE_ACCOUNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PO_REQ_CHARGE_ACCOUNT" AS
/* $Header: POXWFB5B.pls 115.4 2002/11/25 21:49:55 sbull ship $*/
    ...
    FUNCTION BUILD (
        ...
        SOURCE_DOCUMENT_LINE_NUM IN VARCHAR2 DEFAULT NULL,
...
BEGIN
  ...
  FND_MESSAGE.SET_TOKEN('FUNC', 'PO_REQ_CHARGE_ACCOUNT');
  FB_ERROR_MSG := FND_MESSAGE.GET_ENCODED;
  RETURN FALSE;
END;

END PO_REQ_CHARGE_ACCOUNT;
