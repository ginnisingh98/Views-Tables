--------------------------------------------------------
--  DDL for Package Body BEN_ABP_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ABP_RKU" as
...
begin
hr_utility.set_location('Entering: ben_abp_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_abp_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_abp_RKU;
