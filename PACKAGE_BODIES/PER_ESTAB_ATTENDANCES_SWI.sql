--------------------------------------------------------
--  DDL for Package Body PER_ESTAB_ATTENDANCES_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ESTAB_ATTENDANCES_SWI" As
/* $Header: peesaswi.pkb 115.4 2002/12/05 15:15:44 pkakar ship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'per_estab_attendances_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_attended_estab_swi;
  --
  ...
  --
  per_esa_ins.set_base_key_value
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_attended_estab_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_attended_estab_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_attended_estab_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_attended_estab_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_attended_estab_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
