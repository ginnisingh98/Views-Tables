--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_POSITION
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_POSITION" as
/*
 * Generated by hr_pump_meta_mapper at: 2013/08/29 22:08:30
 * Generated for API: HR_POSITION_API.DELETE_POSITION
 */
--
...
,P_POSITION_NAME in varchar2) is
...
decode(l.pval005,cn,nn,vn,HR_SECURITY.GET_SECURITY_PROFILE,n(l.pval005)) p5,
l.pval005 d5,
