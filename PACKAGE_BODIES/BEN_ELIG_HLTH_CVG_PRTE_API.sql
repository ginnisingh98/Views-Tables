--------------------------------------------------------
--  DDL for Package Body BEN_ELIG_HLTH_CVG_PRTE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIG_HLTH_CVG_PRTE_API" as
/* $Header: beehcapi.pkb 115.1 2002/12/24 00:06:27 rpillay noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_ELIG_HLTH_CVG_PRTE_api.';
--
-- ----------------------------------------------------------------------------
...
procedure create_ELIG_HLTH_CVG_PRTE
  ...
  --
  l_ELIG_HLTH_CVG_PRTE_id ben_ELIG_HLTH_CVG_PRTE_f.ELIG_HLTH_CVG_PRTE_id%TYPE;
  l_effective_start_date ben_ELIG_HLTH_CVG_PRTE_f.effective_start_date%TYPE;
  l_effective_end_date ben_ELIG_HLTH_CVG_PRTE_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_ELIG_HLTH_CVG_PRTE';
  l_object_version_number ben_ELIG_HLTH_CVG_PRTE_f.object_version_number%TYPE;
  --
begin
  --
  ...
  --
  savepoint create_ELIG_HLTH_CVG_PRTE;
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_ELIG_HLTH_CVG_PRTE
    --
    ben_ELIG_HLTH_CVG_PRTE_bk1.create_ELIG_HLTH_CVG_PRTE_b
      (
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_ELIG_HLTH_CVG_PRTE'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_ELIG_HLTH_CVG_PRTE
    --
  end;
  --
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_ELIG_HLTH_CVG_PRTE
    --
    ben_ELIG_HLTH_CVG_PRTE_bk1.create_ELIG_HLTH_CVG_PRTE_a
      (
       p_ELIG_HLTH_CVG_PRTE_id          =>  l_ELIG_HLTH_CVG_PRTE_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_ELIG_HLTH_CVG_PRTE
    --
  end;
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_ELIG_HLTH_CVG_PRTE;
    --
...
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_ELIG_HLTH_CVG_PRTE
    --
  ...
  exception
    ...
    --
    -- End of API User Hook for the before hook of update_ELIG_HLTH_CVG_PRTE
    --
  end;
  --
  ben_ehc_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_ELIG_HLTH_CVG_PRTE
    --
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_ELIG_HLTH_CVG_PRTE
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_ELIG_HLTH_CVG_PRTE
    --
  ...
  exception
    ...
    --
    -- End of API User Hook for the before hook of delete_ELIG_HLTH_CVG_PRTE
    --
  end;
  --
  ben_ehc_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_ELIG_HLTH_CVG_PRTE
    --
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_ELIG_HLTH_CVG_PRTE
    --
  end;
  --
  ben_profile_handler.event_handler
