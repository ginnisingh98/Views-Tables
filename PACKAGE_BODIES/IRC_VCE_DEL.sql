--------------------------------------------------------
--  DDL for Package Body IRC_VCE_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_VCE_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  irc_vce_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Delete the irc_variable_comp_elements row.
  --
  delete from irc_variable_comp_elements
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in irc_vce_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in irc_vce_shd.g_rec_type) is
--
...
Begin
  ...
  --
  irc_vce_bus.delete_validate(p_rec);
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
  -- Call the supporting pre-delete operation
  --
  irc_vce_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  irc_vce_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  irc_vce_del.post_delete(p_rec);
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
End del;
...
Begin
  ...
  l_rec.variable_comp_lookup := p_variable_comp_lookup;
