--------------------------------------------------------
--  DDL for Package Body BEN_BEC_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BEC_RKU" as
...
begin
hr_utility.set_location('Entering: ben_bec_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_bec_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_bec_RKU;
