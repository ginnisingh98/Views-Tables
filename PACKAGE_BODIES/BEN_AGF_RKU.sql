--------------------------------------------------------
--  DDL for Package Body BEN_AGF_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_AGF_RKU" as
...
begin
hr_utility.set_location('Entering: ben_agf_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_agf_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_agf_RKU;
