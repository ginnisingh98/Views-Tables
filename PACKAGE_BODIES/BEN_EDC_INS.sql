--------------------------------------------------------
--  DDL for Package Body BEN_EDC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EDC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_edc_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.elig_dsbld_stat_cvg_id       = p_rec.elig_dsbld_stat_cvg_id
    and    t.effective_start_date =
             ben_edc_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_elig_dsbld_stat_cvg_f.created_by%TYPE;
  l_creation_date       ben_elig_dsbld_stat_cvg_f.creation_date%TYPE;
  l_last_update_date   	ben_elig_dsbld_stat_cvg_f.last_update_date%TYPE;
  l_last_updated_by     ben_elig_dsbld_stat_cvg_f.last_updated_by%TYPE;
  l_last_update_login   ben_elig_dsbld_stat_cvg_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_elig_dsbld_stat_cvg_f
  --
  insert into ben_elig_dsbld_stat_cvg_f
...
--
  ...
  cursor c1 is
	select BEN_ELIG_DSBLD_STAT_CVG_F_S.nextval
 		from sys.dual;
--
--
--
Begin
  ...
  -- *
  open c1;
  fetch c1 into p_rec.ELIG_DSBLD_STAT_CVG_ID;
  close c1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  p_elig_dsbld_stat_cvg_id        	:= l_rec.elig_dsbld_stat_cvg_id;
