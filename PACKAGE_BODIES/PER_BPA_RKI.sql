--------------------------------------------------------
--  DDL for Package Body PER_BPA_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_BPA_RKI" as
...
begin
hr_utility.set_location('Entering: PER_BPA_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: PER_BPA_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end PER_BPA_RKI;
