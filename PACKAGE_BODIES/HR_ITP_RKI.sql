--------------------------------------------------------
--  DDL for Package Body HR_ITP_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ITP_RKI" as
...
begin
hr_utility.set_location('Entering: hr_itp_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: hr_itp_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end hr_itp_RKI;
