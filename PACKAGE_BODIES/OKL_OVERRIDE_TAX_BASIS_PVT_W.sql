--------------------------------------------------------
--  DDL for Package Body OKL_OVERRIDE_TAX_BASIS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_OVERRIDE_TAX_BASIS_PVT_W" as
  /* $Header: OKLEOTBB.pls 120.0 2005/08/24 14:31:45 asawanka noship $ */
  ...
  as
    ddp_tbov_rec okl_override_tax_basis_pvt.tbov_rec_type;
    ddx_tbov_rec okl_override_tax_basis_pvt.tbov_rec_type;
  ...
  begin
    ...
    okl_override_tax_basis_pvt.override_tax_basis(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tbov_tbl okl_override_tax_basis_pvt.tbov_tbl_type;
    ddx_tbov_tbl okl_override_tax_basis_pvt.tbov_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
...
end okl_override_tax_basis_pvt_w;
