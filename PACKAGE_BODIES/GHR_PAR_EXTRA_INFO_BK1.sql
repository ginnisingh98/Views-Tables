--------------------------------------------------------
--  DDL for Package Body GHR_PAR_EXTRA_INFO_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_PAR_EXTRA_INFO_BK1" as
...
procedure CREATE_PAR_EXTRA_INFO_A
...
begin
hr_utility.set_location('Entering: GHR_PAR_EXTRA_INFO_BK1.CREATE_PAR_EXTRA_INFO_A', 10);
hr_utility.set_location(' Leaving: GHR_PAR_EXTRA_INFO_BK1.CREATE_PAR_EXTRA_INFO_A', 20);
end CREATE_PAR_EXTRA_INFO_A;
procedure CREATE_PAR_EXTRA_INFO_B
(P_PA_REQUEST_ID in NUMBER
,P_INFORMATION_TYPE in VARCHAR2
,P_REI_ATTRIBUTE_CATEGORY in VARCHAR2
,P_REI_ATTRIBUTE1 in VARCHAR2
...
begin
hr_utility.set_location('Entering: GHR_PAR_EXTRA_INFO_BK1.CREATE_PAR_EXTRA_INFO_B', 10);
hr_utility.set_location(' Leaving: GHR_PAR_EXTRA_INFO_BK1.CREATE_PAR_EXTRA_INFO_B', 20);
end CREATE_PAR_EXTRA_INFO_B;
end GHR_PAR_EXTRA_INFO_BK1;
