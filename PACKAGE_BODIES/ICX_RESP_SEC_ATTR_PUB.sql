--------------------------------------------------------
--  DDL for Package Body ICX_RESP_SEC_ATTR_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ICX_RESP_SEC_ATTR_PUB" AS
-- $Header: ICXPTRSB.pls 115.1 99/07/17 03:21:17 porting ship $
...
BEGIN
   ...
   SAVEPOINT Create_Resp_Sec_Attr_PUB;
   ...
   ICX_Resp_Sec_Attr_PVT.Create_Resp_Sec_Attr
   (
...
--      p_msg_entity_index	=>	p_msg_entity_index	,
   ...
   then
      ROLLBACK to Create_Resp_Sec_Attr_PUB;
...
IS
   l_api_name		CONSTANT VARCHAR2(30) := 'Delete_Resp_Sec_Attr';
   l_api_version_number	CONSTANT NUMBER	      := 1.0;
   l_return_status		 VARCHAR2(10);
...
BEGIN
   ...
   SAVEPOINT Delete_Resp_Sec_Attr_PUB;
   ...
   ICX_Resp_Sec_Attr_PVT.Delete_Resp_Sec_Attr
   (
      p_api_version_number	=>	p_api_version_number	,
      p_init_msg_list		=>	p_init_msg_list		,
      p_simulate		=>	p_simulate		,
...
--      p_msg_entity_index	=>	p_msg_entity_index	,
   ...
   if FND_API.To_Boolean( p_simulate)
   then
      ROLLBACK to Delete_Resp_Sec_Attr_PUB;
...
end Delete_Resp_Sec_Attr;


END ICX_Resp_Sec_Attr_PUB;
