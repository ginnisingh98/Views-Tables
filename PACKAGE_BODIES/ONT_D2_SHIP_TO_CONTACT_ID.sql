--------------------------------------------------------
--  DDL for Package Body ONT_D2_SHIP_TO_CONTACT_ID
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D2_SHIP_TO_CONTACT_ID" AS
...
--  FILENAME
--  
--      ONT_D2_SHIP_TO_CONTACT_ID
--  
--  DESCRIPTION
--  
--      Body of package ONT_D2_SHIP_TO_CONTACT_ID
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D2_SHIP_TO_CONTACT_ID';
...
BEGIN
  ...
  END IF;
    ...
    l_return_value := ONT_HEADER_Def_Util.g_cached_record.SHIP_TO_CONTACT_ID;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
