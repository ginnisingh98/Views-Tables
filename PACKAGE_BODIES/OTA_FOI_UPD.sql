--------------------------------------------------------
--  DDL for Package Body OTA_FOI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_FOI_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_foi_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the ota_frm_obj_inclusions Row
  --
  update ota_frm_obj_inclusions
    set
...
Begin
  ...
  --
  ota_foi_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_foi_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_foi_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
