--------------------------------------------------------
--  DDL for Package Body HR_ORU_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ORU_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_oru_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Delete the hr_all_organization_units row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hr_oru_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hr_oru_shd.g_rec_type) is
--
...
Begin
  ...
  --
  hr_oru_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  hr_oru_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hr_oru_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hr_oru_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
