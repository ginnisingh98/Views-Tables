--------------------------------------------------------
--  DDL for Package Body AHL_LTP_SPACE_UNAVL_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AHL_LTP_SPACE_UNAVL_PUB_W" as
  /* $Header: AHLWSUAB.pls 115.3 2002/12/04 19:38:39 ssurapan noship $ */
  ...
  as
    ddp_x_space_restriction_tbl ahl_ltp_space_unavl_pub.space_restriction_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ahl_ltp_space_unavl_pub_w.rosetta_table_copy_in_p1(ddp_x_space_restriction_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    ahl_ltp_space_unavl_pub.process_space_restriction(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      p_module_type,
    ...
    ahl_ltp_space_unavl_pub_w.rosetta_table_copy_out_p1(ddp_x_space_restriction_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
