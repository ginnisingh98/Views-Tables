--------------------------------------------------------
--  DDL for Package Body PNRX_C_RENT_INCREASE_DETAILACC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PNRX_C_RENT_INCREASE_DETAILACC" AS
/* $Header: PNRXCADB.pls 120.0 2007/10/03 14:25:45 rthumma noship $ */
   ...
   BEGIN
      ...
      pnrx_rent_increase_detailacc.rent_increase_detailacc (
	 ...
	 p_include_draft          => argument11,
         ...
         p_account_class          => argument13,
         p_set_of_books_id        => TO_NUMBER (argument14),
         p_chart_of_accounts_id   => TO_NUMBER (argument15),
