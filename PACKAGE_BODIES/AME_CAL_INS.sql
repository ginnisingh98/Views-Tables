--------------------------------------------------------
--  DDL for Package Body AME_CAL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_CAL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_cal_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
 ...
 l_last_update_login  := l_current_user_id;
  --
  -- Insert the row into: ame_calling_apps_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.application_id                   := p_application_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  ame_cal_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ame_cal_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where cal.application_id = p_application_id
                          and cal.language = l.language_code);
  --
