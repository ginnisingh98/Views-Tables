--------------------------------------------------------
--  DDL for Package Body BEN_WITHIN_YEAR_PERD_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_WITHIN_YEAR_PERD_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_WITHIN_YEAR_PERD_BK1.CREATE_WITHIN_YEAR_PERD_A', 10);
hr_utility.set_location(' Leaving: BEN_WITHIN_YEAR_PERD_BK1.CREATE_WITHIN_YEAR_PERD_A', 20);
end CREATE_WITHIN_YEAR_PERD_A;
...
begin
hr_utility.set_location('Entering: BEN_WITHIN_YEAR_PERD_BK1.CREATE_WITHIN_YEAR_PERD_B', 10);
hr_utility.set_location(' Leaving: BEN_WITHIN_YEAR_PERD_BK1.CREATE_WITHIN_YEAR_PERD_B', 20);
end CREATE_WITHIN_YEAR_PERD_B;
