--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_AU_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_AU_PERSONAL_PAY_M" as
/*
 * Generated by hr_pump_meta_mapper at: 2013/08/29 22:08:45
 * Generated for API: HR_AU_PERSONAL_PAY_METHOD_API.CREATE_AU_PERSONAL_PAY_METHOD
 */
--
...
decode(l.pval030,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval030,'PAYEE_TYPE',d(l.pval001),l.pval041)) p30,
l.pval030 d30,
l.pval031 p31,
l.pval032 p32,
l.pval033 p33,
...
(P_ORG_PAYMENT_METHOD_USER_KEY => c.p38);
end if;
--
L_PAYEE_ID := 
...
HR_AU_PERSONAL_PAY_METHOD_API.CREATE_AU_PERSONAL_PAY_METHOD
(p_validate => l_validate
,P_EFFECTIVE_DATE => c.p1
,P_ASSIGNMENT_ID => L_ASSIGNMENT_ID
,P_ORG_PAYMENT_METHOD_ID => L_ORG_PAYMENT_METHOD_ID
,P_BANK_BSB_CODE => c.p2
...
,P_EXTERNAL_ACCOUNT_ID => c.p32
,P_OBJECT_VERSION_NUMBER => c.p33
,P_EFFECTIVE_START_DATE => c.p34
,P_EFFECTIVE_END_DATE => c.p35
,P_COMMENT_ID => c.p36);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p31,L_PERSONAL_PAYMENT_METHOD_ID);
--
...
end hrdpp_CREATE_AU_PERSONAL_PAY_M;
