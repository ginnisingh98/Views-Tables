--------------------------------------------------------
--  DDL for Package Body OE_2PC2_SHIPSET_INCITEM
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC2_SHIPSET_INCITEM" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 IS 
   ...
   WHERE a.ITEM_TYPE_CODE = 'INCLUDED'
   AND   (  a.LINE_ID ) IN  
                 ( SELECT  b.LINE_ID
