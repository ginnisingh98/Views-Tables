--------------------------------------------------------
--  DDL for Package Body OE_1025PC2_LINE_PURREL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_1025PC2_LINE_PURREL" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_name varchar2(30) :='PUR_REL_THE_LINE';
