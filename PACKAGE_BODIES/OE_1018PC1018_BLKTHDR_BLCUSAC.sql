--------------------------------------------------------
--  DDL for Package Body OE_1018PC1018_BLKTHDR_BLCUSAC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_1018PC1018_BLKTHDR_BLCUSAC" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_status_code varchar2(8) :='COMPLETE';
   ...
   AND   w.item_key = OE_BLANKET_HEADER_SECURITY.g_record.HEADER_ID || ''
;
...
BEGIN 
   ...
   Return; 
END Is_Valid;
END OE_1018PC1018_BLKTHDR_BLCUSAC;
