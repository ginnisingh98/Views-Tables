--------------------------------------------------------
--  DDL for Package Body OKL_VP_TERMINATE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_VP_TERMINATE_PVT_W" as
  /* $Header: OKLETERB.pls 120.1 2005/07/12 09:11:34 dkagrawa noship $ */
  ...
  as
    ddp_ter_header_rec okl_vp_terminate_pvt.terminate_header_rec_type;
  ...
  begin
    ...
    okl_vp_terminate_pvt.terminate_contract(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
