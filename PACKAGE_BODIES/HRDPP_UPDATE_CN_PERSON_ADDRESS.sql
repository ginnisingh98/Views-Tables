--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_CN_PERSON_ADDRESS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_CN_PERSON_ADDRESS" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:37
 * Generated for API: HR_CN_PERSON_ADDRESS_API.UPDATE_CN_PERSON_ADDRESS
 */
--
...
,P_PROVINCE_CITY_SAR in varchar2 default null
...
decode(l.pval010,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval010,'CN_PROVINCE',d(l.pval001),vn)) p10,
l.pval010 d10,
...
HR_CN_PERSON_ADDRESS_API.UPDATE_CN_PERSON_ADDRESS
...
,P_ADDRESS_LINE1 => c.p8
,P_ADDRESS_LINE2 => c.p9
,P_PROVINCE_CITY_SAR => c.p10
,P_POSTAL_CODE => c.p11
,P_COUNTRY => L_COUNTRY
,P_TELEPHONE => c.p12
,P_FAX => c.p13
...
end hrdpp_UPDATE_CN_PERSON_ADDRESS;
