--------------------------------------------------------
--  DDL for Package Body HXC_ATC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_ATC_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hxc_atc_shd.';  -- Global package name
...
Begin
  --
  If (p_constraint_name = 'HXC_ALIAS_TYPE_COMPONENTS_PK') Then
...
Begin
  --
  If (p_alias_type_component_id is null and
    ...
    l_fct_ret := false;
  Else
    If (p_alias_type_component_id
        = hxc_atc_shd.g_old_rec.alias_type_component_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into hxc_atc_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> hxc_atc_shd.g_old_rec.object_version_number) Then
