--------------------------------------------------------
--  DDL for Package Body HR_SA_ASSIGNMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SA_ASSIGNMENT_API" AS
/* $Header: peasgsai.pkb 115.0 2003/09/10 01:49:57 adevanat noship $ */
/*
 +==========================================================================================
 |              Copyright (c) 1999 Oracle Corporation Ltd
 |                           All rights reserved.
 +==========================================================================================
 |SQL Script File Name : HR SA WR AS . PKB
 |                Name : hr_sa_assignment_api
 |         Description : Assignment API Wrapper for SA
 |
 |   Name           Date         Version Bug     Text
 |   -------------- ----------   ------- -----   ----
 |   adevanat       09-Sep-2003  115.0           Initial Version(Copied from pesawras.pkb)
 |NOTES
 +==========================================================================================
*/

g_package  VARCHAR2(33) := 'hr_sa_assignment_api.';
--
-- ----------------------------------------------------------------------------
...
PROCEDURE create_sa_secondary_emp_asg
  ...
  l_proc               VARCHAR2(72) := g_package||'create_sa_secondary_emp_asg';
  --
  -- Declare cursors
  --
...
BEGIN
 ...
 hr_assignment_api.create_secondary_emp_asg
  ...
  ,p_scl_segment2                 =>     p_gosi_num
  ,p_scl_segment3                 =>     p_gosi_annuities
  ,p_scl_segment4                 =>     p_annuities_branch_join_date
  ,p_scl_segment5                 =>     p_gosi_hazards
  ,p_scl_segment6                 =>     p_hazards_branch_join_date
  ...
  --
  END create_sa_secondary_emp_asg;
...
PROCEDURE update_sa_emp_asg
 ...
 --
    -- Declare cursors AND local variables
    --
    l_proc                       VARCHAR2(72) := g_package||'update_sa_emp_asg';
    l_effective_date             DATE;
    l_legislation_code           per_business_groups.legislation_code%TYPE;
    l_business_group_id          per_business_groups.business_group_id%type;
    a              varchar2(100);
  ...
  BEGIN
    ...
    --
      ...
      ,p_segment2                     => p_gosi_num
      ,p_segment3                     => p_gosi_annuities
      ,p_segment4                     => p_annuities_branch_join_date
      ,p_segment5                     => p_gosi_hazards
      ,p_segment6                     => p_hazards_branch_join_date
      ,p_soft_coding_keyflex_id       => p_soft_coding_keyflex_id
      ,p_comment_id                   => p_comment_id
      ,p_effective_start_date         => p_effective_start_date
      ,p_effective_END_date           => p_effective_end_date
