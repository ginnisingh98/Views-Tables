--------------------------------------------------------
--  DDL for Package Body IRC_SEARCH_CRITERIA_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_SEARCH_CRITERIA_BK1" as
...
begin
hr_utility.set_location('Entering: IRC_SEARCH_CRITERIA_BK1.CREATE_SAVED_SEARCH_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
irc_search_criteria_be1.CREATE_SAVED_SEARCH_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_SAVED_SEARCH', 'AP');
hr_utility.set_location(' Leaving: IRC_SEARCH_CRITERIA_BK1.CREATE_SAVED_SEARCH_A', 20);
...
begin
hr_utility.set_location('Entering: IRC_SEARCH_CRITERIA_BK1.CREATE_SAVED_SEARCH_B', 10);
hr_utility.set_location(' Leaving: IRC_SEARCH_CRITERIA_BK1.CREATE_SAVED_SEARCH_B', 20);
end CREATE_SAVED_SEARCH_B;
