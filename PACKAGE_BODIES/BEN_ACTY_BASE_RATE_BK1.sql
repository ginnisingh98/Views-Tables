--------------------------------------------------------
--  DDL for Package Body BEN_ACTY_BASE_RATE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ACTY_BASE_RATE_BK1" as
...
procedure CREATE_ACTY_BASE_RATE_A
...
begin
hr_utility.set_location('Entering: BEN_ACTY_BASE_RATE_BK1.CREATE_ACTY_BASE_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_ACTY_BASE_RATE_BK1.CREATE_ACTY_BASE_RATE_A', 20);
end CREATE_ACTY_BASE_RATE_A;
procedure CREATE_ACTY_BASE_RATE_B
(P_ORDR_NUM in NUMBER
,P_ACTY_TYP_CD in VARCHAR2
,P_SUB_ACTY_TYP_CD in VARCHAR2
,P_NAME in VARCHAR2
...
begin
hr_utility.set_location('Entering: BEN_ACTY_BASE_RATE_BK1.CREATE_ACTY_BASE_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_ACTY_BASE_RATE_BK1.CREATE_ACTY_BASE_RATE_B', 20);
end CREATE_ACTY_BASE_RATE_B;
end BEN_ACTY_BASE_RATE_BK1;
