--------------------------------------------------------
--  DDL for Package Body PER_QUALIFICATIONS_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_QUALIFICATIONS_BE1" as 
...
p_language_code                varchar2) is
  ...
  --
  l_proc varchar2(72):='  per_qualifications_be1.create_qualification_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.qualifications.create_qualification';
