--------------------------------------------------------
--  DDL for Package Body OE_LINE_SCREDIT_SECURITY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_LINE_SCREDIT_SECURITY" AS
/* $Header: OEXXLSCB.pls 115.23 2004/06/22 18:35:23 jvicenti ship $ */


--  Global constant holding the package name

G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'OE_Line_Scredit_Security';
...
l_result := OE_PC_Constraints_Admin_PVT.Is_OP_constrained
    ...
    , p_entity_id   => OE_PC_GLOBALS.G_ENTITY_LINE_SCREDIT
         ...
         IF l_result = OE_PC_GLOBALS.YES THEN
            IF x_on_operation_action = 1 THEN
               ...
               IF l_debug_level  > 0 THEN
                   oe_debug_pub.add(  'LINE SALES CREDIT SECURITY , ATTRIBUTE CHANGE REQUIRES REASON' , 1 ) ;
               END IF;
            ...
            ELSIF x_on_operation_action = 2 THEN
               ...
               IF OE_GLOBALS.G_AUDIT_REASON_RQD_FLAG <> 'Y' then
                  IF l_debug_level  > 0 THEN
                      oe_debug_pub.add(  'LINE SALES CREDIT SECURITY , ATTRIBUTE CHANGE REQUIRES HISTORY' , 1 ) ;
                  END IF;
...
IF l_debug_level  > 0 THEN
    oe_debug_pub.add(  'ENTER OE_LINE_SCREDIT_SECURITY.ENTITY' , 1 ) ;
END IF;

-- Initializing return status to SUCCESS
x_return_status := FND_API.G_RET_STS_SUCCESS;

IF p_LINE_SCREDIT_rec.operation = OE_GLOBALS.G_OPR_CREATE THEN
    l_operation := OE_PC_GLOBALS.CREATE_OP;
ELSIF p_LINE_SCREDIT_rec.operation = OE_GLOBALS.G_OPR_UPDATE THEN
    l_operation := OE_PC_GLOBALS.UPDATE_OP;
ELSIF p_LINE_SCREDIT_rec.operation = OE_GLOBALS.G_OPR_DELETE THEN
...
OE_LINE_SCREDIT_SECURITY.g_record := l_rowtype_rec;
...
IF l_debug_level  > 0 THEN
    oe_debug_pub.add(  'EXIT OE_LINE_SCREDIT_SECURITY.ENTITY' , 1 ) ;
END IF;
...
BEGIN
IF l_debug_level  > 0 THEN
    oe_debug_pub.add(  'ENTER OE_LINE_SCREDIT_SECURITY.ATTRIBUTES' , 1 ) ;
END IF;
...
-- check constraints for all the changed attributes.
    ...
    IF p_line_scredit_rec.percent = FND_API.G_MISS_NUM THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.percent,p_old_line_scredit_rec.percent) THEN
    ...
    IF p_line_scredit_rec.salesrep_id = FND_API.G_MISS_NUM THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.salesrep_id,p_old_line_scredit_rec.salesrep_id) THEN
    ...
    IF p_line_scredit_rec.dw_update_advice_flag = FND_API.G_MISS_CHAR THEN NULL;
      ELSIF NOT OE_GLOBALS.Equal(p_line_scredit_rec.dw_update_advice_flag, p_old_line_scredit_rec.dw_update_advice_flag) THEN
    ...
    IF p_line_scredit_rec.wh_update_date = FND_API.G_MISS_DATE THEN NULL;
      ELSIF NOT OE_GLOBALS.Equal(p_line_scredit_rec.wh_update_date, p_old_line_scredit_rec.wh_update_date) THEN
    ...
    IF p_line_scredit_rec.context = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.context,p_old_line_scredit_rec.context) THEN
   ...
   IF p_line_scredit_rec.attribute1 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute1,p_old_line_scredit_rec.attribute1) THEN
    ...
    IF p_line_scredit_rec.attribute10 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute10,p_old_line_scredit_rec.attribute10) THEN
    ...
    IF p_line_scredit_rec.attribute11 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute11,p_old_line_scredit_rec.attribute11) THEN
    ...
    IF p_line_scredit_rec.attribute12 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute12,p_old_line_scredit_rec.attribute12) THEN
    ...
    IF p_line_scredit_rec.attribute13 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute13,p_old_line_scredit_rec.attribute13) THEN
    ...
    IF p_line_scredit_rec.attribute14 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute14,p_old_line_scredit_rec.attribute14) THEN
    ...
    IF p_line_scredit_rec.attribute15 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute15,p_old_line_scredit_rec.attribute15) THEN
    ...
    IF p_line_scredit_rec.attribute2 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute2,p_old_line_scredit_rec.attribute2) THEN
    ...
    IF p_line_scredit_rec.attribute3 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute3,p_old_line_scredit_rec.attribute3) THEN
    ...
    IF p_line_scredit_rec.attribute4 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute4,p_old_line_scredit_rec.attribute4) THEN
    ...
    IF p_line_scredit_rec.attribute5 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute5,p_old_line_scredit_rec.attribute5) THEN
    ...
    IF p_line_scredit_rec.attribute6 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute6,p_old_line_scredit_rec.attribute6) THEN
    ...
    IF p_line_scredit_rec.attribute7 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute7,p_old_line_scredit_rec.attribute7) THEN
    ...
    IF p_line_scredit_rec.attribute8 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute8,p_old_line_scredit_rec.attribute8) THEN
    ...
    IF p_line_scredit_rec.attribute9 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.attribute9,p_old_line_scredit_rec.attribute9) THEN
    ...
    IF p_line_scredit_rec.sales_credit_type_id = FND_API.G_MISS_NUM THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_line_scredit_rec.sales_credit_type_id,p_old_line_scredit_rec.sales_credit_type_id) THEN
...
IF l_debug_level  > 0 THEN
    oe_debug_pub.add(  'EXIT OE_LINE_SCREDIT_SECURITY.ATTRIBUTES' , 1 ) ;
END IF;
