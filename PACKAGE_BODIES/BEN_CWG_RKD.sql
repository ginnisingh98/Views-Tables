--------------------------------------------------------
--  DDL for Package Body BEN_CWG_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CWG_RKD" as
...
begin
hr_utility.set_location('Entering: ben_cwg_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_cwg_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_cwg_RKD;
