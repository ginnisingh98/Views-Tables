--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_ELEMENT_OUTCOME
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_ELEMENT_OUTCOME" as
/*
...
,P_OUTCOME_NAME in varchar2 default null) is
...
,nd(P_COMPETENCE_ELEMENT_ID,I_COMPETENCE_ELEMENT_ID)
...
hr_pump_get.GET_CEO_OVN
(P_DATA_PUMP_ALWAYS_CALL => null
,P_ELEMENT_OUTCOME_NAME => c.p48);
--
L_OUTCOME_ID := 
...
,P_COMP_ELEMENT_OUTCOME_ID => c.p2
,P_OBJECT_VERSION_NUMBER => L_OBJECT_VERSION_NUMBER
,P_COMPETENCE_ELEMENT_ID => c.p3
