--------------------------------------------------------
--  DDL for Package Body GR_SAFETY_COMBINATIONS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GR_SAFETY_COMBINATIONS_PKG" AS
/*$Header: GRHISCB.pls 115.4 2002/10/28 16:49:37 gkelly ship $*/
...
/*   Check the main safety phrase code first. */

   l_safety_phrase := p_safety_phrase_code;
...
/*	 Now check the combination phrase	 */
   ...
   l_safety_phrase := p_safety_phrase_code_combo;
   GR_SAFETY_PHRASES_B_PKG.Check_Primary_Key
					(l_safety_phrase,
					 'F',
					 l_rowid,
...
/*		  p_combination_sequence is the safety phrase combination to check.
...
END GR_SAFETY_COMBINATIONS_PKG;
