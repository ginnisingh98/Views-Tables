--------------------------------------------------------
--  DDL for Package Body HXC_ULT_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_ULT_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_ult_del.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Delete the hxc_layouts_tl row.
  --
  delete from hxc_layouts_tl
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hxc_ult_shd.g_rec_type) is
--
  l_proc  varchar2(72) ;
--
Begin
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hxc_ult_shd.g_rec_type) is
--
  l_proc  varchar2(72) ;
--
Begin
...
Begin
  ...
  --
  hxc_ult_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  hxc_ult_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hxc_ult_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hxc_ult_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Having converted the arguments into the hxc_ult_rec
  -- plsql record structure we must call the corresponding entity
  -- business process
  --
  hxc_ult_del.del(l_rec);
  --
  if g_debug then
  	hr_utility.set_location(' Leaving:'||l_proc, 10);
  end if;
