--------------------------------------------------------
--  DDL for Package Body OKL_OPT_RUL_TMP_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_OPT_RUL_TMP_PUB_W" as
  /* $Header: OKLURTMB.pls 120.2 2005/12/08 17:55:21 stmathew noship $ */
  ...
  procedure insert_opt_rul_tmp(p_api_version  NUMBER
  ...
  as
    ddp_rgrv_tbl okl_opt_rul_tmp_pub.rgrv_tbl_type;
    ddx_rgrv_tbl okl_opt_rul_tmp_pub.rgrv_tbl_type;
  ...
  begin
    ...
    okl_opt_rul_tmp_pub.insert_opt_rul_tmp(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_rgrv_rec okl_opt_rul_tmp_pub.rgrv_rec_type;
    ddx_rgrv_rec okl_opt_rul_tmp_pub.rgrv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_opt_rul_tmp(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_opt_rul_tmp_pub.lock_opt_rul_tmp(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_opt_rul_tmp(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_opt_rul_tmp_pub.update_opt_rul_tmp(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_opt_rul_tmp(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_opt_rul_tmp_pub.delete_opt_rul_tmp(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_opt_rul_tmp(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_opt_rul_tmp_pub.validate_opt_rul_tmp(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
