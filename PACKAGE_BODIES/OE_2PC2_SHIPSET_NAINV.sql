--------------------------------------------------------
--  DDL for Package Body OE_2PC2_SHIPSET_NAINV
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC2_SHIPSET_NAINV" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 IS 
   ...
   WHERE a.INVOICE_INTERFACE_STATUS_CODE = 'NOT_ELIGIBLE'
   AND   (  a.LINE_ID ) IN  
                 ( SELECT  b.LINE_ID
