--------------------------------------------------------
--  DDL for Package Body HR_ASSIGNMENT_BK8
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ASSIGNMENT_BK8" as
...
begin
hr_utility.set_location('Entering: HR_ASSIGNMENT_BK8.CREATE_SECONDARY_APL_ASG_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
hr_assignment_be8.CREATE_SECONDARY_APL_ASG_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_SECONDARY_APL_ASG', 'AP');
hr_utility.set_location(' Leaving: HR_ASSIGNMENT_BK8.CREATE_SECONDARY_APL_ASG_A', 20);
end CREATE_SECONDARY_APL_ASG_A;
procedure CREATE_SECONDARY_APL_ASG_B
(P_EFFECTIVE_DATE in DATE
,P_PERSON_ID in NUMBER
,P_ORGANIZATION_ID in NUMBER
,P_RECRUITER_ID in NUMBER
...
l_legislation_code   varchar2(30);
begin
hr_utility.set_location('Entering: HR_ASSIGNMENT_BK8.CREATE_SECONDARY_APL_ASG_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_SECONDARY_APL_ASG', 'BP');
hr_utility.set_location(' Leaving: HR_ASSIGNMENT_BK8.CREATE_SECONDARY_APL_ASG_B', 20);
end CREATE_SECONDARY_APL_ASG_B;
end HR_ASSIGNMENT_BK8;
