--------------------------------------------------------
--  DDL for Package Body PAY_US_BALANCE_VIEW_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_US_BALANCE_VIEW_PKG" as
/* $Header: pybaluev.pkb 120.0.12010000.2 2009/09/22 07:37:30 nchinnam ship $ */
...
/* setting the session varaible using the CA balance pkg also because
   in pybvrou*.pkb we are getting the session value from CA balance pkg
   This was the case always dont know why the code started falling over
   after Q3 2003
*/

  --pay_ca_balance_view_pkg.set_session_var('LEG_CODE',l_leg_code);
  --
...
RETURN NUMBER IS
  ...
  --
  /* Modified query for performance enhancement Bug No. 3354133 */
