--------------------------------------------------------
--  DDL for Package Body HR_RU_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_RU_CONTINGENT_WORKER_API" as
/* $Header: pecwkrui.pkb 120.0 2005/05/31 07:27:19 appldev noship $ */
--
-- Package Variables
--
g_package  CONSTANT varchar2(33) := 'hr_ru_contingent_worker_api.';
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_ru_cwk >--------------------------|
-- ----------------------------------------------------------------------------
...
begin
  ...
  l_proc := g_package||'create_ru_cwk';
