--------------------------------------------------------
--  DDL for Package Body GME_RESOURCE_TXNS_DBL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_RESOURCE_TXNS_DBL" AS
/* $Header: GMEVGRTB.pls 120.2 2005/07/12 12:35:43 snene noship $ */
