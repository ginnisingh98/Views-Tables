--------------------------------------------------------
--  DDL for Package Body BEN_OTP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_OTP_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_otp_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'BEN_OPTIP_F_PK') Then
...
Begin
  ...
  Else
    If (p_optip_id =
        ben_otp_shd.g_old_rec.optip_id and
        p_object_version_number =
        ben_otp_shd.g_old_rec.object_version_number) Then
      --
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into ben_otp_shd.g_old_rec;
...
Begin
  ...
  If (p_datetrack_mode <> hr_api.g_insert) then
    ...
    dt_api.validate_dt_mode
      ...
      ,p_base_table_name         => 'ben_optip_f'
      ,p_base_key_column         => 'optip_id'
      ,p_base_key_value          => p_optip_id
      ,p_parent_table_name1      => 'ben_pgm_f'
      ,p_parent_key_column1      => 'pgm_id'
      ,p_parent_key_value1       => ben_otp_shd.g_old_rec.pgm_id
      ,p_parent_table_name2      => 'ben_ptip_f'
      ,p_parent_key_column2      => 'ptip_id'
      ,p_parent_key_value2       => ben_otp_shd.g_old_rec.ptip_id
      ,p_parent_table_name3      => 'ben_opt_f'
      ,p_parent_key_column3      => 'opt_id'
      ,p_parent_key_value3       => ben_otp_shd.g_old_rec.opt_id
...
Begin
  ...
  l_rec.otp_attribute_category           := p_otp_attribute_category;
  l_rec.otp_attribute1                   := p_otp_attribute1;
  l_rec.otp_attribute2                   := p_otp_attribute2;
  l_rec.otp_attribute3                   := p_otp_attribute3;
  l_rec.otp_attribute4                   := p_otp_attribute4;
  l_rec.otp_attribute5                   := p_otp_attribute5;
  l_rec.otp_attribute6                   := p_otp_attribute6;
  l_rec.otp_attribute7                   := p_otp_attribute7;
  l_rec.otp_attribute8                   := p_otp_attribute8;
  l_rec.otp_attribute9                   := p_otp_attribute9;
  l_rec.otp_attribute10                  := p_otp_attribute10;
  l_rec.otp_attribute11                  := p_otp_attribute11;
  l_rec.otp_attribute12                  := p_otp_attribute12;
  l_rec.otp_attribute13                  := p_otp_attribute13;
  l_rec.otp_attribute14                  := p_otp_attribute14;
  l_rec.otp_attribute15                  := p_otp_attribute15;
  l_rec.otp_attribute16                  := p_otp_attribute16;
  l_rec.otp_attribute17                  := p_otp_attribute17;
  l_rec.otp_attribute18                  := p_otp_attribute18;
  l_rec.otp_attribute19                  := p_otp_attribute19;
  l_rec.otp_attribute20                  := p_otp_attribute20;
  l_rec.otp_attribute21                  := p_otp_attribute21;
  l_rec.otp_attribute22                  := p_otp_attribute22;
  l_rec.otp_attribute23                  := p_otp_attribute23;
  l_rec.otp_attribute24                  := p_otp_attribute24;
  l_rec.otp_attribute25                  := p_otp_attribute25;
  l_rec.otp_attribute26                  := p_otp_attribute26;
  l_rec.otp_attribute27                  := p_otp_attribute27;
  l_rec.otp_attribute28                  := p_otp_attribute28;
  l_rec.otp_attribute29                  := p_otp_attribute29;
  l_rec.otp_attribute30                  := p_otp_attribute30;
