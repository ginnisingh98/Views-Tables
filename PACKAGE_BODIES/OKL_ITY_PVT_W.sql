--------------------------------------------------------
--  DDL for Package Body OKL_ITY_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ITY_PVT_W" as
  /* $Header: OKLIITYB.pls 120.1 2005/07/13 09:28:48 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_ity_pvt.ity_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).inf_id := rosetta_g_miss_num_map(a1(indx));
          t(ddindx).group_asset_yn := a2(indx);
          t(ddindx).group_by_contract_yn := a3(indx);
  ...
  procedure rosetta_table_copy_out_p2(t okl_ity_pvt.ity_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a25 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := rosetta_g_miss_num_map(t(ddindx).inf_id);
          a2(indx) := t(ddindx).group_asset_yn;
          a3(indx) := t(ddindx).group_by_contract_yn;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_ity_pvt.okl_invoice_types_tl_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p5(t okl_ity_pvt.okl_invoice_types_tl_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_in_p8(t out nocopy okl_ity_pvt.ityv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_VARCHAR2_TABLE_100
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_VARCHAR2_TABLE_200
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).inf_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).name := a4(indx);
          t(ddindx).description := a5(indx);
          t(ddindx).group_asset_yn := a6(indx);
          t(ddindx).group_by_contract_yn := a7(indx);
  ...
  procedure rosetta_table_copy_out_p8(t okl_ity_pvt.ityv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_VARCHAR2_TABLE_100
    ...
    a28 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).inf_id);
          a4(indx) := t(ddindx).name;
          a5(indx) := t(ddindx).description;
          a6(indx) := t(ddindx).group_asset_yn;
          a7(indx) := t(ddindx).group_by_contract_yn;
  ...
  as
    ddp_ityv_rec okl_ity_pvt.ityv_rec_type;
    ddx_ityv_rec okl_ity_pvt.ityv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ddp_ityv_rec.id := rosetta_g_miss_num_map(p5_a0);
    ddp_ityv_rec.object_version_number := rosetta_g_miss_num_map(p5_a1);
    ddp_ityv_rec.sfwt_flag := p5_a2;
    ddp_ityv_rec.inf_id := rosetta_g_miss_num_map(p5_a3);
    ddp_ityv_rec.name := p5_a4;
    ddp_ityv_rec.description := p5_a5;
    ddp_ityv_rec.group_asset_yn := p5_a6;
    ddp_ityv_rec.group_by_contract_yn := p5_a7;
    ddp_ityv_rec.attribute_category := p5_a8;
    ddp_ityv_rec.attribute1 := p5_a9;
    ddp_ityv_rec.attribute2 := p5_a10;
    ddp_ityv_rec.attribute3 := p5_a11;
    ddp_ityv_rec.attribute4 := p5_a12;
    ddp_ityv_rec.attribute5 := p5_a13;
    ddp_ityv_rec.attribute6 := p5_a14;
    ddp_ityv_rec.attribute7 := p5_a15;
    ddp_ityv_rec.attribute8 := p5_a16;
    ddp_ityv_rec.attribute9 := p5_a17;
    ddp_ityv_rec.attribute10 := p5_a18;
    ddp_ityv_rec.attribute11 := p5_a19;
    ddp_ityv_rec.attribute12 := p5_a20;
    ddp_ityv_rec.attribute13 := p5_a21;
    ddp_ityv_rec.attribute14 := p5_a22;
    ddp_ityv_rec.attribute15 := p5_a23;
    ddp_ityv_rec.created_by := rosetta_g_miss_num_map(p5_a24);
    ddp_ityv_rec.creation_date := rosetta_g_miss_date_in_map(p5_a25);
    ddp_ityv_rec.last_updated_by := rosetta_g_miss_num_map(p5_a26);
    ddp_ityv_rec.last_update_date := rosetta_g_miss_date_in_map(p5_a27);
    ddp_ityv_rec.last_update_login := rosetta_g_miss_num_map(p5_a28);


    -- here's the delegated call to the old PL/SQL routine
    okl_ity_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a0 := rosetta_g_miss_num_map(ddx_ityv_rec.id);
    p6_a1 := rosetta_g_miss_num_map(ddx_ityv_rec.object_version_number);
    p6_a2 := ddx_ityv_rec.sfwt_flag;
    p6_a3 := rosetta_g_miss_num_map(ddx_ityv_rec.inf_id);
    p6_a4 := ddx_ityv_rec.name;
    p6_a5 := ddx_ityv_rec.description;
    p6_a6 := ddx_ityv_rec.group_asset_yn;
    p6_a7 := ddx_ityv_rec.group_by_contract_yn;
    p6_a8 := ddx_ityv_rec.attribute_category;
    p6_a9 := ddx_ityv_rec.attribute1;
    p6_a10 := ddx_ityv_rec.attribute2;
    p6_a11 := ddx_ityv_rec.attribute3;
    p6_a12 := ddx_ityv_rec.attribute4;
    p6_a13 := ddx_ityv_rec.attribute5;
    p6_a14 := ddx_ityv_rec.attribute6;
    p6_a15 := ddx_ityv_rec.attribute7;
    p6_a16 := ddx_ityv_rec.attribute8;
    p6_a17 := ddx_ityv_rec.attribute9;
    p6_a18 := ddx_ityv_rec.attribute10;
    p6_a19 := ddx_ityv_rec.attribute11;
    p6_a20 := ddx_ityv_rec.attribute12;
    p6_a21 := ddx_ityv_rec.attribute13;
    p6_a22 := ddx_ityv_rec.attribute14;
    p6_a23 := ddx_ityv_rec.attribute15;
    p6_a24 := rosetta_g_miss_num_map(ddx_ityv_rec.created_by);
    p6_a25 := ddx_ityv_rec.creation_date;
    p6_a26 := rosetta_g_miss_num_map(ddx_ityv_rec.last_updated_by);
    p6_a27 := ddx_ityv_rec.last_update_date;
    p6_a28 := rosetta_g_miss_num_map(ddx_ityv_rec.last_update_login);
  end;
  ...
  as
    ddp_ityv_tbl okl_ity_pvt.ityv_tbl_type;
    ddx_ityv_tbl okl_ity_pvt.ityv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_ity_pvt_w.rosetta_table_copy_in_p8(ddp_ityv_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_ity_pvt_w.rosetta_table_copy_out_p8(ddx_ityv_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ity_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ity_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ity_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ity_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
