--------------------------------------------------------
--  DDL for Package Body OTA_BSL_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_BSL_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_bsl_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure update_dml
  (p_rec in out nocopy ota_bsl_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Update the ota_booking_status_types_tl Row
  --
  update ota_booking_status_types_tl
    set
...
Begin
  ...
  --
  ota_bsl_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_bsl_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_bsl_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
  ...
  cursor csr_upd_langs is
    select bst.language
     ...
     where bst.booking_status_type_id = p_booking_status_type_id
       and p_language_code in (bst.language
                              ,bst.source_lang);
  --
