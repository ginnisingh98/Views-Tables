--------------------------------------------------------
--  DDL for Package Body OTA_TPS_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TPS_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ota_tps_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Delete the ota_training_plans row.
  --
  delete from ota_training_plans
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in ota_tps_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in ota_tps_shd.g_rec_type) is
--
...
Begin
  ...
  --
  ota_tps_bus.delete_validate(p_rec);
  ...
  --
  ota_tps_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  ota_tps_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  ota_tps_del.post_delete(p_rec);
  --
	--CALL TO RAISE ANY ERRORS ON MULTI MESSAGE LIST
  hr_multi_message.end_validation_set;
