--------------------------------------------------------
--  DDL for Package Body HR_PERSONAL_PAY_METHOD_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PERSONAL_PAY_METHOD_BK2" as
...
begin
hr_utility.set_location('Entering: HR_PERSONAL_PAY_METHOD_BK2.UPDATE_PERSONAL_PAY_METHOD_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
hr_personal_pay_method_be2.UPDATE_PERSONAL_PAY_METHOD_A
...
l_legislation_code := PAY_PPM_BUS.return_legislation_code(P_PERSONAL_PAYMENT_METHOD_ID => P_PERSONAL_PAYMENT_METHOD_ID
);
if l_legislation_code = 'ZA' then
PER_ZA_USER_HOOK_PKG.VALIDATE_UPDATE_PER_PAYMENT
(P_EFFECTIVE_DATE => P_EFFECTIVE_DATE
,P_EFFECTIVE_START_DATE => P_EFFECTIVE_START_DATE
,P_EFFECTIVE_END_DATE => P_EFFECTIVE_END_DATE
,P_PERSONAL_PAYMENT_METHOD_ID => P_PERSONAL_PAYMENT_METHOD_ID
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_PERSONAL_PAY_METHOD', 'AP');
hr_utility.set_location(' Leaving: HR_PERSONAL_PAY_METHOD_BK2.UPDATE_PERSONAL_PAY_METHOD_A', 20);
...
l_legislation_code   varchar2(30);
begin
hr_utility.set_location('Entering: HR_PERSONAL_PAY_METHOD_BK2.UPDATE_PERSONAL_PAY_METHOD_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_leg_hooks then
l_legislation_code := PAY_PPM_BUS.return_legislation_code(P_PERSONAL_PAYMENT_METHOD_ID => P_PERSONAL_PAYMENT_METHOD_ID
);
if l_legislation_code = 'AE' then
HR_AE_VALIDATE_PKG.UPDATE_PAYMENT_METHOD_VALIDATE
(P_EFFECTIVE_DATE => P_EFFECTIVE_DATE
,P_PERSONAL_PAYMENT_METHOD_ID => P_PERSONAL_PAYMENT_METHOD_ID
,P_PPM_INFORMATION1 => P_PPM_INFORMATION1
);
...
PAY_PL_PERSONAL_PAY_METHOD.UPDATE_PL_PERSONAL_PAY_METHOD
(P_SEGMENT1 => P_SEGMENT1
,P_SEGMENT2 => P_SEGMENT2
,P_SEGMENT3 => P_SEGMENT3
,P_SEGMENT12 => P_SEGMENT12
...
PAY_US_PPM_HOOK.UPDATE_BANK_DETAILS
(P_PERSONAL_PAYMENT_METHOD_ID => P_PERSONAL_PAYMENT_METHOD_ID
,P_SEGMENT3 => P_SEGMENT3
,P_SEGMENT4 => P_SEGMENT4
,P_PPM_INFORMATION1 => P_PPM_INFORMATION1
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_PERSONAL_PAY_METHOD', 'BP');
hr_utility.set_location(' Leaving: HR_PERSONAL_PAY_METHOD_BK2.UPDATE_PERSONAL_PAY_METHOD_B', 20);
end UPDATE_PERSONAL_PAY_METHOD_B;
