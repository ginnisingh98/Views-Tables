--------------------------------------------------------
--  DDL for Package Body IGS_TR_TSTP_GRP_LMT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_TR_TSTP_GRP_LMT_PKG" AS
/* $Header: IGSTI14B.pls 115.2 2002/11/29 04:17:33 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_tr_tstp_grp_lmt%ROWTYPE;
  new_references igs_tr_tstp_grp_lmt%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    INSERT INTO igs_tr_tstp_grp_lmt (
      tracking_type,
      step_group_id,
      step_group_limit,
      creation_date,
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_tr_tstp_grp_lmt
    WHERE rowid = x_rowid;
