--------------------------------------------------------
--  DDL for Package Body BEN_WCN_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_WCN_RKU" as
...
begin
hr_utility.set_location('Entering: ben_wcn_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_wcn_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_wcn_RKU;
