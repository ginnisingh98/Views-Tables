--------------------------------------------------------
--  DDL for Package Body PER_REC_ACTIVITY_FOR_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_REC_ACTIVITY_FOR_BE1" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  per_rec_activity_for_be1.create_rec_activity_for_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.rec_activity_for.create_rec_activity_for';
