--------------------------------------------------------
--  DDL for Package Body BEN_SERVICE_AREA_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_SERVICE_AREA_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_SERVICE_AREA_BK2.UPDATE_SERVICE_AREA_A', 10);
hr_utility.set_location(' Leaving: BEN_SERVICE_AREA_BK2.UPDATE_SERVICE_AREA_A', 20);
end UPDATE_SERVICE_AREA_A;
...
begin
hr_utility.set_location('Entering: BEN_SERVICE_AREA_BK2.UPDATE_SERVICE_AREA_B', 10);
hr_utility.set_location(' Leaving: BEN_SERVICE_AREA_BK2.UPDATE_SERVICE_AREA_B', 20);
end UPDATE_SERVICE_AREA_B;
