--------------------------------------------------------
--  DDL for Package Body HR_NO_CONTRACT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_NO_CONTRACT_API" as
/* $Header: pectcnoi.pkb 120.0 2005/05/31 07:19:34 appldev noship $ */


--
-- Package Variables
--
g_package  varchar2(33) := 'hr_no_contract_api.';
--
-- ----------------------------------------------------------------------
-- |------------------------< create_no_contract >----------------------|
-- ----------------------------------------------------------------------
...
procedure create_no_contract
  ...
  l_proc              varchar2(72) := g_package||'create_no_contract';
...
begin
  ...
  hr_contract_api.create_contract
    ...
    ,p_ctr_information_category      => 'NO'
    ,p_ctr_information1	             => p_contract_end_date
