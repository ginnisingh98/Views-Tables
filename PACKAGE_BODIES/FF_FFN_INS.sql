--------------------------------------------------------
--  DDL for Package Body FF_FFN_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FF_FFN_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ff_ffn_ins.';  -- Global package name
--
...
Begin
  ...
  --
  ff_ffn_ins.g_function_id_i := p_function_id;
  --
...
Begin
  ...
  --
  -- Insert the row into: ff_functions
  --
...
--
  Cursor C_Sel1 is select ff_functions_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from ff_functions
     where function_id =
             ff_ffn_ins.g_function_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (ff_ffn_ins.g_function_id_i is not null) Then
    --
    ...
    p_rec.function_id :=
      ff_ffn_ins.g_function_id_i;
    ff_ffn_ins.g_function_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.function_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  ff_ffn_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  ff_ffn_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ff_ffn_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
