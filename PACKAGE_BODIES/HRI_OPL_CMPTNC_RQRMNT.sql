--------------------------------------------------------
--  DDL for Package Body HRI_OPL_CMPTNC_RQRMNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRI_OPL_CMPTNC_RQRMNT" AS
/* $Header: hripcmrq.pkb 120.1 2005/06/08 02:54:44 anmajumd noship $ */
--
...
--
g_row_indicator               g_number_tabtype;
g_core_cmptnc_indicator       g_number_tabtype;
g_essntl_cmptnc_indicator     g_number_tabtype;
g_org_rqrmnt_indicator        g_number_tabtype;
g_job_rqrmnt_indicator        g_number_tabtype;
g_grade_rqrmnt_indicator      g_number_tabtype;
g_pos_rqrmnt_indicator        g_number_tabtype;
g_effective_start_date        g_date_tabtype;
g_effective_end_date          g_date_tabtype;
g_business_group_id           g_number_tabtype;
g_organization_id             g_number_tabtype;
g_job_id                      g_number_tabtype;
g_grade_id                    g_number_tabtype;
g_position_id                 g_number_tabtype;
g_enterprise_id               g_number_tabtype;
g_competence_id               g_number_tabtype;
g_competence_element_id       g_number_tabtype;
g_low_level_id                g_number_tabtype;
g_high_level_id               g_number_tabtype;
g_essntl_cmptnc_flag_code     g_varchar2_tabtype;
...
--
g_target_table          VARCHAR2(30) DEFAULT 'HRI_MB_CMPTNC_RQRMNT_CT';
g_cncrnt_prgrm_shrtnm   VARCHAR2(30) DEFAULT 'HRICMPTNCRQRMNT';
--
-- @@ Code specific to this view/table below ENDS
--
...
BEGIN
  ...
  LOOP
    ...
    BULK COLLECT INTO
           g_row_indicator
          ,g_core_cmptnc_indicator
          ,g_essntl_cmptnc_indicator
          ,g_org_rqrmnt_indicator
          ,g_job_rqrmnt_indicator
          ,g_grade_rqrmnt_indicator
          ,g_pos_rqrmnt_indicator
          ...
          ,g_enterprise_id
          ,g_competence_id
          ,g_competence_element_id
          ,g_low_level_id
          ,g_high_level_id
          ,g_essntl_cmptnc_flag_code
          ,g_last_change_date
    LIMIT g_chunk_size;
    -- log('finish fetch ...');
    --
