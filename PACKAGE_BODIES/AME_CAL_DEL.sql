--------------------------------------------------------
--  DDL for Package Body AME_CAL_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_CAL_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_cal_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the ame_calling_apps_tl row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in ame_cal_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in ame_cal_shd.g_rec_type) is
--
...
Begin
  ...
  --
  ame_cal_bus.delete_validate(p_rec);
  --
  ...
  --
  ame_cal_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  ame_cal_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  ame_cal_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
...
Begin
  ...
  --
  --
  -- Having converted the arguments into the ame_cal_rec
  -- plsql record structure we must call the corresponding entity
  -- business process
  --
  ame_cal_del.del(l_rec);
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End del;
--
