--------------------------------------------------------
--  DDL for Package Body FEM_DIS_CUSTOMERS_HIER_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FEM_DIS_CUSTOMERS_HIER_PKG" as
/* $Header: fem_discust_pkb.plb 120.0 2005/10/19 19:21:00 appldev noship $ */
...
begin
  ...
  close c;
  if (    (recinfo.LEVEL11_DISPLAY_CODE = X_LEVEL11_DISPLAY_CODE)
...
end FEM_DIS_CUSTOMERS_HIER_PKG;
