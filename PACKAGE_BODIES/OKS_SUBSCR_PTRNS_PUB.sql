--------------------------------------------------------
--  DDL for Package Body OKS_SUBSCR_PTRNS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKS_SUBSCR_PTRNS_PUB" AS
/* $Header: OKSPPTRB.pls 120.0 2005/05/25 17:58:02 appldev noship $ */

  PROCEDURE qc IS
  BEGIN
    OKS_SUBSCR_PTRNS_PVT.qc;
  END qc;

  PROCEDURE change_version IS
  BEGIN
    OKS_SUBSCR_PTRNS_PVT.change_version;
  END change_version;

  PROCEDURE api_copy IS
  BEGIN
    OKS_SUBSCR_PTRNS_PVT.api_copy;
  END api_copy;
  ...
  OKS_SUBSCR_PTRNS_PVT.insert_row(
  ...
  If p_scpv_tbl.COUNT > 0 Then
          ...
          Loop
            ...
            Exit When  (l_ptr = p_scpv_tbl.LAST);
            l_ptr := p_scpv_tbl.NEXT(l_ptr);
  ...
  OKS_SUBSCR_PTRNS_PVT.update_row(
                                p_api_version      => p_api_version,
                                p_init_msg_list    => p_init_msg_list,
                                x_return_status    => x_return_status,
                                x_msg_count        => x_msg_count,
  ...
  OKS_SUBSCR_PTRNS_PVT.delete_row(
                                p_api_version      => p_api_version,
                                p_init_msg_list    => p_init_msg_list,
                                x_return_status    => x_return_status,
                                x_msg_count        => x_msg_count,
  ...
  End If;
    ...
    OKS_SUBSCR_PTRNS_PVT.validate_row(
                                p_api_version,
                                p_init_msg_list,
                                x_return_status,
                                x_msg_count,
