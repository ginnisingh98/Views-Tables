--------------------------------------------------------
--  DDL for Package Body BEN_CBR_PER_IN_LER_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CBR_PER_IN_LER_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_CBR_PER_IN_LER_BK1.CREATE_CBR_PER_IN_LER_A', 10);
hr_utility.set_location(' Leaving: BEN_CBR_PER_IN_LER_BK1.CREATE_CBR_PER_IN_LER_A', 20);
end CREATE_CBR_PER_IN_LER_A;
...
begin
hr_utility.set_location('Entering: BEN_CBR_PER_IN_LER_BK1.CREATE_CBR_PER_IN_LER_B', 10);
hr_utility.set_location(' Leaving: BEN_CBR_PER_IN_LER_BK1.CREATE_CBR_PER_IN_LER_B', 20);
end CREATE_CBR_PER_IN_LER_B;
