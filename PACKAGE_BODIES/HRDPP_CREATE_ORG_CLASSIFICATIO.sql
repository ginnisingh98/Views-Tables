--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_ORG_CLASSIFICATIO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_ORG_CLASSIFICATIO" as
/*
...
decode(l.pval002,cn,vn,
 hr_pump_get.gl(l.pval002,'ORG_CLASS',d(l.pval001),l.pval006)) p2,
l.pval003 p3,
l.pval004 p4,
...
,P_ORG_CLASSIF_CODE => c.p2
,P_ORG_INFORMATION_ID => c.p3
