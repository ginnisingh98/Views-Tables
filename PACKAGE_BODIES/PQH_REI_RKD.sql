--------------------------------------------------------
--  DDL for Package Body PQH_REI_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_REI_RKD" as
/* $Header: pqreirhi.pkb 115.3 2002/12/03 20:42:51 generated noship $ */
...
begin
hr_utility.set_location('Entering: PQH_REI_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PQH_REI_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PQH_REI_RKD;
