--------------------------------------------------------
--  DDL for Package Body OKL_SETUPPOVALUES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPPOVALUES_PUB_W" as
  /* $Header: OKLUSDVB.pls 115.2 2002/12/24 04:18:26 sgorantl noship $ */
  ...
  as
    ddp_povv_rec okl_setuppovalues_pub.povv_rec_type;
    ddx_no_data_found boolean;
    ddx_povv_rec okl_setuppovalues_pub.povv_rec_type;
  ...
  begin
    ...
    okl_setuppovalues_pub.get_rec(ddp_povv_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_povv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_povv_rec.id);
    p4_a1 := rosetta_g_miss_num_map(ddx_povv_rec.object_version_number);
    p4_a2 := rosetta_g_miss_num_map(ddx_povv_rec.ove_id);
    p4_a3 := rosetta_g_miss_num_map(ddx_povv_rec.pon_id);
    p4_a4 := ddx_povv_rec.from_date;
    p4_a5 := rosetta_g_miss_num_map(ddx_povv_rec.created_by);
    p4_a6 := ddx_povv_rec.to_date;
    p4_a7 := ddx_povv_rec.creation_date;
    p4_a8 := rosetta_g_miss_num_map(ddx_povv_rec.last_updated_by);
    p4_a9 := ddx_povv_rec.last_update_date;
    p4_a10 := rosetta_g_miss_num_map(ddx_povv_rec.last_update_login);
  end;
  ...
  as
    ddp_pdtv_rec okl_setuppovalues_pub.pdtv_rec_type;
    ddp_optv_rec okl_setuppovalues_pub.optv_rec_type;
    ddp_povv_rec okl_setuppovalues_pub.povv_rec_type;
    ddx_povv_rec okl_setuppovalues_pub.povv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppovalues_pub.insert_povalues(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pdtv_rec okl_setuppovalues_pub.pdtv_rec_type;
    ddp_optv_rec okl_setuppovalues_pub.optv_rec_type;
    ddp_povv_tbl okl_setuppovalues_pub.povv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppovalues_pub.delete_povalues(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
