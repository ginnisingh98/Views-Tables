--------------------------------------------------------
--  DDL for Package Body OE_2PC1018_BLKTHDR_BKDISNR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC1018_BLKTHDR_BKDISNR" AS 
 PROCEDURE Is_Valid
 ( 
...
BEGIN 
   ...
   Return; 
END Is_Valid;
END OE_2PC1018_BLKTHDR_BKDISNR;
