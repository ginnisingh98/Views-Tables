--------------------------------------------------------
--  DDL for Package Body OKL_AGR_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AGR_PVT_W" as
  /* $Header: OKLIAGRB.pls 120.1 2005/07/07 13:45:01 dkagrawa noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_agr_pvt.agr_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ae_line_type := a1(indx);
          t(ddindx).org_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).set_of_books_id := rosetta_g_miss_num_map(a3(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_agr_pvt.agr_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a9 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := t(ddindx).ae_line_type;
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).org_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).set_of_books_id);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_agr_pvt.agrv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p5(t okl_agr_pvt.agrv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  as
    ddp_agrv_rec okl_agr_pvt.agrv_rec_type;
    ddx_agrv_rec okl_agr_pvt.agrv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_agr_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_agrv_tbl okl_agr_pvt.agrv_tbl_type;
    ddx_agrv_tbl okl_agr_pvt.agrv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_agr_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_agr_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_agr_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_agr_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
