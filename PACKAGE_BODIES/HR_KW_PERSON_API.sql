--------------------------------------------------------
--  DDL for Package Body HR_KW_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_KW_PERSON_API" as
/* $Header: peperkwi.pkb 120.1 2005/06/22 04:40:28 adevanat noship $ */

   -- Package Variables
   g_package   VARCHAR2(33) := 'hr_kw_person_api.';
