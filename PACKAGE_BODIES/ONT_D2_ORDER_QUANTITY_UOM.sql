--------------------------------------------------------
--  DDL for Package Body ONT_D2_ORDER_QUANTITY_UOM
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D2_ORDER_QUANTITY_UOM" AS
...
--  FILENAME
--  
--      ONT_D2_ORDER_QUANTITY_UOM
--  
--  DESCRIPTION
--  
--      Body of package ONT_D2_ORDER_QUANTITY_UOM
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D2_ORDER_QUANTITY_UOM';
...
BEGIN
    ...
    l_return_value := ONT_ITEM_Def_Util.g_cached_record.PRIMARY_UOM_CODE;
    END IF;
...
WHEN OTHERS THEN
         ...
         ( p_attribute_code => 'ORDER_QUANTITY_UOM'
         , p_rule_id => l_rule_id
         );
         RETURN NULL;
END Get_Default_Value;
END ONT_D2_ORDER_QUANTITY_UOM;
