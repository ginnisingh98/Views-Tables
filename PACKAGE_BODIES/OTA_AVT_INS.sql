--------------------------------------------------------
--  DDL for Package Body OTA_AVT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_AVT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_avt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: ota_activity_versions_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.activity_version_id              := p_activity_version_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  ota_avt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ota_avt_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where avt.activity_version_id = p_activity_version_id
                          and avt.language = l.language_code);
  --
