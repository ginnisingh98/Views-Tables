--------------------------------------------------------
--  DDL for Package Body PQH_BEL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_BEL_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqh_bel_shd.';  -- Global package name
--
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
...
Begin
  ...
  --
  If (p_constraint_name = 'PQH_BUDGET_ELEMENTS_FK2') Then
    hr_utility.set_message(801, 'HR_6153_ALL_PROCEDURE_FAIL');
    hr_utility.set_message_token('PROCEDURE', l_proc);
    hr_utility.set_message_token('STEP','5');
    hr_utility.raise_error;
  ElsIf (p_constraint_name = 'PQH_BUDGET_ELEMENT_PK') Then
    hr_utility.set_message(801, 'HR_6153_ALL_PROCEDURE_FAIL');
    hr_utility.set_message_token('PROCEDURE', l_proc);
    hr_utility.set_message_token('STEP','10');
    hr_utility.raise_error;
  ElsIf (p_constraint_name = 'PQH_BUDGET_ELEMENT_UK') Then
...
Begin
  ...
  --
  If (
	p_budget_element_id is null and
  ...
  Else
    If (
	p_budget_element_id = g_old_rec.budget_element_id and
...
Exception
  When HR_Api.Object_Locked then
    ...
    hr_utility.set_message_token('TABLE_NAME', 'pqh_budget_elements');
    hr_utility.raise_error;
End lck;
--
-- ----------------------------------------------------------------------------
