--------------------------------------------------------
--  DDL for Package Body OKL_TRX_ACCT_OPTS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TRX_ACCT_OPTS_PUB_W" as
  /* $Header: OKLUTAOB.pls 120.1 2005/07/20 07:15:27 asawanka noship $ */
  ...
  procedure insert_trx_acct_opts(p_api_version  NUMBER
  ...
  as
    ddp_taov_rec okl_trx_acct_opts_pub.taov_rec_type;
    ddx_taov_rec okl_trx_acct_opts_pub.taov_rec_type;
  ...
  begin
    ...
    okl_trx_acct_opts_pub.insert_trx_acct_opts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_taov_tbl okl_trx_acct_opts_pub.taov_tbl_type;
    ddx_taov_tbl okl_trx_acct_opts_pub.taov_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_trx_acct_opts(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_acct_opts_pub.lock_trx_acct_opts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_trx_acct_opts(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_acct_opts_pub.update_trx_acct_opts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_trx_acct_opts(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_acct_opts_pub.delete_trx_acct_opts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_trx_acct_opts(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_acct_opts_pub.validate_trx_acct_opts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
