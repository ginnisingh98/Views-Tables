--------------------------------------------------------
--  DDL for Package Body PSB_WS_LINE_YEAR_I_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSB_WS_LINE_YEAR_I_PVT" AS
/* $Header: PSBWLYIB.pls 120.3 2005/09/23 08:28:08 shtripat ship $ */

  G_PKG_NAME CONSTANT VARCHAR2(30):= 'PSB_WS_LINE_YEAR_I_PVT';
...
BEGIN
  ...
  FOR i in 1..p_column_count LOOP
    ...
    /* Bug 3246927 Start */
		...
		l_ytd_amount := NVL(l_ytd_amount,0);
    	END IF;

    IF (l_ytd_amount IS NOT NULL) then
    -- IF (nvl(l_ytd_amount,0) <> 0) then
...
/* Bug No 1584464 End */
	...
	fnd_message.set_name('PSB', 'WS_CREATE_DIST_FAILED_EXC');
	RAISE FND_API.G_EXC_ERROR ;
      ELSIF l_return_status = FND_API.G_RET_STS_UNEXP_ERROR THEN
	fnd_message.set_name('PSB', 'WS_CREATE_DIST_FAILED_UNEXC');
	RAISE FND_API.G_EXC_UNEXPECTED_ERROR ;
      END IF;
