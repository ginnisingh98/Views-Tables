--------------------------------------------------------
--  DDL for Package Body BEN_DRR_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DRR_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_drr_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure update_dml(p_rec in out nocopy ben_drr_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Update the ben_dsgn_rqmt_rlshp_typ Row
  --
  update ben_dsgn_rqmt_rlshp_typ
  set
  dsgn_rqmt_rlshp_typ_id            = p_rec.dsgn_rqmt_rlshp_typ_id,
  rlshp_typ_cd                      = p_rec.rlshp_typ_cd,
  dsgn_rqmt_id                      = p_rec.dsgn_rqmt_id,
  business_group_id                 = p_rec.business_group_id,
  drr_attribute_category            = p_rec.drr_attribute_category,
  drr_attribute1                    = p_rec.drr_attribute1,
  drr_attribute2                    = p_rec.drr_attribute2,
  drr_attribute3                    = p_rec.drr_attribute3,
  drr_attribute4                    = p_rec.drr_attribute4,
  drr_attribute5                    = p_rec.drr_attribute5,
  drr_attribute6                    = p_rec.drr_attribute6,
  drr_attribute7                    = p_rec.drr_attribute7,
  drr_attribute8                    = p_rec.drr_attribute8,
  drr_attribute9                    = p_rec.drr_attribute9,
  drr_attribute10                   = p_rec.drr_attribute10,
  drr_attribute11                   = p_rec.drr_attribute11,
  drr_attribute12                   = p_rec.drr_attribute12,
  drr_attribute13                   = p_rec.drr_attribute13,
  drr_attribute14                   = p_rec.drr_attribute14,
  drr_attribute15                   = p_rec.drr_attribute15,
  drr_attribute16                   = p_rec.drr_attribute16,
  drr_attribute17                   = p_rec.drr_attribute17,
  drr_attribute18                   = p_rec.drr_attribute18,
  drr_attribute19                   = p_rec.drr_attribute19,
  drr_attribute20                   = p_rec.drr_attribute20,
  drr_attribute21                   = p_rec.drr_attribute21,
  drr_attribute22                   = p_rec.drr_attribute22,
  drr_attribute23                   = p_rec.drr_attribute23,
  drr_attribute24                   = p_rec.drr_attribute24,
  drr_attribute25                   = p_rec.drr_attribute25,
  drr_attribute26                   = p_rec.drr_attribute26,
  drr_attribute27                   = p_rec.drr_attribute27,
  drr_attribute28                   = p_rec.drr_attribute28,
  drr_attribute29                   = p_rec.drr_attribute29,
  drr_attribute30                   = p_rec.drr_attribute30,
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_update(p_rec in ben_drr_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy ben_drr_shd.g_rec_type) is
--
...
Begin
  ...
  If (p_rec.rlshp_typ_cd = hr_api.g_varchar2) then
    p_rec.rlshp_typ_cd :=
    ben_drr_shd.g_old_rec.rlshp_typ_cd;
  End If;
  If (p_rec.dsgn_rqmt_id = hr_api.g_number) then
    p_rec.dsgn_rqmt_id :=
    ben_drr_shd.g_old_rec.dsgn_rqmt_id;
  End If;
  If (p_rec.business_group_id = hr_api.g_number) then
    p_rec.business_group_id :=
    ben_drr_shd.g_old_rec.business_group_id;
  End If;
  If (p_rec.drr_attribute_category = hr_api.g_varchar2) then
    p_rec.drr_attribute_category :=
    ben_drr_shd.g_old_rec.drr_attribute_category;
  End If;
  If (p_rec.drr_attribute1 = hr_api.g_varchar2) then
    p_rec.drr_attribute1 :=
    ben_drr_shd.g_old_rec.drr_attribute1;
  End If;
  If (p_rec.drr_attribute2 = hr_api.g_varchar2) then
    p_rec.drr_attribute2 :=
    ben_drr_shd.g_old_rec.drr_attribute2;
  End If;
  If (p_rec.drr_attribute3 = hr_api.g_varchar2) then
    p_rec.drr_attribute3 :=
    ben_drr_shd.g_old_rec.drr_attribute3;
  End If;
  If (p_rec.drr_attribute4 = hr_api.g_varchar2) then
    p_rec.drr_attribute4 :=
    ben_drr_shd.g_old_rec.drr_attribute4;
  End If;
  If (p_rec.drr_attribute5 = hr_api.g_varchar2) then
    p_rec.drr_attribute5 :=
    ben_drr_shd.g_old_rec.drr_attribute5;
  End If;
  If (p_rec.drr_attribute6 = hr_api.g_varchar2) then
    p_rec.drr_attribute6 :=
    ben_drr_shd.g_old_rec.drr_attribute6;
  End If;
  If (p_rec.drr_attribute7 = hr_api.g_varchar2) then
    p_rec.drr_attribute7 :=
    ben_drr_shd.g_old_rec.drr_attribute7;
  End If;
  If (p_rec.drr_attribute8 = hr_api.g_varchar2) then
    p_rec.drr_attribute8 :=
    ben_drr_shd.g_old_rec.drr_attribute8;
  End If;
  If (p_rec.drr_attribute9 = hr_api.g_varchar2) then
    p_rec.drr_attribute9 :=
    ben_drr_shd.g_old_rec.drr_attribute9;
  End If;
  If (p_rec.drr_attribute10 = hr_api.g_varchar2) then
    p_rec.drr_attribute10 :=
    ben_drr_shd.g_old_rec.drr_attribute10;
  End If;
  If (p_rec.drr_attribute11 = hr_api.g_varchar2) then
    p_rec.drr_attribute11 :=
    ben_drr_shd.g_old_rec.drr_attribute11;
  End If;
  If (p_rec.drr_attribute12 = hr_api.g_varchar2) then
    p_rec.drr_attribute12 :=
    ben_drr_shd.g_old_rec.drr_attribute12;
  End If;
  If (p_rec.drr_attribute13 = hr_api.g_varchar2) then
    p_rec.drr_attribute13 :=
    ben_drr_shd.g_old_rec.drr_attribute13;
  End If;
  If (p_rec.drr_attribute14 = hr_api.g_varchar2) then
    p_rec.drr_attribute14 :=
    ben_drr_shd.g_old_rec.drr_attribute14;
  End If;
  If (p_rec.drr_attribute15 = hr_api.g_varchar2) then
    p_rec.drr_attribute15 :=
    ben_drr_shd.g_old_rec.drr_attribute15;
  End If;
  If (p_rec.drr_attribute16 = hr_api.g_varchar2) then
    p_rec.drr_attribute16 :=
    ben_drr_shd.g_old_rec.drr_attribute16;
  End If;
  If (p_rec.drr_attribute17 = hr_api.g_varchar2) then
    p_rec.drr_attribute17 :=
    ben_drr_shd.g_old_rec.drr_attribute17;
  End If;
  If (p_rec.drr_attribute18 = hr_api.g_varchar2) then
    p_rec.drr_attribute18 :=
    ben_drr_shd.g_old_rec.drr_attribute18;
  End If;
  If (p_rec.drr_attribute19 = hr_api.g_varchar2) then
    p_rec.drr_attribute19 :=
    ben_drr_shd.g_old_rec.drr_attribute19;
  End If;
  If (p_rec.drr_attribute20 = hr_api.g_varchar2) then
    p_rec.drr_attribute20 :=
    ben_drr_shd.g_old_rec.drr_attribute20;
  End If;
  If (p_rec.drr_attribute21 = hr_api.g_varchar2) then
    p_rec.drr_attribute21 :=
    ben_drr_shd.g_old_rec.drr_attribute21;
  End If;
  If (p_rec.drr_attribute22 = hr_api.g_varchar2) then
    p_rec.drr_attribute22 :=
    ben_drr_shd.g_old_rec.drr_attribute22;
  End If;
  If (p_rec.drr_attribute23 = hr_api.g_varchar2) then
    p_rec.drr_attribute23 :=
    ben_drr_shd.g_old_rec.drr_attribute23;
  End If;
  If (p_rec.drr_attribute24 = hr_api.g_varchar2) then
    p_rec.drr_attribute24 :=
    ben_drr_shd.g_old_rec.drr_attribute24;
  End If;
  If (p_rec.drr_attribute25 = hr_api.g_varchar2) then
    p_rec.drr_attribute25 :=
    ben_drr_shd.g_old_rec.drr_attribute25;
  End If;
  If (p_rec.drr_attribute26 = hr_api.g_varchar2) then
    p_rec.drr_attribute26 :=
    ben_drr_shd.g_old_rec.drr_attribute26;
  End If;
  If (p_rec.drr_attribute27 = hr_api.g_varchar2) then
    p_rec.drr_attribute27 :=
    ben_drr_shd.g_old_rec.drr_attribute27;
  End If;
  If (p_rec.drr_attribute28 = hr_api.g_varchar2) then
    p_rec.drr_attribute28 :=
    ben_drr_shd.g_old_rec.drr_attribute28;
  End If;
  If (p_rec.drr_attribute29 = hr_api.g_varchar2) then
    p_rec.drr_attribute29 :=
    ben_drr_shd.g_old_rec.drr_attribute29;
  End If;
  If (p_rec.drr_attribute30 = hr_api.g_varchar2) then
    p_rec.drr_attribute30 :=
    ben_drr_shd.g_old_rec.drr_attribute30;
  End If;
...
Begin
  ...
  --
  convert_defs(p_rec);
  ben_drr_bus.update_validate(p_rec
  ,p_effective_date);
  --
