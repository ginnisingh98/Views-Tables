--------------------------------------------------------
--  DDL for Package Body BEN_PREM_CSTG_BY_SGMT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PREM_CSTG_BY_SGMT_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_PREM_CSTG_BY_SGMT_BK2.UPDATE_PREM_CSTG_BY_SGMT_A', 10);
hr_utility.set_location(' Leaving: BEN_PREM_CSTG_BY_SGMT_BK2.UPDATE_PREM_CSTG_BY_SGMT_A', 20);
end UPDATE_PREM_CSTG_BY_SGMT_A;
...
begin
hr_utility.set_location('Entering: BEN_PREM_CSTG_BY_SGMT_BK2.UPDATE_PREM_CSTG_BY_SGMT_B', 10);
hr_utility.set_location(' Leaving: BEN_PREM_CSTG_BY_SGMT_BK2.UPDATE_PREM_CSTG_BY_SGMT_B', 20);
end UPDATE_PREM_CSTG_BY_SGMT_B;
