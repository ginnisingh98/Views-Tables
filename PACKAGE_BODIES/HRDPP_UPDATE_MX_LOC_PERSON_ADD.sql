--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_MX_LOC_PERSON_ADD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_MX_LOC_PERSON_ADD" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:06
 * Generated for API: HR_PERSON_ADDRESS_API.UPDATE_MX_LOC_PERSON_ADDRESS
 */
--
...
,P_STREET_NAME_AND_NUM in varchar2 default null
,P_NEIGHBORHOOD in varchar2 default null
,P_MUNICIPALITY in varchar2 default null
...
decode(l.pval012,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval012,'PER_MX_STATE_CODES',d(l.pval001),vn)) p12,
l.pval012 d12,
...
l.pval043 d43,
decode(l.pval044,cn,nn,vn,nh,n(l.pval044)) p44,
l.pval044 d44,
...
HR_PERSON_ADDRESS_API.UPDATE_MX_LOC_PERSON_ADDRESS
...
end hrdpp_UPDATE_MX_LOC_PERSON_ADD;
