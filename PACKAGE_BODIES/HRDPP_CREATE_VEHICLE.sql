--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_VEHICLE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_VEHICLE" as
/*
...
,P_VRE_INFORMATION20 in varchar2 default null) is
...
,P_MODEL
,dc(P_INITIAL_REGISTRATION)
,dc(P_LAST_REGISTRATION_RENEW_DATE)
,P_LIST_PRICE
...
,dc(P_LEASE_CONTRACT_EXPIRY_DATE)
,P_TAXATION_METHOD
,P_FLEET_INFO
,dc(P_FLEET_TRANSFER_DATE)
,P_COLOR
,P_SEATING_CAPACITY
,P_WEIGHT
,P_WEIGHT_UOM
...
decode(l.pval003,cn,vn,
 hr_pump_get.gl(l.pval003,'PQP_VEHICLE_TYPE',d(l.pval001),vn)) p3,
...
decode(l.pval007,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval007,'PQP_FUEL_TYPE',d(l.pval001),vn)) p7,
l.pval007 d7,
decode(l.pval008,cn,vn,vn,vn,l.pval008) p8,
l.pval008 d8,
decode(l.pval009,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval009,'PQP_VEHICLE_STATUS',d(l.pval001),vn)) p9,
l.pval009 d9,
decode(l.pval010,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval010,'PQP_VEHICLE_INACTIVE_REASONS',d(l.pval001),vn)) p10,
l.pval010 d10,
...
decode(l.pval021,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval021,'PQP_VEHICLE_OWNERSHIP_TYPE',d(l.pval001),vn)) p21,
l.pval021 d21,
...
l.pval024 d24,
decode(l.pval025,cn,dn,vn,dn,d(l.pval025)) p25,
l.pval025 d25,
decode(l.pval026,cn,vn,vn,vn,l.pval026) p26,
l.pval026 d26,
decode(l.pval027,cn,vn,vn,vn,l.pval027) p27,
l.pval027 d27,
decode(l.pval028,cn,dn,vn,dn,d(l.pval028)) p28,
l.pval028 d28,
...
l.pval034 d34,
decode(l.pval035,cn,dn,vn,dn,d(l.pval035)) p35,
l.pval035 d35,
...
,P_REGISTRATION_NUMBER => c.p2
,P_VEHICLE_TYPE => c.p3
,P_VEHICLE_ID_NUMBER => c.p4
,p_business_group_id => p_business_group_id
,P_MAKE => c.p5
,P_ENGINE_CAPACITY_IN_CC => c.p6
,P_FUEL_TYPE => c.p7
,P_CURRENCY_CODE => c.p8
,P_VEHICLE_STATUS => c.p9
,P_VEHICLE_INACTIVITY_REASON => c.p10
,P_MODEL => c.p11
,P_INITIAL_REGISTRATION => c.p12
,P_LAST_REGISTRATION_RENEW_DATE => c.p13
,P_LIST_PRICE => c.p14
,P_ACCESSORY_VALUE_AT_STARTDATE => c.p15
,P_ACCESSORY_VALUE_ADDED_LATER => c.p16
,P_MARKET_VALUE_CLASSIC_CAR => c.p17
,P_FISCAL_RATINGS => c.p18
,P_FISCAL_RATINGS_UOM => c.p19
,P_VEHICLE_PROVIDER => c.p20
,P_VEHICLE_OWNERSHIP => c.p21
,P_SHARED_VEHICLE => c.p22
,P_ASSET_NUMBER => c.p23
,P_LEASE_CONTRACT_NUMBER => c.p24
,P_LEASE_CONTRACT_EXPIRY_DATE => c.p25
,P_TAXATION_METHOD => c.p26
,P_FLEET_INFO => c.p27
,P_FLEET_TRANSFER_DATE => c.p28
,P_COLOR => c.p29
,P_SEATING_CAPACITY => c.p30
,P_WEIGHT => c.p31
,P_WEIGHT_UOM => c.p32
,P_MODEL_YEAR => c.p33
,P_INSURANCE_NUMBER => c.p34
,P_INSURANCE_EXPIRY_DATE => c.p35
,P_COMMENTS => c.p36
,P_VRE_ATTRIBUTE_CATEGORY => c.p37
,P_VRE_ATTRIBUTE1 => c.p38
,P_VRE_ATTRIBUTE2 => c.p39
,P_VRE_ATTRIBUTE3 => c.p40
,P_VRE_ATTRIBUTE4 => c.p41
,P_VRE_ATTRIBUTE5 => c.p42
,P_VRE_ATTRIBUTE6 => c.p43
,P_VRE_ATTRIBUTE7 => c.p44
,P_VRE_ATTRIBUTE8 => c.p45
,P_VRE_ATTRIBUTE9 => c.p46
,P_VRE_ATTRIBUTE10 => c.p47
,P_VRE_ATTRIBUTE11 => c.p48
,P_VRE_ATTRIBUTE12 => c.p49
,P_VRE_ATTRIBUTE13 => c.p50
,P_VRE_ATTRIBUTE14 => c.p51
,P_VRE_ATTRIBUTE15 => c.p52
,P_VRE_ATTRIBUTE16 => c.p53
,P_VRE_ATTRIBUTE17 => c.p54
,P_VRE_ATTRIBUTE18 => c.p55
,P_VRE_ATTRIBUTE19 => c.p56
,P_VRE_ATTRIBUTE20 => c.p57
,P_VRE_INFORMATION_CATEGORY => c.p58
,P_VRE_INFORMATION1 => c.p59
,P_VRE_INFORMATION2 => c.p60
,P_VRE_INFORMATION3 => c.p61
,P_VRE_INFORMATION4 => c.p62
,P_VRE_INFORMATION5 => c.p63
,P_VRE_INFORMATION6 => c.p64
,P_VRE_INFORMATION7 => c.p65
,P_VRE_INFORMATION8 => c.p66
,P_VRE_INFORMATION9 => c.p67
,P_VRE_INFORMATION10 => c.p68
,P_VRE_INFORMATION11 => c.p69
,P_VRE_INFORMATION12 => c.p70
,P_VRE_INFORMATION13 => c.p71
,P_VRE_INFORMATION14 => c.p72
,P_VRE_INFORMATION15 => c.p73
,P_VRE_INFORMATION16 => c.p74
,P_VRE_INFORMATION17 => c.p75
,P_VRE_INFORMATION18 => c.p76
,P_VRE_INFORMATION19 => c.p77
,P_VRE_INFORMATION20 => c.p78
,P_VEHICLE_REPOSITORY_ID => c.p79
,P_OBJECT_VERSION_NUMBER => c.p80
,P_EFFECTIVE_START_DATE => c.p81
,P_EFFECTIVE_END_DATE => c.p82);
