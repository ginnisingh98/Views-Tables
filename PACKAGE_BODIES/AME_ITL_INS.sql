--------------------------------------------------------
--  DDL for Package Body AME_ITL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ITL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_itl_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: ame_item_classes_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.item_class_id                    := p_item_class_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  ame_itl_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ame_itl_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where itl.item_class_id = p_item_class_id
                          and itl.language = l.language_code);
  --
