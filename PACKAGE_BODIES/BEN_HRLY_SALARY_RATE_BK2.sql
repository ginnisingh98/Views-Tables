--------------------------------------------------------
--  DDL for Package Body BEN_HRLY_SALARY_RATE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_HRLY_SALARY_RATE_BK2" as
/* $Header: behsrapi.pkb 120.0 2005/05/28 03:10:55 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_HRLY_SALARY_RATE_BK2.UPDATE_HRLY_SALARY_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_HRLY_SALARY_RATE_BK2.UPDATE_HRLY_SALARY_RATE_A', 20);
end UPDATE_HRLY_SALARY_RATE_A;
...
begin
hr_utility.set_location('Entering: BEN_HRLY_SALARY_RATE_BK2.UPDATE_HRLY_SALARY_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_HRLY_SALARY_RATE_BK2.UPDATE_HRLY_SALARY_RATE_B', 20);
end UPDATE_HRLY_SALARY_RATE_B;
