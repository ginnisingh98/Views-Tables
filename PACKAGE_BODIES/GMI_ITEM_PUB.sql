--------------------------------------------------------
--  DDL for Package Body GMI_ITEM_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GMI_ITEM_PUB" AS
--$Header: GMIPITMB.pls 115.13 2002/10/28 15:09:05 jdiiorio gmigapib.pls $
