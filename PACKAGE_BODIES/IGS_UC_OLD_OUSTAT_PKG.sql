--------------------------------------------------------
--  DDL for Package Body IGS_UC_OLD_OUSTAT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_UC_OLD_OUSTAT_PKG" AS
/* $Header: IGSXI43B.pls 115.3 2003/02/28 07:51:55 bayadav noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_uc_old_oustat%ROWTYPE;
  new_references igs_uc_old_oustat%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.old_outcome_status                := x_old_outcome_status;
  ...
  */
  ...
  BEGIN
    ...
    before_dml(
      ...
      x_old_outcome_status                => x_old_outcome_status,
    ...
    INSERT INTO igs_uc_old_oustat (
      ...
      new_references.app_no,
      new_references.choice_no,
      new_references.old_outcome_status,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.old_outcome_status = x_old_outcome_status)
  ...
  */
  ...
  BEGIN
    ...
    UPDATE igs_uc_old_oustat
      SET
        old_outcome_status                = new_references.old_outcome_status,
