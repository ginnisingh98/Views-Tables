--------------------------------------------------------
--  DDL for Package Body BEN_PL_CARE_PRVDR_TYP_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PL_CARE_PRVDR_TYP_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_PL_CARE_PRVDR_TYP_BK2.UPDATE_PL_CARE_PRVDR_TYP_A', 10);
hr_utility.set_location(' Leaving: BEN_PL_CARE_PRVDR_TYP_BK2.UPDATE_PL_CARE_PRVDR_TYP_A', 20);
end UPDATE_PL_CARE_PRVDR_TYP_A;
...
begin
hr_utility.set_location('Entering: BEN_PL_CARE_PRVDR_TYP_BK2.UPDATE_PL_CARE_PRVDR_TYP_B', 10);
hr_utility.set_location(' Leaving: BEN_PL_CARE_PRVDR_TYP_BK2.UPDATE_PL_CARE_PRVDR_TYP_B', 20);
end UPDATE_PL_CARE_PRVDR_TYP_B;
