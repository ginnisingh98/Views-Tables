--------------------------------------------------------
--  DDL for Package Body GME_TERMINATE_BATCH_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_TERMINATE_BATCH_PVT" AS
/*  $Header: GMEVTRBB.pls 120.5.12010000.2 2010/03/30 19:52:53 gmurator ship $    */
