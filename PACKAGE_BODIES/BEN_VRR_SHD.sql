--------------------------------------------------------
--  DDL for Package Body BEN_VRR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_VRR_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_vrr_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_VARBL_RT_RL_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_VARBL_RT_RL_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  If (p_effective_date is null or
    ...
    l_fct_ret := false;
  Else
    If (p_vrbl_rt_rl_id = g_old_rec.vrbl_rt_rl_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
    ...
    (p_effective_date      => p_effective_date,
     ...
     p_base_table_name     => 'ben_vrbl_rt_rl_f',
     p_base_key_column     => 'vrbl_rt_rl_id',
     p_base_key_value      => p_vrbl_rt_rl_id,
     p_parent_table_name1      => 'ben_actl_prem_f',
     --p_parent_key_column1      => 'actl_prem_id',
    -- p_parent_key_value1       => g_old_rec.actl_prem_id,
     p_parent_table_name2      => 'ben_acty_base_rt_f',
     p_parent_key_column2      => 'acty_base_rt_id',
     p_parent_key_value2       => g_old_rec.acty_base_rt_id,
...
Begin
  ...
  --
  l_rec.vrbl_rt_rl_id                    := p_vrbl_rt_rl_id;
  ...
  l_rec.vrr_attribute_category           := p_vrr_attribute_category;
  l_rec.vrr_attribute1                   := p_vrr_attribute1;
  l_rec.vrr_attribute2                   := p_vrr_attribute2;
  l_rec.vrr_attribute3                   := p_vrr_attribute3;
  l_rec.vrr_attribute4                   := p_vrr_attribute4;
  l_rec.vrr_attribute5                   := p_vrr_attribute5;
  l_rec.vrr_attribute6                   := p_vrr_attribute6;
  l_rec.vrr_attribute7                   := p_vrr_attribute7;
  l_rec.vrr_attribute8                   := p_vrr_attribute8;
  l_rec.vrr_attribute9                   := p_vrr_attribute9;
  l_rec.vrr_attribute10                  := p_vrr_attribute10;
  l_rec.vrr_attribute11                  := p_vrr_attribute11;
  l_rec.vrr_attribute12                  := p_vrr_attribute12;
  l_rec.vrr_attribute13                  := p_vrr_attribute13;
  l_rec.vrr_attribute14                  := p_vrr_attribute14;
  l_rec.vrr_attribute15                  := p_vrr_attribute15;
  l_rec.vrr_attribute16                  := p_vrr_attribute16;
  l_rec.vrr_attribute17                  := p_vrr_attribute17;
  l_rec.vrr_attribute18                  := p_vrr_attribute18;
  l_rec.vrr_attribute19                  := p_vrr_attribute19;
  l_rec.vrr_attribute20                  := p_vrr_attribute20;
  l_rec.vrr_attribute21                  := p_vrr_attribute21;
  l_rec.vrr_attribute22                  := p_vrr_attribute22;
  l_rec.vrr_attribute23                  := p_vrr_attribute23;
  l_rec.vrr_attribute24                  := p_vrr_attribute24;
  l_rec.vrr_attribute25                  := p_vrr_attribute25;
  l_rec.vrr_attribute26                  := p_vrr_attribute26;
  l_rec.vrr_attribute27                  := p_vrr_attribute27;
  l_rec.vrr_attribute28                  := p_vrr_attribute28;
  l_rec.vrr_attribute29                  := p_vrr_attribute29;
  l_rec.vrr_attribute30                  := p_vrr_attribute30;
