--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_SUPPLEMENTARY_ROL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_SUPPLEMENTARY_ROL" as
/*
 * Generated by hr_pump_meta_mapper at: 2013/08/29 22:08:27
 * Generated for API: PER_SUPPLEMENTARY_ROLE_API.CREATE_SUPPLEMENTARY_ROLE
 */
--
...
,dc(P_START_DATE)
,dc(P_END_DATE)
,dc(P_CONFIDENTIAL_DATE)
,P_EMP_RIGHTS_FLAG
,dc(P_END_OF_RIGHTS_DATE)
...
decode(l.pval005,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval005,'YES_NO',d(l.pval001),l.pval056)) p5,
l.pval005 d5,
decode(l.pval006,cn,dn,vn,dn,d(l.pval006)) p6,
l.pval006 d6,
decode(l.pval007,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval007,'YES_NO',d(l.pval001),l.pval056)) p7,
l.pval007 d7,
...
l.pval050 p50,
l.pval051 p51,
decode(l.pval052,cn,vn,l.pval052) p52,
decode(l.pval053,cn,vn,l.pval053) p53,
...
(P_ORGANIZATION_NAME => c.p55
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p56);
end if;
--
...
,P_ROLE_ID => L_ROLE_ID
,P_OBJECT_VERSION_NUMBER => c.p51);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p50,L_ROLE_ID);
--
...
end hrdpp_CREATE_SUPPLEMENTARY_ROL;
