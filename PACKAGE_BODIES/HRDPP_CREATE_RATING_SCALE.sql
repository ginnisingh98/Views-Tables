--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_RATING_SCALE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_RATING_SCALE" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:06
 * Generated for API: HR_RATING_SCALES_API.CREATE_RATING_SCALE
 */
--
...
decode(l.pval004,cn,vn,
 hr_pump_get.gl(l.pval004,'RATING_SCALE_TYPE',d(l.pval002),l.pval001)) p4,
...
HR_RATING_SCALES_API.CREATE_RATING_SCALE
