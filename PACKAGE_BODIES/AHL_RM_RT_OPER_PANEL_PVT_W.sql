--------------------------------------------------------
--  DDL for Package Body AHL_RM_RT_OPER_PANEL_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AHL_RM_RT_OPER_PANEL_PVT_W" as
  /* $Header: AHLWRAPB.pls 120.0.12000000.1 2007/10/17 13:21:24 adivenka noship $ */
  ...
  procedure rosetta_table_copy_in_p1(t out nocopy ahl_rm_rt_oper_panel_pvt.rt_oper_panel_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_DATE_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        ddindx := 1;
        while true loop
          t(ddindx).rt_oper_panel_id := a0(indx);
          ...
          t(ddindx).panel_type_id := a7(indx);
          t(ddindx).panel_type := a8(indx);
  ...
  procedure rosetta_table_copy_out_p1(t ahl_rm_rt_oper_panel_pvt.rt_oper_panel_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  if t is null or t.count = 0 then
    ...
    a25 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        indx := 1;
        while true loop
          a0(indx) := t(ddindx).rt_oper_panel_id;
          ...
          a7(indx) := t(ddindx).panel_type_id;
          a8(indx) := t(ddindx).panel_type;
  ...
  procedure process_rt_oper_panel(p_api_version  NUMBER
  ...
  as
    ddp_x_rt_oper_panel_tbl ahl_rm_rt_oper_panel_pvt.rt_oper_panel_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ahl_rm_rt_oper_panel_pvt_w.rosetta_table_copy_in_p1(ddp_x_rt_oper_panel_tbl, p9_a0
      , p9_a1
      , p9_a2
      , p9_a3
      , p9_a4
    ...
    ahl_rm_rt_oper_panel_pvt.process_rt_oper_panel(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      p_default,
    ...
    ahl_rm_rt_oper_panel_pvt_w.rosetta_table_copy_out_p1(ddp_x_rt_oper_panel_tbl, p9_a0
      , p9_a1
      , p9_a2
      , p9_a3
      , p9_a4
...
end ahl_rm_rt_oper_panel_pvt_w;
