--------------------------------------------------------
--  DDL for Package Body PSB_PARAMETER_FORMULAS_L_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSB_PARAMETER_FORMULAS_L_PVT" AS
/* $Header: PSBWPFLB.pls 120.2 2005/07/13 11:36:07 shtripat ship $ */
...
PSB_PARAMETER_FORMULAS_PVT.LOCK_ROW (
  p_api_version ,
  p_init_msg_list,
  p_commit  ,
  p_validation_level,
