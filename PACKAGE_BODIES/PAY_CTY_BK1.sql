--------------------------------------------------------
--  DDL for Package Body PAY_CTY_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_CTY_BK1" as
...
begin
hr_utility.set_location('Entering: PAY_CTY_BK1.CREATE_CITY_TAX_RULE_A', 10);
hr_utility.set_location(' Leaving: PAY_CTY_BK1.CREATE_CITY_TAX_RULE_A', 20);
end CREATE_CITY_TAX_RULE_A;
...
begin
hr_utility.set_location('Entering: PAY_CTY_BK1.CREATE_CITY_TAX_RULE_B', 10);
hr_utility.set_location(' Leaving: PAY_CTY_BK1.CREATE_CITY_TAX_RULE_B', 20);
end CREATE_CITY_TAX_RULE_B;
end PAY_CTY_BK1;
