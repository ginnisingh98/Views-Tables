--------------------------------------------------------
--  DDL for Package Body BEN_SHR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_SHR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_shr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.schedd_hrs_rt_id       = p_rec.schedd_hrs_rt_id
    and    t.effective_start_date =
             ben_shr_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_schedd_hrs_rt_f.created_by%TYPE;
  l_creation_date       ben_schedd_hrs_rt_f.creation_date%TYPE;
  l_last_update_date   	ben_schedd_hrs_rt_f.last_update_date%TYPE;
  l_last_updated_by     ben_schedd_hrs_rt_f.last_updated_by%TYPE;
  l_last_update_login   ben_schedd_hrs_rt_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_schedd_hrs_rt_f
  --
  insert into ben_schedd_hrs_rt_f
  (	schedd_hrs_rt_id,
...
--
  ...
  cursor c1 is select ben_schedd_hrs_rt_f_s.nextval
               from   sys.dual;
--
--
--
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.schedd_hrs_rt_id;
  close c1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  p_schedd_hrs_rt_id        	:= l_rec.schedd_hrs_rt_id;
