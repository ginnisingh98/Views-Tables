--------------------------------------------------------
--  DDL for Package Body BEN_XCC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XCC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xcc_ins.';  -- Global package name
...
Begin
  ...
  --
  -- Insert the row into: ben_ext_crit_cmbn
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ext_crit_cmbn_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
--
  ...
  --
  create_app_ownerships('EXT_CRIT_CMBN_ID', p_rec.ext_crit_cmbn_id);
  --
...
Begin
  ...
  --
  p_ext_crit_cmbn_id := l_rec.ext_crit_cmbn_id;
