--------------------------------------------------------
--  DDL for Package Body PSP_POA_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_POA_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  psp_poa_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_organization_account_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_organization_account_id  in  number) is
--
...
Begin
  ...
  --
  psp_poa_ins.g_organization_account_id_i := p_organization_account_id;
  --
...
Begin
  ...
  --
  -- Insert the row into: psp_organization_accounts
  --
  insert into psp_organization_accounts
...
--
  Cursor C_Sel1 is select psp_organization_accounts_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from psp_organization_accounts
     where organization_account_id =
             psp_poa_ins.g_organization_account_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (psp_poa_ins.g_organization_account_id_i is not null) Then
    --
    ...
    p_rec.organization_account_id :=
      psp_poa_ins.g_organization_account_id_i;
    psp_poa_ins.g_organization_account_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.organization_account_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  psp_poa_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  psp_poa_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  psp_poa_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
...
Procedure ins
  ...
  ,p_funding_source_code            in     varchar2 default null
...
Begin
  ...
  --
  p_organization_account_id := l_rec.organization_account_id;
