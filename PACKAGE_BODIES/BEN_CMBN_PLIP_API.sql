--------------------------------------------------------
--  DDL for Package Body BEN_CMBN_PLIP_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CMBN_PLIP_API" as
/* $Header: becplapi.pkb 120.0 2005/05/28 01:14:12 appldev noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_CMBN_PLIP_api.';
--
-- ----------------------------------------------------------------------------
-- |------------------------< create_CMBN_PLIP >----------------------|
-- ----------------------------------------------------------------------------
...
procedure create_CMBN_PLIP
  ...
  --
  l_cmbn_plip_id ben_cmbn_plip_f.cmbn_plip_id%TYPE;
  l_effective_start_date ben_cmbn_plip_f.effective_start_date%TYPE;
  l_effective_end_date ben_cmbn_plip_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_CMBN_PLIP';
  l_object_version_number ben_cmbn_plip_f.object_version_number%TYPE;
  --
begin
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_CMBN_PLIP
    --
    ben_CMBN_PLIP_bk1.create_CMBN_PLIP_b
      (
       p_name                           =>  p_name
      ,p_business_group_id              =>  p_business_group_id
      ,p_cpl_attribute_category         =>  p_cpl_attribute_category
      ,p_cpl_attribute1                 =>  p_cpl_attribute1
      ,p_cpl_attribute2                 =>  p_cpl_attribute2
      ,p_cpl_attribute3                 =>  p_cpl_attribute3
      ,p_cpl_attribute4                 =>  p_cpl_attribute4
      ,p_cpl_attribute5                 =>  p_cpl_attribute5
      ,p_cpl_attribute6                 =>  p_cpl_attribute6
      ,p_cpl_attribute7                 =>  p_cpl_attribute7
      ,p_cpl_attribute8                 =>  p_cpl_attribute8
      ,p_cpl_attribute9                 =>  p_cpl_attribute9
      ,p_cpl_attribute10                =>  p_cpl_attribute10
      ,p_cpl_attribute11                =>  p_cpl_attribute11
      ,p_cpl_attribute12                =>  p_cpl_attribute12
      ,p_cpl_attribute13                =>  p_cpl_attribute13
      ,p_cpl_attribute14                =>  p_cpl_attribute14
      ,p_cpl_attribute15                =>  p_cpl_attribute15
      ,p_cpl_attribute16                =>  p_cpl_attribute16
      ,p_cpl_attribute17                =>  p_cpl_attribute17
      ,p_cpl_attribute18                =>  p_cpl_attribute18
      ,p_cpl_attribute19                =>  p_cpl_attribute19
      ,p_cpl_attribute20                =>  p_cpl_attribute20
      ,p_cpl_attribute21                =>  p_cpl_attribute21
      ,p_cpl_attribute22                =>  p_cpl_attribute22
      ,p_cpl_attribute23                =>  p_cpl_attribute23
      ,p_cpl_attribute24                =>  p_cpl_attribute24
      ,p_cpl_attribute25                =>  p_cpl_attribute25
      ,p_cpl_attribute26                =>  p_cpl_attribute26
      ,p_cpl_attribute27                =>  p_cpl_attribute27
      ,p_cpl_attribute28                =>  p_cpl_attribute28
      ,p_cpl_attribute29                =>  p_cpl_attribute29
      ,p_cpl_attribute30                =>  p_cpl_attribute30
      ,p_pgm_id                         =>  p_pgm_id
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_CMBN_PLIP'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_CMBN_PLIP
    --
  end;
  --
  ben_cpl_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_CMBN_PLIP
    --
    ben_CMBN_PLIP_bk1.create_CMBN_PLIP_a
      (
       p_cmbn_plip_id                   =>  l_cmbn_plip_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_CMBN_PLIP
    --
  end;
  --
...
procedure update_CMBN_PLIP
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_CMBN_PLIP';
  l_object_version_number ben_cmbn_plip_f.object_version_number%TYPE;
  l_effective_start_date ben_cmbn_plip_f.effective_start_date%TYPE;
  l_effective_end_date ben_cmbn_plip_f.effective_end_date%TYPE;
  --
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_CMBN_PLIP
    --
    ben_CMBN_PLIP_bk2.update_CMBN_PLIP_b
      (
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_CMBN_PLIP'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_CMBN_PLIP
    --
  end;
  --
  ben_cpl_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_CMBN_PLIP
    --
    ben_CMBN_PLIP_bk2.update_CMBN_PLIP_a
      (
       p_cmbn_plip_id                   =>  p_cmbn_plip_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_CMBN_PLIP
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_CMBN_PLIP
    --
    ben_CMBN_PLIP_bk3.delete_CMBN_PLIP_b
      (
       p_cmbn_plip_id                   =>  p_cmbn_plip_id
      ,p_object_version_number          =>  p_object_version_number
    ,p_effective_date                      => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_CMBN_PLIP'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_CMBN_PLIP
    --
  end;
  --
  ben_cpl_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_CMBN_PLIP
    --
    ben_CMBN_PLIP_bk3.delete_CMBN_PLIP_a
      (
       p_cmbn_plip_id                   =>  p_cmbn_plip_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_CMBN_PLIP
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
