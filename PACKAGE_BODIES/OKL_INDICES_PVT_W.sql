--------------------------------------------------------
--  DDL for Package Body OKL_INDICES_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_INDICES_PVT_W" as
  /* $Header: OKLOIDXB.pls 120.1 2005/07/14 12:00:27 asawanka noship $ */
  ...
  as
    ddp_idxv_rec okl_indices_pvt.idxv_rec_type;
    ddp_ivev_tbl okl_indices_pvt.ivev_tbl_type;
    ddx_idxv_rec okl_indices_pvt.idxv_rec_type;
    ddx_ivev_tbl okl_indices_pvt.ivev_tbl_type;
  ...
  begin
    ...
    okl_indices_pvt.create_indices(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_indices_pvt.update_indices(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_indices_pvt.validate_indices(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_idxv_tbl okl_indices_pvt.idxv_tbl_type;
    ddx_idxv_tbl okl_indices_pvt.idxv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_indices_pvt.lock_indices(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_indices_pvt.delete_indices(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_indices_pvt.create_index_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ivev_rec okl_indices_pvt.ivev_rec_type;
    ddx_ivev_rec okl_indices_pvt.ivev_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_indices_pvt.lock_index_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_indices_pvt.update_index_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_indices_pvt.delete_index_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_indices_pvt.validate_index_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
