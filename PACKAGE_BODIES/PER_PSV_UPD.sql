--------------------------------------------------------
--  DDL for Package Body PER_PSV_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PSV_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_psv_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Update the per_pos_structure_versions Row
  --
...
Begin
  ...
  --
  per_psv_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  per_psv_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  per_psv_upd.post_update
     (p_effective_date
     ,p_rec
     );
End upd;
