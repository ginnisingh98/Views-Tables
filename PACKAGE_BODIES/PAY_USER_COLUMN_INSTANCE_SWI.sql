--------------------------------------------------------
--  DDL for Package Body PAY_USER_COLUMN_INSTANCE_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_USER_COLUMN_INSTANCE_SWI" As
/* $Header: pypciswi.pkb 120.0 2005/05/29 07:24 appldev noship $ */
--
-- Package variables
--
g_package  varchar2(43) := 'pay_user_column_instance_swi';
--
-- ----------------------------------------------------------------------------
