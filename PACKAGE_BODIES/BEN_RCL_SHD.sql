--------------------------------------------------------
--  DDL for Package Body BEN_RCL_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_RCL_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_rcl_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_RLTD_PER_CHG_CS_LER_F_FK1') Then
    fnd_message.set_name('BEN', 'BEN_91000_INVALID_BUS_GROUP');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_RLTD_PER_CHG_CS_LER_F_PK') Then
...
--
  ...
  Cursor C_Sel1 is
    ...
    where	rltd_per_chg_cs_ler_id = p_rltd_per_chg_cs_ler_id
...
Begin
  ...
  If (p_effective_date is null or
      p_rltd_per_chg_cs_ler_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_rltd_per_chg_cs_ler_id = g_old_rec.rltd_per_chg_cs_ler_id and
...
Begin
  ...
  --
  update  ben_rltd_per_chg_cs_ler_f t
  set	  t.effective_end_date	  = p_new_effective_end_date,
	  t.object_version_number = l_object_version_number
  where	  t.rltd_per_chg_cs_ler_id	  = p_base_key_value
  and	  p_effective_date
...
Begin
  ...
  l_rec.rltd_per_chg_cs_ler_rl           := p_rltd_per_chg_cs_ler_rl;
  l_rec.business_group_id                := p_business_group_id;
  l_rec.rcl_attribute_category           := p_rcl_attribute_category;
  l_rec.rcl_attribute1                   := p_rcl_attribute1;
  l_rec.rcl_attribute2                   := p_rcl_attribute2;
  l_rec.rcl_attribute3                   := p_rcl_attribute3;
  l_rec.rcl_attribute4                   := p_rcl_attribute4;
  l_rec.rcl_attribute5                   := p_rcl_attribute5;
  l_rec.rcl_attribute6                   := p_rcl_attribute6;
  l_rec.rcl_attribute7                   := p_rcl_attribute7;
  l_rec.rcl_attribute8                   := p_rcl_attribute8;
  l_rec.rcl_attribute9                   := p_rcl_attribute9;
  l_rec.rcl_attribute10                  := p_rcl_attribute10;
  l_rec.rcl_attribute11                  := p_rcl_attribute11;
  l_rec.rcl_attribute12                  := p_rcl_attribute12;
  l_rec.rcl_attribute13                  := p_rcl_attribute13;
  l_rec.rcl_attribute14                  := p_rcl_attribute14;
  l_rec.rcl_attribute15                  := p_rcl_attribute15;
  l_rec.rcl_attribute16                  := p_rcl_attribute16;
  l_rec.rcl_attribute17                  := p_rcl_attribute17;
  l_rec.rcl_attribute18                  := p_rcl_attribute18;
  l_rec.rcl_attribute19                  := p_rcl_attribute19;
  l_rec.rcl_attribute20                  := p_rcl_attribute20;
  l_rec.rcl_attribute21                  := p_rcl_attribute21;
  l_rec.rcl_attribute22                  := p_rcl_attribute22;
  l_rec.rcl_attribute23                  := p_rcl_attribute23;
  l_rec.rcl_attribute24                  := p_rcl_attribute24;
  l_rec.rcl_attribute25                  := p_rcl_attribute25;
  l_rec.rcl_attribute26                  := p_rcl_attribute26;
  l_rec.rcl_attribute27                  := p_rcl_attribute27;
  l_rec.rcl_attribute28                  := p_rcl_attribute28;
  l_rec.rcl_attribute29                  := p_rcl_attribute29;
  l_rec.rcl_attribute30                  := p_rcl_attribute30;
