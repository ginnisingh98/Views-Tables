--------------------------------------------------------
--  DDL for Package Body OKL_TRX_CONTRACTS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TRX_CONTRACTS_PUB_W" as
  /* $Header: OKLUTCNB.pls 120.9.12010000.6 2008/11/12 23:53:29 apaul ship $ */
  ...
  as
    ddp_tcnv_rec okl_trx_contracts_pub.tcnv_rec_type;
    ddp_tclv_tbl okl_trx_contracts_pub.tclv_tbl_type;
    ddx_tcnv_rec okl_trx_contracts_pub.tcnv_rec_type;
  ...
  begin
    ...
    okl_trx_contracts_pub.create_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pub.update_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pub.validate_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tcnv_tbl okl_trx_contracts_pub.tcnv_tbl_type;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pub.lock_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pub.delete_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pub.create_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tclv_rec okl_trx_contracts_pub.tclv_rec_type;
    ddx_tclv_rec okl_trx_contracts_pub.tclv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pub.lock_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pub.update_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pub.delete_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pub.validate_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
