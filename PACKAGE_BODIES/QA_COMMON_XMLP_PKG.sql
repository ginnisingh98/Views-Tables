--------------------------------------------------------
--  DDL for Package Body QA_COMMON_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."QA_COMMON_XMLP_PKG" As
/* $Header: QACOMMONB.pls 120.0 2007/12/27 08:19:42 dwkrishn noship $ */
