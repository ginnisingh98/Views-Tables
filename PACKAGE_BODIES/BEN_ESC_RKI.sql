--------------------------------------------------------
--  DDL for Package Body BEN_ESC_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ESC_RKI" as
...
begin
hr_utility.set_location('Entering: ben_esc_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_esc_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_esc_RKI;
