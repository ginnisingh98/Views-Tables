--------------------------------------------------------
--  DDL for Package Body BEN_LCT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LCT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_lct_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.ler_chg_ptip_enrt_id       = p_rec.ler_chg_ptip_enrt_id
    and    t.effective_start_date =
             ben_lct_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_ler_chg_ptip_enrt_f.created_by%TYPE;
  l_creation_date       ben_ler_chg_ptip_enrt_f.creation_date%TYPE;
  l_last_update_date   	ben_ler_chg_ptip_enrt_f.last_update_date%TYPE;
  l_last_updated_by     ben_ler_chg_ptip_enrt_f.last_updated_by%TYPE;
  l_last_update_login   ben_ler_chg_ptip_enrt_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_ler_chg_ptip_enrt_f
  --
  insert into ben_ler_chg_ptip_enrt_f
...
--
--
  cursor c1 is select ben_ler_chg_ptip_enrt_f_s.nextval
               from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  ...
  --
  open c1;
  fetch c1 into p_rec.ler_chg_ptip_enrt_id;
  close c1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_lct_rec
  ...
  --
  p_ler_chg_ptip_enrt_id        	:= l_rec.ler_chg_ptip_enrt_id;
