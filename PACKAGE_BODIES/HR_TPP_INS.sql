--------------------------------------------------------
--  DDL for Package Body HR_TPP_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_TPP_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_tpp_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: hr_tab_page_properties_b
  --
...
--
  Cursor C_Sel1 is select hr_tab_page_properties_b_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.tab_page_property_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  hr_tpp_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  hr_tpp_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hr_tpp_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Begin
  ...
  --
  p_tab_page_property_id := l_rec.tab_page_property_id;
