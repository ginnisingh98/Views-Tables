--------------------------------------------------------
--  DDL for Package Body PQH_TJR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_TJR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_tjr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: pqh_txn_job_requirements
  --
...
--
  Cursor C_Sel1 is select pqh_txn_job_requirements_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.txn_job_requirement_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  pqh_tjr_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  pqh_tjr_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pqh_tjr_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pqh_tjr_ins.post_insert
     (p_rec
     );
  --
...
Begin
  ...
  --
  p_txn_job_requirement_id := l_rec.txn_job_requirement_id;
