--------------------------------------------------------
--  DDL for Package Body XTR_FORECAST_HEADERS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."XTR_FORECAST_HEADERS_PKG" AS
/* $Header: xtrfhdrb.pls 120.1 2005/06/29 06:39:16 badiredd ship $ 	*/
--
-- Package
--   XTR_FORECASTT_HEADERS_PKG
-- Purpose
...
--
  ...
  PROCEDURE Check_Unique(
		X_rowid			VARCHAR2,
		X_name			VARCHAR2,
		l_err_code	IN OUT NOCOPY	VARCHAR2) IS
  ...
  BEGIN
	...
	IF chk_duplicates%FOUND THEN
		l_err_code := 'CE_DUPLICATE_FORECAST_HDR';
/*
