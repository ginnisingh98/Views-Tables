--------------------------------------------------------
--  DDL for Package Body OE_8PC1_ORDER_HDRINVC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_8PC1_ORDER_HDRINVC" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_status_code varchar2(8) :='COMPLETE';
   ...
   AND a.HEADER_ID = OE_LINE_ADJ_SECURITY.g_record.HEADER_ID
;
