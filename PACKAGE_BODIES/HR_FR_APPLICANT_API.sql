--------------------------------------------------------
--  DDL for Package Body HR_FR_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_FR_APPLICANT_API" as
/* $Header: peappfri.pkb 115.2 2002/12/11 16:01:59 sfmorris noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := 'hr_fr_applicant_api.';
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_fr_applicant >--------------------------|
-- ----------------------------------------------------------------------------
...
procedure create_fr_applicant
  ...
  ,p_number_of_dependents          in     varchar2
  ...
  --
  l_proc                 varchar2(72) := g_package||'create_fr_applicant';
