--------------------------------------------------------
--  DDL for Package Body HR_FGT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_FGT_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_fgt_bus.';  -- Global package name
--
...
begin
  ...
  --
  hr_fdg_bus.set_security_group_id
...
Begin
  ...
  hr_utility.set_location('Entering:'|| l_proc, 10);
  --
  l_legislation_code := hr_fdg_bus.return_legislation_code
    (p_form_data_group_id           => p_form_data_group_id
    );
  --
...
Begin
  ...
  --
  IF NOT hr_fgt_shd.api_updating
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 10);
  --
  l_api_updating := hr_fgt_shd.api_updating
    (p_form_data_group_id           => p_form_data_group_id
  ...
  --
  if (  (   l_api_updating
        and nvl(hr_fgt_shd.g_old_rec.source_lang,hr_api.g_varchar2) <>
...
--
-- ----------------------------------------------------------------------------
-- |-----------------------< chk_user_data_group_name >-----------------------|
-- ----------------------------------------------------------------------------
Procedure chk_user_data_group_name
  (p_form_data_group_id           in number
  ,p_language                     in varchar2
  ,p_user_data_group_name         in varchar2
  ) is
  --
  l_proc                         varchar2(72) := g_package || 'chk_user_data_group_name';
  l_api_updating                 boolean;
  --
Begin
  hr_utility.set_location('Entering:'||l_proc, 10);
  ...
  hr_api.mandatory_arg_error
    (p_api_name                     => l_proc
    ,p_argument                     => 'user_data_group_name'
    ,p_argument_value               => p_user_data_group_name
    );
  --
  hr_utility.set_location('Leaving:'||l_proc, 100);
End chk_user_data_group_name;
--
-- ----------------------------------------------------------------------------
-- |---------------------------< chk_description >----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  chk_user_data_group_name
    (p_form_data_group_id           => p_rec.form_data_group_id
    ,p_language                     => p_rec.language
    ,p_user_data_group_name         => p_rec.user_data_group_name
    );
  --
  chk_description
    (p_form_data_group_id           => p_rec.form_data_group_id
