--------------------------------------------------------
--  DDL for Package Body BEN_PEI_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PEI_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)    := '  ben_pei_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    select t.created_by,
           t.creation_date
    from   ben_pl_extract_identifier_f t
    where  t.pl_extract_identifier_id = p_rec.pl_extract_identifier_id
    and    t.effective_start_date =  ben_pei_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc        varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_pl_extract_identifier_f.created_by%TYPE;
  l_creation_date       ben_pl_extract_identifier_f.creation_date%TYPE;
  l_last_update_date    ben_pl_extract_identifier_f.last_update_date%TYPE;
  l_last_updated_by     ben_pl_extract_identifier_f.last_updated_by%TYPE;
  l_last_update_login   ben_pl_extract_identifier_f.last_update_login%TYPE;
--
Begin
  ...
  --
  insert into ben_pl_extract_identifier_f
    (
  ...
  values
    (
     p_rec.pl_extract_identifier_id
    ,p_rec.pl_id
    ,p_rec.plip_id
    ,p_rec.oipl_id
...
Procedure pre_insert
  ...
  --
  cursor c1 is
    select ben_pl_extract_identifier_s.nextval
    from   sys.dual;
  --
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  open c1;
    fetch c1 into p_rec.pl_extract_identifier_id;
  close c1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  p_pl_extract_identifier_id  := l_rec.pl_extract_identifier_id;
