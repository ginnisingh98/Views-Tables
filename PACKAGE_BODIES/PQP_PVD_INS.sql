--------------------------------------------------------
--  DDL for Package Body PQP_PVD_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_PVD_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqp_pvd_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Insert the row into: pqp_vehicle_details
  --
  insert into pqp_vehicle_details
      (vehicle_details_id
      ,vehicle_type
      ,business_group_id
      ,registration_number
...
--
  Cursor C_Sel1 is select pqp_vehicle_details_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.vehicle_details_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  pqp_pvd_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pqp_pvd_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pqp_pvd_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
--    ,p_private_use_contributions
  ...
  --
  p_vehicle_details_id := l_rec.vehicle_details_id;
