--------------------------------------------------------
--  DDL for Package Body JTF_TASK_ASSIGNMENTS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_TASK_ASSIGNMENTS_PUB_W" as
  /* $Header: jtfbtkab.pls 120.3 2006/04/26 04:16 knayyar ship $ */
  ...
  begin
    ...
    jtf_task_assignments_pub.create_task_assignment(p_api_version,
      p_init_msg_list,
      p_commit,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    jtf_task_assignments_pub.update_task_assignment(p_api_version,
