--------------------------------------------------------
--  DDL for Package Body PAY_BALANCE_FEEDS_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_BALANCE_FEEDS_BE2" as 
...
p_exist_run_result_warning     boolean) is
  ...
  --
  l_proc varchar2(72):='  pay_balance_feeds_be2.update_balance_feed_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.pay.api.balance_feeds.update_balance_feed';
