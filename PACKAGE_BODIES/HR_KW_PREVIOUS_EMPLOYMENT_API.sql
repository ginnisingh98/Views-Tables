--------------------------------------------------------
--  DDL for Package Body HR_KW_PREVIOUS_EMPLOYMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_KW_PREVIOUS_EMPLOYMENT_API" as
/* $Header: pepemkwi.pkb 120.0 2005/05/31 13:26:24 appldev noship $ */

   -- Package Variables
   g_package   VARCHAR2(33) := 'hr_kw_previous_employment_api.';
...
begin
 ...
 l_proc :=  g_package||'create_kw_previous_employer';
 if g_debug then
...
(  p_effective_date               =>      l_effective_date
 ...
 if g_debug then
  ...
  --
end create_kw_previous_employer;
...
begin
 ...
 l_proc :=  g_package||'update_kw_previous_employer';
 if g_debug then
  hr_utility.set_location('Entering:'|| l_proc, 5);
 end if;
  --
...
(  p_effective_date             =>      l_effective_date
 ...
 if g_debug then
  ...
  --
end update_kw_previous_employer;
