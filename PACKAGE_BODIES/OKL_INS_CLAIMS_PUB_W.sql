--------------------------------------------------------
--  DDL for Package Body OKL_INS_CLAIMS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_INS_CLAIMS_PUB_W" as
  /* $Header: OKLOCLMB.pls 115.2 2003/05/26 07:46:11 arajagop noship $ */
  ...
  procedure insert_ins_claims(p_api_version  NUMBER
  ...
  as
    ddp_clmv_tbl okl_ins_claims_pub.clmv_tbl_type;
    ddx_clmv_tbl okl_ins_claims_pub.clmv_tbl_type;
  ...
  begin
    ...
    okl_ins_claims_pub.insert_ins_claims(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_clmv_rec okl_ins_claims_pub.clmv_rec_type;
    ddx_clmv_rec okl_ins_claims_pub.clmv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_ins_claims(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_claims_pub.lock_ins_claims(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_ins_claims(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_claims_pub.update_ins_claims(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_ins_claims(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_claims_pub.delete_ins_claims(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_ins_claims(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_claims_pub.validate_ins_claims(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
