--------------------------------------------------------
--  DDL for Package Body OKL_CRT_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CRT_PVT_W" as
  /* $Header: OKLICRTB.pls 115.2 2003/10/07 17:58:41 pdevaraj noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_crt_pvt.crtv_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p2(t okl_crt_pvt.crtv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_crt_pvt.crt_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_VARCHAR2_TABLE_200
    , a2 JTF_VARCHAR2_TABLE_100
    , a3 JTF_DATE_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).currency_code := a15(indx);
          t(ddindx).program_update_date := rosetta_g_miss_date_in_map(a16(indx));
          t(ddindx).attribute_category := a17(indx);
          t(ddindx).attribute1 := a18(indx);
          t(ddindx).attribute2 := a19(indx);
  ...
  procedure rosetta_table_copy_out_p5(t okl_crt_pvt.crt_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_VARCHAR2_TABLE_200
    , a2 out nocopy JTF_VARCHAR2_TABLE_100
    , a3 out nocopy JTF_DATE_TABLE
    , a4 out nocopy JTF_NUMBER_TABLE
    ...
    a37 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a15(indx) := t(ddindx).currency_code;
          a16(indx) := t(ddindx).program_update_date;
          a17(indx) := t(ddindx).attribute_category;
          a18(indx) := t(ddindx).attribute1;
          a19(indx) := t(ddindx).attribute2;
  ...
  as
    ddp_crtv_rec okl_crt_pvt.crtv_rec_type;
    ddx_crtv_rec okl_crt_pvt.crtv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_crt_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_crtv_tbl okl_crt_pvt.crtv_tbl_type;
    ddx_crtv_tbl okl_crt_pvt.crtv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_crt_pvt_w.rosetta_table_copy_in_p2(ddp_crtv_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_crt_pvt_w.rosetta_table_copy_out_p2(ddx_crtv_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_crt_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_crt_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_crt_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_crt_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
