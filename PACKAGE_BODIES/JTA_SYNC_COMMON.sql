--------------------------------------------------------
--  DDL for Package Body JTA_SYNC_COMMON
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTA_SYNC_COMMON" AS
/* $Header: jtavscb.pls 120.4 2006/04/12 03:31:10 deeprao ship $ */
/*=======================================================================+
 ...
 +======================================================================*/
   ...
   --   p_task_rec.resultusermessage := p_user_message;
     ...
     p_task_rec.resultsystemmessage := jta_sync_common.sync_failure;
   END;
