--------------------------------------------------------
--  DDL for Package Body BEN_POSTAL_ZIP_RANGE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_POSTAL_ZIP_RANGE_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_POSTAL_ZIP_RANGE_BK1.CREATE_POSTAL_ZIP_RANGE_A', 10);
hr_utility.set_location(' Leaving: BEN_POSTAL_ZIP_RANGE_BK1.CREATE_POSTAL_ZIP_RANGE_A', 20);
end CREATE_POSTAL_ZIP_RANGE_A;
...
begin
hr_utility.set_location('Entering: BEN_POSTAL_ZIP_RANGE_BK1.CREATE_POSTAL_ZIP_RANGE_B', 10);
hr_utility.set_location(' Leaving: BEN_POSTAL_ZIP_RANGE_BK1.CREATE_POSTAL_ZIP_RANGE_B', 20);
end CREATE_POSTAL_ZIP_RANGE_B;
