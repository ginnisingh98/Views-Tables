--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_EXTERNAL_EFFORT_L
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_EXTERNAL_EFFORT_L" as
/*
...
,P_EXT_EFFORT_LINE_USER_KEY in varchar2) is
...
,P_ASSIGNMENT_ID
,P_CURRENCY_CODE
,nd(P_DISTRIBUTION_AMOUNT,I_DISTRIBUTION_AMOUNT)
,P_SET_OF_BOOKS_ID
...
l.pval001 d1,
decode(l.pval002,cn,dn,vn,D(NULL),d(l.pval002)) p2,
l.pval002 d2,
decode(l.pval003,cn,nn,vn,NULL,n(l.pval003)) p3,
l.pval003 d3,
decode(l.pval004,cn,nn,vn,NULL,n(l.pval004)) p4,
l.pval004 d4,
decode(l.pval005,cn,vn,vn,vh,l.pval005) p5,
l.pval005 d5,
decode(l.pval006,cn,nn,vn,nh,n(l.pval006)) p6,
l.pval006 d6,
decode(l.pval007,cn,nn,vn,NULL,n(l.pval007)) p7,
l.pval007 d7,
...
L_EXTERNAL_EFFORT_LINE_ID:=nn;
else
L_EXTERNAL_EFFORT_LINE_ID := 
PSP_EXTERNAL_EFFORT_LINES_PKG.get_external_effort_line_id
(P_EXT_EFFORT_LINE_USER_KEY => c.p32);
end if;
--
hr_data_pump.api_trc_on;
PSP_EXTERNAL_EFFORT_LINES_API.UPDATE_EXTERNAL_EFFORT_LINE
