--------------------------------------------------------
--  DDL for Package Body PQH_PTI_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_PTI_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqh_pti_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_dml(p_rec in pqh_pti_shd.g_rec_type) is
--
...
Begin
  ...
  --
  --
  -- Delete the pqh_ptx_info_types row.
  --
  delete from pqh_ptx_info_types
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pqh_pti_shd.g_rec_type) is
--
...
Procedure del
  ...
  p_rec	      in pqh_pti_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  pqh_pti_bus.delete_validate(p_rec
  ,p_effective_date);
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the pqh_pti_rec
