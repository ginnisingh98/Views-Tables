--------------------------------------------------------
--  DDL for Package Body BEN_ACTUAL_PREMIUM_RATE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ACTUAL_PREMIUM_RATE_BK2" as
/* $Header: beapvapi.pkb 120.0 2005/05/28 00:27:33 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_ACTUAL_PREMIUM_RATE_BK2.UPDATE_ACTUAL_PREMIUM_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_ACTUAL_PREMIUM_RATE_BK2.UPDATE_ACTUAL_PREMIUM_RATE_A', 20);
end UPDATE_ACTUAL_PREMIUM_RATE_A;
...
begin
hr_utility.set_location('Entering: BEN_ACTUAL_PREMIUM_RATE_BK2.UPDATE_ACTUAL_PREMIUM_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_ACTUAL_PREMIUM_RATE_BK2.UPDATE_ACTUAL_PREMIUM_RATE_B', 20);
end UPDATE_ACTUAL_PREMIUM_RATE_B;
