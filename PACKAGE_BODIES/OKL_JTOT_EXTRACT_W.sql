--------------------------------------------------------
--  DDL for Package Body OKL_JTOT_EXTRACT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_JTOT_EXTRACT_W" as
  /* $Header: OKLEJEXB.pls 120.2 2005/12/07 19:54:43 smereddy noship $ */
  ...
  as
    ddx_party_tab okl_jtot_extract.party_tab_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_jtot_extract.get_party(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    okl_jtot_extract_w.rosetta_table_copy_out_p4(ddx_party_tab, p9_a0
      , p9_a1
      , p9_a2
      , p9_a3
      , p9_a4
  ...
  as
    ddx_rle_code_tbl okl_jtot_extract.rle_code_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_jtot_extract.get_subclass_def_roles(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    okl_jtot_extract_w.rosetta_table_copy_out_p6(ddx_rle_code_tbl, p6_a0
      , p6_a1
      );
  end;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_jtot_extract.get_contract_def_roles(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
