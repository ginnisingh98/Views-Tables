--------------------------------------------------------
--  DDL for Package Body FND_OAM_BF_COMP_CUST_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FND_OAM_BF_COMP_CUST_PKG" as
/* $Header: AFOAMFPCB.pls 120.1 2005/07/02 03:03:51 appldev noship $ */
...
is
begin
  FND_OAM_BF_COMP_CUST_pkg.LOAD_ROW(
...
begin
      ...
      if (fnd_load_util.upload_test(f_luby, f_ludate, db_luby,
        ...
        FND_OAM_BF_COMP_CUST_pkg.UPDATE_ROW (
          X_BIZ_FLOW_KEY => X_BIZ_FLOW_KEY,
	  X_COMPONENT_TYPE => X_COMPONENT_TYPE,
      ...
      exception
        ...
        FND_OAM_BF_COMP_CUST_pkg.INSERT_ROW (
          X_ROWID => row_id,
          X_BIZ_FLOW_KEY => X_BIZ_FLOW_KEY,
	  X_COMPONENT_TYPE => X_COMPONENT_TYPE,
   	  X_COMPONENT_APPL_ID => X_COMPONENT_APPL_ID,
...
is
  cursor C is select ROWID from FND_OAM_BF_COMP_CUST
    where BIZ_FLOW_KEY = X_BIZ_FLOW_KEY
    and component_type = x_component_type
    and component_appl_id = x_component_appl_id
    and component_id = x_component_id;
...
is
begin
  delete from FND_OAM_BF_COMP_CUST
  where biz_flow_key = x_biz_flow_key
  and component_type = x_component_type
  and component_appl_id = x_component_appl_id
  and component_id = x_component_id;
...
--	return;
  ...
  FND_OAM_BF_COMP_CUST_pkg.delete_row(
	X_BIZ_FLOW_KEY => X_BIZ_FLOW_KEY,
   	X_COMPONENT_TYPE => X_COMPONENT_TYPE,
	X_COMPONENT_APPL_ID => v_component_appl_id,
	X_COMPONENT_ID => v_component_id);
