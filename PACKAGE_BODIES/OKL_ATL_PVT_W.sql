--------------------------------------------------------
--  DDL for Package Body OKL_ATL_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ATL_PVT_W" as
  /* $Header: OKLIATLB.pls 115.6 2003/03/26 19:47:49 hkpatel noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_atl_pvt.atl_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p2(t okl_atl_pvt.atl_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_atl_pvt.atlv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).avl_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).crd_code := a3(indx);
          t(ddindx).code_combination_id := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).ae_line_type := a5(indx);
          t(ddindx).sequence_number := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).description := a7(indx);
          t(ddindx).percentage := rosetta_g_miss_num_map(a8(indx));
          t(ddindx).account_builder_yn := a9(indx);
          ...
          t(ddindx).avl_tbl_index := rosetta_g_miss_num_map(a26(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_atl_pvt.atlv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    ...
    a32 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).avl_id);
          a3(indx) := t(ddindx).crd_code;
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).code_combination_id);
          a5(indx) := t(ddindx).ae_line_type;
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).sequence_number);
          a7(indx) := t(ddindx).description;
          a8(indx) := rosetta_g_miss_num_map(t(ddindx).percentage);
          a9(indx) := t(ddindx).account_builder_yn;
          ...
          a26(indx) := rosetta_g_miss_num_map(t(ddindx).avl_tbl_index);
  ...
  as
    ddp_atlv_rec okl_atl_pvt.atlv_rec_type;
    ddx_atlv_rec okl_atl_pvt.atlv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_atl_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_atlv_tbl okl_atl_pvt.atlv_tbl_type;
    ddx_atlv_tbl okl_atl_pvt.atlv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_atl_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_atl_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_atl_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_atl_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
