--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_STATE_TAX_RULE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_STATE_TAX_RULE" as
/*
...
,P_EMP_STATE_TAX_RULE_USER_KEY in varchar2) is
...
,nd(P_REMAINDER_PERCENT,I_REMAINDER_PERCENT)
,nd(P_SECONDARY_WA,I_SECONDARY_WA)
,nd(P_SIT_ADDITIONAL_TAX,I_SIT_ADDITIONAL_TAX)
,nd(P_SIT_OVERRIDE_AMOUNT,I_SIT_OVERRIDE_AMOUNT)
,nd(P_SIT_OVERRIDE_RATE,I_SIT_OVERRIDE_RATE)
...
,P_SUI_EXEMPT
,P_WC_EXEMPT
,nd(P_SUI_WAGE_BASE_OVERRIDE_AMOUN,I_SUI_WAGE_BASE_OVERRIDE_AMOUN)
...
decode(l.pval017,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval017,'YES_NO',d(l.pval001),vn)) p17,
l.pval017 d17,
...
L_EMP_STATE_TAX_RULE_ID:=nn;
else
L_EMP_STATE_TAX_RULE_ID := 
hr_pump_get.get_emp_state_tax_rule_id
(P_EMP_STATE_TAX_RULE_USER_KEY => c.p84);
end if;
--
if c.p84 is null or
c.p1 is null then
...
hr_pump_get.GET_STATE_TAX_RULE_OVN
(P_EMP_STATE_TAX_RULE_USER_KEY => c.p84
...
,P_ADDITIONAL_WA_AMOUNT => c.p3
,P_FILING_STATUS_CODE => c.p4
,P_REMAINDER_PERCENT => c.p5
,P_SECONDARY_WA => c.p6
,P_SIT_ADDITIONAL_TAX => c.p7
,P_SIT_OVERRIDE_AMOUNT => c.p8
,P_SIT_OVERRIDE_RATE => c.p9
,P_WITHHOLDING_ALLOWANCES => c.p10
,P_EXCESSIVE_WA_REJECT_DATE => c.p11
,P_SDI_EXEMPT => c.p12
,P_SIT_EXEMPT => c.p13
,P_SIT_OPTIONAL_CALC_IND => c.p14
,P_STATE_NON_RESIDENT_CERT => c.p15
,P_SUI_EXEMPT => c.p16
,P_WC_EXEMPT => c.p17
,P_SUI_WAGE_BASE_OVERRIDE_AMOUN => c.p18
,P_SUPP_TAX_OVERRIDE_RATE => c.p19
...
,P_ATTRIBUTE29 => c.p49
,P_ATTRIBUTE30 => c.p50
,P_STA_INFORMATION_CATEGORY => c.p51
,P_STA_INFORMATION1 => c.p52
,P_STA_INFORMATION2 => c.p53
,P_STA_INFORMATION3 => c.p54
,P_STA_INFORMATION4 => c.p55
,P_STA_INFORMATION5 => c.p56
,P_STA_INFORMATION6 => c.p57
,P_STA_INFORMATION7 => c.p58
,P_STA_INFORMATION8 => c.p59
,P_STA_INFORMATION9 => c.p60
,P_STA_INFORMATION10 => c.p61
,P_STA_INFORMATION11 => c.p62
,P_STA_INFORMATION12 => c.p63
,P_STA_INFORMATION13 => c.p64
,P_STA_INFORMATION14 => c.p65
,P_STA_INFORMATION15 => c.p66
,P_STA_INFORMATION16 => c.p67
,P_STA_INFORMATION17 => c.p68
,P_STA_INFORMATION18 => c.p69
,P_STA_INFORMATION19 => c.p70
,P_STA_INFORMATION20 => c.p71
,P_STA_INFORMATION21 => c.p72
,P_STA_INFORMATION22 => c.p73
,P_STA_INFORMATION23 => c.p74
,P_STA_INFORMATION24 => c.p75
,P_STA_INFORMATION25 => c.p76
,P_STA_INFORMATION26 => c.p77
,P_STA_INFORMATION27 => c.p78
,P_STA_INFORMATION28 => c.p79
,P_STA_INFORMATION29 => c.p80
,P_STA_INFORMATION30 => c.p81
