--------------------------------------------------------
--  DDL for Package Body GR_INGRED_CONC_DETAILS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GR_INGRED_CONC_DETAILS_PKG" AS
/*$Header: GRHINCDB.pls 120.0 2005/07/08 11:23:56 methomas noship $*/
...
/*     Initialization Routine */
   ...
   x_oracle_error := 0;
   x_msg_data := NULL;
   l_msg_token := p_inventory_item_id || ' ' || p_ingredient_item_id;
...
EXCEPTION
   ...
   WHEN Item_Exists_Error THEN
      ROLLBACK TO SAVEPOINT Insert_Row;
	  l_msg_token := p_inventory_item_id;
	  x_return_status := 'E';
...
/*		  p_inventory_item_id is the item id to check.
**	      p_ingredient_item_id is the second part of the key
**		  p_source_item_id is the third part of the key
...
BEGIN
   ...
   l_msg_data := p_inventory_item_id || ' ' || p_ingredient_item_id;
