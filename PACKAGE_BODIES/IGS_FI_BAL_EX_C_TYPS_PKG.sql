--------------------------------------------------------
--  DDL for Package Body IGS_FI_BAL_EX_C_TYPS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_FI_BAL_EX_C_TYPS_PKG" AS
/* $Header: IGSSI98B.pls 115.9 2003/03/19 08:36:16 smadathi ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_fi_bal_ex_c_typs%ROWTYPE;
  new_references igs_fi_bal_ex_c_typs%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.bal_exc_credit_type_id            := x_bal_exc_credit_type_id;
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_fi_bal_ex_c_typs
      WHERE    bal_exc_credit_type_id = x_bal_exc_credit_type_id
      FOR UPDATE NOWAIT;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_FI_EXCT_CRTY_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  ||  smadathi        10-Apr-2002      Bug 2289191. Enabled_flag column reference removed.
  ||  vchappid        25-mar-2002    Added call to procedure check_uniqueness
  */
  BEGIN
    ...
    IF (p_action = 'INSERT') THEN
      ...
      IF ( get_pk_for_validation(
             new_references.bal_exc_credit_type_id
           )
         ) THEN
        fnd_message.set_name('IGS','IGS_GE_RECORD_ALREADY_EXISTS');
        igs_ge_msg_stack.add;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igs_fi_bal_ex_c_typs_s.NEXTVAL
    INTO      x_bal_exc_credit_type_id
    FROM      dual;

    before_dml(
      p_action                            => 'INSERT',
      x_rowid                             => x_rowid,
      x_bal_exc_credit_type_id            => x_bal_exc_credit_type_id,
    ...
    INSERT INTO igs_fi_bal_ex_c_typs (
      bal_exc_credit_type_id,
      balance_rule_id,
      credit_type_id,
      creation_date,
      created_by,
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_fi_bal_ex_c_typs
    WHERE rowid = x_rowid;
