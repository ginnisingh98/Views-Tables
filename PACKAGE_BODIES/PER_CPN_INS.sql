--------------------------------------------------------
--  DDL for Package Body PER_CPN_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CPN_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_cpn_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure insert_dml(p_rec in out nocopy per_cpn_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Insert the row into: per_competences
  -- ngundura added column competence_alias
  insert into per_competences
  (	competence_id,
	name,
	business_group_id,
  ...
  (	p_rec.competence_id,
	...
	p_rec.rating_scale_id,
       ...
       ,p_rec.competence_cluster                -- BUG3356369
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_insert(p_rec  in out nocopy per_cpn_shd.g_rec_type) is
--
  l_proc  varchar2(72) := g_package||'pre_insert';
--
   cursor C_Sel1 is select per_competences_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.competence_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure post_insert(p_rec in per_cpn_shd.g_rec_type) is
--
...
Begin
  ...
  If p_validate then
    ...
    -- Issue the savepoint.
    --
    SAVEPOINT ins_per_cpn;
  End If;
  --
  -- Call the supporting insert validate operations
  --
  per_cpn_bus.insert_validate(p_rec,p_effective_date);
  --
...
Exception
  When HR_Api.Validate_Enabled Then
    ...
    --
    ROLLBACK TO ins_per_cpn;
end ins;
--
-- ----------------------------------------------------------------------------
-- |---------------------------------< ins >----------------------------------|
-- ----------------------------------------------------------------------------
-- ngundura added competence_alias as a parameter to ins
Procedure ins
  (
...
Begin
  ...
  -- p_rec structure.
  -- ngundura added competence_alias as a parameter to convert args
  l_rec :=
 ...
 ,p_information20
  ...
  --
  p_competence_id := l_rec.competence_id;
