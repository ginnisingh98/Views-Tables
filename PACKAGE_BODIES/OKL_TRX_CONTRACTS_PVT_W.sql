--------------------------------------------------------
--  DDL for Package Body OKL_TRX_CONTRACTS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TRX_CONTRACTS_PVT_W" as
  /* $Header: OKLOTCNB.pls 120.9.12010000.6 2008/11/12 23:55:10 apaul ship $ */
  ...
  as
    ddp_tcnv_rec okl_trx_contracts_pvt.tcnv_rec_type;
    ddp_tclv_tbl okl_trx_contracts_pvt.tclv_tbl_type;
    ddx_tcnv_rec okl_trx_contracts_pvt.tcnv_rec_type;
    ddx_tclv_tbl okl_trx_contracts_pvt.tclv_tbl_type;
  ...
  begin
    ...
    okl_trx_contracts_pvt.create_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pvt.update_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pvt.validate_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tcnv_tbl okl_trx_contracts_pvt.tcnv_tbl_type;
    ddx_tcnv_tbl okl_trx_contracts_pvt.tcnv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pvt.lock_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pvt.delete_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pvt.create_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tclv_rec okl_trx_contracts_pvt.tclv_rec_type;
    ddx_tclv_rec okl_trx_contracts_pvt.tclv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pvt.lock_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pvt.update_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pvt.delete_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_contracts_pvt.validate_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
