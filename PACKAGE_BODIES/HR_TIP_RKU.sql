--------------------------------------------------------
--  DDL for Package Body HR_TIP_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_TIP_RKU" as
...
begin
hr_utility.set_location('Entering: hr_tip_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: hr_tip_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end hr_tip_RKU;
