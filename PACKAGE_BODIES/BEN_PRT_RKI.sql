--------------------------------------------------------
--  DDL for Package Body BEN_PRT_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PRT_RKI" as
...
begin
hr_utility.set_location('Entering: ben_prt_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_prt_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_prt_RKI;
