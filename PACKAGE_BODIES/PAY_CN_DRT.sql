--------------------------------------------------------
--  DDL for Package Body PAY_CN_DRT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_CN_DRT" AS
/* $Header: pycndrt.pkb 120.0.12010000.3 2018/03/23 10:35:23 dduvvuri noship $ */
/* ************************************************************************
 +======================================================================+
...
************************************************************************ */
    ...
    g_package   VARCHAR2(100) := 'pay_cn_drt.';
    ...
    BEGIN
      ...
      IF p_table_name = 'PAY_ELEMENT_ENTRY_VALUES_F' THEN
        ...
        BEGIN
          ...
          AND     piv.name in ( 'Account Number' )
