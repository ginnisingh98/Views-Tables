--------------------------------------------------------
--  DDL for Package Body OKL_SETUP_ACCRUALS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUP_ACCRUALS_PVT_W" as
  /* $Header: OKLEARUB.pls 120.2 2006/08/09 11:17:22 abhsaxen noship $ */
  ...
  as
    ddp_agnv_rec okl_setup_accruals_pvt.agnv_rec_type;
    ddx_agnv_rec okl_setup_accruals_pvt.agnv_rec_type;
  ...
  begin
    ...
    okl_setup_accruals_pvt.create_accrual_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_agnv_tbl okl_setup_accruals_pvt.agnv_tbl_type;
    ddx_agnv_tbl okl_setup_accruals_pvt.agnv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setup_accruals_pvt.update_accrual_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setup_accruals_pvt.delete_accrual_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
