--------------------------------------------------------
--  DDL for Package Body AME_ACL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ACL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_acl_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  l_current_user_id    := fnd_global.user_id;--ame_util.getLoggedInUserId;
  ...
  --
  --
  -- Insert the row into: ame_actions_tl
  --
...
Begin
  ...
  -- Insert the row
  --
  ame_acl_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ame_acl_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
...
Begin
  ...
  --
  -- Having converted the arguments into the ame_acl_rec
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where acl.action_id = p_action_id
                          and acl.language = l.language_code);
  --
