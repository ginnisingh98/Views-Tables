--------------------------------------------------------
--  DDL for Package Body HR_POSITION_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_POSITION_BK1" as
...
begin
hr_utility.set_location('Entering: HR_POSITION_BK1.CREATE_POSITION_A', 10);
hr_utility.set_location(' Leaving: HR_POSITION_BK1.CREATE_POSITION_A', 20);
end CREATE_POSITION_A;
...
GHR_UTILITY.validate_create_nfc
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_POSITION', 'BP');
hr_utility.set_location(' Leaving: HR_POSITION_BK1.CREATE_POSITION_B', 20);
end CREATE_POSITION_B;
end HR_POSITION_BK1;
