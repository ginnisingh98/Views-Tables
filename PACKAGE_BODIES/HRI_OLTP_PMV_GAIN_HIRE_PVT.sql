--------------------------------------------------------
--  DDL for Package Body HRI_OLTP_PMV_GAIN_HIRE_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRI_OLTP_PMV_GAIN_HIRE_PVT" AS
/* $Header: hriopghp.pkb 120.0 2005/05/29 07:32:37 appldev noship $ */
--
-- New-arch detail query
--
