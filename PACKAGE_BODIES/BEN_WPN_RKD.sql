--------------------------------------------------------
--  DDL for Package Body BEN_WPN_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_WPN_RKD" as
/* $Header: bewpnrhi.pkb 120.0.12010000.2 2008/08/05 15:47:09 generated ship $ */
...
begin
hr_utility.set_location('Entering: ben_wpn_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_wpn_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_wpn_RKD;
