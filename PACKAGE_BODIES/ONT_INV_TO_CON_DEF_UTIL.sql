--------------------------------------------------------
--  DDL for Package Body ONT_INV_TO_CON_DEF_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_INV_TO_CON_DEF_UTIL" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_INV_TO_CON_Def_Util
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_INV_TO_CON_Def_Util';
 
 
  g_database_object_name varchar2(30) :='OE_AK_INV_TO_CONTACT_V';
...
END  Get_Attr_Val_Date;
  ...
  PROCEDURE Clear_INV_TO_CON_Cache
  IS  
  BEGIN  
  g_cached_record.CONTACT_ID := null;
   END Clear_INV_TO_CON_Cache;
...
IS
CURSOR cache IS 
  SELECT * FROM   OE_AK_INV_TO_CONTACT_V
