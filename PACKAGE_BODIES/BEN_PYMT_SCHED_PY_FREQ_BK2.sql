--------------------------------------------------------
--  DDL for Package Body BEN_PYMT_SCHED_PY_FREQ_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PYMT_SCHED_PY_FREQ_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_PYMT_SCHED_PY_FREQ_BK2.UPDATE_PYMT_SCHED_PY_FREQ_A', 10);
hr_utility.set_location(' Leaving: BEN_PYMT_SCHED_PY_FREQ_BK2.UPDATE_PYMT_SCHED_PY_FREQ_A', 20);
end UPDATE_PYMT_SCHED_PY_FREQ_A;
...
begin
hr_utility.set_location('Entering: BEN_PYMT_SCHED_PY_FREQ_BK2.UPDATE_PYMT_SCHED_PY_FREQ_B', 10);
hr_utility.set_location(' Leaving: BEN_PYMT_SCHED_PY_FREQ_BK2.UPDATE_PYMT_SCHED_PY_FREQ_B', 20);
end UPDATE_PYMT_SCHED_PY_FREQ_B;
