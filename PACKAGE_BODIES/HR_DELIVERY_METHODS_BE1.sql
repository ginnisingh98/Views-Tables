--------------------------------------------------------
--  DDL for Package Body HR_DELIVERY_METHODS_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DELIVERY_METHODS_BE1" as 
...
p_attribute20                  varchar2) is
  ...
  --
  l_proc varchar2(72):='  hr_delivery_methods_be1.create_delivery_method_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.delivery_methods.create_delivery_method';
