--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_US_PERSON
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_US_PERSON" as
/*
 * Generated by hr_pump_meta_mapper at: 2018/06/16 10:06:14
 * Generated for API: HR_PERSON_API.UPDATE_US_PERSON
 */
--
...
decode(l.pval053,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval053,'US_ETHNIC_GROUP',d(l.pval001),l.pval116)) p53,
l.pval053 d53,
decode(l.pval054,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval054,'PER_US_I9_STATE',d(l.pval001),l.pval116)) p54,
l.pval054 d54,
decode(l.pval055,cn,vn,vn,vh,l.pval055) p55,
l.pval055 d55,
decode(l.pval056,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval056,'US_VETERAN_STATUS',d(l.pval001),l.pval116)) p56,
l.pval056 d56,
decode(l.pval057,cn,vn,l.pval057) p57,
decode(l.pval058,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval058,'US_NEW_HIRE_STATUS',d(l.pval001),l.pval116)) p58,
l.pval058 d58,
decode(l.pval059,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval059,'US_NEW_HIRE_EXCEPTIONS',d(l.pval001),l.pval116)) p59,
l.pval059 d59,
...
,P_I_9 => c.p54
,P_I_9_EXPIRATION_DATE => c.p55
,P_VETERAN_STATUS => c.p56
,P_VETS100A => c.p57
,P_NEW_HIRE => c.p58
,P_EXCEPTION_REASON => c.p59
,P_CHILD_SUPPORT_OBLIGATION => c.p60
,P_OPTED_FOR_MEDICARE_FLAG => c.p61
