--------------------------------------------------------
--  DDL for Package Body OE_2PC2_SHIPSET_RLMLIN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC2_SHIPSET_RLMLIN" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 IS 
   ...
   WHERE a.SOURCE_DOCUMENT_TYPE_ID = 5
   AND   (  a.LINE_ID ) IN  
                 ( SELECT  b.LINE_ID
