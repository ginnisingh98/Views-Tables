--------------------------------------------------------
--  DDL for Package Body HR_AE_ASSIGNMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_AE_ASSIGNMENT_API" AS
/* $Header: peasgaei.pkb 120.1.12000000.1 2007/01/21 20:19:31 appldev ship $ */
/*
 +==========================================================================================
 |              Copyright (c) 1999 Oracle Corporation Ltd
 |                           All rights reserved.
 +==========================================================================================
 |SQL Script File Name : peasgaei.pkb
 |                Name : hr_ae_assignment_api
 |         Description : Assignment API Wrapper for UAE
 |
 |   Name           Date         Version Bug     Text
 |   -------------- ----------   ------- -----   ----
 |   Abhijeet       27-May-2005  115.0           Initial Version
 |   Anand M D      03-Feb-2006  115.1           Added parameters Accommodation Provided and
 |                                               Transportation Provided
 |NOTES
 +==========================================================================================
*/

g_package  VARCHAR2(33) := 'hr_ae_assignment_api.';
--
-- ----------------------------------------------------------------------------
...
PROCEDURE create_ae_secondary_emp_asg
  ...
  l_proc               VARCHAR2(72) := g_package||'create_ae_secondary_emp_asg';
  --
  -- Declare cursors
  --
...
BEGIN
  ...
  --
  -- Ensure that the employee IS within an AE business group
  --
 ...
 hr_assignment_api.create_secondary_emp_asg
  ...
  ,p_scl_segment2                 =>     p_civil_reg_number
  ,p_scl_segment3                 =>     p_social_sec_number
  ,p_scl_segment4                 =>     p_contribution_start_date
  ,p_scl_segment5                 =>     p_latest_qualification
  ,p_scl_segment7                 =>     p_accommodation_provided
  ,p_scl_segment8                 =>     p_transportation_provided
  ...
  --
  END create_ae_secondary_emp_asg;
...
PROCEDURE update_ae_emp_asg
 ...
 --
    -- Declare cursors AND local variables
    --
    l_proc                       VARCHAR2(72) := g_package||'update_ae_emp_asg';
    l_effective_date             DATE;
    l_legislation_code           per_business_groups.legislation_code%TYPE;
    l_business_group_id          per_business_groups.business_group_id%type;
    a              varchar2(100);
  ...
  BEGIN
    ...
    --
      ...
      ,p_segment2                 => p_civil_reg_number
      ,p_segment3                 => p_social_sec_number
      ,p_segment4                 => p_contribution_start_date
      ,p_segment5                 => p_latest_qualification
      ,p_segment7                 => p_accommodation_provided
      ,p_segment8                 => p_transportation_provided
      ,p_soft_coding_keyflex_id       => p_soft_coding_keyflex_id
      ,p_comment_id                   => p_comment_id
      ,p_effective_start_date         => p_effective_start_date
      ,p_effective_END_date           => p_effective_end_date
