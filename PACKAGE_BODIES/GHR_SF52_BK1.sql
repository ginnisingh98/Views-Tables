--------------------------------------------------------
--  DDL for Package Body GHR_SF52_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_SF52_BK1" as
...
,P_CAPPED_OTHER_PAY in NUMBER
,P_PAR_OBJECT_VERSION_NUMBER in NUMBER
,P_1_PA_ROUTING_HISTORY_ID in NUMBER
,P_1_PRH_OBJECT_VERSION_NUMBER in NUMBER
,P_2_PA_ROUTING_HISTORY_ID in NUMBER
,P_2_PRH_OBJECT_VERSION_NUMBER in NUMBER
...
begin
hr_utility.set_location('Entering: GHR_SF52_BK1.CREATE_SF52_A', 10);
hr_utility.set_location(' Leaving: GHR_SF52_BK1.CREATE_SF52_A', 20);
end CREATE_SF52_A;
procedure CREATE_SF52_B
(P_NOA_FAMILY_CODE in VARCHAR2
,P_PA_REQUEST_ID in NUMBER
,P_ROUTING_GROUP_ID in NUMBER
,P_PROPOSED_EFFECTIVE_ASAP_FLAG in VARCHAR2
...
begin
hr_utility.set_location('Entering: GHR_SF52_BK1.CREATE_SF52_B', 10);
hr_utility.set_location(' Leaving: GHR_SF52_BK1.CREATE_SF52_B', 20);
end CREATE_SF52_B;
end GHR_SF52_BK1;
