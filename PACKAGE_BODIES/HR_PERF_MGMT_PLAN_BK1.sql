--------------------------------------------------------
--  DDL for Package Body HR_PERF_MGMT_PLAN_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PERF_MGMT_PLAN_BK1" as
...
begin
hr_utility.set_location('Entering: HR_PERF_MGMT_PLAN_BK1.CREATE_PERF_MGMT_PLAN_A', 10);
hr_utility.set_location(' Leaving: HR_PERF_MGMT_PLAN_BK1.CREATE_PERF_MGMT_PLAN_A', 20);
end CREATE_PERF_MGMT_PLAN_A;
...
begin
hr_utility.set_location('Entering: HR_PERF_MGMT_PLAN_BK1.CREATE_PERF_MGMT_PLAN_B', 10);
hr_utility.set_location(' Leaving: HR_PERF_MGMT_PLAN_BK1.CREATE_PERF_MGMT_PLAN_B', 20);
end CREATE_PERF_MGMT_PLAN_B;
