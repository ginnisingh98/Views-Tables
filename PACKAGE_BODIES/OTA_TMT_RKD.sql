--------------------------------------------------------
--  DDL for Package Body OTA_TMT_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TMT_RKD" as
...
begin
hr_utility.set_location('Entering: OTA_TMT_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: OTA_TMT_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end OTA_TMT_RKD;
