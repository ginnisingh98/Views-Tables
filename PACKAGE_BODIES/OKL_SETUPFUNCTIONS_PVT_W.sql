--------------------------------------------------------
--  DDL for Package Body OKL_SETUPFUNCTIONS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPFUNCTIONS_PVT_W" as
  /* $Header: OKLESDFB.pls 120.1 2005/07/12 09:09:04 dkagrawa noship $ */
  ...
  as
    ddp_dsfv_rec okl_setupfunctions_pvt.dsfv_rec_type;
    ddx_no_data_found boolean;
    ddx_dsfv_rec okl_setupfunctions_pvt.dsfv_rec_type;
  ...
  begin
    ...
    okl_setupfunctions_pvt.get_rec(ddp_dsfv_rec,
      x_return_status,
      ddx_no_data_found,
      ddx_dsfv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p3_a0 := rosetta_g_miss_num_map(ddx_dsfv_rec.id);
    p3_a1 := rosetta_g_miss_num_map(ddx_dsfv_rec.object_version_number);
    p3_a2 := ddx_dsfv_rec.sfwt_flag;
    p3_a3 := ddx_dsfv_rec.fnctn_code;
    p3_a4 := ddx_dsfv_rec.name;
    p3_a5 := ddx_dsfv_rec.description;
    p3_a6 := ddx_dsfv_rec.version;
    p3_a7 := ddx_dsfv_rec.start_date;
    p3_a8 := ddx_dsfv_rec.end_date;
    p3_a9 := ddx_dsfv_rec.source;
    p3_a10 := ddx_dsfv_rec.attribute_category;
    p3_a11 := ddx_dsfv_rec.attribute1;
    p3_a12 := ddx_dsfv_rec.attribute2;
    p3_a13 := ddx_dsfv_rec.attribute3;
    p3_a14 := ddx_dsfv_rec.attribute4;
    p3_a15 := ddx_dsfv_rec.attribute5;
    p3_a16 := ddx_dsfv_rec.attribute6;
    p3_a17 := ddx_dsfv_rec.attribute7;
    p3_a18 := ddx_dsfv_rec.attribute8;
    p3_a19 := ddx_dsfv_rec.attribute9;
    p3_a20 := ddx_dsfv_rec.attribute10;
    p3_a21 := ddx_dsfv_rec.attribute11;
    p3_a22 := ddx_dsfv_rec.attribute12;
    p3_a23 := ddx_dsfv_rec.attribute13;
    p3_a24 := ddx_dsfv_rec.attribute14;
    p3_a25 := ddx_dsfv_rec.attribute15;
    p3_a26 := rosetta_g_miss_num_map(ddx_dsfv_rec.org_id);
    p3_a27 := rosetta_g_miss_num_map(ddx_dsfv_rec.created_by);
    p3_a28 := ddx_dsfv_rec.creation_date;
    p3_a29 := rosetta_g_miss_num_map(ddx_dsfv_rec.last_updated_by);
    p3_a30 := ddx_dsfv_rec.last_update_date;
    p3_a31 := rosetta_g_miss_num_map(ddx_dsfv_rec.last_update_login);
  end;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupfunctions_pvt.insert_functions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupfunctions_pvt.update_functions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
