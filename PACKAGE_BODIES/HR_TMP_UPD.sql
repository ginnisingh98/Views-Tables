--------------------------------------------------------
--  DDL for Package Body HR_TMP_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_TMP_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_tmp_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the hr_form_templates_b Row
  --
  update hr_form_templates_b
    set
...
Begin
  ...
  --
  hr_tmp_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hr_tmp_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hr_tmp_upd.post_update
     (p_effective_date
     ,p_rec
     );
End upd;
