--------------------------------------------------------
--  DDL for Package Body BEN_DPC_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DPC_RKI" as
/* $Header: bedpcrhi.pkb 120.1 2006/03/31 01:02:57 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_dpc_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_dpc_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_dpc_RKI;
