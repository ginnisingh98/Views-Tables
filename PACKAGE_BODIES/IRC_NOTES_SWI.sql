--------------------------------------------------------
--  DDL for Package Body IRC_NOTES_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_NOTES_SWI" As
/* $Header: irinoswi.pkb 120.0 2005/09/27 09:09 sayyampe noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'irc_notes_swi.';
--
-- ----------------------------------------------------------------------------
-- |------------------------------< create_note >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  irc_ino_ins.set_base_key_value
    (p_note_id => p_note_id
    );
  --
  -- Call API
