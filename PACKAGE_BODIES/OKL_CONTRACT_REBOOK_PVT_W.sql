--------------------------------------------------------
--  DDL for Package Body OKL_CONTRACT_REBOOK_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CONTRACT_REBOOK_PVT_W" as
  /* $Header: OKLERBKB.pls 120.2 2005/12/06 23:42:46 rpillay noship $ */
  ...
  as
    ddp_trx_date date;
    ddx_tcnv_rec okl_contract_rebook_pvt.tcnv_rec_type;
  ...
  begin
    ...
    okl_contract_rebook_pvt.create_txn_contract(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
