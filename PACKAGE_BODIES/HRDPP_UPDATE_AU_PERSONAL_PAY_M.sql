--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_AU_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_AU_PERSONAL_PAY_M" as
/*
...
decode(l.pval031,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval031,'PAYEE_TYPE',d(l.pval001),l.pval039)) p31,
l.pval031 d31,
l.pval032 p32,
l.pval033 p33,
decode(l.pval034,cn,dn,d(l.pval034)) p34,
...
(P_PERSONAL_PAY_METHOD_USER_KEY => c.p36);
end if;
--
if c.p36 is null or
c.p1 is null then
...
,P_PAYEE_ORG => c.p37
,P_PAYEE_PERSON_USER_KEY => c.p38
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p39);
--
hr_data_pump.api_trc_on;
HR_AU_PERSONAL_PAY_METHOD_API.UPDATE_AU_PERSONAL_PAY_METHOD
(p_validate => l_validate
,P_EFFECTIVE_DATE => c.p1
,P_DATETRACK_UPDATE_MODE => c.p2
,P_PERSONAL_PAYMENT_METHOD_ID => L_PERSONAL_PAYMENT_METHOD_ID
,P_OBJECT_VERSION_NUMBER => L_OBJECT_VERSION_NUMBER
,P_BANK_BSB_CODE => c.p3
,P_BANK_ACCOUNT_NUMBER => c.p4
,P_BANK_ACCOUNT_NAME => c.p5
,P_AMOUNT => c.p6
,P_COMMENTS => c.p7
,P_PERCENTAGE => c.p8
,P_PRIORITY => c.p9
...
,P_COMMENT_ID => c.p32
,P_EXTERNAL_ACCOUNT_ID => c.p33
,P_EFFECTIVE_START_DATE => c.p34
,P_EFFECTIVE_END_DATE => c.p35);
...
l.pval034 = decode(c.p34,null,cn,dc(c.p34)),
l.pval035 = decode(c.p35,null,cn,dc(c.p35))
