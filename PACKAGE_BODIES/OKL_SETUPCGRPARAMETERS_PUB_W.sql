--------------------------------------------------------
--  DDL for Package Body OKL_SETUPCGRPARAMETERS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPCGRPARAMETERS_PUB_W" as
  /* $Header: OKLUSCMB.pls 120.1 2005/07/18 16:13:22 viselvar noship $ */
  ...
  as
    ddp_cgmv_rec okl_setupcgrparameters_pub.cgmv_rec_type;
    ddx_no_data_found boolean;
    ddx_cgmv_rec okl_setupcgrparameters_pub.cgmv_rec_type;
  ...
  begin
    ...
    okl_setupcgrparameters_pub.get_rec(ddp_cgmv_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_cgmv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_cgmv_rec.id);
    p4_a1 := rosetta_g_miss_num_map(ddx_cgmv_rec.object_version_number);
    p4_a2 := rosetta_g_miss_num_map(ddx_cgmv_rec.cgr_id);
    p4_a3 := rosetta_g_miss_num_map(ddx_cgmv_rec.pmr_id);
    p4_a4 := rosetta_g_miss_num_map(ddx_cgmv_rec.created_by);
    p4_a5 := ddx_cgmv_rec.creation_date;
    p4_a6 := rosetta_g_miss_num_map(ddx_cgmv_rec.last_updated_by);
    p4_a7 := ddx_cgmv_rec.last_update_date;
    p4_a8 := rosetta_g_miss_num_map(ddx_cgmv_rec.last_update_login);
  end;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupcgrparameters_pub.insert_cgrparameters(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupcgrparameters_pub.update_cgrparameters(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_cgmv_tbl okl_setupcgrparameters_pub.cgmv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupcgrparameters_pub.delete_cgrparameters(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_cgmv_tbl okl_setupcgrparameters_pub.cgmv_tbl_type;
    ddx_cgmv_tbl okl_setupcgrparameters_pub.cgmv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
...
end okl_setupcgrparameters_pub_w;
