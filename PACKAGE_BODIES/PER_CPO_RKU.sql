--------------------------------------------------------
--  DDL for Package Body PER_CPO_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CPO_RKU" as
/* $Header: pecporhi.pkb 115.0 2004/03/17 10:23 generated noship $ */
...
begin
hr_utility.set_location('Entering: PER_CPO_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PER_CPO_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PER_CPO_RKU;
