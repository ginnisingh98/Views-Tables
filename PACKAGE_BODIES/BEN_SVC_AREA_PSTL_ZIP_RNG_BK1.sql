--------------------------------------------------------
--  DDL for Package Body BEN_SVC_AREA_PSTL_ZIP_RNG_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_SVC_AREA_PSTL_ZIP_RNG_BK1" as
...
procedure CREATE_SVC_AREA_PSTL_ZIP_RNG_A
...
begin
hr_utility.set_location('Entering: BEN_SVC_AREA_PSTL_ZIP_RNG_BK1.CREATE_SVC_AREA_PSTL_ZIP_RNG_A', 10);
hr_utility.set_location(' Leaving: BEN_SVC_AREA_PSTL_ZIP_RNG_BK1.CREATE_SVC_AREA_PSTL_ZIP_RNG_A', 20);
end CREATE_SVC_AREA_PSTL_ZIP_RNG_A;
procedure CREATE_SVC_AREA_PSTL_ZIP_RNG_B
(P_SVC_AREA_ID in NUMBER
,P_PSTL_ZIP_RNG_ID in NUMBER
,P_BUSINESS_GROUP_ID in NUMBER
,P_SAZ_ATTRIBUTE_CATEGORY in VARCHAR2
...
begin
hr_utility.set_location('Entering: BEN_SVC_AREA_PSTL_ZIP_RNG_BK1.CREATE_SVC_AREA_PSTL_ZIP_RNG_B', 10);
hr_utility.set_location(' Leaving: BEN_SVC_AREA_PSTL_ZIP_RNG_BK1.CREATE_SVC_AREA_PSTL_ZIP_RNG_B', 20);
end CREATE_SVC_AREA_PSTL_ZIP_RNG_B;
end BEN_SVC_AREA_PSTL_ZIP_RNG_BK1;
