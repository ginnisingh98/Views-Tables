--------------------------------------------------------
--  DDL for Package Body BEN_CGP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CGP_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_cgp_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  If (p_effective_date is null or
      p_cntng_prtn_elig_prfl_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_cntng_prtn_elig_prfl_id = g_old_rec.cntng_prtn_elig_prfl_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_child_table_name1       => 'ben_cntnu_prtn_ctfn_typ_f',
	 p_child_key_column1       => 'cntnu_prtn_ctfn_typ_id',
...
Begin
  ...
  l_rec.cgp_attribute_category           := p_cgp_attribute_category;
  l_rec.cgp_attribute1                   := p_cgp_attribute1;
  l_rec.cgp_attribute2                   := p_cgp_attribute2;
  l_rec.cgp_attribute3                   := p_cgp_attribute3;
  l_rec.cgp_attribute4                   := p_cgp_attribute4;
  l_rec.cgp_attribute5                   := p_cgp_attribute5;
  l_rec.cgp_attribute6                   := p_cgp_attribute6;
  l_rec.cgp_attribute7                   := p_cgp_attribute7;
  l_rec.cgp_attribute8                   := p_cgp_attribute8;
  l_rec.cgp_attribute9                   := p_cgp_attribute9;
  l_rec.cgp_attribute10                  := p_cgp_attribute10;
  l_rec.cgp_attribute11                  := p_cgp_attribute11;
  l_rec.cgp_attribute12                  := p_cgp_attribute12;
  l_rec.cgp_attribute13                  := p_cgp_attribute13;
  l_rec.cgp_attribute14                  := p_cgp_attribute14;
  l_rec.cgp_attribute15                  := p_cgp_attribute15;
  l_rec.cgp_attribute16                  := p_cgp_attribute16;
  l_rec.cgp_attribute17                  := p_cgp_attribute17;
  l_rec.cgp_attribute18                  := p_cgp_attribute18;
  l_rec.cgp_attribute19                  := p_cgp_attribute19;
  l_rec.cgp_attribute20                  := p_cgp_attribute20;
  l_rec.cgp_attribute21                  := p_cgp_attribute21;
  l_rec.cgp_attribute22                  := p_cgp_attribute22;
  l_rec.cgp_attribute23                  := p_cgp_attribute23;
  l_rec.cgp_attribute24                  := p_cgp_attribute24;
  l_rec.cgp_attribute25                  := p_cgp_attribute25;
  l_rec.cgp_attribute26                  := p_cgp_attribute26;
  l_rec.cgp_attribute27                  := p_cgp_attribute27;
  l_rec.cgp_attribute28                  := p_cgp_attribute28;
  l_rec.cgp_attribute29                  := p_cgp_attribute29;
  l_rec.cgp_attribute30                  := p_cgp_attribute30;
