--------------------------------------------------------
--  DDL for Package Body JTF_TASK_RECURRENCES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_TASK_RECURRENCES_PUB_W" as
  /* $Header: jtfbtkcb.pls 120.2 2006/04/26 04:24 knayyar ship $ */
  ...
  procedure update_task_recurrence(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , p_commit  VARCHAR2
    , p_task_id  NUMBER
    , p_recurrence_rule_id  NUMBER
    , p_occurs_which  INTEGER
    , p_day_of_week  INTEGER
    , p_date_of_month  INTEGER
    , p_occurs_month  INTEGER
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    jtf_task_recurrences_pub.update_task_recurrence(p_api_version,
      p_init_msg_list,
      p_commit,
      p_task_id,
...
end jtf_task_recurrences_pub_w;
