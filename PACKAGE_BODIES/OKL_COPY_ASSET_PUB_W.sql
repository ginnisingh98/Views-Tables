--------------------------------------------------------
--  DDL for Package Body OKL_COPY_ASSET_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_COPY_ASSET_PUB_W" as
  /* $Header: OKLUCALB.pls 115.7 2003/10/16 09:59:58 avsingh noship $ */
  ...
  as
    ddp_from_cle_id_tbl okl_copy_asset_pub.klev_tbl_type;
    ddx_cle_id_tbl okl_copy_asset_pub.klev_tbl_type;
  ...
  begin
    ...
    okl_copy_asset_pub.copy_asset_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_copy_asset_pub.copy_all_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
