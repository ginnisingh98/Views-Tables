--------------------------------------------------------
--  DDL for Package Body BEN_XWC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XWC_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xwc_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_EXT_WHERE_CLAUSE_FK1') Then
  ...
  ElsIf (p_constraint_name = 'BEN_EXT_WHERE_CLAUSE_FK6') Then
    ...
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_EXT_WHERE_CLAUSE_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  --
  If (
	p_ext_where_clause_id is null and
  ...
  Else
    If (
	p_ext_where_clause_id = g_old_rec.ext_where_clause_id and
...
Begin
  ...
  l_rec.val                              := p_val;
  l_rec.and_or_cd                        := p_and_or_cd;
  l_rec.ext_data_elmt_id                 := p_ext_data_elmt_id;
  l_rec.cond_ext_data_elmt_id            := p_cond_ext_data_elmt_id;
  ...
  l_rec.cond_ext_data_elmt_in_rcd_id     := p_cond_ext_data_elmt_in_rcd_id;
  --
