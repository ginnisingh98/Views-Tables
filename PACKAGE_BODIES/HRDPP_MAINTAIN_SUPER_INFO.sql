--------------------------------------------------------
--  DDL for Package Body HRDPP_MAINTAIN_SUPER_INFO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_MAINTAIN_SUPER_INFO" as
/*
 * Generated by hr_pump_meta_mapper at: 2013/08/29 22:08:51
 * Generated for API: HR_AU_TAX_API.MAINTAIN_SUPER_INFO
 */
--
...
l.pval025 d25,
decode(l.pval026,cn,vn,vn,'NO',
 hr_pump_get.gl(l.pval026,'YES_NO',dn,vn)) p26,
l.pval026 d26,
l.pval027 p27,
...
(P_ASSIGNMENT_USER_KEY => c.p28);
end if;
--
hr_data_pump.api_trc_on;
HR_AU_TAX_API.MAINTAIN_SUPER_INFO
