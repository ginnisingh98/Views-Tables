--------------------------------------------------------
--  DDL for Package Body BEN_XWC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XWC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xwc_ins.';  -- Global package name
...
Begin
  ...
  --
  -- Insert the row into: ben_ext_where_clause
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ext_where_clause_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
--
  ...
  --
  create_app_ownerships('EXT_WHERE_CLAUSE_ID', p_rec.ext_where_clause_id);
  --
...
Begin
  ...
  --
  p_ext_where_clause_id := l_rec.ext_where_clause_id;
