--------------------------------------------------------
--  DDL for Package Body IGI_IGIIABLD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGI_IGIIABLD_XMLP_PKG" AS
/* $Header: IGIIABLDB.pls 120.0.12010000.1 2008/07/29 08:58:19 appldev ship $ */
...
procedure FDRCSID(idstring in varchar2) is
  BEGIN
    IF (idstring is NULL) THEN
      NULL;
    END IF;
        --        FDRCSID('$Header: IGIIABLDB.pls 120.0.12010000.1 2008/07/29 08:58:19 appldev ship $');
  END;
...
PRAGMA AUTONOMOUS_TRANSACTION;
  ...
  BEGIN
    ...
    EXCEPTION
      WHEN OTHERS THEN
        RP_REPORT_NAME := 'Inflation Accounting : Backlog Detail Report' || '(' || CURRENCY_CODE || ')';
