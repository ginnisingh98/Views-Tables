--------------------------------------------------------
--  DDL for Package Body OTA_OFFERING_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_OFFERING_BK1" as
...
begin
hr_utility.set_location('Entering: OTA_OFFERING_BK1.CREATE_OFFERING_A', 10);
hr_utility.set_location(' Leaving: OTA_OFFERING_BK1.CREATE_OFFERING_A', 20);
end CREATE_OFFERING_A;
...
begin
hr_utility.set_location('Entering: OTA_OFFERING_BK1.CREATE_OFFERING_B', 10);
hr_utility.set_location(' Leaving: OTA_OFFERING_BK1.CREATE_OFFERING_B', 20);
end CREATE_OFFERING_B;
