--------------------------------------------------------
--  DDL for Package Body HR_FR_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_FR_PERSON_API" as
/* $Header: peperfri.pkb 115.3 2002/11/27 10:26:50 sfmorris noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := 'hr_fr_person_api.';
--
-- ----------------------------------------------------------------------------
-- |--------------------------< update_fr_person >----------------------------|
-- ----------------------------------------------------------------------------
...
procedure update_fr_person
  ...
  l_proc                 varchar2(72) := g_package||'update_fr_person';
