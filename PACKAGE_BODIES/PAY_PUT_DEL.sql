--------------------------------------------------------
--  DDL for Package Body PAY_PUT_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PUT_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_put_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Delete the pay_user_tables row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pay_put_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in pay_put_shd.g_rec_type) is
--
...
Begin
  ...
  --
  pay_put_bus.delete_validate(p_rec);
  --
  ...
  --
  pay_put_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  pay_put_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  pay_put_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
