--------------------------------------------------------
--  DDL for Package Body WMS_RULE_5
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WMS_RULE_5" AS
...
,base.grade_code 
,mln.LOT_NUMBER consist_string
,mln.EXPIRATION_DATE||base.DATE_RECEIVED order_by_string
...
,base.SERIAL_NUMBER asc,mln.EXPIRATION_DATE asc
,base.DATE_RECEIVED asc
,mln.LOT_NUMBER
;
...
,base.UOM_CODE
,base.GRADE_CODE
,mln.EXPIRATION_DATE,base.DATE_RECEIVED,mln.LOT_NUMBER
,mln.LOT_NUMBER
,base.SERIAL_NUMBER,base.CONVERSION_RATE
,mln.EXPIRATION_DATE||base.DATE_RECEIVED
 order by base.CONVERSION_RATE desc
,base.SERIAL_NUMBER asc,mln.EXPIRATION_DATE asc
,base.DATE_RECEIVED asc
,mln.LOT_NUMBER
