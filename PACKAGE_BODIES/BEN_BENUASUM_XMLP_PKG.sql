--------------------------------------------------------
--  DDL for Package Body BEN_BENUASUM_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENUASUM_XMLP_PKG" AS
/* $Header: BENUASUMB.pls 120.1 2007/12/10 08:38:58 vjaganat noship $ */
...
function CF_SUMMARY_EVENTFormula return Number is
  ...
  CP_ACTNCLSED     := CP_ACTNNOENRTDEL +  CP_ACTNENRTDEL;
  CP_TOTPROCD      := CP_ACTNNOACTN + CP_ACTNCLSED;
    return 1;
  end;
...
--Functions to refer Oracle report placeholders--
 ...
 Function CP_ACTNNOACTN_p return number is
	Begin
	 ...
	 END;
 Function CP_ACTNCLSED_p return number is
	Begin
	 return CP_ACTNCLSED;
	 END;
 ...
 Function CP_PERSONS_UNPROCESSED_p return number is
	Begin
	 ...
	 END;
 Function CP_TOTPROCD_p return number is
	Begin
	 return CP_TOTPROCD;
	 END;
