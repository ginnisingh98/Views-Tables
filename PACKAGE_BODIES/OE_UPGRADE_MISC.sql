--------------------------------------------------------
--  DDL for Package Body OE_UPGRADE_MISC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_UPGRADE_MISC" AS
/* $Header: OEXIUMSB.pls 115.8 2003/10/20 06:58:28 appldev ship $ */
...
, x_freight_amount OUT NOCOPY NUMBER
...
BEGIN
    ...
    IF l_count = 0 THEN
        ...
        IF p_charge_type_code = 'Insurance' THEN
	      l_charge_type_code := 'INSURANCE';
        ELSIF p_charge_type_code = 'Duty' THEN
	      l_charge_type_code := 'DUTY';
        ELSIF p_charge_type_code = 'Export' THEN
	      l_charge_type_code := 'EXPORT';
        ELSIF p_charge_type_code = 'Handling' THEN
	      l_charge_type_code := 'HANDLING';
        ELSIF p_charge_type_code = 'Freight' THEN
	      l_charge_type_code := 'FREIGHT';
        ELSE
           RAISE ERROR_IN_MAPPING_FREIGHT;
        END IF;
