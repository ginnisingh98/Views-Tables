--------------------------------------------------------
--  DDL for Package Body PQH_RFE_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_RFE_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_rfe_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_rate_factor_on_elmnt_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_rate_factor_on_elmnt_id  in  number) is
--
...
Begin
  ...
  --
  pqh_rfe_ins.g_rate_factor_on_elmnt_id_i := p_rate_factor_on_elmnt_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: pqh_rate_factor_on_elmnts
  --
...
--
  Cursor C_Sel1 is select pqh_rate_factor_on_elmnts_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from pqh_rate_factor_on_elmnts
     where rate_factor_on_elmnt_id =
             pqh_rfe_ins.g_rate_factor_on_elmnt_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (pqh_rfe_ins.g_rate_factor_on_elmnt_id_i is not null) Then
    --
    ...
    p_rec.rate_factor_on_elmnt_id :=
      pqh_rfe_ins.g_rate_factor_on_elmnt_id_i;
    pqh_rfe_ins.g_rate_factor_on_elmnt_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.rate_factor_on_elmnt_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  pqh_rfe_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pqh_rfe_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pqh_rfe_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the pqh_rfe_rec
  ...
  --
  p_rate_factor_on_elmnt_id := l_rec.rate_factor_on_elmnt_id;
