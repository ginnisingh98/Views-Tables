--------------------------------------------------------
--  DDL for Package Body HR_DOCUMENT_EXTRA_INFO_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DOCUMENT_EXTRA_INFO_BE3" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  hr_document_extra_info_be3.delete_doc_extra_info_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.document_extra_info.delete_doc_extra_info';
...
end hr_document_extra_info_be3;
