--------------------------------------------------------
--  DDL for Package Body PER_QTT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_QTT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_qtt_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the per_qualification_types_tl Row
  --
...
Begin
  ...
  --
  per_qtt_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  per_qtt_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  per_qtt_upd.post_update
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
  ...
  cursor csr_upd_langs is
    select qtt.language
     ...
     where qtt.qualification_type_id = p_qualification_type_id
       and p_language_code in (qtt.language
                              ,qtt.source_lang);
  --
