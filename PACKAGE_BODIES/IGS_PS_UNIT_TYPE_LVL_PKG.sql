--------------------------------------------------------
--  DDL for Package Body IGS_PS_UNIT_TYPE_LVL_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_PS_UNIT_TYPE_LVL_PKG" AS
/* $Header: IGSPI1YB.pls 120.1 2005/08/10 01:16:13 appldev ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_ps_unit_type_lvl%ROWTYPE;
  new_references igs_ps_unit_type_lvl%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igs_ps_unit_type_lvl_s.NEXTVAL
    INTO      x_unit_type_id
    FROM      dual;
    ...
    INSERT INTO igs_ps_unit_type_lvl (
      unit_type_id,
      level_code,
      description,
      closed_ind,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.level_code = x_level_code)
