--------------------------------------------------------
--  DDL for Package Body BEN_CBS_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CBS_RKU" as
...
begin
hr_utility.set_location('Entering: ben_cbs_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_cbs_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_cbs_RKU;
