--------------------------------------------------------
--  DDL for Package Body PAY_RFP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_RFP_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_rfp_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PAY_REPORT_FORMAT_PARAMETER_PK') Then
...
Begin
  --
  If (p_report_format_mapping_id is null and
      p_parameter_name is null and
  ...
  Else
    If (p_report_format_mapping_id
        = pay_rfp_shd.g_old_rec.report_format_mapping_id and
        p_parameter_name
        = pay_rfp_shd.g_old_rec.parameter_name and
        p_object_version_number
        = pay_rfp_shd.g_old_rec.object_version_number
       ) Then
      --
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into pay_rfp_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> pay_rfp_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  l_rec.parameter_value                  := p_parameter_value;
