--------------------------------------------------------
--  DDL for Package Body PQH_WKS_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_WKS_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqh_wks_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_dml(p_rec in pqh_wks_shd.g_rec_type) is
--
...
Begin
  ...
  --
  --
  -- Delete the pqh_worksheets row.
  --
  delete from pqh_worksheets
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pqh_wks_shd.g_rec_type) is
--
...
Procedure del
  ...
  p_rec	      in pqh_wks_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  pqh_wks_bus.delete_validate(p_rec
  ,p_effective_date);
  --
