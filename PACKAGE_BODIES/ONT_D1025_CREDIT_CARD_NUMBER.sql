--------------------------------------------------------
--  DDL for Package Body ONT_D1025_CREDIT_CARD_NUMBER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1025_CREDIT_CARD_NUMBER" AS
...
--  FILENAME
--  
--      ONT_D1025_CREDIT_CARD_NUMBER
--  
--  DESCRIPTION
--  
--      Body of package ONT_D1025_CREDIT_CARD_NUMBER
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1025_CREDIT_CARD_NUMBER';
...
END ONT_D1025_CREDIT_CARD_NUMBER;
