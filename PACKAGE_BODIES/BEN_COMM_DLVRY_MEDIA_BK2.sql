--------------------------------------------------------
--  DDL for Package Body BEN_COMM_DLVRY_MEDIA_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_COMM_DLVRY_MEDIA_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_COMM_DLVRY_MEDIA_BK2.UPDATE_COMM_DLVRY_MEDIA_A', 10);
hr_utility.set_location(' Leaving: BEN_COMM_DLVRY_MEDIA_BK2.UPDATE_COMM_DLVRY_MEDIA_A', 20);
end UPDATE_COMM_DLVRY_MEDIA_A;
...
begin
hr_utility.set_location('Entering: BEN_COMM_DLVRY_MEDIA_BK2.UPDATE_COMM_DLVRY_MEDIA_B', 10);
hr_utility.set_location(' Leaving: BEN_COMM_DLVRY_MEDIA_BK2.UPDATE_COMM_DLVRY_MEDIA_B', 20);
end UPDATE_COMM_DLVRY_MEDIA_B;
