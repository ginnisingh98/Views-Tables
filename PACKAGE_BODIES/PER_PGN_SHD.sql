--------------------------------------------------------
--  DDL for Package Body PER_PGN_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PGN_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_pgn_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PER_GEN_HIERARCHY_NODE_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PER_GEN_HIER_NOD_VER_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','10');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PER_GEN_HIER_NOD_VER_FK3') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  --
  If (p_hierarchy_node_id is null and
    ...
    l_fct_ret := false;
  Else
    If (p_hierarchy_node_id
        = per_pgn_shd.g_old_rec.hierarchy_node_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_pgn_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_pgn_shd.g_old_rec.object_version_number) Then
...
Exception
  When HR_Api.Object_Locked then
    ...
    fnd_message.set_token('TABLE_NAME', 'per_gen_hierarchy_nodes');
    fnd_message.raise_error;
End lck;
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  l_rec.node_type                        := p_node_type;
  l_rec.seq                              := p_seq;
  l_rec.parent_hierarchy_node_id         := p_parent_hierarchy_node_id;
