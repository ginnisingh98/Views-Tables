--------------------------------------------------------
--  DDL for Package Body PER_SA_WORK_INCIDENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_SA_WORK_INCIDENT_API" as
/* $Header: peincsai.pkb 115.0 2003/09/10 02:19:17 adevanat noship $ */

-- Package Variables
--
g_package  varchar2(33) := 'per_sa_work_incident_api.';
--
-- ----------------------------------------------------------------------
...
procedure create_sa_work_incident
  ...
  l_proc              varchar2(72) := g_package||'create_sa_work_incident';
...
begin
  ...
  --
  savepoint create_sa_work_incident;
  --
  ...
  --
    per_work_incident_api.create_work_incident
      (p_validate                       => p_validate
       ...
       ,p_inc_information_category      => 'SA'
       ,p_inc_information1              => p_date_wage_stop
       ,p_inc_information2              => p_patient_number
       ,p_inc_information3              => p_admission_date
       ,p_inc_information4              => p_hospitalised_from
       ,p_inc_information5              => p_hospitalised_to
       ,p_inc_information6              => p_rest_home_from
       ,p_inc_information7              => p_rest_home_to
       ,p_inc_information8              => p_number_external_visits
       ,p_inc_information9              => p_days_violated_med
       ,p_inc_information10             => p_violation_type
       ,p_inc_information11             => p_days_escorted
       ,p_inc_information12             => p_date_commenced
...
procedure update_sa_work_incident
  ...
  --
  l_business_group_id    per_contracts_f.business_group_id%TYPE;
  l_proc                 varchar2(72) := g_package||'update_sa_work_incident';
  l_legislation_code     varchar2(2);
  --
  cursor csr_get_business_group_id is
    select per.business_group_id
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_sa_work_incident;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
