--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_EXTERNAL_EFFORT_L
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_EXTERNAL_EFFORT_L" as
/*
...
(P_EXT_EFFORT_LINE_USER_KEY => c.p2);
end if;
--
hr_data_pump.api_trc_on;
PSP_EXTERNAL_EFFORT_LINES_API.DELETE_EXTERNAL_EFFORT_LINE
