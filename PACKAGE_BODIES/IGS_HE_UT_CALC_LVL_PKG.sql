--------------------------------------------------------
--  DDL for Package Body IGS_HE_UT_CALC_LVL_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_HE_UT_CALC_LVL_PKG" AS
/* $Header: IGSWI34B.pls 115.1 2003/09/02 15:31:18 smaddali noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_he_ut_calc_lvl%ROWTYPE;
  new_references igs_he_ut_calc_lvl%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGS_HE_UT_CALC_LVL_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    INSERT INTO igs_he_ut_calc_lvl (
      tariff_calc_type_cd,
      tariff_level_cd,
      closed_ind,
      creation_date,
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGS_HE_UT_CALC_LVL_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
