--------------------------------------------------------
--  DDL for Package Body PSB_BUDGET_GROUP_I_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSB_BUDGET_GROUP_I_PVT" AS
/* $Header: PSBWBGIB.pls 120.2 2005/07/13 11:32:23 shtripat ship $ */
...
BEGIN
   ...
   PSB_Budget_Groups_PVT.INSERT_ROW (
     p_api_version,
     p_init_msg_list,
     p_commit,
     p_validation_level,
