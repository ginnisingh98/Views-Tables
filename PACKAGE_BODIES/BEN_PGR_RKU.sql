--------------------------------------------------------
--  DDL for Package Body BEN_PGR_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PGR_RKU" as
...
begin
hr_utility.set_location('Entering: ben_pgr_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_pgr_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_pgr_RKU;
