--------------------------------------------------------
--  DDL for Package Body BEN_CPE_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CPE_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_cpe_bus.';  -- Global package name
--
-- The following two global variables are only to be
-- used by the return_legislation_code function.
--
g_legislation_code            varchar2(150)  default null;
g_copy_entity_result_id       number         default null;
--
--  ---------------------------------------------------------------------------
...
Procedure set_security_group_id
  ...
  -- ben_copy_entity_results and PER_BUSINESS_GROUPS_PERF
  ...
  if csr_sec_grp%notfound then
     ...
     hr_multi_message.add
       (p_associated_column1
        => nvl(p_associated_column1,'COPY_ENTITY_RESULT_ID')
       );
     --
  else
    close csr_sec_grp;
...
Begin
  ...
  --
  if ( nvl(ben_cpe_bus.g_copy_entity_result_id, hr_api.g_number)
       = p_copy_entity_result_id) then
    --
    -- The legislation code has already been found with a previous
    -- call to this function. Just return the value in the global
    -- variable.
    --
    l_legislation_code := ben_cpe_bus.g_legislation_code;
    ...
    --
    close csr_leg_code;
    ben_cpe_bus.g_copy_entity_result_id       := p_copy_entity_result_id;
    ben_cpe_bus.g_legislation_code  := l_legislation_code;
  end if;
...
Begin
  ...
  --
  IF NOT ben_cpe_shd.api_updating
