--------------------------------------------------------
--  DDL for Package Body IGF_AW_FI_INC_LEVEL_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_AW_FI_INC_LEVEL_PKG" AS
/* $Header: IGFWI42B.pls 115.5 2002/11/28 12:31:59 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_aw_fi_inc_level%ROWTYPE;
  new_references igf_aw_fi_inc_level%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.range_id                          := x_range_id;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AW_FINC_FISET_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igf_aw_fi_inc_level_s.NEXTVAL
    INTO      x_range_id
    FROM      dual;
    ...
    INSERT INTO igf_aw_fi_inc_level (
      category_id,
      range_id,
      minvalue,
      maxvalue,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.category_id = x_category_id)
        AND (tlinfo.minvalue = x_minvalue)
        AND (tlinfo.maxvalue = x_maxvalue)
       ) THEN
      NULL;
    ELSE
  ...
  */
  BEGIN
    ...
    DELETE FROM igf_aw_fi_inc_level
    WHERE rowid = x_rowid;
