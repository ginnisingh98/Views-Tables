--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_CBR_PER_IN_LER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_CBR_PER_IN_LER" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 13:01:22
 * Generated for API: ben_cbr_per_in_ler_api.UPDATE_CBR_PER_IN_LER
 */
--
...
,I_CNT_NUM in varchar2 default 'N'
,P_PRVS_ELIG_PERD_END_DT in date default null
,I_PRVS_ELIG_PERD_END_DT in varchar2 default 'N'
...
,p_link_value
,P_INIT_EVT_FLAG
,nd(P_CNT_NUM,I_CNT_NUM)
,dd(P_PRVS_ELIG_PERD_END_DT,I_PRVS_ELIG_PERD_END_DT)
...
decode(l.pval001,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval001,'YES_NO',d(l.pval035),vn)) p1,
l.pval001 d1,
decode(l.pval002,cn,nn,vn,nh,n(l.pval002)) p2,
l.pval002 d2,
...
l.pval034 d34,
decode(l.pval035,cn,dn,d(l.pval035)) p35,
...
L_CBR_PER_IN_LER_ID:=nn;
else
L_CBR_PER_IN_LER_ID := 
hr_pump_get.get_cbr_per_in_ler_id
(P_CBR_PER_IN_LER_USER_KEY => c.p36);
end if;
--
if c.d37=cn then
L_PER_IN_LER_ID:=nn;
elsif c.d37 is null then 
L_PER_IN_LER_ID:=nh;
else
L_PER_IN_LER_ID := 
hr_pump_get.get_per_in_ler_id
(P_PER_IN_LER_USER_KEY => c.p37);
end if;
--
if c.d38=cn then
L_CBR_QUALD_BNF_ID:=nn;
elsif c.d38 is null then 
L_CBR_QUALD_BNF_ID:=nh;
else
L_CBR_QUALD_BNF_ID := 
hr_pump_get.get_cbr_quald_bnf_id
(P_CBR_QUALD_BNF_USER_KEY => c.p38);
end if;
--
if c.p36 is null then
...
hr_pump_get.GET_CBR_PER_IN_LER_OVN
(P_CBR_PER_IN_LER_USER_KEY => c.p36);
end if;
--
hr_data_pump.api_trc_on;
ben_cbr_per_in_ler_api.UPDATE_CBR_PER_IN_LER
(p_validate => l_validate
,P_CBR_PER_IN_LER_ID => L_CBR_PER_IN_LER_ID
,P_INIT_EVT_FLAG => c.p1
,P_CNT_NUM => c.p2
,P_PER_IN_LER_ID => L_PER_IN_LER_ID
,P_CBR_QUALD_BNF_ID => L_CBR_QUALD_BNF_ID
,P_PRVS_ELIG_PERD_END_DT => c.p3
,p_business_group_id => p_business_group_id
,P_CRP_ATTRIBUTE_CATEGORY => c.p4
,P_CRP_ATTRIBUTE1 => c.p5
,P_CRP_ATTRIBUTE2 => c.p6
,P_CRP_ATTRIBUTE3 => c.p7
,P_CRP_ATTRIBUTE4 => c.p8
,P_CRP_ATTRIBUTE5 => c.p9
,P_CRP_ATTRIBUTE6 => c.p10
,P_CRP_ATTRIBUTE7 => c.p11
,P_CRP_ATTRIBUTE8 => c.p12
,P_CRP_ATTRIBUTE9 => c.p13
,P_CRP_ATTRIBUTE10 => c.p14
,P_CRP_ATTRIBUTE11 => c.p15
,P_CRP_ATTRIBUTE12 => c.p16
,P_CRP_ATTRIBUTE13 => c.p17
,P_CRP_ATTRIBUTE14 => c.p18
,P_CRP_ATTRIBUTE15 => c.p19
,P_CRP_ATTRIBUTE16 => c.p20
,P_CRP_ATTRIBUTE17 => c.p21
,P_CRP_ATTRIBUTE18 => c.p22
,P_CRP_ATTRIBUTE19 => c.p23
,P_CRP_ATTRIBUTE20 => c.p24
,P_CRP_ATTRIBUTE21 => c.p25
,P_CRP_ATTRIBUTE22 => c.p26
,P_CRP_ATTRIBUTE23 => c.p27
,P_CRP_ATTRIBUTE24 => c.p28
,P_CRP_ATTRIBUTE25 => c.p29
,P_CRP_ATTRIBUTE26 => c.p30
,P_CRP_ATTRIBUTE27 => c.p31
,P_CRP_ATTRIBUTE28 => c.p32
,P_CRP_ATTRIBUTE29 => c.p33
,P_CRP_ATTRIBUTE30 => c.p34
,P_OBJECT_VERSION_NUMBER => L_OBJECT_VERSION_NUMBER
,P_EFFECTIVE_DATE => c.p35);
...
end hrdpp_UPDATE_CBR_PER_IN_LER;
