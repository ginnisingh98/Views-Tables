--------------------------------------------------------
--  DDL for Package Body OTA_ENT_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_ENT_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_ent_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'OTA_EVENTS_TL_PK') Then
...
Begin
  ...
  Else
    If (p_event_id
        = ota_ent_shd.g_old_rec.event_id and
        p_language
        = ota_ent_shd.g_old_rec.language
       ) Then
      --
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into ota_ent_shd.g_old_rec;
...
Exception
  When HR_Api.Object_Locked then
    ...
    fnd_message.set_token('TABLE_NAME', 'ota_events_tl');
    fnd_message.raise_error;
End lck;
--
-- ----------------------------------------------------------------------------
...
--  following ADD_LANGUAGE procedure.
--
-- ----------------------------------------------------------------------------
