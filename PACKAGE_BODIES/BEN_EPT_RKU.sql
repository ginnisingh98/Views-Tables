--------------------------------------------------------
--  DDL for Package Body BEN_EPT_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EPT_RKU" as
...
begin
hr_utility.set_location('Entering: ben_ept_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_ept_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_ept_RKU;
