--------------------------------------------------------
--  DDL for Package Body PER_WORK_INCIDENT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_WORK_INCIDENT_BK2" as
...
begin
hr_utility.set_location('Entering: PER_WORK_INCIDENT_BK2.UPDATE_WORK_INCIDENT_A', 10);
hr_utility.set_location(' Leaving: PER_WORK_INCIDENT_BK2.UPDATE_WORK_INCIDENT_A', 20);
end UPDATE_WORK_INCIDENT_A;
...
begin
hr_utility.set_location('Entering: PER_WORK_INCIDENT_BK2.UPDATE_WORK_INCIDENT_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_leg_hooks then
l_legislation_code := PER_INC_BUS.RETURN_LEGISLATION_CODE(P_INCIDENT_ID => P_INCIDENT_ID
);
if l_legislation_code = 'DE' then
HR_DE_EXTRA_WORK_INC_CHECKS.WORK_INCIDENT_CHECKS
...
HR_NO_VALIDATE_PKG.WORKINC_VALIDATE
(P_INCIDENT_DATE => P_INCIDENT_DATE
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_WORK_INCIDENT', 'BP');
hr_utility.set_location(' Leaving: PER_WORK_INCIDENT_BK2.UPDATE_WORK_INCIDENT_B', 20);
end UPDATE_WORK_INCIDENT_B;
