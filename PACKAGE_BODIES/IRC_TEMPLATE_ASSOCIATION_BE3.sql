--------------------------------------------------------
--  DDL for Package Body IRC_TEMPLATE_ASSOCIATION_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_TEMPLATE_ASSOCIATION_BE3" as 
...
end irc_template_association_be3;
