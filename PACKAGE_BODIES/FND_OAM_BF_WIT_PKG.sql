--------------------------------------------------------
--  DDL for Package Body FND_OAM_BF_WIT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FND_OAM_BF_WIT_PKG" as
/* $Header: AFOAMFWB.pls 120.1 2005/07/02 03:04:11 appldev noship $ */
...
is
  cursor C is select ROWID from FND_OAM_BF_WIT
    where BIZ_FLOW_KEY = X_BIZ_FLOW_KEY
    and item_type = X_ITEM_TYPE;
begin
  insert into fnd_oam_bf_wit (
    BIZ_FLOW_KEY,
    ITEM_TYPE,
    MONITORED_FLAG,
    DISPLAY_ORDER,
