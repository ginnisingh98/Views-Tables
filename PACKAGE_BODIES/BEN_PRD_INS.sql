--------------------------------------------------------
--  DDL for Package Body BEN_PRD_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PRD_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_prd_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_paird_rt_f.created_by%TYPE;
  l_creation_date       ben_paird_rt_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_paird_rt_f
  --
...
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.paird_rt_id;
  close c1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  dt_api.validate_dt_mode
	(p_effective_date	   => p_effective_date,
	 ...
	 p_parent_key_value1       => p_rec.parnt_acty_base_rt_id,
	 p_parent_table_name2      => 'ben_acty_base_rt_f',
	 p_parent_key_column2      => 'acty_base_rt_id',
	 p_parent_key_value2       => p_rec.chld_acty_base_rt_id,
...
Begin
  ...
  --
  p_paird_rt_id          	:= l_rec.paird_rt_id;
