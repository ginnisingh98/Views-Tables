--------------------------------------------------------
--  DDL for Package Body PAY_OPT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_OPT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_opt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure insert_dml
  (p_rec in out nocopy pay_opt_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Insert the row into: pay_org_payment_methods_f_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.org_payment_method_id            := p_org_payment_method_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  --
  pay_opt_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  pay_opt_ins.pre_insert
    (p_rec                         => p_rec
  ...
  -- Insert the row
  --
  pay_opt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pay_opt_ins.post_insert
     (p_rec
     );
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where opt.org_payment_method_id = p_org_payment_method_id
                          and opt.language = l.language_code);
  --
