--------------------------------------------------------
--  DDL for Package Body HR_HU_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_HU_CONTINGENT_WORKER_API" as
/* $Header: pecwkhui.pkb 115.0 2004/03/18 01:40:49 vikgupta noship $ */

--   package variables
g_package  varchar2(33) := 'hr_hu_contingent_worker_api.';
...
procedure create_hu_cwk
  ...
  ,p_tax_identification_no         in     varchar2
...
hr_contingent_worker_api.create_cwk
  ...
  ,p_person_id                     => p_per_object_version_number
