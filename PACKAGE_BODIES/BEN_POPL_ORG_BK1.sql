--------------------------------------------------------
--  DDL for Package Body BEN_POPL_ORG_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_POPL_ORG_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_POPL_ORG_BK1.CREATE_POPL_ORG_A', 10);
hr_utility.set_location(' Leaving: BEN_POPL_ORG_BK1.CREATE_POPL_ORG_A', 20);
end CREATE_POPL_ORG_A;
...
begin
hr_utility.set_location('Entering: BEN_POPL_ORG_BK1.CREATE_POPL_ORG_B', 10);
hr_utility.set_location(' Leaving: BEN_POPL_ORG_BK1.CREATE_POPL_ORG_B', 20);
end CREATE_POPL_ORG_B;
