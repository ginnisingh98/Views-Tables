--------------------------------------------------------
--  DDL for Package Body BEN_CRD_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CRD_RKU" as
...
begin
hr_utility.set_location('Entering: ben_crd_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_crd_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_crd_RKU;
