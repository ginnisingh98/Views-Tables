--------------------------------------------------------
--  DDL for Package Body HR_CONTRACT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_CONTRACT_BK2" as
...
begin
hr_utility.set_location('Entering: HR_CONTRACT_BK2.UPDATE_CONTRACT_A', 10);
hr_utility.set_location(' Leaving: HR_CONTRACT_BK2.UPDATE_CONTRACT_A', 20);
end UPDATE_CONTRACT_A;
...
begin
hr_utility.set_location('Entering: HR_CONTRACT_BK2.UPDATE_CONTRACT_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_leg_hooks then
l_legislation_code := PER_CTC_BUS.return_legislation_code(P_CONTRACT_ID => P_CONTRACT_ID
);
...
PER_FR_CONTRACTS_VAL.PERSON_CONTRACT_UPDATE
(P_CTR_INFORMATION_CATEGORY => P_CTR_INFORMATION_CATEGORY
...
HR_NO_VALIDATE_PKG.UPDATE_CONTRACT_VALIDATE
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_CONTRACT', 'BP');
hr_utility.set_location(' Leaving: HR_CONTRACT_BK2.UPDATE_CONTRACT_B', 20);
end UPDATE_CONTRACT_B;
end HR_CONTRACT_BK2;
