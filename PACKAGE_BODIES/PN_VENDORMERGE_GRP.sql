--------------------------------------------------------
--  DDL for Package Body PN_VENDORMERGE_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PN_VENDORMERGE_GRP" AS
/* $Header: pngvdrb.pls 120.0 2005/07/29 22:51:57 atsingh noship $ */

G_PKG_NAME 	CONSTANT VARCHAR2(30):='PN_VendorMerge_GRP';
...
BEGIN
        ...
        x_return_status := FND_API.G_RET_STS_SUCCESS;
         ...
         FND_MESSAGE.SET_NAME('PN','PN_PAYMENT_TERMS');
	 IF SQL%FOUND THEN
		x_return_status := FND_API.G_RET_STS_SUCCESS;
	 ...
	 FND_MSG_PUB.Add;
         ...
         -- Prepare message name
         FND_MESSAGE.SET_NAME('PN','PN_PAYMENT_ITEMS');
	 IF SQL%FOUND THEN
		x_return_status := FND_API.G_RET_STS_SUCCESS;
		l_row_count := SQL%ROWCOUNT;
	 ELSE
