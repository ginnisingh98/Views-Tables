--------------------------------------------------------
--  DDL for Package Body OKL_LS_RT_FCTR_SETS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_LS_RT_FCTR_SETS_PUB_W" as
  /* $Header: OKLULRTB.pls 120.2 2005/08/11 11:56:26 asawanka noship $ */
  ...
  as
    ddp_lrtv_tbl okl_ls_rt_fctr_sets_pub.lrtv_tbl_type;
    ddx_lrtv_tbl okl_ls_rt_fctr_sets_pub.lrtv_tbl_type;
  ...
  as
    ddp_lrtv_rec okl_ls_rt_fctr_sets_pub.lrtv_rec_type;
    ddx_lrtv_rec okl_ls_rt_fctr_sets_pub.lrtv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
   null;
  end;
