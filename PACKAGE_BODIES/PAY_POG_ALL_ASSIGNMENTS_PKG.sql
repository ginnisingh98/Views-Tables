--------------------------------------------------------
--  DDL for Package Body PAY_POG_ALL_ASSIGNMENTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_POG_ALL_ASSIGNMENTS_PKG" AS
/* $Header: pypogasg.pkb 120.1 2006/01/10 07:20:39 nbristow noship $ */
--
-- +---------------------------------------+
...
(
  ...
  begin
    hr_utility.trace('>> PAY_POG_ALL_ASSIGNMENTS_PKG.after_insert');
--
    pay_asg_process_grp_pkg.asg_insert_trigger
...
(
  ...
  begin
    hr_utility.trace('>> PAY_POG_ALL_ASSIGNMENTS_PKG.after_update');
--
    dyt_mode := p_datetrack_mode;
--
    pay_asg_process_grp_pkg.asg_update_trigger
                (p_assignment_id            => p_assignment_id,
                 ...
                 p_new_effective_start_date => p_effective_start_date,
                 p_new_effective_end_date   => p_effective_end_date,
                 p_old_payroll_id           => p_payroll_id_o,
                 p_new_payroll_id           => p_payroll_id,
...
(
  ...
  begin
    hr_utility.trace('>> PAY_POG_ALL_ASSIGNMENTS_PKG.after_delete');
--
    dyt_mode := p_datetrack_mode;
--
    pay_asg_process_grp_pkg.asg_delete_trigger
             (p_assignment_id      => p_assignment_id,
...
END PAY_POG_ALL_ASSIGNMENTS_PKG;
