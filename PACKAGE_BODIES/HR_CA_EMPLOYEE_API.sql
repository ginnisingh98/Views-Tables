--------------------------------------------------------
--  DDL for Package Body HR_CA_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_CA_EMPLOYEE_API" as
/* $Header: peempcai.pkb 115.1 2002/12/05 14:04:17 pkakar noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := 'hr_ca_employee_api.';
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_ca_employee >---------------------------|
-- ----------------------------------------------------------------------------
...
procedure create_ca_employee
  ...
  --
  l_proc                 varchar2(72) := g_package||'create_ca_employee';
