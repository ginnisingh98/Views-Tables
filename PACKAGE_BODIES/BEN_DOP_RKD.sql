--------------------------------------------------------
--  DDL for Package Body BEN_DOP_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DOP_RKD" as
...
begin
hr_utility.set_location('Entering: BEN_DOP_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: BEN_DOP_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end BEN_DOP_RKD;
