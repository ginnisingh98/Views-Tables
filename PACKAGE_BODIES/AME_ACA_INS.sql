--------------------------------------------------------
--  DDL for Package Body AME_ACA_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ACA_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_aca_ins.';  -- Global package name
--
...
Begin
  ...
  --
  ame_aca_ins.g_application_id_i := p_application_id;
  --
...
--
  Cursor C_Sel1 Is
    ...
    where t.application_id = p_rec.application_id
    and    t.start_date =
...
--
  ...
  l_created_by          ame_calling_apps.created_by%TYPE;
  l_creation_date       ame_calling_apps.creation_date%TYPE;
  l_last_update_date    ame_calling_apps.last_update_date%TYPE;
  l_last_updated_by     ame_calling_apps.last_updated_by%TYPE;
  l_last_update_login   ame_calling_apps.last_update_login%TYPE;
...
Begin
  ...
  --
  --
  -- Insert the row into: ame_calling_apps
  --
...
--
  Cursor C_Sel1 is select ame_applications_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from ame_calling_apps
     where application_id =
             ame_aca_ins.g_application_id_i
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (ame_aca_ins.g_application_id_i is not null) Then
    --
    ...
    If C_Sel2%found Then
       ...
       fnd_message.set_token('TABLE_NAME','ame_calling_apps');
       fnd_message.raise_error;
    End If;
    Close C_Sel2;
    --
    ...
    p_rec.application_id :=
      ame_aca_ins.g_application_id_i;
    ame_aca_ins.g_application_id_i := null;
  Else
    --
...
Procedure ins
  ...
  ,p_line_item_id_query             in     varchar2 default null
...
Begin
  ...
  --
  -- Having converted the arguments into the ame_aca_rec
