--------------------------------------------------------
--  DDL for Package Body PAY_PUR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PUR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_pur_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_user_row_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_user_row_id  in  number) is
--
...
Begin
  ...
  --
  pay_pur_ins.g_user_row_id_i := p_user_row_id;
  --
...
--
  Cursor C_Sel1 Is
    select t.created_by,
           t.creation_date
    from   pay_user_rows_f t
    where  t.user_row_id       = p_rec.user_row_id
    and    t.effective_start_date =
             pay_pur_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc                varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          pay_user_rows_f.created_by%TYPE;
  l_creation_date       pay_user_rows_f.creation_date%TYPE;
  l_last_update_date    pay_user_rows_f.last_update_date%TYPE;
  l_last_updated_by     pay_user_rows_f.last_updated_by%TYPE;
  l_last_update_login   pay_user_rows_f.last_update_login%TYPE;
--
Begin
  ...
  p_rec.object_version_number :=
    dt_api.get_object_version_number
      ...
      ,p_base_key_value  => p_rec.user_row_id
      );
  --
  ...
  End If;
  --
  pay_pur_shd.g_api_dml := true;  -- Set the api dml status
  --
  -- Insert the row into: pay_user_rows_f
  --
  ...
  --
  pay_pur_shd.g_api_dml := false;   -- Unset the api dml status
...
--
  Cursor C_Sel1 is select pay_user_rows_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from pay_user_rows_f
     where user_row_id =
             pay_pur_ins.g_user_row_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (pay_pur_ins.g_user_row_id_i is not null) Then
    --
    ...
    If C_Sel2%found Then
       ...
       fnd_message.set_token('TABLE_NAME','pay_user_rows_f');
       fnd_message.raise_error;
    End If;
    Close C_Sel2;
    --
    ...
    p_rec.user_row_id :=
      pay_pur_ins.g_user_row_id_i;
    pay_pur_ins.g_user_row_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.user_row_id;
    Close C_Sel1;
  End If;
  --
  --
...
Begin
  ...
  begin
    ...
    create_app_ownerships
      ('USER_ROW_ID', p_rec.user_row_id
      );
    --
    --
    pay_pur_rki.after_insert
      (p_effective_date
      => p_effective_date
      ...
      => p_rec.object_version_number
      ,p_disable_units_check
      => p_disable_units_check
      ,p_disable_range_overlap_check
      => p_disable_range_overlap_check
      );
    --
  exception
...
Begin
  ...
  --
  -- Having converted the arguments into the pay_pur_rec
  ...
  --
  p_user_row_id                      := l_rec.user_row_id;
