--------------------------------------------------------
--  DDL for Package Body PAY_EEI_MIG_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_EEI_MIG_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_eei_mig_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure update_dml
  (p_rec in out nocopy pay_eei_mig_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  convert_defs(p_rec);
  pay_eei_mig_bus.update_validate
     (p_rec
     );
  --
  -- Call the supporting pre-update operation
  --
  pay_eei_mig_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  pay_eei_mig_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  pay_eei_mig_upd.post_update
     (p_rec
     );
End upd;
--
