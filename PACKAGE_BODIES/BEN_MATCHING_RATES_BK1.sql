--------------------------------------------------------
--  DDL for Package Body BEN_MATCHING_RATES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_MATCHING_RATES_BK1" as
/* $Header: bemtrapi.pkb 115.4 2002/12/16 17:38:59 generated ship $ */
...
begin
hr_utility.set_location('Entering: BEN_MATCHING_RATES_BK1.CREATE_MATCHING_RATES_A', 10);
hr_utility.set_location(' Leaving: BEN_MATCHING_RATES_BK1.CREATE_MATCHING_RATES_A', 20);
end CREATE_MATCHING_RATES_A;
...
begin
hr_utility.set_location('Entering: BEN_MATCHING_RATES_BK1.CREATE_MATCHING_RATES_B', 10);
hr_utility.set_location(' Leaving: BEN_MATCHING_RATES_BK1.CREATE_MATCHING_RATES_B', 20);
end CREATE_MATCHING_RATES_B;
