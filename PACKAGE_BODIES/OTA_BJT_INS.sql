--------------------------------------------------------
--  DDL for Package Body OTA_BJT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_BJT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_bjt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: ota_bkng_justifications_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.booking_justification_id         := p_booking_justification_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  ota_bjt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ota_bjt_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where bjt.booking_justification_id = p_booking_justification_id
                          and bjt.language = l.language_code);
  --
