--------------------------------------------------------
--  DDL for Package Body OKL_SETUP_TRXPARAMS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUP_TRXPARAMS_PUB_W" as
  /* $Header: OKLUTXRB.pls 115.0 2004/07/02 02:38:45 sgorantl noship $ */
  ...
  procedure create_trx_parm(p_api_version  NUMBER
  ...
  as
    ddp_sxpv_rec okl_setup_trxparams_pub.sxpv_rec_type;
    ddx_sxpv_rec okl_setup_trxparams_pub.sxpv_rec_type;
  ...
  begin
    ...
    okl_setup_trxparams_pub.create_trx_parm(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_trx_parm(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setup_trxparams_pub.update_trx_parm(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_sxpv_tbl okl_setup_trxparams_pub.sxpv_tbl_type;
    ddx_sxpv_tbl okl_setup_trxparams_pub.sxpv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure delete_trx_parm(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setup_trxparams_pub.delete_trx_parm(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure create_trx_asset_parm(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setup_trxparams_pub.create_trx_asset_parm(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_trx_asset_parm(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setup_trxparams_pub.update_trx_asset_parm(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
