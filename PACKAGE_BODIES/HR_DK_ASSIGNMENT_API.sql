--------------------------------------------------------
--  DDL for Package Body HR_DK_ASSIGNMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DK_ASSIGNMENT_API" AS
/* $Header: peasgdki.pkb 120.1.12000000.2 2007/05/08 07:23:20 saurai ship $ */

g_package  VARCHAR2(33) := 'hr_dk_assignment_api.';
--
-- ----------------------------------------------------------------------------
...
PROCEDURE create_dk_secondary_emp_asg
  ...
  ,p_emp_group		          IN     VARCHAR2 DEFAULT NULL
  ,p_union_membership	          IN     VARCHAR2 DEFAULT NULL
  ...
  l_proc               VARCHAR2(72) := g_package||'create_dk_secondary_emp_asg';
  --
  -- Declare cursors
  --
...
BEGIN
  ...
  --
  -- Ensure that the employee IS within a dk business group
  --
 ...
 hr_assignment_api.create_secondary_emp_asg
  ...
  ,p_title                        =>     p_title
  ,p_scl_segment1                 =>     p_legal_entity
  --,p_scl_segment2                 =>     p_pension_provider Removed from assignment level and it's captured at Element entry level
  ,p_scl_segment3                 =>     p_cond_of_emp
  ,p_scl_segment4                 =>     p_emp_group
  ,p_scl_segment5                 =>     p_union_membership
  ,p_scl_segment6                 =>     p_termination_reason
  ,p_scl_segment7                 =>     p_notified_date
  ,p_scl_segment8                 =>     p_termination_date
  ,p_scl_segment9                 =>     p_adjusted_seniority_date
  ,p_scl_segment10                =>     p_default_work_pattern		-- Holiday Entitlement
  ,p_scl_segment11                =>     p_hourly_accrual_rate		-- Holiday Entitlement
  ,p_scl_segment12                =>     p_accrual_type			-- Holiday Entitlement
  ,p_scl_segment13                =>     p_salaried_allowance_rate	-- Holiday Entitlement
  ,p_scl_segment14                =>     p_job_occupation_employee_code	-- DA Office codes
  ,p_scl_segment15                =>     p_job_status_employee_code	-- DA Office codes
  ,p_scl_segment16                =>     p_salary_basis_employee_code	-- DA Office codes
  ,p_scl_segment17                =>     p_time_off_in_lieu		-- DA Office codes
  ,p_scl_segment18                =>     p_section_28_registration	-- Sick Pay Defaults
  ...
  --
  END create_dk_secondary_emp_asg;
