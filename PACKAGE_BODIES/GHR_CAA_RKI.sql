--------------------------------------------------------
--  DDL for Package Body GHR_CAA_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_CAA_RKI" as
...
begin
hr_utility.set_location('Entering: GHR_CAA_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: GHR_CAA_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end GHR_CAA_RKI;
