--------------------------------------------------------
--  DDL for Package Body OKL_SERVICE_INTEGRATION_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SERVICE_INTEGRATION_PVT_W" as
  /* $Header: OKLESRIB.pls 115.1 2003/10/20 18:56:00 dedey noship $ */
  ...
  procedure rosetta_table_copy_in_p19(t out nocopy okl_service_integration_pvt.link_line_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    ) as
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        ddindx := 1;
        while true loop
          t(ddindx).okl_service_line_id := rosetta_g_miss_num_map(a0(indx));
          t(ddindx).oks_service_line_id := rosetta_g_miss_num_map(a1(indx));
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p19(t okl_service_integration_pvt.link_line_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  if t is null or t.count = 0 then
    ...
    a1 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        indx := 1;
        while true loop
          a0(indx) := rosetta_g_miss_num_map(t(ddindx).okl_service_line_id);
          a1(indx) := rosetta_g_miss_num_map(t(ddindx).oks_service_line_id);
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_in_p21(t out nocopy okl_service_integration_pvt.srv_cov_tbl_type, a0 JTF_NUMBER_TABLE
    ) as
    ddindx binary_integer; indx binary_integer;
  begin
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        ddindx := 1;
        while true loop
          t(ddindx).oks_cov_prod_line_id := rosetta_g_miss_num_map(a0(indx));
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p21(t okl_service_integration_pvt.srv_cov_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ) as
    ddindx binary_integer; indx binary_integer;
  begin
  if t is null or t.count = 0 then
    a0 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        indx := 1;
        while true loop
          a0(indx) := rosetta_g_miss_num_map(t(ddindx).oks_cov_prod_line_id);
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure delete_service_line(p_api_version  NUMBER
  ...
  as
    ddp_clev_rec okl_service_integration_pvt.clev_rec_type;
    ddp_klev_rec okl_service_integration_pvt.klev_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_service_integration_pvt.delete_service_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure get_service_link_line(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
    , p_lease_contract_id  NUMBER
    , p6_a0 out nocopy JTF_NUMBER_TABLE
    , p6_a1 out nocopy JTF_NUMBER_TABLE
    , x_service_contract_id out nocopy  NUMBER
  )

  as
    ddx_link_line_tbl okl_service_integration_pvt.link_line_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_service_integration_pvt.get_service_link_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    okl_service_integration_pvt_w.rosetta_table_copy_out_p19(ddx_link_line_tbl, p6_a0
      , p6_a1
      );

  end;

  procedure update_service_line(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
    , p_okl_chr_id  NUMBER
    , p_oks_chr_id  NUMBER
    , p_oks_service_line_id  NUMBER
    , p_supplier_id  NUMBER
    , x_okl_service_line_id out nocopy  NUMBER
    ...
    , p10_a20  DATE := fnd_api.g_miss_date
    , p10_a21  DATE := fnd_api.g_miss_date
    , p10_a22  NUMBER := 0-1962.0724
    , p10_a23  NUMBER := 0-1962.0724
    , p10_a24  DATE := fnd_api.g_miss_date
    , p10_a25  DATE := fnd_api.g_miss_date
    , p10_a26  DATE := fnd_api.g_miss_date
    , p10_a27  NUMBER := 0-1962.0724
    , p10_a28  NUMBER := 0-1962.0724
    , p10_a29  NUMBER := 0-1962.0724
    , p10_a30  NUMBER := 0-1962.0724
    , p10_a31  NUMBER := 0-1962.0724
    , p10_a32  NUMBER := 0-1962.0724
    , p10_a33  NUMBER := 0-1962.0724
    , p10_a34  DATE := fnd_api.g_miss_date
    , p10_a35  VARCHAR2 := fnd_api.g_miss_char
    , p10_a36  DATE := fnd_api.g_miss_date
    , p10_a37  VARCHAR2 := fnd_api.g_miss_char
    , p10_a38  NUMBER := 0-1962.0724
    , p10_a39  NUMBER := 0-1962.0724
    , p10_a40  NUMBER := 0-1962.0724
    ...
    , p10_a67  VARCHAR2 := fnd_api.g_miss_char
    ...
    , p10_a76  NUMBER := 0-1962.0724
    , p10_a77  NUMBER := 0-1962.0724
    , p10_a78  NUMBER := 0-1962.0724
    , p10_a79  DATE := fnd_api.g_miss_date
    , p10_a80  NUMBER := 0-1962.0724
    , p10_a81  DATE := fnd_api.g_miss_date
    , p10_a82  NUMBER := 0-1962.0724
    , p10_a83  DATE := fnd_api.g_miss_date
    , p10_a84  DATE := fnd_api.g_miss_date
    , p10_a85  DATE := fnd_api.g_miss_date
    , p10_a86  DATE := fnd_api.g_miss_date
    , p10_a87  NUMBER := 0-1962.0724
    , p10_a88  NUMBER := 0-1962.0724
    , p10_a89  NUMBER := 0-1962.0724
    , p10_a90  VARCHAR2 := fnd_api.g_miss_char
    , p10_a91  NUMBER := 0-1962.0724
    , p10_a92  VARCHAR2 := fnd_api.g_miss_char
    , p10_a93  NUMBER := 0-1962.0724
    , p10_a94  NUMBER := 0-1962.0724
    , p10_a95  DATE := fnd_api.g_miss_date
    , p10_a96  VARCHAR2 := fnd_api.g_miss_char
    , p10_a97  VARCHAR2 := fnd_api.g_miss_char
  ...
  begin
    ...
    ddp_clev_rec.id := rosetta_g_miss_num_map(p9_a0);
    ddp_clev_rec.object_version_number := rosetta_g_miss_num_map(p9_a1);
    ddp_clev_rec.sfwt_flag := p9_a2;
    ddp_clev_rec.chr_id := rosetta_g_miss_num_map(p9_a3);
    ddp_clev_rec.cle_id := rosetta_g_miss_num_map(p9_a4);
    ddp_clev_rec.cle_id_renewed := rosetta_g_miss_num_map(p9_a5);
    ddp_clev_rec.cle_id_renewed_to := rosetta_g_miss_num_map(p9_a6);
    ddp_clev_rec.lse_id := rosetta_g_miss_num_map(p9_a7);
    ddp_clev_rec.line_number := p9_a8;
    ddp_clev_rec.sts_code := p9_a9;
    ddp_clev_rec.display_sequence := rosetta_g_miss_num_map(p9_a10);
    ddp_clev_rec.trn_code := p9_a11;
    ddp_clev_rec.dnz_chr_id := rosetta_g_miss_num_map(p9_a12);
    ddp_clev_rec.comments := p9_a13;
    ddp_clev_rec.item_description := p9_a14;
    ddp_clev_rec.oke_boe_description := p9_a15;
    ddp_clev_rec.cognomen := p9_a16;
    ddp_clev_rec.hidden_ind := p9_a17;
    ddp_clev_rec.price_unit := rosetta_g_miss_num_map(p9_a18);
    ddp_clev_rec.price_unit_percent := rosetta_g_miss_num_map(p9_a19);
    ddp_clev_rec.price_negotiated := rosetta_g_miss_num_map(p9_a20);
    ddp_clev_rec.price_negotiated_renewed := rosetta_g_miss_num_map(p9_a21);
    ddp_clev_rec.price_level_ind := p9_a22;
    ddp_clev_rec.invoice_line_level_ind := p9_a23;
    ddp_clev_rec.dpas_rating := p9_a24;
    ddp_clev_rec.block23text := p9_a25;
    ddp_clev_rec.exception_yn := p9_a26;
    ddp_clev_rec.template_used := p9_a27;
    ddp_clev_rec.date_terminated := rosetta_g_miss_date_in_map(p9_a28);
    ddp_clev_rec.name := p9_a29;
    ddp_clev_rec.start_date := rosetta_g_miss_date_in_map(p9_a30);
    ddp_clev_rec.end_date := rosetta_g_miss_date_in_map(p9_a31);
    ddp_clev_rec.date_renewed := rosetta_g_miss_date_in_map(p9_a32);
    ddp_clev_rec.upg_orig_system_ref := p9_a33;
    ddp_clev_rec.upg_orig_system_ref_id := rosetta_g_miss_num_map(p9_a34);
    ddp_clev_rec.orig_system_source_code := p9_a35;
    ddp_clev_rec.orig_system_id1 := rosetta_g_miss_num_map(p9_a36);
    ddp_clev_rec.orig_system_reference1 := p9_a37;
    ddp_clev_rec.attribute_category := p9_a38;
    ddp_clev_rec.attribute1 := p9_a39;
    ddp_clev_rec.attribute2 := p9_a40;
    ddp_clev_rec.attribute3 := p9_a41;
    ddp_clev_rec.attribute4 := p9_a42;
    ddp_clev_rec.attribute5 := p9_a43;
    ddp_clev_rec.attribute6 := p9_a44;
    ddp_clev_rec.attribute7 := p9_a45;
    ddp_clev_rec.attribute8 := p9_a46;
    ddp_clev_rec.attribute9 := p9_a47;
    ddp_clev_rec.attribute10 := p9_a48;
    ddp_clev_rec.attribute11 := p9_a49;
    ddp_clev_rec.attribute12 := p9_a50;
    ddp_clev_rec.attribute13 := p9_a51;
    ddp_clev_rec.attribute14 := p9_a52;
    ddp_clev_rec.attribute15 := p9_a53;
    ddp_clev_rec.created_by := rosetta_g_miss_num_map(p9_a54);
    ddp_clev_rec.creation_date := rosetta_g_miss_date_in_map(p9_a55);
    ddp_clev_rec.last_updated_by := rosetta_g_miss_num_map(p9_a56);
    ddp_clev_rec.last_update_date := rosetta_g_miss_date_in_map(p9_a57);
    ddp_clev_rec.price_type := p9_a58;
    ddp_clev_rec.currency_code := p9_a59;
    ddp_clev_rec.currency_code_renewed := p9_a60;
    ddp_clev_rec.last_update_login := rosetta_g_miss_num_map(p9_a61);
    ddp_clev_rec.old_sts_code := p9_a62;
    ddp_clev_rec.new_sts_code := p9_a63;
    ddp_clev_rec.old_ste_code := p9_a64;
    ddp_clev_rec.new_ste_code := p9_a65;
    ddp_clev_rec.call_action_asmblr := p9_a66;
    ddp_clev_rec.request_id := rosetta_g_miss_num_map(p9_a67);
    ddp_clev_rec.program_application_id := rosetta_g_miss_num_map(p9_a68);
    ddp_clev_rec.program_id := rosetta_g_miss_num_map(p9_a69);
    ddp_clev_rec.program_update_date := rosetta_g_miss_date_in_map(p9_a70);
    ddp_clev_rec.price_list_id := rosetta_g_miss_num_map(p9_a71);
    ddp_clev_rec.pricing_date := rosetta_g_miss_date_in_map(p9_a72);
    ddp_clev_rec.price_list_line_id := rosetta_g_miss_num_map(p9_a73);
    ddp_clev_rec.line_list_price := rosetta_g_miss_num_map(p9_a74);
    ddp_clev_rec.item_to_price_yn := p9_a75;
    ddp_clev_rec.price_basis_yn := p9_a76;
    ddp_clev_rec.config_header_id := rosetta_g_miss_num_map(p9_a77);
    ddp_clev_rec.config_revision_number := rosetta_g_miss_num_map(p9_a78);
    ddp_clev_rec.config_complete_yn := p9_a79;
    ddp_clev_rec.config_valid_yn := p9_a80;
    ddp_clev_rec.config_top_model_line_id := rosetta_g_miss_num_map(p9_a81);
    ddp_clev_rec.config_item_type := p9_a82;
    ddp_clev_rec.config_item_id := rosetta_g_miss_num_map(p9_a83);
    ddp_clev_rec.cust_acct_id := rosetta_g_miss_num_map(p9_a84);
    ddp_clev_rec.bill_to_site_use_id := rosetta_g_miss_num_map(p9_a85);
    ddp_clev_rec.inv_rule_id := rosetta_g_miss_num_map(p9_a86);
    ddp_clev_rec.line_renewal_type_code := p9_a87;
    ddp_clev_rec.ship_to_site_use_id := rosetta_g_miss_num_map(p9_a88);
    ddp_clev_rec.payment_term_id := rosetta_g_miss_num_map(p9_a89);

    ddp_klev_rec.id := rosetta_g_miss_num_map(p10_a0);
    ddp_klev_rec.object_version_number := rosetta_g_miss_num_map(p10_a1);
    ddp_klev_rec.kle_id := rosetta_g_miss_num_map(p10_a2);
    ddp_klev_rec.sty_id := rosetta_g_miss_num_map(p10_a3);
    ddp_klev_rec.prc_code := p10_a4;
    ddp_klev_rec.fcg_code := p10_a5;
    ddp_klev_rec.nty_code := p10_a6;
    ddp_klev_rec.estimated_oec := rosetta_g_miss_num_map(p10_a7);
    ddp_klev_rec.lao_amount := rosetta_g_miss_num_map(p10_a8);
    ddp_klev_rec.title_date := rosetta_g_miss_date_in_map(p10_a9);
    ddp_klev_rec.fee_charge := rosetta_g_miss_num_map(p10_a10);
    ddp_klev_rec.lrs_percent := rosetta_g_miss_num_map(p10_a11);
    ddp_klev_rec.initial_direct_cost := rosetta_g_miss_num_map(p10_a12);
    ddp_klev_rec.percent_stake := rosetta_g_miss_num_map(p10_a13);
    ddp_klev_rec.percent := rosetta_g_miss_num_map(p10_a14);
    ddp_klev_rec.evergreen_percent := rosetta_g_miss_num_map(p10_a15);
    ddp_klev_rec.amount_stake := rosetta_g_miss_num_map(p10_a16);
    ddp_klev_rec.occupancy := rosetta_g_miss_num_map(p10_a17);
    ddp_klev_rec.coverage := rosetta_g_miss_num_map(p10_a18);
    ddp_klev_rec.residual_percentage := rosetta_g_miss_num_map(p10_a19);
    ddp_klev_rec.date_last_inspection := rosetta_g_miss_date_in_map(p10_a20);
    ddp_klev_rec.date_sold := rosetta_g_miss_date_in_map(p10_a21);
    ddp_klev_rec.lrv_amount := rosetta_g_miss_num_map(p10_a22);
    ddp_klev_rec.capital_reduction := rosetta_g_miss_num_map(p10_a23);
    ddp_klev_rec.date_next_inspection_due := rosetta_g_miss_date_in_map(p10_a24);
    ddp_klev_rec.date_residual_last_review := rosetta_g_miss_date_in_map(p10_a25);
    ddp_klev_rec.date_last_reamortisation := rosetta_g_miss_date_in_map(p10_a26);
    ddp_klev_rec.vendor_advance_paid := rosetta_g_miss_num_map(p10_a27);
    ddp_klev_rec.weighted_average_life := rosetta_g_miss_num_map(p10_a28);
    ddp_klev_rec.tradein_amount := rosetta_g_miss_num_map(p10_a29);
    ddp_klev_rec.bond_equivalent_yield := rosetta_g_miss_num_map(p10_a30);
    ddp_klev_rec.termination_purchase_amount := rosetta_g_miss_num_map(p10_a31);
    ddp_klev_rec.refinance_amount := rosetta_g_miss_num_map(p10_a32);
    ddp_klev_rec.year_built := rosetta_g_miss_num_map(p10_a33);
    ddp_klev_rec.delivered_date := rosetta_g_miss_date_in_map(p10_a34);
    ddp_klev_rec.credit_tenant_yn := p10_a35;
    ddp_klev_rec.date_last_cleanup := rosetta_g_miss_date_in_map(p10_a36);
    ddp_klev_rec.year_of_manufacture := p10_a37;
    ddp_klev_rec.coverage_ratio := rosetta_g_miss_num_map(p10_a38);
    ddp_klev_rec.remarketed_amount := rosetta_g_miss_num_map(p10_a39);
    ddp_klev_rec.gross_square_footage := rosetta_g_miss_num_map(p10_a40);
    ddp_klev_rec.prescribed_asset_yn := p10_a41;
    ddp_klev_rec.date_remarketed := rosetta_g_miss_date_in_map(p10_a42);
    ddp_klev_rec.net_rentable := rosetta_g_miss_num_map(p10_a43);
    ddp_klev_rec.remarket_margin := rosetta_g_miss_num_map(p10_a44);
    ddp_klev_rec.date_letter_acceptance := rosetta_g_miss_date_in_map(p10_a45);
    ddp_klev_rec.repurchased_amount := rosetta_g_miss_num_map(p10_a46);
    ddp_klev_rec.date_commitment_expiration := rosetta_g_miss_date_in_map(p10_a47);
    ddp_klev_rec.date_repurchased := rosetta_g_miss_date_in_map(p10_a48);
    ddp_klev_rec.date_appraisal := rosetta_g_miss_date_in_map(p10_a49);
    ddp_klev_rec.residual_value := rosetta_g_miss_num_map(p10_a50);
    ddp_klev_rec.appraisal_value := rosetta_g_miss_num_map(p10_a51);
    ddp_klev_rec.secured_deal_yn := p10_a52;
    ddp_klev_rec.gain_loss := rosetta_g_miss_num_map(p10_a53);
    ddp_klev_rec.floor_amount := rosetta_g_miss_num_map(p10_a54);
    ddp_klev_rec.re_lease_yn := p10_a55;
    ddp_klev_rec.previous_contract := p10_a56;
    ddp_klev_rec.tracked_residual := rosetta_g_miss_num_map(p10_a57);
    ddp_klev_rec.date_title_received := rosetta_g_miss_date_in_map(p10_a58);
    ddp_klev_rec.amount := rosetta_g_miss_num_map(p10_a59);
    ddp_klev_rec.attribute_category := p10_a60;
    ddp_klev_rec.attribute1 := p10_a61;
    ddp_klev_rec.attribute2 := p10_a62;
    ddp_klev_rec.attribute3 := p10_a63;
    ddp_klev_rec.attribute4 := p10_a64;
    ddp_klev_rec.attribute5 := p10_a65;
    ddp_klev_rec.attribute6 := p10_a66;
    ddp_klev_rec.attribute7 := p10_a67;
    ddp_klev_rec.attribute8 := p10_a68;
    ddp_klev_rec.attribute9 := p10_a69;
    ddp_klev_rec.attribute10 := p10_a70;
    ddp_klev_rec.attribute11 := p10_a71;
    ddp_klev_rec.attribute12 := p10_a72;
    ddp_klev_rec.attribute13 := p10_a73;
    ddp_klev_rec.attribute14 := p10_a74;
    ddp_klev_rec.attribute15 := p10_a75;
    ddp_klev_rec.sty_id_for := rosetta_g_miss_num_map(p10_a76);
    ddp_klev_rec.clg_id := rosetta_g_miss_num_map(p10_a77);
    ddp_klev_rec.created_by := rosetta_g_miss_num_map(p10_a78);
    ddp_klev_rec.creation_date := rosetta_g_miss_date_in_map(p10_a79);
    ddp_klev_rec.last_updated_by := rosetta_g_miss_num_map(p10_a80);
    ddp_klev_rec.last_update_date := rosetta_g_miss_date_in_map(p10_a81);
    ddp_klev_rec.last_update_login := rosetta_g_miss_num_map(p10_a82);
    ddp_klev_rec.date_funding := rosetta_g_miss_date_in_map(p10_a83);
    ddp_klev_rec.date_funding_required := rosetta_g_miss_date_in_map(p10_a84);
    ddp_klev_rec.date_accepted := rosetta_g_miss_date_in_map(p10_a85);
    ddp_klev_rec.date_delivery_expected := rosetta_g_miss_date_in_map(p10_a86);
    ddp_klev_rec.oec := rosetta_g_miss_num_map(p10_a87);
    ddp_klev_rec.capital_amount := rosetta_g_miss_num_map(p10_a88);
    ddp_klev_rec.residual_grnty_amount := rosetta_g_miss_num_map(p10_a89);
    ddp_klev_rec.residual_code := p10_a90;
    ddp_klev_rec.rvi_premium := rosetta_g_miss_num_map(p10_a91);
    ddp_klev_rec.credit_nature := p10_a92;
    ddp_klev_rec.capitalized_interest := rosetta_g_miss_num_map(p10_a93);
    ddp_klev_rec.capital_reduction_percent := rosetta_g_miss_num_map(p10_a94);
    ddp_klev_rec.date_pay_investor_start := rosetta_g_miss_date_in_map(p10_a95);
    ddp_klev_rec.pay_investor_frequency := p10_a96;
    ddp_klev_rec.pay_investor_event := p10_a97;
    ddp_klev_rec.pay_investor_remittance_days := rosetta_g_miss_num_map(p10_a98);


    -- here's the delegated call to the old PL/SQL routine
    okl_service_integration_pvt.update_service_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure create_cov_asset_line(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  as
    ddp_clev_tbl okl_service_integration_pvt.clev_tbl_type;
    ddp_klev_tbl okl_service_integration_pvt.klev_tbl_type;
    ddp_cimv_tbl okl_service_integration_pvt.cimv_tbl_type;
    ddp_cov_tbl okl_service_integration_pvt.srv_cov_tbl_type;
    ddx_clev_tbl okl_service_integration_pvt.clev_tbl_type;
    ddx_klev_tbl okl_service_integration_pvt.klev_tbl_type;
    ddx_cimv_tbl okl_service_integration_pvt.cimv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_service_integration_pvt_w.rosetta_table_copy_in_p21(ddp_cov_tbl, p8_a0
      );
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_service_integration_pvt.create_cov_asset_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_cov_asset_line(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_service_integration_pvt.update_cov_asset_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_service_integration_pvt_w;
