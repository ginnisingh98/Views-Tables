--------------------------------------------------------
--  DDL for Package Body OE_1PC2_LINE_SHIPA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_1PC2_LINE_SHIPA" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_status_code varchar2(8) :='NOTIFIED';
  ...
  WHERE   a.HEADER_ID =  OE_HEADER_SECURITY.g_record.HEADER_ID
                         )
;
