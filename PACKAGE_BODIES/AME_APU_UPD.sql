--------------------------------------------------------
--  DDL for Package Body AME_APU_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_APU_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_apu_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
 ...
 ,p_action_type_id =>  p_rec.action_type_id
    ...
    --
    --
    -- Update the ame_approver_type_usages Row
    --
...
Begin
  ...
  begin
    ...
    ame_apu_rku.after_update
      ...
      => p_rec.object_version_number
      ,p_start_date_o
      => ame_apu_shd.g_old_rec.start_date
      ,p_end_date_o
      => ame_apu_shd.g_old_rec.end_date
      ,p_object_version_number_o
      => ame_apu_shd.g_old_rec.object_version_number
      );
    --
  exception
    --
...
Begin
 ...
 ,p_action_type_id =>  p_rec.action_type_id
  ...
  --
  ame_apu_upd.convert_defs(p_rec);
  --
  ame_apu_bus.update_validate
    (p_rec                              => p_rec
    ,p_effective_date                   => p_effective_date
    ,p_datetrack_mode                   => p_datetrack_mode
    ,p_validation_start_date            => l_validation_start_date
