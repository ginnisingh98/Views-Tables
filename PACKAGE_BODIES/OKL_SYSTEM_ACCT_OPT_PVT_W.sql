--------------------------------------------------------
--  DDL for Package Body OKL_SYSTEM_ACCT_OPT_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SYSTEM_ACCT_OPT_PVT_W" as
  /* $Header: OKLESAOB.pls 120.5.12010000.3 2009/06/02 10:33:40 racheruv ship $ */
  ...
  as
    ddx_saov_rec okl_system_acct_opt_pvt.saov_rec_type;
  ...
  begin
    ...
    okl_system_acct_opt_pvt.get_system_acct_opt(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_saov_rec okl_system_acct_opt_pvt.saov_rec_type;
    ddx_saov_rec okl_system_acct_opt_pvt.saov_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_system_acct_opt_pvt.updt_system_acct_opt(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
