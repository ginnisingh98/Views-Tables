--------------------------------------------------------
--  DDL for Package Body BEN_CLF_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CLF_RKI" as
...
begin
hr_utility.set_location('Entering: ben_clf_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_clf_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_clf_RKI;
