--------------------------------------------------------
--  DDL for Package Body BEN_GOOD_SVC_TYPE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_GOOD_SVC_TYPE_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_GOOD_SVC_TYPE_BK1.CREATE_GOOD_SVC_TYPE_A', 10);
hr_utility.set_location(' Leaving: BEN_GOOD_SVC_TYPE_BK1.CREATE_GOOD_SVC_TYPE_A', 20);
end CREATE_GOOD_SVC_TYPE_A;
...
begin
hr_utility.set_location('Entering: BEN_GOOD_SVC_TYPE_BK1.CREATE_GOOD_SVC_TYPE_B', 10);
hr_utility.set_location(' Leaving: BEN_GOOD_SVC_TYPE_BK1.CREATE_GOOD_SVC_TYPE_B', 20);
end CREATE_GOOD_SVC_TYPE_B;
