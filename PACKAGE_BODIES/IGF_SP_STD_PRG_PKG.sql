--------------------------------------------------------
--  DDL for Package Body IGF_SP_STD_PRG_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_SP_STD_PRG_PKG" AS
/* $Header: IGFPI06B.pls 115.2 2003/03/19 08:50:40 smadathi noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_sp_std_prg_all%ROWTYPE;
  new_references igf_sp_std_prg_all%ROWTYPE;
  ...
  */
  BEGIN
    ...
    IF (((old_references.fee_cls_id = new_references.fee_cls_id)) OR
      ...
      NULL;
    ELSIF NOT igf_sp_std_fc_pkg.get_pk_for_validation (
                new_references.fee_cls_id
              ) THEN
      fnd_message.set_name ('FND', 'FORM_RECORD_DELETED');
      igs_ge_msg_stack.add;
  ...
  */
  BEGIN
    ...
    igf_sp_std_unit_pkg.get_fk_igf_sp_std_prg (
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_SP_STDP_SDFC_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_SP_STDP_CRV_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igf_sp_std_prg_s.NEXTVAL
    ...
    INSERT INTO igf_sp_std_prg_all (
      fee_cls_prg_id,
      fee_cls_id,
      course_cd,
      version_number,
  ...
  */
  BEGIN
    ...
    DELETE FROM igf_sp_std_prg_all
    WHERE rowid = x_rowid;
