--------------------------------------------------------
--  DDL for Package Body BEN_PRMRY_CARE_PRVDR_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PRMRY_CARE_PRVDR_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_PRMRY_CARE_PRVDR_BK2.UPDATE_PRMRY_CARE_PRVDR_A', 10);
hr_utility.set_location(' Leaving: BEN_PRMRY_CARE_PRVDR_BK2.UPDATE_PRMRY_CARE_PRVDR_A', 20);
end UPDATE_PRMRY_CARE_PRVDR_A;
...
begin
hr_utility.set_location('Entering: BEN_PRMRY_CARE_PRVDR_BK2.UPDATE_PRMRY_CARE_PRVDR_B', 10);
hr_utility.set_location(' Leaving: BEN_PRMRY_CARE_PRVDR_BK2.UPDATE_PRMRY_CARE_PRVDR_B', 20);
end UPDATE_PRMRY_CARE_PRVDR_B;
