--------------------------------------------------------
--  DDL for Package Body BEN_ELS_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELS_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_els_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.elig_los_prte_id       = p_rec.elig_los_prte_id
    and    t.effective_start_date =
             ben_els_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_elig_los_prte_f.created_by%TYPE;
  l_creation_date       ben_elig_los_prte_f.creation_date%TYPE;
  l_last_update_date   	ben_elig_los_prte_f.last_update_date%TYPE;
  l_last_updated_by     ben_elig_los_prte_f.last_updated_by%TYPE;
  l_last_update_login   ben_elig_los_prte_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_elig_los_prte_f
  --
  insert into ben_elig_los_prte_f
  (	elig_los_prte_id,
...
--
  cursor c1 is
    select ben_elig_los_prte_f_s.nextval
    from sys.dual;
--
--
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.elig_los_prte_id;
  close c1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_els_rec
  ...
  --
  p_elig_los_prte_id        	:= l_rec.elig_los_prte_id;
