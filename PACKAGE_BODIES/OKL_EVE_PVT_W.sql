--------------------------------------------------------
--  DDL for Package Body OKL_EVE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_EVE_PVT_W" as
  /* $Header: OKLIEVEB.pls 120.0 2005/07/07 10:39:26 viselvar noship $ */
  procedure rosetta_table_copy_in_p1(t out nocopy okl_eve_pvt.okl_eve_tbl, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        ddindx := 1;
        while true loop
          t(ddindx).end_of_term_ver_id := a0(indx);
          ...
          t(ddindx).end_of_term_id := a6(indx);
  ...
  procedure rosetta_table_copy_out_p1(t okl_eve_pvt.okl_eve_tbl, a0 out nocopy JTF_NUMBER_TABLE
  ...
  if t is null or t.count = 0 then
    ...
    a27 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        indx := 1;
        while true loop
          a0(indx) := t(ddindx).end_of_term_ver_id;
          ...
          a6(indx) := t(ddindx).end_of_term_id;
  ...
  as
    ddp_eve_rec okl_eve_pvt.okl_eve_rec;
    ddx_eve_rec okl_eve_pvt.okl_eve_rec;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_eve_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a0 := ddx_eve_rec.end_of_term_ver_id;
    p6_a1 := ddx_eve_rec.object_version_number;
    p6_a2 := ddx_eve_rec.version_number;
    p6_a3 := ddx_eve_rec.effective_from_date;
    p6_a4 := ddx_eve_rec.effective_to_date;
    p6_a5 := ddx_eve_rec.sts_code;
    p6_a6 := ddx_eve_rec.end_of_term_id;
    p6_a7 := ddx_eve_rec.attribute_category;
    p6_a8 := ddx_eve_rec.attribute1;
    p6_a9 := ddx_eve_rec.attribute2;
    p6_a10 := ddx_eve_rec.attribute3;
    p6_a11 := ddx_eve_rec.attribute4;
    p6_a12 := ddx_eve_rec.attribute5;
    p6_a13 := ddx_eve_rec.attribute6;
    p6_a14 := ddx_eve_rec.attribute7;
    p6_a15 := ddx_eve_rec.attribute8;
    p6_a16 := ddx_eve_rec.attribute9;
    p6_a17 := ddx_eve_rec.attribute10;
    p6_a18 := ddx_eve_rec.attribute11;
    p6_a19 := ddx_eve_rec.attribute12;
    p6_a20 := ddx_eve_rec.attribute13;
    p6_a21 := ddx_eve_rec.attribute14;
    p6_a22 := ddx_eve_rec.attribute15;
    p6_a23 := ddx_eve_rec.created_by;
    p6_a24 := ddx_eve_rec.creation_date;
    p6_a25 := ddx_eve_rec.last_updated_by;
    p6_a26 := ddx_eve_rec.last_update_date;
    p6_a27 := ddx_eve_rec.last_update_login;
  end;
  ...
  as
    ddp_eve_tbl okl_eve_pvt.okl_eve_tbl;
    ddx_eve_tbl okl_eve_pvt.okl_eve_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_eve_pvt_w.rosetta_table_copy_in_p1(ddp_eve_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_eve_pvt_w.rosetta_table_copy_out_p1(ddx_eve_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_eve_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_eve_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
