--------------------------------------------------------
--  DDL for Package Body IGS_PS_NOTE_TYPES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_PS_NOTE_TYPES_PKG" AS
/* $Header: IGSPI1KB.pls 115.7 2002/11/29 02:07:30 nsidana ship $ */
  l_rowid VARCHAR2(25);
  old_references igs_ps_note_types%RowType;
  new_references igs_ps_note_types%RowType;
  ...
  ***************************************************************/
  ...
  BEGIN
    ...
    Igs_Ps_Catlg_Notes_Pkg.Get_FK_Igs_Ps_Note_Types (
      old_references.note_type_id
      );
  ...
  ***************************************************************/
    ...
    CURSOR cur_rowid IS
      ...
      AND      note_type = x_note_type 	and      ((l_rowid is null) or (rowid <> l_rowid))
    ...
    IF (p_action = 'INSERT') THEN
      ...
      Null;
	     IF Get_Pk_For_Validation(
    		new_references.note_type_id)  THEN
	       Fnd_Message.Set_name('IGS','IGS_GE_RECORD_ALREADY_EXISTS');
      IGS_GE_MSG_STACK.ADD;
	       App_Exception.Raise_Exception;
	     END IF;
...
l_rowid:=NULL;
  ...
  ***************************************************************/
    ...
    cursor C is select ROWID from IGS_PS_NOTE_TYPES
             where                 NOTE_TYPE_ID= X_NOTE_TYPE_ID
;
 ...
 begin
     X_LAST_UPDATE_DATE := SYSDATE;
      ...
      IGS_GE_MSG_STACK.ADD;
          ...
          ----
       SELECT igs_ps_note_types_s.nextval
       INTO x_NOTE_TYPE_ID
       FROM  dual;
       ---
 ...
 procedure LOCK_ROW (
      X_ROWID in  VARCHAR2,
       ...
       x_DESCRIPTION IN VARCHAR2,
       x_CLOSED_IND IN VARCHAR2,
       x_CATALOG_SCHEDULE IN VARCHAR2  ) AS
  /*************************************************************
  Created By :
  Date Created By :
  Purpose :
...
begin
  ...
  close c1;
if ( (  tlinfo.NOTE_TYPE = X_NOTE_TYPE)
  ...
  ***************************************************************/
    ...
    cursor c1 is select ROWID from IGS_PS_NOTE_TYPES
             where     NOTE_TYPE_ID= X_NOTE_TYPE_ID
;
begin
	open c1;
