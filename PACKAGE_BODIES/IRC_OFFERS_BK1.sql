--------------------------------------------------------
--  DDL for Package Body IRC_OFFERS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_OFFERS_BK1" as
...
begin
hr_utility.set_location('Entering: IRC_OFFERS_BK1.CREATE_OFFER_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
irc_offers_be1.CREATE_OFFER_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_OFFER', 'AP');
hr_utility.set_location(' Leaving: IRC_OFFERS_BK1.CREATE_OFFER_A', 20);
end CREATE_OFFER_A;
...
begin
hr_utility.set_location('Entering: IRC_OFFERS_BK1.CREATE_OFFER_B', 10);
hr_utility.set_location(' Leaving: IRC_OFFERS_BK1.CREATE_OFFER_B', 20);
end CREATE_OFFER_B;
end IRC_OFFERS_BK1;
