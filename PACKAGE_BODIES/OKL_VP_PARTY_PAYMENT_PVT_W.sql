--------------------------------------------------------
--  DDL for Package Body OKL_VP_PARTY_PAYMENT_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_VP_PARTY_PAYMENT_PVT_W" as
  /* $Header: OKLEVPDB.pls 120.0 2005/10/21 01:06:56 manumanu noship $ */
  procedure create_party_pymnt_dtls(p_api_version  NUMBER
  ...
  as
    ddp_srfvv_rec okl_vp_party_payment_pvt.srfvv_rec_type;
    ddx_srfvv_rec okl_vp_party_payment_pvt.srfvv_rec_type;
  ...
  begin
    ...
    ddp_srfvv_rec.id := p5_a0;
    ddp_srfvv_rec.object_version_number := p5_a1;
    ddp_srfvv_rec.cpl_id := p5_a2;
    ddp_srfvv_rec.vendor_id := p5_a3;
    ddp_srfvv_rec.pay_site_id := p5_a4;
    ddp_srfvv_rec.payment_term_id := p5_a5;
    ddp_srfvv_rec.payment_method_code := p5_a6;
    ddp_srfvv_rec.pay_group_code := p5_a7;
    ddp_srfvv_rec.payment_hdr_id := p5_a8;
    ddp_srfvv_rec.payment_start_date := p5_a9;
    ddp_srfvv_rec.payment_frequency := p5_a10;
    ddp_srfvv_rec.remit_days := p5_a11;
    ddp_srfvv_rec.disbursement_basis := p5_a12;
    ddp_srfvv_rec.disbursement_fixed_amount := p5_a13;
    ddp_srfvv_rec.disbursement_percent := p5_a14;
    ddp_srfvv_rec.processing_fee_basis := p5_a15;
    ddp_srfvv_rec.processing_fee_fixed_amount := p5_a16;
    ddp_srfvv_rec.processing_fee_percent := p5_a17;
    ...
    ddp_srfvv_rec.created_by := p5_a35;
    ddp_srfvv_rec.creation_date := p5_a36;
    ddp_srfvv_rec.last_updated_by := p5_a37;
    ddp_srfvv_rec.last_update_date := p5_a38;
    ddp_srfvv_rec.last_update_login := p5_a39;


    -- here's the delegated call to the old PL/SQL routine
    okl_vp_party_payment_pvt.create_party_pymnt_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a0 := ddx_srfvv_rec.id;
    p6_a1 := ddx_srfvv_rec.object_version_number;
    p6_a2 := ddx_srfvv_rec.cpl_id;
    p6_a3 := ddx_srfvv_rec.vendor_id;
    p6_a4 := ddx_srfvv_rec.pay_site_id;
    p6_a5 := ddx_srfvv_rec.payment_term_id;
    p6_a6 := ddx_srfvv_rec.payment_method_code;
    p6_a7 := ddx_srfvv_rec.pay_group_code;
    p6_a8 := ddx_srfvv_rec.payment_hdr_id;
    p6_a9 := ddx_srfvv_rec.payment_start_date;
    p6_a10 := ddx_srfvv_rec.payment_frequency;
    p6_a11 := ddx_srfvv_rec.remit_days;
    p6_a12 := ddx_srfvv_rec.disbursement_basis;
    p6_a13 := ddx_srfvv_rec.disbursement_fixed_amount;
    p6_a14 := ddx_srfvv_rec.disbursement_percent;
    p6_a15 := ddx_srfvv_rec.processing_fee_basis;
    p6_a16 := ddx_srfvv_rec.processing_fee_fixed_amount;
    p6_a17 := ddx_srfvv_rec.processing_fee_percent;
    ...
    p6_a35 := ddx_srfvv_rec.created_by;
    p6_a36 := ddx_srfvv_rec.creation_date;
    p6_a37 := ddx_srfvv_rec.last_updated_by;
    p6_a38 := ddx_srfvv_rec.last_update_date;
    p6_a39 := ddx_srfvv_rec.last_update_login;
  end;
  ...
  as
    ddp_srfvv_tbl okl_vp_party_payment_pvt.srfvv_tbl_type;
    ddx_srfvv_tbl okl_vp_party_payment_pvt.srfvv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_party_pymnt_dtls(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_vp_party_payment_pvt.lock_party_pymnt_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_party_pymnt_dtls(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_vp_party_payment_pvt.update_party_pymnt_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_party_pymnt_dtls(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_vp_party_payment_pvt.delete_party_pymnt_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_party_pymnt_dtls(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_vp_party_payment_pvt.validate_party_pymnt_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_vp_party_payment_pvt_w;
