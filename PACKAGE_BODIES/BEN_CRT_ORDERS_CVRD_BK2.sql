--------------------------------------------------------
--  DDL for Package Body BEN_CRT_ORDERS_CVRD_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CRT_ORDERS_CVRD_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_CRT_ORDERS_CVRD_BK2.UPDATE_CRT_ORDERS_CVRD_A', 10);
hr_utility.set_location(' Leaving: BEN_CRT_ORDERS_CVRD_BK2.UPDATE_CRT_ORDERS_CVRD_A', 20);
end UPDATE_CRT_ORDERS_CVRD_A;
...
begin
hr_utility.set_location('Entering: BEN_CRT_ORDERS_CVRD_BK2.UPDATE_CRT_ORDERS_CVRD_B', 10);
hr_utility.set_location(' Leaving: BEN_CRT_ORDERS_CVRD_BK2.UPDATE_CRT_ORDERS_CVRD_B', 20);
end UPDATE_CRT_ORDERS_CVRD_B;
