--------------------------------------------------------
--  DDL for Package Body PER_PDP_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PDP_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_pdp_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the per_periods_of_placement Row
  --
...
Begin
  ...
  --
  per_pdp_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  per_pdp_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  per_pdp_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
...
Begin
  ...
  -- To prevent confusion, period_of_placement_id is not passed in upd
