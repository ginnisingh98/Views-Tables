--------------------------------------------------------
--  DDL for Package Body PO_REQ_VARIANCE_ACCOUNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PO_REQ_VARIANCE_ACCOUNT" AS
/* $Header: POXWFB8B.pls 115.4 2002/11/25 21:48:35 sbull ship $*/
...
BEGIN
  ...
  FND_MESSAGE.SET_TOKEN('FUNC', 'PO_REQ_VARIANCE_ACCOUNT');
  FB_ERROR_MSG := FND_MESSAGE.GET_ENCODED;
  RETURN FALSE;
END;

END PO_REQ_VARIANCE_ACCOUNT;
