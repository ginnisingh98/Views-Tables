--------------------------------------------------------
--  DDL for Package Body PSP_ELEMENT_TYPE_ACCOUNTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_ELEMENT_TYPE_ACCOUNTS_PKG" as
 /* $Header: PSPSUEAB.pls 115.7 2002/11/18 08:31:55 lveerubh ship $ */
...
procedure INSERT_ROW (
  ...
  X_POETA_END_DATE   in DATE DEFAULT NULL
    ...
    cursor C is select ROWID from PSP_ELEMENT_TYPE_ACCOUNTS
      where ELEMENT_ACCOUNT_ID = X_ELEMENT_ACCOUNT_ID
...
begin
  ...
  insert into PSP_ELEMENT_TYPE_ACCOUNTS (
    ELEMENT_ACCOUNT_ID,
    ELEMENT_TYPE_ID,
    START_DATE_ACTIVE,
    END_DATE_ACTIVE,
...
procedure LOCK_ROW (
  ...
  cursor c1 is select
    ...
    and BUSINESS_GROUP_ID = X_BUSINESS_GROUP_ID
    and SET_OF_BOOKS_ID = X_SET_OF_BOOKS_ID
    for update of ELEMENT_ACCOUNT_ID nowait;
  tlinfo c1%rowtype;
...
begin
  ...
  if ( (tlinfo.ELEMENT_TYPE_ID = X_ELEMENT_TYPE_ID)
...
begin
  ...
  update PSP_ELEMENT_TYPE_ACCOUNTS set
...
procedure ADD_ROW (
  ...
  cursor c1 is select rowid from PSP_ELEMENT_TYPE_ACCOUNTS
     where ELEMENT_ACCOUNT_ID = X_ELEMENT_ACCOUNT_ID
     and BUSINESS_GROUP_ID = X_BUSINESS_GROUP_ID
     and SET_OF_BOOKS_ID = X_SET_OF_BOOKS_ID
  ;
...
begin
  delete from PSP_ELEMENT_TYPE_ACCOUNTS
  where ELEMENT_ACCOUNT_ID = X_ELEMENT_ACCOUNT_ID
  and BUSINESS_GROUP_ID = X_BUSINESS_GROUP_ID
  and SET_OF_BOOKS_ID = X_SET_OF_BOOKS_ID;
  if (sql%notfound) then
