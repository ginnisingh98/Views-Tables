--------------------------------------------------------
--  DDL for Package Body PAY_ROM_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ROM_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_rom_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          pay_run_type_org_methods_f.created_by%TYPE;
  l_creation_date       pay_run_type_org_methods_f.creation_date%TYPE;
...
Begin
  ...
  --
  --
  -- Insert the row into: pay_run_type_org_methods_f
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.run_type_org_method_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  begin
    ...
    --
    create_app_ownerships('RUN_TYPE_ORG_METHOD_ID', p_rec.run_type_org_method_id);
    --
...
Begin
  ...
  --
  p_run_type_org_method_id           := l_rec.run_type_org_method_id;
