--------------------------------------------------------
--  DDL for Package Body PAY_STA_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_STA_BK2" as
...
begin
hr_utility.set_location('Entering: PAY_STA_BK2.UPDATE_STATE_TAX_RULE_A', 10);
hr_utility.set_location(' Leaving: PAY_STA_BK2.UPDATE_STATE_TAX_RULE_A', 20);
end UPDATE_STATE_TAX_RULE_A;
...
begin
hr_utility.set_location('Entering: PAY_STA_BK2.UPDATE_STATE_TAX_RULE_B', 10);
hr_utility.set_location(' Leaving: PAY_STA_BK2.UPDATE_STATE_TAX_RULE_B', 20);
end UPDATE_STATE_TAX_RULE_B;
end PAY_STA_BK2;
