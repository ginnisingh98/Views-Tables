--------------------------------------------------------
--  DDL for Package Body OE_1025PC2_LINE_BRANCH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_1025PC2_LINE_BRANCH" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_name varchar2(30) :='BRANCH_ON_SOURCE_TYPE';
