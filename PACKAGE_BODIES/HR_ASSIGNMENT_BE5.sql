--------------------------------------------------------
--  DDL for Package Body HR_ASSIGNMENT_BE5
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ASSIGNMENT_BE5" as 
...
p_supervisor_assignment_id     number) is
  ...
  --
  l_proc varchar2(72):='  hr_assignment_be5.update_apl_asg_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.assignment.update_apl_asg';
...
end update_apl_asg_a;
end hr_assignment_be5;
