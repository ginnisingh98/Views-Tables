--------------------------------------------------------
--  DDL for Package Body BIM_MCHACQ_IND_TEMP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BIM_MCHACQ_IND_TEMP_PVT" AS
/* $Header: bimvnqib.pls 115.2 2000/03/03 20:36:20 pkm ship  $ */
