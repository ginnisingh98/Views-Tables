--------------------------------------------------------
--  DDL for Package Body OTA_CPE_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CPE_RKI" as
...
begin
hr_utility.set_location('Entering: OTA_CPE_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: OTA_CPE_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end OTA_CPE_RKI;
