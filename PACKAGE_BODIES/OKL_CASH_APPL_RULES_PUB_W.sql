--------------------------------------------------------
--  DDL for Package Body OKL_CASH_APPL_RULES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CASH_APPL_RULES_PUB_W" as
  /* $Header: OKLUCAPB.pls 120.3 2007/08/02 15:52:59 nikshah ship $ */
  ...
  begin
    ...
    okl_cash_appl_rules_pub.okl_cash_applic(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_cash_appl_rules_pub.create_manual_receipt(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
