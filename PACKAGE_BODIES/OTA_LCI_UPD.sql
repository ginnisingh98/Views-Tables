--------------------------------------------------------
--  DDL for Package Body OTA_LCI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_LCI_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_lci_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the ota_lp_cat_inclusions Row
  --
  update ota_lp_cat_inclusions
    set
...
Begin
  ...
  --
  ota_lci_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_lci_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_lci_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
