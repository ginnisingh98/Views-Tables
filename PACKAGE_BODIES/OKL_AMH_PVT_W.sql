--------------------------------------------------------
--  DDL for Package Body OKL_AMH_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AMH_PVT_W" as
  /* $Header: OKLIAMHB.pls 115.3 2004/06/01 23:47:40 gkadarka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_amh_pvt.amhv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).hold_period_days := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).category_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).book_type_code := a4(indx);
          t(ddindx).method_id := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).deprn_rate := rosetta_g_miss_num_map(a6(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_amh_pvt.amhv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a12 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).hold_period_days);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).category_id);
          a4(indx) := t(ddindx).book_type_code;
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).method_id);
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).deprn_rate);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_amh_pvt.amh_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_VARCHAR2_TABLE_100
  ...
  procedure rosetta_table_copy_out_p5(t okl_amh_pvt.amh_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    , a3 out nocopy JTF_NUMBER_TABLE
    , a4 out nocopy JTF_VARCHAR2_TABLE_100
  ...
  as
    ddp_amhv_rec okl_amh_pvt.amhv_rec_type;
    ddx_amhv_rec okl_amh_pvt.amhv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_amh_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_amhv_tbl okl_amh_pvt.amhv_tbl_type;
    ddx_amhv_tbl okl_amh_pvt.amhv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_amh_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_amh_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_amh_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_amh_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
