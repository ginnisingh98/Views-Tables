--------------------------------------------------------
--  DDL for Package Body PV_ENTYROUT_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PV_ENTYROUT_PUB" as
/* $Header: pvrpertb.pls 120.0 2005/05/27 16:23:46 appldev noship $ */
-- Start of Comments
...
G_PKG_NAME CONSTANT VARCHAR2(30):= 'PV_ENTYROUT_PUB';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'pvrpertb.pls';
...
l_api_version_number      CONSTANT NUMBER   := 2.0;
 BEGIN
    ...
    -- Calling Private package: Create_ENTYROUT
      PV_entyrout_PVT.Create_entyrout(
         ...
         X_ENTITY_ROUTING_ID          => x_ENTITY_ROUTING_ID,
...
l_api_version_number      CONSTANT NUMBER   := 2.0;
 BEGIN
    ...
    PV_entyrout_PVT.Update_entyrout(
       P_Api_Version_Number         => 2.0,
       P_Init_Msg_List              => FND_API.G_FALSE,
       P_Commit                     => p_commit,
       P_Validation_Level           => P_Validation_Level,
