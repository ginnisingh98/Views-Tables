--------------------------------------------------------
--  DDL for Package Body HR_AE_UTILITY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_AE_UTILITY" AS
 /* $Header: hraeutil.pkb 120.0 2005/09/10 03:56:34 psnellin noship $ */
 --
 --
 -- Formats the full name for the UAE legislation.
 --
 FUNCTION per_ae_full_name
