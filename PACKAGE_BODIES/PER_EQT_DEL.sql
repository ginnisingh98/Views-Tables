--------------------------------------------------------
--  DDL for Package Body PER_EQT_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_EQT_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_eqt_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_dml(p_rec in per_eqt_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Delete the per_qualification_types row.
  --
  delete from per_qualification_types
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in per_eqt_shd.g_rec_type) is
--
...
-- ----------------------------------------------------------------------------
-- mvankada
-- Passed Developer DF columns as arguments to the procedure after_delete

Procedure post_delete(p_rec in per_eqt_shd.g_rec_type
                      ) is
--
...
Begin
  ...
  begin
    per_eqt_rkd.after_delete
     (p_qualification_type_id     => p_rec.qualification_type_id
     ,p_object_version_number     => per_eqt_shd.g_old_rec.object_version_number
...
Procedure del
  (
  p_rec	      in per_eqt_shd.g_rec_type
...
Begin
  ...
  --
  per_eqt_bus.delete_validate(p_rec);
  --
