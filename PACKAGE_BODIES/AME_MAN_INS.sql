--------------------------------------------------------
--  DDL for Package Body AME_MAN_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_MAN_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_man_ins.';  -- Global package name
--
...
Begin
  ...
  --
  ame_man_ins.g_attribute_id_i := p_attribute_id;
  ame_man_ins.g_action_type_id_i := p_action_type_id;
  --
...
--
  Cursor C_Sel1 Is
    select t.creation_date
      from ame_mandatory_attributes t
     where t.attribute_id = p_rec.attribute_id
 and    t.action_type_id = p_rec.action_type_id
       and t.start_date = ame_man_shd.g_old_rec.start_date
...
--
  ...
  l_created_by          ame_mandatory_attributes.created_by%TYPE;
  l_creation_date       ame_mandatory_attributes.creation_date%TYPE;
  l_last_update_date    ame_mandatory_attributes.last_update_date%TYPE;
  l_last_updated_by     ame_mandatory_attributes.last_updated_by%TYPE;
  l_last_update_login   ame_mandatory_attributes.last_update_login%TYPE;
...
Begin
  ...
  p_rec.object_version_number :=
   ame_man_shd.get_object_version_number
 ...
 ,p_action_type_id =>  p_rec.action_type_id
  ...
  --
  --
  -- Insert the row into: ame_mandatory_attributes
  --
...
--
--  Cursor C_Sel1 is select ame_mandatory_attributes_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from ame_mandatory_attributes
     where attribute_id =
             ame_man_ins.g_attribute_id_i
       and action_type_id =
             ame_man_ins.g_action_type_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (ame_man_ins.g_attribute_id_i is not null or
      ame_man_ins.g_action_type_id_i is not null) Then
    --
    ...
    p_rec.attribute_id :=
      ame_man_ins.g_attribute_id_i;
    ame_man_ins.g_attribute_id_i := null;
    p_rec.action_type_id :=
      ame_man_ins.g_action_type_id_i;
    ame_man_ins.g_action_type_id_i := null;
  End If;
    --
