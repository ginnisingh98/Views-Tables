--------------------------------------------------------
--  DDL for Package Body HR_AE_CONTACT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_AE_CONTACT_API" as
/* $Header: peconaei.pkb 120.3.12000000.1 2007/01/21 21:24:44 appldev ship $ */
--
	-- Package Variables
   g_package  varchar2(33) := 'hr_ae_contact_api';
