--------------------------------------------------------
--  DDL for Package Body BEN_PYD_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PYD_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pyd_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_ptip_dpnt_cvg_ctfn_f.created_by%TYPE;
  l_creation_date       ben_ptip_dpnt_cvg_ctfn_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_ptip_dpnt_cvg_ctfn_f
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ptip_dpnt_cvg_ctfn_id;
  Close C_Sel1;
  --   --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_pyd_rec
  ...
  --
  p_ptip_dpnt_cvg_ctfn_id        	:= l_rec.ptip_dpnt_cvg_ctfn_id;
