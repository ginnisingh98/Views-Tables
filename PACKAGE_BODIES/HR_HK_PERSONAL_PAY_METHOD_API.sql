--------------------------------------------------------
--  DDL for Package Body HR_HK_PERSONAL_PAY_METHOD_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_HK_PERSONAL_PAY_METHOD_API" AS
/* $Header: hrhkwrpm.pkb 115.3 2002/12/09 09:57:50 vgsriniv ship $ */
--
g_package  VARCHAR2(33) := 'hr_hk_personal_pay_method_api.';
--
-- ----------------------------------------------------------------------------
...
PROCEDURE check_hk_insert_legislation
  ...
  c_leg_code            CONSTANT VARCHAR2(2) := 'HK';
  --
  CURSOR legsel IS
...
PROCEDURE create_hk_personal_pay_method
  ...
  -- Declare cursors and local variables
  --
  l_proc                VARCHAR2(72) := g_package||'create_hk_personal_pay_method';
  l_valid               VARCHAR2(150);
  l_effective_date      DATE;
  --
BEGIN
  ...
  --
  hr_utility.set_location(' Leaving:'||l_proc, 8);
END create_hk_personal_pay_method;
-- ----------------------------------------------------------------------------
