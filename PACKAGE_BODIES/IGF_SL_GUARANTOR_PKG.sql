--------------------------------------------------------
--  DDL for Package Body IGF_SL_GUARANTOR_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_SL_GUARANTOR_PKG" AS
/* $Header: IGFLI03B.pls 115.7 2003/10/14 06:45:38 sjadhav ship $ */

  l_rowid VARCHAR2(25);
  old_references igf_sl_guarantor%ROWTYPE;
  new_references igf_sl_guarantor%ROWTYPE;
  ...
  */
  BEGIN
    ...
    igf_sl_cl_recipient_pkg.get_fk_igf_sl_guarantor (
      old_references.guarantor_id
    );
  ...
  */
  ...
  ||  Change History :
  ||  Who             When            What
  ||  veramach        3-SEP-2003      1.Added p_action checks for UPDATE
  ||  (reverse chronological order - newest change first)
  */
  BEGIN
