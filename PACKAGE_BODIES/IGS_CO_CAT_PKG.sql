--------------------------------------------------------
--  DDL for Package Body IGS_CO_CAT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_CO_CAT_PKG" AS
/* $Header: IGSLI02B.pls 115.5 2002/11/29 01:02:31 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_co_cat%ROWTYPE;
  new_references igs_co_cat%ROWTYPE;
  ...
  */
  BEGIN
    ...
    igs_co_cat_itm_pkg.get_fk_igs_co_cat (
      old_references.correspondence_cat
    );

    igs_co_cat_map_pkg.get_fk_igs_co_cat (
      old_references.correspondence_cat
    );
