--------------------------------------------------------
--  DDL for Package Body PE_POI_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PE_POI_RKU" as
...
begin
hr_utility.set_location('Entering: PE_POI_RKU.AFTER_UPDATE', 10);
...
hr_api.validate_commit_unit(l_commit_unit_number, 'PER_POSITION_EXTRA_INFO', 'AU');
hr_utility.set_location(' Leaving: PE_POI_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PE_POI_RKU;
