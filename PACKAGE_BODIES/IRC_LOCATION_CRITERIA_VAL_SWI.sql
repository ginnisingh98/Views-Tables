--------------------------------------------------------
--  DDL for Package Body IRC_LOCATION_CRITERIA_VAL_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_LOCATION_CRITERIA_VAL_SWI" As
/* $Header: irlcvswi.pkb 120.0 2005/10/03 14:58 rbanda noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'irc_location_criteria_val_swi.';
--
-- ----------------------------------------------------------------------------
...
PROCEDURE create_location_criteria
  ...
  --
  -- Other variables
  l_location_criteria_value_id   number;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_location_criteria_swi;
  --
  ...
  --
  irc_lcv_ins.set_base_key_value
    (p_location_criteria_value_id => p_location_criteria_value_id
    );
  --
  -- Call API
  --
  irc_location_criteria_val_api.create_location_criteria
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_location_criteria_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_location_criteria_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  irc_location_criteria_val_api.delete_location_criteria
    (p_validate                     => l_validate
    ,p_location_criteria_value_id   => p_location_criteria_value_id
    ,p_object_version_number        => p_object_version_number
    );
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_location_criteria_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
