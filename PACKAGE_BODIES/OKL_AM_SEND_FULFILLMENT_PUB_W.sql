--------------------------------------------------------
--  DDL for Package Body OKL_AM_SEND_FULFILLMENT_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_SEND_FULFILLMENT_PUB_W" as
  /* $Header: OKLUSFWB.pls 115.9 2002/12/13 19:38:28 gkadarka noship $ */
  ...
  as
    ddp_send_rec okl_am_send_fulfillment_pub.full_rec_type;
    ddx_send_rec okl_am_send_fulfillment_pub.full_rec_type;
  ...
  begin
    ...
    okl_am_send_fulfillment_pub.send_fulfillment(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_send_tbl okl_am_send_fulfillment_pub.full_tbl_type;
    ddx_send_tbl okl_am_send_fulfillment_pub.full_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  as
    ddp_party_tbl okl_am_send_fulfillment_pub.q_party_uv_tbl_type;
    ddx_party_tbl okl_am_send_fulfillment_pub.q_party_uv_tbl_type;
    ddp_qtev_rec okl_am_send_fulfillment_pub.qtev_rec_type;
    ddx_qtev_rec okl_am_send_fulfillment_pub.qtev_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_send_fulfillment_pub.send_terminate_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_send_fulfillment_pub.send_repurchase_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_send_fulfillment_pub.send_restructure_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_send_fulfillment_pub.send_consolidate_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_am_send_fulfillment_pub_w;
