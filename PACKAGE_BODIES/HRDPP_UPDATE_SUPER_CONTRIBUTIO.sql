--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_SUPER_CONTRIBUTIO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_SUPER_CONTRIBUTIO" as
/*
...
,P_ELEMENT_ENTRY_USER_KEY in varchar2) is
...
l.pval030 d30,
decode(l.pval031,cn,dn,d(l.pval031)) p31,
decode(l.pval032,cn,dn,d(l.pval032)) p32,
l.pval033 p33,
...
(P_ASSIGNMENT_USER_KEY => c.p34);
end if;
--
if c.p35 is null then
L_ELEMENT_ENTRY_ID:=nn;
else
L_ELEMENT_ENTRY_ID := 
hr_pump_get.get_element_entry_id
(P_ELEMENT_ENTRY_USER_KEY => c.p35);
end if;
--
hr_data_pump.api_trc_on;
HR_AU_SUPER_API.UPDATE_SUPER_CONTRIBUTION
...
,P_SUPER_FUND_NAME => c.p3
,P_ATTRIBUTE_CATEGORY => c.p4
,P_ATTRIBUTE1 => c.p5
,P_ATTRIBUTE2 => c.p6
,P_ATTRIBUTE3 => c.p7
,P_ATTRIBUTE4 => c.p8
...
,P_ATTRIBUTE20 => c.p24
,P_PAY_VALUE => c.p25
,P_MEMBER_NUMBER => c.p26
,P_SG_AMOUNT => c.p27
,P_SG_PERCENT => c.p28
,P_NON_SG_AMOUNT => c.p29
,P_NON_SG_PERCENT => c.p30
,P_EFFECTIVE_START_DATE => c.p31
,P_EFFECTIVE_END_DATE => c.p32
...
l.pval031 = decode(c.p31,null,cn,dc(c.p31)),
l.pval032 = decode(c.p32,null,cn,dc(c.p32)),
