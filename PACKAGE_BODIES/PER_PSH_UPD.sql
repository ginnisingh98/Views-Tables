--------------------------------------------------------
--  DDL for Package Body PER_PSH_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PSH_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_psh_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the per_scorecard_sharing Row
  --
  update per_scorecard_sharing
    set
     sharing_instance_id             = p_rec.sharing_instance_id
...
Begin
  ...
  --
  per_psh_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  per_psh_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  per_psh_upd.post_update
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
