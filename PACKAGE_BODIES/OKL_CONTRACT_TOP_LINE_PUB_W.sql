--------------------------------------------------------
--  DDL for Package Body OKL_CONTRACT_TOP_LINE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CONTRACT_TOP_LINE_PUB_W" as
  /* $Header: OKLUKTLB.pls 115.3 2003/10/16 01:11:03 smereddy noship $ */
  ...
  as
    ddp_clev_rec okl_contract_top_line_pub.clev_rec_type;
    ddp_klev_rec okl_contract_top_line_pub.klev_rec_type;
    ddp_cimv_rec okl_contract_top_line_pub.cimv_rec_type;
    ddp_cplv_rec okl_contract_top_line_pub.cplv_rec_type;
    ddx_clev_rec okl_contract_top_line_pub.clev_rec_type;
    ddx_klev_rec okl_contract_top_line_pub.klev_rec_type;
    ddx_cimv_rec okl_contract_top_line_pub.cimv_rec_type;
    ddx_cplv_rec okl_contract_top_line_pub.cplv_rec_type;
  ...
  begin
    ...
    okl_contract_top_line_pub.create_contract_top_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_top_line_pub.update_contract_top_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_top_line_pub.delete_contract_top_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_clev_tbl okl_contract_top_line_pub.clev_tbl_type;
    ddp_klev_tbl okl_contract_top_line_pub.klev_tbl_type;
    ddp_cimv_tbl okl_contract_top_line_pub.cimv_tbl_type;
    ddp_cplv_tbl okl_contract_top_line_pub.cplv_tbl_type;
    ddx_clev_tbl okl_contract_top_line_pub.clev_tbl_type;
    ddx_klev_tbl okl_contract_top_line_pub.klev_tbl_type;
    ddx_cimv_tbl okl_contract_top_line_pub.cimv_tbl_type;
    ddx_cplv_tbl okl_contract_top_line_pub.cplv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
