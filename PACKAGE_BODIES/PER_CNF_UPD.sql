--------------------------------------------------------
--  DDL for Package Body PER_CNF_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CNF_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_cnf_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the per_ri_configurations Row
  --
...
Begin
  ...
  --
  If (p_rec.configuration_type = hr_api.g_varchar2) then
    p_rec.configuration_type :=
    per_cnf_shd.g_old_rec.configuration_type;
  End If;
  If (p_rec.configuration_status = hr_api.g_varchar2) then
    p_rec.configuration_status :=
    per_cnf_shd.g_old_rec.configuration_status;
  End If;
  --
