--------------------------------------------------------
--  DDL for Package Body IBE_PHY_MEDIA_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IBE_PHY_MEDIA_PVT" AS
/* $Header: IBEVDPMB.pls 115.1 2002/12/14 07:52:56 schak ship $ */
G_PKG_NAME  CONSTANT VARCHAR2(21):= 'IBE_PHY_MEDIA_PVT';
G_FILE_NAME CONSTANT VARCHAR2(12):= 'IBEVDPMB.pls';
-- ****************************************************************************
