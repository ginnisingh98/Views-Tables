--------------------------------------------------------
--  DDL for Package Body JTF_IH_RESULT_REASONS_SEED_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_IH_RESULT_REASONS_SEED_PUB" AS
 /* $Header: JTFIHRRB.pls 115.2 2001/11/09 19:00:26 pkm ship      $ */
     ...
     BEGIN
        UPDATE jtf_ih_result_reasons
        SET
          result_id=DECODE(x_result_id,FND_API.G_MISS_NUM,NULL,x_result_id)
        , reason_id=DECODE(x_reason_id,FND_API.G_MISS_NUM,NULL,x_reason_id)
