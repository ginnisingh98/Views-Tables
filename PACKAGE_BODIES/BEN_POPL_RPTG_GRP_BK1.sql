--------------------------------------------------------
--  DDL for Package Body BEN_POPL_RPTG_GRP_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_POPL_RPTG_GRP_BK1" as
/* $Header: bergrapi.pkb 120.0 2005/05/28 11:39:06 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/01/04 08:40:51 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: BEN_POPL_RPTG_GRP_BK1.CREATE_POPL_RPTG_GRP_A', 10);
hr_utility.set_location(' Leaving: BEN_POPL_RPTG_GRP_BK1.CREATE_POPL_RPTG_GRP_A', 20);
end CREATE_POPL_RPTG_GRP_A;
...
begin
hr_utility.set_location('Entering: BEN_POPL_RPTG_GRP_BK1.CREATE_POPL_RPTG_GRP_B', 10);
hr_utility.set_location(' Leaving: BEN_POPL_RPTG_GRP_BK1.CREATE_POPL_RPTG_GRP_B', 20);
end CREATE_POPL_RPTG_GRP_B;
