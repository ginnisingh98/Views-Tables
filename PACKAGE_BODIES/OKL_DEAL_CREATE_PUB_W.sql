--------------------------------------------------------
--  DDL for Package Body OKL_DEAL_CREATE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_DEAL_CREATE_PUB_W" as
  /* $Header: OKLUDCRB.pls 120.2 2007/08/21 22:21:10 smereddy noship $ */
  ...
  as
    ddp_durv_rec okl_deal_create_pub.deal_rec_type;
    ddx_durv_rec okl_deal_create_pub.deal_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ddp_durv_rec.chr_start_date := rosetta_g_miss_date_in_map(p5_a5);
    ddp_durv_rec.chr_end_date := rosetta_g_miss_date_in_map(p5_a6);
    ddp_durv_rec.khr_term_duration := rosetta_g_miss_num_map(p5_a7);
    ddp_durv_rec.chr_cust_po_number := p5_a8;
    ddp_durv_rec.chr_inv_organization_id := rosetta_g_miss_num_map(p5_a9);
    ddp_durv_rec.chr_authoring_org_id := rosetta_g_miss_num_map(p5_a10);
    ...
    ddp_durv_rec.chr_date_signed := rosetta_g_miss_date_in_map(p5_a18);
    ddp_durv_rec.khr_date_deal_transferred := rosetta_g_miss_date_in_map(p5_a19);
    ddp_durv_rec.khr_accepted_date := rosetta_g_miss_date_in_map(p5_a20);
    ddp_durv_rec.khr_expected_delivery_date := rosetta_g_miss_date_in_map(p5_a21);
    ddp_durv_rec.khr_amd_code := p5_a22;
    ddp_durv_rec.khr_deal_type := p5_a23;
    ddp_durv_rec.mla_contract_number := p5_a24;
    ddp_durv_rec.mla_gvr_chr_id_referred := rosetta_g_miss_num_map(p5_a25);
    ddp_durv_rec.mla_gvr_id := rosetta_g_miss_num_map(p5_a26);
    ddp_durv_rec.cust_id := rosetta_g_miss_num_map(p5_a27);
    ...
    ddp_durv_rec.lessor_id := rosetta_g_miss_num_map(p5_a32);
    ...
    ddp_durv_rec.khr_pdt_id := rosetta_g_miss_num_map(p5_a39);
    ddp_durv_rec.product_name := p5_a40;
    ddp_durv_rec.product_description := p5_a41;
    ddp_durv_rec.khr_khr_id := rosetta_g_miss_num_map(p5_a42);
    ddp_durv_rec.program_contract_number := p5_a43;
    ddp_durv_rec.cl_contract_number := p5_a44;
    ddp_durv_rec.cl_gvr_chr_id_referred := rosetta_g_miss_num_map(p5_a45);
    ddp_durv_rec.cl_gvr_id := rosetta_g_miss_num_map(p5_a46);
    ddp_durv_rec.rg_larles_id := rosetta_g_miss_num_map(p5_a47);
    ddp_durv_rec.r_larles_id := rosetta_g_miss_num_map(p5_a48);
    ddp_durv_rec.r_larles_rule_information1 := p5_a49;
    ddp_durv_rec.col_larles_form_left_prompt := p5_a50;
    ddp_durv_rec.rg_larebl_id := rosetta_g_miss_num_map(p5_a51);
    ddp_durv_rec.r_larebl_id := rosetta_g_miss_num_map(p5_a52);
    ddp_durv_rec.r_larebl_rule_information1 := p5_a53;
    ddp_durv_rec.col_larebl_form_left_prompt := p5_a54;
    ddp_durv_rec.chr_cust_acct_id := rosetta_g_miss_num_map(p5_a55);
    ddp_durv_rec.customer_account := p5_a56;
    ddp_durv_rec.cust_site_description := p5_a57;
    ddp_durv_rec.contact_id := rosetta_g_miss_num_map(p5_a58);
    ...
    ddp_durv_rec.rg_latown_id := rosetta_g_miss_num_map(p5_a63);
    ddp_durv_rec.r_latown_id := rosetta_g_miss_num_map(p5_a64);
    ddp_durv_rec.r_latown_rule_information1 := p5_a65;
    ddp_durv_rec.col_latown_form_left_prompt := p5_a66;
    ddp_durv_rec.rg_lanntf_id := rosetta_g_miss_num_map(p5_a67);
    ddp_durv_rec.r_lanntf_id := rosetta_g_miss_num_map(p5_a68);
    ddp_durv_rec.r_lanntf_rule_information1 := p5_a69;
    ddp_durv_rec.col_lanntf_form_left_prompt := p5_a70;
    ddp_durv_rec.rg_lacpln_id := rosetta_g_miss_num_map(p5_a71);
    ddp_durv_rec.r_lacpln_id := rosetta_g_miss_num_map(p5_a72);
    ddp_durv_rec.r_lacpln_rule_information1 := p5_a73;
    ddp_durv_rec.col_lacpln_form_left_prompt := p5_a74;
    ddp_durv_rec.rg_lapact_id := rosetta_g_miss_num_map(p5_a75);
    ddp_durv_rec.r_lapact_id := rosetta_g_miss_num_map(p5_a76);
    ...
    ddp_durv_rec.khr_currency_conv_rate := rosetta_g_miss_num_map(p5_a80);
    ddp_durv_rec.khr_currency_conv_date := rosetta_g_miss_date_in_map(p5_a81);
    ddp_durv_rec.khr_assignable_yn := p5_a82;
    ddp_durv_rec.legal_entity_id := rosetta_g_miss_num_map(p5_a83);


    -- here's the delegated call to the old PL/SQL routine
    okl_deal_create_pub.update_deal(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a7 := rosetta_g_miss_num_map(ddx_durv_rec.khr_term_duration);
    p6_a8 := ddx_durv_rec.chr_cust_po_number;
    p6_a9 := rosetta_g_miss_num_map(ddx_durv_rec.chr_inv_organization_id);
    p6_a10 := rosetta_g_miss_num_map(ddx_durv_rec.chr_authoring_org_id);
    ...
    p6_a25 := rosetta_g_miss_num_map(ddx_durv_rec.mla_gvr_chr_id_referred);
    p6_a26 := rosetta_g_miss_num_map(ddx_durv_rec.mla_gvr_id);
    p6_a27 := rosetta_g_miss_num_map(ddx_durv_rec.cust_id);
    ...
    p6_a32 := rosetta_g_miss_num_map(ddx_durv_rec.lessor_id);
    ...
    p6_a39 := rosetta_g_miss_num_map(ddx_durv_rec.khr_pdt_id);
    p6_a40 := ddx_durv_rec.product_name;
    p6_a41 := ddx_durv_rec.product_description;
    p6_a42 := rosetta_g_miss_num_map(ddx_durv_rec.khr_khr_id);
    p6_a43 := ddx_durv_rec.program_contract_number;
    p6_a44 := ddx_durv_rec.cl_contract_number;
    p6_a45 := rosetta_g_miss_num_map(ddx_durv_rec.cl_gvr_chr_id_referred);
    p6_a46 := rosetta_g_miss_num_map(ddx_durv_rec.cl_gvr_id);
    p6_a47 := rosetta_g_miss_num_map(ddx_durv_rec.rg_larles_id);
    p6_a48 := rosetta_g_miss_num_map(ddx_durv_rec.r_larles_id);
    p6_a49 := ddx_durv_rec.r_larles_rule_information1;
    p6_a50 := ddx_durv_rec.col_larles_form_left_prompt;
    p6_a51 := rosetta_g_miss_num_map(ddx_durv_rec.rg_larebl_id);
    p6_a52 := rosetta_g_miss_num_map(ddx_durv_rec.r_larebl_id);
    p6_a53 := ddx_durv_rec.r_larebl_rule_information1;
    p6_a54 := ddx_durv_rec.col_larebl_form_left_prompt;
    p6_a55 := rosetta_g_miss_num_map(ddx_durv_rec.chr_cust_acct_id);
    p6_a56 := ddx_durv_rec.customer_account;
    p6_a57 := ddx_durv_rec.cust_site_description;
    p6_a58 := rosetta_g_miss_num_map(ddx_durv_rec.contact_id);
    ...
    p6_a63 := rosetta_g_miss_num_map(ddx_durv_rec.rg_latown_id);
    p6_a64 := rosetta_g_miss_num_map(ddx_durv_rec.r_latown_id);
    p6_a65 := ddx_durv_rec.r_latown_rule_information1;
    p6_a66 := ddx_durv_rec.col_latown_form_left_prompt;
    p6_a67 := rosetta_g_miss_num_map(ddx_durv_rec.rg_lanntf_id);
    p6_a68 := rosetta_g_miss_num_map(ddx_durv_rec.r_lanntf_id);
    p6_a69 := ddx_durv_rec.r_lanntf_rule_information1;
    p6_a70 := ddx_durv_rec.col_lanntf_form_left_prompt;
    p6_a71 := rosetta_g_miss_num_map(ddx_durv_rec.rg_lacpln_id);
    p6_a72 := rosetta_g_miss_num_map(ddx_durv_rec.r_lacpln_id);
    p6_a73 := ddx_durv_rec.r_lacpln_rule_information1;
    p6_a74 := ddx_durv_rec.col_lacpln_form_left_prompt;
    p6_a75 := rosetta_g_miss_num_map(ddx_durv_rec.rg_lapact_id);
    p6_a76 := rosetta_g_miss_num_map(ddx_durv_rec.r_lapact_id);
    ...
    p6_a80 := rosetta_g_miss_num_map(ddx_durv_rec.khr_currency_conv_rate);
    p6_a81 := ddx_durv_rec.khr_currency_conv_date;
    p6_a82 := ddx_durv_rec.khr_assignable_yn;
    p6_a83 := rosetta_g_miss_num_map(ddx_durv_rec.legal_entity_id);
  end;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_deal_create_pub.load_deal(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_deal_create_pub.create_deal(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_kpl_rec okl_deal_create_pub.party_rec_type;
    ddx_kpl_rec okl_deal_create_pub.party_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_deal_create_pub.create_party(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_deal_create_pub.update_party(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
