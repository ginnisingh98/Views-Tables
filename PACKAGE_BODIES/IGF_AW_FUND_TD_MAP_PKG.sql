--------------------------------------------------------
--  DDL for Package Body IGF_AW_FUND_TD_MAP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_AW_FUND_TD_MAP_PKG" AS
/* $Header: IGFWI50B.pls 115.2 2002/11/28 11:23:34 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_aw_fund_td_map_all%ROWTYPE;
  new_references igf_aw_fund_td_map_all%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.ftodo_id                          := x_ftodo_id;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AP_FTODO_FMAST_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AP_FCLASS_TDI_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igf_aw_fund_td_map_s.NEXTVAL
    INTO      x_ftodo_id
    FROM      dual;
    ...
    INSERT INTO igf_aw_fund_td_map_all (
      ftodo_id,
      fund_id,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND (tlinfo.item_sequence_number = x_item_sequence_number)
       ) THEN
      NULL;
    ELSE
  ...
  */
  ...
  BEGIN
    ...
    UPDATE igf_aw_fund_td_map_all
      SET
        fund_id                           = new_references.fund_id,
        item_sequence_number              = new_references.item_sequence_number,
  ...
  */
  BEGIN
    ...
    DELETE FROM igf_aw_fund_td_map_all
    WHERE rowid = x_rowid;
