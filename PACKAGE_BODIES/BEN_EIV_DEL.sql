--------------------------------------------------------
--  DDL for Package Body BEN_EIV_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EIV_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_eiv_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Delete the ben_extra_input_values row.
  --
...
Procedure pre_delete(p_effective_date in date
                    ,p_rec in ben_eiv_shd.g_rec_type) is
--
...
Begin
  ...
  --
  ben_eiv_bus.delete_validate(p_rec,p_effective_date);
  --
  -- Call the supporting pre-delete operation
  --
  ben_eiv_del.pre_delete(p_effective_date,p_rec);
  --
  -- Delete the row.
  --
  ben_eiv_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  ben_eiv_del.post_delete(p_effective_date,p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- business process
  --
  ben_eiv_del.del(p_effective_date
                 ,l_rec);
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End del;
