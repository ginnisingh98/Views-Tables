--------------------------------------------------------
--  DDL for Package Body BEN_CM_TYP_USG_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CM_TYP_USG_API" as
/* $Header: bectuapi.pkb 115.5 2002/12/16 17:35:24 glingapp ship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_cm_typ_usg_api.';
--
-- ----------------------------------------------------------------------------
-- |------------------------< create_cm_typ_usg >-----------------------------|
-- ----------------------------------------------------------------------------
--
procedure create_cm_typ_usg
  (p_validate                       in  boolean   default false
  ,p_cm_typ_usg_id                  out nocopy number
  ,p_effective_start_date           out nocopy date
  ,p_effective_end_date             out nocopy date
  ,p_all_r_any_cd                   in  varchar2  default null
  ...
  --
  l_cm_typ_usg_id ben_cm_typ_usg_f.cm_typ_usg_id%TYPE;
  l_effective_start_date ben_cm_typ_usg_f.effective_start_date%TYPE;
  l_effective_end_date ben_cm_typ_usg_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_cm_typ_usg';
  l_object_version_number ben_cm_typ_usg_f.object_version_number%TYPE;
  --
begin
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_cm_typ_usg
    --
    ben_cm_typ_usg_bk1.create_cm_typ_usg_b
      (p_all_r_any_cd                   =>  p_all_r_any_cd
      ,p_cm_usg_rl                      =>  p_cm_usg_rl
      ,p_descr_text                     =>  p_descr_text
      ,p_pgm_id                         =>  p_pgm_id
      ,p_pl_id                          =>  p_pl_id
      ...
      ,p_ctu_attribute_category         =>  p_ctu_attribute_category
      ,p_ctu_attribute1                 =>  p_ctu_attribute1
      ,p_ctu_attribute2                 =>  p_ctu_attribute2
      ,p_ctu_attribute3                 =>  p_ctu_attribute3
      ,p_ctu_attribute4                 =>  p_ctu_attribute4
      ,p_ctu_attribute5                 =>  p_ctu_attribute5
      ,p_ctu_attribute6                 =>  p_ctu_attribute6
      ,p_ctu_attribute7                 =>  p_ctu_attribute7
      ,p_ctu_attribute8                 =>  p_ctu_attribute8
      ,p_ctu_attribute9                 =>  p_ctu_attribute9
      ,p_ctu_attribute10                =>  p_ctu_attribute10
      ,p_ctu_attribute11                =>  p_ctu_attribute11
      ,p_ctu_attribute12                =>  p_ctu_attribute12
      ,p_ctu_attribute13                =>  p_ctu_attribute13
      ,p_ctu_attribute14                =>  p_ctu_attribute14
      ,p_ctu_attribute15                =>  p_ctu_attribute15
      ,p_ctu_attribute16                =>  p_ctu_attribute16
      ,p_ctu_attribute17                =>  p_ctu_attribute17
      ,p_ctu_attribute18                =>  p_ctu_attribute18
      ,p_ctu_attribute19                =>  p_ctu_attribute19
      ,p_ctu_attribute20                =>  p_ctu_attribute20
      ,p_ctu_attribute21                =>  p_ctu_attribute21
      ,p_ctu_attribute22                =>  p_ctu_attribute22
      ,p_ctu_attribute23                =>  p_ctu_attribute23
      ,p_ctu_attribute24                =>  p_ctu_attribute24
      ,p_ctu_attribute25                =>  p_ctu_attribute25
      ,p_ctu_attribute26                =>  p_ctu_attribute26
      ,p_ctu_attribute27                =>  p_ctu_attribute27
      ,p_ctu_attribute28                =>  p_ctu_attribute28
      ,p_ctu_attribute29                =>  p_ctu_attribute29
      ,p_ctu_attribute30                =>  p_ctu_attribute30
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'CREATE_cm_typ_usg'
        ,p_hook_type   => 'BP');
    --
    -- End of API User Hook for the before hook of create_cm_typ_usg
    --
  end;
  --
  ben_ctu_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_cm_typ_usg
    --
    ben_cm_typ_usg_bk1.create_cm_typ_usg_a
      (p_cm_typ_usg_id                  =>  l_cm_typ_usg_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
      ,p_all_r_any_cd                   =>  p_all_r_any_cd
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        ...
        ,p_hook_type   => 'AP');
    --
    -- End of API User Hook for the after hook of create_cm_typ_usg
    --
  end;
  --
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_cm_typ_usg;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
    --
    p_cm_typ_usg_id := null;
  ...
  when others then
    ...
    raise;
    --
end create_cm_typ_usg;
-- ----------------------------------------------------------------------------
-- |------------------------< update_cm_typ_usg >-----------------------------|
-- ----------------------------------------------------------------------------
--
procedure update_cm_typ_usg
  (p_validate                       in  boolean   default false
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_cm_typ_usg';
  l_object_version_number ben_cm_typ_usg_f.object_version_number%TYPE;
  l_effective_start_date ben_cm_typ_usg_f.effective_start_date%TYPE;
  l_effective_end_date ben_cm_typ_usg_f.effective_end_date%TYPE;
  --
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_cm_typ_usg
    --
    ben_cm_typ_usg_bk2.update_cm_typ_usg_b
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      --
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_cm_typ_usg'
        ,p_hook_type   => 'BP');
    --
    -- End of API User Hook for the before hook of update_cm_typ_usg
    --
  end;
  --
  ben_ctu_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_cm_typ_usg
    --
    ben_cm_typ_usg_bk2.update_cm_typ_usg_a
      (p_cm_typ_usg_id                  =>  p_cm_typ_usg_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
      ,p_all_r_any_cd                   =>  p_all_r_any_cd
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        ...
        ,p_hook_type   => 'AP');
    --
    -- End of API User Hook for the after hook of update_cm_typ_usg
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when others then
    ...
    raise;
    --
end update_cm_typ_usg;
-- ----------------------------------------------------------------------------
-- |------------------------< delete_cm_typ_usg >-----------------------------|
-- ----------------------------------------------------------------------------
--
procedure delete_cm_typ_usg
  (p_validate                       in  boolean  default false
  ,p_cm_typ_usg_id                  in  number
  ,p_effective_start_date           out nocopy date
  ,p_effective_end_date             out nocopy date
...
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_cm_typ_usg
    --
    ben_cm_typ_usg_bk3.delete_cm_typ_usg_b
      (p_cm_typ_usg_id                  =>  p_cm_typ_usg_id
      ,p_object_version_number          =>  p_object_version_number
      ,p_effective_date                 =>  trunc(p_effective_date)
      ,p_datetrack_mode                 =>  p_datetrack_mode);
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      --
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_cm_typ_usg'
        ,p_hook_type   => 'BP');
    --
    -- End of API User Hook for the before hook of delete_cm_typ_usg
    --
  end;
  --
  ben_ctu_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_cm_typ_usg
    --
    ben_cm_typ_usg_bk3.delete_cm_typ_usg_a
      (p_cm_typ_usg_id                  =>  p_cm_typ_usg_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
      ,p_object_version_number          =>  l_object_version_number
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        ...
        ,p_hook_type   => 'AP');
    --
    -- End of API User Hook for the after hook of delete_cm_typ_usg
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
