--------------------------------------------------------
--  DDL for Package Body HXC_TKS_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_TKS_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hxc_tks_upd.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Update the hxc_tk_timekeeper_submits Row
  --
...
Procedure upd
  ...
  ,p_resource_id                  in     number    default hr_api.g_number
  ) is
--
