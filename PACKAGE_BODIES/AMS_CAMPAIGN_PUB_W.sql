--------------------------------------------------------
--  DDL for Package Body AMS_CAMPAIGN_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AMS_CAMPAIGN_PUB_W" as
  /* $Header: amswcpnb.pls 115.12 2002/12/02 20:31:34 dbiswas ship $ */
  ...
  begin
    ...
    ddp_camp_rec.campaign_id := rosetta_g_miss_num_map(p7_a0);
    ddp_camp_rec.last_update_date := rosetta_g_miss_date_in_map(p7_a1);
    ddp_camp_rec.last_updated_by := rosetta_g_miss_num_map(p7_a2);
    ddp_camp_rec.creation_date := rosetta_g_miss_date_in_map(p7_a3);
    ddp_camp_rec.created_by := rosetta_g_miss_num_map(p7_a4);
    ddp_camp_rec.last_update_login := rosetta_g_miss_num_map(p7_a5);
    ddp_camp_rec.object_version_number := rosetta_g_miss_num_map(p7_a6);
    ddp_camp_rec.custom_setup_id := rosetta_g_miss_num_map(p7_a7);
    ddp_camp_rec.owner_user_id := rosetta_g_miss_num_map(p7_a8);
    ddp_camp_rec.user_status_id := rosetta_g_miss_num_map(p7_a9);
    ddp_camp_rec.status_code := p7_a10;
    ddp_camp_rec.status_date := rosetta_g_miss_date_in_map(p7_a11);
    ...
    ddp_camp_rec.fund_source_id := rosetta_g_miss_num_map(p7_a24);
    ddp_camp_rec.parent_campaign_id := rosetta_g_miss_num_map(p7_a25);
    ddp_camp_rec.application_id := rosetta_g_miss_num_map(p7_a26);
    ddp_camp_rec.qp_list_header_id := rosetta_g_miss_num_map(p7_a27);
    ddp_camp_rec.media_id := rosetta_g_miss_num_map(p7_a28);
    ddp_camp_rec.channel_id := rosetta_g_miss_num_map(p7_a29);
    ...
    ddp_camp_rec.budget_amount_tc := rosetta_g_miss_num_map(p7_a35);
    ddp_camp_rec.budget_amount_fc := rosetta_g_miss_num_map(p7_a36);
    ddp_camp_rec.forecasted_plan_start_date := rosetta_g_miss_date_in_map(p7_a37);
    ddp_camp_rec.forecasted_plan_end_date := rosetta_g_miss_date_in_map(p7_a38);
    ddp_camp_rec.forecasted_exec_start_date := rosetta_g_miss_date_in_map(p7_a39);
    ddp_camp_rec.forecasted_exec_end_date := rosetta_g_miss_date_in_map(p7_a40);
    ddp_camp_rec.actual_plan_start_date := rosetta_g_miss_date_in_map(p7_a41);
    ddp_camp_rec.actual_plan_end_date := rosetta_g_miss_date_in_map(p7_a42);
    ddp_camp_rec.actual_exec_start_date := rosetta_g_miss_date_in_map(p7_a43);
    ddp_camp_rec.actual_exec_end_date := rosetta_g_miss_date_in_map(p7_a44);
    ddp_camp_rec.inbound_url := p7_a45;
    ddp_camp_rec.inbound_email_id := p7_a46;
    ddp_camp_rec.inbound_phone_no := p7_a47;
    ddp_camp_rec.duration := rosetta_g_miss_num_map(p7_a48);
    ddp_camp_rec.duration_uom_code := p7_a49;
    ddp_camp_rec.ff_priority := p7_a50;
    ddp_camp_rec.ff_override_cover_letter := rosetta_g_miss_num_map(p7_a51);
    ...
    ddp_camp_rec.cc_manager_user_id := rosetta_g_miss_num_map(p7_a56);
    ddp_camp_rec.forecasted_revenue := rosetta_g_miss_num_map(p7_a57);
    ddp_camp_rec.actual_revenue := rosetta_g_miss_num_map(p7_a58);
    ddp_camp_rec.forecasted_cost := rosetta_g_miss_num_map(p7_a59);
    ddp_camp_rec.actual_cost := rosetta_g_miss_num_map(p7_a60);
    ddp_camp_rec.forecasted_response := rosetta_g_miss_num_map(p7_a61);
    ddp_camp_rec.actual_response := rosetta_g_miss_num_map(p7_a62);
    ddp_camp_rec.target_response := rosetta_g_miss_num_map(p7_a63);
    ...
    ddp_camp_rec.version_no := rosetta_g_miss_num_map(p7_a85);
    ddp_camp_rec.campaign_calendar := p7_a86;
    ddp_camp_rec.start_period_name := p7_a87;
    ddp_camp_rec.end_period_name := p7_a88;
    ddp_camp_rec.city_id := rosetta_g_miss_num_map(p7_a89);
    ddp_camp_rec.global_flag := p7_a90;
    ddp_camp_rec.show_campaign_flag := p7_a91;
    ddp_camp_rec.business_unit_id := rosetta_g_miss_num_map(p7_a92);
    ddp_camp_rec.accounts_closed_flag := p7_a93;
    ddp_camp_rec.task_id := rosetta_g_miss_num_map(p7_a94);
    ddp_camp_rec.related_event_from := p7_a95;
    ddp_camp_rec.related_event_id := rosetta_g_miss_num_map(p7_a96);
  ...
  begin
    ...
    ddp_camp_rec.campaign_id := rosetta_g_miss_num_map(p6_a0);
    ddp_camp_rec.last_update_date := rosetta_g_miss_date_in_map(p6_a1);
    ddp_camp_rec.last_updated_by := rosetta_g_miss_num_map(p6_a2);
    ddp_camp_rec.creation_date := rosetta_g_miss_date_in_map(p6_a3);
    ddp_camp_rec.created_by := rosetta_g_miss_num_map(p6_a4);
    ddp_camp_rec.last_update_login := rosetta_g_miss_num_map(p6_a5);
    ddp_camp_rec.object_version_number := rosetta_g_miss_num_map(p6_a6);
    ddp_camp_rec.custom_setup_id := rosetta_g_miss_num_map(p6_a7);
    ddp_camp_rec.owner_user_id := rosetta_g_miss_num_map(p6_a8);
    ddp_camp_rec.user_status_id := rosetta_g_miss_num_map(p6_a9);
    ddp_camp_rec.status_code := p6_a10;
    ddp_camp_rec.status_date := rosetta_g_miss_date_in_map(p6_a11);
    ...
    ddp_camp_rec.fund_source_id := rosetta_g_miss_num_map(p6_a24);
    ddp_camp_rec.parent_campaign_id := rosetta_g_miss_num_map(p6_a25);
    ddp_camp_rec.application_id := rosetta_g_miss_num_map(p6_a26);
    ddp_camp_rec.qp_list_header_id := rosetta_g_miss_num_map(p6_a27);
    ddp_camp_rec.media_id := rosetta_g_miss_num_map(p6_a28);
    ddp_camp_rec.channel_id := rosetta_g_miss_num_map(p6_a29);
    ...
    ddp_camp_rec.budget_amount_tc := rosetta_g_miss_num_map(p6_a35);
    ddp_camp_rec.budget_amount_fc := rosetta_g_miss_num_map(p6_a36);
    ddp_camp_rec.forecasted_plan_start_date := rosetta_g_miss_date_in_map(p6_a37);
    ddp_camp_rec.forecasted_plan_end_date := rosetta_g_miss_date_in_map(p6_a38);
    ddp_camp_rec.forecasted_exec_start_date := rosetta_g_miss_date_in_map(p6_a39);
    ddp_camp_rec.forecasted_exec_end_date := rosetta_g_miss_date_in_map(p6_a40);
    ddp_camp_rec.actual_plan_start_date := rosetta_g_miss_date_in_map(p6_a41);
    ddp_camp_rec.actual_plan_end_date := rosetta_g_miss_date_in_map(p6_a42);
    ddp_camp_rec.actual_exec_start_date := rosetta_g_miss_date_in_map(p6_a43);
    ddp_camp_rec.actual_exec_end_date := rosetta_g_miss_date_in_map(p6_a44);
    ddp_camp_rec.inbound_url := p6_a45;
    ddp_camp_rec.inbound_email_id := p6_a46;
    ddp_camp_rec.inbound_phone_no := p6_a47;
    ddp_camp_rec.duration := rosetta_g_miss_num_map(p6_a48);
    ddp_camp_rec.duration_uom_code := p6_a49;
    ddp_camp_rec.ff_priority := p6_a50;
    ddp_camp_rec.ff_override_cover_letter := rosetta_g_miss_num_map(p6_a51);
    ...
    ddp_camp_rec.cc_manager_user_id := rosetta_g_miss_num_map(p6_a56);
    ddp_camp_rec.forecasted_revenue := rosetta_g_miss_num_map(p6_a57);
    ddp_camp_rec.actual_revenue := rosetta_g_miss_num_map(p6_a58);
    ddp_camp_rec.forecasted_cost := rosetta_g_miss_num_map(p6_a59);
    ddp_camp_rec.actual_cost := rosetta_g_miss_num_map(p6_a60);
    ddp_camp_rec.forecasted_response := rosetta_g_miss_num_map(p6_a61);
    ddp_camp_rec.actual_response := rosetta_g_miss_num_map(p6_a62);
    ddp_camp_rec.target_response := rosetta_g_miss_num_map(p6_a63);
    ...
    ddp_camp_rec.version_no := rosetta_g_miss_num_map(p6_a85);
    ddp_camp_rec.campaign_calendar := p6_a86;
    ddp_camp_rec.start_period_name := p6_a87;
    ddp_camp_rec.end_period_name := p6_a88;
    ddp_camp_rec.city_id := rosetta_g_miss_num_map(p6_a89);
    ddp_camp_rec.global_flag := p6_a90;
    ddp_camp_rec.show_campaign_flag := p6_a91;
    ddp_camp_rec.business_unit_id := rosetta_g_miss_num_map(p6_a92);
    ddp_camp_rec.accounts_closed_flag := p6_a93;
    ddp_camp_rec.task_id := rosetta_g_miss_num_map(p6_a94);
    ddp_camp_rec.related_event_from := p6_a95;
    ddp_camp_rec.related_event_id := rosetta_g_miss_num_map(p6_a96);
