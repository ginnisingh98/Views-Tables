--------------------------------------------------------
--  DDL for Package Body QP_MODIFIERS_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."QP_MODIFIERS_GRP" AS
/* $Header: QPXGMLSB.pls 120.3 2005/07/12 17:19:52 appldev ship $ */

--  Global constant holding the package name

G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'QP_Modifiers_GRP';
...
l_p_MODIFIER_LIST_rec         QP_MODIFIERS_PUB.Modifier_List_Rec_Type;
...
BEGIN
   ...
   END IF;
    ...
    IF l_qp_status = 'S'
    AND nvl(l_list_source_code,'NULL') <> QP_GLOBALS.G_ENTITY_BSO --bug#3385041
    THEN
