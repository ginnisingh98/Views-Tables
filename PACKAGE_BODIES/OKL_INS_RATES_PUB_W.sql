--------------------------------------------------------
--  DDL for Package Body OKL_INS_RATES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_INS_RATES_PUB_W" as
  /* $Header: OKLOINRB.pls 120.1 2005/07/14 12:01:00 asawanka noship $ */
  ...
  procedure insert_ins_rates(p_api_version  NUMBER
  ...
  as
    ddp_inrv_tbl okl_ins_rates_pub.inrv_tbl_type;
    ddx_inrv_tbl okl_ins_rates_pub.inrv_tbl_type;
  ...
  begin
    ...
    okl_ins_rates_pub.insert_ins_rates(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_inrv_rec okl_ins_rates_pub.inrv_rec_type;
    ddx_inrv_rec okl_ins_rates_pub.inrv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_ins_rates(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_rates_pub.lock_ins_rates(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_ins_rates(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_rates_pub.update_ins_rates(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_ins_rates(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_rates_pub.delete_ins_rates(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_ins_rates(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_rates_pub.validate_ins_rates(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
