--------------------------------------------------------
--  DDL for Package Body BEN_PCM_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PCM_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pcm_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_PER_CM_F_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_PER_CM_F_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  If (p_effective_date is null or
    ...
    l_fct_ret := false;
  Else
    If (p_per_cm_id = g_old_rec.per_cm_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_child_table_name1       => 'ben_per_cm_prvdd_f',
	 p_child_key_column1       => 'per_cm_prvdd_id',
	 p_child_table_name2       => 'ben_per_cm_trgr_f',
	 p_child_key_column2       => 'per_cm_trgr_id',
	 p_child_table_name3       => 'ben_per_cm_usg_f',
	 p_child_key_column3       => 'per_cm_usg_id',
...
Begin
  ...
  l_rec.rqstbl_untl_dt                   := p_rqstbl_untl_dt;
  ...
  l_rec.pcm_attribute_category           := p_pcm_attribute_category;
  l_rec.pcm_attribute1                   := p_pcm_attribute1;
  l_rec.pcm_attribute2                   := p_pcm_attribute2;
  l_rec.pcm_attribute3                   := p_pcm_attribute3;
  l_rec.pcm_attribute4                   := p_pcm_attribute4;
  l_rec.pcm_attribute5                   := p_pcm_attribute5;
  l_rec.pcm_attribute6                   := p_pcm_attribute6;
  l_rec.pcm_attribute7                   := p_pcm_attribute7;
  l_rec.pcm_attribute8                   := p_pcm_attribute8;
  l_rec.pcm_attribute9                   := p_pcm_attribute9;
  l_rec.pcm_attribute10                  := p_pcm_attribute10;
  l_rec.pcm_attribute11                  := p_pcm_attribute11;
  l_rec.pcm_attribute12                  := p_pcm_attribute12;
  l_rec.pcm_attribute13                  := p_pcm_attribute13;
  l_rec.pcm_attribute14                  := p_pcm_attribute14;
  l_rec.pcm_attribute15                  := p_pcm_attribute15;
  l_rec.pcm_attribute16                  := p_pcm_attribute16;
  l_rec.pcm_attribute17                  := p_pcm_attribute17;
  l_rec.pcm_attribute18                  := p_pcm_attribute18;
  l_rec.pcm_attribute19                  := p_pcm_attribute19;
  l_rec.pcm_attribute20                  := p_pcm_attribute20;
  l_rec.pcm_attribute21                  := p_pcm_attribute21;
  l_rec.pcm_attribute22                  := p_pcm_attribute22;
  l_rec.pcm_attribute23                  := p_pcm_attribute23;
  l_rec.pcm_attribute24                  := p_pcm_attribute24;
  l_rec.pcm_attribute25                  := p_pcm_attribute25;
  l_rec.pcm_attribute26                  := p_pcm_attribute26;
  l_rec.pcm_attribute27                  := p_pcm_attribute27;
  l_rec.pcm_attribute28                  := p_pcm_attribute28;
  l_rec.pcm_attribute29                  := p_pcm_attribute29;
  l_rec.pcm_attribute30                  := p_pcm_attribute30;
