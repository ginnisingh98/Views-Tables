--------------------------------------------------------
--  DDL for Package Body OE_HEADER_ADJ_PCFWK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_HEADER_ADJ_PCFWK" AS
/* $Header: OEXKHADB.pls 120.0 2005/05/31 22:35:46 appldev noship $ */

-- Globals
-------------------------------------------
 g_application_id     constant number := 660;
 g_entity_id          constant number := 6;
 g_entity_short_name  constant varchar2(15) := 'HEADER_ADJ';
-------------------------------------------
