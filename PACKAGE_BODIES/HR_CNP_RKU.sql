--------------------------------------------------------
--  DDL for Package Body HR_CNP_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_CNP_RKU" as
...
begin
hr_utility.set_location('Entering: hr_cnp_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: hr_cnp_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end hr_cnp_RKU;
