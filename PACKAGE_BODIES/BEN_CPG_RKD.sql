--------------------------------------------------------
--  DDL for Package Body BEN_CPG_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CPG_RKD" as
...
begin
hr_utility.set_location('Entering: BEN_CPG_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: BEN_CPG_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end BEN_CPG_RKD;
