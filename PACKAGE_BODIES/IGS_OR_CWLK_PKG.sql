--------------------------------------------------------
--  DDL for Package Body IGS_OR_CWLK_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_OR_CWLK_PKG" AS
/* $Header: IGSOI26B.pls 115.4 2002/11/29 01:43:18 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_or_cwlk%ROWTYPE;
  new_references igs_or_cwlk%ROWTYPE;
  ...
  */
  BEGIN
    ...
    igs_or_cwlk_dtl_pkg.get_fk_igs_or_cwlk (
      old_references.crosswalk_id
    );
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ((tlinfo.institution_code = x_institution_code) OR ((tlinfo.institution_code IS NULL) AND (X_institution_code IS NULL)))
