--------------------------------------------------------
--  DDL for Package Body BEN_BTR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BTR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_btr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.comp_lvl_acty_rt_id       = p_rec.comp_lvl_acty_rt_id
    and    t.effective_start_date =
             ben_btr_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_comp_lvl_acty_rt_f.created_by%TYPE;
  l_creation_date       ben_comp_lvl_acty_rt_f.creation_date%TYPE;
  l_last_update_date   	ben_comp_lvl_acty_rt_f.last_update_date%TYPE;
  l_last_updated_by     ben_comp_lvl_acty_rt_f.last_updated_by%TYPE;
  l_last_update_login   ben_comp_lvl_acty_rt_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_comp_lvl_acty_rt_f
  --
  insert into ben_comp_lvl_acty_rt_f
  (	comp_lvl_acty_rt_id,
...
--
  ...
  cursor c1 is
     select ben_comp_lvl_acty_rt_f_s.nextval
     from sys.dual;
--
--
--
Begin
  ...
  open c1;
  --
     fetch c1 into p_rec.comp_lvl_acty_rt_id;
  --
  close c1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_btr_rec
  ...
  --
  p_comp_lvl_acty_rt_id        	:= l_rec.comp_lvl_acty_rt_id;
