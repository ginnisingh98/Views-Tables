--------------------------------------------------------
--  DDL for Package Body OKL_CSP_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CSP_PVT_W" as
  /* $Header: OKLICSPB.pls 120.1 2005/07/08 10:34:30 dkagrawa noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_csp_pvt.csp_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).pov_id := rosetta_g_miss_num_map(a1(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_csp_pvt.csp_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a24 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := rosetta_g_miss_num_map(t(ddindx).pov_id);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_csp_pvt.cspv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_VARCHAR2_TABLE_100
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).pov_id := rosetta_g_miss_num_map(a2(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_csp_pvt.cspv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    , a3 out nocopy JTF_NUMBER_TABLE
    , a4 out nocopy JTF_VARCHAR2_TABLE_100
    ...
    a24 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).pov_id);
  ...
  as
    ddp_cspv_rec okl_csp_pvt.cspv_rec_type;
    ddx_cspv_rec okl_csp_pvt.cspv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_csp_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_cspv_tbl okl_csp_pvt.cspv_tbl_type;
    ddx_cspv_tbl okl_csp_pvt.cspv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_csp_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_csp_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_csp_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_csp_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
