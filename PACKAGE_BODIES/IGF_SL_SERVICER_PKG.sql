--------------------------------------------------------
--  DDL for Package Body IGF_SL_SERVICER_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_SL_SERVICER_PKG" AS
/* $Header: IGFLI04B.pls 115.7 2003/10/14 06:45:40 sjadhav ship $ */

  l_rowid VARCHAR2(25);
  old_references igf_sl_servicer%ROWTYPE;
  new_references igf_sl_servicer%ROWTYPE;
  ...
  PROCEDURE set_column_values (
    ...
    x_duns_servicer_id                  IN     VARCHAR2    DEFAULT NULL,
  ...
  */
  BEGIN
    ...
    igf_sl_servicer_brc_pkg.get_fk_igf_sl_servicer (
      old_references.servicer_id
    );
  ...
  */
  ...
  PROCEDURE insert_row (
    ...
    x_duns_servicer_id                  IN     VARCHAR2,
    x_party_id                          IN     NUMBER,
  ...
  */
  ...
  BEGIN
    ...
    before_dml(
      ...
      x_duns_servicer_id                  => x_duns_servicer_id,
