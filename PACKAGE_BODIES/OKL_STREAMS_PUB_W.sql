--------------------------------------------------------
--  DDL for Package Body OKL_STREAMS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_STREAMS_PUB_W" as
  /* $Header: OKLUSTMB.pls 120.3 2005/09/02 12:41:22 mansrini noship $ */
  ...
  as
    ddp_stmv_rec okl_streams_pub.stmv_rec_type;
    ddp_selv_tbl okl_streams_pub.selv_tbl_type;
    ddx_stmv_rec okl_streams_pub.stmv_rec_type;
    ddx_selv_tbl okl_streams_pub.selv_tbl_type;
  ...
  as
    ddp_stmv_tbl okl_streams_pub.stmv_tbl_type;
    ddp_selv_tbl okl_streams_pub.selv_tbl_type;
    ddx_stmv_tbl okl_streams_pub.stmv_tbl_type;
    ddx_selv_tbl okl_streams_pub.selv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_streams_pub.update_streams(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_streams_pub.validate_streams(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_streams_pub.lock_streams(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_streams_pub.delete_streams(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_streams_pub.create_stream_elements(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_selv_rec okl_streams_pub.selv_rec_type;
    ddx_selv_rec okl_streams_pub.selv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_streams_pub.lock_stream_elements(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_streams_pub.update_stream_elements(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_streams_pub.delete_stream_elements(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_streams_pub.validate_stream_elements(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
