--------------------------------------------------------
--  DDL for Package Body CN_SYIN_ATTR_RULES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CN_SYIN_ATTR_RULES_PKG" AS
-- $Header: cnsyinhb.pls 120.6 2005/12/27 04:04:59 hanaraya ship $
...
PROCEDURE Populate_Fields (x_column_id                 number,
  ...
  --   01/26/94         Tony Lower              Created
  --
PROCEDURE Default_Row (X_rule_id        IN OUT NOCOPY  number) IS
  BEGIN
