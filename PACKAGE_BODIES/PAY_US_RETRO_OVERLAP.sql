--------------------------------------------------------
--  DDL for Package Body PAY_US_RETRO_OVERLAP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_US_RETRO_OVERLAP" 
--  /* $Header: pyusenro.pkb 120.1.12010000.1 2008/10/17 10:27:58 pvelugul noship $ */
/*
...
-- Checking whether Enhanced Retropay is enabled or not
   ...
   END LOOP;
    ...
    IF lv_qualified = 'Y'
    THEN
        lv_short_name := 'US_ENHANCED_RETROPAY';
...
BEGIN
 gv_package_name := 'PAY_US_RETRO_OVERLAP';
