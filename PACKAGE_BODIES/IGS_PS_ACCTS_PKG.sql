--------------------------------------------------------
--  DDL for Package Body IGS_PS_ACCTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_PS_ACCTS_PKG" AS
/* $Header: IGSPI3BB.pls 115.4 2002/11/29 02:24:40 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_ps_accts_all%ROWTYPE;
  new_references igs_ps_accts_all%ROWTYPE;

  PROCEDURE set_column_values (
    p_action                            IN     VARCHAR2,
    x_rowid                             IN     VARCHAR2    DEFAULT NULL,
    x_course_account_id                 IN     NUMBER      DEFAULT NULL,
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.course_account_id                 := x_course_account_id;
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_ps_accts_all
      WHERE    course_account_id = x_course_account_id
      FOR UPDATE NOWAIT;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_FI_PSAA_CRV_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  BEGIN
    ...
    IF (p_action = 'INSERT') THEN
      ...
      IF ( get_pk_for_validation(
             new_references.course_account_id
           )
         ) THEN
  ...
  PROCEDURE insert_row (
    ...
    x_course_account_id                 IN OUT NOCOPY NUMBER,
    x_course_cd                         IN     VARCHAR2,
    x_version_number                    IN     NUMBER,
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igs_ps_accts_s.NEXTVAL
    INTO      x_course_account_id
    FROM      dual;
    ...
    before_dml(
      p_action                            => 'INSERT',
      x_rowid                             => x_rowid,
      x_course_account_id                 => x_course_account_id,
