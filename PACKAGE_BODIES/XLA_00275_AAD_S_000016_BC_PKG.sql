--------------------------------------------------------
--  DDL for Package Body XLA_00275_AAD_S_000016_BC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."XLA_00275_AAD_S_000016_BC_PKG" AS
--
/*======================================================================+
...
+=======================================================================+
| Package Name                                                          |
|     XLA_00275_AAD_S_000016_BC_PKG                                     |
|                                                                       |
| DESCRIPTION                                                           |
|     Package generated From Product Accounting Definition              |
|      Name    : China Projects Standard Accounting                     |
|      Code    : JA_CN_PA_DEFAULT_ACCRUAL                               |
|      Owner   : PRODUCT                                                |
|      Version :                                                        |
|      AMB Context Code: DEFAULT                                        |
| HISTORY                                                               |
|     Generated at 29-08-2013 at 11:08:40 by user ANONYMOUS             |
+=======================================================================*/
--
--
...
C_DEFAULT_MODULE      CONSTANT VARCHAR2(240) := 'xla.plsql.XLA_00275_AAD_S_000016_BC_PKG';
...
EXCEPTION
       ...
       WHEN OTHERS THEN
          xla_exceptions_pkg.raise_message
             (p_location   => 'XLA_00275_AAD_S_000016_BC_PKG.trace');
END trace;
...
WHEN OTHERS  THEN
   xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00275_AAD_S_000016_BC_PKG.ValidateLookupMeaning');
       --
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00275_AAD_S_000016_BC_PKG.GetMeaning');
END GetMeaning;
--
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00275_AAD_S_000016_BC_PKG.AcctDerRule_1');
END AcctDerRule_1;
--
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00275_AAD_S_000016_BC_PKG.AcctLineType_2');
END AcctLineType_2;
--
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00275_AAD_S_000016_BC_PKG.AcctLineType_3');
END AcctLineType_3;
--
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00275_AAD_S_000016_BC_PKG.AcctLineType_4');
END AcctLineType_4;
--
...
EXCEPTION
  ...
  WHEN OTHERS THEN
      IF (C_LEVEL_EXCEPTION >= g_log_level) THEN
       ...
       END IF;
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00275_AAD_S_000016_BC_PKG.insert_sources_5');
...
xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00275_AAD_S_000016_BC_PKG.EventClass_5');
...
WHEN OTHERS THEN
   xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00275_AAD_S_000016_BC_PKG.CreateHeadersAndLines');
...
xla_ae_journal_entry_pkg.SetProductAcctDefinition
   (p_product_rule_code      => 'JA_CN_PA_DEFAULT_ACCRUAL'
   ,p_product_rule_type_code => 'S'
   ,p_product_rule_version   => ''
   ,p_product_rule_name      => 'China Projects Standard Accounting'
   ,p_amb_context_code       => 'DEFAULT'
   );
...
WHEN OTHERS THEN
   ...
   END IF;
   xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00275_AAD_S_000016_BC_PKG.CreateJournalEntries');
...
BEGIN
   ...
   END IF;
--
END XLA_00275_AAD_S_000016_BC_PKG;
--
