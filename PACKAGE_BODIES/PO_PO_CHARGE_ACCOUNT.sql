--------------------------------------------------------
--  DDL for Package Body PO_PO_CHARGE_ACCOUNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PO_PO_CHARGE_ACCOUNT" AS
/* $Header: POXWFB1B.pls 115.4 2002/11/25 21:51:47 sbull ship $*/
...
BEGIN
  ...
  FND_MESSAGE.SET_TOKEN('FUNC', 'PO_PO_CHARGE_ACCOUNT');
  FB_ERROR_MSG := FND_MESSAGE.GET_ENCODED;
  RETURN FALSE;
END;

END PO_PO_CHARGE_ACCOUNT;
