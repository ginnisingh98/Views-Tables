--------------------------------------------------------
--  DDL for Package Body OKL_SUBSIDY_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SUBSIDY_PUB_W" as
  /* $Header: OKLUSUBB.pls 120.4 2005/10/30 04:50:55 appldev noship $ */
  ...
  as
    ddp_subv_rec okl_subsidy_pub.subv_rec_type;
    ddx_subv_rec okl_subsidy_pub.subv_rec_type;
  ...
  begin
    ...
    okl_subsidy_pub.create_subsidy(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_subv_tbl okl_subsidy_pub.subv_tbl_type;
    ddx_subv_tbl okl_subsidy_pub.subv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_subsidy_pub.update_subsidy(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_subsidy_pub.delete_subsidy(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_subsidy_pub.lock_subsidy(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_subsidy_pub.validate_subsidy(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_sucv_rec okl_subsidy_pub.sucv_rec_type;
    ddx_sucv_rec okl_subsidy_pub.sucv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_subsidy_pub.create_subsidy_criteria(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_sucv_tbl okl_subsidy_pub.sucv_tbl_type;
    ddx_sucv_tbl okl_subsidy_pub.sucv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_subsidy_pub.update_subsidy_criteria(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_subsidy_pub.delete_subsidy_criteria(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_subsidy_pub.lock_subsidy_criteria(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_subsidy_pub.validate_subsidy_criteria(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
