--------------------------------------------------------
--  DDL for Package Body BEN_BVR_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BVR_RKI" as
/* $Header: bebvrrhi.pkb 120.0 2005/05/28 00:54:44 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_bvr_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_bvr_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_bvr_RKI;
