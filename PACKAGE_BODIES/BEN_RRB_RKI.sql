--------------------------------------------------------
--  DDL for Package Body BEN_RRB_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_RRB_RKI" as
/* $Header: berrbrhi.pkb 120.0.12010000.2 2008/08/05 15:26:44 generated ship $ */
...
begin
hr_utility.set_location('Entering: ben_rrb_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_rrb_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_rrb_RKI;
