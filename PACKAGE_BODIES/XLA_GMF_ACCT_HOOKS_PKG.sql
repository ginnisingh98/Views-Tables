--------------------------------------------------------
--  DDL for Package Body XLA_GMF_ACCT_HOOKS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."XLA_GMF_ACCT_HOOKS_PKG" AS
-- $Header: xlaapgmf.pkb 120.2 2006/06/28 05:54:15 vinaykum noship $
...
C_DEFAULT_MODULE      CONSTANT VARCHAR2(240) := 'xla.plsql.xla_gmf_acct_hooks_pkg';
...
EXCEPTION
   ...
   WHEN OTHERS THEN
      xla_exceptions_pkg.raise_message
         (p_location   => 'xla_gmf_acct_hooks_pkg.trace');
END trace;
...
EXCEPTION
   ...
   WHEN OTHERS THEN
      xla_exceptions_pkg.raise_message
         (p_location   => 'xla_gmf_acct_hooks_pkg.print_logfile');
END print_logfile;
...
WHEN xla_exceptions_pkg.application_exception THEN
   ...
   xla_exceptions_pkg.raise_message
      ...
      ,p_token_1        => 'LOCATION'
      ,p_value_1        => 'xla_gmf_acct_hooks_pkg.main'
      ,p_token_2        => 'ERROR'
