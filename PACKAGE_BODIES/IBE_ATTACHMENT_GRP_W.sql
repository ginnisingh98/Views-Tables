--------------------------------------------------------
--  DDL for Package Body IBE_ATTACHMENT_GRP_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IBE_ATTACHMENT_GRP_W" as
  /* $Header: IBEGRATB.pls 115.2 2002/12/18 07:06:58 schak ship $ */
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).secured_flag := a44(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
    ...
    a44 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a44(indx) := t(ddindx).secured_flag;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_in_p4(t out nocopy ibe_attachment_grp.number_table, a0 JTF_NUMBER_TABLE) as
    ddindx binary_integer; indx binary_integer;
  begin
  if a0 is null then
    t := null;
  elsif a0.count = 0 then
    t := ibe_attachment_grp.number_table();
  else
      if a0.count > 0 then
      t := ibe_attachment_grp.number_table();
      t.extend(a0.count);
  ...
  procedure rosetta_table_copy_out_p4(t ibe_attachment_grp.number_table, a0 out nocopy JTF_NUMBER_TABLE) as
    ddindx binary_integer; indx binary_integer;
  begin
  if t is null then
    a0 := null;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy ibe_attachment_grp.varchar2_table_300, a0 JTF_VARCHAR2_TABLE_300) as
    ddindx binary_integer; indx binary_integer;
  begin
  if a0 is null then
    t := null;
  elsif a0.count = 0 then
    t := ibe_attachment_grp.varchar2_table_300();
  else
      if a0.count > 0 then
      t := ibe_attachment_grp.varchar2_table_300();
      t.extend(a0.count);
  ...
  procedure rosetta_table_copy_out_p5(t ibe_attachment_grp.varchar2_table_300, a0 out nocopy JTF_VARCHAR2_TABLE_300) as
    ddindx binary_integer; indx binary_integer;
  begin
  if t is null then
    a0 := null;
  ...
  procedure rosetta_table_copy_in_p6(t out nocopy ibe_attachment_grp.varchar2_table_20, a0 JTF_VARCHAR2_TABLE_100) as
    ddindx binary_integer; indx binary_integer;
  begin
  if a0 is null then
    t := null;
  elsif a0.count = 0 then
    t := ibe_attachment_grp.varchar2_table_20();
  else
      if a0.count > 0 then
      t := ibe_attachment_grp.varchar2_table_20();
      t.extend(a0.count);
  ...
  procedure rosetta_table_copy_out_p6(t ibe_attachment_grp.varchar2_table_20, a0 out nocopy JTF_VARCHAR2_TABLE_100) as
    ddindx binary_integer; indx binary_integer;
  begin
  if t is null then
    a0 := null;
  ...
  as
    ddx_ath_id_tbl ibe_attachment_grp.number_table;
    ddx_dlv_id_tbl ibe_attachment_grp.number_table;
    ddx_file_name_tbl ibe_attachment_grp.varchar2_table_300;
    ddx_file_id_tbl ibe_attachment_grp.number_table;
    ddx_file_ext_tbl ibe_attachment_grp.varchar2_table_20;
    ddx_dsp_width_tbl ibe_attachment_grp.number_table;
    ddx_dsp_height_tbl ibe_attachment_grp.number_table;
    ddx_version_tbl ibe_attachment_grp.number_table;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ibe_attachment_grp.list_attachment(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    ibe_attachment_grp_w.rosetta_table_copy_out_p4(ddx_ath_id_tbl, x_ath_id_tbl);

    ibe_attachment_grp_w.rosetta_table_copy_out_p4(ddx_dlv_id_tbl, x_dlv_id_tbl);

    ibe_attachment_grp_w.rosetta_table_copy_out_p5(ddx_file_name_tbl, x_file_name_tbl);

    ibe_attachment_grp_w.rosetta_table_copy_out_p4(ddx_file_id_tbl, x_file_id_tbl);

    ibe_attachment_grp_w.rosetta_table_copy_out_p6(ddx_file_ext_tbl, x_file_ext_tbl);

    ibe_attachment_grp_w.rosetta_table_copy_out_p4(ddx_dsp_width_tbl, x_dsp_width_tbl);

    ibe_attachment_grp_w.rosetta_table_copy_out_p4(ddx_dsp_height_tbl, x_dsp_height_tbl);

    ibe_attachment_grp_w.rosetta_table_copy_out_p4(ddx_version_tbl, x_version_tbl);
  end;
  ...
  as
    ddp_attachment_rec ibe_attachment_grp.attachment_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ddp_attachment_rec.secured_flag := p6_a44;

    -- here's the delegated call to the old PL/SQL routine
    ibe_attachment_grp.save_attachment(p_api_version,
      p_init_msg_list,
      p_commit,
      x_return_status,
      x_msg_count,
    ...
    p6_a44 := ddp_attachment_rec.secured_flag;
  end;
  ...
  as
    ddp_attachment_tbl ibe_attachment_grp.attachment_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ibe_attachment_grp_w.rosetta_table_copy_in_p1(ddp_attachment_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
    ...
    ibe_attachment_grp_w.rosetta_table_copy_out_p1(ddp_attachment_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  as
    ddp_ath_id_ver_tbl ibe_attachment_grp.ath_id_ver_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ibe_attachment_grp_w.rosetta_table_copy_in_p3(ddp_ath_id_ver_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      );
    ...
    -- here's the delegated call to the old PL/SQL routine
    ibe_attachment_grp.delete_attachment(p_api_version,
      p_init_msg_list,
      p_commit,
      x_return_status,
      x_msg_count,
    ...
    ibe_attachment_grp_w.rosetta_table_copy_out_p3(ddp_ath_id_ver_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      );
