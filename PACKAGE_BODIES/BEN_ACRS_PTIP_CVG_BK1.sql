--------------------------------------------------------
--  DDL for Package Body BEN_ACRS_PTIP_CVG_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ACRS_PTIP_CVG_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_ACRS_PTIP_CVG_BK1.CREATE_ACRS_PTIP_CVG_A', 10);
hr_utility.set_location(' Leaving: BEN_ACRS_PTIP_CVG_BK1.CREATE_ACRS_PTIP_CVG_A', 20);
end CREATE_ACRS_PTIP_CVG_A;
...
begin
hr_utility.set_location('Entering: BEN_ACRS_PTIP_CVG_BK1.CREATE_ACRS_PTIP_CVG_B', 10);
hr_utility.set_location(' Leaving: BEN_ACRS_PTIP_CVG_BK1.CREATE_ACRS_PTIP_CVG_B', 20);
end CREATE_ACRS_PTIP_CVG_B;
