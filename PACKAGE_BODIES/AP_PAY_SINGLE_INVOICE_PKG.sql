--------------------------------------------------------
--  DDL for Package Body AP_PAY_SINGLE_INVOICE_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AP_PAY_SINGLE_INVOICE_PKG" AS
/* $Header: appayinb.pls 120.13.12000000.2 2007/07/04 07:13:51 rkvadaka ship $ */
...
G_MODULE_NAME           CONSTANT VARCHAR2(100) := 'AP.PLSQL.AP_PAY_SINGLE_INVOICE_PKG';
  ...
  BEGIN
    ...
    BEGIN
       ...
       AND  CBAU.bank_acct_use_id = p_internal_bank_acct_id;
