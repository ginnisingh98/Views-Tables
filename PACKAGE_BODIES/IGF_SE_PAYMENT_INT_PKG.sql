--------------------------------------------------------
--  DDL for Package Body IGF_SE_PAYMENT_INT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_SE_PAYMENT_INT_PKG" AS
/* $Header: IGFSI03B.pls 120.0 2005/06/01 14:53:53 appldev noship $ */
...
/*=======================================================================+
 ...
 |                                                                       |
 | DESCRIPTION                                                           |
 |      PL/SQL body for package: IGF_SE_PAYMENT_INT_PKG
 |                                                                       |
 | NOTES                                                                 |
 |                                                                       |
 ...
 *=======================================================================*/
  ...
  l_rowid VARCHAR2(25);
  old_references igf_se_payment_int%ROWTYPE;
  new_references igf_se_payment_int%ROWTYPE;
  ...
  */
  BEGIN
    ...
    IF (UPPER(column_name) = 'STATUS' OR column_name IS NULL) THEN
      IF NOT (new_references.status IN ('NEW','DONE','ERROR'))  THEN
