--------------------------------------------------------
--  DDL for Package Body HR_SA_PREVIOUS_EMPLOYMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SA_PREVIOUS_EMPLOYMENT_API" as
/* $Header: pepemsai.pkb 115.0 2003/09/10 02:12:48 adevanat noship $ */

   -- Package Variables
   g_package   VARCHAR2(33) := 'hr_sa_previous_employment_api.';
...
begin
 ...
 l_proc :=  g_package||'create_sa_previous_employer';
 if g_debug then
...
(  p_effective_date               =>      l_effective_date
 ...
 if g_debug then
  ...
  --
end create_sa_previous_employer;
...
begin
 ...
 l_proc :=  g_package||'update_sa_previous_employer';
 if g_debug then
  hr_utility.set_location('Entering:'|| l_proc, 5);
 end if;
  --
...
(  p_effective_date             =>      l_effective_date
 ...
 if g_debug then
  ...
  --
end update_sa_previous_employer;
