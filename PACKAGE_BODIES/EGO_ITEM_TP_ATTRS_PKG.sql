--------------------------------------------------------
--  DDL for Package Body EGO_ITEM_TP_ATTRS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."EGO_ITEM_TP_ATTRS_PKG" AS
/* $Header: EGOITPAB.pls 120.0 2006/07/01 20:11:38 vtviswes noship $ */

               ------------------------------------
               -- Global Variables and Constants --
               ------------------------------------

   G_PKG_NAME                CONSTANT VARCHAR2(30) := 'EGO_ITEM_TP_ATTRS_PKG';
...
IS
BEGIN
  delete from EGO_ITEM_TP_ATTRS_EXT_TL T
  where not exists
    (select NULL
  ...
  update EGO_ITEM_TP_ATTRS_EXT_TL T set (
      TL_EXT_ATTR1,
      TL_EXT_ATTR2,
      TL_EXT_ATTR3,
      TL_EXT_ATTR4,
    ...
    (select
      ...
      B.TL_EXT_ATTR39,
      B.TL_EXT_ATTR40
    from EGO_ITEM_TP_ATTRS_EXT_TL B
    where B.EXTENSION_ID = T.EXTENSION_ID
  ...
  where (
      ...
      SUBT.EXTENSION_ID,
      SUBT.LANGUAGE
    from EGO_ITEM_TP_ATTRS_EXT_TL SUBB, EGO_ITEM_TP_ATTRS_EXT_TL SUBT
  ...
  insert into EGO_ITEM_TP_ATTRS_EXT_TL (
    ...
    L.LANGUAGE_CODE,
    B.SOURCE_LANG
  from EGO_ITEM_TP_ATTRS_EXT_TL B, FND_LANGUAGES L
