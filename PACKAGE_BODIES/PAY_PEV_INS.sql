--------------------------------------------------------
--  DDL for Package Body PAY_PEV_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PEV_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_pev_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  pay_pev_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  pay_pev_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pay_pev_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pay_pev_ins.post_insert
     (p_rec
     );
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the pay_pev_rec
