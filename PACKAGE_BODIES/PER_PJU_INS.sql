--------------------------------------------------------
--  DDL for Package Body PER_PJU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PJU_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_pju_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_previous_job_usage_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_previous_job_usage_id  in  number) is
--
...
Begin
  ...
  --
  per_pju_ins.g_previous_job_usage_id_i := p_previous_job_usage_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: per_previous_job_usages
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (per_pju_ins.g_previous_job_usage_id_i is not null) Then
    --
    ...
    p_rec.previous_job_usage_id :=
      per_pju_ins.g_previous_job_usage_id_i;
    per_pju_ins.g_previous_job_usage_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.previous_job_usage_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  -- Having converted the arguments into the per_pju_rec
  ...
  --
  p_previous_job_usage_id := l_rec.previous_job_usage_id;
