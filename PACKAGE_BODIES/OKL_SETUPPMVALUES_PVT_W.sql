--------------------------------------------------------
--  DDL for Package Body OKL_SETUPPMVALUES_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPPMVALUES_PVT_W" as
  /* $Header: OKLESMVB.pls 120.2 2007/03/04 09:59:51 dcshanmu ship $ */
  ...
  as
    ddp_pmvv_rec okl_setuppmvalues_pvt.pmvv_rec_type;
    ddx_no_data_found boolean;
    ddx_pmvv_rec okl_setuppmvalues_pvt.pmvv_rec_type;
  ...
  begin
    ...
    okl_setuppmvalues_pvt.get_rec(ddp_pmvv_rec,
      x_return_status,
      ddx_no_data_found,
      ddx_pmvv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p3_a0 := rosetta_g_miss_num_map(ddx_pmvv_rec.id);
    p3_a1 := rosetta_g_miss_num_map(ddx_pmvv_rec.object_version_number);
    p3_a2 := rosetta_g_miss_num_map(ddx_pmvv_rec.ptv_id);
    p3_a3 := rosetta_g_miss_num_map(ddx_pmvv_rec.ptl_id);
    p3_a4 := rosetta_g_miss_num_map(ddx_pmvv_rec.ptq_id);
    p3_a5 := ddx_pmvv_rec.from_date;
    p3_a6 := ddx_pmvv_rec.to_date;
    p3_a7 := rosetta_g_miss_num_map(ddx_pmvv_rec.created_by);
    p3_a8 := ddx_pmvv_rec.creation_date;
    p3_a9 := rosetta_g_miss_num_map(ddx_pmvv_rec.last_updated_by);
    p3_a10 := ddx_pmvv_rec.last_update_date;
    p3_a11 := rosetta_g_miss_num_map(ddx_pmvv_rec.last_update_login);
  end;
  ...
  as
    ddp_ptlv_rec okl_setuppmvalues_pvt.ptlv_rec_type;
    ddp_pmvv_rec okl_setuppmvalues_pvt.pmvv_rec_type;
    ddx_pmvv_rec okl_setuppmvalues_pvt.pmvv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppmvalues_pvt.insert_pmvalues(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ptlv_rec okl_setuppmvalues_pvt.ptlv_rec_type;
    ddp_pmvv_tbl okl_setuppmvalues_pvt.pmvv_tbl_type;
    ddx_pmvv_tbl okl_setuppmvalues_pvt.pmvv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppmvalues_pvt.delete_pmvalues(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
