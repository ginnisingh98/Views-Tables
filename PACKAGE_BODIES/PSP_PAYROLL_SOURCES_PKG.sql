--------------------------------------------------------
--  DDL for Package Body PSP_PAYROLL_SOURCES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_PAYROLL_SOURCES_PKG" as
 /* $Header: PSPSUSRB.pls 115.6 2002/11/18 09:01:46 lveerubh ship $ */
procedure INSERT_ROW (
  ...
  X_MODE in VARCHAR2 default 'R'
    ...
    cursor C is select ROWID from PSP_PAYROLL_SOURCES
...
begin
  ...
  insert into PSP_PAYROLL_SOURCES (
    SOURCE_TYPE,
    SOURCE_CODE,
    DESCRIPTION,
    ATTRIBUTE_CATEGORY,
...
begin
  ...
  update PSP_PAYROLL_SOURCES set
...
procedure ADD_ROW (
  ...
  cursor c1 is select rowid from PSP_PAYROLL_SOURCES
     where SOURCE_TYPE = X_SOURCE_TYPE
     and SOURCE_CODE = X_SOURCE_CODE
  ;
  dummy c1%rowtype;
...
begin
  delete from PSP_PAYROLL_SOURCES
  where SOURCE_TYPE = X_SOURCE_TYPE
  and SOURCE_CODE = X_SOURCE_CODE;
  if (sql%notfound) then
    raise no_data_found;
