--------------------------------------------------------
--  DDL for Package Body BEN_OPT_PLTYP_IN_PGM_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_OPT_PLTYP_IN_PGM_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_OPT_PLTYP_IN_PGM_BK2.UPDATE_OPT_PLTYP_IN_PGM_A', 10);
hr_utility.set_location(' Leaving: BEN_OPT_PLTYP_IN_PGM_BK2.UPDATE_OPT_PLTYP_IN_PGM_A', 20);
end UPDATE_OPT_PLTYP_IN_PGM_A;
...
begin
hr_utility.set_location('Entering: BEN_OPT_PLTYP_IN_PGM_BK2.UPDATE_OPT_PLTYP_IN_PGM_B', 10);
hr_utility.set_location(' Leaving: BEN_OPT_PLTYP_IN_PGM_BK2.UPDATE_OPT_PLTYP_IN_PGM_B', 20);
end UPDATE_OPT_PLTYP_IN_PGM_B;
