--------------------------------------------------------
--  DDL for Package Body OKL_SYS_ACCT_OPTS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SYS_ACCT_OPTS_PUB_W" as
  /* $Header: OKLUSAOB.pls 120.5.12010000.3 2009/06/02 10:58:41 racheruv ship $ */
  ...
  procedure insert_sys_acct_opts(p_api_version  NUMBER
  ...
  as
    ddp_saov_rec okl_sys_acct_opts_pub.saov_rec_type;
    ddx_saov_rec okl_sys_acct_opts_pub.saov_rec_type;
  ...
  begin
    ...
    okl_sys_acct_opts_pub.insert_sys_acct_opts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_saov_tbl okl_sys_acct_opts_pub.saov_tbl_type;
    ddx_saov_tbl okl_sys_acct_opts_pub.saov_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_sys_acct_opts(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_sys_acct_opts_pub.lock_sys_acct_opts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_sys_acct_opts(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_sys_acct_opts_pub.update_sys_acct_opts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_sys_acct_opts(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_sys_acct_opts_pub.delete_sys_acct_opts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_sys_acct_opts(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_sys_acct_opts_pub.validate_sys_acct_opts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
