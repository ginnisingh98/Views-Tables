--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_HK_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_HK_PERSONAL_PAY_M" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:19
 * Generated for API: HR_HK_PERSONAL_PAY_METHOD_API.UPDATE_HK_PERSONAL_PAY_METHOD
 */
--
...
HR_HK_PERSONAL_PAY_METHOD_API.UPDATE_HK_PERSONAL_PAY_METHOD
...
,P_BANK_CODE => c.p3
,P_BRANCH_CODE => c.p4
,P_ACCOUNT_NUMBER => c.p5
,P_BANK_ACCOUNT_NAME => c.p6
,P_AMOUNT => c.p7
,P_COMMENTS => c.p8
,P_PERCENTAGE => c.p9
,P_PRIORITY => c.p10
...
end hrdpp_UPDATE_HK_PERSONAL_PAY_M;
