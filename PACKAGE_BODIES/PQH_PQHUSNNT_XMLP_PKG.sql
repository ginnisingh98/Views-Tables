--------------------------------------------------------
--  DDL for Package Body PQH_PQHUSNNT_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_PQHUSNNT_XMLP_PKG" AS
/* $Header: PQHUSNNTB.pls 120.1 2007/12/07 06:56:20 vjaganat noship $ */
  ...
  BEGIN
    ...
    PQH_TENURE_DETAIL.GETPERSONINFO(L_MANAGER_ID
                                   ...
                                   ,L_HIREDATE);
    PQH_TENURE_DETAIL.GETREPORTBODYTEXT('NT'
                                       ,CP_REGARDS
                                       ,CP_BODY_TEXT
                                       ,L_BODY_TEXT2
                                       ,L_BODY_TEXT3
    ...
    CP_BODY_TEXT := REPLACE(CP_BODY_TEXT
                           ,'EFFECTIVE_DATE'
                           ,FND_DATE.DATE_TO_DISPLAYDATE(CP_CONTRACT_START_DATE));
    CP_BODY_TEXT := REPLACE(CP_BODY_TEXT
