--------------------------------------------------------
--  DDL for Package Body OPI_DBI_CALENDAR_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OPI_DBI_CALENDAR_PKG" AS
/* $Header: OPIDRCALB.pls 115.3 2002/10/18 00:09:02 csheu noship $ */
...
begin
 ...
 if(period_type = 'WTD') then
  ...
  if l_date < bis_common_parameters.get_global_start_date
  then
