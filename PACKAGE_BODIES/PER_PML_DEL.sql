--------------------------------------------------------
--  DDL for Package Body PER_PML_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PML_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_pml_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the per_objectives_library row.
  --
  delete from per_objectives_library
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in per_pml_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in per_pml_shd.g_rec_type) is
--
...
Begin
  ...
  --
  per_pml_bus.delete_validate(p_rec);
  --
  ...
  --
  per_pml_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  per_pml_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  per_pml_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the per_pml_rec
  -- plsql record structure we must call the corresponding entity
  -- business process
  --
  per_pml_del.del(l_rec);
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End del;
--
