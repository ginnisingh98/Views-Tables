--------------------------------------------------------
--  DDL for Package Body PER_SALARY_SURVEY_LINE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_SALARY_SURVEY_LINE_BK1" as
...
begin
hr_utility.set_location('Entering: PER_SALARY_SURVEY_LINE_BK1.CREATE_SALARY_SURVEY_LINE_A', 10);
hr_utility.set_location(' Leaving: PER_SALARY_SURVEY_LINE_BK1.CREATE_SALARY_SURVEY_LINE_A', 20);
end CREATE_SALARY_SURVEY_LINE_A;
...
begin
hr_utility.set_location('Entering: PER_SALARY_SURVEY_LINE_BK1.CREATE_SALARY_SURVEY_LINE_B', 10);
hr_utility.set_location(' Leaving: PER_SALARY_SURVEY_LINE_BK1.CREATE_SALARY_SURVEY_LINE_B', 20);
end CREATE_SALARY_SURVEY_LINE_B;
