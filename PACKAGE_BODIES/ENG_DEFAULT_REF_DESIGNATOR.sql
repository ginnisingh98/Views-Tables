--------------------------------------------------------
--  DDL for Package Body ENG_DEFAULT_REF_DESIGNATOR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ENG_DEFAULT_REF_DESIGNATOR" AS
/* $Header: ENGDRFDB.pls 115.6 2002/12/12 16:26:23 akumar ship $ */

--  Global constant holding the package name

G_PKG_NAME        CONSTANT VARCHAR2(30) := 'ENG_Default_Ref_Designator';
...
BEGIN
    ...
    IF l_ref_designator_rec.ref_designator_comment = FND_API.G_MISS_CHAR THEN
...
l_ref_designator_rec.attribute1 := p_old_ref_designator_rec.attribute1;
END IF;

IF l_ref_designator_rec.attribute2 = FND_API.G_MISS_CHAR THEN
l_ref_designator_rec.attribute2 := p_old_ref_designator_rec.attribute2;
END IF;

IF l_ref_designator_rec.attribute3 = FND_API.G_MISS_CHAR THEN
l_ref_designator_rec.attribute3 := p_old_ref_designator_rec.attribute3;
END IF;

IF l_ref_designator_rec.attribute4 = FND_API.G_MISS_CHAR THEN
l_ref_designator_rec.attribute4 := p_old_ref_designator_rec.attribute4;
END IF;

IF l_ref_designator_rec.attribute5 = FND_API.G_MISS_CHAR THEN
l_ref_designator_rec.attribute5 := p_old_ref_designator_rec.attribute5;
END IF;

IF l_ref_designator_rec.attribute6 = FND_API.G_MISS_CHAR THEN
l_ref_designator_rec.attribute6 := p_old_ref_designator_rec.attribute6;
END IF;

IF l_ref_designator_rec.attribute7 = FND_API.G_MISS_CHAR THEN
l_ref_designator_rec.attribute7 := p_old_ref_designator_rec.attribute7;
END IF;

IF l_ref_designator_rec.attribute8 = FND_API.G_MISS_CHAR THEN
l_ref_designator_rec.attribute8 := p_old_ref_designator_rec.attribute8;
END IF;

IF l_ref_designator_rec.attribute9 = FND_API.G_MISS_CHAR THEN
l_ref_designator_rec.attribute9 := p_old_ref_designator_rec.attribute9;
    END IF;
