--------------------------------------------------------
--  DDL for Package Body BEN_RTS_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_RTS_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_rts_ins.';  -- Global package name
g_debug boolean := hr_utility.debug_enabled;
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_person_rate_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_person_rate_id  in  number) is
--
...
Begin
  ...
  --
  ben_rts_ins.g_person_rate_id_i := p_person_rate_id;
  --
  if g_debug then
...
Begin
  ...
  --
  -- Insert the row into: ben_cwb_person_rates
  --
...
--
  Cursor C_Sel1 is select ben_cwb_person_rates_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from ben_cwb_person_rates
     where person_rate_id =
             ben_rts_ins.g_person_rate_id_i;
--
...
Begin
  ...
  --
If (ben_rts_ins.g_person_rate_id_i is not null) Then
    --
    ...
    p_rec.person_rate_id :=
      ben_rts_ins.g_person_rate_id_i;
    ben_rts_ins.g_person_rate_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.person_rate_id;
    Close C_Sel1;
  End If;
  --
  if g_debug then
...
Begin
  ...
  --
  ben_rts_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  ben_rts_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ben_rts_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
...
Begin
  ...
  --
  p_person_rate_id := l_rec.person_rate_id;
