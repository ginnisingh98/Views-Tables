--------------------------------------------------------
--  DDL for Package Body BEN_EHC_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EHC_RKI" as
/* $Header: beehcrhi.pkb 120.0 2005/05/28 02:14:11 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_EHC_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: BEN_EHC_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end BEN_EHC_RKI;
