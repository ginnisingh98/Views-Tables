--------------------------------------------------------
--  DDL for Package Body BEN_XCR_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XCR_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xcr_del.';  -- Global package name
...
Begin
  ...
  --
  -- Delete the ben_ext_crit_prfl row.
  --
...
Procedure del
  (
  p_rec	      in ben_xcr_shd.g_rec_type
  ) is
--
