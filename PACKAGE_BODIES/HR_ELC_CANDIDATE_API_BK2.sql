--------------------------------------------------------
--  DDL for Package Body HR_ELC_CANDIDATE_API_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ELC_CANDIDATE_API_BK2" as
/* $Header: peecaapi.pkb 120.0 2005/10/02 02:15:09 generated $ */
...
begin
hr_utility.set_location('Entering: HR_ELC_CANDIDATE_API_BK2.UPDATE_ELECTION_CANDIDATE_A', 10);
hr_utility.set_location(' Leaving: HR_ELC_CANDIDATE_API_BK2.UPDATE_ELECTION_CANDIDATE_A', 20);
end UPDATE_ELECTION_CANDIDATE_A;
...
begin
hr_utility.set_location('Entering: HR_ELC_CANDIDATE_API_BK2.UPDATE_ELECTION_CANDIDATE_B', 10);
hr_utility.set_location(' Leaving: HR_ELC_CANDIDATE_API_BK2.UPDATE_ELECTION_CANDIDATE_B', 20);
end UPDATE_ELECTION_CANDIDATE_B;
