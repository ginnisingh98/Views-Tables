--------------------------------------------------------
--  DDL for Package Body EDW_SICM_INV_PAYMTS_HOOK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."EDW_SICM_INV_PAYMTS_HOOK" as
/*$Header: FIIAIPHB.pls 120.0 2002/08/24 04:40:45 appldev noship $ */

FUNCTION Pre_Fact_Collect(p_object_name varchar2) RETURN BOOLEAN IS
begin
  -- Update DUNS
  Update FII_AP_INV_PAYMTS_FSTG Fact
