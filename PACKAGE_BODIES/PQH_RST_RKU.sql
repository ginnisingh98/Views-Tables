--------------------------------------------------------
--  DDL for Package Body PQH_RST_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_RST_RKU" as
...
begin
hr_utility.set_location('Entering: PQH_RST_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PQH_RST_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQH_RST_RKU;
