--------------------------------------------------------
--  DDL for Package Body BEN_BENEFIT_PRVDR_POOL_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENEFIT_PRVDR_POOL_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_BENEFIT_PRVDR_POOL_BK2.UPDATE_BENEFIT_PRVDR_POOL_A', 10);
hr_utility.set_location(' Leaving: BEN_BENEFIT_PRVDR_POOL_BK2.UPDATE_BENEFIT_PRVDR_POOL_A', 20);
end UPDATE_BENEFIT_PRVDR_POOL_A;
...
begin
hr_utility.set_location('Entering: BEN_BENEFIT_PRVDR_POOL_BK2.UPDATE_BENEFIT_PRVDR_POOL_B', 10);
hr_utility.set_location(' Leaving: BEN_BENEFIT_PRVDR_POOL_BK2.UPDATE_BENEFIT_PRVDR_POOL_B', 20);
end UPDATE_BENEFIT_PRVDR_POOL_B;
