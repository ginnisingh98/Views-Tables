--------------------------------------------------------
--  DDL for Package Body BEN_BBP_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BBP_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_bbp_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_dml(p_rec in ben_bbp_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Delete the ben_batch_parameter row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in ben_bbp_shd.g_rec_type) is
--
...
Procedure del
  ...
  p_rec	      in ben_bbp_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  ben_bbp_bus.delete_validate(p_rec,p_effective_date);
  --
...
Begin
  ...
  --
  l_rec.batch_parameter_id:= p_batch_parameter_id;
