--------------------------------------------------------
--  DDL for Package Body PER_PRT_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PRT_FLEX" as
/* $Header: peprtfli.pkb 115.1 99/07/18 14:29:25 porting ship $ */
--
--
-- ---------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_prt_flex.';  -- Global package name
--
--
--
----------------------------------------------------------------------------
