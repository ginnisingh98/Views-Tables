--------------------------------------------------------
--  DDL for Package Body BEN_PON_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PON_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pon_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.pl_typ_opt_typ_id       = p_rec.pl_typ_opt_typ_id
    and    t.effective_start_date =
             ben_pon_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_pl_typ_opt_typ_f.created_by%TYPE;
  l_creation_date       ben_pl_typ_opt_typ_f.creation_date%TYPE;
  l_last_update_date   	ben_pl_typ_opt_typ_f.last_update_date%TYPE;
  l_last_updated_by     ben_pl_typ_opt_typ_f.last_updated_by%TYPE;
  l_last_update_login   ben_pl_typ_opt_typ_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_pl_typ_opt_typ_f
  --
  insert into ben_pl_typ_opt_typ_f
  (	pl_typ_opt_typ_id,
...
--
  Cursor C_Sel1 is select ben_pl_typ_opt_typ_f_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.pl_typ_opt_typ_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  dt_api.validate_dt_mode
	(p_effective_date	   => p_effective_date,
	 ...
	 p_parent_key_value1       => p_rec.opt_id,
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_pon_rec
  ...
  --
  p_pl_typ_opt_typ_id        	:= l_rec.pl_typ_opt_typ_id;
