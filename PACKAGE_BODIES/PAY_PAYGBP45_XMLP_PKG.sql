--------------------------------------------------------
--  DDL for Package Body PAY_PAYGBP45_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PAYGBP45_XMLP_PKG" AS
/* $Header: PAYGBP45B.pls 120.1 2008/01/07 15:57:25 srikrish noship $ */
  ...
  FUNCTION C_FORMAT_DATA_FORMULA(TITLE IN VARCHAR2
                                ...
                                ,W1_M1_INDICATOR IN VARCHAR2) RETURN VARCHAR2 IS
  BEGIN
    C_TITLE := SUBSTR(HR_GENERAL.DECODE_LOOKUP('TITLE'
                                              ,TITLE)
                     ,1
                     ,5);
  ...
  PROCEDURE SPLIT_EMPLOYER_ADDRESS(P_EMPLOYER_ADDRESS IN VARCHAR2
    ...
    LINE_LENGTH CONSTANT NUMBER DEFAULT 38;
