--------------------------------------------------------
--  DDL for Package Body OE_2PC2_SHIPSET_SCHEXST
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC2_SHIPSET_SCHEXST" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 IS 
   ...
   WHERE a.SCHEDULE_STATUS_CODE IS NOT NULL 
   AND   (  a.LINE_ID ) IN  
                 ( SELECT  b.LINE_ID
