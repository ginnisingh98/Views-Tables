--------------------------------------------------------
--  DDL for Package Body HR_ASSIGNMENT_BEE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ASSIGNMENT_BEE" as 
...
p_effective_end_date           date) is
  ...
  --
  l_proc varchar2(72):='  hr_assignment_beE.set_new_primary_asg_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.assignment.set_new_primary_asg';
...
end set_new_primary_asg_a;
end hr_assignment_beE;
