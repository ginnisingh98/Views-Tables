--------------------------------------------------------
--  DDL for Package Body OKL_TXL_ASSETS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TXL_ASSETS_PVT_W" as
  /* $Header: OKLOTALB.pls 120.3.12010000.2 2010/04/29 15:21:20 rpillay ship $ */
  ...
  as
    ddp_talv_rec okl_txl_assets_pvt.tlvv_rec_type;
    ddx_talv_rec okl_txl_assets_pvt.tlvv_rec_type;
  ...
  begin
    ...
    okl_txl_assets_pvt.create_txl_asset_def(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_talv_tbl okl_txl_assets_pvt.tlvv_tbl_type;
    ddx_talv_tbl okl_txl_assets_pvt.tlvv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_txl_assets_pvt.lock_txl_asset_def(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_txl_assets_pvt.update_txl_asset_def(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_txl_assets_pvt.delete_txl_asset_def(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_txl_assets_pvt.validate_txl_asset_def(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
