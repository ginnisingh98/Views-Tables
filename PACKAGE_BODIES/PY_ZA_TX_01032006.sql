--------------------------------------------------------
--  DDL for Package Body PY_ZA_TX_01032006
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PY_ZA_TX_01032006" AS
/* $Header: pyzat007.pkb 120.1.12000000.2 2007/06/29 06:39:22 rpahune noship $ */
...
/*
   ...
   PRIVATE PROCEDURES
      WrtHrTrc
         Wrapper procedure for py_za_tx_utl_01032006.WriteHrTrace
      NetTxbIncCalc
   ...
   ---------- ---------- -------------- ------- --------------------------------
   J.N. Louw  20/04/2007 115.5          5965050 TX_ON_LS_PTD
   A. Mahanty 16/05/2006 115.4          5148830 References to the dimension
                                                _rtr_asg_tax_ptd added in
                                                ZATX6_01032006.  Norcalc is used
                                                even when the asg has retro
                                                results.
   A. Mahanty 01/03/2006 115.3          4346955 References to the dimension
                                                _non_rtr_asg_tax_ptd removed in
                                                ZATX6_01032005. SitCalc is used
                                                when the assignment has retropay
                                                results.
...
-------------------------------------------------------------------------------
-- WrtHrTrc
-- Wrapper for py_za_tx_utl_01032006.WriteHrTrace
-------------------------------------------------------------------------------
PROCEDURE WrtHrTrc(
   p_Buf IN VARCHAR2
   )
...
BEGIN
   py_za_tx_utl_01032006.WriteHrTrace(p_Buf);
END WrtHrTrc;
...
--
   SELECT last_day(dbi_SES_DTE)
     ...
     FROM dual;
   hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',3);
...
--
   ...
   hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',4);
...
-----------------------------
   ...
   -------------------------
      ...
      --------------------------------
         hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',19);
         -------------
         -- Excess ITD
         -------------
      ...
      -------------------------------
         hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',20);
         -------------
         -- Current RA
         -------------
         ...
         IF bal_CUR_PF_CMTD + bal_ANN_PF_CMTD = 0 THEN
            hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',21);
            nti_PerNrfiCon := (
                                bal_TOT_RFI_INC_CMTD + bal_TOT_NRFI_INC_CMTD
                              )
                              * nti_SitFactor;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',22);
         ...
         IF bal_CUR_PF_CMTD + bal_ANN_PF_CMTD = 0 THEN
            hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',23);

            nti_AnnNrfiCon := nti_PerNrfiCon
                            + bal_TOT_NRFI_AN_INC_CMTD
                            + bal_TOT_RFI_AN_INC_CMTD;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',24);
            nti_AnnNrfiCon := nti_PerNrfiCon + bal_TOT_NRFI_AN_INC_CMTD;
         END IF;
      --------------------------------------
      -- Arrear Retirement Annuity Abatement
      --------------------------------------
         hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',25);
         -------------
         -- Excess ITD
         -------------
   ...
   ---------------------------
      ...
      hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',26);
   ...
   --------------------------------------
      ...
      hr_utility.set_location('py_za_tx_01032006.NetTxbIncCalc',27);
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxOvr_01032006: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxOvr_01032006;
...
PROCEDURE LteCalc AS
   ...
   --
      ...
      BEGIN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',1);
         ...
         hr_utility.set_location('py_za_tx_01032006.LteCalc',2);
      ...
      AS
         ...
         l_dimension pay_balance_dimensions.dimension_name%TYPE ;
      BEGIN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',3);
         -- Get the Balance Type ID
         SELECT pbt.balance_type_id
           INTO l_BalTypId
           FROM pay_balance_types pbt
         ...
         hr_utility.set_location('py_za_tx_01032006.LteCalc',4);
...
BEGIN
   hr_utility.set_location('py_za_tx_01032006.LteCalc',5);
   -- Does the Assignment have an OFigure?
   --
   IF bal_TOT_TXB_INC_ITD <= 0 THEN
      hr_utility.set_location('py_za_tx_01032006.LteCalc',6);
      ...
      hr_utility.set_location('py_za_tx_01032006.LteCalc',8);

      trc_SitFactor := (l_EndDate - l_StrtDte + 1) / py_za_tx_utl_01032006.DaysWorked;
      hr_utility.set_location('py_za_tx_01032006.LteCalc',9);
      ...
      hr_utility.set_location('py_za_tx_01032006.LteCalc',10);

      -- Update Globals with Correct Taxable Values
      py_za_tx_utl_01032006.TrvAll;

      bal_TOT_TXB_PO_PTD  := bal_TOT_TXB_PO_PTD
                       * py_za_tx_utl_01032006.GlbVal('ZA_PUBL_TAX_PERC',l_EndDate)
                       / 100;
      hr_utility.set_location('py_za_tx_01032006.LteCalc',11);

      -- Rebates
      py_za_tx_utl_01032006.SetRebates;
      -- Abatements
      py_za_tx_utl_01032006.Abatements;

      hr_utility.set_location('py_za_tx_01032006.LteCalc',12);
      ...
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',13);
      -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01032006.LteCalc',14);
         trc_TotLibBse := 0;
      END IF;
   ...
   ELSE
      hr_utility.set_location('py_za_tx_01032006.LteCalc',15);
      ...
      hr_utility.set_location('py_za_tx_01032006.LteCalc',16);

      -- Global Values
      l_ZA_TX_YR_END        := l_EndDate;
      l_ZA_ADL_TX_RBT       := py_za_tx_utl_01032006.GlbVal('ZA_ADDITIONAL_TAX_REBATE',l_EndDate);
      l_ZA_PRI_TX_RBT       := py_za_tx_utl_01032006.GlbVal('ZA_PRIMARY_TAX_REBATE',l_EndDate);
      l_ZA_PRI_TX_THRSHLD   := py_za_tx_utl_01032006.GlbVal('ZA_PRIM_TAX_THRESHOLD',l_EndDate);
      l_ZA_SC_TX_THRSHLD    := py_za_tx_utl_01032006.GlbVal('ZA_SEC_TAX_THRESHOLD',l_EndDate);

      -- Calculate the assignments 65 Year Date
      l_65Year := add_months(dbi_PER_DTE_OF_BRTH,780);

      IF l_65Year <= l_ZA_TX_YR_END THEN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',17);
         -- give the extra abatement
         trc_Rebate    := l_ZA_PRI_TX_RBT + l_ZA_ADL_TX_RBT;
         trc_Threshold := l_ZA_SC_TX_THRSHLD;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.LteCalc',18);
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',19);
         -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01032006.LteCalc',20);
         trc_TotLibBse := 0;
      END IF;
   ...
   hr_utility.set_location('py_za_tx_01032006.LteCalc',21);
   ...
   hr_utility.set_location('py_za_tx_01032006.LteCalc',22);
...
--
   ...
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.LteCalc',23);
      -- Normal Earnings
      ...
      IF trc_TxbNorInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',24);
         -- Tax Liability
         trc_TotLibNI := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbNorInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01032006.LteCalc',25);
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.LteCalc',26);
      -- Set Cascade Figures and Refund
...
--
   ...
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.LteCalc',27);
      ...
      IF trc_TxbFrnInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',28);
         -- Tax Liability
         trc_TotLibFB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbFrnInc);
      ...
      ElSE
         hr_utility.set_location('py_za_tx_01032006.LteCalc',29);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.LteCalc',30);
      -- Set Cascade Figures and Refund
...
--
   ...
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.LteCalc',31);
      -- Travel Earnings
      ...
      IF trc_TxbTrvInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',32);
         -- Tax Liability
         trc_TotLibTA := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbTrvInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01032006.LteCalc',33);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.LteCalc',34);
      -- Set Cascade Figures and Refund
...
--
   ...
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.LteCalc',35);
      ...
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',36);
         -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnBonInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01032006.LteCalc',39);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.LteCalc',40);
      -- Set Cascade Figures and Refund
...
--
   ...
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.LteCalc',41);
      ...
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',42);
         -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnPymInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01032006.LteCalc',45);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.LteCalc',46);
      -- Set Cascade Figures and Refund
...
--
   ...
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.LteCalc',47);
      ...
      IF trc_TxbPblOffInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.LteCalc',48);
         -- Tax Liability
         trc_TotLibPO := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbPblOffInc);
      ...
      ElSE
         hr_utility.set_location('py_za_tx_01032006.LteCalc',49);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.LteCalc',50);
      -- Set Cascade Figures and Refund
...
--
   ...
   IF trc_TxbAnnPymInc + trc_PblOffErn < glb_ZA_SIT_LIM THEN
      hr_utility.set_location('py_za_tx_01032006.LteCalc',51);
      l_Sl := TRUE;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.LteCalc',52);
      l_Sl := FALSE;
   END IF;

   py_za_tx_utl_01032006.ValidateTaxOns(p_Rf => l_Sl);

-- Set IT3A Indicator
--
   IF trc_TxbAnnPymInc + trc_PblOffErn >= trc_Threshold THEN
      hr_utility.set_location('py_za_tx_01032006.LteCalc',53);
      trc_It3Ind := 0; -- Over Lim
   ELSE
      hr_utility.set_location('py_za_tx_01032006.LteCalc',54);
...
BEGIN
   hr_utility.set_location('py_za_tx_01032006.SeaCalc',1);
...
--
   hr_utility.set_location('py_za_tx_01032006.SeaCalc',2);
   IF trc_TxbIncPtd = 0 THEN -- Pre-Earnings Calc
      hr_utility.set_location('py_za_tx_01032006.SeaCalc',3);
      -- Site Factor
      --
      ...
      IF l_65Year BETWEEN dbi_ZA_TX_YR_STRT AND dbi_ZA_TX_YR_END THEN
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',4);
         -- give the extra abatement
         trc_Rebate    := glb_ZA_PRI_TX_RBT + glb_ZA_ADL_TX_RBT;
         trc_Threshold := glb_ZA_SC_TX_THRSHLD;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',5);
         -- not eligable for extra abatement
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',6);
         -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',7);
         trc_TotLibBse := 0;
      END IF;
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',8);
         -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFpAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibBse);
      ElSE
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',9);
         trc_LibFpAP := 0;
      END IF;
   ...
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SeaCalc',10);
      -- Site Factor
      --
      trc_SitFactor := glb_ZA_WRK_DYS_PR_YR / dbi_SEA_WRK_DYS_WRK;
   ...
   hr_utility.set_location('py_za_tx_01032006.SeaCalc',11);
   ...
   --
      ...
      IF trc_NorIncPtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',12);
         -- Normal Earnings
         ...
         -- Threshold Check
         IF trc_TxbNorInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032006.SeaCalc',13);
            -- Tax Liability
            trc_TotLibNI := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbNorInc);
         ...
         ELSE
            hr_utility.set_location('py_za_tx_01032006.SeaCalc',14);
            trc_TotLibNI := 0;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',15);
         trc_NorErn    := 0;
         trc_TxbNorInc := 0;
         trc_TotLibNI  := 0;
      END IF;
   ...
   --
      ...
      IF trc_FrnBenPtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',16);
         -- Fringe Benefit Earnings
         ...
         -- Threshold Check
         IF trc_TxbFrnInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032006.SeaCalc',17);
            -- Tax Liability
            trc_TotLibFB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbFrnInc);
            trc_LibFyFB  := trc_TotLibFB - least(trc_TotLibFB,trc_TotLibNI);
            trc_TotLibFB := greatest(trc_TotLibFB,trc_TotLibNI);
         ...
         ELSE
            hr_utility.set_location('py_za_tx_01032006.SeaCalc',18);
            trc_TotLibFB := trc_TotLibNI;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',19);
         trc_FrnBenErn := trc_NorErn;
         trc_TxbFrnInc := trc_TxbNorInc;
         trc_TotLibFB  := trc_TotLibNI;
      END IF;
   ...
   --
      ...
      IF trc_AnnPymPtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',20);
         -- Annual Payments Earnings
         ...
         -- Threshold Check
         IF trc_TxbAnnPymInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032006.SeaCalc',21);
            -- Tax Liability
            trc_TotLibAP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         ...
         ELSE
            hr_utility.set_location('py_za_tx_01032006.SeaCalc',22);
            trc_TotLibAP := trc_TotLibFB;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',23);
   ...
   -- Net Pay Validation
   --
      py_za_tx_utl_01032006.ValidateTaxOns;

   hr_utility.set_location('py_za_tx_01032006.SeaCalc',24);

   -- Set IT3A Indicator
   --
      IF trc_TxbAnnPymInc + trc_PblOffErn >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',25);
         trc_It3Ind := 0; -- Over Lim
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SeaCalc',26);
         trc_It3Ind := 1; -- Under Lim
      END IF;
   END IF;
...
BEGIN
   ...
   hr_utility.set_location('py_za_tx_01032006.SitCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'SitCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01032006.SitCalc',2);
...
--
 trc_TxbIncYtd :=
   ...
   hr_utility.set_location('py_za_tx_01032006.SitCalc',3);

-- Site Factor
--
   trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01032006.DaysWorked;

   hr_utility.set_location('py_za_tx_01032006.SitCalc',4);
...
-- Abatements
   ...
   hr_utility.set_location('py_za_tx_01032006.SitCalc',5);
...
--
   ...
   IF trc_DmdRmnRun <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.SitCalc',6);
      -- Taxable Deemed Remuneration
      trc_TxbDmdRmn := trc_DmdRmnRun;
      -- Threshold Check
      IF trc_TxbDmdRmn >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SitCalc',7);
         -- Tax Liability
         trc_TotLibDR := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbDmdRmn);
         trc_LibFyDR  := (trc_TotLibDR - 0) / trc_SitFactor;
         trc_TotLibDR := greatest(trc_TotLibDR,0);
         trc_LibFpDR  := trc_LibFyDR - bal_TX_ON_DR_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SitCalc',8);
         -- Set Cascade Figures and Refund
         trc_TotLibDR   := 0;
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SitCalc',9);
      -- Set Cascade Figures and Refund
      trc_TxbDmdRmn  := 0;
      trc_TotLibDR   := 0;
      trc_LibFpDR    := -1 * bal_TX_ON_DR_YTD;
   ...
   hr_utility.set_location('py_za_tx_01032006.SitCalc',10);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.SitCalc',11);
      -- Normal Earnings
      ...
      -- Threshold Check
      IF trc_TxbNorInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SitCalc',12);
         -- Tax Liability
         trc_TotLibNI := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbNorInc);
         ...
         trc_LibFpNI  := trc_LibFyNI - bal_TX_ON_NI_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SitCalc',13);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SitCalc',14);
      -- Set Cascade Figures and Refund
      trc_NorErn     := 0;
      trc_TxbNorInc  := 0;
      trc_TotLibNI   := trc_TotLibDR;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.SitCalc',15);
      -- Fringe Benefit Earnings
      ...
      -- Threshold Check
      IF trc_TxbFrnInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SitCalc',16);
         -- Tax Liability
         trc_TotLibFB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbFrnInc);
         ...
         trc_LibFpFB  := trc_LibFyFB - bal_TX_ON_FB_YTD;
      ElSE
         hr_utility.set_location('py_za_tx_01032006.SitCalc',17);
         -- Set Cascade Figures and Refund
         trc_TotLibFB   := trc_TotLibNI;
         trc_LibFpFB    := -1 * bal_TX_ON_FB_YTD;
         trc_LibFpFBOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SitCalc',18);
      -- Set Cascade Figures and Refund
      trc_FrnBenErn  := trc_NorErn;
      trc_TxbFrnInc  := trc_TxbNorInc;
      trc_TotLibFB   := trc_TotLibNI;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.SitCalc',19);
      -- Travel Earnings
      ...
      -- Threshold Check
      IF trc_TxbTrvInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SitCalc',20);
         -- Tax Liability
         trc_TotLibTA := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbTrvInc);
         ...
         trc_LibFpTA  := trc_LibFyTA - bal_TX_ON_TA_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SitCalc',21);
         -- Set Cascade Figures and Refund
         trc_TotLibTA   := trc_TotLibFB;
         trc_LibFpTA    := -1 * bal_TX_ON_TA_YTD;
         trc_LibFpTAOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SitCalc',22);
      -- Set Cascade Figures and Refund
      trc_TrvAllErn  := trc_FrnBenErn;
      trc_TxbTrvInc  := trc_TxbFrnInc;
      trc_TotLibTA   := trc_TotLibFB;
...
--
   ...
   IF trc_BonProYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.SitCalc',23);
      ...
      IF trc_TxbBonProInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SitCalc',24);
         -- Tax Liability
         trc_TotLibBP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbBonProInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SitCalc',25);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SitCalc',26);
      -- Set Cascade Figures and Refund
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.SitCalc',27);
      -- Annual Bonus Earnings
      trc_AnnBonErn := trc_AnnBonYtd + trc_TrvAllErn;
      -- Taxable Annual Bonus Income
      trc_TxbAnnBonInc := trc_AnnBonErn - trc_AnnTotAbm;
      -- Threshold Check
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SitCalc',28);
         -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnBonInc);
         trc_LibFyAB := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibTA);
         trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibTA);
         hr_utility.set_location('py_za_tx_01032006.SitCalc',29);
         -- Check Bonus Provision
         IF trc_BonProYtd <> 0 THEN
            hr_utility.set_location('py_za_tx_01032006.SitCalc',30);
            -- Check Bonus Provision Frequency
            IF dbi_BP_TX_RCV = 'B' OR py_za_tx_utl_01032006.SitePeriod THEN
               hr_utility.set_location('py_za_tx_01032006.SitCalc',31);
               trc_LibFpAB :=
               trc_LibFyAB - (bal_TX_ON_BP_YTD
                             + trc_LibFpBP
                             + bal_TX_ON_AB_YTD);
            ELSE
               hr_utility.set_location('py_za_tx_01032006.SitCalc',32);
               trc_LibFpAB := 0;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.SitCalc',33);
            trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SitCalc',34);
         -- Set Cascade Figures and Refund
         trc_TotLibAB   := trc_TotLibTA;
         trc_LibFpAB    := -1 * bal_TX_ON_AB_YTD;
         trc_LibFpABOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SitCalc',35);
      -- Set Cascade Figures and Refund
      trc_LibFpAB      := -1 * bal_TX_ON_AB_YTD;
      trc_LibFpABOvr   := TRUE;

      IF dbi_BP_TX_RCV = 'A' AND py_za_tx_utl_01032006.SitePeriod THEN
         hr_utility.set_location('py_za_tx_01032006.SitCalc',36);
         trc_LibFpBP      := -1 * bal_TX_ON_BP_YTD;
         trc_LibFpBPOvr   := TRUE;
         trc_LibFpAPOvr   := TRUE;
         ...
         trc_TotLibAB     := trc_TotLibTA;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SitCalc',37);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.SitCalc',38);
      -- Annual Payments Earnings
      trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
      -- Taxable Annual Payments Income
      trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
      -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SitCalc',39);
         -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
         trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
         trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.SitCalc',40);
         -- Set Cascade Figures and Refund
         trc_TotLibAP   := trc_TotLibAB;
         trc_LibFpAP    := -1 * bal_TX_ON_AP_YTD;
         trc_LibFpAPOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SitCalc',41);
      -- Set Cascade Figures and Refund
      trc_AnnPymErn    := trc_AnnBonErn;
      trc_TxbAnnPymInc := trc_TxbAnnBonInc;
      trc_TotLibAP     := trc_TotLibAB;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.SitCalc',42);
      -- Public Office Allowance Earnings
      ...
      -- Threshold Check
      IF trc_TxbPblOffInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.SitCalc',43);
         -- Tax Liability
         trc_TotLibPO := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbPblOffInc);
         ...
         trc_LibFpPO  := trc_LibFyPO - bal_TX_ON_PO_YTD;
      ElSE
         hr_utility.set_location('py_za_tx_01032006.SitCalc',44);
         -- Set Cascade Figures and Refund
         trc_TotLibPO   := trc_TotLibAP;
         trc_LibFpPO    := -1 * bal_TX_ON_PO_YTD;
         trc_LibFpPOOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SitCalc',45);
      -- Set Cascade Figures and Refund
      trc_PblOffErn     := trc_AnnPymErn;
      trc_TxbPblOffInc  := trc_TxbAnnPymInc;
      trc_TotLibPO      := trc_TotLibAP;
...
--
   ...
   -- Site Limit Check
   IF trc_TxbAnnPymInc + trc_PblOffErn < glb_ZA_SIT_LIM THEN
      hr_utility.set_location('py_za_tx_01032006.SitCalc',46);
      l_Sl := TRUE;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SitCalc',47);
      l_Sl := FALSE;
   END IF;

   py_za_tx_utl_01032006.ValidateTaxOns(p_Rf => l_Sl);

   hr_utility.set_location('py_za_tx_01032006.SitCalc',48);

-- Set IT3A Indicator
--
   IF trc_TxbAnnPymInc + trc_PblOffErn >= trc_Threshold THEN
      hr_utility.set_location('py_za_tx_01032006.SitCalc',49);
      trc_It3Ind := 0; -- Over Lim
   ELSE
      hr_utility.set_location('py_za_tx_01032006.SitCalc',50);
      trc_It3Ind := 1; -- Under Lim
   END IF;
...
--
   ...
   hr_utility.set_location('py_za_tx_01032006.SitCalc',51);
...
BEGIN
   ...
   hr_utility.set_location('py_za_tx_01032006.DirCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'DirCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01032006.DirCalc',2);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',3);
      -- Normal Earnings
      trc_NorErn := trc_NorIncYtd;
      -- Tax Liability
      trc_TotLibNI := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_NorErn);
      trc_LibFyNI  := trc_TotLibNI - 0;
      trc_TotLibNI := greatest(trc_TotLibNI,0);
      trc_LibFpNI  := trc_LibFyNI - bal_TX_ON_NI_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.DirCalc',4);
      -- Set Cascade Figures and Refund
      trc_NorErn     := 0;
      trc_TotLibNI   := 0;
      trc_LibFpNI    := -1 * bal_TX_ON_NI_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',5);
      -- Fringe Benefit Earnings
      trc_FrnBenErn := trc_FrnBenYtd + trc_NorErn;
      -- Tax Liability
      trc_TotLibFB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_FrnBenErn);
      trc_LibFyFB  := trc_TotLibFB - least(trc_TotLibFB,trc_TotLibNI);
      trc_TotLibFB := greatest(trc_TotLibFB,trc_TotLibNI);
      trc_LibFpFB  := trc_LibFyFB - bal_TX_ON_FB_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.DirCalc',6);
      -- Set Cascade Figures and Refund
      trc_FrnBenErn  := trc_NorErn;
      trc_TotLibFB   := trc_TotLibNI;
      trc_LibFpFB    := -1 * bal_TX_ON_FB_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',7);
      -- Travel Allowance Earnings
      trc_TrvAllErn := trc_TrvAllYtd + trc_FrnBenErn;
      -- Tax Liability
      trc_TotLibTA := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TrvAllErn);
      trc_LibFyTA  := trc_TotLibTA - least(trc_TotLibTA,trc_TotLibFB);
      trc_TotLibTA := greatest(trc_TotLibTA,trc_TotLibFB);
      trc_LibFpTA  := trc_LibFyTA - bal_TX_ON_TA_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.DirCalc',8);
      -- Set Cascade Figures and Refund
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_BonProYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',9);
      -- Bonus Provision Earnings
      trc_BonProErn := trc_BonProYtd + trc_TrvAllErn;
      -- Tax Liability
      trc_TotLibBP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_BonProErn);
      trc_LibFyBP  := trc_TotLibBP - least(trc_TotLibBP,trc_TotLibTA);
      trc_TotLibBP := greatest(trc_TotLibBP,trc_TotLibTA);
      trc_LibFpBP  := trc_LibFyBP - bal_TX_ON_BP_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.DirCalc',10);
      -- Set Cascade Figures and Refund
      trc_BonProErn  := trc_TrvAllErn;
      trc_TotLibBP   := trc_TotLibTA;
      trc_LibFpBP    := -1 * bal_TX_ON_BP_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',11);
      -- Annual Bonus Earnings
      trc_AnnBonErn := trc_AnnBonYtd + trc_TrvAllErn;
      -- Tax Liability
      trc_TotLibAB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_AnnBonErn);
      trc_LibFyAB  := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibTA);
      trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibTA);
      -- Check Bonus Provision
      IF trc_BonProYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032006.DirCalc',12);
         -- Check Bonus Provision Frequency
         IF dbi_BP_TX_RCV = 'B' OR py_za_tx_utl_01032006.SitePeriod THEN
            hr_utility.set_location('py_za_tx_01032006.DirCalc',13);
            trc_LibFpAB :=
            trc_LibFyAB - (bal_TX_ON_BP_YTD
                          + trc_LibFpBP
                          + bal_TX_ON_AB_YTD);
         ELSE
            hr_utility.set_location('py_za_tx_01032006.DirCalc',14);
            trc_LibFpAB := 0;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.DirCalc',15);
         trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.DirCalc',16);
      -- Set Cascade Figures and Refund
      trc_LibFpAB    := -1 * bal_TX_ON_AB_YTD;
      trc_LibFpABOvr := TRUE;

      IF dbi_BP_TX_RCV = 'A' AND py_za_tx_utl_01032006.SitePeriod THEN
         hr_utility.set_location('py_za_tx_01032006.DirCalc',17);
         trc_LibFpBP    := -1 * bal_TX_ON_BP_YTD;
         trc_LibFpBPOvr := TRUE;
         trc_LibFpAPOvr := TRUE;
         ...
         trc_TotLibAB   := trc_TotLibTA;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.DirCalc',18);
         trc_AnnBonErn  := trc_BonProErn;
         trc_TotLibAB   := trc_TotLibBP;
      END IF;
   END IF;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',19);
      -- Annual Payments Earnings
      trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
      -- Tax Liability
      trc_TotLibAP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_AnnPymErn);
      trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
      trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
      trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
   ElSE
      hr_utility.set_location('py_za_tx_01032006.DirCalc',20);
      -- Set Cascade Figures and Refund
      trc_AnnPymErn  := trc_AnnBonErn;
      trc_TotLibAP   := trc_TotLibAB;
      trc_LibFpAP    := -1 * bal_TX_ON_AP_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',21);
      -- Public Office Allowance Earnings
      trc_PblOffErn := trc_PblOffYtd + trc_AnnPymErn;
      -- Tax Liability
      trc_TotLibPO := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_PblOffErn);
      trc_LibFyPO  := trc_TotLibPO - least(trc_TotLibPO,trc_TotLibAP);
      trc_TotLibPO := greatest(trc_TotLibPO,trc_TotLibAP);
      trc_LibFpPO  := trc_LibFyPO - bal_TX_ON_PO_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.DirCalc',22);
      -- Set Cascade Figures and Refund
      trc_PblOffErn  := trc_AnnPymErn;
      trc_TotLibPO   := trc_TotLibAP;
      trc_LibFpPO    := -1 * bal_TX_ON_PO_YTD;
...
-- Net Pay Validation
--
   py_za_tx_utl_01032006.ValidateTaxOns(p_Rf => TRUE);

   hr_utility.set_location('py_za_tx_01032006.DirCalc',23);

-- Tax Percentage Indicator
--
   IF dbi_TX_STA    IN ('D','P') THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',24);
      trc_TxPercVal := dbi_TX_DIR_VAL;
   ELSIF dbi_TX_STA = 'E' THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',25);
      trc_TxPercVal := glb_ZA_CC_TX_PRC;
   ELSIF dbi_TX_STA = 'F' THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',26);
      trc_TxPercVal := glb_ZA_TMP_TX_RTE;
   ELSIF dbi_TX_STA = 'J' THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',27);
      trc_TxPercVal := glb_ZA_PER_SERV_COMP_PERC;
   ELSIF dbi_TX_STA = 'K' THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',28);
      trc_TxPercVal := glb_ZA_PER_SERV_TRST_PERC;
   ELSIF dbi_TX_STA = 'L' THEN
      hr_utility.set_location('py_za_tx_01032006.DirCalc',29);
      trc_TxPercVal := glb_ZA_PER_SERV_COMP_PERC;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.DirCalc',30);
      trc_TxPercVal := 0;
   END IF;

   hr_utility.set_location('py_za_tx_01032006.DirCalc',31);
...
BEGIN
   ...
   hr_utility.set_location('py_za_tx_01032006.BasCalc',1);
-- Identify the Calculation
--
   trc_CalTyp := 'BasCalc';
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_DmdRmnRun <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.BasCalc',2);
      -- Taxable Deemed Remuneration
      trc_TxbDmdRmn := trc_DmdRmnRun;
      -- Threshold Check
      IF trc_TxbDmdRmn >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.BasCalc',3);
         -- Tax Liability
         trc_TotLibDR := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbDmdRmn);
      ELSE
         hr_utility.set_location('py_za_tx_01032006.BasCalc',4);
         trc_TotLibDR := 0;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.BasCalc',5);
      trc_TotLibDR := 0;
   END IF;

   hr_utility.set_location('py_za_tx_01032006.BasCalc',6);
...
--
   ...
   -- Threshold Check
   IF trc_TxbBseInc >= trc_Threshold THEN
      hr_utility.set_location('py_za_tx_01032006.BasCalc',7);
      -- Tax Liability
      trc_TotLibBse := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbBseInc);
      trc_TotLibBse := greatest(trc_TotLibBse,trc_TotLibDR);
   ELSE
      hr_utility.set_location('py_za_tx_01032006.BasCalc',8);
      trc_TotLibBse := trc_TotLibDR;
   END IF;

   hr_utility.set_location('py_za_tx_01032006.BasCalc',9);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.BasCalc',10);
      -- Annual Bonus Earnings
      ...
      -- Threshold Check
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.BasCalc',11);
         -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnBonInc);
         ...
         IF bal_BP_YTD <> 0 THEN
            hr_utility.set_location('py_za_tx_01032006.BasCalc',12);
            -- Check Bonus Provision Frequency
            IF dbi_BP_TX_RCV = 'A' THEN
               hr_utility.set_location('py_za_tx_01032006.BasCalc',13);
               trc_LibFpAB := 0;
            ELSE
               hr_utility.set_location('py_za_tx_01032006.BasCalc',14);
               trc_LibFpAB := trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                            + bal_TX_ON_AB_YTD);
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.BasCalc',15);
            trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.BasCalc',16);
         trc_TotLibAB := trc_TotLibBse;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.BasCalc',17);
      trc_TotLibAB     := trc_TotLibBse;
      trc_TxbAnnBonInc := trc_TxbBseInc;
   END IF;

   hr_utility.set_location('py_za_tx_01032006.BasCalc',18);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.BasCalc',19);
   -- Taxable Annual Payments Income
      trc_TxbAnnPymInc := trc_AnnPymYtd + trc_TxbAnnBonInc;
   -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.BasCalc',20);
      -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
         trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
         trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.BasCalc',21);
         NULL;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.BasCalc',22);
      NULL;
   END IF;
...
BEGIN
   ...
   hr_utility.set_location('py_za_tx_01032006.CalCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'CalCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01032006.CalCalc',2);
...
--
   IF trc_TxbIncYtd = 0 THEN
      hr_utility.set_location('py_za_tx_01032006.CalCalc',3);
      BasCalc;
   ELSE -- continue CalCalc
      hr_utility.set_location('py_za_tx_01032006.CalCalc',4);
   -- Site Factor
   --
      trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01032006.DaysWorked;
   ...
   -- Abatements
      ...
      hr_utility.set_location('py_za_tx_01032006.CalCalc',5);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_DmdRmnRun <> 0 THEN
         hr_utility.set_location('py_za_tx_01032006.CalCalc',6);
         -- Taxable Deemed Remuneration
         trc_TxbDmdRmn := trc_DmdRmnRun;
         -- Threshold Check
         IF trc_TxbDmdRmn >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032006.CalCalc',7);
         -- Tax Liability
            trc_TotLibDR := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbDmdRmn);
         ELSE
            hr_utility.set_location('py_za_tx_01032006.CalCalc',8);
            trc_TotLibDR := 0;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.CalCalc',9);
         trc_TotLibDR := 0;
      END IF;

      hr_utility.set_location('py_za_tx_01032006.CalCalc',10);
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.CalCalc',11);
         -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbBseInc);
         trc_TotLibBse := greatest(trc_TotLibBse,trc_TotLibDR);
      ELSE
         hr_utility.set_location('py_za_tx_01032006.CalCalc',12);
         trc_TotLibBse := trc_TotLibDR;
      END IF;

      hr_utility.set_location('py_za_tx_01032006.CalCalc',13);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnBonYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032006.CalCalc',14);
         -- Annual Bonus Earnings
         ...
         -- Threshold Check
         IF trc_TxbAnnBonInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032006.CalCalc',15);
            -- Tax Liability
            trc_TotLibAB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnBonInc);
            trc_LibFyAB := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibBse);
            trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibBse);
            -- Check Bonus Provision
            IF bal_BP_YTD <> 0 THEN
               hr_utility.set_location('py_za_tx_01032006.CalCalc',16);
               -- Check Bonus Provision Frequency
               IF dbi_BP_TX_RCV = 'A' THEN
                  hr_utility.set_location('py_za_tx_01032006.CalCalc',17);
                  trc_LibFpAB := 0;
               ELSE
                  hr_utility.set_location('py_za_tx_01032006.CalCalc',18);
                  trc_LibFpAB := trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                               + bal_TX_ON_AB_YTD);
               END IF;
            ELSE
               hr_utility.set_location('py_za_tx_01032006.CalCalc',19);
               trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.CalCalc',20);
            trc_TotLibAB := trc_TotLibBse;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.CalCalc',21);
         trc_AnnBonErn    := trc_BseErn;
         trc_TxbAnnBonInc := trc_TxbBseInc;
         trc_TotLibAB     := trc_TotLibBse;
      END IF;

      hr_utility.set_location('py_za_tx_01032006.CalCalc',22);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnPymYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032006.CalCalc',23);
         -- Annual Payments Earnings
         trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
         -- Taxable Annual Payments Income
         trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
         -- Threshold Check
         IF trc_TxbAnnPymInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032006.CalCalc',24);
            -- Tax Liability
            trc_TotLibAP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnPymInc);
            trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
            trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
            trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.CalCalc',25);
            trc_TotLibAP := trc_TotLibAB;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.CalCalc',26);
         trc_AnnPymErn    := trc_AnnBonErn;
         trc_TxbAnnPymInc := trc_TxbAnnBonInc;
         trc_TotLibAP     := trc_TotLibAB;
      END IF;
   ...
   hr_utility.set_location('py_za_tx_01032006.CalCalc',27);
...
BEGIN
   ...
   hr_utility.set_location('py_za_tx_01032006.YtdCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'YtdCalc';
...
-- Update Global Balance Values with correct TAXABLE values
   ...
   hr_utility.set_location('py_za_tx_01032006.YtdCalc',2);
...
-- If the Ytd Taxable Income = 0, execute the CalCalc
   IF trc_TxbIncYtd = 0 THEN
      hr_utility.set_location('py_za_tx_01032006.YtdCalc',3);
      CalCalc;
   ELSE --Continue YtdCalc
      hr_utility.set_location('py_za_tx_01032006.YtdCalc',4);
   -- Site Factor
      trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01032006.DaysWorked;
   ...
   -- Abatements
      ...
      hr_utility.set_location('py_za_tx_01032006.YtdCalc',5);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_DmdRmnRun <> 0 THEN
         hr_utility.set_location('py_za_tx_01032006.YtdCalc',6);
         -- Taxable Deemed Remuneration
         trc_TxbDmdRmn := trc_DmdRmnRun;
         -- Threshold Check
         IF trc_TxbDmdRmn >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032006.YtdCalc',7);
            -- Tax Liability
            trc_TotLibDR := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbDmdRmn);
         ELSE
            hr_utility.set_location('py_za_tx_01032006.YtdCalc',8);
            trc_TotLibDR := 0;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.YtdCalc',9);
         trc_TotLibDR := 0;
      END IF;

      hr_utility.set_location('py_za_tx_01032006.YtdCalc',10);
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.YtdCalc',11);
         -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbBseInc);
         trc_TotLibBse := greatest(trc_TotLibBse,trc_TotLibDR);
      ELSE
         hr_utility.set_location('py_za_tx_01032006.YtdCalc',12);
         trc_TotLibBse := trc_TotLibDR;
      END IF;

      hr_utility.set_location('py_za_tx_01032006.YtdCalc',13);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnBonYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032006.YtdCalc',14);
         -- Annual Bonus Earnings
         trc_AnnBonErn := trc_AnnBonYtd + trc_BseErn;
         -- Taxable Annual Bonus Income
         trc_TxbAnnBonInc := trc_AnnBonErn - trc_AnnTotAbm;
         -- Threshold Check
         IF trc_TxbAnnBonInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032006.YtdCalc',15);
            -- Tax Liability
            trc_TotLibAB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnBonInc);
            trc_LibFyAB  := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibBse);
            trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibBse);
            -- Check Bonus Provision
            IF bal_BP_YTD <> 0 THEN
               hr_utility.set_location('py_za_tx_01032006.YtdCalc',16);
               -- Check Bonus Provision Frequency
               IF dbi_BP_TX_RCV = 'A' THEN
                  hr_utility.set_location('py_za_tx_01032006.YtdCalc',17);
                  trc_LibFpAB := 0;
               ELSE
                  hr_utility.set_location('py_za_tx_01032006.YtdCalc',18);
                  trc_LibFpAB := trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                               + bal_TX_ON_AB_YTD);
               END IF;
            ELSE
               hr_utility.set_location('py_za_tx_01032006.YtdCalc',19);
               trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.YtdCalc',20);
            trc_TotLibAB := trc_TotLibBse;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.YtdCalc',21);
         trc_AnnBonErn    := trc_BseErn;
         trc_TxbAnnBonInc := trc_TxbBseInc;
         trc_TotLibAB     := trc_TotLibBse;
      END IF;

      hr_utility.set_location('py_za_tx_01032006.YtdCalc',22);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnPymYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032006.YtdCalc',23);
         -- Annual Payments Earnings
         trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
         -- Taxable Annual Payments Income
         trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
         -- Threshold Check
         IF trc_TxbAnnPymInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032006.YtdCalc',24);
            -- Tax Liability
            trc_TotLibAP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnPymInc);
            trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
            trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
            trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.YtdCalc',25);
            trc_TotLibAP := trc_TotLibAB;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.YtdCalc',26);
         trc_AnnPymErn    := trc_AnnBonErn;
         trc_TxbAnnPymInc := trc_TxbAnnBonInc;
         trc_TotLibAP     := trc_TotLibAB;
      END IF;
   ...
   --
      ...
      hr_utility.set_location('py_za_tx_01032006.YtdCalc',27);
...
BEGIN
   ...
   hr_utility.set_location('py_za_tx_01032006.NorCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'NorCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01032006.NorCalc',2);
...
-- Period Factor
   py_za_tx_utl_01032006.PeriodFactor;

-- Possible Periods Factor
   py_za_tx_utl_01032006.PossiblePeriodsFactor;
...
-- Abatements
   ...
   hr_utility.set_location('py_za_tx_01032006.NorCalc',3);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_DmdRmnRun <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.NorCalc',4);
      -- Taxable Deemed Remuneration
      trc_TxbDmdRmn := trc_DmdRmnRun;
      -- Threshold Check
      IF trc_TxbDmdRmn >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.NorCalc',5);
         -- Tax Liability
         trc_TotLibDR := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbDmdRmn);
         trc_LibFyDR  := trc_TotLibDR - 0;
         trc_TotLibDR := greatest(trc_TotLibDR,0);
         -- DeAnnualise
         trc_LibFpDR := py_za_tx_utl_01032006.DeAnnualise
                           ( p_Liab    => trc_LibFyDR
                           , p_TxOnYtd => bal_TX_ON_DR_YTD
                           , p_TxOnPtd => bal_TX_ON_DR_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032006.NorCalc',6);
         -- Set Cascade Figures and Refund
         trc_TotLibDR   := 0;
         trc_LibFpDR    := -1 * bal_TX_ON_DR_YTD;
         trc_LibFpDROvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.NorCalc',7);
      -- Set Cascade Figures and Refund
      trc_TxbDmdRmn  := 0;
      trc_TotLibDR   := 0;
      trc_LibFpDR    := -1 * bal_TX_ON_DR_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.NorCalc',8);

      -- Annualise Normal Income
      trc_NorErn := py_za_tx_utl_01032006.Annualise
      ...
      -- Threshold Check
      IF trc_TxbNorInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.NorCalc',9);
         -- Tax Liability
         trc_TotLibNI := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbNorInc);
         trc_LibFyNI  := trc_TotLibNI - least(trc_TotLibNI,trc_TotLibDR);
         trc_TotLibNI := greatest(trc_TotLibNI,trc_TotLibDR);
         -- DeAnnualise
         trc_LibFpNI := py_za_tx_utl_01032006.DeAnnualise
                           ( p_Liab    => trc_LibFyNI
                           , p_TxOnYtd => bal_TX_ON_NI_YTD
                           , p_TxOnPtd => bal_TX_ON_NI_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032006.NorCalc',10);
         -- Set Cascade Figures and Refund
         trc_TotLibNI   := trc_TotLibDR;
         trc_LibFpNI    := -1 * bal_TX_ON_NI_YTD;
         trc_LibFpNIOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.NorCalc',11);
      -- Set Cascade Figures and Refund
      trc_NorErn     := 0;
      trc_TxbNorInc  := 0;
      trc_TotLibNI   := trc_TotLibDR;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.NorCalc',12);

      -- Annualise Fringe Benefits
      trc_FrnBenErn := py_za_tx_utl_01032006.Annualise
      ...
      -- Threshold Check
      IF trc_TxbFrnInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.NorCalc',13);
         -- Tax Liability
         trc_TotLibFB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbFrnInc);
         trc_LibFyFB  := trc_TotLibFB - least(trc_TotLibFB,trc_TotLibNI);
         trc_TotLibFB := greatest(trc_TotLibFB,trc_TotLibNI);
         -- DeAnnualise
         trc_LibFpFB := py_za_tx_utl_01032006.DeAnnualise
                           ( trc_LibFyFB
                           , bal_TX_ON_FB_YTD
                           , bal_TX_ON_FB_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032006.NorCalc',14);
         -- Set Cascade Figures and Refund
         trc_TotLibFB   := trc_TotLibNI;
         trc_LibFpFB    := -1 * bal_TX_ON_FB_YTD;
         trc_LibFpFBOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.NorCalc',15);
      -- Set Cascade Figures and Refund
      trc_FrnBenErn  := trc_NorErn;
      trc_TxbFrnInc  := trc_TxbNorInc;
      trc_TotLibFB   := trc_TotLibNI;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.NorCalc',16);
      -- Ptd Travel Allowance
      trc_TrvAllPtd := bal_TOT_TXB_TA_PTD;
      -- Annualise Travel Allowance
      trc_TrvAllErn := py_za_tx_utl_01032006.Annualise
      ...
      -- Threshold Check
      IF trc_TxbTrvInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.NorCalc',17);
         -- Tax Liability
         trc_TotLibTA := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbTrvInc);
         trc_LibFyTA  := trc_TotLibTA - least(trc_TotLibTA,trc_TotLibFB);
         trc_TotLibTA := greatest(trc_TotLibTA,trc_TotLibFB);
         -- DeAnnualise
         trc_LibFpTA := py_za_tx_utl_01032006.DeAnnualise
                           ( trc_LibFyTA
                           , bal_TX_ON_TA_YTD
                           , bal_TX_ON_TA_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032006.NorCalc',18);
         -- Set Cascade Figures and Refund
         trc_TotLibTA   := trc_TotLibFB;
         trc_LibFpTA    := -1 * bal_TX_ON_TA_YTD;
         trc_LibFpTAOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.NorCalc',19);
      -- Set Cascade Figures and Refund
      trc_TrvAllErn  := trc_FrnBenErn;
      trc_TxbTrvInc  := trc_TxbFrnInc;
      trc_TotLibTA   := trc_TotLibFB;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_BonProYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.NorCalc',20);
      -- Annualise Bonus Provision
      trc_BonProErn := py_za_tx_utl_01032006.Annualise
      ...
      -- Threshold Check
      IF trc_TxbBonProInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.NorCalc',21);
         -- Tax Liability
         trc_TotLibBP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbBonProInc);
         trc_LibFyBP  := trc_TotLibBP - least(trc_TotLibBP,trc_TotLibTA);
         trc_TotLibBP := greatest(trc_TotLibBP,trc_TotLibTA);
         -- DeAnnualise
         trc_LibFpBP := py_za_tx_utl_01032006.DeAnnualise
                           ( trc_LibFyBP
                           , bal_TX_ON_BP_YTD
                           , bal_TX_ON_BP_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032006.NorCalc',22);
         -- Set Cascade Figures and Refund
         trc_TotLibBP   := trc_TotLibTA;
         trc_LibFpBP    := -1 * bal_TX_ON_BP_YTD;
         trc_LibFpBPOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.NorCalc',23);
      -- Set Cascade Figures and Refund
      trc_BonProErn    := trc_TrvAllErn;
      trc_TxbBonProInc := trc_TxbTrvInc;
      trc_TotLibBP     := trc_TotLibTA;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.NorCalc',24);
      -- Annual Bonus Earnings
      trc_AnnBonErn := trc_AnnBonYtd + trc_TrvAllErn;
      -- Taxable Annual Bonus Income
      trc_TxbAnnBonInc := trc_AnnBonErn - trc_AnnTotAbm;
      -- Threshold Check
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.NorCalc',25);
         -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnBonInc);
         trc_LibFyAB  := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibTA);
         trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibTA);
         -- Check Bonus Provision
         IF trc_BonProYtd <> 0 THEN
            hr_utility.set_location('py_za_tx_01032006.NorCalc',26);
            -- Check Bonus Provision Frequency
            IF dbi_BP_TX_RCV = 'A' THEN
               hr_utility.set_location('py_za_tx_01032006.NorCalc',27);
               trc_LibFpAB := 0;
            ELSE
               hr_utility.set_location('py_za_tx_01032006.NorCalc',28);
               trc_LibFpAB := trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                            + trc_LibFpBP
                                            + bal_TX_ON_AB_YTD);
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.NorCalc',29);
            trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.NorCalc',30);
         -- Set Cascade Figures and Refund
         trc_TotLibAB   := trc_TotLibTA;
         trc_LibFpAB    := -1 * bal_TX_ON_AB_YTD;
         trc_LibFpABOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.NorCalc',31);
      -- Set Cascade Figures and Refund
      trc_AnnBonErn    := trc_BonProErn;
      trc_TxbAnnBonInc := trc_TxbBonProInc;
      trc_TotLibAB     := trc_TotLibBP;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.NorCalc',32);
      -- Annual Payments Earnings
      trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
      -- Taxable Annual Payments Income
      trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
      -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.NorCalc',33);
         -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
         trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
         hr_utility.set_location('py_za_tx_01032006.NorCalc',34);
         trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.NorCalc',35);
         -- Set Cascade Figures and Refund
         trc_TotLibAP   := trc_TotLibAB;
         trc_LibFpAP    := -1 * bal_TX_ON_AP_YTD;
         trc_LibFpAPOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.NorCalc',36);
      -- Set Cascade Figures and Refund
      trc_AnnPymErn    := trc_AnnBonErn;
      trc_TxbAnnPymInc := trc_TxbAnnBonInc;
      trc_TotLibAP     := trc_TotLibAB;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032006.NorCalc',37);
      -- Ptd Public Office Allowance
      trc_PblOffPtd := bal_TOT_TXB_PO_PTD;
      -- Annualise Public Office Allowance
      trc_PblOffErn := py_za_tx_utl_01032006.Annualise
      ...
      -- Threshold Check
      IF trc_TxbPblOffInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032006.NorCalc',38);
         -- Tax Liability
         trc_TotLibPO := py_za_tx_utl_01032006.TaxLiability(p_Amt => trc_TxbPblOffInc);
         trc_LibFyPO  := trc_TotLibPO - least(trc_TotLibPO,trc_TotLibAP);
         trc_TotLibPO := greatest(trc_TotLibPO,trc_TotLibAP);
         -- DeAnnualise
         trc_LibFpPO := py_za_tx_utl_01032006.DeAnnualise
                           ( trc_LibFyPO
                           , bal_TX_ON_PO_YTD
                           , bal_TX_ON_PO_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032006.NorCalc',39);
         -- Set Cascade Figures and Refund
         trc_TotLibPO   := trc_TotLibAP;
         trc_LibFpPO    := -1 * bal_TX_ON_PO_YTD;
         trc_LibFpPOOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.NorCalc',40);
      -- Set Cascade Figures and Refund
      trc_PblOffErn     := trc_AnnPymErn;
      trc_TxbPblOffInc  := trc_TxbAnnPymInc;
      trc_TotLibPO      := trc_TotLibAP;
...
--
   ...
   hr_utility.set_location('py_za_tx_01032006.NorCalc',41);
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxGlb_01032006: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxGlb_01032006;
-------------------------------------------------------------------------------
-- ZaTxDbi_01032006                                                          --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxDbi_01032006: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxDbi_01032006;
-------------------------------------------------------------------------------
-- ZaTxBal1_01032006                                                         --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal1_01032006: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal1_01032006;
-------------------------------------------------------------------------------
-- ZaTxBal2_01032006                                                         --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal2_01032006: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal2_01032006;
-------------------------------------------------------------------------------
-- ZaTxBal3_01032006                                                         --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal3_01032006: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal3_01032006;
-------------------------------------------------------------------------------
-- ZaTxBal4_01032006                                                         --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal4_01032006: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal4_01032006;
-------------------------------------------------------------------------------
-- ZaTxBal5_01032006                                                         --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal5_01032006: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal5_01032006;
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal6_01032006: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal6_01032006;
...
--
--      py_za_tx_utl_01032006.g_HrTraceEnabled  := TRUE;
--      py_za_tx_utl_01032006.g_HrTracePipeName := 'ZATAX';

-- Call hr_utility start procedure
   py_za_tx_utl_01032006.StartHrTrace;
...
-- Setup Trace Header Info
   ...
   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',1);
...
-- Contexts
   ...
   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',2);
...
--
   ...
   */
   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',3);
...
--
   IF dbi_TX_STA IN ('C','N') THEN
      IF trc_OvrTxCalc AND (trc_OvrTyp = 'S' OR trc_OvrTyp = 'P') THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',4);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',5);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_C';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',6);
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',7);
         trc_CalTyp := 'OvrCalc';
      ...
      ELSIF dbi_TX_DIR_NUM = 'NULL' THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',8);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',9);
            xpt_Msg := 'PY_ZA_TX_DIR_NUM';
         END IF;
         RAISE xpt_E;
      -- Check that directive value is filled in
      ELSIF dbi_TX_DIR_VAL = -1 THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',10);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',11);
            xpt_Msg := 'PY_ZA_TX_DIR_MONT';
         END IF;
         RAISE xpt_E;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',12);
         trc_CalTyp := 'NoCalc';
...
--
   ELSIF dbi_TX_STA IN ('D','P') THEN
      IF trc_OvrTxCalc AND trc_OvrTyp = 'S' THEN
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',13);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_DEF';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',14);
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',15);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'P' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',16);
            trc_OvrWrn := 'WARNING: Tax Override - '||to_char(trc_OvrPrc)||' Percent';
            -- Percentage taken into account in py_za_tx_utl_01032006.TaxLiability
         END IF;
         -- Check Directive Number First
         IF dbi_TX_DIR_NUM = 'NULL' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',17);
            IF xpt_Msg = 'No Error' THEN
               hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',18);
               xpt_Msg := 'PY_ZA_TX_DIR_NUM';
            END IF;
            RAISE xpt_E;
         -- Check that directive value is filled in
         ELSIF dbi_TX_DIR_VAL = -1 THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',19);
            IF xpt_Msg = 'No Error' THEN
               hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',20);
               xpt_Msg := 'PY_ZA_TX_DIR_PERC';
            END IF;
            RAISE xpt_E;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',21);
            DirCalc;
         END IF;
      END IF;
-- E = Close Corporation
...
--
   ELSIF dbi_TX_STA IN ('E','F','J','K','L') THEN
      IF trc_OvrTxCalc AND trc_OvrTyp = 'S' THEN
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',22);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_DEF';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',23);
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',24);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'P' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',25);
            trc_OvrWrn := 'WARNING: Tax Override - '||to_char(trc_OvrPrc)||' Percent';
            -- Percentage taken into account in py_za_tx_utl_01032006.TaxLiability
         END IF;
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',26);
...
--
   ELSIF dbi_TX_STA = 'G' THEN
      IF trc_OvrTxCalc AND (trc_OvrTyp = 'S' OR trc_OvrTyp = 'P') THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',27);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',28);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_G';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',29);
      -- Check that seasonal worker days worked is filled in
      ELSIF dbi_SEA_WRK_DYS_WRK = 0 THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',30);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',31);
            xpt_Msg := 'PY_ZA_TX_SEA_WRK_DYS';
         END IF;
         RAISE xpt_E;
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',32);
            trc_CalTyp := 'OvrCalc';
            trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
            py_za_tx_utl_01032006.SetRebates;
         ELSE
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',33);
            SeaCalc;
         END IF;
      END IF;
-- A = Normal
...
--
   ELSIF dbi_TX_STA IN ('A','B','M') THEN
      IF dbi_TX_STA <> 'M' THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',34);
         -- Deemed Remuneration only applicable to 'M'
         bal_DIR_DMD_RMN_ITD := 0;
      END IF;

      IF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',35);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
         py_za_tx_utl_01032006.SetRebates;
         trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01032006.DaysWorked;
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'S' THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',36);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Forced Site Calculation';
         -- Force the Site Calculation
         SitCalc;
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',37);
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'P' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',38);
            trc_OvrWrn := 'WARNING: Tax Override - '||to_char(trc_OvrPrc)||' Percent';
            -- Percentage taken into account in py_za_tx_utl_01032006.TaxLiability
         END IF;

         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',39);
         IF py_za_tx_utl_01032006.LatePayPeriod THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',40);
            LteCalc;
         -- Is this a SITE Period?
         ELSIF py_za_tx_utl_01032006.EmpTermPrePeriod THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',41);
            SitCalc;
         ELSIF py_za_tx_utl_01032006.LstPeriod OR py_za_tx_utl_01032006.EmpTermInPeriod THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',42);
            IF py_za_tx_utl_01032006.PreErnPeriod THEN
               hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',43);
               YtdCalc;
            ELSE
               hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',44);
               SitCalc;
            END IF;
         ElSE
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',45);
            -- The employee has NOT been terminated!
            IF py_za_tx_utl_01032006.PreErnPeriod THEN
               hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',46);
               YtdCalc;
           -- Bug 4346955 Bug 5148830
          /*  ELSIF dbi_ZA_ASG_TX_RTR_PRD = 'Y' THEN
               hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',47);
               IF dbi_ZA_ASG_TAX_RTR_RSLTS = 'Y' THEN
                  hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',48);
                  SitCalc;
               ELSIF py_za_tx_utl_01032006.NegPtd THEN
                  hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',49);
                  SitCalc;
               ELSE
                  hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',50);
                  NorCalc;
               END IF; */
            ELSIF py_za_tx_utl_01032006.NegPtd THEN
               hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',51);
               SitCalc;
            ELSE
               hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',52);
               NorCalc;
            END IF;
         END IF;
      END IF;
...
--
   ELSIF dbi_TX_STA IN ('H','Q') THEN
      IF trc_OvrTxCalc THEN
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',53);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',54);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_H';
         END IF;
         RAISE xpt_E;
      ELSE
         hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',55);
         trc_LibFpNI := -1 * bal_TX_ON_NI_YTD;
         trc_LibFpFB := -1 * bal_TX_ON_FB_YTD;
         trc_LibFpTA := -1 * bal_TX_ON_TA_YTD;
         trc_LibFpBP := -1 * bal_TX_ON_BP_YTD;
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',56);
      hr_utility.set_message(801, 'ERROR: Invalid Tax Status');
      hr_utility.raise_error;
   END IF;

   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',57);

-- Post Calculation Steps
--
   py_za_tx_utl_01032006.SitPaySplit;

   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',58);

-- Execute the Arrear Processing
--
   IF py_za_tx_utl_01032006.SitePeriod THEN
      hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',59);
      py_za_tx_utl_01032006.ArrearExcess;
   END IF;

   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',60);

-- Calculate Net Taxable Income
--
   NetTxbIncCalc;

   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',61);
--
-- Tax on Lump Sums
--
...
--
   ...
   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',62);
   ...
   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',63);
   ...
   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',64);
...
--
   py_za_tx_utl_01032006.Trace;

   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',65);

-- Clear Globals
--
   py_za_tx_utl_01032006.ClearGlobals;

   hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',66);
...
-- Call hr_utility stop procedure
   py_za_tx_utl_01032006.StopHrTrace;
...
EXCEPTION
   WHEN xpt_FxdPrc THEN
      hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',67);
      ...
      hr_utility.raise_error;
   WHEN xpt_E  THEN
      hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',68);
      ...
      hr_utility.raise_error;
   WHEN OTHERS THEN
      hr_utility.set_location('py_za_tx_01032006.ZaTx_01032006',69);
      WrtHrTrc('Sql error code: '||TO_CHAR(SQLCODE));
      WrtHrTrc('Sql error msg: '||SUBSTR(SQLERRM(SQLCODE), 1, 100));
      py_za_tx_utl_01032006.StopHrTrace;
      hr_utility.set_message(801, 'ZaTx_01032006: '||TO_CHAR(SQLCODE));
      py_za_tx_utl_01032006.ClearGlobals;
      hr_utility.raise_error;
END ZaTx_01032006;
