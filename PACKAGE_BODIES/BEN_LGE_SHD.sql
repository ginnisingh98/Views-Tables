--------------------------------------------------------
--  DDL for Package Body BEN_LGE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LGE_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_lge_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_LER_CHG_PGM_ENRT_F_PK') Then
...
--
  ...
  Cursor C_Sel1 is
    ...
    where	ler_chg_pgm_enrt_id = p_ler_chg_pgm_enrt_id
...
Begin
  ...
  If (p_effective_date is null or
      p_ler_chg_pgm_enrt_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_ler_chg_pgm_enrt_id = g_old_rec.ler_chg_pgm_enrt_id and
...
--
  ...
  Cursor C_Sel1 Is
    ...
    where   t.ler_chg_pgm_enrt_id = p_base_key_value
    and     p_effective_date
...
Begin
  ...
  --
  update  ben_ler_chg_pgm_enrt_f t
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_ler_chg_pgm_enrt_f',
	 p_base_key_column	   => 'ler_chg_pgm_enrt_id',
	 p_base_key_value 	   => p_ler_chg_pgm_enrt_id,
	 p_parent_table_name1      => 'ben_ler_f',
	 p_parent_key_column1      => 'ler_id',
...
Begin
  ...
  l_rec.lge_attribute_category           := p_lge_attribute_category;
  l_rec.lge_attribute1                   := p_lge_attribute1;
  l_rec.lge_attribute2                   := p_lge_attribute2;
  l_rec.lge_attribute3                   := p_lge_attribute3;
  l_rec.lge_attribute4                   := p_lge_attribute4;
  l_rec.lge_attribute5                   := p_lge_attribute5;
  l_rec.lge_attribute6                   := p_lge_attribute6;
  l_rec.lge_attribute7                   := p_lge_attribute7;
  l_rec.lge_attribute8                   := p_lge_attribute8;
  l_rec.lge_attribute9                   := p_lge_attribute9;
  l_rec.lge_attribute10                  := p_lge_attribute10;
  l_rec.lge_attribute11                  := p_lge_attribute11;
  l_rec.lge_attribute12                  := p_lge_attribute12;
  l_rec.lge_attribute13                  := p_lge_attribute13;
  l_rec.lge_attribute14                  := p_lge_attribute14;
  l_rec.lge_attribute15                  := p_lge_attribute15;
  l_rec.lge_attribute16                  := p_lge_attribute16;
  l_rec.lge_attribute17                  := p_lge_attribute17;
  l_rec.lge_attribute18                  := p_lge_attribute18;
  l_rec.lge_attribute19                  := p_lge_attribute19;
  l_rec.lge_attribute20                  := p_lge_attribute20;
  l_rec.lge_attribute21                  := p_lge_attribute21;
  l_rec.lge_attribute22                  := p_lge_attribute22;
  l_rec.lge_attribute23                  := p_lge_attribute23;
  l_rec.lge_attribute24                  := p_lge_attribute24;
  l_rec.lge_attribute25                  := p_lge_attribute25;
  l_rec.lge_attribute26                  := p_lge_attribute26;
  l_rec.lge_attribute27                  := p_lge_attribute27;
  l_rec.lge_attribute28                  := p_lge_attribute28;
  l_rec.lge_attribute29                  := p_lge_attribute29;
  l_rec.lge_attribute30                  := p_lge_attribute30;
