--------------------------------------------------------
--  DDL for Package Body BEN_PER_CM_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PER_CM_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_PER_CM_BK2.UPDATE_PER_CM_A', 10);
hr_utility.set_location(' Leaving: BEN_PER_CM_BK2.UPDATE_PER_CM_A', 20);
end UPDATE_PER_CM_A;
...
begin
hr_utility.set_location('Entering: BEN_PER_CM_BK2.UPDATE_PER_CM_B', 10);
hr_utility.set_location(' Leaving: BEN_PER_CM_BK2.UPDATE_PER_CM_B', 20);
end UPDATE_PER_CM_B;
end BEN_PER_CM_BK2;
