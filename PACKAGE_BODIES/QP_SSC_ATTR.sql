--------------------------------------------------------
--  DDL for Package Body QP_SSC_ATTR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."QP_SSC_ATTR" AS
/* $Header: QPXASSCB.pls 120.0 2005/06/02 00:23:16 appldev noship $ */

--  Global constant holding the package name

G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'QP_SSC_ATTR';
...
BEGIN
    ...
    l_attr_rec.column              := 'APPLICATION_SHORT_NAME';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 30;
    l_attr_rec.name                := 'application_short_name';
    l_attr_rec.code                := 'application_short_name';
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'PTE_SOURCE_SYSTEM_ID';
    l_attr_rec.type                := 'NUMBER';
    l_attr_rec.name                := 'pte_source_system';
    l_attr_rec.code                := 'pte_source_system_id';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
