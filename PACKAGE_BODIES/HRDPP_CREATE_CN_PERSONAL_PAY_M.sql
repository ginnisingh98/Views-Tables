--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_CN_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_CN_PERSONAL_PAY_M" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:41
 * Generated for API: HR_CN_PERSONAL_PAY_METHOD_API.CREATE_CN_PERSONAL_PAY_METHOD
 */
--
...
decode(l.pval031,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval031,'PAYEE_TYPE',d(l.pval001),l.pval042)) p31,
l.pval031 d31,
l.pval032 p32,
l.pval033 p33,
l.pval034 p34,
...
(P_ORG_PAYMENT_METHOD_USER_KEY => c.p39);
end if;
--
L_PAYEE_ID := 
...
,P_PAYEE_ORG => c.p40
,P_PAYEE_PERSON_USER_KEY => c.p41
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p42);
--
hr_data_pump.api_trc_on;
HR_CN_PERSONAL_PAY_METHOD_API.CREATE_CN_PERSONAL_PAY_METHOD
...
,P_BANK_NAME => c.p27
,P_BANK_BRANCH => c.p28
,P_BANK_ACCOUNT_NUMBER => c.p29
,P_CONCAT_SEGMENTS => c.p30
,P_PAYEE_TYPE => c.p31
,P_PAYEE_ID => L_PAYEE_ID
,P_PERSONAL_PAYMENT_METHOD_ID => L_PERSONAL_PAYMENT_METHOD_ID
,P_EXTERNAL_ACCOUNT_ID => c.p33
,P_OBJECT_VERSION_NUMBER => c.p34
,P_EFFECTIVE_START_DATE => c.p35
,P_EFFECTIVE_END_DATE => c.p36
,P_COMMENT_ID => c.p37);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p32,L_PERSONAL_PAYMENT_METHOD_ID);
--
...
end hrdpp_CREATE_CN_PERSONAL_PAY_M;
