--------------------------------------------------------
--  DDL for Package Body BEN_SHR_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_SHR_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_shr_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  If (p_datetrack_mode = 'CORRECTION') then
    ...
    --
    -- Update the ben_schedd_hrs_rt_f Row
    --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy ben_shr_shd.g_rec_type) is
--
...
Begin
  ...
  If (p_rec.vrbl_rt_prfl_id = hr_api.g_number) then
    ...
    ben_shr_shd.g_old_rec.vrbl_rt_prfl_id;
  End If;
  If (p_rec.excld_flag = hr_api.g_varchar2) then
    p_rec.excld_flag :=
    ben_shr_shd.g_old_rec.excld_flag;
  End If;
  If (p_rec.ordr_num = hr_api.g_number) then
    p_rec.ordr_num :=
    ben_shr_shd.g_old_rec.ordr_num;
  End If;
  If (p_rec.freq_cd = hr_api.g_varchar2) then
    p_rec.freq_cd :=
    ben_shr_shd.g_old_rec.freq_cd;
  End If;
  If (p_rec.hrs_num = hr_api.g_number) then
    p_rec.hrs_num :=
    ben_shr_shd.g_old_rec.hrs_num;
  End If;

  If (p_rec.max_hrs_num = hr_api.g_number) then
    p_rec.max_hrs_num :=
    ben_shr_shd.g_old_rec.max_hrs_num;
  End If;
  If (p_rec.schedd_hrs_rl = hr_api.g_number) then
    p_rec.schedd_hrs_rl :=
    ben_shr_shd.g_old_rec.schedd_hrs_rl;
  End If;
  If (p_rec.determination_cd = hr_api.g_varchar2) then
    p_rec.determination_cd :=
    ben_shr_shd.g_old_rec.determination_cd;
  End If;
  If (p_rec.determination_rl = hr_api.g_number) then
    p_rec.determination_rl :=
    ben_shr_shd.g_old_rec.determination_rl;
  End If;
  If (p_rec.rounding_cd = hr_api.g_varchar2) then
    p_rec.rounding_cd :=
    ben_shr_shd.g_old_rec.rounding_cd;
  End If;
  If (p_rec.rounding_rl = hr_api.g_number) then
    p_rec.rounding_rl :=
    ben_shr_shd.g_old_rec.rounding_rl;
  End If;


  If (p_rec.business_group_id = hr_api.g_number) then
    p_rec.business_group_id :=
    ben_shr_shd.g_old_rec.business_group_id;
  End If;
  If (p_rec.shr_attribute_category = hr_api.g_varchar2) then
    p_rec.shr_attribute_category :=
    ben_shr_shd.g_old_rec.shr_attribute_category;
  End If;
  If (p_rec.shr_attribute1 = hr_api.g_varchar2) then
    p_rec.shr_attribute1 :=
    ben_shr_shd.g_old_rec.shr_attribute1;
  End If;
  If (p_rec.shr_attribute2 = hr_api.g_varchar2) then
    p_rec.shr_attribute2 :=
    ben_shr_shd.g_old_rec.shr_attribute2;
  End If;
  If (p_rec.shr_attribute3 = hr_api.g_varchar2) then
    p_rec.shr_attribute3 :=
    ben_shr_shd.g_old_rec.shr_attribute3;
  End If;
  If (p_rec.shr_attribute4 = hr_api.g_varchar2) then
    p_rec.shr_attribute4 :=
    ben_shr_shd.g_old_rec.shr_attribute4;
  End If;
  If (p_rec.shr_attribute5 = hr_api.g_varchar2) then
    p_rec.shr_attribute5 :=
    ben_shr_shd.g_old_rec.shr_attribute5;
  End If;
  If (p_rec.shr_attribute6 = hr_api.g_varchar2) then
    p_rec.shr_attribute6 :=
    ben_shr_shd.g_old_rec.shr_attribute6;
  End If;
  If (p_rec.shr_attribute7 = hr_api.g_varchar2) then
    p_rec.shr_attribute7 :=
    ben_shr_shd.g_old_rec.shr_attribute7;
  End If;
  If (p_rec.shr_attribute8 = hr_api.g_varchar2) then
    p_rec.shr_attribute8 :=
    ben_shr_shd.g_old_rec.shr_attribute8;
  End If;
  If (p_rec.shr_attribute9 = hr_api.g_varchar2) then
    p_rec.shr_attribute9 :=
    ben_shr_shd.g_old_rec.shr_attribute9;
  End If;
  If (p_rec.shr_attribute10 = hr_api.g_varchar2) then
    p_rec.shr_attribute10 :=
    ben_shr_shd.g_old_rec.shr_attribute10;
  End If;
  If (p_rec.shr_attribute11 = hr_api.g_varchar2) then
    p_rec.shr_attribute11 :=
    ben_shr_shd.g_old_rec.shr_attribute11;
  End If;
  If (p_rec.shr_attribute12 = hr_api.g_varchar2) then
    p_rec.shr_attribute12 :=
    ben_shr_shd.g_old_rec.shr_attribute12;
  End If;
  If (p_rec.shr_attribute13 = hr_api.g_varchar2) then
    p_rec.shr_attribute13 :=
    ben_shr_shd.g_old_rec.shr_attribute13;
  End If;
  If (p_rec.shr_attribute14 = hr_api.g_varchar2) then
    p_rec.shr_attribute14 :=
    ben_shr_shd.g_old_rec.shr_attribute14;
  End If;
  If (p_rec.shr_attribute15 = hr_api.g_varchar2) then
    p_rec.shr_attribute15 :=
    ben_shr_shd.g_old_rec.shr_attribute15;
  End If;
  If (p_rec.shr_attribute16 = hr_api.g_varchar2) then
    p_rec.shr_attribute16 :=
    ben_shr_shd.g_old_rec.shr_attribute16;
  End If;
  If (p_rec.shr_attribute17 = hr_api.g_varchar2) then
    p_rec.shr_attribute17 :=
    ben_shr_shd.g_old_rec.shr_attribute17;
  End If;
  If (p_rec.shr_attribute18 = hr_api.g_varchar2) then
    p_rec.shr_attribute18 :=
    ben_shr_shd.g_old_rec.shr_attribute18;
  End If;
  If (p_rec.shr_attribute19 = hr_api.g_varchar2) then
    p_rec.shr_attribute19 :=
    ben_shr_shd.g_old_rec.shr_attribute19;
  End If;
  If (p_rec.shr_attribute20 = hr_api.g_varchar2) then
    p_rec.shr_attribute20 :=
    ben_shr_shd.g_old_rec.shr_attribute20;
  End If;
  If (p_rec.shr_attribute21 = hr_api.g_varchar2) then
    p_rec.shr_attribute21 :=
    ben_shr_shd.g_old_rec.shr_attribute21;
  End If;
  If (p_rec.shr_attribute22 = hr_api.g_varchar2) then
    p_rec.shr_attribute22 :=
    ben_shr_shd.g_old_rec.shr_attribute22;
  End If;
  If (p_rec.shr_attribute23 = hr_api.g_varchar2) then
    p_rec.shr_attribute23 :=
    ben_shr_shd.g_old_rec.shr_attribute23;
  End If;
  If (p_rec.shr_attribute24 = hr_api.g_varchar2) then
    p_rec.shr_attribute24 :=
    ben_shr_shd.g_old_rec.shr_attribute24;
  End If;
  If (p_rec.shr_attribute25 = hr_api.g_varchar2) then
    p_rec.shr_attribute25 :=
    ben_shr_shd.g_old_rec.shr_attribute25;
  End If;
  If (p_rec.shr_attribute26 = hr_api.g_varchar2) then
    p_rec.shr_attribute26 :=
    ben_shr_shd.g_old_rec.shr_attribute26;
  End If;
  If (p_rec.shr_attribute27 = hr_api.g_varchar2) then
    p_rec.shr_attribute27 :=
    ben_shr_shd.g_old_rec.shr_attribute27;
  End If;
  If (p_rec.shr_attribute28 = hr_api.g_varchar2) then
    p_rec.shr_attribute28 :=
    ben_shr_shd.g_old_rec.shr_attribute28;
  End If;
  If (p_rec.shr_attribute29 = hr_api.g_varchar2) then
    p_rec.shr_attribute29 :=
    ben_shr_shd.g_old_rec.shr_attribute29;
  End If;
  If (p_rec.shr_attribute30 = hr_api.g_varchar2) then
    p_rec.shr_attribute30 :=
    ben_shr_shd.g_old_rec.shr_attribute30;
  End If;
