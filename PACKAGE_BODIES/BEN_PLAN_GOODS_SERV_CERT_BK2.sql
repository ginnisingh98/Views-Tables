--------------------------------------------------------
--  DDL for Package Body BEN_PLAN_GOODS_SERV_CERT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PLAN_GOODS_SERV_CERT_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_PLAN_GOODS_SERV_CERT_BK2.UPDATE_PLAN_GOODS_SERV_CERT_A', 10);
hr_utility.set_location(' Leaving: BEN_PLAN_GOODS_SERV_CERT_BK2.UPDATE_PLAN_GOODS_SERV_CERT_A', 20);
end UPDATE_PLAN_GOODS_SERV_CERT_A;
...
begin
hr_utility.set_location('Entering: BEN_PLAN_GOODS_SERV_CERT_BK2.UPDATE_PLAN_GOODS_SERV_CERT_B', 10);
hr_utility.set_location(' Leaving: BEN_PLAN_GOODS_SERV_CERT_BK2.UPDATE_PLAN_GOODS_SERV_CERT_B', 20);
end UPDATE_PLAN_GOODS_SERV_CERT_B;
