--------------------------------------------------------
--  DDL for Package Body BEN_AVR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_AVR_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_avr_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_ACTY_VRBL_RT_PK') Then
...
Begin
  ...
  If (p_effective_date is null or
    ...
    l_fct_ret := false;
  Else
    If (p_acty_vrbl_rt_id = g_old_rec.acty_vrbl_rt_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
    ...
    (p_effective_date      => p_effective_date,
     ...
     p_base_table_name     => 'ben_acty_vrbl_rt_f',
     p_base_key_column     => 'acty_vrbl_rt_id',
     p_base_key_value      => p_acty_vrbl_rt_id,
     p_parent_table_name1      => 'ben_acty_base_rt_f',
     p_parent_key_column1      => 'acty_base_rt_id',
     p_parent_key_value1       => g_old_rec.acty_base_rt_id,
     p_parent_table_name2      => 'ben_vrbl_rt_prfl_f',
     p_parent_key_column2      => 'vrbl_rt_prfl_id',
     p_parent_key_value2       => g_old_rec.vrbl_rt_prfl_id,
...
Begin
  ...
  l_rec.avr_attribute_category           := p_avr_attribute_category;
  l_rec.avr_attribute1                   := p_avr_attribute1;
  l_rec.avr_attribute2                   := p_avr_attribute2;
  l_rec.avr_attribute3                   := p_avr_attribute3;
  l_rec.avr_attribute4                   := p_avr_attribute4;
  l_rec.avr_attribute5                   := p_avr_attribute5;
  l_rec.avr_attribute6                   := p_avr_attribute6;
  l_rec.avr_attribute7                   := p_avr_attribute7;
  l_rec.avr_attribute8                   := p_avr_attribute8;
  l_rec.avr_attribute9                   := p_avr_attribute9;
  l_rec.avr_attribute10                  := p_avr_attribute10;
  l_rec.avr_attribute11                  := p_avr_attribute11;
  l_rec.avr_attribute12                  := p_avr_attribute12;
  l_rec.avr_attribute13                  := p_avr_attribute13;
  l_rec.avr_attribute14                  := p_avr_attribute14;
  l_rec.avr_attribute15                  := p_avr_attribute15;
  l_rec.avr_attribute16                  := p_avr_attribute16;
  l_rec.avr_attribute17                  := p_avr_attribute17;
  l_rec.avr_attribute18                  := p_avr_attribute18;
  l_rec.avr_attribute19                  := p_avr_attribute19;
  l_rec.avr_attribute20                  := p_avr_attribute20;
  l_rec.avr_attribute21                  := p_avr_attribute21;
  l_rec.avr_attribute22                  := p_avr_attribute22;
  l_rec.avr_attribute23                  := p_avr_attribute23;
  l_rec.avr_attribute24                  := p_avr_attribute24;
  l_rec.avr_attribute25                  := p_avr_attribute25;
  l_rec.avr_attribute26                  := p_avr_attribute26;
  l_rec.avr_attribute27                  := p_avr_attribute27;
  l_rec.avr_attribute28                  := p_avr_attribute28;
  l_rec.avr_attribute29                  := p_avr_attribute29;
  l_rec.avr_attribute30                  := p_avr_attribute30;
