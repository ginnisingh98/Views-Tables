--------------------------------------------------------
--  DDL for Package Body ICX_RESP_SEC_ATTR_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ICX_RESP_SEC_ATTR_PVT" AS
-- $Header: ICXVTRSB.pls 115.2 99/07/17 03:30:44 porting ship $
...
BEGIN
   ...
   SAVEPOINT Create_Resp_Sec_Attr_PVT;
...
EXCEPTION
   ...
   WHEN FND_API.G_EXC_ERROR THEN
      ...
      Rollback to Create_Resp_Sec_Attr_PVT;
...
BEGIN
   ...
   SAVEPOINT Delete_Resp_Sec_Attr_PVT;
   ...
   Delete from AK_RESP_SECURITY_ATTRIBUTES
    where resp_application_id    = p_application_id
      and attribute_code    = p_attribute_code
      and responsibility_id = p_responsibility_id
      and attribute_application_id = p_attribute_appl_id;
...
EXCEPTION
   ...
   WHEN FND_API.G_EXC_ERROR THEN
      ...
      Rollback to Delete_Resp_Sec_Attr_PVT;
      p_return_status := FND_API.G_RET_STS_ERROR;
