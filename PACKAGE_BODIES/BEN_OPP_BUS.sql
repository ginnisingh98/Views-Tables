--------------------------------------------------------
--  DDL for Package Body BEN_OPP_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_OPP_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_opp_bus.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------< chk_oiplip_id >------|
-- ----------------------------------------------------------------------------
...
--
-- In Parameters
--   oiplip_id PK of record being inserted or updated.
...
--
Procedure chk_oiplip_id(p_oiplip_id                in number,
                           p_effective_date              in date,
                           p_object_version_number       in number) is
  --
  l_proc         varchar2(72) := g_package||'chk_oiplip_id';
...
Begin
  ...
  --
  l_api_updating := ben_opp_shd.api_updating
    (p_effective_date              => p_effective_date,
     p_oiplip_id                => p_oiplip_id,
     p_object_version_number       => p_object_version_number);
  --
  if (l_api_updating
     and nvl(p_oiplip_id,hr_api.g_number)
     <>  ben_opp_shd.g_old_rec.oiplip_id) then
    --
    -- raise error as PK has changed
    --
    ben_opp_shd.constraint_error('BEN_OIPLIP_F_PK');
    --
...
function return_legislation_code
  ...
  (p_oiplip_id in number) return varchar2 is
  --
  -- Declare cursor
  --
