--------------------------------------------------------
--  DDL for Package Body AP_WEB_CUST_DFLEX_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AP_WEB_CUST_DFLEX_PKG" AS
/* $Header: apwdfcfb.pls 120.10.12010000.3 2008/09/15 09:15:56 rveliche ship $ */
...
--    p_region          - INOUT parameter, has a value when thic funtion is called
--                        can be overridden.
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
