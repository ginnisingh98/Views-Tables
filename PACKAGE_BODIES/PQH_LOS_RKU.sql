--------------------------------------------------------
--  DDL for Package Body PQH_LOS_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_LOS_RKU" as
/* $Header: pqlosrhi.pkb 120.0 2005/05/29 02:11:26 generated noship $ */
...
begin
hr_utility.set_location('Entering: PQH_LOS_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PQH_LOS_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQH_LOS_RKU;
