--------------------------------------------------------
--  DDL for Package Body BEN_XDD_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XDD_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xdd_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_dml(p_rec in ben_xdd_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Delete the ben_ext_data_elmt_decd row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in ben_xdd_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure post_delete(p_rec in ben_xdd_shd.g_rec_type) is
--
...
--
  ...
  begin
    ...
    --
    delete_app_ownerships('EXT_DATA_ELMT_DECD_ID', p_rec.ext_data_elmt_decd_id);
    --
    ben_xdd_rkd.after_delete
      (
...
Procedure del
  (
  p_rec	      in ben_xdd_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  ben_xdd_bus.delete_validate(p_rec);
  --
...
Begin
  ...
  --
  l_rec.ext_data_elmt_decd_id:= p_ext_data_elmt_decd_id;
