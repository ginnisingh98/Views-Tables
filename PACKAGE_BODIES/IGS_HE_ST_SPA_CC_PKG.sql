--------------------------------------------------------
--  DDL for Package Body IGS_HE_ST_SPA_CC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_HE_ST_SPA_CC_PKG" AS
/* $Header: IGSWI43B.pls 120.2 2005/07/03 18:46:10 appldev ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_he_st_spa_cc%ROWTYPE;
  new_references igs_he_st_spa_cc%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.he_spa_cc_id                      := x_he_spa_cc_id;
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_he_st_spa_cc
      WHERE    he_spa_cc_id = x_he_spa_cc_id
      FOR UPDATE NOWAIT;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGS_HE_ST_SPA_CC_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
 ...
 INSERT INTO igs_he_st_spa_cc (
      ...
      x_last_updated_by,
      x_last_update_login
    ) RETURNING ROWID, he_spa_cc_id INTO x_rowid, x_he_spa_cc_id;
 IF (x_mode = 'S') THEN
...
EXCEPTION
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGS_HE_ST_SPA_CC_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
