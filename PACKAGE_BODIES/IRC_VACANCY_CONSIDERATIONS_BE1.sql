--------------------------------------------------------
--  DDL for Package Body IRC_VACANCY_CONSIDERATIONS_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_VACANCY_CONSIDERATIONS_BE1" as 
...
p_effective_date               date) is
  ...
  --
  l_proc varchar2(72):='  irc_vacancy_considerations_be1.create_vacancy_consideration_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.vacancy_considerations.create_vacancy_consideration';
