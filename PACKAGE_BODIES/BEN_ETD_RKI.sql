--------------------------------------------------------
--  DDL for Package Body BEN_ETD_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ETD_RKI" as
/* $Header: beetdrhi.pkb 120.1 2006/02/28 01:50:18 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_etd_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_etd_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_etd_RKI;
