--------------------------------------------------------
--  DDL for Package Body IGS_FI_OTC_CHARGES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_FI_OTC_CHARGES_PKG" AS
/* $Header: IGSSIA4B.pls 115.4 2002/11/29 04:01:23 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_fi_otc_charges%ROWTYPE;
  new_references igs_fi_otc_charges%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.otc_charge_id                     := x_otc_charge_id;
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_fi_otc_charges
      WHERE    otc_charge_id = x_otc_charge_id
      FOR UPDATE NOWAIT;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_FI_OTCH_CRDT_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_FI_OTCH_INVI_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igs_fi_otc_charges_s.NEXTVAL
    INTO      x_otc_charge_id
    FROM      dual;

    before_dml(
      p_action                            => 'INSERT',
      x_rowid                             => x_rowid,
      x_otc_charge_id                     => x_otc_charge_id,
    ...
    INSERT INTO igs_fi_otc_charges (
      otc_charge_id,
      invoice_id,
      credit_id,
      creation_date,
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_fi_otc_charges
    WHERE rowid = x_rowid;
