--------------------------------------------------------
--  DDL for Package Body BEN_CM_TYP_TRGR_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CM_TYP_TRGR_BK1" as
/* $Header: becttapi.pkb 115.3 2002/12/16 17:35:02 generated ship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/01/04 08:38:24 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: BEN_CM_TYP_TRGR_BK1.CREATE_CM_TYP_TRGR_A', 10);
hr_utility.set_location(' Leaving: BEN_CM_TYP_TRGR_BK1.CREATE_CM_TYP_TRGR_A', 20);
end CREATE_CM_TYP_TRGR_A;
...
begin
hr_utility.set_location('Entering: BEN_CM_TYP_TRGR_BK1.CREATE_CM_TYP_TRGR_B', 10);
hr_utility.set_location(' Leaving: BEN_CM_TYP_TRGR_BK1.CREATE_CM_TYP_TRGR_B', 20);
end CREATE_CM_TYP_TRGR_B;
