--------------------------------------------------------
--  DDL for Package Body IGS_AS_ASSESSOR_TYPE_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AS_ASSESSOR_TYPE_PKG" as
/* $Header: IGSDI39B.pls 115.7 2003/05/19 04:43:21 ijeddy ship $ */

  l_rowid VARCHAR2(25);
  old_references IGS_AS_ASSESSOR_TYPE%RowType;
  new_references IGS_AS_ASSESSOR_TYPE%RowType;
  ...
  BEGIN
    ...
    IGS_AS_ITEM_ASSESSOR_PKG.GET_FK_IGS_AS_ASSESSOR_TYPE (
      old_references.ass_assessor_type
      );
...
procedure INSERT_ROW (
  ...
  X_MODE in VARCHAR2 default 'R'
    ...
    cursor C is select ROWID from IGS_AS_ASSESSOR_TYPE
      where ASS_ASSESSOR_TYPE = X_ASS_ASSESSOR_TYPE;
...
Before_DML(
 ...
 x_last_update_login=>X_LAST_UPDATE_LOGIN
  ...
  insert into IGS_AS_ASSESSOR_TYPE (
    ASS_ASSESSOR_TYPE,
    DESCRIPTION,
    DFLT_IND,
    CLOSED_IND,
...
Before_DML(
 ...
 x_last_update_login=>X_LAST_UPDATE_LOGIN
  ...
  update IGS_AS_ASSESSOR_TYPE set
...
procedure ADD_ROW (
  ...
  cursor c1 is select rowid from IGS_AS_ASSESSOR_TYPE
     where ASS_ASSESSOR_TYPE = X_ASS_ASSESSOR_TYPE
  ;
begin
  open c1;
...
begin
 Before_DML(
  ...
  delete from IGS_AS_ASSESSOR_TYPE
 where ROWID = X_ROWID;
  if (sql%notfound) then
    raise no_data_found;
  end if;
