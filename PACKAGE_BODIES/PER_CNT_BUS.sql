--------------------------------------------------------
--  DDL for Package Body PER_CNT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CNT_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_cnt_bus.';  -- Global package name
--
-- The following two global variables are only to be
-- used by the return_legislation_code function.
--
g_legislation_code            varchar2(150)  default null;
g_configuration_code          varchar2(60)   default null;
...
Procedure set_security_group_id
  ...
  -- per_ri_configurations_tl and PER_BUSINESS_GROUPS_PERF
  ...
  if csr_sec_grp%notfound then
     ...
     hr_multi_message.add
       (p_associated_column1
        => nvl(p_associated_column1,'CONFIGURATION_CODE')
       );
     --
  else
    close csr_sec_grp;
...
Begin
  ...
  --
  --
  if (( nvl(per_cnt_bus.g_configuration_code, hr_api.g_varchar2)
       = p_configuration_code)
  and ( nvl(per_cnt_bus.g_language, hr_api.g_varchar2)
       = p_language)) then
    --
    ...
    -- variable.
    --
    l_legislation_code := per_cnt_bus.g_legislation_code;
    ...
    --
    close csr_leg_code;
    per_cnt_bus.g_configuration_code          := p_configuration_code;
    per_cnt_bus.g_language                    := p_language;
    per_cnt_bus.g_legislation_code  := l_legislation_code;
  end if;
...
Begin
  ...
  --
  IF NOT per_cnt_shd.api_updating
