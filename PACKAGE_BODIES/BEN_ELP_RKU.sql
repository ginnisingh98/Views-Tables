--------------------------------------------------------
--  DDL for Package Body BEN_ELP_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELP_RKU" as
/* $Header: beelprhi.pkb 120.1.12000000.2 2007/01/29 16:28:36 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2008/10/18 16:31:40 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: ben_elp_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_elp_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_elp_RKU;
