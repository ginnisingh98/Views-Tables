--------------------------------------------------------
--  DDL for Package Body IGS_CA_DA_OVD_VALS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_CA_DA_OVD_VALS_PKG" AS
/* $Header: IGSCI20B.pls 120.1 2005/08/11 05:48:17 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_ca_da_ovd_vals%ROWTYPE;
  new_references igs_ca_da_ovd_vals%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.ovrd_val_id                       := x_ovrd_val_id;
    new_references.sys_date_type                     := x_sys_date_type;
    new_references.element_code                      := x_element_code;
    new_references.element_code_value                := x_element_code_value;
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_ca_da_ovd_vals
      WHERE    ovrd_val_id = x_ovrd_val_id
      FOR UPDATE NOWAIT;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGS_CA_DA_OVD_VALS_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    before_dml(
      p_action                            => 'INSERT',
      x_rowid                             => x_rowid,
      x_ovrd_val_id                       => x_ovrd_val_id,
      x_sys_date_type                     => x_sys_date_type,
      x_element_code                      => x_element_code,
      x_element_code_value                => x_element_code_value,
    ...
    INSERT INTO igs_ca_da_ovd_vals (
      ovrd_val_id,
      sys_date_type,
      element_code,
      element_code_value,
      ...
      igs_ca_da_ovd_vals_s.NEXTVAL,
      new_references.sys_date_type,
      new_references.element_code,
      new_references.element_code_value,
      ...
      x_last_updated_by,
      x_last_update_login
    ) RETURNING ROWID, ovrd_val_id INTO x_rowid, x_ovrd_val_id;
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND (tlinfo.element_code_value = x_element_code_value)
        AND (tlinfo.date_alias = x_date_alias)
       ) THEN
      NULL;
    ELSE
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGS_CA_DA_OVD_VALS_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_ca_da_ovd_vals
    WHERE rowid = x_rowid;
