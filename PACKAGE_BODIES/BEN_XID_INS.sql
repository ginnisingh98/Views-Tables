--------------------------------------------------------
--  DDL for Package Body BEN_XID_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XID_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xid_ins.';  -- Global package name
--
--
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure insert_dml(p_rec in out nocopy ben_xid_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Insert the row into: ben_ext_incl_data_elmt
  --
  insert into ben_ext_incl_data_elmt
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_insert(p_rec  in out nocopy ben_xid_shd.g_rec_type) is
--
  l_proc  varchar2(72) := g_package||'pre_insert';
--
  Cursor C_Sel1 is select ben_ext_incl_data_elmt_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ext_incl_data_elmt_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure post_insert(p_rec in ben_xid_shd.g_rec_type) is
--
...
--
  ...
  begin
    ...
    --
    create_app_ownerships('EXT_INCL_DATA_ELMT_ID', p_rec.ext_incl_data_elmt_id);
    --
    --
    ben_xid_rki.after_insert
      (
...
Begin
  ...
  --
  ben_xid_bus.insert_validate(p_rec);
  --
...
Begin
  ...
  --
  p_ext_incl_data_elmt_id := l_rec.ext_incl_data_elmt_id;
