--------------------------------------------------------
--  DDL for Package Body AME_ACU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ACU_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_acu_ins.';  -- Global package name
--
...
Begin
  ...
  --
  ame_acu_ins.g_rule_id_i := p_rule_id;
  ame_acu_ins.g_action_id_i := p_action_id;
  --
...
--
  ...
  l_created_by          ame_action_usages.created_by%TYPE;
  l_creation_date       ame_action_usages.creation_date%TYPE;
  l_last_update_date    ame_action_usages.last_update_date%TYPE;
  l_last_updated_by     ame_action_usages.last_updated_by%TYPE;
  l_last_update_login   ame_action_usages.last_update_login%TYPE;
...
Begin
 ...
 ,p_rule_id =>  p_rec.rule_id
  ...
  --
  --
  -- Insert the row into: ame_action_usages
  --
...
--
--  Cursor C_Sel1 is select ame_action_usages_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from ame_action_usages
     where rule_id =
             ame_acu_ins.g_rule_id_i
       and action_id =
             ame_acu_ins.g_action_id_i
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (ame_acu_ins.g_rule_id_i is not null or
      ame_acu_ins.g_action_id_i is not null) Then
    --
    ...
    If C_Sel2%found Then
       ...
       fnd_message.set_token('TABLE_NAME','ame_action_usages');
       fnd_message.raise_error;
    End If;
    Close C_Sel2;
    --
    ...
    p_rec.rule_id :=
      ame_acu_ins.g_rule_id_i;
    ame_acu_ins.g_rule_id_i := null;
    p_rec.action_id :=
      ame_acu_ins.g_action_id_i;
    ame_acu_ins.g_action_id_i := null;
  End If;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  -- Having converted the arguments into the ame_acu_rec
