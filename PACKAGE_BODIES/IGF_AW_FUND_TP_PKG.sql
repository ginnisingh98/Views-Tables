--------------------------------------------------------
--  DDL for Package Body IGF_AW_FUND_TP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_AW_FUND_TP_PKG" AS
/* $Header: IGFWI17B.pls 115.11 2003/11/10 05:51:23 veramach ship $ */

  l_rowid VARCHAR2(25);
  old_references igf_aw_fund_tp_all%ROWTYPE;
  new_references igf_aw_fund_tp_all%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.tp_perct                          := x_tp_perct;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AW_FTPV_CA_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AW_FTPV_FMAST_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    INSERT INTO igf_aw_fund_tp_all (
      fund_id,
      tp_cal_type,
      tp_sequence_number,
      tp_perct,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ((tlinfo.tp_perct = x_tp_perct) OR ((tlinfo.tp_perct IS NULL) AND (X_tp_perct IS NULL)))
       ) THEN
      NULL;
    ELSE
  ...
  */
  ...
  BEGIN
    ...
    UPDATE igf_aw_fund_tp_all
      SET
        tp_perct                          = new_references.tp_perct,
  ...
  */
  BEGIN
    ...
    DELETE FROM igf_aw_fund_tp_all
    WHERE rowid = x_rowid;
