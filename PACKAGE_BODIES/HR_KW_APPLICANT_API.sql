--------------------------------------------------------
--  DDL for Package Body HR_KW_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_KW_APPLICANT_API" as
/* $Header: peappkwi.pkb 120.1 2005/06/22 04:31:25 adevanat noship $ */

--
g_package  VARCHAR2(33) := 'hr_kw_applicant_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_kw_applicant >------------------------------|
-- -----------------------------------------------------------------------------
PROCEDURE create_kw_applicant
  ...
  --
  l_proc                 VARCHAR2(72) := g_package||'create_kw_applicant';
