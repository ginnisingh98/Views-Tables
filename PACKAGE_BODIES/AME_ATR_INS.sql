--------------------------------------------------------
--  DDL for Package Body AME_ATR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ATR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_atr_ins.';  -- Global package name
--
...
Begin
  ...
  --
  ame_atr_ins.g_attribute_id_i := p_attribute_id;
  --
...
--
  ...
  l_created_by          ame_attributes.created_by%TYPE;
  l_creation_date       ame_attributes.creation_date%TYPE;
  l_last_update_date    ame_attributes.last_update_date%TYPE;
  l_last_updated_by     ame_attributes.last_updated_by%TYPE;
  l_last_update_login   ame_attributes.last_update_login%TYPE;
...
Begin
  ...
  --
  --
  -- Insert the row into: ame_attributes
  --
...
--
  Cursor C_Sel1 is select ame_attributes_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from ame_attributes
     where attribute_id =
             ame_atr_ins.g_attribute_id_i
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (ame_atr_ins.g_attribute_id_i is not null) Then
    --
    ...
    If C_Sel2%found Then
       ...
       fnd_message.set_token('TABLE_NAME','ame_attributes');
       fnd_message.raise_error;
    End If;
    Close C_Sel2;
    --
    ...
    p_rec.attribute_id :=
      ame_atr_ins.g_attribute_id_i;
    ame_atr_ins.g_attribute_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.attribute_id;
    Close C_Sel1;
  End If;
  --
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the ame_atr_rec
  ...
  --
  p_attribute_id := l_rec.attribute_id;
