--------------------------------------------------------
--  DDL for Package Body PAY_ETP_DEL_ND
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ETP_DEL_ND" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_etp_del_nd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_delete_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  If (p_datetrack_mode <> hr_api.g_zap) then
    ...
    p_rec.effective_start_date
      := pay_etp_shd_nd.g_old_rec.effective_start_date;
    --
    ...
    --
    pay_etp_shd_nd.upd_effective_end_date
      (p_effective_date         => p_effective_date
  ...
  hr_utility.set_location('Entering:'||l_proc, 5);
   begin
    ...
    pay_etp_rkd.after_delete
      ...
      => pay_etp_shd_nd.g_old_rec.effective_end_date
      ,p_business_group_id_o
      => pay_etp_shd_nd.g_old_rec.business_group_id
      ,p_legislation_code_o
      => pay_etp_shd_nd.g_old_rec.legislation_code
      ,p_formula_id_o
      => pay_etp_shd_nd.g_old_rec.formula_id
      ,p_input_currency_code_o
      => pay_etp_shd_nd.g_old_rec.input_currency_code
      ,p_output_currency_code_o
      => pay_etp_shd_nd.g_old_rec.output_currency_code
      ,p_classification_id_o
      => pay_etp_shd_nd.g_old_rec.classification_id
      ,p_benefit_classification_id_o
      => pay_etp_shd_nd.g_old_rec.benefit_classification_id
      ,p_additional_entry_allowed_f_o
      => pay_etp_shd_nd.g_old_rec.additional_entry_allowed_flag
      ,p_adjustment_only_flag_o
      => pay_etp_shd_nd.g_old_rec.adjustment_only_flag
      ,p_closed_for_entry_flag_o
      => pay_etp_shd_nd.g_old_rec.closed_for_entry_flag
      ,p_element_name_o
      => pay_etp_shd_nd.g_old_rec.element_name
      ,p_indirect_only_flag_o
      => pay_etp_shd_nd.g_old_rec.indirect_only_flag
      ,p_multiple_entries_allowed_f_o
      => pay_etp_shd_nd.g_old_rec.multiple_entries_allowed_flag
      ,p_multiply_value_flag_o
      => pay_etp_shd_nd.g_old_rec.multiply_value_flag
      ,p_post_termination_rule_o
      => pay_etp_shd_nd.g_old_rec.post_termination_rule
      ,p_process_in_run_flag_o
      => pay_etp_shd_nd.g_old_rec.process_in_run_flag
      ,p_processing_priority_o
      => pay_etp_shd_nd.g_old_rec.processing_priority
      ,p_processing_type_o
      => pay_etp_shd_nd.g_old_rec.processing_type
      ,p_standard_link_flag_o
      => pay_etp_shd_nd.g_old_rec.standard_link_flag
      ,p_comment_id_o
      => pay_etp_shd_nd.g_old_rec.comment_id
      ,p_comments_o
      => pay_etp_shd_nd.g_old_rec.comments
      ,p_description_o
      => pay_etp_shd_nd.g_old_rec.description
      ,p_legislation_subgroup_o
      => pay_etp_shd_nd.g_old_rec.legislation_subgroup
      ,p_qualifying_age_o
      => pay_etp_shd_nd.g_old_rec.qualifying_age
      ,p_qualifying_length_of_servi_o
      => pay_etp_shd_nd.g_old_rec.qualifying_length_of_service
      ,p_qualifying_units_o
      => pay_etp_shd_nd.g_old_rec.qualifying_units
      ,p_reporting_name_o
      => pay_etp_shd_nd.g_old_rec.reporting_name
      ,p_attribute_category_o
      => pay_etp_shd_nd.g_old_rec.attribute_category
      ,p_attribute1_o
      => pay_etp_shd_nd.g_old_rec.attribute1
      ,p_attribute2_o
      => pay_etp_shd_nd.g_old_rec.attribute2
      ,p_attribute3_o
      => pay_etp_shd_nd.g_old_rec.attribute3
      ,p_attribute4_o
      => pay_etp_shd_nd.g_old_rec.attribute4
      ,p_attribute5_o
      => pay_etp_shd_nd.g_old_rec.attribute5
      ,p_attribute6_o
      => pay_etp_shd_nd.g_old_rec.attribute6
      ,p_attribute7_o
      => pay_etp_shd_nd.g_old_rec.attribute7
      ,p_attribute8_o
      => pay_etp_shd_nd.g_old_rec.attribute8
      ,p_attribute9_o
      => pay_etp_shd_nd.g_old_rec.attribute9
      ,p_attribute10_o
      => pay_etp_shd_nd.g_old_rec.attribute10
      ,p_attribute11_o
      => pay_etp_shd_nd.g_old_rec.attribute11
      ,p_attribute12_o
      => pay_etp_shd_nd.g_old_rec.attribute12
      ,p_attribute13_o
      => pay_etp_shd_nd.g_old_rec.attribute13
      ,p_attribute14_o
      => pay_etp_shd_nd.g_old_rec.attribute14
      ,p_attribute15_o
      => pay_etp_shd_nd.g_old_rec.attribute15
      ,p_attribute16_o
      => pay_etp_shd_nd.g_old_rec.attribute16
      ,p_attribute17_o
      => pay_etp_shd_nd.g_old_rec.attribute17
      ,p_attribute18_o
      => pay_etp_shd_nd.g_old_rec.attribute18
      ,p_attribute19_o
      => pay_etp_shd_nd.g_old_rec.attribute19
      ,p_attribute20_o
      => pay_etp_shd_nd.g_old_rec.attribute20
      ,p_element_information_catego_o
      => pay_etp_shd_nd.g_old_rec.element_information_category
      ,p_element_information1_o
      => pay_etp_shd_nd.g_old_rec.element_information1
      ,p_element_information2_o
      => pay_etp_shd_nd.g_old_rec.element_information2
      ,p_element_information3_o
      => pay_etp_shd_nd.g_old_rec.element_information3
      ,p_element_information4_o
      => pay_etp_shd_nd.g_old_rec.element_information4
      ,p_element_information5_o
      => pay_etp_shd_nd.g_old_rec.element_information5
      ,p_element_information6_o
      => pay_etp_shd_nd.g_old_rec.element_information6
      ,p_element_information7_o
      => pay_etp_shd_nd.g_old_rec.element_information7
      ,p_element_information8_o
      => pay_etp_shd_nd.g_old_rec.element_information8
      ,p_element_information9_o
      => pay_etp_shd_nd.g_old_rec.element_information9
      ,p_element_information10_o
      => pay_etp_shd_nd.g_old_rec.element_information10
      ,p_element_information11_o
      => pay_etp_shd_nd.g_old_rec.element_information11
      ,p_element_information12_o
      => pay_etp_shd_nd.g_old_rec.element_information12
      ,p_element_information13_o
      => pay_etp_shd_nd.g_old_rec.element_information13
      ,p_element_information14_o
      => pay_etp_shd_nd.g_old_rec.element_information14
      ,p_element_information15_o
      => pay_etp_shd_nd.g_old_rec.element_information15
      ,p_element_information16_o
      => pay_etp_shd_nd.g_old_rec.element_information16
      ,p_element_information17_o
      => pay_etp_shd_nd.g_old_rec.element_information17
      ,p_element_information18_o
      => pay_etp_shd_nd.g_old_rec.element_information18
      ,p_element_information19_o
      => pay_etp_shd_nd.g_old_rec.element_information19
      ,p_element_information20_o
      => pay_etp_shd_nd.g_old_rec.element_information20
      ,p_third_party_pay_only_flag_o
      => pay_etp_shd_nd.g_old_rec.third_party_pay_only_flag
      ,p_object_version_number_o
      => pay_etp_shd_nd.g_old_rec.object_version_number
      ,p_iterative_flag_o
      => pay_etp_shd_nd.g_old_rec.iterative_flag
      ,p_iterative_formula_id_o
      => pay_etp_shd_nd.g_old_rec.iterative_formula_id
      ,p_iterative_priority_o
      => pay_etp_shd_nd.g_old_rec.iterative_priority
      ,p_creator_type_o
      => pay_etp_shd_nd.g_old_rec.creator_type
      ,p_retro_summ_ele_id_o
      => pay_etp_shd_nd.g_old_rec.retro_summ_ele_id
      ,p_grossup_flag_o
      => pay_etp_shd_nd.g_old_rec.grossup_flag
      ,p_process_mode_o
      => pay_etp_shd_nd.g_old_rec.process_mode
      ,p_advance_indicator_o
      => pay_etp_shd_nd.g_old_rec.advance_indicator
      ,p_advance_payable_o
      => pay_etp_shd_nd.g_old_rec.advance_payable
      ,p_advance_deduction_o
      => pay_etp_shd_nd.g_old_rec.advance_deduction
      ,p_process_advance_entry_o
      => pay_etp_shd_nd.g_old_rec.process_advance_entry
      ,p_proration_group_id_o
      => pay_etp_shd_nd.g_old_rec.proration_group_id
      ,p_proration_formula_id_o
      => pay_etp_shd_nd.g_old_rec.proration_formula_id
      ,p_recalc_event_group_id_o
      => pay_etp_shd_nd.g_old_rec.recalc_event_group_id
      ,p_once_each_period_flag_o
      => pay_etp_shd_nd.g_old_rec.once_each_period_flag
      ,p_time_definition_type_o
      => pay_etp_shd_nd.g_old_rec.time_definition_type
      ,p_time_definition_id_o
      => pay_etp_shd_nd.g_old_rec.time_definition_id
...
Begin
  ...
  --
  p_rec.business_group_id    := pay_etp_shd_nd.g_old_rec.business_group_id;
  p_rec.legislation_code     := pay_etp_shd_nd.g_old_rec.legislation_code;
  p_rec.legislation_subgroup := pay_etp_shd_nd.g_old_rec.legislation_subgroup;
  --
  ...
  --
  pay_etp_bus_nd.delete_validate
    (p_rec                              => p_rec
    ,p_effective_date                   => p_effective_date
    ,p_datetrack_mode                   => p_datetrack_mode
    ,p_validation_start_date            => l_validation_start_date
...
--
  l_rec         		 pay_etp_shd_nd.g_rec_type;
  l_proc        		 varchar2(72) := g_package||'del';
  l_balance_feeds_warning 	 boolean;
