--------------------------------------------------------
--  DDL for Package Body BEN_PL_PRMRY_CARE_PRVDR_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PL_PRMRY_CARE_PRVDR_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PL_PRMRY_CARE_PRVDR_BK1.CREATE_PL_PRMRY_CARE_PRVDR_A', 10);
hr_utility.set_location(' Leaving: BEN_PL_PRMRY_CARE_PRVDR_BK1.CREATE_PL_PRMRY_CARE_PRVDR_A', 20);
end CREATE_PL_PRMRY_CARE_PRVDR_A;
...
begin
hr_utility.set_location('Entering: BEN_PL_PRMRY_CARE_PRVDR_BK1.CREATE_PL_PRMRY_CARE_PRVDR_B', 10);
hr_utility.set_location(' Leaving: BEN_PL_PRMRY_CARE_PRVDR_BK1.CREATE_PL_PRMRY_CARE_PRVDR_B', 20);
end CREATE_PL_PRMRY_CARE_PRVDR_B;
