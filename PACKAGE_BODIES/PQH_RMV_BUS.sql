--------------------------------------------------------
--  DDL for Package Body PQH_RMV_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_RMV_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_rmv_bus.';  -- Global package name
--
-- The following two global variables are only to be
-- used by the return_legislation_code function.
--
g_legislation_code            varchar2(150)  default null;
g_node_value_id               number         default null;
--
--  ---------------------------------------------------------------------------
  ...
  cursor csr_sec_grp is
    select pbg.security_group_id,
      ...
      from per_business_groups_perf pbg
         , pqh_rt_matrix_node_values rmv
     where rmv.node_value_id = p_node_value_id
       and pbg.business_group_id (+) = rmv.business_group_id;
  --
  ...
  if csr_sec_grp%notfound then
     ...
     hr_multi_message.add
       (p_associated_column1
        => nvl(p_associated_column1,'NODE_VALUE_ID')
       );
     --
  else
    close csr_sec_grp;
...
Begin
  ...
  --
  if ( nvl(pqh_rmv_bus.g_node_value_id, hr_api.g_number)
       = p_node_value_id) then
    --
    -- The legislation code has already been found with a previous
    -- call to this function. Just return the value in the global
    -- variable.
    --
    l_legislation_code := pqh_rmv_bus.g_legislation_code;
    ...
    --
    close csr_leg_code;
    pqh_rmv_bus.g_node_value_id               := p_node_value_id;
    pqh_rmv_bus.g_legislation_code  := l_legislation_code;
  end if;
...
Begin
  ...
  --
  IF NOT pqh_rmv_shd.api_updating
      (p_node_value_id                     => p_rec.node_value_id
...
Begin
  ...
  IF hr_startup_data_api_support.g_startup_mode
     ...
     hr_api.validate_bus_grp_id
       ...
       ,p_associated_column1 => pqh_rmv_shd.g_tab_nam
                                || '.BUSINESS_GROUP_ID');
     --
