--------------------------------------------------------
--  DDL for Package Body BEN_EPR_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EPR_RKI" as
...
begin
hr_utility.set_location('Entering: ben_epr_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_epr_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_epr_RKI;
