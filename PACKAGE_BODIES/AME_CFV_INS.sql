--------------------------------------------------------
--  DDL for Package Body AME_CFV_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_CFV_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_cfv_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_application_id_i  number   default null;
g_variable_name_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  ...
  ,p_variable_name  in  varchar2) is
--
...
Begin
  ...
  --
  ame_cfv_ins.g_application_id_i := p_application_id;
  ame_cfv_ins.g_variable_name_i := p_variable_name;
  --
...
--
 ...
 and    t.variable_name = p_rec.variable_name
    and    t.start_date =
...
--
  ...
  l_created_by          ame_config_vars.created_by%TYPE;
  l_creation_date       ame_config_vars.creation_date%TYPE;
  l_last_update_date    ame_config_vars.last_update_date%TYPE;
  l_last_updated_by     ame_config_vars.last_updated_by%TYPE;
  l_last_update_login   ame_config_vars.last_update_login%TYPE;
...
Begin
 ...
 ,p_variable_name =>  p_rec.variable_name
  ...
  --
  --
  -- Insert the row into: ame_config_vars
  --
 ...
 Cursor C_Sel2 is
    Select null
     ...
     where application_id =
             ame_cfv_ins.g_application_id_i
       and variable_name =
             ame_cfv_ins.g_variable_name_i
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (ame_cfv_ins.g_application_id_i is not null or
      ame_cfv_ins.g_variable_name_i is not null) Then
    --
    ...
    p_rec.application_id :=
      ame_cfv_ins.g_application_id_i;
    ame_cfv_ins.g_application_id_i := null;
    p_rec.variable_name :=
      ame_cfv_ins.g_variable_name_i;
    ame_cfv_ins.g_variable_name_i := null;
  End If;
  --
  -- Set Description of the Config Variable. The 'ins' procedure does not
  -- contain any p_description parameter, and hence it is populated here, from
  -- the seeded Default value for the config variable.
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the ame_cfv_rec
