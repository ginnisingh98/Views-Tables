--------------------------------------------------------
--  DDL for Package Body ONT_D1_INVOICE_TO_ORG_ID
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1_INVOICE_TO_ORG_ID" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D1_INVOICE_TO_ORG_ID
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1_INVOICE_TO_ORG_ID';
...
BEGIN
    ...
    l_return_value := ONT_AGREEMENT_Def_Util.g_cached_record.INVOICE_TO_ORG_ID;
    END IF;
  ...
  END IF;
    ...
    l_return_value := ONT_SHIP_TO_ORG_Def_Util.g_cached_record.INVOICE_TO_ORG_ID;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
    ...
    l_return_value := ONT_SOLD_TO_ORG_Def_Util.g_cached_record.INVOICE_TO_ORG_ID;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
...
WHEN OTHERS THEN
         ...
         ( p_attribute_code => 'INVOICE_TO_ORG_ID'
         , p_rule_id => l_rule_id
         );
         RETURN NULL;
