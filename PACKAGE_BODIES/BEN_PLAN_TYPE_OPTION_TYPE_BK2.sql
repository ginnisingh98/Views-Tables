--------------------------------------------------------
--  DDL for Package Body BEN_PLAN_TYPE_OPTION_TYPE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PLAN_TYPE_OPTION_TYPE_BK2" as
/* $Header: beponapi.pkb 120.0 2005/05/28 10:56:01 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_PLAN_TYPE_OPTION_TYPE_BK2.UPDATE_PLAN_TYPE_OPTION_TYPE_A', 10);
hr_utility.set_location(' Leaving: BEN_PLAN_TYPE_OPTION_TYPE_BK2.UPDATE_PLAN_TYPE_OPTION_TYPE_A', 20);
end UPDATE_PLAN_TYPE_OPTION_TYPE_A;
...
begin
hr_utility.set_location('Entering: BEN_PLAN_TYPE_OPTION_TYPE_BK2.UPDATE_PLAN_TYPE_OPTION_TYPE_B', 10);
hr_utility.set_location(' Leaving: BEN_PLAN_TYPE_OPTION_TYPE_BK2.UPDATE_PLAN_TYPE_OPTION_TYPE_B', 20);
end UPDATE_PLAN_TYPE_OPTION_TYPE_B;
