--------------------------------------------------------
--  DDL for Package Body BEN_DCR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DCR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_dcr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    select t.created_by,
           t.creation_date
    from   ben_dpnt_cvg_rqd_rlshp_f t
    where  t.dpnt_cvg_rqd_rlshp_id       = p_rec.dpnt_cvg_rqd_rlshp_id
    and    t.effective_start_date =
             ben_dcr_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_dpnt_cvg_rqd_rlshp_f.created_by%TYPE;
  l_creation_date       ben_dpnt_cvg_rqd_rlshp_f.creation_date%TYPE;
  l_last_update_date   	ben_dpnt_cvg_rqd_rlshp_f.last_update_date%TYPE;
  l_last_updated_by     ben_dpnt_cvg_rqd_rlshp_f.last_updated_by%TYPE;
  l_last_update_login   ben_dpnt_cvg_rqd_rlshp_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_dpnt_cvg_rqd_rlshp_f
  --
  insert into ben_dpnt_cvg_rqd_rlshp_f
  (	dpnt_cvg_rqd_rlshp_id,
...
--
  ...
  cursor c1 is
	select BEN_DPNT_CVG_RQD_RLSHP_F_S.nextval
		from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  ...
  open c1;
  fetch c1 into p_rec.dpnt_cvg_rqd_rlshp_id;
  close c1;
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_dcr_rec
  ...
  --
  p_dpnt_cvg_rqd_rlshp_id        	:= l_rec.dpnt_cvg_rqd_rlshp_id;
