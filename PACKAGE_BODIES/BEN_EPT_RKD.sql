--------------------------------------------------------
--  DDL for Package Body BEN_EPT_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EPT_RKD" as
...
begin
hr_utility.set_location('Entering: ben_ept_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_ept_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_ept_RKD;
