--------------------------------------------------------
--  DDL for Package Body PQH_SITUATIONS_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_SITUATIONS_SWI" As
/* $Header: pqlosswi.pkb 115.1 2002/12/03 00:08:24 rpasapul noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'pqh_situations_swi.';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_situation >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_situation_swi;
  --
  ...
  -- Call API
  --
  pqh_situations_api.create_situation
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_situation_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_situation_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  pqh_situations_api.delete_situation
    (p_validate                     => l_validate
    ,p_situation_id                 => p_situation_id
    ,p_object_version_number        => p_object_version_number
    );
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_situation_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_situation_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  pqh_situations_api.update_situation
    (p_validate                     => l_validate
    ,p_effective_date               => p_effective_date
    ,p_situation_id                 => p_situation_id
    ,p_object_version_number        => p_object_version_number
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_situation_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
