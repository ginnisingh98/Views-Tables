--------------------------------------------------------
--  DDL for Package Body OKL_TXD_ASSETS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TXD_ASSETS_PVT_W" as
  /* $Header: OKLOASDB.pls 115.6 2002/12/20 19:23:12 avsingh noship $ */
  ...
  as
    ddp_asdv_rec okl_txd_assets_pvt.advv_rec_type;
    ddx_asdv_rec okl_txd_assets_pvt.advv_rec_type;
  ...
  begin
    ...
    okl_txd_assets_pvt.create_txd_asset_def(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_asdv_tbl okl_txd_assets_pvt.advv_tbl_type;
    ddx_asdv_tbl okl_txd_assets_pvt.advv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_txd_assets_pvt.lock_txd_asset_def(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_txd_assets_pvt.update_txd_asset_def(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_txd_assets_pvt.delete_txd_asset_def(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_txd_assets_pvt.validate_txd_asset_def(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
