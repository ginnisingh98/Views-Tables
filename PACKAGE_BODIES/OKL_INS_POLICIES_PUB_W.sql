--------------------------------------------------------
--  DDL for Package Body OKL_INS_POLICIES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_INS_POLICIES_PUB_W" as
  /* $Header: OKLOIPYB.pls 120.1 2005/09/22 10:15:33 pagarg noship $ */
  ...
  as
    ddp_ipyv_tbl okl_ins_policies_pub.ipyv_tbl_type;
    ddx_ipyv_tbl okl_ins_policies_pub.ipyv_tbl_type;
  ...
  begin
    ...
    okl_ins_policies_pub.insert_ins_policies(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ipyv_rec okl_ins_policies_pub.ipyv_rec_type;
    ddx_ipyv_rec okl_ins_policies_pub.ipyv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_policies_pub.lock_ins_policies(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_policies_pub.update_ins_policies(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_policies_pub.delete_ins_policies(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ins_policies_pub.validate_ins_policies(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
