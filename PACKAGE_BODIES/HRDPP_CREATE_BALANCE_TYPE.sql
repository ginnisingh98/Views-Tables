--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_BALANCE_TYPE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_BALANCE_TYPE" as
/*
...
,P_REPORTING_NAME in varchar2 default null) is
...
L_INPUT_VALUE_ID := 
PER_BF_GEN_DATA_PUMP.get_input_value_id
(P_REPORTING_NAME => c.p11
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p10);
end if;
--
hr_data_pump.api_trc_on;
PER_BF_BALANCE_TYPES_API.CREATE_BALANCE_TYPE
(P_BALANCE_TYPE_ID => c.p1
,P_OBJECT_VERSION_NUMBER => c.p2
,P_INPUT_VALUE_ID => L_INPUT_VALUE_ID
,p_business_group_id => p_business_group_id
,P_DISPLAYED_NAME => c.p3
,P_INTERNAL_NAME => c.p4
,P_UOM => c.p5
,P_CURRENCY => c.p6
,P_CATEGORY => c.p7
,P_DATE_FROM => c.p8
