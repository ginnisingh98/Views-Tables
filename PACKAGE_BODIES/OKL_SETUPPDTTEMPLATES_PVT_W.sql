--------------------------------------------------------
--  DDL for Package Body OKL_SETUPPDTTEMPLATES_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPPDTTEMPLATES_PVT_W" as
  /* $Header: OKLESPTB.pls 115.2 2002/12/24 04:04:10 sgorantl noship $ */
  ...
  as
    ddp_ptlv_rec okl_setuppdttemplates_pvt.ptlv_rec_type;
    ddx_no_data_found boolean;
    ddx_ptlv_rec okl_setuppdttemplates_pvt.ptlv_rec_type;
  ...
  begin
    ...
    okl_setuppdttemplates_pvt.get_rec(ddp_ptlv_rec,
      x_return_status,
      ddx_no_data_found,
      ddx_ptlv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p3_a0 := rosetta_g_miss_num_map(ddx_ptlv_rec.id);
    p3_a1 := rosetta_g_miss_num_map(ddx_ptlv_rec.object_version_number);
    p3_a2 := ddx_ptlv_rec.name;
    p3_a3 := ddx_ptlv_rec.version;
    p3_a4 := ddx_ptlv_rec.description;
    p3_a5 := ddx_ptlv_rec.from_date;
    p3_a6 := ddx_ptlv_rec.to_date;
    p3_a7 := rosetta_g_miss_num_map(ddx_ptlv_rec.created_by);
    p3_a8 := ddx_ptlv_rec.creation_date;
    p3_a9 := rosetta_g_miss_num_map(ddx_ptlv_rec.last_updated_by);
    p3_a10 := ddx_ptlv_rec.last_update_date;
    p3_a11 := rosetta_g_miss_num_map(ddx_ptlv_rec.last_update_login);
  end;

  procedure get_version(p_name  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppdttemplates_pvt.get_version(p_name,
      p_cur_version,
      ddp_from_date,
      ddp_to_date,
      p_table,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppdttemplates_pvt.check_overlaps(p_id,
      p_name,
      ddp_from_date,
      ddp_to_date,
      p_table,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppdttemplates_pvt.insert_pdttemplates(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppdttemplates_pvt.update_pdttemplates(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_setuppdttemplates_pvt_w;
