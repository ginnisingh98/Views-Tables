--------------------------------------------------------
--  DDL for Package Body PQP_AAT_API_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_AAT_API_BK1" as
...
begin
hr_utility.set_location('Entering: PQP_AAT_API_BK1.CREATE_ASSIGNMENT_ATTRIBUTE_A', 10);
hr_utility.set_location(' Leaving: PQP_AAT_API_BK1.CREATE_ASSIGNMENT_ATTRIBUTE_A', 20);
end CREATE_ASSIGNMENT_ATTRIBUTE_A;
...
begin
hr_utility.set_location('Entering: PQP_AAT_API_BK1.CREATE_ASSIGNMENT_ATTRIBUTE_B', 10);
hr_utility.set_location(' Leaving: PQP_AAT_API_BK1.CREATE_ASSIGNMENT_ATTRIBUTE_B', 20);
end CREATE_ASSIGNMENT_ATTRIBUTE_B;
end PQP_AAT_API_BK1;
