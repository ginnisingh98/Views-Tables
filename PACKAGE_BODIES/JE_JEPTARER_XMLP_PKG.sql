--------------------------------------------------------
--  DDL for Package Body JE_JEPTARER_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JE_JEPTARER_XMLP_PKG" AS
/* $Header: JEPTARERB.pls 120.1 2007/12/25 16:59:07 dwkrishn noship $ */
  ...
  FUNCTION PLACE_COA_ID_P RETURN VARCHAR2 IS
  BEGIN
    RETURN PLACE_COA_ID;
  END PLACE_COA_ID_P;
