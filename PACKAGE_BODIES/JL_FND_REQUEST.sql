--------------------------------------------------------
--  DDL for Package Body JL_FND_REQUEST
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JL_FND_REQUEST" as
/* $Header: jlfndrqb.pls 115.1 99/07/16 03:12:00 porting ship $ */
