--------------------------------------------------------
--  DDL for Package Body OKL_SETUPPQVALUES_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPPQVALUES_PVT_W" as
  /* $Header: OKLESUVB.pls 120.2 2007/09/26 08:50:47 rajnisku ship $ */
  ...
  as
    ddp_pqvv_rec okl_setuppqvalues_pvt.pqvv_rec_type;
    ddx_no_data_found boolean;
    ddx_pqvv_rec okl_setuppqvalues_pvt.pqvv_rec_type;
  ...
  begin
    ...
    okl_setuppqvalues_pvt.get_rec(ddp_pqvv_rec,
      ddx_no_data_found,
      x_return_status,
      ddx_pqvv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p3_a0 := rosetta_g_miss_num_map(ddx_pqvv_rec.id);
    p3_a1 := rosetta_g_miss_num_map(ddx_pqvv_rec.object_version_number);
    p3_a2 := rosetta_g_miss_num_map(ddx_pqvv_rec.pdq_id);
    p3_a3 := rosetta_g_miss_num_map(ddx_pqvv_rec.pdt_id);
    p3_a4 := rosetta_g_miss_num_map(ddx_pqvv_rec.qve_id);
    p3_a5 := ddx_pqvv_rec.from_date;
    p3_a6 := ddx_pqvv_rec.to_date;
    p3_a7 := rosetta_g_miss_num_map(ddx_pqvv_rec.created_by);
    p3_a8 := ddx_pqvv_rec.creation_date;
    p3_a9 := rosetta_g_miss_num_map(ddx_pqvv_rec.last_updated_by);
    p3_a10 := ddx_pqvv_rec.last_update_date;
    p3_a11 := rosetta_g_miss_num_map(ddx_pqvv_rec.last_update_login);
  end;
  ...
  as
    ddp_pqyv_rec okl_setuppqvalues_pvt.pqyv_rec_type;
    ddp_pdtv_rec okl_setuppqvalues_pvt.pdtv_rec_type;
    ddp_pqvv_rec okl_setuppqvalues_pvt.pqvv_rec_type;
    ddx_pqvv_rec okl_setuppqvalues_pvt.pqvv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppqvalues_pvt.insert_pqvalues(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pqyv_rec okl_setuppqvalues_pvt.pqyv_rec_type;
    ddp_pdtv_rec okl_setuppqvalues_pvt.pdtv_rec_type;
    ddp_pqvv_tbl okl_setuppqvalues_pvt.pqvv_tbl_type;
    ddx_pqvv_tbl okl_setuppqvalues_pvt.pqvv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppqvalues_pvt.update_pqvalues(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
