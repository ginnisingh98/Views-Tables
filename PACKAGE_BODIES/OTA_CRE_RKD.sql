--------------------------------------------------------
--  DDL for Package Body OTA_CRE_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CRE_RKD" as
...
begin
hr_utility.set_location('Entering: OTA_CRE_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: OTA_CRE_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end OTA_CRE_RKD;
