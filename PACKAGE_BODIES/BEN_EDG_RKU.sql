--------------------------------------------------------
--  DDL for Package Body BEN_EDG_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EDG_RKU" as
...
begin
hr_utility.set_location('Entering: ben_edg_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_edg_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_edg_RKU;
