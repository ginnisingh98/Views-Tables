--------------------------------------------------------
--  DDL for Package Body BEN_PPR_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PPR_RKU" as
...
begin
hr_utility.set_location('Entering: BEN_PPR_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: BEN_PPR_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end BEN_PPR_RKU;
