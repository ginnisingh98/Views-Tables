--------------------------------------------------------
--  DDL for Package Body BEN_WCT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_WCT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_wct_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.wv_prtn_rsn_ctfn_ptip_id       = p_rec.wv_prtn_rsn_ctfn_ptip_id
    and    t.effective_start_date =
             ben_wct_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_wv_prtn_rsn_ctfn_ptip_f.created_by%TYPE;
  l_creation_date       ben_wv_prtn_rsn_ctfn_ptip_f.creation_date%TYPE;
  l_last_update_date   	ben_wv_prtn_rsn_ctfn_ptip_f.last_update_date%TYPE;
  l_last_updated_by     ben_wv_prtn_rsn_ctfn_ptip_f.last_updated_by%TYPE;
  l_last_update_login   ben_wv_prtn_rsn_ctfn_ptip_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_wv_prtn_rsn_ctfn_ptip_f
  --
  insert into ben_wv_prtn_rsn_ctfn_ptip_f
  ...
  Values
  (	p_rec.wv_prtn_rsn_ctfn_ptip_id,
...
--
cursor c1 is
      select BEN_WV_PRTN_RSN_CTFN_PTIP_F_S.nextval
      from sys.dual;
--
--
Begin
  ...
  --
       open c1;
        fetch c1 into p_rec. WV_PRTN_RSN_CTFN_PTIP_ID;
      close c1;
 --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  dt_api.validate_dt_mode
	(p_effective_date	   => p_effective_date,
	 ...
	 p_parent_key_value2       => p_rec.wv_prtn_rsn_ptip_id,
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_wct_rec
  ...
  --
  p_wv_prtn_rsn_ctfn_ptip_id        	:= l_rec.wv_prtn_rsn_ctfn_ptip_id;
