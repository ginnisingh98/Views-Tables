--------------------------------------------------------
--  DDL for Package Body AME_ACU_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ACU_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_acu_bus.';  -- Global package name
--
--  ---------------------------------------------------------------------------
--  |------------------------<chk_action_id  >-----------------------------|
--  ---------------------------------------------------------------------------
...
--
-- Description:
--   Validates that the action_id is a foreign key to ame_actions.action_id.
--
-- Prerequisites:
--   None.
--
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
procedure chk_action_id
  (p_action_id   in number,
   p_effective_date        in date) is
  l_proc              varchar2(72)  :=  g_package||'chk_action_id';
  tempCount integer;
  cursor c_sel1 is
    select null
      from ame_actions
...
begin
  ...
  if c_sel1%notfound then
    close c_sel1;
    fnd_message.set_name('PER','AME_400481_INV_ACTION_ID');
...
exception
   when app_exception.application_exception then
     if hr_multi_message.exception_add
       (p_associated_column1 => 'ACION_ID') then
...
Begin
  ...
  --
  IF NOT ame_acu_shd.api_updating
...
Begin
  ...
  --
  --
  chk_action_id(p_action_id       => p_rec.action_id
               ,p_effective_date  => p_effective_date);
  --
  --
