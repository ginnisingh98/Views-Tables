--------------------------------------------------------
--  DDL for Package Body IGF_AW_FISAP_BATCH_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_AW_FISAP_BATCH_PKG" AS
/* $Header: IGFWI73B.pls 120.0 2005/09/13 09:52:31 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_aw_fisap_batch%ROWTYPE;
  new_references igf_aw_fisap_batch%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.reported_time_txt                 := x_reported_time_txt;
  ...
  */
  BEGIN
    ...
    igf_aw_fisap_rep_pkg.get_fk_igf_aw_fisap_batch (
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND ((tlinfo.reported_time_txt = x_reported_time_txt) OR ((tlinfo.reported_time_txt IS NULL) AND (X_reported_time_txt IS NULL)))
       ) THEN
      NULL;
    ELSE
