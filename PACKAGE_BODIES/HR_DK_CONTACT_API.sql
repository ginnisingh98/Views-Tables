--------------------------------------------------------
--  DDL for Package Body HR_DK_CONTACT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DK_CONTACT_API" AS
/* $Header: pecondki.pkb 120.2 2005/10/18 22:47 saurai noship $ */
--
	-- Package Variables
   g_package  varchar2(33) := 'hr_dk_contact_api';
