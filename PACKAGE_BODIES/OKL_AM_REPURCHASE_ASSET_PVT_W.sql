--------------------------------------------------------
--  DDL for Package Body OKL_AM_REPURCHASE_ASSET_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_REPURCHASE_ASSET_PVT_W" as
  /* $Header: OKLERQUB.pls 120.2 2005/08/19 01:36:48 rmunjulu noship $ */
  ...
  as
    ddp_qtev_rec okl_am_repurchase_asset_pvt.qtev_rec_type;
    ddp_tqlv_tbl okl_am_repurchase_asset_pvt.tqlv_tbl_type;
    ddx_qtev_rec okl_am_repurchase_asset_pvt.qtev_rec_type;
    ddx_tqlv_tbl okl_am_repurchase_asset_pvt.tqlv_tbl_type;
  ...
  begin
    ...
    okl_am_repurchase_asset_pvt.create_repurchase_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_repurchase_asset_pvt.update_repurchase_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_am_repurchase_asset_pvt_w;
