--------------------------------------------------------
--  DDL for Package Body HR_AE_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_AE_PERSON_API" as
/* $Header: peperaei.pkb 120.2.12000000.1 2007/01/22 01:09:02 appldev noship $ */

   -- Package Variables
   g_package   VARCHAR2(33) := 'hr_ae_person_api.';
...
procedure update_ae_person
  ...
  l_proc                 varchar2(72) := g_package||'update_ae_person';
...
begin
 ...
 if g_debug then
  ...
  ,p_per_information3             => p_mother_name
  ,p_per_information4             => p_alt_first_name
  ,p_per_information5             => p_alt_father_name
  ,p_per_information6             => p_alt_grandfather_name
  ,p_per_information7          	  => p_alt_family_name
  ,p_per_information8          	  => p_alt_mother_name
  ,p_per_information9          	  => p_previous_nationality
  ,p_per_information10            => p_religion
  ,p_per_information11            => p_education_level
  ,p_per_information12            => p_country_of_birth
  ,p_per_information13            => p_alt_place_of_birth
  ,p_per_information16         	  => p_date_of_change
  ,p_per_information17            => p_reason_for_change
  ,p_per_information18            => p_nationality
