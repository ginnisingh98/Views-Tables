--------------------------------------------------------
--  DDL for Package Body OKL_RELEASE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_RELEASE_PUB_W" as
  /* $Header: OKLUREKB.pls 120.3 2005/10/30 03:50:32 appldev noship $ */
  ...
  as
    ddp_trx_date date;
    ddx_tcnv_rec okl_release_pub.tcnv_rec_type;
  ...
  begin
    ...
    okl_release_pub.create_release_contract(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
