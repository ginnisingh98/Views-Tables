--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_BENEFITS_GROUP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_BENEFITS_GROUP" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 13:01:48
 * Generated for API: ben_benefits_group_api.DELETE_BENEFITS_GROUP
 */
--
...
--
if c.p1 is null then
L_BENFTS_GRP_ID:=nn;
else
L_BENFTS_GRP_ID := 
hr_pump_get.GET_BENFTS_GRP_ID
(P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_BENEFITS_GROUP => c.p1);
end if;
--
if c.p1 is null then
...
end hrdpp_DELETE_BENEFITS_GROUP;
