--------------------------------------------------------
--  DDL for Package Body HR_NO_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_NO_CONTINGENT_WORKER_API" AS
  /* $Header: pecwknoi.pkb 120.0 2005/05/31 07:26:01 appldev noship $ */
--
-- Package Variables
	g_package  varchar2(33) := 'hr_no_contingent_worker_api.';
...
procedure create_no_cwk
  ...
  l_proc                 varchar2(72) := g_package||'update_no_person';
...
hr_contingent_worker_api.create_cwk
  ...
  ,p_per_information_category      => 'NO'
  ,p_per_information1              => p_social_security_office
  ,p_per_information2              => p_qualification
  ,p_per_information3              => p_nus2000_code
  ,p_per_information4              => p_grade_point_avg
  ,p_per_information5              => p_no_of_credits
