--------------------------------------------------------
--  DDL for Package Body BEN_EPM_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EPM_RKI" as
...
begin
hr_utility.set_location('Entering: BEN_EPM_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: BEN_EPM_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end BEN_EPM_RKI;
