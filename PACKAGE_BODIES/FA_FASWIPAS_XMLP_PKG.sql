--------------------------------------------------------
--  DDL for Package Body FA_FASWIPAS_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FASWIPAS_XMLP_PKG" AS
/* $Header: FASWIPASB.pls 120.0.12010000.1 2008/07/28 13:17:50 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    RP_Report_Name := ':Construction in Process Assets Report:';
