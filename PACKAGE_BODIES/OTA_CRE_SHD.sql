--------------------------------------------------------
--  DDL for Package Body OTA_CRE_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CRE_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_cre_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'OTA_CERT_ENROLLMENTS_PK') Then
...
Begin
  --
  If (p_cert_enrollment_id is null and
    ...
    l_fct_ret := false;
  Else
    If (p_cert_enrollment_id
        = ota_cre_shd.g_old_rec.cert_enrollment_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into ota_cre_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> ota_cre_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  l_rec.certification_status_code        := p_certification_status_code;
  l_rec.completion_date                  := p_completion_date;
  l_rec.business_group_id                := p_business_group_id;
  l_rec.unenrollment_date                := p_unenrollment_date;
  l_rec.expiration_date                  := p_expiration_date;
  l_rec.earliest_enroll_date             := p_earliest_enroll_date;
  ...
  l_rec.enrollment_date                  := p_enrollment_date;
  --
