--------------------------------------------------------
--  DDL for Package Body OKC_TGN_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKC_TGN_PVT" AS
/* $Header: OKCSTGNB.pls 120.0 2005/05/25 18:05:32 appldev noship $ */
...
*/
  ---------------------------------------------------------------------------
  -- FUNCTION get_rec for: OKC_TIME_TPG_NAMED_V
  ---------------------------------------------------------------------------
  FUNCTION get_rec (
    p_tgnv_rec                     IN tgnv_rec_type,
    x_no_data_found                OUT NOCOPY BOOLEAN
  ) RETURN tgnv_rec_type IS
    CURSOR okc_tgnv_pk_csr (p_id                 IN NUMBER) IS
    SELECT
            ID,
            OBJECT_VERSION_NUMBER,
--Bug 3122962            SFWT_FLAG,
            ...
            LAST_UPDATE_DATE,
            LAST_UPDATE_LOGIN
      FROM Okc_Time_Tpg_Named_V
     WHERE okc_time_tpg_named_v.id = p_id;
    l_okc_tgnv_pk                  okc_tgnv_pk_csr%ROWTYPE;
    l_tgnv_rec                     tgnv_rec_type;
  BEGIN
    x_no_data_found := TRUE;
    -- Get current database values
    OPEN okc_tgnv_pk_csr (p_tgnv_rec.id);
    FETCH okc_tgnv_pk_csr INTO
              l_tgnv_rec.ID,
              l_tgnv_rec.OBJECT_VERSION_NUMBER,
--Bug 3122962              l_tgnv_rec.SFWT_FLAG,
              l_tgnv_rec.CNH_ID,
              l_tgnv_rec.DNZ_CHR_ID,
              l_tgnv_rec.TZE_ID,
              l_tgnv_rec.TVE_ID_LIMITED,
              l_tgnv_rec.DESCRIPTION,
              l_tgnv_rec.SHORT_DESCRIPTION,
              l_tgnv_rec.COMMENTS,
              l_tgnv_rec.ATTRIBUTE_CATEGORY,
              l_tgnv_rec.ATTRIBUTE1,
              l_tgnv_rec.ATTRIBUTE2,
              l_tgnv_rec.ATTRIBUTE3,
              l_tgnv_rec.ATTRIBUTE4,
              l_tgnv_rec.ATTRIBUTE5,
              l_tgnv_rec.ATTRIBUTE6,
              l_tgnv_rec.ATTRIBUTE7,
              l_tgnv_rec.ATTRIBUTE8,
              l_tgnv_rec.ATTRIBUTE9,
              l_tgnv_rec.ATTRIBUTE10,
              l_tgnv_rec.ATTRIBUTE11,
              l_tgnv_rec.ATTRIBUTE12,
              l_tgnv_rec.ATTRIBUTE13,
              l_tgnv_rec.ATTRIBUTE14,
              l_tgnv_rec.ATTRIBUTE15,
              l_tgnv_rec.CREATED_BY,
              l_tgnv_rec.CREATION_DATE,
              l_tgnv_rec.LAST_UPDATED_BY,
              l_tgnv_rec.LAST_UPDATE_DATE,
              l_tgnv_rec.LAST_UPDATE_LOGIN;
    x_no_data_found := okc_tgnv_pk_csr%NOTFOUND;
    CLOSE okc_tgnv_pk_csr;
    RETURN(l_tgnv_rec);
  END get_rec;
  ...
  FUNCTION get_rec (
    ...
    l_row_notfound                 BOOLEAN := TRUE;
  BEGIN
    RETURN(get_rec(p_tgnv_rec, l_row_notfound));
  END get_rec;

  ----------------------------------------------------------
  -- FUNCTION null_out_defaults for: OKC_TIME_TPG_NAMED_V --
  ----------------------------------------------------------
  ...
  BEGIN
    IF (l_tgnv_rec.object_version_number = OKC_API.G_MISS_NUM) THEN
      l_tgnv_rec.object_version_number := NULL;
    END IF;
--Bug 3122962
/*    IF (l_tgnv_rec.sfwt_flag = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.sfwt_flag := NULL;
    END IF;
*/
    IF (l_tgnv_rec.cnh_id = OKC_API.G_MISS_NUM) THEN
      l_tgnv_rec.cnh_id := NULL;
    END IF;
    IF (l_tgnv_rec.dnz_chr_id = OKC_API.G_MISS_NUM) THEN
      l_tgnv_rec.dnz_chr_id := NULL;
    END IF;
    IF (l_tgnv_rec.tze_id = OKC_API.G_MISS_NUM) THEN
      l_tgnv_rec.tze_id := NULL;
    END IF;
    IF (l_tgnv_rec.tve_id_limited = OKC_API.G_MISS_NUM) THEN
      l_tgnv_rec.tve_id_limited := NULL;
    END IF;
    IF (l_tgnv_rec.description = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.description := NULL;
    END IF;
    IF (l_tgnv_rec.short_description = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.short_description := NULL;
    END IF;
    IF (l_tgnv_rec.comments = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.comments := NULL;
    END IF;
    IF (l_tgnv_rec.attribute_category = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute_category := NULL;
    END IF;
    IF (l_tgnv_rec.attribute1 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute1 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute2 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute2 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute3 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute3 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute4 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute4 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute5 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute5 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute6 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute6 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute7 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute7 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute8 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute8 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute9 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute9 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute10 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute10 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute11 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute11 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute12 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute12 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute13 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute13 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute14 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute14 := NULL;
    END IF;
    IF (l_tgnv_rec.attribute15 = OKC_API.G_MISS_CHAR) THEN
      l_tgnv_rec.attribute15 := NULL;
    END IF;
    IF (l_tgnv_rec.created_by = OKC_API.G_MISS_NUM) THEN
      l_tgnv_rec.created_by := NULL;
    END IF;
    IF (l_tgnv_rec.creation_date = OKC_API.G_MISS_DATE) THEN
      l_tgnv_rec.creation_date := NULL;
    END IF;
    IF (l_tgnv_rec.last_updated_by = OKC_API.G_MISS_NUM) THEN
      l_tgnv_rec.last_updated_by := NULL;
    END IF;
    IF (l_tgnv_rec.last_update_date = OKC_API.G_MISS_DATE) THEN
      l_tgnv_rec.last_update_date := NULL;
    END IF;
    IF (l_tgnv_rec.last_update_login = OKC_API.G_MISS_NUM) THEN
      l_tgnv_rec.last_update_login := NULL;
    END IF;
    RETURN(l_tgnv_rec);
...
*/
  ...
  ---------------------------------------------------------------------------
  --------------------------------------------------
  -- Validate_Attributes for:OKC_TIME_TPG_NAMED_V --
  --------------------------------------------------
  ...
  PROCEDURE Validate_DNZ_Chr_ID (
    ...
    BEGIN
      ...
      IF (p_tgnv_rec.dnz_chr_id IS NOT NULL AND
          p_tgnv_rec.dnz_chr_id <> OKC_API.G_MISS_NUM)
      THEN
        OPEN okc_chrv_pk_csr(p_tgnv_rec.dnz_chr_id);
  ...
  PROCEDURE Validate_Cnh_Id (
    ...
    item_not_found_error          EXCEPTION;
    l_row_notfound                 BOOLEAN := TRUE;
    CURSOR okc_cnhv_pk_csr (p_id                 IN NUMBER,
					   p_dnz_chr_id         IN NUMBER) IS
    SELECT
      '1'
      FROM okc_condition_headers_b, okc_k_headers_b k
     WHERE okc_condition_headers_b.id = p_id
	  AND okc_condition_headers_b.dnz_chr_id = p_dnz_chr_id and
		 okc_condition_headers_b.template_yn = k.template_yn and
		 okc_condition_headers_b.dnz_chr_id = k.id;
    CURSOR okc_cnhv_pk_csr1 (p_id                 IN NUMBER) IS
    SELECT
      '1'
      FROM okc_condition_headers_b
     WHERE okc_condition_headers_b.id = p_id
	  AND okc_condition_headers_b.dnz_chr_id is NULL and
		 okc_condition_headers_b.template_yn = 'Y';
    l_okc_cnhv_pk                   okc_cnhv_pk_csr%ROWTYPE;
    l_okc_cnhv_pk1                  okc_cnhv_pk_csr1%ROWTYPE;
  BEGIN
    x_return_status                := OKC_API.G_RET_STS_SUCCESS;
    IF (p_tgnv_rec.CNH_ID IS NOT NULL AND
        p_tgnv_rec.CNH_ID <> OKC_API.G_MISS_NUM)
    THEN
	 IF p_tgnv_rec.dnz_chr_id <> 0 Then
        OPEN okc_cnhv_pk_csr(p_tgnv_rec.CNH_ID, p_tgnv_rec.dnz_chr_id);
	 ...
	 /* For Standard Articles */
        OPEN okc_cnhv_pk_csr1(p_tgnv_rec.CNH_ID);
        FETCH okc_cnhv_pk_csr1 INTO l_okc_cnhv_pk1;
        l_row_notfound := okc_cnhv_pk_csr1%NOTFOUND;
        CLOSE okc_cnhv_pk_csr1;
        IF (l_row_notfound) THEN
          OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'CNH_ID');
          RAISE item_not_found_error;
        END IF;
	 END IF;
    --  OKC_UTIL.Check_Unique(p_view_name => 'OKC_TIME_TPG_NAMED_V',
    --               p_col_name	=> 'CNH_ID',
    --               p_col_value => p_tgnv_rec.CNH_ID,
    --               p_id => p_tgnv_rec.ID,
  ...
  PROCEDURE Validate_Tve_Id_Limited (
    ...
    BEGIN
      x_return_status                := OKC_API.G_RET_STS_SUCCESS;
      IF (p_tgnv_rec.TVE_ID_LIMITED IS NOT NULL AND
          p_tgnv_rec.TVE_ID_LIMITED <> OKC_API.G_MISS_NUM)
      THEN
        OPEN okc_tvev_pk_csr(p_tgnv_rec.TVE_ID_LIMITED);
  ...
  PROCEDURE Validate_Time_Zone_Id (
    ...
    BEGIN
      x_return_status                := OKC_API.G_RET_STS_SUCCESS;
      IF (p_tgnv_rec.TZE_ID IS NOT NULL AND
          p_tgnv_rec.TZE_ID <> OKC_API.G_MISS_NUM)
      THEN
        OPEN okx_timezones_v_pk_csr(p_tgnv_rec.TZE_ID);
...
/*
  PROCEDURE Validate_SFWT_Flag (
    ...
    p_tgnv_rec                     IN tgnv_rec_type) IS
  BEGIN
    IF upper(p_tgnv_rec.sfwt_flag) = 'Y' OR
       upper(p_tgnv_rec.sfwt_flag) = 'N'
    THEN
       IF p_tgnv_rec.sfwt_flag = 'Y' OR
          p_tgnv_rec.sfwt_flag = 'N'
       THEN
         x_return_status := OKC_API.G_RET_STS_SUCCESS;
       ELSE
...
*/
  ...
  BEGIN
    IF p_tgnv_rec.id = OKC_API.G_MISS_NUM OR
       p_tgnv_rec.id IS NULL
    THEN
      OKC_API.set_message(G_APP_NAME, G_REQUIRED_VALUE,G_COL_NAME_TOKEN,'id');
      x_return_status := OKC_API.G_RET_STS_ERROR;
    ELSIF p_tgnv_rec.object_version_number = OKC_API.G_MISS_NUM OR
          p_tgnv_rec.object_version_number IS NULL
    THEN
    ...
    IF p_tgnv_rec.dnz_chr_id <> 0 Then
      ...
      END IF;
    END IF;
    Validate_Cnh_Id (l_return_status,
                     p_tgnv_rec);
    IF (l_return_status <> OKC_API.G_RET_STS_SUCCESS) THEN
      IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN  -- need to leave
        x_return_status := l_return_status;
    ...
    END IF;
    IF (p_tgnv_rec.tve_id_limited is NOT NULL AND
        p_tgnv_rec.tve_id_limited <> OKC_API.G_MISS_NUM) THEN
...
*/
  ...
  ---------------------------------------------------------------------------
  ----------------------------------------------
  -- Validate_Record for:OKC_TIME_TPG_NAMED_V --
  ----------------------------------------------
...
*/
  ...
  ---------------------------------------------------------------------------
  -------------------------------------------
  -- validate_row for:OKC_TIME_TPG_NAMED_V --
  -------------------------------------------
  PROCEDURE validate_row(
...
--Bug 3122962    l_okc_timevalues_tl_rec        okc_timevalues_tl_rec_type;
  BEGIN
    ...
    l_return_status := Validate_Attributes(l_tgnv_rec);
    ...
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    l_return_status := Validate_Record(l_tgnv_rec);
    IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_UNEXPECTED_ERROR;
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
  ...
  END validate_row;
  ------------------------------------------
  -- PL/SQL TBL validate_row for:TGNV_TBL --
  ------------------------------------------
  PROCEDURE validate_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
*/
  -----------------------------------------
  -- insert_row for:OKC_TIME_TPG_NAMED_V --
  -----------------------------------------
  PROCEDURE insert_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
--Bug 3122962    lx_okc_timevalues_tl_rec       okc_timevalues_tl_rec_type;
    ...
    FUNCTION fill_who_columns (
      ...
      l_tgnv_rec	tgnv_rec_type := p_tgnv_rec;
    BEGIN
      l_tgnv_rec.CREATION_DATE := SYSDATE;
      l_tgnv_rec.CREATED_BY := FND_GLOBAL.USER_ID;
      l_tgnv_rec.LAST_UPDATE_DATE := l_tgnv_rec.CREATION_DATE;
      l_tgnv_rec.LAST_UPDATED_BY := FND_GLOBAL.USER_ID;
      l_tgnv_rec.LAST_UPDATE_LOGIN := FND_GLOBAL.LOGIN_ID;
      RETURN(l_tgnv_rec);
    END fill_who_columns;
    ---------------------------------------------
    -- Set_Attributes for:OKC_TIME_TPG_NAMED_V --
    ---------------------------------------------
    FUNCTION Set_Attributes (
      p_tgnv_rec IN  tgnv_rec_type,
      ...
      l_return_status                VARCHAR2(1) := OKC_API.G_RET_STS_SUCCESS;
    BEGIN
      x_tgnv_rec := p_tgnv_rec;
      x_tgnv_rec.OBJECT_VERSION_NUMBER := 1;
--Bug 3122962      x_tgnv_rec.SFWT_FLAG := 'N';
      RETURN(l_return_status);
    END Set_Attributes;
  BEGIN
    l_return_status := OKC_API.START_ACTIVITY(l_api_name,
    ...
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    l_tgnv_rec := null_out_defaults(p_tgnv_rec);
    -- Set primary key value
    l_tgnv_rec.ID := get_seq_id;
    --- Setting item attributes
    l_return_status := Set_Attributes(
      l_tgnv_rec,                        -- IN
      l_def_tgnv_rec);                   -- OUT
    ...
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    l_def_tgnv_rec := fill_who_columns(l_def_tgnv_rec);
    --- Validate all non-missing attributes (Item Level Validation)
    l_return_status := Validate_Attributes(l_def_tgnv_rec);
    --- If any errors happen abort API
    IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_UNEXPECTED_ERROR;
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    l_return_status := Validate_Record(l_def_tgnv_rec);
    IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_UNEXPECTED_ERROR;
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    ...
    --------------------------------------
    migrate(l_def_tgnv_rec, l_tve_rec);
--Bug 3122962    migrate(l_def_tgnv_rec, l_okc_timevalues_tl_rec);
    --------------------------------------------
    ...
    ELSIF (x_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    migrate(lx_tve_rec, l_def_tgnv_rec);
/*    insert_row(
      p_init_msg_list,
      x_return_status,
      x_msg_count,
    ...
    ELSIF (x_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    migrate(lx_okc_timevalues_tl_rec, l_def_tgnv_rec);
*/
    -- Set OUT values
    x_tgnv_rec := l_def_tgnv_rec;
    OKC_API.END_ACTIVITY(x_msg_count, x_msg_data);
  EXCEPTION
    WHEN OKC_API.G_EXCEPTION_ERROR THEN
      x_return_status := OKC_API.HANDLE_EXCEPTIONS
  ...
  END insert_row;
  ----------------------------------------
  -- PL/SQL TBL insert_row for:TGNV_TBL --
  ----------------------------------------
  PROCEDURE insert_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
*/
  ---------------------------------------
  -- lock_row for:OKC_TIME_TPG_NAMED_V --
  ---------------------------------------
  PROCEDURE lock_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
--Bug 3122962    l_okc_timevalues_tl_rec        okc_timevalues_tl_rec_type;
  BEGIN
    ...
    -- Move VIEW record to "Child" records
    --------------------------------------
    migrate(p_tgnv_rec, l_tve_rec);
--Bug 3122962    migrate(p_tgnv_rec, l_okc_timevalues_tl_rec);
    --------------------------------------------
...
*/
  ...
  END lock_row;
  --------------------------------------
  -- PL/SQL TBL lock_row for:TGNV_TBL --
  --------------------------------------
  PROCEDURE lock_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
*/
  -----------------------------------------
  -- update_row for:OKC_TIME_TPG_NAMED_V --
  -----------------------------------------
  PROCEDURE update_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
--Bug 3122962    lx_okc_timevalues_tl_rec       okc_timevalues_tl_rec_type;
    ...
    FUNCTION fill_who_columns (
      ...
      l_tgnv_rec	tgnv_rec_type := p_tgnv_rec;
    BEGIN
      l_tgnv_rec.LAST_UPDATE_DATE := SYSDATE;
      l_tgnv_rec.LAST_UPDATED_BY := FND_GLOBAL.USER_ID;
      l_tgnv_rec.LAST_UPDATE_LOGIN := FND_GLOBAL.LOGIN_ID;
      RETURN(l_tgnv_rec);
    END fill_who_columns;
    ...
    BEGIN
      x_tgnv_rec := p_tgnv_rec;
      -- Get current database values
      l_tgnv_rec := get_rec(p_tgnv_rec, l_row_notfound);
      IF (l_row_notfound) THEN
        l_return_status := OKC_API.G_RET_STS_UNEXP_ERROR;
      END IF;
      IF (x_tgnv_rec.id = OKC_API.G_MISS_NUM)
      THEN
        x_tgnv_rec.id := l_tgnv_rec.id;
      END IF;
      IF (x_tgnv_rec.object_version_number = OKC_API.G_MISS_NUM)
      THEN
        x_tgnv_rec.object_version_number := l_tgnv_rec.object_version_number;
      END IF;
--Bug 3122962
/*      IF (x_tgnv_rec.sfwt_flag = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.sfwt_flag := l_tgnv_rec.sfwt_flag;
      END IF;
*/
      IF (x_tgnv_rec.cnh_id = OKC_API.G_MISS_NUM)
      THEN
        x_tgnv_rec.cnh_id := l_tgnv_rec.cnh_id;
      END IF;
      IF (x_tgnv_rec.dnz_chr_id = OKC_API.G_MISS_NUM)
      THEN
        x_tgnv_rec.dnz_chr_id := l_tgnv_rec.dnz_chr_id;
      END IF;
      IF (x_tgnv_rec.tze_id = OKC_API.G_MISS_NUM)
      THEN
        x_tgnv_rec.tze_id := l_tgnv_rec.tze_id;
      END IF;
      IF (x_tgnv_rec.tve_id_limited = OKC_API.G_MISS_NUM)
      THEN
        x_tgnv_rec.tve_id_limited := l_tgnv_rec.tve_id_limited;
      END IF;
      IF (x_tgnv_rec.description = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.description := l_tgnv_rec.description;
      END IF;
      IF (x_tgnv_rec.short_description = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.short_description := l_tgnv_rec.short_description;
      END IF;
      IF (x_tgnv_rec.comments = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.comments := l_tgnv_rec.comments;
      END IF;
      IF (x_tgnv_rec.attribute_category = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute_category := l_tgnv_rec.attribute_category;
      END IF;
      IF (x_tgnv_rec.attribute1 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute1 := l_tgnv_rec.attribute1;
      END IF;
      IF (x_tgnv_rec.attribute2 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute2 := l_tgnv_rec.attribute2;
      END IF;
      IF (x_tgnv_rec.attribute3 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute3 := l_tgnv_rec.attribute3;
      END IF;
      IF (x_tgnv_rec.attribute4 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute4 := l_tgnv_rec.attribute4;
      END IF;
      IF (x_tgnv_rec.attribute5 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute5 := l_tgnv_rec.attribute5;
      END IF;
      IF (x_tgnv_rec.attribute6 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute6 := l_tgnv_rec.attribute6;
      END IF;
      IF (x_tgnv_rec.attribute7 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute7 := l_tgnv_rec.attribute7;
      END IF;
      IF (x_tgnv_rec.attribute8 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute8 := l_tgnv_rec.attribute8;
      END IF;
      IF (x_tgnv_rec.attribute9 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute9 := l_tgnv_rec.attribute9;
      END IF;
      IF (x_tgnv_rec.attribute10 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute10 := l_tgnv_rec.attribute10;
      END IF;
      IF (x_tgnv_rec.attribute11 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute11 := l_tgnv_rec.attribute11;
      END IF;
      IF (x_tgnv_rec.attribute12 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute12 := l_tgnv_rec.attribute12;
      END IF;
      IF (x_tgnv_rec.attribute13 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute13 := l_tgnv_rec.attribute13;
      END IF;
      IF (x_tgnv_rec.attribute14 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute14 := l_tgnv_rec.attribute14;
      END IF;
      IF (x_tgnv_rec.attribute15 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgnv_rec.attribute15 := l_tgnv_rec.attribute15;
      END IF;
      IF (x_tgnv_rec.created_by = OKC_API.G_MISS_NUM)
      THEN
        x_tgnv_rec.created_by := l_tgnv_rec.created_by;
      END IF;
      IF (x_tgnv_rec.creation_date = OKC_API.G_MISS_DATE)
      THEN
        x_tgnv_rec.creation_date := l_tgnv_rec.creation_date;
      END IF;
      IF (x_tgnv_rec.last_updated_by = OKC_API.G_MISS_NUM)
      THEN
        x_tgnv_rec.last_updated_by := l_tgnv_rec.last_updated_by;
      END IF;
      IF (x_tgnv_rec.last_update_date = OKC_API.G_MISS_DATE)
      THEN
        x_tgnv_rec.last_update_date := l_tgnv_rec.last_update_date;
      END IF;
      IF (x_tgnv_rec.last_update_login = OKC_API.G_MISS_NUM)
      THEN
        x_tgnv_rec.last_update_login := l_tgnv_rec.last_update_login;
      END IF;
      RETURN(l_return_status);
    END populate_new_record;
    ---------------------------------------------
...
--      x_tgnv_rec.SFWT_FLAG := upper(p_tgnv_rec.SFWT_FLAG);
      x_tgnv_rec.OBJECT_VERSION_NUMBER := NVL(x_tgnv_rec.OBJECT_VERSION_NUMBER, 0) + 1;
      RETURN(l_return_status);
    END Set_Attributes;
  BEGIN
    l_return_status := OKC_API.START_ACTIVITY(l_api_name,
    ...
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    l_return_status := populate_new_record(l_tgnv_rec, l_def_tgnv_rec);
    IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_UNEXPECTED_ERROR;
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
...
*/
  ...
  END update_row;
  ----------------------------------------
  -- PL/SQL TBL update_row for:TGNV_TBL --
  ----------------------------------------
  PROCEDURE update_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
*/
  -----------------------------------------
  -- delete_row for:OKC_TIME_TPG_NAMED_V --
  -----------------------------------------
  PROCEDURE delete_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
--Bug 3122962    l_okc_timevalues_tl_rec        okc_timevalues_tl_rec_type;
  ...
  BEGIN
    ...
    -- Move VIEW record to "Child" records
    --------------------------------------
--Bug 3122962    migrate(l_tgnv_rec, l_okc_timevalues_tl_rec);
    migrate(l_tgnv_rec, l_tve_rec);
    --------------------------------------------
...
*/
  ...
  END delete_row;
  ----------------------------------------
  -- PL/SQL TBL delete_row for:TGNV_TBL --
  ----------------------------------------
  PROCEDURE delete_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
