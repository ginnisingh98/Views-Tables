--------------------------------------------------------
--  DDL for Package Body IRC_OFFERS_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_OFFERS_BE3" as 
--Code generated on 30/08/2013 11:35:52
/* $Header: hrapiwfe.pkb 120.4.12010000.2 2008/09/29 12:54:07 srgnanas ship $*/
procedure delete_offer_a (
p_object_version_number        number,
p_offer_id                     number) is
  l_event_key number;
  l_event_data clob;
  ...
  --
  l_proc varchar2(72):='  irc_offers_be3.delete_offer_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.offers.delete_offer';
