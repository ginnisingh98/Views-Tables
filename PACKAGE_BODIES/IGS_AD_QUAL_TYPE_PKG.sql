--------------------------------------------------------
--  DDL for Package Body IGS_AD_QUAL_TYPE_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AD_QUAL_TYPE_PKG" AS
/* $Header: IGSAII0B.pls 120.0 2005/10/14 10:42:59 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_ad_qual_type%ROWTYPE;
  new_references igs_ad_qual_type%ROWTYPE;
  ...
  */
  BEGIN
    ...
    IF (((old_references.admission_cat = new_references.admission_cat) AND
      ...
      NULL;
    ELSIF NOT igs_ad_prcs_cat_pkg.get_pk_for_validation (
  ...
  */
    CURSOR cur_rowid IS
      ...
      WHERE   ((admission_cat = x_admission_cat) AND
               (s_admission_process_type = x_s_admission_process_type));
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGS_AD_QUAL_TYPE_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
...
--    x_admission_cat := NULL;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGS_AD_QUAL_TYPE_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
