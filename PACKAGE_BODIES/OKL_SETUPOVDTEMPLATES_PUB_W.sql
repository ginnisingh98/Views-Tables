--------------------------------------------------------
--  DDL for Package Body OKL_SETUPOVDTEMPLATES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPOVDTEMPLATES_PUB_W" as
  /* $Header: OKLUSVTB.pls 115.2 2002/12/24 04:22:28 sgorantl noship $ */
  ...
  as
    ddp_ovtv_rec okl_setupovdtemplates_pub.ovtv_rec_type;
    ddx_no_data_found boolean;
    ddx_ovtv_rec okl_setupovdtemplates_pub.ovtv_rec_type;
  ...
  begin
    ...
    okl_setupovdtemplates_pub.get_rec(ddp_ovtv_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_ovtv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_ovtv_rec.id);
    p4_a1 := rosetta_g_miss_num_map(ddx_ovtv_rec.object_version_number);
    p4_a2 := rosetta_g_miss_num_map(ddx_ovtv_rec.ovd_id);
    p4_a3 := rosetta_g_miss_num_map(ddx_ovtv_rec.rul_id);
    p4_a4 := rosetta_g_miss_num_map(ddx_ovtv_rec.sequence_number);
    p4_a5 := rosetta_g_miss_num_map(ddx_ovtv_rec.created_by);
    p4_a6 := ddx_ovtv_rec.creation_date;
    p4_a7 := rosetta_g_miss_num_map(ddx_ovtv_rec.last_updated_by);
    p4_a8 := ddx_ovtv_rec.last_update_date;
    p4_a9 := rosetta_g_miss_num_map(ddx_ovtv_rec.last_update_login);
  end;
  ...
  as
    ddp_optv_rec okl_setupovdtemplates_pub.optv_rec_type;
    ddp_ovev_rec okl_setupovdtemplates_pub.ovev_rec_type;
    ddp_ovdv_rec okl_setupovdtemplates_pub.ovdv_rec_type;
    ddp_ovtv_rec okl_setupovdtemplates_pub.ovtv_rec_type;
    ddx_ovtv_rec okl_setupovdtemplates_pub.ovtv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupovdtemplates_pub.insert_ovdtemplates(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ...
    ddp_ovev_rec okl_setupovdtemplates_pub.ovev_rec_type;
    ddp_ovdv_rec okl_setupovdtemplates_pub.ovdv_rec_type;
    ddp_ovtv_tbl okl_setupovdtemplates_pub.ovtv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupovdtemplates_pub.delete_ovdtemplates(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_setupovdtemplates_pub_w;
