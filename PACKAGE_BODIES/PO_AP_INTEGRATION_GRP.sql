--------------------------------------------------------
--  DDL for Package Body PO_AP_INTEGRATION_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PO_AP_INTEGRATION_GRP" AS
/* $Header: POXGAPIB.pls 115.1 2004/03/25 07:17:42 axian noship $ */

g_pkg_name CONSTANT VARCHAR2(30) := 'PO_AP_INTEGRATION_GRP';
...
BEGIN
  ...
  -- Call the private get_invoice_numbering_options
  PO_AP_INTEGRATION_PVT.get_invoice_numbering_options(
      p_api_version                => p_api_version,
      p_org_id                     => p_org_id,
      x_return_status              => x_return_status,
      x_msg_data                   => x_msg_data,
      x_buying_company_identifier  => x_buying_company_identifier,
      x_gapless_inv_num_flag       => x_gapless_inv_num_flag
  );
