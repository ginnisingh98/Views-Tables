--------------------------------------------------------
--  DDL for Package Body WPS_RES_INSTANCE_AVAILABILITY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WPS_RES_INSTANCE_AVAILABILITY" AS
/* $Header: wpsinsab.pls 120.0 2005/05/24 17:40:39 appldev noship $ */
