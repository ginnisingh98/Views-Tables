--------------------------------------------------------
--  DDL for Package Body OKL_ACC_GEN_RULE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ACC_GEN_RULE_PVT_W" as
  /* $Header: OKLOAGRB.pls 120.1 2005/07/07 13:34:06 dkagrawa noship $ */
  ...
  as
    ddp_agrv_rec okl_acc_gen_rule_pvt.agrv_rec_type;
    ddp_aulv_tbl okl_acc_gen_rule_pvt.aulv_tbl_type;
    ddx_agrv_rec okl_acc_gen_rule_pvt.agrv_rec_type;
    ddx_aulv_tbl okl_acc_gen_rule_pvt.aulv_tbl_type;
  ...
  begin
    ...
    okl_acc_gen_rule_pvt.create_acc_gen_rule(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_gen_rule_pvt.update_acc_gen_rule(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_gen_rule_pvt.validate_acc_gen_rule(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_agrv_tbl okl_acc_gen_rule_pvt.agrv_tbl_type;
    ddx_agrv_tbl okl_acc_gen_rule_pvt.agrv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_gen_rule_pvt.lock_acc_gen_rule(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_gen_rule_pvt.delete_acc_gen_rule(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_gen_rule_pvt.create_acc_gen_rule_lns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_aulv_rec okl_acc_gen_rule_pvt.aulv_rec_type;
    ddx_aulv_rec okl_acc_gen_rule_pvt.aulv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_gen_rule_pvt.lock_acc_gen_rule_lns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_gen_rule_pvt.update_acc_gen_rule_lns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_gen_rule_pvt.delete_acc_gen_rule_lns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_gen_rule_pvt.validate_acc_gen_rule_lns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
