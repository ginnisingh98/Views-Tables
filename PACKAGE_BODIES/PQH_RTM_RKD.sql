--------------------------------------------------------
--  DDL for Package Body PQH_RTM_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_RTM_RKD" as
...
begin
hr_utility.set_location('Entering: PQH_RTM_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PQH_RTM_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PQH_RTM_RKD;
