--------------------------------------------------------
--  DDL for Package Body OKL_SPLIT_ASSET_COMP_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SPLIT_ASSET_COMP_PUB_W" as
  /* $Header: OKLUSACB.pls 115.2 2002/12/25 00:29:48 avsingh noship $ */
  ...
  as
    ddp_asdv_tbl okl_split_asset_comp_pub.advv_tbl_type;
    ddx_asdv_tbl okl_split_asset_comp_pub.advv_tbl_type;
  ...
  begin
    ...
    okl_split_asset_comp_pub.create_split_asset_comp(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_split_asset_comp_pub.update_split_asset_comp(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_split_asset_comp_pub.delete_split_asset_comp(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
