--------------------------------------------------------
--  DDL for Package Body PAY_PBC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PBC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_pbc_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_balance_category_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_balance_category_id  in  number) is
--
...
Begin
  ...
  --
  pay_pbc_ins.g_balance_category_id_i := p_balance_category_id;
  --
...
--
  Cursor C_Sel1 Is
    select t.created_by,
           t.creation_date
    from   pay_balance_categories_f t
    where  t.balance_category_id       = p_rec.balance_category_id
    and    t.effective_start_date =
             pay_pbc_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc                varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          pay_balance_categories_f.created_by%TYPE;
  l_creation_date       pay_balance_categories_f.creation_date%TYPE;
  l_last_update_date    pay_balance_categories_f.last_update_date%TYPE;
  l_last_updated_by     pay_balance_categories_f.last_updated_by%TYPE;
  l_last_update_login   pay_balance_categories_f.last_update_login%TYPE;
--
Begin
  ...
  --
  --
  -- Insert the row into: pay_balance_categories_f
  --
...
--
  Cursor C_Sel1 is select pay_balance_categories_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from pay_balance_categories_f
     where balance_category_id =
             pay_pbc_ins.g_balance_category_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (pay_pbc_ins.g_balance_category_id_i is not null) Then
    --
    ...
    p_rec.balance_category_id :=
      pay_pbc_ins.g_balance_category_id_i;
    pay_pbc_ins.g_balance_category_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.balance_category_id;
    Close C_Sel1;
  End If;
  --
  --
...
Begin
  ...
  --
  p_balance_category_id              := l_rec.balance_category_id;
