--------------------------------------------------------
--  DDL for Package Body PER_PEOPLE_INFO_TYPES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PEOPLE_INFO_TYPES_PKG" as
/* $Header: perperit.pkb 115.3 2002/12/06 15:20:29 eumenyio ship $ */
--------------------------------------------------------------------------------
...
procedure INSERT_ROW (
  ...
  cursor C is select ROWID from PER_PEOPLE_INFO_TYPES
...
begin
  update PER_PEOPLE_INFO_TYPES set
...
begin
  ...
  delete from PER_PEOPLE_INFO_TYPES
  where INFORMATION_TYPE = X_INFORMATION_TYPE;
...
is
  l_proc                        VARCHAR2(61) := 'PER_PEOPLE_INFO_TYPES_PKG.LOAD_ROW';
  l_rowid                       rowid;
  l_request_id                  PER_PEOPLE_INFO_types.request_id%TYPE;
