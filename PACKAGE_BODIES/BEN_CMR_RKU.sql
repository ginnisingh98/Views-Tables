--------------------------------------------------------
--  DDL for Package Body BEN_CMR_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CMR_RKU" as
/* $Header: becmrrhi.pkb 120.2 2006/03/30 23:54:32 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_cmr_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_cmr_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_cmr_RKU;
