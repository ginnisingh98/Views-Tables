--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_PRTT_ENRT_RESULT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_PRTT_ENRT_RESULT" as
/*
...
,P_SSPNDD_FLAG
,P_PRTT_IS_CVRD_FLAG
,nd(P_BNFT_AMT,I_BNFT_AMT)
,dd(P_ORGNL_ENRT_DT,I_ORGNL_ENRT_DT)
,P_ENRT_MTHD_CD
,P_NO_LNGR_ELIG_FLAG
,P_ENRT_OVRIDN_FLAG
,P_ENRT_OVRID_RSN_CD
,dd(P_ERLST_DEENRT_DT,I_ERLST_DEENRT_DT)
,dd(P_ENRT_CVG_STRT_DT,I_ENRT_CVG_STRT_DT)
,dd(P_ENRT_CVG_THRU_DT,I_ENRT_CVG_THRU_DT)
,dd(P_ENRT_OVRID_THRU_DT,I_ENRT_OVRID_THRU_DT)
...
,P_BNFT_TYP_CD
,nd(P_BNFT_ORDR_NUM,I_BNFT_ORDR_NUM)
...
decode(l.pval003,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval003,'YES_NO',d(l.pval056),vn)) p3,
l.pval003 d3,
decode(l.pval004,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval004,'YES_NO',d(l.pval056),vn)) p4,
l.pval004 d4,
...
decode(l.pval007,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval007,'BEN_ENRT_RSLT_MTHD',d(l.pval056),vn)) p7,
l.pval007 d7,
decode(l.pval008,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval008,'YES_NO',d(l.pval056),vn)) p8,
l.pval008 d8,
decode(l.pval009,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval009,'YES_NO',d(l.pval056),vn)) p9,
l.pval009 d9,
decode(l.pval010,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval010,'BEN_OVRID_RSN',d(l.pval056),vn)) p10,
l.pval010 d10,
decode(l.pval011,cn,dn,vn,dh,d(l.pval011)) p11,
l.pval011 d11,
decode(l.pval012,cn,dn,vn,dh,d(l.pval012)) p12,
l.pval012 d12,
...
l.pval049 d49,
decode(l.pval050,cn,dn,vn,dh,d(l.pval050)) p50,
l.pval050 d50,
decode(l.pval051,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval051,'BEN_BNFT_TYP',d(l.pval056),vn)) p51,
l.pval051 d51,
decode(l.pval052,cn,nn,vn,nh,n(l.pval052)) p52,
l.pval052 d52,
decode(l.pval053,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval053,'BEN_PRTT_ENRT_RSLT_STAT',d(l.pval056),vn)) p53,
l.pval053 d53,
decode(l.pval054,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval054,'BEN_NNMNTRY_UOM',d(l.pval056),vn)) p54,
l.pval054 d54,
decode(l.pval055,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval055,'BEN_COMP_LVL',d(l.pval056),vn)) p55,
l.pval055 d55,
decode(l.pval056,cn,dn,d(l.pval056)) p56,
decode(l.pval057,cn,vn,l.pval057) p57,
decode(l.pval058,cn,vn,vn,null,l.pval058) p58,
l.pval058 d58,
decode(l.pval059,cn,vn,l.pval059) p59,
...
--
if upper(c.p58) = 'TRUE' then
L_MULTI_ROW_VALIDATE := true;
elsif upper(c.p58) = 'FALSE' then
L_MULTI_ROW_VALIDATE := false;
elsif c.p58 is not null then
...
hr_utility.set_message_token('VALUE',c.p58);
hr_utility.set_message_token('TABLE','HR_PUMP_BATCH_LINES');
hr_utility.raise_error;
end if;
--
...
(P_PRTT_ENRT_RSLT_USER_KEY => c.p59);
end if;
--
if c.d60=cn then
L_OIPL_ID:=nn;
...
hr_pump_get.GET_PRTT_ENRT_RSLT_OVN
(P_PRTT_ENRT_RSLT_USER_KEY => c.p59
,P_EFFECTIVE_DATE => c.p56);
end if;
--
...
,P_LER_ID => L_LER_ID
,P_SSPNDD_FLAG => c.p3
,P_PRTT_IS_CVRD_FLAG => c.p4
,P_BNFT_AMT => c.p5
,P_UOM => L_UOM
,P_ORGNL_ENRT_DT => c.p6
,P_ENRT_MTHD_CD => c.p7
,P_NO_LNGR_ELIG_FLAG => c.p8
,P_ENRT_OVRIDN_FLAG => c.p9
,P_ENRT_OVRID_RSN_CD => c.p10
,P_ERLST_DEENRT_DT => c.p11
,P_ENRT_CVG_STRT_DT => c.p12
,P_ENRT_CVG_THRU_DT => c.p13
,P_ENRT_OVRID_THRU_DT => c.p14
,P_PL_ORDR_NUM => c.p15
,P_PLIP_ORDR_NUM => c.p16
,P_PTIP_ORDR_NUM => c.p17
,P_OIPL_ORDR_NUM => c.p18
,P_PEN_ATTRIBUTE_CATEGORY => c.p19
,P_PEN_ATTRIBUTE1 => c.p20
,P_PEN_ATTRIBUTE2 => c.p21
,P_PEN_ATTRIBUTE3 => c.p22
,P_PEN_ATTRIBUTE4 => c.p23
,P_PEN_ATTRIBUTE5 => c.p24
,P_PEN_ATTRIBUTE6 => c.p25
,P_PEN_ATTRIBUTE7 => c.p26
,P_PEN_ATTRIBUTE8 => c.p27
,P_PEN_ATTRIBUTE9 => c.p28
,P_PEN_ATTRIBUTE10 => c.p29
,P_PEN_ATTRIBUTE11 => c.p30
,P_PEN_ATTRIBUTE12 => c.p31
,P_PEN_ATTRIBUTE13 => c.p32
,P_PEN_ATTRIBUTE14 => c.p33
,P_PEN_ATTRIBUTE15 => c.p34
,P_PEN_ATTRIBUTE16 => c.p35
,P_PEN_ATTRIBUTE17 => c.p36
,P_PEN_ATTRIBUTE18 => c.p37
,P_PEN_ATTRIBUTE19 => c.p38
,P_PEN_ATTRIBUTE20 => c.p39
,P_PEN_ATTRIBUTE21 => c.p40
,P_PEN_ATTRIBUTE22 => c.p41
,P_PEN_ATTRIBUTE23 => c.p42
,P_PEN_ATTRIBUTE24 => c.p43
,P_PEN_ATTRIBUTE25 => c.p44
,P_PEN_ATTRIBUTE26 => c.p45
,P_PEN_ATTRIBUTE27 => c.p46
,P_PEN_ATTRIBUTE28 => c.p47
,P_PEN_ATTRIBUTE29 => c.p48
,P_PEN_ATTRIBUTE30 => c.p49
,P_REQUEST_ID => L_REQUEST_ID
,P_PROGRAM_APPLICATION_ID => L_PROGRAM_APPLICATION_ID
,P_PROGRAM_ID => L_PROGRAM_ID
,P_PROGRAM_UPDATE_DATE => c.p50
,P_OBJECT_VERSION_NUMBER => L_OBJECT_VERSION_NUMBER
,P_PER_IN_LER_ID => L_PER_IN_LER_ID
,P_BNFT_TYP_CD => c.p51
,P_BNFT_ORDR_NUM => c.p52
,P_PRTT_ENRT_RSLT_STAT_CD => c.p53
,P_BNFT_NNMNTRY_UOM => c.p54
,P_COMP_LVL_CD => c.p55
,P_EFFECTIVE_DATE => c.p56
,P_DATETRACK_MODE => c.p57
