--------------------------------------------------------
--  DDL for Package Body BEN_MTR_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_MTR_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_mtr_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  If (p_datetrack_mode <> 'CORRECTION') then
    ...
    --
    ben_mtr_shd.upd_effective_end_date
     (p_effective_date	       => p_effective_date,
      p_base_key_value	       => p_rec.mtchg_rt_id,
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy ben_mtr_shd.g_rec_type) is
--
...
Begin
  ...
  If (p_rec.no_mx_mtch_amt_flag = hr_api.g_varchar2) then
    ...
    ben_mtr_shd.g_old_rec.no_mx_mtch_amt_flag;
  End If;
  If (p_rec.no_mx_pct_of_py_num_flag = hr_api.g_varchar2) then
    p_rec.no_mx_pct_of_py_num_flag :=
    ben_mtr_shd.g_old_rec.no_mx_pct_of_py_num_flag;
  End If;
  If (p_rec.cntnu_mtch_aftr_mx_rl_flag = hr_api.g_varchar2) then
    p_rec.cntnu_mtch_aftr_mx_rl_flag :=
    ben_mtr_shd.g_old_rec.cntnu_mtch_aftr_mx_rl_flag;
  End If;
  If (p_rec.no_mx_amt_of_py_num_flag = hr_api.g_varchar2) then
    p_rec.no_mx_amt_of_py_num_flag :=
    ben_mtr_shd.g_old_rec.no_mx_amt_of_py_num_flag;
  End If;
  If (p_rec.business_group_id = hr_api.g_number) then
    p_rec.business_group_id :=
    ben_mtr_shd.g_old_rec.business_group_id;
  End If;
  If (p_rec.mtr_attribute_category = hr_api.g_varchar2) then
    p_rec.mtr_attribute_category :=
    ben_mtr_shd.g_old_rec.mtr_attribute_category;
  End If;
  If (p_rec.mtr_attribute1 = hr_api.g_varchar2) then
    p_rec.mtr_attribute1 :=
    ben_mtr_shd.g_old_rec.mtr_attribute1;
  End If;
  If (p_rec.mtr_attribute2 = hr_api.g_varchar2) then
    p_rec.mtr_attribute2 :=
    ben_mtr_shd.g_old_rec.mtr_attribute2;
  End If;
  If (p_rec.mtr_attribute3 = hr_api.g_varchar2) then
    p_rec.mtr_attribute3 :=
    ben_mtr_shd.g_old_rec.mtr_attribute3;
  End If;
  If (p_rec.mtr_attribute4 = hr_api.g_varchar2) then
    p_rec.mtr_attribute4 :=
    ben_mtr_shd.g_old_rec.mtr_attribute4;
  End If;
  If (p_rec.mtr_attribute5 = hr_api.g_varchar2) then
    p_rec.mtr_attribute5 :=
    ben_mtr_shd.g_old_rec.mtr_attribute5;
  End If;
  If (p_rec.mtr_attribute6 = hr_api.g_varchar2) then
    p_rec.mtr_attribute6 :=
    ben_mtr_shd.g_old_rec.mtr_attribute6;
  End If;
  If (p_rec.mtr_attribute7 = hr_api.g_varchar2) then
    p_rec.mtr_attribute7 :=
    ben_mtr_shd.g_old_rec.mtr_attribute7;
  End If;
  If (p_rec.mtr_attribute8 = hr_api.g_varchar2) then
    p_rec.mtr_attribute8 :=
    ben_mtr_shd.g_old_rec.mtr_attribute8;
  End If;
  If (p_rec.mtr_attribute9 = hr_api.g_varchar2) then
    p_rec.mtr_attribute9 :=
    ben_mtr_shd.g_old_rec.mtr_attribute9;
  End If;
  If (p_rec.mtr_attribute10 = hr_api.g_varchar2) then
    p_rec.mtr_attribute10 :=
    ben_mtr_shd.g_old_rec.mtr_attribute10;
  End If;
  If (p_rec.mtr_attribute11 = hr_api.g_varchar2) then
    p_rec.mtr_attribute11 :=
    ben_mtr_shd.g_old_rec.mtr_attribute11;
  End If;
  If (p_rec.mtr_attribute12 = hr_api.g_varchar2) then
    p_rec.mtr_attribute12 :=
    ben_mtr_shd.g_old_rec.mtr_attribute12;
  End If;
  If (p_rec.mtr_attribute13 = hr_api.g_varchar2) then
    p_rec.mtr_attribute13 :=
    ben_mtr_shd.g_old_rec.mtr_attribute13;
  End If;
  If (p_rec.mtr_attribute14 = hr_api.g_varchar2) then
    p_rec.mtr_attribute14 :=
    ben_mtr_shd.g_old_rec.mtr_attribute14;
  End If;
  If (p_rec.mtr_attribute15 = hr_api.g_varchar2) then
    p_rec.mtr_attribute15 :=
    ben_mtr_shd.g_old_rec.mtr_attribute15;
  End If;
  If (p_rec.mtr_attribute16 = hr_api.g_varchar2) then
    p_rec.mtr_attribute16 :=
    ben_mtr_shd.g_old_rec.mtr_attribute16;
  End If;
  If (p_rec.mtr_attribute17 = hr_api.g_varchar2) then
    p_rec.mtr_attribute17 :=
    ben_mtr_shd.g_old_rec.mtr_attribute17;
  End If;
  If (p_rec.mtr_attribute18 = hr_api.g_varchar2) then
    p_rec.mtr_attribute18 :=
    ben_mtr_shd.g_old_rec.mtr_attribute18;
  End If;
  If (p_rec.mtr_attribute19 = hr_api.g_varchar2) then
    p_rec.mtr_attribute19 :=
    ben_mtr_shd.g_old_rec.mtr_attribute19;
  End If;
  If (p_rec.mtr_attribute20 = hr_api.g_varchar2) then
    p_rec.mtr_attribute20 :=
    ben_mtr_shd.g_old_rec.mtr_attribute20;
  End If;
  If (p_rec.mtr_attribute21 = hr_api.g_varchar2) then
    p_rec.mtr_attribute21 :=
    ben_mtr_shd.g_old_rec.mtr_attribute21;
  End If;
  If (p_rec.mtr_attribute22 = hr_api.g_varchar2) then
    p_rec.mtr_attribute22 :=
    ben_mtr_shd.g_old_rec.mtr_attribute22;
  End If;
  If (p_rec.mtr_attribute23 = hr_api.g_varchar2) then
    p_rec.mtr_attribute23 :=
    ben_mtr_shd.g_old_rec.mtr_attribute23;
  End If;
  If (p_rec.mtr_attribute24 = hr_api.g_varchar2) then
    p_rec.mtr_attribute24 :=
    ben_mtr_shd.g_old_rec.mtr_attribute24;
  End If;
  If (p_rec.mtr_attribute25 = hr_api.g_varchar2) then
    p_rec.mtr_attribute25 :=
    ben_mtr_shd.g_old_rec.mtr_attribute25;
  End If;
  If (p_rec.mtr_attribute26 = hr_api.g_varchar2) then
    p_rec.mtr_attribute26 :=
    ben_mtr_shd.g_old_rec.mtr_attribute26;
  End If;
  If (p_rec.mtr_attribute27 = hr_api.g_varchar2) then
    p_rec.mtr_attribute27 :=
    ben_mtr_shd.g_old_rec.mtr_attribute27;
  End If;
  If (p_rec.mtr_attribute28 = hr_api.g_varchar2) then
    p_rec.mtr_attribute28 :=
    ben_mtr_shd.g_old_rec.mtr_attribute28;
  End If;
  If (p_rec.mtr_attribute29 = hr_api.g_varchar2) then
    p_rec.mtr_attribute29 :=
    ben_mtr_shd.g_old_rec.mtr_attribute29;
  End If;
  If (p_rec.mtr_attribute30 = hr_api.g_varchar2) then
    p_rec.mtr_attribute30 :=
    ben_mtr_shd.g_old_rec.mtr_attribute30;
  End If;
