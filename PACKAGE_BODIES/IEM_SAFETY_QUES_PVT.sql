--------------------------------------------------------
--  DDL for Package Body IEM_SAFETY_QUES_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IEM_SAFETY_QUES_PVT" as
/* $Header: iemvsfqb.pls 115.3 2004/04/08 21:20:02 chtang shipped $*/

G_PKG_NAME CONSTANT varchar2(30) :='IEM_SAFETY_QUES_PVT';
