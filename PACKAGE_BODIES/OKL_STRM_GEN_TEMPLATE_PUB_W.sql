--------------------------------------------------------
--  DDL for Package Body OKL_STRM_GEN_TEMPLATE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_STRM_GEN_TEMPLATE_PUB_W" as
  /* $Header: OKLUTSGB.pls 120.9 2007/10/15 16:07:00 dpsingh ship $ */
  ...
  as
    ddp_gtsv_rec okl_strm_gen_template_pub.gtsv_rec_type;
    ddp_gttv_rec okl_strm_gen_template_pub.gttv_rec_type;
    ddp_gtpv_tbl okl_strm_gen_template_pub.gtpv_tbl_type;
    ddp_gtlv_tbl okl_strm_gen_template_pub.gtlv_tbl_type;
    ddx_gttv_rec okl_strm_gen_template_pub.gttv_rec_type;
  ...
  begin
    ...
    okl_strm_gen_template_pub.create_strm_gen_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_strm_gen_template_pub.update_strm_gen_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_strm_gen_template_pub.delete_tmpt_prc_params(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_strm_gen_template_pub.delete_pri_tmpt_lns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_strm_gen_template_pub.delete_dep_tmpt_lns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_strm_gen_template_pub.update_dep_strms(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_strm_gen_template_pub.create_version_duplicate(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddx_error_msgs_tbl okl_strm_gen_template_pub.error_msgs_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_strm_gen_template_pub.validate_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddx_wrn_msgs_tbl okl_strm_gen_template_pub.error_msgs_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_strm_gen_template_pub.validate_for_warnings(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ...
    ddp_gttv_rec okl_strm_gen_template_pub.gttv_rec_type;
    ddp_gtpv_tbl okl_strm_gen_template_pub.gtpv_tbl_type;
    ddp_pri_gtlv_tbl okl_strm_gen_template_pub.gtlv_tbl_type;
    ddp_del_dep_gtlv_tbl okl_strm_gen_template_pub.gtlv_tbl_type;
    ddp_ins_dep_gtlv_tbl okl_strm_gen_template_pub.gtlv_tbl_type;
    ddx_gttv_rec okl_strm_gen_template_pub.gttv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_strm_gen_template_pub.update_pri_dep_of_sgt(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_strm_gen_template_pub_w;
