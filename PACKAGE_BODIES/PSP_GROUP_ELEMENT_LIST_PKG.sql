--------------------------------------------------------
--  DDL for Package Body PSP_GROUP_ELEMENT_LIST_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_GROUP_ELEMENT_LIST_PKG" as
 /* $Header: PSPSUGEB.pls 115.6 2002/11/18 08:49:53 lveerubh ship $ */
procedure INSERT_ROW (
  ...
  X_MODE in VARCHAR2 default 'R'
    ...
    cursor C is select ROWID from PSP_GROUP_ELEMENT_LIST
...
begin
  ...
  insert into PSP_GROUP_ELEMENT_LIST (
    ELEMENT_GROUP_ID,
    ELEMENT_TYPE_ID,
    START_DATE_ACTIVE,
    ATTRIBUTE_CATEGORY,
...
begin
  ...
  update PSP_GROUP_ELEMENT_LIST set
...
procedure ADD_ROW (
  ...
  cursor c1 is select rowid from PSP_GROUP_ELEMENT_LIST
     where ELEMENT_GROUP_ID = X_ELEMENT_GROUP_ID
     and ELEMENT_TYPE_ID = X_ELEMENT_TYPE_ID
     and START_DATE_ACTIVE = X_START_DATE_ACTIVE
  ;
...
begin
  delete from PSP_GROUP_ELEMENT_LIST
  where ELEMENT_GROUP_ID = X_ELEMENT_GROUP_ID
  and ELEMENT_TYPE_ID = X_ELEMENT_TYPE_ID
  and START_DATE_ACTIVE = X_START_DATE_ACTIVE;
  if (sql%notfound) then
