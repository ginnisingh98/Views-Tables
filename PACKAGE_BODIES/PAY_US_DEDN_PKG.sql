--------------------------------------------------------
--  DDL for Package Body PAY_US_DEDN_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_US_DEDN_PKG" AS
/* $Header: pyusdedn.pkb 115.2 2003/01/09 18:09:38 tclewis ship $ */
--
------------------------------------------------------------------------
-- PAY_US_TOT_OWED returns total owed input value of those deduction elements
...
--
   l_Total_owed := 0;
   BEGIN
      select  nvl(peev.screen_entry_value,0)
      into l_Total_owed
      from
