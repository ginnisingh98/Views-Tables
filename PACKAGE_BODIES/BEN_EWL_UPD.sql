--------------------------------------------------------
--  DDL for Package Body BEN_EWL_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EWL_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_ewl_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
  ...
  If (p_datetrack_mode = 'CORRECTION') then
    ...
    p_rec.object_version_number :=
	  ...
	  (p_base_table_name	=> 'ben_elig_wk_loc_prte_f',
	   ...
	   p_base_key_value	=> p_rec.elig_wk_loc_prte_id);
    --
    ben_ewl_shd.g_api_dml := true;  -- Set the api dml status
    --
    -- Update the ben_elig_wk_loc_prte_f Row
    --
    ...
    --
    ben_ewl_shd.g_api_dml := false;   -- Unset the api dml status
    --
...
Begin
  ...
  If (p_datetrack_mode <> 'CORRECTION') then
    ...
    --
    ben_ewl_shd.upd_effective_end_date
     (p_effective_date	       => p_effective_date,
      p_base_key_value	       => p_rec.elig_wk_loc_prte_id,
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'ben_elig_wk_loc_prte_f'
        ,p_hook_type   => 'AU');
      --
  end;
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy ben_ewl_shd.g_rec_type) is
--
...
Begin
  ...
  If (p_rec.business_group_id = hr_api.g_number) then
    ...
    ben_ewl_shd.g_old_rec.business_group_id;
  End If;
  If (p_rec.ordr_num = hr_api.g_number) then
    p_rec.ordr_num :=
    ben_ewl_shd.g_old_rec.ordr_num;
  End If;
  If (p_rec.location_id = hr_api.g_number) then
    p_rec.location_id :=
    ben_ewl_shd.g_old_rec.location_id;
  End If;
  If (p_rec.eligy_prfl_id = hr_api.g_number) then
    p_rec.eligy_prfl_id :=
    ben_ewl_shd.g_old_rec.eligy_prfl_id;
  End If;
  If (p_rec.excld_flag = hr_api.g_varchar2) then
    p_rec.excld_flag :=
    ben_ewl_shd.g_old_rec.excld_flag;
  End If;
  If (p_rec.ewl_attribute_category = hr_api.g_varchar2) then
    p_rec.ewl_attribute_category :=
    ben_ewl_shd.g_old_rec.ewl_attribute_category;
  End If;
  If (p_rec.ewl_attribute1 = hr_api.g_varchar2) then
    p_rec.ewl_attribute1 :=
    ben_ewl_shd.g_old_rec.ewl_attribute1;
  End If;
  If (p_rec.ewl_attribute2 = hr_api.g_varchar2) then
    p_rec.ewl_attribute2 :=
    ben_ewl_shd.g_old_rec.ewl_attribute2;
  End If;
  If (p_rec.ewl_attribute3 = hr_api.g_varchar2) then
    p_rec.ewl_attribute3 :=
    ben_ewl_shd.g_old_rec.ewl_attribute3;
  End If;
  If (p_rec.ewl_attribute4 = hr_api.g_varchar2) then
    p_rec.ewl_attribute4 :=
    ben_ewl_shd.g_old_rec.ewl_attribute4;
  End If;
  If (p_rec.ewl_attribute5 = hr_api.g_varchar2) then
    p_rec.ewl_attribute5 :=
    ben_ewl_shd.g_old_rec.ewl_attribute5;
  End If;
  If (p_rec.ewl_attribute6 = hr_api.g_varchar2) then
    p_rec.ewl_attribute6 :=
    ben_ewl_shd.g_old_rec.ewl_attribute6;
  End If;
  If (p_rec.ewl_attribute7 = hr_api.g_varchar2) then
    p_rec.ewl_attribute7 :=
    ben_ewl_shd.g_old_rec.ewl_attribute7;
  End If;
  If (p_rec.ewl_attribute8 = hr_api.g_varchar2) then
    p_rec.ewl_attribute8 :=
    ben_ewl_shd.g_old_rec.ewl_attribute8;
  End If;
  If (p_rec.ewl_attribute9 = hr_api.g_varchar2) then
    p_rec.ewl_attribute9 :=
    ben_ewl_shd.g_old_rec.ewl_attribute9;
  End If;
  If (p_rec.ewl_attribute10 = hr_api.g_varchar2) then
    p_rec.ewl_attribute10 :=
    ben_ewl_shd.g_old_rec.ewl_attribute10;
  End If;
  If (p_rec.ewl_attribute11 = hr_api.g_varchar2) then
    p_rec.ewl_attribute11 :=
    ben_ewl_shd.g_old_rec.ewl_attribute11;
  End If;
  If (p_rec.ewl_attribute12 = hr_api.g_varchar2) then
    p_rec.ewl_attribute12 :=
    ben_ewl_shd.g_old_rec.ewl_attribute12;
  End If;
  If (p_rec.ewl_attribute13 = hr_api.g_varchar2) then
    p_rec.ewl_attribute13 :=
    ben_ewl_shd.g_old_rec.ewl_attribute13;
  End If;
  If (p_rec.ewl_attribute14 = hr_api.g_varchar2) then
    p_rec.ewl_attribute14 :=
    ben_ewl_shd.g_old_rec.ewl_attribute14;
  End If;
  If (p_rec.ewl_attribute15 = hr_api.g_varchar2) then
    p_rec.ewl_attribute15 :=
    ben_ewl_shd.g_old_rec.ewl_attribute15;
  End If;
  If (p_rec.ewl_attribute16 = hr_api.g_varchar2) then
    p_rec.ewl_attribute16 :=
    ben_ewl_shd.g_old_rec.ewl_attribute16;
  End If;
  If (p_rec.ewl_attribute17 = hr_api.g_varchar2) then
    p_rec.ewl_attribute17 :=
    ben_ewl_shd.g_old_rec.ewl_attribute17;
  End If;
  If (p_rec.ewl_attribute18 = hr_api.g_varchar2) then
    p_rec.ewl_attribute18 :=
    ben_ewl_shd.g_old_rec.ewl_attribute18;
  End If;
  If (p_rec.ewl_attribute19 = hr_api.g_varchar2) then
    p_rec.ewl_attribute19 :=
    ben_ewl_shd.g_old_rec.ewl_attribute19;
  End If;
  If (p_rec.ewl_attribute20 = hr_api.g_varchar2) then
    p_rec.ewl_attribute20 :=
    ben_ewl_shd.g_old_rec.ewl_attribute20;
  End If;
  If (p_rec.ewl_attribute21 = hr_api.g_varchar2) then
    p_rec.ewl_attribute21 :=
    ben_ewl_shd.g_old_rec.ewl_attribute21;
  End If;
  If (p_rec.ewl_attribute22 = hr_api.g_varchar2) then
    p_rec.ewl_attribute22 :=
    ben_ewl_shd.g_old_rec.ewl_attribute22;
  End If;
  If (p_rec.ewl_attribute23 = hr_api.g_varchar2) then
    p_rec.ewl_attribute23 :=
    ben_ewl_shd.g_old_rec.ewl_attribute23;
  End If;
  If (p_rec.ewl_attribute24 = hr_api.g_varchar2) then
    p_rec.ewl_attribute24 :=
    ben_ewl_shd.g_old_rec.ewl_attribute24;
  End If;
  If (p_rec.ewl_attribute25 = hr_api.g_varchar2) then
    p_rec.ewl_attribute25 :=
    ben_ewl_shd.g_old_rec.ewl_attribute25;
  End If;
  If (p_rec.ewl_attribute26 = hr_api.g_varchar2) then
    p_rec.ewl_attribute26 :=
    ben_ewl_shd.g_old_rec.ewl_attribute26;
  End If;
  If (p_rec.ewl_attribute27 = hr_api.g_varchar2) then
    p_rec.ewl_attribute27 :=
    ben_ewl_shd.g_old_rec.ewl_attribute27;
  End If;
  If (p_rec.ewl_attribute28 = hr_api.g_varchar2) then
    p_rec.ewl_attribute28 :=
    ben_ewl_shd.g_old_rec.ewl_attribute28;
  End If;
  If (p_rec.ewl_attribute29 = hr_api.g_varchar2) then
    p_rec.ewl_attribute29 :=
    ben_ewl_shd.g_old_rec.ewl_attribute29;
  End If;
  If (p_rec.ewl_attribute30 = hr_api.g_varchar2) then
    p_rec.ewl_attribute30 :=
    ben_ewl_shd.g_old_rec.ewl_attribute30;
  End If;
  If (p_rec.criteria_score = hr_api.g_number) then
    p_rec.criteria_score :=
    ben_ewl_shd.g_old_rec.criteria_score;
  End If;
  If (p_rec.criteria_weight = hr_api.g_number) then
    p_rec.criteria_weight :=
    ben_ewl_shd.g_old_rec.criteria_weight;
  End If;
...
Begin
  ...
  --
  l_rec :=
  ben_ewl_shd.convert_args
  (
  p_elig_wk_loc_prte_id,
  null,
  null,
  p_business_group_id,
  p_ordr_num,
