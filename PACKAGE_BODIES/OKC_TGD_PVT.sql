--------------------------------------------------------
--  DDL for Package Body OKC_TGD_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKC_TGD_PVT" AS
/* $Header: OKCSTGDB.pls 120.0 2005/05/25 22:48:46 appldev noship $ */
  ...
  ---------------------------------------------------------------------------
  -- FUNCTION get_rec for: OKC_TIMEVALUES
  ---------------------------------------------------------------------------
  FUNCTION get_rec (
...
*/
  ---------------------------------------------------------------------------
  -- FUNCTION get_rec for: OKC_TIME_TPG_DELIMITED_V
  ---------------------------------------------------------------------------
  FUNCTION get_rec (
    p_tgdv_rec                     IN tgdv_rec_type,
    x_no_data_found                OUT NOCOPY BOOLEAN
  ) RETURN tgdv_rec_type IS
    CURSOR okc_tgdv_pk_csr (p_id                 IN NUMBER) IS
    SELECT
            ID,
            OBJECT_VERSION_NUMBER,
--Bug 3122962            SFWT_FLAG,
            ...
            LAST_UPDATE_DATE,
            LAST_UPDATE_LOGIN
      FROM Okc_Time_Tpg_Delimited_V
     WHERE okc_time_tpg_delimited_v.id = p_id;
    l_okc_tgdv_pk                  okc_tgdv_pk_csr%ROWTYPE;
    l_tgdv_rec                     tgdv_rec_type;
  BEGIN
    x_no_data_found := TRUE;
    -- Get current database values
    OPEN okc_tgdv_pk_csr (p_tgdv_rec.id);
    FETCH okc_tgdv_pk_csr INTO
              l_tgdv_rec.ID,
              l_tgdv_rec.OBJECT_VERSION_NUMBER,
--Bug 3122962              l_tgdv_rec.SFWT_FLAG,
              l_tgdv_rec.TVE_ID_LIMITED,
              l_tgdv_rec.DNZ_CHR_ID,
              l_tgdv_rec.TZE_ID,
              l_tgdv_rec.DESCRIPTION,
              l_tgdv_rec.SHORT_DESCRIPTION,
              l_tgdv_rec.COMMENTS,
              l_tgdv_rec.MONTH,
              l_tgdv_rec.DAY,
              l_tgdv_rec.HOUR,
              ...
              l_tgdv_rec.SECOND,
              l_tgdv_rec.NTH,
              l_tgdv_rec.DAY_OF_WEEK,
              l_tgdv_rec.ATTRIBUTE_CATEGORY,
              l_tgdv_rec.ATTRIBUTE1,
              l_tgdv_rec.ATTRIBUTE2,
              l_tgdv_rec.ATTRIBUTE3,
              l_tgdv_rec.ATTRIBUTE4,
              l_tgdv_rec.ATTRIBUTE5,
              l_tgdv_rec.ATTRIBUTE6,
              l_tgdv_rec.ATTRIBUTE7,
              l_tgdv_rec.ATTRIBUTE8,
              l_tgdv_rec.ATTRIBUTE9,
              l_tgdv_rec.ATTRIBUTE10,
              l_tgdv_rec.ATTRIBUTE11,
              l_tgdv_rec.ATTRIBUTE12,
              l_tgdv_rec.ATTRIBUTE13,
              l_tgdv_rec.ATTRIBUTE14,
              l_tgdv_rec.ATTRIBUTE15,
              l_tgdv_rec.CREATED_BY,
              l_tgdv_rec.CREATION_DATE,
              l_tgdv_rec.LAST_UPDATED_BY,
              l_tgdv_rec.LAST_UPDATE_DATE,
              l_tgdv_rec.LAST_UPDATE_LOGIN;
    x_no_data_found := okc_tgdv_pk_csr%NOTFOUND;
    CLOSE okc_tgdv_pk_csr;
    RETURN(l_tgdv_rec);
  END get_rec;
  ...
  FUNCTION get_rec (
    ...
    l_row_notfound                 BOOLEAN := TRUE;
  BEGIN
    RETURN(get_rec(p_tgdv_rec, l_row_notfound));
  END get_rec;

  --------------------------------------------------------------
  -- FUNCTION null_out_defaults for: OKC_TIME_TPG_DELIMITED_V --
  --------------------------------------------------------------
  FUNCTION null_out_defaults (
    p_tgdv_rec	IN tgdv_rec_type
  ) RETURN tgdv_rec_type IS
    l_tgdv_rec	tgdv_rec_type := p_tgdv_rec;
  BEGIN
    IF (l_tgdv_rec.object_version_number = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.object_version_number := NULL;
    END IF;
--Bug 3122962
/*    IF (l_tgdv_rec.sfwt_flag = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.sfwt_flag := NULL;
    END IF;
*/
    IF (l_tgdv_rec.tve_id_limited = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.tve_id_limited := NULL;
    END IF;
    IF (l_tgdv_rec.dnz_chr_id = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.dnz_chr_id := NULL;
    END IF;
    IF (l_tgdv_rec.tze_id = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.tze_id := NULL;
    END IF;
    IF (l_tgdv_rec.description = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.description := NULL;
    END IF;
    IF (l_tgdv_rec.short_description = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.short_description := NULL;
    END IF;
    IF (l_tgdv_rec.comments = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.comments := NULL;
    END IF;
    IF (l_tgdv_rec.month = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.month := NULL;
    END IF;
    IF (l_tgdv_rec.day = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.day := NULL;
    END IF;
    IF (l_tgdv_rec.hour = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.hour := NULL;
    END IF;
    IF (l_tgdv_rec.minute = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.minute := NULL;
    END IF;
    IF (l_tgdv_rec.second = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.second := NULL;
    END IF;
    IF (l_tgdv_rec.nth = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.nth := NULL;
    END IF;
    IF (l_tgdv_rec.day_of_week = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.day_of_week := NULL;
    END IF;
    IF (l_tgdv_rec.attribute_category = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute_category := NULL;
    END IF;
    IF (l_tgdv_rec.attribute1 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute1 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute2 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute2 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute3 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute3 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute4 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute4 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute5 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute5 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute6 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute6 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute7 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute7 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute8 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute8 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute9 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute9 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute10 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute10 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute11 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute11 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute12 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute12 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute13 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute13 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute14 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute14 := NULL;
    END IF;
    IF (l_tgdv_rec.attribute15 = OKC_API.G_MISS_CHAR) THEN
      l_tgdv_rec.attribute15 := NULL;
    END IF;
    IF (l_tgdv_rec.created_by = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.created_by := NULL;
    END IF;
    IF (l_tgdv_rec.creation_date = OKC_API.G_MISS_DATE) THEN
      l_tgdv_rec.creation_date := NULL;
    END IF;
    IF (l_tgdv_rec.last_updated_by = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.last_updated_by := NULL;
    END IF;
    IF (l_tgdv_rec.last_update_date = OKC_API.G_MISS_DATE) THEN
      l_tgdv_rec.last_update_date := NULL;
    END IF;
    IF (l_tgdv_rec.last_update_login = OKC_API.G_MISS_NUM) THEN
      l_tgdv_rec.last_update_login := NULL;
    END IF;
    RETURN(l_tgdv_rec);
...
*/
  ...
  ---------------------------------------------------------------------------
  ------------------------------------------------------
  -- Validate_Attributes for:OKC_TIME_TPG_DELIMITED_V --
  ------------------------------------------------------
  PROCEDURE Validate_DNZ_Chr_ID (
      x_return_status                OUT NOCOPY VARCHAR2,
      p_tgdv_rec                     IN tgdv_rec_type) IS
    ...
    BEGIN
      ...
      IF (p_tgdv_rec.dnz_chr_id IS NOT NULL AND
          p_tgdv_rec.dnz_chr_id <> OKC_API.G_MISS_NUM)
      THEN
        OPEN okc_chrv_pk_csr(p_tgdv_rec.dnz_chr_id);
  ...
  PROCEDURE Validate_Month (
    x_return_status                OUT NOCOPY VARCHAR2,
    p_tgdv_rec                     IN tgdv_rec_type) IS
  BEGIN
    IF (p_tgdv_rec.month > 12) OR
       (p_tgdv_rec.month < 1)
    THEN
       OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'MONTH');
       x_return_status := OKC_API.G_RET_STS_ERROR;
    ELSE
       x_return_status := OKC_API.G_RET_STS_SUCCESS;
    END IF;
  ...
  PROCEDURE Validate_Day (
    x_return_status                OUT NOCOPY VARCHAR2,
    p_tgdv_rec                     IN tgdv_rec_type) IS
  BEGIN
    IF ((p_tgdv_rec.day > 31  and p_tgdv_rec.day <> 99) OR
        p_tgdv_rec.day < 1)
    THEN
       OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'DAY');
       x_return_status := OKC_API.G_RET_STS_ERROR;
    ELSE
       x_return_status := OKC_API.G_RET_STS_SUCCESS;
    END IF;
  ...
  PROCEDURE Validate_Day_of_Week (
    x_return_status                OUT NOCOPY VARCHAR2,
    p_tgdv_rec                     IN tgdv_rec_type) IS
  BEGIN

    IF upper(p_tgdv_rec.day_of_week)  in ('MON','TUE','WED','THU','FRI','SAT','SUN')
    THEN
       IF p_tgdv_rec.day_of_week  in ('MON','TUE','WED','THU','FRI','SAT','SUN')
       THEN
         x_return_status := OKC_API.G_RET_STS_SUCCESS;
       ELSE
         OKC_API.set_message(G_APP_NAME, G_UPPERCASE_REQUIRED,G_COL_NAME_TOKEN,'DAY_OF_WEEK');
         x_return_status := OKC_API.G_RET_STS_ERROR;
       END IF;
    ELSE
       OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'DAY_OF_WEEK');
       x_return_status := OKC_API.G_RET_STS_ERROR;
    END IF;
  END Validate_Day_of_Week;

  PROCEDURE Validate_Hour (
    x_return_status                OUT NOCOPY VARCHAR2,
    p_tgdv_rec                     IN tgdv_rec_type) IS
  BEGIN
    IF (p_tgdv_rec.hour > 24  OR
        p_tgdv_rec.hour < 0)
    THEN
       OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'HOUR');
       x_return_status := OKC_API.G_RET_STS_ERROR;
    ELSE
       x_return_status := OKC_API.G_RET_STS_SUCCESS;
    END IF;
  ...
  PROCEDURE Validate_Minute (
    x_return_status                OUT NOCOPY VARCHAR2,
    p_tgdv_rec                     IN tgdv_rec_type) IS
  BEGIN
    IF (p_tgdv_rec.minute > 60  OR
        p_tgdv_rec.minute < 0)
    THEN
       OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'MINUTE');
       x_return_status := OKC_API.G_RET_STS_ERROR;
    ELSE
       x_return_status := OKC_API.G_RET_STS_SUCCESS;
    END IF;
  ...
  PROCEDURE Validate_Second (
    x_return_status                OUT NOCOPY VARCHAR2,
    p_tgdv_rec                     IN tgdv_rec_type) IS
  BEGIN
    IF (p_tgdv_rec.second > 60  OR
        p_tgdv_rec.second < 0)
    THEN
       OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'SECOND');
       x_return_status := OKC_API.G_RET_STS_ERROR;
    ELSE
       x_return_status := OKC_API.G_RET_STS_SUCCESS;
    END IF;
  ...
  PROCEDURE Validate_Nth (
    x_return_status                OUT NOCOPY VARCHAR2,
    p_tgdv_rec                     IN tgdv_rec_type) IS
  BEGIN
    IF ((p_tgdv_rec.nth > 5  and p_tgdv_rec.day <> 99) OR
        p_tgdv_rec.day < 0)
    THEN
       OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'NTH');
       x_return_status := OKC_API.G_RET_STS_ERROR;
    ELSE
       x_return_status := OKC_API.G_RET_STS_SUCCESS;
    END IF;
  ...
  PROCEDURE Validate_Time_Zone_Id (
    ...
    BEGIN
      x_return_status                := OKC_API.G_RET_STS_SUCCESS;
      IF (p_tgdv_rec.TZE_ID IS NOT NULL AND
          p_tgdv_rec.TZE_ID <> OKC_API.G_MISS_NUM)
      THEN
        OPEN okx_timezones_v_pk_csr(p_tgdv_rec.TZE_ID);
  ...
  PROCEDURE Validate_Tve_Id_Limited (
    ...
    BEGIN
      x_return_status                := OKC_API.G_RET_STS_SUCCESS;
      IF (p_tgdv_rec.TVE_ID_LIMITED IS NOT NULL AND
          p_tgdv_rec.TVE_ID_LIMITED <> OKC_API.G_MISS_NUM)
      THEN
        OPEN okc_tvev_pk_csr(p_tgdv_rec.TVE_ID_LIMITED);
...
/*
  PROCEDURE Validate_SFWT_Flag (
    ...
    p_tgdv_rec                     IN tgdv_rec_type) IS
  BEGIN
    IF upper(p_tgdv_rec.sfwt_flag) = 'Y' OR
       upper(p_tgdv_rec.sfwt_flag) = 'N'
    THEN
       IF p_tgdv_rec.sfwt_flag = 'Y' OR
          p_tgdv_rec.sfwt_flag = 'N'
       THEN
         x_return_status := OKC_API.G_RET_STS_SUCCESS;
       ELSE
...
*/
  ...
  BEGIN
    IF p_tgdv_rec.id = OKC_API.G_MISS_NUM OR
       p_tgdv_rec.id IS NULL
    THEN
      OKC_API.set_message(G_APP_NAME, G_REQUIRED_VALUE,G_COL_NAME_TOKEN,'id');
      x_return_status := OKC_API.G_RET_STS_ERROR;
    ELSIF p_tgdv_rec.object_version_number = OKC_API.G_MISS_NUM OR
          p_tgdv_rec.object_version_number IS NULL
    THEN
      OKC_API.set_message(G_APP_NAME, G_REQUIRED_VALUE,G_COL_NAME_TOKEN,'object_version_number');
      x_return_status := OKC_API.G_RET_STS_ERROR;
    END IF;
    IF p_tgdv_rec.dnz_chr_id <> 0 Then
      ...
      END IF;
    END IF;
    IF (p_tgdv_rec.month is NOT NULL AND
        p_tgdv_rec.month <> OKC_API.G_MISS_NUM) THEN
      Validate_Month (l_return_status,
                      p_tgdv_rec);
      IF (l_return_status <> OKC_API.G_RET_STS_SUCCESS) THEN
        IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN  -- need to leave
          x_return_status := l_return_status;
      ...
      END IF;
    END IF;
    IF (p_tgdv_rec.day is NOT NULL AND
        p_tgdv_rec.day <> OKC_API.G_MISS_NUM) THEN
      Validate_Day (l_return_status,
                    p_tgdv_rec);
      IF (l_return_status <> OKC_API.G_RET_STS_SUCCESS) THEN
        IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN  -- need to leave
          x_return_status := l_return_status;
      ...
      END IF;
    END IF;
    IF (p_tgdv_rec.day_of_week is NOT NULL AND
        p_tgdv_rec.day_of_week <> OKC_API.G_MISS_CHAR) THEN
      Validate_Day_of_Week (l_return_status,
                            p_tgdv_rec);
      IF (l_return_status <> OKC_API.G_RET_STS_SUCCESS) THEN
        IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN  -- need to leave
          x_return_status := l_return_status;
      ...
      END IF;
    END IF;
    IF (p_tgdv_rec.hour is NOT NULL AND
        p_tgdv_rec.hour <> OKC_API.G_MISS_NUM) THEN
      Validate_Hour (l_return_status,
                     p_tgdv_rec);
      IF (l_return_status <> OKC_API.G_RET_STS_SUCCESS) THEN
        IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN  -- need to leave
          x_return_status := l_return_status;
      ...
      END IF;
    END IF;
    IF (p_tgdv_rec.minute is NOT NULL AND
        p_tgdv_rec.minute <> OKC_API.G_MISS_NUM) THEN
      Validate_Minute (l_return_status,
                       p_tgdv_rec);
      IF (l_return_status <> OKC_API.G_RET_STS_SUCCESS) THEN
        IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN  -- need to leave
          x_return_status := l_return_status;
      ...
      END IF;
    END IF;
    IF (p_tgdv_rec.second is NOT NULL AND
        p_tgdv_rec.second <> OKC_API.G_MISS_NUM) THEN
      Validate_Second (l_return_status,
                       p_tgdv_rec);
      IF (l_return_status <> OKC_API.G_RET_STS_SUCCESS) THEN
        IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN  -- need to leave
          x_return_status := l_return_status;
      ...
      END IF;
    END IF;
    IF (p_tgdv_rec.nth is NOT NULL AND
        p_tgdv_rec.nth <> OKC_API.G_MISS_NUM) THEN
      Validate_Nth (l_return_status,
                    p_tgdv_rec);
      IF (l_return_status <> OKC_API.G_RET_STS_SUCCESS) THEN
        IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN  -- need to leave
          x_return_status := l_return_status;
    ...
    END IF;
    IF (p_tgdv_rec.tve_id_limited is NOT NULL AND
        p_tgdv_rec.tve_id_limited <> OKC_API.G_MISS_NUM) THEN
...
*/
  ...
  ---------------------------------------------------------------------------
  --------------------------------------------------
  -- Validate_Record for:OKC_TIME_TPG_DELIMITED_V --
  --------------------------------------------------
  FUNCTION Validate_Record (
    p_tgdv_rec IN tgdv_rec_type
  ) RETURN VARCHAR2 IS
    l_return_status                VARCHAR2(1) := OKC_API.G_RET_STS_SUCCESS;
    l_dummy_date                   DATE := OKC_API.G_MISS_DATE;
  BEGIN
    IF (p_tgdv_rec.month is NULL or
        p_tgdv_rec.month = OKC_API.G_MISS_NUM) and
       (p_tgdv_rec.day is NULL or
        p_tgdv_rec.day = OKC_API.G_MISS_NUM) and
       (p_tgdv_rec.nth is NULL or
        p_tgdv_rec.nth = OKC_API.G_MISS_NUM) and
       (p_tgdv_rec.day_of_week is NULL or
        p_tgdv_rec.day_of_week = OKC_API.G_MISS_CHAR) and
       (p_tgdv_rec.hour is NULL or
        p_tgdv_rec.hour = OKC_API.G_MISS_NUM) and
       (p_tgdv_rec.minute is NULL or
        p_tgdv_rec.minute = OKC_API.G_MISS_NUM) and
       (p_tgdv_rec.second is NULL or
        p_tgdv_rec.second = OKC_API.G_MISS_NUM)
    THEN
       OKC_API.set_message(G_APP_NAME, G_REQUIRED_VALUE,G_COL_NAME_TOKEN,'month',G_COL_NAME_TOKEN,'day', G_COL_NAME_TOKEN,'day_of_week',G_COL_NAME_TOKEN,'hour',G_COL_NAME_TOKEN,'minute',G_COL_NAME_TOKEN,'second');
       l_return_status  := OKC_API.G_RET_STS_ERROR;
    ELSIF
       (p_tgdv_rec.day is NOT NULL and
        p_tgdv_rec.day <> OKC_API.G_MISS_NUM) and
       (p_tgdv_rec.day_of_week is NOT NULL and
        p_tgdv_rec.day_of_week <> OKC_API.G_MISS_CHAR)
    THEN
       OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'day',G_COL_NAME_TOKEN,'day_of_week');
       l_return_status  := OKC_API.G_RET_STS_ERROR;
    ELSIF
       (p_tgdv_rec.nth is NOT NULL and
        p_tgdv_rec.day <> OKC_API.G_MISS_NUM) and
       (p_tgdv_rec.day_of_week is NULL or
        p_tgdv_rec.day_of_week = OKC_API.G_MISS_CHAR)
    THEN
       OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'nth',G_COL_NAME_TOKEN,'day_of_week');
       l_return_status  := OKC_API.G_RET_STS_ERROR;
    ELSIF
       (p_tgdv_rec.month is NOT NULL and
        p_tgdv_rec.month <> OKC_API.G_MISS_NUM) or
       (p_tgdv_rec.day is NOT NULL and
        p_tgdv_rec.day <> OKC_API.G_MISS_NUM and
	   p_tgdv_rec.day <> 99) or
       (p_tgdv_rec.hour is NOT NULL and
        p_tgdv_rec.hour <> OKC_API.G_MISS_NUM) or
       (p_tgdv_rec.minute is NOT NULL and
        p_tgdv_rec.minute <> OKC_API.G_MISS_NUM) or
       (p_tgdv_rec.second is NOT NULL and
        p_tgdv_rec.second <> OKC_API.G_MISS_NUM)
   THEN
      select
      to_date(
      lpad(decode(p_tgdv_rec.month,OKC_API.G_MISS_NUM,'01',
                              NULL, '01',
                              p_tgdv_rec.month),2,'0') ||
      lpad(decode(p_tgdv_rec.day,OKC_API.G_MISS_NUM,'01',
                              NULL, '01',99,'01',
                              p_tgdv_rec.day),2,'0') ||
      lpad(decode(p_tgdv_rec.hour,OKC_API.G_MISS_NUM,'00',
                              NULL, '00',
                              p_tgdv_rec.hour),2,'0') ||
      lpad(decode(p_tgdv_rec.minute,OKC_API.G_MISS_NUM,'00',
                              NULL, '00',
                              p_tgdv_rec.minute),2,'0') ||
      lpad(decode(p_tgdv_rec.second,OKC_API.G_MISS_NUM,'00',
                              NULL, '00',
                              p_tgdv_rec.second),2,'0'),
      'mmddhh24miss')
      into l_dummy_date
      from dual;
    END IF;
  ...
  EXCEPTION
    WHEN VALUE_ERROR THEN
       OKC_API.set_message(G_APP_NAME, G_INVALID_VALUE,G_COL_NAME_TOKEN,'month',G_COL_NAME_TOKEN,'day',G_COL_NAME_TOKEN,'hour',G_COL_NAME_TOKEN,'minute',G_COL_NAME_TOKEN,'second');
      l_return_status := OKC_API.G_RET_STS_ERROR;
      RETURN(l_return_status);
    WHEN OTHERS THEN
    -- store SQL error message on message stack for caller
...
*/
  ...
  ---------------------------------------------------------------------------
  -----------------------------------------------
  -- validate_row for:OKC_TIME_TPG_DELIMITED_V --
  -----------------------------------------------
  PROCEDURE validate_row(
...
--Bug 3122962    l_okc_timevalues_tl_rec        okc_timevalues_tl_rec_type;
  BEGIN
    ...
    l_return_status := Validate_Attributes(l_tgdv_rec);
    ...
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    l_return_status := Validate_Record(l_tgdv_rec);
    IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_UNEXPECTED_ERROR;
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
  ...
  END validate_row;
  ------------------------------------------
  -- PL/SQL TBL validate_row for:TGDV_TBL --
  ------------------------------------------
  PROCEDURE validate_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
    ...
    x_msg_count                    OUT NOCOPY NUMBER,
    x_msg_data                     OUT NOCOPY VARCHAR2,
    p_tgdv_tbl                     IN tgdv_tbl_type) IS
    ...
    IF (p_tgdv_tbl.COUNT > 0) THEN
      ...
      LOOP
        validate_row (
          ...
          p_tgdv_rec                     => p_tgdv_tbl(i));
        EXIT WHEN (i = p_tgdv_tbl.LAST);
        i := p_tgdv_tbl.NEXT(i);
      END LOOP;
    END IF;
  EXCEPTION
...
*/
  ---------------------------------------------
  -- insert_row for:OKC_TIME_TPG_DELIMITED_V --
  ---------------------------------------------
  PROCEDURE insert_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
    ...
    x_msg_data                     OUT NOCOPY VARCHAR2,
    p_tgdv_rec                     IN tgdv_rec_type,
    x_tgdv_rec                     OUT NOCOPY tgdv_rec_type) IS

    l_api_version                 CONSTANT NUMBER := 1;
    l_api_name                     CONSTANT VARCHAR2(30) := 'V_insert_row';
    l_return_status                VARCHAR2(1) := OKC_API.G_RET_STS_SUCCESS;
    l_tgdv_rec                     tgdv_rec_type;
    l_def_tgdv_rec                 tgdv_rec_type;
    l_tve_rec                      tve_rec_type;
...
--Bug 3122962    lx_okc_timevalues_tl_rec       okc_timevalues_tl_rec_type;
    ...
    FUNCTION fill_who_columns (
      ...
      l_tgdv_rec	tgdv_rec_type := p_tgdv_rec;
    BEGIN
      l_tgdv_rec.CREATION_DATE := SYSDATE;
      l_tgdv_rec.CREATED_BY := FND_GLOBAL.USER_ID;
      l_tgdv_rec.LAST_UPDATE_DATE := l_tgdv_rec.CREATION_DATE;
      l_tgdv_rec.LAST_UPDATED_BY := FND_GLOBAL.USER_ID;
      l_tgdv_rec.LAST_UPDATE_LOGIN := FND_GLOBAL.LOGIN_ID;
      RETURN(l_tgdv_rec);
    END fill_who_columns;
    -------------------------------------------------
    -- Set_Attributes for:OKC_TIME_TPG_DELIMITED_V --
    -------------------------------------------------
    FUNCTION Set_Attributes (
      p_tgdv_rec IN  tgdv_rec_type,
      x_tgdv_rec OUT NOCOPY tgdv_rec_type
    ) RETURN VARCHAR2 IS
      l_return_status                VARCHAR2(1) := OKC_API.G_RET_STS_SUCCESS;
    BEGIN
      x_tgdv_rec := p_tgdv_rec;
-- **** Added the following line(s) for uppercasing *****
      x_tgdv_rec.DAY_OF_WEEK := upper(p_tgdv_rec.DAY_OF_WEEK);
      x_tgdv_rec.OBJECT_VERSION_NUMBER := 1;
--Bug 3122962      x_tgdv_rec.SFWT_FLAG := 'N';
      RETURN(l_return_status);
    END Set_Attributes;
  BEGIN
    l_return_status := OKC_API.START_ACTIVITY(l_api_name,
    ...
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    l_tgdv_rec := null_out_defaults(p_tgdv_rec);
    -- Set primary key value
    l_tgdv_rec.ID := get_seq_id;
    --- Setting item attributes
    l_return_status := Set_Attributes(
      l_tgdv_rec,                        -- IN
      l_def_tgdv_rec);                   -- OUT
    ...
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    l_def_tgdv_rec := fill_who_columns(l_def_tgdv_rec);
    --- Validate all non-missing attributes (Item Level Validation)
    l_return_status := Validate_Attributes(l_def_tgdv_rec);
    --- If any errors happen abort API
    IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_UNEXPECTED_ERROR;
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    l_return_status := Validate_Record(l_def_tgdv_rec);
    IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_UNEXPECTED_ERROR;
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    ...
    --------------------------------------
    migrate(l_def_tgdv_rec, l_tve_rec);
--Bug 3122962    migrate(l_def_tgdv_rec, l_okc_timevalues_tl_rec);
    --------------------------------------------
    ...
    ELSIF (x_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    migrate(lx_tve_rec, l_def_tgdv_rec);
/*    insert_row(
      p_init_msg_list,
      x_return_status,
      x_msg_count,
    ...
    ELSIF (x_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    migrate(lx_okc_timevalues_tl_rec, l_def_tgdv_rec);
*/
    -- Set OUT values
    x_tgdv_rec := l_def_tgdv_rec;
    OKC_API.END_ACTIVITY(x_msg_count, x_msg_data);
  EXCEPTION
    WHEN OKC_API.G_EXCEPTION_ERROR THEN
      x_return_status := OKC_API.HANDLE_EXCEPTIONS
  ...
  END insert_row;
  ----------------------------------------
  -- PL/SQL TBL insert_row for:TGDV_TBL --
  ----------------------------------------
  PROCEDURE insert_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
    ...
    x_msg_count                    OUT NOCOPY NUMBER,
    x_msg_data                     OUT NOCOPY VARCHAR2,
    p_tgdv_tbl                     IN tgdv_tbl_type,
    x_tgdv_tbl                     OUT NOCOPY tgdv_tbl_type) IS
...
*/
  -------------------------------------------
  -- lock_row for:OKC_TIME_TPG_DELIMITED_V --
  -------------------------------------------
  PROCEDURE lock_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
--Bug 3122962    l_okc_timevalues_tl_rec        okc_timevalues_tl_rec_type;
  BEGIN
    ...
    -- Move VIEW record to "Child" records
    --------------------------------------
    migrate(p_tgdv_rec, l_tve_rec);
--Bug 3122962    migrate(p_tgdv_rec, l_okc_timevalues_tl_rec);
    --------------------------------------------
...
*/
  ...
  END lock_row;
  --------------------------------------
  -- PL/SQL TBL lock_row for:TGDV_TBL --
  --------------------------------------
  PROCEDURE lock_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
*/
  ---------------------------------------------
  -- update_row for:OKC_TIME_TPG_DELIMITED_V --
  ---------------------------------------------
  PROCEDURE update_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
--Bug 3122962    lx_okc_timevalues_tl_rec       okc_timevalues_tl_rec_type;
    ...
    FUNCTION fill_who_columns (
      ...
      l_tgdv_rec	tgdv_rec_type := p_tgdv_rec;
    BEGIN
      l_tgdv_rec.LAST_UPDATE_DATE := SYSDATE;
      l_tgdv_rec.LAST_UPDATED_BY := FND_GLOBAL.USER_ID;
      l_tgdv_rec.LAST_UPDATE_LOGIN := FND_GLOBAL.LOGIN_ID;
      RETURN(l_tgdv_rec);
    END fill_who_columns;
    ...
    BEGIN
      x_tgdv_rec := p_tgdv_rec;
      -- Get current database values
      l_tgdv_rec := get_rec(p_tgdv_rec, l_row_notfound);
      IF (l_row_notfound) THEN
        l_return_status := OKC_API.G_RET_STS_UNEXP_ERROR;
      END IF;
      IF (x_tgdv_rec.id = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.id := l_tgdv_rec.id;
      END IF;
      IF (x_tgdv_rec.object_version_number = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.object_version_number := l_tgdv_rec.object_version_number;
      END IF;
--Bug 3122962
/*      IF (x_tgdv_rec.sfwt_flag = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.sfwt_flag := l_tgdv_rec.sfwt_flag;
      END IF;
*/
      IF (x_tgdv_rec.dnz_chr_id = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.dnz_chr_id := l_tgdv_rec.dnz_chr_id;
      END IF;
      IF (x_tgdv_rec.tze_id = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.tze_id := l_tgdv_rec.tze_id;
      END IF;
      IF (x_tgdv_rec.tve_id_limited = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.tve_id_limited := l_tgdv_rec.tve_id_limited;
      END IF;
      IF (x_tgdv_rec.description = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.description := l_tgdv_rec.description;
      END IF;
      IF (x_tgdv_rec.short_description = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.short_description := l_tgdv_rec.short_description;
      END IF;
      IF (x_tgdv_rec.comments = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.comments := l_tgdv_rec.comments;
      END IF;
      IF (x_tgdv_rec.month = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.month := l_tgdv_rec.month;
      END IF;
      IF (x_tgdv_rec.day = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.day := l_tgdv_rec.day;
      END IF;
      IF (x_tgdv_rec.hour = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.hour := l_tgdv_rec.hour;
      END IF;
      IF (x_tgdv_rec.minute = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.minute := l_tgdv_rec.minute;
      END IF;
      IF (x_tgdv_rec.second = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.second := l_tgdv_rec.second;
      END IF;
      IF (x_tgdv_rec.nth = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.nth := l_tgdv_rec.nth;
      END IF;
      IF (x_tgdv_rec.day_of_week = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.day_of_week := l_tgdv_rec.day_of_week;
      END IF;
      IF (x_tgdv_rec.attribute_category = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute_category := l_tgdv_rec.attribute_category;
      END IF;
      IF (x_tgdv_rec.attribute1 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute1 := l_tgdv_rec.attribute1;
      END IF;
      IF (x_tgdv_rec.attribute2 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute2 := l_tgdv_rec.attribute2;
      END IF;
      IF (x_tgdv_rec.attribute3 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute3 := l_tgdv_rec.attribute3;
      END IF;
      IF (x_tgdv_rec.attribute4 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute4 := l_tgdv_rec.attribute4;
      END IF;
      IF (x_tgdv_rec.attribute5 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute5 := l_tgdv_rec.attribute5;
      END IF;
      IF (x_tgdv_rec.attribute6 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute6 := l_tgdv_rec.attribute6;
      END IF;
      IF (x_tgdv_rec.attribute7 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute7 := l_tgdv_rec.attribute7;
      END IF;
      IF (x_tgdv_rec.attribute8 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute8 := l_tgdv_rec.attribute8;
      END IF;
      IF (x_tgdv_rec.attribute9 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute9 := l_tgdv_rec.attribute9;
      END IF;
      IF (x_tgdv_rec.attribute10 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute10 := l_tgdv_rec.attribute10;
      END IF;
      IF (x_tgdv_rec.attribute11 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute11 := l_tgdv_rec.attribute11;
      END IF;
      IF (x_tgdv_rec.attribute12 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute12 := l_tgdv_rec.attribute12;
      END IF;
      IF (x_tgdv_rec.attribute13 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute13 := l_tgdv_rec.attribute13;
      END IF;
      IF (x_tgdv_rec.attribute14 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute14 := l_tgdv_rec.attribute14;
      END IF;
      IF (x_tgdv_rec.attribute15 = OKC_API.G_MISS_CHAR)
      THEN
        x_tgdv_rec.attribute15 := l_tgdv_rec.attribute15;
      END IF;
      IF (x_tgdv_rec.created_by = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.created_by := l_tgdv_rec.created_by;
      END IF;
      IF (x_tgdv_rec.creation_date = OKC_API.G_MISS_DATE)
      THEN
        x_tgdv_rec.creation_date := l_tgdv_rec.creation_date;
      END IF;
      IF (x_tgdv_rec.last_updated_by = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.last_updated_by := l_tgdv_rec.last_updated_by;
      END IF;
      IF (x_tgdv_rec.last_update_date = OKC_API.G_MISS_DATE)
      THEN
        x_tgdv_rec.last_update_date := l_tgdv_rec.last_update_date;
      END IF;
      IF (x_tgdv_rec.last_update_login = OKC_API.G_MISS_NUM)
      THEN
        x_tgdv_rec.last_update_login := l_tgdv_rec.last_update_login;
      END IF;
      RETURN(l_return_status);
    END populate_new_record;
    -------------------------------------------------
...
-- **** Added the following line(s) for uppercasing *****
      x_tgdv_rec.DAY_OF_WEEK := upper(p_tgdv_rec.DAY_OF_WEEK);
--      x_tgdv_rec.SFWT_FLAG := upper(p_tgdv_rec.SFWT_FLAG);
      x_tgdv_rec.OBJECT_VERSION_NUMBER := NVL(x_tgdv_rec.OBJECT_VERSION_NUMBER, 0) + 1;
      RETURN(l_return_status);
    END Set_Attributes;
  BEGIN
    l_return_status := OKC_API.START_ACTIVITY(l_api_name,
    ...
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
    END IF;
    l_return_status := populate_new_record(l_tgdv_rec, l_def_tgdv_rec);
    IF (l_return_status = OKC_API.G_RET_STS_UNEXP_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_UNEXPECTED_ERROR;
    ELSIF (l_return_status = OKC_API.G_RET_STS_ERROR) THEN
      RAISE OKC_API.G_EXCEPTION_ERROR;
...
*/
  ...
  END update_row;
  ----------------------------------------
  -- PL/SQL TBL update_row for:TGDV_TBL --
  ----------------------------------------
  PROCEDURE update_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
*/
  ---------------------------------------------
  -- delete_row for:OKC_TIME_TPG_DELIMITED_V --
  ---------------------------------------------
  PROCEDURE delete_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
...
--Bug 3122962    l_okc_timevalues_tl_rec        okc_timevalues_tl_rec_type;
  ...
  BEGIN
    ...
    -- Move VIEW record to "Child" records
    --------------------------------------
--Bug 3122962    migrate(l_tgdv_rec, l_okc_timevalues_tl_rec);
    migrate(l_tgdv_rec, l_tve_rec);
    --------------------------------------------
...
*/
  ...
  END delete_row;
  ----------------------------------------
  -- PL/SQL TBL delete_row for:TGDV_TBL --
  ----------------------------------------
  PROCEDURE delete_row(
    p_api_version                  IN NUMBER,
    p_init_msg_list                IN VARCHAR2,
