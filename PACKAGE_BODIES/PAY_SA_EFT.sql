--------------------------------------------------------
--  DDL for Package Body PAY_SA_EFT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_SA_EFT" as
 /* $Header: pysaeftp.pkb 120.0 2005/05/29 08:29:56 appldev noship $ */
 g_package                  varchar2(33) := 'PAY_SA_PAYFILE.';
 -- Global Variables
 ...
 FUNCTION get_customer_formula_header    (
                            ...
                            ,p_report_text10 OUT NOCOPY VARCHAR2) return varchar2 IS
 ...
 select PMETH_INFORMATION1,PMETH_INFORMATION2,PMETH_INFORMATION3
 ...
 fetch c_get_name into l_id_header,l_id_body,l_id_footer;
 close c_get_name;
 ...
 FUNCTION get_customer_formula_body      (
                                 ...
                                 ,p_local_nationality IN VARCHAR2) return varchar2 IS
 l_header varchar2(100);
 l_body varchar2(100);
 l_footer varchar2(100);
 l_inputs ff_exec.inputs_t;
