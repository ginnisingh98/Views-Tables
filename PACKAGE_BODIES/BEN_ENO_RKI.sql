--------------------------------------------------------
--  DDL for Package Body BEN_ENO_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ENO_RKI" as
...
begin
hr_utility.set_location('Entering: ben_eno_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_eno_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_eno_RKI;
