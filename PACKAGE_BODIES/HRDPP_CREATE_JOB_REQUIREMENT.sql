--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_JOB_REQUIREMENT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_JOB_REQUIREMENT" as
/*
 * Generated by hr_pump_meta_mapper at: 2018/06/16 10:06:12
 * Generated for API: HR_JOB_REQUIREMENT_API.CREATE_JOB_REQUIREMENT
 */
--
...
,P_JOB_REQUIREMENT_USER_KEY in varchar2
...
l.pval001 d1,
decode(l.pval002,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval002,'YES_NO',d(l.pval060),vn)) p2,
l.pval002 d2,
...
l.pval055 p55,
l.pval056 p56,
decode(l.pval057,cn,nn,n(l.pval057)) p57,
decode(l.pval058,cn,vn,l.pval058) p58,
decode(l.pval059,cn,vn,l.pval059) p59,
decode(l.pval060,cn,dn,d(l.pval060)) p60
...
,P_SEGMENT29 => c.p52
,P_SEGMENT30 => c.p53
,P_CONCAT_SEGMENTS => c.p54
,P_JOB_REQUIREMENT_ID => L_JOB_REQUIREMENT_ID
,P_OBJECT_VERSION_NUMBER => c.p56
,P_ANALYSIS_CRITERIA_ID => c.p57);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p55,L_JOB_REQUIREMENT_ID);
--
...
end hrdpp_CREATE_JOB_REQUIREMENT;
