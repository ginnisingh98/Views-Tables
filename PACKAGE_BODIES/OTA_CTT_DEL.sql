--------------------------------------------------------
--  DDL for Package Body OTA_CTT_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CTT_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_ctt_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the ota_category_usages_tl row.
  --
  delete from ota_category_usages_tl
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in ota_ctt_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in ota_ctt_shd.g_rec_type) is
--
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'OTA_CATEGORY_USAGES_TL'
        ,p_hook_type   => 'AD');
      --
  end;
  --
...
Begin
  ...
  --
  ota_ctt_bus.delete_validate(p_rec);
  --
  ...
  --
  ota_ctt_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  ota_ctt_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  ota_ctt_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
...
Begin
  ...
  --
  --
  -- Having converted the arguments into the ota_ctt_rec
  -- plsql record structure we must call the corresponding entity
  -- business process
  --
  ota_ctt_del.del(l_rec);
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End del;
--
