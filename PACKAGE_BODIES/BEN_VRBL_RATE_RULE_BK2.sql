--------------------------------------------------------
--  DDL for Package Body BEN_VRBL_RATE_RULE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_VRBL_RATE_RULE_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_VRBL_RATE_RULE_BK2.UPDATE_VRBL_RATE_RULE_A', 10);
hr_utility.set_location(' Leaving: BEN_VRBL_RATE_RULE_BK2.UPDATE_VRBL_RATE_RULE_A', 20);
end UPDATE_VRBL_RATE_RULE_A;
...
begin
hr_utility.set_location('Entering: BEN_VRBL_RATE_RULE_BK2.UPDATE_VRBL_RATE_RULE_B', 10);
hr_utility.set_location(' Leaving: BEN_VRBL_RATE_RULE_BK2.UPDATE_VRBL_RATE_RULE_B', 20);
end UPDATE_VRBL_RATE_RULE_B;
