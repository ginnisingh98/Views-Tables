--------------------------------------------------------
--  DDL for Package Body HR_ASSIGNMENT_BEC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ASSIGNMENT_BEC" as 
...
p_effective_end_date           date) is
  ...
  --
  l_proc varchar2(72):='  hr_assignment_beC.activate_apl_asg_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.assignment.activate_apl_asg';
...
end activate_apl_asg_a;
end hr_assignment_beC;
