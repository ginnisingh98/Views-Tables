--------------------------------------------------------
--  DDL for Package Body PQH_CORPS_EXTRA_INFO_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_CORPS_EXTRA_INFO_SWI" As
/* $Header: pqceiswi.pkb 115.0 2003/12/15 05:47 kgowripe noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'pqh_corps_extra_info_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_corps_extra_info_swi;
  --
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_corps_extra_info_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_corps_extra_info_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_corps_extra_info_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_corps_extra_info_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_corps_extra_info_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
  ...
  when others then
    ...
    p_return_status := hr_multi_message.get_return_status_disable;
    hr_utility.set_location(' Leaving:' || l_proc,50);
end update_corps_extra_info;
end pqh_corps_extra_info_swi;
