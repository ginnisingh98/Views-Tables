--------------------------------------------------------
--  DDL for Package Body BEN_XCT_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XCT_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xct_del.';  -- Global package name
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_dml(p_rec in ben_xct_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Delete the ben_ext_crit_typ row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in ben_xct_shd.g_rec_type) is
--
...
--
  ...
  --
  delete_app_ownerships('EXT_CRIT_TYP_ID', p_rec.ext_crit_typ_id);
  --
  -- Start of API User Hook for post_delete.
  --
  begin
    --
    ben_xct_rkd.after_delete
      (
...
Procedure del
  ...
  p_rec	      in ben_xct_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  ben_xct_bus.delete_validate(p_rec
  ,p_effective_date);
  --
