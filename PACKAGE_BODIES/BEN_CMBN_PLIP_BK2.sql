--------------------------------------------------------
--  DDL for Package Body BEN_CMBN_PLIP_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CMBN_PLIP_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_CMBN_PLIP_BK2.UPDATE_CMBN_PLIP_A', 10);
hr_utility.set_location(' Leaving: BEN_CMBN_PLIP_BK2.UPDATE_CMBN_PLIP_A', 20);
end UPDATE_CMBN_PLIP_A;
...
begin
hr_utility.set_location('Entering: BEN_CMBN_PLIP_BK2.UPDATE_CMBN_PLIP_B', 10);
hr_utility.set_location(' Leaving: BEN_CMBN_PLIP_BK2.UPDATE_CMBN_PLIP_B', 20);
end UPDATE_CMBN_PLIP_B;
