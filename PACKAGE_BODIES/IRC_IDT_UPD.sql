--------------------------------------------------------
--  DDL for Package Body IRC_IDT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_IDT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  irc_idt_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
--   this procedure is:
--   1) Increment the object  ersion_number by 1 if the object  ersion_number
...
Begin
  ...
  --
  --
  -- Update the irc_default_postings_tl Row
  --
...
Begin
  ...
  If (p_rec.org_description  = hr_api.g_varchar2) then
    ...
    irc_idt_shd.g_org_description_upd:=true;
  End If;
