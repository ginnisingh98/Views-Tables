--------------------------------------------------------
--  DDL for Package Body BEN_PERSON_BNFTS_BAL_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PERSON_BNFTS_BAL_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_PERSON_BNFTS_BAL_BK2.UPDATE_PERSON_BNFTS_BAL_A', 10);
hr_utility.set_location(' Leaving: BEN_PERSON_BNFTS_BAL_BK2.UPDATE_PERSON_BNFTS_BAL_A', 20);
end UPDATE_PERSON_BNFTS_BAL_A;
...
begin
hr_utility.set_location('Entering: BEN_PERSON_BNFTS_BAL_BK2.UPDATE_PERSON_BNFTS_BAL_B', 10);
hr_utility.set_location(' Leaving: BEN_PERSON_BNFTS_BAL_BK2.UPDATE_PERSON_BNFTS_BAL_B', 20);
end UPDATE_PERSON_BNFTS_BAL_B;
