--------------------------------------------------------
--  DDL for Package Body GMA_GME_TEXT_TBL_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GMA_GME_TEXT_TBL_PKG" AS
/* $Header: GMAGMETB.pls 115.7 2003/02/24 19:20:33 kmoizudd noship $ */
...
procedure INSERT_ROW (
  ...
  cursor C is select ROWID from GME_TEXT_TABLE_TL
...
is
begin
  update GME_TEXT_TABLE_TL T set (
      TEXT
    ) = (select
      B.TEXT
    from GME_TEXT_TABLE_TL B
  ...
  where (
      ...
      SUBT.LINE_NO,
      SUBT.LANGUAGE
    from GME_TEXT_TABLE_TL SUBB, GME_TEXT_TABLE_TL SUBT
  ...
  insert into GME_TEXT_TABLE_TL (
    ...
    L.LANGUAGE_CODE,
    B.SOURCE_LANG
  from GME_TEXT_TABLE_TL B, FND_LANGUAGES L
  where L.INSTALLED_FLAG in ('I', 'B')
...
procedure LOAD_ROW (
 ...
 BEGIN
   ...
   GMA_GME_TEXT_TBL_PKG.UPDATE_ROW( X_ROW_ID => l_row_id,
...
-- Bug #1712111 (JKB)
 ...
 EXCEPTION
  ...
  GMA_GME_TEXT_TBL_PKG.INSERT_ROW (  X_ROWID => l_row_id,
                                    X_TEXT_CODE => X_TEXT_CODE,
                                    X_LANG_CODE => X_LANG_CODE,
                                    X_PARAGRAPH_CODE => X_PARAGRAPH_CODE,
                                    X_SUB_PARACODE => X_SUB_PARACODE,
