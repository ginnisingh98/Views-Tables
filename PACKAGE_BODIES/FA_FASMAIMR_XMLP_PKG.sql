--------------------------------------------------------
--  DDL for Package Body FA_FASMAIMR_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FASMAIMR_XMLP_PKG" AS
/* $Header: FASMAIMRB.pls 120.0.12010000.1 2008/07/28 13:16:55 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    RP_Report_Name := ':MASS ADDITIONS INVOICE MERGE REPORT:';
    RETURN('MASS ADDITIONS INVOICE MERGE REPORT');
END;
RETURN NULL; end;
