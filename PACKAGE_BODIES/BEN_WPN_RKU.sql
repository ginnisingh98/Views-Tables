--------------------------------------------------------
--  DDL for Package Body BEN_WPN_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_WPN_RKU" as
...
begin
hr_utility.set_location('Entering: ben_wpn_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_wpn_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_wpn_RKU;
