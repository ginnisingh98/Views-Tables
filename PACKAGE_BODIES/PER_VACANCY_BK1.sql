--------------------------------------------------------
--  DDL for Package Body PER_VACANCY_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_VACANCY_BK1" as
/* $Header: pevacapi.pkb 120.0.12000000.2 2007/06/12 08:51:35 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2008/10/18 16:43:47 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: PER_VACANCY_BK1.CREATE_VACANCY_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
per_vacancy_be1.CREATE_VACANCY_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_VACANCY', 'AP');
hr_utility.set_location(' Leaving: PER_VACANCY_BK1.CREATE_VACANCY_A', 20);
...
begin
hr_utility.set_location('Entering: PER_VACANCY_BK1.CREATE_VACANCY_B', 10);
hr_utility.set_location(' Leaving: PER_VACANCY_BK1.CREATE_VACANCY_B', 20);
end CREATE_VACANCY_B;
end PER_VACANCY_BK1;
