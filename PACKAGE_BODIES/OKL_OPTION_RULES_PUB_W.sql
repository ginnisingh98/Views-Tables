--------------------------------------------------------
--  DDL for Package Body OKL_OPTION_RULES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_OPTION_RULES_PUB_W" as
  /* $Header: OKLUORLB.pls 115.4 2002/12/24 04:13:26 sgorantl noship $ */
  ...
  as
    ddp_orlv_rec okl_option_rules_pub.orlv_rec_type;
    ddp_ovdv_tbl okl_option_rules_pub.ovdv_tbl_type;
    ddx_orlv_rec okl_option_rules_pub.orlv_rec_type;
    ddx_ovdv_tbl okl_option_rules_pub.ovdv_tbl_type;
  ...
  begin
    ...
    okl_option_rules_pub.create_option_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_option_rules_pub.update_option_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_option_rules_pub.validate_option_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_orlv_tbl okl_option_rules_pub.orlv_tbl_type;
    ddx_orlv_tbl okl_option_rules_pub.orlv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_option_rules_pub.lock_option_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_option_rules_pub.delete_option_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_option_rules_pub.create_option_val_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ovdv_rec okl_option_rules_pub.ovdv_rec_type;
    ddx_ovdv_rec okl_option_rules_pub.ovdv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_option_rules_pub.lock_option_val_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_option_rules_pub.update_option_val_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_option_rules_pub.delete_option_val_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_option_rules_pub.validate_option_val_rules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
