--------------------------------------------------------
--  DDL for Package Body IRC_DEFAULT_POSTING_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_DEFAULT_POSTING_BE2" as 
...
p_attribute30                  varchar2) is
  ...
  --
  l_proc varchar2(72):='  irc_default_posting_be2.update_default_posting_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.default_posting.update_default_posting';
...
end update_default_posting_a;
end irc_default_posting_be2;
