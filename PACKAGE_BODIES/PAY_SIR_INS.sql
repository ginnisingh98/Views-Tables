--------------------------------------------------------
--  DDL for Package Body PAY_SIR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_SIR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_sir_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: pay_shadow_iterative_rules
  --
  insert into pay_shadow_iterative_rules
      (iterative_rule_id
      ,element_type_id
      ,result_name
      ,iterative_rule_type
...
--
  Cursor C_Sel1 is select pay_shadow_iterative_rules_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
...
Begin
  ...
  --
  pay_sir_bus.insert_validate(p_effective_date ,p_rec);
  --
  -- Call the supporting pre-insert operation
  --
  pay_sir_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pay_sir_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pay_sir_ins.post_insert(p_rec);
  --
