--------------------------------------------------------
--  DDL for Package Body OTA_TPC_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TPC_RKU" as
...
begin
hr_utility.set_location('Entering: OTA_TPC_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: OTA_TPC_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end OTA_TPC_RKU;
