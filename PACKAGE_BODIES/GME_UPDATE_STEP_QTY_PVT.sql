--------------------------------------------------------
--  DDL for Package Body GME_UPDATE_STEP_QTY_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_UPDATE_STEP_QTY_PVT" AS
/* $Header: GMEVUSQB.pls 120.10.12010000.3 2010/03/22 15:42:50 gmurator ship $ */
   g_debug                     VARCHAR2 (5)
