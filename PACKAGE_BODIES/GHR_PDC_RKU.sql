--------------------------------------------------------
--  DDL for Package Body GHR_PDC_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_PDC_RKU" as
...
begin
hr_utility.set_location('Entering: GHR_PDC_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: GHR_PDC_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end GHR_PDC_RKU;
