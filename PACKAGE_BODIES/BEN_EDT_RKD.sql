--------------------------------------------------------
--  DDL for Package Body BEN_EDT_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EDT_RKD" as
/* $Header: beedtrhi.pkb 120.1 2006/02/28 01:56:55 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_edt_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_edt_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_edt_RKD;
