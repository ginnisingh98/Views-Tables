--------------------------------------------------------
--  DDL for Package Body PAY_ETP_INS_ND
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ETP_INS_ND" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_etp_ins_nd.';  -- Global package name
--
...
Begin
  ...
  --
  pay_etp_ins_nd.g_element_type_id_i := p_element_type_id;
  --
 ...
 Cursor C_Sel2 is
    Select null
     ...
     where element_type_id =
             pay_etp_ins_nd.g_element_type_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (pay_etp_ins_nd.g_element_type_id_i is not null) Then
    --
    ...
    p_rec.element_type_id :=
      pay_etp_ins_nd.g_element_type_id_i;
    pay_etp_ins_nd.g_element_type_id_i := null;
  Else
    --
...
Begin
  ...
  --
  pay_etp_bus_nd.insert_validate
    (p_rec                   => p_rec
    ,p_effective_date        => p_effective_date
    ,p_datetrack_mode        => l_datetrack_mode
    ,p_validation_start_date => l_validation_start_date
