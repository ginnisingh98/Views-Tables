--------------------------------------------------------
--  DDL for Package Body HR_PERSON_DEPLOYMENT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PERSON_DEPLOYMENT_BK1" as
...
begin
hr_utility.set_location('Entering: HR_PERSON_DEPLOYMENT_BK1.CREATE_PERSON_DEPLOYMENT_A', 10);
hr_utility.set_location(' Leaving: HR_PERSON_DEPLOYMENT_BK1.CREATE_PERSON_DEPLOYMENT_A', 20);
end CREATE_PERSON_DEPLOYMENT_A;
...
begin
hr_utility.set_location('Entering: HR_PERSON_DEPLOYMENT_BK1.CREATE_PERSON_DEPLOYMENT_B', 10);
hr_utility.set_location(' Leaving: HR_PERSON_DEPLOYMENT_BK1.CREATE_PERSON_DEPLOYMENT_B', 20);
end CREATE_PERSON_DEPLOYMENT_B;
