--------------------------------------------------------
--  DDL for Package Body AST_WEBASSIST_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AST_WEBASSIST_PVT" AS
/* $Header: astvwbab.pls 115.6 2002/02/06 11:21:26 pkm ship      $ */


  G_PKG_NAME    CONSTANT VARCHAR2(30)   :='AST_WEBASSIST_PVT';
  G_FILE_NAME   CONSTANT VARCHAR2(12)   :='astvwbas.pls';
  ...
  BEGIN
   ...
   -- Implementation of User Hooks
    ...
    IF (JTF_USR_HKS.Ok_to_execute(G_PKG_NAME, l_api_name, 'B', 'C' )  )  THEN
      ast_WEBASSIST_CUHK.Create_WebAssist_PRE(p_api_version => l_api_version,
    ...
    IF (JTF_USR_HKS.Ok_to_execute(G_PKG_NAME, l_api_name, 'B', 'V' )  )  THEN
      ast_WEBASSIST_VUHK.Create_WebAssist_PRE(p_api_version => l_api_version,
        x_return_status => l_return_status,
        x_msg_count => l_msg_count,
        x_msg_data => l_msg_data,
        p_assist_rec => l_assist_rec,
    ...
    -- API body
    IF p_assist_rec.assist_id IS NOT NULL
    THEN
      OPEN c0;
      FETCH c0 INTO P_DUMMY;
      IF c0%notfound THEN
    ...
    IF  (JTF_USR_HKS.Ok_to_execute(G_PKG_NAME, l_api_name, 'A', 'V' )  )  THEN
      ast_WEBASSIST_VUHK.Create_WebAssist_Post(p_api_version => l_api_version,
        x_return_status => l_return_status,
        x_msg_count => l_msg_count,
        x_msg_data => l_msg_data,
        p_assist_rec => l_assist_rec,
    ...
    IF  (JTF_USR_HKS.Ok_to_execute(G_PKG_NAME, l_api_name, 'A', 'C' )  )  THEN
      ast_WEBASSIST_CUHK.Create_WebAssist_Post (p_api_version => l_api_version,
        x_return_status => l_return_status,
        x_msg_count => l_msg_count,
        x_msg_data => l_msg_data,
        p_assist_rec => l_assist_rec,
...
BEGIN
   ...
   -- Implementation of User Hooks
    ...
    /*               Customer pre -processing  section - Mandatory              */
    IF  (JTF_USR_HKS.Ok_to_execute(G_PKG_NAME, l_api_name, 'B', 'C' )  )  THEN
                  ast_WEBASSIST_CUHK.Lock_WebAssist_PRE(p_api_version => l_api_version,
                       x_return_status => l_return_status,
                       x_msg_count => l_msg_count,
                       x_msg_data => l_msg_data,
                       p_assist_rec => l_assist_rec,
    ...
    /*               Verticle industry pre- processing section  -  mandatory     */
    IF (JTF_USR_HKS.Ok_to_execute(G_PKG_NAME, l_api_name, 'B', 'V' )  )  THEN
                          ast_WEBASSIST_VUHK.Lock_WebAssist_PRE(p_api_version => l_api_version,
                       x_return_status => l_return_status,
                       x_msg_count => l_msg_count,
                       x_msg_data => l_msg_data,
                       p_assist_rec => l_assist_rec,
    ...
    -- ENDof API body
             ...
             /*  Vertical Post Processing section      -  mandatory                           */
             IF  (JTF_USR_HKS.Ok_to_execute(G_PKG_NAME, l_api_name, 'A', 'V' )  )  THEN
                          ast_WEBASSIST_VUHK.Lock_WebAssist_POST(p_api_version => l_api_version,
                                    x_return_status => l_return_status,
                                    x_msg_count => l_msg_count,
                                    x_msg_data => l_msg_data,
                                    p_assist_rec => l_assist_rec,
             ...
             /*  Customer  Post Processing section      -  mandatory                           */
             IF  (JTF_USR_HKS.Ok_to_execute(G_PKG_NAME, l_api_name, 'A', 'C' )  )  THEN
                          ast_WEBASSIST_CUHK.Lock_WebAssist_POST (p_api_version => l_api_version,
                                    x_return_status => l_return_status,
                                    x_msg_count => l_msg_count,
                                    x_msg_data => l_msg_data,
                                    p_assist_rec => l_assist_rec,
