--------------------------------------------------------
--  DDL for Package Body IRC_SEARCH_CRITERIA_BE4
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_SEARCH_CRITERIA_BE4" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  irc_search_criteria_be4.create_vacancy_criteria_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.search_criteria.create_vacancy_criteria';
