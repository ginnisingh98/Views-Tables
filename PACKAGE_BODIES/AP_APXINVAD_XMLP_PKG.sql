--------------------------------------------------------
--  DDL for Package Body AP_APXINVAD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AP_APXINVAD_XMLP_PKG" AS
/* $Header: APXINVADB.pls 120.0 2007/12/27 08:04:36 vjaganat noship $ */
...
--Functions to refer Oracle report placeholders--
 ...
 Function C_CHART_OF_ACCOUNTS_ID_p return number is
	Begin
	 ...
	 END;
 Function C_sequence_id_p return number is
	Begin
	 return C_sequence_id;
	 END;
 Function C_NLS_END_OF_REPORT_p return varchar2 is
	Begin
	 return C_NLS_END_OF_REPORT;
	 END;
END AP_APXINVAD_XMLP_PKG ;
