--------------------------------------------------------
--  DDL for Package Body IGS_PR_STDNT_PR_FND_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_PR_STDNT_PR_FND_PKG" AS
/* $Header: IGSQI45B.pls 120.0 2005/07/05 12:15:50 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_pr_stdnt_pr_fnd%ROWTYPE;
  new_references igs_pr_stdnt_pr_fnd%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_PR_PSEF_PRO_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_PR_PSEF_FCAT_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  END IF;
  INSERT INTO igs_pr_stdnt_pr_fnd (
      person_id,
      course_cd,
      spo_sequence_number,
      fund_code,
