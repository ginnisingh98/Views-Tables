--------------------------------------------------------
--  DDL for Package Body PAY_PPE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PPE_BK1" as
...
begin
hr_utility.set_location('Entering: PAY_PPE_BK1.CREATE_PROCESS_EVENT_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
pay_ppe_be1.CREATE_PROCESS_EVENT_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_PROCESS_EVENT', 'AP');
hr_utility.set_location(' Leaving: PAY_PPE_BK1.CREATE_PROCESS_EVENT_A', 20);
...
begin
hr_utility.set_location('Entering: PAY_PPE_BK1.CREATE_PROCESS_EVENT_B', 10);
hr_utility.set_location(' Leaving: PAY_PPE_BK1.CREATE_PROCESS_EVENT_B', 20);
end CREATE_PROCESS_EVENT_B;
end PAY_PPE_BK1;
