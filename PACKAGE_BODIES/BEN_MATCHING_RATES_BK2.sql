--------------------------------------------------------
--  DDL for Package Body BEN_MATCHING_RATES_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_MATCHING_RATES_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_MATCHING_RATES_BK2.UPDATE_MATCHING_RATES_A', 10);
hr_utility.set_location(' Leaving: BEN_MATCHING_RATES_BK2.UPDATE_MATCHING_RATES_A', 20);
end UPDATE_MATCHING_RATES_A;
...
begin
hr_utility.set_location('Entering: BEN_MATCHING_RATES_BK2.UPDATE_MATCHING_RATES_B', 10);
hr_utility.set_location(' Leaving: BEN_MATCHING_RATES_BK2.UPDATE_MATCHING_RATES_B', 20);
end UPDATE_MATCHING_RATES_B;
