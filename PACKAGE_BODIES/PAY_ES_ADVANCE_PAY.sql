--------------------------------------------------------
--  DDL for Package Body PAY_ES_ADVANCE_PAY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ES_ADVANCE_PAY" AS
/* $Header: pyesapay.pkb 120.0 2005/06/03 06:47:04 appldev noship $ */
   g_package  CONSTANT VARCHAR2(33) := 'pay_es_advance_pay.';
   --
