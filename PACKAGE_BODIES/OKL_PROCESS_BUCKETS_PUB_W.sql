--------------------------------------------------------
--  DDL for Package Body OKL_PROCESS_BUCKETS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PROCESS_BUCKETS_PUB_W" as
  /* $Header: OKLUBUKB.pls 120.1 2005/07/18 10:30:19 asawanka noship $ */
  ...
  as
    ddp_bktv_rec okl_process_buckets_pub.bktv_rec_type;
    ddx_bktv_rec okl_process_buckets_pub.bktv_rec_type;
  ...
  begin
    ...
    okl_process_buckets_pub.create_buckets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_bktv_tbl okl_process_buckets_pub.bktv_tbl_type;
    ddx_bktv_tbl okl_process_buckets_pub.bktv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_buckets_pub.update_buckets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_buckets_pub.delete_buckets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
