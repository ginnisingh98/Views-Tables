--------------------------------------------------------
--  DDL for Package Body BEN_ART_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ART_RKU" as
/* $Header: beartrhi.pkb 120.0.12010000.2 2008/08/05 14:03:53 generated ship $ */
...
begin
hr_utility.set_location('Entering: ben_art_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_art_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_art_RKU;
