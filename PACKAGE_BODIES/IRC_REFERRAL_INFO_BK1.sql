--------------------------------------------------------
--  DDL for Package Body IRC_REFERRAL_INFO_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_REFERRAL_INFO_BK1" as
...
begin
hr_utility.set_location('Entering: IRC_REFERRAL_INFO_BK1.CREATE_REFERRAL_INFO_A', 10);
hr_utility.set_location(' Leaving: IRC_REFERRAL_INFO_BK1.CREATE_REFERRAL_INFO_A', 20);
end CREATE_REFERRAL_INFO_A;
...
begin
hr_utility.set_location('Entering: IRC_REFERRAL_INFO_BK1.CREATE_REFERRAL_INFO_B', 10);
hr_utility.set_location(' Leaving: IRC_REFERRAL_INFO_BK1.CREATE_REFERRAL_INFO_B', 20);
end CREATE_REFERRAL_INFO_B;
