--------------------------------------------------------
--  DDL for Package Body BEN_PCS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PCS_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pcs_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_PRTT_ENRT_CTFN_PRVDD_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_PRTT_ENRT_CTFN_PRVDD_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  If (p_effective_date is null or
      p_prtt_enrt_ctfn_prvdd_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_prtt_enrt_ctfn_prvdd_id = g_old_rec.prtt_enrt_ctfn_prvdd_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_prtt_enrt_ctfn_prvdd_f',
	 p_base_key_column	   => 'prtt_enrt_ctfn_prvdd_id',
	 p_base_key_value 	   => p_prtt_enrt_ctfn_prvdd_id,
	 p_parent_table_name1      => 'ben_prtt_enrt_actn_f',
	 p_parent_key_column1      => 'prtt_enrt_actn_id',
	 p_parent_key_value1       => g_old_rec.prtt_enrt_actn_id,
	 p_parent_table_name2      => 'ben_prtt_enrt_rslt_f',
	 p_parent_key_column2      => 'prtt_enrt_rslt_id',
...
Begin
  ...
  l_rec.enrt_r_bnft_ctfn_cd              := p_enrt_r_bnft_ctfn_cd;
  l_rec.prtt_enrt_rslt_id                := p_prtt_enrt_rslt_id;
  l_rec.prtt_enrt_actn_id                := p_prtt_enrt_actn_id;
  l_rec.business_group_id                := p_business_group_id;
  l_rec.pcs_attribute_category           := p_pcs_attribute_category;
  l_rec.pcs_attribute1                   := p_pcs_attribute1;
  l_rec.pcs_attribute2                   := p_pcs_attribute2;
  l_rec.pcs_attribute3                   := p_pcs_attribute3;
  l_rec.pcs_attribute4                   := p_pcs_attribute4;
  l_rec.pcs_attribute5                   := p_pcs_attribute5;
  l_rec.pcs_attribute6                   := p_pcs_attribute6;
  l_rec.pcs_attribute7                   := p_pcs_attribute7;
  l_rec.pcs_attribute8                   := p_pcs_attribute8;
  l_rec.pcs_attribute9                   := p_pcs_attribute9;
  l_rec.pcs_attribute10                  := p_pcs_attribute10;
  l_rec.pcs_attribute11                  := p_pcs_attribute11;
  l_rec.pcs_attribute12                  := p_pcs_attribute12;
  l_rec.pcs_attribute13                  := p_pcs_attribute13;
  l_rec.pcs_attribute14                  := p_pcs_attribute14;
  l_rec.pcs_attribute15                  := p_pcs_attribute15;
  l_rec.pcs_attribute16                  := p_pcs_attribute16;
  l_rec.pcs_attribute17                  := p_pcs_attribute17;
  l_rec.pcs_attribute18                  := p_pcs_attribute18;
  l_rec.pcs_attribute19                  := p_pcs_attribute19;
  l_rec.pcs_attribute20                  := p_pcs_attribute20;
  l_rec.pcs_attribute21                  := p_pcs_attribute21;
  l_rec.pcs_attribute22                  := p_pcs_attribute22;
  l_rec.pcs_attribute23                  := p_pcs_attribute23;
  l_rec.pcs_attribute24                  := p_pcs_attribute24;
  l_rec.pcs_attribute25                  := p_pcs_attribute25;
  l_rec.pcs_attribute26                  := p_pcs_attribute26;
  l_rec.pcs_attribute27                  := p_pcs_attribute27;
  l_rec.pcs_attribute28                  := p_pcs_attribute28;
  l_rec.pcs_attribute29                  := p_pcs_attribute29;
  l_rec.pcs_attribute30                  := p_pcs_attribute30;
