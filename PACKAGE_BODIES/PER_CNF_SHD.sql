--------------------------------------------------------
--  DDL for Package Body PER_CNF_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CNF_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_cnf_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'SYS_C00255674') Then
...
Begin
  --
  If (p_configuration_code is null and
  ...
  Else
    If (p_configuration_code
        = per_cnf_shd.g_old_rec.configuration_code and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_cnf_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_cnf_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  l_rec.configuration_type               := p_configuration_type;
  l_rec.configuration_status             := p_configuration_status;
