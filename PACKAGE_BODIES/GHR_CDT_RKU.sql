--------------------------------------------------------
--  DDL for Package Body GHR_CDT_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_CDT_RKU" as
...
begin
hr_utility.set_location('Entering: GHR_CDT_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: GHR_CDT_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end GHR_CDT_RKU;
