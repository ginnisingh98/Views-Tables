--------------------------------------------------------
--  DDL for Package Body BEN_PER_CM_TRGR_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PER_CM_TRGR_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PER_CM_TRGR_BK1.CREATE_PER_CM_TRGR_A', 10);
hr_utility.set_location(' Leaving: BEN_PER_CM_TRGR_BK1.CREATE_PER_CM_TRGR_A', 20);
end CREATE_PER_CM_TRGR_A;
...
begin
hr_utility.set_location('Entering: BEN_PER_CM_TRGR_BK1.CREATE_PER_CM_TRGR_B', 10);
hr_utility.set_location(' Leaving: BEN_PER_CM_TRGR_BK1.CREATE_PER_CM_TRGR_B', 20);
end CREATE_PER_CM_TRGR_B;
