--------------------------------------------------------
--  DDL for Package Body OKS_SRVAVL_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKS_SRVAVL_PUB" AS
/* $Header: OKSPSVAB.pls 120.0 2005/05/25 18:19:15 appldev noship $ */
...
--Restore ID/OBJECT VERSION NUMBER
  ...
  l_savv_rec                        := g_savv_rec;
  l_savv_rec.id	                  := p_savv_rec.id;
  l_savv_rec.object_version_number	:= p_savv_rec.object_version_number;

  oks_srvavl_pvt.insert_serv_avail
  (
    p_api_version                  ,
    p_init_msg_list                ,
    x_return_status                ,
  ...
  If p_savv_tbl.COUNT > 0 Then
          ...
          Loop
            ...
            Exit When  (l_ptr = p_savv_tbl.LAST);
            l_ptr := p_savv_tbl.NEXT(l_ptr);
  ...
  oks_srvavl_pvt.lock_serv_avail
  (
    p_api_version                  ,
    p_init_msg_list                ,
    x_return_status                ,
...
--Restore ID/OBJECT VERSION NUMBER
  ...
  oks_srvavl_pvt.update_serv_avail
  (
    p_api_version                  ,
    p_init_msg_list                ,
    x_return_status                ,
...
--Restore ID/OBJECT VERSION NUMBER
  ...
  oks_srvavl_pvt.delete_serv_avail
  (
    p_api_version                  ,
    p_init_msg_list                ,
    x_return_status                ,
...
--Restore ID/OBJECT VERSION NUMBER
  ...
  oks_srvavl_pvt.validate_serv_avail
  (
    p_api_version                  ,
    p_init_msg_list                ,
    x_return_status                ,
