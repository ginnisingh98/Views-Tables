--------------------------------------------------------
--  DDL for Package Body BEN_PLAN_GOODS_SERVICES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PLAN_GOODS_SERVICES_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PLAN_GOODS_SERVICES_BK1.CREATE_PLAN_GOODS_SERVICES_A', 10);
hr_utility.set_location(' Leaving: BEN_PLAN_GOODS_SERVICES_BK1.CREATE_PLAN_GOODS_SERVICES_A', 20);
end CREATE_PLAN_GOODS_SERVICES_A;
...
begin
hr_utility.set_location('Entering: BEN_PLAN_GOODS_SERVICES_BK1.CREATE_PLAN_GOODS_SERVICES_B', 10);
hr_utility.set_location(' Leaving: BEN_PLAN_GOODS_SERVICES_BK1.CREATE_PLAN_GOODS_SERVICES_B', 20);
end CREATE_PLAN_GOODS_SERVICES_B;
