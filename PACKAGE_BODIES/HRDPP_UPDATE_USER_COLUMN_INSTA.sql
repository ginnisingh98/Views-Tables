--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_USER_COLUMN_INSTA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_USER_COLUMN_INSTA" as
/*
...
,P_USER_ROW_USER_KEY in varchar2) is
...
c.p7 is null or
c.p1 is null then
L_USER_COLUMN_INSTANCE_ID:=nn;
else
L_USER_COLUMN_INSTANCE_ID := 
PAY_USER_TABLE_DATA_PUMP.get_user_column_instance_id
(P_USER_COLUMN_USER_KEY => c.p6
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_USER_ROW_USER_KEY => c.p7
...
PAY_USER_TABLE_DATA_PUMP.GET_USER_COLUMN_INSTANCE_OVN
(P_USER_COLUMN_USER_KEY => c.p6
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_USER_ROW_USER_KEY => c.p7
,P_EFFECTIVE_DATE => c.p1);
