--------------------------------------------------------
--  DDL for Package Body BEN_CM_TYP_USG_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CM_TYP_USG_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_CM_TYP_USG_BK1.CREATE_CM_TYP_USG_A', 10);
hr_utility.set_location(' Leaving: BEN_CM_TYP_USG_BK1.CREATE_CM_TYP_USG_A', 20);
end CREATE_CM_TYP_USG_A;
...
begin
hr_utility.set_location('Entering: BEN_CM_TYP_USG_BK1.CREATE_CM_TYP_USG_B', 10);
hr_utility.set_location(' Leaving: BEN_CM_TYP_USG_BK1.CREATE_CM_TYP_USG_B', 20);
end CREATE_CM_TYP_USG_B;
