--------------------------------------------------------
--  DDL for Package Body ISC_DBI_REV_BOOK_TREND_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ISC_DBI_REV_BOOK_TREND_PKG" AS
/* $Header: ISCRGBHB.pls 120.0 2005/05/25 17:36:38 appldev noship $ */
...
PROCEDURE GET_SQL(p_param IN BIS_PMV_PAGE_PARAMETER_TBL,x_custom_sql OUT NOCOPY VARCHAR2,
  ...
  l_cust_flag		NUMBER := 0; -- 0 for customer, 1 for cust class, 3 for all
