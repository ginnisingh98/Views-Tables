--------------------------------------------------------
--  DDL for Package Body OKL_TRX_TYPES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TRX_TYPES_PUB_W" as
  /* $Header: OKLUTRYB.pls 120.2 2005/07/20 07:15:46 asawanka noship $ */
  ...
  as
    ddp_tryv_rec okl_trx_types_pub.tryv_rec_type;
    ddx_tryv_rec okl_trx_types_pub.tryv_rec_type;
  ...
  begin
    ...
    okl_trx_types_pub.insert_trx_types(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tryv_tbl okl_trx_types_pub.tryv_tbl_type;
    ddx_tryv_tbl okl_trx_types_pub.tryv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_trx_types(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_types_pub.lock_trx_types(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_types_pub.update_trx_types(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_types_pub.delete_trx_types(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_trx_types(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_types_pub.validate_trx_types(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
