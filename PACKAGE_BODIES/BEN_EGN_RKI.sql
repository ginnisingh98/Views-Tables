--------------------------------------------------------
--  DDL for Package Body BEN_EGN_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EGN_RKI" as
/* $Header: beegnrhi.pkb 120.0 2005/05/28 02:12:39 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_egn_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_egn_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_egn_RKI;
