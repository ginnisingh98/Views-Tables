--------------------------------------------------------
--  DDL for Package Body BEN_LGL_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LGL_RKU" as
/* $Header: belglrhi.pkb 120.0 2005/05/28 03:23:51 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_lgl_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_lgl_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_lgl_RKU;
