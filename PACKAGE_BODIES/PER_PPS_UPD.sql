--------------------------------------------------------
--  DDL for Package Body PER_PPS_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PPS_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_pps_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  per_pps_shd.g_api_dml := true;  -- Set the api dml status
  --
  -- Update the per_parent_spines Row
  --
  update per_parent_spines
    ...
    ,increment_frequency             = p_rec.increment_frequency
    ,increment_period                = p_rec.increment_period
    ,last_automatic_increment_date   = p_rec.last_automatic_increment_date
    ...
    where parent_spine_id = p_rec.parent_spine_id;
  --
  per_pps_shd.g_api_dml := false;   -- Unset the api dml status
  --
...
Begin
  ...
  begin
    ...
    per_pps_rku.after_update
      ...
      => p_rec.increment_frequency
      ,p_increment_period
      => p_rec.increment_period
      ,p_last_automatic_increment_dat
      => p_rec.last_automatic_increment_date
      ,p_request_id
      => p_rec.request_id
      ...
      => per_pps_shd.g_old_rec.business_group_id
      ,p_name_o
      => per_pps_shd.g_old_rec.name
      ,p_comments_o
      => per_pps_shd.g_old_rec.comments
      ,p_increment_frequency_o
      => per_pps_shd.g_old_rec.increment_frequency
      ,p_increment_period_o
      => per_pps_shd.g_old_rec.increment_period
      ,p_last_automatic_increment_d_o
      => per_pps_shd.g_old_rec.last_automatic_increment_date
      ,p_request_id_o
      => per_pps_shd.g_old_rec.request_id
      ,p_program_application_id_o
      => per_pps_shd.g_old_rec.program_application_id
      ,p_program_id_o
      => per_pps_shd.g_old_rec.program_id
      ,p_program_update_date_o
      => per_pps_shd.g_old_rec.program_update_date
      ,p_attribute_category_o
      => per_pps_shd.g_old_rec.attribute_category
      ,p_attribute1_o
      => per_pps_shd.g_old_rec.attribute1
      ,p_attribute2_o
      => per_pps_shd.g_old_rec.attribute2
      ,p_attribute3_o
      => per_pps_shd.g_old_rec.attribute3
      ,p_attribute4_o
      => per_pps_shd.g_old_rec.attribute4
      ,p_attribute5_o
      => per_pps_shd.g_old_rec.attribute5
      ,p_attribute6_o
      => per_pps_shd.g_old_rec.attribute6
      ,p_attribute7_o
      => per_pps_shd.g_old_rec.attribute7
      ,p_attribute8_o
      => per_pps_shd.g_old_rec.attribute8
      ,p_attribute9_o
      => per_pps_shd.g_old_rec.attribute9
      ,p_attribute10_o
      => per_pps_shd.g_old_rec.attribute10
      ,p_attribute11_o
      => per_pps_shd.g_old_rec.attribute11
      ,p_attribute12_o
      => per_pps_shd.g_old_rec.attribute12
      ,p_attribute13_o
      => per_pps_shd.g_old_rec.attribute13
      ,p_attribute14_o
      => per_pps_shd.g_old_rec.attribute14
      ,p_attribute15_o
      => per_pps_shd.g_old_rec.attribute15
      ,p_attribute16_o
      => per_pps_shd.g_old_rec.attribute16
      ,p_attribute17_o
      => per_pps_shd.g_old_rec.attribute17
      ,p_attribute18_o
      => per_pps_shd.g_old_rec.attribute18
      ,p_attribute19_o
      => per_pps_shd.g_old_rec.attribute19
      ,p_attribute20_o
      => per_pps_shd.g_old_rec.attribute20
      ,p_information_category_o
      => per_pps_shd.g_old_rec.information_category
      ,p_information1_o
      => per_pps_shd.g_old_rec.information1
      ,p_information2_o
      => per_pps_shd.g_old_rec.information2
      ,p_information3_o
      => per_pps_shd.g_old_rec.information3
      ,p_information4_o
      => per_pps_shd.g_old_rec.information4
      ,p_information5_o
      => per_pps_shd.g_old_rec.information5
      ,p_information6_o
      => per_pps_shd.g_old_rec.information6
      ,p_information7_o
      => per_pps_shd.g_old_rec.information7
      ,p_information8_o
      => per_pps_shd.g_old_rec.information8
      ,p_information9_o
      => per_pps_shd.g_old_rec.information9
      ,p_information10_o
      => per_pps_shd.g_old_rec.information10
      ,p_information11_o
      => per_pps_shd.g_old_rec.information11
      ,p_information12_o
      => per_pps_shd.g_old_rec.information12
      ,p_information13_o
      => per_pps_shd.g_old_rec.information13
      ,p_information14_o
      => per_pps_shd.g_old_rec.information14
      ,p_information15_o
      => per_pps_shd.g_old_rec.information15
      ,p_information16_o
      => per_pps_shd.g_old_rec.information16
      ,p_information17_o
      => per_pps_shd.g_old_rec.information17
      ,p_information18_o
      => per_pps_shd.g_old_rec.information18
      ,p_information19_o
      => per_pps_shd.g_old_rec.information19
      ,p_information20_o
      => per_pps_shd.g_old_rec.information20
      ,p_information21_o
      => per_pps_shd.g_old_rec.information21
      ,p_information22_o
      => per_pps_shd.g_old_rec.information22
      ,p_information23_o
      => per_pps_shd.g_old_rec.information23
      ,p_information24_o
      => per_pps_shd.g_old_rec.information24
      ,p_information25_o
      => per_pps_shd.g_old_rec.information25
      ,p_information26_o
      => per_pps_shd.g_old_rec.information26
      ,p_information27_o
      => per_pps_shd.g_old_rec.information27
      ,p_information28_o
      => per_pps_shd.g_old_rec.information28
      ,p_information29_o
      => per_pps_shd.g_old_rec.information29
      ,p_information30_o
      => per_pps_shd.g_old_rec.information30
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'PER_PARENT_SPINES'
        ,p_hook_type   => 'AU');
      --
  end;
  --
...
Begin
  ...
  If (p_rec.comments = hr_api.g_varchar2) then
    ...
    per_pps_shd.g_old_rec.comments;
  End If;
  If (p_rec.increment_frequency = hr_api.g_number) then
    p_rec.increment_frequency :=
    per_pps_shd.g_old_rec.increment_frequency;
  End If;
  If (p_rec.increment_period = hr_api.g_varchar2) then
    p_rec.increment_period :=
    per_pps_shd.g_old_rec.increment_period;
  End If;
  If (p_rec.last_automatic_increment_date = hr_api.g_date) then
    p_rec.last_automatic_increment_date :=
    per_pps_shd.g_old_rec.last_automatic_increment_date;
  End If;
...
Begin
  ...
  --
  per_pps_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  per_pps_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  per_pps_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
