--------------------------------------------------------
--  DDL for Package Body HR_PERSON_ADDRESS_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PERSON_ADDRESS_BE2" as 
...
p_add_information20            varchar2) is
  l_event_key number;
  l_event_data clob;
  ...
  --
  l_proc varchar2(72):='  hr_person_address_be2.update_person_address_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.person_address.update_person_address';
