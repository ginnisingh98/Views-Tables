--------------------------------------------------------
--  DDL for Package Body IRC_AGENCY_VACANCIES_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_AGENCY_VACANCIES_BE3" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  irc_agency_vacancies_be3.delete_agency_vacancy_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.agency_vacancies.delete_agency_vacancy';
