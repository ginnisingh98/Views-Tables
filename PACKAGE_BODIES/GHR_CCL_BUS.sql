--------------------------------------------------------
--  DDL for Package Body GHR_CCL_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_CCL_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ghr_ccl_bus.';  -- Global package name
--
-- The following two global variables are only to be
-- used by the return_legislation_code function.
--
g_legislation_code            varchar2(150)  default null;
g_compl_claim_id              number         default null;
--
--  ---------------------------------------------------------------------------
...
Procedure set_security_group_id
  ...
  -- ghr_compl_claims and PER_BUSINESS_GROUPS
  ...
  cursor csr_sec_grp is
    select pbg.security_group_id
      from per_business_groups pbg
         , ghr_compl_claims ccl
      --   , EDIT_HERE table_name(s) 333
     where ccl.compl_claim_id = p_compl_claim_id;
...
Begin
  ...
  --
  if ( nvl(ghr_ccl_bus.g_compl_claim_id, hr_api.g_number)
       = p_compl_claim_id) then
    --
    -- The legislation code has already been found with a previous
    -- call to this function. Just return the value in the global
    -- variable.
    --
    l_legislation_code := ghr_ccl_bus.g_legislation_code;
    ...
    --
    close csr_leg_code;
    ghr_ccl_bus.g_compl_claim_id              := p_compl_claim_id;
    ghr_ccl_bus.g_legislation_code  := l_legislation_code;
  end if;
...
Begin
  ...
  --
  IF NOT ghr_ccl_shd.api_updating
