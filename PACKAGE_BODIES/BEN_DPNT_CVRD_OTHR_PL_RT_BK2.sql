--------------------------------------------------------
--  DDL for Package Body BEN_DPNT_CVRD_OTHR_PL_RT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DPNT_CVRD_OTHR_PL_RT_BK2" as
/* $Header: bedclapi.pkb 115.1 2002/12/23 12:34:51 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_DPNT_CVRD_OTHR_PL_RT_BK2.UPDATE_DPNT_CVRD_OTHR_PL_RT_A', 10);
hr_utility.set_location(' Leaving: BEN_DPNT_CVRD_OTHR_PL_RT_BK2.UPDATE_DPNT_CVRD_OTHR_PL_RT_A', 20);
end UPDATE_DPNT_CVRD_OTHR_PL_RT_A;
...
begin
hr_utility.set_location('Entering: BEN_DPNT_CVRD_OTHR_PL_RT_BK2.UPDATE_DPNT_CVRD_OTHR_PL_RT_B', 10);
hr_utility.set_location(' Leaving: BEN_DPNT_CVRD_OTHR_PL_RT_BK2.UPDATE_DPNT_CVRD_OTHR_PL_RT_B', 20);
end UPDATE_DPNT_CVRD_OTHR_PL_RT_B;
