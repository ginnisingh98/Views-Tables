--------------------------------------------------------
--  DDL for Package Body HXC_HAD_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_HAD_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_had_del.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Delete the hxc_alias_definitions row.
  --
  delete from hxc_alias_definitions
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hxc_had_shd.g_rec_type) is
--
  l_proc  varchar2(72);
--
Begin
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hxc_had_shd.g_rec_type) is
--
  l_proc  varchar2(72);
--
Begin
...
Begin
  ...
  --
  hxc_had_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  hxc_had_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hxc_had_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hxc_had_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
