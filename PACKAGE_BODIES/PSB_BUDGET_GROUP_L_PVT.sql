--------------------------------------------------------
--  DDL for Package Body PSB_BUDGET_GROUP_L_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSB_BUDGET_GROUP_L_PVT" AS
/* $Header: PSBWBGLB.pls 120.2 2005/07/13 11:32:34 shtripat ship $ */
...
BEGIN
    ...
    PSB_Budget_Groups_PVT.LOCK_ROW (
     p_api_version,
     p_init_msg_list,
     p_commit,
     p_validation_level,
