--------------------------------------------------------
--  DDL for Package Body HR_CNP_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_CNP_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_cnp_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Update the hr_canvas_properties Row
  --
  update hr_canvas_properties
    set
     canvas_property_id              = p_rec.canvas_property_id
    ,object_version_number           = p_rec.object_version_number
    ,form_canvas_id                  = p_rec.form_canvas_id
    ,template_canvas_id              = p_rec.template_canvas_id
    ,height                          = p_rec.height
    ...
    where canvas_property_id = p_rec.canvas_property_id;
  --
  --
  --
...
Begin
  ...
  begin
    ...
    hr_cnp_rku.after_update
      ...
      ,p_form_canvas_id_o             => hr_cnp_shd.g_old_rec.form_canvas_id
      ,p_object_version_number_o      => hr_cnp_shd.g_old_rec.object_version_number
      ,p_template_canvas_id_o         => hr_cnp_shd.g_old_rec.template_canvas_id
      ,p_height_o                     => hr_cnp_shd.g_old_rec.height
      ,p_visible_o                    => hr_cnp_shd.g_old_rec.visible
      ,p_width_o                      => hr_cnp_shd.g_old_rec.width
      ,p_x_position_o                 => hr_cnp_shd.g_old_rec.x_position
      ,p_y_position_o                 => hr_cnp_shd.g_old_rec.y_position
      ,p_information_category_o       => hr_cnp_shd.g_old_rec.information_category
      ,p_information1_o               => hr_cnp_shd.g_old_rec.information1
      ,p_information2_o               => hr_cnp_shd.g_old_rec.information2
      ,p_information3_o               => hr_cnp_shd.g_old_rec.information3
      ,p_information4_o               => hr_cnp_shd.g_old_rec.information4
      ,p_information5_o               => hr_cnp_shd.g_old_rec.information5
      ,p_information6_o               => hr_cnp_shd.g_old_rec.information6
      ,p_information7_o               => hr_cnp_shd.g_old_rec.information7
      ,p_information8_o               => hr_cnp_shd.g_old_rec.information8
      ,p_information9_o               => hr_cnp_shd.g_old_rec.information9
      ,p_information10_o              => hr_cnp_shd.g_old_rec.information10
      ,p_information11_o              => hr_cnp_shd.g_old_rec.information11
      ,p_information12_o              => hr_cnp_shd.g_old_rec.information12
      ,p_information13_o              => hr_cnp_shd.g_old_rec.information13
      ,p_information14_o              => hr_cnp_shd.g_old_rec.information14
      ,p_information15_o              => hr_cnp_shd.g_old_rec.information15
      ,p_information16_o              => hr_cnp_shd.g_old_rec.information16
      ,p_information17_o              => hr_cnp_shd.g_old_rec.information17
      ,p_information18_o              => hr_cnp_shd.g_old_rec.information18
      ,p_information19_o              => hr_cnp_shd.g_old_rec.information19
      ,p_information20_o              => hr_cnp_shd.g_old_rec.information20
      ,p_information21_o              => hr_cnp_shd.g_old_rec.information21
      ,p_information22_o              => hr_cnp_shd.g_old_rec.information22
      ,p_information23_o              => hr_cnp_shd.g_old_rec.information23
      ,p_information24_o              => hr_cnp_shd.g_old_rec.information24
      ,p_information25_o              => hr_cnp_shd.g_old_rec.information25
      ,p_information26_o              => hr_cnp_shd.g_old_rec.information26
      ,p_information27_o              => hr_cnp_shd.g_old_rec.information27
      ,p_information28_o              => hr_cnp_shd.g_old_rec.information28
      ,p_information29_o              => hr_cnp_shd.g_old_rec.information29
      ,p_information30_o              => hr_cnp_shd.g_old_rec.information30
      );
    --
  exception
    --
...
Begin
  ...
  If (p_rec.form_canvas_id = hr_api.g_number) then
    p_rec.form_canvas_id := hr_cnp_shd.g_old_rec.form_canvas_id;
  End If;
  If (p_rec.template_canvas_id = hr_api.g_number) then
    p_rec.template_canvas_id := hr_cnp_shd.g_old_rec.template_canvas_id;
  End If;
  If (p_rec.height = hr_api.g_number) then
    p_rec.height := hr_cnp_shd.g_old_rec.height;
  End If;
  If (p_rec.visible = hr_api.g_number) then
    p_rec.visible := hr_cnp_shd.g_old_rec.visible;
  End If;
  If (p_rec.width = hr_api.g_number) then
    p_rec.width := hr_cnp_shd.g_old_rec.width;
  End If;
  If (p_rec.x_position = hr_api.g_number) then
    p_rec.x_position := hr_cnp_shd.g_old_rec.x_position;
  End If;
  If (p_rec.y_position = hr_api.g_number) then
    p_rec.y_position := hr_cnp_shd.g_old_rec.y_position;
  End If;
  If (p_rec.information_category = hr_api.g_varchar2) then
    p_rec.information_category := hr_cnp_shd.g_old_rec.information_category;
  End If;
  If (p_rec.information1 = hr_api.g_varchar2) then
    p_rec.information1 := hr_cnp_shd.g_old_rec.information1;
  End If;
  If (p_rec.information2 = hr_api.g_varchar2) then
    p_rec.information2 := hr_cnp_shd.g_old_rec.information2;
  End If;
  If (p_rec.information3 = hr_api.g_varchar2) then
    p_rec.information3 := hr_cnp_shd.g_old_rec.information3;
  End If;
  If (p_rec.information4 = hr_api.g_varchar2) then
    p_rec.information4 := hr_cnp_shd.g_old_rec.information4;
  End If;
  If (p_rec.information5 = hr_api.g_varchar2) then
    p_rec.information5 := hr_cnp_shd.g_old_rec.information5;
  End If;
  If (p_rec.information6 = hr_api.g_varchar2) then
    p_rec.information6 := hr_cnp_shd.g_old_rec.information6;
  End If;
  If (p_rec.information7 = hr_api.g_varchar2) then
    p_rec.information7 := hr_cnp_shd.g_old_rec.information7;
  End If;
  If (p_rec.information8 = hr_api.g_varchar2) then
    p_rec.information8 := hr_cnp_shd.g_old_rec.information8;
  End If;
  If (p_rec.information9 = hr_api.g_varchar2) then
    p_rec.information9 := hr_cnp_shd.g_old_rec.information9;
  End If;
  If (p_rec.information10 = hr_api.g_varchar2) then
    p_rec.information10 := hr_cnp_shd.g_old_rec.information10;
  End If;
  If (p_rec.information11 = hr_api.g_varchar2) then
    p_rec.information11 := hr_cnp_shd.g_old_rec.information11;
  End If;
  If (p_rec.information12 = hr_api.g_varchar2) then
    p_rec.information12 := hr_cnp_shd.g_old_rec.information12;
  End If;
  If (p_rec.information13 = hr_api.g_varchar2) then
    p_rec.information13 := hr_cnp_shd.g_old_rec.information13;
  End If;
  If (p_rec.information14 = hr_api.g_varchar2) then
    p_rec.information14 := hr_cnp_shd.g_old_rec.information14;
  End If;
  If (p_rec.information15 = hr_api.g_varchar2) then
    p_rec.information15 := hr_cnp_shd.g_old_rec.information15;
  End If;
  If (p_rec.information16 = hr_api.g_varchar2) then
    p_rec.information16 := hr_cnp_shd.g_old_rec.information16;
  End If;
  If (p_rec.information17 = hr_api.g_varchar2) then
    p_rec.information17 := hr_cnp_shd.g_old_rec.information17;
  End If;
  If (p_rec.information18 = hr_api.g_varchar2) then
    p_rec.information18 := hr_cnp_shd.g_old_rec.information18;
  End If;
  If (p_rec.information19 = hr_api.g_varchar2) then
    p_rec.information19 := hr_cnp_shd.g_old_rec.information19;
  End If;
  If (p_rec.information20 = hr_api.g_varchar2) then
    p_rec.information20 := hr_cnp_shd.g_old_rec.information20;
  End If;
  If (p_rec.information21 = hr_api.g_varchar2) then
    p_rec.information21 := hr_cnp_shd.g_old_rec.information21;
  End If;
  If (p_rec.information22 = hr_api.g_varchar2) then
    p_rec.information22 := hr_cnp_shd.g_old_rec.information22;
  End If;
  If (p_rec.information23 = hr_api.g_varchar2) then
    p_rec.information23 := hr_cnp_shd.g_old_rec.information23;
  End If;
  If (p_rec.information24 = hr_api.g_varchar2) then
    p_rec.information24 := hr_cnp_shd.g_old_rec.information24;
  End If;
  If (p_rec.information25 = hr_api.g_varchar2) then
    p_rec.information25 := hr_cnp_shd.g_old_rec.information25;
  End If;
  If (p_rec.information26 = hr_api.g_varchar2) then
    p_rec.information26 := hr_cnp_shd.g_old_rec.information26;
  End If;
  If (p_rec.information27 = hr_api.g_varchar2) then
    p_rec.information27 := hr_cnp_shd.g_old_rec.information27;
  End If;
  If (p_rec.information28 = hr_api.g_varchar2) then
    p_rec.information28 := hr_cnp_shd.g_old_rec.information28;
  End If;
  If (p_rec.information29 = hr_api.g_varchar2) then
    p_rec.information29 := hr_cnp_shd.g_old_rec.information29;
  End If;
  If (p_rec.information30 = hr_api.g_varchar2) then
    p_rec.information30 := hr_cnp_shd.g_old_rec.information30;
  End If;
  --
End convert_defs;
--
...
Begin
  ...
  --
  hr_cnp_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hr_cnp_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hr_cnp_upd.post_update
     (p_effective_date
     ,p_rec
     );
End upd;
