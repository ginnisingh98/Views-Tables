--------------------------------------------------------
--  DDL for Package Body BEN_QIG_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_QIG_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_qig_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  If (p_datetrack_mode = hr_api.g_correction) then
    ...
    --
    --
    -- Update the ben_qua_in_gr_rt_f Row
    --
...
Begin
  ...
  If (p_rec.ordr_num = hr_api.g_number) then
    ...
    ben_qig_shd.g_old_rec.ordr_num;
  End If;
  If (p_rec.qig_attribute_category = hr_api.g_varchar2) then
    p_rec.qig_attribute_category :=
    ben_qig_shd.g_old_rec.qig_attribute_category;
  End If;
  If (p_rec.qig_attribute1 = hr_api.g_varchar2) then
    p_rec.qig_attribute1 :=
    ben_qig_shd.g_old_rec.qig_attribute1;
  End If;
  If (p_rec.qig_attribute2 = hr_api.g_varchar2) then
    p_rec.qig_attribute2 :=
    ben_qig_shd.g_old_rec.qig_attribute2;
  End If;
  If (p_rec.qig_attribute3 = hr_api.g_varchar2) then
    p_rec.qig_attribute3 :=
    ben_qig_shd.g_old_rec.qig_attribute3;
  End If;
  If (p_rec.qig_attribute4 = hr_api.g_varchar2) then
    p_rec.qig_attribute4 :=
    ben_qig_shd.g_old_rec.qig_attribute4;
  End If;
  If (p_rec.qig_attribute5 = hr_api.g_varchar2) then
    p_rec.qig_attribute5 :=
    ben_qig_shd.g_old_rec.qig_attribute5;
  End If;
  If (p_rec.qig_attribute6 = hr_api.g_varchar2) then
    p_rec.qig_attribute6 :=
    ben_qig_shd.g_old_rec.qig_attribute6;
  End If;
  If (p_rec.qig_attribute7 = hr_api.g_varchar2) then
    p_rec.qig_attribute7 :=
    ben_qig_shd.g_old_rec.qig_attribute7;
  End If;
  If (p_rec.qig_attribute8 = hr_api.g_varchar2) then
    p_rec.qig_attribute8 :=
    ben_qig_shd.g_old_rec.qig_attribute8;
  End If;
  If (p_rec.qig_attribute9 = hr_api.g_varchar2) then
    p_rec.qig_attribute9 :=
    ben_qig_shd.g_old_rec.qig_attribute9;
  End If;
  If (p_rec.qig_attribute10 = hr_api.g_varchar2) then
    p_rec.qig_attribute10 :=
    ben_qig_shd.g_old_rec.qig_attribute10;
  End If;
  If (p_rec.qig_attribute11 = hr_api.g_varchar2) then
    p_rec.qig_attribute11 :=
    ben_qig_shd.g_old_rec.qig_attribute11;
  End If;
  If (p_rec.qig_attribute12 = hr_api.g_varchar2) then
    p_rec.qig_attribute12 :=
    ben_qig_shd.g_old_rec.qig_attribute12;
  End If;
  If (p_rec.qig_attribute13 = hr_api.g_varchar2) then
    p_rec.qig_attribute13 :=
    ben_qig_shd.g_old_rec.qig_attribute13;
  End If;
  If (p_rec.qig_attribute14 = hr_api.g_varchar2) then
    p_rec.qig_attribute14 :=
    ben_qig_shd.g_old_rec.qig_attribute14;
  End If;
  If (p_rec.qig_attribute15 = hr_api.g_varchar2) then
    p_rec.qig_attribute15 :=
    ben_qig_shd.g_old_rec.qig_attribute15;
  End If;
  If (p_rec.qig_attribute16 = hr_api.g_varchar2) then
    p_rec.qig_attribute16 :=
    ben_qig_shd.g_old_rec.qig_attribute16;
  End If;
  If (p_rec.qig_attribute17 = hr_api.g_varchar2) then
    p_rec.qig_attribute17 :=
    ben_qig_shd.g_old_rec.qig_attribute17;
  End If;
  If (p_rec.qig_attribute18 = hr_api.g_varchar2) then
    p_rec.qig_attribute18 :=
    ben_qig_shd.g_old_rec.qig_attribute18;
  End If;
  If (p_rec.qig_attribute19 = hr_api.g_varchar2) then
    p_rec.qig_attribute19 :=
    ben_qig_shd.g_old_rec.qig_attribute19;
  End If;
  If (p_rec.qig_attribute20 = hr_api.g_varchar2) then
    p_rec.qig_attribute20 :=
    ben_qig_shd.g_old_rec.qig_attribute20;
  End If;
  If (p_rec.qig_attribute21 = hr_api.g_varchar2) then
    p_rec.qig_attribute21 :=
    ben_qig_shd.g_old_rec.qig_attribute21;
  End If;
  If (p_rec.qig_attribute22 = hr_api.g_varchar2) then
    p_rec.qig_attribute22 :=
    ben_qig_shd.g_old_rec.qig_attribute22;
  End If;
  If (p_rec.qig_attribute23 = hr_api.g_varchar2) then
    p_rec.qig_attribute23 :=
    ben_qig_shd.g_old_rec.qig_attribute23;
  End If;
  If (p_rec.qig_attribute24 = hr_api.g_varchar2) then
    p_rec.qig_attribute24 :=
    ben_qig_shd.g_old_rec.qig_attribute24;
  End If;
  If (p_rec.qig_attribute25 = hr_api.g_varchar2) then
    p_rec.qig_attribute25 :=
    ben_qig_shd.g_old_rec.qig_attribute25;
  End If;
  If (p_rec.qig_attribute26 = hr_api.g_varchar2) then
    p_rec.qig_attribute26 :=
    ben_qig_shd.g_old_rec.qig_attribute26;
  End If;
  If (p_rec.qig_attribute27 = hr_api.g_varchar2) then
    p_rec.qig_attribute27 :=
    ben_qig_shd.g_old_rec.qig_attribute27;
  End If;
  If (p_rec.qig_attribute28 = hr_api.g_varchar2) then
    p_rec.qig_attribute28 :=
    ben_qig_shd.g_old_rec.qig_attribute28;
  End If;
  If (p_rec.qig_attribute29 = hr_api.g_varchar2) then
    p_rec.qig_attribute29 :=
    ben_qig_shd.g_old_rec.qig_attribute29;
  End If;
  If (p_rec.qig_attribute30 = hr_api.g_varchar2) then
    p_rec.qig_attribute30 :=
    ben_qig_shd.g_old_rec.qig_attribute30;
  End If;
  --
...
Begin
  ...
  --
  ben_qig_upd.convert_defs(p_rec);
  --
