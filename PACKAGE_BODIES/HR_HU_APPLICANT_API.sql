--------------------------------------------------------
--  DDL for Package Body HR_HU_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_HU_APPLICANT_API" as
/* $Header: peapphui.pkb 115.0 2004/03/18 01:37:42 vikgupta noship $ */

--   package variables
g_package  varchar2(33) := 'hr_hu_applicant_api.';
