--------------------------------------------------------
--  DDL for Package Body BEN_VRR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_VRR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_vrr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.vrbl_rt_rl_id       = p_rec.vrbl_rt_rl_id
    and    t.effective_start_date =
             ben_vrr_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc        varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_vrbl_rt_rl_f.created_by%TYPE;
  l_creation_date       ben_vrbl_rt_rl_f.creation_date%TYPE;
  l_last_update_date    ben_vrbl_rt_rl_f.last_update_date%TYPE;
  l_last_updated_by     ben_vrbl_rt_rl_f.last_updated_by%TYPE;
  l_last_update_login   ben_vrbl_rt_rl_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_vrbl_rt_rl_f
  --
  insert into ben_vrbl_rt_rl_f
  ( vrbl_rt_rl_id,
...
--
    cursor c1 is
        select BEN_VRBL_RT_RL_F_S.nextval
        from   sys.dual;
--
--
Begin
  ...
  --
   open c1;
   fetch c1 into p_rec.VRBL_RT_RL_id;
   close c1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  dt_api.validate_dt_mode
    (p_effective_date      => p_effective_date,
     ...
     p_parent_key_value2       => p_rec.acty_base_rt_id,
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_vrr_rec
  ...
  --
  p_vrbl_rt_rl_id           := l_rec.vrbl_rt_rl_id;
