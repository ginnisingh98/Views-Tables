--------------------------------------------------------
--  DDL for Package Body OTA_CERT_ENROLLMENT_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CERT_ENROLLMENT_BE1" as 
...
p_enrollment_date              date) is
  ...
  --
  l_proc varchar2(72):='  ota_cert_enrollment_be1.create_cert_enrollment_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.ota.api.cert_enrollment.create_cert_enrollment';
