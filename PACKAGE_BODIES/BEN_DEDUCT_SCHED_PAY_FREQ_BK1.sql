--------------------------------------------------------
--  DDL for Package Body BEN_DEDUCT_SCHED_PAY_FREQ_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DEDUCT_SCHED_PAY_FREQ_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_DEDUCT_SCHED_PAY_FREQ_BK1.CREATE_DEDUCT_SCHED_PAY_FREQ_A', 10);
hr_utility.set_location(' Leaving: BEN_DEDUCT_SCHED_PAY_FREQ_BK1.CREATE_DEDUCT_SCHED_PAY_FREQ_A', 20);
end CREATE_DEDUCT_SCHED_PAY_FREQ_A;
...
begin
hr_utility.set_location('Entering: BEN_DEDUCT_SCHED_PAY_FREQ_BK1.CREATE_DEDUCT_SCHED_PAY_FREQ_B', 10);
hr_utility.set_location(' Leaving: BEN_DEDUCT_SCHED_PAY_FREQ_BK1.CREATE_DEDUCT_SCHED_PAY_FREQ_B', 20);
end CREATE_DEDUCT_SCHED_PAY_FREQ_B;
