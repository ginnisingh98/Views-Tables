--------------------------------------------------------
--  DDL for Package Body HR_ORGANIZATION_BK4
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ORGANIZATION_BK4" as
...
begin
hr_utility.set_location('Entering: HR_ORGANIZATION_BK4.UPDATE_ORGANIZATION_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
hr_organization_be4.UPDATE_ORGANIZATION_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_ORGANIZATION', 'AP');
hr_utility.set_location(' Leaving: HR_ORGANIZATION_BK4.UPDATE_ORGANIZATION_A', 20);
...
l_legislation_code   varchar2(30);
begin
hr_utility.set_location('Entering: HR_ORGANIZATION_BK4.UPDATE_ORGANIZATION_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
...
PER_IN_ORG_INFO_LEG_HOOK.CHECK_ORGANIZATION_UPDATE
(P_EFFECTIVE_DATE => P_EFFECTIVE_DATE
,P_ORGANIZATION_ID => P_ORGANIZATION_ID
,P_NAME => P_NAME
,P_DATE_FROM => P_DATE_FROM
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_ORGANIZATION', 'BP');
hr_utility.set_location(' Leaving: HR_ORGANIZATION_BK4.UPDATE_ORGANIZATION_B', 20);
end UPDATE_ORGANIZATION_B;
