--------------------------------------------------------
--  DDL for Package Body OKL_FE_STD_RATE_TMPL_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_FE_STD_RATE_TMPL_PVT_W" as
  /* $Header: OKLESRTB.pls 120.0 2005/07/07 10:37:59 viselvar noship $ */
  procedure rosetta_table_copy_in_p5(t out nocopy okl_fe_std_rate_tmpl_pvt.okl_number_table, a0 JTF_NUMBER_TABLE) as
  ...
  procedure rosetta_table_copy_out_p5(t okl_fe_std_rate_tmpl_pvt.okl_number_table, a0 out nocopy JTF_NUMBER_TABLE) as
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure rosetta_table_copy_in_p8(t out nocopy okl_fe_std_rate_tmpl_pvt.invalid_object_tbl, a0 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p8(t okl_fe_std_rate_tmpl_pvt.invalid_object_tbl, a0 out nocopy JTF_NUMBER_TABLE
  ...
  as
    ddx_srtv_rec okl_fe_std_rate_tmpl_pvt.okl_srtv_rec;
    ddx_srv_rec okl_fe_std_rate_tmpl_pvt.okl_srv_rec;
    ddx_ech_rec okl_fe_std_rate_tmpl_pvt.okl_ech_rec;
    ddx_ecl_tbl okl_fe_std_rate_tmpl_pvt.okl_ecl_tbl;
    ddx_ecv_tbl okl_fe_std_rate_tmpl_pvt.okl_ecv_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_fe_std_rate_tmpl_pvt.get_version(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_srv_rec okl_fe_std_rate_tmpl_pvt.okl_srv_rec;
    ddx_srv_rec okl_fe_std_rate_tmpl_pvt.okl_srv_rec;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_std_rate_tmpl_pvt.create_version(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_srtv_rec okl_fe_std_rate_tmpl_pvt.okl_srtv_rec;
    ddp_srv_rec okl_fe_std_rate_tmpl_pvt.okl_srv_rec;
    ddx_srtv_rec okl_fe_std_rate_tmpl_pvt.okl_srtv_rec;
    ddx_srv_rec okl_fe_std_rate_tmpl_pvt.okl_srv_rec;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_std_rate_tmpl_pvt.insert_srt(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_std_rate_tmpl_pvt.update_srt(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddx_obj_tbl okl_fe_std_rate_tmpl_pvt.invalid_object_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_std_rate_tmpl_pvt.invalid_objects(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_std_rate_tmpl_pvt.calc_start_date(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure enddate_std_rate_tmpl(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
    , p_srv_id_tbl JTF_NUMBER_TABLE
    , p_end_date  DATE
  )

  as
    ddp_srv_id_tbl okl_fe_std_rate_tmpl_pvt.okl_number_table;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_fe_std_rate_tmpl_pvt_w.rosetta_table_copy_in_p5(ddp_srv_id_tbl, p_srv_id_tbl);


    -- here's the delegated call to the old PL/SQL routine
    okl_fe_std_rate_tmpl_pvt.enddate_std_rate_tmpl(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_fe_std_rate_tmpl_pvt_w;
