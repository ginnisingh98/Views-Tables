--------------------------------------------------------
--  DDL for Package Body IGI_IAC_RXI_O_WRAP_ASSET_BAL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGI_IAC_RXI_O_WRAP_ASSET_BAL" AS
/* $Header: igiiaxbb.pls 120.1.12000000.1 2007/08/01 16:20:00 npandya noship $ */
...
g_path        VARCHAR2(100)  := 'IGI.PLSQL.igiiaxbb.igi_iac_rxi_o_wrap_asset_bal.';
...
--===========================FND_LOG.END=======================================
  ...
  PROCEDURE start_rx_process (
		...
		argument1         IN  VARCHAR2,   -- report short name
		argument2         IN  VARCHAR2,   -- Book Type Code
		argument3         IN  VARCHAR2,   -- Period Counter
		argument4         IN  VARCHAR2,    -- Category Struct Id
		argument5         IN  VARCHAR2,    -- Category Id
		argument6         IN  VARCHAR2  DEFAULT  NULL,  -- Chart Of Accounts
		argument7         IN  VARCHAR2  DEFAULT  NULL,  -- From Cost Center
		argument8         IN  VARCHAR2  DEFAULT  NULL,  -- To Cost Center
		argument9         IN  VARCHAR2  DEFAULT  NULL,  -- From Asset
		argument10        IN  VARCHAR2  DEFAULT  NULL,  -- To Asset
  ...
  l_path 			 VARCHAR2(150) := g_path||'start_rx_process';
  BEGIN
    ...
    igi_iac_rxi_i_wrap_Asset_bal.run_report
		 ( p_reptShrtName		=>	argument1,
			p_bookType		=>	argument2,
			p_period		=>	argument3,
			p_categoryId		=>	argument5,
			p_chartOfAccts		=>	argument6,
			p_from_cc		=>	argument7,
			p_to_cc			=>	argument8,
			p_from_asset_num	=>	argument9,
			p_to_asset_num		=>	argument10,
...
END igi_iac_rxi_o_wrap_asset_bal;
