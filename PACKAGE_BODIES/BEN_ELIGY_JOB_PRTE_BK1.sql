--------------------------------------------------------
--  DDL for Package Body BEN_ELIGY_JOB_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIGY_JOB_PRTE_BK1" as
/* $Header: beejpapi.pkb 120.0 2005/05/28 02:16:59 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_ELIGY_JOB_PRTE_BK1.CREATE_ELIGY_JOB_PRTE_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIGY_JOB_PRTE_BK1.CREATE_ELIGY_JOB_PRTE_A', 20);
end CREATE_ELIGY_JOB_PRTE_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIGY_JOB_PRTE_BK1.CREATE_ELIGY_JOB_PRTE_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIGY_JOB_PRTE_BK1.CREATE_ELIGY_JOB_PRTE_B', 20);
end CREATE_ELIGY_JOB_PRTE_B;
