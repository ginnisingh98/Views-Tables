--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_PRTT_RT_VAL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_PRTT_RT_VAL" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 13:01:11
 * Generated for API: ben_prtt_rt_val_api.DELETE_PRTT_RT_VAL
 */
--
...
(P_PRTT_RT_VAL_USER_KEY => c.p2);
end if;
--
if c.d3=cn then
L_ENRT_RT_ID:=nn;
elsif c.d3 is null then 
L_ENRT_RT_ID:=nh;
else
L_ENRT_RT_ID := 
hr_pump_get.get_enrt_rt_id
(P_ENRT_RT_USER_KEY => c.p3);
end if;
--
