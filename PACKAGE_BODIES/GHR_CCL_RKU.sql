--------------------------------------------------------
--  DDL for Package Body GHR_CCL_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_CCL_RKU" as
...
begin
hr_utility.set_location('Entering: GHR_CCL_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: GHR_CCL_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end GHR_CCL_RKU;
