--------------------------------------------------------
--  DDL for Package Body HR_SE_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SE_APPLICANT_API" AS
 /* $Header: peappsei.pkb 120.0 2005/05/31 05:27 appldev noship $ */


--
g_package  VARCHAR2(33) := 'hr_se_applicant_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_se_applicant >------------------------------|
-- -----------------------------------------------------------------------------
  ...
  --
  l_proc                 VARCHAR2(72) := g_package||'create_se_applicant';
...
begin
  ...
  ,p_per_information_category     => 'SE'
  ,p_per_information1             => p_citizenship
  ,p_per_information2             => p_sun_code
  ,p_per_information3             => p_education_course
  ,p_per_information4             => p_social_security_office
  ,p_per_information5             => p_tfa_insurance
