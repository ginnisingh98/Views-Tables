--------------------------------------------------------
--  DDL for Package Body HR_COMPETENCE_ELEMENT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_COMPETENCE_ELEMENT_BK1" as
...
begin
hr_utility.set_location('Entering: HR_COMPETENCE_ELEMENT_BK1.CREATE_COMPETENCE_ELEMENT_B', 10);
hr_utility.set_location(' Leaving: HR_COMPETENCE_ELEMENT_BK1.CREATE_COMPETENCE_ELEMENT_B', 20);
end CREATE_COMPETENCE_ELEMENT_B;
