--------------------------------------------------------
--  DDL for Package Body CAC_SYNC_TASK_UTL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CAC_SYNC_TASK_UTL" AS
/* $Header: cacvstnb.pls 120.1 2005/06/10 20:20:59 rhshriva noship $ */
/*=======================================================================+
...
*=======================================================================*/
   ...
   FUNCTION is_this_first_task(p_task_id IN NUMBER)
    ...
    BEGIN
        ...
        FETCH c_sync INTO x_sync_id,x_principal_id ;
        ----------------------------------------------------------------------
