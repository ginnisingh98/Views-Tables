--------------------------------------------------------
--  DDL for Package Body JGRX_FAREG_MULTIREPTS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JGRX_FAREG_MULTIREPTS" AS
/* $Header: jgrxfrmb.pls 115.1 2000/08/29 16:20:07 pkm ship   $ */

PROCEDURE get_format(errbuf    OUT VARCHAR2,
                                retcode   OUT NUMBER,
