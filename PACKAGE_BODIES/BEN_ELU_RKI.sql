--------------------------------------------------------
--  DDL for Package Body BEN_ELU_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELU_RKI" as
/* $Header: beelurhi.pkb 120.1 2006/02/27 00:37:05 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_elu_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_elu_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_elu_RKI;
