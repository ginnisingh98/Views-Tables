--------------------------------------------------------
--  DDL for Package Body PAY_ELEMENT_LINK_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ELEMENT_LINK_BK2" as
...
begin
hr_utility.set_location('Entering: PAY_ELEMENT_LINK_BK2.UPDATE_ELEMENT_LINK_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
pay_element_link_be2.UPDATE_ELEMENT_LINK_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_ELEMENT_LINK', 'AP');
hr_utility.set_location(' Leaving: PAY_ELEMENT_LINK_BK2.UPDATE_ELEMENT_LINK_A', 20);
...
begin
hr_utility.set_location('Entering: PAY_ELEMENT_LINK_BK2.UPDATE_ELEMENT_LINK_B', 10);
hr_utility.set_location(' Leaving: PAY_ELEMENT_LINK_BK2.UPDATE_ELEMENT_LINK_B', 20);
end UPDATE_ELEMENT_LINK_B;
