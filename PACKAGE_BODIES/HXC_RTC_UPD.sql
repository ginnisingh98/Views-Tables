--------------------------------------------------------
--  DDL for Package Body HXC_RTC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_RTC_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_rtc_upd.';  -- Global package name
...
Begin
  ...
  --
  -- Update the hxc_retrieval_rule_comps Row
  --
  update hxc_retrieval_rule_comps
    set
     retrieval_rule_comp_id          = p_rec.retrieval_rule_comp_id
...
Begin
  ...
  --
  If (p_rec.retrieval_rule_id = hr_api.g_number) then
    p_rec.retrieval_rule_id :=
    hxc_rtc_shd.g_old_rec.retrieval_rule_id;
  End If;
...
Begin
  ...
  --
  hxc_rtc_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hxc_rtc_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hxc_rtc_upd.post_update
     (p_effective_date
     ,p_rec
     );
End upd;
...
Procedure upd
  ...
  ,p_retrieval_rule_id            in     number    default hr_api.g_number
