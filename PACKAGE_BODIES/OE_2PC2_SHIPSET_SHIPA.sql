--------------------------------------------------------
--  DDL for Package Body OE_2PC2_SHIPSET_SHIPA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC2_SHIPSET_SHIPA" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_status_code varchar2(8) :='NOTIFIED';
   ...
   AND   b.SHIP_SET_ID =  OE_LINE_SECURITY.g_record.SHIP_SET_ID
                    );
