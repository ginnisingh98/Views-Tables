--------------------------------------------------------
--  DDL for Package Body OE_PRICE_ORDER_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_PRICE_ORDER_PVT_W" as
  /* $Header: ONTRPROB.pls 120.0 2005/05/31 22:49:35 appldev noship $ */
  ...
  begin
    ...
    oe_price_order_pvt_w.rosetta_table_copy_in_p3(ddp_line_price_att_tbl, p3_a0
      , p3_a1
      , p3_a2
      , p3_a3
      , p3_a4
