--------------------------------------------------------
--  DDL for Package Body BEN_BENEFIT_ACTIONS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENEFIT_ACTIONS_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_BENEFIT_ACTIONS_BK1.CREATE_BENEFIT_ACTIONS_A', 10);
hr_utility.set_location(' Leaving: BEN_BENEFIT_ACTIONS_BK1.CREATE_BENEFIT_ACTIONS_A', 20);
end CREATE_BENEFIT_ACTIONS_A;
...
begin
hr_utility.set_location('Entering: BEN_BENEFIT_ACTIONS_BK1.CREATE_BENEFIT_ACTIONS_B', 10);
hr_utility.set_location(' Leaving: BEN_BENEFIT_ACTIONS_BK1.CREATE_BENEFIT_ACTIONS_B', 20);
end CREATE_BENEFIT_ACTIONS_B;
