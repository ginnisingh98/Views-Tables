--------------------------------------------------------
--  DDL for Package Body WMS_DATECHECK_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WMS_DATECHECK_PVT" AS
/* $Header: WMSVPPDB.pls 120.1 2005/09/29 00:51:23 amohamme noship $*/
--
