--------------------------------------------------------
--  DDL for Package Body PER_VACANCY_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_VACANCY_BE3" as 
--Code generated on 18/10/2008 04:43:50
...
p_vacancy_id                   number) is
  ...
  --
  l_proc varchar2(72):='  per_vacancy_be3.delete_vacancy_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.vacancy.delete_vacancy';
