--------------------------------------------------------
--  DDL for Package Body PER_CA_PERSON_ADDRESS_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CA_PERSON_ADDRESS_API" as
/* $Header: peaddcai.pkb 115.4 2003/03/18 00:35:46 mmukherj noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  per_ca_person_address_api.';
--
-- ----------------------------------------------------------------------------
...
procedure create_ca_person_address
  ...
  --
  l_proc                varchar2(72) := g_package||'create_ca_person_address';
  --
begin
...
procedure update_ca_person_address
  ...
  -- Declare cursors and local variables
  --
  l_proc                varchar2(72) := g_package||'update_ca_person_address';
...
begin
  hr_utility.set_location('Entering:'|| l_proc, 5);
  --
  -- Check that the Address identified is CA style.
  --
  open  csr_add_style;
  fetch csr_add_style
   into l_style;
