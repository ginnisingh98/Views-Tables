--------------------------------------------------------
--  DDL for Package Body GME_DELETE_BATCH_STEP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_DELETE_BATCH_STEP_PVT" AS
/* $Header: GMEVDBSB.pls 120.3.12010000.1 2008/07/25 10:30:00 appldev ship $ */
