--------------------------------------------------------
--  DDL for Package Body BEN_WV_PRTN_RSN_PTIP_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_WV_PRTN_RSN_PTIP_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_WV_PRTN_RSN_PTIP_BK2.UPDATE_WV_PRTN_RSN_PTIP_A', 10);
hr_utility.set_location(' Leaving: BEN_WV_PRTN_RSN_PTIP_BK2.UPDATE_WV_PRTN_RSN_PTIP_A', 20);
end UPDATE_WV_PRTN_RSN_PTIP_A;
...
begin
hr_utility.set_location('Entering: BEN_WV_PRTN_RSN_PTIP_BK2.UPDATE_WV_PRTN_RSN_PTIP_B', 10);
hr_utility.set_location(' Leaving: BEN_WV_PRTN_RSN_PTIP_BK2.UPDATE_WV_PRTN_RSN_PTIP_B', 20);
end UPDATE_WV_PRTN_RSN_PTIP_B;
