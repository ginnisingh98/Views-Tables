--------------------------------------------------------
--  DDL for Package Body PNRX_C_SPACE_ASSIGN_LEASE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PNRX_C_SPACE_ASSIGN_LEASE" AS
/* $Header: PNRXCLEB.pls 115.4 2002/11/15 19:48:34 stripath ship $ */

PROCEDURE pn_sp_as_lease(
  errbuf            OUT NOCOPY VARCHAR2,
  retcode           OUT NOCOPY VARCHAR2,
  argument1         IN  VARCHAR2,   --lease_number_low
  argument2         IN  VARCHAR2,   --lease_number_high
  argument3         IN  VARCHAR2,   --as_of_date
  argument4         IN  VARCHAR2,   --report_type
