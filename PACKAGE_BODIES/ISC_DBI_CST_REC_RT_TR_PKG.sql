--------------------------------------------------------
--  DDL for Package Body ISC_DBI_CST_REC_RT_TR_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ISC_DBI_CST_REC_RT_TR_PKG" AS
/*$Header: ISCRGBUB.pls 120.1 2006/06/26 06:55:56 abhdixi noship $
    /*----------------------------------------------------
        Declare PRIVATE procedures and functions for package
    -----------------------------------------------------*/
    /* Freight Cost Recovery Rate Trend */
    FUNCTION get_trd_sel_clause(p_view_by_dim IN VARCHAR2)
        RETURN VARCHAR2;


    /*------------------------------------------------
         Freight Cost Recovery Rate Trend Function
    -------------------------------------------------*/
    ...
    BEGIN
        ...
        'SELECT
            ' || ' cal.name VIEWBY,
	nvl(p_freight_cost,0)			ISC_MEASURE_11,
