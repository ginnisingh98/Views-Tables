--------------------------------------------------------
--  DDL for Package Body PQH_CEA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_CEA_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqh_cea_shd.';  -- Global package name
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  If (p_constraint_name = 'PQH_COPY_ENTITY_ATTRIBS_FK1') Then
    hr_utility.set_message(801, 'HR_6153_ALL_PROCEDURE_FAIL');
    hr_utility.set_message_token('PROCEDURE', l_proc);
    hr_utility.set_message_token('STEP','5');
    hr_utility.raise_error;
  ElsIf (p_constraint_name = 'PQH_COPY_ENTITY_ATTRIBS_PK') Then
    hr_utility.set_message(801, 'HR_6153_ALL_PROCEDURE_FAIL');
    hr_utility.set_message_token('PROCEDURE', l_proc);
...
Begin
  ...
  --
  If (
	p_copy_entity_attrib_id is null and
  ...
  Else
    If (
	p_copy_entity_attrib_id = g_old_rec.copy_entity_attrib_id and
...
Exception
  When HR_Api.Object_Locked then
    ...
    hr_utility.set_message_token('TABLE_NAME', 'pqh_copy_entity_attribs');
    hr_utility.raise_error;
End lck;
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  l_rec.row_type_cd                      := p_row_type_cd;
  ...
  l_rec.check_information1               := p_check_information1;
  l_rec.check_information2               := p_check_information2;
  l_rec.check_information3               := p_check_information3;
