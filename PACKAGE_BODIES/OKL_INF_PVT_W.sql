--------------------------------------------------------
--  DDL for Package Body OKL_INF_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_INF_PVT_W" as
  /* $Header: OKLIINFB.pls 120.1 2005/09/16 18:14:31 varao noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_inf_pvt.inf_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).contract_level_yn := a1(indx);
          t(ddindx).object_version_number := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).ilt_id := rosetta_g_miss_num_map(a3(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_inf_pvt.inf_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a27 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := t(ddindx).contract_level_yn;
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).object_version_number);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).ilt_id);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_inf_pvt.oklinvoiceformatstltbltype, a0 JTF_NUMBER_TABLE
    , a1 JTF_VARCHAR2_TABLE_100
  ...
  procedure rosetta_table_copy_out_p5(t okl_inf_pvt.oklinvoiceformatstltbltype, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_VARCHAR2_TABLE_100
  ...
  procedure rosetta_table_copy_in_p8(t out nocopy okl_inf_pvt.infv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ilt_id := rosetta_g_miss_num_map(a2(indx));
          ...
          t(ddindx).contract_level_yn := a7(indx);
  ...
  procedure rosetta_table_copy_out_p8(t okl_inf_pvt.infv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a30 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).ilt_id);
          ...
          a7(indx) := t(ddindx).contract_level_yn;
  ...
  as
    ddp_infv_rec okl_inf_pvt.infv_rec_type;
    ddx_infv_rec okl_inf_pvt.infv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_inf_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_infv_tbl okl_inf_pvt.infv_tbl_type;
    ddx_infv_tbl okl_inf_pvt.infv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_inf_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_inf_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_inf_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_inf_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
