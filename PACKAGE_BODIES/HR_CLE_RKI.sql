--------------------------------------------------------
--  DDL for Package Body HR_CLE_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_CLE_RKI" as
...
begin
hr_utility.set_location('Entering: HR_CLE_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: HR_CLE_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end HR_CLE_RKI;
