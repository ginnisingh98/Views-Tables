--------------------------------------------------------
--  DDL for Package Body OTA_CERT_MBR_ENROLLMENT_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CERT_MBR_ENROLLMENT_SWI" As
/* $Header: otcmeswi.pkb 120.0 2005/06/03 08:32 appldev noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'ota_cert_mbr_enrollment_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_cert_mbr_enrollment_swi;
  --
  ...
  --
  ota_cme_ins.set_base_key_value
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_cert_mbr_enrollment_swi;
    --
...
PROCEDURE update_cert_mbr_enrollment
  ...
  --
  -- Other variables
  l_proc    varchar2(72) := g_package ||'update_cert_mbr_enrollment';
Begin
  hr_utility.set_location(' Entering:' || l_proc,10);
  --
  -- Issue a savepoint
  --
  savepoint update_cert_mbr_enrollment_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_cert_mbr_enrollment_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_cert_mbr_enrollment_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  ota_cert_mbr_enrollment_api.delete_cert_mbr_enrollment
    (p_cert_mbr_enrollment_id       => p_cert_mbr_enrollment_id
    ,p_object_version_number        => p_object_version_number
    ,p_validate                     => l_validate
    );
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_cert_mbr_enrollment_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
