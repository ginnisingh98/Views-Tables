--------------------------------------------------------
--  DDL for Package Body PER_ABB_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ABB_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_abb_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Update the per_absence_attendance_types Row
  --
  update per_absence_attendance_types
    ...
    ,hours_or_days                   = p_rec.hours_or_days
    ,increasing_or_decreasing_flag   = p_rec.increasing_or_decreasing_flag
    ...
    ,user_role                       = p_rec.user_role
    ,assignment_status_type_id       = p_rec.assignment_status_type_id
    ,advance_pay                     = p_rec.advance_pay
    ,absence_overlap_flag            = p_rec.absence_overlap_flag
    where absence_attendance_type_id = p_rec.absence_attendance_type_id;
  --
...
Begin
  ...
  begin
    ...
    per_abb_rku.after_update
      ...
      => per_abb_shd.g_old_rec.business_group_id
      ,p_input_value_id_o
      => per_abb_shd.g_old_rec.input_value_id
      ,p_date_effective_o
      => per_abb_shd.g_old_rec.date_effective
      ,p_name_o
      => per_abb_shd.g_old_rec.name
      ,p_absence_category_o
      => per_abb_shd.g_old_rec.absence_category
      ,p_comments_o
      => per_abb_shd.g_old_rec.comments
      ,p_date_end_o
      => per_abb_shd.g_old_rec.date_end
      ,p_hours_or_days_o
      => per_abb_shd.g_old_rec.hours_or_days
      ,p_inc_or_dec_flag_o
      => per_abb_shd.g_old_rec.increasing_or_decreasing_flag
      ,p_request_id_o
      => per_abb_shd.g_old_rec.request_id
      ,p_program_application_id_o
      => per_abb_shd.g_old_rec.program_application_id
      ,p_program_id_o
      => per_abb_shd.g_old_rec.program_id
      ,p_program_update_date_o
      => per_abb_shd.g_old_rec.program_update_date
      ,p_attribute_category_o
      => per_abb_shd.g_old_rec.attribute_category
      ,p_attribute1_o
      => per_abb_shd.g_old_rec.attribute1
      ,p_attribute2_o
      => per_abb_shd.g_old_rec.attribute2
      ,p_attribute3_o
      => per_abb_shd.g_old_rec.attribute3
      ,p_attribute4_o
      => per_abb_shd.g_old_rec.attribute4
      ,p_attribute5_o
      => per_abb_shd.g_old_rec.attribute5
      ,p_attribute6_o
      => per_abb_shd.g_old_rec.attribute6
      ,p_attribute7_o
      => per_abb_shd.g_old_rec.attribute7
      ,p_attribute8_o
      => per_abb_shd.g_old_rec.attribute8
      ,p_attribute9_o
      => per_abb_shd.g_old_rec.attribute9
      ,p_attribute10_o
      => per_abb_shd.g_old_rec.attribute10
      ,p_attribute11_o
      => per_abb_shd.g_old_rec.attribute11
      ,p_attribute12_o
      => per_abb_shd.g_old_rec.attribute12
      ,p_attribute13_o
      => per_abb_shd.g_old_rec.attribute13
      ,p_attribute14_o
      => per_abb_shd.g_old_rec.attribute14
      ,p_attribute15_o
      => per_abb_shd.g_old_rec.attribute15
      ,p_attribute16_o
      => per_abb_shd.g_old_rec.attribute16
      ,p_attribute17_o
      => per_abb_shd.g_old_rec.attribute17
      ,p_attribute18_o
      => per_abb_shd.g_old_rec.attribute18
      ,p_attribute19_o
      => per_abb_shd.g_old_rec.attribute19
      ,p_attribute20_o
      => per_abb_shd.g_old_rec.attribute20
      ,p_object_version_number_o
      => per_abb_shd.g_old_rec.object_version_number
      ,p_information_category_o
      => per_abb_shd.g_old_rec.information_category
      ,p_information1_o
      => per_abb_shd.g_old_rec.information1
      ,p_information2_o
      => per_abb_shd.g_old_rec.information2
      ,p_information3_o
      => per_abb_shd.g_old_rec.information3
      ,p_information4_o
      => per_abb_shd.g_old_rec.information4
      ,p_information5_o
      => per_abb_shd.g_old_rec.information5
      ,p_information6_o
      => per_abb_shd.g_old_rec.information6
      ,p_information7_o
      => per_abb_shd.g_old_rec.information7
      ,p_information8_o
      => per_abb_shd.g_old_rec.information8
      ,p_information9_o
      => per_abb_shd.g_old_rec.information9
      ,p_information10_o
      => per_abb_shd.g_old_rec.information10
      ,p_information11_o
      => per_abb_shd.g_old_rec.information11
      ,p_information12_o
      => per_abb_shd.g_old_rec.information12
      ,p_information13_o
      => per_abb_shd.g_old_rec.information13
      ,p_information14_o
      => per_abb_shd.g_old_rec.information14
      ,p_information15_o
      => per_abb_shd.g_old_rec.information15
      ,p_information16_o
      => per_abb_shd.g_old_rec.information16
      ,p_information17_o
      => per_abb_shd.g_old_rec.information17
      ,p_information18_o
      => per_abb_shd.g_old_rec.information18
      ,p_information19_o
      => per_abb_shd.g_old_rec.information19
      ,p_information20_o
      => per_abb_shd.g_old_rec.information20
      --
         ,p_user_role_o
      => per_abb_shd.g_old_rec.user_role
         ,p_assignment_status_type_id_o
      => per_abb_shd.g_old_rec.assignment_status_type_id
         ,p_advance_pay_o
      => per_abb_shd.g_old_rec.advance_pay
         ,p_absence_overlap_flag_o
      => p_rec.absence_overlap_flag
      --
      );
    --
...
Begin
  ...
  If (p_rec.comments = hr_api.g_varchar2) then
    ...
    per_abb_shd.g_old_rec.comments;
  End If;
  If (p_rec.hours_or_days = hr_api.g_varchar2) then
    p_rec.hours_or_days :=
    per_abb_shd.g_old_rec.hours_or_days;
  End If;
  If (p_rec.increasing_or_decreasing_flag = hr_api.g_varchar2) then
    p_rec.increasing_or_decreasing_flag :=
    per_abb_shd.g_old_rec.increasing_or_decreasing_flag;
  End If;
  ...
  End If;
  --
    If (p_rec.user_role = hr_api.g_varchar2) then
      p_rec.user_role :=
      per_abb_shd.g_old_rec.user_role;
  End If;
    If (p_rec.assignment_status_type_id = hr_api.g_number) then
      ...
      per_abb_shd.g_old_rec.assignment_status_type_id;
  End If;
    If (p_rec.advance_pay = hr_api.g_varchar2) then
      p_rec.advance_pay :=
      per_abb_shd.g_old_rec.advance_pay;
  End If;
  If (p_rec.absence_overlap_flag = hr_api.g_varchar2) then
        p_rec.absence_overlap_flag :=
        per_abb_shd.g_old_rec.absence_overlap_flag;
  End If;
  --
  --
End convert_defs;
...
Begin
  ...
  --
  per_abb_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  per_abb_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  per_abb_upd.post_update
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
