--------------------------------------------------------
--  DDL for Package Body PER_PDP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PDP_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_pdp_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PER_PERIODS_OF_PLACEMENT_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PER_PERIODS_OF_PLACEMENT_UK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Function api_updating
  ...
  Cursor C_Sel1 is
    ...
    where       period_of_placement_id = p_period_of_placement_id;
  --
  l_fct_ret     boolean;
  --
Begin
  ...
  If (p_object_version_number is null and
      p_period_of_placement_id is null
     ) Then
    --
  ...
  Else
    If (p_object_version_number
        = per_pdp_shd.g_old_rec.object_version_number and
        p_period_of_placement_id
        = per_pdp_shd.g_old_rec.period_of_placement_id
       ) Then
      --
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_pdp_shd.g_old_rec;
      ...
      Close C_Sel1;
      If (p_object_version_number
          <> per_pdp_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  l_rec.period_of_placement_id           := p_period_of_placement_id;
