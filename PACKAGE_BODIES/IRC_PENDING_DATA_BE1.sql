--------------------------------------------------------
--  DDL for Package Body IRC_PENDING_DATA_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_PENDING_DATA_BE1" as 
...
p_security_group_key           varchar2) is
  ...
  --
  l_proc varchar2(72):='  irc_pending_data_be1.create_pending_data_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.pending_data.create_pending_data';
