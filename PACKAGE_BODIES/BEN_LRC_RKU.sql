--------------------------------------------------------
--  DDL for Package Body BEN_LRC_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LRC_RKU" as
...
begin
hr_utility.set_location('Entering: ben_lrc_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_lrc_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_lrc_RKU;
