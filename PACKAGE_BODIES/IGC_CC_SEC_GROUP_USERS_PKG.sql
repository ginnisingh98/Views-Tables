--------------------------------------------------------
--  DDL for Package Body IGC_CC_SEC_GROUP_USERS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGC_CC_SEC_GROUP_USERS_PKG" as
/* $Header: IGCCSCUB.pls 120.6.12000000.1 2007/08/20 12:14:45 mbremkum ship $ */

  G_PKG_NAME CONSTANT VARCHAR2(30):= 'IGC_CC_SEC_GROUP_USERS_PKG';
