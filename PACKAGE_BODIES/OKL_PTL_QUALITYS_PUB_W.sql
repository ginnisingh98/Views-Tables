--------------------------------------------------------
--  DDL for Package Body OKL_PTL_QUALITYS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PTL_QUALITYS_PUB_W" as
  /* $Header: OKLUPTQB.pls 115.4 2002/12/24 04:17:16 sgorantl noship $ */
  ...
  as
    ddp_ptqv_rec okl_ptl_qualitys_pub.ptqv_rec_type;
    ddp_ptvv_tbl okl_ptl_qualitys_pub.ptvv_tbl_type;
    ddx_ptqv_rec okl_ptl_qualitys_pub.ptqv_rec_type;
    ddx_ptvv_tbl okl_ptl_qualitys_pub.ptvv_tbl_type;
  ...
  begin
    ...
    okl_ptl_qualitys_pub.create_ptl_qualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptl_qualitys_pub.update_ptl_qualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptl_qualitys_pub.validate_ptl_qualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ptqv_tbl okl_ptl_qualitys_pub.ptqv_tbl_type;
    ddx_ptqv_tbl okl_ptl_qualitys_pub.ptqv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptl_qualitys_pub.lock_ptl_qualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptl_qualitys_pub.delete_ptl_qualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptl_qualitys_pub.create_ptl_qlty_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ptvv_rec okl_ptl_qualitys_pub.ptvv_rec_type;
    ddx_ptvv_rec okl_ptl_qualitys_pub.ptvv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptl_qualitys_pub.lock_ptl_qlty_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptl_qualitys_pub.update_ptl_qlty_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptl_qualitys_pub.delete_ptl_qlty_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptl_qualitys_pub.validate_ptl_qlty_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
