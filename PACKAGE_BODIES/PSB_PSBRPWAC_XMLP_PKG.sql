--------------------------------------------------------
--  DDL for Package Body PSB_PSBRPWAC_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSB_PSBRPWAC_XMLP_PKG" AS
/* $Header: PSBRPWACB.pls 120.0 2008/01/07 10:51:30 vijranga noship $ */
  ...
  BEGIN
    ...
    ELSE
      SELECT
        NAME,
        BUDGET_CALENDAR_ID
      INTO CP_PARAM_WS_NAME,L_CALENDAR_ID
      FROM
        PSB_WORKSHEETS
  ...
  EXCEPTION
	...
	/*RAISE_APPLICATION_ERROR(-20101,'errorcode = '|| err || 'SQLERRM '||SQLERRM);*/
    RETURN (FALSE);
