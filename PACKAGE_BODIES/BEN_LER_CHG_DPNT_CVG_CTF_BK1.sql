--------------------------------------------------------
--  DDL for Package Body BEN_LER_CHG_DPNT_CVG_CTF_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LER_CHG_DPNT_CVG_CTF_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_LER_CHG_DPNT_CVG_CTF_BK1.CREATE_LER_CHG_DPNT_CVG_CTF_A', 10);
hr_utility.set_location(' Leaving: BEN_LER_CHG_DPNT_CVG_CTF_BK1.CREATE_LER_CHG_DPNT_CVG_CTF_A', 20);
end CREATE_LER_CHG_DPNT_CVG_CTF_A;
...
begin
hr_utility.set_location('Entering: BEN_LER_CHG_DPNT_CVG_CTF_BK1.CREATE_LER_CHG_DPNT_CVG_CTF_B', 10);
hr_utility.set_location(' Leaving: BEN_LER_CHG_DPNT_CVG_CTF_BK1.CREATE_LER_CHG_DPNT_CVG_CTF_B', 20);
end CREATE_LER_CHG_DPNT_CVG_CTF_B;
