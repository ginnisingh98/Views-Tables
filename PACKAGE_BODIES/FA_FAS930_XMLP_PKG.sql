--------------------------------------------------------
--  DDL for Package Body FA_FAS930_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FAS930_XMLP_PKG" AS
/* $Header: FAS930B.pls 120.0.12010000.1 2008/07/28 13:16:06 appldev ship $ */
function report_nameformula(Company_Name in varchar2, CURRENCY_CODE in varchar2) return varchar2 is
begin
DECLARE
...
BEGIN
  ...
  RP_CURRENCY_CODE := CURRENCY_CODE;
...
EXCEPTION
  WHEN OTHERS THEN
    RP_Report_Name := ':Leased Assets Report:';
...
--Functions to refer Oracle report placeholders--
 ...
 Function RP_BAL_LPROMPT_p(ACCT_BAL_LPROMPT varchar2)return varchar2 is
	...
	RP_BAL_LPROMPT:= ACCT_BAL_LPROMPT;
	 ...
	 END;
 Function RP_CAT_LPROMPT_p return varchar2 is
	Begin
	 return RP_CAT_LPROMPT;
	 END;
