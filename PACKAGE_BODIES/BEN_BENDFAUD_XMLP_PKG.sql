--------------------------------------------------------
--  DDL for Package Body BEN_BENDFAUD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENDFAUD_XMLP_PKG" AS
/* $Header: BENDFAUDB.pls 120.1 2007/12/10 08:29:55 vjaganat noship $ */
...
function CF_STANDARD_HEADERFormula return Number is
  ...
  l_location                   hr_locations.description%type ;
  l_audit_log                  hr_lookups.meaning%type ;
  l_benft_group                ben_benfts_grp.name%type ;
  l_all			       varchar2(80);
 begin
  ...
  CP_BENEFIT_GROUP              := l_benft_group;
