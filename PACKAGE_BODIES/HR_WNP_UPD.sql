--------------------------------------------------------
--  DDL for Package Body HR_WNP_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_WNP_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_wnp_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure update_dml
  (p_rec in out nocopy hr_wnp_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Update the hr_window_properties_b Row
  --
  update hr_window_properties_b
    set
     window_property_id              = p_rec.window_property_id
    ,form_window_id                  = p_rec.form_window_id
    ,template_window_id              = p_rec.template_window_id
    ,height                          = p_rec.height
    ,width                           = p_rec.width
    ...
    where window_property_id = p_rec.window_property_id;
  --
  --
  --
...
Begin
  ...
  begin
    --
    hr_wnp_rku.after_update
      (p_window_property_id
      => p_rec.window_property_id
      ,p_form_window_id
      => p_rec.form_window_id
      ,p_template_window_id
      => p_rec.template_window_id
      ,p_height
      => p_rec.height
      ,p_width
      => p_rec.width
      ...
      => p_rec.information30
      ,p_form_window_id_o
      => hr_wnp_shd.g_old_rec.form_window_id
      ,p_template_window_id_o
      => hr_wnp_shd.g_old_rec.template_window_id
      ,p_height_o
      => hr_wnp_shd.g_old_rec.height
      ,p_width_o
      => hr_wnp_shd.g_old_rec.width
      ,p_x_position_o
      => hr_wnp_shd.g_old_rec.x_position
      ,p_y_position_o
      => hr_wnp_shd.g_old_rec.y_position
      ,p_information_category_o
      => hr_wnp_shd.g_old_rec.information_category
      ,p_information1_o
      => hr_wnp_shd.g_old_rec.information1
      ,p_information2_o
      => hr_wnp_shd.g_old_rec.information2
      ,p_information3_o
      => hr_wnp_shd.g_old_rec.information3
      ,p_information4_o
      => hr_wnp_shd.g_old_rec.information4
      ,p_information5_o
      => hr_wnp_shd.g_old_rec.information5
      ,p_information6_o
      => hr_wnp_shd.g_old_rec.information6
      ,p_information7_o
      => hr_wnp_shd.g_old_rec.information7
      ,p_information8_o
      => hr_wnp_shd.g_old_rec.information8
      ,p_information9_o
      => hr_wnp_shd.g_old_rec.information9
      ,p_information10_o
      => hr_wnp_shd.g_old_rec.information10
      ,p_information11_o
      => hr_wnp_shd.g_old_rec.information11
      ,p_information12_o
      => hr_wnp_shd.g_old_rec.information12
      ,p_information13_o
      => hr_wnp_shd.g_old_rec.information13
      ,p_information14_o
      => hr_wnp_shd.g_old_rec.information14
      ,p_information15_o
      => hr_wnp_shd.g_old_rec.information15
      ,p_information16_o
      => hr_wnp_shd.g_old_rec.information16
      ,p_information17_o
      => hr_wnp_shd.g_old_rec.information17
      ,p_information18_o
      => hr_wnp_shd.g_old_rec.information18
      ,p_information19_o
      => hr_wnp_shd.g_old_rec.information19
      ,p_information20_o
      => hr_wnp_shd.g_old_rec.information20
      ,p_information21_o
      => hr_wnp_shd.g_old_rec.information21
      ,p_information22_o
      => hr_wnp_shd.g_old_rec.information22
      ,p_information23_o
      => hr_wnp_shd.g_old_rec.information23
      ,p_information24_o
      => hr_wnp_shd.g_old_rec.information24
      ,p_information25_o
      => hr_wnp_shd.g_old_rec.information25
      ,p_information26_o
      => hr_wnp_shd.g_old_rec.information26
      ,p_information27_o
      => hr_wnp_shd.g_old_rec.information27
      ,p_information28_o
      => hr_wnp_shd.g_old_rec.information28
      ,p_information29_o
      => hr_wnp_shd.g_old_rec.information29
      ,p_information30_o
      => hr_wnp_shd.g_old_rec.information30
      );
    --
  exception
    --
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'HR_WINDOW_PROPERTIES_B'
        ,p_hook_type   => 'AU');
      --
  end;
  --
...
Begin
  ...
  --
  If (p_rec.form_window_id = hr_api.g_number) then
    p_rec.form_window_id :=
    hr_wnp_shd.g_old_rec.form_window_id;
  End If;
  If (p_rec.template_window_id = hr_api.g_number) then
    p_rec.template_window_id :=
    hr_wnp_shd.g_old_rec.template_window_id;
  End If;
...
Begin
  ...
  --
  convert_defs(p_rec);
  hr_wnp_bus.update_validate
     (p_rec
     );
  --
  -- Call the supporting pre-update operation
  --
  hr_wnp_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hr_wnp_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hr_wnp_upd.post_update
     (p_rec
     );
End upd;
--
...
Procedure upd
  ...
  ,p_form_window_id               in     number    default hr_api.g_number
  ,p_template_window_id           in     number    default hr_api.g_number
