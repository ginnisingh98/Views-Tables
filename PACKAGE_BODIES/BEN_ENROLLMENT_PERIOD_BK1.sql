--------------------------------------------------------
--  DDL for Package Body BEN_ENROLLMENT_PERIOD_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ENROLLMENT_PERIOD_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_ENROLLMENT_PERIOD_BK1.CREATE_ENROLLMENT_PERIOD_A', 10);
hr_utility.set_location(' Leaving: BEN_ENROLLMENT_PERIOD_BK1.CREATE_ENROLLMENT_PERIOD_A', 20);
end CREATE_ENROLLMENT_PERIOD_A;
...
begin
hr_utility.set_location('Entering: BEN_ENROLLMENT_PERIOD_BK1.CREATE_ENROLLMENT_PERIOD_B', 10);
hr_utility.set_location(' Leaving: BEN_ENROLLMENT_PERIOD_BK1.CREATE_ENROLLMENT_PERIOD_B', 20);
end CREATE_ENROLLMENT_PERIOD_B;
