--------------------------------------------------------
--  DDL for Package Body FA_FAS400_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FAS400_XMLP_PKG" AS
/* $Header: FAS400B.pls 120.0.12010000.1 2008/07/28 13:14:08 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    RETURN(':Journal Entry Reserve Ledger:');
END;
RETURN NULL; end;
...
END;
RETURN NULL; end;
function ACCT_CC_APROMPTFormula return VARCHAR2 is
begin
/*srw.reference(acct_cc_lprompt);*/null;
RETURN NULL; end;
function Period_ClosedFormula return VARCHAR2 is
begin
/*srw.reference(period1);*/null;
RETURN NULL; end;
function Currency_CodeFormula return VARCHAR2 is
begin
