--------------------------------------------------------
--  DDL for Package Body IGS_AD_PANEL_MEMBRS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AD_PANEL_MEMBRS_PKG" AS
/* $Header: IGSAIG8B.pls 115.2 2003/06/23 06:59:30 akadam noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_ad_panel_membrs%ROWTYPE;
  new_references igs_ad_panel_membrs%ROWTYPE;
  ...
  /*
  ||  Created By : Amit Kadam Amit Kadam
  ...
  */
  ...
  BEGIN
    ...
    new_references.panel_seq_num                     := x_panel_seq_num;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_AD_INTVWPNL_PLNMEMBR_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGS_AD_PANEL_MEMBRS_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    before_dml(
      ...
      x_panel_seq_num                     => x_panel_seq_num,
    ...
    INSERT INTO igs_ad_panel_membrs (
      panel_code,
      member_person_id,
      panel_seq_num,
      role_type_code,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ((tlinfo.panel_seq_num = x_panel_seq_num) OR ((tlinfo.panel_seq_num IS NULL) AND (X_panel_seq_num IS NULL)))
        AND (tlinfo.role_type_code = x_role_type_code)
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGS_AD_PANEL_MEMBRS_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    UPDATE igs_ad_panel_membrs
      SET
        panel_seq_num                     = new_references.panel_seq_num,
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_ad_panel_membrs
    WHERE rowid = x_rowid;
