--------------------------------------------------------
--  DDL for Package Body HR_DK_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DK_APPLICANT_API" AS
 /* $Header: peappdki.pkb 120.2 2005/10/18 22:32 saurai noship $ */


--
g_package  VARCHAR2(33) := 'hr_dk_applicant_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_dk_applicant >------------------------------|
-- -----------------------------------------------------------------------------
  ...
  --
  l_proc                 VARCHAR2(72) := g_package||'create_dk_applicant';
