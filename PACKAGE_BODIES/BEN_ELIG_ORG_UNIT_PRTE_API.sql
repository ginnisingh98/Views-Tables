--------------------------------------------------------
--  DDL for Package Body BEN_ELIG_ORG_UNIT_PRTE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIG_ORG_UNIT_PRTE_API" as
/* $Header: beeouapi.pkb 120.0 2005/05/28 02:33:13 appldev noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_ELIG_ORG_UNIT_PRTE_api.';
--
-- ----------------------------------------------------------------------------
...
procedure create_ELIG_ORG_UNIT_PRTE
  ...
  --
  l_elig_org_unit_prte_id ben_elig_org_unit_prte_f.elig_org_unit_prte_id%TYPE;
  ...
  l_proc varchar2(72) := g_package||'create_ELIG_ORG_UNIT_PRTE';
...
begin
  ...
  --
  savepoint create_ELIG_ORG_UNIT_PRTE;
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_ELIG_ORG_UNIT_PRTE
    --
    ben_ELIG_ORG_UNIT_PRTE_bk1.create_ELIG_ORG_UNIT_PRTE_b
      (
      ...
      ,p_eou_attribute_category         =>  p_eou_attribute_category
      ,p_eou_attribute1                 =>  p_eou_attribute1
      ,p_eou_attribute2                 =>  p_eou_attribute2
      ,p_eou_attribute3                 =>  p_eou_attribute3
      ,p_eou_attribute4                 =>  p_eou_attribute4
      ,p_eou_attribute5                 =>  p_eou_attribute5
      ,p_eou_attribute6                 =>  p_eou_attribute6
      ,p_eou_attribute7                 =>  p_eou_attribute7
      ,p_eou_attribute8                 =>  p_eou_attribute8
      ,p_eou_attribute9                 =>  p_eou_attribute9
      ,p_eou_attribute10                =>  p_eou_attribute10
      ,p_eou_attribute11                =>  p_eou_attribute11
      ,p_eou_attribute12                =>  p_eou_attribute12
      ,p_eou_attribute13                =>  p_eou_attribute13
      ,p_eou_attribute14                =>  p_eou_attribute14
      ,p_eou_attribute15                =>  p_eou_attribute15
      ,p_eou_attribute16                =>  p_eou_attribute16
      ,p_eou_attribute17                =>  p_eou_attribute17
      ,p_eou_attribute18                =>  p_eou_attribute18
      ,p_eou_attribute19                =>  p_eou_attribute19
      ,p_eou_attribute20                =>  p_eou_attribute20
      ,p_eou_attribute21                =>  p_eou_attribute21
      ,p_eou_attribute22                =>  p_eou_attribute22
      ,p_eou_attribute23                =>  p_eou_attribute23
      ,p_eou_attribute24                =>  p_eou_attribute24
      ,p_eou_attribute25                =>  p_eou_attribute25
      ,p_eou_attribute26                =>  p_eou_attribute26
      ,p_eou_attribute27                =>  p_eou_attribute27
      ,p_eou_attribute28                =>  p_eou_attribute28
      ,p_eou_attribute29                =>  p_eou_attribute29
      ,p_eou_attribute30                =>  p_eou_attribute30
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_ELIG_ORG_UNIT_PRTE'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_ELIG_ORG_UNIT_PRTE
    --
  end;
  --
  ben_eou_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_ELIG_ORG_UNIT_PRTE
    --
    ben_ELIG_ORG_UNIT_PRTE_bk1.create_ELIG_ORG_UNIT_PRTE_a
      (
       p_elig_org_unit_prte_id          =>  l_elig_org_unit_prte_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_ELIG_ORG_UNIT_PRTE
    --
  end;
  --
  ben_profile_handler.event_handler
    (p_event                       => 'CREATE',
     ...
     p_base_table_reference_column => 'ELIG_ORG_UNIT_FLAG',
     p_reference_table             => 'BEN_ELIG_ORG_UNIT_PRTE_F',
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_ELIG_ORG_UNIT_PRTE;
    --
...
procedure update_ELIG_ORG_UNIT_PRTE
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_ELIG_ORG_UNIT_PRTE';
  l_object_version_number ben_elig_org_unit_prte_f.object_version_number%TYPE;
  l_effective_start_date ben_elig_org_unit_prte_f.effective_start_date%TYPE;
  l_effective_end_date ben_elig_org_unit_prte_f.effective_end_date%TYPE;
  --
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_ELIG_ORG_UNIT_PRTE;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_ELIG_ORG_UNIT_PRTE
    --
    ben_ELIG_ORG_UNIT_PRTE_bk2.update_ELIG_ORG_UNIT_PRTE_b
      (
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_ELIG_ORG_UNIT_PRTE'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_ELIG_ORG_UNIT_PRTE
    --
  end;
  --
  ben_eou_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_ELIG_ORG_UNIT_PRTE
    --
    ben_ELIG_ORG_UNIT_PRTE_bk2.update_ELIG_ORG_UNIT_PRTE_a
      (
       p_elig_org_unit_prte_id          =>  p_elig_org_unit_prte_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_ELIG_ORG_UNIT_PRTE
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO update_ELIG_ORG_UNIT_PRTE;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint delete_ELIG_ORG_UNIT_PRTE;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_ELIG_ORG_UNIT_PRTE
    --
    ben_ELIG_ORG_UNIT_PRTE_bk3.delete_ELIG_ORG_UNIT_PRTE_b
      (
       p_elig_org_unit_prte_id          =>  p_elig_org_unit_prte_id
      ,p_object_version_number          =>  p_object_version_number
    ,p_effective_date                      => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_ELIG_ORG_UNIT_PRTE'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_ELIG_ORG_UNIT_PRTE
    --
  end;
  --
  ben_eou_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_ELIG_ORG_UNIT_PRTE
    --
    ben_ELIG_ORG_UNIT_PRTE_bk3.delete_ELIG_ORG_UNIT_PRTE_a
      (
       p_elig_org_unit_prte_id          =>  p_elig_org_unit_prte_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_ELIG_ORG_UNIT_PRTE
    --
  end;
  --
  ben_profile_handler.event_handler
    (p_event                       => 'DELETE',
     p_base_table                  => 'BEN_ELIGY_PRFL_F',
     p_base_table_column           => 'ELIGY_PRFL_ID',
     p_base_table_column_value     => ben_eou_shd.g_old_rec.eligy_prfl_id,
     p_base_table_reference_column => 'ELIG_ORG_UNIT_FLAG',
     p_reference_table             => 'BEN_ELIG_ORG_UNIT_PRTE_F',
     p_reference_table_column      => 'ELIGY_PRFL_ID');
  --
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO delete_ELIG_ORG_UNIT_PRTE;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
