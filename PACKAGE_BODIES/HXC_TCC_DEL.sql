--------------------------------------------------------
--  DDL for Package Body HXC_TCC_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_TCC_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_tcc_del.';  -- Global package name
...
Begin
  ...
  --
  -- Delete the hxc_time_category_comps row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hxc_tcc_shd.g_rec_type) is
--
  l_proc  varchar2(72);
--
Begin
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hxc_tcc_shd.g_rec_type) is
--
  l_proc  varchar2(72);
--
Begin
  ...
  IF ( hxc_tcc_shd.g_old_rec.type = 'MC' )
  THEN
        hxc_time_category_api.set_dynamic_sql_string ( p_time_category_id => hxc_tcc_shd.g_old_rec.time_category_id );
  END IF;
...
Begin
  ...
  --
  hxc_tcc_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  hxc_tcc_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hxc_tcc_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hxc_tcc_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
