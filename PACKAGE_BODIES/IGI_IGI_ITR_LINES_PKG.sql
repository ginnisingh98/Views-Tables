--------------------------------------------------------
--  DDL for Package Body IGI_IGI_ITR_LINES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGI_IGI_ITR_LINES_PKG" as
-- $Header: igiitrbb.pls 120.5.12000000.1 2007/09/12 10:30:26 mbremkum ship $
--
  ...
  BEGIN
	...
	IF ( l_excep_level >=  l_debug_level)  THEN
  	      FND_LOG.MESSAGE(l_excep_level,'igi.plsql.igiitrbb.IGI_IGI_ITR_LINES_PKG.lock_row.msg1', FALSE);
	END IF;
	...
	IF ( l_excep_level >=  l_debug_level)  THEN
  	      FND_LOG.MESSAGE(l_excep_level,'igi.plsql.igiitrbb.IGI_IGI_ITR_LINES_PKG.lock_row.msg2', FALSE);
	END IF;
