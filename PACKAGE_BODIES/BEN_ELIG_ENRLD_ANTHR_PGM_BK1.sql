--------------------------------------------------------
--  DDL for Package Body BEN_ELIG_ENRLD_ANTHR_PGM_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIG_ENRLD_ANTHR_PGM_BK1" as
/* $Header: beeegapi.pkb 120.0 2005/05/28 02:03:14 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_ELIG_ENRLD_ANTHR_PGM_BK1.CREATE_ELIG_ENRLD_ANTHR_PGM_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_ENRLD_ANTHR_PGM_BK1.CREATE_ELIG_ENRLD_ANTHR_PGM_A', 20);
end CREATE_ELIG_ENRLD_ANTHR_PGM_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIG_ENRLD_ANTHR_PGM_BK1.CREATE_ELIG_ENRLD_ANTHR_PGM_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_ENRLD_ANTHR_PGM_BK1.CREATE_ELIG_ENRLD_ANTHR_PGM_B', 20);
end CREATE_ELIG_ENRLD_ANTHR_PGM_B;
