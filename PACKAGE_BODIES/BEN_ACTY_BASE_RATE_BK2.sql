--------------------------------------------------------
--  DDL for Package Body BEN_ACTY_BASE_RATE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ACTY_BASE_RATE_BK2" as
/* $Header: beabrapi.pkb 120.3 2006/01/19 08:04:50 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/01/04 08:37:21 (YYYY/MM/DD HH24:MI:SS)
procedure UPDATE_ACTY_BASE_RATE_A
...
begin
hr_utility.set_location('Entering: BEN_ACTY_BASE_RATE_BK2.UPDATE_ACTY_BASE_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_ACTY_BASE_RATE_BK2.UPDATE_ACTY_BASE_RATE_A', 20);
end UPDATE_ACTY_BASE_RATE_A;
procedure UPDATE_ACTY_BASE_RATE_B
(P_ACTY_BASE_RT_ID in NUMBER
,P_ORDR_NUM in NUMBER
,P_ACTY_TYP_CD in VARCHAR2
,P_SUB_ACTY_TYP_CD in VARCHAR2
...
begin
hr_utility.set_location('Entering: BEN_ACTY_BASE_RATE_BK2.UPDATE_ACTY_BASE_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_ACTY_BASE_RATE_BK2.UPDATE_ACTY_BASE_RATE_B', 20);
end UPDATE_ACTY_BASE_RATE_B;
end BEN_ACTY_BASE_RATE_BK2;
