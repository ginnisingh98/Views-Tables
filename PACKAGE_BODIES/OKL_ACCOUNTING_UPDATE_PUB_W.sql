--------------------------------------------------------
--  DDL for Package Body OKL_ACCOUNTING_UPDATE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ACCOUNTING_UPDATE_PUB_W" as
  /* $Header: OKLUAEUB.pls 120.1 2005/07/07 13:35:05 dkagrawa noship $ */
  ...
  as
    ddp_aelv_rec okl_accounting_update_pub.aelv_rec_type;
    ddx_aelv_rec okl_accounting_update_pub.aelv_rec_type;
  ...
  begin
    ...
    okl_accounting_update_pub.update_acct_entries(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
