--------------------------------------------------------
--  DDL for Package Body WMS_RULE_9
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WMS_RULE_9" AS
...
,base.PROJECT_ID
,base.TASK_ID
 from MTL_UNITS_OF_MEASURE bmuom
...
and muom.UOM_CODE = mptdtv.TRANSACTION_UOM
and bmuom.UOM_CLASS = muom.UOM_CLASS
and bmuom.BASE_UOM_FLAG = 'Y'
and (
...
,bmuom.UOM_CODE
,base.LOCATION_MAXIMUM_UNITS
,base.LOCATION_CURRENT_UNITS
,base.LOCATION_SUGGESTED_UNITS
,base.LOCATION_AVAILABLE_UNITS
,base.LOCATION_WEIGHT_UOM_CODE
,base.MAX_WEIGHT
,base.CURRENT_WEIGHT
,base.SUGGESTED_WEIGHT
,base.AVAILABLE_WEIGHT
,base.VOLUME_UOM_CODE
,base.MAX_CUBIC_AREA
,base.CURRENT_CUBIC_AREA
,base.SUGGESTED_CUBIC_AREA
,base.AVAILABLE_CUBIC_AREA ) >= mptdtv.PRIMARY_QUANTITY
)
