--------------------------------------------------------
--  DDL for Package Body PQP_GDA_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_GDA_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqp_gda_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_gap_daily_absence_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_gap_daily_absence_id  in  number) is
--
...
Begin
  ...
  --
  pqp_gda_ins.g_gap_daily_absence_id_i := p_gap_daily_absence_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: pqp_gap_daily_absences
  --
...
--
  Cursor C_Sel1 is select pqp_gap_daily_absences_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from pqp_gap_daily_absences
     where gap_daily_absence_id =
             pqp_gda_ins.g_gap_daily_absence_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (pqp_gda_ins.g_gap_daily_absence_id_i is not null) Then
    --
    ...
    p_rec.gap_daily_absence_id :=
      pqp_gda_ins.g_gap_daily_absence_id_i;
    pqp_gda_ins.g_gap_daily_absence_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.gap_daily_absence_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  pqp_gda_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pqp_gda_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pqp_gda_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Begin
  ...
  --
  p_gap_daily_absence_id := l_rec.gap_daily_absence_id;
