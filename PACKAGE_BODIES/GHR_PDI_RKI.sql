--------------------------------------------------------
--  DDL for Package Body GHR_PDI_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_PDI_RKI" as
...
begin
hr_utility.set_location('Entering: GHR_PDI_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: GHR_PDI_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end GHR_PDI_RKI;
