--------------------------------------------------------
--  DDL for Package Body PER_KW_WORK_INCIDENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_KW_WORK_INCIDENT_API" as
/* $Header: peinckwi.pkb 120.0 2005/05/31 10:06:29 appldev noship $ */

-- Package Variables
--
g_package  varchar2(33) := 'per_kw_work_incident_api.';
--
-- ----------------------------------------------------------------------
...
procedure create_kw_work_incident
  ...
  l_proc              varchar2(72) := g_package||'create_kw_work_incident';
...
begin
  ...
  --
  savepoint create_kw_work_incident;
  --
  ...
  --
    per_work_incident_api.create_work_incident
      (p_validate                       => p_validate
       ...
       ,p_inc_information_category      => 'KW'
       ,p_inc_information1              => p_length_of_treatment
       ,p_inc_information2              => p_units
...
procedure update_kw_work_incident
  ...
  --
  l_business_group_id    per_contracts_f.business_group_id%TYPE;
  l_proc                 varchar2(72) := g_package||'update_kw_work_incident';
  l_legislation_code     varchar2(2);
  --
  cursor csr_get_business_group_id is
    select per.business_group_id
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_kw_work_incident;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
