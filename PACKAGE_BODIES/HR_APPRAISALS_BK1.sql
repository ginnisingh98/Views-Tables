--------------------------------------------------------
--  DDL for Package Body HR_APPRAISALS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_APPRAISALS_BK1" as
...
begin
hr_utility.set_location('Entering: HR_APPRAISALS_BK1.CREATE_APPRAISAL_A', 10);
hr_utility.set_location(' Leaving: HR_APPRAISALS_BK1.CREATE_APPRAISAL_A', 20);
end CREATE_APPRAISAL_A;
...
begin
hr_utility.set_location('Entering: HR_APPRAISALS_BK1.CREATE_APPRAISAL_B', 10);
hr_utility.set_location(' Leaving: HR_APPRAISALS_BK1.CREATE_APPRAISAL_B', 20);
end CREATE_APPRAISAL_B;
