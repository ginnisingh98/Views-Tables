--------------------------------------------------------
--  DDL for Package Body PAY_ELEMENT_ENTRY_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ELEMENT_ENTRY_BK1" as
...
begin
hr_utility.set_location('Entering: PAY_ELEMENT_ENTRY_BK1.CREATE_ELEMENT_ENTRY_A', 10);
...
HR_NO_VALIDATE_PKG.CREATE_ELE_ENTRY_AP
(P_EFFECTIVE_DATE => P_EFFECTIVE_DATE
);
end if;
end if;
hr_multi_message.end_validation_set;
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_ELEMENT_ENTRY', 'AP');
hr_utility.set_location(' Leaving: PAY_ELEMENT_ENTRY_BK1.CREATE_ELEMENT_ENTRY_A', 20);
end CREATE_ELEMENT_ENTRY_A;
...
l_legislation_code   varchar2(30);
begin
hr_utility.set_location('Entering: PAY_ELEMENT_ENTRY_BK1.CREATE_ELEMENT_ENTRY_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_leg_hooks then
l_legislation_code := hr_api.return_legislation_code(p_business_group_id => P_BUSINESS_GROUP_ID);
if l_legislation_code = 'DE' then
HR_DE_VALIDATE_PKG.CREATE_ELEMENT_ENTRY_VALIDATE
(P_EFFECTIVE_DATE => P_EFFECTIVE_DATE
...
HR_NO_VALIDATE_PKG.CREATE_ELE_ENTRY_BP
(P_EFFECTIVE_DATE => P_EFFECTIVE_DATE
);
end if;
end if;
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_ELEMENT_ENTRY', 'BP');
hr_utility.set_location(' Leaving: PAY_ELEMENT_ENTRY_BK1.CREATE_ELEMENT_ENTRY_B', 20);
end CREATE_ELEMENT_ENTRY_B;
