--------------------------------------------------------
--  DDL for Package Body PQP_AAD_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_AAD_RKU" as
...
begin
hr_utility.set_location('Entering: PQP_AAD_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PQP_AAD_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQP_AAD_RKU;
