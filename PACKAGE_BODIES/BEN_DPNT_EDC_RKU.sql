--------------------------------------------------------
--  DDL for Package Body BEN_DPNT_EDC_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DPNT_EDC_RKU" as
...
begin
hr_utility.set_location('Entering: BEN_DPNT_EDC_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: BEN_DPNT_EDC_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
