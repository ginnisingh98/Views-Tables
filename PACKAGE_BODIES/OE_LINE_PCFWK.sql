--------------------------------------------------------
--  DDL for Package Body OE_LINE_PCFWK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_LINE_PCFWK" AS
/* $Header: OEXKLINB.pls 120.0 2005/06/01 02:38:51 appldev noship $ */

-- Globals
-------------------------------------------
 g_application_id     constant number := 660;
 g_entity_id          constant number := 2;
 g_entity_short_name  constant varchar2(15) := 'LINE';
-------------------------------------------
