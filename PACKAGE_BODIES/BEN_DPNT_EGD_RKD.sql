--------------------------------------------------------
--  DDL for Package Body BEN_DPNT_EGD_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DPNT_EGD_RKD" as
...
begin
hr_utility.set_location('Entering: BEN_DPNT_EGD_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: BEN_DPNT_EGD_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
