--------------------------------------------------------
--  DDL for Package Body HR_SA_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SA_APPLICANT_API" as
/* $Header: peappsai.pkb 120.3 2005/06/20 02:01:07 adevanat noship $ */

--
g_package  VARCHAR2(33) := 'hr_sa_applicant_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_sa_applicant >------------------------------|
-- -----------------------------------------------------------------------------
PROCEDURE create_sa_applicant
  ...
  --
  l_proc                 VARCHAR2(72) := g_package||'create_sa_applicant';
