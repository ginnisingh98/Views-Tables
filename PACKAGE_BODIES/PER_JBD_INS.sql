--------------------------------------------------------
--  DDL for Package Body PER_JBD_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_JBD_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_jbd_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure insert_dml(p_rec in out per_jbd_shd.g_rec_type) is
--
...
Begin
  ...
  --
  per_jbd_shd.g_api_dml := true;  -- Set the api dml status
  --
  -- Insert the row into: per_job_definitions
  --
  ...
  --
  per_jbd_shd.g_api_dml := false;   -- Unset the api dml status
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_insert(p_rec  in out per_jbd_shd.g_rec_type) is
--
  l_proc  varchar2(72) := g_package||'pre_insert';
--
  Cursor C_Sel1 is select per_job_definitions_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.job_definition_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure post_insert(p_rec in per_jbd_shd.g_rec_type) is
--
...
Begin
  ...
  If p_validate then
    ...
    -- Issue the savepoint.
    --
    SAVEPOINT ins_per_jbd;
  End If;

  --
  -- Call the supporting insert validate operations
  --
  per_jbd_bus.insert_validate(p_rec);
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the per_jbd_rec
  ...
  --
  p_job_definition_id := l_rec.job_definition_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End ins;
--
...
begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  -- determine if a job combination exists
  --
  ...
  --
  -- determine the state of p_job_definition_id
  --
  -- p_job_definition_id
  -- state                 meaning
  -- ===================== =======
  ...
  elsif l_job_definition_id is not null then
    --
