--------------------------------------------------------
--  DDL for Package Body AME_GPI_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_GPI_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_gpi_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_approval_group_item_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_approval_group_item_id  in  number) is
--
...
Begin
  ...
  --
  ame_gpi_ins.g_approval_group_item_id_i := p_approval_group_item_id;
  --
...
Procedure dt_insert_dml
  (p_rec                     in out nocopy ame_gpi_shd.g_rec_type
...
--
  Cursor C_Sel1 Is
    ...
    and    t.start_date =
             ame_gpi_shd.g_old_rec.start_date
...
--
  ...
  l_creation_date       ame_approval_group_items.creation_date%TYPE;
  l_last_update_date    ame_approval_group_items.last_update_date%TYPE;
  l_last_updated_by     ame_approval_group_items.last_updated_by%TYPE;
  l_last_update_login   ame_approval_group_items.last_update_login%TYPE;
...
Begin
  ...
  p_rec.object_version_number :=
   ame_gpi_shd.get_object_version_number
  ...
  --
  --
  -- Insert the row into: ame_approval_group_items
  --
  insert into ame_approval_group_items
      (approval_group_item_id
      ,approval_group_id
      ,parameter_name
      ,parameter
      ,order_number
...
--
  Cursor C_Sel1 is select ame_approval_group_items_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from ame_approval_group_items
     where approval_group_item_id =
             ame_gpi_ins.g_approval_group_item_id_i
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (ame_gpi_ins.g_approval_group_item_id_i is not null) Then
    --
    ...
    p_rec.approval_group_item_id :=
      ame_gpi_ins.g_approval_group_item_id_i;
    ame_gpi_ins.g_approval_group_item_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.approval_group_item_id;
    Close C_Sel1;
  End If;
  --
  --
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'AME_APPROVAL_GROUP_ITEMS'
        ,p_hook_type   => 'AI');
      --
  end;
  --
...
-- MURTHY_CHANGES
  ...
  ame_gpi_bus.chk_approval_group_id
...
Begin
  ...
  --
  -- Having converted the arguments into the ame_gpi_rec
  ...
  --
  p_approval_group_item_id := l_rec.approval_group_item_id;
