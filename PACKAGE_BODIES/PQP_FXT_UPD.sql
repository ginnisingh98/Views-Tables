--------------------------------------------------------
--  DDL for Package Body PQP_FXT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_FXT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqp_fxt_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the pqp_flxdu_xml_tags Row
  --
...
Begin
  ...
  --
  If (p_rec.flxdu_column_id = hr_api.g_number) then
    p_rec.flxdu_column_id :=
    pqp_fxt_shd.g_old_rec.flxdu_column_id;
  End If;
  If (p_rec.flxdu_xml_tag_name = hr_api.g_varchar2) then
    p_rec.flxdu_xml_tag_name :=
    pqp_fxt_shd.g_old_rec.flxdu_xml_tag_name;
  End If;
...
Procedure upd
  ...
  ,p_flxdu_column_id              in     number    default hr_api.g_number
  ,p_flxdu_xml_tag_name           in     varchar2  default hr_api.g_varchar2
