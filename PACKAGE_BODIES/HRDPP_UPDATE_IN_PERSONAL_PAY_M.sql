--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_IN_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_IN_PERSONAL_PAY_M" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:20
 * Generated for API: hr_in_personal_pay_method_api.update_in_personal_pay_method
 */
--
...
decode(l.pval029,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval029,'IN_ACCOUNT_TYPE',d(l.pval001),l.pval041)) p29,
l.pval029 d29,
decode(l.pval030,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval030,'IN_BANK',d(l.pval001),l.pval041)) p30,
l.pval030 d30,
decode(l.pval031,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval031,'IN_BANK_BRANCH',d(l.pval001),l.pval041)) p31,
l.pval031 d31,
decode(l.pval032,cn,vn,vn,vh,l.pval032) p32,
l.pval032 d32,
decode(l.pval033,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval033,'PAYEE_TYPE',d(l.pval001),l.pval041)) p33,
l.pval033 d33,
l.pval034 p34,
l.pval035 p35,
...
(P_PERSONAL_PAY_METHOD_USER_KEY => c.p38);
end if;
--
if c.p38 is null or
c.p1 is null then
...
,P_PAYEE_ORG => c.p39
,P_PAYEE_PERSON_USER_KEY => c.p40
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p41);
--
hr_data_pump.api_trc_on;
hr_in_personal_pay_method_api.update_in_personal_pay_method
...
end hrdpp_update_in_personal_pay_m;
