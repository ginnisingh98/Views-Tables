--------------------------------------------------------
--  DDL for Package Body PER_PCL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PCL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_pcl_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.cagr_entitlement_line_id       = p_rec.cagr_entitlement_line_id
    and    t.effective_start_date =
             per_pcl_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc                varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          per_cagr_entitlement_lines_f.created_by%TYPE;
  l_creation_date       per_cagr_entitlement_lines_f.creation_date%TYPE;
  l_last_update_date    per_cagr_entitlement_lines_f.last_update_date%TYPE;
  l_last_updated_by     per_cagr_entitlement_lines_f.last_updated_by%TYPE;
  l_last_update_login   per_cagr_entitlement_lines_f.last_update_login%TYPE;
--
Begin
  ...
  --
  --
  -- Insert the row into: per_cagr_entitlement_lines_f
  --
  insert into per_cagr_entitlement_lines_f
...
--
  Cursor C_Sel1 is select per_cagr_entitlement_lines_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.cagr_entitlement_line_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  -- Having converted the arguments into the per_pcl_rec
  ...
  --
  p_cagr_entitlement_line_id         := l_rec.cagr_entitlement_line_id;
