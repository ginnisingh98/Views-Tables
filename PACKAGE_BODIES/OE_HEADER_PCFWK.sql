--------------------------------------------------------
--  DDL for Package Body OE_HEADER_PCFWK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_HEADER_PCFWK" AS
/* $Header: OEXKHDRB.pls 120.0 2005/06/01 01:29:26 appldev noship $ */

-- Globals
-------------------------------------------
 g_application_id     constant number := 660;
 g_entity_id          constant number := 1;
 g_entity_short_name  constant varchar2(15) := 'HEADER';
-------------------------------------------
