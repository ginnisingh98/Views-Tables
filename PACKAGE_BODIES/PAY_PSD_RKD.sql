--------------------------------------------------------
--  DDL for Package Body PAY_PSD_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PSD_RKD" as
...
begin
hr_utility.set_location('Entering: PAY_PSD_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PAY_PSD_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PAY_PSD_RKD;
