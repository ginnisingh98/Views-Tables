--------------------------------------------------------
--  DDL for Package Body OTA_BSL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_BSL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_bsl_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: ota_booking_status_types_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.booking_status_type_id           := p_booking_status_type_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  ota_bsl_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ota_bsl_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where bst.booking_status_type_id = p_booking_status_type_id
                          and bst.language = l.language_code);
  --
