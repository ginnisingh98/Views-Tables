--------------------------------------------------------
--  DDL for Package Body BEN_PIL_ELCTBL_CHC_POPL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PIL_ELCTBL_CHC_POPL_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PIL_ELCTBL_CHC_POPL_BK1.CREATE_PIL_ELCTBL_CHC_POPL_A', 10);
hr_utility.set_location(' Leaving: BEN_PIL_ELCTBL_CHC_POPL_BK1.CREATE_PIL_ELCTBL_CHC_POPL_A', 20);
end CREATE_PIL_ELCTBL_CHC_POPL_A;
...
begin
hr_utility.set_location('Entering: BEN_PIL_ELCTBL_CHC_POPL_BK1.CREATE_PIL_ELCTBL_CHC_POPL_B', 10);
hr_utility.set_location(' Leaving: BEN_PIL_ELCTBL_CHC_POPL_BK1.CREATE_PIL_ELCTBL_CHC_POPL_B', 20);
end CREATE_PIL_ELCTBL_CHC_POPL_B;
