--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_ORGANIZATION
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_ORGANIZATION" as
/*
...
(P_COST_ALLOC_KEYFLEX_USER_KEY => c.p74);
end if;
--
if c.d75=cn or
c.p2 is null then
