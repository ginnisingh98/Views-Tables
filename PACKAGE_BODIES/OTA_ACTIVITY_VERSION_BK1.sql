--------------------------------------------------------
--  DDL for Package Body OTA_ACTIVITY_VERSION_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_ACTIVITY_VERSION_BK1" as
...
begin
hr_utility.set_location('Entering: OTA_ACTIVITY_VERSION_BK1.CREATE_ACTIVITY_VERSION_A', 10);
hr_utility.set_location(' Leaving: OTA_ACTIVITY_VERSION_BK1.CREATE_ACTIVITY_VERSION_A', 20);
end CREATE_ACTIVITY_VERSION_A;
...
begin
hr_utility.set_location('Entering: OTA_ACTIVITY_VERSION_BK1.CREATE_ACTIVITY_VERSION_B', 10);
hr_utility.set_location(' Leaving: OTA_ACTIVITY_VERSION_BK1.CREATE_ACTIVITY_VERSION_B', 20);
end CREATE_ACTIVITY_VERSION_B;
