--------------------------------------------------------
--  DDL for Package Body IGS_CO_LTR_PHR_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_CO_LTR_PHR_PKG" AS
/* $Header: IGSLI10B.pls 115.4 2002/11/29 01:04:40 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_co_ltr_phr%ROWTYPE;
  new_references igs_co_ltr_phr%ROWTYPE;
