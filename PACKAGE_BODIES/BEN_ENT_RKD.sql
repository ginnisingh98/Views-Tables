--------------------------------------------------------
--  DDL for Package Body BEN_ENT_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ENT_RKD" as
...
begin
hr_utility.set_location('Entering: BEN_ENT_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: BEN_ENT_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end BEN_ENT_RKD;
