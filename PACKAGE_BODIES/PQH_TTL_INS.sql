--------------------------------------------------------
--  DDL for Package Body PQH_TTL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_TTL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqh_ttl_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure insert_dml(p_rec in out nocopy pqh_ttl_shd.g_rec_type) is
--
...
Begin
  ...
  --
  --
  -- Insert the row into: pqh_templates_tl
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_insert(p_rec  in out nocopy pqh_ttl_shd.g_rec_type,
...
Begin
  ...
  --
  p_rec.template_id := p_template_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure post_insert(p_rec in pqh_ttl_shd.g_rec_type) is
--
...
Begin
  ...
  --
  pqh_ttl_bus.insert_validate(p_rec);
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the pqh_ttl_rec
...
begin
  ...
  for l_lang in csr_ins_langs loop
    ...
    ins(p_template_id   => p_template_id,
