--------------------------------------------------------
--  DDL for Package Body PER_BF_PAYROLL_RUNS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_BF_PAYROLL_RUNS_BK2" as
...
begin
hr_utility.set_location('Entering: PER_BF_PAYROLL_RUNS_BK2.UPDATE_PAYROLL_RUN_A', 10);
hr_utility.set_location(' Leaving: PER_BF_PAYROLL_RUNS_BK2.UPDATE_PAYROLL_RUN_A', 20);
end UPDATE_PAYROLL_RUN_A;
...
begin
hr_utility.set_location('Entering: PER_BF_PAYROLL_RUNS_BK2.UPDATE_PAYROLL_RUN_B', 10);
hr_utility.set_location(' Leaving: PER_BF_PAYROLL_RUNS_BK2.UPDATE_PAYROLL_RUN_B', 20);
end UPDATE_PAYROLL_RUN_B;
