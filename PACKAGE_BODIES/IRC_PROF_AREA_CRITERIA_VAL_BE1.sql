--------------------------------------------------------
--  DDL for Package Body IRC_PROF_AREA_CRITERIA_VAL_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_PROF_AREA_CRITERIA_VAL_BE1" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  irc_prof_area_criteria_val_be1.create_prof_area_criteria_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.prof_area_criteria_val.create_prof_area_criteria';
