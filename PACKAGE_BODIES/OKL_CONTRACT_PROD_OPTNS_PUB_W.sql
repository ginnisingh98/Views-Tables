--------------------------------------------------------
--  DDL for Package Body OKL_CONTRACT_PROD_OPTNS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CONTRACT_PROD_OPTNS_PUB_W" as
  /* $Header: OKLUCSPB.pls 120.1 2005/07/08 10:20:39 asawanka noship $ */
  ...
  as
    ddp_cspv_rec okl_contract_prod_optns_pub.cspv_rec_type;
    ddx_cspv_rec okl_contract_prod_optns_pub.cspv_rec_type;
  ...
  begin
    ...
    okl_contract_prod_optns_pub.create_contract_option(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_cspv_tbl okl_contract_prod_optns_pub.cspv_tbl_type;
    ddx_cspv_tbl okl_contract_prod_optns_pub.cspv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_prod_optns_pub.update_contract_option(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_prod_optns_pub.delete_contract_option(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_prod_optns_pub.lock_contract_option(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_prod_optns_pub.validate_contract_option(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_contract_prod_optns_pub_w;
