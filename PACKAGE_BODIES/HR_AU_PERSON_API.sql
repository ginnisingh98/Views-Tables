--------------------------------------------------------
--  DDL for Package Body HR_AU_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_AU_PERSON_API" AS
/* $Header: hrauwrpe.pkb 115.5 2002/12/03 09:42:17 apunekar ship $ */
/*
 +==========================================================================================
 |              Copyright (c) 1999 Oracle Corporation Ltd
 |                           All rights reserved.
 +==========================================================================================
 |SQL Script File Name : HR AU WR PE . PKB
 |                Name : hr_au_person_api
 |         Description : Person API Wrapper for AU
 |
...
*/
   ...
   g_package   VARCHAR2(33) := 'hr_au_person_api.';
   ...
   --
   l_proc                VARCHAR2(72) := g_package||'update_AU_person';
