--------------------------------------------------------
--  DDL for Package Body BEN_PSL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PSL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_psl_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    select t.created_by,
           t.creation_date
    from   ben_per_info_chg_cs_ler_f t
    where  t.per_info_chg_cs_ler_id       = p_rec.per_info_chg_cs_ler_id
    and    t.effective_start_date =
             ben_psl_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc        varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_per_info_chg_cs_ler_f.created_by%TYPE;
  l_creation_date       ben_per_info_chg_cs_ler_f.creation_date%TYPE;
  l_last_update_date    ben_per_info_chg_cs_ler_f.last_update_date%TYPE;
  l_last_updated_by     ben_per_info_chg_cs_ler_f.last_updated_by%TYPE;
  l_last_update_login   ben_per_info_chg_cs_ler_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_per_info_chg_cs_ler_f
  --
  insert into ben_per_info_chg_cs_ler_f
...
--
  Cursor C_Sel1 is select ben_per_info_chg_cs_ler_f_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.per_info_chg_cs_ler_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_psl_rec
  ...
  --
  p_per_info_chg_cs_ler_id      := l_rec.per_info_chg_cs_ler_id;
