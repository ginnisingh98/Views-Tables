--------------------------------------------------------
--  DDL for Package Body PAY_CNU_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_CNU_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_cnu_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the pay_fr_contribution_usages row.
  --
  delete from pay_fr_contribution_usages
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pay_cnu_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in pay_cnu_shd.g_rec_type) is
--
...
Begin
  ...
  --
  pay_cnu_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  pay_cnu_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  pay_cnu_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  pay_cnu_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
