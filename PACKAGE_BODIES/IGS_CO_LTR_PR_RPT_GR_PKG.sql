--------------------------------------------------------
--  DDL for Package Body IGS_CO_LTR_PR_RPT_GR_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_CO_LTR_PR_RPT_GR_PKG" AS
/* $Header: IGSLI11B.pls 115.9 2002/11/29 01:04:56 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_co_ltr_pr_rpt_gr_all%ROWTYPE;
  new_references igs_co_ltr_pr_rpt_gr_all%ROWTYPE;
 ...
 Begin
  ...
  -- Trigger description :-
  -- "OSS_TST".trg_lprg_br_i
  -- BEFORE INSERT
  -- ON IGS_CO_LTR_PR_RPT_GR
  -- FOR EACH ROW
  ...
  */
  BEGIN
    ...
    igs_co_s_per_lt_parm_pkg.get_fk_igs_co_ltr_pr_rpt_gr(
  ...
  */
  ...
  BEGIN
    ...
    INSERT INTO igs_co_ltr_pr_rpt_gr_all (
      correspondence_type,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ((tlinfo.letter_parameter_type = x_letter_parameter_type) OR ((tlinfo.letter_parameter_type IS NULL) AND (X_letter_parameter_type IS NULL)))
  ...
  */
  ...
  BEGIN
    ...
    UPDATE igs_co_ltr_pr_rpt_gr_all
      SET
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_co_ltr_pr_rpt_gr_all
    WHERE rowid = x_rowid;
