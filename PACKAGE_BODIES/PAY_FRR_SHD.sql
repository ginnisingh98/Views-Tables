--------------------------------------------------------
--  DDL for Package Body PAY_FRR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_FRR_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_frr_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PAY_FORMULA_RESULT_RULES_F_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PAY_FRR_RESULT_RULE_TYPE_CHK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','10');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PAY_FRR_SEVERITY_LEVEL_CHK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  If (p_effective_date is null or
      p_formula_result_rule_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_formula_result_rule_id =
        pay_frr_shd.g_old_rec.formula_result_rule_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into pay_frr_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> pay_frr_shd.g_old_rec.object_version_number) Then
...
--
  ...
  --
  update  pay_formula_result_rules_f t
  set     t.effective_end_date    = p_new_effective_end_date
    ,     t.object_version_number = l_object_version_number
  where   t.formula_result_rule_id        = p_base_key_value
  and     p_effective_date
...
Begin
  ...
  If (p_datetrack_mode <> hr_api.g_insert) then
    ...
    dt_api.validate_dt_mode
      ...
      ,p_base_table_name         => 'pay_formula_result_rules_f'
      ,p_base_key_column         => 'formula_result_rule_id'
      ,p_base_key_value          => p_formula_result_rule_id
