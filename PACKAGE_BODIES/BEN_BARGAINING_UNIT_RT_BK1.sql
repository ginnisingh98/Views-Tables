--------------------------------------------------------
--  DDL for Package Body BEN_BARGAINING_UNIT_RT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BARGAINING_UNIT_RT_BK1" as
/* $Header: beburapi.pkb 120.0 2005/05/28 00:53:37 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_BARGAINING_UNIT_RT_BK1.CREATE_BARGAINING_UNIT_RT_A', 10);
hr_utility.set_location(' Leaving: BEN_BARGAINING_UNIT_RT_BK1.CREATE_BARGAINING_UNIT_RT_A', 20);
end CREATE_BARGAINING_UNIT_RT_A;
...
begin
hr_utility.set_location('Entering: BEN_BARGAINING_UNIT_RT_BK1.CREATE_BARGAINING_UNIT_RT_B', 10);
hr_utility.set_location(' Leaving: BEN_BARGAINING_UNIT_RT_BK1.CREATE_BARGAINING_UNIT_RT_B', 20);
end CREATE_BARGAINING_UNIT_RT_B;
