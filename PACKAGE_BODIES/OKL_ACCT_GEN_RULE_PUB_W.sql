--------------------------------------------------------
--  DDL for Package Body OKL_ACCT_GEN_RULE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ACCT_GEN_RULE_PUB_W" as
  /* $Header: OKLUACGB.pls 120.1 2005/07/07 13:35:54 dkagrawa noship $ */
  ...
  as
    ddx_acc_lines okl_acct_gen_rule_pub.acct_tbl_type;
  ...
  begin
    ...
    okl_acct_gen_rule_pub.get_rule_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_acc_lines okl_acct_gen_rule_pub.acct_tbl_type;
    ddx_acc_lines okl_acct_gen_rule_pub.acct_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acct_gen_rule_pub.updt_rule_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
