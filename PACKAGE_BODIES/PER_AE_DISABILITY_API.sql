--------------------------------------------------------
--  DDL for Package Body PER_AE_DISABILITY_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_AE_DISABILITY_API" as
/* $Header: pedisaei.pkb 120.0.12000000.1 2007/01/21 21:54:19 appldev ship $ */


--
-- Package Variables
--
g_package  varchar2(33) := 'per_ae_disability_api.';
--
-- ----------------------------------------------------------------------
-- |-----------------------< create_ae_disability >---------------------|
-- ----------------------------------------------------------------------
--
procedure create_ae_disability
  ...
  ,p_relevant_to_social_security   in     varchar2 default null
  ...
  l_proc              varchar2(72) := g_package||'create_ae_disability';
...
begin
  ...
  --
  savepoint create_ae_disability;
  --
  ...
  per_disability_api.create_disability
       ...
       ,p_dis_information_category      => 'AE'
       ,p_dis_information1              => p_relevant_to_social_security
  ...
  --
end create_ae_disability;
--
-- ----------------------------------------------------------------------
-- |------------------------< update_ae_disability >--------------------|
-- ----------------------------------------------------------------------
--
procedure update_ae_disability
  (p_validate                      in     boolean  default false
  ,p_effective_date                in     date
  ...
  ,p_relevant_to_social_security   in     varchar2 default hr_api.g_varchar2
  ,p_effective_start_date             out nocopy date
  ,p_effective_end_date               out nocopy date
  ) is
  --
  ...
  --
  l_business_group_id    per_contracts_f.business_group_id%TYPE;
  l_proc                 varchar2(72) := g_package||'update_ae_disability';
  l_legislation_code     varchar2(2);
  --
  cursor csr_get_business_group_id is
    select per.business_group_id
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_ae_disability;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  hr_utility.set_location(' Leaving:'||l_proc, 70);
  --
end update_ae_disability;
--
end per_ae_disability_api;
