--------------------------------------------------------
--  DDL for Package Body GHR_CAA_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_CAA_RKD" as
...
begin
hr_utility.set_location('Entering: GHR_CAA_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: GHR_CAA_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end GHR_CAA_RKD;
