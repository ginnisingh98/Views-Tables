--------------------------------------------------------
--  DDL for Package Body BEN_PGM_EXTRA_INFO_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PGM_EXTRA_INFO_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_PGM_EXTRA_INFO_BK2.UPDATE_PGM_EXTRA_INFO_A', 10);
hr_utility.set_location(' Leaving: BEN_PGM_EXTRA_INFO_BK2.UPDATE_PGM_EXTRA_INFO_A', 20);
end UPDATE_PGM_EXTRA_INFO_A;
...
begin
hr_utility.set_location('Entering: BEN_PGM_EXTRA_INFO_BK2.UPDATE_PGM_EXTRA_INFO_B', 10);
hr_utility.set_location(' Leaving: BEN_PGM_EXTRA_INFO_BK2.UPDATE_PGM_EXTRA_INFO_B', 20);
end UPDATE_PGM_EXTRA_INFO_B;
