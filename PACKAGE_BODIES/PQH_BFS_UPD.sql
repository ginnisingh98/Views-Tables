--------------------------------------------------------
--  DDL for Package Body PQH_BFS_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_BFS_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqh_bfs_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure update_dml(p_rec in out nocopy pqh_bfs_shd.g_rec_type) is
--
...
Begin
  ...
  --
  --
  -- Update the pqh_budget_fund_srcs Row
  --
  update pqh_budget_fund_srcs
  set
  budget_fund_src_id                = p_rec.budget_fund_src_id,
  budget_element_id                 = p_rec.budget_element_id,
  ...
  where budget_fund_src_id = p_rec.budget_fund_src_id;
  --
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_update(p_rec in pqh_bfs_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure post_update(p_rec in pqh_bfs_shd.g_rec_type) is
--
...
--
 ...
 ,p_budget_element_id_o           =>pqh_bfs_shd.g_old_rec.budget_element_id
 ,p_cost_allocation_keyflex_id_o  =>pqh_bfs_shd.g_old_rec.cost_allocation_keyflex_id
 ...
 ,p_distribution_percentage_o     =>pqh_bfs_shd.g_old_rec.distribution_percentage
 ,p_object_version_number_o       =>pqh_bfs_shd.g_old_rec.object_version_number
      );
    --
  exception
    --
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'pqh_budget_fund_srcs'
        ,p_hook_type   => 'AU');
      --
  end;
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy pqh_bfs_shd.g_rec_type) is
--
...
Procedure upd
  (
  p_rec        in out nocopy pqh_bfs_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  convert_defs(p_rec);
  pqh_bfs_bus.update_validate(p_rec);
  --
...
Begin
  ...
  --
  l_rec :=
  pqh_bfs_shd.convert_args
  (
  p_budget_fund_src_id,
  p_budget_element_id,
