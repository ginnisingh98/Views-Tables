--------------------------------------------------------
--  DDL for Package Body BEN_ACTION_TYPE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ACTION_TYPE_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_ACTION_TYPE_BK2.UPDATE_ACTION_TYPE_A', 10);
hr_utility.set_location(' Leaving: BEN_ACTION_TYPE_BK2.UPDATE_ACTION_TYPE_A', 20);
end UPDATE_ACTION_TYPE_A;
...
begin
hr_utility.set_location('Entering: BEN_ACTION_TYPE_BK2.UPDATE_ACTION_TYPE_B', 10);
hr_utility.set_location(' Leaving: BEN_ACTION_TYPE_BK2.UPDATE_ACTION_TYPE_B', 20);
end UPDATE_ACTION_TYPE_B;
