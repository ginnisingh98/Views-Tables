--------------------------------------------------------
--  DDL for Package Body BEN_PSQ_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PSQ_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_psq_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Insert the row into: ben_pymt_sched_py_freq
  --
...
Begin
  ...
  open c1;
    --
    fetch c1 into p_rec.PYMT_SCHED_PY_FREQ_id;
    --
  close c1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  p_pymt_sched_py_freq_id := l_rec.pymt_sched_py_freq_id;
