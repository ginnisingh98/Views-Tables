--------------------------------------------------------
--  DDL for Package Body WMS_RULE_15
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WMS_RULE_15" AS
...
and mil.ORGANIZATION_ID (+) = base.ORGANIZATION_ID
and mil.INVENTORY_LOCATION_ID (+) = base.LOCATOR_ID
and ppovs.PROJECT_ID (+) = mptdtv.PROJECT_ID
and ppp.ORGANIZATION_ID (+) = mil.ORGANIZATION_ID
and ppp.PROJECT_ID (+) = mil.PROJECT_ID
and (
 ppovs.PLANNING_GROUP = ppp.PLANNING_GROUP
)
