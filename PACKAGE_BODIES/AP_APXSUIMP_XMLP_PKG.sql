--------------------------------------------------------
--  DDL for Package Body AP_APXSUIMP_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AP_APXSUIMP_XMLP_PKG" AS
/* $Header: APXSUIMPB.pls 120.0 2007/12/27 08:33:20 vjaganat noship $ */
    ...
    BEGIN
     ...
     -- P_DEBUG_SWITCH := 'Y';
      ...
      IF (P_DEBUG_SWITCH in ('y','Y')) THEN
        NULL;
      END IF;
      AP_VENDOR_PUB_PKG.IMPORT_VENDORS(P_API_VERSION => 1.0
                                      ,P_SOURCE => 'IMPORT'
