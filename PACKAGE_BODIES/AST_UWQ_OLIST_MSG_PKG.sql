--------------------------------------------------------
--  DDL for Package Body AST_UWQ_OLIST_MSG_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AST_UWQ_OLIST_MSG_PKG" AS
/* $Header: astuomsb.pls 115.3 2003/02/19 01:08:19 jraj ship $ */
...
BEGIN
  ...
  if  p_action_key = 'astuomsb_camp_details' then  -- begin of main "if"
