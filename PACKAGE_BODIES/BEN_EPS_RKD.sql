--------------------------------------------------------
--  DDL for Package Body BEN_EPS_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EPS_RKD" as
/* $Header: beepsrhi.pkb 120.1 2006/02/21 04:03:44 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_eps_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_eps_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_eps_RKD;
