--------------------------------------------------------
--  DDL for Package Body PER_ESTAB_ATTENDANCES_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ESTAB_ATTENDANCES_BE3" as 
--Code generated on 04/01/2007 09:32:13
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  per_estab_attendances_be3.delete_attended_estab_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.estab_attendances.delete_attended_estab';
