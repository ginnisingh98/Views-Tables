--------------------------------------------------------
--  DDL for Package Body GR_ITEM_CONC_DETAILS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GR_ITEM_CONC_DETAILS_PKG" AS
/*$Header: GRHIICDB.pls 115.6 2002/10/25 20:11:58 methomas ship $*/
...
/*     Initialization Routine */
   ...
   x_oracle_error := 0;
   x_msg_data := NULL;
   l_msg_token := p_item_code || ' ' || p_ingredient_item_code;
...
**	      p_ingredient_item_code is the second part of the key
**		  p_source_item_code is the third part of the key
...
BEGIN
   ...
   l_msg_data := p_item_code || ' ' || p_ingredient_item_code;
