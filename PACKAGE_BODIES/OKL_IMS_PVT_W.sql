--------------------------------------------------------
--  DDL for Package Body OKL_IMS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_IMS_PVT_W" as
  /* $Header: OKLEIMSB.pls 120.2 2005/07/14 11:57:14 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_ims_pvt.ims_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).start_date := rosetta_g_miss_date_in_map(a26(indx));
          t(ddindx).pkg_name := a27(indx);
          t(ddindx).proc_name := a28(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p2(t okl_ims_pvt.ims_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a28 := JTF_VARCHAR2_TABLE_300();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a26(indx) := t(ddindx).start_date;
          a27(indx) := t(ddindx).pkg_name;
          a28(indx) := t(ddindx).proc_name;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_ims_pvt.okl_invoice_mssgs_tl_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p5(t okl_ims_pvt.okl_invoice_mssgs_tl_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_in_p8(t out nocopy okl_ims_pvt.imsv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_VARCHAR2_TABLE_100
    , a4 JTF_VARCHAR2_TABLE_200
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).pkg_name := a31(indx);
          t(ddindx).proc_name := a32(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p8(t okl_ims_pvt.imsv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    , a3 out nocopy JTF_VARCHAR2_TABLE_100
    , a4 out nocopy JTF_VARCHAR2_TABLE_200
    ...
    a32 := JTF_VARCHAR2_TABLE_300();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a31(indx) := t(ddindx).pkg_name;
          a32(indx) := t(ddindx).proc_name;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  as
    ddp_imsv_rec okl_ims_pvt.imsv_rec_type;
    ddx_imsv_rec okl_ims_pvt.imsv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ddp_imsv_rec.id := rosetta_g_miss_num_map(p5_a0);
    ddp_imsv_rec.org_id := rosetta_g_miss_num_map(p5_a1);
    ddp_imsv_rec.object_version_number := rosetta_g_miss_num_map(p5_a2);
    ddp_imsv_rec.sfwt_flag := p5_a3;
    ddp_imsv_rec.name := p5_a4;
    ddp_imsv_rec.message_text := p5_a5;
    ddp_imsv_rec.priority := rosetta_g_miss_num_map(p5_a6);
    ddp_imsv_rec.description := p5_a7;
    ddp_imsv_rec.end_date := rosetta_g_miss_date_in_map(p5_a8);
    ddp_imsv_rec.attribute_category := p5_a9;
    ddp_imsv_rec.attribute1 := p5_a10;
    ddp_imsv_rec.attribute2 := p5_a11;
    ddp_imsv_rec.attribute3 := p5_a12;
    ddp_imsv_rec.attribute4 := p5_a13;
    ddp_imsv_rec.attribute5 := p5_a14;
    ddp_imsv_rec.attribute6 := p5_a15;
    ddp_imsv_rec.attribute7 := p5_a16;
    ddp_imsv_rec.attribute8 := p5_a17;
    ddp_imsv_rec.attribute9 := p5_a18;
    ddp_imsv_rec.attribute10 := p5_a19;
    ddp_imsv_rec.attribute11 := p5_a20;
    ddp_imsv_rec.attribute12 := p5_a21;
    ddp_imsv_rec.attribute13 := p5_a22;
    ddp_imsv_rec.attribute14 := p5_a23;
    ddp_imsv_rec.attribute15 := p5_a24;
    ddp_imsv_rec.created_by := rosetta_g_miss_num_map(p5_a25);
    ddp_imsv_rec.creation_date := rosetta_g_miss_date_in_map(p5_a26);
    ddp_imsv_rec.last_updated_by := rosetta_g_miss_num_map(p5_a27);
    ddp_imsv_rec.last_update_date := rosetta_g_miss_date_in_map(p5_a28);
    ddp_imsv_rec.last_update_login := rosetta_g_miss_num_map(p5_a29);
    ddp_imsv_rec.start_date := rosetta_g_miss_date_in_map(p5_a30);
    ddp_imsv_rec.pkg_name := p5_a31;
    ddp_imsv_rec.proc_name := p5_a32;


    -- here's the delegated call to the old PL/SQL routine
    okl_ims_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a0 := rosetta_g_miss_num_map(ddx_imsv_rec.id);
    p6_a1 := rosetta_g_miss_num_map(ddx_imsv_rec.org_id);
    p6_a2 := rosetta_g_miss_num_map(ddx_imsv_rec.object_version_number);
    p6_a3 := ddx_imsv_rec.sfwt_flag;
    p6_a4 := ddx_imsv_rec.name;
    p6_a5 := ddx_imsv_rec.message_text;
    p6_a6 := rosetta_g_miss_num_map(ddx_imsv_rec.priority);
    p6_a7 := ddx_imsv_rec.description;
    p6_a8 := ddx_imsv_rec.end_date;
    p6_a9 := ddx_imsv_rec.attribute_category;
    p6_a10 := ddx_imsv_rec.attribute1;
    p6_a11 := ddx_imsv_rec.attribute2;
    p6_a12 := ddx_imsv_rec.attribute3;
    p6_a13 := ddx_imsv_rec.attribute4;
    p6_a14 := ddx_imsv_rec.attribute5;
    p6_a15 := ddx_imsv_rec.attribute6;
    p6_a16 := ddx_imsv_rec.attribute7;
    p6_a17 := ddx_imsv_rec.attribute8;
    p6_a18 := ddx_imsv_rec.attribute9;
    p6_a19 := ddx_imsv_rec.attribute10;
    p6_a20 := ddx_imsv_rec.attribute11;
    p6_a21 := ddx_imsv_rec.attribute12;
    p6_a22 := ddx_imsv_rec.attribute13;
    p6_a23 := ddx_imsv_rec.attribute14;
    p6_a24 := ddx_imsv_rec.attribute15;
    p6_a25 := rosetta_g_miss_num_map(ddx_imsv_rec.created_by);
    p6_a26 := ddx_imsv_rec.creation_date;
    p6_a27 := rosetta_g_miss_num_map(ddx_imsv_rec.last_updated_by);
    p6_a28 := ddx_imsv_rec.last_update_date;
    p6_a29 := rosetta_g_miss_num_map(ddx_imsv_rec.last_update_login);
    p6_a30 := ddx_imsv_rec.start_date;
    p6_a31 := ddx_imsv_rec.pkg_name;
    p6_a32 := ddx_imsv_rec.proc_name;
  end;
  ...
  as
    ddp_imsv_tbl okl_ims_pvt.imsv_tbl_type;
    ddx_imsv_tbl okl_ims_pvt.imsv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_ims_pvt_w.rosetta_table_copy_in_p8(ddp_imsv_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_ims_pvt_w.rosetta_table_copy_out_p8(ddx_imsv_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ims_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ims_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ims_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ims_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
