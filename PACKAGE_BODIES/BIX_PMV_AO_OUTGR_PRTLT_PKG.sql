--------------------------------------------------------
--  DDL for Package Body BIX_PMV_AO_OUTGR_PRTLT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BIX_PMV_AO_OUTGR_PRTLT_PKG" AS
/*$Header: bixooutp.plb 115.2 2004/03/08 07:38:00 pubalasu noship $ */
...
l_custom_rec.attribute_value:= 'BIX_PMV_AO_OUTCOMES';
l_custom_rec.attribute_type := BIS_PMV_PARAMETERS_PUB.BIND_TYPE;
l_custom_rec.attribute_data_type := BIS_PMV_PARAMETERS_PUB.VARCHAR2_BIND;
...
NULL;
END GET_SQL;
END BIX_PMV_AO_OUTGR_PRTLT_PKG;
