--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_CBR_QUALD_BNF
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_CBR_QUALD_BNF" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 13:01:20
 * Generated for API: ben_cbr_quald_bnf_api.DELETE_CBR_QUALD_BNF
 */
--
...
,P_CBR_QUALD_BNF_USER_KEY in varchar2) is
...
ben_cbr_quald_bnf_api.DELETE_CBR_QUALD_BNF
...
end hrdpp_DELETE_CBR_QUALD_BNF;
