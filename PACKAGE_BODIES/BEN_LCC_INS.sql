--------------------------------------------------------
--  DDL for Package Body BEN_LCC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LCC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_lcc_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.ler_chg_dpnt_cvg_ctfn_id       = p_rec.ler_chg_dpnt_cvg_ctfn_id
    and    t.effective_start_date =
             ben_lcc_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_ler_chg_dpnt_cvg_ctfn_f.created_by%TYPE;
  l_creation_date       ben_ler_chg_dpnt_cvg_ctfn_f.creation_date%TYPE;
  l_last_update_date   	ben_ler_chg_dpnt_cvg_ctfn_f.last_update_date%TYPE;
  l_last_updated_by     ben_ler_chg_dpnt_cvg_ctfn_f.last_updated_by%TYPE;
  l_last_update_login   ben_ler_chg_dpnt_cvg_ctfn_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_ler_chg_dpnt_cvg_ctfn_f
  --
  insert into ben_ler_chg_dpnt_cvg_ctfn_f
  ...
  Values
  (	p_rec.ler_chg_dpnt_cvg_ctfn_id,
...
--
 Cursor C_Sel1 is select ben_ler_chg_dpnt_cvg_ctfn_f_s.nextval from sys.dual;
--
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ler_chg_dpnt_cvg_ctfn_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  dt_api.validate_dt_mode
	(p_effective_date	   => p_effective_date,
	 ...
	 p_parent_key_value1       => p_rec.ler_chg_dpnt_cvg_id,
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_lcc_rec
  ...
  --
  p_ler_chg_dpnt_cvg_ctfn_id        	:= l_rec.ler_chg_dpnt_cvg_ctfn_id;
