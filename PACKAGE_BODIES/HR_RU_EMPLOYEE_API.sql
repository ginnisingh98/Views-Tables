--------------------------------------------------------
--  DDL for Package Body HR_RU_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_RU_EMPLOYEE_API" as
/* $Header: peemprui.pkb 120.0 2005/05/31 08:05:54 appldev noship $ */
  g_package CONSTANT varchar2(33) := 'hr_ru_employee_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_ru_employee >------------------------------|
-- -----------------------------------------------------------------------------
