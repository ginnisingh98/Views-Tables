--------------------------------------------------------
--  DDL for Package Body BEN_CCP_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CCP_RKU" as
/* $Header: beccprhi.pkb 120.1 2005/11/21 04:51:30 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_ccp_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_ccp_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_ccp_RKU;
