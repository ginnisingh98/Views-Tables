--------------------------------------------------------
--  DDL for Package Body OTA_TPC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TPC_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ota_tpc_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'OTA_TRAINING_PLAN_COSTS_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'OTA_TRAINING_PLAN_COSTS_FK2') Then
    fnd_message.set_name('OTA', 'OTA_13828_TPC_NO_TRAINING_PLAN');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','10');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'OTA_TRAINING_PLAN_COSTS_FK3') Then
    fnd_message.set_name('OTA', 'OTA_13829_TPC_NO_BOOKING');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','15');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'OTA_TRAINING_PLAN_COSTS_FK4') Then
    fnd_message.set_name('OTA', 'OTA_13834_TPC_NO_EVENT');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','20');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'OTA_TRAINING_PLAN_COSTS_PK') Then
    fnd_message.set_name('OTA', 'OTA_13828_TPC_NO_TRAINING_PLAN');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','25');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'OTA_TRAINING_PLAN_COSTS_UK2') Then
    fnd_message.set_name('OTA', 'OTA_13837_TPC_BAD_UNIQUE_COST');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','30');
    fnd_message.raise_error;
  Else
    fnd_message.set_name(801, 'HR_7877_API_INVALID_CONSTRAINT');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  --
  If (p_training_plan_cost_id is null and
    ...
    l_fct_ret := false;
  Else
    If (p_training_plan_cost_id
        = ota_tpc_shd.g_old_rec.training_plan_cost_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into ota_tpc_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> ota_tpc_shd.g_old_rec.object_version_number) Then
...
Exception
  When HR_Api.Object_Locked then
    ...
    fnd_message.set_token('TABLE_NAME', 'ota_training_plan_costs');
    fnd_message.raise_error;
End lck;
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  l_rec.tp_measurement_type_id           := p_tp_measurement_type_id;
  ...
  l_rec.tp_cost_information1             := p_tp_cost_information1;
  l_rec.tp_cost_information2             := p_tp_cost_information2;
  l_rec.tp_cost_information3             := p_tp_cost_information3;
  l_rec.tp_cost_information4             := p_tp_cost_information4;
  l_rec.tp_cost_information5             := p_tp_cost_information5;
  l_rec.tp_cost_information6             := p_tp_cost_information6;
  l_rec.tp_cost_information7             := p_tp_cost_information7;
  l_rec.tp_cost_information8             := p_tp_cost_information8;
  l_rec.tp_cost_information9             := p_tp_cost_information9;
  l_rec.tp_cost_information10            := p_tp_cost_information10;
  l_rec.tp_cost_information11            := p_tp_cost_information11;
  l_rec.tp_cost_information12            := p_tp_cost_information12;
  l_rec.tp_cost_information13            := p_tp_cost_information13;
  l_rec.tp_cost_information14            := p_tp_cost_information14;
  l_rec.tp_cost_information15            := p_tp_cost_information15;
  l_rec.tp_cost_information16            := p_tp_cost_information16;
  l_rec.tp_cost_information17            := p_tp_cost_information17;
  l_rec.tp_cost_information18            := p_tp_cost_information18;
  l_rec.tp_cost_information19            := p_tp_cost_information19;
  l_rec.tp_cost_information20            := p_tp_cost_information20;
  l_rec.tp_cost_information21            := p_tp_cost_information21;
  l_rec.tp_cost_information22            := p_tp_cost_information22;
  l_rec.tp_cost_information23            := p_tp_cost_information23;
  l_rec.tp_cost_information24            := p_tp_cost_information24;
  l_rec.tp_cost_information25            := p_tp_cost_information25;
  l_rec.tp_cost_information26            := p_tp_cost_information26;
  l_rec.tp_cost_information27            := p_tp_cost_information27;
  l_rec.tp_cost_information28            := p_tp_cost_information28;
  l_rec.tp_cost_information29            := p_tp_cost_information29;
  l_rec.tp_cost_information30            := p_tp_cost_information30;
  --
