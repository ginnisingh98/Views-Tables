--------------------------------------------------------
--  DDL for Package Body IRC_APL_PRFL_SNAPSHOTS_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_APL_PRFL_SNAPSHOTS_BE2" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  irc_apl_prfl_snapshots_be2.update_applicant_snapshot_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.apl_prfl_snapshots.update_applicant_snapshot';
...
end update_applicant_snapshot_a;
