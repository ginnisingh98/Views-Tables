--------------------------------------------------------
--  DDL for Package Body ONT_D2_TAX_EXEMPT_NUMBER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D2_TAX_EXEMPT_NUMBER" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D2_TAX_EXEMPT_NUMBER
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D2_TAX_EXEMPT_NUMBER';
