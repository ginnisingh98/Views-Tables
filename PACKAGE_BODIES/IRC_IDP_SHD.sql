--------------------------------------------------------
--  DDL for Package Body IRC_IDP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_IDP_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  irc_idp_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'IRC_DEFAULT_POSTINGS_FK2') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'IRC_DEFAULT_POSTINGS_FK3') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','10');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'IRC_DEFAULT_POSTINGS_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  --
  If (p_default_posting_id is null and
  ...
  Else
    If (p_default_posting_id
        = irc_idp_shd.g_old_rec.default_posting_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into irc_idp_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> irc_idp_shd.g_old_rec.object_version_number) Then
