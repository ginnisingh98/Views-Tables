--------------------------------------------------------
--  DDL for Package Body OKL_LRF_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_LRF_PVT_W" as
  /* $Header: OKLILRFB.pls 120.1 2005/07/05 12:28:54 asawanka noship $ */
  procedure rosetta_table_copy_in_p28(t out nocopy okl_lrf_pvt.lrfv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).lrt_id := a2(indx);
          t(ddindx).term_in_months := a3(indx);
          t(ddindx).residual_value_percent := a4(indx);
          t(ddindx).interest_rate := a5(indx);
          t(ddindx).lease_rate_factor := a6(indx);
          ...
          t(ddindx).is_new_flag := a28(indx);
          t(ddindx).rate_set_version_id := a29(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p28(t okl_lrf_pvt.lrfv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a29 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := t(ddindx).lrt_id;
          a3(indx) := t(ddindx).term_in_months;
          a4(indx) := t(ddindx).residual_value_percent;
          a5(indx) := t(ddindx).interest_rate;
          a6(indx) := t(ddindx).lease_rate_factor;
          ...
          a28(indx) := t(ddindx).is_new_flag;
          a29(indx) := t(ddindx).rate_set_version_id;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_in_p31(t out nocopy okl_lrf_pvt.lrf_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p31(t okl_lrf_pvt.lrf_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    , a3 out nocopy JTF_NUMBER_TABLE
    , a4 out nocopy JTF_NUMBER_TABLE
  ...
  as
    ddp_lrfv_rec okl_lrf_pvt.lrfv_rec_type;
    ddx_lrfv_rec okl_lrf_pvt.lrfv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_lrf_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a0 := ddx_lrfv_rec.id;
    p6_a1 := ddx_lrfv_rec.object_version_number;
    p6_a2 := ddx_lrfv_rec.lrt_id;
    p6_a3 := ddx_lrfv_rec.term_in_months;
    p6_a4 := ddx_lrfv_rec.residual_value_percent;
    p6_a5 := ddx_lrfv_rec.interest_rate;
    p6_a6 := ddx_lrfv_rec.lease_rate_factor;
    p6_a7 := ddx_lrfv_rec.created_by;
    p6_a8 := ddx_lrfv_rec.creation_date;
    p6_a9 := ddx_lrfv_rec.last_updated_by;
    p6_a10 := ddx_lrfv_rec.last_update_date;
    p6_a11 := ddx_lrfv_rec.last_update_login;
    p6_a12 := ddx_lrfv_rec.attribute_category;
    p6_a13 := ddx_lrfv_rec.attribute1;
    p6_a14 := ddx_lrfv_rec.attribute2;
    p6_a15 := ddx_lrfv_rec.attribute3;
    p6_a16 := ddx_lrfv_rec.attribute4;
    p6_a17 := ddx_lrfv_rec.attribute5;
    p6_a18 := ddx_lrfv_rec.attribute6;
    p6_a19 := ddx_lrfv_rec.attribute7;
    p6_a20 := ddx_lrfv_rec.attribute8;
    p6_a21 := ddx_lrfv_rec.attribute9;
    p6_a22 := ddx_lrfv_rec.attribute10;
    p6_a23 := ddx_lrfv_rec.attribute11;
    p6_a24 := ddx_lrfv_rec.attribute12;
    p6_a25 := ddx_lrfv_rec.attribute13;
    p6_a26 := ddx_lrfv_rec.attribute14;
    p6_a27 := ddx_lrfv_rec.attribute15;
    p6_a28 := ddx_lrfv_rec.is_new_flag;
    p6_a29 := ddx_lrfv_rec.rate_set_version_id;
  end;
  ...
  as
    ddp_lrfv_tbl okl_lrf_pvt.lrfv_tbl_type;
    ddx_lrfv_tbl okl_lrf_pvt.lrfv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_lrf_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_lrf_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_lrf_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_lrf_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
