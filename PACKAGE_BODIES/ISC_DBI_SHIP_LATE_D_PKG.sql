--------------------------------------------------------
--  DDL for Package Body ISC_DBI_SHIP_LATE_D_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ISC_DBI_SHIP_LATE_D_PKG" AS
/* $Header: ISCRG68B.pls 120.1 2005/10/17 16:49:13 hprathur noship $ */
...
BEGIN
  ...
  l_custom_rec.attribute_name := ':ISC_LATE_SCHEDULE_FLAG';
  l_custom_rec.attribute_value := to_char(l_late_schedule_flag);
