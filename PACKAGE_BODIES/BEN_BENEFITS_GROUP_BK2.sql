--------------------------------------------------------
--  DDL for Package Body BEN_BENEFITS_GROUP_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENEFITS_GROUP_BK2" as
...
procedure UPDATE_BENEFITS_GROUP_A
...
begin
hr_utility.set_location('Entering: BEN_BENEFITS_GROUP_BK2.UPDATE_BENEFITS_GROUP_A', 10);
hr_utility.set_location(' Leaving: BEN_BENEFITS_GROUP_BK2.UPDATE_BENEFITS_GROUP_A', 20);
end UPDATE_BENEFITS_GROUP_A;
procedure UPDATE_BENEFITS_GROUP_B
(P_BENFTS_GRP_ID in NUMBER
,P_BUSINESS_GROUP_ID in NUMBER
,P_NAME in VARCHAR2
,P_BNG_DESC in VARCHAR2
...
begin
hr_utility.set_location('Entering: BEN_BENEFITS_GROUP_BK2.UPDATE_BENEFITS_GROUP_B', 10);
hr_utility.set_location(' Leaving: BEN_BENEFITS_GROUP_BK2.UPDATE_BENEFITS_GROUP_B', 20);
end UPDATE_BENEFITS_GROUP_B;
end BEN_BENEFITS_GROUP_BK2;
