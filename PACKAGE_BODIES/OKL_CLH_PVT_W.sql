--------------------------------------------------------
--  DDL for Package Body OKL_CLH_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CLH_PVT_W" as
  /* $Header: OKLICLHB.pls 120.3 2005/09/23 12:15:02 varangan noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_clh_pvt.clhv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).request_id := rosetta_g_miss_num_map(a26(indx));
          t(ddindx).program_application_id := rosetta_g_miss_num_map(a27(indx));
          t(ddindx).program_id := rosetta_g_miss_num_map(a28(indx));
          ...
          t(ddindx).checklist_purpose_code := a35(indx);
          t(ddindx).decision_date := rosetta_g_miss_date_in_map(a36(indx));
          t(ddindx).checklist_obj_id := rosetta_g_miss_num_map(a37(indx));
          t(ddindx).checklist_obj_type_code := a38(indx);
          t(ddindx).ckl_id := rosetta_g_miss_num_map(a39(indx));
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p2(t okl_clh_pvt.clhv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a39 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a26(indx) := rosetta_g_miss_num_map(t(ddindx).request_id);
          a27(indx) := rosetta_g_miss_num_map(t(ddindx).program_application_id);
          a28(indx) := rosetta_g_miss_num_map(t(ddindx).program_id);
          ...
          a35(indx) := t(ddindx).checklist_purpose_code;
          a36(indx) := t(ddindx).decision_date;
          a37(indx) := rosetta_g_miss_num_map(t(ddindx).checklist_obj_id);
          a38(indx) := t(ddindx).checklist_obj_type_code;
          a39(indx) := rosetta_g_miss_num_map(t(ddindx).ckl_id);
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_clh_pvt.clh_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_VARCHAR2_TABLE_200
    , a3 JTF_VARCHAR2_TABLE_2000
    , a4 JTF_VARCHAR2_TABLE_600
  ...
  procedure rosetta_table_copy_out_p5(t okl_clh_pvt.clh_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_VARCHAR2_TABLE_200
    , a3 out nocopy JTF_VARCHAR2_TABLE_2000
    , a4 out nocopy JTF_VARCHAR2_TABLE_600
  ...
  as
    ddp_clhv_rec okl_clh_pvt.clhv_rec_type;
    ddx_clhv_rec okl_clh_pvt.clhv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_clh_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_clhv_tbl okl_clh_pvt.clhv_tbl_type;
    ddx_clhv_tbl okl_clh_pvt.clhv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_clh_pvt_w.rosetta_table_copy_in_p2(ddp_clhv_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_clh_pvt_w.rosetta_table_copy_out_p2(ddx_clhv_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_clh_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_clh_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_clh_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_clh_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
