--------------------------------------------------------
--  DDL for Package Body PER_PMS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PMS_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_pms_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PER_PERSONAL_SCORECAREDS_PK') Then
...
Begin
  ...
  Else
    If (p_scorecard_id
        = per_pms_shd.g_old_rec.scorecard_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_pms_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_pms_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  l_rec.scorecard_name                   := p_scorecard_name;
