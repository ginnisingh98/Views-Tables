--------------------------------------------------------
--  DDL for Package Body BEN_DCO_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DCO_RKI" as
/* $Header: bedcorhi.pkb 120.2 2006/03/30 23:58:46 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/01/04 08:38:28 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: BEN_DCO_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: BEN_DCO_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end BEN_DCO_RKI;
