--------------------------------------------------------
--  DDL for Package Body BEN_ELIGIBILITY_RULE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIGIBILITY_RULE_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_ELIGIBILITY_RULE_BK1.CREATE_ELIGIBILITY_RULE_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIGIBILITY_RULE_BK1.CREATE_ELIGIBILITY_RULE_A', 20);
end CREATE_ELIGIBILITY_RULE_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIGIBILITY_RULE_BK1.CREATE_ELIGIBILITY_RULE_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIGIBILITY_RULE_BK1.CREATE_ELIGIBILITY_RULE_B', 20);
end CREATE_ELIGIBILITY_RULE_B;
