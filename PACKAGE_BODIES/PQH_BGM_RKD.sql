--------------------------------------------------------
--  DDL for Package Body PQH_BGM_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_BGM_RKD" as
...
begin
hr_utility.set_location('Entering: PQH_BGM_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PQH_BGM_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PQH_BGM_RKD;
