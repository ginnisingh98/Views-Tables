--------------------------------------------------------
--  DDL for Package Body IRC_CMP_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_CMP_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  irc_cmp_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_communication_property_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_communication_property_id  in  number) is
--
...
Begin
  ...
  --
  irc_cmp_ins.g_communication_property_id_i := p_communication_property_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: irc_comm_properties
  --
  insert into irc_comm_properties
...
--
  Cursor C_Sel1 is select irc_comm_properties_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from irc_comm_properties
     where communication_property_id =
             irc_cmp_ins.g_communication_property_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (irc_cmp_ins.g_communication_property_id_i is not null) Then
    --
    ...
    p_rec.communication_property_id :=
      irc_cmp_ins.g_communication_property_id_i;
    irc_cmp_ins.g_communication_property_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.communication_property_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  irc_cmp_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  irc_cmp_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  -- irc_cmp_ins.post_insert
  --   (p_effective_date
  --   ,p_rec
  --   );
  --
...
Begin
  ...
  --
  p_communication_property_id := l_rec.communication_property_id;
