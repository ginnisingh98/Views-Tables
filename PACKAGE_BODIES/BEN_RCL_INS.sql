--------------------------------------------------------
--  DDL for Package Body BEN_RCL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_RCL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_rcl_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_rltd_per_chg_cs_ler_f.created_by%TYPE;
  l_creation_date       ben_rltd_per_chg_cs_ler_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_rltd_per_chg_cs_ler_f
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.rltd_per_chg_cs_ler_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_rcl_rec
  ...
  --
  p_rltd_per_chg_cs_ler_id      := l_rec.rltd_per_chg_cs_ler_id;
