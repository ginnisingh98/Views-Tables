--------------------------------------------------------
--  DDL for Package Body HR_SG_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SG_APPLICANT_API" as
/* $Header: hrsgwraa.pkb 120.5 2007/10/26 01:37:21 jalin ship $ */

--
g_package  VARCHAR2(33) := 'hr_sg_applicant_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_sg_applicant >------------------------------|
-- -----------------------------------------------------------------------------
PROCEDURE create_sg_applicant
  ...
  --
  l_proc                 VARCHAR2(72) := g_package||'create_sg_applicant';
...
begin
  ...
  ,p_vacancy_id                   => p_vacancy_id /*6393528 */
  --
