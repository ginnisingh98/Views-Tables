--------------------------------------------------------
--  DDL for Package Body OTA_CMS_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CMS_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_cms_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_chat_message_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_chat_message_id  in  number) is
--
...
Begin
  ...
  --
  ota_cms_ins.g_chat_message_id_i := p_chat_message_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: ota_chat_messages
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (ota_cms_ins.g_chat_message_id_i is not null) Then
    --
    ...
    p_rec.chat_message_id :=
      ota_cms_ins.g_chat_message_id_i;
    ota_cms_ins.g_chat_message_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.chat_message_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  p_chat_message_id := l_rec.chat_message_id;
