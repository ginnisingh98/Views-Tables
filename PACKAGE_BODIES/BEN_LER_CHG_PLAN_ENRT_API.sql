--------------------------------------------------------
--  DDL for Package Body BEN_LER_CHG_PLAN_ENRT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LER_CHG_PLAN_ENRT_API" as
/* $Header: belprapi.pkb 115.3 2002/12/16 07:02:43 rpgupta ship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_ler_chg_plan_enrt_api.';
--
-- ----------------------------------------------------------------------------
...
procedure create_ler_chg_plan_enrt
  ...
  --
  l_ler_chg_plip_enrt_id ben_ler_chg_plip_enrt_f.ler_chg_plip_enrt_id%TYPE;
  l_effective_start_date ben_ler_chg_plip_enrt_f.effective_start_date%TYPE;
  l_effective_end_date ben_ler_chg_plip_enrt_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_ler_chg_plan_enrt';
  l_object_version_number ben_ler_chg_plip_enrt_f.object_version_number%TYPE;
  --
begin
  --
  ...
  --
  savepoint create_ler_chg_plan_enrt;
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_ler_chg_plan_enrt
    --
    ben_ler_chg_plan_enrt_bk1.create_ler_chg_plan_enrt_b
      (
      ...
      ,p_enrt_rl                        =>  p_enrt_rl
      ,p_enrt_cd                        =>  p_enrt_cd
      ,p_lpr_attribute_category         =>  p_lpr_attribute_category
      ,p_lpr_attribute1                 =>  p_lpr_attribute1
      ,p_lpr_attribute2                 =>  p_lpr_attribute2
      ,p_lpr_attribute3                 =>  p_lpr_attribute3
      ,p_lpr_attribute4                 =>  p_lpr_attribute4
      ,p_lpr_attribute5                 =>  p_lpr_attribute5
      ,p_lpr_attribute6                 =>  p_lpr_attribute6
      ,p_lpr_attribute7                 =>  p_lpr_attribute7
      ,p_lpr_attribute8                 =>  p_lpr_attribute8
      ,p_lpr_attribute9                 =>  p_lpr_attribute9
      ,p_lpr_attribute10                =>  p_lpr_attribute10
      ,p_lpr_attribute11                =>  p_lpr_attribute11
      ,p_lpr_attribute12                =>  p_lpr_attribute12
      ,p_lpr_attribute13                =>  p_lpr_attribute13
      ,p_lpr_attribute14                =>  p_lpr_attribute14
      ,p_lpr_attribute15                =>  p_lpr_attribute15
      ,p_lpr_attribute16                =>  p_lpr_attribute16
      ,p_lpr_attribute17                =>  p_lpr_attribute17
      ,p_lpr_attribute18                =>  p_lpr_attribute18
      ,p_lpr_attribute19                =>  p_lpr_attribute19
      ,p_lpr_attribute20                =>  p_lpr_attribute20
      ,p_lpr_attribute21                =>  p_lpr_attribute21
      ,p_lpr_attribute22                =>  p_lpr_attribute22
      ,p_lpr_attribute23                =>  p_lpr_attribute23
      ,p_lpr_attribute24                =>  p_lpr_attribute24
      ,p_lpr_attribute25                =>  p_lpr_attribute25
      ,p_lpr_attribute26                =>  p_lpr_attribute26
      ,p_lpr_attribute27                =>  p_lpr_attribute27
      ,p_lpr_attribute28                =>  p_lpr_attribute28
      ,p_lpr_attribute29                =>  p_lpr_attribute29
      ,p_lpr_attribute30                =>  p_lpr_attribute30
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_ler_chg_plan_enrt'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_ler_chg_plan_enrt
    --
  end;
  --
  ben_lpr_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_ler_chg_plan_enrt
    --
    ben_ler_chg_plan_enrt_bk1.create_ler_chg_plan_enrt_a
      (
       p_ler_chg_plip_enrt_id           =>  l_ler_chg_plip_enrt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_ler_chg_plan_enrt
    --
  end;
  --
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_ler_chg_plan_enrt;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
    --
    p_ler_chg_plip_enrt_id := null;
  ...
  when others then
    ...
    --
    ROLLBACK TO create_ler_chg_plan_enrt;
    p_ler_chg_plip_enrt_id := null; --nocopy change
...
procedure update_ler_chg_plan_enrt
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_ler_chg_plan_enrt';
  l_object_version_number ben_ler_chg_plip_enrt_f.object_version_number%TYPE;
  l_effective_start_date ben_ler_chg_plip_enrt_f.effective_start_date%TYPE;
  l_effective_end_date ben_ler_chg_plip_enrt_f.effective_end_date%TYPE;
  --
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_ler_chg_plan_enrt;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_ler_chg_plan_enrt
    --
    ben_ler_chg_plan_enrt_bk2.update_ler_chg_plan_enrt_b
      (
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_ler_chg_plan_enrt'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_ler_chg_plan_enrt
    --
  end;
  --
  ben_lpr_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_ler_chg_plan_enrt
    --
    ben_ler_chg_plan_enrt_bk2.update_ler_chg_plan_enrt_a
      (
       p_ler_chg_plip_enrt_id           =>  p_ler_chg_plip_enrt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_ler_chg_plan_enrt
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO update_ler_chg_plan_enrt;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint delete_ler_chg_plan_enrt;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_ler_chg_plan_enrt
    --
    ben_ler_chg_plan_enrt_bk3.delete_ler_chg_plan_enrt_b
      (
       p_ler_chg_plip_enrt_id           =>  p_ler_chg_plip_enrt_id
      ,p_object_version_number          =>  p_object_version_number
    ,p_effective_date                      => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_ler_chg_plan_enrt'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_ler_chg_plan_enrt
    --
  end;
  --
  ben_lpr_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_ler_chg_plan_enrt
    --
    ben_ler_chg_plan_enrt_bk3.delete_ler_chg_plan_enrt_a
      (
       p_ler_chg_plip_enrt_id           =>  p_ler_chg_plip_enrt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_ler_chg_plan_enrt
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO delete_ler_chg_plan_enrt;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
