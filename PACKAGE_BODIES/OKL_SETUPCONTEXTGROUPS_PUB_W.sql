--------------------------------------------------------
--  DDL for Package Body OKL_SETUPCONTEXTGROUPS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPCONTEXTGROUPS_PUB_W" as
  /* $Header: OKLUSCGB.pls 120.1 2005/07/18 15:59:26 viselvar noship $ */
  ...
  as
    ddp_cgrv_rec okl_setupcontextgroups_pub.cgrv_rec_type;
    ddx_no_data_found boolean;
    ddx_cgrv_rec okl_setupcontextgroups_pub.cgrv_rec_type;
  ...
  begin
    ...
    okl_setupcontextgroups_pub.get_rec(ddp_cgrv_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_cgrv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_cgrv_rec.id);
    p4_a1 := rosetta_g_miss_num_map(ddx_cgrv_rec.object_version_number);
    p4_a2 := ddx_cgrv_rec.sfwt_flag;
    p4_a3 := ddx_cgrv_rec.name;
    p4_a4 := ddx_cgrv_rec.description;
    p4_a5 := rosetta_g_miss_num_map(ddx_cgrv_rec.created_by);
    p4_a6 := ddx_cgrv_rec.creation_date;
    p4_a7 := rosetta_g_miss_num_map(ddx_cgrv_rec.last_updated_by);
    p4_a8 := ddx_cgrv_rec.last_update_date;
    p4_a9 := rosetta_g_miss_num_map(ddx_cgrv_rec.last_update_login);
  end;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupcontextgroups_pub.insert_contextgroups(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupcontextgroups_pub.update_contextgroups(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
