--------------------------------------------------------
--  DDL for Package Body FARX_C_INVMISS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FARX_C_INVMISS_PKG" as
/* $Header: farxcimb.pls 120.2.12010000.2 2009/07/19 13:46:28 glchen ship $ */

PROCEDURE MISS_ASSET (
  errbuf	 out nocopy varchar2,
  retcode	 out nocopy number,
  argument1		in	varchar2,   -- inventory name
...
--  and fcp.concurrent_program_name = 'RXFAPIMA';

  h_request_id := fnd_global.conc_request_id;
  fnd_profile.get('USER_ID',h_user_id);

  farx_inv_miss_pkg.miss_asset (
	inventory_name => argument1,
...
PROCEDURE COMPARE (
  ...
  retcode	 out nocopy number,
  argument1		in	varchar2,   -- inventory name
  argument2             in      varchar2 default null, -- category flex struc
  argument3             in      varchar2    default null, -- category
  argument4        in      varchar2	default null,  -- location flex struc
  argument5        in      varchar2 default null, -- location
  argument6        in  varchar2  default  null,
  argument7        in  varchar2  default  null,
  argument8        in  varchar2  default  null,
  argument9        in  varchar2  default  null,
