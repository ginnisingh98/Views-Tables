--------------------------------------------------------
--  DDL for Package Body HR_ELECTIONS_API_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ELECTIONS_API_BK2" as
...
begin
hr_utility.set_location('Entering: HR_ELECTIONS_API_BK2.UPDATE_ELECTION_INFORMATION_A', 10);
hr_utility.set_location(' Leaving: HR_ELECTIONS_API_BK2.UPDATE_ELECTION_INFORMATION_A', 20);
end UPDATE_ELECTION_INFORMATION_A;
...
begin
hr_utility.set_location('Entering: HR_ELECTIONS_API_BK2.UPDATE_ELECTION_INFORMATION_B', 10);
hr_utility.set_location(' Leaving: HR_ELECTIONS_API_BK2.UPDATE_ELECTION_INFORMATION_B', 20);
end UPDATE_ELECTION_INFORMATION_B;
