--------------------------------------------------------
--  DDL for Package Body GHR_COMPLAINT_BK_1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_COMPLAINT_BK_1" as
...
begin
hr_utility.set_location('Entering: GHR_COMPLAINT_BK_1.CREATE_COMPLAINT_A', 10);
hr_utility.set_location(' Leaving: GHR_COMPLAINT_BK_1.CREATE_COMPLAINT_A', 20);
end CREATE_COMPLAINT_A;
...
begin
hr_utility.set_location('Entering: GHR_COMPLAINT_BK_1.CREATE_COMPLAINT_B', 10);
hr_utility.set_location(' Leaving: GHR_COMPLAINT_BK_1.CREATE_COMPLAINT_B', 20);
end CREATE_COMPLAINT_B;
