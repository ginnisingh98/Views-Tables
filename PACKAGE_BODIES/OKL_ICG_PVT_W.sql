--------------------------------------------------------
--  DDL for Package Body OKL_ICG_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ICG_PVT_W" as
  /* $Header: OKLIICGB.pls 120.1 2005/07/13 09:26:09 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_icg_pvt.icg_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).iay_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).object_version_number := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).date_from := rosetta_g_miss_date_in_map(a4(indx));
          t(ddindx).date_to := rosetta_g_miss_date_in_map(a5(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_icg_pvt.icg_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a10 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).iay_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).object_version_number);
          a4(indx) := t(ddindx).date_from;
          a5(indx) := t(ddindx).date_to;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_icg_pvt.icgv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p5(t okl_icg_pvt.icgv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  as
    ddp_icgv_rec okl_icg_pvt.icgv_rec_type;
    ddx_icgv_rec okl_icg_pvt.icgv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_icg_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_icgv_tbl okl_icg_pvt.icgv_tbl_type;
    ddx_icgv_tbl okl_icg_pvt.icgv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_icg_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_icg_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_icg_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_icg_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
