--------------------------------------------------------
--  DDL for Package Body HR_EXU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_EXU_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_exu_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Insert the row into: hr_exception_usages
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.exception_usage_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Procedure ins
  (
  p_exception_usage_id           out nocopy number,
...
Begin
  ...
  --
  p_exception_usage_id := l_rec.exception_usage_id;
