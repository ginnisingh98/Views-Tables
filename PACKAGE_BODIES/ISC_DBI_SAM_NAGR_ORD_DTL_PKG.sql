--------------------------------------------------------
--  DDL for Package Body ISC_DBI_SAM_NAGR_ORD_DTL_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ISC_DBI_SAM_NAGR_ORD_DTL_PKG" as
/* $Header: ISCRGCMB.pls 120.8 2006/05/15 14:32:52 scheung noship $ */
...
org_ou_id, customer_id, item_id, sales_grp_id, resource_id,
isc_attribute_1,isc_attribute_2,isc_attribute_4,isc_measure_1,isc_measure_2,isc_attribute_11
from
(select f.order_number isc_attribute_1,
        f.line_number isc_attribute_2,
        trunc(f.fulfilled_date) isc_attribute_4,
        f.header_id isc_attribute_11,
        f.org_ou_id,
        f.customer_id,
        f.inventory_item_id||''-''||f.item_inv_org_id item_id,
        sc.sales_grp_id,
        sc.resource_id,
...
and f.unit_selling_price <> 0
and f.charge_periodicity_code is NULL
and f.blanket_line_number is null
