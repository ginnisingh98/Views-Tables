--------------------------------------------------------
--  DDL for Package Body PER_QUALIFICATIONS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_QUALIFICATIONS_BK2" as
...
begin
hr_utility.set_location('Entering: PER_QUALIFICATIONS_BK2.UPDATE_QUALIFICATION_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
per_qualifications_be2.UPDATE_QUALIFICATION_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_QUALIFICATION', 'AP');
hr_utility.set_location(' Leaving: PER_QUALIFICATIONS_BK2.UPDATE_QUALIFICATION_A', 20);
...
l_legislation_code   varchar2(30);
begin
hr_utility.set_location('Entering: PER_QUALIFICATIONS_BK2.UPDATE_QUALIFICATION_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_leg_hooks then
l_legislation_code := PER_QUA_BUS.return_legislation_code(P_QUALIFICATION_ID => P_QUALIFICATION_ID
);
if l_legislation_code = 'FI' then
HR_FI_VALIDATE_PKG.QUAL_UPDATE_VALIDATE
(P_QUA_INFORMATION_CATEGORY => P_QUA_INFORMATION_CATEGORY
,P_QUALIFICATION_ID => P_QUALIFICATION_ID
,P_QUA_INFORMATION1 => P_QUA_INFORMATION1
,P_QUA_INFORMATION2 => P_QUA_INFORMATION2
...
HR_NO_VALIDATE_PKG.QUAL_UPDATE_VALIDATE
(P_QUA_INFORMATION_CATEGORY => P_QUA_INFORMATION_CATEGORY
,P_QUALIFICATION_ID => P_QUALIFICATION_ID
,P_QUALIFICATION_TYPE_ID => P_QUALIFICATION_TYPE_ID
,P_QUA_INFORMATION1 => P_QUA_INFORMATION1
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_QUALIFICATION', 'BP');
hr_utility.set_location(' Leaving: PER_QUALIFICATIONS_BK2.UPDATE_QUALIFICATION_B', 20);
end UPDATE_QUALIFICATION_B;
