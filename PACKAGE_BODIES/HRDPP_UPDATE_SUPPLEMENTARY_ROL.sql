--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_SUPPLEMENTARY_ROL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_SUPPLEMENTARY_ROL" as
/*
 * Generated by hr_pump_meta_mapper at: 2013/08/29 22:08:28
 * Generated for API: PER_SUPPLEMENTARY_ROLE_API.UPDATE_SUPPLEMENTARY_ROLE
 */
--
...
,I_START_DATE in varchar2 default 'N'
,P_END_DATE in date default null
,I_END_DATE in varchar2 default 'N'
,P_CONFIDENTIAL_DATE in date default null
,I_CONFIDENTIAL_DATE in varchar2 default 'N'
,P_EMP_RIGHTS_FLAG in varchar2 default null
,P_END_OF_RIGHTS_DATE in date default null
,I_END_OF_RIGHTS_DATE in varchar2 default 'N'
...
,P_OLD_END_DATE in date default null
,I_OLD_END_DATE in varchar2 default 'N'
,P_ROLE_USER_KEY in varchar2) is
...
,p_link_value
,dc(P_EFFECTIVE_DATE)
,dd(P_START_DATE,I_START_DATE)
,dd(P_END_DATE,I_END_DATE)
,dd(P_CONFIDENTIAL_DATE,I_CONFIDENTIAL_DATE)
,P_EMP_RIGHTS_FLAG
,dd(P_END_OF_RIGHTS_DATE,I_END_OF_RIGHTS_DATE)
...
,dd(P_OLD_END_DATE,I_OLD_END_DATE)
,P_ROLE_USER_KEY);
...
decode(l.pval007,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval007,'YES_NO',d(l.pval001),vn)) p7,
l.pval007 d7,
...
L_ROLE_ID := 
hr_pump_get.get_role_id
(P_ROLE_USER_KEY => c.p51);
end if;
--
if c.p51 is null then
...
,P_START_DATE => c.p2
,P_END_DATE => c.p3
,P_CONFIDENTIAL_DATE => c.p4
,P_EMP_RIGHTS_FLAG => c.p5
,P_END_OF_RIGHTS_DATE => c.p6
,P_PRIMARY_CONTACT_FLAG => c.p7
...
,P_ATTRIBUTE19 => c.p27
,P_ATTRIBUTE20 => c.p28
,P_ROLE_INFORMATION_CATEGORY => c.p29
,P_ROLE_INFORMATION1 => c.p30
,P_ROLE_INFORMATION2 => c.p31
,P_ROLE_INFORMATION3 => c.p32
,P_ROLE_INFORMATION4 => c.p33
,P_ROLE_INFORMATION5 => c.p34
,P_ROLE_INFORMATION6 => c.p35
,P_ROLE_INFORMATION7 => c.p36
,P_ROLE_INFORMATION8 => c.p37
,P_ROLE_INFORMATION9 => c.p38
,P_ROLE_INFORMATION10 => c.p39
,P_ROLE_INFORMATION11 => c.p40
,P_ROLE_INFORMATION12 => c.p41
,P_ROLE_INFORMATION13 => c.p42
,P_ROLE_INFORMATION14 => c.p43
,P_ROLE_INFORMATION15 => c.p44
,P_ROLE_INFORMATION16 => c.p45
,P_ROLE_INFORMATION17 => c.p46
,P_ROLE_INFORMATION18 => c.p47
,P_ROLE_INFORMATION19 => c.p48
,P_ROLE_INFORMATION20 => c.p49
,P_OLD_END_DATE => c.p50);
...
end hrdpp_UPDATE_SUPPLEMENTARY_ROL;
