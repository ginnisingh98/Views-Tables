--------------------------------------------------------
--  DDL for Package Body OKL_CASH_ALLCTN_RLS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CASH_ALLCTN_RLS_PUB_W" as
  /* $Header: OKLUCATB.pls 120.1 2005/07/07 12:48:57 asawanka noship $ */
  ...
  procedure insert_cash_allctn_rls(p_api_version  NUMBER
  ...
  as
    ddp_catv_tbl okl_cash_allctn_rls_pub.catv_tbl_type;
    ddx_catv_tbl okl_cash_allctn_rls_pub.catv_tbl_type;
  ...
  begin
    ...
    okl_cash_allctn_rls_pub.insert_cash_allctn_rls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_catv_rec okl_cash_allctn_rls_pub.catv_rec_type;
    ddx_catv_rec okl_cash_allctn_rls_pub.catv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_cash_allctn_rls(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_cash_allctn_rls_pub.lock_cash_allctn_rls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_cash_allctn_rls(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_cash_allctn_rls_pub.update_cash_allctn_rls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_cash_allctn_rls(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_cash_allctn_rls_pub.delete_cash_allctn_rls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_cash_allctn_rls(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_cash_allctn_rls_pub.validate_cash_allctn_rls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
