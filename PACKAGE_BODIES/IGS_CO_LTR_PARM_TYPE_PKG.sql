--------------------------------------------------------
--  DDL for Package Body IGS_CO_LTR_PARM_TYPE_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_CO_LTR_PARM_TYPE_PKG" AS
/* $Header: IGSLI09B.pls 115.5 2002/11/29 01:04:25 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_co_ltr_parm_type%ROWTYPE;
  new_references igs_co_ltr_parm_type%ROWTYPE;
  ...
  */
  BEGIN
    ...
    igs_co_ltr_param_pkg.get_fk_igs_co_ltr_parm_type (
      old_references.letter_parameter_type
    );

    igs_co_ltr_pr_rstcn_pkg.get_fk_igs_co_ltr_parm_type (
      old_references.letter_parameter_type
    );
  ...
  */
  ...
  BEGIN
    ...
    INSERT INTO igs_co_ltr_parm_type (
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND (tlinfo.s_letter_parameter_type = x_s_letter_parameter_type)
  ...
  */
  ...
  BEGIN
    ...
    UPDATE igs_co_ltr_parm_type
      SET
        description                       = new_references.description,
        s_letter_parameter_type           = new_references.s_letter_parameter_type,
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_co_ltr_parm_type
    WHERE rowid = x_rowid;
