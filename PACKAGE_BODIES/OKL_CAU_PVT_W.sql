--------------------------------------------------------
--  DDL for Package Body OKL_CAU_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CAU_PVT_W" as
  /* $Header: OKLECAUB.pls 115.1 2002/12/24 20:17:29 bvaghela noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_cau_pvt.cauv_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p2(t okl_cau_pvt.cauv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_cau_pvt.cau_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_VARCHAR2_TABLE_200
    , a2 JTF_VARCHAR2_TABLE_2000
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_VARCHAR2_TABLE_100
  ...
  procedure rosetta_table_copy_out_p5(t okl_cau_pvt.cau_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_VARCHAR2_TABLE_200
    , a2 out nocopy JTF_VARCHAR2_TABLE_2000
    , a3 out nocopy JTF_NUMBER_TABLE
    , a4 out nocopy JTF_VARCHAR2_TABLE_100
  ...
  as
    ddp_cauv_rec okl_cau_pvt.cauv_rec_type;
    ddx_cauv_rec okl_cau_pvt.cauv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ddp_cauv_rec.id := rosetta_g_miss_num_map(p5_a0);
    ddp_cauv_rec.name := p5_a1;
    ddp_cauv_rec.description := p5_a2;
    ddp_cauv_rec.object_version_number := rosetta_g_miss_num_map(p5_a3);
    ddp_cauv_rec.attribute_category := p5_a4;
    ddp_cauv_rec.attribute1 := p5_a5;
    ddp_cauv_rec.attribute2 := p5_a6;
    ddp_cauv_rec.attribute3 := p5_a7;
    ddp_cauv_rec.attribute4 := p5_a8;
    ddp_cauv_rec.attribute5 := p5_a9;
    ddp_cauv_rec.attribute6 := p5_a10;
    ddp_cauv_rec.attribute7 := p5_a11;
    ddp_cauv_rec.attribute8 := p5_a12;
    ddp_cauv_rec.attribute9 := p5_a13;
    ddp_cauv_rec.attribute10 := p5_a14;
    ddp_cauv_rec.attribute11 := p5_a15;
    ddp_cauv_rec.attribute12 := p5_a16;
    ddp_cauv_rec.attribute13 := p5_a17;
    ddp_cauv_rec.attribute14 := p5_a18;
    ddp_cauv_rec.attribute15 := p5_a19;
    ddp_cauv_rec.org_id := rosetta_g_miss_num_map(p5_a20);
    ddp_cauv_rec.created_by := rosetta_g_miss_num_map(p5_a21);
    ddp_cauv_rec.creation_date := rosetta_g_miss_date_in_map(p5_a22);
    ddp_cauv_rec.last_updated_by := rosetta_g_miss_num_map(p5_a23);
    ddp_cauv_rec.last_update_date := rosetta_g_miss_date_in_map(p5_a24);
    ddp_cauv_rec.last_update_login := rosetta_g_miss_num_map(p5_a25);


    -- here's the delegated call to the old PL/SQL routine
    okl_cau_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a0 := rosetta_g_miss_num_map(ddx_cauv_rec.id);
    p6_a1 := ddx_cauv_rec.name;
    p6_a2 := ddx_cauv_rec.description;
    p6_a3 := rosetta_g_miss_num_map(ddx_cauv_rec.object_version_number);
    p6_a4 := ddx_cauv_rec.attribute_category;
    p6_a5 := ddx_cauv_rec.attribute1;
    p6_a6 := ddx_cauv_rec.attribute2;
    p6_a7 := ddx_cauv_rec.attribute3;
    p6_a8 := ddx_cauv_rec.attribute4;
    p6_a9 := ddx_cauv_rec.attribute5;
    p6_a10 := ddx_cauv_rec.attribute6;
    p6_a11 := ddx_cauv_rec.attribute7;
    p6_a12 := ddx_cauv_rec.attribute8;
    p6_a13 := ddx_cauv_rec.attribute9;
    p6_a14 := ddx_cauv_rec.attribute10;
    p6_a15 := ddx_cauv_rec.attribute11;
    p6_a16 := ddx_cauv_rec.attribute12;
    p6_a17 := ddx_cauv_rec.attribute13;
    p6_a18 := ddx_cauv_rec.attribute14;
    p6_a19 := ddx_cauv_rec.attribute15;
    p6_a20 := rosetta_g_miss_num_map(ddx_cauv_rec.org_id);
    p6_a21 := rosetta_g_miss_num_map(ddx_cauv_rec.created_by);
    p6_a22 := ddx_cauv_rec.creation_date;
    p6_a23 := rosetta_g_miss_num_map(ddx_cauv_rec.last_updated_by);
    p6_a24 := ddx_cauv_rec.last_update_date;
    p6_a25 := rosetta_g_miss_num_map(ddx_cauv_rec.last_update_login);
  end;
  ...
  as
    ddp_cauv_tbl okl_cau_pvt.cauv_tbl_type;
    ddx_cauv_tbl okl_cau_pvt.cauv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_cau_pvt_w.rosetta_table_copy_in_p2(ddp_cauv_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_cau_pvt_w.rosetta_table_copy_out_p2(ddx_cauv_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_cau_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_cau_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_cau_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_cau_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
