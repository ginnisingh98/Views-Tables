--------------------------------------------------------
--  DDL for Package Body BEN_EXT_DEFN_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EXT_DEFN_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_EXT_DEFN_BK2.UPDATE_EXT_DEFN_A', 10);
hr_utility.set_location(' Leaving: BEN_EXT_DEFN_BK2.UPDATE_EXT_DEFN_A', 20);
end UPDATE_EXT_DEFN_A;
...
begin
hr_utility.set_location('Entering: BEN_EXT_DEFN_BK2.UPDATE_EXT_DEFN_B', 10);
hr_utility.set_location(' Leaving: BEN_EXT_DEFN_BK2.UPDATE_EXT_DEFN_B', 20);
end UPDATE_EXT_DEFN_B;
