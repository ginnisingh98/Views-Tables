--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_MX_LOC_PERSON_ADD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_MX_LOC_PERSON_ADD" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:06
 * Generated for API: HR_PERSON_ADDRESS_API.CREATE_MX_LOC_PERSON_ADDRESS
 */
--
...
decode(l.pval013,cn,vn,
 hr_pump_get.gl(l.pval013,'PER_MX_STATE_CODES',d(l.pval001),vn)) p13,
...
HR_PERSON_ADDRESS_API.CREATE_MX_LOC_PERSON_ADDRESS
...
,P_STREET_NAME_AND_NUM => c.p8
,P_NEIGHBORHOOD => c.p9
,P_MUNICIPALITY => c.p10
,P_POSTAL_CODE => c.p11
,P_CITY => c.p12
,P_STATE => c.p13
,P_COUNTRY => L_COUNTRY
...
,P_OBJECT_VERSION_NUMBER => c.p47);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p46,L_ADDRESS_ID);
--
...
end hrdpp_CREATE_MX_LOC_PERSON_ADD;
