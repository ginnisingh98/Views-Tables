--------------------------------------------------------
--  DDL for Package Body PER_CEO_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CEO_RKU" as
/* $Header: peceorhi.pkb 120.1 2005/09/30 00:35 generated noship $ */
...
begin
hr_utility.set_location('Entering: PER_CEO_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PER_CEO_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PER_CEO_RKU;
