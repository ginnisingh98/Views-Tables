--------------------------------------------------------
--  DDL for Package Body HR_FI_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_FI_CONTINGENT_WORKER_API" AS
  /* $Header: pecwkfii.pkb 120.1.12000000.2 2007/02/14 12:19:49 dbehera ship $ */
--
	-- Package Variables
	g_package  varchar2(33) := '  hr_fi_contingent_worker_api.';
