--------------------------------------------------------
--  DDL for Package Body BEN_FULL_PRT_TIME_RATE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_FULL_PRT_TIME_RATE_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_FULL_PRT_TIME_RATE_BK1.CREATE_FULL_PRT_TIME_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_FULL_PRT_TIME_RATE_BK1.CREATE_FULL_PRT_TIME_RATE_A', 20);
end CREATE_FULL_PRT_TIME_RATE_A;
...
begin
hr_utility.set_location('Entering: BEN_FULL_PRT_TIME_RATE_BK1.CREATE_FULL_PRT_TIME_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_FULL_PRT_TIME_RATE_BK1.CREATE_FULL_PRT_TIME_RATE_B', 20);
end CREATE_FULL_PRT_TIME_RATE_B;
