--------------------------------------------------------
--  DDL for Package Body OKL_AGB_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AGB_PVT_W" as
  /* $Header: OKLIAGBB.pls 120.1 2005/07/07 13:44:32 dkagrawa noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_agb_pvt.agb_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_DATE_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).date_balance := rosetta_g_miss_date_in_map(a3(indx));
          t(ddindx).acc_group_id := rosetta_g_miss_num_map(a4(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_agb_pvt.agb_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a10 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a3(indx) := t(ddindx).date_balance;
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).acc_group_id);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_agb_pvt.agbv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).acc_group_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).khr_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).date_balance := rosetta_g_miss_date_in_map(a4(indx));
          t(ddindx).amount := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).created_by := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).creation_date := rosetta_g_miss_date_in_map(a7(indx));
          t(ddindx).last_updated_by := rosetta_g_miss_num_map(a8(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_agb_pvt.agbv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    ...
    a10 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).acc_group_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).khr_id);
          a4(indx) := t(ddindx).date_balance;
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).amount);
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).created_by);
          a7(indx) := t(ddindx).creation_date;
          a8(indx) := rosetta_g_miss_num_map(t(ddindx).last_updated_by);
  ...
  as
    ddp_agbv_rec okl_agb_pvt.agbv_rec_type;
    ddx_agbv_rec okl_agb_pvt.agbv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_agb_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_agbv_tbl okl_agb_pvt.agbv_tbl_type;
    ddx_agbv_tbl okl_agb_pvt.agbv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_agb_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_agb_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_agb_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_agb_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
