--------------------------------------------------------
--  DDL for Package Body BEN_DPNT_EGD_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DPNT_EGD_RKI" as
...
begin
hr_utility.set_location('Entering: BEN_DPNT_EGD_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: BEN_DPNT_EGD_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
