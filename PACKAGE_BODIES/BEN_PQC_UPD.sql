--------------------------------------------------------
--  DDL for Package Body BEN_PQC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PQC_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_pqc_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
  ...
  If (p_datetrack_mode = hr_api.g_correction) then
    ...
    p_rec.object_version_number :=
      dt_api.get_object_version_number
        (p_base_table_name => 'ben_prtt_rmt_rqst_ctfn_prvdd_f'
        ,p_base_key_column => 'prtt_rmt_rqst_ctfn_prvdd_id'
        ,p_base_key_value  => p_rec.prtt_rmt_rqst_ctfn_prvdd_id
        );
    --
    ben_pqc_shd.g_api_dml := true;  -- Set the api dml status
    --
    -- Update the ben_prtt_rmt_rqst_ctfn_prvdd_f Row
    --
    update  ben_prtt_rmt_rqst_ctfn_prvdd_f
    set
     prtt_rmt_rqst_ctfn_prvdd_id          = p_rec.prtt_rmt_rqst_ctfn_prvdd_id
    ,prtt_clm_gd_or_svc_typ_id            = p_rec.prtt_clm_gd_or_svc_typ_id
    ,pl_gd_r_svc_ctfn_id                  = p_rec.pl_gd_r_svc_ctfn_id
    ,reimbmt_ctfn_rqd_flag                = p_rec.reimbmt_ctfn_rqd_flag
    ,business_group_id                    = p_rec.business_group_id
    ,prtt_enrt_actn_id                    = p_rec.prtt_enrt_actn_id
    ,reimbmt_ctfn_recd_dt                 = p_rec.reimbmt_ctfn_recd_dt
    ,reimbmt_ctfn_dnd_dt                  = p_rec.reimbmt_ctfn_dnd_dt
    ,reimbmt_ctfn_typ_cd                  = p_rec.reimbmt_ctfn_typ_cd
    ,pqc_attribute_category               = p_rec.pqc_attribute_category
    ,pqc_attribute1                       = p_rec.pqc_attribute1
    ,pqc_attribute2                       = p_rec.pqc_attribute2
    ,pqc_attribute3                       = p_rec.pqc_attribute3
    ,pqc_attribute4                       = p_rec.pqc_attribute4
    ,pqc_attribute5                       = p_rec.pqc_attribute5
    ,pqc_attribute6                       = p_rec.pqc_attribute6
    ,pqc_attribute7                       = p_rec.pqc_attribute7
    ,pqc_attribute8                       = p_rec.pqc_attribute8
    ,pqc_attribute9                       = p_rec.pqc_attribute9
    ,pqc_attribute10                      = p_rec.pqc_attribute10
    ,pqc_attribute11                      = p_rec.pqc_attribute11
    ,pqc_attribute12                      = p_rec.pqc_attribute12
    ,pqc_attribute13                      = p_rec.pqc_attribute13
    ,pqc_attribute14                      = p_rec.pqc_attribute14
    ,pqc_attribute15                      = p_rec.pqc_attribute15
    ,pqc_attribute16                      = p_rec.pqc_attribute16
    ,pqc_attribute17                      = p_rec.pqc_attribute17
    ,pqc_attribute18                      = p_rec.pqc_attribute18
    ,pqc_attribute19                      = p_rec.pqc_attribute19
    ,pqc_attribute20                      = p_rec.pqc_attribute20
    ,pqc_attribute21                      = p_rec.pqc_attribute21
    ,pqc_attribute22                      = p_rec.pqc_attribute22
    ,pqc_attribute23                      = p_rec.pqc_attribute23
    ,pqc_attribute24                      = p_rec.pqc_attribute24
    ,pqc_attribute25                      = p_rec.pqc_attribute25
    ,pqc_attribute26                      = p_rec.pqc_attribute26
    ,pqc_attribute27                      = p_rec.pqc_attribute27
    ,pqc_attribute28                      = p_rec.pqc_attribute28
    ,pqc_attribute29                      = p_rec.pqc_attribute29
    ,pqc_attribute30                      = p_rec.pqc_attribute30
...
Begin
  ...
  begin
    ...
    ben_pqc_rku.after_update
      ...
      ,p_reimbmt_ctfn_rqd_flag
      => p_rec.reimbmt_ctfn_rqd_flag
      ,p_business_group_id
      => p_rec.business_group_id
      ,p_prtt_enrt_actn_id
      => p_rec.prtt_enrt_actn_id
      ,p_reimbmt_ctfn_recd_dt
      => p_rec.reimbmt_ctfn_recd_dt
      ,p_reimbmt_ctfn_dnd_dt
      => p_rec.reimbmt_ctfn_dnd_dt
      ,p_reimbmt_ctfn_typ_cd
      => p_rec.reimbmt_ctfn_typ_cd
      ,p_pqc_attribute_category
      => p_rec.pqc_attribute_category
      ,p_pqc_attribute1
      => p_rec.pqc_attribute1
      ,p_pqc_attribute2
      => p_rec.pqc_attribute2
      ,p_pqc_attribute3
      => p_rec.pqc_attribute3
      ,p_pqc_attribute4
      => p_rec.pqc_attribute4
      ,p_pqc_attribute5
      => p_rec.pqc_attribute5
      ,p_pqc_attribute6
      => p_rec.pqc_attribute6
      ,p_pqc_attribute7
      => p_rec.pqc_attribute7
      ,p_pqc_attribute8
      => p_rec.pqc_attribute8
      ,p_pqc_attribute9
      => p_rec.pqc_attribute9
      ,p_pqc_attribute10
      => p_rec.pqc_attribute10
      ,p_pqc_attribute11
      => p_rec.pqc_attribute11
      ,p_pqc_attribute12
      => p_rec.pqc_attribute12
      ,p_pqc_attribute13
      => p_rec.pqc_attribute13
      ,p_pqc_attribute14
      => p_rec.pqc_attribute14
      ,p_pqc_attribute15
      => p_rec.pqc_attribute15
      ,p_pqc_attribute16
      => p_rec.pqc_attribute16
      ,p_pqc_attribute17
      => p_rec.pqc_attribute17
      ,p_pqc_attribute18
      => p_rec.pqc_attribute18
      ,p_pqc_attribute19
      => p_rec.pqc_attribute19
      ,p_pqc_attribute20
      => p_rec.pqc_attribute20
      ,p_pqc_attribute21
      => p_rec.pqc_attribute21
      ,p_pqc_attribute22
      => p_rec.pqc_attribute22
      ,p_pqc_attribute23
      => p_rec.pqc_attribute23
      ,p_pqc_attribute24
      => p_rec.pqc_attribute24
      ,p_pqc_attribute25
      => p_rec.pqc_attribute25
      ,p_pqc_attribute26
      => p_rec.pqc_attribute26
      ,p_pqc_attribute27
      => p_rec.pqc_attribute27
      ,p_pqc_attribute28
      => p_rec.pqc_attribute28
      ,p_pqc_attribute29
      => p_rec.pqc_attribute29
      ,p_pqc_attribute30
      => p_rec.pqc_attribute30
...
Begin
  ...
  --
  If (p_rec.prtt_clm_gd_or_svc_typ_id = hr_api.g_number) then
    p_rec.prtt_clm_gd_or_svc_typ_id :=
    ben_pqc_shd.g_old_rec.prtt_clm_gd_or_svc_typ_id;
  End If;
  If (p_rec.pl_gd_r_svc_ctfn_id = hr_api.g_number) then
    p_rec.pl_gd_r_svc_ctfn_id :=
    ben_pqc_shd.g_old_rec.pl_gd_r_svc_ctfn_id;
  End If;
  If (p_rec.reimbmt_ctfn_rqd_flag = hr_api.g_varchar2) then
    p_rec.reimbmt_ctfn_rqd_flag :=
    ben_pqc_shd.g_old_rec.reimbmt_ctfn_rqd_flag;
  End If;
  ...
  If (p_rec.prtt_enrt_actn_id = hr_api.g_number) then
    ...
    ben_pqc_shd.g_old_rec.prtt_enrt_actn_id;
  End If;
  If (p_rec.reimbmt_ctfn_recd_dt = hr_api.g_date) then
    p_rec.reimbmt_ctfn_recd_dt :=
    ben_pqc_shd.g_old_rec.reimbmt_ctfn_recd_dt;
  End If;
  If (p_rec.reimbmt_ctfn_dnd_dt = hr_api.g_date) then
    p_rec.reimbmt_ctfn_dnd_dt :=
    ben_pqc_shd.g_old_rec.reimbmt_ctfn_dnd_dt;
  End If;
  If (p_rec.reimbmt_ctfn_typ_cd = hr_api.g_varchar2) then
    p_rec.reimbmt_ctfn_typ_cd :=
    ben_pqc_shd.g_old_rec.reimbmt_ctfn_typ_cd;
  End If;
  If (p_rec.pqc_attribute_category = hr_api.g_varchar2) then
    p_rec.pqc_attribute_category :=
    ben_pqc_shd.g_old_rec.pqc_attribute_category;
  End If;
  If (p_rec.pqc_attribute1 = hr_api.g_varchar2) then
    p_rec.pqc_attribute1 :=
    ben_pqc_shd.g_old_rec.pqc_attribute1;
  End If;
  If (p_rec.pqc_attribute2 = hr_api.g_varchar2) then
    p_rec.pqc_attribute2 :=
    ben_pqc_shd.g_old_rec.pqc_attribute2;
  End If;
  If (p_rec.pqc_attribute3 = hr_api.g_varchar2) then
    p_rec.pqc_attribute3 :=
    ben_pqc_shd.g_old_rec.pqc_attribute3;
  End If;
  If (p_rec.pqc_attribute4 = hr_api.g_varchar2) then
    p_rec.pqc_attribute4 :=
    ben_pqc_shd.g_old_rec.pqc_attribute4;
  End If;
  If (p_rec.pqc_attribute5 = hr_api.g_varchar2) then
    p_rec.pqc_attribute5 :=
    ben_pqc_shd.g_old_rec.pqc_attribute5;
  End If;
  If (p_rec.pqc_attribute6 = hr_api.g_varchar2) then
    p_rec.pqc_attribute6 :=
    ben_pqc_shd.g_old_rec.pqc_attribute6;
  End If;
  If (p_rec.pqc_attribute7 = hr_api.g_varchar2) then
    p_rec.pqc_attribute7 :=
    ben_pqc_shd.g_old_rec.pqc_attribute7;
  End If;
  If (p_rec.pqc_attribute8 = hr_api.g_varchar2) then
    p_rec.pqc_attribute8 :=
    ben_pqc_shd.g_old_rec.pqc_attribute8;
  End If;
  If (p_rec.pqc_attribute9 = hr_api.g_varchar2) then
    p_rec.pqc_attribute9 :=
    ben_pqc_shd.g_old_rec.pqc_attribute9;
  End If;
  If (p_rec.pqc_attribute10 = hr_api.g_varchar2) then
    p_rec.pqc_attribute10 :=
    ben_pqc_shd.g_old_rec.pqc_attribute10;
  End If;
  If (p_rec.pqc_attribute11 = hr_api.g_varchar2) then
    p_rec.pqc_attribute11 :=
    ben_pqc_shd.g_old_rec.pqc_attribute11;
  End If;
  If (p_rec.pqc_attribute12 = hr_api.g_varchar2) then
    p_rec.pqc_attribute12 :=
    ben_pqc_shd.g_old_rec.pqc_attribute12;
  End If;
  If (p_rec.pqc_attribute13 = hr_api.g_varchar2) then
    p_rec.pqc_attribute13 :=
    ben_pqc_shd.g_old_rec.pqc_attribute13;
  End If;
  If (p_rec.pqc_attribute14 = hr_api.g_varchar2) then
    p_rec.pqc_attribute14 :=
    ben_pqc_shd.g_old_rec.pqc_attribute14;
  End If;
  If (p_rec.pqc_attribute15 = hr_api.g_varchar2) then
    p_rec.pqc_attribute15 :=
    ben_pqc_shd.g_old_rec.pqc_attribute15;
  End If;
  If (p_rec.pqc_attribute16 = hr_api.g_varchar2) then
    p_rec.pqc_attribute16 :=
    ben_pqc_shd.g_old_rec.pqc_attribute16;
  End If;
  If (p_rec.pqc_attribute17 = hr_api.g_varchar2) then
    p_rec.pqc_attribute17 :=
    ben_pqc_shd.g_old_rec.pqc_attribute17;
  End If;
  If (p_rec.pqc_attribute18 = hr_api.g_varchar2) then
    p_rec.pqc_attribute18 :=
    ben_pqc_shd.g_old_rec.pqc_attribute18;
  End If;
  If (p_rec.pqc_attribute19 = hr_api.g_varchar2) then
    p_rec.pqc_attribute19 :=
    ben_pqc_shd.g_old_rec.pqc_attribute19;
  End If;
  If (p_rec.pqc_attribute20 = hr_api.g_varchar2) then
    p_rec.pqc_attribute20 :=
    ben_pqc_shd.g_old_rec.pqc_attribute20;
  End If;
  If (p_rec.pqc_attribute21 = hr_api.g_varchar2) then
    p_rec.pqc_attribute21 :=
    ben_pqc_shd.g_old_rec.pqc_attribute21;
  End If;
  If (p_rec.pqc_attribute22 = hr_api.g_varchar2) then
    p_rec.pqc_attribute22 :=
    ben_pqc_shd.g_old_rec.pqc_attribute22;
  End If;
  If (p_rec.pqc_attribute23 = hr_api.g_varchar2) then
    p_rec.pqc_attribute23 :=
    ben_pqc_shd.g_old_rec.pqc_attribute23;
  End If;
  If (p_rec.pqc_attribute24 = hr_api.g_varchar2) then
    p_rec.pqc_attribute24 :=
    ben_pqc_shd.g_old_rec.pqc_attribute24;
  End If;
  If (p_rec.pqc_attribute25 = hr_api.g_varchar2) then
    p_rec.pqc_attribute25 :=
    ben_pqc_shd.g_old_rec.pqc_attribute25;
  End If;
  If (p_rec.pqc_attribute26 = hr_api.g_varchar2) then
    p_rec.pqc_attribute26 :=
    ben_pqc_shd.g_old_rec.pqc_attribute26;
  End If;
  If (p_rec.pqc_attribute27 = hr_api.g_varchar2) then
    p_rec.pqc_attribute27 :=
    ben_pqc_shd.g_old_rec.pqc_attribute27;
  End If;
  If (p_rec.pqc_attribute28 = hr_api.g_varchar2) then
    p_rec.pqc_attribute28 :=
    ben_pqc_shd.g_old_rec.pqc_attribute28;
  End If;
  If (p_rec.pqc_attribute29 = hr_api.g_varchar2) then
    p_rec.pqc_attribute29 :=
    ben_pqc_shd.g_old_rec.pqc_attribute29;
  End If;
  If (p_rec.pqc_attribute30 = hr_api.g_varchar2) then
    p_rec.pqc_attribute30 :=
    ben_pqc_shd.g_old_rec.pqc_attribute30;
  End If;
  --
...
Begin
  ...
  --
  ben_pqc_upd.convert_defs(p_rec);
  --
  ben_pqc_bus.update_validate
    (p_rec                              => p_rec
    ,p_effective_date                   => p_effective_date
    ,p_datetrack_mode                   => p_datetrack_mode
    ,p_validation_start_date            => l_validation_start_date
