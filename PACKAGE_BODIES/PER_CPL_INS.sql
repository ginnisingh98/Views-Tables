--------------------------------------------------------
--  DDL for Package Body PER_CPL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CPL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_cpl_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: per_competences_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.competence_id                    := p_competence_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  per_cpl_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  per_cpl_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where cpl.competence_id = p_competence_id
                          and cpl.language = l.language_code);
  --
...
--
--
  per_cpl_upd.upd_key_flex_meanings( p_competence_id );
  --
  hr_utility.set_location(' Leaving:'||l_proc,20);
 End ins_tl;
end per_cpl_ins;
