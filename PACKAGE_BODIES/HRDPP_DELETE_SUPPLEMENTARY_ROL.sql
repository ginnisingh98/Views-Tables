--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_SUPPLEMENTARY_ROL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_SUPPLEMENTARY_ROL" as
/*
 * Generated by hr_pump_meta_mapper at: 2013/08/29 22:08:29
 * Generated for API: PER_SUPPLEMENTARY_ROLE_API.DELETE_SUPPLEMENTARY_ROLE
 */
--
...
(P_ROLE_USER_KEY => c.p2);
end if;
--
hr_data_pump.api_trc_on;
PER_SUPPLEMENTARY_ROLE_API.DELETE_SUPPLEMENTARY_ROLE
...
end hrdpp_DELETE_SUPPLEMENTARY_ROL;
