--------------------------------------------------------
--  DDL for Package Body HR_FWT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_FWT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_fwt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: hr_form_windows_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.form_window_id                   := p_form_window_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  --
  hr_fwt_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  hr_fwt_ins.pre_insert
    (p_rec                         => p_rec
  ...
  -- Insert the row
  --
  hr_fwt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hr_fwt_ins.post_insert
     (p_rec
     );
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where fwt.form_window_id = p_form_window_id
                          and fwt.language = l.language_code);
  --
