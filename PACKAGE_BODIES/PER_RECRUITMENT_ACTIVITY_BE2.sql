--------------------------------------------------------
--  DDL for Package Body PER_RECRUITMENT_ACTIVITY_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_RECRUITMENT_ACTIVITY_BE2" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  per_recruitment_activity_be2.update_recruitment_activity_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.recruitment_activity.update_recruitment_activity';
...
end update_recruitment_activity_a;
