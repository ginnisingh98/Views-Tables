--------------------------------------------------------
--  DDL for Package Body HR_SE_CONTACT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SE_CONTACT_API" AS
/* $Header: peconsei.pkb 120.0 2005/05/31 07:09 appldev noship $ */
--
	-- Package Variables
   g_package  varchar2(33) := 'hr_se_contact_api';
