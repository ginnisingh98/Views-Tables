--------------------------------------------------------
--  DDL for Package Body OKL_PMV_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PMV_PVT_W" as
  /* $Header: OKLIPMVB.pls 115.4 2002/12/24 04:08:00 sgorantl noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_pmv_pvt.pmv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ptl_id := rosetta_g_miss_num_map(a1(indx));
          t(ddindx).ptq_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).ptv_id := rosetta_g_miss_num_map(a3(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_pmv_pvt.pmv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a11 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := rosetta_g_miss_num_map(t(ddindx).ptl_id);
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).ptq_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).ptv_id);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_pmv_pvt.pmvv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ptv_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).ptl_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).ptq_id := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).from_date := rosetta_g_miss_date_in_map(a5(indx));
          t(ddindx).to_date := rosetta_g_miss_date_in_map(a6(indx));
          t(ddindx).created_by := rosetta_g_miss_num_map(a7(indx));
          t(ddindx).creation_date := rosetta_g_miss_date_in_map(a8(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_pmv_pvt.pmvv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    , a3 out nocopy JTF_NUMBER_TABLE
    , a4 out nocopy JTF_NUMBER_TABLE
    ...
    a11 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).ptv_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).ptl_id);
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).ptq_id);
          a5(indx) := t(ddindx).from_date;
          a6(indx) := t(ddindx).to_date;
          a7(indx) := rosetta_g_miss_num_map(t(ddindx).created_by);
          a8(indx) := t(ddindx).creation_date;
  ...
  as
    ddp_pmvv_rec okl_pmv_pvt.pmvv_rec_type;
    ddx_pmvv_rec okl_pmv_pvt.pmvv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_pmv_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pmvv_tbl okl_pmv_pvt.pmvv_tbl_type;
    ddx_pmvv_tbl okl_pmv_pvt.pmvv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pmv_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pmv_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pmv_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pmv_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
