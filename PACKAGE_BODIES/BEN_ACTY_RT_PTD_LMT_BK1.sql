--------------------------------------------------------
--  DDL for Package Body BEN_ACTY_RT_PTD_LMT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ACTY_RT_PTD_LMT_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_ACTY_RT_PTD_LMT_BK1.CREATE_ACTY_RT_PTD_LMT_A', 10);
hr_utility.set_location(' Leaving: BEN_ACTY_RT_PTD_LMT_BK1.CREATE_ACTY_RT_PTD_LMT_A', 20);
end CREATE_ACTY_RT_PTD_LMT_A;
...
begin
hr_utility.set_location('Entering: BEN_ACTY_RT_PTD_LMT_BK1.CREATE_ACTY_RT_PTD_LMT_B', 10);
hr_utility.set_location(' Leaving: BEN_ACTY_RT_PTD_LMT_BK1.CREATE_ACTY_RT_PTD_LMT_B', 20);
end CREATE_ACTY_RT_PTD_LMT_B;
