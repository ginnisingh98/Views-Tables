--------------------------------------------------------
--  DDL for Package Body OKL_SETUPPOPTIONS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPPOPTIONS_PVT_W" as
  /* $Header: OKLESPOB.pls 115.3 2002/12/24 04:03:36 sgorantl noship $ */
  ...
  as
    ddp_ponv_rec okl_setuppoptions_pvt.ponv_rec_type;
    ddx_no_data_found boolean;
    ddx_ponv_rec okl_setuppoptions_pvt.ponv_rec_type;
  ...
  begin
    ...
    okl_setuppoptions_pvt.get_rec(ddp_ponv_rec,
      ddx_no_data_found,
      x_return_status,
      ddx_ponv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p3_a0 := rosetta_g_miss_num_map(ddx_ponv_rec.id);
    p3_a1 := rosetta_g_miss_num_map(ddx_ponv_rec.object_version_number);
    p3_a2 := rosetta_g_miss_num_map(ddx_ponv_rec.opt_id);
    p3_a3 := rosetta_g_miss_num_map(ddx_ponv_rec.pdt_id);
    p3_a4 := ddx_ponv_rec.from_date;
    p3_a5 := ddx_ponv_rec.to_date;
    p3_a6 := ddx_ponv_rec.optional_yn;
    p3_a7 := rosetta_g_miss_num_map(ddx_ponv_rec.created_by);
    p3_a8 := ddx_ponv_rec.creation_date;
    p3_a9 := rosetta_g_miss_num_map(ddx_ponv_rec.last_updated_by);
    p3_a10 := ddx_ponv_rec.last_update_date;
    p3_a11 := rosetta_g_miss_num_map(ddx_ponv_rec.last_update_login);
  end;
  ...
  as
    ddp_pdtv_rec okl_setuppoptions_pvt.pdtv_rec_type;
    ddp_ponv_rec okl_setuppoptions_pvt.ponv_rec_type;
    ddx_ponv_rec okl_setuppoptions_pvt.ponv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppoptions_pvt.insert_poptions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pdtv_rec okl_setuppoptions_pvt.pdtv_rec_type;
    ddp_ponv_tbl okl_setuppoptions_pvt.ponv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppoptions_pvt.delete_poptions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
