--------------------------------------------------------
--  DDL for Package Body AHL_VWP_TASK_CST_PR_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AHL_VWP_TASK_CST_PR_PVT_W" as
  /* $Header: AHLWTCPB.pls 120.1 2006/05/04 06:46 anraj noship $ */
  ...
  procedure get_task_cost_details(p_api_version  NUMBER
  ...
  begin
    ...
    ahl_vwp_task_cst_pr_pvt.get_task_cost_details(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      p_module_type,
  ...
  procedure estimate_task_cost(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , p_commit  VARCHAR2
    , p_validation_level  NUMBER
    , p_module_type  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    ahl_vwp_task_cst_pr_pvt.estimate_task_cost(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      p_module_type,
  ...
  procedure estimate_task_price(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , p_commit  VARCHAR2
    , p_validation_level  NUMBER
    , p_module_type  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    ahl_vwp_task_cst_pr_pvt.estimate_task_price(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      p_module_type,
  ...
  procedure update_task_cost_details(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , p_commit  VARCHAR2
    , p_validation_level  NUMBER
    , p_module_type  VARCHAR2
  ...
  begin
    ...
    ddp_cost_price_rec.visit_task_id := p5_a0;
    ddp_cost_price_rec.visit_id := p5_a1;
    ddp_cost_price_rec.mr_id := p5_a2;
    ddp_cost_price_rec.actual_cost := p5_a3;
    ddp_cost_price_rec.estimated_cost := p5_a4;
    ddp_cost_price_rec.actual_price := p5_a5;
    ddp_cost_price_rec.estimated_price := p5_a6;
    ddp_cost_price_rec.currency := p5_a7;
    ddp_cost_price_rec.snapshot_id := p5_a8;
    ddp_cost_price_rec.object_version_number := p5_a9;
    ddp_cost_price_rec.estimated_profit := p5_a10;
    ddp_cost_price_rec.actual_profit := p5_a11;
    ddp_cost_price_rec.outside_party_flag := p5_a12;
    ddp_cost_price_rec.is_outside_pty_flag_updt := p5_a13;
    ddp_cost_price_rec.is_cst_pr_info_required := p5_a14;
    ddp_cost_price_rec.is_cst_struc_updated := p5_a15;
    ddp_cost_price_rec.price_list_id := p5_a16;
    ddp_cost_price_rec.price_list_name := p5_a17;
    ddp_cost_price_rec.service_request_id := p5_a18;
    ddp_cost_price_rec.customer_id := p5_a19;
    ddp_cost_price_rec.organization_id := p5_a20;
    ddp_cost_price_rec.visit_start_date := rosetta_g_miss_date_in_map(p5_a21);
    ddp_cost_price_rec.visit_end_date := rosetta_g_miss_date_in_map(p5_a22);
    ddp_cost_price_rec.mr_start_date := rosetta_g_miss_date_in_map(p5_a23);
    ddp_cost_price_rec.mr_end_date := rosetta_g_miss_date_in_map(p5_a24);
    ddp_cost_price_rec.task_start_date := rosetta_g_miss_date_in_map(p5_a25);
    ddp_cost_price_rec.task_end_date := rosetta_g_miss_date_in_map(p5_a26);
    ddp_cost_price_rec.task_name := p5_a27;
    ddp_cost_price_rec.visit_task_number := p5_a28;
    ddp_cost_price_rec.mr_title := p5_a29;
    ddp_cost_price_rec.mr_description := p5_a30;
    ddp_cost_price_rec.billing_item_id := p5_a31;
    ddp_cost_price_rec.item_name := p5_a32;
    ddp_cost_price_rec.item_description := p5_a33;
    ddp_cost_price_rec.organization_name := p5_a34;
    ddp_cost_price_rec.workorder_id := p5_a35;
    ddp_cost_price_rec.master_wo_flag := p5_a36;
    ddp_cost_price_rec.mr_session_id := p5_a37;
    ddp_cost_price_rec.cost_session_id := p5_a38;
    ddp_cost_price_rec.created_by := p5_a39;
    ddp_cost_price_rec.creation_date := rosetta_g_miss_date_in_map(p5_a40);
    ddp_cost_price_rec.last_updated_by := p5_a41;
    ddp_cost_price_rec.last_update_date := rosetta_g_miss_date_in_map(p5_a42);
    ddp_cost_price_rec.last_update_login := p5_a43;
    ddp_cost_price_rec.attribute_category := p5_a44;
    ddp_cost_price_rec.attribute1 := p5_a45;
    ddp_cost_price_rec.attribute2 := p5_a46;
    ddp_cost_price_rec.attribute3 := p5_a47;
    ddp_cost_price_rec.attribute4 := p5_a48;
    ddp_cost_price_rec.attribute5 := p5_a49;
    ddp_cost_price_rec.attribute6 := p5_a50;
    ddp_cost_price_rec.attribute7 := p5_a51;
    ddp_cost_price_rec.attribute8 := p5_a52;
    ddp_cost_price_rec.attribute9 := p5_a53;
    ddp_cost_price_rec.attribute10 := p5_a54;
    ddp_cost_price_rec.attribute11 := p5_a55;
    ddp_cost_price_rec.attribute12 := p5_a56;
    ddp_cost_price_rec.attribute13 := p5_a57;
    ddp_cost_price_rec.attribute14 := p5_a58;
    ddp_cost_price_rec.attribute15 := p5_a59;




    -- here's the delegated call to the old PL/SQL routine
    ahl_vwp_task_cst_pr_pvt.update_task_cost_details(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      p_module_type,
  ...
  procedure get_node_cost_details(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , p_commit  VARCHAR2
    , p_validation_level  NUMBER
    , p_module_type  VARCHAR2
    ...
    , p8_a19 in out nocopy  NUMBER
    , p8_a20 in out nocopy  NUMBER
    , p8_a21 in out nocopy  DATE
    , p8_a22 in out nocopy  DATE
    , p8_a23 in out nocopy  DATE
    , p8_a24 in out nocopy  DATE
    , p8_a25 in out nocopy  DATE
    , p8_a26 in out nocopy  DATE
    , p8_a27 in out nocopy  VARCHAR2
    , p8_a28 in out nocopy  NUMBER
    , p8_a29 in out nocopy  VARCHAR2
    , p8_a30 in out nocopy  VARCHAR2
    , p8_a31 in out nocopy  NUMBER
    , p8_a32 in out nocopy  VARCHAR2
    , p8_a33 in out nocopy  VARCHAR2
    , p8_a34 in out nocopy  VARCHAR2
    , p8_a35 in out nocopy  NUMBER
    , p8_a36 in out nocopy  VARCHAR2
    , p8_a37 in out nocopy  NUMBER
    , p8_a38 in out nocopy  NUMBER
    , p8_a39 in out nocopy  NUMBER
    , p8_a40 in out nocopy  DATE
    , p8_a41 in out nocopy  NUMBER
    , p8_a42 in out nocopy  DATE
    , p8_a43 in out nocopy  NUMBER
    , p8_a44 in out nocopy  VARCHAR2
    , p8_a45 in out nocopy  VARCHAR2
    , p8_a46 in out nocopy  VARCHAR2
    , p8_a47 in out nocopy  VARCHAR2
    , p8_a48 in out nocopy  VARCHAR2
    , p8_a49 in out nocopy  VARCHAR2
    , p8_a50 in out nocopy  VARCHAR2
    , p8_a51 in out nocopy  VARCHAR2
    , p8_a52 in out nocopy  VARCHAR2
    , p8_a53 in out nocopy  VARCHAR2
    , p8_a54 in out nocopy  VARCHAR2
    , p8_a55 in out nocopy  VARCHAR2
    , p8_a56 in out nocopy  VARCHAR2
    , p8_a57 in out nocopy  VARCHAR2
    , p8_a58 in out nocopy  VARCHAR2
    , p8_a59 in out nocopy  VARCHAR2
  )
  ...
  begin
    ...
    ddp_x_cost_price_rec.visit_task_id := p8_a0;
    ddp_x_cost_price_rec.visit_id := p8_a1;
    ddp_x_cost_price_rec.mr_id := p8_a2;
    ddp_x_cost_price_rec.actual_cost := p8_a3;
    ddp_x_cost_price_rec.estimated_cost := p8_a4;
    ddp_x_cost_price_rec.actual_price := p8_a5;
    ddp_x_cost_price_rec.estimated_price := p8_a6;
    ddp_x_cost_price_rec.currency := p8_a7;
    ddp_x_cost_price_rec.snapshot_id := p8_a8;
    ddp_x_cost_price_rec.object_version_number := p8_a9;
    ddp_x_cost_price_rec.estimated_profit := p8_a10;
    ddp_x_cost_price_rec.actual_profit := p8_a11;
    ddp_x_cost_price_rec.outside_party_flag := p8_a12;
    ddp_x_cost_price_rec.is_outside_pty_flag_updt := p8_a13;
    ddp_x_cost_price_rec.is_cst_pr_info_required := p8_a14;
    ddp_x_cost_price_rec.is_cst_struc_updated := p8_a15;
    ddp_x_cost_price_rec.price_list_id := p8_a16;
    ddp_x_cost_price_rec.price_list_name := p8_a17;
    ddp_x_cost_price_rec.service_request_id := p8_a18;
    ddp_x_cost_price_rec.customer_id := p8_a19;
    ddp_x_cost_price_rec.organization_id := p8_a20;
    ddp_x_cost_price_rec.visit_start_date := rosetta_g_miss_date_in_map(p8_a21);
    ddp_x_cost_price_rec.visit_end_date := rosetta_g_miss_date_in_map(p8_a22);
    ddp_x_cost_price_rec.mr_start_date := rosetta_g_miss_date_in_map(p8_a23);
    ddp_x_cost_price_rec.mr_end_date := rosetta_g_miss_date_in_map(p8_a24);
    ddp_x_cost_price_rec.task_start_date := rosetta_g_miss_date_in_map(p8_a25);
    ddp_x_cost_price_rec.task_end_date := rosetta_g_miss_date_in_map(p8_a26);
    ddp_x_cost_price_rec.task_name := p8_a27;
    ddp_x_cost_price_rec.visit_task_number := p8_a28;
    ddp_x_cost_price_rec.mr_title := p8_a29;
    ddp_x_cost_price_rec.mr_description := p8_a30;
    ddp_x_cost_price_rec.billing_item_id := p8_a31;
    ddp_x_cost_price_rec.item_name := p8_a32;
    ddp_x_cost_price_rec.item_description := p8_a33;
    ddp_x_cost_price_rec.organization_name := p8_a34;
    ddp_x_cost_price_rec.workorder_id := p8_a35;
    ddp_x_cost_price_rec.master_wo_flag := p8_a36;
    ddp_x_cost_price_rec.mr_session_id := p8_a37;
    ddp_x_cost_price_rec.cost_session_id := p8_a38;
    ddp_x_cost_price_rec.created_by := p8_a39;
    ddp_x_cost_price_rec.creation_date := rosetta_g_miss_date_in_map(p8_a40);
    ddp_x_cost_price_rec.last_updated_by := p8_a41;
    ddp_x_cost_price_rec.last_update_date := rosetta_g_miss_date_in_map(p8_a42);
    ddp_x_cost_price_rec.last_update_login := p8_a43;
    ddp_x_cost_price_rec.attribute_category := p8_a44;
    ddp_x_cost_price_rec.attribute1 := p8_a45;
    ddp_x_cost_price_rec.attribute2 := p8_a46;
    ddp_x_cost_price_rec.attribute3 := p8_a47;
    ddp_x_cost_price_rec.attribute4 := p8_a48;
    ddp_x_cost_price_rec.attribute5 := p8_a49;
    ddp_x_cost_price_rec.attribute6 := p8_a50;
    ddp_x_cost_price_rec.attribute7 := p8_a51;
    ddp_x_cost_price_rec.attribute8 := p8_a52;
    ddp_x_cost_price_rec.attribute9 := p8_a53;
    ddp_x_cost_price_rec.attribute10 := p8_a54;
    ddp_x_cost_price_rec.attribute11 := p8_a55;
    ddp_x_cost_price_rec.attribute12 := p8_a56;
    ddp_x_cost_price_rec.attribute13 := p8_a57;
    ddp_x_cost_price_rec.attribute14 := p8_a58;
    ddp_x_cost_price_rec.attribute15 := p8_a59;

    -- here's the delegated call to the old PL/SQL routine
    ahl_vwp_task_cst_pr_pvt.get_node_cost_details(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      p_module_type,
    ...
    p8_a0 := ddp_x_cost_price_rec.visit_task_id;
    p8_a1 := ddp_x_cost_price_rec.visit_id;
    p8_a2 := ddp_x_cost_price_rec.mr_id;
    p8_a3 := ddp_x_cost_price_rec.actual_cost;
    p8_a4 := ddp_x_cost_price_rec.estimated_cost;
    p8_a5 := ddp_x_cost_price_rec.actual_price;
    p8_a6 := ddp_x_cost_price_rec.estimated_price;
    p8_a7 := ddp_x_cost_price_rec.currency;
    p8_a8 := ddp_x_cost_price_rec.snapshot_id;
    p8_a9 := ddp_x_cost_price_rec.object_version_number;
    p8_a10 := ddp_x_cost_price_rec.estimated_profit;
    p8_a11 := ddp_x_cost_price_rec.actual_profit;
    p8_a12 := ddp_x_cost_price_rec.outside_party_flag;
    p8_a13 := ddp_x_cost_price_rec.is_outside_pty_flag_updt;
    p8_a14 := ddp_x_cost_price_rec.is_cst_pr_info_required;
    p8_a15 := ddp_x_cost_price_rec.is_cst_struc_updated;
    p8_a16 := ddp_x_cost_price_rec.price_list_id;
    p8_a17 := ddp_x_cost_price_rec.price_list_name;
    p8_a18 := ddp_x_cost_price_rec.service_request_id;
    p8_a19 := ddp_x_cost_price_rec.customer_id;
    p8_a20 := ddp_x_cost_price_rec.organization_id;
    p8_a21 := ddp_x_cost_price_rec.visit_start_date;
    p8_a22 := ddp_x_cost_price_rec.visit_end_date;
    p8_a23 := ddp_x_cost_price_rec.mr_start_date;
    p8_a24 := ddp_x_cost_price_rec.mr_end_date;
    p8_a25 := ddp_x_cost_price_rec.task_start_date;
    p8_a26 := ddp_x_cost_price_rec.task_end_date;
    p8_a27 := ddp_x_cost_price_rec.task_name;
    p8_a28 := ddp_x_cost_price_rec.visit_task_number;
    p8_a29 := ddp_x_cost_price_rec.mr_title;
    p8_a30 := ddp_x_cost_price_rec.mr_description;
    p8_a31 := ddp_x_cost_price_rec.billing_item_id;
    p8_a32 := ddp_x_cost_price_rec.item_name;
    p8_a33 := ddp_x_cost_price_rec.item_description;
    p8_a34 := ddp_x_cost_price_rec.organization_name;
    p8_a35 := ddp_x_cost_price_rec.workorder_id;
    p8_a36 := ddp_x_cost_price_rec.master_wo_flag;
    p8_a37 := ddp_x_cost_price_rec.mr_session_id;
    p8_a38 := ddp_x_cost_price_rec.cost_session_id;
    p8_a39 := ddp_x_cost_price_rec.created_by;
    p8_a40 := ddp_x_cost_price_rec.creation_date;
    p8_a41 := ddp_x_cost_price_rec.last_updated_by;
    p8_a42 := ddp_x_cost_price_rec.last_update_date;
    p8_a43 := ddp_x_cost_price_rec.last_update_login;
    p8_a44 := ddp_x_cost_price_rec.attribute_category;
    p8_a45 := ddp_x_cost_price_rec.attribute1;
    p8_a46 := ddp_x_cost_price_rec.attribute2;
    p8_a47 := ddp_x_cost_price_rec.attribute3;
    p8_a48 := ddp_x_cost_price_rec.attribute4;
    p8_a49 := ddp_x_cost_price_rec.attribute5;
    p8_a50 := ddp_x_cost_price_rec.attribute6;
    p8_a51 := ddp_x_cost_price_rec.attribute7;
    p8_a52 := ddp_x_cost_price_rec.attribute8;
    p8_a53 := ddp_x_cost_price_rec.attribute9;
    p8_a54 := ddp_x_cost_price_rec.attribute10;
    p8_a55 := ddp_x_cost_price_rec.attribute11;
    p8_a56 := ddp_x_cost_price_rec.attribute12;
    p8_a57 := ddp_x_cost_price_rec.attribute13;
    p8_a58 := ddp_x_cost_price_rec.attribute14;
    p8_a59 := ddp_x_cost_price_rec.attribute15;
  end;

  procedure get_task_items_no_price(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , p_commit  VARCHAR2
    , p_validation_level  NUMBER
    , p_module_type  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    ahl_vwp_task_cst_pr_pvt.get_task_items_no_price(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      p_module_type,
