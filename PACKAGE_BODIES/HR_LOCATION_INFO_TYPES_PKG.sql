--------------------------------------------------------
--  DDL for Package Body HR_LOCATION_INFO_TYPES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_LOCATION_INFO_TYPES_PKG" as
/* $Header: perlocit.pkb 115.3 2002/12/06 14:10:50 eumenyio ship $ */
--------------------------------------------------------------------------------
...
procedure INSERT_ROW (
  ...
  cursor C is select ROWID from HR_LOCATION_INFO_TYPES
...
begin
  update HR_LOCATION_INFO_TYPES set
...
begin
  ...
  delete from HR_LOCATION_INFO_TYPES
  where INFORMATION_TYPE = X_INFORMATION_TYPE;
...
is
  l_proc                        VARCHAR2(61) := 'HR_LOCATION_INFO_TYPES_PKG.LOAD_ROW';
  l_rowid                       rowid;
  l_request_id                  HR_LOCATION_INFO_types.request_id%TYPE;
  l_progam_application_id       HR_LOCATION_INFO_types.program_application_id%TYPE;
  l_program_id                  HR_LOCATION_INFO_types.program_id%TYPE;
  l_program_update_date         HR_LOCATION_INFO_types.program_update_date%TYPE;
  l_created_by                  HR_LOCATION_INFO_types.created_by%TYPE             := 0;
  l_creation_date               HR_LOCATION_INFO_types.creation_date%TYPE          := SYSDATE;
  l_last_update_date            HR_LOCATION_INFO_types.last_update_date%TYPE       := SYSDATE;
  l_last_updated_by             HR_LOCATION_INFO_types.last_updated_by%TYPE         := 0;
  l_last_update_login           HR_LOCATION_INFO_types.last_update_login%TYPE      := 0;
begin
...
END HR_LOCATION_INFO_TYPES_PKG;
