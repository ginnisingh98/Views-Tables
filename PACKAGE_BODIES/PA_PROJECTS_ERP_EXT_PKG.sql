--------------------------------------------------------
--  DDL for Package Body PA_PROJECTS_ERP_EXT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PA_PROJECTS_ERP_EXT_PKG" as
/* $Header: PAPRETHB.pls 115.1 2003/11/03 06:07:14 svenketa noship $ */

procedure ADD_LANGUAGE
is
begin
  delete from PA_PROJECTS_ERP_EXT_TL T
  where not exists
    (select NULL
  ...
  update PA_PROJECTS_ERP_EXT_TL T set (
      TL_EXT_ATTR1,
      TL_EXT_ATTR2,
      TL_EXT_ATTR3,
      TL_EXT_ATTR4,
  ...
  where (
      ...
      SUBT.EXTENSION_ID,
      SUBT.LANGUAGE
    from PA_PROJECTS_ERP_EXT_TL SUBB, PA_PROJECTS_ERP_EXT_TL SUBT
  ...
  insert into PA_PROJECTS_ERP_EXT_TL (
    ...
    L.LANGUAGE_CODE,
    B.SOURCE_LANG
  from PA_PROJECTS_ERP_EXT_TL B, FND_LANGUAGES L
