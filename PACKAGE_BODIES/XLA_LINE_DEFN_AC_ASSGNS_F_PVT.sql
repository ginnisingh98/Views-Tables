--------------------------------------------------------
--  DDL for Package Body XLA_LINE_DEFN_AC_ASSGNS_F_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."XLA_LINE_DEFN_AC_ASSGNS_F_PVT" AS
/* $Header: xlathlac.pkb 120.1 2005/04/28 18:45:54 masada ship $ */
...
C_DEFAULT_MODULE      CONSTANT VARCHAR2(240) := 'xla.plsql.xla_line_defn_ac_assgns_f_pvt';
...
EXCEPTION
  ...
  WHEN OTHERS THEN
    xla_exceptions_pkg.raise_message
      (p_location   => 'xla_line_defn_ac_assgns_f_pvt.trace');
END trace;
...
WHERE  application_id                   = x_application_id
  ...
  AND  analytical_criterion_type_code   = x_analy_criterion_type_code
  AND  analytical_criterion_code        = x_analy_criterion_code
;
...
,x_analy_criterion_type_code
,x_analy_criterion_code
,1
,x_last_update_date
,x_last_updated_by
,x_last_update_login)
