--------------------------------------------------------
--  DDL for Package Body PER_SST_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_SST_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_sst_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the per_ri_setup_sub_tasks_tl row.
  --
  delete from per_ri_setup_sub_tasks_tl
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in per_sst_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in per_sst_shd.g_rec_type) is
--
...
Begin
  ...
  --
  per_sst_bus.delete_validate(p_rec);
  --
  ...
  --
  per_sst_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  per_sst_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  per_sst_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
