--------------------------------------------------------
--  DDL for Package Body BEN_ESA_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ESA_RKD" as
...
begin
hr_utility.set_location('Entering: ben_esa_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_esa_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_esa_RKD;
