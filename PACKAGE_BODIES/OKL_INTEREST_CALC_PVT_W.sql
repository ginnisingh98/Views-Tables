--------------------------------------------------------
--  DDL for Package Body OKL_INTEREST_CALC_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_INTEREST_CALC_PVT_W" as
  /* $Header: OKLEITUB.pls 120.2 2005/12/08 12:01:48 gboomina noship $ */
  ...
  begin
    ...
    okl_interest_calc_pvt.calc_interest_activate(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
