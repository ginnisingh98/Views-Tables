--------------------------------------------------------
--  DDL for Package Body HR_UCX_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_UCX_RKD" as
...
begin
hr_utility.set_location('Entering: HR_UCX_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: HR_UCX_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end HR_UCX_RKD;
