--------------------------------------------------------
--  DDL for Package Body OTA_RESOURCE_USAGE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_RESOURCE_USAGE_BK2" as
...
begin
hr_utility.set_location('Entering: OTA_RESOURCE_USAGE_BK2.UPDATE_RESOURCE_A', 10);
hr_utility.set_location(' Leaving: OTA_RESOURCE_USAGE_BK2.UPDATE_RESOURCE_A', 20);
end UPDATE_RESOURCE_A;
...
begin
hr_utility.set_location('Entering: OTA_RESOURCE_USAGE_BK2.UPDATE_RESOURCE_B', 10);
hr_utility.set_location(' Leaving: OTA_RESOURCE_USAGE_BK2.UPDATE_RESOURCE_B', 20);
end UPDATE_RESOURCE_B;
