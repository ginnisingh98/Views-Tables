--------------------------------------------------------
--  DDL for Package Body HR_TPT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_TPT_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_tpt_bus.';  -- Global package name
--
...
begin
  ...
  --
  hr_tpp_bus.set_security_group_id
...
Begin
  ...
  hr_utility.set_location('Entering:'|| l_proc, 10);
  --
  l_legislation_code := hr_tpp_bus.return_legislation_code
    (p_tab_page_property_id         => p_tab_page_property_id
    );
  --
...
Begin
  ...
  --
  IF NOT hr_tpt_shd.api_updating
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 10);
  --
  l_api_updating := hr_tpt_shd.api_updating
    (p_tab_page_property_id         => p_tab_page_property_id
  ...
  --
  if (  (   l_api_updating
        and nvl(hr_tpt_shd.g_old_rec.source_lang,hr_api.g_varchar2) <>
