--------------------------------------------------------
--  DDL for Package Body BEN_QIG_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_QIG_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_qig_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_qua_in_gr_rt_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_qua_in_gr_rt_id  in  number) is
--
...
Begin
  ...
  --
  ben_qig_ins.g_qua_in_gr_rt_id_i := p_qua_in_gr_rt_id;
  --
...
--
  Cursor C_Sel1 Is
    ...
    where  t.qua_in_gr_rt_id       = p_rec.qua_in_gr_rt_id
    and    t.effective_start_date =
             ben_qig_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc                varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_qua_in_gr_rt_f.created_by%TYPE;
  l_creation_date       ben_qua_in_gr_rt_f.creation_date%TYPE;
  l_last_update_date    ben_qua_in_gr_rt_f.last_update_date%TYPE;
  l_last_updated_by     ben_qua_in_gr_rt_f.last_updated_by%TYPE;
  l_last_update_login   ben_qua_in_gr_rt_f.last_update_login%TYPE;
--
Begin
  ...
  --
  --
  -- Insert the row into: ben_qua_in_gr_rt_f
  --
  insert into ben_qua_in_gr_rt_f
      (qua_in_gr_rt_id
...
--
  Cursor C_Sel1 is select ben_qua_in_gr_rt_f_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from ben_qua_in_gr_rt_f
     where qua_in_gr_rt_id =
             ben_qig_ins.g_qua_in_gr_rt_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (ben_qig_ins.g_qua_in_gr_rt_id_i is not null) Then
    --
    ...
    p_rec.qua_in_gr_rt_id :=
      ben_qig_ins.g_qua_in_gr_rt_id_i;
    ben_qig_ins.g_qua_in_gr_rt_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.qua_in_gr_rt_id;
    Close C_Sel1;
  End If;
  --
  --
...
Begin
  ...
  --
  p_qua_in_gr_rt_id                        := l_rec.qua_in_gr_rt_id;
