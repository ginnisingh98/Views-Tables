--------------------------------------------------------
--  DDL for Package Body HR_ORGANIZATION_BE5
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ORGANIZATION_BE5" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  hr_organization_be5.delete_organization_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.organization.delete_organization';
