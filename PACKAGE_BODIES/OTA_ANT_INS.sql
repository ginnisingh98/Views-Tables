--------------------------------------------------------
--  DDL for Package Body OTA_ANT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_ANT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_ant_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: ota_announcements_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.announcement_id                  := p_announcement_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  ota_ant_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ota_ant_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where ant.announcement_id = p_announcement_id
                          and ant.language = l.language_code);
  --
