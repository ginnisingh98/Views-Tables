--------------------------------------------------------
--  DDL for Package Body HR_ASSIGNMENT_BE7
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ASSIGNMENT_BE7" as 
--Code generated on 30/08/2013 11:36:18
/* $Header: hrapiwfe.pkb 120.4.12010000.2 2008/09/29 12:54:07 srgnanas ship $*/
procedure suspend_emp_asg_a (
...
p_effective_end_date           date) is
  ...
  --
  l_proc varchar2(72):='  hr_assignment_be7.suspend_emp_asg_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.assignment.suspend_emp_asg';
...
end suspend_emp_asg_a;
end hr_assignment_be7;
