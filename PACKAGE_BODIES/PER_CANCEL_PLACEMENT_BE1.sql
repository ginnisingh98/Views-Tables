--------------------------------------------------------
--  DDL for Package Body PER_CANCEL_PLACEMENT_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CANCEL_PLACEMENT_BE1" as 
...
p_payment_warning              boolean) is
  ...
  --
  l_proc varchar2(72):='  per_cancel_placement_be1.cancel_placement_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.cancel_placement.cancel_placement';
