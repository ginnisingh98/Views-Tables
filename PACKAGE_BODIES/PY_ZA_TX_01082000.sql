--------------------------------------------------------
--  DDL for Package Body PY_ZA_TX_01082000
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PY_ZA_TX_01082000" AS
/* $Header: pyzat003.pkb 120.2 2005/06/28 00:10:47 kapalani noship $ */
...
/*
   ...
   PRIVATE PROCEDURES
      WrtHrTrc
         Wrapper procedure for py_za_tx_utl_01082000.WriteHrTrace
      NetTxbIncCalc
   ...
   MODIFICATION HISTORY
      ...
      ---------   ----------------   -------   -----------------------------------
      A. Mahanty  14/04/2005         115.10    Bug 3491357 :BRA Enhancement
                                               Balance Values retrieval modified.
      J.N. Louw   12/10/2001         115.8     Fixed Abatements calculation
                                               in NetTxbIncCalc
                                               Fixed trc_TotLib[CatCode] Cascade
                                               Figure calculation
      J.N. Louw   27/09/2001         115.7     Added bal_ANN_PF_CYTD
      J.N. Louw   22/08/2001         115.6     NorCalc.TrvAll Ptd summation added
      J.N. Louw   22/08/2001         115.5     Added WrtHrTrc wrapper
      J.N. Louw   22/08/2001         115.4     Bug: 1902369 Negative Ptd Check
                                               Bug: 1887835
                                               New Annual Classifications
      J.N. Louw   31/06/2001         115.3     Bug: 1820687
                                                  Restraint of Trade Item
      J.N. Louw   11/05/2001         115.2     Bug: 1777857
                                                  Override Warning Message changed
                                                  to be always set
                                                  p_OvrWrn := trc_OvrWrn
      J.N. Louw   30/03/2001         115.1     Bug: 1706149
                                                  Site/Paye Split not prorated
                                                  correctly. Fixed by setting
                                                  the Site Factor for a
                                                  tax amount override
      L.Kloppers  31/01/2001         115.0     Changed ptp.attribute1 to
                                                  ptp.prd_information1
      J.N. Louw   17/01/2001         110.3     Added Negative Check Category
                                                  Calculation Logic - AB/AP
      J.N. Louw   13/12/2000         110.2     Upped Header Ver for Patch
      J.N. Louw   06/12/2000         110.1     Added SetRebates procedure call
                                               Modified ZaTx_01082000 with new
                                                  logic
      J.N. Louw   28/11/2000         110.0     Next Version of Main ZA Tax
                                                  Package.
...
BEGIN
   py_za_tx_utl_01082000.WriteHrTrace(p_Buf);
END WrtHrTrc;
...
PROCEDURE NetTxbIncCalc AS
   ...
   nti_PerArrPenFnd     NUMBER(15,2) DEFAULT 0;
   nti_PerArrPenFndAbm  NUMBER(15,2) DEFAULT 0;
   nti_PerRetAnu        NUMBER(15,2) DEFAULT 0;
   nti_PerNrfiCon       NUMBER(15,2) DEFAULT 0;
   nti_PerRetAnuMax     NUMBER(15,2) DEFAULT 0;
   nti_PerRetAnuAbm     NUMBER(15,2) DEFAULT 0;
   nti_PerArrRetAnu     NUMBER(15,2) DEFAULT 0;
   nti_PerArrRetAnuAbm  NUMBER(15,2) DEFAULT 0;
   nti_AnnArrPenFnd     NUMBER(15,2) DEFAULT 0;
   nti_AnnArrPenFndAbm  NUMBER(15,2) DEFAULT 0;
   nti_AnnRetAnu        NUMBER(15,2) DEFAULT 0;
   nti_AnnNrfiCon       NUMBER(15,2) DEFAULT 0;
   nti_AnnRetAnuMax     NUMBER(15,2) DEFAULT 0;
   nti_AnnRetAnuAbm     NUMBER(15,2) DEFAULT 0;
   nti_AnnArrRetAnu     NUMBER(15,2) DEFAULT 0;
   nti_AnnArrRetAnuAbm  NUMBER(15,2) DEFAULT 0;
...
BEGIN
   hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',1);
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',2);
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',3);
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',4);
...
--
   nti_PerTypInc :=
      ...
      + bal_RES_TRD_NRFI_CMTD
      + bal_RES_TRD_RFI_CMTD
...
--
   nti_AnnTypErn :=
    ...
    + ( bal_AB_NRFI_CMTD
      + bal_AB_RFI_CMTD
      + bal_AA_PRCHD_RVAL_NRFI_CMTD
      + bal_AA_PRCHD_RVAL_RFI_CMTD
      + bal_AC_NRFI_CMTD
      + bal_AC_RFI_CMTD
      + bal_ANU_FRM_RET_FND_NRFI_CMTD
      + bal_ANU_FRM_RET_FND_RFI_CMTD
      + bal_ARES_TRD_NRFI_CMTD
      + bal_ARES_TRD_RFI_CMTD
...
-----------------------------
   ...
   -------------------------
      ...
      --------------------------------
         ...
         IF py_za_tx_01082000.dbi_ARR_PF_FRQ = 'M' THEN
            hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',5);
            nti_PerArrPenFnd := nti_PerArrPenFnd
                              + ( bal_ARR_PF_CMTD
                                * nti_SitFactor
                                );
         ELSE
            hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',6);
            nti_AnnArrPenFnd := bal_ARR_PF_CMTD;
         END IF;
          ---------
          -- Annual
          ---------
          nti_AnnArrPenFnd := nti_PerArrPenFnd
                            + nti_AnnArrPenFnd
                            + bal_ANN_ARR_PF_CMTD;
      ...
      -------------------------------
         hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',7);
         -------------
         -- Current RA
         -------------
         IF py_za_tx_01082000.dbi_RA_FRQ = 'M' THEN
            hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',8);
            -- Calculate RA Contribution
            nti_PerRetAnu := bal_RA_CMTD * nti_SitFactor;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',9);
            -- Calculate RA Contribution
            nti_AnnRetAnu := bal_RA_CMTD;
         END IF;
         ---------------------
         -- Current NRFI Contr
         ---------------------
         IF bal_PF_CMTD + bal_ANN_PF_CMTD = 0 THEN
            hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',10);
            nti_PerNrfiCon := ( bal_TOT_RFI_INC_CMTD
                              + bal_TOT_NRFI_INC_CMTD
                              )
                              * nti_SitFactor;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',11);
      ...
      --------------------------------------
         ...
         IF py_za_tx_01082000.dbi_ARR_RA_FRQ = 'M' THEN
            hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',12);
         ...
         ELSE
            hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',13);

            nti_AnnArrRetAnu := bal_ARR_RA_CMTD;
         END IF;
         ---------
         -- Annual
         ---------
   ...
   -----------------------------------------------------------
      ...
      IF l_65Year > dbi_ZA_TX_YR_END THEN
         nti_MedAidAbm := 0;
      END IF;
      hr_utility.set_location('py_za_tx_01082000.NetTxbIncCalc',62);
   -------------------
   -- Total Abatements
   -------------------
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxOvr_01082000: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxOvr_01082000;
...
PROCEDURE LteCalc AS
   ...
   --
      ...
      BEGIN
         hr_utility.set_location('py_za_tx_01082000.LteCalc',1);
      -- Get the Balance Type ID
         ...
         hr_utility.set_location('py_za_tx_01082000.LteCalc',2);
      ...
      -- Variables
         ...
         l_dimension pay_balance_dimensions.dimension_name%TYPE ;
      BEGIN
         hr_utility.set_location('py_za_tx_01082000.LteCalc',3);
      -- Get the Balance Type ID
         SELECT pbt.balance_type_id
           INTO l_BalTypId
           FROM pay_balance_types pbt
         ...
         hr_utility.set_location('py_za_tx_01082000.LteCalc',4);
...
BEGIN
   hr_utility.set_location('py_za_tx_01082000.LteCalc',5);
-- Does the Assignment have an OFigure?
--
   IF bal_TOT_TXB_INC_ITD <= 0 THEN
      hr_utility.set_location('py_za_tx_01082000.LteCalc',6);
   ...
   -- Set the Site Factor to the value of the previous tax year
      ...
      hr_utility.set_location('py_za_tx_01082000.LteCalc',7);
      ...
      hr_utility.set_location('py_za_tx_01082000.LteCalc',8);

      trc_SitFactor := (l_EndDate - l_StrtDte + 1) / py_za_tx_utl_01082000.DaysWorked;
   ...
   -- Get the assignment's previous tax year end date
      ...
      hr_utility.set_location('py_za_tx_01082000.LteCalc',9);
   ...
   hr_utility.set_location('py_za_tx_01082000.LteCalc',10);

   -- Update Globals with Correct Taxable Values
      py_za_tx_utl_01082000.TrvAll;

      bal_PO_NRFI_PTD := bal_PO_NRFI_PTD * py_za_tx_utl_01082000.GlbVal('ZA_PUBL_TAX_PERC',l_EndDate) / 100;
      bal_PO_RFI_PTD := bal_PO_RFI_PTD * py_za_tx_utl_01082000.GlbVal('ZA_PUBL_TAX_PERC',l_EndDate) / 100;

   hr_utility.set_location('py_za_tx_01082000.LteCalc',11);

   -- Rebates
      py_za_tx_utl_01082000.SetRebates;
   -- Abatements
      py_za_tx_utl_01082000.Abatements;

   hr_utility.set_location('py_za_tx_01082000.LteCalc',12);
   ...
   -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.LteCalc',13);
      -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01082000.LteCalc',14);
         trc_TotLibBse := 0;
      END IF;
   ...
   ELSE
      hr_utility.set_location('py_za_tx_01082000.LteCalc',15);
   ...
   --   threshold and rebate figures
     ...
     SELECT MAX(ptp.end_date) "EndDate"
      ...
      hr_utility.set_location('py_za_tx_01082000.LteCalc',16);

   -- Global Values
      l_ZA_TX_YR_END        := l_EndDate;
      l_ZA_ADL_TX_RBT       := py_za_tx_utl_01082000.GlbVal('ZA_ADDITIONAL_TAX_REBATE',l_EndDate);
      l_ZA_PRI_TX_RBT       := py_za_tx_utl_01082000.GlbVal('ZA_PRIMARY_TAX_REBATE',l_EndDate);
      l_ZA_PRI_TX_THRSHLD   := py_za_tx_utl_01082000.GlbVal('ZA_PRIM_TAX_THRESHOLD',l_EndDate);
      l_ZA_SC_TX_THRSHLD    := py_za_tx_utl_01082000.GlbVal('ZA_SEC_TAX_THRESHOLD',l_EndDate);

   -- Calculate the assignments 65 Year Date
      l_65Year := add_months(dbi_PER_DTE_OF_BRTH,780);

      IF l_65Year <= l_ZA_TX_YR_END THEN
         hr_utility.set_location('py_za_tx_01082000.LteCalc',17);
      -- give the extra abatement
         trc_Rebate := l_ZA_PRI_TX_RBT + l_ZA_ADL_TX_RBT;
         trc_Threshold := l_ZA_SC_TX_THRSHLD;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.LteCalc',18);
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.LteCalc',19);
      -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01082000.LteCalc',20);
         trc_TotLibBse := 0;
      END IF;
...
-- Set the SitFactor back to 1
   ...
   hr_utility.set_location('py_za_tx_01082000.LteCalc',21);
...
-- Abatements
   ...
   hr_utility.set_location('py_za_tx_01082000.LteCalc',22);
...
--
   ...
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.LteCalc',23);
   -- Normal Earnings
   ...
   -- Threshold Check
      IF trc_TxbNorInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.LteCalc',24);
      -- Tax Liability
         trc_TotLibNI := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbNorInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01082000.LteCalc',25);
         trc_TotLibNI := 0;
      -- Refund any tax paid
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.LteCalc',26);
...
--
   ...
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.LteCalc',27);
   ...
   -- Threshold Check
      IF trc_TxbFrnInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.LteCalc',28);
      -- Tax Liability
         trc_TotLibFB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbFrnInc);
      ...
      ElSE
         hr_utility.set_location('py_za_tx_01082000.LteCalc',29);
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.LteCalc',30);
...
--
   ...
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.LteCalc',31);
   -- Travel Earnings
   ...
   -- Threshold Check
      IF trc_TxbTrvInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.LteCalc',32);
      -- Tax Liability
         trc_TotLibTA := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbTrvInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01082000.LteCalc',33);
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.LteCalc',34);
...
--
   ...
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.LteCalc',35);
   ...
   -- Threshold Check
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.LteCalc',36);
      -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnBonInc);
         trc_LibFyAB := trc_TotLibAB - trc_TotLibTA;
      -- Negative Check
         IF trc_LibFyAB < 0 THEN
            hr_utility.set_location('py_za_tx_01082000.LteCalc',37);
            trc_TotLibAB := trc_TotLibTA;
         -- Refund any tax paid
            trc_LibFpAB := -1 * bal_TX_ON_AB_YTD;
            trc_NpValABOvr := TRUE;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.LteCalc',38);
            trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.LteCalc',39);
         trc_TotLibAB := trc_TotLibTA;
      -- Refund any tax paid
         trc_LibFpAB := -1 * bal_TX_ON_AB_YTD;
         trc_NpValABOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.LteCalc',40);
...
--
   -- Ytd Annual Payments
   trc_AnnPymYtd := ( bal_AA_PRCHD_RVAL_NRFI_YTD   + bal_AA_PRCHD_RVAL_RFI_YTD
   ...
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.LteCalc',41);
   ...
   -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.LteCalc',42);
      -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFyAP := trc_TotLibAP - trc_TotLibAB;
      -- Negative Check
         IF trc_LibFyAP < 0 THEN
            hr_utility.set_location('py_za_tx_01082000.LteCalc',43);
            trc_TotLibAP := trc_TotLibAB;
         -- Refund any tax paid
            trc_LibFpAP := -1 * bal_TX_ON_AP_YTD;
            trc_NpValAPOvr := TRUE;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.LteCalc',44);
            trc_LibFpAP := trc_LibFyAP - bal_TX_ON_AP_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.LteCalc',45);
         trc_TotLibAP := trc_TotLibAB;
      -- Refund any tax paid
         trc_LibFpAP := -1 * bal_TX_ON_AP_YTD;
         trc_NpValAPOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.LteCalc',46);
...
--
   ...
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.LteCalc',47);
   ...
   ELSE
      hr_utility.set_location('py_za_tx_01082000.LteCalc',48);
      trc_LibFyPO := 0;
   -- Refund any tax paid
...
--
   ...
   IF trc_TxbAnnPymInc + trc_PblOffErn < glb_ZA_SIT_LIM THEN
      hr_utility.set_location('py_za_tx_01082000.LteCalc',49);
      l_Sl := TRUE;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.LteCalc',50);
      l_Sl := FALSE;
   END IF;

   py_za_tx_utl_01082000.NpVal(p_Rf => l_Sl);

-- Set IT3A Indicator
--
   IF trc_TxbAnnPymInc + trc_PblOffErn >= trc_Threshold THEN
      hr_utility.set_location('py_za_tx_01082000.LteCalc',51);
      trc_It3Ind := 0; -- Over Lim
   ELSE
      hr_utility.set_location('py_za_tx_01082000.LteCalc',52);
...
BEGIN
   hr_utility.set_location('py_za_tx_01082000.SeaCalc',1);
...
--
   hr_utility.set_location('py_za_tx_01082000.SeaCalc',2);
   IF trc_TxbIncPtd = 0 THEN -- Pre-Earnings Calc
      hr_utility.set_location('py_za_tx_01082000.SeaCalc',3);
   -- Site Factor
   --
   ...
   -- Abatements
      ...
      IF l_65Year BETWEEN dbi_ZA_TX_YR_STRT AND dbi_ZA_TX_YR_END THEN
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',4);
      -- give the extra abatement
         trc_Rebate := glb_ZA_PRI_TX_RBT + glb_ZA_ADL_TX_RBT;
         trc_Threshold := glb_ZA_SC_TX_THRSHLD;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',5);
      -- not eligable for extra abatement
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',6);
      -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',7);
         trc_TotLibBse := 0;
      END IF;
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',8);
      -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFpAP := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibBse);
      ElSE
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',9);
         trc_LibFpAP := 0;
      END IF;
   ...
   ELSE
      hr_utility.set_location('py_za_tx_01082000.SeaCalc',10);
   -- Site Factor
   --
      trc_SitFactor := glb_ZA_WRK_DYS_PR_YR / dbi_SEA_WRK_DYS_WRK;
   ...
   hr_utility.set_location('py_za_tx_01082000.SeaCalc',11);

   -- Normal Income
   --
      -- Run Normal Income
      trc_NorIncPtd := ( bal_COMM_NRFI_RUN          + bal_COMM_RFI_RUN
                       + bal_COMP_ALL_NRFI_RUN      + bal_COMP_ALL_RFI_RUN
                       + bal_ENT_ALL_NRFI_RUN       + bal_ENT_ALL_RFI_RUN
                       + bal_OTHER_TXB_ALL_NRFI_RUN + bal_OTHER_TXB_ALL_RFI_RUN
                       + bal_OVTM_NRFI_RUN          + bal_OVTM_RFI_RUN
      ...
      IF trc_NorIncPtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',12);
      -- Normal Earnings
      ...
      -- Threshold Check
         IF trc_TxbNorInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01082000.SeaCalc',13);
         -- Tax Liability
            trc_TotLibNI := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbNorInc);
         ...
         ELSE
            hr_utility.set_location('py_za_tx_01082000.SeaCalc',14);
            trc_TotLibNI := 0;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',15);
         trc_NorErn := 0;
         trc_TxbNorInc := 0;
         trc_TotLibNI := 0;
      END IF;
   ...
   --
      -- Run Fringe Benefits
      trc_FrnBenPtd := ( bal_AST_PRCHD_RVAL_NRFI_RUN + bal_AST_PRCHD_RVAL_RFI_RUN
                       + bal_BUR_AND_SCH_NRFI_RUN    + bal_BUR_AND_SCH_RFI_RUN
                       + bal_FREE_ACCOM_NRFI_RUN     + bal_FREE_ACCOM_RFI_RUN
                       + bal_FREE_SERV_NRFI_RUN      + bal_FREE_SERV_RFI_RUN
                       + bal_LOW_LOANS_NRFI_RUN      + bal_LOW_LOANS_RFI_RUN
      ...
      IF trc_FrnBenPtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',16);
      -- Fringe Benefit Earnings
      ...
      -- Threshold Check
         IF trc_TxbFrnInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01082000.SeaCalc',17);
         -- Tax Liability
            trc_TotLibFB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbFrnInc);
            trc_LibFyFB  := trc_TotLibFB - least(trc_TotLibFB,trc_TotLibNI);
            trc_TotLibFB := greatest(trc_TotLibFB,trc_TotLibNI);
         ...
         ELSE
            hr_utility.set_location('py_za_tx_01082000.SeaCalc',18);
            trc_TotLibFB := trc_TotLibNI;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',19);
         trc_FrnBenErn := trc_NorErn;
         trc_TxbFrnInc := trc_TxbNorInc;
         trc_TotLibFB := trc_TotLibNI;
      END IF;
   ...
   --
      -- Run Annual Payments
      trc_AnnPymPtd := ( bal_AA_PRCHD_RVAL_NRFI_RUN   + bal_AA_PRCHD_RVAL_RFI_RUN
                       + bal_AC_NRFI_RUN              + bal_AC_RFI_RUN
                       + bal_ANU_FRM_RET_FND_NRFI_RUN + bal_ANU_FRM_RET_FND_RFI_RUN
                       + bal_ARES_TRD_NRFI_RUN        + bal_ARES_TRD_RFI_RUN
                       + bal_PRCH_ANU_TXB_NRFI_RUN    + bal_PRCH_ANU_TXB_RFI_RUN
      ...
      IF trc_AnnPymPtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',20);
      -- Annual Payments Earnings
      ...
      -- Threshold Check
         IF trc_TxbAnnPymInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01082000.SeaCalc',21);
         -- Tax Liability
            trc_TotLibAP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnPymInc);
            trc_LibFyAP := trc_TotLibAP - trc_TotLibFB;
         -- Negative Check
            IF trc_LibFyAP < 0 THEN
               hr_utility.set_location('py_za_tx_01082000.SeaCalc',22);
               trc_TotLibAP := trc_TotLibFB;
            -- Refund any tax paid
               trc_LibFpAP := 0;
            ELSE
               hr_utility.set_location('py_za_tx_01082000.SeaCalc',23);
               trc_LibFpAP := trc_LibFyAP;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.SeaCalc',24);
            trc_TotLibAP := trc_TotLibFB;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',25);
   ...
   -- Net Pay Validation
   --
      py_za_tx_utl_01082000.NpVal;

   hr_utility.set_location('py_za_tx_01082000.SeaCalc',26);

   -- Set IT3A Indicator
   --
      IF trc_TxbAnnPymInc + trc_PblOffErn >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',27);
         trc_It3Ind := 0; -- Over Lim
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SeaCalc',28);
         trc_It3Ind := 1; -- Under Lim
      END IF;
   END IF;
...
BEGIN
   hr_utility.set_location('py_za_tx_01082000.SitCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'SitCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.SitCalc',2);
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.SitCalc',3);

-- Site Factor
--
   trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01082000.DaysWorked;

   hr_utility.set_location('py_za_tx_01082000.SitCalc',4);
...
-- Abatements
   ...
   hr_utility.set_location('py_za_tx_01082000.SitCalc',5);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.SitCalc',6);
   -- Normal Earnings
   ...
   -- Threshold Check
      IF trc_TxbNorInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.SitCalc',7);
      -- Tax Liability
         trc_TotLibNI := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbNorInc);
         ...
         trc_LibFpNI  := trc_LibFyNI - bal_TX_ON_NI_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SitCalc',8);
         trc_TotLibNI := 0;
      -- Refund any tax paid
         trc_LibFpNI := -1 * bal_TX_ON_NI_YTD;
         trc_NpValNIOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.SitCalc',9);
      trc_NorErn := 0;
      trc_TxbNorInc := 0;
      trc_TotLibNI := 0;
   -- Refund any tax paid
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.SitCalc',10);
   -- Fringe Benefit Earnings
   ...
   -- Threshold Check
      IF trc_TxbFrnInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.SitCalc',11);
      -- Tax Liability
         trc_TotLibFB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbFrnInc);
         ...
         trc_LibFpFB  := trc_LibFyFB - bal_TX_ON_FB_YTD;
      ElSE
         hr_utility.set_location('py_za_tx_01082000.SitCalc',12);
         trc_TotLibFB := trc_TotLibNI;
      -- Refund any tax paid
         trc_LibFpFB := -1 * bal_TX_ON_FB_YTD;
         trc_NpValFBOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.SitCalc',13);
      trc_FrnBenErn := trc_NorErn;
      trc_TxbFrnInc := trc_TxbNorInc;
      trc_TotLibFB := trc_TotLibNI;
   -- Refund any tax paid
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.SitCalc',14);
   -- Travel Earnings
   ...
   -- Threshold Check
      IF trc_TxbTrvInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.SitCalc',15);
      -- Tax Liability
         trc_TotLibTA := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbTrvInc);
         ...
         trc_LibFpTA  := trc_LibFyTA - bal_TX_ON_TA_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SitCalc',16);
         trc_TotLibTA := trc_TotLibFB;
      -- Refund any tax paid
         trc_LibFpTA := -1 * bal_TX_ON_TA_YTD;
         trc_NpValTAOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.SitCalc',17);
      trc_TrvAllErn := trc_FrnBenErn;
      trc_TxbTrvInc := trc_TxbFrnInc;
      trc_TotLibTA := trc_TotLibFB;
   -- Refund any tax paid
...
--
   ...
   IF trc_BonProYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.SitCalc',18);
   ...
   -- Threshold Check
      IF trc_TxbBonProInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.SitCalc',19);
      -- Tax Liability
         trc_TotLibBP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbBonProInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SitCalc',20);
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.SitCalc',21);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.SitCalc',22);
   -- Annual Bonus Earnings
      trc_AnnBonErn := trc_AnnBonYtd + trc_TrvAllErn;
   -- Taxable Annual Bonus Income
      trc_TxbAnnBonInc := trc_AnnBonErn - trc_AnnTotAbm;
   -- Threshold Check
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.SitCalc',23);
      -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnBonInc);
         trc_LibFyAB := trc_TotLibAB - trc_TotLibTA;
      -- Negative Check
         IF trc_LibFyAB < 0 THEN
            hr_utility.set_location('py_za_tx_01082000.SitCalc',24);
            trc_TotLibAB := trc_TotLibTA;
         -- Refund any tax paid
            trc_LibFpAB := -1 * bal_TX_ON_AB_YTD;
            trc_NpValABOvr := TRUE;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.SitCalc',25);
         -- Check Bonus Provision
            IF trc_BonProYtd <> 0 THEN
               hr_utility.set_location('py_za_tx_01082000.SitCalc',26);
               trc_LibFpAB := trc_LibFyAB - (bal_TX_ON_BP_YTD
                                            + trc_LibFpBP
                                            + bal_TX_ON_AB_YTD
                                            );
            ELSE
               hr_utility.set_location('py_za_tx_01082000.SitCalc',27);
               trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
            END IF;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SitCalc',28);
         trc_TotLibAB := trc_TotLibTA;
      -- Refund any tax paid
         trc_LibFpAB := -1 * bal_TX_ON_AB_YTD;
         trc_NpValABOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.SitCalc',29);
      trc_AnnBonErn := trc_TrvAllErn;
      trc_TxbAnnBonInc := trc_TxbTrvInc;
      trc_TotLibAB := trc_TotLibTA;
   -- Refund any tax paid
...
--
   -- Ytd Annual Payments
   trc_AnnPymYtd :=
      ( bal_AA_PRCHD_RVAL_NRFI_YTD
      + bal_AA_PRCHD_RVAL_RFI_YTD
      + bal_AC_NRFI_YTD
      + bal_AC_RFI_YTD
      + bal_ANU_FRM_RET_FND_NRFI_YTD
      + bal_ANU_FRM_RET_FND_RFI_YTD
      + bal_ARES_TRD_NRFI_YTD
      + bal_ARES_TRD_RFI_YTD
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.SitCalc',30);
   -- Annual Payments Earnings
      trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
   -- Taxable Annual Payments Income
      trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
   -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.SitCalc',31);
      -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFyAP := trc_TotLibAP - trc_TotLibAB;
      -- Negative Check
         IF trc_LibFyAP < 0 THEN
            hr_utility.set_location('py_za_tx_01082000.SitCalc',32);
            trc_TotLibAP := trc_TotLibAB;
         -- Refund any tax paid
            trc_LibFpAP := -1 * bal_TX_ON_AP_YTD;
            trc_NpValAPOvr := TRUE;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.SitCalc',33);
            trc_LibFpAP := trc_LibFyAP - bal_TX_ON_AP_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.SitCalc',34);
         trc_TotLibAP := trc_TotLibAB;
      -- Refund any tax paid
         trc_LibFpAP := -1 * bal_TX_ON_AP_YTD;
         trc_NpValAPOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.SitCalc',35);
      trc_AnnPymErn := trc_AnnBonErn;
      trc_TxbAnnPymInc := trc_TxbAnnBonInc;
      trc_TotLibAP := trc_TotLibAB;
   -- Refund any tax paid
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.SitCalc',36);
   -- Public Office Earnings
   ...
   -- Tax Liability
      ...
      trc_LibFpPO := trc_LibFyPO -  bal_TX_ON_PO_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.SitCalc',37);
      trc_LibFyPO := 0;
   -- Refund any tax paid
      trc_LibFpPO := -1 * bal_TX_ON_PO_YTD;
      trc_NpValPOOvr := TRUE;
...
--
   ...
   -- Site Limit Check
   IF trc_TxbAnnPymInc + trc_PblOffErn < glb_ZA_SIT_LIM THEN
      hr_utility.set_location('py_za_tx_01082000.SitCalc',38);
      l_Sl := TRUE;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.SitCalc',39);
      l_Sl := FALSE;
   END IF;

   py_za_tx_utl_01082000.NpVal(p_Rf => l_Sl);

   hr_utility.set_location('py_za_tx_01082000.SitCalc',40);

-- Set IT3A Indicator
--
   IF trc_TxbAnnPymInc + trc_PblOffErn >= trc_Threshold THEN
      hr_utility.set_location('py_za_tx_01082000.SitCalc',41);
      trc_It3Ind := 0; -- Over Lim
   ELSE
      hr_utility.set_location('py_za_tx_01082000.SitCalc',42);
      trc_It3Ind := 1; -- Under Lim
   END IF;
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.SitCalc',43);
...
BEGIN
   hr_utility.set_location('py_za_tx_01082000.DirCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'DirCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.DirCalc',2);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.DirCalc',3);
   -- Normal Earnings
      trc_NorErn := trc_NorIncYtd;
   -- Tax Liability
      trc_TotLibNI := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_NorErn);
      trc_LibFyNI := trc_TotLibNI - 0;
      trc_LibFpNI := trc_LibFyNI - bal_TX_ON_NI_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.DirCalc',4);
      trc_NorErn := 0;
      trc_TotLibNI := 0;
   -- Refund any tax paid
      trc_LibFpNI := -1 * bal_TX_ON_NI_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.DirCalc',5);
   -- Fringe Benefit Earnings
      trc_FrnBenErn := trc_FrnBenYtd + trc_NorErn;
   -- Tax Liability
      trc_TotLibFB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_FrnBenErn);
      trc_LibFyFB  := trc_TotLibFB - least(trc_TotLibFB,trc_TotLibNI);
      trc_TotLibFB := greatest(trc_TotLibFB,trc_TotLibNI);
      trc_LibFpFB  := trc_LibFyFB - bal_TX_ON_FB_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.DirCalc',6);
      trc_FrnBenErn := trc_NorErn;
      trc_TotLibFB := trc_TotLibNI;
   -- Refund any tax paid
      trc_LibFpFB := -1 * bal_TX_ON_FB_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.DirCalc',7);
   -- Travel Allowance Earnings
      trc_TrvAllErn := trc_TrvAllYtd + trc_FrnBenErn;
   -- Tax Liability
      trc_TotLibTA := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TrvAllErn);
      trc_LibFyTA  := trc_TotLibTA - least(trc_TotLibTA,trc_TotLibFB);
      trc_TotLibTA := greatest(trc_TotLibTA,trc_TotLibFB);
      trc_LibFpTA  := trc_LibFyTA - bal_TX_ON_TA_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.DirCalc',8);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_BonProYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.DirCalc',9);
   -- Bonus Provision Earnings
      trc_BonProErn := trc_BonProYtd + trc_TrvAllErn;
   -- Tax Liability
      trc_TotLibBP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_BonProErn);
      trc_LibFyBP  := trc_TotLibBP - least(trc_TotLibBP,trc_TotLibTA);
      trc_TotLibBP := greatest(trc_TotLibBP,trc_TotLibTA);
      trc_LibFpBP  := trc_LibFyBP - bal_TX_ON_BP_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.DirCalc',10);
      trc_BonProErn := trc_TrvAllErn;
      trc_TotLibBP := trc_TotLibTA;
   -- Refund any tax paid
      trc_LibFpBP := -1 * bal_TX_ON_BP_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.DirCalc',11);
   -- Annual Bonus Earnings
      trc_AnnBonErn := trc_AnnBonYtd + trc_TrvAllErn;
   -- Tax Liability
      trc_TotLibAB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_AnnBonErn);
      trc_LibFyAB  := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibTA);
      trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibTA);
   -- Check Bonus Provision
      IF trc_BonProYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01082000.DirCalc',12);
      -- Check Bonus Provision Frequency
         IF dbi_BP_TX_RCV = 'A' THEN
            hr_utility.set_location('py_za_tx_01082000.DirCalc',13);
            trc_LibFpAB := 0;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.DirCalc',14);
            trc_LibFpAB :=
         ...
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.DirCalc',15);
         trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.DirCalc',16);
      trc_AnnBonErn := trc_TrvAllErn;
      trc_TotLibAB := trc_TotLibTA;
   -- Refund any tax paid
      trc_LibFpAB := -1 * bal_TX_ON_AB_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.DirCalc',17);
   -- Annual Payments Earnings
      trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
   -- Tax Liability
      trc_TotLibAP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_AnnPymErn);
      trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
      trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
      trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
   ElSE
      hr_utility.set_location('py_za_tx_01082000.DirCalc',18);
      trc_AnnPymErn := trc_AnnBonErn;
      trc_TotLibAP := trc_TotLibAB;
   -- Refund any tax paid
      trc_LibFpAP := -1 * bal_TX_ON_AP_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.DirCalc',19);
   -- Tax Liability
      trc_LibFyPO := trc_PblOffYtd * glb_ZA_PBL_TX_RTE / 100;
      trc_LibFpPO := trc_LibFyPO -  bal_TX_ON_PO_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.DirCalc',20);
      trc_LibFyPO := 0;
   -- Refund any tax paid
      trc_LibFpPO := -1 * bal_TX_ON_PO_YTD;
      trc_NpValPOOvr := TRUE;
...
-- Net Pay Validation
--
   py_za_tx_utl_01082000.NpVal(p_Rf => TRUE);

   hr_utility.set_location('py_za_tx_01082000.DirCalc',21);

-- Tax Percentage Indicator
--
   IF dbi_TX_STA = 'D' THEN
      hr_utility.set_location('py_za_tx_01082000.DirCalc',22);
      trc_TxPercVal := dbi_TX_DIR_VAL;
   ELSIF dbi_TX_STA = 'E' THEN
      hr_utility.set_location('py_za_tx_01082000.DirCalc',23);
      trc_TxPercVal := glb_ZA_CC_TX_PRC;
   ELSIF dbi_TX_STA = 'F' THEN
      hr_utility.set_location('py_za_tx_01082000.DirCalc',24);
      trc_TxPercVal := glb_ZA_TMP_TX_RTE;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.DirCalc',25);
      trc_TxPercVal := 0;
   END IF;

   hr_utility.set_location('py_za_tx_01082000.DirCalc',26);
...
BEGIN
   hr_utility.set_location('py_za_tx_01082000.BasCalc',1);
-- Identify the Calculation
--
   trc_CalTyp := 'BasCalc';

-- Tax Rebates, Threshold Figure
--
   -- Calculate the assignments 65 Year Date
   l_65Year := add_months(dbi_PER_DTE_OF_BRTH,780);

   hr_utility.set_location('py_za_tx_01082000.BasCalc',2);

   IF l_65Year BETWEEN dbi_ZA_TX_YR_STRT AND dbi_ZA_TX_YR_END THEN
      hr_utility.set_location('py_za_tx_01082000.BasCalc',3);
   -- give the extra abatement
      trc_Rebate := glb_ZA_PRI_TX_RBT + glb_ZA_ADL_TX_RBT;
      trc_Threshold := glb_ZA_SC_TX_THRSHLD;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.BasCalc',4);
   -- not eligable for extra abatement
      trc_Rebate := glb_ZA_PRI_TX_RBT;
      trc_Threshold := glb_ZA_PRI_TX_THRSHLD;
   END IF;
...
--
   ...
   trc_BseErn :=
      ( bal_AB_NRFI_PTD
      + bal_AB_RFI_PTD
      + bal_AA_PRCHD_RVAL_NRFI_PTD
      + bal_AA_PRCHD_RVAL_RFI_PTD
      + bal_AC_NRFI_PTD
      + bal_AC_RFI_PTD
      + bal_ANU_FRM_RET_FND_NRFI_PTD
      + bal_ANU_FRM_RET_FND_RFI_PTD
      + bal_ARES_TRD_NRFI_PTD
      + bal_ARES_TRD_RFI_PTD
   ...
   -- Threshold Check
   IF trc_TxbBseInc >= trc_Threshold THEN
      hr_utility.set_location('py_za_tx_01082000.BasCalc',5);
   -- Tax Liability
      trc_TotLibBse := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbBseInc);
   ELSE
      hr_utility.set_location('py_za_tx_01082000.BasCalc',6);
      trc_TotLibBse := 0;
   END IF;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.BasCalc',7);
   -- Taxable Annual Bonus Income
      trc_TxbAnnBonInc := trc_AnnBonYtd + trc_TxbBseInc;
   -- Threshold Check
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.BasCalc',8);
      -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnBonInc);
         trc_LibFyAB := trc_TotLibAB - trc_TotLibBse;
      -- Negative Check
         IF trc_LibFyAB < 0 THEN
            hr_utility.set_location('py_za_tx_01082000.BasCalc',9);
         ...
         -- Check Bonus Provision
            IF bal_BP_YTD <> 0 THEN
               hr_utility.set_location('py_za_tx_01082000.BasCalc',10);
            -- Check Bonus Provision Frequency
               IF dbi_BP_TX_RCV = 'A' THEN
                  hr_utility.set_location('py_za_tx_01082000.BasCalc',11);
                  trc_LibFpAB := 0;
               ELSE
                  hr_utility.set_location('py_za_tx_01082000.BasCalc',12);
                  trc_LibFpAB :=
                  trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                + bal_TX_ON_AB_YTD);
               END IF;
            ELSE
               hr_utility.set_location('py_za_tx_01082000.BasCalc',13);
               trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
            END IF;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.BasCalc',14);
         trc_TotLibAB := trc_TotLibBse;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.BasCalc',15);
      trc_TotLibAB := trc_TotLibBse;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.BasCalc',16);
   -- Taxable Annual Payments Income
      trc_TxbAnnPymInc := trc_AnnPymYtd + trc_TxbAnnBonInc;
   -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.BasCalc',17);
      -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFyAP := trc_TotLibAP - trc_TotLibAB;
      -- Negative Check
         IF trc_LibFyAP < 0 THEN
            hr_utility.set_location('py_za_tx_01082000.BasCalc',18);
            trc_TotLibAP := trc_TotLibAB;
         -- Refund any tax paid
            trc_LibFpAP := -1 * bal_TX_ON_AB_YTD;
            trc_NpValAPOvr := TRUE;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.BasCalc',19);
            trc_LibFpAP := trc_LibFyAP - bal_TX_ON_AP_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.BasCalc',20);
         NULL;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.BasCalc',21);
      NULL;
   END IF;
...
BEGIN
   hr_utility.set_location('py_za_tx_01082000.CalCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'CalCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.CalCalc',2);
...
--
   trc_TxbIncYtd :=
      ...
      + bal_RES_TRD_NRFI_CYTD
      + bal_RES_TRD_RFI_CYTD
...
--
   IF trc_TxbIncYtd = 0 THEN
      hr_utility.set_location('py_za_tx_01082000.CalCalc',3);
      BasCalc;
   ELSE -- continue CalCalc
      hr_utility.set_location('py_za_tx_01082000.CalCalc',4);
   -- Site Factor
   --
      trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01082000.DaysWorked;
   ...
   -- Abatements
      ...
      hr_utility.set_location('py_za_tx_01082000.CalCalc',5);
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.CalCalc',6);
      -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01082000.CalCalc',7);
         trc_TotLibBse := 0;
      END IF;
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnBonYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01082000.CalCalc',8);
      -- Annual Bonus Earnings
      ...
      -- Threshold Check
         IF trc_TxbAnnBonInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01082000.CalCalc',9);
         -- Tax Liability
            trc_TotLibAB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnBonInc);
            trc_LibFyAB := trc_TotLibAB - trc_TotLibBse;
         -- Negative Check
            IF trc_LibFyAB < 0 THEN
               hr_utility.set_location('py_za_tx_01082000.CalCalc',10);
               trc_TotLibAB := trc_TotLibBse;
            -- Refund any tax paid
               trc_LibFpAB := -1 * bal_TX_ON_AB_YTD;
               trc_NpValABOvr := TRUE;
            ...
            -- Check Bonus Provision
               IF bal_BP_YTD <> 0 THEN
                  hr_utility.set_location('py_za_tx_01082000.CalCalc',11);
               -- Check Bonus Provision Frequency
                  IF dbi_BP_TX_RCV = 'A' THEN
                     hr_utility.set_location('py_za_tx_01082000.CalCalc',12);
                     trc_LibFpAB := 0;
                  ELSE
                     hr_utility.set_location('py_za_tx_01082000.CalCalc',13);
                     trc_LibFpAB :=
                     trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                   + bal_TX_ON_AB_YTD);
                  END IF;
               ELSE
                  hr_utility.set_location('py_za_tx_01082000.CalCalc',14);
                  trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
               END IF;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.CalCalc',15);
            trc_TotLibAB := trc_TotLibBse;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.CalCalc',16);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnPymYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01082000.CalCalc',17);
      -- Annual Payments Earnings
         trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
      -- Taxable Annual Payments Income
         trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
      -- Threshold Check
         IF trc_TxbAnnPymInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01082000.CalCalc',18);
         -- Tax Liability
            trc_TotLibAP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnPymInc);
            trc_LibFyAP := trc_TotLibAP - trc_TotLibAB;
         -- Negative Check
            IF trc_LibFyAP < 0 THEN
               hr_utility.set_location('py_za_tx_01082000.CalCalc',19);
               trc_TotLibAP := trc_TotLibAB;
            -- Refund any tax paid
               trc_LibFpAP := -1 * bal_TX_ON_AP_YTD;
               trc_NpValAPOvr := TRUE;
            ELSE
               hr_utility.set_location('py_za_tx_01082000.CalCalc',20);
               trc_LibFpAP := trc_LibFyAP - bal_TX_ON_AP_YTD;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.CalCalc',21);
            trc_TotLibAP := trc_TotLibAB;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.CalCalc',22);
         trc_AnnPymErn := trc_AnnBonErn;
         trc_TxbAnnPymInc := trc_TxbAnnBonInc;
         trc_TotLibAP := trc_TotLibAB;
      END IF;
   ...
   hr_utility.set_location('py_za_tx_01082000.CalCalc',23);
...
BEGIN
   hr_utility.set_location('py_za_tx_01082000.YtdCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'YtdCalc';
...
-- Update Global Balance Values with correct TAXABLE values
   ...
   hr_utility.set_location('py_za_tx_01082000.YtdCalc',2);
...
-- If the Ytd Taxable Income = 0, execute the CalCalc
   IF trc_TxbIncYtd = 0 THEN
      hr_utility.set_location('py_za_tx_01082000.YtdCalc',3);
      CalCalc;
   ELSE --Continue YtdCalc
      hr_utility.set_location('py_za_tx_01082000.YtdCalc',4);
   -- Site Factor
      trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01082000.DaysWorked;
   ...
   -- Abatements
      ...
      hr_utility.set_location('py_za_tx_01082000.YtdCalc',5);
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.YtdCalc',6);
      -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01082000.YtdCalc',7);
         trc_TotLibBse := 0;
      END IF;
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnBonYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01082000.YtdCalc',8);
      -- Annual Bonus Earnings
         trc_AnnBonErn := trc_AnnBonYtd + trc_BseErn;
      -- Taxable Annual Bonus Income
         trc_TxbAnnBonInc := trc_AnnBonErn - trc_AnnTotAbm;
      -- Threshold Check
         IF trc_TxbAnnBonInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01082000.YtdCalc',9);
         -- Tax Liability
            trc_TotLibAB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnBonInc);
            trc_LibFyAB := trc_TotLibAB - trc_TotLibBse;
         -- Negative Check
            IF trc_LibFyAB < 0 THEN
               hr_utility.set_location('py_za_tx_01082000.YtdCalc',10);
               trc_TotLibAB := trc_TotLibBse;
            -- Refund any tax paid
               trc_LibFpAB := -1 * bal_TX_ON_AB_YTD;
               trc_NpValABOvr := TRUE;
            ...
            -- Check Bonus Provision
               IF bal_BP_YTD <> 0 THEN
                  hr_utility.set_location('py_za_tx_01082000.YtdCalc',11);
               -- Check Bonus Provision Frequency
                  IF dbi_BP_TX_RCV = 'A' THEN
                     hr_utility.set_location('py_za_tx_01082000.YtdCalc',12);
                     trc_LibFpAB := 0;
                  ELSE
                     hr_utility.set_location('py_za_tx_01082000.YtdCalc',13);
                     trc_LibFpAB :=
                     trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                   + bal_TX_ON_AB_YTD);
                  END IF;
               ELSE
                  hr_utility.set_location('py_za_tx_01082000.YtdCalc',14);
                  trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
               END IF;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.YtdCalc',15);
            trc_TotLibAB := trc_TotLibBse;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.YtdCalc',16);
         trc_AnnBonErn := trc_BseErn;-- Cascade Figure
         trc_TxbAnnBonInc := trc_TxbBseInc;
         trc_TotLibAB := trc_TotLibBse;
      END IF;
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnPymYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01082000.YtdCalc',17);
      -- Annual Payments Earnings
         trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
      -- Taxable Annual Payments Income
         trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
      -- Threshold Check
         IF trc_TxbAnnPymInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01082000.YtdCalc',18);
         -- Tax Liability
            trc_TotLibAP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnPymInc);
            trc_LibFyAP := trc_TotLibAP - trc_TotLibAB;
         -- Negative Check
            IF trc_LibFyAP < 0 THEN
               hr_utility.set_location('py_za_tx_01082000.YtdCalc',19);
               trc_TotLibAP := trc_TotLibAB;
            -- Refund any tax paid
               trc_LibFpAP := -1 * bal_TX_ON_AP_YTD;
               trc_NpValAPOvr := TRUE;
            ELSE
               hr_utility.set_location('py_za_tx_01082000.YtdCalc',20);
               trc_LibFpAP := trc_LibFyAP - bal_TX_ON_AP_YTD;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.YtdCalc',21);
            trc_TotLibAP := trc_TotLibAB;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.YtdCalc',22);
   ...
   --
      ...
      hr_utility.set_location('py_za_tx_01082000.YtdCalc',23);
...
BEGIN
   hr_utility.set_location('py_za_tx_01082000.NorCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'NorCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.NorCalc',2);
...
-- Period Factor
   py_za_tx_utl_01082000.PeriodFactor;

-- Possible Periods Factor
   py_za_tx_utl_01082000.PossiblePeriodsFactor;
...
-- Abatements
   ...
   hr_utility.set_location('py_za_tx_01082000.NorCalc',3);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.NorCalc',4);

   -- Annualise Normal Income
      trc_NorErn := py_za_tx_utl_01082000.Annualise
   ...
   -- Threshold Check
      IF trc_TxbNorInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.NorCalc',5);
      -- Tax Liability
         trc_TotLibNI := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbNorInc);
         trc_LibFyNI := trc_TotLibNI - 0;
      -- DeAnnualise
         trc_LibFpNI := py_za_tx_utl_01082000.DeAnnualise
            (p_Liab    => trc_LibFyNI
            ,p_TxOnYtd => bal_TX_ON_NI_YTD
            ,p_TxOnPtd => bal_TX_ON_NI_PTD
            );
      ELSE
         hr_utility.set_location('py_za_tx_01082000.NorCalc',6);
         trc_TotLibNI := 0;
      -- Refund any tax paid
         trc_LibFpNI := -1 * bal_TX_ON_NI_YTD;
         trc_NpValNIOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.NorCalc',7);
      trc_NorErn := 0;
      trc_TxbNorInc := 0;
      trc_TotLibNI := 0;
   -- Refund any tax paid
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.NorCalc',8);

   -- Annualise Fringe Benefits
      trc_FrnBenErn := py_za_tx_utl_01082000.Annualise
   ...
   -- Threshold Check
      IF trc_TxbFrnInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.NorCalc',9);
      -- Tax Liability
         trc_TotLibFB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbFrnInc);
         trc_LibFyFB  := trc_TotLibFB - least(trc_TotLibFB,trc_TotLibNI);
         trc_TotLibFB := greatest(trc_TotLibFB,trc_TotLibNI);
      -- DeAnnualise
         trc_LibFpFB := py_za_tx_utl_01082000.DeAnnualise
            (trc_LibFyFB
            ,bal_TX_ON_FB_YTD
            ,bal_TX_ON_FB_PTD
            );
      ELSE
         hr_utility.set_location('py_za_tx_01082000.NorCalc',10);
         trc_TotLibFB := trc_TotLibNI;
      -- Refund any tax paid
         trc_LibFpFB := -1 * bal_TX_ON_FB_YTD;
         trc_NpValFBOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.NorCalc',11);
      trc_FrnBenErn := trc_NorErn;
      trc_TxbFrnInc := trc_TxbNorInc;
      trc_TotLibFB := trc_TotLibNI;
   -- Refund any tax paid
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.NorCalc',12);
   -- Ptd Travel Allowance
      trc_TrvAllPtd := bal_TA_NRFI_PTD + bal_TA_RFI_PTD;
   -- Annualise Travel Allowance
      trc_TrvAllErn := py_za_tx_utl_01082000.Annualise
   ...
   -- Threshold Check
      IF trc_TxbTrvInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.NorCalc',13);
      -- Tax Liability
         trc_TotLibTA := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbTrvInc);
         trc_LibFyTA := trc_TotLibTA - least(trc_TotLibTA,trc_TotLibFB);
         trc_TotLibTA := greatest(trc_TotLibTA,trc_TotLibFB);
      -- DeAnnualise
         trc_LibFpTA := py_za_tx_utl_01082000.DeAnnualise
            (trc_LibFyTA
            ,bal_TX_ON_TA_YTD
            ,bal_TX_ON_TA_PTD
            );
      ELSE
         hr_utility.set_location('py_za_tx_01082000.NorCalc',14);
         trc_TotLibTA := trc_TotLibFB;
      -- Refund any tax paid
         trc_LibFpTA := -1 * bal_TX_ON_TA_YTD;
         trc_NpValTAOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.NorCalc',15);
      trc_TrvAllErn := trc_FrnBenErn;-- Cascade Figure
      trc_TxbTrvInc := trc_TxbFrnInc;
      trc_TotLibTA := trc_TotLibFB;
   -- Refund any tax paid
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_BonProYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.NorCalc',16);
   -- Annualise Bonus Provision
      trc_BonProErn := py_za_tx_utl_01082000.Annualise
   ...
   -- Threshold Check
      IF trc_TxbBonProInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.NorCalc',17);
      -- Tax Liability
         trc_TotLibBP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbBonProInc);
         trc_LibFyBP := trc_TotLibBP - least(trc_TotLibBP,trc_TotLibTA);
         trc_TotLibBP := greatest(trc_TotLibBP,trc_TotLibTA);
      -- DeAnnualise
         trc_LibFpBP := py_za_tx_utl_01082000.DeAnnualise
            (trc_LibFyBP
            ,bal_TX_ON_BP_YTD
            ,bal_TX_ON_BP_PTD
           );
      ELSE
         hr_utility.set_location('py_za_tx_01082000.NorCalc',18);
         trc_TotLibBP := trc_TotLibTA;
      -- Refund any tax paid
         trc_LibFpBP := -1 * bal_TX_ON_BP_YTD;
         trc_NpValBPOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.NorCalc',19);
      trc_BonProErn := trc_TrvAllErn;
      trc_TxbBonProInc := trc_TxbTrvInc;
      trc_TotLibBP := trc_TotLibTA;
   -- Refund any tax paid
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.NorCalc',20);
   -- Annual Bonus Earnings
      trc_AnnBonErn := trc_AnnBonYtd + trc_TrvAllErn;
   -- Taxable Annual Bonus Income
      trc_TxbAnnBonInc := trc_AnnBonErn - trc_AnnTotAbm;
   -- Threshold Check
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.NorCalc',21);
      -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnBonInc);
         trc_LibFyAB := trc_TotLibAB - trc_TotLibTA;
      -- Negative Check
         IF trc_LibFyAB < 0 THEN
            hr_utility.set_location('py_za_tx_01082000.NorCalc',22);
            trc_TotLibAB := trc_TotLibTA;
         -- Refund any tax paid
            trc_LibFpAB := -1 * bal_TX_ON_AB_YTD;
            trc_NpValABOvr := TRUE;
         ...
         -- Check Bonus Provision
            IF trc_BonProYtd <> 0 THEN
               hr_utility.set_location('py_za_tx_01082000.NorCalc',23);
            -- Check Bonus Provision Frequency
               IF dbi_BP_TX_RCV = 'A' THEN
                  hr_utility.set_location('py_za_tx_01082000.NorCalc',24);
                  trc_LibFpAB := 0;
               ELSE
                  hr_utility.set_location('py_za_tx_01082000.NorCalc',25);
                  trc_LibFpAB :=
                  trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                + trc_LibFpBP
                                + bal_TX_ON_AB_YTD);
               END IF;
            ELSE
               hr_utility.set_location('py_za_tx_01082000.NorCalc',26);
               trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
            END IF;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.NorCalc',27);
         trc_TotLibAB := trc_TotLibTA;
      -- Refund any tax paid
         trc_LibFpAB := -1 * bal_TX_ON_AB_YTD;
         trc_NpValABOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.NorCalc',28);
      trc_AnnBonErn := trc_TrvAllErn;
      trc_TxbAnnBonInc := trc_TxbTrvInc;
      trc_TotLibAB := trc_TotLibTA;
   -- Refund any tax paid
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.NorCalc',29);
   -- Annual Payments Earnings
      trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
   -- Taxable Annual Payments Income
      trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
   -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01082000.NorCalc',30);
      -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01082000.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFyAP := trc_TotLibAP - trc_TotLibAB;
      -- Negative Check
         IF trc_LibFyAP < 0 THEN
            hr_utility.set_location('py_za_tx_01082000.NorCalc',31);
            trc_TotLibAP := trc_TotLibAB;
         -- Refund any tax paid
            trc_LibFpAP := -1 * bal_TX_ON_AP_YTD;
            trc_NpValAPOvr := TRUE;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.NorCalc',32);
            trc_LibFpAP := trc_LibFyAP - bal_TX_ON_AP_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.NorCalc',33);
         trc_TotLibAP := trc_TotLibAB;
      -- Refund any tax paid
         trc_LibFpAP := -1 * bal_TX_ON_AP_YTD;
         trc_NpValAPOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.NorCalc',34);
      trc_AnnPymErn := trc_AnnBonErn;
      trc_TxbAnnPymInc := trc_TxbAnnBonInc;
      trc_TotLibAP := trc_TotLibAB;
   -- Refund any tax paid
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01082000.NorCalc',35);
   ...
   -- Annualise Public Office Allowance
      trc_PblOffErn := py_za_tx_utl_01082000.Annualise
         (p_YtdInc => trc_PblOffYtd
         ,p_PtdInc => trc_PblOffPtd
         );
   -- Tax Liability
      trc_LibFyPO := trc_PblOffErn * glb_ZA_PBL_TX_RTE / 100;
      trc_LibFpPO := py_za_tx_utl_01082000.DeAnnualise
         (trc_LibFyPO
         ,bal_TX_ON_PO_YTD
         ,bal_TX_ON_PO_PTD
         );
   ELSE
      hr_utility.set_location('py_za_tx_01082000.NorCalc',36);
   -- Refund any tax paid
      trc_LibFpPO := -1 * bal_TX_ON_PO_YTD;
      trc_NpValPOOvr := TRUE;
   END IF;
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.NorCalc',37);
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxGlb_01082000: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxGlb_01082000;

-- Function to Initialise Globals - Database Item Values
--
FUNCTION ZaTxDbi_01082000(
-- Database Items
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxDbi_01082000: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxDbi_01082000;


-- Function to Initialise Globals - Balance Values
-- First Section
FUNCTION ZaTxBal1_01082000(
-- Balances
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal1_01082000: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal1_01082000;


-- Function to Initialise Globals - Balance Values
-- Second Section
FUNCTION ZaTxBal2_01082000(
-- Balances
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal2_01082000: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal2_01082000;

-- Function to Initialise Globals - Balance Values
-- Third Section
FUNCTION ZaTxBal3_01082000(
-- Balances
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal3_01082000: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal3_01082000;

-- Function to Initialise Globals - Balance Values
-- Fourth Section
FUNCTION ZaTxBal4_01082000(
-- Balances
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal4_01082000: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal4_01082000;

FUNCTION ZaTxBal5_01082000(
-- Balances
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal4_01082000: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal5_01082000;

-- Main Tax Function
-- Called from Fast Formula
FUNCTION ZaTx_01082000(
/*  PARAMETERS */
-- Contexts
...
--
--   py_za_tx_utl_01082000.g_HrTraceEnabled  := TRUE;
--   py_za_tx_utl_01082000.g_HrTracePipeName := 'ZATAX';

-- Call hr_utility start procedure
   py_za_tx_utl_01082000.StartHrTrace;
...
-- Setup Trace Header Info
   ...
   WrtHrTrc('-------------------------------------------------------------------------------');
   WrtHrTrc('   dbi_ARR_PF_FRQ: '          ||dbi_ARR_PF_FRQ);
   WrtHrTrc('   dbi_ARR_RA_FRQ: '          ||dbi_ARR_RA_FRQ);
   ...
   WrtHrTrc('   dbi_RA_FRQ: '              ||dbi_RA_FRQ);
   ...
   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',1);
...
-- Contexts
   ...
   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',2);
...
--
   ...
   L = Labour Broker
   */
   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',3);

-- C = Directive Amount
--
   IF dbi_TX_STA = 'C' THEN
      IF trc_OvrTxCalc AND (trc_OvrTyp = 'S' OR trc_OvrTyp = 'P') THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',4);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',5);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_C';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',6);
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',7);
         trc_CalTyp := 'OvrCalc';
      ...
      ELSIF dbi_TX_DIR_NUM = 'NULL' THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',8);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',9);
            xpt_Msg := 'PY_ZA_TX_DIR_NUM';
         END IF;
         RAISE xpt_E;
      -- Check that directive value is filled in
      ELSIF dbi_TX_DIR_VAL = -1 THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',10);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',11);
            xpt_Msg := 'PY_ZA_TX_DIR_MONT';
         END IF;
         RAISE xpt_E;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',12);
         trc_CalTyp := 'NoCalc';
...
--
   ELSIF dbi_TX_STA = 'D' THEN
      IF trc_OvrTxCalc AND trc_OvrTyp = 'S' THEN
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',13);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_DEF';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',14);
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',15);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'P' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',16);
            trc_OvrWrn := 'WARNING: Tax Override - '||to_char(trc_OvrPrc)||' Percent';
            -- Percentage taken into account in py_za_tx_utl_01082000.TaxLiability
         END IF;
      -- Check Directive Number First
         IF dbi_TX_DIR_NUM = 'NULL' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',17);
            IF xpt_Msg = 'No Error' THEN
               hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',18);
               xpt_Msg := 'PY_ZA_TX_DIR_NUM';
            END IF;
            RAISE xpt_E;
         -- Check that directive value is filled in
         ELSIF dbi_TX_DIR_VAL = -1 THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',19);
            IF xpt_Msg = 'No Error' THEN
               hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',20);
               xpt_Msg := 'PY_ZA_TX_DIR_PERC';
            END IF;
            RAISE xpt_E;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',21);
            DirCalc;
         END IF;
      END IF;
-- E = Close Corporation
...
--
   ELSIF dbi_TX_STA IN ('E','F','J','L') THEN
      IF trc_OvrTxCalc AND trc_OvrTyp = 'S' THEN
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',22);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_DEF';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',23);
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',24);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'P' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',25);
            trc_OvrWrn := 'WARNING: Tax Override - '||to_char(trc_OvrPrc)||' Percent';
            -- Percentage taken into account in py_za_tx_utl_01082000.TaxLiability
         END IF;
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',26);
...
--
   ELSIF dbi_TX_STA = 'G' THEN
      IF trc_OvrTxCalc AND (trc_OvrTyp = 'S' OR trc_OvrTyp = 'P') THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',27);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',28);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_G';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',29);
   -- Check that seasonal worker days worked is filled in
      ELSIF dbi_SEA_WRK_DYS_WRK = 0 THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',30);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',31);
            xpt_Msg := 'PY_ZA_TX_SEA_WRK_DYS';
         END IF;
         RAISE xpt_E;
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',32);
            trc_CalTyp := 'OvrCalc';
            trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
            py_za_tx_utl_01082000.SetRebates;
         ELSE
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',33);
            SeaCalc;
         END IF;
      END IF;
-- A = Normal
...
--
   ELSIF dbi_TX_STA IN ('A','B','K') THEN
      IF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',34);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
         py_za_tx_utl_01082000.SetRebates;
         trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01082000.DaysWorked;
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'S' THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',35);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Forced Site Calculation';
         -- Force the Site Calculation
         SitCalc;
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',36);
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'P' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',37);
            trc_OvrWrn := 'WARNING: Tax Override - '||to_char(trc_OvrPrc)||' Percent';
            -- Percentage taken into account in py_za_tx_utl_01082000.TaxLiability
         END IF;

         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',38);
         IF py_za_tx_utl_01082000.LatePayPeriod THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',39);
            LteCalc;
         -- Is this a SITE Period?
         ELSIF py_za_tx_utl_01082000.EmpTermPrePeriod THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',40);
            SitCalc;
         ELSIF py_za_tx_utl_01082000.LstPeriod OR py_za_tx_utl_01082000.EmpTermInPeriod THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',41);
            IF py_za_tx_utl_01082000.PreErnPeriod THEN
               hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',42);
               YtdCalc;
            ELSE
               hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',43);
               SitCalc;
            END IF;
         ElSE
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',44);
         -- The employee has NOT been terminated!
            IF py_za_tx_utl_01082000.PreErnPeriod THEN
               hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',45);
               YtdCalc;
            ELSIF py_za_tx_utl_01082000.RetroInPrd THEN
               hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',46);
               SitCalc;
            ELSIF py_za_tx_utl_01082000.NegPtd THEN
               hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',47);
               SitCalc;
            ELSE
               hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',48);
               NorCalc;
            END IF;
         END IF;
      END IF;
...
--
   ELSIF dbi_TX_STA = 'H' THEN
      IF trc_OvrTxCalc THEN
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',49);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',50);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_H';
         END IF;
         RAISE xpt_E;
      ELSE
         hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',51);
         trc_LibFpNI := 0;
         trc_LibFpFB := 0;
         trc_LibFpTA := 0;
         trc_LibFpBP := 0;
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',52);
      hr_utility.set_message(801, 'ERROR: Invalid Tax Status');
      hr_utility.raise_error;
   END IF;

   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',53);

-- Post Calculation Steps
--
   py_za_tx_utl_01082000.SitPaySplit;

   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',54);

-- Execute the Arrear Processing
--
   IF py_za_tx_utl_01082000.SitePeriod THEN
      hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',55);
      py_za_tx_utl_01082000.ArrearExcess;
   END IF;

   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',56);

-- Calculate Net Taxable Income
--
   NetTxbIncCalc;

   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',57);
...
--
   ...
   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',58);
   ...
   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',59);
   ...
   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',60);

-- Execute The Tax Trace
--
   py_za_tx_utl_01082000.Trace;

   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',61);

-- Clear Globals
--
   py_za_tx_utl_01082000.ClearGlobals;

   hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',62);

-- End off Trace File
   WrtHrTrc('------------------------------------------------------------');
   WrtHrTrc('-- End of Trace File ');
   WrtHrTrc('------------------------------------------------------------');

-- Call hr_utility stop procedure
   py_za_tx_utl_01082000.StopHrTrace;
...
EXCEPTION
   WHEN xpt_E  THEN
      hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',63);
      ...
      hr_utility.raise_error;
   WHEN OTHERS THEN
      hr_utility.set_location('py_za_tx_01082000.ZaTx_01082000',64);
      WrtHrTrc('Sql error code: '||TO_CHAR(SQLCODE));
      WrtHrTrc('Sql error msg: '||SUBSTR(SQLERRM(SQLCODE), 1, 100));
      py_za_tx_utl_01082000.StopHrTrace;
      hr_utility.set_message(801, 'ZaTx_01082000: '||TO_CHAR(SQLCODE));
      py_za_tx_utl_01082000.ClearGlobals;
      hr_utility.raise_error;
END ZaTx_01082000;

END py_za_tx_01082000;
