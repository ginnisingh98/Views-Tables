--------------------------------------------------------
--  DDL for Package Body CSI_T_TXN_RLTNSHPS_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CSI_T_TXN_RLTNSHPS_GRP" as
/*$Header: csigtiib.pls 115.16 2004/01/08 23:54:02 rmamidip ship $*/

  g_pkg_name    CONSTANT VARCHAR2(30) := 'csi_t_txn_rltnshps_grp';
  g_file_name   CONSTANT VARCHAR2(12) := 'csigtiib.pls';
  ...
  IS
    ...
    l_api_name            CONSTANT VARCHAR2(30)  := 'create_txn_ii_rltns_dtls';
  ...
  BEGIN
    ...
    csi_t_gen_utility_pvt.add('API Being Executed     : Create Txn Relationships');
    ...
    ****/
    ...
    IF px_txn_ii_rltns_tbl.COUNT > 0 THEN
      ...
      LOOP
        ...
        l_txn_ii_rltns_rec := px_txn_ii_rltns_tbl(l_ind);
        ...
        px_txn_ii_rltns_tbl(l_ind) := l_txn_ii_rltns_rec;
    ...
    ****/
    ...
    csi_t_gen_utility_pvt.add('API Successfully Executed         : Create Txn Relationships');
  ...
  */
  ...
  BEGIN
    ...
    csi_t_gen_utility_pvt.add('API Being Executed     : Update Txn Relationships');
    csi_t_gen_utility_pvt.add('Transaction Start Time :'||to_char(sysdate, 'MM/DD/YY HH24:MI:SS'));
    ...
    ****/
    ...
    csi_t_txn_rltnshps_pvt.update_txn_ii_rltns_dtls (
      p_api_version      => p_api_version,
      p_commit           => p_commit,
      p_init_msg_list    => p_init_msg_list,
      p_validation_level => p_validation_level,
    ...
    ****/
    ...
    csi_t_gen_utility_pvt.add('API Successfully Executed         : Update Txn Relationships ');
    csi_t_gen_utility_pvt.add('Transaction End Time :'||to_char(sysdate, 'MM/DD/YY HH24:MI:SS'));
  ...
  */
  ...
  BEGIN
    ...
    -- Standard Start of API savepoint
    SAVEPOINT Delete_Inst_Reltship_Dtls;

    csi_t_gen_utility_pvt.add('API Being Executed     : Delete Txn Relationships');
    csi_t_gen_utility_pvt.add('Transaction Start Time :'||to_char(sysdate, 'MM/DD/YY HH24:MI:SS'));
    ...
    ****/
    ...
    csi_t_txn_rltnshps_pvt.delete_txn_ii_rltns_dtls(
      ...
      p_init_msg_list        => p_init_msg_list,
      p_validation_level     => p_validation_level,
      p_txn_ii_rltns_ids_tbl => p_txn_ii_rltns_ids_tbl,
      x_return_status        => l_return_status,
      x_msg_count            => l_msg_count,
      x_msg_data             => l_msg_data);
    ...
    ****/
    ...
    csi_t_gen_utility_pvt.add('API Successfully Executed         : Delete Txn Relationships');
    csi_t_gen_utility_pvt.add('Transaction End Time :'||to_char(sysdate, 'MM/DD/YY HH24:MI:SS'));
  ...
  EXCEPTION
    WHEN FND_API.G_EXC_ERROR THEN
      ...
      ROLLBACK TO Delete_Inst_Reltship_Dtls;
      x_return_status := FND_API.G_RET_STS_ERROR ;
      FND_MSG_PUB.Count_And_Get (
        p_count  => x_msg_count,
        p_data   => x_msg_data);
