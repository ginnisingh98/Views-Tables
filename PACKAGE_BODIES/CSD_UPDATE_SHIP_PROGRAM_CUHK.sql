--------------------------------------------------------
--  DDL for Package Body CSD_UPDATE_SHIP_PROGRAM_CUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CSD_UPDATE_SHIP_PROGRAM_CUHK" as
/* $Header: csdcshpb.pls 120.0.12010000.3 2010/04/19 18:32:09 nnadig noship $ */
--
...
--													for shipped item id.
--					   p_flag		  if the value return is = 0, the main program
