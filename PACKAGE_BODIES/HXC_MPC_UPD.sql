--------------------------------------------------------
--  DDL for Package Body HXC_MPC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_MPC_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_mpc_upd.';  -- Global package name
...
Begin
  ...
  --
  -- Update the hxc_mapping_components Row
  --
  update hxc_mapping_components
    set
...
Begin
  ...
  --
  convert_defs(p_rec);
  hxc_mpc_bus.update_validate
     (p_rec
     );
  --
  -- Call the supporting pre-update operation
  --
  hxc_mpc_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hxc_mpc_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hxc_mpc_upd.post_update
     (p_rec
     );
End upd;
--
...
Procedure upd
  ...
  ,p_bld_blk_info_type_id         in     number    default hr_api.g_varchar2
