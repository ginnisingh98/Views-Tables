--------------------------------------------------------
--  DDL for Package Body GL_RGXRPTD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GL_RGXRPTD_XMLP_PKG" AS
/* $Header: RGXRPTDB.pls 120.0 2007/12/27 15:38:44 vijranga noship $ */
...
function c_segment_overirdeformula(segment_override in varchar2) return char is
begin
