--------------------------------------------------------
--  DDL for Package Body BEN_PPR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PPR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_ppr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_prmry_care_prvdr_f.created_by%TYPE;
  l_creation_date       ben_prmry_care_prvdr_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_prmry_care_prvdr_f
  --
...
Begin
  ...
  open c1;
  fetch c1 into p_rec.prmry_care_prvdr_id;
  close c1;
...
Begin
  ...
  --
  p_prmry_care_prvdr_id         := l_rec.prmry_care_prvdr_id;
