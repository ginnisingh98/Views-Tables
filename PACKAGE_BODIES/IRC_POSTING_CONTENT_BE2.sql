--------------------------------------------------------
--  DDL for Package Body IRC_POSTING_CONTENT_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_POSTING_CONTENT_BE2" as 
...
p_date_approved                date) is
  ...
  --
  l_proc varchar2(72):='  irc_posting_content_be2.update_posting_content_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.posting_content.update_posting_content';
