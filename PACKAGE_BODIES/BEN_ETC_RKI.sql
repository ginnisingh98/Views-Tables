--------------------------------------------------------
--  DDL for Package Body BEN_ETC_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ETC_RKI" as
...
begin
hr_utility.set_location('Entering: BEN_ETC_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: BEN_ETC_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end BEN_ETC_RKI;
