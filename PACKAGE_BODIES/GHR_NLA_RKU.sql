--------------------------------------------------------
--  DDL for Package Body GHR_NLA_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_NLA_RKU" as
...
begin
hr_utility.set_location('Entering: ghr_nla_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ghr_nla_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ghr_nla_RKU;
