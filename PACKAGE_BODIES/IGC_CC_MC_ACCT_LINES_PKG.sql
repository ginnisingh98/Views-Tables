--------------------------------------------------------
--  DDL for Package Body IGC_CC_MC_ACCT_LINES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGC_CC_MC_ACCT_LINES_PKG" as
/* $Header: IGCCMCAB.pls 120.3.12000000.1 2007/08/20 12:12:50 mbremkum ship $*/

 G_PKG_NAME CONSTANT VARCHAR2(30):= 'IGC_CC_MC_ACCT_LINES_PKG';
...
PROCEDURE Insert_Row(
 ...
 IS
  ...
  CURSOR C IS SELECT Rowid FROM IGC_CC_MC_ACCT_LINES
 ...
 BEGIN
    ...
    X_return_status := FND_API.G_RET_STS_SUCCESS ;
     ...
     INSERT INTO IGC_CC_MC_ACCT_LINES (
               CC_Acct_Line_Id,
               Set_Of_Books_Id,
               CC_Acct_Func_Amt,
...
DELETE FROM IGC_CC_MC_ACCT_LINES
WHERE rowid = p_Rowid;
