--------------------------------------------------------
--  DDL for Package Body BEN_LEE_RSN_RL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LEE_RSN_RL_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_LEE_RSN_RL_BK1.CREATE_LEE_RSN_RL_A', 10);
hr_utility.set_location(' Leaving: BEN_LEE_RSN_RL_BK1.CREATE_LEE_RSN_RL_A', 20);
end CREATE_LEE_RSN_RL_A;
...
begin
hr_utility.set_location('Entering: BEN_LEE_RSN_RL_BK1.CREATE_LEE_RSN_RL_B', 10);
hr_utility.set_location(' Leaving: BEN_LEE_RSN_RL_BK1.CREATE_LEE_RSN_RL_B', 20);
end CREATE_LEE_RSN_RL_B;
