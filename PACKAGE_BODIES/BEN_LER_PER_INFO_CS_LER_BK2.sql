--------------------------------------------------------
--  DDL for Package Body BEN_LER_PER_INFO_CS_LER_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LER_PER_INFO_CS_LER_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_LER_PER_INFO_CS_LER_BK2.UPDATE_LER_PER_INFO_CS_LER_A', 10);
hr_utility.set_location(' Leaving: BEN_LER_PER_INFO_CS_LER_BK2.UPDATE_LER_PER_INFO_CS_LER_A', 20);
end UPDATE_LER_PER_INFO_CS_LER_A;
...
begin
hr_utility.set_location('Entering: BEN_LER_PER_INFO_CS_LER_BK2.UPDATE_LER_PER_INFO_CS_LER_B', 10);
hr_utility.set_location(' Leaving: BEN_LER_PER_INFO_CS_LER_BK2.UPDATE_LER_PER_INFO_CS_LER_B', 20);
end UPDATE_LER_PER_INFO_CS_LER_B;
