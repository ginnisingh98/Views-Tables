--------------------------------------------------------
--  DDL for Package Body HXC_DRU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_DRU_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_dru_ins.';  -- Global package name
...
Begin
  ...
  --
  -- Insert the row into: hxc_data_app_rule_usages
  --
  insert into hxc_data_app_rule_usages
...
--
  l_proc  varchar2(72);
--
  Cursor C_Sel1 is select hxc_data_app_rule_usages_s.nextval from sys.dual;
--
Begin
  if g_debug then
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.data_app_rule_usage_id;
  Close C_Sel1;
  --
  if g_debug then
	hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  hxc_dru_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  hxc_dru_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hxc_dru_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Procedure ins
  ...
  ,p_data_app_rule_usage_id            out nocopy number
...
Begin
  ...
  --
  -- Having converted the arguments into the hxc_dru_rec
  ...
  --
  p_data_app_rule_usage_id := l_rec.data_app_rule_usage_id;
