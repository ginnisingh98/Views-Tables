--------------------------------------------------------
--  DDL for Package Body BEN_PAP_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PAP_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pap_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_prtt_anthr_pl_rt_f.created_by%TYPE;
  l_creation_date       ben_prtt_anthr_pl_rt_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_prtt_anthr_pl_rt_f
  --
...
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.prtt_anthr_pl_rt_id;
  close c1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  p_prtt_anthr_pl_rt_id        	:= l_rec.prtt_anthr_pl_rt_id;
