--------------------------------------------------------
--  DDL for Package Body PER_ASP_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ASP_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_asp_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure insert_dml(p_rec in out nocopy per_asp_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Insert the row into: per_sec_profile_assignments
  --
  insert into per_sec_profile_assignments
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_insert(p_rec  in out nocopy per_asp_shd.g_rec_type) is
--
  l_proc  varchar2(72) := g_package||'pre_insert';
--
  Cursor C_Sel1 is select per_sec_profile_assignments_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.sec_profile_assignment_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure post_insert(p_rec in per_asp_shd.g_rec_type) is
--
...
Begin
  ...
  --
  per_asp_bus.insert_validate(p_rec);
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the per_asp_rec
  ...
  --
  p_sec_profile_assignment_id := l_rec.sec_profile_assignment_id;
