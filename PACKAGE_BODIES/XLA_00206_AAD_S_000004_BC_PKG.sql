--------------------------------------------------------
--  DDL for Package Body XLA_00206_AAD_S_000004_BC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."XLA_00206_AAD_S_000004_BC_PKG" AS
--
/*======================================================================+
...
| HISTORY                                                               |
|     Generated at 29-08-2013 at 11:08:21 by user ANONYMOUS             |
+=======================================================================*/
--
--
...
C_DEFAULT_MODULE      CONSTANT VARCHAR2(240) := 'xla.plsql.XLA_00206_AAD_S_000004_BC_PKG';
...
EXCEPTION
       ...
       WHEN OTHERS THEN
          xla_exceptions_pkg.raise_message
             (p_location   => 'XLA_00206_AAD_S_000004_BC_PKG.trace');
END trace;
...
WHEN OTHERS  THEN
   xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.ValidateLookupMeaning');
       --
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.GetMeaning');
END GetMeaning;
--
...
EXCEPTION
 ...
 WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.Description_1');
END Description_1;
...
EXCEPTION
 ...
 WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.Description_2');
END Description_2;
...
l_component_code         := 'PROGRAM_ACCOUNT_BSV';
l_component_type_code    := 'S';
l_component_appl_id      :=  206;
l_amb_context_code       := 'DEFAULT';
...
--
  ...
  x_value_type_code       := 'S';
  l_output_value          := TO_CHAR(p_source_5);
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctDerRule_3');
END AcctDerRule_3;
--
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctDerRule_4');
END AcctDerRule_4;
--
...
l_component_type         := 'AMB_ADR';
l_component_code         := 'USGL_ACCOUNT_461001';
l_component_type_code    := 'S';
l_component_appl_id      :=  206;
l_amb_context_code       := 'DEFAULT';
x_transaction_coa_id     :=  null;
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctDerRule_5');
END AcctDerRule_5;
--
...
l_component_type         := 'AMB_ADR';
l_component_code         := 'USGL_ACCOUNT_480102';
l_component_type_code    := 'S';
l_component_appl_id      :=  206;
l_amb_context_code       := 'DEFAULT';
x_transaction_coa_id     :=  null;
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctDerRule_6');
END AcctDerRule_6;
--
...
l_component_code             := 'USSGL_TC_A150_PROG_ACT_4610';
l_component_type_code        := 'S';
l_component_appl_id          :=  206;
l_amb_context_code           := 'DEFAULT';
l_entity_code                := 'LOANS';
l_event_class_code           := 'DIRECT';
l_event_type_code            := 'DIRECT_LOAN_APPROVED';
l_line_definition_owner_code := 'S';
l_line_definition_code       := 'FED_LNS_APPROVAL';
--
...
') =  'DR' AND 
((NVL(p_source_9,'
') =  'DIRECT_LOAN_APPROVED') OR 
(NVL(p_source_9,'
') =  'DISBURSEMENT_FUNDED' AND 
NVL(p_source_10,9E125) =  1 AND 
NVL(p_source_11,'
') =  'N')
) THEN 
   ...
   xla_ae_lines_pkg.SetAcctClass(
           p_accounting_class_code  => 'PROG_ACT'
   ...
   l_rec_acct_attrs.array_num_value(3)  := p_source_14;
   l_rec_acct_attrs.array_acct_attr_code(4) := 'ENTERED_CURRENCY_CODE';
   l_rec_acct_attrs.array_char_value(4)  := p_source_15;
   l_rec_acct_attrs.array_acct_attr_code(5) := 'EXCHANGE_DATE';
   l_rec_acct_attrs.array_date_value(5)  := p_source_16;
   l_rec_acct_attrs.array_acct_attr_code(6) := 'EXCHANGE_RATE';
   l_rec_acct_attrs.array_num_value(6)  := p_source_17;
   l_rec_acct_attrs.array_acct_attr_code(7) := 'EXCHANGE_RATE_TYPE';
   l_rec_acct_attrs.array_char_value(7)  := p_source_18;
...
, p_source_5 => p_source_5
   ...
   IF NVL(l_segment,'NULL') <> '#$NO_OVERRIDE#$' THEN  -- 4465612
      ...
      xla_ae_lines_pkg.set_segment(
        ...
        , p_adr_code                => 'PROGRAM_ACCOUNT_BSV'
        , p_adr_type_code           => 'S'
        , p_component_type          => l_component_type
        , p_component_code          => l_component_code
        , p_component_type_code     => l_component_type_code
  ...
  END IF;
   ...
   IF NVL(l_segment,'NULL') <> '#$NO_OVERRIDE#$' THEN  -- 4465612
      ...
      xla_ae_lines_pkg.set_segment(
        ...
        , p_flexfield_segment_code  => l_adr_flexfield_segment_code
        , p_flex_value_set_id       => l_adr_flex_value_set_id
        , p_adr_code                => 'USGL_ACCOUNT_461001'
        , p_adr_type_code           => 'S'
        , p_component_type          => l_component_type
        , p_component_code          => l_component_code
        , p_component_type_code     => l_component_type_code
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctLineType_7');
END AcctLineType_7;
--
...
--
l_component_type             := 'AMB_JLT';
l_component_code             := 'USSGL_TC_A150_PROG_ACT_4610_C';
l_component_type_code        := 'S';
l_component_appl_id          :=  206;
l_amb_context_code           := 'DEFAULT';
l_entity_code                := 'LOANS';
l_event_class_code           := 'DIRECT';
l_event_type_code            := 'FUTURE_DISBURSEMENT_CANCELLED';
l_line_definition_owner_code := 'S';
l_line_definition_code       := 'FED_LNS_CANCEL';
--
l_balance_type_code          := 'A';
l_segment                     := NULL;
l_ccid                        := NULL;
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctLineType_8');
END AcctLineType_8;
--
...
--
l_component_type             := 'AMB_JLT';
l_component_code             := 'USSGL_TC_A150_PROG_ACT_4801';
l_component_type_code        := 'S';
l_component_appl_id          :=  206;
l_amb_context_code           := 'DEFAULT';
l_entity_code                := 'LOANS';
  ...
  END IF;
   ...
   IF NVL(l_segment,'NULL') <> '#$NO_OVERRIDE#$' THEN  -- 4465612
      ...
      xla_ae_lines_pkg.set_segment(
        ...
        , p_flexfield_segment_code  => l_adr_flexfield_segment_code
        , p_flex_value_set_id       => l_adr_flex_value_set_id
        , p_adr_code                => 'USGL_ACCOUNT_480102'
        , p_adr_type_code           => 'S'
        , p_component_type          => l_component_type
        , p_component_code          => l_component_code
        , p_component_type_code     => l_component_type_code
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctLineType_9');
END AcctLineType_9;
--
...
--
l_component_type             := 'AMB_JLT';
l_component_code             := 'USSGL_TC_A150_PROG_ACT_4801_C';
l_component_type_code        := 'S';
l_component_appl_id          :=  206;
l_amb_context_code           := 'DEFAULT';
l_entity_code                := 'LOANS';
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctLineType_10');
END AcctLineType_10;
--
...
--
l_component_type             := 'AMB_JLT';
l_component_code             := 'USSGL_TC_B204_FIN_ACCT_4610';
l_component_type_code        := 'S';
l_component_appl_id          :=  206;
l_amb_context_code           := 'DEFAULT';
l_entity_code                := 'LOANS';
...
') =  'N')
   ...
   --
   xla_ae_lines_pkg.SetAcctClass(
           p_accounting_class_code  => 'FIN_ACT'
         , p_ae_header_id           => l_ae_header_id
         );
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctLineType_11');
END AcctLineType_11;
--
...
--
l_component_type             := 'AMB_JLT';
l_component_code             := 'USSGL_TC_B204_FIN_ACCT_4610_C';
l_component_type_code        := 'S';
l_component_appl_id          :=  206;
l_amb_context_code           := 'DEFAULT';
l_entity_code                := 'LOANS';
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctLineType_12');
END AcctLineType_12;
--
...
--
l_component_type             := 'AMB_JLT';
l_component_code             := 'USSGL_TC_B204_FIN_ACCT_4801';
l_component_type_code        := 'S';
l_component_appl_id          :=  206;
l_amb_context_code           := 'DEFAULT';
l_entity_code                := 'LOANS';
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctLineType_13');
END AcctLineType_13;
--
...
--
l_component_type             := 'AMB_JLT';
l_component_code             := 'USSGL_TC_B204_FIN_ACCT_4801_C';
l_component_type_code        := 'S';
l_component_appl_id          :=  206;
l_amb_context_code           := 'DEFAULT';
l_entity_code                := 'LOANS';
...
EXCEPTION
  ...
  WHEN OTHERS THEN
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.AcctLineType_14');
END AcctLineType_14;
--
...
SELECT
  ...
  FROM (
       SELECT xet.event_id                  event_id
            ...
            , CASE r
                ...
                WHEN 4 THEN 'FUNDS_RESERVED_FLAG' 
            ...
            , CASE r
                ...
                WHEN 4 THEN TO_CHAR(h2.FUNDS_RESERVED_FLAG)
  ...
  AND fvl1.language(+)            = USERENV('LANG')
     AND fvl15.lookup_type(+)         = 'CURRENCY_CODE'
  AND fvl15.lookup_code(+)         = h2.LOAN_CURRENCY
  AND fvl15.view_application_id(+) = 101
...
SELECT  event_id
       ...
       SELECT xet.event_id                  event_id
            ...
            , CASE r
               WHEN 1 THEN 'LNS_LOAN_DETAILS_EXT_V' 
                ...
                WHEN 10 THEN 'LNS_LOAN_DETAILS_EXT_V' 
            ...
            , CASE r
                ...
                WHEN 2 THEN 'DERIVED_PROGRAM_ACCOUNT_BSV' 
                WHEN 3 THEN 'CODE_COMBINATION_ID' 
                WHEN 4 THEN 'LINE_TYPE' 
                WHEN 5 THEN 'ACCOUNT_TYPE' 
                WHEN 6 THEN 'EVENT_TYPE' 
                WHEN 7 THEN 'DISBURSEMENT_NUMBER' 
                WHEN 8 THEN 'DISTRIBUTION_ID' 
                WHEN 9 THEN 'DISTRIBUTION_TYPE' 
                WHEN 10 THEN 'DISTRIBUTION_AMOUNT' 
                
                ELSE null
              END                           source_code
            , CASE r
                WHEN 1 THEN TO_CHAR(l1.ACCOUNT_NAME)
                WHEN 2 THEN TO_CHAR(l1.DERIVED_PROGRAM_ACCOUNT_BSV)
                WHEN 3 THEN TO_CHAR(l1.CODE_COMBINATION_ID)
                WHEN 4 THEN TO_CHAR(l1.LINE_TYPE)
                WHEN 5 THEN TO_CHAR(l1.ACCOUNT_TYPE)
                WHEN 6 THEN TO_CHAR(l1.EVENT_TYPE)
                WHEN 7 THEN TO_CHAR(l1.DISBURSEMENT_NUMBER)
                WHEN 8 THEN TO_CHAR(l1.DISTRIBUTION_ID)
                WHEN 9 THEN TO_CHAR(l1.DISTRIBUTION_TYPE)
                WHEN 10 THEN TO_CHAR(l1.DISTRIBUTION_AMOUNT)
  ...
  AND fvl4.language(+)            = USERENV('LANG')
     AND fvl8.lookup_type(+)         = 'LOAN_DISTRIBUTION_ACCOUNT_DRCR'
  AND fvl8.lookup_code(+)         = l1.ACCOUNT_TYPE
  AND fvl8.view_application_id(+) = 206
  AND fvl8.language(+)            = USERENV('LANG')
     AND fvl9.lookup_type(+)         = 'LOAN_ACCOUNTING_EVENT'
  AND fvl9.lookup_code(+)         = l1.EVENT_TYPE
  AND fvl9.view_application_id(+) = 206
  AND fvl9.language(+)            = USERENV('LANG')
     AND fvl13.lookup_type(+)         = 'LOAN_DISTRIBUTION_ACCOUNT_DRCR'
  AND fvl13.lookup_code(+)         = l1.DISTRIBUTION_TYPE
  AND fvl13.view_application_id(+) = 206
...
EXCEPTION
  ...
  WHEN OTHERS THEN
      IF (C_LEVEL_EXCEPTION >= g_log_level) THEN
       ...
       END IF;
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.insert_sources_15');
...
TYPE t_array_source_11 IS TABLE OF LNS_LOAN_HEADERS_EXT_V.FUNDS_RESERVED_FLAG%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_15 IS TABLE OF LNS_LOAN_HEADERS_EXT_V.LOAN_CURRENCY%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_16 IS TABLE OF LNS_LOAN_HEADERS_EXT_V.EXCHANGE_DATE%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_17 IS TABLE OF LNS_LOAN_HEADERS_EXT_V.EXCHANGE_RATE%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_18 IS TABLE OF LNS_LOAN_HEADERS_EXT_V.EXCHANGE_RATE_TYPE%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_20 IS TABLE OF LNS_LOAN_HEADERS_EXT_V.GL_DATE%TYPE INDEX BY BINARY_INTEGER;

TYPE t_array_source_4 IS TABLE OF LNS_LOAN_DETAILS_EXT_V.ACCOUNT_NAME%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_5 IS TABLE OF LNS_LOAN_DETAILS_EXT_V.DERIVED_PROGRAM_ACCOUNT_BSV%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_6 IS TABLE OF LNS_LOAN_DETAILS_EXT_V.CODE_COMBINATION_ID%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_7 IS TABLE OF LNS_LOAN_DETAILS_EXT_V.LINE_TYPE%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_8 IS TABLE OF LNS_LOAN_DETAILS_EXT_V.ACCOUNT_TYPE%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_9 IS TABLE OF LNS_LOAN_DETAILS_EXT_V.EVENT_TYPE%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_10 IS TABLE OF LNS_LOAN_DETAILS_EXT_V.DISBURSEMENT_NUMBER%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_12 IS TABLE OF LNS_LOAN_DETAILS_EXT_V.DISTRIBUTION_ID%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_13 IS TABLE OF LNS_LOAN_DETAILS_EXT_V.DISTRIBUTION_TYPE%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_14 IS TABLE OF LNS_LOAN_DETAILS_EXT_V.DISTRIBUTION_AMOUNT%TYPE INDEX BY BINARY_INTEGER;
...
-- Event Class Code: DIRECT
  ...
  , h2.FUNDS_RESERVED_FLAG    source_11
  , h2.LOAN_CURRENCY    source_15
  , fvl15.meaning   source_15_meaning
  , h2.EXCHANGE_DATE    source_16
  , h2.EXCHANGE_RATE    source_17
  , h2.EXCHANGE_RATE_TYPE    source_18
  , h2.GL_DATE    source_20
  FROM xla_events_gt     xet 
  , LNS_LOAN_HEADERS_EXT_V  h2
  , fnd_lookup_values    fvl1
  , fnd_lookup_values    fvl15
...
-- Event Class Code: DIRECT
  ...
  , l1.DERIVED_PROGRAM_ACCOUNT_BSV    source_5
  , l1.CODE_COMBINATION_ID    source_6
  , l1.LINE_TYPE    source_7
  , l1.ACCOUNT_TYPE    source_8
  , fvl8.meaning   source_8_meaning
  , l1.EVENT_TYPE    source_9
  , fvl9.meaning   source_9_meaning
  , l1.DISBURSEMENT_NUMBER    source_10
  , l1.DISTRIBUTION_ID    source_12
  , l1.DISTRIBUTION_TYPE    source_13
  , fvl13.meaning   source_13_meaning
  , l1.DISTRIBUTION_AMOUNT    source_14
  FROM xla_events_gt     xet 
  , LNS_LOAN_DETAILS_EXT_V  l1
  , fnd_lookup_values    fvl4
  , fnd_lookup_values    fvl8
...
BEGIN
IF g_log_enabled THEN
   l_log_module := C_DEFAULT_MODULE||'.EventType_15';
END IF;
IF (C_LEVEL_PROCEDURE >= g_log_level) THEN
   trace
      (p_msg      => 'BEGIN of EventType_15'
      ,p_level    => C_LEVEL_PROCEDURE
      ,p_module   => l_log_module);
END IF;
...
g_array_event(l_event_id).array_value_char('source_11') := l_array_source_11(hdr_idx);
g_array_event(l_event_id).array_value_char('source_15') := l_array_source_15(hdr_idx);
g_array_event(l_event_id).array_value_char('source_15_meaning') := l_array_source_15_meaning(hdr_idx);
...
g_array_event(l_event_id).array_value_date('source_20') := l_array_source_20(hdr_idx);
...
l_acc_rev_gl_date_source := NULL;
     ...
     l_rec_acct_attrs.array_acct_attr_code(1)   := 'GL_DATE';
      l_rec_acct_attrs.array_date_value(1) := g_array_event(l_event_id).array_value_date('source_20');
...
AcctLineType_7 (
 ...
 , p_source_11 => g_array_event(l_event_id).array_value_char('source_11')
 , p_source_12 => l_array_source_12(Idx)
 , p_source_13 => l_array_source_13(Idx)
 , p_source_13_meaning => l_array_source_13_meaning(Idx)
 , p_source_14 => l_array_source_14(Idx)
 , p_source_15 => g_array_event(l_event_id).array_value_char('source_15')
 , p_source_15_meaning => g_array_event(l_event_id).array_value_char('source_15_meaning')
 , p_source_16 => g_array_event(l_event_id).array_value_date('source_16')
...
xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.EventType_15');
  ...
  FROM (
       SELECT xet.event_id                  event_id
            ...
            , CASE r
                ...
                WHEN 2 THEN 'LOAN_TYPE' 
                WHEN 3 THEN 'LOAN_NUMBER' 
                WHEN 4 THEN 'LOAN_CURRENCY' 
                WHEN 5 THEN 'EXCHANGE_DATE' 
                WHEN 6 THEN 'EXCHANGE_RATE' 
                WHEN 7 THEN 'EXCHANGE_RATE_TYPE' 
                WHEN 8 THEN 'SUBSIDY_COST' 
                WHEN 9 THEN 'GL_DATE' 
            ...
            , CASE r
                ...
                WHEN 2 THEN TO_CHAR(h2.LOAN_TYPE)
                WHEN 3 THEN TO_CHAR(h2.LOAN_NUMBER)
                WHEN 4 THEN TO_CHAR(h2.LOAN_CURRENCY)
                WHEN 5 THEN TO_CHAR(h2.EXCHANGE_DATE)
                WHEN 6 THEN TO_CHAR(h2.EXCHANGE_RATE)
                WHEN 7 THEN TO_CHAR(h2.EXCHANGE_RATE_TYPE)
                WHEN 8 THEN TO_CHAR(h2.SUBSIDY_COST)
                WHEN 9 THEN TO_CHAR(h2.GL_DATE)
...
EXCEPTION
  ...
  WHEN OTHERS THEN
      IF (C_LEVEL_EXCEPTION >= g_log_level) THEN
       ...
       END IF;
       xla_exceptions_pkg.raise_message
           (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.insert_sources_16');
...
TYPE t_array_source_17 IS TABLE OF LNS_LOAN_HEADERS_EXT_V.EXCHANGE_RATE%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_18 IS TABLE OF LNS_LOAN_HEADERS_EXT_V.EXCHANGE_RATE_TYPE%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_19 IS TABLE OF LNS_LOAN_HEADERS_EXT_V.SUBSIDY_COST%TYPE INDEX BY BINARY_INTEGER;
TYPE t_array_source_20 IS TABLE OF LNS_LOAN_HEADERS_EXT_V.GL_DATE%TYPE INDEX BY BINARY_INTEGER;
...
BEGIN
IF g_log_enabled THEN
   l_log_module := C_DEFAULT_MODULE||'.EventType_16';
END IF;
IF (C_LEVEL_PROCEDURE >= g_log_level) THEN
   trace
      (p_msg      => 'BEGIN of EventType_16'
      ,p_level    => C_LEVEL_PROCEDURE
      ,p_module   => l_log_module);
END IF;
...
xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.EventType_16');
...
WHEN OTHERS THEN
   xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.CreateHeadersAndLines');
...
WHEN OTHERS THEN
   ...
   END IF;
   xla_exceptions_pkg.raise_message
      (p_location => 'XLA_00206_AAD_S_000004_BC_PKG.CreateJournalEntries');
...
BEGIN
   ...
   END IF;
--
END XLA_00206_AAD_S_000004_BC_PKG;
--
