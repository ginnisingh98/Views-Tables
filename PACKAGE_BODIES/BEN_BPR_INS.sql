--------------------------------------------------------
--  DDL for Package Body BEN_BPR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BPR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_bpr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_bnft_pool_rlovr_rqmt_f.created_by%TYPE;
  l_creation_date       ben_bnft_pool_rlovr_rqmt_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_bnft_pool_rlovr_rqmt_f
  --
...
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.bnft_pool_rlovr_rqmt_id;
  close c1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  p_bnft_pool_rlovr_rqmt_id        	:= l_rec.bnft_pool_rlovr_rqmt_id;
