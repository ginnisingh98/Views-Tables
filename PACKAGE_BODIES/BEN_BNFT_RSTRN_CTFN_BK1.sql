--------------------------------------------------------
--  DDL for Package Body BEN_BNFT_RSTRN_CTFN_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BNFT_RSTRN_CTFN_BK1" as
/* $Header: bebrcapi.pkb 120.0 2005/05/28 00:49:50 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_BNFT_RSTRN_CTFN_BK1.CREATE_BNFT_RSTRN_CTFN_A', 10);
hr_utility.set_location(' Leaving: BEN_BNFT_RSTRN_CTFN_BK1.CREATE_BNFT_RSTRN_CTFN_A', 20);
end CREATE_BNFT_RSTRN_CTFN_A;
...
begin
hr_utility.set_location('Entering: BEN_BNFT_RSTRN_CTFN_BK1.CREATE_BNFT_RSTRN_CTFN_B', 10);
hr_utility.set_location(' Leaving: BEN_BNFT_RSTRN_CTFN_BK1.CREATE_BNFT_RSTRN_CTFN_B', 20);
end CREATE_BNFT_RSTRN_CTFN_B;
