--------------------------------------------------------
--  DDL for Package Body AME_APG_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_APG_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_apg_ins.';  -- Global package name
--
...
Begin
  ...
  --
  ame_apg_ins.g_approval_group_id_i := p_approval_group_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: ame_approval_groups
  --
...
--
  Cursor C_Sel1 is select ame_approval_groups_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from ame_approval_groups
     where approval_group_id =
             ame_apg_ins.g_approval_group_id_i
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (ame_apg_ins.g_approval_group_id_i is not null) Then
    --
    ...
    p_rec.approval_group_id :=
      ame_apg_ins.g_approval_group_id_i;
    ame_apg_ins.g_approval_group_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.approval_group_id;
    Close C_Sel1;
  End If;
  --
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the ame_apg_rec
  ...
  --
  p_approval_group_id := l_rec.approval_group_id;
