--------------------------------------------------------
--  DDL for Package Body IRC_APL_PRFL_SNAPSHOTS_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_APL_PRFL_SNAPSHOTS_BE1" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  irc_apl_prfl_snapshots_be1.create_applicant_snapshot_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.apl_prfl_snapshots.create_applicant_snapshot';
...
end create_applicant_snapshot_a;
