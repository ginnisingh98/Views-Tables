--------------------------------------------------------
--  DDL for Package Body BEN_PRTL_MO_RT_PRTN_VAL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PRTL_MO_RT_PRTN_VAL_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PRTL_MO_RT_PRTN_VAL_BK1.CREATE_PRTL_MO_RT_PRTN_VAL_A', 10);
hr_utility.set_location(' Leaving: BEN_PRTL_MO_RT_PRTN_VAL_BK1.CREATE_PRTL_MO_RT_PRTN_VAL_A', 20);
end CREATE_PRTL_MO_RT_PRTN_VAL_A;
...
begin
hr_utility.set_location('Entering: BEN_PRTL_MO_RT_PRTN_VAL_BK1.CREATE_PRTL_MO_RT_PRTN_VAL_B', 10);
hr_utility.set_location(' Leaving: BEN_PRTL_MO_RT_PRTN_VAL_BK1.CREATE_PRTL_MO_RT_PRTN_VAL_B', 20);
end CREATE_PRTL_MO_RT_PRTN_VAL_B;
