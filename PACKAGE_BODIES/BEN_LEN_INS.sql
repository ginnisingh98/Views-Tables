--------------------------------------------------------
--  DDL for Package Body BEN_LEN_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LEN_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_len_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.lee_rsn_id       = p_rec.lee_rsn_id
    and    t.effective_start_date =
             ben_len_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_lee_rsn_f.created_by%TYPE;
  l_creation_date       ben_lee_rsn_f.creation_date%TYPE;
  l_last_update_date   	ben_lee_rsn_f.last_update_date%TYPE;
  l_last_updated_by     ben_lee_rsn_f.last_updated_by%TYPE;
  l_last_update_login   ben_lee_rsn_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_lee_rsn_f
  --
  insert into ben_lee_rsn_f
  (	lee_rsn_id,
  ...
  (	p_rec.lee_rsn_id,
	...
	p_rec.ENRT_PERD_STRT_DAYS ,
	p_rec.ENRT_PERD_END_DAYS ,
...
--
  Cursor C_Sel1 is select ben_lee_rsn_f_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.lee_rsn_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  dt_api.validate_dt_mode
	(p_effective_date	   => p_effective_date,
	 ...
	 p_parent_key_value1       => p_rec.popl_enrt_typ_cycl_id,
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_len_rec
