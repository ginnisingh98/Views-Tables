--------------------------------------------------------
--  DDL for Package Body OTA_COI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_COI_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_coi_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the ota_chat_obj_inclusions Row
  --
  update ota_chat_obj_inclusions
    set
...
Begin
  ...
  --
  ota_coi_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_coi_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_coi_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
