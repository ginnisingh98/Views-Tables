--------------------------------------------------------
--  DDL for Package Body AS_PROD_WORKSHEET_LINES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AS_PROD_WORKSHEET_LINES_PKG" as
/* $Header: asxtpwlb.pls 115.8 2004/01/13 10:08:50 gbatra ship $ */
-- Start of Comments
-- Package name     : AS_PROD_WORKSHEET_LINES_PKG
-- Purpose          :
-- History          :
-- NOTE             :
-- End of Comments
...
G_PKG_NAME CONSTANT VARCHAR2(30):= 'AS_PROD_WORKSHEET_LINES_PKG';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'asxtpwlb.pls';

PROCEDURE Insert_Row(
          px_PROD_WORKSHEET_LINE_ID   IN OUT NOCOPY NUMBER,
          ...
          p_GROUP_FORECAST_AMOUNT    NUMBER,
          ...
          p_GROUP_FORECAST_AMOUNT_FLAG    VARCHAR2,
 ...
 IS
   CURSOR C2 IS SELECT AS_PROD_WORKSHEET_LINES_S.nextval FROM sys.dual;
BEGIN
   If (px_PROD_WORKSHEET_LINE_ID IS NULL) OR (px_PROD_WORKSHEET_LINE_ID = FND_API.G_MISS_NUM) then
       OPEN C2;
       FETCH C2 INTO px_PROD_WORKSHEET_LINE_ID;
       CLOSE C2;
   End If;
   INSERT INTO AS_PROD_WORKSHEET_LINES(
           PROD_WORKSHEET_LINE_ID,
           ...
           px_PROD_WORKSHEET_LINE_ID,
           decode( p_FORECAST_WORKSHEET_ID, FND_API.G_MISS_NUM, NULL, p_FORECAST_WORKSHEET_ID),
           ...
           decode( p_SALES_QUOTA_ID, FND_API.G_MISS_NUM, NULL, p_SALES_QUOTA_ID),
           ...
           decode( p_GROUP_FORECAST_AMOUNT, FND_API.G_MISS_NUM, NULL, p_GROUP_FORECAST_AMOUNT),
           ...
           decode( p_GROUP_FORECAST_AMOUNT_FLAG, FND_API.G_MISS_CHAR, NULL, p_GROUP_FORECAST_AMOUNT_FLAG),
           ...
           decode( p_FST_SALES_CATEGORY_ID, FND_API.G_MISS_NUM, NULL, p_FST_SALES_CATEGORY_ID),
...
PROCEDURE Update_Row(
          p_PROD_WORKSHEET_LINE_ID    NUMBER,
          p_FORECAST_WORKSHEET_ID    NUMBER,
          p_CREATED_BY    NUMBER,
          p_CREATION_DATE    DATE,
          p_LAST_UPDATED_BY    NUMBER,
 ...
 BEGIN
    ...
    SET object_version_number =  nvl(object_version_number,0) + 1,
              FORECAST_WORKSHEET_ID = decode( p_FORECAST_WORKSHEET_ID, FND_API.G_MISS_NUM, FORECAST_WORKSHEET_ID, p_FORECAST_WORKSHEET_ID),
              ...
              SALES_QUOTA_ID = decode( p_SALES_QUOTA_ID, FND_API.G_MISS_NUM, SALES_QUOTA_ID, p_SALES_QUOTA_ID),
              ...
              GROUP_FORECAST_AMOUNT = decode( p_GROUP_FORECAST_AMOUNT, FND_API.G_MISS_NUM, GROUP_FORECAST_AMOUNT, p_GROUP_FORECAST_AMOUNT),
              ...
              GROUP_FORECAST_AMOUNT_FLAG = decode( p_GROUP_FORECAST_AMOUNT_FLAG, FND_API.G_MISS_CHAR, GROUP_FORECAST_AMOUNT_FLAG, p_GROUP_FORECAST_AMOUNT_FLAG),
              ...
              FST_SALES_CATEGORY_ID = decode( p_FST_SALES_CATEGORY_ID, FND_API.G_MISS_NUM, FST_SALES_CATEGORY_ID, p_FST_SALES_CATEGORY_ID),
             ...
             /*
              ...
              FORECAST_WORKSHEET_ID = decode( p_FORECAST_WORKSHEET_ID, NULL, FORECAST_WORKSHEET_ID,FND_API.G_MISS_NUM,NULL,p_FORECAST_WORKSHEET_ID),
              ...
              --QUOTA_AMOUNT_FLAG = decode( p_QUOTA_AMOUNT_FLAG, FND_API.G_MISS_CHAR, QUOTA_AMOUNT_FLAG, p_QUOTA_AMOUNT_FLAG),
              GROUP_FORECAST_AMOUNT = decode( p_GROUP_FORECAST_AMOUNT, NULL,GROUP_FORECAST_AMOUNT, FND_API.G_MISS_NUM,NULL,  p_GROUP_FORECAST_AMOUNT),
              GROUP_FORECAST_AMOUNT_FLAG = decode( p_GROUP_FORECAST_AMOUNT_FLAG, NULL, GROUP_FORECAST_AMOUNT_FLAG, FND_API.G_MISS_CHAR,NULL, p_GROUP_FORECAST_AMOUNT_FLAG),

              FST_SALES_CATEGORY_ID = decode( p_FST_SALES_CATEGORY_ID, NULL, FST_SALES_CATEGORY_ID,FND_API.G_MISS_NUM, NULL, p_FST_SALES_CATEGORY_ID),
              INTEREST_TYPE_ID = decode( p_INTEREST_TYPE_ID, NULL,INTEREST_TYPE_ID,  FND_API.G_MISS_NUM, NULL,p_INTEREST_TYPE_ID),
              SALES_QUOTA_ID = decode( p_SALES_QUOTA_ID, NULL,SALES_QUOTA_ID,  FND_API.G_MISS_NUM,NULL,  p_SALES_QUOTA_ID),
      ...
      */
    where PROD_WORKSHEET_LINE_ID = p_PROD_WORKSHEET_LINE_ID;
...
PROCEDURE Delete_Row(
 ...
 IS
 BEGIN
   DELETE FROM AS_PROD_WORKSHEET_LINES
    WHERE PROD_WORKSHEET_LINE_ID = p_PROD_WORKSHEET_LINE_ID;
   If (SQL%NOTFOUND) then
       RAISE NO_DATA_FOUND;
   End If;
...
PROCEDURE Lock_Row(
 ...
 IS
   CURSOR C IS
        ...
        WHERE PROD_WORKSHEET_LINE_ID =  p_PROD_WORKSHEET_LINE_ID
        FOR UPDATE of PROD_WORKSHEET_LINE_ID NOWAIT;
   Recinfo C%ROWTYPE;
 BEGIN
    OPEN C;
    ...
    CLOSE C;
    if (
           (      Recinfo.PROD_WORKSHEET_LINE_ID = p_PROD_WORKSHEET_LINE_ID)
       AND (    ( Recinfo.FORECAST_WORKSHEET_ID = p_FORECAST_WORKSHEET_ID)
            OR (    ( Recinfo.FORECAST_WORKSHEET_ID IS NULL )
                AND (  p_FORECAST_WORKSHEET_ID IS NULL )))
       ...
       AND (    ( Recinfo.SALES_QUOTA_ID = p_SALES_QUOTA_ID)
            OR (    ( Recinfo.SALES_QUOTA_ID IS NULL )
                AND (  p_SALES_QUOTA_ID IS NULL )))
       ...
       AND (    ( Recinfo.GROUP_FORECAST_AMOUNT = p_GROUP_FORECAST_AMOUNT)
            OR (    ( Recinfo.GROUP_FORECAST_AMOUNT IS NULL )
                AND (  p_GROUP_FORECAST_AMOUNT IS NULL )))
       ...
       AND (    ( Recinfo.GROUP_FORECAST_AMOUNT_FLAG = p_GROUP_FORECAST_AMOUNT_FLAG)
            OR (    ( Recinfo.GROUP_FORECAST_AMOUNT_FLAG IS NULL )
                AND (  p_GROUP_FORECAST_AMOUNT_FLAG IS NULL )))
       ...
       AND (    ( Recinfo.FST_SALES_CATEGORY_ID = p_FST_SALES_CATEGORY_ID)
            OR (    ( Recinfo.FST_SALES_CATEGORY_ID IS NULL )
                AND (  p_FST_SALES_CATEGORY_ID IS NULL )))
...
End AS_PROD_WORKSHEET_LINES_PKG;
