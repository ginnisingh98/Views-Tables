--------------------------------------------------------
--  DDL for Package Body BEN_ELIG_COMPTNCY_PRTE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIG_COMPTNCY_PRTE_BK1" as
/* $Header: beecyapi.pkb 120.0 2005/05/28 01:55:17 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_ELIG_COMPTNCY_PRTE_BK1.CREATE_ELIG_COMPTNCY_PRTE_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_COMPTNCY_PRTE_BK1.CREATE_ELIG_COMPTNCY_PRTE_A', 20);
end CREATE_ELIG_COMPTNCY_PRTE_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIG_COMPTNCY_PRTE_BK1.CREATE_ELIG_COMPTNCY_PRTE_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_COMPTNCY_PRTE_BK1.CREATE_ELIG_COMPTNCY_PRTE_B', 20);
end CREATE_ELIG_COMPTNCY_PRTE_B;
