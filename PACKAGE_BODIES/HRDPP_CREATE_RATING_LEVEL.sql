--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_RATING_LEVEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_RATING_LEVEL" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:15
 * Generated for API: HR_RATING_LEVELS_API.CREATE_RATING_LEVEL
 */
--
...
,P_RATING_SCALE_NAME => c.p30
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID);
--
L_COMPETENCE_ID := 
PER_COMPETENCE_DATA_PUMP.get_competence_id
(P_DATA_PUMP_ALWAYS_CALL => null
,P_COMPETENCE_NAME => c.p31
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID);
--
hr_data_pump.api_trc_on;
HR_RATING_LEVELS_API.CREATE_RATING_LEVEL
...
,P_ATTRIBUTE19 => c.p25
,P_ATTRIBUTE20 => c.p26
,P_RATING_LEVEL_ID => c.p27
,P_OBJECT_VERSION_NUMBER => c.p28
,P_OBJ_VER_NUMBER_CPN_OR_RSC => c.p29);
...
l.pval029 = decode(c.p29,null,cn,c.p29)
