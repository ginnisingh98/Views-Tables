--------------------------------------------------------
--  DDL for Package Body BEN_CWB_PERSON_GROUPS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CWB_PERSON_GROUPS_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_CWB_PERSON_GROUPS_BK2.UPDATE_GROUP_BUDGET_A', 10);
hr_utility.set_location(' Leaving: BEN_CWB_PERSON_GROUPS_BK2.UPDATE_GROUP_BUDGET_A', 20);
end UPDATE_GROUP_BUDGET_A;
...
begin
hr_utility.set_location('Entering: BEN_CWB_PERSON_GROUPS_BK2.UPDATE_GROUP_BUDGET_B', 10);
hr_utility.set_location(' Leaving: BEN_CWB_PERSON_GROUPS_BK2.UPDATE_GROUP_BUDGET_B', 20);
end UPDATE_GROUP_BUDGET_B;
