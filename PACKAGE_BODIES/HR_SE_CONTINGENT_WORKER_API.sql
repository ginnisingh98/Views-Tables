--------------------------------------------------------
--  DDL for Package Body HR_SE_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SE_CONTINGENT_WORKER_API" AS
  /* $Header: pecwksei.pkb 120.0 2005/05/31 07:28:25 appldev noship $ */
--
	-- Package Variables
	g_package  varchar2(33) := '  hr_se_contingent_worker_api.';
