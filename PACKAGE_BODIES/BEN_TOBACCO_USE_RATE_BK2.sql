--------------------------------------------------------
--  DDL for Package Body BEN_TOBACCO_USE_RATE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_TOBACCO_USE_RATE_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_TOBACCO_USE_RATE_BK2.UPDATE_TOBACCO_USE_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_TOBACCO_USE_RATE_BK2.UPDATE_TOBACCO_USE_RATE_A', 20);
end UPDATE_TOBACCO_USE_RATE_A;
...
begin
hr_utility.set_location('Entering: BEN_TOBACCO_USE_RATE_BK2.UPDATE_TOBACCO_USE_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_TOBACCO_USE_RATE_BK2.UPDATE_TOBACCO_USE_RATE_B', 20);
end UPDATE_TOBACCO_USE_RATE_B;
