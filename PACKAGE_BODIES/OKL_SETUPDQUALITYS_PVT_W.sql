--------------------------------------------------------
--  DDL for Package Body OKL_SETUPDQUALITYS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPDQUALITYS_PVT_W" as
  /* $Header: OKLESDQB.pls 120.2 2007/03/04 10:09:31 dcshanmu ship $ */
  ...
  as
    ddp_pdqv_rec okl_setupdqualitys_pvt.pdqv_rec_type;
    ddx_no_data_found boolean;
    ddx_pdqv_rec okl_setupdqualitys_pvt.pdqv_rec_type;
  ...
  begin
    ...
    okl_setupdqualitys_pvt.get_rec(ddp_pdqv_rec,
      ddx_no_data_found,
      x_return_status,
      ddx_pdqv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p3_a0 := rosetta_g_miss_num_map(ddx_pdqv_rec.id);
    p3_a1 := rosetta_g_miss_num_map(ddx_pdqv_rec.object_version_number);
    p3_a2 := rosetta_g_miss_num_map(ddx_pdqv_rec.ptl_id);
    p3_a3 := rosetta_g_miss_num_map(ddx_pdqv_rec.pqy_id);
    p3_a4 := ddx_pdqv_rec.from_date;
    p3_a5 := ddx_pdqv_rec.to_date;
    p3_a6 := rosetta_g_miss_num_map(ddx_pdqv_rec.created_by);
    p3_a7 := ddx_pdqv_rec.creation_date;
    p3_a8 := rosetta_g_miss_num_map(ddx_pdqv_rec.last_updated_by);
    p3_a9 := ddx_pdqv_rec.last_update_date;
    p3_a10 := rosetta_g_miss_num_map(ddx_pdqv_rec.last_update_login);
  end;
  ...
  as
    ddp_ptlv_rec okl_setupdqualitys_pvt.ptlv_rec_type;
    ddp_pdqv_rec okl_setupdqualitys_pvt.pdqv_rec_type;
    ddx_pdqv_rec okl_setupdqualitys_pvt.pdqv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupdqualitys_pvt.insert_dqualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ptlv_rec okl_setupdqualitys_pvt.ptlv_rec_type;
    ddp_pdqv_tbl okl_setupdqualitys_pvt.pdqv_tbl_type;
    ddx_pdqv_tbl okl_setupdqualitys_pvt.pdqv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupdqualitys_pvt.delete_dqualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
