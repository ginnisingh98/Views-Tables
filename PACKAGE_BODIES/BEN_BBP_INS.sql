--------------------------------------------------------
--  DDL for Package Body BEN_BBP_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BBP_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_bbp_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure insert_dml(p_rec in out nocopy ben_bbp_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Insert the row into: ben_batch_parameter
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_insert(p_rec  in out nocopy ben_bbp_shd.g_rec_type) is
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  select ben_batch_parameter_s.nextval
  into   p_rec.batch_parameter_id
  from   sys.dual;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Procedure ins
  (p_effective_date in date,
   p_rec            in out nocopy ben_bbp_shd.g_rec_type) is
--
...
Begin
  ...
  --
  ben_bbp_bus.insert_validate(p_rec,p_effective_date);
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_bbp_rec
  ...
  --
  p_batch_parameter_id := l_rec.batch_parameter_id;
