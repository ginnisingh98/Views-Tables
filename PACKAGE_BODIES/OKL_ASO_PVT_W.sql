--------------------------------------------------------
--  DDL for Package Body OKL_ASO_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ASO_PVT_W" as
  /* $Header: OKLIASOB.pls 120.1.12010000.2 2010/04/30 15:38:38 rpillay noship $ */
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).asset_id := a18(indx);
          t(ddindx).inv_item_id := a19(indx);
          t(ddindx).supplier_id := a20(indx);
          t(ddindx).primary_component := a21(indx);
          t(ddindx).unit_cost := a22(indx);
          t(ddindx).number_of_units := a23(indx);
          t(ddindx).manufacturer_name := a24(indx);
          t(ddindx).year_manufactured := a25(indx);
          t(ddindx).model_number := a26(indx);
          t(ddindx).short_description := a27(indx);
    ...
    a29 := JTF_VARCHAR2_TABLE_2000();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a18(indx) := t(ddindx).asset_id;
          a19(indx) := t(ddindx).inv_item_id;
          a20(indx) := t(ddindx).supplier_id;
          a21(indx) := t(ddindx).primary_component;
          a22(indx) := t(ddindx).unit_cost;
          a23(indx) := t(ddindx).number_of_units;
          a24(indx) := t(ddindx).manufacturer_name;
          a25(indx) := t(ddindx).year_manufactured;
          a26(indx) := t(ddindx).model_number;
          a27(indx) := t(ddindx).short_description;
  ...
  as
    ddp_asov_tbl okl_aso_pvt.asov_tbl_type;
    ddx_asov_tbl okl_aso_pvt.asov_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_aso_pvt_w.rosetta_table_copy_in_p23(ddp_asov_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_aso_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    okl_aso_pvt_w.rosetta_table_copy_out_p23(ddx_asov_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_aso_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_aso_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_asov_rec okl_aso_pvt.asov_rec_type;
    ddx_asov_rec okl_aso_pvt.asov_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ddp_asov_rec.id := p5_a0;
    ddp_asov_rec.object_version_number := p5_a1;
    ddp_asov_rec.attribute_category := p5_a2;
    ddp_asov_rec.attribute1 := p5_a3;
    ddp_asov_rec.attribute2 := p5_a4;
    ddp_asov_rec.attribute3 := p5_a5;
    ddp_asov_rec.attribute4 := p5_a6;
    ddp_asov_rec.attribute5 := p5_a7;
    ddp_asov_rec.attribute6 := p5_a8;
    ddp_asov_rec.attribute7 := p5_a9;
    ddp_asov_rec.attribute8 := p5_a10;
    ddp_asov_rec.attribute9 := p5_a11;
    ddp_asov_rec.attribute10 := p5_a12;
    ddp_asov_rec.attribute11 := p5_a13;
    ddp_asov_rec.attribute12 := p5_a14;
    ddp_asov_rec.attribute13 := p5_a15;
    ddp_asov_rec.attribute14 := p5_a16;
    ddp_asov_rec.attribute15 := p5_a17;
    ddp_asov_rec.asset_id := p5_a18;
    ddp_asov_rec.inv_item_id := p5_a19;
    ddp_asov_rec.supplier_id := p5_a20;
    ddp_asov_rec.primary_component := p5_a21;
    ddp_asov_rec.unit_cost := p5_a22;
    ddp_asov_rec.number_of_units := p5_a23;
    ddp_asov_rec.manufacturer_name := p5_a24;
    ddp_asov_rec.year_manufactured := p5_a25;
    ddp_asov_rec.model_number := p5_a26;
    ddp_asov_rec.short_description := p5_a27;
    ddp_asov_rec.description := p5_a28;
    ddp_asov_rec.comments := p5_a29;
    ...
    p6_a0 := ddx_asov_rec.id;
    p6_a1 := ddx_asov_rec.object_version_number;
    p6_a2 := ddx_asov_rec.attribute_category;
    p6_a3 := ddx_asov_rec.attribute1;
    p6_a4 := ddx_asov_rec.attribute2;
    p6_a5 := ddx_asov_rec.attribute3;
    p6_a6 := ddx_asov_rec.attribute4;
    p6_a7 := ddx_asov_rec.attribute5;
    p6_a8 := ddx_asov_rec.attribute6;
    p6_a9 := ddx_asov_rec.attribute7;
    p6_a10 := ddx_asov_rec.attribute8;
    p6_a11 := ddx_asov_rec.attribute9;
    p6_a12 := ddx_asov_rec.attribute10;
    p6_a13 := ddx_asov_rec.attribute11;
    p6_a14 := ddx_asov_rec.attribute12;
    p6_a15 := ddx_asov_rec.attribute13;
    p6_a16 := ddx_asov_rec.attribute14;
    p6_a17 := ddx_asov_rec.attribute15;
    p6_a18 := ddx_asov_rec.asset_id;
    p6_a19 := ddx_asov_rec.inv_item_id;
    p6_a20 := ddx_asov_rec.supplier_id;
    p6_a21 := ddx_asov_rec.primary_component;
    p6_a22 := ddx_asov_rec.unit_cost;
    p6_a23 := ddx_asov_rec.number_of_units;
    p6_a24 := ddx_asov_rec.manufacturer_name;
    p6_a25 := ddx_asov_rec.year_manufactured;
    p6_a26 := ddx_asov_rec.model_number;
    p6_a27 := ddx_asov_rec.short_description;
    p6_a28 := ddx_asov_rec.description;
    p6_a29 := ddx_asov_rec.comments;
  end;
