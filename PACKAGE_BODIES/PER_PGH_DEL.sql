--------------------------------------------------------
--  DDL for Package Body PER_PGH_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PGH_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_pgh_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the per_gen_hierarchy row.
  --
  delete from per_gen_hierarchy
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in per_pgh_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in per_pgh_shd.g_rec_type) is
--
...
Begin
  ...
  --
  per_pgh_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  per_pgh_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  per_pgh_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  per_pgh_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
