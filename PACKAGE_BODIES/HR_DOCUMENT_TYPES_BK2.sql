--------------------------------------------------------
--  DDL for Package Body HR_DOCUMENT_TYPES_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DOCUMENT_TYPES_BK2" as
...
begin
hr_utility.set_location('Entering: HR_DOCUMENT_TYPES_BK2.UPDATE_DOCUMENT_TYPE_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
hr_document_types_be2.UPDATE_DOCUMENT_TYPE_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_DOCUMENT_TYPE', 'AP');
hr_utility.set_location(' Leaving: HR_DOCUMENT_TYPES_BK2.UPDATE_DOCUMENT_TYPE_A', 20);
...
begin
hr_utility.set_location('Entering: HR_DOCUMENT_TYPES_BK2.UPDATE_DOCUMENT_TYPE_B', 10);
hr_utility.set_location(' Leaving: HR_DOCUMENT_TYPES_BK2.UPDATE_DOCUMENT_TYPE_B', 20);
end UPDATE_DOCUMENT_TYPE_B;
