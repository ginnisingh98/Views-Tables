--------------------------------------------------------
--  DDL for Package Body ARP_CPC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ARP_CPC_PKG" as
/* $Header: AROCPCB.pls 120.1 2005/08/11 00:50:14 hyu noship $ */
...
--
--
PROCEDURE check_unique (c_profile_class_name in varchar2, c_rowid in varchar2) is
BEGIN
  NULL;
END check_unique;
--
