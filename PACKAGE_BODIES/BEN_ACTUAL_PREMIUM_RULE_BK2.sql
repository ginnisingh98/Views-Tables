--------------------------------------------------------
--  DDL for Package Body BEN_ACTUAL_PREMIUM_RULE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ACTUAL_PREMIUM_RULE_BK2" as
/* $Header: beavaapi.pkb 120.0 2005/05/28 00:31:27 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_ACTUAL_PREMIUM_RULE_BK2.UPDATE_ACTUAL_PREMIUM_RULE_A', 10);
hr_utility.set_location(' Leaving: BEN_ACTUAL_PREMIUM_RULE_BK2.UPDATE_ACTUAL_PREMIUM_RULE_A', 20);
end UPDATE_ACTUAL_PREMIUM_RULE_A;
...
begin
hr_utility.set_location('Entering: BEN_ACTUAL_PREMIUM_RULE_BK2.UPDATE_ACTUAL_PREMIUM_RULE_B', 10);
hr_utility.set_location(' Leaving: BEN_ACTUAL_PREMIUM_RULE_BK2.UPDATE_ACTUAL_PREMIUM_RULE_B', 20);
end UPDATE_ACTUAL_PREMIUM_RULE_B;
