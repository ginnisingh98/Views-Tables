--------------------------------------------------------
--  DDL for Package Body OTA_TPC_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TPC_RKI" as
...
begin
hr_utility.set_location('Entering: OTA_TPC_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: OTA_TPC_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end OTA_TPC_RKI;
