--------------------------------------------------------
--  DDL for Package Body JTF_CAL_AVLBLTY_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_CAL_AVLBLTY_PVT_W" as
  /* $Header: jtfwavb.pls 120.2 2006/04/27 23:29 deeprao ship $ */
  ...
  as
    ddp_rslist jtf_cal_avlblty_pvt.rstab;
    ddp_startdatetime date;
    ddp_enddatetime date;
    ddx_availbltylist jtf_cal_avlblty_pvt.avlbltb;
    ddx_totalavailbltylist jtf_cal_avlblty_pvt.avlbltb;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    jtf_cal_avlblty_pvt_w.rosetta_table_copy_in_p1(ddp_rslist, p5_a0
      , p5_a1
      , p5_a2
      );

    ddp_startdatetime := rosetta_g_miss_date_in_map(p_startdatetime);

    ddp_enddatetime := rosetta_g_miss_date_in_map(p_enddatetime);
    ...
    jtf_cal_avlblty_pvt.availability(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    jtf_cal_avlblty_pvt_w.rosetta_table_copy_out_p3(ddx_availbltylist, p10_a0
      , p10_a1
      , p10_a2
      , p10_a3
      , p10_a4
    ...
    jtf_cal_avlblty_pvt_w.rosetta_table_copy_out_p3(ddx_totalavailbltylist, p11_a0
      , p11_a1
      , p11_a2
      , p11_a3
      , p11_a4
