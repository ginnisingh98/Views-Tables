--------------------------------------------------------
--  DDL for Package Body PER_WORK_INCIDENT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_WORK_INCIDENT_BK1" as
...
begin
hr_utility.set_location('Entering: PER_WORK_INCIDENT_BK1.CREATE_WORK_INCIDENT_A', 10);
hr_utility.set_location(' Leaving: PER_WORK_INCIDENT_BK1.CREATE_WORK_INCIDENT_A', 20);
end CREATE_WORK_INCIDENT_A;
...
begin
hr_utility.set_location('Entering: PER_WORK_INCIDENT_BK1.CREATE_WORK_INCIDENT_B', 10);
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_WORK_INCIDENT', 'BP');
hr_utility.set_location(' Leaving: PER_WORK_INCIDENT_BK1.CREATE_WORK_INCIDENT_B', 20);
end CREATE_WORK_INCIDENT_B;
