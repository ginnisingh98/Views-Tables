--------------------------------------------------------
--  DDL for Package Body OKL_ACCT_GEN_RULE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ACCT_GEN_RULE_PVT_W" as
  /* $Header: OKLEACGB.pls 120.1 2005/07/07 13:36:03 dkagrawa noship $ */
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).segment_desc := a2(indx);
          t(ddindx).segment_number := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).agr_id := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).ae_line_type := a5(indx);
          t(ddindx).source := a6(indx);
          t(ddindx).constants := a7(indx);
    ...
    a29 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := t(ddindx).segment_desc;
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).segment_number);
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).agr_id);
          a5(indx) := t(ddindx).ae_line_type;
          a6(indx) := t(ddindx).source;
          a7(indx) := t(ddindx).constants;
  ...
  as
    ddx_acc_lines okl_acct_gen_rule_pvt.acct_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_acct_gen_rule_pvt.get_rule_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    okl_acct_gen_rule_pvt_w.rosetta_table_copy_out_p4(ddx_acc_lines, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  as
    ddp_acc_lines okl_acct_gen_rule_pvt.acct_tbl_type;
    ddx_acc_lines okl_acct_gen_rule_pvt.acct_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_acct_gen_rule_pvt_w.rosetta_table_copy_in_p4(ddp_acc_lines, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acct_gen_rule_pvt.updt_rule_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
