--------------------------------------------------------
--  DDL for Package Body HXC_HTC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_HTC_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_htc_upd.';  -- Global package name
...
Begin
  ...
  --
  -- Update the hxc_time_categories Row
  --
  update hxc_time_categories
    set
     time_category_id                = p_rec.time_category_id
    ,time_category_name              = p_rec.time_category_name
    ,operator                        = p_rec.operator
    ,description                     = p_rec.description
    ,display                         = p_rec.display
    ,object_version_number           = p_rec.object_version_number
        ,last_updated_by		     = fnd_global.user_id
    ,last_update_date		     = sysdate
    ,last_update_login	             = fnd_global.login_id

    where time_category_id = p_rec.time_category_id;
  --
...
Begin
  ...
  begin
    ...
    hxc_htc_rku.after_update
      ...
      ,p_time_category_name_o
      => hxc_htc_shd.g_old_rec.time_category_name
      ,p_operator_o => hxc_htc_shd.g_old_rec.operator
      ,p_description_o => hxc_htc_shd.g_old_rec.description
      ,p_display_o => hxc_htc_shd.g_old_rec.display
...
Begin
  ...
  --
  If (p_rec.time_category_name = hr_api.g_varchar2) then
    p_rec.time_category_name :=
    hxc_htc_shd.g_old_rec.time_category_name;
  End If;
  --
...
Begin
  ...
  --
  convert_defs(p_rec);
  hxc_htc_bus.update_validate
     (p_rec
     );
  --
  -- Call the supporting pre-update operation
  --
  hxc_htc_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hxc_htc_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hxc_htc_upd.post_update
     (p_rec
     );
...
Procedure upd
  ...
  ,p_time_category_name           in     varchar2  default hr_api.g_varchar2
