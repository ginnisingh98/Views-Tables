--------------------------------------------------------
--  DDL for Package Body OTA_CFT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CFT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_cft_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure update_dml
  (p_rec in out nocopy ota_cft_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Update the ota_conference_servers_tl Row
  --
  update ota_conference_servers_tl
    set
     conference_server_id            = p_rec.conference_server_id
...
Begin
  ...
  --
  ota_cft_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_cft_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_cft_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
  ...
  cursor csr_upd_langs is
    select cft.language
     ...
     where cft.conference_server_id = p_conference_server_id
       and p_language_code in (cft.language
                              ,cft.source_lang);
  --
