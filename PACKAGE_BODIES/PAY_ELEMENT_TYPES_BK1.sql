--------------------------------------------------------
--  DDL for Package Body PAY_ELEMENT_TYPES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_ELEMENT_TYPES_BK1" as
...
begin
hr_utility.set_location('Entering: PAY_ELEMENT_TYPES_BK1.CREATE_ELEMENT_TYPE_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
pay_element_types_be1.CREATE_ELEMENT_TYPE_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_ELEMENT_TYPE', 'AP');
hr_utility.set_location(' Leaving: PAY_ELEMENT_TYPES_BK1.CREATE_ELEMENT_TYPE_A', 20);
...
begin
hr_utility.set_location('Entering: PAY_ELEMENT_TYPES_BK1.CREATE_ELEMENT_TYPE_B', 10);
hr_utility.set_location(' Leaving: PAY_ELEMENT_TYPES_BK1.CREATE_ELEMENT_TYPE_B', 20);
end CREATE_ELEMENT_TYPE_B;
