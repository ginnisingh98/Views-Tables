--------------------------------------------------------
--  DDL for Package Body AP_APXPAYAD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AP_APXPAYAD_XMLP_PKG" AS
/* $Header: APXPAYADB.pls 120.0 2007/12/27 08:18:48 vjaganat noship $ */
...
C_doc_sequence_id := l_doc_sequence_id;
...
--Functions to refer Oracle report placeholders--
 ...
 Function C_CHART_OF_ACCOUNTS_ID_p return number is
	Begin
	 ...
	 END;
 Function C_doc_sequence_id_p return number is
	Begin
	 return C_doc_sequence_id;
	 END;
