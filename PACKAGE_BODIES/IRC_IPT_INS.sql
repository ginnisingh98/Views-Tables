--------------------------------------------------------
--  DDL for Package Body IRC_IPT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_IPT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  irc_ipt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: irc_posting_contents_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.posting_content_id               := p_posting_content_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  irc_ipt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  irc_ipt_ins.post_insert
     (p_rec
     );
  hr_multi_message.end_validation_set;
  --
