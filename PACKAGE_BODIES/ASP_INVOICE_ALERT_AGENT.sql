--------------------------------------------------------
--  DDL for Package Body ASP_INVOICE_ALERT_AGENT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ASP_INVOICE_ALERT_AGENT" as
/* $Header: aspadiab.pls 120.5 2005/09/28 13:45 axavier noship $ */
---------------------------------------------------------------------------
-- Package Name:   ASP_INVOICE_ALERT_AGENT
---------------------------------------------------------------------------
-- Description:
...
/*-------------------------------------------------------------------------*
 |                             Private Constants
 *-------------------------------------------------------------------------*/
G_PKG_NAME  CONSTANT VARCHAR2(30):= 'ASP_INVOICE_ALERT_AGENT';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'aspadiab.pls';
...
IS
  ...
  CURSOR get_customer_id(c_delinquency_id in number) is
    SELECT
...
BEGIN
  ...
  If(funcmode = 'RUN') Then
    ...
    BEGIN
      OPEN get_customer_id(l_delinquency_id);
