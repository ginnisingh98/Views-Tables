--------------------------------------------------------
--  DDL for Package Body PQH_CRE_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_CRE_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_cre_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the pqh_criteria_rate_elements row.
  --
  delete from pqh_criteria_rate_elements
  where criteria_rate_element_id = p_rec.criteria_rate_element_id;
  --
  --
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pqh_cre_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in pqh_cre_shd.g_rec_type) is
--
...
Begin
  ...
  begin
    ...
    --
    pqh_cre_rkd.after_delete
      (p_criteria_rate_element_id
      => p_rec.criteria_rate_element_id
      ,p_criteria_rate_defn_id_o
      => pqh_cre_shd.g_old_rec.criteria_rate_defn_id
      ,p_element_type_id_o
      => pqh_cre_shd.g_old_rec.element_type_id
      ,p_input_value_id_o
      => pqh_cre_shd.g_old_rec.input_value_id
...
Begin
  ...
  --
  pqh_cre_bus.delete_validate(p_rec);
  --
  ...
  --
  pqh_cre_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  pqh_cre_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  pqh_cre_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
