--------------------------------------------------------
--  DDL for Package Body BEN_TTL_PRTT_RT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_TTL_PRTT_RT_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_TTL_PRTT_RT_BK1.CREATE_TTL_PRTT_RT_A', 10);
hr_utility.set_location(' Leaving: BEN_TTL_PRTT_RT_BK1.CREATE_TTL_PRTT_RT_A', 20);
end CREATE_TTL_PRTT_RT_A;
...
begin
hr_utility.set_location('Entering: BEN_TTL_PRTT_RT_BK1.CREATE_TTL_PRTT_RT_B', 10);
hr_utility.set_location(' Leaving: BEN_TTL_PRTT_RT_BK1.CREATE_TTL_PRTT_RT_B', 20);
end CREATE_TTL_PRTT_RT_B;
