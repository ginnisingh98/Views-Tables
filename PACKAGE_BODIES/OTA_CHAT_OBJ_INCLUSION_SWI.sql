--------------------------------------------------------
--  DDL for Package Body OTA_CHAT_OBJ_INCLUSION_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CHAT_OBJ_INCLUSION_SWI" As
/* $Header: otcoiswi.pkb 120.1 2005/08/02 18:39 asud noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'ota_chat_obj_inclusion_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_chat_obj_inclusion_swi;
  --
  ...
  --
  ota_coi_ins.set_base_key_value
    (p_chat_id => p_chat_id
  ...
  -- Call API
  --
  ota_chat_obj_inclusion_api.create_chat_obj_inclusion
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_chat_obj_inclusion_swi;
    --
...
Begin
  ...
  -- Call API
  --
  ota_chat_obj_inclusion_api.update_chat_obj_inclusion
    (p_validate                     => l_validate
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_chat_obj_inclusion_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_chat_obj_inclusion_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  ota_chat_obj_inclusion_api.delete_chat_obj_inclusion
    (p_validate                     => l_validate
    ,p_chat_id                      => p_chat_id
    ,p_object_id                    => p_object_id
    ,p_object_type                  => p_object_type
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_chat_obj_inclusion_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
