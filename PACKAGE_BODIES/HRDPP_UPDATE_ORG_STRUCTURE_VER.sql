--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_ORG_STRUCTURE_VER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_ORG_STRUCTURE_VER" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:40
 * Generated for API: PER_ORG_STRUCTURE_VERSION_API.UPDATE_ORG_STRUCTURE_VERSION
 */
--
...
,I_COPY_STRUCTURE_VERSION_ID in varchar2 default 'N'
...
,dc(P_DATE_FROM)
,P_VERSION_NUMBER
,nd(P_COPY_STRUCTURE_VERSION_ID,I_COPY_STRUCTURE_VERSION_ID)
...
(P_ORG_STR_VERSION_USER_KEY => c.p9);
end if;
--
if c.p10 is null or
c.p2 is null or
...
hr_pump_get.GET_ORG_STR_VER_OVN
(P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_ORGANIZATION_STRUCTURE_ID => c.p10
,P_DATE_FROM => c.p2
...
end hrdpp_UPDATE_ORG_STRUCTURE_VER;
