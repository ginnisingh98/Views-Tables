--------------------------------------------------------
--  DDL for Package Body PER_SA_DISABILITY_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_SA_DISABILITY_API" as
/* $Header: pedissai.pkb 115.0 2003/09/10 02:21:34 adevanat noship $ */


--
-- Package Variables
--
g_package  varchar2(33) := 'per_sa_disability_api.';
--
-- ----------------------------------------------------------------------
...
begin
  ...
  --
  savepoint create_sa_disability;
  --
  ...
  per_disability_api.create_disability
       ...
       ,p_dis_information_category      => 'SA'
       ,p_dis_information1              => p_employment_office
...
procedure update_sa_disability
  ...
  --
  l_business_group_id    per_contracts_f.business_group_id%TYPE;
  l_proc                 varchar2(72) := g_package||'update_sa_disability';
  l_legislation_code     varchar2(2);
  --
  cursor csr_get_business_group_id is
    select per.business_group_id
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_sa_disability;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
