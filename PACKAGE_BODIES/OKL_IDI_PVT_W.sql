--------------------------------------------------------
--  DDL for Package Body OKL_IDI_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_IDI_PVT_W" as
  /* $Header: OKLIIDIB.pls 120.1 2005/07/13 09:26:25 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_idi_pvt.idi_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).idi_type := a2(indx);
          t(ddindx).process_flag := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).proportion_contributed := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).index_name := a5(indx);
          t(ddindx).program_id := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).description := a7(indx);
          t(ddindx).value := rosetta_g_miss_num_map(a8(indx));
          t(ddindx).datetime_valid := rosetta_g_miss_date_in_map(a9(indx));
          t(ddindx).datetime_invalid := rosetta_g_miss_date_in_map(a10(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_idi_pvt.idi_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a34 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := t(ddindx).idi_type;
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).process_flag);
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).proportion_contributed);
          a5(indx) := t(ddindx).index_name;
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).program_id);
          a7(indx) := t(ddindx).description;
          a8(indx) := rosetta_g_miss_num_map(t(ddindx).value);
          a9(indx) := t(ddindx).datetime_valid;
          a10(indx) := t(ddindx).datetime_invalid;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_idi_pvt.idiv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_VARCHAR2_TABLE_200
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).value := rosetta_g_miss_num_map(a7(indx));
          t(ddindx).datetime_valid := rosetta_g_miss_date_in_map(a8(indx));
          t(ddindx).datetime_invalid := rosetta_g_miss_date_in_map(a9(indx));
          ...
          t(ddindx).program_update_date := rosetta_g_miss_date_in_map(a29(indx));
          t(ddindx).created_by := rosetta_g_miss_num_map(a30(indx));
          t(ddindx).creation_date := rosetta_g_miss_date_in_map(a31(indx));
          t(ddindx).last_updated_by := rosetta_g_miss_num_map(a32(indx));
          t(ddindx).last_update_date := rosetta_g_miss_date_in_map(a33(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_idi_pvt.idiv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_VARCHAR2_TABLE_200
    , a3 out nocopy JTF_NUMBER_TABLE
    , a4 out nocopy JTF_NUMBER_TABLE
    ...
    a34 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a7(indx) := rosetta_g_miss_num_map(t(ddindx).value);
          a8(indx) := t(ddindx).datetime_valid;
          a9(indx) := t(ddindx).datetime_invalid;
  ...
  as
    ddp_idiv_rec okl_idi_pvt.idiv_rec_type;
    ddx_idiv_rec okl_idi_pvt.idiv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ddp_idiv_rec.id := rosetta_g_miss_num_map(p5_a0);
    ddp_idiv_rec.object_version_number := rosetta_g_miss_num_map(p5_a1);
    ddp_idiv_rec.idi_type := p5_a2;
    ddp_idiv_rec.process_flag := rosetta_g_miss_num_map(p5_a3);
    ddp_idiv_rec.proportion_contributed := rosetta_g_miss_num_map(p5_a4);
    ddp_idiv_rec.index_name := p5_a5;
    ddp_idiv_rec.description := p5_a6;
    ddp_idiv_rec.value := rosetta_g_miss_num_map(p5_a7);
    ddp_idiv_rec.datetime_valid := rosetta_g_miss_date_in_map(p5_a8);
    ddp_idiv_rec.datetime_invalid := rosetta_g_miss_date_in_map(p5_a9);
    ddp_idiv_rec.attribute_category := p5_a10;
    ddp_idiv_rec.attribute1 := p5_a11;
    ddp_idiv_rec.attribute2 := p5_a12;
    ddp_idiv_rec.attribute3 := p5_a13;
    ddp_idiv_rec.attribute4 := p5_a14;
    ddp_idiv_rec.attribute5 := p5_a15;
    ddp_idiv_rec.attribute6 := p5_a16;
    ddp_idiv_rec.attribute7 := p5_a17;
    ddp_idiv_rec.attribute8 := p5_a18;
    ddp_idiv_rec.attribute9 := p5_a19;
    ddp_idiv_rec.attribute10 := p5_a20;
    ddp_idiv_rec.attribute11 := p5_a21;
    ddp_idiv_rec.attribute12 := p5_a22;
    ddp_idiv_rec.attribute13 := p5_a23;
    ddp_idiv_rec.attribute14 := p5_a24;
    ddp_idiv_rec.attribute15 := p5_a25;
    ddp_idiv_rec.program_id := rosetta_g_miss_num_map(p5_a26);
    ddp_idiv_rec.request_id := rosetta_g_miss_num_map(p5_a27);
    ddp_idiv_rec.program_application_id := rosetta_g_miss_num_map(p5_a28);
    ddp_idiv_rec.program_update_date := rosetta_g_miss_date_in_map(p5_a29);
    ddp_idiv_rec.created_by := rosetta_g_miss_num_map(p5_a30);
    ddp_idiv_rec.creation_date := rosetta_g_miss_date_in_map(p5_a31);
    ddp_idiv_rec.last_updated_by := rosetta_g_miss_num_map(p5_a32);
    ddp_idiv_rec.last_update_date := rosetta_g_miss_date_in_map(p5_a33);
    ddp_idiv_rec.last_update_login := rosetta_g_miss_num_map(p5_a34);


    -- here's the delegated call to the old PL/SQL routine
    okl_idi_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a0 := rosetta_g_miss_num_map(ddx_idiv_rec.id);
    p6_a1 := rosetta_g_miss_num_map(ddx_idiv_rec.object_version_number);
    p6_a2 := ddx_idiv_rec.idi_type;
    p6_a3 := rosetta_g_miss_num_map(ddx_idiv_rec.process_flag);
    p6_a4 := rosetta_g_miss_num_map(ddx_idiv_rec.proportion_contributed);
    p6_a5 := ddx_idiv_rec.index_name;
    p6_a6 := ddx_idiv_rec.description;
    p6_a7 := rosetta_g_miss_num_map(ddx_idiv_rec.value);
    p6_a8 := ddx_idiv_rec.datetime_valid;
    p6_a9 := ddx_idiv_rec.datetime_invalid;
    p6_a10 := ddx_idiv_rec.attribute_category;
    p6_a11 := ddx_idiv_rec.attribute1;
    p6_a12 := ddx_idiv_rec.attribute2;
    p6_a13 := ddx_idiv_rec.attribute3;
    p6_a14 := ddx_idiv_rec.attribute4;
    p6_a15 := ddx_idiv_rec.attribute5;
    p6_a16 := ddx_idiv_rec.attribute6;
    p6_a17 := ddx_idiv_rec.attribute7;
    p6_a18 := ddx_idiv_rec.attribute8;
    p6_a19 := ddx_idiv_rec.attribute9;
    p6_a20 := ddx_idiv_rec.attribute10;
    p6_a21 := ddx_idiv_rec.attribute11;
    p6_a22 := ddx_idiv_rec.attribute12;
    p6_a23 := ddx_idiv_rec.attribute13;
    p6_a24 := ddx_idiv_rec.attribute14;
    p6_a25 := ddx_idiv_rec.attribute15;
    p6_a26 := rosetta_g_miss_num_map(ddx_idiv_rec.program_id);
    p6_a27 := rosetta_g_miss_num_map(ddx_idiv_rec.request_id);
    p6_a28 := rosetta_g_miss_num_map(ddx_idiv_rec.program_application_id);
    p6_a29 := ddx_idiv_rec.program_update_date;
    p6_a30 := rosetta_g_miss_num_map(ddx_idiv_rec.created_by);
    p6_a31 := ddx_idiv_rec.creation_date;
    p6_a32 := rosetta_g_miss_num_map(ddx_idiv_rec.last_updated_by);
    p6_a33 := ddx_idiv_rec.last_update_date;
    p6_a34 := rosetta_g_miss_num_map(ddx_idiv_rec.last_update_login);
  end;
  ...
  as
    ddp_idiv_tbl okl_idi_pvt.idiv_tbl_type;
    ddx_idiv_tbl okl_idi_pvt.idiv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_idi_pvt_w.rosetta_table_copy_in_p5(ddp_idiv_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_idi_pvt_w.rosetta_table_copy_out_p5(ddx_idiv_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_idi_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_idi_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_idi_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_idi_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
