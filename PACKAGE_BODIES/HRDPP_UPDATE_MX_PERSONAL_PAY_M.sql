--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_MX_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_MX_PERSONAL_PAY_M" as
/*
...
decode(l.pval028,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval028,'MX_BANK',d(l.pval001),l.pval042)) p28,
l.pval028 d28,
...
decode(l.pval031,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval031,'MX_HR_BANK_ACCT_TYPE',d(l.pval001),l.pval042)) p31,
l.pval031 d31,
...
decode(l.pval034,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval034,'PAYEE_TYPE',d(l.pval001),l.pval042)) p34,
l.pval034 d34,
l.pval035 p35,
l.pval036 p36,
...
(P_PERSONAL_PAY_METHOD_USER_KEY => c.p39);
end if;
--
if c.p39 is null or
c.p1 is null then
...
HR_MX_PERSONAL_PAY_METHOD_API.UPDATE_MX_PERSONAL_PAY_METHOD
