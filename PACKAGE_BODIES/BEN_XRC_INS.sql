--------------------------------------------------------
--  DDL for Package Body BEN_XRC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XRC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xrc_ins.';  -- Global package name
...
Begin
  ...
  --
  -- Insert the row into: ben_ext_rcd
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ext_rcd_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
--
  ...
  --
  create_app_ownerships('EXT_RCD_ID', p_rec.ext_rcd_id);
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_xrc_rec
