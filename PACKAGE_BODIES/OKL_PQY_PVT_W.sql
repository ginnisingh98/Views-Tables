--------------------------------------------------------
--  DDL for Package Body OKL_PQY_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PQY_PVT_W" as
  /* $Header: OKLIPQYB.pls 115.6 2002/12/24 04:09:13 sgorantl noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_pqy_pvt.pqy_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p2(t okl_pqy_pvt.pqy_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_pqy_pvt.pqyv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p5(t okl_pqy_pvt.pqyv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  as
    ddp_pqyv_rec okl_pqy_pvt.pqyv_rec_type;
    ddx_pqyv_rec okl_pqy_pvt.pqyv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_pqy_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pqyv_tbl okl_pqy_pvt.pqyv_tbl_type;
    ddx_pqyv_tbl okl_pqy_pvt.pqyv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pqy_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pqy_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pqy_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pqy_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
