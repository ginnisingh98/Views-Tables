--------------------------------------------------------
--  DDL for Package Body BEN_ETD_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ETD_RKD" as
...
begin
hr_utility.set_location('Entering: ben_etd_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_etd_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_etd_RKD;
