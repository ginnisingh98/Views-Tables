--------------------------------------------------------
--  DDL for Package Body PER_CNT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CNT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_cnt_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the per_ri_configurations_tl Row
  --
...
Begin
  ...
  If (p_rec.configuration_name = hr_api.g_varchar2) then
    ...
    per_cnt_shd.g_old_rec.configuration_name;
  End If;
  If (p_rec.configuration_description = hr_api.g_varchar2) then
    p_rec.configuration_description :=
    per_cnt_shd.g_old_rec.configuration_description;
  End If;
