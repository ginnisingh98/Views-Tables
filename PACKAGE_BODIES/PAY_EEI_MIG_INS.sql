--------------------------------------------------------
--  DDL for Package Body PAY_EEI_MIG_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_EEI_MIG_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_eei_mig_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  pay_eei_mig_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  pay_eei_mig_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pay_eei_mig_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pay_eei_mig_ins.post_insert
     (p_rec
     );
  --
