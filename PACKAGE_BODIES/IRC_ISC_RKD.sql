--------------------------------------------------------
--  DDL for Package Body IRC_ISC_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_ISC_RKD" as
...
begin
hr_utility.set_location('Entering: IRC_ISC_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: IRC_ISC_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end IRC_ISC_RKD;
