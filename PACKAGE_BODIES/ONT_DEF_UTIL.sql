--------------------------------------------------------
--  DDL for Package Body ONT_DEF_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_DEF_UTIL" AS
/* $Header: OEXDUTLB.pls 120.2 2005/08/28 22:57:03 shewgupt noship $ */
...
BEGIN
	-- reverted fix for FP bug 4286055 to fix bug 4567396
