--------------------------------------------------------
--  DDL for Package Body HXC_LKR_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_LKR_RKU" as
...
begin
hr_utility.set_location('Entering: HXC_LKR_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: HXC_LKR_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end HXC_LKR_RKU;
