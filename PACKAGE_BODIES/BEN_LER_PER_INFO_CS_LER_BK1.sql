--------------------------------------------------------
--  DDL for Package Body BEN_LER_PER_INFO_CS_LER_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LER_PER_INFO_CS_LER_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_LER_PER_INFO_CS_LER_BK1.CREATE_LER_PER_INFO_CS_LER_A', 10);
hr_utility.set_location(' Leaving: BEN_LER_PER_INFO_CS_LER_BK1.CREATE_LER_PER_INFO_CS_LER_A', 20);
end CREATE_LER_PER_INFO_CS_LER_A;
...
begin
hr_utility.set_location('Entering: BEN_LER_PER_INFO_CS_LER_BK1.CREATE_LER_PER_INFO_CS_LER_B', 10);
hr_utility.set_location(' Leaving: BEN_LER_PER_INFO_CS_LER_BK1.CREATE_LER_PER_INFO_CS_LER_B', 20);
end CREATE_LER_PER_INFO_CS_LER_B;
