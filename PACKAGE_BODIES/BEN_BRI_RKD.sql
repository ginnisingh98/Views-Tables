--------------------------------------------------------
--  DDL for Package Body BEN_BRI_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BRI_RKD" as
...
begin
hr_utility.set_location('Entering: ben_bri_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_bri_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_bri_RKD;
