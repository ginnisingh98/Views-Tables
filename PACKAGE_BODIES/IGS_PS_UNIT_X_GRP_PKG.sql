--------------------------------------------------------
--  DDL for Package Body IGS_PS_UNIT_X_GRP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_PS_UNIT_X_GRP_PKG" AS
/* $Header: IGSPI2IB.pls 115.6 2002/11/29 02:16:55 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_ps_unit_x_grp%ROWTYPE;
  new_references igs_ps_unit_x_grp%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.unit_x_listed_group_name	:= x_unit_x_listed_group_name;
  ...
  */
  BEGIN
    ...
    igs_ps_unit_x_grpmem_pkg.get_fk_igs_ps_unit_x_grp (
      old_references.unit_x_listed_group_id
    );
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.unit_x_listed_group_name = x_unit_x_listed_group_name)
