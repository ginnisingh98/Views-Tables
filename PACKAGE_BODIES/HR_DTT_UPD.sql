--------------------------------------------------------
--  DDL for Package Body HR_DTT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DTT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_dtt_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the hr_document_types_tl Row
  --
...
Begin
  ...
  --
  hr_dtt_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hr_dtt_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hr_dtt_upd.post_update
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
  ...
  cursor csr_upd_langs is
    select dtt.language
     ...
     where dtt.document_type_id = p_document_type_id
       and p_language_code in (dtt.language
                              ,dtt.source_language);
  --
