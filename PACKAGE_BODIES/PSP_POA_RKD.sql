--------------------------------------------------------
--  DDL for Package Body PSP_POA_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_POA_RKD" as
...
begin
hr_utility.set_location('Entering: PSP_POA_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PSP_POA_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PSP_POA_RKD;
