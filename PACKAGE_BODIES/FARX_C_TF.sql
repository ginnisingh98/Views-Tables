--------------------------------------------------------
--  DDL for Package Body FARX_C_TF
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FARX_C_TF" as
/* $Header: farxctfb.pls 120.2.12010000.2 2009/07/19 13:52:05 glchen ship $ */
...
--  and fcp.concurrent_program_name = 'RXFATFR';
