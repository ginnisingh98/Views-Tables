--------------------------------------------------------
--  DDL for Package Body OKL_SPLIT_ASSET_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SPLIT_ASSET_PVT_W" as
  /* $Header: OKLESPAB.pls 115.9 2004/02/17 22:56:18 avsingh noship $ */
  ...
  procedure rosetta_table_copy_in_p10(t out nocopy okl_split_asset_pvt.cle_tbl_type, a0 JTF_NUMBER_TABLE
    ) as
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        ddindx := 1;
        while true loop
          t(ddindx).cle_id := rosetta_g_miss_num_map(a0(indx));
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p10(t okl_split_asset_pvt.cle_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ) as
    ddindx binary_integer; indx binary_integer;
  begin
  if t is null or t.count = 0 then
    a0 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        indx := 1;
        while true loop
          a0(indx) := rosetta_g_miss_num_map(t(ddindx).cle_id);
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_in_p13(t out nocopy okl_split_asset_pvt.ib_tbl_type, a0 JTF_NUMBER_TABLE
    ) as
    ddindx binary_integer; indx binary_integer;
  begin
  if a0 is not null and a0.count > 0 then
  ...
  procedure rosetta_table_copy_out_p13(t okl_split_asset_pvt.ib_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ) as
    ddindx binary_integer; indx binary_integer;
  begin
  if t is null or t.count = 0 then
  ...
  as
    ddp_ib_tbl okl_split_asset_pvt.ib_tbl_type;
    ddx_txdv_tbl okl_split_asset_pvt.txdv_tbl_type;
    ddx_txlv_rec okl_split_asset_pvt.txlv_rec_type;
    ddx_trxv_rec okl_split_asset_pvt.trxv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_split_asset_pvt.create_split_transaction(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_txdv_tbl okl_split_asset_pvt.txdv_tbl_type;
    ddx_txdv_tbl okl_split_asset_pvt.txdv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_split_asset_pvt.update_split_transaction(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_txdv_tbl okl_split_asset_pvt.txdv_tbl_type;
    ddp_txlv_rec okl_split_asset_pvt.txlv_rec_type;
    ddx_cle_tbl okl_split_asset_pvt.cle_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_split_asset_pvt.split_fixed_asset(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_itiv_tbl okl_split_asset_pvt.itiv_tbl_type;
    ddx_itiv_tbl okl_split_asset_pvt.itiv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_split_asset_pvt.create_split_comp_srl_num(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
