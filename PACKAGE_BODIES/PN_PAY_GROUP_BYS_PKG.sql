--------------------------------------------------------
--  DDL for Package Body PN_PAY_GROUP_BYS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PN_PAY_GROUP_BYS_PKG" AS
  --$Header: PNGRPBYB.pls 115.3 2004/02/12 08:33:29 kkhegde noship $

/*===========================================================================+
 | PROCEDURE insert_row
 | DESCRIPTION
 |    inserts row into pn_pay_group_bys
 | SCOPE - PUBLIC
...
CURSOR group_by IS
  ...
  WHERE  GROUP_BY_ID = x_GROUP_BY_ID;

BEGIN

INSERT INTO PN_PAY_GROUP_BYS
(GROUP_BY_ID
,GROUPING_RULE_ID
...
,ATTRIBUTE15)
VALUES
(NVL(x_GROUP_BY_ID, PN_PAY_GROUP_BYS_S.NEXTVAL)
,x_GROUPING_RULE_ID
,x_GROUP_BY_LOOKUP_CODE
,x_LAST_UPDATE_DATE
,x_LAST_UPDATED_BY
,x_CREATION_DATE
,x_CREATED_BY
...
,x_ATTRIBUTE14
,x_ATTRIBUTE15)
RETURNING GROUP_BY_ID INTO x_GROUP_BY_ID;

-- Check if a valid row was inserted
OPEN group_by;
FETCH group_by INTO x_GROUP_BY_ID;

  IF (group_by%NOTFOUND) THEN
    CLOSE group_by;
    RAISE NO_DATA_FOUND;
  END IF;
...
/*===========================================================================+
 ...
 | DESCRIPTION
 |    updates a row in pn_pay_group_bys
 | SCOPE - PUBLIC
 | MODIFICATION HISTORY
 |
 |   15-DEC-2003  Kiran  o Created.
...
UPDATE PN_PAY_GROUP_BYS SET
 GROUPING_RULE_ID     = x_GROUPING_RULE_ID
,GROUP_BY_LOOKUP_CODE = x_GROUP_BY_LOOKUP_CODE
...
/*===========================================================================+
 | PROCEDURE lock_row
 | DESCRIPTION
 |    locks a row in pn_pay_group_bys
 | SCOPE - PUBLIC
 | MODIFICATION HISTORY
 |
 |   15-DEC-2003  Kiran  o Created.
...
CURSOR group_by IS
  ...
  FROM   PN_PAY_GROUP_BYS
  WHERE  GROUP_BY_ID = x_GROUP_BY_ID
  FOR UPDATE OF GROUP_BY_ID NOWAIT;

tlinfo group_by%ROWTYPE;

BEGIN

OPEN group_by;
FETCH group_by INTO tlinfo;
...
IF NOT (tlinfo.GROUP_BY_ID = x_GROUP_BY_ID) THEN
  lock_row_exception('GROUP_BY_ID',tlinfo.GROUP_BY_ID);
END IF;
...
IF NOT ((tlinfo.GROUP_BY_LOOKUP_CODE = x_GROUP_BY_LOOKUP_CODE) OR
   (tlinfo.GROUP_BY_LOOKUP_CODE IS NULL AND x_GROUP_BY_LOOKUP_CODE IS NULL))THEN
  lock_row_exception('GROUP_BY_LOOKUP_CODE',tlinfo.GROUP_BY_LOOKUP_CODE);
END IF;
...
/*===========================================================================+
 ...
 | DESCRIPTION
 |    deletes a row from pn_pay_group_bys
 | SCOPE - PUBLIC
 | MODIFICATION HISTORY
 |
 |   15-DEC-2003  Kiran  o Created.
 +===========================================================================*/
PROCEDURE delete_row(
 x_GROUP_BY_ID          IN            NUMBER) IS

BEGIN

DELETE FROM PN_PAY_GROUP_BYS
WHERE GROUP_BY_ID = x_GROUP_BY_ID;
