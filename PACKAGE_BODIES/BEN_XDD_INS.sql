--------------------------------------------------------
--  DDL for Package Body BEN_XDD_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XDD_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xdd_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure insert_dml(p_rec in out nocopy ben_xdd_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Insert the row into: ben_ext_data_elmt_decd
  --
  insert into ben_ext_data_elmt_decd
  (	ext_data_elmt_decd_id,
	val,
	dcd_val,
	chg_evt_source,
	ext_data_elmt_id,
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_insert(p_rec  in out nocopy ben_xdd_shd.g_rec_type) is
--
  l_proc  varchar2(72) := g_package||'pre_insert';
--
  Cursor C_Sel1 is select ben_ext_data_elmt_decd_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ext_data_elmt_decd_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure post_insert(p_rec in ben_xdd_shd.g_rec_type) is
--
...
--
  ...
  begin
    ...
    --
    create_app_ownerships('EXT_DATA_ELMT_DECD_ID', p_rec.ext_data_elmt_decd_id);
    --
    ben_xdd_rki.after_insert
      (
...
Begin
  ...
  --
  ben_xdd_bus.insert_validate(p_rec);
  --
...
Begin
  ...
  -- p_rec structure.
  --
  hr_utility.set_location(' value ' || p_val , 101);
  hr_utility.set_location('d  value ' ||  p_dcd_val , 101);
  ...
  --
  -- Having converted the arguments into the ben_xdd_rec
  ...
  --
  p_ext_data_elmt_decd_id := l_rec.ext_data_elmt_decd_id;
