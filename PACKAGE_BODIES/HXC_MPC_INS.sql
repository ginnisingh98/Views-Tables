--------------------------------------------------------
--  DDL for Package Body HXC_MPC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_MPC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_mpc_ins.';  -- Global package name
...
Procedure insert_dml
  (p_rec in out nocopy hxc_mpc_shd.g_rec_type
  ) is
--
  l_proc  varchar2(72);
--
Begin
  ...
  --
  -- Insert the row into: hxc_mapping_components
  --

  insert into hxc_mapping_components
...
--
  l_proc  varchar2(72);
--
  Cursor C_Sel1 is select hxc_mapping_components_s.nextval from sys.dual;
--
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.mapping_component_id;
  Close C_Sel1;
  --
  if g_debug then
  	hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  hxc_mpc_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  hxc_mpc_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  hxc_mpc_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hxc_mpc_ins.post_insert
     (p_rec
     );
  --
  if g_debug then
...
Procedure ins
  ...
  ,p_mapping_component_id              out nocopy number
...
Begin
  ...
  --
  p_mapping_component_id := l_rec.mapping_component_id;
