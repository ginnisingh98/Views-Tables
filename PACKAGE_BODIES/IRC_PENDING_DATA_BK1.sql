--------------------------------------------------------
--  DDL for Package Body IRC_PENDING_DATA_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_PENDING_DATA_BK1" as
...
begin
hr_utility.set_location('Entering: IRC_PENDING_DATA_BK1.CREATE_PENDING_DATA_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
irc_pending_data_be1.CREATE_PENDING_DATA_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_PENDING_DATA', 'AP');
hr_utility.set_location(' Leaving: IRC_PENDING_DATA_BK1.CREATE_PENDING_DATA_A', 20);
...
begin
hr_utility.set_location('Entering: IRC_PENDING_DATA_BK1.CREATE_PENDING_DATA_B', 10);
hr_utility.set_location(' Leaving: IRC_PENDING_DATA_BK1.CREATE_PENDING_DATA_B', 20);
end CREATE_PENDING_DATA_B;
