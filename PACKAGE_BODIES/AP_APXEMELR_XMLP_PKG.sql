--------------------------------------------------------
--  DDL for Package Body AP_APXEMELR_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AP_APXEMELR_XMLP_PKG" AS
/* $Header: APXEMELRB.pls 120.0 2007/12/27 07:38:30 vjaganat noship $ */
...
BEGIN
  ...
  /*commented by raj P_SUP_CHOSE := nvl(P_SUP_CHOSE,'All');
  P_LOC_CHOSE := nvl(P_LOC_CHOSE,'All');*/


  P_SUP_CHOSE_m := P_SUP_CHOSE;
  P_LOC_CHOSE_m := P_LOC_CHOSE;


  P_SUP_CHOSE_m := nvl(P_SUP_CHOSE_m,'All');
  P_LOC_CHOSE_m := nvl(P_LOC_CHOSE_m,'All');
