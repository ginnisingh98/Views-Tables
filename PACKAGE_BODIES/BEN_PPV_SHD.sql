--------------------------------------------------------
--  DDL for Package Body BEN_PPV_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PPV_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_ppv_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'PRTL_MO_RT_PRTN_VAL_F_PK') Then
...
Begin
  ...
  If (p_effective_date is null or
      p_prtl_mo_rt_prtn_val_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_prtl_mo_rt_prtn_val_id = g_old_rec.prtl_mo_rt_prtn_val_id and
    ...
    Else
      ...
      If (p_object_version_number <> g_old_rec.object_version_number) Then
        hr_utility.set_message('PAY', 'HR_7155_OBJECT_INVALID');
        hr_utility.raise_error;
      End If;
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_prtl_mo_rt_prtn_val_f',
	 p_base_key_column	   => 'prtl_mo_rt_prtn_val_id',
	 p_base_key_value 	   => p_prtl_mo_rt_prtn_val_id,
	 p_parent_table_name1      => 'ben_actl_prem_f',
	 p_parent_key_column1      => 'actl_prem_id',
	 ...
	 p_parent_table_name3      => 'ben_acty_base_rt_f',
	 p_parent_key_column3      => 'acty_base_rt_id',
	 p_parent_key_value3       => g_old_rec.acty_base_rt_id,
...
Exception
  When HR_Api.Object_Locked then
    ...
    -- error message.
    --
    hr_utility.set_message('PAY', 'HR_7165_OBJECT_LOCKED');
    hr_utility.set_message_token('TABLE_NAME', 'ben_prtl_mo_rt_prtn_val_f');
    hr_utility.raise_error;
...
Begin
  ...
  --
  l_rec.prtl_mo_rt_prtn_val_id           := p_prtl_mo_rt_prtn_val_id;
  l_rec.effective_end_date               := p_effective_end_date;
  l_rec.effective_start_date             := p_effective_start_date;
  l_rec.business_group_id                := p_business_group_id;
  l_rec.rndg_cd                          := p_rndg_cd;
  l_rec.to_dy_mo_num                     := p_to_dy_mo_num;
  l_rec.from_dy_mo_num                   := p_from_dy_mo_num;
  l_rec.pct_val                          := p_pct_val;
  l_rec.acty_base_rt_id                  := p_acty_base_rt_id;
  l_rec.strt_r_stp_cvg_cd                := p_strt_r_stp_cvg_cd;
  l_rec.rndg_rl                          := p_rndg_rl;
  l_rec.prtl_mo_prortn_rl                := p_prtl_mo_prortn_rl;
  l_rec.actl_prem_id                     := p_actl_prem_id;
  l_rec.cvg_amt_calc_mthd_id             := p_cvg_amt_calc_mthd_id;
  l_rec.num_days_month                   := p_num_days_month;
  l_rec.prorate_by_day_to_mon_flag       := p_prorate_by_day_to_mon_flag;
  l_rec.pmrpv_attribute_category         := p_pmrpv_attribute_category;
  l_rec.pmrpv_attribute1                 := p_pmrpv_attribute1;
  l_rec.pmrpv_attribute2                 := p_pmrpv_attribute2;
  l_rec.pmrpv_attribute3                 := p_pmrpv_attribute3;
  l_rec.pmrpv_attribute4                 := p_pmrpv_attribute4;
  l_rec.pmrpv_attribute5                 := p_pmrpv_attribute5;
  l_rec.pmrpv_attribute6                 := p_pmrpv_attribute6;
  l_rec.pmrpv_attribute7                 := p_pmrpv_attribute7;
  l_rec.pmrpv_attribute8                 := p_pmrpv_attribute8;
  l_rec.pmrpv_attribute9                 := p_pmrpv_attribute9;
  l_rec.pmrpv_attribute10                := p_pmrpv_attribute10;
  l_rec.pmrpv_attribute11                := p_pmrpv_attribute11;
  l_rec.pmrpv_attribute12                := p_pmrpv_attribute12;
  l_rec.pmrpv_attribute13                := p_pmrpv_attribute13;
  l_rec.pmrpv_attribute14                := p_pmrpv_attribute14;
  l_rec.pmrpv_attribute15                := p_pmrpv_attribute15;
  l_rec.pmrpv_attribute16                := p_pmrpv_attribute16;
  l_rec.pmrpv_attribute17                := p_pmrpv_attribute17;
  l_rec.pmrpv_attribute18                := p_pmrpv_attribute18;
  l_rec.pmrpv_attribute19                := p_pmrpv_attribute19;
  l_rec.pmrpv_attribute20                := p_pmrpv_attribute20;
  l_rec.pmrpv_attribute21                := p_pmrpv_attribute21;
  l_rec.pmrpv_attribute22                := p_pmrpv_attribute22;
  l_rec.pmrpv_attribute23                := p_pmrpv_attribute23;
  l_rec.pmrpv_attribute24                := p_pmrpv_attribute24;
  l_rec.pmrpv_attribute25                := p_pmrpv_attribute25;
  l_rec.pmrpv_attribute26                := p_pmrpv_attribute26;
  l_rec.pmrpv_attribute27                := p_pmrpv_attribute27;
  l_rec.pmrpv_attribute28                := p_pmrpv_attribute28;
  l_rec.pmrpv_attribute29                := p_pmrpv_attribute29;
  l_rec.pmrpv_attribute30                := p_pmrpv_attribute30;
