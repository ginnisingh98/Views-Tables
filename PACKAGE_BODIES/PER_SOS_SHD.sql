--------------------------------------------------------
--  DDL for Package Body PER_SOS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_SOS_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_sos_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  If (p_solution_id is null and
      p_solution_set_name is null and
  ...
  Else
    If (p_solution_id
        = per_sos_shd.g_old_rec.solution_id and
        p_solution_set_name
        = per_sos_shd.g_old_rec.solution_set_name and
        p_user_id
        = per_sos_shd.g_old_rec.user_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_sos_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_sos_shd.g_old_rec.object_version_number) Then
