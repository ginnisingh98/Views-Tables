--------------------------------------------------------
--  DDL for Package Body OE_2PC1018_BLKTHDR_BLCUSAC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC1018_BLKTHDR_BLCUSAC" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_status_code varchar2(8) :='COMPLETE';
   ...
   AND a.ORDER_NUMBER = OE_LINE_SECURITY.g_record.BLANKET_NUMBER
;
...
BEGIN 
   ...
   Return; 
END Is_Valid;
END OE_2PC1018_BLKTHDR_BLCUSAC;
