--------------------------------------------------------
--  DDL for Package Body OTA_ANNOUNCEMENT_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_ANNOUNCEMENT_SWI" As
/* $Header: otancswi.pkb 115.1 2003/12/30 17:46:54 dhmulia noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'ota_announcement_swi.';
--
-- ----------------------------------------------------------------------------
-- |--------------------------< create_announcement >-------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_announcement_swi;
  --
  ...
  --
  ota_anc_ins.set_base_key_value
    (p_announcement_id => p_announcement_id
    );
  --
  -- Call API
  --
  ota_announcement_api.create_announcement
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_announcement_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_announcement_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  ota_announcement_api.delete_announcement
    (p_validate                     => l_validate
    ,p_announcement_id              => p_announcement_id
    ,p_object_version_number        => p_object_version_number
    );
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_announcement_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
...
PROCEDURE update_announcement
  ...
  --
  -- Other variables
  l_proc    varchar2(72) := g_package ||'update_announcement';
Begin
  hr_utility.set_location(' Entering:' || l_proc,10);
  --
  -- Issue a savepoint
  --
  savepoint update_announcement_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  ota_announcement_api.update_announcement
    (p_validate                     => l_validate
    ,p_effective_date               => p_effective_date
    ,p_announcement_title           => p_announcement_title
    ,p_announcement_body            => p_announcement_body
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_announcement_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
