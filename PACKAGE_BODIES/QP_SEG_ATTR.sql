--------------------------------------------------------
--  DDL for Package Body QP_SEG_ATTR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."QP_SEG_ATTR" AS
/* $Header: QPXASEGB.pls 120.0 2005/06/02 01:31:48 appldev noship $ */

--  Global constant holding the package name

G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'QP_SEG_ATTR';
...
BEGIN
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'AVAILABILITY_IN_BASIC';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 1;
    l_attr_rec.name                := 'availability_in_basic';
    l_attr_rec.code                := 'availability_in_basic';
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'PRC_CONTEXT_ID';
    l_attr_rec.type                := 'NUMBER';
    l_attr_rec.name                := 'prc_context';
    l_attr_rec.code                := 'prc_context_id';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'SEEDED_FORMAT_TYPE';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 1;
    l_attr_rec.name                := 'seeded_format_type';
    l_attr_rec.code                := 'seeded_format_type';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;

    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'SEEDED_PRECEDENCE';
    l_attr_rec.type                := 'NUMBER';
    l_attr_rec.name                := 'seeded_precedence';
    l_attr_rec.code                := 'seeded_precedence';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;

    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'SEEDED_SEGMENT_NAME';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 80;
    l_attr_rec.name                := 'seeded_segment_name';
    l_attr_rec.code                := 'seeded_segment_name';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;

    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'SEEDED_VALUESET_ID';
    l_attr_rec.type                := 'NUMBER';
    l_attr_rec.name                := 'seeded_valueset';
    l_attr_rec.code                := 'seeded_valueset_id';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    l_attr_rec.value               := TRUE;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'SEGMENT_code';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 30;
    l_attr_rec.name                := 'segment_code';
    l_attr_rec.code                := 'segment_code';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'SEGMENT_MAPPING_COLUMN';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 30;
    l_attr_rec.name                := 'segment_mapping_column';
    l_attr_rec.code                := 'segment_mapping_column';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;

    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'USER_FORMAT_TYPE';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 1;
    l_attr_rec.name                := 'user_format_type';
    l_attr_rec.code                := 'user_format_type';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;

    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'USER_PRECEDENCE';
    l_attr_rec.type                := 'NUMBER';
    l_attr_rec.name                := 'user_precedence';
    l_attr_rec.code                := 'user_precedence';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;

    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'USER_SEGMENT_NAME';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 80;
    l_attr_rec.name                := 'user_segment_name';
    l_attr_rec.code                := 'user_segment_name';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;

    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'USER_DESCRIPTION';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 2000;
    l_attr_rec.name                := 'user_description';
    l_attr_rec.code                := 'user_description';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;

    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'SEEDED_DESCRIPTION';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 2000;
    l_attr_rec.name                := 'seeded_description';
    l_attr_rec.code                := 'seeded_description';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;

    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'USER_VALUESET_ID';
    l_attr_rec.type                := 'NUMBER';
    l_attr_rec.name                := 'user_valueset';
    l_attr_rec.code                := 'user_valueset_id';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    l_attr_rec.value               := TRUE;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;
    ...
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 1;
    l_attr_rec.name                := 'required_flag';
    l_attr_rec.code                := 'required_flag';
    l_attr_rec.db_attr             := FALSE;
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;
