--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_POSITION
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_POSITION" as
/*
 * Generated by hr_pump_meta_mapper at: 2018/06/16 10:06:02
 * Generated for API: hr_position_api.create_position
 */
--
...
,I_SECURITY_PROFILE_ID in varchar2 default 'N'
...
,P_COMMENTS
,dc(P_CURRENT_JOB_PROP_END_DATE)
,dc(P_CURRENT_ORG_PROP_END_DATE)
,dc(P_AVAIL_STATUS_PROP_END_DATE)
,dc(P_DATE_END)
,dc(P_EARLIEST_HIRE_DATE)
,dc(P_FILL_BY_DATE)
,P_FREQUENCY
,P_FTE
,P_MAX_PERSONS
...
,nd(P_SECURITY_PROFILE_ID,I_SECURITY_PROFILE_ID)
,P_JOB_NAME
,P_ORGANIZATION_NAME
,P_SHARED_TYPE_NAME
,P_SYSTEM_TYPE_CD
...
decode(l.pval014,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval014,'BARGAINING_UNIT_CODE',d(l.pval007),l.pval009)) p14,
l.pval014 d14,
l.plongval plongval,
decode(l.pval016,cn,dn,vn,dn,d(l.pval016)) p16,
l.pval016 d16,
decode(l.pval017,cn,dn,vn,dn,d(l.pval017)) p17,
l.pval017 d17,
...
decode(l.pval022,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval022,'FREQUENCY',d(l.pval007),l.pval009)) p22,
l.pval022 d22,
decode(l.pval023,cn,nn,vn,nn,n(l.pval023)) p23,
l.pval023 d23,
decode(l.pval024,cn,nn,vn,nn,n(l.pval024)) p24,
l.pval024 d24,
decode(l.pval025,cn,nn,vn,nn,n(l.pval025)) p25,
l.pval025 d25,
decode(l.pval026,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval026,'FREQUENCY',d(l.pval007),l.pval009)) p26,
l.pval026 d26,
decode(l.pval027,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval027,'DAY_CODE',d(l.pval007),l.pval009)) p27,
l.pval027 d27,
decode(l.pval028,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval028,'MONTH_CODE',d(l.pval007),l.pval009)) p28,
l.pval028 d28,
decode(l.pval029,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval029,'YES_NO',d(l.pval007),l.pval009)) p29,
l.pval029 d29,
decode(l.pval030,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval030,'YES_NO',d(l.pval007),l.pval009)) p30,
l.pval030 d30,
decode(l.pval031,cn,vn,vn,'NONE',
 hr_pump_get.gl(l.pval031,'POSITION_TYPE',d(l.pval007),l.pval009)) p31,
l.pval031 d31,
...
decode(l.pval034,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval034,'QUALIFYING_UNITS',d(l.pval007),l.pval009)) p34,
l.pval034 d34,
decode(l.pval035,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval035,'YES_NO',d(l.pval007),l.pval009)) p35,
l.pval035 d35,
decode(l.pval036,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval036,'YES_NO',d(l.pval007),l.pval009)) p36,
l.pval036 d36,
decode(l.pval037,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval037,'YES_NO',d(l.pval007),l.pval009)) p37,
l.pval037 d37,
decode(l.pval038,cn,vn,vn,vn,l.pval038) p38,
l.pval038 d38,
decode(l.pval039,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval039,'POSITION_STATUS',d(l.pval007),l.pval009)) p39,
l.pval039 d39,
decode(l.pval040,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval040,'DAY_CODE',d(l.pval007),l.pval009)) p40,
l.pval040 d40,
decode(l.pval041,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval041,'MONTH_CODE',d(l.pval007),l.pval009)) p41,
l.pval041 d41,
...
l.pval045 d45,
decode(l.pval046,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval046,'YES_NO',d(l.pval007),l.pval009)) p46,
l.pval046 d46,
decode(l.pval047,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval047,'YES_NO',d(l.pval007),l.pval009)) p47,
l.pval047 d47,
decode(l.pval048,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval048,'DAY_CODE',d(l.pval007),l.pval009)) p48,
l.pval048 d48,
decode(l.pval049,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval049,'MONTH_CODE',d(l.pval007),l.pval009)) p49,
l.pval049 d49,
...
l.pval144 d144,
decode(l.pval145,cn,nn,vn,nn,n(l.pval145)) p145,
l.pval145 d145,
decode(l.pval146,cn,nn,vn,nn,n(l.pval146)) p146,
l.pval146 d146,
decode(l.pval147,cn,nn,vn,nn,n(l.pval147)) p147,
l.pval147 d147,
decode(l.pval148,cn,dn,vn,dn,d(l.pval148)) p148,
l.pval148 d148,
decode(l.pval149,cn,nn,vn,HR_SECURITY.GET_SECURITY_PROFILE,n(l.pval149)) p149,
l.pval149 d149,
decode(l.pval150,cn,vn,l.pval150) p150,
decode(l.pval151,cn,vn,l.pval151) p151,
...
(P_ORGANIZATION_NAME => c.p151
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p7
,P_LANGUAGE_CODE => c.p9);
end if;
--
...
(P_SHARED_TYPE_NAME => c.p152
,P_SYSTEM_TYPE_CD => c.p153
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_LANGUAGE_CODE => c.p9);
end if;
--
...
(P_ENTRY_GRADE_RULE_USER_KEY => c.p155);
end if;
--
if c.p156 is null or
c.p9 is null then
L_LOCATION_ID:=nn;
else
L_LOCATION_ID := 
hr_pump_get.get_location_id
(P_LOCATION_CODE => c.p156
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_LANGUAGE_CODE => c.p9);
end if;
--
if c.p157 is null or
c.p7 is null then
L_PAY_FREQ_PAYROLL_ID:=nn;
else
L_PAY_FREQ_PAYROLL_ID := 
hr_pump_get.get_pay_freq_payroll_id
(P_PAY_FREQ_PAYROLL_NAME => c.p157
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p7);
end if;
--
...
(P_PRIOR_POSITION_NAME => c.p158
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p7);
end if;
--
if c.p159 is null or
c.p7 is null then
L_RELIEF_POSITION_ID:=nn;
else
L_RELIEF_POSITION_ID := 
hr_pump_get.get_relief_position_id
(P_RELIEF_POSITION_NAME => c.p159
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p7);
end if;
--
...
(P_SUCCESSOR_POSITION_NAME => c.p161
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p7);
end if;
--
if c.p162 is null or
c.p7 is null then
L_SUPERVISOR_POSITION_ID:=nn;
else
L_SUPERVISOR_POSITION_ID := 
hr_pump_get.get_supervisor_position_id
(P_SUPERVISOR_POSITION_NAME => c.p162
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p7);
end if;
--
if c.p163 is null then
L_PAY_BASIS_ID:=nn;
else
L_PAY_BASIS_ID := 
hr_pump_get.get_pay_basis_id
(P_PAY_BASIS_NAME => c.p163
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID);
end if;
--
...
,P_POSITION_DEFINITION_ID => c.p4
,P_NAME => c.p5
,P_OBJECT_VERSION_NUMBER => c.p6
,P_JOB_ID => L_JOB_ID
,P_ORGANIZATION_ID => L_ORGANIZATION_ID
,P_EFFECTIVE_DATE => c.p7
,P_DATE_EFFECTIVE => c.p8
,P_LANGUAGE_CODE => c.p9
...
,P_POSITION_TRANSACTION_ID => c.p10
...
,P_AMENDMENT_DATE => c.p11
,P_AMENDMENT_RECOMMENDATION => c.p12
,P_AMENDMENT_REF_NUMBER => c.p13
,P_BARGAINING_UNIT_CD => c.p14
,P_COMMENTS => L_COMMENTS
,P_CURRENT_JOB_PROP_END_DATE => c.p16
,P_CURRENT_ORG_PROP_END_DATE => c.p17
,P_AVAIL_STATUS_PROP_END_DATE => c.p18
,P_DATE_END => c.p19
,P_EARLIEST_HIRE_DATE => c.p20
,P_FILL_BY_DATE => c.p21
,P_FREQUENCY => c.p22
,P_FTE => c.p23
,P_MAX_PERSONS => c.p24
,P_OVERLAP_PERIOD => c.p25
,P_OVERLAP_UNIT_CD => c.p26
,P_PAY_TERM_END_DAY_CD => c.p27
,P_PAY_TERM_END_MONTH_CD => c.p28
,P_PERMANENT_TEMPORARY_FLAG => c.p29
,P_PERMIT_RECRUITMENT_FLAG => c.p30
,P_POSITION_TYPE => c.p31
,P_POSTING_DESCRIPTION => c.p32
,P_PROBATION_PERIOD => c.p33
,P_PROBATION_PERIOD_UNIT_CD => c.p34
,P_REPLACEMENT_REQUIRED_FLAG => c.p35
,P_REVIEW_FLAG => c.p36
,P_SEASONAL_FLAG => c.p37
,P_SECURITY_REQUIREMENTS => c.p38
,P_STATUS => c.p39
,P_TERM_START_DAY_CD => c.p40
,P_TERM_START_MONTH_CD => c.p41
,P_TIME_NORMAL_FINISH => c.p42
,P_TIME_NORMAL_START => c.p43
,P_UPDATE_SOURCE_CD => c.p44
,P_WORKING_HOURS => c.p45
,P_WORKS_COUNCIL_APPROVAL_FLAG => c.p46
,P_WORK_PERIOD_TYPE_CD => c.p47
,P_WORK_TERM_END_DAY_CD => c.p48
,P_WORK_TERM_END_MONTH_CD => c.p49
,P_PROPOSED_FTE_FOR_LAYOFF => c.p50
,P_PROPOSED_DATE_FOR_LAYOFF => c.p51
,P_PAY_BASIS_ID => L_PAY_BASIS_ID
,P_SUPERVISOR_ID => L_SUPERVISOR_ID
,P_INFORMATION1 => c.p52
,P_INFORMATION2 => c.p53
,P_INFORMATION3 => c.p54
,P_INFORMATION4 => c.p55
,P_INFORMATION5 => c.p56
,P_INFORMATION6 => c.p57
,P_INFORMATION7 => c.p58
,P_INFORMATION8 => c.p59
,P_INFORMATION9 => c.p60
,P_INFORMATION10 => c.p61
,P_INFORMATION11 => c.p62
,P_INFORMATION12 => c.p63
,P_INFORMATION13 => c.p64
,P_INFORMATION14 => c.p65
,P_INFORMATION15 => c.p66
,P_INFORMATION16 => c.p67
,P_INFORMATION17 => c.p68
,P_INFORMATION18 => c.p69
,P_INFORMATION19 => c.p70
,P_INFORMATION20 => c.p71
,P_INFORMATION21 => c.p72
,P_INFORMATION22 => c.p73
,P_INFORMATION23 => c.p74
,P_INFORMATION24 => c.p75
,P_INFORMATION25 => c.p76
,P_INFORMATION26 => c.p77
,P_INFORMATION27 => c.p78
,P_INFORMATION28 => c.p79
,P_INFORMATION29 => c.p80
,P_INFORMATION30 => c.p81
,P_INFORMATION_CATEGORY => c.p82
,P_ATTRIBUTE1 => c.p83
,P_ATTRIBUTE2 => c.p84
,P_ATTRIBUTE3 => c.p85
,P_ATTRIBUTE4 => c.p86
...
,P_ATTRIBUTE16 => c.p98
,P_ATTRIBUTE17 => c.p99
,P_ATTRIBUTE18 => c.p100
,P_ATTRIBUTE19 => c.p101
,P_ATTRIBUTE20 => c.p102
,P_ATTRIBUTE21 => c.p103
,P_ATTRIBUTE22 => c.p104
,P_ATTRIBUTE23 => c.p105
,P_ATTRIBUTE24 => c.p106
,P_ATTRIBUTE25 => c.p107
,P_ATTRIBUTE26 => c.p108
,P_ATTRIBUTE27 => c.p109
,P_ATTRIBUTE28 => c.p110
,P_ATTRIBUTE29 => c.p111
,P_ATTRIBUTE30 => c.p112
,P_ATTRIBUTE_CATEGORY => c.p113
,P_SEGMENT1 => c.p114
,P_SEGMENT2 => c.p115
,P_SEGMENT3 => c.p116
,P_SEGMENT4 => c.p117
...
,P_SEGMENT29 => c.p142
,P_SEGMENT30 => c.p143
,P_CONCAT_SEGMENTS => c.p144
,P_REQUEST_ID => c.p145
,P_PROGRAM_APPLICATION_ID => c.p146
,P_PROGRAM_ID => c.p147
,P_PROGRAM_UPDATE_DATE => c.p148
,P_SECURITY_PROFILE_ID => c.p149);
