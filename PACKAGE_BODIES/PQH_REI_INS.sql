--------------------------------------------------------
--  DDL for Package Body PQH_REI_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_REI_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_rei_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_role_extra_info_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_role_extra_info_id  in  number) is
--
...
Begin
  ...
  --
  pqh_rei_ins.g_role_extra_info_id_i := p_role_extra_info_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: pqh_role_extra_info
  --
  insert into pqh_role_extra_info
      (role_extra_info_id
      ,role_id
      ,information_type
      ,request_id
...
--
  Cursor C_Sel1 is select pqh_role_extra_info_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from pqh_role_extra_info
     where role_extra_info_id =
             pqh_rei_ins.g_role_extra_info_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (pqh_rei_ins.g_role_extra_info_id_i is not null) Then
    --
    ...
    If C_Sel2%found Then
       ...
       fnd_message.set_token('TABLE_NAME','pqh_role_extra_info');
    ...
    p_rec.role_extra_info_id :=
      pqh_rei_ins.g_role_extra_info_id_i;
    pqh_rei_ins.g_role_extra_info_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.role_extra_info_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  If p_validate then
    ...
    -- Issue the savepoint.
    --
    SAVEPOINT ins_pqh_rei;
  End If;
  --
  --
  -- Call the supporting insert validate operations
  --
  pqh_rei_bus.insert_validate
     (p_rec
     );

  -- Call the supporting pre-insert operation
  --
  pqh_rei_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pqh_rei_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pqh_rei_ins.post_insert
     (p_rec
     );
  --
  --
...
Begin
  ...
  --
  p_role_extra_info_id := l_rec.role_extra_info_id;
