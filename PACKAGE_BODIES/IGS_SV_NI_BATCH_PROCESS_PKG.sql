--------------------------------------------------------
--  DDL for Package Body IGS_SV_NI_BATCH_PROCESS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_SV_NI_BATCH_PROCESS_PKG" AS
/* $Header: IGSSV03B.pls 120.1 2006/05/31 10:01:26 vskumar noship $ */
...
G_PKG_NAME         CONSTANT VARCHAR2(30) := 'IGS_SV_NI_BATCH_PROCESS_PKG';
...
l_prog_label CONSTANT VARCHAR2(500) :='igs.plsql.igs_sv_ni_batch_process_pkg';
...
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Submit_Event';
...
END IF;
  ...
  l_event_key := p_batch_id  || l_con_req_id;
	...
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.event_parameters';
...
BEGIN
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Dump_Current_Person';
  ...
  Put_Log_Msg('****** Execution error - dumping current person *********',0);

  Put_Log_Msg(' person_id '||        p_student_rec.person_id ,0);
  Put_Log_Msg(' form_id   '||        p_student_rec.form_id ,0);
  Put_Log_Msg(' print_form   '||        p_student_rec.print_form ,0);
  Put_Log_Msg(' record_number '||    p_student_rec.record_number ,0);
  Put_Log_Msg(' record_status '||    p_student_rec.record_status ,0);
  Put_Log_Msg(' person_number '||    p_student_rec.person_number ,0);
  Put_Log_Msg(' sevis_user_id '||    p_student_rec.sevis_user_id ,0);
  Put_Log_Msg(' form_id '||          p_student_rec.form_id ,0);
  Put_Log_Msg(' person_status '||    p_student_rec.person_status ,0);
  Put_Log_Msg(' issue_status  '||    p_student_rec.issue_status ,0);
  Put_Log_Msg(' bio_status '||       p_student_rec.bio_status ,0);
  Put_Log_Msg(' other_status '||     p_student_rec.other_status ,0);
  Put_Log_Msg(' f_addr_status '||    p_student_rec.f_addr_status ,0);
  Put_Log_Msg(' us_addr_status '||   p_student_rec.us_addr_status ,0);
  Put_Log_Msg(' edu_status '||       p_student_rec.edu_status ,0);
  Put_Log_Msg(' dep_status '||       p_student_rec.dep_status ,0);
  Put_Log_Msg(' fin_status '||       p_student_rec.fin_status ,0);
  Put_Log_Msg(' dep_count '||        p_student_rec.dep_count ,0);
  Put_Log_Msg(' edu_count '||        p_student_rec.edu_count ,0);
...
/* Debug
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_School_Sevis_Id';
...
/* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Is_Number';
...
BEGIN
 /* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Lookup_Name';
...
/* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Convert_Country_Code';
...
/* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Convert_Visa_Type';
...
BEGIN
  /* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Convert_Suffix';
...
BEGIN
 /* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Block_Name';
...
/* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Person_Sevis_Id';
...
/* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Check_US_Terr';
...
/* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Issue_Info';
...
EXCEPTION
   ...
   WHEN OTHERS THEN
	...
	END IF;
      ...
      Put_Log_Msg(l_api_name||' OTHERS ERROR ',0);
...
FUNCTION Validate_Name(p_Name IN varchar2) RETURN boolean IS
    ...
    /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Name';
...
BEGIN
  ...
  -- 06 J-2
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Bio_Info';
   ...
   ELSE
      ...
      IF Check_US_Terr(p_person_rec.person_number,p_data_rec.citizen_cntry_code) ='E' THEN
        ...
        --Error in the citizenship countries
         ...
         Put_Log_Msg('Error validation citizenship country code',0);
         l_not_valid := TRUE;
      END IF;
...
BEGIN
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Other_Info';
   ...
   IF (c_alternate_id%FOUND) THEN
      ...
      IF Is_Number(p_data_rec.tax_id) = '' THEN
...
BEGIN
   ...
   /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_F_Addr_Info';
...
BEGIN
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_US_Addr_Info';
   ...
   FOR c_addr_rec IN c_addr LOOP
       ...
       p_data_rec(l_counter).primary_flag := c_addr_rec.identifying_address_flag;
...
/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Edu_Info
	  ';
...
BEGIN
	...
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Othr_Prgm_Info';
...
FUNCTION Validate_Prgm_Info (
   ...
   p_auth_drp_data_rec IN OUT NOCOPY IGS_SV_PRGMS_INFO%ROWTYPE
) RETURN VARCHAR2
IS
  ...
  CURSOR c_res IS
   ...
   l_not_valid     BOOLEAN := FALSE;
   l_AUTH_CODE     VARCHAR2(2);
   l_AUTH_START_DT DATE;
   l_AUTH_END_DT   DATE;
   l_COMMENTS      VARCHAR2(500);
   l_visa_type VARCHAR(5);
...
BEGIN
	...
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Prgm_Info';
...
--   p_data_rec.batch_id := NULL;  -- This will tell us if there's been any records found
   IF p_person_rec.batch_type = 'I' THEN
     ...
     --  Check for drop below FC
      --mmkumar, auth_drop_below
     /*
     p_auth_drp_data_rec.prgm_action_type := '';

     IF IGS_EN_SEVIS.ENRF_GET_SEVIS_AUTH_DETAILS(
           p_person_id     => p_person_rec.person_id,
           p_auth_code     => l_auth_code,
           p_auth_start_dt => l_auth_start_dt,
           p_auth_end_dt   => l_auth_end_dt,
           p_comments      => l_comments )

      THEN

        p_auth_drp_data_rec.prgm_action_type :='DB';
	p_auth_drp_data_rec.authorization_reason := l_auth_code;
	p_auth_drp_data_rec.prgm_start_date := to_char(l_auth_start_dt,'YYYY-MM-DD');
        p_auth_drp_data_rec.prgm_end_date := to_char(l_auth_end_dt,'YYYY-MM-DD');
        p_auth_drp_data_rec.remarks := l_comments;



        FOR c_drp_rec IN c_drp LOOP

	  l_auth_rec_count := l_auth_rec_count +1;	-- prbhardw CP enhancement
	  IF l_cancel_flag <> 'Y' THEN
		  IF c_drp_rec.authorization_reason
		     ...
		     p_auth_drp_data_rec.auth_action_code := 'EDIT';
		     -- already reported.
		   ...
		   END IF;
	  ELSE
	       p_auth_drp_data_rec.auth_action_code := 'CANCEL';
	  END IF;

        END LOOP;
	IF l_auth_rec_count = 0 THEN
	      p_auth_drp_data_rec.auth_action_code := 'ADD';
	END IF;
...
BEGIN
   ...
   /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Finance_Info';
...
/******************************************************************
   ...
   Change History
   Who                  When            What
   vskumar		26-May-06	xbuild3 performance fix. replace sql query used igs_person_base_v view rather igs_pe_person.
------------------------------------------------------------------------
...
BEGIN
   ...
   /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Dependent_Info';
...
/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Convictions_Info';
...
/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Legal_Info';
...
/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_ev_Legal_Info';
...
BEGIN
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Empl_Info';
...
EXCEPTION
   ...
   WHEN FND_API.G_EXC_ERROR THEN
	...
	END IF;
      ...
      Put_Log_Msg(l_api_name||' EXEC ERROR ',0);
      RETURN 'U';
...
IS
 ...
 BEGIN
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.validate_employment_Info';
...
BEGIN
	...
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Validate_Empl_Info';
...
BEGIN
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Issue_Info';
...
BEGIN
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Bio_Info';
...
/* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Other_Info';
...
BEGIN
   ...
   /* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Address_Info';
...
BEGIN
   ...
   /* Debug */
IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Edu_Info';
...
BEGIN
   ...
   Put_Log_Msg(l_api_name||' begins ',0);
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Finance_Info';
...
BEGIN
   /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Dependent_Info';
...
BEGIN
   ...
   Put_Log_Msg(l_api_name||' begins ',0);
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_Legal_Info';
     ...
     IF p_edu_type = 'PRGM' THEN
	  IF p_data_rec.prgm_action_type = 'C' THEN
	   ...
	   ELSIF p_data_rec.prgm_action_type = 'S' OR p_data_rec.prgm_action_type = 'SP' THEN
	      l_action := 'SHORTEN';
	      l_tag_code := 'SV_PRGMS';
	   ELSIF p_data_rec.prgm_action_type = 'EP' THEN
	      l_action := 'EDIT';
	      l_tag_code := 'SV_PRGMS';
	   ...
	   ELSIF p_data_rec.prgm_action_type = 'ED' THEN
	      l_action := 'END';
	      l_tag_code := 'SV_STATUS';
	   ELSIF p_data_rec.prgm_action_type = 'DB' THEN
	      l_action := p_data_rec.auth_action_code;
...
END IF;
   ...
   ELSIF p_person_rec.legal_status = 'U' THEN --Unexpected error - terminate execution
      ...
      Put_Log_Msg('Unexpected error returned by validation ',0);
      /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Update_Registration_Info';
	...
	END IF;
     ...
     -- Update session dates for the main record required.
      ...
      IF p_person_rec.f_addr_status  = 'E' THEN -- Validation error - mark person as invalid
        ...
        Put_Log_Msg('Validation error occurs - return S ',0);
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Update_Registration_Info';
	   l_debug_str := 'Returning S from Update_Registration_Info.';
...
EXCEPTION
   ...
   WHEN FND_API.G_EXC_ERROR THEN
      ...
      Put_Log_Msg(l_api_name||' EXEC_ERROR returns U',0);
      /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Update_Registration_Info';
   ...
   WHEN OTHERS THEN
      ...
      Put_Log_Msg(l_api_name||' OTHERS return U',0);
      /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Update_Registration_Info';
...
END IF;
   ...
   ELSIF p_person_rec.legal_status = 'S' THEN
	...
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Previous_Legal_Info';
	...
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Current_Legal_Info';
...
END IF;
   ...
   IF p_person_rec.bio_status = 'E'
      ...
      Put_Log_Msg('UPI - Validation error occurs ',0);
      /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Update_Personal_Info';
   ...
   IF ( p_person_rec.bio_status = 'U'
      ...
      Put_Log_Msg('UPI - unexpected error returned by validation ',0);
      /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Update_Personal_Info';
   ...
   ELSIF p_person_rec.bio_status = 'N' THEN -- Not found
      ...
      Put_Log_Msg('UPI BIO block is not found ',0);
      /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Update_Personal_Info';
...
IS
   ...
   BEGIN
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_EV_Prgm_Info';
...
IS
   ...
   BEGIN
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Get_nonimg_Prgm_Info';
...
--manoj stars
	...
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Previous_Dependent_Info';
	...
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	  l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Current_Dependent_Info';
...
FOR l_current IN 1.. l_count LOOP
	...
	/* Debug */
      ...
      ELSIF  l_status = 'S' THEN
	    ...
	    IF l_cur_rec(l_current).action_code IN ('N','A') THEN
	        l_cur_rec(l_current).action_code := 'A';  -- add
	    ELSE
	        l_cur_rec(l_current).action_code := 'C';  -- cancel
	    END IF;

            IF l_cur_rec(l_current).action_code <> l_prev_rec.action_code THEN
		  p_person_rec.empl_status := 'C';  -- Changed
                  p_person_rec.changes_found := 'Y';
	    ELSE
...
BEGIN
    /* Debug */
    IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
       l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Remove_Person_Data';
...
BEGIN
   ...
   /* Debug */
   IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
      l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.EV_Batch_Process';
...
BEGIN
	/* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Create_Batch';
   ...
   LOOP			-- prbhardw
	...
	END IF;
     /*FETCH c_student_list INTO
	  ...
	  IF g_create_count = 250 OR g_update_count = 250 THEN
	       ...
	       IF g_create_count = 250 THEN	-- prbhardw CP enhancement
	...
	END IF;
      ...
      Put_Log_Msg('',1);
      Put_Log_Msg('*******************Next person '||l_student_rec.person_number||'**************************',0);
	 ...
	 IF dso_id IS NULL THEN
	       OPEN c_get_dso_id(l_student_rec.person_id);
	       FETCH c_get_dso_id INTO dso_id;
	       CLOSE c_get_dso_id;
	 END IF;
	 /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
...
BEGIN
   /* Debug */
  IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
     l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.NIMG_Batch_Process';
...
BEGIN
   ...
   /* Debug */
     IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
       l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Purge_Batch';
...
BEGIN
   /* Debug */
  IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
     l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.EV_Purge_Batch';
...
BEGIN
   ...
   /* Debug */
     IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
        l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.NIMG_Purge_Batch';
...
BEGIN
   /* Debug */
     IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
        l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Generate_Message';
...
BEGIN
    /* Debug */
     IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
        l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.process_person_record';
...
BEGIN
     ...
     IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
        l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.process_trans_header';
...
BEGIN
     ...
     IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
        l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.process_student_record';
...
BEGIN
     IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
        l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.process_dep_record';
...
IS
 ...
 BEGIN
       /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.Generate_Batch_XML';
	   l_debug_str := 'Batch_id for Generate_Batch_XML: '||batch_id;
	   fnd_log.string_with_context( fnd_log.level_statement,l_label,l_debug_str, NULL,NULL,NULL,NULL,NULL,NULL);
	END IF;
      Put_Log_Msg('Batch_id for Generate_Batch_XML: '||batch_id, 0);
...
BEGIN
  ...
  FOR i IN 1..g_parallel_batches.COUNT LOOP
     ...
     Put_Log_Msg('  ' || g_parallel_batches(i) || '   :  ' || l_per_count,0);
  ...
  FOR i IN 1..g_running_batches.COUNT LOOP
     ...
     FETCH c_persons_per_batch INTO l_per_count;
     CLOSE c_persons_per_batch;
     Put_Log_Msg('  ' || g_running_batches(i) || '   :  ' || l_per_count,0);
     l_batch_count := l_batch_count+1;
  END LOOP;
  ...
  --   Put_Log_Msg('  ------------------------',0);
   ...
   --  Put_Log_Msg('        Person Number			Information ',0);
     ...
     FOR new_persons IN c_get_new_persons(g_parallel_batches(i)) LOOP
          Put_Log_Msg('        ' || rpad(new_persons.prsn_num,30,' ') || '             ' || new_persons.info,0);
     END LOOP;
  ...
  FOR i IN 1..g_running_batches.COUNT LOOP
     Put_Log_Msg('  Batch ID: ' || g_running_batches(i),0);
     Put_Log_Msg('  ------------------------',0);
     fnd_message.set_name('IGS','IGS_SV_NEW_PERS');
     fnd_file.put_line(fnd_file.log,'     ' || fnd_message.get());
   --  Put_Log_Msg('     New Persons: ',0);
...
EXCEPTION
  ...
  WHEN OTHERS THEN
      ...
      /* Debug */
	IF fnd_log.test(fnd_log.level_statement,l_prog_label) THEN
	   l_label := 'igs.plsql.igs_sv_ni_batch_process_pkg.compose_log_file';
