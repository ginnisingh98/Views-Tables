--------------------------------------------------------
--  DDL for Package Body BEN_LOS_FACTORS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LOS_FACTORS_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_LOS_FACTORS_BK2.UPDATE_LOS_FACTORS_A', 10);
hr_utility.set_location(' Leaving: BEN_LOS_FACTORS_BK2.UPDATE_LOS_FACTORS_A', 20);
end UPDATE_LOS_FACTORS_A;
...
begin
hr_utility.set_location('Entering: BEN_LOS_FACTORS_BK2.UPDATE_LOS_FACTORS_B', 10);
hr_utility.set_location(' Leaving: BEN_LOS_FACTORS_BK2.UPDATE_LOS_FACTORS_B', 20);
end UPDATE_LOS_FACTORS_B;
