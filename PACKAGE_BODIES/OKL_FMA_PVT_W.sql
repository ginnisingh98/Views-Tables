--------------------------------------------------------
--  DDL for Package Body OKL_FMA_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_FMA_PVT_W" as
  /* $Header: OKLIFMAB.pls 120.1 2005/07/12 07:05:00 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_fma_pvt.fma_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).there_can_be_only_one_yn := a3(indx);
          t(ddindx).cgr_id := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).fyp_code := a5(indx);
          t(ddindx).version := a6(indx);
          t(ddindx).formula_string := a7(indx);
  ...
  procedure rosetta_table_copy_out_p2(t okl_fma_pvt.fma_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a31 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a3(indx) := t(ddindx).there_can_be_only_one_yn;
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).cgr_id);
          a5(indx) := t(ddindx).fyp_code;
          a6(indx) := t(ddindx).version;
          a7(indx) := t(ddindx).formula_string;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_fma_pvt.okl_formulae_tl_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p5(t okl_fma_pvt.okl_formulae_tl_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_in_p8(t out nocopy okl_fma_pvt.fmav_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_VARCHAR2_TABLE_100
    , a3 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).cgr_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).fyp_code := a4(indx);
          t(ddindx).name := a5(indx);
          t(ddindx).formula_string := a6(indx);
          ...
          t(ddindx).there_can_be_only_one_yn := a28(indx);
  ...
  procedure rosetta_table_copy_out_p8(t okl_fma_pvt.fmav_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a33 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).cgr_id);
          a4(indx) := t(ddindx).fyp_code;
          a5(indx) := t(ddindx).name;
          a6(indx) := t(ddindx).formula_string;
          ...
          a28(indx) := t(ddindx).there_can_be_only_one_yn;
  ...
  as
    ddp_fmav_rec okl_fma_pvt.fmav_rec_type;
    ddx_fmav_rec okl_fma_pvt.fmav_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_fma_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_fmav_tbl okl_fma_pvt.fmav_tbl_type;
    ddx_fmav_tbl okl_fma_pvt.fmav_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_fma_pvt_w.rosetta_table_copy_in_p8(ddp_fmav_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_fma_pvt_w.rosetta_table_copy_out_p8(ddx_fmav_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fma_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fma_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fma_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fma_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
