--------------------------------------------------------
--  DDL for Package Body BEN_PLAN_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PLAN_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_PLAN_BK2.UPDATE_PLAN_A', 10);
hr_utility.set_location(' Leaving: BEN_PLAN_BK2.UPDATE_PLAN_A', 20);
end UPDATE_PLAN_A;
procedure UPDATE_PLAN_B
(P_PL_ID in NUMBER
,P_NAME in VARCHAR2
,P_ALWS_QDRO_FLAG in VARCHAR2
,P_ALWS_QMCSO_FLAG in VARCHAR2
...
begin
hr_utility.set_location('Entering: BEN_PLAN_BK2.UPDATE_PLAN_B', 10);
hr_utility.set_location(' Leaving: BEN_PLAN_BK2.UPDATE_PLAN_B', 20);
end UPDATE_PLAN_B;
end BEN_PLAN_BK2;
