--------------------------------------------------------
--  DDL for Package Body OKL_POV_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_POV_PVT_W" as
  /* $Header: OKLIPOVB.pls 115.7 2002/12/24 04:08:38 sgorantl noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_pov_pvt.pov_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_DATE_TABLE
    , a4 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ove_id := rosetta_g_miss_num_map(a1(indx));
          t(ddindx).pon_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).from_date := rosetta_g_miss_date_in_map(a3(indx));
          t(ddindx).to_date := rosetta_g_miss_date_in_map(a4(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_pov_pvt.pov_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a10 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := rosetta_g_miss_num_map(t(ddindx).ove_id);
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).pon_id);
          a3(indx) := t(ddindx).from_date;
          a4(indx) := t(ddindx).to_date;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_pov_pvt.povv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ove_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).pon_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).from_date := rosetta_g_miss_date_in_map(a4(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_pov_pvt.povv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    ...
    a10 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).ove_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).pon_id);
          a4(indx) := t(ddindx).from_date;
  ...
  as
    ddp_povv_rec okl_pov_pvt.povv_rec_type;
    ddx_povv_rec okl_pov_pvt.povv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_pov_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_povv_tbl okl_pov_pvt.povv_tbl_type;
    ddx_povv_tbl okl_pov_pvt.povv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pov_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pov_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pov_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pov_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
