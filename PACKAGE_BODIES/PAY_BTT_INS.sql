--------------------------------------------------------
--  DDL for Package Body PAY_BTT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_BTT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_btt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure insert_dml
  (p_rec in out nocopy pay_btt_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Insert the row into: pay_balance_types_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.balance_type_id                  := p_balance_type_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  begin
    --
     hr_utility.set_location('Entering:'||l_proc||p_rec.balance_type_id||' : '||p_rec.balance_name||' : '||p_rec.reporting_name, 6);
    pay_btt_rki.after_insert
...
Begin
  ...
  -- Insert the row
  --
  pay_btt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pay_btt_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
