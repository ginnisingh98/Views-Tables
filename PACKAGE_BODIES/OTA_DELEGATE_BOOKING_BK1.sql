--------------------------------------------------------
--  DDL for Package Body OTA_DELEGATE_BOOKING_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_DELEGATE_BOOKING_BK1" as
...
begin
hr_utility.set_location('Entering: OTA_DELEGATE_BOOKING_BK1.CREATE_DELEGATE_BOOKING_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
ota_delegate_booking_be1.CREATE_DELEGATE_BOOKING_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_DELEGATE_BOOKING', 'AP');
hr_utility.set_location(' Leaving: OTA_DELEGATE_BOOKING_BK1.CREATE_DELEGATE_BOOKING_A', 20);
...
begin
hr_utility.set_location('Entering: OTA_DELEGATE_BOOKING_BK1.CREATE_DELEGATE_BOOKING_B', 10);
hr_utility.set_location(' Leaving: OTA_DELEGATE_BOOKING_BK1.CREATE_DELEGATE_BOOKING_B', 20);
end CREATE_DELEGATE_BOOKING_B;
