--------------------------------------------------------
--  DDL for Package Body BEN_DESIGN_RQMT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DESIGN_RQMT_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_DESIGN_RQMT_BK1.CREATE_DESIGN_RQMT_A', 10);
hr_utility.set_location(' Leaving: BEN_DESIGN_RQMT_BK1.CREATE_DESIGN_RQMT_A', 20);
end CREATE_DESIGN_RQMT_A;
...
begin
hr_utility.set_location('Entering: BEN_DESIGN_RQMT_BK1.CREATE_DESIGN_RQMT_B', 10);
hr_utility.set_location(' Leaving: BEN_DESIGN_RQMT_BK1.CREATE_DESIGN_RQMT_B', 20);
end CREATE_DESIGN_RQMT_B;
