--------------------------------------------------------
--  DDL for Package Body PQH_BUDGETS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_BUDGETS_BK1" as
...
begin
hr_utility.set_location('Entering: PQH_BUDGETS_BK1.CREATE_BUDGET_A', 10);
hr_utility.set_location(' Leaving: PQH_BUDGETS_BK1.CREATE_BUDGET_A', 20);
end CREATE_BUDGET_A;
...
begin
hr_utility.set_location('Entering: PQH_BUDGETS_BK1.CREATE_BUDGET_B', 10);
hr_utility.set_location(' Leaving: PQH_BUDGETS_BK1.CREATE_BUDGET_B', 20);
end CREATE_BUDGET_B;
end PQH_BUDGETS_BK1;
