--------------------------------------------------------
--  DDL for Package Body PQH_COPY_ENTITY_ATTRIBS_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_COPY_ENTITY_ATTRIBS_SWI" As
/* $Header: pqceaswi.pkb 115.0 2003/07/30 11:42 rpasapul noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'pqh_copy_entity_attribs_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_copy_entity_attrib_swi;
  --
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_copy_entity_attrib_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_copy_entity_attrib_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_copy_entity_attrib_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_copy_entity_attrib_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_copy_entity_attrib_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
