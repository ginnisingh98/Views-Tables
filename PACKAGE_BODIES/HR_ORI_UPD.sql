--------------------------------------------------------
--  DDL for Package Body HR_ORI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ORI_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_ori_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Update the hr_organization_information Row
  --
...
Begin
  ...
  --
  If (p_rec.org_information_context = hr_api.g_varchar2) then
    p_rec.org_information_context :=
    hr_ori_shd.g_old_rec.org_information_context;
  End If;
  If (p_rec.organization_id = hr_api.g_number) then
    ...
    hr_ori_shd.g_old_rec.organization_id;
  End If;
  If (p_rec.org_information1 = hr_api.g_varchar2) then
    p_rec.org_information1 :=
    hr_ori_shd.g_old_rec.org_information1;
  End If;
  If (p_rec.org_information10 = hr_api.g_varchar2) then
    p_rec.org_information10 :=
    hr_ori_shd.g_old_rec.org_information10;
  End If;
  If (p_rec.org_information11 = hr_api.g_varchar2) then
    p_rec.org_information11 :=
    hr_ori_shd.g_old_rec.org_information11;
  End If;
  If (p_rec.org_information12 = hr_api.g_varchar2) then
    p_rec.org_information12 :=
    hr_ori_shd.g_old_rec.org_information12;
  End If;
  If (p_rec.org_information13 = hr_api.g_varchar2) then
    p_rec.org_information13 :=
    hr_ori_shd.g_old_rec.org_information13;
  End If;
  If (p_rec.org_information14 = hr_api.g_varchar2) then
    p_rec.org_information14 :=
    hr_ori_shd.g_old_rec.org_information14;
  End If;
  If (p_rec.org_information15 = hr_api.g_varchar2) then
    p_rec.org_information15 :=
    hr_ori_shd.g_old_rec.org_information15;
  End If;
  If (p_rec.org_information16 = hr_api.g_varchar2) then
    p_rec.org_information16 :=
    hr_ori_shd.g_old_rec.org_information16;
  End If;
  If (p_rec.org_information17 = hr_api.g_varchar2) then
    p_rec.org_information17 :=
    hr_ori_shd.g_old_rec.org_information17;
  End If;
  If (p_rec.org_information18 = hr_api.g_varchar2) then
    p_rec.org_information18 :=
    hr_ori_shd.g_old_rec.org_information18;
  End If;
  If (p_rec.org_information19 = hr_api.g_varchar2) then
    p_rec.org_information19 :=
    hr_ori_shd.g_old_rec.org_information19;
  End If;
  If (p_rec.org_information2 = hr_api.g_varchar2) then
    p_rec.org_information2 :=
    hr_ori_shd.g_old_rec.org_information2;
  End If;
  If (p_rec.org_information20 = hr_api.g_varchar2) then
    p_rec.org_information20 :=
    hr_ori_shd.g_old_rec.org_information20;
  End If;
  If (p_rec.org_information3 = hr_api.g_varchar2) then
    p_rec.org_information3 :=
    hr_ori_shd.g_old_rec.org_information3;
  End If;
  If (p_rec.org_information4 = hr_api.g_varchar2) then
    p_rec.org_information4 :=
    hr_ori_shd.g_old_rec.org_information4;
  End If;
  If (p_rec.org_information5 = hr_api.g_varchar2) then
    p_rec.org_information5 :=
    hr_ori_shd.g_old_rec.org_information5;
  End If;
  If (p_rec.org_information6 = hr_api.g_varchar2) then
    p_rec.org_information6 :=
    hr_ori_shd.g_old_rec.org_information6;
  End If;
  If (p_rec.org_information7 = hr_api.g_varchar2) then
    p_rec.org_information7 :=
    hr_ori_shd.g_old_rec.org_information7;
  End If;
  If (p_rec.org_information8 = hr_api.g_varchar2) then
    p_rec.org_information8 :=
    hr_ori_shd.g_old_rec.org_information8;
  End If;
  If (p_rec.org_information9 = hr_api.g_varchar2) then
    p_rec.org_information9 :=
    hr_ori_shd.g_old_rec.org_information9;
  End If;
...
Procedure upd
  ...
  ,p_org_information_context      in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_organization_id              in     number     -- default hr_api.g_number --r115.21
  ,p_org_information1             in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information10            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information11            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information12            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information13            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information14            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information15            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information16            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information17            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information18            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information19            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information2             in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information20            in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information3             in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information4             in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information5             in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information6             in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information7             in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information8             in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_org_information9             in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute_category           in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute1                   in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute2                   in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute3                   in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute4                   in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute5                   in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute6                   in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute7                   in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute8                   in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute9                   in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute10                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute11                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute12                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute13                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute14                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute15                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute16                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute17                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute18                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute19                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ,p_attribute20                  in     varchar2 -- r115.21   -- default hr_api.g_varchar2 -- r115.21
  ) is
--
