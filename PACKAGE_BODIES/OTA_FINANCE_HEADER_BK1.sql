--------------------------------------------------------
--  DDL for Package Body OTA_FINANCE_HEADER_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_FINANCE_HEADER_BK1" as
...
begin
hr_utility.set_location('Entering: OTA_FINANCE_HEADER_BK1.CREATE_FINANCE_HEADER_A', 10);
hr_utility.set_location(' Leaving: OTA_FINANCE_HEADER_BK1.CREATE_FINANCE_HEADER_A', 20);
end CREATE_FINANCE_HEADER_A;
...
begin
hr_utility.set_location('Entering: OTA_FINANCE_HEADER_BK1.CREATE_FINANCE_HEADER_B', 10);
hr_utility.set_location(' Leaving: OTA_FINANCE_HEADER_BK1.CREATE_FINANCE_HEADER_B', 20);
end CREATE_FINANCE_HEADER_B;
