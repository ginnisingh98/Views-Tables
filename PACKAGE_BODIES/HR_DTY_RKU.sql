--------------------------------------------------------
--  DDL for Package Body HR_DTY_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DTY_RKU" as
...
begin
hr_utility.set_location('Entering: HR_DTY_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: HR_DTY_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end HR_DTY_RKU;
