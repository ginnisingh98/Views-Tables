--------------------------------------------------------
--  DDL for Package Body OTA_SKILL_PROVISION_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_SKILL_PROVISION_BK1" as
...
begin
hr_utility.set_location('Entering: OTA_SKILL_PROVISION_BK1.CREATE_SKILL_PROVISION_A', 10);
hr_utility.set_location(' Leaving: OTA_SKILL_PROVISION_BK1.CREATE_SKILL_PROVISION_A', 20);
end CREATE_SKILL_PROVISION_A;
...
begin
hr_utility.set_location('Entering: OTA_SKILL_PROVISION_BK1.CREATE_SKILL_PROVISION_B', 10);
hr_utility.set_location(' Leaving: OTA_SKILL_PROVISION_BK1.CREATE_SKILL_PROVISION_B', 20);
end CREATE_SKILL_PROVISION_B;
