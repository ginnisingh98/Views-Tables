--------------------------------------------------------
--  DDL for Package Body BEN_APR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_APR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_apr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.actl_prem_id       = p_rec.actl_prem_id
    and    t.effective_start_date =
             ben_apr_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_actl_prem_f.created_by%TYPE;
  l_creation_date       ben_actl_prem_f.creation_date%TYPE;
  l_last_update_date   	ben_actl_prem_f.last_update_date%TYPE;
  l_last_updated_by     ben_actl_prem_f.last_updated_by%TYPE;
  l_last_update_login   ben_actl_prem_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_actl_prem_f
  --
  insert into ben_actl_prem_f
  (	actl_prem_id,
  ...
  (	p_rec.actl_prem_id,
	...
	p_rec.rndg_rl,
        p_rec.val_calc_rl,
	p_rec.prem_asnmt_cd,
	p_rec.prem_asnmt_lvl_cd,
	p_rec.actl_prem_typ_cd,
	p_rec.prem_pyr_cd,
	p_rec.cr_lkbk_val,
	p_rec.cr_lkbk_uom,
	p_rec.cr_lkbk_crnt_py_only_flag,
	p_rec.prsptv_r_rtsptv_cd,
	p_rec.upr_lmt_val,
...
--
  ...
  cursor c1 is select ben_actl_prem_f_s.nextval
               from   sys.dual;
--
--
--
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.actl_prem_id;
  close c1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
--	 p_parent_key_value1       => p_rec.comp_lvl_fctr_id,
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_apr_rec
  ...
  --
  p_actl_prem_id        	:= l_rec.actl_prem_id;
