--------------------------------------------------------
--  DDL for Package Body PQH_CEC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_CEC_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqh_cec_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the pqh_copy_entity_contexts Row
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy pqh_cec_shd.g_rec_type) is
--
...
Begin
  ...
  If (p_rec.application_short_name = hr_api.g_varchar2) then
    ...
    pqh_cec_shd.g_old_rec.application_short_name;
  End If;
  If (p_rec.legislation_code = hr_api.g_varchar2) then
    p_rec.legislation_code :=
    pqh_cec_shd.g_old_rec.legislation_code;
  End If;
  If (p_rec.responsibility_key = hr_api.g_varchar2) then
    p_rec.responsibility_key :=
    pqh_cec_shd.g_old_rec.responsibility_key;
  End If;
  If (p_rec.transaction_short_name = hr_api.g_varchar2) then
    p_rec.transaction_short_name :=
    pqh_cec_shd.g_old_rec.transaction_short_name;
  End If;
