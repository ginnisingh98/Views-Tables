--------------------------------------------------------
--  DDL for Package Body POS_WINDOW_SV
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."POS_WINDOW_SV" AS
/* $Header: POSWNDWB.pls 115.3 1999/11/30 12:19:46 pkm ship   $ */
  ...
  BEGIN
    ...
    htp.p('<SCRIPT>
           ...
           top.getTop().FND_MESSAGES["ICX_POS_BTN_CANCEL"] + "</title>")
           </SCRIPT>');
  ...
  function drawMe(doc)
  {
    ...
    var htmlString = "<html>" +
                     ...
                     "</td><td valign=center><font class=datablack>" +
                          top.getTop().FND_MESSAGES[''ICX_POS_CANCEL_WARN''] +
    ...
    htp.p('	  <frame src="' || l_script_name ||
          '/pos_window_sv.buildbuttons?p_button1Name=ICX_POS_DISCARD&p_button1Function=discard()&p_button2Name=&p_button2Function=&p_button3Name=ICX_POS_CONTINUE_WORKING&p_button3Function=continueWork(top)"');
