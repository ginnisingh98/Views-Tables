--------------------------------------------------------
--  DDL for Package Body HR_ASSIGNMENT_BKO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ASSIGNMENT_BKO" as
...
begin
hr_utility.set_location('Entering: HR_ASSIGNMENT_BKO.UPDATE_CWK_ASG_CRITERIA_A', 10);
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_CWK_ASG_CRITERIA', 'AP');
hr_utility.set_location(' Leaving: HR_ASSIGNMENT_BKO.UPDATE_CWK_ASG_CRITERIA_A', 20);
...
begin
hr_utility.set_location('Entering: HR_ASSIGNMENT_BKO.UPDATE_CWK_ASG_CRITERIA_B', 10);
hr_utility.set_location(' Leaving: HR_ASSIGNMENT_BKO.UPDATE_CWK_ASG_CRITERIA_B', 20);
