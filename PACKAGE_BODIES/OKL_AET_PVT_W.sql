--------------------------------------------------------
--  DDL for Package Body OKL_AET_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AET_PVT_W" as
  /* $Header: OKLIAETB.pls 120.2 2005/12/02 12:56:41 dkagrawa noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_aet_pvt.aet_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        ddindx := 1;
        while true loop
          t(ddindx).accounting_event_id := rosetta_g_miss_num_map(a0(indx));
          t(ddindx).org_id := rosetta_g_miss_num_map(a1(indx));
          t(ddindx).event_type_code := a2(indx);
          t(ddindx).accounting_date := rosetta_g_miss_date_in_map(a3(indx));
          t(ddindx).event_number := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).event_status_code := a5(indx);
          t(ddindx).source_id := rosetta_g_miss_num_map(a6(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_aet_pvt.aet_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  if t is null or t.count = 0 then
    ...
    a17 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        indx := 1;
        while true loop
          a0(indx) := rosetta_g_miss_num_map(t(ddindx).accounting_event_id);
          a1(indx) := rosetta_g_miss_num_map(t(ddindx).org_id);
          a2(indx) := t(ddindx).event_type_code;
          a3(indx) := t(ddindx).accounting_date;
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).event_number);
          a5(indx) := t(ddindx).event_status_code;
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).source_id);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_aet_pvt.aetv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).event_type_code := a3(indx);
          t(ddindx).accounting_date := rosetta_g_miss_date_in_map(a4(indx));
          t(ddindx).event_number := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).event_status_code := a6(indx);
          t(ddindx).source_id := rosetta_g_miss_num_map(a7(indx));
          t(ddindx).source_table := a8(indx);
          t(ddindx).program_id := rosetta_g_miss_num_map(a9(indx));
          t(ddindx).program_application_id := rosetta_g_miss_num_map(a10(indx));
          t(ddindx).program_update_date := rosetta_g_miss_date_in_map(a11(indx));
          t(ddindx).request_id := rosetta_g_miss_num_map(a12(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_aet_pvt.aetv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    ...
    a17 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a3(indx) := t(ddindx).event_type_code;
          a4(indx) := t(ddindx).accounting_date;
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).event_number);
          a6(indx) := t(ddindx).event_status_code;
          a7(indx) := rosetta_g_miss_num_map(t(ddindx).source_id);
          a8(indx) := t(ddindx).source_table;
          a9(indx) := rosetta_g_miss_num_map(t(ddindx).program_id);
          a10(indx) := rosetta_g_miss_num_map(t(ddindx).program_application_id);
          a11(indx) := t(ddindx).program_update_date;
          a12(indx) := rosetta_g_miss_num_map(t(ddindx).request_id);
  ...
  as
    ddp_aetv_rec okl_aet_pvt.aetv_rec_type;
    ddx_aetv_rec okl_aet_pvt.aetv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  as
    ddp_aetv_tbl okl_aet_pvt.aetv_tbl_type;
    ddx_aetv_tbl okl_aet_pvt.aetv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_aet_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_aet_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_aet_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_aet_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
