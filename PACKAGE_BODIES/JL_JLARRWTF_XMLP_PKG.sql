--------------------------------------------------------
--  DDL for Package Body JL_JLARRWTF_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JL_JLARRWTF_XMLP_PKG" AS
/* $Header: JLARRWTFB.pls 120.1 2007/12/25 16:37:12 dwkrishn noship $ */
  ...
  FUNCTION CF_WITH_TAKEN_RECFORMULA(DGI_TAX_REGIME_CODE IN VARCHAR2
                                   ...
                                   ,WITHHOLDING_AMOUNT IN NUMBER) RETURN VARCHAR2 IS
    L_REC VARCHAR2(58);
  BEGIN
    L_REC := DGI_TAX_REGIME_CODE || WITHHOLDING_AGENT_CUIT || TO_CHAR(TO_DATE(WITHHOLDING_DATE
                            ,'RRRR/MM/DD HH24:MI:SS')
                    ,'DD/MM/YYYY') || WITHHOLDING_CERT_NUM || LPAD(LTRIM(TO_CHAR(ROUND(WITHHOLDING_AMOUNT
                                     ,2)
                               ,'9999999999999.99'))
                 ,16
                 ,' ');
    RETURN (L_REC);
  END CF_WITH_TAKEN_RECFORMULA;
