--------------------------------------------------------
--  DDL for Package Body IGS_FI_BILL_P_PLANS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_FI_BILL_P_PLANS_PKG" AS
/* $Header: IGSSIE3B.pls 115.0 2003/08/26 07:20:01 smvk noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_fi_bill_p_plans%ROWTYPE;
  new_references igs_fi_bill_p_plans%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_FI_BPP_PPSA_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGS_FI_BILL_P_PLANS_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    INSERT INTO igs_fi_bill_p_plans (
      student_plan_id,
      bill_id,
      plan_start_date,
      plan_end_date,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.plan_start_date = x_plan_start_date)
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGS_FI_BILL_P_PLANS_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
