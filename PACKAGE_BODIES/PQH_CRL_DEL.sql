--------------------------------------------------------
--  DDL for Package Body PQH_CRL_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_CRL_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_crl_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the pqh_criteria_rate_defn_tl row.
  --
  delete from pqh_criteria_rate_defn_tl
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pqh_crl_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in pqh_crl_shd.g_rec_type) is
--
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'PQH_CRITERIA_RATE_DEFN_TL'
        ,p_hook_type   => 'AD');
      --
  end;
  --
...
Begin
  ...
  --
  pqh_crl_bus.delete_validate(p_rec);
  --
  ...
  --
  pqh_crl_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  pqh_crl_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  pqh_crl_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
...
Begin
  ...
  --
  --
  -- Having converted the arguments into the pqh_crl_rec
  -- plsql record structure we must call the corresponding entity
  -- business process
  --
  pqh_crl_del.del(l_rec);
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End del;
--
