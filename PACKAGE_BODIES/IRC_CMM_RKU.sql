--------------------------------------------------------
--  DDL for Package Body IRC_CMM_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_CMM_RKU" as
...
begin
hr_utility.set_location('Entering: IRC_CMM_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: IRC_CMM_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end IRC_CMM_RKU;
