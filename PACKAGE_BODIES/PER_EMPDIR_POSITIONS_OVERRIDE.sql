--------------------------------------------------------
--  DDL for Package Body PER_EMPDIR_POSITIONS_OVERRIDE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_EMPDIR_POSITIONS_OVERRIDE" AS
...
BEGIN
    ...
    EXCEPTION WHEN OTHERS THEN
        ...
        retcode := '1';
        per_empdir_ss.write_log(1, 'Error in before_dml positions : '||SQLCODE);
        per_empdir_ss.write_log(1, 'Error Msg: '||substr(SQLERRM,1,700));
END before_dml;
END PER_EMPDIR_POSITIONS_OVERRIDE;
