--------------------------------------------------------
--  DDL for Package Body PAY_US_DATABASE_ITEMS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_US_DATABASE_ITEMS_PKG" as
/* $Header: pyusdbip.pkb 115.1 99/07/17 06:42:53 porting ship  $ */
--
...
--
  ...
  T Grisco  13-DEC-1995	 	Added some trace statements and fixed the
				problem of not converting p_route_name to
				upper case when passing it to insert_user_entity
  M Reid    06-JUN-1997  40.3   Removed show errors
  A Myers   12-FEB-1998 110.1	Added parameter to insert_user_entity and
				associated logic, as per pydyndbi.pkb 110.10.
*/
--
-- Procedures
--
