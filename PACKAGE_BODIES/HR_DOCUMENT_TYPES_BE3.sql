--------------------------------------------------------
--  DDL for Package Body HR_DOCUMENT_TYPES_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_DOCUMENT_TYPES_BE3" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  hr_document_types_be3.delete_document_type_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.document_types.delete_document_type';
