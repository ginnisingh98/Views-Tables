--------------------------------------------------------
--  DDL for Package Body PER_REQUISITIONS_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_REQUISITIONS_BE3" as 
--Code generated on 04/01/2007 09:33:12
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  per_requisitions_be3.delete_requisition_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.requisitions.delete_requisition';
