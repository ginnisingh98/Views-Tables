--------------------------------------------------------
--  DDL for Package Body IRC_TEMPLATE_ASSOCIATION_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_TEMPLATE_ASSOCIATION_BE1" as 
...
p_end_date                     date) is
  ...
  --
  l_proc varchar2(72):='  irc_template_association_be1.create_template_association_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.template_association.create_template_association';
