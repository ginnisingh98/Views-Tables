--------------------------------------------------------
--  DDL for Package Body PQH_TCA_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_TCA_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqh_tca_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure delete_dml(p_rec in pqh_tca_shd.g_rec_type) is
--
...
Begin
  ...
  --
  --
  -- Delete the pqh_txn_category_attributes row.
  --
  delete from pqh_txn_category_attributes
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pqh_tca_shd.g_rec_type) is
--
...
Procedure del
  ...
  p_rec	      in pqh_tca_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  pqh_tca_bus.delete_validate(p_rec
  ,p_effective_date);
  --
