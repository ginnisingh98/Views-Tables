--------------------------------------------------------
--  DDL for Package Body BEN_ELIG_DPNT_CVD_OTHR_PL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIG_DPNT_CVD_OTHR_PL_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_ELIG_DPNT_CVD_OTHR_PL_BK1.CREATE_ELIG_DPNT_CVD_OTHR_PL_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_DPNT_CVD_OTHR_PL_BK1.CREATE_ELIG_DPNT_CVD_OTHR_PL_A', 20);
end CREATE_ELIG_DPNT_CVD_OTHR_PL_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIG_DPNT_CVD_OTHR_PL_BK1.CREATE_ELIG_DPNT_CVD_OTHR_PL_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_DPNT_CVD_OTHR_PL_BK1.CREATE_ELIG_DPNT_CVD_OTHR_PL_B', 20);
end CREATE_ELIG_DPNT_CVD_OTHR_PL_B;
