--------------------------------------------------------
--  DDL for Package Body PER_BF_PAYMENT_DETAILS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_BF_PAYMENT_DETAILS_BK1" as
...
begin
hr_utility.set_location('Entering: PER_BF_PAYMENT_DETAILS_BK1.CREATE_PAYMENT_DETAIL_A', 10);
hr_utility.set_location(' Leaving: PER_BF_PAYMENT_DETAILS_BK1.CREATE_PAYMENT_DETAIL_A', 20);
end CREATE_PAYMENT_DETAIL_A;
...
begin
hr_utility.set_location('Entering: PER_BF_PAYMENT_DETAILS_BK1.CREATE_PAYMENT_DETAIL_B', 10);
hr_utility.set_location(' Leaving: PER_BF_PAYMENT_DETAILS_BK1.CREATE_PAYMENT_DETAIL_B', 20);
end CREATE_PAYMENT_DETAIL_B;
