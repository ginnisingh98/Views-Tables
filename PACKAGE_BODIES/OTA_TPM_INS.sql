--------------------------------------------------------
--  DDL for Package Body OTA_TPM_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TPM_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ota_tpm_ins.';  -- Global package name
--
g_training_plan_member_id_i  number   default null;

-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_training_plan_member_id  in  number) is
--
...
Begin
  ...
  --
  ota_tpm_ins.g_training_plan_member_id_i := p_training_plan_member_id;
  --
...
Begin
  ...
  --
  -- Insert the row into: ota_training_plan_members
  --
  insert into ota_training_plan_members
...
--
  Cursor C_Sel1 is select ota_training_plan_members_s.nextval from sys.dual;
--
Cursor C_Sel2 is
    Select null
      from ota_training_plan_members
     where training_plan_member_id =
             ota_tpm_ins.g_training_plan_member_id_i;
--
  l_exists varchar2(1);
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  If (ota_tpm_ins.g_training_plan_member_id_i is not null) Then
    --
    ...
    p_rec.training_plan_member_id :=
      ota_tpm_ins.g_training_plan_member_id_i;
    ota_tpm_ins.g_training_plan_member_id_i := null;
  Else
    --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.training_plan_member_id;
  Close C_Sel1;
...
Begin
  ...
  --
  ota_tpm_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  ota_tpm_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ota_tpm_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Begin
  ...
  --
  p_training_plan_member_id := l_rec.training_plan_member_id;
