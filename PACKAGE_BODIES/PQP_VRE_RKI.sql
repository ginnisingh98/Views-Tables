--------------------------------------------------------
--  DDL for Package Body PQP_VRE_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_VRE_RKI" as
...
begin
hr_utility.set_location('Entering: PQP_VRE_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: PQP_VRE_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end PQP_VRE_RKI;
