--------------------------------------------------------
--  DDL for Package Body IRC_CMM_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_CMM_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  irc_cmm_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_communication_message_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_communication_message_id  in  number) is
--
...
Begin
  ...
  --
  irc_cmm_ins.g_communication_message_id_i := p_communication_message_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: irc_comm_messages
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (irc_cmm_ins.g_communication_message_id_i is not null) Then
    --
    ...
    p_rec.communication_message_id :=
      irc_cmm_ins.g_communication_message_id_i;
    irc_cmm_ins.g_communication_message_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.communication_message_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Procedure ins
  ...
  ,p_message_subject                in     varchar2 default null
...
Begin
  ...
  --
  p_communication_message_id := l_rec.communication_message_id;
