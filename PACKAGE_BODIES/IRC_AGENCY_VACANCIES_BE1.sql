--------------------------------------------------------
--  DDL for Package Body IRC_AGENCY_VACANCIES_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_AGENCY_VACANCIES_BE1" as 
...
p_object_version_number        varchar2) is
  ...
  --
  l_proc varchar2(72):='  irc_agency_vacancies_be1.create_agency_vacancy_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.agency_vacancies.create_agency_vacancy';
