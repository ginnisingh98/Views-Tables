--------------------------------------------------------
--  DDL for Package Body PQH_WORKSHEET_PERIODS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_WORKSHEET_PERIODS_BK1" as
...
begin
hr_utility.set_location('Entering: PQH_WORKSHEET_PERIODS_BK1.CREATE_WORKSHEET_PERIOD_A', 10);
hr_utility.set_location(' Leaving: PQH_WORKSHEET_PERIODS_BK1.CREATE_WORKSHEET_PERIOD_A', 20);
end CREATE_WORKSHEET_PERIOD_A;
...
begin
hr_utility.set_location('Entering: PQH_WORKSHEET_PERIODS_BK1.CREATE_WORKSHEET_PERIOD_B', 10);
hr_utility.set_location(' Leaving: PQH_WORKSHEET_PERIODS_BK1.CREATE_WORKSHEET_PERIOD_B', 20);
end CREATE_WORKSHEET_PERIOD_B;
