--------------------------------------------------------
--  DDL for Package Body GME_GANTT_RSRC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_GANTT_RSRC_PKG" AS
/* $Header: GMEGNTRB.pls 120.3.12000000.2 2007/01/26 22:57:02 snene ship $  */
 ...
 #======================================================================*/
   ...
   BEGIN
      ...
      IF (get_rsrc_info%FOUND) THEN
         ...
         x_resource_desc := r_pad (l_resource_desc, 40);
