--------------------------------------------------------
--  DDL for Package Body BEN_CPI_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CPI_RKI" as
...
begin
hr_utility.set_location('Entering: BEN_CPI_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: BEN_CPI_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end BEN_CPI_RKI;
