--------------------------------------------------------
--  DDL for Package Body BEN_JRT_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_JRT_RKI" as
...
begin
hr_utility.set_location('Entering: BEN_JRT_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: BEN_JRT_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end BEN_JRT_RKI;
