--------------------------------------------------------
--  DDL for Package Body BEN_PERIOD_LIMIT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PERIOD_LIMIT_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PERIOD_LIMIT_BK1.CREATE_PERIOD_LIMIT_A', 10);
hr_utility.set_location(' Leaving: BEN_PERIOD_LIMIT_BK1.CREATE_PERIOD_LIMIT_A', 20);
end CREATE_PERIOD_LIMIT_A;
...
begin
hr_utility.set_location('Entering: BEN_PERIOD_LIMIT_BK1.CREATE_PERIOD_LIMIT_B', 10);
hr_utility.set_location(' Leaving: BEN_PERIOD_LIMIT_BK1.CREATE_PERIOD_LIMIT_B', 20);
end CREATE_PERIOD_LIMIT_B;
