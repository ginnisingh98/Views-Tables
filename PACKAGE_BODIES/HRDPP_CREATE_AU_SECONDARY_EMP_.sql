--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_AU_SECONDARY_EMP_
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_AU_SECONDARY_EMP_" as
/*
 * Generated by hr_pump_meta_mapper at: 2013/08/29 22:08:39
 * Generated for API: HR_AU_ASSIGNMENT_API.CREATE_AU_SECONDARY_EMP_ASG
 */
--
...
,P_TITLE
,P_LEV_LOD_FLG
,P_GROUP_CERT_ISSUE_DATE
,P_HRS_WORKED_PER_WEEK
,P_PGP_SEGMENT1
,P_PGP_SEGMENT2
,P_PGP_SEGMENT3
,P_PGP_SEGMENT4
...
decode(l.pval003,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval003,'EMP_ASSIGN_REASON',d(l.pval001),l.pval125)) p3,
l.pval003 d3,
...
decode(l.pval006,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval006,'EMP_CAT',d(l.pval001),l.pval125)) p6,
l.pval006 d6,
...
decode(l.pval016,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval016,'FREQUENCY',d(l.pval001),l.pval125)) p16,
l.pval016 d16,
decode(l.pval017,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval017,'REC_TYPE',d(l.pval001),l.pval125)) p17,
l.pval017 d17,
...
decode(l.pval020,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval020,'BARGAINING_UNIT_CODE',d(l.pval001),l.pval125)) p20,
l.pval020 d20,
decode(l.pval021,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval021,'YES_NO',d(l.pval001),l.pval125)) p21,
l.pval021 d21,
decode(l.pval022,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval022,'HOURLY_SALARIED_CODE',d(l.pval001),l.pval125)) p22,
l.pval022 d22,
...
l.pval088 d88,
decode(l.pval089,cn,nn,vn,nn,n(l.pval089)) p89,
l.pval089 d89,
...
l.pval121 p121,
l.pval122 p122,
decode(l.pval123,cn,vn,l.pval123) p123,
decode(l.pval124,cn,vn,l.pval124) p124,
decode(l.pval125,cn,vn,l.pval125) p125,
...
L_LEGAL_EMPLOYER_ID varchar2(2000);
...
(P_PERSON_USER_KEY => c.p123);
end if;
--
if c.p124 is null or
c.p1 is null or
c.p125 is null then
...
--
if c.p127 is null or
c.p1 is null then
L_POSITION_ID:=nn;
else
L_POSITION_ID := 
hr_pump_get.get_position_id
(P_POSITION_NAME => c.p127
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p1);
end if;
--
if c.p128 is null or
c.p1 is null then
L_JOB_ID:=nn;
else
L_JOB_ID := 
...
(P_LOCATION_CODE => c.p131
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_LANGUAGE_CODE => c.p125);
end if;
--
if c.p132 is null then
L_SUPERVISOR_ID:=nn;
else
L_SUPERVISOR_ID := 
hr_pump_get.get_supervisor_id
(P_SUPERVISOR_USER_KEY => c.p132);
end if;
--
if c.p133 is null then
L_SPECIAL_CEILING_STEP_ID:=nn;
else
L_SPECIAL_CEILING_STEP_ID := 
hr_pump_get.get_special_ceiling_step_id
(P_SPECIAL_CEILIN_STEP_USER_KEY => c.p133);
end if;
--
if c.p134 is null then
L_PAY_BASIS_ID:=nn;
else
L_PAY_BASIS_ID := 
hr_pump_get.get_pay_basis_id
(P_PAY_BASIS_NAME => c.p134
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID);
end if;
--
if c.p135 is null then
L_DEFAULT_CODE_COMB_ID:=nn;
else
L_DEFAULT_CODE_COMB_ID := 
hr_pump_get.get_default_code_comb_id
(P_DEFAULT_CODE_COMB_USER_KEY => c.p135);
end if;
--
...
(P_SET_OF_BOOKS_NAME => c.p136);
end if;
--
if c.p137 is null then
L_LEGAL_EMPLOYER_ID:=vn;
else
L_LEGAL_EMPLOYER_ID := 
PER_AU_DATA_PUMP.get_legal_employer_id
(P_LEGAL_EMPLOYER_NAME => c.p137
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID);
end if;
--
...
(P_ESTABLISHMENT_NAME => c.p139
,P_LOCATION => c.p140);
end if;
--
if c.p141 is null or
c.p1 is null then
...
HR_AU_ASSIGNMENT_API.CREATE_AU_SECONDARY_EMP_ASG
...
,P_LEV_LOD_FLG => c.p55
,P_GROUP_CERT_ISSUE_DATE => c.p56
,P_HRS_WORKED_PER_WEEK => c.p57
,P_PGP_SEGMENT1 => c.p58
,P_PGP_SEGMENT2 => c.p59
,P_PGP_SEGMENT3 => c.p60
,P_PGP_SEGMENT4 => c.p61
,P_PGP_SEGMENT5 => c.p62
,P_PGP_SEGMENT6 => c.p63
,P_PGP_SEGMENT7 => c.p64
,P_PGP_SEGMENT8 => c.p65
,P_PGP_SEGMENT9 => c.p66
,P_PGP_SEGMENT10 => c.p67
,P_PGP_SEGMENT11 => c.p68
,P_PGP_SEGMENT12 => c.p69
,P_PGP_SEGMENT13 => c.p70
,P_PGP_SEGMENT14 => c.p71
,P_PGP_SEGMENT15 => c.p72
,P_PGP_SEGMENT16 => c.p73
,P_PGP_SEGMENT17 => c.p74
,P_PGP_SEGMENT18 => c.p75
,P_PGP_SEGMENT19 => c.p76
,P_PGP_SEGMENT20 => c.p77
,P_PGP_SEGMENT21 => c.p78
,P_PGP_SEGMENT22 => c.p79
,P_PGP_SEGMENT23 => c.p80
,P_PGP_SEGMENT24 => c.p81
,P_PGP_SEGMENT25 => c.p82
,P_PGP_SEGMENT26 => c.p83
,P_PGP_SEGMENT27 => c.p84
,P_PGP_SEGMENT28 => c.p85
,P_PGP_SEGMENT29 => c.p86
,P_PGP_SEGMENT30 => c.p87
,P_PGP_CONCAT_SEGMENTS => c.p88
,P_CONTRACT_ID => L_CONTRACT_ID
,P_ESTABLISHMENT_ID => L_ESTABLISHMENT_ID
,P_COLLECTIVE_AGREEMENT_ID => L_COLLECTIVE_AGREEMENT_ID
,P_CAGR_ID_FLEX_NUM => c.p89
...
,P_CAGR_GRADE_DEF_ID => c.p110
,P_CAGR_CONCATENATED_SEGMENTS => c.p111
,P_ASSIGNMENT_ID => L_ASSIGNMENT_ID
,P_SOFT_CODING_KEYFLEX_ID => c.p113
,P_PEOPLE_GROUP_ID => c.p114
,P_OBJECT_VERSION_NUMBER => c.p115
,P_EFFECTIVE_START_DATE => c.p116
,P_EFFECTIVE_END_DATE => c.p117
,P_ASSIGNMENT_SEQUENCE => c.p118
,P_COMMENT_ID => c.p119
,P_CONCATENATED_SEGMENTS => c.p120
,P_GROUP_NAME => c.p121
,P_OTHER_MANAGER_WARNING => L_OTHER_MANAGER_WARNING);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p112,L_ASSIGNMENT_ID);
--
...
end hrdpp_CREATE_AU_SECONDARY_EMP_;
