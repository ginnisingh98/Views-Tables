--------------------------------------------------------
--  DDL for Package Body ONT_D1_ACCOUNTING_RULE_DURA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1_ACCOUNTING_RULE_DURA" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D1_ACCOUNTING_RULE_DURA
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1_ACCOUNTING_RULE_DURA';
