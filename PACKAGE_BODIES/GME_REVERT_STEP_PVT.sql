--------------------------------------------------------
--  DDL for Package Body GME_REVERT_STEP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_REVERT_STEP_PVT" AS
   /* $Header: GMEVRWSB.pls 120.4 2005/10/26 15:55:51 pxkumar noship $ */
...
g_pkg_name   CONSTANT VARCHAR2 (30) := 'gme_revert_step_pvt';
 ...
 ,x_return_status        OUT NOCOPY VARCHAR2) IS
   ...
   BEGIN
      ...
      END IF;   /* IFGME_common_pvt.STEP_CONTROL = 'Y' */
