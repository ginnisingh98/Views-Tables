--------------------------------------------------------
--  DDL for Package Body HR_SE_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SE_PERSON_API" AS
  /* $Header: pepersei.pkb 120.0 2005/05/31 14:00:57 appldev noship $ */

   -- Package Variables
   g_package   VARCHAR2(33) := 'hr_se_person_api.';
