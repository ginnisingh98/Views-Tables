--------------------------------------------------------
--  DDL for Package Body HR_TCP_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_TCP_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_tcp_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure insert_dml
  (p_rec in out nocopy hr_tcp_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Insert the row into: hr_template_item_context_pages
  --
...
--
  Cursor C_Sel1 is select hr_tcp_s.nextval from sys.dual
;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.template_item_context_page_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  hr_tcp_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  hr_tcp_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  hr_tcp_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hr_tcp_ins.post_insert
     (p_rec
     );
  --
...
Begin
  ...
  --
  p_template_item_context_page_i := l_rec.template_item_context_page_id;
