--------------------------------------------------------
--  DDL for Package Body BEN_EPB_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EPB_RKU" as
...
begin
hr_utility.set_location('Entering: ben_epb_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_epb_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_epb_RKU;
