--------------------------------------------------------
--  DDL for Package Body BEN_ELP_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELP_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_elp_ins.';  -- Global package name
--
g_eligy_prfl_id_i  number   default null;
...
--
procedure set_base_key_value (p_eligy_prfl_id  in  number) is
--
...
Begin
  ...
  --
  ben_elp_ins.g_eligy_prfl_id_i := p_eligy_prfl_id;
  --
...
--
  Cursor C_Sel1 Is
    select t.created_by,
           t.creation_date
    from   ben_eligy_prfl_f t
    where  t.eligy_prfl_id       = p_rec.eligy_prfl_id
    and    t.effective_start_date =
             ben_elp_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_eligy_prfl_f.created_by%TYPE;
  l_creation_date       ben_eligy_prfl_f.creation_date%TYPE;
  l_last_update_date   	ben_eligy_prfl_f.last_update_date%TYPE;
  l_last_updated_by     ben_eligy_prfl_f.last_updated_by%TYPE;
  l_last_update_login   ben_eligy_prfl_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_eligy_prfl_f
  --
  insert into ben_eligy_prfl_f
  (	eligy_prfl_id,
  ...
  (	p_rec.eligy_prfl_id,
	...
	p_rec.elp_attribute30,
        ...
        p_rec.elig_crit_values_flag,   /* RBC */
        p_rec.object_version_number ,
	l_created_by,
   	l_creation_date,
   	l_last_update_date,
...
--
  cursor c1 is
    select ben_eligy_prfl_f_s.nextval
    from sys.dual;
--
--
 Cursor C_Sel2 is
    Select null
     ...
     where eligy_prfl_id =
             ben_elp_ins.g_eligy_prfl_id_i;
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  --
  --
    If (ben_elp_ins.g_eligy_prfl_id_i is not null) Then
    --
    ...
    Open C_Sel2;
       ...
       End if;
    Close C_Sel2;
    p_rec.eligy_prfl_id:=ben_elp_ins.g_eligy_prfl_id_i;
    ben_elp_ins.g_eligy_prfl_id_i:=null;
  ELSE
   open c1;
    fetch c1 into p_rec.eligy_prfl_id;
   close c1;
  END IF;
  --
  --
