--------------------------------------------------------
--  DDL for Package Body BEN_EDR_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EDR_RKI" as
...
begin
hr_utility.set_location('Entering: ben_edr_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_edr_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_edr_RKI;
