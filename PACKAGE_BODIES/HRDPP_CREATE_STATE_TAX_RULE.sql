--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_STATE_TAX_RULE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_STATE_TAX_RULE" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:18
 * Generated for API: PAY_STATE_TAX_RULE_API.CREATE_STATE_TAX_RULE
 */
--
...
decode(l.pval018,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval018,'YES_NO',d(l.pval001),vn)) p18,
l.pval018 d18,
decode(l.pval019,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval019,'YES_NO',d(l.pval001),vn)) p19,
l.pval019 d19,
...
l.pval084 p84,
l.pval085 p85,
decode(l.pval086,cn,dn,d(l.pval086)) p86,
...
,P_DEFAULT_FLAG => c.p2
,P_ASSIGNMENT_ID => c.p3
,P_STATE_CODE => c.p4
,P_ADDITIONAL_WA_AMOUNT => c.p5
,P_FILING_STATUS_CODE => c.p6
,P_REMAINDER_PERCENT => c.p7
,P_SECONDARY_WA => c.p8
,P_SIT_ADDITIONAL_TAX => c.p9
,P_SIT_OVERRIDE_AMOUNT => c.p10
,P_SIT_OVERRIDE_RATE => c.p11
,P_WITHHOLDING_ALLOWANCES => c.p12
,P_EXCESSIVE_WA_REJECT_DATE => c.p13
,P_SDI_EXEMPT => c.p14
,P_SIT_EXEMPT => c.p15
,P_SIT_OPTIONAL_CALC_IND => c.p16
,P_STATE_NON_RESIDENT_CERT => c.p17
,P_SUI_EXEMPT => c.p18
,P_WC_EXEMPT => c.p19
,P_SUI_WAGE_BASE_OVERRIDE_AMOUN => c.p20
,P_SUPP_TAX_OVERRIDE_RATE => c.p21
...
,P_ATTRIBUTE29 => c.p51
,P_ATTRIBUTE30 => c.p52
,P_STA_INFORMATION_CATEGORY => c.p53
,P_STA_INFORMATION1 => c.p54
,P_STA_INFORMATION2 => c.p55
,P_STA_INFORMATION3 => c.p56
,P_STA_INFORMATION4 => c.p57
,P_STA_INFORMATION5 => c.p58
,P_STA_INFORMATION6 => c.p59
,P_STA_INFORMATION7 => c.p60
,P_STA_INFORMATION8 => c.p61
,P_STA_INFORMATION9 => c.p62
,P_STA_INFORMATION10 => c.p63
,P_STA_INFORMATION11 => c.p64
,P_STA_INFORMATION12 => c.p65
,P_STA_INFORMATION13 => c.p66
,P_STA_INFORMATION14 => c.p67
,P_STA_INFORMATION15 => c.p68
,P_STA_INFORMATION16 => c.p69
,P_STA_INFORMATION17 => c.p70
,P_STA_INFORMATION18 => c.p71
,P_STA_INFORMATION19 => c.p72
,P_STA_INFORMATION20 => c.p73
,P_STA_INFORMATION21 => c.p74
,P_STA_INFORMATION22 => c.p75
,P_STA_INFORMATION23 => c.p76
,P_STA_INFORMATION24 => c.p77
,P_STA_INFORMATION25 => c.p78
,P_STA_INFORMATION26 => c.p79
,P_STA_INFORMATION27 => c.p80
,P_STA_INFORMATION28 => c.p81
,P_STA_INFORMATION29 => c.p82
,P_STA_INFORMATION30 => c.p83
,P_EMP_STATE_TAX_RULE_ID => L_EMP_STATE_TAX_RULE_ID
,P_OBJECT_VERSION_NUMBER => c.p85
,P_EFFECTIVE_START_DATE => c.p86
,P_EFFECTIVE_END_DATE => c.p87);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p84,L_EMP_STATE_TAX_RULE_ID);
--
update hr_pump_batch_lines l set
l.pval084 = decode(c.p84,null,cn,c.p84),
l.pval085 = decode(c.p85,null,cn,c.p85),
l.pval086 = decode(c.p86,null,cn,dc(c.p86)),
...
end hrdpp_CREATE_STATE_TAX_RULE;
