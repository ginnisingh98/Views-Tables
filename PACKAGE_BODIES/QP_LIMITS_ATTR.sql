--------------------------------------------------------
--  DDL for Package Body QP_LIMITS_ATTR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."QP_LIMITS_ATTR" AS
/* $Header: QPXALMTB.pls 120.0 2005/06/02 00:57:26 appldev noship $ */

--  Global constant holding the package name

G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'QP_LIMITS_ATTR';
...
BEGIN
    ...
    l_attr_rec.column              := 'AMOUNT';
    l_attr_rec.type                := 'NUMBER';
    l_attr_rec.name                := 'amount';
    l_attr_rec.code                := 'amount';
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'BASIS';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 30;
    l_attr_rec.name                := 'basis';
    l_attr_rec.code                := 'basis';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'LIMIT_EXCEED_ACTION_CODE';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 30;
    l_attr_rec.name                := 'limit_exceed_action';
    l_attr_rec.code                := 'limit_exceed_action_code';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'LIMIT_HOLD_FLAG';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 1;
    l_attr_rec.name                := 'limit_hold';
    l_attr_rec.code                := 'limit_hold_flag';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    l_attr_rec.value               := TRUE;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'LIMIT_LEVEL_CODE';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 30;
    l_attr_rec.name                := 'limit_level';
    l_attr_rec.code                := 'limit_level_code';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    l_attr_rec.value               := TRUE;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'LIMIT_NUMBER';
    l_attr_rec.type                := 'NUMBER';
    l_attr_rec.name                := 'limit_number';
    l_attr_rec.code                := 'limit_number';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;
    ...
    I                              := I + 1;
    l_attr_rec                     := OE_GENERATE.G_MISS_ATTR_REC;
    l_attr_rec.column              := 'ORGANIZATION_FLAG';
    l_attr_rec.type                := 'VARCHAR2';
    l_attr_rec.length              := 1;
    l_attr_rec.name                := 'organization';
    l_attr_rec.code                := 'organization_flag';
    l_attr_rec.category            := OE_GENERATE.G_CAT_REGULAR;
    l_attr_rec.value               := TRUE;
    OE_GENERATE.g_attr_tbl(I)      := l_attr_rec;
