--------------------------------------------------------
--  DDL for Package Body PQP_DET_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_DET_RKU" as
...
begin
hr_utility.set_location('Entering: PQP_DET_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PQP_DET_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQP_DET_RKU;
