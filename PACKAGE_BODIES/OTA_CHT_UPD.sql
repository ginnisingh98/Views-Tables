--------------------------------------------------------
--  DDL for Package Body OTA_CHT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CHT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_cht_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure update_dml
  (p_rec in out nocopy ota_cht_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  ota_cht_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_cht_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_cht_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
  ...
  cursor csr_upd_langs is
    select cht.language
     ...
     where cht.chat_id = p_chat_id
       and p_language_code in (cht.language
                              ,cht.source_lang);
  --
