--------------------------------------------------------
--  DDL for Package Body HR_LEI_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_LEI_RKI" as
...
begin
hr_utility.set_location('Entering: HR_LEI_RKI.AFTER_INSERT', 10);
...
hr_api.validate_commit_unit(l_commit_unit_number, 'HR_LOCATION_EXTRA_INFO', 'AI');
hr_utility.set_location(' Leaving: HR_LEI_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end HR_LEI_RKI;
