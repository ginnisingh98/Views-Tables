--------------------------------------------------------
--  DDL for Package Body PAY_BAD_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_BAD_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_bad_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the pay_bal_attribute_definitions row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pay_bad_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in pay_bad_shd.g_rec_type) is
--
...
Begin
  ...
  begin
    ...
    --
    pay_bad_rkd.after_delete
      (p_attribute_id
      => p_rec.attribute_id
      ,p_attribute_name_o
      => pay_bad_shd.g_old_rec.attribute_name
      ,p_alterable_o
      => pay_bad_shd.g_old_rec.alterable
      ,p_legislation_code_o
      => pay_bad_shd.g_old_rec.legislation_code
      ,p_business_group_id_o
      => pay_bad_shd.g_old_rec.business_group_id
      ,p_user_attribute_name_o
      => pay_bad_shd.g_old_rec.user_attribute_name
      );
    --
  exception
    --
...
Begin
  ...
  --
  pay_bad_bus.delete_validate(p_rec);
  --
  ...
  --
  pay_bad_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  pay_bad_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  pay_bad_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
