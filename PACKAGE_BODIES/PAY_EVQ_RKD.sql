--------------------------------------------------------
--  DDL for Package Body PAY_EVQ_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_EVQ_RKD" as
...
begin
hr_utility.set_location('Entering: PAY_EVQ_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PAY_EVQ_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PAY_EVQ_RKD;
