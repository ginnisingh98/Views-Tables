--------------------------------------------------------
--  DDL for Package Body HXC_EGC_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_EGC_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_egc_shd.';  -- Global package name
...
Begin
  --
  If (p_constraint_name = 'HXC_ENTITY_GROUP_COMPS_PK') Then
...
Begin
  --
  If (p_entity_group_comp_id is null and
    ...
    l_fct_ret := false;
  Else
    If (p_entity_group_comp_id
        = hxc_egc_shd.g_old_rec.entity_group_comp_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into hxc_egc_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> hxc_egc_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  hr_api.mandatory_arg_error
    (p_api_name           => l_proc
    ,p_argument           => 'ENTITY_GROUP_COMP_ID'
    ,p_argument_value     => p_entity_group_comp_id
    );
  --
  Open  C_Sel1;
  Fetch C_Sel1 Into hxc_egc_shd.g_old_rec;
...
Exception
  When HR_Api.Object_Locked then
    ...
    fnd_message.set_token('TABLE_NAME', 'hxc_entity_group_comps');
    fnd_message.raise_error;
End lck;
--
-- ----------------------------------------------------------------------------
