--------------------------------------------------------
--  DDL for Package Body PQH_TRAN_CATEGORY_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_TRAN_CATEGORY_BK1" as
...
begin
hr_utility.set_location('Entering: PQH_TRAN_CATEGORY_BK1.CREATE_TRAN_CATEGORY_A', 10);
hr_utility.set_location(' Leaving: PQH_TRAN_CATEGORY_BK1.CREATE_TRAN_CATEGORY_A', 20);
end CREATE_TRAN_CATEGORY_A;
...
begin
hr_utility.set_location('Entering: PQH_TRAN_CATEGORY_BK1.CREATE_TRAN_CATEGORY_B', 10);
hr_utility.set_location(' Leaving: PQH_TRAN_CATEGORY_BK1.CREATE_TRAN_CATEGORY_B', 20);
end CREATE_TRAN_CATEGORY_B;
