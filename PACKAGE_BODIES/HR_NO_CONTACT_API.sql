--------------------------------------------------------
--  DDL for Package Body HR_NO_CONTACT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_NO_CONTACT_API" AS
/* $Header: peconnoi.pkb 120.0 2005/05/31 07:07 appldev noship $ */
--
-- Package Variables
   g_package  varchar2(33) := 'hr_no_contact_api';
