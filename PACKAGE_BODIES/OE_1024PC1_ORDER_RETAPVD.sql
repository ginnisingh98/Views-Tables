--------------------------------------------------------
--  DDL for Package Body OE_1024PC1_ORDER_RETAPVD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_1024PC1_ORDER_RETAPVD" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_result_code varchar2(30) :='PASS';
   CURSOR C_VC  IS 
   SELECT count(*) 
