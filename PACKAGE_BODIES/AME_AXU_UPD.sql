--------------------------------------------------------
--  DDL for Package Body AME_AXU_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_AXU_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_axu_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
 ...
 ,p_rule_type =>  p_rec.rule_type
    ...
    --
    --
    -- Update the ame_action_type_usages Row
    --
...
Begin
  ...
  begin
    ...
    ame_axu_rku.after_update
      ...
      => p_rec.object_version_number
      ,p_start_date_o
      => ame_axu_shd.g_old_rec.start_date
      ,p_end_date_o
      => ame_axu_shd.g_old_rec.end_date
      ,p_security_group_id_o
      => ame_axu_shd.g_old_rec.security_group_id
      ,p_object_version_number_o
      => ame_axu_shd.g_old_rec.object_version_number
      );
    --
  exception
    --
...
Begin
 ...
 ,p_rule_type =>  p_rec.rule_type
  ...
  --
  ame_axu_upd.convert_defs(p_rec);
  --
  ame_axu_bus.update_validate
    (p_rec                              => p_rec
    ,p_effective_date                   => p_effective_date
    ,p_datetrack_mode                   => p_datetrack_mode
    ,p_validation_start_date            => l_validation_start_date
