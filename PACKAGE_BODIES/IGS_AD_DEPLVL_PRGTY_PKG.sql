--------------------------------------------------------
--  DDL for Package Body IGS_AD_DEPLVL_PRGTY_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AD_DEPLVL_PRGTY_PKG" AS
/* $Header: IGSAIG7B.pls 115.5 2003/10/30 13:17:59 akadam noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_ad_deplvl_prgty%ROWTYPE;
  new_references igs_ad_deplvl_prgty%ROWTYPE;
  ...
  */
    CURSOR cur_rowid IS
      ...
      AND      program_type = x_program_type
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_AD_DEPLVL_PRGTY_FK1');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    INSERT INTO igs_ad_deplvl_prgty (
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_ad_deplvl_prgty
    WHERE rowid = x_rowid;
