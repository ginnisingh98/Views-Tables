--------------------------------------------------------
--  DDL for Package Body HR_KI_OPTIONS_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_KI_OPTIONS_SWI" As
/* $Header: hroptswi.pkb 115.0 2004/01/09 02:36 vkarandi noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'hr_ki_options_swi.';
--
-- ----------------------------------------------------------------------------
-- |-----------------------------< create_option >----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  hr_opt_ins.set_base_key_value
    (p_option_id => p_option_id
    );
  --
  -- Call API
  --
  hr_ki_options_api.create_option
...
Begin
  ...
  -- Call API
  --
  hr_ki_options_api.delete_option
    (p_validate                     => l_validate
    ,p_option_id                    => p_option_id
    ,p_object_version_number        => p_object_version_number
    );
...
Begin
  ...
  -- Call API
  --
  hr_ki_options_api.update_option
    (p_validate                     => l_validate
    ,p_option_id                    => p_option_id
    ,p_value                        => p_value
    ,p_encrypted                    => p_encrypted
