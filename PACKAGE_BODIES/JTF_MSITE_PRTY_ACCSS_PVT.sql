--------------------------------------------------------
--  DDL for Package Body JTF_MSITE_PRTY_ACCSS_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_MSITE_PRTY_ACCSS_PVT" AS
/* $Header: JTFVMPRB.pls 115.1 2001/03/02 19:08:07 pkm ship      $ */

G_PKG_NAME  CONSTANT VARCHAR2(30):= 'JTF_MSITE_PRTY_ACCSS_PVT';
G_FILE_NAME CONSTANT VARCHAR2(12):= 'JTFVMPRB.pls';
...
BEGIN
  ...
  IF (c1%NOTFOUND) THEN
    CLOSE c1;
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_PARTY_NOT_FOUND');
...
BEGIN
  ...
  THEN
    ...
    IF (c1%NOTFOUND) THEN
      CLOSE c1;
      FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_PRTY_NOT_FOUND');
  ...
  THEN
    ...
    IF (c2%NOTFOUND) THEN
      CLOSE c2;
      FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITEPRTY_NOT_FOUND');
      FND_MESSAGE.Set_Token('MSITE_ID', p_msite_id);
      FND_MESSAGE.Set_Token('PARTY_ID', p_party_id);
      RAISE FND_API.G_EXC_ERROR;
    END IF;
  ...
  ELSE
    ...
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_NO_MP_IDS_SPEC');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_ERROR;
  END IF;
...
BEGIN
  ...
  IF ((p_party_id IS NULL) OR
      (p_party_id = FND_API.G_MISS_NUM))
  THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_INVALID_PRTY_ID');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_ERROR;
  END IF;
  ...
  IF (x_return_status = FND_API.G_RET_STS_UNEXP_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_PRTY_ID_VLD_FAIL');
    FND_MESSAGE.Set_Token('PARTY_ID', p_party_id);
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_UNEXPECTED_ERROR;
  ELSIF (x_return_status = FND_API.G_RET_STS_ERROR) THEN
  ...
  ELSIF (x_return_status = FND_API.G_RET_STS_UNEXP_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSPRT_ID_VLD_FAIL');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_UNEXPECTED_ERROR;
  ELSIF (x_return_status = FND_API.G_RET_STS_SUCCESS) THEN -- duplicate exists
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSPRT_ID_DUP_EXISTS');
    FND_MESSAGE.Set_Token('MSITE_ID', p_msite_id);
    FND_MESSAGE.Set_Token('PARTY_ID', p_party_id);
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_ERROR;
...
BEGIN
  ...
  IF (p_msite_prty_accss_id IS NULL) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSPRT_ID_IS_NULL');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_ERROR;
  END IF;
...
BEGIN
  ...
  IF (x_return_status = FND_API.G_RET_STS_UNEXP_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MP_INVALID_CREATE');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_UNEXPECTED_ERROR;
  ELSIF (x_return_status = FND_API.G_RET_STS_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MP_INVALID_CREATE');
  ...
  --
  BEGIN
    Jtf_Msite_Prty_Accss_Pkg.insert_row
      (
      p_msite_prty_accss_id                => FND_API.G_MISS_NUM,
  ...
  EXCEPTION
     WHEN NO_DATA_FOUND THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_PRTY_INSERT_FL');
       FND_MSG_PUB.Add;
       RAISE FND_API.G_EXC_ERROR;
     WHEN OTHERS THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_PRTY_INSERT_FL');
...
BEGIN
  ...
  IF (x_return_status = FND_API.G_RET_STS_UNEXP_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MP_INVALID_UPDATE');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_UNEXPECTED_ERROR;
  ELSIF (x_return_status = FND_API.G_RET_STS_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MP_INVALID_UPDATE');
  ...
  BEGIN
    Jtf_Msite_Prty_Accss_Pkg.update_row
      (
      p_msite_prty_accss_id                => l_msite_prty_accss_id,
      p_object_version_number              => p_object_version_number,
      p_start_date_active                  => p_start_date_active,
  ...
  EXCEPTION
     WHEN NO_DATA_FOUND THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_PRTY_UPDATE_FL');
       FND_MSG_PUB.ADD;
       RAISE FND_API.G_EXC_ERROR;
     WHEN OTHERS THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_PRTY_UPDATE_FL');
...
BEGIN
  ...
  -- delete for jtf_msite_prty_accss
  BEGIN
    Jtf_Msite_Prty_Accss_Pkg.delete_row(l_msite_prty_accss_id);
  EXCEPTION
     WHEN NO_DATA_FOUND THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_PRTY_DELETE_FL');
       FND_MSG_PUB.Add;
       RAISE FND_API.G_EXC_ERROR;
     WHEN OTHERS THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_PRTY_DELETE_FL');
