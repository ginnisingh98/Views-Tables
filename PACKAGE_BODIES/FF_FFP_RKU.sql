--------------------------------------------------------
--  DDL for Package Body FF_FFP_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FF_FFP_RKU" as
...
begin
hr_utility.set_location('Entering: FF_FFP_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: FF_FFP_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end FF_FFP_RKU;
