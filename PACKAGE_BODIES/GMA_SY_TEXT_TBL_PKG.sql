--------------------------------------------------------
--  DDL for Package Body GMA_SY_TEXT_TBL_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GMA_SY_TEXT_TBL_PKG" AS
/* $Header: GMASYTXB.pls 115.6 2003/02/24 19:21:21 kmoizudd ship $ */
procedure INSERT_ROW (
  ...
  cursor C is select ROWID from SY_TEXT_TBL_TL
...
is
begin
  update SY_TEXT_TBL_TL T set (
      TEXT
    ) = (select
      B.TEXT
    from SY_TEXT_TBL_TL B
  ...
  where (
      ...
      SUBT.LINE_NO,
      SUBT.LANGUAGE
    from SY_TEXT_TBL_TL SUBB, SY_TEXT_TBL_TL SUBT
  ...
  insert into SY_TEXT_TBL_TL (
    ...
    L.LANGUAGE_CODE,
    B.SOURCE_LANG
  from SY_TEXT_TBL_TL B, FND_LANGUAGES L
  where L.INSTALLED_FLAG in ('I', 'B')
...
procedure LOAD_ROW (
 ...
 BEGIN
   ...
   GMA_SY_TEXT_TBL_PKG.UPDATE_ROW ( X_ROW_ID => l_row_id,
