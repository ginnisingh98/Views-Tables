--------------------------------------------------------
--  DDL for Package Body BEN_XFI_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XFI_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xfi_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure insert_dml(p_rec in out nocopy ben_xfi_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Insert the row into: ben_ext_file
  --
  insert into ben_ext_file
  (	ext_file_id,
	name,
	xml_tag_name,
	business_group_id,
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_insert(p_rec  in out nocopy ben_xfi_shd.g_rec_type) is
--
  l_proc  varchar2(72) := g_package||'pre_insert';
--
  Cursor C_Sel1 is select ben_ext_file_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ext_file_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure post_insert(p_rec in ben_xfi_shd.g_rec_type) is
--
...
--
  ...
  begin
    ...
    --
    create_app_ownerships('EXT_FILE_ID', p_rec.ext_file_id);
    --
    --
    ben_xfi_rki.after_insert
      (
...
Begin
  ...
  --
  ben_xfi_bus.insert_validate(p_rec);
  --
...
Begin
  ...
  --
  p_ext_file_id := l_rec.ext_file_id;
