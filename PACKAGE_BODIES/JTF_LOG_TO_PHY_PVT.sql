--------------------------------------------------------
--  DDL for Package Body JTF_LOG_TO_PHY_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_LOG_TO_PHY_PVT" AS
/* $Header: JTFVDPOB.pls 120.2 2005/10/25 05:06:45 psanyal ship $ */
G_PKG_NAME  CONSTANT VARCHAR2(21):= 'JTF_LOG_TO_PHY_PVT';
G_FILE_NAME CONSTANT VARCHAR2(12):= 'JTFVDPOB.pls';
-- ****************************************************************************
