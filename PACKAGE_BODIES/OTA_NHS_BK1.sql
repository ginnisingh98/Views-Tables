--------------------------------------------------------
--  DDL for Package Body OTA_NHS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_NHS_BK1" as
...
begin
hr_utility.set_location('Entering: OTA_NHS_BK1.CREATE_NON_OTA_HISTORIES_A', 10);
hr_utility.set_location(' Leaving: OTA_NHS_BK1.CREATE_NON_OTA_HISTORIES_A', 20);
end CREATE_NON_OTA_HISTORIES_A;
...
begin
hr_utility.set_location('Entering: OTA_NHS_BK1.CREATE_NON_OTA_HISTORIES_B', 10);
hr_utility.set_location(' Leaving: OTA_NHS_BK1.CREATE_NON_OTA_HISTORIES_B', 20);
end CREATE_NON_OTA_HISTORIES_B;
end OTA_NHS_BK1;
