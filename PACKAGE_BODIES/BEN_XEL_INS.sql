--------------------------------------------------------
--  DDL for Package Body BEN_XEL_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_XEL_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_xel_ins.';  -- Global package name
--
--
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure insert_dml(p_rec in out nocopy ben_xel_shd.g_rec_type) is
--
...
Begin
  ...
  --
  -- Insert the row into: ben_ext_data_elmt
  --
  insert into ben_ext_data_elmt
  (	ext_data_elmt_id,
	name,
	xml_tag_name ,
	data_elmt_typ_cd,
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_insert(p_rec  in out nocopy ben_xel_shd.g_rec_type) is
--
  l_proc  varchar2(72) := g_package||'pre_insert';
--
  Cursor C_Sel1 is select ben_ext_data_elmt_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.ext_data_elmt_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
--
  ...
  begin
    ...
    --
    create_app_ownerships('EXT_DATA_ELMT_ID', p_rec.ext_data_elmt_id);
    --
    --
    ben_xel_rki.after_insert
      (
...
Begin
  ...
  --
  ben_xel_bus.insert_validate(p_rec
  ,p_effective_date);
  --
...
Begin
  ...
  --
  p_ext_data_elmt_id := l_rec.ext_data_elmt_id;
