--------------------------------------------------------
--  DDL for Package Body PER_SHT_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_SHT_RKU" as
...
begin
hr_utility.set_location('Entering: per_sht_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: per_sht_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end per_sht_RKU;
