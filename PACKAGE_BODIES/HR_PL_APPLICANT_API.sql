--------------------------------------------------------
--  DDL for Package Body HR_PL_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PL_APPLICANT_API" as
/* $Header: peapppli.pkb 120.1 2005/09/27 03:22:25 mseshadr noship $ */
--
--   package variables
...
g_package := 'hr_pl_applicant_api.';
l_proc    := g_package||'create_pl_applicant OLD';
  hr_utility.set_location('Entering:'|| l_proc, 5);
/*
  Replaced existing code with Call to new overloaded procedure
...
*/
 ...
 hr_pl_applicant_api.create_pl_applicant
