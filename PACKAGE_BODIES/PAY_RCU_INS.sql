--------------------------------------------------------
--  DDL for Package Body PAY_RCU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_RCU_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_rcu_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_retro_component_usage_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_retro_component_usage_id  in  number) is
--
...
Begin
  ...
  --
  pay_rcu_ins.g_retro_component_usage_id_i := p_retro_component_usage_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: pay_retro_component_usages
  --
...
--
  Cursor C_Sel1 is select pay_retro_component_usages_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from pay_retro_component_usages
     where retro_component_usage_id =
             pay_rcu_ins.g_retro_component_usage_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (pay_rcu_ins.g_retro_component_usage_id_i is not null) Then
    --
    ...
    p_rec.retro_component_usage_id :=
      pay_rcu_ins.g_retro_component_usage_id_i;
    pay_rcu_ins.g_retro_component_usage_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.retro_component_usage_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  pay_rcu_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pay_rcu_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pay_rcu_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Procedure ins
  ...
  ,p_retro_component_usage_id          out nocopy number
  ,p_object_version_number             out nocopy number
  ,p_replace_run_flag               in     varchar2 default null
  ,p_use_override_dates             in     varchar2 default null
  ) is
--
...
Begin
  ...
  --
  p_retro_component_usage_id := l_rec.retro_component_usage_id;
