--------------------------------------------------------
--  DDL for Package Body FA_FAS444_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FAS444_XMLP_PKG" AS
/* $Header: FAS444B.pls 120.0.12010000.1 2008/07/28 13:14:41 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    RP_Report_Name := ':Retired Assets Without Property Classes Report:';
