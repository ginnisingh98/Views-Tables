--------------------------------------------------------
--  DDL for Package Body PQH_CEI_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_CEI_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_cei_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the pqh_corps_extra_info row.
  --
  delete from pqh_corps_extra_info
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pqh_cei_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in pqh_cei_shd.g_rec_type) is
--
...
Begin
  ...
  --
  pqh_cei_bus.delete_validate(p_rec);
  --
  ...
  --
  pqh_cei_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  pqh_cei_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  pqh_cei_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
...
Begin
  ...
  --
  l_rec.corps_extra_info_id := p_corps_extra_info_id;
