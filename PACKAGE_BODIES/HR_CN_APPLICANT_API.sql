--------------------------------------------------------
--  DDL for Package Body HR_CN_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_CN_APPLICANT_API" AS
/* $Header: hrcnwraa.pkb 115.2 2003/02/04 07:28:58 statkar noship $ */

--
  g_package  VARCHAR2(33) := 'hr_cn_applicant_api.';
...
--
--  Description:
--      Calls standard API to create an applicant.  Performs mapping of Developer
...
--
  ...
  --
  l_proc                 VARCHAR2(72) := g_package||'create_cn_applicant';
...
--
  ...
  --
   -- Set the g_trace value to its default value.
  IF g_trace THEN
      g_trace:=FALSE;
  END IF;

END create_cn_applicant;
--
--
