--------------------------------------------------------
--  DDL for Package Body BEN_QIG_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_QIG_RKU" as
...
begin
hr_utility.set_location('Entering: BEN_QIG_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: BEN_QIG_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end BEN_QIG_RKU;
