--------------------------------------------------------
--  DDL for Package Body HR_SA_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SA_EMPLOYEE_API" as
/* $Header: peempsai.pkb 120.1 2005/06/14 22:07:07 adevanat noship $ */
--
  g_package  varchar2(33) := 'hr_sa_employee_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_sa_employee >------------------------------|
-- -----------------------------------------------------------------------------
...
is
    ...
    l_proc                 VARCHAR2(72) := g_package||'create_sa_employee';
  ...
  BEGIN
    ...
    hr_employee_api.create_employee
      ...
      ,p_per_information7             => p_religion
      ,p_per_information8             => p_hijrah_birth_date
      ,p_per_information9             => p_hijrah_hire_date
      ,p_per_information10	      => p_education_level
