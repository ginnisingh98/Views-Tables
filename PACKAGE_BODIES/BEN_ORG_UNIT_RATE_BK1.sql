--------------------------------------------------------
--  DDL for Package Body BEN_ORG_UNIT_RATE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ORG_UNIT_RATE_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_ORG_UNIT_RATE_BK1.CREATE_ORG_UNIT_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_ORG_UNIT_RATE_BK1.CREATE_ORG_UNIT_RATE_A', 20);
end CREATE_ORG_UNIT_RATE_A;
...
begin
hr_utility.set_location('Entering: BEN_ORG_UNIT_RATE_BK1.CREATE_ORG_UNIT_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_ORG_UNIT_RATE_BK1.CREATE_ORG_UNIT_RATE_B', 20);
end CREATE_ORG_UNIT_RATE_B;
