--------------------------------------------------------
--  DDL for Package Body AME_GPI_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_GPI_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_gpi_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'AME_APPROVAL_GROUP_ITEMS_PK') Then
...
Begin
  ...
  If (p_effective_date is null or
      p_approval_group_item_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_approval_group_item_id =
        ame_gpi_shd.g_old_rec.approval_group_item_id and
        p_object_version_number =
        ame_gpi_shd.g_old_rec.object_version_number) Then
      --
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into ame_gpi_shd.g_old_rec;
...
--
  ...
  --
  update  ame_approval_group_items t
  set     t.end_date    = p_new_end_date
    ,     t.object_version_number = l_object_version_number
  where   t.approval_group_item_id = p_approval_group_item_id
  and     p_effective_date
...
Begin
  ...
  if (p_datetrack_mode = hr_api.g_update) then
    ...
    p_validation_end_date   := ame_gpi_shd.g_old_rec.end_date;
