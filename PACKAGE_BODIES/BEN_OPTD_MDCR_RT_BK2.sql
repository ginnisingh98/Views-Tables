--------------------------------------------------------
--  DDL for Package Body BEN_OPTD_MDCR_RT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_OPTD_MDCR_RT_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_OPTD_MDCR_RT_BK2.UPDATE_OPTD_MDCR_RT_A', 10);
hr_utility.set_location(' Leaving: BEN_OPTD_MDCR_RT_BK2.UPDATE_OPTD_MDCR_RT_A', 20);
end UPDATE_OPTD_MDCR_RT_A;
...
begin
hr_utility.set_location('Entering: BEN_OPTD_MDCR_RT_BK2.UPDATE_OPTD_MDCR_RT_B', 10);
hr_utility.set_location(' Leaving: BEN_OPTD_MDCR_RT_BK2.UPDATE_OPTD_MDCR_RT_B', 20);
end UPDATE_OPTD_MDCR_RT_B;
