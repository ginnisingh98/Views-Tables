--------------------------------------------------------
--  DDL for Package Body OTA_LPT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_LPT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_lpt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: ota_learning_paths_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.learning_path_id                 := p_learning_path_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  ota_lpt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ota_lpt_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where lpt.learning_path_id = p_learning_path_id
                          and lpt.language = l.language_code);
  --
