--------------------------------------------------------
--  DDL for Package Body HR_EX_EMPLOYEE_BE4
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_EX_EMPLOYEE_BE4" as 
--Code generated on 30/08/2013 11:36:16
/* $Header: hrapiwfe.pkb 120.4.12010000.2 2008/09/29 12:54:07 srgnanas ship $*/
procedure reverse_terminate_employee_a (
p_person_id                    number,
p_actual_termination_date      date,
p_clear_details                varchar2) is
  l_event_key number;
  l_event_data clob;
  ...
  --
  l_proc varchar2(72):='  hr_ex_employee_be4.reverse_terminate_employee_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.ex_employee.reverse_terminate_employee';
