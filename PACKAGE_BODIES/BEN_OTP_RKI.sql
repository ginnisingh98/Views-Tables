--------------------------------------------------------
--  DDL for Package Body BEN_OTP_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_OTP_RKI" as
...
begin
hr_utility.set_location('Entering: ben_otp_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_otp_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_otp_RKI;
