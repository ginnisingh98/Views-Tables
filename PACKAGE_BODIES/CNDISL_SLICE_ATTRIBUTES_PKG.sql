--------------------------------------------------------
--  DDL for Package Body CNDISL_SLICE_ATTRIBUTES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CNDISL_SLICE_ATTRIBUTES_PKG" as
-- $Header: cndislcb.pls 115.1 99/07/16 07:06:33 porting ship $
