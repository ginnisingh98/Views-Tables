--------------------------------------------------------
--  DDL for Package Body HR_SE_ASSIGNMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SE_ASSIGNMENT_API" AS
/* $Header: peasgsei.pkb 120.0 2005/05/31 05:46:49 appldev noship $ */

g_package  VARCHAR2(33) := 'hr_se_assignment_api.';
--
-- ----------------------------------------------------------------------------
-- |---------------------< create_se_secondary_emp_asg >-----------------------|
-- ----------------------------------------------------------------------------
--

PROCEDURE create_se_secondary_emp_asg
  ...
  ,p_ssyk_skills_code		  IN     VARCHAR2 DEFAULT NULL
  ,p_work_title			  IN     VARCHAR2 DEFAULT NULL
  ,p_notification_date		  IN	 VARCHAR2 DEFAULT NULL
  ,p_asg_termination_date	  IN	 VARCHAR2 DEFAULT NULL
  ...
  l_proc               VARCHAR2(72) := g_package||'create_se_secondary_emp_asg';
  v_field	VARCHAR2(20);
  --
  -- Declare cursors
  --
...
BEGIN
  ...
  --
  -- Ensure that the employee IS within a SE business group
  --
  ...
  IF csr_legislation%notfound THEN
    ...
    hr_utility.set_message_token('LEG_CODE', 'SE');
 ...
 hr_assignment_api.create_secondary_emp_asg
  ...
  ,p_scl_segment3                 =>     p_ssyk_skills_code
  ,p_scl_segment4                 =>     p_work_title
  ,p_scl_segment5                 =>     p_notification_date
  ,p_scl_segment6                 =>     p_asg_termination_date
  ,p_scl_segment7                 =>     p_termination_reason
  ...
  --
  END create_se_secondary_emp_asg;

  -- ----------------------------------------------------------------------------
  -- |--------------------------< update_se_emp_asg >---------------------------|
  -- ----------------------------------------------------------------------------
  --
PROCEDURE update_se_emp_asg
  (p_validate                     IN     BOOLEAN  DEFAULT FALSE
  ,p_effective_date               IN     DATE
  ...
  ,p_ssyk_skills_code		  IN     VARCHAR2 DEFAULT hr_api.g_varchar2
  ,p_work_title			  IN     VARCHAR2 DEFAULT hr_api.g_varchar2
  ,p_notification_date		  IN	 VARCHAR2 DEFAULT hr_api.g_varchar2
  ,p_asg_termination_date	  IN	 VARCHAR2 DEFAULT hr_api.g_varchar2
 ...
 --
    -- Declare cursors AND local variables
    --
    l_proc                       VARCHAR2(72) := g_package||'update_se_emp_asg';
    l_effective_date             DATE;
    l_legislation_code           per_business_groups.legislation_code%TYPE;
    l_business_group_id          per_business_groups.business_group_id%type;
    a              varchar2(100);
  ...
  BEGIN
    ...
    --
    -- Check that the legislation of the specified business group IS 'SE.
    --
    IF l_legislation_code <> 'SE' THEN
      hr_utility.set_message(801, 'HR_7961_PER_BUS_GRP_INVALID');
      hr_utility.set_message_token('LEG_CODE','SE');
      hr_utility.raise_error;
    END IF;
    ...
    --
      ...
      ,p_segment3                     => p_ssyk_skills_code
      ,p_segment4                     => p_work_title
      ,p_segment5		      => p_notification_date
      ,p_segment6                     => p_asg_termination_date
      ,p_segment7                     => p_termination_reason
      ,p_soft_coding_keyflex_id       => p_soft_coding_keyflex_id
      ,p_comment_id                   => p_comment_id
      ,p_effective_start_date         => p_effective_start_date
      ,p_effective_END_date           => p_effective_end_date
  ...
  END update_se_emp_asg;


END hr_se_assignment_api;
