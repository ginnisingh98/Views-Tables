--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_PERSONAL_PAY_METH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_PERSONAL_PAY_METH" as
/*
 * Generated by hr_pump_meta_mapper at: 2018/06/16 10:06:10
 * Generated for API: HR_PERSONAL_PAY_METHOD_API.DELETE_PERSONAL_PAY_METHOD
 */
--
...
,P_PERSONAL_PAY_METHOD_USER_KEY in varchar2) is
...
(P_PERSONAL_PAY_METHOD_USER_KEY => c.p5);
end if;
--
if c.p5 is null or
c.p1 is null then
...
end hrdpp_DELETE_PERSONAL_PAY_METH;
