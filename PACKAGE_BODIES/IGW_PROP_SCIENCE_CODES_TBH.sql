--------------------------------------------------------
--  DDL for Package Body IGW_PROP_SCIENCE_CODES_TBH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGW_PROP_SCIENCE_CODES_TBH" AS
/* $Header: igwtkeyb.pls 115.5 2002/11/15 00:45:24 ashkumar ship $ */

   ---------------------------------------------------------------------------

   G_PKG_NAME VARCHAR2(30) := 'IGW_PROP_SCIENCE_CODES_TBH';
   ...
   BEGIN
      ...
      UPDATE igw_prop_science_codes
      SET    science_code = p_science_code,
