--------------------------------------------------------
--  DDL for Package Body CAC_SYNC_TASK_CATEGORY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CAC_SYNC_TASK_CATEGORY" AS
/* $Header: cacvstyb.pls 120.1 2005/07/02 02:21:43 appldev noship $ */
/*======================================================================+
