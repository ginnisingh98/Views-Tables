--------------------------------------------------------
--  DDL for Package Body HR_IPT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_IPT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_ipt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: hr_item_properties_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.item_property_id                 := p_item_property_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  hr_ipt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hr_ipt_ins.post_insert
     (p_rec
     );
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where ipt.item_property_id = p_item_property_id
                          and ipt.language = l.language_code);
  --
