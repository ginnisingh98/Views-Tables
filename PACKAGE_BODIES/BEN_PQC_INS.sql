--------------------------------------------------------
--  DDL for Package Body BEN_PQC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PQC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_pqc_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.prtt_rmt_rqst_ctfn_prvdd_id       = p_rec.prtt_rmt_rqst_ctfn_prvdd_id
    and    t.effective_start_date =
             ben_pqc_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc                varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_prtt_rmt_rqst_ctfn_prvdd_f.created_by%TYPE;
  l_creation_date       ben_prtt_rmt_rqst_ctfn_prvdd_f.creation_date%TYPE;
  l_last_update_date    ben_prtt_rmt_rqst_ctfn_prvdd_f.last_update_date%TYPE;
  l_last_updated_by     ben_prtt_rmt_rqst_ctfn_prvdd_f.last_updated_by%TYPE;
  l_last_update_login   ben_prtt_rmt_rqst_ctfn_prvdd_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_prtt_rmt_rqst_ctfn_prvdd_f
  --
  insert into ben_prtt_rmt_rqst_ctfn_prvdd_f
...
--
  Cursor C_Sel1 is select ben_prtt_rmt_rqst_ctfn_prvdd_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.prtt_rmt_rqst_ctfn_prvdd_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  dt_api.validate_dt_mode
    ...
    ,p_parent_key_value1       => p_rec.pl_gd_r_svc_ctfn_id
...
Begin
  ...
  --
  p_prtt_rmt_rqst_ctfn_prvdd_id      := l_rec.prtt_rmt_rqst_ctfn_prvdd_id;
