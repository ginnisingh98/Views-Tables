--------------------------------------------------------
--  DDL for Package Body JTF_MSITE_RESP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_MSITE_RESP_PVT" AS
/* $Header: JTFVMRSB.pls 115.2 2002/02/14 05:49:39 appldev ship $ */

G_PKG_NAME  CONSTANT VARCHAR2(30):= 'JTF_MSITE_RESP_PVT';
G_FILE_NAME CONSTANT VARCHAR2(12):= 'JTFVMRSB.pls';
...
BEGIN
  ...
  -- Check if msite_id exists in jtf_msites_b
  OPEN c1(p_msite_id);
  FETCH c1 INTO l_tmp_id;
  IF (c1%NOTFOUND) THEN
    CLOSE c1;
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_ID_NOT_FOUND');
...
BEGIN
  ...
  IF (c1%NOTFOUND) THEN
    CLOSE c1;
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_RESP_APPL_NOT_FOUND');
...
BEGIN
  ...
  -- application_id exists in jtf_msite_resps_b
  ...
  THEN
    ...
    IF (c1%NOTFOUND) THEN
      CLOSE c1;
      FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_RESP_NOT_FOUND');
  ...
  THEN
    ...
    IF (c2%NOTFOUND) THEN
      CLOSE c2;
      FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITERESP_NOT_FOUND');
      FND_MESSAGE.Set_Token('MSITE_ID', p_msite_id);
      FND_MESSAGE.Set_Token('RESP_ID', p_responsibility_id);
      FND_MESSAGE.Set_Token('APPL_ID', p_application_id);
      RAISE FND_API.G_EXC_ERROR;
  ...
  ELSE
    ...
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_NO_MR_IDS_SPEC');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_ERROR;
  END IF;
...
BEGIN
  ...
  THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_INVALID_RESP_ID');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_ERROR;
  END IF;
  ...
  IF ((p_application_id IS NULL) OR
      (p_application_id = FND_API.G_MISS_NUM))
  THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_INVALID_APPL_ID');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_ERROR;
  END IF;
  ...
  THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_INVLD_MSRSP_DSP_NAME');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_ERROR;
  END IF;
  ...
  THEN
    IF(p_sort_order < 0) THEN
      FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_INVLD_SORT_ORDER');
      FND_MSG_PUB.Add;
     RAISE FND_API.G_EXC_ERROR;
    END IF;
  END IF;
  ...
  IF (x_return_status = FND_API.G_RET_STS_UNEXP_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_ID_VLD_FAIL');
    FND_MESSAGE.Set_Token('MSITE_ID', p_msite_id);
    FND_MSG_PUB.Add;
  ...
  IF (x_return_status = FND_API.G_RET_STS_UNEXP_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_RESP_ID_VLD_FAIL');
    FND_MESSAGE.Set_Token('RESP_ID', p_responsibility_id);
    FND_MESSAGE.Set_Token('APPL_ID', p_application_id);
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_UNEXPECTED_ERROR;
  ...
  ELSIF (x_return_status = FND_API.G_RET_STS_UNEXP_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSRSP_ID_VLD_FAIL');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_UNEXPECTED_ERROR;
  ELSIF (x_return_status = FND_API.G_RET_STS_SUCCESS) THEN -- duplicate exists
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSRSP_ID_DUP_EXISTS');
    FND_MESSAGE.Set_Token('MSITE_ID', p_msite_id);
    FND_MESSAGE.Set_Token('RESP_ID', p_responsibility_id);
    FND_MESSAGE.Set_Token('APPL_ID', p_application_id);
    FND_MSG_PUB.Add;
...
BEGIN
  ...
  IF (p_msite_resp_id IS NULL) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSRSP_ID_IS_NULL');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_ERROR;
  END IF;
  ...
  THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_OVN_IS_NULL');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_ERROR;
  END IF;
...
BEGIN
  ...
  IF (x_return_status = FND_API.G_RET_STS_UNEXP_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MR_INVALID_CREATE');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_UNEXPECTED_ERROR;
  ELSIF (x_return_status = FND_API.G_RET_STS_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MR_INVALID_CREATE');
  ...
  EXCEPTION
     WHEN NO_DATA_FOUND THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_RESP_INSERT_FL');
       FND_MSG_PUB.Add;
       RAISE FND_API.G_EXC_ERROR;
     WHEN OTHERS THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_RESP_INSERT_FL');
...
BEGIN
  ...
  IF (x_return_status = FND_API.G_RET_STS_UNEXP_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MR_INVALID_UPDATE');
    FND_MSG_PUB.Add;
    RAISE FND_API.G_EXC_UNEXPECTED_ERROR;
  ELSIF (x_return_status = FND_API.G_RET_STS_ERROR) THEN
    FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MR_INVALID_UPDATE');
  ...
  EXCEPTION
     WHEN NO_DATA_FOUND THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_RESP_UPDATE_FL');
       FND_MSG_PUB.ADD;
       RAISE FND_API.G_EXC_ERROR;
     WHEN OTHERS THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_RESP_UPDATE_FL');
...
BEGIN
  ...
  -- delete for jtf_msite_resps_b and _tl tables
  BEGIN
    Jtf_Msite_Resp_Pkg.delete_row(l_msite_resp_id);
  EXCEPTION
     WHEN NO_DATA_FOUND THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_RESP_DELETE_FL');
       FND_MSG_PUB.Add;
       RAISE FND_API.G_EXC_ERROR;
     WHEN OTHERS THEN
       FND_MESSAGE.Set_Name('JTF', 'JTF_MSITE_MSITE_RESP_DELETE_FL');
