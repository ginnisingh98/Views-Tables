--------------------------------------------------------
--  DDL for Package Body OE_1019PC1018_BLKTHDR_BLCUSAC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_1019PC1018_BLKTHDR_BLCUSAC" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_name varchar2(30) :='CUSTOMER_ACCEPTED';
 l_wf_activity_status_code varchar2(8) :='COMPLETE';
   ...
   AND a.ORDER_NUMBER = OE_BLANKET_LINE_SECURITY.g_record.ORDER_NUMBER
;
...
BEGIN 
   ...
   Return; 
END Is_Valid;
END OE_1019PC1018_BLKTHDR_BLCUSAC;
