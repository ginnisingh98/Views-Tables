--------------------------------------------------------
--  DDL for Package Body PER_RECRUITMENT_ACTIVITY_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_RECRUITMENT_ACTIVITY_BE3" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  per_recruitment_activity_be3.delete_recruitment_activity_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.recruitment_activity.delete_recruitment_activity';
...
end per_recruitment_activity_be3;
