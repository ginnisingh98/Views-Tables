--------------------------------------------------------
--  DDL for Package Body OTA_FNS_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_FNS_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_fns_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Update the ota_frm_notif_subscribers Row
  --
  update ota_frm_notif_subscribers
    set
...
Begin
  ...
  --
  ota_fns_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_fns_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_fns_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
