--------------------------------------------------------
--  DDL for Package Body IRC_LOCATION_CRITERIA_VAL_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_LOCATION_CRITERIA_VAL_BE2" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  irc_location_criteria_val_be2.delete_location_criteria_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.location_criteria_val.delete_location_criteria';
...
end delete_location_criteria_a;
end irc_location_criteria_val_be2;
