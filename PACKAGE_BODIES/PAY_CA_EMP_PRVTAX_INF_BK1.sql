--------------------------------------------------------
--  DDL for Package Body PAY_CA_EMP_PRVTAX_INF_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_CA_EMP_PRVTAX_INF_BK1" as
/* $Header: pycprapi.pkb 120.2.12000000.1 2007/01/17 18:11:39 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/06/27 12:05:49 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: PAY_CA_EMP_PRVTAX_INF_BK1.CREATE_CA_EMP_PRVTAX_INF_A', 10);
hr_utility.set_location(' Leaving: PAY_CA_EMP_PRVTAX_INF_BK1.CREATE_CA_EMP_PRVTAX_INF_A', 20);
end CREATE_CA_EMP_PRVTAX_INF_A;
...
begin
hr_utility.set_location('Entering: PAY_CA_EMP_PRVTAX_INF_BK1.CREATE_CA_EMP_PRVTAX_INF_B', 10);
hr_utility.set_location(' Leaving: PAY_CA_EMP_PRVTAX_INF_BK1.CREATE_CA_EMP_PRVTAX_INF_B', 20);
end CREATE_CA_EMP_PRVTAX_INF_B;
