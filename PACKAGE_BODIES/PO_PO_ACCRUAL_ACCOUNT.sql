--------------------------------------------------------
--  DDL for Package Body PO_PO_ACCRUAL_ACCOUNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PO_PO_ACCRUAL_ACCOUNT" AS
/* $Header: POXWFB4B.pls 115.4 2002/11/25 21:50:23 sbull ship $*/
...
BEGIN
  ...
  FND_MESSAGE.SET_TOKEN('FUNC', 'PO_PO_ACCRUAL_ACCOUNT');
