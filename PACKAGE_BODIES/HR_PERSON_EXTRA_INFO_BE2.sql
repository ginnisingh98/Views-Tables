--------------------------------------------------------
--  DDL for Package Body HR_PERSON_EXTRA_INFO_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PERSON_EXTRA_INFO_BE2" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  hr_person_extra_info_be2.update_person_extra_info_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.person_extra_info.update_person_extra_info';
