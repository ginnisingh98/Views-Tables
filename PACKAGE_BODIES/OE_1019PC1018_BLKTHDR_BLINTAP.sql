--------------------------------------------------------
--  DDL for Package Body OE_1019PC1018_BLKTHDR_BLINTAP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_1019PC1018_BLKTHDR_BLINTAP" AS 
 PROCEDURE Is_Valid
 ( 
...
BEGIN 
   ...
   Return; 
END Is_Valid;
END OE_1019PC1018_BLKTHDR_BLINTAP;
