--------------------------------------------------------
--  DDL for Package Body OKL_PROVISIONS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PROVISIONS_PUB_W" as
  /* $Header: OKLUPVNB.pls 120.1 2005/07/18 10:32:39 asawanka noship $ */
  ...
  procedure insert_provisions(p_api_version  NUMBER
  ...
  as
    ddp_pvnv_rec okl_provisions_pub.pvnv_rec_type;
    ddx_pvnv_rec okl_provisions_pub.pvnv_rec_type;
  ...
  begin
    ...
    okl_provisions_pub.insert_provisions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pvnv_tbl okl_provisions_pub.pvnv_tbl_type;
    ddx_pvnv_tbl okl_provisions_pub.pvnv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_provisions(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_provisions_pub.lock_provisions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_provisions_pub.update_provisions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_provisions_pub.delete_provisions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_provisions(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_provisions_pub.validate_provisions(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
