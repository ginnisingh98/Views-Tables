--------------------------------------------------------
--  DDL for Package Body ALR_ACTION_SET_INPUTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ALR_ACTION_SET_INPUTS_PKG" as
/* $Header: ALRASINB.pls 120.3.12010000.1 2008/07/27 06:58:28 appldev ship $ */
procedure INSERT_ROW (
  ...
  cursor C is select ROWID from ALR_ACTION_SET_INPUTS
...
exception
  ...
  ALR_ACTION_SET_INPUTS_PKG.INSERT_ROW(
    X_ROWID => l_row_id,
    X_APPLICATION_ID => l_app_id,
    X_ALERT_ID => l_alert_id,
    X_ACTION_SET_ID => l_action_set_id,
...
begin
  update ALR_ACTION_SET_INPUTS set
    VALUE = X_VALUE,
