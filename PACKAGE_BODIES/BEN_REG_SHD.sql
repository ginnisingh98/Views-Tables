--------------------------------------------------------
--  DDL for Package Body BEN_REG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_REG_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_reg_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_REGN_FK2') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_REGN_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','10');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_REGN_UK1') Then
...
Begin
  ...
  If (p_effective_date is null or
    ...
    l_fct_ret := false;
  Else
    If (p_regn_id = g_old_rec.regn_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_child_table_name1       => 'ben_pl_regn_f',
	 p_child_key_column1       => 'pl_regn_id',
	 p_child_table_name2       => 'ben_regn_for_regy_body_f',
	 p_child_key_column2       => 'regn_for_regy_body_id',
...
Begin
  ...
  l_rec.sttry_citn_name                  := p_sttry_citn_name;
  l_rec.reg_attribute_category           := p_reg_attribute_category;
  l_rec.reg_attribute1                   := p_reg_attribute1;
  l_rec.reg_attribute2                   := p_reg_attribute2;
  l_rec.reg_attribute3                   := p_reg_attribute3;
  l_rec.reg_attribute4                   := p_reg_attribute4;
  l_rec.reg_attribute5                   := p_reg_attribute5;
  l_rec.reg_attribute6                   := p_reg_attribute6;
  l_rec.reg_attribute7                   := p_reg_attribute7;
  l_rec.reg_attribute8                   := p_reg_attribute8;
  l_rec.reg_attribute9                   := p_reg_attribute9;
  l_rec.reg_attribute10                  := p_reg_attribute10;
  l_rec.reg_attribute11                  := p_reg_attribute11;
  l_rec.reg_attribute12                  := p_reg_attribute12;
  l_rec.reg_attribute13                  := p_reg_attribute13;
  l_rec.reg_attribute14                  := p_reg_attribute14;
  l_rec.reg_attribute15                  := p_reg_attribute15;
  l_rec.reg_attribute16                  := p_reg_attribute16;
  l_rec.reg_attribute17                  := p_reg_attribute17;
  l_rec.reg_attribute18                  := p_reg_attribute18;
  l_rec.reg_attribute19                  := p_reg_attribute19;
  l_rec.reg_attribute20                  := p_reg_attribute20;
  l_rec.reg_attribute21                  := p_reg_attribute21;
  l_rec.reg_attribute22                  := p_reg_attribute22;
  l_rec.reg_attribute23                  := p_reg_attribute23;
  l_rec.reg_attribute24                  := p_reg_attribute24;
  l_rec.reg_attribute25                  := p_reg_attribute25;
  l_rec.reg_attribute26                  := p_reg_attribute26;
  l_rec.reg_attribute27                  := p_reg_attribute27;
  l_rec.reg_attribute28                  := p_reg_attribute28;
  l_rec.reg_attribute29                  := p_reg_attribute29;
  l_rec.reg_attribute30                  := p_reg_attribute30;
