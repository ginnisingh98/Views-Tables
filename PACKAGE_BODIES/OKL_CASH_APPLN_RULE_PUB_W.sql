--------------------------------------------------------
--  DDL for Package Body OKL_CASH_APPLN_RULE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CASH_APPLN_RULE_PUB_W" as
  /* $Header: OKLUCSLB.pls 120.2 2005/10/30 03:48:47 appldev noship $ */
  ...
  as
    ddp_catv_tbl okl_cash_appln_rule_pub.catv_tbl_type;
    ddx_catv_tbl okl_cash_appln_rule_pub.catv_tbl_type;
  ...
  begin
    ...
    okl_cat_pvt_w.rosetta_table_copy_in_p5(ddp_catv_tbl, p2_a0
      , p2_a1
      , p2_a2
      , p2_a3
      , p2_a4
    ...
    okl_cash_appln_rule_pub.maint_cash_appln_rule(p_api_version,
      p_init_msg_list,
      ddp_catv_tbl,
      ddx_catv_tbl,
      x_return_status,
    ...
    okl_cat_pvt_w.rosetta_table_copy_out_p5(ddx_catv_tbl, p3_a0
      , p3_a1
      , p3_a2
      , p3_a3
      , p3_a4
