--------------------------------------------------------
--  DDL for Package Body BEN_BENEFIT_GRP_RATE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENEFIT_GRP_RATE_BK1" as
/* $Header: bebrgapi.pkb 120.0 2005/05/28 00:50:31 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/01/04 08:37:49 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: BEN_BENEFIT_GRP_RATE_BK1.CREATE_BENEFIT_GRP_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_BENEFIT_GRP_RATE_BK1.CREATE_BENEFIT_GRP_RATE_A', 20);
end CREATE_BENEFIT_GRP_RATE_A;
...
begin
hr_utility.set_location('Entering: BEN_BENEFIT_GRP_RATE_BK1.CREATE_BENEFIT_GRP_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_BENEFIT_GRP_RATE_BK1.CREATE_BENEFIT_GRP_RATE_B', 20);
end CREATE_BENEFIT_GRP_RATE_B;
