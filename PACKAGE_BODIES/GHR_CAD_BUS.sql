--------------------------------------------------------
--  DDL for Package Body GHR_CAD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_CAD_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ghr_cad_bus.';  -- Global package name
--
-- The following two global variables are only to be
-- used by the return_legislation_code function.
--
g_legislation_code            varchar2(150)  default null;
g_compl_adr_id                number         default null;
--
--  ---------------------------------------------------------------------------
...
Procedure set_security_group_id
  ...
  -- ghr_compl_adrs and PER_BUSINESS_GROUPS
  ...
  cursor csr_sec_grp is
    select pbg.security_group_id
     ...
     where cad.compl_adr_id = p_compl_adr_id;
...
Begin
  ...
  --
  if ( nvl(ghr_cad_bus.g_compl_adr_id, hr_api.g_number)
       = p_compl_adr_id) then
    --
    ...
    -- variable.
    --
    l_legislation_code := ghr_cad_bus.g_legislation_code;
    ...
    --
    close csr_leg_code;
    ghr_cad_bus.g_compl_adr_id                := p_compl_adr_id;
    ghr_cad_bus.g_legislation_code  := l_legislation_code;
  end if;
...
Begin
  ...
  --
  IF NOT ghr_cad_shd.api_updating
