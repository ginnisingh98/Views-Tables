--------------------------------------------------------
--  DDL for Package Body XNP_LI_DONE_U
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."XNP_LI_DONE_U" AS
/*$Header: XNPLIDNB.pls 115.0 2000/02/03 22:41:53 pkm ship        $*/
...
/* append header parameters to make header */
  ...
  l_msg_header.message_code := 'LI_DONE' ;
...
/* check if the recipient list is NULL */
  ...
  IF (l_recipient_list IS NULL) THEN
    XNP_MESSAGE.GET_SUBSCRIBER_LIST( 'LI_DONE', l_recipient_list );
