--------------------------------------------------------
--  DDL for Package Body OKL_PQV_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PQV_PVT_W" as
  /* $Header: OKLIPQVB.pls 115.10 2002/12/24 04:08:56 sgorantl noship $ */
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).pdq_id := rosetta_g_miss_num_map(a1(indx));
          t(ddindx).pdt_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).qve_id := rosetta_g_miss_num_map(a3(indx));
    ...
    a11 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := rosetta_g_miss_num_map(t(ddindx).pdq_id);
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).pdt_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).qve_id);
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).pdq_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).pdt_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).qve_id := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).from_date := rosetta_g_miss_date_in_map(a5(indx));
          t(ddindx).to_date := rosetta_g_miss_date_in_map(a6(indx));
          t(ddindx).created_by := rosetta_g_miss_num_map(a7(indx));
          t(ddindx).creation_date := rosetta_g_miss_date_in_map(a8(indx));
    ...
    a11 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).pdq_id);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).pdt_id);
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).qve_id);
          a5(indx) := t(ddindx).from_date;
          a6(indx) := t(ddindx).to_date;
          a7(indx) := rosetta_g_miss_num_map(t(ddindx).created_by);
          a8(indx) := t(ddindx).creation_date;
  ...
  as
    ddp_pqvv_rec okl_pqv_pvt.pqvv_rec_type;
    ddx_pqvv_rec okl_pqv_pvt.pqvv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_pqv_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pqvv_tbl okl_pqv_pvt.pqvv_tbl_type;
    ddx_pqvv_tbl okl_pqv_pvt.pqvv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pqv_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pqv_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pqv_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pqv_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
