--------------------------------------------------------
--  DDL for Package Body BEN_REGULATORY_PURPOSE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_REGULATORY_PURPOSE_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_REGULATORY_PURPOSE_BK1.CREATE_REGULATORY_PURPOSE_A', 10);
hr_utility.set_location(' Leaving: BEN_REGULATORY_PURPOSE_BK1.CREATE_REGULATORY_PURPOSE_A', 20);
end CREATE_REGULATORY_PURPOSE_A;
...
begin
hr_utility.set_location('Entering: BEN_REGULATORY_PURPOSE_BK1.CREATE_REGULATORY_PURPOSE_B', 10);
hr_utility.set_location(' Leaving: BEN_REGULATORY_PURPOSE_BK1.CREATE_REGULATORY_PURPOSE_B', 20);
end CREATE_REGULATORY_PURPOSE_B;
