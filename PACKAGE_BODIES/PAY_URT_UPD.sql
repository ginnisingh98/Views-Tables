--------------------------------------------------------
--  DDL for Package Body PAY_URT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_URT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_urt_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the pay_user_rows_f_tl Row
  --
...
Begin
  ...
  --
  pay_urt_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  pay_urt_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  --pay_urt_upd.post_update(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
End upd;
  ...
  cursor csr_upd_langs is
    select prt.language
     ...
     where prt.user_row_id = p_user_row_id
       and p_language_code in (prt.language
                              ,prt.source_lang);
  --
