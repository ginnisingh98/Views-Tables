--------------------------------------------------------
--  DDL for Package Body OKL_TAO_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TAO_PVT_W" as
  /* $Header: OKLITAOB.pls 120.1 2005/07/15 07:40:04 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_tao_pvt.tao_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).rev_ccid := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).freight_ccid := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).rec_ccid := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).clearing_ccid := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).tax_ccid := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).unbilled_ccid := rosetta_g_miss_num_map(a7(indx));
          t(ddindx).unearned_ccid := rosetta_g_miss_num_map(a8(indx));
          ...
          t(ddindx).post_to_gl_yn := a32(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p2(t okl_tao_pvt.tao_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a32 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).rev_ccid);
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).freight_ccid);
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).rec_ccid);
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).clearing_ccid);
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).tax_ccid);
          a7(indx) := rosetta_g_miss_num_map(t(ddindx).unbilled_ccid);
          a8(indx) := rosetta_g_miss_num_map(t(ddindx).unearned_ccid);
          ...
          a32(indx) := t(ddindx).post_to_gl_yn;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_tao_pvt.taov_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).unearned_ccid := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).rev_ccid := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).freight_ccid := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).rec_ccid := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).clearing_ccid := rosetta_g_miss_num_map(a7(indx));
          t(ddindx).tax_ccid := rosetta_g_miss_num_map(a8(indx));
          t(ddindx).unbilled_ccid := rosetta_g_miss_num_map(a9(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_tao_pvt.taov_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    , a3 out nocopy JTF_NUMBER_TABLE
    , a4 out nocopy JTF_NUMBER_TABLE
    ...
    a32 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).unearned_ccid);
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).rev_ccid);
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).freight_ccid);
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).rec_ccid);
          a7(indx) := rosetta_g_miss_num_map(t(ddindx).clearing_ccid);
          a8(indx) := rosetta_g_miss_num_map(t(ddindx).tax_ccid);
          a9(indx) := rosetta_g_miss_num_map(t(ddindx).unbilled_ccid);
  ...
  as
    ddp_taov_rec okl_tao_pvt.taov_rec_type;
    ddx_taov_rec okl_tao_pvt.taov_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_tao_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_taov_tbl okl_tao_pvt.taov_tbl_type;
    ddx_taov_tbl okl_tao_pvt.taov_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_tao_pvt_w.rosetta_table_copy_in_p5(ddp_taov_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_tao_pvt_w.rosetta_table_copy_out_p5(ddx_taov_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_tao_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_tao_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_tao_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_tao_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
