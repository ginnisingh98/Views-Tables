--------------------------------------------------------
--  DDL for Package Body CE_CEXTRXCD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CE_CEXTRXCD_XMLP_PKG" AS
/* $Header: CEXTRXCDB.pls 120.0 2007/12/28 07:58:00 abraghun noship $ */
      ...
      BEGIN
        ...
        ELSE
          ...
          WHERE B.BRANCH_PARTY_ID = A.BANK_BRANCH_ID
            AND A.BANK_ACCOUNT_ID = P_BANK_ACCOUNT_ID;
        END IF;
      EXCEPTION
        WHEN OTHERS THEN
          SET_NAME('CE'
  ...
  BEGIN
    ...
    RETURN (TRUE);
  END AFTERREPORT;
  FUNCTION G_BANK_ACCOUNTGROUPFILTER(TYPE_DSP IN VARCHAR2) RETURN BOOLEAN IS
  BEGIN
    IF (TYPE_DSP = '') THEN
      C_THE_END := 'N';
    ELSE
