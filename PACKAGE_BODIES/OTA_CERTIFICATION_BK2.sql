--------------------------------------------------------
--  DDL for Package Body OTA_CERTIFICATION_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CERTIFICATION_BK2" as
...
begin
hr_utility.set_location('Entering: OTA_CERTIFICATION_BK2.UPDATE_CERTIFICATION_A', 10);
hr_utility.set_location(' Leaving: OTA_CERTIFICATION_BK2.UPDATE_CERTIFICATION_A', 20);
end UPDATE_CERTIFICATION_A;
...
begin
hr_utility.set_location('Entering: OTA_CERTIFICATION_BK2.UPDATE_CERTIFICATION_B', 10);
hr_utility.set_location(' Leaving: OTA_CERTIFICATION_BK2.UPDATE_CERTIFICATION_B', 20);
end UPDATE_CERTIFICATION_B;
