--------------------------------------------------------
--  DDL for Package Body PQH_BUDGET_PERIODS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_BUDGET_PERIODS_BK2" as
...
begin
hr_utility.set_location('Entering: PQH_BUDGET_PERIODS_BK2.UPDATE_BUDGET_PERIOD_A', 10);
hr_utility.set_location(' Leaving: PQH_BUDGET_PERIODS_BK2.UPDATE_BUDGET_PERIOD_A', 20);
end UPDATE_BUDGET_PERIOD_A;
...
begin
hr_utility.set_location('Entering: PQH_BUDGET_PERIODS_BK2.UPDATE_BUDGET_PERIOD_B', 10);
hr_utility.set_location(' Leaving: PQH_BUDGET_PERIODS_BK2.UPDATE_BUDGET_PERIOD_B', 20);
end UPDATE_BUDGET_PERIOD_B;
