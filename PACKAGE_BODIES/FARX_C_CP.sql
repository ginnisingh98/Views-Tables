--------------------------------------------------------
--  DDL for Package Body FARX_C_CP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FARX_C_CP" as
/* $Header: farxccpb.pls 120.2.12010000.2 2009/07/19 10:52:24 glchen ship $ */
...
--  and fcp.concurrent_program_name = 'RXFACAP';
