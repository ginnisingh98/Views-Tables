--------------------------------------------------------
--  DDL for Package Body OKL_SETUP_STRMS_TRANS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUP_STRMS_TRANS_PUB_W" as
  /* $Header: OKLUSMNB.pls 120.1 2005/07/19 07:30:46 asawanka noship $ */
  ...
  as
    ddp_sgnv_tbl okl_setup_strms_trans_pub.sgnv_tbl_type;
    ddx_sgnv_tbl okl_setup_strms_trans_pub.sgnv_tbl_type;
  ...
  begin
    ...
    okl_setup_strms_trans_pub.insert_translations(p_api_version,
      p_init_msg_list,
      ddp_sgnv_tbl,
      ddx_sgnv_tbl,
      x_return_status,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setup_strms_trans_pub.update_translations(p_api_version,
      p_init_msg_list,
      ddp_sgnv_tbl,
      ddx_sgnv_tbl,
      x_return_status,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setup_strms_trans_pub.delete_translations(p_api_version,
      p_init_msg_list,
      ddp_sgnv_tbl,
      x_return_status,
      x_msg_count,
