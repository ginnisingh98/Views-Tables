--------------------------------------------------------
--  DDL for Package Body BEN_EPE_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EPE_RKU" as
/* $Header: beeperhi.pkb 120.0 2005/05/28 02:36:58 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_epe_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_epe_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_epe_RKU;
