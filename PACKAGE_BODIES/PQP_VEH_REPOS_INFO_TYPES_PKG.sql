--------------------------------------------------------
--  DDL for Package Body PQP_VEH_REPOS_INFO_TYPES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_VEH_REPOS_INFO_TYPES_PKG" as
/* $Header: pqpvehrepeit.pkb 120.0 2005/05/29 02:22:31 appldev noship $ */
------------------------------------------------------------------------------
/*
==============================================================================
...
CURSOR C1 IS
 	select  1
 	from    pqp_veh_repos_info_types t
...
procedure INSERT_ROW (
  ...
  cursor C is select ROWID from pqp_veh_repos_info_types
...
begin
  update pqp_veh_repos_info_types set
...
begin
  ...
  delete from pqp_veh_repos_info_types
  where INFORMATION_TYPE = X_INFORMATION_TYPE;
...
is
  l_proc                        VARCHAR2(61) := 'pqp_veh_repos_info_types_pkg.LOAD_ROW';
  l_rowid                       rowid;
  l_created_by                  pqp_veh_repos_info_types.created_by%TYPE             := 0;
  l_creation_date               pqp_veh_repos_info_types.creation_date%TYPE          := SYSDATE;
  l_last_update_date            pqp_veh_repos_info_types.last_update_date%TYPE       := SYSDATE;
  l_last_updated_by             pqp_veh_repos_info_types.last_updated_by%TYPE         := 0;
  l_last_update_login           pqp_veh_repos_info_types.last_update_login%TYPE      := 0;
begin
...
is
begin
  UPDATE pqp_veh_repos_info_types
