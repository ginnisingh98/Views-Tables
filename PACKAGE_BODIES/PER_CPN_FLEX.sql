--------------------------------------------------------
--  DDL for Package Body PER_CPN_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CPN_FLEX" as
/* $Header: pecpnfli.pkb 115.1 99/07/17 18:51:24 porting ship $ */
--
--
-- ---------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_cpn_flex.';  -- Global package name
--
--
--
----------------------------------------------------------------------------
