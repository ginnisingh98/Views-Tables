--------------------------------------------------------
--  DDL for Package Body IGS_UC_REF_COUNTRY_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_UC_REF_COUNTRY_PKG" AS
/* $Header: IGSXI55B.pls 120.0 2006/08/21 03:42:56 jbaber noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_uc_ref_country%ROWTYPE;
  new_references igs_uc_ref_country%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND ((tlinfo.type = x_type) OR ((tlinfo.type IS NULL) AND (X_type IS NULL)))
