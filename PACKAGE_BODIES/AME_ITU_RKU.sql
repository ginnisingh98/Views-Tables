--------------------------------------------------------
--  DDL for Package Body AME_ITU_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ITU_RKU" as
...
begin
hr_utility.set_location('Entering: AME_ITU_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: AME_ITU_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end AME_ITU_RKU;
