--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_PTNL_LER_FOR_PER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_PTNL_LER_FOR_PER" as
/*
 * Generated by hr_pump_meta_mapper at: 2013/08/29 22:08:12
 * Generated for API: ben_ptnl_ler_for_per_api.DELETE_PTNL_LER_FOR_PER
 */
--
...
,P_PTNL_LER_FOR_PER_USER_KEY in varchar2) is
...
(P_PTNL_LER_FOR_PER_USER_KEY => c.p2);
end if;
--
if c.p2 is null then
...
end hrdpp_DELETE_PTNL_LER_FOR_PER;
