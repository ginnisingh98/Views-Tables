--------------------------------------------------------
--  DDL for Package Body OKL_RULE_APIS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_RULE_APIS_PVT_W" as
  /* $Header: OKLERAPB.pls 120.2 2005/08/03 05:51:10 asawanka noship $ */
  ...
  as
    ddx_rgpv_tbl okl_rule_apis_pvt.rgpv_tbl_type;
  ...
  begin
    ...
    okl_rule_apis_pvt.get_contract_rgs(p_api_version,
      p_init_msg_list,
      p_chr_id,
      p_cle_id,
      p_rgd_code,
  ...
  as
    ddp_rgpv_rec okl_rule_apis_pvt.rgpv_rec_type;
    ddx_rulv_tbl okl_rule_apis_pvt.rulv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_rule_apis_pvt.get_contract_rules(p_api_version,
      p_init_msg_list,
      ddp_rgpv_rec,
      p_rdf_code,
      x_return_status,
  ...
  as
    ddp_rulv_rec okl_rule_apis_pvt.rulv_rec_type;
    ddx_rulv_disp_rec okl_rule_apis_pvt.rulv_disp_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_rule_apis_pvt.get_rule_disp_value(p_api_version,
      p_init_msg_list,
      ddp_rulv_rec,
      x_return_status,
      x_msg_count,
