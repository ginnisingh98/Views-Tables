--------------------------------------------------------
--  DDL for Package Body HR_APPRAISAL_TEMPLATES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_APPRAISAL_TEMPLATES_BK1" as
...
begin
hr_utility.set_location('Entering: HR_APPRAISAL_TEMPLATES_BK1.CREATE_APPRAISAL_TEMPLATE_A', 10);
hr_utility.set_location(' Leaving: HR_APPRAISAL_TEMPLATES_BK1.CREATE_APPRAISAL_TEMPLATE_A', 20);
end CREATE_APPRAISAL_TEMPLATE_A;
...
begin
hr_utility.set_location('Entering: HR_APPRAISAL_TEMPLATES_BK1.CREATE_APPRAISAL_TEMPLATE_B', 10);
hr_utility.set_location(' Leaving: HR_APPRAISAL_TEMPLATES_BK1.CREATE_APPRAISAL_TEMPLATE_B', 20);
end CREATE_APPRAISAL_TEMPLATE_B;
