--------------------------------------------------------
--  DDL for Package Body BIS_CUSTOM_RELATED_LINKS_MLS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BIS_CUSTOM_RELATED_LINKS_MLS" AS
/* $Header: BISPCRLB.pls 120.0 2005/10/14 13:19:26 slowe noship $ */
/*
REM +=======================================================================+
...
BEGIN
    ...
    DELETE FROM BIS_CUSTOM_RELATED_LINKS_TL T
    WHERE NOT EXISTS
    (
      SELECT NULL
      FROM   BIS_CUSTOM_RELATED_LINKS B
