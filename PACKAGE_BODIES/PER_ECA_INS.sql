--------------------------------------------------------
--  DDL for Package Body PER_ECA_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ECA_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_eca_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
l_proc  varchar2(72) := g_package||'insert_dml';
  l_created_by          per_election_candidates.created_by%TYPE;
  l_creation_date       per_election_candidates.creation_date%TYPE;
...
--
-- Insert the row into: per_election_candidates
--
insert into per_election_candidates
...
--
Cursor C_Sel1 is select per_election_candidates_s.nextval from sys.dual;
--
Begin
hr_utility.set_location('Entering:'||l_proc, 5);
--
...
--
Open C_Sel1;
Fetch C_Sel1 Into p_rec.election_candidate_id;
Close C_Sel1;
--
hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  If p_validate then
    ...
    -- Issue the savepoint.
    --
    SAVEPOINT ins_per_eca;
  End If;

  --
  -- Call the supporting insert validate operations
  --
  per_eca_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  per_eca_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  per_eca_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  per_eca_ins.post_insert
     (p_rec
     );
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the per_eca_rec
  ...
  --
  p_election_candidate_id := l_rec.election_candidate_id;
