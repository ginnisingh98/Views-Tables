--------------------------------------------------------
--  DDL for Package Body WMS_RULE_4
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WMS_RULE_4" AS
...
,base.grade_code 
,NULL consist_string
,msn.SERIAL_NUMBER order_by_string
...
and msn.INVENTORY_ITEM_ID = base.INVENTORY_ITEM_ID
and msn.SERIAL_NUMBER = base.SERIAL_NUMBER
and (
 msi.SERIAL_NUMBER_CONTROL_CODE = 2
or msi.SERIAL_NUMBER_CONTROL_CODE = 5
)
 order by msn.SERIAL_NUMBER asc
,base.SERIAL_NUMBER asc,base.CONVERSION_RATE desc
;
...
,base.UOM_CODE
,base.GRADE_CODE
,msn.SERIAL_NUMBER,base.SERIAL_NUMBER,base.CONVERSION_RATE
,msn.SERIAL_NUMBER
 order by msn.SERIAL_NUMBER asc
,base.SERIAL_NUMBER asc,base.CONVERSION_RATE desc
;
