--------------------------------------------------------
--  DDL for Package Body BEN_ELIG_AGE_CVG_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIG_AGE_CVG_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_ELIG_AGE_CVG_BK2.UPDATE_ELIG_AGE_CVG_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_AGE_CVG_BK2.UPDATE_ELIG_AGE_CVG_A', 20);
end UPDATE_ELIG_AGE_CVG_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIG_AGE_CVG_BK2.UPDATE_ELIG_AGE_CVG_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_AGE_CVG_BK2.UPDATE_ELIG_AGE_CVG_B', 20);
end UPDATE_ELIG_AGE_CVG_B;
