--------------------------------------------------------
--  DDL for Package Body OE_HEADER_SCREDIT_PCFWK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_HEADER_SCREDIT_PCFWK" AS
/* $Header: OEXKHSCB.pls 120.0 2005/06/01 00:16:47 appldev noship $ */

-- Globals
-------------------------------------------
 g_application_id     constant number := 660;
 g_entity_id          constant number := 5;
 g_entity_short_name  constant varchar2(15) := 'HEADER_SCREDIT';
-------------------------------------------
