--------------------------------------------------------
--  DDL for Package Body IRC_INTERVIEW_DETAILS_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_INTERVIEW_DETAILS_BK2" as
...
begin
hr_utility.set_location('Entering: IRC_INTERVIEW_DETAILS_BK2.UPDATE_IRC_INTERVIEW_DETAILS_A', 10);
hr_utility.set_location(' Leaving: IRC_INTERVIEW_DETAILS_BK2.UPDATE_IRC_INTERVIEW_DETAILS_A', 20);
end UPDATE_IRC_INTERVIEW_DETAILS_A;
...
begin
hr_utility.set_location('Entering: IRC_INTERVIEW_DETAILS_BK2.UPDATE_IRC_INTERVIEW_DETAILS_B', 10);
hr_utility.set_location(' Leaving: IRC_INTERVIEW_DETAILS_BK2.UPDATE_IRC_INTERVIEW_DETAILS_B', 20);
end UPDATE_IRC_INTERVIEW_DETAILS_B;
