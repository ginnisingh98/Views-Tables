--------------------------------------------------------
--  DDL for Package Body BEN_EBN_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EBN_RKU" as
...
begin
hr_utility.set_location('Entering: ben_ebn_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_ebn_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_ebn_RKU;
