--------------------------------------------------------
--  DDL for Package Body OKL_FE_ADJ_MATRIX_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_FE_ADJ_MATRIX_PVT_W" as
  /* $Header: OKLEPAMB.pls 120.0 2005/07/07 10:37:39 viselvar noship $ */
  procedure rosetta_table_copy_in_p6(t out nocopy okl_fe_adj_matrix_pvt.invalid_object_tbl, a0 JTF_NUMBER_TABLE
  ...
  procedure rosetta_table_copy_out_p6(t okl_fe_adj_matrix_pvt.invalid_object_tbl, a0 out nocopy JTF_NUMBER_TABLE
  ...
  as
    ddx_pamv_rec okl_fe_adj_matrix_pvt.okl_pamv_rec;
    ddx_pal_rec okl_fe_adj_matrix_pvt.okl_pal_rec;
    ddx_ech_rec okl_fe_adj_matrix_pvt.okl_ech_rec;
    ddx_ecl_tbl okl_fe_adj_matrix_pvt.okl_ecl_tbl;
    ddx_ecv_tbl okl_fe_adj_matrix_pvt.okl_ecv_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_fe_adj_matrix_pvt.get_version(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pal_rec okl_fe_adj_matrix_pvt.okl_pal_rec;
    ddx_pal_rec okl_fe_adj_matrix_pvt.okl_pal_rec;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_adj_matrix_pvt.create_version(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pamv_rec okl_fe_adj_matrix_pvt.okl_pamv_rec;
    ddp_pal_rec okl_fe_adj_matrix_pvt.okl_pal_rec;
    ddx_pamv_rec okl_fe_adj_matrix_pvt.okl_pamv_rec;
    ddx_pal_rec okl_fe_adj_matrix_pvt.okl_pal_rec;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_adj_matrix_pvt.insert_adj_mat(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_adj_matrix_pvt.update_adj_mat(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pal_rec okl_fe_adj_matrix_pvt.okl_pal_rec;
    ddp_ech_rec okl_fe_adj_matrix_pvt.okl_ech_rec;
    ddp_ecl_tbl okl_fe_adj_matrix_pvt.okl_ecl_tbl;
    ddp_ecv_tbl okl_fe_adj_matrix_pvt.okl_ecv_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  as
    ddx_obj_tbl okl_fe_adj_matrix_pvt.invalid_object_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_adj_matrix_pvt.invalid_objects(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_adj_matrix_pvt.calc_start_date(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
