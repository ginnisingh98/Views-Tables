--------------------------------------------------------
--  DDL for Package Body WF_ENGINE_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WF_ENGINE_UTIL" as
...
begin
  ...
  begin
   begin
    ...
    --Bug 18597161. If this is a WAIT activity we can execute at once as it will
    --be deferred by definition.
    if upper(funname)='WF_STANDARD.WAIT' then
