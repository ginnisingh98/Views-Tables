--------------------------------------------------------
--  DDL for Package Body HRWSECI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRWSECI" AS
/* $Header: pecobeci.pkb 115.7 1999/11/05 15:04:40 pkm ship      $ */
--
--
--
...
FUNCTION person_disabled (p_person_id             IN NUMBER,
  ...
  l_package      VARCHAR2(70) := 'hrwseci.person_disabled';
  --
...
begin
  ...
  open c1;
    ...
    loop
      ...
      if l_months > 0 then
        --
        l_total_months := l_total_months + l_months;
        --
      end if;
      --
    end loop;
  ...
  close c1;
  --
  -- Add current enrollment months
  --
  l_total_months := l_total_months + months_between(p_coverage_end_date,
                                                    p_coverage_start_date);
  --
  if l_total_months > 36 then
    --
    return true;
    --
  else
...
PROCEDURE check_cobra_coverage_period
                 (p_qualifying_event      IN VARCHAR2,
                  ...
                  p_coverage_uom          OUT VARCHAR2) IS
  --
  l_package      VARCHAR2(70) := 'hrwseci.check_cobra_coverage_period';
  --
  ...
  CURSOR C1 IS
    ...
    AND    HR1.lookup_type = 'US_COBRA_EVENT'
    AND    HR1.lookup_code = CCP.qualifying_event
    AND    HR2.lookup_type = 'US_COBRA_SPECIAL_TYPES'
    AND    HR2.lookup_code = CCP.type_code
    AND    HR3.lookup_type = 'US_COBRA_COVERAGE_UOM'
    AND    HR3.lookup_code = CCP.coverage_uom
    AND    p_qualifying_start_date
...
PROCEDURE hr_cobra_chk_event_eligible (p_organization_id NUMBER,
				       ...
				       p_position_id NUMBER,
                                       p_qualifying_event VARCHAR2,
                                       p_qualifying_date IN OUT DATE ) IS
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_cobra_chk_event_eligible', 0);
--
--
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_cobra_chk_benefits_exist', 0);
--
--
...
PROCEDURE hr_get_assignment_info (p_assignment_id NUMBER,
				  ...
				  p_position_id IN OUT NUMBER) IS
--
-- declare cursor
--
   CURSOR org_id IS
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_get_assignment_info', 0);
--
-- get org id
--
   OPEN  org_id;
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_cobra_chk_elect_status', 0);
--
 --
 -- fetch status
 --
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_cobra_get_await_meaning', 0);
--
--
-- get the meaning
--
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_cobra_get_period_type', 0);
--
--
...
--
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_insert',1);
--
...
--
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_insert',2);
--
...
--
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_insert',3);
--
...
--
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_insert',4);
--
...
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_insert',7);
--
   hr_cobra_ins_benefits(p_cobra_coverage_enrollment_id,
                         ...
                         p_qualifying_date);
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_insert',8);
--
--
-- Calculate amount charged
--
   p_amount_charged := hr_cobra_calc_amt_charged ( p_cobra_coverage_enrollment_id );
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_insert',9);
--
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_cobra_ins_benefits', 0);
--
--
-- insert benefits
--
...
-- Notes
--
FUNCTION hr_cobra_calc_amt_charged ( p_cobra_coverage_enrollment_id NUMBER ) RETURN VARCHAR2 IS
--
-- declare local variables
--
   l_amount_charged VARCHAR2(60);
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_cobra_calc_amt_charged', 0);
--
--
-- get amount charged
--
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_cobra_ins_schedule', 0);
--
...
PROCEDURE hr_cobra_do_cce_update ( p_Rowid                        IN OUT VARCHAR2,
                               ...
                               p_amount_charged                 IN OUT  VARCHAR2 ) IS
--
-- declare local variables
--
BEGIN
...
--   hr_utility.trace_on;
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_update', 1);
--
   per_cobra_cov_enrollments_pkg.hr_cobra_chk_unique_enrollment (
    p_cobra_coverage_enrollment_id,
    p_assignment_id,
    ...
    p_qualifying_date );
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_update', 2);
--
-- do update
--
...
--
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_update', 3);
--
--
...
--
  ...
  THEN
      ...
      --
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_update', 4);
--
         ...
         THEN
             ...
             --
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_update', 5);
--
      ...
      --
   END IF;
hr_utility.set_location('hrwseci.hr_cobra_do_cce_update', 6);
--
--
-- calculate amount charged
--
   p_amount_charged := hr_cobra_calc_amt_charged( p_cobra_coverage_enrollment_id );
--
hr_utility.set_location('hrwseci.hr_cobra_do_cce_update', 7);
...
--
   IF ( p_old_first_payment_due_date IS NOT NULL AND
        p_first_payment_due_date     IS NOT NULL )
   THEN
        IF ( TO_DATE(p_old_first_payment_due_date,'DD-MON-YYYY') <> p_first_payment_due_date )
        THEN
        hr_cobra_ins_schedule( p_business_group_id,
                               p_cobra_coverage_enrollment_id,
                               p_event_coverage,
                               ...
                               p_grace_days );
        END IF;
   ELSIF ( p_first_payment_due_date IS NOT NULL )
   THEN
        hr_cobra_ins_schedule( p_business_group_id,
                               p_cobra_coverage_enrollment_id,
                               p_event_coverage,
...
PROCEDURE hr_cobra_get_current_status ( p_cobra_coverage_enrollment_id NUMBER,
                                        ...
                                        p_status_meaning        IN OUT VARCHAR2,
                                        p_status_date           IN OUT DATE,
                                        p_d_status_date         IN OUT DATE ) IS
--
-- declare local variables
--
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_cobra_get_current_status', 0);
--
--
...
--   hr_utility.trace_on;
--
hr_utility.set_location('hrwseci.hr_cobra_do ccs insert', 1);
--
--
...
--
hr_utility.set_location('hrwseci.hr_cobra_do ccs insert', 2);
--
--
...
--
   ...
   END IF;
--
hr_utility.set_location('hrwseci.hr_cobra_do ccs insert', 3);
--
--
...
--
   per_cobra_cov_statuses_pkg.hr_cobra_chk_status_order
				 ...
				 p_effective_date );
--
hr_utility.set_location('hrwseci.hr_cobra_do ccs insert', 4);
--
--
-- do insert
--
   per_cobra_cov_statuses_pkg.insert_row
                             ( p_Rowid,
                               ...
                               p_comments );
--
hr_utility.set_location('hrwseci.hr_cobra_do ccs insert', 5);
--
--
...
--
hr_utility.set_location('hrwseci.hr_cobra_do ccs insert', 6);
--
--
...
--
--
hr_utility.set_location('hrwseci.hr_cobra_do_ccs_update', 1);
--
-- Call to check status is unique
--
   per_cobra_cov_statuses_pkg.hr_cobra_chk_status_unique
...
--
--
hr_utility.set_location('hrwseci.hr_cobra_do_ccs_update', 2);
--
...
--
  ...
  THEN
      --
hr_utility.set_location('hrwseci.hr_cobra_chk_do_ccs_update', 4);
      per_cobra_cov_statuses_pkg.hr_cobra_chk_status_elect_rej (
                                   p_business_group_id,
                                   p_cobra_coverage_enrollment_id,
                                   p_cobra_coverage_status_id,
   ...
   END IF;
--
hr_utility.set_location('hrwseci.hr_cobra_chk_do_ccs_update', 3);
--
--
-- check status order
--
...
--
--
hr_utility.set_location('hrwseci.hr_cobra_chk_do_ccs_update', 5);
--
...
PROCEDURE hr_cobra_button_status ( p_business_group_id          NUMBER,
                                   ...
                                   p_status_meaning      IN OUT VARCHAR2 ) IS
--
-- declare local variables
--
...
-- hr_utility.trace_on;
--
hr_utility.set_location('hrwseci.hr_cobra_button_status', 0);
--
--
-- Call to check status is unique
--
   per_cobra_cov_statuses_pkg.hr_cobra_chk_status_unique
				 ...
				 p_status );
--
hr_utility.set_location('hrwseci.hr_cobra_button_status', 1);
--
--
-- Call to check elect/rej not co-existing
--
   ...
   END IF;
--
hr_utility.set_location('hrwseci.hr_cobra_button_status', 2);
--
--
-- Call to check status inserted in correct order
--
   per_cobra_cov_statuses_pkg.hr_cobra_chk_status_order
				 ...
				 p_status_date);
--
hr_utility.set_location('hrwseci.hr_cobra_button_status', 3);
--
--
-- do insert
--
   per_cobra_cov_statuses_pkg.insert_row
                             ( p_dummy_rowid,
                               ...
                               NULL);
--
hr_utility.set_location('hrwseci.hr_cobra_button_status', 4);
--
--
--
-- get current status
--
   hr_cobra_get_current_status ( p_cobra_coverage_enrollment_id,
                                 ...
                                 p_d_status_date );
--
hr_utility.set_location('hrwseci.hr_cobra_button_status', 5);
--
--
--
...
BEGIN
--
hr_utility.set_location('hrwseci.hr_cobra_chk_dup_pay_due_date', 0);
--
--
...
--
   ...
   CLOSE due_date;
--
  hr_utility.set_location('hrwseci.chk dup pay due date', 1);
--
--
...
--
   ...
   THEN
--
  hr_utility.set_location('hrwseci.chk dup pay due date', 2);
--
   ...
   END IF;
--
  hr_utility.set_location('hrwseci.chk dup pay due date', 3);
--
--
...
--
--
  hr_utility.set_location('hrwseci.do scp insert', 1);
--
   hr_cobra_chk_dup_pay_due_date( p_scheduled_cobra_payment_id,
                                  p_cobra_coverage_enrollment_id,
                                  p_due_date );
--
  hr_utility.set_location('hrwseci.do scp insert', 2);
--
--
-- get new scp_id
--
   ...
   CLOSE scp_id;
--
  hr_utility.set_location('hrwseci.do scp insert', 3);
--
...
--
--
  hr_utility.set_location('hrwseci.do scp update', 1);
--
   hr_cobra_chk_dup_pay_due_date( p_scheduled_cobra_payment_id,
                                  p_cobra_coverage_enrollment_id,
                                  p_due_date );
...
PROCEDURE hr_cobra_default_cobra_cost ( p_element_type_id        NUMBER,
                                        ...
                                        p_business_group_id      NUMBER,
                                        p_coverage_amount IN OUT VARCHAR2,
                                        p_basic_cost      IN OUT VARCHAR2) IS
--
-- declare cursor
--
...
--
hr_utility.set_location('hrwseci.cobra def cobra cost', 1);
  OPEN  coverage_amount;
  FETCH coverage_amount INTO p_coverage_amount, p_basic_cost;
--
-- check if any coverage
--
hr_utility.set_location('hrwseci.cobra def cobra cost', 2);
   IF (coverage_amount%NOTFOUND)
   THEN
hr_utility.set_location('hrwseci.cobra def cobra cost', 3);
       --
       -- default 0.00
       --
         p_basic_cost      := 0;
...
--
hr_utility.set_location('hrwseci.cobra def cobra cost', 4);
--
--
...
PROCEDURE hr_cobra_do_ccb_update ( p_Rowid                        IN OUT VARCHAR2,
                                   ...
                                   p_Attribute20                       VARCHAR2,
                                   p_qualifying_event                  VARCHAR2,
                                   p_new_amount_charged         IN OUT VARCHAR2 ) IS
BEGIN
--
-- do update
--
...
--
   p_new_amount_charged := hr_cobra_calc_amt_charged( p_cobra_coverage_enrollment_id );
--
...
BEGIN
--
hr_utility.set_location('hrwseci.get basic cost', 0);
--
--
   OPEN  chk_ee_exists;
   ...
   CLOSE chk_ee_exists;
--
hr_utility.set_location('hrwseci.get basic cost', 1);
--
--
   IF ( l_ees_exist = 'Y' )
   THEN
--
hr_utility.set_location('hrwseci.get basic cost', 2);
--
   --
   ...
   ELSE
--
hr_utility.set_location('hrwseci.get basic cost', 3);
--
   --
     OPEN  get_basic_cost;
...
-- return basic cost
--
hr_utility.set_location('hrwseci.get basic cost', 4);
--
--
   RETURN l_basic_cost;
--
...
PROCEDURE eci_init_form( p_assignment_id NUMBER,
			 ...
			 p_period_type IN OUT VARCHAR2) IS
--
BEGIN
--
	hr_get_assignment_info ( p_assignment_id,
				 ...
				 p_position_id);
--
	p_await_meaning := hrwseci.hr_cobra_get_await_meaning;
	p_period_type   := hrwseci.hr_cobra_get_period_type;
--
END eci_init_form;
--
Procedure chk_cobra_dependent_id(p_cobra_dependent_id     in number,
  ...
  --
  l_proc         varchar2(72) := 'chk_cobra_dependent_id';
  --
Begin
  --
...
PROCEDURE hr_cobra_do_cdp_insert
  (p_cobra_dependent_id           out number,
   p_cobra_coverage_enrollment_id in  number,
   p_contact_relationship_id      in  number,
   p_effective_start_date         in  date,
   p_effective_end_date           in  date,
