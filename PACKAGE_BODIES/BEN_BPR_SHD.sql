--------------------------------------------------------
--  DDL for Package Body BEN_BPR_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BPR_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_bpr_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_BNFT_POOL_RLOVR_RQMT_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_BNFT_POOL_RLOVR_RQMT_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','10');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_BNFT_POOL_RLOVR_RQMT_F_FK2') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  If (p_effective_date is null or
      p_bnft_pool_rlovr_rqmt_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_bnft_pool_rlovr_rqmt_id = g_old_rec.bnft_pool_rlovr_rqmt_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_bnft_pool_rlovr_rqmt_f',
	 p_base_key_column	   => 'bnft_pool_rlovr_rqmt_id',
	 p_base_key_value 	   => p_bnft_pool_rlovr_rqmt_id,
	 p_parent_table_name1      => 'ben_acty_base_rt_f',
	 p_parent_key_column1      => 'acty_base_rt_id',
...
Begin
  ...
  l_rec.no_mn_rlovr_pct_dfnd_flag        := p_no_mn_rlovr_pct_dfnd_flag;
  l_rec.no_mx_rlovr_pct_dfnd_flag        := p_no_mx_rlovr_pct_dfnd_flag;
  l_rec.no_mn_rlovr_val_dfnd_flag        := p_no_mn_rlovr_val_dfnd_flag;
  l_rec.no_mx_rlovr_val_dfnd_flag        := p_no_mx_rlovr_val_dfnd_flag;
  l_rec.rlovr_val_incrmt_num             := p_rlovr_val_incrmt_num;
  l_rec.rlovr_val_rl                     := p_rlovr_val_rl;
  l_rec.mn_rlovr_val                     := p_mn_rlovr_val;
  l_rec.mx_rlovr_val                     := p_mx_rlovr_val;
  ...
  l_rec.prtt_elig_rlovr_rl               := p_prtt_elig_rlovr_rl;
  l_rec.mx_rchd_dflt_ordr_num            := p_mx_rchd_dflt_ordr_num;
  l_rec.pct_rlovr_incrmt_num             := p_pct_rlovr_incrmt_num;
  l_rec.mn_rlovr_pct_num                 := p_mn_rlovr_pct_num;
  l_rec.mx_rlovr_pct_num                 := p_mx_rlovr_pct_num;
  l_rec.crs_rlovr_procg_cd               := p_crs_rlovr_procg_cd;
  l_rec.mx_pct_ttl_crs_cn_roll_num       := p_mx_pct_ttl_crs_cn_roll_num;
