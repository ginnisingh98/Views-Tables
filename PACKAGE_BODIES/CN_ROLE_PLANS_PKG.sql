--------------------------------------------------------
--  DDL for Package Body CN_ROLE_PLANS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CN_ROLE_PLANS_PKG" AS
/* $Header: cntrlplb.pls 120.0 2005/07/13 00:41:51 chanthon noship $ */
...
procedure INSERT_ROW
  ...
  X_OBJECT_VERSION_NUMBER     IN NUMBER) IS
    ...
    L_ATTRIBUTE_CATEGORY	       	  cn_role_plans.ATTRIBUTE_CATEGORY%type;
    L_ATTRIBUTE1		       	  cn_role_plans.ATTRIBUTE1%type;
    L_ATTRIBUTE2		       	  cn_role_plans.ATTRIBUTE2%type;
    L_ATTRIBUTE3		       	  cn_role_plans.ATTRIBUTE3%type;
    L_ATTRIBUTE4		       	  cn_role_plans.ATTRIBUTE4%type;
    L_ATTRIBUTE5		       	  cn_role_plans.ATTRIBUTE5%type;
    L_ATTRIBUTE6		       	  cn_role_plans.ATTRIBUTE6%type;
    L_ATTRIBUTE7		       	  cn_role_plans.ATTRIBUTE7%type;
    L_ATTRIBUTE8		       	  cn_role_plans.ATTRIBUTE8%type;
    L_ATTRIBUTE9		       	  cn_role_plans.ATTRIBUTE9%type;
    L_ATTRIBUTE10		       	  cn_role_plans.ATTRIBUTE10%type;
    L_ATTRIBUTE11		       	  cn_role_plans.ATTRIBUTE11%type;
    L_ATTRIBUTE12		       	  cn_role_plans.ATTRIBUTE12%type;
    L_ATTRIBUTE13		       	  cn_role_plans.ATTRIBUTE13%type;
    L_ATTRIBUTE14		       	  cn_role_plans.ATTRIBUTE14%type;
    L_ATTRIBUTE15	       		  cn_role_plans.ATTRIBUTE15%type;
    L_CREATED_BY	       		  cn_role_plans.CREATED_BY%type;
    L_CREATION_DATE		       	  cn_role_plans.CREATION_DATE%type;
...
procedure LOCK_ROW (X_ROLE_PLAN_ID	  IN NUMBER) IS
BEGIN
   NULL;
END lock_row;
