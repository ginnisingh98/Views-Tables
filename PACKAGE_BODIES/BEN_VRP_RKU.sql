--------------------------------------------------------
--  DDL for Package Body BEN_VRP_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_VRP_RKU" as
...
begin
hr_utility.set_location('Entering: ben_vrp_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_vrp_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_vrp_RKU;
