--------------------------------------------------------
--  DDL for Package Body BEN_ASSIGNMENT_SET_RATE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ASSIGNMENT_SET_RATE_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_ASSIGNMENT_SET_RATE_BK2.UPDATE_ASSIGNMENT_SET_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_ASSIGNMENT_SET_RATE_BK2.UPDATE_ASSIGNMENT_SET_RATE_A', 20);
end UPDATE_ASSIGNMENT_SET_RATE_A;
...
begin
hr_utility.set_location('Entering: BEN_ASSIGNMENT_SET_RATE_BK2.UPDATE_ASSIGNMENT_SET_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_ASSIGNMENT_SET_RATE_BK2.UPDATE_ASSIGNMENT_SET_RATE_B', 20);
end UPDATE_ASSIGNMENT_SET_RATE_B;
