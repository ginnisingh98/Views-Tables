--------------------------------------------------------
--  DDL for Package Body BEN_OTHR_PTIP_RT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_OTHR_PTIP_RT_API" as
/* $Header: beoprapi.pkb 115.1 2002/12/13 08:30:36 bmanyam noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_OTHR_PTIP_RT_api.';
--
-- ----------------------------------------------------------------------------
-- |------------------------< create_OTHR_PTIP_RT >----------------------|
-- ----------------------------------------------------------------------------
...
procedure create_OTHR_PTIP_RT
  ...
  --
  l_othr_ptip_rt_id ben_othr_ptip_rt_f.othr_ptip_rt_id%TYPE;
  l_effective_start_date ben_othr_ptip_rt_f.effective_start_date%TYPE;
  l_effective_end_date ben_othr_ptip_rt_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_OTHR_PTIP_RT';
  l_object_version_number ben_othr_ptip_rt_f.object_version_number%TYPE;
  --
begin
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_OTHR_PTIP_RT
    --
    ben_OTHR_PTIP_RT_bk1.create_OTHR_PTIP_RT_b
      (
      ...
      ,p_opr_attribute_category         =>  p_opr_attribute_category
      ,p_opr_attribute1                 =>  p_opr_attribute1
      ,p_opr_attribute2                 =>  p_opr_attribute2
      ,p_opr_attribute3                 =>  p_opr_attribute3
      ,p_opr_attribute4                 =>  p_opr_attribute4
      ,p_opr_attribute5                 =>  p_opr_attribute5
      ,p_opr_attribute6                 =>  p_opr_attribute6
      ,p_opr_attribute7                 =>  p_opr_attribute7
      ,p_opr_attribute8                 =>  p_opr_attribute8
      ,p_opr_attribute9                 =>  p_opr_attribute9
      ,p_opr_attribute10                =>  p_opr_attribute10
      ,p_opr_attribute11                =>  p_opr_attribute11
      ,p_opr_attribute12                =>  p_opr_attribute12
      ,p_opr_attribute13                =>  p_opr_attribute13
      ,p_opr_attribute14                =>  p_opr_attribute14
      ,p_opr_attribute15                =>  p_opr_attribute15
      ,p_opr_attribute16                =>  p_opr_attribute16
      ,p_opr_attribute17                =>  p_opr_attribute17
      ,p_opr_attribute18                =>  p_opr_attribute18
      ,p_opr_attribute19                =>  p_opr_attribute19
      ,p_opr_attribute20                =>  p_opr_attribute20
      ,p_opr_attribute21                =>  p_opr_attribute21
      ,p_opr_attribute22                =>  p_opr_attribute22
      ,p_opr_attribute23                =>  p_opr_attribute23
      ,p_opr_attribute24                =>  p_opr_attribute24
      ,p_opr_attribute25                =>  p_opr_attribute25
      ,p_opr_attribute26                =>  p_opr_attribute26
      ,p_opr_attribute27                =>  p_opr_attribute27
      ,p_opr_attribute28                =>  p_opr_attribute28
      ,p_opr_attribute29                =>  p_opr_attribute29
      ,p_opr_attribute30                =>  p_opr_attribute30
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_OTHR_PTIP_RT'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_OTHR_PTIP_RT
    --
  end;
  --
  ben_opr_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_OTHR_PTIP_RT
    --
    ben_OTHR_PTIP_RT_bk1.create_OTHR_PTIP_RT_a
      (
       p_othr_ptip_rt_id         =>  l_othr_ptip_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_OTHR_PTIP_RT
    --
  end;
  --
  ben_profile_handler.event_handler
    (p_event                       => 'CREATE',
     ...
     p_base_table_reference_column => 'RT_OTHR_PTIP_FLAG',
     p_reference_table             => 'BEN_OTHR_PTIP_RT_F',
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_OTHR_PTIP_RT;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
    --
    p_othr_ptip_rt_id := null;
...
procedure update_OTHR_PTIP_RT
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_OTHR_PTIP_RT';
  l_object_version_number ben_othr_ptip_rt_f.object_version_number%TYPE;
  l_effective_start_date ben_othr_ptip_rt_f.effective_start_date%TYPE;
  l_effective_end_date ben_othr_ptip_rt_f.effective_end_date%TYPE;
  --
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_OTHR_PTIP_RT
    --
    ben_OTHR_PTIP_RT_bk2.update_OTHR_PTIP_RT_b
      (
       p_othr_ptip_rt_id         =>  p_othr_ptip_rt_id
      ,p_excld_flag                     =>  p_excld_flag
      ,p_ordr_num                       =>  p_ordr_num
      ,p_only_pls_subj_cobra_flag       =>  p_only_pls_subj_cobra_flag
      ,p_vrbl_rt_prfl_id                  =>  p_vrbl_rt_prfl_id
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_OTHR_PTIP_RT'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_OTHR_PTIP_RT
    --
  end;
  --
  ben_opr_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_OTHR_PTIP_RT
    --
    ben_OTHR_PTIP_RT_bk2.update_OTHR_PTIP_RT_a
      (
       p_othr_ptip_rt_id         =>  p_othr_ptip_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_OTHR_PTIP_RT
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO update_OTHR_PTIP_RT;
    --
	-- NOCOPY Changes
    p_effective_start_date := null;
    p_effective_end_date := null;
...
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_OTHR_PTIP_RT
    --
    ben_OTHR_PTIP_RT_bk3.delete_OTHR_PTIP_RT_b
      (
       p_othr_ptip_rt_id         =>  p_othr_ptip_rt_id
      ,p_object_version_number          =>  p_object_version_number
    ,p_effective_date                      => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_OTHR_PTIP_RT'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_OTHR_PTIP_RT
    --
  end;
  --
  ben_opr_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_OTHR_PTIP_RT
    --
    ben_OTHR_PTIP_RT_bk3.delete_OTHR_PTIP_RT_a
      (
       p_othr_ptip_rt_id         =>  p_othr_ptip_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_OTHR_PTIP_RT
    --
  end;
  --
  ben_profile_handler.event_handler
    (p_event                       => 'DELETE',
     p_base_table                  => 'BEN_VRBL_RT_PRFL_F',
     p_base_table_column           => 'VRBL_RT_PRFL_ID',
     p_base_table_column_value     => ben_opr_shd.g_old_rec.vrbl_rt_prfl_id,
     p_base_table_reference_column => 'RT_OTHR_PTIP_FLAG',
     p_reference_table             => 'BEN_OTHR_PTIP_RT_F',
     p_reference_table_column      => 'VRBL_RT_PRFL_ID');
  --
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO delete_OTHR_PTIP_RT;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
