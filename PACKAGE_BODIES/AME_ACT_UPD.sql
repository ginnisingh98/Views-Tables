--------------------------------------------------------
--  DDL for Package Body AME_ACT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ACT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_act_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  begin
    ...
    ame_act_rku.after_update
      ...
      => p_rec.object_version_number
      ,p_parameter_o
      => ame_act_shd.g_old_rec.parameter
      ,p_start_date_o
      => ame_act_shd.g_old_rec.start_date
      ,p_end_date_o
      => ame_act_shd.g_old_rec.end_date
      ,p_description_o
      => ame_act_shd.g_old_rec.description
      ,p_security_group_id_o
      => ame_act_shd.g_old_rec.security_group_id
      ,p_parameter_two_o
      => ame_act_shd.g_old_rec.parameter_two
      ,p_object_version_number_o
      => ame_act_shd.g_old_rec.object_version_number
      );
    --
  exception
    --
...
Begin
 ...
 ,p_action_type_id =>  p_rec.action_type_id
  ...
  --
  ame_act_upd.convert_defs(p_rec);
  --
  ame_act_bus.update_validate
    (p_rec                              => p_rec
    ,p_effective_date                   => p_effective_date
    ,p_datetrack_mode                   => p_datetrack_mode
    ,p_validation_start_date            => l_validation_start_date
