--------------------------------------------------------
--  DDL for Package Body FA_FAS500_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FAS500_XMLP_PKG" AS
/* $Header: FAS500B.pls 120.0.12010000.1 2008/07/28 13:15:01 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    RETURN(':Asset Disposals Responsibility Report:');
END;
RETURN NULL; end;
