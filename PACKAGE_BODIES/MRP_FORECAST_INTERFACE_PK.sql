--------------------------------------------------------
--  DDL for Package Body MRP_FORECAST_INTERFACE_PK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."MRP_FORECAST_INTERFACE_PK" AS
    /* $Header: MRPFAPIB.pls 120.3.12010000.2 2009/05/27 14:19:53 rnatukul ship $ */
      ...
      --              END IF;
        ...
        BEGIN
            ...
            WHERE   organization_id =
                        forecast_interface(counter).organization_id;
/* OPM-CONVERGE-START*/
/*Commented as the process forecast has been merged with Oracle Forecast.
 * Also the migrated forecast data from the interface tables for the process
 * organizations should be pushed to the final tables.*/
