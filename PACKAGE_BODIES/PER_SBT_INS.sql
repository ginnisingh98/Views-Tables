--------------------------------------------------------
--  DDL for Package Body PER_SBT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_SBT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_sbt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: per_subjects_taken_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.subjects_taken_id                := p_subjects_taken_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  per_sbt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  per_sbt_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where sbt.subjects_taken_id = p_subjects_taken_id
                          and sbt.language = l.language_code);
  --
