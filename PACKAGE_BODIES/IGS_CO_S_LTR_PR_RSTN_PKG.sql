--------------------------------------------------------
--  DDL for Package Body IGS_CO_S_LTR_PR_RSTN_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_CO_S_LTR_PR_RSTN_PKG" AS
/* $Header: IGSLI20B.pls 115.5 2002/11/29 01:07:10 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_co_s_ltr_pr_rstn%ROWTYPE;
  new_references igs_co_s_ltr_pr_rstn%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_CO_CORT_SLPR_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    INSERT INTO igs_co_s_ltr_pr_rstn (
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_co_s_ltr_pr_rstn
    WHERE rowid = x_rowid;
