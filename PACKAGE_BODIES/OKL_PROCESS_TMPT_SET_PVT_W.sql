--------------------------------------------------------
--  DDL for Package Body OKL_PROCESS_TMPT_SET_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PROCESS_TMPT_SET_PVT_W" as
  /* $Header: OKLETMSB.pls 120.2 2005/10/30 03:21:27 appldev noship $ */
  ...
  as
    ddp_aesv_rec okl_process_tmpt_set_pvt.aesv_rec_type;
    ddp_avlv_tbl okl_process_tmpt_set_pvt.avlv_tbl_type;
    ddp_atlv_tbl okl_process_tmpt_set_pvt.atlv_tbl_type;
    ddx_aesv_rec okl_process_tmpt_set_pvt.aesv_rec_type;
    ddx_avlv_tbl okl_process_tmpt_set_pvt.avlv_tbl_type;
    ddx_atlv_tbl okl_process_tmpt_set_pvt.atlv_tbl_type;
  ...
  begin
    ...
    okl_process_tmpt_set_pvt.create_tmpt_set(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pvt.update_tmpt_set(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_aesv_tbl okl_process_tmpt_set_pvt.aesv_tbl_type;
    ddx_aesv_tbl okl_process_tmpt_set_pvt.aesv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pvt.delete_tmpt_set(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pvt.create_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_avlv_rec okl_process_tmpt_set_pvt.avlv_rec_type;
    ddx_avlv_rec okl_process_tmpt_set_pvt.avlv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pvt.update_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pvt.delete_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pvt.create_tmpt_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_atlv_rec okl_process_tmpt_set_pvt.atlv_rec_type;
    ddx_atlv_rec okl_process_tmpt_set_pvt.atlv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pvt.update_tmpt_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pvt.delete_tmpt_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pvt.copy_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
