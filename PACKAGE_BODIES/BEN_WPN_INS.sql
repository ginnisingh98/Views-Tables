--------------------------------------------------------
--  DDL for Package Body BEN_WPN_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_WPN_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_wpn_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_wv_prtn_rsn_pl_f.created_by%TYPE;
  l_creation_date       ben_wv_prtn_rsn_pl_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_wv_prtn_rsn_pl_f
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
                ...
                open c1;
                fetch c1 into p_rec.wv_prtn_rsn_pl_id;
                close c1;
  --
  --
  --
...
Begin
  ...
  --
  p_wv_prtn_rsn_pl_id        	:= l_rec.wv_prtn_rsn_pl_id;
