--------------------------------------------------------
--  DDL for Package Body ASP_SERVICE_ALERT_AGENT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ASP_SERVICE_ALERT_AGENT" as
/* $Header: aspaesab.pls 120.4 2005/09/13 17:19 axavier noship $ */
---------------------------------------------------------------------------
...
/*-------------------------------------------------------------------------*
 |                             Private Constants
 *-------------------------------------------------------------------------*/
G_PKG_NAME  CONSTANT VARCHAR2(30):= 'ASP_SERVICE_ALERT_AGENT';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'aspaesab.pls';
...
IS
  ...
  CURSOR get_customer_id(c_incident_id in number) is
...
BEGIN
  ...
  If(funcmode = 'RUN') Then
    ...
    BEGIN
      OPEN get_customer_id(l_incident_id);
