--------------------------------------------------------
--  DDL for Package Body ONT_D1_PRICING_DATE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1_PRICING_DATE" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D1_PRICING_DATE
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1_PRICING_DATE';
