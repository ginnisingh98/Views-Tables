--------------------------------------------------------
--  DDL for Package Body BEN_NOC_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_NOC_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_noc_bus.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------< chk_no_othr_cvg_rt_id >------|
-- ----------------------------------------------------------------------------
--
-- Description
...
--
-- In Parameters
--   no_othr_cvg_rt_id PK of record being inserted or updated.
...
--
Procedure chk_no_othr_cvg_rt_id(p_no_othr_cvg_rt_id                in number,
                           p_effective_date              in date,
                           p_object_version_number       in number) is
  --
  l_proc         varchar2(72) := g_package||'chk_no_othr_cvg_rt_id';
...
Begin
  ...
  --
  l_api_updating := ben_noc_shd.api_updating
    (p_effective_date              => p_effective_date,
     p_no_othr_cvg_rt_id                => p_no_othr_cvg_rt_id,
     p_object_version_number       => p_object_version_number);
  --
  if (l_api_updating
     and nvl(p_no_othr_cvg_rt_id,hr_api.g_number)
     <>  ben_noc_shd.g_old_rec.no_othr_cvg_rt_id) then
    --
    -- raise error as PK has changed
    --
    ben_noc_shd.constraint_error('BEN_NO_OTHR_CVG_RT_PK');
    --
  elsif not l_api_updating then
    --
    -- check if PK is null
    --
    if p_no_othr_cvg_rt_id is not null then
      --
...
--   Internal table handler use only.
--
Procedure chk_coord_ben_no_cvg_flag(p_no_othr_cvg_rt_id                in number,
...
Begin
  ...
  if (l_api_updating
      ...
      <> nvl(ben_noc_shd.g_old_rec.coord_ben_no_cvg_flag,hr_api.g_varchar2)
...
function return_legislation_code
  (p_no_othr_cvg_rt_id in number) return varchar2 is
  --
  -- Declare cursor
  --
  cursor csr_leg_code is
    ...
    from   per_business_groups a,
           ben_no_othr_cvg_rt_f b
    where b.no_othr_cvg_rt_id      = p_no_othr_cvg_rt_id
