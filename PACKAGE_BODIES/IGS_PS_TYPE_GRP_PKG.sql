--------------------------------------------------------
--  DDL for Package Body IGS_PS_TYPE_GRP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_PS_TYPE_GRP_PKG" AS
 /* $Header: IGSPI38B.pls 115.3 2002/11/29 02:23:43 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references IGS_PS_TYPE_GRP%RowType;
  new_references IGS_PS_TYPE_GRP%RowType;
  ...
  BEGIN
    ...
    IGS_PS_TYPE_PKG.GET_FK_IGS_PS_TYPE_GRP (
      old_references.course_type_group_cd
      );

    IGS_AD_SBMAO_FN_CTTT_PKG.GET_FK_IGS_PS_TYPE_GRP (
      old_references.course_type_group_cd
      );
...
procedure INSERT_ROW (
  ...
  X_MODE in VARCHAR2 default 'R'
    ...
    cursor C is select ROWID from IGS_PS_TYPE_GRP
      where COURSE_TYPE_GROUP_CD = X_COURSE_TYPE_GROUP_CD;
...
procedure ADD_ROW (
  ...
  cursor c1 is select rowid from IGS_PS_TYPE_GRP
     where COURSE_TYPE_GROUP_CD = X_COURSE_TYPE_GROUP_CD
  ;
begin
  open c1;
