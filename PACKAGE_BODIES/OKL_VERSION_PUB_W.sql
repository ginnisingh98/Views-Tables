--------------------------------------------------------
--  DDL for Package Body OKL_VERSION_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_VERSION_PUB_W" as
  /* $Header: OKLUVERB.pls 120.1 2005/07/22 10:20:50 dkagrawa noship $ */
  ...
  as
    ddp_cvmv_rec okl_version_pub.cvmv_rec_type;
    ddx_cvmv_rec okl_version_pub.cvmv_rec_type;
  ...
  begin
    ...
    okl_version_pub.version_contract(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_cvmv_tbl okl_version_pub.cvmv_tbl_type;
    ddx_cvmv_tbl okl_version_pub.cvmv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
