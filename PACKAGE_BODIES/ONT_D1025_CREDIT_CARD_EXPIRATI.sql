--------------------------------------------------------
--  DDL for Package Body ONT_D1025_CREDIT_CARD_EXPIRATI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1025_CREDIT_CARD_EXPIRATI" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D1025_CREDIT_CARD_EXPIRATI
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1025_CREDIT_CARD_EXPIRATI';
