--------------------------------------------------------
--  DDL for Package Body HR_PREVIOUS_EMPLOYMENT_BKA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PREVIOUS_EMPLOYMENT_BKA" as
...
begin
hr_utility.set_location('Entering: HR_PREVIOUS_EMPLOYMENT_BKA.CREATE_PREV_JOB_EXTRA_INFO_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
hr_previous_employment_beA.CREATE_PREV_JOB_EXTRA_INFO_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_PREV_JOB_EXTRA_INFO', 'AP');
hr_utility.set_location(' Leaving: HR_PREVIOUS_EMPLOYMENT_BKA.CREATE_PREV_JOB_EXTRA_INFO_A', 20);
...
begin
hr_utility.set_location('Entering: HR_PREVIOUS_EMPLOYMENT_BKA.CREATE_PREV_JOB_EXTRA_INFO_B', 10);
hr_utility.set_location(' Leaving: HR_PREVIOUS_EMPLOYMENT_BKA.CREATE_PREV_JOB_EXTRA_INFO_B', 20);
end CREATE_PREV_JOB_EXTRA_INFO_B;
