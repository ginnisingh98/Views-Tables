--------------------------------------------------------
--  DDL for Package Body PQH_ASA_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_ASA_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_asa_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_assignment_acco_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_assignment_acco_id  in  number) is
--
...
Begin
  ...
  --
  pqh_asa_ins.g_assignment_acco_id_i := p_assignment_acco_id;
  --
...
--
  Cursor C_Sel1 Is
    ...
    where  t.assignment_acco_id       = p_rec.assignment_acco_id
    and    t.effective_start_date =
             pqh_asa_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc                varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          pqh_assign_accommodations_f.created_by%TYPE;
  l_creation_date       pqh_assign_accommodations_f.creation_date%TYPE;
  l_last_update_date    pqh_assign_accommodations_f.last_update_date%TYPE;
  l_last_updated_by     pqh_assign_accommodations_f.last_updated_by%TYPE;
  l_last_update_login   pqh_assign_accommodations_f.last_update_login%TYPE;
--
Begin
  ...
  --
  --
  -- Insert the row into: pqh_assign_accommodations_f
  --
  insert into pqh_assign_accommodations_f
      (assignment_acco_id
...
--
  Cursor C_Sel1 is select pqh_assign_accommodations_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from pqh_assign_accommodations_f
     where assignment_acco_id =
             pqh_asa_ins.g_assignment_acco_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (pqh_asa_ins.g_assignment_acco_id_i is not null) Then
    --
    ...
    p_rec.assignment_acco_id :=
      pqh_asa_ins.g_assignment_acco_id_i;
    pqh_asa_ins.g_assignment_acco_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.assignment_acco_id;
    Close C_Sel1;
  End If;
  --
  --
...
Begin
  ...
  dt_api.validate_dt_mode
    ...
    ,p_parent_key_value1       => p_rec.accommodation_id
...
Begin
  ...
  --
  p_assignment_acco_id               := l_rec.assignment_acco_id;
