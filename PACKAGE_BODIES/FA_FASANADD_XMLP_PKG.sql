--------------------------------------------------------
--  DDL for Package Body FA_FASANADD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FASANADD_XMLP_PKG" AS
/* $Header: FASANADDB.pls 120.0.12010000.1 2008/07/28 13:16:17 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    RP_Report_Name := ':Annual Additions Report:';
