--------------------------------------------------------
--  DDL for Package Body IGS_AD_UHK_PSTATS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AD_UHK_PSTATS_PKG" AS
/* $Header: IGSADD7B.pls 120.0 2006/05/02 05:22:26 apadegal noship $ */
  ...
  EXCEPTION
    ...
    FND_MESSAGE.SET_TOKEN ('NAME','IGS_AD_UHK_PSTATS_PKG.Derive_Person_Stats');
    IGS_GE_MSG_STACK.ADD;

    APP_EXCEPTION.RAISE_EXCEPTION;

  END Derive_Person_Stats ;
