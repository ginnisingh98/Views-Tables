--------------------------------------------------------
--  DDL for Package Body HR_CONTACT_EXTRA_INFO_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_CONTACT_EXTRA_INFO_BK2" as
...
begin
hr_utility.set_location('Entering: HR_CONTACT_EXTRA_INFO_BK2.UPDATE_CONTACT_EXTRA_INFO_A', 10);
hr_utility.set_location(' Leaving: HR_CONTACT_EXTRA_INFO_BK2.UPDATE_CONTACT_EXTRA_INFO_A', 20);
end UPDATE_CONTACT_EXTRA_INFO_A;
...
begin
hr_utility.set_location('Entering: HR_CONTACT_EXTRA_INFO_BK2.UPDATE_CONTACT_EXTRA_INFO_B', 10);
...
per_in_con_leg_hook.check_in_con_update
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_CONTACT_EXTRA_INFO', 'BP');
hr_utility.set_location(' Leaving: HR_CONTACT_EXTRA_INFO_BK2.UPDATE_CONTACT_EXTRA_INFO_B', 20);
end UPDATE_CONTACT_EXTRA_INFO_B;
