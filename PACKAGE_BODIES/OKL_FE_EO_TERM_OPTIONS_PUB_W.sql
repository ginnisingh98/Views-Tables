--------------------------------------------------------
--  DDL for Package Body OKL_FE_EO_TERM_OPTIONS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_FE_EO_TERM_OPTIONS_PUB_W" as
  /* $Header: OKLUEOTB.pls 120.0 2005/07/07 10:45:59 viselvar noship $ */
  ...
  as
    ddx_eto_tbl okl_fe_eo_term_options_pub.okl_eto_tbl;
  ...
  begin
    ...
    okl_fe_eo_term_options_pub.get_item_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddx_etv_tbl okl_fe_eo_term_options_pub.okl_etv_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_eo_term_options_pub.get_eo_term_values(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddx_ethv_rec okl_fe_eo_term_options_pub.okl_ethv_rec;
    ddx_eve_rec okl_fe_eo_term_options_pub.okl_eve_rec;
    ddx_eto_tbl okl_fe_eo_term_options_pub.okl_eto_tbl;
    ddx_etv_tbl okl_fe_eo_term_options_pub.okl_etv_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_eo_term_options_pub.get_end_of_term_option(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ethv_rec okl_fe_eo_term_options_pub.okl_ethv_rec;
    ddp_eve_rec okl_fe_eo_term_options_pub.okl_eve_rec;
    ddp_eto_tbl okl_fe_eo_term_options_pub.okl_eto_tbl;
    ddp_etv_tbl okl_fe_eo_term_options_pub.okl_etv_tbl;
    ddx_ethv_rec okl_fe_eo_term_options_pub.okl_ethv_rec;
    ddx_eve_rec okl_fe_eo_term_options_pub.okl_eve_rec;
    ddx_eto_tbl okl_fe_eo_term_options_pub.okl_eto_tbl;
    ddx_etv_tbl okl_fe_eo_term_options_pub.okl_etv_tbl;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_eo_term_options_pub.insert_end_of_term_option(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_eo_term_options_pub.update_end_of_term_option(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_eo_term_options_pub.create_version(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddx_obj_tbl okl_fe_eo_term_options_pub.invalid_object_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_eo_term_options_pub.invalid_objects(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_fe_eo_term_options_pub.calc_start_date(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_fe_eo_term_options_pub_w;
