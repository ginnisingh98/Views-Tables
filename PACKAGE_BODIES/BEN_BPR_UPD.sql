--------------------------------------------------------
--  DDL for Package Body BEN_BPR_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BPR_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_bpr_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
  ...
  If (p_datetrack_mode = 'CORRECTION') then
    ...
    p_rec.object_version_number :=
	  ...
	  (p_base_table_name	=> 'ben_bnft_pool_rlovr_rqmt_f',
	   ...
	   p_base_key_value	=> p_rec.bnft_pool_rlovr_rqmt_id);
    --
    ben_bpr_shd.g_api_dml := true;  -- Set the api dml status
    --
    -- Update the ben_bnft_pool_rlovr_rqmt_f Row
    --
    update  ben_bnft_pool_rlovr_rqmt_f
    set
        bnft_pool_rlovr_rqmt_id         = p_rec.bnft_pool_rlovr_rqmt_id,
    no_mn_rlovr_pct_dfnd_flag       = p_rec.no_mn_rlovr_pct_dfnd_flag,
    no_mx_rlovr_pct_dfnd_flag       = p_rec.no_mx_rlovr_pct_dfnd_flag,
    no_mn_rlovr_val_dfnd_flag       = p_rec.no_mn_rlovr_val_dfnd_flag,
    no_mx_rlovr_val_dfnd_flag       = p_rec.no_mx_rlovr_val_dfnd_flag,
    rlovr_val_incrmt_num            = p_rec.rlovr_val_incrmt_num,
    rlovr_val_rl                    = p_rec.rlovr_val_rl,
    mn_rlovr_val                    = p_rec.mn_rlovr_val,
    mx_rlovr_val                    = p_rec.mx_rlovr_val,
    val_rndg_cd                     = p_rec.val_rndg_cd,
    val_rndg_rl                     = p_rec.val_rndg_rl,
    pct_rndg_cd                     = p_rec.pct_rndg_cd,
    pct_rndg_rl                     = p_rec.pct_rndg_rl,
    prtt_elig_rlovr_rl              = p_rec.prtt_elig_rlovr_rl,
    mx_rchd_dflt_ordr_num           = p_rec.mx_rchd_dflt_ordr_num,
    pct_rlovr_incrmt_num            = p_rec.pct_rlovr_incrmt_num,
    mn_rlovr_pct_num                = p_rec.mn_rlovr_pct_num,
    mx_rlovr_pct_num                = p_rec.mx_rlovr_pct_num,
    crs_rlovr_procg_cd              = p_rec.crs_rlovr_procg_cd,
    mx_pct_ttl_crs_cn_roll_num      = p_rec.mx_pct_ttl_crs_cn_roll_num,
    ...
    where   bnft_pool_rlovr_rqmt_id = p_rec.bnft_pool_rlovr_rqmt_id
    and     effective_start_date = p_validation_start_date
    and     effective_end_date   = p_validation_end_date;
    --
    ben_bpr_shd.g_api_dml := false;   -- Unset the api dml status
    --
...
Begin
  ...
  If (p_datetrack_mode <> 'CORRECTION') then
    ...
    --
    ben_bpr_shd.upd_effective_end_date
     (p_effective_date	       => p_effective_date,
      p_base_key_value	       => p_rec.bnft_pool_rlovr_rqmt_id,
...
--
 ...
 ,p_validation_start_date         =>p_validation_start_date
 ,p_validation_end_date           =>p_validation_end_date
 ,p_effective_start_date_o        =>ben_bpr_shd.g_old_rec.effective_start_date
 ,p_effective_end_date_o          =>ben_bpr_shd.g_old_rec.effective_end_date
 ,p_no_mn_rlovr_pct_dfnd_flag_o   =>ben_bpr_shd.g_old_rec.no_mn_rlovr_pct_dfnd_flag
 ,p_no_mx_rlovr_pct_dfnd_flag_o   =>ben_bpr_shd.g_old_rec.no_mx_rlovr_pct_dfnd_flag
 ,p_no_mn_rlovr_val_dfnd_flag_o   =>ben_bpr_shd.g_old_rec.no_mn_rlovr_val_dfnd_flag
 ,p_no_mx_rlovr_val_dfnd_flag_o   =>ben_bpr_shd.g_old_rec.no_mx_rlovr_val_dfnd_flag
 ,p_rlovr_val_incrmt_num_o        =>ben_bpr_shd.g_old_rec.rlovr_val_incrmt_num
 ,p_rlovr_val_rl_o                =>ben_bpr_shd.g_old_rec.rlovr_val_rl
 ,p_mn_rlovr_val_o                =>ben_bpr_shd.g_old_rec.mn_rlovr_val
 ,p_mx_rlovr_val_o                =>ben_bpr_shd.g_old_rec.mx_rlovr_val
 ,p_val_rndg_cd_o                 =>ben_bpr_shd.g_old_rec.val_rndg_cd
 ,p_val_rndg_rl_o                 =>ben_bpr_shd.g_old_rec.val_rndg_rl
 ,p_pct_rndg_cd_o                 =>ben_bpr_shd.g_old_rec.pct_rndg_cd
 ,p_pct_rndg_rl_o                 =>ben_bpr_shd.g_old_rec.pct_rndg_rl
 ,p_prtt_elig_rlovr_rl_o          =>ben_bpr_shd.g_old_rec.prtt_elig_rlovr_rl
 ,p_mx_rchd_dflt_ordr_num_o       =>ben_bpr_shd.g_old_rec.mx_rchd_dflt_ordr_num
 ,p_pct_rlovr_incrmt_num_o        =>ben_bpr_shd.g_old_rec.pct_rlovr_incrmt_num
 ,p_mn_rlovr_pct_num_o            =>ben_bpr_shd.g_old_rec.mn_rlovr_pct_num
 ,p_mx_rlovr_pct_num_o            =>ben_bpr_shd.g_old_rec.mx_rlovr_pct_num
 ,p_crs_rlovr_procg_cd_o          =>ben_bpr_shd.g_old_rec.crs_rlovr_procg_cd
 ,p_mx_pct_ttl_crs_cn_roll_num_o  =>ben_bpr_shd.g_old_rec.mx_pct_ttl_crs_cn_roll_num
 ,p_bnft_prvdr_pool_id_o          =>ben_bpr_shd.g_old_rec.bnft_prvdr_pool_id
 ,p_acty_base_rt_id_o             =>ben_bpr_shd.g_old_rec.acty_base_rt_id
 ,p_business_group_id_o           =>ben_bpr_shd.g_old_rec.business_group_id
 ,p_bpr_attribute_category_o      =>ben_bpr_shd.g_old_rec.bpr_attribute_category
 ,p_bpr_attribute1_o              =>ben_bpr_shd.g_old_rec.bpr_attribute1
 ,p_bpr_attribute2_o              =>ben_bpr_shd.g_old_rec.bpr_attribute2
 ,p_bpr_attribute3_o              =>ben_bpr_shd.g_old_rec.bpr_attribute3
 ,p_bpr_attribute4_o              =>ben_bpr_shd.g_old_rec.bpr_attribute4
 ,p_bpr_attribute5_o              =>ben_bpr_shd.g_old_rec.bpr_attribute5
 ,p_bpr_attribute6_o              =>ben_bpr_shd.g_old_rec.bpr_attribute6
 ,p_bpr_attribute7_o              =>ben_bpr_shd.g_old_rec.bpr_attribute7
 ,p_bpr_attribute8_o              =>ben_bpr_shd.g_old_rec.bpr_attribute8
 ,p_bpr_attribute9_o              =>ben_bpr_shd.g_old_rec.bpr_attribute9
 ,p_bpr_attribute10_o             =>ben_bpr_shd.g_old_rec.bpr_attribute10
 ,p_bpr_attribute11_o             =>ben_bpr_shd.g_old_rec.bpr_attribute11
 ,p_bpr_attribute12_o             =>ben_bpr_shd.g_old_rec.bpr_attribute12
 ,p_bpr_attribute13_o             =>ben_bpr_shd.g_old_rec.bpr_attribute13
 ,p_bpr_attribute14_o             =>ben_bpr_shd.g_old_rec.bpr_attribute14
 ,p_bpr_attribute15_o             =>ben_bpr_shd.g_old_rec.bpr_attribute15
 ,p_bpr_attribute16_o             =>ben_bpr_shd.g_old_rec.bpr_attribute16
 ,p_bpr_attribute17_o             =>ben_bpr_shd.g_old_rec.bpr_attribute17
 ,p_bpr_attribute18_o             =>ben_bpr_shd.g_old_rec.bpr_attribute18
 ,p_bpr_attribute19_o             =>ben_bpr_shd.g_old_rec.bpr_attribute19
 ,p_bpr_attribute20_o             =>ben_bpr_shd.g_old_rec.bpr_attribute20
 ,p_bpr_attribute21_o             =>ben_bpr_shd.g_old_rec.bpr_attribute21
 ,p_bpr_attribute22_o             =>ben_bpr_shd.g_old_rec.bpr_attribute22
 ,p_bpr_attribute23_o             =>ben_bpr_shd.g_old_rec.bpr_attribute23
 ,p_bpr_attribute24_o             =>ben_bpr_shd.g_old_rec.bpr_attribute24
 ,p_bpr_attribute25_o             =>ben_bpr_shd.g_old_rec.bpr_attribute25
 ,p_bpr_attribute26_o             =>ben_bpr_shd.g_old_rec.bpr_attribute26
 ,p_bpr_attribute27_o             =>ben_bpr_shd.g_old_rec.bpr_attribute27
 ,p_bpr_attribute28_o             =>ben_bpr_shd.g_old_rec.bpr_attribute28
 ,p_bpr_attribute29_o             =>ben_bpr_shd.g_old_rec.bpr_attribute29
 ,p_bpr_attribute30_o             =>ben_bpr_shd.g_old_rec.bpr_attribute30
 ,p_object_version_number_o       =>ben_bpr_shd.g_old_rec.object_version_number
      );
    --
  exception
    --
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'ben_bnft_pool_rlovr_rqmt_f'
        ,p_hook_type   => 'AU');
      --
  end;
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy ben_bpr_shd.g_rec_type) is
--
...
Begin
  ...
  --
  If (p_rec.no_mn_rlovr_pct_dfnd_flag = hr_api.g_varchar2) then
    p_rec.no_mn_rlovr_pct_dfnd_flag :=
    ben_bpr_shd.g_old_rec.no_mn_rlovr_pct_dfnd_flag;
  End If;
  If (p_rec.no_mx_rlovr_pct_dfnd_flag = hr_api.g_varchar2) then
    p_rec.no_mx_rlovr_pct_dfnd_flag :=
    ben_bpr_shd.g_old_rec.no_mx_rlovr_pct_dfnd_flag;
  End If;
  If (p_rec.no_mn_rlovr_val_dfnd_flag = hr_api.g_varchar2) then
    p_rec.no_mn_rlovr_val_dfnd_flag :=
    ben_bpr_shd.g_old_rec.no_mn_rlovr_val_dfnd_flag;
  End If;
  If (p_rec.no_mx_rlovr_val_dfnd_flag = hr_api.g_varchar2) then
    p_rec.no_mx_rlovr_val_dfnd_flag :=
    ben_bpr_shd.g_old_rec.no_mx_rlovr_val_dfnd_flag;
  End If;
  If (p_rec.rlovr_val_incrmt_num = hr_api.g_number) then
    p_rec.rlovr_val_incrmt_num :=
    ben_bpr_shd.g_old_rec.rlovr_val_incrmt_num;
  End If;
  If (p_rec.rlovr_val_rl = hr_api.g_number) then
    p_rec.rlovr_val_rl :=
    ben_bpr_shd.g_old_rec.rlovr_val_rl;
  End If;
  If (p_rec.mn_rlovr_val = hr_api.g_number) then
    p_rec.mn_rlovr_val :=
    ben_bpr_shd.g_old_rec.mn_rlovr_val;
  End If;
  If (p_rec.mx_rlovr_val = hr_api.g_number) then
    p_rec.mx_rlovr_val :=
    ben_bpr_shd.g_old_rec.mx_rlovr_val;
  End If;
  If (p_rec.val_rndg_cd = hr_api.g_varchar2) then
    p_rec.val_rndg_cd :=
    ben_bpr_shd.g_old_rec.val_rndg_cd;
  End If;
...
Begin
  ...
  --
  l_rec :=
  ben_bpr_shd.convert_args
  (
  p_bnft_pool_rlovr_rqmt_id,
  null,
  null,
  p_no_mn_rlovr_pct_dfnd_flag,
  p_no_mx_rlovr_pct_dfnd_flag,
  p_no_mn_rlovr_val_dfnd_flag,
  p_no_mx_rlovr_val_dfnd_flag,
  p_rlovr_val_incrmt_num,
  p_rlovr_val_rl,
  p_mn_rlovr_val,
  p_mx_rlovr_val,
  p_val_rndg_cd,
  ...
  p_pct_rndg_cd,
  p_pct_rndg_rl,
  p_prtt_elig_rlovr_rl,
  p_mx_rchd_dflt_ordr_num,
  p_pct_rlovr_incrmt_num,
  p_mn_rlovr_pct_num,
  p_mx_rlovr_pct_num,
  p_crs_rlovr_procg_cd,
  p_mx_pct_ttl_crs_cn_roll_num,
