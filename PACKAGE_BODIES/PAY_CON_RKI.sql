--------------------------------------------------------
--  DDL for Package Body PAY_CON_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_CON_RKI" as
...
begin
hr_utility.set_location('Entering: PAY_CON_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: PAY_CON_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end PAY_CON_RKI;
