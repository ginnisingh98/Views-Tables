--------------------------------------------------------
--  DDL for Package Body ADI_SECURITY_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ADI_SECURITY_API" AS
/* $Header: frmsapib.pls 120.0 2006/12/14 02:07:13 dvayro noship $ */
----------------------------------------------------------------------------------------
