--------------------------------------------------------
--  DDL for Package Body BEN_DPNT_EGD_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DPNT_EGD_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_dpnt_egd_bus.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
--
-- In Parameters
--   eligy_criteria_dpnt_id PK of record being inserted or updated.
...
--
Procedure chk_eligy_criteria_dpnt_id(p_eligy_criteria_dpnt_id           in number,
...
Begin
  ...
  --
  l_api_updating := ben_dpnt_egd_shd.api_updating
    (p_eligy_criteria_dpnt_id                => p_eligy_criteria_dpnt_id,
     p_object_version_number            => p_object_version_number);
  --
  if (l_api_updating
     and nvl(p_eligy_criteria_dpnt_id,hr_api.g_number)
     <>  ben_dpnt_egd_shd.g_old_rec.eligy_criteria_dpnt_id) then
    --
    -- raise error as PK has changed
    --
    ben_dpnt_egd_shd.constraint_error('BEN_dpnt_eligy_criteria_PK');
    --
  elsif not l_api_updating then
    --
    -- check if PK is null
    --
    if p_eligy_criteria_dpnt_id is not null then
      --
...
--     p_eligy_criteria_dpnt_id is eligy_criteria_dpnt_id
--     p_business_group_id
--
-- Post Success
--   Processing continues
...
--
-- In Parameters
--   p_eligy_criteria_dpnt_id          PK of record being inserted or updated.
...
--   Internal table handler use only.
--
Procedure chk_all_lookups(p_eligy_criteria_dpnt_id            in number,
...
Begin
  ...
  if (l_api_updating
      and p_criteria_type
      <> nvl(ben_dpnt_egd_shd.g_old_rec.criteria_type,hr_api.g_varchar2)
  ...
  if (l_api_updating
        ...
        <> nvl(ben_dpnt_egd_shd.g_old_rec.crit_col1_val_type_cd,hr_api.g_varchar2)
        or not l_api_updating)
  ...
  --
    if (l_api_updating
        ...
        <> nvl(ben_dpnt_egd_shd.g_old_rec.crit_col1_datatype,hr_api.g_varchar2)
        or not l_api_updating)
  ...
  if (l_api_updating
        ...
        <> nvl(ben_dpnt_egd_shd.g_old_rec.crit_col2_val_type_cd,hr_api.g_varchar2)
        or not l_api_updating)
  ...
  --
   if (l_api_updating
        ...
        <> nvl(ben_dpnt_egd_shd.g_old_rec.allow_range_validation_flg,hr_api.g_varchar2)
        or not l_api_updating)
  ...
  --  Added by rbingi for allow_range_validation_flag2 exixts check in Lookup
   if (l_api_updating
        ...
        <> nvl(ben_dpnt_egd_shd.g_old_rec.allow_range_validation_flag2,hr_api.g_varchar2)
        or not l_api_updating)
  ...
  if (l_api_updating
        ...
        <> nvl(ben_dpnt_egd_shd.g_old_rec.user_defined_flag,hr_api.g_varchar2)
        or not l_api_updating)
...
Procedure  chk_col_lookup_type( p_eligy_criteria_dpnt_id      in number,
                                p_col1_lookup_type       in varchar2,
  ...
  hr_utility.set_location('Entering:'||l_proc, 5);
    ...
    --
      ...
      if (l_api_updating
          ...
          <> nvl(ben_dpnt_egd_shd.g_old_rec.col1_lookup_type,hr_api.g_varchar2)
          or not l_api_updating)
	 ...
	 close c1;
      ...
      if (l_api_updating
          ...
          <> nvl(ben_dpnt_egd_shd.g_old_rec.col2_lookup_type,hr_api.g_varchar2)
          or not l_api_updating)
...
Procedure chk_access_calc_rule (p_eligy_criteria_dpnt_id      in number,
  ...
  hr_utility.set_location('Entering:'||l_proc, 5);
    ...
    --
      ...
      if (l_api_updating
          ...
          <> nvl(ben_dpnt_egd_shd.g_old_rec.access_calc_rule,hr_api.g_number)
          or not l_api_updating)
...
Procedure chk_col_value_set_id (p_eligy_criteria_dpnt_id      in number,
  ...
  hr_utility.set_location('Entering:'||l_proc, 5);
    ...
    --
      ...
      if (l_api_updating
          ...
          <> nvl(ben_dpnt_egd_shd.g_old_rec.col1_value_set_id,hr_api.g_number)
          or not l_api_updating)
	 ...
	 close c1;
      ...
      if (l_api_updating
          ...
          <> nvl(ben_dpnt_egd_shd.g_old_rec.col2_value_set_id,hr_api.g_number)
          or not l_api_updating)
...
--   ben_dpnt_eligy_crit_values_f table when the user deletes the record in the ben_
...
--   Internal table handler use only.
--
procedure chk_child_records(p_eligy_criteria_dpnt_id  in number) is
  --
...
--   Internal table handler use only.
--
Procedure chk_access_exclusive(p_access_table_name1	  in varchar2,
...
Procedure chk_table_column (p_eligy_criteria_dpnt_id      in  number,
                            p_access_table_name1     in  varchar2,
	                    p_access_column_name1    in  varchar2,
			    p_access_table_name2     in  varchar2,
	                    p_access_column_name2    in  varchar2,
    ...
    --
	 ...
	 close c1;
	  ...
	  if p_access_table_name1 is null then
	     fnd_message.set_name('BEN','BEN_94730_TABLE_REQUIRED');
	     fnd_message.raise_error;
            --
	     else
...
--Bug 4729818 Added new parameter p_set
  ...
  hr_utility.set_location('Entering:'||l_proc, 5);
	...
	then
	  ...
	  then
	    --
	    if (p_col_lookup_type is not null or p_col_value_set_id is not null )
	    then
	      --
	      fnd_message.set_name('BEN','BEN_94137_VALID_CRIT_BASIS');
    	      fnd_message.raise_error;
...
--	Bug 4729818 Display Appropriate error messages for two Sets
	if (p_set = 1) then --signifies set 1 is being checked
        fnd_message.set_name('BEN','BEN_94732_DEP_VAL_TYP_CD_NULL');
    	fnd_message.raise_error;
	end if;
...
Procedure chk_col_val_type_cd_upd(p_eligy_criteria_dpnt_id          in number,
	    ...
	    --
         ...
         if (
           (l_api_updating
            ...
            <> nvl(ben_dpnt_egd_shd.g_old_rec.crit_col1_val_type_cd,hr_api.g_number)
	    )
          or not l_api_updating
	  )
...
--   Internal table handler use only.
--
Procedure chk_tab_col_rl_null(p_access_table_name1	  in varchar2,
                              p_access_column_name1	  in varchar2) is
  --
...
Procedure chk_tab_col_rl_upd(      p_eligy_criteria_dpnt_id      in number,
                                   p_access_table_name1	    in varchar2,
                                   p_access_column_name1    in varchar2,
                                   p_object_version_number  in number) is
    ...
    --
      ...
      if (l_api_updating
          or not l_api_updating)
           then
        --
         chk_child_records(p_eligy_criteria_dpnt_id   => p_eligy_criteria_dpnt_id);
        --
      end if;
      --
      if (l_api_updating
          and p_access_table_name1
          <> nvl(ben_dpnt_egd_shd.g_old_rec.access_table_name1,hr_api.g_number)
          or not l_api_updating)
      ...
      if (l_api_updating
          ...
          <> nvl(ben_dpnt_egd_shd.g_old_rec.access_column_name1,hr_api.g_number)
          or not l_api_updating)
...
Begin
  ...
  --
  chk_eligy_criteria_dpnt_id(p_eligy_criteria_dpnt_id          => p_rec.eligy_criteria_dpnt_id,
                        p_object_version_number      => p_rec.object_version_number);
  --
  chk_name_unique( p_eligy_criteria_dpnt_id               => p_rec.eligy_criteria_dpnt_id
                  ,p_name                            => p_rec.name
                  ,p_business_group_id               => p_rec.business_group_id);
  --
  /* Bug 5338058 - Commenting this check as short_code need not to be unique
  chk_short_code_unique( p_eligy_criteria_dpnt_id          => p_rec.eligy_criteria_dpnt_id
                        ,p_short_code                 => p_rec.short_code
                        ,p_business_group_id          => p_rec.business_group_id); */
  --
  chk_all_lookups (    p_eligy_criteria_dpnt_id            => p_rec.eligy_criteria_dpnt_id ,
		       ...
		       p_user_defined_flag	      => p_rec.user_defined_flag,
                       ...
                       p_object_version_number        => p_rec.object_version_number) ;
  --
  chk_col_lookup_type (p_eligy_criteria_dpnt_id           => p_rec.eligy_criteria_dpnt_id,
		       ...
		       p_col2_lookup_type            => p_rec.col2_lookup_type,
                       ...
                       p_business_group_id           => p_rec.business_group_id);
  --
  chk_col_value_set_id(p_eligy_criteria_dpnt_id           => p_rec.eligy_criteria_dpnt_id,
                       p_col1_value_set_id           => p_rec.col1_value_set_id,
		       p_col2_value_set_id           => p_rec.col2_value_set_id,
                       p_object_version_number       => p_rec.object_version_number);
  --
  /*chk_access_calc_rule(p_eligy_criteria_dpnt_id           => p_rec.eligy_criteria_dpnt_id,
                       p_access_calc_rule            => p_rec.access_calc_rule,
                       p_business_group_id           => p_rec.business_group_id,
                       p_effective_date              => p_effective_date,
                       p_object_version_number       => p_rec.object_version_number);*/
  /*chk_access_exclusive(p_access_table_name1	     => p_rec.access_table_name1,
                       p_access_column_name1	     => p_rec.access_column_name1);*/
  chk_table_column (  p_eligy_criteria_dpnt_id           => p_rec.eligy_criteria_dpnt_id,
...
--Bug 4729818 Make the call according to the signature
  ...
  then
  chk_tab_col_rl_null(p_access_table_name1	   => p_rec.access_table_name1,
                      p_access_column_name1	   => p_rec.access_column_name1);
  end if;
  ...
  /*if(p_rec.time_access_calc_rule2 is not null) then
   ...
   if p_rec.crit_col1_val_type_cd like '%HIER' and
       l_set2_empty = 'N' then
     --
      fnd_message.set_name('BEN','BEN_94271_egd_HIER_NO_SET2');
      fnd_message.raise_error;
     --
   end if;
   --
   if(l_set2_empty = 'N') then
     ...
     --
     --
	  /*chk_access_exclusive(p_access_table_name1	     => p_rec.access_table_name2,
...
-- Bug 4729818 Make the call according to the signature
   ...
   if p_rec.criteria_type = 'USER'
   then
	chk_tab_col_rl_null(p_access_table_name1	   => p_rec.access_table_name2,
                      p_access_column_name1	   => p_rec.access_column_name2);
   end if;
 end if;
...
Begin
  ...
  chk_col_value_set_id( p_eligy_criteria_dpnt_id       => p_rec.eligy_criteria_dpnt_id,
		        ...
		        p_col2_value_set_id       => p_rec.col2_value_set_id,
                        p_object_version_number   => p_rec.object_version_number);
  --
  chk_tab_col_rl_upd(   p_eligy_criteria_dpnt_id      => p_rec.eligy_criteria_dpnt_id,
                        p_access_table_name1	 => p_rec.access_table_name1,
                        p_access_column_name1    => p_rec.access_column_name1,
                        p_object_version_number  => p_rec.object_version_number);
  --
  ...
  chk_table_column (   p_eligy_criteria_dpnt_id          => p_rec.eligy_criteria_dpnt_id,
		       ...
		       p_access_table_name2         => p_rec.access_table_name2,
	               p_access_column_name2        => p_rec.access_column_name2,
                       p_object_version_number      => p_rec.object_version_number);
 --
 chk_col_val_type_cd_upd (p_eligy_criteria_dpnt_id      => p_rec.eligy_criteria_dpnt_id,
...
-- Bug 4729818 Make the call according to the signature
 ...
 chk_allw_range_vld_flag_upd( p_eligy_criteria_dpnt_id    => p_rec.eligy_criteria_dpnt_id,
		       p_allow_range_validation_flg  => p_rec.allow_range_validation_flg,
...
function return_legislation_code
  (p_eligy_criteria_dpnt_id in number) return varchar2 is
  --
  -- Declare cursor
  --
...
begin
  ...
  hr_api.mandatory_arg_error(p_api_name       => l_proc,
                             p_argument       => 'eligy_criteria_dpnt_id',
                             p_argument_value => p_eligy_criteria_dpnt_id);
  --
  open csr_leg_code;
    --
