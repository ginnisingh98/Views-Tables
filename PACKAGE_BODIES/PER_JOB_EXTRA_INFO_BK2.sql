--------------------------------------------------------
--  DDL for Package Body PER_JOB_EXTRA_INFO_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_JOB_EXTRA_INFO_BK2" as
...
begin
hr_utility.set_location('Entering: PER_JOB_EXTRA_INFO_BK2.UPDATE_JOB_EXTRA_INFO_A', 10);
hr_utility.set_location(' Leaving: PER_JOB_EXTRA_INFO_BK2.UPDATE_JOB_EXTRA_INFO_A', 20);
end UPDATE_JOB_EXTRA_INFO_A;
...
begin
hr_utility.set_location('Entering: PER_JOB_EXTRA_INFO_BK2.UPDATE_JOB_EXTRA_INFO_B', 10);
hr_utility.set_location(' Leaving: PER_JOB_EXTRA_INFO_BK2.UPDATE_JOB_EXTRA_INFO_B', 20);
end UPDATE_JOB_EXTRA_INFO_B;
