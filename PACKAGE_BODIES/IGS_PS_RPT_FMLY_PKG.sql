--------------------------------------------------------
--  DDL for Package Body IGS_PS_RPT_FMLY_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_PS_RPT_FMLY_PKG" AS
/* $Header: IGSPI2CB.pls 115.7 2003/03/21 08:00:47 sarakshi ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_ps_rpt_fmly_all%ROWTYPE;
  new_references igs_ps_rpt_fmly_all%ROWTYPE;
  ...
  */
  BEGIN
    ...
    igs_ps_unit_ver_pkg.get_fk_igs_ps_rpt_fmly_all (
      old_references.rpt_fmly_id
    );
  ...
  */
    CURSOR cur_rowid IS
      ...
      WHERE    repeat_code = x_repeat_code
  ...
  */
  ...
  BEGIN
    ...
    select igs_ps_rpt_fmly_all_s.NEXTVAL
    into x_rpt_fmly_id
    from dual;
    ...
    INSERT INTO igs_ps_rpt_fmly_all (
      rpt_fmly_id,
      repeat_code,
      description,
      closed_ind,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.repeat_code = x_repeat_code)
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_ps_rpt_fmly_all
    WHERE rowid = x_rowid;
