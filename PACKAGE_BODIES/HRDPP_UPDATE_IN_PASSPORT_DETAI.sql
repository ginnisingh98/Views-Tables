--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_IN_PASSPORT_DETAI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_IN_PASSPORT_DETAI" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:01
 * Generated for API: hr_in_person_extra_info_api.update_in_passport_details
 */
--
...
,P_PASSPORT_NAME in varchar2 default null
,P_PASSPORT_NUMBER in varchar2 default null
,P_PLACE_OF_ISSUE in varchar2 default null
,P_ECNR_REQUIRED in varchar2 default null
,P_PERSON_EXTRA_INFO_USER_KEY in varchar2
,P_ISSUE_DATE in varchar2 default null
,P_EXPIRY_DATE in varchar2 default null
,P_ISSUING_COUNTRY in varchar2 default null) is
...
L_ISSUE_DATE varchar2(2000);
L_EXPIRY_DATE varchar2(2000);
L_ISSUING_COUNTRY varchar2(2000);
--
begin
...
--
if c.p26 is null then
L_PERSON_EXTRA_INFO_ID:=nn;
else
L_PERSON_EXTRA_INFO_ID := 
PER_IN_DATA_PUMP.get_person_extra_info_id
(P_PERSON_EXTRA_INFO_USER_KEY => c.p26);
end if;
--
if c.p26 is null then
...
PER_IN_DATA_PUMP.GET_PERSON_EXTRA_INFO_OVN
(P_PERSON_EXTRA_INFO_USER_KEY => c.p26);
end if;
--
if c.d27=cn then
L_ISSUE_DATE:=vn;
elsif c.d27 is null then 
L_ISSUE_DATE:=vh;
else
L_ISSUE_DATE := 
PER_IN_DATA_PUMP.GET_ISSUE_DATE
(P_ISSUE_DATE => c.p27);
end if;
--
if c.d28=cn then
L_EXPIRY_DATE:=vn;
elsif c.d28 is null then 
L_EXPIRY_DATE:=vh;
else
L_EXPIRY_DATE := 
PER_IN_DATA_PUMP.GET_EXPIRY_DATE
(P_EXPIRY_DATE => c.p28);
end if;
--
if c.d29=cn then
L_ISSUING_COUNTRY:=vn;
elsif c.d29 is null then 
L_ISSUING_COUNTRY:=vh;
else
L_ISSUING_COUNTRY := 
PER_IN_DATA_PUMP.GET_PASSPORT_COUNTRY
(P_ISSUING_COUNTRY => c.p29);
end if;
--
hr_data_pump.api_trc_on;
hr_in_person_extra_info_api.update_in_passport_details
...
,P_PASSPORT_NAME => c.p22
,P_PASSPORT_NUMBER => c.p23
,P_PLACE_OF_ISSUE => c.p24
,P_ISSUE_DATE => L_ISSUE_DATE
,P_EXPIRY_DATE => L_EXPIRY_DATE
,P_ECNR_REQUIRED => c.p25
,P_ISSUING_COUNTRY => L_ISSUING_COUNTRY);
...
end hrdpp_update_in_passport_detai;
