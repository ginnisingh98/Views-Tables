--------------------------------------------------------
--  DDL for Package Body FA_FAS449_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FAS449_XMLP_PKG" AS
/* $Header: FAS449B.pls 120.0.12010000.1 2008/07/28 13:14:52 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    RP_Report_Name := ':Form 4684 - Casualties and Thefts Report:';
...
END;
RETURN NULL; end;
function precisionformula(V_CURRENCY_CODE in varchar2) return number is
begin
DECLARE
	l_precision	NUMBER;
BEGIN
