--------------------------------------------------------
--  DDL for Package Body POS_COMMON_APIS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."POS_COMMON_APIS" AS
/* $Header: POSCOMAB.pls 115.4 2002/11/26 02:31:35 ammitra ship $ */
...
begin
	...
	x_supplier_user_id := wf_engine.GetItemAttrNumber ( itemtype => itemtype,
                                   		 	itemkey  => itemkey,
                            	 	         	aname    => 'SUPPLIER_USER_ID');

	--dbms_output.put_line (' Get Supplier Username ' || x_supplier_user_id);
	if x_supplier_user_id is not null then
