--------------------------------------------------------
--  DDL for Package Body PER_AST_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_AST_FLEX" as
/* $Header: peastfli.pkb 115.0 99/07/17 18:45:54 porting ship $ */
--
--
-- ---------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_ast_flex.';  -- Global package name
--
--
--
----------------------------------------------------------------------------
