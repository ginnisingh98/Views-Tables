--------------------------------------------------------
--  DDL for Package Body AS_LEAD_CONTACTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AS_LEAD_CONTACTS_PKG" as
/* $Header: asxtlcnb.pls 115.5 2002/12/13 11:20:38 nkamble ship $ */
-- Start of Comments
-- Package name     : AS_LEAD_CONTACTS_PKG
-- Purpose          :
-- History          :
-- NOTE             :
-- End of Comments
...
G_PKG_NAME CONSTANT VARCHAR2(30):= 'AS_LEAD_CONTACTS_PKG';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'asxtlcnb.pls';
...
PROCEDURE Insert_Row(
 ...
 IS
   CURSOR C2 IS SELECT AS_LEAD_CONTACTS_S.nextval FROM sys.dual;
BEGIN
   ...
   INSERT INTO AS_LEAD_CONTACTS(
           ...
           decode( p_PRIMARY_CONTACT_FLAG, FND_API.G_MISS_CHAR, NULL, p_PRIMARY_CONTACT_FLAG),
           decode( p_ROLE, FND_API.G_MISS_CHAR, NULL, p_ROLE),
...
PROCEDURE Update_Row(
 ...
 BEGIN
    ...
    SET
              ...
              CONTACT_ID = decode( p_CONTACT_ID, FND_API.G_MISS_NUM, CONTACT_ID, p_CONTACT_ID),
              ...
              ROLE = decode( p_ROLE, FND_API.G_MISS_CHAR, ROLE, p_ROLE),
