--------------------------------------------------------
--  DDL for Package Body GME_REROUTE_BATCH_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_REROUTE_BATCH_PVT" AS
   /* $Header: GMEVRRBB.pls 120.10 2006/08/18 15:51:27 svgonugu noship $ */
