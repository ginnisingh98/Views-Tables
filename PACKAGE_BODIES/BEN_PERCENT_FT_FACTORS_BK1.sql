--------------------------------------------------------
--  DDL for Package Body BEN_PERCENT_FT_FACTORS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PERCENT_FT_FACTORS_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PERCENT_FT_FACTORS_BK1.CREATE_PERCENT_FT_FACTORS_A', 10);
hr_utility.set_location(' Leaving: BEN_PERCENT_FT_FACTORS_BK1.CREATE_PERCENT_FT_FACTORS_A', 20);
end CREATE_PERCENT_FT_FACTORS_A;
...
begin
hr_utility.set_location('Entering: BEN_PERCENT_FT_FACTORS_BK1.CREATE_PERCENT_FT_FACTORS_B', 10);
hr_utility.set_location(' Leaving: BEN_PERCENT_FT_FACTORS_BK1.CREATE_PERCENT_FT_FACTORS_B', 20);
end CREATE_PERCENT_FT_FACTORS_B;
