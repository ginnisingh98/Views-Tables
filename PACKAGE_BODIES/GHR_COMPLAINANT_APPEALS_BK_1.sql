--------------------------------------------------------
--  DDL for Package Body GHR_COMPLAINANT_APPEALS_BK_1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_COMPLAINANT_APPEALS_BK_1" as
...
begin
hr_utility.set_location('Entering: GHR_COMPLAINANT_APPEALS_BK_1.CREATE_COMPLAINANT_APPEAL_A', 10);
hr_utility.set_location(' Leaving: GHR_COMPLAINANT_APPEALS_BK_1.CREATE_COMPLAINANT_APPEAL_A', 20);
end CREATE_COMPLAINANT_APPEAL_A;
...
begin
hr_utility.set_location('Entering: GHR_COMPLAINANT_APPEALS_BK_1.CREATE_COMPLAINANT_APPEAL_B', 10);
hr_utility.set_location(' Leaving: GHR_COMPLAINANT_APPEALS_BK_1.CREATE_COMPLAINANT_APPEAL_B', 20);
end CREATE_COMPLAINANT_APPEAL_B;
