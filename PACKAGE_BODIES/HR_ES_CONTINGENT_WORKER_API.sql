--------------------------------------------------------
--  DDL for Package Body HR_ES_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ES_CONTINGENT_WORKER_API" as
/* $Header: pecwkesi.pkb 115.0 2004/03/18 01:24:04 vikgupta noship $ */
--
--   package variables
g_package  varchar2(33) := 'hr_es_contingent_worker_api.';
