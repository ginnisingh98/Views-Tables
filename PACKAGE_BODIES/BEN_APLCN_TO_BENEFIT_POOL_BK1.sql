--------------------------------------------------------
--  DDL for Package Body BEN_APLCN_TO_BENEFIT_POOL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_APLCN_TO_BENEFIT_POOL_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_APLCN_TO_BENEFIT_POOL_BK1.CREATE_APLCN_TO_BENEFIT_POOL_A', 10);
hr_utility.set_location(' Leaving: BEN_APLCN_TO_BENEFIT_POOL_BK1.CREATE_APLCN_TO_BENEFIT_POOL_A', 20);
end CREATE_APLCN_TO_BENEFIT_POOL_A;
...
begin
hr_utility.set_location('Entering: BEN_APLCN_TO_BENEFIT_POOL_BK1.CREATE_APLCN_TO_BENEFIT_POOL_B', 10);
hr_utility.set_location(' Leaving: BEN_APLCN_TO_BENEFIT_POOL_BK1.CREATE_APLCN_TO_BENEFIT_POOL_B', 20);
end CREATE_APLCN_TO_BENEFIT_POOL_B;
