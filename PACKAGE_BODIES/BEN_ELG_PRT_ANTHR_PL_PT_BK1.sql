--------------------------------------------------------
--  DDL for Package Body BEN_ELG_PRT_ANTHR_PL_PT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELG_PRT_ANTHR_PL_PT_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_ELG_PRT_ANTHR_PL_PT_BK1.CREATE_ELG_PRT_ANTHR_PL_PT_A', 10);
hr_utility.set_location(' Leaving: BEN_ELG_PRT_ANTHR_PL_PT_BK1.CREATE_ELG_PRT_ANTHR_PL_PT_A', 20);
end CREATE_ELG_PRT_ANTHR_PL_PT_A;
...
begin
hr_utility.set_location('Entering: BEN_ELG_PRT_ANTHR_PL_PT_BK1.CREATE_ELG_PRT_ANTHR_PL_PT_B', 10);
hr_utility.set_location(' Leaving: BEN_ELG_PRT_ANTHR_PL_PT_BK1.CREATE_ELG_PRT_ANTHR_PL_PT_B', 20);
end CREATE_ELG_PRT_ANTHR_PL_PT_B;
