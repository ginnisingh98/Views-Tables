--------------------------------------------------------
--  DDL for Package Body BEN_CEP_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CEP_RKI" as
...
begin
hr_utility.set_location('Entering: ben_cep_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_cep_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_cep_RKI;
