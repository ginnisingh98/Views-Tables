--------------------------------------------------------
--  DDL for Package Body BEN_CCT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CCT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_cct_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_cm_typ_f.created_by%TYPE;
  l_creation_date       ben_cm_typ_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_cm_typ_f
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.cm_typ_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  dt_api.validate_dt_mode
	(p_effective_date	   => p_effective_date,
	 ...
	 p_parent_key_value1       => p_rec.parnt_cm_typ_id,
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_cct_rec
