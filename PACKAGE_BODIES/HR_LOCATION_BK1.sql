--------------------------------------------------------
--  DDL for Package Body HR_LOCATION_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_LOCATION_BK1" as
...
begin
hr_utility.set_location('Entering: HR_LOCATION_BK1.CREATE_LOCATION_A', 10);
...
hr_location_be1.CREATE_LOCATION_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_LOCATION', 'AP');
hr_utility.set_location(' Leaving: HR_LOCATION_BK1.CREATE_LOCATION_A', 20);
end CREATE_LOCATION_A;
procedure CREATE_LOCATION_B
(P_EFFECTIVE_DATE in DATE
,P_LANGUAGE_CODE in VARCHAR2
,P_LOCATION_CODE in VARCHAR2
,P_DESCRIPTION in VARCHAR2
...
l_legislation_code   varchar2(30);
begin
hr_utility.set_location('Entering: HR_LOCATION_BK1.CREATE_LOCATION_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
...
HR_AE_VALIDATE_PKG.CREATE_LOCATION_VALIDATE
(P_STYLE => P_STYLE
,P_EFFECTIVE_DATE => P_EFFECTIVE_DATE
,P_ADDRESS_LINE_3 => P_ADDRESS_LINE_3
,P_TOWN_OR_CITY => P_TOWN_OR_CITY
...
PER_ES_LOCATION.CREATE_ES_LOCATION
(P_STYLE => P_STYLE
,P_POSTAL_CODE => P_POSTAL_CODE
,P_REGION_2 => P_REGION_2
);
elsif l_legislation_code = 'PL' then
PER_PL_LOCATION.CREATE_PL_LOCATION
(P_STYLE => P_STYLE
,P_ADDRESS_LINE_1 => P_ADDRESS_LINE_1
,P_ADDRESS_LINE_2 => P_ADDRESS_LINE_2
);
elsif l_legislation_code = 'RU' then
HR_RU_LOCATION_HOOK.CREATE_RU_LOCATION
(P_STYLE => P_STYLE
,P_LOC_INFORMATION13 => P_LOC_INFORMATION13
,P_POSTAL_CODE => P_POSTAL_CODE
);
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_LOCATION', 'BP');
hr_utility.set_location(' Leaving: HR_LOCATION_BK1.CREATE_LOCATION_B', 20);
end CREATE_LOCATION_B;
end HR_LOCATION_BK1;
