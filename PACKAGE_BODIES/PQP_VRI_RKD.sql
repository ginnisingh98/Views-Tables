--------------------------------------------------------
--  DDL for Package Body PQP_VRI_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_VRI_RKD" as
...
begin
hr_utility.set_location('Entering: PQP_VRI_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: PQP_VRI_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end PQP_VRI_RKD;
