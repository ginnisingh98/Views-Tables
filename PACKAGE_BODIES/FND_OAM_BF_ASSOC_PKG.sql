--------------------------------------------------------
--  DDL for Package Body FND_OAM_BF_ASSOC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FND_OAM_BF_ASSOC_PKG" as
/* $Header: AFOAMFAB.pls 120.1 2005/07/02 03:03:10 appldev noship $ */
  -- Module name for this package
  MODULE constant varchar2(200) := 'fnd.plsql.FND_OAM_BF_ASSOC_PKG';
...
begin
      ...
      if (fnd_load_util.upload_test(f_luby, f_ludate, db_luby,
        ...
        fnd_oam_bf_assoc_pkg.UPDATE_ROW (
          X_BIZ_FLOW_PARENT_KEY => X_BIZ_FLOW_PARENT_KEY,
          X_BIZ_FLOW_CHILD_KEY => X_BIZ_FLOW_CHILD_KEY,
          X_MONITORED_FLAG => X_MONITORED_FLAG,
          X_DISPLAY_ORDER => X_DISPLAY_ORDER,
      ...
      exception
        ...
        fnd_oam_bf_assoc_pkg.INSERT_ROW (
          X_ROWID => row_id,
          X_BIZ_FLOW_PARENT_KEY => X_BIZ_FLOW_PARENT_KEY,
          X_BIZ_FLOW_CHILD_KEY => X_BIZ_FLOW_CHILD_KEY,
          X_MONITORED_FLAG => X_MONITORED_FLAG,
...
is
  cursor C is select ROWID from FND_OAM_BF_ASSOC
    where BIZ_FLOW_PARENT_KEY = X_BIZ_FLOW_PARENT_KEY
    and biz_flow_child_key = x_biz_flow_child_key;
begin
  check_loop(
