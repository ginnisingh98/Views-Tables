--------------------------------------------------------
--  DDL for Package Body PSP_PRT_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_PRT_RKU" as
...
begin
hr_utility.set_location('Entering: PSP_PRT_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PSP_PRT_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PSP_PRT_RKU;
