--------------------------------------------------------
--  DDL for Package Body BEN_PET_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PET_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pet_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_POPL_ENRT_TYP_CYCL_FK2') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_POPL_ENRT_TYP_CYCL_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  If (p_effective_date is null or
      p_popl_enrt_typ_cycl_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_popl_enrt_typ_cycl_id = g_old_rec.popl_enrt_typ_cycl_id and
...
Begin
  ...
  l_rec.pet_attribute_category           := p_pet_attribute_category;
  l_rec.pet_attribute1                   := p_pet_attribute1;
  l_rec.pet_attribute2                   := p_pet_attribute2;
  l_rec.pet_attribute3                   := p_pet_attribute3;
  l_rec.pet_attribute4                   := p_pet_attribute4;
  l_rec.pet_attribute5                   := p_pet_attribute5;
  l_rec.pet_attribute6                   := p_pet_attribute6;
  l_rec.pet_attribute7                   := p_pet_attribute7;
  l_rec.pet_attribute8                   := p_pet_attribute8;
  l_rec.pet_attribute9                   := p_pet_attribute9;
  l_rec.pet_attribute10                  := p_pet_attribute10;
  l_rec.pet_attribute11                  := p_pet_attribute11;
  l_rec.pet_attribute12                  := p_pet_attribute12;
  l_rec.pet_attribute13                  := p_pet_attribute13;
  l_rec.pet_attribute14                  := p_pet_attribute14;
  l_rec.pet_attribute15                  := p_pet_attribute15;
  l_rec.pet_attribute16                  := p_pet_attribute16;
  l_rec.pet_attribute17                  := p_pet_attribute17;
  l_rec.pet_attribute18                  := p_pet_attribute18;
  l_rec.pet_attribute19                  := p_pet_attribute19;
  l_rec.pet_attribute20                  := p_pet_attribute20;
  l_rec.pet_attribute21                  := p_pet_attribute21;
  l_rec.pet_attribute22                  := p_pet_attribute22;
  l_rec.pet_attribute23                  := p_pet_attribute23;
  l_rec.pet_attribute24                  := p_pet_attribute24;
  l_rec.pet_attribute25                  := p_pet_attribute25;
  l_rec.pet_attribute26                  := p_pet_attribute26;
  l_rec.pet_attribute27                  := p_pet_attribute27;
  l_rec.pet_attribute28                  := p_pet_attribute28;
  l_rec.pet_attribute29                  := p_pet_attribute29;
  l_rec.pet_attribute30                  := p_pet_attribute30;
