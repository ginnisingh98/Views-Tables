--------------------------------------------------------
--  DDL for Package Body PER_COT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_COT_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_cot_bus.';  -- Global package name
--
...
begin
  ...
  --
  --
  per_cpo_bus.set_security_group_id(
...
Begin
  ...
  --
  IF NOT per_cot_shd.api_updating
