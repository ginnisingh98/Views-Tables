--------------------------------------------------------
--  DDL for Package Body OTA_ADT_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_ADT_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_adt_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure update_dml
  (p_rec in out nocopy ota_adt_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Update the ota_activity_definitions_tl Row
  --
  update ota_activity_definitions_tl
    set
...
Begin
  ...
  --
  ota_adt_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_adt_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_adt_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
  ...
  cursor csr_upd_langs is
    select adt.language
     ...
     where adt.activity_id = p_activity_id
       and p_language_code in (adt.language
                              ,adt.source_lang);
  --
