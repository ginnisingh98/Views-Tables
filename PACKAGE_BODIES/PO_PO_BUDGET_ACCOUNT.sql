--------------------------------------------------------
--  DDL for Package Body PO_PO_BUDGET_ACCOUNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PO_PO_BUDGET_ACCOUNT" AS
/* $Header: POXWFB2B.pls 115.4 2002/11/25 21:51:22 sbull ship $*/
...
BEGIN
  ...
  FND_MESSAGE.SET_TOKEN('FUNC', 'PO_PO_BUDGET_ACCOUNT');
  FB_ERROR_MSG := FND_MESSAGE.GET_ENCODED;
  RETURN FALSE;
END;

END PO_PO_BUDGET_ACCOUNT;
