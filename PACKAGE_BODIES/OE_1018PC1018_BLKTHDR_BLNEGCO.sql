--------------------------------------------------------
--  DDL for Package Body OE_1018PC1018_BLKTHDR_BLNEGCO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_1018PC1018_BLKTHDR_BLNEGCO" AS 
 PROCEDURE Is_Valid
 ( 
...
BEGIN 
   ...
   Return; 
END Is_Valid;
END OE_1018PC1018_BLKTHDR_BLNEGCO;
