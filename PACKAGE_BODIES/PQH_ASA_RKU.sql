--------------------------------------------------------
--  DDL for Package Body PQH_ASA_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_ASA_RKU" as
...
begin
hr_utility.set_location('Entering: PQH_ASA_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PQH_ASA_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQH_ASA_RKU;
