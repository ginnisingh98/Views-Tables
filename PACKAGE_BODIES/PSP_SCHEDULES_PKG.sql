--------------------------------------------------------
--  DDL for Package Body PSP_SCHEDULES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_SCHEDULES_PKG" as
--$Header: PSPLSTHB.pls 115.6 2002/11/18 12:10:51 lveerubh ship $
procedure INSERT_ROW (
  ...
  X_SET_OF_BOOKS_ID in NUMBER
    ...
    cursor C is select ROWID from PSP_SCHEDULES
...
procedure ADD_ROW (
  ...
  cursor c1 is select rowid from PSP_SCHEDULES
     where ASSIGNMENT_ID = X_ASSIGNMENT_ID
     and BUSINESS_GROUP_ID = X_BUSINESS_GROUP_ID
     and SET_OF_BOOKS_ID = X_SET_OF_BOOKS_ID
  ;
