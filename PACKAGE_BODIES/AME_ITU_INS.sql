--------------------------------------------------------
--  DDL for Package Body AME_ITU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ITU_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_itu_ins.';  -- Global package name
--
...
Begin
  ...
  --
  ame_itu_ins.g_application_id_i := p_application_id;
  ame_itu_ins.g_item_class_id_i  := p_item_class_id;
  --
  ...
  Cursor C_Sel1 Is
    select t.creation_date
     ...
     where t.item_class_id  = p_rec.item_class_id
       ...
       and t.start_date     = ame_itu_shd.g_old_rec.start_date
...
--
  ...
  l_created_by          ame_item_class_usages.created_by%TYPE;
  l_creation_date       ame_item_class_usages.creation_date%TYPE;
  l_last_update_date    ame_item_class_usages.last_update_date%TYPE;
  l_last_updated_by     ame_item_class_usages.last_updated_by%TYPE;
  l_last_update_login   ame_item_class_usages.last_update_login%TYPE;
...
Begin
  ...
  --
  --
  -- Insert the row into: ame_item_class_usages
  --
...
--
/*
  Cursor C_Sel1 is select ame_item_class_usages_s.nextval from sys.dual;
*/
--
 Cursor C_Sel2 is
    Select null
     ...
     where application_id =
             ame_itu_ins.g_application_id_i
       and item_class_id =
             ame_itu_ins.g_item_class_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (ame_itu_ins.g_application_id_i is not null or
      ame_itu_ins.g_item_class_id_i is not null) Then
    --
    ...
    p_rec.application_id :=
      ame_itu_ins.g_application_id_i;
    ame_itu_ins.g_application_id_i := null;
    p_rec.item_class_id :=
      ame_itu_ins.g_item_class_id_i;
    ame_itu_ins.g_item_class_id_i := null;
/*
  Else
    --
...
Begin
  ...
  --
  -- Having converted the arguments into the ame_itu_rec
