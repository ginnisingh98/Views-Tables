--------------------------------------------------------
--  DDL for Package Body BEN_AGE_FACTOR_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_AGE_FACTOR_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_AGE_FACTOR_BK1.CREATE_AGE_FACTOR_A', 10);
hr_utility.set_location(' Leaving: BEN_AGE_FACTOR_BK1.CREATE_AGE_FACTOR_A', 20);
end CREATE_AGE_FACTOR_A;
...
begin
hr_utility.set_location('Entering: BEN_AGE_FACTOR_BK1.CREATE_AGE_FACTOR_B', 10);
hr_utility.set_location(' Leaving: BEN_AGE_FACTOR_BK1.CREATE_AGE_FACTOR_B', 20);
end CREATE_AGE_FACTOR_B;
