--------------------------------------------------------
--  DDL for Package Body HXC_ULP_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_ULP_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_ulp_del.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Delete the hxc_layout_comp_prompts row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hxc_ulp_shd.g_rec_type) is
--
  l_proc  varchar2(72) ;
--
Begin
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hxc_ulp_shd.g_rec_type) is
--
  l_proc  varchar2(72) ;
--
Begin
...
Begin
  ...
  --
  hxc_ulp_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  hxc_ulp_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hxc_ulp_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hxc_ulp_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
