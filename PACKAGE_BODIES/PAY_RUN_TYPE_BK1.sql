--------------------------------------------------------
--  DDL for Package Body PAY_RUN_TYPE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_RUN_TYPE_BK1" as
...
begin
hr_utility.set_location('Entering: PAY_RUN_TYPE_BK1.CREATE_RUN_TYPE_A', 10);
hr_utility.set_location(' Leaving: PAY_RUN_TYPE_BK1.CREATE_RUN_TYPE_A', 20);
end CREATE_RUN_TYPE_A;
...
begin
hr_utility.set_location('Entering: PAY_RUN_TYPE_BK1.CREATE_RUN_TYPE_B', 10);
hr_utility.set_location(' Leaving: PAY_RUN_TYPE_BK1.CREATE_RUN_TYPE_B', 20);
end CREATE_RUN_TYPE_B;
