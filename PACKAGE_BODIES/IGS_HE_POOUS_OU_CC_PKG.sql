--------------------------------------------------------
--  DDL for Package Body IGS_HE_POOUS_OU_CC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_HE_POOUS_OU_CC_PKG" AS
/* $Header: IGSWI48B.pls 120.0 2005/06/01 21:52:32 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_he_poous_ou_cc%ROWTYPE;
  new_references igs_he_poous_ou_cc%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.hesa_poous_cc_id                  := x_hesa_poous_cc_id;
  ...
  */
  BEGIN
    ...
    IF (((old_references.hesa_poous_ou_id = new_references.hesa_poous_ou_id)) OR
        ((new_references.hesa_poous_ou_id IS NULL))) THEN
      NULL;
    ELSIF NOT igs_he_poous_ou_all_pkg.get_pk_for_validation (
                new_references.hesa_poous_ou_id
              ) THEN
      fnd_message.set_name ('FND', 'FORM_RECORD_DELETED');
      igs_ge_msg_stack.add;
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_he_poous_ou_cc
      WHERE    hesa_poous_cc_id = x_hesa_poous_cc_id
      FOR UPDATE NOWAIT;
  ...
  BEGIN
    ...
    IF (p_action = 'INSERT') THEN
      ...
      IF ( get_pk_for_validation(
             new_references.hesa_poous_cc_id
           )
         ) THEN
        fnd_message.set_name('IGS','IGS_GE_RECORD_ALREADY_EXISTS');
        igs_ge_msg_stack.add;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGS_HE_POOUS_OU_CC_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    INSERT INTO igs_he_poous_ou_cc (
      hesa_poous_cc_id,
      hesa_poous_ou_id,
      cost_centre,
      subject,
      ...
      x_last_updated_by,
      x_last_update_login
    ) RETURNING ROWID, hesa_poous_cc_id INTO x_rowid, x_hesa_poous_cc_id;
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.hesa_poous_ou_id = x_hesa_poous_ou_id)
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGS_HE_POOUS_OU_CC_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    UPDATE igs_he_poous_ou_cc
      SET
        hesa_poous_ou_id                  = new_references.hesa_poous_ou_id,
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_he_poous_ou_cc
    WHERE rowid = x_rowid;
