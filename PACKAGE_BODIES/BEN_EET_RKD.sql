--------------------------------------------------------
--  DDL for Package Body BEN_EET_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EET_RKD" as
...
begin
hr_utility.set_location('Entering: ben_eet_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_eet_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_eet_RKD;
