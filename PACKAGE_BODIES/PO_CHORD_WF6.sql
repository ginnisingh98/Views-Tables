--------------------------------------------------------
--  DDL for Package Body PO_CHORD_WF6
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PO_CHORD_WF6" AS
/* $Header: POXWCO6B.pls 120.22 2008/02/21 22:06:17 jburugul ship $ */
  ...
  -- <Complex Work R12 End>
	...
	*/
    ...
    OR  x_shipments_control.work_approver_id = 'Y'
	  OR	((NOT l_is_complex_work_po) AND
          (x_shipments_control.quantity_change > nvl(x_tolerance_control.s_quantity_t,0)))
    ...
    --<R12 Requester Driven Procurement>
	  OR	((NOT l_is_complex_work_po) AND
          (x_shipments_control.amount_change > nvl(x_tolerance_control.s_amount_t,0)))
    OR ((l_is_complex_work_po) AND
