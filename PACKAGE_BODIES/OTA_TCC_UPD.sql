--------------------------------------------------------
--  DDL for Package Body OTA_TCC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TCC_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ota_tcc_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the ota_cross_charges Row
  --
  update ota_cross_charges
    set
...
Begin
  ...
  If (p_rec.type = hr_api.g_varchar2) then
    ...
    ota_tcc_shd.g_old_rec.type;
  End If;
  If (p_rec.from_to = hr_api.g_varchar2) then
    p_rec.from_to :=
    ota_tcc_shd.g_old_rec.from_to;
  End If;
...
Begin
  ...
  --
  ota_tcc_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_tcc_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_tcc_upd.post_update
     (p_effective_date
     ,p_rec
     );
   --
