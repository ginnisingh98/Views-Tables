--------------------------------------------------------
--  DDL for Package Body BEN_JRT_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_JRT_RKU" as
/* $Header: bejrtrhi.pkb 120.2 2006/03/30 23:48:52 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_JRT_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: BEN_JRT_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end BEN_JRT_RKU;
