--------------------------------------------------------
--  DDL for Package Body OKL_SETUPTQYVALUES_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPTQYVALUES_PVT_W" as
  /* $Header: OKLESEVB.pls 115.2 2002/12/24 04:01:13 sgorantl noship $ */
  ...
  as
    ddp_ptvv_rec okl_setuptqyvalues_pvt.ptvv_rec_type;
    ddx_no_data_found boolean;
    ddx_ptvv_rec okl_setuptqyvalues_pvt.ptvv_rec_type;
  ...
  begin
    ...
    okl_setuptqyvalues_pvt.get_rec(ddp_ptvv_rec,
      ddx_no_data_found,
      x_return_status,
      ddx_ptvv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p3_a0 := rosetta_g_miss_num_map(ddx_ptvv_rec.id);
    p3_a1 := rosetta_g_miss_num_map(ddx_ptvv_rec.object_version_number);
    p3_a2 := rosetta_g_miss_num_map(ddx_ptvv_rec.ptq_id);
    p3_a3 := ddx_ptvv_rec.value;
    p3_a4 := ddx_ptvv_rec.description;
    p3_a5 := ddx_ptvv_rec.from_date;
    p3_a6 := ddx_ptvv_rec.to_date;
    p3_a7 := rosetta_g_miss_num_map(ddx_ptvv_rec.created_by);
    p3_a8 := ddx_ptvv_rec.creation_date;
    p3_a9 := rosetta_g_miss_num_map(ddx_ptvv_rec.last_updated_by);
    p3_a10 := ddx_ptvv_rec.last_update_date;
    p3_a11 := rosetta_g_miss_num_map(ddx_ptvv_rec.last_update_login);
  end;
  ...
  as
    ddp_ptqv_rec okl_setuptqyvalues_pvt.ptqv_rec_type;
    ddp_ptvv_rec okl_setuptqyvalues_pvt.ptvv_rec_type;
    ddx_ptvv_rec okl_setuptqyvalues_pvt.ptvv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuptqyvalues_pvt.insert_tqyvalues(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuptqyvalues_pvt.update_tqyvalues(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
