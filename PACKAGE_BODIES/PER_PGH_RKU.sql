--------------------------------------------------------
--  DDL for Package Body PER_PGH_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PGH_RKU" as
/* $Header: pepghrhi.pkb 120.0 2005/05/31 14:05:56 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/01/04 09:32:36 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: per_pgh_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: per_pgh_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end per_pgh_RKU;
