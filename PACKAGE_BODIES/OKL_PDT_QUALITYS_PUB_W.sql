--------------------------------------------------------
--  DDL for Package Body OKL_PDT_QUALITYS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PDT_QUALITYS_PUB_W" as
  /* $Header: OKLUPQYB.pls 115.6 2002/12/24 04:16:03 sgorantl noship $ */
  ...
  as
    ddp_pqyv_rec okl_pdt_qualitys_pub.pqyv_rec_type;
    ddp_qvev_tbl okl_pdt_qualitys_pub.qvev_tbl_type;
    ddx_pqyv_rec okl_pdt_qualitys_pub.pqyv_rec_type;
    ddx_qvev_tbl okl_pdt_qualitys_pub.qvev_tbl_type;
  ...
  begin
    ...
    okl_pdt_qualitys_pub.create_pdt_qualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_qualitys_pub.update_pdt_qualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_qualitys_pub.validate_pdt_qualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_pqyv_tbl okl_pdt_qualitys_pub.pqyv_tbl_type;
    ddx_pqyv_tbl okl_pdt_qualitys_pub.pqyv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_qualitys_pub.lock_pdt_qualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_qualitys_pub.delete_pdt_qualitys(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_qualitys_pub.create_pdt_quality_vals(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_qvev_rec okl_pdt_qualitys_pub.qvev_rec_type;
    ddx_qvev_rec okl_pdt_qualitys_pub.qvev_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_qualitys_pub.lock_pdt_quality_vals(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_qualitys_pub.update_pdt_quality_vals(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_qualitys_pub.delete_pdt_quality_vals(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_pdt_qualitys_pub.validate_pdt_quality_vals(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
