--------------------------------------------------------
--  DDL for Package Body OE_1PC1018_BLKTHDR_BLCUSAC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_1PC1018_BLKTHDR_BLCUSAC" AS 
 PROCEDURE Is_Valid
 ( 
...
BEGIN 
   ...
   Return; 
END Is_Valid;
END OE_1PC1018_BLKTHDR_BLCUSAC;
