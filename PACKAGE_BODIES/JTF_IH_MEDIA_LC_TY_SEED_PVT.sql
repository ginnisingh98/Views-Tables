--------------------------------------------------------
--  DDL for Package Body JTF_IH_MEDIA_LC_TY_SEED_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_IH_MEDIA_LC_TY_SEED_PVT" AS
/* $Header: JTFIHMTB.pls 115.1 2000/02/15 12:25:19 pkm ship     $ */
