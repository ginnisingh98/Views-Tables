--------------------------------------------------------
--  DDL for Package Body OKL_ACCOUNT_DIST_MISC_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ACCOUNT_DIST_MISC_PVT_W" as
  /* $Header: OKLETDSB.pls 120.1 2005/07/07 13:34:41 dkagrawa noship $ */
  ...
  as
    ddp_tabv_tbl okl_account_dist_misc_pvt.tabv_tbl_type;
    ddx_tabv_tbl okl_account_dist_misc_pvt.tabv_tbl_type;
  ...
  begin
    ...
    okl_account_dist_misc_pvt.insert_updt_dstrs(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_account_dist_misc_pvt_w;
