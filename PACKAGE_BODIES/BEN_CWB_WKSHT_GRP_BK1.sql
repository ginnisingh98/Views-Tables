--------------------------------------------------------
--  DDL for Package Body BEN_CWB_WKSHT_GRP_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CWB_WKSHT_GRP_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_CWB_WKSHT_GRP_BK1.CREATE_CWB_WKSHT_GRP_A', 10);
hr_utility.set_location(' Leaving: BEN_CWB_WKSHT_GRP_BK1.CREATE_CWB_WKSHT_GRP_A', 20);
end CREATE_CWB_WKSHT_GRP_A;
...
begin
hr_utility.set_location('Entering: BEN_CWB_WKSHT_GRP_BK1.CREATE_CWB_WKSHT_GRP_B', 10);
hr_utility.set_location(' Leaving: BEN_CWB_WKSHT_GRP_BK1.CREATE_CWB_WKSHT_GRP_B', 20);
end CREATE_CWB_WKSHT_GRP_B;
