--------------------------------------------------------
--  DDL for Package Body PQP_GDS_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_GDS_RKU" as
...
begin
hr_utility.set_location('Entering: PQP_GDS_RKU.AFTER_UPDATE', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
PAY_DYT_DURATION_SUMMARY_PKG.AFTER_UPDATE
...
hr_api.validate_commit_unit(l_commit_unit_number, 'PQP_GAP_DURATION_SUMMARY', 'AU');
hr_utility.set_location(' Leaving: PQP_GDS_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQP_GDS_RKU;
