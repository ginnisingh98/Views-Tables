--------------------------------------------------------
--  DDL for Package Body GME_UNRELEASE_STEP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_UNRELEASE_STEP_PVT" AS
/* $Header: GMEVURSB.pls 120.6.12010000.2 2010/03/30 19:55:39 gmurator ship $ */
