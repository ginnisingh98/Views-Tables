--------------------------------------------------------
--  DDL for Package Body BEN_CPC_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CPC_RKI" as
/* $Header: becpcrhi.pkb 120.0 2005/05/28 01:11:03 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_cpc_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_cpc_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_cpc_RKI;
