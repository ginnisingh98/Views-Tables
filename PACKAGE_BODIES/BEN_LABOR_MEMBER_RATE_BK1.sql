--------------------------------------------------------
--  DDL for Package Body BEN_LABOR_MEMBER_RATE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LABOR_MEMBER_RATE_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_LABOR_MEMBER_RATE_BK1.CREATE_LABOR_MEMBER_RATE_A', 10);
hr_utility.set_location(' Leaving: BEN_LABOR_MEMBER_RATE_BK1.CREATE_LABOR_MEMBER_RATE_A', 20);
end CREATE_LABOR_MEMBER_RATE_A;
...
begin
hr_utility.set_location('Entering: BEN_LABOR_MEMBER_RATE_BK1.CREATE_LABOR_MEMBER_RATE_B', 10);
hr_utility.set_location(' Leaving: BEN_LABOR_MEMBER_RATE_BK1.CREATE_LABOR_MEMBER_RATE_B', 20);
end CREATE_LABOR_MEMBER_RATE_B;
