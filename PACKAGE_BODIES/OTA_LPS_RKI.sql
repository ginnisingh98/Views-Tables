--------------------------------------------------------
--  DDL for Package Body OTA_LPS_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_LPS_RKI" as
...
begin
hr_utility.set_location('Entering: OTA_LPS_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: OTA_LPS_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end OTA_LPS_RKI;
