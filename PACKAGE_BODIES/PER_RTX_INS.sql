--------------------------------------------------------
--  DDL for Package Body PER_RTX_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_RTX_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_rtx_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure insert_dml
  (p_rec in out nocopy per_rtx_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Insert the row into: per_rating_levels_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.rating_level_id                  := p_rating_level_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  per_rtx_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  per_rtx_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
    ...
    select l.language_code
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                       ...
                       and   rtx.language        = l.language_code);
  --
