--------------------------------------------------------
--  DDL for Package Body PAY_CTY_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_CTY_SHD" AS
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_cty_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'PAY_USCTY_HT_EXEMPT_CHK') Then
    hr_utility.set_message(801, 'PAY_72743_CTY_HT_Y_OR_N');
    hr_utility.raise_error;
  ElsIf (p_constraint_name = 'PAY_USCTY_LIT_EXEMPT_CHK') Then
    hr_utility.set_message(801, 'PAY_72745_CTY_LIT_Y_OR_N');
    hr_utility.raise_error;
  ElsIf (p_constraint_name = 'PAY_USCTY_SD_EXEMPT_CHK') Then
    hr_utility.set_message(801, 'PAY_72751_CTY_SD_Y_OR_N');
    hr_utility.raise_error;
  ElsIf (p_constraint_name = 'PAY_US_EMP_CITY_TAX_RULES_FK1') Then
    hr_utility.set_message(801, 'HR_7952_ADDR_NO_STATE_CODE');  /* 26 SEP 97 */
    hr_utility.raise_error;
  ElsIf (p_constraint_name = 'PAY_US_EMP_CITY_TAX_RULES_FK2') Then
    hr_utility.set_message(801, 'PAY_52969_TAX_BG_MATCH_ASG');
    hr_utility.raise_error;
  ElsIf (p_constraint_name = 'PAY_US_EMP_CITY_TAX_RULES_FK3') Then
...
Begin
  ...
  If (p_effective_date is null or
      p_emp_city_tax_rule_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_emp_city_tax_rule_id = g_old_rec.emp_city_tax_rule_id and
  ...
  If (p_datetrack_mode <> 'INSERT') then
    ...
    dt_api.validate_dt_mode
      (p_effective_date          => p_effective_date,
       ...
       p_base_table_name         => 'pay_us_emp_city_tax_rules_f',
       p_base_key_column         => 'emp_city_tax_rule_id',
       p_base_key_value          => p_emp_city_tax_rule_id,
...
Begin
  ...
  l_rec.cty_information_category         := p_cty_information_category;
  l_rec.cty_information1                 := p_cty_information1;
  l_rec.cty_information2                 := p_cty_information2;
  l_rec.cty_information3                 := p_cty_information3;
  l_rec.cty_information4                 := p_cty_information4;
  l_rec.cty_information5                 := p_cty_information5;
  l_rec.cty_information6                 := p_cty_information6;
  l_rec.cty_information7                 := p_cty_information7;
  l_rec.cty_information8                 := p_cty_information8;
  l_rec.cty_information9                 := p_cty_information9;
  l_rec.cty_information10                := p_cty_information10;
  l_rec.cty_information11                := p_cty_information11;
  l_rec.cty_information12                := p_cty_information12;
  l_rec.cty_information13                := p_cty_information13;
  l_rec.cty_information14                := p_cty_information14;
  l_rec.cty_information15                := p_cty_information15;
  l_rec.cty_information16                := p_cty_information16;
  l_rec.cty_information17                := p_cty_information17;
  l_rec.cty_information18                := p_cty_information18;
  l_rec.cty_information19                := p_cty_information19;
  l_rec.cty_information20                := p_cty_information20;
  l_rec.cty_information21                := p_cty_information21;
  l_rec.cty_information22                := p_cty_information22;
  l_rec.cty_information23                := p_cty_information23;
  l_rec.cty_information24                := p_cty_information24;
  l_rec.cty_information25                := p_cty_information25;
  l_rec.cty_information26                := p_cty_information26;
  l_rec.cty_information27                := p_cty_information27;
  l_rec.cty_information28                := p_cty_information28;
  l_rec.cty_information29                := p_cty_information29;
  l_rec.cty_information30                      := p_cty_information30;
  --
