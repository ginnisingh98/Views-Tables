--------------------------------------------------------
--  DDL for Package Body IGS_CO_CAT_MAP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_CO_CAT_MAP_PKG" AS
/* $Header: IGSLI04B.pls 115.5 2003/10/30 13:29:16 rghosh ship $ */

  l_rowid VARCHAR2(25);
  old_references igs_co_cat_map%ROWTYPE;
  new_references igs_co_cat_map%ROWTYPE;
  ...
  */
  BEGIN
    ...
    IF (UPPER(column_name) = 'DFLT_CAT_IND' OR column_name IS NULL) THEN
      IF NOT (new_references.dflt_cat_ind IN ('Y', 'N'))  THEN
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.dflt_cat_ind = x_dflt_cat_ind)
       ) THEN
      NULL;
    ELSE
