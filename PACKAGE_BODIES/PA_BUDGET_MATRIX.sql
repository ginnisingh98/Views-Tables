--------------------------------------------------------
--  DDL for Package Body PA_BUDGET_MATRIX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PA_BUDGET_MATRIX" AS
 -- $Header: PAXBUMXB.pls 120.2 2005/08/23 12:00:52 dlai noship $
--================================================================
--
--
------------------------------------------------------------------------------------------------------------------
...
PROCEDURE  pa_budget_matrix_driver (
...
END pa_budget_matrix_driver;


PROCEDURE  pa_calc_side_totals(
			x_project_id                    IN      NUMBER
			, x_Budget_version_id           IN      NUMBER
			, x_task_id                     IN      NUMBER
			, x_RLMI                        IN      NUMBER
			...
			, x_tot                         IN OUT  NOCOPY NUMBER --File.Sql.39 bug 4440895
			, x_tot2                        IN OUT  NOCOPY NUMBER ) --File.Sql.39 bug 4440895
...
PROCEDURE  pa_calc_bottom_totals(
			x_project_id                    IN      NUMBER
			, x_Budget_version_id           IN      NUMBER
			, x_task_id                     IN      NUMBER
			, x_start_date                  IN      DATE
			, x_end_date                    IN      DATE
			, x_list_view_totals            IN OUT  NOCOPY VARCHAR2 --File.Sql.39 bug 4440895
			, x_p1                          IN OUT  NOCOPY VARCHAR2 --File.Sql.39 bug 4440895
			, x_p2                          IN OUT  NOCOPY VARCHAR2 --File.Sql.39 bug 4440895
			, x_p3                          IN OUT  NOCOPY VARCHAR2 --File.Sql.39 bug 4440895
			, x_p4                          IN OUT  NOCOPY VARCHAR2 --File.Sql.39 bug 4440895
			, x_p1_tot                      IN OUT  NOCOPY NUMBER --File.Sql.39 bug 4440895
			, x_p2_tot                      IN OUT  NOCOPY NUMBER --File.Sql.39 bug 4440895
			, x_p3_tot                      IN OUT  NOCOPY NUMBER --File.Sql.39 bug 4440895
			, x_p4_tot                      IN OUT  NOCOPY NUMBER ) --File.Sql.39 bug 4440895
...
PROCEDURE  pa_calc_grand_totals(
			x_project_id                    IN      NUMBER
			, x_Budget_version_id           IN      NUMBER
			, x_task_id                     IN      NUMBER
			, x_start_date                  IN      DATE
			, x_end_date                    IN      DATE
			, x_list_view_totals            IN OUT  NOCOPY VARCHAR2 --File.Sql.39 bug 4440895
			, x_grand_tot                   IN OUT  NOCOPY NUMBER ) --File.Sql.39 bug 4440895
