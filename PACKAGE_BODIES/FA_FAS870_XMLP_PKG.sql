--------------------------------------------------------
--  DDL for Package Body FA_FAS870_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FAS870_XMLP_PKG" AS
/* $Header: FAS870B.pls 120.0.12010000.1 2008/07/28 13:16:02 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    RETURN(':Reserve Adjustments Report:');
END;
RETURN NULL; end;
