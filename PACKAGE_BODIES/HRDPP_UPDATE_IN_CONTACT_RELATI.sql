--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_IN_CONTACT_RELATI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_IN_CONTACT_RELATI" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:12
 * Generated for API: hr_in_contact_rel_api.update_in_contact_relationship
 */
--
...
,P_CONTACT_REL_USER_KEY in varchar2) is
...
,P_BONDHOLDER_FLAG
,dd(P_DATE_START,I_DATE_START)
,dd(P_DATE_END,I_DATE_END)
,P_RLTD_PER_RSDS_W_DSGNTR_FLAG
,P_PERSONAL_FLAG
,nd(P_SEQUENCE_NUMBER,I_SEQUENCE_NUMBER)
,P_DEPENDENT_FLAG
,P_BENEFICIARY_FLAG
...
decode(l.pval002,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval002,'CONTACT',d(l.pval001),vn)) p2,
l.pval002 d2,
l.plongval plongval,
decode(l.pval004,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval004,'YES_NO',d(l.pval001),vn)) p4,
l.pval004 d4,
decode(l.pval005,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval005,'YES_NO',d(l.pval001),vn)) p5,
l.pval005 d5,
decode(l.pval006,cn,vn,vn,'N',
...
l.pval008 d8,
decode(l.pval009,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval009,'YES_NO',d(l.pval001),vn)) p9,
l.pval009 d9,
decode(l.pval010,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval010,'YES_NO',d(l.pval001),vn)) p10,
l.pval010 d10,
...
PER_IN_DATA_PUMP.GET_CONTACT_RELATIONSHIP_OVN
(P_CONTACT_REL_USER_KEY => c.p43);
end if;
--
hr_data_pump.api_trc_on;
hr_in_contact_rel_api.update_in_contact_relationship
...
,P_THIRD_PARTY_PAY_FLAG => c.p5
,P_BONDHOLDER_FLAG => c.p6
,P_DATE_START => c.p7
,P_START_LIFE_REASON_ID => L_START_LIFE_REASON_ID
,P_DATE_END => c.p8
,P_END_LIFE_REASON_ID => L_END_LIFE_REASON_ID
,P_RLTD_PER_RSDS_W_DSGNTR_FLAG => c.p9
,P_PERSONAL_FLAG => c.p10
,P_SEQUENCE_NUMBER => c.p11
,P_DEPENDENT_FLAG => c.p12
,P_BENEFICIARY_FLAG => c.p13
,P_CONT_ATTRIBUTE_CATEGORY => c.p14
,P_CONT_ATTRIBUTE1 => c.p15
,P_CONT_ATTRIBUTE2 => c.p16
,P_CONT_ATTRIBUTE3 => c.p17
,P_CONT_ATTRIBUTE4 => c.p18
,P_CONT_ATTRIBUTE5 => c.p19
,P_CONT_ATTRIBUTE6 => c.p20
,P_CONT_ATTRIBUTE7 => c.p21
,P_CONT_ATTRIBUTE8 => c.p22
,P_CONT_ATTRIBUTE9 => c.p23
,P_CONT_ATTRIBUTE10 => c.p24
,P_CONT_ATTRIBUTE11 => c.p25
,P_CONT_ATTRIBUTE12 => c.p26
,P_CONT_ATTRIBUTE13 => c.p27
,P_CONT_ATTRIBUTE14 => c.p28
,P_CONT_ATTRIBUTE15 => c.p29
,P_CONT_ATTRIBUTE16 => c.p30
,P_CONT_ATTRIBUTE17 => c.p31
,P_CONT_ATTRIBUTE18 => c.p32
,P_CONT_ATTRIBUTE19 => c.p33
,P_CONT_ATTRIBUTE20 => c.p34
,P_GUARDIAN_NAME => c.p35
,P_GUARDIAN_BIRTH_DATE => L_GUARDIAN_BIRTH_DATE
,P_GUARDIAN_ADDRESS => c.p36
,P_GUARDIAN_TELEPHONE => c.p37
...
end hrdpp_update_in_contact_relati;
