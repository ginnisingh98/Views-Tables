--------------------------------------------------------
--  DDL for Package Body PQH_LOS_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_LOS_RKI" as
...
begin
hr_utility.set_location('Entering: PQH_LOS_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: PQH_LOS_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end PQH_LOS_RKI;
