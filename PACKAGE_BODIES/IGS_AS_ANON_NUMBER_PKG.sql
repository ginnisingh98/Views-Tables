--------------------------------------------------------
--  DDL for Package Body IGS_AS_ANON_NUMBER_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AS_ANON_NUMBER_PKG" AS
/* $Header: IGSDI61B.pls 115.1 2002/11/28 23:26:12 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_as_anon_number%ROWTYPE;
  new_references igs_as_anon_number%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.anum_id                           := x_anum_id;
    new_references.anonymous_number                  := x_anonymous_number;
  ...
  */
  BEGIN
    ...
    IF ( get_uk_for_validation (
           new_references.anonymous_number,
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_as_anon_number
      WHERE    anonymous_number = x_anonymous_number
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_AS_ANUM_CI_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igs_as_anon_number_s.NEXTVAL
    INTO      x_anum_id
    FROM      dual;
    ...
    before_dml(
      ...
      x_rowid                             => x_rowid,
      x_anum_id                           => x_anum_id,
      x_anonymous_number                  => x_anonymous_number,
    ...
    INSERT INTO igs_as_anon_number (
      anum_id,
      anonymous_number,
      load_cal_type,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.anonymous_number = x_anonymous_number)
  ...
  */
  ...
  BEGIN
    ...
    UPDATE igs_as_anon_number
      SET
        anonymous_number                  = new_references.anonymous_number,
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_as_anon_number
    WHERE rowid = x_rowid;
