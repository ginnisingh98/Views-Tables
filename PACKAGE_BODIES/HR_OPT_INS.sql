--------------------------------------------------------
--  DDL for Package Body HR_OPT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_OPT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_opt_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_option_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_option_id  in  number) is
--
...
Begin
  ...
  --
  hr_opt_ins.g_option_id_i := p_option_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: hr_ki_options
  --
...
--
  Cursor C_Sel1 is select hr_ki_options_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from hr_ki_options
     where option_id =
             hr_opt_ins.g_option_id_i;
--
...
Begin
  ...
  --
  If (hr_opt_ins.g_option_id_i is not null) Then
    --
    ...
    If C_Sel2%found Then
       ...
       fnd_message.set_token('TABLE_NAME','hr_ki_options');
  ...
  Else
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.option_id;
    Close C_Sel1;
  End If;
...
Begin
  ...
  --
  hr_opt_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  hr_opt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hr_opt_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the hr_opt_rec
