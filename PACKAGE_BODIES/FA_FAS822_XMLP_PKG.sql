--------------------------------------------------------
--  DDL for Package Body FA_FAS822_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FAS822_XMLP_PKG" AS
/* $Header: FAS822B.pls 120.0.12010000.1 2008/07/28 13:15:39 appldev ship $ */
  ...
  BEGIN
    ...
    EXCEPTION
      WHEN OTHERS THEN
        RP_REPORT_NAME := ':Mass Additions Create Report:';
