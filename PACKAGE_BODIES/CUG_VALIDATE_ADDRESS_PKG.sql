--------------------------------------------------------
--  DDL for Package Body CUG_VALIDATE_ADDRESS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CUG_VALIDATE_ADDRESS_PKG" AS
/* $Header: CUGVADIB.pls 115.2 2002/12/04 20:31:15 pkesani noship $ */
--
...
END; -- Package Body CUG_VALIDATE_ADDRESS_PKG
