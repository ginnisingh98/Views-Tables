--------------------------------------------------------
--  DDL for Package Body HR_KW_UTILITY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_KW_UTILITY" AS
 /* $Header: hrkwutil.pkb 120.0 2005/05/31 01:12:47 appldev noship $ */
 --
 --
 -- Formats the full name for the Kuwait legislation.
 --
 FUNCTION per_kw_full_name
