--------------------------------------------------------
--  DDL for Package Body BEN_ERG_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ERG_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_erg_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_ELIG_PERF_RTNG_PRTE_F_PK') Then
...
Begin
  ...
  If (p_effective_date is null or
      p_ELIG_PERF_RTNG_PRTE_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_ELIG_PERF_RTNG_PRTE_id = g_old_rec.ELIG_PERF_RTNG_PRTE_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_ELIG_PERF_RTNG_PRTE_f',
	 p_base_key_column	   => 'ELIG_PERF_RTNG_PRTE_id',
	 p_base_key_value 	   => p_ELIG_PERF_RTNG_PRTE_id,
	 p_parent_table_name1      => 'ben_ELIGY_PRFL_f',
	 p_parent_key_column1      => 'ELIGY_PRFL_id',
...
Exception
  When HR_Api.Object_Locked then
    ...
    fnd_message.set_token('TABLE_NAME', 'BEN_ELIG_PERF_RTNG_PRTE_F');
    fnd_message.raise_error;
...
Begin
  ...
  l_rec.perf_rtng_cd                     := p_perf_rtng_cd;
  l_rec.erg_attribute_category           := p_erg_attribute_category;
  l_rec.erg_attribute1                   := p_erg_attribute1;
  l_rec.erg_attribute2                   := p_erg_attribute2;
  l_rec.erg_attribute3                   := p_erg_attribute3;
  l_rec.erg_attribute4                   := p_erg_attribute4;
  l_rec.erg_attribute5                   := p_erg_attribute5;
  l_rec.erg_attribute6                   := p_erg_attribute6;
  l_rec.erg_attribute7                   := p_erg_attribute7;
  l_rec.erg_attribute8                   := p_erg_attribute8;
  l_rec.erg_attribute9                   := p_erg_attribute9;
  l_rec.erg_attribute10                  := p_erg_attribute10;
  l_rec.erg_attribute11                  := p_erg_attribute11;
  l_rec.erg_attribute12                  := p_erg_attribute12;
  l_rec.erg_attribute13                  := p_erg_attribute13;
  l_rec.erg_attribute14                  := p_erg_attribute14;
  l_rec.erg_attribute15                  := p_erg_attribute15;
  l_rec.erg_attribute16                  := p_erg_attribute16;
  l_rec.erg_attribute17                  := p_erg_attribute17;
  l_rec.erg_attribute18                  := p_erg_attribute18;
  l_rec.erg_attribute19                  := p_erg_attribute19;
  l_rec.erg_attribute20                  := p_erg_attribute20;
  l_rec.erg_attribute21                  := p_erg_attribute21;
  l_rec.erg_attribute22                  := p_erg_attribute22;
  l_rec.erg_attribute23                  := p_erg_attribute23;
  l_rec.erg_attribute24                  := p_erg_attribute24;
  l_rec.erg_attribute25                  := p_erg_attribute25;
  l_rec.erg_attribute26                  := p_erg_attribute26;
  l_rec.erg_attribute27                  := p_erg_attribute27;
  l_rec.erg_attribute28                  := p_erg_attribute28;
  l_rec.erg_attribute29                  := p_erg_attribute29;
  l_rec.erg_attribute30                  := p_erg_attribute30;
