--------------------------------------------------------
--  DDL for Package Body OKL_PTM_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PTM_PVT_W" as
  /* $Header: OKLIPTMB.pls 120.2 2006/11/03 14:12:04 sosharma noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_ptm_pvt.ptm_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ptm_code := a2(indx);
          t(ddindx).jtf_amv_item_id := rosetta_g_miss_num_map(a3(indx));
          ...
          t(ddindx).recipient_type_code := a28(indx);
          t(ddindx).xml_tmplt_code := a29(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p2(t okl_ptm_pvt.ptm_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a29 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := t(ddindx).ptm_code;
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).jtf_amv_item_id);
          ...
          a28(indx) := t(ddindx).recipient_type_code;
          a29(indx) := t(ddindx).xml_tmplt_code;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_ptm_pvt.okl_process_tmplts_tl_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).email_subject_line := a4(indx);
  ...
  procedure rosetta_table_copy_out_p5(t okl_ptm_pvt.okl_process_tmplts_tl_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a9 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a4(indx) := t(ddindx).email_subject_line;
  ...
  procedure rosetta_table_copy_in_p8(t out nocopy okl_ptm_pvt.ptmv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_VARCHAR2_TABLE_100
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_VARCHAR2_TABLE_100
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).email_subject_line := a5(indx);
          ...
          t(ddindx).recipient_type_code := a30(indx);
          t(ddindx).xml_tmplt_code := a31(indx);
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p8(t okl_ptm_pvt.ptmv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_VARCHAR2_TABLE_100
    , a3 out nocopy JTF_NUMBER_TABLE
    , a4 out nocopy JTF_VARCHAR2_TABLE_100
    ...
    a31 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a5(indx) := t(ddindx).email_subject_line;
          ...
          a30(indx) := t(ddindx).recipient_type_code;
          a31(indx) := t(ddindx).xml_tmplt_code;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  as
    ddp_ptmv_rec okl_ptm_pvt.ptmv_rec_type;
    ddx_ptmv_rec okl_ptm_pvt.ptmv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ddp_ptmv_rec.id := rosetta_g_miss_num_map(p5_a0);
    ddp_ptmv_rec.org_id := rosetta_g_miss_num_map(p5_a1);
    ddp_ptmv_rec.ptm_code := p5_a2;
    ddp_ptmv_rec.jtf_amv_item_id := rosetta_g_miss_num_map(p5_a3);
    ddp_ptmv_rec.sfwt_flag := p5_a4;
    ddp_ptmv_rec.email_subject_line := p5_a5;
    ddp_ptmv_rec.start_date := rosetta_g_miss_date_in_map(p5_a6);
    ddp_ptmv_rec.end_date := rosetta_g_miss_date_in_map(p5_a7);
    ddp_ptmv_rec.object_version_number := rosetta_g_miss_num_map(p5_a8);
    ddp_ptmv_rec.attribute_category := p5_a9;
    ddp_ptmv_rec.attribute1 := p5_a10;
    ddp_ptmv_rec.attribute2 := p5_a11;
    ddp_ptmv_rec.attribute3 := p5_a12;
    ddp_ptmv_rec.attribute4 := p5_a13;
    ddp_ptmv_rec.attribute5 := p5_a14;
    ddp_ptmv_rec.attribute6 := p5_a15;
    ddp_ptmv_rec.attribute7 := p5_a16;
    ddp_ptmv_rec.attribute8 := p5_a17;
    ddp_ptmv_rec.attribute9 := p5_a18;
    ddp_ptmv_rec.attribute10 := p5_a19;
    ddp_ptmv_rec.attribute11 := p5_a20;
    ddp_ptmv_rec.attribute12 := p5_a21;
    ddp_ptmv_rec.attribute13 := p5_a22;
    ddp_ptmv_rec.attribute14 := p5_a23;
    ddp_ptmv_rec.attribute15 := p5_a24;
    ddp_ptmv_rec.created_by := rosetta_g_miss_num_map(p5_a25);
    ddp_ptmv_rec.creation_date := rosetta_g_miss_date_in_map(p5_a26);
    ddp_ptmv_rec.last_updated_by := rosetta_g_miss_num_map(p5_a27);
    ddp_ptmv_rec.last_update_date := rosetta_g_miss_date_in_map(p5_a28);
    ddp_ptmv_rec.last_update_login := rosetta_g_miss_num_map(p5_a29);
    ddp_ptmv_rec.recipient_type_code := p5_a30;
    ddp_ptmv_rec.xml_tmplt_code := p5_a31;


    -- here's the delegated call to the old PL/SQL routine
    okl_ptm_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a0 := rosetta_g_miss_num_map(ddx_ptmv_rec.id);
    p6_a1 := rosetta_g_miss_num_map(ddx_ptmv_rec.org_id);
    p6_a2 := ddx_ptmv_rec.ptm_code;
    p6_a3 := rosetta_g_miss_num_map(ddx_ptmv_rec.jtf_amv_item_id);
    p6_a4 := ddx_ptmv_rec.sfwt_flag;
    p6_a5 := ddx_ptmv_rec.email_subject_line;
    p6_a6 := ddx_ptmv_rec.start_date;
    p6_a7 := ddx_ptmv_rec.end_date;
    p6_a8 := rosetta_g_miss_num_map(ddx_ptmv_rec.object_version_number);
    p6_a9 := ddx_ptmv_rec.attribute_category;
    p6_a10 := ddx_ptmv_rec.attribute1;
    p6_a11 := ddx_ptmv_rec.attribute2;
    p6_a12 := ddx_ptmv_rec.attribute3;
    p6_a13 := ddx_ptmv_rec.attribute4;
    p6_a14 := ddx_ptmv_rec.attribute5;
    p6_a15 := ddx_ptmv_rec.attribute6;
    p6_a16 := ddx_ptmv_rec.attribute7;
    p6_a17 := ddx_ptmv_rec.attribute8;
    p6_a18 := ddx_ptmv_rec.attribute9;
    p6_a19 := ddx_ptmv_rec.attribute10;
    p6_a20 := ddx_ptmv_rec.attribute11;
    p6_a21 := ddx_ptmv_rec.attribute12;
    p6_a22 := ddx_ptmv_rec.attribute13;
    p6_a23 := ddx_ptmv_rec.attribute14;
    p6_a24 := ddx_ptmv_rec.attribute15;
    p6_a25 := rosetta_g_miss_num_map(ddx_ptmv_rec.created_by);
    p6_a26 := ddx_ptmv_rec.creation_date;
    p6_a27 := rosetta_g_miss_num_map(ddx_ptmv_rec.last_updated_by);
    p6_a28 := ddx_ptmv_rec.last_update_date;
    p6_a29 := rosetta_g_miss_num_map(ddx_ptmv_rec.last_update_login);
    p6_a30 := ddx_ptmv_rec.recipient_type_code;
    p6_a31 := ddx_ptmv_rec.xml_tmplt_code;
  end;
  ...
  as
    ddp_ptmv_tbl okl_ptm_pvt.ptmv_tbl_type;
    ddx_ptmv_tbl okl_ptm_pvt.ptmv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_ptm_pvt_w.rosetta_table_copy_in_p8(ddp_ptmv_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_ptm_pvt_w.rosetta_table_copy_out_p8(ddx_ptmv_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptm_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptm_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptm_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_ptm_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
