--------------------------------------------------------
--  DDL for Package Body BEN_PYD_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PYD_RKD" as
/* $Header: bepydrhi.pkb 120.0.12010000.2 2008/08/05 15:24:16 generated ship $ */
...
begin
hr_utility.set_location('Entering: ben_pyd_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_pyd_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_pyd_RKD;
