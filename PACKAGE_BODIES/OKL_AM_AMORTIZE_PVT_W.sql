--------------------------------------------------------
--  DDL for Package Body OKL_AM_AMORTIZE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_AMORTIZE_PVT_W" as
  /* $Header: OKLETATB.pls 120.6.12010000.2 2010/04/29 15:14:06 rpillay ship $ */
  ...
  begin
    ...
    okl_am_amortize_pvt.create_offlease_asset_trx(p_api_version => p_api_version,
  ...
  as
    ddp_header_rec okl_am_amortize_pvt.thpv_rec_type;
    ddp_lines_rec okl_am_amortize_pvt.tlpv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_amortize_pvt.update_offlease_asset_trx(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_header_tbl okl_am_amortize_pvt.thpv_tbl_type;
    ddp_lines_tbl okl_am_amortize_pvt.tlpv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  as
    ddp_deprn_rec okl_am_amortize_pvt.deprn_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_amortize_pvt.update_depreciation(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
