--------------------------------------------------------
--  DDL for Package Body OKL_TAX_BASIS_OVERRIDE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TAX_BASIS_OVERRIDE_PUB_W" as
  /* $Header: OKLUTBOB.pls 120.0 2005/08/24 14:34:30 asawanka noship $ */
  ...
  procedure insert_tax_basis_override(p_api_version  NUMBER
  ...
  as
    ddp_tbov_rec okl_tax_basis_override_pub.tbov_rec_type;
    ddx_tbov_rec okl_tax_basis_override_pub.tbov_rec_type;
  ...
  begin
    ...
    okl_tax_basis_override_pub.insert_tax_basis_override(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tbov_tbl okl_tax_basis_override_pub.tbov_tbl_type;
    ddx_tbov_tbl okl_tax_basis_override_pub.tbov_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_tax_basis_override(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_tax_basis_override_pub.lock_tax_basis_override(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_tax_basis_override(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_tax_basis_override_pub.update_tax_basis_override(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_tax_basis_override(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_tax_basis_override_pub.delete_tax_basis_override(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_tax_basis_override(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_tax_basis_override_pub.validate_tax_basis_override(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_tax_basis_override_pub_w;
