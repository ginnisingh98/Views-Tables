--------------------------------------------------------
--  DDL for Package Body ISC_DBI_FR_COST_PER_W_TR_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ISC_DBI_FR_COST_PER_W_TR_PKG" AS
/*$Header: ISCRGBYB.pls 120.1 2006/06/26 06:40:21 abhdixi noship $
    /*----------------------------------------------------
    ...
    /*------------------------------------------------
    Rated Freight Cost per Unit Weight Trend Function
    -------------------------------------------------*/
