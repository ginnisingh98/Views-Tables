--------------------------------------------------------
--  DDL for Package Body ONT_D1_FOB_POINT_CODE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1_FOB_POINT_CODE" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D1_FOB_POINT_CODE
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1_FOB_POINT_CODE';
...
BEGIN
    ...
    l_return_value := ONT_SHIP_TO_ORG_Def_Util.g_cached_record.FOB_POINT_CODE;
    END IF;
  ...
  END IF;
    ...
    l_return_value := ONT_INV_ORG_Def_Util.g_cached_record.FOB_POINT_CODE;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
    ...
    l_return_value := ONT_SOLD_TO_ORG_Def_Util.g_cached_record.FOB_POINT_CODE;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
    ...
    l_return_value := ONT_ORDER_TYPE_Def_Util.g_cached_record.FOB_POINT_CODE;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
