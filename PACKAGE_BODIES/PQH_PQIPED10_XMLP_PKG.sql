--------------------------------------------------------
--  DDL for Package Body PQH_PQIPED10_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_PQIPED10_XMLP_PKG" AS
/* $Header: PQIPED10B.pls 120.2 2008/04/16 11:17:10 amakrish noship $ */
  ...
  LINE VARCHAR2(1);
    ...
    CURSOR GET_LINE1_COUNTS IS
      ...
      WHERE PEO.PERSON_ID = ASS.PERSON_ID
        ...
        AND HL.LOOKUP_CODE not in ( '1' , '2' , '3' , '4' )
