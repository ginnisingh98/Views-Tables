--------------------------------------------------------
--  DDL for Package Body OTA_FINANCE_LINE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_FINANCE_LINE_BK2" as
...
begin
hr_utility.set_location('Entering: OTA_FINANCE_LINE_BK2.UPDATE_FINANCE_LINE_A', 10);
hr_utility.set_location(' Leaving: OTA_FINANCE_LINE_BK2.UPDATE_FINANCE_LINE_A', 20);
end UPDATE_FINANCE_LINE_A;
...
begin
hr_utility.set_location('Entering: OTA_FINANCE_LINE_BK2.UPDATE_FINANCE_LINE_B', 10);
hr_utility.set_location(' Leaving: OTA_FINANCE_LINE_BK2.UPDATE_FINANCE_LINE_B', 20);
end UPDATE_FINANCE_LINE_B;
