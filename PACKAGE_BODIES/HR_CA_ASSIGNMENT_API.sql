--------------------------------------------------------
--  DDL for Package Body HR_CA_ASSIGNMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_CA_ASSIGNMENT_API" as
/* $Header: peasgcai.pkb 115.3 2002/12/10 05:02:03 raranjan noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  hr_ca_assignment_api.';
--
-- ----------------------------------------------------------------------------
...
(p_validate                     in     boolean  default false
  ...
  l_proc               varchar2(72) := g_package||'create_ca_secondary_emp_asg';
  --
...
begin
  ...
  --
  -- Ensure that the employee is within a CA business group
  --
  ...
  if csr_legislation%notfound then
    ...
    hr_utility.set_message_token('LEG_CODE', 'CA');
  ...
  ,p_scl_segment6                 =>     p_naic_override_code
  ,p_scl_segment7                 =>     p_seasonal_worker
  ,p_scl_segment8                 =>     p_officer_code
  ,p_scl_segment9                 =>     p_wci_account_number
  ,p_scl_segment10                =>     p_wci_code_override
  ,p_scl_concat_segments          =>	 p_ca_concat_segments
  ...
  --
end create_ca_secondary_emp_asg;
--
-- ----------------------------------------------------------------------------
-- |--------------------------< update_ca_emp_asg >----------------------------|
-- ----------------------------------------------------------------------------
...
begin
  ...
  hr_utility.set_location(l_proc, 20);
  --
  -- Check that the legislation of the specified business group is 'CA'.
  --
  ...
  ,p_segment5                     =>     p_shift
  ,p_segment6                     =>     p_naic_override_code
  ,p_segment7                     =>     p_seasonal_worker
  ,p_segment8                     =>     p_officer_code
  ,p_segment9                     =>     p_wci_account_number
  ,p_segment10                    =>     p_wci_code_override
  ,p_concat_segments              =>     p_ca_concat_segments
  ,p_contract_id                  =>     p_contract_id
  ,p_establishment_id             =>     p_establishment_id
  ,p_collective_agreement_id      =>     p_collective_agreement_id
  ,p_cagr_id_flex_num             =>     p_cagr_id_flex_num
