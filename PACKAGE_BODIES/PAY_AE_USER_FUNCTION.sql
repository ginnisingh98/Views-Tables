--------------------------------------------------------
--  DDL for Package Body PAY_AE_USER_FUNCTION
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_AE_USER_FUNCTION" as
/* $Header: pyaerunf.pkb 120.1 2006/06/02 13:24:04 spendhar noship $ */
  ...
  close csr_get_id_flex_num;
    ...
    l_outputs(1).name := 'CONTRIBUTORY_SALARY_REFERENCE';
