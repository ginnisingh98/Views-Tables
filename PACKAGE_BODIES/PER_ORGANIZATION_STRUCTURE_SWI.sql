--------------------------------------------------------
--  DDL for Package Body PER_ORGANIZATION_STRUCTURE_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ORGANIZATION_STRUCTURE_SWI" As
/* $Header: peorsswi.pkb 115.1 2002/12/03 01:18:55 ndorai noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'per_organization_structure_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_org_structure_swi;
  --
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_org_structure_swi;
    --
...
PROCEDURE create_org_struct_and_def_ver
  ...
  --
  -- Other variables
  l_proc    varchar2(72) := g_package ||'create_org_struct_and_def_ver';
Begin
  hr_utility.set_location(' Entering:' || l_proc,10);
  --
  -- Issue a savepoint
  --
  savepoint create_org_struct_def_ver_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to create_org_struct_def_ver_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_organization_structure_id    := null;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_org_structure_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  per_organization_structure_api.delete_organization_structure
    (p_validate                     => l_validate
    ,p_organization_structure_id    => p_organization_structure_id
    ,p_object_version_number        => p_object_version_number
    );
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_org_structure_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
...
PROCEDURE update_organization_structure
  ...
  --
  -- Other variables
  l_proc    varchar2(72) := g_package ||'update_organization_structure';
Begin
  hr_utility.set_location(' Entering:' || l_proc,10);
  --
  -- Issue a savepoint
  --
  savepoint update_org_structure_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  per_organization_structure_api.update_organization_structure
    (p_validate                     => l_validate
    ,p_effective_date               => p_effective_date
    ,p_organization_structure_id    => p_organization_structure_id
    ,p_name                         => p_name
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_org_structure_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
