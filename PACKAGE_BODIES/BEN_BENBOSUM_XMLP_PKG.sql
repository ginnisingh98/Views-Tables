--------------------------------------------------------
--  DDL for Package Body BEN_BENBOSUM_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENBOSUM_XMLP_PKG" AS
/* $Header: BENBOSUMB.pls 120.1 2007/12/10 08:24:51 vjaganat noship $ */
...
function CF_STANDARD_HEADERFormula return Number is
  ...
  l_business_group             per_business_groups.name%type ;   l_plan                       ben_pl_f.name%type ;
  l_enrollment_type_cycle      varchar2(800);   l_plans_not_in_programs      hr_lookups.meaning%type ;
  ...
  l_organization               hr_all_organization_units.name%type ;   l_postal_zip_range           varchar2(80);
...
function G_benefit_action_idGroupFilter return boolean is
begin
...
--Functions to refer Oracle report placeholders--
 ...
 Function CP_LEGAL_ENTITY_p return varchar2 is
	Begin
	 ...
	 END;
 Function CP_TO_OCRD_DT_p return date is
	Begin
 ...
 Function CP_PERSONS_PROCESSED_p return number is
	Begin
	 ...
	 END;
 Function CP_FROM_OCRD_DT_p return date is
	Begin
 ...
 Function CP_PERSONS_UNPROCESSED_p return number is
	Begin
	 ...
	 END;
 Function CP_LF_EVT_BO_p return number is
	Begin
	 return CP_LF_EVT_BO;
	 END;
 Function CP_PERSON_BNFT_GRP_p return varchar2 is
	Begin
	 ...
	 END;
 Function CP_PEOPLE_LF_EVT_BO_p return number is
	Begin
	 return CP_PEOPLE_LF_EVT_BO;
	 END;
 ...
 Function CP_BUSINESS_GROUP_p return varchar2 is
	Begin
	 ...
	 END;
 Function CP_LF_EVT_BO_CLS_p return number is
	Begin
	 return CP_LF_EVT_BO_CLS;
	 END;
 Function CP_LF_EVT_BO_IP_WE_p return number is
	Begin
	 return CP_LF_EVT_BO_IP_WE;
	 END;
 Function CP_LF_EVT_BO_IP_WOE_p return number is
	Begin
	 return CP_LF_EVT_BO_IP_WOE;
	 END;
 Function CP_RESULTING_STATUS_p return varchar2 is
	Begin
	 return CP_RESULTING_STATUS;
	 END;
