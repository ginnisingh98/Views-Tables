--------------------------------------------------------
--  DDL for Package Body AME_CNU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_CNU_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ame_cnu_ins.';  -- Global package name
--
...
Begin
  ...
  --
  ame_cnu_ins.g_rule_id_i := p_rule_id;
  ame_cnu_ins.g_condition_id_i := p_condition_id;
  --
...
Procedure dt_insert_dml
  (p_rec                     in out nocopy ame_cnu_shd.g_rec_type
...
--
 ...
 and    t.rule_id = p_rec.rule_id
    and    t.start_date =
             ame_cnu_shd.g_old_rec.start_date
...
--
  ...
  l_created_by          ame_condition_usages.created_by%TYPE;
  l_creation_date       ame_condition_usages.creation_date%TYPE;
  l_last_update_date    ame_condition_usages.last_update_date%TYPE;
  l_last_updated_by     ame_condition_usages.last_updated_by%TYPE;
  l_last_update_login   ame_condition_usages.last_update_login%TYPE;
...
Begin
  ...
  --
  --
  -- Insert the row into: ame_condition_usages
  --
...
--
--  Cursor C_Sel1 is select ame_condition_usages_s.nextval from sys.dual;
--
 Cursor C_Sel2 is
    Select null
      from ame_condition_usages
     where rule_id =
             ame_cnu_ins.g_rule_id_i
       and condition_id =
             ame_cnu_ins.g_condition_id_i
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
    If (ame_cnu_ins.g_rule_id_i is not null or
      ame_cnu_ins.g_condition_id_i is not null) Then
    --
    ...
    p_rec.rule_id :=
      ame_cnu_ins.g_rule_id_i;
    ame_cnu_ins.g_rule_id_i := null;
    p_rec.condition_id :=
      ame_cnu_ins.g_condition_id_i;
    ame_cnu_ins.g_condition_id_i := null;
  End If;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
  ...
  exception
    ...
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'AME_CONDITION_USAGES'
        ,p_hook_type   => 'AI');
      --
  end;
  --
...
Begin
  ...
  --
  -- Having converted the arguments into the ame_cnu_rec
