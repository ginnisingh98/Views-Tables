--------------------------------------------------------
--  DDL for Package Body JAI_JOM_ST_TRIGGER_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JAI_JOM_ST_TRIGGER_PKG" AS
/* $Header: jai_jom_st_t.plb 120.0 2005/09/01 12:35:53 rallamse noship $ */

/*  REM +======================================================================+
  REM NAME          BRU_T1
  REM
  REM DESCRIPTION   Called from trigger JAI_JOM_ST_BRIUD_T1
  REM
  REM NOTES         Refers to old trigger JAI_JOM_ST_BRU_T1
  REM
  REM +======================================================================+
*/
