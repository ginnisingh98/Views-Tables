--------------------------------------------------------
--  DDL for Package Body IGF_AW_FUND_UNIT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_AW_FUND_UNIT_PKG" AS
/* $Header: IGFWI48B.pls 115.1 2002/11/28 12:17:40 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_aw_fund_unit_all%ROWTYPE;
  new_references igf_aw_fund_unit_all%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.funit_id                          := x_funit_id;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AP_FUNIT_FMAST_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igf_aw_fund_unit_s.NEXTVAL
    INTO      x_funit_id
    FROM      dual;
    ...
    INSERT INTO igf_aw_fund_unit_all (
      funit_id,
      fund_id,
      unit_cd,
      version_number,
  ...
  */
  BEGIN
    ...
    DELETE FROM igf_aw_fund_unit_all
    WHERE rowid = x_rowid;
