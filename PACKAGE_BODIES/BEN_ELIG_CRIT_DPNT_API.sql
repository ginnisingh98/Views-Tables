--------------------------------------------------------
--  DDL for Package Body BEN_ELIG_CRIT_DPNT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIG_CRIT_DPNT_API" as
/* $Header: beecdapi.pkb 120.0.12010000.3 2010/04/19 07:29:26 pvelvano noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_elig_crit_dpnt_api.';
--
-- ----------------------------------------------------------------------------
...
procedure create_dpnt_eligy_criteria
  ...
  l_proc varchar2(72) :=    g_package||'create_dpnt_eligy_criteria';
  l_object_version_number   ben_eligy_criteria_dpnt.object_version_number%TYPE;
  --
begin
  --
  ...
  --
  savepoint create_eligy_criteria_dpnt;
  --
  ...
  begin
    ...
    --
    ben_elig_crit_dpnt_bk1.create_dpnt_eligy_criteria_b
      (
        p_name                               => p_name
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_dpnt_eligy_criteria'
        ,p_hook_type   => 'BP'
        );
    --
  ...
  --
  ben_dpnt_egd_ins.ins
    (
     p_eligy_criteria_dpnt_id             => l_eligy_criteria_dpnt_id
    ,p_name                          => p_name
    ,p_short_code                    => p_short_code
    ,p_description                   => p_description
    ,p_criteria_type		     => p_criteria_type
  ...
  begin
    ...
    --
    ben_elig_crit_dpnt_bk1.create_dpnt_eligy_criteria_a
      (
     p_eligy_criteria_dpnt_id             => l_eligy_criteria_dpnt_id
    ,p_name                          => p_name
    ,p_short_code                    => p_short_code
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_eligy_criteria_dpnt;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
    --
    p_eligy_criteria_dpnt_id      := null;
  ...
  when others then
    ...
    raise;
    --
end create_dpnt_eligy_criteria;
-- ----------------------------------------------------------------------------
...
procedure update_dpnt_eligy_criteria
  ...
  --
  l_eligy_criteria_dpnt_id       ben_eligy_criteria_dpnt.eligy_criteria_dpnt_id%TYPE;
  l_proc varchar2(72)      := g_package||'update_dpnt_eligy_criteria';
  l_object_version_number  ben_eligy_criteria_dpnt.object_version_number%TYPE;
  --
begin
...
----hr_utility.trace_on(null,'TRACE-file');
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_dpnt_eligy_criteria;
  --

  --
  -- Process Logic
  --
  l_eligy_criteria_dpnt_id     := p_eligy_criteria_dpnt_id;
  l_object_version_number := p_object_version_number;
  --
  begin
    --
    -- Start of API User Hook for the before hook of update_dpnt_eligy_criteria
    --
    ben_elig_crit_dpnt_bk2.update_dpnt_eligy_criteria_b
      (
            p_eligy_criteria_dpnt_id             => l_eligy_criteria_dpnt_id
           ,p_name                          => p_name
           ,p_short_code                    => p_short_code
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_dpnt_eligy_criteria'
        ,p_hook_type   => 'BP'
        );
    --
  ...
  begin
    ...
    --
    ben_elig_crit_dpnt_bk2.update_dpnt_eligy_criteria_a
      (
            p_eligy_criteria_dpnt_id             => l_eligy_criteria_dpnt_id
           ,p_name                          => p_name
           ,p_short_code                    => p_short_code
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO update_dpnt_eligy_criteria;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
  ...
  when others then
    ...
    raise;
    --
end update_dpnt_eligy_criteria;
-- ----------------------------------------------------------------------------
...
procedure delete_dpnt_eligy_criteria
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'delete_dpnt_eligy_criteria';
  l_object_version_number ben_eligy_criteria_dpnt.object_version_number%TYPE;
  --
begin
  --
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint delete_dpnt_eligy_criteria;
  --
  ...
  begin
    ...
    --
    ben_elig_crit_dpnt_bk3.delete_dpnt_eligy_criteria_b
      (
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_dpnt_eligy_criteria'
        ,p_hook_type   => 'BP'
        );
    --
  ...
  begin
    ...
    --
    ben_elig_crit_dpnt_bk3.delete_dpnt_eligy_criteria_a
      (
       p_eligy_criteria_dpnt_id              =>  p_eligy_criteria_dpnt_id
      ,p_object_version_number          =>  l_object_version_number
      ,p_effective_date                 => trunc(p_effective_date)
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO delete_dpnt_eligy_criteria;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
  ...
  when others then
    ...
    raise;
    --
end delete_dpnt_eligy_criteria;
--
-- ----------------------------------------------------------------------------
-- |-------------------------------< lck >------------------------------------|
-- ----------------------------------------------------------------------------
