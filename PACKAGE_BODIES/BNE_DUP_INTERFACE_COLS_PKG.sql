--------------------------------------------------------
--  DDL for Package Body BNE_DUP_INTERFACE_COLS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BNE_DUP_INTERFACE_COLS_PKG" as
/* $Header: bnedupintcolb.pls 120.2 2005/06/29 03:39:49 dvayro noship $ */
...
procedure INSERT_ROW (
  ...
  X_RESOLVER_CLASSNAME in VARCHAR2,
  ...
  cursor C is select ROWID from BNE_DUP_INTERFACE_COLS
    ...
    ;
begin
  insert into BNE_DUP_INTERFACE_COLS (
    INTERFACE_APP_ID,
    INTERFACE_CODE,
    DUP_PROFILE_APP_ID,
    DUP_PROFILE_CODE,
...
begin
  for tlinfo in c1 loop
    if ((tlinfo.OBJECT_VERSION_NUMBER = X_OBJECT_VERSION_NUMBER)
        AND (tlinfo.RESOLVER_CLASSNAME = X_RESOLVER_CLASSNAME)
    ) then
      null;
    else
...
begin
  update BNE_DUP_INTERFACE_COLS set
    OBJECT_VERSION_NUMBER = X_OBJECT_VERSION_NUMBER,
    RESOLVER_CLASSNAME    = X_RESOLVER_CLASSNAME,
  ...
  begin
    ...
    if (fnd_load_util.upload_test(f_luby, f_ludate, db_luby,
      ...
      BNE_DUP_INTERFACE_COLS_PKG.Update_Row(
        ...
        X_RESOLVER_CLASSNAME           => x_resolver_classname,
...
end BNE_DUP_INTERFACE_COLS_PKG;
