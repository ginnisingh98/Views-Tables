--------------------------------------------------------
--  DDL for Package Body PER_ECA_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ECA_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_eca_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
--
If (p_constraint_name = 'PER_ELECTION_CANDIDATES_FK1') Then
fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
fnd_message.set_token('PROCEDURE', l_proc);
fnd_message.set_token('STEP','5');
fnd_message.raise_error;
ElsIf (p_constraint_name = 'PER_ELECTION_CANDIDATES_FK2') Then
fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
fnd_message.set_token('PROCEDURE', l_proc);
fnd_message.set_token('STEP','10');
fnd_message.raise_error;
ElsIf (p_constraint_name = 'PER_ELECTION_CANDIDATE_PK') Then
fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
--
If (p_election_candidate_id is null and
...
l_fct_ret := false;
Else
If (p_election_candidate_id
= per_eca_shd.g_old_rec.election_candidate_id and
...
--
Open C_Sel1;
Fetch C_Sel1 Into per_eca_shd.g_old_rec;
...
If (p_object_version_number
  <> per_eca_shd.g_old_rec.object_version_number) Then
...
fnd_message.set_token('TABLE_NAME', 'per_election_candidates');
fnd_message.raise_error;
End lck;
--
-- ----------------------------------------------------------------------------
...
--
l_rec.election_candidate_id            := p_election_candidate_id;
...
l_rec.candidate_info_category   := p_candidate_info_category;
l_rec.candidate_information1           := p_candidate_information1;
l_rec.candidate_information2           := p_candidate_information2;
l_rec.candidate_information3           := p_candidate_information3;
l_rec.candidate_information4           := p_candidate_information4;
l_rec.candidate_information5           := p_candidate_information5;
l_rec.candidate_information6           := p_candidate_information6;
l_rec.candidate_information7           := p_candidate_information7;
l_rec.candidate_information8           := p_candidate_information8;
l_rec.candidate_information9           := p_candidate_information9;
l_rec.candidate_information10          := p_candidate_information10;
l_rec.candidate_information11          := p_candidate_information11;
l_rec.candidate_information12          := p_candidate_information12;
l_rec.candidate_information13          := p_candidate_information13;
l_rec.candidate_information14          := p_candidate_information14;
l_rec.candidate_information15          := p_candidate_information15;
l_rec.candidate_information16          := p_candidate_information16;
l_rec.candidate_information17          := p_candidate_information17;
l_rec.candidate_information18          := p_candidate_information18;
l_rec.candidate_information19          := p_candidate_information19;
l_rec.candidate_information20          := p_candidate_information20;
l_rec.candidate_information21          := p_candidate_information21;
l_rec.candidate_information22          := p_candidate_information22;
l_rec.candidate_information23          := p_candidate_information23;
l_rec.candidate_information24          := p_candidate_information24;
l_rec.candidate_information25          := p_candidate_information25;
l_rec.candidate_information26          := p_candidate_information26;
l_rec.candidate_information27          := p_candidate_information27;
l_rec.candidate_information28          := p_candidate_information28;
l_rec.candidate_information29          := p_candidate_information29;
l_rec.candidate_information30          := p_candidate_information30;
