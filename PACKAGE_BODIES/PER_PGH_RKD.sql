--------------------------------------------------------
--  DDL for Package Body PER_PGH_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PGH_RKD" as
/* $Header: pepghrhi.pkb 120.0 2005/05/31 14:05:56 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/01/04 09:32:35 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: per_pgh_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: per_pgh_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end per_pgh_RKD;
