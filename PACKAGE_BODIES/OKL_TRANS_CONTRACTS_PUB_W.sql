--------------------------------------------------------
--  DDL for Package Body OKL_TRANS_CONTRACTS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TRANS_CONTRACTS_PUB_W" as
  /* $Header: OKLUTCTB.pls 120.8.12010000.3 2008/11/12 23:52:35 apaul ship $ */
  ...
  as
    ddp_tcnv_rec okl_trans_contracts_pub.tcnv_rec_type;
    ddp_tclv_tbl okl_trans_contracts_pub.tclv_tbl_type;
    ddx_tcnv_rec okl_trans_contracts_pub.tcnv_rec_type;
    ddx_tclv_tbl okl_trans_contracts_pub.tclv_tbl_type;
  ...
  begin
    ...
    okl_trans_contracts_pub.create_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_tcnv_tbl okl_trans_contracts_pub.tcnv_tbl_type;
    ddx_tcnv_tbl okl_trans_contracts_pub.tcnv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  as
    ddp_tclv_rec okl_trans_contracts_pub.tclv_rec_type;
    ddx_tclv_rec okl_trans_contracts_pub.tclv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trans_contracts_pub.create_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trans_contracts_pub.update_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trans_contracts_pub.update_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trans_contracts_pub.delete_trx_contracts(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trans_contracts_pub.delete_trx_cntrct_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
