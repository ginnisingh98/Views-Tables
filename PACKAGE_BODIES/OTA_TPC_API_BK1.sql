--------------------------------------------------------
--  DDL for Package Body OTA_TPC_API_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TPC_API_BK1" as
...
begin
hr_utility.set_location('Entering: OTA_TPC_API_BK1.CREATE_COST_A', 10);
hr_utility.set_location(' Leaving: OTA_TPC_API_BK1.CREATE_COST_A', 20);
end CREATE_COST_A;
...
begin
hr_utility.set_location('Entering: OTA_TPC_API_BK1.CREATE_COST_B', 10);
hr_utility.set_location(' Leaving: OTA_TPC_API_BK1.CREATE_COST_B', 20);
end CREATE_COST_B;
end OTA_TPC_API_BK1;
