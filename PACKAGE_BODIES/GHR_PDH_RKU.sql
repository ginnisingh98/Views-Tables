--------------------------------------------------------
--  DDL for Package Body GHR_PDH_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_PDH_RKU" as
...
begin
hr_utility.set_location('Entering: GHR_PDH_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: GHR_PDH_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end GHR_PDH_RKU;
