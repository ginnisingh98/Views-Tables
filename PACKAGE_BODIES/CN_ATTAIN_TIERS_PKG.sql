--------------------------------------------------------
--  DDL for Package Body CN_ATTAIN_TIERS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CN_ATTAIN_TIERS_PKG" as
/* $Header: cntattrb.pls 115.4 2002/11/21 21:09:07 hlchen ship $ */
procedure INSERT_ROW (
  X_ROWID in out nocopy VARCHAR2,
  X_ATTAIN_TIER_ID in NUMBER,
  ...
  cursor C is select ROWID from CN_ATTAIN_TIERS
    where ATTAIN_TIER_ID = X_ATTAIN_TIER_ID
    ;
begin
  insert into CN_ATTAIN_TIERS (
    ATTAIN_TIER_ID,
    ATTAIN_SCHEDULE_ID,
    PERCENT,
    ATTRIBUTE_CATEGORY,
...
procedure LOCK_ROW (
  ...
  cursor c1 is select
    ...
    where ATTAIN_TIER_ID = X_ATTAIN_TIER_ID
    for update of ATTAIN_TIER_ID nowait;
begin
  for tlinfo in c1 loop
      if (   (tlinfo.ATTAIN_SCHEDULE_ID = X_ATTAIN_SCHEDULE_ID)
