--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_SECONDARY_EMP_ASG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_SECONDARY_EMP_ASG" as
/*
 * Generated by hr_pump_meta_mapper at: 2018/06/16 10:06:59
 * Generated for API: hr_assignment_api.create_secondary_emp_asg
 */
--
...
decode(l.pval003,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval003,'EMP_ASSIGN_REASON',d(l.pval001),l.pval159)) p3,
l.pval003 d3,
...
decode(l.pval006,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval006,'EMP_CAT',d(l.pval001),l.pval159)) p6,
l.pval006 d6,
decode(l.pval007,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval007,'FREQUENCY',d(l.pval001),l.pval159)) p7,
l.pval007 d7,
decode(l.pval008,cn,vn,vn,vn,l.pval008) p8,
l.pval008 d8,
decode(l.pval009,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval009,'YES_NO',d(l.pval001),l.pval159)) p9,
l.pval009 d9,
...
decode(l.pval012,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval012,'FREQUENCY',d(l.pval001),l.pval159)) p12,
l.pval012 d12,
decode(l.pval013,cn,nn,vn,nn,n(l.pval013)) p13,
l.pval013 d13,
decode(l.pval014,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval014,'QUALIFYING_UNITS',d(l.pval001),l.pval159)) p14,
l.pval014 d14,
decode(l.pval015,cn,nn,vn,nn,n(l.pval015)) p15,
l.pval015 d15,
decode(l.pval016,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval016,'FREQUENCY',d(l.pval001),l.pval159)) p16,
l.pval016 d16,
decode(l.pval017,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval017,'REC_TYPE',d(l.pval001),l.pval159)) p17,
l.pval017 d17,
...
decode(l.pval020,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval020,'BARGAINING_UNIT_CODE',d(l.pval001),l.pval159)) p20,
l.pval020 d20,
decode(l.pval021,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval021,'YES_NO',d(l.pval001),l.pval159)) p21,
l.pval021 d21,
decode(l.pval022,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval022,'HOURLY_SALARIED_CODE',d(l.pval001),l.pval159)) p22,
l.pval022 d22,
...
l.pval136 d136,
decode(l.pval137,cn,nn,vn,nn,n(l.pval137)) p137,
l.pval137 d137,
...
l.pval142 p142,
l.pval143 p143,
decode(l.pval144,cn,nn,n(l.pval144)) p144,
l.pval145 p145,
l.pval146 p146,
decode(l.pval147,cn,nn,n(l.pval147)) p147,
decode(l.pval148,cn,nn,n(l.pval148)) p148,
l.pval149 p149,
decode(l.pval150,cn,dn,d(l.pval150)) p150,
decode(l.pval151,cn,dn,d(l.pval151)) p151,
l.pval152 p152,
l.pval153 p153,
l.pval154 p154,
l.pval155 p155,
l.pval156 p156,
decode(l.pval157,cn,vn,l.pval157) p157,
decode(l.pval158,cn,vn,l.pval158) p158,
decode(l.pval159,cn,vn,l.pval159) p159,
...
(P_ORGANIZATION_NAME => c.p158
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p159);
end if;
--
...
(P_USER_STATUS => c.p163
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_LANGUAGE_CODE => c.p159);
end if;
--
if c.p164 is null or
c.p1 is null then
L_PAYROLL_ID:=nn;
else
L_PAYROLL_ID := 
hr_pump_get.get_payroll_id
(P_PAYROLL_NAME => c.p164
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p1);
end if;
--
if c.p165 is null or
c.p159 is null then
L_LOCATION_ID:=nn;
else
L_LOCATION_ID := 
hr_pump_get.get_location_id
(P_LOCATION_CODE => c.p165
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_LANGUAGE_CODE => c.p159);
end if;
--
if c.p166 is null then
L_SUPERVISOR_ID:=nn;
else
L_SUPERVISOR_ID := 
hr_pump_get.get_supervisor_id
(P_SUPERVISOR_USER_KEY => c.p166);
end if;
--
if c.p167 is null then
L_SPECIAL_CEILING_STEP_ID:=nn;
else
L_SPECIAL_CEILING_STEP_ID := 
hr_pump_get.get_special_ceiling_step_id
(P_SPECIAL_CEILIN_STEP_USER_KEY => c.p167);
end if;
--
if c.p168 is null then
L_PAY_BASIS_ID:=nn;
else
L_PAY_BASIS_ID := 
hr_pump_get.get_pay_basis_id
(P_PAY_BASIS_NAME => c.p168
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID);
end if;
--
if c.p169 is null then
L_DEFAULT_CODE_COMB_ID:=nn;
else
L_DEFAULT_CODE_COMB_ID := 
hr_pump_get.get_default_code_comb_id
(P_DEFAULT_CODE_COMB_USER_KEY => c.p169);
end if;
--
if c.p170 is null then
L_SET_OF_BOOKS_ID:=nn;
else
L_SET_OF_BOOKS_ID := 
hr_pump_get.get_set_of_books_id
(P_SET_OF_BOOKS_NAME => c.p170);
end if;
--
if c.p171 is null then
L_CONTRACT_ID:=nn;
else
L_CONTRACT_ID := 
hr_pump_get.get_contract_id
(P_CONTRACT_USER_KEY => c.p171);
end if;
--
if c.p172 is null or
c.p1 is null or
c.p159 is null then
...
(P_ESTABLISHMENT_ORG_NAME => c.p172
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p159);
end if;
--
if c.p173 is null or
c.p1 is null then
...
,P_TITLE => c.p54
,P_SCL_SEGMENT1 => c.p55
,P_SCL_SEGMENT2 => c.p56
,P_SCL_SEGMENT3 => c.p57
,P_SCL_SEGMENT4 => c.p58
,P_SCL_SEGMENT5 => c.p59
,P_SCL_SEGMENT6 => c.p60
,P_SCL_SEGMENT7 => c.p61
,P_SCL_SEGMENT8 => c.p62
,P_SCL_SEGMENT9 => c.p63
,P_SCL_SEGMENT10 => c.p64
,P_SCL_SEGMENT11 => c.p65
,P_SCL_SEGMENT12 => c.p66
,P_SCL_SEGMENT13 => c.p67
,P_SCL_SEGMENT14 => c.p68
,P_SCL_SEGMENT15 => c.p69
,P_SCL_SEGMENT16 => c.p70
,P_SCL_SEGMENT17 => c.p71
,P_SCL_SEGMENT18 => c.p72
,P_SCL_SEGMENT19 => c.p73
,P_SCL_SEGMENT20 => c.p74
,P_SCL_SEGMENT21 => c.p75
,P_SCL_SEGMENT22 => c.p76
,P_SCL_SEGMENT23 => c.p77
,P_SCL_SEGMENT24 => c.p78
,P_SCL_SEGMENT25 => c.p79
,P_SCL_SEGMENT26 => c.p80
,P_SCL_SEGMENT27 => c.p81
,P_SCL_SEGMENT28 => c.p82
,P_SCL_SEGMENT29 => c.p83
,P_SCL_SEGMENT30 => c.p84
,P_SCL_CONCAT_SEGMENTS => c.p85
,P_PGP_SEGMENT1 => c.p86
,P_PGP_SEGMENT2 => c.p87
,P_PGP_SEGMENT3 => c.p88
,P_PGP_SEGMENT4 => c.p89
,P_PGP_SEGMENT5 => c.p90
,P_PGP_SEGMENT6 => c.p91
,P_PGP_SEGMENT7 => c.p92
,P_PGP_SEGMENT8 => c.p93
,P_PGP_SEGMENT9 => c.p94
,P_PGP_SEGMENT10 => c.p95
,P_PGP_SEGMENT11 => c.p96
,P_PGP_SEGMENT12 => c.p97
,P_PGP_SEGMENT13 => c.p98
,P_PGP_SEGMENT14 => c.p99
,P_PGP_SEGMENT15 => c.p100
,P_PGP_SEGMENT16 => c.p101
,P_PGP_SEGMENT17 => c.p102
,P_PGP_SEGMENT18 => c.p103
,P_PGP_SEGMENT19 => c.p104
,P_PGP_SEGMENT20 => c.p105
,P_PGP_SEGMENT21 => c.p106
,P_PGP_SEGMENT22 => c.p107
,P_PGP_SEGMENT23 => c.p108
,P_PGP_SEGMENT24 => c.p109
,P_PGP_SEGMENT25 => c.p110
,P_PGP_SEGMENT26 => c.p111
,P_PGP_SEGMENT27 => c.p112
,P_PGP_SEGMENT28 => c.p113
,P_PGP_SEGMENT29 => c.p114
,P_PGP_SEGMENT30 => c.p115
,P_PGP_CONCAT_SEGMENTS => c.p116
...
,P_CAG_SEGMENT1 => c.p117
,P_CAG_SEGMENT2 => c.p118
,P_CAG_SEGMENT3 => c.p119
,P_CAG_SEGMENT4 => c.p120
,P_CAG_SEGMENT5 => c.p121
,P_CAG_SEGMENT6 => c.p122
,P_CAG_SEGMENT7 => c.p123
,P_CAG_SEGMENT8 => c.p124
,P_CAG_SEGMENT9 => c.p125
,P_CAG_SEGMENT10 => c.p126
,P_CAG_SEGMENT11 => c.p127
,P_CAG_SEGMENT12 => c.p128
,P_CAG_SEGMENT13 => c.p129
,P_CAG_SEGMENT14 => c.p130
,P_CAG_SEGMENT15 => c.p131
,P_CAG_SEGMENT16 => c.p132
,P_CAG_SEGMENT17 => c.p133
,P_CAG_SEGMENT18 => c.p134
,P_CAG_SEGMENT19 => c.p135
,P_CAG_SEGMENT20 => c.p136
,P_NOTICE_PERIOD => c.p137
,P_NOTICE_PERIOD_UOM => c.p138
,P_EMPLOYEE_CATEGORY => c.p139
,P_WORK_AT_HOME => c.p140
,P_JOB_POST_SOURCE_NAME => c.p141
,P_GRADE_LADDER_PGM_ID => L_GRADE_LADDER_PGM_ID
,P_SUPERVISOR_ASSIGNMENT_ID => L_SUPERVISOR_ASSIGNMENT_ID
,P_GROUP_NAME => c.p142
,P_CONCATENATED_SEGMENTS => c.p143
,P_CAGR_GRADE_DEF_ID => c.p144
,P_CAGR_CONCATENATED_SEGMENTS => c.p145
,P_ASSIGNMENT_ID => L_ASSIGNMENT_ID
,P_SOFT_CODING_KEYFLEX_ID => c.p147
,P_PEOPLE_GROUP_ID => c.p148
,P_OBJECT_VERSION_NUMBER => c.p149
,P_EFFECTIVE_START_DATE => c.p150
,P_EFFECTIVE_END_DATE => c.p151
,P_ASSIGNMENT_SEQUENCE => c.p152
,P_COMMENT_ID => c.p153
,P_OTHER_MANAGER_WARNING => L_OTHER_MANAGER_WARNING
,P_HOURLY_SALARIED_WARNING => L_HOURLY_SALARIED_WARNING
,P_GSP_POST_PROCESS_WARNING => c.p156);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p146,L_ASSIGNMENT_ID);
--
...
l.pval144 = decode(c.p144,null,cn,c.p144),
l.pval145 = decode(c.p145,null,cn,c.p145),
l.pval146 = decode(c.p146,null,cn,c.p146),
l.pval147 = decode(c.p147,null,cn,c.p147),
l.pval148 = decode(c.p148,null,cn,c.p148),
l.pval149 = decode(c.p149,null,cn,c.p149),
l.pval150 = decode(c.p150,null,cn,dc(c.p150)),
l.pval151 = decode(c.p151,null,cn,dc(c.p151)),
l.pval152 = decode(c.p152,null,cn,c.p152),
l.pval153 = decode(c.p153,null,cn,c.p153),
l.pval154 = decode(c.p154,null,cn,c.p154),
l.pval155 = decode(c.p155,null,cn,c.p155),
l.pval156 = decode(c.p156,null,cn,c.p156)
...
end hrdpp_create_secondary_emp_asg;
