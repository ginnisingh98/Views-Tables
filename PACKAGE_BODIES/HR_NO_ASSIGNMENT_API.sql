--------------------------------------------------------
--  DDL for Package Body HR_NO_ASSIGNMENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_NO_ASSIGNMENT_API" AS
/* $Header: peasgnoi.pkb 120.0 2005/05/31 05:44:02 appldev noship $ */

g_package  VARCHAR2(33) := 'hr_no_assignment_api.';
--
-- ----------------------------------------------------------------------------
...
PROCEDURE create_no_secondary_emp_asg
  ...
  l_proc               VARCHAR2(72) := g_package||'create_no_secondary_emp_asg';
  v_field	VARCHAR2(20);
  --
  -- Declare cursors
  --
...
BEGIN
  ...
  --
  -- Ensure that the employee IS within a NO business group
  --
 ...
 hr_assignment_api.create_secondary_emp_asg
  ...
  ,p_scl_segment3                 =>     p_ssb_position_code
  ,p_scl_segment4                 =>     p_work_title
  ,p_scl_segment5                 =>     p_job_status
  ,p_scl_segment6                 =>     p_cond_of_emp
  ,p_scl_segment7                 =>     p_part_full_time
  ,p_scl_segment8                 =>     p_shift_work
  ,p_scl_segment9                 =>     p_payroll_period
  ,p_scl_segment10                =>     p_agreed_working_hours
  ,p_scl_segment11                =>     p_date_notice_received
  ,p_scl_segment12                =>     p_retirement_date
  ,p_scl_segment13                =>     p_retirement_inquiry_sent
  ,p_scl_segment14                =>     p_retirement_age
  ...
  --
  END create_no_secondary_emp_asg;
...
PROCEDURE update_no_emp_asg
 ...
 --
    -- Declare cursors AND local variables
    --
    l_proc                       VARCHAR2(72) := g_package||'update_no_emp_asg';
    l_effective_date             DATE;
    l_legislation_code           per_business_groups.legislation_code%TYPE;
    l_business_group_id          per_business_groups.business_group_id%type;
    a              varchar2(100);
  ...
  BEGIN
    ...
    --
      ...
      ,p_segment3       	      => p_ssb_position_code
      ,p_segment4  	              => p_work_title
      ,p_segment5                     => p_job_status
      ,p_segment6                     => p_cond_of_emp
      ,p_segment7                     => p_part_full_time
      ,p_segment8                     => p_shift_work
      ,p_segment9                     => p_payroll_period
      ,p_segment10                    => p_agreed_working_hours
      ,p_segment11                =>     p_date_notice_received
      ,p_segment12                =>     p_retirement_date
      ,p_segment13                =>     p_retirement_inquiry_sent
      ,p_segment14                =>     p_retirement_age
      ,p_soft_coding_keyflex_id       => p_soft_coding_keyflex_id
      ,p_comment_id                   => p_comment_id
      ,p_effective_start_date         => p_effective_start_date
      ,p_effective_END_date           => p_effective_end_date
