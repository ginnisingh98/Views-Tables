--------------------------------------------------------
--  DDL for Package Body IGF_AW_FN_RPKG_PRTY_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_AW_FN_RPKG_PRTY_PKG" AS
/* $Header: IGFWI67B.pls 120.0 2005/06/01 15:20:43 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_aw_fn_rpkg_prty%ROWTYPE;
  new_references igf_aw_fn_rpkg_prty%ROWTYPE;
  ...
  */
    CURSOR cur_rowid IS
      ...
      AND      fund_order_num = x_fund_order_num
      FOR UPDATE NOWAIT;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGF_AW_FN_RPKG_PRTY_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
    ...
    INSERT INTO igf_aw_fn_rpkg_prty (
      ci_cal_type,
      ci_sequence_number,
      fund_order_num,
      fund_id,
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGF_AW_FN_RPKG_PRTY_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
  ...
  */
  BEGIN
    ...
    DELETE FROM igf_aw_fn_rpkg_prty
    WHERE rowid = x_rowid;
