--------------------------------------------------------
--  DDL for Package Body HR_KW_CONTRACT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_KW_CONTRACT_API" as
/* $Header: pectckwi.pkb 120.0 2005/05/31 07:19:04 appldev noship $ */


--
-- Package Variables
--
g_package  varchar2(33) := 'hr_kw_contract_api.';
--
-- ----------------------------------------------------------------------
-- |------------------------< create_kw_contract >----------------------|
-- ----------------------------------------------------------------------
