--------------------------------------------------------
--  DDL for Package Body HR_NZ_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_NZ_APPLICANT_API" AS
/* $Header: hrnzwrap.pkb 120.2 2005/10/05 22:25:40 rpalli noship $ */

  -- Package Variables
  --
  g_package  VARCHAR2(33) := 'hr_nz_applicant_api.';
