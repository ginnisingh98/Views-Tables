--------------------------------------------------------
--  DDL for Package Body HXC_ULQ_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_ULQ_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_ulq_del.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Delete the hxc_layout_comp_qualifiers row.
  --
  delete from hxc_layout_comp_qualifiers
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hxc_ulq_shd.g_rec_type) is
--
  l_proc  varchar2(72) ;
--
Begin
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hxc_ulq_shd.g_rec_type) is
--
  l_proc  varchar2(72) ;
--
Begin
...
Begin
  ...
  --
  hxc_ulq_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  hxc_ulq_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hxc_ulq_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hxc_ulq_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
