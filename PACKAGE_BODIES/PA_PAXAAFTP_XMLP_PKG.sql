--------------------------------------------------------
--  DDL for Package Body PA_PAXAAFTP_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PA_PAXAAFTP_XMLP_PKG" AS
/* $Header: PAXAAFTPB.pls 120.0 2008/01/02 11:07:11 krreddy noship $ */
...
IF P_FUNCTION_CODE is not null then
 select function_code
 into func
 from pa_functions
 where function_code = P_FUNCTION_CODE;
END IF;
C_function_code := func;
...
--Functions to refer Oracle report placeholders--
 ...
 Function c_no_data_found_p return varchar2 is
	Begin
	 ...
	 END;
 Function C_function_code_p return varchar2 is
	Begin
