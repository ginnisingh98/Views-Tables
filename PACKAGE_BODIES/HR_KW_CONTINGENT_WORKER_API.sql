--------------------------------------------------------
--  DDL for Package Body HR_KW_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_KW_CONTINGENT_WORKER_API" as
/* $Header: pecwkkwi.pkb 120.1 2005/06/22 04:38:09 adevanat noship $ */
--
	-- Package Variables
	g_package  varchar2(33) := '  hr_kw_contingent_worker_api.';
