--------------------------------------------------------
--  DDL for Package Body IGS_RE_THS_EXAM_TYPE_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_RE_THS_EXAM_TYPE_PKG" as
/* $Header: IGSRI20B.pls 115.3 2002/11/29 03:36:59 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references IGS_RE_THS_EXAM_TYPE%RowType;
  new_references IGS_RE_THS_EXAM_TYPE%RowType;
 ...
 END Check_Constraints ;
  ...
  BEGIN
    ...
    IGS_RE_THESIS_EXAM_PKG.GET_FK_IGS_RE_THS_EXAM_TYPE (
...
procedure INSERT_ROW (
  ...
  X_MODE in VARCHAR2 default 'R'
    ...
    cursor C is select ROWID from IGS_RE_THS_EXAM_TYPE
      where THESIS_EXAM_TYPE = X_THESIS_EXAM_TYPE;
...
begin
  ...
  insert into IGS_RE_THS_EXAM_TYPE (
    THESIS_EXAM_TYPE,
    DESCRIPTION,
    CLOSED_IND,
    CREATION_DATE,
...
begin
  ...
  update IGS_RE_THS_EXAM_TYPE set
...
procedure ADD_ROW (
  ...
  cursor c1 is select rowid from IGS_RE_THS_EXAM_TYPE
     where THESIS_EXAM_TYPE = X_THESIS_EXAM_TYPE
  ;
begin
  open c1;
...
begin
  ...
  delete from IGS_RE_THS_EXAM_TYPE
  where ROWID = X_ROWID;
  if (sql%notfound) then
    raise no_data_found;
  end if;
