--------------------------------------------------------
--  DDL for Package Body BEN_PTIP_DPNT_CVG_CTFN_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PTIP_DPNT_CVG_CTFN_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PTIP_DPNT_CVG_CTFN_BK1.CREATE_PTIP_DPNT_CVG_CTFN_A', 10);
hr_utility.set_location(' Leaving: BEN_PTIP_DPNT_CVG_CTFN_BK1.CREATE_PTIP_DPNT_CVG_CTFN_A', 20);
end CREATE_PTIP_DPNT_CVG_CTFN_A;
...
begin
hr_utility.set_location('Entering: BEN_PTIP_DPNT_CVG_CTFN_BK1.CREATE_PTIP_DPNT_CVG_CTFN_B', 10);
hr_utility.set_location(' Leaving: BEN_PTIP_DPNT_CVG_CTFN_BK1.CREATE_PTIP_DPNT_CVG_CTFN_B', 20);
end CREATE_PTIP_DPNT_CVG_CTFN_B;
