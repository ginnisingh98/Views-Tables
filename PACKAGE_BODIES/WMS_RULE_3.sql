--------------------------------------------------------
--  DDL for Package Body WMS_RULE_3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WMS_RULE_3" AS
...
,base.SERIAL_NUMBER asc,WMS_Parameter_PVT.GetItemOnHand(
base.ORGANIZATION_ID
,mptdtv.INVENTORY_ITEM_ID
,base.SUBINVENTORY_CODE
,base.LOCATOR_ID
...
,base.LOCATOR_ID
,msi.PRIMARY_UOM_CODE
,mptdtv.TRANSACTION_UOM ),base.SERIAL_NUMBER,base.CONVERSION_RATE
,WMS_Parameter_PVT.GetItemOnHand(
base.ORGANIZATION_ID
,mptdtv.INVENTORY_ITEM_ID
,base.SUBINVENTORY_CODE
