--------------------------------------------------------
--  DDL for Package Body HR_AE_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_AE_EMPLOYEE_API" as
/* $Header: peempaei.pkb 120.1.12000000.1 2007/01/21 22:09:20 appldev ship $ */
--
  g_package  varchar2(33) := 'hr_ae_employee_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_ae_employee >------------------------------|
-- -----------------------------------------------------------------------------
...
is
    ...
    l_proc                 VARCHAR2(72) := g_package||'create_ae_employee';
