--------------------------------------------------------
--  DDL for Package Body OKL_SETUPPQYVALUES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPPQYVALUES_PUB_W" as
  /* $Header: OKLUSQVB.pls 115.2 2002/12/24 04:21:11 sgorantl noship $ */
  ...
  as
    ddp_qvev_rec okl_setuppqyvalues_pub.qvev_rec_type;
    ddx_no_data_found boolean;
    ddx_qvev_rec okl_setuppqyvalues_pub.qvev_rec_type;
  ...
  begin
    ...
    okl_setuppqyvalues_pub.get_rec(ddp_qvev_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_qvev_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_qvev_rec.id);
    p4_a1 := rosetta_g_miss_num_map(ddx_qvev_rec.object_version_number);
    p4_a2 := rosetta_g_miss_num_map(ddx_qvev_rec.pqy_id);
    p4_a3 := ddx_qvev_rec.value;
    p4_a4 := ddx_qvev_rec.description;
    p4_a5 := ddx_qvev_rec.from_date;
    p4_a6 := ddx_qvev_rec.to_date;
    p4_a7 := rosetta_g_miss_num_map(ddx_qvev_rec.created_by);
    p4_a8 := ddx_qvev_rec.creation_date;
    p4_a9 := rosetta_g_miss_num_map(ddx_qvev_rec.last_updated_by);
    p4_a10 := ddx_qvev_rec.last_update_date;
    p4_a11 := rosetta_g_miss_num_map(ddx_qvev_rec.last_update_login);
  end;
  ...
  as
    ddp_pqyv_rec okl_setuppqyvalues_pub.pqyv_rec_type;
    ddp_qvev_rec okl_setuppqyvalues_pub.qvev_rec_type;
    ddx_qvev_rec okl_setuppqyvalues_pub.qvev_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppqyvalues_pub.insert_pqyvalues(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setuppqyvalues_pub.update_pqyvalues(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
