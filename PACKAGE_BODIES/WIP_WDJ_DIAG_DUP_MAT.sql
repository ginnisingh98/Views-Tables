--------------------------------------------------------
--  DDL for Package Body WIP_WDJ_DIAG_DUP_MAT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WIP_WDJ_DIAG_DUP_MAT" as
/* $Header: WIPDJ03B.pls 120.1 2008/05/01 04:06:58 shjindal noship $ */
PROCEDURE init is
BEGIN
null;
END init;
...
WIP_DIAG_DISCRETE_LOT.dup_mat_txn_wdj(l_org_id, report, reportClob);
...
BEGIN
name := 'Duplicate Material Transactions';
...
descStr := 'This health check diagnostic identifies potential data inconsistency in WIP material transactions.<BR>'||
           'It fetches duplicate material transactions related to discrete/lot based jobs.<BR>'||
