--------------------------------------------------------
--  DDL for Package Body BEN_SHR_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_SHR_RKU" as
...
begin
hr_utility.set_location('Entering: ben_shr_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_shr_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_shr_RKU;
