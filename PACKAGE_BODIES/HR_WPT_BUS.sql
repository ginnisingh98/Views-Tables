--------------------------------------------------------
--  DDL for Package Body HR_WPT_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_WPT_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_wpt_bus.';  -- Global package name
--
...
begin
  ...
  --
  hr_wnp_bus.set_security_group_id
...
Begin
  ...
  hr_utility.set_location('Entering:'|| l_proc, 10);
  --
  l_legislation_code := hr_wnp_bus.return_legislation_code
    (p_window_property_id           => p_window_property_id
    );
  --
...
Begin
  ...
  --
  IF NOT hr_wpt_shd.api_updating
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 10);
  --
  l_api_updating := hr_wpt_shd.api_updating
    (p_window_property_id           => p_window_property_id
  ...
  --
  if (  (   l_api_updating
        and nvl(hr_wpt_shd.g_old_rec.source_lang,hr_api.g_varchar2) <>
...
Procedure chk_title
  ...
  --
  l_proc                         varchar2(72) := g_package || 'chk_title';
  l_api_updating                 boolean;
  --
Begin
  hr_utility.set_location('Entering:'||l_proc, 10);
