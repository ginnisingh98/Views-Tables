--------------------------------------------------------
--  DDL for Package Body IGS_AS_ANON_ID_ASS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AS_ANON_ID_ASS_PKG" AS
/* $Header: IGSDI63B.pls 115.1 2002/11/28 23:26:43 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_as_anon_id_ass%ROWTYPE;
  new_references igs_as_anon_id_ass%ROWTYPE;
  ...
  */
    CURSOR cur_rowid IS
      ...
      AND      assessment_type = x_assessment_type
      AND      load_cal_type = x_load_cal_type
      AND      load_ci_sequence_number = x_load_ci_sequence_number
      FOR UPDATE NOWAIT;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_AS_AASS_ATYP_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_AS_AASS_CI_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  */
  ...
  BEGIN
    ...
    INSERT INTO igs_as_anon_id_ass (
      person_id,
      anonymous_id,
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_as_anon_id_ass
    WHERE rowid = x_rowid;
