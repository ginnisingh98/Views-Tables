--------------------------------------------------------
--  DDL for Package Body JE_JEHUFAMD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JE_JEHUFAMD_XMLP_PKG" AS
/* $Header: JEHUFAMDB.pls 120.1 2007/12/25 16:53:15 dwkrishn noship $ */
  ...
  BEGIN
    CP_FDRCSID := '$Header: JEHUFAMDB.pls 120.1 2007/12/25 16:53:15 dwkrishn noship $';
  END VERSION;
  ...
  FUNCTION CP_END_DATE_OPEN_P RETURN VARCHAR2 IS
  BEGIN
    RETURN CP_END_DATE_OPEN;
  END CP_END_DATE_OPEN_P;
