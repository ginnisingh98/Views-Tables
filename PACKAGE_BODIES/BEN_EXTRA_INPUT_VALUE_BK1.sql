--------------------------------------------------------
--  DDL for Package Body BEN_EXTRA_INPUT_VALUE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EXTRA_INPUT_VALUE_BK1" as
/* $Header: beeivapi.pkb 120.0 2005/05/28 02:16:14 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/01/04 08:38:57 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: BEN_EXTRA_INPUT_VALUE_BK1.CREATE_EXTRA_INPUT_VALUE_A', 10);
hr_utility.set_location(' Leaving: BEN_EXTRA_INPUT_VALUE_BK1.CREATE_EXTRA_INPUT_VALUE_A', 20);
end CREATE_EXTRA_INPUT_VALUE_A;
...
begin
hr_utility.set_location('Entering: BEN_EXTRA_INPUT_VALUE_BK1.CREATE_EXTRA_INPUT_VALUE_B', 10);
hr_utility.set_location(' Leaving: BEN_EXTRA_INPUT_VALUE_BK1.CREATE_EXTRA_INPUT_VALUE_B', 20);
end CREATE_EXTRA_INPUT_VALUE_B;
