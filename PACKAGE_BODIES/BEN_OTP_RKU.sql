--------------------------------------------------------
--  DDL for Package Body BEN_OTP_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_OTP_RKU" as
/* $Header: beotprhi.pkb 115.3 2003/09/25 00:30:57 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_otp_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_otp_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_otp_RKU;
