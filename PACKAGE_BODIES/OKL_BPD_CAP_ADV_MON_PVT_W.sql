--------------------------------------------------------
--  DDL for Package Body OKL_BPD_CAP_ADV_MON_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_BPD_CAP_ADV_MON_PVT_W" as
  /* $Header: OKLEAMSB.pls 120.2 2007/08/02 08:40:22 dcshanmu ship $ */
  ...
  as
    ddp_adv_rcpt_rec okl_bpd_cap_adv_mon_pvt.adv_rcpt_rec;
    ddx_adv_rcpt_rec okl_bpd_cap_adv_mon_pvt.adv_rcpt_rec;
  ...
  begin
    ...
    ddp_adv_rcpt_rec.customer_num := rosetta_g_miss_num_map(p5_a10);
    ...
    okl_bpd_cap_adv_mon_pvt.handle_advanced_manual_pay(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a10 := rosetta_g_miss_num_map(ddx_adv_rcpt_rec.customer_num);
