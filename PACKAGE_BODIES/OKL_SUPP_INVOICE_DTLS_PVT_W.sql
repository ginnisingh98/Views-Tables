--------------------------------------------------------
--  DDL for Package Body OKL_SUPP_INVOICE_DTLS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SUPP_INVOICE_DTLS_PVT_W" as
  /* $Header: OKLOSIDB.pls 120.1 2005/07/18 13:22:22 viselvar noship $ */
  ...
  as
    ddp_sidv_rec okl_supp_invoice_dtls_pvt.sidv_rec_type;
    ddx_sidv_rec okl_supp_invoice_dtls_pvt.sidv_rec_type;
  ...
  begin
    ...
    okl_supp_invoice_dtls_pvt.create_sup_inv_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_sidv_tbl okl_supp_invoice_dtls_pvt.sidv_tbl_type;
    ddx_sidv_tbl okl_supp_invoice_dtls_pvt.sidv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_supp_invoice_dtls_pvt.lock_sup_inv_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_supp_invoice_dtls_pvt.update_sup_inv_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_supp_invoice_dtls_pvt.delete_sup_inv_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_supp_invoice_dtls_pvt.validate_sup_inv_dtls(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_supp_invoice_dtls_pvt_w;
