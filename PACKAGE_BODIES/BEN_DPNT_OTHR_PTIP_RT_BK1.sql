--------------------------------------------------------
--  DDL for Package Body BEN_DPNT_OTHR_PTIP_RT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DPNT_OTHR_PTIP_RT_BK1" as
/* $Header: bedotapi.pkb 115.1 2002/12/13 08:28:50 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_DPNT_OTHR_PTIP_RT_BK1.CREATE_DPNT_OTHR_PTIP_RT_A', 10);
hr_utility.set_location(' Leaving: BEN_DPNT_OTHR_PTIP_RT_BK1.CREATE_DPNT_OTHR_PTIP_RT_A', 20);
end CREATE_DPNT_OTHR_PTIP_RT_A;
...
begin
hr_utility.set_location('Entering: BEN_DPNT_OTHR_PTIP_RT_BK1.CREATE_DPNT_OTHR_PTIP_RT_B', 10);
hr_utility.set_location(' Leaving: BEN_DPNT_OTHR_PTIP_RT_BK1.CREATE_DPNT_OTHR_PTIP_RT_B', 20);
end CREATE_DPNT_OTHR_PTIP_RT_B;
