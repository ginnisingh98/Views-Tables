--------------------------------------------------------
--  DDL for Package Body OKL_CONTRACT_PARTY_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CONTRACT_PARTY_PUB_W" as
  /* $Header: OKLUCPCB.pls 120.1 2005/08/04 01:19:22 manumanu noship $ */
  ...
  as
    ddp_ctcv_rec okl_contract_party_pub.ctcv_rec_type;
    ddx_ctcv_rec okl_contract_party_pub.ctcv_rec_type;
  ...
  begin
    ...
    okl_contract_party_pub.create_contact(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ctcv_tbl okl_contract_party_pub.ctcv_tbl_type;
    ddx_ctcv_tbl okl_contract_party_pub.ctcv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_party_pub.update_contact(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_party_pub.delete_contact(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_cplv_rec okl_contract_party_pub.cplv_rec_type;
    ddx_cplv_rec okl_contract_party_pub.cplv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_party_pub.create_k_party_role(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_cplv_tbl okl_contract_party_pub.cplv_tbl_type;
    ddx_cplv_tbl okl_contract_party_pub.cplv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_party_pub.update_k_party_role(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_party_pub.delete_k_party_role(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
