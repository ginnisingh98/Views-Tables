--------------------------------------------------------
--  DDL for Package Body BEN_BENDFSUM_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENDFSUM_XMLP_PKG" AS
/* $Header: BENDFSUMB.pls 120.1 2007/12/10 08:30:40 vjaganat noship $ */
...
function CF_STANDARD_HEADERFormula return Number is
  ...
  l_enrollment_type_cycle      varchar2(1000);
...
l_postal_zip_range           varchar2(185);
...
function CF_SUMMARY_EVENTFormula return Number is
  ...
  begin
    ...
    (p_concurrent_request_id         => P_CONCURRENT_REQUEST_ID
    ,p_cd_1  => 'DEFNOCHG', p_val_1  => CP_DEFNOCHG
    ,p_cd_2  => 'DEFWCHG',  p_val_2  => CP_DEFWCHG
