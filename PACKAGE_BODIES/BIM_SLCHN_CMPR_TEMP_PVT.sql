--------------------------------------------------------
--  DDL for Package Body BIM_SLCHN_CMPR_TEMP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BIM_SLCHN_CMPR_TEMP_PVT" AS
/* $Header: bimvsccb.pls 115.4 2000/08/15 13:01:31 pkm ship      $ */
