--------------------------------------------------------
--  DDL for Package Body BEN_ELN_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELN_RKI" as
...
begin
hr_utility.set_location('Entering: ben_eln_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_eln_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_eln_RKI;
