--------------------------------------------------------
--  DDL for Package Body AME_ATTRIBUTE_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AME_ATTRIBUTE_SWI" As
/* $Header: amatrswi.pkb 120.0 2005/09/02 03:51 mbocutt noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'ame_attribute_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_ame_attribute_swi;
  --
  ...
  --
  ame_atr_ins.set_base_key_value
    (p_attribute_id => p_attribute_id
    );
  --
  -- Call API
  --
  ame_attribute_api.create_ame_attribute
    ...
    ,p_atr_object_version_number    => p_atr_object_version_number
    ,p_atr_start_date               => p_atr_start_date
    ,p_atr_end_date                 => p_atr_end_date
    ,p_atu_object_version_number    => p_atu_object_version_number
    ,p_atu_start_date               => p_atu_start_date
    ,p_atu_end_date                 => p_atu_end_date
    );
  --
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_ame_attribute_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_ame_attribute_usage_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to create_ame_attribute_usage_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_ame_attribute_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  ame_attribute_api.update_ame_attribute
    (p_validate                     => l_validate
    ,p_attribute_id                 => p_attribute_id
    ,p_description                  => p_description
    ,p_object_version_number        => p_object_version_number
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_ame_attribute_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_ame_attribute_usage_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_ame_attribute_usage_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_object_version_number        := l_object_version_number;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_ame_attribute_usage_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_ame_attribute_usage_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_object_version_number        := l_object_version_number;
