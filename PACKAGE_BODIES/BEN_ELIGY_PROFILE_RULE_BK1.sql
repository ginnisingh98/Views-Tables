--------------------------------------------------------
--  DDL for Package Body BEN_ELIGY_PROFILE_RULE_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIGY_PROFILE_RULE_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_ELIGY_PROFILE_RULE_BK1.CREATE_ELIGY_PROFILE_RULE_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIGY_PROFILE_RULE_BK1.CREATE_ELIGY_PROFILE_RULE_A', 20);
end CREATE_ELIGY_PROFILE_RULE_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIGY_PROFILE_RULE_BK1.CREATE_ELIGY_PROFILE_RULE_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIGY_PROFILE_RULE_BK1.CREATE_ELIGY_PROFILE_RULE_B', 20);
end CREATE_ELIGY_PROFILE_RULE_B;
