--------------------------------------------------------
--  DDL for Package Body OKL_PROVISIONS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PROVISIONS_PUB" AS
/* $Header: OKLPPVNB.pls 115.10 2004/04/13 11:00:16 rnaik noship $ */

  PROCEDURE add_language IS
  BEGIN
--    okl_pvn_pvt.add_language;
    NULL;
  END add_language;
  ...
  PROCEDURE insert_provisions(
    ...
    l_data                            VARCHAR2(100);
    l_api_name                        CONSTANT VARCHAR2(30)  := 'insert_provisions';
    l_count                           NUMBER ;
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_PROVISIONS_PUB','insert_provisions');
  ...
  BEGIN
    x_return_status := FND_API.G_RET_STS_SUCCESS;
    SAVEPOINT lock_provisions;
    l_pvnv_rec := p_pvnv_rec;

    okl_pvn_pvt.lock_row(
                               p_api_version   => p_api_version
                              ,p_init_msg_list => p_init_msg_list
                              ,x_return_status => l_return_status
                              ,x_msg_count     => x_msg_count
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_PROVISIONS_PUB','lock_provisions');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_PROVISIONS_PUB','update_provisions');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_PROVISIONS_PUB','delete_provisions');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  PROCEDURE validate_provisions(
    ...
    l_data                            VARCHAR2(100);
    l_count                           NUMBER;
    l_api_name                        CONSTANT VARCHAR2(30)  := 'validate_provisions';
    l_return_status                   VARCHAR2(1)    := FND_API.G_RET_STS_SUCCESS;
  BEGIN
    x_return_status := FND_API.G_RET_STS_SUCCESS;
    SAVEPOINT validate_provisions;
    l_pvnv_rec := p_pvnv_rec;



    okl_pvn_pvt.validate_row(
                               p_api_version   => p_api_version
                              ,p_init_msg_list => p_init_msg_list
                              ,x_return_status => l_return_status
                              ,x_msg_count     => x_msg_count
  ...
  EXCEPTION
    WHEN FND_API.G_EXC_ERROR THEN
      ROLLBACK TO validate_provisions;
      x_return_status := FND_API.G_RET_STS_ERROR;
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_PROVISIONS_PUB','validate_provisions');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
