--------------------------------------------------------
--  DDL for Package Body PQH_WEL_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_WEL_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqh_wel_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure update_dml(p_rec in out nocopy pqh_wel_shd.g_rec_type) is
--
...
Begin
  ...
  --
  --
  -- Update the pqh_worksheet_bdgt_elmnts Row
  --
  update pqh_worksheet_bdgt_elmnts
  set
  ...
  where worksheet_bdgt_elmnt_id = p_rec.worksheet_bdgt_elmnt_id;
  --
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_update(p_rec in pqh_wel_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure post_update(p_rec in pqh_wel_shd.g_rec_type) is
--
...
--
 ...
 ,p_worksheet_budget_set_id_o     =>pqh_wel_shd.g_old_rec.worksheet_budget_set_id
 ,p_element_type_id_o             =>pqh_wel_shd.g_old_rec.element_type_id
 ,p_distribution_percentage_o     =>pqh_wel_shd.g_old_rec.distribution_percentage
 ,p_object_version_number_o       =>pqh_wel_shd.g_old_rec.object_version_number
      );
    --
  exception
    --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy pqh_wel_shd.g_rec_type) is
--
...
Begin
  ...
  --
  If (p_rec.worksheet_budget_set_id = hr_api.g_number) then
    p_rec.worksheet_budget_set_id :=
    pqh_wel_shd.g_old_rec.worksheet_budget_set_id;
  End If;
  If (p_rec.element_type_id = hr_api.g_number) then
    p_rec.element_type_id :=
    pqh_wel_shd.g_old_rec.element_type_id;
  End If;
  If (p_rec.distribution_percentage = hr_api.g_number) then
    p_rec.distribution_percentage :=
    pqh_wel_shd.g_old_rec.distribution_percentage;
  End If;
...
Begin
  ...
  --
  convert_defs(p_rec);
  pqh_wel_bus.update_validate(p_rec);
  --
