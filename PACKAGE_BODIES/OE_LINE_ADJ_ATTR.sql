--------------------------------------------------------
--  DDL for Package Body OE_LINE_ADJ_ATTR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_LINE_ADJ_ATTR" AS
/* $Header: OEXALADB.pls 120.0 2005/05/31 22:51:57 appldev noship $ */

--  Global constant holding the package name

G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'OE_LINE_ADJ_ATTR';
