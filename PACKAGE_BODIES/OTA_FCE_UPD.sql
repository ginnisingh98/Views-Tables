--------------------------------------------------------
--  DDL for Package Body OTA_FCE_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_FCE_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_fce_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Update the ota_open_fc_enrollments Row
  --
  update ota_open_fc_enrollments
    set
     enrollment_id                   = p_rec.enrollment_id
...
Begin
  ...
  --
  ota_fce_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_fce_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_fce_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
