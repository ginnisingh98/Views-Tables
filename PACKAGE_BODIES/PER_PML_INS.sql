--------------------------------------------------------
--  DDL for Package Body PER_PML_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PML_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_pml_ins.';  -- Global package name
--
...
Begin
  ...
  --
  per_pml_ins.g_objective_id_i := p_objective_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: per_objectives_library
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (per_pml_ins.g_objective_id_i is not null) Then
    --
    ...
    p_rec.objective_id :=
      per_pml_ins.g_objective_id_i;
    per_pml_ins.g_objective_id_i := null;
  Else
    --
...
--
  ...
  l_proc  			 varchar2(72) := g_package||'ins';
  l_objective_name_warning       boolean;
