--------------------------------------------------------
--  DDL for Package Body PAY_PBC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PBC_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_pbc_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  If (p_datetrack_mode = hr_api.g_correction) then
    ...
    --
    --
    -- Update the pay_balance_categories_f Row
    --
...
Begin
  ...
  If (p_rec.save_run_balance_enabled = hr_api.g_varchar2) then
    ...
    pay_pbc_shd.g_old_rec.save_run_balance_enabled;
  End If;
  If (p_rec.user_category_name = hr_api.g_varchar2) then
    p_rec.user_category_name :=
    pay_pbc_shd.g_old_rec.user_category_name;
  End If;
  If (p_rec.pbc_information_category = hr_api.g_varchar2) then
    p_rec.pbc_information_category :=
    pay_pbc_shd.g_old_rec.pbc_information_category;
  End If;
  If (p_rec.pbc_information1 = hr_api.g_varchar2) then
    p_rec.pbc_information1 :=
    pay_pbc_shd.g_old_rec.pbc_information1;
  End If;
  If (p_rec.pbc_information2 = hr_api.g_varchar2) then
    p_rec.pbc_information2 :=
    pay_pbc_shd.g_old_rec.pbc_information2;
  End If;
  If (p_rec.pbc_information3 = hr_api.g_varchar2) then
    p_rec.pbc_information3 :=
    pay_pbc_shd.g_old_rec.pbc_information3;
  End If;
  If (p_rec.pbc_information4 = hr_api.g_varchar2) then
    p_rec.pbc_information4 :=
    pay_pbc_shd.g_old_rec.pbc_information4;
  End If;
  If (p_rec.pbc_information5 = hr_api.g_varchar2) then
    p_rec.pbc_information5 :=
    pay_pbc_shd.g_old_rec.pbc_information5;
  End If;
  If (p_rec.pbc_information6 = hr_api.g_varchar2) then
    p_rec.pbc_information6 :=
    pay_pbc_shd.g_old_rec.pbc_information6;
  End If;
  If (p_rec.pbc_information7 = hr_api.g_varchar2) then
    p_rec.pbc_information7 :=
    pay_pbc_shd.g_old_rec.pbc_information7;
  End If;
  If (p_rec.pbc_information8 = hr_api.g_varchar2) then
    p_rec.pbc_information8 :=
    pay_pbc_shd.g_old_rec.pbc_information8;
  End If;
  If (p_rec.pbc_information9 = hr_api.g_varchar2) then
    p_rec.pbc_information9 :=
    pay_pbc_shd.g_old_rec.pbc_information9;
  End If;
  If (p_rec.pbc_information10 = hr_api.g_varchar2) then
    p_rec.pbc_information10 :=
    pay_pbc_shd.g_old_rec.pbc_information10;
  End If;
  If (p_rec.pbc_information11 = hr_api.g_varchar2) then
    p_rec.pbc_information11 :=
    pay_pbc_shd.g_old_rec.pbc_information11;
  End If;
  If (p_rec.pbc_information12 = hr_api.g_varchar2) then
    p_rec.pbc_information12 :=
    pay_pbc_shd.g_old_rec.pbc_information12;
  End If;
  If (p_rec.pbc_information13 = hr_api.g_varchar2) then
    p_rec.pbc_information13 :=
    pay_pbc_shd.g_old_rec.pbc_information13;
  End If;
  If (p_rec.pbc_information14 = hr_api.g_varchar2) then
    p_rec.pbc_information14 :=
    pay_pbc_shd.g_old_rec.pbc_information14;
  End If;
  If (p_rec.pbc_information15 = hr_api.g_varchar2) then
    p_rec.pbc_information15 :=
    pay_pbc_shd.g_old_rec.pbc_information15;
  End If;
  If (p_rec.pbc_information16 = hr_api.g_varchar2) then
    p_rec.pbc_information16 :=
    pay_pbc_shd.g_old_rec.pbc_information16;
  End If;
  If (p_rec.pbc_information17 = hr_api.g_varchar2) then
    p_rec.pbc_information17 :=
    pay_pbc_shd.g_old_rec.pbc_information17;
  End If;
  If (p_rec.pbc_information18 = hr_api.g_varchar2) then
    p_rec.pbc_information18 :=
    pay_pbc_shd.g_old_rec.pbc_information18;
  End If;
  If (p_rec.pbc_information19 = hr_api.g_varchar2) then
    p_rec.pbc_information19 :=
    pay_pbc_shd.g_old_rec.pbc_information19;
  End If;
  If (p_rec.pbc_information20 = hr_api.g_varchar2) then
    p_rec.pbc_information20 :=
    pay_pbc_shd.g_old_rec.pbc_information20;
  End If;
  If (p_rec.pbc_information21 = hr_api.g_varchar2) then
    p_rec.pbc_information21 :=
    pay_pbc_shd.g_old_rec.pbc_information21;
  End If;
  If (p_rec.pbc_information22 = hr_api.g_varchar2) then
    p_rec.pbc_information22 :=
    pay_pbc_shd.g_old_rec.pbc_information22;
  End If;
  If (p_rec.pbc_information23 = hr_api.g_varchar2) then
    p_rec.pbc_information23 :=
    pay_pbc_shd.g_old_rec.pbc_information23;
  End If;
  If (p_rec.pbc_information24 = hr_api.g_varchar2) then
    p_rec.pbc_information24 :=
    pay_pbc_shd.g_old_rec.pbc_information24;
  End If;
  If (p_rec.pbc_information25 = hr_api.g_varchar2) then
    p_rec.pbc_information25 :=
    pay_pbc_shd.g_old_rec.pbc_information25;
  End If;
  If (p_rec.pbc_information26 = hr_api.g_varchar2) then
    p_rec.pbc_information26 :=
    pay_pbc_shd.g_old_rec.pbc_information26;
  End If;
  If (p_rec.pbc_information27 = hr_api.g_varchar2) then
    p_rec.pbc_information27 :=
    pay_pbc_shd.g_old_rec.pbc_information27;
  End If;
  If (p_rec.pbc_information28 = hr_api.g_varchar2) then
    p_rec.pbc_information28 :=
    pay_pbc_shd.g_old_rec.pbc_information28;
  End If;
  If (p_rec.pbc_information29 = hr_api.g_varchar2) then
    p_rec.pbc_information29 :=
    pay_pbc_shd.g_old_rec.pbc_information29;
  End If;
  If (p_rec.pbc_information30 = hr_api.g_varchar2) then
    p_rec.pbc_information30 :=
...
Begin
  ...
  --
  pay_pbc_upd.convert_defs(p_rec);
  --
