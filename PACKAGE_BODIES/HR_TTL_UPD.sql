--------------------------------------------------------
--  DDL for Package Body HR_TTL_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_TTL_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_ttl_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the hr_ki_topics_tl Row
  --
...
Begin
  ...
  --
  hr_ttl_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hr_ttl_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hr_ttl_upd.post_update
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
  ...
  cursor csr_upd_langs is
    select ttl.language
     ...
     where
       ...
       and p_language_code in (ttl.language
                              ,ttl.source_lang);
  --
