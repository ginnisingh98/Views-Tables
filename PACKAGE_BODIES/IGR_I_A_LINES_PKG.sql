--------------------------------------------------------
--  DDL for Package Body IGR_I_A_LINES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGR_I_A_LINES_PKG" AS
/* $Header: IGSRH17B.pls 120.0 2005/06/01 22:35:22 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igr_i_a_lines%ROWTYPE;
  new_references igr_i_a_lines%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.sales_lead_line_id                := x_sales_lead_line_id;
  ...
  */
  BEGIN
    ...
    IF (((old_references.person_id = new_references.person_id) AND
      ...
      NULL;
    ELSIF NOT igr_i_appl_pkg.get_pk_For_validation (
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND (tlinfo.enquiry_appl_number = x_enquiry_appl_number)
        AND ((tlinfo.preference = x_preference) OR ((tlinfo.preference IS NULL) AND (X_preference IS NULL)))
       ) THEN
      NULL;
    ELSE
