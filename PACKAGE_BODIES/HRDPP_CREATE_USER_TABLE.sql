--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_USER_TABLE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_USER_TABLE" as
/*
...
l.pval002 d2,
decode(l.pval003,cn,vn,vn,'M',
 hr_pump_get.gl(l.pval003,'RANGE_MATCH',d(l.pval001),vn)) p3,
l.pval003 d3,
decode(l.pval004,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval004,'DATA_TYPE',d(l.pval001),vn)) p4,
l.pval004 d4,
...
,P_RANGE_OR_MATCH => c.p3
,P_USER_KEY_UNITS => c.p4
,P_USER_TABLE_NAME => c.p5
,P_USER_ROW_TITLE => c.p6
,P_USER_TABLE_ID => L_USER_TABLE_ID
,P_OBJECT_VERSION_NUMBER => c.p8);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p7,L_USER_TABLE_ID);
--
