--------------------------------------------------------
--  DDL for Package Body BEN_PYMT_CHECK_DET_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PYMT_CHECK_DET_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PYMT_CHECK_DET_BK1.CREATE_PYMT_CHECK_DET_A', 10);
hr_utility.set_location(' Leaving: BEN_PYMT_CHECK_DET_BK1.CREATE_PYMT_CHECK_DET_A', 20);
end CREATE_PYMT_CHECK_DET_A;
...
begin
hr_utility.set_location('Entering: BEN_PYMT_CHECK_DET_BK1.CREATE_PYMT_CHECK_DET_B', 10);
hr_utility.set_location(' Leaving: BEN_PYMT_CHECK_DET_BK1.CREATE_PYMT_CHECK_DET_B', 20);
end CREATE_PYMT_CHECK_DET_B;
