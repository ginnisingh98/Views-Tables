--------------------------------------------------------
--  DDL for Package Body BEN_DSGN_RQMT_RLSHP_TYP_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DSGN_RQMT_RLSHP_TYP_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_DSGN_RQMT_RLSHP_TYP_BK1.CREATE_DSGN_RQMT_RLSHP_TYP_A', 10);
hr_utility.set_location(' Leaving: BEN_DSGN_RQMT_RLSHP_TYP_BK1.CREATE_DSGN_RQMT_RLSHP_TYP_A', 20);
end CREATE_DSGN_RQMT_RLSHP_TYP_A;
...
begin
hr_utility.set_location('Entering: BEN_DSGN_RQMT_RLSHP_TYP_BK1.CREATE_DSGN_RQMT_RLSHP_TYP_B', 10);
hr_utility.set_location(' Leaving: BEN_DSGN_RQMT_RLSHP_TYP_BK1.CREATE_DSGN_RQMT_RLSHP_TYP_B', 20);
end CREATE_DSGN_RQMT_RLSHP_TYP_B;
