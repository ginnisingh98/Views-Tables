--------------------------------------------------------
--  DDL for Package Body OTA_LME_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_LME_RKU" as
...
begin
hr_utility.set_location('Entering: OTA_LME_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: OTA_LME_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end OTA_LME_RKU;
