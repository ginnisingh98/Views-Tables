--------------------------------------------------------
--  DDL for Package Body HXC_ULT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_ULT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_ult_ins.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Insert the row into: hxc_layouts_tl
  --
...
Begin
  ...
  --
  hxc_ult_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  hxc_ult_ins.pre_insert
    (p_rec                         => p_rec
  ...
  -- Insert the row
  --
  hxc_ult_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hxc_ult_ins.post_insert
     (p_rec
     );
  --
  if g_debug then
...
Procedure ins_tl
  ...
  ,p_layout_id                    in number
  ,p_display_layout_name          in varchar2 default null
  ) is
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where ult.layout_id = p_layout_id
                          and ult.language = l.language_code);
  --
  l_proc  varchar2(72)  ;
  --
Begin
