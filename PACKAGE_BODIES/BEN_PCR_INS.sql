--------------------------------------------------------
--  DDL for Package Body BEN_PCR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PCR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pcr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_per_cm_trgr_f.created_by%TYPE;
  l_creation_date       ben_per_cm_trgr_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_per_cm_trgr_f
  --
...
Begin
  ...
  --
  open c1;
  fetch c1 into p_rec.per_cm_trgr_id;
  close c1;
