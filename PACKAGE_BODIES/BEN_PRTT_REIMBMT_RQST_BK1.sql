--------------------------------------------------------
--  DDL for Package Body BEN_PRTT_REIMBMT_RQST_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PRTT_REIMBMT_RQST_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PRTT_REIMBMT_RQST_BK1.CREATE_PRTT_REIMBMT_RQST_A', 10);
hr_utility.set_location(' Leaving: BEN_PRTT_REIMBMT_RQST_BK1.CREATE_PRTT_REIMBMT_RQST_A', 20);
end CREATE_PRTT_REIMBMT_RQST_A;
...
begin
hr_utility.set_location('Entering: BEN_PRTT_REIMBMT_RQST_BK1.CREATE_PRTT_REIMBMT_RQST_B', 10);
hr_utility.set_location(' Leaving: BEN_PRTT_REIMBMT_RQST_BK1.CREATE_PRTT_REIMBMT_RQST_B', 20);
end CREATE_PRTT_REIMBMT_RQST_B;
