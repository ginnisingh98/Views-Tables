--------------------------------------------------------
--  DDL for Package Body JTF_FM_OCM_REND_REQ_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."JTF_FM_OCM_REND_REQ_W" as
  /* $Header: jtfgfmrwb.pls 120.1 2005/07/02 00:44:13 appldev noship $ */
  ...
  begin
    ...
    jtf_fm_ocm_rend_req.create_fulfillment_rendition(p_init_msg_list,
      p_api_version,
      p_commit,
