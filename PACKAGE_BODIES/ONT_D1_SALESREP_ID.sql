--------------------------------------------------------
--  DDL for Package Body ONT_D1_SALESREP_ID
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1_SALESREP_ID" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D1_SALESREP_ID
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1_SALESREP_ID';
...
BEGIN
    ...
    l_return_value := ONT_BLANKET_HEADER_Def_Util.g_cached_record.SALESREP_ID;
    END IF;
