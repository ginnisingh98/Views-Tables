--------------------------------------------------------
--  DDL for Package Body OTA_CRE_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CRE_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_cre_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Procedure update_dml
  (p_rec in out nocopy ota_cre_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  --
  -- Update the ota_cert_enrollments Row
  --
  update ota_cert_enrollments
    set
    ...
    ,certification_status_code       = p_rec.certification_status_code
    ,completion_date                 = p_rec.completion_date
    ,business_group_id               = p_rec.business_group_id
    ,unenrollment_date               = p_rec.unenrollment_date
    ,expiration_date                 = p_rec.expiration_date
    ,earliest_enroll_date            = p_rec.earliest_enroll_date
    ...
    ,enrollment_date                 = p_rec.enrollment_date
...
Begin
  ...
  begin
    ...
    ota_cre_rku.after_update
      ...
      ,p_certification_status_code
      => p_rec.certification_status_code
      ,p_completion_date
      => p_rec.completion_date
      ,p_business_group_id
      => p_rec.business_group_id
      ,p_unenrollment_date
      => p_rec.unenrollment_date
      ,p_expiration_date
      => p_rec.expiration_date
      ,p_earliest_enroll_date
      => p_rec.earliest_enroll_date
      ,p_is_history_flag
...
Begin
  ...
  If (p_rec.contact_id = hr_api.g_number) then
    ...
    ota_cre_shd.g_old_rec.contact_id;
  End If;
  If (p_rec.certification_status_code = hr_api.g_varchar2) then
    p_rec.certification_status_code :=
    ota_cre_shd.g_old_rec.certification_status_code;
  End If;
  ...
  If (p_rec.business_group_id = hr_api.g_number) then
    ...
    ota_cre_shd.g_old_rec.business_group_id;
  End If;
  If (p_rec.unenrollment_date = hr_api.g_date) then
    p_rec.unenrollment_date :=
    ota_cre_shd.g_old_rec.unenrollment_date;
  End If;
  If (p_rec.expiration_date = hr_api.g_date) then
    ...
    ota_cre_shd.g_old_rec.expiration_date;
  End If;
  If (p_rec.earliest_enroll_date = hr_api.g_date) then
    p_rec.earliest_enroll_date :=
    ota_cre_shd.g_old_rec.earliest_enroll_date;
  End If;
  ...
  If (p_rec.attribute20 = hr_api.g_varchar2) then
    ...
    ota_cre_shd.g_old_rec.attribute20;
  End If;
  If (p_rec.enrollment_date = hr_api.g_date) then
      p_rec.enrollment_date :=
      ota_cre_shd.g_old_rec.enrollment_date;
  End If;
  --
...
Begin
  ...
  --
  ota_cre_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_cre_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_cre_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
