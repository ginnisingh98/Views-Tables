--------------------------------------------------------
--  DDL for Package Body PQH_RMV_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_RMV_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_rmv_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_node_value_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_node_value_id  in  number) is
--
...
Begin
  ...
  --
  pqh_rmv_ins.g_node_value_id_i := p_node_value_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: pqh_rt_matrix_node_values
  --
...
--
  Cursor C_Sel1 is select pqh_rt_matrix_node_values_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from pqh_rt_matrix_node_values
     where node_value_id =
             pqh_rmv_ins.g_node_value_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (pqh_rmv_ins.g_node_value_id_i is not null) Then
    --
    ...
    p_rec.node_value_id :=
      pqh_rmv_ins.g_node_value_id_i;
    pqh_rmv_ins.g_node_value_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.node_value_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  pqh_rmv_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pqh_rmv_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pqh_rmv_ins.post_insert
     (p_rec
     );
  --
  -- Call to raise any errors on multi-message list
...
Begin
  ...
  --
  p_node_value_id := l_rec.node_value_id;
