--------------------------------------------------------
--  DDL for Package Body BEN_ELIG_BRGNG_UNIT_PRTE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIG_BRGNG_UNIT_PRTE_BK2" as
/* $Header: beebuapi.pkb 120.0 2005/05/28 01:47:52 generated noship $ */
...
begin
hr_utility.set_location('Entering: BEN_ELIG_BRGNG_UNIT_PRTE_BK2.UPDATE_ELIG_BRGNG_UNIT_PRTE_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_BRGNG_UNIT_PRTE_BK2.UPDATE_ELIG_BRGNG_UNIT_PRTE_A', 20);
end UPDATE_ELIG_BRGNG_UNIT_PRTE_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIG_BRGNG_UNIT_PRTE_BK2.UPDATE_ELIG_BRGNG_UNIT_PRTE_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIG_BRGNG_UNIT_PRTE_BK2.UPDATE_ELIG_BRGNG_UNIT_PRTE_B', 20);
end UPDATE_ELIG_BRGNG_UNIT_PRTE_B;
