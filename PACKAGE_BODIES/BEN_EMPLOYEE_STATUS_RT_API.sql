--------------------------------------------------------
--  DDL for Package Body BEN_EMPLOYEE_STATUS_RT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EMPLOYEE_STATUS_RT_API" as
/* $Header: beesrapi.pkb 120.0 2005/05/28 02:57:58 appldev noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_EMPLOYEE_STATUS_RT_api.';
--
-- ----------------------------------------------------------------------------
...
procedure create_EMPLOYEE_STATUS_RT
  ...
  --
  l_ee_stat_rt_id ben_ee_stat_rt_f.ee_stat_rt_id%TYPE;
  l_effective_start_date ben_ee_stat_rt_f.effective_start_date%TYPE;
  l_effective_end_date ben_ee_stat_rt_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_EMPLOYEE_STATUS_RT';
  l_object_version_number ben_ee_stat_rt_f.object_version_number%TYPE;
  --
begin
  --
  ...
  --
  savepoint create_EMPLOYEE_STATUS_RT;
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_EMPLOYEE_STATUS_RT
    --
    ben_EMPLOYEE_STATUS_RT_bk1.create_EMPLOYEE_STATUS_RT_b
      (
      ...
      ,p_esr_attribute_category         =>  p_esr_attribute_category
      ,p_esr_attribute1                 =>  p_esr_attribute1
      ,p_esr_attribute2                 =>  p_esr_attribute2
      ,p_esr_attribute3                 =>  p_esr_attribute3
      ,p_esr_attribute4                 =>  p_esr_attribute4
      ,p_esr_attribute5                 =>  p_esr_attribute5
      ,p_esr_attribute6                 =>  p_esr_attribute6
      ,p_esr_attribute7                 =>  p_esr_attribute7
      ,p_esr_attribute8                 =>  p_esr_attribute8
      ,p_esr_attribute9                 =>  p_esr_attribute9
      ,p_esr_attribute10                =>  p_esr_attribute10
      ,p_esr_attribute11                =>  p_esr_attribute11
      ,p_esr_attribute12                =>  p_esr_attribute12
      ,p_esr_attribute13                =>  p_esr_attribute13
      ,p_esr_attribute14                =>  p_esr_attribute14
      ,p_esr_attribute15                =>  p_esr_attribute15
      ,p_esr_attribute16                =>  p_esr_attribute16
      ,p_esr_attribute17                =>  p_esr_attribute17
      ,p_esr_attribute18                =>  p_esr_attribute18
      ,p_esr_attribute19                =>  p_esr_attribute19
      ,p_esr_attribute20                =>  p_esr_attribute20
      ,p_esr_attribute21                =>  p_esr_attribute21
      ,p_esr_attribute22                =>  p_esr_attribute22
      ,p_esr_attribute23                =>  p_esr_attribute23
      ,p_esr_attribute24                =>  p_esr_attribute24
      ,p_esr_attribute25                =>  p_esr_attribute25
      ,p_esr_attribute26                =>  p_esr_attribute26
      ,p_esr_attribute27                =>  p_esr_attribute27
      ,p_esr_attribute28                =>  p_esr_attribute28
      ,p_esr_attribute29                =>  p_esr_attribute29
      ,p_esr_attribute30                =>  p_esr_attribute30
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_EMPLOYEE_STATUS_RT'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_EMPLOYEE_STATUS_RT
    --
  end;
  --
  ben_esr_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_EMPLOYEE_STATUS_RT
    --
    ben_EMPLOYEE_STATUS_RT_bk1.create_EMPLOYEE_STATUS_RT_a
      (
       p_ee_stat_rt_id                  =>  l_ee_stat_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_EMPLOYEE_STATUS_RT
    --
  end;
  --
  ben_profile_handler.event_handler
    (p_event                       => 'CREATE',
     ...
     p_base_table_reference_column => 'RT_EE_STAT_FLAG',
     p_reference_table             => 'BEN_EE_STAT_RT_F',
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_EMPLOYEE_STATUS_RT;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
    --
    p_ee_stat_rt_id := null;
...
procedure update_EMPLOYEE_STATUS_RT
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_EMPLOYEE_STATUS_RT';
  l_object_version_number ben_ee_stat_rt_f.object_version_number%TYPE;
  l_effective_start_date ben_ee_stat_rt_f.effective_start_date%TYPE;
  l_effective_end_date ben_ee_stat_rt_f.effective_end_date%TYPE;
  --
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_EMPLOYEE_STATUS_RT;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_EMPLOYEE_STATUS_RT
    --
    ben_EMPLOYEE_STATUS_RT_bk2.update_EMPLOYEE_STATUS_RT_b
      (
       p_ee_stat_rt_id                  =>  p_ee_stat_rt_id
      ,p_vrbl_rt_prfl_id                =>  p_vrbl_rt_prfl_id
      ,p_assignment_status_type_id      =>  p_assignment_status_type_id
      ,p_excld_flag                     =>  p_excld_flag
      ,p_ordr_num                       =>  p_ordr_num
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_EMPLOYEE_STATUS_RT'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_EMPLOYEE_STATUS_RT
    --
  end;
  --
  ben_esr_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_EMPLOYEE_STATUS_RT
    --
    ben_EMPLOYEE_STATUS_RT_bk2.update_EMPLOYEE_STATUS_RT_a
      (
       p_ee_stat_rt_id                  =>  p_ee_stat_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_EMPLOYEE_STATUS_RT
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO update_EMPLOYEE_STATUS_RT;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint delete_EMPLOYEE_STATUS_RT;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_EMPLOYEE_STATUS_RT
    --
    ben_EMPLOYEE_STATUS_RT_bk3.delete_EMPLOYEE_STATUS_RT_b
      (
       p_ee_stat_rt_id                  =>  p_ee_stat_rt_id
      ,p_object_version_number          =>  p_object_version_number
    ,p_effective_date                      => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_EMPLOYEE_STATUS_RT'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_EMPLOYEE_STATUS_RT
    --
  end;
  --
  ben_esr_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_EMPLOYEE_STATUS_RT
    --
    ben_EMPLOYEE_STATUS_RT_bk3.delete_EMPLOYEE_STATUS_RT_a
      (
       p_ee_stat_rt_id                  =>  p_ee_stat_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_EMPLOYEE_STATUS_RT
    --
  end;
  --
  ben_profile_handler.event_handler
    (p_event                       => 'DELETE',
     p_base_table                  => 'BEN_VRBL_RT_PRFL_F',
     p_base_table_column           => 'VRBL_RT_PRFL_ID',
     p_base_table_column_value     => ben_esr_shd.g_old_rec.vrbl_rt_prfl_id,
     p_base_table_reference_column => 'RT_EE_STAT_FLAG',
     p_reference_table             => 'BEN_EE_STAT_RT_F',
     p_reference_table_column      => 'VRBL_RT_PRFL_ID');
  --
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO delete_EMPLOYEE_STATUS_RT;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
