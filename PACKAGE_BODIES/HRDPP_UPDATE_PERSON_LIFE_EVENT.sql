--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_PERSON_LIFE_EVENT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_PERSON_LIFE_EVENT" as
/*
...
,P_MGR_OVRID_PERSON_USER_KEY in varchar2 default null) is
...
,P_PRVS_STAT_CD
,dd(P_LF_EVT_OCRD_DT,I_LF_EVT_OCRD_DT)
,dd(P_BCKT_DT,I_BCKT_DT)
,dd(P_CLSD_DT,I_CLSD_DT)
,dd(P_NTFN_DT,I_NTFN_DT)
,dd(P_MGR_OVRID_DT,I_MGR_OVRID_DT)
...
,P_BCKT_PER_IN_LER_USER_KEY
,P_LIFE_EVENT_REASON
,P_PERSON_USER_KEY
,P_ASSIGNMENT_USER_KEY
,P_WS_MGR_USER_KEY
,P_GROUP_PL_USER_KEY
,P_MGR_OVRID_PERSON_USER_KEY);
...
decode(l.pval001,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval001,'BEN_PER_IN_LER_STAT',d(l.pval043),vn)) p1,
l.pval001 d1,
decode(l.pval002,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval002,'BEN_PER_IN_LER_STAT',d(l.pval043),vn)) p2,
l.pval002 d2,
...
(P_PER_IN_LER_USER_KEY => c.p44);
end if;
--
if c.d45=cn then
L_TRGR_TABLE_PK_ID:=nn;
elsif c.d45 is null then 
L_TRGR_TABLE_PK_ID:=nh;
else
L_TRGR_TABLE_PK_ID := 
hr_pump_get.get_trgr_table_pk_id
(P_TRGR_TABLE_PK_USER_KEY => c.p45);
end if;
--
if c.d46=cn then
L_PTNL_LER_FOR_PER_ID:=nn;
elsif c.d46 is null then 
L_PTNL_LER_FOR_PER_ID:=nh;
else
L_PTNL_LER_FOR_PER_ID := 
hr_pump_get.get_ptnl_ler_for_per_id
(P_PTNL_LER_FOR_PER_USER_KEY => c.p46);
end if;
--
if c.d47=cn then
L_BCKT_PER_IN_LER_ID:=nn;
elsif c.d47 is null then 
L_BCKT_PER_IN_LER_ID:=nh;
else
L_BCKT_PER_IN_LER_ID := 
hr_pump_get.get_bckt_per_in_ler_id
(P_BCKT_PER_IN_LER_USER_KEY => c.p47);
end if;
--
if c.d48=cn or
c.p43 is null then
L_LER_ID:=nn;
elsif c.d48 is null then 
L_LER_ID:=nh;
else
L_LER_ID := 
hr_pump_get.get_ler_id
(P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_LIFE_EVENT_REASON => c.p48
...
L_WS_MGR_ID := 
hr_pump_get.get_ws_mgr_id
(P_WS_MGR_USER_KEY => c.p51);
end if;
--
if c.d52=cn then
L_GROUP_PL_ID:=nn;
...
L_GROUP_PL_ID := 
hr_pump_get.get_group_pl_id
(P_GROUP_PL_USER_KEY => c.p52);
end if;
--
if c.d53=cn then
L_MGR_OVRID_PERSON_ID:=nn;
elsif c.d53 is null then 
L_MGR_OVRID_PERSON_ID:=nh;
else
L_MGR_OVRID_PERSON_ID := 
hr_pump_get.get_mgr_ovrid_person_id
(P_MGR_OVRID_PERSON_USER_KEY => c.p53);
end if;
--
L_REQUEST_ID := 
...
hr_pump_get.GET_PER_IN_LER_OVN
(P_PER_IN_LER_USER_KEY => c.p44);
end if;
--
...
,P_PER_IN_LER_STAT_CD => c.p1
,P_PRVS_STAT_CD => c.p2
,P_LF_EVT_OCRD_DT => c.p3
...
,P_BCKT_PER_IN_LER_ID => L_BCKT_PER_IN_LER_ID
,P_LER_ID => L_LER_ID
...
,P_MGR_OVRID_PERSON_ID => L_MGR_OVRID_PERSON_ID
,P_MGR_OVRID_DT => c.p10
,P_PIL_ATTRIBUTE_CATEGORY => c.p11
,P_PIL_ATTRIBUTE1 => c.p12
,P_PIL_ATTRIBUTE2 => c.p13
,P_PIL_ATTRIBUTE3 => c.p14
,P_PIL_ATTRIBUTE4 => c.p15
,P_PIL_ATTRIBUTE5 => c.p16
,P_PIL_ATTRIBUTE6 => c.p17
,P_PIL_ATTRIBUTE7 => c.p18
,P_PIL_ATTRIBUTE8 => c.p19
,P_PIL_ATTRIBUTE9 => c.p20
,P_PIL_ATTRIBUTE10 => c.p21
,P_PIL_ATTRIBUTE11 => c.p22
,P_PIL_ATTRIBUTE12 => c.p23
,P_PIL_ATTRIBUTE13 => c.p24
,P_PIL_ATTRIBUTE14 => c.p25
,P_PIL_ATTRIBUTE15 => c.p26
,P_PIL_ATTRIBUTE16 => c.p27
,P_PIL_ATTRIBUTE17 => c.p28
,P_PIL_ATTRIBUTE18 => c.p29
,P_PIL_ATTRIBUTE19 => c.p30
,P_PIL_ATTRIBUTE20 => c.p31
,P_PIL_ATTRIBUTE21 => c.p32
,P_PIL_ATTRIBUTE22 => c.p33
,P_PIL_ATTRIBUTE23 => c.p34
,P_PIL_ATTRIBUTE24 => c.p35
,P_PIL_ATTRIBUTE25 => c.p36
,P_PIL_ATTRIBUTE26 => c.p37
,P_PIL_ATTRIBUTE27 => c.p38
,P_PIL_ATTRIBUTE28 => c.p39
,P_PIL_ATTRIBUTE29 => c.p40
,P_PIL_ATTRIBUTE30 => c.p41
,P_REQUEST_ID => L_REQUEST_ID
,P_PROGRAM_APPLICATION_ID => L_PROGRAM_APPLICATION_ID
,P_PROGRAM_ID => L_PROGRAM_ID
,P_PROGRAM_UPDATE_DATE => c.p42
