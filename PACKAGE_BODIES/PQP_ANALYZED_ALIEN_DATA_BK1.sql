--------------------------------------------------------
--  DDL for Package Body PQP_ANALYZED_ALIEN_DATA_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_ANALYZED_ALIEN_DATA_BK1" as
...
begin
hr_utility.set_location('Entering: PQP_ANALYZED_ALIEN_DATA_BK1.CREATE_ANALYZED_ALIEN_DATA_A', 10);
hr_utility.set_location(' Leaving: PQP_ANALYZED_ALIEN_DATA_BK1.CREATE_ANALYZED_ALIEN_DATA_A', 20);
end CREATE_ANALYZED_ALIEN_DATA_A;
...
begin
hr_utility.set_location('Entering: PQP_ANALYZED_ALIEN_DATA_BK1.CREATE_ANALYZED_ALIEN_DATA_B', 10);
hr_utility.set_location(' Leaving: PQP_ANALYZED_ALIEN_DATA_BK1.CREATE_ANALYZED_ALIEN_DATA_B', 20);
end CREATE_ANALYZED_ALIEN_DATA_B;
