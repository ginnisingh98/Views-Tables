--------------------------------------------------------
--  DDL for Package Body PO_PO_VARIANCE_ACCOUNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PO_PO_VARIANCE_ACCOUNT" AS
/* $Header: POXWFB3B.pls 115.4 2002/11/25 21:50:57 sbull ship $*/
...
BEGIN
  ...
  FND_MESSAGE.SET_TOKEN('FUNC', 'PO_PO_VARIANCE_ACCOUNT');
