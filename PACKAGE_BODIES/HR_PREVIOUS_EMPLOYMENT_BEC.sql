--------------------------------------------------------
--  DDL for Package Body HR_PREVIOUS_EMPLOYMENT_BEC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PREVIOUS_EMPLOYMENT_BEC" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  hr_previous_employment_beC.delete_prev_job_extra_info_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.previous_employment.delete_prev_job_extra_info';
...
end delete_prev_job_extra_info_a;
end hr_previous_employment_beC;
