--------------------------------------------------------
--  DDL for Package Body IGS_OR_UNIT_ACCTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_OR_UNIT_ACCTS_PKG" AS
/* $Header: IGSOI32B.pls 115.4 2002/11/29 01:44:53 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_or_unit_accts_all%ROWTYPE;
  new_references igs_or_unit_accts_all%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.org_account_id                    := x_org_account_id;
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_or_unit_accts_all
      WHERE    org_account_id = x_org_account_id
      FOR UPDATE NOWAIT;
  ...
  */
  ...
  BEGIN
    ...
    SELECT    igs_or_unit_accts_s.NEXTVAL
    INTO      x_org_account_id
    FROM      dual;
    ...
    before_dml(
      p_action                            => 'INSERT',
      x_rowid                             => x_rowid,
      x_org_account_id                    => x_org_account_id,
    ...
    INSERT INTO igs_or_unit_accts_all (
      org_account_id,
      org_unit_cd,
      start_dt,
      segment,
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_or_unit_accts_all
    WHERE rowid = x_rowid;
