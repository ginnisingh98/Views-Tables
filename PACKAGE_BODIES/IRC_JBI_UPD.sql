--------------------------------------------------------
--  DDL for Package Body IRC_JBI_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_JBI_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  irc_jbi_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Update the irc_job_basket_items Row
  --
...
Begin
  ...
  begin
    --
    irc_jbi_rku.after_update(p_effective_date => p_effective_date
...
Begin
  ...
  --
  irc_jbi_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  irc_jbi_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  irc_jbi_upd.post_update
     (p_effective_date
     ,p_rec
     );
End upd;
...
Begin
  ...
  --
  l_rec :=
  irc_jbi_shd.convert_args(p_job_basket_item_id
  ,p_party_id
  ,null
  ,p_recruitment_activity_id
  ,p_object_version_number
