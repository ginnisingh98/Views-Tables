--------------------------------------------------------
--  DDL for Package Body BEN_RGR_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_RGR_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_rgr_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    select t.created_by,
           t.creation_date
    from   ben_popl_rptg_grp_f t
    where  t.popl_rptg_grp_id       = p_rec.popl_rptg_grp_id
    and    t.effective_start_date =
             ben_rgr_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_popl_rptg_grp_f.created_by%TYPE;
  l_creation_date       ben_popl_rptg_grp_f.creation_date%TYPE;
  l_last_update_date   	ben_popl_rptg_grp_f.last_update_date%TYPE;
  l_last_updated_by     ben_popl_rptg_grp_f.last_updated_by%TYPE;
  l_last_update_login   ben_popl_rptg_grp_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_popl_rptg_grp_f
  --
  insert into ben_popl_rptg_grp_f
  (	popl_rptg_grp_id,
...
--
  Cursor C_Sel1 is select ben_popl_rptg_grp_f_s.nextval from sys.dual;
--
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.popl_rptg_grp_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_rgr_rec
  ...
  --
  p_popl_rptg_grp_id        	:= l_rec.popl_rptg_grp_id;
