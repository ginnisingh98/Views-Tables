--------------------------------------------------------
--  DDL for Package Body BEN_DEC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DEC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_dec_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    select t.created_by,
           t.creation_date
    from   ben_dsgntr_enrld_cvg_f t
    where  t.dsgntr_enrld_cvg_id       = p_rec.dsgntr_enrld_cvg_id
    and    t.effective_start_date =
             ben_dec_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_dsgntr_enrld_cvg_f.created_by%TYPE;
  l_creation_date       ben_dsgntr_enrld_cvg_f.creation_date%TYPE;
  l_last_update_date   	ben_dsgntr_enrld_cvg_f.last_update_date%TYPE;
  l_last_updated_by     ben_dsgntr_enrld_cvg_f.last_updated_by%TYPE;
  l_last_update_login   ben_dsgntr_enrld_cvg_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_dsgntr_enrld_cvg_f
  --
  insert into ben_dsgntr_enrld_cvg_f
  (	dsgntr_enrld_cvg_id,
...
Begin
  ...
  --
  --
  select ben_dsgntr_enrld_cvg_f_s.nextval
    into p_rec.dsgntr_enrld_cvg_id from sys.dual;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Procedure ins
  ...
  p_dsgntr_crntly_enrld_flag     in varchar2         default null,
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_dec_rec
  ...
  --
  p_dsgntr_enrld_cvg_id        	:= l_rec.dsgntr_enrld_cvg_id;
