--------------------------------------------------------
--  DDL for Package Body BEN_BENERTYP_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENERTYP_XMLP_PKG" AS
/* $Header: BENERTYPB.pls 120.1 2007/12/10 08:33:16 vjaganat noship $ */
