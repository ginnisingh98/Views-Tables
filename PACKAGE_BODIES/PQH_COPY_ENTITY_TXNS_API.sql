--------------------------------------------------------
--  DDL for Package Body PQH_COPY_ENTITY_TXNS_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_COPY_ENTITY_TXNS_API" as
/* $Header: pqcetapi.pkb 115.5 2002/12/05 19:31:27 rpasapul ship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  PQH_COPY_ENTITY_TXN_APIS.';
--
-- ----------------------------------------------------------------------------
...
begin
  ...
  begin
    ...
    --
    PQH_COPY_ENTITY_TXNS_bk1.create_COPY_ENTITY_TXN_b
      (
  ...
  begin
    ...
    --
    PQH_COPY_ENTITY_TXNS_bk1.create_COPY_ENTITY_TXN_a
      (
       p_copy_entity_txn_id             =>  l_copy_entity_txn_id
      ,p_transaction_category_id        =>  p_transaction_category_id
      ,p_txn_category_attribute_id      =>  p_txn_category_attribute_id
