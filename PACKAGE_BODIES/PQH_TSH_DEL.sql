--------------------------------------------------------
--  DDL for Package Body PQH_TSH_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_TSH_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_tsh_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the pqh_ss_trans_state_history row.
  --
  delete from pqh_ss_trans_state_history
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pqh_tsh_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in pqh_tsh_shd.g_rec_type) is
--
...
Begin
  ...
  --
  pqh_tsh_bus.delete_validate(p_rec);
  --
  ...
  --
  pqh_tsh_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  pqh_tsh_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  pqh_tsh_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
