--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_CBR_PER_IN_LER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_CBR_PER_IN_LER" as
/*
...
,P_CBR_PER_IN_LER_USER_KEY in varchar2) is
...
(P_CBR_PER_IN_LER_USER_KEY => c.p2);
end if;
--
if c.p2 is null then
