--------------------------------------------------------
--  DDL for Package Body HR_AE_APPLICANT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_AE_APPLICANT_API" as
/* $Header: peappaei.pkb 120.3.12000000.1 2007/01/21 19:58:57 appldev ship $ */

--
g_package  VARCHAR2(33) := 'hr_ae_applicant_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_ae_applicant >------------------------------|
-- -----------------------------------------------------------------------------
PROCEDURE create_ae_applicant
  ...
  --
  l_proc                 VARCHAR2(72) := g_package||'create_ae_applicant';
...
end create_ae_applicant;
--
end hr_ae_applicant_api;
