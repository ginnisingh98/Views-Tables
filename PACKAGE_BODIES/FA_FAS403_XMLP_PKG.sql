--------------------------------------------------------
--  DDL for Package Body FA_FAS403_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FAS403_XMLP_PKG" AS
/* $Header: FAS403B.pls 120.0.12010000.1 2008/07/28 13:14:15 appldev ship $ */
...
BEGIN
  SELECT period_name,
         ...
         decode(period_close_date, null,  decode(deprn_run,null,'NO','YES'),
				         'YES'),
         fiscal_year
  INTO   l_period_name,
         l_period_PC,
...
EXCEPTION
  WHEN OTHERS THEN
    RP_Report_Name := ':Account Reconciliation Reserve Ledger:';
...
RETURN NULL; end;
function d_cost_centerformula(Acct_CC_LPrompt in varchar2, Cost_Center in varchar2) return varchar2 is
begin
/*srw.reference(Cost_Center);*/null;
return(Acct_CC_LPrompt||': '||Cost_Center);
end;
...
--Functions to refer Oracle report placeholders--
 ...
 Function Period1_FY_p return number is
	Begin
	 return Period1_FY;
	 END;
 Function Period_Closed_p return varchar2 is
	Begin
 ...
 Function C_Bal_LPrompt_p return varchar2 is
	Begin
	 ...
	 END;
 Function C_Co_Value_p return varchar2 is
	Begin
	 return C_Co_Value;
	 END;
 Function C_CC_LPrompt_p return varchar2 is
	Begin
	 return C_CC_LPrompt;
	 END;
 Function C_CC_APrompt_p return varchar2 is
	Begin
	 return C_CC_APrompt;
	 END;
 Function C_Closed_p return varchar2 is
	Begin
	 return C_Closed;
	 END;
...
/*PROCEDURE VERSION IS
  ...
  BEGIN
     FDRCSID := '$Header: FAS403B.pls 120.0.12010000.1 2008/07/28 13:14:15 appldev ship $';
  END VERSION;*/
procedure FA_RSVLDG
       (book            in  varchar2,
        period          in  varchar2,
