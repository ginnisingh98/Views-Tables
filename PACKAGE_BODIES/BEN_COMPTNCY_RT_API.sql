--------------------------------------------------------
--  DDL for Package Body BEN_COMPTNCY_RT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_COMPTNCY_RT_API" as
/* $Header: bectyapi.pkb 115.1 2002/12/16 17:35:48 glingapp noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_comptncy_rt_api.';
--
-- ----------------------------------------------------------------------------
-- |------------------------< create_comptncy_rt >----------------------|
-- ----------------------------------------------------------------------------
...
procedure create_comptncy_rt
  ...
  --
  l_comptncy_rt_id        ben_comptncy_rt_f.comptncy_rt_id%TYPE;
  l_effective_start_date  ben_comptncy_rt_f.effective_start_date%TYPE;
  l_effective_end_date    ben_comptncy_rt_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_comptncy_rt';
  l_object_version_number ben_comptncy_rt_f.object_version_number%TYPE;
  --
begin
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_comptncy_rt
    --
    ben_comptncy_rt_bk1.create_comptncy_rt_b
      (
      ...
      ,p_cty_attribute_category         =>  p_cty_attribute_category
      ,p_cty_attribute1                 =>  p_cty_attribute1
      ,p_cty_attribute2                 =>  p_cty_attribute2
      ,p_cty_attribute3                 =>  p_cty_attribute3
      ,p_cty_attribute4                 =>  p_cty_attribute4
      ,p_cty_attribute5                 =>  p_cty_attribute5
      ,p_cty_attribute6                 =>  p_cty_attribute6
      ,p_cty_attribute7                 =>  p_cty_attribute7
      ,p_cty_attribute8                 =>  p_cty_attribute8
      ,p_cty_attribute9                 =>  p_cty_attribute9
      ,p_cty_attribute10                =>  p_cty_attribute10
      ,p_cty_attribute11                =>  p_cty_attribute11
      ,p_cty_attribute12                =>  p_cty_attribute12
      ,p_cty_attribute13                =>  p_cty_attribute13
      ,p_cty_attribute14                =>  p_cty_attribute14
      ,p_cty_attribute15                =>  p_cty_attribute15
      ,p_cty_attribute16                =>  p_cty_attribute16
      ,p_cty_attribute17                =>  p_cty_attribute17
      ,p_cty_attribute18                =>  p_cty_attribute18
      ,p_cty_attribute19                =>  p_cty_attribute19
      ,p_cty_attribute20                =>  p_cty_attribute20
      ,p_cty_attribute21                =>  p_cty_attribute21
      ,p_cty_attribute22                =>  p_cty_attribute22
      ,p_cty_attribute23                =>  p_cty_attribute23
      ,p_cty_attribute24                =>  p_cty_attribute24
      ,p_cty_attribute25                =>  p_cty_attribute25
      ,p_cty_attribute26                =>  p_cty_attribute26
      ,p_cty_attribute27                =>  p_cty_attribute27
      ,p_cty_attribute28                =>  p_cty_attribute28
      ,p_cty_attribute29                =>  p_cty_attribute29
      ,p_cty_attribute30                =>  p_cty_attribute30
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_COMPTNCY_RT'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_comptncy_rt
    --
  end;
  --
  ben_cty_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_comptncy_rt
    --
    ben_comptncy_rt_bk1.create_comptncy_rt_a
      (
       p_comptncy_rt_id                 =>  l_comptncy_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_comptncy_rt
    --
  end;
  --
  ...
  ben_profile_handler.event_handler
    (p_event                       => 'CREATE',
     ...
     p_base_table_reference_column => 'RT_COMPTNCY_FLAG',
     p_reference_table             => 'BEN_COMPTNCY_RT_F',
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_comptncy_rt;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
    --
    p_comptncy_rt_id := null;
...
procedure update_comptncy_rt
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_comptncy_rt';
  l_object_version_number   ben_comptncy_rt_f.object_version_number%TYPE;
  l_effective_start_date    ben_comptncy_rt_f.effective_start_date%TYPE;
  l_effective_end_date      ben_comptncy_rt_f.effective_end_date%TYPE;
  --
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_comptncy_rt
    --
    ben_comptncy_rt_bk2.update_comptncy_rt_b
      (
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_COMPTNCY_RT'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_comptncy_rt
    --
  end;
  --
  ben_cty_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_comptncy_rt
    --
    ben_comptncy_rt_bk2.update_comptncy_rt_a
      (
       p_comptncy_rt_id                 =>  p_comptncy_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_comptncy_rt
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO update_comptncy_rt;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
...
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_comptncy_rt
    --
    ben_comptncy_rt_bk3.delete_comptncy_rt_b
      (
       p_comptncy_rt_id               =>  p_comptncy_rt_id
      ,p_object_version_number   =>  p_object_version_number
      ,p_effective_date          => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_COMPTNCY_RT'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_comptncy_rt
    --
  end;
  --
  ben_cty_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_comptncy_rt
    --
    ben_comptncy_rt_bk3.delete_comptncy_rt_a
      (
       p_comptncy_rt_id                      =>  p_comptncy_rt_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_comptncy_rt
    --
  end;
  --
  ...
  ben_profile_handler.event_handler
    (p_event                       => 'DELETE',
     p_base_table                  => 'BEN_VRBL_RT_PRFL_F',
     p_base_table_column           => 'VRBL_RT_PRFL_ID',
     p_base_table_column_value     =>  ben_cty_shd.g_old_rec.vrbl_rt_prfl_id,
     p_base_table_reference_column => 'RT_COMPTNCY_FLAG',
     p_reference_table             => 'BEN_COMPTNCY_RT_F',
     p_reference_table_column      => 'VRBL_RT_PRFL_ID');
  --
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO delete_comptncy_rt;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
