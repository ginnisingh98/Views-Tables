--------------------------------------------------------
--  DDL for Package Body HR_PAY_SCALE_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_PAY_SCALE_SWI" As
-- $Header: peppsswi.pkb 115.0 2003/12/17 04:36 lsilveir noship $
--
-- Package variables
--
g_package  varchar2(33) := 'hr_pay_scale_swi.';
--
-- ----------------------------------------------------------------------------
-- |---------------------------< create_pay_scale >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_pay_scale_swi;
  --
  ...
  --
  per_pps_ins.set_base_key_value
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_pay_scale_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_pay_scale_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_pay_scale_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_pay_scale_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_pay_scale_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
