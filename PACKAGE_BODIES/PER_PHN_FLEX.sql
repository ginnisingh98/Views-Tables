--------------------------------------------------------
--  DDL for Package Body PER_PHN_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PHN_FLEX" as
/* $Header: pephnfli.pkb 115.0 99/07/18 14:18:02 porting ship $ */
--
-- ----------------------------------------------------------------------------
-- |                     Private Global Definitions                           |
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_phn_flex.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |--------------------------< val_phn_type >------------------------------|
-- ----------------------------------------------------------------------------
...
--
--  Post Success:
--    Processing of per_phn_flex continues.
--
--  Post failure:
...
--  {End of Comments}
-- ----------------------------------------------------------------------------
Procedure val_phn_type
             (p_rec   in per_phn_shd.g_rec_type) is
--
  l_proc    varchar2(72) := g_package||'val_phn_type';
--
begin
