--------------------------------------------------------
--  DDL for Package Body BEN_ECV_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ECV_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_ecv_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_sel1 is
    ...
    where  t.eligy_crit_values_id = p_rec.eligy_crit_values_id
    and    t.effective_start_date = ben_ecv_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_eligy_crit_values_f.created_by%TYPE;
  l_creation_date       ben_eligy_crit_values_f.creation_date%TYPE;
  l_last_update_date   	ben_eligy_crit_values_f.last_update_date%TYPE;
  l_last_updated_by     ben_eligy_crit_values_f.last_updated_by%TYPE;
  l_last_update_login   ben_eligy_crit_values_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into ben_eligy_crit_values_f
  --
  Insert into ben_eligy_crit_values_f
  (
  ...
  p_rec.ecv_attribute_category,
  p_rec.ecv_attribute1,
  p_rec.ecv_attribute2,
  p_rec.ecv_attribute3,
  p_rec.ecv_attribute4,
  p_rec.ecv_attribute5,
  p_rec.ecv_attribute6,
  p_rec.ecv_attribute7,
  p_rec.ecv_attribute8,
  p_rec.ecv_attribute9,
  p_rec.ecv_attribute10,
  p_rec.ecv_attribute11,
  p_rec.ecv_attribute12,
  p_rec.ecv_attribute13,
  p_rec.ecv_attribute14,
  p_rec.ecv_attribute15,
  p_rec.ecv_attribute16,
  p_rec.ecv_attribute17,
  p_rec.ecv_attribute18,
  p_rec.ecv_attribute19,
  p_rec.ecv_attribute20,
  p_rec.ecv_attribute21,
  p_rec.ecv_attribute22,
  p_rec.ecv_attribute23,
  p_rec.ecv_attribute24,
  p_rec.ecv_attribute25,
  p_rec.ecv_attribute26,
  p_rec.ecv_attribute27,
  p_rec.ecv_attribute28,
  p_rec.ecv_attribute29,
  p_rec.ecv_attribute30,
  p_rec.object_version_number,
  l_created_by,
  l_creation_date,
  l_last_update_date,
...
--
  Cursor C_Sel1 is select ben_eligy_crit_values_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.eligy_crit_values_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
--	 p_parent_key_value1       => p_rec.eligy_criteria_id,
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_ecv_rec
  ...
  --
  p_eligy_crit_values_id    := l_rec.eligy_crit_values_id;
