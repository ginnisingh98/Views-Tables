--------------------------------------------------------
--  DDL for Package Body OKL_RELOCATE_ASSETS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_RELOCATE_ASSETS_PUB_W" as
  /* $Header: OKLURASB.pls 115.3 2002/12/19 23:32:29 gkadarka noship $ */
  ...
  procedure insert_relocate_assets(p_api_version  NUMBER
  ...
  as
    ddp_rasv_tbl okl_relocate_assets_pub.rasv_tbl_type;
    ddx_rasv_tbl okl_relocate_assets_pub.rasv_tbl_type;
  ...
  begin
    ...
    okl_relocate_assets_pub.insert_relocate_assets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_rasv_rec okl_relocate_assets_pub.rasv_rec_type;
    ddx_rasv_rec okl_relocate_assets_pub.rasv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_relocate_assets(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_relocate_assets_pub.lock_relocate_assets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_relocate_assets(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_relocate_assets_pub.update_relocate_assets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_relocate_assets(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_relocate_assets_pub.delete_relocate_assets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_relocate_assets(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_relocate_assets_pub.validate_relocate_assets(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
