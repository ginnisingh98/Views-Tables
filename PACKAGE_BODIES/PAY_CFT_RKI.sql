--------------------------------------------------------
--  DDL for Package Body PAY_CFT_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_CFT_RKI" as
...
begin
hr_utility.set_location('Entering: PAY_CFT_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: PAY_CFT_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end PAY_CFT_RKI;
