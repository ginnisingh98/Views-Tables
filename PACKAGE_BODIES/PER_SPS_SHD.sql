--------------------------------------------------------
--  DDL for Package Body PER_SPS_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_SPS_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_sps_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PER_SPINAL_POINT_STEPS_F_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PER_SPINAL_POINT_STEPS_F_FK2') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','10');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PER_SPINAL_POINT_STEPS_F_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  Else
    If (p_step_id =
        per_sps_shd.g_old_rec.step_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_sps_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_sps_shd.g_old_rec.object_version_number) Then
...
Procedure find_dt_del_modes
  ...
  Cursor C_Sel1 Is
    select
     t.grade_spine_id
    from   per_spinal_point_steps_f t
    where  t.step_id = p_base_key_value
    and    p_effective_date
...
--
  ...
  --
  update  per_spinal_point_steps_f t
...
Begin
  ...
  If (p_datetrack_mode <> hr_api.g_insert) then
    ...
    dt_api.validate_dt_mode
      ...
      ,p_parent_table_name1      => 'per_grade_spines_f'
      ,p_parent_key_column1      => 'grade_spine_id'
      ,p_parent_key_value1       => per_sps_shd.g_old_rec.grade_spine_id
      ,p_child_table_name1       => 'per_cagr_entitlement_lines_f'
      ,p_child_key_column1       => 'cagr_entitlement_line_id'
      ,p_child_table_name2       => 'hr_all_positions_f'
      ,p_child_key_column2       => 'position_id'
      ,p_child_alt_base_key_column2 => 'entry_step_id'
      ,p_child_table_name3       => 'per_all_assignments_f'
      ,p_child_key_column3       => 'assignment_id'
      ,p_child_alt_base_key_column3 => 'special_ceiling_step_id'
...
Exception
  When HR_Api.Object_Locked then
    ...
    fnd_message.set_token('TABLE_NAME', 'per_spinal_point_steps_f');
    fnd_message.raise_error;
End lck;
--
-- ----------------------------------------------------------------------------
