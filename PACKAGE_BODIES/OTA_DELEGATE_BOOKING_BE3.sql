--------------------------------------------------------
--  DDL for Package Body OTA_DELEGATE_BOOKING_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_DELEGATE_BOOKING_BE3" as 
...
p_person_id                    number) is
  ...
  --
  l_proc varchar2(72):='  ota_delegate_booking_be3.delete_delegate_booking_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.ota.api.delegate_booking.delete_delegate_booking';
