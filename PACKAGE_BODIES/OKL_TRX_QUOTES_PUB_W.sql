--------------------------------------------------------
--  DDL for Package Body OKL_TRX_QUOTES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TRX_QUOTES_PUB_W" as
  /* $Header: OKLUQTEB.pls 120.2 2007/11/02 21:03:05 rmunjulu ship $ */
  ...
  procedure insert_trx_quotes(p_api_version  NUMBER
  ...
  as
    ddp_qtev_tbl okl_trx_quotes_pub.qtev_tbl_type;
    ddx_qtev_tbl okl_trx_quotes_pub.qtev_tbl_type;
  ...
  begin
    ...
    okl_trx_quotes_pub.insert_trx_quotes(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_qtev_rec okl_trx_quotes_pub.qtev_rec_type;
    ddx_qtev_rec okl_trx_quotes_pub.qtev_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_trx_quotes(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_quotes_pub.lock_trx_quotes(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_trx_quotes(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_quotes_pub.update_trx_quotes(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_trx_quotes(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_quotes_pub.delete_trx_quotes(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_trx_quotes(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trx_quotes_pub.validate_trx_quotes(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
