--------------------------------------------------------
--  DDL for Package Body OKL_SETUPOPTIONS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPOPTIONS_PUB_W" as
  /* $Header: OKLUSOTB.pls 115.2 2002/12/24 04:19:38 sgorantl noship $ */
  ...
  as
    ddp_optv_rec okl_setupoptions_pub.optv_rec_type;
    ddx_no_data_found boolean;
    ddx_optv_rec okl_setupoptions_pub.optv_rec_type;
  ...
  begin
    ...
    okl_setupoptions_pub.get_rec(ddp_optv_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_optv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_optv_rec.id);
    p4_a1 := rosetta_g_miss_num_map(ddx_optv_rec.object_version_number);
    p4_a2 := ddx_optv_rec.name;
    p4_a3 := ddx_optv_rec.description;
    p4_a4 := ddx_optv_rec.from_date;
    p4_a5 := ddx_optv_rec.to_date;
    p4_a6 := ddx_optv_rec.attribute_category;
    p4_a7 := ddx_optv_rec.attribute1;
    p4_a8 := ddx_optv_rec.attribute2;
    p4_a9 := ddx_optv_rec.attribute3;
    p4_a10 := ddx_optv_rec.attribute4;
    p4_a11 := ddx_optv_rec.attribute5;
    p4_a12 := ddx_optv_rec.attribute6;
    p4_a13 := ddx_optv_rec.attribute7;
    p4_a14 := ddx_optv_rec.attribute8;
    p4_a15 := ddx_optv_rec.attribute9;
    p4_a16 := ddx_optv_rec.attribute10;
    p4_a17 := ddx_optv_rec.attribute11;
    p4_a18 := ddx_optv_rec.attribute12;
    p4_a19 := ddx_optv_rec.attribute13;
    p4_a20 := ddx_optv_rec.attribute14;
    p4_a21 := ddx_optv_rec.attribute15;
    p4_a22 := rosetta_g_miss_num_map(ddx_optv_rec.created_by);
    p4_a23 := ddx_optv_rec.creation_date;
    p4_a24 := rosetta_g_miss_num_map(ddx_optv_rec.last_updated_by);
    p4_a25 := ddx_optv_rec.last_update_date;
    p4_a26 := rosetta_g_miss_num_map(ddx_optv_rec.last_update_login);
  end;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupoptions_pub.insert_options(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupoptions_pub.update_options(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
