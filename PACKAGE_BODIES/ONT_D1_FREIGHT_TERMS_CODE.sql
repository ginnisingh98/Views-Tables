--------------------------------------------------------
--  DDL for Package Body ONT_D1_FREIGHT_TERMS_CODE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ONT_D1_FREIGHT_TERMS_CODE" AS
...
--  DESCRIPTION
--  
--      Body of package ONT_D1_FREIGHT_TERMS_CODE
--  
--  NOTES
--  
--  HISTORY
...
G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'ONT_D1_FREIGHT_TERMS_CODE';
...
BEGIN
    ...
    l_return_value := ONT_SHIP_TO_ORG_Def_Util.g_cached_record.FREIGHT_TERMS_CODE;
    END IF;
  ...
  END IF;
    ...
    l_return_value := ONT_INV_ORG_Def_Util.g_cached_record.FREIGHT_TERMS_CODE;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
    ...
    l_return_value := ONT_SOLD_TO_ORG_Def_Util.g_cached_record.FREIGHT_TERMS_CODE;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
    ...
    l_return_value := ONT_ORDER_TYPE_Def_Util.g_cached_record.FREIGHT_TERMS_CODE;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
    ...
    l_return_value := ONT_PRICE_LIST_Def_Util.g_cached_record.FREIGHT_TERMS_CODE;
    END IF;
    IF l_return_value IS NOT NULL THEN
       GOTO RETURN_VALUE;
  END IF;
...
WHEN OTHERS THEN
         ...
         ( p_attribute_code => 'FREIGHT_TERMS_CODE'
         , p_rule_id => l_rule_id
         );
         RETURN NULL;
END Get_Default_Value;
END ONT_D1_FREIGHT_TERMS_CODE;
