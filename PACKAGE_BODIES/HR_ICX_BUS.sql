--------------------------------------------------------
--  DDL for Package Body HR_ICX_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ICX_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hr_icx_bus.';  -- Global package name
--
-- The following two global variables are only to be
-- used by the return_legislation_code function.
--
g_legislation_code            varchar2(150)  default null;
g_item_context_id             number         default null;
--
--  ---------------------------------------------------------------------------
...
Procedure set_security_group_id
  ...
  -- hr_item_contexts and PER_BUSINESS_GROUPS
  ...
  cursor csr_sec_grp is
    select pbg.security_group_id
     ...
     where icx.item_context_id = p_item_context_id;
...
Begin
  ...
  --
  if ( nvl(hr_icx_bus.g_item_context_id, hr_api.g_number)
       = p_item_context_id) then
    --
    -- The legislation code has already been found with a previous
    -- call to this function. Just return the value in the global
    -- variable.
    --
    l_legislation_code := hr_icx_bus.g_legislation_code;
    ...
    --
    close csr_leg_code;
    hr_icx_bus.g_item_context_id   := p_item_context_id;
    hr_icx_bus.g_legislation_code  := l_legislation_code;
  end if;
...
Begin
  ...
  --
  IF NOT hr_icx_shd.api_updating
