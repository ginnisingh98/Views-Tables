--------------------------------------------------------
--  DDL for Package Body OE_HEADER_ADJ_SECURITY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_HEADER_ADJ_SECURITY" AS
/* $Header: OEXXHADB.pls 120.0.12010000.2 2010/02/23 11:01:54 aambasth ship $ */


--  Global constant holding the package name

G_PKG_NAME                    CONSTANT VARCHAR2(30) := 'OE_Header_Adj_Security';
...
-- Bug 1755817: if header adjustment belongs to a different order, then
         ...
         IF l_result = OE_PC_GLOBALS.YES THEN
            IF x_on_operation_action = 1 THEN
               ...
               IF l_debug_level  > 0 THEN
                   oe_debug_pub.add(  'HEADER ADJUSTMENTS SECURITY - SETTING REQUIRES REASON TO TRUE' , 5 ) ;
               END IF;
            ...
            ELSIF x_on_operation_action = 2 THEN
               ...
               IF OE_GLOBALS.G_AUDIT_REASON_RQD_FLAG <> 'Y' then
                  IF l_debug_level  > 0 THEN
                      oe_debug_pub.add(  'HEADER ADJUSTMENTS SECURITY - SETTING REQUIRES HISTORY TO TRUE' , 5 ) ;
                  END IF;
...
IF l_debug_level  > 0 THEN
    oe_debug_pub.add(  'ENTER OE_HEADER_ADJ_SECURITY.ENTITY' , 1 ) ;
END IF;

-- Initializing return status to SUCCESS
x_return_status := FND_API.G_RET_STS_SUCCESS;

IF p_HEADER_ADJ_rec.operation = OE_GLOBALS.G_OPR_CREATE THEN
...
OE_Header_Adj_Util.API_Rec_To_Rowtype_Rec(p_HEADER_ADJ_rec
								, l_rowtype_rec);

--Initialize security global record
OE_HEADER_ADJ_SECURITY.g_record := l_rowtype_rec;
...
IF l_debug_level  > 0 THEN
    oe_debug_pub.add(  'EXIT OE_HEADER_ADJ_SECURITY.ENTITY' , 1 ) ;
END IF;
...
BEGIN
IF l_debug_level  > 0 THEN
    oe_debug_pub.add(  'ENTER OE_HEADER_ADJ_SECURITY.ATTRIBUTES' , 1 ) ;
END IF;
...
OE_HEADER_ADJ_SECURITY.g_record := l_rowtype_rec;
    ...
    --Bug 9323560 starts
    oe_debug_pub.add( 'p_header_adj_rec.applied_flag: ' || p_header_adj_rec.applied_flag );

    IF p_header_adj_rec.applied_flag = FND_API.G_MISS_CHAR THEN
        NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.applied_flag,p_old_header_adj_rec.applied_flag) THEN
...
-- check constraints for all the changed attributes.
    ...
    IF p_header_adj_rec.automatic_flag = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.automatic_flag,p_old_header_adj_rec.automatic_flag) THEN
    ...
    IF p_header_adj_rec.discount_id = FND_API.G_MISS_NUM THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.discount_id,p_old_header_adj_rec.discount_id) THEN
    ...
    IF p_header_adj_rec.operand = FND_API.G_MISS_NUM THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.operand,p_old_header_adj_rec.operand) THEN
    ...
    IF p_header_adj_rec.discount_line_id = FND_API.G_MISS_NUM THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.discount_line_id,p_old_header_adj_rec.discount_line_id) THEN
    ...
    IF p_header_adj_rec.percent = FND_API.G_MISS_NUM THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.percent,p_old_header_adj_rec.percent) THEN
    ...
    IF p_header_adj_rec.request_id = FND_API.G_MISS_NUM THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.request_id,p_old_header_adj_rec.request_id) THEN
    ...
    IF p_header_adj_rec.context = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.context,p_old_header_adj_rec.context) THEN
    ...
    IF p_header_adj_rec.attribute1 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute1,p_old_header_adj_rec.attribute1) THEN
    ...
    IF p_header_adj_rec.attribute10 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute10,p_old_header_adj_rec.attribute10) THEN
    ...
    IF p_header_adj_rec.attribute11 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute11,p_old_header_adj_rec.attribute11) THEN
    ...
    IF p_header_adj_rec.attribute12 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute12,p_old_header_adj_rec.attribute12) THEN
    ...
    IF p_header_adj_rec.attribute13 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute13,p_old_header_adj_rec.attribute13) THEN
    ...
    IF p_header_adj_rec.attribute14 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute14,p_old_header_adj_rec.attribute14) THEN
    ...
    IF p_header_adj_rec.attribute15 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute15,p_old_header_adj_rec.attribute15) THEN
    ...
    IF p_header_adj_rec.attribute2 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute2,p_old_header_adj_rec.attribute2) THEN
    ...
    IF p_header_adj_rec.attribute3 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute3,p_old_header_adj_rec.attribute3) THEN
    ...
    IF p_header_adj_rec.attribute4 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute4,p_old_header_adj_rec.attribute4) THEN
    ...
    IF p_header_adj_rec.attribute5 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute5,p_old_header_adj_rec.attribute5) THEN
    ...
    IF p_header_adj_rec.attribute6 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute6,p_old_header_adj_rec.attribute6) THEN
    ...
    IF p_header_adj_rec.attribute7 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute7,p_old_header_adj_rec.attribute7) THEN
    ...
    IF p_header_adj_rec.attribute8 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute8,p_old_header_adj_rec.attribute8) THEN
    ...
    IF p_header_adj_rec.attribute9 = FND_API.G_MISS_CHAR THEN NULL;
    ELSIF NOT OE_GLOBALS.EQUAL(p_header_adj_rec.attribute9,p_old_header_adj_rec.attribute9) THEN
...
IF l_debug_level  > 0 THEN
    oe_debug_pub.add(  'EXIT OE_HEADER_ADJ_SECURITY.ATTRIBUTES' , 1 ) ;
END IF;
