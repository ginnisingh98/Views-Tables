--------------------------------------------------------
--  DDL for Package Body HR_NO_QUALIFICATION_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_NO_QUALIFICATION_API" as
/* $Header: pequanoi.pkb 120.0 2005/05/31 16:20 appldev noship $ */
--
  g_package  varchar2(33) := 'hr_no_qualification_api.';
--
-- ----------------------------------------------------------------------------
...
procedure CREATE_NO_QUALIFICATION
  ...
  BEGIN
   ...
   ,p_qua_information_category      => 'NO'
   ,p_qua_information1              => p_nus2000_code
   ,p_qua_information2     	    	=> p_highest_level
   ,p_qua_information3     	    	=> p_grade_point_avg
   ,p_qua_information4     	    	=> p_no_of_credits
