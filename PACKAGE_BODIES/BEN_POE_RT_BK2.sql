--------------------------------------------------------
--  DDL for Package Body BEN_POE_RT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_POE_RT_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_POE_RT_BK2.UPDATE_POE_RT_A', 10);
hr_utility.set_location(' Leaving: BEN_POE_RT_BK2.UPDATE_POE_RT_A', 20);
end UPDATE_POE_RT_A;
...
begin
hr_utility.set_location('Entering: BEN_POE_RT_BK2.UPDATE_POE_RT_B', 10);
hr_utility.set_location(' Leaving: BEN_POE_RT_BK2.UPDATE_POE_RT_B', 20);
end UPDATE_POE_RT_B;
end BEN_POE_RT_BK2;
