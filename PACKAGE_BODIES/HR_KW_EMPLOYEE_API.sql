--------------------------------------------------------
--  DDL for Package Body HR_KW_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_KW_EMPLOYEE_API" as
/* $Header: peempkwi.pkb 120.1 2005/06/22 04:42:00 adevanat noship $ */
--
  g_package  varchar2(33) := 'hr_kw_employee_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_kw_employee >------------------------------|
-- -----------------------------------------------------------------------------
...
is
    ...
    l_proc                 VARCHAR2(72) := g_package||'create_kw_employee';
