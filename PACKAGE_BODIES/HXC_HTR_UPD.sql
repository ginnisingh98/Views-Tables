--------------------------------------------------------
--  DDL for Package Body HXC_HTR_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_HTR_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_htr_upd.';  -- Global package name
...
Begin
  ...
  --
  -- Update the hxc_time_recipients Row
  --
  update hxc_time_recipients
    set
     time_recipient_id               = p_rec.time_recipient_id
    ,name                            = p_rec.name
    ,application_id                  = p_rec.application_id
    ,object_version_number           = p_rec.object_version_number
    ,application_retrieval_function  = p_rec.application_retrieval_function
    ,application_update_process      = p_rec.application_update_process
    ,appl_validation_process         = p_rec.appl_validation_process
    ,application_period_function     = p_rec.application_period_function
    ,appl_dynamic_template_process   = p_rec.appl_dynamic_template_process
    ,extension_function1             = p_rec.extension_function1
    ,extension_function2             = p_rec.extension_function2
        ,last_updated_by		     = fnd_global.user_id
    ,last_update_date		     = sysdate
    ,last_update_login	             = fnd_global.login_id

    where time_recipient_id = p_rec.time_recipient_id;
  --
...
Begin
  ...
  begin
    ...
    hxc_htr_rku.after_update
      ...
      ,p_name_o
      => hxc_htr_shd.g_old_rec.name
      ,p_appl_retrieval_function_o
      => hxc_htr_shd.g_old_rec.application_retrieval_function
      ,p_appl_update_process_o
      => hxc_htr_shd.g_old_rec.application_update_process
      ,p_appl_validation_process_o
      => hxc_htr_shd.g_old_rec.appl_validation_process
      ,p_appl_period_function_o
      => hxc_htr_shd.g_old_rec.application_period_function
      ,p_appl_dyn_template_process_o
      => hxc_htr_shd.g_old_rec.appl_dynamic_template_process
      ,p_extension_function1_o
      => hxc_htr_shd.g_old_rec.extension_function1
      ,p_extension_function2_o
      => hxc_htr_shd.g_old_rec.extension_function2
      ,p_application_id_o
      => hxc_htr_shd.g_old_rec.application_id
...
Begin
  ...
  --
  hxc_htr_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hxc_htr_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hxc_htr_upd.post_update
     (p_effective_date
     ,p_rec
     );
End upd;
