--------------------------------------------------------
--  DDL for Package Body HXC_ATC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_ATC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  hxc_atc_ins.';  -- Global package name
g_debug	   boolean	:= hr_utility.debug_enabled;
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_alias_type_component_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_alias_type_component_id  in  number) is
--
  l_proc       varchar2(72);
--
Begin
  ...
  --
  hxc_atc_ins.g_alias_type_component_id_i := p_alias_type_component_id;
  --
  if g_debug then
...
Begin
  ...
  --
  --
  -- Insert the row into: hxc_alias_type_components
  --
...
Begin
  ...
  --
  If (hxc_atc_ins.g_alias_type_component_id_i is not null) Then
    --
    ...
    If C_Sel2%found Then
       ...
       fnd_message.set_token('TABLE_NAME','hxc_alias_type_components');
    ...
    p_rec.alias_type_component_id :=
      hxc_atc_ins.g_alias_type_component_id_i;
    hxc_atc_ins.g_alias_type_component_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.alias_type_component_id;
    Close C_Sel1;
  End If;
  --
  if g_debug then
...
Begin
  ...
  --
  p_alias_type_component_id := l_rec.alias_type_component_id;
