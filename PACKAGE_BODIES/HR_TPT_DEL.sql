--------------------------------------------------------
--  DDL for Package Body HR_TPT_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_TPT_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_tpt_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the hr_tab_page_properties_tl row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hr_tpt_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hr_tpt_shd.g_rec_type) is
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
    begin
    --
    hr_tpt_rkd.after_delete
      (p_tab_page_property_id
      => p_rec.tab_page_property_id
      ,p_language
      => p_rec.language
      ,p_source_lang_o
      => hr_tpt_shd.g_old_rec.source_lang
      ,p_label_o
      => hr_tpt_shd.g_old_rec.label
      );
    --
  exception
    --
...
Begin
  ...
  --
  hr_tpt_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  hr_tpt_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hr_tpt_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hr_tpt_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
