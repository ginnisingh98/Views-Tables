--------------------------------------------------------
--  DDL for Package Body OKL_SETUP_STREAMTYPES_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUP_STREAMTYPES_PUB_W" as
  /* $Header: OKLUSMTB.pls 120.3 2008/01/29 17:24:06 gkadarka ship $ */
  ...
  procedure create_stream_type(p_api_version  NUMBER
  ...
  as
    ddp_styv_rec okl_setup_streamtypes_pub.styv_rec_type;
    ddx_styv_rec okl_setup_streamtypes_pub.styv_rec_type;
  ...
  begin
    ...
    okl_setup_streamtypes_pub.create_stream_type(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_stream_type(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setup_streamtypes_pub.update_stream_type(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_styv_tbl okl_setup_streamtypes_pub.styv_tbl_type;
    ddx_styv_tbl okl_setup_streamtypes_pub.styv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
...
end okl_setup_streamtypes_pub_w;
