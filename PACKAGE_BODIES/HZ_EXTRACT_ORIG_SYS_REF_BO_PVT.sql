--------------------------------------------------------
--  DDL for Package Body HZ_EXTRACT_ORIG_SYS_REF_BO_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HZ_EXTRACT_ORIG_SYS_REF_BO_PVT" AS
/*$Header: ARHEOSVB.pls 120.2 2005/09/02 18:43:50 awu noship $ */
/*
...
begin
	...
	-- Debug info.
        IF fnd_log.level_procedure>=fnd_log.g_current_runtime_level THEN
        	hz_utility_v2pub.debug(p_message=>'get_orig_sys_ref_objs(+)',
                               p_prefix=>l_debug_prefix,
                               p_msg_level=>fnd_log.level_procedure);
    	END IF;


        x_orig_sys_ref_objs := HZ_ORIG_SYS_REF_OBJ_TBL();

	open c1;
	fetch c1 BULK COLLECT into x_orig_sys_ref_objs;
	close c1;
