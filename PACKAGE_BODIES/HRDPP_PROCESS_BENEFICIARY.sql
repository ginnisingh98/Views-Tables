--------------------------------------------------------
--  DDL for Package Body HRDPP_PROCESS_BENEFICIARY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_PROCESS_BENEFICIARY" as
/*
...
,P_TTEE_PERSON_USER_KEY in varchar2 default null) is
...
decode(l.pval001,cn,nn,vn,nh,n(l.pval001)) p1,
l.pval001 d1,
...
decode(l.pval006,cn,vn,
 hr_pump_get.gl(l.pval006,'BEN_PRMRY_CNTNGNT',d(l.pval003),l.pval031)) p6,
...
l.pval010 d10,
decode(l.pval011,cn,vn,vn,null,l.pval011) p11,
l.pval011 d11,
...
decode(l.pval016,cn,dn,d(l.pval016)) p16,
decode(l.pval017,cn,nn,n(l.pval017)) p17,
...
decode(l.pval026,cn,vn,l.pval026) p26,
decode(l.pval027,cn,vn,l.pval027) p27,
decode(l.pval028,cn,dn,d(l.pval028)) p28,
decode(l.pval029,cn,nn,n(l.pval029)) p29,
...
--
if upper(c.p11) = 'TRUE' then
L_MULTI_ROW_ACTN := true;
elsif upper(c.p11) = 'FALSE' then
L_MULTI_ROW_ACTN := false;
elsif c.p11 is not null then
...
hr_utility.set_message_token('VALUE',c.p11);
hr_utility.set_message_token('TABLE','HR_PUMP_BATCH_LINES');
hr_utility.raise_error;
end if;
--
...
,P_EMPLOYEE_NUMBER => c.p13
,P_NATIONAL_IDENTIFIER => c.p14
,P_FULL_NAME => c.p15
,P_DATE_OF_BIRTH => c.p16
,P_PERSON_NUM => c.p17
...
(P_DATA_PUMP_ALWAYS_CALL => null
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_CON_EMPLOYEE_NUMBER => c.p25
,P_CON_NATIONAL_IDENTIFIER => c.p26
,P_CON_FULL_NAME => c.p27
,P_CON_DATE_OF_BIRTH => c.p28
,P_CON_PERSON_NUM => c.p29
,P_EFFECTIVE_DATE => c.p3);
--
if c.d30=cn or
c.p3 is null or
...
(P_ORGANIZATION_NAME => c.p30
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p3
,P_LANGUAGE_CODE => c.p31);
end if;
--
if c.d32=cn then
L_TTEE_PERSON_ID:=nn;
...
(P_TTEE_PERSON_USER_KEY => c.p32);
end if;
--
hr_data_pump.api_trc_on;
BEN_ENROLLMENT_PROCESS.PROCESS_BENEFICIARY
