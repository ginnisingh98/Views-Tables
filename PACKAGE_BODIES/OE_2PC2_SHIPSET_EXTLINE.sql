--------------------------------------------------------
--  DDL for Package Body OE_2PC2_SHIPSET_EXTLINE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC2_SHIPSET_EXTLINE" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 IS 
   ...
   WHERE a.SOURCE_TYPE_CODE = 'EXTERNAL'
   AND   (  a.LINE_ID ) IN  
                 ( SELECT  b.LINE_ID
