--------------------------------------------------------
--  DDL for Package Body IGF_SP_FC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_SP_FC_PKG" AS
/* $Header: IGFPI01B.pls 115.2 2003/03/19 08:49:40 smadathi noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_sp_fc_all%ROWTYPE;
  new_references igf_sp_fc_all%ROWTYPE;
  ...
  */
  BEGIN
    ...
    igf_sp_prg_pkg.get_fk_igf_sp_fc (
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_AW_SFCL_FMAST_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
...
/*
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGF', 'IGF_SP_SFCL_LKUP_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
