--------------------------------------------------------
--  DDL for Package Body GME_INIT_RSRC_TXNS_SUMMARY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_INIT_RSRC_TXNS_SUMMARY" AS
/* $Header: GMEMIRSB.pls 120.0 2005/05/26 14:22:32 appldev noship $ */
/*============================================================================
