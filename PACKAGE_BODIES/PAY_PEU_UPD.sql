--------------------------------------------------------
--  DDL for Package Body PAY_PEU_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PEU_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_peu_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Update the pay_event_updates Row
  --
  update pay_event_updates
    set
...
Begin
  ...
  --
  pay_peu_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  pay_peu_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  pay_peu_upd.post_update
     (p_effective_date
     ,p_rec
     );
End upd;
