--------------------------------------------------------
--  DDL for Package Body OKL_ACC_GROUP_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ACC_GROUP_PVT_W" as
  /* $Header: OKLOAGCB.pls 120.1 2005/07/07 13:34:24 dkagrawa noship $ */
  ...
  as
    ddp_agcv_rec okl_acc_group_pvt.agcv_rec_type;
    ddp_agbv_tbl okl_acc_group_pvt.agbv_tbl_type;
    ddx_agcv_rec okl_acc_group_pvt.agcv_rec_type;
    ddx_agbv_tbl okl_acc_group_pvt.agbv_tbl_type;
  ...
  begin
    ...
    okl_acc_group_pvt.create_acc_group(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.update_acc_group(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.validate_acc_group(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_agcv_tbl okl_acc_group_pvt.agcv_tbl_type;
    ddx_agcv_tbl okl_acc_group_pvt.agcv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.create_acc_ccid(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.lock_acc_ccid(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.update_acc_ccid(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.delete_acc_ccid(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.validate_acc_ccid(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.create_acc_bal(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_agbv_rec okl_acc_group_pvt.agbv_rec_type;
    ddx_agbv_rec okl_acc_group_pvt.agbv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.lock_acc_bal(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.update_acc_bal(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.delete_acc_bal(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acc_group_pvt.validate_acc_bal(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
