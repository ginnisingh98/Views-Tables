--------------------------------------------------------
--  DDL for Package Body OTA_TPC_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TPC_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ota_tpc_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: ota_training_plan_costs
  --
  insert into ota_training_plan_costs
...
--
  Cursor C_Sel1 is select ota_training_plan_costs_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.training_plan_cost_id;
  Close C_Sel1;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
...
Begin
  ...
  --
  ota_tpc_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  ota_tpc_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ota_tpc_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Begin
  ...
  --
  p_training_plan_cost_id := l_rec.training_plan_cost_id;
