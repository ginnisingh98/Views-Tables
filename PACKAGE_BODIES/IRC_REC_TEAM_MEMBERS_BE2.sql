--------------------------------------------------------
--  DDL for Package Body IRC_REC_TEAM_MEMBERS_BE2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_REC_TEAM_MEMBERS_BE2" as 
...
p_interview_security           varchar2) is
  ...
  --
  l_proc varchar2(72):='  irc_rec_team_members_be2.update_rec_team_member_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.rec_team_members.update_rec_team_member';
...
end update_rec_team_member_a;
end irc_rec_team_members_be2;
