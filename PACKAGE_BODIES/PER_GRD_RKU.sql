--------------------------------------------------------
--  DDL for Package Body PER_GRD_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_GRD_RKU" as
...
begin
hr_utility.set_location('Entering: PER_GRD_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PER_GRD_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PER_GRD_RKU;
