--------------------------------------------------------
--  DDL for Package Body BEN_DCL_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DCL_RKU" as
...
begin
hr_utility.set_location('Entering: BEN_DCL_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: BEN_DCL_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end BEN_DCL_RKU;
