--------------------------------------------------------
--  DDL for Package Body PQH_BDT_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_BDT_RKU" as
...
begin
hr_utility.set_location('Entering: PQH_BDT_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PQH_BDT_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQH_BDT_RKU;
