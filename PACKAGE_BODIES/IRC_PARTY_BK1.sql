--------------------------------------------------------
--  DDL for Package Body IRC_PARTY_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_PARTY_BK1" as
...
begin
hr_utility.set_location('Entering: IRC_PARTY_BK1.CREATE_REGISTERED_USER_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
irc_party_be1.CREATE_REGISTERED_USER_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_REGISTERED_USER', 'AP');
hr_utility.set_location(' Leaving: IRC_PARTY_BK1.CREATE_REGISTERED_USER_A', 20);
...
begin
hr_utility.set_location('Entering: IRC_PARTY_BK1.CREATE_REGISTERED_USER_B', 10);
hr_utility.set_location(' Leaving: IRC_PARTY_BK1.CREATE_REGISTERED_USER_B', 20);
end CREATE_REGISTERED_USER_B;
end IRC_PARTY_BK1;
