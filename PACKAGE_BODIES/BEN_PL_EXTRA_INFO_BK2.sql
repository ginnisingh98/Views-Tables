--------------------------------------------------------
--  DDL for Package Body BEN_PL_EXTRA_INFO_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PL_EXTRA_INFO_BK2" as
...
procedure UPDATE_PL_EXTRA_INFO_A
...
begin
hr_utility.set_location('Entering: BEN_PL_EXTRA_INFO_BK2.UPDATE_PL_EXTRA_INFO_A', 10);
hr_utility.set_location(' Leaving: BEN_PL_EXTRA_INFO_BK2.UPDATE_PL_EXTRA_INFO_A', 20);
end UPDATE_PL_EXTRA_INFO_A;
procedure UPDATE_PL_EXTRA_INFO_B
(P_PL_EXTRA_INFO_ID in NUMBER
,P_PLI_ATTRIBUTE_CATEGORY in VARCHAR2
,P_PLI_ATTRIBUTE1 in VARCHAR2
,P_PLI_ATTRIBUTE2 in VARCHAR2
...
begin
hr_utility.set_location('Entering: BEN_PL_EXTRA_INFO_BK2.UPDATE_PL_EXTRA_INFO_B', 10);
hr_utility.set_location(' Leaving: BEN_PL_EXTRA_INFO_BK2.UPDATE_PL_EXTRA_INFO_B', 20);
end UPDATE_PL_EXTRA_INFO_B;
end BEN_PL_EXTRA_INFO_BK2;
