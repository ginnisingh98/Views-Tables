--------------------------------------------------------
--  DDL for Package Body PER_ECA_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ECA_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  per_eca_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the per_election_candidates row.
  --
  delete from per_election_candidates
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in per_eca_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in per_eca_shd.g_rec_type) is
--
...
Begin
  ...
  --
  per_eca_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  per_eca_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  per_eca_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  per_eca_del.post_delete(p_rec);
  --
...
Begin
  ...
  -- business process
  --
  per_eca_del.del(l_rec, p_validate);
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End del;
--
