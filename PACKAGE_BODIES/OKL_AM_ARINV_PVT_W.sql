--------------------------------------------------------
--  DDL for Package Body OKL_AM_ARINV_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_ARINV_PVT_W" as
  /* $Header: OKLEARVB.pls 115.6 2002/12/24 19:06:58 gkadarka noship $ */
  ...
  as
    ddp_ariv_tbl okl_am_arinv_pvt.ariv_tbl_type;
  ...
  begin
    ...
    okl_am_arinv_pvt.create_asset_repair_invoice(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_ariv_tbl okl_am_arinv_pvt.ariv_tbl_type;
    ddx_ariv_tbl okl_am_arinv_pvt.ariv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_arinv_pvt.approve_asset_repair(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
