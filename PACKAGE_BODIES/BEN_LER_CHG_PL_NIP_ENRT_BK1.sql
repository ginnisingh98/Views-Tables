--------------------------------------------------------
--  DDL for Package Body BEN_LER_CHG_PL_NIP_ENRT_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LER_CHG_PL_NIP_ENRT_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_LER_CHG_PL_NIP_ENRT_BK1.CREATE_LER_CHG_PL_NIP_ENRT_A', 10);
hr_utility.set_location(' Leaving: BEN_LER_CHG_PL_NIP_ENRT_BK1.CREATE_LER_CHG_PL_NIP_ENRT_A', 20);
end CREATE_LER_CHG_PL_NIP_ENRT_A;
...
begin
hr_utility.set_location('Entering: BEN_LER_CHG_PL_NIP_ENRT_BK1.CREATE_LER_CHG_PL_NIP_ENRT_B', 10);
hr_utility.set_location(' Leaving: BEN_LER_CHG_PL_NIP_ENRT_BK1.CREATE_LER_CHG_PL_NIP_ENRT_B', 20);
end CREATE_LER_CHG_PL_NIP_ENRT_B;
