--------------------------------------------------------
--  DDL for Package Body PQH_DE_LEVEL_NUMBERS_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_DE_LEVEL_NUMBERS_SWI" As
/* $Header: pqgvnswi.pkb 115.1 2002/11/27 23:44:02 rpasapul noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'pqh_de_level_numbers_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_level_numbers_swi;
  --
  ...
  -- Call API
  --
  pqh_de_level_numbers_api.delete_level_numbers
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to delete_level_numbers_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint insert_level_numbers_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Register Surrogate ID or user key values
  --
  pqh_gvn_ins.set_base_key_value
    (p_level_number_id => p_level_number_id
    );
  --
  -- Call API
  --
  pqh_de_level_numbers_api.insert_level_numbers
    (p_validate                     => l_validate
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to insert_level_numbers_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_level_numbers_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
  ...
  -- Call API
  --
  pqh_de_level_numbers_api.update_level_numbers
    (p_validate                     => l_validate
    ,p_effective_date               => p_effective_date
    ,p_level_number                 => p_level_number
    ,p_description                  => p_description
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_level_numbers_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
