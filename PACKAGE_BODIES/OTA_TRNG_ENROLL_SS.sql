--------------------------------------------------------
--  DDL for Package Body OTA_TRNG_ENROLL_SS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_TRNG_ENROLL_SS" as
/* $Header: ottrnenr.pkb 120.2 2008/01/08 14:06:43 aabalakr noship $ */

g_package  varchar2(33)	:= ' ota_trng_enroll_ss.';  -- Global package name
...
--      l_notification_text     := '  The appropriate cost center has been charged.';
   ...
   /*   wf_engine.setItemAttrText (itemtype => p_item_type
      ...
      l_object_version_number := OTA_TRNG_ENROLL_SS.Get_Booking_OVN (p_booking_id => l_booking_id);
...
l_person_details
	OTA_TRNG_ENROLL_SS.csr_person_to_enroll_details%ROWTYPE;
l_cancel_boolean  boolean;
l_dummy number;
Begin
p_double_book := 'N';
l_person_details := OTA_TRNG_ENROLL_SS.Get_Person_To_Enroll_Details(p_person_id => p_person_id);
