--------------------------------------------------------
--  DDL for Package Body BEN_ELIGY_PROFILE_RULE_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIGY_PROFILE_RULE_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_ELIGY_PROFILE_RULE_BK2.UPDATE_ELIGY_PROFILE_RULE_A', 10);
hr_utility.set_location(' Leaving: BEN_ELIGY_PROFILE_RULE_BK2.UPDATE_ELIGY_PROFILE_RULE_A', 20);
end UPDATE_ELIGY_PROFILE_RULE_A;
...
begin
hr_utility.set_location('Entering: BEN_ELIGY_PROFILE_RULE_BK2.UPDATE_ELIGY_PROFILE_RULE_B', 10);
hr_utility.set_location(' Leaving: BEN_ELIGY_PROFILE_RULE_BK2.UPDATE_ELIGY_PROFILE_RULE_B', 20);
end UPDATE_ELIGY_PROFILE_RULE_B;
