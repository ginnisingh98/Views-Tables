--------------------------------------------------------
--  DDL for Package Body PA_ALLOC_SOURCE_LINES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PA_ALLOC_SOURCE_LINES_PKG" AS
 /* $Header: PAXATSLB.pls 120.2 2005/08/19 16:19:00 ramurthy noship $  */
procedure INSERT_ROW (
  ...
  X_LAST_UPDATE_LOGIN	in NUMBER
    ...
    cursor C is select ROWID from PA_ALLOC_SOURCE_LINES
      where RULE_ID = X_RULE_ID
      and LINE_NUM = X_LINE_NUM;
 begin

  insert into PA_ALLOC_SOURCE_LINES (
    RULE_ID,
    LINE_NUM,
    PROJECT_ORG_ID,
    TASK_ORG_ID,
...
begin
  ...
  update PA_ALLOC_SOURCE_LINES set
    LINE_NUM = X_LINE_NUM,
