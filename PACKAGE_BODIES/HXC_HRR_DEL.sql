--------------------------------------------------------
--  DDL for Package Body HXC_HRR_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_HRR_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_hrr_del.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Delete the hxc_resource_rules row.
  --
  delete from hxc_resource_rules
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in hxc_hrr_shd.g_rec_type) is
--
  l_proc  varchar2(72);
--
Begin
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in hxc_hrr_shd.g_rec_type) is
--
  l_proc  varchar2(72);
--
Begin
...
Begin
  ...
  --
  hxc_hrr_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  hxc_hrr_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  hxc_hrr_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  hxc_hrr_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
