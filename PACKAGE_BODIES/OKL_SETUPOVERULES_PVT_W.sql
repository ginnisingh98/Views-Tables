--------------------------------------------------------
--  DDL for Package Body OKL_SETUPOVERULES_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPOVERULES_PVT_W" as
  /* $Header: OKLESODB.pls 115.3 2002/12/24 04:01:54 sgorantl noship $ */
  ...
  as
    ddp_ovdv_rec okl_setupoverules_pvt.ovdv_rec_type;
    ddx_no_data_found boolean;
    ddx_ovdv_rec okl_setupoverules_pvt.ovdv_rec_type;
  ...
  begin
    ...
    okl_setupoverules_pvt.get_rec(ddp_ovdv_rec,
      x_return_status,
      ddx_no_data_found,
      ddx_ovdv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p3_a0 := rosetta_g_miss_num_map(ddx_ovdv_rec.id);
    p3_a1 := ddx_ovdv_rec.context_intent;
    p3_a2 := rosetta_g_miss_num_map(ddx_ovdv_rec.object_version_number);
    p3_a3 := rosetta_g_miss_num_map(ddx_ovdv_rec.orl_id);
    p3_a4 := rosetta_g_miss_num_map(ddx_ovdv_rec.ove_id);
    p3_a5 := ddx_ovdv_rec.individual_instructions;
    p3_a6 := ddx_ovdv_rec.copy_or_enter_flag;
    p3_a7 := rosetta_g_miss_num_map(ddx_ovdv_rec.context_org);
    p3_a8 := rosetta_g_miss_num_map(ddx_ovdv_rec.context_inv_org);
    p3_a9 := ddx_ovdv_rec.context_asset_book;
    p3_a10 := rosetta_g_miss_num_map(ddx_ovdv_rec.created_by);
    p3_a11 := ddx_ovdv_rec.creation_date;
    p3_a12 := rosetta_g_miss_num_map(ddx_ovdv_rec.last_updated_by);
    p3_a13 := ddx_ovdv_rec.last_update_date;
    p3_a14 := rosetta_g_miss_num_map(ddx_ovdv_rec.last_update_login);
  end;
  ...
  as
    ddp_optv_rec okl_setupoverules_pvt.optv_rec_type;
    ddp_ovev_rec okl_setupoverules_pvt.ovev_rec_type;
    ddp_ovdv_rec okl_setupoverules_pvt.ovdv_rec_type;
    ddx_ovdv_rec okl_setupoverules_pvt.ovdv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupoverules_pvt.insert_overules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_optv_rec okl_setupoverules_pvt.optv_rec_type;
    ddp_ovev_rec okl_setupoverules_pvt.ovev_rec_type;
    ddp_ovdv_tbl okl_setupoverules_pvt.ovdv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupoverules_pvt.delete_overules(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
