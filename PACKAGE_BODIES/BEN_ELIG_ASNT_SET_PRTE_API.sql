--------------------------------------------------------
--  DDL for Package Body BEN_ELIG_ASNT_SET_PRTE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ELIG_ASNT_SET_PRTE_API" as
/* $Header: beeanapi.pkb 120.0 2005/05/28 01:43:14 appldev noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_ELIG_ASNT_SET_PRTE_api.';
--
-- ----------------------------------------------------------------------------
...
procedure create_ELIG_ASNT_SET_PRTE
  ...
  --
  l_elig_asnt_set_prte_id ben_elig_asnt_set_prte_f.elig_asnt_set_prte_id%TYPE;
  l_effective_start_date ben_elig_asnt_set_prte_f.effective_start_date%TYPE;
  l_effective_end_date ben_elig_asnt_set_prte_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_ELIG_ASNT_SET_PRTE';
  l_object_version_number ben_elig_asnt_set_prte_f.object_version_number%TYPE;
  --
begin
  --
  ...
  --
  savepoint create_ELIG_ASNT_SET_PRTE;
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_ELIG_ASNT_SET_PRTE
    --
    ben_ELIG_ASNT_SET_PRTE_bk1.create_ELIG_ASNT_SET_PRTE_b
      (
      ...
      ,p_ean_attribute_category         =>  p_ean_attribute_category
      ,p_ean_attribute1                 =>  p_ean_attribute1
      ,p_ean_attribute2                 =>  p_ean_attribute2
      ,p_ean_attribute3                 =>  p_ean_attribute3
      ,p_ean_attribute4                 =>  p_ean_attribute4
      ,p_ean_attribute5                 =>  p_ean_attribute5
      ,p_ean_attribute6                 =>  p_ean_attribute6
      ,p_ean_attribute7                 =>  p_ean_attribute7
      ,p_ean_attribute8                 =>  p_ean_attribute8
      ,p_ean_attribute9                 =>  p_ean_attribute9
      ,p_ean_attribute10                =>  p_ean_attribute10
      ,p_ean_attribute11                =>  p_ean_attribute11
      ,p_ean_attribute12                =>  p_ean_attribute12
      ,p_ean_attribute13                =>  p_ean_attribute13
      ,p_ean_attribute14                =>  p_ean_attribute14
      ,p_ean_attribute15                =>  p_ean_attribute15
      ,p_ean_attribute16                =>  p_ean_attribute16
      ,p_ean_attribute17                =>  p_ean_attribute17
      ,p_ean_attribute18                =>  p_ean_attribute18
      ,p_ean_attribute19                =>  p_ean_attribute19
      ,p_ean_attribute20                =>  p_ean_attribute20
      ,p_ean_attribute21                =>  p_ean_attribute21
      ,p_ean_attribute22                =>  p_ean_attribute22
      ,p_ean_attribute23                =>  p_ean_attribute23
      ,p_ean_attribute24                =>  p_ean_attribute24
      ,p_ean_attribute25                =>  p_ean_attribute25
      ,p_ean_attribute26                =>  p_ean_attribute26
      ,p_ean_attribute27                =>  p_ean_attribute27
      ,p_ean_attribute28                =>  p_ean_attribute28
      ,p_ean_attribute29                =>  p_ean_attribute29
      ,p_ean_attribute30                =>  p_ean_attribute30
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_ELIG_ASNT_SET_PRTE'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_ELIG_ASNT_SET_PRTE
    --
  end;
  --
  ben_ean_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_ELIG_ASNT_SET_PRTE
    --
    ben_ELIG_ASNT_SET_PRTE_bk1.create_ELIG_ASNT_SET_PRTE_a
      (
       p_elig_asnt_set_prte_id          =>  l_elig_asnt_set_prte_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_ELIG_ASNT_SET_PRTE
    --
  end;
  --
  ben_profile_handler.event_handler
    (p_event                       => 'CREATE',
     ...
     p_base_table_reference_column => 'ELIG_ASNT_SET_FLAG',
     p_reference_table             => 'BEN_ELIG_ASNT_SET_PRTE_F',
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_ELIG_ASNT_SET_PRTE;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
    --
    p_elig_asnt_set_prte_id := null;
...
procedure update_ELIG_ASNT_SET_PRTE
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_ELIG_ASNT_SET_PRTE';
  l_object_version_number ben_elig_asnt_set_prte_f.object_version_number%TYPE;
  l_effective_start_date ben_elig_asnt_set_prte_f.effective_start_date%TYPE;
  l_effective_end_date ben_elig_asnt_set_prte_f.effective_end_date%TYPE;
  --
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_ELIG_ASNT_SET_PRTE;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_ELIG_ASNT_SET_PRTE
    --
    ben_ELIG_ASNT_SET_PRTE_bk2.update_ELIG_ASNT_SET_PRTE_b
      (
       p_elig_asnt_set_prte_id          =>  p_elig_asnt_set_prte_id
      ,p_ordr_num                       =>  p_ordr_num
      ,p_excld_flag                     =>  p_excld_flag
      ,p_assignment_set_id              =>  p_assignment_set_id
      ,p_eligy_prfl_id                  =>  p_eligy_prfl_id
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_ELIG_ASNT_SET_PRTE'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_ELIG_ASNT_SET_PRTE
    --
  end;
  --
  ben_ean_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_ELIG_ASNT_SET_PRTE
    --
    ben_ELIG_ASNT_SET_PRTE_bk2.update_ELIG_ASNT_SET_PRTE_a
      (
       p_elig_asnt_set_prte_id          =>  p_elig_asnt_set_prte_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_ELIG_ASNT_SET_PRTE
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO update_ELIG_ASNT_SET_PRTE;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint delete_ELIG_ASNT_SET_PRTE;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_ELIG_ASNT_SET_PRTE
    --
    ben_ELIG_ASNT_SET_PRTE_bk3.delete_ELIG_ASNT_SET_PRTE_b
      (
       p_elig_asnt_set_prte_id          =>  p_elig_asnt_set_prte_id
      ,p_object_version_number          =>  p_object_version_number
    ,p_effective_date                      => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_ELIG_ASNT_SET_PRTE'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_ELIG_ASNT_SET_PRTE
    --
  end;
  --
  ben_ean_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_ELIG_ASNT_SET_PRTE
    --
    ben_ELIG_ASNT_SET_PRTE_bk3.delete_ELIG_ASNT_SET_PRTE_a
      (
       p_elig_asnt_set_prte_id          =>  p_elig_asnt_set_prte_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_ELIG_ASNT_SET_PRTE
    --
  end;
  --
  ben_profile_handler.event_handler
    (p_event                       => 'DELETE',
     p_base_table                  => 'BEN_ELIGY_PRFL_F',
     p_base_table_column           => 'ELIGY_PRFL_ID',
     p_base_table_column_value     => ben_ean_shd.g_old_rec.eligy_prfl_id,
     p_base_table_reference_column => 'ELIG_ASNT_SET_FLAG',
     p_reference_table             => 'BEN_ELIG_ASNT_SET_PRTE_F',
     p_reference_table_column      => 'ELIGY_PRFL_ID');
  --
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO delete_ELIG_ASNT_SET_PRTE;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
