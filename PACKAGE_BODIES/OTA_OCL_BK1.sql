--------------------------------------------------------
--  DDL for Package Body OTA_OCL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_OCL_BK1" as
...
begin
hr_utility.set_location('Entering: OTA_OCL_BK1.CREATE_COMPETENCE_LANGUAGE_A', 10);
hr_utility.set_location(' Leaving: OTA_OCL_BK1.CREATE_COMPETENCE_LANGUAGE_A', 20);
end CREATE_COMPETENCE_LANGUAGE_A;
...
begin
hr_utility.set_location('Entering: OTA_OCL_BK1.CREATE_COMPETENCE_LANGUAGE_B', 10);
hr_utility.set_location(' Leaving: OTA_OCL_BK1.CREATE_COMPETENCE_LANGUAGE_B', 20);
end CREATE_COMPETENCE_LANGUAGE_B;
end OTA_OCL_BK1;
