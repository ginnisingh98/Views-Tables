--------------------------------------------------------
--  DDL for Package Body PER_REQ_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_REQ_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_req_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the per_requisitions Row
  --
...
Begin
  ...
  --
  convert_defs(p_rec);
  per_req_bus.update_validate
     (p_rec
     );
  --
  -- Call the supporting pre-update operation
  --
  per_req_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  per_req_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  per_req_upd.post_update
     (p_rec
     );
End upd;
--
