--------------------------------------------------------
--  DDL for Package Body OKL_INV_FORMAT_DELETE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_INV_FORMAT_DELETE_PUB_W" as
  /* $Header: OKLUIFDB.pls 120.1 2005/07/14 12:02:05 asawanka noship $ */
  ...
  as
    ddp_inf_del_rec okl_inv_format_delete_pub.inf_del_rec_type;
  ...
  begin
    ...
    okl_inv_format_delete_pub.delete_format(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_inf_del_tbl okl_inv_format_delete_pub.inf_del_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
