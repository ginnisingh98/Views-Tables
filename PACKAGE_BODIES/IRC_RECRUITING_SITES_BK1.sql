--------------------------------------------------------
--  DDL for Package Body IRC_RECRUITING_SITES_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_RECRUITING_SITES_BK1" as
...
begin
hr_utility.set_location('Entering: IRC_RECRUITING_SITES_BK1.CREATE_RECRUITING_SITE_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
irc_recruiting_sites_be1.CREATE_RECRUITING_SITE_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'CREATE_RECRUITING_SITE', 'AP');
hr_utility.set_location(' Leaving: IRC_RECRUITING_SITES_BK1.CREATE_RECRUITING_SITE_A', 20);
...
begin
hr_utility.set_location('Entering: IRC_RECRUITING_SITES_BK1.CREATE_RECRUITING_SITE_B', 10);
hr_utility.set_location(' Leaving: IRC_RECRUITING_SITES_BK1.CREATE_RECRUITING_SITE_B', 20);
end CREATE_RECRUITING_SITE_B;
