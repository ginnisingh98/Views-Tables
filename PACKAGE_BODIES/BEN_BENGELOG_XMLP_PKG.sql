--------------------------------------------------------
--  DDL for Package Body BEN_BENGELOG_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENGELOG_XMLP_PKG" AS
/* $Header: BENGELOGB.pls 120.1 2007/12/10 08:34:54 vjaganat noship $ */
...
function CF_STANDARD_HEADERFormula return Number is
  ...
  begin
  select decode(audit_log_flag, 'Y', 'Yes', 'N', 'No')  into CP_AUDIT_LOG
  ...
  begin
  select decode(lmt_prpnip_by_org_flag, 'Y', 'Yes', 'N', 'No')  into CP_LMT_BY_ORG
  from   ben_benefit_actions bft
  where bft.request_id = P_CONCURRENT_REQUEST_ID;
...
--Functions to refer Oracle report placeholders--
 ...
 Function CP_AUDIT_LOG_p return varchar2 is
	Begin
	 return CP_AUDIT_LOG;
	 END;
 Function CP_LMT_BY_ORG_p return varchar2 is
	Begin
	 return CP_LMT_BY_ORG;
	 END;
