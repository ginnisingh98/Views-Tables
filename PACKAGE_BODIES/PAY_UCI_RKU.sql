--------------------------------------------------------
--  DDL for Package Body PAY_UCI_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_UCI_RKU" as
...
begin
hr_utility.set_location('Entering: PAY_UCI_RKU.AFTER_UPDATE', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
PAY_DYT_USER_COLUMN_INSTA_PKG.AFTER_UPDATE
...
hr_api.validate_commit_unit(l_commit_unit_number, 'PAY_USER_COLUMN_INSTANCES_F', 'AU');
hr_utility.set_location(' Leaving: PAY_UCI_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PAY_UCI_RKU;
