--------------------------------------------------------
--  DDL for Package Body PY_ZA_TX_01032004
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PY_ZA_TX_01032004" AS
/* $Header: pyzat005.pkb 120.0 2005/05/29 10:30:14 appldev noship $ */
...
/*
   ...
   PRIVATE PROCEDURES
      WrtHrTrc
         Wrapper procedure for py_za_tx_utl_01032004.WriteHrTrace
      NetTxbIncCalc
   ...
   MODIFICATION HISTORY
      ...
      ---------   ----------------   -------   --------------------------------
      A. Mahanty  14/04/2005         115.7     Bug 3491357 :BRA Enhancement
                                               Balance Values retrieval modified.
      J.N. Louw   07/01/2005         115.6     Bugs 4106307
                                                    4106240
      R.V. Pahune 29/12/2004         115.5     disable the trace 'ZATAX'
      J.N. Louw   18/12/2004         115.4     Bug 3931259
      J.N. Louw   27/10/2004         115.3     Bug 3931277
      J.N. Louw   24-02-2004         115.1     Added bal_LB_PYMNTS to
                                               trc_NorIncYtd in NorCalc
...
-------------------------------------------------------------------------------
-- WrtHrTrc
-- Wrapper for py_za_tx_utl_01032004.WriteHrTrace
-------------------------------------------------------------------------------
PROCEDURE WrtHrTrc(
   p_Buf IN VARCHAR2
   )
...
BEGIN
   py_za_tx_utl_01032004.WriteHrTrace(p_Buf);
END WrtHrTrc;
...
BEGIN
   hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',1);
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',2);
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',3);
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',4);
...
--
   nti_PerTypInc :=
      ...
      + bal_LB_PYMNTS_NRFI_CMTD      + bal_LB_PYMNTS_RFI_CMTD
...
--
   nti_AnnTypErn :=
    ...
    + ( bal_AB_NRFI_CMTD              + bal_AB_RFI_CMTD
      ...
      + bal_ANN_LB_PYMNTS_NRFI_CMTD   + bal_ANN_LB_PYMNTS_RFI_CMTD
      + bal_ANN_PYM_DBT_NRFI_CMTD     + bal_ANN_PYM_DBT_RFI_CMTD
...
-----------------------------
   ...
   -- Fixed Pension Basis
   ----------------------
   IF dbi_ASG_PEN_BAS = '1' THEN
      hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',5);
   -- Annualise Txb Pkg Cmp
      nti_PerTxbPkg := bal_TXB_PKG_COMP_CMTD * nti_SitFactor;

      hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',6);

      nti_AnnTxbPkg := nti_PerTxbPkg + bal_ANN_TXB_PKG_COMP_CMTD;

   -- Check if there is taxable income in the package
      IF nti_AnnTxbPkg <> 0 THEN
      -- Check ASG_SALARY
         IF dbi_TOT_PKG = -1 THEN
            hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',7);
            nti_TotPkg := dbi_ASG_SAL * dbi_ASG_SAL_FCTR;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',8);
            nti_TotPkg := dbi_TOT_PKG;
         END IF;

      -- Calculate the Taxable Fixed Percentage
         nti_TxbFxdPrc := least((dbi_FXD_PRC * (nti_TotPkg / nti_AnnTxbPkg)), 100)/ 100;

         hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',9);

      -- Calculate RFI and NRFI portions
         -- Periodic
         hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',10);
         nti_PerRFITotPkgPTD := bal_TXB_PKG_COMP_CMTD * nti_TxbFxdPrc;

         nti_PerNRFITotPkgPTD := bal_TXB_PKG_COMP_CMTD - nti_PerRFITotPkgPTD;
         -- Annual
         hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',11);
         nti_AnnRFITotPkgPTD := bal_ANN_TXB_PKG_COMP_CMTD * nti_TxbFxdPrc;

         nti_AnnNRFITotPkgPTD := bal_ANN_TXB_PKG_COMP_CMTD - nti_AnnRFITotPkgPTD;
      END IF;

   -- Calculate the Update values
      -- Periodic
      hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',12);
      nti_PerRFITotPkgPTD_Upd := nti_PerRFITotPkgPTD - bal_RFI_TOT_PKG_CMTD;

      nti_PerNRFITotPkgPTD_Upd := nti_PerNRFITotPkgPTD - bal_NRFI_TOT_PKG_CMTD;

      -- Annual
      hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',13);
      nti_AnnRFITotPkgPTD_Upd := nti_AnnRFITotPkgPTD - bal_ANN_RFI_TOT_PKG_CMTD;

      nti_AnnNRFITotPkgPTD_Upd := nti_AnnNRFITotPkgPTD - bal_ANN_NRFI_TOT_PKG_CMTD;

   -- Add RFI upd values to RFI balance values
      -- Periodic
      hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',14);
      bal_TOT_RFI_INC_CMTD := bal_TOT_RFI_INC_CMTD
                            + bal_RFI_TOT_PKG_CMTD
                            + nti_PerRFITotPkgPTD_Upd;
      -- Annual
      hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',15);
      bal_TOT_RFI_AN_INC_CMTD := bal_TOT_RFI_AN_INC_CMTD
                               + bal_ANN_RFI_TOT_PKG_CMTD
                               + nti_AnnRFITotPkgPTD_Upd;
   -- Add NRFI upd values to NRFI balance values
      -- Periodic
      hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',16);
      bal_TOT_NRFI_INC_CMTD := bal_TOT_NRFI_INC_CMTD
                             + bal_NRFI_TOT_PKG_CMTD
                             + nti_PerNRFITotPkgPTD_Upd;
      -- Annual
      hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',17);
      bal_TOT_NRFI_AN_INC_CMTD := bal_TOT_NRFI_AN_INC_CMTD
                                + bal_ANN_NRFI_TOT_PKG_CMTD
                                + nti_AnnNRFITotPkgPTD_Upd;

      hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',18);
   END IF;
   -------------------------
   ...
   -------------------------
      ...
      --------------------------------
         hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',19);
         -------------
         -- Excess ITD
         -------------
      ...
      -------------------------------
         hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',20);
         -------------
         -- Current RA
         -------------
         ...
         IF bal_CUR_PF_CMTD + bal_ANN_PF_CMTD = 0 THEN
            hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',21);
            nti_PerNrfiCon := (
                                bal_TOT_RFI_INC_CMTD + bal_TOT_NRFI_INC_CMTD
                              )
                              * nti_SitFactor;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',22);
         ...
         IF bal_CUR_PF_CMTD + bal_ANN_PF_CMTD = 0 THEN
            hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',23);

            nti_AnnNrfiCon := nti_PerNrfiCon
                            + bal_TOT_NRFI_AN_INC_CMTD
                            + bal_TOT_RFI_AN_INC_CMTD;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',24);
      ...
      --------------------------------------
         hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',25);
         -------------
         -- Excess ITD
         -------------
   ...
   -----------------------------------------------------------
      ...
      hr_utility.set_location('py_za_tx_01032004.NetTxbIncCalc',26);
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxOvr_01032004: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxOvr_01032004;
...
PROCEDURE LteCalc AS
   ...
   --
      ...
      BEGIN
         hr_utility.set_location('py_za_tx_01032004.LteCalc',1);
         ...
         hr_utility.set_location('py_za_tx_01032004.LteCalc',2);
      ...
      AS
         ...
         l_dimension pay_balance_dimensions.dimension_name%TYPE ;
      BEGIN
         hr_utility.set_location('py_za_tx_01032004.LteCalc',3);
         -- Get the Balance Type ID
         SELECT pbt.balance_type_id
           INTO l_BalTypId
           FROM pay_balance_types pbt
         ...
         hr_utility.set_location('py_za_tx_01032004.LteCalc',4);
...
BEGIN
   hr_utility.set_location('py_za_tx_01032004.LteCalc',5);
   -- Does the Assignment have an OFigure?
   --
   IF bal_TOT_TXB_INC_ITD <= 0 THEN
      hr_utility.set_location('py_za_tx_01032004.LteCalc',6);
      ...
      hr_utility.set_location('py_za_tx_01032004.LteCalc',8);

      trc_SitFactor := (l_EndDate - l_StrtDte + 1) / py_za_tx_utl_01032004.DaysWorked;

      hr_utility.set_location('py_za_tx_01032004.LteCalc',9);
      ...
      bal_IC_PYMNTS_NRFI_PTD       := getBalVal('Independent Contractor Payments NRFI',l_EndDate);
      bal_IC_PYMNTS_RFI_PTD        := getBalVal('Independent Contractor Payments RFI',l_EndDate);
      bal_ANN_IC_PYMNTS_NRFI_PTD   := getBalVal('Annual Independent Contractor Payments NRFI',l_EndDate);
      bal_ANN_IC_PYMNTS_RFI_PTD    := getBalVal('Annual Independent Contractor Payments RFI',l_EndDate);
      bal_LB_PYMNTS_NRFI_PTD       := getBalVal('Labour Broker Payments NRFI',l_EndDate);
      bal_LB_PYMNTS_RFI_PTD        := getBalVal('Labour Broker Payments RFI',l_EndDate);
      bal_ANN_LB_PYMNTS_NRFI_PTD   := getBalVal('Annual Labour Broker Payments NRFI',l_EndDate);
      bal_ANN_LB_PYMNTS_RFI_PTD    := getBalVal('Annual Labour Broker Payments RFI',l_EndDate);
      ...
      bal_ANN_PYM_DBT_NRFI_PTD     := getBalVal('Annual Payment of Employee Debt NRFI',l_EndDate);
      bal_ANN_PYM_DBT_RFI_PTD      := getBalVal('Annual Payment of Employee Debt RFI',l_EndDate);
      ...
      bal_RFI_TOT_PKG_PTD          := getBalVal('RFIable Total Package',l_EndDate);
      bal_NRFI_TOT_PKG_PTD         := getBalVal('NRFIable Total Package',l_EndDate);
      bal_ANN_RFI_TOT_PKG_PTD      := getBalVal('Annual RFIable Total Package',l_EndDate);
      bal_ANN_NRFI_TOT_PKG_PTD     := getBalVal('Annual NRFIable Total Package',l_EndDate);

      hr_utility.set_location('py_za_tx_01032004.LteCalc',10);

      -- Update Globals with Correct Taxable Values
      py_za_tx_utl_01032004.TrvAll;

      bal_PO_NRFI_PTD := bal_PO_NRFI_PTD
                       * py_za_tx_utl_01032004.GlbVal('ZA_PUBL_TAX_PERC',l_EndDate)
                       / 100;
      bal_PO_RFI_PTD  := bal_PO_RFI_PTD
                       * py_za_tx_utl_01032004.GlbVal('ZA_PUBL_TAX_PERC',l_EndDate)
                       / 100;

      hr_utility.set_location('py_za_tx_01032004.LteCalc',11);

      -- Rebates
      py_za_tx_utl_01032004.SetRebates;
      -- Abatements
      py_za_tx_utl_01032004.Abatements;

      hr_utility.set_location('py_za_tx_01032004.LteCalc',12);
      ...
      trc_BseErn :=
         ...
         + bal_IC_PYMNTS_NRFI_PTD       + bal_IC_PYMNTS_RFI_PTD
         + bal_LB_PYMNTS_NRFI_PTD       + bal_LB_PYMNTS_RFI_PTD
         ...
         * trc_SitFactor)
         ...
         + bal_ANN_IC_PYMNTS_NRFI_PTD   + bal_ANN_IC_PYMNTS_RFI_PTD
         + bal_ANN_LB_PYMNTS_NRFI_PTD   + bal_ANN_LB_PYMNTS_RFI_PTD
         + bal_ANN_PYM_DBT_NRFI_PTD     + bal_ANN_PYM_DBT_RFI_PTD
      ...
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.LteCalc',13);
      -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01032004.LteCalc',14);
         trc_TotLibBse := 0;
      END IF;
   ...
   ELSE
      hr_utility.set_location('py_za_tx_01032004.LteCalc',15);
      ...
      hr_utility.set_location('py_za_tx_01032004.LteCalc',16);

      -- Global Values
      l_ZA_TX_YR_END        := l_EndDate;
      l_ZA_ADL_TX_RBT       := py_za_tx_utl_01032004.GlbVal('ZA_ADDITIONAL_TAX_REBATE',l_EndDate);
      l_ZA_PRI_TX_RBT       := py_za_tx_utl_01032004.GlbVal('ZA_PRIMARY_TAX_REBATE',l_EndDate);
      l_ZA_PRI_TX_THRSHLD   := py_za_tx_utl_01032004.GlbVal('ZA_PRIM_TAX_THRESHOLD',l_EndDate);
      l_ZA_SC_TX_THRSHLD    := py_za_tx_utl_01032004.GlbVal('ZA_SEC_TAX_THRESHOLD',l_EndDate);

      -- Calculate the assignments 65 Year Date
      l_65Year := add_months(dbi_PER_DTE_OF_BRTH,780);

      IF l_65Year <= l_ZA_TX_YR_END THEN
         hr_utility.set_location('py_za_tx_01032004.LteCalc',17);
         -- give the extra abatement
         trc_Rebate    := l_ZA_PRI_TX_RBT + l_ZA_ADL_TX_RBT;
         trc_Threshold := l_ZA_SC_TX_THRSHLD;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.LteCalc',18);
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.LteCalc',19);
         -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01032004.LteCalc',20);
         trc_TotLibBse := 0;
      END IF;
   ...
   hr_utility.set_location('py_za_tx_01032004.LteCalc',21);
   ...
   hr_utility.set_location('py_za_tx_01032004.LteCalc',22);
...
--
   ...
   trc_NorIncYtd :=
      ...
      + bal_IC_PYMNTS_NRFI_YTD     + bal_IC_PYMNTS_RFI_YTD
      + bal_LB_PYMNTS_NRFI_YTD     + bal_LB_PYMNTS_RFI_YTD
   ...
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.LteCalc',23);
      -- Normal Earnings
      ...
      IF trc_TxbNorInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.LteCalc',24);
         -- Tax Liability
         trc_TotLibNI := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbNorInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01032004.LteCalc',25);
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.LteCalc',26);
      -- Set Cascade Figures and Refund
...
--
   ...
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.LteCalc',27);
      ...
      IF trc_TxbFrnInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.LteCalc',28);
         -- Tax Liability
         trc_TotLibFB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbFrnInc);
      ...
      ElSE
         hr_utility.set_location('py_za_tx_01032004.LteCalc',29);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.LteCalc',30);
      -- Set Cascade Figures and Refund
...
--
   ...
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.LteCalc',31);
      -- Travel Earnings
      ...
      IF trc_TxbTrvInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.LteCalc',32);
         -- Tax Liability
         trc_TotLibTA := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbTrvInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01032004.LteCalc',33);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.LteCalc',34);
      -- Set Cascade Figures and Refund
...
--
   ...
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.LteCalc',35);
      ...
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.LteCalc',36);
         -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnBonInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01032004.LteCalc',39);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.LteCalc',40);
      -- Set Cascade Figures and Refund
...
--
   ...
   trc_AnnPymYtd :=
      ...
      + bal_ANN_IC_PYMNTS_NRFI_YTD   + bal_ANN_IC_PYMNTS_RFI_YTD
      + bal_ANN_LB_PYMNTS_NRFI_YTD   + bal_ANN_LB_PYMNTS_RFI_YTD
      + bal_ANN_PYM_DBT_NRFI_YTD     + bal_ANN_PYM_DBT_RFI_YTD
   ...
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.LteCalc',41);
      ...
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.LteCalc',42);
         -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnPymInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01032004.LteCalc',45);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.LteCalc',46);
      -- Set Cascade Figures and Refund
...
--
   ...
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.LteCalc',47);
   ...
   ELSE
      hr_utility.set_location('py_za_tx_01032004.LteCalc',48);
      -- Set Cascade Figures and Refund
      trc_LibFyPO    := 0;
...
--
   ...
   IF trc_TxbAnnPymInc + trc_PblOffErn < glb_ZA_SIT_LIM THEN
      hr_utility.set_location('py_za_tx_01032004.LteCalc',49);
      l_Sl := TRUE;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.LteCalc',50);
      l_Sl := FALSE;
   END IF;

   py_za_tx_utl_01032004.ValidateTaxOns(p_Rf => l_Sl);

-- Set IT3A Indicator
--
   IF trc_TxbAnnPymInc + trc_PblOffErn >= trc_Threshold THEN
      hr_utility.set_location('py_za_tx_01032004.LteCalc',51);
      trc_It3Ind := 0; -- Over Lim
   ELSE
      hr_utility.set_location('py_za_tx_01032004.LteCalc',52);
...
BEGIN
   hr_utility.set_location('py_za_tx_01032004.SeaCalc',1);
...
--
   hr_utility.set_location('py_za_tx_01032004.SeaCalc',2);
   IF trc_TxbIncPtd = 0 THEN -- Pre-Earnings Calc
      hr_utility.set_location('py_za_tx_01032004.SeaCalc',3);
      -- Site Factor
      --
      ...
      IF l_65Year BETWEEN dbi_ZA_TX_YR_STRT AND dbi_ZA_TX_YR_END THEN
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',4);
         -- give the extra abatement
         trc_Rebate    := glb_ZA_PRI_TX_RBT + glb_ZA_ADL_TX_RBT;
         trc_Threshold := glb_ZA_SC_TX_THRSHLD;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',5);
         -- not eligable for extra abatement
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',6);
         -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbBseInc);
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',7);
         trc_TotLibBse := 0;
      END IF;
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',8);
         -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFpAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibBse);
      ElSE
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',9);
         trc_LibFpAP := 0;
      END IF;
   ...
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SeaCalc',10);
      -- Site Factor
      --
      trc_SitFactor := glb_ZA_WRK_DYS_PR_YR / dbi_SEA_WRK_DYS_WRK;
   ...
   hr_utility.set_location('py_za_tx_01032004.SeaCalc',11);
   ...
   --
      ...
      IF trc_NorIncPtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',12);
         -- Normal Earnings
         ...
         -- Threshold Check
         IF trc_TxbNorInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032004.SeaCalc',13);
            -- Tax Liability
            trc_TotLibNI := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbNorInc);
         ...
         ELSE
            hr_utility.set_location('py_za_tx_01032004.SeaCalc',14);
            trc_TotLibNI := 0;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',15);
         trc_NorErn    := 0;
         trc_TxbNorInc := 0;
         trc_TotLibNI  := 0;
      END IF;
   ...
   --
      ...
      IF trc_FrnBenPtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',16);
         -- Fringe Benefit Earnings
         ...
         -- Threshold Check
         IF trc_TxbFrnInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032004.SeaCalc',17);
            -- Tax Liability
            trc_TotLibFB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbFrnInc);
            trc_LibFyFB  := trc_TotLibFB - least(trc_TotLibFB,trc_TotLibNI);
            trc_TotLibFB := greatest(trc_TotLibFB,trc_TotLibNI);
         ...
         ELSE
            hr_utility.set_location('py_za_tx_01032004.SeaCalc',18);
            trc_TotLibFB := trc_TotLibNI;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',19);
         trc_FrnBenErn := trc_NorErn;
         trc_TxbFrnInc := trc_TxbNorInc;
         trc_TotLibFB  := trc_TotLibNI;
      END IF;
   ...
   --
      ...
      IF trc_AnnPymPtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',20);
         -- Annual Payments Earnings
         ...
         -- Threshold Check
         IF trc_TxbAnnPymInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032004.SeaCalc',21);
            -- Tax Liability
            trc_TotLibAP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         ...
         ELSE
            hr_utility.set_location('py_za_tx_01032004.SeaCalc',22);
            trc_TotLibAP := trc_TotLibFB;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',23);
   ...
   -- Net Pay Validation
   --
      py_za_tx_utl_01032004.ValidateTaxOns;

   hr_utility.set_location('py_za_tx_01032004.SeaCalc',24);

   -- Set IT3A Indicator
   --
      IF trc_TxbAnnPymInc + trc_PblOffErn >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',25);
         trc_It3Ind := 0; -- Over Lim
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SeaCalc',26);
         trc_It3Ind := 1; -- Under Lim
      END IF;
   END IF;
...
BEGIN
   hr_utility.set_location('py_za_tx_01032004.SitCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'SitCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.SitCalc',2);
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.SitCalc',3);

-- Site Factor
--
   trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01032004.DaysWorked;

   hr_utility.set_location('py_za_tx_01032004.SitCalc',4);
...
-- Abatements
   ...
   hr_utility.set_location('py_za_tx_01032004.SitCalc',5);
...
--
   ...
   IF trc_DmdRmnRun <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.SitCalc',6);
      -- Taxable Deemed Remuneration
      trc_TxbDmdRmn := trc_DmdRmnRun;
      -- Threshold Check
      IF trc_TxbDmdRmn >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.SitCalc',7);
         -- Tax Liability
         trc_TotLibDR := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbDmdRmn);
         trc_LibFyDR  := (trc_TotLibDR - 0) / trc_SitFactor;
         trc_TotLibDR := greatest(trc_TotLibDR,0);
         trc_LibFpDR  := trc_LibFyDR - bal_TX_ON_DR_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SitCalc',8);
         -- Set Cascade Figures and Refund
         trc_TotLibDR   := 0;
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SitCalc',9);
      -- Set Cascade Figures and Refund
      trc_TxbDmdRmn  := 0;
      trc_TotLibDR   := 0;
      trc_LibFpDR    := -1 * bal_TX_ON_DR_YTD;
   ...
   hr_utility.set_location('py_za_tx_01032004.SitCalc',10);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.SitCalc',11);
      -- Normal Earnings
      ...
      -- Threshold Check
      IF trc_TxbNorInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.SitCalc',12);
         -- Tax Liability
         trc_TotLibNI := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbNorInc);
         ...
         trc_LibFpNI  := trc_LibFyNI - bal_TX_ON_NI_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SitCalc',13);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SitCalc',14);
      -- Set Cascade Figures and Refund
      trc_NorErn     := 0;
      trc_TxbNorInc  := 0;
      trc_TotLibNI   := trc_TotLibDR;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.SitCalc',15);
      -- Fringe Benefit Earnings
      ...
      -- Threshold Check
      IF trc_TxbFrnInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.SitCalc',16);
         -- Tax Liability
         trc_TotLibFB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbFrnInc);
         ...
         trc_LibFpFB  := trc_LibFyFB - bal_TX_ON_FB_YTD;
      ElSE
         hr_utility.set_location('py_za_tx_01032004.SitCalc',17);
         -- Set Cascade Figures and Refund
         trc_TotLibFB   := trc_TotLibNI;
         trc_LibFpFB    := -1 * bal_TX_ON_FB_YTD;
         trc_LibFpFBOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SitCalc',18);
      -- Set Cascade Figures and Refund
      trc_FrnBenErn  := trc_NorErn;
      trc_TxbFrnInc  := trc_TxbNorInc;
      trc_TotLibFB   := trc_TotLibNI;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.SitCalc',19);
      -- Travel Earnings
      ...
      -- Threshold Check
      IF trc_TxbTrvInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.SitCalc',20);
         -- Tax Liability
         trc_TotLibTA := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbTrvInc);
         ...
         trc_LibFpTA  := trc_LibFyTA - bal_TX_ON_TA_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SitCalc',21);
         -- Set Cascade Figures and Refund
         trc_TotLibTA   := trc_TotLibFB;
         trc_LibFpTA    := -1 * bal_TX_ON_TA_YTD;
         trc_LibFpTAOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SitCalc',22);
      -- Set Cascade Figures and Refund
      trc_TrvAllErn  := trc_FrnBenErn;
      trc_TxbTrvInc  := trc_TxbFrnInc;
      trc_TotLibTA   := trc_TotLibFB;
...
--
   ...
   IF trc_BonProYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.SitCalc',23);
      ...
      IF trc_TxbBonProInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.SitCalc',24);
         -- Tax Liability
         trc_TotLibBP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbBonProInc);
      ...
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SitCalc',25);
         -- Set Cascade Figures and Refund
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SitCalc',26);
      -- Set Cascade Figures and Refund
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.SitCalc',27);
      -- Annual Bonus Earnings
      trc_AnnBonErn := trc_AnnBonYtd + trc_TrvAllErn;
      -- Taxable Annual Bonus Income
      trc_TxbAnnBonInc := trc_AnnBonErn - trc_AnnTotAbm;
      -- Threshold Check
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.SitCalc',28);
         -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnBonInc);
         trc_LibFyAB := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibTA);
         trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibTA);
         hr_utility.set_location('py_za_tx_01032004.SitCalc',29);
         -- Check Bonus Provision
         IF trc_BonProYtd <> 0 THEN
            hr_utility.set_location('py_za_tx_01032004.SitCalc',30);
            -- Check Bonus Provision Frequency
            IF dbi_BP_TX_RCV = 'B' OR py_za_tx_utl_01032004.SitePeriod THEN
               hr_utility.set_location('py_za_tx_01032004.SitCalc',31);
               trc_LibFpAB :=
               trc_LibFyAB - (bal_TX_ON_BP_YTD
                             + trc_LibFpBP
                             + bal_TX_ON_AB_YTD);
            ELSE
               hr_utility.set_location('py_za_tx_01032004.SitCalc',32);
               trc_LibFpAB := 0;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.SitCalc',33);
            trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SitCalc',34);
         -- Set Cascade Figures and Refund
         trc_TotLibAB   := trc_TotLibTA;
         trc_LibFpAB    := -1 * bal_TX_ON_AB_YTD;
         trc_LibFpABOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SitCalc',35);
      -- Set Cascade Figures and Refund
      trc_LibFpAB      := -1 * bal_TX_ON_AB_YTD;
      trc_LibFpABOvr   := TRUE;

      IF dbi_BP_TX_RCV = 'A' AND py_za_tx_utl_01032004.SitePeriod THEN
         hr_utility.set_location('py_za_tx_01032004.SitCalc',36);
         trc_LibFpBP      := -1 * bal_TX_ON_BP_YTD;
         trc_LibFpBPOvr   := TRUE;
         trc_LibFpAPOvr   := TRUE;
         ...
         trc_TotLibAB     := trc_TotLibTA;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SitCalc',37);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.SitCalc',38);
      -- Annual Payments Earnings
      trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
      -- Taxable Annual Payments Income
      trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
      -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.SitCalc',39);
         -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
         trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
         trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.SitCalc',40);
         -- Set Cascade Figures and Refund
         trc_TotLibAP   := trc_TotLibAB;
         trc_LibFpAP    := -1 * bal_TX_ON_AP_YTD;
         trc_LibFpAPOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SitCalc',41);
      -- Set Cascade Figures and Refund
      trc_AnnPymErn    := trc_AnnBonErn;
      trc_TxbAnnPymInc := trc_TxbAnnBonInc;
      trc_TotLibAP     := trc_TotLibAB;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.SitCalc',42);
      -- Public Office Earnings
      ...
      trc_LibFpPO := trc_LibFyPO -  bal_TX_ON_PO_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SitCalc',43);
      -- Set Cascade Figures and Refund
      trc_LibFyPO    := 0;
      trc_LibFpPO    := -1 * bal_TX_ON_PO_YTD;
      trc_LibFpPOOvr := TRUE;
...
--
   ...
   -- Site Limit Check
   IF trc_TxbAnnPymInc + trc_PblOffErn < glb_ZA_SIT_LIM THEN
      hr_utility.set_location('py_za_tx_01032004.SitCalc',44);
      l_Sl := TRUE;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SitCalc',45);
      l_Sl := FALSE;
   END IF;

   py_za_tx_utl_01032004.ValidateTaxOns(p_Rf => l_Sl);

   hr_utility.set_location('py_za_tx_01032004.SitCalc',46);

-- Set IT3A Indicator
--
   IF trc_TxbAnnPymInc + trc_PblOffErn >= trc_Threshold THEN
      hr_utility.set_location('py_za_tx_01032004.SitCalc',47);
      trc_It3Ind := 0; -- Over Lim
   ELSE
      hr_utility.set_location('py_za_tx_01032004.SitCalc',48);
      trc_It3Ind := 1; -- Under Lim
   END IF;
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.SitCalc',49);
...
BEGIN
   hr_utility.set_location('py_za_tx_01032004.DirCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'DirCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.DirCalc',2);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',3);
      -- Normal Earnings
      trc_NorErn := trc_NorIncYtd;
      -- Tax Liability
      trc_TotLibNI := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_NorErn);
      trc_LibFyNI  := trc_TotLibNI - 0;
      trc_TotLibNI := greatest(trc_TotLibNI,0);
      trc_LibFpNI  := trc_LibFyNI - bal_TX_ON_NI_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.DirCalc',4);
      -- Set Cascade Figures and Refund
      trc_NorErn     := 0;
      trc_TotLibNI   := 0;
      trc_LibFpNI    := -1 * bal_TX_ON_NI_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',5);
      -- Fringe Benefit Earnings
      trc_FrnBenErn := trc_FrnBenYtd + trc_NorErn;
      -- Tax Liability
      trc_TotLibFB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_FrnBenErn);
      trc_LibFyFB  := trc_TotLibFB - least(trc_TotLibFB,trc_TotLibNI);
      trc_TotLibFB := greatest(trc_TotLibFB,trc_TotLibNI);
      trc_LibFpFB  := trc_LibFyFB - bal_TX_ON_FB_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.DirCalc',6);
      -- Set Cascade Figures and Refund
      trc_FrnBenErn  := trc_NorErn;
      trc_TotLibFB   := trc_TotLibNI;
      trc_LibFpFB    := -1 * bal_TX_ON_FB_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',7);
      -- Travel Allowance Earnings
      trc_TrvAllErn := trc_TrvAllYtd + trc_FrnBenErn;
      -- Tax Liability
      trc_TotLibTA := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TrvAllErn);
      trc_LibFyTA  := trc_TotLibTA - least(trc_TotLibTA,trc_TotLibFB);
      trc_TotLibTA := greatest(trc_TotLibTA,trc_TotLibFB);
      trc_LibFpTA  := trc_LibFyTA - bal_TX_ON_TA_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.DirCalc',8);
      -- Set Cascade Figures and Refund
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_BonProYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',9);
      -- Bonus Provision Earnings
      trc_BonProErn := trc_BonProYtd + trc_TrvAllErn;
      -- Tax Liability
      trc_TotLibBP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_BonProErn);
      trc_LibFyBP  := trc_TotLibBP - least(trc_TotLibBP,trc_TotLibTA);
      trc_TotLibBP := greatest(trc_TotLibBP,trc_TotLibTA);
      trc_LibFpBP  := trc_LibFyBP - bal_TX_ON_BP_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.DirCalc',10);
      -- Set Cascade Figures and Refund
      trc_BonProErn  := trc_TrvAllErn;
      trc_TotLibBP   := trc_TotLibTA;
      trc_LibFpBP    := -1 * bal_TX_ON_BP_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',11);
      -- Annual Bonus Earnings
      trc_AnnBonErn := trc_AnnBonYtd + trc_TrvAllErn;
      -- Tax Liability
      trc_TotLibAB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_AnnBonErn);
      trc_LibFyAB  := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibTA);
      trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibTA);
      -- Check Bonus Provision
      IF trc_BonProYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032004.DirCalc',12);
         -- Check Bonus Provision Frequency
         IF dbi_BP_TX_RCV = 'B' OR py_za_tx_utl_01032004.SitePeriod THEN
            hr_utility.set_location('py_za_tx_01032004.DirCalc',13);
            trc_LibFpAB :=
            trc_LibFyAB - (bal_TX_ON_BP_YTD
                          + trc_LibFpBP
                          + bal_TX_ON_AB_YTD);
         ELSE
            hr_utility.set_location('py_za_tx_01032004.DirCalc',14);
            trc_LibFpAB := 0;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.DirCalc',15);
         trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.DirCalc',16);
      -- Set Cascade Figures and Refund
      trc_LibFpAB    := -1 * bal_TX_ON_AB_YTD;
      trc_LibFpABOvr := TRUE;

      IF dbi_BP_TX_RCV = 'A' AND py_za_tx_utl_01032004.SitePeriod THEN
         hr_utility.set_location('py_za_tx_01032004.DirCalc',17);
         trc_LibFpBP    := -1 * bal_TX_ON_BP_YTD;
         trc_LibFpBPOvr := TRUE;
         trc_LibFpAPOvr := TRUE;
         ...
         trc_TotLibAB   := trc_TotLibTA;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.DirCalc',18);
         trc_AnnBonErn  := trc_BonProErn;
         trc_TotLibAB   := trc_TotLibBP;
      END IF;
   END IF;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',19);
      -- Annual Payments Earnings
      trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
      -- Tax Liability
      trc_TotLibAP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_AnnPymErn);
      trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
      trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
      trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
   ElSE
      hr_utility.set_location('py_za_tx_01032004.DirCalc',20);
      -- Set Cascade Figures and Refund
      trc_AnnPymErn  := trc_AnnBonErn;
      trc_TotLibAP   := trc_TotLibAB;
      trc_LibFpAP    := -1 * bal_TX_ON_AP_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',21);
      -- Tax Liability
      trc_LibFyPO := trc_PblOffYtd * glb_ZA_PBL_TX_RTE / 100;
      trc_LibFpPO := trc_LibFyPO -  bal_TX_ON_PO_YTD;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.DirCalc',22);
      -- Set Cascade Figures and Refund
      trc_LibFyPO    := 0;
      trc_LibFpPO    := -1 * bal_TX_ON_PO_YTD;
      trc_LibFpPOOvr := TRUE;
...
-- Net Pay Validation
--
   py_za_tx_utl_01032004.ValidateTaxOns(p_Rf => TRUE);

   hr_utility.set_location('py_za_tx_01032004.DirCalc',23);

-- Tax Percentage Indicator
--
   IF dbi_TX_STA    IN ('D','P') THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',24);
      trc_TxPercVal := dbi_TX_DIR_VAL;
   ELSIF dbi_TX_STA = 'E' THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',25);
      trc_TxPercVal := glb_ZA_CC_TX_PRC;
   ELSIF dbi_TX_STA = 'F' THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',26);
      trc_TxPercVal := glb_ZA_TMP_TX_RTE;
   ELSIF dbi_TX_STA = 'J' THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',27);
      trc_TxPercVal := glb_ZA_PER_SERV_COMP_PERC;
   ELSIF dbi_TX_STA = 'K' THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',28);
      trc_TxPercVal := glb_ZA_PER_SERV_TRST_PERC;
   ELSIF dbi_TX_STA = 'L' THEN
      hr_utility.set_location('py_za_tx_01032004.DirCalc',29);
      trc_TxPercVal := glb_ZA_PER_SERV_COMP_PERC;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.DirCalc',30);
      trc_TxPercVal := 0;
   END IF;

   hr_utility.set_location('py_za_tx_01032004.DirCalc',31);
...
BEGIN
   hr_utility.set_location('py_za_tx_01032004.BasCalc',1);
-- Identify the Calculation
--
   trc_CalTyp := 'BasCalc';
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_DmdRmnRun <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.BasCalc',2);
      -- Taxable Deemed Remuneration
      trc_TxbDmdRmn := trc_DmdRmnRun;
      -- Threshold Check
      IF trc_TxbDmdRmn >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.BasCalc',3);
         -- Tax Liability
         trc_TotLibDR := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbDmdRmn);
      ELSE
         hr_utility.set_location('py_za_tx_01032004.BasCalc',4);
         trc_TotLibDR := 0;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.BasCalc',5);
      trc_TotLibDR := 0;
   END IF;

   hr_utility.set_location('py_za_tx_01032004.BasCalc',6);
...
--
   ...
   -- Threshold Check
   IF trc_TxbBseInc >= trc_Threshold THEN
      hr_utility.set_location('py_za_tx_01032004.BasCalc',7);
      -- Tax Liability
      trc_TotLibBse := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbBseInc);
      trc_TotLibBse := greatest(trc_TotLibBse,trc_TotLibDR);
   ELSE
      hr_utility.set_location('py_za_tx_01032004.BasCalc',8);
      trc_TotLibBse := trc_TotLibDR;
   END IF;

   hr_utility.set_location('py_za_tx_01032004.BasCalc',9);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.BasCalc',10);
      -- Annual Bonus Earnings
      ...
      -- Threshold Check
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.BasCalc',11);
         -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnBonInc);
         ...
         IF bal_BP_YTD <> 0 THEN
            hr_utility.set_location('py_za_tx_01032004.BasCalc',12);
            -- Check Bonus Provision Frequency
            IF dbi_BP_TX_RCV = 'A' THEN
               hr_utility.set_location('py_za_tx_01032004.BasCalc',13);
               trc_LibFpAB := 0;
            ELSE
               hr_utility.set_location('py_za_tx_01032004.BasCalc',14);
               trc_LibFpAB := trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                            + bal_TX_ON_AB_YTD);
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.BasCalc',15);
            trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.BasCalc',16);
         trc_TotLibAB := trc_TotLibBse;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.BasCalc',17);
      trc_TotLibAB     := trc_TotLibBse;
      trc_TxbAnnBonInc := trc_TxbBseInc;
   END IF;

   hr_utility.set_location('py_za_tx_01032004.BasCalc',18);
...
--
   ...
   trc_AnnPymYtd :=
      ( bal_AA_PRCHD_RVAL_NRFI_YTD   + bal_AA_PRCHD_RVAL_RFI_YTD
      + bal_ANN_BUR_AND_SCH_NRFI_YTD + bal_ANN_BUR_AND_SCH_RFI_YTD
      + bal_ANN_IC_PYMNTS_NRFI_YTD   + bal_ANN_IC_PYMNTS_RFI_PTD
      + bal_ANN_LB_PYMNTS_NRFI_YTD   + bal_ANN_LB_PYMNTS_RFI_PTD
      + bal_ANN_PYM_DBT_NRFI_YTD     + bal_ANN_PYM_DBT_RFI_YTD
      + bal_AC_NRFI_YTD              + bal_AC_RFI_YTD
      + bal_ANU_FRM_RET_FND_NRFI_YTD + bal_ANU_FRM_RET_FND_RFI_YTD
      + bal_ARES_TRD_NRFI_YTD        + bal_ARES_TRD_RFI_YTD
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.BasCalc',19);
   -- Taxable Annual Payments Income
      trc_TxbAnnPymInc := trc_AnnPymYtd + trc_TxbAnnBonInc;
   -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.BasCalc',20);
      -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
         trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
         trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.BasCalc',21);
         NULL;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.BasCalc',22);
      NULL;
   END IF;
...
BEGIN
   hr_utility.set_location('py_za_tx_01032004.CalCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'CalCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.CalCalc',2);
...
--
   trc_TxbIncYtd :=
      ...
      + bal_IC_PYMNTS_NRFI_CYTD      + bal_IC_PYMNTS_RFI_CYTD
      + bal_LB_PYMNTS_NRFI_CYTD      + bal_LB_PYMNTS_RFI_CYTD
...
--
   IF trc_TxbIncYtd = 0 THEN
      hr_utility.set_location('py_za_tx_01032004.CalCalc',3);
      BasCalc;
   ELSE -- continue CalCalc
      hr_utility.set_location('py_za_tx_01032004.CalCalc',4);
   -- Site Factor
   --
      trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01032004.DaysWorked;
   ...
   -- Abatements
      ...
      hr_utility.set_location('py_za_tx_01032004.CalCalc',5);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_DmdRmnRun <> 0 THEN
         hr_utility.set_location('py_za_tx_01032004.CalCalc',6);
         -- Taxable Deemed Remuneration
         trc_TxbDmdRmn := trc_DmdRmnRun;
         -- Threshold Check
         IF trc_TxbDmdRmn >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032004.CalCalc',7);
         -- Tax Liability
            trc_TotLibDR := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbDmdRmn);
         ELSE
            hr_utility.set_location('py_za_tx_01032004.CalCalc',8);
            trc_TotLibDR := 0;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.CalCalc',9);
         trc_TotLibDR := 0;
      END IF;

      hr_utility.set_location('py_za_tx_01032004.CalCalc',10);
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.CalCalc',11);
         -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbBseInc);
         trc_TotLibBse := greatest(trc_TotLibBse,trc_TotLibDR);
      ELSE
         hr_utility.set_location('py_za_tx_01032004.CalCalc',12);
         trc_TotLibBse := trc_TotLibDR;
      END IF;

      hr_utility.set_location('py_za_tx_01032004.CalCalc',13);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnBonYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032004.CalCalc',14);
         -- Annual Bonus Earnings
         ...
         -- Threshold Check
         IF trc_TxbAnnBonInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032004.CalCalc',15);
            -- Tax Liability
            trc_TotLibAB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnBonInc);
            trc_LibFyAB := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibBse);
            trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibBse);
            -- Check Bonus Provision
            IF bal_BP_YTD <> 0 THEN
               hr_utility.set_location('py_za_tx_01032004.CalCalc',16);
               -- Check Bonus Provision Frequency
               IF dbi_BP_TX_RCV = 'A' THEN
                  hr_utility.set_location('py_za_tx_01032004.CalCalc',17);
                  trc_LibFpAB := 0;
               ELSE
                  hr_utility.set_location('py_za_tx_01032004.CalCalc',18);
                  trc_LibFpAB := trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                               + bal_TX_ON_AB_YTD);
               END IF;
            ELSE
               hr_utility.set_location('py_za_tx_01032004.CalCalc',19);
               trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.CalCalc',20);
            trc_TotLibAB := trc_TotLibBse;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.CalCalc',21);
         trc_AnnBonErn    := trc_BseErn;
         trc_TxbAnnBonInc := trc_TxbBseInc;
         trc_TotLibAB     := trc_TotLibBse;
      END IF;

      hr_utility.set_location('py_za_tx_01032004.CalCalc',22);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnPymYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032004.CalCalc',23);
         -- Annual Payments Earnings
         trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
         -- Taxable Annual Payments Income
         trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
         -- Threshold Check
         IF trc_TxbAnnPymInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032004.CalCalc',24);
            -- Tax Liability
            trc_TotLibAP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnPymInc);
            trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
            trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
            trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.CalCalc',25);
            trc_TotLibAP := trc_TotLibAB;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.CalCalc',26);
         trc_AnnPymErn    := trc_AnnBonErn;
         trc_TxbAnnPymInc := trc_TxbAnnBonInc;
         trc_TotLibAP     := trc_TotLibAB;
      END IF;
   ...
   hr_utility.set_location('py_za_tx_01032004.CalCalc',27);
...
BEGIN
   hr_utility.set_location('py_za_tx_01032004.YtdCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'YtdCalc';
...
-- Update Global Balance Values with correct TAXABLE values
   ...
   hr_utility.set_location('py_za_tx_01032004.YtdCalc',2);
...
-- If the Ytd Taxable Income = 0, execute the CalCalc
   IF trc_TxbIncYtd = 0 THEN
      hr_utility.set_location('py_za_tx_01032004.YtdCalc',3);
      CalCalc;
   ELSE --Continue YtdCalc
      hr_utility.set_location('py_za_tx_01032004.YtdCalc',4);
   -- Site Factor
      trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01032004.DaysWorked;
   ...
   -- Abatements
      ...
      hr_utility.set_location('py_za_tx_01032004.YtdCalc',5);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_DmdRmnRun <> 0 THEN
         hr_utility.set_location('py_za_tx_01032004.YtdCalc',6);
         -- Taxable Deemed Remuneration
         trc_TxbDmdRmn := trc_DmdRmnRun;
         -- Threshold Check
         IF trc_TxbDmdRmn >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032004.YtdCalc',7);
            -- Tax Liability
            trc_TotLibDR := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbDmdRmn);
         ELSE
            hr_utility.set_location('py_za_tx_01032004.YtdCalc',8);
            trc_TotLibDR := 0;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.YtdCalc',9);
         trc_TotLibDR := 0;
      END IF;

      hr_utility.set_location('py_za_tx_01032004.YtdCalc',10);
   ...
   --
      ...
      -- Threshold Check
      IF trc_TxbBseInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.YtdCalc',11);
         -- Tax Liability
         trc_TotLibBse := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbBseInc);
         trc_TotLibBse := greatest(trc_TotLibBse,trc_TotLibDR);
      ELSE
         hr_utility.set_location('py_za_tx_01032004.YtdCalc',12);
         trc_TotLibBse := trc_TotLibDR;
      END IF;

      hr_utility.set_location('py_za_tx_01032004.YtdCalc',13);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnBonYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032004.YtdCalc',14);
         -- Annual Bonus Earnings
         trc_AnnBonErn := trc_AnnBonYtd + trc_BseErn;
         -- Taxable Annual Bonus Income
         trc_TxbAnnBonInc := trc_AnnBonErn - trc_AnnTotAbm;
         -- Threshold Check
         IF trc_TxbAnnBonInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032004.YtdCalc',15);
            -- Tax Liability
            trc_TotLibAB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnBonInc);
            trc_LibFyAB  := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibBse);
            trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibBse);
            -- Check Bonus Provision
            IF bal_BP_YTD <> 0 THEN
               hr_utility.set_location('py_za_tx_01032004.YtdCalc',16);
               -- Check Bonus Provision Frequency
               IF dbi_BP_TX_RCV = 'A' THEN
                  hr_utility.set_location('py_za_tx_01032004.YtdCalc',17);
                  trc_LibFpAB := 0;
               ELSE
                  hr_utility.set_location('py_za_tx_01032004.YtdCalc',18);
                  trc_LibFpAB := trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                               + bal_TX_ON_AB_YTD);
               END IF;
            ELSE
               hr_utility.set_location('py_za_tx_01032004.YtdCalc',19);
               trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.YtdCalc',20);
            trc_TotLibAB := trc_TotLibBse;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.YtdCalc',21);
         trc_AnnBonErn    := trc_BseErn;
         trc_TxbAnnBonInc := trc_TxbBseInc;
         trc_TotLibAB     := trc_TotLibBse;
      END IF;

      hr_utility.set_location('py_za_tx_01032004.YtdCalc',22);
   ...
   --
      ...
      -- Skip the calculation if there is No Income
      IF trc_AnnPymYtd <> 0 THEN
         hr_utility.set_location('py_za_tx_01032004.YtdCalc',23);
         -- Annual Payments Earnings
         trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
         -- Taxable Annual Payments Income
         trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
         -- Threshold Check
         IF trc_TxbAnnPymInc >= trc_Threshold THEN
            hr_utility.set_location('py_za_tx_01032004.YtdCalc',24);
            -- Tax Liability
            trc_TotLibAP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnPymInc);
            trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
            trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
            trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.YtdCalc',25);
            trc_TotLibAP := trc_TotLibAB;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.YtdCalc',26);
         trc_AnnPymErn    := trc_AnnBonErn;
         trc_TxbAnnPymInc := trc_TxbAnnBonInc;
         trc_TotLibAP     := trc_TotLibAB;
      END IF;
   ...
   --
      ...
      hr_utility.set_location('py_za_tx_01032004.YtdCalc',27);
...
BEGIN
   hr_utility.set_location('py_za_tx_01032004.NorCalc',1);
-- Identify the calculation
--
   trc_CalTyp := 'NorCalc';
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.NorCalc',2);
...
-- Period Factor
   py_za_tx_utl_01032004.PeriodFactor;

-- Possible Periods Factor
   py_za_tx_utl_01032004.PossiblePeriodsFactor;
...
-- Abatements
   ...
   hr_utility.set_location('py_za_tx_01032004.NorCalc',3);
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_DmdRmnRun <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.NorCalc',4);
      -- Taxable Deemed Remuneration
      trc_TxbDmdRmn := trc_DmdRmnRun;
      -- Threshold Check
      IF trc_TxbDmdRmn >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.NorCalc',5);
         -- Tax Liability
         trc_TotLibDR := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbDmdRmn);
         trc_LibFyDR  := trc_TotLibDR - 0;
         trc_TotLibDR := greatest(trc_TotLibDR,0);
         -- DeAnnualise
         trc_LibFpDR := py_za_tx_utl_01032004.DeAnnualise
                           ( p_Liab    => trc_LibFyDR
                           , p_TxOnYtd => bal_TX_ON_DR_YTD
                           , p_TxOnPtd => bal_TX_ON_DR_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032004.NorCalc',6);
         -- Set Cascade Figures and Refund
         trc_TotLibDR   := 0;
         trc_LibFpDR    := -1 * bal_TX_ON_DR_YTD;
         trc_LibFpDROvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.NorCalc',7);
      -- Set Cascade Figures and Refund
      trc_TxbDmdRmn  := 0;
      trc_TotLibDR   := 0;
      trc_LibFpDR    := -1 * bal_TX_ON_DR_YTD;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_NorIncYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.NorCalc',8);

      -- Annualise Normal Income
      trc_NorErn := py_za_tx_utl_01032004.Annualise
      ...
      -- Threshold Check
      IF trc_TxbNorInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.NorCalc',9);
         -- Tax Liability
         trc_TotLibNI := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbNorInc);
         trc_LibFyNI  := trc_TotLibNI - least(trc_TotLibNI,trc_TotLibDR);
         trc_TotLibNI := greatest(trc_TotLibNI,trc_TotLibDR);
         -- DeAnnualise
         trc_LibFpNI := py_za_tx_utl_01032004.DeAnnualise
                           ( p_Liab    => trc_LibFyNI
                           , p_TxOnYtd => bal_TX_ON_NI_YTD
                           , p_TxOnPtd => bal_TX_ON_NI_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032004.NorCalc',10);
         -- Set Cascade Figures and Refund
         trc_TotLibNI   := trc_TotLibDR;
         trc_LibFpNI    := -1 * bal_TX_ON_NI_YTD;
         trc_LibFpNIOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.NorCalc',11);
      -- Set Cascade Figures and Refund
      trc_NorErn     := 0;
      trc_TxbNorInc  := 0;
      trc_TotLibNI   := trc_TotLibDR;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_FrnBenYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.NorCalc',12);

      -- Annualise Fringe Benefits
      trc_FrnBenErn := py_za_tx_utl_01032004.Annualise
      ...
      -- Threshold Check
      IF trc_TxbFrnInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.NorCalc',13);
         -- Tax Liability
         trc_TotLibFB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbFrnInc);
         trc_LibFyFB  := trc_TotLibFB - least(trc_TotLibFB,trc_TotLibNI);
         trc_TotLibFB := greatest(trc_TotLibFB,trc_TotLibNI);
         -- DeAnnualise
         trc_LibFpFB := py_za_tx_utl_01032004.DeAnnualise
                           ( trc_LibFyFB
                           , bal_TX_ON_FB_YTD
                           , bal_TX_ON_FB_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032004.NorCalc',14);
         -- Set Cascade Figures and Refund
         trc_TotLibFB   := trc_TotLibNI;
         trc_LibFpFB    := -1 * bal_TX_ON_FB_YTD;
         trc_LibFpFBOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.NorCalc',15);
      -- Set Cascade Figures and Refund
      trc_FrnBenErn  := trc_NorErn;
      trc_TxbFrnInc  := trc_TxbNorInc;
      trc_TotLibFB   := trc_TotLibNI;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_TrvAllYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.NorCalc',16);
      -- Ptd Travel Allowance
      trc_TrvAllPtd := bal_TA_NRFI_PTD + bal_TA_RFI_PTD;
      -- Annualise Travel Allowance
      trc_TrvAllErn := py_za_tx_utl_01032004.Annualise
      ...
      -- Threshold Check
      IF trc_TxbTrvInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.NorCalc',17);
         -- Tax Liability
         trc_TotLibTA := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbTrvInc);
         trc_LibFyTA  := trc_TotLibTA - least(trc_TotLibTA,trc_TotLibFB);
         trc_TotLibTA := greatest(trc_TotLibTA,trc_TotLibFB);
         -- DeAnnualise
         trc_LibFpTA := py_za_tx_utl_01032004.DeAnnualise
                           ( trc_LibFyTA
                           , bal_TX_ON_TA_YTD
                           , bal_TX_ON_TA_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032004.NorCalc',18);
         -- Set Cascade Figures and Refund
         trc_TotLibTA   := trc_TotLibFB;
         trc_LibFpTA    := -1 * bal_TX_ON_TA_YTD;
         trc_LibFpTAOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.NorCalc',19);
      -- Set Cascade Figures and Refund
      trc_TrvAllErn  := trc_FrnBenErn;
      trc_TxbTrvInc  := trc_TxbFrnInc;
      trc_TotLibTA   := trc_TotLibFB;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_BonProYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.NorCalc',20);
      -- Annualise Bonus Provision
      trc_BonProErn := py_za_tx_utl_01032004.Annualise
      ...
      -- Threshold Check
      IF trc_TxbBonProInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.NorCalc',21);
         -- Tax Liability
         trc_TotLibBP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbBonProInc);
         trc_LibFyBP  := trc_TotLibBP - least(trc_TotLibBP,trc_TotLibTA);
         trc_TotLibBP := greatest(trc_TotLibBP,trc_TotLibTA);
         -- DeAnnualise
         trc_LibFpBP := py_za_tx_utl_01032004.DeAnnualise
                           ( trc_LibFyBP
                           , bal_TX_ON_BP_YTD
                           , bal_TX_ON_BP_PTD
                           );
      ELSE
         hr_utility.set_location('py_za_tx_01032004.NorCalc',22);
         -- Set Cascade Figures and Refund
         trc_TotLibBP   := trc_TotLibTA;
         trc_LibFpBP    := -1 * bal_TX_ON_BP_YTD;
         trc_LibFpBPOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.NorCalc',23);
      -- Set Cascade Figures and Refund
      trc_BonProErn    := trc_TrvAllErn;
      trc_TxbBonProInc := trc_TxbTrvInc;
      trc_TotLibBP     := trc_TotLibTA;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnBonYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.NorCalc',24);
      -- Annual Bonus Earnings
      trc_AnnBonErn := trc_AnnBonYtd + trc_TrvAllErn;
      -- Taxable Annual Bonus Income
      trc_TxbAnnBonInc := trc_AnnBonErn - trc_AnnTotAbm;
      -- Threshold Check
      IF trc_TxbAnnBonInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.NorCalc',25);
         -- Tax Liability
         trc_TotLibAB := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnBonInc);
         trc_LibFyAB  := trc_TotLibAB - least(trc_TotLibAB,trc_TotLibTA);
         trc_TotLibAB := greatest(trc_TotLibAB,trc_TotLibTA);
         -- Check Bonus Provision
         IF trc_BonProYtd <> 0 THEN
            hr_utility.set_location('py_za_tx_01032004.NorCalc',26);
            -- Check Bonus Provision Frequency
            IF dbi_BP_TX_RCV = 'A' THEN
               hr_utility.set_location('py_za_tx_01032004.NorCalc',27);
               trc_LibFpAB := 0;
            ELSE
               hr_utility.set_location('py_za_tx_01032004.NorCalc',28);
               trc_LibFpAB := trc_LibFyAB - ( bal_TX_ON_BP_YTD
                                            + trc_LibFpBP
                                            + bal_TX_ON_AB_YTD);
            END IF;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.NorCalc',29);
            trc_LibFpAB := trc_LibFyAB - bal_TX_ON_AB_YTD;
         END IF;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.NorCalc',30);
         -- Set Cascade Figures and Refund
         trc_TotLibAB   := trc_TotLibTA;
         trc_LibFpAB    := -1 * bal_TX_ON_AB_YTD;
         trc_LibFpABOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.NorCalc',31);
      -- Set Cascade Figures and Refund
      trc_AnnBonErn    := trc_BonProErn;
      trc_TxbAnnBonInc := trc_TxbBonProInc;
      trc_TotLibAB     := trc_TotLibBP;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_AnnPymYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.NorCalc',32);
      -- Annual Payments Earnings
      trc_AnnPymErn := trc_AnnPymYtd + trc_AnnBonErn;
      -- Taxable Annual Payments Income
      trc_TxbAnnPymInc := trc_AnnPymErn - trc_AnnTotAbm;
      -- Threshold Check
      IF trc_TxbAnnPymInc >= trc_Threshold THEN
         hr_utility.set_location('py_za_tx_01032004.NorCalc',33);
         -- Tax Liability
         trc_TotLibAP := py_za_tx_utl_01032004.TaxLiability(p_Amt => trc_TxbAnnPymInc);
         trc_LibFyAP  := trc_TotLibAP - least(trc_TotLibAP,trc_TotLibAB);
         trc_TotLibAP := greatest(trc_TotLibAP,trc_TotLibAB);
         hr_utility.set_location('py_za_tx_01032004.NorCalc',34);
         trc_LibFpAP  := trc_LibFyAP - bal_TX_ON_AP_YTD;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.NorCalc',35);
         -- Set Cascade Figures and Refund
         trc_TotLibAP   := trc_TotLibAB;
         trc_LibFpAP    := -1 * bal_TX_ON_AP_YTD;
         trc_LibFpAPOvr := TRUE;
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.NorCalc',36);
      -- Set Cascade Figures and Refund
      trc_AnnPymErn    := trc_AnnBonErn;
      trc_TxbAnnPymInc := trc_TxbAnnBonInc;
      trc_TotLibAP     := trc_TotLibAB;
...
--
   ...
   -- Skip the calculation if there is No Income
   IF trc_PblOffYtd <> 0 THEN
      hr_utility.set_location('py_za_tx_01032004.NorCalc',37);
      -- Ptd Public Office Allowance
      trc_PblOffPtd :=bal_PO_NRFI_PTD + bal_PO_RFI_PTD;
      -- Annualise Public Office Allowance
      trc_PblOffErn := py_za_tx_utl_01032004.Annualise
                          ( p_YtdInc => trc_PblOffYtd
                          , p_PtdInc => trc_PblOffPtd
                          );
      -- Tax Liability
      trc_LibFyPO := trc_PblOffErn * glb_ZA_PBL_TX_RTE / 100;
      trc_LibFpPO := py_za_tx_utl_01032004.DeAnnualise
                        ( trc_LibFyPO
                        , bal_TX_ON_PO_YTD
                        , bal_TX_ON_PO_PTD
                        );
   ELSE
      hr_utility.set_location('py_za_tx_01032004.NorCalc',38);
      -- Set Cascade Figures and Refund
      trc_LibFpPO    := -1 * bal_TX_ON_PO_YTD;
      trc_LibFpPOOvr := TRUE;
   END IF;
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.NorCalc',39);
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxGlb_01032004: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxGlb_01032004;
-------------------------------------------------------------------------------
-- ZaTxDbi_01032004                                                          --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
-- Initialise Package Globals
-- Database Items
   dbi_ASG_SAL             := p_ASG_SAL;
   dbi_ASG_SAL_FCTR        := p_ASG_SAL_FCTR;
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxDbi_01032004: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxDbi_01032004;
-------------------------------------------------------------------------------
-- ZaTxBal1_01032004                                                         --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
-- Balances
   ...
   bal_ANN_IC_PYMNTS_NRFI_CMTD    := p_ANN_IC_PYMNTS_NRFI_CMTD;
   bal_ANN_IC_PYMNTS_NRFI_CYTD    := p_ANN_IC_PYMNTS_NRFI_CYTD;
   bal_ANN_IC_PYMNTS_NRFI_RUN     := p_ANN_IC_PYMNTS_NRFI_RUN;
   bal_ANN_IC_PYMNTS_NRFI_PTD     := p_ANN_IC_PYMNTS_NRFI_PTD;
   bal_ANN_IC_PYMNTS_NRFI_QTD     := p_ANN_IC_PYMNTS_NRFI_QTD;
   bal_ANN_IC_PYMNTS_NRFI_YTD     := p_ANN_IC_PYMNTS_NRFI_YTD;
   bal_ANN_IC_PYMNTS_RFI_CMTD     := p_ANN_IC_PYMNTS_RFI_CMTD;
   bal_ANN_IC_PYMNTS_RFI_CYTD     := p_ANN_IC_PYMNTS_RFI_CYTD;
   bal_ANN_IC_PYMNTS_RFI_RUN      := p_ANN_IC_PYMNTS_RFI_RUN;
   bal_ANN_IC_PYMNTS_RFI_PTD      := p_ANN_IC_PYMNTS_RFI_PTD;
   bal_ANN_IC_PYMNTS_RFI_QTD      := p_ANN_IC_PYMNTS_RFI_QTD;
   bal_ANN_IC_PYMNTS_RFI_YTD      := p_ANN_IC_PYMNTS_RFI_YTD;
   bal_ANN_LB_PYMNTS_NRFI_CMTD    := p_ANN_LB_PYMNTS_NRFI_CMTD;
   bal_ANN_LB_PYMNTS_NRFI_CYTD    := p_ANN_LB_PYMNTS_NRFI_CYTD;
   bal_ANN_LB_PYMNTS_NRFI_RUN     := p_ANN_LB_PYMNTS_NRFI_RUN;
   bal_ANN_LB_PYMNTS_NRFI_PTD     := p_ANN_LB_PYMNTS_NRFI_PTD;
   bal_ANN_LB_PYMNTS_NRFI_QTD     := p_ANN_LB_PYMNTS_NRFI_QTD;
   bal_ANN_LB_PYMNTS_NRFI_YTD     := p_ANN_LB_PYMNTS_NRFI_YTD;
   bal_ANN_LB_PYMNTS_RFI_CMTD     := p_ANN_LB_PYMNTS_RFI_CMTD;
   bal_ANN_LB_PYMNTS_RFI_CYTD     := p_ANN_LB_PYMNTS_RFI_CYTD;
   bal_ANN_LB_PYMNTS_RFI_RUN      := p_ANN_LB_PYMNTS_RFI_RUN;
   bal_ANN_LB_PYMNTS_RFI_PTD      := p_ANN_LB_PYMNTS_RFI_PTD;
   bal_ANN_LB_PYMNTS_RFI_QTD      := p_ANN_LB_PYMNTS_RFI_QTD;
   bal_ANN_LB_PYMNTS_RFI_YTD      := p_ANN_LB_PYMNTS_RFI_YTD;
   bal_ANN_NRFI_TOT_PKG_CMTD      := p_ANN_NRFI_TOT_PKG_CMTD;
   bal_ANN_NRFI_TOT_PKG_PTD       := p_ANN_NRFI_TOT_PKG_PTD;
   bal_ANN_NRFI_TOT_PKG_YTD       := p_ANN_NRFI_TOT_PKG_YTD;
   bal_ANN_PYM_DBT_NRFI_CMTD      := p_ANN_PYM_DBT_NRFI_CMTD;
   bal_ANN_PYM_DBT_NRFI_RUN       := p_ANN_PYM_DBT_NRFI_RUN;
   bal_ANN_PYM_DBT_NRFI_PTD       := p_ANN_PYM_DBT_NRFI_PTD;
   bal_ANN_PYM_DBT_NRFI_YTD       := p_ANN_PYM_DBT_NRFI_YTD;
   bal_ANN_PYM_DBT_RFI_CMTD       := p_ANN_PYM_DBT_RFI_CMTD;
   bal_ANN_PYM_DBT_RFI_RUN        := p_ANN_PYM_DBT_RFI_RUN;
   bal_ANN_PYM_DBT_RFI_PTD        := p_ANN_PYM_DBT_RFI_PTD;
   bal_ANN_PYM_DBT_RFI_YTD        := p_ANN_PYM_DBT_RFI_YTD;
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal1_01032004: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal1_01032004;
-------------------------------------------------------------------------------
-- ZaTxBal2_01032004                                                         --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
-- Balances
   ...
   bal_ANN_RFI_TOT_PKG_CMTD       := p_ANN_RFI_TOT_PKG_CMTD;
   bal_ANN_RFI_TOT_PKG_PTD        := p_ANN_RFI_TOT_PKG_PTD;
   bal_ANN_RFI_TOT_PKG_YTD        := p_ANN_RFI_TOT_PKG_YTD;
   bal_ANN_TXB_PKG_COMP_CMTD      := p_ANN_TXB_PKG_COMP_CMTD;
   bal_ANN_TXB_PKG_COMP_CYTD      := p_ANN_TXB_PKG_COMP_CYTD;
   bal_ANN_TXB_PKG_COMP_RUN       := p_ANN_TXB_PKG_COMP_RUN;
   bal_ANN_TXB_PKG_COMP_PTD       := p_ANN_TXB_PKG_COMP_PTD;
   bal_ANN_TXB_PKG_COMP_YTD       := p_ANN_TXB_PKG_COMP_YTD;
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal2_01032004: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal2_01032004;
-------------------------------------------------------------------------------
-- ZaTxBal3_01032004                                                         --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
-- Balances
   ...
   bal_IC_PYMNTS_NRFI_CMTD        := p_IC_PYMNTS_NRFI_CMTD;
   bal_IC_PYMNTS_NRFI_CYTD        := p_IC_PYMNTS_NRFI_CYTD;
   bal_IC_PYMNTS_NRFI_RUN         := p_IC_PYMNTS_NRFI_RUN;
   bal_IC_PYMNTS_NRFI_PTD         := p_IC_PYMNTS_NRFI_PTD;
   bal_IC_PYMNTS_NRFI_QTD         := p_IC_PYMNTS_NRFI_QTD;
   bal_IC_PYMNTS_NRFI_YTD         := p_IC_PYMNTS_NRFI_YTD;
   bal_IC_PYMNTS_RFI_CMTD         := p_IC_PYMNTS_RFI_CMTD;
   bal_IC_PYMNTS_RFI_CYTD         := p_IC_PYMNTS_RFI_CYTD;
   bal_IC_PYMNTS_RFI_RUN          := p_IC_PYMNTS_RFI_RUN;
   bal_IC_PYMNTS_RFI_PTD          := p_IC_PYMNTS_RFI_PTD;
   bal_IC_PYMNTS_RFI_QTD          := p_IC_PYMNTS_RFI_QTD;
   bal_IC_PYMNTS_RFI_YTD          := p_IC_PYMNTS_RFI_YTD;
   bal_LB_PYMNTS_NRFI_CMTD        := p_LB_PYMNTS_NRFI_CMTD;
   bal_LB_PYMNTS_NRFI_CYTD        := p_LB_PYMNTS_NRFI_CYTD;
   bal_LB_PYMNTS_NRFI_RUN         := p_LB_PYMNTS_NRFI_RUN;
   bal_LB_PYMNTS_NRFI_PTD         := p_LB_PYMNTS_NRFI_PTD;
   bal_LB_PYMNTS_NRFI_QTD         := p_LB_PYMNTS_NRFI_QTD;
   bal_LB_PYMNTS_NRFI_YTD         := p_LB_PYMNTS_NRFI_YTD;
   bal_LB_PYMNTS_RFI_CMTD         := p_LB_PYMNTS_RFI_CMTD;
   bal_LB_PYMNTS_RFI_CYTD         := p_LB_PYMNTS_RFI_CYTD;
   bal_LB_PYMNTS_RFI_RUN          := p_LB_PYMNTS_RFI_RUN;
   bal_LB_PYMNTS_RFI_PTD          := p_LB_PYMNTS_RFI_PTD;
   bal_LB_PYMNTS_RFI_QTD          := p_LB_PYMNTS_RFI_QTD;
   bal_LB_PYMNTS_RFI_YTD          := p_LB_PYMNTS_RFI_YTD;

   RETURN l_Dum;
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal3_01032004: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal3_01032004;
-------------------------------------------------------------------------------
-- ZaTxBal4_01032004                                                         --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
-- Balances
   ...
   bal_NRFI_TOT_PKG_CMTD          := p_NRFI_TOT_PKG_CMTD;
   bal_NRFI_TOT_PKG_CYTD          := p_NRFI_TOT_PKG_CYTD;
   bal_NRFI_TOT_PKG_PTD           := p_NRFI_TOT_PKG_PTD;
   bal_NRFI_TOT_PKG_YTD           := p_NRFI_TOT_PKG_YTD;
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal4_01032004: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal4_01032004;
-------------------------------------------------------------------------------
-- ZaTxBal5_01032004                                                         --
-- Tax module supporting function                                            --
-------------------------------------------------------------------------------
...
-- Balances
   ...
   bal_RFI_TOT_PKG_CMTD           := p_RFI_TOT_PKG_CMTD;
   bal_RFI_TOT_PKG_CYTD           := p_RFI_TOT_PKG_CYTD;
   bal_RFI_TOT_PKG_PTD            := p_RFI_TOT_PKG_PTD;
   bal_RFI_TOT_PKG_YTD            := p_RFI_TOT_PKG_YTD;
   ...
   bal_TXB_PKG_COMP_CMTD          := p_TXB_PKG_COMP_CMTD;
   bal_TXB_PKG_COMP_CYTD          := p_TXB_PKG_COMP_CYTD;
   bal_TXB_PKG_COMP_RUN           := p_TXB_PKG_COMP_RUN;
   bal_TXB_PKG_COMP_PTD           := p_TXB_PKG_COMP_PTD;
   bal_TXB_PKG_COMP_YTD           := p_TXB_PKG_COMP_YTD;
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal5_01032004: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal5_01032004;
...
EXCEPTION
   WHEN OTHERS THEN
      hr_utility.set_message(801, 'ZaTxBal6_01032004: '||TO_CHAR(SQLCODE));
      hr_utility.raise_error;
END ZaTxBal6_01032004;
...
--
--   py_za_tx_utl_01032004.g_HrTraceEnabled  := TRUE;
--   py_za_tx_utl_01032004.g_HrTracePipeName := 'ZATAX';

-- Call hr_utility start procedure
   py_za_tx_utl_01032004.StartHrTrace;
...
-- Setup Trace Header Info
   ...
   WrtHrTrc('-------------------------------------------------------------------------------');
   WrtHrTrc('   dbi_ASG_SAL:                   '||to_char(dbi_ASG_SAL                         ));
   WrtHrTrc('   dbi_ASG_SAL_FCTR:              '||to_char(dbi_ASG_SAL_FCTR                    ));
   WrtHrTrc('   dbi_BP_TX_RCV:                 '||        dbi_BP_TX_RCV                        );
   WrtHrTrc('   dbi_FXD_PRC:                   '||        dbi_FXD_PRC                          );
   ...
   WrtHrTrc('   dbi_TOT_PKG:                   '||to_char(dbi_TOT_PKG                         ));
   ...
   WrtHrTrc('   dbi_ASG_PEN_BAS:               '||        dbi_ASG_PEN_BAS                      );
   ...
   WrtHrTrc('   bal_ANN_IC_PYMNTS_NRFI_CMTD:   '||to_char(bal_ANN_IC_PYMNTS_NRFI_CMTD  ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_NRFI_CYTD:   '||to_char(bal_ANN_IC_PYMNTS_NRFI_CYTD  ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_NRFI_RUN:    '||to_char(bal_ANN_IC_PYMNTS_NRFI_RUN   ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_NRFI_PTD:    '||to_char(bal_ANN_IC_PYMNTS_NRFI_PTD   ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_NRFI_QTD:    '||to_char(bal_ANN_IC_PYMNTS_NRFI_QTD   ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_NRFI_YTD:    '||to_char(bal_ANN_IC_PYMNTS_NRFI_YTD   ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_RFI_CMTD:    '||to_char(bal_ANN_IC_PYMNTS_RFI_CMTD   ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_RFI_CYTD:    '||to_char(bal_ANN_IC_PYMNTS_RFI_CYTD   ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_RFI_RUN:     '||to_char(bal_ANN_IC_PYMNTS_RFI_RUN    ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_RFI_PTD:     '||to_char(bal_ANN_IC_PYMNTS_RFI_PTD    ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_RFI_QTD:     '||to_char(bal_ANN_IC_PYMNTS_RFI_QTD    ));
   WrtHrTrc('   bal_ANN_IC_PYMNTS_RFI_YTD:     '||to_char(bal_ANN_IC_PYMNTS_RFI_YTD    ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_NRFI_CMTD:   '||to_char(bal_ANN_LB_PYMNTS_NRFI_CMTD  ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_NRFI_CYTD:   '||to_char(bal_ANN_LB_PYMNTS_NRFI_CYTD  ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_NRFI_RUN:    '||to_char(bal_ANN_LB_PYMNTS_NRFI_RUN   ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_NRFI_PTD:    '||to_char(bal_ANN_LB_PYMNTS_NRFI_PTD   ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_NRFI_QTD:    '||to_char(bal_ANN_LB_PYMNTS_NRFI_QTD   ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_NRFI_YTD:    '||to_char(bal_ANN_LB_PYMNTS_NRFI_YTD   ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_RFI_CMTD:    '||to_char(bal_ANN_LB_PYMNTS_RFI_CMTD   ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_RFI_CYTD:    '||to_char(bal_ANN_LB_PYMNTS_RFI_CYTD   ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_RFI_RUN:     '||to_char(bal_ANN_LB_PYMNTS_RFI_RUN    ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_RFI_PTD:     '||to_char(bal_ANN_LB_PYMNTS_RFI_PTD    ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_RFI_QTD:     '||to_char(bal_ANN_LB_PYMNTS_RFI_QTD    ));
   WrtHrTrc('   bal_ANN_LB_PYMNTS_RFI_YTD:     '||to_char(bal_ANN_LB_PYMNTS_RFI_YTD    ));
   WrtHrTrc('   bal_ANN_NRFI_TOT_PKG_CMTD:     '||to_char(bal_ANN_NRFI_TOT_PKG_CMTD     ));
   WrtHrTrc('   bal_ANN_NRFI_TOT_PKG_PTD:      '||to_char(bal_ANN_NRFI_TOT_PKG_PTD     ));
   WrtHrTrc('   bal_ANN_NRFI_TOT_PKG_YTD:      '||to_char(bal_ANN_NRFI_TOT_PKG_YTD     ));
   WrtHrTrc('   bal_ANN_PYM_DBT_NRFI_CMTD:     '||to_char(bal_ANN_PYM_DBT_NRFI_CMTD    ));
   WrtHrTrc('   bal_ANN_PYM_DBT_NRFI_RUN:      '||to_char(bal_ANN_PYM_DBT_NRFI_RUN     ));
   WrtHrTrc('   bal_ANN_PYM_DBT_NRFI_PTD:      '||to_char(bal_ANN_PYM_DBT_NRFI_PTD     ));
   WrtHrTrc('   bal_ANN_PYM_DBT_NRFI_YTD:      '||to_char(bal_ANN_PYM_DBT_NRFI_YTD     ));
   WrtHrTrc('   bal_ANN_PYM_DBT_RFI_CMTD:      '||to_char(bal_ANN_PYM_DBT_RFI_CMTD     ));
   WrtHrTrc('   bal_ANN_PYM_DBT_RFI_RUN:       '||to_char(bal_ANN_PYM_DBT_RFI_RUN      ));
   WrtHrTrc('   bal_ANN_PYM_DBT_RFI_PTD:       '||to_char(bal_ANN_PYM_DBT_RFI_PTD      ));
   WrtHrTrc('   bal_ANN_PYM_DBT_RFI_YTD:       '||to_char(bal_ANN_PYM_DBT_RFI_YTD      ));
   ...
   WrtHrTrc('   bal_ANN_RFI_TOT_PKG_CMTD:      '||to_char(bal_ANN_RFI_TOT_PKG_CMTD     ));
   WrtHrTrc('   bal_ANN_RFI_TOT_PKG_PTD:       '||to_char(bal_ANN_RFI_TOT_PKG_PTD      ));
   WrtHrTrc('   bal_ANN_RFI_TOT_PKG_YTD:       '||to_char(bal_ANN_RFI_TOT_PKG_YTD      ));
   WrtHrTrc('   bal_ANN_TXB_PKG_COMP_CMTD:     '||to_char(bal_ANN_TXB_PKG_COMP_CMTD    ));
   WrtHrTrc('   bal_ANN_TXB_PKG_COMP_CYTD:     '||to_char(bal_ANN_TXB_PKG_COMP_CYTD    ));
   WrtHrTrc('   bal_ANN_TXB_PKG_COMP_RUN:      '||to_char(bal_ANN_TXB_PKG_COMP_RUN     ));
   WrtHrTrc('   bal_ANN_TXB_PKG_COMP_PTD:      '||to_char(bal_ANN_TXB_PKG_COMP_PTD     ));
   WrtHrTrc('   bal_ANN_TXB_PKG_COMP_YTD:      '||to_char(bal_ANN_TXB_PKG_COMP_YTD     ));
   ...
   WrtHrTrc('   bal_IC_PYMNTS_NRFI_CMTD:       '||to_char(bal_IC_PYMNTS_NRFI_CMTD      ));
   WrtHrTrc('   bal_IC_PYMNTS_NRFI_CYTD:       '||to_char(bal_IC_PYMNTS_NRFI_CYTD      ));
   WrtHrTrc('   bal_IC_PYMNTS_NRFI_RUN:        '||to_char(bal_IC_PYMNTS_NRFI_RUN       ));
   WrtHrTrc('   bal_IC_PYMNTS_NRFI_PTD:        '||to_char(bal_IC_PYMNTS_NRFI_PTD       ));
   WrtHrTrc('   bal_IC_PYMNTS_NRFI_QTD:        '||to_char(bal_IC_PYMNTS_NRFI_QTD       ));
   WrtHrTrc('   bal_IC_PYMNTS_NRFI_YTD:        '||to_char(bal_IC_PYMNTS_NRFI_YTD       ));
   WrtHrTrc('   bal_IC_PYMNTS_RFI_CMTD:        '||to_char(bal_IC_PYMNTS_RFI_CMTD       ));
   WrtHrTrc('   bal_IC_PYMNTS_RFI_CYTD:        '||to_char(bal_IC_PYMNTS_RFI_CYTD       ));
   WrtHrTrc('   bal_IC_PYMNTS_RFI_RUN:         '||to_char(bal_IC_PYMNTS_RFI_RUN        ));
   WrtHrTrc('   bal_IC_PYMNTS_RFI_PTD:         '||to_char(bal_IC_PYMNTS_RFI_PTD        ));
   WrtHrTrc('   bal_IC_PYMNTS_RFI_QTD:         '||to_char(bal_IC_PYMNTS_RFI_QTD        ));
   WrtHrTrc('   bal_IC_PYMNTS_RFI_YTD:         '||to_char(bal_IC_PYMNTS_RFI_YTD        ));
   WrtHrTrc('   bal_LB_PYMNTS_NRFI_CMTD:       '||to_char(bal_LB_PYMNTS_NRFI_CMTD      ));
   WrtHrTrc('   bal_LB_PYMNTS_NRFI_CYTD:       '||to_char(bal_LB_PYMNTS_NRFI_CYTD      ));
   WrtHrTrc('   bal_LB_PYMNTS_NRFI_RUN:        '||to_char(bal_LB_PYMNTS_NRFI_RUN       ));
   WrtHrTrc('   bal_LB_PYMNTS_NRFI_PTD:        '||to_char(bal_LB_PYMNTS_NRFI_PTD       ));
   WrtHrTrc('   bal_LB_PYMNTS_NRFI_QTD:        '||to_char(bal_LB_PYMNTS_NRFI_QTD       ));
   WrtHrTrc('   bal_LB_PYMNTS_NRFI_YTD:        '||to_char(bal_LB_PYMNTS_NRFI_YTD       ));
   WrtHrTrc('   bal_LB_PYMNTS_RFI_CMTD:        '||to_char(bal_LB_PYMNTS_RFI_CMTD       ));
   WrtHrTrc('   bal_LB_PYMNTS_RFI_CYTD:        '||to_char(bal_LB_PYMNTS_RFI_CYTD       ));
   WrtHrTrc('   bal_LB_PYMNTS_RFI_RUN:         '||to_char(bal_LB_PYMNTS_RFI_RUN        ));
   WrtHrTrc('   bal_LB_PYMNTS_RFI_PTD:         '||to_char(bal_LB_PYMNTS_RFI_PTD        ));
   WrtHrTrc('   bal_LB_PYMNTS_RFI_QTD:         '||to_char(bal_LB_PYMNTS_RFI_QTD        ));
   WrtHrTrc('   bal_LB_PYMNTS_RFI_YTD:         '||to_char(bal_LB_PYMNTS_RFI_YTD        ));
   ...
   WrtHrTrc('   bal_NET_TXB_INC_CMTD:          '||to_char(bal_NET_TXB_INC_CMTD         ));
   WrtHrTrc('   bal_NRFI_TOT_PKG_CMTD:         '||to_char(bal_NRFI_TOT_PKG_CMTD        ));
   WrtHrTrc('   bal_NRFI_TOT_PKG_CYTD:         '||to_char(bal_NRFI_TOT_PKG_CYTD        ));
   WrtHrTrc('   bal_NRFI_TOT_PKG_PTD:          '||to_char(bal_NRFI_TOT_PKG_PTD         ));
   WrtHrTrc('   bal_NRFI_TOT_PKG_YTD:          '||to_char(bal_NRFI_TOT_PKG_YTD         ));
   ...
   WrtHrTrc('   bal_RFI_TOT_PKG_CMTD:          '||to_char(bal_RFI_TOT_PKG_CMTD         ));
   WrtHrTrc('   bal_RFI_TOT_PKG_CYTD:          '||to_char(bal_RFI_TOT_PKG_CYTD         ));
   WrtHrTrc('   bal_RFI_TOT_PKG_PTD:           '||to_char(bal_RFI_TOT_PKG_PTD          ));
   WrtHrTrc('   bal_RFI_TOT_PKG_YTD:           '||to_char(bal_RFI_TOT_PKG_YTD          ));
   ...
   WrtHrTrc('   bal_TXB_PKG_COMP_CMTD:         '||to_char(bal_TXB_PKG_COMP_CMTD        ));
   WrtHrTrc('   bal_TXB_PKG_COMP_CYTD:         '||to_char(bal_TXB_PKG_COMP_CYTD        ));
   WrtHrTrc('   bal_TXB_PKG_COMP_RUN:          '||to_char(bal_TXB_PKG_COMP_RUN         ));
   WrtHrTrc('   bal_TXB_PKG_COMP_PTD:          '||to_char(bal_TXB_PKG_COMP_PTD         ));
   WrtHrTrc('   bal_TXB_PKG_COMP_YTD:          '||to_char(bal_TXB_PKG_COMP_YTD         ));
   ...
   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',1);
...
-- Contexts
   ...
   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',2);

-- Temporary Fixed Percentage Check
--
   IF  dbi_ASG_PEN_BAS = '1' AND dbi_FXD_PRC = -1 THEN
      RAISE xpt_FxdPrc;
   END IF;
...
--
   ...
   */
   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',3);
...
--
   IF dbi_TX_STA IN ('C','N') THEN
      IF trc_OvrTxCalc AND (trc_OvrTyp = 'S' OR trc_OvrTyp = 'P') THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',4);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',5);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_C';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',6);
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',7);
         trc_CalTyp := 'OvrCalc';
      ...
      ELSIF dbi_TX_DIR_NUM = 'NULL' THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',8);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',9);
            xpt_Msg := 'PY_ZA_TX_DIR_NUM';
         END IF;
         RAISE xpt_E;
      -- Check that directive value is filled in
      ELSIF dbi_TX_DIR_VAL = -1 THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',10);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',11);
            xpt_Msg := 'PY_ZA_TX_DIR_MONT';
         END IF;
         RAISE xpt_E;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',12);
         trc_CalTyp := 'NoCalc';
...
--
   ELSIF dbi_TX_STA IN ('D','P') THEN
      IF trc_OvrTxCalc AND trc_OvrTyp = 'S' THEN
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',13);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_DEF';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',14);
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',15);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'P' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',16);
            trc_OvrWrn := 'WARNING: Tax Override - '||to_char(trc_OvrPrc)||' Percent';
            -- Percentage taken into account in py_za_tx_utl_01032004.TaxLiability
         END IF;
         -- Check Directive Number First
         IF dbi_TX_DIR_NUM = 'NULL' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',17);
            IF xpt_Msg = 'No Error' THEN
               hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',18);
               xpt_Msg := 'PY_ZA_TX_DIR_NUM';
            END IF;
            RAISE xpt_E;
         -- Check that directive value is filled in
         ELSIF dbi_TX_DIR_VAL = -1 THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',19);
            IF xpt_Msg = 'No Error' THEN
               hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',20);
               xpt_Msg := 'PY_ZA_TX_DIR_PERC';
            END IF;
            RAISE xpt_E;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',21);
            DirCalc;
         END IF;
      END IF;
-- E = Close Corporation
...
--
   ELSIF dbi_TX_STA IN ('E','F','J','K','L') THEN
      IF trc_OvrTxCalc AND trc_OvrTyp = 'S' THEN
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',22);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_DEF';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',23);
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',24);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'P' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',25);
            trc_OvrWrn := 'WARNING: Tax Override - '||to_char(trc_OvrPrc)||' Percent';
            -- Percentage taken into account in py_za_tx_utl_01032004.TaxLiability
         END IF;
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',26);
...
--
   ELSIF dbi_TX_STA = 'G' THEN
      IF trc_OvrTxCalc AND (trc_OvrTyp = 'S' OR trc_OvrTyp = 'P') THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',27);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',28);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_G';
         END IF;
         RAISE xpt_E;
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',29);
      -- Check that seasonal worker days worked is filled in
      ELSIF dbi_SEA_WRK_DYS_WRK = 0 THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',30);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',31);
            xpt_Msg := 'PY_ZA_TX_SEA_WRK_DYS';
         END IF;
         RAISE xpt_E;
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',32);
            trc_CalTyp := 'OvrCalc';
            trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
            py_za_tx_utl_01032004.SetRebates;
         ELSE
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',33);
            SeaCalc;
         END IF;
      END IF;
-- A = Normal
...
--
   ELSIF dbi_TX_STA IN ('A','B','M') THEN
      IF dbi_TX_STA <> 'M' THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',34);
         -- Deemed Remuneration only applicable to 'M'
         bal_DIR_DMD_RMN_ITD := 0;
      END IF;

      IF trc_OvrTxCalc AND trc_OvrTyp = 'V' THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',35);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Total Tax Value: '||to_char(trc_LibFpNI + trc_LibFpAP);
         py_za_tx_utl_01032004.SetRebates;
         trc_SitFactor := dbi_ZA_DYS_IN_YR / py_za_tx_utl_01032004.DaysWorked;
      ELSIF trc_OvrTxCalc AND trc_OvrTyp = 'S' THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',36);
         trc_CalTyp := 'OvrCalc';
         trc_OvrWrn := 'WARNING: Tax Override - Forced Site Calculation';
         -- Force the Site Calculation
         SitCalc;
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',37);
      ELSE
         IF trc_OvrTxCalc AND trc_OvrTyp = 'P' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',38);
            trc_OvrWrn := 'WARNING: Tax Override - '||to_char(trc_OvrPrc)||' Percent';
            -- Percentage taken into account in py_za_tx_utl_01032004.TaxLiability
         END IF;

         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',39);
         IF py_za_tx_utl_01032004.LatePayPeriod THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',40);
            LteCalc;
         -- Is this a SITE Period?
         ELSIF py_za_tx_utl_01032004.EmpTermPrePeriod THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',41);
            SitCalc;
         ELSIF py_za_tx_utl_01032004.LstPeriod OR py_za_tx_utl_01032004.EmpTermInPeriod THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',42);
            IF py_za_tx_utl_01032004.PreErnPeriod THEN
               hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',43);
               YtdCalc;
            ELSE
               hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',44);
               SitCalc;
            END IF;
         ElSE
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',45);
            -- The employee has NOT been terminated!
            IF py_za_tx_utl_01032004.PreErnPeriod THEN
               hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',46);
               YtdCalc;
            ELSIF dbi_ZA_ASG_TX_RTR_PRD = 'Y' THEN
               hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',47);
               SitCalc;
            ELSIF py_za_tx_utl_01032004.NegPtd THEN
               hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',48);
               SitCalc;
            ELSE
               hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',49);
               NorCalc;
            END IF;
         END IF;
      END IF;
...
--
   ELSIF dbi_TX_STA IN ('H','Q') THEN
      IF trc_OvrTxCalc THEN
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',50);
         IF xpt_Msg = 'No Error' THEN
            hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',51);
            xpt_Msg := 'PY_ZA_TX_OVR_TX_STATE_H';
         END IF;
         RAISE xpt_E;
      ELSE
         hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',52);
         trc_LibFpNI := -1 * bal_TX_ON_NI_YTD;
         trc_LibFpFB := -1 * bal_TX_ON_FB_YTD;
         trc_LibFpTA := -1 * bal_TX_ON_TA_YTD;
         trc_LibFpBP := -1 * bal_TX_ON_BP_YTD;
      ...
      END IF;
   ELSE
      hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',53);
      hr_utility.set_message(801, 'ERROR: Invalid Tax Status');
      hr_utility.raise_error;
   END IF;

   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',54);

-- Post Calculation Steps
--
   py_za_tx_utl_01032004.SitPaySplit;

   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',55);

-- Execute the Arrear Processing
--
   IF py_za_tx_utl_01032004.SitePeriod THEN
      hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',56);
      py_za_tx_utl_01032004.ArrearExcess;
   END IF;

   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',57);

-- Calculate Net Taxable Income
--
   NetTxbIncCalc;

   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',58);
...
--
   ...
   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',59);
   ...
   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',60);
   ...
   p_PerRFITotPkgPTD_Upd  := trc_PerRFITotPkgPTD_Upd;
   p_PerNRFITotPkgPTD_Upd := trc_PerNRFITotPkgPTD_Upd;
   p_AnnRFITotPkgPTD_Upd  := trc_AnnRFITotPkgPTD_Upd;
   p_AnnNRFITotPkgPTD_Upd := trc_AnnNRFITotPkgPTD_Upd;

   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',61);

-- Execute The Tax Trace
--
   py_za_tx_utl_01032004.Trace;

   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',62);

-- Clear Globals
--
   py_za_tx_utl_01032004.ClearGlobals;

   hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',63);
...
-- Call hr_utility stop procedure
   py_za_tx_utl_01032004.StopHrTrace;
...
EXCEPTION
   WHEN xpt_FxdPrc THEN
      hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',66);
      WrtHrTrc('Sql error msg: Fixed Percentage was not entered for Fixed Percentage of Total Package Pension Basis');
      py_za_tx_utl_01032004.StopHrTrace;
      hr_utility.set_message(801, 'Fixed Percentage not entered');
      py_za_tx_utl_01032004.ClearGlobals;
      hr_utility.raise_error;
   WHEN xpt_E  THEN
      hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',64);
      ...
      hr_utility.raise_error;
   WHEN OTHERS THEN
      hr_utility.set_location('py_za_tx_01032004.ZaTx_01032004',65);
      WrtHrTrc('Sql error code: '||TO_CHAR(SQLCODE));
      WrtHrTrc('Sql error msg: '||SUBSTR(SQLERRM(SQLCODE), 1, 100));
      py_za_tx_utl_01032004.StopHrTrace;
      hr_utility.set_message(801, 'ZaTx_01032004: '||TO_CHAR(SQLCODE));
      py_za_tx_utl_01032004.ClearGlobals;
      hr_utility.raise_error;
END ZaTx_01032004;
