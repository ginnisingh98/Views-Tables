--------------------------------------------------------
--  DDL for Package Body BEN_DERIVE_PART_AND_RATE_PREM
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DERIVE_PART_AND_RATE_PREM" as
/* $Header: bendrpre.pkb 115.6 2002/10/23 00:58:11 ikasire noship $ */
--------------------------------------------------------------------------------
/*
+==============================================================================+
...
History
        ...
        27 Jun 00        G Perry    115.1      Added age_calc_rl support.
        17-jan-01        tilak      115.2      derived factor validation changed
                                               from > max to > max +1
        16-Nov-01        ikasire    115.3      Bug 2101937 - Fixed the error in the ceil
                                               condition of version 116.2 in all cursors.
        03-Nov-01        ikasire    115.4      Bug 2101937 - fixed the typo in the
                                               version 115.3
        22-Oct-02        ikasire    115.6      Bug 2502763 add more parameters to clf
                                               routine
*/
--------------------------------------------------------------------------------
--
g_package varchar2(80) := 'ben_derive_part_and_rate_prem';
