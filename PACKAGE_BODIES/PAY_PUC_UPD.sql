--------------------------------------------------------
--  DDL for Package Body PAY_PUC_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PUC_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_puc_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Update the pay_user_columns Row
  --
...
Begin
  ...
  --
  pay_puc_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  pay_puc_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  pay_puc_upd.post_update
     (p_rec
     ,l_formula_warning
     );
  --
