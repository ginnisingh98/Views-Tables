--------------------------------------------------------
--  DDL for Package Body BEN_BENCLAUD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENCLAUD_XMLP_PKG" AS
/* $Header: BENCLAUDB.pls 120.1 2007/12/10 08:25:44 vjaganat noship $ */
...
function CF_STANDARD_HEADERFormula return Number is
  ...
  l_derivable_factors          hr_lookups.meaning%type ;   l_validate                   hr_lookups.meaning%type ;
 ...
 begin
  ...
  l_all := substrb(fnd_message.get,1,80);
   begin
    ...
    begin
                select meaning into CP_AUDIT_LOG
    from hr_lookups a,
          ben_benefit_actions b
...
--Functions to refer Oracle report placeholders--
 ...
 Function CP_AUDIT_LOG_p return varchar2 is
	Begin
	 return CP_AUDIT_LOG;
	 END;
 Function CP_ACTION_ITEM_EFFECTIVE_DATE1 return varchar2 is
	Begin
