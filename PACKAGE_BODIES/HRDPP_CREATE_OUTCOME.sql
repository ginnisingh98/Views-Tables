--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_OUTCOME
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_OUTCOME" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:36
 * Generated for API: HR_COMPETENCE_OUTCOME_API.CREATE_OUTCOME
 */
--
...
,P_COMPETENCE_NAME in varchar2) is
...
,P_COMPETENCE_NAME => c.p52
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID);
--
hr_data_pump.api_trc_on;
HR_COMPETENCE_OUTCOME_API.CREATE_OUTCOME
