--------------------------------------------------------
--  DDL for Package Body GME_UNRELEASE_BATCH_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_UNRELEASE_BATCH_PVT" AS
/* $Header: GMEVURBB.pls 120.18.12010000.4 2009/08/11 09:02:33 apmishra ship $ */
...
--              gme_common_pvt.g_txn_hdr_tbl_cnt := gme_common_pvt.g_txn_hdr_tbl_cnt + 1;
	   ...
	   gme_transactions_pvt.get_mmt_transactions (
           ...
           IF l_mat_dtl_rec.line_type = gme_common_pvt.g_line_type_ing THEN
                -- Bug 6997483
                 ...
                 END IF;
                 -- Bug 6997483
                 -- Call create_resv_pplot only of the source_line_id of the ing return/reversal transaction
