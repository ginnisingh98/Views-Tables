--------------------------------------------------------
--  DDL for Package Body IGS_AD_LOC_ACCTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AD_LOC_ACCTS_PKG" AS
/* $Header: IGSAIF1B.pls 115.7 2003/10/30 13:26:09 rghosh noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_ad_loc_accts_all%ROWTYPE;
  new_references igs_ad_loc_accts_all%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.location_account_id               := x_location_account_id;
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_ad_loc_accts_all
      WHERE    location_account_id = x_location_account_id
      FOR UPDATE NOWAIT;
  ...
  */
  ...
  BEGIN
    ...
    IF (cur_rowid%FOUND) THEN
      CLOSE cur_rowid;
      fnd_message.set_name ('IGS', 'IGS_FI_ALOA_LOC_FK');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
      RETURN;
    END IF;
  ...
  BEGIN
    ...
    IF (p_action = 'INSERT') THEN
      ...
      IF ( get_pk_for_validation(
             new_references.location_account_id
           )
         ) THEN
  ...
  */
  ...
  BEGIN
    ...
    x_location_account_id := -1;
    before_dml(
      p_action                            => 'INSERT',
      x_rowid                             => x_rowid,
      x_location_account_id               => x_location_account_id,
    ...
    INSERT INTO igs_ad_loc_accts_all (
      location_account_id,
      location_cd,
      segment,
      segment_num,
      ...
      x_last_updated_by,
      x_last_update_login
    )RETURNING location_account_id INTO x_location_account_id;
  ...
  */
  ...
  BEGIN
    ...
    IF (
        (tlinfo.location_cd = x_location_cd)
  ...
  */
  BEGIN
    ...
    DELETE FROM igs_ad_loc_accts_all
    WHERE rowid = x_rowid;
