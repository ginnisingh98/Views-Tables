--------------------------------------------------------
--  DDL for Package Body BEN_DCO_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_DCO_RKU" as
...
begin
hr_utility.set_location('Entering: BEN_DCO_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: BEN_DCO_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end BEN_DCO_RKU;
