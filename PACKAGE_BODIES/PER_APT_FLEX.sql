--------------------------------------------------------
--  DDL for Package Body PER_APT_FLEX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_APT_FLEX" as
/* $Header: peaptfli.pkb 115.1 99/07/17 18:36:12 porting ship $ */
--
--
-- ---------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_apt_flex.';  -- Global package name
--
--
--
----------------------------------------------------------------------------
