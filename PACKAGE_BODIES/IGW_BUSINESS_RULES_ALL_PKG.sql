--------------------------------------------------------
--  DDL for Package Body IGW_BUSINESS_RULES_ALL_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGW_BUSINESS_RULES_ALL_PKG" as
 /* $Header: igwstbrb.pls 115.5 2002/11/14 18:43:38 vmedikon ship $ */
procedure INSERT_ROW (
  ...
  X_MODE in VARCHAR2 default 'R'
    ...
    cursor C is select ROWID from IGW_BUSINESS_RULES_ALL
...
begin
  ...
  insert into IGW_BUSINESS_RULES_ALL (
    RULE_ID,
...
begin
  ...
  update IGW_BUSINESS_RULES_ALL set
    RULE_ID = X_RULE_ID,
    RULE_SEQUENCE_NUMBER = X_RULE_SEQUENCE_NUMBER,
...
begin
  delete from IGW_BUSINESS_RULES_ALL
  where ROWID = X_ROWID;
  if (sql%notfound) then
    raise no_data_found;
  end if;
