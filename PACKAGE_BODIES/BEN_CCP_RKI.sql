--------------------------------------------------------
--  DDL for Package Body BEN_CCP_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CCP_RKI" as
...
begin
hr_utility.set_location('Entering: ben_ccp_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_ccp_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_ccp_RKI;
