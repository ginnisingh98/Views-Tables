--------------------------------------------------------
--  DDL for Package Body BEN_PND_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PND_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_pnd_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_pl_dpnt_cvg_ctfn_f.created_by%TYPE;
  l_creation_date       ben_pl_dpnt_cvg_ctfn_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_pl_dpnt_cvg_ctfn_f
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.pl_dpnt_cvg_ctfn_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_pnd_rec
  ...
  --
  p_pl_dpnt_cvg_ctfn_id        	:= l_rec.pl_dpnt_cvg_ctfn_id;
