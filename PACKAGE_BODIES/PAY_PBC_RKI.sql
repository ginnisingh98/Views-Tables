--------------------------------------------------------
--  DDL for Package Body PAY_PBC_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PBC_RKI" as
...
begin
hr_utility.set_location('Entering: PAY_PBC_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: PAY_PBC_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end PAY_PBC_RKI;
