--------------------------------------------------------
--  DDL for Package Body IGI_DOS_DEFAULT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGI_DOS_DEFAULT_PKG" AS
-- $Header: igidoshb.pls 120.7.12000000.1 2007/06/08 09:49:05 vkilambi ship $
