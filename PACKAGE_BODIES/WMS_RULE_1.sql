--------------------------------------------------------
--  DDL for Package Body WMS_RULE_1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."WMS_RULE_1" AS
...
,base.UOM_CODE
,base.GRADE_CODE
,mln.EXPIRATION_DATE,base.DATE_RECEIVED,base.SERIAL_NUMBER,base.CONVERSION_RATE
