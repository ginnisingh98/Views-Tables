--------------------------------------------------------
--  DDL for Package Body IGS_CO_TYPE_JO_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_CO_TYPE_JO_PKG" AS
/* $Header: IGSLI24B.pls 115.2 2002/11/29 01:07:41 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_co_type_jo%ROWTYPE;
  new_references igs_co_type_jo%ROWTYPE;
  ...
  */
    CURSOR cur_rowid IS
      ...
      AND      s_job_name = x_s_job_name
      AND      output_num = x_output_num
      FOR UPDATE NOWAIT;
