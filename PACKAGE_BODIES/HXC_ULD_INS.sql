--------------------------------------------------------
--  DDL for Package Body HXC_ULD_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_ULD_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_uld_ins.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Insert the row into: hxc_layout_comp_definitions
  --
...
Begin
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.layout_comp_definition_id;
  Close C_Sel1;
  --
  if g_debug then
  	hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Procedure ins
  ...
  ,p_layout_comp_definition_id         out nocopy number
...
Begin
  ...
  --
  p_layout_comp_definition_id := l_rec.layout_comp_definition_id;
