--------------------------------------------------------
--  DDL for Package Body OKL_IRK_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_IRK_PVT_W" as
  /* $Header: OKLIIRKB.pls 120.1 2005/07/13 09:28:27 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_irk_pvt.irkv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_DATE_TABLE
    , a4 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ranking_seq := rosetta_g_miss_num_map(a1(indx));
          t(ddindx).object_version_number := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).date_from := rosetta_g_miss_date_in_map(a3(indx));
          t(ddindx).date_to := rosetta_g_miss_date_in_map(a4(indx));
          t(ddindx).isu_id := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).ic_code := a6(indx);
  ...
  procedure rosetta_table_copy_out_p2(t okl_irk_pvt.irkv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a27 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := rosetta_g_miss_num_map(t(ddindx).ranking_seq);
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).object_version_number);
          a3(indx) := t(ddindx).date_from;
          a4(indx) := t(ddindx).date_to;
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).isu_id);
          a6(indx) := t(ddindx).ic_code;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_irk_pvt.irk_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
    , a3 JTF_DATE_TABLE
    , a4 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ranking_seq := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).date_from := rosetta_g_miss_date_in_map(a3(indx));
          t(ddindx).date_to := rosetta_g_miss_date_in_map(a4(indx));
          t(ddindx).isu_id := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).ic_code := a6(indx);
  ...
  procedure rosetta_table_copy_out_p5(t okl_irk_pvt.irk_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    , a2 out nocopy JTF_NUMBER_TABLE
    , a3 out nocopy JTF_DATE_TABLE
    , a4 out nocopy JTF_DATE_TABLE
    ...
    a27 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).ranking_seq);
          a3(indx) := t(ddindx).date_from;
          a4(indx) := t(ddindx).date_to;
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).isu_id);
          a6(indx) := t(ddindx).ic_code;
  ...
  as
    ddp_irkv_rec okl_irk_pvt.irkv_rec_type;
    ddx_irkv_rec okl_irk_pvt.irkv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_irk_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_irkv_tbl okl_irk_pvt.irkv_tbl_type;
    ddx_irkv_tbl okl_irk_pvt.irkv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_irk_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_irk_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_irk_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_irk_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
