--------------------------------------------------------
--  DDL for Package Body SSP_SSPRPSPA_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."SSP_SSPRPSPA_XMLP_PKG" AS
/* $Header: SSPRPSPAB.pls 120.1 2008/01/07 14:42:30 srikrish noship $ */
  ...
  BEGIN
    ...
    BEGIN
      DUE_DATE := M_DUE_DATE;
      EWC := DUE_DATE;
      QW := SSP_PAD_PKG.MATCHING_WEEK_OF_ADOPTION(M_MATCHING_DATE);
      C_EWC := EWC;
      C_WQ := QW;
      SELECT
