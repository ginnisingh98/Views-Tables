--------------------------------------------------------
--  DDL for Package Body OKL_ASSET_RETURNS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ASSET_RETURNS_PUB_W" as
  /* $Header: OKLUARTB.pls 120.3 2008/01/14 18:26:04 rmunjulu ship $ */
  ...
  procedure insert_asset_returns(p_api_version  NUMBER
  ...
  as
    ddp_artv_tbl okl_asset_returns_pub.artv_tbl_type;
    ddx_artv_tbl okl_asset_returns_pub.artv_tbl_type;
  ...
  begin
    ...
    okl_asset_returns_pub.insert_asset_returns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_artv_rec okl_asset_returns_pub.artv_rec_type;
    ddx_artv_rec okl_asset_returns_pub.artv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_asset_returns(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_asset_returns_pub.lock_asset_returns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure update_asset_returns(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_asset_returns_pub.update_asset_returns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_asset_returns(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_asset_returns_pub.delete_asset_returns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_asset_returns(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_asset_returns_pub.validate_asset_returns(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
