--------------------------------------------------------
--  DDL for Package Body BEN_EOY_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EOY_RKU" as
...
begin
hr_utility.set_location('Entering: ben_eoy_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: ben_eoy_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end ben_eoy_RKU;
