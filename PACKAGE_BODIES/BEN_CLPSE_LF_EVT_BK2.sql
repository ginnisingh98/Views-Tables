--------------------------------------------------------
--  DDL for Package Body BEN_CLPSE_LF_EVT_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CLPSE_LF_EVT_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_CLPSE_LF_EVT_BK2.UPDATE_CLPSE_LF_EVT_A', 10);
hr_utility.set_location(' Leaving: BEN_CLPSE_LF_EVT_BK2.UPDATE_CLPSE_LF_EVT_A', 20);
end UPDATE_CLPSE_LF_EVT_A;
...
begin
hr_utility.set_location('Entering: BEN_CLPSE_LF_EVT_BK2.UPDATE_CLPSE_LF_EVT_B', 10);
hr_utility.set_location(' Leaving: BEN_CLPSE_LF_EVT_BK2.UPDATE_CLPSE_LF_EVT_B', 20);
end UPDATE_CLPSE_LF_EVT_B;
