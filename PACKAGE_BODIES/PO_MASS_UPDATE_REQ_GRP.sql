--------------------------------------------------------
--  DDL for Package Body PO_MASS_UPDATE_REQ_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PO_MASS_UPDATE_REQ_GRP" AS
/* $Header: PO_Mass_Update_Req_GRP.plb 120.2 2008/01/09 14:34:18 rakchakr noship $*/
...
g_pkg_name CONSTANT VARCHAR2(100) := 'PO_Mass_Update_Req_GRP';
...
PO_Mass_Update_Req_PVT.DO_Update(p_update_person,
                                 p_old_personid,
                                 p_new_personid,
                                 p_document_type,
                                 p_document_no_from,
