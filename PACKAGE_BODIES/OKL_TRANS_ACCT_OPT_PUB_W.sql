--------------------------------------------------------
--  DDL for Package Body OKL_TRANS_ACCT_OPT_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TRANS_ACCT_OPT_PUB_W" as
  /* $Header: OKLUTACB.pls 120.1 2005/07/20 10:11:39 dkagrawa noship $ */
  ...
  as
    ddp_taov_rec okl_trans_acct_opt_pub.taov_rec_type;
    ddx_taov_rec okl_trans_acct_opt_pub.taov_rec_type;
  ...
  begin
    ...
    okl_trans_acct_opt_pub.get_trx_acct_opt(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_trans_acct_opt_pub.updt_trx_acct_opt(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
