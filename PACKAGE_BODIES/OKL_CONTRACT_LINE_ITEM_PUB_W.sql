--------------------------------------------------------
--  DDL for Package Body OKL_CONTRACT_LINE_ITEM_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CONTRACT_LINE_ITEM_PUB_W" as
  /* $Header: OKLUCLIB.pls 115.2 2003/10/16 01:15:36 smereddy noship $ */
  ...
  as
    ddp_line_item_tbl okl_contract_line_item_pub.line_item_tbl_type;
    ddx_line_item_tbl okl_contract_line_item_pub.line_item_tbl_type;
  ...
  begin
    ...
    okl_contract_line_item_pub.create_contract_line_item(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_line_item_pub.update_contract_line_item(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_contract_line_item_pub.delete_contract_line_item(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_clev_rec okl_contract_line_item_pub.clev_rec_type;
    ddp_klev_rec okl_contract_line_item_pub.klev_rec_type;
    ddp_cimv_rec okl_contract_line_item_pub.cimv_rec_type;
    ddx_clev_rec okl_contract_line_item_pub.clev_rec_type;
    ddx_klev_rec okl_contract_line_item_pub.klev_rec_type;
    ddx_cimv_rec okl_contract_line_item_pub.cimv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  as
    ddp_clev_tbl okl_contract_line_item_pub.clev_tbl_type;
    ddp_klev_tbl okl_contract_line_item_pub.klev_tbl_type;
    ddp_cimv_tbl okl_contract_line_item_pub.cimv_tbl_type;
    ddx_clev_tbl okl_contract_line_item_pub.clev_tbl_type;
    ddx_klev_tbl okl_contract_line_item_pub.klev_tbl_type;
    ddx_cimv_tbl okl_contract_line_item_pub.cimv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
...
end okl_contract_line_item_pub_w;
