--------------------------------------------------------
--  DDL for Package Body PER_RECRUITMENT_ACTIVITY_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_RECRUITMENT_ACTIVITY_BK2" as
...
begin
hr_utility.set_location('Entering: PER_RECRUITMENT_ACTIVITY_BK2.UPDATE_RECRUITMENT_ACTIVITY_A', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_app_hooks then
per_recruitment_activity_be2.UPDATE_RECRUITMENT_ACTIVITY_A
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_RECRUITMENT_ACTIVITY', 'AP');
hr_utility.set_location(' Leaving: PER_RECRUITMENT_ACTIVITY_BK2.UPDATE_RECRUITMENT_ACTIVITY_A', 20);
...
begin
hr_utility.set_location('Entering: PER_RECRUITMENT_ACTIVITY_BK2.UPDATE_RECRUITMENT_ACTIVITY_B', 10);
hr_utility.set_location(' Leaving: PER_RECRUITMENT_ACTIVITY_BK2.UPDATE_RECRUITMENT_ACTIVITY_B', 20);
end UPDATE_RECRUITMENT_ACTIVITY_B;
