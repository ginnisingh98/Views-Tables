--------------------------------------------------------
--  DDL for Package Body HRDPP_DELETE_PERSON_EXTRA_INFO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_DELETE_PERSON_EXTRA_INFO" as
/*
 * Generated by hr_pump_meta_mapper at: 2013/08/29 22:08:29
 * Generated for API: HR_PERSON_EXTRA_INFO_API.DELETE_PERSON_EXTRA_INFO
 */
--
...
(P_PERSON_EXTRA_INFO_USER_KEY => c.p2);
end if;
--
...
end hrdpp_DELETE_PERSON_EXTRA_INFO;
