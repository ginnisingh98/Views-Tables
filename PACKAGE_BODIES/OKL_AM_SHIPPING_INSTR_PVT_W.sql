--------------------------------------------------------
--  DDL for Package Body OKL_AM_SHIPPING_INSTR_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_SHIPPING_INSTR_PVT_W" as
  /* $Header: OKLESHIB.pls 115.7 2002/12/19 23:23:44 gkadarka noship $ */
  ...
  as
    ddp_rasv_rec okl_am_shipping_instr_pvt.rasv_rec_type;
    ddx_rasv_rec okl_am_shipping_instr_pvt.rasv_rec_type;
  ...
  begin
    ...
    okl_am_shipping_instr_pvt.create_shipping_instr(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_rasv_tbl okl_am_shipping_instr_pvt.rasv_tbl_type;
    ddx_rasv_tbl okl_am_shipping_instr_pvt.rasv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_shipping_instr_pvt.update_shipping_instr(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_shipping_instr_pvt.send_shipping_instr(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_am_shipping_instr_pvt_w;
