--------------------------------------------------------
--  DDL for Package Body PAY_SG_BAL_UPLOAD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_SG_BAL_UPLOAD" as
-- /* $Header: pysgupld.pkb 120.0 2005/05/29 08:50:31 appldev noship $ */
--
-- +======================================================================+
...
-- |                           All rights reserved.                       |
-- +======================================================================+
-- SQL Script File Name : pysgupld.pkb
...
--
 ...
 --
  ...
  --  06-NOV-2000 removed tax_unit_id, as it is no longer required
  -----------------------------------------------------------------------------
 --
 ...
 begin
   --
   hr_utility.trace('Entering pay_sg_bal_upload.is_supported');
   --
   ...
   --
   hr_utility.trace('Exiting pay_sg_bal_upload.is_supported');
   --
 end is_supported;
 --
  -----------------------------------------------------------------------------
 ...
 begin
   --
   hr_utility.trace('Entering pay_sg_bal_upload.include_adjustment_test');
   --
   ...
   --
   hr_utility.trace('Exiting pay_sg_bal_upload.include_adjustment_test');
   --
 ...
 begin
   --
   hr_utility.trace('Entering pay_sg_bal_upload.validate_batch_lines');
   --
   hr_utility.trace('Exiting pay_sg_bal_upload.validate_batch_lines');
   --
