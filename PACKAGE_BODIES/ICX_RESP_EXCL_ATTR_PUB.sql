--------------------------------------------------------
--  DDL for Package Body ICX_RESP_EXCL_ATTR_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."ICX_RESP_EXCL_ATTR_PUB" AS
-- $Header: ICXPTREB.pls 115.1 99/07/17 03:21:10 porting ship $
...
BEGIN
   ...
   SAVEPOINT Create_Resp_Excl_Attr_PUB;
   ...
   ICX_Resp_Excl_Attr_PVT.Create_Resp_Excl_Attr
   (
...
--      p_msg_entity_index	=>	p_msg_entity_index	,
   ...
   then
      ROLLBACK to Create_Resp_Excl_Attr_PUB;
...
BEGIN
   ...
   SAVEPOINT Delete_Resp_Excl_Attr_PUB;
   ...
   ICX_Resp_Excl_Attr_PVT.Delete_Resp_Excl_Attr
   (
      p_api_version_number	=>	p_api_version_number	,
      p_init_msg_list		=>	p_init_msg_list		,
      p_simulate		=>	p_simulate		,
...
--      p_msg_entity_index	=>	p_msg_entity_index	,
   ...
   if FND_API.To_Boolean( p_simulate)
   then
      ROLLBACK to Delete_Resp_Excl_Attr_PUB;
