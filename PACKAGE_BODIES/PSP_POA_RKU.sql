--------------------------------------------------------
--  DDL for Package Body PSP_POA_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_POA_RKU" as
...
begin
hr_utility.set_location('Entering: PSP_POA_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PSP_POA_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PSP_POA_RKU;
