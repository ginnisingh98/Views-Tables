--------------------------------------------------------
--  DDL for Package Body OKL_TRANS_CONTRACTS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_TRANS_CONTRACTS_PUB" AS
/* $Header: OKLPTCTB.pls 115.3 2002/12/18 12:42:41 kjinger noship $ */
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    OKL_TRANS_CONTRACTS_pvt.create_trx_contracts(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_TRANS_CONTRACTS_PUB','create_trx_contracts');
   ...
   -- vertical industry-preprocessing
    ...
    IF (l_tcnv_tbl.COUNT > 0) THEN
      ...
      LOOP
        ...
        OKL_TRANS_CONTRACTS_pub.create_trx_contracts(
                           p_api_version   => p_api_version
                          ,p_init_msg_list => p_init_msg_list
                          ,x_return_status => l_return_status
                          ,x_msg_count     => x_msg_count
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    OKL_TRANS_CONTRACTS_pvt.update_trx_contracts(
                         p_api_version   => p_api_version
                        ,p_init_msg_list => p_init_msg_list
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_TRANS_CONTRACTS_PUB','update_trx_contracts');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    OKL_TRANS_CONTRACTS_pvt.delete_trx_contracts(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_TRANS_CONTRACTS_PUB','delete_trx_contracts');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    OKL_TRANS_CONTRACTS_pvt.create_trx_cntrct_lines(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_TRANS_CONTRACTS_PUB','create_trx_cntrct_lines');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    OKL_TRANS_CONTRACTS_pvt.update_trx_cntrct_lines(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_TRANS_CONTRACTS_PUB','update_trx_cntrct_lines');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    OKL_TRANS_CONTRACTS_pvt.delete_trx_cntrct_lines(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_TRANS_CONTRACTS_PUB','delete_trx_cntrct_lines');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
