--------------------------------------------------------
--  DDL for Package Body BEN_YRP_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_YRP_RKI" as
...
begin
hr_utility.set_location('Entering: ben_yrp_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: ben_yrp_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end ben_yrp_RKI;
