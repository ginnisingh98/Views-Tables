--------------------------------------------------------
--  DDL for Package Body BEN_LER_BNFT_RSTRN_CTFN_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_LER_BNFT_RSTRN_CTFN_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_LER_BNFT_RSTRN_CTFN_BK2.UPDATE_LER_BNFT_RSTRN_CTFN_A', 10);
hr_utility.set_location(' Leaving: BEN_LER_BNFT_RSTRN_CTFN_BK2.UPDATE_LER_BNFT_RSTRN_CTFN_A', 20);
end UPDATE_LER_BNFT_RSTRN_CTFN_A;
...
begin
hr_utility.set_location('Entering: BEN_LER_BNFT_RSTRN_CTFN_BK2.UPDATE_LER_BNFT_RSTRN_CTFN_B', 10);
hr_utility.set_location(' Leaving: BEN_LER_BNFT_RSTRN_CTFN_BK2.UPDATE_LER_BNFT_RSTRN_CTFN_B', 20);
end UPDATE_LER_BNFT_RSTRN_CTFN_B;
