--------------------------------------------------------
--  DDL for Package Body AHL_FMP_MR_DOC_ASSO_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AHL_FMP_MR_DOC_ASSO_PVT_W" as
  /* $Header: AHLWMRDB.pls 120.0 2005/05/26 01:57:55 appldev noship $ */
  ...
  procedure rosetta_table_copy_in_p1(t out nocopy ahl_fmp_mr_doc_asso_pvt.doc_association_tbl, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).mr_header_id := a8(indx);
          t(ddindx).mr_title := a9(indx);
          t(ddindx).mr_version_number := a10(indx);
  ...
  procedure rosetta_table_copy_out_p1(t ahl_fmp_mr_doc_asso_pvt.doc_association_tbl, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a38 := JTF_VARCHAR2_TABLE_100();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a8(indx) := t(ddindx).mr_header_id;
          a9(indx) := t(ddindx).mr_title;
          a10(indx) := t(ddindx).mr_version_number;
  ...
  procedure process_doc_association(p_api_version  NUMBER
  ...
  as
    ddp_x_association_tbl ahl_fmp_mr_doc_asso_pvt.doc_association_tbl;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ahl_fmp_mr_doc_asso_pvt_w.rosetta_table_copy_in_p1(ddp_x_association_tbl, p10_a0
      , p10_a1
      , p10_a2
      , p10_a3
      , p10_a4
    ...
    ahl_fmp_mr_doc_asso_pvt.process_doc_association(p_api_version,
      p_init_msg_list,
      p_commit,
      p_validation_level,
      p_validate_only,
    ...
    ahl_fmp_mr_doc_asso_pvt_w.rosetta_table_copy_out_p1(ddp_x_association_tbl, p10_a0
      , p10_a1
      , p10_a2
      , p10_a3
      , p10_a4
