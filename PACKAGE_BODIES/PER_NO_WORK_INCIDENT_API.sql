--------------------------------------------------------
--  DDL for Package Body PER_NO_WORK_INCIDENT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_NO_WORK_INCIDENT_API" as
/* $Header: peincnoi.pkb 120.0 2005/05/31 10:07:41 appldev noship $ */

-- Package Variables
--
g_package  varchar2(33) := 'per_no_work_incident_api.';
--
-- ----------------------------------------------------------------------
...
procedure create_no_work_incident
  ...
  l_proc              varchar2(72) := g_package||'create_no_work_incident';
...
begin
  ...
  --
  savepoint create_no_work_incident;
  --
  ...
  --
    per_work_incident_api.create_work_incident
      (p_validate                       => p_validate
       ...
       ,p_inc_information_category      => 'NO'
       ,p_inc_information1              => p_date_rep_social_security
       ,p_inc_information2              => p_date_rep_labor_inspection
...
procedure update_no_work_incident
  ...
  --
  l_business_group_id    per_contracts_f.business_group_id%TYPE;
  l_proc                 varchar2(72) := g_package||'update_no_work_incident';
  l_legislation_code     varchar2(2);
  --
  cursor csr_get_business_group_id is
    select per.business_group_id
