--------------------------------------------------------
--  DDL for Package Body PAY_SE_POPULATE_COUNTRIES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_SE_POPULATE_COUNTRIES" AS
/* $Header: pysepop.pkb 120.0 2005/05/29 02:17:14 appldev noship $ */
--
-- Purpose: to insert the countries into user table
 ...
 PROCEDURE POPULATE_COUNTRIES
   ...
   BEGIN
	...
	-- Get the Table ID for the Table PER DIEM OVERSEAS NORMAL AMOUNT
	--
	...
	WHERE user_table_name='PER DIEM OVERSEAS NORMAL AMOUNT'
       ...
       -- Get the Column ID for the Table PER DIEM OVERSEAS NORMAL AMOUNT
       --
