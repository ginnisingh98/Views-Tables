--------------------------------------------------------
--  DDL for Package Body BEN_CMBN_AGE_LOS_FCTR_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CMBN_AGE_LOS_FCTR_BK2" as
...
procedure UPDATE_CMBN_AGE_LOS_FCTR_A
...
begin
hr_utility.set_location('Entering: BEN_CMBN_AGE_LOS_FCTR_BK2.UPDATE_CMBN_AGE_LOS_FCTR_A', 10);
hr_utility.set_location(' Leaving: BEN_CMBN_AGE_LOS_FCTR_BK2.UPDATE_CMBN_AGE_LOS_FCTR_A', 20);
end UPDATE_CMBN_AGE_LOS_FCTR_A;
procedure UPDATE_CMBN_AGE_LOS_FCTR_B
(P_CMBN_AGE_LOS_FCTR_ID in NUMBER
,P_NAME in VARCHAR2
,P_LOS_FCTR_ID in NUMBER
,P_AGE_FCTR_ID in NUMBER
...
begin
hr_utility.set_location('Entering: BEN_CMBN_AGE_LOS_FCTR_BK2.UPDATE_CMBN_AGE_LOS_FCTR_B', 10);
hr_utility.set_location(' Leaving: BEN_CMBN_AGE_LOS_FCTR_BK2.UPDATE_CMBN_AGE_LOS_FCTR_B', 20);
end UPDATE_CMBN_AGE_LOS_FCTR_B;
end BEN_CMBN_AGE_LOS_FCTR_BK2;
