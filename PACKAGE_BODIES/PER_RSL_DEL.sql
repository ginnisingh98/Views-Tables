--------------------------------------------------------
--  DDL for Package Body PER_RSL_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_RSL_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_rsl_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the per_rating_scales_tl row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in per_rsl_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in per_rsl_shd.g_rec_type) is
--
...
Begin
  ...
  begin
    --
    per_rsl_rkd.after_delete
      (p_rating_scale_id
      => p_rec.rating_scale_id
      ,p_language
      => p_rec.language
      ,p_source_lang_o
      => per_rsl_shd.g_old_rec.source_lang
      ,p_name_o
      => per_rsl_shd.g_old_rec.name
      ,p_description_o
      => per_rsl_shd.g_old_rec.description
      );
    --
  exception
    --
...
Begin
  ...
  --
  per_rsl_bus.delete_validate(p_rec);
  --
  ...
  --
  per_rsl_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  per_rsl_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  per_rsl_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
...
Begin
  ...
  --
  l_rec.rating_scale_id := p_rating_scale_id;  l_rec.language := p_language;
  --
  --
