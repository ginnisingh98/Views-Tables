--------------------------------------------------------
--  DDL for Package Body OZF_PRODUCT_ALLOCATIONS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OZF_PRODUCT_ALLOCATIONS_PKG" AS
/* $Header: ozftpalb.pls 120.0 2005/06/01 03:16:19 appldev noship $  */

---g_version	CONSTANT CHAR(80)    := '$Header: ozftpalb.pls 120.0 2005/06/01 03:16:19 appldev noship $';
   G_PKG_NAME   CONSTANT VARCHAR2(30):='OZF_PRODUCT_ALLOCATIONS_PKG';
   G_FILE_NAME CONSTANT VARCHAR2(12) := 'ozftpalb.pls';
...
BEGIN
   ...
   INSERT INTO ozf_product_allocations(
    ...
    VALUES
         (
           DECODE( px_product_allocation_id, FND_API.G_MISS_NUM, NULL, px_product_allocation_id),
           ...
           DECODE( p_item_id, FND_API.G_MISS_NUM, NULL, p_item_id),
           ...
           DECODE( p_parent_product_allocation_id, FND_API.G_MISS_NUM, NULL, p_parent_product_allocation_id),
...
PROCEDURE Update_Row(
 ...
 BEGIN
    ...
    SET
              product_allocation_id = DECODE( p_product_allocation_id, null, product_allocation_id, FND_API.G_MISS_NUM, null, p_product_allocation_id),
              ...
              fund_id = DECODE( p_fund_id, null, fund_id, FND_API.G_MISS_NUM, null, p_fund_id),
              item_type = DECODE( p_item_type, null, item_type, FND_API.g_miss_char, null, p_item_type),
              item_id = DECODE( p_item_id, null, item_id, FND_API.G_MISS_NUM, null, p_item_id),
              ...
              parent_product_allocation_id = DECODE(p_parent_product_allocation_id,null,parent_product_allocation_id, FND_API.G_MISS_NUM, null, p_parent_product_allocation_id),
...
PROCEDURE Lock_Row(
 ...
 IS
   CURSOR C IS
        ...
        WHERE product_allocation_id =  p_product_allocation_id
        AND object_version_number = p_object_version_number
        FOR UPDATE OF product_allocation_id NOWAIT;
   Recinfo C%ROWTYPE;
 BEGIN
