--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_CA_EMP_FEDTAX_INF
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_CA_EMP_FEDTAX_INF" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:15
 * Generated for API: PAY_CA_EMP_FEDTAX_INF_API.UPDATE_CA_EMP_FEDTAX_INF
 */
--
...
,I_FED_OVERRIDE_AMOUNT in varchar2 default 'N'
,P_FED_OVERRIDE_RATE in number default null
,I_FED_OVERRIDE_RATE in varchar2 default 'N'
...
,I_FED_LSF_AMOUNT in varchar2 default 'N'
,P_EFFECTIVE_DATE in date
,P_DATETRACK_MODE in varchar2
,P_EMP_FED_TAX_INF_USER_KEY in varchar2) is
...
,P_EI_EXEMPT_FLAG
,P_TAX_CALC_METHOD
,nd(P_FED_OVERRIDE_AMOUNT,I_FED_OVERRIDE_AMOUNT)
,nd(P_FED_OVERRIDE_RATE,I_FED_OVERRIDE_RATE)
...
,nd(P_FED_LSF_AMOUNT,I_FED_LSF_AMOUNT)
,dc(P_EFFECTIVE_DATE)
,P_DATETRACK_MODE
...
decode(l.pval015,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval015,'YES_NO',d(l.pval053),vn)) p15,
l.pval015 d15,
decode(l.pval016,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval016,'YES_NO',d(l.pval053),vn)) p16,
l.pval016 d16,
decode(l.pval017,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval017,'YES_NO',d(l.pval053),vn)) p17,
l.pval017 d17,
...
decode(l.pval054,cn,vn,l.pval054) p54,
...
--
if c.p55 is null then
L_EMP_FED_TAX_INF_ID:=nn;
else
L_EMP_FED_TAX_INF_ID := 
hr_pump_get.get_emp_fed_tax_inf_id
(P_EMP_FED_TAX_INF_USER_KEY => c.p55);
end if;
--
if c.p55 is null or
c.p53 is null then
...
hr_pump_get.GET_CA_EMP_FEDTAX_INF_OVN
(P_EMP_FED_TAX_INF_USER_KEY => c.p55
,P_EFFECTIVE_DATE => c.p53);
end if;
--
...
,P_EMPLOYMENT_PROVINCE => c.p5
,P_TAX_CREDIT_AMOUNT => c.p6
,P_CLAIM_CODE => c.p7
,P_BASIC_EXEMPTION_FLAG => c.p8
,P_ADDITIONAL_TAX => c.p9
,P_ANNUAL_DEDN => c.p10
,P_TOTAL_EXPENSE_BY_COMMISSION => c.p11
,P_TOTAL_REMNRTN_BY_COMMISSION => c.p12
,P_PRESCRIBED_ZONE_DEDN_AMT => c.p13
,P_OTHER_FEDTAX_CREDITS => c.p14
,P_CPP_QPP_EXEMPT_FLAG => c.p15
,P_FED_EXEMPT_FLAG => c.p16
,P_EI_EXEMPT_FLAG => c.p17
,P_TAX_CALC_METHOD => c.p18
,P_FED_OVERRIDE_AMOUNT => c.p19
,P_FED_OVERRIDE_RATE => c.p20
,P_CA_TAX_INFORMATION_CATEGORY => c.p21
,P_CA_TAX_INFORMATION1 => c.p22
,P_CA_TAX_INFORMATION2 => c.p23
,P_CA_TAX_INFORMATION3 => c.p24
,P_CA_TAX_INFORMATION4 => c.p25
,P_CA_TAX_INFORMATION5 => c.p26
,P_CA_TAX_INFORMATION6 => c.p27
,P_CA_TAX_INFORMATION7 => c.p28
,P_CA_TAX_INFORMATION8 => c.p29
,P_CA_TAX_INFORMATION9 => c.p30
,P_CA_TAX_INFORMATION10 => c.p31
,P_CA_TAX_INFORMATION11 => c.p32
,P_CA_TAX_INFORMATION12 => c.p33
,P_CA_TAX_INFORMATION13 => c.p34
,P_CA_TAX_INFORMATION14 => c.p35
,P_CA_TAX_INFORMATION15 => c.p36
,P_CA_TAX_INFORMATION16 => c.p37
,P_CA_TAX_INFORMATION17 => c.p38
,P_CA_TAX_INFORMATION18 => c.p39
,P_CA_TAX_INFORMATION19 => c.p40
,P_CA_TAX_INFORMATION20 => c.p41
,P_CA_TAX_INFORMATION21 => c.p42
,P_CA_TAX_INFORMATION22 => c.p43
,P_CA_TAX_INFORMATION23 => c.p44
,P_CA_TAX_INFORMATION24 => c.p45
,P_CA_TAX_INFORMATION25 => c.p46
,P_CA_TAX_INFORMATION26 => c.p47
,P_CA_TAX_INFORMATION27 => c.p48
,P_CA_TAX_INFORMATION28 => c.p49
,P_CA_TAX_INFORMATION29 => c.p50
,P_CA_TAX_INFORMATION30 => c.p51
,P_OBJECT_VERSION_NUMBER => L_OBJECT_VERSION_NUMBER
,P_FED_LSF_AMOUNT => c.p52
,P_EFFECTIVE_DATE => c.p53
,P_DATETRACK_MODE => c.p54);
...
end hrdpp_UPDATE_CA_EMP_FEDTAX_INF;
