--------------------------------------------------------
--  DDL for Package Body IGS_PS_GOVT_DSCP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_PS_GOVT_DSCP_PKG" as
/* $Header: IGSPI59B.pls 115.3 2002/11/29 02:32:30 nsidana ship $ */
  l_rowid VARCHAR2(25);
  old_references IGS_PS_GOVT_DSCP%RowType;
  new_references IGS_PS_GOVT_DSCP%RowType;
  ...
  BEGIN
	-- If being closed, validate disciplines.
	IF p_updating AND
	   old_references.closed_ind <> new_references.closed_ind THEN
		IF IGS_PS_VAL_GD.crsp_val_gd_upd (
...
END check_constraints;
  ...
  BEGIN
    ...
    IGS_PS_DSCP_PKG.GET_FK_IGS_PS_GOVT_DSCP (
      old_references.govt_discipline_group_cd
      );

    IGS_FI_GV_DSP_HEC_CN_PKG.GET_FK_IGS_PS_GOVT_DSCP (
      old_references.govt_discipline_group_cd
      );
...
procedure INSERT_ROW (
  ...
  X_MODE in VARCHAR2 default 'R'
    ...
    cursor C is select ROWID from IGS_PS_GOVT_DSCP
      where GOVT_DISCIPLINE_GROUP_CD = X_GOVT_DISCIPLINE_GROUP_CD;
...
procedure ADD_ROW (
  ...
  cursor c1 is select rowid from IGS_PS_GOVT_DSCP
     where GOVT_DISCIPLINE_GROUP_CD = X_GOVT_DISCIPLINE_GROUP_CD
  ;
begin
  open c1;
