--------------------------------------------------------
--  DDL for Package Body GR_EMEA_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GR_EMEA_PKG" AS
/*$Header: GRHIIEUB.pls 115.8 2002/10/30 19:59:16 mgrosser ship $*/
...
/*	  Now call the check foreign key procedure */
   ...
   Check_Foreign_Keys
			     (p_item_code,
				  ...
				  p_consolidated_safety_phrase,
				  p_approved_supply_list_conc,
...
/* 	   Now check the primary key doesn't already exist */
   ...
   INSERT INTO gr_emea
				  ...
				  consolidated_safety_phrase,
				  approved_supply_list_conc,
				  attribute_category,
				  attribute1,
				  attribute2,
				  attribute3,
...
/*	  Now call the check foreign key procedure */
   ...
   ELSE
	  ...
	  SET	 item_code 	 	 	 		 	 = p_item_code,
			 ...
			 consolidated_safety_phrase	  	 = p_consolidated_safety_phrase,
			 approved_supply_list_conc	  	 = p_approved_supply_list_conc,
...
/* 	   Check the not null columns */
   ...
   IF p_european_index_number IS NULL THEN
      x_return_status := 'E';
	  FND_MESSAGE.SET_NAME('GR',
	                       'GR_NULL_VALUE');
	  FND_MESSAGE.SET_TOKEN('CODE',
   ...
   IF p_approved_supply_list_conc IS NULL THEN
      x_return_status := 'E';
      FND_MESSAGE.SET_NAME('GR',
	                       'GR_NULL_VALUE');
	  FND_MESSAGE.SET_TOKEN('CODE',
...
CURSOR c_get_item_rowid
 IS
   SELECT eur.rowid
   FROM	  gr_emea eur
   WHERE  eur.item_code = p_item_code;
