--------------------------------------------------------
--  DDL for Package Body HR_AE_CONTINGENT_WORKER_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_AE_CONTINGENT_WORKER_API" as
/* $Header: pecwkaei.pkb 120.3.12000000.1 2007/01/21 21:39:55 appldev ship $ */
--
	-- Package Variables
	g_package  varchar2(33) := '  hr_ae_contingent_worker_api.';
