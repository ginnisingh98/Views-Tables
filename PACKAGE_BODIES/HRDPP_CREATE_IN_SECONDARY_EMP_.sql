--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_IN_SECONDARY_EMP_
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_IN_SECONDARY_EMP_" as
/*
...
,P_ASS_ATTRIBUTE30
,P_TITLE
,P_COVERED_BY_GRATUITY_ACT
,P_HAVING_SUBSTANTIAL_INTEREST
,P_DIRECTOR
,P_SPECIFIED
...
decode(l.pval003,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval003,'EMP_ASSIGN_REASON',d(l.pval001),l.pval133)) p3,
l.pval003 d3,
...
decode(l.pval006,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval006,'EMP_CAT',d(l.pval001),l.pval133)) p6,
l.pval006 d6,
decode(l.pval007,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval007,'FREQUENCY',d(l.pval001),l.pval133)) p7,
l.pval007 d7,
decode(l.pval008,cn,vn,vn,vn,l.pval008) p8,
l.pval008 d8,
decode(l.pval009,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval009,'YES_NO',d(l.pval001),l.pval133)) p9,
l.pval009 d9,
...
decode(l.pval012,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval012,'FREQUENCY',d(l.pval001),l.pval133)) p12,
l.pval012 d12,
decode(l.pval013,cn,nn,vn,nn,n(l.pval013)) p13,
l.pval013 d13,
decode(l.pval014,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval014,'QUALIFYING_UNITS',d(l.pval001),l.pval133)) p14,
l.pval014 d14,
decode(l.pval015,cn,nn,vn,nn,n(l.pval015)) p15,
l.pval015 d15,
decode(l.pval016,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval016,'FREQUENCY',d(l.pval001),l.pval133)) p16,
l.pval016 d16,
decode(l.pval017,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval017,'REC_TYPE',d(l.pval001),l.pval133)) p17,
l.pval017 d17,
...
decode(l.pval020,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval020,'BARGAINING_UNIT_CODE',d(l.pval001),l.pval133)) p20,
l.pval020 d20,
decode(l.pval021,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval021,'YES_NO',d(l.pval001),l.pval133)) p21,
l.pval021 d21,
decode(l.pval022,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval022,'HOURLY_SALARIED_CODE',d(l.pval001),l.pval133)) p22,
l.pval022 d22,
...
decode(l.pval055,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval055,'YES_NO',d(l.pval001),l.pval133)) p55,
l.pval055 d55,
decode(l.pval056,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval056,'YES_NO',d(l.pval001),l.pval133)) p56,
l.pval056 d56,
decode(l.pval057,cn,vn,vn,'N',
 hr_pump_get.gl(l.pval057,'YES_NO',d(l.pval001),l.pval133)) p57,
l.pval057 d57,
...
l.pval112 d112,
decode(l.pval113,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval113,'EMPLOYEE_CATG',d(l.pval001),l.pval133)) p113,
l.pval113 d113,
...
decode(l.pval133,cn,vn,l.pval133) p133,
...
L_GRE_LEGAL_ENTITY varchar2(2000);
L_PF_ORGANIZATION varchar2(2000);
L_PROF_TAX_ORGANIZATION varchar2(2000);
L_ESI_ORGANIZATION varchar2(2000);
L_FACTORY varchar2(2000);
...
--
if c.p131 is null then
L_PERSON_ID:=nn;
else
L_PERSON_ID := 
hr_pump_get.get_person_id
(P_PERSON_USER_KEY => c.p131);
end if;
--
if c.p132 is null or
c.p1 is null or
c.p133 is null then
...
(P_ORGANIZATION_NAME => c.p132
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p133);
end if;
--
...
(P_PAYROLL_NAME => c.p138
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p1);
end if;
--
if c.p139 is null or
c.p133 is null then
L_LOCATION_ID:=nn;
else
L_LOCATION_ID := 
hr_pump_get.get_location_id
(P_LOCATION_CODE => c.p139
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_LANGUAGE_CODE => c.p133);
end if;
--
...
(P_SPECIAL_CEILIN_STEP_USER_KEY => c.p141);
end if;
--
...
(P_DEFAULT_CODE_COMB_USER_KEY => c.p143);
end if;
--
...
(P_SET_OF_BOOKS_NAME => c.p144);
end if;
--
if c.p145 is null then
L_GRE_LEGAL_ENTITY:=vn;
else
L_GRE_LEGAL_ENTITY := 
PER_IN_DATA_PUMP.GET_GRE_ID
(P_GRE_LEGAL_ENTITY => c.p145);
end if;
--
if c.p146 is null then
L_PF_ORGANIZATION:=vn;
else
L_PF_ORGANIZATION := 
PER_IN_DATA_PUMP.GET_PF_ORG_ID
(P_PF_ORGANIZATION => c.p146);
end if;
--
if c.p147 is null then
L_PROF_TAX_ORGANIZATION:=vn;
else
L_PROF_TAX_ORGANIZATION := 
PER_IN_DATA_PUMP.GET_PROF_TAX_ORG_ID
(P_PROF_TAX_ORGANIZATION => c.p147);
end if;
--
if c.p148 is null then
L_ESI_ORGANIZATION:=vn;
else
L_ESI_ORGANIZATION := 
PER_IN_DATA_PUMP.GET_ESI_ID
(P_ESI_ORGANIZATION => c.p148);
end if;
--
if c.p149 is null then
L_FACTORY:=vn;
else
L_FACTORY := 
PER_IN_DATA_PUMP.GET_FACTORY_ID
(P_FACTORY => c.p149);
end if;
--
if c.p150 is null then
L_ESTABLISHMENT:=vn;
else
L_ESTABLISHMENT := 
PER_IN_DATA_PUMP.GET_EST_ID
(P_ESTABLISHMENT => c.p150);
end if;
--
if c.p151 is null then
L_CONTRACT_ID:=nn;
else
L_CONTRACT_ID := 
hr_pump_get.get_contract_id
(P_CONTRACT_USER_KEY => c.p151);
end if;
--
...
(P_ESTABLISHMENT_ORG_NAME => c.p152
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p133);
end if;
--
if c.p153 is null or
c.p1 is null then
...
(P_CAGR_ID_FLEX_NUM_USER_KEY => c.p154);
end if;
--
if c.p155 is null or
c.p1 is null then
L_GRADE_LADDER_PGM_ID:=nn;
else
L_GRADE_LADDER_PGM_ID := 
hr_pump_get.get_grade_ladder_pgm_id
(P_GRADE_LADDER_NAME => c.p155
,P_BUSINESS_GROUP_ID => P_BUSINESS_GROUP_ID
,P_EFFECTIVE_DATE => c.p1);
end if;
--
...
(P_SVR_ASSIGNMENT_USER_KEY => c.p156);
end if;
--
hr_data_pump.api_trc_on;
hr_in_assignment_api.create_in_secondary_emp_asg
...
,P_TITLE => c.p54
,P_GRE_LEGAL_ENTITY => L_GRE_LEGAL_ENTITY
,P_PF_ORGANIZATION => L_PF_ORGANIZATION
,P_PROF_TAX_ORGANIZATION => L_PROF_TAX_ORGANIZATION
,P_ESI_ORGANIZATION => L_ESI_ORGANIZATION
,P_FACTORY => L_FACTORY
,P_ESTABLISHMENT => L_ESTABLISHMENT
,P_COVERED_BY_GRATUITY_ACT => c.p55
,P_HAVING_SUBSTANTIAL_INTEREST => c.p56
,P_DIRECTOR => c.p57
,P_SPECIFIED => c.p58
...
,P_GSP_POST_PROCESS_WARNING => c.p130);
