--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_CA_EMP_PRVTAX_INF
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_CA_EMP_PRVTAX_INF" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:13
 * Generated for API: PAY_CA_EMP_PRVTAX_INF_API.CREATE_CA_EMP_PRVTAX_INF
 */
--
...
,P_PPIP_EXEMPT_FLAG in varchar2 default null) is
...
decode(l.pval012,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval012,'YES_NO',d(l.pval063),vn)) p12,
l.pval012 d12,
decode(l.pval013,cn,nn,vn,nn,n(l.pval013)) p13,
l.pval013 d13,
decode(l.pval014,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval014,'YES_NO',d(l.pval063),vn)) p14,
l.pval014 d14,
decode(l.pval015,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval015,'YES_NO',d(l.pval063),vn)) p15,
l.pval015 d15,
...
decode(l.pval024,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval024,'YES_NO',d(l.pval063),vn)) p24,
l.pval024 d24,
decode(l.pval025,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval025,'YES_NO',d(l.pval063),vn)) p25,
l.pval025 d25,
decode(l.pval026,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval026,'YES_NO',d(l.pval063),vn)) p26,
l.pval026 d26,
decode(l.pval027,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval027,'YES_NO',d(l.pval063),vn)) p27,
l.pval027 d27,
...
l.pval062 d62,
decode(l.pval063,cn,dn,d(l.pval063)) p63,
...
,P_PROVINCE_CODE => c.p6
,P_JURISDICTION_CODE => c.p7
,P_TAX_CREDIT_AMOUNT => c.p8
,P_BASIC_EXEMPTION_FLAG => c.p9
,P_DEDUCTION_CODE => c.p10
,P_EXTRA_INFO_NOT_PROVIDED => c.p11
,P_MARRIAGE_STATUS => c.p12
,P_NO_OF_INFIRM_DEPENDANTS => c.p13
,P_NON_RESIDENT_STATUS => c.p14
,P_DISABILITY_STATUS => c.p15
,P_NO_OF_DEPENDANTS => c.p16
,P_ANNUAL_DEDN => c.p17
,P_TOTAL_EXPENSE_BY_COMMISSION => c.p18
,P_TOTAL_REMNRTN_BY_COMMISSION => c.p19
,P_PRESCRIBED_ZONE_DEDN_AMT => c.p20
,P_ADDITIONAL_TAX => c.p21
,P_PROV_OVERRIDE_RATE => c.p22
,P_PROV_OVERRIDE_AMOUNT => c.p23
,P_PROV_EXEMPT_FLAG => c.p24
,P_PMED_EXEMPT_FLAG => c.p25
,P_WC_EXEMPT_FLAG => c.p26
,P_QPP_EXEMPT_FLAG => c.p27
,P_TAX_CALC_METHOD => c.p28
,P_OTHER_TAX_CREDIT => c.p29
,P_CA_TAX_INFORMATION_CATEGORY => c.p30
,P_CA_TAX_INFORMATION1 => c.p31
,P_CA_TAX_INFORMATION2 => c.p32
,P_CA_TAX_INFORMATION3 => c.p33
,P_CA_TAX_INFORMATION4 => c.p34
,P_CA_TAX_INFORMATION5 => c.p35
,P_CA_TAX_INFORMATION6 => c.p36
,P_CA_TAX_INFORMATION7 => c.p37
,P_CA_TAX_INFORMATION8 => c.p38
,P_CA_TAX_INFORMATION9 => c.p39
,P_CA_TAX_INFORMATION10 => c.p40
,P_CA_TAX_INFORMATION11 => c.p41
,P_CA_TAX_INFORMATION12 => c.p42
,P_CA_TAX_INFORMATION13 => c.p43
,P_CA_TAX_INFORMATION14 => c.p44
,P_CA_TAX_INFORMATION15 => c.p45
,P_CA_TAX_INFORMATION16 => c.p46
,P_CA_TAX_INFORMATION17 => c.p47
,P_CA_TAX_INFORMATION18 => c.p48
,P_CA_TAX_INFORMATION19 => c.p49
,P_CA_TAX_INFORMATION20 => c.p50
,P_CA_TAX_INFORMATION21 => c.p51
,P_CA_TAX_INFORMATION22 => c.p52
,P_CA_TAX_INFORMATION23 => c.p53
,P_CA_TAX_INFORMATION24 => c.p54
,P_CA_TAX_INFORMATION25 => c.p55
,P_CA_TAX_INFORMATION26 => c.p56
,P_CA_TAX_INFORMATION27 => c.p57
,P_CA_TAX_INFORMATION28 => c.p58
,P_CA_TAX_INFORMATION29 => c.p59
,P_CA_TAX_INFORMATION30 => c.p60
,P_OBJECT_VERSION_NUMBER => c.p61
,P_PROV_LSP_AMOUNT => c.p62
,P_EFFECTIVE_DATE => c.p63
,P_PPIP_EXEMPT_FLAG => c.p64);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p1,L_EMP_PROVINCE_TAX_INF_ID);
--
...
end hrdpp_CREATE_CA_EMP_PRVTAX_INF;
