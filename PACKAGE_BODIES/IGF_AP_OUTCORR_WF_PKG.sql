--------------------------------------------------------
--  DDL for Package Body IGF_AP_OUTCORR_WF_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_AP_OUTCORR_WF_PKG" AS
/* $Header: IGFAI52B.pls 120.0 2005/06/01 14:03:38 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igf_ap_outcorr_wf%ROWTYPE;
  new_references igf_ap_outcorr_wf%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.item_key                          := x_item_key;
    new_references.ow_id                             := x_ow_id;
  ...
  */
  ...
  BEGIN
    ...
    END IF;
     ...
     select igf_ap_outcorr_wf_s.nextval INTO x_ow_id FROM dual;
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND ((tlinfo.item_key = x_item_key) OR ((tlinfo.item_key IS NULL) AND (X_item_key IS NULL)))
	AND (tlinfo.ow_id = x_ow_id)
       ) THEN
      NULL;
    ELSE
  ...
  BEGIN
    ...
    UPDATE igf_ap_outcorr_wf
      SET
        ...
        item_key                          = new_references.item_key,
	ow_id                             = new_references.ow_id,
