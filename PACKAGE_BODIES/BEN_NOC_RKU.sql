--------------------------------------------------------
--  DDL for Package Body BEN_NOC_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_NOC_RKU" as
...
begin
hr_utility.set_location('Entering: BEN_NOC_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: BEN_NOC_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end BEN_NOC_RKU;
