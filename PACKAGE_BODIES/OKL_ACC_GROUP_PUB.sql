--------------------------------------------------------
--  DDL for Package Body OKL_ACC_GROUP_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ACC_GROUP_PUB" AS
/* $Header: OKLPAGCB.pls 115.5 2002/12/18 12:09:28 kjinger noship $ */
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    okl_acc_group_pvt.create_acc_group(p_api_version   => p_api_version
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    okl_acc_group_pvt.create_acc_ccid(p_api_version   => p_api_version
                          ,p_init_msg_list => p_init_msg_list
                          ,x_return_status => l_return_status
                          ,x_msg_count     => x_msg_count
                          ,x_msg_data      => x_msg_data
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','create_acc_ccid');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
   ...
   -- vertical industry-preprocessing
    ...
    IF (l_agcv_tbl.COUNT > 0) THEN
      ...
      LOOP
        ...
        OKL_ACC_GROUP_PUB.create_acc_ccid(
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    okl_acc_group_pvt.update_acc_group(p_api_version   => p_api_version
                        ,p_init_msg_list => p_init_msg_list
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','update_acc_ccid');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  PROCEDURE validate_acc_group(p_api_version           IN  NUMBER
                              ,p_init_msg_list         IN  VARCHAR2 DEFAULT OKC_API.G_FALSE
                              ,x_return_status         OUT NOCOPY VARCHAR2
                              ,x_msg_count             OUT NOCOPY NUMBER
                              ,x_msg_data              OUT NOCOPY VARCHAR2
    ...
    l_return_status         VARCHAR2(1) := FND_API.G_RET_STS_SUCCESS;
    l_api_name              CONSTANT VARCHAR2(30)  := 'validate_acc_ccid';
    l_agcv_rec              agcv_rec_type := p_agcv_rec;
    l_agbv_tbl              agbv_tbl_type := p_agbv_tbl;
...
-- call complex entity API
    ...
    okl_acc_group_pvt.validate_acc_group(p_api_version   => p_api_version
                          ,p_init_msg_list => p_init_msg_list
                          ,x_return_status => l_return_status
                          ,x_msg_count     => x_msg_count
                          ,x_msg_data      => x_msg_data
  ...
  EXCEPTION
    ...
    WHEN FND_API.G_EXC_ERROR THEN
      ROLLBACK TO validate_acc_group;
      x_return_status := FND_API.G_RET_STS_ERROR;
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','validate_acc_group');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
 ...
 IS
    ...
    l_return_status          VARCHAR2(1)   := FND_API.G_RET_STS_SUCCESS;
    l_api_name               CONSTANT VARCHAR2(30)  := 'lock_acc_ccid';
  ...
  BEGIN
    ...
    SAVEPOINT lock_acc_ccid;


    okl_acc_group_pvt.lock_acc_ccid(
                         p_api_version   => p_api_version
                        ,p_init_msg_list => p_init_msg_list
                        ,x_return_status => l_return_status
                        ,x_msg_count     => x_msg_count
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','lock_acc_ccid');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  --Initialize the return status
    ...
    IF (p_agcv_tbl.COUNT > 0) THEN
      ...
      LOOP
        ...
        OKL_ACC_GROUP_PUB.lock_acc_ccid(p_api_version   => p_api_version
                          ,p_init_msg_list => p_init_msg_list
                          ,x_return_status => l_return_status
                          ,x_msg_count     => x_msg_count
                          ,x_msg_data      => x_msg_data
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_STREAM_TYPE_PUB','lock_acc_ccid');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    okl_acc_group_pvt.update_acc_ccid(p_api_version   => p_api_version
                          ,p_init_msg_list => p_init_msg_list
                          ,x_return_status => l_return_status
                          ,x_msg_count     => x_msg_count
                          ,x_msg_data      => x_msg_data
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    okl_acc_group_pvt.delete_acc_ccid(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','delete_acc_ccid');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    okl_acc_group_pvt.validate_acc_ccid(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','validate_acc_ccid');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    okl_acc_group_pvt.create_acc_bal(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','create_acc_bal');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  PROCEDURE lock_acc_bal(
    ...
    l_api_name                        CONSTANT VARCHAR2(30)  := 'lock_acc_bal';

  BEGIN

    x_return_status    := FND_API.G_RET_STS_SUCCESS;
	SAVEPOINT lock_acc_bal;

    okl_acc_group_pvt.lock_acc_bal(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','lock_acc_bal');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    okl_acc_group_pvt.update_acc_bal(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','update_acc_bal');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  BEGIN
   ...
   -- call complex entity API
    ...
    okl_acc_group_pvt.delete_acc_bal(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','delete_acc_bal');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
  ...
  PROCEDURE validate_acc_bal(
    ...
    l_api_name                        CONSTANT VARCHAR2(30)  := 'validate_acc_bal';

    l_agbv_rec                      agbv_rec_type := p_agbv_rec;

  BEGIN

    SAVEPOINT validate_acc_bal;
    x_return_status    := FND_API.G_RET_STS_SUCCESS;
   ...
   -- call complex entity API
    ...
    okl_acc_group_pvt.validate_acc_bal(
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      FND_MSG_PUB.ADD_EXC_MSG('OKL_ACC_GROUP_PUB','validate_acc_bal');
      -- store SQL error message on message stack for caller
      FND_MSG_PUB.Count_and_get(p_encoded => OKC_API.G_FALSE
                               ,p_count   => x_msg_count
                               ,p_data    => x_msg_data);
