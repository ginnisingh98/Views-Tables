--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_IN_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_IN_PERSONAL_PAY_M" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:14
 * Generated for API: hr_in_personal_pay_method_api.create_in_personal_pay_method
 */
--
...
l.pval027 d27,
decode(l.pval028,cn,vn,vn,'SB',
 hr_pump_get.gl(l.pval028,'IN_ACCOUNT_TYPE',d(l.pval001),l.pval043)) p28,
l.pval028 d28,
decode(l.pval029,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval029,'IN_BANK',d(l.pval001),l.pval043)) p29,
l.pval029 d29,
decode(l.pval030,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval030,'IN_BANK_BRANCH',d(l.pval001),l.pval043)) p30,
l.pval030 d30,
decode(l.pval031,cn,vn,vn,vn,l.pval031) p31,
l.pval031 d31,
decode(l.pval032,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval032,'PAYEE_TYPE',d(l.pval001),l.pval043)) p32,
l.pval032 d32,
l.pval033 p33,
l.pval034 p34,
l.pval035 p35,
...
(P_ORG_PAYMENT_METHOD_USER_KEY => c.p40);
end if;
--
L_PAYEE_ID := 
...
,P_PAYEE_ORG => c.p41
,P_PAYEE_PERSON_USER_KEY => c.p42
,P_EFFECTIVE_DATE => c.p1
,P_LANGUAGE_CODE => c.p43);
--
hr_data_pump.api_trc_on;
hr_in_personal_pay_method_api.create_in_personal_pay_method
...
,P_ATTRIBUTE19 => c.p25
,P_ATTRIBUTE20 => c.p26
,P_ACCOUNT_NUMBER => c.p27
,P_ACCOUNT_TYPE => c.p28
,P_BANK_CODE => c.p29
,P_BRANCH_CODE => c.p30
,P_CONCAT_SEGMENTS => c.p31
,P_PAYEE_TYPE => c.p32
,P_PAYEE_ID => L_PAYEE_ID
,P_PERSONAL_PAYMENT_METHOD_ID => L_PERSONAL_PAYMENT_METHOD_ID
,P_EXTERNAL_ACCOUNT_ID => c.p34
,P_OBJECT_VERSION_NUMBER => c.p35
,P_EFFECTIVE_START_DATE => c.p36
,P_EFFECTIVE_END_DATE => c.p37
,P_COMMENT_ID => c.p38);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p33,L_PERSONAL_PAYMENT_METHOD_ID);
--
...
l.pval036 = decode(c.p36,null,cn,dc(c.p36)),
...
end hrdpp_create_in_personal_pay_m;
