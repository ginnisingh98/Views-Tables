--------------------------------------------------------
--  DDL for Package Body PER_ABB_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ABB_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_abb_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PER_ABSENCE_ATTENDANCE_TYP_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PER_ABSENCE_ATTENDANCE_TYP_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  --
  If (p_absence_attendance_type_id is null and
  ...
  Else
    If (p_absence_attendance_type_id
        = per_abb_shd.g_old_rec.absence_attendance_type_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_abb_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_abb_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  l_rec.hours_or_days                    := p_hours_or_days;
  l_rec.increasing_or_decreasing_flag    := p_inc_or_dec_flag;
  ...
  --
  l_rec.user_role                        := p_user_role;
  l_rec.assignment_status_type_id        := p_assignment_status_type_id;
  l_rec.advance_pay                      := p_advance_pay;
  l_rec.absence_overlap_flag             := p_absence_overlap_flag ;
  --
