--------------------------------------------------------
--  DDL for Package Body IGW_BUDGET_PERIODS_TBH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGW_BUDGET_PERIODS_TBH" AS
-- $Header: igwtbprb.pls 115.5 2002/11/14 18:41:23 vmedikon ship $
...
begin
  x_return_status := FND_API.G_RET_STS_SUCCESS;
    ...
    insert into igw_budget_periods(
	proposal_id
	,version_id
        ,budget_period_id
	,start_date
    ...
    open c_budget_period;
    fetch c_budget_period into x_ROWID;
    if (c_budget_period%notfound) then
      close c_budget_period;
      raise no_data_found;
    end if;
    close c_budget_period;
...
begin
    ...
    ,      program_income = p_program_income
    ,      program_income_source = p_program_income_source
