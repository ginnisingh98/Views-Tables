--------------------------------------------------------
--  DDL for Package Body FND_SET_COPY
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FND_SET_COPY" as
/* $Header: AFRSCPSB.pls 115.1 99/07/16 23:26:44 porting sh $ */

function set_program_args(
  parent 			in  number,
  req_set_prog_id               in  number,
  ...
  attribute99 in out varchar2, attribute100 in out varchar2) return boolean is
...
begin
  ...
  select
    p.srs_flag, p.concurrent_program_name, r.application_id,
  ...
  into
    ...
    arg_tab(25), arg_tab(26), arg_tab(27), arg_tab(28),
    arg_tab(29), arg_tab(30), arg_tab(31), arg_tab(32),
    arg_tab(33), arg_tab(34), arg_tab(35), arg_tab(36),
    arg_tab(37), arg_tab(38), arg_tab(39), arg_tab(40),
    arg_tab(41), arg_tab(42), arg_tab(43), arg_tab(44),
    arg_tab(45), arg_tab(46), arg_tab(47), arg_tab(48),
    arg_tab(49), arg_tab(50), arg_tab(51), arg_tab(52),
    arg_tab(53), arg_tab(54), arg_tab(55), arg_tab(56),
    arg_tab(57), arg_tab(58), arg_tab(59), arg_tab(60),
    arg_tab(61), arg_tab(62), arg_tab(63), arg_tab(64),
    arg_tab(65), arg_tab(66), arg_tab(67), arg_tab(68),
    arg_tab(69), arg_tab(70), arg_tab(71), arg_tab(72),
    arg_tab(73), arg_tab(74), arg_tab(75), arg_tab(76),
    arg_tab(77), arg_tab(78), arg_tab(79), arg_tab(80),
    arg_tab(81), arg_tab(82), arg_tab(83), arg_tab(84),
    arg_tab(85), arg_tab(86), arg_tab(87), arg_tab(88),
    arg_tab(89), arg_tab(90), arg_tab(91), arg_tab(92),
    arg_tab(93), arg_tab(94), arg_tab(95), arg_tab(96),
    arg_tab(97), arg_tab(98), arg_tab(99), arg_tab(100)
  from fnd_run_requests r, fnd_concurrent_programs p
  where r.parent_request_id = parent
    and r.request_set_program_id = req_set_prog_id
