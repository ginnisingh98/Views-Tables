--------------------------------------------------------
--  DDL for Package Body BEN_VEP_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_VEP_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_vep_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.vrbl_rt_elig_prfl_id       = p_rec.vrbl_rt_elig_prfl_id
    and    t.effective_start_date =
             ben_vep_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc                varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          BEN_VRBL_RT_ELIG_PRFL_f.created_by%TYPE;
  l_creation_date       BEN_VRBL_RT_ELIG_PRFL_f.creation_date%TYPE;
  l_last_update_date   	BEN_VRBL_RT_ELIG_PRFL_f.last_update_date%TYPE;
  l_last_updated_by     BEN_VRBL_RT_ELIG_PRFL_f.last_updated_by%TYPE;
  l_last_update_login   BEN_VRBL_RT_ELIG_PRFL_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: BEN_VRBL_RT_ELIG_PRFL_f
  --
  insert into BEN_VRBL_RT_ELIG_PRFL_f
...
--
  Cursor C_Sel1 is select BEN_VRBL_RT_ELIG_PRFL_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.vrbl_rt_elig_prfl_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  dt_api.validate_dt_mode
    ...
    ,p_parent_key_value2       => p_rec.eligy_prfl_id
...
Begin
  ...
  --
  p_vrbl_rt_elig_prfl_id             := l_rec.vrbl_rt_elig_prfl_id;
