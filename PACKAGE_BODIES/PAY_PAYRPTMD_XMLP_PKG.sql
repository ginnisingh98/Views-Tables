--------------------------------------------------------
--  DDL for Package Body PAY_PAYRPTMD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PAYRPTMD_XMLP_PKG" AS
/* $Header: PAYRPTMDB.pls 120.0 2008/01/11 07:08:32 srikrish noship $ */

function BeforeReport return boolean is
 l_trace_value varchar2(10);
begin

   P_ENABLED_FLAG_1 := NVL(P_ENABLED_FLAG,'Y');
...
function cf_count_table_nameformula(CS_COUNT_TABLE_NAME in number) return number is
begin
 CP_COUNT_TABLE_NAME := CS_COUNT_TABLE_NAME;
  return 1;
...
--Functions to refer Oracle report placeholders--
 ...
 Function CP_COUNT_TABLE_NAME_p return number is
	Begin
	 return CP_COUNT_TABLE_NAME;
	 END;
