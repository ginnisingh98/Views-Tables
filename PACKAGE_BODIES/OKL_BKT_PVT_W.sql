--------------------------------------------------------
--  DDL for Package Body OKL_BKT_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_BKT_PVT_W" as
  /* $Header: OKLIBKTB.pls 120.1 2005/07/07 12:47:28 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_bkt_pvt.bkt_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ibc_id := rosetta_g_miss_num_map(a1(indx));
          t(ddindx).version := a2(indx);
          t(ddindx).loss_rate := rosetta_g_miss_num_map(a3(indx));
          ...
          t(ddindx).last_updated_by := rosetta_g_miss_num_map(a14(indx));
          t(ddindx).last_update_date := rosetta_g_miss_date_in_map(a15(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_bkt_pvt.bkt_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a16 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := rosetta_g_miss_num_map(t(ddindx).ibc_id);
          a2(indx) := t(ddindx).version;
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).loss_rate);
          ...
          a14(indx) := rosetta_g_miss_num_map(t(ddindx).last_updated_by);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_bkt_pvt.bktv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).ibc_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).version := a3(indx);
          t(ddindx).comments := a4(indx);
          t(ddindx).loss_rate := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).program_id := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).request_id := rosetta_g_miss_num_map(a7(indx));
          t(ddindx).program_application_id := rosetta_g_miss_num_map(a8(indx));
          t(ddindx).program_update_date := rosetta_g_miss_date_in_map(a9(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_bkt_pvt.bktv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_NUMBER_TABLE
    ...
    a16 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).ibc_id);
          a3(indx) := t(ddindx).version;
          a4(indx) := t(ddindx).comments;
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).loss_rate);
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).program_id);
          a7(indx) := rosetta_g_miss_num_map(t(ddindx).request_id);
          a8(indx) := rosetta_g_miss_num_map(t(ddindx).program_application_id);
          a9(indx) := t(ddindx).program_update_date;
  ...
  as
    ddp_bktv_rec okl_bkt_pvt.bktv_rec_type;
    ddx_bktv_rec okl_bkt_pvt.bktv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_bkt_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_bktv_tbl okl_bkt_pvt.bktv_tbl_type;
    ddx_bktv_tbl okl_bkt_pvt.bktv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_bkt_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_bkt_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_bkt_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_bkt_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
