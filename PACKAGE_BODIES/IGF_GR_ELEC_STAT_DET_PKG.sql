--------------------------------------------------------
--  DDL for Package Body IGF_GR_ELEC_STAT_DET_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_GR_ELEC_STAT_DET_PKG" AS
/* $Header: IGFGI10B.pls 115.6 2002/11/28 14:17:33 nsidana ship $ */

  l_rowid VARCHAR2(25);
  old_references igf_gr_elec_stat_det_all%ROWTYPE;
  new_references igf_gr_elec_stat_det_all%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.esd_id                            := x_esd_id;
    ...
    new_references.gaps_process_date                 := x_gaps_process_date;
    new_references.adj_batch_id                      := x_adj_batch_id;
  ...
  */
    ...
    l_org_id                     igf_gr_elec_stat_det_all.org_id%TYPE;
  ...
  BEGIN
    ...
    ELSE
      ...
      app_exception.raise_exception;
    END IF;
    SELECT igf_gr_elec_stat_det_s.NEXTVAL INTO x_esd_id FROM dual;
    ...
    before_dml(
      ...
      x_adj_amt                           => x_adj_amt,
      x_gaps_process_date                 => x_gaps_process_date,
      x_adj_batch_id                      => x_adj_batch_id,
    ...
    INSERT INTO igf_gr_elec_stat_det_all (
      esd_id,
      rep_pell_id,
      duns_id,
      gaps_award_num,
      ...
      new_references.gaps_process_date,
      new_references.adj_batch_id,
      x_last_update_date,
      x_last_updated_by,
      x_last_update_date,
      x_last_updated_by,
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND ((tlinfo.adj_amt = x_adj_amt) OR ((tlinfo.adj_amt IS NULL) AND (X_adj_amt IS NULL)))
        AND ((tlinfo.gaps_process_date = x_gaps_process_date) OR ((tlinfo.gaps_process_date IS NULL) AND (X_gaps_process_date IS NULL)))
        AND ((tlinfo.adj_batch_id = x_adj_batch_id) OR ((tlinfo.adj_batch_id IS NULL) AND (X_adj_batch_id IS NULL)))
       ) THEN
      NULL;
    ELSE
  ...
  */
  ...
  BEGIN
    ...
    UPDATE igf_gr_elec_stat_det_all
      SET
        ...
        gaps_process_date                 = new_references.gaps_process_date,
        adj_batch_id                      = new_references.adj_batch_id,
  ...
  */
  BEGIN
    ...
    DELETE FROM igf_gr_elec_stat_det_all
    WHERE rowid = x_rowid;
