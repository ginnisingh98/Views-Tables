--------------------------------------------------------
--  DDL for Package Body PAY_RAN_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_RAN_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_ran_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_range_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_range_id  in  number) is
--
...
Begin
  ...
  --
  pay_ran_ins.g_range_id_i := p_range_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: pay_ranges_f
  --
  insert into pay_ranges_f
      (range_id
      ,range_table_id
      ,low_band
      ,high_band
...
--
  Cursor C_Sel1 is select pay_ranges_f_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from pay_ranges_f
     where range_id =
             pay_ran_ins.g_range_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (pay_ran_ins.g_range_id_i is not null) Then
    --
  ...
  Else
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.range_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  pay_ran_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pay_ran_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --

-- Commented Because the User Hook is not provided now
/*
pay_ran_ins.post_insert
     (p_rec
     );
*/
