--------------------------------------------------------
--  DDL for Package Body OTA_CTL_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CTL_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_ctl_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the ota_certifications_tl row.
  --
  delete from ota_certifications_tl
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in ota_ctl_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in ota_ctl_shd.g_rec_type) is
--
...
Begin
  ...
  --
  ota_ctl_bus.delete_validate(p_rec);
  --
  ...
  --
  ota_ctl_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  ota_ctl_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  ota_ctl_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
...
Begin
  ...
  --
  --
  -- Having converted the arguments into the ota_ctl_rec
  -- plsql record structure we must call the corresponding entity
  -- business process
  --
  ota_ctl_del.del(l_rec);
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End del;
--
