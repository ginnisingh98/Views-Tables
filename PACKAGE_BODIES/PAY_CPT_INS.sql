--------------------------------------------------------
--  DDL for Package Body PAY_CPT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_CPT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pay_cpt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.emp_province_tax_inf_id       = p_rec.emp_province_tax_inf_id
    and    t.effective_start_date =
             pay_cpt_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          pay_ca_emp_prov_tax_info_f.created_by%TYPE;
  l_creation_date       pay_ca_emp_prov_tax_info_f.creation_date%TYPE;
  l_last_update_date   	pay_ca_emp_prov_tax_info_f.last_update_date%TYPE;
  l_last_updated_by     pay_ca_emp_prov_tax_info_f.last_updated_by%TYPE;
  l_last_update_login   pay_ca_emp_prov_tax_info_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: pay_ca_emp_prov_tax_info_f
  --
  insert into pay_ca_emp_prov_tax_info_f
...
--
  Cursor C_Sel1 is select pay_ca_emp_prov_tax_info_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.emp_province_tax_inf_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
 ...
 */
  ...
  --
  p_emp_province_tax_inf_id        	:= l_rec.emp_province_tax_inf_id;
