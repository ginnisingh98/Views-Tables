--------------------------------------------------------
--  DDL for Package Body PAY_PPD_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PPD_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_ppd_shd.';  -- Global package name
...
Begin
  --
  If (p_constraint_name = 'PAY_PL_PAYE_DETAILS_F_PK') Then
...
Begin
  ...
  Else
    If (p_paye_details_id =
        pay_ppd_shd.g_old_rec.paye_details_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into pay_ppd_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> pay_ppd_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  If (p_datetrack_mode <> hr_api.g_insert) then
    ...
    /*4555363: Included TERM_NORMAL.Otherwise l_validation_start_date and l_validation_end_date
               will not be set
     */
...
Begin
  ...
  l_rec.tax_reduction                    := p_tax_reduction;
  l_rec.tax_calc_with_spouse_child       := p_tax_calc_with_spouse_child;
  l_rec.income_reduction                 := p_income_reduction;
  l_rec.income_reduction_amount          := p_income_reduction_amount;
  l_rec.rate_of_tax                      := p_rate_of_tax;
