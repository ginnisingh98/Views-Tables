--------------------------------------------------------
--  DDL for Package Body HR_SE_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SE_EMPLOYEE_API" as
/* $Header: peempsei.pkb 120.0 2005/05/31 08:06 appldev noship $ */
--
  g_package  varchar2(33) := 'hr_se_employee_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_se_employee >------------------------------|
-- -----------------------------------------------------------------------------
...
is
    ...
    l_proc                 VARCHAR2(72) := g_package||'create_se_employee';
