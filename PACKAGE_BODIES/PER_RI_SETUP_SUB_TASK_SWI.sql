--------------------------------------------------------
--  DDL for Package Body PER_RI_SETUP_SUB_TASK_SWI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_RI_SETUP_SUB_TASK_SWI" As
/* $Header: pessbswi.pkb 115.1 2003/08/06 01:31:06 kavenkat noship $ */
--
-- Package variables
--
g_package  varchar2(33) := 'per_ri_setup_sub_task_swi.';
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint create_setup_sub_task_swi;
  --
...
exception
  when hr_multi_message.error_message_exist then
    ...
    --
    rollback to create_setup_sub_task_swi;
    --
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint delete_setup_sub_task_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to delete_setup_sub_task_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
    p_return_status := hr_multi_message.get_return_status_disable;
...
Begin
  ...
  -- Issue a savepoint
  --
  savepoint update_setup_sub_task_swi;
  --
  -- Initialise Multiple Message Detection
  --
  hr_multi_message.enable_message_list;
...
exception
  when hr_multi_message.error_message_exist then
    ...
    -- at least one message exists in the list.
    --
    rollback to update_setup_sub_task_swi;
    --
    -- Reset IN OUT parameters and set OUT parameters
    --
