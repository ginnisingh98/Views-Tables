--------------------------------------------------------
--  DDL for Package Body BEN_APLD_DPNT_CVG_PRFL_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_APLD_DPNT_CVG_PRFL_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_APLD_DPNT_CVG_PRFL_BK1.CREATE_APLD_DPNT_CVG_PRFL_A', 10);
hr_utility.set_location(' Leaving: BEN_APLD_DPNT_CVG_PRFL_BK1.CREATE_APLD_DPNT_CVG_PRFL_A', 20);
end CREATE_APLD_DPNT_CVG_PRFL_A;
...
begin
hr_utility.set_location('Entering: BEN_APLD_DPNT_CVG_PRFL_BK1.CREATE_APLD_DPNT_CVG_PRFL_B', 10);
hr_utility.set_location(' Leaving: BEN_APLD_DPNT_CVG_PRFL_BK1.CREATE_APLD_DPNT_CVG_PRFL_B', 20);
end CREATE_APLD_DPNT_CVG_PRFL_B;
