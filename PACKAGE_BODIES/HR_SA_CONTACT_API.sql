--------------------------------------------------------
--  DDL for Package Body HR_SA_CONTACT_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_SA_CONTACT_API" as
/* $Header: peconsai.pkb 120.3 2005/06/20 02:11:56 adevanat noship $ */
--
	-- Package Variables
   g_package  varchar2(33) := 'hr_sa_contact_api';
