--------------------------------------------------------
--  DDL for Package Body HR_KI_TOPIC_INTEGRATIONS_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_KI_TOPIC_INTEGRATIONS_BK1" as
...
begin
hr_utility.set_location('Entering: HR_KI_TOPIC_INTEGRATIONS_BK1.CREATE_TOPIC_INTEGRATION_A', 10);
hr_utility.set_location(' Leaving: HR_KI_TOPIC_INTEGRATIONS_BK1.CREATE_TOPIC_INTEGRATION_A', 20);
end CREATE_TOPIC_INTEGRATION_A;
...
begin
hr_utility.set_location('Entering: HR_KI_TOPIC_INTEGRATIONS_BK1.CREATE_TOPIC_INTEGRATION_B', 10);
hr_utility.set_location(' Leaving: HR_KI_TOPIC_INTEGRATIONS_BK1.CREATE_TOPIC_INTEGRATION_B', 20);
end CREATE_TOPIC_INTEGRATION_B;
