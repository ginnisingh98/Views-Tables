--------------------------------------------------------
--  DDL for Package Body OTA_SRT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_SRT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_srt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: ota_suppliable_resources_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.supplied_resource_id             := p_supplied_resource_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  ota_srt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  ota_srt_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where srt.supplied_resource_id = p_supplied_resource_id
                          and srt.language = l.language_code);
  --
...
Begin
  ...
  ota_srt_upd.upd_key_flex_meanings(p_supplied_resource_id);
  --
  hr_utility.set_location('Leaving:'||l_proc,20);
End ins_tl;
--
