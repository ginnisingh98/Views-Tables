--------------------------------------------------------
--  DDL for Package Body BEN_WV_PRTN_RSN_PTIP_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_WV_PRTN_RSN_PTIP_API" as
/* $Header: bewptapi.pkb 115.3 2003/01/01 00:02:56 mmudigon ship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_WV_PRTN_RSN_PTIP_api.';
--
-- ----------------------------------------------------------------------------
...
procedure create_WV_PRTN_RSN_PTIP
  ...
  --
  l_wv_prtn_rsn_ptip_id ben_wv_prtn_rsn_ptip_f.wv_prtn_rsn_ptip_id%TYPE;
  l_effective_start_date ben_wv_prtn_rsn_ptip_f.effective_start_date%TYPE;
  l_effective_end_date ben_wv_prtn_rsn_ptip_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_WV_PRTN_RSN_PTIP';
  l_object_version_number ben_wv_prtn_rsn_ptip_f.object_version_number%TYPE;
  --
begin
  --
  ...
  --
  savepoint create_WV_PRTN_RSN_PTIP;
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_WV_PRTN_RSN_PTIP
    --
    ben_WV_PRTN_RSN_PTIP_bk1.create_WV_PRTN_RSN_PTIP_b
      (
       p_business_group_id              =>  p_business_group_id
      ,p_ptip_id                        =>  p_ptip_id
      ,p_dflt_flag                      =>  p_dflt_flag
      ,p_wv_prtn_rsn_cd                 =>  p_wv_prtn_rsn_cd
      ,p_wpt_attribute_category         =>  p_wpt_attribute_category
      ,p_wpt_attribute1                 =>  p_wpt_attribute1
      ,p_wpt_attribute2                 =>  p_wpt_attribute2
      ,p_wpt_attribute3                 =>  p_wpt_attribute3
      ,p_wpt_attribute4                 =>  p_wpt_attribute4
      ,p_wpt_attribute5                 =>  p_wpt_attribute5
      ,p_wpt_attribute6                 =>  p_wpt_attribute6
      ,p_wpt_attribute7                 =>  p_wpt_attribute7
      ,p_wpt_attribute8                 =>  p_wpt_attribute8
      ,p_wpt_attribute9                 =>  p_wpt_attribute9
      ,p_wpt_attribute10                =>  p_wpt_attribute10
      ,p_wpt_attribute11                =>  p_wpt_attribute11
      ,p_wpt_attribute12                =>  p_wpt_attribute12
      ,p_wpt_attribute13                =>  p_wpt_attribute13
      ,p_wpt_attribute14                =>  p_wpt_attribute14
      ,p_wpt_attribute15                =>  p_wpt_attribute15
      ,p_wpt_attribute16                =>  p_wpt_attribute16
      ,p_wpt_attribute17                =>  p_wpt_attribute17
      ,p_wpt_attribute18                =>  p_wpt_attribute18
      ,p_wpt_attribute19                =>  p_wpt_attribute19
      ,p_wpt_attribute20                =>  p_wpt_attribute20
      ,p_wpt_attribute21                =>  p_wpt_attribute21
      ,p_wpt_attribute22                =>  p_wpt_attribute22
      ,p_wpt_attribute23                =>  p_wpt_attribute23
      ,p_wpt_attribute24                =>  p_wpt_attribute24
      ,p_wpt_attribute25                =>  p_wpt_attribute25
      ,p_wpt_attribute26                =>  p_wpt_attribute26
      ,p_wpt_attribute27                =>  p_wpt_attribute27
      ,p_wpt_attribute28                =>  p_wpt_attribute28
      ,p_wpt_attribute29                =>  p_wpt_attribute29
      ,p_wpt_attribute30                =>  p_wpt_attribute30
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_WV_PRTN_RSN_PTIP'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_WV_PRTN_RSN_PTIP
    --
  end;
  --
  ben_wpt_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_WV_PRTN_RSN_PTIP
    --
    ben_WV_PRTN_RSN_PTIP_bk1.create_WV_PRTN_RSN_PTIP_a
      (
       p_wv_prtn_rsn_ptip_id            =>  l_wv_prtn_rsn_ptip_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_WV_PRTN_RSN_PTIP
    --
  end;
  --
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    --
    ROLLBACK TO create_WV_PRTN_RSN_PTIP;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
    --
    p_wv_prtn_rsn_ptip_id := null;
...
procedure update_WV_PRTN_RSN_PTIP
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_WV_PRTN_RSN_PTIP';
  l_object_version_number ben_wv_prtn_rsn_ptip_f.object_version_number%TYPE;
  l_effective_start_date ben_wv_prtn_rsn_ptip_f.effective_start_date%TYPE;
  l_effective_end_date ben_wv_prtn_rsn_ptip_f.effective_end_date%TYPE;
  --
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint update_WV_PRTN_RSN_PTIP;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_WV_PRTN_RSN_PTIP
    --
    ben_WV_PRTN_RSN_PTIP_bk2.update_WV_PRTN_RSN_PTIP_b
      (
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_WV_PRTN_RSN_PTIP'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_WV_PRTN_RSN_PTIP
    --
  end;
  --
  ben_wpt_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_WV_PRTN_RSN_PTIP
    --
    ben_WV_PRTN_RSN_PTIP_bk2.update_WV_PRTN_RSN_PTIP_a
      (
       p_wv_prtn_rsn_ptip_id            =>  p_wv_prtn_rsn_ptip_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_WV_PRTN_RSN_PTIP
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO update_WV_PRTN_RSN_PTIP;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
...
begin
  ...
  -- Issue a savepoint if operating in validation only mode
  --
  savepoint delete_WV_PRTN_RSN_PTIP;
  --
  hr_utility.set_location(l_proc, 20);
  --
  -- Process Logic
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_WV_PRTN_RSN_PTIP
    --
    ben_WV_PRTN_RSN_PTIP_bk3.delete_WV_PRTN_RSN_PTIP_b
      (
       p_wv_prtn_rsn_ptip_id            =>  p_wv_prtn_rsn_ptip_id
      ,p_object_version_number          =>  p_object_version_number
    ,p_effective_date                      => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_WV_PRTN_RSN_PTIP'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_WV_PRTN_RSN_PTIP
    --
  end;
  --
  ben_wpt_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_WV_PRTN_RSN_PTIP
    --
    ben_WV_PRTN_RSN_PTIP_bk3.delete_WV_PRTN_RSN_PTIP_a
      (
       p_wv_prtn_rsn_ptip_id            =>  p_wv_prtn_rsn_ptip_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_WV_PRTN_RSN_PTIP
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
exception
  ...
  when hr_api.validate_enabled then
    ...
    -- we must rollback to the savepoint
    --
    ROLLBACK TO delete_WV_PRTN_RSN_PTIP;
    --
    -- Only set output warning arguments
    -- (Any key or derived arguments must be set to null
    -- when validation only mode is being used.)
