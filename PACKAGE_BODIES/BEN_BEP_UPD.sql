--------------------------------------------------------
--  DDL for Package Body BEN_BEP_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BEP_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ben_bep_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_update_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  If (p_datetrack_mode = hr_api.g_correction) then
    ...
    --
    --
    -- Update the ben_elig_obj_elig_profl_f Row
    --
    update  ben_elig_obj_elig_profl_f
    set
     elig_obj_elig_prfl_id                = p_rec.elig_obj_elig_prfl_id
    ,elig_obj_id                          = p_rec.elig_obj_id
    ,elig_prfl_id                         = p_rec.elig_prfl_id
    ,mndtry_flag                          = p_rec.mndtry_flag
    ,business_group_id                    = p_rec.business_group_id
    ,bep_attribute_category               = p_rec.bep_attribute_category
    ,bep_attribute1                       = p_rec.bep_attribute1
    ,bep_attribute2                       = p_rec.bep_attribute2
    ,bep_attribute3                       = p_rec.bep_attribute3
    ,bep_attribute4                       = p_rec.bep_attribute4
    ,bep_attribute5                       = p_rec.bep_attribute5
    ,bep_attribute6                       = p_rec.bep_attribute6
    ,bep_attribute7                       = p_rec.bep_attribute7
    ,bep_attribute8                       = p_rec.bep_attribute8
    ,bep_attribute9                       = p_rec.bep_attribute9
    ,bep_attribute10                      = p_rec.bep_attribute10
    ,bep_attribute11                      = p_rec.bep_attribute11
    ,bep_attribute12                      = p_rec.bep_attribute12
    ,bep_attribute13                      = p_rec.bep_attribute13
    ,bep_attribute14                      = p_rec.bep_attribute14
    ,bep_attribute15                      = p_rec.bep_attribute15
    ,bep_attribute16                      = p_rec.bep_attribute16
    ,bep_attribute17                      = p_rec.bep_attribute17
    ,bep_attribute18                      = p_rec.bep_attribute18
    ,bep_attribute19                      = p_rec.bep_attribute19
    ,bep_attribute20                      = p_rec.bep_attribute20
...
Begin
  ...
  --
  If (p_rec.elig_obj_id = hr_api.g_number) then
    p_rec.elig_obj_id :=
    ben_bep_shd.g_old_rec.elig_obj_id;
  End If;
  If (p_rec.elig_prfl_id = hr_api.g_number) then
    p_rec.elig_prfl_id :=
    ben_bep_shd.g_old_rec.elig_prfl_id;
  End If;
  ...
  If (p_rec.business_group_id = hr_api.g_number) then
    ...
    ben_bep_shd.g_old_rec.business_group_id;
  End If;
  If (p_rec.bep_attribute_category = hr_api.g_varchar2) then
    p_rec.bep_attribute_category :=
    ben_bep_shd.g_old_rec.bep_attribute_category;
  End If;
  If (p_rec.bep_attribute1 = hr_api.g_varchar2) then
    p_rec.bep_attribute1 :=
    ben_bep_shd.g_old_rec.bep_attribute1;
  End If;
  If (p_rec.bep_attribute2 = hr_api.g_varchar2) then
    p_rec.bep_attribute2 :=
    ben_bep_shd.g_old_rec.bep_attribute2;
  End If;
  If (p_rec.bep_attribute3 = hr_api.g_varchar2) then
    p_rec.bep_attribute3 :=
    ben_bep_shd.g_old_rec.bep_attribute3;
  End If;
  If (p_rec.bep_attribute4 = hr_api.g_varchar2) then
    p_rec.bep_attribute4 :=
    ben_bep_shd.g_old_rec.bep_attribute4;
  End If;
  If (p_rec.bep_attribute5 = hr_api.g_varchar2) then
    p_rec.bep_attribute5 :=
    ben_bep_shd.g_old_rec.bep_attribute5;
  End If;
  If (p_rec.bep_attribute6 = hr_api.g_varchar2) then
    p_rec.bep_attribute6 :=
    ben_bep_shd.g_old_rec.bep_attribute6;
  End If;
  If (p_rec.bep_attribute7 = hr_api.g_varchar2) then
    p_rec.bep_attribute7 :=
    ben_bep_shd.g_old_rec.bep_attribute7;
  End If;
  If (p_rec.bep_attribute8 = hr_api.g_varchar2) then
    p_rec.bep_attribute8 :=
    ben_bep_shd.g_old_rec.bep_attribute8;
  End If;
  If (p_rec.bep_attribute9 = hr_api.g_varchar2) then
    p_rec.bep_attribute9 :=
    ben_bep_shd.g_old_rec.bep_attribute9;
  End If;
  If (p_rec.bep_attribute10 = hr_api.g_varchar2) then
    p_rec.bep_attribute10 :=
    ben_bep_shd.g_old_rec.bep_attribute10;
  End If;
  If (p_rec.bep_attribute11 = hr_api.g_varchar2) then
    p_rec.bep_attribute11 :=
    ben_bep_shd.g_old_rec.bep_attribute11;
  End If;
  If (p_rec.bep_attribute12 = hr_api.g_varchar2) then
    p_rec.bep_attribute12 :=
    ben_bep_shd.g_old_rec.bep_attribute12;
  End If;
  If (p_rec.bep_attribute13 = hr_api.g_varchar2) then
    p_rec.bep_attribute13 :=
    ben_bep_shd.g_old_rec.bep_attribute13;
  End If;
  If (p_rec.bep_attribute14 = hr_api.g_varchar2) then
    p_rec.bep_attribute14 :=
    ben_bep_shd.g_old_rec.bep_attribute14;
  End If;
  If (p_rec.bep_attribute15 = hr_api.g_varchar2) then
    p_rec.bep_attribute15 :=
    ben_bep_shd.g_old_rec.bep_attribute15;
  End If;
  If (p_rec.bep_attribute16 = hr_api.g_varchar2) then
    p_rec.bep_attribute16 :=
    ben_bep_shd.g_old_rec.bep_attribute16;
  End If;
  If (p_rec.bep_attribute17 = hr_api.g_varchar2) then
    p_rec.bep_attribute17 :=
    ben_bep_shd.g_old_rec.bep_attribute17;
  End If;
  If (p_rec.bep_attribute18 = hr_api.g_varchar2) then
    p_rec.bep_attribute18 :=
    ben_bep_shd.g_old_rec.bep_attribute18;
  End If;
  If (p_rec.bep_attribute19 = hr_api.g_varchar2) then
    p_rec.bep_attribute19 :=
    ben_bep_shd.g_old_rec.bep_attribute19;
  End If;
  If (p_rec.bep_attribute20 = hr_api.g_varchar2) then
    p_rec.bep_attribute20 :=
    ben_bep_shd.g_old_rec.bep_attribute20;
  End If;
  --
...
Begin
  ...
  --
  ben_bep_upd.convert_defs(p_rec);
  --
  ben_bep_bus.update_validate
    (p_rec                              => p_rec
    ,p_effective_date                   => p_effective_date
    ,p_datetrack_mode                   => p_datetrack_mode
    ,p_validation_start_date            => l_validation_start_date
