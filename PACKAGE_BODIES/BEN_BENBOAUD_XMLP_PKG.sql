--------------------------------------------------------
--  DDL for Package Body BEN_BENBOAUD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_BENBOAUD_XMLP_PKG" AS
/* $Header: BENBOAUDB.pls 120.1 2007/12/10 08:24:12 vjaganat noship $ */
...
function CF_STANDARD_HEADERFormula return Number is
  ...
  l_comp_object_selection_rule ff_formulas_f.formula_name%type ;   l_person_selection_rule      ff_formulas_f.formula_name%type ;   l_life_event_reason          ben_ler_f.name%type ;
