--------------------------------------------------------
--  DDL for Package Body PER_ESTAB_ATTENDANCES_BE1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_ESTAB_ATTENDANCES_BE1" as 
...
p_address                      varchar2) is
  ...
  --
  l_proc varchar2(72):='  per_estab_attendances_be1.create_attended_estab_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.api.estab_attendances.create_attended_estab';
