--------------------------------------------------------
--  DDL for Package Body PQH_PQHWSPBD_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_PQHWSPBD_XMLP_PKG" AS
/* $Header: PQHWSPBDB.pls 120.2 2007/12/21 19:32:17 vjaganat noship $ */
  FUNCTION BEFOREREPORT RETURN BOOLEAN IS
  l_dummy boolean;
  BEGIN
    DECLARE
      CURSOR CSR_POSITION_NAME IS
        SELECT
          NAME
        FROM
          PER_POSITIONS
    ...
    BEGIN
      ...
      FETCH CSR_ORG_NAME
       INTO
         CP_ORGANIZATION_NAME;
      CLOSE CSR_ORG_NAME;
      OPEN CSR_POSITION_NAME;
      FETCH CSR_POSITION_NAME
       INTO
         CP_POSITION_NAME;
      CLOSE CSR_POSITION_NAME;
      OPEN CSR_POSN_TYPE;
      FETCH CSR_POSN_TYPE
       INTO
         CP_POSITION_TYPE;
  ...
  FUNCTION CF_FORMAT_MASK(BUDGET_UNIT_ID IN NUMBER) RETURN CHAR IS
    CURSOR CSR_UOM IS
      SELECT
        SYSTEM_TYPE_CD
      FROM
  ...
  END CP_ORGANIZATION_NAME_P;

  FUNCTION CP_POSITION_NAME_P RETURN VARCHAR2 IS
  BEGIN
    RETURN CP_POSITION_NAME;
  END CP_POSITION_NAME_P;
