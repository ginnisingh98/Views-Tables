--------------------------------------------------------
--  DDL for Package Body HR_NO_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_NO_EMPLOYEE_API" as
/* $Header: peempnoi.pkb 120.0 2005/05/31 08:04 appldev noship $ */
--
  g_package  varchar2(33) := 'hr_no_employee_api.';
-- -----------------------------------------------------------------------------
-- |-----------------------< create_no_employee >------------------------------|
-- -----------------------------------------------------------------------------
...
is
    ...
    l_proc                 VARCHAR2(72) := g_package||'create_no_employee';
