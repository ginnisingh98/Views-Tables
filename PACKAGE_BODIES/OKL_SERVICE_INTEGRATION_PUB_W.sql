--------------------------------------------------------
--  DDL for Package Body OKL_SERVICE_INTEGRATION_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SERVICE_INTEGRATION_PUB_W" as
  /* $Header: OKLUSRIB.pls 115.1 2003/10/20 18:56:53 dedey noship $ */
  ...
  as
    ddp_clev_rec okl_service_integration_pub.clev_rec_type;
    ddp_klev_rec okl_service_integration_pub.klev_rec_type;
  ...
  begin
    ...
    okl_service_integration_pub.delete_service_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddx_link_line_tbl okl_service_integration_pub.link_line_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_service_integration_pub.get_service_link_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_service_integration_pub.update_service_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_clev_tbl okl_service_integration_pub.clev_tbl_type;
    ddp_klev_tbl okl_service_integration_pub.klev_tbl_type;
    ddp_cimv_tbl okl_service_integration_pub.cimv_tbl_type;
    ddp_cov_tbl okl_service_integration_pub.srv_cov_tbl_type;
    ddx_clev_tbl okl_service_integration_pub.clev_tbl_type;
    ddx_klev_tbl okl_service_integration_pub.klev_tbl_type;
    ddx_cimv_tbl okl_service_integration_pub.cimv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_service_integration_pub.create_cov_asset_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_service_integration_pub.update_cov_asset_line(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_service_integration_pub_w;
