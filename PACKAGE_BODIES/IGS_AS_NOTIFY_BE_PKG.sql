--------------------------------------------------------
--  DDL for Package Body IGS_AS_NOTIFY_BE_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_AS_NOTIFY_BE_PKG" AS
/* $Header: IGSDI65B.pls 115.1 2002/11/28 23:27:17 nsidana noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_as_notify_be%ROWTYPE;
  new_references igs_as_notify_be%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    new_references.internal_name                     := x_internal_name;
  ...
  */
    CURSOR cur_rowid IS
      ...
      AND      internal_name =  x_internal_name
  ...
  */
  ...
  BEGIN
    ...
    IF (
        ...
        AND (tlinfo.internal_name = x_internal_name)
       ) THEN
      NULL;
    ELSE
  ...
  */
  ...
  BEGIN
    ...
    UPDATE igs_as_notify_be
      SET
        uoo_id                            = new_references.uoo_id,
        internal_name                     = new_references.internal_name,
