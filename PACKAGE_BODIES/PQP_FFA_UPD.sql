--------------------------------------------------------
--  DDL for Package Body PQP_FFA_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_FFA_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqp_ffa_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the pqp_flxdu_func_attributes Row
  --
...
Begin
  ...
  --
  If (p_rec.flxdu_func_name = hr_api.g_varchar2) then
    p_rec.flxdu_func_name :=
    pqp_ffa_shd.g_old_rec.flxdu_func_name;
  End If;
  If (p_rec.flxdu_func_source_type = hr_api.g_varchar2) then
    p_rec.flxdu_func_source_type :=
    pqp_ffa_shd.g_old_rec.flxdu_func_source_type;
  End If;
  If (p_rec.flxdu_func_integrator_code = hr_api.g_varchar2) then
    p_rec.flxdu_func_integrator_code :=
    pqp_ffa_shd.g_old_rec.flxdu_func_integrator_code;
  End If;
  If (p_rec.flxdu_func_xml_data = hr_api.g_varchar2) then
    p_rec.flxdu_func_xml_data :=
    pqp_ffa_shd.g_old_rec.flxdu_func_xml_data;
  End If;
...
Procedure upd
  ...
  ,p_flxdu_func_name              in     varchar2  default hr_api.g_varchar2
  ,p_flxdu_func_source_type       in     varchar2  default hr_api.g_varchar2
  ,p_flxdu_func_integrator_code   in     varchar2  default hr_api.g_varchar2
  ,p_flxdu_func_xml_data          in     varchar2  default hr_api.g_varchar2
