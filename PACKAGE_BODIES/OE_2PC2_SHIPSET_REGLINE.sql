--------------------------------------------------------
--  DDL for Package Body OE_2PC2_SHIPSET_REGLINE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC2_SHIPSET_REGLINE" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 IS 
   ...
   WHERE a.LINE_CATEGORY_CODE = 'ORDER'
   AND   (  a.LINE_ID ) IN  
                 ( SELECT  b.LINE_ID
