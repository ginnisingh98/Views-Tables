--------------------------------------------------------
--  DDL for Package Body OKL_AM_RESTRUCTURE_QUOTE_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AM_RESTRUCTURE_QUOTE_PVT_W" as
  /* $Header: OKLERTQB.pls 120.2 2007/11/02 21:08:09 rmunjulu ship $ */
  ...
  as
    ddp_quot_rec okl_am_restructure_quote_pvt.quot_rec_type;
    ddx_quot_rec okl_am_restructure_quote_pvt.quot_rec_type;
  ...
  begin
    ...
    okl_am_restructure_quote_pvt.create_restructure_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_quot_tbl okl_am_restructure_quote_pvt.quot_tbl_type;
    ddx_quot_tbl okl_am_restructure_quote_pvt.quot_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_am_restructure_quote_pvt.update_restructure_quote(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
...
end okl_am_restructure_quote_pvt_w;
