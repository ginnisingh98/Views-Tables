--------------------------------------------------------
--  DDL for Package Body PSB_ACCT_POS_SET_LINE_O_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSB_ACCT_POS_SET_LINE_O_PVT" AS
/* $Header: PSBWSLOB.pls 120.2 2005/07/13 11:37:53 shtripat ship $ */

  G_PKG_NAME CONSTANT VARCHAR2(30):= 'PSB_Acct_Pos_Set_Line_O_PVT';
...
BEGIN
  ...
  PSB_Acct_Position_Set_Line_Pvt.Update_Row
  (
