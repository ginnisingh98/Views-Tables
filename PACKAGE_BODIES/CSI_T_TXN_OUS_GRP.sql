--------------------------------------------------------
--  DDL for Package Body CSI_T_TXN_OUS_GRP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CSI_T_TXN_OUS_GRP" as
/*$Header: csigtoub.pls 115.12 2004/01/08 23:54:07 rmamidip ship $*/

  g_pkg_name    CONSTANT VARCHAR2(30) := 'csi_t_txn_ous_grp';
  g_file_name   CONSTANT VARCHAR2(12) := 'csigtoub.pls';
  ...
  BEGIN
    ...
    csi_t_gen_utility_pvt.add('API Being Executed     : Create Txn Org Assignments');
    ...
    ****/
    ...
    csi_t_gen_utility_pvt.add('API Successfully Executed         : Create Txn Org Assignments');
  ...
  */
  ...
  BEGIN
    ...
    csi_t_gen_utility_pvt.add('API Being Executed     : Update Txn Org Assignments');
    csi_t_gen_utility_pvt.add('Transaction Start Time :'||to_char(sysdate, 'MM/DD/YY HH24:MI:SS'));
    ...
    ****/
    ...
    csi_t_txn_ous_pvt.update_txn_org_assgn_dtls(
      p_api_version          => p_api_version,
      p_commit               => p_commit,
      p_init_msg_list        => p_init_msg_list,
      p_validation_level     => p_validation_level,
    ...
    ****/
    ...
    csi_t_gen_utility_pvt.add('API Successfully Executed         : Update Txn Org Assignments');
    csi_t_gen_utility_pvt.add('Transaction End Time :'||to_char(sysdate, 'MM/DD/YY HH24:MI:SS'));
  ...
  BEGIN
    ...
    csi_t_gen_utility_pvt.add('API Being Executed     : Delete Txn Org Assignments');
    csi_t_gen_utility_pvt.add('Transaction Start Time :'||to_char(sysdate, 'MM/DD/YY HH24:MI:SS'));
    ...
    ****/
    ...
    csi_t_txn_ous_pvt.delete_txn_org_assgn_dtls(
      ...
      p_init_msg_list         => p_init_msg_list,
      p_validation_level      => p_validation_level,
      p_txn_org_assgn_ids_tbl => p_txn_org_assgn_ids_tbl,
      x_return_status         => l_return_status,
      x_msg_count             => l_msg_count,
      x_msg_data              => l_msg_data);
    ...
    ****/
    ...
    csi_t_gen_utility_pvt.add('API Successfully Executed         : Delete Txn Org Assignments');
    csi_t_gen_utility_pvt.add('Transaction End Time :'||to_char(sysdate, 'MM/DD/YY HH24:MI:SS'));
