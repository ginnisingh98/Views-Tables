--------------------------------------------------------
--  DDL for Package Body OKL_RFC_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_RFC_PVT_W" as
  /* $Header: OKLIRFCB.pls 115.4 2002/12/19 23:27:29 gkadarka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_rfc_pvt.rfc_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).cos_code := a1(indx);
          t(ddindx).art_id := rosetta_g_miss_num_map(a2(indx));
          ...
          t(ddindx).currency_code := a31(indx);
          t(ddindx).currency_conversion_code := a32(indx);
  ...
  procedure rosetta_table_copy_out_p2(t okl_rfc_pvt.rfc_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a35 := JTF_DATE_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := t(ddindx).cos_code;
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).art_id);
          ...
          a31(indx) := t(ddindx).currency_code;
          a32(indx) := t(ddindx).currency_conversion_code;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_rfc_pvt.oklremarktngcoststltbltype, a0 JTF_NUMBER_TABLE
    , a1 JTF_VARCHAR2_TABLE_100
  ...
  procedure rosetta_table_copy_out_p5(t okl_rfc_pvt.oklremarktngcoststltbltype, a0 out nocopy JTF_NUMBER_TABLE
    , a1 out nocopy JTF_VARCHAR2_TABLE_100
  ...
  procedure rosetta_table_copy_in_p8(t out nocopy okl_rfc_pvt.rfcv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_VARCHAR2_TABLE_100
    , a3 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).currency_conversion_code := a34(indx);
          t(ddindx).currency_conversion_type := a35(indx);
          t(ddindx).currency_conversion_rate := rosetta_g_miss_num_map(a36(indx));
          t(ddindx).currency_conversion_date := rosetta_g_miss_date_in_map(a37(indx));
          ddindx := ddindx+1;
          if a0.last =indx
            then exit;
          end if;
  ...
  procedure rosetta_table_copy_out_p8(t okl_rfc_pvt.rfcv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a37 := JTF_DATE_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a34(indx) := t(ddindx).currency_conversion_code;
          a35(indx) := t(ddindx).currency_conversion_type;
          a36(indx) := rosetta_g_miss_num_map(t(ddindx).currency_conversion_rate);
          a37(indx) := t(ddindx).currency_conversion_date;
          indx := indx+1;
          if t.last =ddindx
            then exit;
          end if;
  ...
  as
    ddp_rfcv_rec okl_rfc_pvt.rfcv_rec_type;
    ddx_rfcv_rec okl_rfc_pvt.rfcv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ddp_rfcv_rec.id := rosetta_g_miss_num_map(p5_a0);
    ddp_rfcv_rec.object_version_number := rosetta_g_miss_num_map(p5_a1);
    ddp_rfcv_rec.sfwt_flag := p5_a2;
    ddp_rfcv_rec.art_id := rosetta_g_miss_num_map(p5_a3);
    ddp_rfcv_rec.cos_code := p5_a4;
    ddp_rfcv_rec.amount := rosetta_g_miss_num_map(p5_a5);
    ddp_rfcv_rec.comments := p5_a6;
    ddp_rfcv_rec.attribute_category := p5_a7;
    ddp_rfcv_rec.attribute1 := p5_a8;
    ddp_rfcv_rec.attribute2 := p5_a9;
    ddp_rfcv_rec.attribute3 := p5_a10;
    ddp_rfcv_rec.attribute4 := p5_a11;
    ddp_rfcv_rec.attribute5 := p5_a12;
    ddp_rfcv_rec.attribute6 := p5_a13;
    ddp_rfcv_rec.attribute7 := p5_a14;
    ddp_rfcv_rec.attribute8 := p5_a15;
    ddp_rfcv_rec.attribute9 := p5_a16;
    ddp_rfcv_rec.attribute10 := p5_a17;
    ddp_rfcv_rec.attribute11 := p5_a18;
    ddp_rfcv_rec.attribute12 := p5_a19;
    ddp_rfcv_rec.attribute13 := p5_a20;
    ddp_rfcv_rec.attribute14 := p5_a21;
    ddp_rfcv_rec.attribute15 := p5_a22;
    ddp_rfcv_rec.org_id := rosetta_g_miss_num_map(p5_a23);
    ddp_rfcv_rec.request_id := rosetta_g_miss_num_map(p5_a24);
    ddp_rfcv_rec.program_application_id := rosetta_g_miss_num_map(p5_a25);
    ddp_rfcv_rec.program_id := rosetta_g_miss_num_map(p5_a26);
    ddp_rfcv_rec.program_update_date := rosetta_g_miss_date_in_map(p5_a27);
    ddp_rfcv_rec.created_by := rosetta_g_miss_num_map(p5_a28);
    ddp_rfcv_rec.creation_date := rosetta_g_miss_date_in_map(p5_a29);
    ddp_rfcv_rec.last_updated_by := rosetta_g_miss_num_map(p5_a30);
    ddp_rfcv_rec.last_update_date := rosetta_g_miss_date_in_map(p5_a31);
    ddp_rfcv_rec.last_update_login := rosetta_g_miss_num_map(p5_a32);
    ddp_rfcv_rec.currency_code := p5_a33;
    ddp_rfcv_rec.currency_conversion_code := p5_a34;
    ddp_rfcv_rec.currency_conversion_type := p5_a35;
    ddp_rfcv_rec.currency_conversion_rate := rosetta_g_miss_num_map(p5_a36);
    ddp_rfcv_rec.currency_conversion_date := rosetta_g_miss_date_in_map(p5_a37);


    -- here's the delegated call to the old PL/SQL routine
    okl_rfc_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a0 := rosetta_g_miss_num_map(ddx_rfcv_rec.id);
    p6_a1 := rosetta_g_miss_num_map(ddx_rfcv_rec.object_version_number);
    p6_a2 := ddx_rfcv_rec.sfwt_flag;
    p6_a3 := rosetta_g_miss_num_map(ddx_rfcv_rec.art_id);
    p6_a4 := ddx_rfcv_rec.cos_code;
    p6_a5 := rosetta_g_miss_num_map(ddx_rfcv_rec.amount);
    p6_a6 := ddx_rfcv_rec.comments;
    p6_a7 := ddx_rfcv_rec.attribute_category;
    p6_a8 := ddx_rfcv_rec.attribute1;
    p6_a9 := ddx_rfcv_rec.attribute2;
    p6_a10 := ddx_rfcv_rec.attribute3;
    p6_a11 := ddx_rfcv_rec.attribute4;
    p6_a12 := ddx_rfcv_rec.attribute5;
    p6_a13 := ddx_rfcv_rec.attribute6;
    p6_a14 := ddx_rfcv_rec.attribute7;
    p6_a15 := ddx_rfcv_rec.attribute8;
    p6_a16 := ddx_rfcv_rec.attribute9;
    p6_a17 := ddx_rfcv_rec.attribute10;
    p6_a18 := ddx_rfcv_rec.attribute11;
    p6_a19 := ddx_rfcv_rec.attribute12;
    p6_a20 := ddx_rfcv_rec.attribute13;
    p6_a21 := ddx_rfcv_rec.attribute14;
    p6_a22 := ddx_rfcv_rec.attribute15;
    p6_a23 := rosetta_g_miss_num_map(ddx_rfcv_rec.org_id);
    p6_a24 := rosetta_g_miss_num_map(ddx_rfcv_rec.request_id);
    p6_a25 := rosetta_g_miss_num_map(ddx_rfcv_rec.program_application_id);
    p6_a26 := rosetta_g_miss_num_map(ddx_rfcv_rec.program_id);
    p6_a27 := ddx_rfcv_rec.program_update_date;
    p6_a28 := rosetta_g_miss_num_map(ddx_rfcv_rec.created_by);
    p6_a29 := ddx_rfcv_rec.creation_date;
    p6_a30 := rosetta_g_miss_num_map(ddx_rfcv_rec.last_updated_by);
    p6_a31 := ddx_rfcv_rec.last_update_date;
    p6_a32 := rosetta_g_miss_num_map(ddx_rfcv_rec.last_update_login);
    p6_a33 := ddx_rfcv_rec.currency_code;
    p6_a34 := ddx_rfcv_rec.currency_conversion_code;
    p6_a35 := ddx_rfcv_rec.currency_conversion_type;
    p6_a36 := rosetta_g_miss_num_map(ddx_rfcv_rec.currency_conversion_rate);
    p6_a37 := ddx_rfcv_rec.currency_conversion_date;
  end;
  ...
  as
    ddp_rfcv_tbl okl_rfc_pvt.rfcv_tbl_type;
    ddx_rfcv_tbl okl_rfc_pvt.rfcv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_rfc_pvt_w.rosetta_table_copy_in_p8(ddp_rfcv_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_rfc_pvt_w.rosetta_table_copy_out_p8(ddx_rfcv_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_rfc_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_rfc_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_rfc_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_rfc_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
