--------------------------------------------------------
--  DDL for Package Body BEN_CMBN_PTIP_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_CMBN_PTIP_API" as
/* $Header: becbpapi.pkb 120.0 2005/05/28 00:55:05 appldev noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := '  ben_CMBN_PTIP_api.';
--
-- ----------------------------------------------------------------------------
-- |------------------------< create_CMBN_PTIP >----------------------|
-- ----------------------------------------------------------------------------
...
procedure create_CMBN_PTIP
  ...
  --
  l_cmbn_ptip_id ben_cmbn_ptip_f.cmbn_ptip_id%TYPE;
  l_effective_start_date ben_cmbn_ptip_f.effective_start_date%TYPE;
  l_effective_end_date ben_cmbn_ptip_f.effective_end_date%TYPE;
  l_proc varchar2(72) := g_package||'create_CMBN_PTIP';
  l_object_version_number ben_cmbn_ptip_f.object_version_number%TYPE;
  --
begin
  --
  ...
  begin
    --
    -- Start of API User Hook for the before hook of create_CMBN_PTIP
    --
    ben_CMBN_PTIP_bk1.create_CMBN_PTIP_b
      (
       p_name                           =>  p_name
      ,p_business_group_id              =>  p_business_group_id
      ,p_cbp_attribute_category         =>  p_cbp_attribute_category
      ,p_cbp_attribute1                 =>  p_cbp_attribute1
      ,p_cbp_attribute2                 =>  p_cbp_attribute2
      ,p_cbp_attribute3                 =>  p_cbp_attribute3
      ,p_cbp_attribute4                 =>  p_cbp_attribute4
      ,p_cbp_attribute5                 =>  p_cbp_attribute5
      ,p_cbp_attribute6                 =>  p_cbp_attribute6
      ,p_cbp_attribute7                 =>  p_cbp_attribute7
      ,p_cbp_attribute8                 =>  p_cbp_attribute8
      ,p_cbp_attribute9                 =>  p_cbp_attribute9
      ,p_cbp_attribute10                =>  p_cbp_attribute10
      ,p_cbp_attribute11                =>  p_cbp_attribute11
      ,p_cbp_attribute12                =>  p_cbp_attribute12
      ,p_cbp_attribute13                =>  p_cbp_attribute13
      ,p_cbp_attribute14                =>  p_cbp_attribute14
      ,p_cbp_attribute15                =>  p_cbp_attribute15
      ,p_cbp_attribute16                =>  p_cbp_attribute16
      ,p_cbp_attribute17                =>  p_cbp_attribute17
      ,p_cbp_attribute18                =>  p_cbp_attribute18
      ,p_cbp_attribute19                =>  p_cbp_attribute19
      ,p_cbp_attribute20                =>  p_cbp_attribute20
      ,p_cbp_attribute21                =>  p_cbp_attribute21
      ,p_cbp_attribute22                =>  p_cbp_attribute22
      ,p_cbp_attribute23                =>  p_cbp_attribute23
      ,p_cbp_attribute24                =>  p_cbp_attribute24
      ,p_cbp_attribute25                =>  p_cbp_attribute25
      ,p_cbp_attribute26                =>  p_cbp_attribute26
      ,p_cbp_attribute27                =>  p_cbp_attribute27
      ,p_cbp_attribute28                =>  p_cbp_attribute28
      ,p_cbp_attribute29                =>  p_cbp_attribute29
      ,p_cbp_attribute30                =>  p_cbp_attribute30
      ,p_pgm_id                         =>  p_pgm_id
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (
         p_module_name => 'CREATE_CMBN_PTIP'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of create_CMBN_PTIP
    --
  end;
  --
  ben_cbp_ins.ins
  ...
  begin
    --
    -- Start of API User Hook for the after hook of create_CMBN_PTIP
    --
    ben_CMBN_PTIP_bk1.create_CMBN_PTIP_a
      (
       p_cmbn_ptip_id                   =>  l_cmbn_ptip_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of create_CMBN_PTIP
    --
  end;
  --
...
procedure update_CMBN_PTIP
  ...
  -- Declare cursors and local variables
  --
  l_proc varchar2(72) := g_package||'update_CMBN_PTIP';
  l_object_version_number ben_cmbn_ptip_f.object_version_number%TYPE;
  l_effective_start_date ben_cmbn_ptip_f.effective_start_date%TYPE;
  l_effective_end_date ben_cmbn_ptip_f.effective_end_date%TYPE;
  --
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of update_CMBN_PTIP
    --
    ben_CMBN_PTIP_bk2.update_CMBN_PTIP_b
      (
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'UPDATE_CMBN_PTIP'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of update_CMBN_PTIP
    --
  end;
  --
  ben_cbp_upd.upd
  ...
  begin
    --
    -- Start of API User Hook for the after hook of update_CMBN_PTIP
    --
    ben_CMBN_PTIP_bk2.update_CMBN_PTIP_a
      (
       p_cmbn_ptip_id                   =>  p_cmbn_ptip_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of update_CMBN_PTIP
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
...
begin
  ...
  begin
    --
    -- Start of API User Hook for the before hook of delete_CMBN_PTIP
    --
    ben_CMBN_PTIP_bk3.delete_CMBN_PTIP_b
      (
       p_cmbn_ptip_id                   =>  p_cmbn_ptip_id
      ,p_object_version_number          =>  p_object_version_number
    ,p_effective_date                      => trunc(p_effective_date)
  ...
  exception
    when hr_api.cannot_find_prog_unit then
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'DELETE_CMBN_PTIP'
        ,p_hook_type   => 'BP'
        );
    --
    -- End of API User Hook for the before hook of delete_CMBN_PTIP
    --
  end;
  --
  ben_cbp_del.del
  ...
  begin
    --
    -- Start of API User Hook for the after hook of delete_CMBN_PTIP
    --
    ben_CMBN_PTIP_bk3.delete_CMBN_PTIP_a
      (
       p_cmbn_ptip_id                   =>  p_cmbn_ptip_id
      ,p_effective_start_date           =>  l_effective_start_date
      ,p_effective_end_date             =>  l_effective_end_date
  ...
  exception
    ...
    --
    -- End of API User Hook for the after hook of delete_CMBN_PTIP
    --
  end;
  --
  hr_utility.set_location(l_proc, 60);
