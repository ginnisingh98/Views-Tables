--------------------------------------------------------
--  DDL for Package Body GHR_CAD_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_CAD_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ghr_cad_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< delete_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Delete the ghr_compl_adrs row.
  --
  delete from ghr_compl_adrs
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in ghr_cad_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in ghr_cad_shd.g_rec_type) is
--
...
Begin
  ...
  --
  ghr_cad_bus.delete_validate(p_rec);
  --
  -- Call the supporting pre-delete operation
  --
  ghr_cad_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  ghr_cad_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  ghr_cad_del.post_delete(p_rec);
  --
End del;
--
-- ----------------------------------------------------------------------------
