--------------------------------------------------------
--  DDL for Package Body BEN_ABP_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ABP_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_abp_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_APLCN_TO_BNFT_POOL_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_APLCN_TO_BNFT_POOL_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  If (p_effective_date is null or
      p_aplcn_to_bnft_pool_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_aplcn_to_bnft_pool_id = g_old_rec.aplcn_to_bnft_pool_id and
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_aplcn_to_bnft_pool_f',
	 p_base_key_column	   => 'aplcn_to_bnft_pool_id',
	 p_base_key_value 	   => p_aplcn_to_bnft_pool_id,
	 p_parent_table_name1      => 'ben_acty_base_rt_f',
	 p_parent_key_column1      => 'acty_base_rt_id',
...
Begin
  ...
  l_rec.abp_attribute_category           := p_abp_attribute_category;
  l_rec.abp_attribute1                   := p_abp_attribute1;
  l_rec.abp_attribute2                   := p_abp_attribute2;
  l_rec.abp_attribute3                   := p_abp_attribute3;
  l_rec.abp_attribute4                   := p_abp_attribute4;
  l_rec.abp_attribute5                   := p_abp_attribute5;
  l_rec.abp_attribute6                   := p_abp_attribute6;
  l_rec.abp_attribute7                   := p_abp_attribute7;
  l_rec.abp_attribute8                   := p_abp_attribute8;
  l_rec.abp_attribute9                   := p_abp_attribute9;
  l_rec.abp_attribute10                  := p_abp_attribute10;
  l_rec.abp_attribute11                  := p_abp_attribute11;
  l_rec.abp_attribute12                  := p_abp_attribute12;
  l_rec.abp_attribute13                  := p_abp_attribute13;
  l_rec.abp_attribute14                  := p_abp_attribute14;
  l_rec.abp_attribute15                  := p_abp_attribute15;
  l_rec.abp_attribute16                  := p_abp_attribute16;
  l_rec.abp_attribute17                  := p_abp_attribute17;
  l_rec.abp_attribute18                  := p_abp_attribute18;
  l_rec.abp_attribute19                  := p_abp_attribute19;
  l_rec.abp_attribute20                  := p_abp_attribute20;
  l_rec.abp_attribute21                  := p_abp_attribute21;
  l_rec.abp_attribute22                  := p_abp_attribute22;
  l_rec.abp_attribute23                  := p_abp_attribute23;
  l_rec.abp_attribute24                  := p_abp_attribute24;
  l_rec.abp_attribute25                  := p_abp_attribute25;
  l_rec.abp_attribute26                  := p_abp_attribute26;
  l_rec.abp_attribute27                  := p_abp_attribute27;
  l_rec.abp_attribute28                  := p_abp_attribute28;
  l_rec.abp_attribute29                  := p_abp_attribute29;
  l_rec.abp_attribute30                  := p_abp_attribute30;
