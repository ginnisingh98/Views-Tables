--------------------------------------------------------
--  DDL for Package Body BEN_ESH_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_ESH_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_esh_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (p_constraint_name = 'BEN_ELIG_SCH_HRS_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'BEN_ELIG_SCH_HRS_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
--
  ...
  Cursor C_Sel1 is
    ...
    where	elig_schedd_hrs_prte_id = p_elig_schedd_hrs_prte_id
...
Begin
  ...
  If (p_effective_date is null or
      p_elig_schedd_hrs_prte_id is null or
    ...
    l_fct_ret := false;
  Else
    If (p_elig_schedd_hrs_prte_id = g_old_rec.elig_schedd_hrs_prte_id and
...
--
  ...
  Cursor C_Sel1 Is
    ...
    where   t.elig_schedd_hrs_prte_id = p_base_key_value
    and     p_effective_date
...
Begin
  ...
  --
  update  ben_elig_schedd_hrs_prte_f t
...
Begin
  ...
  If (p_datetrack_mode <> 'INSERT') then
	...
	(p_effective_date	   => p_effective_date,
	 ...
	 p_base_table_name	   => 'ben_elig_schedd_hrs_prte_f',
	 p_base_key_column	   => 'elig_schedd_hrs_prte_id',
	 p_base_key_value 	   => p_elig_schedd_hrs_prte_id,
	 p_parent_table_name1      => 'ben_eligy_prfl_f',
	 p_parent_key_column1      => 'eligy_prfl_id',
...
Begin
  ...
  l_rec.esh_attribute_category           := p_esh_attribute_category;
  l_rec.esh_attribute1                   := p_esh_attribute1;
  l_rec.esh_attribute2                   := p_esh_attribute2;
  l_rec.esh_attribute3                   := p_esh_attribute3;
  l_rec.esh_attribute4                   := p_esh_attribute4;
  l_rec.esh_attribute5                   := p_esh_attribute5;
  l_rec.esh_attribute6                   := p_esh_attribute6;
  l_rec.esh_attribute7                   := p_esh_attribute7;
  l_rec.esh_attribute8                   := p_esh_attribute8;
  l_rec.esh_attribute9                   := p_esh_attribute9;
  l_rec.esh_attribute10                  := p_esh_attribute10;
  l_rec.esh_attribute11                  := p_esh_attribute11;
  l_rec.esh_attribute12                  := p_esh_attribute12;
  l_rec.esh_attribute13                  := p_esh_attribute13;
  l_rec.esh_attribute14                  := p_esh_attribute14;
  l_rec.esh_attribute15                  := p_esh_attribute15;
  l_rec.esh_attribute16                  := p_esh_attribute16;
  l_rec.esh_attribute17                  := p_esh_attribute17;
  l_rec.esh_attribute18                  := p_esh_attribute18;
  l_rec.esh_attribute19                  := p_esh_attribute19;
  l_rec.esh_attribute20                  := p_esh_attribute20;
  l_rec.esh_attribute21                  := p_esh_attribute21;
  l_rec.esh_attribute22                  := p_esh_attribute22;
  l_rec.esh_attribute23                  := p_esh_attribute23;
  l_rec.esh_attribute24                  := p_esh_attribute24;
  l_rec.esh_attribute25                  := p_esh_attribute25;
  l_rec.esh_attribute26                  := p_esh_attribute26;
  l_rec.esh_attribute27                  := p_esh_attribute27;
  l_rec.esh_attribute28                  := p_esh_attribute28;
  l_rec.esh_attribute29                  := p_esh_attribute29;
  l_rec.esh_attribute30                  := p_esh_attribute30;
