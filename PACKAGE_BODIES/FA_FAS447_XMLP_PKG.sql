--------------------------------------------------------
--  DDL for Package Body FA_FAS447_XMLP_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FA_FAS447_XMLP_PKG" AS
/* $Header: FAS447B.pls 120.0.12010000.1 2008/07/28 13:14:47 appldev ship $ */
...
EXCEPTION
  WHEN OTHERS THEN
    RP_Report_Name := ':Form 4797 - Ordinary Gains and Losses Report:';
