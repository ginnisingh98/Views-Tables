--------------------------------------------------------
--  DDL for Package Body GHR_PAH_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_PAH_RKU" as
...
begin
hr_utility.set_location('Entering: GHR_PAH_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: GHR_PAH_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end GHR_PAH_RKU;
