--------------------------------------------------------
--  DDL for Package Body CSI_COUNTER_VUHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CSI_COUNTER_VUHK" AS
/* $Header: csivhcib.pls 120.0 2005/06/10 15:03:18 rktow noship $ */
...
G_FILE_NAME CONSTANT VARCHAR2(12) := 'csivhcib.pls';
...
BEGIN
	x_return_status := FND_API.G_RET_STS_SUCCESS;
END create_ctr_associations_pre;
...
BEGIN
	x_return_status := FND_API.G_RET_STS_SUCCESS;
END create_ctr_associations_post;
...
BEGIN
	x_return_status := FND_API.G_RET_STS_SUCCESS;
END update_ctr_associations_pre;
...
BEGIN
	x_return_status := FND_API.G_RET_STS_SUCCESS;
END update_ctr_associations_post;
