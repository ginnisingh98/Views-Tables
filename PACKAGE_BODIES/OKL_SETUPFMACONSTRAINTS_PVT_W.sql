--------------------------------------------------------
--  DDL for Package Body OKL_SETUPFMACONSTRAINTS_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPFMACONSTRAINTS_PVT_W" as
  /* $Header: OKLESFCB.pls 120.1 2005/07/12 09:09:21 dkagrawa noship $ */
  ...
  as
    ddp_fodv_rec okl_setupfmaconstraints_pvt.fodv_rec_type;
    ddx_no_data_found boolean;
    ddx_fodv_rec okl_setupfmaconstraints_pvt.fodv_rec_type;
  ...
  begin
    ...
    okl_setupfmaconstraints_pvt.get_rec(ddp_fodv_rec,
      x_return_status,
      ddx_no_data_found,
      ddx_fodv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p3_a0 := rosetta_g_miss_num_map(ddx_fodv_rec.id);
    p3_a1 := rosetta_g_miss_num_map(ddx_fodv_rec.object_version_number);
    p3_a2 := rosetta_g_miss_num_map(ddx_fodv_rec.opd_id);
    p3_a3 := rosetta_g_miss_num_map(ddx_fodv_rec.fma_id);
    p3_a4 := ddx_fodv_rec.label;
    p3_a5 := rosetta_g_miss_num_map(ddx_fodv_rec.created_by);
    p3_a6 := ddx_fodv_rec.creation_date;
    p3_a7 := rosetta_g_miss_num_map(ddx_fodv_rec.last_updated_by);
    p3_a8 := ddx_fodv_rec.last_update_date;
    p3_a9 := rosetta_g_miss_num_map(ddx_fodv_rec.last_update_login);
  end;
  ...
  as
    ddp_fmav_rec okl_setupfmaconstraints_pvt.fmav_rec_type;
    ddp_fodv_rec okl_setupfmaconstraints_pvt.fodv_rec_type;
    ddx_fodv_rec okl_setupfmaconstraints_pvt.fodv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupfmaconstraints_pvt.insert_fmaconstraints(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupfmaconstraints_pvt.update_fmaconstraints(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_fodv_tbl okl_setupfmaconstraints_pvt.fodv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupfmaconstraints_pvt.delete_fmaconstraints(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_fmav_rec okl_setupfmaconstraints_pvt.fmav_rec_type;
    ddp_fodv_tbl okl_setupfmaconstraints_pvt.fodv_tbl_type;
    ddx_fodv_tbl okl_setupfmaconstraints_pvt.fodv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
...
end okl_setupfmaconstraints_pvt_w;
