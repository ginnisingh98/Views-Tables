--------------------------------------------------------
--  DDL for Package Body PQH_WST_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_WST_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  pqh_wst_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure update_dml(p_rec in out nocopy pqh_wst_shd.g_rec_type) is
--
...
Begin
  ...
  --
  --
  -- Update the pqh_worksheet_budget_sets Row
  --
  update pqh_worksheet_budget_sets
  set
  worksheet_budget_set_id           = p_rec.worksheet_budget_set_id,
  ...
  where worksheet_budget_set_id = p_rec.worksheet_budget_set_id;
  --
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_update(p_rec in pqh_wst_shd.g_rec_type) is
--
...
p_effective_date in date,p_rec in pqh_wst_shd.g_rec_type) is
--
...
--
 ...
 ,p_dflt_budget_set_id_o          =>pqh_wst_shd.g_old_rec.dflt_budget_set_id
 ,p_worksheet_period_id_o         =>pqh_wst_shd.g_old_rec.worksheet_period_id
 ,p_budget_unit1_percent_o        =>pqh_wst_shd.g_old_rec.budget_unit1_percent
 ,p_budget_unit2_percent_o        =>pqh_wst_shd.g_old_rec.budget_unit2_percent
 ,p_budget_unit3_percent_o        =>pqh_wst_shd.g_old_rec.budget_unit3_percent
 ,p_budget_unit1_value_o          =>pqh_wst_shd.g_old_rec.budget_unit1_value
 ,p_budget_unit2_value_o          =>pqh_wst_shd.g_old_rec.budget_unit2_value
 ,p_budget_unit3_value_o          =>pqh_wst_shd.g_old_rec.budget_unit3_value
 ,p_object_version_number_o       =>pqh_wst_shd.g_old_rec.object_version_number
 ,p_budget_unit1_value_type_cd_o  =>pqh_wst_shd.g_old_rec.budget_unit1_value_type_cd
 ,p_budget_unit2_value_type_cd_o  =>pqh_wst_shd.g_old_rec.budget_unit2_value_type_cd
 ,p_budget_unit3_value_type_cd_o  =>pqh_wst_shd.g_old_rec.budget_unit3_value_type_cd
 ,p_budget_unit1_available_o      =>pqh_wst_shd.g_old_rec.budget_unit1_available
 ,p_budget_unit2_available_o      =>pqh_wst_shd.g_old_rec.budget_unit2_available
 ,p_budget_unit3_available_o      =>pqh_wst_shd.g_old_rec.budget_unit3_available
      );
    --
  exception
    --
    when hr_api.cannot_find_prog_unit then
      ...
      hr_api.cannot_find_prog_unit_error
        (p_module_name => 'pqh_worksheet_budget_sets'
        ,p_hook_type   => 'AU');
      --
  end;
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure convert_defs(p_rec in out nocopy pqh_wst_shd.g_rec_type) is
--
...
Procedure upd
  ...
  p_rec        in out nocopy pqh_wst_shd.g_rec_type
  ) is
--
...
Begin
  ...
  --
  convert_defs(p_rec);
  pqh_wst_bus.update_validate(p_rec
  ,p_effective_date);
  --
