--------------------------------------------------------
--  DDL for Package Body OZF_CLAIMS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OZF_CLAIMS_PKG" as
/* $Header: ozftclab.pls 120.3.12010000.2 2009/07/23 17:15:37 kpatro ship $ */
-- ===============================================================
-- Start of Comments
-- Package name
--          OZF_CLAIMS_PKG
...
G_PKG_NAME CONSTANT VARCHAR2(30):= 'OZF_CLAIMS_PKG';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'ozftclab.pls';
...
PROCEDURE Insert_Row(
	  ...
	  p_offer_id                 NUMBER,  -- Added for Rule Based Settlement
          p_settled_from             VARCHAR2, -- Added for Rule Based Settlement
...
/*   IF (px_org_id IS NULL OR px_org_id = FND_API.G_MISS_NUM) THEN
   ...
   INSERT INTO OZF_CLAIMS_ALL(
	   ...
	   legal_entity_id,
           ...
           close_status_id,
           open_status_id,
	   pre_auth_deduction_number, -- Added for Rule Based Settlement
	   ...
	   p_pre_auth_ded_number,
	   p_pre_auth_ded_normalized,
	   p_offer_id,
           p_settled_from,
	   p_approval_in_prog
           );
...
PROCEDURE Update_Row(
	  ...
	  p_legal_entity_id            NUMBER,
          ...
          p_open_status_id             NUMBER,
	  p_pre_auth_ded_number        VARCHAR2, -- Added For Rule Based Settlement
	  p_pre_auth_ded_normalized    VARCHAR2,
	  p_offer_id                   NUMBER,
 ...
 BEGIN
    ...
    SET
	      ...
	      -- Added For Rule Based Settlement
	      pre_auth_deduction_number = p_pre_auth_ded_number,
	      pre_auth_deduction_normalized = p_pre_auth_ded_normalized,
	      offer_id = p_offer_id,
	      settled_from = p_settled_from,
	      approval_in_prog = p_approval_in_prog
