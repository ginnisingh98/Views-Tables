--------------------------------------------------------
--  DDL for Package Body OE_1025PC2_LINE_SHIPA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_1025PC2_LINE_SHIPA" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 l_wf_activity_name varchar2(30) :='SHIP_LINE';
 l_wf_activity_status_code varchar2(8) :='NOTIFIED';
   CURSOR C_VC  IS 
   SELECT count(*) 
   ...
   AND a.LINE_ID = OE_LINE_PAYMENT_SECURITY.g_record.LINE_ID
;
