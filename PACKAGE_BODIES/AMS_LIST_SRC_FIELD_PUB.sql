--------------------------------------------------------
--  DDL for Package Body AMS_LIST_SRC_FIELD_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."AMS_LIST_SRC_FIELD_PUB" as
/* $Header: amsplsfb.pls 115.5 2002/11/22 08:54:12 jieli ship $ */
-- ===============================================================
-- Start of Comments
-- Package name
...
G_PKG_NAME CONSTANT VARCHAR2(30):= 'AMS_List_Src_Field_PUB';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'amsplsfb.pls';
...
l_pvt_list_src_field_rec    AMS_List_Src_Field_PVT.list_src_field_rec_type;
 BEGIN
      -- Standard Start of API savepoint
      SAVEPOINT CREATE_List_Src_Field_PUB;
      ...
      -- API body
      --
    -- Calling Private package: Create_List_Src_Field
    -- Hint: Primary key needs to be returned
     ...
     p_list_src_field_rec  => l_pvt_list_src_field_rec,
...
EXCEPTION
 ...
 AMS_Utility_PVT.Error_Message(p_message_name => 'AMS_API_RESOURCE_LOCKED');
   ...
   WHEN FND_API.G_EXC_ERROR THEN
     ROLLBACK TO CREATE_List_Src_Field_PUB;
     x_return_status := FND_API.G_RET_STS_ERROR;
...
l_pvt_list_src_field_rec  AMS_List_Src_Field_PVT.list_src_field_rec_type;
 BEGIN
      -- Standard Start of API savepoint
      SAVEPOINT UPDATE_List_Src_Field_PUB;
      ...
      -- API body
      --
    AMS_List_Src_Field_PVT.Update_List_Src_Field(
    p_api_version_number         => 1.0,
    p_init_msg_list              => FND_API.G_FALSE,
    p_commit                     => p_commit,
    p_validation_level           => FND_API.G_VALID_LEVEL_FULL,
...
EXCEPTION
 ...
 AMS_Utility_PVT.Error_Message(p_message_name => 'AMS_API_RESOURCE_LOCKED');
   ...
   WHEN FND_API.G_EXC_ERROR THEN
     ROLLBACK TO UPDATE_List_Src_Field_PUB;
     x_return_status := FND_API.G_RET_STS_ERROR;
     -- Standard call to get message count and if count=1, get the message
     FND_MSG_PUB.Count_And_Get (
            p_encoded => FND_API.G_FALSE,
...
L_API_VERSION_NUMBER        CONSTANT NUMBER   := 1.0;
l_LIST_SOURCE_FIELD_ID  NUMBER := p_LIST_SOURCE_FIELD_ID;
l_object_version_number  NUMBER := p_object_version_number;
l_pvt_list_src_field_rec  AMS_List_Src_Field_PVT.list_src_field_rec_type;
 BEGIN
      -- Standard Start of API savepoint
      SAVEPOINT DELETE_List_Src_Field_PUB;
      ...
      -- API body
      --
    AMS_List_Src_Field_PVT.Delete_List_Src_Field(
    p_api_version_number         => 1.0,
    p_init_msg_list              => FND_API.G_FALSE,
    p_commit                     => p_commit,
    p_validation_level           => FND_API.G_VALID_LEVEL_FULL,
    ...
    x_msg_count                  => x_msg_count,
    x_msg_data                   => x_msg_data,
    p_list_source_field_id     => l_list_source_field_id,
...
EXCEPTION
 ...
 AMS_Utility_PVT.Error_Message(p_message_name => 'AMS_API_RESOURCE_LOCKED');
   ...
   WHEN FND_API.G_EXC_ERROR THEN
     ROLLBACK TO DELETE_List_Src_Field_PUB;
     x_return_status := FND_API.G_RET_STS_ERROR;
     -- Standard call to get message count and if count=1, get the message
     FND_MSG_PUB.Count_And_Get (
            p_encoded => FND_API.G_FALSE,
...
l_pvt_list_src_field_rec    AMS_List_Src_Field_PVT.list_src_field_rec_type;
 BEGIN
    ...
    -- Calling Private package: Create_List_Src_Field
    -- Hint: Primary key needs to be returned
     AMS_List_Src_Field_PVT.Lock_List_Src_Field(
     p_api_version_number         => 1.0,
     p_init_msg_list              => FND_API.G_FALSE,
     x_return_status              => x_return_status,
     x_msg_count                  => x_msg_count,
...
EXCEPTION
 ...
 AMS_Utility_PVT.Error_Message(p_message_name => 'AMS_API_RESOURCE_LOCKED');
   ...
   WHEN FND_API.G_EXC_ERROR THEN
     ROLLBACK TO LOCK_List_Src_Field_PUB;
     x_return_status := FND_API.G_RET_STS_ERROR;
     -- Standard call to get message count and if count=1, get the message
     FND_MSG_PUB.Count_And_Get (
            p_encoded => FND_API.G_FALSE,
