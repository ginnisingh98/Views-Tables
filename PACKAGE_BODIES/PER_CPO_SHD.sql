--------------------------------------------------------
--  DDL for Package Body PER_CPO_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_CPO_SHD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_cpo_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PER_COMPETENCE_OUTCOMES_PK') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
    fnd_message.set_token('STEP','5');
    fnd_message.raise_error;
  ElsIf (p_constraint_name = 'PER_COMPETENCE_OUTCOMES_FK1') Then
    fnd_message.set_name('PAY', 'HR_6153_ALL_PROCEDURE_FAIL');
    fnd_message.set_token('PROCEDURE', l_proc);
...
Begin
  ...
  Else
    If (p_outcome_id
        = per_cpo_shd.g_old_rec.outcome_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_cpo_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_cpo_shd.g_old_rec.object_version_number) Then
...
Begin
  ...
  l_rec.outcome_number                   := p_outcome_number;
  l_rec.name                             := p_name;
