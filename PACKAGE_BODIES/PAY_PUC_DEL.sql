--------------------------------------------------------
--  DDL for Package Body PAY_PUC_DEL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_PUC_DEL" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_puc_del.';  -- Global package name
--
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  -- Delete the pay_user_columns row.
  --
...
-- {End Of Comments}
-- ----------------------------------------------------------------------------
Procedure pre_delete(p_rec in pay_puc_shd.g_rec_type) is
--
...
-- {End Of Comments}
-- -----------------------------------------------------------------------------
Procedure post_delete(p_rec in pay_puc_shd.g_rec_type) is
--
...
Begin
  ...
  begin
    ...
    pay_puc_rkd.after_delete
      ...
      ,p_user_table_id_o
      => pay_puc_shd.g_old_rec.user_table_id
      ,p_formula_id_o
      => pay_puc_shd.g_old_rec.formula_id
      ,p_user_column_name_o
      => pay_puc_shd.g_old_rec.user_column_name
      ,p_object_version_number_o
      => pay_puc_shd.g_old_rec.object_version_number
      );
    --
  exception
    --
...
Begin
  ...
  --
  pay_puc_bus.delete_validate(p_rec);
  --
  ...
  --
  pay_puc_del.pre_delete(p_rec);
  --
  -- Delete the row.
  --
  pay_puc_del.delete_dml(p_rec);
  --
  -- Call the supporting post-delete operation
  --
  pay_puc_del.post_delete(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
