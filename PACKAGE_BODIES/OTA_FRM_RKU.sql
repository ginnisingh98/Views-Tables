--------------------------------------------------------
--  DDL for Package Body OTA_FRM_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_FRM_RKU" as
...
begin
hr_utility.set_location('Entering: OTA_FRM_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: OTA_FRM_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end OTA_FRM_RKU;
