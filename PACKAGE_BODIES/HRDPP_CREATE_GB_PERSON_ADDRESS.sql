--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_GB_PERSON_ADDRESS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_GB_PERSON_ADDRESS" as
/*
 * Generated by hr_pump_meta_mapper at: 2018/06/16 10:06:04
 * Generated for API: HR_PERSON_ADDRESS_API.CREATE_GB_PERSON_ADDRESS
 */
--
...
decode(l.pval012,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval012,'GB_COUNTY',d(l.pval001),vn)) p12,
l.pval012 d12,
...
end hrdpp_CREATE_GB_PERSON_ADDRESS;
