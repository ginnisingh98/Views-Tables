--------------------------------------------------------
--  DDL for Package Body OKL_AUL_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_AUL_PVT_W" as
  /* $Header: OKLIAULB.pls 120.1 2005/07/07 13:08:19 asawanka noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_aul_pvt.aul_tbl_type, a0 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).segment := a1(indx);
          t(ddindx).agr_id := rosetta_g_miss_num_map(a2(indx));
          t(ddindx).source := a3(indx);
          t(ddindx).segment_number := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).object_version_number := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).constants := a6(indx);
  ...
  procedure rosetta_table_copy_out_p2(t okl_aul_pvt.aul_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a27 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := t(ddindx).segment;
          a2(indx) := rosetta_g_miss_num_map(t(ddindx).agr_id);
          a3(indx) := t(ddindx).source;
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).segment_number);
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).object_version_number);
          a6(indx) := t(ddindx).constants;
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_aul_pvt.aulv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).source := a2(indx);
          t(ddindx).segment := a3(indx);
          t(ddindx).segment_number := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).constants := a5(indx);
          ...
          t(ddindx).agr_id := rosetta_g_miss_num_map(a22(indx));
          t(ddindx).created_by := rosetta_g_miss_num_map(a23(indx));
          t(ddindx).creation_date := rosetta_g_miss_date_in_map(a24(indx));
          t(ddindx).last_updated_by := rosetta_g_miss_num_map(a25(indx));
          t(ddindx).last_update_date := rosetta_g_miss_date_in_map(a26(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_aul_pvt.aulv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a27 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a2(indx) := t(ddindx).source;
          a3(indx) := t(ddindx).segment;
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).segment_number);
          a5(indx) := t(ddindx).constants;
          ...
          a22(indx) := rosetta_g_miss_num_map(t(ddindx).agr_id);
          a23(indx) := rosetta_g_miss_num_map(t(ddindx).created_by);
          a24(indx) := t(ddindx).creation_date;
          a25(indx) := rosetta_g_miss_num_map(t(ddindx).last_updated_by);
          a26(indx) := t(ddindx).last_update_date;
  ...
  as
    ddp_aulv_rec okl_aul_pvt.aulv_rec_type;
    ddx_aulv_rec okl_aul_pvt.aulv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_aul_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_aulv_tbl okl_aul_pvt.aulv_tbl_type;
    ddx_aulv_tbl okl_aul_pvt.aulv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_aul_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_aul_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_aul_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_aul_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
