--------------------------------------------------------
--  DDL for Package Body HR_RU_PERSON_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_RU_PERSON_API" as
/* $Header: peperrui.pkb 120.0 2005/05/31 13:59 appldev noship $ */

   -- Package Variables
   g_package  CONSTANT VARCHAR2(33) := 'hr_ru_person_api.';
   g_debug boolean;
...
procedure update_ru_person
  ...
  l_proc CONSTANT                varchar2(72) := g_package||'update_ru_person';
