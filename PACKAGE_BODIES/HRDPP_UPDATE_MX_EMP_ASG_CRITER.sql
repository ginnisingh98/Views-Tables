--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_MX_EMP_ASG_CRITER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_MX_EMP_ASG_CRITER" as
/*
 * Generated by hr_pump_meta_mapper at: 2007/01/04 09:01:01
 * Generated for API: HR_MX_ASSIGNMENT_API.UPDATE_MX_EMP_ASG_CRITERIA
 */
--
...
decode(l.pval036,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval036,'MX_STAT_IMSS_LEAVING_REASON',d(l.pval001),l.pval055)) p36,
l.pval036 d36,
...
(P_SVR_ASSIGNMENT_USER_KEY => c.p63);
end if;
--
if c.p49 is null or
c.p1 is null then
...
(P_CON_SEG_USER_NAME => c.p64
,P_EFFECTIVE_DATE => c.p1);
end if;
--
hr_data_pump.api_trc_on;
HR_MX_ASSIGNMENT_API.UPDATE_MX_EMP_ASG_CRITERIA
(P_EFFECTIVE_DATE => c.p1
...
end hrdpp_UPDATE_MX_EMP_ASG_CRITER;
