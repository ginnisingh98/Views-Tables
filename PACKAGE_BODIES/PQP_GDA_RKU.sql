--------------------------------------------------------
--  DDL for Package Body PQP_GDA_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_GDA_RKU" as
...
begin
hr_utility.set_location('Entering: PQP_GDA_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PQP_GDA_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQP_GDA_RKU;
