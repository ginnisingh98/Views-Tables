--------------------------------------------------------
--  DDL for Package Body OKL_RAP_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_RAP_PVT_W" as
  /* $Header: OKLIRAPB.pls 120.0 2007/12/10 18:29:48 dcshanmu noship $ */
  procedure rosetta_table_copy_in_p2(t out nocopy okl_rap_pvt.rap_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        ddindx := 1;
        while true loop
          t(ddindx).acc_parameter_id := a0(indx);
          t(ddindx).report_id := a1(indx);
          t(ddindx).acct_param_type_code := a2(indx);
          t(ddindx).segment_range_from := a3(indx);
          t(ddindx).segment_range_to := a4(indx);
  ...
  procedure rosetta_table_copy_out_p2(t okl_rap_pvt.rap_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
  ...
  if t is null or t.count = 0 then
    ...
    a9 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        indx := 1;
        while true loop
          a0(indx) := t(ddindx).acc_parameter_id;
          a1(indx) := t(ddindx).report_id;
          a2(indx) := t(ddindx).acct_param_type_code;
          a3(indx) := t(ddindx).segment_range_from;
          a4(indx) := t(ddindx).segment_range_to;
  ...
  as
    ddp_rap_rec okl_rap_pvt.rap_rec_type;
    ddx_rap_rec okl_rap_pvt.rap_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_rap_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_rap_tbl okl_rap_pvt.rap_tbl_type;
    ddx_rap_tbl okl_rap_pvt.rap_tbl_type;
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_rap_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_rap_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_rap_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_rap_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
