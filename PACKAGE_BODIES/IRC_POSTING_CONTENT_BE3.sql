--------------------------------------------------------
--  DDL for Package Body IRC_POSTING_CONTENT_BE3
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_POSTING_CONTENT_BE3" as 
...
p_object_version_number        number) is
  ...
  --
  l_proc varchar2(72):='  irc_posting_content_be3.delete_posting_content_a';
begin
  hr_utility.set_location('Entering: '||l_proc,10);
  -- check the status of the business event
  l_event_name:='oracle.apps.per.irc.api.posting_content.delete_posting_content';
