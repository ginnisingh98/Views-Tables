--------------------------------------------------------
--  DDL for Package Body IRC_IOF_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IRC_IOF_RKD" as
...
begin
hr_utility.set_location('Entering: IRC_IOF_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: IRC_IOF_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end IRC_IOF_RKD;
