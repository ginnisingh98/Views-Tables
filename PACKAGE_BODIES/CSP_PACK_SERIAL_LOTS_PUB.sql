--------------------------------------------------------
--  DDL for Package Body CSP_PACK_SERIAL_LOTS_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."CSP_PACK_SERIAL_LOTS_PUB" AS
/* $Header: cspptspb.pls 115.5 2003/05/02 17:23:12 phegde ship $ */
-- Start of Comments
...
G_PKG_NAME CONSTANT VARCHAR2(30):= 'CSP_Pack_Serial_Lots_PUB';
G_FILE_NAME CONSTANT VARCHAR2(12) := 'cspptspb.pls';

-- Start of Comments
-- ***************** Private Conversion Routines Values -> Ids **************
-- Purpose
--
-- This procedure takes a public Pack_Serial_Lots record as input. It may contain
-- values or ids. All values are then converted into ids and a
-- private Pack_Serial_Lotsrecord is returned for the private
-- API call.
--
-- Conversions:
--
...
--
-- End of Comments
PROCEDURE Convert_plsl_Values_To_Ids(
         P_plsl_Rec        IN   CSP_pack_serial_lots_PUB.plsl_Rec_Type,
         x_pvt_plsl_rec    OUT NOCOPY   CSP_pack_serial_lots_PVT.plsl_Rec_Type
)
IS
...
BEGIN
  -- Hint: Add logic to process value-id verification for Pack_Serial_Lots record.
...
/*
    x_pvt_plsl_rec.PACKLIST_SERIAL_LOT_ID := P_plsl_Rec.PACKLIST_SERIAL_LOT_ID;
    x_pvt_plsl_rec.CREATED_BY := P_plsl_Rec.CREATED_BY;
    x_pvt_plsl_rec.CREATION_DATE := P_plsl_Rec.CREATION_DATE;
    x_pvt_plsl_rec.LAST_UPDATED_BY := P_plsl_Rec.LAST_UPDATED_BY;
    x_pvt_plsl_rec.LAST_UPDATE_DATE := P_plsl_Rec.LAST_UPDATE_DATE;
    x_pvt_plsl_rec.LAST_UPDATE_LOGIN := P_plsl_Rec.LAST_UPDATE_LOGIN;
    x_pvt_plsl_rec.PACKLIST_LINE_ID := P_plsl_Rec.PACKLIST_LINE_ID;
    x_pvt_plsl_rec.ORGANIZATION_ID := P_plsl_Rec.ORGANIZATION_ID;
    x_pvt_plsl_rec.INVENTORY_ITEM_ID := P_plsl_Rec.INVENTORY_ITEM_ID;
    x_pvt_plsl_rec.QUANTITY := P_plsl_Rec.QUANTITY;
    x_pvt_plsl_rec.LOT_NUMBER := P_plsl_Rec.LOT_NUMBER;
    x_pvt_plsl_rec.SERIAL_NUMBER := P_plsl_Rec.SERIAL_NUMBER;
*/
...
END Convert_plsl_Values_To_Ids;
PROCEDURE Create_pack_serial_lots(
 ...
 IS
l_api_name                CONSTANT VARCHAR2(30) := 'Create_pack_serial_lots';
l_api_version_number      CONSTANT NUMBER   := 2.0;
l_pvt_plsl_rec    CSP_Pack_Serial_Lots_PVT.plsl_Rec_Type;
 BEGIN
      -- Standard Start of API savepoint
      SAVEPOINT CREATE_Pack_Serial_Lots_PUB;
      ...
      -- Debug Message
      JTF_PLSQL_API.Debug_Message(FND_MSG_PUB.G_MSG_LVL_DEBUG_LOW, 'CSP', 'AS: Public API: Convert_plsl_Values_To_Ids');

      -- Convert the values to ids
      --
      Convert_plsl_Values_To_Ids (
            p_plsl_rec       =>  p_plsl_rec,
            x_pvt_plsl_rec   =>  l_pvt_plsl_rec
      );

    -- Calling Private package: Create_Pack_Serial_Lots
    -- Hint: Primary key needs to be returned
      CSP_pack_serial_lots_PVT.Create_pack_serial_lots(
      P_Api_Version_Number         => 2.0,
      P_Init_Msg_List              => FND_API.G_FALSE,
      P_Commit                     => FND_API.G_FALSE,
      P_Validation_Level           => FND_API.G_VALID_LEVEL_FULL,
      P_plsl_Rec  =>  l_pvt_plsl_Rec ,
    -- Hint: Add detail tables as parameter lists if it's master-detail relationship.
      X_PACKLIST_SERIAL_LOT_ID     => x_PACKLIST_SERIAL_LOT_ID,
...
l_pvt_plsl_rec  CSP_Pack_Serial_Lots_PVT.plsl_Rec_Type;
 BEGIN
      -- Standard Start of API savepoint
      SAVEPOINT UPDATE_Pack_Serial_Lots_PUB;
    ...
    CSP_pack_serial_lots_PVT.Update_pack_serial_lots(
    P_Api_Version_Number         => 2.0,
    P_Init_Msg_List              => FND_API.G_FALSE,
    P_Commit                     => p_commit,
    P_Validation_Level           => FND_API.G_VALID_LEVEL_FULL,
...
l_pvt_plsl_rec  CSP_Pack_Serial_Lots_PVT.plsl_Rec_Type;
 BEGIN
      -- Standard Start of API savepoint
      SAVEPOINT DELETE_Pack_Serial_Lots_PUB;
    ...
    CSP_pack_serial_lots_PVT.Delete_pack_serial_lots(
    P_Api_Version_Number         => 2.0,
    P_Init_Msg_List              => FND_API.G_FALSE,
    P_Commit                     => p_commit,
    P_Validation_Level           => FND_API.G_VALID_LEVEL_FULL,
...
--  x_tot_rec_amount             OUT NOCOPY  NUMBER
 ...
 IS
l_api_name                CONSTANT VARCHAR2(30) := 'Get_pack_serial_lots';
l_api_version_number      CONSTANT NUMBER   := 2.0;
 BEGIN
      -- Standard Start of API savepoint
      SAVEPOINT GET_Pack_Serial_Lots_PUB;
      ...
      --
      -- Debug Message
      JTF_PLSQL_API.Debug_Message(FND_MSG_PUB.G_MSG_LVL_DEBUG_LOW, 'CSP', 'Public API: - Calling PVT.Get_Pack_Serial_Lots');
/*
    CSP_pack_serial_lots_PVT.Get_pack_serial_lots(
    P_Api_Version_Number         => 2.0,
    P_Init_Msg_List              => FND_API.G_FALSE,
    p_validation_level           => FND_API.G_VALID_LEVEL_FULL,
    P_Identity_Salesforce_id     => p_identity_salesforce_id,
