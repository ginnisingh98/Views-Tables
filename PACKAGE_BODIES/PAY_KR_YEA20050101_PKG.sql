--------------------------------------------------------
--  DDL for Package Body PAY_KR_YEA20050101_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_KR_YEA20050101_PKG" as
/* $Header: pykryea4.pkb 120.6 2006/12/21 07:44:00 pdesu noship $ */
-- Constant
	-- Bug 3966549
	...
	if (p_yea_info.nationality = 'F' and p_yea_info.fixed_tax_rate = 'Y') then
		...
		if p_yea_info.non_resident_flag = 'N' then
			...
			p_yea_info.total_credit_card_exp :=p_yea_info.emp_cre_card_direct_exp2004 + p_yea_info.dpnt_cre_card_direct_exp2004
			                                   + p_yea_info.giro_tuition_paid_exp2004 + p_yea_info.cash_receipt_exp2005;
