--------------------------------------------------------
--  DDL for Package Body HR_ES_EMPLOYEE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ES_EMPLOYEE_API" as
/* $Header: peempesi.pkb 115.0 2004/03/18 01:25:07 vikgupta noship $ */
--
-- Package Variables
--
g_package  varchar2(33) := 'hr_es_employee_api.';
--
-- ----------------------------------------------------------------------------
-- |-------------------------< create_es_employee >---------------------------|
-- ----------------------------------------------------------------------------
