--------------------------------------------------------
--  DDL for Package Body OTA_LCI_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_LCI_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_lci_bus.';  -- Global package name
--
...
Begin
  ...
  --
  if (( nvl(ota_lci_bus.g_learning_path_id, hr_api.g_number)
       = p_learning_path_id)
  and ( nvl(ota_lci_bus.g_category_usage_id, hr_api.g_number)
    ...
    -- variable.
    --
    l_legislation_code := ota_lci_bus.g_legislation_code;
    ...
    --
    close csr_leg_code;
    ota_lci_bus.g_learning_path_id            := p_learning_path_id;
    ota_lci_bus.g_category_usage_id           := p_category_usage_id;
    ota_lci_bus.g_legislation_code  := l_legislation_code;
  end if;
...
begin
  ...
  if ((p_rec.learning_path_id is not null) and
    ...
    nvl(ota_lci_shd.g_old_rec.attribute_category, hr_api.g_varchar2) <>
    nvl(p_rec.attribute_category, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute1, hr_api.g_varchar2) <>
    nvl(p_rec.attribute1, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute2, hr_api.g_varchar2) <>
    nvl(p_rec.attribute2, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute3, hr_api.g_varchar2) <>
    nvl(p_rec.attribute3, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute4, hr_api.g_varchar2) <>
    nvl(p_rec.attribute4, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute5, hr_api.g_varchar2) <>
    nvl(p_rec.attribute5, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute6, hr_api.g_varchar2) <>
    nvl(p_rec.attribute6, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute7, hr_api.g_varchar2) <>
    nvl(p_rec.attribute7, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute8, hr_api.g_varchar2) <>
    nvl(p_rec.attribute8, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute9, hr_api.g_varchar2) <>
    nvl(p_rec.attribute9, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute10, hr_api.g_varchar2) <>
    nvl(p_rec.attribute10, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute11, hr_api.g_varchar2) <>
    nvl(p_rec.attribute11, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute12, hr_api.g_varchar2) <>
    nvl(p_rec.attribute12, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute13, hr_api.g_varchar2) <>
    nvl(p_rec.attribute13, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute14, hr_api.g_varchar2) <>
    nvl(p_rec.attribute14, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute15, hr_api.g_varchar2) <>
    nvl(p_rec.attribute15, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute16, hr_api.g_varchar2) <>
    nvl(p_rec.attribute16, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute17, hr_api.g_varchar2) <>
    nvl(p_rec.attribute17, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute18, hr_api.g_varchar2) <>
    nvl(p_rec.attribute18, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute19, hr_api.g_varchar2) <>
    nvl(p_rec.attribute19, hr_api.g_varchar2)  or
    nvl(ota_lci_shd.g_old_rec.attribute20, hr_api.g_varchar2) <>
    nvl(p_rec.attribute20, hr_api.g_varchar2) ))
    or (p_rec.learning_path_id is null) and
       (p_rec.category_usage_id is null)  then
    --
    ...
    hr_dflex_utility.ins_or_upd_descflex_attribs
      ...
      ,p_descflex_name                   => 'OTA_LP_CAT_INCLUSIONS'
...
Begin
  ...
  --
  IF NOT ota_lci_shd.api_updating
...
--
Procedure check_lp_category_dates
  (
   p_learning_path_id           in    number
  , p_category_usage_id        in number
  ) is
  ...
  CURSOR csr_cat_start_end_date is
   ...
   CURSOR csr_lp_start_end_date IS
...
Begin
  ...
  IF hr_multi_message.no_exclusive_error
     ...
     OPEN csr_lp_start_end_date;
     FETCH csr_lp_start_end_date into l_lp_start_date, l_lp_end_date;

     IF csr_cat_start_end_date%FOUND  AND csr_lp_start_end_date%FOUND THEN
        CLOSE csr_cat_start_end_date;
	 CLOSE csr_lp_start_end_date;
        IF ( l_cat_start_date > l_lp_start_date
             or l_cat_end_date < l_lp_end_date
           ) THEN
          --
...
Begin
  ...
  --
   check_unique_key( p_learning_path_id
                  , p_category_usage_id );
  --
  if p_rec.primary_flag = 'Y' then
     check_multiple_primary_ctgr(p_learning_path_id);
     check_lp_category_dates(p_learning_path_id       => p_rec.learning_path_id
                                                     , p_category_usage_id => p_rec.category_usage_id);
  end if;
...
--
  ...
  l_start_date_changed boolean := ota_general.value_changed( ota_lci_shd.g_old_rec.start_date_active
                                       , p_rec.start_date_active );
  l_end_date_changed boolean :=   ota_general.value_changed( ota_lci_shd.g_old_rec.end_date_active
                                       , p_rec.end_date_active );
  l_start_date ota_lp_cat_inclusions.start_date_active%TYPE;
  l_end_date ota_lp_cat_inclusions.end_date_active%TYPE;
--
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  ...
  IF l_start_date_changed OR l_end_date_changed THEN
        ...
        ELSE
             l_start_date := ota_lci_shd.g_old_rec.start_date_active;
        END IF;

        IF (l_end_date_changed) THEN
             l_end_date := p_rec.end_date_active;
        ELSE
             l_end_date := ota_lci_shd.g_old_rec.end_date_active;
        END IF;
...
WHEN app_exception.application_exception THEN
               ...
               IF hr_multi_message.exception_add(
                    p_associated_column1    => 'OTA_LP_CAT_INCLUSIONS.PRIMARY_FLAG')
...
Begin
  ...
  WHEN app_exception.application_exception THEN
               ...
               IF hr_multi_message.exception_add(
                    p_associated_column1    => 'OTA_LP_CAT_INCLUSIONS.START_DATE_ACTIVE'
                    ,p_associated_column2    => 'OTA_LP_CAT_INCLUSIONS.END_DATE_ACTIVE')
                                           THEN
...
Begin
  ...
  WHEN app_exception.application_exception THEN
               ...
               IF hr_multi_message.exception_add(
                    p_associated_column1    => 'OTA_LP_CAT_INCLUSIONS.learning_path_id',
                    p_associated_column2    => 'OTA_LP_CAT_INCLUSIONS.CATEGORY_USAGE_ID')
                                                              THEN
                   hr_utility.set_location(' Leaving:'||v_proc, 22);
                   RAISE;
