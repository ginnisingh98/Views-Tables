--------------------------------------------------------
--  DDL for Package Body PAY_BDT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_BDT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_bdt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: pay_balance_dimensions_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.balance_dimension_id             := p_balance_dimension_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  -- Insert the row
  --
  pay_bdt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  --pay_bdt_ins.post_insert(p_rec);
  --
  -- Call to raise any errors on multi-message list
  hr_multi_message.end_validation_set;
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where bdt.balance_dimension_id = p_balance_dimension_id
                          and bdt.language = l.language_code);
  --
