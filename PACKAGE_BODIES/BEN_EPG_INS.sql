--------------------------------------------------------
--  DDL for Package Body BEN_EPG_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EPG_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_epg_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  ...
  l_created_by          ben_elig_ppl_grp_prte_f.created_by%TYPE;
  l_creation_date       ben_elig_ppl_grp_prte_f.creation_date%TYPE;
...
Begin
  ...
  --
  -- Insert the row into: ben_elig_ppl_grp_prte_f
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
          open c1;
          fetch c1 into p_rec.elig_ppl_grp_prte_id;
          close c1;
  --
  --
  --
...
Begin
  ...
  --
  p_elig_ppl_grp_prte_id        	:= l_rec.elig_ppl_grp_prte_id;
