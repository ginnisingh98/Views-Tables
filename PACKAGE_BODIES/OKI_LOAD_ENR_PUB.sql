--------------------------------------------------------
--  DDL for Package Body OKI_LOAD_ENR_PUB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKI_LOAD_ENR_PUB" AS
/* $Header: OKIPENRB.pls 115.4 2002/12/01 17:50:24 rpotnuru noship $ */
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
  -- Procedure to create all the expired not renewed records.
...
--------------------------------------------------------------------------------
  ...
  BEGIN
    ...
    -- Call procedure to create the expired not renewed
    oki_load_enr_pvt.crt_exp_not_rnw (
