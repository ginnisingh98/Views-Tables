--------------------------------------------------------
--  DDL for Package Body OKL_SETUPDSFPARAMETERS_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_SETUPDSFPARAMETERS_PUB_W" as
  /* $Header: OKLUSFRB.pls 120.1 2005/07/19 07:30:13 asawanka noship $ */
  ...
  as
    ddp_fprv_rec okl_setupdsfparameters_pub.fprv_rec_type;
    ddx_no_data_found boolean;
    ddx_fprv_rec okl_setupdsfparameters_pub.fprv_rec_type;
  ...
  begin
    ...
    okl_setupdsfparameters_pub.get_rec(ddp_fprv_rec,
      x_return_status,
      x_msg_data,
      ddx_no_data_found,
      ddx_fprv_rec);
  ...
  if ddx_no_data_found is null
    ...
    p4_a0 := rosetta_g_miss_num_map(ddx_fprv_rec.id);
    p4_a1 := rosetta_g_miss_num_map(ddx_fprv_rec.object_version_number);
    p4_a2 := ddx_fprv_rec.sfwt_flag;
    p4_a3 := rosetta_g_miss_num_map(ddx_fprv_rec.dsf_id);
    p4_a4 := rosetta_g_miss_num_map(ddx_fprv_rec.pmr_id);
    p4_a5 := rosetta_g_miss_num_map(ddx_fprv_rec.sequence_number);
    p4_a6 := ddx_fprv_rec.value;
    p4_a7 := ddx_fprv_rec.instructions;
    p4_a8 := ddx_fprv_rec.fpr_type;
    p4_a9 := rosetta_g_miss_num_map(ddx_fprv_rec.created_by);
    p4_a10 := ddx_fprv_rec.creation_date;
    p4_a11 := rosetta_g_miss_num_map(ddx_fprv_rec.last_updated_by);
    p4_a12 := ddx_fprv_rec.last_update_date;
    p4_a13 := rosetta_g_miss_num_map(ddx_fprv_rec.last_update_login);
  end;
  ...
  as
    ddp_dsfv_rec okl_setupdsfparameters_pub.dsfv_rec_type;
    ddp_fprv_rec okl_setupdsfparameters_pub.fprv_rec_type;
    ddx_fprv_rec okl_setupdsfparameters_pub.fprv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupdsfparameters_pub.insert_dsfparameters(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupdsfparameters_pub.update_dsfparameters(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_fprv_tbl okl_setupdsfparameters_pub.fprv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_setupdsfparameters_pub.delete_dsfparameters(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_dsfv_rec okl_setupdsfparameters_pub.dsfv_rec_type;
    ddp_fprv_tbl okl_setupdsfparameters_pub.fprv_tbl_type;
    ddx_fprv_tbl okl_setupdsfparameters_pub.fprv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
...
end okl_setupdsfparameters_pub_w;
