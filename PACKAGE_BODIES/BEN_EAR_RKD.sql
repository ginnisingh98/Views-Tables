--------------------------------------------------------
--  DDL for Package Body BEN_EAR_RKD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EAR_RKD" as
/* $Header: beearrhi.pkb 120.2 2006/03/31 00:04:23 generated noship $ */
...
begin
hr_utility.set_location('Entering: ben_ear_RKD.AFTER_DELETE', 10);
hr_utility.set_location(' Leaving: ben_ear_RKD.AFTER_DELETE', 20);
end AFTER_DELETE;
end ben_ear_RKD;
