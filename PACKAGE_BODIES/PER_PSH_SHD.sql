--------------------------------------------------------
--  DDL for Package Body PER_PSH_SHD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PER_PSH_SHD" as
/* $Header: pepshrhi.pkb 120.2 2006/05/08 19:35:08 tpapired noship $ */
--
-- ----------------------------------------------------------------------------
-- |                     Private Global Definitions                           |
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  per_psh_shd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |---------------------------< constraint_error >---------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  --
  If (p_constraint_name = 'PER_SCORECARD_SHARING_PK') Then
...
Function api_updating
  ...
  Cursor C_Sel1 is
    ...
    where       sharing_instance_id = p_sharing_instance_id;
  --
  l_fct_ret     boolean;
  --
Begin
  --
  If (p_sharing_instance_id is null and
    ...
    l_fct_ret := false;
  Else
    If (p_sharing_instance_id
        = per_psh_shd.g_old_rec.sharing_instance_id and
    ...
    Else
      ...
      --
      Open C_Sel1;
      Fetch C_Sel1 Into per_psh_shd.g_old_rec;
      ...
      If (p_object_version_number
          <> per_psh_shd.g_old_rec.object_version_number) Then
