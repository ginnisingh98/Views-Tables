--------------------------------------------------------
--  DDL for Package Body OKL_VP_EXTEND_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_VP_EXTEND_PVT_W" as
  /* $Header: OKLEEXTB.pls 120.1 2005/07/11 12:49:27 dkagrawa noship $ */
  ...
  as
    ddp_ext_header_rec okl_vp_extend_pvt.extension_header_rec_type;
  ...
  begin
    ...
    okl_vp_extend_pvt.extend_contract(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
