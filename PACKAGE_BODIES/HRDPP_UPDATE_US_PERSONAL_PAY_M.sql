--------------------------------------------------------
--  DDL for Package Body HRDPP_UPDATE_US_PERSONAL_PAY_M
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_UPDATE_US_PERSONAL_PAY_M" as
/*
 * Generated by hr_pump_meta_mapper at: 2018/06/16 10:06:10
 * Generated for API: HR_PERSONAL_PAY_METHOD_API.UPDATE_US_PERSONAL_PAY_METHOD
 */
--
...
,P_TRANSIT_CODE in varchar2 default null
...
,I_PRENOTE_DATE in varchar2 default 'N'
...
,P_ACCOUNT_TYPE
,P_BANK_BRANCH
,nd(P_AMOUNT,I_AMOUNT)
,P_COMMENTS
,nd(P_PERCENTAGE,I_PERCENTAGE)
,nd(P_PRIORITY,I_PRIORITY)
...
,P_ATTRIBUTE20
,P_PAYEE_TYPE
,dd(P_PRENOTE_DATE,I_PRENOTE_DATE)
,P_TERRITORY_CODE
...
decode(l.pval007,cn,vn,vn,vh,
 hr_pump_get.gl(l.pval007,'US_ACCOUNT_TYPE',d(l.pval001),l.pval075)) p7,
l.pval007 d7,
...
l.pval034 d34,
decode(l.pval035,cn,dn,vn,dh,d(l.pval035)) p35,
l.pval035 d35,
...
(P_PERSONAL_PAY_METHOD_USER_KEY => c.p72);
end if;
--
if c.p72 is null or
c.p1 is null then
...
HR_PERSONAL_PAY_METHOD_API.UPDATE_US_PERSONAL_PAY_METHOD
...
,P_PRENOTE_DATE => c.p35
,P_TERRITORY_CODE => c.p36
,P_PPM_INFORMATION_CATEGORY => c.p37
,P_PPM_INFORMATION1 => c.p38
,P_PPM_INFORMATION2 => c.p39
,P_PPM_INFORMATION3 => c.p40
,P_PPM_INFORMATION4 => c.p41
,P_PPM_INFORMATION5 => c.p42
,P_PPM_INFORMATION6 => c.p43
,P_PPM_INFORMATION7 => c.p44
,P_PPM_INFORMATION8 => c.p45
,P_PPM_INFORMATION9 => c.p46
,P_PPM_INFORMATION10 => c.p47
,P_PPM_INFORMATION11 => c.p48
,P_PPM_INFORMATION12 => c.p49
,P_PPM_INFORMATION13 => c.p50
,P_PPM_INFORMATION14 => c.p51
,P_PPM_INFORMATION15 => c.p52
,P_PPM_INFORMATION16 => c.p53
,P_PPM_INFORMATION17 => c.p54
,P_PPM_INFORMATION18 => c.p55
,P_PPM_INFORMATION19 => c.p56
,P_PPM_INFORMATION20 => c.p57
,P_PPM_INFORMATION21 => c.p58
,P_PPM_INFORMATION22 => c.p59
,P_PPM_INFORMATION23 => c.p60
,P_PPM_INFORMATION24 => c.p61
,P_PPM_INFORMATION25 => c.p62
,P_PPM_INFORMATION26 => c.p63
,P_PPM_INFORMATION27 => c.p64
,P_PPM_INFORMATION28 => c.p65
,P_PPM_INFORMATION29 => c.p66
,P_PPM_INFORMATION30 => c.p67
,P_COMMENT_ID => c.p68
,P_EXTERNAL_ACCOUNT_ID => c.p69
...
end hrdpp_UPDATE_US_PERSONAL_PAY_M;
