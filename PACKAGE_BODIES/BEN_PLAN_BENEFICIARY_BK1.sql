--------------------------------------------------------
--  DDL for Package Body BEN_PLAN_BENEFICIARY_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_PLAN_BENEFICIARY_BK1" as
...
begin
hr_utility.set_location('Entering: BEN_PLAN_BENEFICIARY_BK1.CREATE_PLAN_BENEFICIARY_A', 10);
hr_utility.set_location(' Leaving: BEN_PLAN_BENEFICIARY_BK1.CREATE_PLAN_BENEFICIARY_A', 20);
end CREATE_PLAN_BENEFICIARY_A;
...
begin
hr_utility.set_location('Entering: BEN_PLAN_BENEFICIARY_BK1.CREATE_PLAN_BENEFICIARY_B', 10);
hr_utility.set_location(' Leaving: BEN_PLAN_BENEFICIARY_BK1.CREATE_PLAN_BENEFICIARY_B', 20);
end CREATE_PLAN_BENEFICIARY_B;
