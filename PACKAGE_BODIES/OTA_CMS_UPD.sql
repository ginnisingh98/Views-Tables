--------------------------------------------------------
--  DDL for Package Body OTA_CMS_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CMS_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ota_cms_upd.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< update_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Update the ota_chat_messages Row
  --
  update ota_chat_messages
    set
     chat_message_id                 = p_rec.chat_message_id
...
Begin
  ...
  --
  ota_cms_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  ota_cms_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  ota_cms_upd.post_update
     (p_effective_date
     ,p_rec
     );
  --
