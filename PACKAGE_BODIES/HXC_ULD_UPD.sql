--------------------------------------------------------
--  DDL for Package Body HXC_ULD_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_ULD_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_uld_upd.';  -- Global package name
...
Begin
  ...
  --
  --
  -- Update the hxc_layout_comp_definitions Row
  --
...
Begin
  ...
  If (p_rec.component_type = hr_api.g_varchar2) then
    ...
    hxc_uld_shd.g_old_rec.component_type;
  End If;
  If (p_rec.component_class = hr_api.g_varchar2) then
    p_rec.component_class :=
    hxc_uld_shd.g_old_rec.component_class;
  End If;
  If (p_rec.render_type = hr_api.g_varchar2) then
    p_rec.render_type :=
    hxc_uld_shd.g_old_rec.render_type;
  End If;
  --
...
Procedure upd
  ...
  ,p_component_class              in     varchar2  default hr_api.g_varchar2
  ,p_component_type               in     varchar2  default hr_api.g_varchar2
  ,p_render_type                  in     varchar2  default hr_api.g_varchar2
  ) is
--
