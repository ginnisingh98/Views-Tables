--------------------------------------------------------
--  DDL for Package Body HXC_ULP_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_ULP_RKU" as
...
begin
hr_utility.set_location('Entering: HXC_ULP_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: HXC_ULP_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end HXC_ULP_RKU;
