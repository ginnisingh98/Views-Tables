--------------------------------------------------------
--  DDL for Package Body GME_REVERT_BATCH_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GME_REVERT_BATCH_PVT" AS
/* $Header: GMEVRWBB.pls 120.8 2006/07/13 17:37:24 creddy noship $ */
