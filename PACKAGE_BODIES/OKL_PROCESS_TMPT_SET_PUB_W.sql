--------------------------------------------------------
--  DDL for Package Body OKL_PROCESS_TMPT_SET_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_PROCESS_TMPT_SET_PUB_W" as
  /* $Header: OKLUTMSB.pls 120.2 2005/10/30 03:52:18 appldev noship $ */
  ...
  as
    ddp_aesv_rec okl_process_tmpt_set_pub.aesv_rec_type;
    ddp_avlv_tbl okl_process_tmpt_set_pub.avlv_tbl_type;
    ddp_atlv_tbl okl_process_tmpt_set_pub.atlv_tbl_type;
    ddx_aesv_rec okl_process_tmpt_set_pub.aesv_rec_type;
    ddx_avlv_tbl okl_process_tmpt_set_pub.avlv_tbl_type;
    ddx_atlv_tbl okl_process_tmpt_set_pub.atlv_tbl_type;
  ...
  begin
    ...
    okl_process_tmpt_set_pub.create_tmpt_set(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pub.update_tmpt_set(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_aesv_tbl okl_process_tmpt_set_pub.aesv_tbl_type;
    ddx_aesv_tbl okl_process_tmpt_set_pub.aesv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pub.delete_tmpt_set(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pub.create_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_avlv_rec okl_process_tmpt_set_pub.avlv_rec_type;
    ddx_avlv_rec okl_process_tmpt_set_pub.avlv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pub.update_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pub.delete_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pub.create_tmpt_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_atlv_rec okl_process_tmpt_set_pub.atlv_rec_type;
    ddx_atlv_rec okl_process_tmpt_set_pub.atlv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pub.update_tmpt_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pub.delete_tmpt_lines(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_process_tmpt_set_pub.copy_template(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p7_a0 := rosetta_g_miss_num_map(ddx_avlv_rec.id);
    p7_a1 := rosetta_g_miss_num_map(ddx_avlv_rec.object_version_number);
    p7_a2 := rosetta_g_miss_num_map(ddx_avlv_rec.try_id);
    p7_a3 := rosetta_g_miss_num_map(ddx_avlv_rec.aes_id);
    p7_a4 := rosetta_g_miss_num_map(ddx_avlv_rec.sty_id);
    p7_a5 := rosetta_g_miss_num_map(ddx_avlv_rec.fma_id);
    p7_a6 := rosetta_g_miss_num_map(ddx_avlv_rec.set_of_books_id);
    p7_a7 := ddx_avlv_rec.fac_code;
    p7_a8 := ddx_avlv_rec.syt_code;
    p7_a9 := ddx_avlv_rec.post_to_gl;
    p7_a10 := ddx_avlv_rec.advance_arrears;
    p7_a11 := ddx_avlv_rec.memo_yn;
    p7_a12 := ddx_avlv_rec.prior_year_yn;
    p7_a13 := ddx_avlv_rec.name;
    p7_a14 := ddx_avlv_rec.description;
    p7_a15 := ddx_avlv_rec.version;
    p7_a16 := ddx_avlv_rec.factoring_synd_flag;
    p7_a17 := ddx_avlv_rec.start_date;
    p7_a18 := ddx_avlv_rec.end_date;
    p7_a19 := ddx_avlv_rec.accrual_yn;
    p7_a20 := ddx_avlv_rec.attribute_category;
    p7_a21 := ddx_avlv_rec.attribute1;
    p7_a22 := ddx_avlv_rec.attribute2;
    p7_a23 := ddx_avlv_rec.attribute3;
    p7_a24 := ddx_avlv_rec.attribute4;
    p7_a25 := ddx_avlv_rec.attribute5;
    p7_a26 := ddx_avlv_rec.attribute6;
    p7_a27 := ddx_avlv_rec.attribute7;
    p7_a28 := ddx_avlv_rec.attribute8;
    p7_a29 := ddx_avlv_rec.attribute9;
    p7_a30 := ddx_avlv_rec.attribute10;
    p7_a31 := ddx_avlv_rec.attribute11;
    p7_a32 := ddx_avlv_rec.attribute12;
    p7_a33 := ddx_avlv_rec.attribute13;
    p7_a34 := ddx_avlv_rec.attribute14;
    p7_a35 := ddx_avlv_rec.attribute15;
    p7_a36 := rosetta_g_miss_num_map(ddx_avlv_rec.org_id);
    p7_a37 := rosetta_g_miss_num_map(ddx_avlv_rec.created_by);
    p7_a38 := ddx_avlv_rec.creation_date;
    p7_a39 := rosetta_g_miss_num_map(ddx_avlv_rec.last_updated_by);
    p7_a40 := ddx_avlv_rec.last_update_date;
    p7_a41 := rosetta_g_miss_num_map(ddx_avlv_rec.last_update_login);
    p7_a42 := ddx_avlv_rec.inv_code;
  end;

end okl_process_tmpt_set_pub_w;
