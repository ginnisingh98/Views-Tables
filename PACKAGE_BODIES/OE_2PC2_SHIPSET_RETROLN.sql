--------------------------------------------------------
--  DDL for Package Body OE_2PC2_SHIPSET_RETROLN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OE_2PC2_SHIPSET_RETROLN" AS 
 PROCEDURE Is_Valid
 ( 
 ...
 IS 
   ...
   WHERE a.RETROBILL_REQUEST_ID IS NOT NULL 
   AND   (  a.LINE_ID ) IN  
                 ( SELECT  b.LINE_ID
