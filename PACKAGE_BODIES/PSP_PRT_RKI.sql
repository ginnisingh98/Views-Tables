--------------------------------------------------------
--  DDL for Package Body PSP_PRT_RKI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PSP_PRT_RKI" as
...
begin
hr_utility.set_location('Entering: PSP_PRT_RKI.AFTER_INSERT', 10);
hr_utility.set_location(' Leaving: PSP_PRT_RKI.AFTER_INSERT', 20);
end AFTER_INSERT;
end PSP_PRT_RKI;
