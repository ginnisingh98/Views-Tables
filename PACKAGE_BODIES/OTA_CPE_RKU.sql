--------------------------------------------------------
--  DDL for Package Body OTA_CPE_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OTA_CPE_RKU" as
...
begin
hr_utility.set_location('Entering: OTA_CPE_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: OTA_CPE_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end OTA_CPE_RKU;
