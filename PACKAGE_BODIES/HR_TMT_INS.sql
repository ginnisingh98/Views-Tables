--------------------------------------------------------
--  DDL for Package Body HR_TMT_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_TMT_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hr_tmt_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |------------------------------< insert_dml >------------------------------|
-- ----------------------------------------------------------------------------
...
Begin
  ...
  --
  --
  -- Insert the row into: hr_form_templates_tl
  --
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  p_rec.form_template_id                 := p_form_template_id;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
End pre_insert;
--
...
Begin
  ...
  --
  hr_tmt_bus.insert_validate
     (p_rec
     );
  --
  -- Call the supporting pre-insert operation
  --
  hr_tmt_ins.pre_insert
    (p_rec                         => p_rec
  ...
  -- Insert the row
  --
  hr_tmt_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  hr_tmt_ins.post_insert
     (p_rec
     );
  --
     ...
     where l.installed_flag in ('I','B')
       and not exists (select null
                        ...
                        where tmt.form_template_id = p_form_template_id
                          and tmt.language = l.language_code);
  --
