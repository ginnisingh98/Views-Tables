--------------------------------------------------------
--  DDL for Package Body PQH_PSU_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_PSU_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pqh_psu_ins.';  -- Global package name
--
-- The following global variables are only to be used by
-- the set_base_key_value and pre_insert procedures.
--
g_emp_stat_situation_id_i  number   default null;
--
-- ----------------------------------------------------------------------------
-- |------------------------< set_base_key_value >----------------------------|
-- ----------------------------------------------------------------------------
procedure set_base_key_value
  (p_emp_stat_situation_id  in  number) is
--
...
Begin
  ...
  --
  pqh_psu_ins.g_emp_stat_situation_id_i := p_emp_stat_situation_id;
  --
...
Begin
  ...
  --
  --
  -- Insert the row into: pqh_fr_emp_stat_situations
  --
  insert into pqh_fr_emp_stat_situations
...
--
  Cursor C_Sel1 is select pqh_fr_emp_stat_situations_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from pqh_fr_emp_stat_situations
     where emp_stat_situation_id =
             pqh_psu_ins.g_emp_stat_situation_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (pqh_psu_ins.g_emp_stat_situation_id_i is not null) Then
    --
    ...
    p_rec.emp_stat_situation_id :=
      pqh_psu_ins.g_emp_stat_situation_id_i;
    pqh_psu_ins.g_emp_stat_situation_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.emp_stat_situation_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  pqh_psu_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pqh_psu_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pqh_psu_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Procedure ins
  ...
  ,p_provisional_start_date         in     date     default null
  ,p_provisional_end_date           in     date     default null
...
Begin
  ...
  --
  -- Having converted the arguments into the pqh_psu_rec
  ...
  --
  p_emp_stat_situation_id := l_rec.emp_stat_situation_id;
