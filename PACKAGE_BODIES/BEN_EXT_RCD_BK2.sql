--------------------------------------------------------
--  DDL for Package Body BEN_EXT_RCD_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EXT_RCD_BK2" as
...
begin
hr_utility.set_location('Entering: BEN_EXT_RCD_BK2.UPDATE_EXT_RCD_A', 10);
hr_utility.set_location(' Leaving: BEN_EXT_RCD_BK2.UPDATE_EXT_RCD_A', 20);
end UPDATE_EXT_RCD_A;
...
begin
hr_utility.set_location('Entering: BEN_EXT_RCD_BK2.UPDATE_EXT_RCD_B', 10);
hr_utility.set_location(' Leaving: BEN_EXT_RCD_BK2.UPDATE_EXT_RCD_B', 20);
end UPDATE_EXT_RCD_B;
end BEN_EXT_RCD_BK2;
