--------------------------------------------------------
--  DDL for Package Body HR_TEMPLATE_WINDOWS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_TEMPLATE_WINDOWS_PKG" as
/* $Header: hrtwulct.pkb 115.2 2002/12/11 10:58:29 raranjan noship $ */
...
procedure INSERT_ROW (
  ...
  cursor C is select ROWID from HR_TEMPLATE_WINDOWS_B
    where TEMPLATE_WINDOW_ID = X_TEMPLATE_WINDOW_ID
    ;
begin
...
begin
  update HR_TEMPLATE_WINDOWS_B set
...
begin
 ...
 exception
   when no_data_found then
     select hr_template_windows_b_s.nextval
     into x_template_window_id
     from dual;
 end;
