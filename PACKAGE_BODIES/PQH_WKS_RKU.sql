--------------------------------------------------------
--  DDL for Package Body PQH_WKS_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_WKS_RKU" as
...
begin
hr_utility.set_location('Entering: PQH_WKS_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PQH_WKS_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQH_WKS_RKU;
