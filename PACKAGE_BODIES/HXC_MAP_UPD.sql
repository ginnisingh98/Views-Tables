--------------------------------------------------------
--  DDL for Package Body HXC_MAP_UPD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HXC_MAP_UPD" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  hxc_map_upd.';  -- Global package name
...
Begin
  ...
  --
  convert_defs(p_rec);
  hxc_map_bus.update_validate
     (p_rec
     );
  --
  -- Call the supporting pre-update operation
  --
  hxc_map_upd.pre_update(p_rec);
  --
  -- Update the row.
  --
  hxc_map_upd.update_dml(p_rec);
  --
  -- Call the supporting post-update operation
  --
  hxc_map_upd.post_update
     (p_rec
     );
End upd;
--
