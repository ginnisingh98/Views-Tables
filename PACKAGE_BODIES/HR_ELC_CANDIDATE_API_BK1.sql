--------------------------------------------------------
--  DDL for Package Body HR_ELC_CANDIDATE_API_BK1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HR_ELC_CANDIDATE_API_BK1" as
...
begin
hr_utility.set_location('Entering: HR_ELC_CANDIDATE_API_BK1.CREATE_ELECTION_CANDIDATE_A', 10);
hr_utility.set_location(' Leaving: HR_ELC_CANDIDATE_API_BK1.CREATE_ELECTION_CANDIDATE_A', 20);
end CREATE_ELECTION_CANDIDATE_A;
...
begin
hr_utility.set_location('Entering: HR_ELC_CANDIDATE_API_BK1.CREATE_ELECTION_CANDIDATE_B', 10);
hr_utility.set_location(' Leaving: HR_ELC_CANDIDATE_API_BK1.CREATE_ELECTION_CANDIDATE_B', 20);
end CREATE_ELECTION_CANDIDATE_B;
