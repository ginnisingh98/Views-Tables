--------------------------------------------------------
--  DDL for Package Body OKL_CSH_ORDER_SEQ_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_CSH_ORDER_SEQ_PUB_W" as
  /* $Header: OKLUSATB.pls 120.1 2005/07/08 10:33:56 dkagrawa noship $ */
  ...
  procedure update_order_sequence(p_api_version  NUMBER
  ...
  as
    ddp_okl_csh_order_rec okl_csh_order_seq_pub.okl_csh_order_rec_type;
    ddx_okl_csh_order_rec okl_csh_order_seq_pub.okl_csh_order_rec_type;
  ...
  begin
    ...
    okl_csh_order_seq_pub.update_order_sequence(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_okl_csh_order_tbl okl_csh_order_seq_pub.okl_csh_order_tbl_type;
    ddx_okl_csh_order_tbl okl_csh_order_seq_pub.okl_csh_order_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
