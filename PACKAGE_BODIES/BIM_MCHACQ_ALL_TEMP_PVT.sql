--------------------------------------------------------
--  DDL for Package Body BIM_MCHACQ_ALL_TEMP_PVT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BIM_MCHACQ_ALL_TEMP_PVT" AS
/* $Header: bimvnqab.pls 115.2 2000/03/03 20:36:18 pkm ship  $ */
