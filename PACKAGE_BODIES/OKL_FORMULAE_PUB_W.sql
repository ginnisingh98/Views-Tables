--------------------------------------------------------
--  DDL for Package Body OKL_FORMULAE_PUB_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_FORMULAE_PUB_W" as
  /* $Header: OKLUFMAB.pls 120.1 2005/07/12 07:06:13 asawanka noship $ */
  ...
  as
    ddp_fmav_rec okl_formulae_pub.fmav_rec_type;
    ddx_fmav_rec okl_formulae_pub.fmav_rec_type;
  ...
  begin
    ...
    okl_formulae_pub.insert_formulae(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  as
    ddp_fmav_tbl okl_formulae_pub.fmav_tbl_type;
    ddx_fmav_tbl okl_formulae_pub.fmav_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
  ...
  procedure lock_formulae(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_formulae_pub.lock_formulae(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_formulae_pub.update_formulae(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure delete_formulae(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_formulae_pub.delete_formulae(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  procedure validate_formulae(p_api_version  NUMBER
    , p_init_msg_list  VARCHAR2
    , x_return_status out nocopy  VARCHAR2
    , x_msg_count out nocopy  NUMBER
    , x_msg_data out nocopy  VARCHAR2
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_formulae_pub.validate_formulae(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
