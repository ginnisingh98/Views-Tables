--------------------------------------------------------
--  DDL for Package Body HRDPP_CREATE_PERSON_LIFE_EVENT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."HRDPP_CREATE_PERSON_LIFE_EVENT" as
/*
 * Generated by hr_pump_meta_mapper at: 2013/08/29 22:08:10
 * Generated for API: ben_person_life_event_api.CREATE_PERSON_LIFE_EVENT
 */
--
...
decode(l.pval002,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval002,'BEN_PER_IN_LER_STAT',d(l.pval045),vn)) p2,
l.pval002 d2,
decode(l.pval003,cn,vn,vn,vn,
 hr_pump_get.gl(l.pval003,'BEN_PER_IN_LER_STAT',d(l.pval045),vn)) p3,
l.pval003 d3,
...
l.pval043 d43,
l.pval044 p44,
decode(l.pval045,cn,dn,d(l.pval045)) p45,
...
(P_TRGR_TABLE_PK_USER_KEY => c.p46);
end if;
--
...
(P_PTNL_LER_FOR_PER_USER_KEY => c.p47);
end if;
--
...
(P_BCKT_PER_IN_LER_USER_KEY => c.p48);
end if;
--
if c.p49 is null or
c.p45 is null then
...
,P_LIFE_EVENT_REASON => c.p49
,P_EFFECTIVE_DATE => c.p45);
end if;
--
...
(P_ASSIGNMENT_USER_KEY => c.p51);
end if;
--
if c.p52 is null then
L_WS_MGR_ID:=nn;
else
L_WS_MGR_ID := 
hr_pump_get.get_ws_mgr_id
(P_WS_MGR_USER_KEY => c.p52);
end if;
--
...
(P_MGR_OVRID_PERSON_USER_KEY => c.p54);
end if;
--
L_REQUEST_ID := 
...
,P_PER_IN_LER_STAT_CD => c.p2
,P_PRVS_STAT_CD => c.p3
,P_LF_EVT_OCRD_DT => c.p4
...
,P_MGR_OVRID_DT => c.p11
,P_PIL_ATTRIBUTE_CATEGORY => c.p12
,P_PIL_ATTRIBUTE1 => c.p13
,P_PIL_ATTRIBUTE2 => c.p14
,P_PIL_ATTRIBUTE3 => c.p15
,P_PIL_ATTRIBUTE4 => c.p16
,P_PIL_ATTRIBUTE5 => c.p17
,P_PIL_ATTRIBUTE6 => c.p18
,P_PIL_ATTRIBUTE7 => c.p19
,P_PIL_ATTRIBUTE8 => c.p20
,P_PIL_ATTRIBUTE9 => c.p21
,P_PIL_ATTRIBUTE10 => c.p22
,P_PIL_ATTRIBUTE11 => c.p23
,P_PIL_ATTRIBUTE12 => c.p24
,P_PIL_ATTRIBUTE13 => c.p25
,P_PIL_ATTRIBUTE14 => c.p26
,P_PIL_ATTRIBUTE15 => c.p27
,P_PIL_ATTRIBUTE16 => c.p28
,P_PIL_ATTRIBUTE17 => c.p29
,P_PIL_ATTRIBUTE18 => c.p30
,P_PIL_ATTRIBUTE19 => c.p31
,P_PIL_ATTRIBUTE20 => c.p32
,P_PIL_ATTRIBUTE21 => c.p33
,P_PIL_ATTRIBUTE22 => c.p34
,P_PIL_ATTRIBUTE23 => c.p35
,P_PIL_ATTRIBUTE24 => c.p36
,P_PIL_ATTRIBUTE25 => c.p37
,P_PIL_ATTRIBUTE26 => c.p38
,P_PIL_ATTRIBUTE27 => c.p39
,P_PIL_ATTRIBUTE28 => c.p40
,P_PIL_ATTRIBUTE29 => c.p41
,P_PIL_ATTRIBUTE30 => c.p42
,P_REQUEST_ID => L_REQUEST_ID
,P_PROGRAM_APPLICATION_ID => L_PROGRAM_APPLICATION_ID
,P_PROGRAM_ID => L_PROGRAM_ID
,P_PROGRAM_UPDATE_DATE => c.p43
,P_OBJECT_VERSION_NUMBER => c.p44
,P_EFFECTIVE_DATE => c.p45);
hr_data_pump.api_trc_off;
--
iuk(p_batch_line_id,c.p1,L_PER_IN_LER_ID);
--
...
end hrdpp_CREATE_PERSON_LIFE_EVENT;
