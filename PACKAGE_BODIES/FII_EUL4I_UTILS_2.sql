--------------------------------------------------------
--  DDL for Package Body FII_EUL4I_UTILS_2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."FII_EUL4I_UTILS_2" AS
/* $Header: FIIEL42B.pls 120.0 2002/08/24 04:52:34 appldev noship $ */
...
*/
              ...
              (pTableNameIn = 'EDW_TRD_PARTNER_M' AND
               SUBSTRB(pColumnNameIn,1,4) IN ('PTP1','PTP2','PTP3','PTP4') AND
...
*/
              OR
              (pTableNameIn = 'EDW_TRD_PARTNER_M' AND
               SUBSTRB(pColumnNameIn,1,4) IN ('PTP1','PTP2','PTP3') AND
               pColumnNameIn NOT LIKE 'PTP__NAME')
