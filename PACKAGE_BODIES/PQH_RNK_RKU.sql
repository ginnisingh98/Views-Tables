--------------------------------------------------------
--  DDL for Package Body PQH_RNK_RKU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQH_RNK_RKU" as
...
begin
hr_utility.set_location('Entering: PQH_RNK_RKU.AFTER_UPDATE', 10);
hr_utility.set_location(' Leaving: PQH_RNK_RKU.AFTER_UPDATE', 20);
end AFTER_UPDATE;
end PQH_RNK_RKU;
