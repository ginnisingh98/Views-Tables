--------------------------------------------------------
--  DDL for Package Body PQP_VEHICLE_REPOSITORY_BK2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PQP_VEHICLE_REPOSITORY_BK2" as
/* $Header: pqvreapi.pkb 120.0 2005/05/29 02:18:02 generated noship $ */
-- Code generated by the Oracle HRMS API Hook Pre-processor
-- Created on 2007/10/10 13:38:25 (YYYY/MM/DD HH24:MI:SS)
...
begin
hr_utility.set_location('Entering: PQP_VEHICLE_REPOSITORY_BK2.UPDATE_VEHICLE_A', 10);
hr_utility.set_location(' Leaving: PQP_VEHICLE_REPOSITORY_BK2.UPDATE_VEHICLE_A', 20);
end UPDATE_VEHICLE_A;
...
begin
hr_utility.set_location('Entering: PQP_VEHICLE_REPOSITORY_BK2.UPDATE_VEHICLE_B', 10);
l_commit_unit_number := hr_api.return_commit_unit;
if hr_api.call_leg_hooks then
l_legislation_code := PQP_VRE_BUS.RETURN_LEGISLATION_CODE(P_VEHICLE_REPOSITORY_ID => P_VEHICLE_REPOSITORY_ID
);
if l_legislation_code = 'PL' then
PQP_PL_VEHICLE_REPOSITORY.UPDATE_PL_VEHICLE
...
hr_api.validate_commit_unit(l_commit_unit_number, 'UPDATE_VEHICLE', 'BP');
hr_utility.set_location(' Leaving: PQP_VEHICLE_REPOSITORY_BK2.UPDATE_VEHICLE_B', 20);
end UPDATE_VEHICLE_B;
