--------------------------------------------------------
--  DDL for Package Body GHR_CST_BUS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."GHR_CST_BUS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  ghr_cst_bus.';  -- Global package name
--
-- The following two global variables are only to be
-- used by the return_legislation_code function.
--
g_legislation_code            varchar2(150)  default null;
g_compl_agency_cost_id             number         default null;
--
--  ---------------------------------------------------------------------------
...
Procedure set_security_group_id
  ...
  -- ghr_compl_agency_costs and PER_BUSINESS_GROUPS
  ...
  cursor csr_sec_grp is
    select pbg.security_group_id
      from per_business_groups pbg
         , ghr_compl_agency_costs cst
      --   , EDIT_HERE table_name(s) 333
     where cst.compl_agency_cost_id = p_compl_agency_cost_id;
...
Begin
  ...
  --
  if ( nvl(ghr_cst_bus.g_compl_agency_cost_id, hr_api.g_number)
       = p_compl_agency_cost_id) then
    --
    -- The legislation code has already been found with a previous
    -- call to this function. Just return the value in the global
    -- variable.
    --
    l_legislation_code := ghr_cst_bus.g_legislation_code;
    ...
    --
    close csr_leg_code;
    ghr_cst_bus.g_compl_agency_cost_id             := p_compl_agency_cost_id;
    ghr_cst_bus.g_legislation_code  := l_legislation_code;
  end if;
...
Begin
  ...
  --
  IF NOT ghr_cst_shd.api_updating
