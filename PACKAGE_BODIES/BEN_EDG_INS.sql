--------------------------------------------------------
--  DDL for Package Body BEN_EDG_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."BEN_EDG_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33)	:= '  ben_edg_ins.';  -- Global package name
--
-- ----------------------------------------------------------------------------
-- |----------------------------< dt_insert_dml >-----------------------------|
-- ----------------------------------------------------------------------------
...
--
  Cursor C_Sel1 Is
    ...
    where  t.elig_dpnt_cvrd_othr_pgm_id       = p_rec.elig_dpnt_cvrd_othr_pgm_id
    and    t.effective_start_date =
             ben_edg_shd.g_old_rec.effective_start_date
    and    t.effective_end_date   = (p_validation_start_date - 1);
--
  l_proc		varchar2(72) := g_package||'dt_insert_dml';
  l_created_by          ben_elig_dpnt_cvrd_othr_pgm_f.created_by%TYPE;
  l_creation_date       ben_elig_dpnt_cvrd_othr_pgm_f.creation_date%TYPE;
  l_last_update_date   	ben_elig_dpnt_cvrd_othr_pgm_f.last_update_date%TYPE;
  l_last_updated_by     ben_elig_dpnt_cvrd_othr_pgm_f.last_updated_by%TYPE;
  l_last_update_login   ben_elig_dpnt_cvrd_othr_pgm_f.last_update_login%TYPE;
--
Begin
  ...
  --
  -- Insert the row into: ben_elig_dpnt_cvrd_othr_pgm_f
  --
  insert into ben_elig_dpnt_cvrd_othr_pgm_f
  ...
  Values
  (	p_rec.elig_dpnt_cvrd_othr_pgm_id,
...
--
  Cursor C_Sel1 is select ben_elig_dpnt_cvrd_othr_pgm_s.nextval from sys.dual;
--
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  ...
  --
  Open C_Sel1;
  Fetch C_Sel1 Into p_rec.elig_dpnt_cvrd_othr_pgm_id;
  Close C_Sel1;
  --
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  -- Having converted the arguments into the ben_edg_rec
  ...
  --
  p_elig_dpnt_cvrd_othr_pgm_id        	:= l_rec.elig_dpnt_cvrd_othr_pgm_id;
