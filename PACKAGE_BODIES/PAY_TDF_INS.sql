--------------------------------------------------------
--  DDL for Package Body PAY_TDF_INS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."PAY_TDF_INS" as
...
-- ----------------------------------------------------------------------------
--
g_package  varchar2(33) := '  pay_tdf_ins.';  -- Global package name
--
...
procedure set_base_key_value
  (p_time_definition_id  in  number) is
--
...
Begin
  ...
  --
  pay_tdf_ins.g_time_definition_id_i := p_time_definition_id;
  --
...
Begin
  ...
  --
  -- Insert the row into: pay_time_definitions
  --
...
--
  Cursor C_Sel1 is select pay_time_definitions_s.nextval from sys.dual;
--
  Cursor C_Sel2 is
    Select null
      from pay_time_definitions
     where time_definition_id =
             pay_tdf_ins.g_time_definition_id_i;
--
...
Begin
  hr_utility.set_location('Entering:'||l_proc, 5);
  --
  If (pay_tdf_ins.g_time_definition_id_i is not null) Then
    --
    ...
    p_rec.time_definition_id :=
      pay_tdf_ins.g_time_definition_id_i;
    pay_tdf_ins.g_time_definition_id_i := null;
  Else
    --
    ...
    --
    Open C_Sel1;
    Fetch C_Sel1 Into p_rec.time_definition_id;
    Close C_Sel1;
  End If;
  --
  hr_utility.set_location(' Leaving:'||l_proc, 10);
...
Begin
  ...
  --
  pay_tdf_ins.pre_insert(p_rec);
  --
  -- Insert the row
  --
  pay_tdf_ins.insert_dml(p_rec);
  --
  -- Call the supporting post-insert operation
  --
  pay_tdf_ins.post_insert
     (p_effective_date
     ,p_rec
     );
  --
...
Begin
  ...
  --
  p_time_definition_id := l_rec.time_definition_id;
