--------------------------------------------------------
--  DDL for Package Body IGS_HE_OU_CC_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGS_HE_OU_CC_PKG" AS
/* $Header: IGSWI45B.pls 120.0 2005/06/01 14:17:50 appldev noship $ */

  l_rowid VARCHAR2(25);
  old_references igs_he_ou_cc%ROWTYPE;
  new_references igs_he_ou_cc%ROWTYPE;
  ...
  */
  ...
  BEGIN
    ...
    -- Populate New Values.
    new_references.hesa_ou_cc_id                     := x_hesa_ou_cc_id;
  ...
  */
    CURSOR cur_rowid IS
      SELECT   rowid
      FROM     igs_he_ou_cc
      WHERE    hesa_ou_cc_id = x_hesa_ou_cc_id
      FOR UPDATE NOWAIT;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      ...
      fnd_message.set_token ('ROUTINE', 'IGS_HE_OU_CC_PKG.INSERT_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;

    x_hesa_ou_cc_id := NULL;

    before_dml(
      p_action                            => 'INSERT',
      x_rowid                             => x_rowid,
      x_hesa_ou_cc_id                     => x_hesa_ou_cc_id,
    ...
    INSERT INTO igs_he_ou_cc (
      ...
      x_last_updated_by,
      x_last_update_login
    ) RETURNING ROWID, hesa_ou_cc_id INTO x_rowid, x_hesa_ou_cc_id;
  ...
  */
  ...
  BEGIN
    ...
    ELSE
      fnd_message.set_name( 'FND', 'SYSTEM-INVALID ARGS');
      fnd_message.set_token ('ROUTINE', 'IGS_HE_OU_CC_PKG.UPDATE_ROW');
      igs_ge_msg_stack.add;
      app_exception.raise_exception;
    END IF;
