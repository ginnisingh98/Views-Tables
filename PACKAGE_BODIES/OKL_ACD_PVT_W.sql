--------------------------------------------------------
--  DDL for Package Body OKL_ACD_PVT_W
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."OKL_ACD_PVT_W" as
  /* $Header: OKLIACDB.pls 120.2 2005/12/02 12:57:10 dkagrawa noship $ */
  ...
  procedure rosetta_table_copy_in_p2(t out nocopy okl_acd_pvt.acd_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_DATE_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).date_report := rosetta_g_miss_date_in_map(a1(indx));
          t(ddindx).cdn_code := a2(indx);
          t(ddindx).clm_id := rosetta_g_miss_num_map(a3(indx));
          t(ddindx).isp_id := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).iln_id := rosetta_g_miss_num_map(a5(indx));
  ...
  procedure rosetta_table_copy_out_p2(t okl_acd_pvt.acd_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a33 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a1(indx) := t(ddindx).date_report;
          a2(indx) := t(ddindx).cdn_code;
          a3(indx) := rosetta_g_miss_num_map(t(ddindx).clm_id);
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).isp_id);
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).iln_id);
  ...
  procedure rosetta_table_copy_in_p5(t out nocopy okl_acd_pvt.acdv_tbl_type, a0 JTF_NUMBER_TABLE
    , a1 JTF_NUMBER_TABLE
    , a2 JTF_VARCHAR2_TABLE_100
    , a3 JTF_NUMBER_TABLE
    , a4 JTF_NUMBER_TABLE
  ...
  if a0 is not null and a0.count > 0 then
      if a0.count > 0 then
        ...
        while true loop
          ...
          t(ddindx).isp_id := rosetta_g_miss_num_map(a4(indx));
          t(ddindx).clm_id := rosetta_g_miss_num_map(a5(indx));
          t(ddindx).kle_id := rosetta_g_miss_num_map(a6(indx));
          t(ddindx).date_report := rosetta_g_miss_date_in_map(a7(indx));
          ...
          t(ddindx).org_id := rosetta_g_miss_num_map(a24(indx));
  ...
  procedure rosetta_table_copy_out_p5(t okl_acd_pvt.acdv_tbl_type, a0 out nocopy JTF_NUMBER_TABLE
    ...
    a33 := JTF_NUMBER_TABLE();
      ...
      if t.count > 0 then
        ...
        while true loop
          ...
          a4(indx) := rosetta_g_miss_num_map(t(ddindx).isp_id);
          a5(indx) := rosetta_g_miss_num_map(t(ddindx).clm_id);
          a6(indx) := rosetta_g_miss_num_map(t(ddindx).kle_id);
          a7(indx) := t(ddindx).date_report;
          ...
          a24(indx) := rosetta_g_miss_num_map(t(ddindx).org_id);
  ...
  as
    ddp_acdv_rec okl_acd_pvt.acdv_rec_type;
    ddx_acdv_rec okl_acd_pvt.acdv_rec_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    ddp_acdv_rec.id := rosetta_g_miss_num_map(p5_a0);
    ddp_acdv_rec.object_version_number := rosetta_g_miss_num_map(p5_a1);
    ddp_acdv_rec.cdn_code := p5_a2;
    ddp_acdv_rec.iln_id := rosetta_g_miss_num_map(p5_a3);
    ddp_acdv_rec.isp_id := rosetta_g_miss_num_map(p5_a4);
    ddp_acdv_rec.clm_id := rosetta_g_miss_num_map(p5_a5);
    ddp_acdv_rec.kle_id := rosetta_g_miss_num_map(p5_a6);
    ddp_acdv_rec.date_report := rosetta_g_miss_date_in_map(p5_a7);
    ddp_acdv_rec.attribute_category := p5_a8;
    ddp_acdv_rec.attribute1 := p5_a9;
    ddp_acdv_rec.attribute2 := p5_a10;
    ddp_acdv_rec.attribute3 := p5_a11;
    ddp_acdv_rec.attribute4 := p5_a12;
    ddp_acdv_rec.attribute5 := p5_a13;
    ddp_acdv_rec.attribute6 := p5_a14;
    ddp_acdv_rec.attribute7 := p5_a15;
    ddp_acdv_rec.attribute8 := p5_a16;
    ddp_acdv_rec.attribute9 := p5_a17;
    ddp_acdv_rec.attribute10 := p5_a18;
    ddp_acdv_rec.attribute11 := p5_a19;
    ddp_acdv_rec.attribute12 := p5_a20;
    ddp_acdv_rec.attribute13 := p5_a21;
    ddp_acdv_rec.attribute14 := p5_a22;
    ddp_acdv_rec.attribute15 := p5_a23;
    ddp_acdv_rec.org_id := rosetta_g_miss_num_map(p5_a24);
    ddp_acdv_rec.request_id := rosetta_g_miss_num_map(p5_a25);
    ddp_acdv_rec.program_application_id := rosetta_g_miss_num_map(p5_a26);
    ddp_acdv_rec.program_id := rosetta_g_miss_num_map(p5_a27);
    ddp_acdv_rec.program_update_date := rosetta_g_miss_date_in_map(p5_a28);
    ddp_acdv_rec.created_by := rosetta_g_miss_num_map(p5_a29);
    ddp_acdv_rec.creation_date := rosetta_g_miss_date_in_map(p5_a30);
    ddp_acdv_rec.last_updated_by := rosetta_g_miss_num_map(p5_a31);
    ddp_acdv_rec.last_update_date := rosetta_g_miss_date_in_map(p5_a32);
    ddp_acdv_rec.last_update_login := rosetta_g_miss_num_map(p5_a33);


    -- here's the delegated call to the old PL/SQL routine
    okl_acd_pvt.insert_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
    ...
    p6_a0 := rosetta_g_miss_num_map(ddx_acdv_rec.id);
    p6_a1 := rosetta_g_miss_num_map(ddx_acdv_rec.object_version_number);
    p6_a2 := ddx_acdv_rec.cdn_code;
    p6_a3 := rosetta_g_miss_num_map(ddx_acdv_rec.iln_id);
    p6_a4 := rosetta_g_miss_num_map(ddx_acdv_rec.isp_id);
    p6_a5 := rosetta_g_miss_num_map(ddx_acdv_rec.clm_id);
    p6_a6 := rosetta_g_miss_num_map(ddx_acdv_rec.kle_id);
    p6_a7 := ddx_acdv_rec.date_report;
    p6_a8 := ddx_acdv_rec.attribute_category;
    p6_a9 := ddx_acdv_rec.attribute1;
    p6_a10 := ddx_acdv_rec.attribute2;
    p6_a11 := ddx_acdv_rec.attribute3;
    p6_a12 := ddx_acdv_rec.attribute4;
    p6_a13 := ddx_acdv_rec.attribute5;
    p6_a14 := ddx_acdv_rec.attribute6;
    p6_a15 := ddx_acdv_rec.attribute7;
    p6_a16 := ddx_acdv_rec.attribute8;
    p6_a17 := ddx_acdv_rec.attribute9;
    p6_a18 := ddx_acdv_rec.attribute10;
    p6_a19 := ddx_acdv_rec.attribute11;
    p6_a20 := ddx_acdv_rec.attribute12;
    p6_a21 := ddx_acdv_rec.attribute13;
    p6_a22 := ddx_acdv_rec.attribute14;
    p6_a23 := ddx_acdv_rec.attribute15;
    p6_a24 := rosetta_g_miss_num_map(ddx_acdv_rec.org_id);
    p6_a25 := rosetta_g_miss_num_map(ddx_acdv_rec.request_id);
    p6_a26 := rosetta_g_miss_num_map(ddx_acdv_rec.program_application_id);
    p6_a27 := rosetta_g_miss_num_map(ddx_acdv_rec.program_id);
    p6_a28 := ddx_acdv_rec.program_update_date;
    p6_a29 := rosetta_g_miss_num_map(ddx_acdv_rec.created_by);
    p6_a30 := ddx_acdv_rec.creation_date;
    p6_a31 := rosetta_g_miss_num_map(ddx_acdv_rec.last_updated_by);
    p6_a32 := ddx_acdv_rec.last_update_date;
    p6_a33 := rosetta_g_miss_num_map(ddx_acdv_rec.last_update_login);
  end;
  ...
  as
    ddp_acdv_tbl okl_acd_pvt.acdv_tbl_type;
    ddx_acdv_tbl okl_acd_pvt.acdv_tbl_type;
    ddindx binary_integer; indx binary_integer;
  begin
    ...
    okl_acd_pvt_w.rosetta_table_copy_in_p5(ddp_acdv_tbl, p5_a0
      , p5_a1
      , p5_a2
      , p5_a3
      , p5_a4
    ...
    okl_acd_pvt_w.rosetta_table_copy_out_p5(ddx_acdv_tbl, p6_a0
      , p6_a1
      , p6_a2
      , p6_a3
      , p6_a4
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acd_pvt.lock_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acd_pvt.update_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acd_pvt.delete_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
  ...
  begin
    ...
    -- here's the delegated call to the old PL/SQL routine
    okl_acd_pvt.validate_row(p_api_version,
      p_init_msg_list,
      x_return_status,
      x_msg_count,
      x_msg_data,
