--------------------------------------------------------
--  DDL for Package Body IGF_SE_EXT_JOB_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "APPS"."IGF_SE_EXT_JOB_PKG" AS
/* $Header: IGFSI01B.pls 120.1 2005/09/08 14:42:14 appldev noship $ */
/*=======================================================================+
 ...
 |                                                                       |
 | DESCRIPTION                                                           |
 |      PL/SQL body for package: IGF_SE_EXT_JOB_ALL_PKG                  |
 |                                                                       |
 | NOTES                                                                 |
 |                                                                       |
 ...
 | HISTORY                                                               |
 | Who       When          What                                          |
 | veramach  July 2004     FA 151 HR Integration - Obsoleted the package |
